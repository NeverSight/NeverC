...
if(CMAKE_GENERATOR MATCHES "Ninja")
  if(NOT LLVM_PARALLEL_LINK_JOBS AND LLVM_ENABLE_LTO)
    message(STATUS "LTO provides its own parallel linking - limiting parallel link jobs to 2.")
...
if(uppercase_LLVM_ENABLE_LTO STREQUAL "FULL")
...
if( uppercase_LLVM_ENABLE_SUPPORT_XCODE_SIGNPOSTS STREQUAL "FORCE_OFF" )
  # NeverC's default build does not need Xcode signposts; avoid probing
  # os/signpost.h on every configure.
elseif( uppercase_LLVM_ENABLE_SUPPORT_XCODE_SIGNPOSTS STREQUAL "WITH_ASSERTS" OR
        uppercase_LLVM_ENABLE_SUPPORT_XCODE_SIGNPOSTS STREQUAL "FORCE_ON" )
  ...
  if(macos_signposts_available)
    ...
    elseif( uppercase_LLVM_ENABLE_SUPPORT_XCODE_SIGNPOSTS STREQUAL "FORCE_ON" )
      message(FATAL_ERROR "LLVM_ENABLE_SUPPORT_XCODE_SIGNPOSTS=FORCE_ON but os/signpost.h is not usable")
    endif()
  elseif( uppercase_LLVM_ENABLE_SUPPORT_XCODE_SIGNPOSTS STREQUAL "FORCE_ON" )
    message(FATAL_ERROR "LLVM_ENABLE_SUPPORT_XCODE_SIGNPOSTS=FORCE_ON but os/signpost.h is unavailable")
  endif()
else()
