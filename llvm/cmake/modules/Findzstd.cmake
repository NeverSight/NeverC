# Find the zstd headers and shared/static libraries.
#
# Defines zstd_FOUND and, when available, the imported targets
...
if(zstd_FOUND)
  if(zstd_LIBRARY MATCHES "${zstd_STATIC_LIBRARY_SUFFIX}$" AND
     NOT zstd_LIBRARY MATCHES "\\.dll\\.a$")
  ...
  elseif(NOT TARGET zstd::libzstd_shared)
    ...
    if(WIN32 OR CYGWIN)
      ...
      if(NOT "${CMAKE_INSTALL_LIBDIR}" STREQUAL "" AND
         NOT "${CMAKE_INSTALL_BINDIR}" STREQUAL "")
        string(REGEX REPLACE "${CMAKE_INSTALL_LIBDIR}$"
               "${CMAKE_INSTALL_BINDIR}" zstd_DIRNAME "${zstd_DIRNAME}")
      endif()
      get_filename_component(zstd_BASENAME "${zstd_LIBRARY}" NAME)
      string(REGEX REPLACE "\\${CMAKE_LINK_LIBRARY_SUFFIX}$"
             "${CMAKE_SHARED_LIBRARY_SUFFIX}" zstd_BASENAME "${zstd_BASENAME}")
