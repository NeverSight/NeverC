...
#    -DHOST_ARCH=[aarch64|arm64|i686|x86|x86_64|x64]
...
elseif(HOST_ARCH STREQUAL "x86_64" OR HOST_ARCH STREQUAL "x64")
  ...
  message(SEND_ERROR "Unknown host architecture ${HOST_ARCH}. Must be aarch64 (or arm64), i686 (or x86), or x86_64 (or x64).")
endif()
