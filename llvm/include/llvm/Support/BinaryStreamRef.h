...
protected:
  ...
  BinaryStreamRefBase(IntrusiveRefCntPtr<StreamType> SharedImpl,
...
protected:
  ...
  IntrusiveRefCntPtr<StreamType> SharedImpl;
...
class BinaryStreamRef
  ...
  BinaryStreamRef(IntrusiveRefCntPtr<BinaryStream> Impl, uint64_t ViewOffset,
                  uint64_t Length)
...
public:
  ...
  BinaryStreamRef(BinaryStream &Stream, uint64_t Offset, uint64_t Length);
...
class WritableBinaryStreamRef
  ...
  WritableBinaryStreamRef(IntrusiveRefCntPtr<WritableBinaryStream> Impl,
                          uint64_t ViewOffset, uint64_t Length)
      : BinaryStreamRefBase(Impl, ViewOffset, Length) {}
...
namespace detail {
class ArrayRefBSImpl : public BinaryStream {
public:
  ArrayRefBSImpl(ArrayRef<uint8_t> Data, endianness Endian)
      : BBS(Data, Endian) {}
...
class MutableArrayRefBSImpl : public WritableBinaryStream {
public:
  MutableArrayRefBSImpl(MutableArrayRef<uint8_t> Data, endianness Endian)
      : BBS(Data, Endian) {}
  llvm::endianness getEndian() const override { return BBS.getEndian(); }
  Error readBytes(uint64_t Offset, uint64_t Size,
                  ArrayRef<uint8_t> &Buffer) override {
...
inline BinaryStreamRef::BinaryStreamRef(BinaryStream &Stream)
    : BinaryStreamRefBase(Stream) {}
inline BinaryStreamRef::BinaryStreamRef(BinaryStream &Stream, uint64_t Offset,
                                        uint64_t Length)
    : BinaryStreamRefBase(Stream, Offset, Length) {}
inline BinaryStreamRef::BinaryStreamRef(ArrayRef<uint8_t> Data,
                                        endianness Endian)
    : BinaryStreamRefBase(IntrusiveRefCntPtr<detail::ArrayRefBSImpl>(
                              new detail::ArrayRefBSImpl(Data, Endian)),
                          0, Data.size()) {}
inline BinaryStreamRef::BinaryStreamRef(StringRef Data, endianness Endian)
    : BinaryStreamRef(ArrayRef(Data.bytes_begin(), Data.bytes_end()), Endian) {}
inline Error BinaryStreamRef::readBytes(uint64_t Offset, uint64_t Size,
                                        ArrayRef<uint8_t> &Buffer) const {
...
inline Error
BinaryStreamRef::readLongestContiguousChunk(uint64_t Offset,
                                            ArrayRef<uint8_t> &Buffer) const {
...
inline WritableBinaryStreamRef::WritableBinaryStreamRef(
    WritableBinaryStream &Stream)
    : BinaryStreamRefBase(Stream) {}
inline WritableBinaryStreamRef::WritableBinaryStreamRef(
    WritableBinaryStream &Stream, uint64_t Offset, uint64_t Length)
    : BinaryStreamRefBase(Stream, Offset, Length) {}
inline WritableBinaryStreamRef::WritableBinaryStreamRef(
    MutableArrayRef<uint8_t> Data, endianness Endian)
    : BinaryStreamRefBase(IntrusiveRefCntPtr<detail::MutableArrayRefBSImpl>(
                              new detail::MutableArrayRefBSImpl(Data, Endian)),
                          0, Data.size()) {}
inline Error WritableBinaryStreamRef::writeBytes(uint64_t Offset,
                                                 ArrayRef<uint8_t> Data) const {
  if (auto EC = checkOffsetForWrite(Offset, Data.size()))
    return EC;
  return BorrowedImpl->writeBytes(ViewOffset + Offset, Data);
}
inline WritableBinaryStreamRef::operator BinaryStreamRef() const {
  return BinaryStreamRef(*BorrowedImpl, ViewOffset, Length);
}
inline Error WritableBinaryStreamRef::commit() {
