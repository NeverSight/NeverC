...
///
class circular_raw_ostream : public ::llvm::raw_ostream {
public:
...
private:
  ...
  ///
  ::llvm::raw_ostream *TheStream = nullptr;
...
public:
  ...
  ///
  circular_raw_ostream(::llvm::raw_ostream &Stream, const char *Header,
                       size_t BuffSize = 0, bool Owns = REFERENCE_ONLY)
      : ::llvm::raw_ostream(/*unbuffered*/ true), OwnsStream(Owns),
  ...
  /// stream.
  ///
  void setStream(::llvm::raw_ostream &Stream, bool Owns = REFERENCE_ONLY) {
    releaseStream();
    TheStream = &Stream;
    OwnsStream = Owns;
  }
