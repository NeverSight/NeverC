...
/// return it.
class BinaryStream : public ThreadSafeRefCountedBase<BinaryStream> {
public:
  BinaryStream() = default;
  BinaryStream(const BinaryStream &) : ThreadSafeRefCountedBase() {}
  BinaryStream &operator=(const BinaryStream &) { return *this; }
