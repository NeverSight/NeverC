...
using ulittle16_t = detail::packed_endian_specific_integral<
    uint16_t, ::llvm::endianness::little, unaligned>;
using ulittle32_t = detail::packed_endian_specific_integral<
    uint32_t, ::llvm::endianness::little, unaligned>;
using ulittle64_t = detail::packed_endian_specific_integral<
    uint64_t, ::llvm::endianness::little, unaligned>;
...
using aligned_ulittle16_t = detail::packed_endian_specific_integral<
    uint16_t, ::llvm::endianness::little, aligned>;
using aligned_ulittle32_t = detail::packed_endian_specific_integral<
    uint32_t, ::llvm::endianness::little, aligned>;
using aligned_ulittle64_t = detail::packed_endian_specific_integral<
    uint64_t, ::llvm::endianness::little, aligned>;
...
using unaligned_uint16_t = detail::packed_endian_specific_integral<
    uint16_t, ::llvm::endianness::native, unaligned>;
using unaligned_uint32_t = detail::packed_endian_specific_integral<
    uint32_t, ::llvm::endianness::native, unaligned>;
using unaligned_uint64_t = detail::packed_endian_specific_integral<
    uint64_t, ::llvm::endianness::native, unaligned>;
...
template <typename T>
using big_t =
    detail::packed_endian_specific_integral<T, ::llvm::endianness::big,
                                            unaligned>;
