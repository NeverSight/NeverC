...
class TimerGroup {
  struct PrintRecord {
    ...
    PrintRecord(const TimeRecord &Time, StringRef Name, StringRef Description)
  ...
  SmallVector<PrintRecord, 8> TimersToPrint;
...
#ifdef __cplusplus
/* TimerGroup/Timer/TimeRecord out-of-line and TableGen dependencies live in
 * csupport/ltimer.h (inline); include after declarations above. */
#include "csupport/ltimer.h"
#endif
