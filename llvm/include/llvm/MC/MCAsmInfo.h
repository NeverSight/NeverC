...
protected:
  ...
  /// The default of "" means that for this system a plain private symbol
  ...
  /// relocated as a 64-bit GP-relative offset, e.g. .gpdword.  Defaults to
  /// nullptr.
  const char *GPRel64Directive = nullptr;

  /// If non-null, a directive that is used to emit a word which should be
  /// relocated as a 32-bit GP-relative offset, e.g. .gpword or .gprel32.
  /// Defaults to nullptr.
  ...
  /// .dtpreldword/.tprelword/.tpreldword.
...
public:
  ...
  bool usesCFIForEH() const {
    return (ExceptionsType == ExceptionHandling::DwarfCFI || usesWindowsCFI());
  }
