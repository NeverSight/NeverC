...
public:
  ...
  /// If IsImporting is true, this module is being parsed for LTO
  ...
  /// compile with full LTO, and whether it has a summary.
...
/// being parsed for LTO importing into another module.
Expected<std::unique_ptr<Module>>
...
/// to an empty file and IgnoreEmptyLTOIndexFile is true, then
/// this function will return nullptr.
Expected<std::unique_ptr<ModuleSummaryIndex>>
getModuleSummaryIndexForFile(StringRef Path,
                             bool IgnoreEmptyLTOIndexFile = false);
