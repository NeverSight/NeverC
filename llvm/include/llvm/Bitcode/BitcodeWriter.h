...
public:
  ...
  /// (currently for use in LTO optimization).
  ///
  /// \p GenerateHash enables hashing the Module and including the hash in the
  /// bitcode (currently for use in LTO incremental build).
  ///
  ...
  ///
  /// ModHash is for use in LTO incremental build, generated while the
  /// IR bitcode file writing.
  void writeLinkBitcode(const Module &M, const ModuleSummaryIndex &Index,
...
///
/// ModHash is for use in LTO incremental build, generated while the IR
/// bitcode file writing.
void writeLinkBitcodeToFile(const Module &M, raw_ostream &Out,
                            const ModuleSummaryIndex &Index,
                            const ModuleHash &ModHash);
