...
public:
  ...
  /// on some targets expose additional post-RA scheduling opportunities.
...
public:
  ...
  /// for stack machines and other virtual-register machines. If true, all
  /// vregs must be allocated before PEI. If false, then
