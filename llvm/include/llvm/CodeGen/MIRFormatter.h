...
///
/// NeverC note: only the printer-side hooks survive. The parser-side
/// hooks (`parseImmMnemonic`, `parseCustomPseudoSourceValue`,
/// `parseIRValue`) were dropped together with `llvm/lib/CodeGen/MIRParser/`
/// since neverc never consumes textual MIR.
class MIRFormatter {
public:
