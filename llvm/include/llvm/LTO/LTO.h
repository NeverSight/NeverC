...
/// functionality. It supports regular LTO and parallel LTO code generation.
/// You can use it from a linker in the following way:
...
public:
  ...
  LTO(Config Conf, unsigned ParallelCodeGenParallelismLevel = 1,
...
public:
  ...
  // internalization decisions directly to the module.
  struct GlobalResolution {
    ...
    /// The regular LTO object is partition 0.
    ///
