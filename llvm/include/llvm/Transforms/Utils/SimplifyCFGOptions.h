...
struct SimplifyCFGOptions {
  ...
  bool isCompatibleWith(const SimplifyCFGOptions &Other) const {
    return BonusInstThreshold == Other.BonusInstThreshold &&
           ForwardSwitchCondToPhi == Other.ForwardSwitchCondToPhi &&
           ConvertSwitchRangeToICmp == Other.ConvertSwitchRangeToICmp &&
           ConvertSwitchToLookupTable == Other.ConvertSwitchToLookupTable &&
           NeedCanonicalLoop == Other.NeedCanonicalLoop &&
           HoistCommonInsts == Other.HoistCommonInsts &&
           SinkCommonInsts == Other.SinkCommonInsts &&
           SimplifyCondBranch == Other.SimplifyCondBranch &&
           SpeculateBlocks == Other.SpeculateBlocks;
  }
};
