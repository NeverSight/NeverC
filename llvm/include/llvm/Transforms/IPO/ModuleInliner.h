...
///
/// NeverC: ported from upstream LLVM (release/21.x) with the CtxProf and
/// InlineOrder dependencies removed; uses a built-in smallest-callee-first
/// lazy priority queue.  Used by the LTO ParallelOpt serial phase to avoid
/// the CGSCC framework's superlinear incremental call-graph maintenance.
