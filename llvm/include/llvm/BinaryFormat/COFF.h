...
// COFF enum members declared below. #undef every name we redefine as an
// enumerator. `#undef` on an undefined macro is a harmless no-op.
...
#undef IMAGE_AUX_SYMBOL_TYPE_TOKEN_DEF
#undef IMAGE_SCN_TYPE_NOLOAD
...
#undef IMAGE_REL_ARM64_BRANCH14
#undef IMAGE_REL_ARM64_REL32
...
#undef IMAGE_WEAK_EXTERN_ANTI_DEPENDENCY
...
#undef IMAGE_DLL_CHARACTERISTICS_EX_CET_COMPAT
