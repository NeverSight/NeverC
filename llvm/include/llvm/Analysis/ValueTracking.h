...
inline bool isKnownNeverInfinity(const Value *V, const DataLayout &DL,
                                 ...
                                 bool UseInstrInfo = true) {
  KnownFPClass Known =
      computeKnownFPClass(V, DL, fcInf, Depth, TLI, AC, CtxI, DT, UseInstrInfo);
  return Known.isKnownNeverInfinity();
}

/// Return true if the floating-point value can never contain a NaN or infinity.
inline bool isKnownNeverInfOrNaN(const Value *V, const DataLayout &DL,
                                 const TargetLibraryInfo *TLI,
                                 unsigned Depth = 0,
                                 AssumptionCache *AC = nullptr,
                                 const Instruction *CtxI = nullptr,
...
inline bool isKnownNeverNaN(const Value *V, const DataLayout &DL,
                            ...
                            bool UseInstrInfo = true) {
  KnownFPClass Known =
      computeKnownFPClass(V, DL, fcNan, Depth, TLI, AC, CtxI, DT, UseInstrInfo);
