...
public:
  ...
  ///                      C or other languages with runtime metadata.
  ...
  /// \param UnderlyingType Underlying type of a fixed enum.
  /// \param RunTimeLang  Optional parameter, runtime language version.
  /// \param UniqueIdentifier A unique identifier for the enum.
  /// \param IsScoped Boolean flag indicate if this is a scoped enum.
  DICompositeType *
