...
public:
  ...
  ///
  /// Class type for pointer-to-members, global constant wrapper for static
  /// members, or virtual base pointer offset for inheritance.
  ///
...
/// Represents a module in the programming language, for example, a NeverC
