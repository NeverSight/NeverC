...
// Choose ';' as the delimiter. ':' was used once but doesn't work well for
// functions which commonly have :'s in their names.
...
public:
  ...
  /// used as the key for a global lookup (e.g. profile).
  ...
  /// This is a 64 bits hash that is used by PGO to have a compact
