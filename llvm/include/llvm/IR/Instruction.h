...
public:
  ...
  /// Check if this instruction is before the given instruction in the same
  /// basic block. Returns true if this instruction precedes the given
  /// instruction, otherwise returns false. If the instructions belong to
  /// different basic blocks, returns false.
...
public:
  ...
  bool isSameOperationAs(const Instruction *I,
