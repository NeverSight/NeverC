...
void DWARFContext::dump(
  ...
  // NeverC: .debug_macro / .debug_macinfo dump is unsupported (DWARFDebugMacro
  // has been removed).
  ...
  // NeverC: .gdb_index / .apple_* / .debug_names dumpers removed with the
  // corresponding accelerator table implementations.
}
