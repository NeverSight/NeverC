...
void GlobalDCEPass::ScanVTables(Module &) {}

void GlobalDCEPass::ScanVTableLoad(Function *, Metadata *, uint64_t) {}

void GlobalDCEPass::ScanTypeCheckedLoadIntrinsics(Module &) {}

void GlobalDCEPass::AddVirtualFunctionDependencies(Module &) {}
