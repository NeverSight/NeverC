...
// Static implementation moved here from the removed MIRPrinter.cpp so the
// MachineMemOperand printer can still format IR values without pulling in the
// full MIR YAML writer.
