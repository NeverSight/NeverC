...
/// one pointer type to another, i32->i8), sink it into user blocks to
...
static bool OptimizeNoopCopyExpression(CastInst *CI, const TargetLowering &TLI,
  ...
  // to.  This helps us consider truncates as noop copies when they are.
...
/// targets with multiple condition code registers, where it might lose.
///
/// Return true if any changes are made.
...
///   ...
///
/// It would use two comparisons on targets where lowering of icmp sgt/slt is
/// different from lowering of icmp eq. This function tries to convert
