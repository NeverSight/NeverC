...
void TargetLoweringBase::computeRegisterProperties(
  ...
  // a group of value types. For example, on x86_64 the representative
  // for i8, i16, i32, and i64 is GR64.
  for (unsigned i = 0; i != MVT::VALUETYPE_SIZE; ++i) {
...
/// with SSE1, or 8 promoted MVT::f64 values with the X86 FP stack.
///
...
bool TargetLoweringBase::isJumpTableRelative() const { return true; }
