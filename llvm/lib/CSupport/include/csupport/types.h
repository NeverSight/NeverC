...
/* MSVC compatibility: provide __builtin_clzll etc. for real MSVC only.
 * Clang on Windows defines _MSC_VER for ABI compat but already has the
 * builtins natively, so skip the shims for Clang. */
