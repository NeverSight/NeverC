...
enum NodeType : unsigned {
  ...
  /// Represents the global base register for PIC code (LEA RIP-relative).
  GlobalBaseReg,
  ...
  // SjLj exception handling setjmp (__builtin_setjmp).
  EH_SJLJ_SETJMP,

  // SjLj exception handling longjmp (__builtin_longjmp).
  EH_SJLJ_LONGJMP,
