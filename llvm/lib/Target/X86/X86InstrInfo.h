...
/// Return true if the specified global value reference is relative to a
/// PIC base (X86ISD::GlobalBaseReg).
inline static bool isGlobalRelativeToPICBase(unsigned char TargetFlag) {
  switch (TargetFlag) {
  case X86II::MO_GOTOFF:          // ELF large code model local.
  case X86II::MO_GOT:             // ELF large code model global.
  case X86II::MO_PIC_BASE_OFFSET: // Large code model GOT materialization.
  case X86II::MO_TLVP:
    return true;
  default:
    return false;
