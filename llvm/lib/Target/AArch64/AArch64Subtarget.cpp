...
AArch64Subtarget::AArch64Subtarget(
    ...
    const TargetMachine &TM, unsigned MinSVEVectorSizeInBitsOverride,
    unsigned MaxSVEVectorSizeInBitsOverride, bool StreamingSVEMode,
    bool StreamingCompatibleSVEMode, bool HasMinSize)
