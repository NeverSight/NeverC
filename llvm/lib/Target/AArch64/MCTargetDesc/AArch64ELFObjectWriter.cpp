...
AArch64ELFObjectWriter::AArch64ELFObjectWriter(uint8_t OSABI)
    : MCELFObjectTargetWriter(OSABI, ELF::EM_AARCH64,
                              /*HasRelocationAddend=*/true) {}

#define R_CLS(rtype) ELF::R_AARCH64_##rtype
...
llvm::createAArch64ELFObjectWriter(uint8_t OSABI) {
  return std::make_unique<AArch64ELFObjectWriter>(OSABI);
}
