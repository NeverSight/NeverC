...
private:
  ...
  bool expandSaveZA(MachineBasicBlock &MBB, MachineBasicBlock::iterator MBBI);
...
bool AArch64ExpandPseudo::expandSaveZA(MachineBasicBlock &MBB,
                                       MachineBasicBlock::iterator MBBI) {
