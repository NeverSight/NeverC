...
#define NVK_SDK_VERSION_MAJOR 2
#define NVK_SDK_VERSION_MINOR 1
#define NVK_SDK_VERSION_PATCH 0
#define NVK_SDK_VERSION \
	((NVK_SDK_VERSION_MAJOR << 16) | (NVK_SDK_VERSION_MINOR << 8) | \
	 NVK_SDK_VERSION_PATCH)
