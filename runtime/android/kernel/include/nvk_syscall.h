...
static nvk_syscall_fn_t *_nvk_sys_call_table;
static int _nvk_syscall_inited;

static int nvk_syscall_init(void)
{
...
static int nvk_syscall_replace(int nr, nvk_syscall_fn_t new_fn,
...
static int nvk_syscall_restore(int nr, nvk_syscall_fn_t orig)
{
	unsigned long entry;
