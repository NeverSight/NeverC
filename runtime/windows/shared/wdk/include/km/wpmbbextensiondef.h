...
DEFINE_GUID(_WinPhoneExtensionDeviceServiceGuid, 0x84a3bfbf, 0xf1d8, 0x496e, 0x9f, 0x05, 0xd3, 0xde, 0x70, 0x97, 0x31, 0x52);

// VZW IMS and LTE attach
//{20AE8FC1-7B8D-4790-8108-79F9FD80EA51}
DEFINE_GUID(_VZWIMSandLTEAttachGUID, 0x20AE8FC1, 0x7B8D, 0x4790, 0x81, 0x08, 0x79, 0xF9, 0xFD, 0x80, 0xEA, 0x51);

// VZW Admin
//{EB1826E8-5D5A-4BE5-BE34-943EC6679DEE}
DEFINE_GUID(_VZWAdminGUID, 0xEB1826E8, 0x5D5A, 0x4BE5, 0xBE, 0x34, 0x94, 0x3E, 0xC6, 0x67, 0x9D, 0xEE);

// VZW Internet
//{4D3494D1-7581-48B1-9E51-A5B69B853B43}
DEFINE_GUID(_VZWInternetGUID, 0x4D3494D1, 0x7581, 0x48B1, 0x9E, 0x51, 0xA5, 0xB6, 0x9B, 0x85, 0x3B, 0x43);

// VZW Apps
//{1F96FA6B-9529-44C7-9C38-183A1C50ABF4}
DEFINE_GUID(_VZWAppsGUID, 0x1F96FA6B, 0x9529, 0x44C7, 0x9C, 0x38, 0x18, 0x3A, 0x1C, 0x50, 0xAB, 0xF4);

// ATT General internet and LTE Attach
//{9476C91D-608F-47B6-856A-1D90C1BED333}
DEFINE_GUID(_ATTGeneralInternetandLTEAttachGUID, 0x9476C91D, 0x608F, 0x47B6, 0x85, 0x6A, 0x1D, 0x90, 0xC1, 0xBE, 0xD3, 0x33);

// Sprint general internet and LTE attach
// {3F1DE464-1DD2-40BB-944E-D2F00FB83A06}
DEFINE_GUID(_SprintInternetGUID, 0x3f1de464, 0x1dd2, 0x40bb, 0x94, 0x4e, 0xd2, 0xf0, 0xf, 0xb8, 0x3a, 0x6);

// Sprint tethering profile
// {BD382A7A-8777-47C5-969C-39023DB382E8}
DEFINE_GUID(_SprintPamGUID, 0xbd382a7a, 0x8777, 0x47c5, 0x96, 0x9c, 0x39, 0x2, 0x3d, 0xb3, 0x82, 0xe8);

// Sprint OTA provisioning
// {E2704AAC-0B88-47B8-B1DF-AA4AC6D9E19D}
DEFINE_GUID(_SprintOtaGUID, 0xe2704aac, 0xb88, 0x47b8, 0xb1, 0xdf, 0xaa, 0x4a, 0xc6, 0xd9, 0xe1, 0x9d);

// Generic profile guids. These guids are meant to use by the MBB driver to target specific profiles for different configurations.
// It is up to the SV and OEMs to define the mapping and use of these guids to configure the modem for different MOs.
...
// A network-specific error. The following table shows the connection failure values as documented in the 3GPP TS 24.008
// Specification. http://msdn.microsoft.com/en-us/library/windows/hardware/ff571202(v=vs.85).aspx
...
DEFINE_GUID(_WinPhoneIHVExtensionDeviceServiceGuid, 0x2DDDB22A, 0x598F, 0x40E2, 0x9c, 0x6b, 0xe9, 0x38, 0x2c, 0x9b, 0x5a, 0x8d);
...
typedef struct
{
    ...
    DWORD dwPropertyNameOffset;          // offset relative to rgProperties + (cProperties * sizeof(WWAN_WINPHONE_DM_PROPERTY)) of
                                         // WWAN_WINPHONE_DM_CONFIG where null-terminate unicode string property name is stored
...
#define WWAN_WINPHONE_DM_CONFIG_PS_DETACH_ATTACH_REQUIRED \
    0x00000001 // the DM CONFIG needs a PS detach and attach action to take effect
