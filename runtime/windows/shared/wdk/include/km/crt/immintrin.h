...
// These SVML intrinsics require a runtime lib, so comment them
// out for now until they are actually used.
...
// Comment out TSX intrinsics because some Windows code defines _serialize
// as something else (locking).  This should be fine because TSX is probably
// not going to be used by any Windows components given its security issues.
