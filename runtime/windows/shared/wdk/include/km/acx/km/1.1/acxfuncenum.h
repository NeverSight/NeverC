...
//
#define ACX_ALWAYS_AVAILABLE_FUNCTION_COUNT  221
...
typedef enum _ACXFUNCENUM {
    ...
    AcxCircuitGetElementsCountTableIndex = 210,
    AcxCircuitGetPinsCountTableIndex = 211,
    AcxCircuitGetSymbolicLinkNameTableIndex = 212,
    AcxCircuitGetNotificationIdTableIndex = 213,
    AcxFactoryCircuitGetSymbolicLinkNameTableIndex = 214,
    AcxDataFormatListRemoveDataFormatsTableIndex = 215,
    AcxPinRemoveModeDataFormatListTableIndex = 216,
    AcxStreamGetElementsCountTableIndex = 217,
    AcxStreamGetNotificationIdTableIndex = 218,
    AcxTargetCircuitGetSymbolicLinkNameTableIndex = 219,
    AcxTargetPinFlushModeDataFormatListCacheTableIndex = 220,
    AcxFunctionTableNumEntries = 221,
} ACXFUNCENUM;
