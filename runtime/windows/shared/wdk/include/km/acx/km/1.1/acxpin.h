...
typedef
_Function_class_(EVT_ACX_PIN_DATAFORMAT_CHANGE_NOTIFICATION)
_IRQL_requires_same_
_IRQL_requires_max_(PASSIVE_LEVEL)
VOID
NTAPI
...
typedef EVT_ACX_PIN_DATAFORMAT_CHANGE_NOTIFICATION *PFN_ACX_PIN_DATAFORMAT_CHANGE_NOTIFICATION;
...
typedef enum _ACX_PIN_CONFIG_FLAGS {
    ...
    AcxPinConfigNoDefaultDataFormatLists    = 0x00000010,
    AcxPinConfigValidFlags                  = 0x00000011
} ACX_PIN_CONFIG_FLAGS;

#define AcxInstanceIndeterminate ((ULONG)(-1))
    ...
    )
{
    ...
    Config->MaxStreams = AcxInstanceIndeterminate;
}
...
//
// ACX Function: AcxPinRemoveModeDataFormatList
//
typedef
_IRQL_requires_max_(DISPATCH_LEVEL)
WDFAPI
NTSTATUS
(NTAPI *PFN_ACXPINREMOVEMODEDATAFORMATLIST)(
    _In_
    PACX_DRIVER_GLOBALS DriverGlobals,
    _In_
    ACXPIN AcxPin,
...
{
    return ((PFN_ACXPINREMOVEMODEDATAFORMATLIST) AcxFunctions[AcxPinRemoveModeDataFormatListTableIndex])(AcxDriverGlobals, AcxPin, SignalProcessingMode, DataFormatList);
}
