...
#define SIZEOF_NDIS_WWAN_SET_PROVISIONED_CONTEXT_REVISION_2_FOR_NON_MBBCX_DRIVER \
    (FIELD_OFFSET(NDIS_WWAN_SET_PROVISIONED_CONTEXT_V2, ProvisionedContext) + \
     RTL_SIZEOF_THROUGH_FIELD(WWAN_SET_PROVISIONED_CONTEXT_V2, Reserved))
#endif
...
#define SIZEOF_NDIS_WWAN_BASE_STATIONS_INFO_REQ_REVISION_1 \
    (FIELD_OFFSET(NDIS_WWAN_BASE_STATIONS_INFO_REQ, BaseStationsInfoRequest) + \
     RTL_SIZEOF_THROUGH_FIELD(WWAN_BASE_STATIONS_INFO_REQ, MaxCDMACount))
#define SIZEOF_NDIS_WWAN_BASE_STATIONS_INFO_REQ_REVISION_2 \
    (FIELD_OFFSET(NDIS_WWAN_BASE_STATIONS_INFO_REQ, BaseStationsInfoRequest) + \
     RTL_SIZEOF_THROUGH_FIELD(WWAN_BASE_STATIONS_INFO_REQ, MaxNRCount))

#define SIZEOF_NDIS_WWAN_BASE_STATIONS_INFO_RESULT_REVISION_1 \
    (FIELD_OFFSET(NDIS_WWAN_BASE_STATIONS_INFO, BaseStationsInfo.CDMAMrlSize) - \
     FIELD_SIZE(NDIS_WWAN_BASE_STATIONS_INFO, BaseStationsInfo.SystemSubType))
