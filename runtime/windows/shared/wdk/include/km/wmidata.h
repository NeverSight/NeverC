...
#define InjectWriteVendorDefinedRtn     3
typedef struct _INJECT_WRITE_VENDOR_DEFINED_IN
{
    // 
    ULONG Offset;
    #define INJECT_WRITE_VENDOR_DEFINED_IN_Offset_SIZE sizeof(ULONG)
    #define INJECT_WRITE_VENDOR_DEFINED_IN_Offset_ID 1

    // 
    ULONG BytesToWrite;
    #define INJECT_WRITE_VENDOR_DEFINED_IN_BytesToWrite_SIZE sizeof(ULONG)
    #define INJECT_WRITE_VENDOR_DEFINED_IN_BytesToWrite_ID 2

    // 
    UCHAR Data[1];
    #define INJECT_WRITE_VENDOR_DEFINED_IN_Data_ID 3

} INJECT_WRITE_VENDOR_DEFINED_IN, *PINJECT_WRITE_VENDOR_DEFINED_IN;

typedef struct _INJECT_WRITE_VENDOR_DEFINED_OUT
{
    // 
    ULONG Status;
    #define INJECT_WRITE_VENDOR_DEFINED_OUT_Status_SIZE sizeof(ULONG)
    #define INJECT_WRITE_VENDOR_DEFINED_OUT_Status_ID 4

} INJECT_WRITE_VENDOR_DEFINED_OUT, *PINJECT_WRITE_VENDOR_DEFINED_OUT;

#define INJECT_WRITE_VENDOR_DEFINED_OUT_SIZE (FIELD_OFFSET(INJECT_WRITE_VENDOR_DEFINED_OUT, Status) + INJECT_WRITE_VENDOR_DEFINED_OUT_Status_SIZE)

#define InjectReadVendorDefinedRtn     4
typedef struct _INJECT_READ_VENDOR_DEFINED_IN
{
    // 
    ULONG Offset;
    #define INJECT_READ_VENDOR_DEFINED_IN_Offset_SIZE sizeof(ULONG)
    #define INJECT_READ_VENDOR_DEFINED_IN_Offset_ID 1

    // 
    ULONG BytesToRead;
    #define INJECT_READ_VENDOR_DEFINED_IN_BytesToRead_SIZE sizeof(ULONG)
    #define INJECT_READ_VENDOR_DEFINED_IN_BytesToRead_ID 2

} INJECT_READ_VENDOR_DEFINED_IN, *PINJECT_READ_VENDOR_DEFINED_IN;

#define INJECT_READ_VENDOR_DEFINED_IN_SIZE (FIELD_OFFSET(INJECT_READ_VENDOR_DEFINED_IN, BytesToRead) + INJECT_READ_VENDOR_DEFINED_IN_BytesToRead_SIZE)

typedef struct _INJECT_READ_VENDOR_DEFINED_OUT
{
    // 
    ULONG Status;
    #define INJECT_READ_VENDOR_DEFINED_OUT_Status_SIZE sizeof(ULONG)
    #define INJECT_READ_VENDOR_DEFINED_OUT_Status_ID 3

    // 
    ULONG BytesRead;
    #define INJECT_READ_VENDOR_DEFINED_OUT_BytesRead_SIZE sizeof(ULONG)
    #define INJECT_READ_VENDOR_DEFINED_OUT_BytesRead_ID 4

    // 
    UCHAR OutputBuffer[1];
    #define INJECT_READ_VENDOR_DEFINED_OUT_OutputBuffer_ID 5

} INJECT_READ_VENDOR_DEFINED_OUT, *PINJECT_READ_VENDOR_DEFINED_OUT;
