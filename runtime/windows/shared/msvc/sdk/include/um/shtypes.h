...
// etc.
//
//  When an ID list is passed to one of shell APIs (such as
//  SHGetPathFromIDList),
...
typedef /* [wire_marshal] */ const ITEMIDLIST_ABSOLUTE __unaligned
    *PCUIDLIST_ABSOLUTE;
...
typedef /* [wire_marshal] */ const ITEMIDLIST_RELATIVE __unaligned
    *PCUIDLIST_RELATIVE;
...
//    GetDisplayNameOf STRRET_OFFSET  Use STRRET.uOffset     Offset into
//    SHITEMID for ANSI string STRRET_CSTR    Use STRRET.cStr        ANSI Buffer
//
typedef /* [v1_enum] */
    enum tagSTRRET_TYPE {
      STRRET_WSTR = 0,
