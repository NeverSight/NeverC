...
typedef /* [public][public][public][public][switch_type] */
...
typedef /* [switch_type] */ union __MIDL___MIDL_itf_vsmgmt_0000_0000_0001
    *PVSS_MGMT_OBJECT_UNION;
...
typedef struct IVssSnapshotMgmtVtbl {
  ...
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in IVssSnapshotMgmt *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IVssSnapshotMgmt *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IVssSnapshotMgmt *This);
...
interface IVssSnapshotMgmt { CONST_VTBL struct IVssSnapshotMgmtVtbl *lpVtbl; };
...
#define IVssSnapshotMgmt_GetProviderMgmtInterface(This, ProviderId,            \
                                                  InterfaceId, ppItf)          \
  ((This)->lpVtbl->GetProviderMgmtInterface(This, ProviderId, InterfaceId,     \
                                            ppItf))
...
typedef struct IVssSnapshotMgmt2Vtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in IVssSnapshotMgmt2 *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IVssSnapshotMgmt2 *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IVssSnapshotMgmt2 *This);
...
typedef struct IVssDifferentialSoftwareSnapshotMgmtVtbl {
  ...
  DECLSPEC_XFGVIRT(IVssDifferentialSoftwareSnapshotMgmt,
...
typedef struct IVssDifferentialSoftwareSnapshotMgmt2Vtbl {
  ...
  DECLSPEC_XFGVIRT(IVssDifferentialSoftwareSnapshotMgmt2,
...
#define IVssDifferentialSoftwareSnapshotMgmt2_MigrateDiffAreas(                \
  ...
  ((This)->lpVtbl->MigrateDiffAreas(This, pwszVolumeName,                      \
                                    pwszDiffAreaVolumeName,                    \
...
public:
  ...
  virtual HRESULT STDMETHODCALLTYPE QuerySnapshotDeltaBitmap(
      ...
      /* [size_is][size_is][out] */
      __RPC__deref_out_ecount_full_opt(*pcBitmapLength) BYTE * *ppbBitmap) = 0;
};
...
typedef struct IVssDifferentialSoftwareSnapshotMgmt3Vtbl {
  ...
  DECLSPEC_XFGVIRT(IVssDifferentialSoftwareSnapshotMgmt3,
...
typedef struct IVssEnumMgmtObjectVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in IVssEnumMgmtObject *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IVssEnumMgmtObject *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IVssEnumMgmtObject *This);

  DECLSPEC_XFGVIRT(IVssEnumMgmtObject, Next)
  HRESULT(STDMETHODCALLTYPE *Next)(__RPC__in IVssEnumMgmtObject *This,
                                   /* [in] */ ULONG celt,
                                   /* [length_is][size_is][out] */
  ...
  HRESULT(STDMETHODCALLTYPE *Skip)(__RPC__in IVssEnumMgmtObject *This,
                                   /* [in] */ ULONG celt);

  DECLSPEC_XFGVIRT(IVssEnumMgmtObject, Reset)
  HRESULT(STDMETHODCALLTYPE *Reset)(__RPC__in IVssEnumMgmtObject *This);
