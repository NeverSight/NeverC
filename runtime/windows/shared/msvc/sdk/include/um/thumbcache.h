...
#define WTS_E_NOSTORAGEPROVIDERTHUMBNAILHANDLER                                \
  MAKE_HRESULT(SEVERITY_ERROR, FACILITY_ITF, 0xB207)
...
typedef struct ISharedBitmapVtbl {
  ...
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in ISharedBitmap *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in ISharedBitmap *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in ISharedBitmap *This);
  ...
  HRESULT(STDMETHODCALLTYPE *GetSize)(__RPC__in ISharedBitmap *This,
  ...
  HRESULT(STDMETHODCALLTYPE *InitializeBitmap)(__RPC__in ISharedBitmap *This,
                                               /* [in] */ __RPC__in HBITMAP hbm,
...
interface ISharedBitmap { CONST_VTBL struct ISharedBitmapVtbl *lpVtbl; };
...
typedef struct IThumbnailCacheVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in IThumbnailCache *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IThumbnailCache *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IThumbnailCache *This);
...
interface IThumbnailCache { CONST_VTBL struct IThumbnailCacheVtbl *lpVtbl; };
...
#define IThumbnailCache_GetThumbnail(This, pShellItem, cxyRequestedThumbSize,  \
  ...
  ((This)->lpVtbl->GetThumbnail(This, pShellItem, cxyRequestedThumbSize,       \
                                flags, ppvThumb, pOutFlags, pThumbnailID))
...
/* [call_as] */ HRESULT
STDMETHODCALLTYPE IThumbnailCache_RemoteGetThumbnail_Proxy(
...
IThumbnailCache_RemoteGetThumbnailByID_Proxy(
    __RPC__in IThumbnailCache *This,
    /* [in] */ WTS_THUMBNAILID thumbnailID,
    /* [in] */ UINT cxyRequestedThumbSize,
    /* [out] */ __RPC__deref_out_opt ISharedBitmap **ppvThumb,
...
typedef struct IThumbnailProviderVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in IThumbnailProvider *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IThumbnailProvider *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IThumbnailProvider *This);
...
typedef struct IThumbnailSettingsVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in IThumbnailSettings *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IThumbnailSettings *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IThumbnailSettings *This);

  DECLSPEC_XFGVIRT(IThumbnailSettings, SetContext)
  HRESULT(STDMETHODCALLTYPE *SetContext)(__RPC__in IThumbnailSettings *This,
...
typedef struct IThumbnailCachePrimerVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IThumbnailCachePrimer *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IThumbnailCachePrimer *This);
...
IThumbnailCache_GetThumbnail_Proxy(IThumbnailCache *This,
                                   /* [in] */ IShellItem *pShellItem,
                                   /* [in] */ UINT cxyRequestedThumbSize,
                                   /* [in] */ WTS_FLAGS flags,
                                   /* [annotation][unique][out] */
...
/* [local] */ HRESULT STDMETHODCALLTYPE
IThumbnailCache_GetThumbnailByID_Proxy(IThumbnailCache *This,
                                       /* [in] */ WTS_THUMBNAILID thumbnailID,
                                       /* [in] */ UINT cxyRequestedThumbSize,
                                       /* [annotation][unique][out] */
                                       _Out_opt_ ISharedBitmap **ppvThumb,
