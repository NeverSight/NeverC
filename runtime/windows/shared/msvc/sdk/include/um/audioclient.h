...
typedef interface IAudioEffectsChangedNotificationClient
...
typedef interface IAcousticEchoCancellationControl
...
typedef struct IAudioClientVtbl {
  ...
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(IAudioClient *This,
                                             /* [in] */ REFIID riid,
                                             /* [annotation][iid_is][out] */
...
typedef struct IAudioClient2Vtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(IAudioClient2 *This,
                                             /* [in] */ REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);
  ...
  DECLSPEC_XFGVIRT(IAudioClient, Initialize)
  HRESULT(STDMETHODCALLTYPE *Initialize)(IAudioClient2 *This,
                                         /* [annotation][in] */
                                         _In_ AUDCLNT_SHAREMODE ShareMode,
                                         /* [annotation][in] */
                                         _In_ DWORD StreamFlags,
  ...
  DECLSPEC_XFGVIRT(IAudioClient, GetService)
  HRESULT(STDMETHODCALLTYPE *GetService)(IAudioClient2 *This,
                                         /* [annotation][in] */
                                         _In_ REFIID riid,
                                         /* [annotation][iid_is][out] */
                                         _Out_ void **ppv);
...
interface IAudioClient2 { CONST_VTBL struct IAudioClient2Vtbl *lpVtbl; };
...
// AudioClient3ActivationParams is an optional activation parameter for
// IAudioClient3
//
...
// the "tracing context" identifier can ease correlation of which audio client
// instance belongs to which application context
//
// Sample app code:
// PROPVARIANT var;
// PropVariantInit(&var);
// auto p = reinterpret_cast<AudioClient3ActivationParams
// *>CoTaskMemAlloc(sizeof(AudioClient3ActivationParams)); if (nullptr == p) {
// ... } p->tracingContextId = /* app-specific context identifier */; var.vt =
// VT_BLOB; var.blob.cbSize = sizeof(*p); var.blob.pBlobData =
// reinterpret_cast<BYTE *>(p); hr = ActivateAudioInterfaceAsync(device,
...
typedef struct IAudioClient3Vtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(IAudioClient3 *This,
                                             /* [in] */ REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);
  ...
  DECLSPEC_XFGVIRT(IAudioClient, Initialize)
  HRESULT(STDMETHODCALLTYPE *Initialize)(IAudioClient3 *This,
                                         /* [annotation][in] */
                                         _In_ AUDCLNT_SHAREMODE ShareMode,
                                         /* [annotation][in] */
                                         _In_ DWORD StreamFlags,
  ...
  DECLSPEC_XFGVIRT(IAudioClient, GetService)
  HRESULT(STDMETHODCALLTYPE *GetService)(IAudioClient3 *This,
                                         /* [annotation][in] */
                                         _In_ REFIID riid,
                                         /* [annotation][iid_is][out] */
                                         _Out_ void **ppv);
...
interface IAudioClient3 { CONST_VTBL struct IAudioClient3Vtbl *lpVtbl; };
...
public:
  virtual HRESULT STDMETHODCALLTYPE GetBuffer(
      ...
      _Outptr_result_buffer_(
          _Inexpressible_("NumFramesRequested * pFormat->nBlockAlign")) BYTE *
          *ppData) = 0;
...
typedef struct IAudioRenderClientVtbl {
  ...
  HRESULT(STDMETHODCALLTYPE *GetBuffer)(
      ...
      _In_ UINT32 NumFramesRequested,
      /* [annotation][out] */
      _Outptr_result_buffer_(_Inexpressible_(
          "NumFramesRequested * pFormat->nBlockAlign")) BYTE **ppData);
...
public:
  virtual HRESULT STDMETHODCALLTYPE GetBuffer(
      /* [annotation][out] */
      _Outptr_result_buffer_(
          _Inexpressible_("*pNumFramesToRead * pFormat->nBlockAlign")) BYTE *
          *ppData,
      /* [annotation][out] */
...
typedef struct IAudioCaptureClientVtbl {
  ...
  HRESULT(STDMETHODCALLTYPE *GetBuffer)(
      ...
      /* [annotation][out] */
      _Outptr_result_buffer_(_Inexpressible_(
          "*pNumFramesToRead * pFormat->nBlockAlign")) BYTE **ppData,
      /* [annotation][out] */
      _Out_ UINT32 *pNumFramesToRead,
      /* [annotation][out] */
      _Out_ DWORD *pdwFlags,
...
typedef struct IAudioClockVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(IAudioClock *This,
                                             /* [in] */ REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);
...
interface IAudioClock { CONST_VTBL struct IAudioClockVtbl *lpVtbl; };
...
typedef struct IAudioClock2Vtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(IAudioClock2 *This,
                                             /* [in] */ REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);
...
interface IAudioClock2 { CONST_VTBL struct IAudioClock2Vtbl *lpVtbl; };
...
typedef struct IAudioClientDuckingControlVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(IAudioClientDuckingControl *This,
                                             /* [in] */ REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(IAudioClientDuckingControl *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(IAudioClientDuckingControl *This);

  DECLSPEC_XFGVIRT(IAudioClientDuckingControl,
...
#define IAudioClientDuckingControl_AddRef(This) ((This)->lpVtbl->AddRef(This))

#define IAudioClientDuckingControl_Release(This) ((This)->lpVtbl->Release(This))

#define IAudioClientDuckingControl_SetDuckingOptionsForCurrentStream(This,     \
                                                                     options)  \
...
typedef struct IAudioViewManagerServiceVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(IAudioViewManagerService *This,
                                             /* [in] */ REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(IAudioViewManagerService *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(IAudioViewManagerService *This);
...
#define IAudioViewManagerService_AddRef(This) ((This)->lpVtbl->AddRef(This))

#define IAudioViewManagerService_Release(This) ((This)->lpVtbl->Release(This))
...
typedef struct IAudioEffectsChangedNotificationClientVtbl {
  ...
  DECLSPEC_XFGVIRT(IAudioEffectsChangedNotificationClient,
...
#define IAudioEffectsChangedNotificationClient_QueryInterface(This, riid,      \
                                                              ppvObject)       \
  ((This)->lpVtbl->QueryInterface(This, riid, ppvObject))
...
typedef struct IAudioEffectsManagerVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(IAudioEffectsManager *This,
                                             /* [in] */ REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(IAudioEffectsManager *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(IAudioEffectsManager *This);

  DECLSPEC_XFGVIRT(IAudioEffectsManager,
                   RegisterAudioEffectsChangedNotificationCallback)
...
#define IAudioEffectsManager_AddRef(This) ((This)->lpVtbl->AddRef(This))

#define IAudioEffectsManager_Release(This) ((This)->lpVtbl->Release(This))

#define IAudioEffectsManager_RegisterAudioEffectsChangedNotificationCallback(  \
    This, client)                                                              \
  ((This)->lpVtbl->RegisterAudioEffectsChangedNotificationCallback(This,       \
                                                                   client))

#define IAudioEffectsManager_UnregisterAudioEffectsChangedNotificationCallback( \
    This, client)                                                               \
  ((This)->lpVtbl->UnregisterAudioEffectsChangedNotificationCallback(This,      \
                                                                     client))
...
#if WINAPI_FAMILY_PARTITION(WINAPI_PARTITION_APP)
typedef enum AMBISONICS_TYPE { AMBISONICS_TYPE_FULL3D = 0 } AMBISONICS_TYPE;
...
// The AMBISONICS_PARAMS initialization structure should be completely filled
// out and then passed into the SetData API of IAmbisonicsControl Service on
// IAudioClient unsigned int(32) size of AMBISONICS_PARAMS unsigned int(32)
// version of AMBISONICS_PARAMS struct unsigned int(32) ambisonics_type is the
// enumeration of ambisonics types unsigned int(32) ambisonics_channel_ordering
// is the enumeration of ambisonics channel ordering unsigned int(32)
// ambisonics_normalization is the enumeration of ambisonics normaliztion
// unsigned int(32) ambisonics_order
// unsigned int(32) ambisonics_num_channels
// unsigned int(32) ambisonics_channel_map is a sequence of 32-bit unsigned
// integers that maps audio channels in a given audio track to ambisonic
// components, given the defined ambisonics_channel_ordering. The sequence of
// channel_map values should match the channel sequence within the given audio
// track.
...
typedef struct IAudioAmbisonicsControlVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IAudioAmbisonicsControl *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IAudioAmbisonicsControl *This);

  DECLSPEC_XFGVIRT(IAudioAmbisonicsControl, SetData)
  HRESULT(STDMETHODCALLTYPE *SetData)(
      __RPC__in IAudioAmbisonicsControl *This,
      /* [size_is][in] */
      __RPC__in_ecount_full(cbAmbisonicsParams)
          const AMBISONICS_PARAMS *pAmbisonicsParams,
...
typedef struct IAcousticEchoCancellationControlVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(IAcousticEchoCancellationControl *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(IAcousticEchoCancellationControl *This);

  DECLSPEC_XFGVIRT(IAcousticEchoCancellationControl,
                   SetEchoCancellationRenderEndpoint)
  HRESULT(STDMETHODCALLTYPE *SetEchoCancellationRenderEndpoint)(
      IAcousticEchoCancellationControl *This, LPCWSTR endpointId);
...
#define IAcousticEchoCancellationControl_SetEchoCancellationRenderEndpoint(    \
    This, endpointId)                                                          \
