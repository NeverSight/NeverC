...
#define BTH_LE_GAP_APPEARANCE_HID_SUBCATEGORY_PRESENTATION_REMOTE 0x0A
...
typedef VOID(CALLBACK *PFNBLUETOOTH_GATT_EVENT_CALLBACK)(
    _In_ BTH_LE_GATT_EVENT_TYPE EventType, _In_ PVOID EventOutParameter,
...
FORCEINLINE
BOOLEAN
IsBthLEUuidMatch(_In_ BTH_LE_UUID uuid1, _In_ BTH_LE_UUID uuid2)
/*++
