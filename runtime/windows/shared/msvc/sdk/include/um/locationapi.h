...
typedef interface _ICivicAddressReportFactoryEvents
...
typedef struct ILocationReportVtbl {
  ...
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in ILocationReport *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in ILocationReport *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in ILocationReport *This);
...
interface ILocationReport { CONST_VTBL struct ILocationReportVtbl *lpVtbl; };
...
typedef struct ILatLongReportVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in ILatLongReport *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in ILatLongReport *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in ILatLongReport *This);
...
interface ILatLongReport { CONST_VTBL struct ILatLongReportVtbl *lpVtbl; };
...
typedef struct ICivicAddressReportVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in ICivicAddressReport *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in ICivicAddressReport *This);
...
public:
  ...
  virtual HRESULT STDMETHODCALLTYPE GetReport(
      /* [in] */ __RPC__in REFIID reportType,
      /* [retval][out] */ __RPC__deref_out_opt ILocationReport *
          *ppLocationReport) = 0;
  ...
  virtual HRESULT STDMETHODCALLTYPE GetDesiredAccuracy(
      /* [in] */ __RPC__in REFIID reportType,
      /* [retval][out] */ __RPC__out enum LOCATION_DESIRED_ACCURACY *
          pDesiredAccuracy) = 0;
...
typedef struct ILocationVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in ILocation *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in ILocation *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in ILocation *This);
  ...
  HRESULT(STDMETHODCALLTYPE *UnregisterForReport)(__RPC__in ILocation *This,
                                                  /* [in] */ __RPC__in REFIID
                                                      reportType);
...
interface ILocation { CONST_VTBL struct ILocationVtbl *lpVtbl; };
...
#define ILocation_RequestPermissions(This, hParent, pReportTypes, count,       \
                                     fModal)                                   \
  ((This)->lpVtbl->RequestPermissions(This, hParent, pReportTypes, count,      \
                                      fModal))
...
typedef struct ILocationPowerVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in ILocationPower *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in ILocationPower *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in ILocationPower *This);

  DECLSPEC_XFGVIRT(ILocationPower, Connect)
  HRESULT(STDMETHODCALLTYPE *Connect)(__RPC__in ILocationPower *This);

  DECLSPEC_XFGVIRT(ILocationPower, Disconnect)
  HRESULT(STDMETHODCALLTYPE *Disconnect)(__RPC__in ILocationPower *This);

  END_INTERFACE
} ILocationPowerVtbl;

interface ILocationPower { CONST_VTBL struct ILocationPowerVtbl *lpVtbl; };
...
#define ILocationPower_AddRef(This) ((This)->lpVtbl->AddRef(This))

#define ILocationPower_Release(This) ((This)->lpVtbl->Release(This))

#define ILocationPower_Connect(This) ((This)->lpVtbl->Connect(This))

#define ILocationPower_Disconnect(This) ((This)->lpVtbl->Disconnect(This))
...
typedef struct IDefaultLocationVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in IDefaultLocation *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IDefaultLocation *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IDefaultLocation *This);
...
interface IDefaultLocation { CONST_VTBL struct IDefaultLocationVtbl *lpVtbl; };
...
typedef struct ILocationEventsVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in ILocationEvents *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in ILocationEvents *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in ILocationEvents *This);
...
interface ILocationEvents { CONST_VTBL struct ILocationEventsVtbl *lpVtbl; };
...
typedef struct IDispLatLongReportVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in IDispLatLongReport *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IDispLatLongReport *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IDispLatLongReport *This);
...
#define IDispLatLongReport_GetIDsOfNames(This, riid, rgszNames, cNames, lcid,  \
                                         rgDispId)                             \
  ((This)->lpVtbl->GetIDsOfNames(This, riid, rgszNames, cNames, lcid, rgDispId))

#define IDispLatLongReport_Invoke(This, dispIdMember, riid, lcid, wFlags,      \
...
typedef struct IDispCivicAddressReportVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IDispCivicAddressReport *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IDispCivicAddressReport *This);
...
#define IDispCivicAddressReport_GetIDsOfNames(This, riid, rgszNames, cNames,   \
                                              lcid, rgDispId)                  \
  ((This)->lpVtbl->GetIDsOfNames(This, riid, rgszNames, cNames, lcid, rgDispId))

#define IDispCivicAddressReport_Invoke(This, dispIdMember, riid, lcid, wFlags, \
                                       pDispParams, pVarResult, pExcepInfo,    \
                                       puArgErr)                               \
  ((This)->lpVtbl->Invoke(This, dispIdMember, riid, lcid, wFlags, pDispParams, \
                          pVarResult, pExcepInfo, puArgErr))
...
public:
  ...
  virtual /* [id] */ HRESULT STDMETHODCALLTYPE StopListeningForReports(
      void) = 0;
...
typedef struct ILocationReportFactoryVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in ILocationReportFactory *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in ILocationReportFactory *This);
...
#define ILocationReportFactory_GetIDsOfNames(This, riid, rgszNames, cNames,    \
                                             lcid, rgDispId)                   \
  ((This)->lpVtbl->GetIDsOfNames(This, riid, rgszNames, cNames, lcid, rgDispId))

#define ILocationReportFactory_Invoke(This, dispIdMember, riid, lcid, wFlags,  \
                                      pDispParams, pVarResult, pExcepInfo,     \
                                      puArgErr)                                \
  ((This)->lpVtbl->Invoke(This, dispIdMember, riid, lcid, wFlags, pDispParams, \
                          pVarResult, pExcepInfo, puArgErr))
...
typedef struct ILatLongReportFactoryVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in ILatLongReportFactory *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in ILatLongReportFactory *This);
...
#define ILatLongReportFactory_GetIDsOfNames(This, riid, rgszNames, cNames,     \
                                            lcid, rgDispId)                    \
  ((This)->lpVtbl->GetIDsOfNames(This, riid, rgszNames, cNames, lcid, rgDispId))

#define ILatLongReportFactory_Invoke(This, dispIdMember, riid, lcid, wFlags,   \
                                     pDispParams, pVarResult, pExcepInfo,      \
                                     puArgErr)                                 \
  ((This)->lpVtbl->Invoke(This, dispIdMember, riid, lcid, wFlags, pDispParams, \
                          pVarResult, pExcepInfo, puArgErr))
...
public:
  virtual /* [id][propget] */ HRESULT STDMETHODCALLTYPE get_CivicAddressReport(
      /* [retval][out] */ __RPC__deref_out_opt IDispCivicAddressReport *
      *pVal) = 0;
};
...
typedef struct ICivicAddressReportFactoryVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in ICivicAddressReportFactory *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in ICivicAddressReportFactory *This);
...
#define ICivicAddressReportFactory_GetIDsOfNames(This, riid, rgszNames,        \
                                                 cNames, lcid, rgDispId)       \
  ((This)->lpVtbl->GetIDsOfNames(This, riid, rgszNames, cNames, lcid, rgDispId))

#define ICivicAddressReportFactory_Invoke(This, dispIdMember, riid, lcid,      \
                                          wFlags, pDispParams, pVarResult,     \
                                          pExcepInfo, puArgErr)                \
  ((This)->lpVtbl->Invoke(This, dispIdMember, riid, lcid, wFlags, pDispParams, \
                          pVarResult, pExcepInfo, puArgErr))

#define ICivicAddressReportFactory_ListenForReports(This,                      \
...
#define ICivicAddressReportFactory_put_ReportInterval(This,                    \
...
class DECLSPEC_UUID("8B7FBFE0-5CD7-494a-AF8C-283A65707506") DefaultLocation;
#endif
...
class DECLSPEC_UUID("ED81C073-1F84-4ca8-A161-183C776BC651") LatLongReport;
#endif
...
class DECLSPEC_UUID("D39E7BDD-7D05-46b8-8721-80CF035F57D7") CivicAddressReport;
#endif
...
#define _ILatLongReportFactoryEvents_GetIDsOfNames(This, riid, rgszNames,      \
                                                   cNames, lcid, rgDispId)     \
  ((This)->lpVtbl->GetIDsOfNames(This, riid, rgszNames, cNames, lcid, rgDispId))

#define _ILatLongReportFactoryEvents_Invoke(This, dispIdMember, riid, lcid,    \
                                            wFlags, pDispParams, pVarResult,   \
                                            pExcepInfo, puArgErr)              \
  ((This)->lpVtbl->Invoke(This, dispIdMember, riid, lcid, wFlags, pDispParams, \
                          pVarResult, pExcepInfo, puArgErr))
...
#define _ICivicAddressReportFactoryEvents_QueryInterface(This, riid,           \
                                                         ppvObject)            \
  ((This)->lpVtbl->QueryInterface(This, riid, ppvObject))
...
#define _ICivicAddressReportFactoryEvents_GetTypeInfo(This, iTInfo, lcid,      \
                                                      ppTInfo)                 \
  ((This)->lpVtbl->GetTypeInfo(This, iTInfo, lcid, ppTInfo))

#define _ICivicAddressReportFactoryEvents_GetIDsOfNames(                       \
...
class DECLSPEC_UUID("7A7C3277-8F84-4636-95B2-EBB5507FF77E") DispLatLongReport;
#endif
...
#pragma deprecated(                                                            \
    ICivicAddressReport) // Please do not use ICivicAddressReport, use
                         // Geolocation WinRT APIs instead.
#pragma deprecated(IDefaultLocation) // Please do not use IDefaultLocation, use
                                     // Geolocation WinRT APIs instead.
#pragma deprecated(IDispLatLongReport) // Please do not use IDispLatLongReport,
                                       // use Geolocation WinRT APIs instead.
#pragma deprecated(                                                            \
    IDispCivicAddressReport) // Please do not use IDispCivicAddressReport, use
                             // Geolocation WinRT APIs instead.
#pragma deprecated(ILatLongReport) // Please do not use ILatLongReport, use
                                   // Geolocation WinRT APIs instead.
#pragma deprecated(ILocation) // Please do not use ILocation, use Geolocation
                              // WinRT APIs instead.
#pragma deprecated(ILocationEvents) // Please do not use ILocationEvents, use
                                    // Geolocation WinRT APIs instead.
#pragma deprecated(ILocationPower)  // Please do not use ILocationPower, use
                                    // Geolocation WinRT APIs instead.
#pragma deprecated(ILocationReport) // Please do not use ILocationReport, use
                                    // Geolocation WinRT APIs instead.
