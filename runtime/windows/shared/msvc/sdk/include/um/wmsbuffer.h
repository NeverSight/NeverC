...
EXTERN_GUID(IID_INSSBuffer, 0xE1CD3524, 0x03D7, 0x11d2, 0x9E, 0xED, 0x00, 0x60,
            0x97, 0xD2, 0xD7, 0xCF);
EXTERN_GUID(IID_IWMSBuffer, 0xE1CD3524, 0x03D7, 0x11d2, 0x9E, 0xED, 0x00, 0x60,
            0x97, 0xD2, 0xD7, 0xCF);
EXTERN_GUID(IID_INSSBuffer2, 0x4f528693, 0x1035, 0x43fe, 0xb4, 0x28, 0x75, 0x75,
            0x61, 0xad, 0x3a, 0x68);
EXTERN_GUID(IID_INSSBuffer3, 0xc87ceaaf, 0x75be, 0x4bc4, 0x84, 0xeb, 0xac, 0x27,
            0x98, 0x50, 0x76, 0x72);
EXTERN_GUID(IID_INSSBuffer4, 0xb6b8fd5a, 0x32e2, 0x49d4, 0xa9, 0x10, 0xc2, 0x6c,
            0xc8, 0x54, 0x65, 0xed);
EXTERN_GUID(IID_IWMSBufferAllocator, 0x61103CA4, 0x2033, 0x11d2, 0x9E, 0xF1,
            0x00, 0x60, 0x97, 0xD2, 0xD7, 0xCF);
...
typedef struct INSSBufferVtbl {
  ...
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(INSSBuffer *This,
                                             /* [in] */ REFIID riid,
  ...
  HRESULT(STDMETHODCALLTYPE *GetLength)(INSSBuffer *This,
                                        /* [out] */ DWORD *pdwLength);

  DECLSPEC_XFGVIRT(INSSBuffer, SetLength)
  HRESULT(STDMETHODCALLTYPE *SetLength)(INSSBuffer *This,
                                        /* [in] */ DWORD dwLength);

  DECLSPEC_XFGVIRT(INSSBuffer, GetMaxLength)
  HRESULT(STDMETHODCALLTYPE *GetMaxLength)(INSSBuffer *This,
                                           /* [out] */ DWORD *pdwLength);

  DECLSPEC_XFGVIRT(INSSBuffer, GetBuffer)
  HRESULT(STDMETHODCALLTYPE *GetBuffer)(INSSBuffer *This,
                                        /* [out] */ BYTE **ppdwBuffer);
...
interface INSSBuffer { CONST_VTBL struct INSSBufferVtbl *lpVtbl; };
...
typedef struct INSSBuffer2Vtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(INSSBuffer2 *This,
                                             /* [in] */ REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);
  ...
  DECLSPEC_XFGVIRT(INSSBuffer, GetLength)
  HRESULT(STDMETHODCALLTYPE *GetLength)(INSSBuffer2 *This,
                                        /* [out] */ DWORD *pdwLength);

  DECLSPEC_XFGVIRT(INSSBuffer, SetLength)
  HRESULT(STDMETHODCALLTYPE *SetLength)(INSSBuffer2 *This,
                                        /* [in] */ DWORD dwLength);

  DECLSPEC_XFGVIRT(INSSBuffer, GetMaxLength)
  HRESULT(STDMETHODCALLTYPE *GetMaxLength)(INSSBuffer2 *This,
                                           /* [out] */ DWORD *pdwLength);

  DECLSPEC_XFGVIRT(INSSBuffer, GetBuffer)
  HRESULT(STDMETHODCALLTYPE *GetBuffer)(INSSBuffer2 *This,
                                        /* [out] */ BYTE **ppdwBuffer);
...
interface INSSBuffer2 { CONST_VTBL struct INSSBuffer2Vtbl *lpVtbl; };
...
typedef struct INSSBuffer3Vtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(INSSBuffer3 *This,
                                             /* [in] */ REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);
  ...
  DECLSPEC_XFGVIRT(INSSBuffer, GetLength)
  HRESULT(STDMETHODCALLTYPE *GetLength)(INSSBuffer3 *This,
                                        /* [out] */ DWORD *pdwLength);

  DECLSPEC_XFGVIRT(INSSBuffer, SetLength)
  HRESULT(STDMETHODCALLTYPE *SetLength)(INSSBuffer3 *This,
                                        /* [in] */ DWORD dwLength);

  DECLSPEC_XFGVIRT(INSSBuffer, GetMaxLength)
  HRESULT(STDMETHODCALLTYPE *GetMaxLength)(INSSBuffer3 *This,
                                           /* [out] */ DWORD *pdwLength);

  DECLSPEC_XFGVIRT(INSSBuffer, GetBuffer)
  HRESULT(STDMETHODCALLTYPE *GetBuffer)(INSSBuffer3 *This,
                                        /* [out] */ BYTE **ppdwBuffer);
...
interface INSSBuffer3 { CONST_VTBL struct INSSBuffer3Vtbl *lpVtbl; };
...
#define INSSBuffer3_SetProperty(This, guidBufferProperty, pvBufferProperty,    \
                                dwBufferPropertySize)                          \
  ((This)->lpVtbl->SetProperty(This, guidBufferProperty, pvBufferProperty,     \
                               dwBufferPropertySize))

#define INSSBuffer3_GetProperty(This, guidBufferProperty, pvBufferProperty,    \
                                pdwBufferPropertySize)                         \
  ((This)->lpVtbl->GetProperty(This, guidBufferProperty, pvBufferProperty,     \
                               pdwBufferPropertySize))
...
typedef struct INSSBuffer4Vtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(INSSBuffer4 *This,
                                             /* [in] */ REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);
  ...
  DECLSPEC_XFGVIRT(INSSBuffer, GetLength)
  HRESULT(STDMETHODCALLTYPE *GetLength)(INSSBuffer4 *This,
                                        /* [out] */ DWORD *pdwLength);

  DECLSPEC_XFGVIRT(INSSBuffer, SetLength)
  HRESULT(STDMETHODCALLTYPE *SetLength)(INSSBuffer4 *This,
                                        /* [in] */ DWORD dwLength);

  DECLSPEC_XFGVIRT(INSSBuffer, GetMaxLength)
  HRESULT(STDMETHODCALLTYPE *GetMaxLength)(INSSBuffer4 *This,
                                           /* [out] */ DWORD *pdwLength);

  DECLSPEC_XFGVIRT(INSSBuffer, GetBuffer)
  HRESULT(STDMETHODCALLTYPE *GetBuffer)(INSSBuffer4 *This,
                                        /* [out] */ BYTE **ppdwBuffer);

  DECLSPEC_XFGVIRT(INSSBuffer, GetBufferAndLength)
  HRESULT(STDMETHODCALLTYPE *GetBufferAndLength)(INSSBuffer4 *This,
                                                 /* [out] */ BYTE **ppdwBuffer,
                                                 /* [out] */ DWORD *pdwLength);
...
interface INSSBuffer4 { CONST_VTBL struct INSSBuffer4Vtbl *lpVtbl; };
...
#define INSSBuffer4_SetProperty(This, guidBufferProperty, pvBufferProperty,    \
                                dwBufferPropertySize)                          \
  ((This)->lpVtbl->SetProperty(This, guidBufferProperty, pvBufferProperty,     \
                               dwBufferPropertySize))

#define INSSBuffer4_GetProperty(This, guidBufferProperty, pvBufferProperty,    \
                                pdwBufferPropertySize)                         \
  ((This)->lpVtbl->GetProperty(This, guidBufferProperty, pvBufferProperty,     \
                               pdwBufferPropertySize))
...
#define INSSBuffer4_GetPropertyByIndex(This, dwBufferPropertyIndex,            \
                                       pguidBufferProperty, pvBufferProperty,  \
                                       pdwBufferPropertySize)                  \
  ((This)->lpVtbl->GetPropertyByIndex(This, dwBufferPropertyIndex,             \
                                      pguidBufferProperty, pvBufferProperty,   \
                                      pdwBufferPropertySize))
...
typedef struct IWMSBufferAllocatorVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(IWMSBufferAllocator *This,
                                             /* [in] */ REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);
  ...
  HRESULT(STDMETHODCALLTYPE *AllocateBuffer)(IWMSBufferAllocator *This,
                                             /* [in] */ DWORD dwMaxBufferSize,
...
#define IWMSBufferAllocator_AllocatePageSizeBuffer(This, dwMaxBufferSize,      \
                                                   ppBuffer)                   \
