...
// MessageText:
//
// Row could not be inserted into the rowset without exceeding provider's
// maximum number of active rows.
//
...
// MessageText:
//
// Data or literal value could not be converted to the type of the column in the
// data source, and the provider was unable to determine which columns could not
// be converted.  Data overflow or sign mismatch was not the cause.
//
...
// MessageText:
//
// Numerator was greater than denominator. Values must express ratio between
// zero and 1.
//
...
// MessageText:
//
// Data source object could not be created because the named data source already
// exists.
//
...
// MessageText:
//
// Goal was rejected because no nonzero weights were specified for any goals
// supported. Current goal was not changed.
//
...
// MessageText:
//
// No rows were returned because the offset value moves the position before the
// beginning or after the end of the rowset.
//
...
// MessageText:
//
// Set of rows is not contiguous to, or does not overlap, the rows in the watch
// region.
//
...
// MessageText:
//
// Region is not a proper subregion of the region identified by the watch region
// handle.
//
...
// MessageText:
//
// Execution stopped because a resource limit was reached. No results were
// returned.
//
...
// MessageText:
//
// Command object whose command tree contains a rowset or rowsets cannot be
// cloned.
//
...
// MessageText:
//
// Rowset used optimistic concurrency and the value of a column has changed
...
// MessageText:
//
// Literal value in the command exceeded the range of the type of the associated
// column.
//
...
// MessageText:
//
// Most recent data for a newly inserted row could not be retrieved because the
// insert is pending.
//
...
// MessageText:
//
// Session cannot be created because maximum number of active sessions was
// already reached. Consumer must release one or more sessions before creating a
// new session object.
//
...
// MessageText:
//
// Initialization string specifies a provider that does not match the active
// provider.
//
...
// MessageText:
//
// ConstraintType is not DBCONSTRAINTTYPE_FOREIGNKEY and cForeignKeyColumns is
// not zero.
//
...
// MessageText:
//
// rguidColumnType points to a GUID that does not match the object type of this
// column, or this column was not set.
//
...
// MessageText:
//
// OLE DB object represented by this URL is locked by one or more other
// processes.
//
...
// MessageText:
//
// Object cannot be created at this URL because an object named by this URL
// already exists.
//
...
// MessageText:
//
// Column or constraint could not be dropped because it is referenced by a
// dependent view or constraint.
//
...
// MessageText:
//
// Object cannot be created at this URL because the server is out of physical
// storage.
//
...
// MessageText:
//
// The specified statistic does not exist in the current data source or did not
// apply to the specified table or it does not support a histogram.
//
...
// MessageText:
//
// Column or table could not be altered because it is referenced by a
// constraint.
//
...
// MessageText:
//
// Requested column is valid, but could not be retrieved. This could be due to a
// forward only cursor attempting to go backwards in a row.
//
...
// MessageText:
//
// Fetching requested number of rows will exceed total number of active rows
// supported by the rowset.
//
...
// MessageText:
//
// One or more column types are incompatible. Conversion errors will occur
// during copying.
//
...
// MessageText:
//
// Operation succeeded, but status array or string buffer could not be
// allocated.
//
...
// MessageText:
//
// Weight is not supported or exceeded the supported limit, and was set to 0 or
// the supported limit.
//
...
// MessageText:
//
// Consumer does not want to receive further notification calls for this
// operation.
//
...
// MessageText:
//
// Command was executed to reposition to the start of the rowset. Either the
// order of the columns changed, or columns were added to or removed from the
// rowset.
//
...
// MessageText:
//
// Provider cannot keep track of all the changes. Client must refetch the data
...
// MessageText:
//
// Execution stopped because a resource limit was reached. Results obtained so
// far were returned, but execution cannot resume.
//
...
// MessageText:
//
// Multiple-step operation completed with one or more errors. Check each status
// value.
//
...
#endif // OLEDBVER >= 0x0210
//@@@- V2.1
// To help DSL display more meaningful error message, we need to overwrite
// system error message in the following two cases.
