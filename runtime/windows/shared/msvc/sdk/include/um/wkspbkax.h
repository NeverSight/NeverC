...
public:
  virtual /* [helpstring][id] */ HRESULT STDMETHODCALLTYPE SetupWorkspace(
      void) = 0;

  virtual /* [helpstring][id] */ HRESULT STDMETHODCALLTYPE
  InitializeWorkspaceConfiguration(void) = 0;
  ...
  virtual /* [helpstring][id][propget] */ HRESULT STDMETHODCALLTYPE
  get_WorkspaceFoldersCount(
      /* [in] */ __RPC__in BSTR WkspId,
      /* [retval][out] */ __RPC__out LONG * pVal) = 0;

  virtual /* [helpstring][id][propget] */ HRESULT STDMETHODCALLTYPE
  get_WorkspaceFolderName(
      /* [in] */ __RPC__in BSTR WkspId,
      /* [in] */ LONG itr,
      /* [retval][out] */ __RPC__deref_out_opt BSTR * pVal) = 0;

  virtual /* [helpstring][id][propget] */ HRESULT STDMETHODCALLTYPE
  get_WorkspaceFolderContentsCount(
      /* [in] */ __RPC__in BSTR WkspId,
      /* [in] */ __RPC__in BSTR WkspFolder,
      /* [retval][out] */ __RPC__out LONG * pVal) = 0;

  virtual /* [helpstring][id][propget] */ HRESULT STDMETHODCALLTYPE
  get_WorkspaceFolderImageData(
      /* [in] */ __RPC__in BSTR WkspId,
      /* [in] */ __RPC__in BSTR WkspFolder,
      /* [in] */ LONG itr,
      /* [retval][out] */ __RPC__deref_out_opt BSTR * pVal) = 0;
  ...
  virtual /* [helpstring][id][propget] */ HRESULT STDMETHODCALLTYPE
  get_WorkspaceFolderItemFileExtension(
      /* [in] */ __RPC__in BSTR WkspId,
      /* [in] */ __RPC__in BSTR WkspFolder,
      /* [in] */ LONG itr,
      /* [retval][out] */ __RPC__deref_out_opt BSTR * pVal) = 0;
  ...
  virtual /* [helpstring][id][propget] */ HRESULT STDMETHODCALLTYPE
  get_IsWorkspaceFolderItemRemoteDesktop(
      /* [in] */ __RPC__in BSTR WkspId,
      /* [in] */ __RPC__in BSTR WkspFolder,
      /* [in] */ LONG itr,
...
typedef struct IWorkspaceBrokerAxVtbl {
  ...
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in IWorkspaceBrokerAx *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IWorkspaceBrokerAx *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IWorkspaceBrokerAx *This);
  ...
  /* [helpstring][id] */ HRESULT(
      STDMETHODCALLTYPE *InitializeWorkspaceConfiguration)(
      __RPC__in IWorkspaceBrokerAx *This);

  DECLSPEC_XFGVIRT(IWorkspaceBrokerAx, get_WorkspacesCount)
  /* [helpstring][id][propget] */ HRESULT(
      STDMETHODCALLTYPE *get_WorkspacesCount)(
      __RPC__in IWorkspaceBrokerAx *This,
  ...
  /* [helpstring][id][propget] */ HRESULT(
      STDMETHODCALLTYPE *get_WorkspaceFoldersCount)(
      __RPC__in IWorkspaceBrokerAx *This,
      /* [in] */ __RPC__in BSTR WkspId,
      /* [retval][out] */ __RPC__out LONG *pVal);
  ...
  /* [helpstring][id][propget] */ HRESULT(
      STDMETHODCALLTYPE *get_WorkspaceFolderName)(
      __RPC__in IWorkspaceBrokerAx *This,
      /* [in] */ __RPC__in BSTR WkspId,
      /* [in] */ LONG itr,
      /* [retval][out] */ __RPC__deref_out_opt BSTR *pVal);
  ...
  /* [helpstring][id][propget] */ HRESULT(
      STDMETHODCALLTYPE *get_WorkspaceFolderContentsCount)(
      __RPC__in IWorkspaceBrokerAx *This,
      /* [in] */ __RPC__in BSTR WkspId,
      /* [in] */ __RPC__in BSTR WkspFolder,
      /* [retval][out] */ __RPC__out LONG *pVal);
  ...
  /* [helpstring][id][propget] */ HRESULT(
      STDMETHODCALLTYPE *get_WorkspaceFolderImageData)(
      __RPC__in IWorkspaceBrokerAx *This,
      /* [in] */ __RPC__in BSTR WkspId,
      /* [in] */ __RPC__in BSTR WkspFolder,
      /* [in] */ LONG itr,
  ...
  /* [helpstring][id][propget] */ HRESULT(
      STDMETHODCALLTYPE *get_WorkspaceFolderItemName)(
      __RPC__in IWorkspaceBrokerAx *This,
      /* [in] */ __RPC__in BSTR WkspId,
      /* [in] */ __RPC__in BSTR WkspFolder,
      /* [in] */ LONG itr,
  ...
  /* [helpstring][id][propget] */ HRESULT(
      STDMETHODCALLTYPE *get_WorkspaceFolderItemFileExtension)(
      __RPC__in IWorkspaceBrokerAx *This,
      /* [in] */ __RPC__in BSTR WkspId,
      /* [in] */ __RPC__in BSTR WkspFolder,
      /* [in] */ LONG itr,
  ...
  /* [helpstring][id][propget] */ HRESULT(
      STDMETHODCALLTYPE *get_IsWorkspaceFolderItemRemoteDesktop)(
      __RPC__in IWorkspaceBrokerAx *This,
      /* [in] */ __RPC__in BSTR WkspId,
      /* [in] */ __RPC__in BSTR WkspFolder,
      /* [in] */ LONG itr,
...
#define IWorkspaceBrokerAx_AddRef(This) ((This)->lpVtbl->AddRef(This))

#define IWorkspaceBrokerAx_Release(This) ((This)->lpVtbl->Release(This))
...
#define IWorkspaceBrokerAx_GetIDsOfNames(This, riid, rgszNames, cNames, lcid,  \
                                         rgDispId)                             \
  ((This)->lpVtbl->GetIDsOfNames(This, riid, rgszNames, cNames, lcid, rgDispId))

#define IWorkspaceBrokerAx_Invoke(This, dispIdMember, riid, lcid, wFlags,      \
...
#define IWorkspaceBrokerAx_get_WorkspaceFolderContentsCount(This, WkspId,      \
                                                            WkspFolder, pVal)  \
  ((This)->lpVtbl->get_WorkspaceFolderContentsCount(This, WkspId, WkspFolder,  \
                                                    pVal))

#define IWorkspaceBrokerAx_get_WorkspaceFolderImageData(This, WkspId,          \
                                                        WkspFolder, itr, pVal) \
  ((This)->lpVtbl->get_WorkspaceFolderImageData(This, WkspId, WkspFolder, itr, \
                                                pVal))

#define IWorkspaceBrokerAx_get_WorkspaceFolderItemName(This, WkspId,           \
                                                       WkspFolder, itr, pVal)  \
  ((This)->lpVtbl->get_WorkspaceFolderItemName(This, WkspId, WkspFolder, itr,  \
                                               pVal))

#define IWorkspaceBrokerAx_get_WorkspaceFolderItemFileExtension(               \
    This, WkspId, WkspFolder, itr, pVal)                                       \
  ((This)->lpVtbl->get_WorkspaceFolderItemFileExtension(                       \
      This, WkspId, WkspFolder, itr, pVal))

#define IWorkspaceBrokerAx_get_IsWorkspaceFolderItemRemoteDesktop(             \
    This, WkspId, WkspFolder, itr, pVal)                                       \
  ((This)->lpVtbl->get_IsWorkspaceFolderItemRemoteDesktop(                     \
      This, WkspId, WkspFolder, itr, pVal))

#define IWorkspaceBrokerAx_LaunchWorkspaceItem(                                \
    This, WkspId, WkspFolder, WkspItemName, ActivationContext)                 \
  ((This)->lpVtbl->LaunchWorkspaceItem(This, WkspId, WkspFolder, WkspItemName, \
                                       ActivationContext))
...
public:
  ...
  virtual /* [helpstring][id][propget] */ HRESULT STDMETHODCALLTYPE
  get_WorkspaceLastUpdateDescription(
      /* [in] */ __RPC__in BSTR bstrWorkspaceGUID,
      /* [retval][out] */ __RPC__deref_out_opt BSTR * pbstrMessage) = 0;

  virtual /* [helpstring][id][propget] */ HRESULT STDMETHODCALLTYPE
  get_IsDefaultWorkspace(
      /* [in] */ __RPC__in BSTR bstrWorkspaceGUID,
      /* [retval][out] */ __RPC__out VARIANT_BOOL * pVal) = 0;
};
...
typedef struct IWorkspaceBrokerAx2Vtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IWorkspaceBrokerAx2 *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IWorkspaceBrokerAx2 *This);
  ...
  /* [helpstring][id][propget] */ HRESULT(
      STDMETHODCALLTYPE *get_WorkspaceDescription)(
      __RPC__in IWorkspaceBrokerAx2 *This,
      /* [in] */ __RPC__in BSTR bstrWorkspaceGUID,
  ...
  /* [helpstring][id][propget] */ HRESULT(
      STDMETHODCALLTYPE *get_WorkspaceLastUpdateDescription)(
      __RPC__in IWorkspaceBrokerAx2 *This,
      /* [in] */ __RPC__in BSTR bstrWorkspaceGUID,
      /* [retval][out] */ __RPC__deref_out_opt BSTR *pbstrMessage);
  ...
  /* [helpstring][id][propget] */ HRESULT(
      STDMETHODCALLTYPE *get_IsDefaultWorkspace)(
      __RPC__in IWorkspaceBrokerAx2 *This,
      /* [in] */ __RPC__in BSTR bstrWorkspaceGUID,
      /* [retval][out] */ __RPC__out VARIANT_BOOL *pVal);
...
#define IWorkspaceBrokerAx2_AddRef(This) ((This)->lpVtbl->AddRef(This))

#define IWorkspaceBrokerAx2_Release(This) ((This)->lpVtbl->Release(This))
...
#define IWorkspaceBrokerAx2_GetIDsOfNames(This, riid, rgszNames, cNames, lcid, \
                                          rgDispId)                            \
  ((This)->lpVtbl->GetIDsOfNames(This, riid, rgszNames, cNames, lcid, rgDispId))

#define IWorkspaceBrokerAx2_Invoke(This, dispIdMember, riid, lcid, wFlags,     \
                                   pDispParams, pVarResult, pExcepInfo,        \
                                   puArgErr)                                   \
  ((This)->lpVtbl->Invoke(This, dispIdMember, riid, lcid, wFlags, pDispParams, \
                          pVarResult, pExcepInfo, puArgErr))
...
#define IWorkspaceBrokerAx2_get_WorkspaceFolderContentsCount(This, WkspId,     \
                                                             WkspFolder, pVal) \
  ((This)->lpVtbl->get_WorkspaceFolderContentsCount(This, WkspId, WkspFolder,  \
                                                    pVal))

#define IWorkspaceBrokerAx2_get_WorkspaceFolderImageData(                      \
    This, WkspId, WkspFolder, itr, pVal)                                       \
  ((This)->lpVtbl->get_WorkspaceFolderImageData(This, WkspId, WkspFolder, itr, \
                                                pVal))

#define IWorkspaceBrokerAx2_get_WorkspaceFolderItemName(This, WkspId,          \
                                                        WkspFolder, itr, pVal) \
  ((This)->lpVtbl->get_WorkspaceFolderItemName(This, WkspId, WkspFolder, itr,  \
                                               pVal))

#define IWorkspaceBrokerAx2_get_WorkspaceFolderItemFileExtension(              \
    This, WkspId, WkspFolder, itr, pVal)                                       \
  ((This)->lpVtbl->get_WorkspaceFolderItemFileExtension(                       \
      This, WkspId, WkspFolder, itr, pVal))

#define IWorkspaceBrokerAx2_get_IsWorkspaceFolderItemRemoteDesktop(            \
    This, WkspId, WkspFolder, itr, pVal)                                       \
  ((This)->lpVtbl->get_IsWorkspaceFolderItemRemoteDesktop(                     \
      This, WkspId, WkspFolder, itr, pVal))

#define IWorkspaceBrokerAx2_LaunchWorkspaceItem(                               \
    This, WkspId, WkspFolder, WkspItemName, ActivationContext)                 \
  ((This)->lpVtbl->LaunchWorkspaceItem(This, WkspId, WkspFolder, WkspItemName, \
                                       ActivationContext))
...
#define IWorkspaceBrokerAx2_get_WorkspaceDescription(This, bstrWorkspaceGUID,  \
                                                     pbstrMessage)             \
  ((This)->lpVtbl->get_WorkspaceDescription(This, bstrWorkspaceGUID,           \
                                            pbstrMessage))

#define IWorkspaceBrokerAx2_get_WorkspaceURL(This, bstrWorkspaceGUID,          \
                                             pbstrMessage)                     \
  ((This)->lpVtbl->get_WorkspaceURL(This, bstrWorkspaceGUID, pbstrMessage))

#define IWorkspaceBrokerAx2_get_WorkspaceLastUpdateDescription(                \
    This, bstrWorkspaceGUID, pbstrMessage)                                     \
  ((This)->lpVtbl->get_WorkspaceLastUpdateDescription(This, bstrWorkspaceGUID, \
                                                      pbstrMessage))

#define IWorkspaceBrokerAx2_get_IsDefaultWorkspace(This, bstrWorkspaceGUID,    \
                                                   pVal)                       \
...
typedef struct _IWorkspaceBrokerAxEventsVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in _IWorkspaceBrokerAxEvents *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in _IWorkspaceBrokerAxEvents *This);
...
#define _IWorkspaceBrokerAxEvents_AddRef(This) ((This)->lpVtbl->AddRef(This))

#define _IWorkspaceBrokerAxEvents_Release(This) ((This)->lpVtbl->Release(This))
...
#define _IWorkspaceBrokerAxEvents_GetIDsOfNames(This, riid, rgszNames, cNames, \
                                                lcid, rgDispId)                \
  ((This)->lpVtbl->GetIDsOfNames(This, riid, rgszNames, cNames, lcid, rgDispId))

#define _IWorkspaceBrokerAxEvents_Invoke(This, dispIdMember, riid, lcid,       \
...
class DECLSPEC_UUID("CD70A734-B6DB-4588-9813-FF2E37A4661F") WorkspaceBrokerAx;
#endif
