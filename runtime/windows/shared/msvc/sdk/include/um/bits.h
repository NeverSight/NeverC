...
typedef struct IBackgroundCopyFileVtbl {
  ...
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IBackgroundCopyFile *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IBackgroundCopyFile *This);
...
typedef struct IEnumBackgroundCopyFilesVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IEnumBackgroundCopyFiles *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IEnumBackgroundCopyFiles *This);
  ...
  HRESULT(STDMETHODCALLTYPE *Skip)(__RPC__in IEnumBackgroundCopyFiles *This,
                                   /* [in] */ ULONG celt);

  DECLSPEC_XFGVIRT(IEnumBackgroundCopyFiles, Reset)
  HRESULT(STDMETHODCALLTYPE *Reset)(__RPC__in IEnumBackgroundCopyFiles *This);
  ...
  HRESULT(STDMETHODCALLTYPE *GetCount)(__RPC__in IEnumBackgroundCopyFiles *This,
...
typedef struct IBackgroundCopyErrorVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IBackgroundCopyError *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IBackgroundCopyError *This);
...
public:
  virtual HRESULT STDMETHODCALLTYPE AddFileSet(
      /* [in] */ ULONG cFileCount,
      /* [size_is][in] */ __RPC__in_ecount_full(cFileCount) BG_FILE_INFO *
          pFileSet) = 0;
  ...
  virtual HRESULT STDMETHODCALLTYPE SetProxySettings(
      ...
      /* [unique][string][in] */
      __RPC__in_opt_string const WCHAR *ProxyBypassList) = 0;
...
typedef struct IBackgroundCopyJobVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in IBackgroundCopyJob *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IBackgroundCopyJob *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IBackgroundCopyJob *This);

  DECLSPEC_XFGVIRT(IBackgroundCopyJob, AddFileSet)
  HRESULT(STDMETHODCALLTYPE *AddFileSet)(__RPC__in IBackgroundCopyJob *This,
                                         /* [in] */ ULONG cFileCount,
                                         /* [size_is][in] */
  ...
  HRESULT(STDMETHODCALLTYPE *AddFile)(__RPC__in IBackgroundCopyJob *This,
                                      /* [in] */ __RPC__in LPCWSTR RemoteUrl,
  ...
  HRESULT(STDMETHODCALLTYPE *Suspend)(__RPC__in IBackgroundCopyJob *This);

  DECLSPEC_XFGVIRT(IBackgroundCopyJob, Resume)
  HRESULT(STDMETHODCALLTYPE *Resume)(__RPC__in IBackgroundCopyJob *This);

  DECLSPEC_XFGVIRT(IBackgroundCopyJob, Cancel)
  HRESULT(STDMETHODCALLTYPE *Cancel)(__RPC__in IBackgroundCopyJob *This);

  DECLSPEC_XFGVIRT(IBackgroundCopyJob, Complete)
  HRESULT(STDMETHODCALLTYPE *Complete)(__RPC__in IBackgroundCopyJob *This);

  DECLSPEC_XFGVIRT(IBackgroundCopyJob, GetId)
  HRESULT(STDMETHODCALLTYPE *GetId)(__RPC__in IBackgroundCopyJob *This,
                                    /* [out] */ __RPC__out GUID *pVal);

  DECLSPEC_XFGVIRT(IBackgroundCopyJob, GetType)
  HRESULT(STDMETHODCALLTYPE *GetType)(__RPC__in IBackgroundCopyJob *This,
  ...
  HRESULT(STDMETHODCALLTYPE *SetDisplayName)(__RPC__in IBackgroundCopyJob *This,
  ...
  HRESULT(STDMETHODCALLTYPE *SetDescription)(__RPC__in IBackgroundCopyJob *This,
                                             /* [in] */ __RPC__in LPCWSTR Val);
  ...
  HRESULT(STDMETHODCALLTYPE *SetPriority)(__RPC__in IBackgroundCopyJob *This,
  ...
  HRESULT(STDMETHODCALLTYPE *SetNotifyFlags)(__RPC__in IBackgroundCopyJob *This,
                                             /* [in] */ ULONG Val);
  ...
  HRESULT(STDMETHODCALLTYPE *TakeOwnership)(__RPC__in IBackgroundCopyJob *This);
...
typedef struct IEnumBackgroundCopyJobsVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IEnumBackgroundCopyJobs *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IEnumBackgroundCopyJobs *This);
  ...
  HRESULT(STDMETHODCALLTYPE *Skip)(__RPC__in IEnumBackgroundCopyJobs *This,
                                   /* [in] */ ULONG celt);

  DECLSPEC_XFGVIRT(IEnumBackgroundCopyJobs, Reset)
  HRESULT(STDMETHODCALLTYPE *Reset)(__RPC__in IEnumBackgroundCopyJobs *This);
  ...
  HRESULT(STDMETHODCALLTYPE *GetCount)(__RPC__in IEnumBackgroundCopyJobs *This,
                                       /* [out] */ __RPC__out ULONG *puCount);
...
typedef struct IBackgroundCopyCallbackVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IBackgroundCopyCallback *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IBackgroundCopyCallback *This);
...
#define AsyncIBackgroundCopyCallback_Begin_JobModification(This, pJob,         \
                                                           dwReserved)         \
...
typedef struct IBackgroundCopyManagerVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IBackgroundCopyManager *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IBackgroundCopyManager *This);
