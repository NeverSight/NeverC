...
#define E_DRM_INSUFFICIENT_BUFFER                                              \
...
#define E_DRM_INVALID_LICENSE_SIGNATURE                                        \
  MSDRM_MAKE_ERROR(MSDRM_CLIENT_ZONE, 0x02)
...
#define E_DRM_TOO_MANY_LOADED_ENVIRONMENTS                                     \
  MSDRM_MAKE_ERROR(MSDRM_CLIENT_ZONE, 0x0C)
...
#define E_DRM_ENABLING_PRINCIPAL_FAILURE                                       \
  MSDRM_MAKE_ERROR(MSDRM_CLIENT_ZONE, 0x10)
...
#define E_DRM_CRYPTO_OPERATION_UNSUPPORTED                                     \
  MSDRM_MAKE_ERROR(MSDRM_CLIENT_ZONE, 0x14)
...
#define E_DRM_BIND_VALIDITY_TIME_VIOLATED                                      \
  MSDRM_MAKE_ERROR(MSDRM_CLIENT_ZONE, 0x18)
...
#define E_DRM_MANIFEST_POLICY_VIOLATION                                        \
  MSDRM_MAKE_ERROR(MSDRM_POLICY_ZONE, 0x000C)
...
#define E_DRM_BIND_ACCESS_PRINCIPAL_NOT_ENABLING                               \
  MSDRM_MAKE_ERROR(MSDRM_CLIENT_ZONE, 0x22)
...
#define E_DRM_BIND_INDICATED_PRINCIPAL_MISSING                                 \
  MSDRM_MAKE_ERROR(MSDRM_CLIENT_ZONE, 0x24)

//      E_DRM_BIND_MACHINE_NOT_FOUND_IN_GROUP_IDENTITY 0x8004CF25
#define E_DRM_BIND_MACHINE_NOT_FOUND_IN_GROUP_IDENTITY                         \
  MSDRM_MAKE_ERROR(MSDRM_CLIENT_ZONE, 0x25)
...
#define E_DRM_BIND_REVOCATION_LIST_STALE                                       \
  MSDRM_MAKE_ERROR(MSDRM_CLIENT_ZONE, 0x27)

//      E_DRM_BIND_NO_APPLICABLE_REVOCATION_LIST  0x8004CF28
#define E_DRM_BIND_NO_APPLICABLE_REVOCATION_LIST                               \
  MSDRM_MAKE_ERROR(MSDRM_CLIENT_ZONE, 0x28)
...
#define E_DRM_BIND_INTERVALTIME_VIOLATED                                       \
  MSDRM_MAKE_ERROR(MSDRM_CLIENT_ZONE, 0x2F)

//      E_DRM_BIND_NO_SATISFIED_RIGHTS_GROUP      0x8004CF30
#define E_DRM_BIND_NO_SATISFIED_RIGHTS_GROUP                                   \
  MSDRM_MAKE_ERROR(MSDRM_CLIENT_ZONE, 0x30)

//      E_DRM_BIND_SPECIFIED_WORK_MISSING         0x8004CF31
#define E_DRM_BIND_SPECIFIED_WORK_MISSING                                      \
  MSDRM_MAKE_ERROR(MSDRM_CLIENT_ZONE, 0x31)
...
#define E_DRM_NEEDS_GROUPIDENTITY_ACTIVATION                                   \
  MSDRM_MAKE_ERROR(MSDRM_CLIENT_ZONE, 0x3E)
...
#define E_DRM_INVALID_ISSUANCELICENSE_TEMPLATE                                 \
  MSDRM_MAKE_ERROR(MSDRM_CLIENT_ZONE, 0x54)
...
#define E_DRM_EXPIRED_OFFICIAL_ISSUANCELICENSE_TEMPLATE                        \
  MSDRM_MAKE_ERROR(MSDRM_CLIENT_ZONE, 0x57)

//      E_DRM_INVALID_CLIENT_LICENSOR_CERTIFICATE           0x8004CF58
#define E_DRM_INVALID_CLIENT_LICENSOR_CERTIFICATE                              \
  MSDRM_MAKE_ERROR(MSDRM_CLIENT_ZONE, 0x58)
...
#define E_DRM_GLOBAL_OPTION_ALREADY_SET                                        \
  MSDRM_MAKE_ERROR(MSDRM_CLIENT_ZONE, 0x74)
...
#define E_DRM_WINDOW_REGISTRATION_FAILED                                       \
  MSDRM_MAKE_ERROR(MSDRM_CLIENT_ZONE, 0x77)
...
#define E_DRM_PLATFORM_POLICY_VIOLATION                                        \
  MSDRM_MAKE_ERROR(MSDRM_CLIENT_ZONE, 0x79)

//      E_DRM_TEMPLATE_ACQUISITION_FAILED         0x8004CF80
#define E_DRM_TEMPLATE_ACQUISITION_FAILED                                      \
  MSDRM_MAKE_ERROR(MSDRM_CLIENT_ZONE, 0x80)

//      E_DRM_ISSUANCELICENSE_LENGTH_LIMIT_EXCEEDED         0x8004CF81
#define E_DRM_ISSUANCELICENSE_LENGTH_LIMIT_EXCEEDED                            \
  MSDRM_MAKE_ERROR(MSDRM_CLIENT_ZONE, 0x81)
