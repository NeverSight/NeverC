...
public:
  ...
  virtual void STDMETHODCALLTYPE VSSetConstantBuffers1(
      ...
      _In_range_(0, D3D11_COMMONSHADER_CONSTANT_BUFFER_API_SLOT_COUNT - 1)
          UINT StartSlot,
      /* [annotation] */
      _In_range_(0, D3D11_COMMONSHADER_CONSTANT_BUFFER_API_SLOT_COUNT -
...
typedef struct ID3D11DeviceContext1Vtbl {
  ...
  DECLSPEC_XFGVIRT(ID3D11DeviceContext,
  ...
  void(STDMETHODCALLTYPE *OMGetRenderTargets)(
      ...
      /* [annotation] */
      _Outptr_opt_result_maybenull_ ID3D11DepthStencilView *
          *ppDepthStencilView);
  ...
  void(STDMETHODCALLTYPE *OMGetDepthStencilState)(
      ID3D11DeviceContext1 *This,
      /* [annotation] */
      _Outptr_opt_result_maybenull_ ID3D11DepthStencilState *
          *ppDepthStencilState,
      /* [annotation] */
...
#define ID3D11VideoContext1_GetDecoderBuffer(This, pDecoder, Type,             \
...
#define ID3D11VideoContext1_DecoderBeginFrame(This, pDecoder, pView,           \
...
#define ID3D11VideoContext1_SubmitDecoderBuffers(This, pDecoder, NumBuffers,   \
                                                 pBufferDesc)                  \
...
#define ID3D11VideoContext1_VideoProcessorSetOutputTargetRect(                 \
...
#define ID3D11VideoContext1_VideoProcessorSetOutputColorSpace(                 \
...
#define ID3D11VideoContext1_VideoProcessorSetOutputStereoMode(                 \
...
#define ID3D11VideoContext1_VideoProcessorGetOutputTargetRect(                 \
...
#define ID3D11VideoContext1_VideoProcessorGetOutputColorSpace(                 \
    This, pVideoProcessor, pColorSpace)                                        \
...
#define ID3D11VideoContext1_VideoProcessorGetOutputStereoMode(                 \
...
#define ID3D11VideoContext1_GetEncryptionBltKey(This, pCryptoSession, KeySize, \
                                                pReadbackKey)                  \
...
#define ID3D11VideoContext1_SubmitDecoderBuffers1(This, pDecoder, NumBuffers,  \
                                                  pBufferDesc)                 \
...
#define ID3D11VideoContext1_CheckCryptoSessionStatus(This, pCryptoSession,     \
                                                     pStatus)                  \
...
#define ID3D11VideoContext1_DecoderUpdateDownsampling(This, pDecoder,          \
                                                      pOutputDesc)             \
...
typedef struct ID3D11VideoProcessorEnumerator1Vtbl {
  ...
  DECLSPEC_XFGVIRT(ID3D11VideoProcessorEnumerator,
  ...
  DECLSPEC_XFGVIRT(ID3D11VideoProcessorEnumerator1,
...
#define ID3D11VideoProcessorEnumerator1_CheckVideoProcessorFormatConversion(   \
    This, InputFormat, InputColorSpace, OutputFormat, OutputColorSpace,        \
    pSupported)                                                                \
...
typedef struct ID3D11Device1Vtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(ID3D11Device1 *This,
                                             /* [in] */ REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);
