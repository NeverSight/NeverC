...
Abstract:
    ...
    This include file defines the vdm context structure so we can inspect it
from 64-bit
...
#define VDMCONTEXT_CONTROL                                                     \
  (VDMCONTEXT_i386 | 0x00000001L) // SS:SP, CS:IP, FLAGS, BP
#define VDMCONTEXT_INTEGER                                                     \
  (VDMCONTEXT_i386 | 0x00000002L) // AX, BX, CX, DX, SI, DI
...
#define VDMCONTEXT_EXTENDED_REGISTERS                                          \
  (VDMCONTEXT_i386 | 0x00000020L) // cpu specific extensions
