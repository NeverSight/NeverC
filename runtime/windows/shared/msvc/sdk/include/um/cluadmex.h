...
typedef struct IGetClusterUIInfoVtbl {
  ...
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in IGetClusterUIInfo *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IGetClusterUIInfo *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IGetClusterUIInfo *This);
  ...
  /* [local] */ LCID(STDMETHODCALLTYPE *GetLocale)(IGetClusterUIInfo *This);

  DECLSPEC_XFGVIRT(IGetClusterUIInfo, GetFont)
  /* [local] */ HFONT(STDMETHODCALLTYPE *GetFont)(IGetClusterUIInfo *This);

  DECLSPEC_XFGVIRT(IGetClusterUIInfo, GetIcon)
  /* [local] */ HICON(STDMETHODCALLTYPE *GetIcon)(IGetClusterUIInfo *This);
...
typedef struct IGetClusterDataInfoVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IGetClusterDataInfo *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IGetClusterDataInfo *This);
...
typedef struct IGetClusterObjectInfoVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IGetClusterObjectInfo *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IGetClusterObjectInfo *This);
...
typedef struct IGetClusterNodeInfoVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IGetClusterNodeInfo *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IGetClusterNodeInfo *This);
...
typedef struct IGetClusterGroupInfoVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IGetClusterGroupInfo *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IGetClusterGroupInfo *This);
...
typedef struct IGetClusterResourceInfoVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IGetClusterResourceInfo *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IGetClusterResourceInfo *This);
...
typedef struct IGetClusterNetworkInfoVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IGetClusterNetworkInfo *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IGetClusterNetworkInfo *This);
...
typedef struct IGetClusterNetInterfaceInfoVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IGetClusterNetInterfaceInfo *This);
...
typedef struct IWCPropertySheetCallbackVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IWCPropertySheetCallback *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IWCPropertySheetCallback *This);
...
typedef struct IWEExtendPropertySheetVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IWEExtendPropertySheet *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IWEExtendPropertySheet *This);
...
typedef struct IWCWizardCallbackVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in IWCWizardCallback *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IWCWizardCallback *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IWCWizardCallback *This);

  DECLSPEC_XFGVIRT(IWCWizardCallback, AddWizardPage)
  HRESULT(STDMETHODCALLTYPE *AddWizardPage)(__RPC__in IWCWizardCallback *This,
                                            /* [in] */ __RPC__in LONG *hpage);

  DECLSPEC_XFGVIRT(IWCWizardCallback, EnableNext)
  HRESULT(STDMETHODCALLTYPE *EnableNext)(__RPC__in IWCWizardCallback *This,
                                         /* [in] */ __RPC__in LONG *hpage,
                                         /* [in] */ BOOL bEnable);
...
typedef struct IWEExtendWizardVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in IWEExtendWizard *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IWEExtendWizard *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IWEExtendWizard *This);
...
interface IWEExtendWizard { CONST_VTBL struct IWEExtendWizardVtbl *lpVtbl; };
...
typedef struct IWCContextMenuCallbackVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IWCContextMenuCallback *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IWCContextMenuCallback *This);
...
typedef struct IWEExtendContextMenuVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IWEExtendContextMenu *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IWEExtendContextMenu *This);
...
typedef struct IWEInvokeCommandVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in IWEInvokeCommand *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IWEInvokeCommand *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IWEInvokeCommand *This);
...
interface IWEInvokeCommand { CONST_VTBL struct IWEInvokeCommandVtbl *lpVtbl; };
...
typedef struct IWCWizard97CallbackVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IWCWizard97Callback *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IWCWizard97Callback *This);
  ...
  HRESULT(STDMETHODCALLTYPE *EnableNext)(__RPC__in IWCWizard97Callback *This,
                                         /* [in] */ __RPC__in LONG *hpage,
                                         /* [in] */ BOOL bEnable);
...
typedef struct IWEExtendWizard97Vtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in IWEExtendWizard97 *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IWEExtendWizard97 *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IWEExtendWizard97 *This);
