...
// If this is a WAN router interface with static routes, use IPX_NO_UPDATE as
// default. If you want to trigger an update on this interface and to keep the
// data as static data, use IPX_AUTO_STATIC value. IPX_AUTO_STATIC update can be
// set only on a WAN interface
//
...
// use IPX_RELIABLE_DELIVERY_PACKET_TYPE (this can be set only in combination
// with IPX_AUTO_STATIC_UPDATE in the UpdateMode).

// RIP Route Filter Info
//
// These filters apply to routes accepted or advertised by RIP on each
// interface.
