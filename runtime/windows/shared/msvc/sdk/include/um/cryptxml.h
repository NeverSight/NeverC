...
typedef struct _CRYPT_XML_TRANSFORM_INFO CRYPT_XML_TRANSFORM_INFO,
...
typedef struct _CRYPT_XML_REFERENCES CRYPT_XML_REFERENCES,
    *PCRYPT_XML_REFERENCES;
typedef struct _CRYPT_XML_SIGNED_INFO CRYPT_XML_SIGNED_INFO,
...
typedef struct _CRYPT_XML_ALGORITHM_INFO CRYPT_XML_ALGORITHM_INFO,
...
#define wszXMLNS_DIGSIG_SignatureProperties                                    \
  L"http://www.w3.org/2000/09/xmldsig#SignatureProperties"
...
#define wszURI_XMLNS_DIGSIG_SHA384                                             \
  L"http://www.w3.org/2001/04/xmldsig-more#sha384"
#define wszURI_XMLNS_DIGSIG_SHA512 L"http://www.w3.org/2001/04/xmlenc#sha512"

#define wszURI_XMLNS_DIGSIG_RSA_SHA1                                           \
  L"http://www.w3.org/2000/09/xmldsig#rsa-sha1"
#define wszURI_XMLNS_DIGSIG_DSA_SHA1                                           \
  L"http://www.w3.org/2000/09/xmldsig#dsa-sha1"

#define wszURI_XMLNS_DIGSIG_RSA_SHA256                                         \
  L"http://www.w3.org/2001/04/xmldsig-more#rsa-sha256"
#define wszURI_XMLNS_DIGSIG_RSA_SHA384                                         \
  L"http://www.w3.org/2001/04/xmldsig-more#rsa-sha384"
#define wszURI_XMLNS_DIGSIG_RSA_SHA512                                         \
  L"http://www.w3.org/2001/04/xmldsig-more#rsa-sha512"

#define wszURI_XMLNS_DIGSIG_ECDSA_SHA1                                         \
  L"http://www.w3.org/2001/04/xmldsig-more#ecdsa-sha1"
#define wszURI_XMLNS_DIGSIG_ECDSA_SHA256                                       \
  L"http://www.w3.org/2001/04/xmldsig-more#ecdsa-sha256"
#define wszURI_XMLNS_DIGSIG_ECDSA_SHA384                                       \
  L"http://www.w3.org/2001/04/xmldsig-more#ecdsa-sha384"
#define wszURI_XMLNS_DIGSIG_ECDSA_SHA512                                       \
  L"http://www.w3.org/2001/04/xmldsig-more#ecdsa-sha512"

#define wszURI_XMLNS_DIGSIG_HMAC_SHA1                                          \
  L"http://www.w3.org/2000/09/xmldsig#hmac-sha1"
#define wszURI_XMLNS_DIGSIG_HMAC_SHA256                                        \
  L"http://www.w3.org/2001/04/xmldsig-more#hmac-sha256"
#define wszURI_XMLNS_DIGSIG_HMAC_SHA384                                        \
  L"http://www.w3.org/2001/04/xmldsig-more#hmac-sha384"
#define wszURI_XMLNS_DIGSIG_HMAC_SHA512                                        \
  L"http://www.w3.org/2001/04/xmldsig-more#hmac-sha512"

#define wszURI_CANONICALIZATION_C14N                                           \
  L"http://www.w3.org/TR/2001/REC-xml-c14n-20010315"
#define wszURI_CANONICALIZATION_C14NC                                          \
  L"http://www.w3.org/TR/2001/REC-xml-c14n-20010315#WithComments"
#define wszURI_CANONICALIZATION_EXSLUSIVE_C14N                                 \
  L"http://www.w3.org/2001/10/xml-exc-c14n#"
#define wszURI_CANONICALIZATION_EXSLUSIVE_C14NC                                \
  L"http://www.w3.org/2001/10/xml-exc-c14n#WithComments"

#define wszURI_TRANSFORM_XPATH L"http://www.w3.org/TR/1999/REC-xpath-19991116"
#define wszURI_XMLNS_TRANSFORM_BASE64                                          \
  L"http://www.w3.org/2000/09/xmldsig#base64"
#define wszURI_XMLNS_TRANSFORM_ENVELOPED                                       \
  L"http://www.w3.org/2000/09/xmldsig#enveloped-signature"
...
// CryptXmlOpenToEncode
// When this flag is set, ECKeyValue schema defined in XML Signature Syntax and
// Processing Version 1.1 is used to encode the ECC signing key.  Otherwise, ECC
// key value uses the schema defined in RFC4050.
...
typedef struct _CRYPT_XML_BLOB {
  ...
  _Field_range_(0, CRYPT_XML_BLOB_MAX) ULONG cbData;
  _Field_size_(cbData) BYTE *pbData;
...
typedef enum {
  ...
  CRYPT_XML_PROPERTY_XML_OUTPUT_CHARSET =
      5, // CRYPT_XML_CHARSET, sizeof(CRYPT_XML_CHARSET)
} CRYPT_XML_PROPERTY_ID;

typedef struct _CRYPT_XML_PROPERTY {
  CRYPT_XML_PROPERTY_ID dwPropId;
  _Field_size_bytes_(cbValue) const void *pvValue;
  ULONG cbValue;
...
****************************************************************************/
typedef _Success_(return == 0) HRESULT(CALLBACK *PFN_CRYPT_XML_WRITE_CALLBACK)(
    _Inout_ void *pvCallbackState, _In_reads_bytes_(cbData) const BYTE *pbData,
    ULONG cbData);
...
typedef _Success_(return == 0)
    HRESULT(CALLBACK *PFN_CRYPT_XML_DATA_PROVIDER_READ)(
        ...
        _Out_writes_bytes_to_(cbData, *pcbRead) BYTE *pbData, _In_ ULONG cbData,
        _Out_range_(0, cbData) ULONG *pcbRead);
...
****************************************************************************/
typedef _Success_(return == 0) HRESULT(
    CALLBACK *PFN_CRYPT_XML_DATA_PROVIDER_CLOSE)(_Inout_ void *pvCallbackState);
...
/****************************************************************************
 ...
 cbBufferSize
    ...
    that can be 0 if the size does not matter or can't be determined by the
provider. This value is used by a caller of pfnRead to determine a size of the
receiving buffer.
...
/****************************************************************************
 ...
 NOTE: In the transform chain, the output of the trasnform is the input of the
next one.
...
type="ds:CanonicalizationMethodType"/> <complexType
name="CanonicalizationMethodType" mixed="true"> <sequence> <any
...
type="ds:HMACOutputLengthType"/> <any namespace="##other" minOccurs="0"
maxOccurs="unbounded"/>
...
/****************************************************************************
 ...
 cbBufferSize
    ...
    This value can be 0 if the size can't be determined at the initialization
time.
...
typedef struct _CRYPT_XML_TRANSFORM_CHAIN_CONFIG {
  ...
  _Field_size_(cTransformInfo) PCRYPT_XML_TRANSFORM_INFO *rgpTransformInfo;
...
typedef struct _CRYPT_XML_X509DATA {
  UINT cX509Data;
  _Field_size_(cX509Data) CRYPT_XML_X509DATA_ITEM *rgX509Data;
} CRYPT_XML_X509DATA;
...
typedef struct _CRYPT_XML_KEY_INFO {
  ...
  LPCWSTR wszId;
  UINT cKeyInfo;
  _Field_size_(cKeyInfo) CRYPT_XML_KEY_INFO_ITEM *rgKeyInfo;
  BCRYPT_KEY_HANDLE
  hVerifyKey; // <= A handle, resolved from the first KeyValue, if any
...
typedef struct _CRYPT_XML_REFERENCE {
  ...
  ULONG cTransform;
  _Field_size_(cTransform) CRYPT_XML_ALGORITHM *rgTransform;
...
typedef struct _CRYPT_XML_REFERENCES {
  ULONG cReference;
  _Field_size_(cReference) PCRYPT_XML_REFERENCE *rgpReference;
...
/****************************************************************************
 ...
 SignedInfo
    The structure of CRYPT_XML_SIGNED_INFO includes the canonicalization
algorithm, a signature algorithm, and one or more references. The SignedInfo
element may contain an optional ID attribute that will allow it to be referenced
by other signatures and objects.

SignatureValue
    CRYPT_DATA_BLOB that contains a cryptographic signature value over the
<SignedInfo> element.
...
typedef struct _CRYPT_XML_SIGNATURE {
  ...
  ULONG cObject;
  _Field_size_(cObject) PCRYPT_XML_OBJECT *rgpObject; // OPTIONAL
...
typedef struct _CRYPT_XML_DOC_CTXT {
  ...
  ULONG cSignature;
  _Field_size_(cSignature) PCRYPT_XML_SIGNATURE *rgpSignature;
...
****************************************************************************/
_Success_(return == 0) HRESULT WINAPI CryptXmlClose(_In_ HCRYPTXML hCryptXml);
...
****************************************************************************/
_Success_(return == 0) HRESULT WINAPI CryptXmlGetTransforms(
...
CRYPT_XML_FLAG_ENFORCE_ID_NAME_FORMAT
 ...
 wszId
    ...
    If this parameter is NULL or an empty string, then no Id attribute will be
produced.
...
****************************************************************************/
_Success_(return == 0) HRESULT WINAPI CryptXmlOpenToEncode(
    _In_opt_ const CRYPT_XML_TRANSFORM_CHAIN_CONFIG *pConfig, DWORD dwFlags,
    _In_opt_ LPCWSTR wszId,
    _In_reads_opt_(cProperty) const CRYPT_XML_PROPERTY *rgProperty,
    _In_ ULONG cProperty, _In_opt_ const CRYPT_XML_BLOB *pEncoded,
...
****************************************************************************/
_Success_(return == 0) HRESULT WINAPI CryptXmlOpenToDecode(
    _In_opt_ const CRYPT_XML_TRANSFORM_CHAIN_CONFIG *pConfig, DWORD dwFlags,
    _In_reads_opt_(cProperty) const CRYPT_XML_PROPERTY *rgProperty,
    _In_ ULONG cProperty, _In_ const CRYPT_XML_BLOB *pEncoded,
...
/****************************************************************************
 ...
 rgProperty
    [in, optional] Specifies additional properties used to decode the <Object>
element.
 ...
 ppObject
    ...
    This parameter must be NULL when hSignatureOrObject is a handle to the
Object.

 REMARKS:
    When the hSignatureOrObject specifies a handle to a Reference returned
    by CryptXmlCreateReference, then pEncoded specifies XML content to be
included inside the <Object> node after the optional <Manifest> element. The
pEncoded pointer must be valid till the signature is complete. Otherwise, use
CRYPT_XML_FLAG_ADD_OBJECT_CREATE_COPY flag to create in-memory copy.

****************************************************************************/
_Success_(return == 0) HRESULT WINAPI CryptXmlAddObject(
    _In_ HCRYPTXML hSignatureOrObject, DWORD dwFlags,
    _In_reads_opt_(cProperty) const CRYPT_XML_PROPERTY *rgProperty,
    _In_ ULONG cProperty, _In_ const CRYPT_XML_BLOB *pEncoded,
...
****************************************************************************/
_Success_(return == 0) HRESULT WINAPI CryptXmlCreateReference(
    _In_ HCRYPTXML hCryptXml, DWORD dwFlags, _In_opt_ LPCWSTR wszId,
    _In_opt_ LPCWSTR wszURI, _In_opt_ LPCWSTR wszType,
    _In_ const CRYPT_XML_ALGORITHM *pDigestMethod, ULONG cTransform,
    _In_reads_opt_(cTransform) const CRYPT_XML_ALGORITHM *rgTransform,
...
****************************************************************************/
_Success_(return == 0) HRESULT WINAPI
    CryptXmlDigestReference(_In_ HCRYPTXML hReference, DWORD dwFlags,
...
****************************************************************************/
_Success_(return == 0) HRESULT WINAPI
    CryptXmlSetHMACSecret(_In_ HCRYPTXML hSignature,
                          _In_reads_bytes_(cbSecret) const BYTE *pbSecret,
                          ULONG cbSecret);
...
typedef struct _CRYPT_XML_KEYINFO_PARAM {
  ...
  LPCWSTR wszSubjectName;
  ULONG cCertificate;
  _Field_size_(cCertificate) CERT_BLOB *rgCertificate;
  ULONG cCRL;
  _Field_size_(cCRL) CERT_BLOB *rgCRL;
...
****************************************************************************/
_Success_(return == 0) HRESULT WINAPI
    CryptXmlSign(_In_ HCRYPTXML hSignature,
                 _In_opt_ HCRYPTPROV_OR_NCRYPT_KEY_HANDLE hKey, DWORD dwKeySpec,
...
****************************************************************************/
_Success_(return == 0) HRESULT WINAPI
    CryptXmlImportPublicKey(DWORD dwFlags,
...
****************************************************************************/
_Success_(return == 0) HRESULT WINAPI
    CryptXmlVerifySignature(_In_ HCRYPTXML hSignature,
                            _In_opt_ BCRYPT_KEY_HANDLE hKey, DWORD dwFlags);
...
****************************************************************************/
_Success_(return == 0) HRESULT WINAPI
    CryptXmlGetDocContext(_In_ HCRYPTXML hCryptXml,
...
****************************************************************************/
_Success_(return == 0) HRESULT WINAPI
    CryptXmlGetSignature(_In_ HCRYPTXML hCryptXml,
...
****************************************************************************/
_Success_(return == 0) HRESULT WINAPI
    CryptXmlGetReference(_In_ HCRYPTXML hCryptXml,
...
****************************************************************************/
_Success_(return == 0) HRESULT WINAPI
    CryptXmlGetStatus(_In_ HCRYPTXML hCryptXml,
...
****************************************************************************/
_Success_(return == 0) HRESULT WINAPI
    CryptXmlEncode(_In_ HCRYPTXML hCryptXml, CRYPT_XML_CHARSET dwCharset,
                   _In_reads_opt_(cProperty)
                       const CRYPT_XML_PROPERTY *rgProperty,
                   _In_ ULONG cProperty, _Inout_ void *pvCallbackState,
...
/****************************************************************************
 CRYPT_XML_ALGORITHM_INFO
    ...
    wszAlgorithmURI
        The URI associated with attribute of the SignatureMethod or DigestMethod
elements
    ...
    wszCNGExtraAlgid
        An extra algorithm string, other than the string in the pwszCNGAlgid
member, that can be passed to the CNG functions.
...
NOTE: the BCrypt* and NCrypt* functions that are defined in Bcrypt.h and
Ncrypt.h
...
****************************************************************************/
_Success_(return == 0) HRESULT WINAPI
    CryptXmlGetAlgorithmInfo(_In_ const CRYPT_XML_ALGORITHM *pXmlAlgorithm,
                             DWORD dwFlags,
...
wszAlgorithmURI CRYPT_XML_ALGORITHM_INFO_FIND_BY_NAME           - wszName
...
****************************************************************************/
const CRYPT_XML_ALGORITHM_INFO *WINAPI
CryptXmlFindAlgorithmInfo(_In_ DWORD dwFindByType, _In_ const void *pvFindBy,
                          _In_ DWORD dwGroupId, DWORD dwFlags);
...
/****************************************************************************
 ...
 an application provided callback function, pfnEnumAlgInfo, is called.
    ...
    pvArg
        [in, optional] Specifies an application defined parameter for the
callback.
...
typedef BOOL(WINAPI *PFN_CRYPT_XML_ENUM_ALG_INFO)(
    _In_ const CRYPT_XML_ALGORITHM_INFO *pInfo, _Inout_opt_ void *pvArg);

_Success_(return == 0) HRESULT WINAPI CryptXmlEnumAlgorithmInfo(
    _In_ DWORD dwGroupId, _In_ DWORD dwFlags, _Inout_opt_ void *pvArg,
...
****************************************************************************/
typedef _Success_(return == 0) HRESULT(WINAPI *CryptXmlDllGetInterface)(
    DWORD dwFlags, _In_ const CRYPT_XML_ALGORITHM_INFO *pMethod,
...
/****************************************************************************
 CryptXmlDllEncodeAlgorithm
    ...
    dwCharset
        A CRYPT_XML_CHARSET value that specifies the character set of the
encoded XML.
...
****************************************************************************/
typedef _Success_(return == 0) HRESULT(WINAPI *CryptXmlDllEncodeAlgorithm)(
    _In_ const CRYPT_XML_ALGORITHM_INFO *pAlgInfo, CRYPT_XML_CHARSET dwCharset,
    _Inout_ void *pvCallbackState, _In_ PFN_CRYPT_XML_WRITE_CALLBACK pfnWrite);
...
typedef _Success_(return == 0) HRESULT(WINAPI *CryptXmlDllCreateDigest)(
    _In_ const CRYPT_XML_ALGORITHM *pDigestMethod,
    _Out_range_(0, CRYPT_XML_DIGEST_VALUE_MAX) ULONG *pcbSize,
...
****************************************************************************/
typedef _Success_(return == 0)
    HRESULT(WINAPI *CryptXmlDllDigestData)(_In_ CRYPT_XML_DIGEST hDigest,
...
****************************************************************************/
typedef _Success_(return == 0)
    HRESULT(WINAPI *CryptXmlDllFinalizeDigest)(_In_ CRYPT_XML_DIGEST hDigest,
...
****************************************************************************/
typedef _Success_(return == 0)
    HRESULT(WINAPI *CryptXmlDllCloseDigest)(_In_ CRYPT_XML_DIGEST hDigest);
...
/****************************************************************************
 CryptXmlDllSignData
    ...
    pSignatureMethod
        [in] A pointer to a CRYPT_XML_ALGORITHM structure that specifies the
algorithm.
    ...
    hCryptProvOrNCryptKey
        ...
        the CryptAcquireContext function or an NCRYPT_KEY_HANDLE handle that has
been created by using the NCryptOpenKey function. New applications should always
pass in the NCRYPT_KEY_HANDLE handle.
    ...
    cbInput
        [in] The size, in bytes, of the buffer pointed to by the pbInput
parameter.
    ...
    pbOutput
        ...
        ize of this buffer.
        If this parameter is NULL, this function will calculate the size needed
for the encrypted data and return the size in the location pointed to by the
pcbResult parameter.

    cbOutput
        [in] The size, in bytes, of the buffer pointed to by the pbOutput
pramater.

    pcbResult
        [out] A pointer to a DWORD variable that receives the number of bytes
copied to the pbOutput buffer. If pbOutput is NULL, this receives the size, in
bytes, required for the signature.


****************************************************************************/
typedef _Success_(return == 0) HRESULT(WINAPI *CryptXmlDllSignData)(
    _In_ const CRYPT_XML_ALGORITHM *pSignatureMethod,
    _In_ HCRYPTPROV_OR_NCRYPT_KEY_HANDLE hCryptProvOrNCryptKey,
    _In_ DWORD dwKeySpec, _In_reads_bytes_(cbInput) const BYTE *pbInput,
    _In_ ULONG cbInput,
    _Out_writes_bytes_to_opt_(cbOutput, *pcbResult) BYTE *pbOutput,
    _In_ ULONG cbOutput, _Out_range_(0, cbOutput) ULONG *pcbResult);
...
algorithm.
    ...
    hCryptProv
        ...
        Windows XP:  Must be a HCRYPTPROV returned by the CryptAcquireContext
function.
    ...
    cbInput
        [in] The size, in bytes, of the buffer pointed to by teh pbInput
paramter.

    pbSignature
        [in] A pointer to a buffer that contains the signature value to be
verified. The cbSignature parameter contains the size of this buffer.

    cbSignature
        [in] The size, in bytes, of the pbSignature buffer.

****************************************************************************/
typedef _Success_(return == 0) HRESULT(WINAPI *CryptXmlDllVerifySignature)(
    _In_ const CRYPT_XML_ALGORITHM *pSignatureMethod,
    _In_ BCRYPT_KEY_HANDLE hKey, _In_reads_bytes_(cbInput) const BYTE *pbInput,
    _In_ ULONG cbInput, _In_reads_bytes_(cbSignature) const BYTE *pbSignature,
...
****************************************************************************/
typedef _Success_(return == 0) HRESULT(WINAPI *CryptXmlDllGetAlgorithmInfo)(
...
****************************************************************************/
typedef _Success_(return == 0) HRESULT(WINAPI *CryptXmlDllEncodeKeyValue)(
    _In_ NCRYPT_KEY_HANDLE hKey, CRYPT_XML_CHARSET dwCharset,
    _Inout_ void *pvCallbackState, _In_ PFN_CRYPT_XML_WRITE_CALLBACK pfnWrite);
...
****************************************************************************/
typedef _Success_(return == 0)
    HRESULT(WINAPI *CryptXmlDllCreateKey)(_In_ const CRYPT_XML_BLOB *pEncoded,
                                          _Out_ BCRYPT_KEY_HANDLE *phKey);
