...
typedef struct _NTMS_ALLOCATION_INFORMATION {
  ...
  LPVOID lpReserved;
#endif
  NTMS_GUID AllocatedFrom; // original source of media (scratch pool, app pool,
                           // import etc).
...
DWORD
WINAPI
GetNtmsMediaPoolNameA(_In_ HANDLE hSession, _In_ LPNTMS_GUID lpPoolId,
                      _Out_writes_to_(*lpdwBufSize, *lpdwBufSize)
                          LPSTR lpNameBuf,
                      _Inout_ LPDWORD lpdwBufSize);

DWORD
WINAPI
GetNtmsMediaPoolNameW(_In_ HANDLE hSession, _In_ LPNTMS_GUID lpPoolId,
                      _Out_writes_to_(*lpdwBufSize, *lpdwBufSize)
                          LPWSTR lpNameBuf,
                      _Inout_ LPDWORD lpdwBufSize);
...
DWORD
WINAPI
GetNtmsUIOptionsA(_In_ HANDLE hSession, _In_ const LPNTMS_GUID lpObjectId,
                  _In_ DWORD dwType,
                  _Out_writes_to_(*lpdwBufSize, *lpdwBufSize)
...
_Success_(return == ERROR_SUCCESS) DWORD WINAPI
    GetNtmsUIOptionsW(_In_ HANDLE hSession, _In_ const LPNTMS_GUID lpObjectId,
                      _In_ DWORD dwType,
                      _Out_writes_to_(*lpdwBufSize, *lpdwBufSize)
...
DWORD
WINAPI
GetVolumesFromDriveW(_In_ LPWSTR pszDriveName,
                     _Outptr_ LPWSTR *VolumeNameBufferPtr,
                     _Outptr_ LPWSTR *DriveLetterBufferPtr);

DWORD
WINAPI
GetVolumesFromDriveA(_In_ LPSTR pszDriveName,
