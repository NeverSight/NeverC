...
typedef struct IEVRVideoStreamControlVtbl {
  ...
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(IEVRVideoStreamControl *This,
                                             /* [in] */ REFIID riid,
  ...
  HRESULT(STDMETHODCALLTYPE *SetStreamActiveState)(IEVRVideoStreamControl *This,
                                                   /* [in] */ BOOL fActive);

  DECLSPEC_XFGVIRT(IEVRVideoStreamControl, GetStreamActiveState)
  HRESULT(STDMETHODCALLTYPE *GetStreamActiveState)(IEVRVideoStreamControl *This,
                                                   /* [annotation][out] */
...
public:
  virtual HRESULT STDMETHODCALLTYPE GetAvailableVideoProcessorModes(
      ...
      /* [size_is][size_is][out] */ __RPC__deref_out_ecount_full_opt(
          *lpdwNumProcessingModes) GUID *
          *ppVideoProcessingModes) = 0;

  virtual HRESULT STDMETHODCALLTYPE GetVideoProcessorCaps(
      /* [in] */ __RPC__in LPGUID lpVideoProcessorMode,
      /* [out] */ __RPC__out DXVA2_VideoProcessorCaps *
          lpVideoProcessorCaps) = 0;
  ...
  virtual HRESULT STDMETHODCALLTYPE SetBackgroundColor(COLORREF ClrBkg) = 0;
};
...
typedef struct IMFVideoProcessorVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in IMFVideoProcessor *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IMFVideoProcessor *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IMFVideoProcessor *This);
  ...
  HRESULT(STDMETHODCALLTYPE *GetAvailableVideoProcessorModes)(
      ...
      /* [out][in] */ __RPC__inout UINT *lpdwNumProcessingModes,
      /* [size_is][size_is][out] */
      __RPC__deref_out_ecount_full_opt(*lpdwNumProcessingModes)
          GUID **ppVideoProcessingModes);
  ...
  HRESULT(STDMETHODCALLTYPE *GetProcAmpRange)(
      __RPC__in IMFVideoProcessor *This, DWORD dwProperty,
  ...
  HRESULT(STDMETHODCALLTYPE *GetProcAmpValues)(
      __RPC__in IMFVideoProcessor *This, DWORD dwFlags,
  ...
  HRESULT(STDMETHODCALLTYPE *SetBackgroundColor)(
      __RPC__in IMFVideoProcessor *This, COLORREF ClrBkg);
...
#define IMFVideoProcessor_GetAvailableVideoProcessorModes(                     \
    This, lpdwNumProcessingModes, ppVideoProcessingModes)                      \
  ((This)->lpVtbl->GetAvailableVideoProcessorModes(                            \
      This, lpdwNumProcessingModes, ppVideoProcessingModes))

#define IMFVideoProcessor_GetVideoProcessorCaps(This, lpVideoProcessorMode,    \
                                                lpVideoProcessorCaps)          \
  ((This)->lpVtbl->GetVideoProcessorCaps(This, lpVideoProcessorMode,           \
                                         lpVideoProcessorCaps))
