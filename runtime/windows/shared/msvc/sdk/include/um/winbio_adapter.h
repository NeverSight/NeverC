...
#define WINBIO_MAKE_INTERFACE_VERSION(major, minor)                            \
...
//
typedef HRESULT(WINAPI *PIBIO_SENSOR_ATTACH_FN)(
    _Inout_ PWINBIO_PIPELINE Pipeline);

typedef HRESULT(WINAPI *PIBIO_SENSOR_DETACH_FN)(
    _Inout_ PWINBIO_PIPELINE Pipeline);

// Clears out all Sensor-specific pipeline context
typedef HRESULT(WINAPI *PIBIO_SENSOR_CLEAR_CONTEXT_FN)(
    _Inout_ PWINBIO_PIPELINE Pipeline);

typedef HRESULT(WINAPI *PIBIO_SENSOR_QUERY_STATUS_FN)(
    _Inout_ PWINBIO_PIPELINE Pipeline, _Out_ PWINBIO_SENSOR_STATUS Status);

typedef HRESULT(WINAPI *PIBIO_SENSOR_RESET_FN)(
    _Inout_ PWINBIO_PIPELINE Pipeline);

typedef HRESULT(WINAPI *PIBIO_SENSOR_SET_MODE_FN)(
    _Inout_ PWINBIO_PIPELINE Pipeline, _In_ WINBIO_SENSOR_MODE Mode);

typedef HRESULT(WINAPI *PIBIO_SENSOR_SET_INDICATOR_STATUS_FN)(
    _Inout_ PWINBIO_PIPELINE Pipeline,
    _In_ WINBIO_INDICATOR_STATUS IndicatorStatus);

typedef HRESULT(WINAPI *PIBIO_SENSOR_GET_INDICATOR_STATUS_FN)(
    _Inout_ PWINBIO_PIPELINE Pipeline,
    _Out_ PWINBIO_INDICATOR_STATUS IndicatorStatus);

typedef HRESULT(WINAPI *PIBIO_SENSOR_START_CAPTURE_FN)(
    _Inout_ PWINBIO_PIPELINE Pipeline, _In_ WINBIO_BIR_PURPOSE Purpose,
    _Out_ LPOVERLAPPED *Overlapped);

typedef HRESULT(WINAPI *PIBIO_SENSOR_FINISH_CAPTURE_FN)(
    _Inout_ PWINBIO_PIPELINE Pipeline,
...
//
typedef HRESULT(WINAPI *PIBIO_SENSOR_EXPORT_SENSOR_DATA_FN)(
    _Inout_ PWINBIO_PIPELINE Pipeline, _Out_ PWINBIO_BIR *SampleBuffer,
    _Out_ PSIZE_T SampleSize);

typedef HRESULT(WINAPI *PIBIO_SENSOR_CANCEL_FN)(
    _Inout_ PWINBIO_PIPELINE Pipeline);
...
//
typedef HRESULT(WINAPI *PIBIO_SENSOR_PUSH_DATA_TO_ENGINE_FN)(
    _Inout_ PWINBIO_PIPELINE Pipeline, _In_ WINBIO_BIR_PURPOSE Purpose,
    _In_ WINBIO_BIR_DATA_FLAGS Flags, _Out_ PWINBIO_REJECT_DETAIL RejectDetail);

typedef HRESULT(WINAPI *PIBIO_SENSOR_CONTROL_UNIT_FN)(
    _Inout_ PWINBIO_PIPELINE Pipeline, _In_ ULONG ControlCode,
    _In_reads_bytes_(SendBufferSize) PUCHAR SendBuffer,
    _In_ SIZE_T SendBufferSize,
    _Out_writes_bytes_to_(ReceiveBufferSize, *ReceiveDataSize)
        PUCHAR ReceiveBuffer,
    _In_ SIZE_T ReceiveBufferSize, _Out_ PSIZE_T ReceiveDataSize,
    _Out_ PULONG OperationStatus);

typedef HRESULT(WINAPI *PIBIO_SENSOR_CONTROL_UNIT_PRIVILEGED_FN)(
    _Inout_ PWINBIO_PIPELINE Pipeline, _In_ ULONG ControlCode,
    _In_reads_bytes_(SendBufferSize) PUCHAR SendBuffer,
    _In_ SIZE_T SendBufferSize,
    _Out_writes_bytes_to_(ReceiveBufferSize, *ReceiveDataSize)
...
//
typedef HRESULT(WINAPI *PIBIO_SENSOR_NOTIFY_POWER_CHANGE_FN)(
    _Inout_ PWINBIO_PIPELINE Pipeline, _In_ ULONG PowerEventType);
#endif
...
//
typedef HRESULT(WINAPI *PIBIO_SENSOR_PIPELINE_INIT_FN)(
    _Inout_ PWINBIO_PIPELINE Pipeline);

typedef HRESULT(WINAPI *PIBIO_SENSOR_PIPELINE_CLEANUP_FN)(
    _Inout_ PWINBIO_PIPELINE Pipeline);

typedef HRESULT(WINAPI *PIBIO_SENSOR_ACTIVATE_FN)(
    _Inout_ PWINBIO_PIPELINE Pipeline);

typedef HRESULT(WINAPI *PIBIO_SENSOR_DEACTIVATE_FN)(
    _Inout_ PWINBIO_PIPELINE Pipeline);

typedef HRESULT(WINAPI *PIBIO_SENSOR_QUERY_EXTENDED_INFO_FN)(
    _Inout_ PWINBIO_PIPELINE Pipeline,
    _Out_writes_bytes_(SensorInfoSize) PWINBIO_EXTENDED_SENSOR_INFO SensorInfo,
    _In_ SIZE_T SensorInfoSize);

typedef HRESULT(WINAPI *PIBIO_SENSOR_QUERY_CALIBRATION_FORMATS_FN)(
    _Inout_ PWINBIO_PIPELINE Pipeline,
    _Out_writes_to_(FormatArraySize, *FormatCount) PWINBIO_UUID FormatArray,
    _In_ SIZE_T FormatArraySize, _Out_ PSIZE_T FormatCount);

typedef HRESULT(WINAPI *PIBIO_SENSOR_SET_CALIBRATION_FORMAT_FN)(
    _Inout_ PWINBIO_PIPELINE Pipeline, _In_ PWINBIO_UUID Format);

typedef HRESULT(WINAPI *PIBIO_SENSOR_ACCEPT_CALIBRATION_DATA_FN)(
    _Inout_ PWINBIO_PIPELINE Pipeline,
...
//
typedef HRESULT(WINAPI *PIBIO_SENSOR_ASYNC_IMPORT_RAW_BUFFER_FN)(
    _Inout_ PWINBIO_PIPELINE Pipeline,
    _In_reads_bytes_opt_(RawBufferSize) PUCHAR RawBufferAddress,
    _In_ SIZE_T RawBufferSize,
    _Outptr_result_bytebuffer_maybenull_(*ResultBufferSize)
        PUCHAR *ResultBufferAddress,
    _Out_opt_ SIZE_T *ResultBufferSize);

typedef HRESULT(WINAPI *PIBIO_SENSOR_ASYNC_IMPORT_SECURE_BUFFER_FN)(
    _Inout_ PWINBIO_PIPELINE Pipeline, _In_ GUID SecureBufferIdentifier,
...
//
typedef HRESULT(WINAPI *PIBIO_SENSOR_QUERY_PRIVATE_SENSOR_TYPE_FN)(
    _Inout_ PWINBIO_PIPELINE Pipeline,
    _Out_writes_bytes_to_(TypeInfoBufferSize, *TypeInfoDataSize)
        PUCHAR TypeInfoBufferAddress,
    _In_ SIZE_T TypeInfoBufferSize, _Out_ SIZE_T *TypeInfoDataSize);
...
//
typedef HRESULT(WINAPI *PIBIO_SENSOR_CONNECT_SECURE_FN)(
    _Inout_ PWINBIO_PIPELINE Pipeline,
    _In_ const WINBIO_SECURE_CONNECTION_PARAMS *ConnectionParams,
    _Outptr_ WINBIO_SECURE_CONNECTION_DATA **ConnectionData);

typedef HRESULT(WINAPI *PIBIO_SENSOR_START_CAPTURE_EX_FN)(
    _Inout_ PWINBIO_PIPELINE Pipeline, _In_ WINBIO_BIR_PURPOSE Purpose,
    _In_reads_bytes_opt_(NonceSize) const UCHAR *Nonce, _In_ SIZE_T NonceSize,
    _In_ WINBIO_BIR_DATA_FLAGS Flags, _Out_ OVERLAPPED **Overlapped);

typedef HRESULT(WINAPI *PIBIO_SENSOR_START_NOTIFY_WAKE_FN)(
    _Inout_ PWINBIO_PIPELINE Pipeline, _Out_ OVERLAPPED **Overlapped);

typedef HRESULT(WINAPI *PIBIO_SENSOR_FINISH_NOTIFY_WAKE_FN)(
    _Inout_ PWINBIO_PIPELINE Pipeline, _Out_ WINBIO_WAKE_REASON *Reason);
...
HRESULT
WINAPI
WbioQuerySensorInterface(_Out_ PWINBIO_SENSOR_INTERFACE *SensorInterface);

//
// Pointer to an interface-retrieval function used by the
// framework after a 'GetProcAddress' call.
//
typedef HRESULT(WINAPI *PWINBIO_QUERY_SENSOR_INTERFACE_FN)(
...
//
///////////////////////////////////////////////////////////////////////////////
inline HRESULT WbioSensorAttach(_Inout_ PWINBIO_PIPELINE Pipeline) {
...
inline HRESULT WbioSensorDetach(_Inout_ PWINBIO_PIPELINE Pipeline) {
  if (!ARGUMENT_PRESENT(Pipeline) ||
      !ARGUMENT_PRESENT(Pipeline->SensorInterface)) {
    return E_POINTER;
...
inline HRESULT WbioSensorClearContext(_Inout_ PWINBIO_PIPELINE Pipeline) {
  if (!ARGUMENT_PRESENT(Pipeline) ||
      !ARGUMENT_PRESENT(Pipeline->SensorInterface)) {
    return E_POINTER;
...
inline HRESULT WbioSensorQueryStatus(_Inout_ PWINBIO_PIPELINE Pipeline,
...
inline HRESULT WbioSensorReset(_Inout_ PWINBIO_PIPELINE Pipeline) {
  if (!ARGUMENT_PRESENT(Pipeline) ||
      !ARGUMENT_PRESENT(Pipeline->SensorInterface)) {
    return E_POINTER;
...
inline HRESULT WbioSensorSetMode(_Inout_ PWINBIO_PIPELINE Pipeline,
...
inline HRESULT WbioSensorStartCapture(_Inout_ PWINBIO_PIPELINE Pipeline,
  ...
  if (!ARGUMENT_PRESENT(Pipeline) ||
    ...
    return Pipeline->SensorInterface->StartCapture(Pipeline, Purpose,
                                                   Overlapped);
  }
}
//-----------------------------------------------------------------------------
...
inline HRESULT
WbioSensorFinishCapture(_Inout_ PWINBIO_PIPELINE Pipeline,
                        _Out_ PWINBIO_REJECT_DETAIL RejectDetail) {
  if (!ARGUMENT_PRESENT(Pipeline) ||
      !ARGUMENT_PRESENT(Pipeline->SensorInterface)) {
    return E_POINTER;
    ...
    return Pipeline->SensorInterface->FinishCapture(Pipeline, RejectDetail);
  }
}
//-----------------------------------------------------------------------------
...
// Export raw capture buffer
//
inline HRESULT WbioSensorExportSensorData(_Inout_ PWINBIO_PIPELINE Pipeline,
  ...
  if (!ARGUMENT_PRESENT(Pipeline) ||
    ...
    return Pipeline->SensorInterface->ExportSensorData(Pipeline, SampleBuffer,
                                                       SampleSize);
  }
}
//-----------------------------------------------------------------------------

inline HRESULT WbioSensorCancel(_Inout_ PWINBIO_PIPELINE Pipeline) {
  if (!ARGUMENT_PRESENT(Pipeline) ||
      !ARGUMENT_PRESENT(Pipeline->SensorInterface)) {
    return E_POINTER;
...
//
inline HRESULT
WbioSensorPushDataToEngine(_Inout_ PWINBIO_PIPELINE Pipeline,
                           _In_ WINBIO_BIR_PURPOSE Purpose,
  ...
  if (!ARGUMENT_PRESENT(Pipeline) ||
    ...
    return Pipeline->SensorInterface->PushDataToEngine(Pipeline, Purpose, Flags,
                                                       RejectDetail);
  }
}
//-----------------------------------------------------------------------------
...
inline HRESULT
WbioSensorControlUnit(_Inout_ PWINBIO_PIPELINE Pipeline, _In_ ULONG ControlCode,
                      _In_reads_bytes_(SendBufferSize) PUCHAR SendBuffer,
                      _In_ SIZE_T SendBufferSize,
                      _Out_writes_bytes_to_(ReceiveBufferSize, *ReceiveDataSize)
                          PUCHAR ReceiveBuffer,
  ...
  if (!ARGUMENT_PRESENT(Pipeline) ||
    ...
    return Pipeline->SensorInterface->ControlUnit(
        Pipeline, ControlCode, SendBuffer, SendBufferSize, ReceiveBuffer,
        ReceiveBufferSize, ReceiveDataSize, OperationStatus);
  }
}
//-----------------------------------------------------------------------------

inline HRESULT WbioSensorControlUnitPrivileged(
    _Inout_ PWINBIO_PIPELINE Pipeline, _In_ ULONG ControlCode,
    _In_reads_bytes_(SendBufferSize) PUCHAR SendBuffer,
    _In_ SIZE_T SendBufferSize,
    _Out_writes_bytes_to_(ReceiveBufferSize, *ReceiveDataSize)
  ...
  if (!ARGUMENT_PRESENT(Pipeline) ||
    ...
    return E_POINTER;
                 ...
                 Pipeline->SensorInterface->ControlUnitPrivileged)) {
    return E_NOTIMPL;
  } else {
...
inline HRESULT WbioSensorNotifyPowerChange(_Inout_ PWINBIO_PIPELINE Pipeline,
  ...
  if (!ARGUMENT_PRESENT(Pipeline) ||
    ...
    return Pipeline->SensorInterface->NotifyPowerChange(Pipeline,
                                                        PowerEventType);
  }
}
//-----------------------------------------------------------------------------
...
inline HRESULT WbioSensorPipelineInit(_Inout_ PWINBIO_PIPELINE Pipeline) {
  if (!ARGUMENT_PRESENT(Pipeline) ||
      !ARGUMENT_PRESENT(Pipeline->SensorInterface)) {
    return E_POINTER;
...
inline HRESULT WbioSensorPipelineCleanup(_Inout_ PWINBIO_PIPELINE Pipeline) {
  if (!ARGUMENT_PRESENT(Pipeline) ||
      !ARGUMENT_PRESENT(Pipeline->SensorInterface)) {
    return E_POINTER;
...
inline HRESULT WbioSensorActivate(_Inout_ PWINBIO_PIPELINE Pipeline) {
  if (!ARGUMENT_PRESENT(Pipeline) ||
      !ARGUMENT_PRESENT(Pipeline->SensorInterface)) {
    return E_POINTER;
...
inline HRESULT WbioSensorDeactivate(_Inout_ PWINBIO_PIPELINE Pipeline) {
  if (!ARGUMENT_PRESENT(Pipeline) ||
      !ARGUMENT_PRESENT(Pipeline->SensorInterface)) {
    return E_POINTER;
...
inline HRESULT
WbioSensorQueryExtendedInfo(_Inout_ PWINBIO_PIPELINE Pipeline,
                            _Out_writes_bytes_(SensorInfoSize)
                                PWINBIO_EXTENDED_SENSOR_INFO SensorInfo,
                            _In_ SIZE_T SensorInfoSize) {
  if (!ARGUMENT_PRESENT(Pipeline) ||
      !ARGUMENT_PRESENT(Pipeline->SensorInterface) ||
    ...
    return Pipeline->SensorInterface->QueryExtendedInfo(Pipeline, SensorInfo,
                                                        SensorInfoSize);
  }
}
//-----------------------------------------------------------------------------

inline HRESULT WbioSensorQueryCalibrationFormats(
    _Inout_ PWINBIO_PIPELINE Pipeline,
    _Out_writes_to_(FormatArraySize, *FormatCount) PWINBIO_UUID FormatArray,
    _In_ SIZE_T FormatArraySize, _Out_ PSIZE_T FormatCount) {
  if (!ARGUMENT_PRESENT(Pipeline) ||
      !ARGUMENT_PRESENT(Pipeline->SensorInterface) ||
      !ARGUMENT_PRESENT(FormatArray) || !ARGUMENT_PRESENT(FormatCount)) {
    return E_POINTER;
  } else if (!ARGUMENT_PRESENT(
                 Pipeline->SensorInterface->QueryCalibrationFormats)) {
    return E_NOTIMPL;
  } else {
    return Pipeline->SensorInterface->QueryCalibrationFormats(
        Pipeline, FormatArray, FormatArraySize, FormatCount);
  }
}
//-----------------------------------------------------------------------------

inline HRESULT WbioSensorSetCalibrationFormat(_Inout_ PWINBIO_PIPELINE Pipeline,
  ...
  if (!ARGUMENT_PRESENT(Pipeline) ||
    ...
    return E_POINTER;
                 ...
                 Pipeline->SensorInterface->SetCalibrationFormat)) {
    return E_NOTIMPL;
  } else {
    return Pipeline->SensorInterface->SetCalibrationFormat(Pipeline, Format);
  }
}
//-----------------------------------------------------------------------------

inline HRESULT
WbioSensorAcceptCalibrationData(_Inout_ PWINBIO_PIPELINE Pipeline,
                                _In_reads_bytes_(CalibrationBufferSize)
                                    PUCHAR CalibrationBuffer,
                                _In_ SIZE_T CalibrationBufferSize) {
  if (!ARGUMENT_PRESENT(Pipeline) ||
      !ARGUMENT_PRESENT(Pipeline->SensorInterface) ||
    ...
    return E_POINTER;
                 ...
                 Pipeline->SensorInterface->AcceptCalibrationData)) {
    return E_NOTIMPL;
  } else {
    return Pipeline->SensorInterface->AcceptCalibrationData(
        Pipeline, CalibrationBuffer, CalibrationBufferSize);
  }
}
//-----------------------------------------------------------------------------
#endif
...
inline HRESULT WbioSensorAsyncImportRawBuffer(
    _Inout_ PWINBIO_PIPELINE Pipeline,
    _In_reads_bytes_opt_(RawBufferSize) PUCHAR RawBufferAddress,
    _In_ SIZE_T RawBufferSize,
    _Outptr_result_bytebuffer_maybenull_(*ResultBufferSize)
  ...
  if (!ARGUMENT_PRESENT(Pipeline) ||
    ...
    return E_POINTER;
                 ...
                 Pipeline->SensorInterface->AsyncImportRawBuffer)) {
    return E_NOTIMPL;
  } else {
    return Pipeline->SensorInterface->AsyncImportRawBuffer(
        Pipeline, RawBufferAddress, RawBufferSize, ResultBufferAddress,
        ResultBufferSize);
  }
}
//-----------------------------------------------------------------------------

inline HRESULT WbioSensorAsyncImportSecureBuffer(
    _Inout_ PWINBIO_PIPELINE Pipeline, _In_ GUID SecureBufferIdentifier,
    _In_reads_bytes_opt_(MetadataBufferSize) PUCHAR MetadataBufferAddress,
    _In_ SIZE_T MetadataBufferSize,
    _Outptr_result_bytebuffer_maybenull_(*ResultBufferSize)
  ...
  if (!ARGUMENT_PRESENT(Pipeline) ||
    ...
    return E_POINTER;
                 ...
                 Pipeline->SensorInterface->AsyncImportSecureBuffer)) {
    return E_NOTIMPL;
  } else {
    return Pipeline->SensorInterface->AsyncImportSecureBuffer(
        Pipeline, SecureBufferIdentifier, MetadataBufferAddress,
        MetadataBufferSize, ResultBufferAddress, ResultBufferSize);
  }
}
//-----------------------------------------------------------------------------
#endif
...
inline HRESULT WbioSensorQueryPrivateSensorType(
    _Inout_ PWINBIO_PIPELINE Pipeline,
    _Out_writes_bytes_to_(TypeInfoBufferSize, *TypeInfoDataSize)
        PUCHAR TypeInfoBufferAddress,
    _In_ SIZE_T TypeInfoBufferSize, _Out_ SIZE_T *TypeInfoDataSize) {
  if (!ARGUMENT_PRESENT(Pipeline) ||
    ...
    return E_POINTER;
                 ...
                 Pipeline->SensorInterface->QueryPrivateSensorType)) {
    return E_NOTIMPL;
  } else {
    return Pipeline->SensorInterface->QueryPrivateSensorType(
        Pipeline, TypeInfoBufferAddress, TypeInfoBufferSize, TypeInfoDataSize);
  }
}
//-----------------------------------------------------------------------------
#endif
...
inline HRESULT WbioSensorConnectSecure(
    _Inout_ PWINBIO_PIPELINE Pipeline,
    _In_ const WINBIO_SECURE_CONNECTION_PARAMS *ConnectionParams,
    _Outptr_ WINBIO_SECURE_CONNECTION_DATA **ConnectionData) {
  if (!ARGUMENT_PRESENT(Pipeline) ||
    ...
    return Pipeline->SensorInterface->ConnectSecure(Pipeline, ConnectionParams,
                                                    ConnectionData);
  }
}
//-----------------------------------------------------------------------------

inline HRESULT WbioSensorStartCaptureEx(
    _Inout_ PWINBIO_PIPELINE Pipeline, _In_ WINBIO_BIR_PURPOSE Purpose,
    _In_reads_bytes_opt_(NonceSize) const UCHAR *Nonce, _In_ SIZE_T NonceSize,
    _In_ WINBIO_BIR_DATA_FLAGS Flags, _Out_ OVERLAPPED **Overlapped) {
  if (!ARGUMENT_PRESENT(Pipeline) ||
    ...
    return Pipeline->SensorInterface->StartCaptureEx(
        Pipeline, Purpose, Nonce, NonceSize, Flags, Overlapped);
  }
}
//-----------------------------------------------------------------------------

inline HRESULT WbioSensorStartNotifyWake(_Inout_ PWINBIO_PIPELINE Pipeline,
...
inline HRESULT WbioSensorFinishNotifyWake(_Inout_ PWINBIO_PIPELINE Pipeline,
...
// Methods available in V1.0 and later
//
typedef HRESULT(WINAPI *PIBIO_ENGINE_ATTACH_FN)(
    _Inout_ PWINBIO_PIPELINE Pipeline);

typedef HRESULT(WINAPI *PIBIO_ENGINE_DETACH_FN)(
    _Inout_ PWINBIO_PIPELINE Pipeline);

// Clears out all Engine-specific pipeline context
typedef HRESULT(WINAPI *PIBIO_ENGINE_CLEAR_CONTEXT_FN)(
    _Inout_ PWINBIO_PIPELINE Pipeline);

// 'QUERY_PREFERRED_FORMAT' - SENSOR ASKS ENGINE WHAT DATA
// FORMAT THE ENGINE PREFERS TO RECEIVE FROM THE SENSOR
typedef HRESULT(WINAPI *PIBIO_ENGINE_QUERY_PREFERRED_FORMAT_FN)(
    _Inout_ PWINBIO_PIPELINE Pipeline,
    _Out_ PWINBIO_REGISTERED_FORMAT StandardFormat,
    _Out_ PWINBIO_UUID VendorFormat);

typedef HRESULT(WINAPI *PIBIO_ENGINE_QUERY_INDEX_VECTOR_SIZE_FN)(
    _Inout_ PWINBIO_PIPELINE Pipeline, _Out_ PSIZE_T IndexElementCount);

//
// RETURN AN ARRAY OF UTF-8 OIDS FOR HASH
// ALGS SUPPORTED BY THE ENGINE
//
typedef HRESULT(WINAPI *PIBIO_ENGINE_QUERY_HASH_ALGORITHMS_FN)(
    _Inout_ PWINBIO_PIPELINE Pipeline, _Out_ PSIZE_T AlgorithmCount,
    _Out_ PSIZE_T AlgorithmBufferSize,
    _Outptr_result_bytebuffer_all_(*AlgorithmBufferSize)
        _At_(*AlgorithmBuffer, _Post_ _NullNull_terminated_)
            PUCHAR *AlgorithmBuffer);

//
// SELECT ONE OID FOR THE ENGINE TO USE
//
typedef HRESULT(WINAPI *PIBIO_ENGINE_SET_HASH_ALGORITHM_FN)(
    _Inout_ PWINBIO_PIPELINE Pipeline, _In_ SIZE_T AlgorithmBufferSize,
    _In_reads_z_(AlgorithmBufferSize) PUCHAR AlgorithmBuffer);

typedef HRESULT(WINAPI *PIBIO_ENGINE_QUERY_SAMPLE_HINT_FN)(
    _Inout_ PWINBIO_PIPELINE Pipeline, _Out_ PSIZE_T SampleHint);

typedef HRESULT(WINAPI *PIBIO_ENGINE_ACCEPT_SAMPLE_DATA_FN)(
    _Inout_ PWINBIO_PIPELINE Pipeline,
    _In_reads_bytes_(SampleSize) PWINBIO_BIR SampleBuffer,
    _In_ SIZE_T SampleSize, _In_ WINBIO_BIR_PURPOSE Purpose,
    _Out_ PWINBIO_REJECT_DETAIL RejectDetail);

// CAN RETURN:
//      'FEATURE SET' - AFTER A PUSH FROM THE SENSOR -
//      WINBIO_DATA_FLAG_INTERMEDIATE 'ENROLLMENT TEMPLATE' - AFTER AN
//      ENROLLMENT CYCLE - WINBIO_DATA_FLAG_PROCESSED 'MATCHING TEMPLATE' -
//      AFTER AN IDENTIFY OR VERIFY OPERATION - WINBIO_DATA_FLAG_PROCESSED
//
typedef HRESULT(WINAPI *PIBIO_ENGINE_EXPORT_ENGINE_DATA_FN)(
    _Inout_ PWINBIO_PIPELINE Pipeline, _In_ WINBIO_BIR_DATA_FLAGS Flags,
    _Outptr_result_bytebuffer_all_(*SampleSize) PWINBIO_BIR *SampleBuffer,
    _Out_ PSIZE_T SampleSize);

typedef HRESULT(WINAPI *PIBIO_ENGINE_VERIFY_FEATURE_SET_FN)(
    _Inout_ PWINBIO_PIPELINE Pipeline, _In_ PWINBIO_IDENTITY Identity,
    _In_ WINBIO_BIOMETRIC_SUBTYPE SubFactor, _Out_ PBOOLEAN Match,
    ...
    _Out_ PSIZE_T HashSize, _Out_ PWINBIO_REJECT_DETAIL RejectDetail);

typedef HRESULT(WINAPI *PIBIO_ENGINE_IDENTIFY_FEATURE_SET_FN)(
    _Inout_ PWINBIO_PIPELINE Pipeline, _Out_ PWINBIO_IDENTITY Identity,
...
typedef HRESULT(WINAPI *PIBIO_ENGINE_CREATE_ENROLLMENT_FN)(
    _Inout_ PWINBIO_PIPELINE Pipeline);

typedef HRESULT(WINAPI *PIBIO_ENGINE_UPDATE_ENROLLMENT_FN)(
    _Inout_ PWINBIO_PIPELINE Pipeline,
    _Out_ PWINBIO_REJECT_DETAIL RejectDetail);

typedef HRESULT(WINAPI *PIBIO_ENGINE_GET_ENROLLMENT_STATUS_FN)(
    _Inout_ PWINBIO_PIPELINE Pipeline,
    _Out_ PWINBIO_REJECT_DETAIL RejectDetail);

typedef HRESULT(WINAPI *PIBIO_ENGINE_GET_ENROLLMENT_HASH_FN)(
    _Inout_ PWINBIO_PIPELINE Pipeline,
    _Outptr_result_bytebuffer_all_(*HashSize) PUCHAR *HashValue,
    _Out_ PSIZE_T HashSize);

typedef HRESULT(WINAPI *PIBIO_ENGINE_CHECK_FOR_DUPLICATE_FN)(
    _Inout_ PWINBIO_PIPELINE Pipeline, _Out_ PWINBIO_IDENTITY Identity,
    _Out_ PWINBIO_BIOMETRIC_SUBTYPE SubFactor, _Out_ PBOOLEAN Duplicate);

typedef HRESULT(WINAPI *PIBIO_ENGINE_COMMIT_ENROLLMENT_FN)(
    _Inout_ PWINBIO_PIPELINE Pipeline, _In_ PWINBIO_IDENTITY Identity,
    _In_ WINBIO_BIOMETRIC_SUBTYPE SubFactor,
    _In_reads_bytes_(PayloadBlobSize) PUCHAR PayloadBlob,
    _In_ SIZE_T PayloadBlobSize);

typedef HRESULT(WINAPI *PIBIO_ENGINE_DISCARD_ENROLLMENT_FN)(
    _Inout_ PWINBIO_PIPELINE Pipeline);

typedef HRESULT(WINAPI *PIBIO_ENGINE_CONTROL_UNIT_FN)(
    _Inout_ PWINBIO_PIPELINE Pipeline, _In_ ULONG ControlCode,
    _In_reads_bytes_(SendBufferSize) PUCHAR SendBuffer,
    _In_ SIZE_T SendBufferSize,
    _Out_writes_bytes_to_(ReceiveBufferSize, *ReceiveDataSize)
...
typedef HRESULT(WINAPI *PIBIO_ENGINE_CONTROL_UNIT_PRIVILEGED_FN)(
    _Inout_ PWINBIO_PIPELINE Pipeline, _In_ ULONG ControlCode,
    _In_reads_bytes_(SendBufferSize) PUCHAR SendBuffer,
    _In_ SIZE_T SendBufferSize,
    _Out_writes_bytes_to_(ReceiveBufferSize, *ReceiveDataSize)
...
// Additional methods available in V2.0 and later
//
typedef HRESULT(WINAPI *PIBIO_ENGINE_NOTIFY_POWER_CHANGE_FN)(
    _Inout_ PWINBIO_PIPELINE Pipeline, _In_ ULONG PowerEventType);

typedef HRESULT(WINAPI *PIBIO_ENGINE_RESERVED_1_FN)(
    _Inout_ PWINBIO_PIPELINE Pipeline, _Out_ PWINBIO_IDENTITY Identity);
...
// Additional methods available in V3.0 and later
//
typedef HRESULT(WINAPI *PIBIO_ENGINE_PIPELINE_INIT_FN)(
    _Inout_ PWINBIO_PIPELINE Pipeline);

typedef HRESULT(WINAPI *PIBIO_ENGINE_PIPELINE_CLEANUP_FN)(
    _Inout_ PWINBIO_PIPELINE Pipeline);

typedef HRESULT(WINAPI *PIBIO_ENGINE_ACTIVATE_FN)(
    _Inout_ PWINBIO_PIPELINE Pipeline);

typedef HRESULT(WINAPI *PIBIO_ENGINE_DEACTIVATE_FN)(
    _Inout_ PWINBIO_PIPELINE Pipeline);

typedef HRESULT(WINAPI *PIBIO_ENGINE_QUERY_EXTENDED_INFO_FN)(
    _Inout_ PWINBIO_PIPELINE Pipeline,
    _Out_writes_bytes_(EngineInfoSize) PWINBIO_EXTENDED_ENGINE_INFO EngineInfo,
    _In_ SIZE_T EngineInfoSize);

typedef HRESULT(WINAPI *PIBIO_ENGINE_IDENTIFY_ALL_FN)(
    _Inout_ PWINBIO_PIPELINE Pipeline, _Out_ PSIZE_T PresenceCount,
    _Out_ PWINBIO_PRESENCE *PresenceArray);

typedef HRESULT(WINAPI *PIBIO_ENGINE_SET_ENROLLMENT_SELECTOR_FN)(
    _Inout_ PWINBIO_PIPELINE Pipeline, _In_ ULONGLONG SelectorValue);

typedef HRESULT(WINAPI *PIBIO_ENGINE_SET_ENROLLMENT_PARAMETERS_FN)(
    _Inout_ PWINBIO_PIPELINE Pipeline,
    _In_ PWINBIO_EXTENDED_ENROLLMENT_PARAMETERS Parameters);

typedef HRESULT(WINAPI *PIBIO_ENGINE_QUERY_EXTENDED_ENROLLMENT_STATUS_FN)(
    _Inout_ PWINBIO_PIPELINE Pipeline,
    _Out_writes_bytes_(EnrollmentStatusSize)
        PWINBIO_EXTENDED_ENROLLMENT_STATUS EnrollmentStatus,
    _In_ SIZE_T EnrollmentStatusSize);

typedef HRESULT(WINAPI *PIBIO_ENGINE_REFRESH_CACHE_FN)(
    _Inout_ PWINBIO_PIPELINE Pipeline);

typedef HRESULT(WINAPI *PIBIO_ENGINE_SELECT_CALIBRATION_FORMAT_FN)(
    _Inout_ PWINBIO_PIPELINE Pipeline,
    _In_reads_(FormatCount) PWINBIO_UUID FormatArray, _In_ SIZE_T FormatCount,
    _Out_ PWINBIO_UUID SelectedFormat, _Out_ PSIZE_T MaxBufferSize);

typedef HRESULT(WINAPI *PIBIO_ENGINE_QUERY_CALIBRATION_DATA_FN)(
    _Inout_ PWINBIO_PIPELINE Pipeline, _Out_ PBOOLEAN DiscardAndRepeatCapture,
    _Out_writes_bytes_to_(MaxBufferSize, *CalibrationBufferSize)
        PUCHAR CalibrationBuffer,
    _Out_ PSIZE_T CalibrationBufferSize, _In_ SIZE_T MaxBufferSize);

typedef HRESULT(WINAPI *PIBIO_ENGINE_SET_ACCOUNT_POLICY_FN)(
    _Inout_ PWINBIO_PIPELINE Pipeline,
...
typedef HRESULT(WINAPI *PIBIO_ENGINE_CREATE_KEY_FN)(
    _Inout_ PWINBIO_PIPELINE Pipeline, _In_reads_(KeySize) const UCHAR *Key,
    _In_ SIZE_T KeySize,
    _Out_writes_bytes_to_(KeyIdentifierSize, *ResultSize) PUCHAR KeyIdentifier,
    _In_ SIZE_T KeyIdentifierSize, _Out_ PSIZE_T ResultSize);

typedef HRESULT(WINAPI *PIBIO_ENGINE_IDENTIFY_FEATURE_SET_SECURE_FN)(
    _Inout_ PWINBIO_PIPELINE Pipeline, _In_reads_(NonceSize) const UCHAR *Nonce,
    _In_ SIZE_T NonceSize,
    _In_reads_(KeyIdentifierSize) const UCHAR *KeyIdentifier,
    _In_ SIZE_T KeyIdentifierSize, _Out_ PWINBIO_IDENTITY Identity,
    _Out_ PWINBIO_BIOMETRIC_SUBTYPE SubFactor,
    _Out_ PWINBIO_REJECT_DETAIL RejectDetail,
...
typedef HRESULT(WINAPI *PIBIO_ENGINE_ACCEPT_PRIVATE_SENSOR_TYPE_INFO_FN)(
    _Inout_ PWINBIO_PIPELINE Pipeline,
...
typedef HRESULT(WINAPI *PIBIO_ENGINE_CREATE_ENROLLMENT_AUTHENTICATED_FN)(
    _Inout_ PWINBIO_PIPELINE Pipeline,
    _Outptr_result_bytebuffer_(*NonceSize) PUCHAR *Nonce,
    _Out_ SIZE_T *NonceSize);

typedef HRESULT(WINAPI *PIBIO_ENGINE_IDENTIFY_FEATURE_SET_AUTHENTICATED_FN)(
    _Inout_ PWINBIO_PIPELINE Pipeline,
    _In_reads_bytes_(NonceSize) const UCHAR *Nonce, _In_ SIZE_T NonceSize,
    _Out_ WINBIO_IDENTITY *Identity, _Out_ WINBIO_BIOMETRIC_SUBTYPE *SubFactor,
...
typedef struct _WINBIO_ENGINE_INTERFACE {
  ...
  AcceptSampleData; // PROCESSES CURRENT BUFFER FROM PIPELINE AND GENERATES
                    // A FEATURE SET IN THE PIPELINE
  PIBIO_ENGINE_EXPORT_ENGINE_DATA_FN
  ExportEngineData; // EXPORTS FEATURE SET OR TEMPLATE
  ...
  CreateEnrollment; // ATTACHES AN EMPTY ENROLLMENT TEMPLATE TO THE PIPELINE
  PIBIO_ENGINE_UPDATE_ENROLLMENT_FN
  UpdateEnrollment; // CONVERTS CURRENT PIPELINE FEATURE SET INTO SOMETHING
                    // THAT CAN BE ADDED TO A TEMPLATE
  PIBIO_ENGINE_GET_ENROLLMENT_STATUS_FN
  GetEnrollmentStatus; // QUERIES TEMPLATE ATTACHED TO THE PIPELINE TO SEE
                       // IF IT IS READY TO COMMIT
  PIBIO_ENGINE_GET_ENROLLMENT_HASH_FN GetEnrollmentHash;
  PIBIO_ENGINE_CHECK_FOR_DUPLICATE_FN
  CheckForDuplicate; // DETERMINES WHETHER TEMPLATE IS ALREADY ENROLLED
...
HRESULT
WINAPI
WbioQueryEngineInterface(_Out_ PWINBIO_ENGINE_INTERFACE *EngineInterface);

//
// Pointer to an interface-retrieval function used by the
// framework after a 'GetProcAddress' call.
//
typedef HRESULT(WINAPI *PWINBIO_QUERY_ENGINE_INTERFACE_FN)(
...
//
///////////////////////////////////////////////////////////////////////////////
inline HRESULT WbioEngineAttach(_Inout_ PWINBIO_PIPELINE Pipeline) {
  if (!ARGUMENT_PRESENT(Pipeline) ||
...
inline HRESULT WbioEngineDetach(_Inout_ PWINBIO_PIPELINE Pipeline) {
  if (!ARGUMENT_PRESENT(Pipeline) ||
      !ARGUMENT_PRESENT(Pipeline->EngineInterface)) {
    return E_POINTER;
...
inline HRESULT WbioEngineClearContext(_Inout_ PWINBIO_PIPELINE Pipeline) {
  if (!ARGUMENT_PRESENT(Pipeline) ||
      !ARGUMENT_PRESENT(Pipeline->EngineInterface)) {
    return E_POINTER;
...
inline HRESULT
WbioEngineQueryPreferredFormat(_Inout_ PWINBIO_PIPELINE Pipeline,
                               _Out_ PWINBIO_REGISTERED_FORMAT StandardFormat,
                               _Out_ PWINBIO_UUID VendorFormat) {
  if (!ARGUMENT_PRESENT(Pipeline) ||
      !ARGUMENT_PRESENT(Pipeline->EngineInterface)) {
    return E_POINTER;
                 ...
                 Pipeline->EngineInterface->QueryPreferredFormat)) {
    return E_NOTIMPL;
  } else {
    return Pipeline->EngineInterface->QueryPreferredFormat(
        Pipeline, StandardFormat, VendorFormat);
  }
}
//-----------------------------------------------------------------------------

inline HRESULT WbioEngineQueryIndexVectorSize(_Inout_ PWINBIO_PIPELINE Pipeline,
                                              _Out_ PSIZE_T IndexElementCount) {
  if (!ARGUMENT_PRESENT(Pipeline) ||
      !ARGUMENT_PRESENT(Pipeline->EngineInterface)) {
    return E_POINTER;
  } else if (!ARGUMENT_PRESENT(
                 Pipeline->EngineInterface->QueryIndexVectorSize)) {
    return E_NOTIMPL;
  } else {
    return Pipeline->EngineInterface->QueryIndexVectorSize(Pipeline,
                                                           IndexElementCount);
  }
}
//-----------------------------------------------------------------------------

inline HRESULT WbioEngineQueryHashAlgorithms(
    _Inout_ PWINBIO_PIPELINE Pipeline, _Out_ PSIZE_T AlgorithmCount,
    _Out_ PSIZE_T AlgorithmBufferSize,
    _Outptr_result_bytebuffer_all_(*AlgorithmBufferSize)
        _At_(*AlgorithmBuffer, _Post_ _NullNull_terminated_)
  ...
  if (!ARGUMENT_PRESENT(Pipeline) ||
    ...
    return E_POINTER;
                 ...
                 Pipeline->EngineInterface->QueryHashAlgorithms)) {
    return E_NOTIMPL;
  } else {
    return Pipeline->EngineInterface->QueryHashAlgorithms(
        Pipeline, AlgorithmCount, AlgorithmBufferSize, AlgorithmBuffer);
  }
}
//-----------------------------------------------------------------------------

inline HRESULT WbioEngineSetHashAlgorithm(_Inout_ PWINBIO_PIPELINE Pipeline,
                                          _In_ SIZE_T AlgorithmBufferSize,
                                          _In_reads_z_(AlgorithmBufferSize)
                                              PUCHAR AlgorithmBuffer) {
  if (!ARGUMENT_PRESENT(Pipeline) ||
      !ARGUMENT_PRESENT(Pipeline->EngineInterface)) {
    return E_POINTER;
    ...
    return Pipeline->EngineInterface->SetHashAlgorithm(
        Pipeline, AlgorithmBufferSize, AlgorithmBuffer);
  }
}
//-----------------------------------------------------------------------------

inline HRESULT WbioEngineQuerySampleHint(_Inout_ PWINBIO_PIPELINE Pipeline,
  ...
  if (!ARGUMENT_PRESENT(Pipeline) ||
    ...
    return Pipeline->EngineInterface->QuerySampleHint(Pipeline, SampleHint);
  }
}
//-----------------------------------------------------------------------------

inline HRESULT WbioEngineAcceptSampleData(
    _Inout_ PWINBIO_PIPELINE Pipeline,
    _In_reads_bytes_(SampleSize) PWINBIO_BIR SampleBuffer,
    _In_ SIZE_T SampleSize, _In_ WINBIO_BIR_PURPOSE Purpose,
    _Out_ PWINBIO_REJECT_DETAIL RejectDetail) {
  if (!ARGUMENT_PRESENT(Pipeline) ||
    ...
    return Pipeline->EngineInterface->AcceptSampleData(
        Pipeline, SampleBuffer, SampleSize, Purpose, RejectDetail);
  }
}
//-----------------------------------------------------------------------------

inline HRESULT WbioEngineExportEngineData(
    _Inout_ PWINBIO_PIPELINE Pipeline, _In_ WINBIO_BIR_DATA_FLAGS Flags,
    _Outptr_result_bytebuffer_all_(*SampleSize) PWINBIO_BIR *SampleBuffer,
    _Out_ PSIZE_T SampleSize) {
  if (!ARGUMENT_PRESENT(Pipeline) ||
    ...
    return Pipeline->EngineInterface->ExportEngineData(
        Pipeline, Flags, SampleBuffer, SampleSize);
  }
}
//-----------------------------------------------------------------------------

inline HRESULT WbioEngineVerifyFeatureSet(
    _Inout_ PWINBIO_PIPELINE Pipeline, _In_ PWINBIO_IDENTITY Identity,
    _In_ WINBIO_BIOMETRIC_SUBTYPE SubFactor, _Out_ PBOOLEAN Match,
    _Outptr_result_bytebuffer_all_(*PayloadBlobSize) PUCHAR *PayloadBlob,
    _Out_ PSIZE_T PayloadBlobSize,
  ...
  if (!ARGUMENT_PRESENT(Pipeline) ||
    ...
    return Pipeline->EngineInterface->VerifyFeatureSet(
        Pipeline, Identity, SubFactor, Match, PayloadBlob, PayloadBlobSize,
        HashValue, HashSize, RejectDetail);
  }
}
//-----------------------------------------------------------------------------

inline HRESULT WbioEngineIdentifyFeatureSet(
    _Inout_ PWINBIO_PIPELINE Pipeline, _Out_ PWINBIO_IDENTITY Identity,
    _Out_ PWINBIO_BIOMETRIC_SUBTYPE SubFactor,
    _Outptr_result_bytebuffer_all_(*PayloadBlobSize) PUCHAR *PayloadBlob,
    _Out_ PSIZE_T PayloadBlobSize,
  ...
  if (!ARGUMENT_PRESENT(Pipeline) ||
    ...
    return Pipeline->EngineInterface->IdentifyFeatureSet(
        Pipeline, Identity, SubFactor, PayloadBlob, PayloadBlobSize, HashValue,
        HashSize, RejectDetail);
  }
}
//-----------------------------------------------------------------------------

inline HRESULT WbioEngineCreateEnrollment(_Inout_ PWINBIO_PIPELINE Pipeline) {
  if (!ARGUMENT_PRESENT(Pipeline) ||
      !ARGUMENT_PRESENT(Pipeline->EngineInterface)) {
    return E_POINTER;
...
inline HRESULT
WbioEngineUpdateEnrollment(_Inout_ PWINBIO_PIPELINE Pipeline,
                           _Out_ PWINBIO_REJECT_DETAIL RejectDetail) {
  if (!ARGUMENT_PRESENT(Pipeline) ||
      !ARGUMENT_PRESENT(Pipeline->EngineInterface)) {
    return E_POINTER;
    ...
    return Pipeline->EngineInterface->UpdateEnrollment(Pipeline, RejectDetail);
  }
}
//-----------------------------------------------------------------------------

inline HRESULT
WbioEngineGetEnrollmentStatus(_Inout_ PWINBIO_PIPELINE Pipeline,
                              _Out_ PWINBIO_REJECT_DETAIL RejectDetail) {
  if (!ARGUMENT_PRESENT(Pipeline) ||
      !ARGUMENT_PRESENT(Pipeline->EngineInterface)) {
    return E_POINTER;
  } else if (!ARGUMENT_PRESENT(
                 Pipeline->EngineInterface->GetEnrollmentStatus)) {
    return E_NOTIMPL;
  } else {
    return Pipeline->EngineInterface->GetEnrollmentStatus(Pipeline,
                                                          RejectDetail);
  }
}
//-----------------------------------------------------------------------------
...
inline HRESULT
WbioEngineGetEnrollmentHash(_Inout_ PWINBIO_PIPELINE Pipeline,
                            _Outptr_result_bytebuffer_all_(*HashSize)
                                PUCHAR *HashValue,
                            _Out_ PSIZE_T HashSize) {
  if (!ARGUMENT_PRESENT(Pipeline) ||
      !ARGUMENT_PRESENT(Pipeline->EngineInterface)) {
    ...
    return Pipeline->EngineInterface->GetEnrollmentHash(Pipeline, HashValue,
                                                        HashSize);
  }
}
//-----------------------------------------------------------------------------

inline HRESULT WbioEngineCheckForDuplicate(
    _Inout_ PWINBIO_PIPELINE Pipeline, _Out_ PWINBIO_IDENTITY Identity,
    _Out_ PWINBIO_BIOMETRIC_SUBTYPE SubFactor, _Out_ PBOOLEAN Duplicate) {
  if (!ARGUMENT_PRESENT(Pipeline) ||
      !ARGUMENT_PRESENT(Pipeline->EngineInterface)) {
    ...
    return Pipeline->EngineInterface->CheckForDuplicate(Pipeline, Identity,
                                                        SubFactor, Duplicate);
  }
}
//-----------------------------------------------------------------------------
...
inline HRESULT
WbioEngineCommitEnrollment(_Inout_ PWINBIO_PIPELINE Pipeline,
  ...
  if (!ARGUMENT_PRESENT(Pipeline) ||
    ...
    return Pipeline->EngineInterface->CommitEnrollment(
        Pipeline, Identity, SubFactor, PayloadBlob, PayloadBlobSize);
  }
}
//-----------------------------------------------------------------------------

inline HRESULT WbioEngineDiscardEnrollment(_Inout_ PWINBIO_PIPELINE Pipeline) {
  if (!ARGUMENT_PRESENT(Pipeline) ||
      !ARGUMENT_PRESENT(Pipeline->EngineInterface)) {
    return E_POINTER;
...
inline HRESULT
WbioEngineControlUnit(_Inout_ PWINBIO_PIPELINE Pipeline, _In_ ULONG ControlCode,
                      _In_reads_bytes_(SendBufferSize) PUCHAR SendBuffer,
                      _In_ SIZE_T SendBufferSize,
                      _Out_writes_bytes_to_(ReceiveBufferSize, *ReceiveDataSize)
                          PUCHAR ReceiveBuffer,
...
inline HRESULT WbioEngineControlUnitPrivileged(
    _Inout_ PWINBIO_PIPELINE Pipeline, _In_ ULONG ControlCode,
    _In_reads_bytes_(SendBufferSize) PUCHAR SendBuffer,
    _In_ SIZE_T SendBufferSize,
    _Out_writes_bytes_to_(ReceiveBufferSize, *ReceiveDataSize)
  ...
  if (!ARGUMENT_PRESENT(Pipeline) ||
    ...
    return E_POINTER;
                 ...
                 Pipeline->EngineInterface->ControlUnitPrivileged)) {
    return E_NOTIMPL;
  } else {
...
inline HRESULT WbioEngineNotifyPowerChange(_Inout_ PWINBIO_PIPELINE Pipeline,
                                           _In_ ULONG PowerEventType) {
  if (!ARGUMENT_PRESENT(Pipeline) ||
      !ARGUMENT_PRESENT(Pipeline->EngineInterface)) {
    return E_POINTER;
    ...
    return Pipeline->EngineInterface->NotifyPowerChange(Pipeline,
                                                        PowerEventType);
  }
}
//-----------------------------------------------------------------------------

inline HRESULT WbioEngineReserved_1(_Inout_ PWINBIO_PIPELINE Pipeline,
...
inline HRESULT WbioEnginePipelineInit(_Inout_ PWINBIO_PIPELINE Pipeline) {
  if (!ARGUMENT_PRESENT(Pipeline) ||
      !ARGUMENT_PRESENT(Pipeline->EngineInterface)) {
    return E_POINTER;
...
inline HRESULT WbioEnginePipelineCleanup(_Inout_ PWINBIO_PIPELINE Pipeline) {
  if (!ARGUMENT_PRESENT(Pipeline) ||
      !ARGUMENT_PRESENT(Pipeline->EngineInterface)) {
    return E_POINTER;
...
inline HRESULT WbioEngineActivate(_Inout_ PWINBIO_PIPELINE Pipeline) {
  if (!ARGUMENT_PRESENT(Pipeline) ||
      !ARGUMENT_PRESENT(Pipeline->EngineInterface)) {
    return E_POINTER;
...
inline HRESULT WbioEngineDeactivate(_Inout_ PWINBIO_PIPELINE Pipeline) {
  if (!ARGUMENT_PRESENT(Pipeline) ||
      !ARGUMENT_PRESENT(Pipeline->EngineInterface)) {
    return E_POINTER;
...
inline HRESULT
WbioEngineQueryExtendedInfo(_Inout_ PWINBIO_PIPELINE Pipeline,
                            _Out_writes_bytes_(EngineInfoSize)
                                PWINBIO_EXTENDED_ENGINE_INFO EngineInfo,
                            _In_ SIZE_T EngineInfoSize) {
  if (!ARGUMENT_PRESENT(Pipeline) ||
      !ARGUMENT_PRESENT(Pipeline->EngineInterface) ||
    ...
    return Pipeline->EngineInterface->QueryExtendedInfo(Pipeline, EngineInfo,
                                                        EngineInfoSize);
  }
}
//-----------------------------------------------------------------------------

inline HRESULT WbioEngineIdentifyAll(_Inout_ PWINBIO_PIPELINE Pipeline,
                                     _Out_ PSIZE_T PresenceCount,
                                     _Out_ PWINBIO_PRESENCE *PresenceArray) {
  if (!ARGUMENT_PRESENT(Pipeline) ||
      !ARGUMENT_PRESENT(Pipeline->EngineInterface) ||
      !ARGUMENT_PRESENT(PresenceCount) || !ARGUMENT_PRESENT(PresenceArray)) {
    return E_POINTER;
  } else if (!ARGUMENT_PRESENT(Pipeline->EngineInterface->IdentifyAll)) {
    return E_NOTIMPL;
  } else {
    return Pipeline->EngineInterface->IdentifyAll(Pipeline, PresenceCount,
                                                  PresenceArray);
  }
}
//-----------------------------------------------------------------------------
...
inline HRESULT
WbioEngineSetEnrollmentSelector(_Inout_ PWINBIO_PIPELINE Pipeline,
                                _In_ ULONGLONG SelectorValue) {
  if (!ARGUMENT_PRESENT(Pipeline) ||
      !ARGUMENT_PRESENT(Pipeline->EngineInterface)) {
    return E_POINTER;
  } else if (!ARGUMENT_PRESENT(
                 Pipeline->EngineInterface->SetEnrollmentSelector)) {
    return E_NOTIMPL;
  } else {
    return Pipeline->EngineInterface->SetEnrollmentSelector(Pipeline,
                                                            SelectorValue);
  }
}
//-----------------------------------------------------------------------------

inline HRESULT WbioEngineQueryExtendedEnrollmentStatus(
    _Inout_ PWINBIO_PIPELINE Pipeline,
    _Out_writes_bytes_(EnrollmentStatusSize)
        PWINBIO_EXTENDED_ENROLLMENT_STATUS EnrollmentStatus,
    _In_ SIZE_T EnrollmentStatusSize) {
  if (!ARGUMENT_PRESENT(Pipeline) ||
    ...
    return E_POINTER;
                 ...
                 Pipeline->EngineInterface->QueryExtendedEnrollmentStatus)) {
    return E_NOTIMPL;
  } else {
    return Pipeline->EngineInterface->QueryExtendedEnrollmentStatus(
        Pipeline, EnrollmentStatus, EnrollmentStatusSize);
  }
}
//-----------------------------------------------------------------------------

inline HRESULT WbioEngineSetEnrollmentParameters(
    _Inout_ PWINBIO_PIPELINE Pipeline,
    _In_ PWINBIO_EXTENDED_ENROLLMENT_PARAMETERS Parameters) {
  if (!ARGUMENT_PRESENT(Pipeline) ||
      !ARGUMENT_PRESENT(Pipeline->EngineInterface)) {
    return E_POINTER;
                 ...
                 Pipeline->EngineInterface->SetEnrollmentParameters)) {
    return E_NOTIMPL;
  } else {
    return Pipeline->EngineInterface->SetEnrollmentParameters(Pipeline,
                                                              Parameters);
  }
}
//-----------------------------------------------------------------------------

inline HRESULT WbioEngineRefreshCache(_Inout_ PWINBIO_PIPELINE Pipeline) {
  if (!ARGUMENT_PRESENT(Pipeline) ||
      !ARGUMENT_PRESENT(Pipeline->EngineInterface)) {
    return E_POINTER;
    ...
    return Pipeline->EngineInterface->RefreshCache(Pipeline);
  }
}
//-----------------------------------------------------------------------------

inline HRESULT WbioEngineSelectCalibrationFormat(
    _Inout_ PWINBIO_PIPELINE Pipeline,
    _In_reads_(FormatCount) PWINBIO_UUID FormatArray, _In_ SIZE_T FormatCount,
    _Out_ PWINBIO_UUID SelectedFormat, _Out_ PSIZE_T MaxBufferSize) {
  if (!ARGUMENT_PRESENT(Pipeline) ||
      !ARGUMENT_PRESENT(Pipeline->EngineInterface) ||
      !ARGUMENT_PRESENT(FormatArray) || !ARGUMENT_PRESENT(SelectedFormat) ||
      !ARGUMENT_PRESENT(MaxBufferSize)) {
    return E_POINTER;
  } else if (!ARGUMENT_PRESENT(
                 Pipeline->EngineInterface->SelectCalibrationFormat)) {
    return E_NOTIMPL;
  } else {
    return Pipeline->EngineInterface->SelectCalibrationFormat(
        Pipeline, FormatArray, FormatCount, SelectedFormat, MaxBufferSize);
  }
}
//-----------------------------------------------------------------------------

inline HRESULT WbioEngineQueryCalibrationData(
    _Inout_ PWINBIO_PIPELINE Pipeline, _Out_ PBOOLEAN DiscardAndRepeatCapture,
    _Out_writes_bytes_to_(MaxBufferSize, *CalibrationBufferSize)
        PUCHAR CalibrationBuffer,
    _Out_ PSIZE_T CalibrationBufferSize, _In_ SIZE_T MaxBufferSize) {
  if (!ARGUMENT_PRESENT(Pipeline) ||
    ...
    return E_POINTER;
                 ...
                 Pipeline->EngineInterface->QueryCalibrationData)) {
    return E_NOTIMPL;
  } else {
    return Pipeline->EngineInterface->QueryCalibrationData(
        Pipeline, DiscardAndRepeatCapture, CalibrationBuffer,
        CalibrationBufferSize, MaxBufferSize);
  }
}
//-----------------------------------------------------------------------------

inline HRESULT
WbioEngineSetAccountPolicy(_Inout_ PWINBIO_PIPELINE Pipeline,
                           _In_reads_(PolicyItemCount)
                               PWINBIO_ACCOUNT_POLICY PolicyItemArray,
                           _In_ SIZE_T PolicyItemCount) {
  if (!ARGUMENT_PRESENT(Pipeline) ||
      !ARGUMENT_PRESENT(Pipeline->EngineInterface) ||
    ...
    return Pipeline->EngineInterface->SetAccountPolicy(
        Pipeline, PolicyItemArray, PolicyItemCount);
  }
}
//-----------------------------------------------------------------------------
...
inline HRESULT
WbioEngineCreateKey(_Inout_ PWINBIO_PIPELINE Pipeline,
                    _In_reads_(KeySize) const UCHAR *Key, _In_ SIZE_T KeySize,
                    _Out_writes_bytes_to_(KeyIdentifierSize, *ResultSize)
  ...
  if (!ARGUMENT_PRESENT(Pipeline) ||
    ...
    return Pipeline->EngineInterface->CreateKey(
        Pipeline, Key, KeySize, KeyIdentifier, KeyIdentifierSize, ResultSize);
  }
}
//-----------------------------------------------------------------------------

inline HRESULT WbioEngineIdentifyFeatureSetSecure(
    _Inout_ PWINBIO_PIPELINE Pipeline, _In_reads_(NonceSize) const UCHAR *Nonce,
    _In_ SIZE_T NonceSize,
    _In_reads_(KeyIdentifierSize) const UCHAR *KeyIdentifier,
    _In_ SIZE_T KeyIdentifierSize, _Out_ PWINBIO_IDENTITY Identity,
  ...
  if (!ARGUMENT_PRESENT(Pipeline) ||
    ...
    return E_POINTER;
                 ...
                 Pipeline->EngineInterface->IdentifyFeatureSetSecure)) {
    return E_NOTIMPL;
  } else {
    return Pipeline->EngineInterface->IdentifyFeatureSetSecure(
        Pipeline, Nonce, NonceSize, KeyIdentifier, KeyIdentifierSize, Identity,
        SubFactor, RejectDetail, Authorization, AuthorizationSize);
  }
}
//-----------------------------------------------------------------------------
...
inline HRESULT
WbioEngineAcceptPrivateSensorTypeInfo(_Inout_ PWINBIO_PIPELINE Pipeline,
                                      _In_reads_(TypeInfoBufferSize)
                                          const UCHAR *TypeInfoBufferAddress,
                                      _In_ SIZE_T TypeInfoBufferSize) {
  if (!ARGUMENT_PRESENT(Pipeline) ||
      !ARGUMENT_PRESENT(Pipeline->EngineInterface)) {
    return E_POINTER;
  } else if (!ARGUMENT_PRESENT(
                 Pipeline->EngineInterface->AcceptPrivateSensorTypeInfo)) {
    return E_NOTIMPL;
  } else {
    return Pipeline->EngineInterface->AcceptPrivateSensorTypeInfo(
        Pipeline, TypeInfoBufferAddress, TypeInfoBufferSize);
  }
}
//-----------------------------------------------------------------------------
...
inline HRESULT
WbioEngineCreateEnrollmentAuthenticated(_Inout_ PWINBIO_PIPELINE Pipeline,
                                        _Outptr_result_bytebuffer_(*NonceSize)
                                            PUCHAR *Nonce,
                                        _Out_ SIZE_T *NonceSize) {
  if (!ARGUMENT_PRESENT(Pipeline) ||
      !ARGUMENT_PRESENT(Pipeline->EngineInterface)) {
    return E_POINTER;
                 ...
                 Pipeline->EngineInterface->CreateEnrollmentAuthenticated)) {
    return E_NOTIMPL;
  } else {
    return Pipeline->EngineInterface->CreateEnrollmentAuthenticated(
        Pipeline, Nonce, NonceSize);
  }
}
//-----------------------------------------------------------------------------

inline HRESULT WbioEngineIdentifyFeatureSetAuthenticated(
    _Inout_ PWINBIO_PIPELINE Pipeline,
    _In_reads_bytes_(NonceSize) const UCHAR *Nonce, _In_ SIZE_T NonceSize,
    _Out_ WINBIO_IDENTITY *Identity, _Out_ WINBIO_BIOMETRIC_SUBTYPE *SubFactor,
    _Out_ WINBIO_REJECT_DETAIL *RejectDetail,
  ...
  if (!ARGUMENT_PRESENT(Pipeline) ||
    ...
    return E_POINTER;
                 ...
                 Pipeline->EngineInterface->IdentifyFeatureSetAuthenticated)) {
    return E_NOTIMPL;
  } else {
    return Pipeline->EngineInterface->IdentifyFeatureSetAuthenticated(
        Pipeline, Nonce, NonceSize, Identity, SubFactor, RejectDetail,
        Authentication, AuthenticationSize);
  }
}
//-----------------------------------------------------------------------------
...
// Methods available in V1.0 and later
//
typedef HRESULT(WINAPI *PIBIO_STORAGE_ATTACH_FN)(
    _Inout_ PWINBIO_PIPELINE Pipeline);

typedef HRESULT(WINAPI *PIBIO_STORAGE_DETACH_FN)(
    _Inout_ PWINBIO_PIPELINE Pipeline);

// Clears out all Storage-specific pipeline context
typedef HRESULT(WINAPI *PIBIO_STORAGE_CLEAR_CONTEXT_FN)(
    _Inout_ PWINBIO_PIPELINE Pipeline);

typedef HRESULT(WINAPI *PIBIO_STORAGE_CREATE_DATABASE_FN)(
    _Inout_ PWINBIO_PIPELINE Pipeline, _In_ PWINBIO_UUID DatabaseId,
    _In_ WINBIO_BIOMETRIC_TYPE Factor, _In_ PWINBIO_UUID Format,
    _In_ LPCWSTR FilePath, _In_ LPCWSTR ConnectString,
    _In_ SIZE_T IndexElementCount, _In_ SIZE_T InitialSize);

typedef HRESULT(WINAPI *PIBIO_STORAGE_ERASE_DATABASE_FN)(
    _Inout_ PWINBIO_PIPELINE Pipeline, _In_ PWINBIO_UUID DatabaseId,
    _In_ LPCWSTR FilePath, _In_ LPCWSTR ConnectString);

typedef HRESULT(WINAPI *PIBIO_STORAGE_OPEN_DATABASE_FN)(
    _Inout_ PWINBIO_PIPELINE Pipeline, _In_ PWINBIO_UUID DatabaseId,
    _In_ LPCWSTR FilePath, _In_ LPCWSTR ConnectString);

typedef HRESULT(WINAPI *PIBIO_STORAGE_CLOSE_DATABASE_FN)(
    _Inout_ PWINBIO_PIPELINE Pipeline);

typedef HRESULT(WINAPI *PIBIO_STORAGE_GET_DATA_FORMAT_FN)(
    _Inout_ PWINBIO_PIPELINE Pipeline, _Out_ PWINBIO_UUID Format,
    _Out_ PWINBIO_VERSION Version);

typedef HRESULT(WINAPI *PIBIO_STORAGE_GET_DATABASE_SIZE_FN)(
    _Inout_ PWINBIO_PIPELINE Pipeline, _Out_ PSIZE_T AvailableRecordCount,
    _Out_ PSIZE_T TotalRecordCount);

typedef HRESULT(WINAPI *PIBIO_STORAGE_ADD_RECORD_FN)(
    _Inout_ PWINBIO_PIPELINE Pipeline,
    _In_ PWINBIO_STORAGE_RECORD RecordContents);

typedef HRESULT(WINAPI *PIBIO_STORAGE_DELETE_RECORD_FN)(
    _Inout_ PWINBIO_PIPELINE Pipeline, _In_ PWINBIO_IDENTITY Identity,
    _In_ WINBIO_BIOMETRIC_SUBTYPE SubFactor);

typedef HRESULT(WINAPI *PIBIO_STORAGE_QUERY_BY_SUBJECT_FN)(
    _Inout_ PWINBIO_PIPELINE Pipeline, _In_ PWINBIO_IDENTITY Identity,
    _In_ WINBIO_BIOMETRIC_SUBTYPE SubFactor);

typedef HRESULT(WINAPI *PIBIO_STORAGE_QUERY_BY_CONTENT_FN)(
    _Inout_ PWINBIO_PIPELINE Pipeline, _In_ WINBIO_BIOMETRIC_SUBTYPE SubFactor,
    _In_reads_(IndexElementCount) ULONG IndexVector[],
    _In_ SIZE_T IndexElementCount);

typedef HRESULT(WINAPI *PIBIO_STORAGE_GET_RECORD_COUNT_FN)(
    _Inout_ PWINBIO_PIPELINE Pipeline, _Out_ PSIZE_T RecordCount);

typedef HRESULT(WINAPI *PIBIO_STORAGE_FIRST_RECORD_FN)(
    _Inout_ PWINBIO_PIPELINE Pipeline);

typedef HRESULT(WINAPI *PIBIO_STORAGE_NEXT_RECORD_FN)(
    _Inout_ PWINBIO_PIPELINE Pipeline);

typedef HRESULT(WINAPI *PIBIO_STORAGE_GET_CURRENT_RECORD_FN)(
    _Inout_ PWINBIO_PIPELINE Pipeline,
    _Out_ PWINBIO_STORAGE_RECORD RecordContents);

typedef HRESULT(WINAPI *PIBIO_STORAGE_CONTROL_UNIT_FN)(
    _Inout_ PWINBIO_PIPELINE Pipeline, _In_ ULONG ControlCode,
    _In_reads_bytes_(SendBufferSize) PUCHAR SendBuffer,
    _In_ SIZE_T SendBufferSize,
    _Out_writes_bytes_to_(ReceiveBufferSize, *ReceiveDataSize)
...
typedef HRESULT(WINAPI *PIBIO_STORAGE_CONTROL_UNIT_PRIVILEGED_FN)(
    _Inout_ PWINBIO_PIPELINE Pipeline, _In_ ULONG ControlCode,
    _In_reads_bytes_(SendBufferSize) PUCHAR SendBuffer,
    _In_ SIZE_T SendBufferSize,
    _Out_writes_bytes_to_(ReceiveBufferSize, *ReceiveDataSize)
...
// Additional methods available in V2.0 and later
//
typedef HRESULT(WINAPI *PIBIO_STORAGE_NOTIFY_POWER_CHANGE_FN)(
    _Inout_ PWINBIO_PIPELINE Pipeline, _In_ ULONG PowerEventType);
#endif
...
// Additional methods available in V3.0 and later
//
typedef HRESULT(WINAPI *PIBIO_STORAGE_PIPELINE_INIT_FN)(
    _Inout_ PWINBIO_PIPELINE Pipeline);

typedef HRESULT(WINAPI *PIBIO_STORAGE_PIPELINE_CLEANUP_FN)(
    _Inout_ PWINBIO_PIPELINE Pipeline);

typedef HRESULT(WINAPI *PIBIO_STORAGE_ACTIVATE_FN)(
    _Inout_ PWINBIO_PIPELINE Pipeline);

typedef HRESULT(WINAPI *PIBIO_STORAGE_DEACTIVATE_FN)(
    _Inout_ PWINBIO_PIPELINE Pipeline);

typedef HRESULT(WINAPI *PIBIO_STORAGE_QUERY_EXTENDED_INFO_FN)(
    _Inout_ PWINBIO_PIPELINE Pipeline,
    _Out_writes_bytes_(StorageInfoSize)
        PWINBIO_EXTENDED_STORAGE_INFO StorageInfo,
...
// Additional methods available in V4.0 and later
//
typedef HRESULT(WINAPI *PIBIO_STORAGE_NOTIFY_DATABASE_CHANGE_FN)(
    _Inout_ PWINBIO_PIPELINE Pipeline, _In_ BOOLEAN RecordsAdded);
...
// Additional methods available in V5.0 and later
//
typedef HRESULT(WINAPI *PIBIO_STORAGE_RESERVED_1_FN)(
    _Reserved_ PWINBIO_PIPELINE Pipeline, _Reserved_ PWINBIO_IDENTITY Identity,
    _Reserved_ PULONGLONG Reserved1, _Reserved_ PULONGLONG Reserved2);

typedef HRESULT(WINAPI *PIBIO_STORAGE_RESERVED_2_FN)(
    _Reserved_ PWINBIO_PIPELINE Pipeline, _Reserved_ PWINBIO_IDENTITY Identity);

typedef HRESULT(WINAPI *PIBIO_STORAGE_UPDATE_RECORD_BEGIN_FN)(
    _Inout_ PWINBIO_PIPELINE Pipeline, _In_ PWINBIO_IDENTITY Identity,
    _In_ WINBIO_BIOMETRIC_SUBTYPE SubFactor,
    _Out_ PWINBIO_STORAGE_RECORD RecordContents);

typedef HRESULT(WINAPI *PIBIO_STORAGE_UPDATE_RECORD_COMMIT_FN)(
    _Inout_ PWINBIO_PIPELINE Pipeline,
    _In_ PWINBIO_STORAGE_RECORD RecordContents);
...
HRESULT
WINAPI
WbioQueryStorageInterface(_Out_ PWINBIO_STORAGE_INTERFACE *StorageInterface);

//
// Pointer to an interface-retrieval function used by the
// framework after a 'GetProcAddress' call.
//
typedef HRESULT(WINAPI *PWINBIO_QUERY_STORAGE_INTERFACE_FN)(
...
//
///////////////////////////////////////////////////////////////////////////////
inline HRESULT WbioStorageAttach(_Inout_ PWINBIO_PIPELINE Pipeline) {
  if (!ARGUMENT_PRESENT(Pipeline) ||
...
inline HRESULT WbioStorageDetach(_Inout_ PWINBIO_PIPELINE Pipeline) {
  if (!ARGUMENT_PRESENT(Pipeline) ||
      !ARGUMENT_PRESENT(Pipeline->StorageInterface)) {
    return E_POINTER;
...
inline HRESULT WbioStorageClearContext(_Inout_ PWINBIO_PIPELINE Pipeline) {
  if (!ARGUMENT_PRESENT(Pipeline) ||
      !ARGUMENT_PRESENT(Pipeline->StorageInterface)) {
    return E_POINTER;
...
inline HRESULT WbioStorageCreateDatabase(
    _Inout_ PWINBIO_PIPELINE Pipeline, _In_ PWINBIO_UUID DatabaseId,
    _In_ WINBIO_BIOMETRIC_TYPE Factor, _In_ PWINBIO_UUID Format,
    _In_ LPCWSTR FilePath, _In_ LPCWSTR ConnectString,
    _In_ SIZE_T IndexElementCount, _In_ SIZE_T InitialSize) {
  if (!ARGUMENT_PRESENT(Pipeline) ||
    ...
    return Pipeline->StorageInterface->CreateDatabase(
        Pipeline, DatabaseId, Factor, Format, FilePath, ConnectString,
        IndexElementCount, InitialSize);
  }
}
//-----------------------------------------------------------------------------

inline HRESULT WbioStorageEraseDatabase(_Inout_ PWINBIO_PIPELINE Pipeline,
  ...
  if (!ARGUMENT_PRESENT(Pipeline) ||
    ...
    return Pipeline->StorageInterface->EraseDatabase(Pipeline, DatabaseId,
                                                     FilePath, ConnectString);
  }
}
//-----------------------------------------------------------------------------

inline HRESULT WbioStorageOpenDatabase(_Inout_ PWINBIO_PIPELINE Pipeline,
                                       _In_ PWINBIO_UUID DatabaseId,
                                       _In_ LPCWSTR FilePath,
                                       _In_ LPCWSTR ConnectString) {
  if (!ARGUMENT_PRESENT(Pipeline) ||
    ...
    return Pipeline->StorageInterface->OpenDatabase(Pipeline, DatabaseId,
                                                    FilePath, ConnectString);
  }
}
//-----------------------------------------------------------------------------

inline HRESULT WbioStorageCloseDatabase(_Inout_ PWINBIO_PIPELINE Pipeline) {
  if (!ARGUMENT_PRESENT(Pipeline) ||
      !ARGUMENT_PRESENT(Pipeline->StorageInterface)) {
    return E_POINTER;
...
inline HRESULT WbioStorageGetDataFormat(_Inout_ PWINBIO_PIPELINE Pipeline,
  ...
  if (!ARGUMENT_PRESENT(Pipeline) ||
    ...
    return Pipeline->StorageInterface->GetDataFormat(Pipeline, Format, Version);
  }
}
//-----------------------------------------------------------------------------

inline HRESULT WbioStorageGetDatabaseSize(_Inout_ PWINBIO_PIPELINE Pipeline,
  ...
  if (!ARGUMENT_PRESENT(Pipeline) ||
    ...
    return Pipeline->StorageInterface->GetDatabaseSize(
        Pipeline, AvailableRecordCount, TotalRecordCount);
  }
}
//-----------------------------------------------------------------------------

inline HRESULT
WbioStorageAddRecord(_Inout_ PWINBIO_PIPELINE Pipeline,
                     _In_ PWINBIO_STORAGE_RECORD RecordContents) {
  if (!ARGUMENT_PRESENT(Pipeline) ||
      !ARGUMENT_PRESENT(Pipeline->StorageInterface)) {
    return E_POINTER;
    ...
    return Pipeline->StorageInterface->AddRecord(Pipeline, RecordContents);
  }
}
//-----------------------------------------------------------------------------

inline HRESULT
WbioStorageDeleteRecord(_Inout_ PWINBIO_PIPELINE Pipeline,
                        _In_ PWINBIO_IDENTITY Identity,
                        _In_ WINBIO_BIOMETRIC_SUBTYPE SubFactor) {
  if (!ARGUMENT_PRESENT(Pipeline) ||
      !ARGUMENT_PRESENT(Pipeline->StorageInterface)) {
    ...
    return Pipeline->StorageInterface->DeleteRecord(Pipeline, Identity,
                                                    SubFactor);
  }
}
//-----------------------------------------------------------------------------
...
inline HRESULT
WbioStorageQueryBySubject(_Inout_ PWINBIO_PIPELINE Pipeline,
                          _In_ PWINBIO_IDENTITY Identity,
                          _In_ WINBIO_BIOMETRIC_SUBTYPE SubFactor) {
  if (!ARGUMENT_PRESENT(Pipeline) ||
      !ARGUMENT_PRESENT(Pipeline->StorageInterface)) {
    ...
    return Pipeline->StorageInterface->QueryBySubject(Pipeline, Identity,
                                                      SubFactor);
  }
}
//-----------------------------------------------------------------------------
...
inline HRESULT
WbioStorageQueryByContent(_Inout_ PWINBIO_PIPELINE Pipeline,
                          _In_ WINBIO_BIOMETRIC_SUBTYPE SubFactor,
                          _In_reads_(IndexElementCount) ULONG IndexVector[],
                          _In_ SIZE_T IndexElementCount) {
  if (!ARGUMENT_PRESENT(Pipeline) ||
    ...
    return Pipeline->StorageInterface->QueryByContent(
        Pipeline, SubFactor, IndexVector, IndexElementCount);
  }
}
//-----------------------------------------------------------------------------

inline HRESULT WbioStorageGetRecordCount(_Inout_ PWINBIO_PIPELINE Pipeline,
  ...
  if (!ARGUMENT_PRESENT(Pipeline) ||
    ...
    return Pipeline->StorageInterface->GetRecordCount(Pipeline, RecordCount);
  }
}
//-----------------------------------------------------------------------------

inline HRESULT WbioStorageFirstRecord(_Inout_ PWINBIO_PIPELINE Pipeline) {
  if (!ARGUMENT_PRESENT(Pipeline) ||
      !ARGUMENT_PRESENT(Pipeline->StorageInterface)) {
    return E_POINTER;
...
inline HRESULT WbioStorageNextRecord(_Inout_ PWINBIO_PIPELINE Pipeline) {
  if (!ARGUMENT_PRESENT(Pipeline) ||
      !ARGUMENT_PRESENT(Pipeline->StorageInterface)) {
    return E_POINTER;
...
inline HRESULT
WbioStorageGetCurrentRecord(_Inout_ PWINBIO_PIPELINE Pipeline,
                            _Out_ PWINBIO_STORAGE_RECORD RecordContents) {
  if (!ARGUMENT_PRESENT(Pipeline) ||
      !ARGUMENT_PRESENT(Pipeline->StorageInterface)) {
    return E_POINTER;
    ...
    return Pipeline->StorageInterface->GetCurrentRecord(Pipeline,
                                                        RecordContents);
  }
}
//-----------------------------------------------------------------------------

inline HRESULT WbioStorageControlUnit(
    _Inout_ PWINBIO_PIPELINE Pipeline, _In_ ULONG ControlCode,
    _In_reads_bytes_(SendBufferSize) PUCHAR SendBuffer,
    _In_ SIZE_T SendBufferSize,
    _Out_writes_bytes_to_(ReceiveBufferSize, *ReceiveDataSize)
...
inline HRESULT WbioStorageControlUnitPrivileged(
    _Inout_ PWINBIO_PIPELINE Pipeline, _In_ ULONG ControlCode,
    _In_reads_bytes_(SendBufferSize) PUCHAR SendBuffer,
    _In_ SIZE_T SendBufferSize,
    _Out_writes_bytes_to_(ReceiveBufferSize, *ReceiveDataSize)
  ...
  if (!ARGUMENT_PRESENT(Pipeline) ||
    ...
    return E_POINTER;
                 ...
                 Pipeline->StorageInterface->ControlUnitPrivileged)) {
    return E_NOTIMPL;
  } else {
...
inline HRESULT WbioStorageNotifyPowerChange(_Inout_ PWINBIO_PIPELINE Pipeline,
                                            _In_ ULONG PowerEventType) {
  if (!ARGUMENT_PRESENT(Pipeline) ||
      !ARGUMENT_PRESENT(Pipeline->StorageInterface)) {
    return E_POINTER;
    ...
    return Pipeline->StorageInterface->NotifyPowerChange(Pipeline,
                                                         PowerEventType);
  }
}
//-----------------------------------------------------------------------------
...
inline HRESULT WbioStoragePipelineInit(_Inout_ PWINBIO_PIPELINE Pipeline) {
  if (!ARGUMENT_PRESENT(Pipeline) ||
      !ARGUMENT_PRESENT(Pipeline->StorageInterface)) {
    return E_POINTER;
...
inline HRESULT WbioStoragePipelineCleanup(_Inout_ PWINBIO_PIPELINE Pipeline) {
  if (!ARGUMENT_PRESENT(Pipeline) ||
      !ARGUMENT_PRESENT(Pipeline->StorageInterface)) {
    return E_POINTER;
...
inline HRESULT WbioStorageActivate(_Inout_ PWINBIO_PIPELINE Pipeline) {
  if (!ARGUMENT_PRESENT(Pipeline) ||
      !ARGUMENT_PRESENT(Pipeline->StorageInterface)) {
    return E_POINTER;
...
inline HRESULT WbioStorageDeactivate(_Inout_ PWINBIO_PIPELINE Pipeline) {
  if (!ARGUMENT_PRESENT(Pipeline) ||
      !ARGUMENT_PRESENT(Pipeline->StorageInterface)) {
    return E_POINTER;
...
inline HRESULT
WbioStorageQueryExtendedInfo(_Inout_ PWINBIO_PIPELINE Pipeline,
                             _Out_writes_bytes_(StorageInfoSize)
                                 PWINBIO_EXTENDED_STORAGE_INFO StorageInfo,
                             _In_ SIZE_T StorageInfoSize) {
  if (!ARGUMENT_PRESENT(Pipeline) ||
    ...
    return Pipeline->StorageInterface->QueryExtendedInfo(Pipeline, StorageInfo,
                                                         StorageInfoSize);
  }
}
//-----------------------------------------------------------------------------
...
inline HRESULT
WbioStorageNotifyDatabaseChange(_Inout_ PWINBIO_PIPELINE Pipeline,
                                _In_ BOOLEAN RecordsAdded) {
  if (!ARGUMENT_PRESENT(Pipeline) ||
      !ARGUMENT_PRESENT(Pipeline->StorageInterface)) {
    return E_POINTER;
  } else if (!ARGUMENT_PRESENT(
                 Pipeline->StorageInterface->NotifyDatabaseChange)) {
    return E_NOTIMPL;
  } else {
    return Pipeline->StorageInterface->NotifyDatabaseChange(Pipeline,
                                                            RecordsAdded);
  }
}
//-----------------------------------------------------------------------------
...
inline HRESULT
WbioStorageUpdateRecordBegin(_Inout_ PWINBIO_PIPELINE Pipeline,
                             _In_ PWINBIO_IDENTITY Identity,
                             _In_ WINBIO_BIOMETRIC_SUBTYPE SubFactor,
                             _Out_ PWINBIO_STORAGE_RECORD RecordContents) {
  if (!ARGUMENT_PRESENT(Pipeline) ||
    ...
    return Pipeline->StorageInterface->UpdateRecordBegin(
        Pipeline, Identity, SubFactor, RecordContents);
  }
}

inline HRESULT
WbioStorageUpdateRecordCommit(_Inout_ PWINBIO_PIPELINE Pipeline,
                              _In_ PWINBIO_STORAGE_RECORD RecordContents) {
  if (!ARGUMENT_PRESENT(Pipeline) ||
      !ARGUMENT_PRESENT(Pipeline->StorageInterface)) {
    return E_POINTER;
  } else if (!ARGUMENT_PRESENT(
                 Pipeline->StorageInterface->UpdateRecordCommit)) {
    return E_NOTIMPL;
  } else {
    return Pipeline->StorageInterface->UpdateRecordCommit(Pipeline,
                                                          RecordContents);
  }
}
//-----------------------------------------------------------------------------
...
//
typedef HRESULT(WINAPI *PIBIO_FRAMEWORK_SET_UNIT_STATUS_FN)(
    _Inout_ PWINBIO_PIPELINE Pipeline,
    _In_reads_bytes_(ExtendedStatusSize)
        PWINBIO_EXTENDED_UNIT_STATUS ExtendedStatus,
...
//
typedef HRESULT(WINAPI *PIBIO_FRAMEWORK_VSM_CACHE_CLEAR_FN)(
    _Inout_ PWINBIO_PIPELINE Pipeline);

typedef HRESULT(WINAPI *PIBIO_FRAMEWORK_VSM_CACHE_IMPORT_BEGIN_FN)(
    _Inout_ PWINBIO_PIPELINE Pipeline, _In_ SIZE_T RequiredCapacity,
    _Out_ PSIZE_T MaxBufferSize);

typedef HRESULT(WINAPI *PIBIO_FRAMEWORK_VSM_CACHE_IMPORT_NEXT_FN)(
    _Inout_ PWINBIO_PIPELINE Pipeline,
    _In_reads_bytes_(BufferSize) PUCHAR BufferAddress, _In_ SIZE_T BufferSize);

typedef HRESULT(WINAPI *PIBIO_FRAMEWORK_VSM_CACHE_IMPORT_END_FN)(
    _Inout_ PWINBIO_PIPELINE Pipeline);

typedef HRESULT(WINAPI *PIBIO_FRAMEWORK_VSM_CACHE_EXPORT_BEGIN_FN)(
    _Inout_ PWINBIO_PIPELINE Pipeline, _Out_ PSIZE_T RequiredCapacity,
    _Out_ PSIZE_T MaxBufferSize);

typedef HRESULT(WINAPI *PIBIO_FRAMEWORK_VSM_CACHE_EXPORT_NEXT_FN)(
    _Inout_ PWINBIO_PIPELINE Pipeline,
    _Out_writes_bytes_to_(BufferSize, *ReturnedDataSize) PUCHAR BufferAddress,
    _In_ SIZE_T BufferSize, _Out_ PSIZE_T ReturnedDataSize);

typedef HRESULT(WINAPI *PIBIO_FRAMEWORK_VSM_CACHE_EXPORT_END_FN)(
    _Inout_ PWINBIO_PIPELINE Pipeline);
...
//
typedef HRESULT(WINAPI *PIBIO_FRAMEWORK_VSM_STORAGE_RESERVED_1_FN)(
    _Reserved_ PWINBIO_PIPELINE Pipeline, _In_ SIZE_T Reserved1,
    _Reserved_ PSIZE_T Reserved2);

typedef HRESULT(WINAPI *PIBIO_FRAMEWORK_VSM_STORAGE_RESERVED_2_FN)(
    _Reserved_ PWINBIO_PIPELINE Pipeline, _Reserved_ PUCHAR Reserved1,
    _In_ SIZE_T Reserved2);

typedef HRESULT(WINAPI *PIBIO_FRAMEWORK_VSM_STORAGE_RESERVED_3_FN)(
    _Reserved_ PWINBIO_PIPELINE Pipeline);

typedef HRESULT(WINAPI *PIBIO_FRAMEWORK_ALLOCATE_MEMORY_FN)(
    _Inout_ PWINBIO_PIPELINE Pipeline, _In_ SIZE_T AllocationSize,
    _Out_ PVOID *Address);

typedef HRESULT(WINAPI *PIBIO_FRAMEWORK_FREE_MEMORY_FN)(
    _Inout_ PWINBIO_PIPELINE Pipeline, _In_ PVOID Address);

typedef HRESULT(WINAPI *PIBIO_FRAMEWORK_GET_PROPERTY_FN)(
    _Inout_ PWINBIO_PIPELINE Pipeline, _In_ WINBIO_PROPERTY_TYPE PropertyType,
    _In_ WINBIO_PROPERTY_ID PropertyId, _In_opt_ WINBIO_IDENTITY *Identity,
    _In_opt_ WINBIO_BIOMETRIC_SUBTYPE SubFactor,
    _Outptr_result_bytebuffer_maybenull_(*PropertyBufferSize)
...
//
typedef HRESULT(WINAPI *PIBIO_FRAMEWORK_LOCK_AND_VALIDATE_SECURE_BUFFER_FN)(
    _Inout_ PWINBIO_PIPELINE Pipeline, _In_ GUID SecureBufferIdentifier,
    _Outptr_result_bytebuffer_(*SecureBufferSize) PVOID *SecureBufferAddress,
    _Out_ SIZE_T *SecureBufferSize);

typedef HRESULT(WINAPI *PIBIO_FRAMEWORK_RELEASE_SECURE_BUFFER_FN)(
    _Inout_ PWINBIO_PIPELINE Pipeline, _In_ GUID SecureBufferIdentifier);
...
typedef HRESULT(WINAPI *PIBIO_FRAMEWORK_VSM_QUERY_AUTHORIZED_ENROLLMENTS_FN)(
    _Inout_ PWINBIO_PIPELINE Pipeline, _In_ PWINBIO_IDENTITY Identity,
    _Out_ SIZE_T *SecureIdentityCount,
    _Outptr_result_buffer_(*SecureIdentityCount)
        PWINBIO_IDENTITY *SecureIdentities);

typedef HRESULT(WINAPI *PIBIO_FRAMEWORK_VSM_DECRYPT_SAMPLE_FN)(
    _Inout_ PWINBIO_PIPELINE Pipeline,
    _In_reads_bytes_(AuthenticationSize) const UCHAR *Authentication,
    _In_ SIZE_T AuthenticationSize, _In_reads_bytes_(IvSize) const UCHAR *Iv,
    _In_ SIZE_T IvSize,
...
// Available interface versions...
//
#define WINBIO_FRAMEWORK_INTERFACE_VERSION_3_1                                 \
  WINBIO_MAKE_INTERFACE_VERSION(3, 1)

#if (NTDDI_VERSION >= NTDDI_WIN10_RS1)
#define WINBIO_FRAMEWORK_INTERFACE_VERSION_4_0                                 \
  WINBIO_MAKE_INTERFACE_VERSION(4, 0)
#endif

#if (NTDDI_VERSION >= NTDDI_WIN10_RS2)
#define WINBIO_FRAMEWORK_INTERFACE_VERSION_5_0                                 \
  WINBIO_MAKE_INTERFACE_VERSION(5, 0)
#endif

#if (NTDDI_VERSION >= NTDDI_WIN10_RS3)
#define WINBIO_FRAMEWORK_INTERFACE_VERSION_6_0                                 \
  WINBIO_MAKE_INTERFACE_VERSION(6, 0)
#endif

#if (NTDDI_VERSION >= NTDDI_WIN10_RS4)
#define WINBIO_FRAMEWORK_INTERFACE_VERSION_7_0                                 \
  WINBIO_MAKE_INTERFACE_VERSION(7, 0)
#endif
...
#define WINBIO_IS_FRAMEWORK_VERSION_COMPATIBLE(pipeline, requiredVersion)      \
  ((pipeline->FrameworkInterface->Version.MajorVersion >                       \
    requiredVersion.MajorVersion) ||                                           \
   ((pipeline->FrameworkInterface->Version.MajorVersion ==                     \
     requiredVersion.MajorVersion) &&                                          \
    (pipeline->FrameworkInterface->Version.MinorVersion >=                     \
     requiredVersion.MinorVersion)))
...
///////////////////////////////////////////////////////////////////////////////
inline HRESULT
WbioFrameworkSetUnitStatus(_Inout_ PWINBIO_PIPELINE Pipeline,
                           _In_reads_bytes_(ExtendedStatusSize)
                               PWINBIO_EXTENDED_UNIT_STATUS ExtendedStatus,
                           _In_ SIZE_T ExtendedStatusSize) {
  if (!ARGUMENT_PRESENT(Pipeline) ||
...
inline HRESULT
WbioFrameworkVsmStorageAttach(_Inout_ PWINBIO_PIPELINE Pipeline) {
  if (!ARGUMENT_PRESENT(Pipeline) ||
      !ARGUMENT_PRESENT(Pipeline->SensorInterface)) {
    return E_POINTER;
  } else {
    WINBIO_ADAPTER_INTERFACE_VERSION requiredFrameworkVersion =
        WINBIO_FRAMEWORK_INTERFACE_VERSION_4_0;
...
inline HRESULT
WbioFrameworkVsmStorageDetach(_Inout_ PWINBIO_PIPELINE Pipeline) {
  if (!ARGUMENT_PRESENT(Pipeline) ||
      !ARGUMENT_PRESENT(Pipeline->SensorInterface)) {
    return E_POINTER;
  } else {
...
inline HRESULT
WbioFrameworkVsmStorageClearContext(_Inout_ PWINBIO_PIPELINE Pipeline) {
  if (!ARGUMENT_PRESENT(Pipeline) ||
      !ARGUMENT_PRESENT(Pipeline->SensorInterface)) {
    return E_POINTER;
  } else {
    ...
    if (Pipeline->SensorInterface->Version.MinorVersion == 0 ||
        ...
        !WINBIO_IS_FRAMEWORK_VERSION_COMPATIBLE(Pipeline,
                                                requiredFrameworkVersion) ||
        !ARGUMENT_PRESENT(
            Pipeline->FrameworkInterface->VsmStorageClearContext)) {
      return E_NOTIMPL;
    } else {
...
inline HRESULT WbioFrameworkVsmStorageCreateDatabase(
    _Inout_ PWINBIO_PIPELINE Pipeline, _In_ PWINBIO_UUID DatabaseId,
    _In_ WINBIO_BIOMETRIC_TYPE Factor, _In_ PWINBIO_UUID Format,
    _In_ LPCWSTR FilePath, _In_ LPCWSTR ConnectString,
    _In_ SIZE_T IndexElementCount, _In_ SIZE_T InitialSize) {
  if (!ARGUMENT_PRESENT(Pipeline) ||
    ...
    if (Pipeline->SensorInterface->Version.MinorVersion == 0 ||
        ...
        !WINBIO_IS_FRAMEWORK_VERSION_COMPATIBLE(Pipeline,
                                                requiredFrameworkVersion) ||
        !ARGUMENT_PRESENT(
            Pipeline->FrameworkInterface->VsmStorageCreateDatabase)) {
      return E_NOTIMPL;
    } else {
...
inline HRESULT WbioFrameworkVsmStorageOpenDatabase(
    _Inout_ PWINBIO_PIPELINE Pipeline, _In_ PWINBIO_UUID DatabaseId,
    _In_ LPCWSTR FilePath, _In_ LPCWSTR ConnectString) {
  if (!ARGUMENT_PRESENT(Pipeline) ||
      !ARGUMENT_PRESENT(Pipeline->SensorInterface)) {
    ...
    if (Pipeline->SensorInterface->Version.MinorVersion == 0 ||
        ...
        !WINBIO_IS_FRAMEWORK_VERSION_COMPATIBLE(Pipeline,
                                                requiredFrameworkVersion) ||
        !ARGUMENT_PRESENT(
            Pipeline->FrameworkInterface->VsmStorageOpenDatabase)) {
      return E_NOTIMPL;
    } else {
      return Pipeline->FrameworkInterface->VsmStorageOpenDatabase(
          Pipeline, DatabaseId, FilePath, ConnectString);
    }
  }
}
//-----------------------------------------------------------------------------
...
inline HRESULT
WbioFrameworkVsmStorageCloseDatabase(_Inout_ PWINBIO_PIPELINE Pipeline) {
  if (!ARGUMENT_PRESENT(Pipeline) ||
      !ARGUMENT_PRESENT(Pipeline->SensorInterface)) {
    return E_POINTER;
  } else {
    ...
    if (Pipeline->SensorInterface->Version.MinorVersion == 0 ||
        ...
        !WINBIO_IS_FRAMEWORK_VERSION_COMPATIBLE(Pipeline,
                                                requiredFrameworkVersion) ||
        !ARGUMENT_PRESENT(
            Pipeline->FrameworkInterface->VsmStorageCloseDatabase)) {
      return E_NOTIMPL;
    } else {
...
inline HRESULT
WbioFrameworkVsmStorageDeleteRecord(_Inout_ PWINBIO_PIPELINE Pipeline,
                                    _In_ PWINBIO_IDENTITY Identity,
                                    _In_ WINBIO_BIOMETRIC_SUBTYPE SubFactor) {
  if (!ARGUMENT_PRESENT(Pipeline) ||
      !ARGUMENT_PRESENT(Pipeline->SensorInterface)) {
    ...
    if (Pipeline->SensorInterface->Version.MinorVersion == 0 ||
        ...
        !WINBIO_IS_FRAMEWORK_VERSION_COMPATIBLE(Pipeline,
                                                requiredFrameworkVersion) ||
        !ARGUMENT_PRESENT(
            Pipeline->FrameworkInterface->VsmStorageDeleteRecord)) {
      return E_NOTIMPL;
    } else {
      return Pipeline->FrameworkInterface->VsmStorageDeleteRecord(
          Pipeline, Identity, SubFactor);
    }
  }
}
//-----------------------------------------------------------------------------
...
inline HRESULT
WbioFrameworkVsmStorageNotifyPowerChange(_Inout_ PWINBIO_PIPELINE Pipeline,
                                         _In_ ULONG PowerEventType) {
  if (!ARGUMENT_PRESENT(Pipeline) ||
      !ARGUMENT_PRESENT(Pipeline->SensorInterface)) {
    return E_POINTER;
    ...
    if (Pipeline->SensorInterface->Version.MinorVersion == 0 ||
        ...
        !WINBIO_IS_FRAMEWORK_VERSION_COMPATIBLE(Pipeline,
                                                requiredFrameworkVersion) ||
        !ARGUMENT_PRESENT(
            Pipeline->FrameworkInterface->VsmStorageNotifyPowerChange)) {
      return E_NOTIMPL;
    } else {
      return Pipeline->FrameworkInterface->VsmStorageNotifyPowerChange(
          Pipeline, PowerEventType);
    }
  }
}
//-----------------------------------------------------------------------------
...
inline HRESULT
WbioFrameworkVsmStoragePipelineInit(_Inout_ PWINBIO_PIPELINE Pipeline) {
  if (!ARGUMENT_PRESENT(Pipeline) ||
      !ARGUMENT_PRESENT(Pipeline->SensorInterface)) {
    return E_POINTER;
  } else {
    ...
    if (Pipeline->SensorInterface->Version.MinorVersion == 0 ||
        ...
        !WINBIO_IS_FRAMEWORK_VERSION_COMPATIBLE(Pipeline,
                                                requiredFrameworkVersion) ||
        !ARGUMENT_PRESENT(
            Pipeline->FrameworkInterface->VsmStoragePipelineInit)) {
      return E_NOTIMPL;
    } else {
...
inline HRESULT
WbioFrameworkVsmStoragePipelineCleanup(_Inout_ PWINBIO_PIPELINE Pipeline) {
  if (!ARGUMENT_PRESENT(Pipeline) ||
      !ARGUMENT_PRESENT(Pipeline->SensorInterface)) {
    return E_POINTER;
  } else {
    ...
    if (Pipeline->SensorInterface->Version.MinorVersion == 0 ||
        ...
        !WINBIO_IS_FRAMEWORK_VERSION_COMPATIBLE(Pipeline,
                                                requiredFrameworkVersion) ||
        !ARGUMENT_PRESENT(
            Pipeline->FrameworkInterface->VsmStoragePipelineCleanup)) {
      return E_NOTIMPL;
    } else {
...
inline HRESULT
WbioFrameworkVsmStorageActivate(_Inout_ PWINBIO_PIPELINE Pipeline) {
  if (!ARGUMENT_PRESENT(Pipeline) ||
      !ARGUMENT_PRESENT(Pipeline->SensorInterface)) {
    return E_POINTER;
  } else {
...
inline HRESULT
WbioFrameworkVsmStorageDeactivate(_Inout_ PWINBIO_PIPELINE Pipeline) {
  if (!ARGUMENT_PRESENT(Pipeline) ||
      !ARGUMENT_PRESENT(Pipeline->SensorInterface)) {
    return E_POINTER;
  } else {
...
inline HRESULT WbioFrameworkVsmStorageQueryExtendedInfo(
    _Inout_ PWINBIO_PIPELINE Pipeline,
    _Out_writes_bytes_(StorageInfoSize)
        PWINBIO_EXTENDED_STORAGE_INFO StorageInfo,
    _In_ SIZE_T StorageInfoSize) {
  if (!ARGUMENT_PRESENT(Pipeline) ||
    ...
    if (Pipeline->SensorInterface->Version.MinorVersion == 0 ||
        ...
        !WINBIO_IS_FRAMEWORK_VERSION_COMPATIBLE(Pipeline,
                                                requiredFrameworkVersion) ||
        !ARGUMENT_PRESENT(
            Pipeline->FrameworkInterface->VsmStorageQueryExtendedInfo)) {
      return E_NOTIMPL;
    } else {
      return Pipeline->FrameworkInterface->VsmStorageQueryExtendedInfo(
          Pipeline, StorageInfo, StorageInfoSize);
    }
  }
}
//-----------------------------------------------------------------------------
...
inline HRESULT
WbioFrameworkVsmStorageCacheClear(_Inout_ PWINBIO_PIPELINE Pipeline) {
  if (!ARGUMENT_PRESENT(Pipeline) ||
      !ARGUMENT_PRESENT(Pipeline->SensorInterface)) {
    return E_POINTER;
  } else {
...
inline HRESULT
WbioFrameworkVsmStorageCacheImportBegin(_Inout_ PWINBIO_PIPELINE Pipeline,
  ...
  if (!ARGUMENT_PRESENT(Pipeline) ||
    ...
    if (Pipeline->SensorInterface->Version.MinorVersion == 0 ||
        ...
        !WINBIO_IS_FRAMEWORK_VERSION_COMPATIBLE(Pipeline,
                                                requiredFrameworkVersion) ||
        !ARGUMENT_PRESENT(
            Pipeline->FrameworkInterface->VsmStorageCacheImportBegin)) {
      return E_NOTIMPL;
    } else {
      return Pipeline->FrameworkInterface->VsmStorageCacheImportBegin(
          Pipeline, RequiredCapacity, MaxBufferSize);
    }
  }
}
//-----------------------------------------------------------------------------

inline HRESULT WbioFrameworkVsmStorageCacheImportNext(
    _Inout_ PWINBIO_PIPELINE Pipeline,
    _In_reads_bytes_(BufferSize) PUCHAR BufferAddress, _In_ SIZE_T BufferSize) {
  if (!ARGUMENT_PRESENT(Pipeline) ||
      !ARGUMENT_PRESENT(Pipeline->SensorInterface)) {
    ...
    if (Pipeline->SensorInterface->Version.MinorVersion == 0 ||
        ...
        !WINBIO_IS_FRAMEWORK_VERSION_COMPATIBLE(Pipeline,
                                                requiredFrameworkVersion) ||
        !ARGUMENT_PRESENT(
            Pipeline->FrameworkInterface->VsmStorageCacheImportNext)) {
      return E_NOTIMPL;
    } else {
      return Pipeline->FrameworkInterface->VsmStorageCacheImportNext(
          Pipeline, BufferAddress, BufferSize);
    }
  }
}
//-----------------------------------------------------------------------------
...
inline HRESULT
WbioFrameworkVsmStorageCacheImportEnd(_Inout_ PWINBIO_PIPELINE Pipeline) {
  if (!ARGUMENT_PRESENT(Pipeline) ||
      !ARGUMENT_PRESENT(Pipeline->SensorInterface)) {
    return E_POINTER;
  } else {
    ...
    if (Pipeline->SensorInterface->Version.MinorVersion == 0 ||
        ...
        !WINBIO_IS_FRAMEWORK_VERSION_COMPATIBLE(Pipeline,
                                                requiredFrameworkVersion) ||
        !ARGUMENT_PRESENT(
            Pipeline->FrameworkInterface->VsmStorageCacheImportEnd)) {
      return E_NOTIMPL;
    } else {
...
inline HRESULT
WbioFrameworkVsmStorageCacheExportBegin(_Inout_ PWINBIO_PIPELINE Pipeline,
  ...
  if (!ARGUMENT_PRESENT(Pipeline) ||
    ...
    if (Pipeline->SensorInterface->Version.MinorVersion == 0 ||
        ...
        !WINBIO_IS_FRAMEWORK_VERSION_COMPATIBLE(Pipeline,
                                                requiredFrameworkVersion) ||
        !ARGUMENT_PRESENT(
            Pipeline->FrameworkInterface->VsmStorageCacheExportBegin)) {
      return E_NOTIMPL;
    } else {
...
inline HRESULT WbioFrameworkVsmStorageCacheExportNext(
    _Inout_ PWINBIO_PIPELINE Pipeline,
    _Out_writes_bytes_to_(BufferSize, *ReturnedDataSize) PUCHAR BufferAddress,
    _In_ SIZE_T BufferSize, _Out_ PSIZE_T ReturnedDataSize) {
  if (!ARGUMENT_PRESENT(Pipeline) ||
    ...
    if (Pipeline->SensorInterface->Version.MinorVersion == 0 ||
        ...
        !WINBIO_IS_FRAMEWORK_VERSION_COMPATIBLE(Pipeline,
                                                requiredFrameworkVersion) ||
        !ARGUMENT_PRESENT(
            Pipeline->FrameworkInterface->VsmStorageCacheExportNext)) {
      return E_NOTIMPL;
    } else {
      return Pipeline->FrameworkInterface->VsmStorageCacheExportNext(
          Pipeline, BufferAddress, BufferSize, ReturnedDataSize);
    }
  }
}
//-----------------------------------------------------------------------------
...
inline HRESULT
WbioFrameworkVsmStorageCacheExportEnd(_Inout_ PWINBIO_PIPELINE Pipeline) {
  if (!ARGUMENT_PRESENT(Pipeline) ||
      !ARGUMENT_PRESENT(Pipeline->SensorInterface)) {
    return E_POINTER;
  } else {
    ...
    if (Pipeline->SensorInterface->Version.MinorVersion == 0 ||
        ...
        !WINBIO_IS_FRAMEWORK_VERSION_COMPATIBLE(Pipeline,
                                                requiredFrameworkVersion) ||
        !ARGUMENT_PRESENT(
            Pipeline->FrameworkInterface->VsmStorageCacheExportEnd)) {
      return E_NOTIMPL;
    } else {
...
inline HRESULT WbioFrameworkVsmSensorAttach(_Inout_ PWINBIO_PIPELINE Pipeline) {
  if (!ARGUMENT_PRESENT(Pipeline) ||
      !ARGUMENT_PRESENT(Pipeline->SensorInterface)) {
    return E_POINTER;
  } else {
    WINBIO_ADAPTER_INTERFACE_VERSION requiredFrameworkVersion =
        WINBIO_FRAMEWORK_INTERFACE_VERSION_5_0;
...
inline HRESULT
WbioFrameworkVsmSensoreDetach(_Inout_ PWINBIO_PIPELINE Pipeline) {
  if (!ARGUMENT_PRESENT(Pipeline) ||
      !ARGUMENT_PRESENT(Pipeline->SensorInterface)) {
    return E_POINTER;
  } else {
...
inline HRESULT
WbioFrameworkVsmSensorClearContext(_Inout_ PWINBIO_PIPELINE Pipeline) {
  if (!ARGUMENT_PRESENT(Pipeline) ||
      !ARGUMENT_PRESENT(Pipeline->SensorInterface)) {
    return E_POINTER;
  } else {
    ...
    if (Pipeline->SensorInterface->Version.MinorVersion == 0 ||
        ...
        !WINBIO_IS_FRAMEWORK_VERSION_COMPATIBLE(Pipeline,
                                                requiredFrameworkVersion) ||
        !ARGUMENT_PRESENT(
            Pipeline->FrameworkInterface->VsmSensorClearContext)) {
      return E_NOTIMPL;
    } else {
...
inline HRESULT WbioFrameworkVsmSensorPushDataToEngine(
    _Inout_ PWINBIO_PIPELINE Pipeline, _In_ WINBIO_BIR_PURPOSE Purpose,
    _In_ WINBIO_BIR_DATA_FLAGS Flags,
    _Out_ PWINBIO_REJECT_DETAIL RejectDetail) {
  if (!ARGUMENT_PRESENT(Pipeline) ||
    ...
    if (Pipeline->SensorInterface->Version.MinorVersion == 0 ||
        ...
        !WINBIO_IS_FRAMEWORK_VERSION_COMPATIBLE(Pipeline,
                                                requiredFrameworkVersion) ||
        !ARGUMENT_PRESENT(
            Pipeline->FrameworkInterface->VsmSensorPushDataToEngine)) {
      return E_NOTIMPL;
    } else {
      return Pipeline->FrameworkInterface->VsmSensorPushDataToEngine(
          Pipeline, Purpose, Flags, RejectDetail);
    }
  }
}
//-----------------------------------------------------------------------------
...
inline HRESULT
WbioFrameworkVsmSensorNotifyPowerChange(_Inout_ PWINBIO_PIPELINE Pipeline,
                                        _In_ ULONG PowerEventType) {
  if (!ARGUMENT_PRESENT(Pipeline) ||
      !ARGUMENT_PRESENT(Pipeline->SensorInterface)) {
    return E_POINTER;
    ...
    if (Pipeline->SensorInterface->Version.MinorVersion == 0 ||
        ...
        !WINBIO_IS_FRAMEWORK_VERSION_COMPATIBLE(Pipeline,
                                                requiredFrameworkVersion) ||
        !ARGUMENT_PRESENT(
            Pipeline->FrameworkInterface->VsmSensorNotifyPowerChange)) {
      return E_NOTIMPL;
    } else {
...
inline HRESULT
WbioFrameworkVsmSensorPipelineInit(_Inout_ PWINBIO_PIPELINE Pipeline) {
  if (!ARGUMENT_PRESENT(Pipeline) ||
      !ARGUMENT_PRESENT(Pipeline->SensorInterface)) {
    return E_POINTER;
  } else {
    ...
    if (Pipeline->SensorInterface->Version.MinorVersion == 0 ||
        ...
        !WINBIO_IS_FRAMEWORK_VERSION_COMPATIBLE(Pipeline,
                                                requiredFrameworkVersion) ||
        !ARGUMENT_PRESENT(
            Pipeline->FrameworkInterface->VsmSensorPipelineInit)) {
      return E_NOTIMPL;
    } else {
...
inline HRESULT
WbioFrameworkVsmSensorPipelineCleanup(_Inout_ PWINBIO_PIPELINE Pipeline) {
  if (!ARGUMENT_PRESENT(Pipeline) ||
      !ARGUMENT_PRESENT(Pipeline->SensorInterface)) {
    return E_POINTER;
  } else {
    ...
    if (Pipeline->SensorInterface->Version.MinorVersion == 0 ||
        ...
        !WINBIO_IS_FRAMEWORK_VERSION_COMPATIBLE(Pipeline,
                                                requiredFrameworkVersion) ||
        !ARGUMENT_PRESENT(
            Pipeline->FrameworkInterface->VsmSensorPipelineCleanup)) {
      return E_NOTIMPL;
    } else {
...
inline HRESULT
WbioFrameworkVsmSensorActivate(_Inout_ PWINBIO_PIPELINE Pipeline) {
  if (!ARGUMENT_PRESENT(Pipeline) ||
      !ARGUMENT_PRESENT(Pipeline->SensorInterface)) {
    return E_POINTER;
  } else {
...
inline HRESULT
WbioFrameworkVsmSensorDeactivate(_Inout_ PWINBIO_PIPELINE Pipeline) {
  if (!ARGUMENT_PRESENT(Pipeline) ||
      !ARGUMENT_PRESENT(Pipeline->SensorInterface)) {
    return E_POINTER;
  } else {
...
inline HRESULT WbioFrameworkVsmSensorAsyncImportRawBuffer(
    _Inout_ PWINBIO_PIPELINE Pipeline,
    _In_reads_bytes_opt_(RawBufferSize) PUCHAR RawBufferAddress,
    _In_ SIZE_T RawBufferSize,
    _Outptr_result_bytebuffer_maybenull_(*ResultBufferSize)
  ...
  if (!ARGUMENT_PRESENT(Pipeline) ||
    ...
    if (Pipeline->SensorInterface->Version.MinorVersion == 0 ||
        ...
        !WINBIO_IS_FRAMEWORK_VERSION_COMPATIBLE(Pipeline,
                                                requiredFrameworkVersion) ||
        !ARGUMENT_PRESENT(
            Pipeline->FrameworkInterface->VsmSensorAsyncImportRawBuffer)) {
      return E_NOTIMPL;
    } else {
...
inline HRESULT WbioFrameworkVsmSensorAsyncImportSecureBuffer(
    _Inout_ PWINBIO_PIPELINE Pipeline, _In_ GUID SecureBufferIdentifier,
    _In_reads_bytes_opt_(MetadataBufferSize) PUCHAR MetadataBufferAddress,
    _In_ SIZE_T MetadataBufferSize,
    _Outptr_result_bytebuffer_maybenull_(*ResultBufferSize)
  ...
  if (!ARGUMENT_PRESENT(Pipeline) ||
    ...
    if (Pipeline->SensorInterface->Version.MinorVersion == 0 ||
        ...
        !WINBIO_IS_FRAMEWORK_VERSION_COMPATIBLE(Pipeline,
                                                requiredFrameworkVersion) ||
        !ARGUMENT_PRESENT(
            Pipeline->FrameworkInterface->VsmSensorAsyncImportSecureBuffer)) {
      return E_NOTIMPL;
    } else {
...
inline HRESULT WbioFrameworkAllocateMemory(_Inout_ PWINBIO_PIPELINE Pipeline,
  ...
  if (!ARGUMENT_PRESENT(Pipeline) ||
    ...
    if (Pipeline->SensorInterface->Version.MinorVersion == 0 ||
      ...
      return Pipeline->FrameworkInterface->AllocateMemory(
          Pipeline, AllocationSize, Address);
    }
  }
}
//-----------------------------------------------------------------------------

inline HRESULT WbioFrameworkFreeMemory(_Inout_ PWINBIO_PIPELINE Pipeline,
                                       _In_ PVOID Address) {
  if (!ARGUMENT_PRESENT(Pipeline) ||
      !ARGUMENT_PRESENT(Pipeline->SensorInterface)) {
    return E_POINTER;
    ...
    if (Pipeline->SensorInterface->Version.MinorVersion == 0 ||
      ...
      return Pipeline->FrameworkInterface->FreeMemory(Pipeline, Address);
    }
  }
}
//-----------------------------------------------------------------------------

inline HRESULT WbioFrameworkGetProperty(
    _Inout_ PWINBIO_PIPELINE Pipeline, _In_ WINBIO_PROPERTY_TYPE PropertyType,
    _In_ WINBIO_PROPERTY_ID PropertyId, _In_opt_ WINBIO_IDENTITY *Identity,
    _In_opt_ WINBIO_BIOMETRIC_SUBTYPE SubFactor,
    _Outptr_result_bytebuffer_maybenull_(*PropertyBufferSize)
  ...
  if (!ARGUMENT_PRESENT(Pipeline) ||
    ...
    if (Pipeline->SensorInterface->Version.MinorVersion == 0 ||
      ...
      return Pipeline->FrameworkInterface->GetProperty(
          Pipeline, PropertyType, PropertyId, Identity, SubFactor,
...
inline HRESULT WbioFrameworkLockAndValidateSecureBuffer(
    _Inout_ PWINBIO_PIPELINE Pipeline, _In_ GUID SecureBufferIdentifier,
    _Outptr_result_bytebuffer_(*SecureBufferSize) PVOID *SecureBufferAddress,
    _Out_ SIZE_T *SecureBufferSize) {
  if (!ARGUMENT_PRESENT(Pipeline) ||
    ...
    WINBIO_ADAPTER_INTERFACE_VERSION requiredFrameworkVersion =
        WINBIO_FRAMEWORK_INTERFACE_VERSION_6_0;
    ...
    if (Pipeline->SensorInterface->Version.MinorVersion == 0 ||
      ...
      return Pipeline->FrameworkInterface->LockAndValidateSecureBuffer(
          Pipeline, SecureBufferIdentifier, SecureBufferAddress,
          SecureBufferSize);
    }
  }
}
...
inline HRESULT
WbioFrameworkReleaseSecureBuffer(_Inout_ PWINBIO_PIPELINE Pipeline,
  ...
  if (!ARGUMENT_PRESENT(Pipeline) ||
    ...
    if (Pipeline->SensorInterface->Version.MinorVersion == 0 ||
      ...
      return Pipeline->FrameworkInterface->ReleaseSecureBuffer(
          Pipeline, SecureBufferIdentifier);
    }
  }
}
//-----------------------------------------------------------------------------
...
inline HRESULT WbioFramweworkVsmQueryAuthorizedEnrollments(
    _Inout_ PWINBIO_PIPELINE Pipeline, _In_ PWINBIO_IDENTITY Identity,
    _Out_ SIZE_T *SecureIdentityCount,
    _Outptr_result_buffer_(*SecureIdentityCount)
        PWINBIO_IDENTITY *SecureIdentities) {
  if (!ARGUMENT_PRESENT(Pipeline) ||
    ...
    WINBIO_ADAPTER_INTERFACE_VERSION requiredFrameworkVersion =
        WINBIO_FRAMEWORK_INTERFACE_VERSION_7_0;
    ...
    if (Pipeline->SensorInterface->Version.MinorVersion == 0 ||
        ...
        !WINBIO_IS_FRAMEWORK_VERSION_COMPATIBLE(Pipeline,
                                                requiredFrameworkVersion) ||
        !ARGUMENT_PRESENT(
            Pipeline->FrameworkInterface->QueryAuthorizedEnrollments)) {
      return E_NOTIMPL;
    } else {
      return Pipeline->FrameworkInterface->QueryAuthorizedEnrollments(
          Pipeline, Identity, SecureIdentityCount, SecureIdentities);
    }
  }
}
//-----------------------------------------------------------------------------

inline HRESULT WbioFrameworkVsmDecryptSample(
    _Inout_ PWINBIO_PIPELINE Pipeline,
    _In_reads_bytes_(AuthenticationSize) const UCHAR *Authentication,
    _In_ SIZE_T AuthenticationSize, _In_reads_bytes_(IvSize) const UCHAR *Iv,
    _In_ SIZE_T IvSize,
  ...
  if (!ARGUMENT_PRESENT(Pipeline) ||
    ...
    if (Pipeline->SensorInterface->Version.MinorVersion == 0 ||
      ...
      return Pipeline->FrameworkInterface->DecryptSample(
          Pipeline, Authentication, AuthenticationSize, Iv, IvSize,
