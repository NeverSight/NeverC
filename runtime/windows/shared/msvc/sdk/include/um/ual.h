...
HRESULT
WINAPI
UalStart(_In_ PUAL_DATA_BLOB Data);

HRESULT
WINAPI
UalStop(_In_ PUAL_DATA_BLOB Data);

HRESULT
WINAPI
UalInstrument(_In_ PUAL_DATA_BLOB Data);

HRESULT
WINAPI
UalRegisterProduct(_In_z_ const WCHAR *wszProductName,
