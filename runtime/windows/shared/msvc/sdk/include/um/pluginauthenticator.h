...
typedef const WEBAUTHN_PLUGIN_OPERATION_REQUEST
    *PCWEBAUTHN_PLUGIN_OPERATION_REQUEST;
...
typedef struct _WEBAUTHN_PLUGIN_OPERATION_RESPONSE
    *PWEBAUTHN_PLUGIN_OPERATION_RESPONSE;

typedef const WEBAUTHN_PLUGIN_OPERATION_RESPONSE
    *PCWEBAUTHN_PLUGIN_OPERATION_RESPONSE;
...
typedef const WEBAUTHN_PLUGIN_CANCEL_OPERATION_REQUEST
    *PCWEBAUTHN_PLUGIN_CANCEL_OPERATION_REQUEST;
...
public:
  virtual HRESULT STDMETHODCALLTYPE MakeCredential(
      ...
      /* [retval][out] */ __RPC__out PWEBAUTHN_PLUGIN_OPERATION_RESPONSE
          response) = 0;
...
typedef struct IPluginAuthenticatorVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IPluginAuthenticator *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IPluginAuthenticator *This);
  ...
  HRESULT(STDMETHODCALLTYPE *MakeCredential)(
      ...
      /* [in] */ __RPC__in PCWEBAUTHN_PLUGIN_OPERATION_REQUEST request,
      /* [retval][out] */
      __RPC__out PWEBAUTHN_PLUGIN_OPERATION_RESPONSE response);
...
#define IPluginAuthenticator_AddRef(This) ((This)->lpVtbl->AddRef(This))

#define IPluginAuthenticator_Release(This) ((This)->lpVtbl->Release(This))
