...
struct BoundingSphere {
  ...
  static void
  CreateFromBoundingBox(_Out_ BoundingSphere &Out,
...
struct BoundingOrientedBox {
  ...
  static void
  CreateFromPoints(_Out_ BoundingOrientedBox &Out, _In_ size_t Count,
...
struct BoundingFrustum {
  ...
  BoundingFrustum() noexcept
      : Origin(0, 0, 0), Orientation(0, 0, 0, 1.f), RightSlope(1.f),
        LeftSlope(-1.f), TopSlope(1.f), BottomSlope(-1.f), Near(0), Far(1.f) {}
  ...
  constexpr BoundingFrustum(_In_ const XMFLOAT3 &origin,
      ...
      : Origin(origin), Orientation(orientation), RightSlope(rightSlope),
        LeftSlope(leftSlope), TopSlope(topSlope), BottomSlope(bottomSlope),
  ...
  void GetPlanes(_Out_opt_ XMVECTOR *NearPlane, _Out_opt_ XMVECTOR *FarPlane,
                 _Out_opt_ XMVECTOR *RightPlane, _Out_opt_ XMVECTOR *LeftPlane,
