...
typedef struct IEnumConnectionsVtbl {
  ...
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in IEnumConnections *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IEnumConnections *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IEnumConnections *This);
  ...
  HRESULT(STDMETHODCALLTYPE *Skip)(__RPC__in IEnumConnections *This,
                                   /* [in] */ ULONG cConnections);

  DECLSPEC_XFGVIRT(IEnumConnections, Reset)
  HRESULT(STDMETHODCALLTYPE *Reset)(__RPC__in IEnumConnections *This);
...
interface IEnumConnections { CONST_VTBL struct IEnumConnectionsVtbl *lpVtbl; };
...
typedef struct IConnectionPointVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in IConnectionPoint *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IConnectionPoint *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IConnectionPoint *This);
  ...
  HRESULT(STDMETHODCALLTYPE *Unadvise)(__RPC__in IConnectionPoint *This,
                                       /* [in] */ DWORD dwCookie);
...
interface IConnectionPoint { CONST_VTBL struct IConnectionPointVtbl *lpVtbl; };
...
typedef struct IEnumConnectionPointsVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IEnumConnectionPoints *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IEnumConnectionPoints *This);
  ...
  HRESULT(STDMETHODCALLTYPE *Skip)(__RPC__in IEnumConnectionPoints *This,
                                   /* [in] */ ULONG cConnections);

  DECLSPEC_XFGVIRT(IEnumConnectionPoints, Reset)
  HRESULT(STDMETHODCALLTYPE *Reset)(__RPC__in IEnumConnectionPoints *This);
...
IEnumConnectionPoints_RemoteNext_Proxy(__RPC__in IEnumConnectionPoints *This,
                                       /* [in] */ ULONG cConnections,
                                       /* [length_is][size_is][out] */
                                       __RPC__out_ecount_part(cConnections,
                                                              *pcFetched)
...
typedef struct IConnectionPointContainerVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IConnectionPointContainer *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IConnectionPointContainer *This);
...
typedef struct IClassFactory2Vtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in IClassFactory2 *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IClassFactory2 *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IClassFactory2 *This);
  ...
  /* [local] */ HRESULT(STDMETHODCALLTYPE *LockServer)(IClassFactory2 *This,
                                                       /* [in] */ BOOL fLock);
...
interface IClassFactory2 { CONST_VTBL struct IClassFactory2Vtbl *lpVtbl; };
...
/* [call_as] */ HRESULT
STDMETHODCALLTYPE IClassFactory2_RemoteCreateInstanceLic_Proxy(
    __RPC__in IClassFactory2 *This,
    /* [in] */ __RPC__in REFIID riid,
...
typedef struct IProvideClassInfoVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in IProvideClassInfo *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IProvideClassInfo *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IProvideClassInfo *This);
...
typedef struct IProvideClassInfo2Vtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in IProvideClassInfo2 *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IProvideClassInfo2 *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IProvideClassInfo2 *This);
  ...
  HRESULT(STDMETHODCALLTYPE *GetGUID)(__RPC__in IProvideClassInfo2 *This,
                                      /* [in] */ DWORD dwGuidKind,
...
typedef struct IProvideMultipleClassInfoVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IProvideMultipleClassInfo *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IProvideMultipleClassInfo *This);
  ...
  DECLSPEC_XFGVIRT(IProvideClassInfo2, GetGUID)
  HRESULT(STDMETHODCALLTYPE *GetGUID)(__RPC__in IProvideMultipleClassInfo *This,
                                      /* [in] */ DWORD dwGuidKind,
                                      /* [out] */ __RPC__out GUID *pGUID);
...
typedef struct IOleControlVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in IOleControl *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IOleControl *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IOleControl *This);
  ...
  HRESULT(STDMETHODCALLTYPE *OnMnemonic)(__RPC__in IOleControl *This,
  ...
  HRESULT(STDMETHODCALLTYPE *FreezeEvents)(__RPC__in IOleControl *This,
                                           /* [in] */ BOOL bFreeze);

  END_INTERFACE
} IOleControlVtbl;

interface IOleControl { CONST_VTBL struct IOleControlVtbl *lpVtbl; };
...
typedef struct IOleControlSiteVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in IOleControlSite *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IOleControlSite *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IOleControlSite *This);
  ...
  HRESULT(STDMETHODCALLTYPE *LockInPlaceActive)(__RPC__in IOleControlSite *This,
                                                /* [in] */ BOOL fLock);
  ...
  HRESULT(STDMETHODCALLTYPE *OnFocus)(__RPC__in IOleControlSite *This,
                                      /* [in] */ BOOL fGotFocus);
...
interface IOleControlSite { CONST_VTBL struct IOleControlSiteVtbl *lpVtbl; };
...
public:
  ...
  virtual HRESULT STDMETHODCALLTYPE SetObjects(
      /* [in] */ ULONG cObjects,
      /* [size_is][in] */ __RPC__in_ecount_full(cObjects) IUnknown *
          *ppUnk) = 0;
...
typedef struct IPropertyPageVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in IPropertyPage *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IPropertyPage *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IPropertyPage *This);
  ...
  HRESULT(STDMETHODCALLTYPE *Activate)(__RPC__in IPropertyPage *This,
                                       /* [in] */ __RPC__in HWND hWndParent,
                                       /* [in] */ __RPC__in LPCRECT pRect,
                                       /* [in] */ BOOL bModal);

  DECLSPEC_XFGVIRT(IPropertyPage, Deactivate)
  HRESULT(STDMETHODCALLTYPE *Deactivate)(__RPC__in IPropertyPage *This);
  ...
  HRESULT(STDMETHODCALLTYPE *Show)(__RPC__in IPropertyPage *This,
                                   /* [in] */ UINT nCmdShow);

  DECLSPEC_XFGVIRT(IPropertyPage, Move)
  HRESULT(STDMETHODCALLTYPE *Move)(__RPC__in IPropertyPage *This,
                                   /* [in] */ __RPC__in LPCRECT pRect);

  DECLSPEC_XFGVIRT(IPropertyPage, IsPageDirty)
  HRESULT(STDMETHODCALLTYPE *IsPageDirty)(__RPC__in IPropertyPage *This);

  DECLSPEC_XFGVIRT(IPropertyPage, Apply)
  HRESULT(STDMETHODCALLTYPE *Apply)(__RPC__in IPropertyPage *This);

  DECLSPEC_XFGVIRT(IPropertyPage, Help)
  HRESULT(STDMETHODCALLTYPE *Help)(__RPC__in IPropertyPage *This,
...
interface IPropertyPage { CONST_VTBL struct IPropertyPageVtbl *lpVtbl; };
...
typedef struct IPropertyPage2Vtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in IPropertyPage2 *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IPropertyPage2 *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IPropertyPage2 *This);
  ...
  DECLSPEC_XFGVIRT(IPropertyPage, Activate)
  HRESULT(STDMETHODCALLTYPE *Activate)(__RPC__in IPropertyPage2 *This,
                                       /* [in] */ __RPC__in HWND hWndParent,
                                       /* [in] */ __RPC__in LPCRECT pRect,
                                       /* [in] */ BOOL bModal);

  DECLSPEC_XFGVIRT(IPropertyPage, Deactivate)
  HRESULT(STDMETHODCALLTYPE *Deactivate)(__RPC__in IPropertyPage2 *This);
  ...
  DECLSPEC_XFGVIRT(IPropertyPage, Show)
  HRESULT(STDMETHODCALLTYPE *Show)(__RPC__in IPropertyPage2 *This,
                                   /* [in] */ UINT nCmdShow);

  DECLSPEC_XFGVIRT(IPropertyPage, Move)
  HRESULT(STDMETHODCALLTYPE *Move)(__RPC__in IPropertyPage2 *This,
                                   /* [in] */ __RPC__in LPCRECT pRect);

  DECLSPEC_XFGVIRT(IPropertyPage, IsPageDirty)
  HRESULT(STDMETHODCALLTYPE *IsPageDirty)(__RPC__in IPropertyPage2 *This);

  DECLSPEC_XFGVIRT(IPropertyPage, Apply)
  HRESULT(STDMETHODCALLTYPE *Apply)(__RPC__in IPropertyPage2 *This);

  DECLSPEC_XFGVIRT(IPropertyPage, Help)
  HRESULT(STDMETHODCALLTYPE *Help)(__RPC__in IPropertyPage2 *This,
                                   /* [in] */ __RPC__in LPCOLESTR pszHelpDir);
  ...
  HRESULT(STDMETHODCALLTYPE *EditProperty)(__RPC__in IPropertyPage2 *This,
                                           /* [in] */ DISPID dispID);

  END_INTERFACE
} IPropertyPage2Vtbl;

interface IPropertyPage2 { CONST_VTBL struct IPropertyPage2Vtbl *lpVtbl; };
...
typedef struct IPropertyPageSiteVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in IPropertyPageSite *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IPropertyPageSite *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IPropertyPageSite *This);

  DECLSPEC_XFGVIRT(IPropertyPageSite, OnStatusChange)
  HRESULT(STDMETHODCALLTYPE *OnStatusChange)(__RPC__in IPropertyPageSite *This,
                                             /* [in] */ DWORD dwFlags);
...
typedef struct IPropertyNotifySinkVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IPropertyNotifySink *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IPropertyNotifySink *This);

  DECLSPEC_XFGVIRT(IPropertyNotifySink, OnChanged)
  HRESULT(STDMETHODCALLTYPE *OnChanged)(__RPC__in IPropertyNotifySink *This,
                                        /* [in] */ DISPID dispID);

  DECLSPEC_XFGVIRT(IPropertyNotifySink, OnRequestEdit)
  HRESULT(STDMETHODCALLTYPE *OnRequestEdit)(__RPC__in IPropertyNotifySink *This,
                                            /* [in] */ DISPID dispID);
...
typedef struct ISpecifyPropertyPagesVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in ISpecifyPropertyPages *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in ISpecifyPropertyPages *This);

  DECLSPEC_XFGVIRT(ISpecifyPropertyPages, GetPages)
  HRESULT(STDMETHODCALLTYPE *GetPages)(__RPC__in ISpecifyPropertyPages *This,
...
typedef struct IPersistMemoryVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in IPersistMemory *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IPersistMemory *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IPersistMemory *This);
  ...
  HRESULT(STDMETHODCALLTYPE *IsDirty)(__RPC__in IPersistMemory *This);
  ...
  HRESULT(STDMETHODCALLTYPE *GetSizeMax)(__RPC__in IPersistMemory *This,
                                         /* [out] */ __RPC__out ULONG *pCbSize);

  DECLSPEC_XFGVIRT(IPersistMemory, InitNew)
  HRESULT(STDMETHODCALLTYPE *InitNew)(__RPC__in IPersistMemory *This);

  END_INTERFACE
} IPersistMemoryVtbl;

interface IPersistMemory { CONST_VTBL struct IPersistMemoryVtbl *lpVtbl; };
...
typedef struct IPersistStreamInitVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in IPersistStreamInit *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IPersistStreamInit *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IPersistStreamInit *This);
  ...
  HRESULT(STDMETHODCALLTYPE *IsDirty)(__RPC__in IPersistStreamInit *This);

  DECLSPEC_XFGVIRT(IPersistStreamInit, Load)
  HRESULT(STDMETHODCALLTYPE *Load)(__RPC__in IPersistStreamInit *This,
                                   /* [in] */ __RPC__in_opt LPSTREAM pStm);

  DECLSPEC_XFGVIRT(IPersistStreamInit, Save)
  HRESULT(STDMETHODCALLTYPE *Save)(__RPC__in IPersistStreamInit *This,
                                   /* [in] */ __RPC__in_opt LPSTREAM pStm,
                                   /* [in] */ BOOL fClearDirty);
  ...
  HRESULT(STDMETHODCALLTYPE *InitNew)(__RPC__in IPersistStreamInit *This);
...
typedef struct IPersistPropertyBagVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IPersistPropertyBag *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IPersistPropertyBag *This);
  ...
  HRESULT(STDMETHODCALLTYPE *InitNew)(__RPC__in IPersistPropertyBag *This);
...
typedef struct ISimpleFrameSiteVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in ISimpleFrameSite *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in ISimpleFrameSite *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in ISimpleFrameSite *This);
...
interface ISimpleFrameSite { CONST_VTBL struct ISimpleFrameSiteVtbl *lpVtbl; };
...
#define ISimpleFrameSite_PreMessageFilter(This, hWnd, msg, wp, lp, plResult,   \
                                          pdwCookie)                           \
  ((This)->lpVtbl->PreMessageFilter(This, hWnd, msg, wp, lp, plResult,         \
                                    pdwCookie))

#define ISimpleFrameSite_PostMessageFilter(This, hWnd, msg, wp, lp, plResult,  \
                                           dwCookie)                           \
  ((This)->lpVtbl->PostMessageFilter(This, hWnd, msg, wp, lp, plResult,        \
                                     dwCookie))
...
typedef struct IFontVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in IFont *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IFont *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IFont *This);
  ...
  HRESULT(STDMETHODCALLTYPE *put_Name)(__RPC__in IFont *This,
                                       /* [in] */ __RPC__in BSTR name);

  DECLSPEC_XFGVIRT(IFont, get_Size)
  HRESULT(STDMETHODCALLTYPE *get_Size)(__RPC__in IFont *This,
                                       /* [out] */ __RPC__out CY *pSize);

  DECLSPEC_XFGVIRT(IFont, put_Size)
  HRESULT(STDMETHODCALLTYPE *put_Size)(__RPC__in IFont *This,
                                       /* [in] */ CY size);

  DECLSPEC_XFGVIRT(IFont, get_Bold)
  HRESULT(STDMETHODCALLTYPE *get_Bold)(__RPC__in IFont *This,
                                       /* [out] */ __RPC__out BOOL *pBold);

  DECLSPEC_XFGVIRT(IFont, put_Bold)
  HRESULT(STDMETHODCALLTYPE *put_Bold)(__RPC__in IFont *This,
                                       /* [in] */ BOOL bold);

  DECLSPEC_XFGVIRT(IFont, get_Italic)
  HRESULT(STDMETHODCALLTYPE *get_Italic)(__RPC__in IFont *This,
                                         /* [out] */ __RPC__out BOOL *pItalic);

  DECLSPEC_XFGVIRT(IFont, put_Italic)
  HRESULT(STDMETHODCALLTYPE *put_Italic)(__RPC__in IFont *This,
                                         /* [in] */ BOOL italic);
  ...
  HRESULT(STDMETHODCALLTYPE *put_Underline)(__RPC__in IFont *This,
                                            /* [in] */ BOOL underline);
  ...
  HRESULT(STDMETHODCALLTYPE *put_Strikethrough)(__RPC__in IFont *This,
                                                /* [in] */ BOOL strikethrough);

  DECLSPEC_XFGVIRT(IFont, get_Weight)
  HRESULT(STDMETHODCALLTYPE *get_Weight)(__RPC__in IFont *This,
                                         /* [out] */ __RPC__out SHORT *pWeight);

  DECLSPEC_XFGVIRT(IFont, put_Weight)
  HRESULT(STDMETHODCALLTYPE *put_Weight)(__RPC__in IFont *This,
                                         /* [in] */ SHORT weight);
  ...
  HRESULT(STDMETHODCALLTYPE *put_Charset)(__RPC__in IFont *This,
                                          /* [in] */ SHORT charset);
  ...
  HRESULT(STDMETHODCALLTYPE *SetRatio)(__RPC__in IFont *This,
                                       /* [in] */ LONG cyLogical,
                                       /* [in] */ LONG cyHimetric);
  ...
  HRESULT(STDMETHODCALLTYPE *AddRefHfont)(__RPC__in IFont *This,
                                          /* [in] */ __RPC__in HFONT hFont);

  DECLSPEC_XFGVIRT(IFont, ReleaseHfont)
  HRESULT(STDMETHODCALLTYPE *ReleaseHfont)(__RPC__in IFont *This,
                                           /* [in] */ __RPC__in HFONT hFont);

  DECLSPEC_XFGVIRT(IFont, SetHdc)
  HRESULT(STDMETHODCALLTYPE *SetHdc)(__RPC__in IFont *This,
                                     /* [in] */ __RPC__in HDC hDC);

  END_INTERFACE
} IFontVtbl;

interface IFont { CONST_VTBL struct IFontVtbl *lpVtbl; };
...
typedef /* [public][uuid] */ DECLSPEC_UUID(
    "66504313-BE0F-101A-8BBB-00AA00300CAB") UINT OLE_HANDLE;

typedef /* [hidden][uuid] */ DECLSPEC_UUID(
    "66504306-BE0F-101A-8BBB-00AA00300CAB") LONG OLE_XPOS_HIMETRIC;

typedef /* [hidden][uuid] */ DECLSPEC_UUID(
    "66504307-BE0F-101A-8BBB-00AA00300CAB") LONG OLE_YPOS_HIMETRIC;

typedef /* [hidden][uuid] */ DECLSPEC_UUID(
    "66504308-BE0F-101A-8BBB-00AA00300CAB") LONG OLE_XSIZE_HIMETRIC;

typedef /* [hidden][uuid] */ DECLSPEC_UUID(
    "66504309-BE0F-101A-8BBB-00AA00300CAB") LONG OLE_YSIZE_HIMETRIC;
...
typedef struct IPictureVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in IPicture *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IPicture *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IPicture *This);
  ...
  HRESULT(STDMETHODCALLTYPE *get_Type)(__RPC__in IPicture *This,
  ...
  HRESULT(STDMETHODCALLTYPE *set_hPal)(__RPC__in IPicture *This,
                                       /* [in] */ OLE_HANDLE hPal);
  ...
  HRESULT(STDMETHODCALLTYPE *put_KeepOriginalFormat)(__RPC__in IPicture *This,
                                                     /* [in] */ BOOL keep);

  DECLSPEC_XFGVIRT(IPicture, PictureChanged)
  HRESULT(STDMETHODCALLTYPE *PictureChanged)(__RPC__in IPicture *This);
...
interface IPicture { CONST_VTBL struct IPictureVtbl *lpVtbl; };
...
typedef struct IPicture2Vtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in IPicture2 *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IPicture2 *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IPicture2 *This);
  ...
  HRESULT(STDMETHODCALLTYPE *get_hPal)(__RPC__in IPicture2 *This,
                                       /* [out] */ __RPC__out HHANDLE *phPal);

  DECLSPEC_XFGVIRT(IPicture2, get_Type)
  HRESULT(STDMETHODCALLTYPE *get_Type)(__RPC__in IPicture2 *This,
                                       /* [out] */ __RPC__out SHORT *pType);
  ...
  HRESULT(STDMETHODCALLTYPE *Render)(__RPC__in IPicture2 *This,
                                     /* [in] */ __RPC__in HDC hDC,
                                     /* [in] */ LONG x,
                                     /* [in] */ LONG y,
                                     /* [in] */ LONG cx,
  ...
  HRESULT(STDMETHODCALLTYPE *set_hPal)(__RPC__in IPicture2 *This,
                                       /* [in] */ HHANDLE hPal);
  ...
  HRESULT(STDMETHODCALLTYPE *put_KeepOriginalFormat)(__RPC__in IPicture2 *This,
                                                     /* [in] */ BOOL keep);

  DECLSPEC_XFGVIRT(IPicture2, PictureChanged)
  HRESULT(STDMETHODCALLTYPE *PictureChanged)(__RPC__in IPicture2 *This);
...
interface IPicture2 { CONST_VTBL struct IPicture2Vtbl *lpVtbl; };
...
IFontEventsDisp : public IDispatch{public : };
...
typedef struct IFontEventsDispVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in IFontEventsDisp *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IFontEventsDisp *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IFontEventsDisp *This);
...
interface IFontEventsDisp { CONST_VTBL struct IFontEventsDispVtbl *lpVtbl; };
...
IFontDisp : public IDispatch{public : };
...
typedef struct IFontDispVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in IFontDisp *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IFontDisp *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IFontDisp *This);
...
interface IFontDisp { CONST_VTBL struct IFontDispVtbl *lpVtbl; };
...
IPictureDisp : public IDispatch{public : };
...
typedef struct IPictureDispVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in IPictureDisp *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IPictureDisp *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IPictureDisp *This);
...
interface IPictureDisp { CONST_VTBL struct IPictureDispVtbl *lpVtbl; };
...
typedef struct IOleInPlaceObjectWindowlessVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IOleInPlaceObjectWindowless *This);
...
typedef struct IOleInPlaceSiteExVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in IOleInPlaceSiteEx *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IOleInPlaceSiteEx *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IOleInPlaceSiteEx *This);
  ...
  HRESULT(STDMETHODCALLTYPE *OnUIActivate)(__RPC__in IOleInPlaceSiteEx *This);
  ...
  HRESULT(STDMETHODCALLTYPE *Scroll)(__RPC__in IOleInPlaceSiteEx *This,
                                     /* [in] */ SIZE scrollExtant);

  DECLSPEC_XFGVIRT(IOleInPlaceSite, OnUIDeactivate)
  HRESULT(STDMETHODCALLTYPE *OnUIDeactivate)(__RPC__in IOleInPlaceSiteEx *This,
                                             /* [in] */ BOOL fUndoable);
  ...
  HRESULT(STDMETHODCALLTYPE *OnPosRectChange)(__RPC__in IOleInPlaceSiteEx *This,
                                              /* [in] */ __RPC__in LPCRECT
                                                  lprcPosRect);
...
typedef struct IOleInPlaceSiteWindowlessVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IOleInPlaceSiteWindowless *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IOleInPlaceSiteWindowless *This);
  ...
  DECLSPEC_XFGVIRT(IOleInPlaceSite, Scroll)
  HRESULT(STDMETHODCALLTYPE *Scroll)(__RPC__in IOleInPlaceSiteWindowless *This,
                                     /* [in] */ SIZE scrollExtant);
...
typedef struct IViewObjectExVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in IViewObjectEx *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IViewObjectEx *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IViewObjectEx *This);
  ...
  HRESULT(STDMETHODCALLTYPE *Unfreeze)(__RPC__in IViewObjectEx *This,
                                       /* [in] */ DWORD dwFreeze);
  ...
  HRESULT(STDMETHODCALLTYPE *GetRect)(__RPC__in IViewObjectEx *This,
                                      /* [in] */ DWORD dwAspect,
...
interface IViewObjectEx { CONST_VTBL struct IViewObjectExVtbl *lpVtbl; };
...
typedef struct IOleUndoUnitVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in IOleUndoUnit *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IOleUndoUnit *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IOleUndoUnit *This);
  ...
  HRESULT(STDMETHODCALLTYPE *GetUnitType)(__RPC__in IOleUndoUnit *This,
                                          /* [out] */ __RPC__out CLSID *pClsid,
                                          /* [out] */ __RPC__out LONG *plID);

  DECLSPEC_XFGVIRT(IOleUndoUnit, OnNextAdd)
  HRESULT(STDMETHODCALLTYPE *OnNextAdd)(__RPC__in IOleUndoUnit *This);

  END_INTERFACE
} IOleUndoUnitVtbl;

interface IOleUndoUnit { CONST_VTBL struct IOleUndoUnitVtbl *lpVtbl; };
...
typedef struct IOleParentUndoUnitVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in IOleParentUndoUnit *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IOleParentUndoUnit *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IOleParentUndoUnit *This);
  ...
  DECLSPEC_XFGVIRT(IOleUndoUnit, GetUnitType)
  HRESULT(STDMETHODCALLTYPE *GetUnitType)(__RPC__in IOleParentUndoUnit *This,
                                          /* [out] */ __RPC__out CLSID *pClsid,
                                          /* [out] */ __RPC__out LONG *plID);

  DECLSPEC_XFGVIRT(IOleUndoUnit, OnNextAdd)
  HRESULT(STDMETHODCALLTYPE *OnNextAdd)(__RPC__in IOleParentUndoUnit *This);
  ...
  HRESULT(STDMETHODCALLTYPE *Add)(__RPC__in IOleParentUndoUnit *This,
...
typedef struct IEnumOleUndoUnitsVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in IEnumOleUndoUnits *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IEnumOleUndoUnits *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IEnumOleUndoUnits *This);
  ...
  HRESULT(STDMETHODCALLTYPE *Skip)(__RPC__in IEnumOleUndoUnits *This,
                                   /* [in] */ ULONG cElt);

  DECLSPEC_XFGVIRT(IEnumOleUndoUnits, Reset)
  HRESULT(STDMETHODCALLTYPE *Reset)(__RPC__in IEnumOleUndoUnits *This);
...
typedef struct IOleUndoManagerVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in IOleUndoManager *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IOleUndoManager *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IOleUndoManager *This);
  ...
  HRESULT(STDMETHODCALLTYPE *Add)(__RPC__in IOleUndoManager *This,
                                  /* [in] */ __RPC__in_opt IOleUndoUnit *pUU);
  ...
  HRESULT(STDMETHODCALLTYPE *Enable)(__RPC__in IOleUndoManager *This,
                                     /* [in] */ BOOL fEnable);

  END_INTERFACE
} IOleUndoManagerVtbl;

interface IOleUndoManager { CONST_VTBL struct IOleUndoManagerVtbl *lpVtbl; };
...
typedef struct IPointerInactiveVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in IPointerInactive *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IPointerInactive *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IPointerInactive *This);
...
interface IPointerInactive { CONST_VTBL struct IPointerInactiveVtbl *lpVtbl; };
...
typedef struct IObjectWithSiteVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in IObjectWithSite *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IObjectWithSite *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IObjectWithSite *This);
...
interface IObjectWithSite { CONST_VTBL struct IObjectWithSiteVtbl *lpVtbl; };
...
typedef struct IPerPropertyBrowsingVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IPerPropertyBrowsing *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IPerPropertyBrowsing *This);
...
public:
  virtual HRESULT STDMETHODCALLTYPE Read(
      ...
      /* [size_is][in] */ __RPC__in_ecount_full(cProperties) PROPBAG2 *
          pPropBag,
      /* [unique][in] */ __RPC__in_opt IErrorLog * pErrLog,
      /* [size_is][out] */ __RPC__out_ecount_full(cProperties) VARIANT *
          pvarValue,
      /* [size_is][unique][out][in] */
      __RPC__inout_ecount_full_opt(cProperties) HRESULT * phrError) = 0;

  virtual HRESULT STDMETHODCALLTYPE Write(
      /* [in] */ ULONG cProperties,
      /* [size_is][in] */ __RPC__in_ecount_full(cProperties) PROPBAG2 *
          pPropBag,
      /* [size_is][in] */ __RPC__in_ecount_full(cProperties) VARIANT *
          pvarValue) = 0;
  ...
  virtual HRESULT STDMETHODCALLTYPE GetPropertyInfo(
      /* [in] */ ULONG iProperty,
      /* [in] */ ULONG cProperties,
      /* [size_is][out] */ __RPC__out_ecount_full(cProperties) PROPBAG2 *
          pPropBag,
      /* [out] */ __RPC__out ULONG * pcProperties) = 0;
...
typedef struct IPropertyBag2Vtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in IPropertyBag2 *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IPropertyBag2 *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IPropertyBag2 *This);
...
interface IPropertyBag2 { CONST_VTBL struct IPropertyBag2Vtbl *lpVtbl; };
...
typedef struct IPersistPropertyBag2Vtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IPersistPropertyBag2 *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IPersistPropertyBag2 *This);
  ...
  HRESULT(STDMETHODCALLTYPE *InitNew)(__RPC__in IPersistPropertyBag2 *This);
  ...
  HRESULT(STDMETHODCALLTYPE *IsDirty)(__RPC__in IPersistPropertyBag2 *This);
...
typedef struct IAdviseSinkExVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in IAdviseSinkEx *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IAdviseSinkEx *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IAdviseSinkEx *This);
  ...
  /* [local] */ void(STDMETHODCALLTYPE *OnViewChange)(IAdviseSinkEx *This,
                                                      /* [in] */ DWORD dwAspect,
                                                      /* [in] */ LONG lindex);

  DECLSPEC_XFGVIRT(IAdviseSink, OnRename)
  /* [local] */ void(STDMETHODCALLTYPE *OnRename)(IAdviseSinkEx *This,
                                                  /* [annotation][in] */
                                                  _In_ IMoniker *pmk);

  DECLSPEC_XFGVIRT(IAdviseSink, OnSave)
  /* [local] */ void(STDMETHODCALLTYPE *OnSave)(IAdviseSinkEx *This);

  DECLSPEC_XFGVIRT(IAdviseSink, OnClose)
  /* [local] */ void(STDMETHODCALLTYPE *OnClose)(IAdviseSinkEx *This);
...
interface IAdviseSinkEx { CONST_VTBL struct IAdviseSinkExVtbl *lpVtbl; };
...
/* [call_as] */ HRESULT STDMETHODCALLTYPE
IAdviseSinkEx_RemoteOnViewStatusChange_Proxy(__RPC__in IAdviseSinkEx *This,
                                             /* [in] */ DWORD dwViewStatus);
...
typedef /* [public][uuid] */ DECLSPEC_UUID(
    "66504301-BE0F-101A-8BBB-00AA00300CAB") DWORD OLE_COLOR;
...
typedef struct IQuickActivateVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in IQuickActivate *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IQuickActivate *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IQuickActivate *This);
  ...
  HRESULT(STDMETHODCALLTYPE *SetContentExtent)(__RPC__in IQuickActivate *This,
                                               /* [in] */ __RPC__in LPSIZEL
                                                   pSizel);

  DECLSPEC_XFGVIRT(IQuickActivate, GetContentExtent)
  HRESULT(STDMETHODCALLTYPE *GetContentExtent)(__RPC__in IQuickActivate *This,
                                               /* [out] */ __RPC__out LPSIZEL
                                                   pSizel);

  END_INTERFACE
} IQuickActivateVtbl;

interface IQuickActivate { CONST_VTBL struct IQuickActivateVtbl *lpVtbl; };
...
/* [call_as] */ HRESULT
STDMETHODCALLTYPE IQuickActivate_RemoteQuickActivate_Proxy(
...
unsigned long __RPC_USER HACCEL_UserSize(__RPC__in unsigned long *,
                                         unsigned long, __RPC__in HACCEL *);
unsigned char *__RPC_USER
HACCEL_UserMarshal(__RPC__in unsigned long *,
                   __RPC__inout_xcount(0) unsigned char *, __RPC__in HACCEL *);
unsigned char *__RPC_USER
HACCEL_UserUnmarshal(__RPC__in unsigned long *,
                     __RPC__in_xcount(0) unsigned char *, __RPC__out HACCEL *);
...
unsigned long __RPC_USER HFONT_UserSize(__RPC__in unsigned long *,
                                        unsigned long, __RPC__in HFONT *);
unsigned char *__RPC_USER
HFONT_UserMarshal(__RPC__in unsigned long *,
                  __RPC__inout_xcount(0) unsigned char *, __RPC__in HFONT *);
unsigned char *__RPC_USER
HFONT_UserUnmarshal(__RPC__in unsigned long *,
                    __RPC__in_xcount(0) unsigned char *, __RPC__out HFONT *);
...
unsigned long __RPC_USER HRGN_UserSize(__RPC__in unsigned long *, unsigned long,
                                       __RPC__in HRGN *);
unsigned char *__RPC_USER
HRGN_UserMarshal(__RPC__in unsigned long *,
                 __RPC__inout_xcount(0) unsigned char *, __RPC__in HRGN *);
unsigned char *__RPC_USER
HRGN_UserUnmarshal(__RPC__in unsigned long *,
                   __RPC__in_xcount(0) unsigned char *, __RPC__out HRGN *);
...
unsigned long __RPC_USER HACCEL_UserSize64(__RPC__in unsigned long *,
                                           unsigned long, __RPC__in HACCEL *);
unsigned char *__RPC_USER HACCEL_UserMarshal64(
    __RPC__in unsigned long *, __RPC__inout_xcount(0) unsigned char *,
    __RPC__in HACCEL *);
unsigned char *__RPC_USER HACCEL_UserUnmarshal64(
    __RPC__in unsigned long *, __RPC__in_xcount(0) unsigned char *,
    __RPC__out HACCEL *);
void __RPC_USER HACCEL_UserFree64(__RPC__in unsigned long *,
                                  __RPC__in HACCEL *);
...
unsigned long __RPC_USER HFONT_UserSize64(__RPC__in unsigned long *,
                                          unsigned long, __RPC__in HFONT *);
unsigned char *__RPC_USER
HFONT_UserMarshal64(__RPC__in unsigned long *,
                    __RPC__inout_xcount(0) unsigned char *, __RPC__in HFONT *);
unsigned char *__RPC_USER
HFONT_UserUnmarshal64(__RPC__in unsigned long *,
                      __RPC__in_xcount(0) unsigned char *, __RPC__out HFONT *);
void __RPC_USER HFONT_UserFree64(__RPC__in unsigned long *, __RPC__in HFONT *);

unsigned long __RPC_USER HPALETTE_UserSize64(__RPC__in unsigned long *,
                                             unsigned long,
                                             __RPC__in HPALETTE *);
unsigned char *__RPC_USER HPALETTE_UserMarshal64(
    __RPC__in unsigned long *, __RPC__inout_xcount(0) unsigned char *,
    __RPC__in HPALETTE *);
unsigned char *__RPC_USER HPALETTE_UserUnmarshal64(
    __RPC__in unsigned long *, __RPC__in_xcount(0) unsigned char *,
    __RPC__out HPALETTE *);
void __RPC_USER HPALETTE_UserFree64(__RPC__in unsigned long *,
                                    __RPC__in HPALETTE *);

unsigned long __RPC_USER HRGN_UserSize64(__RPC__in unsigned long *,
                                         unsigned long, __RPC__in HRGN *);
unsigned char *__RPC_USER
HRGN_UserMarshal64(__RPC__in unsigned long *,
                   __RPC__inout_xcount(0) unsigned char *, __RPC__in HRGN *);
unsigned char *__RPC_USER
HRGN_UserUnmarshal64(__RPC__in unsigned long *,
                     __RPC__in_xcount(0) unsigned char *, __RPC__out HRGN *);
...
IEnumConnections_Next_Proxy(IEnumConnections *This,
                            /* [in] */ ULONG cConnections,
                            /* [length_is][size_is][out] */ LPCONNECTDATA rgcd,
                            /* [out] */ ULONG *pcFetched);
...
/* [local] */ HRESULT STDMETHODCALLTYPE
IClassFactory2_CreateInstanceLic_Proxy(IClassFactory2 *This,
                                       /* [annotation][in] */
                                       _In_opt_ IUnknown *pUnkOuter,
                                       /* [annotation][in] */
                                       _Reserved_ IUnknown *pUnkReserved,
...
/* [local] */ HRESULT STDMETHODCALLTYPE
IPersistMemory_Load_Proxy(IPersistMemory *This,
                          /* [size_is][in] */ LPVOID pMem,
                          /* [in] */ ULONG cbSize);
...
/* [local] */ HRESULT STDMETHODCALLTYPE
IPersistMemory_Save_Proxy(IPersistMemory *This,
                          /* [size_is][out] */ LPVOID pMem,
                          /* [in] */ BOOL fClearDirty,
                          /* [in] */ ULONG cbSize);
...
IAdviseSinkEx_OnViewStatusChange_Proxy(IAdviseSinkEx *This,
                                       /* [in] */ DWORD dwViewStatus);

/* [call_as] */ HRESULT STDMETHODCALLTYPE
IAdviseSinkEx_OnViewStatusChange_Stub(__RPC__in IAdviseSinkEx *This,
                                      /* [in] */ DWORD dwViewStatus);

/* [local] */ HRESULT STDMETHODCALLTYPE
IQuickActivate_QuickActivate_Proxy(IQuickActivate *This,
                                   /* [in] */ QACONTAINER *pQaContainer,
                                   /* [out][in] */ QACONTROL *pQaControl);
