...
TDHSTATUS
__stdcall TdhCreatePayloadFilter(
    _In_ LPCGUID ProviderGuid, _In_ PCEVENT_DESCRIPTOR EventDescriptor,
    _In_ BOOLEAN EventMatchANY, _In_ ULONG PayloadPredicateCount,
    _In_reads_(PayloadPredicateCount)
        PPAYLOAD_FILTER_PREDICATE PayloadPredicates,
    _Outptr_result_maybenull_ PVOID *PayloadFilter);

TDHSTATUS
__stdcall TdhDeletePayloadFilter(_Inout_ PVOID *PayloadFilter);

TDHSTATUS
__stdcall TdhAggregatePayloadFilters(
...
TDHSTATUS
__stdcall TdhCleanupPayloadEventFilterDescriptor(
...
typedef struct _PROVIDER_ENUMERATION_INFO {
  ...
  ULONG Reserved;
  _Field_size_(NumberOfProviders)
...
TDHSTATUS
__stdcall TdhGetEventInformation(_In_ PEVENT_RECORD Event,
                                 _In_ ULONG TdhContextCount,
                                 _In_reads_opt_(TdhContextCount)
...
TDHSTATUS
__stdcall TdhGetEventMapInformation(_In_ PEVENT_RECORD pEvent,
                                    _In_ PWSTR pMapName,
                                    _Out_writes_bytes_opt_(*pBufferSize)
                                        PEVENT_MAP_INFO pBuffer,
                                    _Inout_ ULONG *pBufferSize);

TDHSTATUS
__stdcall TdhGetPropertySize(_In_ PEVENT_RECORD pEvent,
                             _In_ ULONG TdhContextCount,
                             _In_reads_opt_(TdhContextCount)
                                 PTDH_CONTEXT pTdhContext,
                             _In_ ULONG PropertyDataCount,
                             _In_reads_(PropertyDataCount)
                                 PPROPERTY_DATA_DESCRIPTOR pPropertyData,
                             _Out_ ULONG *pPropertySize);

TDHSTATUS
__stdcall TdhGetProperty(_In_ PEVENT_RECORD pEvent, _In_ ULONG TdhContextCount,
                         _In_reads_opt_(TdhContextCount)
                             PTDH_CONTEXT pTdhContext,
                         _In_ ULONG PropertyDataCount,
                         _In_reads_(PropertyDataCount)
...
TDHSTATUS
__stdcall TdhEnumerateProviders(_Out_writes_bytes_opt_(*pBufferSize)
...
*/
TDHSTATUS
__stdcall TdhEnumerateProvidersForDecodingSource(
    DECODING_SOURCE filter,
    _Out_writes_bytes_to_opt_(bufferSize, *bufferRequired)
        PROVIDER_ENUMERATION_INFO *buffer,
    ULONG bufferSize, _Out_ ULONG *bufferRequired);
#endif

TDHSTATUS
__stdcall TdhQueryProviderFieldInformation(
    _In_ LPGUID pGuid, _In_ ULONGLONG EventFieldValue,
...
__stdcall TdhEnumerateProviderFieldInformation(
    _In_ LPGUID pGuid, _In_ EVENT_FIELD_TYPE EventFieldType,
    _Out_writes_bytes_opt_(*pBufferSize) PPROVIDER_FIELD_INFOARRAY pBuffer,
    _Inout_ ULONG *pBufferSize);
...
TDHSTATUS
__stdcall TdhEnumerateProviderFilters(_In_ LPGUID Guid,
                                      _In_ ULONG TdhContextCount,
                                      _In_reads_opt_(TdhContextCount)
                                          PTDH_CONTEXT TdhContext,
                                      _Out_ ULONG *FilterCount,
                                      _Out_writes_bytes_opt_(*BufferSize)
                                          PPROVIDER_FILTER_INFO *Buffer,
...
#if (WINVER >= _WIN32_WINNT_WIN7)
TDHSTATUS
__stdcall TdhLoadManifest(_In_ PWSTR Manifest);
#endif

#if (NTDDI_VERSION >= NTDDI_WIN10_19H1)
TDHSTATUS
__stdcall TdhLoadManifestFromMemory(_In_reads_bytes_(cbData) LPCVOID pData,
                                    _In_ ULONG cbData);
#endif

#if (WINVER >= _WIN32_WINNT_WIN7)
TDHSTATUS
__stdcall TdhUnloadManifest(_In_ PWSTR Manifest);
#endif

#if (NTDDI_VERSION >= NTDDI_WIN10_19H1)
TDHSTATUS
__stdcall TdhUnloadManifestFromMemory(_In_reads_bytes_(cbData) LPCVOID pData,
                                      _In_ ULONG cbData);
#endif

#if (WINVER >= _WIN32_WINNT_WIN7)
TDHSTATUS
__stdcall TdhFormatProperty(_In_ PTRACE_EVENT_INFO EventInfo,
                            _In_opt_ PEVENT_MAP_INFO MapInfo,
                            _In_ ULONG PointerSize, _In_ USHORT PropertyInType,
...
TDHSTATUS
__stdcall TdhOpenDecodingHandle(_Out_ PTDH_HANDLE Handle);
#endif

#if (WINVER >= _WIN32_WINNT_WIN8)
TDHSTATUS
__stdcall TdhSetDecodingParameter(_In_ TDH_HANDLE Handle,
                                  _In_ PTDH_CONTEXT TdhContext);
#endif

#if (WINVER >= _WIN32_WINNT_WIN8)
TDHSTATUS
__stdcall TdhGetDecodingParameter(_In_ TDH_HANDLE Handle,
                                  _Inout_ PTDH_CONTEXT TdhContext);
#endif

#if (WINVER >= _WIN32_WINNT_WIN8)
TDHSTATUS
__stdcall TdhGetWppProperty(_In_ TDH_HANDLE Handle,
                            _In_ PEVENT_RECORD EventRecord,
                            _In_ PWSTR PropertyName, _Inout_ PULONG BufferSize,
                            _Out_writes_bytes_(*BufferSize) PBYTE Buffer);
#endif

#if (WINVER >= _WIN32_WINNT_WIN8)
TDHSTATUS
__stdcall TdhGetWppMessage(_In_ TDH_HANDLE Handle,
                           _In_ PEVENT_RECORD EventRecord,
                           _Inout_ PULONG BufferSize,
                           _Out_writes_bytes_(*BufferSize) PBYTE Buffer);
#endif
...
#if (WINVER >= _WIN32_WINNT_WIN8)
TDHSTATUS
__stdcall TdhCloseDecodingHandle(_In_ TDH_HANDLE Handle);
#endif

#if (WINVER >= _WIN32_WINNT_WIN8)
TDHSTATUS
__stdcall TdhLoadManifestFromBinary(_In_ PWSTR BinaryPath);
#endif
...
#if (WINVER >= _WIN32_WINNT_WINBLUE)
TDHSTATUS
__stdcall TdhEnumerateManifestProviderEvents(_In_ LPGUID ProviderGuid,
                                             _Out_writes_bytes_opt_(*BufferSize)
                                                 PPROVIDER_EVENT_INFO Buffer,
                                             _Inout_ ULONG *BufferSize);
#endif

#if (WINVER >= _WIN32_WINNT_WINBLUE)
TDHSTATUS
__stdcall TdhGetManifestEventInformation(_In_ LPGUID ProviderGuid,
...
TDH_INLINE
PWSTR
EMI_MAP_NAME(_In_ PEVENT_MAP_INFO MapInfo) {
...
TDH_INLINE
PWSTR
EMI_MAP_FORMAT(_In_ PEVENT_MAP_INFO MapInfo) {
...
TDH_INLINE
PWSTR
EMI_MAP_OUTPUT(_In_ PEVENT_MAP_INFO MapInfo, _In_ PEVENT_MAP_ENTRY Map) {
  return (Map->OutputOffset == 0) ? NULL
                                  : (PWSTR)((PBYTE)MapInfo + Map->OutputOffset);
}

TDH_INLINE
PWSTR
EMI_MAP_INPUT(_In_ PEVENT_MAP_INFO MapInfo, _In_ PEVENT_MAP_ENTRY Map) {
  if ((MapInfo->Flag & EVENTMAP_INFO_FLAG_MANIFEST_PATTERNMAP) &&
      (Map->InputOffset != 0)) {
...
TDH_INLINE
PWSTR
TEI_MAP_NAME(_In_ PTRACE_EVENT_INFO EventInfo,
             _In_ PEVENT_PROPERTY_INFO Property) {
  return (Property->nonStructType.MapNameOffset == 0)
             ? NULL
             : (PWSTR)((PBYTE)EventInfo +
                       Property->nonStructType.MapNameOffset);
}

TDH_INLINE
PWSTR
TEI_PROPERTY_NAME(_In_ PTRACE_EVENT_INFO EventInfo,
                  _In_ PEVENT_PROPERTY_INFO Property) {
...
TDH_INLINE
PWSTR
TEI_PROVIDER_NAME(_In_ PTRACE_EVENT_INFO EventInfo) {
...
TDH_INLINE
PWSTR
TEI_LEVEL_NAME(_In_ PTRACE_EVENT_INFO EventInfo) {
...
TDH_INLINE
PWSTR
TEI_CHANNEL_NAME(_In_ PTRACE_EVENT_INFO EventInfo) {
...
TDH_INLINE
PWSTR
TEI_KEYWORDS_NAME(_In_ PTRACE_EVENT_INFO EventInfo) {
...
TDH_INLINE
PWSTR
TEI_TASK_NAME(_In_ PTRACE_EVENT_INFO EventInfo) {
...
TDH_INLINE
PWSTR
TEI_OPCODE_NAME(_In_ PTRACE_EVENT_INFO EventInfo) {
...
TDH_INLINE
PWSTR
TEI_EVENT_MESSAGE(_In_ PTRACE_EVENT_INFO EventInfo) {
...
TDH_INLINE
PWSTR
TEI_PROVIDER_MESSAGE(_In_ PTRACE_EVENT_INFO EventInfo) {
...
TDH_INLINE
PWSTR
TEI_ACTIVITYID_NAME(_In_ PTRACE_EVENT_INFO EventInfo) {
...
TDH_INLINE
PWSTR
TEI_RELATEDACTIVITYID_NAME(_In_ PTRACE_EVENT_INFO EventInfo) {
  return (EventInfo->RelatedActivityIDNameOffset == 0)
             ? NULL
             : (PWSTR)((PBYTE)EventInfo +
                       EventInfo->RelatedActivityIDNameOffset);
}
...
TDH_INLINE
PWSTR
PFI_FILTER_MESSAGE(_In_ PPROVIDER_FILTER_INFO FilterInfo) {
...
TDH_INLINE
PWSTR
PFI_PROPERTY_NAME(_In_ PPROVIDER_FILTER_INFO FilterInfo,
                  _In_ PEVENT_PROPERTY_INFO Property) {
  return (Property->NameOffset == 0)
             ? NULL
...
TDH_INLINE
PWSTR
PFI_FIELD_NAME(_In_ PPROVIDER_FIELD_INFOARRAY FieldInfoArray,
...
TDH_INLINE
PWSTR
PFI_FIELD_MESSAGE(_In_ PPROVIDER_FIELD_INFOARRAY FieldInfoArray,
                  _In_ PPROVIDER_FIELD_INFO FieldInfo) {
...
TDH_INLINE
PWSTR
PEI_PROVIDER_NAME(_In_ PPROVIDER_ENUMERATION_INFO ProviderEnum,
