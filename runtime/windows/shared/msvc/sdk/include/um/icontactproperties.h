...
//
//  Category 2 - Hierarchical: These properties have multiple values for any
//  contact
//                      and require labeling to differentiate individual values.
//
//                      PhoneNumber is one example of this type of property
//                      Any given contact can have one or more home, work, and
//                      mobile phone numbers.
//
//
// PROPERTY EXTENSIBILITY:
//      All applications that use contacts need to have additional data
//      available on contacts that the base schema does not provide for.
//
//      There are two ways supported by IContactProperties to extend the contact
//      schema.
//
//      1) Labels (arbitrary strings) can be applied to any existing OS contact
//      array node.
//          Ex: phoneNumbers/PhoneNumber[1] can be labeled with the two labels:
//          Preferred and Business.
//
...
//                    Other
//
//                Some collections can have more labels set (PhoneNumber can
//                have Mobile, Fax, ...)
//
//              Additional labels can be set.  Custom labels must be in the form
//              of URIs.
//
//              Manipulation of labels can be done with
//              IContactProperties::GetLabel / SetLabel / DeleteLabels
//
//              Filtering of data contact can be done with
//              IContactProperties::GetPropertyCollection
//
//      2) New contact properties and array nodes can be defined by an
//      application.
//            The data contained in these properties can be enumerated by other
//            users of IContactProperties
//
//          To create a new property for an application, the same interface is
//          used as standard properties.
//            Use the same property Set functions as built in properties.  The
//            caller must prepend a string with a namespace (in braces) for the
//            contact property.
//
//              **NB: make sure the selected namespace is unique to avoid
//              conflicts with other applications**
//
//           For the application custom.exe to Get or Set a new string property,
//           use:
...
//
//            CreateArrayNode will return the new property name (as always) in
//            the outbound arguments.
//
//===================================================================
...
//          Programmatic access for labels is via IContactProperties (see
//          icontact.idl)
//
...
// physical addresses
//
#define CONTACTPROP_PUB_L1_PHYSICALADDRESSCOLLECTION                           \
