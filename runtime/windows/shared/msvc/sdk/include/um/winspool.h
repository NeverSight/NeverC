...
typedef struct _DRIVER_INFO_3A {
  ...
  LPSTR
  pDependentFiles; // PSCRIPT.DLL\0QMS810.PPD\0PSCRIPTUI.DLL\0PSCRIPTUI.HLP\0PSTEST.TXT\0\0
...
//  e.g. Instead of playing pages in order 4,3,2,1, print processor can play
//  them 3,4,1,2
...
_Success_(return != FALSE) BOOL WINAPI
    EnumPrintersA(_In_ DWORD Flags, _In_opt_ LPSTR Name, DWORD Level,
                  _Out_writes_bytes_to_opt_(cbBuf, *pcbNeeded)
                      LPBYTE pPrinterEnum,
                  DWORD cbBuf, _Out_ LPDWORD pcbNeeded,
                  _Out_ LPDWORD pcReturned);
_Success_(return != FALSE) BOOL WINAPI
    EnumPrintersW(_In_ DWORD Flags, _In_opt_ LPWSTR Name, DWORD Level,
                  _Out_writes_bytes_to_opt_(cbBuf, *pcbNeeded)
                      LPBYTE pPrinterEnum,
                  DWORD cbBuf, _Out_ LPDWORD pcbNeeded,
                  _Out_ LPDWORD pcReturned);
...
HANDLE
WINAPI
GetSpoolFileHandle(_In_ HANDLE hPrinter);

HANDLE
WINAPI
CommitSpoolData(_In_ HANDLE hPrinter, _In_ HANDLE hSpoolFile, DWORD cbCommit);

BOOL WINAPI CloseSpoolFileHandle(_In_ HANDLE hPrinter, _In_ HANDLE hSpoolFile);

BOOL WINAPI OpenPrinterA(_In_opt_ LPSTR pPrinterName, _Out_ LPHANDLE phPrinter,
                         _In_opt_ LPPRINTER_DEFAULTSA pDefault);
BOOL WINAPI OpenPrinterW(_In_opt_ LPWSTR pPrinterName, _Out_ LPHANDLE phPrinter,
...
BOOL WINAPI ResetPrinterA(_In_ HANDLE hPrinter,
                          _In_opt_ LPPRINTER_DEFAULTSA pDefault);
BOOL WINAPI ResetPrinterW(_In_ HANDLE hPrinter,
                          _In_opt_ LPPRINTER_DEFAULTSW pDefault);
#ifdef UNICODE
...
BOOL WINAPI SetJobA(
    _In_ HANDLE hPrinter, DWORD JobId, _In_range_(0, 4) DWORD Level,
...
BOOL WINAPI GetJobA(_In_ HANDLE hPrinter, DWORD JobId, DWORD Level,
                    _Out_writes_bytes_opt_(cbBuf) LPBYTE pJob, DWORD cbBuf,
                    _Out_ LPDWORD pcbNeeded);
BOOL WINAPI GetJobW(_In_ HANDLE hPrinter, DWORD JobId, DWORD Level,
                    _Out_writes_bytes_opt_(cbBuf) LPBYTE pJob, DWORD cbBuf,
                    _Out_ LPDWORD pcbNeeded);
#ifdef UNICODE
...
BOOL WINAPI EnumJobsA(_In_ HANDLE hPrinter, DWORD FirstJob, DWORD NoJobs,
                      DWORD Level, _Out_writes_bytes_opt_(cbBuf) LPBYTE pJob,
                      DWORD cbBuf, _Out_ LPDWORD pcbNeeded,
                      _Out_ LPDWORD pcReturned);
BOOL WINAPI EnumJobsW(_In_ HANDLE hPrinter, DWORD FirstJob, DWORD NoJobs,
                      DWORD Level, _Out_writes_bytes_opt_(cbBuf) LPBYTE pJob,
                      DWORD cbBuf, _Out_ LPDWORD pcbNeeded,
                      _Out_ LPDWORD pcReturned);
#ifdef UNICODE
...
HANDLE
WINAPI
AddPrinterA(_In_opt_ LPSTR pName, _In_range_(1, 2) DWORD Level,
            _When_(Level == 1, _In_reads_bytes_(sizeof(PRINTER_INFO_1)))
                _When_(Level == 2, _In_reads_bytes_(sizeof(PRINTER_INFO_2)))
                    LPBYTE pPrinter);
HANDLE
WINAPI
AddPrinterW(_In_opt_ LPWSTR pName, _In_range_(1, 2) DWORD Level,
            _When_(Level == 1, _In_reads_bytes_(sizeof(PRINTER_INFO_1)))
                _When_(Level == 2, _In_reads_bytes_(sizeof(PRINTER_INFO_2)))
                    LPBYTE pPrinter);
#ifdef UNICODE
...
BOOL WINAPI DeletePrinter(_Inout_ HANDLE hPrinter);

BOOL WINAPI SetPrinterA(
    _In_ HANDLE hPrinter, _In_range_(0, 9) DWORD Level,
    _When_(Level == 0 && Command == PRINTER_CONTROL_SET_STATUS,
           _In_reads_bytes_(sizeof(DWORD)))
        _When_(Level == 0 && Command != PRINTER_CONTROL_SET_STATUS,
               _In_opt_) _When_(Level == 1,
                                _In_reads_bytes_(sizeof(PRINTER_INFO_1)))
            _When_(Level == 2, _In_reads_bytes_(sizeof(PRINTER_INFO_2))) _When_(
                Level == 3, _In_reads_bytes_(sizeof(PRINTER_INFO_3)))
                _When_(Level == 4, _In_reads_bytes_(sizeof(PRINTER_INFO_4)))
                    _When_(Level == 5, _In_reads_bytes_(sizeof(PRINTER_INFO_5)))
                        _When_(Level == 6,
                               _In_reads_bytes_(sizeof(PRINTER_INFO_6)))
                            _When_(Level == 7,
                                   _In_reads_bytes_(sizeof(PRINTER_INFO_7)))
                                _When_(Level == 8,
                                       _In_reads_bytes_(sizeof(PRINTER_INFO_8)))
                                    _When_(Level == 9, _In_reads_bytes_(sizeof(
                                                           PRINTER_INFO_9)))
                                        LPBYTE pPrinter,
    _In_ DWORD Command);
...
BOOL WINAPI GetPrinterA(_In_ HANDLE hPrinter, DWORD Level,
                        _Out_writes_bytes_opt_(cbBuf) LPBYTE pPrinter,
                        DWORD cbBuf, _Out_ LPDWORD pcbNeeded);
BOOL WINAPI GetPrinterW(_In_ HANDLE hPrinter, DWORD Level,
                        _Out_writes_bytes_opt_(cbBuf) LPBYTE pPrinter,
                        DWORD cbBuf, _Out_ LPDWORD pcbNeeded);
#ifdef UNICODE
...
BOOL WINAPI AddPrinterDriverA(_In_opt_ LPSTR pName, DWORD Level,
                              _In_ LPBYTE pDriverInfo);
BOOL WINAPI AddPrinterDriverW(_In_opt_ LPWSTR pName, DWORD Level,
                              _In_ LPBYTE pDriverInfo);
#ifdef UNICODE
...
BOOL WINAPI AddPrinterDriverExA(
    _In_opt_ LPSTR pName, _In_range_(2, 8) DWORD Level,
...
BOOL WINAPI AddPrinterDriverExW(
    _In_opt_ LPWSTR pName, _In_range_(2, 8) DWORD Level,
    _When_(Level == 2, _In_reads_bytes_(sizeof(DRIVER_INFO_2)))
        _When_(Level == 3, _In_reads_bytes_(sizeof(DRIVER_INFO_3)))
            _When_(Level == 4, _In_reads_bytes_(sizeof(DRIVER_INFO_4)))
                _When_(Level == 6, _In_reads_bytes_(sizeof(DRIVER_INFO_6)))
...
BOOL WINAPI EnumPrinterDriversA(_In_opt_ LPSTR pName,
                                _In_opt_ LPSTR pEnvironment, DWORD Level,
                                _Out_writes_bytes_opt_(cbBuf)
                                    LPBYTE pDriverInfo,
                                DWORD cbBuf, _Out_ LPDWORD pcbNeeded,
                                _Out_ LPDWORD pcReturned);
BOOL WINAPI EnumPrinterDriversW(_In_opt_ LPWSTR pName,
                                _In_opt_ LPWSTR pEnvironment, DWORD Level,
                                _Out_writes_bytes_opt_(cbBuf)
                                    LPBYTE pDriverInfo,
                                DWORD cbBuf, _Out_ LPDWORD pcbNeeded,
                                _Out_ LPDWORD pcReturned);
...
BOOL WINAPI GetPrinterDriverA(_In_ HANDLE hPrinter, _In_opt_ LPSTR pEnvironment,
                              DWORD Level,
                              _Out_writes_bytes_opt_(cbBuf) LPBYTE pDriverInfo,
                              DWORD cbBuf, _Out_ LPDWORD pcbNeeded);
BOOL WINAPI GetPrinterDriverW(_In_ HANDLE hPrinter,
                              _In_opt_ LPWSTR pEnvironment, DWORD Level,
                              _Out_writes_bytes_opt_(cbBuf) LPBYTE pDriverInfo,
                              DWORD cbBuf, _Out_ LPDWORD pcbNeeded);
#ifdef UNICODE
...
BOOL WINAPI GetPrinterDriverDirectoryA(_In_opt_ LPSTR pName,
                                       _In_opt_ LPSTR pEnvironment, DWORD Level,
                                       _Out_writes_bytes_opt_(cbBuf)
                                           LPBYTE pDriverDirectory,
                                       DWORD cbBuf, _Out_ LPDWORD pcbNeeded);
BOOL WINAPI GetPrinterDriverDirectoryW(_In_opt_ LPWSTR pName,
...
BOOL WINAPI DeletePrinterDriverA(_In_opt_ LPSTR pName,
                                 _In_opt_ LPSTR pEnvironment,
                                 _In_ LPSTR pDriverName);
BOOL WINAPI DeletePrinterDriverW(_In_opt_ LPWSTR pName,
                                 _In_opt_ LPWSTR pEnvironment,
...
BOOL WINAPI DeletePrinterDriverExA(_In_opt_ LPSTR pName,
                                   _In_opt_ LPSTR pEnvironment,
                                   _In_ LPSTR pDriverName, DWORD dwDeleteFlag,
                                   DWORD dwVersionFlag);
BOOL WINAPI DeletePrinterDriverExW(_In_opt_ LPWSTR pName,
                                   _In_opt_ LPWSTR pEnvironment,
                                   _In_ LPWSTR pDriverName, DWORD dwDeleteFlag,
                                   DWORD dwVersionFlag);
#ifdef UNICODE
...
BOOL WINAPI AddPrintProcessorA(_In_opt_ LPSTR pName,
                               _In_opt_ LPSTR pEnvironment,
                               _In_ LPSTR pPathName,
                               _In_ LPSTR pPrintProcessorName);
BOOL WINAPI AddPrintProcessorW(_In_opt_ LPWSTR pName,
                               _In_opt_ LPWSTR pEnvironment,
...
BOOL WINAPI EnumPrintProcessorsA(_In_opt_ LPSTR pName,
                                 _In_opt_ LPSTR pEnvironment, DWORD Level,
                                 _Out_writes_bytes_opt_(cbBuf)
                                     LPBYTE pPrintProcessorInfo,
                                 DWORD cbBuf, _Out_ LPDWORD pcbNeeded,
                                 _Out_ LPDWORD pcReturned);
BOOL WINAPI EnumPrintProcessorsW(_In_opt_ LPWSTR pName,
                                 _In_opt_ LPWSTR pEnvironment, DWORD Level,
                                 _Out_writes_bytes_opt_(cbBuf)
                                     LPBYTE pPrintProcessorInfo,
                                 DWORD cbBuf, _Out_ LPDWORD pcbNeeded,
...
BOOL WINAPI GetPrintProcessorDirectoryA(_In_opt_ LPSTR pName,
                                        _In_opt_ LPSTR pEnvironment,
                                        DWORD Level,
                                        _Out_writes_bytes_opt_(cbBuf)
                                            LPBYTE pPrintProcessorInfo,
                                        DWORD cbBuf, _Out_ LPDWORD pcbNeeded);
BOOL WINAPI GetPrintProcessorDirectoryW(_In_opt_ LPWSTR pName,
                                        _In_opt_ LPWSTR pEnvironment,
                                        DWORD Level,
                                        _Out_writes_bytes_opt_(cbBuf)
                                            LPBYTE pPrintProcessorInfo,
...
_Success_(return != FALSE) BOOL WINAPI EnumPrintProcessorDatatypesA(
    _In_opt_ LPSTR pName, _In_ LPSTR pPrintProcessorName, DWORD Level,
    _Out_writes_bytes_opt_(cbBuf) LPBYTE pDatatypes, DWORD cbBuf,
    _Out_ LPDWORD pcbNeeded, _Out_ LPDWORD pcReturned);
_Success_(return != FALSE) BOOL WINAPI EnumPrintProcessorDatatypesW(
    _In_opt_ LPWSTR pName, _In_ LPWSTR pPrintProcessorName, DWORD Level,
    _Out_writes_bytes_opt_(cbBuf) LPBYTE pDatatypes, DWORD cbBuf,
    _Out_ LPDWORD pcbNeeded, _Out_ LPDWORD pcReturned);
#ifdef UNICODE
...
BOOL WINAPI DeletePrintProcessorA(_In_opt_ LPSTR pName,
                                  _In_opt_ LPSTR pEnvironment,
                                  _In_ LPSTR pPrintProcessorName);
BOOL WINAPI DeletePrintProcessorW(_In_opt_ LPWSTR pName,
                                  _In_opt_ LPWSTR pEnvironment,
                                  _In_ LPWSTR pPrintProcessorName);
#ifdef UNICODE
...
DWORD
WINAPI
StartDocPrinterA(_In_ HANDLE hPrinter, _In_range_(1, 3) DWORD Level,
                 _When_(Level == 1, _In_reads_bytes_(sizeof(DOC_INFO_1)))
                     _When_(Level == 3, _In_reads_bytes_(sizeof(DOC_INFO_3)))
                         LPBYTE pDocInfo);
DWORD
WINAPI
StartDocPrinterW(_In_ HANDLE hPrinter, _In_range_(1, 3) DWORD Level,
                 _When_(Level == 1, _In_reads_bytes_(sizeof(DOC_INFO_1)))
                     _When_(Level == 3, _In_reads_bytes_(sizeof(DOC_INFO_3)))
                         LPBYTE pDocInfo);
#ifdef UNICODE
...
BOOL WINAPI WritePrinter(_In_ HANDLE hPrinter,
                         _In_reads_bytes_(cbBuf) LPVOID pBuf, DWORD cbBuf,
                         _Out_ LPDWORD pcWritten);

BOOL WINAPI FlushPrinter(_In_ HANDLE hPrinter,
                         _In_reads_bytes_opt_(cbBuf) LPVOID pBuf, DWORD cbBuf,
                         _Out_ LPDWORD pcWritten, DWORD cSleep);

BOOL WINAPI EndPagePrinter(_In_ HANDLE hPrinter);

BOOL WINAPI AbortPrinter(_In_ HANDLE hPrinter);

BOOL WINAPI ReadPrinter(_In_ HANDLE hPrinter,
                        _Out_writes_bytes_(cbBuf) LPVOID pBuf, DWORD cbBuf,
                        _Out_ LPDWORD pNoBytesRead);

BOOL WINAPI EndDocPrinter(_In_ HANDLE hPrinter);

BOOL WINAPI AddJobA(_In_ HANDLE hPrinter, DWORD Level,
                    _Out_writes_bytes_opt_(cbBuf) LPBYTE pData, DWORD cbBuf,
                    _Out_ LPDWORD pcbNeeded);
BOOL WINAPI AddJobW(_In_ HANDLE hPrinter, DWORD Level,
                    _Out_writes_bytes_opt_(cbBuf) LPBYTE pData, DWORD cbBuf,
                    _Out_ LPDWORD pcbNeeded);
#ifdef UNICODE
...
BOOL WINAPI ScheduleJob(_In_ HANDLE hPrinter, DWORD JobId);

BOOL WINAPI PrinterProperties(_In_ HWND hWnd, _In_ HANDLE hPrinter);

_When_(fMode == 0, _Post_satisfies_(return >= sizeof(DEVMODE))) LONG WINAPI
    DocumentPropertiesA(_In_opt_ HWND hWnd, _In_ HANDLE hPrinter,
                        _In_ LPSTR pDeviceName,
                        _Out_opt_ PDEVMODEA pDevModeOutput,
                        _In_opt_ PDEVMODEA pDevModeInput, DWORD fMode);
_When_(fMode == 0, _Post_satisfies_(return >= sizeof(DEVMODE))) LONG WINAPI
    DocumentPropertiesW(_In_opt_ HWND hWnd, _In_ HANDLE hPrinter,
                        _In_ LPWSTR pDeviceName,
                        _Out_opt_ PDEVMODEW pDevModeOutput,
                        _In_opt_ PDEVMODEW pDevModeInput, DWORD fMode);
#ifdef UNICODE
...
LONG WINAPI AdvancedDocumentPropertiesA(_In_ HWND hWnd, _In_ HANDLE hPrinter,
                                        _In_ LPSTR pDeviceName,
                                        _Inout_opt_ PDEVMODEA pDevModeOutput,
                                        _In_opt_ PDEVMODEA pDevModeInput);
LONG WINAPI AdvancedDocumentPropertiesW(_In_ HWND hWnd, _In_ HANDLE hPrinter,
                                        _In_ LPWSTR pDeviceName,
...
LONG ExtDeviceMode(_In_opt_ HWND hWnd, _In_opt_ HANDLE hInst,
                   _Inout_opt_ LPDEVMODEA pDevModeOutput,
                   _In_opt_ LPSTR pDeviceName, _In_opt_ LPSTR pPort,
                   _In_opt_ LPDEVMODEA pDevModeInput, _In_opt_ LPSTR pProfile,
                   DWORD fMode);
#endif // (NTDDI_VERSION >= NTDDI_WINXPSP1)

DWORD
WINAPI
GetPrinterDataA(_In_ HANDLE hPrinter, _In_ LPSTR pValueName,
                _Out_opt_ LPDWORD pType,
                _Out_writes_bytes_opt_(nSize) LPBYTE pData, DWORD nSize,
                _Out_ LPDWORD pcbNeeded);
DWORD
WINAPI
GetPrinterDataW(_In_ HANDLE hPrinter, _In_ LPWSTR pValueName,
                _Out_opt_ LPDWORD pType,
                _Out_writes_bytes_opt_(nSize) LPBYTE pData, DWORD nSize,
                _Out_ LPDWORD pcbNeeded);
#ifdef UNICODE
...
DWORD
WINAPI
GetPrinterDataExA(_In_ HANDLE hPrinter, _In_ LPCSTR pKeyName,
                  _In_ LPCSTR pValueName, _Out_opt_ LPDWORD pType,
                  _Out_writes_bytes_opt_(nSize) LPBYTE pData, DWORD nSize,
                  _Out_ LPDWORD pcbNeeded);
DWORD
WINAPI
GetPrinterDataExW(_In_ HANDLE hPrinter, _In_ LPCWSTR pKeyName,
...
DWORD
WINAPI
EnumPrinterDataA(_In_ HANDLE hPrinter, DWORD dwIndex,
                 _Out_writes_bytes_(cbValueName) LPSTR pValueName,
                 DWORD cbValueName, _Out_ LPDWORD pcbValueName,
                 _Out_opt_ LPDWORD pType,
...
DWORD
WINAPI
EnumPrinterDataW(_In_ HANDLE hPrinter, DWORD dwIndex,
...
DWORD
WINAPI
EnumPrinterDataExA(_In_ HANDLE hPrinter, _In_ LPCSTR pKeyName,
                   _Out_writes_bytes_opt_(cbEnumValues) LPBYTE pEnumValues,
                   DWORD cbEnumValues, _Out_ LPDWORD pcbEnumValues,
                   _Out_ LPDWORD pnEnumValues);
DWORD
WINAPI
EnumPrinterDataExW(_In_ HANDLE hPrinter, _In_ LPCWSTR pKeyName,
                   _Out_writes_bytes_opt_(cbEnumValues) LPBYTE pEnumValues,
                   DWORD cbEnumValues, _Out_ LPDWORD pcbEnumValues,
                   _Out_ LPDWORD pnEnumValues);
#ifdef UNICODE
...
DWORD
WINAPI
EnumPrinterKeyA(_In_ HANDLE hPrinter, _In_ LPCSTR pKeyName,
                _Out_writes_bytes_opt_(cbSubkey) LPSTR pSubkey, DWORD cbSubkey,
                _Out_ LPDWORD pcbSubkey);
DWORD
WINAPI
EnumPrinterKeyW(_In_ HANDLE hPrinter, _In_ LPCWSTR pKeyName,
                _Out_writes_bytes_opt_(cbSubkey) LPWSTR pSubkey, DWORD cbSubkey,
                _Out_ LPDWORD pcbSubkey);
#ifdef UNICODE
...
DWORD
WINAPI
SetPrinterDataA(_In_ HANDLE hPrinter, _In_ LPSTR pValueName, DWORD Type,
                _In_reads_bytes_(cbData) LPBYTE pData, DWORD cbData);
DWORD
WINAPI
SetPrinterDataW(_In_ HANDLE hPrinter, _In_ LPWSTR pValueName, DWORD Type,
                _In_reads_bytes_(cbData) LPBYTE pData, DWORD cbData);
#ifdef UNICODE
...
DWORD
WINAPI
SetPrinterDataExA(_In_ HANDLE hPrinter, _In_ LPCSTR pKeyName,
                  _In_ LPCSTR pValueName, DWORD Type,
                  _In_reads_bytes_(cbData) LPBYTE pData, DWORD cbData);
DWORD
WINAPI
SetPrinterDataExW(_In_ HANDLE hPrinter, _In_ LPCWSTR pKeyName,
                  _In_ LPCWSTR pValueName, DWORD Type,
                  _In_reads_bytes_(cbData) LPBYTE pData, DWORD cbData);
#ifdef UNICODE
...
DWORD
WINAPI
DeletePrinterDataA(_In_ HANDLE hPrinter, _In_ LPSTR pValueName);
DWORD
WINAPI
DeletePrinterDataW(_In_ HANDLE hPrinter, _In_ LPWSTR pValueName);
#ifdef UNICODE
...
DWORD
WINAPI
DeletePrinterDataExA(_In_ HANDLE hPrinter, _In_ LPCSTR pKeyName,
                     _In_ LPCSTR pValueName);
DWORD
WINAPI
DeletePrinterDataExW(_In_ HANDLE hPrinter, _In_ LPCWSTR pKeyName,
...
DWORD
WINAPI
DeletePrinterKeyA(_In_ HANDLE hPrinter, _In_ LPCSTR pKeyName);
DWORD
WINAPI
DeletePrinterKeyW(_In_ HANDLE hPrinter, _In_ LPCWSTR pKeyName);
#ifdef UNICODE
...
DWORD
WINAPI
WaitForPrinterChange(_In_ HANDLE hPrinter, DWORD Flags);

HANDLE
WINAPI
FindFirstPrinterChangeNotification(_In_ HANDLE hPrinter, DWORD fdwFilter,
                                   DWORD fdwOptions,
                                   _In_opt_ PVOID pPrinterNotifyOptions);

BOOL WINAPI FindNextPrinterChangeNotification(
    _In_ HANDLE hChange, _Out_opt_ PDWORD pdwChange, _In_opt_ LPVOID pvReserved,
    _Out_opt_ LPVOID *ppPrinterNotifyInfo);

BOOL WINAPI FreePrinterNotifyInfo(_In_ PPRINTER_NOTIFY_INFO pPrinterNotifyInfo);

BOOL WINAPI FindClosePrinterChangeNotification(_In_ HANDLE hChange);
...
DWORD
WINAPI
PrinterMessageBoxA(_In_ HANDLE hPrinter, DWORD Error, _In_ HWND hWnd,
                   _In_ LPSTR pText, _In_ LPSTR pCaption, DWORD dwType);
DWORD
WINAPI
PrinterMessageBoxW(_In_ HANDLE hPrinter, DWORD Error, _In_ HWND hWnd,
                   _In_ LPWSTR pText, _In_ LPWSTR pCaption, DWORD dwType);
#ifdef UNICODE
...
BOOL WINAPI AddFormA(_In_ HANDLE hPrinter, _In_range_(1, 2) DWORD Level,
                     _When_(Level == 1, _In_reads_bytes_(sizeof(FORM_INFO_1A)))
                         _When_(Level == 2,
                                _In_reads_bytes_(sizeof(FORM_INFO_2A)))
                             LPBYTE pForm);
BOOL WINAPI AddFormW(_In_ HANDLE hPrinter, _In_range_(1, 2) DWORD Level,
...
BOOL WINAPI DeleteFormA(_In_ HANDLE hPrinter, _In_ LPSTR pFormName);
BOOL WINAPI DeleteFormW(_In_ HANDLE hPrinter, _In_ LPWSTR pFormName);
#ifdef UNICODE
...
BOOL WINAPI GetFormA(_In_ HANDLE hPrinter, _In_ LPSTR pFormName, DWORD Level,
                     _Out_writes_bytes_opt_(cbBuf) LPBYTE pForm, DWORD cbBuf,
                     _Out_ LPDWORD pcbNeeded);
BOOL WINAPI GetFormW(_In_ HANDLE hPrinter, _In_ LPWSTR pFormName, DWORD Level,
                     _Out_writes_bytes_opt_(cbBuf) LPBYTE pForm, DWORD cbBuf,
                     _Out_ LPDWORD pcbNeeded);
#ifdef UNICODE
...
BOOL WINAPI SetFormA(_In_ HANDLE hPrinter, _In_ LPSTR pFormName,
                     _In_range_(1, 2) DWORD Level,
                     _When_(Level == 1, _In_reads_bytes_(sizeof(FORM_INFO_1A)))
                         _When_(Level == 2,
                                _In_reads_bytes_(sizeof(FORM_INFO_2A)))
                             LPBYTE pForm);
BOOL WINAPI SetFormW(_In_ HANDLE hPrinter, _In_ LPWSTR pFormName,
                     _In_range_(1, 2) DWORD Level,
                     _When_(Level == 1, _In_reads_bytes_(sizeof(FORM_INFO_1W)))
                         _When_(Level == 2,
                                _In_reads_bytes_(sizeof(FORM_INFO_2W)))
...
BOOL WINAPI EnumFormsA(_In_ HANDLE hPrinter, DWORD Level,
                       _Out_writes_bytes_opt_(cbBuf) LPBYTE pForm, DWORD cbBuf,
                       _Out_ LPDWORD pcbNeeded, _Out_ LPDWORD pcReturned);
BOOL WINAPI EnumFormsW(_In_ HANDLE hPrinter, DWORD Level,
                       _Out_writes_bytes_opt_(cbBuf) LPBYTE pForm, DWORD cbBuf,
                       _Out_ LPDWORD pcbNeeded, _Out_ LPDWORD pcReturned);
#ifdef UNICODE
...
BOOL WINAPI EnumMonitorsA(_In_opt_ LPSTR pName, DWORD Level,
                          _Out_writes_bytes_opt_(cbBuf) LPBYTE pMonitor,
                          DWORD cbBuf, _Out_ LPDWORD pcbNeeded,
                          _Out_ LPDWORD pcReturned);
BOOL WINAPI EnumMonitorsW(_In_opt_ LPWSTR pName, DWORD Level,
                          _Out_writes_bytes_opt_(cbBuf) LPBYTE pMonitor,
                          DWORD cbBuf, _Out_ LPDWORD pcbNeeded,
                          _Out_ LPDWORD pcReturned);
#ifdef UNICODE
...
BOOL WINAPI AddMonitorA(_In_opt_ LPSTR pName, DWORD Level,
                        _In_reads_bytes_opt_(sizeof(MONITOR_INFO_2))
                            LPBYTE pMonitors);
BOOL WINAPI AddMonitorW(_In_opt_ LPWSTR pName, DWORD Level,
                        _In_reads_bytes_opt_(sizeof(MONITOR_INFO_2))
                            LPBYTE pMonitors);
#ifdef UNICODE
...
BOOL WINAPI DeleteMonitorA(_In_opt_ LPSTR pName, _In_opt_ LPSTR pEnvironment,
                           _In_ LPSTR pMonitorName);
BOOL WINAPI DeleteMonitorW(_In_opt_ LPWSTR pName, _In_opt_ LPWSTR pEnvironment,
...
BOOL WINAPI EnumPortsA(_In_opt_ LPSTR pName, DWORD Level,
                       _Out_writes_bytes_opt_(cbBuf) LPBYTE pPort, DWORD cbBuf,
                       _Out_ LPDWORD pcbNeeded, _Out_ LPDWORD pcReturned);
BOOL WINAPI EnumPortsW(_In_opt_ LPWSTR pName, DWORD Level,
                       _Out_writes_bytes_opt_(cbBuf) LPBYTE pPort, DWORD cbBuf,
                       _Out_ LPDWORD pcbNeeded, _Out_ LPDWORD pcReturned);
#ifdef UNICODE
...
BOOL WINAPI AddPortA(_In_opt_ LPSTR pName, _In_ HWND hWnd,
                     _In_ LPSTR pMonitorName);
BOOL WINAPI AddPortW(_In_opt_ LPWSTR pName, _In_ HWND hWnd,
                     _In_ LPWSTR pMonitorName);
#ifdef UNICODE
...
BOOL WINAPI ConfigurePortA(_In_opt_ LPSTR pName, _In_ HWND hWnd,
                           _In_ LPSTR pPortName);
BOOL WINAPI ConfigurePortW(_In_opt_ LPWSTR pName, _In_ HWND hWnd,
...
BOOL WINAPI DeletePortA(_In_opt_ LPSTR pName, _In_ HWND hWnd,
                        _In_ LPSTR pPortName);
BOOL WINAPI DeletePortW(_In_opt_ LPWSTR pName, _In_ HWND hWnd,
                        _In_ LPWSTR pPortName);
#ifdef UNICODE
...
BOOL WINAPI XcvDataW(_In_ HANDLE hXcv, _In_ PCWSTR pszDataName,
...
BOOL WINAPI GetDefaultPrinterA(_Out_writes_opt_(*pcchBuffer) LPSTR pszBuffer,
                               _Inout_ LPDWORD pcchBuffer);
BOOL WINAPI GetDefaultPrinterW(_Out_writes_opt_(*pcchBuffer) LPWSTR pszBuffer,
                               _Inout_ LPDWORD pcchBuffer);
#ifdef UNICODE
...
BOOL WINAPI SetDefaultPrinterA(_In_opt_ LPCSTR pszPrinter);
BOOL WINAPI SetDefaultPrinterW(_In_opt_ LPCWSTR pszPrinter);
#ifdef UNICODE
...
BOOL WINAPI SetPortA(_In_opt_ LPSTR pName, _In_ LPSTR pPortName, DWORD dwLevel,
                     _In_reads_bytes_(sizeof(PORT_INFO_3)) LPBYTE pPortInfo);
BOOL WINAPI SetPortW(_In_opt_ LPWSTR pName, _In_ LPWSTR pPortName,
                     DWORD dwLevel,
                     _In_reads_bytes_(sizeof(PORT_INFO_3)) LPBYTE pPortInfo);
#ifdef UNICODE
...
BOOL WINAPI AddPrinterConnectionA(_In_ LPSTR pName);
BOOL WINAPI AddPrinterConnectionW(_In_ LPWSTR pName);
#ifdef UNICODE
...
BOOL WINAPI DeletePrinterConnectionA(_In_ LPSTR pName);
BOOL WINAPI DeletePrinterConnectionW(_In_ LPWSTR pName);
#ifdef UNICODE
...
HANDLE
WINAPI
ConnectToPrinterDlg(_In_ HWND hwnd, DWORD Flags);
...
BOOL WINAPI AddPrintProvidorA(
    _In_opt_ LPSTR pName, _In_range_(1, 2) DWORD Level,
...
BOOL WINAPI AddPrintProvidorW(
    _In_opt_ LPWSTR pName, _In_range_(1, 2) DWORD Level,
    _When_(Level == 1, _In_reads_bytes_(sizeof(PROVIDOR_INFO_1)))
        _When_(Level == 2, _In_reads_bytes_(sizeof(PROVIDOR_INFO_2)))
            _In_ LPBYTE pProvidorInfo);
#ifdef UNICODE
...
BOOL WINAPI DeletePrintProvidorA(_In_opt_ LPSTR pName,
                                 _In_opt_ LPSTR pEnvironment,
                                 _In_ LPSTR pPrintProvidorName);
BOOL WINAPI DeletePrintProvidorW(_In_opt_ LPWSTR pName,
                                 _In_opt_ LPWSTR pEnvironment,
...
BOOL WINAPI IsValidDevmodeA(_In_opt_ PDEVMODEA pDevmode, size_t DevmodeSize);
BOOL WINAPI IsValidDevmodeW(_In_opt_ PDEVMODEW pDevmode, size_t DevmodeSize);
#ifdef UNICODE
...
#if (NTDDI_VERSION >= NTDDI_WIN8)
#define SPLREG_PRINT_QUEUE_V4_DRIVER_DIRECTORY                                 \
  TEXT("PrintQueueV4DriverDirectory")
#endif // (NTDDI_VERSION >= NTDDI_WIN8)
...
BOOL WINAPI OpenPrinter2A(_In_opt_ LPCSTR pPrinterName,
                          _Out_ LPHANDLE phPrinter,
                          _In_opt_ PPRINTER_DEFAULTSA pDefault,
                          _In_opt_ PPRINTER_OPTIONSA pOptions);
BOOL WINAPI OpenPrinter2W(_In_opt_ LPCWSTR pPrinterName,
                          _Out_ LPHANDLE phPrinter,
...
#define PRINTER_CONNECTION_NO_UI                                               \
  0x00000040 // Fail call if UI is needed in order to install printer driver
...
BOOL WINAPI AddPrinterConnection2A(_In_opt_ HWND hWnd, _In_ LPCSTR pszName,
                                   DWORD dwLevel, _In_ PVOID pConnectionInfo);
BOOL WINAPI AddPrinterConnection2W(_In_opt_ HWND hWnd, _In_ LPCWSTR pszName,
                                   DWORD dwLevel, _In_ PVOID pConnectionInfo);
#ifdef UNICODE
...
HRESULT
WINAPI
InstallPrinterDriverFromPackageA(_In_opt_ LPCSTR pszServer,
...
HRESULT
WINAPI
InstallPrinterDriverFromPackageW(_In_opt_ LPCWSTR pszServer,
...
#define UPDP_SILENT_UPLOAD                                                     \
  0x00000001 // If specified we will not show UI during
             // UploadPrinterDriverPackage API.
#define UPDP_UPLOAD_ALWAYS                                                     \
  0x00000002 // Will not do the optimization of not uploading the files if the
             // driver package is already present on remote machine.
#define UPDP_CHECK_DRIVERSTORE                                                 \
  0x00000004 // Check whether the given package exists in driver store or not.

HRESULT
WINAPI
UploadPrinterDriverPackageA(_In_opt_ LPCSTR pszServer, _In_ LPCSTR pszInfPath,
                            _In_opt_ LPCSTR pszEnvironment, _In_ DWORD dwFlags,
                            _In_ HWND hwnd,
                            _Out_writes_(*pcchDestInfPath) LPSTR pszDestInfPath,
                            _Inout_ PULONG pcchDestInfPath);
HRESULT
WINAPI
UploadPrinterDriverPackageW(_In_opt_ LPCWSTR pszServer, _In_ LPCWSTR pszInfPath,
                            _In_opt_ LPCWSTR pszEnvironment, _In_ DWORD dwFlags,
                            _In_ HWND hwnd,
...
HRESULT
WINAPI
GetCorePrinterDriversA(_In_opt_ LPCSTR pszServer,
                       _In_opt_ LPCSTR pszEnvironment,
                       _In_ LPCSTR pszzCoreDriverDependencies,
                       _In_ DWORD cCorePrinterDrivers,
                       _Out_writes_(cCorePrinterDrivers)
                           PCORE_PRINTER_DRIVERA pCorePrinterDrivers);
HRESULT
WINAPI
GetCorePrinterDriversW(_In_opt_ LPCWSTR pszServer,
                       _In_opt_ LPCWSTR pszEnvironment,
...
HRESULT
WINAPI
CorePrinterDriverInstalledA(_In_opt_ LPCSTR pszServer,
                            _In_opt_ LPCSTR pszEnvironment,
...
HRESULT
WINAPI
CorePrinterDriverInstalledW(_In_opt_ LPCWSTR pszServer,
                            _In_opt_ LPCWSTR pszEnvironment,
                            _In_ GUID CoreDriverGUID,
                            _In_ FILETIME ftDriverDate,
                            _In_ DWORDLONG dwlDriverVersion,
...
GetPrinterDriverPackagePathA(
    _In_opt_ LPCSTR pszServer, _In_opt_ LPCSTR pszEnvironment,
    _In_opt_ LPCSTR pszLanguage, _In_ LPCSTR pszPackageID,
    _Inout_updates_opt_(cchDriverPackageCab) LPSTR pszDriverPackageCab,
    _In_opt_ DWORD cchDriverPackageCab, _Out_ LPDWORD pcchRequiredSize);
HRESULT
WINAPI
GetPrinterDriverPackagePathW(
    _In_opt_ LPCWSTR pszServer, _In_opt_ LPCWSTR pszEnvironment,
    _In_opt_ LPCWSTR pszLanguage, _In_ LPCWSTR pszPackageID,
...
HRESULT
WINAPI
DeletePrinterDriverPackageA(_In_opt_ LPCSTR pszServer, _In_ LPCSTR pszInfPath,
                            _In_opt_ LPCSTR pszEnvironment);
HRESULT
WINAPI
DeletePrinterDriverPackageW(_In_opt_ LPCWSTR pszServer, _In_ LPCWSTR pszInfPath,
                            _In_opt_ LPCWSTR pszEnvironment);
#ifdef UNICODE
...
HRESULT
WINAPI
ReportJobProcessingProgress(_In_ HANDLE printerHandle, ULONG jobId,
                            EPrintXPSJobOperation jobOperation,
                            EPrintXPSJobProgress jobProgress);

BOOL WINAPI GetPrinterDriver2A(_In_opt_ HWND hWnd, _In_ HANDLE hPrinter,
                               _In_opt_ LPSTR pEnvironment, DWORD Level,
                               _Out_writes_bytes_opt_(cbBuf) LPBYTE pDriverInfo,
                               DWORD cbBuf, _Out_ LPDWORD pcbNeeded);
BOOL WINAPI GetPrinterDriver2W(_In_opt_ HWND hWnd, _In_ HANDLE hPrinter,
                               _In_opt_ LPWSTR pEnvironment, DWORD Level,
                               _Out_writes_bytes_opt_(cbBuf) LPBYTE pDriverInfo,
                               DWORD cbBuf, _Out_ LPDWORD pcbNeeded);
#ifdef UNICODE
...
BOOL WINAPI GetPrintExecutionData(_Out_ PRINT_EXECUTION_DATA *pData);
...
DWORD
WINAPI
GetJobNamedPropertyValue(_In_ HANDLE hPrinter, _In_ DWORD JobId,
                         _In_ PCWSTR pszName, _Out_ PrintPropertyValue *pValue);

void WINAPI FreePrintPropertyValue(_Inout_ PrintPropertyValue *pValue);

void WINAPI FreePrintNamedPropertyArray(
    _In_ DWORD cProperties,
    _Inout_opt_ _At_(*ppProperties,
                     _Pre_readable_size_(cProperties) _Post_null_)
        PrintNamedProperty **ppProperties);

DWORD
WINAPI
SetJobNamedProperty(_In_ HANDLE hPrinter, _In_ DWORD JobId,
                    _In_ const PrintNamedProperty *pProperty);

DWORD
WINAPI
DeleteJobNamedProperty(_In_ HANDLE hPrinter, _In_ DWORD JobId,
                       _In_ PCWSTR pszName);

DWORD
WINAPI
EnumJobNamedProperties(_In_ HANDLE hPrinter, _In_ DWORD JobId,
...
HRESULT
WINAPI
GetPrintOutputInfo(_In_ HWND hWnd, _In_ PCWSTR pszPrinter,
                   _Outptr_ HANDLE *phFile, _Outptr_ PWSTR *ppszOutputFile);
