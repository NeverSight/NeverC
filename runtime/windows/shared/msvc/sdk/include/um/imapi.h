...
// this assert will cause compilation breaks in clients whose code would cause
// stack corruption when writing to our boolean pointer
...
enum RECORDER_TYPES { RECORDER_CDR = 0x1, RECORDER_CDRW = 0x2 };
...
public:
  ...
  virtual /* [helpstring] */ HRESULT STDMETHODCALLTYPE GetRecorderGUID(
      /* [size_is][unique][out][in] */ __RPC__inout_ecount_full_opt(
          ulBufferSize) byte *
          pbyUniqueID,
  ...
  virtual /* [helpstring] */ HRESULT STDMETHODCALLTYPE GetDisplayNames(
      ...
      /* [unique][out][in] */ __RPC__deref_opt_inout_opt BSTR *
          pbstrRevision) = 0;
...
typedef struct IDiscRecorderVtbl {
  ...
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in IDiscRecorder *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IDiscRecorder *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IDiscRecorder *This);
...
interface IDiscRecorder { CONST_VTBL struct IDiscRecorderVtbl *lpVtbl; };
...
#define IDiscRecorder_GetRecorderGUID(This, pbyUniqueID, ulBufferSize,         \
                                      pulReturnSizeRequired)                   \
  ((This)->lpVtbl->GetRecorderGUID(This, pbyUniqueID, ulBufferSize,            \
                                   pulReturnSizeRequired))

#define IDiscRecorder_GetRecorderType(This, fTypeCode)                         \
  ((This)->lpVtbl->GetRecorderType(This, fTypeCode))

#define IDiscRecorder_GetDisplayNames(This, pbstrVendorID, pbstrProductID,     \
                                      pbstrRevision)                           \
  ((This)->lpVtbl->GetDisplayNames(This, pbstrVendorID, pbstrProductID,        \
                                   pbstrRevision))
...
#define IDiscRecorder_QueryMediaInfo(This, pbSessions, pbLastTrack,            \
                                     ulStartAddress, ulNextWritable,           \
                                     ulFreeBlocks)                             \
  ((This)->lpVtbl->QueryMediaInfo(This, pbSessions, pbLastTrack,               \
                                  ulStartAddress, ulNextWritable,              \
                                  ulFreeBlocks))
...
public:
  virtual HRESULT STDMETHODCALLTYPE Next(
      ...
      __RPC__out_ecount_part(cRecorders, *pcFetched) IDiscRecorder *
          *ppRecorder,
...
typedef struct IEnumDiscRecordersVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in IEnumDiscRecorders *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IEnumDiscRecorders *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IEnumDiscRecorders *This);

  DECLSPEC_XFGVIRT(IEnumDiscRecorders, Next)
  HRESULT(STDMETHODCALLTYPE *Next)(__RPC__in IEnumDiscRecorders *This,
                                   /* [in] */ ULONG cRecorders,
                                   /* [length_is][size_is][out] */
                                   __RPC__out_ecount_part(cRecorders,
                                                          *pcFetched)
                                       IDiscRecorder **ppRecorder,
                                   /* [out] */ __RPC__out ULONG *pcFetched);

  DECLSPEC_XFGVIRT(IEnumDiscRecorders, Skip)
  HRESULT(STDMETHODCALLTYPE *Skip)(__RPC__in IEnumDiscRecorders *This,
                                   /* [in] */ ULONG cRecorders);

  DECLSPEC_XFGVIRT(IEnumDiscRecorders, Reset)
  HRESULT(STDMETHODCALLTYPE *Reset)(__RPC__in IEnumDiscRecorders *This);
...
typedef struct IEnumDiscMasterFormatsVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IEnumDiscMasterFormats *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IEnumDiscMasterFormats *This);

  DECLSPEC_XFGVIRT(IEnumDiscMasterFormats, Next)
  HRESULT(STDMETHODCALLTYPE *Next)(__RPC__in IEnumDiscMasterFormats *This,
                                   /* [in] */ ULONG cFormats,
                                   /* [length_is][size_is][out] */
                                   __RPC__out_ecount_part(cFormats, *pcFetched)
                                       LPIID lpiidFormatID,
                                   /* [out] */ __RPC__out ULONG *pcFetched);

  DECLSPEC_XFGVIRT(IEnumDiscMasterFormats, Skip)
  HRESULT(STDMETHODCALLTYPE *Skip)(__RPC__in IEnumDiscMasterFormats *This,
                                   /* [in] */ ULONG cFormats);

  DECLSPEC_XFGVIRT(IEnumDiscMasterFormats, Reset)
  HRESULT(STDMETHODCALLTYPE *Reset)(__RPC__in IEnumDiscMasterFormats *This);
...
public:
  ...
  virtual /* [helpstring] */ HRESULT STDMETHODCALLTYPE CloseAudioTrack(
      void) = 0;
};
...
typedef struct IRedbookDiscMasterVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in IRedbookDiscMaster *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IRedbookDiscMaster *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IRedbookDiscMaster *This);
...
public:
  ...
  virtual /* [helpstring] */ HRESULT STDMETHODCALLTYPE AddData(
      /* [in] */ __RPC__in_opt IStorage * pStorage, long lFileOverwrite) = 0;
...
typedef struct IJolietDiscMasterVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in IJolietDiscMaster *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IJolietDiscMaster *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IJolietDiscMaster *This);
  ...
  /* [helpstring] */ HRESULT(STDMETHODCALLTYPE *AddData)(
      __RPC__in IJolietDiscMaster *This,
      /* [in] */ __RPC__in_opt IStorage *pStorage, long lFileOverwrite);
...
public:
  ...
  virtual /* [helpstring] */ HRESULT STDMETHODCALLTYPE NotifyPnPActivity(
      void) = 0;
...
typedef struct IDiscMasterProgressEventsVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IDiscMasterProgressEvents *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IDiscMasterProgressEvents *This);
...
#define IDiscMasterProgressEvents_NotifyAddProgress(This, nCompletedSteps,     \
                                                    nTotalSteps)               \
  ((This)->lpVtbl->NotifyAddProgress(This, nCompletedSteps, nTotalSteps))

#define IDiscMasterProgressEvents_NotifyBlockProgress(This, nCompleted,        \
                                                      nTotal)                  \
  ((This)->lpVtbl->NotifyBlockProgress(This, nCompleted, nTotal))

#define IDiscMasterProgressEvents_NotifyTrackProgress(This, nCurrentTrack,     \
                                                      nTotalTracks)            \
...
typedef struct IDiscMasterVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in IDiscMaster *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IDiscMaster *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IDiscMaster *This);
...
interface IDiscMaster { CONST_VTBL struct IDiscMasterVtbl *lpVtbl; };
...
class DECLSPEC_UUID("520CCA61-51A5-11D3-9144-00104BA11C5E") MSDiscRecorderObj;
#endif
...
class DECLSPEC_UUID("520CCA63-51A5-11D3-9144-00104BA11C5E") MSDiscMasterObj;
#endif
