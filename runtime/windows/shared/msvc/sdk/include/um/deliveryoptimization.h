...
typedef enum _DODownloadProperty {
  ...
  DODownloadProperty_CallbackFreqPercent =
      (DODownloadProperty_SecurityFlags + 1),
  DODownloadProperty_CallbackFreqSeconds =
      (DODownloadProperty_CallbackFreqPercent + 1),
  DODownloadProperty_NoProgressTimeoutSeconds =
      (DODownloadProperty_CallbackFreqSeconds + 1),
  DODownloadProperty_ForegroundPriority =
      (DODownloadProperty_NoProgressTimeoutSeconds + 1),
  ...
  DODownloadProperty_StreamInterface =
      (DODownloadProperty_CallbackInterface + 1),
  ...
  DODownloadProperty_DecryptionInfo =
      (DODownloadProperty_CorrelationVector + 1),
  DODownloadProperty_IntegrityCheckInfo =
      (DODownloadProperty_DecryptionInfo + 1),
  DODownloadProperty_IntegrityCheckMandatory =
      (DODownloadProperty_IntegrityCheckInfo + 1),
  DODownloadProperty_TotalSizeBytes =
      (DODownloadProperty_IntegrityCheckMandatory + 1),
  DODownloadProperty_DisallowOnCellular =
      (DODownloadProperty_TotalSizeBytes + 1),
  DODownloadProperty_HttpCustomAuthHeaders =
      (DODownloadProperty_DisallowOnCellular + 1),
  DODownloadProperty_HttpAllowSecureToNonSecureRedirect =
      (DODownloadProperty_HttpCustomAuthHeaders + 1),
  DODownloadProperty_NonVolatile =
      (DODownloadProperty_HttpAllowSecureToNonSecureRedirect + 1),
  DODownloadProperty_HttpRedirectionTarget =
      (DODownloadProperty_NonVolatile + 1),
  DODownloadProperty_HttpResponseHeaders =
      (DODownloadProperty_HttpRedirectionTarget + 1),
  DODownloadProperty_HttpServerIPAddress =
      (DODownloadProperty_HttpResponseHeaders + 1),
  DODownloadProperty_HttpStatusCode =
      (DODownloadProperty_HttpServerIPAddress + 1)
} DODownloadProperty;
...
public:
  virtual HRESULT STDMETHODCALLTYPE Start(
      /* [unique][in] */ __RPC__in_opt const DO_DOWNLOAD_RANGES_INFO
          *ranges) = 0;
...
typedef struct IDODownloadVtbl {
  ...
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in IDODownload *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IDODownload *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IDODownload *This);
  ...
  HRESULT(STDMETHODCALLTYPE *Pause)(__RPC__in IDODownload *This);

  DECLSPEC_XFGVIRT(IDODownload, Abort)
  HRESULT(STDMETHODCALLTYPE *Abort)(__RPC__in IDODownload *This);

  DECLSPEC_XFGVIRT(IDODownload, Finalize)
  HRESULT(STDMETHODCALLTYPE *Finalize)(__RPC__in IDODownload *This);
...
interface IDODownload { CONST_VTBL struct IDODownloadVtbl *lpVtbl; };
...
#define IDODownload_AddRef(This) ((This)->lpVtbl->AddRef(This))

#define IDODownload_Release(This) ((This)->lpVtbl->Release(This))

#define IDODownload_Start(This, ranges) ((This)->lpVtbl->Start(This, ranges))

#define IDODownload_Pause(This) ((This)->lpVtbl->Pause(This))

#define IDODownload_Abort(This) ((This)->lpVtbl->Abort(This))

#define IDODownload_Finalize(This) ((This)->lpVtbl->Finalize(This))
...
typedef struct IDODownloadStatusCallbackVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IDODownloadStatusCallback *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IDODownloadStatusCallback *This);
...
#define IDODownloadStatusCallback_AddRef(This) ((This)->lpVtbl->AddRef(This))

#define IDODownloadStatusCallback_Release(This) ((This)->lpVtbl->Release(This))
...
public:
  ...
  virtual HRESULT STDMETHODCALLTYPE EnumDownloads(
      /* [unique][in] */ __RPC__in_opt const DO_DOWNLOAD_ENUM_CATEGORY
          *category,
...
typedef struct IDOManagerVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in IDOManager *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IDOManager *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IDOManager *This);
  ...
  HRESULT(STDMETHODCALLTYPE *EnumDownloads)(
      __RPC__in IDOManager *This,
      /* [unique][in] */
      __RPC__in_opt const DO_DOWNLOAD_ENUM_CATEGORY *category,
      /* [out] */ __RPC__deref_out_opt IEnumUnknown **ppEnum);

  END_INTERFACE
} IDOManagerVtbl;

interface IDOManager { CONST_VTBL struct IDOManagerVtbl *lpVtbl; };
...
#define IDOManager_AddRef(This) ((This)->lpVtbl->AddRef(This))

#define IDOManager_Release(This) ((This)->lpVtbl->Release(This))
...
#define IntegrityCheckInfo_PiecesHashFileDigestAlgorithm                       \
  L"PiecesHashFileDigestAlgorithm"
