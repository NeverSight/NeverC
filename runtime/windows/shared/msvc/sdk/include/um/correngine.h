...
typedef struct ICorrelationEngineVtbl {
  ...
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in ICorrelationEngine *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in ICorrelationEngine *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in ICorrelationEngine *This);
  ...
  /* [helpstring][id][propget] */ HRESULT(
      STDMETHODCALLTYPE *get_RetainCorrelationEvents)(
      __RPC__in ICorrelationEngine *This,
      /* [retval][out] */ __RPC__out VARIANT_BOOL *pVal);

  DECLSPEC_XFGVIRT(ICorrelationEngine, put_RetainCorrelationEvents)
  /* [helpstring][id][propput] */ HRESULT(
      STDMETHODCALLTYPE *put_RetainCorrelationEvents)(
      __RPC__in ICorrelationEngine *This,
      /* [in] */ VARIANT_BOOL newVal);
...
#define ICorrelationEngine_GetIDsOfNames(This, riid, rgszNames, cNames, lcid,  \
                                         rgDispId)                             \
  ((This)->lpVtbl->GetIDsOfNames(This, riid, rgszNames, cNames, lcid, rgDispId))

#define ICorrelationEngine_Invoke(This, dispIdMember, riid, lcid, wFlags,      \
...
#define ICorrelationEngine_Filter(This, InputTraceFile, OutputTraceFile,       \
                                  FilterActivityId)                            \
...
class DECLSPEC_UUID("FCDC2CF5-ABCD-4BA5-94DA-1823AE06FE2B") CorrelationEngine;
#endif
