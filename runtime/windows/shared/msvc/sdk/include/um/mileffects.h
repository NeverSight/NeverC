...
typedef interface IMILBitmapEffectConnectionsInfo
...
typedef interface IMILBitmapEffectRenderContextImpl
...
typedef interface IMILBitmapEffectOutputConnector
...
typedef interface IMILBitmapEffectOutputConnectorImpl
...
typedef interface IMILBitmapEffectInteriorInputConnector
...
typedef interface IMILBitmapEffectInteriorOutputConnector
...
DEFINE_GUID(CLSID_MILBitmapEffectGroup, 0xac9c1a9a, 0x7e18, 0x4f64, 0xac, 0x7e,
            0x47, 0xcf, 0x7f, 0x05, 0x1e, 0x95);
DEFINE_GUID(CLSID_MILBitmapEffectBlur, 0xa924df87, 0x225d, 0x4373, 0x8f, 0x5b,
            0xb9, 0xe, 0xc8, 0x5a, 0xe3, 0xde);
DEFINE_GUID(CLSID_MILBitmapEffectDropShadow, 0x459a3fbe, 0xd8ac, 0x4692, 0x87,
            0x4b, 0x7a, 0x26, 0x57, 0x15, 0xaa, 0x16);
DEFINE_GUID(CLSID_MILBitmapEffectOuterGlow, 0xe2161bdd, 0x7eb6, 0x4725, 0x9c,
            0x0b, 0x8a, 0x2a, 0x1b, 0x4f, 0x06, 0x67);
DEFINE_GUID(CLSID_MILBitmapEffectBevel, 0xfd361dbe, 0x6c9b, 0x4de0, 0x82, 0x90,
            0xf6, 0x40, 0xc, 0x27, 0x37, 0xed);
DEFINE_GUID(CLSID_MILBitmapEffectEmboss, 0xcd299846, 0x824f, 0x47ec, 0xa0, 0x07,
            0x12, 0xaa, 0x76, 0x7f, 0x28, 0x16);
extern STDMETHODIMP
MILCreateBitmapEffectFactory(DWORD dwSDKVersion,
                             IMILBitmapEffectFactory **ppFactory);
...
public:
  ...
  virtual HRESULT STDMETHODCALLTYPE GetInputConnectorInfo(
      /* [in] */ ULONG uiIndex,
      /* [out] */ __RPC__deref_out_opt IMILBitmapEffectConnectorInfo *
          *ppConnectorInfo) = 0;
...
#define IMILBitmapEffectConnectionsInfo_GetInputConnectorInfo(This, uiIndex,   \
                                                              ppConnectorInfo) \
  ((This)->lpVtbl->GetInputConnectorInfo(This, uiIndex, ppConnectorInfo))

#define IMILBitmapEffectConnectionsInfo_GetOutputConnectorInfo(                \
    This, uiIndex, ppConnectorInfo)                                            \
...
public:
  virtual HRESULT STDMETHODCALLTYPE GetInputConnector(
      /* [in] */ ULONG uiIndex,
      /* [retval][out] */ __RPC__deref_out_opt IMILBitmapEffectInputConnector *
          *ppConnector) = 0;

  virtual HRESULT STDMETHODCALLTYPE GetOutputConnector(
      /* [in] */ ULONG uiIndex,
      /* [retval][out] */ __RPC__deref_out_opt IMILBitmapEffectOutputConnector *
          *ppConnector) = 0;
};
...
typedef struct IMILBitmapEffectConnectionsVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IMILBitmapEffectConnections *This);
...
#define IMILBitmapEffectConnections_GetInputConnector(This, uiIndex,           \
                                                      ppConnector)             \
  ((This)->lpVtbl->GetInputConnector(This, uiIndex, ppConnector))

#define IMILBitmapEffectConnections_GetOutputConnector(This, uiIndex,          \
                                                       ppConnector)            \
...
public:
  virtual HRESULT STDMETHODCALLTYPE GetOutput(
      ...
      /* [retval][out] */ __RPC__deref_out_opt IWICBitmapSource *
          *ppBitmapSource) = 0;

  virtual HRESULT STDMETHODCALLTYPE GetParentEffect(
      /* [retval][out] */ __RPC__deref_out_opt IMILBitmapEffectGroup *
      *ppParentEffect) = 0;
...
typedef struct IMILBitmapEffectVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in IMILBitmapEffect *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IMILBitmapEffect *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IMILBitmapEffect *This);
...
interface IMILBitmapEffect { CONST_VTBL struct IMILBitmapEffectVtbl *lpVtbl; };
...
public:
  virtual HRESULT STDMETHODCALLTYPE IsInPlaceModificationAllowed(
      /* [in] */ __RPC__in_opt IMILBitmapEffectOutputConnector *
          pOutputConnector,
...
typedef struct IMILBitmapEffectImplVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IMILBitmapEffectImpl *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IMILBitmapEffectImpl *This);
...
#define IMILBitmapEffectImpl_IsInPlaceModificationAllowed(                     \
    This, pOutputConnector, pfModifyInPlace)                                   \
  ((This)->lpVtbl->IsInPlaceModificationAllowed(This, pOutputConnector,        \
                                                pfModifyInPlace))
...
#define IMILBitmapEffectImpl_GetInputBitmapSource(                             \
    This, uiIndex, pRenderContext, pfModifyInPlace, ppBitmapSource)            \
  ((This)->lpVtbl->GetInputBitmapSource(This, uiIndex, pRenderContext,         \
                                        pfModifyInPlace, ppBitmapSource))

#define IMILBitmapEffectImpl_GetOutputBitmapSource(                            \
    This, uiIndex, pRenderContext, pfModifyInPlace, ppBitmapSource)            \
  ((This)->lpVtbl->GetOutputBitmapSource(This, uiIndex, pRenderContext,        \
                                         pfModifyInPlace, ppBitmapSource))
...
typedef struct IMILBitmapEffectGroupVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IMILBitmapEffectGroup *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IMILBitmapEffectGroup *This);
...
#define IMILBitmapEffectGroup_GetInteriorInputConnector(This, uiIndex,         \
                                                        ppConnector)           \
  ((This)->lpVtbl->GetInteriorInputConnector(This, uiIndex, ppConnector))

#define IMILBitmapEffectGroup_GetInteriorOutputConnector(This, uiIndex,        \
                                                         ppConnector)          \
...
public:
  ...
  virtual HRESULT STDMETHODCALLTYPE GetChildren(
      /* [retval][out] */ __RPC__deref_out_opt IMILBitmapEffects *
      *pChildren) = 0;
};
...
typedef struct IMILBitmapEffectGroupImplVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IMILBitmapEffectGroupImpl *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IMILBitmapEffectGroupImpl *This);
...
#define IMILBitmapEffectRenderContextImpl_QueryInterface(This, riid,           \
                                                         ppvObject)            \
  ((This)->lpVtbl->QueryInterface(This, riid, ppvObject))
...
#define IMILBitmapEffectRenderContextImpl_GetUseSoftwareRenderer(This,         \
                                                                 pfSoftware)   \
...
public:
  ...
  virtual HRESULT STDMETHODCALLTYPE CreateContext(
      /* [out] */ __RPC__deref_out_opt IMILBitmapEffectRenderContext *
      *ppContext) = 0;
...
typedef struct IMILBitmapEffectFactoryVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IMILBitmapEffectFactory *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IMILBitmapEffectFactory *This);
...
typedef struct IMILBitmapEffectPrimitiveVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IMILBitmapEffectPrimitive *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IMILBitmapEffectPrimitive *This);
...
#define IMILBitmapEffectPrimitive_GetOutput(This, uiIndex, pContext,           \
                                            pfModifyInPlace, ppBitmapSource)   \
  ((This)->lpVtbl->GetOutput(This, uiIndex, pContext, pfModifyInPlace,         \
                             ppBitmapSource))

#define IMILBitmapEffectPrimitive_TransformPoint(                              \
    This, uiIndex, p, fForwardTransform, pContext, pfPointTransformed)         \
  ((This)->lpVtbl->TransformPoint(This, uiIndex, p, fForwardTransform,         \
                                  pContext, pfPointTransformed))

#define IMILBitmapEffectPrimitive_TransformRect(This, uiIndex, p,              \
                                                fForwardTransform, pContext)   \
...
#define IMILBitmapEffectPrimitive_HasInverseTransform(This, uiIndex,           \
                                                      pfHasInverse)            \
...
#define IMILBitmapEffectPrimitiveImpl_IsVolatile(This, uiOutputIndex,          \
                                                 pfVolatile)                   \
...
public:
  ...
  virtual HRESULT STDMETHODCALLTYPE Item(
      ULONG uindex,
      /* [retval][out] */ __RPC__deref_out_opt IMILBitmapEffect *
          *ppEffect) = 0;
...
typedef struct IMILBitmapEffectsVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in IMILBitmapEffects *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IMILBitmapEffects *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IMILBitmapEffects *This);
  ...
  HRESULT(STDMETHODCALLTYPE *Item)(
      __RPC__in IMILBitmapEffects *This, ULONG uindex,
...
typedef struct IMILBitmapEffectConnectorVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IMILBitmapEffectConnector *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IMILBitmapEffectConnector *This);
...
#define IMILBitmapEffectInputConnector_GetNumberFormats(This,                  \
                                                        pulNumberFormats)      \
  ((This)->lpVtbl->GetNumberFormats(This, pulNumberFormats))
...
#define IMILBitmapEffectOutputConnector_GetNumberFormats(This,                 \
                                                         pulNumberFormats)     \
  ((This)->lpVtbl->GetNumberFormats(This, pulNumberFormats))
...
#define IMILBitmapEffectOutputConnector_GetNumberConnections(                  \
    This, puiNumberConnections)                                                \
  ((This)->lpVtbl->GetNumberConnections(This, puiNumberConnections))

#define IMILBitmapEffectOutputConnector_GetConnection(This, uiIndex,           \
                                                      ppConnection)            \
...
public:
  virtual HRESULT STDMETHODCALLTYPE AddBackLink(
      /* [in] */ __RPC__in_opt IMILBitmapEffectInputConnector *
      pConnection) = 0;
...
#define IMILBitmapEffectOutputConnectorImpl_QueryInterface(This, riid,         \
                                                           ppvObject)          \
  ((This)->lpVtbl->QueryInterface(This, riid, ppvObject))
...
#define IMILBitmapEffectInteriorInputConnector_QueryInterface(This, riid,      \
                                                              ppvObject)       \
  ((This)->lpVtbl->QueryInterface(This, riid, ppvObject))
...
#define IMILBitmapEffectInteriorInputConnector_GetInputConnector(              \
    This, pInputConnector)                                                     \
...
#define IMILBitmapEffectInteriorOutputConnector_QueryInterface(This, riid,     \
                                                               ppvObject)      \
  ((This)->lpVtbl->QueryInterface(This, riid, ppvObject))
...
#define IMILBitmapEffectInteriorOutputConnector_GetOutputConnector(            \
    This, pOutputConnector)                                                    \
...
typedef struct IMILBitmapEffectEventsVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IMILBitmapEffectEvents *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IMILBitmapEffectEvents *This);
