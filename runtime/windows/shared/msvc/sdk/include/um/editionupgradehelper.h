...
typedef struct IEditionUpgradeHelperVtbl {
  ...
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IEditionUpgradeHelper *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IEditionUpgradeHelper *This);
...
#define IEditionUpgradeHelper_AddRef(This) ((This)->lpVtbl->AddRef(This))

#define IEditionUpgradeHelper_Release(This) ((This)->lpVtbl->Release(This))
...
typedef struct IWindowsLockModeHelperVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IWindowsLockModeHelper *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IWindowsLockModeHelper *This);

  DECLSPEC_XFGVIRT(IWindowsLockModeHelper, GetSMode)
  HRESULT(STDMETHODCALLTYPE *GetSMode)(__RPC__in IWindowsLockModeHelper *This,
...
#define IWindowsLockModeHelper_AddRef(This) ((This)->lpVtbl->AddRef(This))

#define IWindowsLockModeHelper_Release(This) ((This)->lpVtbl->Release(This))
...
typedef struct IEditionUpgradeBrokerVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IEditionUpgradeBroker *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IEditionUpgradeBroker *This);
  ...
  HRESULT(STDMETHODCALLTYPE *CanUpgrade)(__RPC__in IEditionUpgradeBroker *This);
...
#define IEditionUpgradeBroker_AddRef(This) ((This)->lpVtbl->AddRef(This))

#define IEditionUpgradeBroker_Release(This) ((This)->lpVtbl->Release(This))
...
typedef struct IContainerActivationHelperVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IContainerActivationHelper *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IContainerActivationHelper *This);
...
#define IContainerActivationHelper_AddRef(This) ((This)->lpVtbl->AddRef(This))

#define IContainerActivationHelper_Release(This) ((This)->lpVtbl->Release(This))
...
#define IClipServiceNotificationHelper_ShowToast(                              \
    This, titleText, bodyText, packageName, appId, launchCommand)              \
  ((This)->lpVtbl->ShowToast(This, titleText, bodyText, packageName, appId,    \
                             launchCommand))
...
typedef struct IFClipNotificationHelperVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IFClipNotificationHelper *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IFClipNotificationHelper *This);
...
#define IFClipNotificationHelper_AddRef(This) ((This)->lpVtbl->AddRef(This))

#define IFClipNotificationHelper_Release(This) ((This)->lpVtbl->Release(This))
