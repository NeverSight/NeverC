...
// MessageText:
//
// Specified synchronization ID is not of the specified format for IDs of that
// type.
//
...
// MessageText:
//
// The item does not exist at the destination, but the creation version of the
// item is contained in the destination knowledge.
//
...
// MessageText:
//
// Item for which data was requested has no data either because it is a
// tombstone or it does not exist.
//
...
// MessageText:
//
// Range was provided out of expected order. Ranges should be provided in
// increasing order.
//
...
// MessageText:
//
// Change was provided that was not expected either because it is out-of-order
// or incorrect.
//
...
// MessageText:
//
// Deserialization failed. This is typically due to serialization data that is
// not valid being supplied to the deserializer.
//
...
// MessageText:
//
// Only one and exactly one range may be specified per batch during forgotten
// knowledge recovery.
//
...
// MessageText:
//
// Object was not correctly initialized. Object state info must be provided as
// the state could not be derived from sync session context.
//
...
// MessageText:
//
// The operation could not be completed as the specified change batch has become
// read-only.
//
...
// MessageText:
//
// The operation could not be completed as an item changed unexpectedly during
// synchronization.
//
...
// MessageText:
//
// A failure during creation may not be recorded per change unit. Item creation
// may only fail for the entire item.
//
...
// MessageText:
//
// The requested data could not be loaded.  This occurs when a recoverable error
// is set while loading the data or if data conversion fails.  Possible
// resolutions include deferring the conflict or resolving the conflict without
// change data.
//
...
// MessageText:
//
// Full enumeration synchronization must be used to apply full enumeration
// change.
//
