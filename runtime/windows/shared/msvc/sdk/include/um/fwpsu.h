...
*    Version 1.0.0 *
* *
*    Defines annotations to be used in Windows Filtering Callout Drivers to
enforce API        *
*    contracts that can be statically verified through the use of CodeQL
queries.              *
* *
...
typedef enum FWPS_FIELDS_INBOUND_ICMP_ERROR_V4_ {
  ...
  FWPS_FIELD_INBOUND_ICMP_ERROR_V4_INTERFACE_INDEX,     // of local/delivery
                                                        // interface
  FWPS_FIELD_INBOUND_ICMP_ERROR_V4_SUB_INTERFACE_INDEX, // of arrival interface
  FWPS_FIELD_INBOUND_ICMP_ERROR_V4_INTERFACE_TYPE,      // of local/delivery
                                                        // interface
...
typedef enum FWPS_FIELDS_INBOUND_ICMP_ERROR_V6_ {
  ...
  FWPS_FIELD_INBOUND_ICMP_ERROR_V6_INTERFACE_INDEX,     // of local/delivery
                                                        // interface
  FWPS_FIELD_INBOUND_ICMP_ERROR_V6_SUB_INTERFACE_INDEX, // of arrival interface
  FWPS_FIELD_INBOUND_ICMP_ERROR_V6_INTERFACE_TYPE,      // of local/delivery
                                                        // interface
...
typedef enum FWPS_FIELDS_ALE_AUTH_RECV_ACCEPT_V4_ {
  ...
  FWPS_FIELD_ALE_AUTH_RECV_ACCEPT_V4_INTERFACE_TYPE, // of local/delivery
                                                     // interface
  FWPS_FIELD_ALE_AUTH_RECV_ACCEPT_V4_TUNNEL_TYPE, // of local/delivery interface
  FWPS_FIELD_ALE_AUTH_RECV_ACCEPT_V4_INTERFACE_INDEX,     // of local/delivery
                                                          // interface
  FWPS_FIELD_ALE_AUTH_RECV_ACCEPT_V4_SUB_INTERFACE_INDEX, // of arrival
                                                          // interface
#if (NTDDI_VERSION >= NTDDI_WIN6SP1)
...
typedef enum FWPS_FIELDS_ALE_AUTH_RECV_ACCEPT_V6_ {
  ...
  FWPS_FIELD_ALE_AUTH_RECV_ACCEPT_V6_INTERFACE_TYPE, // of local/delivery
                                                     // interface
  FWPS_FIELD_ALE_AUTH_RECV_ACCEPT_V6_TUNNEL_TYPE, // of local/delivery interface
  FWPS_FIELD_ALE_AUTH_RECV_ACCEPT_V6_INTERFACE_INDEX,     // of local/delivery
                                                          // interface
  FWPS_FIELD_ALE_AUTH_RECV_ACCEPT_V6_SUB_INTERFACE_INDEX, // of arrival
                                                          // interface
#if (NTDDI_VERSION >= NTDDI_WIN6SP1)
...
typedef struct FWPS_INCOMING_METADATA_VALUES0_ {
  ...
  // Socket control data (and length) for use in outbound transport layer
  // injection.
...
#if (NTDDI_VERSION >= NTDDI_WIN6SP1)
  // Raw IP header (and length) if the packet is sent with IP header from a RAW
  // socket.
...
#define FWPS_IS_METADATA_FIELD_PRESENT(metadataValues, metadataField)          \
  (((metadataValues)->currentMetadataValues & (metadataField)) ==              \
   (metadataField))

#if (NTDDI_VERSION >= NTDDI_WIN8)
#define FWPS_IS_L2_METADATA_FIELD_PRESENT(metadataValues, l2MetadataField)     \
  (((metadataValues)->currentL2MetadataValues & (l2MetadataField)) ==          \
   (l2MetadataField))
#endif // (NTDDI_VERSION >= NTDDI_WIN8)
...
typedef void(NTAPI *FWPS_CALLOUT_CLASSIFY_FN0)(
    ...
    _Inout_opt_ void *layerData, _In_ const FWPS_FILTER0 *filter,
...
typedef void(NTAPI *FWPS_CALLOUT_CLASSIFY_FN1)(
    ...
    _In_ const FWPS_FILTER1 *filter, _In_ UINT64 flowContext,
...
typedef void(NTAPI *FWPS_CALLOUT_CLASSIFY_FN2)(
    ...
    _In_ const FWPS_INCOMING_METADATA_VALUES0 *inMetaValues,
    _Inout_opt_ void *layerData, _In_opt_ const void *classifyContext,
    _In_ const FWPS_FILTER2 *filter, _In_ UINT64 flowContext,
    _Inout_ FWPS_CLASSIFY_OUT0 *classifyOut);
#endif // (NTDDI_VERSION >= NTDDI_WIN8)
...
typedef NTSTATUS(NTAPI *FWPS_CALLOUT_NOTIFY_FN0)(
    _In_ FWPS_CALLOUT_NOTIFY_TYPE notifyType, _In_ const GUID *filterKey,
...
DWORD
WINAPI
FwpsOpenToken0(IN HANDLE engineHandle, IN LUID modifiedId,
               IN DWORD desiredAccess, OUT HANDLE *accessToken);

DWORD
WINAPI
FwpsAleEndpointGetById0(_In_ HANDLE engineHandle, _In_ UINT64 endpointId,
...
DWORD
WINAPI
FwpsAleEndpointEnum0(_In_ HANDLE engineHandle, _In_ HANDLE enumHandle,
...
DWORD
WINAPI
FwpsAleEndpointDestroyEnumHandle0(_In_ HANDLE engineHandle,
...
DWORD
WINAPI
FwpsAleEndpointSetSecurityInfo0(_In_ HANDLE engineHandle,
