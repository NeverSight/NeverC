...
typedef struct IAtscPsipParserVtbl {
  ...
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in IAtscPsipParser *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IAtscPsipParser *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IAtscPsipParser *This);
...
interface IAtscPsipParser { CONST_VTBL struct IAtscPsipParserVtbl *lpVtbl; };
...
typedef struct IATSC_MGTVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in IATSC_MGT *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IATSC_MGT *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IATSC_MGT *This);
  ...
  HRESULT(STDMETHODCALLTYPE *GetRecordType)(__RPC__in IATSC_MGT *This,
                                            /* [in] */ DWORD dwRecordIndex,
...
interface IATSC_MGT { CONST_VTBL struct IATSC_MGTVtbl *lpVtbl; };
...
#define IATSC_MGT_GetRecordDescriptorByIndex(This, dwRecordIndex, dwIndex,     \
                                             ppDescriptor)                     \
  ((This)->lpVtbl->GetRecordDescriptorByIndex(This, dwRecordIndex, dwIndex,    \
                                              ppDescriptor))

#define IATSC_MGT_GetRecordDescriptorByTag(This, dwRecordIndex, bTag,          \
...
typedef struct IATSC_VCTVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in IATSC_VCT *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IATSC_VCT *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IATSC_VCT *This);
...
interface IATSC_VCT { CONST_VTBL struct IATSC_VCTVtbl *lpVtbl; };
...
#define IATSC_VCT_GetRecordIsAccessControlledBitSet(This, dwRecordIndex,       \
                                                    pfVal)                     \
  ((This)->lpVtbl->GetRecordIsAccessControlledBitSet(This, dwRecordIndex,      \
                                                     pfVal))
...
#define IATSC_VCT_GetRecordDescriptorByIndex(This, dwRecordIndex, dwIndex,     \
                                             ppDescriptor)                     \
  ((This)->lpVtbl->GetRecordDescriptorByIndex(This, dwRecordIndex, dwIndex,    \
                                              ppDescriptor))

#define IATSC_VCT_GetRecordDescriptorByTag(This, dwRecordIndex, bTag,          \
                                           pdwCookie, ppDescriptor)            \
  ((This)->lpVtbl->GetRecordDescriptorByTag(This, dwRecordIndex, bTag,         \
                                            pdwCookie, ppDescriptor))
...
typedef struct IATSC_EITVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in IATSC_EIT *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IATSC_EIT *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IATSC_EIT *This);
  ...
  HRESULT(STDMETHODCALLTYPE *GetSourceId)(__RPC__in IATSC_EIT *This,
                                          /* [out] */ __RPC__out WORD *pwVal);
...
interface IATSC_EIT { CONST_VTBL struct IATSC_EITVtbl *lpVtbl; };
...
#define IATSC_EIT_GetRecordDescriptorByIndex(This, dwRecordIndex, dwIndex,     \
                                             ppDescriptor)                     \
  ((This)->lpVtbl->GetRecordDescriptorByIndex(This, dwRecordIndex, dwIndex,    \
                                              ppDescriptor))

#define IATSC_EIT_GetRecordDescriptorByTag(This, dwRecordIndex, bTag,          \
                                           pdwCookie, ppDescriptor)            \
  ((This)->lpVtbl->GetRecordDescriptorByTag(This, dwRecordIndex, bTag,         \
                                            pdwCookie, ppDescriptor))
...
typedef struct IATSC_ETTVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in IATSC_ETT *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IATSC_ETT *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IATSC_ETT *This);
  ...
  HRESULT(STDMETHODCALLTYPE *GetEtmId)(__RPC__in IATSC_ETT *This,
                                       /* [out] */ __RPC__out DWORD *pdwVal);
...
interface IATSC_ETT { CONST_VTBL struct IATSC_ETTVtbl *lpVtbl; };
...
typedef struct IATSC_STTVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in IATSC_STT *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IATSC_STT *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IATSC_STT *This);
...
interface IATSC_STT { CONST_VTBL struct IATSC_STTVtbl *lpVtbl; };
...
typedef struct ISCTE_EASVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in ISCTE_EAS *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in ISCTE_EAS *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in ISCTE_EAS *This);
  ...
  HRESULT(STDMETHODCALLTYPE *GetEASEventID)(__RPC__in ISCTE_EAS *This,
                                            /* [out] */ __RPC__out WORD *pwVal);
  ...
  HRESULT(STDMETHODCALLTYPE *GetDuration)(__RPC__in ISCTE_EAS *This,
                                          /* [out] */ __RPC__out WORD *pwVal);
...
interface ISCTE_EAS { CONST_VTBL struct ISCTE_EASVtbl *lpVtbl; };
...
#define ISCTE_EAS_GetLocationCodes(This, bIndex, pbState, pbCountySubdivision, \
                                   pwCounty)                                   \
  ((This)->lpVtbl->GetLocationCodes(This, bIndex, pbState,                     \
                                    pbCountySubdivision, pwCounty))

#define ISCTE_EAS_GetExceptionCount(This, pbVal)                               \
  ((This)->lpVtbl->GetExceptionCount(This, pbVal))

#define ISCTE_EAS_GetExceptionService(This, bIndex, pbIBRef, pwFirst,          \
                                      pwSecond)                                \
  ((This)->lpVtbl->GetExceptionService(This, bIndex, pbIBRef, pwFirst,         \
                                       pwSecond))
...
typedef struct IAtscContentAdvisoryDescriptorVtbl {
  ...
  DECLSPEC_XFGVIRT(IAtscContentAdvisoryDescriptor,
...
#define IAtscContentAdvisoryDescriptor_GetRecordRatingRegion(This, bIndex,     \
                                                             pbVal)            \
  ((This)->lpVtbl->GetRecordRatingRegion(This, bIndex, pbVal))

#define IAtscContentAdvisoryDescriptor_GetRecordRatedDimensions(This, bIndex,  \
                                                                pbVal)         \
  ((This)->lpVtbl->GetRecordRatedDimensions(This, bIndex, pbVal))

#define IAtscContentAdvisoryDescriptor_GetRecordRatingDimension(               \
    This, bIndexOuter, bIndexInner, pbVal)                                     \
  ((This)->lpVtbl->GetRecordRatingDimension(This, bIndexOuter, bIndexInner,    \
                                            pbVal))

#define IAtscContentAdvisoryDescriptor_GetRecordRatingValue(                   \
    This, bIndexOuter, bIndexInner, pbVal)                                     \
  ((This)->lpVtbl->GetRecordRatingValue(This, bIndexOuter, bIndexInner, pbVal))

#define IAtscContentAdvisoryDescriptor_GetRecordRatingDescriptionText(         \
    This, bIndex, pbLength, ppText)                                            \
  ((This)->lpVtbl->GetRecordRatingDescriptionText(This, bIndex, pbLength,      \
                                                  ppText))
...
typedef struct ICaptionServiceDescriptorVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in ICaptionServiceDescriptor *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in ICaptionServiceDescriptor *This);
...
typedef struct IServiceLocationDescriptorVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IServiceLocationDescriptor *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IServiceLocationDescriptor *This);
...
#define IServiceLocationDescriptor_GetElementLanguageCode(This, bIndex,        \
                                                          LangCode)            \
