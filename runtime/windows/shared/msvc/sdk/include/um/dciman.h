...
extern int WINAPI DCISendCommand(HDC hdc, VOID FAR *pcmd, int nSize,
...
__inline DCIRVAL DCIBeginAccess(LPDCISURFACEINFO pdci, int x, int y, int dx,
                                int dy) {
  RECT rc;
...
__inline DCIRVAL DCISetDestination(LPDCIOFFSCREEN pdci, LPRECT dst,
                                   LPRECT src) {
