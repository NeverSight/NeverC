...
typedef interface IMFContentDecryptionModuleSession
...
typedef interface IMFContentDecryptionModuleSessionCallbacks
...
typedef interface IMFContentDecryptionModuleAccess
...
typedef interface IMFContentDecryptionModuleFactory
...
extern RPC_IF_HANDLE
    __MIDL_itf_mfcontentdecryptionmodule_0000_0000_v0_0_c_ifspec;
extern RPC_IF_HANDLE
    __MIDL_itf_mfcontentdecryptionmodule_0000_0000_v0_0_s_ifspec;
...
typedef struct IMFContentDecryptionModuleSessionVtbl {
  ...
  HRESULT(STDMETHODCALLTYPE *GetKeyStatuses)(
      __RPC__in IMFContentDecryptionModuleSession *This,
      /* [size_is][size_is][out] */
      __RPC__deref_out_ecount_full_opt(*numKeyStatuses)
  ...
  HRESULT(STDMETHODCALLTYPE *Update)(
      __RPC__in IMFContentDecryptionModuleSession *This,
      /* [size_is][in] */
      __RPC__in_ecount_full(responseSize) const BYTE *response,
...
#define IMFContentDecryptionModuleSession_QueryInterface(This, riid,           \
                                                         ppvObject)            \
...
#define IMFContentDecryptionModuleSession_GetKeyStatuses(This, keyStatuses,    \
                                                         numKeyStatuses)       \
...
#define IMFContentDecryptionModuleSession_GenerateRequest(                     \
...
#define IMFContentDecryptionModuleSessionCallbacks_QueryInterface(This, riid,  \
                                                                  ppvObject)   \
  ((This)->lpVtbl->QueryInterface(This, riid, ppvObject))
...
#define IMFContentDecryptionModuleSessionCallbacks_KeyMessage(                 \
    This, messageType, message, messageSize, destinationURL)                   \
  ((This)->lpVtbl->KeyMessage(This, messageType, message, messageSize,         \
                              destinationURL))
...
typedef struct IMFContentDecryptionModuleVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IMFContentDecryptionModule *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IMFContentDecryptionModule *This);
  ...
  HRESULT(STDMETHODCALLTYPE *CreateSession)(
      ...
      /* [in] */ MF_MEDIAKEYSESSION_TYPE sessionType,
      /* [in] */
      __RPC__in_opt IMFContentDecryptionModuleSessionCallbacks *callbacks,
      /* [out] */
      __RPC__deref_out_opt IMFContentDecryptionModuleSession **session);

  DECLSPEC_XFGVIRT(IMFContentDecryptionModule, SetServerCertificate)
  HRESULT(STDMETHODCALLTYPE *SetServerCertificate)(
      __RPC__in IMFContentDecryptionModule *This,
      /* [size_is][in] */
      __RPC__in_ecount_full(certificateSize) const BYTE *certificate,
  ...
  HRESULT(STDMETHODCALLTYPE *CreateTrustedInput)(
      __RPC__in IMFContentDecryptionModule *This,
      /* [size_is][in] */
      __RPC__in_ecount_full(contentInitDataSize) const BYTE *contentInitData,
      /* [in] */ DWORD contentInitDataSize,
  ...
  HRESULT(STDMETHODCALLTYPE *GetProtectionSystemIds)(
      __RPC__in IMFContentDecryptionModule *This,
      /* [size_is][size_is][out] */
      __RPC__deref_out_ecount_full_opt(*count) GUID **systemIds,
...
#define IMFContentDecryptionModule_AddRef(This) ((This)->lpVtbl->AddRef(This))

#define IMFContentDecryptionModule_Release(This) ((This)->lpVtbl->Release(This))

#define IMFContentDecryptionModule_SetContentEnabler(This, contentEnabler,     \
                                                     result)                   \
...
#define IMFContentDecryptionModule_CreateSession(This, sessionType, callbacks, \
                                                 session)                      \
  ((This)->lpVtbl->CreateSession(This, sessionType, callbacks, session))

#define IMFContentDecryptionModule_SetServerCertificate(This, certificate,     \
                                                        certificateSize)       \
  ((This)->lpVtbl->SetServerCertificate(This, certificate, certificateSize))

#define IMFContentDecryptionModule_CreateTrustedInput(                         \
    This, contentInitData, contentInitDataSize, trustedInput)                  \
  ((This)->lpVtbl->CreateTrustedInput(This, contentInitData,                   \
                                      contentInitDataSize, trustedInput))

#define IMFContentDecryptionModule_GetProtectionSystemIds(This, systemIds,     \
                                                          count)               \
...
typedef struct IMFContentDecryptionModuleAccessVtbl {
  ...
  DECLSPEC_XFGVIRT(IMFContentDecryptionModuleAccess,
                   CreateContentDecryptionModule)
  HRESULT(STDMETHODCALLTYPE *CreateContentDecryptionModule)(
      __RPC__in IMFContentDecryptionModuleAccess *This,
      /* [in] */
      __RPC__in_opt IPropertyStore *contentDecryptionModuleProperties,
      /* [out] */
      __RPC__deref_out_opt IMFContentDecryptionModule *
...
#define IMFContentDecryptionModuleAccess_CreateContentDecryptionModule(        \
    This, contentDecryptionModuleProperties, contentDecryptionModule)          \
  ((This)->lpVtbl->CreateContentDecryptionModule(                              \
      This, contentDecryptionModuleProperties, contentDecryptionModule))
...
EXTERN_C const DECLSPEC_SELECTANY PROPERTYKEY
    MF_CONTENTDECRYPTIONMODULE_INPRIVATESTOREPATH = {
        {0x730cb3ac,
         0x51dc,
         0x49da,
         {0xa5, 0x78, 0xb9, 0x53, 0x86, 0xb6, 0x2a, 0xfe}},
        0x01};
EXTERN_C const DECLSPEC_SELECTANY PROPERTYKEY
...
EXTERN_C const DECLSPEC_SELECTANY PROPERTYKEY
    MF_CONTENTDECRYPTIONMODULE_PMPSTORECONTEXT = {
        {0x6d2a2835,
         0xc3a9,
         0x4681,
         {0x97, 0xf2, 0x0a, 0xf5, 0x6b, 0xe9, 0x34, 0x46}},
        0x03};

extern RPC_IF_HANDLE
    __MIDL_itf_mfcontentdecryptionmodule_0000_0004_v0_0_c_ifspec;
extern RPC_IF_HANDLE
    __MIDL_itf_mfcontentdecryptionmodule_0000_0004_v0_0_s_ifspec;
...
typedef struct IMFContentDecryptionModuleFactoryVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(IMFContentDecryptionModuleFactory *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(IMFContentDecryptionModuleFactory *This);
  ...
  DECLSPEC_XFGVIRT(IMFContentDecryptionModuleFactory,
...
#define IMFContentDecryptionModuleFactory_QueryInterface(This, riid,           \
                                                         ppvObject)            \
  ((This)->lpVtbl->QueryInterface(This, riid, ppvObject))
...
#define IMFContentDecryptionModuleFactory_IsTypeSupported(This, keySystem,     \
                                                          contentType)         \
  ((This)->lpVtbl->IsTypeSupported(This, keySystem, contentType))

#define IMFContentDecryptionModuleFactory_CreateContentDecryptionModuleAccess( \
    This, keySystem, configurations, numConfigurations,                        \
    contentDecryptionModuleAccess)                                             \
  ((This)->lpVtbl->CreateContentDecryptionModuleAccess(                        \
      This, keySystem, configurations, numConfigurations,                      \
      contentDecryptionModuleAccess))
...
EXTERN_GUID(MF_ENCRYPTEDMEDIAEXTENSIONS_ACTIVATE, 0x2df7b51e, 0x797b, 0x4d06,
            0xbe, 0x71, 0xd1, 0x4a, 0x52, 0xcf, 0x84, 0x21);
EXTERN_GUID(MF_ENCRYPTEDMEDIAEXTENSIONS_ACTIVATABLE_CLASS_ID, 0x77631a31,
            0xe5e7, 0x4785, 0xbf, 0x17, 0x20, 0xf5, 0x7b, 0x22, 0x48, 0x02);
EXTERN_GUID(MF_ENCRYPTEDMEDIAEXTENSIONS_INITIALIZATION_DATA, 0x3e73735c, 0xe6c0,
            0x481d, 0x82, 0x60, 0xee, 0x5d, 0xb1, 0x34, 0x3b, 0x5f);
STDAPI MFCreateEncryptedMediaExtensionsStoreActivate(
    _In_ IMFPMPHostApp *pmpHost, _In_ IStream *objectStream,
    _In_ LPCWSTR classId, _Outptr_ IMFActivate **activate);
#endif /* WINAPI_FAMILY_PARTITION(WINAPI_PARTITION_APP) */
#pragma endregion

extern RPC_IF_HANDLE
    __MIDL_itf_mfcontentdecryptionmodule_0000_0005_v0_0_c_ifspec;
extern RPC_IF_HANDLE
    __MIDL_itf_mfcontentdecryptionmodule_0000_0005_v0_0_s_ifspec;
