...
#define CALG_MAC                                                               \
  (ALG_CLASS_HASH | ALG_TYPE_ANY | ALG_SID_MAC) // Deprecated. Don't use.
...
#define CALG_CYLINK_MEK                                                        \
  (ALG_CLASS_DATA_ENCRYPT | ALG_TYPE_BLOCK |                                   \
...
#define CRYPT_OWF_REPL_LM_HASH                                                 \
  0x00000001 // this is only for the OWF replacement CSP
#endif       //(NTDDI_VERSION >= NTDDI_WINXP)
...
WINADVAPI
BOOL WINAPI CryptAcquireContextA(_Out_ HCRYPTPROV *phProv,
                                 _In_opt_ LPCSTR szContainer,
                                 _In_opt_ LPCSTR szProvider,
                                 _In_ DWORD dwProvType, _In_ DWORD dwFlags);
WINADVAPI
BOOL WINAPI CryptAcquireContextW(_Out_ HCRYPTPROV *phProv,
...
WINADVAPI
BOOL WINAPI CryptReleaseContext(_In_ HCRYPTPROV hProv, _In_ DWORD dwFlags);
...
WINADVAPI
BOOL WINAPI CryptGenKey(_In_ HCRYPTPROV hProv, _In_ ALG_ID Algid,
                        _In_ DWORD dwFlags, _Out_ HCRYPTKEY *phKey);

WINADVAPI
BOOL WINAPI CryptDeriveKey(_In_ HCRYPTPROV hProv, _In_ ALG_ID Algid,
                           _In_ HCRYPTHASH hBaseData, _In_ DWORD dwFlags,
...
WINADVAPI
BOOL WINAPI CryptSetKeyParam(_In_ HCRYPTKEY hKey, _In_ DWORD dwParam,
                             _In_ CONST BYTE *pbData, _In_ DWORD dwFlags);

WINADVAPI
BOOL WINAPI CryptGetKeyParam(_In_ HCRYPTKEY hKey, _In_ DWORD dwParam,
                             _Out_writes_bytes_to_opt_(*pdwDataLen, *pdwDataLen)
                                 BYTE *pbData,
                             _Inout_ DWORD *pdwDataLen, _In_ DWORD dwFlags);

WINADVAPI
BOOL WINAPI CryptSetHashParam(_In_ HCRYPTHASH hHash, _In_ DWORD dwParam,
                              _In_ CONST BYTE *pbData, _In_ DWORD dwFlags);

WINADVAPI
BOOL WINAPI CryptGetHashParam(_In_ HCRYPTHASH hHash, _In_ DWORD dwParam,
                              _Out_writes_bytes_to_opt_(*pdwDataLen,
                                                        *pdwDataLen)
                                  BYTE *pbData,
                              _Inout_ DWORD *pdwDataLen, _In_ DWORD dwFlags);

WINADVAPI
BOOL WINAPI CryptSetProvParam(_In_ HCRYPTPROV hProv, _In_ DWORD dwParam,
                              _In_ CONST BYTE *pbData, _In_ DWORD dwFlags);

WINADVAPI
BOOL WINAPI CryptGetProvParam(_In_ HCRYPTPROV hProv, _In_ DWORD dwParam,
                              _Out_writes_bytes_to_opt_(*pdwDataLen,
                                                        *pdwDataLen)
                                  BYTE *pbData,
                              _Inout_ DWORD *pdwDataLen, _In_ DWORD dwFlags);
...
WINADVAPI
BOOL WINAPI CryptGenRandom(_In_ HCRYPTPROV hProv, _In_ DWORD dwLen,
                           _Inout_updates_bytes_(dwLen) BYTE *pbBuffer);

WINADVAPI
BOOL WINAPI CryptGetUserKey(_In_ HCRYPTPROV hProv, _In_ DWORD dwKeySpec,
                            _Out_ HCRYPTKEY *phUserKey);

WINADVAPI
BOOL WINAPI CryptExportKey(_In_ HCRYPTKEY hKey, _In_ HCRYPTKEY hExpKey,
                           _In_ DWORD dwBlobType, _In_ DWORD dwFlags,
                           _Out_writes_bytes_to_opt_(*pdwDataLen, *pdwDataLen)
                               BYTE *pbData,
                           _Inout_ DWORD *pdwDataLen);

WINADVAPI
BOOL WINAPI CryptImportKey(_In_ HCRYPTPROV hProv,
                           _In_reads_bytes_(dwDataLen) CONST BYTE *pbData,
                           _In_ DWORD dwDataLen, _In_ HCRYPTKEY hPubKey,
                           _In_ DWORD dwFlags, _Out_ HCRYPTKEY *phKey);

WINADVAPI
_Success_(0 != return) BOOL WINAPI
    CryptEncrypt(_In_ HCRYPTKEY hKey, _In_ HCRYPTHASH hHash, _In_ BOOL Final,
                 _In_ DWORD dwFlags,
                 _Inout_updates_bytes_to_opt_(dwBufLen, *pdwDataLen)
                     BYTE *pbData,
                 _Inout_ DWORD *pdwDataLen, _In_ DWORD dwBufLen);

WINADVAPI
_Success_(0 != return) BOOL WINAPI
    CryptDecrypt(_In_ HCRYPTKEY hKey, _In_ HCRYPTHASH hHash, _In_ BOOL Final,
                 _In_ DWORD dwFlags,
                 _Inout_updates_bytes_to_(*pdwDataLen, *pdwDataLen)
                     BYTE *pbData,
                 _Inout_ DWORD *pdwDataLen);

WINADVAPI
BOOL WINAPI CryptCreateHash(_In_ HCRYPTPROV hProv, _In_ ALG_ID Algid,
                            _In_ HCRYPTKEY hKey, _In_ DWORD dwFlags,
                            _Out_ HCRYPTHASH *phHash);

WINADVAPI
BOOL WINAPI CryptHashData(_In_ HCRYPTHASH hHash,
                          _In_reads_bytes_(dwDataLen) CONST BYTE *pbData,
                          _In_ DWORD dwDataLen, _In_ DWORD dwFlags);

WINADVAPI
BOOL WINAPI CryptHashSessionKey(_In_ HCRYPTHASH hHash, _In_ HCRYPTKEY hKey,
                                _In_ DWORD dwFlags);
...
WINADVAPI
BOOL WINAPI CryptSignHashA(_In_ HCRYPTHASH hHash, _In_ DWORD dwKeySpec,
                           _In_opt_ LPCSTR szDescription, _In_ DWORD dwFlags,
                           _Out_writes_bytes_to_opt_(*pdwSigLen, *pdwSigLen)
                               BYTE *pbSignature,
                           _Inout_ DWORD *pdwSigLen);
WINADVAPI
BOOL WINAPI CryptSignHashW(_In_ HCRYPTHASH hHash, _In_ DWORD dwKeySpec,
                           _In_opt_ LPCWSTR szDescription, _In_ DWORD dwFlags,
                           _Out_writes_bytes_to_opt_(*pdwSigLen, *pdwSigLen)
                               BYTE *pbSignature,
                           _Inout_ DWORD *pdwSigLen);
#ifdef UNICODE
...
WINADVAPI
BOOL WINAPI CryptVerifySignatureA(_In_ HCRYPTHASH hHash,
                                  _In_reads_bytes_(dwSigLen)
                                      CONST BYTE *pbSignature,
                                  _In_ DWORD dwSigLen, _In_ HCRYPTKEY hPubKey,
                                  _In_opt_ LPCSTR szDescription,
                                  _In_ DWORD dwFlags);
WINADVAPI
BOOL WINAPI CryptVerifySignatureW(_In_ HCRYPTHASH hHash,
                                  _In_reads_bytes_(dwSigLen)
                                      CONST BYTE *pbSignature,
                                  _In_ DWORD dwSigLen, _In_ HCRYPTKEY hPubKey,
...
WINADVAPI
BOOL WINAPI CryptSetProviderA(_In_ LPCSTR pszProvName, _In_ DWORD dwProvType);
WINADVAPI
BOOL WINAPI CryptSetProviderW(_In_ LPCWSTR pszProvName, _In_ DWORD dwProvType);
#ifdef UNICODE
...
WINADVAPI
BOOL WINAPI CryptSetProviderExA(_In_ LPCSTR pszProvName, _In_ DWORD dwProvType,
                                _Reserved_ DWORD *pdwReserved,
                                _In_ DWORD dwFlags);
WINADVAPI
BOOL WINAPI CryptSetProviderExW(_In_ LPCWSTR pszProvName, _In_ DWORD dwProvType,
                                _Reserved_ DWORD *pdwReserved,
                                _In_ DWORD dwFlags);
#ifdef UNICODE
...
WINADVAPI
_Success_(0 != return) BOOL WINAPI CryptGetDefaultProviderA(
    _In_ DWORD dwProvType, _Reserved_ DWORD *pdwReserved, _In_ DWORD dwFlags,
    _Out_writes_bytes_to_opt_(*pcbProvName, *pcbProvName) LPSTR pszProvName,
    _Inout_ DWORD *pcbProvName);
WINADVAPI
_Success_(0 != return) BOOL WINAPI CryptGetDefaultProviderW(
    _In_ DWORD dwProvType, _Reserved_ DWORD *pdwReserved, _In_ DWORD dwFlags,
...
WINADVAPI
_Success_(0 != return) BOOL WINAPI CryptEnumProviderTypesA(
    _In_ DWORD dwIndex, _Reserved_ DWORD *pdwReserved, _In_ DWORD dwFlags,
    _Out_ DWORD *pdwProvType,
    _Out_writes_bytes_to_opt_(*pcbTypeName, *pcbTypeName) LPSTR szTypeName,
    _Inout_ DWORD *pcbTypeName);
WINADVAPI
_Success_(0 != return) BOOL WINAPI CryptEnumProviderTypesW(
    _In_ DWORD dwIndex, _Reserved_ DWORD *pdwReserved, _In_ DWORD dwFlags,
    _Out_ DWORD *pdwProvType,
...
WINADVAPI
_Success_(0 != return) BOOL WINAPI
    CryptEnumProvidersA(_In_ DWORD dwIndex, _Reserved_ DWORD *pdwReserved,
                        _In_ DWORD dwFlags, _Out_ DWORD *pdwProvType,
                        _Out_writes_bytes_to_opt_(*pcbProvName, *pcbProvName)
                            LPSTR szProvName,
                        _Inout_ DWORD *pcbProvName);
WINADVAPI
_Success_(0 != return) BOOL WINAPI
    CryptEnumProvidersW(_In_ DWORD dwIndex, _Reserved_ DWORD *pdwReserved,
                        _In_ DWORD dwFlags, _Out_ DWORD *pdwProvType,
                        _Out_writes_bytes_to_opt_(*pcbProvName, *pcbProvName)
                            LPWSTR szProvName,
                        _Inout_ DWORD *pcbProvName);
...
WINADVAPI
BOOL WINAPI CryptContextAddRef(_In_ HCRYPTPROV hProv,
                               _Reserved_ DWORD *pdwReserved,
                               _In_ DWORD dwFlags);

WINADVAPI
BOOL WINAPI CryptDuplicateKey(_In_ HCRYPTKEY hKey,
                              _Reserved_ DWORD *pdwReserved, _In_ DWORD dwFlags,
                              _Out_ HCRYPTKEY *phKey);

WINADVAPI
BOOL WINAPI CryptDuplicateHash(_In_ HCRYPTHASH hHash,
                               _Reserved_ DWORD *pdwReserved,
                               _In_ DWORD dwFlags, _Out_ HCRYPTHASH *phHash);
...
// encryption provider.
//
BOOL __cdecl GetEncSChannel(_Outptr_result_buffer_(*dwDecSize) BYTE **pData,
                            _Out_ DWORD *dwDecSize);
#endif //(NTDDI_VERSION >= NTDDI_WS03)

#endif /* WINAPI_FAMILY_PARTITION(WINAPI_PARTITION_DESKTOP |                   \
          WINAPI_PARTITION_PHONE_RESTRICTED | WINAPI_PARTITION_GAMES) */
#pragma endregion
...
//+-------------------------------------------------------------------------
//  In a CRYPT_BIT_BLOB the last byte may contain 0-7 unused bits. Therefore,
//  the overall bit length is cbData * 8 - cUnusedBits.
//--------------------------------------------------------------------------
...
//  most algorithm types, the Parameters CRYPT_OBJID_BLOB is NULL
//  (Parameters.cbData = 0).
//--------------------------------------------------------------------------
...
#define szOID_NIST_hash_slh_dsa_shake_128s_with_shake128                       \
  "2.16.840.1.101.3.4.3.41"
#define szOID_NIST_hash_slh_dsa_shake_128f_with_shake128                       \
  "2.16.840.1.101.3.4.3.42"
#define szOID_NIST_hash_slh_dsa_shake_192s_with_shake256                       \
  "2.16.840.1.101.3.4.3.43"
#define szOID_NIST_hash_slh_dsa_shake_192f_with_shake256                       \
  "2.16.840.1.101.3.4.3.44"
#define szOID_NIST_hash_slh_dsa_shake_256s_with_shake256                       \
  "2.16.840.1.101.3.4.3.45"
#define szOID_NIST_hash_slh_dsa_shake_256f_with_shake256                       \
...
typedef BOOL(CALLBACK *PCRYPT_DECRYPT_PRIVATE_KEY_FUNC)(
    ...
    _Inout_ DWORD *pcbClearTextKey, _In_ LPVOID pVoidDecryptFunc);
...
typedef BOOL(CALLBACK *PCRYPT_ENCRYPT_PRIVATE_KEY_FUNC)(
    ...
    _Inout_ DWORD *pcbEncryptedKey, _In_ LPVOID pVoidEncryptFunc);
...
// pVoidResolveFunc - this is the pVoidResolveFunc passed in by the caller in
// the
...
// the caller the opportunity to specify where the key is imported to.  the
// callback passes the caller the algoroithm OID and key size to use in making
// the decision. the other callback is used to decrypt the private key if the
// PKCS8 contains an EncryptedPrivateKeyInfo.  both pVoids are preserved and
// passed back to the caller in the respective callback
//+-------------------------------------------------------------------------
...
// key will not be encrypted and an EncryptedPrivateKeyInfo will not be
// generated. The pVoid is preserved and passed back to the caller in the
// respective callback
//+-------------------------------------------------------------------------
...
typedef struct _CERT_OR_CRL_BLOB {
  DWORD dwChoice;
  DWORD cbEncoded;
  _Field_size_bytes_(cbEncoded) BYTE *pbEncoded;
} CERT_OR_CRL_BLOB, *PCERT_OR_CRL_BLOB;

typedef struct _CERT_OR_CRL_BUNDLE {
  DWORD cItem;
  _Field_size_(cItem) PCERT_OR_CRL_BLOB rgItem;
...
//  display of the encoded data, that is, each subfield will be concatenated
//  with a ", " on one line.  If user prefers to display the data in multiple
//  line, set the flag CRYPT_FORMAT_STR_MULTI_LINE, that is, each subfield will
//  be displayed on a seperate line.
//
...
BOOL WINAPI CryptFormatObject(
    _In_ DWORD dwCertEncodingType, _In_ DWORD dwFormatType,
    _In_ DWORD dwFormatStrType, _In_opt_ void *pFormatStruct,
    _In_opt_ LPCSTR lpszStructType,
    _In_reads_bytes_(cbEncoded) const BYTE *pbEncoded, _In_ DWORD cbEncoded,
    _At_((WCHAR *)pbFormat,
...
typedef LPVOID(WINAPI *PFN_CRYPT_ALLOC)(_In_ size_t cbSize);
...
BOOL WINAPI CryptEncodeObject(
    _In_ DWORD dwCertEncodingType, _In_ LPCSTR lpszStructType,
    _In_ const void *pvStructInfo,
...
// contains non-IA5 characters then using this flag in during encoding will
// cause the hostname to be punycode and the path as UTF8-percent encoding For
// example: http://www.zzzzzz.com/yyyyy/qqqqq/rrrrrr.sssss If zzzzzz contains
// non-IA5 characters then using this flag will punycode encode the zzzzzz
// component. If yyyyy or qqqqq or rrrrrr or sssss contain non-IA5 characters
// then using this flag will UTF8 percent encode those characters which are not
// IA5.
...
BOOL WINAPI CryptDecodeObjectEx(
    _In_ DWORD dwCertEncodingType, _In_ LPCSTR lpszStructType,
    _In_reads_bytes_(cbEncoded) const BYTE *pbEncoded, _In_ DWORD cbEncoded,
    _In_ DWORD dwFlags, _In_opt_ PCRYPT_DECODE_PARA pDecodePara,
    _Out_opt_ void *pvStructInfo, _Inout_ DWORD *pcbStructInfo);

WINCRYPT32API
BOOL WINAPI
CryptDecodeObject(_In_ DWORD dwCertEncodingType, _In_ LPCSTR lpszStructType,
                  _In_reads_bytes_(cbEncoded) const BYTE *pbEncoded,
                  _In_ DWORD cbEncoded, _In_ DWORD dwFlags,
                  _Out_writes_bytes_to_opt_(*pcbStructInfo,
...
// (URL). The decoded value contains the Unicode equivalent of the punycode
// encoded host name and UTF8 percent encoded path.
...
// Only used for specific symbols which have collisions today (Apr 2022) to
...
#define szOID_NTDS_CA_SECURITY_EXT                                             \
  "1.3.6.1.4.1.311.25.2" // OID arc for Microsoft CA custom security extension
...
//--------------------------------------------------------------------------
#define wszURI_NTDS_OBJECTSID_PREFIX                                           \
  L"tag:microsoft.com,2022-09-14:sid:" // URI for objectSid info in the SAN, to
                                       // be followed by a string SID
...
#define szOID_ENROLL_ENCRYPTION_ALGORITHM                                      \
  "1.3.6.1.4.1.311.21.29" // algorithm oid
...
BOOL WINAPI CryptInstallOIDFunctionAddress(
    ...
    _In_ DWORD dwEncodingType, _In_ LPCSTR pszFuncName, _In_ DWORD cFuncEntry,
...
HCRYPTOIDFUNCSET
WINAPI
CryptInitOIDFunctionSet(_In_ LPCSTR pszFuncName, _In_ DWORD dwFlags);
...
_Success_(return != FALSE) BOOL WINAPI
    CryptGetOIDFunctionAddress(_In_ HCRYPTOIDFUNCSET hFuncSet,
                               _In_ DWORD dwEncodingType, _In_ LPCSTR pszOID,
                               _In_ DWORD dwFlags, _Outptr_ void **ppvFuncAddr,
...
//--------------------------------------------------------------------------
WINCRYPT32API
_Success_(return != FALSE) BOOL WINAPI CryptGetDefaultOIDDllList(
    _In_ HCRYPTOIDFUNCSET hFuncSet, _In_ DWORD dwEncodingType,
    _Out_writes_to_opt_(*pcchDllList, *pcchDllList)
        _Post_ _NullNull_terminated_ WCHAR *pwszDllList,
...
//--------------------------------------------------------------------------
WINCRYPT32API
_Success_(return != FALSE) BOOL WINAPI CryptGetDefaultOIDFunctionAddress(
    _In_ HCRYPTOIDFUNCSET hFuncSet, _In_ DWORD dwEncodingType,
    _In_opt_ LPCWSTR pwszDll, _In_ DWORD dwFlags, _Outptr_ void **ppvFuncAddr,
...
//--------------------------------------------------------------------------
WINCRYPT32API
BOOL WINAPI CryptRegisterOIDFunction(_In_ DWORD dwEncodingType,
...
//--------------------------------------------------------------------------
WINCRYPT32API
BOOL WINAPI CryptUnregisterOIDFunction(_In_ DWORD dwEncodingType,
                                       _In_ LPCSTR pszFuncName,
                                       _In_ LPCSTR pszOID);
...
//--------------------------------------------------------------------------
WINCRYPT32API
BOOL WINAPI CryptRegisterDefaultOIDFunction(_In_ DWORD dwEncodingType,
                                            _In_ LPCSTR pszFuncName,
                                            _In_ DWORD dwIndex,
...
//--------------------------------------------------------------------------
WINCRYPT32API
BOOL WINAPI CryptUnregisterDefaultOIDFunction(_In_ DWORD dwEncodingType,
                                              _In_ LPCSTR pszFuncName,
                                              _In_ LPCWSTR pwszDll);
...
BOOL WINAPI CryptSetOIDFunctionValue(
    _In_ DWORD dwEncodingType, _In_ LPCSTR pszFuncName, _In_ LPCSTR pszOID,
    _In_opt_ LPCWSTR pwszValueName, _In_ DWORD dwValueType,
...
BOOL WINAPI CryptGetOIDFunctionValue(
    _In_ DWORD dwEncodingType, _In_ LPCSTR pszFuncName, _In_ LPCSTR pszOID,
    _In_opt_ LPCWSTR pwszValueName, _Out_opt_ DWORD *pdwValueType,
...
typedef BOOL(WINAPI *PFN_CRYPT_ENUM_OID_FUNC)(
    _In_ DWORD dwEncodingType, _In_ LPCSTR pszFuncName, _In_ LPCSTR pszOID,
    _In_ DWORD cValue, _In_reads_(cValue) const DWORD rgdwValueType[],
    _In_reads_(cValue) LPCWSTR const rgpwszValueName[],
    _In_reads_(cValue) const BYTE *const rgpbValueData[],
    _In_reads_(cValue) const DWORD rgcbValueData[], _Inout_opt_ void *pvArg);
...
BOOL WINAPI CryptEnumOIDFunction(
    _In_ DWORD dwEncodingType, _In_opt_ LPCSTR pszFuncName,
    _In_opt_ LPCSTR pszOID, _In_ DWORD dwFlags, _Inout_opt_ void *pvArg,
...
#define CRYPT_OID_INFO_MAKE_PARAMETER_SET_ALGORITHM(pwszCNGAlgid,              \
                                                    pwszCNGParaSetName)        \
  pwszCNGAlgid L":" pwszCNGParaSetName

// L"ML-DSA:44"
#define CRYPT32_MLDSA_44_ALGORITHM                                             \
  CRYPT_OID_INFO_MAKE_PARAMETER_SET_ALGORITHM(BCRYPT_MLDSA_ALGORITHM,          \
                                              BCRYPT_MLDSA_PARAMETER_SET_44)
// L"ML-DSA:65"
#define CRYPT32_MLDSA_65_ALGORITHM                                             \
  CRYPT_OID_INFO_MAKE_PARAMETER_SET_ALGORITHM(BCRYPT_MLDSA_ALGORITHM,          \
                                              BCRYPT_MLDSA_PARAMETER_SET_65)
// L"ML-DSA:87"
#define CRYPT32_MLDSA_87_ALGORITHM                                             \
  CRYPT_OID_INFO_MAKE_PARAMETER_SET_ALGORITHM(BCRYPT_MLDSA_ALGORITHM,          \
                                              BCRYPT_MLDSA_PARAMETER_SET_87)

// L"ML-KEM:512"
#define CRYPT32_MLKEM_512_ALGORITHM                                            \
  CRYPT_OID_INFO_MAKE_PARAMETER_SET_ALGORITHM(BCRYPT_MLKEM_ALGORITHM,          \
                                              BCRYPT_MLKEM_PARAMETER_SET_512)
// L"ML-KEM:768"
#define CRYPT32_MLKEM_768_ALGORITHM                                            \
  CRYPT_OID_INFO_MAKE_PARAMETER_SET_ALGORITHM(BCRYPT_MLKEM_ALGORITHM,          \
                                              BCRYPT_MLKEM_PARAMETER_SET_768)
// L"ML-KEM:1024"
#define CRYPT32_MLKEM_1024_ALGORITHM                                           \
  CRYPT_OID_INFO_MAKE_PARAMETER_SET_ALGORITHM(BCRYPT_MLKEM_ALGORITHM,          \
...
PCCRYPT_OID_INFO
WINAPI
CryptFindOIDInfo(_In_ DWORD dwKeyType, _In_ void *pvKey, _In_ DWORD dwGroupId);
...
typedef BOOL(WINAPI *PFN_CRYPT_ENUM_OID_INFO)(_In_ PCCRYPT_OID_INFO pInfo,
...
//--------------------------------------------------------------------------
WINCRYPT32API
BOOL WINAPI CryptEnumOIDInfo(_In_ DWORD dwGroupId, _In_ DWORD dwFlags,
                             _Inout_opt_ void *pvArg,
...
LPCWSTR
WINAPI
CryptFindLocalizedName(_In_ LPCWSTR pwszCryptName);
...
//  CMSG_SIGNED
//
//  The pCertInfo in the CMSG_SIGNER_ENCODE_INFO provides the Issuer,
...
//--------------------------------------------------------------------------
typedef BOOL(WINAPI *PFN_CMSG_STREAM_OUTPUT)(_In_opt_ const void *pvArg,
...
HCRYPTMSG
WINAPI
CryptMsgOpenToEncode(_In_ DWORD dwMsgEncodingType, _In_ DWORD dwFlags,
                     _In_ DWORD dwMsgType, _In_ void const *pvMsgEncodeInfo,
...
DWORD
WINAPI
CryptMsgCalculateEncodedLength(_In_ DWORD dwMsgEncodingType, _In_ DWORD dwFlags,
...
HCRYPTMSG
WINAPI
CryptMsgOpenToDecode(_In_ DWORD dwMsgEncodingType, _In_ DWORD dwFlags,
                     _In_ DWORD dwMsgType,
...
HCRYPTMSG
WINAPI
CryptMsgDuplicate(_In_opt_ HCRYPTMSG hCryptMsg);
...
//--------------------------------------------------------------------------
WINCRYPT32API
BOOL WINAPI CryptMsgGetParam(_In_ HCRYPTMSG hCryptMsg, _In_ DWORD dwParamType,
                             _In_ DWORD dwIndex,
                             _Out_writes_bytes_to_opt_(*pcbData,
                                                       *pcbData) void *pvData,
...
//--------------------------------------------------------------------------
WINCRYPT32API
BOOL WINAPI CryptMsgControl(_In_ HCRYPTMSG hCryptMsg, _In_ DWORD dwFlags,
...
BOOL WINAPI CryptMsgVerifyCountersignatureEncoded(
    _In_opt_ HCRYPTPROV_LEGACY hCryptProv, _In_ DWORD dwEncodingType,
    _In_reads_bytes_(cbSignerInfo) PBYTE pbSignerInfo, _In_ DWORD cbSignerInfo,
    _In_reads_bytes_(cbSignerInfoCountersignature)
...
BOOL WINAPI CryptMsgVerifyCountersignatureEncodedEx(
    ...
    _In_reads_bytes_(cbSignerInfoCountersignature)
        PBYTE pbSignerInfoCountersignature,
    _In_ DWORD cbSignerInfoCountersignature, _In_ DWORD dwSignerType,
    _In_ void *pvSigner, _In_ DWORD dwFlags, _Inout_opt_ void *pvExtra);
...
//--------------------------------------------------------------------------
BOOL WINAPI CryptMsgCountersign(_In_ HCRYPTMSG hCryptMsg, _In_ DWORD dwIndex,
                                _In_ DWORD cCountersigners,
                                _In_reads_(cCountersigners)
...
BOOL WINAPI CryptMsgCountersignEncoded(
    ...
    _Out_writes_bytes_to_opt_(*pcbCountersignature, *pcbCountersignature)
...
typedef _Success_(return != FALSE) BOOL(WINAPI *PFN_CMSG_GEN_ENCRYPT_KEY)(
    ...
    _In_opt_ PVOID pvEncryptAuxInfo, _In_ PCERT_PUBLIC_KEY_INFO pPublicKeyInfo,
    __callback PFN_CMSG_ALLOC pfnAlloc, _Out_ HCRYPTKEY *phEncryptKey,
    _Outptr_result_bytebuffer_(*pcbEncryptParameters)
...
typedef BOOL(WINAPI *PFN_CMSG_EXPORT_ENCRYPT_KEY)(
    _In_ HCRYPTPROV hCryptProv, _In_ HCRYPTKEY hEncryptKey,
...
typedef BOOL(WINAPI *PFN_CMSG_IMPORT_ENCRYPT_KEY)(
    _In_ HCRYPTPROV hCryptProv, _In_ DWORD dwKeySpec,
    _In_ PCRYPT_ALGORITHM_IDENTIFIER paiEncrypt,
    _In_ PCRYPT_ALGORITHM_IDENTIFIER paiPubKey,
    _In_reads_bytes_(cbEncodedKey) PBYTE pbEncodedKey, _In_ DWORD cbEncodedKey,
...
typedef BOOL(WINAPI *PFN_CMSG_GEN_CONTENT_ENCRYPT_KEY)(
    _Inout_ PCMSG_CONTENT_ENCRYPT_INFO pContentEncryptInfo, _In_ DWORD dwFlags,
...
typedef BOOL(WINAPI *PFN_CMSG_EXPORT_KEY_TRANS)(
    ...
    _In_ DWORD dwFlags, _Reserved_ void *pvReserved);
...
#define CERT_CEP_PROP_ID                                                       \
  87 // Version+PropFlags+AuthType+UrlFlags+CESAuthType+Url+Id+CESUrl+ReqId
...
#define IS_CERT_HASH_PROP_ID(X)                                                \
  (CERT_SHA1_HASH_PROP_ID == (X) || CERT_MD5_HASH_PROP_ID == (X) ||            \
   CERT_SHA256_HASH_PROP_ID == (X) || CERT_SHA1_SHA256_HASH_PROP_ID == (X) ||  \
...
//--------------------------------------------------------------------------
WINCRYPT32API
_Must_inspect_result_ HCERTSTORE WINAPI
CertOpenStore(_In_ LPCSTR lpszStoreProvider, _In_ DWORD dwEncodingType,
...
typedef BOOL(WINAPI *PFN_CERT_DLL_OPEN_STORE_PROV_FUNC)(
    _In_ LPCSTR lpszStoreProvider, _In_ DWORD dwEncodingType,
    _In_opt_ HCRYPTPROV_LEGACY hCryptProv, _In_ DWORD dwFlags,
    _In_opt_ const void *pvPara, _In_ HCERTSTORE hCertStore,
...
typedef void(WINAPI *PFN_CERT_STORE_PROV_CLOSE)(
    _Inout_opt_ HCERTSTOREPROV hStoreProv, _In_ DWORD dwFlags);
...
typedef _Success_(return != FALSE) BOOL(WINAPI *PFN_CERT_STORE_PROV_READ_CERT)(
    _Inout_ HCERTSTOREPROV hStoreProv, _In_ PCCERT_CONTEXT pStoreCertContext,
    _In_ DWORD dwFlags, _Outptr_ PCCERT_CONTEXT *ppProvCertContext);
...
typedef BOOL(WINAPI *PFN_CERT_STORE_PROV_WRITE_CERT)(
    _Inout_ HCERTSTOREPROV hStoreProv, _In_ PCCERT_CONTEXT pCertContext,
    _In_ DWORD dwFlags);
...
typedef BOOL(WINAPI *PFN_CERT_STORE_PROV_SET_CERT_PROPERTY)(
    _Inout_ HCERTSTOREPROV hStoreProv, _In_ PCCERT_CONTEXT pCertContext,
    _In_ DWORD dwPropId, _In_ DWORD dwFlags, _In_opt_ const void *pvData);
...
typedef _Success_(return != FALSE) BOOL(WINAPI *PFN_CERT_STORE_PROV_READ_CRL)(
    _Inout_ HCERTSTOREPROV hStoreProv, _In_ PCCRL_CONTEXT pStoreCrlContext,
    _In_ DWORD dwFlags, _Outptr_ PCCRL_CONTEXT *ppProvCrlContext);
...
typedef BOOL(WINAPI *PFN_CERT_STORE_PROV_WRITE_CRL)(
    _Inout_ HCERTSTOREPROV hStoreProv, _In_ PCCRL_CONTEXT pCrlContext,
    _In_ DWORD dwFlags);
...
typedef _Success_(return != FALSE) BOOL(WINAPI *PFN_CERT_STORE_PROV_READ_CTL)(
    _Inout_ HCERTSTOREPROV hStoreProv, _In_ PCCTL_CONTEXT pStoreCtlContext,
    _In_ DWORD dwFlags, _Outptr_ PCCTL_CONTEXT *ppProvCtlContext);
...
typedef BOOL(WINAPI *PFN_CERT_STORE_PROV_WRITE_CTL)(
    _Inout_ HCERTSTOREPROV hStoreProv, _In_ PCCTL_CONTEXT pCtlContext,
    _In_ DWORD dwFlags);
...
typedef BOOL(WINAPI *PFN_CERT_STORE_PROV_CONTROL)(
    _Inout_ HCERTSTOREPROV hStoreProv, _In_ DWORD dwFlags,
    _In_ DWORD dwCtrlType, _In_opt_ void const *pvCtrlPara);
...
typedef _Success_(return != FALSE) BOOL(WINAPI *PFN_CERT_STORE_PROV_FIND_CERT)(
    ...
    _In_ PCCERT_CONTEXT pPrevCertContext, _In_ DWORD dwFlags,
    _Inout_ void **ppvStoreProvFindInfo,
    _Outptr_ PCCERT_CONTEXT *ppProvCertContext);

typedef BOOL(WINAPI *PFN_CERT_STORE_PROV_FREE_FIND_CERT)(
    _Inout_ HCERTSTOREPROV hStoreProv, _In_ PCCERT_CONTEXT pCertContext,
    _In_ void *pvStoreProvFindInfo, _In_ DWORD dwFlags);

typedef BOOL(WINAPI *PFN_CERT_STORE_PROV_GET_CERT_PROPERTY)(
    _Inout_ HCERTSTOREPROV hStoreProv, _In_ PCCERT_CONTEXT pCertContext,
    _In_ DWORD dwPropId, _In_ DWORD dwFlags,
...
typedef _Success_(return != FALSE) BOOL(WINAPI *PFN_CERT_STORE_PROV_FIND_CRL)(
    _Inout_ HCERTSTOREPROV hStoreProv,
    _In_ PCCERT_STORE_PROV_FIND_INFO pFindInfo,
    _In_ PCCRL_CONTEXT pPrevCrlContext, _In_ DWORD dwFlags,
    _Inout_ void **ppvStoreProvFindInfo,
...
typedef _Success_(return != FALSE) BOOL(WINAPI *PFN_CERT_STORE_PROV_FIND_CTL)(
    _In_ HCERTSTOREPROV hStoreProv, _In_ PCCERT_STORE_PROV_FIND_INFO pFindInfo,
    _In_ PCCTL_CONTEXT pPrevCtlContext, _In_ DWORD dwFlags,
    _Inout_ void **ppvStoreProvFindInfo,
...
HCERTSTORE
WINAPI
CertDuplicateStore(_In_ HCERTSTORE hCertStore);
...
//--------------------------------------------------------------------------
WINCRYPT32API
BOOL WINAPI CertSaveStore(_In_ HCERTSTORE hCertStore, _In_ DWORD dwEncodingType,
                          _In_ DWORD dwSaveAs, _In_ DWORD dwSaveTo,
                          _Inout_ void *pvSaveToPara, _In_ DWORD dwFlags);
...
CertGetSubjectCertificateFromStore(
    _In_ HCERTSTORE hCertStore, _In_ DWORD dwCertEncodingType,
...
//  as the pPrevCertContext on a subsequent call.
...
PCCERT_CONTEXT
WINAPI
CertEnumCertificatesInStore(_In_ HCERTSTORE hCertStore,
...
PCCERT_CONTEXT
WINAPI
CertFindCertificateInStore(_In_ HCERTSTORE hCertStore,
                           _In_ DWORD dwCertEncodingType,
                           _In_ DWORD dwFindFlags, _In_ DWORD dwFindType,
...
#define CERT_FIND_SHA1_SHA256_HASH                                             \
  (CERT_COMPARE_SHA1_SHA256_HASH << CERT_COMPARE_SHIFT)
...
//  pvFindPara. The comparison iterates through the CERT_RDN attributes and
//  looks for an attribute match in any of the subject/issuer's RDNs.
//
...
//  Otherwise, a pointer to a read only CERT_CONTEXT is returned. CERT_CONTEXT
//  must be freed by calling CertFreeCertificateContext or is freed when passed
//  as the pPrevIssuerContext on a subsequent call.
//  CertDuplicateCertificateContext can be called to make a duplicate.
//
...
//
//  NOTE: a NON-NULL pPrevIssuerContext is always CertFreeCertificateContext'ed
...
PCCERT_CONTEXT
WINAPI
CertGetIssuerCertificateFromStore(_In_ HCERTSTORE hCertStore,
...
PCCERT_CONTEXT
WINAPI
CertDuplicateCertificateContext(_In_opt_ PCCERT_CONTEXT pCertContext);
...
PCCERT_CONTEXT
WINAPI
CertCreateCertificateContext(_In_ DWORD dwCertEncodingType,
                             _In_reads_bytes_(cbCertEncoded)
...
//      certificate's private key is passed in pvData.
//
...
BOOL WINAPI CertGetCertificateContextProperty(
    _In_ PCCERT_CONTEXT pCertContext, _In_ DWORD dwPropId,
    _Out_writes_bytes_to_opt_(*pcbData, *pcbData) void *pvData,
    _Inout_ DWORD *pcbData);
...
DWORD
WINAPI
CertEnumCertificateContextProperties(_In_ PCCERT_CONTEXT pCertContext,
                                     _In_ DWORD dwPropId);
...
_Success_(return != FALSE) BOOL WINAPI
    CertCreateCTLEntryFromCertificateContextProperties(
        _In_ PCCERT_CONTEXT pCertContext, _In_ DWORD cOptAttr,
        _In_reads_opt_(cOptAttr) PCRYPT_ATTRIBUTE rgOptAttr, _In_ DWORD dwFlags,
        _Reserved_ void *pvReserved,
        _Out_writes_bytes_to_opt_(*pcbCtlEntry, *pcbCtlEntry)
...
//--------------------------------------------------------------------------
WINCRYPT32API
BOOL WINAPI CertSetCertificateContextPropertiesFromCTLEntry(
    _In_ PCCERT_CONTEXT pCertContext, _In_ PCTL_ENTRY pCtlEntry,
    _In_ DWORD dwFlags);
...
PCCRL_CONTEXT
WINAPI
CertGetCRLFromStore(_In_ HCERTSTORE hCertStore,
...
PCCRL_CONTEXT
WINAPI
CertEnumCRLsInStore(_In_ HCERTSTORE hCertStore,
                    _In_opt_ PCCRL_CONTEXT pPrevCrlContext);
...
PCCRL_CONTEXT
WINAPI
CertFindCRLInStore(_In_ HCERTSTORE hCertStore, _In_ DWORD dwCertEncodingType,
                   _In_ DWORD dwFindFlags, _In_ DWORD dwFindType,
                   _In_opt_ const void *pvFindPara,
                   _In_opt_ PCCRL_CONTEXT pPrevCrlContext);
...
PCCRL_CONTEXT
WINAPI
CertDuplicateCRLContext(_In_opt_ PCCRL_CONTEXT pCrlContext);
...
PCCRL_CONTEXT
WINAPI
CertCreateCRLContext(_In_ DWORD dwCertEncodingType,
...
BOOL WINAPI CertGetCRLContextProperty(
    _In_ PCCRL_CONTEXT pCrlContext, _In_ DWORD dwPropId,
    _Out_writes_bytes_to_opt_(*pcbData, *pcbData) void *pvData,
    _Inout_ DWORD *pcbData);
...
DWORD
WINAPI
CertEnumCRLContextProperties(_In_ PCCRL_CONTEXT pCrlContext,
                             _In_ DWORD dwPropId);
...
BOOL WINAPI CertFindCertificateInCRL(
    _In_ PCCERT_CONTEXT pCert, _In_ PCCRL_CONTEXT pCrlContext,
    _In_ DWORD dwFlags, _Reserved_ void *pvReserved,
...
//--------------------------------------------------------------------------
WINCRYPT32API
_Success_(return != FALSE) BOOL WINAPI CertAddEncodedCertificateToStore(
    _In_opt_ HCERTSTORE hCertStore, _In_ DWORD dwCertEncodingType,
    _In_reads_bytes_(cbCertEncoded) const BYTE *pbCertEncoded,
    _In_ DWORD cbCertEncoded, _In_ DWORD dwAddDisposition,
...
//--------------------------------------------------------------------------
WINCRYPT32API
_Success_(return != FALSE) BOOL WINAPI CertAddCertificateContextToStore(
    _In_opt_ HCERTSTORE hCertStore, _In_ PCCERT_CONTEXT pCertContext,
    _In_ DWORD dwAddDisposition, _Outptr_opt_ PCCERT_CONTEXT *ppStoreContext);
...
//--------------------------------------------------------------------------
WINCRYPT32API
_Success_(return != FALSE) BOOL WINAPI CertAddSerializedElementToStore(
    _In_opt_ HCERTSTORE hCertStore,
    _In_reads_bytes_(cbElement) const BYTE *pbElement, _In_ DWORD cbElement,
    _In_ DWORD dwAddDisposition, _In_ DWORD dwFlags,
    _In_ DWORD dwContextTypeFlags, _Out_opt_ DWORD *pdwContextType,
...
//--------------------------------------------------------------------------
WINCRYPT32API
_Success_(return != FALSE) BOOL WINAPI CertAddEncodedCRLToStore(
    _In_opt_ HCERTSTORE hCertStore, _In_ DWORD dwCertEncodingType,
    _In_reads_bytes_(cbCrlEncoded) const BYTE *pbCrlEncoded,
    _In_ DWORD cbCrlEncoded, _In_ DWORD dwAddDisposition,
...
WINCRYPT32API
_Success_(return != FALSE) BOOL WINAPI
    CertAddCRLContextToStore(_In_opt_ HCERTSTORE hCertStore,
...
BOOL WINAPI CertSerializeCertificateStoreElement(
    _In_ PCCERT_CONTEXT pCertContext, _In_ DWORD dwFlags,
...
BOOL WINAPI CertSerializeCRLStoreElement(
    _In_ PCCRL_CONTEXT pCrlContext, _In_ DWORD dwFlags,
    _Out_writes_bytes_to_opt_(*pcbElement, *pcbElement) BYTE *pbElement,
    _Inout_ DWORD *pcbElement);
...
PCCTL_CONTEXT
WINAPI
CertDuplicateCTLContext(_In_opt_ PCCTL_CONTEXT pCtlContext);
...
PCCTL_CONTEXT
WINAPI
CertCreateCTLContext(_In_ DWORD dwMsgAndCertEncodingType,
...
BOOL WINAPI CertGetCTLContextProperty(
    _In_ PCCTL_CONTEXT pCtlContext, _In_ DWORD dwPropId,
    _Out_writes_bytes_to_opt_(*pcbData, *pcbData) void *pvData,
    _Inout_ DWORD *pcbData);
...
DWORD
WINAPI
CertEnumCTLContextProperties(_In_ PCCTL_CONTEXT pCtlContext,
                             _In_ DWORD dwPropId);
...
PCCTL_CONTEXT
WINAPI
CertEnumCTLsInStore(_In_ HCERTSTORE hCertStore,
...
PCTL_ENTRY
WINAPI
CertFindSubjectInCTL(_In_ DWORD dwEncodingType, _In_ DWORD dwSubjectType,
                     _In_ void *pvSubject, _In_ PCCTL_CONTEXT pCtlContext,
                     _In_ DWORD dwFlags);
...
PCCTL_CONTEXT
WINAPI
CertFindCTLInStore(_In_ HCERTSTORE hCertStore,
                   _In_ DWORD dwMsgAndCertEncodingType, _In_ DWORD dwFindFlags,
                   _In_ DWORD dwFindType, _In_opt_ const void *pvFindPara,
                   _In_opt_ PCCTL_CONTEXT pPrevCtlContext);
...
//--------------------------------------------------------------------------
WINCRYPT32API
_Success_(return != FALSE) BOOL WINAPI CertAddEncodedCTLToStore(
    _In_opt_ HCERTSTORE hCertStore, _In_ DWORD dwMsgAndCertEncodingType,
    _In_reads_bytes_(cbCtlEncoded) const BYTE *pbCtlEncoded,
    _In_ DWORD cbCtlEncoded, _In_ DWORD dwAddDisposition,
...
WINCRYPT32API
_Success_(return != FALSE) BOOL WINAPI
    CertAddCTLContextToStore(_In_opt_ HCERTSTORE hCertStore,
...
BOOL WINAPI CertSerializeCTLStoreElement(
    _In_ PCCTL_CONTEXT pCtlContext, _In_ DWORD dwFlags,
    _Out_writes_bytes_to_opt_(*pcbElement, *pcbElement) BYTE *pbElement,
    _Inout_ DWORD *pcbElement);
...
WINCRYPT32API
_Success_(return != FALSE) BOOL WINAPI
    CertAddCertificateLinkToStore(_In_ HCERTSTORE hCertStore,
...
WINCRYPT32API
_Success_(return != FALSE) BOOL WINAPI
    CertAddCRLLinkToStore(_In_ HCERTSTORE hCertStore,
                          _In_ PCCRL_CONTEXT pCrlContext,
                          _In_ DWORD dwAddDisposition,
                          _Outptr_opt_ PCCRL_CONTEXT *ppStoreContext);
...
WINCRYPT32API
_Success_(return != FALSE) BOOL WINAPI
    CertAddCTLLinkToStore(_In_ HCERTSTORE hCertStore,
                          _In_ PCCTL_CONTEXT pCtlContext,
                          _In_ DWORD dwAddDisposition,
                          _Outptr_opt_ PCCTL_CONTEXT *ppStoreContext);
...
WINCRYPT32API
BOOL WINAPI CertControlStore(_In_ HCERTSTORE hCertStore, _In_ DWORD dwFlags,
                             _In_ DWORD dwCtrlType,
                             _In_opt_ void const *pvCtrlPara);
...
WINCRYPT32API
_Success_(return != FALSE) BOOL WINAPI
    CertGetStoreProperty(_In_ HCERTSTORE hCertStore, _In_ DWORD dwPropId,
                         _Out_writes_bytes_to_opt_(*pcbData,
                                                   *pcbData) void *pvData,
                         _Inout_ DWORD *pcbData);
...
typedef BOOL(WINAPI *PFN_CERT_CREATE_CONTEXT_SORT_FUNC)(
    _In_ DWORD cbTotalEncoded, _In_ DWORD cbRemainEncoded, _In_ DWORD cEntry,
...
const void *WINAPI CertCreateContext(
    _In_ DWORD dwContextType, _In_ DWORD dwEncodingType,
    _In_reads_bytes_(cbEncoded) const BYTE *pbEncoded, _In_ DWORD cbEncoded,
    _In_ DWORD dwFlags, _In_opt_ PCERT_CREATE_CONTEXT_PARA pCreatePara);
...
//--------------------------------------------------------------------------
WINCRYPT32API
BOOL WINAPI CertUnregisterPhysicalStore(_In_ const void *pvSystemStore,
                                        _In_ DWORD dwFlags,
                                        _In_ LPCWSTR pwszStoreName);
...
typedef BOOL(WINAPI *PFN_CERT_ENUM_SYSTEM_STORE_LOCATION)(
    _In_ LPCWSTR pwszStoreLocation, _In_ DWORD dwFlags,
    _Reserved_ void *pvReserved, _Inout_opt_ void *pvArg);

typedef BOOL(WINAPI *PFN_CERT_ENUM_SYSTEM_STORE)(
    _In_ const void *pvSystemStore, _In_ DWORD dwFlags,
    _In_ PCERT_SYSTEM_STORE_INFO pStoreInfo, _Reserved_ void *pvReserved,
    _Inout_opt_ void *pvArg);

typedef BOOL(WINAPI *PFN_CERT_ENUM_PHYSICAL_STORE)(
    _In_ const void *pvSystemStore, _In_ DWORD dwFlags,
    _In_ LPCWSTR pwszStoreName, _In_ PCERT_PHYSICAL_STORE_INFO pStoreInfo,
    _Reserved_ void *pvReserved, _Inout_opt_ void *pvArg);
...
BOOL WINAPI CertEnumSystemStoreLocation(
    _In_ DWORD dwFlags, _Inout_opt_ void *pvArg,
...
BOOL WINAPI CertEnumPhysicalStore(
    _In_ const void *pvSystemStore, _In_ DWORD dwFlags, _Inout_opt_ void *pvArg,
...
BOOL WINAPI CertRemoveEnhancedKeyUsageIdentifier(
    _In_ PCCERT_CONTEXT pCertContext, _In_ LPCSTR pszUsageIdentifier);
...
WINCRYPT32API
_Success_(return != FALSE) BOOL WINAPI
    CertGetValidUsages(_In_ DWORD cCerts,
                       _In_reads_(cCerts) PCCERT_CONTEXT *rghCerts,
                       _Out_ int *cNumOIDs,
                       _Out_writes_bytes_to_opt_(*pcbOIDs, *pcbOIDs)
                           LPSTR *rghOIDs,
...
WINCRYPT32API
_Success_(return == TRUE) BOOL WINAPI CryptMsgGetAndVerifySigner(
    _In_ HCRYPTMSG hCryptMsg, _In_ DWORD cSignerStore,
    _In_reads_opt_(cSignerStore) HCERTSTORE *rghSignerStore, _In_ DWORD dwFlags,
    _Outptr_opt_ PCCERT_CONTEXT *ppSigner, _Inout_opt_ DWORD *pdwSignerIndex);
...
BOOL WINAPI CryptMsgSignCTL(_In_ DWORD dwMsgEncodingType,
                            ...
                            _In_ DWORD dwFlags,
                            _Out_writes_bytes_to_opt_(*pcbEncoded, *pcbEncoded)
                                BYTE *pbEncoded,
                            _Inout_ DWORD *pcbEncoded);
...
BOOL WINAPI CryptMsgEncodeAndSignCTL(
    _In_ DWORD dwMsgEncodingType, _In_ PCTL_INFO pCtlInfo,
    _In_ PCMSG_SIGNED_ENCODE_INFO pSignInfo, _In_ DWORD dwFlags,
    _Out_writes_bytes_to_opt_(*pcbEncoded, *pcbEncoded) BYTE *pbEncoded,
    _Inout_ DWORD *pcbEncoded);
...
BOOL WINAPI CertFindSubjectInSortedCTL(
    _In_ PCRYPT_DATA_BLOB pSubjectIdentifier, _In_ PCCTL_CONTEXT pCtlContext,
    _In_ DWORD dwFlags, _Reserved_ void *pvReserved,
...
BOOL WINAPI CertEnumSubjectInSortedCTL(
    _In_ PCCTL_CONTEXT pCtlContext, _Inout_ void **ppvNextSubject,
...
BOOL WINAPI CertVerifyCTLUsage(
    _In_ DWORD dwEncodingType, _In_ DWORD dwSubjectType, _In_ void *pvSubject,
    _In_ PCTL_USAGE pSubjectUsage, _In_ DWORD dwFlags,
...
BOOL WINAPI CertVerifyRevocation(_In_ DWORD dwEncodingType,
                                 _In_ DWORD dwRevType, _In_ DWORD cContext,
...
DWORD
WINAPI
CertGetPublicKeyLength(_In_ DWORD dwCertEncodingType,
...
//--------------------------------------------------------------------------
WINCRYPT32API
_Must_inspect_result_ BOOL WINAPI CryptVerifyCertificateSignature(
    _In_opt_ HCRYPTPROV_LEGACY hCryptProv, _In_ DWORD dwCertEncodingType,
    _In_reads_bytes_(cbEncoded) const BYTE *pbEncoded, _In_ DWORD cbEncoded,
    _In_ PCERT_PUBLIC_KEY_INFO pPublicKey);
...
//--------------------------------------------------------------------------
WINCRYPT32API
_Must_inspect_result_ BOOL WINAPI CryptVerifyCertificateSignatureEx(
    _In_opt_ HCRYPTPROV_LEGACY hCryptProv, _In_ DWORD dwCertEncodingType,
    _In_ DWORD dwSubjectType, _In_ void *pvSubject, _In_ DWORD dwIssuerType,
    _In_opt_ void *pvIssuer, _In_ DWORD dwFlags, _Inout_opt_ void *pvExtra);
...
//--------------------------------------------------------------------------
WINCRYPT32API
BOOL WINAPI CertIsStrongHashToSign(_In_ PCCERT_STRONG_SIGN_PARA pStrongSignPara,
...
BOOL WINAPI CryptHashCertificate(
    _In_opt_ HCRYPTPROV_LEGACY hCryptProv, _In_ ALG_ID Algid,
    _In_ DWORD dwFlags, _In_reads_bytes_(cbEncoded) const BYTE *pbEncoded,
...
WINCRYPT32API
_Success_(return != FALSE) BOOL WINAPI
    CryptHashCertificate2(_In_ LPCWSTR pwszCNGHashAlgid, _In_ DWORD dwFlags,
                          _Reserved_ void *pvReserved,
                          _In_reads_bytes_opt_(cbEncoded) const BYTE *pbEncoded,
                          _In_ DWORD cbEncoded,
                          _Out_writes_bytes_to_opt_(*pcbComputedHash,
                                                    *pcbComputedHash)
                              BYTE *pbComputedHash,
                          _Inout_ DWORD *pcbComputedHash);
...
typedef BOOL(WINAPI *PFN_CRYPT_SIGN_AND_ENCODE_HASH_FUNC)(
    _In_ NCRYPT_KEY_HANDLE hKey, _In_ DWORD dwCertEncodingType,
    _In_ PCRYPT_ALGORITHM_IDENTIFIER pSignatureAlgorithm,
...
typedef BOOL(WINAPI *PFN_CRYPT_VERIFY_ENCODED_SIGNATURE_FUNC)(
    _In_ DWORD dwCertEncodingType, _In_ PCERT_PUBLIC_KEY_INFO pPubKeyInfo,
    _In_ PCRYPT_ALGORITHM_IDENTIFIER pSignatureAlgorithm,
    _In_opt_ void *pvDecodedSignPara,
    _In_ LPCWSTR pwszCNGPubKeyAlgid, // obtained from signature OID
    _In_ LPCWSTR pwszCNGHashAlgid,
    _In_reads_bytes_(cbComputedHash) BYTE *pbComputedHash,
    _In_ DWORD cbComputedHash, _In_reads_bytes_(cbSignature) BYTE *pbSignature,
...
BOOL WINAPI CertVerifyCRLRevocation(
    ...
    _In_ PCERT_INFO pCertId, // Only the Issuer and SerialNumber
                             // fields are used
    _In_ DWORD cCrlInfo, _In_reads_(cCrlInfo) PCRL_INFO rgpCrlInfo[]);
...
LPCSTR
WINAPI
CertAlgIdToOID(_In_ DWORD dwAlgId);
...
DWORD
WINAPI
CertOIDToAlgId(_In_ LPCSTR pszObjId);
...
PCERT_EXTENSION
WINAPI
CertFindExtension(_In_ LPCSTR pszObjId, _In_ DWORD cExtensions,
...
PCRYPT_ATTRIBUTE
WINAPI
CertFindAttribute(_In_ LPCSTR pszObjId, _In_ DWORD cAttr,
...
PCERT_RDN_ATTR
WINAPI
CertFindRDNAttr(_In_ LPCSTR pszObjId, _In_ PCERT_NAME_INFO pName);
...
BOOL WINAPI CertGetIntendedKeyUsage(_In_ DWORD dwCertEncodingType,
                                    _In_ PCERT_INFO pCertInfo,
                                    _Out_writes_bytes_all_(cbKeyUsage)
                                        BYTE *pbKeyUsage,
...
BOOL WINAPI CryptInstallDefaultContext(
    _In_ HCRYPTPROV hCryptProv, _In_ DWORD dwDefaultType,
    _In_opt_ const void *pvDefaultPara, _In_ DWORD dwFlags,
    _Reserved_ void *pvReserved, _Out_ HCRYPTDEFAULTCONTEXT *phDefaultContext);
...
WINCRYPT32API
BOOL WINAPI
CryptUninstallDefaultContext(_In_opt_ HCRYPTDEFAULTCONTEXT hDefaultContext,
                             _In_ DWORD dwFlags, _Reserved_ void *pvReserved);
...
BOOL WINAPI CryptExportPublicKeyInfoEx(
    _In_ HCRYPTPROV_OR_NCRYPT_KEY_HANDLE hCryptProvOrNCryptKey,
    _In_opt_ DWORD dwKeySpec, // not applicable for NCRYPT_KEY_HANDLE
    _In_ DWORD dwCertEncodingType, _In_opt_ LPSTR pszPublicKeyObjId,
    _In_ DWORD dwFlags, _In_opt_ void *pvAuxInfo,
    _Out_writes_bytes_to_opt_(*pcbInfo, *pcbInfo) PCERT_PUBLIC_KEY_INFO pInfo,
    _Inout_ DWORD *pcbInfo);
...
typedef BOOL(WINAPI *PFN_CRYPT_EXPORT_PUBLIC_KEY_INFO_EX2_FUNC)(
    _In_ NCRYPT_KEY_HANDLE hNCryptKey, _In_ DWORD dwCertEncodingType,
    _In_ LPSTR pszPublicKeyObjId, _In_ DWORD dwFlags, _In_opt_ void *pvAuxInfo,
    _Out_writes_bytes_to_opt_(*pcbInfo, *pcbInfo) PCERT_PUBLIC_KEY_INFO pInfo,
    _Inout_ DWORD *pcbInfo);
...
WINCRYPT32API
BOOL WINAPI CryptExportPublicKeyInfoFromBCryptKeyHandle(
    _In_ BCRYPT_KEY_HANDLE hBCryptKey, _In_ DWORD dwCertEncodingType,
    _In_opt_ LPSTR pszPublicKeyObjId, _In_ DWORD dwFlags,
...
BOOL WINAPI CryptImportPublicKeyInfoEx(_In_ HCRYPTPROV hCryptProv,
                                       _In_ DWORD dwCertEncodingType,
                                       _In_ PCERT_PUBLIC_KEY_INFO pInfo,
                                       _In_ ALG_ID aiKeyAlg, _In_ DWORD dwFlags,
                                       _In_opt_ void *pvAuxInfo,
                                       _Out_ HCRYPTKEY *phKey);
...
//--------------------------------------------------------------------------
WINCRYPT32API
BOOL WINAPI CryptImportPublicKeyInfoEx2(_In_ DWORD dwCertEncodingType,
                                        _In_ PCERT_PUBLIC_KEY_INFO pInfo,
                                        _In_ DWORD dwFlags,
                                        _In_opt_ void *pvAuxInfo,
...
typedef BOOL(WINAPI *PFN_IMPORT_PUBLIC_KEY_INFO_EX2_FUNC)(
    _In_ DWORD dwCertEncodingType, _In_ PCERT_PUBLIC_KEY_INFO pInfo,
    _In_ DWORD dwFlags, _In_opt_ void *pvAuxInfo,
    _Out_ BCRYPT_KEY_HANDLE *phKey);
...
//
//  The CRYPT_ACQUIRE_WINDOW_HANDLE_FLAG can be set when a pointer to a window
//  handle (HWND*) is passed in as the pvParameters. The window handle will be
//  used by calling CryptSetProvParam with a NULL HCRYPTPROV and dwParam is
//  PP_CLIENT_HWND before the call to CryptAcquireContext. This will set the
//  window handle for all CAPI calls in this process. The caller should make
//  sure the window handle is valid or clear it out by calling CryptSetProvParam
//  with PP_CLIENT_HWND with a NULL hWnd. Or for cng, the hwnd will be used by
//  calling NCryptSetProperty on the storage provider handle provider with
//  property NCRYPT_WINDOW_HANDLE_PROPERTY and by calling NCryptSetPRoperty on
//  the key handle with property NCRYPT_WINDOW_HANDLE_PROPERTY. If both calls to
//  NCryptSetProperty fail then the function will return the failure of setting
//  the NCRYPT_WINDOW_HANDLE_PROPERTY on the key handle. Do not use this flag
//  with CRYPT_ACQUIRE_SILENT_FLAG.
//
...
BOOL WINAPI CryptAcquireCertificatePrivateKey(
    _In_ PCCERT_CONTEXT pCert, _In_ DWORD dwFlags, _In_opt_ void *pvParameters,
    _Out_ HCRYPTPROV_OR_NCRYPT_KEY_HANDLE *phCryptProvOrNCryptKey,
    _Out_opt_ DWORD *pdwKeySpec, _Out_opt_ BOOL *pfCallerFreeProvOrNCryptKey);
...
// if the PRESOLVE_HCRYPTPROV_FUNC is NULL then the default provider will be
// used.
//
...
typedef BOOL(WINAPI *PFN_EXPORT_PRIV_KEY_FUNC)(
    ...
    _Out_writes_bytes_opt_(*pcbPrivateKeyInfo)
...
//--------------------------------------------------------------------------
WINCRYPT32API
BOOL WINAPI CryptExportPKCS8(_In_ HCRYPTPROV hCryptProv,    // in
                             _In_ DWORD dwKeySpec,          // in
                             _In_ LPSTR pszPrivateKeyObjId, // in
                             _In_ DWORD dwFlags,            // in
                             _In_opt_ void *pvAuxInfo,      // in
                             _Out_writes_bytes_opt_(*pcbPrivateKeyBlob)
...
BOOL WINAPI CryptHashPublicKeyInfo(_In_opt_ HCRYPTPROV_LEGACY hCryptProv,
                                   _In_ ALG_ID Algid, _In_ DWORD dwFlags,
                                   _In_ DWORD dwCertEncodingType,
                                   _In_ PCERT_PUBLIC_KEY_INFO pInfo,
                                   _Out_writes_bytes_to_opt_(*pcbComputedHash,
                                                             *pcbComputedHash)
...
DWORD
WINAPI
CertRDNValueToStrA(_In_ DWORD dwValueType, _In_ PCERT_RDN_VALUE_BLOB pValue,
                   _Out_writes_to_opt_(csz, return) LPSTR psz, _In_ DWORD csz);
//+-------------------------------------------------------------------------
//  Convert a Name Value to a null terminated char string
//
//  Returns the number of characters converted including the terminating null
...
DWORD
WINAPI
CertRDNValueToStrW(_In_ DWORD dwValueType, _In_ PCERT_RDN_VALUE_BLOB pValue,
                   _Out_writes_to_opt_(csz, return) LPWSTR psz, _In_ DWORD csz);
#ifdef UNICODE
...
DWORD
WINAPI
CertNameToStrA(_In_ DWORD dwCertEncodingType, _In_ PCERT_NAME_BLOB pName,
               _In_ DWORD dwStrType, _Out_writes_to_opt_(csz, return) LPSTR psz,
               _In_ DWORD csz);
WINCRYPT32API
DWORD
WINAPI
CertNameToStrW(_In_ DWORD dwCertEncodingType, _In_ PCERT_NAME_BLOB pName,
...
//--------------------------------------------------------------------------
WINCRYPT32API
BOOL WINAPI CertStrToNameA(_In_ DWORD dwCertEncodingType, _In_ LPCSTR pszX500,
                           _In_ DWORD dwStrType, _Reserved_ void *pvReserved,
                           _Out_writes_bytes_to_opt_(*pcbEncoded, *pcbEncoded)
                               BYTE *pbEncoded,
                           _Inout_ DWORD *pcbEncoded,
...
//--------------------------------------------------------------------------
WINCRYPT32API
BOOL WINAPI CertStrToNameW(_In_ DWORD dwCertEncodingType, _In_ LPCWSTR pszX500,
                           _In_ DWORD dwStrType, _Reserved_ void *pvReserved,
                           _Out_writes_bytes_to_opt_(*pcbEncoded, *pcbEncoded)
                               BYTE *pbEncoded,
                           _Inout_ DWORD *pcbEncoded,
...
DWORD
WINAPI
CertGetNameStringA(_In_ PCCERT_CONTEXT pCertContext, _In_ DWORD dwType,
                   _In_ DWORD dwFlags, _In_opt_ void *pvTypePara,
                   _Out_writes_to_opt_(cchNameString, return)
                       LPSTR pszNameString,
...
DWORD
WINAPI
CertGetNameStringW(_In_ PCCERT_CONTEXT pCertContext, _In_ DWORD dwType,
                   _In_ DWORD dwFlags, _In_opt_ void *pvTypePara,
                   _Out_writes_to_opt_(cchNameString, return)
...
typedef PCCERT_CONTEXT(WINAPI *PFN_CRYPT_GET_SIGNER_CERTIFICATE)(
    _Inout_opt_ void *pvGetArg, _In_ DWORD dwCertEncodingType,
...
WINCRYPT32API
BOOL WINAPI
CryptSignMessage(_In_ PCRYPT_SIGN_MESSAGE_PARA pSignPara,
                 _In_ BOOL fDetachedSignature, _In_ DWORD cToBeSigned,
                 _In_reads_opt_(cToBeSigned) const BYTE *rgpbToBeSigned[],
                 _In_reads_(cToBeSigned) DWORD rgcbToBeSigned[],
                 _Out_writes_bytes_to_opt_(*pcbSignedBlob, *pcbSignedBlob)
                     BYTE *pbSignedBlob,
...
BOOL WINAPI CryptVerifyMessageSignature(
    _In_ PCRYPT_VERIFY_MESSAGE_PARA pVerifyPara, _In_ DWORD dwSignerIndex,
...
BOOL WINAPI CryptVerifyDetachedMessageSignature(
    ...
    _In_ DWORD cbDetachedSignBlob, _In_ DWORD cToBeSigned,
...
BOOL WINAPI CryptEncryptMessage(
    _In_ PCRYPT_ENCRYPT_MESSAGE_PARA pEncryptPara, _In_ DWORD cRecipientCert,
    ...
    _Out_writes_bytes_to_opt_(*pcbEncryptedBlob, *pcbEncryptedBlob)
...
BOOL WINAPI CryptSignAndEncryptMessage(
    ...
    _Out_writes_bytes_to_opt_(*pcbSignedAndEncryptedBlob,
...
BOOL WINAPI CryptDecodeMessage(
    ...
    _In_opt_ PCRYPT_VERIFY_MESSAGE_PARA pVerifyPara, _In_ DWORD dwSignerIndex,
    _In_reads_bytes_(cbEncodedBlob) const BYTE *pbEncodedBlob,
    _In_ DWORD cbEncodedBlob, _In_ DWORD dwPrevInnerContentType,
    _Out_opt_ DWORD *pdwMsgType, _Out_opt_ DWORD *pdwInnerContentType,
    _Out_writes_bytes_to_opt_(*pcbDecoded, *pcbDecoded) BYTE *pbDecoded,
    _Inout_opt_ DWORD *pcbDecoded,
    _Outptr_opt_result_maybenull_ PCCERT_CONTEXT *ppXchgCert,
    _Outptr_opt_result_maybenull_ PCCERT_CONTEXT *ppSignerCert);
...
WINCRYPT32API
BOOL WINAPI
CryptHashMessage(_In_ PCRYPT_HASH_MESSAGE_PARA pHashPara,
                 _In_ BOOL fDetachedHash, _In_ DWORD cToBeHashed,
                 _In_reads_(cToBeHashed) const BYTE *rgpbToBeHashed[],
                 _In_reads_(cToBeHashed) DWORD rgcbToBeHashed[],
                 _Out_writes_bytes_to_opt_(*pcbHashedBlob, *pcbHashedBlob)
                     BYTE *pbHashedBlob,
...
BOOL WINAPI CryptVerifyMessageHash(
    ...
    _In_reads_bytes_(cbHashedBlob) BYTE *pbHashedBlob, _In_ DWORD cbHashedBlob,
    _Out_writes_bytes_to_opt_(*pcbToBeHashed, *pcbToBeHashed)
        BYTE *pbToBeHashed,
...
BOOL WINAPI CryptVerifyDetachedMessageHash(
    ...
    _In_ DWORD cbDetachedHashBlob, _In_ DWORD cToBeHashed,
    _In_reads_(cToBeHashed) const BYTE *rgpbToBeHashed[],
    _In_reads_(cToBeHashed) DWORD rgcbToBeHashed[],
    _Out_writes_bytes_to_opt_(*pcbComputedHash, *pcbComputedHash)
        BYTE *pbComputedHash,
...
BOOL WINAPI CryptSignMessageWithKey(_In_ PCRYPT_KEY_SIGN_MESSAGE_PARA pSignPara,
                                    _In_reads_bytes_(cbToBeSigned)
                                        const BYTE *pbToBeSigned,
                                    _In_ DWORD cbToBeSigned,
                                    _Out_writes_bytes_to_opt_(*pcbSignedBlob,
                                                              *pcbSignedBlob)
                                        BYTE *pbSignedBlob,
                                    _Inout_ DWORD *pcbSignedBlob);
...
HCERTSTORE
WINAPI
CertOpenSystemStoreA(_In_opt_ HCRYPTPROV_LEGACY hProv,
                     _In_ LPCSTR szSubsystemProtocol);
WINCRYPT32API
HCERTSTORE
WINAPI
CertOpenSystemStoreW(_In_opt_ HCRYPTPROV_LEGACY hProv,
...
#endif /* WINAPI_FAMILY_PARTITION(WINAPI_PARTITION_APP |                       \
          WINAPI_PARTITION_PHONE_RESTRICTED | WINAPI_PARTITION_SYSTEM |        \
          WINAPI_PARTITION_GAMES) */
#pragma endregion
...
#endif /* WINAPI_FAMILY_PARTITION(WINAPI_PARTITION_DESKTOP                     \
          |WINAPI_PARTITION_PHONE_RESTRICTED | WINAPI_PARTITION_PKG_WINTRUST | \
          WINAPI_PARTITION_GAMES) */
#pragma endregion
...
//                              CERT_QUERY_CONTENT_FLAG_ALL  (the content can be
//                              any type) CERT_QUERY_CONTENT_FLAG_CERT
...
//                        Can be one of the following:
//                              CERT_QUERY_FORMAT_FLAG_ALL (the content can be
//                              any format) CERT_QUERY_FORMAT_FLAG_BINARY
...
//                        Optional output.  If NULL !=
//                        pdwMsgAndCertEncodingType, it contains the encoding
//                        type of the content as any combination of the
//                        following:
//                              X509_ASN_ENCODING
//                              PKCS_7_ASN_ENCODING
//
...
//                        it contains a cert store that includes all of
//                        certificates, CRL, and CTL in the object if the object
...
//                      CERT_QUERY_CONTENT_SERIALIZED_CERT, it is a
//                      PCCERT_CONTEXT; Caller should free the pContext via
//                      CertFreeCertificateContext.
//
//                      If the content type is CERT_QUERY_CONTENT_CRL or
//                      CERT_QUERY_CONTENT_SERIALIZED_CRL, it is a
//                      PCCRL_CONTEXT; Caller should free the pContext via
//                      CertFreeCRLContext.
//
//                      If the content type is CERT_QUERY_CONTENT_CTL or
//                      CERT_QUERY_CONTENT_SERIALIZED_CTL, it is a
//                      PCCTL_CONTEXT; Caller should free the pContext via
//                      CertFreeCTLContext.
//
//  If the *pbObject is of type CERT_QUERY_CONTENT_PKCS10 or
//  CERT_QUERY_CONTENT_PFX, CryptQueryObject will not return anything in
//  *phCertstore, *phMsg, or *ppvContext.
//--------------------------------------------------------------------------
WINCRYPT32API
BOOL WINAPI CryptQueryObject(
    _In_ DWORD dwObjectType, _In_ const void *pvObject,
    _In_ DWORD dwExpectedContentTypeFlags, _In_ DWORD dwExpectedFormatTypeFlags,
    _In_ DWORD dwFlags, _Out_opt_ DWORD *pdwMsgAndCertEncodingType,
    _Out_opt_ DWORD *pdwContentType, _Out_opt_ DWORD *pdwFormatType,
    _Out_opt_ HCERTSTORE *phCertStore, _Out_opt_ HCRYPTMSG *phMsg,
...
LPVOID
WINAPI
CryptMemAlloc(_In_ ULONG cbSize);

WINCRYPT32API
LPVOID
WINAPI
CryptMemRealloc(_In_opt_ LPVOID pv, _In_ ULONG cbSize);
...
typedef VOID(WINAPI *PFN_CRYPT_ASYNC_PARAM_FREE_FUNC)(_In_ LPSTR pszParamOid,
                                                      _In_ LPVOID pvParam);
...
WINCRYPT32API
BOOL WINAPI CryptSetAsyncParam(
    _In_ HCRYPTASYNC hAsync, _In_ LPSTR pszParamOid, _In_opt_ LPVOID pvParam,
    __callback PFN_CRYPT_ASYNC_PARAM_FREE_FUNC pfnFree);

WINCRYPT32API
BOOL WINAPI CryptGetAsyncParam(
    _In_ HCRYPTASYNC hAsync, _In_ LPSTR pszParamOid,
    _Outptr_opt_result_maybenull_ LPVOID *ppvParam,
    _Outptr_opt_result_maybenull_ __callback PFN_CRYPT_ASYNC_PARAM_FREE_FUNC
        *ppfnFree);

WINCRYPT32API
BOOL WINAPI CryptCloseAsyncHandle(_In_opt_ HCRYPTASYNC hAsync);
...
typedef VOID(WINAPI *PFN_FREE_ENCODED_OBJECT_FUNC)(
    _In_opt_ LPCSTR pszObjectOid, _Inout_ PCRYPT_BLOB_ARRAY pObject,
...
//                   _Outptr_ __callback PFN_FREE_ENCODED_OBJECT_FUNC*
//                   ppfnFreeObject, _Outptr_result_maybenull_ LPVOID*
//                   ppvFreeContext, _In_opt_ HCRYPTASYNC hAsyncRetrieve,
...
WINCRYPT32API
_Success_(return == TRUE) BOOL WINAPI
    CryptRetrieveObjectByUrlA(_In_ LPCSTR pszUrl, _In_opt_ LPCSTR pszObjectOid,
                              _In_ DWORD dwRetrievalFlags,
                              _In_ DWORD dwTimeout, // milliseconds
...
WINCRYPT32API
_Success_(return == TRUE) BOOL WINAPI
    CryptRetrieveObjectByUrlW(_In_ LPCWSTR pszUrl, _In_opt_ LPCSTR pszObjectOid,
                              _In_ DWORD dwRetrievalFlags,
                              _In_ DWORD dwTimeout, // milliseconds
                              _Outptr_ LPVOID *ppvObject,
                              _In_opt_ HCRYPTASYNC hAsyncRetrieve,
...
// If CryptInstallCancelRetrieval is called for multiple times, only the most
// recent installation will be kept.
//
// This is only effective for http, https, gopher, and ftp protocol.
// It is ignored by the rest of the protocols.

typedef BOOL(WINAPI *PFN_CRYPT_CANCEL_RETRIEVAL)(_In_ DWORD dwFlags,
                                                 _Inout_opt_ void *pvArg);

//
// PFN_CRYPT_CANCEL_RETRIEVAL
//
// This function should return FALSE when the object retrieval should be
// continued and return TRUE when the object retrieval should be cancelled.
//

WINCRYPT32API
BOOL WINAPI CryptInstallCancelRetrieval(
    __callback PFN_CRYPT_CANCEL_RETRIEVAL pfnCancel, _In_opt_ const void *pvArg,
    _In_ DWORD dwFlags, _Reserved_ void *pvReserved);
...
typedef VOID(WINAPI *PFN_CRYPT_ASYNC_RETRIEVAL_COMPLETION_FUNC)(
    _Inout_opt_ LPVOID pvCompletion, _In_ DWORD dwCompletionCode,
    _In_ LPCSTR pszUrl, _In_opt_ LPSTR pszObjectOid, _In_ LPVOID pvObject);
...
WINCRYPT32API
BOOL WINAPI
CryptGetObjectUrl(_In_ LPCSTR pszUrlOid, _In_ LPVOID pvPara, _In_ DWORD dwFlags,
                  ...
                  _Inout_opt_ DWORD *pcbUrlInfo, _Reserved_ LPVOID pvReserved);
...
WINCRYPT32API
_Success_(return == TRUE) BOOL WINAPI CryptGetTimeValidObject(
    _In_ LPCSTR pszTimeValidOid, _In_ LPVOID pvPara,
    _In_ PCCERT_CONTEXT pIssuer, _In_opt_ LPFILETIME pftValidFor,
    _In_ DWORD dwFlags,
    _In_ DWORD dwTimeout, // milliseconds
    _Outptr_opt_ LPVOID *ppvObject, _In_opt_ PCRYPT_CREDENTIALS pCredentials,
...
//
// By default:
// pKeyProvInfo - The CSP is queried for the KeyProvInfo parameters. Only the
// Provider, Provider Type and Container is queried. Many CSPs don't support
// these queries and will cause a failure. In such cases the pKeyProvInfo must
// be specified (RSA BASE works fine).
//
...
// the CERT_CREATE_SELFSIGN_NO_KEY_INFO in dwFlags.
//
...
// CERT_CREATE_SELFSIGN_NO_SIGN is specified in dwFlags.
//
...
// putting ECC Curve OID vs ECC Curve Parameters in Cert's Public Key
// information's algorithm section:
//      CRYPT_OID_USE_CURVE_NAME_FOR_ENCODE_FLAG
//      CRYPT_OID_USE_CURVE_PARAMETERS_FOR_ENCODE_FLAG
//--------------------------------------------------------------------------
WINCRYPT32API
...
CertCreateSelfSignCertificate(
    _In_opt_ HCRYPTPROV_OR_NCRYPT_KEY_HANDLE hCryptProvOrNCryptKey,
    _In_ PCERT_NAME_BLOB pSubjectIssuerBlob, _In_ DWORD dwFlags,
    _In_opt_ PCRYPT_KEY_PROV_INFO pKeyProvInfo,
    _In_opt_ PCRYPT_ALGORITHM_IDENTIFIER pSignatureAlgorithm,
    _In_opt_ PSYSTEMTIME pStartTime, _In_opt_ PSYSTEMTIME pEndTime,
...
BOOL WINAPI CryptGetKeyIdentifierProperty(
    _In_ const CRYPT_HASH_BLOB *pKeyIdentifier, _In_ DWORD dwPropId,
    _In_ DWORD dwFlags, _In_opt_ LPCWSTR pwszComputerName,
    _Reserved_ void *pvReserved,
    _Out_writes_bytes_to_opt_(*pcbData, *pcbData) void *pvData,
    _Inout_ DWORD *pcbData);
...
BOOL WINAPI CryptSetKeyIdentifierProperty(
    _In_ const CRYPT_HASH_BLOB *pKeyIdentifier, _In_ DWORD dwPropId,
    _In_ DWORD dwFlags, _In_opt_ LPCWSTR pwszComputerName,
    _Reserved_ void *pvReserved, _In_opt_ const void *pvData);
...
typedef BOOL(WINAPI *PFN_CRYPT_ENUM_KEYID_PROP)(
    _In_ const CRYPT_HASH_BLOB *pKeyIdentifier, _In_ DWORD dwFlags,
    _Reserved_ void *pvReserved, _Inout_opt_ void *pvArg, _In_ DWORD cProp,
    _In_reads_(cProp) DWORD *rgdwPropId, _In_reads_(cProp) void **rgpvData,
...
BOOL WINAPI CryptEnumKeyIdentifierProperties(
    _In_opt_ const CRYPT_HASH_BLOB *pKeyIdentifier, _In_ DWORD dwPropId,
    _In_ DWORD dwFlags, _In_opt_ LPCWSTR pwszComputerName,
    _Reserved_ void *pvReserved, _Inout_opt_ void *pvArg,
...
BOOL WINAPI CryptCreateKeyIdentifierFromCSP(
    _In_ DWORD dwCertEncodingType, _In_opt_ LPCSTR pszPubKeyOID,
    _In_reads_bytes_(cbPubKeyStruc) const PUBLICKEYSTRUC *pPubKeyStruc,
    _In_ DWORD cbPubKeyStruc, _In_ DWORD dwFlags, _Reserved_ void *pvReserved,
...
// max size of the object to download, specified by a URL in AIA extention, in
// bytes
...
// CertIsWeakHash() API is called with the Mark-Of-The-Web (CERT_CHAIN_HAS_MOTW)
#define CERT_CHAIN_DISABLE_MOTW_TIMESTAMP_HASH_WEAK_FLAG 0x00008000

#define CERT_CHAIN_DISABLE_WEAK_FLAGS                                          \
  (CERT_CHAIN_DISABLE_ECC_PARA_FLAG | CERT_CHAIN_DISABLE_ALL_EKU_WEAK_FLAG |   \
...
WINCRYPT32API
_Success_(return != FALSE) BOOL WINAPI
    CertCreateCertificateChainEngine(_In_ PCERT_CHAIN_ENGINE_CONFIG pConfig,
...
WINCRYPT32API
VOID WINAPI
CertFreeCertificateChainEngine(_In_opt_ HCERTCHAINENGINE hChainEngine);
...
WINCRYPT32API
BOOL WINAPI
CertResyncCertificateChainEngine(_In_opt_ HCERTCHAINENGINE hChainEngine);
...
WINCRYPT32API
_Success_(return != FALSE) BOOL WINAPI CertGetCertificateChain(
    _In_opt_ HCERTCHAINENGINE hChainEngine, _In_ PCCERT_CONTEXT pCertContext,
    _In_opt_ LPFILETIME pTime, _In_opt_ HCERTSTORE hAdditionalStore,
    _In_ PCERT_CHAIN_PARA pChainPara, _In_ DWORD dwFlags,
    _Reserved_ LPVOID pvReserved, _Out_ PCCERT_CHAIN_CONTEXT *ppChainContext);
...
WINAPI
CertDuplicateCertificateChain(_In_ PCCERT_CHAIN_CONTEXT pChainContext);
...
PCCERT_CHAIN_CONTEXT
WINAPI
CertFindChainInStore(_In_ HCERTSTORE hCertStore, _In_ DWORD dwCertEncodingType,
                     _In_ DWORD dwFindFlags, _In_ DWORD dwFindType,
                     _In_opt_ const void *pvFindPara,
...
typedef BOOL(WINAPI *PFN_CERT_CHAIN_FIND_BY_ISSUER_CALLBACK)(
    _In_ PCCERT_CONTEXT pCert, _Inout_opt_ void *pvFindArg);
...
BOOL WINAPI CertVerifyCertificateChainPolicy(
    _In_ LPCSTR pszPolicyOID, _In_ PCCERT_CHAIN_CONTEXT pChainContext,
...
//
//  CertVerifyCertificateChainPolicy will return a CERT_CHAIN_POLICY_STATUS
//  structure which holds the certificate chain status information from when the
//  certificate chains are validated. The dwError in the returned
//  CERT_CHAIN_POLICY_STATUS will be set to one of three Windows API return code
//  values: S_OK, ERROR_SUCCESS, 0 - Indicates the leaf certificate has a
//  verified SCT extension. E_FAIL - Indicates the leaf certificate doesn't have
//  an SCT extension or is unable to verify. S_FALSE - Same as E_FAIL, however,
//  a non-fatal reason for not finding or being able to verify. For example,
//  code signing certificates that were issued before CA's started adding SCT
//  extension to code signing certificates. The pvExtraPolicyStatus in the
//  CERT_CHAIN_POLICY_STATUS will point to a struct containing more detailed
//  extra error information. The struct will contain the following two fields:
//  LONG lErrorStatus;
//      > 0 : warning - These errors can be ignored. Will map to S_FALSE
//      == 0 : success - Will map to S_OK
//      < 0 : fatal error - These errors shouldn't be ignored. Will map to
//      E_FAIL
//  LONG lErrorSubStatus;
...
// *pdwFlags returns the actual format used in the conversion, optional
//--------------------------------------------------------------------------
_Success_(return) WINCRYPT32STRINGAPI BOOL WINAPI CryptStringToBinaryW(
    _When_(dwFlags != CRYPT_STRING_BINARY, _In_reads_(cchString))
        _When_(dwFlags == CRYPT_STRING_BINARY, _In_reads_bytes_(cchString))
            LPCWSTR pszString,
    _In_ DWORD cchString, _In_ DWORD dwFlags,
...
//--------------------------------------------------------------------------
_Success_(return) WINCRYPT32STRINGAPI BOOL WINAPI
    CryptBinaryToStringA(_In_reads_bytes_(cbBinary) CONST BYTE *pbBinary,
                         _In_ DWORD cbBinary, _In_ DWORD dwFlags,
                         _Out_writes_to_opt_(*pcchString, *pcchString)
                             LPSTR pszString,
...
//--------------------------------------------------------------------------
_Success_(return) WINCRYPT32STRINGAPI BOOL WINAPI
    CryptBinaryToStringW(_In_reads_bytes_(cbBinary) CONST BYTE *pbBinary,
                         _In_ DWORD cbBinary, _In_ DWORD dwFlags,
                         _Out_writes_to_opt_(*pcchString, *pcchString)
                             LPWSTR pszString,
                         _Inout_ DWORD *pcchString);
...
HCERTSTORE
WINAPI
PFXImportCertStore(_In_ CRYPT_DATA_BLOB *pPFX, _In_ LPCWSTR szPassword,
                   _In_ DWORD dwFlags);
...
#define PKCS12_NAMED_NO_PERSIST_KEY                                            \
  0x00020000 // PKCS12_NO_PERSIST_KEY and PKCS12_ALWAYS_CNG_KSP also need to be
             // set
...
BOOL WINAPI PFXVerifyPassword(_In_ CRYPT_DATA_BLOB *pPFX,
                              _In_ LPCWSTR szPassword, _In_ DWORD dwFlags);
...
BOOL WINAPI PFXExportCertStoreEx(_In_ HCERTSTORE hStore,
                                 ...
                                 _In_ LPCWSTR szPassword, _In_ void *pvPara,
                                 _In_ DWORD dwFlags);
...
typedef VOID(CALLBACK *PFN_CERT_SERVER_OCSP_RESPONSE_UPDATE_CALLBACK)(
    ...
    _In_ PCCRL_CONTEXT pNewCrlContext, _In_opt_ PCCRL_CONTEXT pPrevCrlContext,
    _Inout_opt_ PVOID pvArg, _In_ DWORD dwWriteOcspFileError);
...
WINAPI
CertOpenServerOcspResponse(
    _In_ PCCERT_CHAIN_CONTEXT pChainContext, _In_ DWORD dwFlags,
...
//--------------------------------------------------------------------------
WINCRYPT32API
VOID WINAPI CertCloseServerOcspResponse(_In_opt_ HCERT_SERVER_OCSP_RESPONSE
                                            hServerOcspResponse,
                                        _In_ DWORD dwFlags);
...
WINAPI
CertGetServerOcspResponseContext(
    _In_ HCERT_SERVER_OCSP_RESPONSE hServerOcspResponse, _In_ DWORD dwFlags,
    _Reserved_ LPVOID pvReserved);
...
//--------------------------------------------------------------------------
WINCRYPT32API
_Success_(return != FALSE) BOOL WINAPI CertRetrieveLogoOrBiometricInfo(
    _In_ PCCERT_CONTEXT pCertContext, _In_ LPCSTR lpszLogoOrBiometricType,
    _In_ DWORD dwRetrievalFlags,
    _In_ DWORD dwTimeout, // milliseconds
    _In_ DWORD dwFlags, _Reserved_ void *pvReserved,
...
WINCRYPT32API
_Success_(return != FALSE) BOOL WINAPI CertSelectCertificateChains(
    _In_opt_ LPCGUID pSelectionContext, _In_ DWORD dwFlags,
    _In_opt_ PCCERT_SELECT_CHAIN_PARA pChainParameters, _In_ DWORD cCriteria,
    _In_reads_opt_(cCriteria) PCCERT_SELECT_CRITERIA rgpCriteria,
    _In_ HCERTSTORE hStore, _Out_ PDWORD pcSelection,
...
WINCRYPT32API
VOID WINAPI
CertFreeCertificateChainList(_In_ PCCERT_CHAIN_CONTEXT *prgpSelection);
...
typedef struct _CRYPT_TIMESTAMP_REQUEST {
  ...
  DWORD cExtension;
  _Field_size_(cExtension) PCERT_EXTENSION rgExtension; // OPTIONAL
...
typedef struct _CRYPT_TIMESTAMP_RESPONSE {
  ...
  _Field_size_(cFreeText) LPWSTR *rgFreeText;
...
BOOL WINAPI CryptRetrieveTimeStamp(
    _In_ LPCWSTR wszUrl, DWORD dwRetrievalFlags, DWORD dwTimeout,
    _In_ LPCSTR pszHashId, _In_opt_ const CRYPT_TIMESTAMP_PARA *pPara,
    _In_reads_bytes_(cbData) const BYTE *pbData, DWORD cbData,
...
#define TIMESTAMP_VERIFY_CONTEXT_SIGNATURE                                     \
  0x00000020 // CRYPT_VERIFY_CONTEXT_SIGNATURE
...
//
// NOTE:
//    The caller should validate pszTSAPolicyId, if any was specified in the
//    request, and ftTime. The caller should also build a chain for ppTsSigner
//    and validate the trust.
//--------------------------------------------------------------------------

_Success_(return == TRUE) BOOL WINAPI CryptVerifyTimeStampSignature(
    _In_reads_bytes_(cbTSContentInfo) const BYTE *pbTSContentInfo,
    DWORD cbTSContentInfo, _In_reads_bytes_opt_(cbData) const BYTE *pbData,
    DWORD cbData, _In_opt_ HCERTSTORE hAdditionalStore,
    _Outptr_ PCRYPT_TIMESTAMP_CONTEXT *ppTsContext,
    _Outptr_result_maybenull_ PCCERT_CONTEXT *ppTsSigner,
    _Out_opt_ HCERTSTORE *phStore);
...
//    initialize function. The object locator provider must hold onto this
//    context and pass it back into this flush function.
//
...
//    have an identifier then pass in the name. You can pass in NULL which
//    indicates all objects are stale but this is not recommended for
//    performance reasons.
//
// dwIdentifierOrNameListCount
//    Number of names/identifiers in the array. 0 implies that
//    rgIdentifierOrNameList is NULL which means all objects are stale.
//
//--------------------------------------------------------------------------
_Success_(return != 0) typedef BOOL(
    WINAPI *PFN_CRYPT_OBJECT_LOCATOR_PROVIDER_FLUSH)(
...
// the application needs an object. The name blob uniquely identifies the
// content to return. This function can return an identifier data blob.
// Subsequent calls to this function for the same object will pass in the
// identifier that was previously returned. The identifier does not need to
...
//
// pIdentifier
//    This is the identifier that was returned on a previous GET call for this
//    object. On the first call for a particular object it is always NULL.
//
// dwNameType, pNameBlob
//    The name the application is using for the object. The name will uniquely
//    identify an object.
//
...
//--------------------------------------------------------------------------
_Success_(return != 0) typedef BOOL(
    WINAPI *PFN_CRYPT_OBJECT_LOCATOR_PROVIDER_GET)(
    _In_opt_ LPVOID pPluginContext, _In_opt_ PCRYPT_DATA_BLOB pIdentifier,
    _In_ DWORD dwNameType, _In_ PCERT_NAME_BLOB pNameBlob,
    _Outptr_result_bytebuffer_(*pcbContent) PBYTE *ppbContent,
    _Out_ DWORD *pcbContent, _Outptr_result_maybenull_ PCWSTR *ppwszPassword,
...
typedef void(WINAPI *PFN_CRYPT_OBJECT_LOCATOR_PROVIDER_RELEASE)(
    _In_ DWORD dwReason, _In_opt_ LPVOID pPluginContext);
...
typedef void(WINAPI *PFN_CRYPT_OBJECT_LOCATOR_PROVIDER_FREE_PASSWORD)(
    _In_opt_ LPVOID pPluginContext, _In_ PCWSTR pwszPassword);
...
typedef void(WINAPI *PFN_CRYPT_OBJECT_LOCATOR_PROVIDER_FREE)(
    _In_opt_ LPVOID pPluginContext, _In_ PBYTE pbData);
...
typedef void(WINAPI *PFN_CRYPT_OBJECT_LOCATOR_PROVIDER_FREE_IDENTIFIER)(
    _In_opt_ LPVOID pPluginContext, _In_ PCRYPT_DATA_BLOB pIdentifier);

typedef struct _CRYPT_OBJECT_LOCATOR_PROVIDER_TABLE {
  _Field_range_(sizeof(CRYPT_OBJECT_LOCATOR_PROVIDER_TABLE),
                sizeof(CRYPT_OBJECT_LOCATOR_PROVIDER_TABLE)) DWORD cbSize;
...
//
// ppPluginContext
//    Extra information that the provider can return in its initialize call
//    which will be passed back to each of the subsequent callback functions.
//--------------------------------------------------------------------------
_Success_(return != 0) typedef BOOL(
    WINAPI *PFN_CRYPT_OBJECT_LOCATOR_PROVIDER_INITIALIZE)(
    _In_ PFN_CRYPT_OBJECT_LOCATOR_PROVIDER_FLUSH pfnFlush, _In_ LPVOID pContext,
...
WINCRYPT32API
BOOL WINAPI CertIsWeakHash(_In_ DWORD dwHashUseType,
                           _In_ LPCWSTR pwszCNGHashAlgid,
...
typedef WINCRYPT32API BOOL(WINAPI *PFN_CERT_IS_WEAK_HASH)(
    _In_ DWORD dwHashUseType, _In_ LPCWSTR pwszCNGHashAlgid,
    _In_ DWORD dwChainFlags, _In_opt_ PCCERT_CHAIN_CONTEXT pSignerChainContext,
    _In_opt_ LPFILETIME pTimeStamp, _In_opt_ LPCWSTR pwszFileName);
