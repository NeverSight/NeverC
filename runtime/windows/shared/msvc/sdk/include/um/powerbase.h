...
NTSTATUS
WINAPI
CallNtPowerInformation(_In_ POWER_INFORMATION_LEVEL InformationLevel,
...
BOOLEAN
WINAPI
GetPwrCapabilities(_Out_ PSYSTEM_POWER_CAPABILITIES lpspc);

#if (NTDDI_VERSION >= NTDDI_WIN8)
POWER_PLATFORM_ROLE
WINAPI
PowerDeterminePlatformRoleEx(_In_ ULONG Version);
...
DWORD
WINAPI
PowerRegisterSuspendResumeNotification(_In_ DWORD Flags, _In_ HANDLE Recipient,
