...
typedef struct IWorkspaceVtbl {
  ...
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in IWorkspace *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IWorkspace *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IWorkspace *This);
...
interface IWorkspace { CONST_VTBL struct IWorkspaceVtbl *lpVtbl; };
...
#define IWorkspace_AddRef(This) ((This)->lpVtbl->AddRef(This))

#define IWorkspace_Release(This) ((This)->lpVtbl->Release(This))
...
typedef struct IWorkspace2Vtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in IWorkspace2 *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IWorkspace2 *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IWorkspace2 *This);
...
interface IWorkspace2 { CONST_VTBL struct IWorkspace2Vtbl *lpVtbl; };
...
#define IWorkspace2_AddRef(This) ((This)->lpVtbl->AddRef(This))

#define IWorkspace2_Release(This) ((This)->lpVtbl->Release(This))
...
#define IWorkspace2_StartRemoteApplicationEx(                                  \
    This, bstrWorkspaceId, bstrRequestingAppId, bstrRequestingAppFamilyName,   \
    bLaunchIntoImmersiveClient, bstrImmersiveClientActivationContext,          \
    psaParams)                                                                 \
  ((This)->lpVtbl->StartRemoteApplicationEx(                                   \
      This, bstrWorkspaceId, bstrRequestingAppId, bstrRequestingAppFamilyName, \
      bLaunchIntoImmersiveClient, bstrImmersiveClientActivationContext,        \
      psaParams))
...
typedef struct IWorkspace3Vtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in IWorkspace3 *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IWorkspace3 *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IWorkspace3 *This);
...
interface IWorkspace3 { CONST_VTBL struct IWorkspace3Vtbl *lpVtbl; };
...
#define IWorkspace3_AddRef(This) ((This)->lpVtbl->AddRef(This))

#define IWorkspace3_Release(This) ((This)->lpVtbl->Release(This))
...
#define IWorkspace3_StartRemoteApplicationEx(                                  \
    This, bstrWorkspaceId, bstrRequestingAppId, bstrRequestingAppFamilyName,   \
    bLaunchIntoImmersiveClient, bstrImmersiveClientActivationContext,          \
    psaParams)                                                                 \
  ((This)->lpVtbl->StartRemoteApplicationEx(                                   \
...
#define IWorkspace3_GetClaimsToken2(This, bstrClaimsHint, bstrUserHint,        \
                                    claimCookie, hwndCredUiParent,             \
                                    rectCredUiParent, pbstrAccessToken)        \
  ((This)->lpVtbl->GetClaimsToken2(This, bstrClaimsHint, bstrUserHint,         \
                                   claimCookie, hwndCredUiParent,              \
                                   rectCredUiParent, pbstrAccessToken))

#define IWorkspace3_SetClaimsToken(This, bstrAccessToken,                      \
                                   ullAccessTokenExpiration, bstrRefreshToken) \
  ((This)->lpVtbl->SetClaimsToken(This, bstrAccessToken,                       \
                                  ullAccessTokenExpiration, bstrRefreshToken))
...
typedef struct IWorkspaceRegistrationVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IWorkspaceRegistration *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IWorkspaceRegistration *This);
...
#define IWorkspaceRegistration_AddRef(This) ((This)->lpVtbl->AddRef(This))

#define IWorkspaceRegistration_Release(This) ((This)->lpVtbl->Release(This))
...
typedef struct IWorkspaceRegistration2Vtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IWorkspaceRegistration2 *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IWorkspaceRegistration2 *This);
...
#define IWorkspaceRegistration2_AddRef(This) ((This)->lpVtbl->AddRef(This))

#define IWorkspaceRegistration2_Release(This) ((This)->lpVtbl->Release(This))
...
#define IWorkspaceRegistration2_AddResourceEx(                                 \
    This, pUnk, bstrEventLogUploadAddress, pdwCookie, correlationId)           \
  ((This)->lpVtbl->AddResourceEx(This, pUnk, bstrEventLogUploadAddress,        \
                                 pdwCookie, correlationId))

#define IWorkspaceRegistration2_RemoveResourceEx(This, dwCookieConnection,     \
                                                 correlationId)                \
...
typedef struct IWorkspaceScriptableVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IWorkspaceScriptable *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IWorkspaceScriptable *This);
  ...
  /* [helpstring][id] */ HRESULT(
      STDMETHODCALLTYPE *IsWorkspaceCredentialSpecified)(
      __RPC__in IWorkspaceScriptable *This,
      /* [in] */ __RPC__in BSTR bstrWorkspaceId,
      /* [in] */ VARIANT_BOOL bCountUnauthenticatedCredentials,
  ...
  /* [helpstring][id] */ HRESULT(
      STDMETHODCALLTYPE *DisconnectWorkspaceByFriendlyName)(
      __RPC__in IWorkspaceScriptable *This,
...
#define IWorkspaceScriptable_AddRef(This) ((This)->lpVtbl->AddRef(This))

#define IWorkspaceScriptable_Release(This) ((This)->lpVtbl->Release(This))
...
#define IWorkspaceScriptable_GetIDsOfNames(This, riid, rgszNames, cNames,      \
                                           lcid, rgDispId)                     \
  ((This)->lpVtbl->GetIDsOfNames(This, riid, rgszNames, cNames, lcid, rgDispId))

#define IWorkspaceScriptable_Invoke(This, dispIdMember, riid, lcid, wFlags,    \
...
#define IWorkspaceScriptable_StartWorkspace(                                   \
    This, bstrWorkspaceId, bstrUserName, bstrPassword, bstrWorkspaceParams,    \
    lTimeout, lFlags)                                                          \
  ((This)->lpVtbl->StartWorkspace(This, bstrWorkspaceId, bstrUserName,         \
                                  bstrPassword, bstrWorkspaceParams, lTimeout, \
                                  lFlags))

#define IWorkspaceScriptable_IsWorkspaceCredentialSpecified(                   \
    This, bstrWorkspaceId, bCountUnauthenticatedCredentials, pbCredExist)      \
  ((This)->lpVtbl->IsWorkspaceCredentialSpecified(                             \
      This, bstrWorkspaceId, bCountUnauthenticatedCredentials, pbCredExist))
...
#define IWorkspaceScriptable_OnAuthenticated(This, bstrWorkspaceId,            \
                                             bstrUserName)                     \
  ((This)->lpVtbl->OnAuthenticated(This, bstrWorkspaceId, bstrUserName))

#define IWorkspaceScriptable_DisconnectWorkspaceByFriendlyName(                \
    This, bstrWorkspaceFriendlyName)                                           \
  ((This)->lpVtbl->DisconnectWorkspaceByFriendlyName(                          \
      This, bstrWorkspaceFriendlyName))
...
typedef struct IWorkspaceScriptable2Vtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IWorkspaceScriptable2 *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IWorkspaceScriptable2 *This);
...
#define IWorkspaceScriptable2_AddRef(This) ((This)->lpVtbl->AddRef(This))

#define IWorkspaceScriptable2_Release(This) ((This)->lpVtbl->Release(This))
...
#define IWorkspaceScriptable2_GetIDsOfNames(This, riid, rgszNames, cNames,     \
                                            lcid, rgDispId)                    \
  ((This)->lpVtbl->GetIDsOfNames(This, riid, rgszNames, cNames, lcid, rgDispId))

#define IWorkspaceScriptable2_Invoke(This, dispIdMember, riid, lcid, wFlags,   \
                                     pDispParams, pVarResult, pExcepInfo,      \
                                     puArgErr)                                 \
  ((This)->lpVtbl->Invoke(This, dispIdMember, riid, lcid, wFlags, pDispParams, \
                          pVarResult, pExcepInfo, puArgErr))
...
#define IWorkspaceScriptable2_StartWorkspace(                                  \
    This, bstrWorkspaceId, bstrUserName, bstrPassword, bstrWorkspaceParams,    \
    lTimeout, lFlags)                                                          \
  ((This)->lpVtbl->StartWorkspace(This, bstrWorkspaceId, bstrUserName,         \
                                  bstrPassword, bstrWorkspaceParams, lTimeout, \
...
#define IWorkspaceScriptable2_IsWorkspaceCredentialSpecified(                  \
    This, bstrWorkspaceId, bCountUnauthenticatedCredentials, pbCredExist)      \
  ((This)->lpVtbl->IsWorkspaceCredentialSpecified(                             \
      This, bstrWorkspaceId, bCountUnauthenticatedCredentials, pbCredExist))
...
#define IWorkspaceScriptable2_OnAuthenticated(This, bstrWorkspaceId,           \
                                              bstrUserName)                    \
  ((This)->lpVtbl->OnAuthenticated(This, bstrWorkspaceId, bstrUserName))

#define IWorkspaceScriptable2_DisconnectWorkspaceByFriendlyName(               \
    This, bstrWorkspaceFriendlyName)                                           \
  ((This)->lpVtbl->DisconnectWorkspaceByFriendlyName(                          \
      This, bstrWorkspaceFriendlyName))

#define IWorkspaceScriptable2_StartWorkspaceEx(                                \
    This, bstrWorkspaceId, bstrWorkspaceFriendlyName, bstrRedirectorName,      \
    bstrUserName, bstrPassword, bstrAppContainer, bstrWorkspaceParams,         \
    lTimeout, lFlags)                                                          \
  ((This)->lpVtbl->StartWorkspaceEx(                                           \
      This, bstrWorkspaceId, bstrWorkspaceFriendlyName, bstrRedirectorName,    \
      bstrUserName, bstrPassword, bstrAppContainer, bstrWorkspaceParams,       \
      lTimeout, lFlags))

#define IWorkspaceScriptable2_ResourceDismissed(This, bstrWorkspaceId,         \
                                                bstrWorkspaceFriendlyName)     \
  ((This)->lpVtbl->ResourceDismissed(This, bstrWorkspaceId,                    \
                                     bstrWorkspaceFriendlyName))
...
typedef struct IWorkspaceScriptable3Vtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IWorkspaceScriptable3 *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IWorkspaceScriptable3 *This);
...
#define IWorkspaceScriptable3_AddRef(This) ((This)->lpVtbl->AddRef(This))

#define IWorkspaceScriptable3_Release(This) ((This)->lpVtbl->Release(This))
...
#define IWorkspaceScriptable3_GetIDsOfNames(This, riid, rgszNames, cNames,     \
                                            lcid, rgDispId)                    \
  ((This)->lpVtbl->GetIDsOfNames(This, riid, rgszNames, cNames, lcid, rgDispId))

#define IWorkspaceScriptable3_Invoke(This, dispIdMember, riid, lcid, wFlags,   \
                                     pDispParams, pVarResult, pExcepInfo,      \
                                     puArgErr)                                 \
  ((This)->lpVtbl->Invoke(This, dispIdMember, riid, lcid, wFlags, pDispParams, \
                          pVarResult, pExcepInfo, puArgErr))
...
#define IWorkspaceScriptable3_StartWorkspace(                                  \
    This, bstrWorkspaceId, bstrUserName, bstrPassword, bstrWorkspaceParams,    \
    lTimeout, lFlags)                                                          \
  ((This)->lpVtbl->StartWorkspace(This, bstrWorkspaceId, bstrUserName,         \
                                  bstrPassword, bstrWorkspaceParams, lTimeout, \
...
#define IWorkspaceScriptable3_IsWorkspaceCredentialSpecified(                  \
    This, bstrWorkspaceId, bCountUnauthenticatedCredentials, pbCredExist)      \
  ((This)->lpVtbl->IsWorkspaceCredentialSpecified(                             \
      This, bstrWorkspaceId, bCountUnauthenticatedCredentials, pbCredExist))
...
#define IWorkspaceScriptable3_OnAuthenticated(This, bstrWorkspaceId,           \
                                              bstrUserName)                    \
  ((This)->lpVtbl->OnAuthenticated(This, bstrWorkspaceId, bstrUserName))

#define IWorkspaceScriptable3_DisconnectWorkspaceByFriendlyName(               \
    This, bstrWorkspaceFriendlyName)                                           \
  ((This)->lpVtbl->DisconnectWorkspaceByFriendlyName(                          \
      This, bstrWorkspaceFriendlyName))

#define IWorkspaceScriptable3_StartWorkspaceEx(                                \
    This, bstrWorkspaceId, bstrWorkspaceFriendlyName, bstrRedirectorName,      \
    bstrUserName, bstrPassword, bstrAppContainer, bstrWorkspaceParams,         \
    lTimeout, lFlags)                                                          \
  ((This)->lpVtbl->StartWorkspaceEx(                                           \
...
#define IWorkspaceScriptable3_ResourceDismissed(This, bstrWorkspaceId,         \
                                                bstrWorkspaceFriendlyName)     \
  ((This)->lpVtbl->ResourceDismissed(This, bstrWorkspaceId,                    \
                                     bstrWorkspaceFriendlyName))

#define IWorkspaceScriptable3_StartWorkspaceEx2(                               \
    This, bstrWorkspaceId, bstrWorkspaceFriendlyName, bstrRedirectorName,      \
    bstrUserName, bstrPassword, bstrAppContainer, bstrWorkspaceParams,         \
    lTimeout, lFlags, bstrEventLogUploadAddress, correlationId)                \
  ((This)->lpVtbl->StartWorkspaceEx2(                                          \
      This, bstrWorkspaceId, bstrWorkspaceFriendlyName, bstrRedirectorName,    \
      bstrUserName, bstrPassword, bstrAppContainer, bstrWorkspaceParams,       \
      lTimeout, lFlags, bstrEventLogUploadAddress, correlationId))
...
typedef struct IWorkspaceReportMessageVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IWorkspaceReportMessage *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IWorkspaceReportMessage *This);
...
#define IWorkspaceReportMessage_AddRef(This) ((This)->lpVtbl->AddRef(This))

#define IWorkspaceReportMessage_Release(This) ((This)->lpVtbl->Release(This))
...
#define IWorkspaceReportMessage_IsErrorMessageRegistered(                      \
    This, bstrWkspId, dwErrorType, bstrErrorMessageType, dwErrorCode,          \
    pfErrorExist)                                                              \
  ((This)->lpVtbl->IsErrorMessageRegistered(This, bstrWkspId, dwErrorType,     \
                                            bstrErrorMessageType, dwErrorCode, \
                                            pfErrorExist))

#define IWorkspaceReportMessage_RegisterErrorEvent(                            \
    This, bstrWkspId, dwErrorType, bstrErrorMessageType, dwErrorCode)          \
  ((This)->lpVtbl->RegisterErrorEvent(This, bstrWkspId, dwErrorType,           \
                                      bstrErrorMessageType, dwErrorCode))
...
typedef struct _ITSWkspEventsVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in _ITSWkspEvents *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in _ITSWkspEvents *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in _ITSWkspEvents *This);
...
interface _ITSWkspEvents { CONST_VTBL struct _ITSWkspEventsVtbl *lpVtbl; };
...
#define _ITSWkspEvents_AddRef(This) ((This)->lpVtbl->AddRef(This))

#define _ITSWkspEvents_Release(This) ((This)->lpVtbl->Release(This))
...
#define _ITSWkspEvents_GetIDsOfNames(This, riid, rgszNames, cNames, lcid,      \
                                     rgDispId)                                 \
  ((This)->lpVtbl->GetIDsOfNames(This, riid, rgszNames, cNames, lcid, rgDispId))

#define _ITSWkspEvents_Invoke(This, dispIdMember, riid, lcid, wFlags,          \
...
class DECLSPEC_UUID("4F1DFCA6-3AAD-48E1-8406-4BC21A501D7C") Workspace;
#endif
