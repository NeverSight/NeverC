...
//========================================================================================================
// This is the standard DDI that any DXGI-enabled user-mode driver should
// support
//
...
typedef enum DXGI_DDI_FLIP_INTERVAL_TYPE {
  ...
  // For the sync interval override in the present callbacks, IMMEDIATE means
  // the API semantic of sync interval 0, where IMMEDIATE_ALLOW_TEARING is
  // equivalent to the addition of the ALLOW_TEARING API flags.
...
typedef struct DXGI_DDI_ARG_PRESENT {
  ...
  DXGI_DDI_HRESOURCE
  hDstResource;             // if non-zero, it's the destination of the present
...
typedef struct DXGI_DDI_ARG_ROTATE_RESOURCE_IDENTITIES {
  DXGI_DDI_HDEVICE hDevice;             // in
  CONST DXGI_DDI_HRESOURCE *pResources; // in: Array of Resources to rotate
                                        // identities; 0 <= 1, 1 <= 2, etc.
  UINT Resources;
...
//          Horizontal frequencies are stored in KHz. The dynamic range of this
//          encoding format, given 10^-7 resolution is {0..(2^32 - 1) / 10^7},
//          which translates to {0..428.4967296} [Hz] for vertical frequencies
//          and {0..428.4967296} [KHz] for horizontal frequencies. This
...
// Bit indicates that UMD has the option to prevent this Resource from ever
// being a Primary UMD can prevent the actual flip (from optional primary to
// regular primary) and use a copy operation, during Present. Thus, it's
// possible the UMD can opt out of this Resource being actually used as a
// primary.
#define DXGI_DDI_PRIMARY_OPTIONAL 0x1

// Bit indicates that the Primary really represents the IDENTITY rotation,
// eventhough it will be used with non-IDENTITY display modes, since the
// application will take on the burden of honoring the output orientation by
// rotating, say the viewport and projection matrix.
...
// Bit indicates that the driver cannot tolerate setting any subresource of the
// specified resource as a primary. The UMD should set this bit at resource
// creation time if it chooses to implement presentation from this surface via a
// copy operation. The DXGI runtime will not employ flip-style presentation if
// this bit is set
...
typedef struct _DXGI_DDI_ARG_OFFERRESOURCES {
  ...
  Priority; // in:  priority with which to reset the resources
...
typedef struct DXGI_DDI_MULTIPLANE_OVERLAY_CAPS {
  UINT MaxPlanes; // Total number of planes supported (including the DWM's
                  // primary)
...
typedef enum DXGI_DDI_MULTIPLANE_OVERLAY_FEATURE_CAPS {
  ...
  DXGI_DDI_MULTIPLANE_OVERLAY_FEATURE_CAPS_BILINEAR_FILTER =
      0x80, // Can do bilinear stretching
  DXGI_DDI_MULTIPLANE_OVERLAY_FEATURE_CAPS_HIGH_FILTER =
      0x100, // Can do better than bilinear stretching
...
typedef struct _DXGI_DDI_ARG_OFFERRESOURCES1 {
  ...
  _In_reads_(Resources) const
      DXGI_DDI_HRESOURCE *pResources; // in:  array of resources to reset
  _In_ UINT Resources;                // in:  number of elements in pResources
  _In_ D3DDDI_OFFER_PRIORITY
      Priority; // in:  priority with which to reset the resources
  _In_ D3DDDI_OFFER_FLAGS
      Flags; // in:  flags specifying additional behaviors on offer
...
typedef struct _DXGI_DDI_ARG_RECLAIMRESOURCES1 {
  ...
  *pResults; // out: array of results specifying whether each resource was
...
typedef struct DXGI1_6_1_DDI_ARG_PRESENT {
  ...
  DXGI_DDI_FLIP_INTERVAL_TYPE FlipInterval; // Presentation interval (flip only)
  DXGI_DDI_MODE_ROTATION
  RotationHint; // in: Hint that the contents of the frame are rotated with
                // respect to scanout.
  CONST RECT *pDirtyRects; // in: Array of dirty rects
  UINT DirtyRects;         // in: Number of dirty rects
...
typedef struct DXGI_DDI_BASE_FUNCTIONS {
  ...
  HRESULT(__stdcall /*APIENTRY*/ *pfnGetGammaCaps)(
      DXGI_DDI_ARG_GET_GAMMA_CONTROL_CAPS *);
  HRESULT(__stdcall /*APIENTRY*/ *pfnSetDisplayMode)(
      DXGI_DDI_ARG_SETDISPLAYMODE *);
  HRESULT(__stdcall /*APIENTRY*/ *pfnSetResourcePriority)(
      DXGI_DDI_ARG_SETRESOURCEPRIORITY *);
  HRESULT(__stdcall /*APIENTRY*/ *pfnQueryResourceResidency)(
      DXGI_DDI_ARG_QUERYRESOURCERESIDENCY *);
...
typedef struct DXGI1_1_DDI_BASE_FUNCTIONS {
  ...
  HRESULT(__stdcall /*APIENTRY*/ *pfnRotateResourceIdentities)(
      DXGI_DDI_ARG_ROTATE_RESOURCE_IDENTITIES *);
  HRESULT(__stdcall /*APIENTRY*/ *pfnBlt)(DXGI_DDI_ARG_BLT *);
  HRESULT(__stdcall /*APIENTRY*/ *pfnResolveSharedResource)(
      DXGI_DDI_ARG_RESOLVESHAREDRESOURCE *);
...
typedef struct DXGI1_2_DDI_BASE_FUNCTIONS {
  ...
  HRESULT(__stdcall /*APIENTRY*/ *pfnOfferResources)(
      DXGI_DDI_ARG_OFFERRESOURCES *);
  HRESULT(__stdcall /*APIENTRY*/ *pfnReclaimResources)(
      DXGI_DDI_ARG_RECLAIMRESOURCES *);
  // Use IS_DXGI_MULTIPLANE_OVERLAY_FUNCTIONS macro to determine these functions
  // fields are available
  HRESULT(__stdcall /*APIENTRY*/ *pfnGetMultiplaneOverlayCaps)(
      DXGI_DDI_ARG_GETMULTIPLANEOVERLAYCAPS *);
  HRESULT(__stdcall /*APIENTRY*/ *pfnGetMultiplaneOverlayFilterRange)(void *);
  HRESULT(__stdcall /*APIENTRY*/ *pfnCheckMultiplaneOverlaySupport)(
      DXGI_DDI_ARG_CHECKMULTIPLANEOVERLAYSUPPORT *);
  HRESULT(__stdcall /*APIENTRY*/ *pfnPresentMultiplaneOverlay)(
      DXGI_DDI_ARG_PRESENTMULTIPLANEOVERLAY *);
...
typedef struct DXGI1_3_DDI_BASE_FUNCTIONS {
  ...
  HRESULT(__stdcall /*APIENTRY*/ *pfnGetMultiplaneOverlayCaps)(
      DXGI_DDI_ARG_GETMULTIPLANEOVERLAYCAPS *);
  HRESULT(__stdcall /*APIENTRY*/ *pfnGetMultiplaneOverlayGroupCaps)(
      DXGI_DDI_ARG_GETMULTIPLANEOVERLAYGROUPCAPS *);
  ...
  HRESULT(__stdcall /*APIENTRY*/ *pfnCheckPresentDurationSupport)(
      DXGI_DDI_ARG_CHECKPRESENTDURATIONSUPPORT *);
...
typedef struct DXGI1_4_DDI_BASE_FUNCTIONS {
  ...
  HRESULT(__stdcall /*APIENTRY*/ *pfnCheckPresentDurationSupport)(
      DXGI_DDI_ARG_CHECKPRESENTDURATIONSUPPORT *);
  HRESULT(__stdcall /*APIENTRY*/ *pfnTrimResidencySet)(
      DXGI_DDI_ARG_TRIMRESIDENCYSET *);
  HRESULT(__stdcall /*APIENTRY*/ *pfnCheckMultiplaneOverlayColorSpaceSupport)(
      DXGI_DDI_ARG_CHECKMULTIPLANEOVERLAYCOLORSPACESUPPORT *);
  HRESULT(__stdcall /*APIENTRY*/ *pfnPresentMultiplaneOverlay1)(
      DXGI_DDI_ARG_PRESENTMULTIPLANEOVERLAY1 *);
...
typedef struct DXGI1_5_DDI_BASE_FUNCTIONS {
  ...
  HRESULT(__stdcall /*APIENTRY*/ *pfnResolveSharedResource)(
      DXGI_DDI_ARG_RESOLVESHAREDRESOURCE *);
  HRESULT(__stdcall /*APIENTRY*/ *pfnBlt1)(DXGI_DDI_ARG_BLT1 *);
  HRESULT(__stdcall /*APIENTRY*/ *pfnOfferResources1)(
      DXGI_DDI_ARG_OFFERRESOURCES1 *);
  HRESULT(__stdcall /*APIENTRY*/ *pfnReclaimResources)(
      DXGI_DDI_ARG_RECLAIMRESOURCES *);
  HRESULT(__stdcall /*APIENTRY*/ *pfnGetMultiplaneOverlayCaps)(
...
typedef struct DXGIDDICB_PRESENT {
  ...
  D3DKMT_HANDLE hDstAllocation; // in: if non-zero, it's the destination
                                // allocation of the present
  void *pDXGIContext;           // opaque: Fill this with the value in
                                // DXGI_DDI_ARG_PRESENT.pDXGIContext
  ...
  HANDLE BroadcastContext[D3DDDI_MAX_BROADCAST_CONTEXT]; // in: Specifies the
                                                         // handle of the
                                                         // context to
                                                         //     broadcast to.
#if (D3D_UMD_INTERFACE_VERSION >= D3D_UMD_INTERFACE_VERSION_WDDM2_0)
  ...
  _Field_size_bytes_(PrivateDriverDataSize) PVOID
      pPrivateDriverData; // in: Private driver data to pass to DdiPresent and
                          // DdiSetVidPnSourceAddress
...
typedef struct DXGIDDI_MULTIPLANE_OVERLAY_PLANE_INFO {
  UINT ContextCount;
  _Field_size_(ContextCount) HANDLE *pContextList;
  _Field_size_(ContextCount) D3DKMT_HANDLE *pAllocationList;

  UINT DriverPrivateDataSize;
  _Field_size_bytes_(DriverPrivateDataSize) VOID *pDriverPrivateData;
...
typedef struct DXGIDDICB_SUBMITPRESENTBLTTOHWQUEUE {
  ...
  UINT64 HwQueueProgressFenceId; // Hardware queue progress fence ID that will
                                 // be signaled when the Present Blt is done on
                                 // the GPU
...
typedef struct DXGIDDICB_SUBMITPRESENTTOHWQUEUE {
  ...
  _Field_size_(BroadcastHwQueueCount)
      D3DKMT_HANDLE *BroadcastSrcAllocations; // in: allocations which content
                                              // will be presented
  _Field_size_opt_(BroadcastHwQueueCount) D3DKMT_HANDLE
      *BroadcastDstAllocations; // in: if non-zero, it's the destination
                                // allocations of the present
...
HRESULT(APIENTRY CALLBACK *PFNDDXGIDDI_PRESENTCB)(_In_ HANDLE hDevice,
                                                  _In_ DXGIDDICB_PRESENT *);

#if (D3D_UMD_INTERFACE_VERSION >= D3D_UMD_INTERFACE_VERSION_WIN8)
typedef _Check_return_
HRESULT(APIENTRY CALLBACK *PFNDDXGIDDI_PRESENT_MULTIPLANE_OVERLAYCB)(
    _In_ HANDLE hDevice, _In_ CONST DXGIDDICB_PRESENT_MULTIPLANE_OVERLAY *);
#endif // (D3D_UMD_INTERFACE_VERSION >= D3D_UMD_INTERFACE_VERSION_WIN8)

#if (D3D_UMD_INTERFACE_VERSION >= D3D_UMD_INTERFACE_VERSION_WDDM2_2_1)
typedef _Check_return_
HRESULT(APIENTRY CALLBACK *PFNDDXGIDDI_PRESENT_MULTIPLANE_OVERLAY1CB)(
...
typedef _Check_return_
HRESULT(APIENTRY CALLBACK *PFNDDXGIDDI_SUBMITPRESENTBLTTOHWQUEUECB)(
...
typedef _Check_return_
HRESULT(APIENTRY CALLBACK *PFNDDXGIDDI_SUBMITPRESENTTOHWQUEUECB)(
...
#if (D3D_UMD_INTERFACE_VERSION >= D3D_UMD_INTERFACE_VERSION_WIN8)
  // Use IS_DXGI_MULTIPLANE_OVERLAY_FUNCTIONS macro to check if field is
  // available.
...
typedef struct DXGI_DDI_BASE_ARGS {
  DXGI_DDI_BASE_CALLBACKS *pDXGIBaseCallbacks; // in: The driver should record
                                               // this pointer for later use
  union {
#if (D3D_UMD_INTERFACE_VERSION >= D3D_UMD_INTERFACE_VERSION_WDDM2_2_2)
    DXGI1_6_1_DDI_BASE_FUNCTIONS
    *pDXGIDDIBaseFunctions6_1; // in/out: The driver should fill the denoted
                               // struct with DXGI base driver entry points
#endif
#if (D3D_UMD_INTERFACE_VERSION >= D3D_UMD_INTERFACE_VERSION_WDDM2_1_1)
    DXGI1_5_DDI_BASE_FUNCTIONS
    *pDXGIDDIBaseFunctions6; // in/out: The driver should fill the denoted
                             // struct with DXGI base driver entry points
#endif
#if (D3D_UMD_INTERFACE_VERSION >= D3D_UMD_INTERFACE_VERSION_WDDM2_0)
    DXGI1_4_DDI_BASE_FUNCTIONS
    *pDXGIDDIBaseFunctions5; // in/out: The driver should fill the denoted
                             // struct with DXGI base driver entry points
#endif
#if (D3D_UMD_INTERFACE_VERSION >= D3D_UMD_INTERFACE_VERSION_WDDM1_3) // M1
    DXGI1_3_DDI_BASE_FUNCTIONS
    *pDXGIDDIBaseFunctions4; // in/out: The driver should fill the denoted
                             // struct with DXGI base driver entry points
#endif
#if (D3D_UMD_INTERFACE_VERSION >= D3D_UMD_INTERFACE_VERSION_WIN8)
    DXGI1_2_DDI_BASE_FUNCTIONS
    *pDXGIDDIBaseFunctions3; // in/out: The driver should fill the denoted
                             // struct with DXGI base driver entry points
#endif
    DXGI1_1_DDI_BASE_FUNCTIONS
    *pDXGIDDIBaseFunctions2; // in/out: The driver should fill the denoted
                             // struct with DXGI base driver entry points
    DXGI_DDI_BASE_FUNCTIONS
    *pDXGIDDIBaseFunctions; // in/out: The driver should fill the denoted
                            // struct with DXGI base driver entry points
  };
} DXGI_DDI_BASE_ARGS;
