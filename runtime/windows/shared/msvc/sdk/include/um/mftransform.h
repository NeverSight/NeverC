...
enum _MFT_DRAIN_TYPE { MFT_DRAIN_PRODUCE_TAILS = 0, MFT_DRAIN_NO_TAILS = 0x1 };
...
//
// redefine all the method names to have MFT at the beginning so they don't
// class with DMO methods.
//
...
public:
  ...
  virtual HRESULT STDMETHODCALLTYPE GetStreamIDs(
      ...
      /* [size_is][out] */ __RPC__out_ecount_full(dwInputIDArraySize) DWORD *
          pdwInputIDs,
      DWORD dwOutputIDArraySize,
      /* [size_is][out] */ __RPC__out_ecount_full(dwOutputIDArraySize) DWORD *
          pdwOutputIDs) = 0;
  ...
  virtual HRESULT STDMETHODCALLTYPE SetOutputBounds(LONGLONG hnsLowerBound,
  ...
  virtual HRESULT STDMETHODCALLTYPE ProcessMessage(MFT_MESSAGE_TYPE eMessage,
                                                   ULONG_PTR ulParam) = 0;

  virtual /* [local] */ HRESULT STDMETHODCALLTYPE ProcessInput(
      DWORD dwInputStreamID, IMFSample * pSample, DWORD dwFlags) = 0;
...
typedef struct IMFTransformVtbl {
  ...
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in IMFTransform *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IMFTransform *This);
  ...
  HRESULT(STDMETHODCALLTYPE *GetStreamIDs)(
      __RPC__in IMFTransform *This, DWORD dwInputIDArraySize,
      /* [size_is][out] */
  ...
  HRESULT(STDMETHODCALLTYPE *GetInputStreamInfo)(
      __RPC__in IMFTransform *This, DWORD dwInputStreamID,
  ...
  HRESULT(STDMETHODCALLTYPE *GetOutputStreamInfo)(
      __RPC__in IMFTransform *This, DWORD dwOutputStreamID,
  ...
  HRESULT(STDMETHODCALLTYPE *DeleteInputStream)(__RPC__in IMFTransform *This,
                                                DWORD dwStreamID);

  DECLSPEC_XFGVIRT(IMFTransform, AddInputStreams)
  HRESULT(STDMETHODCALLTYPE *AddInputStreams)(
      __RPC__in IMFTransform *This, DWORD cStreams,
  ...
  HRESULT(STDMETHODCALLTYPE *GetInputAvailableType)(
      __RPC__in IMFTransform *This, DWORD dwInputStreamID, DWORD dwTypeIndex,
  ...
  HRESULT(STDMETHODCALLTYPE *GetOutputAvailableType)(
      __RPC__in IMFTransform *This, DWORD dwOutputStreamID, DWORD dwTypeIndex,
      /* [out] */ __RPC__deref_out_opt IMFMediaType **ppType);

  DECLSPEC_XFGVIRT(IMFTransform, SetInputType)
  HRESULT(STDMETHODCALLTYPE *SetInputType)(
      __RPC__in IMFTransform *This, DWORD dwInputStreamID,
      /* [in] */ __RPC__in_opt IMFMediaType *pType, DWORD dwFlags);
  ...
  HRESULT(STDMETHODCALLTYPE *SetOutputBounds)(__RPC__in IMFTransform *This,
  ...
  HRESULT(STDMETHODCALLTYPE *ProcessMessage)(__RPC__in IMFTransform *This,
                                             MFT_MESSAGE_TYPE eMessage,
                                             ULONG_PTR ulParam);

  DECLSPEC_XFGVIRT(IMFTransform, ProcessInput)
  /* [local] */ HRESULT(STDMETHODCALLTYPE *ProcessInput)(IMFTransform *This,
                                                         DWORD dwInputStreamID,
                                                         IMFSample *pSample,
                                                         DWORD dwFlags);
...
interface IMFTransform { CONST_VTBL struct IMFTransformVtbl *lpVtbl; };
...
#define IMFTransform_GetStreamLimits(This, pdwInputMinimum, pdwInputMaximum,   \
                                     pdwOutputMinimum, pdwOutputMaximum)       \
  ((This)->lpVtbl->GetStreamLimits(This, pdwInputMinimum, pdwInputMaximum,     \
                                   pdwOutputMinimum, pdwOutputMaximum))
...
#define IMFTransform_GetStreamIDs(This, dwInputIDArraySize, pdwInputIDs,       \
                                  dwOutputIDArraySize, pdwOutputIDs)           \
  ((This)->lpVtbl->GetStreamIDs(This, dwInputIDArraySize, pdwInputIDs,         \
                                dwOutputIDArraySize, pdwOutputIDs))
...
#define IMFTransform_GetInputStreamAttributes(This, dwInputStreamID,           \
                                              pAttributes)                     \
  ((This)->lpVtbl->GetInputStreamAttributes(This, dwInputStreamID, pAttributes))

#define IMFTransform_GetOutputStreamAttributes(This, dwOutputStreamID,         \
                                               pAttributes)                    \
  ((This)->lpVtbl->GetOutputStreamAttributes(This, dwOutputStreamID,           \
                                             pAttributes))
...
#define IMFTransform_GetInputAvailableType(This, dwInputStreamID, dwTypeIndex, \
                                           ppType)                             \
  ((This)->lpVtbl->GetInputAvailableType(This, dwInputStreamID, dwTypeIndex,   \
                                         ppType))

#define IMFTransform_GetOutputAvailableType(This, dwOutputStreamID,            \
                                            dwTypeIndex, ppType)               \
  ((This)->lpVtbl->GetOutputAvailableType(This, dwOutputStreamID, dwTypeIndex, \
                                          ppType))
...
#define IMFTransform_ProcessOutput(This, dwFlags, cOutputBufferCount,          \
                                   pOutputSamples, pdwStatus)                  \
...
EXTERN_GUID(MEDeviceStreamCreated, 0x0252a1cf, 0x3540, 0x43b4, 0x91, 0x64, 0xd7,
            0x2e, 0xb4, 0x05, 0xfa, 0x40);
...
#if WINAPI_FAMILY_PARTITION(WINAPI_PARTITION_APP | WINAPI_PARTITION_GAMES)
//
// Define the MFT methods back so we don't accidentally hose the IMediaObject
// interface.
//
#ifdef MFT_UNIQUE_METHOD_NAMES
...
EXTERN_C const DECLSPEC_SELECTANY PROPERTYKEY MFPKEY_CLSID = {
    {0xc57a84c0,
     0x1a80,
     0x40a3,
     {0x97, 0xb5, 0x92, 0x72, 0xa4, 0x3, 0xc8, 0xae}},
    0x01};
...
EXTERN_C const DECLSPEC_SELECTANY PROPERTYKEY MFPKEY_EXATTRIBUTE_SUPPORTED = {
    {0x456fe843,
     0x3c87,
     0x40c0,
     {0x94, 0x9d, 0x14, 0x9, 0xc9, 0x7d, 0xab, 0x2c}},
    0x01};
EXTERN_C const DECLSPEC_SELECTANY PROPERTYKEY MFPKEY_MULTICHANNEL_CHANNEL_MASK =
    {{0x58bdaf8c,
      0x3224,
      0x4692,
      {0x86, 0xd0, 0x44, 0xd6, 0x5c, 0x5b, 0xf8, 0x2b}},
     0x01};
EXTERN_C const DECLSPEC_SELECTANY GUID MF_SA_D3D_AWARE = {
    0xeaa35c29,
    0x775e,
    0x488e,
    {0x9b, 0x61, 0xb3, 0x28, 0x3e, 0x49, 0x58, 0x3b}};
EXTERN_C const DECLSPEC_SELECTANY GUID MF_SA_REQUIRED_SAMPLE_COUNT = {
    0x18802c61,
    0x324b,
    0x4952,
    {0xab, 0xd0, 0x17, 0x6f, 0xf5, 0xc6, 0x96, 0xff}};
EXTERN_C const DECLSPEC_SELECTANY GUID MFT_END_STREAMING_AWARE = {
    0x70fbc845,
    0xb07e,
    0x4089,
    {0xb0, 0x64, 0x39, 0x9d, 0xc6, 0x11, 0xf, 0x29}};
EXTERN_C const DECLSPEC_SELECTANY GUID MF_SA_AUDIO_ENDPOINT_AWARE = {
    0xc0381701,
    0x805c,
    0x42b2,
    {0xac, 0x8d, 0xe2, 0xb4, 0xbf, 0x21, 0xf4, 0xf8}};
EXTERN_C const DECLSPEC_SELECTANY GUID MFT_AUDIO_DECODER_AUDIO_ENDPOINT_ID = {
    0xc7ccdd6e,
    0x5398,
    0x4695,
    {0x8b, 0xe7, 0x51, 0xb3, 0xe9, 0x51, 0x11, 0xbd}};
EXTERN_C const DECLSPEC_SELECTANY GUID
    MFT_AUDIO_DECODER_SPATIAL_METADATA_CLIENT = {
        0x5987df4,
        0x1270,
        0x4999,
        {0x92, 0x5f, 0x8e, 0x93, 0x9a, 0x7c, 0xa, 0xf7}};
EXTERN_C const DECLSPEC_SELECTANY GUID
    MFT_AUDIO_DECODER_AUDIO_ENDPOINT_FORMFACTOR = {
        0x8d574310,
        0x909a,
        0x433a,
        {0xac, 0xe7, 0xee, 0xe7, 0x47, 0x19, 0xf9, 0x01}};
EXTERN_C const DECLSPEC_SELECTANY GUID
    MFT_AUDIO_DECODER_AUDIO_ENDPOINT_IS_DIGITAL_STEREO_ONLY = {
        0x26e5a90d,
        0x4ad1,
        0x4f8c,
        {0xb8, 0xaf, 0xad, 0xf1, 0x4d, 0x21, 0x78, 0xf1}};
#endif /* WINAPI_FAMILY_PARTITION(WINAPI_PARTITION_APP |                       \
          WINAPI_PARTITION_GAMES) */
#pragma endregion
...
typedef struct IMFDeviceTransformVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(IMFDeviceTransform *This,
                                             /* [in] */ REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(IMFDeviceTransform *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(IMFDeviceTransform *This);
  ...
  HRESULT(STDMETHODCALLTYPE *GetStreamCount)(IMFDeviceTransform *This,
                                             /* [annotation][out] */
                                             _Out_ DWORD *pcInputStreams,
                                             /* [annotation][out] */
  ...
  HRESULT(STDMETHODCALLTYPE *GetStreamIDs)(IMFDeviceTransform *This,
                                           /* [annotation][in] */
                                           _In_ DWORD dwInputIDArraySize,
                                           /* [annotation][out] */
                                           _Out_ DWORD *pdwInputStreamIds,
  ...
  HRESULT(STDMETHODCALLTYPE *ProcessEvent)(IMFDeviceTransform *This,
                                           /* [annotation][in] */
                                           _In_ DWORD dwInputStreamID,
                                           /* [annotation][in] */
  ...
  HRESULT(STDMETHODCALLTYPE *ProcessInput)(IMFDeviceTransform *This,
                                           /* [annotation][in] */
                                           _In_ DWORD dwInputStreamID,
                                           /* [annotation][in] */
                                           _In_ IMFSample *pSample,
  ...
  HRESULT(STDMETHODCALLTYPE *ProcessMessage)(IMFDeviceTransform *This,
                                             /* [annotation][in] */
                                             _In_ MFT_MESSAGE_TYPE eMessage,
                                             /* [annotation][in] */
  ...
  HRESULT(STDMETHODCALLTYPE *SetInputStreamState)(IMFDeviceTransform *This,
                                                  /* [annotation][in] */
                                                  _In_ DWORD dwStreamID,
                                                  /* [annotation][in] */
                                                  _In_ IMFMediaType *pMediaType,
  ...
  HRESULT(STDMETHODCALLTYPE *FlushInputStream)(IMFDeviceTransform *This,
                                               /* [annotation][in] */
                                               _In_ DWORD dwStreamIndex,
                                               /* [annotation][in] */
                                               _In_ DWORD dwFlags);
  ...
  HRESULT(STDMETHODCALLTYPE *FlushOutputStream)(IMFDeviceTransform *This,
                                                /* [annotation][in] */
                                                _In_ DWORD dwStreamIndex,
                                                /* [annotation][in] */
                                                _In_ DWORD dwFlags);
...
#define IMFDeviceTransform_AddRef(This) ((This)->lpVtbl->AddRef(This))

#define IMFDeviceTransform_Release(This) ((This)->lpVtbl->Release(This))

#define IMFDeviceTransform_InitializeTransform(This, pAttributes)              \
  ((This)->lpVtbl->InitializeTransform(This, pAttributes))

#define IMFDeviceTransform_GetInputAvailableType(This, dwInputStreamID,        \
                                                 dwTypeIndex, pMediaType)      \
  ((This)->lpVtbl->GetInputAvailableType(This, dwInputStreamID, dwTypeIndex,   \
                                         pMediaType))

#define IMFDeviceTransform_GetInputCurrentType(This, dwInputStreamID,          \
                                               pMediaType)                     \
  ((This)->lpVtbl->GetInputCurrentType(This, dwInputStreamID, pMediaType))

#define IMFDeviceTransform_GetInputStreamAttributes(This, dwInputStreamID,     \
                                                    ppAttributes)              \
  ((This)->lpVtbl->GetInputStreamAttributes(This, dwInputStreamID,             \
                                            ppAttributes))

#define IMFDeviceTransform_GetOutputAvailableType(This, dwOutputStreamID,      \
                                                  dwTypeIndex, pMediaType)     \
  ((This)->lpVtbl->GetOutputAvailableType(This, dwOutputStreamID, dwTypeIndex, \
                                          pMediaType))

#define IMFDeviceTransform_GetOutputCurrentType(This, dwOutputStreamID,        \
                                                pMediaType)                    \
  ((This)->lpVtbl->GetOutputCurrentType(This, dwOutputStreamID, pMediaType))

#define IMFDeviceTransform_GetOutputStreamAttributes(This, dwOutputStreamID,   \
                                                     ppAttributes)             \
  ((This)->lpVtbl->GetOutputStreamAttributes(This, dwOutputStreamID,           \
                                             ppAttributes))

#define IMFDeviceTransform_GetStreamCount(This, pcInputStreams,                \
                                          pcOutputStreams)                     \
  ((This)->lpVtbl->GetStreamCount(This, pcInputStreams, pcOutputStreams))

#define IMFDeviceTransform_GetStreamIDs(                                       \
    This, dwInputIDArraySize, pdwInputStreamIds, dwOutputIDArraySize,          \
    pdwOutputStreamIds)                                                        \
  ((This)->lpVtbl->GetStreamIDs(This, dwInputIDArraySize, pdwInputStreamIds,   \
                                dwOutputIDArraySize, pdwOutputStreamIds))

#define IMFDeviceTransform_ProcessEvent(This, dwInputStreamID, pEvent)         \
  ((This)->lpVtbl->ProcessEvent(This, dwInputStreamID, pEvent))

#define IMFDeviceTransform_ProcessInput(This, dwInputStreamID, pSample,        \
                                        dwFlags)                               \
  ((This)->lpVtbl->ProcessInput(This, dwInputStreamID, pSample, dwFlags))
...
#define IMFDeviceTransform_ProcessOutput(This, dwFlags, cOutputBufferCount,    \
                                         pOutputSample, pdwStatus)             \
  ((This)->lpVtbl->ProcessOutput(This, dwFlags, cOutputBufferCount,            \
                                 pOutputSample, pdwStatus))

#define IMFDeviceTransform_SetInputStreamState(This, dwStreamID, pMediaType,   \
                                               value, dwFlags)                 \
  ((This)->lpVtbl->SetInputStreamState(This, dwStreamID, pMediaType, value,    \
                                       dwFlags))

#define IMFDeviceTransform_GetInputStreamState(This, dwStreamID, value)        \
  ((This)->lpVtbl->GetInputStreamState(This, dwStreamID, value))

#define IMFDeviceTransform_SetOutputStreamState(This, dwStreamID, pMediaType,  \
                                                value, dwFlags)                \
  ((This)->lpVtbl->SetOutputStreamState(This, dwStreamID, pMediaType, value,   \
                                        dwFlags))
...
#define IMFDeviceTransform_GetInputStreamPreferredState(This, dwStreamID,      \
                                                        value, ppMediaType)    \
  ((This)->lpVtbl->GetInputStreamPreferredState(This, dwStreamID, value,       \
                                                ppMediaType))
...
typedef struct IMFDeviceTransform2Vtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(IMFDeviceTransform2 *This,
                                             /* [in] */ REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(IMFDeviceTransform2 *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(IMFDeviceTransform2 *This);
  ...
  DECLSPEC_XFGVIRT(IMFDeviceTransform, GetStreamCount)
  HRESULT(STDMETHODCALLTYPE *GetStreamCount)(IMFDeviceTransform2 *This,
                                             /* [annotation][out] */
                                             _Out_ DWORD *pcInputStreams,
                                             /* [annotation][out] */
                                             _Out_ DWORD *pcOutputStreams);
  ...
  DECLSPEC_XFGVIRT(IMFDeviceTransform, GetStreamIDs)
  HRESULT(STDMETHODCALLTYPE *GetStreamIDs)(IMFDeviceTransform2 *This,
                                           /* [annotation][in] */
                                           _In_ DWORD dwInputIDArraySize,
                                           /* [annotation][out] */
                                           _Out_ DWORD *pdwInputStreamIds,
  ...
  DECLSPEC_XFGVIRT(IMFDeviceTransform, ProcessEvent)
  HRESULT(STDMETHODCALLTYPE *ProcessEvent)(IMFDeviceTransform2 *This,
                                           /* [annotation][in] */
                                           _In_ DWORD dwInputStreamID,
                                           /* [annotation][in] */
                                           _In_ IMFMediaEvent *pEvent);
  ...
  DECLSPEC_XFGVIRT(IMFDeviceTransform, ProcessInput)
  HRESULT(STDMETHODCALLTYPE *ProcessInput)(IMFDeviceTransform2 *This,
                                           /* [annotation][in] */
                                           _In_ DWORD dwInputStreamID,
                                           /* [annotation][in] */
                                           _In_ IMFSample *pSample,
  ...
  DECLSPEC_XFGVIRT(IMFDeviceTransform, ProcessMessage)
  HRESULT(STDMETHODCALLTYPE *ProcessMessage)(IMFDeviceTransform2 *This,
                                             /* [annotation][in] */
                                             _In_ MFT_MESSAGE_TYPE eMessage,
                                             /* [annotation][in] */
                                             _In_ ULONG_PTR ulParam);
  ...
  DECLSPEC_XFGVIRT(IMFDeviceTransform, SetInputStreamState)
  HRESULT(STDMETHODCALLTYPE *SetInputStreamState)(IMFDeviceTransform2 *This,
                                                  /* [annotation][in] */
                                                  _In_ DWORD dwStreamID,
                                                  /* [annotation][in] */
                                                  _In_ IMFMediaType *pMediaType,
  ...
  DECLSPEC_XFGVIRT(IMFDeviceTransform, FlushInputStream)
  HRESULT(STDMETHODCALLTYPE *FlushInputStream)(IMFDeviceTransform2 *This,
                                               /* [annotation][in] */
                                               _In_ DWORD dwStreamIndex,
                                               /* [annotation][in] */
                                               _In_ DWORD dwFlags);
  ...
  DECLSPEC_XFGVIRT(IMFDeviceTransform, FlushOutputStream)
  HRESULT(STDMETHODCALLTYPE *FlushOutputStream)(IMFDeviceTransform2 *This,
                                                /* [annotation][in] */
                                                _In_ DWORD dwStreamIndex,
                                                /* [annotation][in] */
                                                _In_ DWORD dwFlags);
...
#define IMFDeviceTransform2_AddRef(This) ((This)->lpVtbl->AddRef(This))

#define IMFDeviceTransform2_Release(This) ((This)->lpVtbl->Release(This))

#define IMFDeviceTransform2_InitializeTransform(This, pAttributes)             \
  ((This)->lpVtbl->InitializeTransform(This, pAttributes))

#define IMFDeviceTransform2_GetInputAvailableType(This, dwInputStreamID,       \
                                                  dwTypeIndex, pMediaType)     \
  ((This)->lpVtbl->GetInputAvailableType(This, dwInputStreamID, dwTypeIndex,   \
                                         pMediaType))

#define IMFDeviceTransform2_GetInputCurrentType(This, dwInputStreamID,         \
                                                pMediaType)                    \
  ((This)->lpVtbl->GetInputCurrentType(This, dwInputStreamID, pMediaType))

#define IMFDeviceTransform2_GetInputStreamAttributes(This, dwInputStreamID,    \
                                                     ppAttributes)             \
  ((This)->lpVtbl->GetInputStreamAttributes(This, dwInputStreamID,             \
                                            ppAttributes))

#define IMFDeviceTransform2_GetOutputAvailableType(This, dwOutputStreamID,     \
                                                   dwTypeIndex, pMediaType)    \
  ((This)->lpVtbl->GetOutputAvailableType(This, dwOutputStreamID, dwTypeIndex, \
                                          pMediaType))

#define IMFDeviceTransform2_GetOutputCurrentType(This, dwOutputStreamID,       \
                                                 pMediaType)                   \
  ((This)->lpVtbl->GetOutputCurrentType(This, dwOutputStreamID, pMediaType))

#define IMFDeviceTransform2_GetOutputStreamAttributes(This, dwOutputStreamID,  \
                                                      ppAttributes)            \
  ((This)->lpVtbl->GetOutputStreamAttributes(This, dwOutputStreamID,           \
                                             ppAttributes))

#define IMFDeviceTransform2_GetStreamCount(This, pcInputStreams,               \
                                           pcOutputStreams)                    \
  ((This)->lpVtbl->GetStreamCount(This, pcInputStreams, pcOutputStreams))

#define IMFDeviceTransform2_GetStreamIDs(                                      \
    This, dwInputIDArraySize, pdwInputStreamIds, dwOutputIDArraySize,          \
    pdwOutputStreamIds)                                                        \
  ((This)->lpVtbl->GetStreamIDs(This, dwInputIDArraySize, pdwInputStreamIds,   \
                                dwOutputIDArraySize, pdwOutputStreamIds))
...
#define IMFDeviceTransform2_ProcessInput(This, dwInputStreamID, pSample,       \
                                         dwFlags)                              \
  ((This)->lpVtbl->ProcessInput(This, dwInputStreamID, pSample, dwFlags))
...
#define IMFDeviceTransform2_ProcessOutput(This, dwFlags, cOutputBufferCount,   \
                                          pOutputSample, pdwStatus)            \
  ((This)->lpVtbl->ProcessOutput(This, dwFlags, cOutputBufferCount,            \
                                 pOutputSample, pdwStatus))

#define IMFDeviceTransform2_SetInputStreamState(This, dwStreamID, pMediaType,  \
                                                value, dwFlags)                \
  ((This)->lpVtbl->SetInputStreamState(This, dwStreamID, pMediaType, value,    \
                                       dwFlags))
...
#define IMFDeviceTransform2_SetOutputStreamState(This, dwStreamID, pMediaType, \
                                                 value, dwFlags)               \
  ((This)->lpVtbl->SetOutputStreamState(This, dwStreamID, pMediaType, value,   \
                                        dwFlags))
...
#define IMFDeviceTransform2_GetInputStreamPreferredState(This, dwStreamID,     \
                                                         value, ppMediaType)   \
  ((This)->lpVtbl->GetInputStreamPreferredState(This, dwStreamID, value,       \
                                                ppMediaType))
...
EXTERN_GUID(MF_DMFT_FRAME_BUFFER_INFO, 0x396CE1C9, 0x67A9, 0x454C, 0x87, 0x97,
            0x95, 0xA4, 0x57, 0x99, 0xD8, 0x04);
...
typedef struct IMFDeviceTransformCallbackVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(IMFDeviceTransformCallback *This,
                                             /* [in] */ REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(IMFDeviceTransformCallback *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(IMFDeviceTransformCallback *This);
...
#define IMFDeviceTransformCallback_AddRef(This) ((This)->lpVtbl->AddRef(This))

#define IMFDeviceTransformCallback_Release(This) ((This)->lpVtbl->Release(This))

#define IMFDeviceTransformCallback_OnBufferSent(This, pCallbackAttributes,     \
                                                pinId)                         \
...
#pragma region Application or Games Family
#if WINAPI_FAMILY_PARTITION(WINAPI_PARTITION_APP | WINAPI_PARTITION_GAMES)
EXTERN_C const DECLSPEC_SELECTANY GUID MF_SA_REQUIRED_SAMPLE_COUNT_PROGRESSIVE =
    {0xb172d58e,
     0xfa77,
     0x4e48,
     {0x8d, 0x2a, 0x1d, 0xf2, 0xd8, 0x50, 0xea, 0xc2}};
EXTERN_C const DECLSPEC_SELECTANY GUID MF_SA_MINIMUM_OUTPUT_SAMPLE_COUNT = {
    0x851745d5,
    0xc3d6,
    0x476d,
...
EXTERN_C const DECLSPEC_SELECTANY GUID MFT_SUPPORT_3DVIDEO = {
...
EXTERN_C const DECLSPEC_SELECTANY GUID MF_ENABLE_3DVIDEO_OUTPUT = {
    0xbdad7bca,
    0xe5f,
    0x4b10,
    {0xab, 0x16, 0x26, 0xde, 0x38, 0x1b, 0x62, 0x93}};
EXTERN_C const DECLSPEC_SELECTANY GUID MF_SA_D3D11_BINDFLAGS = {
    0xeacf97ad,
    0x065c,
    0x4408,
    {0xbe, 0xe3, 0xfd, 0xcb, 0xfd, 0x12, 0x8b, 0xe2}};
EXTERN_C const DECLSPEC_SELECTANY GUID MF_SA_D3D11_USAGE = {
    0xe85fe442,
    0x2ca3,
    0x486e,
    {0xa9, 0xc7, 0x10, 0x9d, 0xda, 0x60, 0x98, 0x80}};
EXTERN_C const DECLSPEC_SELECTANY GUID MF_SA_D3D11_AWARE = {
    0x206b4fc8,
    0xfcf9,
    0x4c51,
    {0xaf, 0xe3, 0x97, 0x64, 0x36, 0x9e, 0x33, 0xa0}};
EXTERN_C const DECLSPEC_SELECTANY GUID MF_SA_D3D11_SHARED = {
    0x7b8f32c3,
    0x6d96,
    0x4b89,
    {0x92, 0x3, 0xdd, 0x38, 0xb6, 0x14, 0x14, 0xf3}};
EXTERN_C const DECLSPEC_SELECTANY GUID MF_SA_D3D11_SHARED_WITHOUT_MUTEX = {
    0x39dbd44d,
    0x2e44,
    0x4931,
...
EXTERN_C const DECLSPEC_SELECTANY GUID MF_SA_D3D11_HW_PROTECTED = {
    0x3a8ba9d9,
    0x92ca,
    0x4307,
    {0xa3, 0x91, 0x69, 0x99, 0xdb, 0xf3, 0xb6, 0xce}};
EXTERN_C const DECLSPEC_SELECTANY GUID MF_SA_BUFFERS_PER_SAMPLE = {
    0x873c5171,
    0x1e3d,
    0x4e25,
    {0x98, 0x8d, 0xb4, 0x33, 0xce, 0x04, 0x19, 0x83}};
EXTERN_C const DECLSPEC_SELECTANY GUID
    MF_SA_D3D11_ALLOCATE_DISPLAYABLE_RESOURCES = {
        0xeeface6d,
        0x2ea9,
        0x4adf,
        {0xbb, 0xdf, 0x7b, 0xbc, 0x48, 0x2a, 0x1b, 0x6d}};
EXTERN_C const DECLSPEC_SELECTANY GUID
    MFT_DECODER_EXPOSE_OUTPUT_TYPES_IN_NATIVE_ORDER = {
        0xef80833f,
        0xf8fa,
        0x44d9,
        {0x80, 0xd8, 0x41, 0xed, 0x62, 0x32, 0x67, 0xc}};
EXTERN_C const DECLSPEC_SELECTANY GUID
    MFT_DECODER_QUALITY_MANAGEMENT_CUSTOM_CONTROL = {
        0xa24e30d7,
        0xde25,
        0x4558,
        {0xbb, 0xfb, 0x71, 0x7, 0xa, 0x2d, 0x33, 0x2e}};
EXTERN_C const DECLSPEC_SELECTANY GUID
    MFT_DECODER_QUALITY_MANAGEMENT_RECOVERY_WITHOUT_ARTIFACTS = {
        0xd8980deb,
        0xa48,
        0x425f,
        {0x86, 0x23, 0x61, 0x1d, 0xb4, 0x1d, 0x38, 0x10}};
EXTERN_C const DECLSPEC_SELECTANY GUID MFT_DECODER_OPERATING_POINT = {
    0xa1230334,
    0x55d4,
    0x4d97,
    {0x82, 0xa7, 0x26, 0xd3, 0xe6, 0x45, 0x67, 0x25}};
EXTERN_C const DECLSPEC_SELECTANY GUID MFT_DECODER_AUTOMATIC_SOFTWARE_FALLBACK =
    {0x41f34f53,
     0x1bf6,
     0x49ed,
     {0xb9, 0x5d, 0x2, 0xd2, 0xa1, 0xd7, 0x11, 0x5a}};
EXTERN_C const DECLSPEC_SELECTANY GUID MFT_REMUX_MARK_I_PICTURE_AS_CLEAN_POINT =
    {0x364e8f85,
     0x3f2e,
     0x436c,
     {0xb2, 0xa2, 0x44, 0x40, 0xa0, 0x12, 0xa9, 0xe8}};
EXTERN_C const DECLSPEC_SELECTANY GUID MFT_DECODER_FINAL_VIDEO_RESOLUTION_HINT =
    {0xdc2f8496,
     0x15c4,
     0x407a,
     {0xb6, 0xf0, 0x1b, 0x66, 0xab, 0x5f, 0xbf, 0x53}};
EXTERN_C const DECLSPEC_SELECTANY GUID MFT_ENCODER_SUPPORTS_CONFIG_EVENT = {
    0x86a355ae,
    0x3a77,
    0x4ec4,
    {0x9f, 0x31, 0x1, 0x14, 0x9a, 0x4e, 0x92, 0xde}};
EXTERN_C const DECLSPEC_SELECTANY GUID MFT_ENUM_HARDWARE_VENDOR_ID_Attribute = {
    0x3aecb0cc,
    0x35b,
    0x4bcc,
...
EXTERN_C const DECLSPEC_SELECTANY GUID MF_TRANSFORM_ASYNC = {
    ...
    0x649a,
    0x497d,
    {0x8c, 0x73, 0x29, 0xf8, 0xfe, 0xd6, 0xad, 0x7a}};
EXTERN_C const DECLSPEC_SELECTANY GUID MF_TRANSFORM_ASYNC_UNLOCK = {
    0xe5666d6b,
    0x3422,
    0x4eb6,
    {0xa4, 0x21, 0xda, 0x7d, 0xb1, 0xf8, 0xe2, 0x7}};
...
EXTERN_C const DECLSPEC_SELECTANY GUID MFT_FRIENDLY_NAME_Attribute = {
    ...
    0x5b41,
    0x4c95,
    {0x9c, 0x19, 0x4e, 0x7d, 0x58, 0x6f, 0xac, 0xe3}};
EXTERN_C const DECLSPEC_SELECTANY GUID MFT_CONNECTED_STREAM_ATTRIBUTE = {
    0x71eeb820,
    0xa59f,
    0x4de2,
    {0xbc, 0xec, 0x38, 0xdb, 0x1d, 0xd6, 0x11, 0xa4}};
...
#if WINAPI_FAMILY_PARTITION(WINAPI_PARTITION_DESKTOP)
STDAPI
MFCreateTransformActivate(_Out_ IMFActivate **ppActivate);
#endif /* WINAPI_FAMILY_PARTITION(WINAPI_PARTITION_DESKTOP) */
#pragma endregion
#endif // (WINVER >= _WIN32_WINNT_WIN7)
#pragma region Track Error Improvements
#if (WINVER >= _WIN32_WINNT_WINTHRESHOLD)
EXTERN_GUID(MFT_AUDIO_DECODER_DEGRADATION_INFO_ATTRIBUTE, 0x6c3386ad, 0xec20,
            0x430d, 0xb2, 0xa5, 0x50, 0x5c, 0x71, 0x78, 0xd9, 0xc4);
...
#pragma region Application or Games Family
#if WINAPI_FAMILY_PARTITION(WINAPI_PARTITION_APP | WINAPI_PARTITION_GAMES)
EXTERN_C const DECLSPEC_SELECTANY GUID MFT_POLICY_SET_AWARE = {
    0x5a633b19,
    0xcc39,
    0x4fa8,
    {0x8c, 0xa5, 0x59, 0x98, 0x1b, 0x7a, 0x0, 0x18}};
EXTERN_C const DECLSPEC_SELECTANY GUID MFT_USING_HARDWARE_DRM = {
    0x34faa77d,
    0xd79e,
    0x4957,
    {0xb8, 0xce, 0x36, 0x2b, 0x26, 0x84, 0x99, 0x6c}};
#endif /* WINAPI_FAMILY_PARTITION(WINAPI_PARTITION_APP |                       \
          WINAPI_PARTITION_GAMES) */
#pragma endregion
