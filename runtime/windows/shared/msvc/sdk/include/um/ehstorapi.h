...
typedef /* [public][helpstring][v1_enum] */ enum _ACT_AUTHORIZATION_STATE_VALUE
    *PACT_AUTHORIZATION_STATE_VALUE;
...
public:
  virtual HRESULT STDMETHODCALLTYPE GetACTs(
      /* [size_is][size_is][out] */ IEnhancedStorageACT *
...
typedef struct IEnumEnhancedStorageACTVtbl {
  ...
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(IEnumEnhancedStorageACT *This,
                                             /* [in] */ REFIID riid,
...
#define IEnumEnhancedStorageACT_GetACTs(This, pppIEnhancedStorageACTs,         \
                                        pcEnhancedStorageACTs)                 \
  ((This)->lpVtbl->GetACTs(This, pppIEnhancedStorageACTs,                      \
                           pcEnhancedStorageACTs))

#define IEnumEnhancedStorageACT_GetMatchingACT(This, szVolume,                 \
...
public:
  ...
  virtual HRESULT STDMETHODCALLTYPE GetSilos(
      /* [size_is][size_is][size_is][out] */ IEnhancedStorageSilo *
...
typedef struct IEnhancedStorageACTVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(IEnhancedStorageACT *This,
                                             /* [in] */ REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);
  ...
  HRESULT(STDMETHODCALLTYPE *Authorize)(IEnhancedStorageACT *This,
                                        /* [in] */ DWORD hwndParent,
                                        /* [in] */ DWORD dwFlags);
...
#define IEnhancedStorageACT_GetSilos(This, pppIEnhancedStorageSilos,           \
                                     pcEnhancedStorageSilos)                   \
  ((This)->lpVtbl->GetSilos(This, pppIEnhancedStorageSilos,                    \
                            pcEnhancedStorageSilos))
...
typedef struct IEnhancedStorageACT2Vtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(IEnhancedStorageACT2 *This,
                                             /* [in] */ REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);
  ...
  DECLSPEC_XFGVIRT(IEnhancedStorageACT, Authorize)
  HRESULT(STDMETHODCALLTYPE *Authorize)(IEnhancedStorageACT2 *This,
                                        /* [in] */ DWORD hwndParent,
                                        /* [in] */ DWORD dwFlags);
...
#define IEnhancedStorageACT2_GetSilos(This, pppIEnhancedStorageSilos,          \
                                      pcEnhancedStorageSilos)                  \
  ((This)->lpVtbl->GetSilos(This, pppIEnhancedStorageSilos,                    \
                            pcEnhancedStorageSilos))
...
typedef struct IEnhancedStorageACT3Vtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(IEnhancedStorageACT3 *This,
                                             /* [in] */ REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(IEnhancedStorageACT3 *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(IEnhancedStorageACT3 *This);

  DECLSPEC_XFGVIRT(IEnhancedStorageACT, Authorize)
  HRESULT(STDMETHODCALLTYPE *Authorize)(IEnhancedStorageACT3 *This,
                                        /* [in] */ DWORD hwndParent,
                                        /* [in] */ DWORD dwFlags);

  DECLSPEC_XFGVIRT(IEnhancedStorageACT, Unauthorize)
  HRESULT(STDMETHODCALLTYPE *Unauthorize)(IEnhancedStorageACT3 *This);
  ...
  HRESULT(STDMETHODCALLTYPE *UnauthorizeEx)(IEnhancedStorageACT3 *This,
                                            /* [in] */ DWORD dwFlags);

  DECLSPEC_XFGVIRT(IEnhancedStorageACT3, IsQueueFrozen)
  HRESULT(STDMETHODCALLTYPE *IsQueueFrozen)(IEnhancedStorageACT3 *This,
...
#define IEnhancedStorageACT3_AddRef(This) ((This)->lpVtbl->AddRef(This))

#define IEnhancedStorageACT3_Release(This) ((This)->lpVtbl->Release(This))
...
#define IEnhancedStorageACT3_GetSilos(This, pppIEnhancedStorageSilos,          \
                                      pcEnhancedStorageSilos)                  \
  ((This)->lpVtbl->GetSilos(This, pppIEnhancedStorageSilos,                    \
                            pcEnhancedStorageSilos))
...
public:
  ...
  virtual HRESULT STDMETHODCALLTYPE GetActions(
      /* [size_is][size_is][out] */ IEnhancedStorageSiloAction *
...
typedef struct IEnhancedStorageSiloVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(IEnhancedStorageSilo *This,
                                             /* [in] */ REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);
  ...
  HRESULT(STDMETHODCALLTYPE *GetInfo)(IEnhancedStorageSilo *This,
...
#define IEnhancedStorageSilo_GetActions(This, pppIEnhancedStorageSiloActions,  \
                                        pcEnhancedStorageSiloActions)          \
  ((This)->lpVtbl->GetActions(This, pppIEnhancedStorageSiloActions,            \
                              pcEnhancedStorageSiloActions))

#define IEnhancedStorageSilo_SendCommand(This, Command, pbCommandBuffer,       \
                                         cbCommandBuffer, pbResponseBuffer,    \
                                         pcbResponseBuffer)                    \
  ((This)->lpVtbl->SendCommand(This, Command, pbCommandBuffer,                 \
                               cbCommandBuffer, pbResponseBuffer,              \
                               pcbResponseBuffer))
...
typedef struct IEnhancedStorageSiloActionVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(IEnhancedStorageSiloAction *This,
                                             /* [in] */ REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);
  ...
  HRESULT(STDMETHODCALLTYPE *GetName)(IEnhancedStorageSiloAction *This,
...
#define IEnhancedStorageSiloAction_GetDescription(This,                        \
...
class DECLSPEC_UUID("af076a15-2ece-4ad4-bb21-29f040e176d8") EnhancedStorageACT;
#endif
...
class DECLSPEC_UUID("cb25220c-76c7-4fee-842b-f3383cd022bc") EnhancedStorageSilo;
#endif
