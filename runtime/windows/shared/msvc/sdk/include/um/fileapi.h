...
WINBASEAPI
BOOL WINAPI
CreateDirectoryA(_In_ LPCSTR lpPathName,
                 _In_opt_ LPSECURITY_ATTRIBUTES lpSecurityAttributes);

WINBASEAPI
BOOL WINAPI
CreateDirectoryW(_In_ LPCWSTR lpPathName,
                 _In_opt_ LPSECURITY_ATTRIBUTES lpSecurityAttributes);
...
HANDLE
WINAPI
CreateFileA(_In_ LPCSTR lpFileName, _In_ DWORD dwDesiredAccess,
...
HANDLE
WINAPI
CreateFileW(_In_ LPCWSTR lpFileName, _In_ DWORD dwDesiredAccess,
            _In_ DWORD dwShareMode,
            _In_opt_ LPSECURITY_ATTRIBUTES lpSecurityAttributes,
            _In_ DWORD dwCreationDisposition, _In_ DWORD dwFlagsAndAttributes,
            _In_opt_ HANDLE hTemplateFile);
...
WINBASEAPI
BOOL WINAPI DefineDosDeviceW(_In_ DWORD dwFlags, _In_ LPCWSTR lpDeviceName,
...
WINBASEAPI
BOOL WINAPI DeleteFileW(_In_ LPCWSTR lpFileName);
...
WINBASEAPI
BOOL WINAPI DeleteVolumeMountPointW(_In_ LPCWSTR lpszVolumeMountPoint);
...
HANDLE
WINAPI
FindFirstChangeNotificationA(_In_ LPCSTR lpPathName, _In_ BOOL bWatchSubtree,
                             _In_ DWORD dwNotifyFilter);

WINBASEAPI
HANDLE
WINAPI
FindFirstChangeNotificationW(_In_ LPCWSTR lpPathName, _In_ BOOL bWatchSubtree,
                             _In_ DWORD dwNotifyFilter);
...
HANDLE
WINAPI
FindFirstFileExA(_In_ LPCSTR lpFileName, _In_ FINDEX_INFO_LEVELS fInfoLevelId,
...
HANDLE
WINAPI
FindFirstFileExW(_In_ LPCWSTR lpFileName, _In_ FINDEX_INFO_LEVELS fInfoLevelId,
                 _Out_writes_bytes_(sizeof(WIN32_FIND_DATAW))
                     LPVOID lpFindFileData,
                 _In_ FINDEX_SEARCH_OPS fSearchOp,
                 _Reserved_ LPVOID lpSearchFilter,
                 _In_ DWORD dwAdditionalFlags);
...
HANDLE
WINAPI
FindFirstVolumeW(_Out_writes_(cchBufferLength) LPWSTR lpszVolumeName,
...
WINBASEAPI
BOOL WINAPI FindNextFileW(_In_ HANDLE hFindFile,
                          _Out_ LPWIN32_FIND_DATAW lpFindFileData);
...
WINBASEAPI
BOOL WINAPI FindNextVolumeW(_Inout_ HANDLE hFindVolume,
...
WINBASEAPI
BOOL WINAPI GetDiskFreeSpaceA(_In_opt_ LPCSTR lpRootPathName,
...
WINBASEAPI
BOOL WINAPI GetDiskFreeSpaceW(_In_opt_ LPCWSTR lpRootPathName,
                              _Out_opt_ LPDWORD lpSectorsPerCluster,
                              _Out_opt_ LPDWORD lpBytesPerSector,
                              _Out_opt_ LPDWORD lpNumberOfFreeClusters,
                              _Out_opt_ LPDWORD lpTotalNumberOfClusters);
...
WINBASEAPI
BOOL WINAPI
GetDiskFreeSpaceExA(_In_opt_ LPCSTR lpDirectoryName,
...
WINBASEAPI
BOOL WINAPI
GetDiskFreeSpaceExW(_In_opt_ LPCWSTR lpDirectoryName,
                    _Out_opt_ PULARGE_INTEGER lpFreeBytesAvailableToCaller,
                    _Out_opt_ PULARGE_INTEGER lpTotalNumberOfBytes,
                    _Out_opt_ PULARGE_INTEGER lpTotalNumberOfFreeBytes);
...
typedef struct DISK_SPACE_INFORMATION {
  ...
  //  Be aware AllocationUnits are mesured in clusters, see comments at the
  //  beginning.
  //
  ...
  //  TotalReservedAllocationUnits) s2 = (AvailableCommittedAllocationUnits +
  //  PoolAvailableAllocationUnits) ActualAvailableAllocationUnits = min( s1, s2
  //  )
  //
...
HRESULT
WINAPI
GetDiskSpaceInformationA(_In_opt_ LPCSTR rootPath,
                         _Out_ DISK_SPACE_INFORMATION *diskSpaceInfo);

WINBASEAPI
HRESULT
WINAPI
GetDiskSpaceInformationW(_In_opt_ LPCWSTR rootPath,
                         _Out_ DISK_SPACE_INFORMATION *diskSpaceInfo);
...
WINBASEAPI
UINT WINAPI GetDriveTypeA(_In_opt_ LPCSTR lpRootPathName);

WINBASEAPI
UINT WINAPI GetDriveTypeW(_In_opt_ LPCWSTR lpRootPathName);
...
DWORD
WINAPI
GetFileAttributesA(_In_ LPCSTR lpFileName);

WINBASEAPI
DWORD
WINAPI
GetFileAttributesW(_In_ LPCWSTR lpFileName);
...
BOOL WINAPI GetFileInformationByHandle(
    _In_ HANDLE hFile, _Out_ LPBY_HANDLE_FILE_INFORMATION lpFileInformation);
...
DWORD
WINAPI
GetFileSize(_In_ HANDLE hFile, _Out_opt_ LPDWORD lpFileSizeHigh);
...
DWORD
WINAPI
GetFinalPathNameByHandleA(_In_ HANDLE hFile,
...
DWORD
WINAPI
GetFinalPathNameByHandleW(_In_ HANDLE hFile,
...
WINBASEAPI
BOOL WINAPI GetFileTime(_In_ HANDLE hFile, _Out_opt_ LPFILETIME lpCreationTime,
                        _Out_opt_ LPFILETIME lpLastAccessTime,
                        _Out_opt_ LPFILETIME lpLastWriteTime);

WINBASEAPI
_Success_(return != 0 && return < nBufferLength) DWORD WINAPI
    GetFullPathNameW(_In_ LPCWSTR lpFileName, _In_ DWORD nBufferLength,
...
WINBASEAPI
_Success_(return != 0 && return < nBufferLength) DWORD WINAPI
    GetFullPathNameA(_In_ LPCSTR lpFileName, _In_ DWORD nBufferLength,
                     _Out_writes_to_opt_(nBufferLength, return +1)
                         LPSTR lpBuffer,
...
DWORD
WINAPI
GetLogicalDriveStringsW(_In_ DWORD nBufferLength,
                        _Out_writes_to_opt_(nBufferLength, return +1)
                            LPWSTR lpBuffer);
...
_Success_(return != 0 && return < cchBuffer) DWORD WINAPI
    GetLongPathNameA(_In_ LPCSTR lpszShortPath,
...
WINBASEAPI
_Success_(return != 0 && return < cchBuffer) DWORD WINAPI
    GetLongPathNameW(_In_ LPCWSTR lpszShortPath,
                     _Out_writes_to_opt_(cchBuffer, return +1)
                         LPWSTR lpszLongPath,
                     _In_ DWORD cchBuffer);
...
WINBASEAPI
BOOL WINAPI AreShortNamesEnabled(_In_ HANDLE Handle, _Out_ BOOL *Enabled);

#endif // (NTDDI_VERSION >= NTDDI_WIN10_FE)

WINBASEAPI
_Success_(return != 0 && return < cchBuffer) DWORD WINAPI
    GetShortPathNameW(_In_ LPCWSTR lpszLongPath,
                      _Out_writes_to_opt_(cchBuffer, return +1)
...
WINBASEAPI
UINT WINAPI GetTempFileNameW(_In_ LPCWSTR lpPathName,
                             _In_ LPCWSTR lpPrefixString, _In_ UINT uUnique,
...
WINBASEAPI
BOOL WINAPI GetVolumeInformationW(_In_opt_ LPCWSTR lpRootPathName,
                                  _Out_writes_opt_(nVolumeNameSize)
                                      LPWSTR lpVolumeNameBuffer,
                                  _In_ DWORD nVolumeNameSize,
                                  _Out_opt_ LPDWORD lpVolumeSerialNumber,
                                  _Out_opt_ LPDWORD lpMaximumComponentLength,
                                  _Out_opt_ LPDWORD lpFileSystemFlags,
                                  _Out_writes_opt_(nFileSystemNameSize)
...
WINBASEAPI
BOOL WINAPI GetVolumePathNameW(_In_ LPCWSTR lpszFileName,
...
WINBASEAPI
BOOL WINAPI LocalFileTimeToFileTime(_In_ CONST FILETIME *lpLocalFileTime,
                                    _Out_ LPFILETIME lpFileTime);

WINBASEAPI
BOOL WINAPI LockFile(_In_ HANDLE hFile, _In_ DWORD dwFileOffsetLow,
                     _In_ DWORD dwFileOffsetHigh,
                     _In_ DWORD nNumberOfBytesToLockLow,
                     _In_ DWORD nNumberOfBytesToLockHigh);

WINBASEAPI
BOOL WINAPI LockFileEx(_In_ HANDLE hFile, _In_ DWORD dwFlags,
...
DWORD
WINAPI
QueryDosDeviceW(_In_opt_ LPCWSTR lpDeviceName,
...
WINBASEAPI
_Must_inspect_result_ BOOL WINAPI
ReadFileEx(_In_ HANDLE hFile,
           _Out_writes_bytes_opt_(nNumberOfBytesToRead) __out_data_source(FILE)
               LPVOID lpBuffer,
...
WINBASEAPI
_Must_inspect_result_ BOOL WINAPI
ReadFileScatter(_In_ HANDLE hFile, _In_ FILE_SEGMENT_ELEMENT aSegmentArray[],
                _In_ DWORD nNumberOfBytesToRead, _Reserved_ LPDWORD lpReserved,
                _Inout_ LPOVERLAPPED lpOverlapped);

WINBASEAPI
BOOL WINAPI RemoveDirectoryA(_In_ LPCSTR lpPathName);
...
WINBASEAPI
BOOL WINAPI SetFileAttributesA(_In_ LPCSTR lpFileName,
...
DWORD
WINAPI
SetFilePointer(_In_ HANDLE hFile, _In_ LONG lDistanceToMove,
               _Inout_opt_ PLONG lpDistanceToMoveHigh, _In_ DWORD dwMoveMethod);

WINBASEAPI
BOOL WINAPI SetFilePointerEx(_In_ HANDLE hFile,
...
WINBASEAPI
BOOL WINAPI UnlockFile(_In_ HANDLE hFile, _In_ DWORD dwFileOffsetLow,
                       _In_ DWORD dwFileOffsetHigh,
                       _In_ DWORD nNumberOfBytesToUnlockLow,
                       _In_ DWORD nNumberOfBytesToUnlockHigh);

WINBASEAPI
BOOL WINAPI UnlockFileEx(_In_ HANDLE hFile, _Reserved_ DWORD dwReserved,
                         _In_ DWORD nNumberOfBytesToUnlockLow,
                         _In_ DWORD nNumberOfBytesToUnlockHigh,
                         _Inout_ LPOVERLAPPED lpOverlapped);
...
DWORD
WINAPI
GetTempPathW(_In_ DWORD nBufferLength,
...
WINBASEAPI
BOOL WINAPI GetVolumeNameForVolumeMountPointW(_In_ LPCWSTR lpszVolumeMountPoint,
                                              _Out_writes_(cchBufferLength)
...
HANDLE
WINAPI
CreateFile2(_In_ LPCWSTR lpFileName, _In_ DWORD dwDesiredAccess,
...
WINBASEAPI
BOOL WINAPI SetFileIoOverlappedRange(_In_ HANDLE FileHandle,
...
DWORD
WINAPI
GetCompressedFileSizeA(_In_ LPCSTR lpFileName,
                       _Out_opt_ LPDWORD lpFileSizeHigh);

WINBASEAPI
DWORD
WINAPI
GetCompressedFileSizeW(_In_ LPCWSTR lpFileName,
                       _Out_opt_ LPDWORD lpFileSizeHigh);
...
HANDLE
WINAPI
FindFirstStreamW(_In_ LPCWSTR lpFileName, _In_ STREAM_INFO_LEVELS InfoLevel,
                 _Out_writes_bytes_(sizeof(WIN32_FIND_STREAM_DATA))
                     LPVOID lpFindStreamData,
                 _Reserved_ DWORD dwFlags);

WINBASEAPI
BOOL APIENTRY FindNextStreamW(_In_ HANDLE hFindStream,
                              _Out_writes_bytes_(sizeof(WIN32_FIND_STREAM_DATA))
                                  LPVOID lpFindStreamData);
...
HANDLE
WINAPI
FindFirstFileNameW(_In_ LPCWSTR lpFileName, _In_ DWORD dwFlags,
                   _Inout_ LPDWORD StringLength,
                   _Out_writes_(*StringLength) PWSTR LinkName);

WINBASEAPI
BOOL APIENTRY FindNextFileNameW(_In_ HANDLE hFindStream,
                                _Inout_ LPDWORD StringLength,
                                _Out_writes_(*StringLength) PWSTR LinkName);
...
WINBASEAPI
_Success_(return > 0 && return < BufferLength) DWORD WINAPI
...
WINBASEAPI
_Success_(return > 0 && return < BufferLength) DWORD WINAPI
    GetTempPath2A(_In_ DWORD BufferLength,
...
typedef struct _CREATEFILE3_EXTENDED_PARAMETERS {
  ...
  LPSECURITY_ATTRIBUTES lpSecurityAttributes;
  HANDLE hTemplateFile;
} CREATEFILE3_EXTENDED_PARAMETERS, *PCREATEFILE3_EXTENDED_PARAMETERS,
...
HANDLE
WINAPI
CreateFile3(_In_z_ LPCWSTR lpFileName, _In_ DWORD dwDesiredAccess,
            _In_ DWORD dwShareMode, _In_ DWORD dwCreationDisposition,
...
HANDLE
WINAPI
CreateDirectory2A(_In_z_ LPCSTR lpPathName, _In_ DWORD dwDesiredAccess,
                  _In_ DWORD dwShareMode, _In_ DIRECTORY_FLAGS DirectoryFlags,
                  _In_opt_ LPSECURITY_ATTRIBUTES lpSecurityAttributes);

WINBASEAPI
HANDLE
WINAPI
CreateDirectory2W(_In_z_ LPCWSTR lpPathName, _In_ DWORD dwDesiredAccess,
                  _In_ DWORD dwShareMode, _In_ DIRECTORY_FLAGS DirectoryFlags,
                  _In_opt_ LPSECURITY_ATTRIBUTES lpSecurityAttributes);
...
WINBASEAPI
BOOL WINAPI RemoveDirectory2A(_In_z_ LPCSTR lpPathName,
                              _In_ DIRECTORY_FLAGS DirectoryFlags);

WINBASEAPI
BOOL WINAPI RemoveDirectory2W(_In_z_ LPCWSTR lpPathName,
                              _In_ DIRECTORY_FLAGS DirectoryFlags);
...
WINBASEAPI
BOOL WINAPI DeleteFile2A(_In_z_ LPCSTR lpFileName, _In_ DWORD Flags);

WINBASEAPI
BOOL WINAPI DeleteFile2W(_In_z_ LPCWSTR lpFileName, _In_ DWORD Flags);
