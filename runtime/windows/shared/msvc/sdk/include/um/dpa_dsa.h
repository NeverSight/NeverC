...
typedef int(CALLBACK *PFNDAENUMCALLBACK)(_In_opt_ void *p,
                                         _In_opt_ void *pData);
typedef int(CALLBACK *PFNDAENUMCALLBACKCONST)(_In_opt_ const void *p,
                                              _In_opt_ void *pData);
typedef int(CALLBACK *PFNDACOMPARE)(_In_opt_ void *p1, _In_opt_ void *p2,
                                    _In_ LPARAM lParam);
typedef int(CALLBACK *PFNDACOMPARECONST)(_In_opt_ const void *p1,
...
WINCOMMCTRLAPI void WINAPI DSA_DestroyCallback(_Inout_opt_ HDSA hdsa,
                                               _In_ PFNDAENUMCALLBACK pfnCB,
                                               _In_opt_ void *pData);
#ifdef __cplusplus
extern "C++" __inline void
DSA_DestroyCallback(_Inout_opt_ HDSA hdsa, _In_ PFNDAENUMCALLBACKCONST pfnCB,
                    _In_opt_ void *pData) {
...
WINCOMMCTRLAPI void WINAPI DSA_EnumCallback(_In_ HDSA hdsa,
                                            ...
                                            _In_opt_ void *pData);
#ifdef __cplusplus
extern "C++" __inline void DSA_EnumCallback(_In_ HDSA hdsa,
                                            _In_ PFNDAENUMCALLBACKCONST pfnCB,
                                            _In_opt_ void *pData) {
  DSA_EnumCallback(hdsa, (PFNDAENUMCALLBACK)pfnCB, pData);
}
#endif
WINCOMMCTRLAPI int WINAPI DSA_InsertItem(_Inout_ HDSA hdsa, _In_ int i,
                                         _In_ const void *pitem);
WINCOMMCTRLAPI PVOID WINAPI DSA_GetItemPtr(_In_ HDSA hdsa, _In_ int i);
_Success_(return) WINCOMMCTRLAPI BOOL WINAPI
    DSA_GetItem(_In_ HDSA hdsa, _In_ int i,
                _Out_writes_(_Inexpressible_(pdsa->cbItem)) void *pitem);
_Success_(return) WINCOMMCTRLAPI BOOL WINAPI
    DSA_SetItem(_Inout_ HDSA hdsa, _In_ int i, _In_ const void *pitem);
...
WINCOMMCTRLAPI BOOL WINAPI DSA_Sort(_Inout_ HDSA pdsa,
                                    _In_ PFNDACOMPARE pfnCompare,
                                    _In_ LPARAM lParam);
#ifdef __cplusplus
extern "C++" __inline BOOL DSA_Sort(_Inout_ HDSA hdsa,
                                    _In_ PFNDACOMPARECONST pfnCompare,
                                    _In_ LPARAM lParam) {
...
WINCOMMCTRLAPI HDPA WINAPI DPA_Clone(_In_ const HDPA hdpa,
...
#ifdef __cplusplus
extern "C++" __inline void
DPA_DestroyCallback(_In_ HDPA hdpa, _In_ PFNDAENUMCALLBACKCONST pfnCB,
                    _In_opt_ void *pData) {
...
WINCOMMCTRLAPI void WINAPI DPA_EnumCallback(_In_opt_ HDPA hdpa,
                                            _In_opt_ PFNDAENUMCALLBACK pfnCB,
                                            _In_opt_ void *pData);
#ifdef __cplusplus
extern "C++" __inline void DPA_EnumCallback(_In_ HDPA hdpa,
                                            _In_ PFNDAENUMCALLBACKCONST pfnCB,
                                            _In_opt_ void *pData) {
...
WINCOMMCTRLAPI int WINAPI DPA_InsertPtr(_Inout_ HDPA hdpa, _In_ int i,
                                        _In_opt_ void *p);
WINCOMMCTRLAPI BOOL WINAPI DPA_SetPtr(_Inout_ HDPA hdpa, _In_ int i,
                                      _In_opt_ void *p);
...
WINCOMMCTRLAPI BOOL WINAPI DPA_Sort(_Inout_ HDPA hdpa,
                                    ...
                                    _In_ LPARAM lParam);
#ifdef __cplusplus
extern "C++" __inline BOOL DPA_Sort(_Inout_ HDPA hdpa,
                                    _In_ PFNDACOMPARECONST pfnCompare,
                                    _In_ LPARAM lParam) {
...
struct IStream;
typedef HRESULT(CALLBACK *PFNDPASTREAM)(_In_ DPASTREAMINFO *pinfo,
...
//
typedef void *(CALLBACK *PFNDPAMERGE)(_In_ UINT uMsg, _In_ void *pvDest,
                                      _In_ void *pvSrc, _In_ LPARAM lParam);
typedef const void *(CALLBACK *PFNDPAMERGECONST)(_In_ UINT uMsg,
...
WINCOMMCTRLAPI BOOL WINAPI DPA_Merge(_Inout_ HDPA hdpaDest, _In_ HDPA hdpaSrc,
                                     _In_ DWORD dwFlags,
                                     _In_ PFNDACOMPARE pfnCompare,
                                     _In_ PFNDPAMERGE pfnMerge,
                                     _In_ LPARAM lParam);
#ifdef __cplusplus
extern "C++" __inline BOOL DPA_Merge(_Inout_ HDPA hdpaDest, _In_ HDPA hdpaSrc,
                                     _In_ DWORD dwFlags,
                                     _In_ PFNDACOMPARECONST pfnCompare,
                                     _In_ PFNDPAMERGECONST pfnMerge,
                                     _In_ LPARAM lParam) {
...
WINCOMMCTRLAPI int WINAPI DPA_Search(_In_ HDPA hdpa, _In_opt_ void *pFind,
                                     _In_ int iStart,
                                     _In_ PFNDACOMPARE pfnCompare,
                                     _In_ LPARAM lParam, _In_ UINT options);
#ifdef __cplusplus
extern "C++" __inline int DPA_Search(_In_ HDPA hdpa, _In_opt_ const void *pFind,
                                     _In_ int iStart,
                                     _In_ PFNDACOMPARECONST pfnCompare,
                                     _In_ LPARAM lParam, _In_ UINT options) {
