...
typedef struct IXpsOMObjectFactory1Vtbl {
  ...
  DECLSPEC_XFGVIRT(IXpsOMObjectFactory1,
...
#define IXpsOMObjectFactory1_CreatePackageFromStream1(This, stream,            \
                                                      reuseObjects, package)   \
  ((This)->lpVtbl->CreatePackageFromStream1(This, stream, reuseObjects,        \
                                            package))

#define IXpsOMObjectFactory1_CreatePackageFromFile1(This, filename,            \
                                                    reuseObjects, package)     \
  ((This)->lpVtbl->CreatePackageFromFile1(This, filename, reuseObjects,        \
                                          package))
...
typedef struct IXpsOMPackage1Vtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(IXpsOMPackage1 *This,
                                             /* [in] */ REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);
...
interface IXpsOMPackage1 { CONST_VTBL struct IXpsOMPackage1Vtbl *lpVtbl; };
...
typedef struct IXpsOMPage1Vtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(IXpsOMPage1 *This,
                                             /* [in] */ REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);
  ...
  HRESULT(STDMETHODCALLTYPE *SetLanguage)(IXpsOMPage1 *This,
                                          /* [string][in] */ LPCWSTR language);

  DECLSPEC_XFGVIRT(IXpsOMPage, GetName)
  HRESULT(STDMETHODCALLTYPE *GetName)(IXpsOMPage1 *This,
                                      /* [retval][string][out] */ LPWSTR *name);

  DECLSPEC_XFGVIRT(IXpsOMPage, SetName)
  HRESULT(STDMETHODCALLTYPE *SetName)(IXpsOMPage1 *This,
  ...
  HRESULT(STDMETHODCALLTYPE *Clone)(IXpsOMPage1 *This,
                                    /* [retval][out] */ IXpsOMPage **page);
...
interface IXpsOMPage1 { CONST_VTBL struct IXpsOMPage1Vtbl *lpVtbl; };
...
#define IXpsDocumentPackageTarget_GetXpsOMPackageWriter(                       \
  ...
  ((This)->lpVtbl->GetXpsOMPackageWriter(                                      \
      This, documentSequencePartName, discardControlPartName, packageWriter))
