...
typedef struct ICertPolicyVtbl {
  ...
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in ICertPolicy *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in ICertPolicy *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in ICertPolicy *This);
  ...
  HRESULT(STDMETHODCALLTYPE *Initialize)(__RPC__in ICertPolicy *This,
  ...
  HRESULT(STDMETHODCALLTYPE *ShutDown)(__RPC__in ICertPolicy *This);

  END_INTERFACE
} ICertPolicyVtbl;

interface ICertPolicy { CONST_VTBL struct ICertPolicyVtbl *lpVtbl; };
...
public:
  virtual HRESULT STDMETHODCALLTYPE GetManageModule(
      /* [retval][out] */ __RPC__deref_out_opt ICertManageModule *
      *ppManageModule) = 0;
};
...
typedef struct ICertPolicy2Vtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in ICertPolicy2 *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in ICertPolicy2 *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in ICertPolicy2 *This);
  ...
  DECLSPEC_XFGVIRT(ICertPolicy, Initialize)
  HRESULT(STDMETHODCALLTYPE *Initialize)(__RPC__in ICertPolicy2 *This,
                                         /* [in] */ __RPC__in const BSTR
                                             strConfig);
  ...
  DECLSPEC_XFGVIRT(ICertPolicy, ShutDown)
  HRESULT(STDMETHODCALLTYPE *ShutDown)(__RPC__in ICertPolicy2 *This);
...
interface ICertPolicy2 { CONST_VTBL struct ICertPolicy2Vtbl *lpVtbl; };
...
typedef struct INDESPolicyVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(INDESPolicy *This,
                                             /* [in] */ REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(INDESPolicy *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(INDESPolicy *This);

  DECLSPEC_XFGVIRT(INDESPolicy, Initialize)
  HRESULT(STDMETHODCALLTYPE *Initialize)(INDESPolicy *This);

  DECLSPEC_XFGVIRT(INDESPolicy, Uninitialize)
  HRESULT(STDMETHODCALLTYPE *Uninitialize)(INDESPolicy *This);
...
interface INDESPolicy { CONST_VTBL struct INDESPolicyVtbl *lpVtbl; };
...
#define INDESPolicy_AddRef(This) ((This)->lpVtbl->AddRef(This))

#define INDESPolicy_Release(This) ((This)->lpVtbl->Release(This))

#define INDESPolicy_Initialize(This) ((This)->lpVtbl->Initialize(This))

#define INDESPolicy_Uninitialize(This) ((This)->lpVtbl->Uninitialize(This))

#define INDESPolicy_GenerateChallenge(This, pwszTemplate, pwszParams,          \
                                      ppwszResponse)                           \
  ((This)->lpVtbl->GenerateChallenge(This, pwszTemplate, pwszParams,           \
                                     ppwszResponse))

#define INDESPolicy_VerifyRequest(This, pctbRequest, pctbSigningCertEncoded,   \
                                  pwszTemplate, pwszTransactionId, pfVerified) \
  ((This)->lpVtbl->VerifyRequest(This, pctbRequest, pctbSigningCertEncoded,    \
                                 pwszTemplate, pwszTransactionId, pfVerified))

#define INDESPolicy_Notify(This, pwszChallenge, pwszTransactionId,             \
                           disposition, lastHResult, pctbIssuedCertEncoded)    \
  ((This)->lpVtbl->Notify(This, pwszChallenge, pwszTransactionId, disposition, \
                          lastHResult, pctbIssuedCertEncoded))
