...
typedef struct IXpsSigningOptionsVtbl {
  ...
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in IXpsSigningOptions *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IXpsSigningOptions *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IXpsSigningOptions *This);
  ...
  HRESULT(STDMETHODCALLTYPE *SetPolicy)(__RPC__in IXpsSigningOptions *This,
  ...
  HRESULT(STDMETHODCALLTYPE *SetFlags)(__RPC__in IXpsSigningOptions *This,
...
typedef struct IXpsSignatureCollectionVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IXpsSignatureCollection *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IXpsSignatureCollection *This);
  ...
  HRESULT(STDMETHODCALLTYPE *RemoveAt)(__RPC__in IXpsSignatureCollection *This,
                                       UINT32 index);
...
typedef struct IXpsSignatureVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(IXpsSignature *This,
                                             /* [in] */ REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);
...
interface IXpsSignature { CONST_VTBL struct IXpsSignatureVtbl *lpVtbl; };
...
public:
  ...
  virtual HRESULT STDMETHODCALLTYPE GetAt(
      /* [in] */ UINT32 index,
      /* [retval][out] */ __RPC__deref_out_opt IXpsSignatureBlock *
          *signatureBlock) = 0;
...
typedef struct IXpsSignatureBlockCollectionVtbl {
  ...
  HRESULT(STDMETHODCALLTYPE *RemoveAt)(
      __RPC__in IXpsSignatureBlockCollection *This, UINT32 index);
...
public:
  virtual HRESULT STDMETHODCALLTYPE GetRequests(
      /* [retval][out] */ __RPC__deref_out_opt IXpsSignatureRequestCollection *
      *requests) = 0;
  ...
  virtual HRESULT STDMETHODCALLTYPE CreateRequest(
      ...
      /* [retval][out] */ __RPC__deref_out_opt IXpsSignatureRequest *
          *signatureRequest) = 0;
};
...
typedef struct IXpsSignatureBlockVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in IXpsSignatureBlock *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IXpsSignatureBlock *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IXpsSignatureBlock *This);
...
typedef struct IXpsSignatureRequestVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IXpsSignatureRequest *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IXpsSignatureRequest *This);
