...
HRESULT WINAPI
WinBioEnumDatabases(_In_ WINBIO_BIOMETRIC_TYPE Factor,
                    _Outptr_result_buffer_(*StorageCount)
                        WINBIO_STORAGE_SCHEMA **StorageSchemaArray,
...
HRESULT WINAPI WinBioAsyncOpenFramework(
    ...
    _In_opt_ HWND TargetWindow, _In_opt_ UINT MessageCode,
    _In_opt_ PWINBIO_ASYNC_COMPLETION_CALLBACK CallbackRoutine,
    _In_opt_ PVOID UserData, _In_ BOOL AsynchronousOpen,
    _Out_opt_ WINBIO_FRAMEWORK_HANDLE *FrameworkHandle);

HRESULT WINAPI
WinBioCloseFramework(_In_ WINBIO_FRAMEWORK_HANDLE FrameworkHandle);

HRESULT WINAPI
WinBioAsyncEnumServiceProviders(_In_ WINBIO_FRAMEWORK_HANDLE FrameworkHandle,
                                _In_ WINBIO_BIOMETRIC_TYPE Factor);

HRESULT WINAPI
WinBioAsyncEnumBiometricUnits(_In_ WINBIO_FRAMEWORK_HANDLE FrameworkHandle,
                              _In_ WINBIO_BIOMETRIC_TYPE Factor);

HRESULT WINAPI
WinBioAsyncEnumDatabases(_In_ WINBIO_FRAMEWORK_HANDLE FrameworkHandle,
                         _In_ WINBIO_BIOMETRIC_TYPE Factor);
...
//
///////////////////////////////////////////////////////////////////////////////
HRESULT WINAPI WinBioOpenSession(_In_ WINBIO_BIOMETRIC_TYPE Factor,
                                 _In_ WINBIO_POOL_TYPE PoolType,
                                 _In_ WINBIO_SESSION_FLAGS Flags,
                                 _In_reads_opt_(UnitCount)
...
HRESULT WINAPI WinBioAsyncOpenSession(
    _In_ WINBIO_BIOMETRIC_TYPE Factor, _In_ WINBIO_POOL_TYPE PoolType,
    _In_ WINBIO_SESSION_FLAGS Flags,
    _In_reads_opt_(UnitCount) WINBIO_UNIT_ID *UnitArray,
    _In_opt_ SIZE_T UnitCount, _In_opt_ GUID *DatabaseId,
    _In_ WINBIO_ASYNC_NOTIFICATION_METHOD NotificationMethod,
    _In_opt_ HWND TargetWindow, _In_opt_ UINT MessageCode,
    _In_opt_ PWINBIO_ASYNC_COMPLETION_CALLBACK CallbackRoutine,
    _In_opt_ PVOID UserData, _In_ BOOL AsynchronousOpen,
...
HRESULT WINAPI WinBioCloseSession(_In_ WINBIO_SESSION_HANDLE SessionHandle);
...
//
///////////////////////////////////////////////////////////////////////////////
HRESULT WINAPI WinBioVerify(_In_ WINBIO_SESSION_HANDLE SessionHandle,
...
typedef VOID(CALLBACK *PWINBIO_VERIFY_CALLBACK)(
    _In_opt_ PVOID VerifyCallbackContext, _In_ HRESULT OperationStatus,
    _In_ WINBIO_UNIT_ID UnitId, _In_ BOOLEAN Match,
    _In_ WINBIO_REJECT_DETAIL RejectDetail);

HRESULT WINAPI WinBioVerifyWithCallback(
    _In_ WINBIO_SESSION_HANDLE SessionHandle, _In_ WINBIO_IDENTITY *Identity,
    _In_ WINBIO_BIOMETRIC_SUBTYPE SubFactor,
    _In_ PWINBIO_VERIFY_CALLBACK VerifyCallback,
    _In_opt_ PVOID VerifyCallbackContext);

HRESULT WINAPI WinBioIdentify(_In_ WINBIO_SESSION_HANDLE SessionHandle,
                              _Out_opt_ WINBIO_UNIT_ID *UnitId,
...
typedef VOID(CALLBACK *PWINBIO_IDENTIFY_CALLBACK)(
    _In_opt_ PVOID IdentifyCallbackContext, _In_ HRESULT OperationStatus,
    _In_ WINBIO_UNIT_ID UnitId, _In_ WINBIO_IDENTITY *Identity,
    _In_ WINBIO_BIOMETRIC_SUBTYPE SubFactor,
    _In_ WINBIO_REJECT_DETAIL RejectDetail);

HRESULT WINAPI
WinBioIdentifyWithCallback(_In_ WINBIO_SESSION_HANDLE SessionHandle,
                           _In_ PWINBIO_IDENTIFY_CALLBACK IdentifyCallback,
                           _In_opt_ PVOID IdentifyCallbackContext);

HRESULT WINAPI WinBioWait(_In_ WINBIO_SESSION_HANDLE SessionHandle);

HRESULT WINAPI WinBioCancel(_In_ WINBIO_SESSION_HANDLE SessionHandle);
...
//
///////////////////////////////////////////////////////////////////////////////
HRESULT WINAPI WinBioLocateSensor(_In_ WINBIO_SESSION_HANDLE SessionHandle,
                                  _Out_opt_ WINBIO_UNIT_ID *UnitId);

typedef VOID(CALLBACK *PWINBIO_LOCATE_SENSOR_CALLBACK)(
    _In_opt_ PVOID LocateCallbackContext, _In_ HRESULT OperationStatus,
...
//
///////////////////////////////////////////////////////////////////////////////
HRESULT WINAPI WinBioEnrollBegin(_In_ WINBIO_SESSION_HANDLE SessionHandle,
                                 _In_ WINBIO_BIOMETRIC_SUBTYPE SubFactor,
                                 _In_ WINBIO_UNIT_ID UnitId);

#if (NTDDI_VERSION >= NTDDI_WINTHRESHOLD)

HRESULT WINAPI WinBioEnrollSelect(_In_ WINBIO_SESSION_HANDLE SessionHandle,
                                  _In_ ULONGLONG SelectorValue);

#endif // (NTDDI_VERSION >= NTDDI_WINTHRESHOLD)

HRESULT
WINAPI WinBioEnrollCapture(_In_ WINBIO_SESSION_HANDLE SessionHandle,
                           _Out_opt_ WINBIO_REJECT_DETAIL *RejectDetail);

typedef VOID(CALLBACK *PWINBIO_ENROLL_CAPTURE_CALLBACK)(
    _In_opt_ PVOID EnrollCallbackContext, _In_ HRESULT OperationStatus,
    _In_ WINBIO_REJECT_DETAIL RejectDetail);
...
HRESULT WINAPI WinBioEnrollCommit(_In_ WINBIO_SESSION_HANDLE SessionHandle,
                                  _Out_opt_ WINBIO_IDENTITY *Identity,
                                  _Out_opt_ BOOLEAN *IsNewTemplate);

HRESULT WINAPI WinBioEnrollDiscard(_In_ WINBIO_SESSION_HANDLE SessionHandle);

HRESULT WINAPI WinBioEnumEnrollments(
    _In_ WINBIO_SESSION_HANDLE SessionHandle, _In_ WINBIO_UNIT_ID UnitId,
    _In_ WINBIO_IDENTITY *Identity,
    _Outptr_result_buffer_maybenull_(*SubFactorCount)
        WINBIO_BIOMETRIC_SUBTYPE **SubFactorArray,
...
//
///////////////////////////////////////////////////////////////////////////////
HRESULT WINAPI WinBioImproveBegin(_In_ WINBIO_SESSION_HANDLE SessionHandle,
                                  _In_ WINBIO_UNIT_ID UnitId);

HRESULT WINAPI WinBioImproveEnd(_In_ WINBIO_SESSION_HANDLE SessionHandle);
...
typedef VOID(CALLBACK *PWINBIO_EVENT_CALLBACK)(
    _In_opt_ PVOID EventCallbackContext, _In_ HRESULT OperationStatus,
    _In_ PWINBIO_EVENT Event);

HRESULT WINAPI WinBioRegisterEventMonitor(
    _In_ WINBIO_SESSION_HANDLE SessionHandle, _In_ WINBIO_EVENT_TYPE EventMask,
    _In_ PWINBIO_EVENT_CALLBACK EventCallback,
    _In_opt_ PVOID EventCallbackContext);

HRESULT WINAPI
WinBioUnregisterEventMonitor(_In_ WINBIO_SESSION_HANDLE SessionHandle);

#if (NTDDI_VERSION >= NTDDI_WINTHRESHOLD)

HRESULT WINAPI WinBioMonitorPresence(_In_ WINBIO_SESSION_HANDLE SessionHandle,
                                     _In_ WINBIO_UNIT_ID UnitId);
...
HRESULT WINAPI WinBioCaptureSample(
    _In_ WINBIO_SESSION_HANDLE SessionHandle, _In_ WINBIO_BIR_PURPOSE Purpose,
    _In_ WINBIO_BIR_DATA_FLAGS Flags, _Out_opt_ WINBIO_UNIT_ID *UnitId,
    _Outptr_result_bytebuffer_maybenull_(*SampleSize) PWINBIO_BIR *Sample,
    _Out_opt_ SIZE_T *SampleSize, _Out_opt_ WINBIO_REJECT_DETAIL *RejectDetail);

typedef VOID(CALLBACK *PWINBIO_CAPTURE_CALLBACK)(
    _In_opt_ PVOID CaptureCallbackContext, _In_ HRESULT OperationStatus,
    _In_ WINBIO_UNIT_ID UnitId, _In_reads_bytes_(SampleSize) PWINBIO_BIR Sample,
    _In_ SIZE_T SampleSize, _In_ WINBIO_REJECT_DETAIL RejectDetail);
...
//
///////////////////////////////////////////////////////////////////////////////
HRESULT WINAPI WinBioDeleteTemplate(_In_ WINBIO_SESSION_HANDLE SessionHandle,
                                    _In_ WINBIO_UNIT_ID UnitId,
                                    _In_ WINBIO_IDENTITY *Identity,
                                    _In_ WINBIO_BIOMETRIC_SUBTYPE SubFactor);
...
//
///////////////////////////////////////////////////////////////////////////////
HRESULT WINAPI WinBioLockUnit(_In_ WINBIO_SESSION_HANDLE SessionHandle,
                              _In_ WINBIO_UNIT_ID UnitId);

HRESULT WINAPI WinBioUnlockUnit(_In_ WINBIO_SESSION_HANDLE SessionHandle,
                                _In_ WINBIO_UNIT_ID UnitId);

HRESULT WINAPI WinBioControlUnit(
    _In_ WINBIO_SESSION_HANDLE SessionHandle, _In_ WINBIO_UNIT_ID UnitId,
    _In_ WINBIO_COMPONENT Component, _In_ ULONG ControlCode,
...
HRESULT WINAPI WinBioGetProperty(
    _In_ WINBIO_SESSION_HANDLE SessionHandle,
    _In_ WINBIO_PROPERTY_TYPE PropertyType, _In_ WINBIO_PROPERTY_ID PropertyId,
    _In_opt_ WINBIO_UNIT_ID UnitId, _In_opt_ WINBIO_IDENTITY *Identity,
...
HRESULT WINAPI WinBioSetProperty(_In_ WINBIO_SESSION_HANDLE SessionHandle,
                                 ...
                                 _In_opt_ WINBIO_BIOMETRIC_SUBTYPE SubFactor,
                                 _In_reads_bytes_(PropertyBufferSize)
                                     PVOID PropertyBuffer,
...
//
///////////////////////////////////////////////////////////////////////////////
HRESULT WINAPI WinBioFree(_In_ PVOID Address);
...
//
///////////////////////////////////////////////////////////////////////////////
HRESULT WINAPI WinBioSetCredential(_In_ WINBIO_CREDENTIAL_TYPE Type,
                                   _In_reads_bytes_(CredentialSize)
                                       PUCHAR Credential,
                                   _In_ SIZE_T CredentialSize,
                                   _In_ WINBIO_CREDENTIAL_FORMAT Format);

HRESULT WINAPI WinBioRemoveCredential(_In_ WINBIO_IDENTITY Identity,
...
HRESULT WINAPI WinBioGetCredentialState(
    _In_ WINBIO_IDENTITY Identity, _In_ WINBIO_CREDENTIAL_TYPE Type,
    _Out_ WINBIO_CREDENTIAL_STATE *CredentialState);

HRESULT WINAPI
WinBioLogonIdentifiedUser(_In_ WINBIO_SESSION_HANDLE SessionHandle);
...
HRESULT WINAPI
WinBioGetEnrolledFactors(_In_ WINBIO_IDENTITY *AccountOwner,
...
//
///////////////////////////////////////////////////////////////////////////////
VOID WINAPI WinBioGetEnabledSetting(_Out_ BOOLEAN *Value,
                                    _Out_ PWINBIO_SETTING_SOURCE_TYPE Source);

VOID WINAPI WinBioGetLogonSetting(_Out_ BOOLEAN *Value,
                                  _Out_ PWINBIO_SETTING_SOURCE_TYPE Source);

VOID WINAPI WinBioGetDomainLogonSetting(
    _Out_ BOOLEAN *Value, _Out_ PWINBIO_SETTING_SOURCE_TYPE Source);

HRESULT WINAPI WinBioIsESSCapable(_Out_ BOOLEAN *Value);
...
HRESULT WINAPI WinBioGetEssState(_Out_ PWINBIO_ESS_STATE EssState);

HRESULT WINAPI
WinBioIsDeviceEnhancedSignInSecurityCapable(_Out_ BOOL *IsCapable);

HRESULT WINAPI
WinBioGetEnhancedSignInSecurityStateSource(_Out_ WINBIO_POLICY_SOURCE *Source);

HRESULT WINAPI
WinBioIsDeviceEnhancedSignInSecurityEnabled(_Out_ BOOL *IsEnabled);

HRESULT WINAPI
WinBioAreEnhancedSignInSecurityRequirementsMet(_Out_ BOOL *AreRequirementsMet);

HRESULT WINAPI
WinBioGetConnectedSensors(_Out_ SIZE_T *SensorCount,
                          _Out_ WINBIO_CONNECTED_SENSOR **ConnectedSensors);

HRESULT WINAPI WinBioGetEnhancedSignInSecurityEnrolledFactors(
    _In_ WINBIO_IDENTITY *Identity,
