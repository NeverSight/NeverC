...
extern const MSREMOTEDECLSPEC char *PROGID_MSRemote_Version =
    MS_REMOTE_PROGID ".1";

extern const MSREMOTEDECLSPEC WCHAR *PROGID_WMSRemote_Version =
...
#define DBPROP_MSREMOTE_SERVER                                                 \
  2 // Name="Remote Server", type=VT_BSTR, def=VT_EMPTY
#define DBPROP_MSREMOTE_PROVIDER                                               \
  3 // Name="Remote Provider", type=VT_BSTR, def=VT_EMPTY
...
#define DBPROP_MSREMOTE_INTERNET_TIMEOUT                                       \
  6 // Name="Internet Timeout", type=VT_I4, def=VT_EMPTY
#define DBPROP_MSREMOTE_TRANSACT_UPDATES                                       \
  7 // Name="Transact Updates", type=VT_BOOL, def=VARIANT_FALSE
#define DBPROP_MSREMOTE_COMMAND_PROPERTIES                                     \
  8 // Name="Command Properties", type=VT_BSTR, def=VT_EMPTY
...
#define DBPROP_MSREMOTE_CURRENT_DFMODE                                         \
  2 // Name="Current DFMode", type=VT_I4, def=21
