...
typedef struct IWSDAddressVtbl {
  ...
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(IWSDAddress *This,
                                             /* [in] */ REFIID riid,
  ...
  HRESULT(STDMETHODCALLTYPE *Serialize)(IWSDAddress *This,
                                        /* [annotation][size_is][out] */
                                        _Out_writes_(cchLength)
                                            LPWSTR pszBuffer,
                                        /* [in] */ DWORD cchLength,
                                        /* [in] */ BOOL fSafe);

  DECLSPEC_XFGVIRT(IWSDAddress, Deserialize)
  HRESULT(STDMETHODCALLTYPE *Deserialize)(IWSDAddress *This,
                                          /* [annotation][in] */
...
interface IWSDAddress { CONST_VTBL struct IWSDAddressVtbl *lpVtbl; };
...
typedef struct IWSDTransportAddressVtbl {
  ...
  HRESULT(STDMETHODCALLTYPE *GetPort)(IWSDTransportAddress *This,
                                      /* [annotation][out] */
                                      _Out_ WORD *pwPort);

  DECLSPEC_XFGVIRT(IWSDTransportAddress, SetPort)
  HRESULT(STDMETHODCALLTYPE *SetPort)(IWSDTransportAddress *This,
                                      /* [in] */ WORD wPort);
...
typedef struct IWSDMessageParametersVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IWSDMessageParameters *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IWSDMessageParameters *This);
...
typedef struct IWSDUdpMessageParametersVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IWSDUdpMessageParameters *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IWSDUdpMessageParameters *This);
...
HRESULT WINAPI WSDCreateUdpAddress(_Outptr_ IWSDUdpAddress **ppAddress);
#if 1
...
typedef struct IWSDUdpAddressVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(IWSDUdpAddress *This,
                                             /* [in] */ REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);
  ...
  DECLSPEC_XFGVIRT(IWSDAddress, Serialize)
  HRESULT(STDMETHODCALLTYPE *Serialize)(IWSDUdpAddress *This,
                                        /* [annotation][size_is][out] */
                                        _Out_writes_(cchLength)
                                            LPWSTR pszBuffer,
                                        /* [in] */ DWORD cchLength,
  ...
  DECLSPEC_XFGVIRT(IWSDTransportAddress, GetPort)
  HRESULT(STDMETHODCALLTYPE *GetPort)(IWSDUdpAddress *This,
                                      /* [annotation][out] */
                                      _Out_ WORD *pwPort);

  DECLSPEC_XFGVIRT(IWSDTransportAddress, SetPort)
  HRESULT(STDMETHODCALLTYPE *SetPort)(IWSDUdpAddress *This,
                                      /* [in] */ WORD wPort);
  ...
  HRESULT(STDMETHODCALLTYPE *SetTTL)(IWSDUdpAddress *This,
                                     /* [in] */ DWORD dwTTL);

  DECLSPEC_XFGVIRT(IWSDUdpAddress, GetTTL)
  HRESULT(STDMETHODCALLTYPE *GetTTL)(IWSDUdpAddress *This,
                                     /* [annotation][out] */
                                     _Out_ DWORD *pdwTTL);
  ...
  HRESULT(STDMETHODCALLTYPE *GetAlias)(IWSDUdpAddress *This,
                                       /* [annotation][out] */
                                       _Out_ GUID *pAlias);
...
interface IWSDUdpAddress { CONST_VTBL struct IWSDUdpAddressVtbl *lpVtbl; };
...
HRESULT WINAPI
WSDCreateHttpMessageParameters(_Outptr_ IWSDHttpMessageParameters **ppTxParams);
...
HRESULT WINAPI WSDCreateHttpAddress(_Outptr_ IWSDHttpAddress **ppAddress);
...
typedef struct IWSDHttpAddressVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(IWSDHttpAddress *This,
                                             /* [in] */ REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);
  ...
  DECLSPEC_XFGVIRT(IWSDAddress, Serialize)
  HRESULT(STDMETHODCALLTYPE *Serialize)(IWSDHttpAddress *This,
                                        /* [annotation][size_is][out] */
                                        _Out_writes_(cchLength)
                                            LPWSTR pszBuffer,
                                        /* [in] */ DWORD cchLength,
  ...
  DECLSPEC_XFGVIRT(IWSDTransportAddress, GetPort)
  HRESULT(STDMETHODCALLTYPE *GetPort)(IWSDHttpAddress *This,
                                      /* [annotation][out] */
                                      _Out_ WORD *pwPort);

  DECLSPEC_XFGVIRT(IWSDTransportAddress, SetPort)
  HRESULT(STDMETHODCALLTYPE *SetPort)(IWSDHttpAddress *This,
                                      /* [in] */ WORD wPort);
  ...
  HRESULT(STDMETHODCALLTYPE *SetSecure)(IWSDHttpAddress *This,
                                        /* [in] */ BOOL fSecure);

  DECLSPEC_XFGVIRT(IWSDHttpAddress, GetPath)
  HRESULT(STDMETHODCALLTYPE *GetPath)(IWSDHttpAddress *This,
                                      /* [annotation][out] */
                                      _Outptr_ LPCWSTR *ppszPath);

  DECLSPEC_XFGVIRT(IWSDHttpAddress, SetPath)
  HRESULT(STDMETHODCALLTYPE *SetPath)(IWSDHttpAddress *This,
                                      /* [annotation][in] */
...
interface IWSDHttpAddress { CONST_VTBL struct IWSDHttpAddressVtbl *lpVtbl; };
...
typedef struct IWSDHttpAuthParametersVtbl {
  ...
  HRESULT(STDMETHODCALLTYPE *GetAuthType)(IWSDHttpAuthParameters *This,
                                          /* [annotation][out] */
                                          _Out_ PWSD_SECURITY_HTTP_AUTH_SCHEMES
                                              pAuthType);
...
public:
  ...
  virtual HRESULT STDMETHODCALLTYPE GetKeyInfo(
      /* [annotation][size_is][out] */
      _Out_writes_bytes_to_opt_(*pdwKeyInfoSize, *pdwKeyInfoSize) BYTE *
          pbKeyInfo,
      /* [annotation][out][in] */
  ...
  virtual HRESULT STDMETHODCALLTYPE GetSignature(
      /* [annotation][size_is][out] */
      _Out_writes_bytes_to_opt_(*pdwSignatureSize, *pdwSignatureSize) BYTE *
          pbSignature,
      /* [annotation][out][in] */
  ...
  virtual HRESULT STDMETHODCALLTYPE GetSignedInfoHash(
      /* [annotation][size_is][out] */
      _Out_writes_bytes_to_opt_(*pdwHashSize, *pdwHashSize) BYTE *
          pbSignedInfoHash,
      /* [annotation][out][in] */
...
typedef struct IWSDSignaturePropertyVtbl {
  ...
  HRESULT(STDMETHODCALLTYPE *GetKeyInfo)(
      IWSDSignatureProperty *This,
      /* [annotation][size_is][out] */
      _Out_writes_bytes_to_opt_(*pdwKeyInfoSize, *pdwKeyInfoSize)
          BYTE *pbKeyInfo,
      /* [annotation][out][in] */
  ...
  HRESULT(STDMETHODCALLTYPE *GetSignature)(
      IWSDSignatureProperty *This,
      /* [annotation][size_is][out] */
      _Out_writes_bytes_to_opt_(*pdwSignatureSize, *pdwSignatureSize)
          BYTE *pbSignature,
      /* [annotation][out][in] */
  ...
  HRESULT(STDMETHODCALLTYPE *GetSignedInfoHash)(
      IWSDSignatureProperty *This,
      /* [annotation][size_is][out] */
      _Out_writes_bytes_to_opt_(*pdwHashSize, *pdwHashSize)
