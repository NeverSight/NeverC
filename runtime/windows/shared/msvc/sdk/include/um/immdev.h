...
typedef struct tagCOMPOSITIONFORM {
  ...
  POINT ptCurrentPos;
  RECT rcArea;
} COMPOSITIONFORM, *PCOMPOSITIONFORM, NEAR *NPCOMPOSITIONFORM,
    FAR *LPCOMPOSITIONFORM;
...
typedef struct tagIMEMENUITEMINFOA {
  ...
  HBITMAP hbmpItem;
} IMEMENUITEMINFOA, *PIMEMENUITEMINFOA, NEAR *NPIMEMENUITEMINFOA,
    FAR *LPIMEMENUITEMINFOA;
typedef struct tagIMEMENUITEMINFOW {
  ...
  HBITMAP hbmpItem;
} IMEMENUITEMINFOW, *PIMEMENUITEMINFOW, NEAR *NPIMEMENUITEMINFOW,
    FAR *LPIMEMENUITEMINFOW;
#ifdef UNICODE
...
typedef struct tagIMECHARPOSITION {
  ...
  UINT cLineHeight;
  RECT rcDocument;
} IMECHARPOSITION, *PIMECHARPOSITION, NEAR *NPIMECHARPOSITION,
    FAR *LPIMECHARPOSITION;
...
UINT WINAPI ImmGetDescriptionA(IN HKL,
                               _Out_writes_opt_(uBufLen) LPSTR lpszDescription,
                               IN UINT uBufLen);
UINT WINAPI ImmGetDescriptionW(IN HKL,
...
UINT WINAPI ImmGetIMEFileNameA(IN HKL,
                               _Out_writes_opt_(uBufLen) LPSTR lpszFileName,
                               IN UINT uBufLen);
UINT WINAPI ImmGetIMEFileNameW(IN HKL,
...
LONG WINAPI ImmGetCompositionStringA(IN HIMC, IN DWORD,
                                     _Out_writes_bytes_opt_(dwBufLen)
                                         LPVOID lpBuf,
                                     IN DWORD dwBufLen);
LONG WINAPI ImmGetCompositionStringW(IN HIMC, IN DWORD,
                                     _Out_writes_bytes_opt_(dwBufLen)
                                         LPVOID lpBuf,
                                     IN DWORD dwBufLen);
#ifdef UNICODE
...
BOOL WINAPI ImmSetCompositionStringA(
    IN HIMC, IN DWORD dwIndex, _In_reads_bytes_opt_(dwCompLen) LPVOID lpComp,
    IN DWORD dwCompLen, _In_reads_bytes_opt_(dwReadLen) LPVOID lpRead,
    IN DWORD dwReadLen);
...
DWORD WINAPI ImmGetCandidateListA(IN HIMC, IN DWORD deIndex,
                                  _Out_writes_bytes_opt_(dwBufLen)
                                      LPCANDIDATELIST lpCandList,
                                  IN DWORD dwBufLen);
DWORD WINAPI ImmGetCandidateListW(IN HIMC, IN DWORD deIndex,
                                  _Out_writes_bytes_opt_(dwBufLen)
                                      LPCANDIDATELIST lpCandList,
                                  IN DWORD dwBufLen);
#ifdef UNICODE
...
DWORD WINAPI ImmGetGuideLineA(_In_ HIMC, _In_ DWORD dwIndex,
                              _Out_writes_bytes_opt_(dwBufLen) LPSTR lpBuf,
                              _In_ DWORD dwBufLen);
DWORD WINAPI ImmGetGuideLineW(_In_ HIMC, _In_ DWORD dwIndex,
...
BOOL WINAPI ImmGetConversionStatus(IN HIMC, _Out_opt_ LPDWORD lpfdwConversion,
...
DWORD WINAPI ImmGetConversionListA(IN HKL, IN HIMC, _In_ LPCSTR lpSrc,
                                   _Out_writes_bytes_(dwBufLen)
                                       LPCANDIDATELIST lpDst,
                                   IN DWORD dwBufLen, IN UINT uFlag);
DWORD WINAPI ImmGetConversionListW(IN HKL, IN HIMC, _In_ LPCWSTR lpSrc,
                                   _Out_writes_bytes_(dwBufLen)
                                       LPCANDIDATELIST lpDst,
                                   IN DWORD dwBufLen, IN UINT uFlag);
#ifdef UNICODE
...
BOOL WINAPI ImmNotifyIME(IN HIMC, IN DWORD dwAction, IN DWORD dwIndex,
                         IN DWORD dwValue);
...
typedef int(CALLBACK *REGISTERWORDENUMPROCA)(_In_ LPCSTR lpszReading, DWORD,
                                             _In_ LPCSTR lpszString, LPVOID);
typedef int(CALLBACK *REGISTERWORDENUMPROCW)(_In_ LPCWSTR lpszReading, DWORD,
                                             _In_ LPCWSTR lpszString, LPVOID);
#ifdef UNICODE
...
BOOL WINAPI ImmRegisterWordA(IN HKL, _In_ LPCSTR lpszReading, IN DWORD,
                             _In_ LPCSTR lpszRegister);
BOOL WINAPI ImmRegisterWordW(IN HKL, _In_ LPCWSTR lpszReading, IN DWORD,
...
BOOL WINAPI ImmUnregisterWordA(IN HKL, _In_ LPCSTR lpszReading, IN DWORD,
                               _In_ LPCSTR lpszUnregister);
BOOL WINAPI ImmUnregisterWordW(IN HKL, _In_ LPCWSTR lpszReading, IN DWORD,
...
UINT WINAPI ImmGetRegisterWordStyleA(IN HKL, IN UINT nItem,
                                     _Out_writes_(nItem)
                                         LPSTYLEBUFA lpStyleBuf);
UINT WINAPI ImmGetRegisterWordStyleW(IN HKL, IN UINT nItem,
                                     _Out_writes_(nItem)
...
UINT WINAPI ImmEnumRegisterWordA(IN HKL, IN REGISTERWORDENUMPROCA,
                                 _In_opt_ LPCSTR lpszReading, IN DWORD,
                                 _In_opt_ LPCSTR lpszRegister, IN LPVOID);
UINT WINAPI ImmEnumRegisterWordW(IN HKL, IN REGISTERWORDENUMPROCW,
                                 _In_opt_ LPCWSTR lpszReading, IN DWORD,
                                 _In_opt_ LPCWSTR lpszRegister, IN LPVOID);
#ifdef UNICODE
...
BOOL WINAPI ImmEnumInputContext(DWORD idThread, IMCENUMPROC lpfn,
                                LPARAM lParam);
DWORD WINAPI ImmGetImeMenuItemsA(IN HIMC, IN DWORD, IN DWORD,
                                 _Out_opt_ LPIMEMENUITEMINFOA lpImeParentMenu,
                                 _Out_writes_bytes_opt_(dwSize)
                                     LPIMEMENUITEMINFOA lpImeMenu,
                                 IN DWORD dwSize);
DWORD WINAPI ImmGetImeMenuItemsW(IN HIMC, IN DWORD, IN DWORD,
...
// IME_CMODE_HANGEUL is old name of IME_CMODE_HANGUL. It will be gone
// eventually.
...
BOOL WINAPI ImmGetHotKey(IN DWORD, _Out_ LPUINT lpuModifiers,
                         _Out_ LPUINT lpuVKey, _Out_ LPHKL phKL);
...
BOOL WINAPI ImeInquire(_In_ LPIMEINFO lpIMEInfo,
                       _Out_writes_(IME_UI_CLASS_NAME_SIZE) LPTSTR lpszUIClass,
                       IN DWORD dwSystemInfoFlags);
BOOL WINAPI ImeConfigure(IN HKL, IN HWND, IN DWORD, IN LPVOID);
DWORD WINAPI ImeConversionList(HIMC, _In_ LPCTSTR lpSource,
                               _Out_writes_bytes_(dwBufLen)
                                   LPCANDIDATELIST lpDest,
                               DWORD dwBufLen, UINT uFlag);
BOOL WINAPI ImeDestroy(UINT);
LRESULT WINAPI ImeEscape(HIMC, UINT, LPVOID);
BOOL WINAPI ImeProcessKey(IN HIMC, IN UINT, IN LPARAM,
                          _In_reads_bytes_(256) CONST LPBYTE lpbKeyState);
...
UINT WINAPI ImeToAsciiEx(IN UINT uVirtKey, IN UINT uScaCode,
                         _In_reads_bytes_(256) CONST LPBYTE lpbKeyState,
                         _Out_writes_bytes_(sizeof(TRANSMSGLIST) +
                                            (sizeof(TRANSMSG) *
                                             (lpTransBuf->uMsgCount
                                                  ? lpTransBuf->uMsgCount - 1
                                                  : 0)))
...
UINT WINAPI ImeToAsciiEx(IN UINT uVirtKey, IN UINT uScaCode,
                         _In_reads_bytes_(256) CONST LPBYTE lpbKeyState,
                         _Out_ LPDWORD lpdwTransBuf, IN UINT fuState,
                         IN HIMC hIMC);
#endif /* WINVER >= 0x040A */
BOOL WINAPI NotifyIME(IN HIMC, IN DWORD, IN DWORD, IN DWORD);
BOOL WINAPI ImeRegisterWord(_In_ LPCTSTR lpszReading, IN DWORD,
                            _In_ LPCTSTR lpszString);
BOOL WINAPI ImeUnregisterWord(_In_ LPCTSTR lpszReading, IN DWORD,
                              _In_ LPCTSTR lpszString);
UINT WINAPI ImeGetRegisterWordStyle(IN UINT nItem,
                                    _Out_writes_(nItem) LPSTYLEBUF lpStyleBuf);
UINT WINAPI ImeEnumRegisterWord(IN REGISTERWORDENUMPROC,
                                _In_opt_ LPCTSTR lpszReading, IN DWORD,
                                _In_opt_ LPCTSTR lpszString, IN LPVOID);
BOOL WINAPI ImeSetCompositionString(IN HIMC, IN DWORD dwIndex,
                                    _In_reads_bytes_(dwCompLen) LPVOID lpComp,
                                    IN DWORD dwCompLen,
                                    _In_reads_bytes_(dwReadLen) LPVOID lpRead,
                                    IN DWORD dwReadLen);
