...
typedef struct IPropertyStorageVtbl {
  ...
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in IPropertyStorage *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IPropertyStorage *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IPropertyStorage *This);

  DECLSPEC_XFGVIRT(IPropertyStorage, ReadMultiple)
  HRESULT(STDMETHODCALLTYPE *ReadMultiple)(__RPC__in IPropertyStorage *This,
                                           /* [in] */ ULONG cpspec,
                                           /* [size_is][in] */
  ...
  HRESULT(STDMETHODCALLTYPE *WriteMultiple)(__RPC__in IPropertyStorage *This,
                                            /* [in] */ ULONG cpspec,
                                            /* [size_is][in] */
                                            __RPC__in_ecount_full(cpspec)
                                                const PROPSPEC rgpspec[],
  ...
  HRESULT(STDMETHODCALLTYPE *DeleteMultiple)(__RPC__in IPropertyStorage *This,
                                             /* [in] */ ULONG cpspec,
                                             /* [size_is][in] */
                                             __RPC__in_ecount_full(cpspec)
                                                 const PROPSPEC rgpspec[]);
  ...
  HRESULT(STDMETHODCALLTYPE *Commit)(__RPC__in IPropertyStorage *This,
                                     /* [in] */ DWORD grfCommitFlags);

  DECLSPEC_XFGVIRT(IPropertyStorage, Revert)
  HRESULT(STDMETHODCALLTYPE *Revert)(__RPC__in IPropertyStorage *This);
  ...
  HRESULT(STDMETHODCALLTYPE *SetClass)(__RPC__in IPropertyStorage *This,
...
interface IPropertyStorage { CONST_VTBL struct IPropertyStorageVtbl *lpVtbl; };
...
typedef /* [unique] */ __RPC_unique_pointer IPropertySetStorage
...
typedef struct IPropertySetStorageVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IPropertySetStorage *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IPropertySetStorage *This);
  ...
  HRESULT(STDMETHODCALLTYPE *Delete)(__RPC__in IPropertySetStorage *This,
                                     /* [in] */ __RPC__in REFFMTID rfmtid);
...
typedef struct IEnumSTATPROPSTGVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in IEnumSTATPROPSTG *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IEnumSTATPROPSTG *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IEnumSTATPROPSTG *This);
  ...
  HRESULT(STDMETHODCALLTYPE *Skip)(__RPC__in IEnumSTATPROPSTG *This,
                                   /* [in] */ ULONG celt);

  DECLSPEC_XFGVIRT(IEnumSTATPROPSTG, Reset)
  HRESULT(STDMETHODCALLTYPE *Reset)(__RPC__in IEnumSTATPROPSTG *This);
...
interface IEnumSTATPROPSTG { CONST_VTBL struct IEnumSTATPROPSTGVtbl *lpVtbl; };
...
typedef /* [unique] */ __RPC_unique_pointer IEnumSTATPROPSETSTG
...
typedef struct IEnumSTATPROPSETSTGVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IEnumSTATPROPSETSTG *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IEnumSTATPROPSETSTG *This);
  ...
  HRESULT(STDMETHODCALLTYPE *Skip)(__RPC__in IEnumSTATPROPSETSTG *This,
                                   /* [in] */ ULONG celt);

  DECLSPEC_XFGVIRT(IEnumSTATPROPSETSTG, Reset)
  HRESULT(STDMETHODCALLTYPE *Reset)(__RPC__in IEnumSTATPROPSETSTG *This);
...
WINOLEAPI FreePropVariantArray(_In_ ULONG cVariants,
...
_Success_(TRUE) /* Raises status on failure */
    ...
    StgConvertVariantToProperty(_In_ const PROPVARIANT *pvar,
                                _In_ USHORT CodePage,
                                _Out_writes_bytes_opt_(*pcb)
                                    SERIALIZEDPROPERTYVALUE *pprop,
                                _Inout_ ULONG *pcb, _In_ PROPID pid,
...
_Success_(TRUE) /* Raises status on failure */
    BOOLEAN __stdcall
    StgConvertPropertyToVariant(_In_ const SERIALIZEDPROPERTYVALUE *pprop,
                                _In_ USHORT CodePage, _Out_ PROPVARIANT *pvar,
