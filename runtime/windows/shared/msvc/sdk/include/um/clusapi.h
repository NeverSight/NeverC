...
// starting with CU use convention of 0x0000 + 2 digit major version + 2 digit
// minor version ie NT13_MAJOR_VERSION = 12 = 0x0C, CU_UPGRADE_VERSION = 3 =
// 0x03
...
#define CLUSTER_DELETE_ACCESS_CONTROL_ENTRY                                    \
  2 // To delete all the ACEs for a particular SID

//
// Return values for CLUSCTL_CLUSTER_CHECK_VOTER_DOWN and
...
typedef struct _CREATE_CLUSTER_CONFIG {
  ...
  CLUSTER_MGMT_POINT_TYPE
  managementPointType; // CLUSAPI Version >= CLUSAPI_VERSION_WINDOWSBLUE
  CLUSTER_MGMT_POINT_RESTYPE
  managementPointResType; // CLUSAPI Version >= CLUSAPI_VERSION_RS3
...
typedef struct _CREATE_CLUSTER_NAME_ACCOUNT {
  ...
  CLUSTER_MGMT_POINT_RESTYPE
  managementPointResType; // CLUSAPI Version >= CLUSAPI_VERSION_RS3
  BOOLEAN bUpgradeVCOs;   // CLUSAPI Version >= CLUSAPI_VERSION_RS3,
...
typedef BOOL(WINAPI *PCLUSAPI_PFN_REASON_HANDLER)(_In_ LPVOID lpParameter,
...
WINAPI
ClusapiSetReasonHandler(_In_ PCLUSAPI_REASON_HANDLER lpHandler);

typedef PCLUSAPI_REASON_HANDLER(WINAPI *PCLUSAPI_SET_REASON_HANDLER)(
...
DWORD
WINAPI
GetNodeClusterState(_In_opt_ LPCWSTR lpszNodeName,
                    _Out_ LPDWORD pdwClusterState);

typedef DWORD(WINAPI *PCLUSAPI_GET_NODE_CLUSTER_STATE)(
    _In_opt_ LPCWSTR lpszNodeName, _Out_ LPDWORD pdwClusterState);
...
HCLUSTER
WINAPI
OpenClusterEx(_In_opt_ LPCWSTR lpszClusterName, _In_ DWORD DesiredAccess,
              _Out_opt_ DWORD *GrantedAccess);

typedef HCLUSTER(WINAPI *PCLUSAPI_OPEN_CLUSTER_EX)(
    _In_opt_ LPCWSTR lpszClusterName, _In_ DWORD dwDesiredAccess,
    _Out_opt_ LPDWORD lpdwGrantedAccess);
#endif

BOOL WINAPI CloseCluster(_In_ HCLUSTER hCluster);

typedef BOOL(WINAPI *PCLUSAPI_CLOSE_CLUSTER)(_In_ HCLUSTER hCluster);

DWORD
WINAPI
SetClusterName(_In_ HCLUSTER hCluster, _In_ LPCWSTR lpszNewClusterName);

typedef DWORD(WINAPI *PCLUSAPI_SetClusterName)(_In_ HCLUSTER hCluster,
                                               _In_ LPCWSTR lpszNewClusterName);

#if (CLUSAPI_VERSION >= CLUSAPI_VERSION_NI)

__success(return == ERROR_SUCCESS) DWORD WINAPI
    SetClusterNameEx(_In_ HCLUSTER hCluster, _In_ LPCWSTR lpszNewClusterName,
                     _In_opt_ LPCWSTR lpszReason);

typedef DWORD(WINAPI *PCLUSAPI_SET_CLUSTER_NAME_EX)(
    _In_ HCLUSTER hCluster, _In_ LPCWSTR lpszNewClusterName,
    _In_opt_ LPCWSTR lpszReason);

#endif

_Success_(return == ERROR_SUCCESS) DWORD WINAPI
    GetClusterInformation(_In_ HCLUSTER hCluster,
                          _Out_writes_to_(*lpcchClusterName,
                                          *lpcchClusterName + 1)
...
typedef DWORD(WINAPI *PCLUSAPI_GET_CLUSTER_INFORMATION)(
    _In_ HCLUSTER hCluster,
    _Out_writes_to_(*lpcchClusterName, *lpcchClusterName + 1)
        LPWSTR lpszClusterName,
    _Inout_ LPDWORD lpcchClusterName,
    _Out_opt_ LPCLUSTERVERSIONINFO lpClusterInfo);

_Success_(return == ERROR_SUCCESS) DWORD WINAPI GetClusterQuorumResource(
    _In_ HCLUSTER hCluster,
    _Out_writes_to_(*lpcchResourceName, *lpcchResourceName + 1)
        LPWSTR lpszResourceName,
    _Inout_ LPDWORD lpcchResourceName,
    _Out_writes_to_(*lpcchDeviceName, *lpcchDeviceName + 1)
        LPWSTR lpszDeviceName,
    _Inout_ LPDWORD lpcchDeviceName, _Out_ LPDWORD lpdwMaxQuorumLogSize);
...
DWORD
WINAPI
SetClusterQuorumResource(_In_ HRESOURCE hResource,
                         _In_opt_ LPCWSTR lpszDeviceName,
                         _In_ DWORD dwMaxQuoLogSize);

typedef DWORD(WINAPI *PCLUSAPI_SET_CLUSTER_QUORUM_RESOURCE)(
    _In_ HRESOURCE hResource, _In_opt_ LPCWSTR lpszDeviceName,
    _In_ DWORD dwMaxQuoLogSize);

#if (CLUSAPI_VERSION >= CLUSAPI_VERSION_NI)

__success(return == ERROR_SUCCESS) DWORD WINAPI
    SetClusterQuorumResourceEx(_In_ HRESOURCE hResource,
                               _In_opt_ LPCWSTR lpszDeviceName,
...
typedef DWORD(WINAPI *PCLUSAPI_SET_CLUSTER_QUORUM_RESOURCE_EX)(
    _In_ HRESOURCE hResource, _In_opt_ LPCWSTR lpszDeviceName,
    _In_ DWORD dwMaxQuorumLogSize, _In_opt_ LPCWSTR lpszReason);

#endif

DWORD
WINAPI
BackupClusterDatabase(_In_ HCLUSTER hCluster, _In_ LPCWSTR lpszPathName);

typedef DWORD(WINAPI *PCLUSAPI_BACKUP_CLUSTER_DATABASE)(
    _In_ HCLUSTER hCluster, _In_ LPCWSTR lpszPathName);

DWORD
WINAPI
RestoreClusterDatabase(_In_ LPCWSTR lpszPathName, _In_ BOOL bForce,
                       _In_opt_ LPCWSTR lpszQuorumDriveLetter);

typedef DWORD(WINAPI *PCLUSAPI_RESTORE_CLUSTER_DATABASE)(
    _In_ LPCWSTR lpszPathName, _In_ BOOL bForce,
    _In_opt_ LPCWSTR lpszQuorumDriveLetter);

DWORD
WINAPI
SetClusterNetworkPriorityOrder(_In_ HCLUSTER hCluster, _In_ DWORD NetworkCount,
                               _In_reads_(NetworkCount) HNETWORK NetworkList[]);

typedef DWORD(WINAPI *PCLUSAPI_SET_CLUSTER_NETWORK_PRIORITY_ORDER)(
    _In_ HCLUSTER hCluster, _In_ DWORD NetworkCount,
    _In_reads_(NetworkCount) HNETWORK NetworkList[]);

DWORD
WINAPI
SetClusterServiceAccountPassword(
    _In_ LPCWSTR lpszClusterName, _In_ LPCWSTR lpszNewPassword,
    _In_ DWORD dwFlags,
    _Out_writes_bytes_to_opt_(*lpcbReturnStatusBufferSize,
...
DWORD
WINAPI
ClusterControl(_In_ HCLUSTER hCluster, _In_opt_ HNODE hHostNode,
...
DWORD
WINAPI
ClusterControlEx(_In_ HCLUSTER hCluster, _In_opt_ HNODE hHostNode,
                 _In_ DWORD dwControlCode,
                 _In_reads_bytes_opt_(nInBufferSize) LPVOID lpInBuffer,
                 _In_ DWORD nInBufferSize,
                 _Out_writes_bytes_to_opt_(nOutBufferSize, *lpBytesReturned)
...
typedef BOOL(WINAPI *PCLUSTER_UPGRADE_PROGRESS_CALLBACK)(
    PVOID pvCallbackArg, CLUSTER_UPGRADE_PHASE eUpgradePhase);

DWORD
WINAPI
ClusterUpgradeFunctionalLevel(_In_ HCLUSTER hCluster, _In_ BOOL perform,
                              _In_opt_ PCLUSTER_UPGRADE_PROGRESS_CALLBACK
                                  pfnProgressCallback,
                              _In_opt_ PVOID pvCallbackArg);

typedef DWORD(WINAPI *PCLUSAPI_CLUSTER_UPGRADE)(
    _In_ HCLUSTER hCluster, _In_ BOOL perform,
...
typedef enum CLUSTER_CHANGE_CLUSTER_V2 {
  ...
  CLUSTER_CHANGE_CLUSTER_ALL_V2 =
      (CLUSTER_CHANGE_CLUSTER_RECONNECT_V2 | CLUSTER_CHANGE_CLUSTER_STATE_V2 |
       ...
       CLUSTER_CHANGE_CLUSTER_RENAME_V2 | CLUSTER_CHANGE_CLUSTER_MEMBERSHIP_V2 |
...
typedef enum CLUSTER_CHANGE_GROUP_V2 {
  ...
  CLUSTER_CHANGE_GROUP_ALL_V2 =
      (CLUSTER_CHANGE_GROUP_DELETED_V2 |
       ...
       CLUSTER_CHANGE_GROUP_STATE_V2 | CLUSTER_CHANGE_GROUP_OWNER_NODE_V2 |
...
typedef enum CLUSTER_CHANGE_GROUPSET_V2 {
  ...
  CLUSTER_CHANGE_GROUPSET_ALL_V2 =
      (CLUSTER_CHANGE_GROUPSET_DELETED_v2 |
       ...
       CLUSTER_CHANGE_GROUPSET_STATE_V2 | CLUSTER_CHANGE_GROUPSET_GROUP_ADDED |
...
typedef enum CLUSTER_CHANGE_NETWORK_V2 {
  ...
  CLUSTER_CHANGE_NETWORK_ALL_V2 =
      (CLUSTER_CHANGE_NETWORK_DELETED_V2 |
       ...
       CLUSTER_CHANGE_NETWORK_STATE_V2 | CLUSTER_CHANGE_NETWORK_HANDLE_CLOSE_V2)
...
typedef enum CLUSTER_CHANGE_NODE_V2 {
  ...
  CLUSTER_CHANGE_NODE_ALL_V2 =
      (CLUSTER_CHANGE_NODE_NETINTERFACE_ADDED_V2 |
       CLUSTER_CHANGE_NODE_DELETED_V2 | CLUSTER_CHANGE_NODE_COMMON_PROPERTY_V2 |
       CLUSTER_CHANGE_NODE_PRIVATE_PROPERTY_V2 | CLUSTER_CHANGE_NODE_STATE_V2 |
       CLUSTER_CHANGE_NODE_GROUP_GAINED_V2 | CLUSTER_CHANGE_NODE_GROUP_LOST_V2 |
...
typedef enum CLUSTER_CHANGE_REGISTRY_V2 {
  ...
  CLUSTER_CHANGE_REGISTRY_ALL_V2 =
      (CLUSTER_CHANGE_REGISTRY_ATTRIBUTES_V2 | CLUSTER_CHANGE_REGISTRY_NAME_V2 |
...
HCHANGE
WINAPI
CreateClusterNotifyPortV2(_In_ HCHANGE hChange, _In_ HCLUSTER hCluster,
                          _In_ NOTIFY_FILTER_AND_TYPE *Filters,
                          _In_ DWORD dwFilterCount, _In_ DWORD_PTR dwNotifyKey);

typedef HCHANGE(WINAPI *PCLUSAPI_CREATE_CLUSTER_NOTIFY_PORT_V2)(
    _In_ HCHANGE hChange, _In_ HCLUSTER hCluster,
    _In_ NOTIFY_FILTER_AND_TYPE *Filters, _In_ DWORD dwFilterCount,
    _In_ DWORD_PTR dwNotifyKey);

DWORD
WINAPI
RegisterClusterNotifyV2(_In_ HCHANGE hChange,
                        _In_ NOTIFY_FILTER_AND_TYPE Filter, _In_ HANDLE hObject,
                        _In_ DWORD_PTR dwNotifyKey);

typedef DWORD(WINAPI *PCLUSAPI_REGISTER_CLUSTER_NOTIFY_V2)(
    _In_ HCHANGE hChange, _In_ NOTIFY_FILTER_AND_TYPE Filter,
    _In_ HANDLE hObject, _In_ DWORD_PTR dwNotifyKey);

DWORD
WINAPI
GetNotifyEventHandle(_In_ HCHANGE hChange, _Out_ LPHANDLE lphTargetEvent);

typedef DWORD(WINAPI *PCLUSAPI_GET_NOTIFY_EVENT_HANDLE_V2)(
    _In_ HCHANGE hChange, _Out_ LPHANDLE lphTargetEvent);

_Success_(return == ERROR_SUCCESS) DWORD WINAPI GetClusterNotifyV2(
    _In_ HCHANGE hChange, _Out_ DWORD_PTR *lpdwNotifyKey,
    ...
    _Inout_updates_to_opt_(*lpcchObjectId, *lpcchObjectId + 1)
        LPWSTR lpszObjectId,
    _Inout_opt_ LPDWORD lpcchObjectId,
    _Inout_updates_to_opt_(*lpcchParentId, *lpcchParentId + 1)
        LPWSTR lpszParentId,
    ...
    _Inout_opt_ LPDWORD lpcchType, _In_opt_ DWORD dwMilliseconds);

typedef DWORD(WINAPI *PCLUSAPI_GET_CLUSTER_NOTIFY_V2)(
    _In_ HCHANGE hChange, _Out_ DWORD_PTR *lpdwNotifyKey,
    _Inout_opt_ PNOTIFY_FILTER_AND_TYPE pFilterAndType,
    _Inout_opt_ BYTE *buffer, _Inout_opt_ LPDWORD lpcchBufferSize,
    _Inout_opt_ LPWSTR lpszObjectId, _Inout_opt_ LPDWORD lpcchObjectId,
    _Inout_opt_ LPWSTR lpszParentId, _Inout_opt_ LPDWORD lpcchParentId,
    _Inout_opt_ LPWSTR lpszName, _Inout_opt_ LPDWORD lpcchName,
    _Inout_opt_ LPWSTR lpszType, _Inout_opt_ LPDWORD lpcchType,
...
HCHANGE
WINAPI
CreateClusterNotifyPort(_In_ HCHANGE hChange, _In_ HCLUSTER hCluster,
                        _In_ DWORD dwFilter, _In_ DWORD_PTR dwNotifyKey);

typedef HCHANGE(WINAPI *PCLUSAPI_CREATE_CLUSTER_NOTIFY_PORT)(
    _In_ HCHANGE hChange, _In_ HCLUSTER hCluster, _In_ DWORD dwFilter,
    _In_ DWORD_PTR dwNotifyKey);

DWORD
WINAPI
RegisterClusterNotify(_In_ HCHANGE hChange, _In_ DWORD dwFilterType,
                      _In_ HANDLE hObject, _In_ DWORD_PTR dwNotifyKey);

typedef DWORD(WINAPI *PCLUSAPI_REGISTER_CLUSTER_NOTIFY)(
    _In_ HCHANGE hChange, _In_ DWORD dwFilterType, _In_ HANDLE hObject,
    _In_ DWORD_PTR dwNotifyKey);

_Success_(return == ERROR_SUCCESS) DWORD WINAPI
    GetClusterNotify(_In_ HCHANGE hChange, _Out_ DWORD_PTR *lpdwNotifyKey,
                     _Out_ LPDWORD lpdwFilterType,
                     _Out_writes_(*lpcchName) LPWSTR lpszName,
                     _Inout_ LPDWORD lpcchName, _In_ DWORD dwMilliseconds);
...
BOOL WINAPI CloseClusterNotifyPort(_In_ HCHANGE hChange);

typedef BOOL(WINAPI *PCLUSAPI_CLOSE_CLUSTER_NOTIFY_PORT)(_In_ HCHANGE hChange);
...
HCLUSENUM
WINAPI
ClusterOpenEnum(_In_ HCLUSTER hCluster, _In_ DWORD dwType);

typedef HCLUSENUM(WINAPI *PCLUSAPI_CLUSTER_OPEN_ENUM)(_In_ HCLUSTER hCluster,
                                                      _In_ DWORD dwType);

DWORD
WINAPI
ClusterGetEnumCount(_In_ HCLUSENUM hEnum);

typedef DWORD(WINAPI *PCLUSAPI_CLUSTER_GET_ENUM_COUNT)(_In_ HCLUSENUM hEnum);

_Success_(return == ERROR_SUCCESS) DWORD WINAPI
    ClusterEnum(_In_ HCLUSENUM hEnum, _In_ DWORD dwIndex,
...
typedef DWORD(WINAPI *PCLUSAPI_CLUSTER_ENUM)(
    _In_ HCLUSENUM hEnum, _In_ DWORD dwIndex, _Out_ LPDWORD lpdwType,
    _Out_writes_to_(*lpcchName, *lpcchName + 1) LPWSTR lpszName,
    _Inout_ LPDWORD lpcchName);

DWORD
WINAPI
ClusterCloseEnum(_In_ HCLUSENUM hEnum);

typedef DWORD(WINAPI *PCLUSAPI_CLUSTER_CLOSE_ENUM)(_In_ HCLUSENUM hEnum);

#if (CLUSAPI_VERSION >= CLUSAPI_VERSION_SERVER2008R2)

HCLUSENUMEX
WINAPI
ClusterOpenEnumEx(_In_ HCLUSTER hCluster, _In_ DWORD dwType,
                  _In_opt_ PVOID pOptions);

typedef HCLUSENUMEX(WINAPI *PCLUSAPI_CLUSTER_OPEN_ENUM_EX)(
    _In_ HCLUSTER hCluster, _In_ DWORD dwType, _In_opt_ PVOID pOptions);

DWORD
WINAPI
ClusterGetEnumCountEx(_In_ HCLUSENUMEX hClusterEnum);
...
DWORD
WINAPI
ClusterEnumEx(_In_ HCLUSENUMEX hClusterEnum, _In_ DWORD dwIndex,
              _Inout_ PCLUSTER_ENUM_ITEM pItem, _Inout_ LPDWORD cbItem);

typedef DWORD(WINAPI *PCLUSAPI_CLUSTER_ENUM_EX)(
    _In_ HCLUSENUMEX hClusterEnum, _In_ DWORD dwIndex,
    _Inout_ PCLUSTER_ENUM_ITEM pItem, _Inout_ LPDWORD cbItem);

DWORD
WINAPI
ClusterCloseEnumEx(_In_ HCLUSENUMEX hClusterEnum);
...
// Group Set StatusInformation Flags; These flags are set only by Cluster
// Service Only;
...
HGROUPSET
WINAPI
CreateClusterGroupSet(_In_ HCLUSTER hCluster, _In_ LPCWSTR groupSetName);

typedef HGROUPSET(WINAPI *PCLUSAPI_CREATE_CLUSTER_GROUP_GROUPSET)(
    _In_ HCLUSTER hCluster, _In_ LPCWSTR lpszGroupSetName);

HGROUPSET
WINAPI
OpenClusterGroupSet(_In_ HCLUSTER hCluster, _In_ LPCWSTR lpszGroupSetName);

typedef HGROUPSET(WINAPI *PCLUSAPI_OPEN_CLUSTER_GROUP_GROUPSET)(
    _In_ HCLUSTER hCluster, _In_ LPCWSTR lpszGroupSetName);

BOOL WINAPI CloseClusterGroupSet(_In_ HGROUPSET hGroupSet);
...
DWORD
WINAPI
DeleteClusterGroupSet(_In_ HGROUPSET hGroupSet);
...
DWORD
WINAPI
DeleteClusterGroupSetEx(_In_ HGROUPSET hGroupSet, _In_opt_ LPCWSTR lpszReason);

typedef DWORD(WINAPI *PCLUSAPI_DELETE_CLUSTER_GROUP_GROUPSET_EX)(
    _In_ HGROUPSET hGroupSet, _In_opt_ LPCWSTR lpszReason);

#endif

DWORD
WINAPI
ClusterAddGroupToGroupSet(_In_ HGROUPSET hGroupSet, _In_ HGROUP hGroup);

DWORD
WINAPI
ClusterAddGroupToGroupSetWithDomains(_In_ HGROUPSET hGroupSet,
                                     _In_ HGROUP hGroup, _In_ DWORD faultDomain,
                                     _In_ DWORD updateDomain);

typedef DWORD(WINAPI *PCLUSAPI_CLUSTER_ADD_GROUP_TO_GROUP_GROUPSET)(
    _In_ HGROUPSET hGroupSet, _In_ HGROUP hGroup);

#if (CLUSAPI_VERSION >= CLUSAPI_VERSION_NI)

DWORD
WINAPI
ClusterAddGroupToGroupSetWithDomainsEx(_In_ HGROUPSET hGroupSet,
                                       _In_ HGROUP hGroup,
...
typedef DWORD(WINAPI *PCLUSAPI_CLUSTER_ADD_GROUP_TO_GROUPSET_WITH_DOMAINS_EX)(
    _In_ HGROUPSET hGroupSet, _In_ HGROUP hGroup, _In_ DWORD faultDomain,
    _In_ DWORD updateDomain, _In_opt_ LPCWSTR lpszReason);

#endif

DWORD
WINAPI
ClusterRemoveGroupFromGroupSet(_In_ HGROUP hGroup);
...
DWORD
WINAPI
ClusterRemoveGroupFromGroupSetEx(_In_ HGROUP hGroup,
                                 _In_opt_ LPCWSTR lpszReason);
...
DWORD
WINAPI
ClusterGroupSetControl(_In_ HGROUPSET hGroupSet, _In_opt_ HNODE hHostNode,
                       _In_ DWORD dwControlCode,
                       _In_reads_bytes_opt_(cbInBufferSize) LPVOID lpInBuffer,
                       _In_ DWORD cbInBufferSize,
                       _Out_writes_bytes_to_opt_(cbOutBufferSize,
                                                 *lpBytesReturned)
                           LPVOID lpOutBuffer,
...
typedef DWORD(WINAPI *PCLUSAPI_CLUSTER_GROUP_GROUPSET_CONTROL)(
    _In_ HGROUPSET hGroupSet, _In_opt_ HNODE hHostNode,
    _In_ DWORD dwControlCode,
    _In_reads_bytes_opt_(cbInBufferSize) LPVOID lpInBuffer,
    _In_ DWORD cbInBufferSize,
    _Out_writes_bytes_to_opt_(cbOutBufferSize, *lpBytesReturned)
        LPVOID lpOutBuffer,
    _In_ DWORD cbOutBufferSize, _Out_opt_ LPDWORD lpBytesReturned);

#if (CLUSAPI_VERSION >= CLUSAPI_VERSION_NI)

__success(return == ERROR_SUCCESS) DWORD WINAPI ClusterGroupSetControlEx(
    _In_ HGROUPSET hGroupSet, _In_opt_ HNODE hHostNode,
    _In_ DWORD dwControlCode,
    _In_reads_bytes_opt_(cbInBufferSize) LPVOID lpInBuffer,
    _In_ DWORD cbInBufferSize,
...
DWORD
WINAPI
AddClusterGroupDependency(_In_ HGROUP hDependentGroup,
                          _In_ HGROUP hProviderGroup);

typedef DWORD(WINAPI *PCLUSAPI_ADD_CLUSTER_GROUP_DEPENDENCY)(
    _In_ HGROUP hDependentGroup, _In_ HGROUP hProviderGroup);

#if (CLUSAPI_VERSION >= CLUSAPI_VERSION_NI)

DWORD
WINAPI
AddClusterGroupDependencyEx(_In_ HGROUP hDependentGroup,
                            _In_ HGROUP hProviderGroup,
                            _In_opt_ LPCWSTR lpszReason);

typedef DWORD(WINAPI *PCLUSAPI_ADD_CLUSTER_GROUP_DEPENDENCY_EX)(
    _In_ HGROUP hDependentGroup, _In_ HGROUP hProviderGroup,
    _In_opt_ LPCWSTR lpszReason);
...
DWORD
WINAPI
SetGroupDependencyExpression(_In_ HGROUP hGroup,
                             _In_ LPCWSTR lpszDependencyExpression);

typedef DWORD(WINAPI *PCLUSAPI_SET_GROUP_DEPENDENCY_EXPRESSION)(
    _In_ HGROUP hGroupSet, _In_ LPCWSTR lpszDependencyExpression);

#if (CLUSAPI_VERSION >= CLUSAPI_VERSION_NI)

DWORD
WINAPI
SetGroupDependencyExpressionEx(_In_ HGROUP hGroup,
                               _In_ LPCWSTR lpszDependencyExpression,
                               _In_opt_ LPCWSTR lpszReason);

typedef DWORD(WINAPI *PCLUSAPI_SET_GROUP_DEPENDENCY_EXPRESSION_EX)(
    _In_ HGROUP hGroup, _In_ LPCWSTR lpszDependencyExpression,
    _In_opt_ LPCWSTR lpszReason);
...
DWORD
WINAPI
RemoveClusterGroupDependency(_In_ HGROUP hGroup, _In_ HGROUP hDependsOn);
...
DWORD
WINAPI
RemoveClusterGroupDependencyEx(_In_ HGROUP hGroup, _In_ HGROUP hDependsOn,
                               _In_opt_ LPCWSTR lpszReason);

typedef DWORD(WINAPI *PCLUSAPI_REMOVE_CLUSTER_GROUP_DEPENDENCY_EX)(
    _In_ HGROUP hGroup, _In_ HGROUP hDependsOn, _In_opt_ LPCWSTR lpszReason);

#endif

DWORD
WINAPI
AddClusterGroupSetDependency(_In_ HGROUPSET hDependentGroupSet,
                             _In_ HGROUPSET hProviderGroupSet);

typedef DWORD(WINAPI *PCLUSAPI_ADD_CLUSTER_GROUP_GROUPSET_DEPENDENCY)(
    _In_ HGROUPSET hDependentGroupSet, _In_ HGROUPSET hProviderGroupSet);

#if (CLUSAPI_VERSION >= CLUSAPI_VERSION_NI)

DWORD
WINAPI
AddClusterGroupSetDependencyEx(_In_ HGROUPSET hDependentGroupSet,
                               _In_ HGROUPSET hProviderGroupSet,
                               _In_opt_ LPCWSTR lpszReason);
...
DWORD
WINAPI
SetClusterGroupSetDependencyExpression(_In_ HGROUPSET hGroupSet,
                                       _In_ LPCWSTR lpszDependencyExprssion);

typedef DWORD(
    WINAPI *PCLUSAPI_SET_CLUSTER_GROUP_GROUPSET_DEPENDENCY_EXPRESSION)(
    _In_ HGROUPSET hGroupSet, _In_ LPCWSTR lpszDependencyExpression);

#if (CLUSAPI_VERSION >= CLUSAPI_VERSION_NI)

DWORD
WINAPI
SetClusterGroupSetDependencyExpressionEx(_In_ HGROUPSET hGroupSet,
                                         _In_ LPCWSTR lpszDependencyExpression,
                                         _In_opt_ LPCWSTR lpszReason);
...
DWORD
WINAPI
RemoveClusterGroupSetDependency(_In_ HGROUPSET hGroupSet,
                                _In_ HGROUPSET hDependsOn);

typedef DWORD(WINAPI *PCLUSAPI_REMOVE_CLUSTER_GROUP_GROUPSET_DEPENDENCY)(
    _In_ HGROUPSET hGroupSet, _In_ HGROUPSET hDependsOn);

#if (CLUSAPI_VERSION >= CLUSAPI_VERSION_NI)

DWORD
WINAPI
RemoveClusterGroupSetDependencyEx(_In_ HGROUPSET hGroupSet,
                                  _In_ HGROUPSET hDependsOn,
                                  _In_opt_ LPCWSTR lpszReason);
...
DWORD
WINAPI
AddClusterGroupToGroupSetDependency(_In_ HGROUP hDependentGroup,
                                    _In_ HGROUPSET hProviderGroupSet);

typedef DWORD(WINAPI *PCLUSAPI_ADD_CLUSTER_GROUP_TO_GROUP_GROUPSET_DEPENDENCY)(
    _In_ HGROUP hDependentGroup, _In_ HGROUPSET hProviderGroupSet);

#if (CLUSAPI_VERSION >= CLUSAPI_VERSION_NI)

DWORD
WINAPI
AddClusterGroupToGroupSetDependencyEx(_In_ HGROUP hDependentGroup,
                                      _In_ HGROUPSET hProviderGroupSet,
                                      _In_opt_ LPCWSTR lpszReason);
...
DWORD
WINAPI
RemoveClusterGroupToGroupSetDependency(_In_ HGROUP hGroup,
                                       _In_ HGROUPSET hDependsOn);

typedef DWORD(
    WINAPI *PCLUSAPI_REMOVE_CLUSTER_GROUP_TO_GROUP_GROUPSET_DEPENDENCY)(
    _In_ HGROUP hGroup, _In_ HGROUPSET hDependsOn);

#if (CLUSAPI_VERSION >= CLUSAPI_VERSION_NI)

DWORD
WINAPI
RemoveClusterGroupToGroupSetDependencyEx(_In_ HGROUP hGroup,
                                         _In_ HGROUPSET hDependsOn,
                                         _In_opt_ LPCWSTR lpszReason);

typedef DWORD(
    WINAPI *PCLUSAPI_REMOVE_CLUSTER_GROUP_TO_GROUP_GROUPSET_DEPENDENCY_EX)(
    _In_ HGROUP hGroup, _In_ HGROUPSET hDependsOn, _In_opt_ LPCWSTR lpszReason);

#endif

HGROUPSETENUM
WINAPI
ClusterGroupSetOpenEnum(IN HCLUSTER hCluster);

DWORD
WINAPI
ClusterGroupSetGetEnumCount(IN HGROUPSETENUM hGroupSetEnum);

__success(return == ERROR_SUCCESS) DWORD WINAPI
    ClusterGroupSetEnum(_In_ HGROUPSETENUM hGroupSetEnum, _In_ DWORD dwIndex,
                        _Out_writes_to_(*lpcchName, *lpcchName + 1)
                            LPWSTR lpszName,
                        _Inout_ LPDWORD lpcchName);

DWORD
WINAPI
ClusterGroupSetCloseEnum(IN HGROUPSETENUM hGroupSetEnum);

HCLUSTER
WINAPI
GetClusterFromGroupSet(_In_ HGROUPSET hGroupSet);
...
DWORD
WINAPI
AddCrossClusterGroupSetDependency(_In_ HGROUPSET hDependentGroupSet,
...
typedef DWORD(WINAPI *PCLUSAPI_ADD_CROSS_CLUSTER_GROUPSET_DEPENDENCY)(
    _In_ HGROUPSET hDependentGroupSet, _In_ LPCWSTR lpRemoteClusterName,
    _In_ LPCWSTR lpRemoteGroupSetName);

DWORD
WINAPI
RemoveCrossClusterGroupSetDependency(_In_ HGROUPSET hDependentGroupSet,
                                     _In_ LPCWSTR lpRemoteClusterName,
                                     _In_ LPCWSTR lpRemoteGroupSetName);
...
CreateClusterAvailabilitySet(
    _In_ HCLUSTER hCluster, _In_ LPCWSTR lpAvailabilitySetName,
    _In_ PCLUSTER_AVAILABILITY_SET_CONFIG pAvailabilitySetConfig);

typedef HGROUPSET(WINAPI *PCLUSAPI_CREATE_CLUSTER_AVAILABILITY_SET)(
    _In_ HCLUSTER hCluster, _In_ LPCWSTR lpAvailabilitySetName,
    _In_ PCLUSTER_AVAILABILITY_SET_CONFIG pAvailabilitySetConfig);

_Success_(return == ERROR_SUCCESS) DWORD WINAPI
    ClusterNodeReplacement(__in HCLUSTER hCluster,
...
DWORD
WINAPI
ClusterCreateAffinityRule(__in HCLUSTER hCluster, __in LPCWSTR ruleName,
                          __in CLUS_AFFINITY_RULE_TYPE ruleType);

typedef DWORD(WINAPI *PCLUSAPI_CLUSTER_CREATE_AFFINITY_RULE)(
    __in HCLUSTER hCluster, __in LPCWSTR ruleName,
    __in CLUS_AFFINITY_RULE_TYPE ruleType);

DWORD
WINAPI
ClusterRemoveAffinityRule(__in HCLUSTER hCluster, __in LPCWSTR ruleName);

typedef DWORD(WINAPI *PCLUSAPI_CLUSTER_REMOVE_AFFINITY_RULE)(
    __in HCLUSTER hCluster, __in LPCWSTR ruleName);

DWORD
WINAPI
ClusterAddGroupToAffinityRule(__in HCLUSTER hCluster, __in LPCWSTR ruleName,
                              __in HGROUP hGroup);

typedef DWORD(WINAPI *PCLUSAPI_CLUSTER_ADD_GROUP_TO_AFFINITY_RULE)(
    __in HCLUSTER hCluster, __in LPCWSTR ruleName, __in HGROUP hGroup);

DWORD
WINAPI
ClusterRemoveGroupFromAffinityRule(__in HCLUSTER hCluster,
                                   __in LPCWSTR ruleName, __in HGROUP hGroup);

typedef DWORD(WINAPI *PCLUSAPI_CLUSTER_REMOVE_GROUP_FROM_AFFINITY_RULE)(
    __in HCLUSTER hCluster, __in LPCWSTR ruleName, __in HGROUP hGroup);

DWORD
WINAPI
ClusterAffinityRuleControl(
    _In_ HCLUSTER hCluster, _In_ LPCWSTR affinityRuleName,
...
typedef DWORD(WINAPI *PCLUSAPI_CLUSTER_AFFINITY_RULE_CONTROL)(
    _In_ HCLUSTER hCluster, _In_ LPCWSTR affinityRuleName,
    _In_opt_ HNODE hHostNode, _In_ DWORD dwControlCode,
    _In_reads_bytes_opt_(cbInBufferSize) LPVOID lpInBuffer,
    _In_ DWORD cbInBufferSize,
...
typedef enum CLUSTER_NODE_STATUS {
  ...
  NodeStatusMax = (NodeStatusIsolated | NodeStatusQuarantined |
                   NodeStatusDrainFailed | NodeStatusAvoidPlacement)
} CLUSTER_NODE_STATUS;
...
HNODE
WINAPI
OpenClusterNode(_In_ HCLUSTER hCluster, _In_ LPCWSTR lpszNodeName);

typedef HNODE(WINAPI *PCLUSAPI_OPEN_CLUSTER_NODE)(_In_ HCLUSTER hCluster,
                                                  _In_ LPCWSTR lpszNodeName);

#if (CLUSAPI_VERSION >= CLUSAPI_VERSION_SERVER2008R2)
HNODE
WINAPI
OpenClusterNodeEx(_In_ HCLUSTER hCluster, _In_opt_ LPCWSTR lpszNodeName,
                  _In_ DWORD dwDesiredAccess,
                  _Out_opt_ DWORD *lpdwGrantedAccess);

typedef HNODE(WINAPI *PCLUSAPI_OPEN_CLUSTER_NODE_EX)(
    _In_ HCLUSTER hCluster, _In_opt_ LPCWSTR lpszNodeName,
...
HNODE
WINAPI
OpenClusterNodeById(__in HCLUSTER hCluster, __in DWORD nodeId);

typedef HNODE(WINAPI *PCLUSAPI_OPEN_NODE_BY_ID)(__in HCLUSTER hCluster,
                                                __in DWORD nodeId);
#endif

BOOL WINAPI CloseClusterNode(_In_ HNODE hNode);

typedef BOOL(WINAPI *PCLUSAPI_CLOSE_CLUSTER_NODE)(_In_ HNODE hNode);

CLUSTER_NODE_STATE
WINAPI
GetClusterNodeState(_In_ HNODE hNode);

typedef CLUSTER_NODE_STATE(WINAPI *PCLUSAPI_GET_CLUSTER_NODE_STATE)(
    _In_ HNODE hNode);

_Success_(return == ERROR_SUCCESS) DWORD WINAPI
    GetClusterNodeId(_In_opt_ HNODE hNode,
                     _Out_writes_to_(*lpcchName, *lpcchName + 1)
                         LPWSTR lpszNodeId,
                     _Inout_ LPDWORD lpcchName);

typedef DWORD(WINAPI *PCLUSAPI_GET_CLUSTER_NODE_ID)(
...
HCLUSTER
WINAPI
GetClusterFromNode(_In_ HNODE hNode);

typedef HCLUSTER(WINAPI *PCLUSAPI_GET_CLUSTER_FROM_NODE)(_In_ HNODE hNode);

DWORD
WINAPI
PauseClusterNode(_In_ HNODE hNode);

typedef DWORD(WINAPI *PCLUSAPI_PAUSE_CLUSTER_NODE)(_In_ HNODE hNode);

DWORD
WINAPI
ResumeClusterNode(_In_ HNODE hNode);

typedef DWORD(WINAPI *PCLUSAPI_RESUME_CLUSTER_NODE)(_In_ HNODE hNode);

DWORD
WINAPI
EvictClusterNode(_In_ HNODE hNode);

typedef DWORD(WINAPI *PCLUSAPI_EVICT_CLUSTER_NODE)(_In_ HNODE hNode);

HNETINTERFACEENUM
WINAPI
ClusterNetInterfaceOpenEnum(_In_ HCLUSTER hCluster,
                            _In_opt_ LPCWSTR lpszNodeName,
                            _In_opt_ LPCWSTR lpszNetworkName);

__success(return == ERROR_SUCCESS) DWORD WINAPI
    ClusterNetInterfaceEnum(_In_ HNETINTERFACEENUM hNetInterfaceEnum,
                            _In_ DWORD dwIndex,
                            _Out_writes_to_(*lpcchName, *lpcchName + 1)
                                LPWSTR lpszName,
                            _Inout_ LPDWORD lpcchName);
...
DWORD
WINAPI
ClusterNetInterfaceCloseEnum(_In_ HNETINTERFACEENUM hNetInterfaceEnum);

HNODEENUM
WINAPI
ClusterNodeOpenEnum(_In_ HNODE hNode, _In_ DWORD dwType);

typedef HNODEENUM(WINAPI *PCLUSAPI_CLUSTER_NODE_OPEN_ENUM)(_In_ HNODE hNode,
                                                           _In_ DWORD dwType);
...
HNODEENUMEX
WINAPI
ClusterNodeOpenEnumEx(_In_ HNODE hNode, _In_ DWORD dwType,
                      _In_opt_ PVOID pOptions);

typedef HNODEENUMEX(WINAPI *PCLUSAPI_CLUSTER_NODE_OPEN_ENUM_EX)(
    _In_ HNODE hNode, _In_ DWORD dwType, _In_opt_ PVOID pOptions);

DWORD
WINAPI
ClusterNodeGetEnumCountEx(_In_ HNODEENUMEX hNodeEnum);

typedef DWORD(WINAPI *PCLUSAPI_CLUSTER_NODE_GET_ENUM_COUNT_EX)(
    _In_ HNODEENUMEX hNodeEnum);

DWORD
WINAPI
ClusterNodeEnumEx(_In_ HNODEENUMEX hNodeEnum, _In_ DWORD dwIndex,
                  _Inout_ PCLUSTER_ENUM_ITEM pItem, _Inout_ LPDWORD cbItem);

typedef DWORD(WINAPI *PCLUSAPI_CLUSTER_NODE_ENUM_EX)(
    _In_ HNODEENUMEX hNodeEnum, _In_ DWORD dwIndex,
    _Inout_ PCLUSTER_ENUM_ITEM pItem, _Inout_ LPDWORD cbItem);

DWORD
WINAPI
ClusterNodeCloseEnumEx(_In_ HNODEENUMEX hNodeEnum);

typedef DWORD(WINAPI *PCLUSAPI_CLUSTER_NODE_CLOSE_ENUM_EX)(
    _In_ HNODEENUMEX hNodeEnum);
...
DWORD
WINAPI
ClusterNodeGetEnumCount(_In_ HNODEENUM hNodeEnum);

typedef DWORD(WINAPI *PCLUSAPI_CLUSTER_NODE_GET_ENUM_COUNT)(
    _In_ HNODEENUM hNodeEnum);

DWORD
WINAPI
ClusterNodeCloseEnum(_In_ HNODEENUM hNodeEnum);

typedef DWORD(WINAPI *PCLUSAPI_CLUSTER_NODE_CLOSE_ENUM)(
    _In_ HNODEENUM hNodeEnum);

_Success_(return == ERROR_SUCCESS) DWORD WINAPI
    ClusterNodeEnum(_In_ HNODEENUM hNodeEnum, _In_ DWORD dwIndex,
                    _Out_ LPDWORD lpdwType,
                    _Out_writes_to_(*lpcchName, *lpcchName + 1) LPWSTR lpszName,
                    _Inout_ LPDWORD lpcchName);

typedef DWORD(WINAPI *PCLUSAPI_CLUSTER_NODE_ENUM)(
    _In_ HNODEENUM hNodeEnum, _In_ DWORD dwIndex, _Out_ LPDWORD lpdwType,
    _Out_writes_to_(*lpcchName, *lpcchName + 1) LPWSTR lpszName,
    _Inout_ LPDWORD lpcchName);

DWORD
WINAPI
EvictClusterNodeEx(_In_ HNODE hNode, _In_ DWORD dwTimeOut,
                   _Out_ HRESULT *phrCleanupStatus);

typedef DWORD(WINAPI *PCLUSAPI_EVICT_CLUSTER_NODE_EX)(
    _In_ HNODE hNode, _In_ DWORD dwTimeOut, _Out_ HRESULT *phrCleanupStatus);

#if (CLUSAPI_VERSION >= CLUSAPI_VERSION_NI)

DWORD
WINAPI
EvictClusterNodeEx2(_In_ HNODE hNode, _In_ DWORD dwTimeout,
                    _Out_ HRESULT *phrCleanupStatus,
                    _In_opt_ LPCWSTR lpszReason);

typedef DWORD(WINAPI *PCLUSAPI_EVICT_CLUSTER_NODE_EX2)(
    _In_ HNODE hNode, _In_ DWORD dwTimeout, _Out_ HRESULT *phrCleanupStatus,
    _In_opt_ LPCWSTR lpszReason);
...
#if (!MIDL_PASS && !__midl)
HKEY WINAPI GetClusterResourceTypeKey(_In_ HCLUSTER hCluster,
                                      _In_ LPCWSTR lpszTypeName,
                                      _In_ REGSAM samDesired);

typedef HKEY(WINAPI *PCLUSAPI_GET_CLUSTER_RESOURCE_TYPE_KEY)(
    _In_ HCLUSTER hCluster, _In_ LPCWSTR lpszTypeName, _In_ REGSAM samDesired);
...
HGROUP
WINAPI
CreateClusterGroup(_In_ HCLUSTER hCluster, _In_ LPCWSTR lpszGroupName);

typedef HGROUP(WINAPI *PCLUSAPI_CREATE_CLUSTER_GROUP)(
    _In_ HCLUSTER hCluster, _In_ LPCWSTR lpszGroupName);

HGROUP
WINAPI
OpenClusterGroup(_In_ HCLUSTER hCluster, _In_ LPCWSTR lpszGroupName);

typedef HGROUP(WINAPI *PCLUSAPI_OPEN_CLUSTER_GROUP)(_In_ HCLUSTER hCluster,
                                                    _In_ LPCWSTR lpszGroupName);

#if (CLUSAPI_VERSION >= CLUSAPI_VERSION_SERVER2008R2)
HGROUP
WINAPI
OpenClusterGroupEx(_In_ HCLUSTER hCluster, _In_opt_ LPCWSTR lpszGroupName,
                   _In_ DWORD dwDesiredAccess,
                   _Out_opt_ DWORD *lpdwGrantedAccess);

typedef HGROUP(WINAPI *PCLUSAPI_OPEN_CLUSTER_GROUP_EX)(
    _In_ HCLUSTER hCluster, _In_opt_ LPCWSTR lpszGroupName,
    _In_ DWORD dwDesiredAccess, _Out_opt_ LPDWORD lpdwGrantedAccess);
...
DWORD
WINAPI
PauseClusterNodeEx(_In_ HNODE hNode, _In_ BOOL bDrainNode,
                   _In_ DWORD dwPauseFlags, _In_opt_ HNODE hNodeDrainTarget);

typedef DWORD(WINAPI *PCLUSAPI_PAUSE_CLUSTER_NODE_EX)(
    _In_ HNODE hNode, _In_ BOOL bDrainNode, _In_ DWORD dwPauseFlags,
...
DWORD
WINAPI
PauseClusterNodeEx2(_In_ HNODE hNode, _In_ BOOL bDrainNode,
                    _In_ DWORD dwPauseFlags, _In_opt_ HNODE hNodeDrainTarget,
                    _In_opt_ LPCWSTR lpszReason);

typedef DWORD(WINAPI *PCLUSAPI_PAUSE_CLUSTER_NODE_EX2)(
    _In_ HNODE hNode, _In_ BOOL bDrainNode, _In_ DWORD dwPauseFlags,
    _In_opt_ HNODE hNodeDrainTarget, _In_opt_ LPCWSTR lpszReason);
...
DWORD
WINAPI
ResumeClusterNodeEx2(_In_ HNODE hNode,
                     _In_ CLUSTER_NODE_RESUME_FAILBACK_TYPE eResumeFailbackType,
                     _In_ DWORD dwResumeFlagsReserved,
                     _In_opt_ LPCWSTR lpszReason);

typedef DWORD(WINAPI *PCLUSAPI_RESUME_CLUSTER_NODE_EX2)(
    _In_ HNODE hNode,
    _In_ CLUSTER_NODE_RESUME_FAILBACK_TYPE eResumeFailbackType,
    _In_ DWORD dwResumeFlagsReserved, _In_opt_ LPCWSTR lpszReason);

#endif

// Group StatusInformation Flags; These flags are set only by Cluster Service
// Only;
...
HGROUP
WINAPI
CreateClusterGroupEx(_In_ HCLUSTER hCluster, _In_ LPCWSTR lpszGroupName,
                     _In_opt_ PCLUSTER_CREATE_GROUP_INFO pGroupInfo);

typedef HGROUP(WINAPI *PCLUSAPI_CREATE_CLUSTER_GROUPEX)(
    _In_ HCLUSTER hCluster, _In_ LPCWSTR lpszGroupName,
    _In_opt_ PCLUSTER_CREATE_GROUP_INFO pGroupInfo);

HGROUPENUMEX
WINAPI
ClusterGroupOpenEnumEx(_In_ HCLUSTER hCluster,
                       _In_reads_bytes_opt_(cbProperties)
                           LPCWSTR lpszProperties,
                       _In_ DWORD cbProperties,
                       _In_reads_bytes_opt_(cbRoProperties)
                           LPCWSTR lpszRoProperties,
                       _In_ DWORD cbRoProperties, _In_ DWORD dwFlags);

typedef HGROUPENUMEX(WINAPI *PCLUSAPI_CLUSTER_GROUP_OPEN_ENUM_EX)(
    _In_ HCLUSTER hCluster,
...
DWORD
WINAPI
ClusterGroupGetEnumCountEx(_In_ HGROUPENUMEX hGroupEnumEx);

typedef DWORD(WINAPI *PCLUSAPI_CLUSTER_GROUP_GET_ENUM_COUNT_EX)(
    _In_ HGROUPENUMEX hGroupEnumEx);

DWORD
WINAPI
ClusterGroupEnumEx(_In_ HGROUPENUMEX hGroupEnumEx, _In_ DWORD dwIndex,
                   _Inout_ PCLUSTER_GROUP_ENUM_ITEM pItem,
                   _Inout_ LPDWORD cbItem);

typedef DWORD(WINAPI *PCLUSAPI_CLUSTER_GROUP_ENUM_EX)(
    _In_ HGROUPENUMEX hGroupEnumEx, _In_ DWORD dwIndex,
    _Inout_ PCLUSTER_GROUP_ENUM_ITEM pItem, _Inout_ LPDWORD cbItem);

DWORD
WINAPI
ClusterGroupCloseEnumEx(_In_ HGROUPENUMEX hGroupEnumEx);

typedef DWORD(WINAPI *PCLUSAPI_CLUSTER_GROUP_CLOSE_ENUM_EX)(
    _In_ HGROUPENUMEX hGroupEnumEx);
...
HRESENUMEX
WINAPI
ClusterResourceOpenEnumEx(_In_ HCLUSTER hCluster,
                          _In_reads_bytes_opt_(cbProperties)
                              LPCWSTR lpszProperties,
                          _In_ DWORD cbProperties,
                          _In_reads_bytes_opt_(cbRoProperties)
...
DWORD
WINAPI
ClusterResourceGetEnumCountEx(_In_ HRESENUMEX hResourceEnumEx);

typedef DWORD(WINAPI *PCLUSAPI_CLUSTER_RESOURCE_GET_ENUM_COUNT_EX)(
    _In_ HRESENUMEX hResourceEnumEx);

DWORD
WINAPI
ClusterResourceEnumEx(_In_ HRESENUMEX hResourceEnumEx, _In_ DWORD dwIndex,
                      _Inout_ PCLUSTER_RESOURCE_ENUM_ITEM pItem,
                      _Inout_ LPDWORD cbItem);

typedef DWORD(WINAPI *PCLUSAPI_CLUSTER_RESOURCE_ENUM_EX)(
    _In_ HRESENUMEX hResourceEnumEx, _In_ DWORD dwIndex,
    _Inout_ PCLUSTER_RESOURCE_ENUM_ITEM pItem, _Inout_ LPDWORD cbItem);

DWORD
WINAPI
ClusterResourceCloseEnumEx(_In_ HRESENUMEX hResourceEnumEx);

typedef DWORD(WINAPI *PCLUSAPI_CLUSTER_RESOURCE_CLOSE_ENUM_EX)(
    _In_ HRESENUMEX hResourceEnumEx);
...
DWORD WINAPI OnlineClusterGroupEx(_In_ HGROUP hGroup,
                                  _In_opt_ HNODE hDestinationNode,
                                  _In_ DWORD dwOnlineFlags,
                                  _In_reads_bytes_opt_(cbInBufferSize)
                                      PBYTE lpInBuffer,
                                  _In_ DWORD cbInBufferSize);

#define CLUSAPI_GROUP_OFFLINE_IGNORE_RESOURCE_STATUS 0x00000001

DWORD WINAPI OfflineClusterGroupEx(_In_ HGROUP hGroup,
...
DWORD
WINAPI
OnlineClusterGroupEx2(_In_ HGROUP hGroup, _In_opt_ HNODE hDestinationNode,
                      _In_ DWORD dwOnlineFlags,
                      _In_reads_bytes_opt_(cbInBufferSize) PBYTE lpInBuffer,
                      _In_ DWORD cbInBufferSize, _In_opt_ LPCWSTR lpszReason);

DWORD
WINAPI
OfflineClusterGroupEx2(__in HGROUP hGroup, __in DWORD dwOfflineFlags,
                       __in_opt PBYTE lpInBuffer, __in DWORD cbInBufferSize,
                       _In_opt_ LPCWSTR lpszReason);
...
DWORD WINAPI OnlineClusterResourceEx(_In_ HRESOURCE hResource,
                                     _In_ DWORD dwOnlineFlags,
                                     _In_reads_bytes_opt_(cbInBufferSize)
                                         PBYTE lpInBuffer,
                                     _In_ DWORD cbInBufferSize);
...
DWORD
WINAPI
OnlineClusterResourceEx2(_In_ HRESOURCE hResource, _In_ DWORD dwOnlineFlags,
                         _In_reads_bytes_opt_(cbInBufferSize) PBYTE lpInBuffer,
                         _In_ DWORD cbInBufferSize,
                         _In_opt_ LPCWSTR lpszReason);
...
// these are passed through the RHS offline resource call for V2 and later
// resources
...
DWORD WINAPI OfflineClusterResourceEx(_In_ HRESOURCE hResource,
                                      _In_ DWORD dwOfflineFlags,
                                      _In_reads_bytes_opt_(cbInBufferSize)
                                          PBYTE lpInBuffer,
                                      _In_ DWORD cbInBufferSize);
...
DWORD
WINAPI
OfflineClusterResourceEx2(_In_ HRESOURCE hResource, _In_ DWORD dwOfflineFlags,
                          _In_reads_bytes_opt_(cbInBufferSize) PBYTE lpInBuffer,
                          _In_ DWORD cbInBufferSize,
                          _In_opt_ LPCWSTR lpszReason);
...
#define CLUSAPI_VALID_CHANGE_RESOURCE_GROUP_FLAGS                              \
  (CLUSAPI_CHANGE_RESOURCE_GROUP_FORCE_MOVE_TO_CSV)

DWORD
WINAPI
MoveClusterGroupEx(_In_ HGROUP hGroup, _In_opt_ HNODE hDestinationNode,
...
DWORD
WINAPI
MoveClusterGroupEx2(_In_ HGROUP hGroup, _In_opt_ HNODE hDestinationNode,
                    _In_ DWORD dwMoveFlags,
                    _In_reads_bytes_opt_(cbInBufferSize) PBYTE lpInBuffer,
                    _In_ DWORD cbInBufferSize, _In_opt_ LPCWSTR lpszReason);
...
DWORD WINAPI CancelClusterGroupOperation(_In_ HGROUP hGroup,
                                         _In_ DWORD dwCancelFlags_RESERVED);

DWORD WINAPI RestartClusterResource(_In_ HRESOURCE hResource,
                                    _In_ DWORD dwFlags);

typedef DWORD(WINAPI *PCLUSAPI_RESTART_CLUSTER_RESOURCE)(HRESOURCE hResource,
                                                         DWORD dwFlags);
...
DWORD
WINAPI
RestartClusterResourceEx(_In_ HRESOURCE hResource, _In_ DWORD dwFlags,
                         _In_opt_ LPCWSTR lpszReason);

typedef DWORD(WINAPI *PCLUSAPI_RESTART_CLUSTER_RESOURCE_EX)(HRESOURCE hResource,
                                                            DWORD dwFlags);
...
BOOL WINAPI CloseClusterGroup(_In_ HGROUP hGroup);

typedef BOOL(WINAPI *PCLUSAPI_CLOSE_CLUSTER_GROUP)(_In_ HGROUP hGroup);

HCLUSTER
WINAPI
GetClusterFromGroup(_In_ HGROUP hGroup);

typedef HCLUSTER(WINAPI *PCLUSAPI_GET_CLUSTER_FROM_GROUP)(_In_ HGROUP hGroup);

_Success_(return >= 0) //!= ClusterGroupStateUnknown
    CLUSTER_GROUP_STATE WINAPI
    GetClusterGroupState(_In_ HGROUP hGroup,
                         _Out_writes_to_opt_(*lpcchNodeName, *lpcchNodeName + 1)
                             LPWSTR lpszNodeName,
                         _Inout_opt_ LPDWORD lpcchNodeName);

typedef CLUSTER_GROUP_STATE(WINAPI *PCLUSAPI_GET_CLUSTER_GROUP_STATE)(
    _In_ HGROUP hGroup,
...
DWORD
WINAPI
SetClusterGroupName(_In_ HGROUP hGroup, _In_ LPCWSTR lpszGroupName);

typedef DWORD(WINAPI *PCLUSAPI_SET_CLUSTER_GROUP_NAME)(HGROUP hGroup,
                                                       LPCWSTR lpszGroupName);

DWORD
WINAPI
SetClusterGroupNodeList(_In_ HGROUP hGroup, _In_ DWORD NodeCount,
                        _In_reads_opt_(NodeCount) HNODE NodeList[]);

typedef DWORD(WINAPI *PCLUSAPI_SET_CLUSTER_GROUP_NODE_LIST)(
    _In_ HGROUP hGroup, _In_ DWORD NodeCount,
    _In_reads_opt_(NodeCount) HNODE NodeList[]);
...
DWORD
WINAPI
SetClusterGroupNameEx(_In_ HGROUP hGroup, _In_ LPCWSTR lpszGroupName,
                      _In_opt_ LPCWSTR lpszReason);

typedef DWORD(WINAPI *PCLUSAPI_SET_CLUSTER_GROUP_NAME_EX)(
    _In_ HGROUP hGroup, _In_ LPCWSTR lpszGroupName,
    _In_opt_ LPCWSTR lpszReason);

DWORD
WINAPI
SetClusterGroupNodeListEx(__in HGROUP hGroup, __in DWORD NodeCount,
                          __in_ecount(NodeCount) HNODE NodeList[],
                          _In_opt_ LPCWSTR lpszReason);

typedef DWORD(WINAPI *PCLUSAPI_SET_CLUSTER_GROUP_NODE_LIST_EX)(
    _In_ HGROUP hGroup, _In_ DWORD NodeCount,
    _In_reads_opt_(NodeCount) HNODE NodeList[], _In_opt_ LPCWSTR lpszReason);

#endif

DWORD
WINAPI
OnlineClusterGroup(_In_ HGROUP hGroup, _In_opt_ HNODE hDestinationNode);

typedef DWORD(WINAPI *PCLUSAPI_ONLINE_CLUSTER_GROUP)(
    _In_ HGROUP hGroup, _In_opt_ HNODE hDestinationNode);

DWORD
WINAPI
MoveClusterGroup(_In_ HGROUP hGroup, _In_opt_ HNODE hDestinationNode);

typedef DWORD(WINAPI *PCLUSAPI_MOVE_CLUSTER_GROUP)(
    _In_ HGROUP hGroup, _In_opt_ HNODE hDestinationNode);

DWORD
WINAPI
OfflineClusterGroup(_In_ HGROUP hGroup);

typedef DWORD(WINAPI *PCLUSAPI_OFFLINE_CLUSTER_GROUP)(HGROUP hGroup);

DWORD
WINAPI
DeleteClusterGroup(_In_ HGROUP hGroup);

typedef DWORD(WINAPI *PCLUSAPI_DELETE_CLUSTER_GROUP)(HGROUP hGroup);

DWORD
WINAPI
DestroyClusterGroup(_In_ HGROUP hGroup);
...
DWORD
WINAPI
DeleteClusterGroupEx(_In_ HGROUP hGroup, _In_opt_ LPCWSTR lpszReason);

typedef DWORD(WINAPI *PCLUSAPI_DELETE_CLUSTER_GROUP_EX)(
    _In_ HGROUP hGroup, _In_opt_ LPCWSTR lpszReason);

DWORD
WINAPI
DestroyClusterGroupEx(_In_ HGROUP hGroup, _In_opt_ LPCWSTR lpszReason);

typedef DWORD(WINAPI *PCLUSAPI_DESTROY_CLUSTER_GROUP_EX)(
    _In_ HGROUP hGroup, _In_opt_ LPCWSTR lpszReason);
...
HGROUPENUM
WINAPI
ClusterGroupOpenEnum(_In_ HGROUP hGroup, _In_ DWORD dwType);

typedef HGROUPENUM(WINAPI *PCLUSAPI_CLUSTER_GROUP_OPEN_ENUM)(HGROUP hGroup,
                                                             DWORD dwType);

DWORD
WINAPI
ClusterGroupGetEnumCount(_In_ HGROUPENUM hGroupEnum);

typedef DWORD(WINAPI *PCLUSAPI_CLUSTER_GROUP_GET_ENUM_COUNT)(
    _In_ HGROUPENUM hGroupEnum);

_Success_(return == ERROR_SUCCESS) DWORD WINAPI
    ClusterGroupEnum(_In_ HGROUPENUM hGroupEnum, _In_ DWORD dwIndex,
                     _Out_ LPDWORD lpdwType,
                     _Out_writes_to_(*lpcchName, *lpcchName + 1)
                         LPWSTR lpszResourceName,
                     _Inout_ LPDWORD lpcchName);

typedef DWORD(WINAPI *PCLUSAPI_CLUSTER_GROUP_ENUM)(
    _In_ HGROUPENUM hGroupEnum, _In_ DWORD dwIndex, _Out_ LPDWORD lpdwType,
    _Out_writes_to_(*lpcchName, *lpcchName + 1) LPWSTR lpszResourceName,
    _Inout_ LPDWORD lpcchName);

DWORD
WINAPI
ClusterGroupCloseEnum(_In_ HGROUPENUM hGroupEnum);
...
HRESOURCE
WINAPI
CreateClusterResource(_In_ HGROUP hGroup, _In_ LPCWSTR lpszResourceName,
                      _In_ LPCWSTR lpszResourceType, _In_ DWORD dwFlags);

typedef HRESOURCE(WINAPI *PCLUSAPI_CREATE_CLUSTER_RESOURCE)(
    HGROUP hGroup, LPCWSTR lpszResourceName, LPCWSTR lpszResourceType,
    DWORD dwFlags);
...
HRESOURCE
WINAPI
CreateClusterResourceEx(_In_ HGROUP hGroup, _In_ LPCWSTR lpszResourceName,
                        _In_ LPCWSTR lpszResourceType, _In_ DWORD dwFlags,
                        _In_opt_ LPCWSTR lpszReason);

typedef HRESOURCE(WINAPI *PCLUSAPI_CREATE_CLUSTER_RESOURCE_EX)(
    _In_ HGROUP hGroup, _In_ LPCWSTR lpszResourceName,
    _In_ LPCWSTR lpszResourceType, _In_ DWORD dwFlags,
    _In_opt_ LPCWSTR lpszReason);
...
HRESOURCE
WINAPI
OpenClusterResource(_In_ HCLUSTER hCluster, _In_ LPCWSTR lpszResourceName);

typedef HRESOURCE(WINAPI *PCLUSAPI_OPEN_CLUSTER_RESOURCE)(
    HCLUSTER hCluster, LPCWSTR lpszResourceName);

#if (CLUSAPI_VERSION >= CLUSAPI_VERSION_SERVER2008R2)
HRESOURCE
WINAPI
OpenClusterResourceEx(_In_ HCLUSTER hCluster, _In_opt_ LPCWSTR lpszResourceName,
                      _In_ DWORD dwDesiredAccess,
                      _Out_opt_ DWORD *lpdwGrantedAccess);

typedef HRESOURCE(WINAPI *PCLUSAPI_OPEN_CLUSTER_RESOURCE_EX)(
    _In_ HCLUSTER hCluster, _In_opt_ LPCWSTR lpszResourceName,
    _In_ DWORD dwDesiredAccess, _Out_opt_ LPDWORD lpdwGrantedAccess);
#endif

BOOL WINAPI CloseClusterResource(_In_ HRESOURCE hResource);

typedef BOOL(WINAPI *PCLUSAPI_CLOSE_CLUSTER_RESOURCE)(HRESOURCE hResource);

HCLUSTER
WINAPI
GetClusterFromResource(_In_ HRESOURCE hResource);

typedef HCLUSTER(WINAPI *PCLUSAPI_GET_CLUSTER_FROM_RESOURCE)(
    _In_ HRESOURCE hResource);

DWORD
WINAPI
DeleteClusterResource(_In_ HRESOURCE hResource);
...
DWORD
WINAPI
DeleteClusterResourceEx(_In_ HRESOURCE hResource, _In_opt_ LPCWSTR lpszReason);

typedef DWORD(WINAPI *PCLUSAPI_DELETE_CLUSTER_RESOURCE_EX)(
    _In_ HRESOURCE hResource, _In_opt_ LPCWSTR lpszReason);

#endif

_Success_(return >= 0) // != ClusterResourceStateUnknown
    CLUSTER_RESOURCE_STATE WINAPI
    GetClusterResourceState(_In_ HRESOURCE hResource,
                            _Out_writes_to_opt_(*lpcchNodeName, *lpcchNodeName)
                                LPWSTR lpszNodeName,
                            _Inout_opt_ LPDWORD lpcchNodeName,
                            _Out_writes_to_opt_(*lpcchGroupName,
                                                *lpcchGroupName)
...
DWORD
WINAPI
SetClusterResourceName(_In_ HRESOURCE hResource, _In_ LPCWSTR lpszResourceName);

typedef DWORD(WINAPI *PCLUSAPI_SET_CLUSTER_RESOURCE_NAME)(
    HRESOURCE hResource, LPCWSTR lpszResourceName);

#if (CLUSAPI_VERSION >= CLUSAPI_VERSION_NI)

DWORD
WINAPI
SetClusterResourceNameEx(_In_ HRESOURCE hResource,
                         _In_ LPCWSTR lpszResourceName,
                         _In_opt_ LPCWSTR lpszReason);

typedef DWORD(WINAPI *PCLUSAPI_SET_CLUSTER_RESOURCE_NAME_EX)(
    _In_ HRESOURCE hResource, _In_ LPCWSTR lpszResourceName,
    _In_opt_ LPCWSTR lpszReason);
...
DWORD
WINAPI
FailClusterResource(_In_ HRESOURCE hResource);
...
DWORD
WINAPI
FailClusterResourceEx(_In_ HRESOURCE hResource, _In_opt_ LPCWSTR lpszReason);

typedef DWORD(WINAPI *PCLUSAPI_FAIL_CLUSTER_RESOURCE_EX)(
    _In_ HRESOURCE hResource, _In_opt_ LPCWSTR lpszReason);
...
DWORD
WINAPI
OnlineClusterResource(_In_ HRESOURCE hResource);

typedef DWORD(WINAPI *PCLUSAPI_ONLINE_CLUSTER_RESOURCE)(HRESOURCE hResource);

DWORD
WINAPI
OfflineClusterResource(_In_ HRESOURCE hResource);

typedef DWORD(WINAPI *PCLUSAPI_OFFLINE_CLUSTER_RESOURCE)(HRESOURCE hResource);

DWORD
WINAPI
ChangeClusterResourceGroup(_In_ HRESOURCE hResource, _In_ HGROUP hGroup);

typedef DWORD(WINAPI *PCLUSAPI_CHANGE_CLUSTER_RESOURCE_GROUP)(
    HRESOURCE hResource, HGROUP hGroup);

DWORD
WINAPI
ChangeClusterResourceGroupEx(_In_ HRESOURCE hResource, _In_ HGROUP hGroup,
                             _In_ ULONGLONG Flags);

typedef DWORD(WINAPI *PCLUSAPI_CHANGE_CLUSTER_RESOURCE_GROUP_EX)(
    HRESOURCE hResource, HGROUP hGroup, _In_ ULONGLONG Flags);

#if (CLUSAPI_VERSION >= CLUSAPI_VERSION_NI)

DWORD
WINAPI
ChangeClusterResourceGroupEx2(_In_ HRESOURCE hResource, _In_ HGROUP hGroup,
                              _In_ ULONGLONG Flags,
                              _In_opt_ LPCWSTR lpszReason);

typedef DWORD(WINAPI *PCLUSAPI_CHANGE_CLUSTER_RESOURCE_GROUP_EX2)(
    _In_ HRESOURCE hResource, _In_ HGROUP hGroup, _In_ ULONGLONG Flags,
    _In_opt_ LPCWSTR lpszReason);
...
DWORD
WINAPI
AddClusterResourceNode(_In_ HRESOURCE hResource, _In_ HNODE hNode);

typedef DWORD(WINAPI *PCLUSAPI_ADD_CLUSTER_RESOURCE_NODE)(HRESOURCE hResource,
                                                          HNODE hNode);

DWORD
WINAPI
RemoveClusterResourceNode(_In_ HRESOURCE hResource, _In_ HNODE hNode);

typedef DWORD(WINAPI *PCLUSAPI_REMOVE_CLUSTER_RESOURCE_NODE)(
    HRESOURCE hResource, HNODE hNode);

#if (CLUSAPI_VERSION >= CLUSAPI_VERSION_NI)

DWORD
WINAPI
AddClusterResourceNodeEx(_In_ HRESOURCE hResource, _In_ HNODE hNode,
                         _In_opt_ LPCWSTR lpszReason);

typedef DWORD(WINAPI *PCLUSAPI_ADD_CLUSTER_RESOURCE_NODE_EX)(
    _In_ HRESOURCE hResource, _In_ HNODE hNode, _In_opt_ LPCWSTR lpszReason);

DWORD
WINAPI
RemoveClusterResourceNodeEx(_In_ HRESOURCE hResource, _In_ HNODE hNode,
                            _In_opt_ LPCWSTR lpszReason);

typedef DWORD(WINAPI *PCLUSAPI_REMOVE_CLUSTER_RESOURCE_NODE_EX)(
    _In_ HRESOURCE hResource, _In_ HNODE hNode, _In_opt_ LPCWSTR lpszReason);
...
DWORD
WINAPI
AddClusterResourceDependency(_In_ HRESOURCE hResource,
                             _In_ HRESOURCE hDependsOn);

typedef DWORD(WINAPI *PCLUSAPI_ADD_CLUSTER_RESOURCE_DEPENDENCY)(
    HRESOURCE hResource, HRESOURCE hDependsOn);

DWORD
WINAPI
RemoveClusterResourceDependency(_In_ HRESOURCE hResource,
                                _In_ HRESOURCE hDependsOn);

typedef DWORD(WINAPI *PCLUSAPI_REMOVE_CLUSTER_RESOURCE_DEPENDENCY)(
    HRESOURCE hResource, HRESOURCE hDependsOn);
...
DWORD
WINAPI
AddClusterResourceDependencyEx(_In_ HRESOURCE hResource,
                               _In_ HRESOURCE hDependsOn,
                               _In_opt_ LPCWSTR lpszReason);

typedef DWORD(WINAPI *PCLUSAPI_ADD_CLUSTER_RESOURCE_DEPENDENCY_EX)(
    _In_ HRESOURCE hResource, _In_ HRESOURCE hDependsOn,
    _In_opt_ LPCWSTR lpszReason);

DWORD
WINAPI
RemoveClusterResourceDependencyEx(_In_ HRESOURCE hResource,
                                  _In_ HRESOURCE hDependsOn,
                                  _In_opt_ LPCWSTR lpszReason);

typedef DWORD(WINAPI *PCLUSAPI_REMOVE_CLUSTER_RESOURCE_DEPENDENCY_EX)(
    _In_ HRESOURCE hResource, _In_ HRESOURCE hDependsOn,
    _In_opt_ LPCWSTR lpszReason);
...
DWORD
WINAPI
SetClusterResourceDependencyExpression(_In_ HRESOURCE hResource,
                                       _In_ LPCWSTR lpszDependencyExpression);

typedef DWORD(WINAPI *PCLUSAPI_SET_CLUSTER_RESOURCE_DEPENDENCY_EXPRESSION)(
    _In_ HRESOURCE hResource, _In_ LPCWSTR lpszDependencyExpression);

_Success_(return == ERROR_SUCCESS) DWORD WINAPI
    GetClusterResourceDependencyExpression(
        _In_ HRESOURCE hResource,
        _Out_writes_to_opt_(*lpcchDependencyExpression,
                            *lpcchDependencyExpression + 1)
            LPWSTR lpszDependencyExpression,
        _Inout_ LPDWORD lpcchDependencyExpression);

typedef DWORD(WINAPI *PCLUSAPI_GET_CLUSTER_RESOURCE_DEPENDENCY_EXPRESSION)(
    _In_ HRESOURCE hResource,
    _Out_writes_to_opt_(*lpcchDependencyExpression,
                        *lpcchDependencyExpression + 1)
        LPWSTR lpszDependencyExpression,
...
DWORD
WINAPI
AddResourceToClusterSharedVolumes(_In_ HRESOURCE hResource);
#endif

typedef DWORD(WINAPI *PCLUSAPI_ADD_RESOURCE_TO_CLUSTER_SHARED_VOLUMES)(
    _In_ HRESOURCE hResource);

#if (CLUSAPI_VERSION >= CLUSAPI_VERSION_SERVER2008R2)
DWORD
WINAPI
RemoveResourceFromClusterSharedVolumes(_In_ HRESOURCE hResource);
#endif

typedef DWORD(WINAPI *PCLUSAPI_REMOVE_RESOURCE_FROM_CLUSTER_SHARED_VOLUMES)(
    _In_ HRESOURCE hResource);

#if (CLUSAPI_VERSION >= CLUSAPI_VERSION_SERVER2008R2)
DWORD
WINAPI
IsFileOnClusterSharedVolume(_In_ LPCWSTR lpszPathName,
                            _Out_ PBOOL pbFileIsOnSharedVolume);
#endif

typedef DWORD(WINAPI *PCLUSAPI_IS_FILE_ON_CLUSTER_SHARED_VOLUME)(
    _In_ LPCWSTR lpszPathName, _Out_ PBOOL pbFileIsOnSharedVolume);

#if (CLUSAPI_VERSION >= CLUSAPI_VERSION_SERVER2008R2)
DWORD
WINAPI
ClusterSharedVolumeSetSnapshotState(
    _In_ GUID guidSnapshotSet, _In_ LPCWSTR lpszVolumeName,
...
BOOL WINAPI CanResourceBeDependent(_In_ HRESOURCE hResource,
                                   _In_ HRESOURCE hResourceDependent);

typedef BOOL(WINAPI *PCLUSAPI_CAN_RESOURCE_BE_DEPENDENT)(
    HRESOURCE hResource, HRESOURCE hResourceDependent);

_Success_(return == ERROR_SUCCESS) DWORD WINAPI ClusterResourceControl(
    _In_ HRESOURCE hResource, _In_opt_ HNODE hHostNode,
    _In_ DWORD dwControlCode,
    _In_reads_bytes_opt_(cbInBufferSize) LPVOID lpInBuffer,
    _In_ DWORD cbInBufferSize,
    _Out_writes_bytes_to_opt_(cbOutBufferSize, *lpBytesReturned)
...
typedef DWORD(WINAPI *PCLUSAPI_CLUSTER_RESOURCE_CONTROL)(
    _In_ HRESOURCE hResource, _In_opt_ HNODE hHostNode,
    _In_ DWORD dwControlCode,
    _In_reads_bytes_opt_(cbInBufferSize) LPVOID lpInBuffer,
    _In_ DWORD cbInBufferSize,
...
_Success_(return == ERROR_SUCCESS) DWORD WINAPI ClusterResourceControlAsUser(
    _In_ HRESOURCE hResource, _In_opt_ HNODE hHostNode,
    _In_ DWORD dwControlCode,
    _In_reads_bytes_opt_(cbInBufferSize) LPVOID lpInBuffer,
    _In_ DWORD cbInBufferSize,
...
_Success_(return == ERROR_SUCCESS) DWORD WINAPI ClusterResourceTypeControl(
    _In_ HCLUSTER hCluster, _In_ LPCWSTR lpszResourceTypeName,
    _In_opt_ HNODE hHostNode, _In_ DWORD dwControlCode,
    _In_reads_bytes_opt_(nInBufferSize) LPVOID lpInBuffer,
    _In_ DWORD nInBufferSize,
    _Out_writes_bytes_to_opt_(nOutBufferSize, *lpBytesReturned)
...
typedef DWORD(WINAPI *PCLUSAPI_CLUSTER_RESOURCE_TYPE_CONTROL)(
    _In_ HCLUSTER hCluster, _In_ LPCWSTR lpszResourceTypeName,
    _In_opt_ HNODE hHostNode, _In_ DWORD dwControlCode,
    _In_reads_bytes_opt_(nInBufferSize) LPVOID lpInBuffer,
    _In_ DWORD nInBufferSize,
...
_Success_(return == ERROR_SUCCESS) DWORD WINAPI ClusterGroupControl(
    _In_ HGROUP hGroup, _In_opt_ HNODE hHostNode, _In_ DWORD dwControlCode,
    _In_reads_bytes_opt_(nInBufferSize) LPVOID lpInBuffer,
    _In_ DWORD nInBufferSize,
    _Out_writes_bytes_to_opt_(nOutBufferSize, *lpBytesReturned)
        LPVOID lpOutBuffer,
...
typedef DWORD(WINAPI *PCLUSAPI_CLUSTER_GROUP_CONTROL)(
    _In_ HGROUP hGroup, _In_opt_ HNODE hHostNode, _In_ DWORD dwControlCode,
    _In_reads_bytes_opt_(nInBufferSize) LPVOID lpInBuffer,
    _In_ DWORD nInBufferSize,
    _Out_writes_bytes_to_opt_(nOutBufferSize, *lpBytesReturned)
...
__success(return == ERROR_SUCCESS) DWORD WINAPI ClusterResourceControlEx(
    _In_ HRESOURCE hResource, _In_opt_ HNODE hHostNode,
    _In_ DWORD dwControlCode,
    _In_reads_bytes_opt_(cbInBufferSize) LPVOID lpInBuffer,
    _In_ DWORD cbInBufferSize,
...
typedef DWORD(WINAPI *PCLUSAPI_CLUSTER_RESOURCE_CONTROL_EX)(
    _In_ HRESOURCE hResource, _In_opt_ HNODE hHostNode,
    _In_ DWORD dwControlCode,
    _In_reads_bytes_opt_(cbInBufferSize) LPVOID lpInBuffer,
    _In_ DWORD cbInBufferSize,
...
__success(return == ERROR_SUCCESS) DWORD WINAPI ClusterResourceControlAsUserEx(
    _In_ HRESOURCE hResource, _In_opt_ HNODE hHostNode,
    _In_ DWORD dwControlCode,
    _In_reads_bytes_opt_(cbInBufferSize) LPVOID lpInBuffer,
    _In_ DWORD cbInBufferSize,
...
typedef DWORD(WINAPI *PCLUSAPI_CLUSTER_RESOURCE_CONTROL_AS_USER_EX)(
    _In_ HRESOURCE hResource, _In_opt_ HNODE hHostNode,
    _In_ DWORD dwControlCode,
    _In_reads_bytes_opt_(cbInBufferSize) LPVOID lpInBuffer,
    _In_ DWORD cbInBufferSize,
...
__success(return == ERROR_SUCCESS) DWORD WINAPI ClusterResourceTypeControlEx(
    _In_ HCLUSTER hCluster, _In_ LPCWSTR lpszResourceTypeName,
    _In_opt_ HNODE hHostNode, _In_ DWORD dwControlCode,
    _In_reads_bytes_opt_(nInBufferSize) LPVOID lpInBuffer,
    _In_ DWORD nInBufferSize,
...
typedef DWORD(WINAPI *PCLUSAPI_CLUSTER_RESOURCE_TYPE_CONTROL_EX)(
    _In_ HCLUSTER hCluster, _In_ LPCWSTR lpszResourceTypeName,
    _In_opt_ HNODE hHostNode, _In_ DWORD dwControlCode,
    _In_reads_bytes_opt_(nInBufferSize) LPVOID lpInBuffer,
    _In_ DWORD nInBufferSize,
...
typedef DWORD(WINAPI *PCLUSAPI_CLUSTER_RESOURCE_TYPE_CONTROL_AS_USER_EX)(
    _In_ HCLUSTER hCluster, _In_ LPCWSTR lpszResourceTypeName,
    _In_opt_ HNODE hHostNode, _In_ DWORD dwControlCode,
    _In_reads_bytes_opt_(nInBufferSize) LPVOID lpInBuffer,
    _In_ DWORD nInBufferSize,
...
__success(return == ERROR_SUCCESS) DWORD WINAPI ClusterGroupControlEx(
    _In_ HGROUP hGroup, _In_opt_ HNODE hHostNode, _In_ DWORD dwControlCode,
    _In_reads_bytes_opt_(nInBufferSize) LPVOID lpInBuffer,
    _In_ DWORD nInBufferSize,
    _Out_writes_bytes_to_opt_(nOutBufferSize, *lpBytesReturned)
...
typedef DWORD(WINAPI *PCLUSAPI_CLUSTER_GROUP_CONTROL_EX)(
    _In_ HGROUP hGroup, _In_opt_ HNODE hHostNode, _In_ DWORD dwControlCode,
    _In_reads_bytes_opt_(nInBufferSize) LPVOID lpInBuffer,
    _In_ DWORD nInBufferSize,
    _Out_writes_bytes_to_opt_(nOutBufferSize, *lpBytesReturned)
...
_Success_(return == ERROR_SUCCESS) DWORD WINAPI ClusterNodeControl(
...
typedef DWORD(WINAPI *PCLUSAPI_CLUSTER_NODE_CONTROL)(
    _In_ HNODE hNode, _In_opt_ HNODE hHostNode, _In_ DWORD dwControlCode,
    _In_reads_bytes_opt_(nInBufferSize) LPVOID lpInBuffer,
    _In_ DWORD nInBufferSize,
    _Out_writes_bytes_to_opt_(nOutBufferSize, *lpBytesReturned)
...
__success(return == ERROR_SUCCESS) DWORD WINAPI ClusterNodeControlEx(
    _In_ HNODE hNode, _In_opt_ HNODE hHostNode, _In_ DWORD dwControlCode,
    _In_reads_bytes_opt_(nInBufferSize) LPVOID lpInBuffer,
    _In_ DWORD nInBufferSize,
    _Out_writes_bytes_to_opt_(nOutBufferSize, *lpBytesReturned)
...
typedef DWORD(WINAPI *PCLUSAPI_CLUSTER_NODE_CONTROL_EX)(
    _In_ HNODE hNode, _In_opt_ HNODE hHostNode, _In_ DWORD dwControlCode,
    _In_reads_bytes_opt_(nInBufferSize) LPVOID lpInBuffer,
    _In_ DWORD nInBufferSize,
    _Out_writes_bytes_to_opt_(nOutBufferSize, *lpBytesReturned)
...
_Success_(return != FALSE) BOOL WINAPI
    GetClusterResourceNetworkName(_In_ HRESOURCE hResource,
                                  _Out_writes_to_(*nSize, *nSize + 1)
                                      LPWSTR lpBuffer,
                                  _Inout_ LPDWORD nSize);

typedef BOOL(WINAPI *PCLUSAPI_GET_CLUSTER_RESOURCE_NETWORK_NAME)(
    _In_ HRESOURCE hResource,
    _Out_writes_to_(*nSize, *nSize + 1) LPWSTR lpBuffer, _Inout_ LPDWORD nSize);
...
typedef enum CLUSTER_PROPERTY_SYNTAX {
  ...
  CLUSPROP_SYNTAX_LIST_VALUE_WORD =
      CLUSPROP_SYNTAX_VALUE(CLUSPROP_TYPE_LIST_VALUE, CLUSPROP_FORMAT_WORD),
  CLUSPROP_SYNTAX_LIST_VALUE_PROPERTY_LIST = CLUSPROP_SYNTAX_VALUE(
      CLUSPROP_TYPE_LIST_VALUE, CLUSPROP_FORMAT_PROPERTY_LIST),
  CLUSPROP_SYNTAX_LIST_VALUE_FILETIME =
      CLUSPROP_SYNTAX_VALUE(CLUSPROP_TYPE_LIST_VALUE, CLUSPROP_FORMAT_FILETIME),
  ...
  CLUSPROP_SYNTAX_DISK_GUID =
      CLUSPROP_SYNTAX_VALUE(CLUSPROP_TYPE_DISK_GUID, CLUSPROP_FORMAT_SZ),
  CLUSPROP_SYNTAX_DISK_SIZE = CLUSPROP_SYNTAX_VALUE(
      CLUSPROP_TYPE_DISK_SIZE, CLUSPROP_FORMAT_ULARGE_INTEGER),
  CLUSPROP_SYNTAX_PARTITION_INFO_EX = CLUSPROP_SYNTAX_VALUE(
      CLUSPROP_TYPE_PARTITION_INFO_EX, CLUSPROP_FORMAT_BINARY),
  CLUSPROP_SYNTAX_PARTITION_INFO_EX2 = CLUSPROP_SYNTAX_VALUE(
      CLUSPROP_TYPE_PARTITION_INFO_EX2, CLUSPROP_FORMAT_BINARY),
  CLUSPROP_SYNTAX_STORAGE_DEVICE_ID_DESCRIPTOR = CLUSPROP_SYNTAX_VALUE(
...
// External codes:
// A control code that applications can use to initiate an operation on a
// cluster object. External control codes are passed as the dwControlCode
// parameter to control code functions.
...
typedef enum CLCTL_CODES {
  ...
  CLCTL_GET_FAILURE_INFO =
      CLCTL_EXTERNAL_CODE(6, CLUS_ACCESS_READ, CLUS_NO_MODIFY),
  ...
  CLCTL_CHECK_VOTER_EVICT =
      CLCTL_EXTERNAL_CODE(17, CLUS_ACCESS_READ, CLUS_NO_MODIFY),
  CLCTL_CHECK_VOTER_DOWN =
      CLCTL_EXTERNAL_CODE(18, CLUS_ACCESS_READ, CLUS_NO_MODIFY),
  ...
  CLCTL_CHECK_VOTER_EVICT_WITNESS =
      CLCTL_EXTERNAL_CODE(27, CLUS_ACCESS_READ, CLUS_NO_MODIFY),
  CLCTL_CHECK_VOTER_DOWN_WITNESS =
      CLCTL_EXTERNAL_CODE(28, CLUS_ACCESS_READ, CLUS_NO_MODIFY),
  ...
  CLCTL_SET_ACCOUNT_ACCESS =
      CLCTL_EXTERNAL_CODE(60, CLUS_ACCESS_WRITE, CLUS_MODIFY),
  ...
  CLCTL_GET_DNS_NAME =
      CLCTL_EXTERNAL_CODE(93, CLUS_ACCESS_READ, CLUS_NO_MODIFY),
  CLCTL_NETNAME_SET_PWD_INFO =
      CLCTL_EXTERNAL_CODE(94, CLUS_ACCESS_WRITE, CLUS_NO_MODIFY),
  CLCTL_NETNAME_DELETE_CO =
      CLCTL_EXTERNAL_CODE(95, CLUS_ACCESS_WRITE, CLUS_NO_MODIFY),
  CLCTL_NETNAME_VALIDATE_VCO =
      CLCTL_EXTERNAL_CODE(96, CLUS_ACCESS_READ, CLUS_NO_MODIFY),
  CLCTL_NETNAME_RESET_VCO =
      CLCTL_EXTERNAL_CODE(97, CLUS_ACCESS_READ, CLUS_NO_MODIFY),
  CLCTL_NETNAME_REPAIR_VCO =
      CLCTL_EXTERNAL_CODE(99, CLUS_ACCESS_READ, CLUS_NO_MODIFY),
  ...
  CLCTL_STORAGE_SYNC_CLUSDISK_DB =
      CLCTL_EXTERNAL_CODE(103, CLUS_ACCESS_WRITE, CLUS_MODIFY),
  CLCTL_STORAGE_GET_DISK_NUMBER_INFO =
      CLCTL_EXTERNAL_CODE(104, CLUS_ACCESS_READ, CLUS_NO_MODIFY),

  CLCTL_QUERY_DELETE =
      CLCTL_EXTERNAL_CODE(110, CLUS_ACCESS_READ, CLUS_NO_MODIFY),

  CLCTL_IPADDRESS_RENEW_LEASE =
      CLCTL_EXTERNAL_CODE(111, CLUS_ACCESS_WRITE, CLUS_MODIFY),
  CLCTL_IPADDRESS_RELEASE_LEASE =
      CLCTL_EXTERNAL_CODE(112, CLUS_ACCESS_WRITE, CLUS_MODIFY),
  ...
  CLCTL_STORAGE_SET_DRIVELETTER =
      CLCTL_EXTERNAL_CODE(122, CLUS_ACCESS_WRITE, CLUS_MODIFY),
  CLCTL_STORAGE_GET_DRIVELETTERS =
      CLCTL_EXTERNAL_CODE(123, CLUS_ACCESS_READ, CLUS_NO_MODIFY),
  CLCTL_STORAGE_GET_DISK_INFO_EX =
      CLCTL_EXTERNAL_CODE(124, CLUS_ACCESS_READ, CLUS_NO_MODIFY),
  CLCTL_STORAGE_GET_AVAILABLE_DISKS_EX =
      CLCTL_EXTERNAL_CODE(125, CLUS_ACCESS_READ, CLUS_NO_MODIFY),
  CLCTL_STORAGE_GET_DISK_INFO_EX2 =
      CLCTL_EXTERNAL_CODE(126, CLUS_ACCESS_READ, CLUS_NO_MODIFY),
  CLCTL_STORAGE_GET_CLUSPORT_DISK_COUNT =
      CLCTL_EXTERNAL_CODE(127, CLUS_ACCESS_READ, CLUS_NO_MODIFY),

  CLCTL_STORAGE_REMAP_DRIVELETTER =
      CLCTL_EXTERNAL_CODE(128, CLUS_ACCESS_READ, CLUS_NO_MODIFY),
  CLCTL_STORAGE_GET_DISKID =
      CLCTL_EXTERNAL_CODE(129, CLUS_ACCESS_READ, CLUS_NO_MODIFY),
  CLCTL_STORAGE_IS_CLUSTERABLE =
      CLCTL_EXTERNAL_CODE(130, CLUS_ACCESS_READ, CLUS_NO_MODIFY),
  CLCTL_STORAGE_REMOVE_VM_OWNERSHIP =
      CLCTL_EXTERNAL_CODE(131, CLUS_ACCESS_WRITE, CLUS_MODIFY),
  CLCTL_STORAGE_GET_MOUNTPOINTS =
      CLCTL_EXTERNAL_CODE(132, CLUS_ACCESS_READ, CLUS_NO_MODIFY),
  CLCTL_STORAGE_GET_DIRTY =
      CLCTL_EXTERNAL_CODE(134, CLUS_ACCESS_READ, CLUS_NO_MODIFY),
  // Codes 135-136 are available for storage after the two previous squatters
  // were made internal.
  CLCTL_STORAGE_GET_SHARED_VOLUME_INFO =
      CLCTL_EXTERNAL_CODE(137, CLUS_ACCESS_READ, CLUS_NO_MODIFY),
  CLCTL_STORAGE_IS_CSV_FILE =
      CLCTL_EXTERNAL_CODE(138, CLUS_ACCESS_READ, CLUS_NO_MODIFY),
  CLCTL_STORAGE_GET_RESOURCEID =
      CLCTL_EXTERNAL_CODE(139, CLUS_ACCESS_READ, CLUS_NO_MODIFY),

  CLCTL_VALIDATE_PATH =
      CLCTL_EXTERNAL_CODE(140, CLUS_ACCESS_READ, CLUS_NO_MODIFY),
  CLCTL_VALIDATE_NETNAME =
      CLCTL_EXTERNAL_CODE(141, CLUS_ACCESS_READ, CLUS_NO_MODIFY),
  CLCTL_VALIDATE_DIRECTORY =
      CLCTL_EXTERNAL_CODE(142, CLUS_ACCESS_READ, CLUS_NO_MODIFY),
  CLCTL_BATCH_BLOCK_KEY =
      CLCTL_EXTERNAL_CODE(143, CLUS_ACCESS_WRITE, CLUS_NO_MODIFY),
  CLCTL_BATCH_UNBLOCK_KEY =
      CLCTL_EXTERNAL_CODE(144, CLUS_ACCESS_READ, CLUS_NO_MODIFY),

  CLCTL_FILESERVER_SHARE_ADD =
      CLCTL_EXTERNAL_CODE(145, CLUS_ACCESS_WRITE, CLUS_MODIFY),
  CLCTL_FILESERVER_SHARE_DEL =
      CLCTL_EXTERNAL_CODE(146, CLUS_ACCESS_WRITE, CLUS_MODIFY),
  CLCTL_FILESERVER_SHARE_MODIFY =
      CLCTL_EXTERNAL_CODE(147, CLUS_ACCESS_WRITE, CLUS_MODIFY),
  CLCTL_FILESERVER_SHARE_REPORT =
      CLCTL_EXTERNAL_CODE(148, CLUS_ACCESS_READ, CLUS_NO_MODIFY),

  CLCTL_NETNAME_GET_OU_FOR_VCO =
      CLCTL_EXTERNAL_CODE(155, CLUS_ACCESS_WRITE, CLUS_MODIFY),

  // Codes 160-161 are available for storage after the two previous squatters
  // were made internal.
  CLCTL_ENABLE_SHARED_VOLUME_DIRECTIO =
      CLCTL_EXTERNAL_CODE(162, CLUS_ACCESS_WRITE, CLUS_MODIFY),
  CLCTL_DISABLE_SHARED_VOLUME_DIRECTIO =
      CLCTL_EXTERNAL_CODE(163, CLUS_ACCESS_WRITE, CLUS_MODIFY),
  CLCTL_GET_SHARED_VOLUME_ID =
      CLCTL_EXTERNAL_CODE(164, CLUS_ACCESS_READ, CLUS_NO_MODIFY),
  CLCTL_SET_CSV_MAINTENANCE_MODE =
      CLCTL_EXTERNAL_CODE(165, CLUS_ACCESS_WRITE, CLUS_MODIFY),
  CLCTL_SET_SHARED_VOLUME_BACKUP_MODE =
      CLCTL_EXTERNAL_CODE(166, CLUS_ACCESS_WRITE, CLUS_MODIFY),
  CLCTL_STORAGE_GET_SHARED_VOLUME_PARTITION_NAMES =
      CLCTL_EXTERNAL_CODE(167, CLUS_ACCESS_READ, CLUS_NO_MODIFY),

  CLCTL_STORAGE_GET_SHARED_VOLUME_STATES =
      CLCTL_EXTERNAL_CODE(168, CLUS_ACCESS_WRITE, CLUS_MODIFY),
  CLCTL_STORAGE_IS_SHARED_VOLUME =
      CLCTL_EXTERNAL_CODE(169, CLUS_ACCESS_READ, CLUS_NO_MODIFY),

  CLCTL_GET_CLUSDB_TIMESTAMP =
      CLCTL_EXTERNAL_CODE(170, CLUS_ACCESS_READ, CLUS_NO_MODIFY),

  // this control has CLUS_MODIFY bit set and will trigger property change
  // notification, that is the only purpose of this control
  CLCTL_RW_MODIFY_NOOP =
      CLCTL_EXTERNAL_CODE(171, CLUS_ACCESS_WRITE, CLUS_MODIFY),
  CLCTL_IS_QUORUM_BLOCKED =
      CLCTL_EXTERNAL_CODE(172, CLUS_ACCESS_READ, CLUS_NO_MODIFY),
  CLCTL_POOL_GET_DRIVE_INFO =
      CLCTL_EXTERNAL_CODE(173, CLUS_ACCESS_READ, CLUS_NO_MODIFY),

  CLCTL_GET_GUM_LOCK_OWNER =
      CLCTL_EXTERNAL_CODE(174, CLUS_ACCESS_READ, CLUS_NO_MODIFY),
  CLCTL_GET_STUCK_NODES =
      CLCTL_EXTERNAL_CODE(175, CLUS_ACCESS_READ, CLUS_NO_MODIFY),
  CLCTL_INJECT_GEM_FAULT =
      CLCTL_EXTERNAL_CODE(176, CLUS_ACCESS_READ, CLUS_NO_MODIFY),
  CLCTL_INTRODUCE_GEM_REPAIR_DELAY =
      CLCTL_EXTERNAL_CODE(177, CLUS_ACCESS_READ, CLUS_NO_MODIFY),
  CLCTL_SEND_DUMMY_GEM_MESSAGES =
      CLCTL_EXTERNAL_CODE(178, CLUS_ACCESS_READ, CLUS_NO_MODIFY),
  CLCTL_BLOCK_GEM_SEND_RECV =
      CLCTL_EXTERNAL_CODE(179, CLUS_ACCESS_READ, CLUS_NO_MODIFY),
  CLCTL_GET_GEMID_VECTOR =
      CLCTL_EXTERNAL_CODE(180, CLUS_ACCESS_READ, CLUS_NO_MODIFY),

  CLCTL_ADD_CRYPTO_CHECKPOINT_EX =
      CLCTL_EXTERNAL_CODE(181, CLUS_ACCESS_WRITE, CLUS_MODIFY),

  // gets the last time the group moved
  CLCTL_GROUP_GET_LAST_MOVE_TIME =
      CLCTL_EXTERNAL_CODE(182, CLUS_ACCESS_READ, CLUS_NO_MODIFY),

  CLCTL_SET_STORAGE_CONFIGURATION =
      CLCTL_EXTERNAL_CODE(184, CLUS_ACCESS_WRITE, CLUS_MODIFY),
  CLCTL_GET_STORAGE_CONFIGURATION =
      CLCTL_EXTERNAL_CODE(185, CLUS_ACCESS_READ, CLUS_NO_MODIFY),
  CLCTL_GET_STORAGE_CONFIG_ATTRIBUTES =
      CLCTL_EXTERNAL_CODE(186, CLUS_ACCESS_READ, CLUS_NO_MODIFY),
  CLCTL_REMOVE_NODE = CLCTL_EXTERNAL_CODE(187, CLUS_ACCESS_WRITE, CLUS_MODIFY),
  CLCTL_IS_FEATURE_INSTALLED =
      CLCTL_EXTERNAL_CODE(188, CLUS_ACCESS_READ, CLUS_NO_MODIFY),
  CLCTL_IS_S2D_FEATURE_SUPPORTED =
      CLCTL_EXTERNAL_CODE(189, CLUS_ACCESS_READ, CLUS_NO_MODIFY),
  CLCTL_STORAGE_GET_PHYSICAL_DISK_INFO =
      CLCTL_EXTERNAL_CODE(190, CLUS_ACCESS_READ, CLUS_NO_MODIFY),
  CLCTL_STORAGE_GET_CLUSBFLT_PATHS =
      CLCTL_EXTERNAL_CODE(191, CLUS_ACCESS_READ, CLUS_NO_MODIFY),
  CLCTL_STORAGE_GET_CLUSBFLT_PATHINFO =
      CLCTL_EXTERNAL_CODE(192, CLUS_ACCESS_READ, CLUS_NO_MODIFY),
  CLCTL_CLEAR_NODE_CONNECTION_INFO =
      CLCTL_EXTERNAL_CODE(193, CLUS_ACCESS_WRITE, CLUS_MODIFY),
  CLCTL_SET_DNS_DOMAIN =
      CLCTL_EXTERNAL_CODE(194, CLUS_ACCESS_WRITE, CLUS_MODIFY),

  // Network health.  STATUS = status matrix now, Extended = future use.
  CTCTL_GET_ROUTESTATUS_BASIC =
      CLCTL_EXTERNAL_CODE(195, CLUS_ACCESS_READ, CLUS_NO_MODIFY),
  CTCTL_GET_ROUTESTATUS_EXTENDED =
      CLCTL_EXTERNAL_CODE(196, CLUS_ACCESS_READ, CLUS_NO_MODIFY),

  CTCTL_GET_FAULT_DOMAIN_STATE =
      CLCTL_EXTERNAL_CODE(197, CLUS_ACCESS_READ, CLUS_NO_MODIFY),

  CLCTL_NETNAME_SET_PWD_INFOEX =
      CLCTL_EXTERNAL_CODE(198, CLUS_ACCESS_WRITE, CLUS_NO_MODIFY),

  CLCTL_GET_NODE_NETWORK_CONNECTIVITY =
      CLCTL_EXTERNAL_CODE(199, CLUS_ACCESS_READ, CLUS_NO_MODIFY),

  // Control codes 2000 to 2999 are reserved.

  CLCTL_STORAGE_GET_AVAILABLE_DISKS_EX2_INT =
      CLCTL_EXTERNAL_CODE(2040, CLUS_ACCESS_READ, CLUS_NO_MODIFY),
  ...
  CLCTL_CLOUD_WITNESS_RESOURCE_TYPE_VALIDATE_CREDENTIALS =
      CLCTL_EXTERNAL_CODE(2104, CLUS_ACCESS_READ, CLUS_NO_MODIFY),
  // takes in a proeprty list of PrimaryToken
  CLCTL_CLOUD_WITNESS_RESOURCE_UPDATE_TOKEN =
      CLCTL_EXTERNAL_CODE(2105, CLUS_ACCESS_WRITE, CLUS_MODIFY),

  //
  // Rolling upgrade controls
  //
  CLCTL_RESOURCE_PREPARE_UPGRADE =
      CLCTL_EXTERNAL_CODE(2106, CLUS_ACCESS_WRITE, CLUS_MODIFY),
  CLCTL_RESOURCE_UPGRADE_COMPLETED =
      CLCTL_EXTERNAL_CODE(2107, CLUS_ACCESS_WRITE, CLUS_MODIFY),

  // takes in a property list of AccountName, PrimaryKey
  CLCTL_CLOUD_WITNESS_RESOURCE_TYPE_VALIDATE_CREDENTIALS_WITH_KEY =
      CLCTL_EXTERNAL_CODE(2108, CLUS_ACCESS_READ, CLUS_NO_MODIFY),
  // takes in a proeprty list of PrimaryKey
  CLCTL_CLOUD_WITNESS_RESOURCE_UPDATE_KEY =
      CLCTL_EXTERNAL_CODE(2109, CLUS_ACCESS_WRITE, CLUS_MODIFY),

  //
  // Storage Replication
  //
  CLCTL_REPLICATION_ADD_REPLICATION_GROUP =
      CLCTL_EXTERNAL_CODE(2128, CLUS_ACCESS_WRITE, CLUS_NO_MODIFY),
  CLCTL_REPLICATION_GET_LOG_INFO =
      CLCTL_EXTERNAL_CODE(2129, CLUS_ACCESS_READ, CLUS_NO_MODIFY),
  CLCTL_REPLICATION_GET_ELIGIBLE_LOGDISKS =
      CLCTL_EXTERNAL_CODE(2130, CLUS_ACCESS_READ, CLUS_NO_MODIFY),
  CLCTL_REPLICATION_GET_ELIGIBLE_TARGET_DATADISKS =
      CLCTL_EXTERNAL_CODE(2131, CLUS_ACCESS_READ, CLUS_NO_MODIFY),
  CLCTL_REPLICATION_GET_ELIGIBLE_SOURCE_DATADISKS =
      CLCTL_EXTERNAL_CODE(2132, CLUS_ACCESS_READ, CLUS_NO_MODIFY),
  CLCTL_REPLICATION_GET_REPLICATED_DISKS =
      CLCTL_EXTERNAL_CODE(2133, CLUS_ACCESS_READ, CLUS_NO_MODIFY),
  CLCTL_REPLICATION_GET_REPLICA_VOLUMES =
      CLCTL_EXTERNAL_CODE(2134, CLUS_ACCESS_READ, CLUS_NO_MODIFY),
  CLCTL_REPLICATION_GET_LOG_VOLUME =
      CLCTL_EXTERNAL_CODE(2135, CLUS_ACCESS_READ, CLUS_NO_MODIFY),
  CLCTL_REPLICATION_GET_RESOURCE_GROUP =
      CLCTL_EXTERNAL_CODE(2136, CLUS_ACCESS_READ, CLUS_NO_MODIFY),
  CLCTL_REPLICATION_GET_REPLICATED_PARTITION_INFO =
      CLCTL_EXTERNAL_CODE(2137, CLUS_ACCESS_READ, CLUS_NO_MODIFY),

  // Get Filetime of last state change
  CLCTL_GET_STATE_CHANGE_TIME =
      CLCTL_EXTERNAL_CODE(2903, CLUS_ACCESS_READ, CLUS_NO_MODIFY),
#if (CLUSAPI_VERSION >= CLUSAPI_VERSION_WINTHRESHOLD)
  CLCTL_SET_CLUSTER_S2D_ENABLED =
      CLCTL_EXTERNAL_CODE(2904, CLUS_ACCESS_WRITE, CLUS_MODIFY),
  // 2906 is free and can be reused
  CLCTL_SET_CLUSTER_S2D_CACHE_METADATA_RESERVE_BYTES =
      CLCTL_EXTERNAL_CODE(2907, CLUS_ACCESS_WRITE, CLUS_MODIFY),
#endif
  CLCTL_GROUPSET_GET_GROUPS =
      CLCTL_EXTERNAL_CODE(2908, CLUS_ACCESS_READ, CLUS_NO_MODIFY),
  CLCTL_GROUPSET_GET_PROVIDER_GROUPS =
      CLCTL_EXTERNAL_CODE(2909, CLUS_ACCESS_READ, CLUS_NO_MODIFY),
  CLCTL_GROUPSET_GET_PROVIDER_GROUPSETS =
      CLCTL_EXTERNAL_CODE(2910, CLUS_ACCESS_READ, CLUS_NO_MODIFY),
  CLCTL_GROUP_GET_PROVIDER_GROUPS =
      CLCTL_EXTERNAL_CODE(2911, CLUS_ACCESS_READ, CLUS_NO_MODIFY),
  CLCTL_GROUP_GET_PROVIDER_GROUPSETS =
      CLCTL_EXTERNAL_CODE(2912, CLUS_ACCESS_READ, CLUS_NO_MODIFY),
  CLCTL_GROUP_SET_CCF_FROM_MASTER =
      CLCTL_EXTERNAL_CODE(2913, CLUS_ACCESS_WRITE, CLUS_MODIFY),
  CLCTL_GET_INFRASTRUCTURE_SOFS_BUFFER =
      CLCTL_EXTERNAL_CODE(2914, CLUS_ACCESS_READ, CLUS_NO_MODIFY),
  CLCTL_SET_INFRASTRUCTURE_SOFS_BUFFER =
      CLCTL_EXTERNAL_CODE(2915, CLUS_ACCESS_WRITE, CLUS_MODIFY),
  CLCTL_NOTIFY_INFRASTRUCTURE_SOFS_CHANGED =
      CLCTL_EXTERNAL_CODE(2916, CLUS_ACCESS_WRITE, CLUS_MODIFY),
  CLCTL_SCALEOUT_COMMAND =
      CLCTL_EXTERNAL_CODE(2917, CLUS_ACCESS_WRITE, CLUS_MODIFY),
  CLCTL_SCALEOUT_CONTROL =
      CLCTL_EXTERNAL_CODE(2918, CLUS_ACCESS_WRITE, CLUS_MODIFY),
  CLCTL_SCALEOUT_GET_CLUSTERS =
      CLCTL_EXTERNAL_CODE(2919, CLUS_ACCESS_READ, CLUS_MODIFY),

  CLCTL_RELOAD_AUTOLOGGER_CONFIG =
      CLCTL_EXTERNAL_CODE(2932, CLUS_ACCESS_WRITE, CLUS_NO_MODIFY),
  CLCTL_STORAGE_RENAME_SHARED_VOLUME =
      CLCTL_EXTERNAL_CODE(2933, CLUS_ACCESS_WRITE, CLUS_NO_MODIFY),
  CLCTL_STORAGE_RENAME_SHARED_VOLUME_GUID =
      CLCTL_EXTERNAL_CODE(2934, CLUS_ACCESS_WRITE, CLUS_NO_MODIFY),
  CLCTL_ENUM_AFFINITY_RULE_NAMES =
      CLCTL_EXTERNAL_CODE(2935, CLUS_ACCESS_READ, CLUS_NO_MODIFY),
  CLCTL_GET_NODES_IN_FD =
      CLCTL_EXTERNAL_CODE(2936, CLUS_ACCESS_READ, CLUS_NO_MODIFY),

  CLCTL_FORCE_DB_FLUSH =
      CLCTL_EXTERNAL_CODE(2937, CLUS_ACCESS_WRITE, CLUS_MODIFY),

  // Internal codes:
  // A control code used by the Cluster service to notify a resource DLL of
  // changes to the cluster environment. Applications cannot use internal
  // control codes; they must use external control codes.
  ...
  CLCTL_PROVIDER_STATE_CHANGE =
      CLCTL_INTERNAL_CODE(20, CLUS_ACCESS_WRITE, CLUS_MODIFY),
  ...
  CLCTL_FSWITNESS_GET_EPOCH_INFO =
      CLCTL_INTERNAL_CODE(23, CLUS_ACCESS_READ, CLUS_NO_MODIFY),
  CLCTL_FSWITNESS_SET_EPOCH_INFO =
      CLCTL_INTERNAL_CODE(24, CLUS_ACCESS_WRITE, CLUS_MODIFY),
  CLCTL_FSWITNESS_RELEASE_LOCK =
      CLCTL_INTERNAL_CODE(25, CLUS_ACCESS_WRITE, CLUS_MODIFY),

  CLCTL_NETNAME_CREDS_NOTIFYCAM =
      CLCTL_INTERNAL_CODE(26, CLUS_ACCESS_WRITE, CLUS_MODIFY),

  CLCTL_NOTIFY_QUORUM_STATUS =
      CLCTL_INTERNAL_CODE(31, CLUS_ACCESS_WRITE, CLUS_MODIFY),

  CLCTL_NOTIFY_MONITOR_SHUTTING_DOWN =
      CLCTL_INTERNAL_CODE(32, CLUS_ACCESS_READ, CLUS_NO_MODIFY),

  CLCTL_UNDELETE = CLCTL_INTERNAL_CODE(33, CLUS_ACCESS_WRITE, CLUS_MODIFY),

  CLCTL_GET_OPERATION_CONTEXT =
      CLCTL_INTERNAL_CODE(2106, CLUS_ACCESS_READ, CLUS_NO_MODIFY),
  CLCTL_NOTIFY_OWNER_CHANGE =
      CLCTL_INTERNAL_CODE(2120, CLUS_ACCESS_WRITE, CLUS_MODIFY),
#if (CLUSAPI_VERSION >= CLUSAPI_VERSION_WINTHRESHOLD)
  CLCTL_VALIDATE_CHANGE_GROUP =
      CLCTL_INTERNAL_CODE(2121, CLUS_ACCESS_READ, CLUS_NO_MODIFY),
#endif

  CLCTL_CHECK_DRAIN_VETO =
      CLCTL_INTERNAL_CODE(2123, CLUS_ACCESS_READ, CLUS_NO_MODIFY),
  CLCTL_NOTIFY_DRAIN_COMPLETE =
      CLCTL_INTERNAL_CODE(2124, CLUS_ACCESS_READ, CLUS_NO_MODIFY),
...
#define CLUSCTL_USER_CODE(Function, Object)                                    \
  (((Object) << CLUSCTL_OBJECT_SHIFT) | CLCTL_USER_BASE |                      \
   (Function << CLUSCTL_FUNCTION_SHIFT))
...
typedef enum CLUSCTL_RESOURCE_CODES {
  ...
  CLUSCTL_RESOURCE_UNDELETE = CLUSCTL_RESOURCE_CODE(CLCTL_UNDELETE),
  ...
  */
  ...
  CLUSCTL_CLOUD_WITNESS_RESOURCE_UPDATE_TOKEN =
      CLUSCTL_RESOURCE_CODE(CLCTL_CLOUD_WITNESS_RESOURCE_UPDATE_TOKEN),

  CLUSCTL_CLOUD_WITNESS_RESOURCE_UPDATE_KEY =
      CLUSCTL_RESOURCE_CODE(CLCTL_CLOUD_WITNESS_RESOURCE_UPDATE_KEY),
...
// To be used with Control Code CLUSCTL_RESOURCE_TYPE_GET_LOCAL_NODE_SRIOV_INFO
// Only:
...
typedef enum CLUSCTL_CLUSTER_CODES {
  ...
  CLUSCTL_CLUSTER_GET_NODES_IN_FD = CLUSCTL_CLUSTER_CODE(CLCTL_GET_NODES_IN_FD),

  CLUSCTL_CLUSTER_FORCE_FLUSH_DB = CLUSCTL_CLUSTER_CODE(CLCTL_FORCE_DB_FLUSH),
...
typedef enum CLUSCTL_AFFINITYRULE_CODES {
  ...
  CLUSCTL_AFFINITYRULE_GET_ID = CLUSCTL_AFFINITYRULE_CODE(CLCTL_GET_ID),
...
typedef enum CLUS_RESSUBCLASS_NETWORK {
  CLUS_RESSUBCLASS_NETWORK_INTERNET_PROTOCOL =
      0x80000000 // Identifies IP address providers
...
typedef enum CLUS_CHARACTERISTICS {
  ...
  CLUS_CHAR_SINGLE_CLUSTER_INSTANCE =
      0x00000040, // only one resource of this type allowed per cluster
  ...
  CLUS_CHAR_INFRASTRUCTURE = 0x00020000, // The resource type is for
                                         // infrastructure and is not for roles
...
#ifdef __cplusplus
typedef struct CLUSPROP_RESOURCE_CLASS_INFO : public CLUSPROP_VALUE,
...
// One entry from list returned by CLCTL_GET_REQUIRED_DEPENDENCIES control
// functions.
...
// NOTE: property lists are 32b aligned which means this structure could be
// returned with a starting address that is 32b. aligned, i.e., an address
// ending in 0, 4, 8 or 0xC. The distance to the ULARGE_INTEGER members are
// properly aligned when the address of the structure ends with 0 or 8 but are
// unaligned when the structure addresses ends with 4 or 0xC. Since it is
// unpredictable as to the alignment of the structure's address, the developer
// must always access the ULARGE_INTEGER members with unaligned pointers or copy
// the data to another, aligned structure.
...
#define BitLockerFlagsAll                                                      \
  (BitLockerEnabled | BitLockerDecrypted | BitlockerEncrypted |                \
   BitLockerDecrypting | BitlockerEncrypting | BitLockerPaused |               \
   BitLockerStopped)
...
typedef enum _CLUSTER_SHARED_VOLUME_RENAME_INPUT_TYPE {
  ...
  ClusterSharedVolumeRenameInputTypeVolumeGuid
    ...
    *PCLUSTER_SHARED_VOLUME_RENAME_INPUT_TYPE;
...
typedef struct _CLUSTER_SHARED_VOLUME_RENAME_INPUT_VOLUME {
  ...
  union {
    ...
    *PCLUSTER_SHARED_VOLUME_RENAME_INPUT_VOLUME;
...
typedef struct _CLUSTER_SHARED_VOLUME_RENAME_INPUT_NAME {
  WCHAR NewVolumeName[MAX_PATH];
    ...
    *PCLUSTER_SHARED_VOLUME_RENAME_INPUT_NAME;
...
typedef struct _CLUSTER_SHARED_VOLUME_RENAME_INPUT_GUID_NAME {
  ...
  WCHAR NewVolumeGuid[50];
    ...
    *PCLUSTER_SHARED_VOLUME_RENAME_INPUT_GUID_NAME;
...
typedef struct _CLUSTER_SHARED_VOLUME_RENAME_GUID_INPUT {
  ...
  CLUSTER_SHARED_VOLUME_RENAME_INPUT_GUID_NAME;
    ...
    *PCLUSTER_SHARED_VOLUME_RENAME_GUID_INPUT;
...
#ifdef __cplusplus
typedef struct CLUSPROP_PARTITION_INFO : public CLUSPROP_VALUE,
...
#ifdef __cplusplus
typedef struct CLUSPROP_PARTITION_INFO_EX : public CLUSPROP_VALUE,
...
#ifdef __cplusplus
typedef struct CLUSPROP_PARTITION_INFO_EX2 : public CLUSPROP_PARTITION_INFO_EX,
...
// Disk partition information property value.
#ifdef __cplusplus
typedef struct CLUSPROP_FTSET_INFO : public CLUSPROP_VALUE,
...
#ifdef __cplusplus
typedef struct CLUSPROP_SCSI_ADDRESS : public CLUSPROP_VALUE,
...
typedef struct CLUS_NETNAME_VS_TOKEN_INFO {
  ...
  DWORD DesiredAccess;
  BOOL InheritHandle;
} CLUS_NETNAME_VS_TOKEN_INFO, CLUS_VS_TOKEN_INFO, *PCLUS_NETNAME_VS_TOKEN_INFO,
    *PCLUS_VS_TOKEN_INFO;

//
// input structure for CLUSCTL_RESOURCE_NETNAME_SET_PWD_INFO and for
// CLUSCTL_RESOURCE_RLUA_SET_PWD_INFO
//
...
// (PWLEN/sizeof(wchar_t))-1 is the max allowed password size, remember to add 1
// to buffers to hold the null
...
//
// input structure for CLUSCTL_RESOURCE_NETNAME_SET_PWD_INFOEX and for
// CLUSCTL_RESOURCE_RLUA_SET_PWD_INFOEX
//
typedef struct CLUS_NETNAME_PWD_INFOEX {
  ...
  WCHAR CreatingDC[MAX_CREATINGDC_LENGTH + 2]; // including the '\\' prefix
  WCHAR ObjectGuid[MAX_OBJECTID];              //
} CLUS_NETNAME_PWD_INFOEX, *PCLUS_NETNAME_PWD_INFOEX, CLUS_RLUA_PWD_INFOEX,
    *PCLUS_RLUA_PWD_INFOEX;

//
// input structure for CLUSCTL_RESOURCE_DNN_SEND_LEADER_STATUS and for
// CLUSCTL_RESOURCE_DNN_REFRESH_CLONES
//
...
typedef struct CLUS_DNN_SODAFS_CLONE_STATUS {
  ...
  CLUSTER_RESOURCE_STATE
  Status; // Indicates the status of the clone (Online/Failed)
...
typedef struct CLUS_NETNAME_IP_INFO_FOR_MULTICHANNEL {
  ...
  IpInfo[ANYSIZE_ARRAY]; // The actual IP Info as an array
...
typedef struct _CLUS_CREATE_INFRASTRUCTURE_FILESERVER_INPUT {
  WCHAR FileServerName[16];
    ...
    *PCLUS_CREATE_INFRASTRUCTURE_FILESERVER_INPUT;
...
typedef struct _CLUS_CREATE_INFRASTRUCTURE_FILESERVER_OUTPUT {
  WCHAR FileServerName[MAX_PATH];
    ...
    *PCLUS_CREATE_INFRASTRUCTURE_FILESERVER_OUTPUT;
...
HRESENUM
WINAPI
ClusterResourceOpenEnum(_In_ HRESOURCE hResource, _In_ DWORD dwType);

typedef HRESENUM(WINAPI *PCLUSAPI_CLUSTER_RESOURCE_OPEN_ENUM)(
    HRESOURCE hResource, DWORD dwType);

DWORD
WINAPI
ClusterResourceGetEnumCount(_In_ HRESENUM hResEnum);

typedef DWORD(WINAPI *PCLUSAPI_CLUSTER_RESOURCE_GET_ENUM_COUNT)(
    _In_ HRESENUM hResEnum);

_Success_(return == ERROR_SUCCESS) DWORD WINAPI
    ClusterResourceEnum(_In_ HRESENUM hResEnum, _In_ DWORD dwIndex,
                        _Out_ LPDWORD lpdwType,
                        _Out_writes_to_(*lpcchName, *lpcchName + 1)
                            LPWSTR lpszName,
                        _Inout_ LPDWORD lpcchName);
...
typedef DWORD(WINAPI *PCLUSAPI_CLUSTER_RESOURCE_ENUM)(
    _In_ HRESENUM hResEnum, _In_ DWORD dwIndex, _Out_ LPDWORD lpdwType,
    _Out_writes_to_(*lpcchName, *lpcchName + 1) LPWSTR lpszName,
    _Inout_ LPDWORD lpcchName);

DWORD
WINAPI
ClusterResourceCloseEnum(_In_ HRESENUM hResEnum);

typedef DWORD(WINAPI *PCLUSAPI_CLUSTER_RESOURCE_CLOSE_ENUM)(HRESENUM hResEnum);

DWORD
WINAPI
CreateClusterResourceType(_In_ HCLUSTER hCluster,
...
typedef DWORD(WINAPI *PCLUSAPI_CREATE_CLUSTER_RESOURCE_TYPE)(
    _In_ HCLUSTER hCluster, _In_ LPCWSTR lpszResourceTypeName,
    _In_ LPCWSTR lpszDisplayName, _In_ LPCWSTR lpszResourceTypeDll,
    _In_ DWORD dwLooksAlivePollInterval, _In_ DWORD dwIsAlivePollInterval);

DWORD
WINAPI
DeleteClusterResourceType(_In_ HCLUSTER hCluster,
                          _In_ LPCWSTR lpszResourceTypeName);

typedef DWORD(WINAPI *PCLUSAPI_DELETE_CLUSTER_RESOURCE_TYPE)(
    HCLUSTER hCluster, LPCWSTR lpszResourceTypeName);

#if (CLUSAPI_VERSION >= CLUSAPI_VERSION_NI)

DWORD
WINAPI
CreateClusterResourceTypeEx(_In_ HCLUSTER hCluster,
                            _In_ LPCWSTR lpszResourceTypeName,
                            _In_ LPCWSTR lpszDisplayName,
                            _In_ LPCWSTR lpszResourceTypeDll,
                            _In_ DWORD dwLooksAlivePollInterval,
...
DWORD
WINAPI
DeleteClusterResourceTypeEx(_In_ HCLUSTER hCluster, _In_ LPCWSTR lpszTypeName,
                            _In_opt_ LPCWSTR lpszReason);

typedef DWORD(WINAPI *PCLUSAPI_DELETE_CLUSTER_RESOURCE_TYPE_EX)(
    _In_ HCLUSTER hCluster, _In_ LPCWSTR lpszTypeName,
    _In_opt_ LPCWSTR lpszReason);
...
HRESTYPEENUM
WINAPI
ClusterResourceTypeOpenEnum(_In_ HCLUSTER hCluster,
                            _In_ LPCWSTR lpszResourceTypeName,
                            _In_ DWORD dwType);
...
DWORD
WINAPI
ClusterResourceTypeGetEnumCount(_In_ HRESTYPEENUM hResTypeEnum);

typedef DWORD(WINAPI *PCLUSAPI_CLUSTER_RESOURCE_TYPE_GET_ENUM_COUNT)(
    _In_ HRESTYPEENUM hResTypeEnum);

_Success_(return == ERROR_SUCCESS) DWORD WINAPI
    ClusterResourceTypeEnum(_In_ HRESTYPEENUM hResTypeEnum, _In_ DWORD dwIndex,
                            _Out_ LPDWORD lpdwType,
                            _Out_writes_to_(*lpcchName, *lpcchName + 1)
                                LPWSTR lpszName,
                            _Inout_ LPDWORD lpcchName);
...
typedef DWORD(WINAPI *PCLUSAPI_CLUSTER_RESOURCE_TYPE_ENUM)(
    _In_ HRESTYPEENUM hResTypeEnum, _In_ DWORD dwIndex, _Out_ LPDWORD lpdwType,
    _Out_writes_to_(*lpcchName, *lpcchName + 1) LPWSTR lpszName,
    _Inout_ LPDWORD lpcchName);

DWORD
WINAPI
ClusterResourceTypeCloseEnum(_In_ HRESTYPEENUM hResTypeEnum);
...
HNETWORK
WINAPI
OpenClusterNetwork(_In_ HCLUSTER hCluster, _In_ LPCWSTR lpszNetworkName);

typedef HNETWORK(WINAPI *PCLUSAPI_OPEN_CLUSTER_NETWORK)(
    _In_ HCLUSTER hCluster, _In_ LPCWSTR lpszNetworkName);

#if (CLUSAPI_VERSION >= CLUSAPI_VERSION_SERVER2008R2)
HNETWORK
WINAPI
OpenClusterNetworkEx(_In_ HCLUSTER hCluster, _In_opt_ LPCWSTR lpszNetworkName,
                     _In_ DWORD dwDesiredAccess,
                     _Out_opt_ DWORD *lpdwGrantedAccess);

typedef HNETWORK(WINAPI *PCLUSAPI_OPEN_CLUSTER_NETWORK_EX)(
    _In_ HCLUSTER hCluster, _In_opt_ LPCWSTR lpszNetworkName,
    _In_ DWORD dwDesiredAccess, _Out_opt_ LPDWORD lpdwGrantedAccess);
#endif

BOOL WINAPI CloseClusterNetwork(_In_ HNETWORK hNetwork);

typedef BOOL(WINAPI *PCLUSAPI_CLOSE_CLUSTER_NETWORK)(_In_ HNETWORK hNetwork);

HCLUSTER
WINAPI
GetClusterFromNetwork(_In_ HNETWORK hNetwork);
...
HNETWORKENUM
WINAPI
ClusterNetworkOpenEnum(_In_ HNETWORK hNetwork, _In_ DWORD dwType);

typedef HNETWORKENUM(WINAPI *PCLUSAPI_CLUSTER_NETWORK_OPEN_ENUM)(
    _In_ HNETWORK hNetwork, _In_ DWORD dwType);

DWORD
WINAPI
ClusterNetworkGetEnumCount(_In_ HNETWORKENUM hNetworkEnum);

typedef DWORD(WINAPI *PCLUSAPI_CLUSTER_NETWORK_GET_ENUM_COUNT)(
    _In_ HNETWORKENUM hNetworkEnum);

_Success_(return == ERROR_SUCCESS) DWORD WINAPI
    ClusterNetworkEnum(_In_ HNETWORKENUM hNetworkEnum, _In_ DWORD dwIndex,
                       _Out_ LPDWORD lpdwType,
                       _Out_writes_to_(*lpcchName, *lpcchName + 1)
                           LPWSTR lpszName,
                       _Inout_ LPDWORD lpcchName);
...
typedef DWORD(WINAPI *PCLUSAPI_CLUSTER_NETWORK_ENUM)(
    _In_ HNETWORKENUM hNetworkEnum, _In_ DWORD dwIndex, _Out_ LPDWORD lpdwType,
    _Out_writes_to_(*lpcchName, *lpcchName + 1) LPWSTR lpszName,
    _Inout_ LPDWORD lpcchName);

DWORD
WINAPI
ClusterNetworkCloseEnum(_In_ HNETWORKENUM hNetworkEnum);
...
CLUSTER_NETWORK_STATE
WINAPI
GetClusterNetworkState(_In_ HNETWORK hNetwork);
...
DWORD
WINAPI
SetClusterNetworkName(_In_ HNETWORK hNetwork, _In_ LPCWSTR lpszName);

typedef DWORD(WINAPI *PCLUSAPI_SET_CLUSTER_NETWORK_NAME)(_In_ HNETWORK hNetwork,
...
DWORD
WINAPI
SetClusterNetworkNameEx(_In_ HNETWORK hNetwork, _In_ LPCWSTR lpszName,
                        _In_opt_ LPCWSTR lpszReason);

typedef DWORD(WINAPI *PCLUSAPI_SET_CLUSTER_NETWORK_NAME_EX)(
    _In_ HNETWORK hNetwork, _In_ LPCWSTR lpszName, _In_opt_ LPCWSTR lpszReason);

#endif

_Success_(return == ERROR_SUCCESS) DWORD WINAPI
    GetClusterNetworkId(_In_ HNETWORK hNetwork,
                        _Out_writes_to_(*lpcchName, *lpcchName + 1)
                            LPWSTR lpszNetworkId,
                        _Inout_ LPDWORD lpcchName);

typedef DWORD(WINAPI *PCLUSAPI_GET_CLUSTER_NETWORK_ID)(
    _In_ HNETWORK hNetwork,
...
typedef DWORD(WINAPI *PCLUSAPI_CLUSTER_NETWORK_CONTROL)(
    _In_ HNETWORK hNetwork, _In_opt_ HNODE hHostNode, _In_ DWORD dwControlCode,
    _In_reads_bytes_opt_(nInBufferSize) LPVOID lpInBuffer,
    _In_ DWORD nInBufferSize,
    _Out_writes_bytes_to_opt_(nOutBufferSize, *lpBytesReturned)
...
typedef DWORD(WINAPI *PCLUSAPI_CLUSTER_NETWORK_CONTROL_EX)(
    _In_ HNETWORK hNetwork, _In_opt_ HNODE hHostNode, _In_ DWORD dwControlCode,
    _In_reads_bytes_opt_(nInBufferSize) LPVOID lpInBuffer,
    _In_ DWORD nInBufferSize,
    _Out_writes_bytes_to_opt_(nOutBufferSize, *lpBytesReturned)
...
HNETINTERFACE
WINAPI
OpenClusterNetInterface(_In_ HCLUSTER hCluster, _In_ LPCWSTR lpszInterfaceName);

typedef HNETINTERFACE(WINAPI *PCLUSAPI_OPEN_CLUSTER_NET_INTERFACE)(
    _In_ HCLUSTER hCluster, _In_ LPCWSTR lpszInterfaceName);

#if (CLUSAPI_VERSION >= CLUSAPI_VERSION_SERVER2008R2)
HNETINTERFACE
WINAPI
OpenClusterNetInterfaceEx(_In_ HCLUSTER hCluster,
                          _In_opt_ LPCWSTR lpszInterfaceName,
                          _In_ DWORD dwDesiredAccess,
                          _Out_opt_ DWORD *lpdwGrantedAccess);

typedef HNETINTERFACE(WINAPI *PCLUSAPI_OPEN_CLUSTER_NETINTERFACE_EX)(
    _In_ HCLUSTER hCluster, _In_opt_ LPCWSTR lpszNetInterfaceName,
    _In_ DWORD dwDesiredAccess, _Out_opt_ LPDWORD lpdwGrantedAccess);
#endif

_Success_(return == ERROR_SUCCESS) DWORD WINAPI
    GetClusterNetInterface(_In_ HCLUSTER hCluster, _In_ LPCWSTR lpszNodeName,
                           _In_ LPCWSTR lpszNetworkName,
                           _Out_writes_to_(*lpcchInterfaceName,
                                           *lpcchInterfaceName + 1)
                               LPWSTR lpszInterfaceName,
                           _Inout_ LPDWORD lpcchInterfaceName);

_Success_(return == ERROR_SUCCESS) DWORD WINAPI
    GetClusterNetInterfaceEx(_In_ HCLUSTER hCluster, _In_ LPCWSTR lpszNodeName,
                             _In_ LPCWSTR lpszNetworkName,
                             _Out_writes_to_(*lpcbInterfaceListBufSize,
                                             *lpcbInterfaceListBufSize)
                                 LPWSTR lpmszInterfaceNameList,
                             _Inout_ LPDWORD lpcbInterfaceListBufSize);

typedef DWORD(WINAPI *PCLUSAPI_GET_CLUSTER_NET_INTERFACE)(
    _In_ HCLUSTER hCluster, _In_ LPCWSTR lpszNodeName,
    _In_ LPCWSTR lpszNetworkName,
    _Out_writes_to_opt_(*lpcchInterfaceName, *lpcchInterfaceName + 1)
        LPWSTR lpszInterfaceName,
    _Inout_ LPDWORD lpcchInterfaceName);

BOOL WINAPI CloseClusterNetInterface(_In_ HNETINTERFACE hNetInterface);

typedef BOOL(WINAPI *PCLUSAPI_CLOSE_CLUSTER_NET_INTERFACE)(
    _In_ HNETINTERFACE hNetInterface);

HCLUSTER
WINAPI
GetClusterFromNetInterface(_In_ HNETINTERFACE hNetInterface);

typedef HCLUSTER(WINAPI *PCLUSAPI_GET_CLUSTER_FROM_NET_INTERFACE)(
    _In_ HNETINTERFACE hNetInterface);

CLUSTER_NETINTERFACE_STATE
WINAPI
GetClusterNetInterfaceState(_In_ HNETINTERFACE hNetInterface);
...
ClusterNetInterfaceControl(
    _In_ HNETINTERFACE hNetInterface, _In_opt_ HNODE hHostNode,
    _In_ DWORD dwControlCode,
    _In_reads_bytes_opt_(nInBufferSize) LPVOID lpInBuffer,
    _In_ DWORD nInBufferSize,
    _Out_writes_bytes_to_opt_(nOutBufferSize, *lpBytesReturned)
...
typedef DWORD(WINAPI *PCLUSAPI_CLUSTER_NET_INTERFACE_CONTROL)(
    _In_ HNETINTERFACE hNetInterface, _In_opt_ HNODE hHostNode,
    _In_ DWORD dwControlCode,
    _In_reads_bytes_opt_(nInBufferSize) LPVOID lpInBuffer,
    _In_ DWORD nInBufferSize,
...
typedef DWORD(WINAPI *PCLUSAPI_CLUSTER_NET_INTERFACE_CONTROL_EX)(
    _In_ HNETINTERFACE hNetInterface, _In_opt_ HNODE hHostNode,
    _In_ DWORD dwControlCode,
    _In_reads_bytes_opt_(nInBufferSize) LPVOID lpInBuffer,
    _In_ DWORD nInBufferSize,
...
#if (!MIDL_PASS && !__midl)
HKEY WINAPI GetClusterKey(_In_ HCLUSTER hCluster, _In_ REGSAM samDesired);

typedef HKEY(WINAPI *PCLUSAPI_GET_CLUSTER_KEY)(HCLUSTER hCluster,
                                               REGSAM samDesired);

HKEY WINAPI GetClusterGroupKey(_In_ HGROUP hGroup, _In_ REGSAM samDesired);

typedef HKEY(WINAPI *PCLUSAPI_GET_CLUSTER_GROUP_KEY)(HGROUP hGroup,
                                                     REGSAM samDesired);

HKEY WINAPI GetClusterResourceKey(_In_ HRESOURCE hResource,
                                  _In_ REGSAM samDesired);

typedef HKEY(WINAPI *PCLUSAPI_GET_CLUSTER_RESOURCE_KEY)(HRESOURCE hResource,
                                                        REGSAM samDesired);

HKEY WINAPI GetClusterNodeKey(_In_ HNODE hNode, _In_ REGSAM samDesired);

typedef HKEY(WINAPI *PCLUSAPI_GET_CLUSTER_NODE_KEY)(HNODE hNode,
                                                    REGSAM samDesired);

HKEY WINAPI GetClusterNetworkKey(_In_ HNETWORK hNetwork,
                                 _In_ REGSAM samDesired);

typedef HKEY(WINAPI *PCLUSAPI_GET_CLUSTER_NETWORK_KEY)(_In_ HNETWORK hNetwork,
                                                       _In_ REGSAM samDesired);

HKEY WINAPI GetClusterNetInterfaceKey(_In_ HNETINTERFACE hNetInterface,
                                      _In_ REGSAM samDesired);

typedef HKEY(WINAPI *PCLUSAPI_GET_CLUSTER_NET_INTERFACE_KEY)(
    _In_ HNETINTERFACE hNetInterface, _In_ REGSAM samDesired);

LONG WINAPI ClusterRegCreateKey(
    _In_ HKEY hKey, _In_ LPCWSTR lpszSubKey, _In_ DWORD dwOptions,
    _In_ REGSAM samDesired, _In_opt_ LPSECURITY_ATTRIBUTES lpSecurityAttributes,
    _Out_ PHKEY phkResult, _Out_opt_ LPDWORD lpdwDisposition);

typedef LONG(WINAPI *PCLUSAPI_CLUSTER_REG_CREATE_KEY)(
    _In_ HKEY hKey, _In_ LPCWSTR lpszSubKey, _In_ DWORD dwOptions,
    _In_ REGSAM samDesired, _In_opt_ LPSECURITY_ATTRIBUTES lpSecurityAttributes,
    _Out_ PHKEY phkResult, _Out_opt_ LPDWORD lpdwDisposition);
...
LONG WINAPI ClusterRegCreateKeyEx(
    __in HKEY hKey, __in LPCWSTR lpSubKey, __in DWORD dwOptions,
    __in REGSAM samDesired, __in_opt LPSECURITY_ATTRIBUTES lpSecurityAttributes,
    __out PHKEY phkResult, __out_opt LPDWORD lpdwDisposition,
    _In_opt_ LPCWSTR lpszReason);

typedef LONG(WINAPI *PCLUSAPI_CLUSTER_REG_CREATE_KEY_EX)(
    _In_ HKEY hKey, _In_ LPCWSTR lpszSubKey, _In_ DWORD dwOptions,
    _In_ REGSAM samDesired, _In_opt_ LPSECURITY_ATTRIBUTES lpSecurityAttributes,
    _Out_ PHKEY phkResult, _Out_opt_ LPDWORD lpdwDisposition,
    _In_opt_ LPCWSTR lpszReason);
...
LONG WINAPI ClusterRegOpenKey(_In_ HKEY hKey, _In_ LPCWSTR lpszSubKey,
                              _In_ REGSAM samDesired, _Out_ PHKEY phkResult);

typedef LONG(WINAPI *PCLUSAPI_CLUSTER_REG_OPEN_KEY)(HKEY hKey,
                                                    LPCWSTR lpszSubKey,
                                                    REGSAM samDesired,
                                                    PHKEY phkResult);

LONG WINAPI ClusterRegDeleteKey(_In_ HKEY hKey, _In_ LPCWSTR lpszSubKey);

typedef LONG(WINAPI *PCLUSAPI_CLUSTER_REG_DELETE_KEY)(HKEY hKey,
                                                      LPCWSTR lpszSubKey);

#if (CLUSAPI_VERSION >= CLUSAPI_VERSION_NI)

LONG WINAPI ClusterRegDeleteKeyEx(_In_ HKEY hKey, _In_ LPCWSTR lpSubKey,
                                  _In_opt_ LPCWSTR lpszReason);

typedef LONG(WINAPI *PCLUSAPI_CLUSTER_REG_DELETE_KEY_EX)(
    _In_ HKEY hKey, _In_ LPCWSTR lpSubKey, _In_opt_ LPCWSTR lpszReason);

#endif

LONG WINAPI ClusterRegCloseKey(_In_ HKEY hKey);

typedef LONG(WINAPI *PCLUSAPI_CLUSTER_REG_CLOSE_KEY)(HKEY hKey);

_Success_(return == ERROR_SUCCESS) LONG WINAPI
    ClusterRegEnumKey(_In_ HKEY hKey, _In_ DWORD dwIndex,
                      _Out_writes_to_(*lpcchName, *lpcchName + 1)
                          LPWSTR lpszName,
                      _Inout_ LPDWORD lpcchName,
                      _Out_opt_ PFILETIME lpftLastWriteTime);

typedef LONG(WINAPI *PCLUSAPI_CLUSTER_REG_ENUM_KEY)(
    _In_ HKEY hKey, _In_ DWORD dwIndex,
    _Out_writes_to_(*lpcchName, *lpcchName + 1) LPWSTR lpszName,
    _Inout_ LPDWORD lpcchName, _Out_ PFILETIME lpftLastWriteTime);

DWORD
WINAPI
ClusterRegSetValue(_In_ HKEY hKey, _In_ LPCWSTR lpszValueName,
                   _In_ DWORD dwType, _In_ CONST BYTE *lpData,
                   _In_ DWORD cbData);

typedef DWORD(WINAPI *PCLUSAPI_CLUSTER_REG_SET_VALUE)(HKEY hKey,
...
DWORD
WINAPI
ClusterRegDeleteValue(_In_ HKEY hKey, _In_ LPCWSTR lpszValueName);

typedef DWORD(WINAPI *PCLUSAPI_CLUSTER_REG_DELETE_VALUE)(HKEY hKey,
                                                         LPCWSTR lpszValueName);
...
DWORD
WINAPI
ClusterRegSetValueEx(_In_ HKEY hKey, _In_ LPCWSTR lpszValueName,
                     _In_ DWORD dwType, _In_ CONST BYTE *lpData,
                     _In_ DWORD cbData, _In_opt_ LPCWSTR lpszReason);

typedef DWORD(WINAPI *PCLUSAPI_CLUSTER_REG_SET_VALUE_EX)(
    _In_ HKEY hKey, _In_ LPCWSTR lpszValueName, _In_ DWORD dwType,
    _In_ CONST BYTE *lpData, _In_ DWORD cbData, _In_opt_ LPCWSTR lpszReason);

DWORD
WINAPI
ClusterRegDeleteValueEx(_In_ HKEY hKey, _In_ LPCWSTR lpszValueName,
                        _In_opt_ LPCWSTR lpszReason);

typedef DWORD(WINAPI *PCLUSAPI_CLUSTER_REG_DELETE_VALUE_EX)(
    _In_ HKEY hKey, _In_ LPCWSTR lpszValueName, _In_opt_ LPCWSTR lpszReason);

#endif

LONG WINAPI ClusterRegQueryValue(_In_ HKEY hKey, _In_ LPCWSTR lpszValueName,
                                 _Out_opt_ LPDWORD lpdwValueType,
                                 _Out_writes_bytes_to_opt_(*lpcbData, *lpcbData)
                                     LPBYTE lpData,
                                 _Inout_opt_ LPDWORD lpcbData);

typedef LONG(WINAPI *PCLUSAPI_CLUSTER_REG_QUERY_VALUE)(
    _In_ HKEY hKey, _In_ LPCWSTR lpszValueName, _Out_opt_ LPDWORD lpdwValueType,
    _Out_writes_bytes_to_opt_(*lpcbData, *lpcbData) LPBYTE lpData,
    _Inout_opt_ LPDWORD lpcbData);

_Success_(return == ERROR_SUCCESS) DWORD WINAPI ClusterRegEnumValue(
    _In_ HKEY hKey, _In_ DWORD dwIndex,
    _Out_writes_to_(*lpcchValueName, *lpcchValueName + 1) LPWSTR lpszValueName,
    _Inout_ LPDWORD lpcchValueName, _Out_opt_ LPDWORD lpdwType,
    _Out_writes_bytes_to_opt_(*lpcbData, *lpcbData) LPBYTE lpData,
    _Inout_opt_ LPDWORD lpcbData);

typedef DWORD(WINAPI *PCLUSAPI_CLUSTER_REG_ENUM_VALUE)(
    _In_ HKEY hKey, _In_ DWORD dwIndex,
    _Out_writes_to_(*lpcchValueName, *lpcchValueName + 1) LPWSTR lpszValueName,
    _Inout_ LPDWORD lpcchValueName, _Out_ LPDWORD lpdwType,
    _Out_writes_bytes_to_opt_(*lpcbData, *lpcbData) LPBYTE lpData,
    _Inout_opt_ LPDWORD lpcbData);

LONG WINAPI ClusterRegQueryInfoKey(_In_ HKEY hKey, _In_ LPDWORD lpcSubKeys,
...
typedef LONG(WINAPI *PCLUSAPI_CLUSTER_REG_QUERY_INFO_KEY)(
    HKEY hKey, LPDWORD lpcSubKeys, LPDWORD lpcbMaxSubKeyLen, LPDWORD lpcValues,
    LPDWORD lpcbMaxValueNameLen, LPDWORD lpcbMaxValueLen,
    LPDWORD lpcbSecurityDescriptor, PFILETIME lpftLastWriteTime);

LONG WINAPI ClusterRegGetKeySecurity(
    _In_ HKEY hKey, _In_ SECURITY_INFORMATION RequestedInformation,
    _Out_writes_bytes_to_(*lpcbSecurityDescriptor, *lpcbSecurityDescriptor)
        PSECURITY_DESCRIPTOR pSecurityDescriptor,
    _Inout_ LPDWORD lpcbSecurityDescriptor);

typedef LONG(WINAPI *PCLUSAPI_CLUSTER_REG_GET_KEY_SECURITY)(
    _In_ HKEY hKey, _In_ SECURITY_INFORMATION RequestedInformation,
    _Out_writes_bytes_to_(*lpcbSecurityDescriptor, *lpcbSecurityDescriptor)
        PSECURITY_DESCRIPTOR pSecurityDescriptor,
    _Inout_ LPDWORD lpcbSecurityDescriptor);
...
typedef LONG(WINAPI *PCLUSAPI_CLUSTER_REG_SET_KEY_SECURITY)(
    HKEY hKey, SECURITY_INFORMATION SecurityInformation,
    PSECURITY_DESCRIPTOR pSecurityDescriptor);

#if (CLUSAPI_VERSION >= CLUSAPI_VERSION_NI)

LONG WINAPI ClusterRegSetKeySecurityEx(
    _In_ HKEY hKey, _In_ SECURITY_INFORMATION SecurityInformation,
    _In_ PSECURITY_DESCRIPTOR pSecurityDescriptor, _In_opt_ LPCWSTR lpszReason);

typedef LONG(WINAPI *PCLUSAPI_CLUSTER_REG_SET_KEY_SECURITY_EX)(
    HKEY hKey, SECURITY_INFORMATION SecurityInformation,
    PSECURITY_DESCRIPTOR pSecurityDescriptor, _In_opt_ LPCWSTR lpszReason);

#endif

LONG WINAPI ClusterRegSyncDatabase(_In_ HCLUSTER hCluster, _In_ DWORD flags);

typedef LONG(WINAPI *PCLUSAPI_CLUSTER_REG_SYNC_DATABASE)(HCLUSTER hCluster,
                                                         DWORD flags);

LONG WINAPI ClusterRegCreateBatch(_In_opt_ HKEY hKey,
                                  _Out_ HREGBATCH *pHREGBATCH);

typedef LONG(WINAPI *PCLUSAPI_CLUSTER_REG_CREATE_BATCH)(
    _In_opt_ HKEY hKey, _Out_ HREGBATCH *pHREGBATCH);

LONG WINAPI ClusterRegBatchAddCommand(
    _In_ HREGBATCH hRegBatch, _In_ CLUSTER_REG_COMMAND dwCommand,
    _In_opt_ LPCWSTR wzName, _In_ DWORD dwOptions,
    _In_reads_bytes_opt_(cbData) VOID CONST *lpData, _In_ DWORD cbData);

typedef LONG(WINAPI *PCLUSTER_REG_BATCH_ADD_COMMAND)(
    _In_ HREGBATCH hRegBatch, _In_ CLUSTER_REG_COMMAND dwCommand,
    _In_opt_ LPWSTR wzName, _In_ DWORD dwOptions,
    _In_reads_bytes_opt_(cbData) VOID CONST *lpData, _In_ DWORD cbData);

LONG WINAPI ClusterRegCloseBatch(_In_ HREGBATCH hRegBatch, _In_ BOOL bCommit,
                                 _Out_opt_ INT *failedCommandNumber);

LONG WINAPI ClusterRegCloseBatchEx(_In_ HREGBATCH hRegBatch, _In_ DWORD flags,
                                   _Out_opt_ INT *failedCommandNumber);

typedef LONG(WINAPI *PCLUSTER_REG_CLOSE_BATCH)(
    _In_ HREGBATCH hRegBatch, _In_ BOOL bCommit,
    _Out_opt_ INT *failedCommandNumber);

LONG WINAPI
ClusterRegBatchReadCommand(_In_ HREGBATCHNOTIFICATION hBatchNotification,
                           _Out_ CLUSTER_BATCH_COMMAND *pBatchCommand);

typedef LONG(WINAPI *PCLUSTER_REG_BATCH_READ_COMMAND)(
    _In_ HREGBATCHNOTIFICATION hBatchNotification,
    _Out_ CLUSTER_BATCH_COMMAND *pBatchCommand);

LONG WINAPI
ClusterRegBatchCloseNotification(_In_ HREGBATCHNOTIFICATION hBatchNotification);

typedef LONG(WINAPI *PCLUSTER_REG_BATCH_CLOSE_NOTIFICATION)(
    _In_ HREGBATCHNOTIFICATION hBatchNotification);

LONG WINAPI ClusterRegCreateBatchNotifyPort(
    _In_ HKEY hKey, _Out_ HREGBATCHPORT *phBatchNotifyPort);

typedef LONG(WINAPI *PCLUSTER_REG_CREATE_BATCH_NOTIFY_PORT)(
    _In_ HKEY hKey, _Out_ HREGBATCHPORT *phBatchNotifyPort);

LONG WINAPI ClusterRegCloseBatchNotifyPort(_In_ HREGBATCHPORT hBatchNotifyPort);

typedef LONG(WINAPI *PCLUSTER_REG_CLOSE_BATCH_NOTIFY_PORT)(
...
LONG WINAPI ClusterRegCreateReadBatch(_In_ HKEY hKey,
                                      _Out_ HREGREADBATCH *phRegReadBatch);

typedef LONG(WINAPI *PCLUSTER_REG_CREATE_READ_BATCH)(
    _In_ HKEY hKey, _Out_ HREGREADBATCH *phRegReadBatch);

LONG WINAPI ClusterRegReadBatchAddCommand(_In_ HREGREADBATCH hRegReadBatch,
                                          _In_ LPCWSTR wzSubkeyName,
                                          _In_ LPCWSTR wzValueName);

typedef LONG(WINAPI *PCLUSTER_REG_READ_BATCH_ADD_COMMAND)(
    _In_ HREGREADBATCH hRegReadBatch, _In_ LPCWSTR wzSubkeyName,
    _In_ LPCWSTR wzValueName);

LONG WINAPI
ClusterRegCloseReadBatch(_In_ HREGREADBATCH hRegReadBatch,
                         _Out_ HREGREADBATCHREPLY *phRegReadBatchReply);

typedef LONG(WINAPI *PCLUSTER_REG_CLOSE_READ_BATCH)(
    _In_ HREGREADBATCH hRegReadBatch,
    _Out_ HREGREADBATCHREPLY *phRegReadBatchReply);

LONG WINAPI
ClusterRegCloseReadBatchEx(_In_ HREGREADBATCH hRegReadBatch, _In_ DWORD flags,
                           _Out_ HREGREADBATCHREPLY *phRegReadBatchReply);

typedef LONG(WINAPI *PCLUSTER_REG_CLOSE_READ_BATCH_EX)(
    _In_ HREGREADBATCH hRegReadBatch, _In_ DWORD flags,
    _Out_ HREGREADBATCHREPLY *phRegReadBatchReply);
...
typedef LONG(WINAPI *PCLUSTER_REG_READ_BATCH_REPLY_NEXT_COMMAND)(
    _In_ HREGREADBATCHREPLY hRegReadBatchReply,
    _Out_ CLUSTER_READ_BATCH_COMMAND *pBatchCommand);

LONG WINAPI
ClusterRegCloseReadBatchReply(_In_ HREGREADBATCHREPLY hRegReadBatchReply);

typedef LONG(WINAPI *PCLUSTER_REG_CLOSE_READ_BATCH_REPLY)(
    _In_ HREGREADBATCHREPLY hRegReadBatchReply);
...
ClusterSetAccountAccess(
    ...
    _In_ DWORD dwAccess, _In_ DWORD dwControlType);

typedef DWORD(WINAPI *PCLUSTER_SET_ACCOUNT_ACCESS)(_In_ HCLUSTER hCluster,
...
typedef BOOL(WINAPI *PCLUSTER_SETUP_PROGRESS_CALLBACK)(
    ...
    _In_opt_ PCWSTR lpszObjectName, DWORD dwStatus);

HCLUSTER
WINAPI
CreateCluster(_In_ PCREATE_CLUSTER_CONFIG pConfig,
...
HCLUSTER
WINAPI
CreateClusterCNOless(_In_ PCREATE_CLUSTER_CONFIG pConfig,
                     _In_opt_ PCLUSTER_SETUP_PROGRESS_CALLBACK
                         pfnProgressCallback,
                     _In_opt_ PVOID pvCallbackArg);

typedef HCLUSTER(WINAPI *PCLUSAPI_CREATE_CLUSTER_CNOLESS)(
    _In_ PCREATE_CLUSTER_CONFIG pConfig,
    _In_opt_ PCLUSTER_SETUP_PROGRESS_CALLBACK pfnProgressCallback,
    _In_opt_ PVOID pvCallbackArg);
...
typedef DWORD(WINAPI *PCLUSAPI_CREATE_CLUSTER_NAME_ACCOUNT)(
    _In_ HCLUSTER hCluster, _In_ PCREATE_CLUSTER_NAME_ACCOUNT pConfig,
    _In_opt_ PCLUSTER_SETUP_PROGRESS_CALLBACK pfnProgressCallback,
    _In_opt_ PVOID pvCallbackArg);
...
DWORD
WINAPI
RemoveClusterNameAccount(_In_ HCLUSTER hCluster,
                         _In_ BOOL bDeleteComputerObjects);

DWORD
WINAPI
RepairClusterNameAccount(
    _In_ HCLUSTER hCluster, _In_ PREPAIR_CLUSTER_NAME_ACCOUNT_CONFIG pConfig,
    _In_opt_ PCLUSTER_SETUP_PROGRESS_CALLBACK pfnProgressCallback,
    _In_opt_ PVOID pvCallbackArg);

typedef DWORD(WINAPI *PCLUSAPI_REPAIR_CLUSTER_NAME_ACCOUNT)(
    _In_ HCLUSTER hCluster);

DWORD
WINAPI
DetermineCNOResTypeFromNodelist(_In_ DWORD cNodes, _In_ PCWSTR *ppszNodeNames,
                                _Out_ CLUSTER_MGMT_POINT_RESTYPE *pCNOResType);

DWORD
WINAPI
DetermineCNOResTypeFromCluster(_In_ HCLUSTER hCluster,
                               _Out_ CLUSTER_MGMT_POINT_RESTYPE *pCNOResType);

DWORD
WINAPI
DetermineClusterCloudTypeFromNodelist(_In_ DWORD cNodes,
                                      _In_ PCWSTR *ppszNodeNames,
                                      _Out_ PCLUSTER_CLOUD_TYPE pCloudType);

DWORD
WINAPI
DetermineClusterCloudTypeFromCluster(_In_ HCLUSTER hCluster,
                                     _Out_ PCLUSTER_CLOUD_TYPE pCloudType);

DWORD
WINAPI
GetNodeCloudTypeDW(_In_ PCWSTR ppszNodeName, __out DWORD *NodeCloudType);
...
DWORD
WINAPI
RegisterClusterResourceTypeNotifyV2(__in HCHANGE hChange,
                                    __in HCLUSTER hCluster, __in LONGLONG Flags,
                                    __in LPCWSTR resTypeName,
                                    __in DWORD_PTR dwNotifyKey);

HNODE
WINAPI
AddClusterNode(_In_ HCLUSTER hCluster, _In_ PCWSTR lpszNodeName,
               _In_opt_ PCLUSTER_SETUP_PROGRESS_CALLBACK pfnProgressCallback,
               _In_opt_ PVOID pvCallbackArg);

DWORD
WINAPI
AddClusterStorageNode(_In_ HCLUSTER hCluster, _In_ PCWSTR lpszNodeName,
                      _In_opt_ PCLUSTER_SETUP_PROGRESS_CALLBACK
                          pfnProgressCallback,
                      _In_opt_ PVOID pvCallbackArg,
...
HNODE
WINAPI
AddClusterNodeEx(_In_ HCLUSTER hCluster, _In_ PCWSTR lpszNodeName,
                 _In_ DWORD dwFlags,
                 _In_opt_ PCLUSTER_SETUP_PROGRESS_CALLBACK pfnProgressCallback,
                 _In_opt_ PVOID pvCallbackArg);
...
DWORD
WINAPI
RemoveClusterStorageNode(__in HCLUSTER hCluster,
                         __in LPCWSTR lpszClusterStorageEnclosureName,
                         __in DWORD dwTimeout, __in DWORD dwFlags);

typedef HNODE(WINAPI *PCLUSAPI_ADD_CLUSTER_NODE)(
    _In_ HCLUSTER hCluster, _In_ PCWSTR lpszNodeName,
    _In_opt_ PCLUSTER_SETUP_PROGRESS_CALLBACK pfnProgressCallback,
    _In_opt_ PVOID pvCallbackArg);

typedef HNODE(WINAPI *PCLUSAPI_ADD_CLUSTER_NODE_EX)(
    _In_ HCLUSTER hCluster, _In_ PCWSTR lpszNodeName, _In_ DWORD dwFlags,
    _In_opt_ PCLUSTER_SETUP_PROGRESS_CALLBACK pfnProgressCallback,
    _In_opt_ PVOID pvCallbackArg);

DWORD
WINAPI
DestroyCluster(_In_ HCLUSTER hCluster,
               _In_opt_ PCLUSTER_SETUP_PROGRESS_CALLBACK pfnProgressCallback,
               _In_opt_ PVOID pvCallbackArg,
...
typedef DWORD(WINAPI *PCLUSAPI_DESTROY_CLUSTER)(
    _In_ HCLUSTER hCluster,
    _In_opt_ PCLUSTER_SETUP_PROGRESS_CALLBACK pfnProgressCallback,
    _In_opt_ PVOID pvCallbackArg, _In_ BOOL fdeleteVirtualComputerObjects);

//
// Standard Resource Type Names, these are duplicated in resapi.w's CLUSTER_ROLE
// struct. Be sure to update that struct when adding restype names.
//
...
#define CLUS_RESTYPE_NAME_VMREPLICA_COORDINATOR                                \
  L"Virtual Machine Replication Coordinator"
...
#define CLUSTER_SHARED_VOLUME_VSS_WRITER_OPERATION_TIMEOUT                     \
  L"SharedVolumeVssWriterOperationTimeout"
#define USE_CLIENT_ACCESS_NETWORKS_FOR_CSV                                     \
  L"UseClientAccessNetworksForSharedVolumes"
...
#define CLUSREG_NAME_ACCELERATED_NETWORKING_ENABLED                            \
  L"AcceleratedNetworkingEnabled"
#define CLUSREG_NAME_ACCELERATED_NETWORKING_NODE_RESERVE                       \
  L"AcceleratedNetworkingNodeReserve"
...
#define CLUSREG_NAME_GROUPSET_AVAILABILITY_SET_INDEX_TO_NODE_MAPPING           \
  L"NodeDomainInfo"
...
#define CLUSREG_NAME_STORAGESPACE_RESILIENCYCOLUMNS                            \
  L"VirtualDiskResiliencyColumns"
#define CLUSREG_NAME_STORAGESPACE_RESILIENCYINTERLEAVE                         \
  L"VirtualDiskResiliencyInterleave"
...
#define CLUSREG_NAME_STORAGESPACE_POOLREEVALTIMEOUT                            \
  L"ReEvaluatePlacementTimeout"
...
typedef struct _SR_RESOURCE_TYPE_REPLICATED_PARTITION_ARRAY {
  ...
  SR_RESOURCE_TYPE_REPLICATED_PARTITION_INFO
  PartitionArray[1]; /**< Variable size array of all replicated partitions
                        on the disk*/
...
typedef struct _SR_RESOURCE_TYPE_QUERY_ELIGIBLE_LOGDISKS {
  ...
  BOOLEAN IncludeOfflineDisks; /**< When TRUE, the result set includes all the
...
typedef struct _SR_RESOURCE_TYPE_ELIGIBLE_TARGET_DATADISKS {
  ...
  GUID TargetReplicationGroupGuid; /**< Replication group to which one of
                                      returned set of disk may be added.*/
  BOOLEAN SkipConnectivityCheck;   /**< When TRUE, even the disks that are
                                      connected to same nodes as the source disk
                                      are included in result set.*/
  BOOLEAN IncludeOfflineDisks; /**< When TRUE, the result set includes offline
                                  disks in Available Storage group.*/
...
typedef struct _SR_RESOURCE_TYPE_ELIGIBLE_SOURCE_DATADISKS {
  GUID DataDiskGuid; /**< Cluster resource identifier of data disk.*/
  BOOLEAN IncludeAvailableStoargeDisks; /**< When TRUE, the result set includes
                                           disks in Available Storage group.*/
...
typedef struct _SR_RESOURCE_TYPE_ELIGIBLE_DISKS_RESULT {
  ...
  DiskInfo[1]; /**< Cluster resource identifier and related information
                  about the disk.*/
...
typedef struct _SR_RESOURCE_TYPE_REPLICATED_DISK {
  ...
  WCHAR
  ReplicationGroupName[MAX_PATH]; /**< Name of the replication group name.*/
...
typedef struct _SR_RESOURCE_TYPE_REPLICATED_DISKS_RESULT {
  ...
  ReplicatedDisks[1]; /**< Array of replicated disks.*/
...
typedef struct _SR_RESOURCE_TYPE_ADD_REPLICATION_GROUP {
  WCHAR ReplicationGroupName[MAX_PATH]; /**< The name of the replication group
                                           to create*/
  ...
  USHORT LogType; /**< Whether the log is file based CLFS log (1) or RAW SR log
                     (2)*/
  DWORD ReplicationMode;          /**< Whether the replication is performed
                                     synchronously(1) or asynchronously(2)*/
  DWORD MinimumPartnersInSync;    /**< Minimum number of synchronous Replication
                                     Partners to be actively in sync before
                                     allowing data access by applications on the
                                     primary Replica*/
  ...
  ULONG VolumeNameCount; /**< Count of number of volumes in \ref VolumeNames
                            field*/
  WCHAR VolumeNames[ANYSIZE_ARRAY]
                   [MAX_PATH]; /**< A collection of volume names*/
} SR_RESOURCE_TYPE_ADD_REPLICATION_GROUP,
    *PSR_RESOURCE_TYPE_ADD_REPLICATION_GROUP;

typedef struct _SR_RESOURCE_TYPE_ADD_REPLICATION_GROUP_RESULT {
  DWORD Result;                /**< Result code*/
  WCHAR ErrorString[MAX_PATH]; /**< Buffer that contains error string from
                                  remote CIM calls.*/
} SR_RESOURCE_TYPE_ADD_REPLICATION_GROUP_RESULT,
    *PSR_RESOURCE_TYPE_ADD_REPLICATION_GROUP_RESULT;

//
// Input structure for CLUSCTL_RESOURCE_TYPE_STORAGE_GET_AVAILABLE_DISKS_EX2 /
// CLUSCTL_RESOURCE_TYPE_STORAGE_GET_AVAILABLE_DISKS_EX2
//
...
#define CLUSCTL_RESOURCE_TYPE_STORAGE_GET_AVAILABLE_DISKS_EX2_FLAG_ADD_VOLUME_INFO \
  0x00000001
#define CLUSCTL_RESOURCE_TYPE_STORAGE_GET_AVAILABLE_DISKS_EX2_FLAG_FILTER_BY_POOL \
  0x00000002
#define CLUSCTL_RESOURCE_TYPE_STORAGE_GET_AVAILABLE_DISKS_EX2_FLAG_INCLUDE_NON_SHARED_DISKS \
  0x00000004
