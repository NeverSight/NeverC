...
public:
  ...
  virtual /* [helpstring][id][propget] */ HRESULT STDMETHODCALLTYPE
      get_AdvertisingScope(
          /* [retval][out] */ __RPC__out RND_ADVERTISING_SCOPE *
          pAdvertisingScope) = 0;
...
typedef struct ITDirectoryObjectConferenceVtbl {
  ...
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in ITDirectoryObjectConference *This);
  ...
  /* [helpstring][id][propget] */ HRESULT(
      STDMETHODCALLTYPE *get_AdvertisingScope)(
      __RPC__in ITDirectoryObjectConference *This,
  ...
  /* [helpstring][id][propput] */ HRESULT(
      STDMETHODCALLTYPE *put_AdvertisingScope)(
      __RPC__in ITDirectoryObjectConference *This,
...
typedef struct ITDirectoryObjectUserVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in ITDirectoryObjectUser *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in ITDirectoryObjectUser *This);
...
public:
  ...
  virtual HRESULT STDMETHODCALLTYPE Clone(
      /* [retval][out] */ __RPC__deref_out_opt IEnumDialableAddrs *
      *ppEnum) = 0;
};
...
typedef struct IEnumDialableAddrsVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in IEnumDialableAddrs *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IEnumDialableAddrs *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IEnumDialableAddrs *This);
  ...
  HRESULT(STDMETHODCALLTYPE *Reset)(__RPC__in IEnumDialableAddrs *This);

  DECLSPEC_XFGVIRT(IEnumDialableAddrs, Skip)
  HRESULT(STDMETHODCALLTYPE *Skip)(__RPC__in IEnumDialableAddrs *This,
                                   /* [in] */ ULONG celt);
...
public:
  virtual /* [helpstring][id][propget] */ HRESULT STDMETHODCALLTYPE
      get_ObjectType(
          /* [retval][out] */ __RPC__out DIRECTORY_OBJECT_TYPE *
          pObjectType) = 0;
  ...
  EnumerateDialableAddrs(
      ...
      /* [out] */ __RPC__deref_out_opt IEnumDialableAddrs *
          *ppEnumDialableAddrs) = 0;
...
typedef struct ITDirectoryObjectVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in ITDirectoryObject *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in ITDirectoryObject *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in ITDirectoryObject *This);
  ...
  /* [helpstring][restricted][hidden][id] */ HRESULT(
      STDMETHODCALLTYPE *EnumerateDialableAddrs)(
      __RPC__in ITDirectoryObject *This,
      /* [in] */ DWORD dwAddressType,
      /* [out] */
  ...
  /* [helpstring][id][propput] */ HRESULT(
      STDMETHODCALLTYPE *put_SecurityDescriptor)(
      __RPC__in ITDirectoryObject *This,
...
public:
  virtual HRESULT STDMETHODCALLTYPE Next(
      /* [in] */ ULONG celt,
      /* [size_is][out] */ __RPC__out_ecount_full(celt) ITDirectoryObject *
          *pVal,
      /* [full][out][in] */ __RPC__inout_opt ULONG * pcFetched) = 0;
  ...
  virtual HRESULT STDMETHODCALLTYPE Clone(
      /* [retval][out] */ __RPC__deref_out_opt IEnumDirectoryObject *
      *ppEnum) = 0;
};
...
typedef struct IEnumDirectoryObjectVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IEnumDirectoryObject *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IEnumDirectoryObject *This);
  ...
  HRESULT(STDMETHODCALLTYPE *Reset)(__RPC__in IEnumDirectoryObject *This);

  DECLSPEC_XFGVIRT(IEnumDirectoryObject, Skip)
  HRESULT(STDMETHODCALLTYPE *Skip)(__RPC__in IEnumDirectoryObject *This,
                                   /* [in] */ ULONG celt);
...
typedef struct ITILSConfigVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in ITILSConfig *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in ITILSConfig *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in ITILSConfig *This);
...
interface ITILSConfig { CONST_VTBL struct ITILSConfigVtbl *lpVtbl; };
...
public:
  ...
  EnumerateDirectoryObjects(
      /* [in] */ DIRECTORY_OBJECT_TYPE DirectoryObjectType,
      /* [in] */ __RPC__in BSTR pName,
      /* [out] */ __RPC__deref_out_opt IEnumDirectoryObject *
          *ppEnumObject) = 0;
};
...
typedef struct ITDirectoryVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in ITDirectory *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in ITDirectory *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in ITDirectory *This);
  ...
  /* [helpstring][id][propget] */ HRESULT(
      STDMETHODCALLTYPE *get_DefaultObjectTTL)(
      __RPC__in ITDirectory *This,
      /* [retval][out] */ __RPC__out long *pTTL);

  DECLSPEC_XFGVIRT(ITDirectory, put_DefaultObjectTTL)
  /* [helpstring][id][propput] */ HRESULT(
      STDMETHODCALLTYPE *put_DefaultObjectTTL)(__RPC__in ITDirectory *This,
                                               /* [in] */ long TTL);
  ...
  /* [helpstring][id][propget] */ HRESULT(
      STDMETHODCALLTYPE *get_DirectoryObjects)(
      __RPC__in ITDirectory *This,
      /* [in] */ DIRECTORY_OBJECT_TYPE DirectoryObjectType,
      /* [in] */ __RPC__in BSTR pName,
      /* [retval][out] */ __RPC__out VARIANT *pVariant);
  ...
  /* [helpstring][restricted][hidden][id] */ HRESULT(
      STDMETHODCALLTYPE *EnumerateDirectoryObjects)(
      __RPC__in ITDirectory *This,
      /* [in] */ DIRECTORY_OBJECT_TYPE DirectoryObjectType,
      /* [in] */ __RPC__in BSTR pName,
...
interface ITDirectory { CONST_VTBL struct ITDirectoryVtbl *lpVtbl; };
...
typedef struct IEnumDirectoryVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in IEnumDirectory *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IEnumDirectory *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IEnumDirectory *This);
  ...
  HRESULT(STDMETHODCALLTYPE *Reset)(__RPC__in IEnumDirectory *This);

  DECLSPEC_XFGVIRT(IEnumDirectory, Skip)
  HRESULT(STDMETHODCALLTYPE *Skip)(__RPC__in IEnumDirectory *This,
                                   /* [in] */ ULONG celt);
...
interface IEnumDirectory { CONST_VTBL struct IEnumDirectoryVtbl *lpVtbl; };
...
public:
  ...
  virtual /* [helpstring][restricted][hidden][id] */ HRESULT STDMETHODCALLTYPE
      EnumerateDefaultDirectories(
          /* [out] */ __RPC__deref_out_opt IEnumDirectory *
          *ppEnumDirectory) = 0;
  ...
  CreateDirectoryObject(
      /* [in] */ DIRECTORY_OBJECT_TYPE DirectoryObjectType,
      /* [in] */ __RPC__in BSTR pName,
      /* [retval][out] */ __RPC__deref_out_opt ITDirectoryObject *
          *ppDirectoryObject) = 0;
};
...
typedef struct ITRendezvousVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in ITRendezvous *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in ITRendezvous *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in ITRendezvous *This);
  ...
  /* [helpstring][id][propget] */ HRESULT(
      STDMETHODCALLTYPE *get_DefaultDirectories)(
      __RPC__in ITRendezvous *This,
      /* [retval][out] */ __RPC__out VARIANT *pVariant);

  DECLSPEC_XFGVIRT(ITRendezvous, EnumerateDefaultDirectories)
  /* [helpstring][restricted][hidden][id] */ HRESULT(
      STDMETHODCALLTYPE *EnumerateDefaultDirectories)(
      __RPC__in ITRendezvous *This,
...
interface ITRendezvous { CONST_VTBL struct ITRendezvousVtbl *lpVtbl; };
...
class DECLSPEC_UUID("F1029E5B-CB5B-11D0-8D59-00C04FD91AC0") Rendezvous;
#endif
