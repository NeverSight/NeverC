...
public:
  virtual /* [id] */ HRESULT STDMETHODCALLTYPE GetNetworks(
      ...
      /* [retval][out] */ __RPC__deref_out_opt IEnumNetworks *
          *ppEnumNetwork) = 0;
  ...
  virtual /* [id] */ HRESULT STDMETHODCALLTYPE GetNetworkConnections(
      /* [retval][out] */ __RPC__deref_out_opt IEnumNetworkConnections *
      *ppEnum) = 0;

  virtual /* [id] */ HRESULT STDMETHODCALLTYPE GetNetworkConnection(
      /* [in] */ GUID gdNetworkConnectionId,
      /* [retval][out] */ __RPC__deref_out_opt INetworkConnection *
          *ppNetworkConnection) = 0;
  ...
  virtual /* [id] */ HRESULT STDMETHODCALLTYPE ClearSimulatedProfileInfo(
      void) = 0;
};
...
typedef struct INetworkListManagerVtbl {
  ...
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in INetworkListManager *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in INetworkListManager *This);
...
typedef struct INetworkListManagerEventsVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in INetworkListManagerEvents *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in INetworkListManagerEvents *This);
...
typedef struct INetworkVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in INetwork *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in INetwork *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in INetwork *This);
...
interface INetwork { CONST_VTBL struct INetworkVtbl *lpVtbl; };
...
typedef struct INetwork2Vtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in INetwork2 *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in INetwork2 *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in INetwork2 *This);
...
interface INetwork2 { CONST_VTBL struct INetwork2Vtbl *lpVtbl; };
...
#define INetwork2_AddRef(This) ((This)->lpVtbl->AddRef(This))

#define INetwork2_Release(This) ((This)->lpVtbl->Release(This))
...
#define INetwork2_Invoke(This, dispIdMember, riid, lcid, wFlags, pDispParams,  \
                         pVarResult, pExcepInfo, puArgErr)                     \
  ((This)->lpVtbl->Invoke(This, dispIdMember, riid, lcid, wFlags, pDispParams, \
                          pVarResult, pExcepInfo, puArgErr))
...
#define INetwork2_GetTimeCreatedAndConnected(                                  \
    This, pdwLowDateTimeCreated, pdwHighDateTimeCreated,                       \
    pdwLowDateTimeConnected, pdwHighDateTimeConnected)                         \
  ((This)->lpVtbl->GetTimeCreatedAndConnected(                                 \
      This, pdwLowDateTimeCreated, pdwHighDateTimeCreated,                     \
...
#define INetwork2_IsDomainAuthenticatedBy(This, domainAuthenticationKind,      \
                                          pValue)                              \
  ((This)->lpVtbl->IsDomainAuthenticatedBy(This, domainAuthenticationKind,     \
                                           pValue))
...
typedef struct IEnumNetworksVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in IEnumNetworks *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IEnumNetworks *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IEnumNetworks *This);
  ...
  /* [id] */ HRESULT(STDMETHODCALLTYPE *Skip)(__RPC__in IEnumNetworks *This,
                                              /* [in] */ ULONG celt);

  DECLSPEC_XFGVIRT(IEnumNetworks, Reset)
  /* [id] */ HRESULT(STDMETHODCALLTYPE *Reset)(__RPC__in IEnumNetworks *This);
...
interface IEnumNetworks { CONST_VTBL struct IEnumNetworksVtbl *lpVtbl; };
...
typedef struct INetworkEventsVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in INetworkEvents *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in INetworkEvents *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in INetworkEvents *This);

  DECLSPEC_XFGVIRT(INetworkEvents, NetworkAdded)
  HRESULT(STDMETHODCALLTYPE *NetworkAdded)(__RPC__in INetworkEvents *This,
                                           /* [in] */ GUID networkId);

  DECLSPEC_XFGVIRT(INetworkEvents, NetworkDeleted)
  HRESULT(STDMETHODCALLTYPE *NetworkDeleted)(__RPC__in INetworkEvents *This,
                                             /* [in] */ GUID networkId);
...
interface INetworkEvents { CONST_VTBL struct INetworkEventsVtbl *lpVtbl; };
...
typedef struct INetworkConnectionVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in INetworkConnection *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in INetworkConnection *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in INetworkConnection *This);
...
typedef struct INetworkConnection2Vtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in INetworkConnection2 *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in INetworkConnection2 *This);
...
#define INetworkConnection2_AddRef(This) ((This)->lpVtbl->AddRef(This))

#define INetworkConnection2_Release(This) ((This)->lpVtbl->Release(This))
...
#define INetworkConnection2_GetIDsOfNames(This, riid, rgszNames, cNames, lcid, \
                                          rgDispId)                            \
  ((This)->lpVtbl->GetIDsOfNames(This, riid, rgszNames, cNames, lcid, rgDispId))

#define INetworkConnection2_Invoke(This, dispIdMember, riid, lcid, wFlags,     \
                                   pDispParams, pVarResult, pExcepInfo,        \
                                   puArgErr)                                   \
  ((This)->lpVtbl->Invoke(This, dispIdMember, riid, lcid, wFlags, pDispParams, \
                          pVarResult, pExcepInfo, puArgErr))
...
#define INetworkConnection2_IsDomainAuthenticatedBy(                           \
    This, domainAuthenticationKind, pValue)                                    \
  ((This)->lpVtbl->IsDomainAuthenticatedBy(This, domainAuthenticationKind,     \
                                           pValue))
...
typedef struct IEnumNetworkConnectionsVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IEnumNetworkConnections *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IEnumNetworkConnections *This);
...
typedef struct INetworkConnectionEventsVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in INetworkConnectionEvents *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in INetworkConnectionEvents *This);

  DECLSPEC_XFGVIRT(INetworkConnectionEvents,
...
public:
  ...
  virtual /* [id] */ HRESULT STDMETHODCALLTYPE SetDestinationAddresses(
      /* [range][in] */ __RPC__in_range(0, NLM_MAX_ADDRESS_LIST_SIZE)
          UINT32 length,
      /* [unique][size_is][in] */
...
typedef struct INetworkCostManagerVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in INetworkCostManager *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in INetworkCostManager *This);
...
typedef struct INetworkCostManagerEventsVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in INetworkCostManagerEvents *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in INetworkCostManagerEvents *This);
...
typedef struct INetworkConnectionCostVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in INetworkConnectionCost *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in INetworkConnectionCost *This);
...
typedef struct INetworkConnectionCostEventsVtbl {
  ...
  DECLSPEC_XFGVIRT(INetworkConnectionCostEvents,
...
#define INetworkConnectionCostEvents_AddRef(This) ((This)->lpVtbl->AddRef(This))

#define INetworkConnectionCostEvents_Release(This)                             \
  ((This)->lpVtbl->Release(This))

#define INetworkConnectionCostEvents_ConnectionCostChanged(This, connectionId, \
                                                           newCost)            \
  ((This)->lpVtbl->ConnectionCostChanged(This, connectionId, newCost))

#define INetworkConnectionCostEvents_ConnectionDataPlanStatusChanged(          \
    This, connectionId)                                                        \
