...
//  WIDEMATH.H
//
//  Portable (x86, x64, arm, arm64) 64-bit and 128-bit arithmetic math
//  functions.
//
//  These are broken up into two main categories:
//
//    - wide integer operations, e.g. 128-bit add, sub, mul, div, shifts,
//    rotates
//    - wide packed vector operations, e.g. 64-bit and 128-bit SIMD primitives
//
//  These functions are all implemented using portable 64-bit integer
//  arithmetic. Portability is achieved by using no CPU-specific intrinsics,
//  types, or ASM.
//
...
int32_t WIDEMATHAPI _SDIV64(int64_t Dividend, int32_t Divisor,
                            int32_t *Remainder);

uint32_t WIDEMATHAPI _UDIV64(uint64_t Dividend, uint32_t Divisor,
                             uint32_t *Remainder);
...
int64_t WIDEMATHAPI SDIV128(int64_t DividendHi, int64_t DividendLo,
                            int64_t Divisor, int64_t *Remainder);

uint64_t WIDEMATHAPI UDIV128(uint64_t DividendHi, uint64_t DividendLo,
...
__forceinline uint64_t WIDEMATHAPI PADC64(uint64_t X, uint64_t Y, uint64_t C,
                                          uint64_t Mask) {
...
__forceinline uint64_t WIDEMATHAPI PADD64(uint64_t X, uint64_t Y,
                                          uint64_t Mask) {
  return PADC64(X, Y, 0ull, Mask);
}

__forceinline uint64_t WIDEMATHAPI PSUB64(uint64_t X, uint64_t Y,
                                          uint64_t Mask) {
...
uint64_t WIDEMATHAPI PADDSI64(uint64_t X, uint64_t Y, uint64_t Mask,
                              unsigned DataWidth);

uint64_t WIDEMATHAPI PADDSU64(uint64_t X, uint64_t Y, uint64_t Mask,
                              unsigned DataWidth);

uint64_t WIDEMATHAPI PALIGNR64(uint64_t X, uint64_t Y, uint64_t ShiftCount);

__forceinline uint64_t WIDEMATHAPI PAND64(uint64_t X, uint64_t Y) {
  return X & Y;
}

__forceinline uint64_t WIDEMATHAPI PANDN64(uint64_t X, uint64_t Y) {
  return (~X) & Y;
}

uint64_t WIDEMATHAPI PAVG64(uint64_t X, uint64_t Y, uint64_t Mask);

uint64_t WIDEMATHAPI PCMPEQ64(uint64_t X, uint64_t Y, uint64_t Mask,
                              unsigned DataWidth);

uint64_t WIDEMATHAPI PCMPGT64(uint64_t X, uint64_t Y, uint64_t Mask,
                              unsigned DataWidth);
...
uint64_t WIDEMATHAPI PMAXI64(uint64_t X, uint64_t Y, uint64_t Mask,
                             unsigned DataWidth);

uint64_t WIDEMATHAPI PMAXU64(uint64_t X, uint64_t Y, uint64_t Mask,
                             unsigned DataWidth);

uint64_t WIDEMATHAPI PMINI64(uint64_t X, uint64_t Y, uint64_t Mask,
                             unsigned DataWidth);

uint64_t WIDEMATHAPI PMINU64(uint64_t X, uint64_t Y, uint64_t Mask,
                             unsigned DataWidth);
...
__forceinline uint64_t WIDEMATHAPI POR64(uint64_t X, uint64_t Y) {
  return X | Y;
}

uint64_t WIDEMATHAPI PSADBW64(uint64_t X, uint64_t Y);

uint64_t WIDEMATHAPI PSIGN64(uint64_t X, uint64_t Y, uint64_t Mask,
                             unsigned DataWidth);

uint64_t WIDEMATHAPI PSUBSI64(uint64_t X, uint64_t Y, uint64_t Mask,
                              unsigned DataWidth);
uint64_t WIDEMATHAPI PSUBSU64(uint64_t X, uint64_t Y, uint64_t Mask,
                              unsigned DataWidth);

uint64_t WIDEMATHAPI PSLL64(uint64_t X, uint64_t ShiftCount, uint64_t Mask,
                            unsigned DataWidth);
uint64_t WIDEMATHAPI PSRA64(uint64_t X, uint64_t ShiftCount, uint64_t Mask,
                            unsigned DataWidth);
uint64_t WIDEMATHAPI PSRL64(uint64_t X, uint64_t ShiftCount, uint64_t Mask,
                            unsigned DataWidth);
...
__forceinline uint64_t WIDEMATHAPI PXOR64(uint64_t X, uint64_t Y) {
  return X ^ Y;
}

uint64_t WIDEMATHAPI PACKSSWB64(uint64_t X, uint64_t Y, uint64_t Mask,
                                unsigned DataWidth);
uint64_t WIDEMATHAPI PACKUSWB64(uint64_t X, uint64_t Y, uint64_t Mask,
                                unsigned DataWidth);
uint64_t WIDEMATHAPI PACKSSDW64(uint64_t X, uint64_t Y, uint64_t Mask,
                                unsigned DataWidth);
uint64_t WIDEMATHAPI PACKUSDW64(uint64_t X, uint64_t Y, uint64_t Mask,
                                unsigned DataWidth);
...
uint128_t WIDEMATHAPI PACKSSWB128(uint128_t X, uint128_t Y, uint64_t Mask,
                                  unsigned DataWidth);
uint128_t WIDEMATHAPI PACKUSWB128(uint128_t X, uint128_t Y, uint64_t Mask,
                                  unsigned DataWidth);
uint128_t WIDEMATHAPI PACKSSDW128(uint128_t X, uint128_t Y, uint64_t Mask,
                                  unsigned DataWidth);
uint128_t WIDEMATHAPI PACKUSDW128(uint128_t X, uint128_t Y, uint64_t Mask,
                                  unsigned DataWidth);

uint128_t WIDEMATHAPI PABS128(uint128_t Y, uint64_t Mask, unsigned DataWidth);

__forceinline uint128_t WIDEMATHAPI PADD128(uint128_t X, uint128_t Y,
                                            uint64_t Mask) {
  uint128_t Result;
...
uint128_t WIDEMATHAPI PADDSI128(uint128_t X, uint128_t Y, uint64_t Mask,
                                unsigned DataWidth);
uint128_t WIDEMATHAPI PADDSU128(uint128_t X, uint128_t Y, uint64_t Mask,
                                unsigned DataWidth);

__forceinline uint128_t WIDEMATHAPI PAND128(uint128_t X, uint128_t Y) {
  uint128_t Result;
...
__forceinline uint128_t WIDEMATHAPI PANDN128(uint128_t X, uint128_t Y) {
  uint128_t Result;
...
uint128_t WIDEMATHAPI PCMPEQ128(uint128_t X, uint128_t Y, uint64_t Mask,
                                unsigned DataWidth);
uint128_t WIDEMATHAPI PCMPGT128(uint128_t X, uint128_t Y, uint64_t Mask,
                                unsigned DataWidth);

uint32_t WIDEMATHAPI PCMPESTRF128(uint128_t X, int LenX, uint128_t Y, int LenY,
                                  int Imm);
uint32_t WIDEMATHAPI PCMPESTRI128(uint128_t X, int LenX, uint128_t Y, int LenY,
                                  int Imm, uint32_t *Eflags);
uint128_t WIDEMATHAPI PCMPESTRM128(uint128_t X, int LenX, uint128_t Y, int LenY,
                                   int Imm, uint32_t *Eflags);
uint32_t WIDEMATHAPI PCMPISTRF128(uint128_t X, uint128_t Y, unsigned Imm);
uint32_t WIDEMATHAPI PCMPISTRI128(uint128_t X, uint128_t Y, unsigned Imm,
                                  uint32_t *Eflags);
uint128_t WIDEMATHAPI PCMPISTRM128(uint128_t X, uint128_t Y, unsigned Imm,
                                   uint32_t *Eflags);
...
uint128_t WIDEMATHAPI PMAXI128(uint128_t X, uint128_t Y, uint64_t Mask,
                               unsigned DataWidth);
uint128_t WIDEMATHAPI PMAXU128(uint128_t X, uint128_t Y, uint64_t Mask,
                               unsigned DataWidth);

uint128_t WIDEMATHAPI PMINI128(uint128_t X, uint128_t Y, uint64_t Mask,
                               unsigned DataWidth);
uint128_t WIDEMATHAPI PMINU128(uint128_t X, uint128_t Y, uint64_t Mask,
                               unsigned DataWidth);
...
uint128_t WIDEMATHAPI PSIGN128(uint128_t X, uint128_t Y, uint64_t Mask,
                               unsigned DataWidth);

uint128_t WIDEMATHAPI PSLL128(uint128_t X, uint128_t Y, uint64_t Mask,
                              unsigned DataWidth);
uint128_t WIDEMATHAPI PSLLDQ(uint128_t X, uint64_t ShiftCount);
uint128_t WIDEMATHAPI PSRA128(uint128_t X, uint128_t Y, uint64_t Mask,
                              unsigned DataWidth);
uint128_t WIDEMATHAPI PSRL128(uint128_t X, uint128_t Y, uint64_t Mask,
                              unsigned DataWidth);
...
uint128_t WIDEMATHAPI PSUBSI128(uint128_t X, uint128_t Y, uint64_t Mask,
                                unsigned DataWidth);
uint128_t WIDEMATHAPI PSUBSU128(uint128_t X, uint128_t Y, uint64_t Mask,
                                unsigned DataWidth);

uint128_t WIDEMATHAPI PSHUFB128(uint128_t X, uint128_t Y);

__forceinline uint128_t WIDEMATHAPI PSHUFD128(uint128_t Y, int Imm) {
  uint64_t InputLo = Y.Q[0];
  uint64_t InputHi = Y.Q[1];
  uint128_t OutputVector;

  OutputVector.Q[0] =
      (uint32_t)((((Imm & 0x02) ? InputHi : InputLo) >> ((Imm & 0x01) << 5))) |
      ((((Imm & 0x08) ? InputHi : InputLo) >> ((Imm & 0x04) << 3)) << 32);
  OutputVector.Q[1] =
      (uint32_t)((((Imm & 0x20) ? InputHi : InputLo) >> ((Imm & 0x10) << 1))) |
...
uint128_t WIDEMATHAPI PUNPCK128(uint128_t X, uint128_t Y,
                                uint64_t SwizzleBytes);
uint128_t WIDEMATHAPI PUNPCKH128(uint128_t X, uint128_t Y,
                                 uint64_t SwizzleBytes);
...
__forceinline uint128_t WIDEMATHAPI PXOR128(uint128_t X, uint128_t Y) {
  uint128_t Result;
...
uint32_t WIDEMATHAPI _CRC64(uint32_t X, uint64_t Y, uint64_t Polynomial,
                            unsigned Datawidth);
...
uint128_t WIDEMATHAPI ROUNDSD128(uint128_t X, uint128_t Y,
                                 unsigned RoundingMode);
uint128_t WIDEMATHAPI ROUNDSS128(uint128_t X, uint128_t Y,
                                 unsigned RoundingMode);
