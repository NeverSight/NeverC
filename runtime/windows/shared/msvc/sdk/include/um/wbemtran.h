...
typedef struct IWbemTransportVtbl {
  ...
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(IWbemTransport *This,
                                             /* [in] */ REFIID riid,
...
interface IWbemTransport { CONST_VTBL struct IWbemTransportVtbl *lpVtbl; };
...
typedef struct IWbemLevel1LoginVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in IWbemLevel1Login *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IWbemLevel1Login *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IWbemLevel1Login *This);
...
interface IWbemLevel1Login { CONST_VTBL struct IWbemLevel1LoginVtbl *lpVtbl; };
...
#define IWbemLevel1Login_EstablishPosition(This, wszLocaleList, dwNumLocales,  \
                                           reserved)                           \
  ((This)->lpVtbl->EstablishPosition(This, wszLocaleList, dwNumLocales,        \
                                     reserved))
...
typedef struct IWbemConnectorLoginVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IWbemConnectorLogin *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IWbemConnectorLogin *This);
...
#define IWbemConnectorLogin_ConnectorLogin(This, wszNetworkResource,           \
                                           ...
                                           riid, pInterface)                   \
  ((This)->lpVtbl->ConnectorLogin(This, wszNetworkResource,                    \
...
typedef struct IWbemClientConnectionTransportVtbl {
  ...
  HRESULT(STDMETHODCALLTYPE *Open)(IWbemClientConnectionTransport *This,
                                   /* [in] */ BSTR strAddressType,
                                   /* [in] */ DWORD dwBinaryAddressLength,
                                   /* [size_is][in] */ BYTE *abBinaryAddress,
                                   /* [in] */ const BSTR strObject,
