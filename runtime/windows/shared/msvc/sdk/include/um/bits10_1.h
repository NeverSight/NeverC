...
public:
  virtual HRESULT STDMETHODCALLTYPE FileRangesTransferred(
      ...
      /* [in] */ DWORD rangeCount,
      /* [size_is][in] */
      __RPC__in_ecount_full(rangeCount) const BG_FILE_RANGE ranges[]) = 0;
};
...
typedef struct IBackgroundCopyCallback3Vtbl {
  ...
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IBackgroundCopyCallback3 *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IBackgroundCopyCallback3 *This);
...
#define IBackgroundCopyCallback3_FileRangesTransferred(This, job, file,        \
                                                       rangeCount, ranges)     \
...
public:
  ...
  virtual HRESULT STDMETHODCALLTYPE RequestFileRanges(
      /* [in] */ DWORD rangeCount,
      /* [size_is][in] */ __RPC__in_ecount_full(rangeCount)
...
typedef struct IBackgroundCopyFile6Vtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IBackgroundCopyFile6 *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IBackgroundCopyFile6 *This);
  ...
  HRESULT(STDMETHODCALLTYPE *SetRemoteName)(
      __RPC__in IBackgroundCopyFile6 *This, __RPC__in LPCWSTR Val);
...
#define IBackgroundCopyFile6_GetPeerDownloadStats(This, pFromOrigin,           \
                                                  pFromPeers)                  \
