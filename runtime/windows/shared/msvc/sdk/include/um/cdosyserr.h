...
//
// IMPORTANT:
// if you add a new string do it at the end of the existing strings for the
// given section (cdosys, cdosvr or cdoex) see x5:191917 for more details
//
// Message categories
//
//
...
//
// 1: 0x200 through 0x7ff, 0x4000 through 0x4fff: Library error messages, not
// localized. 2: 0x2000 through 0x2fff: Server error messages, localized in
// server languages. 3: 0x1000 through 0x1fff: Client text, localized in client
// languages.
//
//////////////////////////////////////////////////////////////////////////////
...
// MessageText:
//
// The object is not active. It may have been deleted or it may not have been
// opened.
//
...
// MessageText:
//
// The requested property or feature, while supported, is not available at this
// time or in this context.
//
...
// MessageText:
//
// The NNTP server name is required, and was not found in the configuration
// source.
//
...
// was %2. The server response was %1
//
...
// MessageText:
//
// The Subject, From, and Newsgroup fields are all required, and one or more was
// not found.
//
...
//  MessageText:
//
//  The server rejected the logon attempt due to authentication failure. The
...
// MessageText:
//
// The content type was not valid in this context. For example, the root of an
// MHTML message must be an HTML document.
//
...
// MessageText:
//
// This is a multipart body part. It has no content other than the body parts
// contained within it.
//
...
// MessageText:
//
// The task with its current task type does not permit a call on Assign. Please
// call CreateUnassignedCopy instead.
//
...
// I expect there are numerous places where these errors could still slip
// through: MIME_E_NOT_FOUND
//
...
// Returned when MimeOLE tries to BinHex encode.  Can also be returned if an
// invalid encoding is specified, but CDO should protect from these cases.
//
...
// MessageText:
//
// Calendaring recurring item expansion failed to register for notifications for
// MDB %1. %n%nFor more information, click
...
// MessageText:
//
// Calendaring agent failed in message save notification with error %1 on %2:
// %3. %n%nFor more information, click
// http://www.microsoft.com/contentredirect.asp.
//
...
// MessageText:
//
// Calendaring agent failed in message delete notification with error %1 on %2:
// %3. %n%nFor more information, click
// http://www.microsoft.com/contentredirect.asp.
//
...
// MessageText:
//
// The mailbox creation callback failed to create one or more folders in mailbox
// %1. %n%nFor more information, click
// http://www.microsoft.com/contentredirect.asp.
//
...
// MessageText:
//
// Calendaring agent failed to uninitialize implied restriction with error %1 on
// %2: %3. %n%nFor more information, click
// http://www.microsoft.com/contentredirect.asp.
//
...
// MessageText:
//
// Calendaring agent failed with error code %1 while expanding recurring
// appointments. %n%nFor more information, click
// http://www.microsoft.com/contentredirect.asp.
//
...
// MessageText:
//
// Calendaring agent failed to update the free/busy cache during an appointment
// save or delete operation. %n%nFor more information, click
// http://www.microsoft.com/contentredirect.asp.
//
...
// MessageText:
//
// Calendaring agent failed to update the free/busy cache and internal data
// while processing a query. %n%nFor more information, click
// http://www.microsoft.com/contentredirect.asp.
//
...
// MessageText:
//
// The mailbox creation callback failed to rename one or more folders in mailbox
// %1. %n%nFor more information, click
// http://www.microsoft.com/contentredirect.asp.
//
...
// MessageText:
//
// The processing of the recurring appointment with the subject "%1" in mailbox:
// %2 failed with error code %3.  This appointment will not be visible in the
// web client or other non-MAPI client. %n%nFor more information, click
// http://www.microsoft.com/contentredirect.asp.
//
...
// MessageText:
//
// The calendaring agent could not publish the free/busy information for "%1"
// because it failed reading the registry with error: %2. The save/delete
// calendar operation for "%3" will not be completed. Please ensure that
// MSExchangeFBPublish agent is started. %n%nFor more information, click
// http://www.microsoft.com/contentredirect.asp.
//
...
// MessageText:
//
// Expiry of an instance for the recurring appointment with the subject "%1" in
// the folder "%2" was detected.  The master for that should be expired before
// this instance. This instance will no longer appear in the web clients until
// the master is updated manually or through replication. %n%nFor more
...
// MessageText:
//
// Unhandled exception %1 caught during initialization of server agents while an
// MDB is mounted. %n%nFor more information, click
// http://www.microsoft.com/contentredirect.asp.
//
...
// MessageText:
//
// Unhandled exception %1 caught trying to stop server agents while an MDB is
// unmounted. %n%nFor more information, click
// http://www.microsoft.com/contentredirect.asp.
//
...
// MessageText:
//
// The calendar for the mailbox %1 is corrupted.  This calendar needs to be
// recreated. %n%nFor more information, click
// http://www.microsoft.com/contentredirect.asp.
//
...
// MessageText:
//
// An inconsistency was detected in %2: %3.  The calendar is being repaired.  If
// other errors occur with this calendar, please view the calendar using
// Microsoft Outlook Web Access.  If a problem persists, please recreate the
// calendar or the containing mailbox. %n%nFor more information, click
// http://www.microsoft.com/contentredirect.asp.
//
...
// MessageText:
//
// The processing of the recurring appointment with the subject "%1" in public
// folder: %2 failed with error code %3.  This appointment will not be visible
// in the web client or other non-MAPI client. %n%nFor more information, click
// http://www.microsoft.com/contentredirect.asp.
//
...
// MessageText:
//
// An inconsistency was detected in %1.  The calendar is being repaired.  If
// other errors occur with this calendar, please view the calendar using
// Microsoft Outlook Web Access.  If a problem persists, please recreate the
// public folder calendar. %n%nFor more information, click
// http://www.microsoft.com/contentredirect.asp.
//
...
// MessageText:
//
// Clearing the calendar instances before a move failed for mailbox %1 with
// error %2. %n%nFor more information, click
// http://www.microsoft.com/contentredirect.asp.
//
...
// MessageText:
//
// Calendaring agent failed with error %1 while attempting to retrieve the
// message class for a recurring appointment.  The message class for the
// instance when viewed with the Web Client will not be the same as the one in
// the series if it is not IPM.Appointment. %n%nFor more information, click
// http://www.microsoft.com/contentredirect.asp.
//
...
// MessageText:
//
// Calendaring agent failed with error %1 while attempting to open the status
// message. If the user is a delegate, the access rights to the mailbox might
// not be set up correctly.  Otherwise, the calendar for this mailbox could be
// corrupted. This could be fixed by moving the mailbox to another Exchange
// server, or exporting the calendar to a Personal Folder File (.PST), and
// re-importing this into a new calendar. %n%nFor more information, click
// http://www.microsoft.com/contentredirect.asp.
//
...
// MessageText:
//
// An appointment with the subject "%1" was saved to mailbox %2. The start time
// is missing, so the calendaring agent cannot publish the free/busy information
// for this appointment. To correct this, please delete the appointment and
// recreate it. %n%nFor more information, click
// http://www.microsoft.com/contentredirect.asp.
//
...
// MessageText:
//
// An appointment with the subject "%1" was saved to mailbox %2. The end time
// and duration are missing. For the purposes of publishing free/busy
// information, this appointment has a duration of zero minutes. To correct
// this, please delete the appointment and recreate it. %n%nFor more
// information, click http://www.microsoft.com/contentredirect.asp.
//
...
// MessageText:
//
// An existing appointment with the subject "%1" in mailbox %2 was modified. The
// start time, or both the duration and end time of the existing appointment
// were missing. %n%nFor more information, click
// http://www.microsoft.com/contentredirect.asp.
//
...
// MessageText:
//
// The existing appointment with the subject "%1" in mailbox %2 was deleted. The
// start time, or both the duration and end time were missing. %n%nFor more
// information, click http://www.microsoft.com/contentredirect.asp.
//
...
// MessageText:
//
// The calendaring agent cannot bind to the appointment with the subject "%1" in
// mailbox %2 because the appointment is missing a start time. The calendaring
// agent will not publish free/busy information for this appointment. To correct
// this, please delete the appointment and recreate it. %n%nFor more
// information, click http://www.microsoft.com/contentredirect.asp.
//
...
// MessageText:
//
// The calendaring agent did bind to the appointment with the subject "%1" in
// mailbox %2, but the appointment is missing an end time and duration. For the
// purposes of publishing free/busy information, this appointment has a duration
// of zero minutes. To correct this, please delete the appointment and recreate
// it. %n%nFor more information, click
// http://www.microsoft.com/contentredirect.asp.
//
...
// MessageText:
//
// The EXCDO logging level has been reloaded from the registry and is now set to
// 0x%1. %n%nFor more information, click
// http://www.microsoft.com/contentredirect.asp.
//
...
// MessageText:
//
// Background calendaring agent is processing the calendar (%1) in the mailbox
// (%2) in the MDB (%3). %n%nFor more information, click
// http://www.microsoft.com/contentredirect.asp.
//
...
// MessageText:
//
// Background calendaring agent has finished processing the calendar (%1) in the
// mailbox (%2) in the MDB (%3).  The return code is %4. %n%nFor more
// information, click http://www.microsoft.com/contentredirect.asp.
//
...
// MessageText:
//
// The background calendaring agent failed with error code %1 while registering
// task. The rendering of large calendars with the web client or Microsoft
// Internet Explorer will be slower. %n%nFor more information, click
// http://www.microsoft.com/contentredirect.asp.
//
...
// session object on the MDB:%1. The error code is %2. The rendering of large
// calendars with the web client or Microsoft Internet Explorer for the mailbox
// %3 with GUID:%4 will be slower. %n%nFor more information, click
// http://www.microsoft.com/contentredirect.asp.
//
...
// MessageText:
//
// The background calendaring agent failed to retrieve the token required for
// logon on the MDB:%1. The error code is %2. The rendering of large calendars
// with the web client or Microsoft Internet Explorer on this MDB will be
// slower. %n%nFor more information, click
// http://www.microsoft.com/contentredirect.asp.
//
...
// MessageText:
//
// Background calendaring agent is sleeping until shutdown or a calendar is
// queued. %n%nFor more information, click
// http://www.microsoft.com/contentredirect.asp.
//
...
// MessageText:
//
// The calendar (%1) in mailbox (%2) in the MDB (%3) has been queued for
// background expansion. %n%nFor more information, click
// http://www.microsoft.com/contentredirect.asp.
//
...
// MessageText:
//
// The background calendaring agent failed in the following function with error
// code %1. %n%nFor more information, click
// http://www.microsoft.com/contentredirect.asp.
//
...
// MessageText:
//
// An attempt was made to save an appointment with the subject "%1" to mailbox
// %2. The duration of the appointment was too large, so it was not saved.
// %n%nFor more information, click http://www.microsoft.com/contentredirect.asp.
//
...
//
// An existing appointment with the subject "%1" in mailbox %2 was modified. The
// duration of the existing appointment was too large. Free/busy publishing may
// not be accurate. %n%nFor more information, click
// http://www.microsoft.com/contentredirect.asp.
//
...
// MessageText:
//
// The recurring appointment expansion in mailbox %1 has taken too long. Some
// recurring appointment instances may not be visible at this time. To ensure
// that the calendar view is correct, please refresh the calendar view in
// Microsoft Outlook Web Access. %n%nFor more information, click
// http://www.microsoft.com/contentredirect.asp.
//
...
// MessageText:
//
// The recurring appointment expansion in mailbox %1 has taken too long. The
// free/busy information for this calendar may be inaccurate. This may be the
// result of many very old recurring appointments. To correct this, please
// remove them or change their start date to a more recent date. %n%nFor more
// information, click http://www.microsoft.com/contentredirect.asp.
//
