 ...
 */
#define DMUS_PC_DLS                                                            \
  (0x00000001) /* Supports DLS downloading and DLS level 1.                    \
                */
...
#define DMUS_PC_DIRECTSOUND                                                    \
  (0x00000080) /* Connects to DirectSound via a DSound buffer. */
...
#define DMUS_PC_SYSTEMMEMORY                                                   \
  (0x7FFFFFFF) /* Sample memory is system memory.                              \
                */
...
#define DMUS_PORT_FEATURE_AUDIOPATH                                            \
  0x00000001 /* Supports audiopath connection to DSound buffers. */
 ...
 * Synthsink talks to DSound Property Query GUID_DMUS_PROP_SynthSink_WAVE -
