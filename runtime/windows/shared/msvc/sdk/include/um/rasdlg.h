...
#if (WINVER >= 0x500)
typedef BOOL(WINAPI *RasCustomDialDlgFn)(HINSTANCE hInstDll, DWORD dwFlags,
                                         LPWSTR lpszPhonebook, LPWSTR lpszEntry,
                                         LPWSTR lpszPhoneNumber,
                                         LPRASDIALDLG lpInfo, PVOID pvInfo);

typedef BOOL(WINAPI *RasCustomEntryDlgFn)(HINSTANCE hInstDll,
 ...
 */
BOOL APIENTRY RasPhonebookDlgA(_In_opt_ LPSTR lpszPhonebook,
                               _In_opt_ LPSTR lpszEntry, LPRASPBDLGA lpInfo);

BOOL APIENTRY RasPhonebookDlgW(_In_opt_ LPWSTR lpszPhonebook,
                               _In_opt_ LPWSTR lpszEntry, LPRASPBDLGW lpInfo);

BOOL APIENTRY RasEntryDlgA(_In_opt_ LPSTR lpszPhonebook,
                           _In_opt_ LPSTR lpszEntry, LPRASENTRYDLGA lpInfo);

BOOL APIENTRY RasEntryDlgW(_In_opt_ LPWSTR lpszPhonebook,
                           _In_opt_ LPWSTR lpszEntry, LPRASENTRYDLGW lpInfo);

BOOL APIENTRY RasDialDlgA(_In_opt_ LPSTR lpszPhonebook,
                          _In_opt_ LPSTR lpszEntry,
                          _In_opt_ LPSTR lpszPhoneNumber,
                          _Inout_ LPRASDIALDLG lpInfo);

BOOL APIENTRY RasDialDlgW(_In_opt_ LPWSTR lpszPhonebook,
                          _In_opt_ LPWSTR lpszEntry,
                          _In_opt_ LPWSTR lpszPhoneNumber,
                          _Inout_ LPRASDIALDLG lpInfo);
