...
BOOL WINAPI MagSetWindowFilterList(HWND hwnd, DWORD dwFilterMode, int count,
                                   HWND *pHWND);
int WINAPI MagGetWindowFilterList(HWND hwnd, DWORD *pdwFilterMode, int count,
                                  HWND *pHWND);
BOOL WINAPI MagSetImageScalingCallback(HWND hwnd,
...
BOOL WINAPI MagSetFullscreenTransform(_In_ float magLevel, _In_ int xOffset,
                                      _In_ int yOffset);
BOOL WINAPI MagGetFullscreenTransform(_Out_ float *pMagLevel,
                                      _Out_ int *pxOffset, _Out_ int *pyOffset);
...
BOOL WINAPI MagSetInputTransform(_In_ BOOL fEnabled,
                                 _In_ const LPRECT pRectSource,
                                 _In_ const LPRECT pRectDest);
BOOL WINAPI MagGetInputTransform(_Out_ BOOL *pfEnabled,
                                 _Out_ LPRECT pRectSource,
