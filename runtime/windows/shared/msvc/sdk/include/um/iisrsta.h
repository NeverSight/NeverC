...
public:
  virtual /* [helpstring][id] */ HRESULT STDMETHODCALLTYPE Stop(
      DWORD dwTimeoutMsecs, DWORD dwForce) = 0;
...
typedef struct IIisServiceControlVtbl {
  ...
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in IIisServiceControl *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IIisServiceControl *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IIisServiceControl *This);
  ...
  /* [helpstring][id] */ HRESULT(STDMETHODCALLTYPE *Stop)(
      __RPC__in IIisServiceControl *This, DWORD dwTimeoutMsecs, DWORD dwForce);

  DECLSPEC_XFGVIRT(IIisServiceControl, Start)
  /* [helpstring][id] */ HRESULT(STDMETHODCALLTYPE *Start)(
      __RPC__in IIisServiceControl *This, DWORD dwTimeoutMsecs);

  DECLSPEC_XFGVIRT(IIisServiceControl, Reboot)
  /* [helpstring][id] */ HRESULT(STDMETHODCALLTYPE *Reboot)(
      __RPC__in IIisServiceControl *This, DWORD dwTimeouMsecs,
...
class DECLSPEC_UUID("E8FB8621-588F-11D2-9D61-00C04F79C5FE") IisServiceControl;
#endif
