...
const IID IID_IWTSPlugin = {0xA1230201,
                            0x1439,
                            0x4e62,
...
typedef struct IWTSPluginVtbl {
  ...
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in IWTSPlugin *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IWTSPlugin *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IWTSPlugin *This);
  ...
  /* [helpstring] */ HRESULT(STDMETHODCALLTYPE *Disconnected)(
      __RPC__in IWTSPlugin *This, DWORD dwDisconnectCode);
...
interface IWTSPlugin { CONST_VTBL struct IWTSPluginVtbl *lpVtbl; };
...
EXTERN_C __declspec(selectany)
const IID IID_IWTSListener = {0xA1230206,
                              0x9a39,
                              0x4d58,
                              {0x86, 0x74, 0xcd, 0xb4, 0xdf, 0xf4, 0xe7, 0x3b}};
...
typedef struct IWTSListenerVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in IWTSListener *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IWTSListener *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IWTSListener *This);
...
interface IWTSListener { CONST_VTBL struct IWTSListenerVtbl *lpVtbl; };
...
EXTERN_C __declspec(selectany) const IID IID_IWTSListenerCallback = {
    0xA1230203,
    0xd6a7,
    0x11d8,
    {0xb9, 0xfd, 0x00, 0x0b, 0xdb, 0xd1, 0xf1, 0x98}};
...
public:
  virtual /* [helpstring] */ HRESULT STDMETHODCALLTYPE OnNewChannelConnection(
      ...
      /* [out] */ __RPC__deref_out_opt IWTSVirtualChannelCallback *
          *ppCallback) = 0;
};
...
typedef struct IWTSListenerCallbackVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IWTSListenerCallback *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IWTSListenerCallback *This);
...
EXTERN_C __declspec(selectany) const IID IID_IWTSVirtualChannelCallback = {
    0xA1230204,
    0xd6a7,
    0x11d8,
    {0xb9, 0xfd, 0x00, 0x0b, 0xdb, 0xd1, 0xf1, 0x98}};
...
typedef struct IWTSVirtualChannelCallbackVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IWTSVirtualChannelCallback *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IWTSVirtualChannelCallback *This);
...
EXTERN_C __declspec(selectany) const IID IID_IWTSVirtualChannelManager = {
    0xA1230205,
    0xd6a7,
    0x11d8,
    {0xb9, 0xfd, 0x00, 0x0b, 0xdb, 0xd1, 0xf1, 0x98}};
...
typedef struct IWTSVirtualChannelManagerVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IWTSVirtualChannelManager *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IWTSVirtualChannelManager *This);
...
EXTERN_C __declspec(selectany) const IID IID_IWTSVirtualChannel = {
    0xA1230207,
    0xd6a7,
    0x11d8,
    {0xb9, 0xfd, 0x00, 0x0b, 0xdb, 0xd1, 0xf1, 0x98}};
...
typedef struct IWTSVirtualChannelVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in IWTSVirtualChannel *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IWTSVirtualChannel *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IWTSVirtualChannel *This);
...
EXTERN_C __declspec(selectany) const IID IID_IWTSPluginServiceProvider = {
    0xd3e07363,
    0x87c,
    0x476c,
    {0x86, 0xa7, 0xdb, 0xb1, 0x5f, 0x46, 0xdd, 0xb4}};
...
typedef struct IWTSPluginServiceProviderVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IWTSPluginServiceProvider *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IWTSPluginServiceProvider *This);
...
EXTERN_C __declspec(selectany) const IID IID_IWTSBitmapRenderer = {
    0x5b7acc97,
    0xf3c9,
    0x46f7,
    {0x8c, 0x5b, 0xfa, 0x68, 0x5d, 0x34, 0x41, 0xb1}};
...
public:
  virtual /* [helpstring] */ HRESULT STDMETHODCALLTYPE Render(
      ...
      /* [size_is][in] */ __RPC__in_ecount_full(cbImageBuffer) BYTE *
          pImageBuffer) = 0;
...
typedef struct IWTSBitmapRendererVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in IWTSBitmapRenderer *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IWTSBitmapRenderer *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IWTSBitmapRenderer *This);
...
EXTERN_C __declspec(selectany) const IID IID_IWTSBitmapRendererCallback = {
    0xd782928e,
    0xfe4e,
    0x4e77,
    {0xae, 0x90, 0x9c, 0xd0, 0xb3, 0xe3, 0xb3, 0x53}};
...
typedef struct IWTSBitmapRendererCallbackVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IWTSBitmapRendererCallback *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IWTSBitmapRendererCallback *This);
...
EXTERN_C __declspec(selectany) const IID IID_IWTSBitmapRenderService = {
    0xea326091, 0x5fe, 0x40c1, {0xb4, 0x9c, 0x3d, 0x2e, 0xf4, 0x62, 0x6a, 0xe}};
...
public:
  virtual /* [helpstring] */ HRESULT STDMETHODCALLTYPE GetMappedRenderer(
      /* [in] */ UINT64 mappingId,
      /* [in] */ __RPC__in_opt IWTSBitmapRendererCallback *
          pMappedRendererCallback,
      /* [out] */ __RPC__deref_out_opt IWTSBitmapRenderer *
          *ppMappedRenderer) = 0;
};
...
typedef struct IWTSBitmapRenderServiceVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IWTSBitmapRenderService *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IWTSBitmapRenderService *This);
