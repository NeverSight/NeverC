...
typedef struct ITfLangBarMgrVtbl {
  ...
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in ITfLangBarMgr *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in ITfLangBarMgr *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in ITfLangBarMgr *This);
  ...
  HRESULT(STDMETHODCALLTYPE *UnadviseEventSink)(__RPC__in ITfLangBarMgr *This,
                                                /* [in] */ DWORD dwCookie);
  ...
  HRESULT(STDMETHODCALLTYPE *ShowFloating)(__RPC__in ITfLangBarMgr *This,
                                           /* [in] */ DWORD dwFlags);
...
interface ITfLangBarMgr { CONST_VTBL struct ITfLangBarMgrVtbl *lpVtbl; };
...
#define ITfLangBarMgr_GetThreadLangBarItemMgr(This, dwThreadId, pplbi,         \
                                              pdwThreadid)                     \
  ((This)->lpVtbl->GetThreadLangBarItemMgr(This, dwThreadId, pplbi,            \
                                           pdwThreadid))
...
typedef struct ITfLangBarEventSinkVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in ITfLangBarEventSink *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in ITfLangBarEventSink *This);

  DECLSPEC_XFGVIRT(ITfLangBarEventSink, OnSetFocus)
  HRESULT(STDMETHODCALLTYPE *OnSetFocus)(__RPC__in ITfLangBarEventSink *This,
                                         /* [in] */ DWORD dwThreadId);
  ...
  HRESULT(STDMETHODCALLTYPE *OnModalInput)(__RPC__in ITfLangBarEventSink *This,
                                           /* [in] */ DWORD dwThreadId,
                                           /* [in] */ UINT uMsg,
                                           /* [in] */ WPARAM wParam,
                                           /* [in] */ LPARAM lParam);
  ...
  HRESULT(STDMETHODCALLTYPE *ShowFloating)(__RPC__in ITfLangBarEventSink *This,
                                           /* [in] */ DWORD dwFlags);
...
typedef struct ITfLangBarItemSinkVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in ITfLangBarItemSink *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in ITfLangBarItemSink *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in ITfLangBarItemSink *This);

  DECLSPEC_XFGVIRT(ITfLangBarItemSink, OnUpdate)
  HRESULT(STDMETHODCALLTYPE *OnUpdate)(__RPC__in ITfLangBarItemSink *This,
                                       /* [in] */ DWORD dwFlags);
...
public:
  ...
  virtual HRESULT STDMETHODCALLTYPE Next(
      /* [in] */ ULONG ulCount,
      /* [size_is][out] */ __RPC__out_ecount_full(ulCount) ITfLangBarItem *
          *ppItem,
...
typedef struct IEnumTfLangBarItemsVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IEnumTfLangBarItems *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IEnumTfLangBarItems *This);
  ...
  HRESULT(STDMETHODCALLTYPE *Reset)(__RPC__in IEnumTfLangBarItems *This);

  DECLSPEC_XFGVIRT(IEnumTfLangBarItems, Skip)
  HRESULT(STDMETHODCALLTYPE *Skip)(__RPC__in IEnumTfLangBarItems *This,
                                   /* [in] */ ULONG ulCount);
...
typedef /* [uuid] */ DECLSPEC_UUID(
    "12a1d29f-a065-440c-9746-eb2002c8bd19") struct TF_LANGBARITEMINFO {
  CLSID clsidService;
  GUID guidItem;
  DWORD dwStyle;
  ULONG ulSort;
...
public:
  ...
  virtual HRESULT STDMETHODCALLTYPE GetItemsStatus(
      ...
      /* [size_is][out] */
      __RPC__out_ecount_full(ulCount) DWORD *pdwStatus) = 0;
  ...
  virtual HRESULT STDMETHODCALLTYPE AdviseItemsSink(
      /* [in] */ ULONG ulCount,
      /* [size_is][in] */ __RPC__in_ecount_full(ulCount) ITfLangBarItemSink *
          *ppunk,
      /* [size_is][in] */ __RPC__in_ecount_full(ulCount) const GUID *pguidItem,
      /* [size_is][out] */
      __RPC__out_ecount_full(ulCount) DWORD *pdwCookie) = 0;
...
typedef struct ITfLangBarItemMgrVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in ITfLangBarItemMgr *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in ITfLangBarItemMgr *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in ITfLangBarItemMgr *This);
...
typedef struct ITfLangBarItemVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in ITfLangBarItem *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in ITfLangBarItem *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in ITfLangBarItem *This);
  ...
  HRESULT(STDMETHODCALLTYPE *Show)(__RPC__in ITfLangBarItem *This,
                                   /* [in] */ BOOL fShow);
...
interface ITfLangBarItem { CONST_VTBL struct ITfLangBarItemVtbl *lpVtbl; };
...
typedef struct ITfSystemLangBarItemSinkVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in ITfSystemLangBarItemSink *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in ITfSystemLangBarItemSink *This);

  DECLSPEC_XFGVIRT(ITfSystemLangBarItemSink, InitMenu)
  HRESULT(STDMETHODCALLTYPE *InitMenu)(__RPC__in ITfSystemLangBarItemSink *This,
...
typedef struct ITfSystemLangBarItemVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in ITfSystemLangBarItem *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in ITfSystemLangBarItem *This);

  DECLSPEC_XFGVIRT(ITfSystemLangBarItem, SetIcon)
  HRESULT(STDMETHODCALLTYPE *SetIcon)(__RPC__in ITfSystemLangBarItem *This,
...
typedef struct ITfSystemLangBarItemTextVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in ITfSystemLangBarItemText *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in ITfSystemLangBarItemText *This);
...
typedef /* [public][public][public][public][public][uuid] */ DECLSPEC_UUID(
    "8fb5f0ce-dfdd-4f0a-85b9-"
    "8988d8dd8ff2") enum __MIDL___MIDL_itf_ctfutb_0000_0010_0001 {
  TF_LBI_CLK_RIGHT = 1,
  TF_LBI_CLK_LEFT = 2
} TfLBIClick;
...
typedef struct ITfLangBarItemButtonVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in ITfLangBarItemButton *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in ITfLangBarItemButton *This);
  ...
  DECLSPEC_XFGVIRT(ITfLangBarItem, Show)
  HRESULT(STDMETHODCALLTYPE *Show)(__RPC__in ITfLangBarItemButton *This,
                                   /* [in] */ BOOL fShow);
  ...
  HRESULT(STDMETHODCALLTYPE *OnClick)(__RPC__in ITfLangBarItemButton *This,
                                      /* [in] */ TfLBIClick click,
                                      /* [in] */ POINT pt,
                                      /* [in] */ __RPC__in const RECT *prcArea);

  DECLSPEC_XFGVIRT(ITfLangBarItemButton, InitMenu)
  HRESULT(STDMETHODCALLTYPE *InitMenu)(__RPC__in ITfLangBarItemButton *This,
                                       /* [in] */ __RPC__in_opt ITfMenu *pMenu);

  DECLSPEC_XFGVIRT(ITfLangBarItemButton, OnMenuSelect)
  HRESULT(STDMETHODCALLTYPE *OnMenuSelect)(__RPC__in ITfLangBarItemButton *This,
                                           /* [in] */ UINT wID);
...
typedef struct ITfLangBarItemBitmapButtonVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in ITfLangBarItemBitmapButton *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in ITfLangBarItemBitmapButton *This);
  ...
  DECLSPEC_XFGVIRT(ITfLangBarItem, Show)
  HRESULT(STDMETHODCALLTYPE *Show)(__RPC__in ITfLangBarItemBitmapButton *This,
                                   /* [in] */ BOOL fShow);
...
#define ITfLangBarItemBitmapButton_DrawBitmap(This, bmWidth, bmHeight,         \
                                              dwFlags, phbmp, phbmpMask)       \
  ((This)->lpVtbl->DrawBitmap(This, bmWidth, bmHeight, dwFlags, phbmp,         \
                              phbmpMask))
...
typedef struct ITfLangBarItemBitmapVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in ITfLangBarItemBitmap *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in ITfLangBarItemBitmap *This);
  ...
  DECLSPEC_XFGVIRT(ITfLangBarItem, Show)
  HRESULT(STDMETHODCALLTYPE *Show)(__RPC__in ITfLangBarItemBitmap *This,
                                   /* [in] */ BOOL fShow);
  ...
  HRESULT(STDMETHODCALLTYPE *OnClick)(__RPC__in ITfLangBarItemBitmap *This,
                                      /* [in] */ TfLBIClick click,
                                      /* [in] */ POINT pt,
                                      /* [in] */ __RPC__in const RECT *prcArea);
...
#define ITfLangBarItemBitmap_DrawBitmap(This, bmWidth, bmHeight, dwFlags,      \
                                        phbmp, phbmpMask)                      \
  ((This)->lpVtbl->DrawBitmap(This, bmWidth, bmHeight, dwFlags, phbmp,         \
                              phbmpMask))
...
typedef /* [public][public][public][uuid] */ DECLSPEC_UUID(
    "f399a969-9e97-4ddd-b974-"
    "2bfb934cfbc9") enum __MIDL_ITfLangBarItemBalloon_0001 {
...
typedef /* [uuid] */ DECLSPEC_UUID(
    "37574483-5c50-4092-a55c-922e3a67e5b8") struct TF_LBBALLOONINFO {
...
typedef struct ITfLangBarItemBalloonVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in ITfLangBarItemBalloon *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in ITfLangBarItemBalloon *This);
  ...
  DECLSPEC_XFGVIRT(ITfLangBarItem, Show)
  HRESULT(STDMETHODCALLTYPE *Show)(__RPC__in ITfLangBarItemBalloon *This,
                                   /* [in] */ BOOL fShow);
  ...
  HRESULT(STDMETHODCALLTYPE *OnClick)(__RPC__in ITfLangBarItemBalloon *This,
                                      /* [in] */ TfLBIClick click,
                                      /* [in] */ POINT pt,
                                      /* [in] */ __RPC__in const RECT *prcArea);
...
typedef struct ITfMenuVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in ITfMenu *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in ITfMenu *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in ITfMenu *This);
...
interface ITfMenu { CONST_VTBL struct ITfMenuVtbl *lpVtbl; };
...
#define ITfMenu_AddMenuItem(This, uId, dwFlags, hbmp, hbmpMask, pch, cch,      \
                            ppMenu)                                            \
  ((This)->lpVtbl->AddMenuItem(This, uId, dwFlags, hbmp, hbmpMask, pch, cch,   \
                               ppMenu))
