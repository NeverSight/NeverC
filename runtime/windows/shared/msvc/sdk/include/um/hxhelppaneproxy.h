...
typedef struct IHxHelpPaneVtbl {
  ...
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in IHxHelpPane *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IHxHelpPane *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IHxHelpPane *This);

  DECLSPEC_XFGVIRT(IHxHelpPane, DisplayTask)
  HRESULT(STDMETHODCALLTYPE *DisplayTask)(__RPC__in IHxHelpPane *This,
                                          /* [in] */ __RPC__in BSTR bstrUrl);

  DECLSPEC_XFGVIRT(IHxHelpPane, DisplayContents)
  HRESULT(STDMETHODCALLTYPE *DisplayContents)(__RPC__in IHxHelpPane *This,
                                              /* [annotation][in] */
                                              _In_opt_ BSTR bstrUrl);

  DECLSPEC_XFGVIRT(IHxHelpPane, DisplaySearchResults)
  HRESULT(STDMETHODCALLTYPE *DisplaySearchResults)(__RPC__in IHxHelpPane *This,
                                                   /* [in] */ __RPC__in BSTR
                                                       bstrSearchQuery);
...
interface IHxHelpPane { CONST_VTBL struct IHxHelpPaneVtbl *lpVtbl; };
...
typedef struct IHxInteractiveUserVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in IHxInteractiveUser *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IHxInteractiveUser *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IHxInteractiveUser *This);

  DECLSPEC_XFGVIRT(IHxInteractiveUser, Execute)
  HRESULT(STDMETHODCALLTYPE *Execute)(__RPC__in IHxInteractiveUser *This,
...
class DECLSPEC_UUID("8cec58e7-07a1-11d9-b15e-000d56bfe6ee") HxHelpPane;
#endif
