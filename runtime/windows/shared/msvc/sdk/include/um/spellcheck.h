...
typedef struct ISpellingErrorVtbl {
  ...
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in ISpellingError *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in ISpellingError *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in ISpellingError *This);
...
interface ISpellingError { CONST_VTBL struct ISpellingErrorVtbl *lpVtbl; };
...
typedef struct IEnumSpellingErrorVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in IEnumSpellingError *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IEnumSpellingError *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IEnumSpellingError *This);
...
#define IEnumSpellingError_Next(This, value) ((This)->lpVtbl->Next(This, value))
...
typedef struct IOptionDescriptionVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in IOptionDescription *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IOptionDescription *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IOptionDescription *This);
...
typedef struct ISpellCheckerVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in ISpellChecker *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in ISpellChecker *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in ISpellChecker *This);
  ...
  HRESULT(STDMETHODCALLTYPE *Add)(__RPC__in ISpellChecker *This,
                                  /* [in] */ __RPC__in LPCWSTR word);

  DECLSPEC_XFGVIRT(ISpellChecker, Ignore)
  HRESULT(STDMETHODCALLTYPE *Ignore)(__RPC__in ISpellChecker *This,
                                     /* [in] */ __RPC__in LPCWSTR word);

  DECLSPEC_XFGVIRT(ISpellChecker, AutoCorrect)
  HRESULT(STDMETHODCALLTYPE *AutoCorrect)(__RPC__in ISpellChecker *This,
                                          /* [in] */ __RPC__in LPCWSTR from,
...
interface ISpellChecker { CONST_VTBL struct ISpellCheckerVtbl *lpVtbl; };
...
#define ISpellChecker_get_Id(This, value) ((This)->lpVtbl->get_Id(This, value))
...
typedef struct ISpellChecker2Vtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in ISpellChecker2 *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in ISpellChecker2 *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in ISpellChecker2 *This);
  ...
  DECLSPEC_XFGVIRT(ISpellChecker, Add)
  HRESULT(STDMETHODCALLTYPE *Add)(__RPC__in ISpellChecker2 *This,
                                  /* [in] */ __RPC__in LPCWSTR word);

  DECLSPEC_XFGVIRT(ISpellChecker, Ignore)
  HRESULT(STDMETHODCALLTYPE *Ignore)(__RPC__in ISpellChecker2 *This,
                                     /* [in] */ __RPC__in LPCWSTR word);

  DECLSPEC_XFGVIRT(ISpellChecker, AutoCorrect)
  HRESULT(STDMETHODCALLTYPE *AutoCorrect)(__RPC__in ISpellChecker2 *This,
                                          /* [in] */ __RPC__in LPCWSTR from,
                                          /* [in] */ __RPC__in LPCWSTR to);
  ...
  HRESULT(STDMETHODCALLTYPE *Remove)(__RPC__in ISpellChecker2 *This,
                                     /* [in] */ __RPC__in LPCWSTR word);

  END_INTERFACE
} ISpellChecker2Vtbl;

interface ISpellChecker2 { CONST_VTBL struct ISpellChecker2Vtbl *lpVtbl; };
...
#define ISpellChecker2_get_Id(This, value) ((This)->lpVtbl->get_Id(This, value))
...
typedef struct ISpellCheckerFactoryVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in ISpellCheckerFactory *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in ISpellCheckerFactory *This);
...
typedef struct IUserDictionariesRegistrarVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IUserDictionariesRegistrar *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IUserDictionariesRegistrar *This);
