...
typedef struct IVssProviderNotificationsVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IVssProviderNotifications *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IVssProviderNotifications *This);
...
public:
  ...
  virtual /* [helpstring] */ HRESULT STDMETHODCALLTYPE BeginPrepareSnapshot(
      ...
      /* [size_is][out][in] */
      __RPC__inout_ecount_full(lLunCount) VDS_LUN_INFORMATION *
          rgLunInformation) = 0;
  ...
  virtual /* [helpstring] */ HRESULT STDMETHODCALLTYPE LocateLuns(
      /* [in] */ LONG lLunCount,
      /* [size_is][unique][in] */ __RPC__in_ecount_full_opt(lLunCount)
              VDS_LUN_INFORMATION *
          rgSourceLuns) = 0;
...
typedef struct IVssHardwareSnapshotProviderVtbl {
  ...
  /* [helpstring] */ HRESULT(STDMETHODCALLTYPE *BeginPrepareSnapshot)(
      ...
      __RPC__in_ecount_full_opt(lLunCount) VSS_PWSZ *rgDeviceNames,
      /* [size_is][out][in] */
      __RPC__inout_ecount_full(lLunCount)
...
public:
  ...
  virtual /* [helpstring] */ HRESULT STDMETHODCALLTYPE OnLunStateChange(
      /* [size_is][unique][in] */ __RPC__in_ecount_full_opt(dwCount)
              VDS_LUN_INFORMATION *
          pSnapshotLuns,
      /* [size_is][unique][in] */
