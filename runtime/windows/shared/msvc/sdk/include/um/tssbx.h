...
typedef /* [public][public][public][public][public][public][public][public] */
    struct __MIDL_IWTSSBPlugin_0004 {
...
public:
  ...
  WTSSBX_SessionChangeNotification(
      ...
      /* [size_is][in] */
      __RPC__in_ecount_full(NumOfSessions)
  ...
  virtual /* [helpstring] */ HRESULT STDMETHODCALLTYPE
      WTSSBX_GetUserExternalSession(
          ...
          /* [out] */ __RPC__out WTSSBX_MACHINE_CONNECT_INFO *
              pMachineConnectInfo) = 0;
};
...
typedef struct IWTSSBPluginVtbl {
  ...
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in IWTSSBPlugin *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IWTSSBPlugin *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IWTSSBPlugin *This);
  ...
  /* [helpstring] */ HRESULT(
      STDMETHODCALLTYPE *WTSSBX_MachineChangeNotification)(
      __RPC__in IWTSSBPlugin *This,
      /* [in] */ WTSSBX_NOTIFICATION_TYPE NotificationType,
      /* [in] */ long MachineId,
  ...
  /* [helpstring] */ HRESULT(
      STDMETHODCALLTYPE *WTSSBX_SessionChangeNotification)(
      __RPC__in IWTSSBPlugin *This,
      /* [in] */ WTSSBX_NOTIFICATION_TYPE NotificationType,
      /* [in] */ long MachineId,
      /* [in] */ DWORD NumOfSessions,
...
interface IWTSSBPlugin { CONST_VTBL struct IWTSSBPluginVtbl *lpVtbl; };
...
#define IWTSSBPlugin_WTSSBX_MachineChangeNotification(This, NotificationType,  \
                                                      MachineId, pMachineInfo) \
  ((This)->lpVtbl->WTSSBX_MachineChangeNotification(This, NotificationType,    \
                                                    MachineId, pMachineInfo))

#define IWTSSBPlugin_WTSSBX_SessionChangeNotification(                         \
    This, NotificationType, MachineId, NumOfSessions, SessionInfo)             \
  ((This)->lpVtbl->WTSSBX_SessionChangeNotification(                           \
      This, NotificationType, MachineId, NumOfSessions, SessionInfo))

#define IWTSSBPlugin_WTSSBX_GetMostSuitableServer(                             \
    This, UserName, DomainName, ApplicationType, FarmName, pMachineId)         \
  ((This)->lpVtbl->WTSSBX_GetMostSuitableServer(                               \
      This, UserName, DomainName, ApplicationType, FarmName, pMachineId))

#define IWTSSBPlugin_Terminated(This) ((This)->lpVtbl->Terminated(This))

#define IWTSSBPlugin_WTSSBX_GetUserExternalSession(                            \
    This, UserName, DomainName, ApplicationType, RedirectorInternalIP,         \
    pSessionId, pMachineConnectInfo)                                           \
  ((This)->lpVtbl->WTSSBX_GetUserExternalSession(                              \
      This, UserName, DomainName, ApplicationType, RedirectorInternalIP,       \
      pSessionId, pMachineConnectInfo))
