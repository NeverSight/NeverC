...
typedef interface ISearchPersistentItemsChangedSink
...
public:
  ...
  virtual HRESULT STDMETHODCALLTYPE GetDocFormat(
      /* [size_is][length_is][out] */ __RPC__out_ecount_part(dwSize, *pdwLength)
          WCHAR wszDocFormat[],
      /* [in] */ DWORD dwSize,
...
typedef struct IUrlAccessorVtbl {
  ...
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in IUrlAccessor *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IUrlAccessor *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IUrlAccessor *This);
  ...
  HRESULT(STDMETHODCALLTYPE *GetCLSID)(__RPC__in IUrlAccessor *This,
                                       /* [out] */ __RPC__out CLSID *pClsid);

  DECLSPEC_XFGVIRT(IUrlAccessor, GetHost)
  HRESULT(STDMETHODCALLTYPE *GetHost)(__RPC__in IUrlAccessor *This,
                                      /* [size_is][length_is][out] */
                                      __RPC__out_ecount_part(dwSize, *pdwLength)
                                          WCHAR wszHost[],
                                      /* [in] */ DWORD dwSize,
                                      /* [out] */ __RPC__out DWORD *pdwLength);

  DECLSPEC_XFGVIRT(IUrlAccessor, IsDirectory)
  HRESULT(STDMETHODCALLTYPE *IsDirectory)(__RPC__in IUrlAccessor *This);
...
interface IUrlAccessor { CONST_VTBL struct IUrlAccessorVtbl *lpVtbl; };
...
#define IUrlAccessor_GetRedirectedURL(This, wszRedirectedURL, dwSize,          \
                                      pdwLength)                               \
...
typedef struct IUrlAccessor2Vtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in IUrlAccessor2 *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IUrlAccessor2 *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IUrlAccessor2 *This);
  ...
  DECLSPEC_XFGVIRT(IUrlAccessor, GetCLSID)
  HRESULT(STDMETHODCALLTYPE *GetCLSID)(__RPC__in IUrlAccessor2 *This,
                                       /* [out] */ __RPC__out CLSID *pClsid);

  DECLSPEC_XFGVIRT(IUrlAccessor, GetHost)
  HRESULT(STDMETHODCALLTYPE *GetHost)(__RPC__in IUrlAccessor2 *This,
                                      /* [size_is][length_is][out] */
                                      __RPC__out_ecount_part(dwSize, *pdwLength)
                                          WCHAR wszHost[],
                                      /* [in] */ DWORD dwSize,
  ...
  DECLSPEC_XFGVIRT(IUrlAccessor, IsDirectory)
  HRESULT(STDMETHODCALLTYPE *IsDirectory)(__RPC__in IUrlAccessor2 *This);
  ...
  HRESULT(STDMETHODCALLTYPE *IsDocument)(__RPC__in IUrlAccessor2 *This);
...
interface IUrlAccessor2 { CONST_VTBL struct IUrlAccessor2Vtbl *lpVtbl; };
...
#define IUrlAccessor2_GetRedirectedURL(This, wszRedirectedURL, dwSize,         \
                                       pdwLength)                              \
  ((This)->lpVtbl->GetRedirectedURL(This, wszRedirectedURL, dwSize, pdwLength))
...
typedef struct IUrlAccessor3Vtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in IUrlAccessor3 *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IUrlAccessor3 *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IUrlAccessor3 *This);
  ...
  DECLSPEC_XFGVIRT(IUrlAccessor, GetCLSID)
  HRESULT(STDMETHODCALLTYPE *GetCLSID)(__RPC__in IUrlAccessor3 *This,
                                       /* [out] */ __RPC__out CLSID *pClsid);

  DECLSPEC_XFGVIRT(IUrlAccessor, GetHost)
  HRESULT(STDMETHODCALLTYPE *GetHost)(__RPC__in IUrlAccessor3 *This,
                                      /* [size_is][length_is][out] */
                                      __RPC__out_ecount_part(dwSize, *pdwLength)
                                          WCHAR wszHost[],
                                      /* [in] */ DWORD dwSize,
  ...
  DECLSPEC_XFGVIRT(IUrlAccessor, IsDirectory)
  HRESULT(STDMETHODCALLTYPE *IsDirectory)(__RPC__in IUrlAccessor3 *This);
  ...
  DECLSPEC_XFGVIRT(IUrlAccessor2, IsDocument)
  HRESULT(STDMETHODCALLTYPE *IsDocument)(__RPC__in IUrlAccessor3 *This);
...
interface IUrlAccessor3 { CONST_VTBL struct IUrlAccessor3Vtbl *lpVtbl; };
...
#define IUrlAccessor3_GetRedirectedURL(This, wszRedirectedURL, dwSize,         \
                                       pdwLength)                              \
  ((This)->lpVtbl->GetRedirectedURL(This, wszRedirectedURL, dwSize, pdwLength))
...
#define IUrlAccessor3_GetImpersonationSidBlobs(This, pcwszURL, pcSidCount,     \
                                               ppSidBlobs)                     \
  ((This)->lpVtbl->GetImpersonationSidBlobs(This, pcwszURL, pcSidCount,        \
                                            ppSidBlobs))
...
typedef struct IUrlAccessor4Vtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in IUrlAccessor4 *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IUrlAccessor4 *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IUrlAccessor4 *This);
  ...
  DECLSPEC_XFGVIRT(IUrlAccessor, GetCLSID)
  HRESULT(STDMETHODCALLTYPE *GetCLSID)(__RPC__in IUrlAccessor4 *This,
                                       /* [out] */ __RPC__out CLSID *pClsid);

  DECLSPEC_XFGVIRT(IUrlAccessor, GetHost)
  HRESULT(STDMETHODCALLTYPE *GetHost)(__RPC__in IUrlAccessor4 *This,
                                      /* [size_is][length_is][out] */
                                      __RPC__out_ecount_part(dwSize, *pdwLength)
                                          WCHAR wszHost[],
                                      /* [in] */ DWORD dwSize,
  ...
  DECLSPEC_XFGVIRT(IUrlAccessor, IsDirectory)
  HRESULT(STDMETHODCALLTYPE *IsDirectory)(__RPC__in IUrlAccessor4 *This);
  ...
  DECLSPEC_XFGVIRT(IUrlAccessor2, IsDocument)
  HRESULT(STDMETHODCALLTYPE *IsDocument)(__RPC__in IUrlAccessor4 *This);
...
interface IUrlAccessor4 { CONST_VTBL struct IUrlAccessor4Vtbl *lpVtbl; };
...
#define IUrlAccessor4_GetRedirectedURL(This, wszRedirectedURL, dwSize,         \
                                       pdwLength)                              \
  ((This)->lpVtbl->GetRedirectedURL(This, wszRedirectedURL, dwSize, pdwLength))
...
#define IUrlAccessor4_GetImpersonationSidBlobs(This, pcwszURL, pcSidCount,     \
                                               ppSidBlobs)                     \
  ((This)->lpVtbl->GetImpersonationSidBlobs(This, pcwszURL, pcSidCount,        \
                                            ppSidBlobs))
...
typedef struct IOpLockStatusVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(IOpLockStatus *This,
                                             /* [in] */ REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);
  ...
  HRESULT(STDMETHODCALLTYPE *IsOplockValid)(IOpLockStatus *This,
                                            /* [annotation][out] */
                                            _Out_ BOOL *pfIsOplockValid);

  DECLSPEC_XFGVIRT(IOpLockStatus, IsOplockBroken)
  HRESULT(STDMETHODCALLTYPE *IsOplockBroken)(IOpLockStatus *This,
                                             /* [annotation][out] */
                                             _Out_ BOOL *pfIsOplockBroken);

  DECLSPEC_XFGVIRT(IOpLockStatus, GetOplockEventHandle)
  HRESULT(STDMETHODCALLTYPE *GetOplockEventHandle)(IOpLockStatus *This,
                                                   /* [annotation][out] */
...
interface IOpLockStatus { CONST_VTBL struct IOpLockStatusVtbl *lpVtbl; };
...
typedef struct ISearchProtocolThreadContextVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(ISearchProtocolThreadContext *This,
                                             /* [in] */ REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);
...
#define ISearchProtocolThreadContext_ThreadIdle(                               \
    This, dwTimeElaspedSinceLastCallInMS)                                      \
...
typedef struct ISearchProtocolVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(ISearchProtocol *This,
                                             /* [in] */ REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);
  ...
  HRESULT(STDMETHODCALLTYPE *CloseAccessor)(ISearchProtocol *This,
...
interface ISearchProtocol { CONST_VTBL struct ISearchProtocolVtbl *lpVtbl; };
...
#define ISearchProtocol_Init(This, pTimeoutInfo, pProtocolHandlerSite,         \
                             pProxyInfo)                                       \
  ((This)->lpVtbl->Init(This, pTimeoutInfo, pProtocolHandlerSite, pProxyInfo))

#define ISearchProtocol_CreateAccessor(This, pcwszURL, pAuthenticationInfo,    \
                                       pIncrementalAccessInfo, pItemInfo,      \
                                       ppAccessor)                             \
  ((This)->lpVtbl->CreateAccessor(This, pcwszURL, pAuthenticationInfo,         \
                                  pIncrementalAccessInfo, pItemInfo,           \
                                  ppAccessor))
...
typedef struct ISearchProtocol2Vtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(ISearchProtocol2 *This,
                                             /* [in] */ REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);
  ...
  DECLSPEC_XFGVIRT(ISearchProtocol, CloseAccessor)
  HRESULT(STDMETHODCALLTYPE *CloseAccessor)(ISearchProtocol2 *This,
                                            /* [in] */ IUrlAccessor *pAccessor);
...
interface ISearchProtocol2 { CONST_VTBL struct ISearchProtocol2Vtbl *lpVtbl; };
...
#define ISearchProtocol2_Init(This, pTimeoutInfo, pProtocolHandlerSite,        \
                              pProxyInfo)                                      \
  ((This)->lpVtbl->Init(This, pTimeoutInfo, pProtocolHandlerSite, pProxyInfo))

#define ISearchProtocol2_CreateAccessor(This, pcwszURL, pAuthenticationInfo,   \
                                        pIncrementalAccessInfo, pItemInfo,     \
                                        ppAccessor)                            \
  ((This)->lpVtbl->CreateAccessor(This, pcwszURL, pAuthenticationInfo,         \
                                  pIncrementalAccessInfo, pItemInfo,           \
...
#define ISearchProtocol2_CreateAccessorEx(This, pcwszURL, pAuthenticationInfo, \
                                          pIncrementalAccessInfo, pItemInfo,   \
                                          pUserData, ppAccessor)               \
  ((This)->lpVtbl->CreateAccessorEx(This, pcwszURL, pAuthenticationInfo,       \
                                    pIncrementalAccessInfo, pItemInfo,         \
                                    pUserData, ppAccessor))
...
typedef struct IProtocolHandlerSiteVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(IProtocolHandlerSite *This,
                                             /* [in] */ REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);
  ...
  HRESULT(STDMETHODCALLTYPE *GetFilter)(IProtocolHandlerSite *This,
                                        /* [in] */ CLSID *pclsidObj,
                                        /* [in] */ LPCWSTR pcwszContentType,
                                        /* [in] */ LPCWSTR pcwszExtension,
...
#define IProtocolHandlerSite_GetFilter(This, pclsidObj, pcwszContentType,      \
                                       pcwszExtension, ppFilter)               \
  ((This)->lpVtbl->GetFilter(This, pclsidObj, pcwszContentType,                \
                             pcwszExtension, ppFilter))
...
public:
  ...
  virtual /* [propget] */ HRESULT STDMETHODCALLTYPE get_Schedule(
      /* [string][retval][out] */ __RPC__deref_out_opt_string LPWSTR *
      ppszTaskArg) = 0;
...
typedef struct ISearchRootVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in ISearchRoot *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in ISearchRoot *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in ISearchRoot *This);
...
interface ISearchRoot { CONST_VTBL struct ISearchRootVtbl *lpVtbl; };
...
typedef struct IEnumSearchRootsVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in IEnumSearchRoots *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IEnumSearchRoots *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IEnumSearchRoots *This);
  ...
  HRESULT(STDMETHODCALLTYPE *Skip)(__RPC__in IEnumSearchRoots *This,
                                   /* [in] */ ULONG celt);

  DECLSPEC_XFGVIRT(IEnumSearchRoots, Reset)
  HRESULT(STDMETHODCALLTYPE *Reset)(__RPC__in IEnumSearchRoots *This);
...
interface IEnumSearchRoots { CONST_VTBL struct IEnumSearchRootsVtbl *lpVtbl; };
...
typedef struct ISearchScopeRuleVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in ISearchScopeRule *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in ISearchScopeRule *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in ISearchScopeRule *This);
...
interface ISearchScopeRule { CONST_VTBL struct ISearchScopeRuleVtbl *lpVtbl; };
...
public:
  virtual HRESULT STDMETHODCALLTYPE Next(
      /* [in] */ ULONG celt,
      /* [size_is][out] */ __RPC__out_ecount_full(celt) ISearchScopeRule *
          *pprgelt,
      /* [unique][out][in] */ __RPC__inout_opt ULONG * pceltFetched) = 0;
  ...
  virtual HRESULT STDMETHODCALLTYPE Clone(
      /* [retval][out] */ __RPC__deref_out_opt IEnumSearchScopeRules *
      *ppenum) = 0;
};
...
typedef struct IEnumSearchScopeRulesVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IEnumSearchScopeRules *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IEnumSearchScopeRules *This);
  ...
  HRESULT(STDMETHODCALLTYPE *Skip)(__RPC__in IEnumSearchScopeRules *This,
                                   /* [in] */ ULONG celt);

  DECLSPEC_XFGVIRT(IEnumSearchScopeRules, Reset)
  HRESULT(STDMETHODCALLTYPE *Reset)(__RPC__in IEnumSearchScopeRules *This);
...
public:
  ...
  virtual HRESULT STDMETHODCALLTYPE EnumerateRoots(
      /* [retval][out] */ __RPC__deref_out_opt IEnumSearchRoots *
      *ppSearchRoots) = 0;
...
typedef struct ISearchCrawlScopeManagerVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in ISearchCrawlScopeManager *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in ISearchCrawlScopeManager *This);
  ...
  HRESULT(STDMETHODCALLTYPE *SaveAll)(__RPC__in ISearchCrawlScopeManager *This);
...
#define ISearchCrawlScopeManager_AddDefaultScopeRule(This, pszURL, fInclude,   \
                                                     fFollowFlags)             \
...
#define ISearchCrawlScopeManager_AddHierarchicalScope(                         \
    This, pszURL, fInclude, fDefault, fOverrideChildren)                       \
  ((This)->lpVtbl->AddHierarchicalScope(This, pszURL, fInclude, fDefault,      \
                                        fOverrideChildren))

#define ISearchCrawlScopeManager_AddUserScopeRule(                             \
    This, pszURL, fInclude, fOverrideChildren, fFollowFlags)                   \
  ((This)->lpVtbl->AddUserScopeRule(This, pszURL, fInclude, fOverrideChildren, \
                                    fFollowFlags))
...
#define ISearchCrawlScopeManager_HasParentScopeRule(This, pszURL,              \
                                                    pfHasParentRule)           \
  ((This)->lpVtbl->HasParentScopeRule(This, pszURL, pfHasParentRule))

#define ISearchCrawlScopeManager_HasChildScopeRule(This, pszURL,               \
                                                   pfHasChildRule)             \
  ((This)->lpVtbl->HasChildScopeRule(This, pszURL, pfHasChildRule))

#define ISearchCrawlScopeManager_IncludedInCrawlScope(This, pszURL,            \
                                                      pfIsIncluded)            \
  ((This)->lpVtbl->IncludedInCrawlScope(This, pszURL, pfIsIncluded))

#define ISearchCrawlScopeManager_IncludedInCrawlScopeEx(This, pszURL,          \
                                                        pfIsIncluded, pReason) \
...
#define ISearchCrawlScopeManager_GetParentScopeVersionId(This, pszURL,         \
                                                         plScopeId)            \
...
typedef struct ISearchCrawlScopeManager2Vtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in ISearchCrawlScopeManager2 *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in ISearchCrawlScopeManager2 *This);
...
#define ISearchCrawlScopeManager2_AddDefaultScopeRule(This, pszURL, fInclude,  \
                                                      fFollowFlags)            \
  ((This)->lpVtbl->AddDefaultScopeRule(This, pszURL, fInclude, fFollowFlags))
...
#define ISearchCrawlScopeManager2_AddHierarchicalScope(                        \
    This, pszURL, fInclude, fDefault, fOverrideChildren)                       \
  ((This)->lpVtbl->AddHierarchicalScope(This, pszURL, fInclude, fDefault,      \
                                        fOverrideChildren))

#define ISearchCrawlScopeManager2_AddUserScopeRule(                            \
    This, pszURL, fInclude, fOverrideChildren, fFollowFlags)                   \
  ((This)->lpVtbl->AddUserScopeRule(This, pszURL, fInclude, fOverrideChildren, \
                                    fFollowFlags))
...
#define ISearchCrawlScopeManager2_EnumerateScopeRules(This,                    \
                                                      ppSearchScopeRules)      \
  ((This)->lpVtbl->EnumerateScopeRules(This, ppSearchScopeRules))

#define ISearchCrawlScopeManager2_HasParentScopeRule(This, pszURL,             \
                                                     pfHasParentRule)          \
  ((This)->lpVtbl->HasParentScopeRule(This, pszURL, pfHasParentRule))

#define ISearchCrawlScopeManager2_HasChildScopeRule(This, pszURL,              \
                                                    pfHasChildRule)            \
  ((This)->lpVtbl->HasChildScopeRule(This, pszURL, pfHasChildRule))

#define ISearchCrawlScopeManager2_IncludedInCrawlScope(This, pszURL,           \
                                                       pfIsIncluded)           \
  ((This)->lpVtbl->IncludedInCrawlScope(This, pszURL, pfIsIncluded))

#define ISearchCrawlScopeManager2_IncludedInCrawlScopeEx(                      \
    This, pszURL, pfIsIncluded, pReason)                                       \
  ((This)->lpVtbl->IncludedInCrawlScopeEx(This, pszURL, pfIsIncluded, pReason))
...
#define ISearchCrawlScopeManager2_GetParentScopeVersionId(This, pszURL,        \
                                                          plScopeId)           \
  ((This)->lpVtbl->GetParentScopeVersionId(This, pszURL, plScopeId))
...
/* [call_as] */ HRESULT
STDMETHODCALLTYPE ISearchCrawlScopeManager2_RemoteGetVersion_Proxy(
    __RPC__in ISearchCrawlScopeManager2 *This,
...
public:
  ...
  virtual HRESULT STDMETHODCALLTYPE OnItemsChanged(
      ...
      /* [size_is][in] */
      __RPC__in_ecount_full(dwNumberOfChanges)
          SEARCH_ITEM_CHANGE rgDataChangeEntries[],
      /* [size_is][out] */
      __RPC__out_ecount_full(dwNumberOfChanges) DWORD rgdwDocIds[],
      /* [size_is][out] */
      __RPC__out_ecount_full(dwNumberOfChanges)
          HRESULT rghrCompletionCodes[]) = 0;
};
...
typedef struct ISearchItemsChangedSinkVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in ISearchItemsChangedSink *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in ISearchItemsChangedSink *This);
...
#define ISearchItemsChangedSink_OnItemsChanged(                                \
    This, dwNumberOfChanges, rgDataChangeEntries, rgdwDocIds,                  \
    rghrCompletionCodes)                                                       \
  ((This)->lpVtbl->OnItemsChanged(This, dwNumberOfChanges,                     \
                                  rgDataChangeEntries, rgdwDocIds,             \
                                  rghrCompletionCodes))
...
#define ISearchPersistentItemsChangedSink_QueryInterface(This, riid,           \
                                                         ppvObject)            \
  ((This)->lpVtbl->QueryInterface(This, riid, ppvObject))
...
#define ISearchPersistentItemsChangedSink_OnItemsChanged(                      \
    This, dwNumberOfChanges, DataChangeEntries, hrCompletionCodes)             \
  ((This)->lpVtbl->OnItemsChanged(This, dwNumberOfChanges, DataChangeEntries,  \
                                  hrCompletionCodes))
...
typedef struct ISearchViewChangedSinkVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in ISearchViewChangedSink *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in ISearchViewChangedSink *This);
...
public:
  virtual HRESULT STDMETHODCALLTYPE OnItemIndexedStatusChange(
      ...
      /* [size_is][in] */
      __RPC__in_ecount_full(dwNumEntries)
          SEARCH_ITEM_INDEXING_STATUS rgItemStatusEntries[]) = 0;
...
typedef struct ISearchNotifyInlineSiteVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in ISearchNotifyInlineSite *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in ISearchNotifyInlineSite *This);
...
#define ISearchNotifyInlineSite_OnItemIndexedStatusChange(                     \
    This, sipStatus, dwNumEntries, rgItemStatusEntries)                        \
  ((This)->lpVtbl->OnItemIndexedStatusChange(This, sipStatus, dwNumEntries,    \
                                             rgItemStatusEntries))

#define ISearchNotifyInlineSite_OnCatalogStatusChange(                         \
    This, guidCatalogResetSignature, guidCheckPointSignature,                  \
    dwLastCheckPointNumber)                                                    \
  ((This)->lpVtbl->OnCatalogStatusChange(This, guidCatalogResetSignature,      \
...
public:
  ...
  virtual HRESULT STDMETHODCALLTYPE GetPersistentItemsChangedSink(
      /* [retval][out] */
      __RPC__deref_out_opt ISearchPersistentItemsChangedSink *
      *ppISearchPersistentItemsChangedSink) = 0;
  ...
  virtual HRESULT STDMETHODCALLTYPE GetItemsChangedSink(
      /* [in] */ __RPC__in_opt ISearchNotifyInlineSite *
  ...
  virtual HRESULT STDMETHODCALLTYPE GetQueryHelper(
      /* [retval][out] */ __RPC__deref_out_opt ISearchQueryHelper *
      *ppSearchQueryHelper) = 0;
  ...
  virtual HRESULT STDMETHODCALLTYPE GetCrawlScopeManager(
      /* [retval][out] */ __RPC__deref_out_opt ISearchCrawlScopeManager *
      *ppCrawlScopeManager) = 0;
};
...
typedef struct ISearchCatalogManagerVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in ISearchCatalogManager *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in ISearchCatalogManager *This);
  ...
  HRESULT(STDMETHODCALLTYPE *Reset)(__RPC__in ISearchCatalogManager *This);

  DECLSPEC_XFGVIRT(ISearchCatalogManager, Reindex)
  HRESULT(STDMETHODCALLTYPE *Reindex)(__RPC__in ISearchCatalogManager *This);
  ...
  HRESULT(STDMETHODCALLTYPE *GetPersistentItemsChangedSink)(
      __RPC__in ISearchCatalogManager *This,
      /* [retval][out] */ __RPC__deref_out_opt ISearchPersistentItemsChangedSink
...
#define ISearchCatalogManager_NumberOfItemsToIndex(                            \
    This, plIncrementalCount, plNotificationQueue, plHighPriorityQueue)        \
  ((This)->lpVtbl->NumberOfItemsToIndex(                                       \
      This, plIncrementalCount, plNotificationQueue, plHighPriorityQueue))
...
#define ISearchCatalogManager_GetPersistentItemsChangedSink(                   \
    This, ppISearchPersistentItemsChangedSink)                                 \
  ((This)->lpVtbl->GetPersistentItemsChangedSink(                              \
      This, ppISearchPersistentItemsChangedSink))

#define ISearchCatalogManager_RegisterViewForNotification(                     \
    This, pszView, pViewChangedSink, pdwCookie)                                \
  ((This)->lpVtbl->RegisterViewForNotification(This, pszView,                  \
                                               pViewChangedSink, pdwCookie))

#define ISearchCatalogManager_GetItemsChangedSink(                             \
    This, pISearchNotifyInlineSite, riid, ppv, pGUIDCatalogResetSignature,     \
    pGUIDCheckPointSignature, pdwLastCheckPointNumber)                         \
  ((This)->lpVtbl->GetItemsChangedSink(                                        \
      This, pISearchNotifyInlineSite, riid, ppv, pGUIDCatalogResetSignature,   \
      pGUIDCheckPointSignature, pdwLastCheckPointNumber))
...
#define ISearchCatalogManager_SetExtensionClusion(This, pszExtension,          \
                                                  fExclude)                    \
...
#define ISearchCatalogManager_put_DiacriticSensitivity(This,                   \
                                                       fDiacriticSensitive)    \
  ((This)->lpVtbl->put_DiacriticSensitivity(This, fDiacriticSensitive))

#define ISearchCatalogManager_get_DiacriticSensitivity(This,                   \
...
typedef struct ISearchCatalogManager2Vtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in ISearchCatalogManager2 *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in ISearchCatalogManager2 *This);
  ...
  DECLSPEC_XFGVIRT(ISearchCatalogManager, Reset)
  HRESULT(STDMETHODCALLTYPE *Reset)(__RPC__in ISearchCatalogManager2 *This);

  DECLSPEC_XFGVIRT(ISearchCatalogManager, Reindex)
  HRESULT(STDMETHODCALLTYPE *Reindex)(__RPC__in ISearchCatalogManager2 *This);
...
#define ISearchCatalogManager2_NumberOfItemsToIndex(                           \
    This, plIncrementalCount, plNotificationQueue, plHighPriorityQueue)        \
  ((This)->lpVtbl->NumberOfItemsToIndex(                                       \
      This, plIncrementalCount, plNotificationQueue, plHighPriorityQueue))
...
#define ISearchCatalogManager2_GetPersistentItemsChangedSink(                  \
    This, ppISearchPersistentItemsChangedSink)                                 \
  ((This)->lpVtbl->GetPersistentItemsChangedSink(                              \
      This, ppISearchPersistentItemsChangedSink))

#define ISearchCatalogManager2_RegisterViewForNotification(                    \
    This, pszView, pViewChangedSink, pdwCookie)                                \
  ((This)->lpVtbl->RegisterViewForNotification(This, pszView,                  \
                                               pViewChangedSink, pdwCookie))
...
#define ISearchCatalogManager2_SetExtensionClusion(This, pszExtension,         \
                                                   fExclude)                   \
  ((This)->lpVtbl->SetExtensionClusion(This, pszExtension, fExclude))
...
#define ISearchCatalogManager2_put_DiacriticSensitivity(This,                  \
                                                        fDiacriticSensitive)   \
  ((This)->lpVtbl->put_DiacriticSensitivity(This, fDiacriticSensitive))

#define ISearchCatalogManager2_get_DiacriticSensitivity(This,                  \
                                                        pfDiacriticSensitive)  \
  ((This)->lpVtbl->get_DiacriticSensitivity(This, pfDiacriticSensitive))
...
#define ISearchCatalogManager2_PrioritizeMatchingURLs(This, pszPattern,        \
                                                      dwPrioritizeFlags)       \
...
typedef struct ISearchCatalogManager3Vtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in ISearchCatalogManager3 *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in ISearchCatalogManager3 *This);
  ...
  DECLSPEC_XFGVIRT(ISearchCatalogManager, Reset)
  HRESULT(STDMETHODCALLTYPE *Reset)(__RPC__in ISearchCatalogManager3 *This);

  DECLSPEC_XFGVIRT(ISearchCatalogManager, Reindex)
  HRESULT(STDMETHODCALLTYPE *Reindex)(__RPC__in ISearchCatalogManager3 *This);
...
#define ISearchCatalogManager3_AddRef(This) ((This)->lpVtbl->AddRef(This))

#define ISearchCatalogManager3_Release(This) ((This)->lpVtbl->Release(This))
...
#define ISearchCatalogManager3_Reset(This) ((This)->lpVtbl->Reset(This))

#define ISearchCatalogManager3_Reindex(This) ((This)->lpVtbl->Reindex(This))
...
#define ISearchCatalogManager3_NumberOfItemsToIndex(                           \
    This, plIncrementalCount, plNotificationQueue, plHighPriorityQueue)        \
  ((This)->lpVtbl->NumberOfItemsToIndex(                                       \
      This, plIncrementalCount, plNotificationQueue, plHighPriorityQueue))
...
#define ISearchCatalogManager3_GetPersistentItemsChangedSink(                  \
    This, ppISearchPersistentItemsChangedSink)                                 \
  ((This)->lpVtbl->GetPersistentItemsChangedSink(                              \
      This, ppISearchPersistentItemsChangedSink))

#define ISearchCatalogManager3_RegisterViewForNotification(                    \
    This, pszView, pViewChangedSink, pdwCookie)                                \
  ((This)->lpVtbl->RegisterViewForNotification(This, pszView,                  \
                                               pViewChangedSink, pdwCookie))

#define ISearchCatalogManager3_GetItemsChangedSink(                            \
    This, pISearchNotifyInlineSite, riid, ppv, pGUIDCatalogResetSignature,     \
    pGUIDCheckPointSignature, pdwLastCheckPointNumber)                         \
  ((This)->lpVtbl->GetItemsChangedSink(                                        \
      This, pISearchNotifyInlineSite, riid, ppv, pGUIDCatalogResetSignature,   \
...
#define ISearchCatalogManager3_SetExtensionClusion(This, pszExtension,         \
                                                   fExclude)                   \
  ((This)->lpVtbl->SetExtensionClusion(This, pszExtension, fExclude))
...
#define ISearchCatalogManager3_put_DiacriticSensitivity(This,                  \
                                                        fDiacriticSensitive)   \
  ((This)->lpVtbl->put_DiacriticSensitivity(This, fDiacriticSensitive))

#define ISearchCatalogManager3_get_DiacriticSensitivity(This,                  \
                                                        pfDiacriticSensitive)  \
  ((This)->lpVtbl->get_DiacriticSensitivity(This, pfDiacriticSensitive))
...
#define ISearchCatalogManager3_PrioritizeMatchingURLs(This, pszPattern,        \
                                                      dwPrioritizeFlags)       \
  ((This)->lpVtbl->PrioritizeMatchingURLs(This, pszPattern, dwPrioritizeFlags))

#define ISearchCatalogManager3_IsContainsSemanticSupported(                    \
    This, isContainsSemanticSupported)                                         \
  ((This)->lpVtbl->IsContainsSemanticSupported(This,                           \
...
public:
  ...
  virtual HRESULT STDMETHODCALLTYPE WriteProperties(
      ...
      /* [size_is][in] */ __RPC__in_ecount_full(dwNumberOfColumns) PROPERTYKEY *
          pColumns,
      /* [size_is][in] */
      __RPC__in_ecount_full(dwNumberOfColumns) SEARCH_COLUMN_PROPERTIES *
          pValues,
...
typedef struct ISearchQueryHelperVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in ISearchQueryHelper *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in ISearchQueryHelper *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in ISearchQueryHelper *This);
  ...
  HRESULT(STDMETHODCALLTYPE *WriteProperties)(
      ...
      /* [size_is][in] */
      __RPC__in_ecount_full(dwNumberOfColumns)
          SEARCH_COLUMN_PROPERTIES *pValues,
...
#define ISearchQueryHelper_put_QueryContentProperties(This,                    \
                                                      pszContentProperties)    \
  ((This)->lpVtbl->put_QueryContentProperties(This, pszContentProperties))

#define ISearchQueryHelper_get_QueryContentProperties(This,                    \
                                                      ppszContentProperties)   \
...
#define ISearchQueryHelper_WriteProperties(                                    \
    This, itemID, dwNumberOfColumns, pColumns, pValues, pftGatherModifiedTime) \
  ((This)->lpVtbl->WriteProperties(This, itemID, dwNumberOfColumns, pColumns,  \
                                   pValues, pftGatherModifiedTime))
...
typedef struct IRowsetPrioritizationVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IRowsetPrioritization *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IRowsetPrioritization *This);
...
#define IRowsetPrioritization_SetScopePriority(This, priority,                 \
                                               scopeStatisticsEventFrequency)  \
  ((This)->lpVtbl->SetScopePriority(This, priority,                            \
                                    scopeStatisticsEventFrequency))

#define IRowsetPrioritization_GetScopePriority(This, priority,                 \
                                               scopeStatisticsEventFrequency)  \
  ((This)->lpVtbl->GetScopePriority(This, priority,                            \
                                    scopeStatisticsEventFrequency))

#define IRowsetPrioritization_GetScopeStatistics(                              \
    This, indexedDocumentCount, oustandingAddCount, oustandingModifyCount)     \
  ((This)->lpVtbl->GetScopeStatistics(                                         \
      This, indexedDocumentCount, oustandingAddCount, oustandingModifyCount))
...
typedef struct IRowsetEventsVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in IRowsetEvents *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IRowsetEvents *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IRowsetEvents *This);
...
interface IRowsetEvents { CONST_VTBL struct IRowsetEventsVtbl *lpVtbl; };
...
#define IRowsetEvents_OnChangedItem(This, itemID, rowsetItemState,             \
                                    changedItemState)                          \
  ((This)->lpVtbl->OnChangedItem(This, itemID, rowsetItemState,                \
                                 changedItemState))
...
public:
  ...
  virtual HRESULT STDMETHODCALLTYPE GetCatalog(
      ...
      /* [retval][out] */ __RPC__deref_out_opt ISearchCatalogManager *
          *ppCatalogManager) = 0;
...
typedef struct ISearchManagerVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in ISearchManager *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in ISearchManager *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in ISearchManager *This);
...
interface ISearchManager { CONST_VTBL struct ISearchManagerVtbl *lpVtbl; };
...
#define ISearchManager_SetProxy(This, sUseProxy, fLocalByPassProxy,            \
                                dwPortNumber, pszProxyName, pszByPassList)     \
  ((This)->lpVtbl->SetProxy(This, sUseProxy, fLocalByPassProxy, dwPortNumber,  \
                            pszProxyName, pszByPassList))
...
public:
  virtual HRESULT STDMETHODCALLTYPE CreateCatalog(
      /* [string][in] */ __RPC__in_string LPCWSTR pszCatalog,
      /* [out] */ __RPC__deref_out_opt ISearchCatalogManager *
          *ppCatalogManager) = 0;
...
typedef struct ISearchManager2Vtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in ISearchManager2 *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in ISearchManager2 *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in ISearchManager2 *This);
...
interface ISearchManager2 { CONST_VTBL struct ISearchManager2Vtbl *lpVtbl; };
...
#define ISearchManager2_AddRef(This) ((This)->lpVtbl->AddRef(This))

#define ISearchManager2_Release(This) ((This)->lpVtbl->Release(This))
...
#define ISearchManager2_SetProxy(This, sUseProxy, fLocalByPassProxy,           \
                                 dwPortNumber, pszProxyName, pszByPassList)    \
  ((This)->lpVtbl->SetProxy(This, sUseProxy, fLocalByPassProxy, dwPortNumber,  \
                            pszProxyName, pszByPassList))
...
public:
  ...
  virtual HRESULT STDMETHODCALLTYPE IsPrefixNormalized(
      /* [size_is][in] */ __RPC__in_ecount_full(cwcQueryToken)
...
typedef struct ISearchLanguageSupportVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in ISearchLanguageSupport *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in ISearchLanguageSupport *This);
...
#define ISearchLanguageSupport_SetDiacriticSensitivity(This,                   \
                                                       fDiacriticSensitive)    \
  ((This)->lpVtbl->SetDiacriticSensitivity(This, fDiacriticSensitive))

#define ISearchLanguageSupport_GetDiacriticSensitivity(This,                   \
                                                       pfDiacriticSensitive)   \
  ((This)->lpVtbl->GetDiacriticSensitivity(This, pfDiacriticSensitive))

#define ISearchLanguageSupport_LoadWordBreaker(This, lcid, riid,               \
                                               ppWordBreaker, pLcidUsed)       \
  ((This)->lpVtbl->LoadWordBreaker(This, lcid, riid, ppWordBreaker, pLcidUsed))

#define ISearchLanguageSupport_LoadStemmer(This, lcid, riid, ppStemmer,        \
                                           pLcidUsed)                          \
  ((This)->lpVtbl->LoadStemmer(This, lcid, riid, ppStemmer, pLcidUsed))

#define ISearchLanguageSupport_IsPrefixNormalized(                             \
    This, pwcsQueryToken, cwcQueryToken, pwcsDocumentToken, cwcDocumentToken,  \
    pulPrefixLength)                                                           \
  ((This)->lpVtbl->IsPrefixNormalized(This, pwcsQueryToken, cwcQueryToken,     \
                                      pwcsDocumentToken, cwcDocumentToken,     \
                                      pulPrefixLength))
...
class DECLSPEC_UUID("7D096C5F-AC08-4f1f-BEB7-5C22C517CE39") CSearchManager;
#endif
...
class DECLSPEC_UUID("30766BD2-EA1C-4F28-BF27-0B44E2F68DB7") CSearchRoot;
#endif
...
class DECLSPEC_UUID("E63DE750-3BD7-4BE5-9C84-6B4281988C44") CSearchScopeRule;
#endif
...
class DECLSPEC_UUID("9E175B8D-F52A-11D8-B9A5-505054503030") FilterRegistration;
#endif
...
ISearchCrawlScopeManager2_GetVersion_Proxy(ISearchCrawlScopeManager2 *This,
                                           /* [out] */ long **plVersion,
                                           /* [out] */ HANDLE *phFileMapping);

/* [call_as] */ HRESULT STDMETHODCALLTYPE
ISearchCrawlScopeManager2_GetVersion_Stub(
    __RPC__in ISearchCrawlScopeManager2 *This,
    /* [out] */ __RPC__out long *plVersion);
