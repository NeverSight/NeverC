...
typedef struct IUserDataPathsInteropVtbl {
  ...
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IUserDataPathsInterop *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IUserDataPathsInterop *This);
...
typedef struct ISystemDataPathsInteropVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in ISystemDataPathsInterop *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in ISystemDataPathsInterop *This);
