...
typedef struct ITfSpeechUIServerVtbl {
  ...
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in ITfSpeechUIServer *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in ITfSpeechUIServer *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in ITfSpeechUIServer *This);

  DECLSPEC_XFGVIRT(ITfSpeechUIServer, Initialize)
  HRESULT(STDMETHODCALLTYPE *Initialize)(__RPC__in ITfSpeechUIServer *This);

  DECLSPEC_XFGVIRT(ITfSpeechUIServer, ShowUI)
  HRESULT(STDMETHODCALLTYPE *ShowUI)(__RPC__in ITfSpeechUIServer *This,
                                     /* [in] */ BOOL fShow);
...
DEFINE_GUID(IID_ITfSpeechUIServer, 0x90e9a944, 0x9244, 0x489f, 0xa7, 0x8f, 0xde,
            0x67, 0xaf, 0xc0, 0x13, 0xa7);
