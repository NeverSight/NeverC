...
#pragma once
    ...
    ((defined(_M_IX86) || defined(_M_AMD64) || defined(_M_ARM64)) &&           \
     defined(USE_SOFT_INTRINSICS))
...
__forceinline uint64_t __U64(const __m64 V) {
  uint64_t *T = (uint64_t *)&V;
  return *T;
}

__forceinline __m64 __MI64(const uint64_t U) {
  __m64 *T = (__m64 *)&U;
  return *T;
}

__forceinline uint128_t __S128(const __m128 V) {
  uint128_t T;
  T.Q[0] = V.m128_u64[0];
  T.Q[1] = V.m128_u64[1];
  return T;
...
__forceinline uint128_t __U128(const __m128i V) {
  uint128_t T;
  T.Q[0] = V.m128i_u64[0];
  T.Q[1] = V.m128i_u64[1];
  return T;
...
__forceinline uint128_t __D128(const __m128d V) {
  uint128_t T;
...
__forceinline uint32_t __S128D0(const __m128 V) {
  uint128_t *T = (uint128_t *)&V;
  return T->D[0];
}
__forceinline uint32_t __S128D1(const __m128 V) {
  uint128_t *T = (uint128_t *)&V;
  return T->D[1];
}
__forceinline uint32_t __S128D2(const __m128 V) {
  uint128_t *T = (uint128_t *)&V;
  return T->D[2];
}
__forceinline uint32_t __S128D3(const __m128 V) {
  uint128_t *T = (uint128_t *)&V;
  return T->D[3];
}

__forceinline uint32_t __U128W0(const __m128i V) {
  uint128_t *T = (uint128_t *)&V;
  return T->W[0];
}
__forceinline uint32_t __U128D0(const __m128i V) {
  uint128_t *T = (uint128_t *)&V;
  return T->D[0];
}
__forceinline uint64_t __U128Q0(const __m128i V) {
  uint128_t *T = (uint128_t *)&V;
  return T->Q[0];
}
__forceinline uint64_t __U128Q1(const __m128i V) {
  uint128_t *T = (uint128_t *)&V;
  return T->Q[1];
}

__forceinline uint64_t __D128Q0(const __m128d V) {
  uint128_t *T = (uint128_t *)&V;
  return T->Q[0];
}
__forceinline uint64_t __D128Q1(const __m128d V) {
  uint128_t *T = (uint128_t *)&V;
  return T->Q[1];
}
__forceinline uint64_t __S128Q0(const __m128 V) {
  uint128_t *T = (uint128_t *)&V;
  return T->Q[0];
}
__forceinline uint64_t __S128Q1(const __m128 V) {
  uint128_t *T = (uint128_t *)&V;
  return T->Q[1];
}

__forceinline double __D128F0(const __m128d V) {
  uint128_t *T = (uint128_t *)&V;
  return *(double *)&T->Q[0];
}
__forceinline float __S128F0(const __m128 V) {
  uint128_t *T = (uint128_t *)&V;
  return *(float *)&T->D[0];
}

__forceinline uint128_t __IMM8_128(const uint64_t C) {
  uint128_t T;
  T.Q[0] = C & 0xff;
  T.Q[1] = 0;
  return T;
...
__forceinline __m128 __MM128(const uint128_t U) {
  __m128 T;
  T.m128_u64[0] = U.Q[0];
  T.m128_u64[1] = U.Q[1];
  return T;
...
__forceinline __m128i __MI128(const uint128_t U) {
  __m128i T;
  T.m128i_u64[0] = U.Q[0];
  T.m128i_u64[1] = U.Q[1];
  return T;
...
__forceinline __m128d __MD128(const uint128_t U) {
  __m128d T;
...
__forceinline uint128_t __MAKEU8_U128(
...
__forceinline uint128_t __MAKEU16_U128(const uint16_t A, const uint16_t B,
...
__forceinline uint128_t __MAKEU32_U128(const uint32_t A, const uint32_t B,
                                       const uint32_t C, const uint32_t D) {
  uint128_t T;
  T.Q[0] = A | ((uint64_t)B << 32);
  T.Q[1] = C | ((uint64_t)D << 32);
  return T;
}
...
__forceinline uint128_t __MAKEF32_U128(const float A, const float B,
...
__forceinline uint128_t __INSERT8_U128(const uint128_t A, const uint8_t B,
                                       const int C) {
  uint128_t T = A;
  T.B[C & 0b1111] = B;
  return T;
}
__forceinline uint128_t __INSERT16_U128(const uint128_t A, const uint16_t B,
                                        const int C) {
  uint128_t T = A;
  T.W[C & 0b111] = B;
  return T;
}
__forceinline uint128_t __INSERT32_U128(const uint128_t A, const uint32_t B,
                                        const int C) {
  uint128_t T = A;
  T.D[C & 0b011] = B;
  return T;
}
__forceinline uint128_t __INSERT64_U128(const uint128_t A, const uint64_t B,
                                        const int C) {
  uint128_t T = A;
  T.Q[C & 0b001] = B;
  return T;
...
__forceinline void __MASKMOVEU128(const uint128_t A, const uint128_t M,
                                  char *Mem) {
...
__forceinline int HasOneBit(const unsigned x) {
  return (x && !(x & (x - 1))) ? 1 : 0;
}
...
#define _mm_aeskeygenassist_si128(b, i)                                        \
  __MI128(AESKEYGENASSIST128(__U128(b), (i)))
...
#define _mm_blendv_epi8(a, b, c)                                               \
  __MI128(PBLENDVB128(__U128(a), __U128(b), __U128(c)))
#define _mm_blendv_pd(a, b, c)                                                 \
  __MD128(BLENDVPD128(__D128(a), __D128(b), __D128(c)))
#define _mm_blendv_ps(a, b, c)                                                 \
  __MM128(BLENDVPS128(__S128(a), __S128(b), __S128(c)))
...
#define _mm_cmp_sd(a, b, i)                                                    \
  __MD128(__MAKEU64_U128(CMPSD64(__D128Q0(a), __D128Q0(b), (i)), __D128Q1(a)))
#define _mm_cmp_ss(a, b, i)                                                    \
  __MM128(__MAKEU32_U128(CMPSS64(__S128D0(a), __S128D0(b), (i)), __S128D1(a),  \
                         __S128D2(a), __S128D3(a)))
#define _mm_cmpr_sd(a, b, i)                                                   \
  __MD128(__MAKEU64_U128(CMPSD64(__D128Q0(a), __D128Q0(b), (i)), __D128Q1(b)))
#define _mm_cmpr_ss(a, b, i)                                                   \
  __MM128(__MAKEU32_U128(CMPSS64(__S128D0(a), __S128D0(b), (i)), __S128D1(b),  \
                         __S128D2(b), __S128D3(b)))
...
#define _mm_cmpestra(a, m, b, n, i)                                            \
  (0 == (0x041 & PCMPESTRF128(__U128(a), (m), __U128(b), (n), (i))))
#define _mm_cmpestrc(a, m, b, n, i)                                            \
  (0 != (0x001 & PCMPESTRF128(__U128(a), (m), __U128(b), (n), (i))))
#define _mm_cmpestro(a, m, b, n, i)                                            \
  (0 != (0x800 & PCMPESTRF128(__U128(a), (m), __U128(b), (n), (i))))
#define _mm_cmpestrs(a, m, b, n, i)                                            \
  (0 != (0x080 & PCMPESTRF128(__U128(a), (m), __U128(b), (n), (i))))
#define _mm_cmpestrz(a, m, b, n, i)                                            \
  (0 != (0x040 & PCMPESTRF128(__U128(a), (m), __U128(b), (n), (i))))
#define _mm_cmpistra(a, b, i)                                                  \
  (0 == (0x041 & PCMPISTRF128(__U128(a), __U128(b), (i))))
#define _mm_cmpistrc(a, b, i)                                                  \
  (0 != (0x001 & PCMPISTRF128(__U128(a), __U128(b), (i))))
#define _mm_cmpistro(a, b, i)                                                  \
  (0 != (0x800 & PCMPISTRF128(__U128(a), __U128(b), (i))))
#define _mm_cmpistrs(a, b, i)                                                  \
  (0 != (0x080 & PCMPISTRF128(__U128(a), __U128(b), (i))))
#define _mm_cmpistrz(a, b, i)                                                  \
  (0 != (0x040 & PCMPISTRF128(__U128(a), __U128(b), (i))))

#define _mm_cmpestri(a, m, b, n, i)                                            \
  (int)PCMPESTRI128(__U128(a), (m), __U128(b), (n), (i), NULL)
#define _mm_cmpistri(a, b, i) (int)PCMPISTRI128(__U128(a), __U128(b), (i), NULL)

#define _mm_cmpestrm(a, m, b, n, i)                                            \
  __MI128(PCMPESTRM128(__U128(a), (m), __U128(b), (n), (i), NULL))
#define _mm_cmpistrm(a, b, i)                                                  \
  __MI128(PCMPISTRM128(__U128(a), __U128(b), (i), NULL))
...
#define _mm_comieq_sd(a, b)                                                    \
  (0x040 == (0x051 & UCOMISD128(__D128(a), __D128(b))))
#define _mm_comieq_ss(a, b)                                                    \
  (0x040 == (0x051 & UCOMISS128(__S128(a), __S128(b))))
#define _mm_comige_sd(a, b)                                                    \
  (0x000 == (0x001 & UCOMISD128(__D128(a), __D128(b))))
#define _mm_comige_ss(a, b)                                                    \
  (0x000 == (0x001 & UCOMISS128(__S128(a), __S128(b))))
#define _mm_comigt_sd(a, b)                                                    \
  (0x000 == (0x041 & UCOMISD128(__D128(a), __D128(b))))
#define _mm_comigt_ss(a, b)                                                    \
  (0x000 == (0x041 & UCOMISS128(__S128(a), __S128(b))))
#define _mm_comile_sd(a, b)                                                    \
  (HasOneBit(0x041 & UCOMISD128(__D128(a), __D128(b))))
#define _mm_comile_ss(a, b)                                                    \
  (HasOneBit(0x041 & UCOMISS128(__S128(a), __S128(b))))
#define _mm_comilt_sd(a, b)                                                    \
  (0x001 == (0x051 & UCOMISD128(__D128(a), __D128(b))))
#define _mm_comilt_ss(a, b)                                                    \
  (0x001 == (0x051 & UCOMISS128(__S128(a), __S128(b))))
#define _mm_comineq_sd(a, b)                                                   \
  (0x040 != (0x051 & UCOMISD128(__D128(a), __D128(b))))
#define _mm_comineq_ss(a, b)                                                   \
  (0x040 != (0x051 & UCOMISS128(__S128(a), __S128(b))))

// CRC32

#define _mm_crc32_u8(a, b)                                                     \
  ((unsigned)_CRC64((uint32_t)a, (uint8_t)b, _CRC32_POLYNOMIAL, _BITS_PER_BYTE))
#define _mm_crc32_u16(a, b)                                                    \
  ((unsigned)_CRC64((uint32_t)a, (uint16_t)b, _CRC32_POLYNOMIAL,               \
                    _BITS_PER_WORD))
#define _mm_crc32_u32(a, b)                                                    \
  ((unsigned)_CRC64((uint32_t)a, (uint32_t)b, _CRC32_POLYNOMIAL,               \
                    _BITS_PER_LONG))
#define _mm_crc32_u64(a, b)                                                    \
  ((unsigned)_CRC64((uint32_t)a, (uint64_t)b, _CRC32_POLYNOMIAL,               \
                    _BITS_PER_QUAD))
...
#define _mm_cvtsd_si32(a)                                                      \
  (int)_CVTSD2SI32(__D128Q0(a), _MM_FROUND_TO_NEAREST_INT)
#define _mm_cvttsd_si32(a) (int)_CVTSD2SI32(__D128Q0(a), _MM_FROUND_TO_ZERO)
#define _mm_cvtss_si64x(a)                                                     \
  (int64_t)_CVTSD2SI64(CVTSS2SD64(__S128D0(a)), _MM_FROUND_TO_NEAREST_INT)
#define _mm_cvttss_si64x(a)                                                    \
  (int64_t)_CVTSD2SI64(CVTSS2SD64(__S128D0(a)), _MM_FROUND_TO_ZERO)
#define _mm_cvtsd_si64x(a)                                                     \
  (int64_t)_CVTSD2SI64(__D128Q0(a), _MM_FROUND_TO_NEAREST_INT)
#define _mm_cvttsd_si64x(a)                                                    \
  (int64_t)_CVTSD2SI64(__D128Q0(a), _MM_FROUND_TO_ZERO)

// CVT other...

#define _mm_cvtsd_ss(a, b)                                                     \
  __MM128(__MAKEU32_U128(CVTSD2SS64(__D128Q0(b)), __S128D1(a), __S128D2(a),    \
                         __S128D3(a)))
#define _mm_cvtss_sd(a, b)                                                     \
  __MD128(__MAKEU64_U128(CVTSS2SD64(__S128D0(b)), __D128Q1(a)))
#define _mm_cvtpd_ps(a)                                                        \
  __MM128(                                                                     \
      __MAKEU32_U128(CVTSD2SS64(__D128Q0(a)), CVTSD2SS64(__D128Q1(a)), 0, 0))
#define _mm_cvtps_pd(a)                                                        \
  __MD128(__MAKEU64_U128(CVTSS2SD64(__S128D0(a)), CVTSS2SD64(__S128D1(a))))
...
#define _mm_loadu_si128(a)                                                     \
  __MI128(__MAKEU64_U128(*(uint64_t *)(a), ((uint64_t *)(a))[1]))
#define _mm_storeu_si128(a, b)                                                 \
  (void)(*(uint64_t *)(a) = __U128Q0(b), ((uint64_t *)(a))[1] = __U128Q1(b))

#define _mm_loadu_pd(a)                                                        \
  __MD128(__MAKEU64_U128(*(uint64_t *)(a), ((uint64_t *)(a))[1]))
#define _mm_storeu_pd(a, b)                                                    \
  (void)(*(uint64_t *)(a) = __D128Q0(b), ((uint64_t *)(a))[1] = __D128Q1(b))

#define _mm_loadu_ps(a)                                                        \
  __MM128(__MAKEU64_U128(*(uint64_t *)(a), ((uint64_t *)(a))[1]))
#define _mm_storeu_ps(a, b)                                                    \
  (void)(*(uint64_t *)(a) = __S128Q0(b), ((uint64_t *)(a))[1] = __S128Q1(b))

// MOVHLPS MOVLHPS

#define _mm_movehl_ps(a, b)                                                    \
  __MM128(__MAKEU32_U128(__S128D2(b), __S128D3(b), __S128D2(a), __S128D3(a)))
#define _mm_movelh_ps(a, b)                                                    \
  __MM128(__MAKEU32_U128(__S128D0(a), __S128D1(a), __S128D0(b), __S128D1(b)))

// MOVLPD MOVHPD

#define _mm_loadl_pd(a, b)                                                     \
  __MD128(__MAKEU64_U128(*(uint64_t *)(b), __D128Q1(a)))
#define _mm_loadh_pd(a, b)                                                     \
  __MD128(__MAKEU64_U128(__D128Q0(a), *(uint64_t *)(b)))
...
#define _mm_loadl_pi(a, b)                                                     \
  __MM128(__MAKEU64_U128(*(uint64_t *)(b), __S128Q1(a)))
#define _mm_loadh_pi(a, b)                                                     \
  __MM128(__MAKEU64_U128(__S128Q0(a), *(uint64_t *)(b)))
...
#define _mm_move_ss(a, b)                                                      \
  __MM128(__MAKEU32_U128(__S128D0(b), __S128D1(a), __S128D2(a), __S128D3(a)))
...
#define _mm_clmulepi64_si128(a, b, c)                                          \
  __MI128(PCLMULQDQ128(__U128(a), __U128(b), (c)))
...
#define _mm_sign_epi8(a, b)                                                    \
  __MI128(PSIGN128(__U128(a), __U128(b), _WIDEMASK_BYTE, _BITS_PER_BYTE))
#define _mm_sign_epi16(a, b)                                                   \
  __MI128(PSIGN128(__U128(a), __U128(b), _WIDEMASK_WORD, _BITS_PER_WORD))
#define _mm_sign_epi32(a, b)                                                   \
  __MI128(PSIGN128(__U128(a), __U128(b), _WIDEMASK_LONG, _BITS_PER_LONG))
...
#define _mm_ucomieq_sd(a, b)                                                   \
  (0x040 == (0x051 & UCOMISD128(__D128(a), __D128(b))))
#define _mm_ucomieq_ss(a, b)                                                   \
  (0x040 == (0x051 & UCOMISS128(__S128(a), __S128(b))))
#define _mm_ucomige_sd(a, b)                                                   \
  (0x000 == (0x001 & UCOMISD128(__D128(a), __D128(b))))
#define _mm_ucomige_ss(a, b)                                                   \
  (0x000 == (0x001 & UCOMISS128(__S128(a), __S128(b))))
#define _mm_ucomigt_sd(a, b)                                                   \
  (0x000 == (0x041 & UCOMISD128(__D128(a), __D128(b))))
#define _mm_ucomigt_ss(a, b)                                                   \
  (0x000 == (0x041 & UCOMISS128(__S128(a), __S128(b))))
#define _mm_ucomile_sd(a, b)                                                   \
  (HasOneBit(0x041 & UCOMISD128(__D128(a), __D128(b))))
#define _mm_ucomile_ss(a, b)                                                   \
  (HasOneBit(0x041 & UCOMISS128(__S128(a), __S128(b))))
#define _mm_ucomilt_sd(a, b)                                                   \
  (0x001 == (0x051 & UCOMISD128(__D128(a), __D128(b))))
#define _mm_ucomilt_ss(a, b)                                                   \
  (0x001 == (0x051 & UCOMISS128(__S128(a), __S128(b))))
#define _mm_ucomineq_sd(a, b)                                                  \
  (0x040 != (0x051 & UCOMISD128(__D128(a), __D128(b))))
#define _mm_ucomineq_ss(a, b)                                                  \
  (0x040 != (0x051 & UCOMISS128(__S128(a), __S128(b))))
...
#define _mm_abs_epi8(b)                                                        \
  __MI128(PABS128(__U128(b), _WIDEMASK_BYTE, _BITS_PER_BYTE))
#define _mm_abs_epi16(b)                                                       \
  __MI128(PABS128(__U128(b), _WIDEMASK_WORD, _BITS_PER_WORD))
#define _mm_abs_epi32(b)                                                       \
  __MI128(PABS128(__U128(b), _WIDEMASK_LONG, _BITS_PER_LONG))

// PACKSSWB

#define _mm_packs_epi16(a, b)                                                  \
  __MI128(PACKSSWB128(__U128(a), __U128(b), _WIDEMASK_WORD, _BITS_PER_WORD))

// PACKSSDW

#define _mm_packs_epi32(a, b)                                                  \
  __MI128(PACKSSDW128(__U128(a), __U128(b), _WIDEMASK_LONG, _BITS_PER_LONG))

// PACKUSWB

#define _mm_packus_epi16(a, b)                                                 \
  __MI128(PACKUSWB128(__U128(a), __U128(b), _WIDEMASK_WORD, _BITS_PER_WORD))

// PACKUSDW

#define _mm_packus_epi32(a, b)                                                 \
  __MI128(PACKUSDW128(__U128(a), __U128(b), _WIDEMASK_LONG, _BITS_PER_LONG))
...
#define _mm_add_epi8(a, b)                                                     \
  __MI128(PADD128(__U128(a), __U128(b), _WIDEMASK_BYTE))
#define _mm_add_epi16(a, b)                                                    \
  __MI128(PADD128(__U128(a), __U128(b), _WIDEMASK_WORD))
#define _mm_add_epi32(a, b)                                                    \
  __MI128(PADD128(__U128(a), __U128(b), _WIDEMASK_LONG))
#define _mm_add_epi64(a, b)                                                    \
  __MI128(PADD128(__U128(a), __U128(b), _WIDEMASK_QUAD))

// PADDS[B/W/D/Q]

#define _mm_adds_epi8(a, b)                                                    \
  __MI128(PADDSI128(__U128(a), __U128(b), _WIDEMASK_BYTE, _BITS_PER_BYTE))
#define _mm_adds_epi16(a, b)                                                   \
  __MI128(PADDSI128(__U128(a), __U128(b), _WIDEMASK_WORD, _BITS_PER_WORD))

// PADDUS[B/W/D/Q]

#define _mm_adds_epu8(a, b)                                                    \
  __MI128(PADDSU128(__U128(a), __U128(b), _WIDEMASK_BYTE, _BITS_PER_BYTE))
#define _mm_adds_epu16(a, b)                                                   \
  __MI128(PADDSU128(__U128(a), __U128(b), _WIDEMASK_WORD, _BITS_PER_WORD))

// PAVG[B/W]

#define _mm_avg_epu8(a, b)                                                     \
  __MI128(PAVG128(__U128(a), __U128(b), _WIDEMASK_BYTE))
#define _mm_avg_epu16(a, b)                                                    \
  __MI128(PAVG128(__U128(a), __U128(b), _WIDEMASK_WORD))

// PCMPEQ[B/W/D]

#define _mm_cmpeq_epi8(a, b)                                                   \
  __MI128(PCMPEQ128(__U128(a), __U128(b), _WIDEMASK_BYTE, _BITS_PER_BYTE))
#define _mm_cmpeq_epi16(a, b)                                                  \
  __MI128(PCMPEQ128(__U128(a), __U128(b), _WIDEMASK_WORD, _BITS_PER_WORD))
#define _mm_cmpeq_epi32(a, b)                                                  \
  __MI128(PCMPEQ128(__U128(a), __U128(b), _WIDEMASK_LONG, _BITS_PER_LONG))
#define _mm_cmpeq_epi64(a, b)                                                  \
  __MI128(PCMPEQ128(__U128(a), __U128(b), _WIDEMASK_QUAD, _BITS_PER_QUAD))

// PCMPGT[B/W/D]

#define _mm_cmpgt_epi8(a, b)                                                   \
  __MI128(PCMPGT128(__U128(a), __U128(b), _WIDEMASK_BYTE, _BITS_PER_BYTE))
#define _mm_cmpgt_epi16(a, b)                                                  \
  __MI128(PCMPGT128(__U128(a), __U128(b), _WIDEMASK_WORD, _BITS_PER_WORD))
#define _mm_cmpgt_epi32(a, b)                                                  \
  __MI128(PCMPGT128(__U128(a), __U128(b), _WIDEMASK_LONG, _BITS_PER_LONG))
#define _mm_cmpgt_epi64(a, b)                                                  \
  __MI128(PCMPGT128(__U128(a), __U128(b), _WIDEMASK_QUAD, _BITS_PER_QUAD))

#define _mm_cmplt_epi8(a, b)                                                   \
  __MI128(PCMPGT128(__U128(b), __U128(a), _WIDEMASK_BYTE, _BITS_PER_BYTE))
#define _mm_cmplt_epi16(a, b)                                                  \
  __MI128(PCMPGT128(__U128(b), __U128(a), _WIDEMASK_WORD, _BITS_PER_WORD))
#define _mm_cmplt_epi32(a, b)                                                  \
  __MI128(PCMPGT128(__U128(b), __U128(a), _WIDEMASK_LONG, _BITS_PER_LONG))
...
#define _mm_insert_epi8(a, b, c)                                               \
  __MI128(__INSERT8_U128(__U128(a), (uint16_t)(b), (c)))
#define _mm_insert_epi16(a, b, c)                                              \
  __MI128(__INSERT16_U128(__U128(a), (uint16_t)(b), (c)))
#define _mm_insert_epi32(a, b, c)                                              \
  __MI128(__INSERT32_U128(__U128(a), (uint32_t)(b), (c)))
#define _mm_insert_epi64(a, b, c)                                              \
  __MI128(__INSERT64_U128(__U128(a), (uint64_t)(b), (c)))
...
#define _mm_max_epi8(a, b)                                                     \
  __MI128(PMAXI128(__U128(a), __U128(b), _WIDEMASK_BYTE, _BITS_PER_BYTE))
#define _mm_max_epi16(a, b)                                                    \
  __MI128(PMAXI128(__U128(a), __U128(b), _WIDEMASK_WORD, _BITS_PER_WORD))
#define _mm_max_epi32(a, b)                                                    \
  __MI128(PMAXI128(__U128(a), __U128(b), _WIDEMASK_LONG, _BITS_PER_LONG))

#define _mm_max_epu8(a, b)                                                     \
  __MI128(PMAXU128(__U128(a), __U128(b), _WIDEMASK_BYTE, _BITS_PER_BYTE))
#define _mm_max_epu16(a, b)                                                    \
  __MI128(PMAXU128(__U128(a), __U128(b), _WIDEMASK_WORD, _BITS_PER_WORD))
#define _mm_max_epu32(a, b)                                                    \
  __MI128(PMAXU128(__U128(a), __U128(b), _WIDEMASK_LONG, _BITS_PER_LONG))

#define _mm_min_epi8(a, b)                                                     \
  __MI128(PMINI128(__U128(a), __U128(b), _WIDEMASK_BYTE, _BITS_PER_BYTE))
#define _mm_min_epi16(a, b)                                                    \
  __MI128(PMINI128(__U128(a), __U128(b), _WIDEMASK_WORD, _BITS_PER_WORD))
#define _mm_min_epi32(a, b)                                                    \
  __MI128(PMINI128(__U128(a), __U128(b), _WIDEMASK_LONG, _BITS_PER_LONG))

#define _mm_min_epu8(a, b)                                                     \
  __MI128(PMINU128(__U128(a), __U128(b), _WIDEMASK_BYTE, _BITS_PER_BYTE))
#define _mm_min_epu16(a, b)                                                    \
  __MI128(PMINU128(__U128(a), __U128(b), _WIDEMASK_WORD, _BITS_PER_WORD))
#define _mm_min_epu32(a, b)                                                    \
  __MI128(PMINU128(__U128(a), __U128(b), _WIDEMASK_LONG, _BITS_PER_LONG))
...
#define _mm_shufflehi_epi16(a, b)                                              \
  __MI128(__MAKEU64_U128(__U128Q0(a), PSHUFW64(__U128Q1(a), b)))
#define _mm_shufflelo_epi16(a, b)                                              \
  __MI128(__MAKEU64_U128(PSHUFW64(__U128Q0(a), b), __U128Q1(a)))

// PSLL[W/L/Q]

#define _mm_sll_epi16(a, b)                                                    \
  __MI128(PSLL128(__U128(a), __U128(b), _WIDEMASK_WORD, _BITS_PER_WORD))
#define _mm_sll_epi32(a, b)                                                    \
  __MI128(PSLL128(__U128(a), __U128(b), _WIDEMASK_LONG, _BITS_PER_LONG))
#define _mm_sll_epi64(a, b)                                                    \
  __MI128(PSLL128(__U128(a), __U128(b), _WIDEMASK_QUAD, _BITS_PER_QUAD))
#define _mm_slli_epi16(a, b)                                                   \
  __MI128(PSLL128(__U128(a), __IMM8_128(b), _WIDEMASK_WORD, _BITS_PER_WORD))
#define _mm_slli_epi32(a, b)                                                   \
  __MI128(PSLL128(__U128(a), __IMM8_128(b), _WIDEMASK_LONG, _BITS_PER_LONG))
#define _mm_slli_epi64(a, b)                                                   \
  __MI128(PSLL128(__U128(a), __IMM8_128(b), _WIDEMASK_QUAD, _BITS_PER_QUAD))
...
#define _mm_sra_epi16(a, b)                                                    \
  __MI128(PSRA128(__U128(a), __U128(b), _WIDEMASK_WORD, _BITS_PER_WORD))
#define _mm_sra_epi32(a, b)                                                    \
  __MI128(PSRA128(__U128(a), __U128(b), _WIDEMASK_LONG, _BITS_PER_LONG))
#define _mm_sra_epi64(a, b)                                                    \
  __MI128(PSRA128(__U128(a), __U128(b), _WIDEMASK_QUAD, _BITS_PER_QUAD))
#define _mm_srai_epi16(a, b)                                                   \
  __MI128(PSRA128(__U128(a), __IMM8_128(b), _WIDEMASK_WORD, _BITS_PER_WORD))
#define _mm_srai_epi32(a, b)                                                   \
  __MI128(PSRA128(__U128(a), __IMM8_128(b), _WIDEMASK_LONG, _BITS_PER_LONG))
#define _mm_srai_epi64(a, b)                                                   \
  __MI128(PSRA128(__U128(a), __IMM8_128(b), _WIDEMASK_QUAD, _BITS_PER_QUAD))

// PSRL[W/L/Q]

#define _mm_srl_epi16(a, b)                                                    \
  __MI128(PSRL128(__U128(a), __U128(b), _WIDEMASK_WORD, _BITS_PER_WORD))
#define _mm_srl_epi32(a, b)                                                    \
  __MI128(PSRL128(__U128(a), __U128(b), _WIDEMASK_LONG, _BITS_PER_LONG))
#define _mm_srl_epi64(a, b)                                                    \
  __MI128(PSRL128(__U128(a), __U128(b), _WIDEMASK_QUAD, _BITS_PER_QUAD))
#define _mm_srli_epi16(a, b)                                                   \
  __MI128(PSRL128(__U128(a), __IMM8_128(b), _WIDEMASK_WORD, _BITS_PER_WORD))
#define _mm_srli_epi32(a, b)                                                   \
  __MI128(PSRL128(__U128(a), __IMM8_128(b), _WIDEMASK_LONG, _BITS_PER_LONG))
#define _mm_srli_epi64(a, b)                                                   \
  __MI128(PSRL128(__U128(a), __IMM8_128(b), _WIDEMASK_QUAD, _BITS_PER_QUAD))
...
#define _mm_sub_epi8(a, b)                                                     \
  __MI128(PSUB128(__U128(a), __U128(b), _WIDEMASK_BYTE))
#define _mm_sub_epi16(a, b)                                                    \
  __MI128(PSUB128(__U128(a), __U128(b), _WIDEMASK_WORD))
#define _mm_sub_epi32(a, b)                                                    \
  __MI128(PSUB128(__U128(a), __U128(b), _WIDEMASK_LONG))
#define _mm_sub_epi64(a, b)                                                    \
  __MI128(PSUB128(__U128(a), __U128(b), _WIDEMASK_QUAD))

// PSUBS[B/W]

#define _mm_subs_epi8(a, b)                                                    \
  __MI128(PSUBSI128(__U128(a), __U128(b), _WIDEMASK_BYTE, _BITS_PER_BYTE))
#define _mm_subs_epi16(a, b)                                                   \
  __MI128(PSUBSI128(__U128(a), __U128(b), _WIDEMASK_WORD, _BITS_PER_WORD))

// PSUBUS[B/W]

#define _mm_subs_epu8(a, b)                                                    \
  __MI128(PSUBSU128(__U128(a), __U128(b), _WIDEMASK_BYTE, _BITS_PER_BYTE))
#define _mm_subs_epu16(a, b)                                                   \
  __MI128(PSUBSU128(__U128(a), __U128(b), _WIDEMASK_WORD, _BITS_PER_WORD))
...
#define _mm_testnzc_si128(a, b)                                                \
  (int)((PTESTZ128(__U128(a), __U128(b)) | PTESTC128(__U128(a), __U128(b)))    \
            ? 0                                                                \
            : 1)
...
#define _mm_load1_pd(a)                                                        \
  __MD128(BROADCAST128(*(uint64_t const *)(a), _BITS_PER_QUAD))
#define _mm_load_ps1(a)                                                        \
  __MM128(BROADCAST128(*(uint32_t const *)(a), _BITS_PER_LONG))

#define _mm_store1_pd(p, a)                                                    \
  (void)(*(uint128_t *)(p) = PSHUFD128(__D128(a), 0b01000100))
#define _mm_store_ps1(p, a)                                                    \
  (void)(*(uint128_t *)(p) = PSHUFD128(__S128(a), 0b00000000))

#define _mm_loadr_pd(p)                                                        \
  __MD128(PSHUFD128(*(uint128_t const *)(void *)(p), 0b01001110))
#define _mm_loadr_ps(p)                                                        \
  __MM128(PSHUFD128(*(uint128_t const *)(void *)(p), 0b00011011))

#define _mm_storer_pd(p, a)                                                    \
  (void)(*(uint128_t *)(p) = PSHUFD128(__D128(a), 0b01001110))
#define _mm_storer_ps(p, a)                                                    \
  (void)(*(uint128_t *)(p) = PSHUFD128(__S128(a), 0b00011011))

#define _mm_set_epi8(a, b, c, d, e, f, g, h, i, j, k, l, m, n, o, p)           \
  __MI128(                                                                     \
      __MAKEU8_U128((uint8_t)(p), (uint8_t)(o), (uint8_t)(n), (uint8_t)(m),    \
                    (uint8_t)(l), (uint8_t)(k), (uint8_t)(j), (uint8_t)(i),    \
                    (uint8_t)(h), (uint8_t)(g), (uint8_t)(f), (uint8_t)(e),    \
                    (uint8_t)(d), (uint8_t)(c), (uint8_t)(b), (uint8_t)(a)))
#define _mm_set_epi16(a, b, c, d, e, f, g, h)                                  \
  __MI128(__MAKEU16_U128((uint16_t)(h), (uint16_t)(g), (uint16_t)(f),          \
                         (uint16_t)(e), (uint16_t)(d), (uint16_t)(c),          \
                         (uint16_t)(b), (uint16_t)(a)))
#define _mm_set_epi32(a, b, c, d)                                              \
  __MI128(__MAKEU32_U128((uint32_t)(d), (uint32_t)(c), (uint32_t)(b),          \
                         (uint32_t)(a)))
#define _mm_set_epi64(a, b) __MI128(__MAKEU64_U128(__U64(b), __U64(a)))
#define _mm_set_epi64x(a, b)                                                   \
  __MI128(__MAKEU64_U128((uint64_t)(b), (uint64_t)(a)))
...
#define _mm_setr_epi8(p, o, n, m, l, k, j, i, h, g, f, e, d, c, b, a)          \
  __MI128(                                                                     \
      __MAKEU8_U128((uint8_t)(p), (uint8_t)(o), (uint8_t)(n), (uint8_t)(m),    \
                    ...
                    (uint8_t)(h), (uint8_t)(g), (uint8_t)(f), (uint8_t)(e),    \
                    (uint8_t)(d), (uint8_t)(c), (uint8_t)(b), (uint8_t)(a)))
#define _mm_setr_epi16(h, g, f, e, d, c, b, a)                                 \
  __MI128(__MAKEU16_U128((uint16_t)(h), (uint16_t)(g), (uint16_t)(f),          \
                         (uint16_t)(e), (uint16_t)(d), (uint16_t)(c),          \
                         (uint16_t)(b), (uint16_t)(a)))
#define _mm_setr_epi32(d, c, b, a)                                             \
  __MI128(__MAKEU32_U128((uint32_t)(d), (uint32_t)(c), (uint32_t)(b),          \
                         (uint32_t)(a)))
#define _mm_setr_epi64(b, a) __MI128(__MAKEU64_U128(__U64(b), __U64(a)))
#define _mm_setr_epi64x(b, a)                                                  \
  __MI128(__MAKEU64_U128((uint64_t)(b), (uint64_t)(a)))
...
__forceinline void __aa64_pause(void) {
...
__forceinline unsigned char _addcarry_u8(unsigned char Carry,
                                         unsigned char Source1,
                                         unsigned char Source2,
                                         unsigned char *Destination) {
  unsigned char Sum = (unsigned char)((Carry != 0) + Source1 + Source2);
  unsigned char CarryVector =
      (unsigned char)((Source1 & Source2) ^ ((Source1 ^ Source2) & ~Sum));
  *Destination = Sum;
  return (unsigned char)(CarryVector >> 7);
}

__forceinline unsigned char _addcarry_u16(unsigned char Carry,
                                          unsigned short Source1,
                                          unsigned short Source2,
                                          unsigned short *Destination) {
  unsigned short Sum = (unsigned short)((Carry != 0) + Source1 + Source2);
  unsigned short CarryVector =
      (unsigned short)((Source1 & Source2) ^ ((Source1 ^ Source2) & ~Sum));
  *Destination = Sum;
  return (unsigned char)(CarryVector >> 15);
}

__forceinline unsigned char _addcarry_u32(unsigned char Carry,
...
__forceinline unsigned char _addcarry_u64(unsigned char Carry,
                                          unsigned __int64 Source1,
                                          unsigned __int64 Source2,
                                          unsigned __int64 *Destination) {
  unsigned __int64 Sum = (Carry != 0) + Source1 + Source2;
  unsigned __int64 CarryVector =
      (Source1 & Source2) ^ ((Source1 ^ Source2) & ~Sum);
  *Destination = Sum;
  return CarryVector >> 63;
}

__forceinline unsigned char _subborrow_u8(unsigned char Borrow,
                                          unsigned char Source1,
                                          unsigned char Source2,
                                          unsigned char *Destination) {
  unsigned char Diff = (unsigned char)(Source1 - Source2 - (Borrow != 0));
  unsigned char CarryVector =
      (unsigned char)((Diff & Source2) ^ ((Diff ^ Source2) & ~Source1));
  *Destination = Diff;
  return (unsigned char)(CarryVector >> 7);
}

__forceinline unsigned char _subborrow_u16(unsigned char Borrow,
                                           unsigned short Source1,
                                           unsigned short Source2,
                                           unsigned short *Destination) {
  unsigned short Diff = (unsigned short)(Source1 - Source2 - (Borrow != 0));
  unsigned short CarryVector =
      (unsigned short)((Diff & Source2) ^ ((Diff ^ Source2) & ~Source1));
  *Destination = Diff;
  return (unsigned char)(CarryVector >> 15);
}

__forceinline unsigned char _subborrow_u32(unsigned char Borrow,
                                           unsigned int Source1,
                                           unsigned int Source2,
                                           unsigned int *Destination) {
...
__forceinline unsigned char _subborrow_u64(unsigned char Borrow,
                                           unsigned __int64 Source1,
                                           unsigned __int64 Source2,
                                           unsigned __int64 *Destination) {
  unsigned __int64 Diff = Source1 - Source2 - (Borrow != 0);
  unsigned __int64 CarryVector =
      (Diff & Source2) ^ ((Diff ^ Source2) & ~Source1);
  *Destination = Diff;
  return CarryVector >> 63;
}

__forceinline unsigned int __andn_u32(unsigned int _Source1,
                                      unsigned int _Source2) {
  return (~_Source1) & _Source2;
}

__forceinline unsigned __int64 __andn_u64(unsigned __int64 _Source1,
...
__forceinline unsigned int __bextr_u32(unsigned int _Source,
                                       unsigned int _Start, unsigned int _Len) {
  return (_Source >> _Start) & ~(~0U << _Len);
}

__forceinline unsigned __int64 __bextr_u64(unsigned __int64 _Source,
...
__forceinline unsigned int __bextr2_u32(unsigned int _Source,
...
__forceinline unsigned __int64 __bextr2_u64(unsigned __int64 _Source,
...
__forceinline unsigned int __blsi_u32(unsigned int _Source) {
  return (0U - _Source) & _Source;
}

__forceinline unsigned __int64 __blsi_u64(unsigned __int64 _Source) {
...
__forceinline unsigned int __blsmsk_u32(unsigned int _Source) {
  return (_Source - 1) ^ _Source;
}

__forceinline unsigned __int64 __blsmsk_u64(unsigned __int64 _Source) {
  return (_Source - 1) ^ _Source;
}
...
__forceinline unsigned int __blsr_u32(unsigned int _Source) {
  return (_Source - 1) & _Source;
}

__forceinline unsigned __int64 __blsr_u64(unsigned __int64 _Source) {
  return (_Source - 1) & _Source;
}
...
// __lzcnt __lzcnt16 __lzcnt64 are builtin to clang and providing them here
// errors.
#if !defined(__clang__)

__forceinline unsigned int __lzcnt(unsigned int Source) {
  unsigned long Bit = 0;
  _BitScanReverse(&Bit, Source);
  return Source ? Bit ^ 31 : 32;
}

__forceinline unsigned short __lzcnt16(unsigned short Source) {
  return (unsigned short)(__lzcnt(Source) - 16u);
}

__forceinline unsigned __int64 __lzcnt64(unsigned __int64 Source) {
  unsigned long Bit = 0;
...
#if defined(__clang__)
__forceinline unsigned __int16 __tzcnt_u16(unsigned __int16 Source) {
  unsigned __int16 Result =
      Source ? (unsigned __int16)__builtin_ctz(Source) : (unsigned __int16)16;
  return Result <= (unsigned __int16)16 ? Result : (unsigned __int16)16;
}

__forceinline unsigned int __tzcnt_u32(unsigned int Source) {
  return Source ? __builtin_ctz(Source) : 32;
}

__forceinline unsigned __int64 __tzcnt_u64(unsigned __int64 Source) {
  return Source ? (unsigned __int64)__builtin_ctzll(Source)
                : (unsigned __int64)64;
}

#else // defined(__clang__)
// The MSVC implementations for _CountTrailingZeros() with 0 parameters are
// defined on ARM64, so we don't need to do the same check like clang does.
...
//
// __movs* and __stos* while similar to memcpy and memset intrinsics do not map
// 1-to-1 for the word, long, and quad cases.  As it turns out implementing them
// as inline loop is actually fewer instructions than even a function call.
//

__forceinline void __movsb(unsigned char *Destination,
                           unsigned char const *Source, size_t Count) {
  while (Count--) {
    *Destination++ = *Source++;
  }
}

__forceinline void __movsw(unsigned short *Destination,
                           unsigned short const *Source, size_t Count) {
  while (Count--) {
    *Destination++ = *Source++;
  }
}

__forceinline void __movsd(unsigned long *Destination,
...
__forceinline void __movsq(unsigned __int64 *Destination,
                           unsigned __int64 const *Source, size_t Count) {
  while (Count--) {
    *Destination++ = *Source++;
  }
}

__forceinline void __stosb(unsigned char *Destination, unsigned char Data,
                           size_t Count) {
  while (Count--) {
    *Destination++ = Data;
  }
...
__forceinline void __stosw(unsigned short *Destination, unsigned short Data,
                           size_t Count) {
  while (Count--) {
    *Destination++ = Data;
  }
...
__forceinline void __stosd(unsigned long *Destination, unsigned long Data,
                           size_t Count) {
  while (Count--) {
    *Destination++ = Data;
  }
...
__forceinline void __stosq(unsigned __int64 *Destination, unsigned __int64 Data,
                           size_t Count) {
  while (Count--) {
    *Destination++ = Data;
  }
...
__forceinline void __ud2(void) { __emit(0); }
