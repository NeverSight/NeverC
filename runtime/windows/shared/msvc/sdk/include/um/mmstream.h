...
public:
  virtual HRESULT STDMETHODCALLTYPE GetMultiMediaStream(
      /* [out] */ __RPC__deref_out_opt IMultiMediaStream *
      *ppMultiMediaStream) = 0;
...
typedef struct IMediaStreamVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in IMediaStream *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IMediaStream *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IMediaStream *This);
  ...
  HRESULT(STDMETHODCALLTYPE *SendEndOfStream)(__RPC__in IMediaStream *This,
                                              DWORD dwFlags);
