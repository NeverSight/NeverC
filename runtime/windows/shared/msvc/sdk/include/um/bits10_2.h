...
#define IBackgroundCopyJobHttpOptions2_SetClientCertificateByID(               \
    This, StoreLocation, StoreName, pCertHashBlob)                             \
  ((This)->lpVtbl->SetClientCertificateByID(This, StoreLocation, StoreName,    \
                                            pCertHashBlob))

#define IBackgroundCopyJobHttpOptions2_SetClientCertificateByName(             \
...
#define IBackgroundCopyJobHttpOptions2_GetClientCertificate(                   \
