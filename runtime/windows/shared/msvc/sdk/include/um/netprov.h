...
typedef struct IProvisioningDomainVtbl {
  ...
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IProvisioningDomain *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IProvisioningDomain *This);

  DECLSPEC_XFGVIRT(IProvisioningDomain, Add)
  HRESULT(STDMETHODCALLTYPE *Add)(__RPC__in IProvisioningDomain *This,
...
class DECLSPEC_UUID("2aa2b5fe-b846-4d07-810c-b21ee45320e3") NetProvisioning;
#endif
