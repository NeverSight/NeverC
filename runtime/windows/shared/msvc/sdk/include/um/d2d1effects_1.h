...
/// Effect description: An effect that takes a Y plane as input 0 and a CbCr
/// plane as input 1 and outputs RGBA.  The CbCr plane can be chroma subsampled.
/// Useful for JPEG color conversion.
/// </summary>
