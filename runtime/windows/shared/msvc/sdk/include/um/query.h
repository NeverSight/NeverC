...
#define PSGUID_QUERY_METADATA                                                  \
  {0x624C9360, 0x93D0, 0x11CF, 0xA7, 0x87, 0x00, 0x00, 0x4C, 0x75, 0x27, 0x52}
...
#define DBSELFGUID                                                             \
  {0xc8b52231, 0x5cf3, 0x11ce, {0xad, 0xe5, 0x00, 0xaa, 0x00, 0x44, 0x77, 0x3d}}
...
#define PSGUID_CHARACTERIZATION                                                \
...
// will not compile due to the case(RTOr) member 'or'. If compiling with the
// /permissive- switch please also define QUERY_H_RESTRICTION_PERMISSIVE
...
typedef struct ISearchQueryHitsVtbl {
  ...
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(ISearchQueryHits *This,
                                             /* [in] */ REFIID riid,
  ...
  SCODE(STDMETHODCALLTYPE *Init)(ISearchQueryHits *This,
                                 /* [in] */ IFilter *pflt,
                                 /* [in] */ ULONG ulFlags);
...
interface ISearchQueryHits { CONST_VTBL struct ISearchQueryHitsVtbl *lpVtbl; };
...
typedef struct IRowsetQueryStatusVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(IRowsetQueryStatus *This,
                                             /* [in] */ REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);
  ...
  HRESULT(STDMETHODCALLTYPE *GetStatus)(IRowsetQueryStatus *This,
                                        /* [out] */ DWORD *pdwStatus);
...
#define IRowsetQueryStatus_GetStatusEx(                                        \
    This, pdwStatus, pcFilteredDocuments, pcDocumentsToFilter,                 \
    pdwRatioFinishedDenominator, pdwRatioFinishedNumerator, cbBmk, pBmk,       \
    piRowBmk, pcRowsTotal)                                                     \
  ((This)->lpVtbl->GetStatusEx(                                                \
      This, pdwStatus, pcFilteredDocuments, pcDocumentsToFilter,               \
      pdwRatioFinishedDenominator, pdwRatioFinishedNumerator, cbBmk, pBmk,     \
      piRowBmk, pcRowsTotal))
