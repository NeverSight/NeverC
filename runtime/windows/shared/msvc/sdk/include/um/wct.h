...
_Check_return_ WINADVAPI HWCT WINAPI OpenThreadWaitChainSession(
    _In_ DWORD Flags, _In_opt_ PWAITCHAINCALLBACK callback);
...
#define WCTP_GETINFO_ALL_FLAGS                                                 \
  (WCT_OUT_OF_PROC_FLAG | WCT_OUT_OF_PROC_COM_FLAG | WCT_OUT_OF_PROC_CS_FLAG)

_Check_return_ WINADVAPI BOOL WINAPI GetThreadWaitChain(
    _In_ HWCT WctHandle, _In_opt_ DWORD_PTR Context, _In_ DWORD Flags,
    _In_ DWORD ThreadId, _Inout_ LPDWORD NodeCount,
