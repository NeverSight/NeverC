...
//
// Definition for NetWkstaTransportDel and NetUseDel deletion force levels and
// flags. The lower 16 bits define the force levels and the upper 16 bits are
// the use flags defined in lmuse.h
//
