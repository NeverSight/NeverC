...
EXTERN_GUID(IID_IConfigAsfWriter2, 0x7989ccaa, 0x53f0, 0x44f0, 0x88, 0x4a, 0xf3,
            0xb0, 0x3f, 0x6a, 0xe0, 0x66);
EXTERN_GUID(IID_IConfigAsfWriter, 0x45086030, 0xF7E4, 0x486a, 0xB5, 0x04, 0x82,
            0x6B, 0xB5, 0x79, 0x2A, 0x3B);
EXTERN_GUID(IID_IAMWMBufferPass, 0x6dd816d7, 0xe740, 0x4123, 0x9e, 0x24, 0x24,
            0x44, 0x41, 0x26, 0x44, 0xd8);
EXTERN_GUID(IID_IAMWMBufferPassCallback, 0xb25b8372, 0xd2d2, 0x44b2, 0x86, 0x53,
            0x1b, 0x8d, 0xae, 0x33, 0x24, 0x89);
...
typedef struct IAMWMBufferPassVtbl {
  ...
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in IAMWMBufferPass *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IAMWMBufferPass *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IAMWMBufferPass *This);
...
interface IAMWMBufferPass { CONST_VTBL struct IAMWMBufferPassVtbl *lpVtbl; };
...
#define IAMWMBufferPass_AddRef(This) ((This)->lpVtbl->AddRef(This))

#define IAMWMBufferPass_Release(This) ((This)->lpVtbl->Release(This))
...
typedef struct IAMWMBufferPassCallbackVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IAMWMBufferPassCallback *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IAMWMBufferPassCallback *This);
...
#define IAMWMBufferPassCallback_AddRef(This) ((This)->lpVtbl->AddRef(This))

#define IAMWMBufferPassCallback_Release(This) ((This)->lpVtbl->Release(This))

#define IAMWMBufferPassCallback_Notify(This, pNSSBuffer3, pPin, prtStart,      \
                                       prtEnd)                                 \
...
typedef struct IConfigAsfWriterVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in IConfigAsfWriter *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IConfigAsfWriter *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IConfigAsfWriter *This);
  ...
  HRESULT(STDMETHODCALLTYPE *SetIndexMode)(__RPC__in IConfigAsfWriter *This,
                                           /* [in] */ BOOL bIndexFile);
...
typedef struct IConfigAsfWriter2Vtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in IConfigAsfWriter2 *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IConfigAsfWriter2 *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IConfigAsfWriter2 *This);
  ...
  DECLSPEC_XFGVIRT(IConfigAsfWriter, SetIndexMode)
  HRESULT(STDMETHODCALLTYPE *SetIndexMode)(__RPC__in IConfigAsfWriter2 *This,
                                           /* [in] */ BOOL bIndexFile);
  ...
  HRESULT(STDMETHODCALLTYPE *SetParam)(__RPC__in IConfigAsfWriter2 *This,
                                       /* [in] */ DWORD dwParam,
                                       /* [in] */ DWORD dwParam1,
                                       /* [in] */ DWORD dwParam2);

  DECLSPEC_XFGVIRT(IConfigAsfWriter2, GetParam)
  HRESULT(STDMETHODCALLTYPE *GetParam)(__RPC__in IConfigAsfWriter2 *This,
                                       /* [in] */ DWORD dwParam,
                                       /* [out] */ __RPC__out DWORD *pdwParam1,
...
#define IConfigAsfWriter2_AddRef(This) ((This)->lpVtbl->AddRef(This))

#define IConfigAsfWriter2_Release(This) ((This)->lpVtbl->Release(This))
...
////////////////////////////////////////////////////////////////
//
// ATOM strings to match compatibility option flags above for certain
// applications that don't want to (or not allowed to) update registry entries
// These need to be setup by the application using the WM filters to enable the
// particular functionality
//
static const WCHAR *g_wszExcludeScriptStreamDeliverySynchronization =
    L"ExcludeScriptStreamDeliverySynchronization";
