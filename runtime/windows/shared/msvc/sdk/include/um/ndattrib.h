...
#define NDF_E_LENGTH_EXCEEDED                                                  \
  MAKE_HRESULT(SEVERITY_ERROR, FACILITY_WINDOWS, NDF_ERROR_START)
//
...
//
#define NDF_E_NOHELPERCLASS                                                    \
  MAKE_HRESULT(SEVERITY_ERROR, FACILITY_WINDOWS, NDF_ERROR_START + 1)
// error code deprecated
#define NDF_E_CANCELLED                                                        \
  MAKE_HRESULT(SEVERITY_ERROR, FACILITY_WINDOWS, NDF_ERROR_START + 2)
// error code deprecated
#define NDF_E_DISABLED                                                         \
  MAKE_HRESULT(SEVERITY_ERROR, FACILITY_WINDOWS, NDF_ERROR_START + 4)
//
...
// Inavlid parameter.
//
#define NDF_E_BAD_PARAM                                                        \
  MAKE_HRESULT(SEVERITY_ERROR, FACILITY_WINDOWS, NDF_ERROR_START + 5)
//
...
//
#define NDF_E_VALIDATION                                                       \
  MAKE_HRESULT(SEVERITY_ERROR, FACILITY_WINDOWS, NDF_ERROR_START + 6)
//
...
//
#define NDF_E_UNKNOWN                                                          \
  MAKE_HRESULT(SEVERITY_ERROR, FACILITY_WINDOWS, NDF_ERROR_START + 7)
//
...
//
#define NDF_E_PROBLEM_PRESENT                                                  \
  MAKE_HRESULT(SEVERITY_ERROR, FACILITY_WINDOWS, NDF_ERROR_START + 8)
typedef /* [v1_enum] */
