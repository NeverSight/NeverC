...
typedef interface IVirtualSurfaceUpdatesCallbackNative
...
typedef interface ISwapChainBackgroundPanelNative
...
typedef interface ISurfaceImageSourceManagerNative
...
typedef interface ISurfaceImageSourceNativeWithD2D
...
extern RPC_IF_HANDLE
    __MIDL_itf_windows2Eui2Examl2Emedia2Edxinterop_0000_0000_v0_0_c_ifspec;
extern RPC_IF_HANDLE
    __MIDL_itf_windows2Eui2Examl2Emedia2Edxinterop_0000_0000_v0_0_s_ifspec;
...
typedef struct ISurfaceImageSourceNativeVtbl {
  ...
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(ISurfaceImageSourceNative *This,
                                             /* [in] */ REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(ISurfaceImageSourceNative *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(ISurfaceImageSourceNative *This);

  DECLSPEC_XFGVIRT(ISurfaceImageSourceNative, SetDevice)
  HRESULT(STDMETHODCALLTYPE *SetDevice)(ISurfaceImageSourceNative *This,
                                        /* [annotation][in] */
                                        _In_ IDXGIDevice *device);

  DECLSPEC_XFGVIRT(ISurfaceImageSourceNative, BeginDraw)
  HRESULT(STDMETHODCALLTYPE *BeginDraw)(ISurfaceImageSourceNative *This,
                                        /* [annotation][in] */
                                        _In_ RECT updateRect,
                                        /* [annotation][out] */
                                        _Out_ IDXGISurface **surface,
  ...
  HRESULT(STDMETHODCALLTYPE *EndDraw)(ISurfaceImageSourceNative *This);
...
typedef struct IVirtualSurfaceUpdatesCallbackNativeVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(IVirtualSurfaceUpdatesCallbackNative *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(IVirtualSurfaceUpdatesCallbackNative *This);
...
#define IVirtualSurfaceUpdatesCallbackNative_QueryInterface(This, riid,        \
                                                            ppvObject)         \
  ((This)->lpVtbl->QueryInterface(This, riid, ppvObject))
...
typedef struct IVirtualSurfaceImageSourceNativeVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(IVirtualSurfaceImageSourceNative *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(IVirtualSurfaceImageSourceNative *This);

  DECLSPEC_XFGVIRT(ISurfaceImageSourceNative, SetDevice)
  HRESULT(STDMETHODCALLTYPE *SetDevice)(IVirtualSurfaceImageSourceNative *This,
                                        /* [annotation][in] */
                                        _In_ IDXGIDevice *device);

  DECLSPEC_XFGVIRT(ISurfaceImageSourceNative, BeginDraw)
  HRESULT(STDMETHODCALLTYPE *BeginDraw)(IVirtualSurfaceImageSourceNative *This,
                                        /* [annotation][in] */
                                        _In_ RECT updateRect,
                                        /* [annotation][out] */
                                        _Out_ IDXGISurface **surface,
  ...
  DECLSPEC_XFGVIRT(ISurfaceImageSourceNative, EndDraw)
  HRESULT(STDMETHODCALLTYPE *EndDraw)(IVirtualSurfaceImageSourceNative *This);

  DECLSPEC_XFGVIRT(IVirtualSurfaceImageSourceNative, Invalidate)
  HRESULT(STDMETHODCALLTYPE *Invalidate)(IVirtualSurfaceImageSourceNative *This,
                                         /* [annotation][in] */
                                         _In_ RECT updateRect);
  ...
  HRESULT(STDMETHODCALLTYPE *Resize)(IVirtualSurfaceImageSourceNative *This,
                                     /* [annotation][in] */
                                     _In_ INT newWidth,
                                     /* [annotation][in] */
                                     _In_ INT newHeight);
...
#define IVirtualSurfaceImageSourceNative_BeginDraw(This, updateRect, surface,  \
                                                   offset)                     \
  ((This)->lpVtbl->BeginDraw(This, updateRect, surface, offset))
...
#define IVirtualSurfaceImageSourceNative_RegisterForUpdatesNeeded(This,        \
                                                                  callback)    \
...
typedef struct ISwapChainBackgroundPanelNativeVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(ISwapChainBackgroundPanelNative *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(ISwapChainBackgroundPanelNative *This);
...
extern RPC_IF_HANDLE
    __MIDL_itf_windows2Eui2Examl2Emedia2Edxinterop_0000_0004_v0_0_c_ifspec;
extern RPC_IF_HANDLE
    __MIDL_itf_windows2Eui2Examl2Emedia2Edxinterop_0000_0004_v0_0_s_ifspec;
...
typedef struct ISurfaceImageSourceManagerNativeVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(ISurfaceImageSourceManagerNative *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(ISurfaceImageSourceManagerNative *This);
...
#define ISurfaceImageSourceManagerNative_FlushAllSurfacesWithDevice(This,      \
                                                                    device)    \
...
typedef struct ISurfaceImageSourceNativeWithD2DVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(ISurfaceImageSourceNativeWithD2D *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(ISurfaceImageSourceNativeWithD2D *This);

  DECLSPEC_XFGVIRT(ISurfaceImageSourceNativeWithD2D, SetDevice)
  HRESULT(STDMETHODCALLTYPE *SetDevice)(ISurfaceImageSourceNativeWithD2D *This,
                                        /* [annotation][in] */
                                        _In_ IUnknown *device);

  DECLSPEC_XFGVIRT(ISurfaceImageSourceNativeWithD2D, BeginDraw)
  HRESULT(STDMETHODCALLTYPE *BeginDraw)(ISurfaceImageSourceNativeWithD2D *This,
                                        /* [annotation][in] */
                                        _In_ REFRECT updateRect,
                                        /* [annotation][in] */
                                        _In_ REFIID iid,
  ...
  HRESULT(STDMETHODCALLTYPE *EndDraw)(ISurfaceImageSourceNativeWithD2D *This);
...
#define ISurfaceImageSourceNativeWithD2D_BeginDraw(This, updateRect, iid,      \
                                                   updateObject, offset)       \
...
typedef struct ISwapChainPanelNativeVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(ISwapChainPanelNative *This,
                                             /* [in] */ REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);
  ...
  HRESULT(STDMETHODCALLTYPE *SetSwapChain)(ISwapChainPanelNative *This,
                                           /* [annotation][in] */
                                           _In_ IDXGISwapChain *swapChain);
...
extern RPC_IF_HANDLE
    __MIDL_itf_windows2Eui2Examl2Emedia2Edxinterop_0000_0007_v0_0_c_ifspec;
extern RPC_IF_HANDLE
    __MIDL_itf_windows2Eui2Examl2Emedia2Edxinterop_0000_0007_v0_0_s_ifspec;
...
typedef struct ISwapChainPanelNative2Vtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(ISwapChainPanelNative2 *This,
                                             /* [in] */ REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(ISwapChainPanelNative2 *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(ISwapChainPanelNative2 *This);

  DECLSPEC_XFGVIRT(ISwapChainPanelNative, SetSwapChain)
  HRESULT(STDMETHODCALLTYPE *SetSwapChain)(ISwapChainPanelNative2 *This,
                                           /* [annotation][in] */
                                           _In_ IDXGISwapChain *swapChain);

  DECLSPEC_XFGVIRT(ISwapChainPanelNative2, SetSwapChainHandle)
  HRESULT(STDMETHODCALLTYPE *SetSwapChainHandle)(ISwapChainPanelNative2 *This,
                                                 /* [annotation][in] */
...
extern RPC_IF_HANDLE
    __MIDL_itf_windows2Eui2Examl2Emedia2Edxinterop_0000_0008_v0_0_c_ifspec;
extern RPC_IF_HANDLE
    __MIDL_itf_windows2Eui2Examl2Emedia2Edxinterop_0000_0008_v0_0_s_ifspec;
