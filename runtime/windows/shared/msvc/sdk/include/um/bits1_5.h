...
typedef /* [public][public][public][public][public][public] */
    struct __MIDL_IBackgroundCopyJob2_0001 {
  LPWSTR UserName;
  LPWSTR Password;
...
typedef /* [public][public][public][public][switch_type] */
    union __MIDL_IBackgroundCopyJob2_0002 {
...
typedef struct IBackgroundCopyJob2Vtbl {
  ...
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IBackgroundCopyJob2 *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IBackgroundCopyJob2 *This);

  DECLSPEC_XFGVIRT(IBackgroundCopyJob, AddFileSet)
  HRESULT(STDMETHODCALLTYPE *AddFileSet)(__RPC__in IBackgroundCopyJob2 *This,
                                         /* [in] */ ULONG cFileCount,
                                         /* [size_is][in] */
  ...
  HRESULT(STDMETHODCALLTYPE *AddFile)(__RPC__in IBackgroundCopyJob2 *This,
  ...
  HRESULT(STDMETHODCALLTYPE *Suspend)(__RPC__in IBackgroundCopyJob2 *This);

  DECLSPEC_XFGVIRT(IBackgroundCopyJob, Resume)
  HRESULT(STDMETHODCALLTYPE *Resume)(__RPC__in IBackgroundCopyJob2 *This);

  DECLSPEC_XFGVIRT(IBackgroundCopyJob, Cancel)
  HRESULT(STDMETHODCALLTYPE *Cancel)(__RPC__in IBackgroundCopyJob2 *This);

  DECLSPEC_XFGVIRT(IBackgroundCopyJob, Complete)
  HRESULT(STDMETHODCALLTYPE *Complete)(__RPC__in IBackgroundCopyJob2 *This);

  DECLSPEC_XFGVIRT(IBackgroundCopyJob, GetId)
  HRESULT(STDMETHODCALLTYPE *GetId)(__RPC__in IBackgroundCopyJob2 *This,
                                    /* [out] */ __RPC__out GUID *pVal);

  DECLSPEC_XFGVIRT(IBackgroundCopyJob, GetType)
  HRESULT(STDMETHODCALLTYPE *GetType)(__RPC__in IBackgroundCopyJob2 *This,
  ...
  HRESULT(STDMETHODCALLTYPE *SetPriority)(__RPC__in IBackgroundCopyJob2 *This,
  ...
  HRESULT(STDMETHODCALLTYPE *RemoveCredentials)(
      __RPC__in IBackgroundCopyJob2 *This, BG_AUTH_TARGET Target,
      BG_AUTH_SCHEME Scheme);
