...
public:
  ...
  virtual HRESULT STDMETHODCALLTYPE InsertChunks(
      /* [in] */ DWORD ChunkCount,
      /* [size_is][in] */ __RPC__in_ecount_full(ChunkCount) DedupChunk *
          pChunkMetadata,
      /* [in] */ DWORD DataByteCount,
      /* [size_is][in] */ __RPC__in_ecount_full(DataByteCount) BYTE *
          pChunkData,
      /* [out] */ __RPC__out GUID * pRequestId) = 0;
  ...
  virtual HRESULT STDMETHODCALLTYPE CommitStreams(
      ...
      /* [size_is][in] */ __RPC__in_ecount_full(StreamCount) DedupStream *
          pStreams,
      /* [in] */ DWORD EntryCount,
      /* [size_is][in] */ __RPC__in_ecount_full(EntryCount) DedupStreamEntry *
          pEntries,
      /* [out] */ __RPC__out GUID * pRequestId) = 0;
  ...
  virtual HRESULT STDMETHODCALLTYPE GetStreams(
      /* [in] */ DWORD StreamCount,
      /* [size_is][in] */ __RPC__in_ecount_full(StreamCount) BSTR *
          pStreamPaths,
      /* [out] */ __RPC__out GUID * pRequestId) = 0;
  ...
  virtual HRESULT STDMETHODCALLTYPE GetStreamsResults(
      ...
      /* [size_is][size_is][out] */
      __RPC__deref_out_ecount_full_opt(*pEntryCount) DedupStreamEntry *
          *ppEntries,
      /* [out] */ __RPC__out DedupDataPortRequestStatus * pStatus,
      /* [size_is][size_is][out] */
      __RPC__deref_out_ecount_full_opt(*pStreamCount) HRESULT *
          *ppItemResults) = 0;
  ...
  virtual HRESULT STDMETHODCALLTYPE GetChunksResults(
      ...
      /* [size_is][size_is][out] */
      __RPC__deref_out_ecount_full_opt(*pChunkCount) DedupChunk *
          *ppChunkMetadata,
      ...
      /* [out] */ __RPC__out DedupDataPortRequestStatus * pStatus,
      /* [size_is][size_is][out] */
      __RPC__deref_out_ecount_full_opt(*pChunkCount) HRESULT *
          *ppItemResults) = 0;
  ...
  virtual HRESULT STDMETHODCALLTYPE GetRequestResults(
      ...
      /* [out] */ __RPC__out DedupDataPortRequestStatus * pStatus,
      /* [size_is][size_is][out] */
      __RPC__deref_out_ecount_full_opt(*pBatchCount) HRESULT *
          *ppItemResults) = 0;
};
...
typedef struct IDedupDataPortVtbl {
  ...
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in IDedupDataPort *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IDedupDataPort *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IDedupDataPort *This);
  ...
  HRESULT(STDMETHODCALLTYPE *GetStreamsResults)(
      ...
      /* [out] */ __RPC__out DWORD *pEntryCount,
      /* [size_is][size_is][out] */
      __RPC__deref_out_ecount_full_opt(*pEntryCount)
          DedupStreamEntry **ppEntries,
      /* [out] */ __RPC__out DedupDataPortRequestStatus *pStatus,
      /* [size_is][size_is][out] */
  ...
  HRESULT(STDMETHODCALLTYPE *GetChunksResults)(
      ...
      /* [out] */ __RPC__out DWORD *pChunkCount,
      /* [size_is][size_is][out] */
      __RPC__deref_out_ecount_full_opt(*pChunkCount)
          DedupChunk **ppChunkMetadata,
      /* [out] */ __RPC__out DWORD *pDataByteCount,
      /* [size_is][size_is][out] */
      __RPC__deref_out_ecount_full_opt(*pDataByteCount) BYTE **ppChunkData,
      /* [out] */ __RPC__out DedupDataPortRequestStatus *pStatus,
...
interface IDedupDataPort { CONST_VTBL struct IDedupDataPortVtbl *lpVtbl; };
...
#define IDedupDataPort_AddRef(This) ((This)->lpVtbl->AddRef(This))

#define IDedupDataPort_Release(This) ((This)->lpVtbl->Release(This))
...
#define IDedupDataPort_InsertChunks(This, ChunkCount, pChunkMetadata,          \
                                    DataByteCount, pChunkData, pRequestId)     \
  ((This)->lpVtbl->InsertChunks(This, ChunkCount, pChunkMetadata,              \
                                DataByteCount, pChunkData, pRequestId))

#define IDedupDataPort_InsertChunksWithStream(This, ChunkCount,                \
                                              pChunkMetadata, DataByteCount,   \
                                              pChunkDataStream, pRequestId)    \
  ((This)->lpVtbl->InsertChunksWithStream(This, ChunkCount, pChunkMetadata,    \
                                          DataByteCount, pChunkDataStream,     \
                                          pRequestId))

#define IDedupDataPort_CommitStreams(This, StreamCount, pStreams, EntryCount,  \
                                     pEntries, pRequestId)                     \
  ((This)->lpVtbl->CommitStreams(This, StreamCount, pStreams, EntryCount,      \
                                 pEntries, pRequestId))

#define IDedupDataPort_CommitStreamsWithStream(                                \
    This, StreamCount, pStreams, EntryCount, pEntriesStream, pRequestId)       \
  ((This)->lpVtbl->CommitStreamsWithStream(                                    \
      This, StreamCount, pStreams, EntryCount, pEntriesStream, pRequestId))
...
#define IDedupDataPort_GetStreamsResults(                                      \
    This, RequestId, MaxWaitMs, StreamEntryIndex, pStreamCount, ppStreams,     \
    pEntryCount, ppEntries, pStatus, ppItemResults)                            \
  ((This)->lpVtbl->GetStreamsResults(                                          \
      This, RequestId, MaxWaitMs, StreamEntryIndex, pStreamCount, ppStreams,   \
      pEntryCount, ppEntries, pStatus, ppItemResults))
...
#define IDedupDataPort_GetChunksResults(                                       \
    This, RequestId, MaxWaitMs, ChunkIndex, pChunkCount, ppChunkMetadata,      \
    pDataByteCount, ppChunkData, pStatus, ppItemResults)                       \
  ((This)->lpVtbl->GetChunksResults(                                           \
      This, RequestId, MaxWaitMs, ChunkIndex, pChunkCount, ppChunkMetadata,    \
      pDataByteCount, ppChunkData, pStatus, ppItemResults))
...
#define IDedupDataPort_GetRequestResults(This, RequestId, MaxWaitMs,           \
                                         pBatchResult, pBatchCount, pStatus,   \
                                         ppItemResults)                        \
  ((This)->lpVtbl->GetRequestResults(This, RequestId, MaxWaitMs, pBatchResult, \
                                     pBatchCount, pStatus, ppItemResults))
...
public:
  virtual HRESULT STDMETHODCALLTYPE GetConfiguration(
      ...
      /* [out] */ __RPC__out DedupCompressionAlgorithm *
          pCompressionAlgorithm) = 0;
...
typedef struct IDedupDataPortManagerVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IDedupDataPortManager *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IDedupDataPortManager *This);
...
#define IDedupDataPortManager_AddRef(This) ((This)->lpVtbl->AddRef(This))

#define IDedupDataPortManager_Release(This) ((This)->lpVtbl->Release(This))

#define IDedupDataPortManager_GetConfiguration(                                \
    This, pMinChunkSize, pMaxChunkSize, pChunkingAlgorithm, pHashingAlgorithm, \
    pCompressionAlgorithm)                                                     \
  ((This)->lpVtbl->GetConfiguration(This, pMinChunkSize, pMaxChunkSize,        \
                                    pChunkingAlgorithm, pHashingAlgorithm,     \
                                    pCompressionAlgorithm))
...
#define IDedupDataPortManager_GetVolumeDataPort(This, Options, Path,           \
                                                ppDataPort)                    \
...
class DECLSPEC_UUID("8f107207-1829-48b2-a64b-e61f8e0d9acb") DedupDataPort;
#endif
