...
// Versioning:
//
// Any time new capabilities are introduced in an OS release, a new capability
// set or "CAPSET" is introduced. For example, AMD64 SV2 has the
// OVRDCAP_AMD64_V1_CAPSET capability associated with it (which will be enabled
// on that OS and later OS's). We may also add multiple capability sets in a
// release in certain situations.
//
...
#define OVRDCAP_AMD64_CFG_CHECK_OPT                                            \
  0x00000141 // MUST NOT CHANGE, hard coded in compiler
#define OVRDCAP_AMD64_CFG_DISPATCH_OPT                                         \
  0x00000142 // MUST NOT CHANGE, hard coded in compiler
#define OVRDCAP_AMD64_XFG_DISPATCH_OPT                                         \
  0x00000143 // MUST NOT CHANGE, hard coded in compiler
...
#define OVRDCAP_ARM64_CFG_CHECK_OPT                                            \
  0x0001001B // MUST NOT CHANGE, hard coded in compiler
#define OVRDCAP_ARM64_CFG_DISPATCH_OPT                                         \
  0x0001001C // MUST NOT CHANGE, hard coded in compiler
#define OVRDCAP_ARM64_EC_CFG_CHECK_OPT                                         \
  0x0001001D // MUST NOT CHANGE, hard coded in compiler
#define OVRDCAP_ARM64_EC_ICALL_CHECK_OPT                                       \
  0x0001001E // MUST NOT CHANGE, hard coded in compiler
#define OVRDCAP_ARM64_EC_CALL_CHECK_OPT                                        \
  0x0001001F // MUST NOT CHANGE, hard coded in compiler
...
#define OVRDCAP_ARM64_UNALIGNED_CRT                                            \
  0x00010022 // MUST NOT CHANGE, hard coded in vcruntime140.dll
...
#define OVRDCAP_ARM64_NO_DEVICE_MEMORY_ALLOCATION                              \
  0x00010036 // Allocated (PAGE_NOCACHE) memory is not device memory.
