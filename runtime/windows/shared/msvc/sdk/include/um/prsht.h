...
#pragma warning(push)
#pragma warning(                                                               \
    disable : 4001) /* nonstandard extension 'single line comment' was used */
#pragma warning(                                                               \
...
#define PSH_USEHBMWATERMARK                                                    \
  0x00010000 // user pass in a hbmWatermark instead of pszbmWatermark
#define PSH_USEHPLWATERMARK 0x00020000 //
#define PSH_STRETCHWATERMARK                                                   \
  0x00040000 // stretchwatermark also applies for the header
...
typedef BOOL(CALLBACK *LPFNADDPROPSHEETPAGES)(LPVOID, LPFNADDPROPSHEETPAGE,
                                              LPARAM);
