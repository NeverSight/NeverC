...
typedef struct IFsrmQuotaBaseVtbl {
  ...
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in IFsrmQuotaBase *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IFsrmQuotaBase *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IFsrmQuotaBase *This);
...
interface IFsrmQuotaBase { CONST_VTBL struct IFsrmQuotaBaseVtbl *lpVtbl; };
...
typedef struct IFsrmQuotaObjectVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in IFsrmQuotaObject *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IFsrmQuotaObject *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IFsrmQuotaObject *This);
  ...
  /* [helpstring][id][propget] */ HRESULT(
      STDMETHODCALLTYPE *get_MatchesSourceTemplate)(
      __RPC__in IFsrmQuotaObject *This,
...
interface IFsrmQuotaObject { CONST_VTBL struct IFsrmQuotaObjectVtbl *lpVtbl; };
...
public:
  ...
  virtual /* [helpstring][id] */ HRESULT STDMETHODCALLTYPE ResetPeakUsage(
      void) = 0;

  virtual /* [helpstring][id] */ HRESULT STDMETHODCALLTYPE
  RefreshUsageProperties(void) = 0;
};
...
typedef struct IFsrmQuotaVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in IFsrmQuota *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IFsrmQuota *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IFsrmQuota *This);
  ...
  /* [helpstring][id][propget] */ HRESULT(
      STDMETHODCALLTYPE *get_QuotaPeakUsageTime)(
      __RPC__in IFsrmQuota *This,
...
interface IFsrmQuota { CONST_VTBL struct IFsrmQuotaVtbl *lpVtbl; };
...
public:
  ...
  CommitAndUpdateDerived(
      ...
      /* [retval][out] */ __RPC__deref_out_opt IFsrmDerivedObjectsResult *
          *derivedObjectsResult) = 0;
};
...
typedef struct IFsrmAutoApplyQuotaVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IFsrmAutoApplyQuota *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IFsrmAutoApplyQuota *This);
  ...
  /* [helpstring][id][propget] */ HRESULT(
      STDMETHODCALLTYPE *get_ExcludeFolders)(
      __RPC__in IFsrmAutoApplyQuota *This,
  ...
  /* [helpstring][id][propput] */ HRESULT(
      STDMETHODCALLTYPE *put_ExcludeFolders)(
      __RPC__in IFsrmAutoApplyQuota *This,
...
public:
  ...
  virtual /* [helpstring][id] */ HRESULT STDMETHODCALLTYPE CreateAutoApplyQuota(
      /* [in] */ __RPC__in BSTR quotaTemplateName,
      /* [in] */ __RPC__in BSTR path,
      /* [retval][out] */ __RPC__deref_out_opt IFsrmAutoApplyQuota *
          *quota) = 0;
...
typedef struct IFsrmQuotaManagerVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in IFsrmQuotaManager *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IFsrmQuotaManager *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IFsrmQuotaManager *This);
...
typedef struct IFsrmQuotaManagerExVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IFsrmQuotaManagerEx *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IFsrmQuotaManagerEx *This);
...
typedef struct IFsrmQuotaTemplateVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in IFsrmQuotaTemplate *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IFsrmQuotaTemplate *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IFsrmQuotaTemplate *This);
...
typedef struct IFsrmQuotaTemplateImportedVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IFsrmQuotaTemplateImported *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IFsrmQuotaTemplateImported *This);
...
public:
  virtual /* [helpstring][id] */ HRESULT STDMETHODCALLTYPE CreateTemplate(
      /* [retval][out] */ __RPC__deref_out_opt IFsrmQuotaTemplate *
      *quotaTemplate) = 0;
...
typedef struct IFsrmQuotaTemplateManagerVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IFsrmQuotaTemplateManager *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IFsrmQuotaTemplateManager *This);
