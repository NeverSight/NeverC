...
NetworkIsolationSetupAppContainerBinaries(
    _In_ PSID applicationContainerSid, _In_ LPCWSTR packageFullName,
    _In_ LPCWSTR packageFolder, _In_ LPCWSTR displayName,
    _In_ BOOL bBinariesFullyComputed,
    _In_reads_(binariesCount) LPCWSTR *binaries, _In_ DWORD binariesCount);
...
typedef void(CALLBACK *PAC_CHANGES_CALLBACK_FN)(
    _In_opt_ void *context, _In_ const INET_FIREWALL_AC_CHANGE *pChange);

DWORD
WINAPI
NetworkIsolationRegisterForAppContainerChanges(
    _In_ DWORD flags, _In_ PAC_CHANGES_CALLBACK_FN callback,
    _In_opt_ PVOID context, _Out_ HANDLE *registrationObject);
DWORD
WINAPI
...
HRESULT
WINAPI
NetworkIsolationEnumerateAppContainerRules(_Outptr_ IEnumVARIANT **newEnum);
...
NetworkIsolationEnumAppContainers(
    _In_ DWORD Flags, _Out_ DWORD *pdwNumPublicAppCs,
    _Outptr_result_buffer_(*pdwNumPublicAppCs)
        PINET_FIREWALL_APP_CONTAINER *ppPublicAppCs);
DWORD
WINAPI
NetworkIsolationGetAppContainerConfig(
    _Out_ DWORD *pdwNumPublicAppCs, _Outptr_result_buffer_(*pdwNumPublicAppCs)
                                        PSID_AND_ATTRIBUTES *appContainerSids);
DWORD
WINAPI
NetworkIsolationSetAppContainerConfig(_In_ DWORD dwNumPublicAppCs,
                                      _In_reads_(dwNumPublicAppCs)
                                          PSID_AND_ATTRIBUTES appContainerSids);
...
NetworkIsolationDiagnoseConnectFailureAndGetInfo(
    _In_ LPCWSTR wszServerName, _Out_ NETISO_ERROR_TYPE *netIsoError);

typedef void(CALLBACK *PNETISO_EDP_ID_CALLBACK_FN)(
    _Inout_opt_ void *context, _In_opt_z_ const LPCWSTR wszEnterpriseId,
    _In_ DWORD dwErr);
#define NETISO_GEID_FOR_WDAG 0x01
#define NETISO_GEID_FOR_NEUTRAL_AWARE 0x02
DWORD
WINAPI
NetworkIsolationGetEnterpriseIdAsync(_In_z_ LPCWSTR wszServerName,
                                     _In_ DWORD dwFlags, _In_opt_ void *context,
                                     _In_ PNETISO_EDP_ID_CALLBACK_FN callback,
                                     _Out_ HANDLE *hOperation);
DWORD
WINAPI
NetworkIsolationGetEnterpriseIdClose(_In_ HANDLE hOperation,
...
typedef DWORD(WINAPI *PFN_FWADDDYNAMICKEYWORDADDRESS0)(
    _In_ const PFW_DYNAMIC_KEYWORD_ADDRESS0 dynamicKeywordAddress);

typedef DWORD(WINAPI *PFN_FWDELETEDYNAMICKEYWORDADDRESS0)(
    _In_ GUID dynamicKeywordAddressId);

typedef DWORD(WINAPI *PFN_FWENUMDYNAMICKEYWORDADDRESSESBYTYPE0)(
    _In_ DWORD flags,
    _Out_ PFW_DYNAMIC_KEYWORD_ADDRESS_DATA0 *dynamicKeywordAddressData);

typedef DWORD(WINAPI *PFN_FWENUMDYNAMICKEYWORDADDRESSBYID0)(
    _In_ GUID dynamicKeywordAddressId,
    _Out_ PFW_DYNAMIC_KEYWORD_ADDRESS_DATA0 *dynamicKeywordAddressData);

typedef DWORD(WINAPI *PFN_FWFREEDYNAMICKEYWORDADDRESSDATA0)(
    _In_ PFW_DYNAMIC_KEYWORD_ADDRESS_DATA0 dynamicKeywordAddressData);

typedef DWORD(WINAPI *PFN_FWUPDATEDYNAMICKEYWORDADDRESS0)(
    _In_ GUID dynamicKeywordAddressId, _In_ PCWSTR updatedAddresses,
    _In_ BOOL append);
...
typedef struct INetFwRemoteAdminSettingsVtbl {
  ...
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in INetFwRemoteAdminSettings *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in INetFwRemoteAdminSettings *This);
...
typedef struct INetFwIcmpSettingsVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in INetFwIcmpSettings *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in INetFwIcmpSettings *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in INetFwIcmpSettings *This);
  ...
  /* [propput][id] */ HRESULT(
      STDMETHODCALLTYPE *put_AllowOutboundParameterProblem)(
      __RPC__in INetFwIcmpSettings *This,
      /* [in] */ VARIANT_BOOL allow);
  ...
  /* [propget][id] */ HRESULT(
      STDMETHODCALLTYPE *get_AllowInboundTimestampRequest)(
      __RPC__in INetFwIcmpSettings *This,
      /* [retval][out] */ __RPC__out VARIANT_BOOL *allow);

  DECLSPEC_XFGVIRT(INetFwIcmpSettings, put_AllowInboundTimestampRequest)
  /* [propput][id] */ HRESULT(
      STDMETHODCALLTYPE *put_AllowInboundTimestampRequest)(
      __RPC__in INetFwIcmpSettings *This,
      /* [in] */ VARIANT_BOOL allow);
...
typedef struct INetFwOpenPortVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in INetFwOpenPort *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in INetFwOpenPort *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in INetFwOpenPort *This);
...
interface INetFwOpenPort { CONST_VTBL struct INetFwOpenPortVtbl *lpVtbl; };
...
public:
  ...
  virtual /* [restricted][propget][id] */ HRESULT STDMETHODCALLTYPE
      get__NewEnum(
...
typedef struct INetFwOpenPortsVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in INetFwOpenPorts *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in INetFwOpenPorts *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in INetFwOpenPorts *This);
...
interface INetFwOpenPorts { CONST_VTBL struct INetFwOpenPortsVtbl *lpVtbl; };
...
public:
  ...
  virtual /* [propget][id] */ HRESULT STDMETHODCALLTYPE get_GloballyOpenPorts(
      /* [retval][out] */ __RPC__deref_out_opt INetFwOpenPorts *
      *openPorts) = 0;
};
...
typedef struct INetFwServiceVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in INetFwService *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in INetFwService *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in INetFwService *This);
...
interface INetFwService { CONST_VTBL struct INetFwServiceVtbl *lpVtbl; };
...
typedef struct INetFwServicesVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in INetFwServices *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in INetFwServices *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in INetFwServices *This);
...
interface INetFwServices { CONST_VTBL struct INetFwServicesVtbl *lpVtbl; };
...
typedef struct INetFwAuthorizedApplicationVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in INetFwAuthorizedApplication *This);
...
public:
  ...
  virtual /* [id] */ HRESULT STDMETHODCALLTYPE Item(
      /* [in] */ __RPC__in BSTR imageFileName,
      /* [retval][out] */ __RPC__deref_out_opt INetFwAuthorizedApplication *
          *app) = 0;
...
typedef struct INetFwRuleVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(INetFwRule *This,
                                             /* [in] */ REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);
  ...
  DECLSPEC_XFGVIRT(IDispatch, GetTypeInfoCount)
  HRESULT(STDMETHODCALLTYPE *GetTypeInfoCount)(INetFwRule *This,
                                               /* [out] */ UINT *pctinfo);

  DECLSPEC_XFGVIRT(IDispatch, GetTypeInfo)
  HRESULT(STDMETHODCALLTYPE *GetTypeInfo)(INetFwRule *This,
                                          /* [in] */ UINT iTInfo,
                                          /* [in] */ LCID lcid,
...
interface INetFwRule { CONST_VTBL struct INetFwRuleVtbl *lpVtbl; };
...
typedef struct INetFwRule2Vtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(INetFwRule2 *This,
                                             /* [in] */ REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);
  ...
  DECLSPEC_XFGVIRT(IDispatch, GetTypeInfo)
  HRESULT(STDMETHODCALLTYPE *GetTypeInfo)(INetFwRule2 *This,
                                          /* [in] */ UINT iTInfo,
                                          /* [in] */ LCID lcid,
                                          /* [out] */ ITypeInfo **ppTInfo);
...
interface INetFwRule2 { CONST_VTBL struct INetFwRule2Vtbl *lpVtbl; };
...
typedef struct INetFwRule3Vtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(INetFwRule3 *This,
                                             /* [in] */ REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);
  ...
  DECLSPEC_XFGVIRT(IDispatch, GetTypeInfo)
  HRESULT(STDMETHODCALLTYPE *GetTypeInfo)(INetFwRule3 *This,
                                          /* [in] */ UINT iTInfo,
                                          /* [in] */ LCID lcid,
                                          /* [out] */ ITypeInfo **ppTInfo);
  ...
  /* [propget][id] */ HRESULT(
      STDMETHODCALLTYPE *get_RemoteMachineAuthorizedList)(
      INetFwRule3 *This,
      /* [retval][out] */ BSTR *wszUserAuthList);

  DECLSPEC_XFGVIRT(INetFwRule3, put_RemoteMachineAuthorizedList)
  /* [propput][id] */ HRESULT(
      STDMETHODCALLTYPE *put_RemoteMachineAuthorizedList)(
      INetFwRule3 *This,
      /* [in] */ BSTR wszUserAuthList);
...
interface INetFwRule3 { CONST_VTBL struct INetFwRule3Vtbl *lpVtbl; };
...
typedef struct INetFwRulesVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(INetFwRules *This,
                                             /* [in] */ REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);
  ...
  DECLSPEC_XFGVIRT(IDispatch, GetTypeInfo)
  HRESULT(STDMETHODCALLTYPE *GetTypeInfo)(INetFwRules *This,
                                          /* [in] */ UINT iTInfo,
                                          /* [in] */ LCID lcid,
                                          /* [out] */ ITypeInfo **ppTInfo);
  ...
  /* [id] */ HRESULT(STDMETHODCALLTYPE *Add)(INetFwRules *This,
                                             /* [in] */ INetFwRule *rule);

  DECLSPEC_XFGVIRT(INetFwRules, Remove)
  /* [id] */ HRESULT(STDMETHODCALLTYPE *Remove)(INetFwRules *This,
                                                /* [in] */ BSTR name);
...
interface INetFwRules { CONST_VTBL struct INetFwRulesVtbl *lpVtbl; };
...
#define INetFwServiceRestriction_RestrictService(                              \
  ...
  ((This)->lpVtbl->RestrictService(This, serviceName, appName,                 \
...
public:
  ...
  virtual /* [propget][id] */ HRESULT STDMETHODCALLTYPE get_RemoteAdminSettings(
      /* [retval][out] */ __RPC__deref_out_opt INetFwRemoteAdminSettings *
      *remoteAdminSettings) = 0;

  virtual /* [propget][id] */ HRESULT STDMETHODCALLTYPE get_IcmpSettings(
      /* [retval][out] */ __RPC__deref_out_opt INetFwIcmpSettings *
      *icmpSettings) = 0;
  ...
  virtual /* [propget][id] */ HRESULT STDMETHODCALLTYPE
      get_AuthorizedApplications(
          /* [retval][out] */
          __RPC__deref_out_opt INetFwAuthorizedApplications * *apps) = 0;
};
...
typedef struct INetFwProfileVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in INetFwProfile *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in INetFwProfile *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in INetFwProfile *This);
  ...
  DECLSPEC_XFGVIRT(INetFwProfile,
                   get_UnicastResponsesToMulticastBroadcastDisabled)
  /* [propget][id] */ HRESULT(
      STDMETHODCALLTYPE *get_UnicastResponsesToMulticastBroadcastDisabled)(
      __RPC__in INetFwProfile *This,
      /* [retval][out] */ __RPC__out VARIANT_BOOL *disabled);
  ...
  DECLSPEC_XFGVIRT(INetFwProfile,
                   put_UnicastResponsesToMulticastBroadcastDisabled)
  /* [propput][id] */ HRESULT(
      STDMETHODCALLTYPE *put_UnicastResponsesToMulticastBroadcastDisabled)(
      __RPC__in INetFwProfile *This,
      /* [in] */ VARIANT_BOOL disabled);
  ...
  /* [propget][id] */ HRESULT(STDMETHODCALLTYPE *get_AuthorizedApplications)(
      __RPC__in INetFwProfile *This,
      /* [retval][out] */ __RPC__deref_out_opt INetFwAuthorizedApplications *
          *apps);

  END_INTERFACE
} INetFwProfileVtbl;

interface INetFwProfile { CONST_VTBL struct INetFwProfileVtbl *lpVtbl; };
...
typedef struct INetFwPolicyVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in INetFwPolicy *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in INetFwPolicy *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in INetFwPolicy *This);
...
interface INetFwPolicy { CONST_VTBL struct INetFwPolicyVtbl *lpVtbl; };
...
public:
  ...
  virtual /* [id] */ HRESULT STDMETHODCALLTYPE RestoreLocalFirewallDefaults(
      void) = 0;
...
typedef struct INetFwPolicy2Vtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(INetFwPolicy2 *This,
                                             /* [in] */ REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);
  ...
  DECLSPEC_XFGVIRT(IDispatch, GetTypeInfo)
  HRESULT(STDMETHODCALLTYPE *GetTypeInfo)(INetFwPolicy2 *This,
                                          /* [in] */ UINT iTInfo,
                                          /* [in] */ LCID lcid,
                                          /* [out] */ ITypeInfo **ppTInfo);
  ...
  DECLSPEC_XFGVIRT(INetFwPolicy2,
                   get_UnicastResponsesToMulticastBroadcastDisabled)
  /* [propget][id] */ HRESULT(
      STDMETHODCALLTYPE *get_UnicastResponsesToMulticastBroadcastDisabled)(
      INetFwPolicy2 *This,
  ...
  /* [propget][id] */ HRESULT(
      STDMETHODCALLTYPE *get_IsRuleGroupCurrentlyEnabled)(
      INetFwPolicy2 *This,
      /* [in] */ BSTR group,
      /* [retval][out] */ VARIANT_BOOL *enabled);
...
interface INetFwPolicy2 { CONST_VTBL struct INetFwPolicy2Vtbl *lpVtbl; };
...
#define INetFwPolicy2_IsRuleGroupEnabled(This, profileTypesBitmask, group,     \
                                         enabled)                              \
  ((This)->lpVtbl->IsRuleGroupEnabled(This, profileTypesBitmask, group,        \
                                      enabled))
...
typedef struct INetFwMgrVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in INetFwMgr *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in INetFwMgr *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in INetFwMgr *This);
...
interface INetFwMgr { CONST_VTBL struct INetFwMgrVtbl *lpVtbl; };
...
typedef struct INetFwProductVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(INetFwProduct *This,
                                             /* [in] */ REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);
  ...
  DECLSPEC_XFGVIRT(IDispatch, GetTypeInfo)
  HRESULT(STDMETHODCALLTYPE *GetTypeInfo)(INetFwProduct *This,
                                          /* [in] */ UINT iTInfo,
                                          /* [in] */ LCID lcid,
                                          /* [out] */ ITypeInfo **ppTInfo);
...
interface INetFwProduct { CONST_VTBL struct INetFwProductVtbl *lpVtbl; };
...
typedef struct INetFwProductsVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(INetFwProducts *This,
                                             /* [in] */ REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);
  ...
  DECLSPEC_XFGVIRT(IDispatch, GetTypeInfo)
  HRESULT(STDMETHODCALLTYPE *GetTypeInfo)(INetFwProducts *This,
                                          /* [in] */ UINT iTInfo,
                                          /* [in] */ LCID lcid,
                                          /* [out] */ ITypeInfo **ppTInfo);
...
interface INetFwProducts { CONST_VTBL struct INetFwProductsVtbl *lpVtbl; };
