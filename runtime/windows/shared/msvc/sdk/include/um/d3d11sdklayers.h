...
typedef interface ID3D11RefDefaultTrackingOptions
...
typedef struct ID3D11DebugVtbl {
  ...
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(ID3D11Debug *This,
                                             /* [in] */ REFIID riid,
...
typedef struct ID3D11TracingDeviceVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(ID3D11TracingDevice *This,
                                             /* [in] */ REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);
...
#define ID3D11TracingDevice_SetShaderTrackingOptionsByType(                    \
    This, ResourceTypeFlags, Options)                                          \
  ((This)->lpVtbl->SetShaderTrackingOptionsByType(This, ResourceTypeFlags,     \
                                                  Options))
...
typedef struct ID3D11RefTrackingOptionsVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(ID3D11RefTrackingOptions *This,
                                             /* [in] */ REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);
  ...
  HRESULT(STDMETHODCALLTYPE *SetTrackingOptions)(ID3D11RefTrackingOptions *This,
                                                 UINT uOptions);
...
public:
  virtual HRESULT STDMETHODCALLTYPE SetTrackingOptions(UINT ResourceTypeFlags,
                                                       UINT Options) = 0;
};
...
typedef struct ID3D11RefDefaultTrackingOptionsVtbl {
  ...
  HRESULT(STDMETHODCALLTYPE *SetTrackingOptions)(
      ID3D11RefDefaultTrackingOptions *This, UINT ResourceTypeFlags,
      UINT Options);
...
#define ID3D11RefDefaultTrackingOptions_SetTrackingOptions(                    \
    This, ResourceTypeFlags, Options)                                          \
...
#define D3D11_FORCE_SHADER_SKIP_OPTIMIZATION                                   \
  __TEXT("ForceShaderSkipOptimization")
...
typedef enum D3D11_MESSAGE_ID {
  ...
  D3D11_MESSAGE_ID_LIVE_TRACKEDWORKLOAD =
      (D3D11_MESSAGE_ID_CREATE_TRACKEDWORKLOAD + 1),
  D3D11_MESSAGE_ID_DESTROY_TRACKEDWORKLOAD =
      (D3D11_MESSAGE_ID_LIVE_TRACKEDWORKLOAD + 1),
...
public:
  ...
  virtual HRESULT STDMETHODCALLTYPE GetStorageFilter(
      /* [annotation] */
      _Out_writes_bytes_opt_(*pFilterByteLength) D3D11_INFO_QUEUE_FILTER *
          pFilter,
      /* [annotation] */
...
typedef struct ID3D11InfoQueueVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(ID3D11InfoQueue *This,
                                             /* [in] */ REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);
  ...
  HRESULT(STDMETHODCALLTYPE *AddApplicationMessage)(ID3D11InfoQueue *This,
                                                    /* [annotation] */
                                                    _In_ D3D11_MESSAGE_SEVERITY
                                                        Severity,
                                                    /* [annotation] */
                                                    _In_ LPCSTR pDescription);

  DECLSPEC_XFGVIRT(ID3D11InfoQueue, SetBreakOnCategory)
  HRESULT(STDMETHODCALLTYPE *SetBreakOnCategory)(ID3D11InfoQueue *This,
                                                 /* [annotation] */
                                                 _In_ D3D11_MESSAGE_CATEGORY
                                                     Category,
                                                 /* [annotation] */
                                                 _In_ BOOL bEnable);

  DECLSPEC_XFGVIRT(ID3D11InfoQueue, SetBreakOnSeverity)
  HRESULT(STDMETHODCALLTYPE *SetBreakOnSeverity)(ID3D11InfoQueue *This,
                                                 /* [annotation] */
                                                 _In_ D3D11_MESSAGE_SEVERITY
                                                     Severity,
                                                 /* [annotation] */
...
DEFINE_GUID(IID_ID3D11TracingDevice, 0x1911c771, 0x1587, 0x413e, 0xa7, 0xe0,
            0xfb, 0x26, 0xc3, 0xde, 0x02, 0x68);
DEFINE_GUID(IID_ID3D11RefTrackingOptions, 0x193dacdf, 0x0db2, 0x4c05, 0xa5,
            0x5c, 0xef, 0x06, 0xca, 0xc5, 0x6f, 0xd9);
DEFINE_GUID(IID_ID3D11RefDefaultTrackingOptions, 0x03916615, 0xc644, 0x418c,
            0x9b, 0xf4, 0x75, 0xdb, 0x5b, 0xe6, 0x3c, 0xa0);
