...
RPC_STATUS
RPC_ENTRY
I_RpcNsSendReceive(IN PRPC_MESSAGE Message,
                   OUT RPC_BINDING_HANDLE __RPC_FAR *Handle);

RPCNSAPI
_Analysis_noreturn_ void RPC_ENTRY
I_RpcNsRaiseException(IN PRPC_MESSAGE Message, IN RPC_STATUS Status);
...
RPC_STATUS
RPC_ENTRY
I_NsServerBindSearch(void);

RPCNSAPI
RPC_STATUS
RPC_ENTRY
I_NsClientBindSearch(void);
