...
#define LOCALSTATE_UNINSTALL_UNMANAGED                                         \
  0x4 // uninstall any unmanaged version before assigning
#define LOCALSTATE_POLICYREMOVE_ORPHAN                                         \
  0x8 // app is orphaned when policy removed
#define LOCALSTATE_POLICYREMOVE_UNINSTALL                                      \
  0x10                              // app is uninstalled when policy removed
