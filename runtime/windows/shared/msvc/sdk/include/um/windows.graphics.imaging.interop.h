...
extern RPC_IF_HANDLE
    __MIDL_itf_windows2Egraphics2Eimaging2Einterop_0000_0000_v0_0_c_ifspec;
extern RPC_IF_HANDLE
    __MIDL_itf_windows2Egraphics2Eimaging2Einterop_0000_0000_v0_0_s_ifspec;
...
typedef struct ISoftwareBitmapNativeVtbl {
  ...
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(ISoftwareBitmapNative *This,
                                             /* [in] */ REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(ISoftwareBitmapNative *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(ISoftwareBitmapNative *This);

  DECLSPEC_XFGVIRT(IInspectable, GetIids)
  HRESULT(STDMETHODCALLTYPE *GetIids)(ISoftwareBitmapNative *This,
                                      /* [out] */ ULONG *iidCount,
  ...
  HRESULT(STDMETHODCALLTYPE *GetTrustLevel)(ISoftwareBitmapNative *This,
                                            /* [out] */ TrustLevel *trustLevel);

  DECLSPEC_XFGVIRT(ISoftwareBitmapNative, GetData)
  HRESULT(STDMETHODCALLTYPE *GetData)(ISoftwareBitmapNative *This,
                                      /* [annotation][in] */
                                      _In_ REFIID riid,
                                      /* [annotation][iid_is][out] */
...
#define ISoftwareBitmapNative_AddRef(This) ((This)->lpVtbl->AddRef(This))

#define ISoftwareBitmapNative_Release(This) ((This)->lpVtbl->Release(This))
...
typedef struct ISoftwareBitmapNativeFactoryVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(ISoftwareBitmapNativeFactory *This,
                                             /* [in] */ REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(ISoftwareBitmapNativeFactory *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(ISoftwareBitmapNativeFactory *This);

  DECLSPEC_XFGVIRT(IInspectable, GetIids)
  HRESULT(STDMETHODCALLTYPE *GetIids)(ISoftwareBitmapNativeFactory *This,
                                      /* [out] */ ULONG *iidCount,
                                      /* [size_is][size_is][out] */ IID **iids);
  ...
  DECLSPEC_XFGVIRT(IInspectable, GetTrustLevel)
  HRESULT(STDMETHODCALLTYPE *GetTrustLevel)(ISoftwareBitmapNativeFactory *This,
                                            /* [out] */ TrustLevel *trustLevel);
...
#define ISoftwareBitmapNativeFactory_AddRef(This) ((This)->lpVtbl->AddRef(This))
...
#define ISoftwareBitmapNativeFactory_CreateFromWICBitmap(                      \
    This, data, forceReadOnly, riid, ppv)                                      \
  ((This)->lpVtbl->CreateFromWICBitmap(This, data, forceReadOnly, riid, ppv))

#define ISoftwareBitmapNativeFactory_CreateFromMF2DBuffer2(                    \
    This, data, subtype, width, height, forceReadOnly, minDisplayAperture,     \
    riid, ppv)                                                                 \
  ((This)->lpVtbl->CreateFromMF2DBuffer2(This, data, subtype, width, height,   \
...
extern RPC_IF_HANDLE
    __MIDL_itf_windows2Egraphics2Eimaging2Einterop_0000_0002_v0_0_c_ifspec;
extern RPC_IF_HANDLE
    __MIDL_itf_windows2Egraphics2Eimaging2Einterop_0000_0002_v0_0_s_ifspec;
