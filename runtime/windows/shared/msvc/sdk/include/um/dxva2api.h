...
//   to make the evr.idl file build. The actual definitions are contained in
//   d3d9.h
//
#if 0
...
//
// Deprecated labels - please use the ones in the DXVA2_VideoTransferFunction
// enum.
//
...
// DXVA2_DECODE_SPECIFY_ENCRYPTED_BLOCKS is an extension function that that
// allows the decoder to specify which portions of the compressed buffers are
// encrypted. If this fucntion is not used to specify this information, it is
// assumed that the entire buffer is encrypted.
...
public:
  ...
  virtual HRESULT STDMETHODCALLTYPE GetDecoderConfigurations(
      ...
      _Out_ UINT *pCount,
      /* [annotation][size_is][unique][out] */
      _Outptr_result_buffer_maybenull_(*pCount)
...
typedef struct IDirectXVideoDecoderServiceVtbl {
  ...
  DECLSPEC_XFGVIRT(IDirectXVideoAccelerationService, CreateSurface)
  HRESULT(STDMETHODCALLTYPE *CreateSurface)(IDirectXVideoDecoderService *This,
                                            /* [annotation][in] */
                                            _In_ UINT Width,
                                            /* [annotation][in] */
                                            _In_ UINT Height,
...
#define IDirectXVideoDecoderService_GetDecoderDeviceGuids(This, pCount,        \
                                                          pGuids)              \
...
#define IDirectXVideoDecoderService_CreateVideoDecoder(                        \
    This, Guid, pVideoDesc, pConfig, ppDecoderRenderTargets, NumRenderTargets, \
    ppDecode)                                                                  \
  ((This)->lpVtbl->CreateVideoDecoder(This, Guid, pVideoDesc, pConfig,         \
                                      ppDecoderRenderTargets,                  \
                                      NumRenderTargets, ppDecode))
...
typedef struct IDirectXVideoProcessorServiceVtbl {
  ...
  DECLSPEC_XFGVIRT(IDirectXVideoAccelerationService, CreateSurface)
  HRESULT(STDMETHODCALLTYPE *CreateSurface)(IDirectXVideoProcessorService *This,
                                            /* [annotation][in] */
                                            _In_ UINT Width,
                                            /* [annotation][in] */
                                            _In_ UINT Height,
...
#define IDirectXVideoProcessorService_GetVideoProcessorCaps(                   \
  ...
  ((This)->lpVtbl->GetVideoProcessorCaps(                                      \
      This, VideoProcDeviceGuid, pVideoDesc, RenderTargetFormat, pCaps))
...
typedef struct IDirectXVideoMemoryConfigurationVtbl {
  ...
  DECLSPEC_XFGVIRT(IDirectXVideoMemoryConfiguration,
...
STDAPI DXVA2CreateVideoService(_In_ IDirect3DDevice9 *pDD, _In_ REFIID riid,
                               _Outptr_ void **ppService);
#endif // _D3D9_H_
