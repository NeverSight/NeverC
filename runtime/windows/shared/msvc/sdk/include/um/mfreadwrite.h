...
#define IMFReadWriteClassFactory_CreateInstanceFromURL(                        \
  ...
  ((This)->lpVtbl->CreateInstanceFromURL(This, clsid, pwszURL, pAttributes,    \
                                         riid, ppvObject))

#define IMFReadWriteClassFactory_CreateInstanceFromObject(                     \
    This, clsid, punkObject, pAttributes, riid, ppvObject)                     \
  ((This)->lpVtbl->CreateInstanceFromObject(This, clsid, punkObject,           \
                                            pAttributes, riid, ppvObject))
...
STDAPI MFCreateSourceReaderFromURL(_In_ LPCWSTR pwszURL,
                                   _In_opt_ IMFAttributes *pAttributes,
                                   _Out_ IMFSourceReader **ppSourceReader);
STDAPI
MFCreateSourceReaderFromByteStream(_In_ IMFByteStream *pByteStream,
                                   _In_opt_ IMFAttributes *pAttributes,
                                   _Out_ IMFSourceReader **ppSourceReader);
STDAPI
MFCreateSourceReaderFromMediaSource(_In_ IMFMediaSource *pMediaSource,
                                    _In_opt_ IMFAttributes *pAttributes,
                                    _Out_ IMFSourceReader **ppSourceReader);
...
EXTERN_GUID(MF_SOURCE_READER_ENABLE_ADVANCED_VIDEO_PROCESSING, 0xf81da2c,
            0xb537, 0x4672, 0xa8, 0xb2, 0xa6, 0x81, 0xb1, 0x73, 0x7, 0xa3);
...
EXTERN_GUID(MF_SOURCE_READER_D3D11_BIND_FLAGS, 0x33f3197b, 0xf73a, 0x4e14, 0x8d,
            0x85, 0xe, 0x4c, 0x43, 0x68, 0x78, 0x8d);
EXTERN_GUID(MF_SOURCE_READER_PASSTHROUGH_MODE, 0x43ff126, 0xfe2c, 0x4708, 0xa0,
            0x9b, 0xda, 0x2a, 0xb4, 0x35, 0xce, 0xd9);
typedef /* [v1_enum] */
...
typedef struct IMFSourceReaderVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(IMFSourceReader *This,
                                             /* [in] */ REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);
  ...
  HRESULT(STDMETHODCALLTYPE *ReadSample)(IMFSourceReader *This,
                                         /* [annotation][in] */
                                         _In_ DWORD dwStreamIndex,
                                         /* [annotation][in] */
                                         _In_ DWORD dwControlFlags,
  ...
  HRESULT(STDMETHODCALLTYPE *Flush)(IMFSourceReader *This,
                                    /* [annotation][in] */
                                    _In_ DWORD dwStreamIndex);
...
interface IMFSourceReader { CONST_VTBL struct IMFSourceReaderVtbl *lpVtbl; };
...
#define IMFSourceReader_GetNativeMediaType(This, dwStreamIndex,                \
                                           dwMediaTypeIndex, ppMediaType)      \
  ((This)->lpVtbl->GetNativeMediaType(This, dwStreamIndex, dwMediaTypeIndex,   \
                                      ppMediaType))
...
#define IMFSourceReader_SetCurrentMediaType(This, dwStreamIndex, pdwReserved,  \
                                            pMediaType)                        \
  ((This)->lpVtbl->SetCurrentMediaType(This, dwStreamIndex, pdwReserved,       \
                                       pMediaType))
...
#define IMFSourceReader_ReadSample(This, dwStreamIndex, dwControlFlags,        \
                                   pdwActualStreamIndex, pdwStreamFlags,       \
                                   pllTimestamp, ppSample)                     \
  ((This)->lpVtbl->ReadSample(This, dwStreamIndex, dwControlFlags,             \
                              pdwActualStreamIndex, pdwStreamFlags,            \
                              pllTimestamp, ppSample))
...
#define IMFSourceReader_GetServiceForStream(This, dwStreamIndex, guidService,  \
                                            riid, ppvObject)                   \
  ((This)->lpVtbl->GetServiceForStream(This, dwStreamIndex, guidService, riid, \
                                       ppvObject))

#define IMFSourceReader_GetPresentationAttribute(This, dwStreamIndex,          \
                                                 guidAttribute, pvarAttribute) \
  ((This)->lpVtbl->GetPresentationAttribute(This, dwStreamIndex,               \
                                            guidAttribute, pvarAttribute))
...
typedef struct IMFSourceReaderExVtbl {
  ...
  DECLSPEC_XFGVIRT(IMFSourceReader, ReadSample)
  HRESULT(STDMETHODCALLTYPE *ReadSample)(IMFSourceReaderEx *This,
                                         /* [annotation][in] */
                                         _In_ DWORD dwStreamIndex,
                                         /* [annotation][in] */
                                         _In_ DWORD dwControlFlags,
  ...
  DECLSPEC_XFGVIRT(IMFSourceReader, Flush)
  HRESULT(STDMETHODCALLTYPE *Flush)(IMFSourceReaderEx *This,
                                    /* [annotation][in] */
                                    _In_ DWORD dwStreamIndex);
...
#define IMFSourceReaderEx_GetNativeMediaType(This, dwStreamIndex,              \
                                             dwMediaTypeIndex, ppMediaType)    \
  ((This)->lpVtbl->GetNativeMediaType(This, dwStreamIndex, dwMediaTypeIndex,   \
                                      ppMediaType))

#define IMFSourceReaderEx_GetCurrentMediaType(This, dwStreamIndex,             \
                                              ppMediaType)                     \
  ((This)->lpVtbl->GetCurrentMediaType(This, dwStreamIndex, ppMediaType))

#define IMFSourceReaderEx_SetCurrentMediaType(This, dwStreamIndex,             \
                                              pdwReserved, pMediaType)         \
  ((This)->lpVtbl->SetCurrentMediaType(This, dwStreamIndex, pdwReserved,       \
                                       pMediaType))

#define IMFSourceReaderEx_SetCurrentPosition(This, guidTimeFormat,             \
                                             varPosition)                      \
  ((This)->lpVtbl->SetCurrentPosition(This, guidTimeFormat, varPosition))

#define IMFSourceReaderEx_ReadSample(This, dwStreamIndex, dwControlFlags,      \
                                     pdwActualStreamIndex, pdwStreamFlags,     \
                                     pllTimestamp, ppSample)                   \
  ((This)->lpVtbl->ReadSample(This, dwStreamIndex, dwControlFlags,             \
                              pdwActualStreamIndex, pdwStreamFlags,            \
...
#define IMFSourceReaderEx_GetServiceForStream(This, dwStreamIndex,             \
                                              guidService, riid, ppvObject)    \
  ((This)->lpVtbl->GetServiceForStream(This, dwStreamIndex, guidService, riid, \
                                       ppvObject))

#define IMFSourceReaderEx_GetPresentationAttribute(                            \
    This, dwStreamIndex, guidAttribute, pvarAttribute)                         \
  ((This)->lpVtbl->GetPresentationAttribute(This, dwStreamIndex,               \
                                            guidAttribute, pvarAttribute))

#define IMFSourceReaderEx_SetNativeMediaType(This, dwStreamIndex, pMediaType,  \
                                             pdwStreamFlags)                   \
  ((This)->lpVtbl->SetNativeMediaType(This, dwStreamIndex, pMediaType,         \
                                      pdwStreamFlags))

#define IMFSourceReaderEx_AddTransformForStream(This, dwStreamIndex,           \
                                                pTransformOrActivate)          \
  ((This)->lpVtbl->AddTransformForStream(This, dwStreamIndex,                  \
                                         pTransformOrActivate))
...
#define IMFSourceReaderEx_GetTransformForStream(                               \
  ...
  ((This)->lpVtbl->GetTransformForStream(                                      \
      This, dwStreamIndex, dwTransformIndex, pGuidCategory, ppTransform))
...
#define IMFSourceReaderCallback_OnReadSample(                                  \
    This, hrStatus, dwStreamIndex, dwStreamFlags, llTimestamp, pSample)        \
  ((This)->lpVtbl->OnReadSample(This, hrStatus, dwStreamIndex, dwStreamFlags,  \
                                llTimestamp, pSample))
...
#define IMFSourceReaderCallback2_OnReadSample(                                 \
    This, hrStatus, dwStreamIndex, dwStreamFlags, llTimestamp, pSample)        \
  ((This)->lpVtbl->OnReadSample(This, hrStatus, dwStreamIndex, dwStreamFlags,  \
                                llTimestamp, pSample))
...
STDAPI MFCreateSinkWriterFromURL(_In_opt_ LPCWSTR pwszOutputURL,
                                 _In_opt_ IMFByteStream *pByteStream,
                                 _In_opt_ IMFAttributes *pAttributes,
                                 _Out_ IMFSinkWriter **ppSinkWriter);
STDAPI MFCreateSinkWriterFromMediaSink(_In_ IMFMediaSink *pMediaSink,
                                       _In_opt_ IMFAttributes *pAttributes,
                                       _Out_ IMFSinkWriter **ppSinkWriter);
...
typedef struct IMFSinkWriterVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(IMFSinkWriter *This,
                                             /* [in] */ REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);
  ...
  HRESULT(STDMETHODCALLTYPE *AddStream)(IMFSinkWriter *This,
                                        /* [annotation][in] */
                                        _In_ IMFMediaType *pTargetMediaType,
                                        /* [annotation][out] */
  ...
  HRESULT(STDMETHODCALLTYPE *WriteSample)(IMFSinkWriter *This,
                                          /* [annotation][in] */
                                          _In_ DWORD dwStreamIndex,
                                          /* [annotation][in] */
  ...
  HRESULT(STDMETHODCALLTYPE *SendStreamTick)(IMFSinkWriter *This,
                                             /* [annotation][in] */
                                             _In_ DWORD dwStreamIndex,
                                             /* [annotation][in] */
                                             _In_ LONGLONG llTimestamp);
  ...
  HRESULT(STDMETHODCALLTYPE *PlaceMarker)(IMFSinkWriter *This,
                                          /* [annotation][in] */
                                          _In_ DWORD dwStreamIndex,
                                          /* [annotation][in] */
  ...
  HRESULT(STDMETHODCALLTYPE *Flush)(IMFSinkWriter *This,
                                    /* [annotation][in] */
                                    _In_ DWORD dwStreamIndex);
...
interface IMFSinkWriter { CONST_VTBL struct IMFSinkWriterVtbl *lpVtbl; };
...
#define IMFSinkWriter_SetInputMediaType(This, dwStreamIndex, pInputMediaType,  \
                                        pEncodingParameters)                   \
  ((This)->lpVtbl->SetInputMediaType(This, dwStreamIndex, pInputMediaType,     \
                                     pEncodingParameters))
...
#define IMFSinkWriter_GetServiceForStream(This, dwStreamIndex, guidService,    \
                                          riid, ppvObject)                     \
  ((This)->lpVtbl->GetServiceForStream(This, dwStreamIndex, guidService, riid, \
                                       ppvObject))
...
typedef struct IMFSinkWriterExVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(IMFSinkWriterEx *This,
                                             /* [in] */ REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);
  ...
  DECLSPEC_XFGVIRT(IMFSinkWriter, WriteSample)
  HRESULT(STDMETHODCALLTYPE *WriteSample)(IMFSinkWriterEx *This,
                                          /* [annotation][in] */
                                          _In_ DWORD dwStreamIndex,
                                          /* [annotation][in] */
                                          _In_ IMFSample *pSample);
  ...
  DECLSPEC_XFGVIRT(IMFSinkWriter, SendStreamTick)
  HRESULT(STDMETHODCALLTYPE *SendStreamTick)(IMFSinkWriterEx *This,
                                             /* [annotation][in] */
                                             _In_ DWORD dwStreamIndex,
                                             /* [annotation][in] */
                                             _In_ LONGLONG llTimestamp);
  ...
  DECLSPEC_XFGVIRT(IMFSinkWriter, PlaceMarker)
  HRESULT(STDMETHODCALLTYPE *PlaceMarker)(IMFSinkWriterEx *This,
                                          /* [annotation][in] */
                                          _In_ DWORD dwStreamIndex,
                                          /* [annotation][in] */
                                          _In_ LPVOID pvContext);
  ...
  DECLSPEC_XFGVIRT(IMFSinkWriter, Flush)
  HRESULT(STDMETHODCALLTYPE *Flush)(IMFSinkWriterEx *This,
                                    /* [annotation][in] */
                                    _In_ DWORD dwStreamIndex);
...
interface IMFSinkWriterEx { CONST_VTBL struct IMFSinkWriterExVtbl *lpVtbl; };
...
#define IMFSinkWriterEx_SetInputMediaType(                                     \
...
#define IMFSinkWriterEx_GetServiceForStream(This, dwStreamIndex, guidService,  \
                                            riid, ppvObject)                   \
  ((This)->lpVtbl->GetServiceForStream(This, dwStreamIndex, guidService, riid, \
                                       ppvObject))
...
#define IMFSinkWriterEx_GetTransformForStream(                                 \
    This, dwStreamIndex, dwTransformIndex, pGuidCategory, ppTransform)         \
  ((This)->lpVtbl->GetTransformForStream(                                      \
      This, dwStreamIndex, dwTransformIndex, pGuidCategory, ppTransform))
...
#define IMFSinkWriterEncoderConfig_SetTargetMediaType(                         \
  ...
  ((This)->lpVtbl->SetTargetMediaType(This, dwStreamIndex, pTargetMediaType,   \
                                      pEncodingParameters))

#define IMFSinkWriterEncoderConfig_PlaceEncodingParameters(                    \
    This, dwStreamIndex, pEncodingParameters)                                  \
  ((This)->lpVtbl->PlaceEncodingParameters(This, dwStreamIndex,                \
                                           pEncodingParameters))
...
EXTERN_GUID(MF_MEDIASINK_AUTOFINALIZE_SUPPORTED, 0x48c131be, 0x135a, 0x41cb,
            0x82, 0x90, 0x3, 0x65, 0x25, 0x9, 0xc9, 0x99);
