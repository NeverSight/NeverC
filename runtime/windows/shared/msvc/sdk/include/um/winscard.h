...
extern WINSCARDAPI LONG WINAPI SCardEstablishContext(
    _In_ DWORD dwScope, _Reserved_ LPCVOID pvReserved1,
    _Reserved_ LPCVOID pvReserved2, _Out_ LPSCARDCONTEXT phContext);

extern WINSCARDAPI LONG WINAPI SCardReleaseContext(_In_ SCARDCONTEXT hContext);

extern WINSCARDAPI LONG WINAPI SCardIsValidContext(_In_ SCARDCONTEXT hContext);
...
_Success_(return == SCARD_S_SUCCESS) extern WINSCARDAPI LONG WINAPI
    SCardListReadersA(
        _In_ SCARDCONTEXT hContext, _In_opt_ LPCSTR mszGroups,
        _When_(_Old_(*pcchReaders) == SCARD_AUTOALLOCATE,
               _At_((LPSTR *)mszReaders,
                    _Outptr_result_buffer_maybenull_(*pcchReaders)
                        _At_(*_Curr_, _Post_z_ _Post_ _NullNull_terminated_)))
            _When_(_Old_(*pcchReaders) != SCARD_AUTOALLOCATE,
                   _Out_writes_opt_(*pcchReaders) _Post_ _NullNull_terminated_)
                LPSTR mszReaders,
        _Inout_ LPDWORD pcchReaders);
_Success_(return == SCARD_S_SUCCESS) extern WINSCARDAPI LONG WINAPI
    SCardListReadersW(
        _In_ SCARDCONTEXT hContext, _In_opt_ LPCWSTR mszGroups,
        _When_(_Old_(*pcchReaders) == SCARD_AUTOALLOCATE,
               _At_((LPWSTR *)mszReaders,
                    _Outptr_result_buffer_maybenull_(*pcchReaders)
                        _At_(*_Curr_, _Post_z_ _Post_ _NullNull_terminated_)))
            _When_(_Old_(*pcchReaders) != SCARD_AUTOALLOCATE,
                   _Out_writes_opt_(*pcchReaders) _Post_ _NullNull_terminated_)
...
_Success_(return == SCARD_S_SUCCESS) extern WINSCARDAPI LONG WINAPI
    SCardListCardsA(
        _In_ SCARDCONTEXT hContext, _In_opt_ LPCBYTE pbAtr,
        _In_reads_opt_(cguidInterfaceCount) LPCGUID rgquidInterfaces,
        _In_ DWORD cguidInterfaceCount,
        _When_(_Old_(*pcchCards) == SCARD_AUTOALLOCATE,
               _At_((LPSTR *)mszCards,
                    _Outptr_result_buffer_maybenull_(*pcchCards)
                        _At_(*_Curr_, _Post_ _NullNull_terminated_)))
            _When_(_Old_(*pcchCards) != SCARD_AUTOALLOCATE,
                   _Out_writes_opt_(*pcchCards) _Post_ _NullNull_terminated_)
                CHAR *mszCards,
...
extern WINSCARDAPI LONG WINAPI SCardListInterfacesA(
    _In_ SCARDCONTEXT hContext, _In_ LPCSTR szCard,
    _Out_ LPGUID pguidInterfaces, _Inout_ LPDWORD pcguidInterfaces);
extern WINSCARDAPI LONG WINAPI SCardListInterfacesW(
    _In_ SCARDCONTEXT hContext, _In_ LPCWSTR szCard,
    _Out_ LPGUID pguidInterfaces, _Inout_ LPDWORD pcguidInterfaces);
#ifdef UNICODE
...
extern WINSCARDAPI
    LONG WINAPI SCardGetProviderIdA(_In_ SCARDCONTEXT hContext,
                                    _In_ LPCSTR szCard,
                                    _Out_ LPGUID pguidProviderId);
extern WINSCARDAPI LONG WINAPI
SCardGetProviderIdW(_In_ SCARDCONTEXT hContext, _In_ LPCWSTR szCard,
                    _Out_ LPGUID pguidProviderId);
#ifdef UNICODE
...
_Success_(return == SCARD_S_SUCCESS) extern WINSCARDAPI LONG WINAPI
    SCardGetCardTypeProviderNameA(
        _In_ SCARDCONTEXT hContext, _In_ LPCSTR szCardName,
        _In_ DWORD dwProviderId,
        _When_(_Old_(*pcchProvider) == SCARD_AUTOALLOCATE,
               _At_((LPSTR *)szProvider,
                    _Outptr_result_buffer_all_(*pcchProvider)))
            _When_(_Old_(*pcchProvider) != SCARD_AUTOALLOCATE,
                   _Out_writes_to_(*pcchProvider, *pcchProvider) _Post_z_)
                CHAR *szProvider,
        _Inout_ LPDWORD pcchProvider);
_Success_(return == SCARD_S_SUCCESS) extern WINSCARDAPI LONG WINAPI
    SCardGetCardTypeProviderNameW(
        _In_ SCARDCONTEXT hContext, _In_ LPCWSTR szCardName,
        _In_ DWORD dwProviderId,
        _When_(_Old_(*pcchProvider) == SCARD_AUTOALLOCATE,
               _At_((LPWSTR *)szProvider,
                    _Outptr_result_buffer_all_(*pcchProvider)))
            _When_(_Old_(*pcchProvider) != SCARD_AUTOALLOCATE,
                   _Out_writes_to_(*pcchProvider, *pcchProvider) _Post_z_)
                WCHAR *szProvider,
...
extern WINSCARDAPI LONG WINAPI
SCardIntroduceReaderGroupA(_In_ SCARDCONTEXT hContext, _In_ LPCSTR szGroupName);
extern WINSCARDAPI LONG WINAPI SCardIntroduceReaderGroupW(
    _In_ SCARDCONTEXT hContext, _In_ LPCWSTR szGroupName);
#ifdef UNICODE
...
extern WINSCARDAPI LONG WINAPI
SCardForgetReaderGroupA(_In_ SCARDCONTEXT hContext, _In_ LPCSTR szGroupName);
extern WINSCARDAPI LONG WINAPI
SCardForgetReaderGroupW(_In_ SCARDCONTEXT hContext, _In_ LPCWSTR szGroupName);
#ifdef UNICODE
...
extern WINSCARDAPI LONG WINAPI SCardIntroduceReaderA(_In_ SCARDCONTEXT hContext,
                                                     _In_ LPCSTR szReaderName,
                                                     _In_ LPCSTR szDeviceName);
extern WINSCARDAPI LONG WINAPI SCardIntroduceReaderW(_In_ SCARDCONTEXT hContext,
...
extern WINSCARDAPI LONG WINAPI SCardForgetReaderA(_In_ SCARDCONTEXT hContext,
                                                  _In_ LPCSTR szReaderName);
extern WINSCARDAPI LONG WINAPI SCardForgetReaderW(_In_ SCARDCONTEXT hContext,
                                                  _In_ LPCWSTR szReaderName);
#ifdef UNICODE
...
extern WINSCARDAPI
    LONG WINAPI SCardAddReaderToGroupA(_In_ SCARDCONTEXT hContext,
                                       _In_ LPCSTR szReaderName,
                                       _In_ LPCSTR szGroupName);
extern WINSCARDAPI LONG WINAPI
SCardAddReaderToGroupW(_In_ SCARDCONTEXT hContext, _In_ LPCWSTR szReaderName,
...
extern WINSCARDAPI
    LONG WINAPI SCardRemoveReaderFromGroupA(_In_ SCARDCONTEXT hContext,
                                            _In_ LPCSTR szReaderName,
                                            _In_ LPCSTR szGroupName);
extern WINSCARDAPI LONG WINAPI SCardRemoveReaderFromGroupW(
    _In_ SCARDCONTEXT hContext, _In_ LPCWSTR szReaderName,
    _In_ LPCWSTR szGroupName);
#ifdef UNICODE
...
extern WINSCARDAPI LONG WINAPI SCardIntroduceCardTypeA(
    _In_ SCARDCONTEXT hContext, _In_ LPCSTR szCardName,
    _In_opt_ LPCGUID pguidPrimaryProvider, _In_opt_ LPCGUID rgguidInterfaces,
    _In_ DWORD dwInterfaceCount, _In_ LPCBYTE pbAtr, _In_ LPCBYTE pbAtrMask,
    _In_ DWORD cbAtrLen);
...
extern WINSCARDAPI LONG WINAPI SCardSetCardTypeProviderNameA(
    _In_ SCARDCONTEXT hContext, _In_ LPCSTR szCardName, _In_ DWORD dwProviderId,
    _In_ LPCSTR szProvider);
extern WINSCARDAPI LONG WINAPI SCardSetCardTypeProviderNameW(
    _In_ SCARDCONTEXT hContext, _In_ LPCWSTR szCardName,
    _In_ DWORD dwProviderId, _In_ LPCWSTR szProvider);
#ifdef UNICODE
...
extern WINSCARDAPI LONG WINAPI SCardForgetCardTypeA(_In_ SCARDCONTEXT hContext,
                                                    _In_ LPCSTR szCardName);
extern WINSCARDAPI LONG WINAPI SCardForgetCardTypeW(_In_ SCARDCONTEXT hContext,
...
extern WINSCARDAPI LONG WINAPI SCardFreeMemory(_In_ SCARDCONTEXT hContext,
                                               _In_ LPCVOID pvMem);
...
extern WINSCARDAPI LONG WINAPI SCardLocateCardsA(
    _In_ SCARDCONTEXT hContext, _In_ LPCSTR mszCards,
    _Inout_ LPSCARD_READERSTATEA rgReaderStates, _In_ DWORD cReaders);
extern WINSCARDAPI LONG WINAPI SCardLocateCardsW(
    _In_ SCARDCONTEXT hContext, _In_ LPCWSTR mszCards,
    _Inout_ LPSCARD_READERSTATEW rgReaderStates, _In_ DWORD cReaders);
#ifdef UNICODE
...
extern WINSCARDAPI LONG WINAPI SCardLocateCardsByATRA(
    _In_ SCARDCONTEXT hContext, _In_ LPSCARD_ATRMASK rgAtrMasks,
    _In_ DWORD cAtrs, _Inout_ LPSCARD_READERSTATEA rgReaderStates,
    _In_ DWORD cReaders);
extern WINSCARDAPI LONG WINAPI SCardLocateCardsByATRW(
    _In_ SCARDCONTEXT hContext, _In_ LPSCARD_ATRMASK rgAtrMasks,
    _In_ DWORD cAtrs, _Inout_ LPSCARD_READERSTATEW rgReaderStates,
    _In_ DWORD cReaders);
#ifdef UNICODE
...
extern WINSCARDAPI LONG WINAPI SCardGetStatusChangeA(
    _In_ SCARDCONTEXT hContext, _In_ DWORD dwTimeout,
    _Inout_ LPSCARD_READERSTATEA rgReaderStates, _In_ DWORD cReaders);
...
extern WINSCARDAPI LONG WINAPI SCardCancel(_In_ SCARDCONTEXT hContext);
...
extern WINSCARDAPI LONG WINAPI SCardConnectA(_In_ SCARDCONTEXT hContext,
                                             _In_ LPCSTR szReader,
                                             _In_ DWORD dwShareMode,
                                             _In_ DWORD dwPreferredProtocols,
                                             _Out_ LPSCARDHANDLE phCard,
                                             _Out_ LPDWORD pdwActiveProtocol);
extern WINSCARDAPI LONG WINAPI SCardConnectW(_In_ SCARDCONTEXT hContext,
...
extern WINSCARDAPI
    LONG WINAPI SCardReconnect(_In_ SCARDHANDLE hCard, _In_ DWORD dwShareMode,
                               _In_ DWORD dwPreferredProtocols,
                               _In_ DWORD dwInitialization,
                               _Out_opt_ LPDWORD pdwActiveProtocol);

extern WINSCARDAPI LONG WINAPI SCardDisconnect(_In_ SCARDHANDLE hCard,
                                               _In_ DWORD dwDisposition);

extern WINSCARDAPI LONG WINAPI SCardBeginTransaction(_In_ SCARDHANDLE hCard);

extern WINSCARDAPI LONG WINAPI SCardEndTransaction(_In_ SCARDHANDLE hCard,
                                                   _In_ DWORD dwDisposition);

extern WINSCARDAPI LONG WINAPI SCardCancelTransaction(_In_ SCARDHANDLE hCard);
//
...
extern WINSCARDAPI LONG WINAPI SCardState(
    _In_ SCARDHANDLE hCard, _Out_ LPDWORD pdwState, _Out_ LPDWORD pdwProtocol,
    _Out_writes_bytes_(*pcbAtrLen) LPBYTE pbAtr, _Inout_ LPDWORD pcbAtrLen);
//
...
extern WINSCARDAPI LONG WINAPI SCardStatusA(
    ...
    _When_(_Old_(*pcchReaderLen) == SCARD_AUTOALLOCATE,
           _At_((LPSTR *)mszReaderNames,
                _Outptr_result_buffer_maybenull_(*pcchReaderLen)
                    _At_(*_Curr_, _Post_z_ _Post_ _NullNull_terminated_)))
        _When_(_Old_(*pcchReaderLen) != SCARD_AUTOALLOCATE,
               _Out_writes_opt_(*pcchReaderLen) _Post_ _NullNull_terminated_)
            LPSTR mszReaderNames,
    _Inout_opt_ LPDWORD pcchReaderLen, _Out_opt_ LPDWORD pdwState,
    _Out_opt_ LPDWORD pdwProtocol,
    _When_(_Old_(*pcbAtrLen) == SCARD_AUTOALLOCATE,
           _At_((LPBYTE *)pbAtr,
                _Outptr_result_buffer_maybenull_(*pcbAtrLen)
                    _At_(*_Curr_, _Post_ _NullNull_terminated_)))
        _When_(_Old_(*pcbAtrLen) != SCARD_AUTOALLOCATE,
               _Out_writes_opt_(*pcbAtrLen) _Post_ _NullNull_terminated_)
            LPBYTE pbAtr,
    _Inout_opt_ LPDWORD pcbAtrLen);
extern WINSCARDAPI LONG WINAPI SCardStatusW(
    _In_ SCARDHANDLE hCard,
    _When_(_Old_(*pcchReaderLen) == SCARD_AUTOALLOCATE,
           _At_((LPWSTR *)mszReaderNames,
                _Outptr_result_buffer_maybenull_(*pcchReaderLen)
                    _At_(*_Curr_, _Post_z_ _Post_ _NullNull_terminated_)))
        _When_(_Old_(*pcchReaderLen) != SCARD_AUTOALLOCATE,
               _Out_writes_opt_(*pcchReaderLen) _Post_ _NullNull_terminated_)
...
extern WINSCARDAPI LONG WINAPI SCardTransmit(
    _In_ SCARDHANDLE hCard, _In_ LPCSCARD_IO_REQUEST pioSendPci,
    _In_reads_bytes_(cbSendLength) LPCBYTE pbSendBuffer,
    _In_ DWORD cbSendLength, _Inout_opt_ LPSCARD_IO_REQUEST pioRecvPci,
    _Out_writes_bytes_(*pcbRecvLength) LPBYTE pbRecvBuffer,
    _Inout_ LPDWORD pcbRecvLength);

#if (NTDDI_VERSION >= NTDDI_VISTA)
extern WINSCARDAPI LONG WINAPI
SCardGetTransmitCount(_In_ SCARDHANDLE hCard, _Out_ LPDWORD pcTransmitCount);
...
extern WINSCARDAPI LONG WINAPI
SCardControl(_In_ SCARDHANDLE hCard, _In_ DWORD dwControlCode,
             ...
             _In_ DWORD cbOutBufferSize, _Out_ LPDWORD lpBytesReturned);

extern WINSCARDAPI LONG WINAPI
SCardGetAttrib(_In_ SCARDHANDLE hCard, _In_ DWORD dwAttrId,
...
extern WINSCARDAPI LONG WINAPI SCardSetAttrib(_In_ SCARDHANDLE hCard,
                                              _In_ DWORD dwAttrId,
                                              _In_reads_bytes_(cbAttrLen)
                                                  LPCBYTE pbAttr,
...
typedef SCARDHANDLE(WINAPI *LPOCNCONNPROCA)(_In_ SCARDCONTEXT, _In_ LPSTR,
                                            _In_ LPSTR, _In_ PVOID);
typedef SCARDHANDLE(WINAPI *LPOCNCONNPROCW)(_In_ SCARDCONTEXT, _In_ LPWSTR,
...
#endif // !UNICODE
typedef BOOL(WINAPI *LPOCNCHKPROC)(_In_ SCARDCONTEXT, _In_ SCARDHANDLE,
                                   _In_ PVOID);
typedef void(WINAPI *LPOCNDSCPROC)(_In_ SCARDCONTEXT, _In_ SCARDHANDLE,
                                   _In_ PVOID);
...
typedef struct {
  ...
  LPCSTR lpstrSearchDesc; // OPTIONAL (eg. "Please insert your <brandname> smart
                          // card.")
...
typedef struct {
  ...
  LPCWSTR lpstrSearchDesc;    // OPTIONAL (eg. "Please insert your <brandname>
                              // smart card.")
  HICON hIcon;                // OPTIONAL 32x32 icon for your brand insignia
...
//
// Only UNICODE is supported. Invoke smart card reader selection provider by
// calling CredUIPromptForWindowsCredentials() supplying
// SCARD_READER_SEL_AUTH_PACKAGE as pulAuthPackage, an instance of
// READER_SEL_REQUEST as pvInAuthBuffer and setting CREDUIWIN_AUTHPACKAGE_ONLY
// in dwFlags. Upon successful return, an instance of READER_SEL_RESPONSE will
// be returned in ppvOutAuthBuffer.
//
...
//
// MatchType:
//     Indicates how the caller wants the reader selection provider to verify
//     smart cards.
//
//     If MatchType is set to RSR_MATCH_TYPE_READER_AND_CONTAINER, reader
//     selection provider will match smart cards based on whether they are in
//     the given reader and have the given key container. Reader name and
//     container name are both optional. Reader name and container name, if any,
//     need to be appended after READER_SEL_REQUEST structure and set their
//     offsets and lengths in ReaderAndContainerParameter member.
//
...
//     Serial number is required. It needs to be appended after
//     READER_SEL_REQUEST structure as a byte array and set its offset and
//     length in SerialNumberParameter member.
//
//     If MatchType is set to RSR_MATCH_TYPE_ALL_CARDS, reader selection
//     provider will allow all recognized cards to be selected by user without
//     any filtering. The card may not be personalized for Base CSP / Smart Card
//     KSP yet, or even have its own CSP.
//
...
//     Number of characters in reader name UNICODE string including the
...
//     (Valid flags include CRYPT_NEWKEYSET, CRYPT_DELETEKEYSET,
//     CRYPT_VERIFYCONTEXT and CRYPT_DEFAULT_CONTAINER_OPTIONAL)
//
...
extern WINSCARDAPI LONG WINAPI
SCardReadCacheA(_In_ SCARDCONTEXT hContext, _In_ UUID *CardIdentifier,
                _In_ DWORD FreshnessCounter, _In_ LPSTR LookupName,
                _Out_writes_bytes_(*DataLen) PBYTE Data, _Out_ DWORD *DataLen);
extern WINSCARDAPI LONG WINAPI
SCardReadCacheW(_In_ SCARDCONTEXT hContext, _In_ UUID *CardIdentifier,
                _In_ DWORD FreshnessCounter, _In_ LPWSTR LookupName,
                _Out_writes_bytes_(*DataLen) PBYTE Data, _Out_ DWORD *DataLen);
#ifdef UNICODE
...
extern WINSCARDAPI LONG WINAPI
SCardWriteCacheA(_In_ SCARDCONTEXT hContext, _In_ UUID *CardIdentifier,
                 _In_ DWORD FreshnessCounter, _In_ LPSTR LookupName,
                 _In_reads_bytes_(DataLen) PBYTE Data, _In_ DWORD DataLen);
extern WINSCARDAPI LONG WINAPI
SCardWriteCacheW(_In_ SCARDCONTEXT hContext, _In_ UUID *CardIdentifier,
                 _In_ DWORD FreshnessCounter, _In_ LPWSTR LookupName,
                 _In_reads_bytes_(DataLen) PBYTE Data, _In_ DWORD DataLen);
#ifdef UNICODE
...
_Success_(return == SCARD_S_SUCCESS) extern WINSCARDAPI LONG WINAPI
    SCardGetReaderIconA(
        _In_ SCARDCONTEXT hContext, _In_ LPCSTR szReaderName,
        _When_(_Old_(*pcbIcon) == SCARD_AUTOALLOCATE,
               _At_((LPBYTE *)pbIcon,
                    _Outptr_result_bytebuffer_all_maybenull_(*pcbIcon)))
            _When_(_Old_(*pcbIcon) != SCARD_AUTOALLOCATE,
                   _Out_writes_bytes_to_(*pcbIcon, *pcbIcon) _Post_z_)
                LPBYTE pbIcon,
...
_Success_(return == SCARD_S_SUCCESS) extern WINSCARDAPI LONG WINAPI
    SCardGetDeviceTypeIdA(_In_ SCARDCONTEXT hContext, _In_ LPCSTR szReaderName,
                          _Inout_ LPDWORD pdwDeviceTypeId);
_Success_(return == SCARD_S_SUCCESS) extern WINSCARDAPI LONG WINAPI
    SCardGetDeviceTypeIdW(_In_ SCARDCONTEXT hContext, _In_ LPCWSTR szReaderName,
                          _Inout_ LPDWORD pdwDeviceTypeId);
#ifdef UNICODE
...
_Success_(return == SCARD_S_SUCCESS) extern WINSCARDAPI LONG WINAPI
    SCardGetReaderDeviceInstanceIdA(
        _In_ SCARDCONTEXT hContext, _In_ LPCSTR szReaderName,
        _When_(_Old_(*pcchDeviceInstanceId) == SCARD_AUTOALLOCATE,
               _At_((LPSTR *)szDeviceInstanceId,
                    _Outptr_result_buffer_maybenull_(*pcchDeviceInstanceId)
                        _At_(*_Curr_, _Post_z_ _Post_ _NullNull_terminated_)))
            _When_(_Old_(*pcchDeviceInstanceId) != SCARD_AUTOALLOCATE,
                   _Out_writes_opt_(*pcchDeviceInstanceId)
                       _Post_ _NullNull_terminated_) LPSTR szDeviceInstanceId,
        _Inout_ LPDWORD pcchDeviceInstanceId);
_Success_(return == SCARD_S_SUCCESS) extern WINSCARDAPI LONG WINAPI
    SCardGetReaderDeviceInstanceIdW(
        _In_ SCARDCONTEXT hContext, _In_ LPCWSTR szReaderName,
        _When_(_Old_(*pcchDeviceInstanceId) == SCARD_AUTOALLOCATE,
               _At_((LPWSTR *)szDeviceInstanceId,
                    _Outptr_result_buffer_maybenull_(*pcchDeviceInstanceId)
                        _At_(*_Curr_, _Post_z_ _Post_ _NullNull_terminated_)))
            _When_(_Old_(*pcchDeviceInstanceId) != SCARD_AUTOALLOCATE,
                   _Out_writes_opt_(*pcchDeviceInstanceId)
                       _Post_ _NullNull_terminated_) LPWSTR szDeviceInstanceId,
        _Inout_ LPDWORD pcchDeviceInstanceId);
#ifdef UNICODE
...
_Success_(return == SCARD_S_SUCCESS) extern WINSCARDAPI LONG WINAPI
    SCardListReadersWithDeviceInstanceIdA(
        _In_ SCARDCONTEXT hContext, _In_ LPCSTR szDeviceInstanceId,
        _When_(_Old_(*pcchReaders) == SCARD_AUTOALLOCATE,
               _At_((LPSTR *)mszReaders,
                    _Outptr_result_buffer_maybenull_(*pcchReaders)
                        _At_(*_Curr_, _Post_z_ _Post_ _NullNull_terminated_)))
...
_Success_(return == SCARD_S_SUCCESS) extern WINSCARDAPI LONG WINAPI
    SCardListReadersWithDeviceInstanceIdW(
        _In_ SCARDCONTEXT hContext, _In_ LPCWSTR szDeviceInstanceId,
        _When_(_Old_(*pcchReaders) == SCARD_AUTOALLOCATE,
               _At_((LPWSTR *)mszReaders,
                    _Outptr_result_buffer_maybenull_(*pcchReaders)
                        _At_(*_Curr_, _Post_z_ _Post_ _NullNull_terminated_)))
        ...
        _Inout_ LPDWORD pcchReaders);
#ifdef UNICODE
#define SCardListReadersWithDeviceInstanceId                                   \
  SCardListReadersWithDeviceInstanceIdW
#else
#define SCardListReadersWithDeviceInstanceId                                   \
  SCardListReadersWithDeviceInstanceIdA
...
#define SCARD_AUDIT_CHV_FAILURE                                                \
  0x0 // A smart card holder verification (CHV)
      // attempt failed.

#define SCARD_AUDIT_CHV_SUCCESS                                                \
  0x1 // A smart card holder verification (CHV)
      // attempt succeeded.

_Success_(return == SCARD_S_SUCCESS) extern WINSCARDAPI LONG WINAPI
    SCardAudit(_In_ SCARDCONTEXT hContext, _In_ DWORD dwEvent);
