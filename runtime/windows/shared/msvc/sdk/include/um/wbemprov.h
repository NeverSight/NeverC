...
typedef struct IWbemPropertyProviderVtbl {
  ...
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IWbemPropertyProvider *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IWbemPropertyProvider *This);
...
public:
  virtual HRESULT STDMETHODCALLTYPE IndicateToConsumer(
      ...
      /* [in] */ long lNumObjects,
      /* [size_is][in] */
      __RPC__in_ecount_full(lNumObjects) IWbemClassObject **apObjects) = 0;
};
...
typedef struct IWbemUnboundObjectSinkVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IWbemUnboundObjectSink *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IWbemUnboundObjectSink *This);
...
typedef struct IWbemEventProviderVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in IWbemEventProvider *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IWbemEventProvider *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IWbemEventProvider *This);
...
typedef struct IWbemEventProviderQuerySinkVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IWbemEventProviderQuerySink *This);
...
public:
  virtual HRESULT STDMETHODCALLTYPE AccessCheck(
      ...
      /* [in] */ long lSidLength,
      /* [unique][size_is][in] */
      __RPC__in_ecount_full_opt(lSidLength) const BYTE *pSid) = 0;
};
...
typedef struct IWbemEventProviderSecurityVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IWbemEventProviderSecurity *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IWbemEventProviderSecurity *This);
...
public:
  virtual HRESULT STDMETHODCALLTYPE FindConsumer(
      /* [in] */ __RPC__in_opt IWbemClassObject * pLogicalConsumer,
      /* [out] */ __RPC__deref_out_opt IWbemUnboundObjectSink *
          *ppConsumer) = 0;
};
...
typedef struct IWbemEventConsumerProviderVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IWbemEventConsumerProvider *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IWbemEventConsumerProvider *This);
...
typedef struct IWbemProviderInitSinkVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IWbemProviderInitSink *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IWbemProviderInitSink *This);

  DECLSPEC_XFGVIRT(IWbemProviderInitSink, SetStatus)
  HRESULT(STDMETHODCALLTYPE *SetStatus)(__RPC__in IWbemProviderInitSink *This,
                                        /* [in] */ LONG lStatus,
                                        /* [in] */ LONG lFlags);
...
typedef struct IWbemProviderInitVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in IWbemProviderInit *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IWbemProviderInit *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IWbemProviderInit *This);
...
typedef struct IWbemProviderIdentityVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IWbemProviderIdentity *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IWbemProviderIdentity *This);
...
typedef struct IWbemEventSinkVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in IWbemEventSink *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IWbemEventSink *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IWbemEventSink *This);

  DECLSPEC_XFGVIRT(IWbemObjectSink, Indicate)
  HRESULT(STDMETHODCALLTYPE *Indicate)(__RPC__in IWbemEventSink *This,
  ...
  HRESULT(STDMETHODCALLTYPE *IsActive)(__RPC__in IWbemEventSink *This);
...
interface IWbemEventSink { CONST_VTBL struct IWbemEventSinkVtbl *lpVtbl; };
...
#define IWbemEventSink_GetRestrictedSink(This, lNumQueries, awszQueries,       \
                                         pCallback, ppSink)                    \
  ((This)->lpVtbl->GetRestrictedSink(This, lNumQueries, awszQueries,           \
                                     pCallback, ppSink))
