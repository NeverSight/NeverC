...
//
// The ADO interfaces were originally platform-dependent and not script
// friendly. ADO interface IID's are reguided in this header file. Therefore,
// newly-compiled applications may not run on downlevel OSes, since the new
// interface IID's are not available on downlevel OSes. To avoid this
// compatibility issue, customers can either: (1) install the KB983246 on all
// downlevel OSes (2) Change your target platform to Win7 or below. This will
// use back the IID defined in Win7 SDK and
...
typedef /* [uuid][helpcontext][public] */ DECLSPEC_UUID(
...
typedef /* [uuid][helpcontext] */ DECLSPEC_UUID(
...
typedef /* [helpcontext][uuid] */ DECLSPEC_UUID(
...
typedef /* [helpcontext][uuid] */ DECLSPEC_UUID(
    "00000543-0000-0010-8000-00AA006D2EA4") enum AffectEnum {
  adAffectCurrent = 1,
  adAffectGroup = 2,
  adAffectAll = 3,
...
typedef /* [helpcontext][uuid] */ DECLSPEC_UUID(
    "00000544-0000-0010-8000-00AA006D2EA4") enum ResyncEnum {
  adResyncUnderlyingValues = 1,
  adResyncAllValues = 2
} ResyncEnum;
typedef /* [helpcontext][uuid] */ DECLSPEC_UUID(
    "00000545-0000-0010-8000-00AA006D2EA4") enum CompareEnum {
  adCompareLessThan = 0,
  adCompareEqual = 1,
...
typedef /* [helpcontext][uuid] */ DECLSPEC_UUID(
    "00000533-0000-0010-8000-00AA006D2EA4") enum SchemaEnum {
...
typedef /* [helpcontext][uuid] */ DECLSPEC_UUID(
    "00000552-0000-0010-8000-00AA006D2EA4") enum SeekEnum {
  adSeekFirstEQ = 0x1,
  adSeekLastEQ = 0x2,
  adSeekAfterEQ = 0x4,
  adSeekAfter = 0x8,
...
typedef struct _ADOCollectionVtbl {
  ...
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in _ADOCollection *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in _ADOCollection *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in _ADOCollection *This);
...
typedef struct _ADODynaCollectionVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in _ADODynaCollection *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in _ADODynaCollection *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in _ADODynaCollection *This);
...
public:
  virtual /* [helpcontext][id][propget] */ HRESULT STDMETHODCALLTYPE
      get_Properties(
          /* [retval][out] */ __RPC__deref_out_opt ADOProperties *
          *ppvObject) = 0;
};
...
typedef struct _ADOVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in _ADO *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in _ADO *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in _ADO *This);
...
public:
  ...
  virtual /* [helpcontext][propget][id] */ HRESULT STDMETHODCALLTYPE
      get_Description(
          /* [retval][out] */ __RPC__deref_out_opt BSTR * pbstr) = 0;
...
typedef struct ErrorVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in ADOError *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in ADOError *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in ADOError *This);
...
typedef struct ErrorsVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in ADOErrors *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in ADOErrors *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in ADOErrors *This);
...
public:
  virtual /* [helpcontext][propget][id] */ HRESULT STDMETHODCALLTYPE
      get_ActiveConnection(
          /* [retval][out] */ __RPC__deref_out_opt _ADOConnection *
          *ppvObject) = 0;

  virtual /* [helpcontext][propputref][id] */ HRESULT STDMETHODCALLTYPE
      putref_ActiveConnection(
          /* [in] */ __RPC__in_opt _ADOConnection * pCon) = 0;

  virtual /* [helpcontext][propput][id] */ HRESULT STDMETHODCALLTYPE
  ...
  virtual /* [helpcontext][propget][id] */ HRESULT STDMETHODCALLTYPE
      get_Parameters(
          /* [retval][out] */ __RPC__deref_out_opt ADOParameters *
          *ppvObject) = 0;
...
typedef struct Command15Vtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in Command15 *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in Command15 *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in Command15 *This);
  ...
  /* [helpcontext][propget][id] */ HRESULT(
      STDMETHODCALLTYPE *get_ActiveConnection)(
      __RPC__in Command15 *This,
      /* [retval][out] */ __RPC__deref_out_opt _ADOConnection **ppvObject);

  DECLSPEC_XFGVIRT(Command15, putref_ActiveConnection)
  /* [helpcontext][propputref][id] */ HRESULT(
      STDMETHODCALLTYPE *putref_ActiveADOConnection)(
      __RPC__in Command15 *This,
      /* [in] */ __RPC__in_opt _ADOConnection *pCon);

  DECLSPEC_XFGVIRT(Command15, put_ActiveConnection)
  /* [helpcontext][propput][id] */ HRESULT(
      STDMETHODCALLTYPE *put_ActiveConnection)(__RPC__in Command15 *This,
                                               /* [in] */ VARIANT vConn);
  ...
  /* [helpcontext][propget][id] */ HRESULT(
      STDMETHODCALLTYPE *get_CommandTimeout)(
      __RPC__in Command15 *This,
      /* [retval][out] */ __RPC__out LONG *pl);

  DECLSPEC_XFGVIRT(Command15, put_CommandTimeout)
  /* [helpcontext][propput][id] */ HRESULT(
      STDMETHODCALLTYPE *put_CommandTimeout)(__RPC__in Command15 *This,
                                             /* [in] */ LONG Timeout);
...
typedef struct Command25Vtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in Command25 *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in Command25 *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in Command25 *This);
  ...
  DECLSPEC_XFGVIRT(Command15, put_ActiveConnection)
  /* [helpcontext][propput][id] */ HRESULT(
      STDMETHODCALLTYPE *put_ActiveConnection)(__RPC__in Command25 *This,
                                               /* [in] */ VARIANT vConn);
  ...
  DECLSPEC_XFGVIRT(Command15, put_CommandTimeout)
  /* [helpcontext][propput][id] */ HRESULT(
      STDMETHODCALLTYPE *put_CommandTimeout)(__RPC__in Command25 *This,
                                             /* [in] */ LONG Timeout);
...
public:
  virtual /* [helpcontext][propputref][id] */ HRESULT __stdcall
  putref_CommandStream(
  ...
  virtual /* [helpcontext][propput][id] */ HRESULT __stdcall
  put_NamedParameters(
      /* [in] */ VARIANT_BOOL fNamedParameters) = 0;

  virtual /* [helpcontext][propget][id] */ HRESULT __stdcall
  get_NamedParameters(
...
typedef struct _CommandVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in _ADOCommand *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in _ADOCommand *This);
  ...
  DECLSPEC_XFGVIRT(Command15, put_ActiveConnection)
  /* [helpcontext][propput][id] */ HRESULT(
      STDMETHODCALLTYPE *put_ActiveConnection)(__RPC__in _ADOCommand *This,
                                               /* [in] */ VARIANT vConn);
  ...
  DECLSPEC_XFGVIRT(Command15, put_CommandTimeout)
  /* [helpcontext][propput][id] */ HRESULT(
      STDMETHODCALLTYPE *put_CommandTimeout)(__RPC__in _ADOCommand *This,
                                             /* [in] */ LONG Timeout);
  ...
  /* [helpcontext][propputref][id] */ HRESULT(
      __stdcall *putref_CommandADOStream)(
      __RPC__in _ADOCommand *This,
...
public:
  ...
  virtual /* [helpcontext][id] */ HRESULT STDMETHODCALLTYPE
...
typedef struct ConnectionEventsVtVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in ConnectionEventsVt *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in ConnectionEventsVt *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in ConnectionEventsVt *This);
...
typedef struct RecordsetEventsVtVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in RecordsetEventsVt *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in RecordsetEventsVt *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in RecordsetEventsVt *This);
...
typedef struct ConnectionEventsVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in ConnectionEvents *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in ConnectionEvents *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in ConnectionEvents *This);
...
typedef struct RecordsetEventsVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in RecordsetEvents *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in RecordsetEvents *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in RecordsetEvents *This);
...
public:
  ...
  virtual /* [helpcontext][id][propput] */ HRESULT STDMETHODCALLTYPE
  ...
  virtual /* [helpcontext][id] */ HRESULT STDMETHODCALLTYPE CommitTrans(
      void) = 0;

  virtual /* [helpcontext][id] */ HRESULT STDMETHODCALLTYPE RollbackTrans(
      void) = 0;
...
typedef struct Connection15Vtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in Connection15 *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in Connection15 *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in Connection15 *This);
  ...
  /* [helpcontext][id][propget] */ HRESULT(
      STDMETHODCALLTYPE *get_ConnectionString)(
      __RPC__in Connection15 *This,
      /* [retval][out] */ __RPC__deref_out_opt BSTR *pbstr);

  DECLSPEC_XFGVIRT(Connection15, put_ConnectionString)
  /* [helpcontext][id][propput] */ HRESULT(
      STDMETHODCALLTYPE *put_ConnectionString)(__RPC__in Connection15 *This,
                                               /* [in] */ __RPC__in BSTR bstr);
  ...
  /* [helpcontext][id][propput] */ HRESULT(
      STDMETHODCALLTYPE *put_CommandTimeout)(__RPC__in Connection15 *This,
                                             /* [in] */ LONG lTimeout);

  DECLSPEC_XFGVIRT(Connection15, get_ConnectionTimeout)
  /* [helpcontext][id][propget] */ HRESULT(
      STDMETHODCALLTYPE *get_ConnectionTimeout)(
      __RPC__in Connection15 *This,
      /* [retval][out] */ __RPC__out LONG *plTimeout);

  DECLSPEC_XFGVIRT(Connection15, put_ConnectionTimeout)
  /* [helpcontext][id][propput] */ HRESULT(
      STDMETHODCALLTYPE *put_ConnectionTimeout)(__RPC__in Connection15 *This,
                                                /* [in] */ LONG lTimeout);
  ...
  /* [helpcontext][propput][id] */ HRESULT(
      STDMETHODCALLTYPE *put_CursorLocation)(
      __RPC__in Connection15 *This,
...
typedef struct _ConnectionVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in _ADOConnection *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in _ADOConnection *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in _ADOConnection *This);
  ...
  DECLSPEC_XFGVIRT(Connection15, put_ConnectionString)
  /* [helpcontext][id][propput] */ HRESULT(
      STDMETHODCALLTYPE *put_ConnectionString)(__RPC__in _ADOConnection *This,
                                               /* [in] */ __RPC__in BSTR bstr);
  ...
  DECLSPEC_XFGVIRT(Connection15, put_CommandTimeout)
  /* [helpcontext][id][propput] */ HRESULT(
      STDMETHODCALLTYPE *put_CommandTimeout)(__RPC__in _ADOConnection *This,
                                             /* [in] */ LONG lTimeout);
  ...
  DECLSPEC_XFGVIRT(Connection15, put_ConnectionTimeout)
  /* [helpcontext][id][propput] */ HRESULT(
      STDMETHODCALLTYPE *put_ConnectionTimeout)(__RPC__in _ADOConnection *This,
                                                /* [in] */ LONG lTimeout);
  ...
  DECLSPEC_XFGVIRT(Connection15, put_DefaultDatabase)
  /* [helpcontext][id][propput] */ HRESULT(
      STDMETHODCALLTYPE *put_DefaultDatabase)(__RPC__in _ADOConnection *This,
                                              /* [in] */ __RPC__in BSTR bstr);
...
typedef struct ADOConnectionConstruction15Vtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in ADOConnectionConstruction15 *This);
...
typedef struct ADOConnectionConstructionVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in ADOConnectionConstruction *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in ADOConnectionConstruction *This);
...
typedef struct _RecordVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in _ADORecord *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in _ADORecord *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in _ADORecord *This);
  ...
  /* [helpcontext][propput][id] */ HRESULT(
      STDMETHODCALLTYPE *put_ActiveConnection)(__RPC__in _ADORecord *This,
                                               /* [in] */ __RPC__in BSTR
                                                   bstrConn);
...
typedef struct _StreamVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in _ADOStream *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in _ADOStream *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in _ADOStream *This);
...
typedef struct ADORecordConstructionVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in ADORecordConstruction *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in ADORecordConstruction *This);
...
typedef struct ADOStreamConstructionVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in ADOStreamConstruction *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in ADOStreamConstruction *This);
...
typedef struct ADOCommandConstructionVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in ADOCommandConstruction *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in ADOCommandConstruction *This);
...
public:
  ...
  virtual /* [helpcontext][id] */ HRESULT STDMETHODCALLTYPE CancelUpdate(
      void) = 0;
  ...
  virtual /* [helpcontext][id] */ HRESULT STDMETHODCALLTYPE MovePrevious(
      void) = 0;
...
typedef struct Recordset15Vtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in Recordset15 *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in Recordset15 *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in Recordset15 *This);
  ...
  /* [helpcontext][propput][id] */ HRESULT(
      STDMETHODCALLTYPE *put_ActiveConnection)(__RPC__in Recordset15 *This,
                                               /* [in] */ VARIANT vConn);
...
typedef struct Recordset20Vtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in Recordset20 *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in Recordset20 *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in Recordset20 *This);
  ...
  DECLSPEC_XFGVIRT(Recordset15, put_ActiveConnection)
  /* [helpcontext][propput][id] */ HRESULT(
      STDMETHODCALLTYPE *put_ActiveConnection)(__RPC__in Recordset20 *This,
                                               /* [in] */ VARIANT vConn);
  ...
  /* [helpcontext][propputref][id] */ HRESULT(
      STDMETHODCALLTYPE *putref_DataSource)(
      __RPC__in Recordset20 *This,
  ...
  /* [helpcontext][propget][id] */ HRESULT(
      STDMETHODCALLTYPE *get_ActiveCommand)(
      __RPC__in Recordset20 *This,
...
typedef struct Recordset21Vtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in Recordset21 *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in Recordset21 *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in Recordset21 *This);
  ...
  DECLSPEC_XFGVIRT(Recordset15, put_ActiveConnection)
  /* [helpcontext][propput][id] */ HRESULT(
      STDMETHODCALLTYPE *put_ActiveConnection)(__RPC__in Recordset21 *This,
                                               /* [in] */ VARIANT vConn);
...
typedef struct _RecordsetVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in _ADORecordset *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in _ADORecordset *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in _ADORecordset *This);
  ...
  DECLSPEC_XFGVIRT(Recordset15, put_ActiveConnection)
  /* [helpcontext][propput][id] */ HRESULT(
      STDMETHODCALLTYPE *put_ActiveConnection)(__RPC__in _ADORecordset *This,
                                               /* [in] */ VARIANT vConn);
...
typedef struct ADORecordsetConstructionVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in ADORecordsetConstruction *This);
...
typedef struct Field15Vtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in Field15 *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in Field15 *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in Field15 *This);
  ...
  /* [helpcontext][propget][id] */ HRESULT(
      STDMETHODCALLTYPE *get_OriginalValue)(
      __RPC__in Field15 *This,
      /* [retval][out] */ __RPC__out VARIANT *pvar);
...
typedef struct Field20Vtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in Field20 *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in Field20 *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in Field20 *This);
...
typedef struct FieldVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in ADOField *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in ADOField *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in ADOField *This);
...
typedef struct Fields15Vtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in Fields15 *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in Fields15 *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in Fields15 *This);
...
typedef struct Fields20Vtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in Fields20 *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in Fields20 *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in Fields20 *This);
...
typedef struct FieldsVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in ADOFields *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in ADOFields *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in ADOFields *This);
...
public:
  ...
  virtual /* [helpcontext][propget][id] */ HRESULT STDMETHODCALLTYPE
      get_Direction(
          /* [retval][out] */ __RPC__out ParameterDirectionEnum *
          plParmDirection) = 0;
...
typedef struct _ParameterVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in _ADOParameter *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in _ADOParameter *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in _ADOParameter *This);
...
typedef struct ParametersVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in ADOParameters *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in ADOParameters *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in ADOParameters *This);
...
typedef struct PropertyVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in ADOProperty *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in ADOProperty *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in ADOProperty *This);
...
typedef struct PropertiesVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in ADOProperties *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in ADOProperties *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in ADOProperties *This);
