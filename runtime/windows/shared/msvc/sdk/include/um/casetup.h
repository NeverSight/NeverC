...
typedef interface ICertSrvSetupKeyInformationCollection
...
typedef interface ICertificateEnrollmentPolicyServerSetup
...
#ifdef __cplusplus
typedef class CCertificateEnrollmentServerSetup
    CCertificateEnrollmentServerSetup;
#else
typedef struct CCertificateEnrollmentServerSetup
    CCertificateEnrollmentServerSetup;
#endif /* __cplusplus */
...
#ifdef __cplusplus
typedef class CCertificateEnrollmentPolicyServerSetup
    CCertificateEnrollmentPolicyServerSetup;
#else
typedef struct CCertificateEnrollmentPolicyServerSetup
    CCertificateEnrollmentPolicyServerSetup;
#endif /* __cplusplus */
...
typedef struct ICertSrvSetupKeyInformationVtbl {
  ...
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in ICertSrvSetupKeyInformation *This);
  ...
  /* [helpstring][id][propget] */ HRESULT(
      STDMETHODCALLTYPE *get_ExistingCACertificate)(
      __RPC__in ICertSrvSetupKeyInformation *This,
  ...
  /* [helpstring][id][propput] */ HRESULT(
      STDMETHODCALLTYPE *put_ExistingCACertificate)(
      __RPC__in ICertSrvSetupKeyInformation *This,
      /* [in] */ VARIANT varVal);
...
#define ICertSrvSetupKeyInformation_GetIDsOfNames(This, riid, rgszNames,       \
                                                  cNames, lcid, rgDispId)      \
  ((This)->lpVtbl->GetIDsOfNames(This, riid, rgszNames, cNames, lcid, rgDispId))

#define ICertSrvSetupKeyInformation_Invoke(This, dispIdMember, riid, lcid,     \
...
public:
  ...
  virtual HRESULT STDMETHODCALLTYPE Add(
      /* [in] */ __RPC__in_opt ICertSrvSetupKeyInformation *
      pIKeyInformation) = 0;
};
...
#define ICertSrvSetupKeyInformationCollection_QueryInterface(This, riid,       \
                                                             ppvObject)        \
  ((This)->lpVtbl->QueryInterface(This, riid, ppvObject))
...
#define ICertSrvSetupKeyInformationCollection_GetTypeInfo(This, iTInfo, lcid,  \
                                                          ppTInfo)             \
  ((This)->lpVtbl->GetTypeInfo(This, iTInfo, lcid, ppTInfo))

#define ICertSrvSetupKeyInformationCollection_GetIDsOfNames(                   \
...
public:
  ...
  virtual HRESULT STDMETHODCALLTYPE GetExistingCACertificates(
      /* [retval][out] */
      __RPC__deref_out_opt ICertSrvSetupKeyInformationCollection * *ppVal) = 0;
  ...
  virtual HRESULT STDMETHODCALLTYPE CAImportPFX(
      ...
      /* [retval][out] */
      __RPC__deref_out_opt ICertSrvSetupKeyInformation **ppVal) = 0;
...
typedef struct ICertSrvSetupVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in ICertSrvSetup *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in ICertSrvSetup *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in ICertSrvSetup *This);
  ...
  HRESULT(STDMETHODCALLTYPE *Install)(__RPC__in ICertSrvSetup *This);

  DECLSPEC_XFGVIRT(ICertSrvSetup, PreUnInstall)
  HRESULT(STDMETHODCALLTYPE *PreUnInstall)(__RPC__in ICertSrvSetup *This,
                                           /* [in] */ VARIANT_BOOL bClientOnly);

  DECLSPEC_XFGVIRT(ICertSrvSetup, PostUnInstall)
  HRESULT(STDMETHODCALLTYPE *PostUnInstall)(__RPC__in ICertSrvSetup *This);

  END_INTERFACE
} ICertSrvSetupVtbl;

interface ICertSrvSetup { CONST_VTBL struct ICertSrvSetupVtbl *lpVtbl; };
...
#define ICertSrvSetup_GetIDsOfNames(This, riid, rgszNames, cNames, lcid,       \
                                    rgDispId)                                  \
  ((This)->lpVtbl->GetIDsOfNames(This, riid, rgszNames, cNames, lcid, rgDispId))

#define ICertSrvSetup_Invoke(This, dispIdMember, riid, lcid, wFlags,           \
...
#define ICertSrvSetup_CAImportPFX(This, bstrFileName, bstrPasswd,              \
                                  bOverwriteExistingKey, ppVal)                \
  ((This)->lpVtbl->CAImportPFX(This, bstrFileName, bstrPasswd,                 \
                               bOverwriteExistingKey, ppVal))

#define ICertSrvSetup_SetCADistinguishedName(This, bstrCADN, bIgnoreUnicode,   \
                                             bOverwriteExistingKey,            \
                                             bOverwriteExistingCAInDS)         \
  ((This)->lpVtbl->SetCADistinguishedName(This, bstrCADN, bIgnoreUnicode,      \
                                          bOverwriteExistingKey,               \
                                          bOverwriteExistingCAInDS))

#define ICertSrvSetup_SetDatabaseInformation(                                  \
    This, bstrDBDirectory, bstrLogDirectory, bstrSharedFolder,                 \
    bForceOverwrite)                                                           \
  ((This)->lpVtbl->SetDatabaseInformation(This, bstrDBDirectory,               \
                                          bstrLogDirectory, bstrSharedFolder,  \
                                          bForceOverwrite))
...
typedef struct IMSCEPSetupVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in IMSCEPSetup *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IMSCEPSetup *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IMSCEPSetup *This);
  ...
  /* [helpstring][id][propget] */ HRESULT(
      STDMETHODCALLTYPE *get_MSCEPErrorString)(
      __RPC__in IMSCEPSetup *This,
      /* [retval][out] */ __RPC__deref_out_opt BSTR *pVal);

  DECLSPEC_XFGVIRT(IMSCEPSetup, InitializeDefaults)
  HRESULT(STDMETHODCALLTYPE *InitializeDefaults)(__RPC__in IMSCEPSetup *This);
  ...
  HRESULT(STDMETHODCALLTYPE *Install)(__RPC__in IMSCEPSetup *This);

  DECLSPEC_XFGVIRT(IMSCEPSetup, PreUnInstall)
  HRESULT(STDMETHODCALLTYPE *PreUnInstall)(__RPC__in IMSCEPSetup *This);

  DECLSPEC_XFGVIRT(IMSCEPSetup, PostUnInstall)
  HRESULT(STDMETHODCALLTYPE *PostUnInstall)(__RPC__in IMSCEPSetup *This);

  END_INTERFACE
} IMSCEPSetupVtbl;

interface IMSCEPSetup { CONST_VTBL struct IMSCEPSetupVtbl *lpVtbl; };
...
#define IMSCEPSetup_GetIDsOfNames(This, riid, rgszNames, cNames, lcid,         \
                                  rgDispId)                                    \
  ((This)->lpVtbl->GetIDsOfNames(This, riid, rgszNames, cNames, lcid, rgDispId))

#define IMSCEPSetup_Invoke(This, dispIdMember, riid, lcid, wFlags,             \
                           pDispParams, pVarResult, pExcepInfo, puArgErr)      \
  ((This)->lpVtbl->Invoke(This, dispIdMember, riid, lcid, wFlags, pDispParams, \
                          pVarResult, pExcepInfo, puArgErr))
...
typedef struct ICertificateEnrollmentServerSetupVtbl {
  ...
  DECLSPEC_XFGVIRT(ICertificateEnrollmentServerSetup,
...
#define ICertificateEnrollmentServerSetup_QueryInterface(This, riid,           \
                                                         ppvObject)            \
  ((This)->lpVtbl->QueryInterface(This, riid, ppvObject))
...
#define ICertificateEnrollmentServerSetup_GetTypeInfo(This, iTInfo, lcid,      \
                                                      ppTInfo)                 \
  ((This)->lpVtbl->GetTypeInfo(This, iTInfo, lcid, ppTInfo))

#define ICertificateEnrollmentServerSetup_GetIDsOfNames(                       \
    This, riid, rgszNames, cNames, lcid, rgDispId)                             \
  ((This)->lpVtbl->GetIDsOfNames(This, riid, rgszNames, cNames, lcid, rgDispId))

#define ICertificateEnrollmentServerSetup_Invoke(                              \
    This, dispIdMember, riid, lcid, wFlags, pDispParams, pVarResult,           \
    pExcepInfo, puArgErr)                                                      \
  ((This)->lpVtbl->Invoke(This, dispIdMember, riid, lcid, wFlags, pDispParams, \
                          pVarResult, pExcepInfo, puArgErr))
...
#define ICertificateEnrollmentServerSetup_GetProperty(This, propertyId,        \
                                                      pPropertyValue)          \
  ((This)->lpVtbl->GetProperty(This, propertyId, pPropertyValue))

#define ICertificateEnrollmentServerSetup_SetProperty(This, propertyId,        \
                                                      pPropertyValue)          \
  ((This)->lpVtbl->SetProperty(This, propertyId, pPropertyValue))

#define ICertificateEnrollmentServerSetup_SetApplicationPoolCredentials(       \
    This, bstrUsername, bstrPassword)                                          \
  ((This)->lpVtbl->SetApplicationPoolCredentials(This, bstrUsername,           \
                                                 bstrPassword))

#define ICertificateEnrollmentServerSetup_Install(This)                        \
  ((This)->lpVtbl->Install(This))

#define ICertificateEnrollmentServerSetup_UnInstall(This, pCAConfig,           \
                                                    pAuthentication)           \
...
typedef struct ICertificateEnrollmentPolicyServerSetupVtbl {
  ...
  DECLSPEC_XFGVIRT(ICertificateEnrollmentPolicyServerSetup,
...
#define ICertificateEnrollmentPolicyServerSetup_QueryInterface(This, riid,     \
                                                               ppvObject)      \
  ((This)->lpVtbl->QueryInterface(This, riid, ppvObject))
...
#define ICertificateEnrollmentPolicyServerSetup_GetTypeInfoCount(This,         \
                                                                 pctinfo)      \
  ((This)->lpVtbl->GetTypeInfoCount(This, pctinfo))

#define ICertificateEnrollmentPolicyServerSetup_GetTypeInfo(This, iTInfo,      \
                                                            lcid, ppTInfo)     \
  ((This)->lpVtbl->GetTypeInfo(This, iTInfo, lcid, ppTInfo))

#define ICertificateEnrollmentPolicyServerSetup_GetIDsOfNames(                 \
    This, riid, rgszNames, cNames, lcid, rgDispId)                             \
  ((This)->lpVtbl->GetIDsOfNames(This, riid, rgszNames, cNames, lcid, rgDispId))
...
#define ICertificateEnrollmentPolicyServerSetup_InitializeInstallDefaults(     \
    This)                                                                      \
  ((This)->lpVtbl->InitializeInstallDefaults(This))

#define ICertificateEnrollmentPolicyServerSetup_GetProperty(This, propertyId,  \
                                                            pPropertyValue)    \
  ((This)->lpVtbl->GetProperty(This, propertyId, pPropertyValue))

#define ICertificateEnrollmentPolicyServerSetup_SetProperty(This, propertyId,  \
                                                            pPropertyValue)    \
  ((This)->lpVtbl->SetProperty(This, propertyId, pPropertyValue))
...
#define ICertificateEnrollmentPolicyServerSetup_UnInstall(                     \
    This, pAuthKeyBasedRenewal)                                                \
...
class DECLSPEC_UUID("961f180f-f55c-413d-a9b3-7d2af4d8e42f") CCertSrvSetup;
#endif
...
class DECLSPEC_UUID("aa4f5c02-8e7c-49c4-94fa-67a5cc5eadb4") CMSCEPSetup;
#endif
