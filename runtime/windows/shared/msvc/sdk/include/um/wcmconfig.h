...
typedef struct IItemEnumeratorVtbl {
  ...
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(IItemEnumerator *This,
                                             /* [in] */ REFIID riid,
  ...
  /* [helpstring] */ HRESULT(STDMETHODCALLTYPE *Reset)(IItemEnumerator *This);

  END_INTERFACE
} IItemEnumeratorVtbl;

interface IItemEnumerator { CONST_VTBL struct IItemEnumeratorVtbl *lpVtbl; };
...
typedef struct ISettingsIdentityVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(ISettingsIdentity *This,
                                             /* [in] */ REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);
...
typedef struct ITargetInfoVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(ITargetInfo *This,
                                             /* [in] */ REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);
...
interface ITargetInfo { CONST_VTBL struct ITargetInfoVtbl *lpVtbl; };
...
#define ITargetInfo_GetTargetProcessorArchitecture(This,                       \
                                                   ProcessorArchitecture)      \
  ((This)->lpVtbl->GetTargetProcessorArchitecture(This, ProcessorArchitecture))

#define ITargetInfo_SetTargetProcessorArchitecture(This,                       \
                                                   ProcessorArchitecture)      \
...
#define ITargetInfo_ExpandTargetPath(This, Offline, Location,                  \
                                     ExpandedLocation)                         \
...
#define ITargetInfo_TranslateWow64(This, ClientArchitecture, Value,            \
                                   TranslatedValue)                            \
  ((This)->lpVtbl->TranslateWow64(This, ClientArchitecture, Value,             \
                                  TranslatedValue))
...
typedef struct ISettingsEngineVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(ISettingsEngine *This,
                                             /* [in] */ REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);
...
interface ISettingsEngine { CONST_VTBL struct ISettingsEngineVtbl *lpVtbl; };
...
#define ISettingsEngine_GetNamespace(This, SettingsID, Access, Reserved,       \
                                     NamespaceItem)                            \
  ((This)->lpVtbl->GetNamespace(This, SettingsID, Access, Reserved,            \
                                NamespaceItem))
...
#define ISettingsEngine_RegisterNamespace(This, SettingsID, Stream,            \
                                          PushSettings, Results)               \
  ((This)->lpVtbl->RegisterNamespace(This, SettingsID, Stream, PushSettings,   \
                                     Results))
...
#define ISettingsEngine_CreateSettingsContext(This, Flags, Reserved,           \
                                              SettingsContext)                 \
  ((This)->lpVtbl->CreateSettingsContext(This, Flags, Reserved,                \
                                         SettingsContext))

#define ISettingsEngine_SetSettingsContext(This, SettingsContext)              \
  ((This)->lpVtbl->SetSettingsContext(This, SettingsContext))

#define ISettingsEngine_ApplySettingsContext(This, SettingsContext,            \
                                             pppwzIdentities, pcIdentities)    \
  ((This)->lpVtbl->ApplySettingsContext(This, SettingsContext,                 \
                                        pppwzIdentities, pcIdentities))
...
typedef struct ISettingsItemVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(ISettingsItem *This,
                                             /* [in] */ REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);
  ...
  HRESULT(STDMETHODCALLTYPE *SetValueRaw)(ISettingsItem *This,
                                          /* [in] */ LONG DataType,
                                          /* [size_is][in] */ const BYTE *Data,
                                          /* [in] */ ULONG DataSize);
...
interface ISettingsItem { CONST_VTBL struct ISettingsItemVtbl *lpVtbl; };
...
typedef struct ISettingsNamespaceVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(ISettingsNamespace *This,
                                             /* [in] */ REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);
...
typedef struct ISettingsResultVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(ISettingsResult *This,
                                             /* [in] */ REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);
...
interface ISettingsResult { CONST_VTBL struct ISettingsResultVtbl *lpVtbl; };
...
typedef struct ISettingsContextVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(ISettingsContext *This,
                                             /* [in] */ REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);
...
interface ISettingsContext { CONST_VTBL struct ISettingsContextVtbl *lpVtbl; };
...
#define ISettingsContext_Deserialize(This, pStream, pTarget, pppResults,       \
                                     pcResultCount)                            \
  ((This)->lpVtbl->Deserialize(This, pStream, pTarget, pppResults,             \
                               pcResultCount))
...
#define ISettingsContext_GetStoredSettings(                                    \
    This, pIdentity, ppAddedSettings, ppModifiedSettings, ppDeletedSettings)   \
  ((This)->lpVtbl->GetStoredSettings(This, pIdentity, ppAddedSettings,         \
                                     ppModifiedSettings, ppDeletedSettings))
...
class DECLSPEC_UUID("9F7D7BB5-20B3-11DA-81A5-0030F1642E3C") SettingsEngine;
#endif
