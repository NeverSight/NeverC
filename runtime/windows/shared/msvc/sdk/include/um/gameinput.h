...
typedef void(CALLBACK *GameInputReadingCallback)(
    ...
    _In_ IGameInputReading *reading, _In_ bool hasOverrunOccurred);
...
typedef void(CALLBACK *GameInputKeyboardLayoutCallback)(
    _In_ GameInputCallbackToken callbackToken, _In_ void *context,
    _In_ IGameInputDevice *device, _In_ uint64_t timestamp,
    _In_ uint32_t currentLayout, _In_ uint32_t previousLayout);
...
typedef struct GameInputRawDeviceItemCollectionInfo {
  ...
  _Field_size_full_opt_(
      1) struct GameInputRawDeviceItemCollectionInfo const *parent;
  _Field_size_full_opt_(
      1) struct GameInputRawDeviceItemCollectionInfo const *firstSibling;
  _Field_size_full_opt_(
      1) struct GameInputRawDeviceItemCollectionInfo const *previousSibling;
  _Field_size_full_opt_(
      1) struct GameInputRawDeviceItemCollectionInfo const *nextSibling;
  _Field_size_full_opt_(
      1) struct GameInputRawDeviceItemCollectionInfo const *lastSibling;
  _Field_size_full_opt_(
      1) struct GameInputRawDeviceItemCollectionInfo const *firstChild;
  _Field_size_full_opt_(
      1) struct GameInputRawDeviceItemCollectionInfo const *lastChild;
...
typedef struct GameInputRawDeviceReportInfo {
  ...
  uint32_t size;
  uint32_t itemCount;
  _Field_size_full_opt_(itemCount)
...
typedef struct GameInputHapticFeedbackMotorInfo {
  ...
  _Field_size_full_(waveformCount)
...
typedef struct GameInputDeviceInfo {
  ...
  _Field_size_full_opt_(touchSensorCount)
  ...
  _Field_size_full_opt_(forceFeedbackMotorCount)
      GameInputForceFeedbackMotorInfo const *forceFeedbackMotorInfo;
  _Field_size_full_opt_(hapticFeedbackMotorCount)
  ...
  _Field_size_bytes_full_opt_(
      deviceDescriptorSize) void const *deviceDescriptorData;
...
DECLARE_INTERFACE_IID_(INTERFACE, IUnknown,
                       "11BE2A7E-4254-445A-9C09-FFC40F006918") {
  _Must_inspect_result_ IFACEMETHOD(QueryInterface)(
      THIS_ _In_ REFIID riid, _COM_Outptr_ void **ppvObj) PURE;
  ...
  _Must_inspect_result_ IFACEMETHOD(GetCurrentReading)(
      THIS_ _In_ GameInputKind inputKind, _In_opt_ IGameInputDevice * device,
      _COM_Outptr_ IGameInputReading * *reading) PURE;

  _Must_inspect_result_ IFACEMETHOD(GetNextReading)(
      THIS_ _In_ IGameInputReading * referenceReading,
      _In_ GameInputKind inputKind, _In_opt_ IGameInputDevice * device,
      _COM_Outptr_ IGameInputReading * *reading) PURE;
  ...
  _Must_inspect_result_ IFACEMETHOD(GetTemporalReading)(
      THIS_ _In_ uint64_t timestamp, _In_ IGameInputDevice *device,
      _COM_Outptr_ IGameInputReading **reading) PURE;

  IFACEMETHOD(RegisterReadingCallback)(
      THIS_ _In_opt_ IGameInputDevice * device, _In_ GameInputKind inputKind,
      _In_ float analogThreshold, _In_opt_ void *context,
  ...
  IFACEMETHOD(RegisterDeviceCallback)(
      ...
      _In_ GameInputEnumerationKind enumerationKind, _In_opt_ void *context,
  ...
  IFACEMETHOD(RegisterSystemButtonCallback)(
      ...
      _In_ GameInputSystemButtons buttonFilter, _In_opt_ void *context,
      _In_ GameInputSystemButtonCallback callbackFunc,
      _Out_opt_ _Result_zeroonfailure_ GameInputCallbackToken *callbackToken)
      PURE;

  IFACEMETHOD(RegisterKeyboardLayoutCallback)(
      THIS_ _In_opt_ IGameInputDevice * device, _In_opt_ void *context,
      _In_ GameInputKeyboardLayoutCallback callbackFunc,
      _Out_opt_ _Result_zeroonfailure_ GameInputCallbackToken *callbackToken)
      PURE;

  IFACEMETHOD_(void, StopCallback)(
      THIS_ _In_ GameInputCallbackToken callbackToken) PURE;

  IFACEMETHOD_(bool, UnregisterCallback)(
      THIS_ _In_ GameInputCallbackToken callbackToken,
      _In_ uint64_t timeoutInMicroseconds) PURE;

  _Must_inspect_result_ IFACEMETHOD(CreateDispatcher)(
      THIS_ _COM_Outptr_ IGameInputDispatcher * *dispatcher) PURE;

  _Must_inspect_result_ IFACEMETHOD(CreateAggregateDevice)(
      THIS_ _In_ GameInputKind inputKind,
      _COM_Outptr_ IGameInputDevice * *device) PURE;

  _Must_inspect_result_ IFACEMETHOD(FindDeviceFromId)(
      THIS_ _In_ APP_LOCAL_DEVICE_ID const *value,
      _COM_Outptr_ IGameInputDevice **device) PURE;

  _Must_inspect_result_ IFACEMETHOD(FindDeviceFromObject)(
      THIS_ _In_ IUnknown * value, _COM_Outptr_ IGameInputDevice * *device)
      PURE;

  _Must_inspect_result_ IFACEMETHOD(FindDeviceFromPlatformHandle)(
      THIS_ _In_ HANDLE value, _COM_Outptr_ IGameInputDevice * *device) PURE;

  _Must_inspect_result_ IFACEMETHOD(FindDeviceFromPlatformString)(
      THIS_ _In_ LPCWSTR value, _COM_Outptr_ IGameInputDevice * *device) PURE;

  IFACEMETHOD(EnableOemDeviceSupport)(
      THIS_ _In_ uint16_t vendorId, _In_ uint16_t productId,
      _In_ uint8_t interfaceNumber, _In_ uint8_t collectionNumber) PURE;

  IFACEMETHOD_(void, SetFocusPolicy)(THIS_ _In_ GameInputFocusPolicy policy)
      PURE;
};
...
DECLARE_INTERFACE_IID_(INTERFACE, IUnknown,
  ...
  IFACEMETHOD_(uint64_t, GetSequenceNumber)(THIS_ _In_ GameInputKind inputKind)
      PURE;
  ...
  IFACEMETHOD_(bool, GetRawReport)(
      THIS_ _Outptr_result_maybenull_ IGameInputRawDeviceReport * *report) PURE;

  IFACEMETHOD_(uint32_t, GetControllerAxisCount)(THIS) PURE;

  IFACEMETHOD_(uint32_t, GetControllerAxisState)(
      THIS_ _In_ uint32_t stateArrayCount,
  ...
  IFACEMETHOD_(uint32_t, GetKeyState)(THIS_ _In_ uint32_t stateArrayCount,
                                      _Out_writes_(stateArrayCount)
                                          GameInputKeyState *stateArray) PURE;

  IFACEMETHOD_(bool, GetMouseState)(THIS_ _Out_ GameInputMouseState * state)
      PURE;
  ...
  IFACEMETHOD_(bool, GetMotionState)(THIS_ _Out_ GameInputMotionState * state)
      PURE;

  IFACEMETHOD_(bool, GetArcadeStickState)(
      THIS_ _Out_ GameInputArcadeStickState * state) PURE;

  IFACEMETHOD_(bool, GetFlightStickState)(
      THIS_ _Out_ GameInputFlightStickState * state) PURE;

  IFACEMETHOD_(bool, GetGamepadState)(THIS_ _Out_ GameInputGamepadState * state)
      PURE;

  IFACEMETHOD_(bool, GetRacingWheelState)(
      THIS_ _Out_ GameInputRacingWheelState * state) PURE;

  IFACEMETHOD_(bool, GetUiNavigationState)(
      THIS_ _Out_ GameInputUiNavigationState * state) PURE;
};
...
DECLARE_INTERFACE_IID_(INTERFACE, IUnknown,
  ...
  IFACEMETHOD_(_Ret_notnull_ GameInputDeviceInfo const *, GetDeviceInfo)(THIS)
      PURE;

  IFACEMETHOD_(GameInputDeviceStatus, GetDeviceStatus)(THIS) PURE;

  IFACEMETHOD_(void, GetBatteryState)(THIS_ _Out_ GameInputBatteryState * state)
      PURE;

  _Must_inspect_result_ IFACEMETHOD(CreateForceFeedbackEffect)(
      THIS_ _In_ uint32_t motorIndex,
  ...
  IFACEMETHOD_(bool, IsForceFeedbackMotorPoweredOn)(
      THIS_ _In_ uint32_t motorIndex) PURE;

  IFACEMETHOD_(void, SetForceFeedbackMotorGain)(THIS_ _In_ uint32_t motorIndex,
  ...
  IFACEMETHOD_(void, SetRumbleState)(
      THIS_ _In_opt_ GameInputRumbleParams const *params) PURE;

  IFACEMETHOD_(void, SetInputSynchronizationState)(THIS_ _In_ bool enabled)
      PURE;
  ...
  _Must_inspect_result_ IFACEMETHOD(CreateRawDeviceReport)(
      THIS_ _In_ uint32_t reportId,
      _In_ GameInputRawDeviceReportKind reportKind,
      _COM_Outptr_ IGameInputRawDeviceReport **report) PURE;

  _Must_inspect_result_ IFACEMETHOD(GetRawDeviceFeature)(
      THIS_ _In_ uint32_t reportId,
      _COM_Outptr_ IGameInputRawDeviceReport **report) PURE;

  IFACEMETHOD(SetRawDeviceFeature)(THIS_ _In_ IGameInputRawDeviceReport *
                                   report) PURE;

  IFACEMETHOD(SendRawDeviceOutput)(THIS_ _In_ IGameInputRawDeviceReport *
                                   report) PURE;

  IFACEMETHOD(SendRawDeviceOutputWithResponse)(
      THIS_ _In_ IGameInputRawDeviceReport * requestReport,
      _COM_Outptr_ IGameInputRawDeviceReport * *responseReport) PURE;

  IFACEMETHOD(ExecuteRawDeviceIoControl)(
      THIS_ _In_ uint32_t controlCode, _In_ size_t inputBufferSize,
  ...
  IFACEMETHOD_(bool, AcquireExclusiveRawDeviceAccess)(
      THIS_ _In_ uint64_t timeoutInMicroseconds) PURE;
...
DECLARE_INTERFACE_IID_(INTERFACE, IUnknown,
  ...
  IFACEMETHOD(OpenWaitHandle)(THIS_ _Outptr_result_nullonfailure_ HANDLE *
                              waitHandle) PURE;
};
...
DECLARE_INTERFACE_IID_(INTERFACE, IUnknown,
  ...
  IFACEMETHOD_(void, GetParams)(THIS_ _Out_ GameInputForceFeedbackParams *
                                params) PURE;

  IFACEMETHOD_(bool, SetParams)(
      THIS_ _In_ GameInputForceFeedbackParams const *params) PURE;

  IFACEMETHOD_(GameInputFeedbackEffectState, GetState)(THIS) PURE;

  IFACEMETHOD_(void, SetState)(THIS_ _In_ GameInputFeedbackEffectState state)
      PURE;
};
...
DECLARE_INTERFACE_IID_(INTERFACE, IUnknown,
  ...
  IFACEMETHOD_(_Ret_notnull_ GameInputRawDeviceReportInfo const *,
               GetReportInfo)(THIS) PURE;

  IFACEMETHOD_(size_t, GetRawDataSize)(THIS) PURE;

  IFACEMETHOD_(size_t, GetRawData)(THIS_ _In_ size_t bufferSize,
                                   _Out_writes_(bufferSize) void *buffer) PURE;

  IFACEMETHOD_(bool, SetRawData)(THIS_ _In_ size_t bufferSize,
                                 _In_reads_(bufferSize) void const *buffer)
      PURE;

  IFACEMETHOD_(bool, GetItemValue)(THIS_ _In_ uint32_t itemIndex,
                                   _Out_ int64_t *value) PURE;

  IFACEMETHOD_(bool, SetItemValue)(THIS_ _In_ uint32_t itemIndex,
...
_Must_inspect_result_
    STDAPI GameInputCreate(_COM_Outptr_ IGameInput **gameInput);
...
#define IGameInput_QueryInterface(This, riid, ppvObj)                          \
...
#define IGameInput_GetCurrentTimestamp(This)                                   \
  ((This)->lpVtbl->GetCurrentTimestamp(This))
...
#define IGameInput_GetNextReading(This, referenceReading, inputKind, device,   \
                                  reading)                                     \
  ((This)->lpVtbl->GetNextReading(This, referenceReading, inputKind, device,   \
                                  reading))
#define IGameInput_GetPreviousReading(This, referenceReading, inputKind,       \
                                      device, reading)                         \
  ((This)->lpVtbl->GetPreviousReading(This, referenceReading, inputKind,       \
                                      device, reading))
...
#define IGameInput_RegisterReadingCallback(This, device, inputKind,            \
                                           analogThreshold, context,           \
                                           callbackFunc, callbackToken)        \
  ((This)->lpVtbl->RegisterReadingCallback(This, device, inputKind,            \
                                           analogThreshold, context,           \
                                           callbackFunc, callbackToken))
#define IGameInput_RegisterDeviceCallback(                                     \
    This, device, inputKind, statusFilter, enumerationKind, context,           \
    callbackFunc, callbackToken)                                               \
  ((This)->lpVtbl->RegisterDeviceCallback(                                     \
      This, device, inputKind, statusFilter, enumerationKind, context,         \
      callbackFunc, callbackToken))
#define IGameInput_RegisterSystemButtonCallback(This, device, buttonFilter,    \
                                                focusPolicy, context,          \
                                                callbackFunc, callbackToken)   \
  ((This)->lpVtbl->RegisterSystemButtonCallback(This, device, buttonFilter,    \
                                                focusPolicy, context,          \
                                                callbackFunc, callbackToken))
#define IGameInput_RegisterKeyboardLayoutCallback(This, device, context,       \
                                                  callbackFunc, callbackToken) \
  ((This)->lpVtbl->RegisterKeyboardLayoutCallback(                             \
      This, device, context, callbackFunc, callbackToken))
#define IGameInput_StopCallback(This, callbackToken)                           \
  ((This)->lpVtbl->StopCallback(This, callbackToken))
#define IGameInput_UnregisterCallback(This, callbackToken,                     \
                                      timeoutInMicroseconds)                   \
  ((This)->lpVtbl->UnregisterCallback(This, callbackToken,                     \
                                      timeoutInMicroseconds))
#define IGameInput_CreateDispatcher(This, dispatcher)                          \
  ((This)->lpVtbl->CreateDispatcher(This, dispatcher))
#define IGameInput_CreateAggregateDevice(This, inputKind, device)              \
  ((This)->lpVtbl->CreateAggregateDevice(This, inputKind, device))
#define IGameInput_FindDeviceFromId(This, value, device)                       \
  ((This)->lpVtbl->FindDeviceFromId(This, value, device))
#define IGameInput_FindDeviceFromObject(This, value, device)                   \
  ((This)->lpVtbl->FindDeviceFromObject(This, value, device))
...
#define IGameInput_EnableOemDeviceSupport(This, vendorId, productId,           \
                                          interfaceNumber, collectionNumber)   \
  ((This)->lpVtbl->EnableOemDeviceSupport(This, vendorId, productId,           \
                                          interfaceNumber, collectionNumber))
#define IGameInput_SetFocusPolicy(This, policy)                                \
  ((This)->lpVtbl->SetFocusPolicy(This, policy))

#define IGameInputReading_QueryInterface(This, riid, ppvObj)                   \
  ((This)->lpVtbl->QueryInterface(This, riid, ppvObj))
...
#define IGameInputReading_GetInputKind(This)                                   \
  ((This)->lpVtbl->GetInputKind(This))
#define IGameInputReading_GetSequenceNumber(This, inputKind)                   \
  ((This)->lpVtbl->GetSequenceNumber(This, inputKind))
#define IGameInputReading_GetTimestamp(This)                                   \
  ((This)->lpVtbl->GetTimestamp(This))
#define IGameInputReading_GetDevice(This, device)                              \
  ((This)->lpVtbl->GetDevice(This, device))
#define IGameInputReading_GetRawReport(This, report)                           \
  ((This)->lpVtbl->GetRawReport(This, report))
#define IGameInputReading_GetControllerAxisCount(This)                         \
  ((This)->lpVtbl->GetControllerAxisCount(This))
#define IGameInputReading_GetControllerAxisState(This, stateArrayCount,        \
                                                 stateArray)                   \
  ((This)->lpVtbl->GetControllerAxisState(This, stateArrayCount, stateArray))
#define IGameInputReading_GetControllerButtonCount(This)                       \
  ((This)->lpVtbl->GetControllerButtonCount(This))
#define IGameInputReading_GetControllerButtonState(This, stateArrayCount,      \
                                                   stateArray)                 \
  ((This)->lpVtbl->GetControllerButtonState(This, stateArrayCount, stateArray))
#define IGameInputReading_GetControllerSwitchCount(This)                       \
  ((This)->lpVtbl->GetControllerSwitchCount(This))
#define IGameInputReading_GetControllerSwitchState(This, stateArrayCount,      \
                                                   stateArray)                 \
...
#define IGameInputReading_GetMouseState(This, state)                           \
  ((This)->lpVtbl->GetMouseState(This, state))
#define IGameInputReading_GetTouchCount(This)                                  \
  ((This)->lpVtbl->GetTouchCount(This))
...
#define IGameInputReading_GetMotionState(This, state)                          \
  ((This)->lpVtbl->GetMotionState(This, state))
#define IGameInputReading_GetArcadeStickState(This, state)                     \
  ((This)->lpVtbl->GetArcadeStickState(This, state))
#define IGameInputReading_GetFlightStickState(This, state)                     \
  ((This)->lpVtbl->GetFlightStickState(This, state))
#define IGameInputReading_GetGamepadState(This, state)                         \
  ((This)->lpVtbl->GetGamepadState(This, state))
#define IGameInputReading_GetRacingWheelState(This, state)                     \
  ((This)->lpVtbl->GetRacingWheelState(This, state))
#define IGameInputReading_GetUiNavigationState(This, state)                    \
  ((This)->lpVtbl->GetUiNavigationState(This, state))

#define IGameInputDevice_QueryInterface(This, riid, ppvObj)                    \
  ((This)->lpVtbl->QueryInterface(This, riid, ppvObj))
#define IGameInputDevice_AddRef(This) ((This)->lpVtbl->AddRef(This))
#define IGameInputDevice_Release(This) ((This)->lpVtbl->Release(This))
#define IGameInputDevice_GetDeviceInfo(This)                                   \
  ((This)->lpVtbl->GetDeviceInfo(This))
#define IGameInputDevice_GetDeviceStatus(This)                                 \
  ((This)->lpVtbl->GetDeviceStatus(This))
#define IGameInputDevice_GetBatteryState(This, state)                          \
  ((This)->lpVtbl->GetBatteryState(This, state))
#define IGameInputDevice_CreateForceFeedbackEffect(This, motorIndex, params,   \
                                                   effect)                     \
...
#define IGameInputDevice_SetForceFeedbackMotorGain(This, motorIndex,           \
                                                   masterGain)                 \
...
#define IGameInputDevice_SetRumbleState(This, params)                          \
...
#define IGameInputDevice_SendInputSynchronizationHint(This)                    \
  ((This)->lpVtbl->SendInputSynchronizationHint(This))
#define IGameInputDevice_PowerOff(This) ((This)->lpVtbl->PowerOff(This))
#define IGameInputDevice_CreateRawDeviceReport(This, reportId, reportKind,     \
                                               report)                         \
...
#define IGameInputDevice_SetRawDeviceFeature(This, report)                     \
  ((This)->lpVtbl->SetRawDeviceFeature(This, report))
#define IGameInputDevice_SendRawDeviceOutput(This, report)                     \
  ((This)->lpVtbl->SendRawDeviceOutput(This, report))
#define IGameInputDevice_SendRawDeviceOutputWithResponse(This, requestReport,  \
                                                         responseReport)       \
  ((This)->lpVtbl->SendRawDeviceOutputWithResponse(This, requestReport,        \
                                                   responseReport))
#define IGameInputDevice_ExecuteRawDeviceIoControl(                            \
    This, controlCode, inputBufferSize, inputBuffer, outputBufferSize,         \
    outputBuffer, outputSize)                                                  \
  ((This)->lpVtbl->ExecuteRawDeviceIoControl(                                  \
      This, controlCode, inputBufferSize, inputBuffer, outputBufferSize,       \
      outputBuffer, outputSize))
...
#define IGameInputDevice_ReleaseExclusiveRawDeviceAccess(This)                 \
...
// MessageText:
//
// The target timestamp for the temporal reading is too far in the past or
// future.
//
...
// MessageText:
//
// The device does not have enough resources remaining to create the requested
// force feedback effect.
//
#define GAMEINPUT_E_INSUFFICIENT_FORCE_FEEDBACK_RESOURCES                      \
  _HRESULT_TYPEDEF_(0x838A0006L)
