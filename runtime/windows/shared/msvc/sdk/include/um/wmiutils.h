...
typedef struct IWbemPathKeyListVtbl {
  ...
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(IWbemPathKeyList *This,
                                             /* [in] */ REFIID riid,
  ...
  HRESULT(STDMETHODCALLTYPE *GetCount)(IWbemPathKeyList *This,
                                       /* [out] */ ULONG *puKeyCount);

  DECLSPEC_XFGVIRT(IWbemPathKeyList, SetKey)
  HRESULT(STDMETHODCALLTYPE *SetKey)(IWbemPathKeyList *This,
                                     /* [string][in] */ LPCWSTR wszName,
                                     /* [in] */ ULONG uFlags,
                                     /* [in] */ ULONG uCimType,
                                     /* [in] */ LPVOID pKeyVal);
  ...
  HRESULT(STDMETHODCALLTYPE *SetKey2)(IWbemPathKeyList *This,
                                      /* [string][in] */ LPCWSTR wszName,
                                      /* [in] */ ULONG uFlags,
                                      /* [in] */ ULONG uCimType,
                                      /* [in] */ VARIANT *pKeyVal);
  ...
  HRESULT(STDMETHODCALLTYPE *GetKey)(IWbemPathKeyList *This,
                                     /* [in] */ ULONG uKeyIx,
                                     /* [in] */ ULONG uFlags,
                                     /* [out][in] */ ULONG *puNameBufSize,
                                     /* [annotation][out][in] */
                                     _Out_writes_opt_(*puNameBufSize)
                                         LPWSTR pszKeyName,
                                     /* [out][in] */ ULONG *puKeyValBufSize,
                                     /* [out][in] */ LPVOID pKeyVal,
  ...
  HRESULT(STDMETHODCALLTYPE *GetKey2)(IWbemPathKeyList *This,
                                      /* [in] */ ULONG uKeyIx,
                                      /* [in] */ ULONG uFlags,
                                      /* [out][in] */ ULONG *puNameBufSize,
                                      /* [annotation][out][in] */
  ...
  HRESULT(STDMETHODCALLTYPE *RemoveKey)(IWbemPathKeyList *This,
                                        /* [string][in] */ LPCWSTR wszName,
                                        /* [in] */ ULONG uFlags);

  DECLSPEC_XFGVIRT(IWbemPathKeyList, RemoveAllKeys)
  HRESULT(STDMETHODCALLTYPE *RemoveAllKeys)(IWbemPathKeyList *This,
                                            /* [in] */ ULONG uFlags);

  DECLSPEC_XFGVIRT(IWbemPathKeyList, MakeSingleton)
  HRESULT(STDMETHODCALLTYPE *MakeSingleton)(IWbemPathKeyList *This,
                                            /* [in] */ boolean bSet);

  DECLSPEC_XFGVIRT(IWbemPathKeyList, GetInfo)
  HRESULT(STDMETHODCALLTYPE *GetInfo)(IWbemPathKeyList *This,
                                      /* [in] */ ULONG uRequestedInfo,
                                      /* [out] */ ULONGLONG *puResponse);

  DECLSPEC_XFGVIRT(IWbemPathKeyList, GetText)
  HRESULT(STDMETHODCALLTYPE *GetText)(IWbemPathKeyList *This,
                                      /* [in] */ long lFlags,
                                      /* [out][in] */ ULONG *puBuffLength,
                                      /* [annotation][string][out][in] */
                                      _Out_writes_(*puBuffLength)
                                          LPWSTR pszText);

  END_INTERFACE
} IWbemPathKeyListVtbl;

interface IWbemPathKeyList { CONST_VTBL struct IWbemPathKeyListVtbl *lpVtbl; };
...
typedef struct IWbemPathVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(IWbemPath *This,
                                             /* [in] */ REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);
  ...
  HRESULT(STDMETHODCALLTYPE *SetText)(IWbemPath *This,
                                      /* [in] */ ULONG uMode,
                                      /* [in] */ LPCWSTR pszPath);

  DECLSPEC_XFGVIRT(IWbemPath, GetText)
  HRESULT(STDMETHODCALLTYPE *GetText)(IWbemPath *This,
                                      /* [in] */ long lFlags,
                                      /* [out][in] */ ULONG *puBuffLength,
                                      /* [annotation][string][out][in] */
                                      _Out_writes_(*puBuffLength)
  ...
  HRESULT(STDMETHODCALLTYPE *GetInfo)(IWbemPath *This,
                                      /* [in] */ ULONG uRequestedInfo,
                                      /* [out] */ ULONGLONG *puResponse);

  DECLSPEC_XFGVIRT(IWbemPath, SetServer)
  HRESULT(STDMETHODCALLTYPE *SetServer)(IWbemPath *This,
                                        /* [string][in] */ LPCWSTR Name);

  DECLSPEC_XFGVIRT(IWbemPath, GetServer)
  HRESULT(STDMETHODCALLTYPE *GetServer)(IWbemPath *This,
                                        /* [out][in] */ ULONG *puNameBufLength,
                                        /* [annotation][string][out][in] */
                                        _Out_writes_(*puNameBufLength)
                                            LPWSTR pName);

  DECLSPEC_XFGVIRT(IWbemPath, GetNamespaceCount)
  HRESULT(STDMETHODCALLTYPE *GetNamespaceCount)(IWbemPath *This,
                                                /* [out] */ ULONG *puCount);
  ...
  HRESULT(STDMETHODCALLTYPE *RemoveNamespaceAt)(IWbemPath *This,
                                                /* [in] */ ULONG uIndex);
  ...
  HRESULT(STDMETHODCALLTYPE *GetScopeCount)(IWbemPath *This,
                                            /* [out] */ ULONG *puCount);

  DECLSPEC_XFGVIRT(IWbemPath, SetScope)
  HRESULT(STDMETHODCALLTYPE *SetScope)(IWbemPath *This,
                                       /* [in] */ ULONG uIndex,
                                       /* [annotation][in] */
                                       _In_ LPWSTR pszClass);

  DECLSPEC_XFGVIRT(IWbemPath, SetScopeFromText)
  HRESULT(STDMETHODCALLTYPE *SetScopeFromText)(IWbemPath *This,
                                               /* [in] */ ULONG uIndex,
                                               /* [annotation][in] */
                                               _In_ LPWSTR pszText);
  ...
  HRESULT(STDMETHODCALLTYPE *RemoveScope)(IWbemPath *This,
                                          /* [in] */ ULONG uIndex);
  ...
  HRESULT(STDMETHODCALLTYPE *SetClassName)(IWbemPath *This,
                                           /* [string][in] */ LPCWSTR Name);

  DECLSPEC_XFGVIRT(IWbemPath, GetClassName)
  HRESULT(STDMETHODCALLTYPE *GetClassName)(IWbemPath *This,
                                           /* [out][in] */ ULONG *puBuffLength,
                                           /* [annotation][string][out][in] */
                                           _Out_writes_opt_(*puBuffLength)
                                               LPWSTR pszName);

  DECLSPEC_XFGVIRT(IWbemPath, GetKeyList)
  HRESULT(STDMETHODCALLTYPE *GetKeyList)(IWbemPath *This,
                                         /* [out] */ IWbemPathKeyList **pOut);

  DECLSPEC_XFGVIRT(IWbemPath, CreateClassPart)
  HRESULT(STDMETHODCALLTYPE *CreateClassPart)(IWbemPath *This,
                                              /* [in] */ long lFlags,
                                              /* [string][in] */ LPCWSTR Name);

  DECLSPEC_XFGVIRT(IWbemPath, DeleteClassPart)
  HRESULT(STDMETHODCALLTYPE *DeleteClassPart)(IWbemPath *This,
                                              /* [in] */ long lFlags);

  DECLSPEC_XFGVIRT(IWbemPath, IsRelative)
  BOOL(STDMETHODCALLTYPE *IsRelative)(IWbemPath *This,
                                      /* [annotation][string][in] */
                                      _In_ LPWSTR wszMachine,
                                      /* [annotation][string][in] */
                                      _In_ LPWSTR wszNamespace);
  ...
  BOOL(STDMETHODCALLTYPE *IsRelativeOrChild)(IWbemPath *This,
                                             /* [annotation][string][in] */
                                             _In_ LPWSTR wszMachine,
                                             /* [annotation][string][in] */
                                             _In_ LPWSTR wszNamespace,
  ...
  BOOL(STDMETHODCALLTYPE *IsLocal)(IWbemPath *This,
                                   /* [string][in] */ LPCWSTR wszMachine);

  DECLSPEC_XFGVIRT(IWbemPath, IsSameClassName)
  BOOL(STDMETHODCALLTYPE *IsSameClassName)(IWbemPath *This,
                                           /* [string][in] */ LPCWSTR wszClass);

  END_INTERFACE
} IWbemPathVtbl;

interface IWbemPath { CONST_VTBL struct IWbemPathVtbl *lpVtbl; };
...
typedef struct IWbemQueryVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(IWbemQuery *This,
                                             /* [in] */ REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);
  ...
  HRESULT(STDMETHODCALLTYPE *SetLanguageFeatures)(IWbemQuery *This,
                                                  /* [in] */ ULONG uFlags,
                                                  /* [in] */ ULONG uArraySize,
                                                  /* [in] */ ULONG *puFeatures);
  ...
  HRESULT(STDMETHODCALLTYPE *Parse)(IWbemQuery *This,
                                    /* [in] */ LPCWSTR pszLang,
                                    /* [in] */ LPCWSTR pszQuery,
                                    /* [in] */ ULONG uFlags);

  DECLSPEC_XFGVIRT(IWbemQuery, GetAnalysis)
  HRESULT(STDMETHODCALLTYPE *GetAnalysis)(IWbemQuery *This,
                                          /* [in] */ ULONG uAnalysisType,
                                          /* [in] */ ULONG uFlags,
                                          /* [out] */ LPVOID *pAnalysis);

  DECLSPEC_XFGVIRT(IWbemQuery, FreeMemory)
  HRESULT(STDMETHODCALLTYPE *FreeMemory)(IWbemQuery *This,
                                         /* [in] */ LPVOID pMem);

  DECLSPEC_XFGVIRT(IWbemQuery, GetQueryInfo)
  HRESULT(STDMETHODCALLTYPE *GetQueryInfo)(IWbemQuery *This,
                                           /* [in] */ ULONG uAnalysisType,
                                           /* [in] */ ULONG uInfoId,
                                           /* [in] */ ULONG uBufSize,
                                           /* [out] */ LPVOID pDestBuf);
...
interface IWbemQuery { CONST_VTBL struct IWbemQueryVtbl *lpVtbl; };
...
#define IWbemQuery_GetQueryInfo(This, uAnalysisType, uInfoId, uBufSize,        \
                                pDestBuf)                                      \
  ((This)->lpVtbl->GetQueryInfo(This, uAnalysisType, uInfoId, uBufSize,        \
                                pDestBuf))
...
class DECLSPEC_UUID("EAC8A024-21E2-4523-AD73-A71A0AA2F56A") WbemQuery;
#endif
