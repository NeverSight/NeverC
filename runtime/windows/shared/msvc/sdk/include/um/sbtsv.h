...
typedef interface ITsSbClientConnectionPropertySet
...
typedef interface ITsSbProvisioningPluginNotifySink
...
//
// If plugins get synch error (E_SB_SYNCH_CONFLICT) while saving resources to
// broker store; Plugins should attempt to retry saving the object.
//
...
typedef struct ITsSbPluginVtbl {
  ...
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in ITsSbPlugin *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in ITsSbPlugin *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in ITsSbPlugin *This);
...
interface ITsSbPlugin { CONST_VTBL struct ITsSbPluginVtbl *lpVtbl; };
...
ITsSbResourcePlugin : public ITsSbPlugin{public : };
...
typedef struct ITsSbResourcePluginVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in ITsSbResourcePlugin *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in ITsSbResourcePlugin *This);
...
#define ITsSbResourcePlugin_Initialize(This, pProvider, pNotifySink,           \
                                       pPropertySet)                           \
  ((This)->lpVtbl->Initialize(This, pProvider, pNotifySink, pPropertySet))
...
public:
  virtual /* [helpstring][id] */ HRESULT STDMETHODCALLTYPE NotifyServiceFailure(
      void) = 0;

  virtual /* [helpstring][id] */ HRESULT STDMETHODCALLTYPE NotifyServiceSuccess(
      void) = 0;
};
...
typedef struct ITsSbServiceNotificationVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in ITsSbServiceNotification *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in ITsSbServiceNotification *This);
...
#define ITsSbServiceNotification_AddRef(This) ((This)->lpVtbl->AddRef(This))

#define ITsSbServiceNotification_Release(This) ((This)->lpVtbl->Release(This))
...
typedef struct ITsSbLoadBalancingVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in ITsSbLoadBalancing *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in ITsSbLoadBalancing *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in ITsSbLoadBalancing *This);
...
#define ITsSbLoadBalancing_Initialize(This, pProvider, pNotifySink,            \
                                      pPropertySet)                            \
  ((This)->lpVtbl->Initialize(This, pProvider, pNotifySink, pPropertySet))
...
public:
  virtual /* [helpstring][id] */ HRESULT STDMETHODCALLTYPE
      QueryEnvironmentForTarget(
          /* [in] */ __RPC__in_opt ITsSbClientConnection * pConnection,
          /* [in] */ __RPC__in_opt ITsSbPlacementNotifySink *
              pPlacementSink) = 0;
};
...
typedef struct ITsSbPlacementVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in ITsSbPlacement *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in ITsSbPlacement *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in ITsSbPlacement *This);
...
interface ITsSbPlacement { CONST_VTBL struct ITsSbPlacementVtbl *lpVtbl; };
...
#define ITsSbPlacement_QueryEnvironmentForTarget(This, pConnection,            \
                                                 pPlacementSink)               \
...
public:
  virtual /* [helpstring][id] */ HRESULT STDMETHODCALLTYPE
      PrepareTargetForConnect(
          /* [in] */ __RPC__in_opt ITsSbClientConnection * pConnection,
          /* [in] */ __RPC__in_opt ITsSbOrchestrationNotifySink *
              pOrchestrationNotifySink) = 0;
};
...
typedef struct ITsSbOrchestrationVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in ITsSbOrchestration *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in ITsSbOrchestration *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in ITsSbOrchestration *This);
...
#define ITsSbOrchestration_Initialize(This, pProvider, pNotifySink,            \
                                      pPropertySet)                            \
  ((This)->lpVtbl->Initialize(This, pProvider, pNotifySink, pPropertySet))
...
#define ITsSbOrchestration_PrepareTargetForConnect(This, pConnection,          \
                                                   pOrchestrationNotifySink)   \
  ((This)->lpVtbl->PrepareTargetForConnect(This, pConnection,                  \
                                           pOrchestrationNotifySink))
...
public:
  ...
  virtual /* [helpstring][id][propget] */ HRESULT STDMETHODCALLTYPE
      get_EnvironmentPropertySet(
          /* [retval][out] */ __RPC__deref_out_opt ITsSbEnvironmentPropertySet *
          *ppPropertySet) = 0;
...
typedef struct ITsSbEnvironmentVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in ITsSbEnvironment *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in ITsSbEnvironment *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in ITsSbEnvironment *This);
  ...
  /* [helpstring][id][propget] */ HRESULT(
      STDMETHODCALLTYPE *get_EnvironmentPropertySet)(
      __RPC__in ITsSbEnvironment *This,
      /* [retval][out] */ __RPC__deref_out_opt ITsSbEnvironmentPropertySet *
          *ppPropertySet);
  ...
  /* [helpstring][id][propput] */ HRESULT(
      STDMETHODCALLTYPE *put_EnvironmentPropertySet)(
      __RPC__in ITsSbEnvironment *This,
...
interface ITsSbEnvironment { CONST_VTBL struct ITsSbEnvironmentVtbl *lpVtbl; };
...
typedef struct ITsSbLoadBalanceResultVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in ITsSbLoadBalanceResult *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in ITsSbLoadBalanceResult *This);
...
public:
  ...
  virtual /* [helpstring][id][propget] */ HRESULT STDMETHODCALLTYPE
      get_IpAddresses(
          /* [size_is][out] */ __RPC__out_ecount_full(*numAddresses)
  ...
  virtual /* [helpstring][id][propput] */ HRESULT STDMETHODCALLTYPE
  put_IpAddresses(
      /* [size_is][in] */ __RPC__in_ecount_full(numAddresses)
              TSSD_ConnectionPoint *
          sockaddr,
  ...
  virtual /* [helpstring][id][propget] */ HRESULT STDMETHODCALLTYPE
      get_TargetPropertySet(
          /* [retval][out] */ __RPC__deref_out_opt ITsSbTargetPropertySet *
          *ppPropertySet) = 0;
...
typedef struct ITsSbTargetVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in ITsSbTarget *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in ITsSbTarget *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in ITsSbTarget *This);
  ...
  /* [helpstring][id][propget] */ HRESULT(
      STDMETHODCALLTYPE *get_TargetPropertySet)(
      __RPC__in ITsSbTarget *This,
      /* [retval][out] */ __RPC__deref_out_opt ITsSbTargetPropertySet *
          *ppPropertySet);
  ...
  /* [helpstring][id][propput] */ HRESULT(
      STDMETHODCALLTYPE *put_TargetPropertySet)(
      __RPC__in ITsSbTarget *This,
      /* [in] */ __RPC__in_opt ITsSbTargetPropertySet *pVal);

  DECLSPEC_XFGVIRT(ITsSbTarget, get_EnvironmentName)
  /* [helpstring][id][propget] */ HRESULT(
      STDMETHODCALLTYPE *get_EnvironmentName)(
      __RPC__in ITsSbTarget *This,
      /* [retval][out] */ __RPC__deref_out_opt BSTR *pVal);

  DECLSPEC_XFGVIRT(ITsSbTarget, put_EnvironmentName)
  /* [helpstring][id][propput] */ HRESULT(
      STDMETHODCALLTYPE *put_EnvironmentName)(__RPC__in ITsSbTarget *This,
                                              /* [in] */ __RPC__in BSTR Val);
  ...
  /* [helpstring][id][propget] */ HRESULT(
      STDMETHODCALLTYPE *get_NumPendingConnections)(
      __RPC__in ITsSbTarget *This,
...
interface ITsSbTarget { CONST_VTBL struct ITsSbTargetVtbl *lpVtbl; };
...
typedef struct ITsSbSessionVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in ITsSbSession *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in ITsSbSession *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in ITsSbSession *This);
  ...
  /* [helpstring][id][propget] */ HRESULT(
      STDMETHODCALLTYPE *get_DisconnectTime)(
      __RPC__in ITsSbSession *This,
      /* [retval][out] */ __RPC__out FILETIME *pTime);

  DECLSPEC_XFGVIRT(ITsSbSession, put_DisconnectTime)
  /* [helpstring][id][propput] */ HRESULT(
      STDMETHODCALLTYPE *put_DisconnectTime)(__RPC__in ITsSbSession *This,
                                             /* [in] */ FILETIME Time);

  DECLSPEC_XFGVIRT(ITsSbSession, get_InitialProgram)
  /* [helpstring][id][propget] */ HRESULT(
      STDMETHODCALLTYPE *get_InitialProgram)(
      __RPC__in ITsSbSession *This,
      /* [retval][out] */ __RPC__deref_out_opt BSTR *app);

  DECLSPEC_XFGVIRT(ITsSbSession, put_InitialProgram)
  /* [helpstring][id][propput] */ HRESULT(
      STDMETHODCALLTYPE *put_InitialProgram)(__RPC__in ITsSbSession *This,
                                             /* [in] */ __RPC__in BSTR
                                                 Application);
...
interface ITsSbSession { CONST_VTBL struct ITsSbSessionVtbl *lpVtbl; };
...
typedef struct ITsSbResourceNotificationVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in ITsSbResourceNotification *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in ITsSbResourceNotification *This);
  ...
  /* [helpstring][id] */ HRESULT(
      STDMETHODCALLTYPE *NotifyClientConnectionStateChange)(
      __RPC__in ITsSbResourceNotification *This,
      /* [in] */ CONNECTION_CHANGE_NOTIFICATION ChangeType,
      /* [in] */ __RPC__in_opt ITsSbClientConnection *pConnection);
...
#define ITsSbResourceNotification_NotifySessionChange(This, changeType,        \
                                                      pSession)                \
  ((This)->lpVtbl->NotifySessionChange(This, changeType, pSession))

#define ITsSbResourceNotification_NotifyTargetChange(This, TargetChangeType,   \
                                                     pTarget)                  \
  ((This)->lpVtbl->NotifyTargetChange(This, TargetChangeType, pTarget))

#define ITsSbResourceNotification_NotifyClientConnectionStateChange(           \
    This, ChangeType, pConnection)                                             \
  ((This)->lpVtbl->NotifyClientConnectionStateChange(This, ChangeType,         \
                                                     pConnection))
...
typedef struct ITsSbResourceNotificationExVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in ITsSbResourceNotificationEx *This);
  ...
  DECLSPEC_XFGVIRT(ITsSbResourceNotificationEx,
                   NotifyClientConnectionStateChangeEx)
  /* [helpstring][id] */ HRESULT(
      STDMETHODCALLTYPE *NotifyClientConnectionStateChangeEx)(
      __RPC__in ITsSbResourceNotificationEx *This,
      /* [in] */ __RPC__in BSTR userName,
      /* [in] */ __RPC__in BSTR domain,
      /* [in] */ __RPC__in BSTR initialProgram,
...
#define ITsSbResourceNotificationEx_AddRef(This) ((This)->lpVtbl->AddRef(This))

#define ITsSbResourceNotificationEx_Release(This)                              \
  ((This)->lpVtbl->Release(This))

#define ITsSbResourceNotificationEx_NotifySessionChangeEx(                     \
    This, targetName, userName, domain, sessionId, sessionState)               \
  ((This)->lpVtbl->NotifySessionChangeEx(This, targetName, userName, domain,   \
                                         sessionId, sessionState))

#define ITsSbResourceNotificationEx_NotifyTargetChangeEx(This, targetName,     \
                                                         targetChangeType)     \
  ((This)->lpVtbl->NotifyTargetChangeEx(This, targetName, targetChangeType))

#define ITsSbResourceNotificationEx_NotifyClientConnectionStateChangeEx(       \
    This, userName, domain, initialProgram, poolName, targetName,              \
    connectionChangeType)                                                      \
  ((This)->lpVtbl->NotifyClientConnectionStateChangeEx(                        \
      This, userName, domain, initialProgram, poolName, targetName,            \
      connectionChangeType))
...
typedef struct ITsSbTaskInfoVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in ITsSbTaskInfo *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in ITsSbTaskInfo *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in ITsSbTaskInfo *This);
...
interface ITsSbTaskInfo { CONST_VTBL struct ITsSbTaskInfoVtbl *lpVtbl; };
...
#define ITsSbTaskInfo_AddRef(This) ((This)->lpVtbl->AddRef(This))

#define ITsSbTaskInfo_Release(This) ((This)->lpVtbl->Release(This))
...
public:
  virtual /* [helpstring][id] */ HRESULT STDMETHODCALLTYPE InitializeTaskPlugin(
      /* [in] */ __RPC__in_opt ITsSbTaskPluginNotifySink *
      pITsSbTaskPluginNotifySink) = 0;

  virtual /* [helpstring][id] */ HRESULT STDMETHODCALLTYPE SetTaskQueue(
      /* [in] */ __RPC__in BSTR pszHostName,
      /* [in] */ DWORD SbTaskInfoSize,
      /* [size_is][in] */ __RPC__in_ecount_full(SbTaskInfoSize) ITsSbTaskInfo *
          pITsSbTaskInfo[]) = 0;
};
...
typedef struct ITsSbTaskPluginVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in ITsSbTaskPlugin *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in ITsSbTaskPlugin *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in ITsSbTaskPlugin *This);
...
interface ITsSbTaskPlugin { CONST_VTBL struct ITsSbTaskPluginVtbl *lpVtbl; };
...
#define ITsSbTaskPlugin_AddRef(This) ((This)->lpVtbl->AddRef(This))

#define ITsSbTaskPlugin_Release(This) ((This)->lpVtbl->Release(This))
...
#define ITsSbTaskPlugin_SetTaskQueue(This, pszHostName, SbTaskInfoSize,        \
                                     pITsSbTaskInfo)                           \
  ((This)->lpVtbl->SetTaskQueue(This, pszHostName, SbTaskInfoSize,             \
                                pITsSbTaskInfo))
...
ITsSbPropertySet : public IPropertyBag{public : };
...
typedef struct ITsSbPropertySetVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in ITsSbPropertySet *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in ITsSbPropertySet *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in ITsSbPropertySet *This);
  ...
  HRESULT(STDMETHODCALLTYPE *Write)(__RPC__in ITsSbPropertySet *This,
...
interface ITsSbPropertySet { CONST_VTBL struct ITsSbPropertySetVtbl *lpVtbl; };
...
ITsSbPluginPropertySet : public ITsSbPropertySet{public : };
...
typedef struct ITsSbPluginPropertySetVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in ITsSbPluginPropertySet *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in ITsSbPluginPropertySet *This);
  ...
  DECLSPEC_XFGVIRT(IPropertyBag, Write)
  HRESULT(STDMETHODCALLTYPE *Write)(__RPC__in ITsSbPluginPropertySet *This,
                                    /* [in] */ __RPC__in LPCOLESTR pszPropName,
                                    /* [in] */ __RPC__in VARIANT *pVar);
...
ITsSbClientConnectionPropertySet : public ITsSbPropertySet{public : };
...
#define ITsSbClientConnectionPropertySet_Read(This, pszPropName, pVar,         \
                                              pErrorLog)                       \
  ((This)->lpVtbl->Read(This, pszPropName, pVar, pErrorLog))
...
ITsSbTargetPropertySet : public ITsSbPropertySet{public : };
...
typedef struct ITsSbTargetPropertySetVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in ITsSbTargetPropertySet *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in ITsSbTargetPropertySet *This);
  ...
  DECLSPEC_XFGVIRT(IPropertyBag, Write)
  HRESULT(STDMETHODCALLTYPE *Write)(__RPC__in ITsSbTargetPropertySet *This,
                                    /* [in] */ __RPC__in LPCOLESTR pszPropName,
                                    /* [in] */ __RPC__in VARIANT *pVar);
...
ITsSbEnvironmentPropertySet : public ITsSbPropertySet{public : };
...
typedef struct ITsSbEnvironmentPropertySetVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in ITsSbEnvironmentPropertySet *This);
  ...
  DECLSPEC_XFGVIRT(IPropertyBag, Write)
  HRESULT(STDMETHODCALLTYPE *Write)(__RPC__in ITsSbEnvironmentPropertySet *This,
                                    /* [in] */ __RPC__in LPCOLESTR pszPropName,
                                    /* [in] */ __RPC__in VARIANT *pVar);
...
typedef struct ITsSbBaseNotifySinkVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in ITsSbBaseNotifySink *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in ITsSbBaseNotifySink *This);
...
public:
  ...
  virtual /* [helpstring][id] */ HRESULT STDMETHODCALLTYPE OnTerminated(
      void) = 0;
};
...
typedef struct ITsSbPluginNotifySinkVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in ITsSbPluginNotifySink *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in ITsSbPluginNotifySink *This);
...
#define ITsSbLoadBalancingNotifySink_OnReportStatus(This, messageType,         \
                                                    messageID)                 \
  ((This)->lpVtbl->OnReportStatus(This, messageType, messageID))
...
typedef struct ITsSbPlacementNotifySinkVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in ITsSbPlacementNotifySink *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in ITsSbPlacementNotifySink *This);
  ...
  /* [helpstring][id] */ HRESULT(
      STDMETHODCALLTYPE *OnQueryEnvironmentCompleted)(
      __RPC__in ITsSbPlacementNotifySink *This,
...
#define ITsSbPlacementNotifySink_OnQueryEnvironmentCompleted(This,             \
                                                             pEnvironment)     \
...
#define ITsSbOrchestrationNotifySink_OnReportStatus(This, messageType,         \
                                                    messageID)                 \
  ((This)->lpVtbl->OnReportStatus(This, messageType, messageID))
...
typedef struct ITsSbTaskPluginNotifySinkVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in ITsSbTaskPluginNotifySink *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in ITsSbTaskPluginNotifySink *This);
...
#define ITsSbTaskPluginNotifySink_AddRef(This) ((This)->lpVtbl->AddRef(This))

#define ITsSbTaskPluginNotifySink_Release(This) ((This)->lpVtbl->Release(This))
...
#define ITsSbTaskPluginNotifySink_OnSetTaskTime(                               \
    This, szTargetName, TaskStartTime, TaskEndTime, TaskDeadline, szTaskLabel, \
    szTaskIdentifier, szTaskPlugin, dwTaskStatus, saContext)                   \
  ((This)->lpVtbl->OnSetTaskTime(                                              \
      This, szTargetName, TaskStartTime, TaskEndTime, TaskDeadline,            \
      szTaskLabel, szTaskIdentifier, szTaskPlugin, dwTaskStatus, saContext))

#define ITsSbTaskPluginNotifySink_OnDeleteTaskTime(This, szTargetName,         \
                                                   szTaskIdentifier)           \
  ((This)->lpVtbl->OnDeleteTaskTime(This, szTargetName, szTaskIdentifier))

#define ITsSbTaskPluginNotifySink_OnUpdateTaskStatus(                          \
    This, szTargetName, TaskIdentifier, TaskStatus)                            \
  ((This)->lpVtbl->OnUpdateTaskStatus(This, szTargetName, TaskIdentifier,      \
                                      TaskStatus))
...
public:
  ...
  virtual /* [helpstring][id][propget] */ HRESULT STDMETHODCALLTYPE
      get_LoadBalanceResult(
          /* [retval][out] */ __RPC__deref_out_opt ITsSbLoadBalanceResult *
          *ppVal) = 0;
  ...
  virtual /* [helpstring][id][propget] */ HRESULT STDMETHODCALLTYPE
      get_Environment(
          /* [retval][out] */ __RPC__deref_out_opt ITsSbEnvironment *
          *ppEnvironment) = 0;

  virtual /* [helpstring][id][propget] */ HRESULT STDMETHODCALLTYPE
  get_ConnectionError(void) = 0;
  ...
  virtual /* [helpstring][id][propget] */ HRESULT STDMETHODCALLTYPE
      get_ClientConnectionPropertySet(
          /* [retval][out] */
          __RPC__deref_out_opt ITsSbClientConnectionPropertySet *
          *ppPropertySet) = 0;
  ...
  virtual /* [helpstring][id][propget] */ HRESULT STDMETHODCALLTYPE
      get_UserSidString(
          /* [retval][out] */ __RPC__deref_out_opt LPTSTR *
          pszUserSidString) = 0;
...
typedef struct ITsSbClientConnectionVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in ITsSbClientConnection *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in ITsSbClientConnection *This);
  ...
  /* [helpstring][id][propget] */ HRESULT(
      STDMETHODCALLTYPE *get_LoadBalanceResult)(
      __RPC__in ITsSbClientConnection *This,
  ...
  /* [helpstring][id][propget] */ HRESULT(
      STDMETHODCALLTYPE *get_ConnectionError)(
      __RPC__in ITsSbClientConnection *This);

  DECLSPEC_XFGVIRT(ITsSbClientConnection, get_SamUserAccount)
  /* [helpstring][id][propget] */ HRESULT(
      STDMETHODCALLTYPE *get_SamUserAccount)(
      __RPC__in ITsSbClientConnection *This,
      /* [retval][out] */ __RPC__deref_out_opt BSTR *pVal);

  DECLSPEC_XFGVIRT(ITsSbClientConnection, get_ClientConnectionPropertySet)
  /* [helpstring][id][propget] */ HRESULT(
      STDMETHODCALLTYPE *get_ClientConnectionPropertySet)(
      __RPC__in ITsSbClientConnection *This,
      /* [retval][out] */ __RPC__deref_out_opt ITsSbClientConnectionPropertySet
          **ppPropertySet);

  DECLSPEC_XFGVIRT(ITsSbClientConnection, get_IsFirstAssignment)
  /* [helpstring][id][propget] */ HRESULT(
      STDMETHODCALLTYPE *get_IsFirstAssignment)(
      __RPC__in ITsSbClientConnection *This,
...
#define ITsSbClientConnection_PutContext(This, contextId, context,             \
                                         existingContext)                      \
...
#define ITsSbClientConnection_get_ClientConnectionPropertySet(This,            \
                                                              ppPropertySet)   \
...
public:
  ...
  CreateLoadBalanceResultObject(
      /* [in] */ __RPC__in BSTR TargetName,
      /* [out] */ __RPC__deref_out_opt ITsSbLoadBalanceResult *
          *ppLBResult) = 0;
  ...
  virtual /* [helpstring][id] */ HRESULT STDMETHODCALLTYPE
      CreatePluginPropertySet(
          /* [retval][out] */ __RPC__deref_out_opt ITsSbPluginPropertySet *
          *ppPropertySet) = 0;

  virtual /* [helpstring][id] */ HRESULT STDMETHODCALLTYPE
      CreateTargetPropertySetObject(
          /* [out] */ __RPC__deref_out_opt ITsSbTargetPropertySet *
          *ppPropertySet) = 0;
  ...
  virtual /* [helpstring][id] */ HRESULT STDMETHODCALLTYPE
      GetResourcePluginStore(
          /* [out] */ __RPC__deref_out_opt ITsSbResourcePluginStore *
          *ppStore) = 0;
  ...
  RegisterForNotification(
      ...
      /* [in] */ __RPC__in_opt ITsSbResourceNotification *
          pPluginNotification) = 0;
  ...
  virtual /* [helpstring][id] */ HRESULT STDMETHODCALLTYPE
      GetInstanceOfGlobalStore(
          /* [out] */ __RPC__deref_out_opt ITsSbGlobalStore *
          *ppGlobalStore) = 0;

  virtual /* [helpstring][id] */ HRESULT STDMETHODCALLTYPE
      CreateEnvironmentPropertySetObject(
          /* [out] */ __RPC__deref_out_opt ITsSbEnvironmentPropertySet *
          *ppPropertySet) = 0;
};
...
typedef struct ITsSbProviderVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in ITsSbProvider *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in ITsSbProvider *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in ITsSbProvider *This);
  ...
  /* [helpstring][id] */ HRESULT(
      STDMETHODCALLTYPE *CreateLoadBalanceResultObject)(
      __RPC__in ITsSbProvider *This,
      /* [in] */ __RPC__in BSTR TargetName,
  ...
  /* [helpstring][id] */ HRESULT(
      STDMETHODCALLTYPE *CreateTargetPropertySetObject)(
      __RPC__in ITsSbProvider *This,
  ...
  /* [helpstring][id] */ HRESULT(
      STDMETHODCALLTYPE *CreateEnvironmentPropertySetObject)(
      __RPC__in ITsSbProvider *This,
      /* [out] */ __RPC__deref_out_opt ITsSbEnvironmentPropertySet *
          *ppPropertySet);
...
interface ITsSbProvider { CONST_VTBL struct ITsSbProviderVtbl *lpVtbl; };
...
#define ITsSbProvider_CreateTargetObject(This, TargetName, EnvironmentName,    \
                                         ppTarget)                             \
  ((This)->lpVtbl->CreateTargetObject(This, TargetName, EnvironmentName,       \
                                      ppTarget))

#define ITsSbProvider_CreateLoadBalanceResultObject(This, TargetName,          \
                                                    ppLBResult)                \
  ((This)->lpVtbl->CreateLoadBalanceResultObject(This, TargetName, ppLBResult))

#define ITsSbProvider_CreateSessionObject(This, TargetName, UserName, Domain,  \
                                          SessionId, ppSession)                \
  ((This)->lpVtbl->CreateSessionObject(This, TargetName, UserName, Domain,     \
                                       SessionId, ppSession))
...
#define ITsSbProvider_CreateEnvironmentObject(This, Name, ServerWeight,        \
                                              ppEnvironment)                   \
  ((This)->lpVtbl->CreateEnvironmentObject(This, Name, ServerWeight,           \
                                           ppEnvironment))
...
#define ITsSbProvider_RegisterForNotification(                                 \
    This, notificationType, ResourceToMonitor, pPluginNotification)            \
  ((This)->lpVtbl->RegisterForNotification(                                    \
      This, notificationType, ResourceToMonitor, pPluginNotification))

#define ITsSbProvider_UnRegisterForNotification(This, notificationType,        \
                                                ResourceToMonitor)             \
  ((This)->lpVtbl->UnRegisterForNotification(This, notificationType,           \
                                             ResourceToMonitor))
...
public:
  ...
  virtual /* [helpstring][id] */ HRESULT STDMETHODCALLTYPE
      EnumerateEnvironments(
          ...
          /* [size_is][out] */ __RPC__out_ecount_full(*pdwCount)
                  ITsSbEnvironment *
              *pVal[]) = 0;
...
typedef struct ITsSbResourcePluginStoreVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in ITsSbResourcePluginStore *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in ITsSbResourcePluginStore *This);
  ...
  /* [helpstring][id] */ HRESULT(
      STDMETHODCALLTYPE *SetTargetPropertyWithVersionCheck)(
      __RPC__in ITsSbResourcePluginStore *This,
      /* [in] */ __RPC__in_opt ITsSbTarget *pTarget,
      /* [in] */ __RPC__in BSTR PropertyName,
      /* [in] */ __RPC__in VARIANT *pProperty);

  DECLSPEC_XFGVIRT(ITsSbResourcePluginStore,
                   SetEnvironmentPropertyWithVersionCheck)
  /* [helpstring][id] */ HRESULT(
      STDMETHODCALLTYPE *SetEnvironmentPropertyWithVersionCheck)(
      __RPC__in ITsSbResourcePluginStore *This,
      /* [in] */ __RPC__in_opt ITsSbEnvironment *pEnvironment,
      /* [in] */ __RPC__in BSTR PropertyName,
      /* [in] */ __RPC__in VARIANT *pProperty);
...
#define ITsSbResourcePluginStore_QueryTarget(This, TargetName, FarmName,       \
                                             ppTarget)                         \
  ((This)->lpVtbl->QueryTarget(This, TargetName, FarmName, ppTarget))

#define ITsSbResourcePluginStore_QuerySessionBySessionId(                      \
    This, dwSessionId, TargetName, ppSession)                                  \
  ((This)->lpVtbl->QuerySessionBySessionId(This, dwSessionId, TargetName,      \
                                           ppSession))
...
#define ITsSbResourcePluginStore_RemoveEnvironmentFromStore(                   \
    This, EnvironmentName, bIgnoreOwner)                                       \
...
#define ITsSbResourcePluginStore_QueryEnvironment(This, EnvironmentName,       \
                                                  ppEnvironment)               \
...
#define ITsSbResourcePluginStore_SaveEnvironment(This, pEnvironment,           \
                                                 bForceWrite)                  \
...
#define ITsSbResourcePluginStore_SetTargetProperty(This, TargetName,           \
                                                   PropertyName, pProperty)    \
  ((This)->lpVtbl->SetTargetProperty(This, TargetName, PropertyName, pProperty))

#define ITsSbResourcePluginStore_SetEnvironmentProperty(                       \
    This, EnvironmentName, PropertyName, pProperty)                            \
  ((This)->lpVtbl->SetEnvironmentProperty(This, EnvironmentName, PropertyName, \
                                          pProperty))

#define ITsSbResourcePluginStore_SetTargetState(This, targetName, newState,    \
                                                pOldState)                     \
...
#define ITsSbResourcePluginStore_EnumerateTargets(                             \
    This, FarmName, EnvName, sortByFieldId, sortyByPropName, pdwCount, pVal)   \
  ((This)->lpVtbl->EnumerateTargets(This, FarmName, EnvName, sortByFieldId,    \
                                    sortyByPropName, pdwCount, pVal))

#define ITsSbResourcePluginStore_EnumerateSessions(                            \
    This, targetName, userName, userDomain, poolName, initialProgram,          \
    pSessionState, pdwCount, ppVal)                                            \
  ((This)->lpVtbl->EnumerateSessions(This, targetName, userName, userDomain,   \
                                     poolName, initialProgram, pSessionState,  \
                                     pdwCount, ppVal))

#define ITsSbResourcePluginStore_GetFarmProperty(This, farmName, propertyName, \
                                                 pVarValue)                    \
...
#define ITsSbResourcePluginStore_SetTargetPropertyWithVersionCheck(            \
    This, pTarget, PropertyName, pProperty)                                    \
  ((This)->lpVtbl->SetTargetPropertyWithVersionCheck(This, pTarget,            \
                                                     PropertyName, pProperty))

#define ITsSbResourcePluginStore_SetEnvironmentPropertyWithVersionCheck(       \
    This, pEnvironment, PropertyName, pProperty)                               \
  ((This)->lpVtbl->SetEnvironmentPropertyWithVersionCheck(                     \
      This, pEnvironment, PropertyName, pProperty))

#define ITsSbResourcePluginStore_AcquireTargetLock(This, targetName,           \
                                                   dwTimeout, ppContext)       \
...
#define ITsSbResourcePluginStore_TestAndSetServerState(                        \
    This, PoolName, ServerFQDN, NewState, TestState, pInitState)               \
  ((This)->lpVtbl->TestAndSetServerState(This, PoolName, ServerFQDN, NewState, \
                                         TestState, pInitState))

#define ITsSbResourcePluginStore_SetServerWaitingToStart(This, PoolName,       \
                                                         serverName)           \
  ((This)->lpVtbl->SetServerWaitingToStart(This, PoolName, serverName))

#define ITsSbResourcePluginStore_GetServerState(This, PoolName, ServerFQDN,    \
                                                pState)                        \
  ((This)->lpVtbl->GetServerState(This, PoolName, ServerFQDN, pState))

#define ITsSbResourcePluginStore_SetServerDrainMode(This, ServerFQDN,          \
                                                    DrainMode)                 \
...
public:
  ...
  virtual /* [helpstring][id] */ HRESULT STDMETHODCALLTYPE EnumerateProperties(
      /* [retval][out] */ __RPC__deref_out_opt ITsSbPropertySet *
      *ppPropertySet) = 0;
...
typedef struct ITsSbFilterPluginStoreVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in ITsSbFilterPluginStore *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in ITsSbFilterPluginStore *This);
...
#define ITsSbFilterPluginStore_AddRef(This) ((This)->lpVtbl->AddRef(This))

#define ITsSbFilterPluginStore_Release(This) ((This)->lpVtbl->Release(This))
...
public:
  ...
  virtual /* [helpstring][id] */ HRESULT STDMETHODCALLTYPE EnumerateTargets(
      ...
      /* [in] */ __RPC__in BSTR EnvName,
      /* [out][in] */ __RPC__inout DWORD * pdwCount,
      /* [size_is][out] */ __RPC__out_ecount_full(*pdwCount) ITsSbTarget *
          *pVal[]) = 0;
  ...
  EnumerateEnvironmentsByProvider(
      /* [in] */ __RPC__in BSTR ProviderName,
      /* [out][in] */ __RPC__inout DWORD * pdwCount,
      /* [size_is][out] */ __RPC__out_ecount_full(*pdwCount) ITsSbEnvironment *
          *ppVal[]) = 0;
  ...
  virtual /* [helpstring][id] */ HRESULT STDMETHODCALLTYPE EnumerateSessions(
      ...
      /* [in] */ __RPC__in TSSESSION_STATE * pSessionState,
      /* [out][in] */ __RPC__inout DWORD * pdwCount,
      /* [size_is][out] */ __RPC__out_ecount_full(*pdwCount) ITsSbSession *
          *ppVal[]) = 0;
...
typedef struct ITsSbGlobalStoreVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in ITsSbGlobalStore *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in ITsSbGlobalStore *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in ITsSbGlobalStore *This);
  ...
  /* [helpstring][id] */ HRESULT(
      STDMETHODCALLTYPE *EnumerateEnvironmentsByProvider)(
      __RPC__in ITsSbGlobalStore *This,
      /* [in] */ __RPC__in BSTR ProviderName,
      /* [out][in] */ __RPC__inout DWORD *pdwCount,
      /* [size_is][out] */
...
interface ITsSbGlobalStore { CONST_VTBL struct ITsSbGlobalStoreVtbl *lpVtbl; };
...
#define ITsSbGlobalStore_QueryTarget(This, ProviderName, TargetName, FarmName, \
                                     ppTarget)                                 \
  ((This)->lpVtbl->QueryTarget(This, ProviderName, TargetName, FarmName,       \
                               ppTarget))

#define ITsSbGlobalStore_QuerySessionBySessionId(                              \
    This, ProviderName, dwSessionId, TargetName, ppSession)                    \
  ((This)->lpVtbl->QuerySessionBySessionId(This, ProviderName, dwSessionId,    \
                                           TargetName, ppSession))
...
#define ITsSbGlobalStore_EnumerateTargets(This, ProviderName, FarmName,        \
                                          EnvName, pdwCount, pVal)             \
  ((This)->lpVtbl->EnumerateTargets(This, ProviderName, FarmName, EnvName,     \
                                    pdwCount, pVal))

#define ITsSbGlobalStore_EnumerateEnvironmentsByProvider(This, ProviderName,   \
                                                         pdwCount, ppVal)      \
  ((This)->lpVtbl->EnumerateEnvironmentsByProvider(This, ProviderName,         \
                                                   pdwCount, ppVal))

#define ITsSbGlobalStore_EnumerateSessions(                                    \
    This, ProviderName, targetName, userName, userDomain, poolName,            \
    initialProgram, pSessionState, pdwCount, ppVal)                            \
  ((This)->lpVtbl->EnumerateSessions(This, ProviderName, targetName, userName, \
                                     userDomain, poolName, initialProgram,     \
                                     pSessionState, pdwCount, ppVal))

#define ITsSbGlobalStore_GetFarmProperty(This, farmName, propertyName,         \
                                         pVarValue)                            \
  ((This)->lpVtbl->GetFarmProperty(This, farmName, propertyName, pVarValue))
...
public:
  ...
  virtual /* [helpstring][id] */ HRESULT STDMETHODCALLTYPE OnJobCancelled(
      void) = 0;
...
typedef struct ITsSbProvisioningPluginNotifySinkVtbl {
  ...
  DECLSPEC_XFGVIRT(ITsSbProvisioningPluginNotifySink,
                   OnVirtualMachineStatusChanged)
  /* [helpstring][id] */ HRESULT(
      STDMETHODCALLTYPE *OnVirtualMachineStatusChanged)(
      __RPC__in ITsSbProvisioningPluginNotifySink *This,
      /* [in] */ __RPC__in VM_NOTIFY_ENTRY *pVmNotifyEntry,
      /* [in] */ VM_NOTIFY_STATUS VmNotifyStatus,
      /* [in] */ HRESULT ErrorCode,
  ...
  DECLSPEC_XFGVIRT(ITsSbProvisioningPluginNotifySink,
                   OnVirtualMachineHostStatusChanged)
  /* [helpstring][id] */ HRESULT(
      STDMETHODCALLTYPE *OnVirtualMachineHostStatusChanged)(
      __RPC__in ITsSbProvisioningPluginNotifySink *This,
      /* [in] */ __RPC__in BSTR VmHost,
      /* [in] */ VM_HOST_NOTIFY_STATUS VmHostNotifyStatus,
      /* [in] */ HRESULT ErrorCode,
...
#define ITsSbProvisioningPluginNotifySink_QueryInterface(This, riid,           \
                                                         ppvObject)            \
  ((This)->lpVtbl->QueryInterface(This, riid, ppvObject))
...
#define ITsSbProvisioningPluginNotifySink_OnVirtualMachineStatusChanged(       \
    This, pVmNotifyEntry, VmNotifyStatus, ErrorCode, ErrorDescr)               \
  ((This)->lpVtbl->OnVirtualMachineStatusChanged(                              \
      This, pVmNotifyEntry, VmNotifyStatus, ErrorCode, ErrorDescr))

#define ITsSbProvisioningPluginNotifySink_OnJobCompleted(This, ResultCode,     \
                                                         ResultDescription)    \
...
#define ITsSbProvisioningPluginNotifySink_LockVirtualMachine(This,             \
                                                             pVmNotifyEntry)   \
  ((This)->lpVtbl->LockVirtualMachine(This, pVmNotifyEntry))

#define ITsSbProvisioningPluginNotifySink_OnVirtualMachineHostStatusChanged(   \
    This, VmHost, VmHostNotifyStatus, ErrorCode, ErrorDescr)                   \
  ((This)->lpVtbl->OnVirtualMachineHostStatusChanged(                          \
      This, VmHost, VmHostNotifyStatus, ErrorCode, ErrorDescr))
...
typedef struct ITsSbProvisioningVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in ITsSbProvisioning *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in ITsSbProvisioning *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in ITsSbProvisioning *This);
...
#define ITsSbProvisioning_AddRef(This) ((This)->lpVtbl->AddRef(This))

#define ITsSbProvisioning_Release(This) ((This)->lpVtbl->Release(This))

#define ITsSbProvisioning_Initialize(This, pProvider, pNotifySink,             \
                                     pPropertySet)                             \
  ((This)->lpVtbl->Initialize(This, pProvider, pNotifySink, pPropertySet))
...
#define ITsSbProvisioning_CreateVirtualMachines(This, JobXmlString, JobGuid,   \
                                                pSink)                         \
  ((This)->lpVtbl->CreateVirtualMachines(This, JobXmlString, JobGuid, pSink))

#define ITsSbProvisioning_PatchVirtualMachines(This, JobXmlString, JobGuid,    \
                                               pSink, pVMPatchInfo)            \
  ((This)->lpVtbl->PatchVirtualMachines(This, JobXmlString, JobGuid, pSink,    \
                                        pVMPatchInfo))

#define ITsSbProvisioning_DeleteVirtualMachines(This, JobXmlString, JobGuid,   \
                                                pSink)                         \
...
typedef struct ITsSbGenericNotifySinkVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in ITsSbGenericNotifySink *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in ITsSbGenericNotifySink *This);
...
#define ITsSbGenericNotifySink_AddRef(This) ((This)->lpVtbl->AddRef(This))

#define ITsSbGenericNotifySink_Release(This) ((This)->lpVtbl->Release(This))
