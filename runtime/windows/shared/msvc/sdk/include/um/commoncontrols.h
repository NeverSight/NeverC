...
WINCOMMCTRLAPI HRESULT WINAPI ImageList_CoCreateInstance(
    _In_ REFCLSID rclsid, _In_opt_ const IUnknown *punkOuter, _In_ REFIID riid,
    _Outptr_ void **ppv);
#endif
...
public:
  ...
  virtual HRESULT STDMETHODCALLTYPE ReplaceIcon(int i,
                                                /* [annotation][in] */
                                                _In_ HICON hicon,
                                                /* [annotation][out] */
                                                _Out_ int *pi) = 0;
  ...
  virtual HRESULT STDMETHODCALLTYPE Replace(int i,
                                            /* [annotation][in] */
                                            _In_ HBITMAP hbmImage,
                                            /* [annotation][unique][in] */
  ...
  virtual HRESULT STDMETHODCALLTYPE AddMasked(
      /* [annotation][in] */
      _In_ HBITMAP hbmImage, COLORREF crMask,
      /* [annotation][out] */
      _Out_ int *pi) = 0;
  ...
  virtual HRESULT STDMETHODCALLTYPE Copy(int iDst,
                                         /* [annotation][in] */
                                         _In_ IUnknown *punkSrc, int iSrc,
                                         UINT uFlags) = 0;

  virtual HRESULT STDMETHODCALLTYPE Merge(int i1,
                                          /* [annotation][in] */
                                          _In_ IUnknown *punk2, int i2, int dx,
                                          int dy, REFIID riid,
                                          /* [annotation][iid_is][out] */
                                          _Outptr_ void **ppv) = 0;

  virtual HRESULT STDMETHODCALLTYPE Clone(REFIID riid,
                                          /* [annotation][iid_is][out] */
                                          _Outptr_ void **ppv) = 0;

  virtual HRESULT STDMETHODCALLTYPE GetImageRect(int i,
                                                 /* [annotation][out] */
                                                 _Out_ RECT *prc) = 0;
  ...
  virtual HRESULT STDMETHODCALLTYPE DragEnter(
      /* [annotation][unique][in] */
      _In_opt_ HWND hwndLock, int x, int y) = 0;
  ...
  virtual HRESULT STDMETHODCALLTYPE SetDragCursorImage(
      /* [annotation][in] */
      _In_ IUnknown * punk, int iDrag, int dxHotspot, int dyHotspot) = 0;
  ...
  virtual HRESULT STDMETHODCALLTYPE GetDragImage(
      ...
      _Out_opt_ POINT * ppt,
      /* [annotation][out] */
      _Out_opt_ POINT * pptHotspot, REFIID riid,
      /* [annotation][iid_is][out] */
      _Outptr_ void **ppv) = 0;

  virtual HRESULT STDMETHODCALLTYPE GetItemFlags(int i,
                                                 /* [annotation][out] */
...
typedef struct IImageListVtbl {
  ...
  HRESULT(STDMETHODCALLTYPE *Add)(IImageList *This,
                                  /* [annotation][in] */
                                  _In_ HBITMAP hbmImage,
                                  /* [annotation][unique][in] */
                                  _In_opt_ HBITMAP hbmMask,
  ...
  HRESULT(STDMETHODCALLTYPE *AddMasked)(IImageList *This,
                                        /* [annotation][in] */
                                        _In_ HBITMAP hbmImage, COLORREF crMask,
                                        /* [annotation][out] */
                                        _Out_ int *pi);
  ...
  HRESULT(STDMETHODCALLTYPE *Clone)(IImageList *This, REFIID riid,
                                    /* [annotation][iid_is][out] */
                                    _Outptr_ void **ppv);
  ...
  HRESULT(STDMETHODCALLTYPE *GetIconSize)(IImageList *This,
                                          /* [annotation][out] */
                                          _Out_ int *cx,
                                          /* [annotation][out] */
                                          _Out_ int *cy);
  ...
  HRESULT(STDMETHODCALLTYPE *GetImageCount)(IImageList *This,
                                            /* [annotation][out] */
                                            _Out_ int *pi);
  ...
  HRESULT(STDMETHODCALLTYPE *GetBkColor)(IImageList *This,
                                         /* [annotation][out] */
                                         _Out_ COLORREF *pclr);
  ...
  HRESULT(STDMETHODCALLTYPE *DragEnter)(IImageList *This,
                                        /* [annotation][unique][in] */
                                        _In_opt_ HWND hwndLock, int x, int y);

  DECLSPEC_XFGVIRT(IImageList, DragLeave)
  HRESULT(STDMETHODCALLTYPE *DragLeave)(IImageList *This,
                                        /* [annotation][unique][in] */
  ...
  HRESULT(STDMETHODCALLTYPE *GetDragImage)(IImageList *This,
                                           /* [annotation][out] */
                                           _Out_opt_ POINT *ppt,
                                           /* [annotation][out] */
...
typedef struct IImageList2Vtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(IImageList2 *This,
                                             /* [in] */ REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);
  ...
  DECLSPEC_XFGVIRT(IImageList, Add)
  HRESULT(STDMETHODCALLTYPE *Add)(IImageList2 *This,
                                  /* [annotation][in] */
                                  _In_ HBITMAP hbmImage,
                                  /* [annotation][unique][in] */
                                  _In_opt_ HBITMAP hbmMask,
  ...
  DECLSPEC_XFGVIRT(IImageList, ReplaceIcon)
  HRESULT(STDMETHODCALLTYPE *ReplaceIcon)(IImageList2 *This, int i,
                                          /* [annotation][in] */
                                          _In_ HICON hicon,
                                          /* [annotation][out] */
                                          _Out_ int *pi);
  ...
  DECLSPEC_XFGVIRT(IImageList, AddMasked)
  HRESULT(STDMETHODCALLTYPE *AddMasked)(IImageList2 *This,
                                        /* [annotation][in] */
                                        _In_ HBITMAP hbmImage, COLORREF crMask,
                                        /* [annotation][out] */
                                        _Out_ int *pi);
  ...
  DECLSPEC_XFGVIRT(IImageList, Merge)
  HRESULT(STDMETHODCALLTYPE *Merge)(IImageList2 *This, int i1,
                                    /* [annotation][in] */
                                    _In_ IUnknown *punk2, int i2, int dx,
                                    int dy, REFIID riid,
                                    /* [annotation][iid_is][out] */
  ...
  DECLSPEC_XFGVIRT(IImageList, Clone)
  HRESULT(STDMETHODCALLTYPE *Clone)(IImageList2 *This, REFIID riid,
                                    /* [annotation][iid_is][out] */
                                    _Outptr_ void **ppv);

  DECLSPEC_XFGVIRT(IImageList, GetImageRect)
  HRESULT(STDMETHODCALLTYPE *GetImageRect)(IImageList2 *This, int i,
                                           /* [annotation][out] */
                                           _Out_ RECT *prc);

  DECLSPEC_XFGVIRT(IImageList, GetIconSize)
  HRESULT(STDMETHODCALLTYPE *GetIconSize)(IImageList2 *This,
                                          /* [annotation][out] */
                                          _Out_ int *cx,
                                          /* [annotation][out] */
                                          _Out_ int *cy);
  ...
  DECLSPEC_XFGVIRT(IImageList, GetImageCount)
  HRESULT(STDMETHODCALLTYPE *GetImageCount)(IImageList2 *This,
                                            /* [annotation][out] */
                                            _Out_ int *pi);
  ...
  DECLSPEC_XFGVIRT(IImageList, GetBkColor)
  HRESULT(STDMETHODCALLTYPE *GetBkColor)(IImageList2 *This,
                                         /* [annotation][out] */
                                         _Out_ COLORREF *pclr);
  ...
  DECLSPEC_XFGVIRT(IImageList, DragEnter)
  HRESULT(STDMETHODCALLTYPE *DragEnter)(IImageList2 *This,
                                        /* [annotation][unique][in] */
                                        _In_opt_ HWND hwndLock, int x, int y);

  DECLSPEC_XFGVIRT(IImageList, DragLeave)
  HRESULT(STDMETHODCALLTYPE *DragLeave)(IImageList2 *This,
                                        /* [annotation][unique][in] */
                                        _In_opt_ HWND hwndLock);
  ...
  DECLSPEC_XFGVIRT(IImageList, GetDragImage)
  HRESULT(STDMETHODCALLTYPE *GetDragImage)(IImageList2 *This,
                                           /* [annotation][out] */
                                           _Out_opt_ POINT *ppt,
                                           /* [annotation][out] */
                                           _Out_opt_ POINT *pptHotspot,
  ...
  HRESULT(STDMETHODCALLTYPE *GetOriginalSize)(IImageList2 *This,
                                              /* [in] */ int iImage,
                                              /* [in] */ DWORD dwFlags,
                                              /* [annotation][out] */
                                              _Out_ int *pcx,
  ...
  HRESULT(STDMETHODCALLTYPE *SetOriginalSize)(IImageList2 *This,
                                              /* [in] */ int iImage,
                                              /* [in] */ int cx,
                                              /* [in] */ int cy);

  DECLSPEC_XFGVIRT(IImageList2, SetCallback)
  HRESULT(STDMETHODCALLTYPE *SetCallback)(IImageList2 *This,
                                          /* [annotation][unique][in] */
                                          _In_opt_ IUnknown *punk);

  DECLSPEC_XFGVIRT(IImageList2, GetCallback)
  HRESULT(STDMETHODCALLTYPE *GetCallback)(IImageList2 *This,
                                          /* [in] */ REFIID riid,
                                          /* [annotation][iid_is][out] */
                                          _Outptr_ void **ppv);

  DECLSPEC_XFGVIRT(IImageList2, ForceImagePresent)
  HRESULT(STDMETHODCALLTYPE *ForceImagePresent)(IImageList2 *This,
                                                /* [in] */ int iImage,
                                                DWORD dwFlags);

  DECLSPEC_XFGVIRT(IImageList2, DiscardImages)
  HRESULT(STDMETHODCALLTYPE *DiscardImages)(IImageList2 *This,
                                            /* [in] */ int iFirstImage,
                                            /* [in] */ int iLastImage,
                                            /* [in] */ DWORD dwFlags);
  ...
  HRESULT(STDMETHODCALLTYPE *Initialize)(IImageList2 *This,
                                         /* [in] */ int cx,
                                         /* [in] */ int cy,
                                         /* [in] */ UINT flags,
                                         /* [in] */ int cInitial,
  ...
  HRESULT(STDMETHODCALLTYPE *Replace2)(IImageList2 *This,
                                       /* [in] */ int i,
                                       /* [annotation][in] */
                                       _In_ HBITMAP hbmImage,
                                       /* [annotation][unique][in] */
...
interface IImageList2 { CONST_VTBL struct IImageList2Vtbl *lpVtbl; };
