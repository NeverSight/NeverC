...
EFaultRepRetVal APIENTRY ReportFault(_In_ LPEXCEPTION_POINTERS pep,
                                     _In_ DWORD dwOpt);
...
typedef EFaultRepRetVal(APIENTRY *pfn_REPORTFAULT)(_In_ LPEXCEPTION_POINTERS,
                                                   _In_ DWORD);
...
HRESULT
WINAPI
WerReportHang(_In_ HWND hwndHungApp, _In_opt_ PCWSTR pwzHungApplicationName);
