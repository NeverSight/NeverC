...
typedef struct ICertGetConfigVtbl {
  ...
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in ICertGetConfig *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in ICertGetConfig *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in ICertGetConfig *This);
...
interface ICertGetConfig { CONST_VTBL struct ICertGetConfigVtbl *lpVtbl; };
...
typedef struct ICertConfigVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in ICertConfig *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in ICertConfig *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in ICertConfig *This);
  ...
  HRESULT(STDMETHODCALLTYPE *Next)(__RPC__in ICertConfig *This,
...
interface ICertConfig { CONST_VTBL struct ICertConfigVtbl *lpVtbl; };
...
typedef struct ICertConfig2Vtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in ICertConfig2 *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in ICertConfig2 *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in ICertConfig2 *This);
  ...
  DECLSPEC_XFGVIRT(ICertConfig, Next)
  HRESULT(STDMETHODCALLTYPE *Next)(__RPC__in ICertConfig2 *This,
                                   /* [retval][out] */ __RPC__out LONG *pIndex);
  ...
  HRESULT(STDMETHODCALLTYPE *SetSharedFolder)(__RPC__in ICertConfig2 *This,
                                              /* [in] */ __RPC__in const BSTR
                                                  strSharedFolder);

  END_INTERFACE
} ICertConfig2Vtbl;

interface ICertConfig2 { CONST_VTBL struct ICertConfig2Vtbl *lpVtbl; };
...
typedef struct ICertRequestVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in ICertRequest *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in ICertRequest *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in ICertRequest *This);
...
interface ICertRequest { CONST_VTBL struct ICertRequestVtbl *lpVtbl; };
...
typedef struct ICertRequest2Vtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in ICertRequest2 *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in ICertRequest2 *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in ICertRequest2 *This);
...
interface ICertRequest2 { CONST_VTBL struct ICertRequest2Vtbl *lpVtbl; };
...
typedef struct ICertRequest3Vtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in ICertRequest3 *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in ICertRequest3 *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in ICertRequest3 *This);
...
interface ICertRequest3 { CONST_VTBL struct ICertRequest3Vtbl *lpVtbl; };
...
#define ICertRequest3_GetIDsOfNames(This, riid, rgszNames, cNames, lcid,       \
                                    rgDispId)                                  \
  ((This)->lpVtbl->GetIDsOfNames(This, riid, rgszNames, cNames, lcid, rgDispId))

#define ICertRequest3_Invoke(This, dispIdMember, riid, lcid, wFlags,           \
                             pDispParams, pVarResult, pExcepInfo, puArgErr)    \
  ((This)->lpVtbl->Invoke(This, dispIdMember, riid, lcid, wFlags, pDispParams, \
                          pVarResult, pExcepInfo, puArgErr))

#define ICertRequest3_Submit(This, Flags, strRequest, strAttributes,           \
                             strConfig, pDisposition)                          \
  ((This)->lpVtbl->Submit(This, Flags, strRequest, strAttributes, strConfig,   \
                          pDisposition))

#define ICertRequest3_RetrievePending(This, RequestId, strConfig,              \
                                      pDisposition)                            \
  ((This)->lpVtbl->RetrievePending(This, RequestId, strConfig, pDisposition))
...
#define ICertRequest3_GetCACertificate(This, fExchangeCertificate, strConfig,  \
                                       Flags, pstrCertificate)                 \
  ((This)->lpVtbl->GetCACertificate(This, fExchangeCertificate, strConfig,     \
                                    Flags, pstrCertificate))
...
#define ICertRequest3_GetIssuedCertificate(This, strConfig, RequestId,         \
                                           strSerialNumber, pDisposition)      \
  ((This)->lpVtbl->GetIssuedCertificate(This, strConfig, RequestId,            \
                                        strSerialNumber, pDisposition))

#define ICertRequest3_GetErrorMessageText(This, hrMessage, Flags,              \
                                          pstrErrorMessageText)                \
  ((This)->lpVtbl->GetErrorMessageText(This, hrMessage, Flags,                 \
                                       pstrErrorMessageText))

#define ICertRequest3_GetCAProperty(This, strConfig, PropId, PropIndex,        \
                                    PropType, Flags, pvarPropertyValue)        \
  ((This)->lpVtbl->GetCAProperty(This, strConfig, PropId, PropIndex, PropType, \
                                 Flags, pvarPropertyValue))
...
#define ICertRequest3_GetCAPropertyDisplayName(This, strConfig, PropId,        \
                                               pstrDisplayName)                \
  ((This)->lpVtbl->GetCAPropertyDisplayName(This, strConfig, PropId,           \
                                            pstrDisplayName))

#define ICertRequest3_GetFullResponseProperty(                                 \
    This, PropId, PropIndex, PropType, Flags, pvarPropertyValue)               \
  ((This)->lpVtbl->GetFullResponseProperty(This, PropId, PropIndex, PropType,  \
                                           Flags, pvarPropertyValue))

#define ICertRequest3_SetCredential(This, hWnd, AuthType, strCredential,       \
                                    strPassword)                               \
  ((This)->lpVtbl->SetCredential(This, hWnd, AuthType, strCredential,          \
                                 strPassword))

#define ICertRequest3_GetRequestIdString(This, pstrRequestId)                  \
  ((This)->lpVtbl->GetRequestIdString(This, pstrRequestId))

#define ICertRequest3_GetIssuedCertificate2(This, strConfig, strRequestId,     \
                                            strSerialNumber, pDisposition)     \
  ((This)->lpVtbl->GetIssuedCertificate2(This, strConfig, strRequestId,        \
                                         strSerialNumber, pDisposition))
...
#define CR_IN_CLIENTFLAGSMASK                                                  \
  ((((((CR_IN_ENCODEMASK | CR_IN_RPC) | CR_IN_MACHINE) | CR_IN_CLIENTIDNONE) | \
     CR_IN_CONNECTONLY) |                                                      \
