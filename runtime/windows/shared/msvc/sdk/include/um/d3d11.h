...
typedef struct ID3D11ResourceVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(ID3D11Resource *This,
                                             /* [in] */ REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);
  ...
  DECLSPEC_XFGVIRT(ID3D11DeviceChild, SetPrivateData)
  HRESULT(STDMETHODCALLTYPE *SetPrivateData)(ID3D11Resource *This,
                                             /* [annotation] */
                                             _In_ REFGUID guid,
                                             /* [annotation] */
                                             _In_ UINT DataSize,
...
typedef struct ID3D11BufferVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(ID3D11Buffer *This,
                                             /* [in] */ REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);
  ...
  DECLSPEC_XFGVIRT(ID3D11DeviceChild, SetPrivateData)
  HRESULT(STDMETHODCALLTYPE *SetPrivateData)(ID3D11Buffer *This,
                                             /* [annotation] */
                                             _In_ REFGUID guid,
                                             /* [annotation] */
                                             _In_ UINT DataSize,
...
typedef struct ID3D11Texture1DVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(ID3D11Texture1D *This,
                                             /* [in] */ REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);
...
typedef struct ID3D11Texture2DVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(ID3D11Texture2D *This,
                                             /* [in] */ REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);
...
typedef struct ID3D11Texture3DVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(ID3D11Texture3D *This,
                                             /* [in] */ REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);
...
typedef struct ID3D11ViewVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(ID3D11View *This,
                                             /* [in] */ REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);
  ...
  DECLSPEC_XFGVIRT(ID3D11DeviceChild, SetPrivateData)
  HRESULT(STDMETHODCALLTYPE *SetPrivateData)(ID3D11View *This,
                                             /* [annotation] */
                                             _In_ REFGUID guid,
                                             /* [annotation] */
                                             _In_ UINT DataSize,
...
struct CD3D11_SHADER_RESOURCE_VIEW_DESC
  ...
  explicit CD3D11_SHADER_RESOURCE_VIEW_DESC(_In_ ID3D11Buffer *,
                                            DXGI_FORMAT format,
...
struct CD3D11_RENDER_TARGET_VIEW_DESC : public D3D11_RENDER_TARGET_VIEW_DESC {
  ...
  explicit CD3D11_RENDER_TARGET_VIEW_DESC(_In_ ID3D11Buffer *,
...
struct CD3D11_VIEWPORT : public D3D11_VIEWPORT {
  ...
  explicit CD3D11_VIEWPORT(_In_ ID3D11Buffer *,
  ...
  explicit CD3D11_VIEWPORT(_In_ ID3D11Texture1D *pTex1D,
                           _In_ ID3D11RenderTargetView *pRTView,
                           FLOAT topLeftX = 0.0f,
                           FLOAT minDepth = D3D11_MIN_DEPTH,
                           FLOAT maxDepth = D3D11_MAX_DEPTH) {
    ...
    TopLeftY = 0.0f;
    Width =
        static_cast<FLOAT>(SubResourceWidth ? SubResourceWidth : 1) - topLeftX;
    Height = 1.0f;
    MinDepth = minDepth;
    MaxDepth = maxDepth;
  }
  explicit CD3D11_VIEWPORT(_In_ ID3D11Texture2D *pTex2D,
                           _In_ ID3D11RenderTargetView *pRTView,
    ...
    Width =
        static_cast<FLOAT>(SubResourceWidth ? SubResourceWidth : 1) - topLeftX;
    Height = static_cast<FLOAT>(SubResourceHeight ? SubResourceHeight : 1) -
             topLeftY;
    MinDepth = minDepth;
    MaxDepth = maxDepth;
  }
  explicit CD3D11_VIEWPORT(_In_ ID3D11Texture3D *pTex3D,
                           _In_ ID3D11RenderTargetView *pRTView,
                           FLOAT topLeftX = 0.0f, FLOAT topLeftY = 0.0f,
                           FLOAT minDepth = D3D11_MIN_DEPTH,
                           FLOAT maxDepth = D3D11_MAX_DEPTH) {
...
struct CD3D11_DEPTH_STENCIL_VIEW_DESC : public D3D11_DEPTH_STENCIL_VIEW_DESC {
  ...
  explicit CD3D11_DEPTH_STENCIL_VIEW_DESC(
      _In_ ID3D11Texture1D *pTex1D, D3D11_DSV_DIMENSION viewDimension,
      DXGI_FORMAT format = DXGI_FORMAT_UNKNOWN, UINT mipSlice = 0,
      UINT firstArraySlice = 0, UINT arraySize = -1, UINT flags = 0) {
    ViewDimension = viewDimension;
    Flags = flags;
  ...
  explicit CD3D11_DEPTH_STENCIL_VIEW_DESC(
      _In_ ID3D11Texture2D *pTex2D, D3D11_DSV_DIMENSION viewDimension,
      DXGI_FORMAT format = DXGI_FORMAT_UNKNOWN, UINT mipSlice = 0,
      UINT firstArraySlice = 0, UINT arraySize = -1, UINT flags = 0) {
    ViewDimension = viewDimension;
    Flags = flags;
...
struct CD3D11_UNORDERED_ACCESS_VIEW_DESC
  ...
  explicit CD3D11_UNORDERED_ACCESS_VIEW_DESC(_In_ ID3D11Buffer *,
                                             DXGI_FORMAT format,
                                             UINT firstElement,
...
// D3D11_FILTER_REDUCTION_TYPE enum replaced it. Old code that uses
// D3D11_COMPARISON_FILTERING_BIT and would never use D3D11_FILTER_MINIMUM_* or
// D3D11_FILTER_MAXIMUM_* will still work fine though, so the define is left to
// avoid breaks.
...
#define D3D11_ENCODE_BASIC_FILTER(min, mag, mip, reduction)                    \
  ((D3D11_FILTER)((((min) & D3D11_FILTER_TYPE_MASK)                            \
                  ...
                  (((reduction) & D3D11_FILTER_REDUCTION_TYPE_MASK)            \
...
#define D3D11_ENCODE_ANISOTROPIC_FILTER(reduction)                             \
  ((D3D11_FILTER)(D3D11_ANISOTROPIC_FILTERING_BIT |                            \
                  D3D11_ENCODE_BASIC_FILTER(                                   \
                      ...
                      D3D11_FILTER_TYPE_LINEAR, reduction)))
...
typedef struct ID3D11QueryVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(ID3D11Query *This,
                                             /* [in] */ REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);
  ...
  DECLSPEC_XFGVIRT(ID3D11DeviceChild, SetPrivateData)
  HRESULT(STDMETHODCALLTYPE *SetPrivateData)(ID3D11Query *This,
                                             /* [annotation] */
                                             _In_ REFGUID guid,
                                             /* [annotation] */
                                             _In_ UINT DataSize,
...
typedef struct ID3D11PredicateVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(ID3D11Predicate *This,
                                             /* [in] */ REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);
...
typedef struct ID3D11CounterVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(ID3D11Counter *This,
                                             /* [in] */ REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);
  ...
  DECLSPEC_XFGVIRT(ID3D11DeviceChild, SetPrivateData)
  HRESULT(STDMETHODCALLTYPE *SetPrivateData)(ID3D11Counter *This,
                                             /* [annotation] */
                                             _In_ REFGUID guid,
                                             /* [annotation] */
                                             _In_ UINT DataSize,
...
typedef struct ID3D11ClassInstanceVtbl {
  ...
  void(STDMETHODCALLTYPE *GetInstanceName)(ID3D11ClassInstance *This,
                                           /* [annotation] */
                                           _Out_writes_opt_(*pBufferLength)
                                               LPSTR pInstanceName,
                                           /* [annotation] */
...
public:
  ...
  virtual void STDMETHODCALLTYPE PSGetShaderResources(
      ...
      _In_range_(0, D3D11_COMMONSHADER_INPUT_RESOURCE_SLOT_COUNT - StartSlot)
          UINT NumViews,
      /* [annotation] */
      _Out_writes_opt_(NumViews) ID3D11ShaderResourceView *
  ...
  virtual void STDMETHODCALLTYPE PSGetShader(
      ...
      /* [annotation] */
      _Out_writes_opt_(*pNumClassInstances) ID3D11ClassInstance *
          *ppClassInstances,
      /* [annotation] */
  ...
  virtual void STDMETHODCALLTYPE OMGetRenderTargetsAndUnorderedAccessViews(
      ...
      /* [annotation] */
      _Out_writes_opt_(NumUAVs) ID3D11UnorderedAccessView *
...
DEFINE_GUID(D3D11_DECODER_PROFILE_HEVC_VLD_MONOCHROME, 0x0685b993, 0x3d8c,
            0x43a0, 0x8b, 0x28, 0xd7, 0x4c, 0x2d, 0x68, 0x99, 0xa4);
DEFINE_GUID(D3D11_DECODER_PROFILE_HEVC_VLD_MONOCHROME10, 0x142a1d0f, 0x69dd,
            0x4ec9, 0x85, 0x91, 0xb1, 0x2f, 0xfc, 0xb9, 0x1a, 0x29);
DEFINE_GUID(D3D11_DECODER_PROFILE_HEVC_VLD_MAIN12, 0x1a72925f, 0x0c2c, 0x4f15,
            0x96, 0xfb, 0xb1, 0x7d, 0x14, 0x73, 0x60, 0x3f);
DEFINE_GUID(D3D11_DECODER_PROFILE_HEVC_VLD_MAIN10_422, 0x0bac4fe5, 0x1532,
            0x4429, 0xa8, 0x54, 0xf8, 0x4d, 0xe0, 0x49, 0x53, 0xdb);
DEFINE_GUID(D3D11_DECODER_PROFILE_HEVC_VLD_MAIN12_422, 0x55bcac81, 0xf311,
            0x4093, 0xa7, 0xd0, 0x1c, 0xbc, 0x0b, 0x84, 0x9b, 0xee);
DEFINE_GUID(D3D11_DECODER_PROFILE_HEVC_VLD_MAIN_444, 0x4008018f, 0xf537, 0x4b36,
            0x98, 0xcf, 0x61, 0xaf, 0x8a, 0x2c, 0x1a, 0x33);
DEFINE_GUID(D3D11_DECODER_PROFILE_HEVC_VLD_MAIN10_EXT, 0x9cc55490, 0xe37c,
            0x4932, 0x86, 0x84, 0x49, 0x20, 0xf9, 0xf6, 0x40, 0x9c);
DEFINE_GUID(D3D11_DECODER_PROFILE_HEVC_VLD_MAIN10_444, 0x0dabeffa, 0x4458,
            0x4602, 0xbc, 0x03, 0x07, 0x95, 0x65, 0x9d, 0x61, 0x7c);
DEFINE_GUID(D3D11_DECODER_PROFILE_HEVC_VLD_MAIN12_444, 0x9798634d, 0xfe9d,
            0x48e5, 0xb4, 0xda, 0xdb, 0xec, 0x45, 0xb3, 0xdf, 0x01);
DEFINE_GUID(D3D11_DECODER_PROFILE_HEVC_VLD_MAIN16, 0xa4fbdbb0, 0xa113, 0x482b,
...
DEFINE_GUID(D3D11_DECODER_PROFILE_AV1_VLD_PROFILE0, 0xb8be4ccb, 0xcf53, 0x46ba,
            0x8d, 0x59, 0xd6, 0xb8, 0xa6, 0xda, 0x5d, 0x2a);
DEFINE_GUID(D3D11_DECODER_PROFILE_AV1_VLD_PROFILE1, 0x6936ff0f, 0x45b1, 0x4163,
            0x9c, 0xc1, 0x64, 0x6e, 0xf6, 0x94, 0x61, 0x08);
DEFINE_GUID(D3D11_DECODER_PROFILE_AV1_VLD_PROFILE2, 0x0c5f2aa1, 0xe541, 0x4089,
            0xbb, 0x7b, 0x98, 0x11, 0x0a, 0x19, 0xd7, 0xc8);
DEFINE_GUID(D3D11_DECODER_PROFILE_AV1_VLD_12BIT_PROFILE2, 0x17127009, 0xa00f,
            0x4ce1, 0x99, 0x4e, 0xbf, 0x40, 0x81, 0xf6, 0xf3, 0xf0);
DEFINE_GUID(D3D11_DECODER_PROFILE_AV1_VLD_12BIT_PROFILE2_420, 0x2d80bed6,
            0x9cac, 0x4835, 0x9e, 0x91, 0x32, 0x7b, 0xbc, 0x4f, 0x9e, 0xe8);
DEFINE_GUID(D3D11_DECODER_PROFILE_MJPEG_VLD_420, 0x725cb506, 0x0c29, 0x43c4,
            0x94, 0x40, 0x8e, 0x93, 0x97, 0x90, 0x3a, 0x04);
DEFINE_GUID(D3D11_DECODER_PROFILE_MJPEG_VLD_422, 0x5b77b9cd, 0x1a35, 0x4c30,
            0x9f, 0xd8, 0xef, 0x4b, 0x60, 0xc0, 0x35, 0xdd);
DEFINE_GUID(D3D11_DECODER_PROFILE_MJPEG_VLD_444, 0xd95161f9, 0x0d44, 0x47e6,
            0xbc, 0xf5, 0x1b, 0xfb, 0xfb, 0x26, 0x8f, 0x97);
DEFINE_GUID(D3D11_DECODER_PROFILE_MJPEG_VLD_4444, 0xc91748d5, 0xfd18, 0x4aca,
            0x9d, 0xb3, 0x3a, 0x66, 0x34, 0xab, 0x54, 0x7d);
DEFINE_GUID(D3D11_DECODER_PROFILE_JPEG_VLD_420, 0xcf782c83, 0xbef5, 0x4a2c,
...
DEFINE_GUID(D3D11_DECODER_PROFILE_JPEG_VLD_444, 0x4cd00e17, 0x89ba, 0x48ef,
...
DEFINE_GUID(D3D11_CRYPTO_TYPE_AES128_CTR, 0x9b6bd711, 0x4f74, 0x41c9, 0x9e,
            0x7b, 0xb, 0xe2, 0xd7, 0xd9, 0x3b, 0x4f);
DEFINE_GUID(D3D11_DECODER_ENCRYPTION_HW_CENC, 0x89d6ac4f, 0x9f2, 0x4229, 0xb2,
            0xcd, 0x37, 0x74, 0xa, 0x6d, 0xfd, 0x81);
DEFINE_GUID(D3D11_DECODER_BITSTREAM_ENCRYPTION_TYPE_CENC, 0xb0405235, 0xc13d,
            0x44f2, 0x9a, 0xe5, 0xdd, 0x48, 0xe0, 0x8e, 0x5b, 0x67);
DEFINE_GUID(D3D11_DECODER_BITSTREAM_ENCRYPTION_TYPE_CBCS, 0x422d9319, 0x9d21,
            0x4bb7, 0x93, 0x71, 0xfa, 0xf5, 0xa8, 0x2c, 0x3e, 0x04);
...
typedef struct ID3D11AuthenticatedChannelVtbl {
  ...
  HRESULT(STDMETHODCALLTYPE *GetCertificate)(ID3D11AuthenticatedChannel *This,
                                             ...
                                             _In_ UINT CertificateSize,
                                             /* [annotation] */
                                             _Out_writes_bytes_(CertificateSize)
                                                 BYTE *pCertificate);
...
DEFINE_GUID(D3D11_AUTHENTICATED_QUERY_PROTECTION, 0xa84eb584, 0xc495, 0x48aa,
...
DEFINE_GUID(D3D11_AUTHENTICATED_QUERY_CRYPTO_SESSION, 0x2634499e, 0xd018,
            0x4d74, 0xac, 0x17, 0x7f, 0x72, 0x40, 0x59, 0x52, 0x8d);
...
DEFINE_GUID(D3D11_AUTHENTICATED_QUERY_RESTRICTED_SHARED_RESOURCE_PROCESS,
            0x649bbadb, 0xf0f4, 0x4639, 0xa1, 0x5b, 0x24, 0x39, 0x3f, 0xc3,
            0xab, 0xac);
DEFINE_GUID(
...
DEFINE_GUID(D3D11_AUTHENTICATED_QUERY_OUTPUT_ID_COUNT, 0x2c042b5e, 0x8c07,
            0x46d5, 0xaa, 0xbe, 0x8f, 0x75, 0xcb, 0xad, 0x4c, 0x31);
DEFINE_GUID(D3D11_AUTHENTICATED_QUERY_OUTPUT_ID, 0x839ddca3, 0x9b4e, 0x41e4,
            0xb0, 0x53, 0x89, 0x2b, 0xd2, 0xa1, 0x1e, 0xe7);
DEFINE_GUID(D3D11_AUTHENTICATED_QUERY_ACCESSIBILITY_ATTRIBUTES, 0x6214d9d2,
            0x432c, 0x4abb, 0x9f, 0xce, 0x21, 0x6e, 0xea, 0x26, 0x9e, 0x3b);
DEFINE_GUID(D3D11_AUTHENTICATED_QUERY_ENCRYPTION_WHEN_ACCESSIBLE_GUID_COUNT,
            0xb30f7066, 0x203c, 0x4b07, 0x93, 0xfc, 0xce, 0xaa, 0xfd, 0x61,
            0x24, 0x1e);
DEFINE_GUID(D3D11_AUTHENTICATED_QUERY_ENCRYPTION_WHEN_ACCESSIBLE_GUID,
            0xf83a5958, 0xe986, 0x4bda, 0xbe, 0xb0, 0x41, 0x1f, 0x6a, 0x7a, 0x1,
            0xb7);
DEFINE_GUID(D3D11_AUTHENTICATED_QUERY_CURRENT_ENCRYPTION_WHEN_ACCESSIBLE,
            0xec1791c7, 0xdad3, 0x4f15, 0x9e, 0xc3, 0xfa, 0xa9, 0x3d, 0x60,
            0xd4, 0xf0);
DEFINE_GUID(D3D11_AUTHENTICATED_CONFIGURE_INITIALIZE, 0x6114bdb, 0x3523, 0x470a,
            0x8d, 0xca, 0xfb, 0xc2, 0x84, 0x51, 0x54, 0xf0);
DEFINE_GUID(D3D11_AUTHENTICATED_CONFIGURE_PROTECTION, 0x50455658, 0x3f47,
            0x4362, 0xbf, 0x99, 0xbf, 0xdf, 0xcd, 0xe9, 0xed, 0x29);
DEFINE_GUID(D3D11_AUTHENTICATED_CONFIGURE_CRYPTO_SESSION, 0x6346cc54, 0x2cfc,
            0x4ad4, 0x82, 0x24, 0xd1, 0x58, 0x37, 0xde, 0x77, 0x0);
DEFINE_GUID(D3D11_AUTHENTICATED_CONFIGURE_SHARED_RESOURCE, 0x772d047, 0x1b40,
            0x48e8, 0x9c, 0xa6, 0xb5, 0xf5, 0x10, 0xde, 0x9f, 0x1);
DEFINE_GUID(D3D11_AUTHENTICATED_CONFIGURE_ENCRYPTION_WHEN_ACCESSIBLE,
            0x41fff286, 0x6ae0, 0x4d43, 0x9d, 0x55, 0xa4, 0x6e, 0x9e, 0xfd,
            0x15, 0x8a);
...
DEFINE_GUID(D3D11_KEY_EXCHANGE_RSAES_OAEP, 0xc1949895, 0xd72a, 0x4a1d, 0x8e,
            0x5d, 0xed, 0x85, 0x7d, 0x17, 0x15, 0x20);
...
public:
  ...
  virtual APP_DEPRECATED_HRESULT STDMETHODCALLTYPE
...
#define ID3D11VideoContext_GetDecoderBuffer(This, pDecoder, Type, pBufferSize, \
                                            ppBuffer)                          \
...
#define ID3D11VideoContext_DecoderBeginFrame(This, pDecoder, pView,            \
...
#define ID3D11VideoContext_SubmitDecoderBuffers(This, pDecoder, NumBuffers,    \
                                                pBufferDesc)                   \
...
#define ID3D11VideoContext_VideoProcessorSetOutputTargetRect(                  \
...
#define ID3D11VideoContext_VideoProcessorSetOutputColorSpace(                  \
...
#define ID3D11VideoContext_VideoProcessorSetOutputStereoMode(                  \
...
#define ID3D11VideoContext_VideoProcessorGetOutputTargetRect(                  \
...
#define ID3D11VideoContext_VideoProcessorGetOutputColorSpace(                  \
    This, pVideoProcessor, pColorSpace)                                        \
...
#define ID3D11VideoContext_VideoProcessorGetOutputStereoMode(                  \
...
#define ID3D11VideoContext_VideoProcessorBlt(                                  \
...
#define ID3D11VideoContext_NegotiateCryptoSessionKeyExchange(                  \
    This, pCryptoSession, DataSize, pData)                                     \
  ((This)->lpVtbl->NegotiateCryptoSessionKeyExchange(This, pCryptoSession,     \
                                                     DataSize, pData))

#define ID3D11VideoContext_EncryptionBlt(This, pCryptoSession, pSrcSurface,    \
...
#define ID3D11VideoContext_GetEncryptionBltKey(This, pCryptoSession, KeySize,  \
                                               pReadbackKey)                   \
...
typedef struct ID3D11DeviceVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(ID3D11Device *This,
                                             /* [in] */ REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);
...
typedef HRESULT(WINAPI *PFN_D3D11_CREATE_DEVICE)(
    ...
    UINT, _COM_Outptr_opt_ ID3D11Device **, _Out_opt_ D3D_FEATURE_LEVEL *,
...
typedef HRESULT(WINAPI *PFN_D3D11_CREATE_DEVICE_AND_SWAP_CHAIN)(
    _In_opt_ IDXGIAdapter *, D3D_DRIVER_TYPE, HMODULE, UINT,
    _In_reads_opt_(FeatureLevels) CONST D3D_FEATURE_LEVEL *, UINT FeatureLevels,
    UINT, _In_opt_ CONST DXGI_SWAP_CHAIN_DESC *,
