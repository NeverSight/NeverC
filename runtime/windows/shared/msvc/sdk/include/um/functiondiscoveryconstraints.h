...
// (visible as defined by the provider) FD_CONSTRAINTVALUE_VISIBILITY_ALL
// (default) you want both visible and not visible/hidden instances (as defined
// by the provider)
...
// FD_CONSTRAINTVALUE_UNPAIRED will return all unpaired devices within wireless
// or wired range FD_CONSTRAINTVALUE_ALL will return all devices cached and
// within wireless or wired range
#define FD_QUERYCONSTRAINT_INQUIRY_TIMEOUT                                     \
  L"InquiryModeTimeout" // #seconds 6-600 supported, default is 300
...
#define SSDP_CONSTRAINTVALUE_TYPE_DEV_LIGHTING                                 \
  SSDP_CONSTRAINTVALUE_TYPE_DEVICE_PREFIX L"Lighting:1"
#define SSDP_CONSTRAINTVALUE_TYPE_DEV_REMINDER                                 \
  SSDP_CONSTRAINTVALUE_TYPE_DEVICE_PREFIX L"Reminder:1"
#define SSDP_CONSTRAINTVALUE_TYPE_DEV_POWERDEVICE                              \
  SSDP_CONSTRAINTVALUE_TYPE_DEVICE_PREFIX L"PowerDevice:1"
#define SSDP_CONSTRAINTVALUE_TYPE_DEV_IGD                                      \
  SSDP_CONSTRAINTVALUE_TYPE_DEVICE_PREFIX L"InternetGatewayDevice:1"
#define SSDP_CONSTRAINTVALUE_TYPE_DEV_WANDEVICE                                \
  SSDP_CONSTRAINTVALUE_TYPE_DEVICE_PREFIX L"WANDevice:1"
#define SSDP_CONSTRAINTVALUE_TYPE_DEV_LANDEVICE                                \
  SSDP_CONSTRAINTVALUE_TYPE_DEVICE_PREFIX L"LANDevice:1"
#define SSDP_CONSTRAINTVALUE_TYPE_DEV_WANCONNDEVICE                            \
  SSDP_CONSTRAINTVALUE_TYPE_DEVICE_PREFIX L"WANConnectionDevice:1"
#define SSDP_CONSTRAINTVALUE_TYPE_DEV_LUXMETER                                 \
  SSDP_CONSTRAINTVALUE_TYPE_DEVICE_PREFIX L"Luxmeter:1"
#define SSDP_CONSTRAINTVALUE_TYPE_DEV_MDARNDR                                  \
  SSDP_CONSTRAINTVALUE_TYPE_DEVICE_PREFIX L"MediaRenderer:1"
#define SSDP_CONSTRAINTVALUE_TYPE_DEV_MDASRVR                                  \
  SSDP_CONSTRAINTVALUE_TYPE_DEVICE_PREFIX L"MediaServer:1"

#define SSDP_CONSTRAINTVALUE_TYPE_SVC_SCANNER                                  \
  SSDP_CONSTRAINTVALUE_TYPE_SVC_PREFIX L"Scanner:1"
#define SSDP_CONSTRAINTVALUE_TYPE_SVC_DIMMING                                  \
  SSDP_CONSTRAINTVALUE_TYPE_SVC_PREFIX L"DimmingService:1"
...
#define PROVIDERWSD_QUERYCONSTRAINT_SSL_CERT_FOR_CLIENT_AUTH                   \
  L"SSLClientAuthCert"
#define PROVIDERWSD_QUERYCONSTRAINT_SSL_CERTHASH_FOR_SERVER_AUTH               \
  L"SSLServerAuthCertHash"
...
#define WNET_CONSTRAINTVALUE_RESOURCETYPE_DISK                                 \
  L"Disk" // All non-printer shares (dwDisplayType == RESOURCEDISPLAYTYPE_SHARE
          // and dwType != RESOURCETYPE_PRINT)
#define WNET_CONSTRAINTVALUE_RESOURCETYPE_PRINTER                              \
  L"Printer" // All printer shares (dwDisplayType == RESOURCEDISPLAYTYPE_SHARE
             // and dwType == RESOURCETYPE_PRINT)
#define WNET_CONSTRAINTVALUE_RESOURCETYPE_DISKORPRINTER                        \
  L"DiskOrPrinter" // All shares (dwDisplayType == RESOURCEDISPLAYTYPE_SHARE)

#define ONLINE_PROVIDER_DEVICES_QUERYCONSTRAINT_OWNERNAME L"OwnerName"

///////////////////////////////////////////////////////////////////////////////
// Device Display Object Provider specific Constraints
#define PROVIDERDDO_QUERYCONSTRAINT_DEVICEFUNCTIONDISPLAYOBJECTS               \
