...
#ifdef __cplusplus
typedef class FsrmAccessDeniedRemediationClient
    FsrmAccessDeniedRemediationClient;
#else
typedef struct FsrmAccessDeniedRemediationClient
    FsrmAccessDeniedRemediationClient;
#endif /* __cplusplus */
...
typedef struct DIFsrmClassificationEventsVtbl {
  ...
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in DIFsrmClassificationEvents *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in DIFsrmClassificationEvents *This);
...
#define DIFsrmClassificationEvents_AddRef(This) ((This)->lpVtbl->AddRef(This))

#define DIFsrmClassificationEvents_Release(This) ((This)->lpVtbl->Release(This))
...
#define DIFsrmClassificationEvents_GetIDsOfNames(This, riid, rgszNames,        \
                                                 cNames, lcid, rgDispId)       \
  ((This)->lpVtbl->GetIDsOfNames(This, riid, rgszNames, cNames, lcid, rgDispId))

#define DIFsrmClassificationEvents_Invoke(This, dispIdMember, riid, lcid,      \
...
class DECLSPEC_UUID("f556d708-6d4d-4594-9c61-7dbb0dae2a46") FsrmSetting;
#endif
...
class DECLSPEC_UUID("f3be42bd-8ac2-409e-bbd8-faf9b6b41feb") FsrmPathMapper;
#endif
...
class DECLSPEC_UUID("1482dc37-fae9-4787-9025-8ce4e024ab56") FsrmExportImport;
#endif
...
class DECLSPEC_UUID("90dcab7f-347c-4bfc-b543-540326305fbe") FsrmQuotaManager;
#endif
...
class DECLSPEC_UUID("0058ef37-aa66-4c48-bd5b-2fce432ab0c8") FsrmReportManager;
#endif
...
class DECLSPEC_UUID("ea25f1b8-1b8d-4290-8ee8-e17c12c2fe20") FsrmReportScheduler;
#endif
...
class DECLSPEC_UUID("2ae64751-b728-4d6b-97a0-b2da2e7d2a3b") AdSyncTask;
#endif
