...
//
// The XSTATE_CONFIG_FEATURE_MSC_INFO struct is used to determine if the
// x86/amd64 machine supports a specific XState feature. Also, it is used to
// locate the XState context feature (AVX) in the context extended buffer.
//
...
typedef struct _MINIDUMP_SYSTEM_PERFORMANCE_INFORMATION_2 {
  ...
  ULONGLONG ContiguousPagesAllocated;
    ...
    *PMINIDUMP_SYSTEM_PERFORMANCE_INFORMATION_2;
...
#define MINIDUMP_SYSMEMINFO1_PERF_RESIDENTAVAILABLEPAGES_SHAREDCOMMITPAGES     \
  0x0008
#define MINIDUMP_SYSMEMINFO1_PERF_MDLPAGESALLOCATED_PFNDATABASECOMMITTEDPAGES  \
  0x0010
#define MINIDUMP_SYSMEMINFO1_PERF_SYSTEMPAGETABLECOMMITTEDPAGES_CONTIGUOUSPAGESALLOCATED \
  0x0020
...
typedef BOOL(WINAPI *MINIDUMP_CALLBACK_ROUTINE)(
    _Inout_ PVOID CallbackParam, _In_ PMINIDUMP_CALLBACK_INPUT CallbackInput,
...
BOOL WINAPI
MiniDumpWriteDump(_In_ HANDLE hProcess, _In_ DWORD ProcessId, _In_ HANDLE hFile,
...
BOOL WINAPI
MiniDumpReadDumpStream(_In_ PVOID BaseOfDump, _In_ ULONG StreamNumber,
