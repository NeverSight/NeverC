...
typedef struct IAdvancedMediaCaptureInitializationSettingsVtbl {
  ...
  DECLSPEC_XFGVIRT(IAdvancedMediaCaptureInitializationSettings,
...
public:
  virtual HRESULT STDMETHODCALLTYPE GetAdvancedMediaCaptureSettings(
      /* [out] */ __RPC__deref_out_opt IAdvancedMediaCaptureSettings *
      *value) = 0;
};
...
typedef struct IAdvancedMediaCaptureVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IAdvancedMediaCapture *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IAdvancedMediaCapture *This);
