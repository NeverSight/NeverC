...
#define IWsbApplicationBackupSupport_CheckConsistency(                         \
    This, wszWriterMetadata, wszComponentName, wszComponentLogicalPath,        \
    cVolumes, rgwszSourceVolumePath, rgwszSnapshotVolumePath, ppAsync)         \
  ((This)->lpVtbl->CheckConsistency(                                           \
      This, wszWriterMetadata, wszComponentName, wszComponentLogicalPath,      \
      cVolumes, rgwszSourceVolumePath, rgwszSnapshotVolumePath, ppAsync))
...
public:
  ...
  virtual HRESULT STDMETHODCALLTYPE OrderComponents(
      ...
      /* [size_is][string][in] */ __RPC__in_ecount_full(cComponents) LPWSTR *
          rgComponentName,
      /* [size_is][string][in] */ __RPC__in_ecount_full(cComponents) LPWSTR *
          rgComponentLogicalPaths,
      /* [size_is][size_is][string][out] */
      __RPC__deref_out_ecount_full_opt_string(cComponents) LPWSTR *
          *prgComponentName,
      /* [size_is][size_is][string][out] */
      __RPC__deref_out_ecount_full_opt_string(cComponents) LPWSTR *
          *prgComponentLogicalPath) = 0;
...
typedef struct IWsbApplicationRestoreSupportVtbl {
  ...
  HRESULT(STDMETHODCALLTYPE *OrderComponents)(
      ...
      /* [size_is][size_is][string][out] */
      __RPC__deref_out_ecount_full_opt_string(cComponents)
...
#define IWsbApplicationRestoreSupport_PreRestore(                              \
    This, wszWriterMetadata, wszComponentName, wszComponentLogicalPath,        \
    bNoRollForward)                                                            \
  ((This)->lpVtbl->PreRestore(This, wszWriterMetadata, wszComponentName,       \
                              wszComponentLogicalPath, bNoRollForward))

#define IWsbApplicationRestoreSupport_PostRestore(                             \
    This, wszWriterMetadata, wszComponentName, wszComponentLogicalPath,        \
    bNoRollForward)                                                            \
  ((This)->lpVtbl->PostRestore(This, wszWriterMetadata, wszComponentName,      \
                               wszComponentLogicalPath, bNoRollForward))

#define IWsbApplicationRestoreSupport_OrderComponents(                         \
    This, cComponents, rgComponentName, rgComponentLogicalPaths,               \
    prgComponentName, prgComponentLogicalPath)                                 \
  ((This)->lpVtbl->OrderComponents(This, cComponents, rgComponentName,         \
                                   rgComponentLogicalPaths, prgComponentName,  \
                                   prgComponentLogicalPath))

#define IWsbApplicationRestoreSupport_IsRollForwardSupported(                  \
    This, pbRollForwardSupported)                                              \
...
typedef struct IWsbApplicationAsyncVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IWsbApplicationAsync *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IWsbApplicationAsync *This);
  ...
  HRESULT(STDMETHODCALLTYPE *Abort)(__RPC__in IWsbApplicationAsync *This);
