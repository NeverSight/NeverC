...
typedef struct IMixerOCXNotifyVtbl {
  ...
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in IMixerOCXNotify *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IMixerOCXNotify *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IMixerOCXNotify *This);

  DECLSPEC_XFGVIRT(IMixerOCXNotify, OnInvalidateRect)
  HRESULT(STDMETHODCALLTYPE *OnInvalidateRect)(__RPC__in IMixerOCXNotify *This,
                                               /* [in] */ __RPC__in LPCRECT
                                                   lpcRect);

  DECLSPEC_XFGVIRT(IMixerOCXNotify, OnStatusChange)
  HRESULT(STDMETHODCALLTYPE *OnStatusChange)(__RPC__in IMixerOCXNotify *This,
                                             /* [in] */ ULONG ulStatusFlags);

  DECLSPEC_XFGVIRT(IMixerOCXNotify, OnDataChange)
  HRESULT(STDMETHODCALLTYPE *OnDataChange)(__RPC__in IMixerOCXNotify *This,
...
typedef struct IMixerOCXVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in IMixerOCX *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IMixerOCX *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IMixerOCX *This);

  DECLSPEC_XFGVIRT(IMixerOCX, OnDisplayChange)
  HRESULT(STDMETHODCALLTYPE *OnDisplayChange)(__RPC__in IMixerOCX *This,
                                              /* [in] */ ULONG ulBitsPerPixel,
                                              /* [in] */ ULONG ulScreenWidth,
  ...
  HRESULT(STDMETHODCALLTYPE *OnDraw)(__RPC__in IMixerOCX *This,
                                     /* [in] */ __RPC__in HDC hdcDraw,
  ...
  HRESULT(STDMETHODCALLTYPE *UnAdvise)(__RPC__in IMixerOCX *This);
...
#define IMixerOCX_GetAspectRatio(This, pdwPictAspectRatioX,                    \
                                 pdwPictAspectRatioY)                          \
  ((This)->lpVtbl->GetAspectRatio(This, pdwPictAspectRatioX,                   \
                                  pdwPictAspectRatioY))
