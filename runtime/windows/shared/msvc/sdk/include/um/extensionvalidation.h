...
typedef struct IExtensionValidationVtbl {
  ...
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(IExtensionValidation *This,
                                             /* [in] */ REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(IExtensionValidation *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(IExtensionValidation *This);
...
#define IExtensionValidation_AddRef(This) ((This)->lpVtbl->AddRef(This))

#define IExtensionValidation_Release(This) ((This)->lpVtbl->Release(This))

#define IExtensionValidation_Validate(                                         \
    This, extensionGuid, extensionModulePath, extensionFileVersionMS,          \
    extensionFileVersionLS, htmlDocumentTop, htmlDocumentSubframe,             \
    htmlElement, contexts, results)                                            \
  ((This)->lpVtbl->Validate(This, extensionGuid, extensionModulePath,          \
                            extensionFileVersionMS, extensionFileVersionLS,    \
                            htmlDocumentTop, htmlDocumentSubframe,             \
                            htmlElement, contexts, results))
