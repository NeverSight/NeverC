...
typedef interface IWMPSubscriptionServiceCallback
...
public:
  virtual HRESULT STDMETHODCALLTYPE allowPlay(HWND hwnd, IWMPMedia * pMedia,
                                              BOOL * pfAllowPlay) = 0;

  virtual HRESULT STDMETHODCALLTYPE allowCDBurn(
      HWND hwnd, IWMPPlaylist * pPlaylist, BOOL * pfAllowBurn) = 0;

  virtual HRESULT STDMETHODCALLTYPE allowPDATransfer(
      HWND hwnd, IWMPPlaylist * pPlaylist, BOOL * pfAllowTransfer) = 0;

  virtual HRESULT STDMETHODCALLTYPE startBackgroundProcessing(HWND hwnd) = 0;
};
...
typedef struct IWMPSubscriptionServiceVtbl {
  ...
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(IWMPSubscriptionService *This,
                                             /* [in] */ REFIID riid,
  ...
  HRESULT(STDMETHODCALLTYPE *allowPlay)(IWMPSubscriptionService *This,
                                        HWND hwnd, IWMPMedia *pMedia,
                                        BOOL *pfAllowPlay);

  DECLSPEC_XFGVIRT(IWMPSubscriptionService, allowCDBurn)
  HRESULT(STDMETHODCALLTYPE *allowCDBurn)(IWMPSubscriptionService *This,
                                          HWND hwnd, IWMPPlaylist *pPlaylist,
                                          BOOL *pfAllowBurn);

  DECLSPEC_XFGVIRT(IWMPSubscriptionService, allowPDATransfer)
  HRESULT(STDMETHODCALLTYPE *allowPDATransfer)(IWMPSubscriptionService *This,
                                               HWND hwnd,
  ...
  HRESULT(STDMETHODCALLTYPE *startBackgroundProcessing)(
      IWMPSubscriptionService *This, HWND hwnd);
...
#define IWMPSubscriptionService_allowCDBurn(This, hwnd, pPlaylist,             \
                                            pfAllowBurn)                       \
  ((This)->lpVtbl->allowCDBurn(This, hwnd, pPlaylist, pfAllowBurn))

#define IWMPSubscriptionService_allowPDATransfer(This, hwnd, pPlaylist,        \
                                                 pfAllowTransfer)              \
...
public:
  virtual HRESULT STDMETHODCALLTYPE onComplete(HRESULT hrResult) = 0;
};
...
typedef struct IWMPSubscriptionServiceCallbackVtbl {
  ...
  HRESULT(STDMETHODCALLTYPE *onComplete)(IWMPSubscriptionServiceCallback *This,
                                         HRESULT hrResult);
...
public:
  ...
  virtual HRESULT STDMETHODCALLTYPE deviceAvailable(
      BSTR bstrDeviceName, IWMPSubscriptionServiceCallback * pCB) = 0;

  virtual HRESULT STDMETHODCALLTYPE prepareForSync(
      BSTR bstrFilename, BSTR bstrDeviceName,
...
typedef struct IWMPSubscriptionService2Vtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(IWMPSubscriptionService2 *This,
                                             /* [in] */ REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);
  ...
  DECLSPEC_XFGVIRT(IWMPSubscriptionService, allowPlay)
  HRESULT(STDMETHODCALLTYPE *allowPlay)(IWMPSubscriptionService2 *This,
                                        HWND hwnd, IWMPMedia *pMedia,
                                        BOOL *pfAllowPlay);

  DECLSPEC_XFGVIRT(IWMPSubscriptionService, allowCDBurn)
  HRESULT(STDMETHODCALLTYPE *allowCDBurn)(IWMPSubscriptionService2 *This,
                                          HWND hwnd, IWMPPlaylist *pPlaylist,
                                          BOOL *pfAllowBurn);

  DECLSPEC_XFGVIRT(IWMPSubscriptionService, allowPDATransfer)
  HRESULT(STDMETHODCALLTYPE *allowPDATransfer)(IWMPSubscriptionService2 *This,
                                               HWND hwnd,
                                               IWMPPlaylist *pPlaylist,
                                               BOOL *pfAllowTransfer);
  ...
  DECLSPEC_XFGVIRT(IWMPSubscriptionService, startBackgroundProcessing)
  HRESULT(STDMETHODCALLTYPE *startBackgroundProcessing)(
      IWMPSubscriptionService2 *This, HWND hwnd);
  ...
  HRESULT(STDMETHODCALLTYPE *serviceEvent)(IWMPSubscriptionService2 *This,
  ...
  HRESULT(STDMETHODCALLTYPE *deviceAvailable)(
      IWMPSubscriptionService2 *This, BSTR bstrDeviceName,
  ...
  HRESULT(STDMETHODCALLTYPE *prepareForSync)(
      IWMPSubscriptionService2 *This, BSTR bstrFilename, BSTR bstrDeviceName,
      IWMPSubscriptionServiceCallback *pCB);
...
#define IWMPSubscriptionService2_allowCDBurn(This, hwnd, pPlaylist,            \
                                             pfAllowBurn)                      \
  ((This)->lpVtbl->allowCDBurn(This, hwnd, pPlaylist, pfAllowBurn))

#define IWMPSubscriptionService2_allowPDATransfer(This, hwnd, pPlaylist,       \
                                                  pfAllowTransfer)             \
  ((This)->lpVtbl->allowPDATransfer(This, hwnd, pPlaylist, pfAllowTransfer))
...
#define IWMPSubscriptionService2_prepareForSync(This, bstrFilename,            \
                                                bstrDeviceName, pCB)           \
...
typedef struct IWMPDownloadItemVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(IWMPDownloadItem *This,
                                             /* [in] */ REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);
  ...
  HRESULT(STDMETHODCALLTYPE *GetTypeInfoCount)(IWMPDownloadItem *This,
                                               /* [out] */ UINT *pctinfo);

  DECLSPEC_XFGVIRT(IDispatch, GetTypeInfo)
  HRESULT(STDMETHODCALLTYPE *GetTypeInfo)(IWMPDownloadItem *This,
                                          /* [in] */ UINT iTInfo,
                                          /* [in] */ LCID lcid,
...
interface IWMPDownloadItem { CONST_VTBL struct IWMPDownloadItemVtbl *lpVtbl; };
...
#define IWMPDownloadItem_GetIDsOfNames(This, riid, rgszNames, cNames, lcid,    \
                                       rgDispId)                               \
  ((This)->lpVtbl->GetIDsOfNames(This, riid, rgszNames, cNames, lcid, rgDispId))

#define IWMPDownloadItem_Invoke(This, dispIdMember, riid, lcid, wFlags,        \
...
typedef struct IWMPDownloadItem2Vtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(IWMPDownloadItem2 *This,
                                             /* [in] */ REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);
  ...
  DECLSPEC_XFGVIRT(IDispatch, GetTypeInfoCount)
  HRESULT(STDMETHODCALLTYPE *GetTypeInfoCount)(IWMPDownloadItem2 *This,
                                               /* [out] */ UINT *pctinfo);

  DECLSPEC_XFGVIRT(IDispatch, GetTypeInfo)
  HRESULT(STDMETHODCALLTYPE *GetTypeInfo)(IWMPDownloadItem2 *This,
                                          /* [in] */ UINT iTInfo,
                                          /* [in] */ LCID lcid,
                                          /* [out] */ ITypeInfo **ppTInfo);
...
#define IWMPDownloadItem2_GetIDsOfNames(This, riid, rgszNames, cNames, lcid,   \
                                        rgDispId)                              \
  ((This)->lpVtbl->GetIDsOfNames(This, riid, rgszNames, cNames, lcid, rgDispId))

#define IWMPDownloadItem2_Invoke(This, dispIdMember, riid, lcid, wFlags,       \
...
typedef struct IWMPDownloadCollectionVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(IWMPDownloadCollection *This,
                                             /* [in] */ REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);
  ...
  DECLSPEC_XFGVIRT(IDispatch, GetTypeInfoCount)
  HRESULT(STDMETHODCALLTYPE *GetTypeInfoCount)(IWMPDownloadCollection *This,
                                               /* [out] */ UINT *pctinfo);

  DECLSPEC_XFGVIRT(IDispatch, GetTypeInfo)
  HRESULT(STDMETHODCALLTYPE *GetTypeInfo)(IWMPDownloadCollection *This,
                                          /* [in] */ UINT iTInfo,
                                          /* [in] */ LCID lcid,
                                          /* [out] */ ITypeInfo **ppTInfo);
...
#define IWMPDownloadCollection_GetIDsOfNames(This, riid, rgszNames, cNames,    \
                                             lcid, rgDispId)                   \
  ((This)->lpVtbl->GetIDsOfNames(This, riid, rgszNames, cNames, lcid, rgDispId))

#define IWMPDownloadCollection_Invoke(This, dispIdMember, riid, lcid, wFlags,  \
                                      pDispParams, pVarResult, pExcepInfo,     \
                                      puArgErr)                                \
  ((This)->lpVtbl->Invoke(This, dispIdMember, riid, lcid, wFlags, pDispParams, \
                          pVarResult, pExcepInfo, puArgErr))
...
#define IWMPDownloadCollection_startDownload(This, bstrSourceURL, bstrType,    \
                                             ppDownload)                       \
...
typedef struct IWMPDownloadManagerVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(IWMPDownloadManager *This,
                                             /* [in] */ REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);
  ...
  DECLSPEC_XFGVIRT(IDispatch, GetTypeInfoCount)
  HRESULT(STDMETHODCALLTYPE *GetTypeInfoCount)(IWMPDownloadManager *This,
                                               /* [out] */ UINT *pctinfo);

  DECLSPEC_XFGVIRT(IDispatch, GetTypeInfo)
  HRESULT(STDMETHODCALLTYPE *GetTypeInfo)(IWMPDownloadManager *This,
                                          /* [in] */ UINT iTInfo,
                                          /* [in] */ LCID lcid,
                                          /* [out] */ ITypeInfo **ppTInfo);
...
#define IWMPDownloadManager_GetIDsOfNames(This, riid, rgszNames, cNames, lcid, \
                                          rgDispId)                            \
  ((This)->lpVtbl->GetIDsOfNames(This, riid, rgszNames, cNames, lcid, rgDispId))

#define IWMPDownloadManager_Invoke(This, dispIdMember, riid, lcid, wFlags,     \
                                   pDispParams, pVarResult, pExcepInfo,        \
                                   puArgErr)                                   \
  ((This)->lpVtbl->Invoke(This, dispIdMember, riid, lcid, wFlags, pDispParams, \
                          pVarResult, pExcepInfo, puArgErr))

#define IWMPDownloadManager_getDownloadCollection(This, lCollectionId,         \
                                                  ppCollection)                \
