...
#define EXITEVENT_STARTUP                                                      \
  (0x80) // Service startup, fake event generated by exit module
...
typedef struct ICertExitVtbl {
  ...
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in ICertExit *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in ICertExit *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in ICertExit *This);
  ...
  HRESULT(STDMETHODCALLTYPE *Notify)(__RPC__in ICertExit *This,
                                     /* [in] */ LONG ExitEvent,
                                     /* [in] */ LONG Context);
...
interface ICertExit { CONST_VTBL struct ICertExitVtbl *lpVtbl; };
...
typedef struct ICertExit2Vtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in ICertExit2 *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in ICertExit2 *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in ICertExit2 *This);
  ...
  DECLSPEC_XFGVIRT(ICertExit, Notify)
  HRESULT(STDMETHODCALLTYPE *Notify)(__RPC__in ICertExit2 *This,
                                     /* [in] */ LONG ExitEvent,
                                     /* [in] */ LONG Context);
...
interface ICertExit2 { CONST_VTBL struct ICertExit2Vtbl *lpVtbl; };
