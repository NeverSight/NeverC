...
public:
  ...
  virtual HRESULT STDMETHODCALLTYPE DeviceToColorimetricColors(
      ...
      /* [size_is][out] */
      __RPC__out_ecount_full(cColors) XYZColorF *pXYZColors) = 0;
  ...
  virtual HRESULT STDMETHODCALLTYPE ColorimetricToDeviceColors(
      ...
      /* [size_is][out] */
      __RPC__out_ecount_full((cColors * cChannels)) FLOAT *pDeviceValues) = 0;
  ...
  virtual HRESULT STDMETHODCALLTYPE GetGamutBoundaryMesh(
      ...
      /* [size_is][out] */
      __RPC__out_ecount_full(cTriangles) GamutShellTriangle * pTriangles) = 0;
  ...
  virtual HRESULT STDMETHODCALLTYPE GetNeutralAxis(
      /* [in] */ UINT cColors,
      /* [size_is][out] */ __RPC__out_ecount_full(cColors) XYZColorF *
          pXYZColors) = 0;
};
...
typedef struct IDeviceModelPlugInVtbl {
  ...
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in IDeviceModelPlugIn *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IDeviceModelPlugIn *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IDeviceModelPlugIn *This);

  DECLSPEC_XFGVIRT(IDeviceModelPlugIn, Initialize)
  HRESULT(STDMETHODCALLTYPE *Initialize)(__RPC__in IDeviceModelPlugIn *This,
                                         /* [in] */ __RPC__in BSTR bstrXml,
                                         /* [in] */ UINT cNumModels,
                                         /* [in] */ UINT iModelPosition);
  ...
  HRESULT(STDMETHODCALLTYPE *GetNeutralAxis)(__RPC__in IDeviceModelPlugIn *This,
                                             /* [in] */ UINT cColors,
                                             /* [size_is][out] */
                                             __RPC__out_ecount_full(cColors)
...
#define IDeviceModelPlugIn_Initialize(This, bstrXml, cNumModels,               \
                                      iModelPosition)                          \
...
#define IDeviceModelPlugIn_DeviceToColorimetricColors(                         \
    This, cColors, cChannels, pDeviceValues, pXYZColors)                       \
  ((This)->lpVtbl->DeviceToColorimetricColors(This, cColors, cChannels,        \
                                              pDeviceValues, pXYZColors))

#define IDeviceModelPlugIn_ColorimetricToDeviceColors(                         \
    This, cColors, cChannels, pXYZColors, pDeviceValues)                       \
  ((This)->lpVtbl->ColorimetricToDeviceColors(This, cColors, cChannels,        \
                                              pXYZColors, pDeviceValues))

#define IDeviceModelPlugIn_ColorimetricToDeviceColorsWithBlack(                \
    This, cColors, cChannels, pXYZColors, pBlackInformation, pDeviceValues)    \
  ((This)->lpVtbl->ColorimetricToDeviceColorsWithBlack(                        \
      This, cColors, cChannels, pXYZColors, pBlackInformation, pDeviceValues))

#define IDeviceModelPlugIn_SetTransformDeviceModelInfo(This, iModelPosition,   \
                                                       pIDeviceModelOther)     \
  ((This)->lpVtbl->SetTransformDeviceModelInfo(This, iModelPosition,           \
                                               pIDeviceModelOther))

#define IDeviceModelPlugIn_GetPrimarySamples(This, pPrimaryColor)              \
  ((This)->lpVtbl->GetPrimarySamples(This, pPrimaryColor))

#define IDeviceModelPlugIn_GetGamutBoundaryMeshSize(This, pNumVertices,        \
                                                    pNumTriangles)             \
  ((This)->lpVtbl->GetGamutBoundaryMeshSize(This, pNumVertices, pNumTriangles))

#define IDeviceModelPlugIn_GetGamutBoundaryMesh(                               \
    This, cChannels, cVertices, cTriangles, pVertices, pTriangles)             \
  ((This)->lpVtbl->GetGamutBoundaryMesh(This, cChannels, cVertices,            \
                                        cTriangles, pVertices, pTriangles))
...
public:
  ...
  virtual HRESULT STDMETHODCALLTYPE SourceToDestinationAppearanceColors(
      ...
      /* [size_is][out] */
      __RPC__out_ecount_full(cColors) JChColorF *pOutputColors) = 0;
};
...
typedef struct IGamutMapModelPlugInVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IGamutMapModelPlugIn *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IGamutMapModelPlugIn *This);
...
#define IGamutMapModelPlugIn_Initialize(This, bstrXml, pSrcPlugIn,             \
                                        pDestPlugIn, pSrcGBD, pDestGBD)        \
  ((This)->lpVtbl->Initialize(This, bstrXml, pSrcPlugIn, pDestPlugIn, pSrcGBD, \
                              pDestGBD))

#define IGamutMapModelPlugIn_SourceToDestinationAppearanceColors(              \
    This, cColors, pInputColors, pOutputColors)                                \
  ((This)->lpVtbl->SourceToDestinationAppearanceColors(                        \
      This, cColors, pInputColors, pOutputColors))
...
DEFINE_GUID(CATID_WcsPlugin, 0xa0b402e0, 0x8240, 0x405f, 0x8a, 0x16, 0x8a, 0x5b,
            0x4d, 0xf2, 0xf0, 0xdd);
