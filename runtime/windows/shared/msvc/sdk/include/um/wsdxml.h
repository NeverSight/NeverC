...
#define WSDXML_TYPE_ENCODING(typeIndex, layerNumber)                           \
  ((((DWORD)layerNumber) << 28) | typeIndex)
#define WSDXML_NAMESPACE_ENCODING(namespaceIndex, layerNumber)                 \
  ((((WORD)layerNumber) << 12) | namespaceIndex)
#define WSDXML_NAME_ENCODING(nameIndex, nameSpaceEncoding)                     \
  ((((DWORD)nameSpaceEncoding) << 16) | nameIndex)
HRESULT WINAPI WSDXMLGetNameFromBuiltinNamespace(_In_ LPCWSTR pszNamespace,
                                                 _In_ LPCWSTR pszName,
                                                 _Outptr_ WSDXML_NAME **ppName);
HRESULT WINAPI WSDXMLCreateContext(_Outptr_ IWSDXMLContext **ppContext);
...
typedef struct IWSDXMLContextVtbl {
  ...
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(IWSDXMLContext *This,
                                             /* [in] */ REFIID riid,
...
interface IWSDXMLContext { CONST_VTBL struct IWSDXMLContextVtbl *lpVtbl; };
