...
typedef enum D2D1_TRANSFORMED_IMAGE_SOURCE_OPTIONS {
  ...
  /// <summary>
  /// Prevents the image source from being automatically scaled (by a ratio of
  /// the context DPI divided by 96) while drawn.
  /// </summary>
...
typedef struct D2D1_TRANSFORMED_IMAGE_SOURCE_PROPERTIES {
  ...
  /// <summary>
  /// The interpolation mode used when the image source is drawn.  This is
  /// ignored if the image source is drawn using the DrawImage method, or using
  /// an image brush.
  /// </summary>
...
/// <summary>
/// Represents a Bezier segment to be used in the creation of an ID2D1Ink
/// object. This structure differs from D2D1_BEZIER_SEGMENT in that it is
/// composed of D2D1_INK_POINT s, which contain a radius in addition to x- and
/// y-coordinates.
/// </summary>
...
/// <summary>
/// Represents a tensor patch with 16 control points, 4 corner colors, and
/// boundary flags. An ID2D1GradientMesh is made up of 1 or more gradient mesh
/// patches. Use the GradientMeshPatch function or the
...
typedef enum D2D1_COLOR_BITMAP_GLYPH_SNAP_OPTION {
  ...
  /// <summary>
  /// Color bitmap glyph positions are snapped to the nearest pixel if the
  /// bitmap resolution matches that of the device context.
  /// </summary>
...
/// ID2D1DeviceContext2::DrawInk when rendering ink. The ink style defines the
/// nib (pen tip) shape and transform.
/// </summary>
interface DX_DECLARE_INTERFACE("bae8b344-23fc-4071-8cb5-d05d6f073848")
    ID2D1InkStyle : public ID2D1Resource {

  STDMETHOD_(void, SetNibTransform)(_In_ CONST D2D1_MATRIX_3X2_F * transform)
      PURE;

  STDMETHOD_(void, GetNibTransform)(_Out_ D2D1_MATRIX_3X2_F * transform)
      CONST PURE;

  STDMETHOD_(void, SetNibShape)(D2D1_INK_NIB_SHAPE nibShape) PURE;
...
/// </summary>
interface DX_DECLARE_INTERFACE("b499923b-7029-478f-a8b3-432c7c5f5312") ID2D1Ink
    : public ID2D1Resource {

  /// <summary>
  /// Resets the ink start point.
  /// </summary>
  STDMETHOD_(void, SetStartPoint)(_In_ CONST D2D1_INK_POINT * startPoint) PURE;
  ...
  STDMETHOD(AddSegments)(
      ...
      UINT32 segmentsCount) PURE;

  /// <summary>
  /// Remove one or more segments from the end of the ink.
  /// </summary>
  STDMETHOD(RemoveSegmentsAtEnd)(UINT32 segmentsCount) PURE;
  ...
  /// </summary>
  STDMETHOD(SetSegmentAtEnd)(_In_ CONST D2D1_INK_BEZIER_SEGMENT * segment) PURE;
  ...
  /// </summary>
  STDMETHOD(GetSegments)(UINT32 startSegment,
                         _Out_writes_(segmentsCount) D2D1_INK_BEZIER_SEGMENT *
                             segments,
                         UINT32 segmentsCount) CONST PURE;

  /// <summary>
  /// Construct a geometric representation of the ink.
  /// </summary>
  STDMETHOD(StreamAsGeometry)(_In_opt_ ID2D1InkStyle * inkStyle,
  ...
  /// </summary>
  STDMETHOD(GetBounds)(_In_opt_ ID2D1InkStyle * inkStyle,
                       _In_opt_ CONST D2D1_MATRIX_3X2_F * worldTransform,
  ...
  COM_DECLSPEC_NOTHROW
  HRESULT
  SetSegmentAtEnd(CONST D2D1_INK_BEZIER_SEGMENT & segment) {
  ...
  COM_DECLSPEC_NOTHROW
  HRESULT
  StreamAsGeometry(_In_opt_ ID2D1InkStyle * inkStyle,
                   CONST D2D1_MATRIX_3X2_F & worldTransform,
                   FLOAT flatteningTolerance,
                   _In_ ID2D1SimplifiedGeometrySink * geometrySink) CONST {
    return StreamAsGeometry(inkStyle, &worldTransform, flatteningTolerance,
                            geometrySink);
  }
  ...
  StreamAsGeometry(_In_opt_ ID2D1InkStyle * inkStyle,
                   _In_opt_ CONST D2D1_MATRIX_3X2_F * worldTransform,
                   _In_ ID2D1SimplifiedGeometrySink * geometrySink) CONST {
    return StreamAsGeometry(inkStyle, worldTransform,
...
/// </summary>
interface DX_DECLARE_INTERFACE("f292e401-c050-4cde-83d7-04962d3b23c2")
  ...
  /// </summary>
  STDMETHOD(GetPatches)(UINT32 startIndex,
                        _Out_writes_(patchesCount) D2D1_GRADIENT_MESH_PATCH *
                            patches,
                        UINT32 patchesCount) CONST PURE;
}; // interface ID2D1GradientMesh

/// <summary>
/// Represents a producer of pixels that can fill an arbitrary 2D plane.
/// </summary>
interface DX_DECLARE_INTERFACE("c9b664e5-74a1-4378-9ac2-eefc37a3f4d8")
    ID2D1ImageSource : public ID2D1Image {

  STDMETHOD(OfferResources)() PURE;

  STDMETHOD(TryReclaimResources)(_Out_ BOOL * resourcesDiscarded) PURE;
}; // interface ID2D1ImageSource

/// <summary>
/// Produces 2D pixel data that has been sourced from WIC.
/// </summary>
interface DX_DECLARE_INTERFACE("77395441-1c8f-4555-8683-f50dab0fe792")
    ID2D1ImageSourceFromWic : public ID2D1ImageSource {

  STDMETHOD(EnsureCached)(_In_opt_ CONST D2D1_RECT_U * rectangleToFill) PURE;

  STDMETHOD(TrimCache)(_In_opt_ CONST D2D1_RECT_U * rectangleToPreserve) PURE;

  STDMETHOD_(void, GetSource)(_Outptr_result_maybenull_ IWICBitmapSource *
                              *wicBitmapSource) CONST PURE;

  COM_DECLSPEC_NOTHROW
  HRESULT
  EnsureCached(CONST D2D1_RECT_U & rectangleToFill) {
    return EnsureCached(&rectangleToFill);
  }

  COM_DECLSPEC_NOTHROW
  HRESULT
  TrimCache(CONST D2D1_RECT_U & rectangleToPreserve) {
    return TrimCache(&rectangleToPreserve);
  }
}; // interface ID2D1ImageSourceFromWic

/// <summary>
/// Represents an image source which shares resources with an original image
/// source.
/// </summary>
interface DX_DECLARE_INTERFACE("7f1f79e5-2796-416c-8f55-700f911445e5")
    ID2D1TransformedImageSource : public ID2D1Image {

  STDMETHOD_(void, GetSource)(_Outptr_result_maybenull_ ID2D1ImageSource *
                              *imageSource) CONST PURE;

  STDMETHOD_(void, GetProperties)(
      _Out_ D2D1_TRANSFORMED_IMAGE_SOURCE_PROPERTIES * properties) CONST PURE;
...
/// effect.
/// </summary>
interface DX_DECLARE_INTERFACE("53dd9855-a3b0-4d5b-82e1-26e25c5e5797")
    ID2D1LookupTable3D : public ID2D1Resource{}; // interface ID2D1LookupTable3D

/// <summary>
/// This interface performs all the same functions as the ID2D1DeviceContext1
/// interface, plus it enables functionality such as ink rendering, gradient
/// mesh rendering, and improved image loading.
/// </summary>
interface DX_DECLARE_INTERFACE("394ea6a3-0c34-4321-950b-6ca20f0be6c7")
    ID2D1DeviceContext2 : public ID2D1DeviceContext1 {

  STDMETHOD(CreateInk)(_In_ CONST D2D1_INK_POINT * startPoint,
                       _COM_Outptr_ ID2D1Ink * *ink) PURE;

  /// <summary>
  /// Creates a new ink style.
  /// </summary>
  STDMETHOD(CreateInkStyle)(_In_opt_ CONST D2D1_INK_STYLE_PROPERTIES *
                                inkStyleProperties,
                            _COM_Outptr_ ID2D1InkStyle * *inkStyle) PURE;

  STDMETHOD(CreateGradientMesh)(
      _In_reads_(patchesCount) CONST D2D1_GRADIENT_MESH_PATCH * patches,
      UINT32 patchesCount, _COM_Outptr_ ID2D1GradientMesh * *gradientMesh) PURE;
  ...
  STDMETHOD(CreateImageSourceFromWic)(
      ...
      _COM_Outptr_ ID2D1ImageSourceFromWic * *imageSource) PURE;

  /// <summary>
  /// Creates a 3D lookup table for mapping a 3-channel input to a 3-channel
  /// output. The table data must be provided in 4-channel format.
  /// </summary>
  STDMETHOD(CreateLookupTable3D)(
      D2D1_BUFFER_PRECISION precision, _In_reads_(3) CONST UINT32 * extents,
      _In_reads_(dataCount) CONST BYTE * data, UINT32 dataCount,
      _In_reads_(2) CONST UINT32 * strides,
      _COM_Outptr_ ID2D1LookupTable3D * *lookupTable) PURE;

  STDMETHOD(CreateImageSourceFromDxgi)(
      _In_reads_(surfaceCount) IDXGISurface * *surfaces, UINT32 surfaceCount,
      DXGI_COLOR_SPACE_TYPE colorSpace,
      D2D1_IMAGE_SOURCE_FROM_DXGI_OPTIONS options,
      _COM_Outptr_ ID2D1ImageSource * *imageSource) PURE;

  /// <summary>
  /// Retrieves the world-space bounds in DIPs of the gradient mesh using the
  /// device context DPI.
  /// </summary>
  STDMETHOD(GetGradientMeshWorldBounds)(_In_ ID2D1GradientMesh * gradientMesh,
                                        _Out_ D2D1_RECT_F * pBounds) CONST PURE;

  STDMETHOD_(void, DrawInk)(_In_ ID2D1Ink * ink, _In_ ID2D1Brush * brush,
                            _In_opt_ ID2D1InkStyle * inkStyle) PURE;

  STDMETHOD_(void, DrawGradientMesh)(_In_ ID2D1GradientMesh * gradientMesh)
      PURE;
  ...
  STDMETHOD(CreateTransformedImageSource)(
      ...
      _COM_Outptr_ ID2D1TransformedImageSource * *transformedImageSource) PURE;

  COM_DECLSPEC_NOTHROW
  HRESULT
  CreateInk(CONST D2D1_INK_POINT & startPoint, _COM_Outptr_ ID2D1Ink * *ink) {
  ...
  COM_DECLSPEC_NOTHROW
  HRESULT
  CreateInkStyle(CONST D2D1_INK_STYLE_PROPERTIES & inkStyleProperties,
  ...
  COM_DECLSPEC_NOTHROW
  HRESULT
  CreateImageSourceFromWic(_In_ IWICBitmapSource * wicBitmapSource,
                           D2D1_IMAGE_SOURCE_LOADING_OPTIONS loadingOptions,
                           _COM_Outptr_ ID2D1ImageSourceFromWic *
                               *imageSource) {
    return CreateImageSourceFromWic(wicBitmapSource, loadingOptions,
                                    D2D1_ALPHA_MODE_UNKNOWN, imageSource);
  }
  ...
  CreateImageSourceFromWic(_In_ IWICBitmapSource * wicBitmapSource,
                           _COM_Outptr_ ID2D1ImageSourceFromWic *
                               *imageSource) {
    return CreateImageSourceFromWic(wicBitmapSource,
  ...
  /// </summary>
  COM_DECLSPEC_NOTHROW
  void DrawGdiMetafile(_In_ ID2D1GdiMetafile * gdiMetafile,
                       CONST D2D1_RECT_F & destinationRectangle,
                       CONST D2D1_RECT_F & sourceRectangle) {
    return DrawGdiMetafile(gdiMetafile, &destinationRectangle,
                           &sourceRectangle);
  }
...
/// objects.
/// </summary>
interface DX_DECLARE_INTERFACE("a44472e1-8dfb-4e60-8492-6e2861c9ca8b")
  ...
  STDMETHOD(CreateDeviceContext)(D2D1_DEVICE_CONTEXT_OPTIONS options,
                                 _COM_Outptr_ ID2D1DeviceContext2 *
                                     *deviceContext2) PURE;
  ...
  /// </summary>
  STDMETHOD_(void, FlushDeviceContexts)(_In_ ID2D1Bitmap * bitmap) PURE;

  /// <summary>
  /// Returns the DXGI device associated with this D2D device.
  /// </summary>
  STDMETHOD(GetDxgiDevice)(_COM_Outptr_ IDXGIDevice * *dxgiDevice) PURE;
...
/// </summary>
interface DX_DECLARE_INTERFACE("0869759f-4f00-413f-b03e-2bda45404d0f")
    ID2D1Factory3 : public ID2D1Factory2 {

  /// <summary>
  /// This creates a new Direct2D device from the given IDXGIDevice.
  /// </summary>
  STDMETHOD(CreateDevice)(_In_ IDXGIDevice * dxgiDevice,
                          _COM_Outptr_ ID2D1Device2 * *d2dDevice2) PURE;
...
/// ID2D1CommandSink1 interface. It also enables access to ink rendering and
/// gradient mesh rendering.
/// </summary>
interface DX_DECLARE_INTERFACE("3bab440e-417e-47df-a2e2-bc0be6a00916")
    ID2D1CommandSink2 : public ID2D1CommandSink1 {

  STDMETHOD(DrawInk)(_In_ ID2D1Ink * ink, _In_ ID2D1Brush * brush,
                     _In_opt_ ID2D1InkStyle * inkStyle) PURE;

  STDMETHOD(DrawGradientMesh)(_In_ ID2D1GradientMesh * gradientMesh) PURE;

  STDMETHOD(DrawGdiMetafile)(_In_ ID2D1GdiMetafile * gdiMetafile,
                             _In_opt_ CONST D2D1_RECT_F * destinationRectangle,
...
/// </summary>
interface DX_DECLARE_INTERFACE("2e69f9e8-dd3f-4bf9-95ba-c04f49d788df")
    ID2D1GdiMetafile1 : public ID2D1GdiMetafile {

  /// <summary>
  /// Returns the DPI reported by the metafile.
  /// </summary>
  STDMETHOD(GetDpi)(_Out_ FLOAT * dpiX, _Out_ FLOAT * dpiY) PURE;

  /// <summary>
  /// Gets the bounds (in DIPs) of the metafile (as specified by the frame rect
  /// declared in the metafile).
  /// </summary>
  STDMETHOD(GetSourceBounds)(_Out_ D2D1_RECT_F * bounds) PURE;
}; // interface ID2D1GdiMetafile1

/// <summary>
/// User-implementable interface for introspecting on a metafile.
/// </summary>
interface DX_DECLARE_INTERFACE("fd0ecb6b-91e6-411e-8655-395e760f91b4")
    ID2D1GdiMetafileSink1 : public ID2D1GdiMetafileSink {

  /// <summary>
  /// Callback for examining a metafile record.
  /// </summary>
  STDMETHOD(ProcessRecord)(DWORD recordType, _In_opt_ CONST void *recordData,
                           DWORD recordDataSize, UINT32 flags) PURE;
...
interface DX_DECLARE_INTERFACE("4dc583bf-3a10-438a-8722-e9765224f1f1")
  ...
  STDMETHOD(AddSprites)(
      UINT32 spriteCount,
      _In_reads_bytes_(sizeof(D2D1_RECT_F) +
                       (spriteCount - 1) * destinationRectanglesStride)
              CONST D2D1_RECT_F *
          destinationRectangles,
      _In_reads_bytes_opt_(sizeof(D2D1_RECT_U) +
                           (spriteCount - 1) * sourceRectanglesStride)
          CONST D2D1_RECT_U *sourceRectangles = NULL,
      _In_reads_bytes_opt_(sizeof(D2D1_COLOR_F) +
                           (spriteCount - 1) * colorsStride)
          CONST D2D1_COLOR_F *colors = NULL,
      _In_reads_bytes_opt_(sizeof(D2D1_MATRIX_3X2_F) +
                           (spriteCount - 1) * transformsStride)
      ...
      UINT32 transformsStride = sizeof(D2D1_MATRIX_3X2_F)) PURE;
  ...
  STDMETHOD(SetSprites)(
      UINT32 startIndex, UINT32 spriteCount,
      _In_reads_bytes_opt_(sizeof(D2D1_RECT_F) +
                           (spriteCount - 1) * destinationRectanglesStride)
...
interface DX_DECLARE_INTERFACE("235a7496-8351-414c-bcd4-6672ab2d8e00")
  ...
  STDMETHOD_(void, DrawSpriteBatch)(
      _In_ ID2D1SpriteBatch * spriteBatch, UINT32 startIndex,
      UINT32 spriteCount, _In_ ID2D1Bitmap * bitmap,
      D2D1_BITMAP_INTERPOLATION_MODE interpolationMode =
          D2D1_BITMAP_INTERPOLATION_MODE_LINEAR,
      D2D1_SPRITE_OPTIONS spriteOptions = D2D1_SPRITE_OPTIONS_NONE) PURE;
  ...
  void DrawSpriteBatch(
      _In_ ID2D1SpriteBatch * spriteBatch, _In_ ID2D1Bitmap * bitmap,
      D2D1_BITMAP_INTERPOLATION_MODE interpolationMode =
          D2D1_BITMAP_INTERPOLATION_MODE_LINEAR,
      D2D1_SPRITE_OPTIONS spriteOptions = D2D1_SPRITE_OPTIONS_NONE) {
    return DrawSpriteBatch(spriteBatch, 0, spriteBatch->GetSpriteCount(),
                           bitmap, interpolationMode, spriteOptions);
  }
}; // interface ID2D1DeviceContext3

interface DX_DECLARE_INTERFACE("852f2087-802c-4037-ab60-ff2e7ee6fc01")
  ...
  /// </summary>
  STDMETHOD(CreateDeviceContext)(D2D1_DEVICE_CONTEXT_OPTIONS options,
                                 _COM_Outptr_ ID2D1DeviceContext3 *
                                     *deviceContext3) PURE;
...
/// </summary>
interface DX_DECLARE_INTERFACE("bd4ec2d2-0662-4bee-ba8e-6f29f032e096")
  ...
  /// </summary>
  STDMETHOD(CreateDevice)(_In_ IDXGIDevice * dxgiDevice,
                          _COM_Outptr_ ID2D1Device3 * *d2dDevice3) PURE;
...
interface DX_DECLARE_INTERFACE("18079135-4cf3-4868-bc8e-06067e6d242d")
  ...
  STDMETHOD(DrawSpriteBatch)(_In_ ID2D1SpriteBatch * spriteBatch,
                             ...
                             D2D1_BITMAP_INTERPOLATION_MODE interpolationMode,
                             D2D1_SPRITE_OPTIONS spriteOptions) PURE;
...
/// </summary>
interface DX_DECLARE_INTERFACE("af671749-d241-4db8-8e41-dcc2e5c1a438")
    ID2D1SvgGlyphStyle : public ID2D1Resource {

  /// <summary>
  /// Provides values to an SVG glyph for fill. The brush with opacity set to 1
  /// is used as the 'context-fill'. The opacity of the brush is used as the
  /// 'context-fill-opacity' value.
  /// </summary>
  /// <param name="brush">A null brush will cause the context-fill value to come
  /// from the defaultFillBrush. If the defaultFillBrush is also null, the
  /// context-fill value will be 'none'.</param>
  STDMETHOD(SetFill)(_In_opt_ ID2D1Brush * brush) PURE;

  /// <summary>
  /// Returns the requested fill parameters.
  /// </summary>
  STDMETHOD_(void, GetFill)(_Outptr_result_maybenull_ ID2D1Brush * *brush) PURE;

  /// <summary>
  /// Provides values to an SVG glyph for stroke properties. The brush with
  /// opacity set to 1 is used as the 'context-stroke'. The opacity of the brush
  /// is used as the 'context-stroke-opacity' value.
  /// </summary>
  /// <param name="brush">A null brush will cause the context-stroke value to be
  /// 'none'.</param>
  /// <param name="strokeWidth">Specifies the 'context-value' for the
  /// 'stroke-width' property.</param> <param name="dashes">Specifies the
  /// 'context-value' for the 'stroke-dasharray' property. A null value will
  /// cause the stroke-dasharray to be set to 'none'.
  /// </param>
  /// <param name="dashOffset">Specifies the 'context-value' for the
  /// 'stroke-dashoffset' property.</param>
  STDMETHOD(SetStroke)(_In_opt_ ID2D1Brush * brush, FLOAT strokeWidth = 1.0f,
                       _In_reads_opt_(dashesCount) CONST FLOAT *dashes = NULL,
                       UINT32 dashesCount = 0, FLOAT dashOffset = 1.0f) PURE;
  ...
  STDMETHOD_(void, GetStroke)(
      ...
      UINT32 dashesCount = 0, _Out_opt_ FLOAT *dashOffset = NULL) PURE;
}; // interface ID2D1SvgGlyphStyle

interface DX_DECLARE_INTERFACE("8c427831-3d90-4476-b647-c4fae349e4db")
    ID2D1DeviceContext4 : public ID2D1DeviceContext3 {

  /// <summary>
  /// Creates an SVG glyph style object.
  /// </summary>
  STDMETHOD(CreateSvgGlyphStyle)(_COM_Outptr_ ID2D1SvgGlyphStyle *
                                 *svgGlyphStyle) PURE;

  /// <summary>
  /// Draws the text within the given layout rectangle. By default, this method
  /// performs baseline snapping and renders color versions of glyphs in color
  /// fonts.
  /// </summary>
  /// <param name="svgGlyphStyle">Object used to style SVG glyphs.</param>
  /// <param name="colorPaletteIndex">The index used to select a color palette
  /// within a color font.</param>
  STDMETHOD_(void, DrawText)(
      ...
      _In_opt_ ID2D1SvgGlyphStyle * svgGlyphStyle, UINT32 colorPaletteIndex = 0,
  ...
  /// <param name="svgGlyphStyle">Object used to style SVG glyphs.</param>
  /// <param name="colorPaletteIndex">The index used to select a color palette
  /// within a color font.</param> <param name="options">The specified text
  /// options. If D2D1_DRAW_TEXT_OPTIONS_CLIP is used, the text is clipped to
  /// the layout bounds. These bounds are derived from the origin and the layout
  /// bounds of the corresponding IDWriteTextLayout object.
  /// </param>
  ...
  STDMETHOD_(void, DrawColorBitmapGlyphRun)(
      DWRITE_GLYPH_IMAGE_FORMATS glyphImageFormat, D2D1_POINT_2F baselineOrigin,
  ...
  /// <param name="svgGlyphStyle">Object used to style SVG glyphs.</param>
  /// <param name="colorPaletteIndex">The index used to select a color palette
  /// within a color font. Note that this not the same as the paletteIndex in
  /// the DWRITE_COLOR_GLYPH_RUN struct, which is not relevant for SVG
  /// glyphs.</param>
  ...
  /// </summary>
  /// <param name="fontEmSize">The specified font size affects the choice of
  /// which bitmap to use from the font. It also affects the output
  /// glyphTransform, causing it to properly scale the glyph.</param> <param
  /// name="glyphTransform">Output transform, which transforms from the glyph's
  /// space to the same output space as the worldTransform. This includes the
  /// input glyphOrigin, the glyph's offset from the glyphOrigin, and any other
  /// required transformations.</param>
  STDMETHOD(GetColorBitmapGlyphImage)(
      DWRITE_GLYPH_IMAGE_FORMATS glyphImageFormat, D2D1_POINT_2F glyphOrigin,
      _In_ IDWriteFontFace * fontFace, FLOAT fontEmSize, UINT16 glyphIndex,
      BOOL isSideways, _In_opt_ CONST D2D1_MATRIX_3X2_F * worldTransform,
      FLOAT dpiX, FLOAT dpiY, _Out_ D2D1_MATRIX_3X2_F * glyphTransform,
      _COM_Outptr_ ID2D1Image * *glyphImage) PURE;

  /// <summary>
  /// Retrieves an image of the SVG glyph from the color glyph cache. If the
  /// cache does not already contain the requested resource, it will be created.
  ...
  /// within a color font. Note that this not the same as the paletteIndex in
  /// the DWRITE_COLOR_GLYPH_RUN struct, which is not relevant for SVG
  /// glyphs.</param> <param name="glyphTransform">Output transform, which
  /// transforms from the glyph's space to the same output space as the
  /// worldTransform. This includes the input glyphOrigin, the glyph's offset
  /// from the glyphOrigin, and any other required transformations.</param>
  STDMETHOD(GetSvgGlyphImage)(
      D2D1_POINT_2F glyphOrigin, _In_ IDWriteFontFace * fontFace,
      FLOAT fontEmSize, UINT16 glyphIndex, BOOL isSideways,
      _In_opt_ CONST D2D1_MATRIX_3X2_F * worldTransform,
      _In_opt_ ID2D1Brush * defaultFillBrush,
      _In_opt_ ID2D1SvgGlyphStyle * svgGlyphStyle, UINT32 colorPaletteIndex,
      _Out_ D2D1_MATRIX_3X2_F * glyphTransform,
      _COM_Outptr_ ID2D1CommandList * *glyphImage) PURE;
...
interface DX_DECLARE_INTERFACE("d7bdb159-5683-4a46-bc9c-72dc720b858b")
  ...
  /// </summary>
  STDMETHOD(CreateDeviceContext)(D2D1_DEVICE_CONTEXT_OPTIONS options,
                                 _COM_Outptr_ ID2D1DeviceContext4 *
                                     *deviceContext4) PURE;
  ...
  /// <summary>
  /// Sets the maximum capacity of the color glyph cache. This cache is used to
  /// store color bitmap glyphs and SVG glyphs, enabling faster performance if
  /// the same glyphs are needed again. If the application still references a
  /// glyph using GetColorBitmapGlyphImage or GetSvgGlyphImage after it has been
  /// evicted, this glyph does not count toward the cache capacity.
  /// </summary>
  STDMETHOD_(void, SetMaximumColorGlyphCacheMemory)(UINT64 maximumInBytes) PURE;
...
/// </summary>
interface DX_DECLARE_INTERFACE("c4349994-838e-4b0f-8cab-44997d9eeacc")
  ...
  /// </summary>
  STDMETHOD(CreateDevice)(_In_ IDXGIDevice * dxgiDevice,
                          _COM_Outptr_ ID2D1Device4 * *d2dDevice4) PURE;
...
interface DX_DECLARE_INTERFACE("c78a6519-40d6-4218-b2de-beeeb744bb3e")
  ...
  /// </summary>
  STDMETHOD(SetPrimitiveBlend2)(D2D1_PRIMITIVE_BLEND primitiveBlend) PURE;
}; // interface ID2D1CommandSink4

/// <summary>
/// Represents a color context to be used with the Color Management Effect.
/// </summary>
interface DX_DECLARE_INTERFACE("1ab42875-c57f-4be9-bd85-9cd78d6f55ee")
  ...
  /// <summary>
  /// Retrieves the DXGI color space of this context. Returns
  ...
  /// </summary>
  STDMETHOD(GetSimpleColorProfile)(_Out_ D2D1_SIMPLE_COLOR_PROFILE *
                                   simpleProfile) CONST PURE;
}; // interface ID2D1ColorContext1

interface DX_DECLARE_INTERFACE("7836d248-68cc-4df6-b9e8-de991bf62eb7")
  ...
  /// document. If null, an empty document is created.</param> <param
  /// name="viewportSize">Size of the initial viewport of the document.</param>
  /// <param name="svgDocument">When this method returns, contains a pointer to
  /// the SVG document.</param>
  STDMETHOD(CreateSvgDocument)(
      _In_opt_ IStream * inputXmlStream, D2D1_SIZE_F viewportSize,
      _COM_Outptr_ ID2D1SvgDocument * *svgDocument) PURE;

  /// <summary>
  /// Draw an SVG document.
  /// </summary>
  STDMETHOD_(void, DrawSvgDocument)(_In_ ID2D1SvgDocument * svgDocument) PURE;

  /// <summary>
  /// Creates a color context from a DXGI color space type. It is only valid to
  /// use this with the Color Management Effect in 'Best' mode.
  /// </summary>
  STDMETHOD(CreateColorContextFromDxgiColorSpace)(
      DXGI_COLOR_SPACE_TYPE colorSpace,
      _COM_Outptr_ ID2D1ColorContext1 * *colorContext) PURE;

  /// <summary>
  /// Creates a color context from a simple color profile. It is only valid to
  /// use this with the Color Management Effect in 'Best' mode.
  /// </summary>
  ...
  CreateColorContextFromSimpleColorProfile(
    ...
    return CreateColorContextFromSimpleColorProfile(&simpleProfile,
                                                    colorContext);
  }
}; // interface ID2D1DeviceContext5

interface DX_DECLARE_INTERFACE("d55ba0a4-6405-4694-aef5-08ee1a4358b4")
  ...
  /// </summary>
  STDMETHOD(CreateDeviceContext)(D2D1_DEVICE_CONTEXT_OPTIONS options,
                                 _COM_Outptr_ ID2D1DeviceContext5 *
                                     *deviceContext5) PURE;
...
/// </summary>
interface DX_DECLARE_INTERFACE("f9976f46-f642-44c1-97ca-da32ea2a2635")
  ...
  /// </summary>
  STDMETHOD(CreateDevice)(_In_ IDXGIDevice * dxgiDevice,
                          _COM_Outptr_ ID2D1Device5 * *d2dDevice5) PURE;
...
interface DX_DECLARE_INTERFACE("7047dd26-b1e7-44a7-959a-8349e2144fa8")
    ID2D1CommandSink5 : public ID2D1CommandSink4 {

  STDMETHOD(BlendImage)(_In_ ID2D1Image * image, D2D1_BLEND_MODE blendMode,
...
interface DX_DECLARE_INTERFACE("985f7e37-4ed0-4a19-98a3-15b0edfde306")
  ...
  /// </summary>
  STDMETHOD_(void,
             BlendImage)(_In_ ID2D1Image * image, D2D1_BLEND_MODE blendMode,
...
interface DX_DECLARE_INTERFACE("7bfef914-2d75-4bad-be87-e18ddb077b6d")
  ...
  /// </summary>
  STDMETHOD(CreateDeviceContext)(D2D1_DEVICE_CONTEXT_OPTIONS options,
                                 _COM_Outptr_ ID2D1DeviceContext6 *
                                     *deviceContext6) PURE;
...
/// </summary>
interface DX_DECLARE_INTERFACE("bdc2bdd3-b96c-4de6-bdf7-99d4745454de")
  ...
  /// </summary>
  STDMETHOD(CreateDevice)(_In_ IDXGIDevice * dxgiDevice,
                          _COM_Outptr_ ID2D1Device6 * *d2dDevice6) PURE;
...
interface DX_DECLARE_INTERFACE("ec891cf7-9b69-4851-9def-4e0915771e62")
  ...
  /// <param name="colorPaletteIndex">The index used to select a color palette
  /// within a color font. Note that this not the same as the paletteIndex in
  /// the DWRITE_COLOR_GLYPH_RUN struct, which is not relevant for paint
  /// glyphs.</param>
...
interface DX_DECLARE_INTERFACE("f07c8968-dd4e-4ba6-9cbd-eb6d3752dcbb")
  ...
  /// </summary>
  STDMETHOD(CreateDeviceContext)(D2D1_DEVICE_CONTEXT_OPTIONS options,
                                 _COM_Outptr_ ID2D1DeviceContext7 *
                                     *deviceContext) PURE;
...
/// </summary>
interface DX_DECLARE_INTERFACE("677c9311-f36d-4b1f-ae86-86d1223ffd3a")
  ...
  /// </summary>
  STDMETHOD(CreateDevice)(_In_ IDXGIDevice * dxgiDevice,
                          _COM_Outptr_ ID2D1Device7 * *d2dDevice6) PURE;
...
void WINAPI D2D1GetGradientMeshInteriorPointsFromCoonsPatch(
    _In_ CONST D2D1_POINT_2F *pPoint0, _In_ CONST D2D1_POINT_2F *pPoint1,
    _In_ CONST D2D1_POINT_2F *pPoint2, _In_ CONST D2D1_POINT_2F *pPoint3,
    _In_ CONST D2D1_POINT_2F *pPoint4, _In_ CONST D2D1_POINT_2F *pPoint5,
    _In_ CONST D2D1_POINT_2F *pPoint6, _In_ CONST D2D1_POINT_2F *pPoint7,
    _In_ CONST D2D1_POINT_2F *pPoint8, _In_ CONST D2D1_POINT_2F *pPoint9,
    _In_ CONST D2D1_POINT_2F *pPoint10, _In_ CONST D2D1_POINT_2F *pPoint11,
    _Out_ D2D1_POINT_2F *pTensorPoint11, _Out_ D2D1_POINT_2F *pTensorPoint12,
