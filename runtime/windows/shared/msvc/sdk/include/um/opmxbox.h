...
// OPM_HDCP_TYPE_0  --> all downsteam tree supports all version fo HDCP
// including v1.4 OPM_HDCP_TYPE_1  --> all downsteam tree must be HDCP 2.2
//
...
//
HRESULT OPMXboxGetHDCPStatusAndType(OPM_HDCP_STATUS *pHDCPStatus,
                                    OPM_HDCP_TYPE *pHDCPType);
