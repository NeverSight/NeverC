...
#define CHECKMETHOD(method)                                                    \
  virtual DECLSPEC_NOTHROW _Must_inspect_result_ HRESULT STDMETHODCALLTYPE     \
      method
#endif
...
/// <summary>
/// Fonts may contain multiple drawable data formats for glyphs. These flags
/// specify which formats are supported in the font, either at a font-wide level
/// or per glyph, and the app may use them to tell DWrite which formats to
/// return when splitting a color glyph run.
/// </summary>
...
/// <summary>
/// Stores an ordered pair of floats, typically the width and height of a
/// rectangle.
/// </summary>
