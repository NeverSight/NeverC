...
extern RPC_IF_HANDLE
    __MIDL_itf_workspaceruntimeclientext_0000_0000_v0_0_c_ifspec;
extern RPC_IF_HANDLE
    __MIDL_itf_workspaceruntimeclientext_0000_0000_v0_0_s_ifspec;
...
public:
  ...
  virtual /* [helpstring] */ HRESULT STDMETHODCALLTYPE IssueDisconnect(
      void) = 0;
};
...
typedef struct IWorkspaceClientExtVtbl {
  ...
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IWorkspaceClientExt *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IWorkspaceClientExt *This);
...
#define IWorkspaceClientExt_GetResourceDisplayName(This,                       \
...
extern RPC_IF_HANDLE
    __MIDL_itf_workspaceruntimeclientext_0000_0001_v0_0_c_ifspec;
extern RPC_IF_HANDLE
    __MIDL_itf_workspaceruntimeclientext_0000_0001_v0_0_s_ifspec;
