...
typedef interface IProtectionPolicyManagerInterop
...
typedef interface IProtectionPolicyManagerInterop2
...
typedef interface IProtectionPolicyManagerInterop3
...
public:
  virtual HRESULT STDMETHODCALLTYPE RequestAccessForWindowAsync(
      ...
      /* [iid_is][retval][out] */
      __RPC__deref_out_opt void **asyncOperation) = 0;
...
#define IProtectionPolicyManagerInterop_RequestAccessForWindowAsync(           \
    This, appWindow, sourceIdentity, targetIdentity, riid, asyncOperation)     \
  ((This)->lpVtbl->RequestAccessForWindowAsync(                                \
      This, appWindow, sourceIdentity, targetIdentity, riid, asyncOperation))

#define IProtectionPolicyManagerInterop_GetForWindow(This, appWindow, riid,    \
                                                     result)                   \
...
typedef struct IProtectionPolicyManagerInterop2Vtbl {
  ...
  DECLSPEC_XFGVIRT(IProtectionPolicyManagerInterop2,
...
#define IProtectionPolicyManagerInterop2_RequestAccessForAppWithWindowAsync(   \
    This, appWindow, sourceIdentity, appPackageFamilyName, riid,               \
    asyncOperation)                                                            \
  ((This)->lpVtbl->RequestAccessForAppWithWindowAsync(                         \
      This, appWindow, sourceIdentity, appPackageFamilyName, riid,             \
      asyncOperation))

#define IProtectionPolicyManagerInterop2_RequestAccessWithAuditingInfoForWindowAsync( \
    This, appWindow, sourceIdentity, targetIdentity, auditInfoUnk, riid,              \
    asyncOperation)                                                                   \
  ((This)->lpVtbl->RequestAccessWithAuditingInfoForWindowAsync(                       \
      This, appWindow, sourceIdentity, targetIdentity, auditInfoUnk, riid,            \
      asyncOperation))

#define IProtectionPolicyManagerInterop2_RequestAccessWithMessageForWindowAsync( \
    This, appWindow, sourceIdentity, targetIdentity, auditInfoUnk,               \
    messageFromApp, riid, asyncOperation)                                        \
  ((This)->lpVtbl->RequestAccessWithMessageForWindowAsync(                       \
      This, appWindow, sourceIdentity, targetIdentity, auditInfoUnk,             \
      messageFromApp, riid, asyncOperation))

#define IProtectionPolicyManagerInterop2_RequestAccessForAppWithAuditingInfoForWindowAsync( \
    This, appWindow, sourceIdentity, appPackageFamilyName, auditInfoUnk, riid,              \
    asyncOperation)                                                                         \
  ((This)->lpVtbl->RequestAccessForAppWithAuditingInfoForWindowAsync(                       \
      This, appWindow, sourceIdentity, appPackageFamilyName, auditInfoUnk,                  \
      riid, asyncOperation))

#define IProtectionPolicyManagerInterop2_RequestAccessForAppWithMessageForWindowAsync( \
    This, appWindow, sourceIdentity, appPackageFamilyName, auditInfoUnk,               \
    messageFromApp, riid, asyncOperation)                                              \
  ((This)->lpVtbl->RequestAccessForAppWithMessageForWindowAsync(                       \
      This, appWindow, sourceIdentity, appPackageFamilyName, auditInfoUnk,             \
      messageFromApp, riid, asyncOperation))
...
typedef struct IProtectionPolicyManagerInterop3Vtbl {
  ...
  DECLSPEC_XFGVIRT(IProtectionPolicyManagerInterop3,
                   RequestAccessWithBehaviorForWindowAsync)
  ...
  DECLSPEC_XFGVIRT(IProtectionPolicyManagerInterop3,
                   RequestAccessToFilesForAppForWindowAsync)
...
#define IProtectionPolicyManagerInterop3_RequestAccessWithBehaviorForWindowAsync( \
    This, appWindow, sourceIdentity, targetIdentity, auditInfoUnk,                \
    messageFromApp, behavior, riid, asyncOperation)                               \
  ((This)->lpVtbl->RequestAccessWithBehaviorForWindowAsync(                       \
      This, appWindow, sourceIdentity, targetIdentity, auditInfoUnk,              \
      messageFromApp, behavior, riid, asyncOperation))

#define IProtectionPolicyManagerInterop3_RequestAccessForAppWithBehaviorForWindowAsync( \
    This, appWindow, sourceIdentity, appPackageFamilyName, auditInfoUnk,                \
    messageFromApp, behavior, riid, asyncOperation)                                     \
  ((This)->lpVtbl->RequestAccessForAppWithBehaviorForWindowAsync(                       \
      This, appWindow, sourceIdentity, appPackageFamilyName, auditInfoUnk,              \
      messageFromApp, behavior, riid, asyncOperation))

#define IProtectionPolicyManagerInterop3_RequestAccessToFilesForAppForWindowAsync( \
    This, appWindow, sourceItemListUnk, appPackageFamilyName, auditInfoUnk,        \
    riid, asyncOperation)                                                          \
  ((This)->lpVtbl->RequestAccessToFilesForAppForWindowAsync(                       \
      This, appWindow, sourceItemListUnk, appPackageFamilyName, auditInfoUnk,      \
      riid, asyncOperation))

#define IProtectionPolicyManagerInterop3_RequestAccessToFilesForAppWithMessageAndBehaviorForWindowAsync( \
    This, appWindow, sourceItemListUnk, appPackageFamilyName, auditInfoUnk,                              \
    messageFromApp, behavior, riid, asyncOperation)                                                      \
  ((This)                                                                                                \
       ->lpVtbl                                                                                          \
       ->RequestAccessToFilesForAppWithMessageAndBehaviorForWindowAsync(                                 \
           This, appWindow, sourceItemListUnk, appPackageFamilyName,                                     \
           auditInfoUnk, messageFromApp, behavior, riid, asyncOperation))

#define IProtectionPolicyManagerInterop3_RequestAccessToFilesForProcessForWindowAsync( \
    This, appWindow, sourceItemListUnk, processId, auditInfoUnk, riid,                 \
    asyncOperation)                                                                    \
  ((This)->lpVtbl->RequestAccessToFilesForProcessForWindowAsync(                       \
      This, appWindow, sourceItemListUnk, processId, auditInfoUnk, riid,               \
      asyncOperation))

#define IProtectionPolicyManagerInterop3_RequestAccessToFilesForProcessWithMessageAndBehaviorForWindowAsync( \
    This, appWindow, sourceItemListUnk, processId, auditInfoUnk,                                             \
    messageFromApp, behavior, riid, asyncOperation)                                                          \
  ((This)                                                                                                    \
       ->lpVtbl                                                                                              \
       ->RequestAccessToFilesForProcessWithMessageAndBehaviorForWindowAsync(                                 \
...
unsigned long __RPC_USER HSTRING_UserSize(__RPC__in unsigned long *,
                                          unsigned long, __RPC__in HSTRING *);
unsigned char *__RPC_USER HSTRING_UserMarshal(
    __RPC__in unsigned long *, __RPC__inout_xcount(0) unsigned char *,
    __RPC__in HSTRING *);
unsigned char *__RPC_USER HSTRING_UserUnmarshal(
    __RPC__in unsigned long *, __RPC__in_xcount(0) unsigned char *,
    __RPC__out HSTRING *);
void __RPC_USER HSTRING_UserFree(__RPC__in unsigned long *,
                                 __RPC__in HSTRING *);
...
unsigned long __RPC_USER HSTRING_UserSize64(__RPC__in unsigned long *,
                                            unsigned long, __RPC__in HSTRING *);
unsigned char *__RPC_USER HSTRING_UserMarshal64(
    __RPC__in unsigned long *, __RPC__inout_xcount(0) unsigned char *,
    __RPC__in HSTRING *);
unsigned char *__RPC_USER HSTRING_UserUnmarshal64(
    __RPC__in unsigned long *, __RPC__in_xcount(0) unsigned char *,
    __RPC__out HSTRING *);
void __RPC_USER HSTRING_UserFree64(__RPC__in unsigned long *,
                                   __RPC__in HSTRING *);
