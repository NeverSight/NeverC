...
DEFINE_GUID(CLSID_XPSRASTERIZER_FACTORY, 0x503E79BF, 0x1D09, 0x4764, 0x9D, 0x72,
            0x1E, 0xB0, 0xC6, 0x59, 0x67, 0xC6);
...
public:
  virtual /* [helpstring] */ HRESULT STDMETHODCALLTYPE RasterizeRect(
      ...
      /* [in] */ INT width,
      /* [in] */ INT height,
      /* [in] */ __RPC__in_opt IXpsRasterizerNotificationCallback *
...
typedef struct IXpsRasterizerVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in IXpsRasterizer *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IXpsRasterizer *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IXpsRasterizer *This);
...
interface IXpsRasterizer { CONST_VTBL struct IXpsRasterizerVtbl *lpVtbl; };
...
typedef struct IXpsRasterizationFactoryVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IXpsRasterizationFactory *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IXpsRasterizationFactory *This);
...
typedef /* [public][public][public] */
    enum __MIDL___MIDL_itf_xpsrassvc_0000_0003_0001 {
      ...
      XPSRAS_PIXEL_FORMAT_128BPP_PRGBA_FLOAT_SCRGB =
          (XPSRAS_PIXEL_FORMAT_64BPP_PRGBA_HALF_SCRGB + 1)
    } XPSRAS_PIXEL_FORMAT;
...
typedef struct IXpsRasterizationFactory1Vtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IXpsRasterizationFactory1 *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IXpsRasterizationFactory1 *This);
...
typedef struct IXpsRasterizationFactory2Vtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IXpsRasterizationFactory2 *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IXpsRasterizationFactory2 *This);
...
#define IXpsRasterizationFactory2_AddRef(This) ((This)->lpVtbl->AddRef(This))

#define IXpsRasterizationFactory2_Release(This) ((This)->lpVtbl->Release(This))

#define IXpsRasterizationFactory2_CreateRasterizer(                            \
    This, xpsPage, DPIX, DPIY, nonTextRenderingMode, textRenderingMode,        \
    pixelFormat, backgroundColor, ppIXpsRasterizer)                            \
  ((This)->lpVtbl->CreateRasterizer(                                           \
      This, xpsPage, DPIX, DPIY, nonTextRenderingMode, textRenderingMode,      \
      pixelFormat, backgroundColor, ppIXpsRasterizer))
