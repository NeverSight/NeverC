...
typedef struct IWSManVtbl {
  ...
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(IWSMan *This,
                                             /* [in] */ REFIID riid,
  ...
  HRESULT(STDMETHODCALLTYPE *GetTypeInfoCount)(IWSMan *This,
                                               /* [out] */ UINT *pctinfo);

  DECLSPEC_XFGVIRT(IDispatch, GetTypeInfo)
  HRESULT(STDMETHODCALLTYPE *GetTypeInfo)(IWSMan *This,
                                          /* [in] */ UINT iTInfo,
                                          /* [in] */ LCID lcid,
...
interface IWSMan { CONST_VTBL struct IWSManVtbl *lpVtbl; };
...
typedef struct IWSManExVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(IWSManEx *This,
                                             /* [in] */ REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);
  ...
  DECLSPEC_XFGVIRT(IDispatch, GetTypeInfoCount)
  HRESULT(STDMETHODCALLTYPE *GetTypeInfoCount)(IWSManEx *This,
                                               /* [out] */ UINT *pctinfo);

  DECLSPEC_XFGVIRT(IDispatch, GetTypeInfo)
  HRESULT(STDMETHODCALLTYPE *GetTypeInfo)(IWSManEx *This,
                                          /* [in] */ UINT iTInfo,
                                          /* [in] */ LCID lcid,
                                          /* [out] */ ITypeInfo **ppTInfo);
  ...
  /* [id] */ HRESULT(
      STDMETHODCALLTYPE *EnumerationFlagHierarchyDeepBasePropsOnly)(
      IWSManEx *This,
      /* [retval][out] */ long *flags);
...
interface IWSManEx { CONST_VTBL struct IWSManExVtbl *lpVtbl; };
...
typedef struct IWSManEx2Vtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(IWSManEx2 *This,
                                             /* [in] */ REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);
  ...
  DECLSPEC_XFGVIRT(IDispatch, GetTypeInfoCount)
  HRESULT(STDMETHODCALLTYPE *GetTypeInfoCount)(IWSManEx2 *This,
                                               /* [out] */ UINT *pctinfo);

  DECLSPEC_XFGVIRT(IDispatch, GetTypeInfo)
  HRESULT(STDMETHODCALLTYPE *GetTypeInfo)(IWSManEx2 *This,
                                          /* [in] */ UINT iTInfo,
                                          /* [in] */ LCID lcid,
                                          /* [out] */ ITypeInfo **ppTInfo);
...
interface IWSManEx2 { CONST_VTBL struct IWSManEx2Vtbl *lpVtbl; };
...
typedef struct IWSManEx3Vtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(IWSManEx3 *This,
                                             /* [in] */ REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);
  ...
  DECLSPEC_XFGVIRT(IDispatch, GetTypeInfoCount)
  HRESULT(STDMETHODCALLTYPE *GetTypeInfoCount)(IWSManEx3 *This,
                                               /* [out] */ UINT *pctinfo);

  DECLSPEC_XFGVIRT(IDispatch, GetTypeInfo)
  HRESULT(STDMETHODCALLTYPE *GetTypeInfo)(IWSManEx3 *This,
                                          /* [in] */ UINT iTInfo,
                                          /* [in] */ LCID lcid,
                                          /* [out] */ ITypeInfo **ppTInfo);
  ...
  /* [id] */ HRESULT(
      STDMETHODCALLTYPE *SessionFlagAllowNegotiateImplicitCredentials)(
      IWSManEx3 *This,
      /* [retval][out] */ long *flags);
...
interface IWSManEx3 { CONST_VTBL struct IWSManEx3Vtbl *lpVtbl; };
...
typedef struct IWSManSessionVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(IWSManSession *This,
                                             /* [in] */ REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);
  ...
  DECLSPEC_XFGVIRT(IDispatch, GetTypeInfo)
  HRESULT(STDMETHODCALLTYPE *GetTypeInfo)(IWSManSession *This,
                                          /* [in] */ UINT iTInfo,
                                          /* [in] */ LCID lcid,
                                          /* [out] */ ITypeInfo **ppTInfo);
...
interface IWSManSession { CONST_VTBL struct IWSManSessionVtbl *lpVtbl; };
...
#define IWSManSession_Invoke(This, dispIdMember, riid, lcid, wFlags,           \
...
#define IWSManSession_Invoke(This, actionUri, resourceUri, parameters, flags,  \
                             result)                                           \
  ((This)->lpVtbl->Invoke(This, actionUri, resourceUri, parameters, flags,     \
                          result))
...
typedef struct IWSManEnumeratorVtbl {
  ...
  DECLSPEC_XFGVIRT(IDispatch, GetTypeInfo)
  HRESULT(STDMETHODCALLTYPE *GetTypeInfo)(IWSManEnumerator *This,
                                          /* [in] */ UINT iTInfo,
                                          /* [in] */ LCID lcid,
                                          /* [out] */ ITypeInfo **ppTInfo);
...
interface IWSManEnumerator { CONST_VTBL struct IWSManEnumeratorVtbl *lpVtbl; };
...
public:
  ...
  virtual /* [helpstring][id] */ HRESULT STDMETHODCALLTYPE ClearSelectors(
      void) = 0;
  ...
  virtual /* [helpstring][id] */ HRESULT STDMETHODCALLTYPE ClearOptions(
      void) = 0;
...
typedef struct IWSManResourceLocatorVtbl {
  ...
  /* [helpstring][propget][id] */ HRESULT(
      STDMETHODCALLTYPE *get_FragmentDialect)(IWSManResourceLocator *This,
                                              /* [retval][out] */ BSTR *text);

  DECLSPEC_XFGVIRT(IWSManResourceLocator, put_FragmentDialect)
  /* [helpstring][propput][id] */ HRESULT(
      STDMETHODCALLTYPE *put_FragmentDialect)(IWSManResourceLocator *This,
                                              /* [in] */ BSTR text);
  ...
  /* [helpstring][propput][id] */ HRESULT(
      STDMETHODCALLTYPE *put_MustUnderstandOptions)(
      IWSManResourceLocator *This,
      /* [in] */ BOOL mustUnderstand);

  DECLSPEC_XFGVIRT(IWSManResourceLocator, get_MustUnderstandOptions)
  /* [helpstring][propget][id] */ HRESULT(
      STDMETHODCALLTYPE *get_MustUnderstandOptions)(
      IWSManResourceLocator *This,
...
IWSManResourceLocatorInternal : public IUnknown{public : };
...
typedef struct IWSManInternalVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(IWSManInternal *This,
                                             /* [in] */ REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);
  ...
  DECLSPEC_XFGVIRT(IDispatch, GetTypeInfo)
  HRESULT(STDMETHODCALLTYPE *GetTypeInfo)(IWSManInternal *This,
                                          /* [in] */ UINT iTInfo,
                                          /* [in] */ LCID lcid,
                                          /* [out] */ ITypeInfo **ppTInfo);
...
interface IWSManInternal { CONST_VTBL struct IWSManInternalVtbl *lpVtbl; };
