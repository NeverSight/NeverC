...
typedef /* [string][unique] */ __RPC_unique_pointer __RPC_string WCHAR
    *VSS_PWSZ;
...
public:
  virtual HRESULT STDMETHODCALLTYPE Next(
      ...
      __RPC__out_ecount_part(celt, *pceltFetched) VSS_OBJECT_PROP * rgelt,
...
typedef struct IVssEnumObjectVtbl {
  ...
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in IVssEnumObject *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IVssEnumObject *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IVssEnumObject *This);

  DECLSPEC_XFGVIRT(IVssEnumObject, Next)
  HRESULT(STDMETHODCALLTYPE *Next)(__RPC__in IVssEnumObject *This,
                                   /* [in] */ ULONG celt,
                                   /* [length_is][size_is][out] */
  ...
  HRESULT(STDMETHODCALLTYPE *Skip)(__RPC__in IVssEnumObject *This,
                                   /* [in] */ ULONG celt);

  DECLSPEC_XFGVIRT(IVssEnumObject, Reset)
  HRESULT(STDMETHODCALLTYPE *Reset)(__RPC__in IVssEnumObject *This);
...
interface IVssEnumObject { CONST_VTBL struct IVssEnumObjectVtbl *lpVtbl; };
...
typedef struct IVssAsyncVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in IVssAsync *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IVssAsync *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IVssAsync *This);
...
interface IVssAsync { CONST_VTBL struct IVssAsyncVtbl *lpVtbl; };
