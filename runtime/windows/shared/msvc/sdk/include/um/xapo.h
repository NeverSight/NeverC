...
interface __declspec(uuid(
    "26D95C66-80F2-499A-AD54-5AE7F01C6D98")) IXAPOParameters;
EXTERN_C const GUID DECLSPEC_SELECTANY IID_IXAPOParameters =
    __uuidof(IXAPOParameters);
#else
...
DECLARE_INTERFACE_(IXAPO, IUnknown) {
  ...
  STDMETHOD(GetRegistrationProperties)(
      THIS_ _Outptr_ XAPO_REGISTRATION_PROPERTIES * *ppRegistrationProperties)
      PURE;
  ...
  STDMETHOD(IsInputFormatSupported)(
      ...
      _Outptr_opt_ WAVEFORMATEX **ppSupportedInputFormat) PURE;
  ...
  STDMETHOD(IsOutputFormatSupported)(
      ...
      _Outptr_opt_ WAVEFORMATEX **ppSupportedOutputFormat) PURE;
  ...
  //  COM error code
  ////
  STDMETHOD(Initialize)(THIS_ _In_reads_bytes_opt_(DataByteSize)
                            const void *pData,
                        UINT32 DataByteSize) PURE;
  ...
  STDMETHOD_(void, Process)(
      ...
      _In_reads_opt_(InputProcessParameterCount)
          const XAPO_PROCESS_BUFFER_PARAMETERS *pInputProcessParameters,
      UINT32 OutputProcessParameterCount,
      _Inout_updates_opt_(OutputProcessParameterCount)
...
DECLARE_INTERFACE_(IXAPOParameters, IUnknown) {
  ...
  //  void
  ////
  STDMETHOD_(void, SetParameters)(THIS_ _In_reads_bytes_(ParameterByteSize)
  ...
  STDMETHOD_(void, GetParameters)(
      THIS_ _Out_writes_bytes_(ParameterByteSize) void *pParameters,
      UINT32 ParameterByteSize) PURE;
};
