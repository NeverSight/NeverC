...
typedef struct IAdapterInfoVtbl {
  ...
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in IAdapterInfo *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IAdapterInfo *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IAdapterInfo *This);
...
interface IAdapterInfo { CONST_VTBL struct IAdapterInfoVtbl *lpVtbl; };
...
typedef struct IPendingProxyConnectionVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IPendingProxyConnection *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IPendingProxyConnection *This);

  DECLSPEC_XFGVIRT(IPendingProxyConnection, Cancel)
  HRESULT(STDMETHODCALLTYPE *Cancel)(__RPC__in IPendingProxyConnection *This);
...
typedef struct IDataChannelVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(IDataChannel *This,
                                             /* [in] */ REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);
...
interface IDataChannel { CONST_VTBL struct IDataChannelVtbl *lpVtbl; };
...
public:
  ...
  virtual HRESULT STDMETHODCALLTYPE GetChannelProperties(
      /* [out] */ __RPC__deref_out_opt ALG_PERSISTENT_DATA_CHANNEL_PROPERTIES *
      *ppProperties) = 0;
};
...
typedef struct IPersistentDataChannelVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IPersistentDataChannel *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IPersistentDataChannel *This);

  DECLSPEC_XFGVIRT(IPersistentDataChannel, Cancel)
  HRESULT(STDMETHODCALLTYPE *Cancel)(__RPC__in IPersistentDataChannel *This);
...
public:
  ...
  virtual HRESULT STDMETHODCALLTYPE GetChannelProperties(
      /* [out] */ __RPC__deref_out_opt ALG_PRIMARY_CHANNEL_PROPERTIES *
      *ppProperties) = 0;
...
typedef struct IPrimaryControlChannelVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IPrimaryControlChannel *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IPrimaryControlChannel *This);

  DECLSPEC_XFGVIRT(IPrimaryControlChannel, Cancel)
  HRESULT(STDMETHODCALLTYPE *Cancel)(__RPC__in IPrimaryControlChannel *This);
...
public:
  ...
  virtual HRESULT STDMETHODCALLTYPE GetChannelProperties(
      /* [out] */ __RPC__deref_out_opt ALG_SECONDARY_CHANNEL_PROPERTIES *
      *ppProperties) = 0;
...
typedef struct ISecondaryControlChannelVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in ISecondaryControlChannel *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in ISecondaryControlChannel *This);

  DECLSPEC_XFGVIRT(ISecondaryControlChannel, Cancel)
  HRESULT(STDMETHODCALLTYPE *Cancel)(__RPC__in ISecondaryControlChannel *This);
...
typedef struct IEnumAdapterInfoVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in IEnumAdapterInfo *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IEnumAdapterInfo *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IEnumAdapterInfo *This);

  DECLSPEC_XFGVIRT(IEnumAdapterInfo, Next)
  HRESULT(STDMETHODCALLTYPE *Next)(__RPC__in IEnumAdapterInfo *This,
                                   /* [in] */ ULONG celt,
                                   /* [length_is][size_is][out] */
  ...
  HRESULT(STDMETHODCALLTYPE *Skip)(__RPC__in IEnumAdapterInfo *This,
                                   /* [in] */ ULONG celt);

  DECLSPEC_XFGVIRT(IEnumAdapterInfo, Reset)
  HRESULT(STDMETHODCALLTYPE *Reset)(__RPC__in IEnumAdapterInfo *This);
...
interface IEnumAdapterInfo { CONST_VTBL struct IEnumAdapterInfoVtbl *lpVtbl; };
...
public:
  virtual HRESULT STDMETHODCALLTYPE AdapterAdded(__RPC__in_opt IAdapterInfo *
                                                 pAdapter) = 0;

  virtual HRESULT STDMETHODCALLTYPE AdapterRemoved(__RPC__in_opt IAdapterInfo *
                                                   pAdapter) = 0;

  virtual HRESULT STDMETHODCALLTYPE AdapterModified(__RPC__in_opt IAdapterInfo *
                                                    pAdapter) = 0;
...
typedef struct IAdapterNotificationSinkVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IAdapterNotificationSink *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IAdapterNotificationSink *This);
...
public:
  virtual HRESULT STDMETHODCALLTYPE CreatePrimaryControlChannel(
      ...
      /* [out] */ __RPC__deref_out_opt IPrimaryControlChannel *
          *ppIControlChannel) = 0;
  ...
  virtual HRESULT STDMETHODCALLTYPE CreateSecondaryControlChannel(
      ...
      /* [in] */ BOOL fPersistent,
      /* [out] */ __RPC__deref_out_opt ISecondaryControlChannel *
          *ppControlChannel) = 0;
  ...
  virtual HRESULT STDMETHODCALLTYPE PrepareProxyConnection(
      ...
      /* [in] */ USHORT usDstPort,
      /* [in] */ BOOL fNoTimeout,
      /* [out] */ __RPC__deref_out_opt IPendingProxyConnection *
          *ppPendingConnection) = 0;
  ...
  virtual HRESULT STDMETHODCALLTYPE CreatePersistentDataChannel(
      ...
      /* [in] */ USHORT usRemotePort,
      /* [in] */ ALG_DIRECTION eDirection,
      /* [out] */ __RPC__deref_out_opt IPersistentDataChannel *
          *ppIPersistentDataChannel) = 0;
  ...
  virtual HRESULT STDMETHODCALLTYPE EnumerateAdapters(
      /* [out] */ __RPC__deref_out_opt IEnumAdapterInfo *
...
typedef struct IApplicationGatewayServicesVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IApplicationGatewayServices *This);
  ...
  DECLSPEC_XFGVIRT(IApplicationGatewayServices,
...
typedef struct IApplicationGatewayVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IApplicationGateway *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IApplicationGateway *This);
  ...
  HRESULT(STDMETHODCALLTYPE *Stop)(__RPC__in IApplicationGateway *This);
