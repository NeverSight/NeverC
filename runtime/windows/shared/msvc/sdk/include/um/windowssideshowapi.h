...
typedef interface ISideShowCapabilitiesCollection
...
public:
  virtual HRESULT STDMETHODCALLTYPE RegisterContent(
      ...
      /* [out] */ __RPC__deref_out_opt ISideShowContentManager *
          *out_ppIContent) = 0;

  virtual HRESULT STDMETHODCALLTYPE RegisterNotifications(
      /* [in] */ __RPC__in REFAPPLICATION_ID in_applicationId,
      /* [out] */ __RPC__deref_out_opt ISideShowNotificationManager *
          *out_ppINotification) = 0;
};
...
typedef struct ISideShowSessionVtbl {
  ...
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in ISideShowSession *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in ISideShowSession *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in ISideShowSession *This);
...
interface ISideShowSession { CONST_VTBL struct ISideShowSessionVtbl *lpVtbl; };
...
#define ISideShowSession_RegisterContent(This, in_applicationId,               \
                                         in_endpointId, out_ppIContent)        \
  ((This)->lpVtbl->RegisterContent(This, in_applicationId, in_endpointId,      \
                                   out_ppIContent))

#define ISideShowSession_RegisterNotifications(This, in_applicationId,         \
                                               out_ppINotification)            \
  ((This)->lpVtbl->RegisterNotifications(This, in_applicationId,               \
                                         out_ppINotification))
...
typedef struct ISideShowNotificationVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in ISideShowNotification *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in ISideShowNotification *This);
...
public:
  ...
  virtual HRESULT STDMETHODCALLTYPE GetDeviceCapabilities(
      /* [out] */ __RPC__deref_out_opt ISideShowCapabilitiesCollection *
      *out_ppCollection) = 0;
};
...
typedef struct ISideShowContentManagerVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in ISideShowContentManager *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in ISideShowContentManager *This);
  ...
  HRESULT(STDMETHODCALLTYPE *Remove)(__RPC__in ISideShowContentManager *This,
...
public:
  virtual HRESULT STDMETHODCALLTYPE GetContent(
      /* [unique][in] */ __RPC__in_opt ISideShowCapabilities *
          in_pICapabilities,
      /* [out] */ __RPC__out DWORD * out_pdwSize,
      /* [size_is][size_is][out] */
      __RPC__deref_out_ecount_full_opt(*out_pdwSize) BYTE * *out_ppbData) = 0;
...
typedef struct ISideShowContentVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in ISideShowContent *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in ISideShowContent *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in ISideShowContent *This);
...
interface ISideShowContent { CONST_VTBL struct ISideShowContentVtbl *lpVtbl; };
...
#define ISideShowContent_GetContent(This, in_pICapabilities, out_pdwSize,      \
                                    out_ppbData)                               \
  ((This)->lpVtbl->GetContent(This, in_pICapabilities, out_pdwSize,            \
                              out_ppbData))

#define ISideShowContent_get_ContentId(This, out_pcontentId)                   \
  ((This)->lpVtbl->get_ContentId(This, out_pcontentId))

#define ISideShowContent_get_DifferentiateContent(This,                        \
...
public:
  ...
  virtual HRESULT STDMETHODCALLTYPE ApplicationEvent(
      ...
      /* [size_is][unique][in] */
      __RPC__in_ecount_full_opt(in_dwEventSize) const BYTE *in_pbEventData) = 0;
...
typedef struct ISideShowEventsVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in ISideShowEvents *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in ISideShowEvents *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in ISideShowEvents *This);
...
interface ISideShowEvents { CONST_VTBL struct ISideShowEventsVtbl *lpVtbl; };
...
#define ISideShowEvents_ApplicationEvent(                                      \
    This, in_pICapabilities, in_dwEventId, in_dwEventSize, in_pbEventData)     \
  ((This)->lpVtbl->ApplicationEvent(This, in_pICapabilities, in_dwEventId,     \
                                    in_dwEventSize, in_pbEventData))
...
typedef struct ISideShowCapabilitiesVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in ISideShowCapabilities *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in ISideShowCapabilities *This);
...
#define ISideShowCapabilities_GetCapability(This, in_keyCapability,            \
                                            inout_pValue)                      \
...
public:
  ...
  virtual HRESULT STDMETHODCALLTYPE GetAt(
      /* [in] */ DWORD in_dwIndex,
      /* [out] */ __RPC__deref_out_opt ISideShowCapabilities *
          *out_ppCapabilities) = 0;
};
...
#define ISideShowCapabilitiesCollection_GetAt(This, in_dwIndex,                \
                                              out_ppCapabilities)              \
...
public:
  virtual HRESULT STDMETHODCALLTYPE GetCapabilities(
      ...
      /* [out][in] */ __RPC__deref_inout_opt ISideShowPropVariantCollection *
          *inout_pValues) = 0;
};
...
typedef struct ISideShowBulkCapabilitiesVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in ISideShowBulkCapabilities *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in ISideShowBulkCapabilities *This);
...
#define ISideShowBulkCapabilities_GetCapability(This, in_keyCapability,        \
                                                inout_pValue)                  \
  ((This)->lpVtbl->GetCapability(This, in_keyCapability, inout_pValue))

#define ISideShowBulkCapabilities_GetCapabilities(This, in_keyCollection,      \
                                                  inout_pValues)               \
...
typedef struct ISideShowKeyCollectionVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in ISideShowKeyCollection *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in ISideShowKeyCollection *This);

  DECLSPEC_XFGVIRT(ISideShowKeyCollection, Add)
  HRESULT(STDMETHODCALLTYPE *Add)(__RPC__in ISideShowKeyCollection *This,
                                  /* [in] */ __RPC__in REFPROPERTYKEY Key);

  DECLSPEC_XFGVIRT(ISideShowKeyCollection, Clear)
  HRESULT(STDMETHODCALLTYPE *Clear)(__RPC__in ISideShowKeyCollection *This);
  ...
  HRESULT(STDMETHODCALLTYPE *GetCount)(__RPC__in ISideShowKeyCollection *This,
                                       /* [in] */ __RPC__in DWORD *pcElems);

  DECLSPEC_XFGVIRT(ISideShowKeyCollection, RemoveAt)
  HRESULT(STDMETHODCALLTYPE *RemoveAt)(__RPC__in ISideShowKeyCollection *This,
                                       /* [in] */ const DWORD dwIndex);
