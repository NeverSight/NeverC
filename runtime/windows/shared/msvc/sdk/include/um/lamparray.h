...
enum class LampArrayEnumerationKind : uint32_t { Async = 1, Blocking = 2 };
...
inline constexpr uint64_t LAMPARRAY_INVALID_CALLBACK_TOKEN_VALUE =
    0x0000000000000000ULL;

typedef void(CALLBACK *LampArrayCallback)(_In_opt_ void *context,
                                          bool isAttached,
                                          _In_ ILampArray *lampArray);

typedef void(CALLBACK *LampArrayStatusCallback)(_In_opt_ void *context,
...
DECLARE_INTERFACE_IID_(INTERFACE, IUnknown,
                       "AE82EDD1-6B75-43CF-9BEA-F600A49A320C") {
  ...
  IFACEMETHOD_(void, GetPosition)(THIS_ _Out_ LampArrayPosition * position)
      PURE;
  ...
  IFACEMETHOD_(bool, GetFixedColor)(THIS_ _Out_ LampArrayColor * fixedColor)
      PURE;

  IFACEMETHOD_(LampArrayColor, GetNearestSupportedColor)(
      THIS_ LampArrayColor desiredColor) PURE;
...
DECLARE_INTERFACE_IID_(INTERFACE, IUnknown,
                       "45577878-466D-40ED-AB72-C448C70E1252") {
  _Must_inspect_result_ IFACEMETHOD(QueryInterface)(
      THIS_ _In_ REFIID riid, _COM_Outptr_ void **ppvObj) PURE;
  ...
  IFACEMETHOD_(void, GetDeviceId)(THIS_ _Out_ APP_LOCAL_DEVICE_ID * deviceId)
      PURE;
  ...
  IFACEMETHOD_(void, GetBoundingBox)(THIS_ _Out_ LampArrayPosition *
                                     boundingBox) PURE;

  IFACEMETHOD_(bool, GetIsEnabled)(THIS) PURE;

  IFACEMETHOD_(void, SetIsEnabled)(THIS_ bool isEnabled) PURE;

  IFACEMETHOD_(double, GetBrightnessLevel)(THIS) PURE;

  IFACEMETHOD_(void, SetBrightnessLevel)(THIS_ double brightnessLevel) PURE;

  IFACEMETHOD_(bool, SupportsScanCodes)(THIS) PURE;

  _Must_inspect_result_ IFACEMETHOD(GetLampInfo)(
      THIS_ uint32_t lampIndex, _COM_Outptr_ ILampInfo **lampInfo) PURE;

  IFACEMETHOD_(uint32_t, GetIndicesCountForPurposes)(
      THIS_ LampPurposes lampPurposes) PURE;

  IFACEMETHOD_(void, GetIndicesForPurposes)(
      THIS_ LampPurposes lampPurposes, uint32_t lampIndicesCount,
      _Out_writes_(lampIndicesCount) uint32_t *lampIndices) PURE;

  IFACEMETHOD_(void, SetColor)(THIS_ LampArrayColor desiredColor) PURE;

  IFACEMETHOD_(void, SetColorsForIndices)(
      THIS_ uint32_t lampIndicesCount,
  ...
  IFACEMETHOD_(void, SetColorsForScanCodes)(
      THIS_ uint32_t scanCodesCount,
...
STDAPI RegisterLampArrayCallback(
    _In_ LampArrayCallback lampArrayCallback, _In_opt_ void *context,
...
STDAPI RegisterLampArrayStatusCallback(
    ...
    LampArrayEnumerationKind enumerationKind, _In_opt_ void *context,
    _Out_ _Result_zeroonfailure_ LampArrayCallbackToken *callbackToken);

STDAPI_(bool)
UnregisterLampArrayCallback(LampArrayCallbackToken callbackToken,
                            uint64_t timeoutInMicroseconds);

STDAPI TrySetLampArrayWorkerThreadAffinityMask(uint64_t threadAffinityMask);
...
// MessageText:
//
// The callback is being registered or unregistered from within a registered
// callback, which is not supported.
//
#define LAMPARRAY_E_CALLBACK_REGISTRATION_WRONG_THREAD                         \
  _HRESULT_TYPEDEF_(0x84980001L)
