...
typedef struct IMessageDispatcherVtbl {
  ...
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(IMessageDispatcher *This,
                                             /* [in] */ REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(IMessageDispatcher *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(IMessageDispatcher *This);

  DECLSPEC_XFGVIRT(IInspectable, GetIids)
  HRESULT(STDMETHODCALLTYPE *GetIids)(IMessageDispatcher *This,
                                      /* [out] */ ULONG *iidCount,
  ...
  HRESULT(STDMETHODCALLTYPE *GetTrustLevel)(IMessageDispatcher *This,
                                            /* [out] */ TrustLevel *trustLevel);

  DECLSPEC_XFGVIRT(IMessageDispatcher, PumpMessages)
  HRESULT(STDMETHODCALLTYPE *PumpMessages)(IMessageDispatcher *This);
...
#define IMessageDispatcher_AddRef(This) ((This)->lpVtbl->AddRef(This))

#define IMessageDispatcher_Release(This) ((This)->lpVtbl->Release(This))
