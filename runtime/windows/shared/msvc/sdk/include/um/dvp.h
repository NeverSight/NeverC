...
DECLARE_INTERFACE_(IDDVideoPortContainer, IUnknown) {
  ...
  STDMETHOD(CreateVideoPort)(THIS_ DWORD, LPDDVIDEOPORTDESC,
                             LPDIRECTDRAWVIDEOPORT FAR *, IUnknown FAR *) PURE;
  STDMETHOD(EnumVideoPorts)(THIS_ DWORD, LPDDVIDEOPORTCAPS, LPVOID,
                            LPDDENUMVIDEOCALLBACK) PURE;
  STDMETHOD(GetVideoPortConnectInfo)(THIS_ DWORD, _Inout_ LPDWORD pcInfo,
                                     _Out_writes_to_opt_(*pcInfo, *pcInfo)
...
DECLARE_INTERFACE_(IDirectDrawVideoPort, IUnknown) {
  ...
  STDMETHOD(GetInputFormats)(THIS_ LPDWORD lpNumFormats,
                             _Out_writes_to_opt_(*lpNumFormats, *lpNumFormats)
                                 LPDDPIXELFORMAT,
                             DWORD) PURE;
  STDMETHOD(GetOutputFormats)(THIS_ LPDDPIXELFORMAT, LPDWORD lpNumFormats,
                              _Out_writes_to_opt_(*lpNumFormats, *lpNumFormats)
                                  LPDDPIXELFORMAT,
                              DWORD) PURE;
