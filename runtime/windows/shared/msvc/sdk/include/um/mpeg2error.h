...
const HRESULT MPEG2_S_MORE_DATA_AVAILABLE =
    MAKE_S_ITF_HRESULT(MPEG2_BASE + 0x00);
const HRESULT MPEG2_S_NO_MORE_DATA_AVAILABLE =
    MAKE_S_ITF_HRESULT(MPEG2_BASE + 0x01);
...
const HRESULT MPEG2_S_MPE_INFO_NOT_FOUND =
    MAKE_S_ITF_HRESULT(MPEG2_BASE + 0x05);
const HRESULT MPEG2_S_NEW_MODULE_VERSION =
    MAKE_S_ITF_HRESULT(MPEG2_BASE + 0x06);
...
const HRESULT MPEG2_E_ALREADY_INITIALIZED =
    MAKE_E_ITF_HRESULT(MPEG2_BASE + 0x01);
...
const HRESULT MPEG2_E_NEXT_TABLE_OPS_NOT_AVAILABLE =
    MAKE_E_ITF_HRESULT(MPEG2_BASE + 0x1C);
const HRESULT MPEG2_E_INCORRECT_DESCRIPTOR_TAG =
    MAKE_E_ITF_HRESULT(MPEG2_BASE + 0x1D);
