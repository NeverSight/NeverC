...
extern RPC_IF_HANDLE
    __MIDL_itf_defaultbrowsersyncsettings_0000_0000_v0_0_c_ifspec;
extern RPC_IF_HANDLE
    __MIDL_itf_defaultbrowsersyncsettings_0000_0000_v0_0_s_ifspec;
...
typedef struct IDefaultBrowserSyncSettingsVtbl {
  ...
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(IDefaultBrowserSyncSettings *This,
                                             /* [in] */ REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(IDefaultBrowserSyncSettings *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(IDefaultBrowserSyncSettings *This);

  DECLSPEC_XFGVIRT(IDefaultBrowserSyncSettings, IsEnabled)
  BOOL(STDMETHODCALLTYPE *IsEnabled)(IDefaultBrowserSyncSettings *This);
...
extern RPC_IF_HANDLE
    __MIDL_itf_defaultbrowsersyncsettings_0000_0002_v0_0_c_ifspec;
extern RPC_IF_HANDLE
    __MIDL_itf_defaultbrowsersyncsettings_0000_0002_v0_0_s_ifspec;
