...
typedef struct IDedupChunkLibraryVtbl {
  ...
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in IDedupChunkLibrary *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IDedupChunkLibrary *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IDedupChunkLibrary *This);
  ...
  HRESULT(STDMETHODCALLTYPE *Uninitialize)(__RPC__in IDedupChunkLibrary *This);

  DECLSPEC_XFGVIRT(IDedupChunkLibrary, SetParameter)
  HRESULT(STDMETHODCALLTYPE *SetParameter)(__RPC__in IDedupChunkLibrary *This,
                                           /* [in] */ DWORD dwParamType,
...
#define IDedupChunkLibrary_StartChunking(This, iidIteratorInterfaceID,         \
                                         ppChunksEnum)                         \
...
public:
  ...
  virtual HRESULT STDMETHODCALLTYPE Next(
      /* [range][in] */ __RPC__in_range(0, DEDUP_CHUNKLIB_MAX_CHUNKS_ENUM)
          ULONG ulMaxChunks,
      /* [length_is][size_is][out] */
      __RPC__out_ecount_part(ulMaxChunks, *pulFetched) DEDUP_CHUNK_INFO_HASH32 *
          pArrChunks,
...
typedef struct IDedupIterateChunksHash32Vtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IDedupIterateChunksHash32 *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IDedupIterateChunksHash32 *This);
  ...
  HRESULT(STDMETHODCALLTYPE *Next)(
      ...
      /* [length_is][size_is][out] */
      __RPC__out_ecount_part(ulMaxChunks, *pulFetched)
          DEDUP_CHUNK_INFO_HASH32 *pArrChunks,
      /* [out] */ __RPC__out ULONG *pulFetched);

  DECLSPEC_XFGVIRT(IDedupIterateChunksHash32, Drain)
  HRESULT(STDMETHODCALLTYPE *Drain)(__RPC__in IDedupIterateChunksHash32 *This);

  DECLSPEC_XFGVIRT(IDedupIterateChunksHash32, Reset)
  HRESULT(STDMETHODCALLTYPE *Reset)(__RPC__in IDedupIterateChunksHash32 *This);
...
#define IDedupIterateChunksHash32_Next(This, ulMaxChunks, pArrChunks,          \
                                       pulFetched)                             \
