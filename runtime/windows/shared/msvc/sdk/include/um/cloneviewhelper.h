...
// 1 == TMM's passed in configuration was applied, with additional proprietary
// IHV settings
#define SETCONFIGURATION_STATUS_ADDITIONAL 1
// 2 == TMM's passed in configuration was overridden and IHV's own settings were
// applied
...
typedef struct ICloneViewHelperVtbl {
  ...
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in ICloneViewHelper *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in ICloneViewHelper *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in ICloneViewHelper *This);
  ...
  HRESULT(STDMETHODCALLTYPE *Commit)(__RPC__in ICloneViewHelper *This,
                                     /* [in] */ BOOL fFinalCall);

  END_INTERFACE
} ICloneViewHelperVtbl;

interface ICloneViewHelper { CONST_VTBL struct ICloneViewHelperVtbl *lpVtbl; };
...
#define ICloneViewHelper_GetConnectedIDs(This, wszAdaptorName, pulCount,       \
                                         pulID, ulFlags)                       \
  ((This)->lpVtbl->GetConnectedIDs(This, wszAdaptorName, pulCount, pulID,      \
                                   ulFlags))

#define ICloneViewHelper_GetActiveTopology(This, wszAdaptorName, ulSourceID,   \
                                           pulCount, pulTargetID)              \
  ((This)->lpVtbl->GetActiveTopology(This, wszAdaptorName, ulSourceID,         \
                                     pulCount, pulTargetID))

#define ICloneViewHelper_SetActiveTopology(This, wszAdaptorName, ulSourceID,   \
                                           ulCount, pulTargetID)               \
  ((This)->lpVtbl->SetActiveTopology(This, wszAdaptorName, ulSourceID,         \
                                     ulCount, pulTargetID))
...
typedef struct IViewHelperVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in IViewHelper *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IViewHelper *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IViewHelper *This);
  ...
  HRESULT(STDMETHODCALLTYPE *Commit)(__RPC__in IViewHelper *This);
...
interface IViewHelper { CONST_VTBL struct IViewHelperVtbl *lpVtbl; };
...
#define IViewHelper_GetConnectedIDs(This, wszAdaptorName, pulCount, pulID,     \
                                    ulFlags)                                   \
  ((This)->lpVtbl->GetConnectedIDs(This, wszAdaptorName, pulCount, pulID,      \
                                   ulFlags))

#define IViewHelper_GetActiveTopology(This, wszAdaptorName, ulSourceID,        \
                                      pulCount, pulTargetID)                   \
  ((This)->lpVtbl->GetActiveTopology(This, wszAdaptorName, ulSourceID,         \
                                     pulCount, pulTargetID))

#define IViewHelper_SetActiveTopology(This, wszAdaptorName, ulSourceID,        \
                                      ulCount, pulTargetID)                    \
  ((This)->lpVtbl->SetActiveTopology(This, wszAdaptorName, ulSourceID,         \
                                     ulCount, pulTargetID))
