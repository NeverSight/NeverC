...
typedef struct ISpatialAudioObjectVtbl {
  ...
  HRESULT(STDMETHODCALLTYPE *SetPosition)(ISpatialAudioObject *This,
                                          /* [annotation][in] */
                                          _In_ float x,
                                          /* [annotation][in] */
                                          _In_ float y,
  ...
  HRESULT(STDMETHODCALLTYPE *SetVolume)(ISpatialAudioObject *This,
                                        /* [annotation][in] */
                                        _In_ float volume);
...
#define ISpatialAudioObjectRenderStream_BeginUpdatingAudioObjects(             \
    This, availableDynamicObjectCount, frameCountPerBuffer)                    \
  ((This)->lpVtbl->BeginUpdatingAudioObjects(                                  \
      This, availableDynamicObjectCount, frameCountPerBuffer))
...
#define ISpatialAudioObjectRenderStream_ActivateSpatialAudioObject(            \
...
typedef struct ISpatialAudioObjectRenderStreamNotifyVtbl {
  ...
  DECLSPEC_XFGVIRT(ISpatialAudioObjectRenderStreamNotify,
...
#define ISpatialAudioObjectRenderStreamNotify_OnAvailableDynamicObjectCountChange( \
    This, sender, hnsComplianceDeadlineTime,                                       \
    availableDynamicObjectCountChange)                                             \
  ((This)->lpVtbl->OnAvailableDynamicObjectCountChange(                            \
      This, sender, hnsComplianceDeadlineTime,                                     \
      availableDynamicObjectCountChange))
...
#define ISpatialAudioClient_GetMaxFrameCount(This, objectFormat,               \
                                             frameCountPerBuffer)              \
...
#define ISpatialAudioClient_IsSpatialAudioStreamAvailable(This, streamUuid,    \
                                                          auxiliaryInfo)       \
  ((This)->lpVtbl->IsSpatialAudioStreamAvailable(This, streamUuid,             \
                                                 auxiliaryInfo))

#define ISpatialAudioClient_ActivateSpatialAudioStream(This, activationParams, \
                                                       riid, stream)           \
  ((This)->lpVtbl->ActivateSpatialAudioStream(This, activationParams, riid,    \
                                              stream))
...
typedef struct ISpatialAudioClient2Vtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(ISpatialAudioClient2 *This,
                                             /* [in] */ REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(ISpatialAudioClient2 *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(ISpatialAudioClient2 *This);
...
#define ISpatialAudioClient2_AddRef(This) ((This)->lpVtbl->AddRef(This))

#define ISpatialAudioClient2_Release(This) ((This)->lpVtbl->Release(This))
...
#define ISpatialAudioClient2_GetSupportedAudioObjectFormatEnumerator(          \
    This, enumerator)                                                          \
  ((This)->lpVtbl->GetSupportedAudioObjectFormatEnumerator(This, enumerator))

#define ISpatialAudioClient2_GetMaxFrameCount(This, objectFormat,              \
                                              frameCountPerBuffer)             \
  ((This)->lpVtbl->GetMaxFrameCount(This, objectFormat, frameCountPerBuffer))
...
#define ISpatialAudioClient2_IsSpatialAudioStreamAvailable(This, streamUuid,   \
                                                           auxiliaryInfo)      \
  ((This)->lpVtbl->IsSpatialAudioStreamAvailable(This, streamUuid,             \
                                                 auxiliaryInfo))

#define ISpatialAudioClient2_ActivateSpatialAudioStream(                       \
    This, activationParams, riid, stream)                                      \
  ((This)->lpVtbl->ActivateSpatialAudioStream(This, activationParams, riid,    \
                                              stream))

#define ISpatialAudioClient2_IsOffloadCapable(This, category,                  \
                                              isOffloadCapable)                \
  ((This)->lpVtbl->IsOffloadCapable(This, category, isOffloadCapable))

#define ISpatialAudioClient2_GetMaxFrameCountForCategory(                      \
    This, category, offloadEnabled, objectFormat, frameCountPerBuffer)         \
  ((This)->lpVtbl->GetMaxFrameCountForCategory(                                \
      This, category, offloadEnabled, objectFormat, frameCountPerBuffer))
...
// SpatialAudioClientActivationParams is an optional activation parameter for
// ISpatialAudioClient
//
...
//
// The "tracing context" identifier helps with correlation of which audio client
...
// *>(CoTaskMemAlloc(sizeof(SpatialAudioClientActivationParams))); if (nullptr
// == p) { ... } p->tracingContextId = /* context identifier */; p->appId = /*
// app identifier */; p->majorVersion = /* app version info */; p->majorVersionN
// = /* app version info */; var.vt = VT_BLOB; var.blob.cbSize = sizeof(*p);
