...
typedef interface IDirectManipulationDragDropEventHandler
...
typedef interface IDirectManipulationDragDropBehavior
...
typedef interface IDirectManipulationAutoScrollBehavior
...
typedef interface IDirectManipulationDeferContactService
...
typedef interface IDirectManipulationSnapPointsInertiaBehavior
    IDirectManipulationSnapPointsInertiaBehavior;
...
typedef interface IDirectManipulationPrimaryContent2
    IDirectManipulationPrimaryContent2;
...
typedef interface IDirectManipulationParametricMotionBehavior
    IDirectManipulationParametricMotionBehavior;
...
typedef interface IDirectManipulationParametricMotionCurve
    IDirectManipulationParametricMotionCurve;
...
typedef interface IDirectManipulationParametricRestPointList
    IDirectManipulationParametricRestPointList;
...
typedef interface IDirectManipulationParametricRestPointBehavior
...
typedef interface IDirectManipulationCompositorPartner
    IDirectManipulationCompositorPartner;
...
typedef interface IDirectManipulationManagerPartner
    IDirectManipulationManagerPartner;
...
typedef interface IDirectManipulationViewportPartner
    IDirectManipulationViewportPartner;
...
#else
typedef struct DirectManipulationPrimaryContent
...
DEFINE_GUID(CLSID_VerticalIndicatorContent, 0xa10b5f17, 0xafe0, 0x4aa2, 0x91,
            0xe9, 0x3e, 0x70, 0x1, 0xd2, 0xe6, 0xb4);
DEFINE_GUID(CLSID_HorizontalIndicatorContent, 0xe7d18cf5, 0x3ec7, 0x44d5, 0xa7,
            0x6b, 0x37, 0x70, 0xf3, 0xcf, 0x90, 0x3d);
DEFINE_GUID(CLSID_VirtualViewportContent, 0x3206a19a, 0x86f0, 0x4cb4, 0xa7,
            0xf3, 0x16, 0xe3, 0xb7, 0xe2, 0xd8, 0x52);
DEFINE_GUID(CLSID_DragDropConfigurationBehavior, 0x09b01b3e, 0xba6c, 0x454d,
            0x82, 0xe8, 0x95, 0xe3, 0x52, 0x32, 0x9f, 0x23);
DEFINE_GUID(CLSID_AutoScrollBehavior, 0x26126a51, 0x3c70, 0x4c9a, 0xae, 0xc2,
            0x94, 0x88, 0x49, 0xee, 0xb0, 0x93);
DEFINE_GUID(CLSID_DeferContactService, 0xd7b67cf4, 0x84bb, 0x434e, 0x86, 0xae,
            0x65, 0x92, 0xbb, 0xc9, 0xab, 0xd9);
...
#define IDirectManipulationManager_CreateViewport(This, frameInfo, window,     \
                                                  riid, object)                \
  ((This)->lpVtbl->CreateViewport(This, frameInfo, window, riid, object))

#define IDirectManipulationManager_CreateContent(This, frameInfo, clsid, riid, \
                                                 object)                       \
...
#define IDirectManipulationManager2_CreateViewport(This, frameInfo, window,    \
                                                   riid, object)               \
  ((This)->lpVtbl->CreateViewport(This, frameInfo, window, riid, object))

#define IDirectManipulationManager2_CreateContent(This, frameInfo, clsid,      \
                                                  riid, object)                \
  ((This)->lpVtbl->CreateContent(This, frameInfo, clsid, riid, object))
...
typedef struct IDirectManipulationManager3Vtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(IDirectManipulationManager3 *This,
                                             /* [in] */ REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(IDirectManipulationManager3 *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(IDirectManipulationManager3 *This);

  DECLSPEC_XFGVIRT(IDirectManipulationManager, Activate)
  HRESULT(STDMETHODCALLTYPE *Activate)(IDirectManipulationManager3 *This,
                                       /* [annotation][in] */
                                       _In_ HWND window);

  DECLSPEC_XFGVIRT(IDirectManipulationManager, Deactivate)
  HRESULT(STDMETHODCALLTYPE *Deactivate)(IDirectManipulationManager3 *This,
                                         /* [annotation][in] */
                                         _In_ HWND window);
  ...
  DECLSPEC_XFGVIRT(IDirectManipulationManager, ProcessInput)
  HRESULT(STDMETHODCALLTYPE *ProcessInput)(IDirectManipulationManager3 *This,
                                           /* [annotation][in] */
                                           _In_ const MSG *message,
                                           /* [annotation][retval][out] */
                                           _Out_ BOOL *handled);
  ...
  HRESULT(STDMETHODCALLTYPE *GetService)(IDirectManipulationManager3 *This,
                                         /* [annotation][in] */
                                         _In_ REFCLSID clsid,
                                         /* [annotation][in] */
                                         _In_ REFIID riid,
...
#define IDirectManipulationManager3_AddRef(This) ((This)->lpVtbl->AddRef(This))
...
#define IDirectManipulationManager3_RegisterHitTestTarget(This, window,        \
                                                          hitTestWindow, type) \
  ((This)->lpVtbl->RegisterHitTestTarget(This, window, hitTestWindow, type))
...
#define IDirectManipulationManager3_CreateViewport(This, frameInfo, window,    \
                                                   riid, object)               \
  ((This)->lpVtbl->CreateViewport(This, frameInfo, window, riid, object))

#define IDirectManipulationManager3_CreateContent(This, frameInfo, clsid,      \
                                                  riid, object)                \
  ((This)->lpVtbl->CreateContent(This, frameInfo, clsid, riid, object))
...
typedef struct IDirectManipulationViewportVtbl {
  ...
  HRESULT(STDMETHODCALLTYPE *SetChaining)(IDirectManipulationViewport *This,
                                          /* [annotation][in] */
                                          _In_ DIRECTMANIPULATION_MOTION_TYPES
                                              enabledTypes);
  ...
  HRESULT(STDMETHODCALLTYPE *SetInputMode)(IDirectManipulationViewport *This,
                                           /* [annotation][in] */
                                           _In_ DIRECTMANIPULATION_INPUT_MODE
                                               mode);
...
#define IDirectManipulationViewport_SetViewportTransform(This, matrix,         \
                                                         pointCount)           \
  ((This)->lpVtbl->SetViewportTransform(This, matrix, pointCount))

#define IDirectManipulationViewport_SyncDisplayTransform(This, matrix,         \
                                                         pointCount)           \
...
typedef struct IDirectManipulationViewport2Vtbl {
  ...
  DECLSPEC_XFGVIRT(IDirectManipulationViewport, SetChaining)
  HRESULT(STDMETHODCALLTYPE *SetChaining)(IDirectManipulationViewport2 *This,
                                          /* [annotation][in] */
                                          _In_ DIRECTMANIPULATION_MOTION_TYPES
                                              enabledTypes);
...
#define IDirectManipulationViewport2_SetViewportTransform(This, matrix,        \
                                                          pointCount)          \
  ((This)->lpVtbl->SetViewportTransform(This, matrix, pointCount))

#define IDirectManipulationViewport2_SyncDisplayTransform(This, matrix,        \
                                                          pointCount)          \
  ((This)->lpVtbl->SyncDisplayTransform(This, matrix, pointCount))
...
typedef struct IDirectManipulationViewportEventHandlerVtbl {
  ...
  DECLSPEC_XFGVIRT(IDirectManipulationViewportEventHandler,
...
#define IDirectManipulationContent_GetOutputTransform(This, matrix,            \
                                                      pointCount)              \
  ((This)->lpVtbl->GetOutputTransform(This, matrix, pointCount))

#define IDirectManipulationContent_GetContentTransform(This, matrix,           \
                                                       pointCount)             \
  ((This)->lpVtbl->GetContentTransform(This, matrix, pointCount))

#define IDirectManipulationContent_SyncContentTransform(This, matrix,          \
                                                        pointCount)            \
...
#define IDirectManipulationPrimaryContent_SetZoomBoundaries(This, zoomMinimum, \
                                                            zoomMaximum)       \
...
#define IDirectManipulationPrimaryContent_GetCenterPoint(This, centerX,        \
                                                         centerY)              \
...
typedef struct IDirectManipulationDragDropEventHandlerVtbl {
  ...
  DECLSPEC_XFGVIRT(IDirectManipulationDragDropEventHandler,
...
#define IDirectManipulationDragDropEventHandler_QueryInterface(This, riid,     \
                                                               ppvObject)      \
  ((This)->lpVtbl->QueryInterface(This, riid, ppvObject))
...
#define IDirectManipulationDragDropEventHandler_OnDragDropStatusChange(        \
    This, viewport, current, previous)                                         \
...
typedef struct IDirectManipulationDragDropBehaviorVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(IDirectManipulationDragDropBehavior *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(IDirectManipulationDragDropBehavior *This);
...
#define IDirectManipulationDragDropBehavior_QueryInterface(This, riid,         \
                                                           ppvObject)          \
  ((This)->lpVtbl->QueryInterface(This, riid, ppvObject))
...
#define IDirectManipulationDragDropBehavior_SetConfiguration(This,             \
                                                             configuration)    \
...
typedef struct IDirectManipulationCompositor2Vtbl {
  ...
  DECLSPEC_XFGVIRT(IDirectManipulationCompositor2,
...
typedef struct IDirectManipulationUpdateManagerVtbl {
  ...
  DECLSPEC_XFGVIRT(IDirectManipulationUpdateManager,
...
#define IDirectManipulationUpdateManager_RegisterWaitHandleCallback(           \
  ...
  ((This)->lpVtbl->RegisterWaitHandleCallback(This, handle, eventHandler,      \
                                              cookie))
...
typedef struct IDirectManipulationAutoScrollBehaviorVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(IDirectManipulationAutoScrollBehavior *This);
...
#define IDirectManipulationAutoScrollBehavior_QueryInterface(This, riid,       \
                                                             ppvObject)        \
  ((This)->lpVtbl->QueryInterface(This, riid, ppvObject))
...
#define IDirectManipulationAutoScrollBehavior_SetConfiguration(                \
...
#define IDirectManipulationDeferContactService_QueryInterface(This, riid,      \
                                                              ppvObject)       \
  ((This)->lpVtbl->QueryInterface(This, riid, ppvObject))
...
#define IDirectManipulationDeferContactService_DeferContact(This, pointerId,   \
                                                            timeout)           \
