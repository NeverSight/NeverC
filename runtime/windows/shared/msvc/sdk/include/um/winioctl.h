...
DEFINE_GUID(GUID_DEVINTERFACE_DISK, 0x53f56307L, 0xb6bf, 0x11d0, 0x94, 0xf2,
            0x00, 0xa0, 0xc9, 0x1e, 0xfb, 0x8b);
DEFINE_GUID(GUID_DEVINTERFACE_CDROM, 0x53f56308L, 0xb6bf, 0x11d0, 0x94, 0xf2,
            0x00, 0xa0, 0xc9, 0x1e, 0xfb, 0x8b);
DEFINE_GUID(GUID_DEVINTERFACE_PARTITION, 0x53f5630aL, 0xb6bf, 0x11d0, 0x94,
            0xf2, 0x00, 0xa0, 0xc9, 0x1e, 0xfb, 0x8b);
DEFINE_GUID(GUID_DEVINTERFACE_TAPE, 0x53f5630bL, 0xb6bf, 0x11d0, 0x94, 0xf2,
            0x00, 0xa0, 0xc9, 0x1e, 0xfb, 0x8b);
DEFINE_GUID(GUID_DEVINTERFACE_WRITEONCEDISK, 0x53f5630cL, 0xb6bf, 0x11d0, 0x94,
            0xf2, 0x00, 0xa0, 0xc9, 0x1e, 0xfb, 0x8b);
DEFINE_GUID(GUID_DEVINTERFACE_VOLUME, 0x53f5630dL, 0xb6bf, 0x11d0, 0x94, 0xf2,
            0x00, 0xa0, 0xc9, 0x1e, 0xfb, 0x8b);
DEFINE_GUID(GUID_DEVINTERFACE_MEDIUMCHANGER, 0x53f56310L, 0xb6bf, 0x11d0, 0x94,
            0xf2, 0x00, 0xa0, 0xc9, 0x1e, 0xfb, 0x8b);
DEFINE_GUID(GUID_DEVINTERFACE_FLOPPY, 0x53f56311L, 0xb6bf, 0x11d0, 0x94, 0xf2,
            0x00, 0xa0, 0xc9, 0x1e, 0xfb, 0x8b);
DEFINE_GUID(GUID_DEVINTERFACE_CDCHANGER, 0x53f56312L, 0xb6bf, 0x11d0, 0x94,
            0xf2, 0x00, 0xa0, 0xc9, 0x1e, 0xfb, 0x8b);
DEFINE_GUID(GUID_DEVINTERFACE_STORAGEPORT, 0x2accfe60L, 0xc130, 0x11d2, 0xb0,
            0x82, 0x00, 0xa0, 0xc9, 0x1e, 0xfb, 0x8b);
DEFINE_GUID(GUID_DEVINTERFACE_VMLUN, 0x6f416619L, 0x9f29, 0x42a5, 0xb2, 0x0b,
            0x37, 0xe2, 0x19, 0xca, 0x02, 0xb0);
DEFINE_GUID(GUID_DEVINTERFACE_SES, 0x1790c9ecL, 0x47d5, 0x4df3, 0xb5, 0xaf,
            0x9a, 0xdf, 0x3c, 0xf2, 0x3e, 0x48);
DEFINE_GUID(GUID_DEVINTERFACE_ZNSDISK, 0xb87941c5L, 0xffdb, 0x43c7, 0xb6, 0xb1,
...
DEFINE_GUID(GUID_DEVINTERFACE_HIDDEN_DISK, 0x7fccc86cL, 0x228a, 0x40ad, 0x8a,
            0x58, 0xf5, 0x90, 0xaf, 0x7b, 0xfd, 0xce);
DEFINE_GUID(GUID_DEVINTERFACE_SERVICE_VOLUME, 0x6ead3d82L, 0x25ec, 0x46bc, 0xb7,
            0xfd, 0xc1, 0xf0, 0xdf, 0x8f, 0x50, 0x37);
DEFINE_GUID(GUID_DEVINTERFACE_HIDDEN_VOLUME, 0x7f108a28L, 0x9833, 0x4b3b, 0xb7,
...
DEFINE_GUID(GUID_DEVINTERFACE_UNIFIED_ACCESS_RPMB, 0x27447c21L, 0xbcc3, 0x4d07,
            0xa0, 0x5b, 0xa3, 0x39, 0x5b, 0xb4, 0xee, 0xe7);

//
// This interface represents a physical persistent memory device, such as an
// NVDIMM. {4283609D-4DC2-43BE-BBB4-4F15DFCE2C61}
//
DEFINE_GUID(GUID_DEVINTERFACE_SCM_PHYSICAL_DEVICE, 0x4283609d, 0x4dc2, 0x43be,
            0xbb, 0xb4, 0x4f, 0x15, 0xdf, 0xce, 0x2c, 0x61);

//
// When a physical device driver detects a change in the health status of a
// physical device, it triggers a PNP custom event (through
// TARGET_DEVICE_CUSTOM_NOTIFICATION) to alert any registered components. The
// custom event's GUID is GUID_SCM_PD_HEALTH_NOTIFICATION and its payload is
// SCM_PD_HEALTH_NOTIFICATION_DATA {9DA2D386-72F5-4EE3-8155-ECA0678E3B06}
//
DEFINE_GUID(GUID_SCM_PD_HEALTH_NOTIFICATION, 0x9da2d386, 0x72f5, 0x4ee3, 0x81,
            0x55, 0xec, 0xa0, 0x67, 0x8e, 0x3b, 0x6);

//
// The passthrough protocol GUID for INVDIMM devices. The application and the
// driver use this value for the "ProtocolGuid" field of the
// SCM_PD_PASSTHROUGH_INPUT and SCM_PD_PASSTHROUGH_OUTPUT structures.
...
// FILE_ANY_ACCESS. The file systems, however, may add additional access checks
// for I/O and FS controls that use this value.
//
...
#define IOCTL_STORAGE_GET_SYSTEM_FEATURE_SUPPORT                               \
  CTL_CODE(IOCTL_STORAGE_BASE, 0x0307, METHOD_BUFFERED, FILE_READ_ACCESS)
...
//
// This IOCTL allows a custom request to be sent directly to a StorMQ miniport.
// Input and output buffer formats are established by the miniport writer.
//
#define IOCTL_STORAGE_MINIPORT_PASSTHROUGH_REQUEST                             \
  CTL_CODE(IOCTL_STORAGE_BASE, 0x0414, METHOD_BUFFERED,                        \
           FILE_READ_ACCESS | FILE_WRITE_ACCESS)
...
//
// This IOCTL includes the same information as IOCTL_STORAGE_GET_DEVICE_NUMBER,
// plus the device GUID.
//
...
//
// This IOCTL offloads the erasure process to the storage device. There is no
// guarantee as to the successful deletion or recoverability of the data on the
// storage device after command completion. This IOCTL is limited to data disks
// in regular Windows. In WinPE, this IOCTL is supported for both boot and data
// disks.
//
// This IOCTL has an optional input and returns no output other than status.
// Callers should first call FSCTL_LOCK_VOLUME before calling this ioctl to
// flush out cached data in upper layers. No waiting of outstanding request
// completion is done before issuing the command to the device.
//
...
//
// This IOCTL indicates that the physical device has triggered some sort of
// event.
//
...
//
// IOCTL_STORAGE_DIAGNOSTIC IOCTL to query diagnostic data from the storage
// driver stack
//
...
//
// IOCTL_STORAGE_GET_PHYSICAL_ELEMENT_STATUS IOCTL to query physical element
// status from device.
//
...
//
// IOCTL_STORAGE_REMOVE_ELEMENT_AND_TRUNCATE IOCTL to remove and truncate
// element from device.
//
...
//
// IOCTL_STORAGE_GET_DEVICE_INTERNAL_LOG IOCTL to get device internal status
// data.
//
...
//
// Note: Function code values of less than 0x800 are reserved for Microsoft.
// Values of 0x800 and higher can be used by vendors.
//       So do not use function code of 0x800 and higher to define new IOCTLs in
//       this file.
//
...
typedef struct _STORAGE_HOTPLUG_INFO {
  ...
  BOOLEAN MediaHotplug;   // ie. does the device succeed a lock even though its
                          // not lockable media?
  BOOLEAN DeviceHotplug;  // ie. 1394, USB, etc.
  BOOLEAN WriteCacheEnableOverride; // This field should not be relied upon
...
//
// This IOCTL can be sent to any disk or adapter device but the query itself
// returns system-wide feature support as offered by the currently-installed
// version of the storage stack.
//
...
#pragma warning(                                                               \
    disable                                                                    \
    : 4214) // bit fields other than int to disable this around the struct
...
//
// This flag indicates that deviceguid is randomly created because a deviceguid
// conflict was observed
//
#define STORAGE_DEVICE_FLAGS_RANDOM_DEVICEGUID_REASON_CONFLICT 0x1

//
// This flag indicates that deviceguid is randomly created because the HW ID was
// not available
//
...
// If this flag is not set this implies it's created from serial number or is
// randomly generated.
//
...
typedef struct _STORAGE_DEVICE_NUMBER_EX {
  ...
  // (for instance, serial number can be used to form the GUID, but not the
  // firmware revision). The device GUID remains the same across reboots.
  //
  // In general, if a device exposes a globally unique identifier, the storage
  // driver will use that identifier to form the GUID. Otherwise, the storage
  // driver will combine the device's vendor ID, product ID and serial number to
  // create the GUID.
  //
  // If a storage driver detects two devices with the same hardware information
  // (which is an indication of a problem with the device), the driver will
  // generate a random GUID for one of the two devices. When handling
  // IOCTL_STORAGE_GET_DEVICE_NUMBER_EX for the device with the random GUID, the
  // driver will add STORAGE_DEVICE_FLAGS_RANDOM_DEVICEGUID_REASON_CONFLICT to
  // the Flags member of this structure.
  //
  // If a storage device does not provide any identifying information, the
  // driver will generate a random GUID and add
  // STORAGE_DEVICE_FLAGS_RANDOM_DEVICEGUID_REASON_NOHWID to the Flags member of
  // this structure.
  //
...
//  passed to applications by the classpnp autorun code (via
...
//
// Input Buffer:
//      a STORAGE_PROPERTY_SET structure which describes what type of property
//      set is being done, what property is being set, and any additional
...
typedef enum _STORAGE_PROPERTY_ID {
  ...
  StorageAdapterCryptoProperty, // Deprecated for GE or greater OS. Use
...
//
// Set structure - additional parameters for specific set property that can
// follow the header
//
...
typedef _Struct_size_bytes_(
    Size) struct _STORAGE_MEDIUM_PRODUCT_TYPE_DESCRIPTOR {
...
typedef struct _DEVICE_LB_PROVISIONING_DESCRIPTOR {
  ...
  DWORD MaxUnmapLbaCount; // Max LBAs that can be unmapped in a single UNMAP
                          // command, in logical blocks.

  DWORD MaxUnmapBlockDescriptorCount; // Max number of descriptors allowed in a
                                      // single UNMAP command.
...
typedef struct _STORAGE_LB_PROVISIONING_MAP_RESOURCES {
  ...
  BYTE AvailableMappingResourcesScope
      : 2; // See LOG_PAGE_LBP_RESOURCE_SCOPE_* definitions in scsi.h for scope
           // values.
  BYTE UsedMappingResourcesScope : 2;
  BYTE Reserved2 : 4;
  BYTE Reserved3[3];
  DWORDLONG
  AvailableMappingResources;      // Available LBA mapping resources, in bytes.
...
typedef struct _DEVICE_POWER_DESCRIPTOR {
  ...
  BOOLEAN
  AsynchronousNotificationSupported;  // The device supports asynchronous
                                      // notifications, delivered via
                                      // IOCTL_STORAGE_EVENT_NOTIFICATION.
  BOOLEAN IdlePowerManagementEnabled; // The device has been registered for
                                      // runtime idle power management.
  ...
  BOOLEAN NoVerifyDuringIdlePower; // Device require no verification during idle
                                   // power transitions.
  BYTE Reserved[2];
  DWORD IdleTimeoutInMS; // The idle timeout value in milliseconds. Only valid
                         // if IdlePowerManagementEnabled == TRUE.
...
typedef struct _STORAGE_CRYPTO_DESCRIPTOR_V2 {
  ...
  //       curCryptoCapability =
  //          (STORAGE_CRYPTO_CAPABILITY_V2*)((PBYTE )curCryptoCapability +
  //          curCryptoCapability->Size)
  //
...
typedef struct _STORAGE_HW_CRYPTO_DESCRIPTOR {
  ...
  _Field_range_(sizeof(struct _STORAGE_HW_CRYPTO_DESCRIPTOR),
                Header.Size) DWORD OffsetToCryptoCapabilities;
...
FORCEINLINE
const STORAGE_HW_CRYPTO_CAPABILITY *GetStorageHwCryptoCapability(
    const STORAGE_HW_CRYPTO_DESCRIPTOR *CryptoDescriptor, DWORD Index) {
  ...
  return (STORAGE_HW_CRYPTO_CAPABILITY *)((const char *)CryptoDescriptor +
                                          Offset);
}
...
//
FORCEINLINE
STORAGE_HW_CRYPTO_CAPABILITY *GetStorageHwCryptoCapabilityMut(
    _In_reads_bytes_(CryptoDescriptor->Header.Size)
        STORAGE_HW_CRYPTO_DESCRIPTOR *CryptoDescriptor,
    DWORD Index) {
  SIZE_T Offset = CryptoDescriptor->OffsetToCryptoCapabilities +
                  Index * CryptoDescriptor->SizeOfCryptoCapability;
...
//
//  The STORAGE_TIER is an identifier for the storage tier relative to the
//  volume/LUN. The storage tier ID for a particular volume has no relationship
//  to the storage tier ID with the same value on a different volume.
//
...
//
//  The response returns a single structure of STORAGE_DEVICE_TIERING_DESCRIPTOR
//  that has all the tiers for this disk.
//
...
typedef _Struct_size_bytes_(
    Size) struct _STORAGE_DEVICE_FAULT_DOMAIN_DESCRIPTOR {
...
//
// Parameters for StorageAdapterProtocolSpecificProperty (or
// StorageDeviceProtocolSpecificProperty) & PropertyStandardQuery
//

//
// Define the different storage command protocols that used between software and
// hardware. e.g. command protocol software uses to communicate with hardware.
...
typedef enum _STORAGE_PROTOCOL_NVME_DATA_TYPE {
  ...
  NVMeDataTypeIdentify, // Retrieved by command - IDENTIFY CONTROLLER or
                        // IDENTIFY NAMESPACE Corresponding values in
                        // STORAGE_PROTOCOL_SPECIFIC_DATA,
                        //      ProtocolDataRequestValue - CNS as defined in
                        //      NVME_IDENTIFY_CNS_CODES
                        //      ProtocolDataRequestSubValue - Namespace Id
                        //      ProtocolDataRequestSubValue2 - CNS Specific Id
                        //      (CNSID) ProtocolDataRequestSubValue3 -
                        //      Controller Id (CNTID)
                        //      ProtocolDataRequestSubValue4 - Command Set
                        //      Identifier (CSI)
  ...
  NVMeDataTypeLogPage, // Retrieved by command - GET LOG PAGE
                       ...
                       //      ProtocolDataRequestSubValue - Lower 32-bit offset
                       //      value ProtocolDataRequestSubValue2 - Upper 32-bit
                       //      offset value ProtocolDataRequestSubValue3 - Log
                       //      specific identifier ProtocolDataRequestSubValue4
  ...
  NVMeDataTypeFeature, // Retrieved by command - GET FEATURES or SET FEATURES
                       ...
                       // (get) or STORAGE_PROTOCOL_SPECIFIC_DATA_EXT (set),
                       //      ProtocolDataRequestValue - Defined in
                       //      NVME_CDW10_GET_FEATURES / NVME_CDW10_SET_FEATURES
                       //      ProtocolDataRequestSubValue - Defined in
                       //      NVME_CDW11_FEATURES ProtocolDataRequestSubValue2
                       //      - Defined in NVME_CDW12_FEATURES
                       //      ProtocolDataRequestSubValue3 - Defined in
                       //      NVME_CDW13_FEATURES ProtocolDataRequestSubValue4
                       //      - Defined in NVME_CDW14_FEATURES
                       //      ProtocolDataRequestSubValue5 - Defined in
                       //      NVME_CDW15_FEATURES

  NVMeDataTypeLogPageEx, // Retrieved by command - GET LOG PAGE
                         // Corresponding values in
                         // STORAGE_PROTOCOL_SPECIFIC_DATA_EXT,
                         //      ProtocolDataValue - Defined in
                         //      NVME_CDW10_GET_LOG_PAGE ProtocolDataSubValue -
                         //      Defined in NVME_CDW11_GET_LOG_PAGE
                         //      ProtocolDataSubValue2 - Defined in
                         //      NVME_CDW12_GET_LOG_PAGE ProtocolDataSubValue3 -
                         //      Defined in NVME_CDW13_GET_LOG_PAGE
                         //      ProtocolDataSubValue4 - Defined in
                         //      NVME_CDW14_GET_LOG_PAGE ProtocolDataSubValue5 -
                         //      Defined in NVME_CDW15_GET_LOG_PAGE (not used
                         //      currently) ProtocolDataSubValue6 - Namespace ID

  NVMeDataTypeFeatureEx, // Retrieved by command - GET FEATURES or SET FEATURES
                         // Corresponding values in STORAGE_cd
                         // PROTOCOL_SPECIFIC_DATA_EXT,
                         //      ProtocolDataValue - Defined in
                         //      NVME_CDW10_GET_FEATURES /
                         //      NVME_CDW10_SET_FEATURES ProtocolDataSubValue -
                         //      Defined in NVME_CDW11_FEATURES
                         //      ProtocolDataSubValue2 - Defined in
                         //      NVME_CDW12_FEATURES ProtocolDataSubValue3 -
                         //      Defined in NVME_CDW13_FEATURES
                         //      ProtocolDataSubValue4 - Defined in
                         //      NVME_CDW14_FEATURES ProtocolDataSubValue5 -
                         //      Defined in NVME_CDW15_FEATURES
                         //      ProtocolDataSubValue6 - Namespace ID

  // For NVMeDataTypeLogPageEx and NVMeDataTypeFeatureEx the namespace ID field
  // is only used for requests sent to an adapter or controller.  In these
  // scenarios, the caller sets ProtocolDataSubValue6 to either 0 (NSID not
  // used) or FFFFFFFFF (request applies to all namespaces). For requests being
  // targeted at a disk, the storage stack driver will substitute in the
  // corresponding NSID automatically.  Callers must set ProtocolDataSubValue6
...
typedef struct _STORAGE_PROTOCOL_SPECIFIC_DATA {
  ...
  DWORD DataType; // The value will be protocol specific, as defined in
  ...
  DWORD ProtocolDataOffset; // The offset of data buffer is from beginning of
                            // this data structure.
  ...
  DWORD
  ProtocolDataRequestSubValue3; // Second additional data sub request value
...
//
// Input parameter for StorageAdapterProtocolSpecificProperty (or
// StorageDeviceProtocolSpecificProperty) & PropertyStandardQuery will be data
// structure STORAGE_PROPERTY_QUERY, where the data field "AdditionalParameters"
// is a buffer in format of STORAGE_PROTOCOL_SPECIFIC_DATA.
//

//
// Out parameter for StorageAdapterProtocolSpecificProperty (or
// StorageDeviceProtocolSpecificProperty) & PropertyStandardQuery will be
...
//
// Input parameter for StorageAdapterProtocolSpecificProperty (or
// StorageDeviceProtocolSpecificProperty) & PropertyStandardSet will be data
// structure STORAGE_PROPERTY_SET, where the data field "AdditionalParameters"
// is a buffer in format of STORAGE_PROTOCOL_SPECIFIC_DATA_EXT.
//

//
// Input parameter for StorageAdapterProtocolSpecificPropertyEx (or
// StorageDeviceProtocolSpecificPropertyEx) & PropertyStandardQuery (or
// PropertyStandardSet) will be data structure
// STORAGE_PROPERTY_QUERY/STORAGE_PROPERTY_SET, where the data field
// "AdditionalParameters" is a buffer in format of
// STORAGE_PROTOCOL_DATA_DESCRIPTOR_EXT.
//
// N.B. this differs from the non-Ex properties which use
// STORAGE_PROTOCOL_SPECIFIC_DATA_EXT in the AdditionalParameters field.
//

//
// Out parameter for
// StorageAdapterProtocolSpecificProperty/StorageAdapterProtocolSpecificPropertyEx
// (or
// StorageDeviceProtocolSpecificProperty/StorageDeviceProtocolSpecificPropertyEx)
// & PropertyStandardSet will be STORAGE_PROTOCOL_DATA_DESCRIPTOR_EXT.
//
...
//
// For
// StorageAdapterProtocolSpecificPropertyEx/StorageDeviceProtocolSpecificPropertyEx
// we require an actual version whereas the older properties used the sizeof as
// a version.
//
#define STORAGE_PROTOCOL_DATA_DESCRIPTOR_EXT_VERSION 1

//
// Parameters for StorageAdapterTemperatureProperty (or
// StorageDeviceTemperatureProperty) & PropertyStandardQuery
//

//
// Input parameters for StorageAdapterTemperatureProperty (or
// StorageDeviceTemperatureProperty) & PropertyStandardQuery uses data structure
// STORAGE_PROPERTY_QUERY.
//

//
// Out parameters for StorageAdapterTemperatureProperty (or
// StorageDeviceTemperatureProperty) & PropertyStandardQuery For
// temperature/threshold data fields, the smallest value of SHORT type - 0x8000
// indicates the value is not reported.
//
...
typedef struct _STORAGE_TEMPERATURE_INFO {
  ...
  BOOLEAN
  OverThresholdChangable; // Can the threshold value being changed by using
                          // IOCTL_STORAGE_SET_TEMPERATURE_THRESHOLD.
  BOOLEAN
  UnderThresholdChangable; // Can the threshold value being changed by using
                           // IOCTL_STORAGE_SET_TEMPERATURE_THRESHOLD.
  BOOLEAN EventGenerated;  // Indicates that notification will be generated when
                           // temperature cross threshold.
  BYTE Reserved0;
  DWORD Reserved1;
...
typedef struct _STORAGE_TEMPERATURE_DATA_DESCRIPTOR {
  ...
  //
  // Indicates the maximum temperature in degrees Celsius that may prevent
  // continued normal operation, possibility of data loss, automatic device
  // shutdown, extreme performance throttling, or permanent damage.
  //
  SHORT CriticalTemperature; // Signed value; in Celsius.

  //
  // Indicates the maximum temperature in degrees Celsius at which the device is
  // capable of operating continuously without degrading operation or
  // reliability.
  //
  SHORT WarningTemperature; // Signed value; in Celsius.

  WORD InfoCount; // Some devices may report more than one temperature
                  // information as there can be multiple sensors implemented.
...
//
// Indicate the target of the request other than the device handle/object
// itself. This is used in "Flags" field of data structures.
//
...
typedef struct _STORAGE_TEMPERATURE_THRESHOLD {
  ...
  BOOLEAN OverThreshold; // If TRUE, set the OverThreshold value; Otherwise, set
                         // the UnderThreshold value.
  BYTE Reserved;

} STORAGE_TEMPERATURE_THRESHOLD, *PSTORAGE_TEMPERATURE_THRESHOLD;

//
// Parameters for StorageAdapterPhysicalTopologyProperty (or
// StorageDevicePhysicalTopologyProperty) & PropertyStandardQuery
//

//
// Input parameters for StorageAdapterPhysicalTopologyProperty (or
// StorageDevicePhysicalTopologyProperty) & PropertyStandardQuery uses data
// structure STORAGE_PROPERTY_QUERY.
//

//
// Out parameters for StorageAdapterPhysicalTopologyProperty (or
// StorageDevicePhysicalTopologyProperty) & PropertyStandardQuery uses data
// structure STORAGE_PHYSICAL_TOPOLOGY_DESCRIPTOR
//
...
typedef struct _STORAGE_PHYSICAL_DEVICE_DATA {
  ...
  STORAGE_SPEC_VERSION SpecVersion; // Supported storage spec version. For
                                    // example: SBC 3, SATA 3.2, NVMe 1.2
...
typedef struct _STORAGE_PHYSICAL_ADAPTER_DATA {
  ...
  SpecVersion; // Supported storage spec version. For example: AHCI 1.3.1
...
typedef struct _STORAGE_PHYSICAL_NODE_DATA {
  ...
  DWORD AdapterDataOffset; // Offset from beginning of this data structure. The
                           // buffer contains an array of
                           // STORAGE_PHYSICAL_ADAPTER_DATA.

  DWORD DeviceCount; // >= 1
  DWORD DeviceDataLength;
  DWORD DeviceDataOffset; // Offset from beginning of this data structure. The
                          // buffer contains an array of
...
typedef struct _STORAGE_PHYSICAL_TOPOLOGY_DESCRIPTOR {
  ...
  DWORD Size;    // Total size of the data. Should be >=
...
typedef _Struct_size_bytes_(
    Size) struct _STORAGE_DEVICE_IO_CAPABILITY_DESCRIPTOR {
...
typedef struct _STORAGE_DEVICE_MANAGEMENT_STATUS {
  ...
  // that didn't fit in the caller's array. Callers should use this field to
  // learn how big the input buffer should be to contain all the available
  // information.
  //
  ...
  // in the array. There are NumberOfOperationalStatus valid elements in the
  // array.
  //
  ...
  //
  // Additional reasons. There are NumberOfAdditionalReasons valid elements in
  // the array.
  //
...
#define STORAGE_ADAPTER_SERIAL_NUMBER_V1_VERSION                               \
  (sizeof(STORAGE_ADAPTER_SERIAL_NUMBER))
#define STORAGE_ADAPTER_SERIAL_NUMBER_V1_SIZE                                  \
  (sizeof(STORAGE_ADAPTER_SERIAL_NUMBER))
...
typedef _Struct_size_bytes_(Size) struct _STORAGE_ZONED_DEVICE_DESCRIPTOR {
  ...
  //
  // Zone Layout Information, to provide a picture about locations of different
  // type of zones on disk. The zone layout starts from the first zone, and
  // groups together zones with same type and size.
  //
...
//
// On persistent memory devices, the unsafe shutdown count is the number of
// times the logical persistent memory disk was shut down in a way that might
...
// For endurance info fields, ValidFields represents bit mapping of valid
// fields.
//

typedef struct _STORAGE_HW_ENDURANCE_INFO {
  DWORD ValidFields; // ValidFields represents bit mapping of valid fields of
                     // any type Eg: Bit 0 stands for GroupId, Bit 1 stands for
                     // Flags, Bit 3 for BytesReadCount

  DWORD GroupId; // Set Id Eg: Set Id for NVMe sets

  struct {
    DWORD Shared
        : 1; // TRUE if information is shared with multiple units/groups
...
typedef struct _STORAGE_HW_ENDURANCE_DATA_DESCRIPTOR {
  ...
  EnduranceInfo; // Endurance Information of the device
...
#define DeviceDsmAction_Notification                                           \
  (0x00000002u | DeviceDsmActionFlag_NonDestructive)
#define DeviceDsmAction_OffloadRead                                            \
  (0x00000003u | DeviceDsmActionFlag_NonDestructive)
#define DeviceDsmAction_OffloadWrite (0x00000004u)
#define DeviceDsmAction_Allocation                                             \
  (0x00000005u | DeviceDsmActionFlag_NonDestructive)
#define DeviceDsmAction_Repair                                                 \
  (0x00000006u | DeviceDsmActionFlag_NonDestructive)
#define DeviceDsmAction_Scrub (0x00000007u | DeviceDsmActionFlag_NonDestructive)
#define DeviceDsmAction_DrtQuery                                               \
  (0x00000008u | DeviceDsmActionFlag_NonDestructive)
#define DeviceDsmAction_DrtClear                                               \
  (0x00000009u | DeviceDsmActionFlag_NonDestructive)
#define DeviceDsmAction_DrtDisable                                             \
  (0x0000000Au | DeviceDsmActionFlag_NonDestructive)
#define DeviceDsmAction_TieringQuery                                           \
  (0x0000000Bu | DeviceDsmActionFlag_NonDestructive)
#define DeviceDsmAction_Map (0x0000000Cu | DeviceDsmActionFlag_NonDestructive)
#define DeviceDsmAction_RegenerateParity                                       \
  (0x0000000Du | DeviceDsmActionFlag_NonDestructive)
#define DeviceDsmAction_NvCache_Change_Priority                                \
  (0x0000000Eu | DeviceDsmActionFlag_NonDestructive)
#define DeviceDsmAction_NvCache_Evict                                          \
  (0x0000000Fu | DeviceDsmActionFlag_NonDestructive)
#define DeviceDsmAction_TopologyIdQuery                                        \
  (0x00000010u | DeviceDsmActionFlag_NonDestructive)
#define DeviceDsmAction_GetPhysicalAddresses                                   \
  (0x00000011u | DeviceDsmActionFlag_NonDestructive)
#define DeviceDsmAction_ScopeRegen                                             \
  (0x00000012u | DeviceDsmActionFlag_NonDestructive)
#define DeviceDsmAction_ReportZones                                            \
  (0x00000013u | DeviceDsmActionFlag_NonDestructive)
#define DeviceDsmAction_OpenZone                                               \
  (0x00000014u | DeviceDsmActionFlag_NonDestructive)
#define DeviceDsmAction_FinishZone                                             \
  (0x00000015u | DeviceDsmActionFlag_NonDestructive)
#define DeviceDsmAction_CloseZone                                              \
  (0x00000016u | DeviceDsmActionFlag_NonDestructive)
#define DeviceDsmAction_ResetWritePointer (0x00000017u)
#define DeviceDsmAction_GetRangeErrorInfo                                      \
  (0x00000018u | DeviceDsmActionFlag_NonDestructive)
#define DeviceDsmAction_WriteZeroes (0x00000019u)
#define DeviceDsmAction_LostQuery                                              \
  (0x0000001Au | DeviceDsmActionFlag_NonDestructive)
#define DeviceDsmAction_GetFreeSpace                                           \
  (0x0000001Bu | DeviceDsmActionFlag_NonDestructive)
#define DeviceDsmAction_ConversionQuery                                        \
  (0x0000001Cu | DeviceDsmActionFlag_NonDestructive)
#define DeviceDsmAction_VdtSet (0x0000001Du)
#define DeviceDsmAction_QueryPreferLocalRepair                                 \
  (0x0000001Eu | DeviceDsmActionFlag_NonDestructive)
...
} DEVICE_DATA_SET_RANGE, *PDEVICE_DATA_SET_RANGE, DEVICE_DSM_RANGE,
    *PDEVICE_DSM_RANGE;
...
typedef struct _DEVICE_MANAGE_DATA_SET_ATTRIBUTES_OUTPUT {
  ...
  DWORD OutputBlockLength;
    ...
    *PDEVICE_MANAGE_DATA_SET_ATTRIBUTES_OUTPUT, DEVICE_DSM_OUTPUT,
    *PDEVICE_DSM_OUTPUT;
...
#define DeviceDsmDefinition_None                                               \
  {DeviceDsmAction_None, FALSE, 0, 0, FALSE, 0, 0}
...
#define DeviceDsmDefinition_Trim                                               \
  {DeviceDsmAction_Trim, FALSE, 0, 0, FALSE, 0, 0}
...
typedef struct _DEVICE_DATA_SET_LB_PROVISIONING_STATE {
  ...
  DWORD SlabAllocationBitMap[ANYSIZE_ARRAY];
    ...
    *PDEVICE_DATA_SET_LB_PROVISIONING_STATE, DEVICE_DSM_ALLOCATION_OUTPUT,
...
typedef struct _DEVICE_DATA_SET_LB_PROVISIONING_STATE_V2 {
  ...
  DWORD SlabAllocationBitMap[ANYSIZE_ARRAY];
    ...
    *PDEVICE_DATA_SET_LB_PROVISIONING_STATE_V2, DEVICE_DSM_ALLOCATION_OUTPUT2,
...
#define GET_REPAIR_TOPOLOGY_ID(R)                                              \
  RtlOffsetToPointer(                                                          \
      R, ALIGN_UP_BY(                                                          \
             FIELD_OFFSET(DEVICE_DATA_SET_REPAIR_PARAMETERS, RepairCopies) +   \
...
#define DeviceDsmDefinition_DrtQuery                                           \
  {DeviceDsmAction_DrtQuery, FALSE, 0, 0, TRUE, 0, 0}
...
#define DeviceDsmDefinition_DrtClear                                           \
  {DeviceDsmAction_DrtClear, FALSE, 0, 0, FALSE, 0, 0}
...
#define DeviceDsmDefinition_DrtDisable                                         \
  {DeviceDsmAction_DrtDisable, FALSE, 0, 0, FALSE, 0, 0}
...
typedef struct _DEVICE_DSM_TIERING_QUERY_OUTPUT {
  ...
  _Field_size_(NumberOfRegionsReturned)
...
#define DeviceDsmDefinition_RegenerateParity                                   \
  {DeviceDsmAction_RegenerateParity, FALSE, 0, 0, FALSE, 0, 0}
...
#define DeviceDsmDefinition_NvCache_Evict                                      \
  {DeviceDsmAction_NvCache_Evict, FALSE, 0, 0, FALSE, 0, 0}
...
#define DEVICE_DSM_PHYSICAL_ADDRESSES_OUTPUT_VERSION_V1                        \
...
#define DeviceDsmDefinition_ScopeRegen                                         \
  {DeviceDsmAction_ScopeRegen, FALSE, 0, 0, FALSE, 0, 0}
...
#define DeviceDsmDefinition_OpenZone                                           \
  {DeviceDsmAction_OpenZone, FALSE, 0, 0, FALSE, 0, 0}
...
#define DeviceDsmDefinition_FinishZone                                         \
  {DeviceDsmAction_FinishZone, FALSE, 0, 0, FALSE, 0, 0}
...
#define DeviceDsmDefinition_CloseZone                                          \
  {DeviceDsmAction_CloseZone, FALSE, 0, 0, FALSE, 0, 0}
...
#define DeviceDsmDefinition_ResetWritePointer                                  \
  {DeviceDsmAction_ResetWritePointer, FALSE, 0, 0, FALSE, 0, 0}
...
typedef struct _DEVICE_DSM_RANGE_ERROR_INFO {
  ...
  // be returned
  //
  // The output ranges, which inform the caller about which regions of the
  // requested ranges are good or bad. The elements of this array are sorted so
  // that their order corresponds to the order of the input ranges. For example,
  // if the first input range was broken into 3 output ranges, those will be the
  // first 3 ranges in the array. The caller can learn which output ranges
  // correspond to an input range by keeping track of the length of the output
  // ranges.
  //
...
#define DeviceDsmDefinition_WriteZeroes                                        \
  {DeviceDsmAction_WriteZeroes, FALSE, 0, 0, FALSE, 0, 0}
...
#define DeviceDsmDefinition_VdtSet                                             \
  {DeviceDsmAction_VdtSet, FALSE, 0, 0, FALSE, 0, 0}
...
FORCEINLINE
PVOID
DeviceDsmParameterBlock(_In_ PDEVICE_DSM_INPUT Input) {
  return (PVOID)((DWORD_PTR)Input + Input->ParameterBlockOffset);
}

FORCEINLINE
PDEVICE_DSM_RANGE
DeviceDsmDataSetRanges(_In_ PDEVICE_DSM_INPUT Input) {
  return (PDEVICE_DSM_RANGE)((DWORD_PTR)Input + Input->DataSetRangesOffset);
}

FORCEINLINE
DWORD
DeviceDsmNumberOfDataSetRanges(_In_ PDEVICE_DSM_INPUT Input) {
  return Input->DataSetRangesLength / sizeof(DEVICE_DSM_RANGE);
}

FORCEINLINE
DWORD
DeviceDsmGetInputLength(_In_ PDEVICE_DSM_DEFINITION Definition,
...
FORCEINLINE
DWORD
DeviceDsmGetNumberOfDataSetRanges(_In_ PDEVICE_DSM_DEFINITION Definition,
...
FORCEINLINE
VOID DeviceDsmInitializeInput(_In_ PDEVICE_DSM_DEFINITION Definition,
                              _Out_writes_bytes_(InputLength)
                                  PDEVICE_DSM_INPUT Input,
                              _In_ _In_range_(>=, sizeof(DEVICE_DSM_INPUT))
                                  DWORD InputLength,
                              _In_ DWORD Flags,
                              _In_reads_bytes_opt_(ParameterBlockLength)
                                  PVOID Parameters,
                              _In_ DWORD ParameterBlockLength) {
  DWORD Bytes = sizeof(DEVICE_DSM_INPUT);
  ...
  RtlCopyMemory(DeviceDsmParameterBlock(Input), Parameters,
...
FORCEINLINE
BOOLEAN
DeviceDsmAddDataSetRange(_Inout_updates_bytes_(InputLength)
                             PDEVICE_DSM_INPUT Input,
                         _In_ _In_range_(>=, sizeof(DEVICE_DSM_INPUT))
                             DWORD InputLength,
                         _In_ LONGLONG Offset, _In_ DWORDLONG Length) {
  DWORD Bytes = 0;
  DWORD Index = 0;
...
FORCEINLINE
BOOLEAN
DeviceDsmValidateInput(_In_ PDEVICE_DSM_DEFINITION Definition,
  ...
  if (!(Input->Flags & DEVICE_DSM_FLAG_ENTIRE_DATA_SET_RANGE)) {
    ...
    if (Input->DataSetRangesLength < Min || Input->DataSetRangesLength > Max ||
  ...
  if (Input->DataSetRangesOffset < Input->ParameterBlockOffset &&
      Input->DataSetRangesOffset + Input->DataSetRangesLength >
...
FORCEINLINE
PVOID
DeviceDsmOutputBlock(_In_ PDEVICE_DSM_OUTPUT Output) {
  return (PVOID)((DWORD_PTR)Output + Output->OutputBlockOffset);
}

FORCEINLINE
DWORD
DeviceDsmGetOutputLength(_In_ PDEVICE_DSM_DEFINITION Definition,
...
FORCEINLINE
BOOLEAN
DeviceDsmValidateOutputLength(_In_ PDEVICE_DSM_DEFINITION Definition,
...
FORCEINLINE
DWORD
DeviceDsmGetOutputBlockLength(_In_ PDEVICE_DSM_DEFINITION Definition,
                              _In_ DWORD OutputLength) {
  DWORD Bytes = 0;
...
FORCEINLINE
VOID DeviceDsmInitializeOutput(_In_ PDEVICE_DSM_DEFINITION Definition,
                               _Out_writes_bytes_(OutputLength)
                                   PDEVICE_DSM_OUTPUT Output,
                               _In_ _In_range_(>=, sizeof(DEVICE_DSM_OUTPUT))
                                   DWORD OutputLength,
                               _In_ DWORD Flags) {
...
FORCEINLINE
BOOLEAN
DeviceDsmValidateOutput(_In_ PDEVICE_DSM_DEFINITION Definition,
                        _In_reads_bytes_(OutputLength)
                            PDEVICE_DSM_OUTPUT Output,
                        _In_ _In_range_(>=, sizeof(DEVICE_DSM_OUTPUT))
                            DWORD OutputLength) {
  DWORD Max = 0;
...
typedef struct _STORAGE_DIAGNOSTIC_DATA {
  ...
  // If the request failed because of buffer too small, this field should be
  // filled with the required buffer size for DiagnosticDataBuffer needed by
  // provider; if the request is successful, it should be filled with returned
  // buffer size of DiagnosticDataBuffer; it should be cleared to zero for other
  // cases.
  DWORD BufferSize;
...
typedef struct _STORAGE_REINITIALIZE_MEDIA {
  ...
  struct {
    ...
    //
    // This field specifies the sanitize method defined in
    // STORAGE_SANITIZE_METHOD enum.
    //
...
//
//  Structures and interfaces dealing with acquistion of device and driver
//  internal telemetry.
//

// For variable size fields we use byte array, defined with zero length in
// structure template. Length of the field is stored as a separate field. No
// more than one variable size field is allowed in one structure and it is
// always placed last.

#pragma warning(push)

//
// Persistent data structures are versioned and "sized" by adding structure
// version field and structure size field
//
...
#define MAX_FW_BUCKET_ID_LENGTH                                                \
  132 // 128 (ACS specification + 1 for zero termination + 3 to align on DWORD)
...
//
//  Device dump section contains common device dump header, followed by set of
//  relative pointers to sub sections Each relative pointer contain size in
//  bytes of the subsection and starting offset from the beginning of the
//  section
//
...
//   RESRICTED DATA - restricted access data (eg encrypted with Microsoft and
//   IHV public keys) PRIVATE DATA   - private device data
//
// All fields in the section definition are used cross platform => types used
// are platform neutral
//

//
// Relative descript    or of a subsection, contains size of the subsection and
// relative offset (0 is the start of the section)
//
typedef struct _DEVICEDUMP_SUBSECTION_POINTER {
  ...
  DWORD dwOffset; // Offset (in bytes) of the subsection block from the start of
                  // the buffer
...
typedef struct _DEVICEDUMP_STRUCTURE_VERSION {
  //
  // Header signature, useful for identifying the structure when reading the
  // dump
  //
  DWORD dwSignature;
...
//
//  Device data header for the secondary data (in crashdump) section , holding
//  device dump information.
//
typedef struct _DEVICEDUMP_SECTION_HEADER {
  //
  // GUID, identifying device dump section. Same GUID as used in registering for
  // SecondaryData callback, stored here for live telemetry interface
  // consistency
  //
  ...
  //
  //  ID value, common for storage device vendors. This ID will be used by
  //  !analyze to create a vendor ID for WinQual.
  //
  //
  // Unique identifier assigned to the organization responsible for device
  // quality (firmware quality). In most cases this is OUID (IEEE) or
  // WorldWideName of the device vendor
  //
  ...
  //
  // Device model number (keep the length of the field proportional to sizeof
  // (DWORD))
  //
  BYTE sModelNumber[DEVICEDUMP_MAX_IDSTRING];

  //
  // Vendor specific device cookie, identifying process and manufacturing
  // parameters. Opaque to the OS and applications.
  //
  BYTE szDeviceManufacturingID
      [DEVICEDUMP_MAX_IDSTRING]; // Keep the length of the field proportional to
                                 // sizeof (DWORD)

  //
  // Sourcing indicator flag - used to detect if data was emulated from other
  // structures or obtained directly from the firmware using log command
  //      Set to 1 if public data was filled in using data from the device
  //      telemetry log Set to 0 if the device doesn't support the command and
  //      the driver filled in as best it could
  //
  DWORD dwFlags;

  //
  // Version of private data as indicated by the firmware.Initially always 0 to
  // specify Private only unspecified data
  //
  DWORD bRestrictedPrivateDataVersion;

  //
  // Issue identifier (hash value) generated by the firmware. Reflects state of
  // the device firmware and used for cross device type/vendor queries. We will
  // rely on standardized namespace of issue IDs and good will of firmware
  // developers to taxonomize
  //
  DWORD dwFirmwareIssueId; // currently unused

  //
  // Firmware bucket ID - long string, opague to Windows , but useful to create
  // unique bucket in concatenation with device identification data
  //
...
//
//  Public subsection header - subsection is holding data, describing device
//  state and accessible to everybody.
//
...
// Maximum length of the description of the collected pages (filled by the
// miniport)
...
//
// Public data is tagged with the table of "log descriptors". Each descriptor
// has LogAddress and number of pages. Specific meaning, assigned to the
// descriptor, is relative to the command set used.
//
...
//
//  Restricted subsection header - subsection is holding data, describing device
//  state and accessible only to Microsoft and a device vendor
//
...
//
//  Private subsection header - subsection is holding data, describing device
//  state and accessible only to a device vendor
//
...
//
typedef _Struct_size_bytes_(
    Descriptor.dwSize) struct _DEVICEDUMP_STORAGEDEVICE_DATA {
  ...
  //
  // Header - set of fields, describing dump section and device (not requiring
  // protocol communication)
  //
  DEVICEDUMP_SECTION_HEADER SectionHeader;

  //
  // Size of the whole section buffer, in bytes , including header and sum total
  // of all the variable sized sub sections
  //
  DWORD dwBufferSize;
  ...
  //
  // "Pointers" to individual sub-sections. Sub sections are filled with the
...
//      - circular buffer of the IO requests as visible by the lower edge of the
//      driver
//              (in case of storage that would be an interface to the controller
//              stack or controller itself)
//
// All fields in the section definition are used cross platform => types used
// are platform neutral
//
...
typedef _Struct_size_bytes_(
    Descriptor.dwSize) struct _DEVICEDUMP_STORAGESTACK_PUBLIC_DUMP {
  ...
  //
  // Standardized log of IO requests issued to the target, starting with number
  // of records. Log is circular, order is not guaranteed
  //
  DWORD uiNumRecords;

  DEVICEDUMP_STORAGESTACK_PUBLIC_STATE_RECORD
  RecordArray[ANYSIZE_ARRAY]; // ANYSIZE_ARRAY
...
#define DEVICEDUMP_CAP_PRIVATE_SECTION                                         \
  0x00000001 // Target supports private data
#define DEVICEDUMP_CAP_RESTRICTED_SECTION                                      \
  0x00000002 // Target supports restricted data
...
typedef struct _STORAGE_IDLE_POWER {
  ...
  DWORD WakeCapableHint
      : 1; // Storage device supports wake from low power states.
  DWORD D3ColdSupported : 1; // Storage device supports D3Cold
  DWORD Reserved : 30;
  DWORD D3IdleTimeout; // Idle time in msec before storage device is
                       // transitioned to D3 (max of ~49.7 days).
...
//
// Output Buffer:
//      A STORAGE_IDLE_POWERUP_REASON structure specifying what caused the power
//      up.
//
...
typedef struct _STORAGE_IDLE_POWERUP_REASON {
  ...
  DWORD Size;    // Size of this structure in bytes.
  STORAGE_POWERUP_REASON_TYPE
  PowerupReason; // The reason for the power up (see above).
...
//  * The number of frames included can be calculated by InputBufferLength /
//  sizeof(STORAGE_RPMB_DATA_FRAME)
//
// Output buffer:
//  An array of STORAGE_RPMB_DATA_FRAME structures
//  * The number of frames included can be calculated by OutputBufferLength /
//  sizeof(STORAGE_RPMB_DATA_FRAME)
//
...
typedef struct _STORAGE_RPMB_DATA_FRAME {
  ...
  //
  // Either the key to be programmed or the MAC authenticating this frame or
  // series of frames
  //
  BYTE KeyOrMAC[32];
...
#define IsKeyReadCopyNumberBypassCache(_k)                                     \
  ((_k) & READ_COPY_NUMBER_BYPASS_CACHE_FLAG)
#define SetReadCopyNumberBypassCacheToKey(_k)                                  \
  ((_k) |= READ_COPY_NUMBER_BYPASS_CACHE_FLAG)
...
//
// Indicate the target of the request other than the device handle/object
// itself. This is used in "Flags" field of data structures for firmware upgrade
// request.
//
...
//
#define STORAGE_HW_FIRMWARE_REQUEST_FLAG_SWITCH_TO_FIRMWARE_WITHOUT_RESET      \
  0x10000000
...
// IOCTL_STORAGE_FIRMWARE_ACTIVATE.
//
#define STORAGE_HW_FIRMWARE_REQUEST_FLAG_REPLACE_AND_SWITCH_UPON_RESET         \
  0x20000000
...
typedef struct _STORAGE_HW_FIRMWARE_INFO_QUERY {
  ...
  DWORD Size;    // Whole size of the buffer (in case this data structure being
                 // extended to be variable length)
  DWORD Flags;
  DWORD Reserved;
...
//   sizeof(STORAGE_HW_FIRMWARE_INFO) + sizeof(STORAGE_HW_FIRMWARE_SLOT_INFO) *
//   (SlotCount - 1).
// If the buffer is not big enough, callee should set the required length in
// "Size" field of STORAGE_HW_FIRMWARE_INFO,
//

//
// Following value maybe used in "PendingActiveSlot" field indicating there is
// no firmware pending to activate.
//
...
typedef struct _STORAGE_HW_FIRMWARE_INFO {
  ...
  DWORD ImagePayloadAlignment; // Number of bytes. Max: PAGE_SIZE. The transfer
...
typedef struct _STORAGE_HW_FIRMWARE_DOWNLOAD {
  ...
  DWORDLONG Offset; // Image file offset, should be aligned to
                    // "ImagePayloadAlignment" value from STORAGE_FIRMWARE_INFO.
  DWORDLONG BufferSize; // should be multiple of "ImagePayloadAlignment" value
                        // from STORAGE_FIRMWARE_INFO.
...
// Buffer layout: <STORAGE_PROTOCOL_COMMAND> <Command> [Error Info Buffer]
// [Data-to-Device Buffer] [Data-from-Device Buffer]
//
...
typedef struct _STORAGE_PROTOCOL_COMMAND {
  ...
  DWORD DataToDeviceTransferLength; // optional, can be zero. Used by WRITE type
                                    // of request.
  DWORD DataFromDeviceTransferLength; // optional, can be zero. Used by READ
                                      // type of request.
  ...
  DWORD FixedProtocolReturnData; // return data, optional. Some protocol, such
                                 // as NVMe, may return a small amount data
                                 // (DWORD0 from completion queue entry) without
                                 // the need of separate device data transfer.
  DWORD
  FixedProtocolReturnData2; // return data2, optional. Some protocol, such
                            // as NVMe, may return a small amount data
                            // (DWORD1 from completion queue entry) without
                            // the need of separate device data transfer.
  DWORD Reserved1[2];
...
#define STORAGE_PROTOCOL_COMMAND_FLAG_ADAPTER_REQUEST                          \
  0x80000000 // Flag indicates the request targeting to adapter instead of
             // device.
...
#define STORAGE_PROTOCOL_COMMAND_LENGTH_NVME                                   \
  0x40 // NVMe commands are always 64 bytes.
...
//  1.  When flag STORAGE_PROTOCOL_COMMAND_FLAG_ADAPTER_REQUEST is set, or the
//  request is sent through adapter, namespace Id from "Command" field is used;
//      otherwise, the underneath driver should determine namespace Id from the
//      device that receives the command.
//  2.  When a command fails, the "ErrorCode" field contains value from NVMe
//  Completion Queue Entry - DW3 - Status Field.
//  3.  "CommandLength" field must have value of 64. i.e.
...
//  5.  When a command succeeds, field "FixedProtocolReturnData" may contain
//  value from NVMe Completion Queue Entry - DW0.
//
...
// Functions 0x300 to 0x5FF are reserved for the logical persistent memory
// device. Functions 0x600 to 0x7FF are reserved for the physical persistent
// memory device. Functions 0x800 and above are reserved for non-Microsoft
// users.
//
...
#define SCM_LOGICAL_DEVICE_FUNCTION(x)                                         \
  (IOCTL_SCM_LOGICAL_DEVICE_FUNCTION_BASE + x)
#define SCM_PHYSICAL_DEVICE_FUNCTION(x)                                        \
  (IOCTL_SCM_PHYSICAL_DEVICE_FUNCTION_BASE + x)

//
// Persistent memory (SCM) bus device IOCTLs.
//

#define IOCTL_SCM_BUS_GET_LOGICAL_DEVICES                                      \
  CTL_CODE(IOCTL_SCMBUS_BASE, SCMBUS_FUNCTION(0x00), METHOD_BUFFERED,          \
           FILE_ANY_ACCESS)
#define IOCTL_SCM_BUS_GET_PHYSICAL_DEVICES                                     \
  CTL_CODE(IOCTL_SCMBUS_BASE, SCMBUS_FUNCTION(0x01), METHOD_BUFFERED,          \
           FILE_ANY_ACCESS)
#define IOCTL_SCM_BUS_GET_REGIONS                                              \
  CTL_CODE(IOCTL_SCMBUS_BASE, SCMBUS_FUNCTION(0x02), METHOD_BUFFERED,          \
           FILE_ANY_ACCESS)
#define IOCTL_SCM_BUS_QUERY_PROPERTY                                           \
  CTL_CODE(IOCTL_SCMBUS_BASE, SCMBUS_FUNCTION(0x03), METHOD_BUFFERED,          \
           FILE_ANY_ACCESS)
#define IOCTL_SCM_BUS_SET_PROPERTY                                             \
  CTL_CODE(IOCTL_SCMBUS_BASE, SCMBUS_FUNCTION(0x05), METHOD_BUFFERED,          \
           FILE_WRITE_ACCESS)

//
// This IOCTL does not require any input nor produce any output data.
//
#define IOCTL_SCM_BUS_RUNTIME_FW_ACTIVATE                                      \
  CTL_CODE(IOCTL_SCMBUS_BASE, SCMBUS_FUNCTION(0x04), METHOD_BUFFERED,          \
           FILE_WRITE_ACCESS)
#define IOCTL_SCM_BUS_REFRESH_NAMESPACE                                        \
  CTL_CODE(IOCTL_SCMBUS_BASE, SCMBUS_FUNCTION(0x06), METHOD_BUFFERED,          \
           FILE_ANY_ACCESS)

//
// Logical persistent memory device IOCTLs.
//
#define IOCTL_SCM_LD_GET_INTERLEAVE_SET                                        \
  CTL_CODE(IOCTL_SCMBUS_BASE, SCM_LOGICAL_DEVICE_FUNCTION(0x00),               \
...
#define IOCTL_SCM_PD_QUERY_PROPERTY                                            \
  CTL_CODE(IOCTL_SCMBUS_BASE, SCM_PHYSICAL_DEVICE_FUNCTION(0x00),              \
           METHOD_BUFFERED, FILE_ANY_ACCESS)
#define IOCTL_SCM_PD_FIRMWARE_DOWNLOAD                                         \
  CTL_CODE(IOCTL_SCMBUS_BASE, SCM_PHYSICAL_DEVICE_FUNCTION(0x01),              \
           METHOD_BUFFERED, FILE_WRITE_ACCESS)
#define IOCTL_SCM_PD_FIRMWARE_ACTIVATE                                         \
  CTL_CODE(IOCTL_SCMBUS_BASE, SCM_PHYSICAL_DEVICE_FUNCTION(0x02),              \
           METHOD_BUFFERED, FILE_WRITE_ACCESS)
#define IOCTL_SCM_PD_PASSTHROUGH                                               \
  CTL_CODE(IOCTL_SCMBUS_BASE, SCM_PHYSICAL_DEVICE_FUNCTION(0x03),              \
           METHOD_BUFFERED, FILE_READ_ACCESS | FILE_WRITE_ACCESS)
#define IOCTL_SCM_PD_UPDATE_MANAGEMENT_STATUS                                  \
  CTL_CODE(IOCTL_SCMBUS_BASE, SCM_PHYSICAL_DEVICE_FUNCTION(0x04),              \
           METHOD_BUFFERED, FILE_ANY_ACCESS)
#define IOCTL_SCM_PD_REINITIALIZE_MEDIA                                        \
  CTL_CODE(IOCTL_SCMBUS_BASE, SCM_PHYSICAL_DEVICE_FUNCTION(0x05),              \
           METHOD_BUFFERED, FILE_WRITE_ACCESS)
#define IOCTL_SCM_PD_SET_PROPERTY                                              \
  CTL_CODE(IOCTL_SCMBUS_BASE, SCM_PHYSICAL_DEVICE_FUNCTION(0x06),              \
           METHOD_BUFFERED, FILE_WRITE_ACCESS)
...
//
// Send this IOCTL to the ScmBus adapter to get a list of all the logical
// persistent memory devices on the system.
//
// Input Buffer:
//      None
//
...
//
// Send this IOCTL to the ScmBus adapter to get a list of all the physical
// persistent memory devices on the system.
//
// Input Buffer:
//      None
...
//
// Send to a logical persistent memory device stack to get a list of all regions
// that make up the logical device.
//
// Send to a physical persistent memory device stack to get a list of all the
// regions that reside on that physical device.
//
// Input Buffer:
//      None
//
...
typedef enum _SCM_BUS_FIRMWARE_ACTIVATION_STATE {
  ...
  ScmBusFirmwareActivationState_Armed =
      1, // NVDIMM is armed to activate the staging firmware
  ScmBusFirmwareActivationState_Busy =
      2 // NVDIMM firmware activation is underway
...
typedef struct _SCM_BUS_RUNTIME_FW_ACTIVATION_INFO {
  ...
  //
  // Size of the data contained in this structure. If the output buffer is too
  // small to contain the requested information, the Size field indicates the
  // length of the output buffer the caller should provide in order to retrieve
  // all the data.
  //
  DWORD Size;
  ...
  struct {
    ...
    //
    // Live activation supported with platform firmware managed processor and
    // I/O quiesce.
    //
    DWORD FwManagedIoQuiesceFwActivationSupported : 1;

    //
    // Live activation supported with OS managed I/O quiesce (device idle) and
    // platform managed processor quiesce.
    //
  ...
  //
  // Estimated processor quiesce time during firmware activation in micro
  // seconds. 0 - no processor quiesce required.
  //
  DWORDLONG EstimatedProcessorAccessQuiesceTimeInUSecs;

  //
  // Estimated I/O access to host memory quiesce time during firmware activation
  // in micro seconds. 0 - no I/O quiesce required.
  //
  DWORDLONG EstimatedIOAccessQuiesceTimeInUSecs;

  //
  // Platform firmware supported Max I/O access to memory quiesce time during
  // firmware activation in micro seconds. 0 - Informaiton not available.
  //
...
//
// Definitions for interfaces related to logical persistent memory devices
// (LDs).
//
...
//
// This IOCTL retrieves the interleave set of a logical persistent memory disk.
// The interleave set is comprised of one or more physical persistent memory
// devices.
//
// Input Buffer:
//      None.
...
typedef struct _SCM_LD_INTERLEAVE_SET_INFO {
  ...
  // the Size field indicates the length of the output buffer the caller should
  // provide in order to retrieve all the data.
  //
  DWORD Size;
...
//
// Definitions for interfaces related to physical persistent memory devices
// (PDs).
//
...
typedef enum _SCM_PD_QUERY_TYPE {
  ...
  ScmPhysicalDeviceQuery_IsSupported, // Used to test whether the descriptor is
                                      // supported
...
typedef enum _SCM_PD_SET_TYPE {
  ...
  ScmPhysicalDeviceSet_IsSupported,    // Used to test whether the descriptor is
                                       // supported
...
//
// Input AdditionalParameters for
// ScmPhysicalDeviceProperty_RuntimeFwActivationArmState
//
...
//
// Output buffer for ScmPhysicalDeviceProperty_DeviceHandle &
// ScmPhysicalDeviceQuery_Descriptor
//

//
// The ScmPhysicalDeviceProperty_DeviceHandle property gets identifying
...
typedef struct _SCM_PD_DEVICE_HANDLE {
  ...
  //
  // A GUID that uniquely identifies the physical device, based on hardware
  // information.
  //
  GUID DeviceGuid;

  //
  // A handle, exposed in the NFIT table, that uniquely identifies the physical
  // device on a local system.
  //
  DWORD DeviceHandle;
...
//
// Output buffer for ScmPhysicalDeviceProperty_DeviceInfo &
// ScmPhysicalDeviceQuery_Descriptor
//
...
typedef struct _SCM_PD_DEVICE_INFO {
  ...
  //
  // The number of times this device went through an unsafe shutdown (i.e. a
  // shutdown that might have led to data loss).
  //
  DWORD UnsafeShutdownCount;

  //
  // The combined size of all the persistent memory regions of the physical
  // device.
  //
  ...
  //
  // The number of the slot in which the physical device is installed on the
  // system.
  //
  DWORD SlotNumber;
  ...
  //
  // An physical device can have regions that implement different format
  // interface codes. This is a list of all format interface codes on this
  // physical device.
  //
  ...
  DWORD SerialNumber4Byte; // 4-byte serial number as defined in the JEDEC SPD
                           // spec and reported in the NFIT.
...
//
// Output buffer for ScmPhysicalDeviceProperty_DeviceSpecificInfo &
// ScmPhysicalDeviceQuery_Descriptor
//
...
//
// The physical device driver fills in this structure with arbitrary numeric
// information.
//
typedef struct _SCM_PD_DEVICE_SPECIFIC_INFO {
  ...
  //
  // The total size of the structure, including the DeviceSpecificProperties
  // array. If the output buffer is too small to contain the requested
  // information, the Size field indicates the length of the output buffer the
  // caller should provide in order to retrieve all the data.
  //
  DWORD Size;
...
//
// Output buffer for ScmPhysicalDeviceQuery_Descriptor &
// ScmPhysicalDeviceProperty_FirmwareInfo
//
typedef struct _SCM_PD_FIRMWARE_INFO {
  ...
  //
  // The slot that will become active once the device is reset. A value of 0xFF
  // means there is no slot waiting to be activated.
  //
  BYTE NextActiveSlot;
...
//
// Constants for ScmPhysicalDeviceProperty_ManagementStatus, which can be
// queried via ScmPhysicalDeviceQuery_Descriptor.
//
...
//
// Output buffer for ScmPhysicalDeviceProperty_ManagementStatus &
// ScmPhysicalDeviceQuery_Descriptor
//
...
typedef struct _SCM_PD_MANAGEMENT_STATUS {
  ...
  // contain the requested information, the Size field indicates the length of
  // the output buffer the caller should provide in order to retrieve all the
  // data.
  //
  DWORD Size;
  ...
  // the array.
  //
  _Field_size_(NumberOfAdditionalReasons)
...
typedef struct _SCM_PD_LOCATION_STRING {
  ...
  // string. If the output buffer is too small to contain the requested
  // information, the Size field indicates the length of the output buffer the
  // caller should provide in order to retrieve all the data.
  //
  DWORD Size;
  ...
  //
  // The Unicode string that represents the physical location of this physical
  // device.
  //
...
typedef struct _SCM_PD_FRU_ID_STRING {
  ...
  //
  // The total size of the structure, including the buffer for the fru id
  // string. If the output buffer is too small to contain the requested
  // information, the Size field indicates the length of the output buffer the
  // caller should provide in order to retrieve all the data.
  //
...
//
// Signals that the firmware image regions contained in the
// SCM_PD_FIRMWARE_DOWNLOAD structure are the last ones of the image. The
// physical device driver finishes the firmware update operation when this flag
// is set.
//
...
typedef enum _SCM_PD_LAST_FW_ACTIVATION_STATUS {
  ScmPdLastFwActivationStatus_None =
      0, // No Firmware Activation performed. Reset to None on boot
  ScmPdLastFwActivationStatus_Success = 1, // Success
  ScmPdLastFwActivationStatus_FwNotFound =
      2, // No new staged firmware to activate
  ScmPdLastFwActivationStatus_ColdRebootRequired =
      3, // NVDIMM Reset required to activate staged firmware
  ScmPdLastFwActivaitonStatus_ActivationInProgress =
      4, // Media disabled during firmware activation
  ScmPdLastFwActivaitonStatus_Retry =
      5, // Activation aborted due to throttling. Retry recommended
  ScmPdLastFwActivaitonStatus_FwUnsupported =
      6, // Staged firmware version does not meet activation requirements
  ScmPdLastFwActivaitonStatus_UnknownError =
      7 // Unclassified firmware activation error
...
//
// This IOCTL sends a vendor-specific command to a physical device and returns
// its output.
//
// Input buffer:
//      SCM_PD_PASSTHROUGH_INPUT
//      The input structure contains another, physical device-type specific
//      structure.
//
// Output buffer:
//      SCM_PD_PASSTHROUGH_OUTPUT
//      The output structure contains another, physical device-type specific
//      structure.
//
...
typedef struct _SCM_PD_PASSTHROUGH_INPUT {
  ...
  //
  // The physical device-type specific structure which contains the passthrough
  // command.
  //
...
typedef struct _SCM_PD_PASSTHROUGH_OUTPUT {
  ...
  //
  // This GUID defines which command protocol is being used. The application
  // should check this field to make sure the driver is using a protocol that it
  // understands.
  //
  GUID ProtocolGuid;
  ...
  //
  // The physical device-type specific structure which contains the output of
  // the passthrough command.
  //
  BYTE Data[ANYSIZE_ARRAY];
...
//
// This structure defines the input of an INVDIMM command. The application
// sending a passthrough command uses this structure as the "Data" field of the
// SCM_PD_PASSTHROUGH_INPUT structure.
//
...
//
// This structure defines the output of an INVDIMM command. The driver will
// respond to a passthrough request by bundling this structure in the "Data"
// field of the SCM_PD_PASSTHROUGH_OUTPUT structure.
//
typedef struct _SCM_PD_PASSTHROUGH_INVDIMM_OUTPUT {

  //
  // The general status of the command (see the INVDIMM _DSM specification for
  // details).
  //
  WORD GeneralStatus;

  //
  // The extended status of the command (see the INVDIMM _DSM specification for
  // details).
  //
  WORD ExtendedStatus;

  //
  // The length, in bytes, of the OutputData field. Even when this is zero, the
  // total size of this structure will be equal to or greater than
  // sizeof(SCM_PD_PASSTHROUGH_INVDIMM_OUTPUT).
  //
...
//
// This IOCTL reinitializes the media of a physical persistent memory device,
// which erases all the data on it.
//
// Input buffer:
...
typedef struct _SCM_PD_REINITIALIZE_MEDIA_INPUT {
  ...
  // If it is set to 0, the physical persistent device may do a crypto-erase or
  // some other quicker form of clearing the data on the media.
  //
  struct {
    DWORD Overwrite : 1;
  } Options;
...
typedef enum _SCM_PD_MEDIA_REINITIALIZATION_STATUS {
  ...
  //
  // The media reinitialization was successful, but the device requires a reboot
  // before being used.
  //
  ScmPhysicalDeviceReinit_RebootNeeded,

  //
  // The media reinitialization was successful, but the device requires a cold
  // boot before being used.
  //
...
#pragma warning(disable                                                        \
                : 4201) // nonstandard extension used : nameless struct/union
#pragma warning(                                                               \
    disable : 4214) // nonstandard extension used : bitfield other than int
#pragma warning(disable : 4820) // padding added after data member
#endif
#endif
...
#define SMART_RCV_DRIVE_DATA_EX                                                \
  CTL_CODE(IOCTL_DISK_BASE, 0x0023, METHOD_BUFFERED, FILE_ANY_ACCESS)
...
#define PARTITION_XINT13_EXTENDED                                              \
  0x0F // Same as type 5 but uses extended int13 services
...
#else
#define IsRecognizedPartition(PartitionType)                                   \
  (((PartitionType) == PARTITION_BSP) || ((PartitionType) == PARTITION_DPP) || \
   ((PartitionType) == PARTITION_FAT_12) ||                                    \
   ((PartitionType) == PARTITION_FAT_16) ||                                    \
   ((PartitionType) == PARTITION_FAT32) ||                                     \
   ((PartitionType) == PARTITION_FAT32_XINT13) ||                              \
...
typedef struct _SENDCMDOUTPARAMS {
  ...
  BYTE bBuffer[1]; // Buffer of arbitrary length in which to store the data read
                   // from the // drive.
...
#define CHANGER_BAR_CODE_SCANNER_INSTALLED                                     \
  0x00000001 // The medium-changer has a bar code scanner installed.
#define CHANGER_INIT_ELEM_STAT_WITH_RANGE                                      \
  0x00000002 // The medium-changer has the ability to initialize elements within
             // a specified range.
#define CHANGER_CLOSE_IEPORT                                                   \
  0x00000004 // The medium-changer has the ability to close the i/e port door.
#define CHANGER_OPEN_IEPORT                                                    \
  0x00000008 // The medium-changer can open the i/e port door.

#define CHANGER_STATUS_NON_VOLATILE                                            \
  0x00000010 // The medium-changer uses non-volatile memory for element status
             // information.
#define CHANGER_EXCHANGE_MEDIA                                                 \
  0x00000020 // The medium-changer supports exchange operations.
#define CHANGER_CLEANER_SLOT                                                   \
  0x00000040 // The medium-changer has a fixed slot designated for cleaner
             // cartridges.
#define CHANGER_LOCK_UNLOCK                                                    \
  0x00000080 // The medium-changer can be (un)secured to (allow)prevent media
             // removal.

#define CHANGER_CARTRIDGE_MAGAZINE                                             \
  0x00000100 // The medium-changer uses cartridge magazines for some storage
             // slots.
#define CHANGER_MEDIUM_FLIP 0x00000200 // The medium-changer can flip medium.
#define CHANGER_POSITION_TO_ELEMENT                                            \
  0x00000400 // The medium-changer can position the transport to a particular
             // element.
...
#define CHANGER_STORAGE_DRIVE                                                  \
  0x00001000 // The medium-changer can use a drive as an independent storage
             // element.
#define CHANGER_STORAGE_IEPORT                                                 \
  0x00002000 // The medium-changer can use a i/e port as an independent storage
             // element.
#define CHANGER_STORAGE_SLOT                                                   \
  0x00004000 // The medium-changer can use a slot as an independent storage
             // element.
#define CHANGER_STORAGE_TRANSPORT                                              \
  0x00008000 // The medium-changer can use a transport as an independent storage
             // element.

#define CHANGER_DRIVE_CLEANING_REQUIRED                                        \
  0x00010000 // The drives controlled by the medium changer require periodic
             // cleaning initiated by an application.
#define CHANGER_PREDISMOUNT_EJECT_REQUIRED                                     \
  0x00020000 // The medium-changer requires a drive eject command to be issued,
             // before a changer move / exchange command can be issued to the
             // drive.

#define CHANGER_CLEANER_ACCESS_NOT_VALID                                       \
  0x00040000 // The access bit in GES isn't valid for cleaner cartridges.
#define CHANGER_PREMOUNT_EJECT_REQUIRED                                        \
  0x00080000 // The medium-changer requires a drive eject command to be issued
             // before a move / exchange command can be issued with the drive as
             // src/dst.

#define CHANGER_VOLUME_IDENTIFICATION                                          \
  0x00100000 // The medium-changer supports volume identification.
#define CHANGER_VOLUME_SEARCH                                                  \
  0x00200000 // The medium-changer can search for volume information.
#define CHANGER_VOLUME_ASSERT                                                  \
  0x00400000 // The medium-changer can verify volume information.
#define CHANGER_VOLUME_REPLACE                                                 \
  0x00800000 // The medium-changer can replace volume information.
#define CHANGER_VOLUME_UNDEFINE                                                \
  0x01000000 // The medium-changer can undefine volume information.
...
#define CHANGER_DEVICE_REINITIALIZE_CAPABLE                                    \
  0x08000000 // The medium-changer can be issued a ChangerReinitializeUnit.
#define CHANGER_KEYPAD_ENABLE_DISABLE                                          \
  0x10000000 // Indicates that the keypad can be enabled/disabled.
#define CHANGER_DRIVE_EMPTY_ON_DOOR_ACCESS                                     \
  0x20000000 // Drives must be empty before access via the door is possible.

#define CHANGER_RESERVED_BIT                                                   \
  0x80000000 // Will be used to indicate Features1 capability bits.
...
#define CHANGER_PREDISMOUNT_ALIGN_TO_SLOT                                      \
  0x80000001 // The transport must be prepositioned to the slot prior to
             // ejecting the media.
#define CHANGER_PREDISMOUNT_ALIGN_TO_DRIVE                                     \
  0x80000002 // The transport must be prepositioned to the drive prior to
             // ejecting the media.
#define CHANGER_CLEANER_AUTODISMOUNT                                           \
  0x80000004 // The device will move the cleaner cartridge back into the slot
             // when cleaning has completed.
#define CHANGER_TRUE_EXCHANGE_CAPABLE                                          \
  0x80000008 // Device can do src -> dest2 exchanges.
#define CHANGER_SLOTS_USE_TRAYS                                                \
  0x80000010 // Slots have removable trays, requiring multiple moves for
             // inject/eject.
#define CHANGER_RTN_MEDIA_TO_ORIGINAL_ADDR                                     \
  0x80000020 // Media must be returned to the slot from which it originated
             // after a move to another element.
#define CHANGER_CLEANER_OPS_NOT_SUPPORTED                                      \
  0x80000040 // Automated cleaning operations are not supported on this device.
#define CHANGER_IEPORT_USER_CONTROL_OPEN                                       \
  0x80000080 // Indicates that user action is necessary to open a closed ieport.
#define CHANGER_IEPORT_USER_CONTROL_CLOSE                                      \
  0x80000100 // Indicates that user action is necessary to close an opened
             // ieport.
#define CHANGER_MOVE_EXTENDS_IEPORT                                            \
  0x80000200 // Indicates that a move media to the ieport extends the tray.
#define CHANGER_MOVE_RETRACTS_IEPORT                                           \
  0x80000400 // Indicates that a move media from the ieport retracts the tray.
...
#define CHANGER_TO_TRANSPORT                                                   \
  0x01 // The device can carry out the operation to a transport from the
       // specified element.
#define CHANGER_TO_SLOT                                                        \
  0x02 // The device can carry out the operation to a slot from the specified
       // element.
#define CHANGER_TO_IEPORT                                                      \
  0x04 // The device can carry out the operation to an IE Port from the
       // specified element.
#define CHANGER_TO_DRIVE                                                       \
  0x08 // The device can carry out the operation to a drive from the specified
       // element.
...
typedef struct _GET_CHANGER_PARAMETERS {
  ...
  //
  // Number of N element(s) as defined by the Element Address Page (or
  // equivalent...).
  //
  ...
  //
  // The device-specific address (from user manual of the device) of the first N
  // element. Used by the UI to relate the various elements to the user.
  //
  ...
  //
  // Specifies the approximate number of seconds for when a cleaning should be
  // completed. Only applicable if drive cleaning is supported. See Features0.
  //
  ...
  //
  // Bitmask defining Move from N element to element. Defined by Device
  // Capabilities Page (or equivalent). AND-masking with the TO_XXX values will
  // indicate legal destinations.
  //
  ...
  //
  // Bitmask defining Exchange from N element to element. Defined by Device
  // Capabilities Page (or equivalent). AND-masking with the TO_XXX values will
  // indicate legal destinations.
  //
  ...
  //
  // Bitmask defining which elements valid for positioning operations. Valid
  // only if CHANGER_POSITION_TO_ELEMENT is set in Features0.
  //
...
typedef struct _CHANGER_ELEMENT_STATUS {
  ...
  // Valid for two-sided media only, and pertains to the id. of the inverted
  // side. Valid only if ELEMENT_STATUS_AVOLTAG bit is set in Flags.
  //
...
#define ELEMENT_STATUS_IMPEXP                                                  \
  0x00000002 // Media in i/e port was placed there by an operator.
#define ELEMENT_STATUS_EXCEPT                                                  \
  0x00000004 // Element is in an abnormal state; check ExceptionCode field for
             // more information.
#define ELEMENT_STATUS_ACCESS                                                  \
  0x00000008 // Access to the i/e port from the medium changer is allowed.
...
#define ELEMENT_STATUS_PRODUCT_DATA                                            \
  0x00000040 // Serial number valid for the drive
...
#define ELEMENT_STATUS_NOT_BUS                                                 \
  0x00008000 // Lun and SCSI Id fields are not on same bus as medium changer.
#define ELEMENT_STATUS_INVERT                                                  \
  0x00400000 // Media in element was inverted (valid only if
             // ELEMENT_STATUS_SVALID bit is set)
#define ELEMENT_STATUS_SVALID                                                  \
  0x00800000 // SourceElementAddress field and ELEMENT_STATUS_INVERT bit are
             // valid.

#define ELEMENT_STATUS_PVOLTAG                                                 \
  0x10000000 // Primary volume information is valid.
#define ELEMENT_STATUS_AVOLTAG                                                 \
  0x20000000 // Alternate volume information is valid.
...
#define ERROR_LABEL_UNREADABLE                                                 \
  0x00000001 // Bar code scanner could not read bar code label.
#define ERROR_LABEL_QUESTIONABLE                                               \
  0x00000002 // Label could be invalid due to unit attention condition.
#define ERROR_SLOT_NOT_PRESENT                                                 \
  0x00000004 // Slot is currently not addressable in the device.
#define ERROR_DRIVE_NOT_INSTALLED 0x00000008 // Drive is not installed.
#define ERROR_TRAY_MALFUNCTION                                                 \
  0x00000010 // Media tray is malfunctioning/broken.
#define ERROR_INIT_STATUS_NEEDED                                               \
  0x00000011 // An Initialize Element Status command is needed.
...
typedef struct _CHANGER_SET_POSITION {
  ...
  //
  // Indicates whether the media currently carried by Transport, should be
  // flipped.
  //
...
typedef struct _READ_ELEMENT_ADDRESS_INFO {
  ...
  //
  // Array of CHANGER_ELEMENT_STATUS structures, one for each element that
  // corresponded with the information passed in with the
...
// compatibility with the current device.
//
...
#define SEARCH_ALL_NO_SEQ                                                      \
  0x4 // Translate - search all defined volume tags but ignore sequence numbers.
#define SEARCH_PRI_NO_SEQ                                                      \
  0x5 // Translate - search only primary volume tags but ignore sequence
      // numbers.
#define SEARCH_ALT_NO_SEQ                                                      \
  0x6 // Translate - search only alternate volume tags but ignore sequence
      // numbers.

#define ASSERT_PRIMARY                                                         \
  0x8 // Assert - as the primary volume tag - if tag now undefined.
#define ASSERT_ALTERNATE                                                       \
  0x9 // Assert - as the alternate volume tag - if tag now undefined.

#define REPLACE_PRIMARY                                                        \
  0xA // Replace - the primary volume tag - current tag ignored.
#define REPLACE_ALTERNATE                                                      \
  0xB // Replace - the alternate volume tag - current tag ignored.

#define UNDEFINE_PRIMARY                                                       \
  0xC // Undefine - the primary volume tag - current tag ignored.
#define UNDEFINE_ALTERNATE                                                     \
  0xD // Undefine - the alternate volume tag - current tag ignored.
...
#define FSCTL_GET_RETRIEVAL_POINTERS                                           \
  CTL_CODE(                                                                    \
      FILE_DEVICE_FILE_SYSTEM, 28, METHOD_NEITHER,                             \
...
#define FSCTL_READ_RAW_ENCRYPTED                                               \
  CTL_CODE(                                                                    \
      FILE_DEVICE_FILE_SYSTEM, 56, METHOD_NEITHER,                             \
...
#define FSCTL_TXFS_MODIFY_RM                                                   \
  CTL_CODE(FILE_DEVICE_FILE_SYSTEM, 81, METHOD_BUFFERED, FILE_WRITE_DATA) // TxF
#define FSCTL_TXFS_QUERY_RM_INFORMATION                                        \
  CTL_CODE(FILE_DEVICE_FILE_SYSTEM, 82, METHOD_BUFFERED, FILE_READ_DATA) // TxF
// decommissioned fsctl value                                                 83
#define FSCTL_TXFS_ROLLFORWARD_REDO                                            \
  CTL_CODE(FILE_DEVICE_FILE_SYSTEM, 84, METHOD_BUFFERED, FILE_WRITE_DATA) // TxF
#define FSCTL_TXFS_ROLLFORWARD_UNDO                                            \
  CTL_CODE(FILE_DEVICE_FILE_SYSTEM, 85, METHOD_BUFFERED, FILE_WRITE_DATA) // TxF
#define FSCTL_TXFS_START_RM                                                    \
  CTL_CODE(FILE_DEVICE_FILE_SYSTEM, 86, METHOD_BUFFERED, FILE_WRITE_DATA) // TxF
#define FSCTL_TXFS_SHUTDOWN_RM                                                 \
  CTL_CODE(FILE_DEVICE_FILE_SYSTEM, 87, METHOD_BUFFERED, FILE_WRITE_DATA) // TxF
...
#define FSCTL_TXFS_CREATE_SECONDARY_RM                                         \
  CTL_CODE(FILE_DEVICE_FILE_SYSTEM, 90, METHOD_BUFFERED, FILE_WRITE_DATA) // TxF
#define FSCTL_TXFS_GET_METADATA_INFO                                           \
  CTL_CODE(FILE_DEVICE_FILE_SYSTEM, 91, METHOD_BUFFERED, FILE_READ_DATA) // TxF
...
#define FSCTL_TXFS_CREATE_MINIVERSION                                          \
  CTL_CODE(FILE_DEVICE_FILE_SYSTEM, 95, METHOD_BUFFERED, FILE_WRITE_DATA) // TxF
...
#define FSCTL_TXFS_TRANSACTION_ACTIVE                                          \
  CTL_CODE(FILE_DEVICE_FILE_SYSTEM, 99, METHOD_BUFFERED, FILE_READ_DATA) // TxF
...
#define FSCTL_TXFS_LIST_TRANSACTIONS                                           \
  CTL_CODE(FILE_DEVICE_FILE_SYSTEM, 121, METHOD_BUFFERED, FILE_READ_DATA) // TxF
...
#define FSCTL_SET_LAYER_ROOT                                                   \
  CTL_CODE(                                                                    \
      FILE_DEVICE_FILE_SYSTEM, 229, METHOD_BUFFERED,                           \
      FILE_ANY_ACCESS) // CONTAINER_ROOT_INFO_INPUT CONTAINER_ROOT_INFO_OUTPUT
#endif
...
#endif                          /* (_WIN32_WINNT >= _WIN32_WINNT_WIN10_RS1) */
#if (NTDDI_VERSION >= NTDDI_WIN10_RS5) ||                                      \
    (NTDDI_VERSION >= NTDDI_WIN8) // Win8 check is for backward compatibility.
...
#define FSCTL_GET_RETRIEVAL_POINTER_COUNT                                      \
  CTL_CODE(                                                                    \
      FILE_DEVICE_FILE_SYSTEM, 266, METHOD_NEITHER,                            \
      FILE_ANY_ACCESS) // STARTING_VCN_INPUT_BUFFER, RETRIEVAL_POINTER_COUNT
#if defined(_WIN64)
...
#define FSCTL_CLEAR_LCN_WEAK_REFERENCE                                         \
...
#define FSCTL_CLEAR_ALL_LCN_WEAK_REFERENCES                                    \
...
#endif
#if (NTDDI_VERSION >= NTDDI_WIN10_NI)
#define FSCTL_REFS_CHECKPOINT_VOLUME                                           \
  CTL_CODE(FILE_DEVICE_FILE_SYSTEM, 287, METHOD_BUFFERED, FILE_ANY_ACCESS)
#define FSCTL_REFS_QUERY_VOLUME_TOTAL_SHARED_LCNS                              \
  CTL_CODE(FILE_DEVICE_FILE_SYSTEM, 288, METHOD_BUFFERED, FILE_ANY_ACCESS)
#endif
#if (NTDDI_VERSION >= NTDDI_WIN10_CU)
#define FSCTL_UPGRADE_VOLUME                                                   \
  CTL_CODE(FILE_DEVICE_FILE_SYSTEM, 289, METHOD_BUFFERED, FILE_ANY_ACCESS)
#endif
#if (NTDDI_VERSION >= NTDDI_WIN11_ZN)
#define FSCTL_REFS_SET_VOLUME_IO_METRICS_INFO                                  \
  CTL_CODE(FILE_DEVICE_FILE_SYSTEM, 290, METHOD_BUFFERED, FILE_ANY_ACCESS)
#define FSCTL_REFS_QUERY_VOLUME_IO_METRICS_INFO                                \
  CTL_CODE(FILE_DEVICE_FILE_SYSTEM, 291, METHOD_BUFFERED, FILE_ANY_ACCESS)
#endif // #if (NTDDI_VERSION >= NTDDI_WIN11_ZN)
#if (NTDDI_VERSION >= NTDDI_WIN11_GE)
#define FSCTL_REFS_SET_ROLLBACK_PROTECTION_INFO                                \
  CTL_CODE(FILE_DEVICE_FILE_SYSTEM, 292, METHOD_BUFFERED,                      \
           FILE_ANY_ACCESS) // REFS_SET_ROLLBACK_PROTECTION_INFO_INPUT_BUFFER
#define FSCTL_REFS_QUERY_ROLLBACK_PROTECTION_INFO                              \
  CTL_CODE(                                                                    \
      FILE_DEVICE_FILE_SYSTEM, 293, METHOD_BUFFERED,                           \
      FILE_ANY_ACCESS) // REFS_QUERY_ROLLBACK_PROTECTION_INFO_OUTPUT_BUFFER
#endif                 // #if (NTDDI_VERSION >= NTDDI_WIN11_GE)
#if (NTDDI_VERSION >= NTDDI_WIN11_GE)
#define FSCTL_FILE_SOV_CHECK_RANGE                                             \
  CTL_CODE(FILE_DEVICE_FILE_SYSTEM, 294, METHOD_BUFFERED, FILE_ANY_ACCESS)
#endif
#if (NTDDI_VERSION >= NTDDI_WIN11_GE)
#define FSCTL_CASCADES_REFS_SET_FILE_REMOTE                                    \
  CTL_CODE(FILE_DEVICE_FILE_SYSTEM, 295, METHOD_BUFFERED, FILE_ANY_ACCESS)
#endif
//
// AVIO IOCTLS.
//
...
#define REFS_VOLUME_DATA_BUFFER_CONTAINS_DRIVER_VERSION(VOLUME_DATA_BUFFER)    \
  ((VOLUME_DATA_BUFFER)->ByteCount >=                                          \
   RTL_SIZEOF_THROUGH_FIELD(REFS_VOLUME_DATA_BUFFER, DriverMinorVersion))
...
#define USN_SOURCE_VALID_FLAGS                                                 \
  (USN_SOURCE_DATA_MANAGEMENT | USN_SOURCE_AUXILIARY_DATA |                    \
...
//
//  ------ Introduced in Vista:
//  MARK_HANDLE_TXF_SYSTEM_LOG - indicates that this stream is being used as the
//  Txf
//      log for an RM on the volume.  Must be called in the kernel using
//      IRP_MN_KERNEL_CALL.
//
//  MARK_HANDLE_NOT_TXF_SYSTEM_LOG - indicates that this component is no longer
//  using this
//      object as a TxF log file.
//
//  ------ Introduced in Win7:
//  MARK_HANDLE_REALTIME - only supported by the UDFS file system.  Marks the
//  device
//      to do realtime streaming of video
//
//  MARK_HANDLE_NOT_REALTIME - only supported by the UDFS file system.  Marks
//  the device
...
//
//  ------ Introduced in Win8
//  MARK_HANDLE_READ_COPY - indicates the data must be read from the specified
//  copy
//      of data.  Only supported for spaces redundent volumes.
//
//  MARK_HANDLE_NOT_READ_COPY - indicates the data is no longer to be read from
//  a specific copy.
//
//  ------ Introduced in WinBlue (win 8.1)
//  MARK_HANDLE_FILTER_METADATA - Flag reserved for internal Microsoft use
//
//  MARK_HANDLE_RETURN_PURGE_FAILURE - When intermixing memory mapped/cached IO
//  with
//      non-cached IO the system attempts, when a non-cached io is issued, to
//      purge memory mappings for the range of the non-cached IO.  If these
//      purges fail the system normally does not return the failure to the
//      caller which can lead to corrupted state (which is why the documentation
//      says to not do this). This flag tells the system to return purge
//      failures for the given handle so the application can better handle this
//      situation
//
//  ------ Introduced in WinThreshold (win10)
//  MARK_HANDLE_DISABLE_FILE_METADATA_OPTIMIZATION - This disabled the FRS
//  compaction
//      feature on the given file.
//
//  MARK_HANDLE_ENABLE_USN_SOURCE_ON_PAGING_IO - Tells NTFS to set the given
//  UsnSourceInfo
...
//      to open the file for write access, the operation is failed with
//      STATUS_ACCESS_DENIED. If a write is seen the operation is failed with
...
//  MARK_HANDLE_SUPPRESS_VOLUME_OPEN_FLUSH - Normally, on the first read/write
//  operation
//      on a volume handle (DASD open) the file system flushes the volume.  This
//      can have performance consequences in certain scenarios.  If this flag is
//      set on a volume handle it will suppress that flush on first IO.
//
...
#if (NTDDI_VERSION >= NTDDI_WINBLUE) ||                                        \
    (NTDDI_VERSION >= NTDDI_WIN7) // Win7 check is for backward compatibility
...
typedef struct _NTFS_STATISTICS {
  ...
  struct {
    ...
    DWORD CacheClusters;     // number of clusters allocated via the cache other
                             // than the hint
  ...
  //
  //  All future expansion of this structure needs to be in NTFS_STATISTICS_EX
  //  starting Windows 10
  //
...
typedef struct _NTFS_STATISTICS_EX {
  ...
  struct {
    ...
    DWORDLONG CacheClusters; // number of clusters allocated via the cache other
                             // than the hint
    DWORDLONG
    CacheMissClusters; // number of clusters allocated without the cache
  } Allocate;
...
#else
#pragma warning(                                                               \
    default : 4201) /* nonstandard extension used : nameless struct/union */
#endif
...
//
// Structures for FSCTL_SET_ENCRYPTION, FSCTL_WRITE_RAW_ENCRYPTED, and
// FSCTL_READ_RAW_ENCRYPTED
//
...
//  encrypt/decrypt a file or an individual stream.
//
...
//
//  The optional output buffer to set encryption indicates that the last
//  encrypted stream in a file has been marked as decrypted.
//
...
#define COPYFILE_SIS_REPLACE                                                   \
  0x0002 // Replace destination if it exists, otherwise don't.
...
#define FILE_INITIATE_REPAIR_HINT1_FILE_RECORD_NOT_BASE_RECORD                 \
  (0x0000000000000008)
...
#define FILE_INITIATE_REPAIR_HINT1_FILE_RECORD_IS_BASE_RECORD                  \
  (0x0000000000080000)
#define FILE_INITIATE_REPAIR_HINT1_INVALID_ARRAY_LENGTH_COUNT                  \
  (0x0000000000100000)
...
#define FILE_INITIATE_REPAIR_HINT1_PARENT_FILE_RECORD_NOT_IN_USE               \
  (0x0000000001000000)
#define FILE_INITIATE_REPAIR_HINT1_PARENT_FILE_RECORD_REUSED                   \
  (0x0000000002000000)
#define FILE_INITIATE_REPAIR_HINT1_PARENT_FILE_RECORD_NOT_EXIST                \
  (0x0000000004000000)
#define FILE_INITIATE_REPAIR_HINT1_PARENT_FILE_RECORD_NOT_BASE_RECORD          \
  (0x0000000008000000)
#define FILE_INITIATE_REPAIR_HINT1_PARENT_FILE_RECORD_NOT_INDEX                \
  (0x0000000010000000)
...
#define FILE_INITIATE_REPAIR_HINT1_PREVIOUS_PARENT_STILL_VALID                 \
  (0x0000008000000000)
#define FILE_INITIATE_REPAIR_HINT1_INDEX_ENTRY_MISMATCH (0x0000010000000000)
#define FILE_INITIATE_REPAIR_HINT1_INVALID_ORPHAN_RECOVERY_NAME                \
  (0x0000020000000000)
#define FILE_INITIATE_REPAIR_HINT1_MULTIPLE_FILE_NAME_ATTRIBUTES               \
  (0x0000040000000000)
...
//  You can specify the log growth amount in number of containers or as a
//  percentage.
//
...
//  TXFS_RM_FLAG_PREFER_AVAILABILITY are mutually exclusive.  After calling
//  ModifyRM with one of these flags set the RM must be restarted for the change
//  to take effect.
//
...
typedef struct _TXFS_MODIFY_RM {
  ...
  //
  //  Maximum log container count if TXFS_RM_FLAG_LOG_CONTAINER_COUNT_MAX is
  //  set.
  //
  ...
  //
  //  Minimum log container count if TXFS_RM_FLAG_LOG_CONTAINER_COUNT_MIN is
  //  set.
  //
  ...
  //
  //  When the log is full, increase its size by this much.  Indicated as either
  //  a percent of the log size or absolute container count, depending on which
  //  of the TXFS_RM_FLAG_LOG_GROWTH_INCREMENT_* flags is set.
  //

  DWORD LogGrowthIncrement;

  //
  //  Sets autoshrink policy if TXFS_RM_FLAG_LOG_AUTO_SHRINK_PERCENTAGE is set.
  //  Autoshrink makes the log shrink so that no more than this percentage of
  ...
  //
  //  If TXFS_RM_FLAG_LOGGING_MODE is set, this must contain one of
  //  TXFS_LOGGING_MODE_SIMPLE or TXFS_LOGGING_MODE_FULL.
  //
...
//
//  The flags field for query RM information is used for the following
//  information:
//
//  1)  To indicate whether the LogGrowthIncrement field is reported as a
//  percent
...
//      TXFS_RM_FLAG_LOG_GROWTH_INCREMENT_PERCENT
//
//  2)  To indicate that there is no set maximum or minimum container count.
//  Possible
...
//
//  2)  To report whether the RM will be reset the next time it is started. Note
//  that
//      only the default RM will report a meaningful value (secondary RMs will
//      always report DO_NOT_RESET) Possible flag values for this are:
//
//      TXFS_RM_FLAG_RESET_RM_AT_NEXT_START xor
//      TXFS_RM_FLAG_DO_NOT_RESET_RM_AT_NEXT_START
//
//  3)  To report whether the RM is in consistency mode or availability mode.
//  Possible
//      flag values for this are:
//
//      TXFS_RM_FLAG_PREFER_CONSISTENCY xor TXFS_RM_FLAG_PREFER_AVAILABILITY
//
//  The RmState field can have exactly one of the above-defined TXF_RM_STATE_
//  values.
//
...
typedef struct _TXFS_QUERY_RM_INFORMATION {
  ...
  //
  //  Amount by which log will grow when it gets full.  Indicated as either a
  //  percent of the log size or absolute container count, depending on which of
  //  the TXFS_RM_FLAG_LOG_GROWTH_INCREMENT_* flags is set.
  //

  DWORD LogGrowthIncrement;

  //
  //  Reports on the autoshrink policy if.  Autoshrink makes the log shrink so
  //  that no more than this percentage of the log is free at any time.  A value
  //  of 0 indicates that autoshrink is off (i.e. the log will not automatically
  //  shrink).
  //
  ...
  //  TXFS_QUERY_RM_INFORMATION_VALID_FLAGS to see what the flags here mean.
  //
  ...
  //
  //  Activity state of the RM.  May be exactly one of the above-defined
  ...
  //
  //  Offset in bytes from the beginning of this structure to a NULL-terminated
  //  Unicode string indicating the path to the RM's transaction manager's log.
  //
...
//  TXFS_START_RM_FLAG_LOG_NO_CONTAINER_COUNT_MAX are mutually exclusive.
//
//  TXFS_START_RM_FLAG_LOG_CONTAINER_COUNT_MIN and
//  TXFS_START_RM_FLAG_LOG_NO_CONTAINER_COUNT_MIN are mutually exclusive.
//
//  TXFS_START_RM_FLAG_PREFER_CONSISTENCY and
//  TXFS_START_RM_FLAG_PREFER_AVAILABILITY are mutually exclusive.
//
...
typedef struct _TXFS_START_RM_INFORMATION {
  ...
  //
  //  Length in bytes of the path to the log to be used by the RM.  This
  ...
  //
  //  The path to the log (in Unicode characters) to be used by the RM goes
  //  here. This parameter is required.
  //
...
typedef struct _TXFS_GET_METADATA_INFO_OUT {
  ...
  //
  //  Returns the TxfId of the file referenced by the handle used to call this
  //  routine.
  //
...
//
//  TXFS_LIST_TRANSACTION_LOCKED_FILES_ENTRY_FLAG_CREATED means the reported
//  name was created in the locking transaction.
//
//  TXFS_LIST_TRANSACTION_LOCKED_FILES_ENTRY_FLAG_DELETED means the reported
//  name was deleted in the locking transaction.
//
//  Note that both flags may appear if the name was both created and deleted in
//  the same transaction.  In that case the FileName[] member will contain only
//  "\0", as there is no meaningful name to report.
//
...
typedef struct _TXFS_LIST_TRANSACTION_LOCKED_FILES_ENTRY {
  ...
  //  TXFS_LIST_TRANSACTION_LOCKED_FILES structure to the next
  ...
  //
  //  TXFS_LIST_TRANSACTION_LOCKED_FILES_ENTRY_FLAG_* flags to indicate whether
  //  the current name was deleted or created in the transaction.
  //
...
typedef struct _TXFS_LIST_TRANSACTION_LOCKED_FILES {
  ...
  //  This value may change from call to call as the transaction locks more
  //  files.
  //
...
//
//  Note that the TXFS_SAVEPOINT_INFORMATION structure is both and in and out
//  structure. The KtmTransaction and ActionCode members are always
//  in-parameters, and the SavepointId member is either an in-parameter, an
//  out-parameter, or not used (see its definition below).
//
...
typedef struct _TXFS_SAVEPOINT_INFORMATION {
  ...
  //  which to roll back.
  //
  //  Out-parameter for TXFS_SET_SAVEPOINT - the newly-created savepoint ID will
  //  be returned here.
  //
...
//
//      Only an out parameter is necessary.  That returns the identifier of the
//      new miniversion created.
//
...
typedef struct _TXFS_TRANSACTION_ACTIVE_INFO {
  ...
  //
  //  Whether or not the volume had active transactions when this snapshot was
  //  taken.
  //
...
typedef struct _RETRIEVAL_POINTER_BASE {
  ...
  LARGE_INTEGER FileAreaOffset; // sector offset to the first allocatable unit
                                // on the filesystem
...
//
//  The volume backs a system critical volume, typically the one that has
//  wimboot image file serving the system files
//
...
//  And hence this relies on the other volume being present in order for the
//  system to boot up.
//
...
typedef struct _REQUEST_OPLOCK_INPUT_BUFFER {
  ...
  //
  //  One or more OPLOCK_LEVEL_CACHE_* values to indicate the desired level of
  //  the oplock.
  //
...
#if (NTDDI_VERSION >= NTDDI_WIN10_CU)
// If the oplock request fails with STATUS_OPLOCK_NOT_GRANTED, this flag
// indicates that the oplock could not be granted due to the presence of a
// writable user-mapped section.
...
typedef struct _REQUEST_OPLOCK_OUTPUT_BUFFER {
  ...
  //
  //  One or more OPLOCK_LEVEL_CACHE_* values indicating the level of the oplock
  ...
  //
  //  One or more OPLOCK_LEVEL_CACHE_* values indicating the level to which an
  //  oplock is being broken, or an oplock level that may be available for
  //  granting, depending on the operation returning this buffer.
  //
  ...
  //  OPLOCK_LEVEL_CACHE_HANDLE level is being lost in an oplock break, these
  //  fields contain the access mode and share mode of the request that is
  //  causing the break.
  //
...
typedef struct _STORAGE_QUERY_DEPENDENT_VOLUME_LEV2_ENTRY {
  ...
  DWORD ProviderSpecificFlags;
  VIRTUAL_STORAGE_TYPE VirtualStorageType;
  DWORD AncestorLevel; // Root parent is 0, every child level after that is
                       // incremented
...
#define FILE_TYPE_NOTIFICATION_FLAG_USAGE_BEGIN                                \
  0x00000001 // Set when adding the specified usage on the given file
#define FILE_TYPE_NOTIFICATION_FLAG_USAGE_END                                  \
  0x00000002 // Set when removing the specified usage on the given file
...
//
//  Have QueryFileLayout include information (defined by DesiredStorageClass in
//  StreamInformation) on DSC streams. This flag must be used in conjunction
//  with QUERY_FILE_LAYOUT_INCLUDE_STREAM_INFORMATION
//
#define QUERY_FILE_LAYOUT_INCLUDE_STREAM_INFORMATION_FOR_DSC_ATTRIBUTE         \
  (0x00000100)
...
//
#define QUERY_FILE_LAYOUT_INCLUDE_STREAM_INFORMATION_FOR_TXF_ATTRIBUTE         \
  (0x00000200)
...
//  QUERY_FILE_LAYOUT_INCLUDE_STREAM_INFORMATION
//
#define QUERY_FILE_LAYOUT_INCLUDE_STREAM_INFORMATION_FOR_EFS_ATTRIBUTE         \
  (0x00000400)
...
//
#define QUERY_FILE_LAYOUT_INCLUDE_ONLY_FILES_WITH_SPECIFIC_ATTRIBUTES          \
  (0x00000800)

//
//  Have QueryFileLayout include files with a DSC attribute in the output
//  buffer. This must be used in conjunction with
...
//
//  Have QueryFileLayout include information (defined by DataStream in
//  StreamInformation) on $DATA streams. This flag must be used in conjunction
//  with QUERY_FILE_LAYOUT_INCLUDE_STREAM_INFORMATION
//
#define QUERY_FILE_LAYOUT_INCLUDE_STREAM_INFORMATION_FOR_DATA_ATTRIBUTE        \
  (0x00002000)

//
//  Have QueryFileLayout include information (defined by Reparse in
//  StreamInformation) on $REPARSE_POINT streams. This flag must be used in
//  conjunction with QUERY_FILE_LAYOUT_INCLUDE_STREAM_INFORMATION
//
#define QUERY_FILE_LAYOUT_INCLUDE_STREAM_INFORMATION_FOR_REPARSE_ATTRIBUTE     \
  (0x00004000)

//
//  Have QueryFileLayout include information (defined by Ea as in
//  StreamInformation) on $EA streams. This flag must be used in conjunction
//  with QUERY_FILE_LAYOUT_INCLUDE_STREAM_INFORMATION
//
#define QUERY_FILE_LAYOUT_INCLUDE_STREAM_INFORMATION_FOR_EA_ATTRIBUTE          \
  (0x00008000)
...
typedef struct _QUERY_FILE_LAYOUT_INPUT {
  ...
  union {
    ...
    _When_((FilterType == QUERY_FILE_LAYOUT_FILTER_TYPE_CLUSTERS),
           _Field_size_(FilterEntryCount)) CLUSTER_RANGE ClusterRanges[1];
...
#if (NTDDI_VERSION < NTDDI_WIN10_RS5) &&                                       \
    (NTDDI_VERSION <                                                           \
     NTDDI_WIN10_RS1) // RS1  check is for backward compatibility.
...
typedef struct _STREAM_LAYOUT_ENTRY {
  ...
  // buffer.
  //
  _Field_size_bytes_(StreamIdentifierLength) WCHAR StreamIdentifier[1];
...
typedef struct _FSCTL_GET_INTEGRITY_INFORMATION_BUFFER {
  WORD ChecksumAlgorithm; // Checksum algorithm. e.g. CHECKSUM_TYPE_UNCHANGED,
...
typedef struct _FSCTL_SET_INTEGRITY_INFORMATION_BUFFER_EX {
  ...
  BYTE KeepIntegrityStateUnchanged; // 1 to keep the current integrity state and
                                    // ignore the value in EnableIntegrity, 0 to
                                    // use EnableIntegrity value
  WORD Reserved;                    // Must be 0
  DWORD Flags;                      // FSCTL_INTEGRITY_FLAG_xxx
...
typedef struct _REPAIR_COPIES_INPUT {
  ...
  DWORD RepairCopies[ANYSIZE_ARRAY]; // The copy numbers of all the copies that
                                     // will be repaired.
...
typedef struct _REPAIR_COPIES_OUTPUT {
  ...
  LARGE_INTEGER
  ResumeFileOffset; // File Offset hint to use to resume repair operation
                    // skipping the range where errors were found
                    // (operational Status is non-success).
...
//      if the bit is NOT set, then the specified region does NOT have that
//      attribute
//
...
#define FILE_REGION_USAGE_QUERY_ALIGNMENT                                      \
...
#define VALID_WRITE_USN_REASON_MASK                                            \
...
//
//  The FILE_STORAGE_TIER is an identifier for the storage tier relative to the
//  volume. The storage tier ID for a particular volume has no relationship to
//  the storage tier ID with the same value on a different volume.
//

//
//  Note! The MediaType is used to indicate an uninitialized in-memory DSC
//  structure. Do not use values 0xfe or 0xff as media types.
//
...
//  that structure reserves the upper WORD   of the Flags field for file system
//  use. We define the following possible values for the Flags field.
//
...
//  FSCTL_QUERY_STORAGE_CLASSES_OUTPUT that has all the tiers for this volume.
//
...
#define FSCTL_QUERY_STORAGE_CLASSES_OUTPUT_VERSION                             \
  sizeof(FSCTL_QUERY_STORAGE_CLASSES_OUTPUT)

//
//  Below are flags used by the Reparse union type within
//  STREAM_INFORMATION_ENTRY.
//

#define QUERY_FILE_LAYOUT_REPARSE_DATA_INVALID                                 \
  (0x0001) // invalid reparse data, corresponds to ERROR_INVALID_REPARSE_DATA
#define QUERY_FILE_LAYOUT_REPARSE_TAG_INVALID                                  \
  (0x0002) // invalid reparse tag, corresponds to ERROR_REPARSE_TAG_INVALID
...
typedef struct _STREAM_INFORMATION_ENTRY {
  ...
  union _StreamInformation {
    ...
    struct _Reparse {
      ...
      //
      //  Offset to reparse point data buffer (REPARSE_DATA_BUFFER or
    ...
    struct _Ea {
      ...
      //
      //  Offset to EA (Extended Attributes) information buffer
...
#define FSCTL_QUERY_REGION_INFO_INPUT_VERSION                                  \
  sizeof(FSCTL_QUERY_REGION_INFO_INPUT)
...
//
//  The FSCTL_QUERY_REGION_INFO response returns a single one of these that
//  include multiple FILE_STORAGE_TIER_REGION records, one for each region.
//
...
typedef struct _FSCTL_QUERY_REGION_INFO_OUTPUT {
  ...
  Regions[ANYSIZE_ARRAY]; // Detailed info on the regions.

} FSCTL_QUERY_REGION_INFO_OUTPUT, *PFSCTL_QUERY_REGION_INFO_OUTPUT;

#define FSCTL_QUERY_REGION_INFO_OUTPUT_VERSION                                 \
  sizeof(FSCTL_QUERY_REGION_INFO_OUTPUT)

//
//  This structure contains the information for the Desired Storage Class
//  attribute.
//
...
typedef struct _ENCRYPTION_KEY_CTRL_INPUT {
  ...
  WORD KeyOffset; // Byte offset of the key blob relative to the start of this
                  // structure. Could be 0 if key blob is not passed.
  ...
  DWORDLONG
  DplCredentialId; // DPL credential runtime ID which is being impacted.
...
typedef struct _VIRTUALIZATION_INSTANCE_INFO_INPUT_EX {
  ...
  WORD NotificationInfoOffset; // Offset from beginning of this struct to the
                               // NotificationInfo Buffer.
...
typedef enum _FS_BPIO_OPERATIONS {
  ...
  //
  //  This request can come from user or kernel mode.  This is a request to
  //  enable
  //  BypassIO for the given file which means a driver may not see all
  //  reads/writes
  //  for that file.
  //
  ...
  //  handle requests that may not be compatible with the BypassIO enabled
  //  state.
  //
  ...
  //  stack below them that BypassIO is now disabled.  They should set
  //  appropriate
  ...
  //  now needs to turn off BypassIO support for a file (a good example is an
  //  encryption
  //  driver wanting to encrypt this file).  They should send this FSCTL to the
  //  top
  ...
  //  enabled,
  //  it should be ignored.  If sent on a file that currently does not have
  //  BypassIO
  ...
  //  This request can come from user or kernel mode.  This is a request to
  //  PAUSE
  //  BypassIO on this volume/storage stack.  All active BypassIO enabled files
  //  will
  ...
  //
  //  Bitlocker is an example of a component that would use this when it needs
  //  to
  //  enable encryption on a volume.  It is fine to send this even if BypassIO
  //  is
  //  not currently enabled on any files on the volume
  //
  //  This operation will not return until all active BypassIO files have
  //  transitioned
  ...
  //  FS_BPIO_VOLUME_STACK_PAUSE) when a snapshot is created and would send this
  //  when
  ...
  //  This request can come from user or kernel mode.  This is a request to
  //  PAUSE
  //  BypassIO on this stream.  All active BypassIO enabled files will stop
  //  doing
  ...
  //  determine if Bypass can be resumed on the stream by issuing a
  //  FS_BPIO_OP_QUERY
...
typedef struct _FS_BPIO_RESULTS {
  ...
  //  ENABLE/QUERY request.  This string is used for diagnostic reasons and
  //  should identify the WHY.
  //
...
#define FS_BPIO_OUTPUT_ENABLE_SIZE                                             \
  (RTL_SIZEOF_THROUGH_FIELD(FS_BPIO_OUTPUT, Enable))
#define FS_BPIO_OUTPUT_QUERY_SIZE                                              \
  (RTL_SIZEOF_THROUGH_FIELD(FS_BPIO_OUTPUT, Query))
#define FS_BPIO_OUTPUT_DISABLE_SIZE                                            \
  ((size_t)FIELD_OFFSET(FS_BPIO_OUTPUT, Enable))
#define FS_BPIO_OUTPUT_VOLUME_STACK_PAUSE_SIZE                                 \
  ((size_t)FIELD_OFFSET(FS_BPIO_OUTPUT, Enable))
#define FS_BPIO_OUTPUT_VOLUME_STACK_RESUME_SIZE                                \
  (RTL_SIZEOF_THROUGH_FIELD(FS_BPIO_OUTPUT, VolumeStackResume))
#define FS_BPIO_OUTPUT_STREAM_PAUSE_SIZE                                       \
  ((size_t)FIELD_OFFSET(FS_BPIO_OUTPUT, Enable))
#define FS_BPIO_OUTPUT_STREAM_RESUME_SIZE                                      \
  (RTL_SIZEOF_THROUGH_FIELD(FS_BPIO_OUTPUT, StreamResume))
#define FS_BPIO_OUTPUT_GET_INFO_SIZE                                           \
  (RTL_SIZEOF_THROUGH_FIELD(FS_BPIO_OUTPUT, GetInfo))
...
// file is opened over SMB. Tells CSVFS that this file open should be valid only
// on coordinating node. If open comes to CSVFS, and this node is not a
// coordinating then open would fail. If file is opened, and coordinating node
// is moved then file open will be invalidated
//
...
typedef struct _NETWORK_APP_INSTANCE_EA {
  ...
  //
  //  The caller places a GUID that should always be unique for a single
...
typedef struct _SMB_SHARE_FLUSH_AND_PURGE_INPUT const
...
typedef struct _SMB_SHARE_FLUSH_AND_PURGE_OUTPUT const
