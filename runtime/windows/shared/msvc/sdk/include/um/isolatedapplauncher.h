...
public:
  virtual HRESULT STDMETHODCALLTYPE Launch(
      ...
      /* [in] */
      __RPC__in const IsolatedAppLauncherTelemetryParameters
          *telemetryParameters) = 0;
};
...
typedef struct IIsolatedAppLauncherVtbl {
  ...
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IIsolatedAppLauncher *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IIsolatedAppLauncher *This);
...
#define IIsolatedAppLauncher_Launch(This, appUserModelId, arguments,           \
                                    telemetryParameters)                       \
...
__declspec(deprecated("IsProcessInWDAGContainer is deprecated and might not "
                      "work on all platforms. For more info, see MSDN."))
STDAPI IsProcessInWDAGContainer(_In_ PVOID Reserved,
                                _Out_ BOOL *isProcessInWDAGContainer);
#endif // (NTDDI_VERSION >= NTDDI_WIN10_19H1)
__declspec(deprecated("IsProcessInIsolatedContainer is deprecated and might "
                      "not work on all platforms. For more info, see MSDN."))
...
typedef struct IIsolatedProcessLauncherVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IIsolatedProcessLauncher *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IIsolatedProcessLauncher *This);
...
#define IIsolatedProcessLauncher_AddRef(This) ((This)->lpVtbl->AddRef(This))

#define IIsolatedProcessLauncher_Release(This) ((This)->lpVtbl->Release(This))

#define IIsolatedProcessLauncher_LaunchProcess(This, process, arguments,       \
                                               workingDirectory)               \
  ((This)->lpVtbl->LaunchProcess(This, process, arguments, workingDirectory))

#define IIsolatedProcessLauncher_ShareDirectory(This, hostPath, containerPath, \
                                                readOnly)                      \
...
typedef struct IIsolatedProcessLauncher2Vtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IIsolatedProcessLauncher2 *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IIsolatedProcessLauncher2 *This);
...
#define IIsolatedProcessLauncher2_AddRef(This) ((This)->lpVtbl->AddRef(This))

#define IIsolatedProcessLauncher2_Release(This) ((This)->lpVtbl->Release(This))

#define IIsolatedProcessLauncher2_LaunchProcess(This, process, arguments,      \
                                                workingDirectory)              \
  ((This)->lpVtbl->LaunchProcess(This, process, arguments, workingDirectory))

#define IIsolatedProcessLauncher2_ShareDirectory(This, hostPath,               \
...
#define IIsolatedProcessLauncher2_LaunchProcess2(                              \
    This, process, arguments, workingDirectory, correlationGuid)               \
  ((This)->lpVtbl->LaunchProcess2(This, process, arguments, workingDirectory,  \
                                  correlationGuid))
