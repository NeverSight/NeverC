...
DEFINE_GUID(GUID_TS_SERVICE_DATAOBJECT, 0x6086fbb5, 0xe225, 0x46ce, 0xa7, 0x70,
            0xc1, 0xbb, 0xd3, 0xe0, 0x5d, 0x7b);
DEFINE_GUID(GUID_TS_SERVICE_ACCESSIBLE, 0xf9786200, 0xa5bf, 0x4a0f, 0x8c, 0x24,
            0xfb, 0x16, 0xf5, 0xd1, 0xaa, 0xbb);
DEFINE_GUID(GUID_TS_SERVICE_ACTIVEX, 0xea937a50, 0xc9a6, 0x4b7d, 0x89, 0x4a,
            0x49, 0xd9, 0x9b, 0x78, 0x48, 0x34);
...
typedef /* [uuid] */ DECLSPEC_UUID(
    "fec4f516-c503-45b1-a5fd-7a3d8ab07049") struct TS_STATUS {
  DWORD dwDynamicFlags;
  DWORD dwStaticFlags;
} TS_STATUS;

typedef /* [uuid] */ DECLSPEC_UUID(
    "f3181bd6-bcf0-41d3-a81c-474b17ec38fb") struct TS_TEXTCHANGE {
  LONG acpStart;
  LONG acpOldEnd;
  LONG acpNewEnd;
} TS_TEXTCHANGE;

typedef /* [public][public][public][public][public][public][public][public][public][uuid]
         */
    DECLSPEC_UUID(
        "05fcf85b-5e9c-4c3e-ab71-"
        "29471d4f38e7") enum __MIDL___MIDL_itf_textstor_0000_0000_0001 {
      TS_AE_NONE = 0,
      TS_AE_START = 1,
      TS_AE_END = 2
    } TsActiveSelEnd;
...
typedef /* [uuid] */ DECLSPEC_UUID(
    "7ecc3ffa-8f73-4d91-98ed-76f8ac5b1600") struct TS_SELECTIONSTYLE {
  TsActiveSelEnd ase;
  BOOL fInterimChar;
} TS_SELECTIONSTYLE;

typedef /* [uuid] */ DECLSPEC_UUID(
    "c4b9c33b-8a0d-4426-bebe-d444a4701fe9") struct TS_SELECTION_ACP {
  LONG acpStart;
  LONG acpEnd;
...
typedef /* [uuid] */ DECLSPEC_UUID(
    "b03413d2-0723-4c4e-9e08-2e9c1ff3772b") struct TS_SELECTION_ANCHOR {
  IAnchor *paStart;
  IAnchor *paEnd;
  TS_SELECTIONSTYLE style;
} TS_SELECTION_ANCHOR;
...
typedef /* [uuid] */ DECLSPEC_UUID(
    "ef3457d9-8446-49a7-a9e6-b50d9d5f3fd9") GUID TS_ATTRID;

typedef /* [uuid] */ DECLSPEC_UUID(
    "2cc2b33f-1174-4507-b8d9-5bc0eb37c197") struct TS_ATTRVAL {
  TS_ATTRID idAttr;
  DWORD dwOverlapId;
  VARIANT varValue;
} TS_ATTRVAL;
...
typedef /* [uuid] */ DECLSPEC_UUID("1faf509e-44c1-458e-950a-38a96705a62b") DWORD
    TsViewCookie;

#define TS_VCOOKIE_NUL (0xffffffff)

typedef /* [public][public][public][uuid] */ DECLSPEC_UUID(
    "7899d7c4-5f07-493c-a89a-"
    "fac8e777f476") enum __MIDL___MIDL_itf_textstor_0000_0000_0002 {
  TS_LC_CREATE = 0,
  TS_LC_CHANGE = 1,
  TS_LC_DESTROY = 2
} TsLayoutCode;
...
typedef /* [public][public][public][uuid] */ DECLSPEC_UUID(
    "033b0df0-f193-4170-b47b-"
    "141afc247878") enum __MIDL___MIDL_itf_textstor_0000_0000_0003 {
  TS_RT_PLAIN = 0,
...
typedef /* [uuid] */ DECLSPEC_UUID(
    "a6231949-37c5-4b74-a24e-2a26c327201d") struct TS_RUNINFO {
  ULONG uCount;
  TsRunType type;
} TS_RUNINFO;
...
public:
  ...
  virtual HRESULT STDMETHODCALLTYPE SetSelection(
      /* [in] */ ULONG ulCount,
      /* [size_is][in] */ __RPC__in_ecount_full(ulCount)
  ...
  virtual HRESULT STDMETHODCALLTYPE GetText(
      ...
      /* [length_is][size_is][out] */
      __RPC__out_ecount_part(cRunInfoReq, *pcRunInfoRet) TS_RUNINFO *
          prgRunInfo,
  ...
  virtual HRESULT STDMETHODCALLTYPE RequestSupportedAttrs(
      ...
      /* [unique][size_is][in] */
      __RPC__in_ecount_full_opt(cFilterAttrs)
...
typedef struct ITextStoreACPVtbl {
  ...
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in ITextStoreACP *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in ITextStoreACP *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in ITextStoreACP *This);
  ...
  HRESULT(STDMETHODCALLTYPE *GetStatus)(__RPC__in ITextStoreACP *This,
  ...
  HRESULT(STDMETHODCALLTYPE *GetEndACP)(__RPC__in ITextStoreACP *This,
  ...
  HRESULT(STDMETHODCALLTYPE *GetScreenExt)(__RPC__in ITextStoreACP *This,
                                           /* [in] */ TsViewCookie vcView,
                                           /* [out] */ __RPC__out RECT *prc);
...
interface ITextStoreACP { CONST_VTBL struct ITextStoreACPVtbl *lpVtbl; };
...
#define ITextStoreACP_InsertEmbedded(This, dwFlags, acpStart, acpEnd,          \
                                     pDataObject, pChange)                     \
  ((This)->lpVtbl->InsertEmbedded(This, dwFlags, acpStart, acpEnd,             \
                                  pDataObject, pChange))
...
#define ITextStoreACP_FindNextAttrTransition(                                  \
  ...
  ((This)->lpVtbl->FindNextAttrTransition(                                     \
      This, acpStart, acpHalt, cFilterAttrs, paFilterAttrs, dwFlags, pacpNext, \
      pfFound, plFoundOffset))
...
typedef struct ITextStoreACP2Vtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in ITextStoreACP2 *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in ITextStoreACP2 *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in ITextStoreACP2 *This);
  ...
  HRESULT(STDMETHODCALLTYPE *GetStatus)(__RPC__in ITextStoreACP2 *This,
                                        /* [out] */ __RPC__out TS_STATUS *pdcs);
  ...
  HRESULT(STDMETHODCALLTYPE *GetEndACP)(__RPC__in ITextStoreACP2 *This,
                                        /* [out] */ __RPC__out LONG *pacp);
  ...
  HRESULT(STDMETHODCALLTYPE *GetScreenExt)(__RPC__in ITextStoreACP2 *This,
                                           /* [in] */ TsViewCookie vcView,
                                           /* [out] */ __RPC__out RECT *prc);
...
interface ITextStoreACP2 { CONST_VTBL struct ITextStoreACP2Vtbl *lpVtbl; };
...
#define ITextStoreACP2_QueryInsert(This, acpTestStart, acpTestEnd, cch,        \
                                   pacpResultStart, pacpResultEnd)             \
  ((This)->lpVtbl->QueryInsert(This, acpTestStart, acpTestEnd, cch,            \
                               pacpResultStart, pacpResultEnd))

#define ITextStoreACP2_GetSelection(This, ulIndex, ulCount, pSelection,        \
                                    pcFetched)                                 \
  ((This)->lpVtbl->GetSelection(This, ulIndex, ulCount, pSelection, pcFetched))
...
#define ITextStoreACP2_GetText(This, acpStart, acpEnd, pchPlain, cchPlainReq,  \
                               pcchPlainRet, prgRunInfo, cRunInfoReq,          \
                               pcRunInfoRet, pacpNext)                         \
  ((This)->lpVtbl->GetText(This, acpStart, acpEnd, pchPlain, cchPlainReq,      \
                           pcchPlainRet, prgRunInfo, cRunInfoReq,              \
...
#define ITextStoreACP2_SetText(This, dwFlags, acpStart, acpEnd, pchText, cch,  \
                               pChange)                                        \
  ((This)->lpVtbl->SetText(This, dwFlags, acpStart, acpEnd, pchText, cch,      \
                           pChange))
...
#define ITextStoreACP2_QueryInsertEmbedded(This, pguidService, pFormatEtc,     \
                                           pfInsertable)                       \
  ((This)->lpVtbl->QueryInsertEmbedded(This, pguidService, pFormatEtc,         \
                                       pfInsertable))

#define ITextStoreACP2_InsertEmbedded(This, dwFlags, acpStart, acpEnd,         \
                                      pDataObject, pChange)                    \
  ((This)->lpVtbl->InsertEmbedded(This, dwFlags, acpStart, acpEnd,             \
                                  pDataObject, pChange))

#define ITextStoreACP2_InsertTextAtSelection(This, dwFlags, pchText, cch,      \
                                             pacpStart, pacpEnd, pChange)      \
  ((This)->lpVtbl->InsertTextAtSelection(This, dwFlags, pchText, cch,          \
                                         pacpStart, pacpEnd, pChange))

#define ITextStoreACP2_InsertEmbeddedAtSelection(This, dwFlags, pDataObject,   \
                                                 pacpStart, pacpEnd, pChange)  \
  ((This)->lpVtbl->InsertEmbeddedAtSelection(This, dwFlags, pDataObject,       \
                                             pacpStart, pacpEnd, pChange))

#define ITextStoreACP2_RequestSupportedAttrs(This, dwFlags, cFilterAttrs,      \
                                             paFilterAttrs)                    \
  ((This)->lpVtbl->RequestSupportedAttrs(This, dwFlags, cFilterAttrs,          \
                                         paFilterAttrs))

#define ITextStoreACP2_RequestAttrsAtPosition(This, acpPos, cFilterAttrs,      \
                                              paFilterAttrs, dwFlags)          \
  ((This)->lpVtbl->RequestAttrsAtPosition(This, acpPos, cFilterAttrs,          \
                                          paFilterAttrs, dwFlags))

#define ITextStoreACP2_RequestAttrsTransitioningAtPosition(                    \
    This, acpPos, cFilterAttrs, paFilterAttrs, dwFlags)                        \
  ((This)->lpVtbl->RequestAttrsTransitioningAtPosition(                        \
      This, acpPos, cFilterAttrs, paFilterAttrs, dwFlags))

#define ITextStoreACP2_FindNextAttrTransition(                                 \
    This, acpStart, acpHalt, cFilterAttrs, paFilterAttrs, dwFlags, pacpNext,   \
    pfFound, plFoundOffset)                                                    \
  ((This)->lpVtbl->FindNextAttrTransition(                                     \
      This, acpStart, acpHalt, cFilterAttrs, paFilterAttrs, dwFlags, pacpNext, \
...
#define ITextStoreACP2_RetrieveRequestedAttrs(This, ulCount, paAttrVals,       \
                                              pcFetched)                       \
  ((This)->lpVtbl->RetrieveRequestedAttrs(This, ulCount, paAttrVals, pcFetched))
...
#define ITextStoreACP2_GetTextExt(This, vcView, acpStart, acpEnd, prc,         \
                                  pfClipped)                                   \
  ((This)->lpVtbl->GetTextExt(This, vcView, acpStart, acpEnd, prc, pfClipped))
...
public:
  ...
  virtual HRESULT STDMETHODCALLTYPE OnAttrsChange(
      ...
      /* [in] */ ULONG cAttrs,
      /* [size_is][in] */
      __RPC__in_ecount_full(cAttrs) const TS_ATTRID *paAttrs) = 0;
...
typedef struct ITextStoreACPSinkVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in ITextStoreACPSink *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in ITextStoreACPSink *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in ITextStoreACPSink *This);
  ...
  HRESULT(STDMETHODCALLTYPE *OnLayoutChange)(__RPC__in ITextStoreACPSink *This,
                                             /* [in] */ TsLayoutCode lcode,
                                             /* [in] */ TsViewCookie vcView);

  DECLSPEC_XFGVIRT(ITextStoreACPSink, OnStatusChange)
  HRESULT(STDMETHODCALLTYPE *OnStatusChange)(__RPC__in ITextStoreACPSink *This,
                                             /* [in] */ DWORD dwFlags);

  DECLSPEC_XFGVIRT(ITextStoreACPSink, OnAttrsChange)
  HRESULT(STDMETHODCALLTYPE *OnAttrsChange)(__RPC__in ITextStoreACPSink *This,
                                            /* [in] */ LONG acpStart,
                                            /* [in] */ LONG acpEnd,
                                            /* [in] */ ULONG cAttrs,
                                            /* [size_is][in] */
                                            __RPC__in_ecount_full(cAttrs)
                                                const TS_ATTRID *paAttrs);

  DECLSPEC_XFGVIRT(ITextStoreACPSink, OnLockGranted)
  HRESULT(STDMETHODCALLTYPE *OnLockGranted)(__RPC__in ITextStoreACPSink *This,
                                            /* [in] */ DWORD dwLockFlags);
...
typedef /* [public][public][public][uuid] */ DECLSPEC_UUID(
    "daa8601e-7695-426f-9bb7-498a6aa64b68") enum __MIDL_IAnchor_0001 {
  TS_GR_BACKWARD = 0,
  TS_GR_FORWARD = 1
} TsGravity;

typedef /* [public][public][uuid] */ DECLSPEC_UUID(
    "898e19df-4fb4-4af3-8daf-9b3c1145c79d") enum __MIDL_IAnchor_0002 {
  TS_SD_BACKWARD = 0,
  TS_SD_FORWARD = 1
} TsShiftDir;
...
typedef struct IAnchorVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in IAnchor *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IAnchor *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IAnchor *This);

  DECLSPEC_XFGVIRT(IAnchor, SetGravity)
  HRESULT(STDMETHODCALLTYPE *SetGravity)(__RPC__in IAnchor *This,
  ...
  HRESULT(STDMETHODCALLTYPE *IsEqual)(__RPC__in IAnchor *This,
                                      /* [in] */ __RPC__in_opt IAnchor *paWith,
                                      /* [out] */ __RPC__out BOOL *pfEqual);

  DECLSPEC_XFGVIRT(IAnchor, Compare)
  HRESULT(STDMETHODCALLTYPE *Compare)(__RPC__in IAnchor *This,
                                      /* [in] */ __RPC__in_opt IAnchor *paWith,
  ...
  HRESULT(STDMETHODCALLTYPE *ShiftTo)(__RPC__in IAnchor *This,
  ...
  HRESULT(STDMETHODCALLTYPE *SetChangeHistoryMask)(__RPC__in IAnchor *This,
                                                   /* [in] */ DWORD dwMask);
  ...
  HRESULT(STDMETHODCALLTYPE *ClearChangeHistory)(__RPC__in IAnchor *This);
...
interface IAnchor { CONST_VTBL struct IAnchorVtbl *lpVtbl; };
...
public:
  ...
  virtual HRESULT STDMETHODCALLTYPE GetSelection(
      ...
      /* [in] */ ULONG ulCount,
      /* [length_is][size_is][out] */
      __RPC__out_ecount_part(ulCount, *pcFetched) TS_SELECTION_ANCHOR *
          pSelection,
      /* [out] */ __RPC__out ULONG * pcFetched) = 0;
...
typedef struct ITextStoreAnchorVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in ITextStoreAnchor *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in ITextStoreAnchor *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in ITextStoreAnchor *This);
  ...
  HRESULT(STDMETHODCALLTYPE *GetStatus)(__RPC__in ITextStoreAnchor *This,
                                        /* [out] */ __RPC__out TS_STATUS *pdcs);
  ...
  HRESULT(STDMETHODCALLTYPE *GetText)(__RPC__in ITextStoreAnchor *This,
                                      /* [in] */ DWORD dwFlags,
                                      /* [in] */ __RPC__in_opt IAnchor *paStart,
                                      /* [in] */ __RPC__in_opt IAnchor *paEnd,
                                      /* [length_is][size_is][out] */
                                      __RPC__out_ecount_part(cchReq, *pcch)
                                          WCHAR *pchText,
                                      /* [in] */ ULONG cchReq,
                                      /* [out] */ __RPC__out ULONG *pcch,
  ...
  HRESULT(STDMETHODCALLTYPE *GetScreenExt)(__RPC__in ITextStoreAnchor *This,
                                           /* [in] */ TsViewCookie vcView,
                                           /* [out] */ __RPC__out RECT *prc);
...
interface ITextStoreAnchor { CONST_VTBL struct ITextStoreAnchorVtbl *lpVtbl; };
...
#define ITextStoreAnchor_QueryInsert(This, paTestStart, paTestEnd, cch,        \
                                     ppaResultStart, ppaResultEnd)             \
  ((This)->lpVtbl->QueryInsert(This, paTestStart, paTestEnd, cch,              \
                               ppaResultStart, ppaResultEnd))

#define ITextStoreAnchor_GetSelection(This, ulIndex, ulCount, pSelection,      \
                                      pcFetched)                               \
  ((This)->lpVtbl->GetSelection(This, ulIndex, ulCount, pSelection, pcFetched))
...
#define ITextStoreAnchor_GetText(This, dwFlags, paStart, paEnd, pchText,       \
                                 cchReq, pcch, fUpdateAnchor)                  \
  ((This)->lpVtbl->GetText(This, dwFlags, paStart, paEnd, pchText, cchReq,     \
                           pcch, fUpdateAnchor))
...
#define ITextStoreAnchor_GetEmbedded(This, dwFlags, paPos, rguidService, riid, \
                                     ppunk)                                    \
  ((This)->lpVtbl->GetEmbedded(This, dwFlags, paPos, rguidService, riid, ppunk))

#define ITextStoreAnchor_InsertEmbedded(This, dwFlags, paStart, paEnd,         \
                                        pDataObject)                           \
  ((This)->lpVtbl->InsertEmbedded(This, dwFlags, paStart, paEnd, pDataObject))

#define ITextStoreAnchor_RequestSupportedAttrs(This, dwFlags, cFilterAttrs,    \
                                               paFilterAttrs)                  \
  ((This)->lpVtbl->RequestSupportedAttrs(This, dwFlags, cFilterAttrs,          \
                                         paFilterAttrs))

#define ITextStoreAnchor_RequestAttrsAtPosition(This, paPos, cFilterAttrs,     \
                                                paFilterAttrs, dwFlags)        \
  ((This)->lpVtbl->RequestAttrsAtPosition(This, paPos, cFilterAttrs,           \
                                          paFilterAttrs, dwFlags))

#define ITextStoreAnchor_RequestAttrsTransitioningAtPosition(                  \
    This, paPos, cFilterAttrs, paFilterAttrs, dwFlags)                         \
  ((This)->lpVtbl->RequestAttrsTransitioningAtPosition(                        \
      This, paPos, cFilterAttrs, paFilterAttrs, dwFlags))

#define ITextStoreAnchor_FindNextAttrTransition(                               \
    This, paStart, paHalt, cFilterAttrs, paFilterAttrs, dwFlags, pfFound,      \
    plFoundOffset)                                                             \
  ((This)->lpVtbl->FindNextAttrTransition(This, paStart, paHalt, cFilterAttrs, \
                                          paFilterAttrs, dwFlags, pfFound,     \
                                          plFoundOffset))

#define ITextStoreAnchor_RetrieveRequestedAttrs(This, ulCount, paAttrVals,     \
                                                pcFetched)                     \
  ((This)->lpVtbl->RetrieveRequestedAttrs(This, ulCount, paAttrVals, pcFetched))
...
#define ITextStoreAnchor_GetAnchorFromPoint(This, vcView, ptScreen, dwFlags,   \
                                            ppaSite)                           \
  ((This)->lpVtbl->GetAnchorFromPoint(This, vcView, ptScreen, dwFlags, ppaSite))

#define ITextStoreAnchor_GetTextExt(This, vcView, paStart, paEnd, prc,         \
                                    pfClipped)                                 \
...
#define ITextStoreAnchor_QueryInsertEmbedded(This, pguidService, pFormatEtc,   \
                                             pfInsertable)                     \
  ((This)->lpVtbl->QueryInsertEmbedded(This, pguidService, pFormatEtc,         \
                                       pfInsertable))

#define ITextStoreAnchor_InsertTextAtSelection(This, dwFlags, pchText, cch,    \
                                               ppaStart, ppaEnd)               \
  ((This)->lpVtbl->InsertTextAtSelection(This, dwFlags, pchText, cch,          \
                                         ppaStart, ppaEnd))

#define ITextStoreAnchor_InsertEmbeddedAtSelection(This, dwFlags, pDataObject, \
                                                   ppaStart, ppaEnd)           \
  ((This)->lpVtbl->InsertEmbeddedAtSelection(This, dwFlags, pDataObject,       \
                                             ppaStart, ppaEnd))
...
typedef struct ITextStoreAnchorSinkVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in ITextStoreAnchorSink *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in ITextStoreAnchorSink *This);
...
#define ITextStoreAnchorSink_OnAttrsChange(This, paStart, paEnd, cAttrs,       \
                                           paAttrs)                            \
