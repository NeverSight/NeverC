...
typedef struct ItsPubPluginVtbl {
  ...
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in ItsPubPlugin *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in ItsPubPlugin *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in ItsPubPlugin *This);
...
interface ItsPubPlugin { CONST_VTBL struct ItsPubPluginVtbl *lpVtbl; };
...
#define ItsPubPlugin_GetResourceList(This, userID, pceAppListSize,             \
                                     resourceList)                             \
...
#define ItsPubPlugin_ResolveResource(This, resourceType, resourceLocation,     \
