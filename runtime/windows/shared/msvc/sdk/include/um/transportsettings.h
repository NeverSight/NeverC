...
typedef struct ITransportSettingsInternalVtbl {
  ...
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(ITransportSettingsInternal *This,
                                             /* [in] */ REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(ITransportSettingsInternal *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(ITransportSettingsInternal *This);
...
#define ITransportSettingsInternal_AddRef(This) ((This)->lpVtbl->AddRef(This))

#define ITransportSettingsInternal_Release(This) ((This)->lpVtbl->Release(This))
...
public:
  virtual HRESULT STDMETHODCALLTYPE ApplySetting(
      ...
      /* [size_is][size_is][out] */
      __RPC__deref_out_ecount_full_opt(*LengthOut) BYTE **ValueOut) = 0;
...
typedef struct INetworkTransportSettingsVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in INetworkTransportSettings *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in INetworkTransportSettings *This);
...
#define INetworkTransportSettings_AddRef(This) ((This)->lpVtbl->AddRef(This))

#define INetworkTransportSettings_Release(This) ((This)->lpVtbl->Release(This))

#define INetworkTransportSettings_ApplySetting(This, SettingId, LengthIn,      \
                                               ValueIn, LengthOut, ValueOut)   \
  ((This)->lpVtbl->ApplySetting(This, SettingId, LengthIn, ValueIn, LengthOut, \
                                ValueOut))

#define INetworkTransportSettings_QuerySetting(This, SettingId, LengthIn,      \
                                               ValueIn, LengthOut, ValueOut)   \
  ((This)->lpVtbl->QuerySetting(This, SettingId, LengthIn, ValueIn, LengthOut, \
                                ValueOut))
...
typedef struct INotificationTransportSyncVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in INotificationTransportSync *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in INotificationTransportSync *This);
  ...
  HRESULT(STDMETHODCALLTYPE *Flush)(__RPC__in INotificationTransportSync *This);
...
#define INotificationTransportSync_AddRef(This) ((This)->lpVtbl->AddRef(This))

#define INotificationTransportSync_Release(This) ((This)->lpVtbl->Release(This))

#define INotificationTransportSync_CompleteDelivery(This)                      \
  ((This)->lpVtbl->CompleteDelivery(This))

#define INotificationTransportSync_Flush(This) ((This)->lpVtbl->Flush(This))
