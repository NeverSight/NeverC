#pragma once
//
// InputEventFlags are intended to be generic Input Flags to indicate actions
// for Touch, Mouse or Keyboard events.
//
...
enum InputEventFlag {
  ...
  InputEventFlag_DownAndUp =
      (InputEventFlag_Down | InputEventFlag_Up), // 0x0005
