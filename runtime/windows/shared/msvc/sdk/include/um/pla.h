...
typedef interface IPerformanceCounterDataCollector
...
#else
typedef struct LegacyDataCollectorSetCollection
...
#else
typedef struct ServerDataCollectorSetCollection
...
#else
typedef struct SystemDataCollectorSetCollection
...
typedef /* [public][public][public][uuid] */ DECLSPEC_UUID(
    "03837504-098b-11d8-9414-"
    "505054503030") enum __MIDL___MIDL_itf_pla_0001_0043_0001 {
...
typedef /* [public][public][public][uuid] */ DECLSPEC_UUID(
    "03837507-098b-11d8-9414-"
    "505054503030") enum __MIDL___MIDL_itf_pla_0001_0043_0002 {
  plaCommaSeparated = 0,
  plaTabSeparated = 1,
  plaSql = 2,
  plaBinary = 3
...
typedef /* [public][public][public][public][public][uuid] */ DECLSPEC_UUID(
    "03837508-098b-11d8-9414-"
    "505054503030") enum __MIDL___MIDL_itf_pla_0001_0043_0003 {
  plaNone = 0,
  plaPattern = 0x1,
  plaComputer = 0x2,
...
typedef /* [public][public][uuid] */ DECLSPEC_UUID(
    "0383750a-098b-11d8-9414-"
    "505054503030") enum __MIDL___MIDL_itf_pla_0001_0043_0004 {
  plaStopped = 0,
  plaRunning = 1,
  plaCompiling = 2,
  plaPending = 3,
...
typedef /* [public][public][public][uuid] */ DECLSPEC_UUID(
    "0383750d-098b-11d8-9414-"
    "505054503030") enum __MIDL___MIDL_itf_pla_0001_0043_0005 {
  plaTimeStamp = 0,
  plaPerformance = 1,
  plaSystem = 2,
  plaCycle = 3
...
typedef /* [public][public][public][uuid] */ DECLSPEC_UUID(
    "0383750e-098b-11d8-9414-"
    "505054503030") enum __MIDL___MIDL_itf_pla_0001_0043_0006 {
  plaFile = 0x1,
  plaRealTime = 0x2,
  plaBoth = 0x3,
  plaBuffering = 0x4
...
typedef /* [public][public][uuid] */ DECLSPEC_UUID(
    "0383751f-098b-11d8-9414-"
    "505054503030") enum __MIDL___MIDL_itf_pla_0001_0043_0007 {
  plaCreateNew = 0x1,
  plaModify = 0x2,
...
typedef /* [public][public][public][public][public][uuid] */ DECLSPEC_UUID(
    "03837535-098b-11d8-9414-"
    "505054503030") enum __MIDL___MIDL_itf_pla_0001_0043_0008 {
  plaIndex = 1,
  plaFlag = 2,
  plaFlagArray = 3,
  plaValidation = 4
...
typedef /* [public][public][public][uuid] */ DECLSPEC_UUID(
    "0383753b-098b-11d8-9414-"
    "505054503030") enum __MIDL___MIDL_itf_pla_0001_0043_0009 {
  plaRunOnce = 0,
  plaSunday = 0x1,
  plaMonday = 0x2,
  plaTuesday = 0x4,
...
typedef /* [public][public][public][uuid] */ DECLSPEC_UUID(
    "0383753f-098b-11d8-9414-"
    "505054503030") enum __MIDL___MIDL_itf_pla_0001_0043_0010 {
  plaDeleteLargest = 0,
  plaDeleteOldest = 1
} ResourcePolicy;

typedef /* [public][public][uuid] */ DECLSPEC_UUID(
    "03837540-098b-11d8-9414-"
    "505054503030") enum __MIDL___MIDL_itf_pla_0001_0043_0011 {
  plaCreateReport = 0x1,
  plaRunRules = 0x2,
  plaCreateHtml = 0x4,
...
typedef /* [public][public][public][uuid] */ DECLSPEC_UUID(
    "03837542-098b-11d8-9414-"
    "505054503030") enum __MIDL___MIDL_itf_pla_0001_0043_0012 {
  plaCreateCab = 0x1,
  plaDeleteData = 0x2,
  plaSendCab = 0x4,
  plaDeleteCab = 0x8,
...
PLA_FUNCTION
PlaExpandTaskArguments(VARIANT vDataSet, _Out_ BSTR *args);
...
PLA_FUNCTION
PlaGetServerCapabilities(_In_opt_ BSTR Server, _Out_ PDWORD Capabilites);

PLA_FUNCTION
PlaGetLegacyAlertActionsStringFromFlags(_In_ DWORD dwFlags,
                                        _Out_ BSTR *pbstrAlertStr);

PLA_FUNCTION
PlaGetLegacyAlertActionsFlagsFromString(_In_ PCWSTR pszArguments,
                                        _Out_ LPDWORD pdwFlags);

typedef VOID (*PLA_CABEXTRACT_CALLBACK)(PCWSTR FileName, PVOID Context);

HRESULT
PlaExtractCabinet(_In_ PCWSTR CabFileName, _In_ PCWSTR DestPath,
                  _In_opt_ PLA_CABEXTRACT_CALLBACK Callback,
                  _In_opt_ PVOID Context);

HRESULT
PlaDeleteReport(_In_ PCWSTR Folder);
...
public:
  virtual /* [propget] */ HRESULT STDMETHODCALLTYPE get_DataCollectors(
      /* [retval][out] */ __RPC__deref_out_opt IDataCollectorCollection *
      *collectors) = 0;
  ...
  virtual /* [propget] */ HRESULT STDMETHODCALLTYPE get_Schedules(
      /* [retval][out] */ __RPC__deref_out_opt IScheduleCollection *
      *ppSchedules) = 0;
  ...
  virtual HRESULT STDMETHODCALLTYPE SetCredentials(__RPC__in BSTR user,
  ...
  virtual HRESULT STDMETHODCALLTYPE Commit(
      /* [in] */ __RPC__in BSTR name,
      /* [unique][in] */ __RPC__in_opt BSTR server, CommitMode mode,
  ...
  virtual HRESULT STDMETHODCALLTYPE SetValue(__RPC__in BSTR key,
...
typedef struct IDataCollectorSetVtbl {
  ...
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in IDataCollectorSet *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IDataCollectorSet *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IDataCollectorSet *This);
  ...
  HRESULT(STDMETHODCALLTYPE *SetCredentials)(__RPC__in IDataCollectorSet *This,
                                             __RPC__in BSTR user,
  ...
  HRESULT(STDMETHODCALLTYPE *Delete)(__RPC__in IDataCollectorSet *This);

  DECLSPEC_XFGVIRT(IDataCollectorSet, Start)
  HRESULT(STDMETHODCALLTYPE *Start)(__RPC__in IDataCollectorSet *This,
                                    /* [in] */ VARIANT_BOOL Synchronous);

  DECLSPEC_XFGVIRT(IDataCollectorSet, Stop)
  HRESULT(STDMETHODCALLTYPE *Stop)(__RPC__in IDataCollectorSet *This,
                                   /* [in] */ VARIANT_BOOL Synchronous);
  ...
  HRESULT(STDMETHODCALLTYPE *SetValue)(__RPC__in IDataCollectorSet *This,
                                       __RPC__in BSTR key,
                                       __RPC__in BSTR value);

  DECLSPEC_XFGVIRT(IDataCollectorSet, GetValue)
  HRESULT(STDMETHODCALLTYPE *GetValue)(
      __RPC__in IDataCollectorSet *This, __RPC__in BSTR key,
...
#define IDataCollectorSet_GetIDsOfNames(This, riid, rgszNames, cNames, lcid,   \
                                        rgDispId)                              \
  ((This)->lpVtbl->GetIDsOfNames(This, riid, rgszNames, cNames, lcid, rgDispId))

#define IDataCollectorSet_Invoke(This, dispIdMember, riid, lcid, wFlags,       \
...
public:
  ...
  virtual /* [propget] */ HRESULT STDMETHODCALLTYPE get_FolderActions(
      /* [retval][out] */ __RPC__deref_out_opt IFolderActionCollection *
      *Actions) = 0;
...
typedef struct IDataManagerVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in IDataManager *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IDataManager *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IDataManager *This);
...
interface IDataManager { CONST_VTBL struct IDataManagerVtbl *lpVtbl; };
...
#define IDataManager_GetIDsOfNames(This, riid, rgszNames, cNames, lcid,        \
                                   rgDispId)                                   \
  ((This)->lpVtbl->GetIDsOfNames(This, riid, rgszNames, cNames, lcid, rgDispId))

#define IDataManager_Invoke(This, dispIdMember, riid, lcid, wFlags,            \
...
typedef struct IFolderActionVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in IFolderAction *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IFolderAction *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IFolderAction *This);
...
interface IFolderAction { CONST_VTBL struct IFolderActionVtbl *lpVtbl; };
...
#define IFolderAction_GetIDsOfNames(This, riid, rgszNames, cNames, lcid,       \
                                    rgDispId)                                  \
  ((This)->lpVtbl->GetIDsOfNames(This, riid, rgszNames, cNames, lcid, rgDispId))

#define IFolderAction_Invoke(This, dispIdMember, riid, lcid, wFlags,           \
                             pDispParams, pVarResult, pExcepInfo, puArgErr)    \
  ((This)->lpVtbl->Invoke(This, dispIdMember, riid, lcid, wFlags, pDispParams, \
                          pVarResult, pExcepInfo, puArgErr))
...
public:
  ...
  virtual HRESULT STDMETHODCALLTYPE Add(__RPC__in_opt IFolderAction *
                                        Action) = 0;
  ...
  virtual HRESULT STDMETHODCALLTYPE CreateFolderAction(
      /* [retval][out] */ __RPC__deref_out_opt IFolderAction *
      *FolderAction) = 0;
};
...
typedef struct IFolderActionCollectionVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IFolderActionCollection *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IFolderActionCollection *This);
  ...
  HRESULT(STDMETHODCALLTYPE *Add)(__RPC__in IFolderActionCollection *This,
                                  __RPC__in_opt IFolderAction *Action);

  DECLSPEC_XFGVIRT(IFolderActionCollection, Remove)
  HRESULT(STDMETHODCALLTYPE *Remove)(__RPC__in IFolderActionCollection *This,
                                     VARIANT Index);

  DECLSPEC_XFGVIRT(IFolderActionCollection, Clear)
  HRESULT(STDMETHODCALLTYPE *Clear)(__RPC__in IFolderActionCollection *This);
...
#define IFolderActionCollection_GetIDsOfNames(This, riid, rgszNames, cNames,   \
                                              lcid, rgDispId)                  \
  ((This)->lpVtbl->GetIDsOfNames(This, riid, rgszNames, cNames, lcid, rgDispId))

#define IFolderActionCollection_Invoke(This, dispIdMember, riid, lcid, wFlags, \
                                       pDispParams, pVarResult, pExcepInfo,    \
                                       puArgErr)                               \
  ((This)->lpVtbl->Invoke(This, dispIdMember, riid, lcid, wFlags, pDispParams, \
                          pVarResult, pExcepInfo, puArgErr))
...
typedef struct IDataCollectorVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in IDataCollector *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IDataCollector *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IDataCollector *This);
  ...
  /* [restricted][hidden][propput] */ HRESULT(
      STDMETHODCALLTYPE *put_DataCollectorSet)(
      __RPC__in IDataCollector *This,
...
interface IDataCollector { CONST_VTBL struct IDataCollectorVtbl *lpVtbl; };
...
#define IDataCollector_GetIDsOfNames(This, riid, rgszNames, cNames, lcid,      \
                                     rgDispId)                                 \
  ((This)->lpVtbl->GetIDsOfNames(This, riid, rgszNames, cNames, lcid, rgDispId))

#define IDataCollector_Invoke(This, dispIdMember, riid, lcid, wFlags,          \
                              pDispParams, pVarResult, pExcepInfo, puArgErr)   \
  ((This)->lpVtbl->Invoke(This, dispIdMember, riid, lcid, wFlags, pDispParams, \
                          pVarResult, pExcepInfo, puArgErr))
...
#define IPerformanceCounterDataCollector_GetTypeInfo(This, iTInfo, lcid,       \
                                                     ppTInfo)                  \
  ((This)->lpVtbl->GetTypeInfo(This, iTInfo, lcid, ppTInfo))

#define IPerformanceCounterDataCollector_GetIDsOfNames(This, riid, rgszNames,  \
                                                       cNames, lcid, rgDispId) \
  ((This)->lpVtbl->GetIDsOfNames(This, riid, rgszNames, cNames, lcid, rgDispId))

#define IPerformanceCounterDataCollector_Invoke(                               \
...
#define IPerformanceCounterDataCollector_get_FileNameFormatPattern(This,       \
                                                                   pattern)    \
  ((This)->lpVtbl->get_FileNameFormatPattern(This, pattern))

#define IPerformanceCounterDataCollector_put_FileNameFormatPattern(This,       \
                                                                   pattern)    \
  ((This)->lpVtbl->put_FileNameFormatPattern(This, pattern))
...
#define IPerformanceCounterDataCollector_CreateOutputLocation(This, Latest,    \
                                                              Location)        \
  ((This)->lpVtbl->CreateOutputLocation(This, Latest, Location))
...
#define IPerformanceCounterDataCollector_get_PerformanceCounters(This,         \
                                                                 counters)     \
  ((This)->lpVtbl->get_PerformanceCounters(This, counters))

#define IPerformanceCounterDataCollector_put_PerformanceCounters(This,         \
                                                                 counters)     \
...
public:
  ...
  virtual /* [propget] */ HRESULT STDMETHODCALLTYPE get_TraceDataProviders(
      /* [retval][out] */ __RPC__deref_out_opt ITraceDataProviderCollection *
      *providers) = 0;
};
...
typedef struct ITraceDataCollectorVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in ITraceDataCollector *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in ITraceDataCollector *This);
  ...
  /* [restricted][hidden][propput] */ HRESULT(
      STDMETHODCALLTYPE *put_BuffersLost)(__RPC__in ITraceDataCollector *This,
  ...
  /* [restricted][hidden][propput] */ HRESULT(
      STDMETHODCALLTYPE *put_BuffersWritten)(
      __RPC__in ITraceDataCollector *This,
      /* [in] */ unsigned long buffers);
  ...
  /* [restricted][hidden][propput] */ HRESULT(
      STDMETHODCALLTYPE *put_EventsLost)(__RPC__in ITraceDataCollector *This,
  ...
  /* [restricted][hidden][propput] */ HRESULT(
      STDMETHODCALLTYPE *put_FreeBuffers)(__RPC__in ITraceDataCollector *This,
                                          /* [in] */ unsigned long buffers);
  ...
  /* [restricted][hidden][propput] */ HRESULT(
      STDMETHODCALLTYPE *put_RealTimeBuffersLost)(
      __RPC__in ITraceDataCollector *This,
      /* [in] */ unsigned long buffers);
  ...
  /* [restricted][hidden][propput] */ HRESULT(
      STDMETHODCALLTYPE *put_SessionThreadId)(
      __RPC__in ITraceDataCollector *This,
...
#define ITraceDataCollector_GetIDsOfNames(This, riid, rgszNames, cNames, lcid, \
                                          rgDispId)                            \
  ((This)->lpVtbl->GetIDsOfNames(This, riid, rgszNames, cNames, lcid, rgDispId))

#define ITraceDataCollector_Invoke(This, dispIdMember, riid, lcid, wFlags,     \
                                   pDispParams, pVarResult, pExcepInfo,        \
                                   puArgErr)                                   \
  ((This)->lpVtbl->Invoke(This, dispIdMember, riid, lcid, wFlags, pDispParams, \
                          pVarResult, pExcepInfo, puArgErr))
...
typedef struct IConfigurationDataCollectorVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IConfigurationDataCollector *This);
...
#define IConfigurationDataCollector_GetIDsOfNames(This, riid, rgszNames,       \
                                                  cNames, lcid, rgDispId)      \
  ((This)->lpVtbl->GetIDsOfNames(This, riid, rgszNames, cNames, lcid, rgDispId))

#define IConfigurationDataCollector_Invoke(This, dispIdMember, riid, lcid,     \
...
#define IConfigurationDataCollector_CreateOutputLocation(This, Latest,         \
                                                         Location)             \
  ((This)->lpVtbl->CreateOutputLocation(This, Latest, Location))
...
typedef struct IAlertDataCollectorVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IAlertDataCollector *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IAlertDataCollector *This);
...
#define IAlertDataCollector_GetIDsOfNames(This, riid, rgszNames, cNames, lcid, \
                                          rgDispId)                            \
  ((This)->lpVtbl->GetIDsOfNames(This, riid, rgszNames, cNames, lcid, rgDispId))

#define IAlertDataCollector_Invoke(This, dispIdMember, riid, lcid, wFlags,     \
                                   pDispParams, pVarResult, pExcepInfo,        \
                                   puArgErr)                                   \
  ((This)->lpVtbl->Invoke(This, dispIdMember, riid, lcid, wFlags, pDispParams, \
                          pVarResult, pExcepInfo, puArgErr))
...
typedef struct IApiTracingDataCollectorVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IApiTracingDataCollector *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IApiTracingDataCollector *This);
...
#define IApiTracingDataCollector_GetIDsOfNames(This, riid, rgszNames, cNames,  \
                                               lcid, rgDispId)                 \
  ((This)->lpVtbl->GetIDsOfNames(This, riid, rgszNames, cNames, lcid, rgDispId))

#define IApiTracingDataCollector_Invoke(This, dispIdMember, riid, lcid,        \
                                        wFlags, pDispParams, pVarResult,       \
                                        pExcepInfo, puArgErr)                  \
  ((This)->lpVtbl->Invoke(This, dispIdMember, riid, lcid, wFlags, pDispParams, \
                          pVarResult, pExcepInfo, puArgErr))
...
public:
  ...
  virtual HRESULT STDMETHODCALLTYPE Add(__RPC__in_opt IDataCollector *
                                        collector) = 0;

  virtual HRESULT STDMETHODCALLTYPE Remove(VARIANT collector) = 0;
  ...
  virtual HRESULT STDMETHODCALLTYPE CreateDataCollectorFromXml(
      ...
      /* [retval][out] */ __RPC__deref_out_opt IDataCollector *
          *pCollector) = 0;
...
typedef struct IDataCollectorCollectionVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IDataCollectorCollection *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IDataCollectorCollection *This);
  ...
  HRESULT(STDMETHODCALLTYPE *Add)(__RPC__in IDataCollectorCollection *This,
                                  __RPC__in_opt IDataCollector *collector);

  DECLSPEC_XFGVIRT(IDataCollectorCollection, Remove)
  HRESULT(STDMETHODCALLTYPE *Remove)(__RPC__in IDataCollectorCollection *This,
                                     VARIANT collector);

  DECLSPEC_XFGVIRT(IDataCollectorCollection, Clear)
  HRESULT(STDMETHODCALLTYPE *Clear)(__RPC__in IDataCollectorCollection *This);
...
#define IDataCollectorCollection_GetIDsOfNames(This, riid, rgszNames, cNames,  \
                                               lcid, rgDispId)                 \
  ((This)->lpVtbl->GetIDsOfNames(This, riid, rgszNames, cNames, lcid, rgDispId))

#define IDataCollectorCollection_Invoke(This, dispIdMember, riid, lcid,        \
                                        wFlags, pDispParams, pVarResult,       \
                                        pExcepInfo, puArgErr)                  \
  ((This)->lpVtbl->Invoke(This, dispIdMember, riid, lcid, wFlags, pDispParams, \
                          pVarResult, pExcepInfo, puArgErr))
...
#define IDataCollectorCollection_CreateDataCollectorFromXml(                   \
    This, bstrXml, pValidation, pCollector)                                    \
  ((This)->lpVtbl->CreateDataCollectorFromXml(This, bstrXml, pValidation,      \
                                              pCollector))
...
public:
  ...
  virtual HRESULT STDMETHODCALLTYPE Add(__RPC__in_opt IDataCollectorSet *
                                        set) = 0;

  virtual HRESULT STDMETHODCALLTYPE Remove(VARIANT set) = 0;
...
typedef struct IDataCollectorSetCollectionVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IDataCollectorSetCollection *This);
  ...
  HRESULT(STDMETHODCALLTYPE *Add)(__RPC__in IDataCollectorSetCollection *This,
                                  __RPC__in_opt IDataCollectorSet *set);

  DECLSPEC_XFGVIRT(IDataCollectorSetCollection, Remove)
  HRESULT(STDMETHODCALLTYPE *Remove)(
      __RPC__in IDataCollectorSetCollection *This, VARIANT set);
...
#define IDataCollectorSetCollection_GetIDsOfNames(This, riid, rgszNames,       \
                                                  cNames, lcid, rgDispId)      \
  ((This)->lpVtbl->GetIDsOfNames(This, riid, rgszNames, cNames, lcid, rgDispId))

#define IDataCollectorSetCollection_Invoke(This, dispIdMember, riid, lcid,     \
                                           wFlags, pDispParams, pVarResult,    \
                                           pExcepInfo, puArgErr)               \
  ((This)->lpVtbl->Invoke(This, dispIdMember, riid, lcid, wFlags, pDispParams, \
                          pVarResult, pExcepInfo, puArgErr))
...
typedef struct ITraceDataProviderVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in ITraceDataProvider *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in ITraceDataProvider *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in ITraceDataProvider *This);
  ...
  HRESULT(STDMETHODCALLTYPE *SetSecurity)(__RPC__in ITraceDataProvider *This,
...
#define ITraceDataProvider_GetIDsOfNames(This, riid, rgszNames, cNames, lcid,  \
                                         rgDispId)                             \
  ((This)->lpVtbl->GetIDsOfNames(This, riid, rgszNames, cNames, lcid, rgDispId))

#define ITraceDataProvider_Invoke(This, dispIdMember, riid, lcid, wFlags,      \
                                  pDispParams, pVarResult, pExcepInfo,         \
                                  puArgErr)                                    \
  ((This)->lpVtbl->Invoke(This, dispIdMember, riid, lcid, wFlags, pDispParams, \
                          pVarResult, pExcepInfo, puArgErr))
...
public:
  ...
  virtual /* [id][propget] */ HRESULT STDMETHODCALLTYPE get_Item(
      /* [in] */ VARIANT index,
      /* [retval][out] */ __RPC__deref_out_opt ITraceDataProvider *
          *ppProvider) = 0;

  virtual /* [id][propget] */ HRESULT STDMETHODCALLTYPE get__NewEnum(
      /* [retval][out] */ __RPC__deref_out_opt IUnknown * *retVal) = 0;

  virtual HRESULT STDMETHODCALLTYPE Add(__RPC__in_opt ITraceDataProvider *
                                        pProvider) = 0;

  virtual HRESULT STDMETHODCALLTYPE Remove(VARIANT vProvider) = 0;
...
typedef struct ITraceDataProviderCollectionVtbl {
  ...
  HRESULT(STDMETHODCALLTYPE *Add)(__RPC__in ITraceDataProviderCollection *This,
                                  __RPC__in_opt ITraceDataProvider *pProvider);

  DECLSPEC_XFGVIRT(ITraceDataProviderCollection, Remove)
  HRESULT(STDMETHODCALLTYPE *Remove)(
      __RPC__in ITraceDataProviderCollection *This, VARIANT vProvider);
...
#define ITraceDataProviderCollection_GetIDsOfNames(This, riid, rgszNames,      \
                                                   cNames, lcid, rgDispId)     \
  ((This)->lpVtbl->GetIDsOfNames(This, riid, rgszNames, cNames, lcid, rgDispId))

#define ITraceDataProviderCollection_Invoke(This, dispIdMember, riid, lcid,    \
                                            wFlags, pDispParams, pVarResult,   \
                                            pExcepInfo, puArgErr)              \
  ((This)->lpVtbl->Invoke(This, dispIdMember, riid, lcid, wFlags, pDispParams, \
                          pVarResult, pExcepInfo, puArgErr))
...
#define ITraceDataProviderCollection_GetTraceDataProvidersByProcess(           \
    This, Server, Pid)                                                         \
...
typedef struct IScheduleVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in ISchedule *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in ISchedule *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in ISchedule *This);
...
interface ISchedule { CONST_VTBL struct IScheduleVtbl *lpVtbl; };
...
#define ISchedule_Invoke(This, dispIdMember, riid, lcid, wFlags, pDispParams,  \
                         pVarResult, pExcepInfo, puArgErr)                     \
  ((This)->lpVtbl->Invoke(This, dispIdMember, riid, lcid, wFlags, pDispParams, \
                          pVarResult, pExcepInfo, puArgErr))
...
public:
  ...
  virtual HRESULT STDMETHODCALLTYPE Add(__RPC__in_opt ISchedule *
                                        pSchedule) = 0;

  virtual HRESULT STDMETHODCALLTYPE Remove(VARIANT vSchedule) = 0;

  virtual HRESULT STDMETHODCALLTYPE Clear(void) = 0;

  virtual HRESULT STDMETHODCALLTYPE AddRange(__RPC__in_opt IScheduleCollection *
                                             pSchedules) = 0;
...
typedef struct IScheduleCollectionVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IScheduleCollection *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IScheduleCollection *This);
  ...
  HRESULT(STDMETHODCALLTYPE *Add)(__RPC__in IScheduleCollection *This,
                                  __RPC__in_opt ISchedule *pSchedule);

  DECLSPEC_XFGVIRT(IScheduleCollection, Remove)
  HRESULT(STDMETHODCALLTYPE *Remove)(__RPC__in IScheduleCollection *This,
                                     VARIANT vSchedule);

  DECLSPEC_XFGVIRT(IScheduleCollection, Clear)
  HRESULT(STDMETHODCALLTYPE *Clear)(__RPC__in IScheduleCollection *This);
...
#define IScheduleCollection_GetIDsOfNames(This, riid, rgszNames, cNames, lcid, \
                                          rgDispId)                            \
  ((This)->lpVtbl->GetIDsOfNames(This, riid, rgszNames, cNames, lcid, rgDispId))

#define IScheduleCollection_Invoke(This, dispIdMember, riid, lcid, wFlags,     \
                                   pDispParams, pVarResult, pExcepInfo,        \
                                   puArgErr)                                   \
  ((This)->lpVtbl->Invoke(This, dispIdMember, riid, lcid, wFlags, pDispParams, \
                          pVarResult, pExcepInfo, puArgErr))
...
typedef struct IValueMapItemVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in IValueMapItem *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IValueMapItem *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IValueMapItem *This);
...
interface IValueMapItem { CONST_VTBL struct IValueMapItemVtbl *lpVtbl; };
...
#define IValueMapItem_GetIDsOfNames(This, riid, rgszNames, cNames, lcid,       \
                                    rgDispId)                                  \
  ((This)->lpVtbl->GetIDsOfNames(This, riid, rgszNames, cNames, lcid, rgDispId))

#define IValueMapItem_Invoke(This, dispIdMember, riid, lcid, wFlags,           \
                             pDispParams, pVarResult, pExcepInfo, puArgErr)    \
  ((This)->lpVtbl->Invoke(This, dispIdMember, riid, lcid, wFlags, pDispParams, \
                          pVarResult, pExcepInfo, puArgErr))
...
public:
  ...
  virtual HRESULT STDMETHODCALLTYPE Add(VARIANT value) = 0;

  virtual HRESULT STDMETHODCALLTYPE Remove(VARIANT value) = 0;

  virtual HRESULT STDMETHODCALLTYPE Clear(void) = 0;

  virtual HRESULT STDMETHODCALLTYPE AddRange(__RPC__in_opt IValueMap * map) = 0;
...
typedef struct IValueMapVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in IValueMap *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IValueMap *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IValueMap *This);
  ...
  HRESULT(STDMETHODCALLTYPE *Add)(__RPC__in IValueMap *This, VARIANT value);

  DECLSPEC_XFGVIRT(IValueMap, Remove)
  HRESULT(STDMETHODCALLTYPE *Remove)(__RPC__in IValueMap *This, VARIANT value);

  DECLSPEC_XFGVIRT(IValueMap, Clear)
  HRESULT(STDMETHODCALLTYPE *Clear)(__RPC__in IValueMap *This);

  DECLSPEC_XFGVIRT(IValueMap, AddRange)
  HRESULT(STDMETHODCALLTYPE *AddRange)(__RPC__in IValueMap *This,
...
interface IValueMap { CONST_VTBL struct IValueMapVtbl *lpVtbl; };
...
#define IValueMap_Invoke(This, dispIdMember, riid, lcid, wFlags, pDispParams,  \
                         pVarResult, pExcepInfo, puArgErr)                     \
  ((This)->lpVtbl->Invoke(This, dispIdMember, riid, lcid, wFlags, pDispParams, \
                          pVarResult, pExcepInfo, puArgErr))
...
class DECLSPEC_UUID("03837521-098b-11d8-9414-505054503030") DataCollectorSet;
#endif
...
class DECLSPEC_UUID("0383751c-098b-11d8-9414-505054503030") TraceSession;
#endif
...
class DECLSPEC_UUID("03837513-098b-11d8-9414-505054503030") TraceDataProvider;
#endif
...
class DECLSPEC_UUID("03837528-098b-11d8-9414-505054503030") LegacyTraceSession;
#endif
...
class DECLSPEC_UUID("03837538-098b-11d8-9414-505054503030") BootTraceSession;
#endif
