...
typedef interface AsyncIFtpAuthenticationProvider
...
/* [uuid] */ struct DECLSPEC_UUID("9e04226f-e38c-419e-a448-62de3b3a8f43")
    CONFIGURATION_ENTRY {
  BSTR bstrKey;
  BSTR bstrValue;
};
...
typedef struct IFtpProviderConstructVtbl {
  ...
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IFtpProviderConstruct *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IFtpProviderConstruct *This);
...
typedef struct IFtpAuthenticationProviderVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IFtpAuthenticationProvider *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IFtpAuthenticationProvider *This);
...
#define IFtpAuthenticationProvider_AuthenticateUser(                           \
    This, pszSessionId, pszSiteName, pszUserName, pszPassword,                 \
    ppszCanonicalUserName, pfAuthenticated)                                    \
  ((This)->lpVtbl->AuthenticateUser(This, pszSessionId, pszSiteName,           \
...
#define AsyncIFtpAuthenticationProvider_Begin_AuthenticateUser(                \
    This, pszSessionId, pszSiteName, pszUserName, pszPassword)                 \
  ((This)->lpVtbl->Begin_AuthenticateUser(This, pszSessionId, pszSiteName,     \
                                          pszUserName, pszPassword))

#define AsyncIFtpAuthenticationProvider_Finish_AuthenticateUser(               \
    This, ppszCanonicalUserName, pfAuthenticated)                              \
  ((This)->lpVtbl->Finish_AuthenticateUser(This, ppszCanonicalUserName,        \
                                           pfAuthenticated))
...
typedef struct IFtpRoleProviderVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in IFtpRoleProvider *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IFtpRoleProvider *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IFtpRoleProvider *This);
...
interface IFtpRoleProvider { CONST_VTBL struct IFtpRoleProviderVtbl *lpVtbl; };
...
#define IFtpRoleProvider_IsUserInRole(This, pszSessionId, pszSiteName,         \
                                      pszUserName, pszRole, pfIsInRole)        \
  ((This)->lpVtbl->IsUserInRole(This, pszSessionId, pszSiteName, pszUserName,  \
                                pszRole, pfIsInRole))
...
typedef struct AsyncIFtpRoleProviderVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in AsyncIFtpRoleProvider *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in AsyncIFtpRoleProvider *This);
...
#define AsyncIFtpRoleProvider_Begin_IsUserInRole(                              \
    This, pszSessionId, pszSiteName, pszUserName, pszRole)                     \
  ((This)->lpVtbl->Begin_IsUserInRole(This, pszSessionId, pszSiteName,         \
                                      pszUserName, pszRole))
...
typedef struct IFtpHomeDirectoryProviderVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IFtpHomeDirectoryProvider *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IFtpHomeDirectoryProvider *This);
...
#define IFtpHomeDirectoryProvider_GetUserHomeDirectoryData(                    \
    This, pszSessionId, pszSiteName, pszUserName, ppszHomeDirectoryData)       \
  ((This)->lpVtbl->GetUserHomeDirectoryData(                                   \
      This, pszSessionId, pszSiteName, pszUserName, ppszHomeDirectoryData))
...
typedef struct AsyncIFtpHomeDirectoryProviderVtbl {
  ...
  DECLSPEC_XFGVIRT(AsyncIFtpHomeDirectoryProvider,
...
#define AsyncIFtpHomeDirectoryProvider_Begin_GetUserHomeDirectoryData(         \
    This, pszSessionId, pszSiteName, pszUserName)                              \
  ((This)->lpVtbl->Begin_GetUserHomeDirectoryData(This, pszSessionId,          \
                                                  pszSiteName, pszUserName))

#define AsyncIFtpHomeDirectoryProvider_Finish_GetUserHomeDirectoryData(        \
    This, ppszHomeDirectoryData)                                               \
...
/* [uuid] */ struct DECLSPEC_UUID("6c678262-fc37-406e-84e8-e9c6a5757cdc")
    LOGGING_PARAMETERS {
...
public:
  virtual HRESULT STDMETHODCALLTYPE Log(
      /* [in] */ __RPC__in const struct LOGGING_PARAMETERS
          *pLoggingParameters) = 0;
};
...
typedef struct IFtpLogProviderVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in IFtpLogProvider *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IFtpLogProvider *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IFtpLogProvider *This);
...
interface IFtpLogProvider { CONST_VTBL struct IFtpLogProviderVtbl *lpVtbl; };
...
typedef struct AsyncIFtpLogProviderVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in AsyncIFtpLogProvider *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in AsyncIFtpLogProvider *This);
  ...
  HRESULT(STDMETHODCALLTYPE *Finish_Log)(__RPC__in AsyncIFtpLogProvider *This);
...
typedef struct IFtpAuthorizationProviderVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IFtpAuthorizationProvider *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IFtpAuthorizationProvider *This);
...
#define IFtpAuthorizationProvider_AddRef(This) ((This)->lpVtbl->AddRef(This))

#define IFtpAuthorizationProvider_Release(This) ((This)->lpVtbl->Release(This))

#define IFtpAuthorizationProvider_GetUserAccessPermission(                     \
    This, pszSessionId, pszSiteName, pszVirtualPath, pszUserName, pFtpAccess)  \
  ((This)->lpVtbl->GetUserAccessPermission(This, pszSessionId, pszSiteName,    \
                                           pszVirtualPath, pszUserName,        \
                                           pFtpAccess))
...
typedef struct AsyncIFtpAuthorizationProviderVtbl {
  ...
  DECLSPEC_XFGVIRT(AsyncIFtpAuthorizationProvider,
...
#define AsyncIFtpAuthorizationProvider_Begin_GetUserAccessPermission(          \
    This, pszSessionId, pszSiteName, pszVirtualPath, pszUserName)              \
  ((This)->lpVtbl->Begin_GetUserAccessPermission(                              \
      This, pszSessionId, pszSiteName, pszVirtualPath, pszUserName))

#define AsyncIFtpAuthorizationProvider_Finish_GetUserAccessPermission(         \
    This, pFtpAccess)                                                          \
...
typedef /* [v1_enum][uuid] */ DECLSPEC_UUID(
    "e95e698b-7505-4e49-8fb1-cb06dc26c096") enum _FTP_PROCESS_STATUS {
...
/* [uuid] */ struct DECLSPEC_UUID("07c3d591-cead-4702-abab-a70886af38a3")
...
public:
  virtual HRESULT STDMETHODCALLTYPE HandlePreprocess(
      /* [in] */ __RPC__in const struct PRE_PROCESS_PARAMETERS
...
typedef struct IFtpPreprocessProviderVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IFtpPreprocessProvider *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IFtpPreprocessProvider *This);
...
#define IFtpPreprocessProvider_AddRef(This) ((This)->lpVtbl->AddRef(This))

#define IFtpPreprocessProvider_Release(This) ((This)->lpVtbl->Release(This))

#define IFtpPreprocessProvider_HandlePreprocess(This, pPreProcessParameters,   \
                                                pFtpProcessStatus)             \
  ((This)->lpVtbl->HandlePreprocess(This, pPreProcessParameters,               \
                                    pFtpProcessStatus))
...
public:
  virtual HRESULT STDMETHODCALLTYPE Begin_HandlePreprocess(
      /* [in] */ __RPC__in const struct PRE_PROCESS_PARAMETERS
          *pPreProcessParameters) = 0;

  virtual HRESULT STDMETHODCALLTYPE Finish_HandlePreprocess(
      /* [retval][out] */ __RPC__out FTP_PROCESS_STATUS *
      pFtpProcessStatus) = 0;
};
...
typedef struct AsyncIFtpPreprocessProviderVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in AsyncIFtpPreprocessProvider *This);
...
#define AsyncIFtpPreprocessProvider_AddRef(This) ((This)->lpVtbl->AddRef(This))

#define AsyncIFtpPreprocessProvider_Release(This)                              \
  ((This)->lpVtbl->Release(This))

#define AsyncIFtpPreprocessProvider_Begin_HandlePreprocess(                    \
    This, pPreProcessParameters)                                               \
  ((This)->lpVtbl->Begin_HandlePreprocess(This, pPreProcessParameters))

#define AsyncIFtpPreprocessProvider_Finish_HandlePreprocess(This,              \
                                                            pFtpProcessStatus) \
...
/* [uuid] */ struct DECLSPEC_UUID("53337595-9165-4a8b-a202-7d5dbf7e4b8b")
...
public:
  virtual HRESULT STDMETHODCALLTYPE HandlePostprocess(
      /* [in] */ __RPC__in const struct POST_PROCESS_PARAMETERS
...
typedef struct IFtpPostprocessProviderVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IFtpPostprocessProvider *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IFtpPostprocessProvider *This);
...
#define IFtpPostprocessProvider_AddRef(This) ((This)->lpVtbl->AddRef(This))

#define IFtpPostprocessProvider_Release(This) ((This)->lpVtbl->Release(This))

#define IFtpPostprocessProvider_HandlePostprocess(                             \
    This, pPostProcessParameters, pFtpProcessStatus)                           \
  ((This)->lpVtbl->HandlePostprocess(This, pPostProcessParameters,             \
                                     pFtpProcessStatus))
...
#define AsyncIFtpPostprocessProvider_AddRef(This) ((This)->lpVtbl->AddRef(This))

#define AsyncIFtpPostprocessProvider_Release(This)                             \
  ((This)->lpVtbl->Release(This))

#define AsyncIFtpPostprocessProvider_Begin_HandlePostprocess(                  \
    This, pPostProcessParameters)                                              \
  ((This)->lpVtbl->Begin_HandlePostprocess(This, pPostProcessParameters))

#define AsyncIFtpPostprocessProvider_Finish_HandlePostprocess(                 \
    This, pFtpProcessStatus)                                                   \
...
class DECLSPEC_UUID("70bdc667-33b2-45f0-ac52-c3ca46f7a656") FtpProvider;
#endif
