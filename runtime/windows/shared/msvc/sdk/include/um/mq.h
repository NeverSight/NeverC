...
typedef enum tagMQConnectionState {
  MQCONN_NOFAILURE = 0, // connection is in the process of establishment, no
                        // failures have occured
  MQCONN_ESTABLISH_PACKET_RECEIVED, // NATIVE SESSION ONLY: connection
                                    // establishment packed has been received

  MQCONN_READY, // connection has been successfully established	and is ready to
                // send messages
  ...
  MQCONN_CREATE_SOCKET_FAILURE, // these 4 states represent failure to establish
                                // TCP connection on 1801
  ...
  MQCONN_INVALID_SERVER_CERT, // could not validate server certificate in https
                              // scenario
  MQCONN_LIMIT_REACHED, // connection limit reached, can't establish new session
                        // to a specific destination
  MQCONN_REFUSED_BY_OTHER_SIDE, // connection refused by other side due to any
                                // reason(quota, invalid packet, connection
                                // limit reached)
  MQCONN_ROUTING_FAILURE,       // absense of DS connectivity prevented getting
                                // routing data
  MQCONN_OUT_OF_MEMORY, // failure due to low memory (e.g. bad_alloc exception
...
#define MQ_LOOKUP_RECEIVE_ALLOW_PEEK                                           \
  0x40000120 // TBD: exact value of this constant
#endif

//
// MQSendMessage,  MQReceiveMessage:  special cases for the transaction
// parameter
//
...
#define PROPID_M_XACT_STATUS_QUEUE_LEN                                         \
  (PROPID_M_BASE + 40)                                  /* VT_UI4           */
...
#define PROPID_M_RESP_FORMAT_NAME_LEN                                          \
  (PROPID_M_BASE + 55)                                 /* VT_UI4           */
#define PROPID_M_DEST_FORMAT_NAME (PROPID_M_BASE + 58) /* VT_LPWSTR        */
#define PROPID_M_DEST_FORMAT_NAME_LEN                                          \
  (PROPID_M_BASE + 59)                                  /* VT_UI4           */
...
#define PROPID_M_COMPOUND_MESSAGE_SIZE                                         \
  (PROPID_M_BASE + 64)                                 /* VT_UI4           */
...
#define PROPID_M_DEADLETTER_QUEUE_LEN                                          \
  (PROPID_M_BASE + 68)                               /* VT_UI4           */
...
//
//  The requested crypto provider for encryption is not supported by the
//  destination.
//
...
//
// The message was sent by downlevel machines (earlier than msmq4) and the
// message size with the subqueue and IPV6 headers exceeded the max message size
//
...
//
//  Time to receive has expired while the message was still in its destination
//  queue (generated by destination)
//
#define MQMSG_CLASS_NACK_RECEIVE_TIMEOUT MQCLASS_CODE(1, 1, 0x02)

//
//  Time to receive has expired while the message was still in its local
//  outgoing queue (generated locally by sender)
//
#define MQMSG_CLASS_NACK_RECEIVE_TIMEOUT_AT_SENDER MQCLASS_CODE(1, 1, 0x03)

//
// Message was rejected by a receiving application (by calling MQMarkRejected
// API)
//
...
#define PROPID_QM_ENCRYPTION_PK_BASE                                           \
  (PROPID_QM_BASE + 31) /* VT_UI1|VT_VECTOR  */
#define PROPID_QM_ENCRYPTION_PK_ENHANCED                                       \
  (PROPID_QM_BASE + 32)                              /* VT_UI1|VT_VECTOR  */
#define PROPID_QM_PATHNAME_DNS (PROPID_QM_BASE + 33) /* VT_LPWSTR         */
#define PROPID_QM_ENCRYPTION_PK_AES                                            \
  (PROPID_QM_BASE + 44) /* VT_UI1|VT_VECTOR  */
...
#define PROPID_MGMT_MSMQ_ACTIVEQUEUES                                          \
  (PROPID_MGMT_MSMQ_BASE + 1) /* VT_LPWSTR | VT_VECTOR  */
#define PROPID_MGMT_MSMQ_PRIVATEQ                                              \
  (PROPID_MGMT_MSMQ_BASE + 2) /* VT_LPWSTR | VT_VECTOR  */
...
#define PROPID_MGMT_MSMQ_BYTES_IN_ALL_QUEUES                                   \
  (PROPID_MGMT_QUEUE_BASE + 6) /* VT_UI8    */
...
#define PROPID_MGMT_QUEUE_PATHNAME                                             \
  (PROPID_MGMT_QUEUE_BASE + 1) /* VT_LPWSTR                                    \
                                */
#define PROPID_MGMT_QUEUE_FORMATNAME                                           \
  (PROPID_MGMT_QUEUE_BASE + 2)                              /* VT_LPWSTR */
#define PROPID_MGMT_QUEUE_TYPE (PROPID_MGMT_QUEUE_BASE + 3) /* VT_LPWSTR */
#define PROPID_MGMT_QUEUE_LOCATION                                             \
  (PROPID_MGMT_QUEUE_BASE + 4)                                 /* VT_LPWSTR    \
                                                                */
...
#define PROPID_MGMT_QUEUE_MESSAGE_COUNT                                        \
  (PROPID_MGMT_QUEUE_BASE + 7) /* VT_UI4    */
#define PROPID_MGMT_QUEUE_BYTES_IN_QUEUE                                       \
  (PROPID_MGMT_QUEUE_BASE + 8) /* VT_UI4    */
#define PROPID_MGMT_QUEUE_JOURNAL_MESSAGE_COUNT                                \
  (PROPID_MGMT_QUEUE_BASE + 9) /* VT_UI4    */
#define PROPID_MGMT_QUEUE_BYTES_IN_JOURNAL                                     \
  (PROPID_MGMT_QUEUE_BASE + 10)                               /* VT_UI4    */
#define PROPID_MGMT_QUEUE_STATE (PROPID_MGMT_QUEUE_BASE + 11) /* VT_LPWSTR */
#define PROPID_MGMT_QUEUE_NEXTHOPS                                             \
  (PROPID_MGMT_QUEUE_BASE + 12) /* VT_LPWSTR|VT_VECTOR  */
#define PROPID_MGMT_QUEUE_EOD_LAST_ACK                                         \
  (PROPID_MGMT_QUEUE_BASE + 13) /* VT_BLOB   */
#define PROPID_MGMT_QUEUE_EOD_LAST_ACK_TIME                                    \
  (PROPID_MGMT_QUEUE_BASE + 14) /* VT_I4     */
#define PROPID_MGMT_QUEUE_EOD_LAST_ACK_COUNT                                   \
  (PROPID_MGMT_QUEUE_BASE + 15) /* VT_UI4    */
#define PROPID_MGMT_QUEUE_EOD_FIRST_NON_ACK                                    \
  (PROPID_MGMT_QUEUE_BASE + 16) /* VT_BLOB   */
#define PROPID_MGMT_QUEUE_EOD_LAST_NON_ACK                                     \
  (PROPID_MGMT_QUEUE_BASE + 17) /* VT_BLOB   */
#define PROPID_MGMT_QUEUE_EOD_NEXT_SEQ                                         \
  (PROPID_MGMT_QUEUE_BASE + 18) /* VT_BLOB   */
#define PROPID_MGMT_QUEUE_EOD_NO_READ_COUNT                                    \
  (PROPID_MGMT_QUEUE_BASE + 19) /* VT_UI4    */
#define PROPID_MGMT_QUEUE_EOD_NO_ACK_COUNT                                     \
  (PROPID_MGMT_QUEUE_BASE + 20) /* VT_UI4    */
#define PROPID_MGMT_QUEUE_EOD_RESEND_TIME                                      \
  (PROPID_MGMT_QUEUE_BASE + 21) /* VT_I4     */
#define PROPID_MGMT_QUEUE_EOD_RESEND_INTERVAL                                  \
  (PROPID_MGMT_QUEUE_BASE + 22) /* VT_UI4    */
#define PROPID_MGMT_QUEUE_EOD_RESEND_COUNT                                     \
  (PROPID_MGMT_QUEUE_BASE + 23) /* VT_UI4    */
#define PROPID_MGMT_QUEUE_EOD_SOURCE_INFO                                      \
  (PROPID_MGMT_QUEUE_BASE + 24) /* VT_VARIANT|VT_VECTOR */
#define PROPID_MGMT_QUEUE_CONNECTION_HISTORY                                   \
  (PROPID_MGMT_QUEUE_BASE + 25) /* VT_BLOB | VT_VECTOR */
#define PROPID_MGMT_QUEUE_SUBQUEUE_COUNT                                       \
  (PROPID_MGMT_QUEUE_BASE + 26) /* VT_UI4 */
#define PROPID_MGMT_QUEUE_SUBQUEUE_NAMES                                       \
  (PROPID_MGMT_QUEUE_BASE + 27) /* VT_LPWSTR|VT_VECTOR  */
...
// MessageText:
//
// One or more of the properties passed resulted in a warning, but the function
// completed.
//
...
// MessageText:
//
// The queue owner was not set during the processing of this call to
// MQSetQueueSecurity().
//
...
// MessageText:
//
// There is a sharing violation. The queue is already open for exclusive
// retrieval.
//
...
// MessageText:
//
// The sort operation specified in MQLocateBegin is invalid (for example, there
...
// MessageText:
//
// The MQ_ACTION_PEEK_NEXT value specified for MQReceiveMessage cannot be used
...
// MessageText:
//
// Operations of the type requested (for example, deleting a queue using a
// direct format name) are not supported for the format name specified.
//
...
// MessageText:
//
// The client does not have sufficient security privileges to perform the
// operation.
//
...
// MessageText:
//
// The request failed because the user buffer is too small to hold the
...
// MessageText:
//
// A recoverable or journal message could not be stored. The message was not
// sent.
//
...
// MessageText:
//
// The size of the buffer for the message identifier or correlation identifier
// is invalid.
//
...
// MessageText:
//
// Either the pointer to the MQQUEUEPROPS structure has a null value, or no
...
// MessageText:
//
// The property identifier specified (for example, PROPID_Q_INSTANCE in
// MQSetQueueProperties) is invalid for the operation requested.
//
...
// MessageText:
//
// Either the pointer to the MQQMROPS structure has a null value, or no
// properties are specified in it.
//
...
// MessageText:
//
// A connection cannot be established with the Distributed Transaction
// Coordinator.
//
...
// MessageText:
//
// The connector type message property is not specified. This property is
// required for sending an acknowledgment message or a secure message.
//
...
// MessageText:
//
// The Message Queuing service was restarted. Any open queue handles should be
// closed.
//
...
// MessageText:
//
// The message label is too long. Its length should be less than or equal to
...
// MessageText:
//
// Obsolete; another MQIS server is being installed. Write operations to the
...
// MessageText:
//
// Independent clients cannot support dependent clients. A Message Queuing
// server is required.
//
...
// MessageText:
//
// The file %1 for the queue %2 in the Lqs folder was deleted because it was
// corrupted.
//
...
// MessageText:
//
// This operation is not supported for Message Queuing installed in workgroup
// mode.
//
...
// MessageText:
//
// The computer joined the domain, but Message Queuing will continue to run in
// workgroup mode because it failed to register itself in Active Directory
// Domain Services.
//
...
// MessageText:
//
// The parameters in MQPRIVATEPROPS are invalid. Either the pointer to the
// MQPRIVATEPROPS structure has a null value, or no properties are specified in
// it.
//
...
// MessageText:
//
// The object that will be deleted is owned by a primary site controller. The
...
// MessageText:
//
// There is no MSMQ Users organizational unit object in Active Directory Domain
// Services for the domain. Please create one manually.
//
...
// For example, you cannot set both PROPID_M_RESP_QUEUE and
// PROPID_M_RESP_FORMAT_NAME when sending a message.
//
...
// MessageText:
//
// The sites where the computer resides cannot be resolved. Check that the
// subnets in your network are configured correctly in Active Directory Domain
...
// MessageText:
//
// This operation is not supported by the remote Message Queuing service. For
// example, MQReceiveMessageByLookupId is not supported by MSMQ 1.0/2.0.
//
...
// MessageText:
//
// The object whose properties are being retrieved from Active Directory Domain
// Services does not belong to the class requested.
//
...
// MessageText:
//
// The value of cCol in MQSORTSET cannot be greater than 1. Active Directory
// Domain Services supports only a single sort key.
//
...
// By default, an Active Directory Domain Services forest does not support
// adding an object with a supplied GUID.
//
...
// MessageText:
//
// Binding to the forest root failed. This error usually indicates a problem in
...
// MessageText:
//
// A local user is authenticated as an anonymous user and cannot access Active
// Directory Domain Services. You need to log on as a domain user to access
...
// MessageText:
//
// The Active Directory Domain Services object specified is not an instance of a
// supported class.
//
...
// MessageText:
//
// The object that will be created should be owned by a primary site controller.
...
// MessageText:
//
// The object that will be updated is owned by a primary site controller. The
// operation cannot be performed.
//
...
// MessageText:
//
// Message Queuing is not able to resolve the address specified by the user. The
// address may be wrong or DNS look-up for address failed.
//
...
// MessageText:
//
// Too many properties passed to the function. Message Queuing can process up to
// 128 properties in one call.
//
...
// MessageText:
//
// The message is currently being processed under a transaction. Till the
// transaction outcome is determined, the message cannot be processed in any
// other transaction.
//
...
typedef VOID(APIENTRY *PMQRECEIVECALLBACK)(
    HRESULT hrStatus, QUEUEHANDLE hSource, DWORD dwTimeout, DWORD dwAction,
    MQMSGPROPS *pMessageProps, LPOVERLAPPED lpOverlapped, HANDLE hCursor);
...
HRESULT
APIENTRY
MQCreateQueue(_In_opt_ PSECURITY_DESCRIPTOR pSecurityDescriptor,
...
HRESULT
APIENTRY
MQDeleteQueue(_In_ LPCWSTR lpwcsFormatName);

HRESULT
APIENTRY
MQLocateBegin(_In_opt_ LPCWSTR lpwcsContext,
              _In_opt_ MQRESTRICTION *pRestriction, _In_ MQCOLUMNSET *pColumns,
              _In_ MQSORTSET *pSort, _Out_ PHANDLE phEnum);

HRESULT
APIENTRY
MQLocateNext(_In_ HANDLE hEnum, _Inout_ DWORD *pcProps,
             _Out_ MQPROPVARIANT aPropVar[]);

HRESULT
APIENTRY
MQLocateEnd(_In_ HANDLE hEnum);

HRESULT
APIENTRY
MQOpenQueue(_In_ LPCWSTR lpwcsFormatName, _In_ DWORD dwAccess,
            _In_ DWORD dwShareMode, _Out_ QUEUEHANDLE *phQueue);

HRESULT
APIENTRY
MQSendMessage(_In_ QUEUEHANDLE hDestinationQueue,
              _In_ MQMSGPROPS *pMessageProps,
              _In_opt_ ITransaction *pTransaction);

HRESULT
APIENTRY
MQReceiveMessage(_In_ QUEUEHANDLE hSource, _In_ DWORD dwTimeout,
                 _In_ DWORD dwAction, _Inout_opt_ MQMSGPROPS *pMessageProps,
                 _Inout_opt_ LPOVERLAPPED lpOverlapped,
                 _In_opt_ PMQRECEIVECALLBACK fnReceiveCallback,
                 _In_opt_ HANDLE hCursor, _In_opt_ ITransaction *pTransaction);

#if (_WIN32_WINNT >= 0x0501)

HRESULT
APIENTRY
MQReceiveMessageByLookupId(_In_ QUEUEHANDLE hSource, _In_ ULONGLONG ullLookupId,
...
HRESULT
APIENTRY
MQCreateCursor(_In_ QUEUEHANDLE hQueue, _Out_ PHANDLE phCursor);

HRESULT
APIENTRY
MQCloseCursor(_In_ HANDLE hCursor);

HRESULT
APIENTRY
MQCloseQueue(_In_ QUEUEHANDLE hQueue);

HRESULT
APIENTRY
MQSetQueueProperties(_In_ LPCWSTR lpwcsFormatName,
                     _Inout_ MQQUEUEPROPS *pQueueProps);

HRESULT
APIENTRY
MQGetQueueProperties(_In_ LPCWSTR lpwcsFormatName,
                     _Inout_ MQQUEUEPROPS *pQueueProps);

HRESULT
APIENTRY
MQGetQueueSecurity(_In_ LPCWSTR lpwcsFormatName,
                   _In_ SECURITY_INFORMATION RequestedInformation,
                   _Out_writes_bytes_(nLength)
                       PSECURITY_DESCRIPTOR pSecurityDescriptor,
                   _In_ DWORD nLength, _Out_ LPDWORD lpnLengthNeeded);

HRESULT
APIENTRY
MQSetQueueSecurity(_In_ LPCWSTR lpwcsFormatName,
                   _In_ SECURITY_INFORMATION SecurityInformation,
                   _In_opt_ PSECURITY_DESCRIPTOR pSecurityDescriptor);

HRESULT
APIENTRY
MQPathNameToFormatName(_In_ LPCWSTR lpwcsPathName,
                       _Out_writes_(*lpdwFormatNameLength)
                           LPWSTR lpwcsFormatName,
                       _Inout_ LPDWORD lpdwFormatNameLength);

HRESULT
APIENTRY
MQHandleToFormatName(_In_ QUEUEHANDLE hQueue,
                     _Out_writes_(*lpdwFormatNameLength) LPWSTR lpwcsFormatName,
                     _Inout_ LPDWORD lpdwFormatNameLength);

HRESULT
APIENTRY
MQInstanceToFormatName(_In_ GUID *pGuid,
                       _Out_writes_(*lpdwFormatNameLength)
                           LPWSTR lpwcsFormatName,
                       _Inout_ LPDWORD lpdwFormatNameLength);
...
HRESULT
APIENTRY
MQADsPathToFormatName(_In_ LPCWSTR lpwcsADsPath,
                      _Out_writes_(*lpdwFormatNameLength)
                          LPWSTR lpwcsFormatName,
                      _Inout_ LPDWORD lpdwFormatNameLength);
...
VOID APIENTRY MQFreeMemory(_In_ PVOID pvMemory);

HRESULT
APIENTRY
MQGetMachineProperties(_In_opt_ LPCWSTR lpwcsMachineName,
                       _In_opt_ const GUID *pguidMachineId,
                       _Inout_ MQQMPROPS *pQMProps);

HRESULT
APIENTRY
MQGetSecurityContext(_In_reads_bytes_opt_(dwCertBufferLength)
                         PVOID lpCertBuffer,
...
HRESULT
APIENTRY
MQGetSecurityContextEx(_In_reads_bytes_opt_(dwCertBufferLength)
                           PVOID lpCertBuffer,
                       _In_ DWORD dwCertBufferLength,
                       _Out_ HANDLE *phSecurityContext);

VOID APIENTRY MQFreeSecurityContext(_In_ HANDLE hSecurityContext);

HRESULT
APIENTRY
MQRegisterCertificate(_In_ DWORD dwFlags, _In_ PVOID lpCertBuffer,
                      _In_ DWORD dwCertBufferLength);

HRESULT
APIENTRY
MQBeginTransaction(_Out_ ITransaction **ppTransaction);

HRESULT
APIENTRY
MQGetOverlappedResult(_In_ LPOVERLAPPED lpOverlapped);

HRESULT
APIENTRY
MQGetPrivateComputerInformation(_In_opt_ LPCWSTR lpwcsComputerName,
                                _Inout_ MQPRIVATEPROPS *pPrivateProps);

HRESULT
APIENTRY
MQPurgeQueue(_In_ QUEUEHANDLE hQueue);

HRESULT
APIENTRY
MQMgmtGetInfo(_In_opt_ LPCWSTR pComputerName, _In_ LPCWSTR pObjectName,
              _Inout_ MQMGMTPROPS *pMgmtProps);

HRESULT
APIENTRY
MQMgmtAction(_In_opt_ LPCWSTR pComputerName, _In_ LPCWSTR pObjectName,
             _In_ LPCWSTR pAction);

HRESULT
APIENTRY
MQMarkMessageRejected(_In_ HANDLE hQueue, _In_ ULONGLONG ullLookupId);

HRESULT
APIENTRY
MQMoveMessage(_In_ QUEUEHANDLE hSourceQueue, _In_ QUEUEHANDLE hDestinationQueue,
              _In_ ULONGLONG ullLookupId, _In_opt_ ITransaction *pTransaction);
