...
STDAPI CreateResourceIndexer(_In_ PCWSTR projectRoot,
...
STDAPI IndexFilePath(_In_ PVOID resourceIndexer, _In_ PCWSTR filePath,
                     _Outptr_ PWSTR *ppResourceUri,
                     _Out_ ULONG *pQualifierCount,
                     _Out_writes_(*pQualifierCount)
                         IndexedResourceQualifier **ppQualifiers);

void DestroyIndexedResults(_In_opt_ PWSTR resourceUri,
                           _In_ ULONG qualifierCount,
                           _In_reads_opt_(qualifierCount)
