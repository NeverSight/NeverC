...
public:
  ...
  virtual /* [helpstring][id] */ HRESULT STDMETHODCALLTYPE GetWMIObject(
      /* [retval][out] */ __RPC__deref_out_opt ISWbemObject *
      *objWMIObject) = 0;

  virtual /* [helpstring][id] */ HRESULT STDMETHODCALLTYPE GetWMIServices(
      /* [retval][out] */ __RPC__deref_out_opt ISWbemServices *
      *objWMIServices) = 0;
};
...
typedef struct IWMIExtensionVtbl {
  ...
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in IWMIExtension *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IWMIExtension *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IWMIExtension *This);
...
interface IWMIExtension { CONST_VTBL struct IWMIExtensionVtbl *lpVtbl; };
