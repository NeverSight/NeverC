...
#define SIPAEVENT_TRUSTBOUNDARY                                                \
  (SIPAEVENTTYPE_AGGREGATION + SIPAEVENTTYPE_CONTAINER + 0x0001)
#define SIPAEVENT_ELAM_AGGREGATION                                             \
  (SIPAEVENTTYPE_AGGREGATION + SIPAEVENTTYPE_CONTAINER + 0x0002)
#define SIPAEVENT_LOADEDMODULE_AGGREGATION                                     \
  (SIPAEVENTTYPE_AGGREGATION + SIPAEVENTTYPE_CONTAINER + 0x0003)
#define SIPAEVENT_TRUSTPOINT_AGGREGATION                                       \
  (SIPAEVENTTYPE_NONMEASURED + SIPAEVENTTYPE_AGGREGATION +                     \
   SIPAEVENTTYPE_CONTAINER + 0x0004)

#if NTDDI_VERSION >= NTDDI_WIN10_RS3

#define SIPAEVENT_KSR_AGGREGATION                                              \
  (SIPAEVENTTYPE_AGGREGATION + SIPAEVENTTYPE_CONTAINER + 0x0005)

#define SIPAEVENT_KSR_SIGNED_MEASUREMENT_AGGREGATION                           \
  (SIPAEVENTTYPE_AGGREGATION + SIPAEVENTTYPE_CONTAINER + 0x0006)

#endif // NTDDI_VERSION >= NTDDI_WIN10_RS3

// SIPAEVENTTYPE_ERROR
#define SIPAERROR_FIRMWAREFAILURE (SIPAEVENTTYPE_ERROR + 0x0001)
#define SIPAERROR_TPMFAILURE                                                   \
  (SIPAEVENTTYPE_NONMEASURED + SIPAEVENTTYPE_ERROR + 0x0002)
#define SIPAERROR_INTERNALFAILURE (SIPAEVENTTYPE_ERROR + 0x0003)
#if NTDDI_VERSION >= NTDDI_WIN10_RS3

#define SIPAERROR_KSRFAILURE                                                   \
...
#define SIPAERROR_HYPERVISORFAILURE (SIPAEVENTTYPE_ERROR + 0x0005)

#endif // NTDDI_VERSION >= NTDDI_WIN11_GE

// SIPAEVENTTYPE_INFORMATION
#define SIPAEVENT_INFORMATION (SIPAEVENTTYPE_INFORMATION + 0x0001)
#define SIPAEVENT_BOOTCOUNTER (SIPAEVENTTYPE_INFORMATION + 0x0002)
#define SIPAEVENT_TRANSFER_CONTROL (SIPAEVENTTYPE_INFORMATION + 0x0003)
#define SIPAEVENT_APPLICATION_RETURN (SIPAEVENTTYPE_INFORMATION + 0x0004)
#define SIPAEVENT_BITLOCKER_UNLOCK (SIPAEVENTTYPE_INFORMATION + 0x0005)
#define SIPAEVENT_EVENTCOUNTER (SIPAEVENTTYPE_INFORMATION + 0x0006)
#define SIPAEVENT_COUNTERID (SIPAEVENTTYPE_INFORMATION + 0x0007)
...
//     - IDK_PROVISIONING_TYPE_VTPM (1) - Skips caching logic and generates new
//     IDKS on boot
#define SIPAEVENT_IDK_GENERATION_STATUS (SIPAEVENTTYPE_INFORMATION + 0x000C)
...
//
#define SIPAEVENT_MORBIT_API_STATUS (SIPAEVENTTYPE_INFORMATION + 0x000B)

// SIPAEVENTTYPE_PREOSPARAMETER
#define SIPAEVENT_BOOTDEBUGGING (SIPAEVENTTYPE_PREOSPARAMETER + 0x0001)
...
#define SIPAEVENT_OSKERNELDEBUG (SIPAEVENTTYPE_OSPARAMETER + 0x0001)
#define SIPAEVENT_CODEINTEGRITY (SIPAEVENTTYPE_OSPARAMETER + 0x0002)
#define SIPAEVENT_TESTSIGNING (SIPAEVENTTYPE_OSPARAMETER + 0x0003)
#define SIPAEVENT_DATAEXECUTIONPREVENTION (SIPAEVENTTYPE_OSPARAMETER + 0x0004)
#define SIPAEVENT_SAFEMODE (SIPAEVENTTYPE_OSPARAMETER + 0x0005)
#define SIPAEVENT_WINPE (SIPAEVENTTYPE_OSPARAMETER + 0x0006)
#define SIPAEVENT_PHYSICALADDRESSEXTENSION (SIPAEVENTTYPE_OSPARAMETER + 0x0007)
#define SIPAEVENT_OSDEVICE (SIPAEVENTTYPE_OSPARAMETER + 0x0008)
#define SIPAEVENT_SYSTEMROOT (SIPAEVENTTYPE_OSPARAMETER + 0x0009)
#define SIPAEVENT_HYPERVISOR_LAUNCH_TYPE (SIPAEVENTTYPE_OSPARAMETER + 0x000A)
#define SIPAEVENT_HYPERVISOR_PATH (SIPAEVENTTYPE_OSPARAMETER + 0x000B)
#define SIPAEVENT_HYPERVISOR_IOMMU_POLICY (SIPAEVENTTYPE_OSPARAMETER + 0x000C)
#define SIPAEVENT_HYPERVISOR_DEBUG (SIPAEVENTTYPE_OSPARAMETER + 0x000D)

#define SIPAEVENT_DRIVER_LOAD_POLICY (SIPAEVENTTYPE_OSPARAMETER + 0x000E)
...
#define SIPAEVENT_HYPERVISOR_MSR_FILTER_POLICY                                 \
  (SIPAEVENTTYPE_OSPARAMETER + 0x0011)
...
#define SIPAEVENT_SMT_STATUS (SIPAEVENTTYPE_OSPARAMETER + 0x0014)
...
#define SIPAEVENT_FLIGHTSIGNING (SIPAEVENTTYPE_OSPARAMETER + 0x0021)

#define SIPAEVENT_PAGEFILE_ENCRYPTION_ENABLED                                  \
  (SIPAEVENTTYPE_OSPARAMETER + 0x0022)

//
// Describes the VSM/IUM identity signing public key.
//
#define SIPAEVENT_VSM_IDKS_INFO (SIPAEVENTTYPE_OSPARAMETER + 0x0023)

//
// Indicates the setting to disable hibernation.
//
#define SIPAEVENT_HIBERNATION_DISABLED (SIPAEVENTTYPE_OSPARAMETER + 0x0024)

//
// Indicates the setting by Guarded Host to disable crash dumps.
//
#define SIPAEVENT_DUMPS_DISABLED (SIPAEVENTTYPE_OSPARAMETER + 0x0025)

//
// Indicates the setting by Guarded Host to disable crash dumps.
//
#define SIPAEVENT_DUMP_ENCRYPTION_ENABLED (SIPAEVENTTYPE_OSPARAMETER + 0x0026)

//
// The data portion for this event is a SHA-256 digest of thefollowing regkey
// value:
// CurrentControlSet\Control\CrashControl\EncryptionCertificates\Certificate.1::PublicKey.
//
#define SIPAEVENT_DUMP_ENCRYPTION_KEY_DIGEST                                   \
  (SIPAEVENTTYPE_OSPARAMETER + 0x0027)
...
//
// The data portion for this event is a single DWORD carrying the LSA_ISO_*
// flags as read from the corresponding UEFI variable ("Kernel_Lsa_Cfg_Flags")
// or from the LsaIso configuration in the registry. This event is only recorded
// if the LsaIso configuration can be found in at least one of these 2 places.
//
#define SIPAEVENT_LSAISO_CONFIG (SIPAEVENTTYPE_OSPARAMETER + 0x0028)
...
//
// This event contains certain details of the active Secure Boot Custom Policy
// (SBCP). The data portion for this event is an instance of
// SIPAEVENT_SBCP_INFO_PAYLOAD_V* structure.
//
#define SIPAEVENT_SBCP_INFO (SIPAEVENTTYPE_OSPARAMETER + 0x0029)
...
//
// This event contains certain details of whether boot DMA protection is
// enabled. The data portion for this event is a BOOLEAN indicating the status
// of boot DMA protection.
//
#define SIPAEVENT_HYPERVISOR_BOOT_DMA_PROTECTION                               \
  (SIPAEVENTTYPE_OSPARAMETER + 0x0030)
...
//
#define SIPAEVENT_SI_POLICY_SIGNER (SIPAEVENTTYPE_OSPARAMETER + 0x0031)

#define SIPAEVENT_SI_POLICY_UPDATE_SIGNER (SIPAEVENTTYPE_OSPARAMETER + 0x0032)

#endif // NTDDI_VERSION >= NTDDI_WIN11_GA

#if NTDDI_VERSION >= NTDDI_WIN10_GE

#define SIPAEVENT_REFS_VOLUME_CHECKPOINT_RECORD_CHECKSUM                       \
  (SIPAEVENTTYPE_OSPARAMETER + 0x0033)

#define SIPAEVENT_REFS_ROLLBACK_PROTECTION_FROZEN_VOLUME_CHECKSUM              \
  (SIPAEVENTTYPE_OSPARAMETER + 0x0034)

#define SIPAEVENT_REFS_ROLLBACK_PROTECTION_USER_PAYLOAD_HASH                   \
  (SIPAEVENTTYPE_OSPARAMETER + 0x0035)

#define SIPAEVENT_REFS_ROLLBACK_PROTECTION_VERIFICATION_SUCCEEDED              \
  (SIPAEVENTTYPE_OSPARAMETER + 0x0036)

#define SIPAEVENT_REFS_ROLLBACK_PROTECTION_VOLUME_FIRST_EVER_MOUNT             \
  (SIPAEVENTTYPE_OSPARAMETER + 0x0037)

typedef struct _SIPAEVENT_REFS_ROLLBACK_PROTECTION_USER_PAYLOAD_HASH_DATA {
  UINT16 ChecksumType;
  BYTE ChecksumBuffer[ANYSIZE_ARRAY];
} SIPAEVENT_REFS_ROLLBACK_PROTECTION_USER_PAYLOAD_HASH_DATA,
    *PSIPAEVENT_REFS_ROLLBACK_PROTECTION_USER_PAYLOAD_HASH_DATA;
...
#define SIPAEVENT_VSM_SEALED_SI_POLICY (SIPAEVENTTYPE_OSPARAMETER + 0x003A)

#define SIPAEVENT_VSM_DRTM_KEYROLL_DETECTED (SIPAEVENTTYPE_OSPARAMETER + 0x003B)
//
// This event is used in Hope Chest SRTM scenarios. It contains the
// anti-rollback UnsesalPolicy associated with sealed protector.
//
#define SIPAEVENT_VSM_SRTM_UNSEAL_POLICY (SIPAEVENTTYPE_OSPARAMETER + 0x003C)
...
// TCG log.
//
#define SIPAEVENT_VSM_SRTM_ANTI_ROLLBACK_COUNTER                               \
  (SIPAEVENTTYPE_OSPARAMETER + 0x003D)

//
// Note: 0x3D...0x39 are currently unused; new events can be added in this range
//

#define SIPAEVENT_VTL1_DUMP_CONFIG (SIPAEVENTTYPE_OSPARAMETER + 0x0040)

#endif // NTDDI_VERSION >= NTDDI_WIN11_DT

// SIPAEVENTTYPE_AUHTORITY
#define SIPAEVENT_NOAUTHORITY (SIPAEVENTTYPE_AUTHORITY + 0x0001)
#define SIPAEVENT_AUTHORITYPUBKEY (SIPAEVENTTYPE_AUTHORITY + 0x0002)

// SIPAEVENTTYPE_LOADEDIMAGE
#define SIPAEVENT_FILEPATH (SIPAEVENTTYPE_LOADEDMODULE + 0x0001)
#define SIPAEVENT_IMAGESIZE (SIPAEVENTTYPE_LOADEDMODULE + 0x0002)
#define SIPAEVENT_HASHALGORITHMID (SIPAEVENTTYPE_LOADEDMODULE + 0x0003)
#define SIPAEVENT_AUTHENTICODEHASH (SIPAEVENTTYPE_LOADEDMODULE + 0x0004)
#define SIPAEVENT_AUTHORITYISSUER (SIPAEVENTTYPE_LOADEDMODULE + 0x0005)
#define SIPAEVENT_AUTHORITYSERIAL (SIPAEVENTTYPE_LOADEDMODULE + 0x0006)
#define SIPAEVENT_IMAGEBASE (SIPAEVENTTYPE_LOADEDMODULE + 0x0007)
#define SIPAEVENT_AUTHORITYPUBLISHER (SIPAEVENTTYPE_LOADEDMODULE + 0x0008)
#define SIPAEVENT_AUTHORITYSHA1THUMBPRINT (SIPAEVENTTYPE_LOADEDMODULE + 0x0009)
#define SIPAEVENT_IMAGEVALIDATED (SIPAEVENTTYPE_LOADEDMODULE + 0x000a)
#define SIPAEVENT_MODULE_SVN (SIPAEVENTTYPE_LOADEDMODULE + 0x000b)

#if NTDDI_VERSION >= NTDDI_WIN10_NI

#define SIPAEVENT_MODULE_PLUTON (SIPAEVENTTYPE_LOADEDMODULE + 0x000c)

#endif // NTDDI_VERSION >= NTDDI_WIN10_NI

#if NTDDI_VERSION >= NTDDI_WIN10_GE

#define SIPAEVENT_MODULE_ORIGINAL_FILENAME (SIPAEVENTTYPE_LOADEDMODULE + 0x000d)

#define SIPAEVENT_MODULE_VERSION (SIPAEVENTTYPE_LOADEDMODULE + 0x000e)

#define SIPAEVENT_PUBLISHER_OEMNAME (SIPAEVENTTYPE_LOADEDMODULE + 0x000f)
#endif // NTDDI_VERSION >= NTDDI_WIN10_GE

// SIPAEVENTTYPE_TRUSTPOINT
#define SIPAEVENT_QUOTE                                                        \
  (SIPAEVENTTYPE_NONMEASURED + SIPAEVENTTYPE_TRUSTPOINT + 0x0001)
#define SIPAEVENT_QUOTESIGNATURE                                               \
  (SIPAEVENTTYPE_NONMEASURED + SIPAEVENTTYPE_TRUSTPOINT + 0x0002)
#define SIPAEVENT_AIKID                                                        \
  (SIPAEVENTTYPE_NONMEASURED + SIPAEVENTTYPE_TRUSTPOINT + 0x0003)
#define SIPAEVENT_AIKPUBDIGEST                                                 \
  (SIPAEVENTTYPE_NONMEASURED + SIPAEVENTTYPE_TRUSTPOINT + 0x0004)

// SIPAEVENTTYPE_ELAM
#define SIPAEVENT_ELAM_KEYNAME (SIPAEVENTTYPE_ELAM + 0x0001)
#define SIPAEVENT_ELAM_CONFIGURATION (SIPAEVENTTYPE_ELAM + 0x0002)
#define SIPAEVENT_ELAM_POLICY (SIPAEVENTTYPE_ELAM + 0x0003)
#define SIPAEVENT_ELAM_MEASURED (SIPAEVENTTYPE_ELAM + 0x0004)
...
#define SIPAEVENT_VBS_DUMP_USES_AMEROOT (SIPAEVENTTYPE_VBS + 0x009)

#if NTDDI_VERSION >= NTDDI_WIN10_VB

#define SIPAEVENT_VBS_VSM_NOSECRETS_ENFORCED (SIPAEVENTTYPE_VBS + 0x00A)
...
// SIPAEVENTTYPE_KSR
#define SIPAEVENT_KSR_SIGNATURE (SIPAEVENTTYPE_KSR + 0x001)
...
//
// The payload for this event is an instance of
// TPM_API_PA_DIRECT_AUTHORIZATION_1 containing a signature over a TPM policy
// matching the system state at the time of launching TcbLaunch.exe. A typical
// TPM policy for validating DRTM state contains a combination of the MLE
// measurement in PCR 18, a state of PCR[22] and a proper value for the DRTM
// SVN.
//
#define SIPAEVENT_DRTM_STATE_AUTH (SIPAEVENTTYPE_DRTM + 0x001)
...
// This event is measured to PCR[20] during DRTM by TcbLaunch.exe.
//
// The payload for this event is a single byte of data containing one of the
// values from the SI_DRTM_SMM_LEVEL enumeration.
//

#define SIPAEVENT_DRTM_SMM_LEVEL (SIPAEVENTTYPE_DRTM + 0x002)
...
#define SIPAEVENT_DRTM_AMD_SMM_HASH (SIPAEVENTTYPE_DRTM + 0x003)
...
#define SIPAEVENT_DRTM_AMD_SMM_SIGNER_KEY (SIPAEVENTTYPE_DRTM + 0x004)
...
typedef struct _WBCL_Iterator {
  ...
  // points to the table in the header that contains the mapping of algorithm
  // ids to digest sizes.
  PVOID digestSizes;
  ...
  // Hash algorithm ID used for the log. The value corresponds to one of the
  // TPM 2.0 ALG_ID values.
...
HRESULT
WbclApiDetectSipaHashAlgID(_In_bytecount_(logSize) PVOID pLogBuffer,
                           _In_ UINT32 logSize, _Out_ UINT16 *algID);

HRESULT
WbclApiSetPreferredHashAlgID(_In_ UINT16 algID,
                             _Out_ WBCL_Iterator *pWbclIterator);

HRESULT
WbclApiInitIterator(_In_bytecount_(logSize) PVOID pLogBuffer,
                    _In_ UINT32 logSize, _Out_ WBCL_Iterator *pWbclIterator);

HRESULT
WbclApiGetCurrentElement(
    _In_ WBCL_Iterator *pWbclIterator, _Out_ UINT32 *pcrIndex,
...
HRESULT
WbclApiMoveToNextElement(_In_ WBCL_Iterator *pWbclIterator);
...
typedef struct _TCG_PCClientPCREventStruct {
  ...
  _Field_size_bytes_(eventDataSize) BYTE event[1];
...
typedef struct _TCG_PCClientTaggedEventStruct {
  ...
  _Field_size_bytes_(EventDataSize) BYTE EventData[ANYSIZE_ARRAY];
...
typedef struct tag_SIPAEVENT_VSM_IDK_INFO_PAYLOAD {
  //
  // Specifies the algorithm used for IDK. Should be one of VSM_IDK_ALG_ID
  // values.
  //
  ULONG32 KeyAlgID;
...
typedef struct tag_SIPAEVENT_SI_POLICY_PAYLOAD {
  ...
  //
  // Indicates the length (in bytes) of the policy name stored as part of
  // VarLengthData.
  //
  ...
  //
  // Indicates the hash digest length (in bytes). Digest is stored as part of
  // VarLengthData.
  //
  UINT32 DigestLength;
  ...
  //
  _Field_size_bytes_(PolicyNameLength +
                     DigestLength) BYTE VarLengthData[ANYSIZE_ARRAY];
...
typedef struct tag_SIPAEVENT_SI_POLICY_CERTIFICATE_PAYLOAD {
  ...
  //
  // Indicates hash algorithm ID used to produce the certificate's ToBeSigned
  // digest in CAPI ALG_ID format.
  //
  UINT32 HashAlgID;
  ...
  // BYTE Digest[DigestLength]
  //
  _Field_size_bytes_(PublisherCommonNameLength + IssuerCommonNameLength +
                     DigestLength) BYTE VarLengthData[ANYSIZE_ARRAY];

} SIPAEVENT_SI_POLICY_CERTIFICATE_PAYLOAD,
    *PSIPAEVENT_SI_POLICY_CERTIFICATE_PAYLOAD;
...
typedef struct tag_SIPAEVENT_SI_POLICY_SIGNER_PAYLOAD {
  //
  // The root certificate ID. Contains one of the MINCRYPT_KNOWN_ROOT_ID values
  // which are also documented at
  // https://learn.microsoft.com/en-us/windows/security/application-security/application-control/windows-defender-application-control/operations/event-tag-explanations
  //
  UINT32 RootID;

  //
  // Indicates the length (in bytes) of all
  // SIPAEVENT_SI_POLICY_CERTIFICATE_PAYLOAD structures.
  //
  ...
  //
  // Indicates the length (in bytes) of the policy name stored as part of
  // VarLengthData. This is the same name as the corresponding
  // SIPAEVENT_SI_POLICY_PAYLOAD PolicyName.
  //
  UINT16 PolicyNameLength;
  ...
  //
  _Field_size_bytes_(PolicyNameLength + EKUsLength +
                     CertificatesLength) BYTE VarLengthData[ANYSIZE_ARRAY];
...
typedef struct tag_SIPAEVENT_REVOCATION_LIST_PAYLOAD {
  ...
  //
  _Field_size_bytes_(DigestLength) BYTE Digest[ANYSIZE_ARRAY];
...
typedef struct tag_SIPAEVENT_KSR_SIGNATURE_PAYLOAD {
  ...
  // Aggregation
  //
  _Field_size_bytes_(SignatureLength) BYTE Signature[ANYSIZE_ARRAY];
...
typedef struct tag_SIPAEVENT_SBCP_INFO_PAYLOAD_V1 {
  ...
  // VarData.
  //
  _Field_range_(1, 64) UINT16 DigestLength;
  ...
  // BYTE Digest[DigestLength]
  //
  _Field_size_bytes_(DigestLength) BYTE VarData[ANYSIZE_ARRAY];
