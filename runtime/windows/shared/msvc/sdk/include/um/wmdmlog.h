...
public:
  ...
  virtual HRESULT STDMETHODCALLTYPE GetLogFileName(
      /* [max_is][string][out] */ __RPC__out_ecount_full_string((256 + 1))
          LPSTR pszFilename,
...
typedef struct IWMDMLoggerVtbl {
  ...
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in IWMDMLogger *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IWMDMLogger *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IWMDMLogger *This);

  DECLSPEC_XFGVIRT(IWMDMLogger, IsEnabled)
  HRESULT(STDMETHODCALLTYPE *IsEnabled)(__RPC__in IWMDMLogger *This,
                                        /* [out] */ __RPC__out BOOL *pfEnabled);

  DECLSPEC_XFGVIRT(IWMDMLogger, Enable)
  HRESULT(STDMETHODCALLTYPE *Enable)(__RPC__in IWMDMLogger *This,
                                     /* [in] */ BOOL fEnable);
  ...
  HRESULT(STDMETHODCALLTYPE *Reset)(__RPC__in IWMDMLogger *This);
  ...
  HRESULT(STDMETHODCALLTYPE *SetSizeParams)(__RPC__in IWMDMLogger *This,
                                            /* [in] */ DWORD dwMaxSize,
...
interface IWMDMLogger { CONST_VTBL struct IWMDMLoggerVtbl *lpVtbl; };
...
class DECLSPEC_UUID("110A3202-5A79-11d3-8D78-444553540000") WMDMLogger;
#endif
