...
/* These values are used in the "syntax" member of the smiVALUE structure which
 * follows */
...
#define SNMPLISTEN_ALL_ADDR                                                    \
  1 /*Use any address based on address family and port no*/
...
HSNMP_SESSION SNMPAPI_CALL SnmpCreateSession(IN HWND hWnd, IN UINT wMsg,
...
SNMPAPI_STATUS SNMPAPI_CALL SnmpListenEx(IN HSNMP_ENTITY hEntity,
                                         IN SNMPAPI_STATUS lStatus,
...
SNMPAPI_STATUS SNMPAPI_CALL SnmpStartupEx(OUT smiLPUINT32 nMajorVersion,
                                          OUT smiLPUINT32 nMinorVersion,
                                          OUT smiLPUINT32 nLevel,
                                          OUT smiLPUINT32 nTranslateMode,
                                          OUT smiLPUINT32 nRetransmitMode);
typedef SNMPAPI_STATUS(SNMPAPI_CALL *PFNSNMPSTARTUPEX)(smiLPUINT32, smiLPUINT32,
...
SNMPAPI_STATUS SNMPAPI_CALL SnmpEntityToStr(_In_ HSNMP_ENTITY entity,
                                            _In_ smiUINT32 size,
...
HSNMP_PDU SNMPAPI_CALL SnmpCreatePdu(IN HSNMP_SESSION session,
                                     IN smiINT PDU_type, IN smiINT32 request_id,
...
HSNMP_VBL SNMPAPI_CALL SnmpCreateVbl(IN HSNMP_SESSION session,
                                     IN smiLPCOID name, IN smiLPCVALUE value);
...
SNMPAPI_STATUS SNMPAPI_CALL SnmpGetVb(IN HSNMP_VBL vbl, IN smiUINT32 index,
                                      OUT smiLPOID name, OUT smiLPVALUE value);

SNMPAPI_STATUS SNMPAPI_CALL SnmpSetVb(IN HSNMP_VBL vbl, IN smiUINT32 index,
                                      IN smiLPCOID name, IN smiLPCVALUE value);
...
SNMPAPI_STATUS SNMPAPI_CALL SnmpOidToStr(_In_ smiLPCOID srcOID,
                                         _In_ smiUINT32 size,
                                         _Out_writes_(size) LPSTR string);
...
SNMPAPI_STATUS SNMPAPI_CALL SnmpOidCompare(IN smiLPCOID xOID, IN smiLPCOID yOID,
                                           IN smiUINT32 maxlen,
                                           OUT smiLPINT result);
