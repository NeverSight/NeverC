...
typedef struct ILogVtbl {
  ...
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in ILog *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in ILog *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in ILog *This);

  DECLSPEC_XFGVIRT(ILog, Force)
  HRESULT(STDMETHODCALLTYPE *Force)(__RPC__in ILog *This,
  ...
  HRESULT(STDMETHODCALLTYPE *TruncatePrefix)(__RPC__in ILog *This,
...
interface ILog { CONST_VTBL struct ILogVtbl *lpVtbl; };
...
#define ILog_ReadRecord(This, lsnToRead, plsnPrev, plsnNext, ppbData, pcbData) \
  ((This)->lpVtbl->ReadRecord(This, lsnToRead, plsnPrev, plsnNext, ppbData,    \
                              pcbData))

#define ILog_ReadRecordPrefix(This, lsnToRead, plsnPrev, plsnNext, pbData,     \
                              pcbData, pcbRecord)                              \
  ((This)->lpVtbl->ReadRecordPrefix(This, lsnToRead, plsnPrev, plsnNext,       \
                                    pbData, pcbData, pcbRecord))
...
typedef struct IFileBasedLogInitVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in IFileBasedLogInit *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IFileBasedLogInit *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IFileBasedLogInit *This);

  DECLSPEC_XFGVIRT(IFileBasedLogInit, InitNew)
  HRESULT(STDMETHODCALLTYPE *InitNew)(__RPC__in IFileBasedLogInit *This,
                                      /* [in] */ __RPC__in LPCWSTR filename,
