...
STDAPI InstantiateComponentFromPackage(_In_ HSTRING classId,
                                       _In_ HSTRING packageFullName,
                                       _COM_Outptr_ IInspectable **instance);
STDAPI RegisterServerForPMP(_In_ HSTRING serverClassId,
                            _In_ IClassFactory *classFactory,
                            _Out_ LPVOID *token);
STDAPI UnregisterServerForPMP(_In_ LPVOID token);
STDAPI GetServerForPMP(_In_ HSTRING serverClassId,
                       _COM_Outptr_ IUnknown **unknown);

STDAPI AreDvdCodecsEnabled();
STDAPI RequireNetworkDuringMediaTaskCompletion(_In_ BOOL requireNetwork,
                                               _Out_opt_ DWORD *requireCount);
...
STDAPI GetMediaComponentPackageInfo(
    _In_ bool trustedOnly, _In_ HSTRING category,
    _COM_Outptr_ ABI::Windows::Foundation::Collections::IVector<
        ABI::Windows::Foundation::Collections::IPropertySet *> *
        *codecPropertiesVector);
#if (NTDDI_VERSION >= NTDDI_WIN11_GA)
STDAPI GetSystemNativeProcessorSignature(_Out_ DWORD *processorSignature);
#endif // NTDDI_VERSION >= NTDDI_WIN11_GA

#if (NTDDI_VERSION >= NTDDI_WIN11_GE)
STDAPI GetDefaultContentDecryptionModuleFactory(
    _In_ PCWSTR keySystem,
    _Outptr_result_maybenull_ IMFContentDecryptionModuleFactory *
...
// MEDIA_BEHAVIOR_MEDIAPLAYBACKLIST_AUTOPLAYBACKITEMRESET
// {45B17027-E16C-4F23-A62B-B37146B2C964}
EXTERN_GUID(MEDIA_BEHAVIOR_MEDIAPLAYBACKLIST_AUTOPLAYBACKITEMRESET, 0x45b17027,
            0xe16c, 0x4f23, 0xa6, 0x2b, 0xb3, 0x71, 0x46, 0xb2, 0xc9, 0x64);
