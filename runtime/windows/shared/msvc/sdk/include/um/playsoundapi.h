...
WINMMAPI
BOOL WINAPI sndPlaySoundA(_In_opt_ LPCSTR pszSound, _In_ UINT fuSound);

WINMMAPI
BOOL WINAPI sndPlaySoundW(_In_opt_ LPCWSTR pszSound, _In_ UINT fuSound);
...
#endif                         /* WINVER >= 0x0400 */
#define SND_SENTRY                                                             \
  0x00080000L /* Generate a SoundSentry event with this sound */
#define SND_RING                                                               \
  0x00100000L /* Treat this as a "ring" from a communications app - don't duck \
                 me */
...
WINMMAPI
BOOL WINAPI PlaySoundA(_In_opt_ LPCSTR pszSound, _In_opt_ HMODULE hmod,
                       _In_ DWORD fdwSound);

WINMMAPI
BOOL WINAPI PlaySoundW(_In_opt_ LPCWSTR pszSound, _In_opt_ HMODULE hmod,
                       _In_ DWORD fdwSound);
