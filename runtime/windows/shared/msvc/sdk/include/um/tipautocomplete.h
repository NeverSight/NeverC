...
typedef struct ITipAutoCompleteProviderVtbl {
  ...
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in ITipAutoCompleteProvider *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in ITipAutoCompleteProvider *This);
...
typedef struct ITipAutoCompleteClientVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in ITipAutoCompleteClient *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in ITipAutoCompleteClient *This);
...
#define ITipAutoCompleteClient_PreferredRects(                                 \
    This, prcACList, prcField, prcModifiedACList, pfShownAboveTip)             \
  ((This)->lpVtbl->PreferredRects(This, prcACList, prcField,                   \
                                  prcModifiedACList, pfShownAboveTip))
