...
// MessageText:
//
// The namespace cannot be started because there are no clients in the
// namespace.
//
...
// MessageText:
//
// The Windows Deployment Services multicast server successfully read its
// configuration settings. The Windows Deployment Services multicast server will
// now process incoming client requests.
//
...
// Services server, which has IP %2. Use the Windows Deployment Services
// management tools to configure your multicast IP address range to avoid this
// multicast IP address. If you allow this overlap to continue, your network
...
// MessageText:
//
// The multicast IP address %1 is being used by another multicast server, which
// has IP %2. Use the Windows Deployment Services management tools to configure
// your multicast IP address range to avoid this multicast IP address. If you
// allow this overlap to continue, your network usage will be increased.
//
...
// MessageText:
//
// The Content Provider %1 is incompatible with this version of Windows
// Deployment Multicast Server. %n
//
...
// MessageText:
//
// The Content Provider %1 returned an error while trying to open a new
// instance. %n %n Configuration: %2 %n Error Information: %3 %n
//
...
// MessageText:
//
// The Content Provider %1 failed to initialize. The provider is marked as
// non-critical. WDS Multicast server will continue to start.%n %n Error
// Information: %2 %n
//
...
//
// The Content Provider %1 failed to initialize. The provider is marked as
// critical. WDS Multicast server will fail to start.%n %n Error Information: %2
// %n
//
...
// MessageText:
//
// The ScheduledCast namespace %1 using content provider %2 could not be
// registered as it starts in the past. The namespace has been removed from the
// namespace store. %n %n Error Information: %3 %n
//
...
// namespace by that name already exists. The namespace has been removed from
// the namespace store. %n %n Error Information: %3 %n
//
...
// MessageText:
//
// The client did not meet the policy requirements set by the administrator and
// was kicked from the session.
//
...
// MessageText:
//
// The client was disconnected by the administrator. The server requested that
// the client use another method to obtain the contents.
//
...
// MessageText:
//
// The client was disconnected by the administrator. An unknown reason was
// specified for disconnecting the client from the session.
//
...
//
//
// The specified WIM file requires a reference WIM such as res.rwm in order to
// be applied.
//
