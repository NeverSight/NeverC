...
extern RPC_IF_HANDLE
    __MIDL_itf_icontentprefetchertasktrigger_0000_0000_v0_0_c_ifspec;
extern RPC_IF_HANDLE
    __MIDL_itf_icontentprefetchertasktrigger_0000_0000_v0_0_s_ifspec;
...
typedef struct IContentPrefetcherTaskTriggerVtbl {
  ...
  DECLSPEC_XFGVIRT(IContentPrefetcherTaskTrigger,
                   IsRegisteredForContentPrefetch)
  /* [annotation][local] */
  _On_failure_(_Post_satisfies_(*isRegistered == false))
...
#define IContentPrefetcherTaskTrigger_TriggerContentPrefetcherTask(            \
    This, packageFullName)                                                     \
  ((This)->lpVtbl->TriggerContentPrefetcherTask(This, packageFullName))

#define IContentPrefetcherTaskTrigger_IsRegisteredForContentPrefetch(          \
    This, packageFullName, isRegistered)                                       \
  ((This)->lpVtbl->IsRegisteredForContentPrefetch(This, packageFullName,       \
                                                  isRegistered))
...
extern RPC_IF_HANDLE
    __MIDL_itf_icontentprefetchertasktrigger_0000_0001_v0_0_c_ifspec;
extern RPC_IF_HANDLE
    __MIDL_itf_icontentprefetchertasktrigger_0000_0001_v0_0_s_ifspec;
