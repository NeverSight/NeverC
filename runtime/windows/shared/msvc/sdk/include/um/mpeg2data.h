...
typedef struct IMpeg2TableFilterVtbl {
  ...
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in IMpeg2TableFilter *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IMpeg2TableFilter *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IMpeg2TableFilter *This);

  DECLSPEC_XFGVIRT(IMpeg2TableFilter, AddPID)
  HRESULT(STDMETHODCALLTYPE *AddPID)(__RPC__in IMpeg2TableFilter *This, PID p);

  DECLSPEC_XFGVIRT(IMpeg2TableFilter, AddTable)
  HRESULT(STDMETHODCALLTYPE *AddTable)(__RPC__in IMpeg2TableFilter *This, PID p,
                                       TID t);

  DECLSPEC_XFGVIRT(IMpeg2TableFilter, AddExtension)
  HRESULT(STDMETHODCALLTYPE *AddExtension)(__RPC__in IMpeg2TableFilter *This,
                                           PID p, TID t, TEID e);

  DECLSPEC_XFGVIRT(IMpeg2TableFilter, RemovePID)
  HRESULT(STDMETHODCALLTYPE *RemovePID)(__RPC__in IMpeg2TableFilter *This,
                                        PID p);

  DECLSPEC_XFGVIRT(IMpeg2TableFilter, RemoveTable)
  HRESULT(STDMETHODCALLTYPE *RemoveTable)(__RPC__in IMpeg2TableFilter *This,
                                          PID p, TID t);

  DECLSPEC_XFGVIRT(IMpeg2TableFilter, RemoveExtension)
  HRESULT(STDMETHODCALLTYPE *RemoveExtension)(__RPC__in IMpeg2TableFilter *This,
                                              PID p, TID t, TEID e);
...
typedef struct IMpeg2DataVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in IMpeg2Data *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IMpeg2Data *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IMpeg2Data *This);
...
#define IMpeg2Data_GetSection(This, pid, tid, pFilter, dwTimeout,              \
                              ppSectionList)                                   \
  ((This)->lpVtbl->GetSection(This, pid, tid, pFilter, dwTimeout,              \
                              ppSectionList))
...
public:
  ...
  virtual HRESULT STDMETHODCALLTYPE GetProgramIdentifier(__RPC__in PID *
                                                         pPid) = 0;

  virtual HRESULT STDMETHODCALLTYPE GetTableIdentifier(__RPC__in TID *
                                                       pTableId) = 0;
};
...
typedef struct ISectionListVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in ISectionList *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in ISectionList *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in ISectionList *This);
  ...
  HRESULT(STDMETHODCALLTYPE *GetProgramIdentifier)(__RPC__in ISectionList *This,
                                                   __RPC__in PID *pPid);

  DECLSPEC_XFGVIRT(ISectionList, GetTableIdentifier)
  HRESULT(STDMETHODCALLTYPE *GetTableIdentifier)(__RPC__in ISectionList *This,
...
typedef struct IMpeg2StreamVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in IMpeg2Stream *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IMpeg2Stream *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IMpeg2Stream *This);
