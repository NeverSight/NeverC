...
typedef enum IORING_OP_CODE {
  ...
  /// <summary>Requests cancellation of a previously submitted
  /// operation</summary>
  /// <remarks>
  /// This attempts to cancel a previously submitted operation. The UserData for
  /// the
...
/// <summary>Requests SubmitIoRing to wait for all operations to
/// complete</summary> <remarks> The constant value for waitOperations parameter
/// in SubmitIoRing to wait for all the entries submitted so far, to be
/// completed.
/// </remarks>
