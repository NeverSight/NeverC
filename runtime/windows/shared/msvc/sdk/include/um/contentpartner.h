...
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////
// These constants are used in the IWMPContentPartner::GetContentPartnerInfo API
// for the bstrInfoName parameter.

static const WCHAR g_szContentPartnerInfo_LoginState[] = L"LoginState";

// Synopsis: IWMPContentPartner::GetContentPartnerInfo
//              /*out parameter*/   VARIANT *pData    -> Type must be VT_BOOL,
//              indicates whether the user is logged into the services

static const WCHAR g_szContentPartnerInfo_MediaPlayerAccountType[] =
    L"MediaPlayerAccountType";

// Synopsis: IWMPContentPartner::GetContentPartnerInfo
//              /*out parameter*/   VARIANT *pData    -> Type must be VT_UI4,  -
//              Represents a WMPAccountType value, this value is interpreted by
//              the media player

static const WCHAR g_szContentPartnerInfo_AccountType[] = L"AccountType";

// Synopsis: IWMPContentPartner::GetContentPartnerInfo
//              /*out parameter*/   VARIANT *pData    -> Type must be VT_BSTR,
//              - Represents subscriptions services account type as a string
//                                                    -> This value is not
//                                                    interpreted by the media
//                                                    player, and may be shown
//                                                    to the user

static const WCHAR g_szContentPartnerInfo_HasCachedCredentials[] =
    L"HasCachedCredentials"; // VT_BOOL - Returns whether plugin has cached
                             // credentials

// Synopsis: IWMPContentPartner::GetContentPartnerInfo
//              /*out parameter*/   VARIANT *pData    -> Type must be VT_BOOL,
//              indicates whether the pluggin has cached
//                                                    -> credentials necessary
//                                                    to log in to the service

static const WCHAR g_szContentPartnerInfo_LicenseRefreshAdvanceWarning[] =
    L"LicenseRefreshAdvanceWarning";

// Synopsis: IWMPContentPartner::GetContentPartnerInfo
//              /*out parameter*/   VARIANT *pData    -> Type must be VT_UI4,
//              representing days  - This value is used by the player to
//              pre-emptively refresh licenses that will expire soon.
//                                                    -> For example, if the
//                                                    plugin can support
//                                                    refreshing a playback
//                                                    license 5 days before it
//                                                    expires, then pData->ulVal
//                                                    should be set to 5.
//                                                    -> This value is a global
//                                                    setting, and cannot be
//                                                    different for different
//                                                    licenses, users, etc.

static const WCHAR g_szContentPartnerInfo_PurchasedTrackRequiresReDownload[] =
    L"PurchasedTrackRequiresReDownload";
//              /*out parameter*/   VARIANT *pData    -> Type must be VT_BOOL,
//              represents whether a purchased track must be redownloaded if the
//              content had been previously downloaded.

static const WCHAR g_szContentPartnerInfo_MaximumTrackPurchasePerPurchase[] =
    L"MaximumNumberOfTracksPerPurchase";
//              /*out parameter*/   VARIANT *pData    -> Type must be VT_UI4,
//              indicates the maximum number of tracks that can be handled in a
//              single IWMPContentParnter::Buy call.
//                                                       0 indicates no maximum.

static const WCHAR g_szContentPartnerInfo_AccountBalance[] = L"AccountBalance";
//              /*out parameter*/   VARIANT *pData    -> Type must be VT_BSTR,
//              - Represents account balance as a string
//                                                    -> This value is not
//                                                    interpreted by the media
//                                                    player, and may be shown
//                                                    to the user
...
//              /*out parameter*/   VARIANT *pData    -> Type must be VT_BSTR,
//              - Represents user's account friendly name as a string
//                                                    -> This value is not
//                                                    interpreted by the media
//                                                    player, and may be shown
//                                                    to the user
...
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////
// These constants are returned to the HTML templates hosted in the player
// (returned from IWMPContentPartner::GetTemplate from the window.external.task
// API
...
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////
// These constants are used in the IWMPContentPartner::GetItemInfo API for the
// bstrInfoName parameter

static const WCHAR g_szItemInfo_PopupURL[] = L"Popup";

// Synopsis: IWMPContentPartner::GetItemInfo
//              /*input parameter*/ VARIANT *pContext -> Type is VT_I4,
//              indicates index of popup URL to return
//              /*out parameter*/   VARIANT *pData    -> Type must be VT_BSTR,
//              indicates URL to host in HTML based dialog

static const WCHAR g_szItemInfo_AuthenticationSuccessURL[] =
    L"AuthenticationSuccessURL";

// Synopsis: IWMPContentPartner::GetItemInfo
//              /*input parameter*/ VARIANT *pContext -> Type is VT_I4,
//              indicates index of Authentication URL to return
//              /*out parameter*/   VARIANT *pData    -> Type must be VT_BSTR,
//              indicates URL to navigate if authentication is successful

static const WCHAR g_szItemInfo_LoginFailureURL[] = L"LoginFailureURL";

// Synopsis: IWMPContentPartner::GetItemInfo
//              /*input parameter*/ VARIANT *pContext -> Type is VT_UI4,
//              indicates index of LoginFailureURL to query.  This value was
//              passed to the player via Notify( wmpcnLoginStateChange, <value
//              /*out parameter*/   VARIANT *pData    -> Type must be VT_BSTR,
//              indicates URL to navigate when loginstatechange

static const WCHAR g_szItemInfo_HTMLViewURL[] = L"HTMLViewURL";

// Synopsis: IWMPContentPartner::GetItemInfo
//              /*input parameter*/ VARIANT *pContext -> Type is VT_BSTR, this
//              is the string specified in the ASX file.  For example: <param
//              name="HTMLFLINK" value="foo" \>
//              /*out parameter*/   VARIANT *pData    -> Type must be VT_BSTR,
//              indicates URL to use for the HTMLView
...
//              indicates index of popup URL to return
//              /*out parameter*/   VARIANT *pData    -> Type must be VT_BSTR,
//              indicates caption for the HTML based dialog

static const WCHAR g_szItemInfo_ALTLoginURL[] = L"ALTLoginURL";

// Synopsis: IWMPContentPartner::GetItemInfo
//              /*input parameter*/ VARIANT *pContext -> Type is VT_EMPTY,
//              contains nothing
//              /*out parameter*/   VARIANT *pData    -> Type must be VT_BSTR,
//              indicates URL for the alternative login
...
//              contains nothing
//              /*out parameter*/   VARIANT *pData    -> Type must be VT_BSTR,
//              indicates caption for the alternative login
...
//              contains nothing
//              /*out parameter*/   VARIANT *pData    -> Type must be VT_BSTR,
//              indicates URL to navigate the service plane
//                                                    -> in the event the user
//                                                    has forgotten their
//                                                    password
...
// Synopsis: IWMPContentPartner::GetItemInfo
//              /*input parameter*/ VARIANT *pContext -> Type is VT_UI4,
//              containing the aritst ID from the catalog
//              /*out parameter*/   VARIANT *pData    -> Type must be VT_BSTR,
//              indicates URL to retrieve artist art

static const WCHAR g_szItemInfo_AlbumArtURL[] = L"AlbumArt";

// Synopsis: IWMPContentPartner::GetItemInfo
//              /*input parameter*/ VARIANT *pContext -> Type is VT_UI4,
//              containing the album ID from the catalog
//              /*out parameter*/   VARIANT *pData    -> Type must be VT_BSTR,
//              indicates URL to retrieve album art

static const WCHAR g_szItemInfo_ListArtURL[] = L"ListArt";

// Synopsis: IWMPContentPartner::GetItemInfo
//              /*input parameter*/ VARIANT *pContext -> Type is VT_UI4,
//              containing the list ID from the catalog
//              /*out parameter*/   VARIANT *pData    -> Type must be VT_BSTR,
//              indicates URL to retrieve list art

static const WCHAR g_szItemInfo_GenreArtURL[] = L"GenreArt";

// Synopsis: IWMPContentPartner::GetItemInfo
//              /*input parameter*/ VARIANT *pContext -> Type is VT_UI4,
//              containing the genre ID from the catalog
//              /*out parameter*/   VARIANT *pData    -> Type must be VT_BSTR,
//              indicates URL to retrieve genre art

static const WCHAR g_szItemInfo_SubGenreArtURL[] = L"SubGenreArt";

// Synopsis: IWMPContentPartner::GetItemInfo
//              /*input parameter*/ VARIANT *pContext -> Type is VT_UI4,
//              containing the sub-genre ID from the catalog
//              /*out parameter*/   VARIANT *pData    -> Type must be VT_BSTR,
//              indicates URL to retrieve sub-genre art

static const WCHAR g_szItemInfo_RadioArtURL[] = L"RadioArt";

// Synopsis: IWMPContentPartner::GetItemInfo
//              /*input parameter*/ VARIANT *pContext -> Type is VT_UI4,
//              containing the radio ID from the catalog
//              /*out parameter*/   VARIANT *pData    -> Type must be VT_BSTR,
//              indicates URL to retrieve radio art
...
//              containing the list ID from the catalog
//              /*out parameter*/   VARIANT *pData    -> Type must be VT_BSTR,
//              indicates URL to retrieve list icon art

static const WCHAR g_szItemInfo_ErrorDescription[] = L"CPErrorDescription";

// Synopsis: IWMPContentPartner::GetItemInfo
//              /*input parameter*/ VARIANT *pContext -> Type is VT_ERROR,
//              containing the error code
//              /*out parameter*/   VARIANT *pData    -> Type must be VT_BSTR,
//              text describing the error.
//                                                       Fail this call if you
//                                                       do not understand error
//                                                       code
...
//              containing the error code
//              /*out parameter*/   VARIANT *pData    -> Type must be VT_BSTR,
//              url that the service pane will be navigated
//                                                       to when then user
//                                                       clicks the resolve link
...
//              containing the error code
//              /*out parameter*/   VARIANT *pData    -> Type must be VT_BSTR,
//              text that will be used for the hyperlink
//                                                       text for the URL
//                                                       returned from
//                                                       g_szItemInfo_ErrorURL

///////////////////////////////////////////////////////////////////////////////////////////////////////////////////
// These constants are used in the all the IWMPContentPartner and
// IWMPContentPartnerCallback APIs that deal with some sort of location or
// object type.

static const WCHAR g_szUnknownLocation[] = L"UnknownLocation";

// Passed when the media player cannot determine a valid location to pass to the
// plugin. should rarely happen

static const WCHAR g_szRootLocation[] =
    L"RootLocation"; // Passed when the user is on the 'root' tree node of the
                     // service

// Passed when the action is taking place on the root content-partner node in
// the media player's lbrary tree

static const WCHAR g_szFlyoutMenu[] =
    L"FlyoutMenu"; // Passed when the user selects the flyout menu of the
                   // service

// Passed when the user selects the flyout menu of the service

static const WCHAR g_szOnlineStore[] =
    L"OnlineStore"; // Used to navigate the player to the online stores page in
                    // the call to IWMPContentPartnerCallback::ChangeView

static const WCHAR g_szVideoRecent[] =
    L"VideoRecent"; // Used to navigate the player to the online stores page in
                    // the call to IWMPContentPartnerCallback::ChangeView

static const WCHAR g_szVideoRoot[] =
    L"VideoRoot"; // Used to navigate the player to the online stores page in
                  // the call to IWMPContentPartnerCallback::ChangeView

// These constants are used in the all the IWMPContentPartner and
// IWMPContentPartnerCallback APIs They indicate either a location in the
// library (see IWMPContentPartner::GetTemplate) or a type being returned via a
// callback (see IWMPContentPartner::GetListContents and
...
static const WCHAR g_szAllUserEffectiveRatingStarss[] =
    L"AllUserEffectiveRatingStarss";
...
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////
// These constants are to be used by the window.external.changeViewOnlineList
// for the bstrViewMode parameter

static const WCHAR g_szViewMode_Report[] =
    L"ViewModeReport"; // Display dynamic list contents in report mode
static const WCHAR g_szViewMode_Details[] =
    L"ViewModeDetails"; // Display dynamic list contents in details mode
static const WCHAR g_szViewMode_Icon[] =
    L"ViewModeIcon"; // Display dynamic list contents in icon mode
static const WCHAR g_szViewMode_Tile[] =
    L"ViewModeTile"; // Display dynamic list contents in tile mode
static const WCHAR g_szViewMode_OrderedList[] =
    L"ViewModeOrderedList"; // Display dynamic list contents in ordered list
                            // mode

///////////////////////////////////////////////////////////////////////////////////////////////////////////////////
// These constants are used in the IWMPContentContainer APIs for detecting fixed
// pricing

static const WCHAR g_szContentPrice_Unknown[] =
    L"PriceUnknown"; // The price of the content is unknown
static const WCHAR g_szContentPrice_CannotBuy[] =
    L"PriceCannotBuy"; // The content cannot be bought
static const WCHAR g_szContentPrice_Free[] =
    L"PriceFree"; // The content is free
//////////////////////////////////////////////////////////////////////
...
//
// These values are written in the registry as a DWORD value called
// 'Capabilities' under
// HKEY_LOCAL_MACHINE\SOFTWARE\Microsoft\MediaPlayer\Subscriptions\<ContentPartnerPluginKey>
// See the MSDN section on Online Stores Programming Reference in the Windows
// Media SDK
//////////////////////////////////////////////////////////////////////
...
// The WMPPartnerNotification enum values are passed to the
// IWMPContentPartner::Notify API

// Synopsis - IWMPContentPartner::Notify( wmpsnBackgroundProcessingBegin
//                                           /*input*/ VARIANT *pContenxt, type
//                                           must be VT_EMPTY
...
//                                           /*input*/ VARIANT *pContenxt, type
//                                           must be VT_EMPTY
// Remarks: the plugin should stop background processing, this enables the
// player to use more CPU for playback
...
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////
// These constants are used in the IWMPContentPartner::RefreshLicesnse APIs for
// the reason
...
// The WMPCallbackNotification enum values are passed to the
// IWMPContentPartner::Notify API

// Synopsis - IWMPContentPartnerCallback::Notify( wmpcnLoginStateChange
//                                           /*input*/ VARIANT *pContext, type
//                                           must be VT_BOOL or VT_UI4
// Remarks: indicates a new login state. VT_BOOL indicates a normal success or
// failure, while setting the type to VT_UI4 indicates a special condition
// (expired or canceled account, etc) in which case the player will query the
// plugin via GetItemInfo( g_szItemInfo_LoginFailureURL, <VT_UI4 value returned
// with wmpcnLoginStateChange>, <VARIANT * to receive the URL as VT_BSTR> )
...
//                                           /*input*/ VARIANT *pContext, type
//                                           must be VT_EMPTY
// Remarks: Instructs the player to not allow any skipping of items in a radio
// playlist
typedef /* [public] */
...
// The WMPTaskType enum values are passed to the IWMPContentPartner::GetTemplate
// API
...
// Remarks: Indicates that the player is in something other than the Library,
// Sync or Burn task
...
// The WMPContextMenuInfo is returned from the IWMPContentPartner::GetCommands
// API

// Synopsis - struct WMPContextMenuInfo

// Member - dwID -> Indicates the value for the command from the plugin. A value
// of zero will
//                  cause the media player to insert a separator in the context
//                  menu

// Member - bstrMenuText -> Indicates the text that will be show in the context
// menu

// Member - bstrHelpText -> Indicates help text that could be shown when the
// user is
...
// Synopsis - GetType -> This returns the type of this container. Can return
// g_szCPAlbumID, g_szCPListID, or g_szUnknownLocation

// Synopsis - GetContentCount -> Returns the content count held in this
// container.

// Synopsis - GetContentPrice -> Returns the price for a piece of content.
//               /*input*/ idxContent -> index of content to get price for.
//               Should be less than value returned by GetContentCount
//               /*output*/ pbstrPrice -> string content the price or
//               g_szContentPrice_Unknown, g_szContentPrice_Free, or
//               g_szContentPrice_CannotBuy

// Synopsis - GetContentID-> Returns the identifier for a piece of content.
//               /*input*/ idxContent -> index of content to indentifier for.
//               Should be less than value returned by GetContentCount
...
typedef struct IWMPContentContainerVtbl {
  ...
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IWMPContentContainer *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IWMPContentContainer *This);

  DECLSPEC_XFGVIRT(IWMPContentContainer, GetID)
  HRESULT(STDMETHODCALLTYPE *GetID)(__RPC__in IWMPContentContainer *This,
...
// The WMPTransactionType enum values are passed to the
// IWMPContentContainerList::GetTransactionType API

// Synopsis - wmpttNoTransaction
// Remarks: Undefined transaction, not currently used

// Synopsis - wmpttDownload
// Remarks: Indicates that this IWMPContentContainerList is to be used for a
// download transaction

// Synopsis - wmpttBuy
// Remarks: Indicates that this IWMPContentContainerList is to be used for a buy
// transaction
...
//               /*output*/ WMPTransactionType *pwmptt -> indicates whether this
//               IWMPContentContainerList will be used to a buy or download

// Synopsis - GetContainerCount-> Returns the number of IWMPContentContainer(s)
// present in this container list.
//               /*output*/ ULONG *pcContainer -> returns the number of
//               containers

// Synopsis - GetContainer-> Returns the IWMPContentContainer given an index.
//               /*input*/ ULONG idxContainer -> the index of the desired
//               container, should be less than the number returned
//                                               by
//                                               IWMPContentContainerList::GetContainerCount
//               /*output*/ IWMPContentContainer **ppContent -> will containe
//               the requested IWMPContentContainer on success
...
typedef struct IWMPContentContainerListVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IWMPContentContainerList *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IWMPContentContainerList *This);
...
// The WMPTemplateSize enum values are returned from the
// IWMPContentPartner::GetTemplate API

// Synopsis - wmptsSmall
// Remarks: indicates the media player will allocate 100 pixels in height for
// the template

// Synopsis - wmptsMedium
// Remarks: indicates the media player will allocate 250 pixels in height for
// the template

// Synopsis - wmptsLarge
// Remarks: indicates the media player will allocate all of the room expect for
// the necessary space
//          for the list-control to display a small set of items for the
//          template
...
// The WMPStreamingType enum values are passed to the returned from the
// IWMPContentPartner::GetStreamingULR API
...
// The WMPAccountType enum values are returned from the
// IWMPContentPartner::GetPartnerInfo when API the string is
// g_szContentPartnerInfo_MediaPlayerAccountType passed

// Synopsis - wmpatBuyOnly
// Remarks: indicates the user only has the option to buy content

// Synopsis - wmpatSubscription
// Remarks: indicates the user has a subcription account, which indicates buy is
// also required for sync to Janus device

// Synopsis - wmpatJanus
// Remarks: indicates the user has a subcirption account, and the ability to
// sync to Janus devices without having to buy
...
// Synopsis - Notify-> This function is called to notify the media player of
// plugin events
//            /*input*/  WMPCallbackNotification type - Event that the plugin is
//            notifying the player of
//            /*input*/  VARIANT * pContext - The context depends on the
//            notification being sent. See
//                           remakrs for WMPCallbackNotification

// Synopsis - BuyComplete -> This function is called to notify the media player
// of that a purchase has completed
//            /*input*/  HRESULT hrResult - The success or error code of the
//            purchase operation.
//            /*input*/  DWORD dwBuyCookie - The cookie passed to
//            IWMPContentPartner::Buy.

// Remarks: This method should ONLY be called on SUCCESS AFTER all licenses have
// been delivered.

// Synopsis - DownloadTrack -> This function is called in response to a
// IWMPContentPartner::Download
//            /*input*/  DWORD dwCookie - The cookie passed to
//            IWMPContentPartner::Download.
//            /*input*/  BSTR bstrTrackURL - The URL to download.
//            /*input*/  DWORD dwServiceTrackID - The content identifier of the
//            content to download.
//            /*input*/  BSTR bstrDownloadParams - A string containing data to
//            be passed to
//                                    IWMPContentPartnerCallback::DownloadTrackComplete.
//            /*input*/  HRESULT hrDownload - The success or error code of
//            download operation.

// Remarks: This method should ONLY be called on SUCCESS AFTER all licenses have
// been delivered. Remarks: The tracks will NOT be download if hrDownload is not
// a success code.

// Synopsis - GetCatalogVersion -> This function is called to retrieve the
// current catalog version.
//            /*output*/  DWORD *pdwVersion- The major version of the catalog
//            being used.
//            /*output*/  DWORD *pdwSchemaVersion - The schema of the catalog
//            being used.
//            /*output*/  LCID *plcid- The language of the catalog being used.

// Synopsis - UpdateDeviceComplete -> This function is called to indicate that
// IWMPContentPartner::UpdateDevice has completed.
//            /*input*/  BSTR bstrDeviceName - The device name passed to
//            IWMPContentPartner::UpdateDevice.

// Synopsis - ChangeView-> This function is called to navigate the media player
// UI
//            /*input*/  BSTR bstrType - a content partner string ID such as
//            g_szCPArtistID, or g_szOnlineStore
//            /*input*/  BSTR bstrID -   The identifier to navigate to
//            /*input*/  BSTR bstrFilter - A filter to place in the 'word wheel'
//            after navigating

// Remarks: When using g_szOnlineStore for bstrType, the bstrID ss a full URL to
// navigate the browser to Remarks: Use 'Back' or 'Forward' in bstrType to
// simulate pressing the applications back and forward navigation buttons
// Remarks: Use g_szRootLocation in bstrType to navigate to the service's root
// node in the libary UI

// Synopsis - AddListContents-> This function is called to add content
// identifiers to a list as a rsult of the
//                               IWMPContentPartner::GetListContents API being
//                               called
//            /*input*/  DWORD dwListCookie - Cookie sent during
//            IWMPContentParnter::GetListContents
//            /*input*/  DWORD cItems - The number of content identifiers being
//            passed in the prgItems parameter
//            /*input*/  DWORD *prgItems - An array of content identifiers

// Synopsis - ListContentsComplete-> This function is called to indicate that
// the plugin has completed a IWMPContentPartner::GetListContents call
//            /*input*/  DWORD dwListCookie - Cookie sent during
//            IWMPContentParnter::GetListContents
//            /*input*/  HRESULT hrSuccess - The success or error code of the
//            GetListContents operation

// Synopsis - SendMessageComplete-> This function is called to indicate that the
// plugin has completed a IWMPContentPartner::SendMessage call
//            /*input*/  BSTR bstrMsg - Message text sent in
//            IWMPContentPartner::SendMessage
//            /*input*/  BSTR bstrParam - Parameter text sent in
//            IWMPContentPartner::SendMessage
//            /*input*/  BSTR bstrResult - Result text

// Synopsis - GetContentIDsInLibrary-> This function is called to retrieve the
// content identifiers that are in the users
//                                     library that have been purchased or
//                                     downloaded.
//            /*output*/  ULONG pcContentIDs - The number of content identifiers
//            returned.
//            /*output*/  ULONG **pprgIDs    - An array of ULONGs containing the
//            content identifiers. Free this array with CoTaskMemFree.

// Synopsis - RefreshLicenseComplete -> This function is called to indicate that
// a license refresh call has completed
//            /*input*/   DWORD dwCookie - This should be the same cookie passed
//            to IWMPContentPartner::RefreshLicense.
//            /*input*/   ULOING contentID - This should be the same content
//            identifier passed to IWMPContentPartner::RefreshLicense.
//            /*input*/   HRESULT hrRefresh - The success or error code of the
//            refresh operation.

// Synopsis - ShowPopup -> This function is called to have the player show a
// popup dialog. Usually this happens
//                          as a result of IWMPContentPartner::InvokeCommand
//                          being called.
//            /*input*/   long lIndex - The URL index to request from the
//            IWMPContentPartner::GetItemInfo( g_szItemInfo_PopupURL, ... ) API.
//            /*input*/   BSTR bstrParameters - The parameters that are
//            concatenated onto the URL returned by
//            IWMPContentPartner::GetItemInfo( g_szItemInfo_PopupURL, ... ) API

// Synopsis - VerifyPermission-> This function is called to indicate that
// permission verification is complete
//            /*input*/ BSTR bstrPermission - Indicates action for which
//            permission was requested.
//            /*input*/   VARIANT * pContext - If sync, this is the canonical
//            name of the device. This is the same thing that was passed in as
//            pContext in VerifyPermission.
//            /*input*/   HRESULT hrPermission - Result of permission
//            verification.
...
typedef struct IWMPContentPartnerCallbackVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IWMPContentPartnerCallback *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IWMPContentPartnerCallback *This);

  DECLSPEC_XFGVIRT(IWMPContentPartnerCallback, Notify)
  HRESULT(STDMETHODCALLTYPE *Notify)(__RPC__in IWMPContentPartnerCallback *This,
                                     /* [in] */ WMPCallbackNotification type,
                                     /* [in] */ __RPC__in VARIANT *pContext);
...
#define IWMPContentPartnerCallback_DownloadTrack(                              \
    This, cookie, bstrTrackURL, dwServiceTrackID, bstrDownloadParams,          \
    hrDownload)                                                                \
  ((This)->lpVtbl->DownloadTrack(This, cookie, bstrTrackURL, dwServiceTrackID, \
                                 bstrDownloadParams, hrDownload))

#define IWMPContentPartnerCallback_GetCatalogVersion(This, pdwVersion,         \
                                                     pdwSchemaVersion, plcid)  \
...
#define IWMPContentPartnerCallback_ChangeView(This, bstrType, bstrID,          \
                                              bstrFilter)                      \
...
#define IWMPContentPartnerCallback_ListContentsComplete(This, dwListCookie,    \
                                                        hrSuccess)             \
  ((This)->lpVtbl->ListContentsComplete(This, dwListCookie, hrSuccess))

#define IWMPContentPartnerCallback_SendMessageComplete(This, bstrMsg,          \
                                                       bstrParam, bstrResult)  \
  ((This)->lpVtbl->SendMessageComplete(This, bstrMsg, bstrParam, bstrResult))

#define IWMPContentPartnerCallback_GetContentIDsInLibrary(This, pcContentIDs,  \
                                                          pprgIDs)             \
  ((This)->lpVtbl->GetContentIDsInLibrary(This, pcContentIDs, pprgIDs))

#define IWMPContentPartnerCallback_RefreshLicenseComplete(                     \
    This, dwCookie, contentID, hrRefresh)                                      \
...
#define IWMPContentPartnerCallback_VerifyPermissionComplete(                   \
    This, bstrPermission, pContext, hrPermission)                              \
  ((This)->lpVtbl->VerifyPermissionComplete(This, bstrPermission, pContext,    \
                                            hrPermission))
...
// Synopsis - SetCallback-> This function allows gives the pugin the ability to
// store a callback pointer
//                          that will be necessary to communicate with the
//                          player
//             /*input*/ pCallback -> interface pointer to the media player's
//             implementation of the IWMPContentPartnerCallback
//
// Remarks: The player will call this with a null value during its shutdown
// process. The plugin can use

// Synopsis - Notify-> This function is called by the player to notify the
// plugin of certain events
//            /*input*/ WMPPartnerNotification type - see comments for
//            WMPPartnerNotification enum
//            /*input*/ VARIANT *pContext - see comments for
//            WMPPartnerNotification enum

// Synopsis - GetItemInfo-> This function is called to retrieve different
// properties about content
//            /*input*/ VARIANT *pContext - see comments above for the strings
//            passed into this API
//            /*out*/   VARIANT *pData - see comments abouve for the strings
//            passed into this API

// Synopsis - GetContentPartnerInfo-> This function is called to retrieve
// different properties about the content partner
//            /*input*/ BSTR bstrInfoName - see comments above for the strings
//            passed into this API
//            /*out*/   VARIANT *pData - see comments above for the strings
//            passed into this API

// Synopsis - GetCommands-> This function allows the plugin to return commands
// to be displayed in context menus
//             /*input*/  BSTR location -> location in the library (such as
//             g_szCPArtistID)
//             /*input*/  VARIANT *pLocationContext -> location in the library
//             (such as VT_UI4, 1231231)
//             /*input*/  BSTR itemLocation -> item type selected in library
//             (such as g_szCPTrackID)
//             /*input*/  ULONG cItemIDs -> the number of selected items of type
//             itemLocation
//             /*input*/  ULONG prgItemIDs -> the array of content identifiers
//             /*output*/ ULONG *pcItemIDs -> the number of context menu
//             commands returned in pprgItems
//             /*output*/ WMPContextMenuInfo **pprgItems -> Array of
//             WMPContenxtMenuInfo items allocated by CoTaskMemAlloc

//             Remarks: See comments for WMPContextMenuInfo for more information

// Synopsis - InvokeCommand-> This function is called when the user selects an
// option fro a context menu command
//                            returned by IWMPContentPartner::GetCommands
//             /*input*/  DWORD dwCommandID -> Command ID from the select
//             WMPContextMenuInfo
//             /*input*/  The remaining parameters are the same as those passed
//             to IWMPContentPartner::GetCommands

//             Remarks: See comments for WMPContextMenuInfo and
//             IWMPContentPartner::GetCommands for more information

// Synopsis - GetCatalogURL -> This function is called by the player to retrieve
// the streaming URL
//             /*input*/  WMPStreamingType -> indicates whether the streaming
//             type is for radio\music\video
//             /*input*/  VARIANT *pStreamContext -> VT_UI4, contains the
//             content identifier
//             /*ouptut*/ BSTR *pbstrURL-> recieves the streaming URL of the
//             content

//             Remarks: The streaming URL for Radio and Video must be contained
//             in an ASX

// Synopsis - GetCatalogURL -> This function is called by the player to retrieve
// the catalog download URL
//             /*input*/  DWORD dwCatalogVersion -> current catalog version, or
//             zero if none exists
//             /*input*/  DWORD dwCatalogSchemaVesrion -> current catalog schema
//             /*input*/  LCID catalogLCID -> current catalog version
//             /*output*/ DWORD *pdwNewCatalogVersion -> version of catalog that
//             URL represents
//             /*ouptut*/ BSTR *pbstrCatalogURL-> recieves URL that the player
//             will use to download catalog
//             /*output*/ VARIANT *pExpirationData-> Must be of type VT_DATE.
//             This is the date at which the player will
//                           will call IWMPContentPartner::GetCatalogURL to
//                           retrieve a new catalog.

// Synopsis - UpdateDevice -> This function is called during sync to allow the
// plugin to do device updates.
//             /*input*/ BSTR bstrDeviceName-> name of device to update
//
// Remarks: This call should function asynchronously. Call
// IWMPContentPartnerCallback::UpdateDeviceComplete when finsihed.

// Synopsis - Login-> This function indicates to the plugin to begin logging in
// to the service
//             /*input*/ BLOB userInfo, an encrypted blob containing the user's
//             login name
//             /*input*/ BLOB pwdInfo,  an encrypted blob containing the user's
//             login password
//             /*input*/ VARIANT_BOOL fUsedCachedCreds, indicates to the plugin
//             to attempt to use cached credentials
//                                                       for login if present.
//             /*input*/ VARIANT_BOOL fOkToCache, indicates that it is
//             acceptable for the plugin to cache
//                                                 the users credential.
//
// Remarks: The plugin is responsible for calling IWMPContentPartner::Notify to
// indicate login state change
//
// Remarks: To unencrypt the user and password name, use
//   CryptUnprotectData( blob, NULL, NULL, NULL, NULL,
//   CRYPTPROTECT_UI_FORBIDDEN, &outBlob)

// Synopsis - Authenticate-> This function indicates to the plugin to
// Authenticate the credentials with the service
//             /*input*/ BLOB userInfo, an encrypted blob containing the user's
//             login name
//             /*input*/ BLOB pwdInfo,  an encrypted blob containing the user's
//             login password
...
// Synopsis - Logout-> This function indicates to the plugin to begin logging
// out from the service
//
// Remarks: The plugin is responsible for calling IWMPContentPartner::Notify to
// indicate login state change
//
// Remarks: The plugin should delete any cached credentials when this API is
// called

// Synopsis - SendMessage -> This function allows HTML templates returned from
// IWMPContentPartner::GetTemplate
//                          to communicate to the plugin
//             /*input*/ bstrMsg -> value send directly from the template
//             returned by IWMPContentPartner::GetTemplate
//                               -> via the window.external.sendMessage API
//             /*input*/ bstrParam -> parameter for the message, also sent from
//             the window.external.sendMessage API
//
// Remarks: The plugin is reponsible for calling
// IWMPContentPartnerCallback::OnSendMessageComplete in order for
//         the HTML template to know that processing of the message occurs. This
//         will be sent to the template via the
//         window.external.OnSendMessageComplete notificaiton

// Synopsis - CompareContainerListPrices-> This function is called to preform a
// comparison operation on tow IWMPContentContainerLists
//            /*input*/   IWMPContentContainerList *pListBase -
//            /*input*/   IWMPContentContainerList *pListCompare -
//            /*output*/  long *pResult* - Return less than 0 when pListBase is
//            less than pListCompare, 0 for equal, and greather than 0 when
//            pListBase is more than pListCompare

// Synopsis - VerifyPermission-> This function is called to get permission to
// perform an action
//            /*input*/ BSTR bstrPermission - Indicates action for which
//            permission is requested
//            /*input*/   VARIANT * pContext - If sync, this is the canonical
//            name of the device. This needs to be returned in
...
public:
  ...
  virtual HRESULT STDMETHODCALLTYPE GetCommands(
      ...
      /* [size_is][size_is][out] */
      __RPC__deref_out_ecount_full_opt(*pcItemIDs) WMPContextMenuInfo *
          *pprgItems) = 0;
  ...
  virtual HRESULT STDMETHODCALLTYPE InvokeCommand(
      ...
      /* [in] */ __RPC__in BSTR itemLocation,
      /* [in] */ ULONG cItemIDs,
      /* [size_is][in] */ __RPC__in_ecount_full(cItemIDs) ULONG *
          rgItemIDs) = 0;
...
typedef struct IWMPContentPartnerVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in IWMPContentPartner *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IWMPContentPartner *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IWMPContentPartner *This);
  ...
  HRESULT(STDMETHODCALLTYPE *Notify)(__RPC__in IWMPContentPartner *This,
                                     /* [in] */ WMPPartnerNotification type,
                                     /* [in] */ __RPC__in VARIANT *pContext);
  ...
  HRESULT(STDMETHODCALLTYPE *GetCommands)(
      ...
      /* [out] */ __RPC__out ULONG *pcItemIDs,
      /* [size_is][size_is][out] */
      __RPC__deref_out_ecount_full_opt(*pcItemIDs)
  ...
  HRESULT(STDMETHODCALLTYPE *UpdateDevice)(__RPC__in IWMPContentPartner *This,
                                           /* [in] */ __RPC__in BSTR
                                               bstrDeviceName);
  ...
  HRESULT(STDMETHODCALLTYPE *Login)(__RPC__in IWMPContentPartner *This,
                                    /* [in] */ BLOB userInfo,
                                    /* [in] */ BLOB pwdInfo,
                                    /* [in] */ VARIANT_BOOL fUsedCachedCreds,
  ...
  HRESULT(STDMETHODCALLTYPE *Authenticate)(__RPC__in IWMPContentPartner *This,
                                           /* [in] */ BLOB userInfo,
                                           /* [in] */ BLOB pwdInfo);

  DECLSPEC_XFGVIRT(IWMPContentPartner, Logout)
  HRESULT(STDMETHODCALLTYPE *Logout)(__RPC__in IWMPContentPartner *This);

  DECLSPEC_XFGVIRT(IWMPContentPartner, SendMessage)
  HRESULT(STDMETHODCALLTYPE *SendMessage)(__RPC__in IWMPContentPartner *This,
                                          /* [in] */ __RPC__in BSTR bstrMsg,
                                          /* [in] */ __RPC__in BSTR bstrParam);
...
#define IWMPContentPartner_GetCommands(This, location, pLocationContext,       \
                                       itemLocation, cItemIDs, prgItemIDs,     \
                                       pcItemIDs, pprgItems)                   \
  ((This)->lpVtbl->GetCommands(This, location, pLocationContext, itemLocation, \
                               cItemIDs, prgItemIDs, pcItemIDs, pprgItems))

#define IWMPContentPartner_InvokeCommand(This, dwCommandID, location,          \
                                         pLocationContext, itemLocation,       \
                                         cItemIDs, rgItemIDs)                  \
  ((This)->lpVtbl->InvokeCommand(This, dwCommandID, location,                  \
                                 pLocationContext, itemLocation, cItemIDs,     \
                                 rgItemIDs))

#define IWMPContentPartner_CanBuySilent(This, pInfo, pbstrTotalPrice,          \
                                        pSilentOK)                             \
...
#define IWMPContentPartner_DownloadTrackComplete(This, hrResult, contentID,    \
                                                 downloadTrackParam)           \
  ((This)->lpVtbl->DownloadTrackComplete(This, hrResult, contentID,            \
                                         downloadTrackParam))

#define IWMPContentPartner_RefreshLicense(This, dwCookie, fLocal, bstrURL,     \
                                          type, contentID, bstrRefreshReason,  \
                                          pReasonContext)                      \
  ((This)->lpVtbl->RefreshLicense(This, dwCookie, fLocal, bstrURL, type,       \
                                  contentID, bstrRefreshReason,                \
                                  pReasonContext))

#define IWMPContentPartner_GetCatalogURL(                                      \
    This, dwCatalogVersion, dwCatalogSchemaVersion, catalogLCID,               \
    pdwNewCatalogVersion, pbstrCatalogURL, pExpirationDate)                    \
  ((This)->lpVtbl->GetCatalogURL(                                              \
      This, dwCatalogVersion, dwCatalogSchemaVersion, catalogLCID,             \
      pdwNewCatalogVersion, pbstrCatalogURL, pExpirationDate))

#define IWMPContentPartner_GetTemplate(                                        \
    This, task, location, pContext, clickLocation, pClickContext, bstrFilter,  \
    bstrViewParams, pbstrTemplateURL, pTemplateSize)                           \
  ((This)->lpVtbl->GetTemplate(This, task, location, pContext, clickLocation,  \
                               pClickContext, bstrFilter, bstrViewParams,      \
...
#define IWMPContentPartner_GetListContents(                                    \
    This, location, pContext, bstrListType, bstrParams, dwListCookie)          \
  ((This)->lpVtbl->GetListContents(This, location, pContext, bstrListType,     \
                                   bstrParams, dwListCookie))

#define IWMPContentPartner_Login(This, userInfo, pwdInfo, fUsedCachedCreds,    \
                                 fOkToCache)                                   \
...
#define IWMPContentPartner_StationEvent(This, bstrStationEventType, StationId, \
                                        PlaylistIndex, TrackID, TrackData,     \
                                        dwSecondsPlayed)                       \
  ((This)->lpVtbl->StationEvent(This, bstrStationEventType, StationId,         \
                                PlaylistIndex, TrackID, TrackData,             \
                                dwSecondsPlayed))

#define IWMPContentPartner_CompareContainerListPrices(This, pListBase,         \
                                                      pListCompare, pResult)   \
  ((This)->lpVtbl->CompareContainerListPrices(This, pListBase, pListCompare,   \
                                              pResult))
