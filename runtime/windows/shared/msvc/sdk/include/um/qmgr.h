...
public:
  ...
  virtual HRESULT STDMETHODCALLTYPE AddFiles(
      /* [in] */ ULONG cFileCount,
      /* [size_is][in] */ __RPC__in_ecount_full(cFileCount) FILESETINFO *
          *ppFileSet) = 0;
...
typedef struct IBackgroundCopyJob1Vtbl {
  ...
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IBackgroundCopyJob1 *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IBackgroundCopyJob1 *This);

  DECLSPEC_XFGVIRT(IBackgroundCopyJob1, CancelJob)
  HRESULT(STDMETHODCALLTYPE *CancelJob)(__RPC__in IBackgroundCopyJob1 *This);
  ...
  HRESULT(STDMETHODCALLTYPE *AddFiles)(__RPC__in IBackgroundCopyJob1 *This,
                                       /* [in] */ ULONG cFileCount,
                                       /* [size_is][in] */
...
typedef struct IEnumBackgroundCopyJobs1Vtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IEnumBackgroundCopyJobs1 *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IEnumBackgroundCopyJobs1 *This);

  DECLSPEC_XFGVIRT(IEnumBackgroundCopyJobs1, Next)
  HRESULT(STDMETHODCALLTYPE *Next)(__RPC__in IEnumBackgroundCopyJobs1 *This,
                                   /* [in] */ ULONG celt,
                                   /* [length_is][size_is][out] */
  ...
  HRESULT(STDMETHODCALLTYPE *Skip)(__RPC__in IEnumBackgroundCopyJobs1 *This,
                                   /* [in] */ ULONG celt);

  DECLSPEC_XFGVIRT(IEnumBackgroundCopyJobs1, Reset)
  HRESULT(STDMETHODCALLTYPE *Reset)(__RPC__in IEnumBackgroundCopyJobs1 *This);
  ...
  HRESULT(STDMETHODCALLTYPE *GetCount)(__RPC__in IEnumBackgroundCopyJobs1 *This,
...
public:
  ...
  virtual HRESULT STDMETHODCALLTYPE EnumJobs(
      /* [in] */ DWORD dwFlags,
      /* [out] */ __RPC__deref_out_opt IEnumBackgroundCopyJobs1 *
          *ppEnumJobs) = 0;
...
typedef struct IBackgroundCopyGroupVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IBackgroundCopyGroup *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IBackgroundCopyGroup *This);

  DECLSPEC_XFGVIRT(IBackgroundCopyGroup, GetProp)
  HRESULT(STDMETHODCALLTYPE *GetProp)(__RPC__in IBackgroundCopyGroup *This,
                                      /* [in] */ GROUPPROP propID,
  ...
  HRESULT(STDMETHODCALLTYPE *ResumeGroup)(__RPC__in IBackgroundCopyGroup *This);

  DECLSPEC_XFGVIRT(IBackgroundCopyGroup, CancelGroup)
  HRESULT(STDMETHODCALLTYPE *CancelGroup)(__RPC__in IBackgroundCopyGroup *This);

  DECLSPEC_XFGVIRT(IBackgroundCopyGroup, get_Size)
  HRESULT(STDMETHODCALLTYPE *get_Size)(__RPC__in IBackgroundCopyGroup *This,
...
/* [call_as] */ HRESULT
STDMETHODCALLTYPE IBackgroundCopyGroup_InternalSetProp_Proxy(
    __RPC__in IBackgroundCopyGroup *This,
    /* [in] */ GROUPPROP propID,
...
typedef struct IEnumBackgroundCopyGroupsVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IEnumBackgroundCopyGroups *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IEnumBackgroundCopyGroups *This);

  DECLSPEC_XFGVIRT(IEnumBackgroundCopyGroups, Next)
  HRESULT(STDMETHODCALLTYPE *Next)(__RPC__in IEnumBackgroundCopyGroups *This,
                                   /* [in] */ ULONG celt,
                                   /* [length_is][size_is][out] */
                                   __RPC__out_ecount_part(celt, *pceltFetched)
                                       GUID *rgelt,
  ...
  HRESULT(STDMETHODCALLTYPE *Skip)(__RPC__in IEnumBackgroundCopyGroups *This,
                                   /* [in] */ ULONG celt);

  DECLSPEC_XFGVIRT(IEnumBackgroundCopyGroups, Reset)
  HRESULT(STDMETHODCALLTYPE *Reset)(__RPC__in IEnumBackgroundCopyGroups *This);
...
public:
  ...
  virtual HRESULT STDMETHODCALLTYPE OnProgressEx(
      ...
      /* [size_is][in] */ __RPC__in_ecount_full(dwByteArraySize) BYTE *
          pByte) = 0;
};
...
typedef struct IBackgroundCopyCallback1Vtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IBackgroundCopyCallback1 *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IBackgroundCopyCallback1 *This);
...
public:
  ...
  virtual HRESULT STDMETHODCALLTYPE EnumGroups(
      /* [in] */ DWORD dwFlags,
      /* [out] */ __RPC__deref_out_opt IEnumBackgroundCopyGroups *
          *ppEnumGroups) = 0;
};
...
typedef struct IBackgroundCopyQMgrVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IBackgroundCopyQMgr *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IBackgroundCopyQMgr *This);
...
IBackgroundCopyGroup_SetProp_Proxy(IBackgroundCopyGroup *This,
                                   /* [in] */ GROUPPROP propID,
                                   /* [in] */ VARIANT *pvarVal);

/* [call_as] */ HRESULT STDMETHODCALLTYPE
IBackgroundCopyGroup_SetProp_Stub(__RPC__in IBackgroundCopyGroup *This,
                                  /* [in] */ GROUPPROP propID,
                                  /* [in] */ __RPC__in VARIANT *pvarVal);
