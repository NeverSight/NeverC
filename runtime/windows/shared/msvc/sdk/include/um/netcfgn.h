...
public:
  virtual HRESULT STDMETHODCALLTYPE GetInterfaceIdsForAdapter(
      ...
      /* [annotation][out] */
      _Outptr_opt_result_buffer_all_(*pdwNumInterfaces) GUID *
          *ppguidInterfaceIds) = 0;
...
typedef struct INetCfgComponentUpperEdgeVtbl {
  ...
  HRESULT(STDMETHODCALLTYPE *GetInterfaceIdsForAdapter)(
      ...
      _Out_ DWORD *pdwNumInterfaces,
      /* [annotation][out] */
      _Outptr_opt_result_buffer_all_(*pdwNumInterfaces)
...
#define INetCfgComponentUpperEdge_RemoveInterfacesFromAdapter(                 \
  ...
  ((This)->lpVtbl->RemoveInterfacesFromAdapter(                                \
      This, pAdapter, dwNumInterfaces, pguidInterfaceIds))
...
typedef struct INetLanConnectionUiInfoVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in INetLanConnectionUiInfo *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in INetLanConnectionUiInfo *This);
...
typedef struct INetRasConnectionIpUiInfoVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in INetRasConnectionIpUiInfo *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in INetRasConnectionIpUiInfo *This);
