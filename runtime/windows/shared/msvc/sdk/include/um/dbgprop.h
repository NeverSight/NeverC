...
// DO NOT USE OBJECT_ATTRIB_FLAGS or PROP_INFO_FLAGS, USE DBGPROP_ATTRIB_FLAGS
// and DBGPROP_INFO_FLAGS instead
...
public:
  ...
  virtual HRESULT STDMETHODCALLTYPE GetExtendedInfo(
      /* [in] */ ULONG cInfos,
      /* [size_is][in] */ __RPC__in_ecount_full(cInfos) GUID *
          rgguidExtendedInfo,
...
typedef struct IDebugPropertyVtbl {
  ...
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in IDebugProperty *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IDebugProperty *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IDebugProperty *This);
...
interface IDebugProperty { CONST_VTBL struct IDebugPropertyVtbl *lpVtbl; };
...
/* [call_as] */ HRESULT
STDMETHODCALLTYPE IDebugProperty_RemoteGetPropertyInfo_Proxy(
    __RPC__in IDebugProperty *This,
    /* [in] */ DWORD dwFieldSpec,
    /* [in] */ UINT nRadix,
...
typedef struct IEnumDebugPropertyInfoVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IEnumDebugPropertyInfo *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IEnumDebugPropertyInfo *This);
  ...
  HRESULT(STDMETHODCALLTYPE *Skip)(__RPC__in IEnumDebugPropertyInfo *This,
                                   /* [in] */ ULONG celt);

  DECLSPEC_XFGVIRT(IEnumDebugPropertyInfo, Reset)
  HRESULT(STDMETHODCALLTYPE *Reset)(__RPC__in IEnumDebugPropertyInfo *This);
  ...
  HRESULT(STDMETHODCALLTYPE *GetCount)(__RPC__in IEnumDebugPropertyInfo *This,
...
/* [call_as] */ HRESULT __stdcall IEnumDebugPropertyInfo_RemoteNext_Proxy(
    __RPC__in IEnumDebugPropertyInfo *This,
    /* [in] */ ULONG celt,
    /* [length_is][size_is][unique][out][in] */
...
public:
  virtual HRESULT STDMETHODCALLTYPE GetExtendedPropertyInfo(
      /* [in] */ DWORD dwFieldSpec,
      /* [in] */ UINT nRadix,
      /* [out] */ __RPC__out ExtendedDebugPropertyInfo *
          pExtendedPropertyInfo) = 0;

  virtual HRESULT STDMETHODCALLTYPE EnumExtendedMembers(
      /* [in] */ DWORD dwFieldSpec,
      /* [in] */ UINT nRadix,
      /* [out] */ __RPC__deref_out_opt IEnumDebugExtendedPropertyInfo *
          *ppeepi) = 0;
};
...
typedef struct IDebugExtendedPropertyVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IDebugExtendedProperty *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IDebugExtendedProperty *This);
...
public:
  virtual HRESULT STDMETHODCALLTYPE Next(
      ...
      __RPC__out_ecount_part(celt, *pceltFetched) ExtendedDebugPropertyInfo *
...
typedef struct IPerPropertyBrowsing2Vtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IPerPropertyBrowsing2 *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IPerPropertyBrowsing2 *This);
...
public:
  virtual HRESULT STDMETHODCALLTYPE GetName(
      ...
      __MIDL__IDebugPropertyEnumType_All0000) = 0;
};
...
typedef struct IDebugPropertyEnumType_AllVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IDebugPropertyEnumType_All *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IDebugPropertyEnumType_All *This);

  DECLSPEC_XFGVIRT(IDebugPropertyEnumType_All, GetName)
  HRESULT(STDMETHODCALLTYPE *GetName)(
      __RPC__in IDebugPropertyEnumType_All *This,
      /* [out] */ __RPC__deref_out_opt BSTR
          *__MIDL__IDebugPropertyEnumType_All0000);
...
#define IDebugPropertyEnumType_All_GetName(                                    \
    This, __MIDL__IDebugPropertyEnumType_All0000)                              \
...
IDebugPropertyEnumType_Locals : public IDebugPropertyEnumType_All{public : };
...
#define IDebugPropertyEnumType_Locals_GetName(                                 \
    This, __MIDL__IDebugPropertyEnumType_All0000)                              \
  ((This)->lpVtbl->GetName(This, __MIDL__IDebugPropertyEnumType_All0000))
...
IDebugPropertyEnumType_Arguments : public IDebugPropertyEnumType_All{public : };
...
#define IDebugPropertyEnumType_Arguments_GetName(                              \
    This, __MIDL__IDebugPropertyEnumType_All0000)                              \
  ((This)->lpVtbl->GetName(This, __MIDL__IDebugPropertyEnumType_All0000))
...
IDebugPropertyEnumType_LocalsPlusArgs : public
                                        IDebugPropertyEnumType_All{public : };
...
#define IDebugPropertyEnumType_LocalsPlusArgs_GetName(                         \
    This, __MIDL__IDebugPropertyEnumType_All0000)                              \
  ((This)->lpVtbl->GetName(This, __MIDL__IDebugPropertyEnumType_All0000))
...
IDebugPropertyEnumType_Registers : public IDebugPropertyEnumType_All{public : };
...
#define IDebugPropertyEnumType_Registers_GetName(                              \
    This, __MIDL__IDebugPropertyEnumType_All0000)                              \
  ((This)->lpVtbl->GetName(This, __MIDL__IDebugPropertyEnumType_All0000))
...
IEnumDebugPropertyInfo_Next_Proxy(IEnumDebugPropertyInfo *This,
                                  /* [in] */ ULONG celt,
                                  /* [out] */ DebugPropertyInfo *pi,
                                  /* [out] */ ULONG *pcEltsfetched);
