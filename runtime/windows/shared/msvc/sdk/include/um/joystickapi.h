...
MMRESULT
WINAPI
joyGetPosEx(_In_ UINT uJoyID, _Out_ LPJOYINFOEX pji);
...
MMRESULT
WINAPI
joyGetDevCapsA(_In_ UINT_PTR uJoyID, _Out_writes_bytes_(cbjc) LPJOYCAPSA pjc,
               _In_ UINT cbjc);

WINMMAPI
MMRESULT
WINAPI
joyGetDevCapsW(_In_ UINT_PTR uJoyID, _Out_writes_bytes_(cbjc) LPJOYCAPSW pjc,
               _In_ UINT cbjc);
...
MMRESULT
WINAPI
joyGetPos(_In_ UINT uJoyID, _Out_ LPJOYINFO pji);

WINMMAPI
MMRESULT
WINAPI
joyGetThreshold(_In_ UINT uJoyID, _Out_ LPUINT puThreshold);

WINMMAPI
MMRESULT
WINAPI
joyReleaseCapture(_In_ UINT uJoyID);

WINMMAPI
MMRESULT
WINAPI
joySetCapture(_In_ HWND hwnd, _In_ UINT uJoyID, _In_ UINT uPeriod,
              _In_ BOOL fChanged);

WINMMAPI
MMRESULT
WINAPI
joySetThreshold(_In_ UINT uJoyID, _In_ UINT uThreshold);

#if (WINVER >= 0x0400)
WINMMAPI
MMRESULT
WINAPI
joyConfigChanged(_In_ DWORD dwFlags);
