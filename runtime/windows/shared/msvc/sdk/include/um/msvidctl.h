...
public:
  ...
  virtual /* [helpstring][restricted][hidden][id][propget] */ HRESULT
      ...
      get__InputsAvailable(
          ...
          /* [retval][out] */ __RPC__deref_out_opt IMSVidInputDevices *
              *pVal) = 0;
  ...
  virtual /* [helpstring][restricted][hidden][id][propget] */ HRESULT
      ...
      get__OutputsAvailable(
          /* [in] */ __RPC__in LPCGUID CategoryGuid,
          /* [retval][out] */ __RPC__deref_out_opt IMSVidOutputDevices *
              *pVal) = 0;

  virtual /* [helpstring][id][propget] */ HRESULT STDMETHODCALLTYPE
      get_VideoRenderersAvailable(
          /* [retval][out] */ __RPC__deref_out_opt IMSVidVideoRendererDevices *
          *pVal) = 0;

  virtual /* [helpstring][id][propget] */ HRESULT STDMETHODCALLTYPE
      get_AudioRenderersAvailable(
          /* [retval][out] */ __RPC__deref_out_opt IMSVidAudioRendererDevices *
          *pVal) = 0;
  ...
  virtual /* [helpstring][id][propget] */ HRESULT STDMETHODCALLTYPE
      get_InputActive(
          /* [retval][out] */ __RPC__deref_out_opt IMSVidInputDevice *
          *pVal) = 0;
  ...
  virtual /* [helpstring][id][propget] */ HRESULT STDMETHODCALLTYPE
      get_VideoRendererActive(
          /* [retval][out] */ __RPC__deref_out_opt IMSVidVideoRenderer *
          *pVal) = 0;
  ...
  virtual /* [helpstring][id][propget] */ HRESULT STDMETHODCALLTYPE
      get_AudioRendererActive(
          /* [retval][out] */ __RPC__deref_out_opt IMSVidAudioRenderer *
          *pVal) = 0;
...
typedef struct IMSVidCtlVtbl {
  ...
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in IMSVidCtl *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IMSVidCtl *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IMSVidCtl *This);
  ...
  /* [id] */ HRESULT(STDMETHODCALLTYPE *Refresh)(__RPC__in IMSVidCtl *This);
  ...
  /* [helpstring][id][propput] */ HRESULT(
      STDMETHODCALLTYPE *put_FeaturesActive)(
      __RPC__in IMSVidCtl *This,
...
typedef struct IMSEventBinderVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in IMSEventBinder *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IMSEventBinder *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IMSEventBinder *This);
...
DEFINE_GUID(SID_MSVidCtl_CurrentAudioEndpoint, 0xcf9a88f4, 0xabcf, 0x4ed8, 0x9b,
            0x74, 0x7d, 0xb3, 0x34, 0x45, 0x45, 0x9e);
...
typedef struct _IMSVidCtlEventsVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in _IMSVidCtlEvents *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in _IMSVidCtlEvents *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in _IMSVidCtlEvents *This);
...
class DECLSPEC_UUID("24DC3975-09BF-4231-8655-3EE71F43837D") MSVidVMR9;
#endif
...
class DECLSPEC_UUID("C45268A2-FA81-4e19-B1E3-72EDBD60AEDA") MSVidEVR;
#endif
...
class DECLSPEC_UUID("4A5869CF-929D-4040-AE03-FCAFC5B9CD42") MSVidGenericSink;
#endif
...
class DECLSPEC_UUID("5740A302-EF0B-45ce-BF3B-4470A14A8980") MSVidITVCapture;
#endif
...
class DECLSPEC_UUID("9E797ED0-5253-4243-A9B7-BD06C58F8EF3") MSVidITVPlayback;
#endif
...
class DECLSPEC_UUID("86151827-E47B-45ee-8421-D10E6E690979") MSVidCCA;
#endif
...
class DECLSPEC_UUID("2291478C-5EE3-4bef-AB5D-B5FF2CF58352") MSVidSBESourceToITV;
#endif
...
class DECLSPEC_UUID("C4BF2784-AE00-41ba-9828-9C953BD3C54A") MSVidCCToVMR;
#endif
...
class DECLSPEC_UUID("D76334CA-D89E-4baf-86AB-DDB59372AFC2") MSVidCCToAR;
#endif
...
class DECLSPEC_UUID("30997F7D-B3B5-4A1C-983A-1FE8098CB77D") MSVidDevice2;
#endif
