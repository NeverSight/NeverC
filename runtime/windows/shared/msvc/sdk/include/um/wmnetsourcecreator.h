...
EXTERN_GUID(CLSID_ClientNetManager, 0xCD12A3CE, 0x9C42, 0x11D2, 0xBE, 0xED,
            0x00, 0x60, 0x08, 0x2F, 0x20, 0x54);
EXTERN_GUID(IID_INSNetSourceCreator, 0x0C0E4080, 0x9081, 0x11d2, 0xBE, 0xEC,
            0x00, 0x60, 0x08, 0x2F, 0x20, 0x54);
...
typedef struct INSNetSourceCreatorVtbl {
  ...
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in INSNetSourceCreator *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in INSNetSourceCreator *This);

  DECLSPEC_XFGVIRT(INSNetSourceCreator, Initialize)
  HRESULT(STDMETHODCALLTYPE *Initialize)(__RPC__in INSNetSourceCreator *This);
  ...
  HRESULT(STDMETHODCALLTYPE *Shutdown)(__RPC__in INSNetSourceCreator *This);
...
#define INSNetSourceCreator_CreateNetSource(                                   \
    This, pszStreamName, pMonitor, pData, pUserContext, pCallback, qwContext)  \
  ((This)->lpVtbl->CreateNetSource(This, pszStreamName, pMonitor, pData,       \
                                   pUserContext, pCallback, qwContext))

#define INSNetSourceCreator_GetNetSourceProperties(This, pszStreamName,        \
                                                   ppPropertiesNode)           \
  ((This)->lpVtbl->GetNetSourceProperties(This, pszStreamName,                 \
                                          ppPropertiesNode))

#define INSNetSourceCreator_GetNetSourceSharedNamespace(This,                  \
                                                        ppSharedNamespace)     \
  ((This)->lpVtbl->GetNetSourceSharedNamespace(This, ppSharedNamespace))

#define INSNetSourceCreator_GetNetSourceAdminInterface(This, pszStreamName,    \
                                                       pVal)                   \
...
#define INSNetSourceCreator_GetProtocolName(                                   \
    This, dwProtocolNum, pwszProtocolName, pcchProtocolName)                   \
  ((This)->lpVtbl->GetProtocolName(This, dwProtocolNum, pwszProtocolName,      \
                                   pcchProtocolName))
