...
typedef struct IBitsTokenOptionsVtbl {
  ...
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in IBitsTokenOptions *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IBitsTokenOptions *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IBitsTokenOptions *This);

  DECLSPEC_XFGVIRT(IBitsTokenOptions, SetHelperTokenFlags)
  HRESULT(STDMETHODCALLTYPE *SetHelperTokenFlags)(
      __RPC__in IBitsTokenOptions *This, DWORD UsageFlags);
  ...
  HRESULT(STDMETHODCALLTYPE *SetHelperToken)(__RPC__in IBitsTokenOptions *This);
...
typedef struct IBackgroundCopyFile4Vtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IBackgroundCopyFile4 *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IBackgroundCopyFile4 *This);
  ...
  HRESULT(STDMETHODCALLTYPE *SetRemoteName)(
      __RPC__in IBackgroundCopyFile4 *This, __RPC__in LPCWSTR Val);
...
#define IBackgroundCopyFile4_GetPeerDownloadStats(This, pFromOrigin,           \
                                                  pFromPeers)                  \
