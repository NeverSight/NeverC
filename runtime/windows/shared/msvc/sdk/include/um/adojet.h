...
public:
  ...
  virtual /* [helpcontext][propget] */ HRESULT STDMETHODCALLTYPE
      get_ConflictFunction(
          /* [retval][out] */ __RPC__deref_out_opt BSTR * pbstr) = 0;

  virtual /* [helpcontext][propput] */ HRESULT STDMETHODCALLTYPE
  put_ConflictFunction(
      /* [in] */ __RPC__in BSTR bstr) = 0;

  virtual /* [helpcontext][propget] */ HRESULT STDMETHODCALLTYPE
      get_ConflictTables(
          /* [retval][out] */ __RPC__deref_out_opt /* external definition not
                                                      present */
          _Recordset *
          *pprset) = 0;
...
typedef struct IReplicaVtbl {
  ...
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in IReplica *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IReplica *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IReplica *This);
  ...
  /* [helpcontext][propget] */ HRESULT(STDMETHODCALLTYPE *get_ConflictTables)(
      __RPC__in IReplica *This,
      /* [retval][out] */
      __RPC__deref_out_opt /* external definition not present */ _Recordset *
          *pprset);
...
typedef struct FilterVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in Filter *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in Filter *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in Filter *This);
...
typedef struct FiltersVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in Filters *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in Filters *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in Filters *This);
...
public:
  ...
  virtual /* [helpcontext] */ HRESULT STDMETHODCALLTYPE RefreshCache(
      /* [in] */ __RPC__in /* external definition not present */ _Connection *
      Connection) = 0;
};
...
typedef struct IJetEngineVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in IJetEngine *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IJetEngine *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IJetEngine *This);
