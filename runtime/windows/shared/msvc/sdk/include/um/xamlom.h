...
_Check_return_
    HRESULT InitializeXamlDiagnostic(_In_ LPCWSTR endPointName, _In_ DWORD pid,
...
_Check_return_ HRESULT InitializeXamlDiagnosticsEx(
    ...
    _In_ LPCWSTR wszDllXamlDiagnostics, _In_ LPCWSTR wszTAPDllName,
    _In_ CLSID tapClsid, _In_ LPCWSTR wszInitializationData);
...
typedef struct IVisualTreeServiceCallbackVtbl {
  ...
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IVisualTreeServiceCallback *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IVisualTreeServiceCallback *This);
...
typedef struct IVisualTreeServiceCallback2Vtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IVisualTreeServiceCallback2 *This);
...
public:
  ...
  virtual HRESULT STDMETHODCALLTYPE GetEnums(
      ...
      /* [size_is][size_is][out] */ __RPC__deref_out_ecount_full_opt(*pCount)
          EnumType **ppEnums) = 0;
  ...
  virtual HRESULT STDMETHODCALLTYPE GetPropertyValuesChain(
      ...
      /* [size_is][size_is][out] */
      __RPC__deref_out_ecount_full_opt(*pSourceCount)
          PropertyChainSource **ppPropertySources,
      /* [out] */ __RPC__out unsigned int *pPropertyCount,
      /* [size_is][size_is][out] */
      __RPC__deref_out_ecount_full_opt(*pPropertyCount)
          PropertyChainValue **ppPropertyValues) = 0;
  ...
  virtual HRESULT STDMETHODCALLTYPE GetCollectionElements(
      ...
      /* [size_is][size_is][out] */
      __RPC__deref_out_ecount_full_opt(*pElementCount)
          CollectionElementValue **ppElementValues) = 0;
...
typedef struct IVisualTreeServiceVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in IVisualTreeService *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IVisualTreeService *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IVisualTreeService *This);
  ...
  HRESULT(STDMETHODCALLTYPE *AddChild)(__RPC__in IVisualTreeService *This,
                                       /* [in] */ InstanceHandle parent,
                                       /* [in] */ InstanceHandle child,
                                       /* [in] */ unsigned int index);

  DECLSPEC_XFGVIRT(IVisualTreeService, RemoveChild)
  HRESULT(STDMETHODCALLTYPE *RemoveChild)(__RPC__in IVisualTreeService *This,
                                          /* [in] */ InstanceHandle parent,
                                          /* [in] */ unsigned int index);

  DECLSPEC_XFGVIRT(IVisualTreeService, ClearChildren)
  HRESULT(STDMETHODCALLTYPE *ClearChildren)(__RPC__in IVisualTreeService *This,
                                            /* [in] */ InstanceHandle parent);
...
#define IVisualTreeService_CreateInstance(This, typeName, value,               \
                                          pInstanceHandle)                     \
  ((This)->lpVtbl->CreateInstance(This, typeName, value, pInstanceHandle))

#define IVisualTreeService_GetPropertyValuesChain(                             \
    This, instanceHandle, pSourceCount, ppPropertySources, pPropertyCount,     \
    ppPropertyValues)                                                          \
  ((This)->lpVtbl->GetPropertyValuesChain(This, instanceHandle, pSourceCount,  \
                                          ppPropertySources, pPropertyCount,   \
                                          ppPropertyValues))

#define IVisualTreeService_SetProperty(This, instanceHandle, value,            \
                                       propertyIndex)                          \
...
#define IVisualTreeService_GetCollectionCount(This, instanceHandle,            \
                                              pCollectionSize)                 \
...
#define IVisualTreeService_GetCollectionElements(                              \
  ...
  ((This)->lpVtbl->GetCollectionElements(This, instanceHandle, startIndex,     \
                                         pElementCount, ppElementValues))
...
public:
  virtual HRESULT STDMETHODCALLTYPE GetDispatcher(
      /* [retval][out] */ __RPC__deref_out_opt IInspectable *
      *ppDispatcher) = 0;
  ...
  virtual HRESULT STDMETHODCALLTYPE HitTest(
      ...
      /* [out] */ __RPC__out unsigned int *pCount,
      /* [size_is][size_is][out] */
      __RPC__deref_out_ecount_full_opt(*pCount)
...
typedef struct IXamlDiagnosticsVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in IXamlDiagnostics *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IXamlDiagnostics *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IXamlDiagnostics *This);
...
interface IXamlDiagnostics { CONST_VTBL struct IXamlDiagnosticsVtbl *lpVtbl; };
...
#define IXamlDiagnostics_GetIInspectableFromHandle(This, instanceHandle,       \
                                                   ppInstance)                 \
...
typedef struct IBitmapDataVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in IBitmapData *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IBitmapData *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IBitmapData *This);
...
interface IBitmapData { CONST_VTBL struct IBitmapDataVtbl *lpVtbl; };
...
#define IBitmapData_CopyBytesTo(This, sourceOffsetInBytes, maxBytesToCopy,     \
                                pvBytes, numberOfBytesCopied)                  \
  ((This)->lpVtbl->CopyBytesTo(This, sourceOffsetInBytes, maxBytesToCopy,      \
                               pvBytes, numberOfBytesCopied))
...
typedef struct IVisualTreeService2Vtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IVisualTreeService2 *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IVisualTreeService2 *This);
  ...
  DECLSPEC_XFGVIRT(IVisualTreeService, AddChild)
  HRESULT(STDMETHODCALLTYPE *AddChild)(__RPC__in IVisualTreeService2 *This,
                                       /* [in] */ InstanceHandle parent,
                                       /* [in] */ InstanceHandle child,
                                       /* [in] */ unsigned int index);

  DECLSPEC_XFGVIRT(IVisualTreeService, RemoveChild)
  HRESULT(STDMETHODCALLTYPE *RemoveChild)(__RPC__in IVisualTreeService2 *This,
                                          /* [in] */ InstanceHandle parent,
                                          /* [in] */ unsigned int index);

  DECLSPEC_XFGVIRT(IVisualTreeService, ClearChildren)
  HRESULT(STDMETHODCALLTYPE *ClearChildren)(__RPC__in IVisualTreeService2 *This,
                                            /* [in] */ InstanceHandle parent);
...
#define IVisualTreeService2_CreateInstance(This, typeName, value,              \
                                           pInstanceHandle)                    \
  ((This)->lpVtbl->CreateInstance(This, typeName, value, pInstanceHandle))
...
#define IVisualTreeService2_SetProperty(This, instanceHandle, value,           \
                                        propertyIndex)                         \
  ((This)->lpVtbl->SetProperty(This, instanceHandle, value, propertyIndex))
...
#define IVisualTreeService2_GetCollectionCount(This, instanceHandle,           \
                                               pCollectionSize)                \
  ((This)->lpVtbl->GetCollectionCount(This, instanceHandle, pCollectionSize))
...
#define IVisualTreeService2_GetPropertyIndex(This, object, propertyName,       \
                                             pPropertyIndex)                   \
...
#define IVisualTreeService2_ReplaceResource(This, resourceDictionary, key,     \
                                            newValue)                          \
...
#define IVisualTreeService2_RenderTargetBitmap(                                \
  ...
  ((This)->lpVtbl->RenderTargetBitmap(This, handle, options, maxPixelWidth,    \
                                      maxPixelHeight, ppBitmapData))
...
typedef struct IVisualTreeService3Vtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IVisualTreeService3 *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IVisualTreeService3 *This);
  ...
  DECLSPEC_XFGVIRT(IVisualTreeService, AddChild)
  HRESULT(STDMETHODCALLTYPE *AddChild)(__RPC__in IVisualTreeService3 *This,
                                       /* [in] */ InstanceHandle parent,
                                       /* [in] */ InstanceHandle child,
                                       /* [in] */ unsigned int index);

  DECLSPEC_XFGVIRT(IVisualTreeService, RemoveChild)
  HRESULT(STDMETHODCALLTYPE *RemoveChild)(__RPC__in IVisualTreeService3 *This,
                                          /* [in] */ InstanceHandle parent,
                                          /* [in] */ unsigned int index);

  DECLSPEC_XFGVIRT(IVisualTreeService, ClearChildren)
  HRESULT(STDMETHODCALLTYPE *ClearChildren)(__RPC__in IVisualTreeService3 *This,
                                            /* [in] */ InstanceHandle parent);
...
#define IVisualTreeService3_CreateInstance(This, typeName, value,              \
                                           pInstanceHandle)                    \
  ((This)->lpVtbl->CreateInstance(This, typeName, value, pInstanceHandle))
...
#define IVisualTreeService3_SetProperty(This, instanceHandle, value,           \
                                        propertyIndex)                         \
  ((This)->lpVtbl->SetProperty(This, instanceHandle, value, propertyIndex))
...
#define IVisualTreeService3_GetCollectionCount(This, instanceHandle,           \
                                               pCollectionSize)                \
  ((This)->lpVtbl->GetCollectionCount(This, instanceHandle, pCollectionSize))
...
#define IVisualTreeService3_GetPropertyIndex(This, object, propertyName,       \
                                             pPropertyIndex)                   \
  ((This)->lpVtbl->GetPropertyIndex(This, object, propertyName, pPropertyIndex))
...
#define IVisualTreeService3_ReplaceResource(This, resourceDictionary, key,     \
                                            newValue)                          \
  ((This)->lpVtbl->ReplaceResource(This, resourceDictionary, key, newValue))
...
#define IVisualTreeService3_ResolveResource(                                   \
  ...
  ((This)->lpVtbl->ResolveResource(This, resourceContext, resourceName,        \
                                   resourceType, propertyIndex))

#define IVisualTreeService3_GetDictionaryItem(                                 \
    This, dictionaryHandle, resourceName, resourceIsImplicitStyle,             \
    resourceHandle)                                                            \
  ((This)->lpVtbl->GetDictionaryItem(This, dictionaryHandle, resourceName,     \
                                     resourceIsImplicitStyle, resourceHandle))

#define IVisualTreeService3_AddDictionaryItem(This, dictionaryHandle,          \
                                              resourceKey, resourceHandle)     \
  ((This)->lpVtbl->AddDictionaryItem(This, dictionaryHandle, resourceKey,      \
                                     resourceHandle))

#define IVisualTreeService3_RemoveDictionaryItem(This, dictionaryHandle,       \
                                                 resourceKey)                  \
