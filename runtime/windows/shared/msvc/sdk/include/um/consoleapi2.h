...
WINBASEAPI
BOOL WINAPI FillConsoleOutputCharacterA(_In_ HANDLE hConsoleOutput,
...
WINBASEAPI
BOOL WINAPI FillConsoleOutputCharacterW(_In_ HANDLE hConsoleOutput,
...
WINBASEAPI
BOOL WINAPI FillConsoleOutputAttribute(_In_ HANDLE hConsoleOutput,
                                       _In_ WORD wAttribute, _In_ DWORD nLength,
                                       _In_ COORD dwWriteCoord,
...
BOOL WINAPI GetConsoleCursorInfo(
    _In_ HANDLE hConsoleOutput, _Out_ PCONSOLE_CURSOR_INFO lpConsoleCursorInfo);

WINBASEAPI
BOOL WINAPI
SetConsoleCursorInfo(_In_ HANDLE hConsoleOutput,
...
WINBASEAPI
BOOL WINAPI ScrollConsoleScreenBufferA(
    _In_ HANDLE hConsoleOutput, _In_ CONST SMALL_RECT *lpScrollRectangle,
    _In_opt_ CONST SMALL_RECT *lpClipRectangle, _In_ COORD dwDestinationOrigin,
...
BOOL WINAPI WriteConsoleOutputA(_In_ HANDLE hConsoleOutput,
                                _In_reads_(dwBufferSize.X *dwBufferSize.Y)
...
BOOL WINAPI ReadConsoleOutputA(_In_ HANDLE hConsoleOutput,
                               _Out_writes_(dwBufferSize.X *dwBufferSize.Y)
                                   PCHAR_INFO lpBuffer,
                               _In_ COORD dwBufferSize,
                               _In_ COORD dwBufferCoord,
...
DWORD
WINAPI
GetConsoleTitleA(_Out_writes_(nSize) LPSTR lpConsoleTitle, _In_ DWORD nSize);

WINBASEAPI
DWORD
WINAPI
GetConsoleTitleW(_Out_writes_(nSize) LPWSTR lpConsoleTitle, _In_ DWORD nSize);
...
DWORD
WINAPI
GetConsoleOriginalTitleA(_Out_writes_(nSize) LPSTR lpConsoleTitle,
                         _In_ DWORD nSize);

WINBASEAPI
DWORD
WINAPI
GetConsoleOriginalTitleW(_Out_writes_(nSize) LPWSTR lpConsoleTitle,
                         _In_ DWORD nSize);
...
WINBASEAPI
BOOL WINAPI SetConsoleTitleA(_In_ LPCSTR lpConsoleTitle);

WINBASEAPI
BOOL WINAPI SetConsoleTitleW(_In_ LPCWSTR lpConsoleTitle);
