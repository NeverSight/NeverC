...
typedef interface IUserActivityRequestManagerInterop
...
typedef struct IUserActivityInteropVtbl {
  ...
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(IUserActivityInterop *This,
                                             /* [in] */ REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(IUserActivityInterop *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(IUserActivityInterop *This);

  DECLSPEC_XFGVIRT(IInspectable, GetIids)
  HRESULT(STDMETHODCALLTYPE *GetIids)(IUserActivityInterop *This,
                                      /* [out] */ ULONG *iidCount,
  ...
  HRESULT(STDMETHODCALLTYPE *GetTrustLevel)(IUserActivityInterop *This,
...
#define IUserActivityInterop_AddRef(This) ((This)->lpVtbl->AddRef(This))

#define IUserActivityInterop_Release(This) ((This)->lpVtbl->Release(This))
...
typedef struct IUserActivitySourceHostInteropVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(IUserActivitySourceHostInterop *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(IUserActivitySourceHostInterop *This);

  DECLSPEC_XFGVIRT(IInspectable, GetIids)
  HRESULT(STDMETHODCALLTYPE *GetIids)(IUserActivitySourceHostInterop *This,
                                      /* [out] */ ULONG *iidCount,
                                      /* [size_is][size_is][out] */ IID **iids);
...
#define IUserActivitySourceHostInterop_SetActivitySourceHost(                  \
    This, activitySourceHost)                                                  \
...
typedef struct IUserActivityRequestManagerInteropVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(IUserActivityRequestManagerInterop *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(IUserActivityRequestManagerInterop *This);

  DECLSPEC_XFGVIRT(IInspectable, GetIids)
  HRESULT(STDMETHODCALLTYPE *GetIids)(IUserActivityRequestManagerInterop *This,
                                      /* [out] */ ULONG *iidCount,
                                      /* [size_is][size_is][out] */ IID **iids);
...
#define IUserActivityRequestManagerInterop_QueryInterface(This, riid,          \
                                                          ppvObject)           \
  ((This)->lpVtbl->QueryInterface(This, riid, ppvObject))
...
#define IUserActivityRequestManagerInterop_GetRuntimeClassName(This,           \
                                                               className)      \
  ((This)->lpVtbl->GetRuntimeClassName(This, className))
...
#define IUserActivityRequestManagerInterop_GetForWindow(This, window, iid,     \
                                                        value)                 \
