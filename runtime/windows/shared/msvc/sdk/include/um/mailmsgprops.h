...
IMMPID_MP_RECIPIENT_LIST,
    ...
    //  Boolean which tells if the input was scanned for <CRLF>.<CRLF> in the
    //  msg
    // body
    ...
    // DWORD - Checksum for global properties (excluding the checksum
    // properties!)
    ...
    //  ANSI String - Contents of the RFC2554 AUTH= string on a MAIL FROM on
    //  inbound messages
...
//  (this flag is provided to check status of recipient... it should never be
//  used directly)
