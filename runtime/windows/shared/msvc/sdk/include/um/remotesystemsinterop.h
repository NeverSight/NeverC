...
public:
  ...
  put_NextCorrelationVectorForThread(
      /* [in] */ HSTRING cv) = 0;
};
...
typedef struct ICorrelationVectorInformationVtbl {
  ...
  ULONG(STDMETHODCALLTYPE *AddRef)(ICorrelationVectorInformation *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(ICorrelationVectorInformation *This);

  DECLSPEC_XFGVIRT(IInspectable, GetIids)
  HRESULT(STDMETHODCALLTYPE *GetIids)(ICorrelationVectorInformation *This,
                                      /* [out] */ ULONG *iidCount,
  ...
  HRESULT(STDMETHODCALLTYPE *GetTrustLevel)(ICorrelationVectorInformation *This,
                                            /* [out] */ TrustLevel *trustLevel);

  DECLSPEC_XFGVIRT(ICorrelationVectorInformation,
                   get_LastCorrelationVectorForThread)
  /* [propget] */ HRESULT(
      STDMETHODCALLTYPE *get_LastCorrelationVectorForThread)(
      ICorrelationVectorInformation *This,
  ...
  DECLSPEC_XFGVIRT(ICorrelationVectorInformation,
                   get_NextCorrelationVectorForThread)
  /* [propget] */ HRESULT(
      STDMETHODCALLTYPE *get_NextCorrelationVectorForThread)(
      ICorrelationVectorInformation *This,
      /* [retval][out] */ HSTRING *cv);
  ...
  DECLSPEC_XFGVIRT(ICorrelationVectorInformation,
                   put_NextCorrelationVectorForThread)
  /* [propput] */ HRESULT(
      STDMETHODCALLTYPE *put_NextCorrelationVectorForThread)(
      ICorrelationVectorInformation *This,
      /* [in] */ HSTRING cv);
...
#define ICorrelationVectorInformation_get_LastCorrelationVectorForThread(This, \
                                                                         cv)   \
  ((This)->lpVtbl->get_LastCorrelationVectorForThread(This, cv))

#define ICorrelationVectorInformation_get_NextCorrelationVectorForThread(This, \
                                                                         cv)   \
  ((This)->lpVtbl->get_NextCorrelationVectorForThread(This, cv))

#define ICorrelationVectorInformation_put_NextCorrelationVectorForThread(This, \
                                                                         cv)   \
