...
DEFINE_GUID(/* 4f27f2de-14e2-430b-a549-7cd48cbc8245 */
            NETWORK_MANAGER_FIRST_IP_ADDRESS_ARRIVAL_GUID, 0x4f27f2de, 0x14e2,
            0x430b, 0xa5, 0x49, 0x7c, 0xd4, 0x8c, 0xbc, 0x82, 0x45);

DEFINE_GUID(/* cc4ba62a-162e-4648-847a-b6bdf993e335 */
            NETWORK_MANAGER_LAST_IP_ADDRESS_REMOVAL_GUID, 0xcc4ba62a, 0x162e,
            0x4648, 0x84, 0x7a, 0xb6, 0xbd, 0xf9, 0x93, 0xe3, 0x35);
...
DEFINE_GUID(/* 1ce20aba-9851-4421-9430-1ddeb766e809 */
            DOMAIN_JOIN_GUID, 0x1ce20aba, 0x9851, 0x4421, 0x94, 0x30, 0x1d,
            0xde, 0xb7, 0x66, 0xe8, 0x09);

DEFINE_GUID(/* ddaf516e-58c2-4866-9574-c3b615d42ea1 */
            DOMAIN_LEAVE_GUID, 0xddaf516e, 0x58c2, 0x4866, 0x95, 0x74, 0xc3,
            0xb6, 0x15, 0xd4, 0x2e, 0xa1);
...
DEFINE_GUID(/* b7569e07-8421-4ee0-ad10-86915afdad09 */
            FIREWALL_PORT_OPEN_GUID, 0xb7569e07, 0x8421, 0x4ee0, 0xad, 0x10,
            0x86, 0x91, 0x5a, 0xfd, 0xad, 0x09);

DEFINE_GUID(/* a144ed38-8e12-4de4-9d96-e64740b1a524 */
            FIREWALL_PORT_CLOSE_GUID, 0xa144ed38, 0x8e12, 0x4de4, 0x9d, 0x96,
            0xe6, 0x47, 0x40, 0xb1, 0xa5, 0x24);
...
DEFINE_GUID(/* 659FCAE6-5BDB-4DA9-B1FF-CA2A178D46E0 */
            MACHINE_POLICY_PRESENT_GUID, 0x659FCAE6, 0x5BDB, 0x4DA9, 0xB1, 0xFF,
            0xCA, 0x2A, 0x17, 0x8D, 0x46, 0xE0);

DEFINE_GUID(/* 54FB46C8-F089-464C-B1FD-59D1B62C3B50 */
            USER_POLICY_PRESENT_GUID, 0x54FB46C8, 0xF089, 0x464C, 0xB1, 0xFD,
            0x59, 0xD1, 0xB6, 0x2C, 0x3B, 0x50);
...
DEFINE_GUID(/* bc90d167-9470-4139-a9ba-be0bbbf5b74d */
            RPC_INTERFACE_EVENT_GUID, 0xbc90d167, 0x9470, 0x4139, 0xa9, 0xba,
            0xbe, 0x0b, 0xbb, 0xf5, 0xb7, 0x4d);

DEFINE_GUID(/* 1f81d131-3fac-4537-9e0c-7e7b0c2f4b55 */
            NAMED_PIPE_EVENT_GUID, 0x1f81d131, 0x3fac, 0x4537, 0x9e, 0x0c, 0x7e,
            0x7b, 0x0c, 0x2f, 0x4b, 0x55);
...
DEFINE_GUID(/* 2d7a2816-0c5e-45fc-9ce7-570e5ecde9c9 */
            CUSTOM_SYSTEM_STATE_CHANGE_EVENT_GUID, 0x2d7a2816, 0x0c5e, 0x45fc,
...
typedef struct _SERVICE_TRIGGER {
  ...
  GUID *pTriggerSubtype; // Provider GUID if the trigger type is
                         // SERVICE_TRIGGER_TYPE_CUSTOM Device class interface
                         // GUID if the trigger type is
...
#define SC_AGGREGATE_STORAGE_KEY                                               \
...
typedef VOID WINAPI SERVICE_MAIN_FUNCTIONW(DWORD dwNumServicesArgs,
                                           LPWSTR *lpServiceArgVectors);

typedef VOID WINAPI SERVICE_MAIN_FUNCTIONA(DWORD dwNumServicesArgs,
...
typedef DWORD WINAPI HANDLER_FUNCTION_EX(DWORD dwControl, DWORD dwEventType,
...
//
typedef VOID(CALLBACK *PFN_SC_NOTIFY_CALLBACK)(_In_ PVOID pParameter);
...
typedef SERVICE_CONTROL_STATUS_REASON_PARAMSA
    SERVICE_CONTROL_STATUS_REASON_PARAMS;
typedef PSERVICE_CONTROL_STATUS_REASON_PARAMSA
    PSERVICE_CONTROL_STATUS_REASON_PARAMS;
#endif // UNICODE
...
BOOL WINAPI ChangeServiceConfigA(
    _In_ SC_HANDLE hService, _In_ DWORD dwServiceType, _In_ DWORD dwStartType,
    ...
    _In_opt_ LPCSTR lpPassword, _In_opt_ LPCSTR lpDisplayName);
WINADVAPI
BOOL WINAPI ChangeServiceConfigW(
    _In_ SC_HANDLE hService, _In_ DWORD dwServiceType, _In_ DWORD dwStartType,
...
WINADVAPI
BOOL WINAPI ChangeServiceConfig2A(_In_ SC_HANDLE hService,
                                  _In_ DWORD dwInfoLevel,
                                  _In_opt_ LPVOID lpInfo);
WINADVAPI
BOOL WINAPI ChangeServiceConfig2W(_In_ SC_HANDLE hService,
                                  _In_ DWORD dwInfoLevel,
                                  _In_opt_ LPVOID lpInfo);
#ifdef UNICODE
...
WINADVAPI
BOOL WINAPI ControlService(_In_ SC_HANDLE hService, _In_ DWORD dwControl,
                           _Out_ LPSERVICE_STATUS lpServiceStatus);

_Must_inspect_result_ WINADVAPI SC_HANDLE WINAPI CreateServiceA(
    _In_ SC_HANDLE hSCManager, _In_ LPCSTR lpServiceName,
    ...
    _In_opt_ LPCSTR lpBinaryPathName, _In_opt_ LPCSTR lpLoadOrderGroup,
    _Out_opt_ LPDWORD lpdwTagId, _In_opt_ LPCSTR lpDependencies,
    _In_opt_ LPCSTR lpServiceStartName, _In_opt_ LPCSTR lpPassword);
_Must_inspect_result_ WINADVAPI SC_HANDLE WINAPI CreateServiceW(
    _In_ SC_HANDLE hSCManager, _In_ LPCWSTR lpServiceName,
    _In_opt_ LPCWSTR lpDisplayName, _In_ DWORD dwDesiredAccess,
    _In_ DWORD dwServiceType, _In_ DWORD dwStartType, _In_ DWORD dwErrorControl,
    _In_opt_ LPCWSTR lpBinaryPathName, _In_opt_ LPCWSTR lpLoadOrderGroup,
    _Out_opt_ LPDWORD lpdwTagId, _In_opt_ LPCWSTR lpDependencies,
    _In_opt_ LPCWSTR lpServiceStartName, _In_opt_ LPCWSTR lpPassword);
#ifdef UNICODE
...
_Must_inspect_result_ WINADVAPI BOOL WINAPI EnumDependentServicesA(
    _In_ SC_HANDLE hService, _In_ DWORD dwServiceState,
...
_Must_inspect_result_ WINADVAPI BOOL WINAPI EnumDependentServicesW(
    _In_ SC_HANDLE hService, _In_ DWORD dwServiceState,
...
_Must_inspect_result_ WINADVAPI BOOL WINAPI EnumServicesStatusA(
    _In_ SC_HANDLE hSCManager, _In_ DWORD dwServiceType,
    _In_ DWORD dwServiceState,
    _Out_writes_bytes_opt_(cbBufSize) LPENUM_SERVICE_STATUSA lpServices,
    _In_ DWORD cbBufSize, _Out_ LPDWORD pcbBytesNeeded,
    _Out_ LPDWORD lpServicesReturned, _Inout_opt_ LPDWORD lpResumeHandle);
_Must_inspect_result_ WINADVAPI BOOL WINAPI EnumServicesStatusW(
    _In_ SC_HANDLE hSCManager, _In_ DWORD dwServiceType,
    _In_ DWORD dwServiceState,
    _Out_writes_bytes_opt_(cbBufSize) LPENUM_SERVICE_STATUSW lpServices,
    _In_ DWORD cbBufSize, _Out_ LPDWORD pcbBytesNeeded,
...
_Must_inspect_result_ WINADVAPI BOOL WINAPI EnumServicesStatusExA(
    _In_ SC_HANDLE hSCManager, _In_ SC_ENUM_TYPE InfoLevel,
    _In_ DWORD dwServiceType, _In_ DWORD dwServiceState,
    _Out_writes_bytes_opt_(cbBufSize) LPBYTE lpServices, _In_ DWORD cbBufSize,
...
_Must_inspect_result_ WINADVAPI BOOL WINAPI EnumServicesStatusExW(
    _In_ SC_HANDLE hSCManager, _In_ SC_ENUM_TYPE InfoLevel,
    _In_ DWORD dwServiceType, _In_ DWORD dwServiceState,
    _Out_writes_bytes_opt_(cbBufSize) LPBYTE lpServices, _In_ DWORD cbBufSize,
    _Out_ LPDWORD pcbBytesNeeded, _Out_ LPDWORD lpServicesReturned,
...
GetServiceKeyNameA(_In_ SC_HANDLE hSCManager, _In_ LPCSTR lpDisplayName,
                   _Out_writes_opt_(*lpcchBuffer) LPSTR lpServiceName,
                   _Inout_ LPDWORD lpcchBuffer);
_Must_inspect_result_ WINADVAPI BOOL WINAPI
GetServiceKeyNameW(_In_ SC_HANDLE hSCManager, _In_ LPCWSTR lpDisplayName,
...
_Must_inspect_result_ WINADVAPI BOOL WINAPI
GetServiceDisplayNameA(_In_ SC_HANDLE hSCManager, _In_ LPCSTR lpServiceName,
                       _Out_writes_opt_(*lpcchBuffer) LPSTR lpDisplayName,
                       _Inout_ LPDWORD lpcchBuffer);
_Must_inspect_result_ WINADVAPI BOOL WINAPI
GetServiceDisplayNameW(_In_ SC_HANDLE hSCManager, _In_ LPCWSTR lpServiceName,
...
SC_LOCK
WINAPI
LockServiceDatabase(_In_ SC_HANDLE hSCManager);

WINADVAPI
BOOL WINAPI NotifyBootConfigStatus(_In_ BOOL BootAcceptable);
...
_Must_inspect_result_
    WINADVAPI SC_HANDLE WINAPI OpenSCManagerA(_In_opt_ LPCSTR lpMachineName,
                                              _In_opt_ LPCSTR lpDatabaseName,
                                              _In_ DWORD dwDesiredAccess);
_Must_inspect_result_ WINADVAPI SC_HANDLE WINAPI
OpenSCManagerW(_In_opt_ LPCWSTR lpMachineName, _In_opt_ LPCWSTR lpDatabaseName,
               _In_ DWORD dwDesiredAccess);
#ifdef UNICODE
...
_Must_inspect_result_
    WINADVAPI SC_HANDLE WINAPI OpenServiceA(_In_ SC_HANDLE hSCManager,
                                            _In_ LPCSTR lpServiceName,
                                            _In_ DWORD dwDesiredAccess);
_Must_inspect_result_ WINADVAPI SC_HANDLE WINAPI
OpenServiceW(_In_ SC_HANDLE hSCManager, _In_ LPCWSTR lpServiceName,
             _In_ DWORD dwDesiredAccess);
#ifdef UNICODE
...
_Must_inspect_result_ WINADVAPI BOOL WINAPI QueryServiceConfigA(
    _In_ SC_HANDLE hService,
    _Out_writes_bytes_opt_(cbBufSize) LPQUERY_SERVICE_CONFIGA lpServiceConfig,
    _In_ DWORD cbBufSize, _Out_ LPDWORD pcbBytesNeeded);
_Must_inspect_result_ WINADVAPI BOOL WINAPI QueryServiceConfigW(
    _In_ SC_HANDLE hService,
...
_When_(dwInfoLevel == SERVICE_CONFIG_DESCRIPTION,
    ...
    _When_(dwInfoLevel == SERVICE_CONFIG_FAILURE_ACTIONS,
        ...
        _When_(dwInfoLevel == SERVICE_CONFIG_REQUIRED_PRIVILEGES_INFO,
            ...
            _Must_inspect_result_ WINADVAPI BOOL WINAPI
    QueryServiceConfig2A(_In_ SC_HANDLE hService, _In_ DWORD dwInfoLevel,
...
_When_(dwInfoLevel == SERVICE_CONFIG_DESCRIPTION,
    ...
    _When_(dwInfoLevel == SERVICE_CONFIG_FAILURE_ACTIONS,
        ...
        _When_(dwInfoLevel == SERVICE_CONFIG_REQUIRED_PRIVILEGES_INFO,
            ...
            _Must_inspect_result_ WINADVAPI BOOL WINAPI
    QueryServiceConfig2W(_In_ SC_HANDLE hService, _In_ DWORD dwInfoLevel,
                         _Out_writes_bytes_opt_(cbBufSize) LPBYTE lpBuffer,
                         _In_ DWORD cbBufSize, _Out_ LPDWORD pcbBytesNeeded);
#ifdef UNICODE
...
_Must_inspect_result_ WINADVAPI BOOL WINAPI QueryServiceLockStatusA(
    _In_ SC_HANDLE hSCManager,
    _Out_writes_bytes_opt_(cbBufSize) LPQUERY_SERVICE_LOCK_STATUSA lpLockStatus,
    _In_ DWORD cbBufSize, _Out_ LPDWORD pcbBytesNeeded);
_Must_inspect_result_ WINADVAPI BOOL WINAPI QueryServiceLockStatusW(
    _In_ SC_HANDLE hSCManager,
...
_Must_inspect_result_ WINADVAPI BOOL WINAPI QueryServiceObjectSecurity(
    _In_ SC_HANDLE hService, _In_ SECURITY_INFORMATION dwSecurityInformation,
...
_Must_inspect_result_ WINADVAPI BOOL WINAPI QueryServiceStatus(
    _In_ SC_HANDLE hService, _Out_ LPSERVICE_STATUS lpServiceStatus);

_Must_inspect_result_ WINADVAPI BOOL WINAPI
QueryServiceStatusEx(_In_ SC_HANDLE hService, _In_ SC_STATUS_TYPE InfoLevel,
                     _Out_writes_bytes_opt_(cbBufSize) LPBYTE lpBuffer,
                     _In_ DWORD cbBufSize, _Out_ LPDWORD pcbBytesNeeded);

_Must_inspect_result_ WINADVAPI SERVICE_STATUS_HANDLE WINAPI
RegisterServiceCtrlHandlerA(_In_ LPCSTR lpServiceName,
                            _In_ __callback LPHANDLER_FUNCTION lpHandlerProc);
_Must_inspect_result_ WINADVAPI SERVICE_STATUS_HANDLE WINAPI
RegisterServiceCtrlHandlerW(_In_ LPCWSTR lpServiceName,
                            _In_ __callback LPHANDLER_FUNCTION lpHandlerProc);
#ifdef UNICODE
...
_Must_inspect_result_ WINADVAPI SERVICE_STATUS_HANDLE WINAPI
RegisterServiceCtrlHandlerExW(_In_ LPCWSTR lpServiceName,
                              _In_ __callback LPHANDLER_FUNCTION_EX
                                  lpHandlerProc,
                              _In_opt_ LPVOID lpContext);
#ifdef UNICODE
...
WINADVAPI
BOOL WINAPI SetServiceObjectSecurity(
    _In_ SC_HANDLE hService, _In_ SECURITY_INFORMATION dwSecurityInformation,
    _In_ PSECURITY_DESCRIPTOR lpSecurityDescriptor);

WINADVAPI
BOOL WINAPI SetServiceStatus(_In_ SERVICE_STATUS_HANDLE hServiceStatus,
...
WINADVAPI
BOOL WINAPI StartServiceA(_In_ SC_HANDLE hService, _In_ DWORD dwNumServiceArgs,
                          _In_reads_opt_(dwNumServiceArgs)
                              LPCSTR *lpServiceArgVectors);
WINADVAPI
BOOL WINAPI StartServiceW(_In_ SC_HANDLE hService, _In_ DWORD dwNumServiceArgs,
                          _In_reads_opt_(dwNumServiceArgs)
...
DWORD
WINAPI
NotifyServiceStatusChangeA(_In_ SC_HANDLE hService, _In_ DWORD dwNotifyMask,
                           _In_ PSERVICE_NOTIFYA pNotifyBuffer);
WINADVAPI
DWORD
WINAPI
NotifyServiceStatusChangeW(_In_ SC_HANDLE hService, _In_ DWORD dwNotifyMask,
...
WINADVAPI
BOOL WINAPI ControlServiceExA(_In_ SC_HANDLE hService, _In_ DWORD dwControl,
                              _In_ DWORD dwInfoLevel,
                              _Inout_ PVOID pControlParams);
WINADVAPI
BOOL WINAPI ControlServiceExW(_In_ SC_HANDLE hService, _In_ DWORD dwControl,
                              _In_ DWORD dwInfoLevel,
                              _Inout_ PVOID pControlParams);
#ifdef UNICODE
...
WINADVAPI
BOOL WINAPI QueryServiceDynamicInformation(
    _In_ SERVICE_STATUS_HANDLE hServiceStatus, _In_ DWORD dwInfoLevel,
...
typedef VOID CALLBACK SC_NOTIFICATION_CALLBACK(_In_ DWORD dwNotify,
...
DWORD
WINAPI
WaitServiceState(_In_ SC_HANDLE hService, _In_ DWORD dwNotify,
                 _In_opt_ DWORD dwTimeout, _In_opt_ HANDLE hCancelEvent);
...
_Must_inspect_result_ DWORD WINAPI
GetServiceRegistryStateKey(_In_ SERVICE_STATUS_HANDLE ServiceStatusHandle,
                           _In_ SERVICE_REGISTRY_STATE_TYPE StateType,
                           _In_ DWORD AccessMask, _Out_ HKEY *ServiceStateKey);
...
_Must_inspect_result_ DWORD WINAPI GetServiceDirectory(
    _In_ SERVICE_STATUS_HANDLE hServiceStatus,
    _In_ SERVICE_DIRECTORY_TYPE eDirectoryType,
    _Out_writes_opt_(cchPathBufferLength) PWCHAR lpPathBuffer,
    _In_ DWORD cchPathBufferLength, _Out_ DWORD *lpcchRequiredBufferLength);
...
_Must_inspect_result_ DWORD WINAPI GetSharedServiceRegistryStateKey(
    _In_ SC_HANDLE ServiceHandle,
    _In_ SERVICE_SHARED_REGISTRY_STATE_TYPE StateType, _In_ DWORD AccessMask,
...
_Must_inspect_result_ DWORD WINAPI GetSharedServiceDirectory(
    _In_ SC_HANDLE ServiceHandle,
    _In_ SERVICE_SHARED_DIRECTORY_TYPE DirectoryType,
    _Out_writes_to_opt_(PathBufferLength, *RequiredBufferLength)
        PWCHAR PathBuffer,
    _In_ DWORD PathBufferLength, _Out_ DWORD *RequiredBufferLength);
