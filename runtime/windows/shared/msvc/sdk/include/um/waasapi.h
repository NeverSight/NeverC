...
typedef struct IWaaSAssessorVtbl {
  ...
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in IWaaSAssessor *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IWaaSAssessor *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IWaaSAssessor *This);
...
interface IWaaSAssessor { CONST_VTBL struct IWaaSAssessorVtbl *lpVtbl; };
...
#define IWaaSAssessor_AddRef(This) ((This)->lpVtbl->AddRef(This))

#define IWaaSAssessor_Release(This) ((This)->lpVtbl->Release(This))
...
class DECLSPEC_UUID("098ef871-fa9f-46af-8958-c083515d7c9c") WaaSAssessor;
#endif
