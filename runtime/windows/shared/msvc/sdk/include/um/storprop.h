...
DWORD
CdromCddaInfo(IN HDEVINFO HDevInfo, IN PSP_DEVINFO_DATA DevInfoData,
...
LONG CdromIsDigitalPlaybackEnabled(IN HDEVINFO DevInfo,
                                   IN PSP_DEVINFO_DATA DevInfoData,
                                   OUT PBOOLEAN Enabled);

LONG CdromSetDefaultDvdRegion(IN GEOID GeoId);
