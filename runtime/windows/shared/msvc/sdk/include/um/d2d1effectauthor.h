...
/// </summary>
typedef HRESULT(CALLBACK *PD2D1_PROPERTY_SET_FUNCTION)(_In_ IUnknown *effect,
                                                       _In_reads_(dataSize)
                                                           const BYTE *data,
                                                       UINT32 dataSize);
...
typedef HRESULT(CALLBACK *PD2D1_PROPERTY_GET_FUNCTION)(
    _In_ const IUnknown *effect, _Out_writes_opt_(dataSize) BYTE *data,
...
/// <summary>
/// Indicates what has changed since the last time the effect was asked to
/// prepare to render.
/// </summary>
...
typedef enum D2D1_PIXEL_OPTIONS {
  ...
  /// <summary>
  /// Indicates that the shader samples its inputs only at exactly the same
  /// scene coordinate as the output pixel, and that it returns transparent
...
typedef enum D2D1_VERTEX_OPTIONS {
  ...
  /// <summary>
  /// Indicates that the output rectangle does not need to be cleared before
  /// drawing custom vertices. This must only be used by transforms whose custom
  /// vertices completely cover their output rectangle.
  /// </summary>
  D2D1_VERTEX_OPTIONS_DO_NOT_CLEAR = 1,

  /// <summary>
  /// Causes a depth buffer to be used while drawing custom vertices. This
  /// impacts drawing behavior when primitives overlap one another.
  /// </summary>
  D2D1_VERTEX_OPTIONS_USE_DEPTH_BUFFER = 2,

  /// <summary>
  /// Indicates that custom vertices do not form primitives which overlap one
  /// another.
  /// </summary>
...
/// <summary>
/// Represents filtering modes transforms may select to use on their input
/// textures.
/// </summary>
...
/// <summary>
/// This is used to define a resource texture when that resource texture is
/// created.
/// </summary>
...
/// <summary>
/// This defines the input layout of vertices and the vertex shader which
/// processes them.
/// </summary>
...
/// <summary>
/// Indicates support for features which are optional on D3D10 feature levels.
/// This may be populated using CheckFeatureSupport.
/// </summary>
...
/// </summary>
interface DX_DECLARE_INTERFACE("9b8b1336-00a5-4668-92b7-ced5d8bf9b7b")
    ID2D1VertexBuffer : public IUnknown {

  STDMETHOD(Map)(_Outptr_result_bytebuffer_(bufferSize) BYTE * *data,
                 UINT32 bufferSize) PURE;

  STDMETHOD(Unmap)() PURE;
}; // interface ID2D1VertexBuffer

interface DX_DECLARE_INTERFACE("688d15c3-02b0-438d-b13a-d1b44c32c39a")
    ID2D1ResourceTexture : public IUnknown {

  /// <summary>
  /// Update the vertex text.
  /// </summary>
  STDMETHOD(Update)(_In_reads_opt_(dimensions) CONST UINT32 * minimumExtents,
                    _In_reads_opt_(dimensions) CONST UINT32 * maximimumExtents,
                    _In_reads_opt_(dimensions - 1) CONST UINT32 * strides,
                    UINT32 dimensions, _In_reads_(dataCount) CONST BYTE * data,
                    UINT32 dataCount) PURE;
}; // interface ID2D1ResourceTexture

/// <summary>
/// A transform uses this interface to specify how to render a particular pass
/// in D2D.
/// </summary>
interface DX_DECLARE_INTERFACE("519ae1bd-d19a-420d-b849-364f594776b7")
  ...
  /// <summary>
  /// Controls the output precision and channel-depth for the associated
  /// transform.
  /// </summary>
  ...
  /// provided, it may improve performance when processing large images.
  /// Instructions should be counted multiple times if occurring within loops.
  /// </summary>
...
/// <summary>
/// A transform uses this interface to specify how to render a particular pass
/// using pixel and vertex shaders.
/// </summary>
interface DX_DECLARE_INTERFACE("693ce632-7f2f-45de-93fe-18d88b37aa21")
  ...
  STDMETHOD(SetPixelShaderConstantBuffer)(
      _In_reads_(bufferCount) CONST BYTE * buffer, UINT32 bufferCount) PURE;

  /// <summary>
  /// Sets the resource texture corresponding to the given shader texture index.
  /// </summary>
  STDMETHOD(SetResourceTexture)(UINT32 textureIndex, _In_ ID2D1ResourceTexture *
                                                         resourceTexture) PURE;
  ...
  /// </summary>
  STDMETHOD(SetPixelShader)(_In_ REFGUID shaderId,
  ...
  STDMETHOD(SetVertexProcessing)(
      ...
      _In_opt_ CONST GUID *vertexShader = NULL) PURE;
...
/// </summary>
interface DX_DECLARE_INTERFACE("5598b14b-9fd7-48b7-9bdb-8f0964eb38bc")
...
/// </summary>
interface DX_DECLARE_INTERFACE("b2efe1e7-729f-4102-949f-505fa21bf666")
...
/// </summary>
interface DX_DECLARE_INTERFACE("13d29038-c3e6-4034-9081-13b53a417992")
  ...
  /// <summary>
  /// Sets the graph to contain a single transform whose inputs map 1:1 with
  /// effect inputs.
  /// </summary>
  ...
  /// <summary>
  /// Indicates that the given transform node should be considered to be the
  ...
  /// </summary>
  STDMETHOD(ConnectNode)(_In_ ID2D1TransformNode * fromNode,
                         _In_ ID2D1TransformNode * toNode,
                         UINT32 toNodeInputIndex) PURE;

  /// <summary>
  /// Connects a transform node inside the graph to the corresponding input of
...
/// </summary>
interface DX_DECLARE_INTERFACE("ef1a287d-342a-4f76-8fdb-da0d6ea9f92b")
  ...
  STDMETHOD(MapInputRectsToOutputRect)(
      ...
      UINT32 inputRectCount, _Out_ D2D1_RECT_L * outputRect,
      _Out_ D2D1_RECT_L * outputOpaqueSubRect) PURE;

  STDMETHOD(MapInvalidRect)(UINT32 inputIndex, D2D1_RECT_L invalidInputRect,
                            _Out_ D2D1_RECT_L * invalidOutputRect) CONST PURE;
}; // interface ID2D1Transform

/// <summary>
/// The interface implemented by a transform author to provide a GPU-based
/// effect.
/// </summary>
interface DX_DECLARE_INTERFACE("36bfdcb6-9739-435d-a30d-a653beff6a6f")
...
/// based effect.
/// </summary>
interface DX_DECLARE_INTERFACE("0d85573c-01e3-4f7d-bfd9-0d60608bf3c3")
  ...
  STDMETHOD(CalculateThreadgroups)(
      _In_ CONST D2D1_RECT_L * outputRect, _Out_ UINT32 * dimensionX,
      _Out_ UINT32 * dimensionY, _Out_ UINT32 * dimensionZ) PURE;
...
/// </summary>
interface DX_DECLARE_INTERFACE("0359dc30-95e6-4568-9055-27720d130e93")
    ID2D1AnalysisTransform : public IUnknown {

  STDMETHOD(ProcessAnalysisResults)(_In_reads_(analysisDataCount) CONST BYTE *
                                        analysisData,
                                    UINT32 analysisDataCount) PURE;
}; // interface ID2D1AnalysisTransform

/// <summary>
/// The interface implemented by a transform author to provide a CPU based
/// source effect.
/// </summary>
interface DX_DECLARE_INTERFACE("db1800dd-0c34-4cf9-be90-31cc0a5653e1")
    ID2D1SourceTransform : public ID2D1Transform {

  STDMETHOD(SetRenderInfo)(_In_ ID2D1RenderInfo * renderInfo) PURE;

  STDMETHOD(Draw)(_In_ ID2D1Bitmap1 * target, _In_ CONST D2D1_RECT_L * drawRect,
                  D2D1_POINT_2U targetOrigin) PURE;
...
/// controlled.
/// </summary>
interface DX_DECLARE_INTERFACE("1a799d8a-69f7-4e4c-9fed-437ccc6684cc")
...
/// </summary>
interface DX_DECLARE_INTERFACE("63ac0b32-ba44-450f-8806-7f4ca1ff2f1b")
    ID2D1BlendTransform : public ID2D1ConcreteTransform {

  STDMETHOD_(void, SetDescription)(_In_ CONST D2D1_BLEND_DESCRIPTION *
                                   description) PURE;

  STDMETHOD_(void, GetDescription)(_Out_ D2D1_BLEND_DESCRIPTION * description)
      CONST PURE;
...
/// </summary>
interface DX_DECLARE_INTERFACE("4998735c-3a19-473c-9781-656847e3a347")
...
/// <summary>
/// An effect uses this interface to offset an image without inserting a
/// rendering pass.
/// </summary>
interface DX_DECLARE_INTERFACE("3fe6adea-7643-4f53-bd14-a0ce63f24042")
...
/// </summary>
interface DX_DECLARE_INTERFACE("90f732e2-5092-4606-a819-8651970baccd")
  ...
  STDMETHOD_(void, GetOutputBounds)(_Out_ D2D1_RECT_L * outputBounds)
      CONST PURE;
...
/// </summary>
interface DX_DECLARE_INTERFACE("a248fd3f-3e6c-4e63-9f03-7f68ecc91db9")
    ID2D1EffectImpl : public IUnknown {

  /// <summary>
  /// Initialize the effect with a context and a transform graph. The effect
  /// must populate the transform graph with a topology and can update it later.
  /// </summary>
  STDMETHOD(Initialize)(_In_ ID2D1EffectContext * effectContext,
                        _In_ ID2D1TransformGraph * transformGraph) PURE;
  ...
  /// inputs to the effect changes, if the effect support a variable number of
  /// inputs.
  /// </summary>
...
/// <summary>
/// The internal context handed to effect authors to create transforms from
/// effects and any other operation tied to context which is not useful to the
/// application facing API.
/// </summary>
interface DX_DECLARE_INTERFACE("3d9f916b-27dc-4ad7-b4f1-64945340f563")
  ...
  /// registered through ID2D1Factory1::RegisterEffect.
  /// </summary>
  ...
  /// </summary>
  STDMETHOD(CreateTransformNodeFromEffect)(_In_ ID2D1Effect * effect,
                                           _COM_Outptr_ ID2D1TransformNode *
                                               *transformNode) PURE;

  STDMETHOD(CreateBlendTransform)(
      UINT32 numInputs, _In_ CONST D2D1_BLEND_DESCRIPTION * blendDescription,
      _COM_Outptr_ ID2D1BlendTransform * *transform) PURE;

  STDMETHOD(CreateBorderTransform)(
      D2D1_EXTEND_MODE extendModeX, D2D1_EXTEND_MODE extendModeY,
      _COM_Outptr_ ID2D1BorderTransform * *transform) PURE;

  STDMETHOD(CreateOffsetTransform)(
      D2D1_POINT_2L offset, _COM_Outptr_ ID2D1OffsetTransform * *transform)
      PURE;

  STDMETHOD(CreateBoundsAdjustmentTransform)(
      _In_ CONST D2D1_RECT_L * outputRectangle,
      _COM_Outptr_ ID2D1BoundsAdjustmentTransform * *transform) PURE;

  STDMETHOD(LoadPixelShader)(
      REFGUID shaderId, _In_reads_(shaderBufferCount) CONST BYTE * shaderBuffer,
      UINT32 shaderBufferCount) PURE;

  STDMETHOD(LoadVertexShader)(REFGUID resourceId,
                              _In_reads_(shaderBufferCount) CONST BYTE *
                                  shaderBuffer,
                              UINT32 shaderBufferCount) PURE;

  STDMETHOD(LoadComputeShader)(REFGUID resourceId,
                               _In_reads_(shaderBufferCount) CONST BYTE *
                                   shaderBuffer,
                               UINT32 shaderBufferCount) PURE;
  ...
  STDMETHOD(CreateResourceTexture)(
      ...
      _In_reads_opt_(resourceTextureProperties->dimensions - 1) CONST UINT32 *
          strides,
      UINT32 dataSize, _COM_Outptr_ ID2D1ResourceTexture * *resourceTexture)
      PURE;

  STDMETHOD(FindResourceTexture)(_In_ CONST GUID * resourceId,
                                 _COM_Outptr_ ID2D1ResourceTexture *
                                     *resourceTexture) PURE;
  ...
  STDMETHOD(CreateVertexBuffer)(
      ...
      _COM_Outptr_ ID2D1VertexBuffer * *buffer) PURE;

  STDMETHOD(FindVertexBuffer)(_In_ CONST GUID * resourceId,
                              _COM_Outptr_ ID2D1VertexBuffer * *buffer) PURE;
