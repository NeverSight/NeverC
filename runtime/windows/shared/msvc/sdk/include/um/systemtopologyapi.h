...
WINBASEAPI
BOOL WINAPI GetNumaNodeProcessorMaskEx(_In_ USHORT Node,
...
_Success_(return != false) WINBASEAPI BOOL WINAPI
    GetNumaNodeProcessorMask2(_In_ USHORT NodeNumber,
                              _Out_writes_to_opt_(ProcessorMaskCount,
                                                  *RequiredMaskCount)
...
WINBASEAPI
BOOL WINAPI GetNumaProximityNodeEx(_In_ ULONG ProximityId,
