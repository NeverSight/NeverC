...
#define TARGET_CLIENT_CONNECTION_MONITORING                                    \
  _T("TargetClientConnectionMonitoring")
...
#define CONN_REQUEST_CLIENT_ADDRESS_FAMILY                                     \
  _T("ConnectionRequestClientAddressFamily")
#define CONN_REQUEST_CLIENT_ADDRESS _T("ConnectionRequestClientAddress")
#define CONN_REQUEST_CLIENT_BUILD_NUMBER                                       \
  _T("ConnectionRequestClientBuildNumber")
#define CONN_REQUEST_PROTOCOL_TYPE _T("ConnectionRequestProtocolType")
#define CONN_REQUEST_CLIENT_TIME_ZONE_BIAS                                     \
  _T("ConnectionRequestClinetTimeZoneBias")
#define CONN_REQUEST_CLIENT_TIME_ZONE_STANDARD_BIAS                            \
  _T("ConnectionRequestClinetTimeZoneStandardBias")
#define CONN_REQUEST_CLIENT_TIME_ZONE_DAYLIGHT_BIAS                            \
  _T("ConnectionRequestClinetTimeZoneDaylightBias")
#define CONN_REQUEST_CLIENT_TIME_ZONE_STANDARD_NAME                            \
  _T("ConnectionRequestClinetTimeZoneStandardName")
#define CONN_REQUEST_CLIENT_TIME_ZONE_DAYLIGHT_NAME                            \
  _T("ConnectionRequestClinetTimeZoneDaylightName")
typedef /* [v1_enum] */
...
typedef /* [v1_enum] */
    enum _CLIENT_MESSAGE_TYPE {
      ...
      CLIENT_MESSAGE_CONNECTION_STATUS =
          (CLIENT_MESSAGE_CONNECTION_INVALID + 1),
...
typedef /* [v1_enum] */
    enum _CONNECTION_CHANGE_NOTIFICATION {
      ...
      CONNECTION_REQUEST_QUERY_PL_COMPLETED =
          (CONNECTION_REQUEST_LB_COMPLETED + 1),
      CONNECTION_REQUEST_ORCH_COMPLETED =
          (CONNECTION_REQUEST_QUERY_PL_COMPLETED + 1)
    } CONNECTION_CHANGE_NOTIFICATION;

// begin_wpp config
// CUSTOM_TYPE(ConnChangeNotification,
// ItemEnum(_CONNECTION_CHANGE_NOTIFICATION)); end_wpp
typedef /* [v1_enum] */
    enum _RD_FARM_TYPE {
      RD_FARM_RDSH = 0,
      RD_FARM_TEMP_VM = 1,
...
// end_wpp
typedef /* [public] */
    struct __MIDL___MIDL_itf_sessdirpublictypes_0000_0000_0001 {
...
typedef /* [public] */
    struct __MIDL___MIDL_itf_sessdirpublictypes_0000_0000_0002 {
