...
NetUserAdd(_In_opt_ LPCWSTR servername OPTIONAL, _In_ DWORD level,
...
NET_API_STATUS NET_API_FUNCTION NetUserEnum(
    _In_opt_ LPCWSTR servername OPTIONAL, _In_ DWORD level, _In_ DWORD filter,
    _Outptr_result_buffer_(_Inexpressible_("varies")) LPBYTE *bufptr,
    _In_ DWORD prefmaxlen, _Out_ LPDWORD entriesread,
    _Out_ LPDWORD totalentries, _Inout_opt_ PDWORD resume_handle OPTIONAL);

NET_API_STATUS NET_API_FUNCTION NetUserGetInfo(
    _In_opt_ LPCWSTR servername OPTIONAL, _In_ LPCWSTR username,
    _In_ DWORD level,
    _Outptr_result_buffer_(_Inexpressible_("varies")) LPBYTE *bufptr);

NET_API_STATUS NET_API_FUNCTION NetUserSetInfo(
    _In_opt_ LPCWSTR servername OPTIONAL, _In_ LPCWSTR username,
    _In_ DWORD level, _In_reads_(_Inexpressible_("varies")) LPBYTE buf,
    _Out_opt_ LPDWORD parm_err OPTIONAL);

NET_API_STATUS NET_API_FUNCTION NetUserDel(_In_opt_ LPCWSTR servername OPTIONAL,
...
NET_API_STATUS NET_API_FUNCTION NetUserGetLocalGroups(
    _In_opt_ LPCWSTR servername OPTIONAL, _In_ LPCWSTR username,
    _In_ DWORD level, _In_ DWORD flags,
    _Outptr_result_buffer_(_Inexpressible_("varies")) LPBYTE *bufptr,
    _In_ DWORD prefmaxlen, _Out_ LPDWORD entriesread,
    _Out_ LPDWORD totalentries);

NET_API_STATUS NET_API_FUNCTION NetUserModalsGet(
    _In_opt_ LPCWSTR servername OPTIONAL, _In_ DWORD level,
    _Outptr_result_buffer_(_Inexpressible_("varies")) LPBYTE *bufptr);

NET_API_STATUS NET_API_FUNCTION
NetUserModalsSet(_In_opt_ LPCWSTR servername OPTIONAL, _In_ DWORD level,
                 _In_reads_(_Inexpressible_("varies")) LPBYTE buf,
                 _Out_opt_ LPDWORD parm_err OPTIONAL);

NET_API_STATUS NET_API_FUNCTION
NetUserChangePassword(_In_opt_ IN LPCWSTR domainname OPTIONAL,
                      _In_opt_ IN LPCWSTR username OPTIONAL,
                      _In_ IN LPCWSTR oldpassword, _In_ IN LPCWSTR newpassword);
...
NET_API_STATUS NET_API_FUNCTION
NetGroupAdd(_In_opt_ LPCWSTR servername OPTIONAL, _In_ DWORD level,
            _In_reads_(_Inexpressible_("varies")) LPBYTE buf,
            _Out_opt_ LPDWORD parm_err OPTIONAL);

NET_API_STATUS NET_API_FUNCTION
NetGroupAddUser(_In_opt_ LPCWSTR servername OPTIONAL, _In_ LPCWSTR GroupName,
                _In_ LPCWSTR username);
...
NET_API_STATUS NET_API_FUNCTION NetGroupEnum(
    ...
    _Outptr_result_buffer_(_Inexpressible_("varies")) LPBYTE *bufptr,
    _In_ DWORD prefmaxlen, _Out_ LPDWORD entriesread,
    _Out_ LPDWORD totalentries, _Inout_opt_ PDWORD_PTR resume_handle OPTIONAL);

NET_API_STATUS NET_API_FUNCTION NetGroupGetInfo(
    _In_opt_ LPCWSTR servername OPTIONAL, _In_ LPCWSTR groupname,
    _In_ DWORD level,
    _Outptr_result_buffer_(_Inexpressible_("varies")) LPBYTE *bufptr);
...
NET_API_STATUS NET_API_FUNCTION
NetGroupDel(_In_opt_ LPCWSTR servername OPTIONAL, _In_ LPCWSTR groupname);

NET_API_STATUS NET_API_FUNCTION
NetGroupDelUser(_In_opt_ LPCWSTR servername OPTIONAL, _In_ LPCWSTR GroupName,
                _In_ LPCWSTR Username);
...
NET_API_STATUS NET_API_FUNCTION
NetLocalGroupAdd(_In_opt_ LPCWSTR servername OPTIONAL, _In_ DWORD level,
                 _In_reads_(_Inexpressible_("varies")) LPBYTE buf,
                 _Out_opt_ LPDWORD parm_err OPTIONAL);

NET_API_STATUS NET_API_FUNCTION
NetLocalGroupAddMember(_In_opt_ LPCWSTR servername OPTIONAL,
                       _In_ LPCWSTR groupname, _In_ PSID membersid);

NET_API_STATUS NET_API_FUNCTION NetLocalGroupEnum(
    _In_opt_ LPCWSTR servername OPTIONAL, _In_ DWORD level,
    _Outptr_result_buffer_(_Inexpressible_("varies")) LPBYTE *bufptr,
    _In_ DWORD prefmaxlen, _Out_ LPDWORD entriesread,
    _Out_ LPDWORD totalentries, _Inout_opt_ PDWORD_PTR resumehandle OPTIONAL);
...
NET_API_STATUS NET_API_FUNCTION
NetLocalGroupDel(_In_opt_ LPCWSTR servername OPTIONAL, _In_ LPCWSTR groupname);

NET_API_STATUS NET_API_FUNCTION
NetLocalGroupDelMember(_In_opt_ LPCWSTR servername OPTIONAL,
                       _In_ LPCWSTR groupname, _In_ PSID membersid);

NET_API_STATUS NET_API_FUNCTION NetLocalGroupGetMembers(
    _In_opt_ LPCWSTR servername OPTIONAL, _In_ LPCWSTR localgroupname,
    _In_ DWORD level,
    _Outptr_result_buffer_(_Inexpressible_("varies")) LPBYTE *bufptr,
    _In_ DWORD prefmaxlen, _Out_ LPDWORD entriesread,
    _Out_ LPDWORD totalentries, _Inout_opt_ PDWORD_PTR resumehandle);
...
NET_API_STATUS NET_API_FUNCTION NetQueryDisplayInformation(
    IN LPCWSTR ServerName OPTIONAL, IN DWORD Level, IN DWORD Index,
    IN DWORD EntriesRequested, IN DWORD PreferredMaximumLength,
    OUT LPDWORD ReturnedEntryCount, OUT PVOID *SortedBuffer);

NET_API_STATUS NET_API_FUNCTION
NetGetDisplayInformationIndex(IN LPCWSTR ServerName OPTIONAL, IN DWORD Level,
...
NET_API_STATUS NET_API_FUNCTION
NetAccessAdd(_In_opt_ LPCWSTR servername OPTIONAL, _In_ DWORD level,
             _In_reads_(_Inexpressible_("varies")) LPBYTE buf,
             _Out_opt_ LPDWORD parm_err OPTIONAL);

NET_API_STATUS NET_API_FUNCTION NetAccessEnum(
    _In_opt_ LPCWSTR servername OPTIONAL, _In_ LPCWSTR BasePath,
    _In_ DWORD Recursive, _In_ DWORD level,
    _Outptr_result_buffer_(_Inexpressible_("varies")) LPBYTE *bufptr,
    _In_ DWORD prefmaxlen, _Out_ LPDWORD entriesread,
    _Out_ LPDWORD totalentries, _Inout_opt_ LPDWORD resume_handle OPTIONAL);

NET_API_STATUS NET_API_FUNCTION NetAccessGetInfo(
    _In_opt_ LPCWSTR servername OPTIONAL, _In_ LPCWSTR resource,
    _In_ DWORD level,
    _Outptr_result_buffer_(_Inexpressible_("varies")) LPBYTE *bufptr);
...
NET_API_STATUS NET_API_FUNCTION NetAccessDel(IN LPCWSTR servername OPTIONAL,
                                             IN LPCWSTR resource);

NET_API_STATUS NET_API_FUNCTION
NetAccessGetUserPerms(IN LPCWSTR servername OPTIONAL, IN LPCWSTR UGname,
...
//        LockoutTime: When the account is locked out. If the account is not
//        locked out
//            it is 0.
//        BadPasswordCount: How many times the password has given incorrectly in
//        the
//            Observation Window.
...
//    PasswordMatched: Indicates the result of the application's authentication
...
//    UserAccountName: Name of the user account
//    HashedPassword: Hash of the string that the password is going to be
//    PasswordMustChangeAtNextLogon: Password must change for the user to be
//    logged in ClearLockout: If the account was locked out, this field can be
...
NET_API_STATUS NET_API_FUNCTION
NetValidatePasswordPolicy(IN LPCWSTR ServerName, IN LPVOID Qualifier,
                          IN NET_VALIDATE_PASSWORD_TYPE ValidationType,
                          IN LPVOID InputArg, OUT LPVOID *OutputArg);

NET_API_STATUS NET_API_FUNCTION
NetValidatePasswordPolicyFree(IN LPVOID *OutputArg);
...
_Success_(return == ERROR_SUCCESS) NET_API_STATUS NET_API_FUNCTION
    NetGetDCName(_In_opt_ LPCWSTR ServerName, _In_opt_ LPCWSTR DomainName,
                 _Outptr_result_nullonfailure_ _At_((LPWSTR *)Buffer,
                                                    _Outptr_result_z_)
                     LPBYTE *Buffer);

_Success_(return == ERROR_SUCCESS) NET_API_STATUS NET_API_FUNCTION
    NetGetAnyDCName(_In_opt_ LPCWSTR ServerName, _In_opt_ LPCWSTR DomainName,
                    _Outptr_result_nullonfailure_ _At_((LPWSTR *)Buffer,
                                                       _Outptr_result_z_)
                        LPBYTE *Buffer);
...
NET_API_STATUS NET_API_FUNCTION I_NetLogonControl(
    _In_opt_ LPCWSTR ServerName OPTIONAL, _In_ DWORD FunctionCode,
...
NET_API_STATUS NET_API_FUNCTION I_NetLogonControl2(
    _In_opt_ LPCWSTR ServerName OPTIONAL, _In_ DWORD FunctionCode,
    _In_ DWORD QueryLevel, _In_reads_(_Inexpressible_("varies")) LPBYTE Data,
    _Outptr_result_buffer_(_Inexpressible_("varies")) LPBYTE *Buffer);
...
NTSTATUS NET_API_FUNCTION NetEnumerateTrustedDomains(
    _In_opt_ IN LPWSTR ServerName OPTIONAL, _Outptr_ OUT LPWSTR *DomainNames);
...
#define NETLOGON_CONTROL_TC_QUERY                                              \
  6 // Query status of specified trusted channel status
#define NETLOGON_CONTROL_TRANSPORT_NOTIFY                                      \
...
#define NETLOGON_CONTROL_CHANGE_PASSWORD                                       \
  9 // Change machine password on a secure channel to a trusted domain
#define NETLOGON_CONTROL_TC_VERIFY                                             \
  10 // Verify status of specified trusted channel
#define NETLOGON_CONTROL_FORCE_DNS_REG                                         \
  11 // Force DNS re-registration of all registered records
#define NETLOGON_CONTROL_QUERY_DNS_REG 12 // Query the status of DNS updates
#define NETLOGON_CONTROL_QUERY_ENC_TYPES                                       \
  13 // Query the supported encryption types
...
#ifdef MIDL_PASS
  [ string,
    range(0, LM_DNS_MAX_NAME_LENGTH + 1) ] wchar_t *netlog2_trusted_dc_name;
#else
...
#ifdef MIDL_PASS
  [ string,
    range(0, LM_DNS_MAX_NAME_LENGTH + 1) ] wchar_t *netlog4_trusted_dc_name;
  [ string,
    range(0, LM_DNS_MAX_NAME_LENGTH + 1) ] wchar_t *netlog4_trusted_domain_name;
#else
...
#define NETLOGON_FULL_SYNC_REPLICATION                                         \
  0x04                            // full sync replication required/progress
...
#define NETLOGON_HAS_TIMESERV                                                  \
  0x20 // The trusted domain DC runs the Windows Time Service
#define NETLOGON_DNS_UPDATE_FAILURE                                            \
  0x40 // There was a failure in the last update for one of the DNS records
#define NETLOGON_VERIFY_STATUS_RETURNED                                        \
  0x80 // Trust verification status returned in netlog2_pdc_connection_status
...
#define DELEGATED_MANAGED_SERVICE_ACCOUNT_PASSWORD                             \
  TEXT("_SA_{F8262F4C-499B-4770-88B4-A75C91D0D8E9}")

DEFINE_GUID( // 262e99c9-6160-4871-acec-4e61736b6f21
    ServiceAccountPasswordGUID, 0x262E99C9, 0x6160, 0x4871, 0xAC, 0xEC, 0x4E,
    0x61, 0x73, 0x6B, 0x6F, 0x21);

NTSTATUS
NetAddServiceAccount(_In_opt_ LPWSTR ServerName, _In_ LPWSTR AccountName,
                     _In_ LPWSTR Password, _In_ DWORD Flags);
...
NTSTATUS
NetRemoveServiceAccount(_In_opt_ LPWSTR ServerName, _In_ LPWSTR AccountName,
                        _In_ DWORD Flags);

NTSTATUS
NetEnumerateServiceAccounts(_In_opt_ LPWSTR ServerName, _In_ DWORD Flags,
                            _Out_ DWORD *AccountsCount,
                            _Outptr_result_buffer_(*AccountsCount)
                                PZPWSTR *Accounts);

NTSTATUS
NetIsServiceAccount(_In_opt_ LPWSTR ServerName, _In_ LPWSTR AccountName,
                    _Out_ BOOL *IsService);

NTSTATUS
NetIsServiceAccount2(_In_opt_ LPWSTR ServerName, _In_ LPWSTR AccountName,
                     _Out_ BOOL *IsService,
                     _Out_ MSA_INFO_ACCOUNT_TYPE *AccountType);

NTSTATUS
NetQueryServiceAccount(_In_opt_ LPWSTR ServerName, _In_ LPWSTR AccountName,
                       _In_ DWORD InfoLevel, _Outptr_ PBYTE *Buffer);
