...
public:
  ...
  virtual HRESULT STDMETHODCALLTYPE Ping(
      /* [range][unique][string][in] */ __RPC__in_opt_string const wchar_t
          *pwszAuthority) = 0;
};
...
typedef struct ICertRequestDVtbl {
  ...
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in ICertRequestD *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in ICertRequestD *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in ICertRequestD *This);
...
interface ICertRequestD { CONST_VTBL struct ICertRequestDVtbl *lpVtbl; };
...
typedef struct ICertRequestD2Vtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in ICertRequestD2 *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in ICertRequestD2 *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in ICertRequestD2 *This);
...
interface ICertRequestD2 { CONST_VTBL struct ICertRequestD2Vtbl *lpVtbl; };
