...
typedef interface IMFMediaSharingEngineClassFactory
...
typedef interface IMFImageSharingEngineClassFactory
...
typedef struct IMFSharingEngineClassFactoryVtbl {
  ...
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(IMFSharingEngineClassFactory *This,
                                             /* [in] */ REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(IMFSharingEngineClassFactory *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(IMFSharingEngineClassFactory *This);

  DECLSPEC_XFGVIRT(IMFSharingEngineClassFactory, CreateInstance)
  HRESULT(STDMETHODCALLTYPE *CreateInstance)(IMFSharingEngineClassFactory *This,
                                             /* [annotation][in] */
                                             _In_ DWORD dwFlags,
                                             /* [annotation][in] */
                                             _In_opt_ IMFAttributes *pAttr,
...
#define IMFSharingEngineClassFactory_AddRef(This) ((This)->lpVtbl->AddRef(This))

#define IMFSharingEngineClassFactory_Release(This)                             \
  ((This)->lpVtbl->Release(This))

#define IMFSharingEngineClassFactory_CreateInstance(This, dwFlags, pAttr,      \
                                                    ppEngine)                  \
...
typedef struct IMFMediaSharingEngineVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(IMFMediaSharingEngine *This,
                                             /* [in] */ REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(IMFMediaSharingEngine *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(IMFMediaSharingEngine *This);

  DECLSPEC_XFGVIRT(IMFMediaEngine, GetError)
  HRESULT(STDMETHODCALLTYPE *GetError)(IMFMediaSharingEngine *This,
                                       /* [annotation][out] */
                                       _Outptr_ IMFMediaError **ppError);

  DECLSPEC_XFGVIRT(IMFMediaEngine, SetErrorCode)
  HRESULT(STDMETHODCALLTYPE *SetErrorCode)(IMFMediaSharingEngine *This,
                                           /* [annotation][in] */
  ...
  HRESULT(STDMETHODCALLTYPE *SetSource)(IMFMediaSharingEngine *This,
                                        /* [annotation][in] */
                                        _In_ BSTR pUrl);

  DECLSPEC_XFGVIRT(IMFMediaEngine, GetCurrentSource)
  HRESULT(STDMETHODCALLTYPE *GetCurrentSource)(IMFMediaSharingEngine *This,
                                               /* [annotation][out] */
                                               _Out_ BSTR *ppUrl);

  DECLSPEC_XFGVIRT(IMFMediaEngine, GetNetworkState)
  USHORT(STDMETHODCALLTYPE *GetNetworkState)(IMFMediaSharingEngine *This);
  ...
  HRESULT(STDMETHODCALLTYPE *SetPreload)(IMFMediaSharingEngine *This,
                                         /* [annotation][in] */
  ...
  HRESULT(STDMETHODCALLTYPE *Load)(IMFMediaSharingEngine *This);
  ...
  USHORT(STDMETHODCALLTYPE *GetReadyState)(IMFMediaSharingEngine *This);

  DECLSPEC_XFGVIRT(IMFMediaEngine, IsSeeking)
  BOOL(STDMETHODCALLTYPE *IsSeeking)(IMFMediaSharingEngine *This);

  DECLSPEC_XFGVIRT(IMFMediaEngine, GetCurrentTime)
  double(STDMETHODCALLTYPE *GetCurrentTime)(IMFMediaSharingEngine *This);

  DECLSPEC_XFGVIRT(IMFMediaEngine, SetCurrentTime)
  HRESULT(STDMETHODCALLTYPE *SetCurrentTime)(IMFMediaSharingEngine *This,
                                             /* [annotation][in] */
                                             _In_ double seekTime);

  DECLSPEC_XFGVIRT(IMFMediaEngine, GetStartTime)
  double(STDMETHODCALLTYPE *GetStartTime)(IMFMediaSharingEngine *This);

  DECLSPEC_XFGVIRT(IMFMediaEngine, GetDuration)
  double(STDMETHODCALLTYPE *GetDuration)(IMFMediaSharingEngine *This);

  DECLSPEC_XFGVIRT(IMFMediaEngine, IsPaused)
  BOOL(STDMETHODCALLTYPE *IsPaused)(IMFMediaSharingEngine *This);
  ...
  double(STDMETHODCALLTYPE *GetPlaybackRate)(IMFMediaSharingEngine *This);

  DECLSPEC_XFGVIRT(IMFMediaEngine, SetPlaybackRate)
  HRESULT(STDMETHODCALLTYPE *SetPlaybackRate)(IMFMediaSharingEngine *This,
                                              /* [annotation][in] */
                                              _In_ double Rate);

  DECLSPEC_XFGVIRT(IMFMediaEngine, GetPlayed)
  HRESULT(STDMETHODCALLTYPE *GetPlayed)(IMFMediaSharingEngine *This,
                                        /* [annotation][out] */
  ...
  BOOL(STDMETHODCALLTYPE *IsEnded)(IMFMediaSharingEngine *This);

  DECLSPEC_XFGVIRT(IMFMediaEngine, GetAutoPlay)
  BOOL(STDMETHODCALLTYPE *GetAutoPlay)(IMFMediaSharingEngine *This);

  DECLSPEC_XFGVIRT(IMFMediaEngine, SetAutoPlay)
  HRESULT(STDMETHODCALLTYPE *SetAutoPlay)(IMFMediaSharingEngine *This,
                                          /* [annotation][in] */
                                          _In_ BOOL AutoPlay);

  DECLSPEC_XFGVIRT(IMFMediaEngine, GetLoop)
  BOOL(STDMETHODCALLTYPE *GetLoop)(IMFMediaSharingEngine *This);

  DECLSPEC_XFGVIRT(IMFMediaEngine, SetLoop)
  HRESULT(STDMETHODCALLTYPE *SetLoop)(IMFMediaSharingEngine *This,
                                      /* [annotation][in] */
                                      _In_ BOOL Loop);

  DECLSPEC_XFGVIRT(IMFMediaEngine, Play)
  HRESULT(STDMETHODCALLTYPE *Play)(IMFMediaSharingEngine *This);

  DECLSPEC_XFGVIRT(IMFMediaEngine, Pause)
  HRESULT(STDMETHODCALLTYPE *Pause)(IMFMediaSharingEngine *This);

  DECLSPEC_XFGVIRT(IMFMediaEngine, GetMuted)
  BOOL(STDMETHODCALLTYPE *GetMuted)(IMFMediaSharingEngine *This);

  DECLSPEC_XFGVIRT(IMFMediaEngine, SetMuted)
  HRESULT(STDMETHODCALLTYPE *SetMuted)(IMFMediaSharingEngine *This,
                                       /* [annotation][in] */
                                       _In_ BOOL Muted);

  DECLSPEC_XFGVIRT(IMFMediaEngine, GetVolume)
  double(STDMETHODCALLTYPE *GetVolume)(IMFMediaSharingEngine *This);

  DECLSPEC_XFGVIRT(IMFMediaEngine, SetVolume)
  HRESULT(STDMETHODCALLTYPE *SetVolume)(IMFMediaSharingEngine *This,
                                        /* [annotation][in] */
                                        _In_ double Volume);

  DECLSPEC_XFGVIRT(IMFMediaEngine, HasVideo)
  BOOL(STDMETHODCALLTYPE *HasVideo)(IMFMediaSharingEngine *This);

  DECLSPEC_XFGVIRT(IMFMediaEngine, HasAudio)
  BOOL(STDMETHODCALLTYPE *HasAudio)(IMFMediaSharingEngine *This);

  DECLSPEC_XFGVIRT(IMFMediaEngine, GetNativeVideoSize)
  HRESULT(STDMETHODCALLTYPE *GetNativeVideoSize)(IMFMediaSharingEngine *This,
                                                 /* [annotation][out] */
                                                 _Out_opt_ DWORD *cx,
                                                 /* [annotation][out] */
                                                 _Out_opt_ DWORD *cy);
  ...
  HRESULT(STDMETHODCALLTYPE *GetVideoAspectRatio)(IMFMediaSharingEngine *This,
                                                  /* [annotation][out] */
                                                  _Out_opt_ DWORD *cx,
                                                  /* [annotation][out] */
                                                  _Out_opt_ DWORD *cy);
  ...
  HRESULT(STDMETHODCALLTYPE *Shutdown)(IMFMediaSharingEngine *This);
  ...
  HRESULT(STDMETHODCALLTYPE *OnVideoStreamTick)(IMFMediaSharingEngine *This,
                                                /* [annotation][out] */
                                                _Out_ LONGLONG *pPts);

  DECLSPEC_XFGVIRT(IMFMediaSharingEngine, GetDevice)
  HRESULT(STDMETHODCALLTYPE *GetDevice)(IMFMediaSharingEngine *This,
                                        /* [annotation][out] */
...
#define IMFMediaSharingEngine_AddRef(This) ((This)->lpVtbl->AddRef(This))

#define IMFMediaSharingEngine_Release(This) ((This)->lpVtbl->Release(This))
...
#define IMFMediaSharingEngine_Load(This) ((This)->lpVtbl->Load(This))
...
#define IMFMediaSharingEngine_IsSeeking(This) ((This)->lpVtbl->IsSeeking(This))
...
#define IMFMediaSharingEngine_IsPaused(This) ((This)->lpVtbl->IsPaused(This))
...
#define IMFMediaSharingEngine_IsEnded(This) ((This)->lpVtbl->IsEnded(This))
...
#define IMFMediaSharingEngine_GetLoop(This) ((This)->lpVtbl->GetLoop(This))

#define IMFMediaSharingEngine_SetLoop(This, Loop)                              \
  ((This)->lpVtbl->SetLoop(This, Loop))

#define IMFMediaSharingEngine_Play(This) ((This)->lpVtbl->Play(This))

#define IMFMediaSharingEngine_Pause(This) ((This)->lpVtbl->Pause(This))

#define IMFMediaSharingEngine_GetMuted(This) ((This)->lpVtbl->GetMuted(This))

#define IMFMediaSharingEngine_SetMuted(This, Muted)                            \
  ((This)->lpVtbl->SetMuted(This, Muted))

#define IMFMediaSharingEngine_GetVolume(This) ((This)->lpVtbl->GetVolume(This))

#define IMFMediaSharingEngine_SetVolume(This, Volume)                          \
  ((This)->lpVtbl->SetVolume(This, Volume))

#define IMFMediaSharingEngine_HasVideo(This) ((This)->lpVtbl->HasVideo(This))

#define IMFMediaSharingEngine_HasAudio(This) ((This)->lpVtbl->HasAudio(This))
...
#define IMFMediaSharingEngine_Shutdown(This) ((This)->lpVtbl->Shutdown(This))

#define IMFMediaSharingEngine_TransferVideoFrame(This, pDstSurf, pSrc, pDst,   \
                                                 pBorderClr)                   \
...
EXTERN_GUID(MF_MEDIA_SHARING_ENGINE_DEVICE_NAME, 0x771e05d1, 0x862f, 0x4299,
            0x95, 0xac, 0xae, 0x81, 0xfd, 0x14, 0xf3, 0xe7);
EXTERN_GUID(MF_MEDIA_SHARING_ENGINE_DEVICE, 0xb461c58a, 0x7a08, 0x4b98, 0x99,
            0xa8, 0x70, 0xfd, 0x5f, 0x3b, 0xad, 0xfd);
DEFINE_GUID(MF_MEDIA_SHARING_ENGINE_INITIAL_SEEK_TIME, 0x6f3497f5, 0xd528,
            0x4a4f, 0x8d, 0xd7, 0xdb, 0x36, 0x65, 0x7e, 0xc4, 0xc9);
DEFINE_GUID(MF_SHUTDOWN_RENDERER_ON_ENGINE_SHUTDOWN, 0xc112d94d, 0x6b9c, 0x48f8,
            0xb6, 0xf9, 0x79, 0x50, 0xff, 0x9a, 0xb7, 0x1e);
DEFINE_GUID(MF_PREFERRED_SOURCE_URI, 0x5fc85488, 0x436a, 0x4db8, 0x90, 0xaf,
            0x4d, 0xb4, 0x2, 0xae, 0x5c, 0x57);
DEFINE_GUID(MF_SHARING_ENGINE_SHAREDRENDERER, 0xefa446a0, 0x73e7, 0x404e, 0x8a,
            0xe2, 0xfe, 0xf6, 0x0a, 0xf5, 0xa3, 0x2b);
DEFINE_GUID(MF_SHARING_ENGINE_CALLBACK, 0x57dc1e95, 0xd252, 0x43fa, 0x9b, 0xbc,
            0x18, 0x0, 0x70, 0xee, 0xfe, 0x6d);
...
typedef struct IMFMediaSharingEngineClassFactoryVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(IMFMediaSharingEngineClassFactory *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(IMFMediaSharingEngineClassFactory *This);
...
#define IMFMediaSharingEngineClassFactory_QueryInterface(This, riid,           \
                                                         ppvObject)            \
  ((This)->lpVtbl->QueryInterface(This, riid, ppvObject))
...
#define IMFMediaSharingEngineClassFactory_CreateInstance(This, dwFlags, pAttr, \
                                                         ppEngine)             \
  ((This)->lpVtbl->CreateInstance(This, dwFlags, pAttr, ppEngine))
...
EXTERN_GUID(CLSID_MFMediaSharingEngineClassFactory, 0xf8e307fb, 0x6d45, 0x4ad3,
            0x99, 0x93, 0x66, 0xcd, 0x5a, 0x52, 0x96, 0x59);
...
typedef struct IMFImageSharingEngineVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(IMFImageSharingEngine *This,
                                             /* [in] */ REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(IMFImageSharingEngine *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(IMFImageSharingEngine *This);

  DECLSPEC_XFGVIRT(IMFImageSharingEngine, SetSource)
  HRESULT(STDMETHODCALLTYPE *SetSource)(IMFImageSharingEngine *This,
                                        /* [annotation][in] */
                                        _In_ IUnknown *pStream);

  DECLSPEC_XFGVIRT(IMFImageSharingEngine, GetDevice)
  HRESULT(STDMETHODCALLTYPE *GetDevice)(IMFImageSharingEngine *This,
                                        /* [annotation][out] */
                                        _Out_ DEVICE_INFO *pDevice);

  DECLSPEC_XFGVIRT(IMFImageSharingEngine, Shutdown)
  HRESULT(STDMETHODCALLTYPE *Shutdown)(IMFImageSharingEngine *This);
...
#define IMFImageSharingEngine_AddRef(This) ((This)->lpVtbl->AddRef(This))

#define IMFImageSharingEngine_Release(This) ((This)->lpVtbl->Release(This))
...
#define IMFImageSharingEngine_Shutdown(This) ((This)->lpVtbl->Shutdown(This))
...
typedef struct IMFImageSharingEngineClassFactoryVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(IMFImageSharingEngineClassFactory *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(IMFImageSharingEngineClassFactory *This);
...
#define IMFImageSharingEngineClassFactory_QueryInterface(This, riid,           \
                                                         ppvObject)            \
  ((This)->lpVtbl->QueryInterface(This, riid, ppvObject))
...
#define IMFImageSharingEngineClassFactory_CreateInstanceFromUDN(               \
...
EXTERN_GUID(CLSID_MFImageSharingEngineClassFactory, 0xb22c3339, 0x87f3, 0x4059,
            0xa0, 0xc5, 0x3, 0x7a, 0xa9, 0x70, 0x7e, 0xaf);
typedef /* [v1_enum] */
...
typedef struct IPlayToControlVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in IPlayToControl *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IPlayToControl *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IPlayToControl *This);
  ...
  HRESULT(STDMETHODCALLTYPE *Disconnect)(__RPC__in IPlayToControl *This);

  END_INTERFACE
} IPlayToControlVtbl;

interface IPlayToControl { CONST_VTBL struct IPlayToControlVtbl *lpVtbl; };
...
#define IPlayToControl_AddRef(This) ((This)->lpVtbl->AddRef(This))

#define IPlayToControl_Release(This) ((This)->lpVtbl->Release(This))

#define IPlayToControl_Connect(This, pFactory)                                 \
  ((This)->lpVtbl->Connect(This, pFactory))

#define IPlayToControl_Disconnect(This) ((This)->lpVtbl->Disconnect(This))
...
typedef struct IPlayToSourceClassFactoryVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(IPlayToSourceClassFactory *This,
                                             /* [in] */ REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(IPlayToSourceClassFactory *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(IPlayToSourceClassFactory *This);

  DECLSPEC_XFGVIRT(IPlayToSourceClassFactory, CreateInstance)
  HRESULT(STDMETHODCALLTYPE *CreateInstance)(IPlayToSourceClassFactory *This,
                                             /* [annotation][in] */
                                             _In_ DWORD dwFlags,
                                             /* [annotation][in] */
                                             _In_ IPlayToControl *pControl,
...
#define IPlayToSourceClassFactory_AddRef(This) ((This)->lpVtbl->AddRef(This))

#define IPlayToSourceClassFactory_Release(This) ((This)->lpVtbl->Release(This))

#define IPlayToSourceClassFactory_CreateInstance(This, dwFlags, pControl,      \
                                                 ppSource)                     \
...
EXTERN_GUID(CLSID_PlayToSourceClassFactory, 0xDA17539A, 0x3DC3, 0x42C1, 0xA7,
            0x49, 0xA1, 0x83, 0xB5, 0x1F, 0x08, 0x5E);
EXTERN_GUID(GUID_PlayToService, 0xf6a8ff9d, 0x9e14, 0x41c9, 0xbf, 0x0f, 0x12,
            0x0a, 0x2b, 0x3c, 0xe1, 0x20);
EXTERN_GUID(GUID_NativeDeviceService, 0xef71e53c, 0x52f4, 0x43c5, 0xb8, 0x6a,
            0xad, 0x6c, 0xb2, 0x16, 0xa6, 0x1e);
