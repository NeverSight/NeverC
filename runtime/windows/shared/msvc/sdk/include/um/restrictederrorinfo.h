...
typedef interface ILanguageExceptionStackBackTrace
...
typedef struct IRestrictedErrorInfoVtbl {
  ...
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IRestrictedErrorInfo *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IRestrictedErrorInfo *This);
...
#define IRestrictedErrorInfo_GetErrorDetails(                                  \
    This, description, error, restrictedDescription, capabilitySid)            \
  ((This)->lpVtbl->GetErrorDetails(This, description, error,                   \
                                   restrictedDescription, capabilitySid))
...
typedef struct ILanguageExceptionErrorInfoVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in ILanguageExceptionErrorInfo *This);
...
#define ILanguageExceptionErrorInfo_AddRef(This) ((This)->lpVtbl->AddRef(This))

#define ILanguageExceptionErrorInfo_Release(This)                              \
  ((This)->lpVtbl->Release(This))

#define ILanguageExceptionErrorInfo_GetLanguageException(This,                 \
                                                         languageException)    \
...
public:
  virtual HRESULT STDMETHODCALLTYPE GetTransformedRestrictedErrorInfo(
      /* [out] */ __RPC__deref_out_opt IRestrictedErrorInfo *
      *restrictedErrorInfo) = 0;
};
...
typedef struct ILanguageExceptionTransformVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in ILanguageExceptionTransform *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(
      __RPC__in ILanguageExceptionTransform *This);

  DECLSPEC_XFGVIRT(ILanguageExceptionTransform,
...
#define ILanguageExceptionTransform_AddRef(This) ((This)->lpVtbl->AddRef(This))

#define ILanguageExceptionTransform_Release(This)                              \
  ((This)->lpVtbl->Release(This))

#define ILanguageExceptionTransform_GetTransformedRestrictedErrorInfo(         \
...
public:
  virtual HRESULT STDMETHODCALLTYPE GetStackBackTrace(
      ...
      /* [max_is][out][in] */
      __RPC__inout_ecount_full(((maxFramesToCapture - 1) + 1))
...
#define ILanguageExceptionStackBackTrace_GetStackBackTrace(                    \
    This, maxFramesToCapture, stackBackTrace, framesCaptured)                  \
  ((This)->lpVtbl->GetStackBackTrace(This, maxFramesToCapture, stackBackTrace, \
                                     framesCaptured))
...
public:
  virtual HRESULT STDMETHODCALLTYPE GetPreviousLanguageExceptionErrorInfo(
      /* [out] */ __RPC__deref_out_opt ILanguageExceptionErrorInfo2 *
      *previousLanguageExceptionErrorInfo) = 0;
  ...
  virtual HRESULT STDMETHODCALLTYPE GetPropagationContextHead(
      /* [out] */ __RPC__deref_out_opt ILanguageExceptionErrorInfo2 *
      *propagatedLanguageExceptionErrorInfoHead) = 0;
};
...
typedef struct ILanguageExceptionErrorInfo2Vtbl {
  ...
  DECLSPEC_XFGVIRT(ILanguageExceptionErrorInfo2,
...
#define ILanguageExceptionErrorInfo2_AddRef(This) ((This)->lpVtbl->AddRef(This))

#define ILanguageExceptionErrorInfo2_Release(This)                             \
  ((This)->lpVtbl->Release(This))

#define ILanguageExceptionErrorInfo2_GetLanguageException(This,                \
                                                          languageException)   \
  ((This)->lpVtbl->GetLanguageException(This, languageException))

#define ILanguageExceptionErrorInfo2_GetPreviousLanguageExceptionErrorInfo(    \
    This, previousLanguageExceptionErrorInfo)                                  \
  ((This)->lpVtbl->GetPreviousLanguageExceptionErrorInfo(                      \
      This, previousLanguageExceptionErrorInfo))

#define ILanguageExceptionErrorInfo2_CapturePropagationContext(                \
    This, languageException)                                                   \
  ((This)->lpVtbl->CapturePropagationContext(This, languageException))

#define ILanguageExceptionErrorInfo2_GetPropagationContextHead(                \
    This, propagatedLanguageExceptionErrorInfoHead)                            \
  ((This)->lpVtbl->GetPropagationContextHead(                                  \
      This, propagatedLanguageExceptionErrorInfoHead))
