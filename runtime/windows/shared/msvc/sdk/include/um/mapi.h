...
#define MAPI_DIALOG_MODELESS                                                   \
  0x00000004 | MAPI_DIALOG /* Display a modeless window    */
#define MAPI_FORCE_UNICODE                                                     \
  0x00040000 /* Don't down-convert to ANSI if provider does not support        \
                Unicode */
...
/* #define MAPI_LOGON_UI        0x00000001     Display logon UI             */
/* #define MAPI_NEW_SESSION     0x00000002     Don't use shared session     */
/* #define MAPI_LONG_MSGID		0x00004000	/* allow 512 char
 * returned ID	*/
...
typedef ULONG(FAR PASCAL MAPILOGON)(ULONG_PTR ulUIParam,
                                    ...
                                    _In_opt_ LPSTR lpszPassword, FLAGS flFlags,
                                    ULONG ulReserved,
                                    LPLHANDLE lplhSession) WIN_NOEXCEPT_PFN;
typedef MAPILOGON FAR *LPMAPILOGON;
DECLSPEC_DEPRECATED MAPILOGON MAPILogon;

typedef ULONG(FAR PASCAL MAPILOGOFF)(LHANDLE lhSession, ULONG_PTR ulUIParam,
                                     FLAGS flFlags,
                                     ULONG ulReserved) WIN_NOEXCEPT_PFN;
typedef MAPILOGOFF FAR *LPMAPILOGOFF;
DECLSPEC_DEPRECATED MAPILOGOFF MAPILogoff;

typedef ULONG(FAR PASCAL MAPISENDMAIL)(LHANDLE lhSession, ULONG_PTR ulUIParam,
                                       lpMapiMessage lpMessage, FLAGS flFlags,
                                       ULONG ulReserved) WIN_NOEXCEPT_PFN;
typedef MAPISENDMAIL FAR *LPMAPISENDMAIL;
MAPISENDMAIL MAPISendMail;

typedef ULONG(FAR PASCAL MAPISENDMAILW)(LHANDLE lhSession, ULONG_PTR ulUIParam,
...
typedef ULONG(FAR PASCAL MAPISENDDOCUMENTS)(ULONG_PTR ulUIParam,
...
typedef ULONG(FAR PASCAL MAPIFINDNEXT)(
    LHANDLE lhSession, ULONG_PTR ulUIParam, _In_ LPSTR lpszMessageType,
    _In_ LPSTR lpszSeedMessageID, FLAGS flFlags, ULONG ulReserved,
    _In_ LPSTR lpszMessageID) WIN_NOEXCEPT_PFN;
...
typedef ULONG(FAR PASCAL MAPIREADMAIL)(
    LHANDLE lhSession, ULONG_PTR ulUIParam, _In_ LPSTR lpszMessageID,
    FLAGS flFlags, ULONG ulReserved,
    lpMapiMessage FAR *lppMessage) WIN_NOEXCEPT_PFN;
...
typedef ULONG(FAR PASCAL MAPISAVEMAIL)(
    ...
    FLAGS flFlags, ULONG ulReserved, _In_ LPSTR lpszMessageID) WIN_NOEXCEPT_PFN;
typedef MAPISAVEMAIL FAR *LPMAPISAVEMAIL;
DECLSPEC_DEPRECATED MAPISAVEMAIL MAPISaveMail;

typedef ULONG(FAR PASCAL MAPIDELETEMAIL)(LHANDLE lhSession, ULONG_PTR ulUIParam,
...
typedef ULONG(FAR PASCAL MAPIADDRESS)(
    LHANDLE lhSession, ULONG_PTR ulUIParam, _In_ LPSTR lpszCaption,
    ULONG nEditFields, _In_ LPSTR lpszLabels, ULONG nRecips,
    lpMapiRecipDesc lpRecips, FLAGS flFlags, ULONG ulReserved,
    LPULONG lpnNewRecips, lpMapiRecipDesc FAR *lppNewRecips) WIN_NOEXCEPT_PFN;
typedef MAPIADDRESS FAR *LPMAPIADDRESS;
DECLSPEC_DEPRECATED MAPIADDRESS MAPIAddress;

typedef ULONG(FAR PASCAL MAPIDETAILS)(LHANDLE lhSession, ULONG_PTR ulUIParam,
...
typedef ULONG(FAR PASCAL MAPIRESOLVENAME)(
    LHANDLE lhSession, ULONG_PTR ulUIParam, _In_ LPSTR lpszName, FLAGS flFlags,
    ULONG ulReserved, lpMapiRecipDesc FAR *lppRecip) WIN_NOEXCEPT_PFN;
