...
**
*								* *	OLE DAO
* component class id definitions
*		* *	DAO has been allocated the GUID::Data1 range of
* 0x00025eXX			* *
*												*
*************************************************************************
...
/*	The pre-3.5 GUIDs have been redefined with "30" added to the ID. For
   example: IID_IDAOIndex becomes IID30_IDAOIndex This way both the 30 and 3.5
   GUIDs can be used at once
*/
...
DEFINE_OLEGUID(IID30_ICDAOJETError, 0x00025e21, 0,
               0); // used by Access, goes away post 3.0
...
DEFINE_OLEGUID(IID30_ICDAORecordset, 0x00025e31, 0,
               0); // NOTE: No change for 3.1 or 3.5
...
// DEFINE_OLEGUID(IID30_ICDAOJETField,		0x00025e51, 0, 0);	//used
// by Access, goes away post 3.0
DEFINE_OLEGUID(IID30_ICDAOJETField, 0x00025e49, 0,
               0); // used by Access, goes away post 3.0
