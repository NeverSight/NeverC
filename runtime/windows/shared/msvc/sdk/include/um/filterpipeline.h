...
//
// XPSDrv driver can specify filter service provider module using the
// <FilterServiceProvider> or <OptionalFilterServiceProvider> element in the
// filter pipeline configuration XML file. The service provider module must
// export the following DrvPopulateFilterServices function, which is called by
// the XPSDrv filter pipeline manager to allow the service provider to
// instantiate filter service objects in the filter pipeline property bag
// specified by the pPropertyBag parameter.
//
HRESULT
WINAPI
DrvPopulateFilterServices(_In_ IPrintPipelinePropertyBag *pPropertyBag);
...
typedef struct IPrintReadStreamVtbl {
  ...
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(IPrintReadStream *This,
                                             /* [in] */ REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(IPrintReadStream *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(IPrintReadStream *This);

  DECLSPEC_XFGVIRT(IPrintReadStream, Seek)
  HRESULT(STDMETHODCALLTYPE *Seek)(IPrintReadStream *This,
                                   /* [annotation][in] */
                                   _In_ LONGLONG dlibMove,
                                   /* [annotation][in] */
                                   _In_ DWORD dwOrigin,
...
interface IPrintReadStream { CONST_VTBL struct IPrintReadStreamVtbl *lpVtbl; };
...
#define IPrintReadStream_AddRef(This) ((This)->lpVtbl->AddRef(This))

#define IPrintReadStream_Release(This) ((This)->lpVtbl->Release(This))

#define IPrintReadStream_Seek(This, dlibMove, dwOrigin, plibNewPosition)       \
  ((This)->lpVtbl->Seek(This, dlibMove, dwOrigin, plibNewPosition))

#define IPrintReadStream_ReadBytes(This, pvBuffer, cbRequested, pcbRead,       \
                                   pbEndOfFile)                                \
...
typedef struct IPrintWriteStreamVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(IPrintWriteStream *This,
                                             /* [in] */ REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(IPrintWriteStream *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(IPrintWriteStream *This);

  DECLSPEC_XFGVIRT(IPrintWriteStream, WriteBytes)
  HRESULT(STDMETHODCALLTYPE *WriteBytes)(IPrintWriteStream *This,
                                         /* [annotation][size_is][in] */
  ...
  void(STDMETHODCALLTYPE *Close)(IPrintWriteStream *This);
...
#define IPrintWriteStream_AddRef(This) ((This)->lpVtbl->AddRef(This))

#define IPrintWriteStream_Release(This) ((This)->lpVtbl->Release(This))
...
#define IPrintWriteStream_Close(This) ((This)->lpVtbl->Close(This))
...
typedef struct IPrintWriteStreamFlushVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(IPrintWriteStreamFlush *This,
                                             /* [in] */ REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(IPrintWriteStreamFlush *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(IPrintWriteStreamFlush *This);

  DECLSPEC_XFGVIRT(IPrintWriteStreamFlush, FlushData)
  HRESULT(STDMETHODCALLTYPE *FlushData)(IPrintWriteStreamFlush *This);
...
#define IPrintWriteStreamFlush_AddRef(This) ((This)->lpVtbl->AddRef(This))

#define IPrintWriteStreamFlush_Release(This) ((This)->lpVtbl->Release(This))

#define IPrintWriteStreamFlush_FlushData(This) ((This)->lpVtbl->FlushData(This))
...
typedef struct IInterFilterCommunicatorVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(IInterFilterCommunicator *This,
                                             /* [in] */ REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(IInterFilterCommunicator *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(IInterFilterCommunicator *This);

  DECLSPEC_XFGVIRT(IInterFilterCommunicator, RequestReader)
  HRESULT(STDMETHODCALLTYPE *RequestReader)(IInterFilterCommunicator *This,
                                            /* [annotation][out] */
                                            _Out_ void **ppIReader);

  DECLSPEC_XFGVIRT(IInterFilterCommunicator, RequestWriter)
  HRESULT(STDMETHODCALLTYPE *RequestWriter)(IInterFilterCommunicator *This,
                                            /* [annotation][out] */
...
#define IInterFilterCommunicator_AddRef(This) ((This)->lpVtbl->AddRef(This))

#define IInterFilterCommunicator_Release(This) ((This)->lpVtbl->Release(This))
...
typedef struct IPrintPipelineManagerControlVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(IPrintPipelineManagerControl *This,
                                             /* [in] */ REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(IPrintPipelineManagerControl *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(IPrintPipelineManagerControl *This);
...
#define IPrintPipelineManagerControl_AddRef(This) ((This)->lpVtbl->AddRef(This))
...
typedef struct IPrintPipelinePropertyBagVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(IPrintPipelinePropertyBag *This,
                                             /* [in] */ REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(IPrintPipelinePropertyBag *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(IPrintPipelinePropertyBag *This);

  DECLSPEC_XFGVIRT(IPrintPipelinePropertyBag, AddProperty)
  HRESULT(STDMETHODCALLTYPE *AddProperty)(IPrintPipelinePropertyBag *This,
                                          /* [annotation][string][in] */
                                          _In_z_ const wchar_t *pszName,
                                          /* [annotation][in] */
  ...
  HRESULT(STDMETHODCALLTYPE *GetProperty)(IPrintPipelinePropertyBag *This,
                                          /* [annotation][string][in] */
                                          _In_z_ const wchar_t *pszName,
                                          /* [annotation][out] */
                                          _Out_ VARIANT *pVar);
  ...
  BOOL(STDMETHODCALLTYPE *DeleteProperty)(IPrintPipelinePropertyBag *This,
                                          /* [annotation][string][in] */
                                          _In_z_ const wchar_t *pszName);
...
#define IPrintPipelinePropertyBag_AddRef(This) ((This)->lpVtbl->AddRef(This))

#define IPrintPipelinePropertyBag_Release(This) ((This)->lpVtbl->Release(This))
...
typedef struct IPrintPipelineProgressReportVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(IPrintPipelineProgressReport *This,
                                             /* [in] */ REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(IPrintPipelineProgressReport *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(IPrintPipelineProgressReport *This);

  DECLSPEC_XFGVIRT(IPrintPipelineProgressReport, ReportProgress)
  HRESULT(STDMETHODCALLTYPE *ReportProgress)(IPrintPipelineProgressReport *This,
                                             /* [annotation][in] */
...
#define IPrintPipelineProgressReport_AddRef(This) ((This)->lpVtbl->AddRef(This))
...
typedef struct IPrintClassObjectFactoryVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(IPrintClassObjectFactory *This,
                                             /* [in] */ REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(IPrintClassObjectFactory *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(IPrintClassObjectFactory *This);
...
#define IPrintClassObjectFactory_AddRef(This) ((This)->lpVtbl->AddRef(This))

#define IPrintClassObjectFactory_Release(This) ((This)->lpVtbl->Release(This))

#define IPrintClassObjectFactory_GetPrintClassObject(This, pszPrinterName,     \
                                                     riid, ppNewObject)        \
...
typedef struct IPrintPipelineFilterVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(IPrintPipelineFilter *This,
                                             /* [in] */ REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(IPrintPipelineFilter *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(IPrintPipelineFilter *This);
  ...
  HRESULT(STDMETHODCALLTYPE *ShutdownOperation)(IPrintPipelineFilter *This);

  DECLSPEC_XFGVIRT(IPrintPipelineFilter, StartOperation)
  HRESULT(STDMETHODCALLTYPE *StartOperation)(IPrintPipelineFilter *This);
...
#define IPrintPipelineFilter_AddRef(This) ((This)->lpVtbl->AddRef(This))

#define IPrintPipelineFilter_Release(This) ((This)->lpVtbl->Release(This))

#define IPrintPipelineFilter_InitializeFilter(                                 \
    This, pINegotiation, pIPropertyBag, pIPipelineControl)                     \
...
typedef struct IXpsDocumentProviderVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(IXpsDocumentProvider *This,
                                             /* [in] */ REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(IXpsDocumentProvider *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(IXpsDocumentProvider *This);

  DECLSPEC_XFGVIRT(IXpsDocumentProvider, GetXpsPart)
  HRESULT(STDMETHODCALLTYPE *GetXpsPart)(IXpsDocumentProvider *This,
                                         /* [annotation][out] */
...
#define IXpsDocumentProvider_AddRef(This) ((This)->lpVtbl->AddRef(This))

#define IXpsDocumentProvider_Release(This) ((This)->lpVtbl->Release(This))
...
typedef struct IXpsDocumentConsumerVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(IXpsDocumentConsumer *This,
                                             /* [in] */ REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(IXpsDocumentConsumer *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(IXpsDocumentConsumer *This);

  DECLSPEC_XFGVIRT(IXpsDocumentConsumer, SendXpsUnknown)
  HRESULT(STDMETHODCALLTYPE *SendXpsUnknown)(IXpsDocumentConsumer *This,
                                             /* [annotation][in] */
                                             _In_ IUnknown *pUnknown);

  DECLSPEC_XFGVIRT(IXpsDocumentConsumer, SendXpsDocument)
  HRESULT(STDMETHODCALLTYPE *SendXpsDocument)(IXpsDocumentConsumer *This,
                                              /* [annotation][in] */
  ...
  HRESULT(STDMETHODCALLTYPE *SendFixedPage)(IXpsDocumentConsumer *This,
                                            /* [annotation][in] */
                                            _In_ IFixedPage *pIFixedPage);

  DECLSPEC_XFGVIRT(IXpsDocumentConsumer, CloseSender)
  HRESULT(STDMETHODCALLTYPE *CloseSender)(IXpsDocumentConsumer *This);
...
#define IXpsDocumentConsumer_AddRef(This) ((This)->lpVtbl->AddRef(This))

#define IXpsDocumentConsumer_Release(This) ((This)->lpVtbl->Release(This))
...
#define IXpsDocumentConsumer_SendFixedDocumentSequence(                        \
    This, pIFixedDocumentSequence)                                             \
...
#define IXpsDocumentConsumer_GetNewEmptyPart(This, uri, riid, ppNewObject,     \
                                             ppWriteStream)                    \
...
typedef struct IXpsDocumentVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(IXpsDocument *This,
                                             /* [in] */ REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(IXpsDocument *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(IXpsDocument *This);
  ...
  HRESULT(STDMETHODCALLTYPE *SetThumbnail)(IXpsDocument *This,
                                           /* [annotation][in] */
...
interface IXpsDocument { CONST_VTBL struct IXpsDocumentVtbl *lpVtbl; };
...
#define IXpsDocument_AddRef(This) ((This)->lpVtbl->AddRef(This))

#define IXpsDocument_Release(This) ((This)->lpVtbl->Release(This))
...
typedef struct IFixedDocumentSequenceVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(IFixedDocumentSequence *This,
                                             /* [in] */ REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(IFixedDocumentSequence *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(IFixedDocumentSequence *This);

  DECLSPEC_XFGVIRT(IFixedDocumentSequence, GetUri)
  HRESULT(STDMETHODCALLTYPE *GetUri)(IFixedDocumentSequence *This,
                                     /* [annotation][out] */
                                     _Out_ BSTR *uri);
...
#define IFixedDocumentSequence_AddRef(This) ((This)->lpVtbl->AddRef(This))

#define IFixedDocumentSequence_Release(This) ((This)->lpVtbl->Release(This))
...
typedef struct IFixedDocumentVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(IFixedDocument *This,
                                             /* [in] */ REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(IFixedDocument *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(IFixedDocument *This);

  DECLSPEC_XFGVIRT(IFixedDocument, GetUri)
  HRESULT(STDMETHODCALLTYPE *GetUri)(IFixedDocument *This,
                                     /* [annotation][out] */
                                     _Out_ BSTR *uri);
...
interface IFixedDocument { CONST_VTBL struct IFixedDocumentVtbl *lpVtbl; };
...
#define IFixedDocument_AddRef(This) ((This)->lpVtbl->AddRef(This))

#define IFixedDocument_Release(This) ((This)->lpVtbl->Release(This))

#define IFixedDocument_GetUri(This, uri) ((This)->lpVtbl->GetUri(This, uri))
...
typedef struct IPartBaseVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(IPartBase *This,
                                             /* [in] */ REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(IPartBase *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(IPartBase *This);

  DECLSPEC_XFGVIRT(IPartBase, GetUri)
  HRESULT(STDMETHODCALLTYPE *GetUri)(IPartBase *This,
                                     /* [annotation][out] */
                                     _Out_ BSTR *uri);

  DECLSPEC_XFGVIRT(IPartBase, GetStream)
  HRESULT(STDMETHODCALLTYPE *GetStream)(IPartBase *This,
                                        /* [annotation][out] */
  ...
  HRESULT(STDMETHODCALLTYPE *SetPartCompression)(IPartBase *This,
                                                 /* [annotation][in] */
                                                 _In_ EXpsCompressionOptions
                                                     compression);

  END_INTERFACE
} IPartBaseVtbl;

interface IPartBase { CONST_VTBL struct IPartBaseVtbl *lpVtbl; };
...
#define IPartBase_AddRef(This) ((This)->lpVtbl->AddRef(This))

#define IPartBase_Release(This) ((This)->lpVtbl->Release(This))

#define IPartBase_GetUri(This, uri) ((This)->lpVtbl->GetUri(This, uri))
...
typedef struct IFixedPageVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(IFixedPage *This,
                                             /* [in] */ REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(IFixedPage *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(IFixedPage *This);

  DECLSPEC_XFGVIRT(IPartBase, GetUri)
  HRESULT(STDMETHODCALLTYPE *GetUri)(IFixedPage *This,
                                     /* [annotation][out] */
                                     _Out_ BSTR *uri);

  DECLSPEC_XFGVIRT(IPartBase, GetStream)
  HRESULT(STDMETHODCALLTYPE *GetStream)(IFixedPage *This,
                                        /* [annotation][out] */
                                        _Outptr_ IPrintReadStream **ppStream);
  ...
  DECLSPEC_XFGVIRT(IPartBase, SetPartCompression)
  HRESULT(STDMETHODCALLTYPE *SetPartCompression)(IFixedPage *This,
                                                 /* [annotation][in] */
                                                 _In_ EXpsCompressionOptions
                                                     compression);
  ...
  HRESULT(STDMETHODCALLTYPE *GetPagePart)(IFixedPage *This,
                                          /* [annotation][string][in] */
                                          _In_z_ const wchar_t *uri,
                                          /* [annotation][out] */
  ...
  HRESULT(STDMETHODCALLTYPE *SetPagePart)(IFixedPage *This,
                                          /* [annotation][in] */
                                          _In_ IUnknown *pUnk);

  DECLSPEC_XFGVIRT(IFixedPage, DeleteResource)
  HRESULT(STDMETHODCALLTYPE *DeleteResource)(IFixedPage *This,
                                             /* [annotation][string][in] */
                                             _In_z_ const wchar_t *uri);
...
interface IFixedPage { CONST_VTBL struct IFixedPageVtbl *lpVtbl; };
...
#define IFixedPage_AddRef(This) ((This)->lpVtbl->AddRef(This))

#define IFixedPage_Release(This) ((This)->lpVtbl->Release(This))

#define IFixedPage_GetUri(This, uri) ((This)->lpVtbl->GetUri(This, uri))
...
typedef struct IPartImageVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(IPartImage *This,
                                             /* [in] */ REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(IPartImage *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(IPartImage *This);

  DECLSPEC_XFGVIRT(IPartBase, GetUri)
  HRESULT(STDMETHODCALLTYPE *GetUri)(IPartImage *This,
                                     /* [annotation][out] */
                                     _Out_ BSTR *uri);

  DECLSPEC_XFGVIRT(IPartBase, GetStream)
  HRESULT(STDMETHODCALLTYPE *GetStream)(IPartImage *This,
                                        /* [annotation][out] */
                                        _Outptr_ IPrintReadStream **ppStream);
  ...
  DECLSPEC_XFGVIRT(IPartBase, SetPartCompression)
  HRESULT(STDMETHODCALLTYPE *SetPartCompression)(IPartImage *This,
                                                 /* [annotation][in] */
                                                 _In_ EXpsCompressionOptions
                                                     compression);

  DECLSPEC_XFGVIRT(IPartImage, GetImageProperties)
  HRESULT(STDMETHODCALLTYPE *GetImageProperties)(IPartImage *This,
                                                 /* [annotation][out] */
...
interface IPartImage { CONST_VTBL struct IPartImageVtbl *lpVtbl; };
...
#define IPartImage_AddRef(This) ((This)->lpVtbl->AddRef(This))

#define IPartImage_Release(This) ((This)->lpVtbl->Release(This))

#define IPartImage_GetUri(This, uri) ((This)->lpVtbl->GetUri(This, uri))
...
typedef struct IPartFontVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(IPartFont *This,
                                             /* [in] */ REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(IPartFont *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(IPartFont *This);

  DECLSPEC_XFGVIRT(IPartBase, GetUri)
  HRESULT(STDMETHODCALLTYPE *GetUri)(IPartFont *This,
                                     /* [annotation][out] */
                                     _Out_ BSTR *uri);

  DECLSPEC_XFGVIRT(IPartBase, GetStream)
  HRESULT(STDMETHODCALLTYPE *GetStream)(IPartFont *This,
                                        /* [annotation][out] */
                                        _Outptr_ IPrintReadStream **ppStream);
  ...
  DECLSPEC_XFGVIRT(IPartBase, SetPartCompression)
  HRESULT(STDMETHODCALLTYPE *SetPartCompression)(IPartFont *This,
                                                 /* [annotation][in] */
                                                 _In_ EXpsCompressionOptions
                                                     compression);
  ...
  HRESULT(STDMETHODCALLTYPE *SetFontOptions)(IPartFont *This,
                                             /* [annotation][in] */
...
interface IPartFont { CONST_VTBL struct IPartFontVtbl *lpVtbl; };
...
#define IPartFont_AddRef(This) ((This)->lpVtbl->AddRef(This))

#define IPartFont_Release(This) ((This)->lpVtbl->Release(This))

#define IPartFont_GetUri(This, uri) ((This)->lpVtbl->GetUri(This, uri))
...
typedef struct IPartFont2Vtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(IPartFont2 *This,
                                             /* [in] */ REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(IPartFont2 *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(IPartFont2 *This);

  DECLSPEC_XFGVIRT(IPartBase, GetUri)
  HRESULT(STDMETHODCALLTYPE *GetUri)(IPartFont2 *This,
                                     /* [annotation][out] */
                                     _Out_ BSTR *uri);

  DECLSPEC_XFGVIRT(IPartBase, GetStream)
  HRESULT(STDMETHODCALLTYPE *GetStream)(IPartFont2 *This,
                                        /* [annotation][out] */
                                        _Outptr_ IPrintReadStream **ppStream);
  ...
  DECLSPEC_XFGVIRT(IPartBase, SetPartCompression)
  HRESULT(STDMETHODCALLTYPE *SetPartCompression)(IPartFont2 *This,
                                                 /* [annotation][in] */
                                                 _In_ EXpsCompressionOptions
                                                     compression);
  ...
  DECLSPEC_XFGVIRT(IPartFont, SetFontOptions)
  HRESULT(STDMETHODCALLTYPE *SetFontOptions)(IPartFont2 *This,
                                             /* [annotation][in] */
                                             _In_ EXpsFontOptions options);
...
interface IPartFont2 { CONST_VTBL struct IPartFont2Vtbl *lpVtbl; };
...
#define IPartFont2_AddRef(This) ((This)->lpVtbl->AddRef(This))

#define IPartFont2_Release(This) ((This)->lpVtbl->Release(This))

#define IPartFont2_GetUri(This, uri) ((This)->lpVtbl->GetUri(This, uri))
...
typedef struct IPartThumbnailVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(IPartThumbnail *This,
                                             /* [in] */ REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(IPartThumbnail *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(IPartThumbnail *This);

  DECLSPEC_XFGVIRT(IPartBase, GetUri)
  HRESULT(STDMETHODCALLTYPE *GetUri)(IPartThumbnail *This,
                                     /* [annotation][out] */
                                     _Out_ BSTR *uri);

  DECLSPEC_XFGVIRT(IPartBase, GetStream)
  HRESULT(STDMETHODCALLTYPE *GetStream)(IPartThumbnail *This,
                                        /* [annotation][out] */
                                        _Outptr_ IPrintReadStream **ppStream);
  ...
  DECLSPEC_XFGVIRT(IPartBase, SetPartCompression)
  HRESULT(STDMETHODCALLTYPE *SetPartCompression)(IPartThumbnail *This,
                                                 /* [annotation][in] */
                                                 _In_ EXpsCompressionOptions
                                                     compression);

  DECLSPEC_XFGVIRT(IPartThumbnail, GetThumbnailProperties)
  HRESULT(STDMETHODCALLTYPE *GetThumbnailProperties)(IPartThumbnail *This,
                                                     /* [annotation][out] */
                                                     _Out_ BSTR *pContentType);
...
interface IPartThumbnail { CONST_VTBL struct IPartThumbnailVtbl *lpVtbl; };
...
#define IPartThumbnail_AddRef(This) ((This)->lpVtbl->AddRef(This))

#define IPartThumbnail_Release(This) ((This)->lpVtbl->Release(This))

#define IPartThumbnail_GetUri(This, uri) ((This)->lpVtbl->GetUri(This, uri))
...
IPartPrintTicket : public IPartBase{public : };
...
typedef struct IPartPrintTicketVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(IPartPrintTicket *This,
                                             /* [in] */ REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(IPartPrintTicket *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(IPartPrintTicket *This);

  DECLSPEC_XFGVIRT(IPartBase, GetUri)
  HRESULT(STDMETHODCALLTYPE *GetUri)(IPartPrintTicket *This,
                                     /* [annotation][out] */
                                     _Out_ BSTR *uri);

  DECLSPEC_XFGVIRT(IPartBase, GetStream)
  HRESULT(STDMETHODCALLTYPE *GetStream)(IPartPrintTicket *This,
                                        /* [annotation][out] */
                                        _Outptr_ IPrintReadStream **ppStream);
  ...
  DECLSPEC_XFGVIRT(IPartBase, SetPartCompression)
  HRESULT(STDMETHODCALLTYPE *SetPartCompression)(IPartPrintTicket *This,
                                                 /* [annotation][in] */
                                                 _In_ EXpsCompressionOptions
                                                     compression);
...
interface IPartPrintTicket { CONST_VTBL struct IPartPrintTicketVtbl *lpVtbl; };
...
#define IPartPrintTicket_AddRef(This) ((This)->lpVtbl->AddRef(This))

#define IPartPrintTicket_Release(This) ((This)->lpVtbl->Release(This))

#define IPartPrintTicket_GetUri(This, uri) ((This)->lpVtbl->GetUri(This, uri))
...
IPartColorProfile : public IPartBase{public : };
...
typedef struct IPartColorProfileVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(IPartColorProfile *This,
                                             /* [in] */ REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(IPartColorProfile *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(IPartColorProfile *This);

  DECLSPEC_XFGVIRT(IPartBase, GetUri)
  HRESULT(STDMETHODCALLTYPE *GetUri)(IPartColorProfile *This,
                                     /* [annotation][out] */
                                     _Out_ BSTR *uri);

  DECLSPEC_XFGVIRT(IPartBase, GetStream)
  HRESULT(STDMETHODCALLTYPE *GetStream)(IPartColorProfile *This,
                                        /* [annotation][out] */
                                        _Outptr_ IPrintReadStream **ppStream);
  ...
  DECLSPEC_XFGVIRT(IPartBase, SetPartCompression)
  HRESULT(STDMETHODCALLTYPE *SetPartCompression)(IPartColorProfile *This,
                                                 /* [annotation][in] */
                                                 _In_ EXpsCompressionOptions
                                                     compression);
...
#define IPartColorProfile_AddRef(This) ((This)->lpVtbl->AddRef(This))

#define IPartColorProfile_Release(This) ((This)->lpVtbl->Release(This))

#define IPartColorProfile_GetUri(This, uri) ((This)->lpVtbl->GetUri(This, uri))
...
IPartResourceDictionary : public IPartBase{public : };
...
typedef struct IPartResourceDictionaryVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(IPartResourceDictionary *This,
                                             /* [in] */ REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(IPartResourceDictionary *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(IPartResourceDictionary *This);

  DECLSPEC_XFGVIRT(IPartBase, GetUri)
  HRESULT(STDMETHODCALLTYPE *GetUri)(IPartResourceDictionary *This,
                                     /* [annotation][out] */
                                     _Out_ BSTR *uri);

  DECLSPEC_XFGVIRT(IPartBase, GetStream)
  HRESULT(STDMETHODCALLTYPE *GetStream)(IPartResourceDictionary *This,
                                        /* [annotation][out] */
                                        _Outptr_ IPrintReadStream **ppStream);
  ...
  DECLSPEC_XFGVIRT(IPartBase, SetPartCompression)
  HRESULT(STDMETHODCALLTYPE *SetPartCompression)(IPartResourceDictionary *This,
                                                 /* [annotation][in] */
                                                 _In_ EXpsCompressionOptions
                                                     compression);
...
#define IPartResourceDictionary_AddRef(This) ((This)->lpVtbl->AddRef(This))

#define IPartResourceDictionary_Release(This) ((This)->lpVtbl->Release(This))
...
typedef struct IXpsPartIteratorVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(IXpsPartIterator *This,
                                             /* [in] */ REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(IXpsPartIterator *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(IXpsPartIterator *This);

  DECLSPEC_XFGVIRT(IXpsPartIterator, Reset)
  void(STDMETHODCALLTYPE *Reset)(IXpsPartIterator *This);

  DECLSPEC_XFGVIRT(IXpsPartIterator, Current)
  HRESULT(STDMETHODCALLTYPE *Current)(IXpsPartIterator *This,
                                      /* [annotation][out] */
                                      _Out_ BSTR *pUri,
                                      /* [annotation][out] */
  ...
  BOOL(STDMETHODCALLTYPE *IsDone)(IXpsPartIterator *This);

  DECLSPEC_XFGVIRT(IXpsPartIterator, Next)
  void(STDMETHODCALLTYPE *Next)(IXpsPartIterator *This);

  END_INTERFACE
} IXpsPartIteratorVtbl;

interface IXpsPartIterator { CONST_VTBL struct IXpsPartIteratorVtbl *lpVtbl; };
...
#define IXpsPartIterator_AddRef(This) ((This)->lpVtbl->AddRef(This))

#define IXpsPartIterator_Release(This) ((This)->lpVtbl->Release(This))

#define IXpsPartIterator_Reset(This) ((This)->lpVtbl->Reset(This))

#define IXpsPartIterator_Current(This, pUri, ppXpsPart)                        \
  ((This)->lpVtbl->Current(This, pUri, ppXpsPart))

#define IXpsPartIterator_IsDone(This) ((This)->lpVtbl->IsDone(This))

#define IXpsPartIterator_Next(This) ((This)->lpVtbl->Next(This))
...
typedef struct IPrintReadStreamFactoryVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(IPrintReadStreamFactory *This,
                                             /* [in] */ REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(IPrintReadStreamFactory *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(IPrintReadStreamFactory *This);

  DECLSPEC_XFGVIRT(IPrintReadStreamFactory, GetStream)
  HRESULT(STDMETHODCALLTYPE *GetStream)(IPrintReadStreamFactory *This,
                                        /* [annotation][out] */
                                        _Outptr_ IPrintReadStream **ppStream);
...
#define IPrintReadStreamFactory_AddRef(This) ((This)->lpVtbl->AddRef(This))

#define IPrintReadStreamFactory_Release(This) ((This)->lpVtbl->Release(This))
...
typedef struct IPartDiscardControlVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(IPartDiscardControl *This,
                                             /* [in] */ REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(IPartDiscardControl *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(IPartDiscardControl *This);
...
#define IPartDiscardControl_AddRef(This) ((This)->lpVtbl->AddRef(This))

#define IPartDiscardControl_Release(This) ((This)->lpVtbl->Release(This))

#define IPartDiscardControl_GetDiscardProperties(This, uriSentinelPage,        \
                                                 uriPartToDiscard)             \
  ((This)->lpVtbl->GetDiscardProperties(This, uriSentinelPage,                 \
                                        uriPartToDiscard))
