...
// MessageText:
//
// Unable to perform the backup. Either you are not connected to the specified
// backup server or the service you are trying to backup is not running.
//
...
// MessageText:
//
// A restore map already exists for the specified component.  You can only
// specify a restore map when performing a full restore.
//
...
// MessageText:
//
// Another application has modified the specified Windows NT Directory Service
// database such that any subsequent backups will fail. You must perform a full
// backup to fix this problem.
//
...
// MessageText:
//
// Unable to perform an incremental backup because a required Windows NT
// Directory Service database log file could not be found.
//
...
// MessageText:
//
// The Windows NT Directory Service component specified is configured to use
// circular database logs. It cannot be backed up without a full backup.
//
...
// MessageText:
//
// The databases have not been restored to this machine. You cannot restore an
// incremental backup until a full backup has been restored.
//
...
// MessageText:
//
// Expiry token is missing. Cannot restore without knowing the expiry
// information.
//
...
// MessageText:
//
// DS Contents in the backup copy are out of date. Try restoring with a more
// recent copy.
//
...
// MessageText:
//
// The version of the log file is not compatible with the version of the Windows
// NT Directory Service database (NTDS).
//
