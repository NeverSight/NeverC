...
typedef interface IAudioProcessingObjectConfiguration
...
typedef interface IAudioSystemEffectsCustomFormats
...
typedef interface IApoAuxiliaryInputConfiguration
...
typedef struct IAudioProcessingObjectRTVtbl {
  ...
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(IAudioProcessingObjectRT *This,
                                             /* [in] */ REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(IAudioProcessingObjectRT *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(IAudioProcessingObjectRT *This);
  ...
  UINT32(STDMETHODCALLTYPE *CalcOutputFrames)(IAudioProcessingObjectRT *This,
                                              /* [annotation][in] */
...
#define IAudioProcessingObjectRT_AddRef(This) ((This)->lpVtbl->AddRef(This))

#define IAudioProcessingObjectRT_Release(This) ((This)->lpVtbl->Release(This))

#define IAudioProcessingObjectRT_APOProcess(                                   \
    This, u32NumInputConnections, ppInputConnections, u32NumOutputConnections, \
    ppOutputConnections)                                                       \
  ((This)->lpVtbl->APOProcess(This, u32NumInputConnections,                    \
                              ppInputConnections, u32NumOutputConnections,     \
                              ppOutputConnections))
...
typedef struct IAudioProcessingObjectVBRVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IAudioProcessingObjectVBR *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IAudioProcessingObjectVBR *This);
...
#define IAudioProcessingObjectVBR_AddRef(This) ((This)->lpVtbl->AddRef(This))

#define IAudioProcessingObjectVBR_Release(This) ((This)->lpVtbl->Release(This))

#define IAudioProcessingObjectVBR_CalcMaxInputFrames(                          \
    This, u32MaxOutputFrameCount, pu32InputFrameCount)                         \
  ((This)->lpVtbl->CalcMaxInputFrames(This, u32MaxOutputFrameCount,            \
                                      pu32InputFrameCount))

#define IAudioProcessingObjectVBR_CalcMaxOutputFrames(                         \
    This, u32MaxInputFrameCount, pu32OutputFrameCount)                         \
  ((This)->lpVtbl->CalcMaxOutputFrames(This, u32MaxInputFrameCount,            \
...
typedef struct IAudioProcessingObjectConfigurationVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(IAudioProcessingObjectConfiguration *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(IAudioProcessingObjectConfiguration *This);
...
#define IAudioProcessingObjectConfiguration_QueryInterface(This, riid,         \
                                                           ppvObject)          \
  ((This)->lpVtbl->QueryInterface(This, riid, ppvObject))
...
#define IAudioProcessingObjectConfiguration_LockForProcess(                    \
    This, u32NumInputConnections, ppInputConnections, u32NumOutputConnections, \
    ppOutputConnections)                                                       \
  ((This)->lpVtbl->LockForProcess(This, u32NumInputConnections,                \
                                  ppInputConnections, u32NumOutputConnections, \
                                  ppOutputConnections))
...
typedef struct IAudioProcessingObjectVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IAudioProcessingObject *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IAudioProcessingObject *This);

  DECLSPEC_XFGVIRT(IAudioProcessingObject, Reset)
  HRESULT(STDMETHODCALLTYPE *Reset)(__RPC__in IAudioProcessingObject *This);

  DECLSPEC_XFGVIRT(IAudioProcessingObject, GetLatency)
  HRESULT(STDMETHODCALLTYPE *GetLatency)(__RPC__in IAudioProcessingObject *This,
...
#define IAudioProcessingObject_AddRef(This) ((This)->lpVtbl->AddRef(This))

#define IAudioProcessingObject_Release(This) ((This)->lpVtbl->Release(This))

#define IAudioProcessingObject_Reset(This) ((This)->lpVtbl->Reset(This))
...
#define IAudioProcessingObject_IsInputFormatSupported(                         \
    This, pOppositeFormat, pRequestedInputFormat, ppSupportedInputFormat)      \
  ((This)->lpVtbl->IsInputFormatSupported(                                     \
      This, pOppositeFormat, pRequestedInputFormat, ppSupportedInputFormat))

#define IAudioProcessingObject_IsOutputFormatSupported(                        \
...
typedef struct IAudioDeviceModulesClientVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(IAudioDeviceModulesClient *This,
                                             /* [in] */ REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(IAudioDeviceModulesClient *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(IAudioDeviceModulesClient *This);
...
#define IAudioDeviceModulesClient_AddRef(This) ((This)->lpVtbl->AddRef(This))

#define IAudioDeviceModulesClient_Release(This) ((This)->lpVtbl->Release(This))

#define IAudioDeviceModulesClient_SetAudioDeviceModulesManager(                \
    This, pAudioDeviceModulesManager)                                          \
  ((This)->lpVtbl->SetAudioDeviceModulesManager(This,                          \
...
extern HRESULT WINAPI EnumerateAPOs(FNAPONOTIFICATIONCALLBACK pfnCallback,
                                    PVOID pvRefData);
extern HRESULT WINAPI GetAPOProperties(REFCLSID clsid,
...
IAudioSystemEffects : public IUnknown{public : };
...
typedef struct IAudioSystemEffectsVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IAudioSystemEffects *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IAudioSystemEffects *This);
...
#define IAudioSystemEffects_AddRef(This) ((This)->lpVtbl->AddRef(This))

#define IAudioSystemEffects_Release(This) ((This)->lpVtbl->Release(This))
...
typedef struct IAudioSystemEffects2Vtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(IAudioSystemEffects2 *This,
                                             /* [in] */ REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(IAudioSystemEffects2 *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(IAudioSystemEffects2 *This);
...
#define IAudioSystemEffects2_AddRef(This) ((This)->lpVtbl->AddRef(This))

#define IAudioSystemEffects2_Release(This) ((This)->lpVtbl->Release(This))

#define IAudioSystemEffects2_GetEffectsList(This, ppEffectsIds, pcEffects,     \
                                            Event)                             \
...
#define IAudioSystemEffectsCustomFormats_GetFormatRepresentation(              \
    This, nFormat, ppwstrFormatRep)                                            \
...
typedef struct IApoAuxiliaryInputConfigurationVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(IApoAuxiliaryInputConfiguration *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(IApoAuxiliaryInputConfiguration *This);
...
#define IApoAuxiliaryInputConfiguration_AddAuxiliaryInput(                     \
    This, dwInputId, cbDataSize, pbyData, pInputConnection)                    \
  ((This)->lpVtbl->AddAuxiliaryInput(This, dwInputId, cbDataSize, pbyData,     \
                                     pInputConnection))
...
#define IApoAuxiliaryInputConfiguration_IsInputFormatSupported(                \
    This, pRequestedInputFormat, ppSupportedInputFormat)                       \
  ((This)->lpVtbl->IsInputFormatSupported(This, pRequestedInputFormat,         \
...
typedef struct IApoAuxiliaryInputRTVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(IApoAuxiliaryInputRT *This,
                                             /* [in] */ REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(IApoAuxiliaryInputRT *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(IApoAuxiliaryInputRT *This);
...
#define IApoAuxiliaryInputRT_AddRef(This) ((This)->lpVtbl->AddRef(This))

#define IApoAuxiliaryInputRT_Release(This) ((This)->lpVtbl->Release(This))
...
IApoAcousticEchoCancellation : public IUnknown{public : };
...
#define IApoAcousticEchoCancellation_AddRef(This) ((This)->lpVtbl->AddRef(This))
...
typedef struct IApoAcousticEchoCancellation2Vtbl {
  ...
  DECLSPEC_XFGVIRT(IApoAcousticEchoCancellation2,
...
#define IApoAcousticEchoCancellation2_GetDesiredReferenceStreamProperties(     \
    This, pProperties)                                                         \
...
typedef /* [public] */
    struct __MIDL___MIDL_itf_audioenginebaseapo_0000_0012_0001 {
  LPARAM AddPageParam;
  LPWSTR pwstrEndpointID;
  IPropertyStore *pFxProperties;
} AudioFXExtensionParams;

DEFINE_PROPERTYKEY(PKEY_FX_Association, 0xD04E05A6, 0x594B, 0x4fb6, 0xA8, 0x0D,
                   0x01, 0xAF, 0x5E, 0xED, 0x7D, 0x1D, 0);
DEFINE_PROPERTYKEY(PKEY_FX_PreMixEffectClsid, 0xD04E05A6, 0x594B, 0x4fb6, 0xA8,
                   0x0D, 0x01, 0xAF, 0x5E, 0xED, 0x7D, 0x1D, 1);
DEFINE_PROPERTYKEY(PKEY_FX_PostMixEffectClsid, 0xD04E05A6, 0x594B, 0x4fb6, 0xA8,
                   0x0D, 0x01, 0xAF, 0x5E, 0xED, 0x7D, 0x1D, 2);
DEFINE_PROPERTYKEY(PKEY_FX_UserInterfaceClsid, 0xD04E05A6, 0x594B, 0x4fb6, 0xA8,
                   0x0D, 0x01, 0xAF, 0x5E, 0xED, 0x7D, 0x1D, 3);
DEFINE_PROPERTYKEY(PKEY_FX_FriendlyName, 0xD04E05A6, 0x594B, 0x4fb6, 0xA8, 0x0D,
                   0x01, 0xAF, 0x5E, 0xED, 0x7D, 0x1D, 4);
DEFINE_PROPERTYKEY(PKEY_FX_StreamEffectClsid, 0xD04E05A6, 0x594B, 0x4fb6, 0xA8,
                   0x0D, 0x01, 0xAF, 0x5E, 0xED, 0x7D, 0x1D, 5);
DEFINE_PROPERTYKEY(PKEY_FX_ModeEffectClsid, 0xD04E05A6, 0x594B, 0x4fb6, 0xA8,
                   0x0D, 0x01, 0xAF, 0x5E, 0xED, 0x7D, 0x1D, 6);
DEFINE_PROPERTYKEY(PKEY_FX_EndpointEffectClsid, 0xD04E05A6, 0x594B, 0x4fb6,
                   0xA8, 0x0D, 0x01, 0xAF, 0x5E, 0xED, 0x7D, 0x1D, 7);
DEFINE_PROPERTYKEY(PKEY_FX_KeywordDetector_StreamEffectClsid, 0xD04E05A6,
                   0x594B, 0x4fb6, 0xA8, 0x0D, 0x01, 0xAF, 0x5E, 0xED, 0x7D,
                   0x1D, 8);
DEFINE_PROPERTYKEY(PKEY_FX_KeywordDetector_ModeEffectClsid, 0xD04E05A6, 0x594B,
                   0x4fb6, 0xA8, 0x0D, 0x01, 0xAF, 0x5E, 0xED, 0x7D, 0x1D, 9);
DEFINE_PROPERTYKEY(PKEY_FX_KeywordDetector_EndpointEffectClsid, 0xD04E05A6,
                   0x594B, 0x4fb6, 0xA8, 0x0D, 0x01, 0xAF, 0x5E, 0xED, 0x7D,
                   0x1D, 10);
DEFINE_PROPERTYKEY(PKEY_FX_Offload_StreamEffectClsid, 0xD04E05A6, 0x594B,
                   0x4fb6, 0xA8, 0x0D, 0x01, 0xAF, 0x5E, 0xED, 0x7D, 0x1D, 11);
DEFINE_PROPERTYKEY(PKEY_FX_Offload_ModeEffectClsid, 0xD04E05A6, 0x594B, 0x4fb6,
                   0xA8, 0x0D, 0x01, 0xAF, 0x5E, 0xED, 0x7D, 0x1D, 12);
DEFINE_PROPERTYKEY(PKEY_CompositeFX_StreamEffectClsid, 0xD04E05A6, 0x594B,
                   0x4fb6, 0xA8, 0x0D, 0x01, 0xAF, 0x5E, 0xED, 0x7D, 0x1D, 13);
DEFINE_PROPERTYKEY(PKEY_CompositeFX_ModeEffectClsid, 0xD04E05A6, 0x594B, 0x4fb6,
                   0xA8, 0x0D, 0x01, 0xAF, 0x5E, 0xED, 0x7D, 0x1D, 14);
DEFINE_PROPERTYKEY(PKEY_CompositeFX_EndpointEffectClsid, 0xD04E05A6, 0x594B,
                   0x4fb6, 0xA8, 0x0D, 0x01, 0xAF, 0x5E, 0xED, 0x7D, 0x1D, 15);
DEFINE_PROPERTYKEY(PKEY_CompositeFX_KeywordDetector_StreamEffectClsid,
                   0xD04E05A6, 0x594B, 0x4fb6, 0xA8, 0x0D, 0x01, 0xAF, 0x5E,
                   0xED, 0x7D, 0x1D, 16);
DEFINE_PROPERTYKEY(PKEY_CompositeFX_KeywordDetector_ModeEffectClsid, 0xD04E05A6,
                   0x594B, 0x4fb6, 0xA8, 0x0D, 0x01, 0xAF, 0x5E, 0xED, 0x7D,
                   0x1D, 17);
DEFINE_PROPERTYKEY(PKEY_CompositeFX_KeywordDetector_EndpointEffectClsid,
                   0xD04E05A6, 0x594B, 0x4fb6, 0xA8, 0x0D, 0x01, 0xAF, 0x5E,
                   0xED, 0x7D, 0x1D, 18);
DEFINE_PROPERTYKEY(PKEY_CompositeFX_Offload_StreamEffectClsid, 0xD04E05A6,
                   0x594B, 0x4fb6, 0xA8, 0x0D, 0x01, 0xAF, 0x5E, 0xED, 0x7D,
                   0x1D, 19);
DEFINE_PROPERTYKEY(PKEY_CompositeFX_Offload_ModeEffectClsid, 0xD04E05A6, 0x594B,
                   0x4fb6, 0xA8, 0x0D, 0x01, 0xAF, 0x5E, 0xED, 0x7D, 0x1D, 20);
DEFINE_PROPERTYKEY(PKEY_FX_SupportAppLauncher, 0xD04E05A6, 0x594B, 0x4fb6, 0xA8,
                   0x0D, 0x01, 0xAF, 0x5E, 0xED, 0x7D, 0x1D, 21);
DEFINE_PROPERTYKEY(PKEY_FX_SupportedFormats, 0xD04E05A6, 0x594B, 0x4fb6, 0xA8,
                   0x0D, 0x01, 0xAF, 0x5E, 0xED, 0x7D, 0x1D, 22);
DEFINE_PROPERTYKEY(PKEY_FX_Enumerator, 0xD04E05A6, 0x594B, 0x4fb6, 0xA8, 0x0D,
                   0x01, 0xAF, 0x5E, 0xED, 0x7D, 0x1D, 23);
DEFINE_PROPERTYKEY(PKEY_FX_VersionMajor, 0xD04E05A6, 0x594B, 0x4fb6, 0xA8, 0x0D,
                   0x01, 0xAF, 0x5E, 0xED, 0x7D, 0x1D, 24);
DEFINE_PROPERTYKEY(PKEY_FX_VersionMinor, 0xD04E05A6, 0x594B, 0x4fb6, 0xA8, 0x0D,
                   0x01, 0xAF, 0x5E, 0xED, 0x7D, 0x1D, 25);
DEFINE_PROPERTYKEY(PKEY_FX_Author, 0xD04E05A6, 0x594B, 0x4fb6, 0xA8, 0x0D, 0x01,
                   0xAF, 0x5E, 0xED, 0x7D, 0x1D, 26);
DEFINE_PROPERTYKEY(PKEY_FX_ObjectId, 0xD04E05A6, 0x594B, 0x4fb6, 0xA8, 0x0D,
                   0x01, 0xAF, 0x5E, 0xED, 0x7D, 0x1D, 27);
DEFINE_PROPERTYKEY(PKEY_FX_State, 0xD04E05A6, 0x594B, 0x4fb6, 0xA8, 0x0D, 0x01,
                   0xAF, 0x5E, 0xED, 0x7D, 0x1D, 28);
DEFINE_PROPERTYKEY(PKEY_FX_EffectPackSchema_Version, 0xD04E05A6, 0x594B, 0x4fb6,
                   0xA8, 0x0D, 0x01, 0xAF, 0x5E, 0xED, 0x7D, 0x1D, 29);
DEFINE_PROPERTYKEY(PKEY_FX_ApplyToBluetooth, 0xD04E05A6, 0x594B, 0x4fb6, 0xA8,
                   0x0D, 0x01, 0xAF, 0x5E, 0xED, 0x7D, 0x1D, 30);
DEFINE_PROPERTYKEY(PKEY_FX_ApplyToUsb, 0xD04E05A6, 0x594B, 0x4fb6, 0xA8, 0x0D,
                   0x01, 0xAF, 0x5E, 0xED, 0x7D, 0x1D, 31);
DEFINE_PROPERTYKEY(PKEY_FX_ApplyToRender, 0xD04E05A6, 0x594B, 0x4fb6, 0xA8,
                   0x0D, 0x01, 0xAF, 0x5E, 0xED, 0x7D, 0x1D, 32);
DEFINE_PROPERTYKEY(PKEY_FX_ApplyToCapture, 0xD04E05A6, 0x594B, 0x4fb6, 0xA8,
                   0x0D, 0x01, 0xAF, 0x5E, 0xED, 0x7D, 0x1D, 33);
DEFINE_PROPERTYKEY(PKEY_FX_RequestSetAsDefault, 0xD04E05A6, 0x594B, 0x4fb6,
                   0xA8, 0x0D, 0x01, 0xAF, 0x5E, 0xED, 0x7D, 0x1D, 34);
DEFINE_PROPERTYKEY(PKEY_FX_RequestSetAsDefaultPriority, 0xD04E05A6, 0x594B,
                   0x4fb6, 0xA8, 0x0D, 0x01, 0xAF, 0x5E, 0xED, 0x7D, 0x1D, 35);
DEFINE_PROPERTYKEY(PKEY_FX_OEM_Preferred_EffectPack_Id, 0xD04E05A6, 0x594B,
                   0x4fb6, 0xA8, 0x0D, 0x01, 0xAF, 0x5E, 0xED, 0x7D, 0x1D, 36);
DEFINE_PROPERTYKEY(PKEY_SFX_ProcessingModes_Supported_For_Streaming, 0xd3993a3f,
                   0x99c2, 0x4402, 0xb5, 0xec, 0xa9, 0x2a, 0x3, 0x67, 0x66,
                   0x4b, 5);
DEFINE_PROPERTYKEY(PKEY_MFX_ProcessingModes_Supported_For_Streaming, 0xd3993a3f,
                   0x99c2, 0x4402, 0xb5, 0xec, 0xa9, 0x2a, 0x3, 0x67, 0x66,
                   0x4b, 6);
DEFINE_PROPERTYKEY(PKEY_EFX_ProcessingModes_Supported_For_Streaming, 0xd3993a3f,
                   0x99c2, 0x4402, 0xb5, 0xec, 0xa9, 0x2a, 0x3, 0x67, 0x66,
                   0x4b, 7);
DEFINE_PROPERTYKEY(
    PKEY_SFX_KeywordDetector_ProcessingModes_Supported_For_Streaming,
    0xd3993a3f, 0x99c2, 0x4402, 0xb5, 0xec, 0xa9, 0x2a, 0x3, 0x67, 0x66, 0x4b,
    8);
DEFINE_PROPERTYKEY(
...
DEFINE_PROPERTYKEY(
    ...
    0xd3993a3f, 0x99c2, 0x4402, 0xb5, 0xec, 0xa9, 0x2a, 0x3, 0x67, 0x66, 0x4b,
    10);
DEFINE_PROPERTYKEY(PKEY_SFX_Offload_ProcessingModes_Supported_For_Streaming,
                   0xd3993a3f, 0x99c2, 0x4402, 0xb5, 0xec, 0xa9, 0x2a, 0x3,
                   0x67, 0x66, 0x4b, 11);
DEFINE_PROPERTYKEY(PKEY_MFX_Offload_ProcessingModes_Supported_For_Streaming,
                   0xd3993a3f, 0x99c2, 0x4402, 0xb5, 0xec, 0xa9, 0x2a, 0x3,
                   0x67, 0x66, 0x4b, 12);
DEFINE_PROPERTYKEY(PKEY_APO_SWFallback_ProcessingModes, 0xd3993a3f, 0x99c2,
                   0x4402, 0xb5, 0xec, 0xa9, 0x2a, 0x3, 0x67, 0x66, 0x4b, 13);
DEFINE_GUID(PKEY_FX_EffectPack_Schema_V1, 0x7abf23d9, 0x727e, 0x4d0b, 0x86,
            0xa3, 0xdd, 0x50, 0x1d, 0x26, 0x0, 0x1);
