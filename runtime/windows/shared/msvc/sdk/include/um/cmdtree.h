...
typedef struct ICommandTreeVtbl {
  ...
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(ICommandTree *This,
                                             /* [in] */ REFIID riid,
...
interface ICommandTree { CONST_VTBL struct ICommandTreeVtbl *lpVtbl; };
...
typedef struct IQueryVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(IQuery *This,
                                             /* [in] */ REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);
...
interface IQuery { CONST_VTBL struct IQueryVtbl *lpVtbl; };
