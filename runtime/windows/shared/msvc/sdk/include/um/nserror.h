...
// MessageText:
//
// The maximum filebitrate value specified is greater than the server's
// configured maximum bandwidth.%0
//
...
// MessageText:
//
// There is no connection established with the Windows Media server. The
// operation failed.%0
//
...
// could not handle your request for multimedia content in a timely manner.
...
// MessageText:
//
// The specified protocol is not recognized. Be sure that the file name and
// syntax, such as slashes, are correct for the protocol.%0
//
...
// MessageText:
//
// The bandwidth required to stream a file is higher than the maximum file
// bandwidth allowed on the server.%0
//
...
// MessageText:
//
// A NetShow administrator at network location %1 set the data stream limit to
// %2 streams.%0
//
...
// MessageText:
//
// A NetShow administrator at network location %1 aborted user session %2 from
// the system.%0
//
...
// MessageText:
//
// The publishing point cannot be started because the server does not have the
// appropriate stream formats. Use the Multicast Announcement Wizard to create a
// new announcement for this publishing point.%0
//
...
// MessageText:
//
// A NetShow administrator at network location %1 set the maximum bandwidth
// limit to %2 bps.%0
//
...
// MessageText:
//
// Source file exceeds the per title maximum bitrate. See NetShow Theater
// documentation for more information.%0
//
...
// MessageText:
//
// Disk %1 ( %2 ) on Content Server %3, will be failed because it is
// catatonic.%0
//
...
// MessageText:
//
// This media file is corrupted or invalid. Contact the content provider for a
// new file.%0
//
...
// content provider for further assistance.%0
//
...
// MessageText:
//
// You are not allowed to open this file. Contact the content provider for
...
// MessageText:
//
// The requested URL cannot be accessed because there is no network
// connection.%0
//
...
// Convert the files to 16-bit, 44-kHz stereo files by using Sound Recorder or
// another audio-processing program, and then try again.%0
//
...
// MessageText:
//
// The wrong number of preprocessing passes was used for the stream's output
// type
//
...
// to analog playback, Click Organize, click Options, and then click the Devices
// tab. Double-click the CD drive, and then in the Playback area, click
// Analog.%0
//
...
// your portable device, and then try syncing the file again.%0
//
...
// MessageText:
//
// Windows Media Player cannot play the file. The portable device does not
// support the specified file type.%0
//
...
// MessageText:
//
// Windows Media Player could not use digital playback to play the CD. The
// Player has automatically switched the CD drive to analog playback. To switch
// back to digital CD playback, click Organize, click Options, and then use the
// Devices tab.%0
//
...
// different format to rip to (such as Windows Media Audio).%0
//
...
// Turn on error correction, and then try again.%0
//
...
//
// Windows Media Player cannot read the CD. The disc might be dirty or damaged
// or the CD drive might be malfunctioning.%0
//
...
// MessageText:
//
// It is not possible to directly burn tracks from one CD to another CD. You
// must first rip the tracks from the CD to your computer, and then burn the
// files to a blank CD.%0
//
...
// MessageText:
//
// Windows Media Player cannot rip tracks from the CD correctly because the CD
// drive settings in Device Manager do not match the CD drive settings in the
// Player.%0
//
...
// Windows Media Player could not use digital playback to play the CD. The
// Player has automatically switched the CD drive to analog playback. To switch
// back to digital CD playback, click Organize, click options, and use the
// Devices tab.%0
//
...
// MessageText:
//
// A generic parse error occurred in the XML parser but no information is
// available.%0
//
...
// MessageText:
//
// A call get GetNamedAttribute or GetNamedAttributeIndex on the XML parser
// resulted in the index not being found.%0
//
...
// MessageText:
//
// Persist was called on the XML parser, but the parser has no data to
// persist.%0
//
...
// MessageText:
//
// Windows Media Player is already searching for files to add to your library.
// Wait for the current process to finish before attempting to search again.%0
//
...
// MessageText:
//
// A component of Windows Media Player is out-of-date. If you are running a
// pre-release version of Windows, try upgrading to a more recent version.%0
//
...
// MessageText:
//
// The request could not be completed because the request does not match the
// current state of the media library.%0
//
...
// store, go to the online store to get burn rights.%0
//
...
//
// Windows Media Player no longer detects a connected portable device. Reconnect
// your portable device, and then try to sync the file again.%0
//
...
// MessageText:
//
// Windows Media Player encountered an error while attempting to access
// information in the library. Try restarting the Player.%0
//
...
// MessageText:
//
// Windows Media Player cannot create the library. You must be logged on as an
// administrator or a member of the Administrators group to install the Player.
// For more information, contact your system administrator.%0
//
...
// MessageText:
//
// The file is already in use. Close other programs that might be using the
// file, or stop playing the file, and then try again.%0
//
...
// MessageText:
//
// The Windows Media Player ActiveX control cannot connect to remote media
// services, but will continue with local media services.%0
//
...
// MessageText:
//
// The requested method or property is not available because the Windows Media
// Player ActiveX control has not been properly activated.%0
//
...
// MessageText:
//
// An error occurred while trying to get the remote Windows Media Player
// window.%0
//
...
// MessageText:
//
// Windows Media Player was not closed properly. A damaged or incompatible
// plug-in might have caused the problem to occur. As a precaution, all optional
// plug-ins have been disabled.%0
//
...
// or the computer where the path is located is not available.%0
//
...
// remove it from the menu. To use this plug-in, install it again.%0
//
...
// MessageText:
//
// The Windows Media Player ActiveX control must be in a docked state for this
// action to be performed.%0
//
...
// MessageText:
//
// Windows Media Player cannot perform the requested action. Your computer's
// time and date might not be set correctly.%0
//
...
// MessageText:
//
// The control (%s) does not support creation of sub-controls, yet (%d)
// sub-controls have been specified.%0
//
...
// MessageText:
//
// An upgrade might be needed for the theme manager to correctly show this skin.
// Skin reports version: %.1f.%0
//
...
// MessageText:
//
// Windows Media Player cannot send the link because your e-mail program is not
// responding. Verify that your e-mail program is configured properly, and then
// try again.%0
//
...
// MessageText:
//
// Windows Media Player cannot switch to full mode because your computer
// administrator has locked this skin.%0
//
...
//  MessageText:
//
//  Windows Media Player cannot overwrite a read-only file. Try using a
//  different file name.%0
//
...
// MessageText:
//
// Windows Media Player encountered a problem while creating or saving the
// playlist.%0
//
...
// MessageText:
//
// Windows Media Player cannot open the Windows Media Download file. The file
// might be damaged.%0
//
...
// MessageText:
//
// The file cannot be added to the library because it is a protected DVR-MS
// file. This content cannot be played back by Windows Media Player.%0
//
...
// a file name that was not found in the ZIP file.%0
//
...
// not support the picture type or the picture is corrupted.%0
//
...
// MessageText:
//
// Windows Media Player cannot compute a Digital Audio Id for the song. It is
// too short.%0
//
...
// MessageText:
//
// Windows Media Player cannot download media usage rights for a file in the
// playlist.%0
//
#define NS_E_WMG_PREROLLLICENSEACQUISITIONNOTALLOWED                           \
  _HRESULT_TYPEDEF_(0xC00D104DL)
...
// that the connection to your video card is secure. Try installing an updated
// device driver for your video card.%0
//
...
// the connection to your hardware might not be secure.%0
//
...
// MessageText:
//
// The Windows Media SDK interface needed to complete the operation does not
// exist at this time.%0
//
...
// codec that either could not be downloaded or that is not supported by the
// Player.%0
//
...
// MessageText:
//
// Windows Media Player cannot play the file. The Player does not support the
// format you are trying to play.%0
//
...
// MessageText:
//
// An operation was attempted on a pin that does not exist in the DirectShow
// filter graph.%0
//
...
// MessageText:
//
// Specified operation cannot be completed while waiting for a media format
// change from the SDK.%0
//
...
// MessageText:
//
// Specified operation cannot be completed because the source filter does not
// exist.%0
//
...
// is available to download, click Web Help.%0
//
...
// MessageText:
//
// Windows Media Player cannot play protected files that contain binary
// streams.%0
//
...
// MessageText:
//
// The timestamp is late compared to the current render position. Advise
// dropping this frame.%0
//
...
// MessageText:
//
// The timestamp is severely late compared to the current render position.
// Advise dropping everything up to the next key frame.%0
//
...
// MessageText:
//
// A later version of Windows Media Player might be required to play this
// playlist.%0
//
...
// MessageText:
//
// The specified auto playlist contains a filter type that is either not valid
// or is not installed on this computer.%0
//
#define NS_E_MLS_SMARTPLAYLIST_FILTER_NOT_REGISTERED                           \
  _HRESULT_TYPEDEF_(0xC00D1075L)
...
// MessageText:
//
// Windows Media Player cannot find the file. Verify that the path is typed
// correctly. If it is, the file might not exist in the specified location, or
// the computer where the file is stored might not be available.%0
//
...
// MessageText:
//
// Windows Media Player cannot play the file because it is not in the current
// playlist.%0
//
...
// MessageText:
//
// There are no items in the playlist. Add items to the playlist, and then try
// again.%0
//
...
// MessageText:
//
// The website cannot be displayed because no web browser is installed on your
// computer.%0
//
...
// correctly. If it is, the file does not exist in the specified location, or
// the computer where the file is stored is not available.%0
//
...
// only one item in the playlist.%0
//
#define NS_E_WMPCORE_PLAYLIST_EMPTY_OR_SINGLE_MEDIA                            \
  _HRESULT_TYPEDEF_(0xC00D108BL)
...
//
// Windows Media Player cannot play the file because the associated playlist
// does not contain any items or the playlist is not valid.%0
//
...
// MessageText:
//
// Windows Media Player cannot play the file. The file is either corrupted or
// the Player does not support the format you are trying to play.%0
//
...
// play the file could not be found.%0
//
...
// MessageText:
//
// Windows Media Player cannot play the file because a required codec is not
// installed on your computer. To try downloading the codec, turn on the
// "Download codecs automatically" option.%0
//
...
// MessageText:
//
// Windows Media Player encountered a problem with the playlist. The format of
// the playlist is not valid.%0
//
...
// MessageText:
//
// Media object corresponding to start of a playlist repeat block was not
// found.%0
//
#define NS_E_WMPCORE_PLAYLIST_REPEAT_START_MEDIA_NONE                          \
  _HRESULT_TYPEDEF_(0xC00D10ADL)
...
// MessageText:
//
// Media object corresponding to the end of a playlist repeat block was not
// found.%0
//
#define NS_E_WMPCORE_PLAYLIST_REPEAT_END_MEDIA_NONE                            \
  _HRESULT_TYPEDEF_(0xC00D10AEL)
...
// MessageText:
//
// Windows Media Player cannot add the playlist to the library because the
// playlist does not contain any items.%0
//
#define NS_E_WMPCORE_PLAYLIST_IMPORT_FAILED_NO_ITEMS                           \
  _HRESULT_TYPEDEF_(0xC00D10B1L)
...
// MessageText:
//
// An error has occurred that could prevent the changing of the video contrast
// on this media.%0
//
#define NS_E_WMPCORE_VIDEO_TRANSFORM_FILTER_INSERTION                          \
  _HRESULT_TYPEDEF_(0xC00D10B2L)
...
// storage card, insert the storage card.%0
//
...
// MessageText:
//
// The playlist contains an ENTRYREF for which no href was parsed. Check the
// syntax of playlist file.%0
//
...
// information about the problem, click the icon next to each file in the list
// pane.%0
//
#define NS_E_WMPCORE_NO_PLAYABLE_MEDIA_IN_PLAYLIST                             \
  _HRESULT_TYPEDEF_(0xC00D10B5L)
...
// MessageText:
//
// Windows Media Player cannot play some or all of the items in the playlist
// because the playlist is nested.%0
//
#define NS_E_WMPCORE_PLAYLIST_EMPTY_NESTED_PLAYLIST_SKIPPED_ITEMS              \
  _HRESULT_TYPEDEF_(0xC00D10B6L)
...
// MessageText:
//
// Windows Media Player cannot find the file. The link from the item in the
// library to its associated digital media file might be broken. To fix the
// problem, try repairing the link or removing the item from the library.%0
//
...
// MessageText:
//
// Windows Media Player cannot sync the file because the device needs to be
// updated.%0
//
...
// MessageText:
//
// Windows Media Player cannot play the video because there is a problem with
// your video card.%0
//
...
// MessageText:
//
// Windows Media Player failed to change the screen mode for full-screen video
// playback.%0
//
...
// information, right-click an item that cannot be played, and then click Error
// Details.%0
//
...
// MessageText:
//
// Cannot change the proxy exception list if the proxy setting is not set to
// custom.%0
//
...
// MessageText:
//
// Cannot change the proxy bypass flag if the proxy setting is not set to
// custom.%0
//
...
// MessageText:
//
// Cannot change the language settings. Either the graph has no audio or the
// audio only supports one language.%0
//
...
// MessageText:
//
// To play the selected item, you must install the Adobe Flash Player. To
// download the Adobe Flash Player, go to the Adobe Web site.%0
//
...
// MessageText:
//
// To play the selected item, you must install a later version of the Adobe
// Flash Player. To download the Adobe Flash Player, go to the Adobe website.%0
//
...
// MessageText:
//
// Windows Media Player cannot play the file because your Internet security
// settings prohibit the use of ActiveX controls.%0
//
#define NS_E_WMPOCXGRAPH_IE_DISALLOWS_ACTIVEX_CONTROLS                         \
  _HRESULT_TYPEDEF_(0xC00D10CBL)
...
// MessageText:
//
// Windows Media Player cannot play the CD. The disc might be dirty or
// damaged.%0
//
...
// MessageText:
//
// Windows Media Player encountered a problem while ripping the track from the
// CD.%0
//
...
// MessageText:
//
// This file cannot be burned to a CD because it is not located on your
// computer.%0
//
...
// MessageText:
//
// It is not possible to burn this file type to an audio CD. Windows Media
// Player can burn the following file types to an audio CD: WMA, MP3, or WAV.%0
//
#define NS_E_WMP_FILE_TYPE_CANNOT_BURN_TO_AUDIO_CD                             \
  _HRESULT_TYPEDEF_(0xC00D10D7L)
...
// before burning might enable the Player to detect the file length.%0
//
...
// that you chose to buy could not be downloaded from the online store.%0
//
...
// Manager to update the device drivers for your audio and video cards. For
// information about using Windows Update or Device Manager, see Windows Help.%0
//
...
// Connect to the Internet, and then try again.%0
//
...
// MessageText:
//
// Your media usage rights were not restored because the restoration was
// canceled.%0
//
...
// MessageText:
//
// An error occurred while backing up or restoring your media usage rights. A
// required web page cannot be displayed.%0
//
...
// MessageText:
//
// Windows Media Player cannot restore your media usage rights from the
// specified location. Choose another location, and then try again.%0
//
...
// MessageText:
//
// Request to the effects control to change transparency status to
// transparent.%0
//
...
// MessageText:
//
// The requested application pane is performing an operation and will not be
// released.%0
//
...
// MessageText:
//
// Windows Media Player cannot add the file to the library because the content
// provider prohibits it. For assistance, contact the company that provided the
// file.%0
//
...
// MessageText:
//
// Windows Media Player cannot add the file to the library. The file might not
// be valid.%0
//
...
// display the website of the company that provided the file.%0
//
#define NS_E_WMP_CONVERT_PLUGIN_UNAVAILABLE_ERRORURL                           \
  _HRESULT_TYPEDEF_(0xC00D115CL)
...
//
// Windows Media Player cannot add the file to the library. The plug-in required
// to add the file is not installed properly. For assistance, contact the
// company that provided the file.%0
//
#define NS_E_WMP_CONVERT_PLUGIN_UNAVAILABLE_NOERRORURL                         \
  _HRESULT_TYPEDEF_(0xC00D115DL)
...
// MessageText:
//
// Windows Media Player cannot play this DVD. Try installing an updated driver
// for your video card or obtaining a newer video card.%0
//
...
// MessageText:
//
// This DVD's resolution exceeds the maximum allowed by your component video
// outputs. Try reducing your screen resolution to 640 x 480, or turn off analog
// component outputs and use a VGA connection to your monitor.%0
//
...
// MessageText:
//
// Windows Media Player cannot display subtitles or highlights in DVD menus.
// Reinstall the DVD decoder or contact the DVD drive manufacturer to obtain an
// updated decoder.%0
//
...
// installing an updated driver for your video card.%0
//
...
// MessageText:
//
// Windows Media Player cannot play the DVD. The disc was created in a manner
// that the Player does not support.%0
//
...
// MessageText:
//
// Windows Media Player cannot play the DVD because your video card does not
// support DVD playback.%0
//
...
// on analog copy protection on the output display. Try installing an updated
// driver for your video card.%0
//
...
// DVD drive does not match the region assigned to your DVD decoder.%0
//
...
// try lowering your screen resolution and color quality settings.%0
//
...
// MessageText:
//
// Windows Media Player cannot play DVD audio. Verify that your sound card is
// set up correctly, and then try again.%0
//
...
// other programs, and then try again. If the problem persists, restart your
// computer.%0
//
...
// not installed on your computer.%0
//
...
// MessageText:
//
// Windows Media Player cannot play the scene because it has a parental rating
// higher than the rating that you are authorized to view.%0
//
...
// MessageText:
//
// Windows Media Player cannot play the DVD because it is currently in use by
// another program. Quit the other program that is using the DVD, and then try
// again.%0
//
...
// MessageText:
//
// Windows Media Player cannot burn the files because the Player cannot find a
// burner. If the burner is connected properly, try using Windows Update to
// install the latest device driver.%0
//
...
// MessageText:
//
// Windows Media Player does not detect storage media in the selected device.
// Insert storage media into the device, and then try again.%0
//
...
// MessageText:
//
// Windows Media Player encountered an error while communicating with the
// device. The storage card on the device might be full, the device might be
// turned off, or the device might not allow playlists or folders to be created
// on it.%0
//
...
// recording speed, and then try again.%0
//
...
// MessageText:
//
// There is not enough storage space on the portable device to complete this
// operation. Delete some unneeded files on the portable device, and then try
// again.%0
//
...
// MessageText:
//
// Windows Media Player cannot burn the files. Verify that your burner is
// connected properly, and then try again. If the problem persists, reinstall
// the Player.%0
//
...
// MessageText:
//
// Windows Media Player did not sync some files to the device because there is
// not enough storage space on the device.%0
//
...
// MessageText:
//
// Windows Media Player cannot perform the requested action because the device
// does not support sync.%0
//
...
// MessageText:
//
// To perform the requested action, you must first set up sync with the
// device.%0
//
...
// MessageText:
//
// You have already created sync partnerships with 16 devices. To create a new
// sync partnership, you must first end an existing partnership.%0
//
#define NS_E_PDA_CANNOT_CREATE_ADDITIONAL_SYNC_RELATIONSHIP                    \
  _HRESULT_TYPEDEF_(0xC00D1185L)
...
// MessageText:
//
// Windows Media Player cannot sync the file because protected files cannot be
// converted to the required quality level or file format.%0
//
...
// MessageText:
//
// The folder that stores converted files is full. Either empty the folder or
// increase its size, and then try again.%0
//
...
// MessageText:
//
// There are too many files with the same name in the folder on the device.
// Change the file name or sync to a different folder.%0
//
...
// MessageText:
//
// Windows Media Player cannot convert the file to the format required by the
// device.%0
//
...
// the device and storing some files in them.%0
//
...
// MessageText:
//
// Windows Media Player cannot convert this file format. If an updated version
// of the codec used to compress this file is available, install it and then try
// to sync the file again.%0
//
...
// MessageText:
//
// Windows Media Player cannot sync the file because a file with the same name
// already exists on the device. Change the file name or try to sync the file to
// a different folder.%0
//
...
// MessageText:
//
// Automatic and manual sync have been turned off temporarily. To sync to a
// device, restart Windows Media Player.%0
//
...
// MessageText:
//
// This device is not available. Connect the device to the computer, and then
// try again.%0
//
...
// MessageText:
//
// Windows Media Player cannot sync the file because an error occurred while
// converting the file to another quality level or format. If the problem
// persists, remove the file from the list of files to sync.%0
//
...
// MessageText:
//
// Windows Media Player cannot sync the file to your device. The file might be
// stored in a location that is not supported. Copy the file from its current
// location to your hard disk, add it to your library, and then try to sync the
// file again.%0
//
...
// configured to use all available protocols, and then try again.%0
//
...
// enough storage space on your computer. Delete some unneeded files on your
// hard disk, and then try again.%0
//
...
// MessageText:
//
// The server denied access to the file. Verify that you are using the correct
...
// has been moved, renamed, or deleted.%0
//
...
//
// Windows Media Player cannot play the file. The Player might not support the
// file type or a required codec might not be installed on your computer.%0
//
...
// MessageText:
//
// Windows Media Player cannot create the playlist because the name already
// exists. Type a different playlist name.%0
//
...
// MessageText:
//
// Windows Media Player cannot delete the playlist because it contains items
// that are not digital media files. Any digital media files in the playlist
// were deleted.%0
//
...
// MessageText:
//
// The playlist cannot be opened because it is stored in a shared folder on
// another computer. If possible, move the playlist to the playlists folder on
// your computer.%0
//
...
// MessageText:
//
// Windows Media Player is already in use. Stop playing any items, close all
// Player dialog boxes, and then try again.%0
//
...
// MessageText:
//
// Windows Media Player encountered an error while burning. Verify that the
// burner is connected properly and that the disc is clean and not damaged.%0
//
...
// MessageText:
//
// Windows Media Player has encountered an unknown error with your portable
// device. Reconnect your portable device, and then try again.%0
//
...
// MessageText:
//
// A codec is required to play this file. To determine if this codec is
// available to download from the web, click Web Help.%0
//
...
// MessageText:
//
// To play the file, you must install the latest Windows service pack. To
// install the service pack from the Windows Update website, click Web Help.%0
//
...
// MessageText:
//
// Windows Media Player no longer detects a portable device. Reconnect your
// portable device, and then try again.%0
//
...
// MessageText:
//
// Windows Media Player cannot sync the file because the portable device does
// not support protected files.%0
//
...
// store, go to the online store to get sync rights.%0
//
...
// MessageText:
//
// Windows Media Player cannot sync the file because the sync rights have
// expired. Go to the content provider's online store to get new sync rights.%0
//
...
// MessageText:
//
// The portable device is already in use. Wait until the current task finishes
// or quit other programs that might be using the portable device, and then try
// again.%0
//
...
// MessageText:
//
// Windows Media Player cannot sync the file because the content provider or
// device prohibits it. You might be able to resolve this problem by going to
// the content provider's online store to get sync rights.%0
//
...
// MessageText:
//
// The content provider has not granted you the right to sync this file. Go to
// the content provider's online store to get sync rights.%0
//
...
// different brand of blank discs.%0
//
...
// MessageText:
//
// Windows Media Player cannot burn the files. Verify that the burner is
// connected properly, and then try again.%0
//
...
//
// Windows Media Player cannot burn the files. Verify that the burner is
// connected properly and that the disc is clean and not damaged. If the burner
// is already in use, wait until the current task finishes or quit other
// programs that might be using the burner.%0
//
...
// or there might be a problem with your network or firewall settings.%0
//
...
// usage rights. Connect to the Internet, and then try again.%0
//
...
// network and that your proxy settings are correct.%0
//
...
// not find any backed up rights on your computer.%0
//
...
// not available (for example, the server might be busy or not online).%0
//
...
// MessageText:
//
// Windows Media Player cannot play the file. A network firewall might be
// preventing the Player from opening the file by using the UDP transport
// protocol. If you typed a URL in the Open URL dialog box, try using a
// different transport protocol (for example, "http:").%0
//
...
// responding. The proxy server might be temporarily unavailable or your Player
// proxy settings might not be valid.%0
//
...
// Player. On the Help menu, click Check for Updates, and then follow the
// instructions.%0
//
...
// different transport protocol (for example, "http:" or "rtsp:").%0
//
...
// MessageText:
//
// Windows Media Player cannot add the file to the library because the file
...
// Windows Media Player cannot play the file because the specified protocol is
// not supported. If you typed a URL in the Open URL dialog box, try using a
// different transport protocol (for example, "mms:").%0
//
...
// MessageText:
//
// Windows Media Player cannot play the file because there are no streaming
// protocols selected. Select one or more protocols, and then try again.%0
//
...
// MessageText:
//
// Windows Media Player cannot switch to Full Screen. You might need to adjust
// your Windows display settings. Open display settings in Control Panel, and
// then try setting Hardware acceleration to Full.%0
//
...
//
// Windows Media Player cannot play the file because a network error occurred.
// The server might not be available (for example, the server is busy or not
// online) or you might not be connected to the network.%0
//
...
// responding. Verify that you are connected to the network, and then try again
// later.%0
//
...
// not enabled. On the Tools menu, click Options, click the Network tab, and
// then select the Multicast check box.%0
//
...
// Verify that you are connected to the network, and then try again later.%0
//
...
// MessageText:
//
// Windows Media Player cannot play the file because the network proxy server
// cannot be found. Verify that your proxy settings are correct, and then try
// again.%0
//
...
// MessageText:
//
// Windows Media Player cannot play, burn, rip, or sync the file because a
// required audio codec is not installed on your computer.%0
//
...
// MessageText:
//
// Windows Media Player cannot burn the files. If the burner is busy, wait for
// the current task to finish. If necessary, verify that the burner is connected
// properly and that you have installed the latest device driver.%0
//
...
// MessageText:
//
// Windows Media Player cannot play the protected file because there is a
// problem with your sound device. Try installing a new device driver or use a
// different sound device.%0
//
...
// MessageText:
//
// Windows Media Player cannot play the file because the required codec is not
// valid.%0
//
...
// MessageText:
//
// The CD drive is in use by another user. Wait for the task to complete, and
// then try again.%0
//
...
// system. You might need to connect to the Internet to update your DRM
// components.%0
//
...
// with your sound or video device. Try installing an updated device driver.%0
//
...
// settings might not be correct.%0
//
...
// MessageText:
//
// The content provider prohibits this action. Go to the content provider's
// online store to get new media usage rights.%0
//
...
// MessageText:
//
// Windows Media Player cannot burn the files because there is not enough free
// disk space to store the temporary files. Delete some unneeded files on your
// hard disk, and then try again.%0
//
...
// MessageText:
//
// Your media usage rights have become corrupted or are no longer valid. This
// might happen if you have replaced hardware components in your computer.%0
//
...
// MessageText:
//
// The required Windows Media Digital Rights Management (DRM) component cannot
// be validated. You might be able to resolve the problem by reinstalling the
// Player.%0
//
...
// MessageText:
//
// You have exceeded your restore limit for the day. Try restoring your media
// usage rights tomorrow.%0
//
...
// MessageText:
//
// Some files might not fit on the CD. The required space cannot be calculated
// accurately because some files might be missing duration information. To
// ensure the calculation is accurate, play the files that are missing duration
// information.%0
//
...
// MessageText:
//
// Windows Media Player cannot verify the file's media usage rights. If you
// obtained this file from an online store, go to the online store to get the
// necessary rights.%0
//
...
// MessageText:
//
// It is not possible to sync because this device's internal clock is not set
// correctly. To set the clock, select the option to set the device clock on the
// Privacy tab of the Options dialog box, connect to the Internet, and then sync
// the device again. For additional assistance, click Web Help.%0
//
...
// MessageText:
//
// Windows Media Player cannot play, burn, rip, or sync the protected file
// because you do not have the appropriate rights.%0
//
...
// any new connections. This could be because it has reached its maximum
// connection limit. Please try again later.%0
//
...
// MessageText:
//
// A number of queued files cannot be played. To find information about the
// problem, click the icon next to each file in the List pane.%0
//
...
// MessageText:
//
// Windows Media Player cannot erase the rewritable CD or DVD. Verify that the
// CD or DVD burner is connected properly and that the disc is clean and not
// damaged. If the burner is already in use, wait until the current task
// finishes or quit other programs that might be using the burner.%0
//
...
// MessageText:
//
// A Windows Media Digital Rights Management (DRM) component encountered a
// problem. Contact Microsoft Product Support.%0
//
...
// MessageText:
//
// It is not possible to obtain the device's certificate. Please contact the
// device manufacturer for a firmware update or for other steps to resolve this
// problem.%0
//
...
// security information from the server could not be validated.%0
//
...
// MessageText:
//
// An audio device was disconnected or reconfigured. Verify that the audio
// device is connected, and then try to play the item again.%0
//
...
// MessageText:
//
// Windows Media Player could not complete burning because the disc is not
// compatible with your drive. Try inserting a different kind of recordable
// media or use a disc that supports a write speed that is compatible with your
// drive.%0
//
...
// MessageText:
//
// Windows Media Player cannot save the sync settings because your device is
// full. Delete some unneeded files on your device and then try again.%0
//
...
// MessageText:
//
// Windows Media Player cannot delete these files right now. If the Player is
// syncing, wait until it is complete and then try again.%0
//
...
// MessageText:
//
// Windows Media Player could not use digital mode to read the CD. The Player
// has automatically switched the CD drive to analog mode. To switch back to
// digital mode, use the Devices tab.%0
//
...
// slow and error correction is turned on. To increase performance, turn off
// playback error correction for this drive.%0
//
...
// MessageText:
//
// Windows Media Player cannot estimate the CD drive's playback speed because
// the CD track is too short.%0
//
...
// current download is complete.%0
//
...
// you obtained the file from an online store, sign in to the store, and then
// try again.%0
//
...
// click the Media Usage Rights tab.%0
//
...
// from an online store, contact the store for assistance.%0
//
...
// obtained this file from an online store, ask the store if a new version of
// the file is available.%0
//
...
// in your current version of Windows Media Player or your current version of
// Windows. If you obtained this file from an online store, contact the store
...
// MessageText:
//
// Windows Media Player cannot download media usage rights at this time. Try
// again later.%0
//
...
// MessageText:
//
// Windows Media Player cannot play, burn, or sync the file because the media
// usage rights are missing. If you obtained the file from an online store, sign
// in to the store, and then try again.%0
//
...
// MessageText:
//
// Windows Media Player cannot read a policy. This can occur when the policy
// does not exist in the registry or when the registry cannot be read.%0
//
...
// If possible, download the file to your computer, and then try to sync the
// file.%0
//
...
// MessageText:
//
// This playlist is not valid or is corrupted. Create a new playlist using
// Windows Media Player, then sync the new playlist instead.%0
//
...
// MessageText:
//
// Windows Media Player encountered a problem while syncing the file to the
// device.%0
//
...
// not responding. Try reconnecting the device, resetting the device, or
// contacting the device manufacturer for updated firmware.%0
//
...
// occurred while converting the file to another quality level or format. The
// original file might be damaged or corrupted.%0
//
...
// MessageText:
//
// Windows Media Player cannot convert the file. The file might have been
// encrypted by the Encrypted File System (EFS). Try decrypting the file first
// and then syncing it. For information about how to decrypt a file, see Windows
// Help and Support.%0
//
#define NS_E_PDA_FAILED_TO_ENCRYPT_TRANSCODED_FILE                             \
  _HRESULT_TYPEDEF_(0xC00D123CL)
...
// MessageText:
//
// Your device requires that this file be converted in order to play on the
// device. However, the device either does not support playing audio, or Windows
// Media Player cannot convert the file to an audio format that is supported by
// the device.%0
//
...
//
// Your device requires that this file be converted in order to play on the
// device. However, the device either does not support playing video, or Windows
// Media Player cannot convert the file to a video format that is supported by
// the device.%0
//
...
//
// Your device requires that this file be converted in order to play on the
// device. However, the device either does not support displaying pictures, or
// Windows Media Player cannot convert the file to a picture format that is
// supported by the device.%0
//
...
// MessageText:
//
// Windows Media Player cannot sync the file to your computer because the file
// name is too long. Try renaming the file on the device.%0
//
...
// MessageText:
//
// Windows Media Player cannot sync the file because the device is not
// responding. This typically occurs when there is a problem with the device
// firmwa re.%0
//
...
// MessageText:
//
// It is not possible to perform the requested action because sync is in
// progress. You can either stop sync or wait for it to complete, and then try
// again.%0
//
...
//
// Windows Media Player cannot convert the file to the format required by the
// device. One or more codecs required to convert the file could not be found.%0
//
...
// MessageText:
//
// Your device is operating slowly or is not responding. Until the device
// responds, it is not possible to sync again. To return the device to normal
// operation, try disconnecting it from the computer or resetting it.%0
//
...
// MessageText:
//
// The Windows Media Player download manager cannot function properly because
// the Player main window cannot be found. Try restarting the Player.%0
//
...
// MessageText:
//
// Windows Media Player encountered a download that has the wrong number of
// files. This might occur if another program is trying to create jobs with the
// same signature as the Player.%0
//
...
// The file will not be available.%0
//
...
// MessageText:
//
// Windows Media Player tried to cancel a download that was already completed.
// The file will not be removed.%0
//
...
// MessageText:
//
// The Windows Media Player download manager cannot create a temporary file
// name. This might occur if the path is not valid or if the disk is full.%0
//
#define NS_E_BKGDOWNLOAD_FAILED_TO_CREATE_TEMPFILE                             \
  _HRESULT_TYPEDEF_(0xC00D1262L)
...
// MessageText:
//
// The Windows Media Player download manager plug-in cannot start. This might
// occur if the system is out of resources.%0
//
...
// MessageText:
//
// The Windows Media Player download manager cannot perform a task because the
// system has no resources to allocate.%0
//
...
//
// The Windows Media Player download manager cannot perform a task because the
// Player is terminating the service. The task will be recovered when the Player
// restarts.%0
//
...
// will be deleted and the operation will not be completed successfully.%0
//
...
// MessageText:
//
// The Windows Media Player download manager cannot start. This might occur if
// the system is out of resources.%0
//
...
// if the wrong system files or Player DLLs are loaded.%0
//
...
// requested download will be canceled.%0
//
...
// cannot verify the list of activated users of this computer.%0
//
...
// is no longer being used. Rights acquisition will stop.%0
//
...
// MessageText:
//
// Windows Media Player cannot play this file until you complete the software
// component upgrade. After the component has been upgraded, try to play the
// file again.%0
//
...
// MessageText:
//
// Windows Media Player cannot play the file. If you clicked a link on a web
// page, the link might not be valid.%0
//
...
// MessageText:
//
// The URL contains characters that cannot be decoded. The URL might be
// truncated or incomplete.%0
//
...
// MessageText:
//
// The content provider has not granted you the right to play this file. Go to
// the content provider's online store to get play rights.%0
//
#define NS_E_SUBSCRIPTIONSERVICE_PLAYBACK_DISALLOWED                           \
  _HRESULT_TYPEDEF_(0xC00D1356L)
...
// MessageText:
//
// The file cannot be purchased or downloaded. The file might not be available
// from the online store.%0
//
...
// MessageText:
//
// You have exceeded the maximum number of files that can be purchased in a
...
// MessageText:
//
// There were problems completing the requested navigation. There are
// identifiers missing in the catalog.%0
//
...
// might be temporarily unavailable.%0
//
...
// MessageText:
//
// Windows Media Player cannot download this item because the server is not
// responding. The server might be temporarily unavailable or you might have
// lost your Internet connection.%0
//
...
// images exceeded the 7 megabyte (MB) limit.%0
//
...
// MessageText:
//
// It is not possible to create a persistent namespace node under a transient
// parent node.%0
//
...
// MessageText:
//
// Cannot find the callback in the namespace when attempting to remove the
// callback.%0
//
...
// MessageText:
//
// The internal code for HTTP status code 412 Precondition Failed due to not
// broadcast type.%0
//
...
// MessageText:
//
// The plug-in does not support any load types. The plug-in must support at
// least one load type.%0
//
#define NS_E_INVALID_PLUGIN_LOAD_TYPE_CONFIGURATION                            \
  _HRESULT_TYPEDEF_(0xC00D1454L)
...
// MessageText:
//
// Only one multicast data writer plug-in can be enabled for a publishing
// point.%0
//
...
// MessageText:
//
// The requested operation cannot be completed while the publishing point is
// started.%0
//
#define NS_E_PUBLISHING_POINT_INVALID_REQUEST_WHILE_STARTED                    \
  _HRESULT_TYPEDEF_(0xC00D1457L)
...
// MessageText:
//
// A multicast data writer plug-in must be enabled in order for this operation
// to be completed.%0
//
...
// MessageText:
//
// Push publishing points are started when the encoder starts pushing the
// stream. This publishing point cannot be started by the server
// administrator.%0
//
#define NS_E_INVALID_PUSH_PUBLISHING_POINT_START_REQUEST                       \
  _HRESULT_TYPEDEF_(0xC00D145BL)
...
// and Windows Server 2003, Enterprise Edition.%0
//
...
// MessageText:
//
// The operation cannot be completed because the publishing point has been
// stopped.%0
//
...
// MessageText:
//
// Cannot execute the requested operation because the playlist has been shut
// down by the Media Server.%0
//
...
// MessageText:
//
// The publishing point successfully started, but one or more of the requested
// data writer plug-ins failed.%0
//
#define NS_S_PUBLISHING_POINT_STARTED_WITH_FAILED_SINKS                        \
  _HRESULT_TYPEDEF_(0x000D1519L)
...
// point is in a critical error state.%0
//
...
// MessageText:
//
// The content can not be played because the server is not currently accepting
// connections. Try connecting at a later time.%0
//
...
// MessageText:
//
// The command does not apply to the current media header user by a server
// component.%0
//
...
// MessageText:
//
// The plug-in has reported an error. See the Troubleshooting tab or the NT
// Application Event Log for details.%0
//
...
// MessageText:
//
// No enabled data source plug-in is available to access the requested
// content.%0
//
...
// MessageText:
//
// No enabled playlist parser plug-in is available to access the requested
// content.%0
//
...
// MessageText:
//
// The server cannot stream the selected file because it is either damaged or
// corrupt. Select a different file.%0
//
...
// MessageText:
//
// The plug-in cannot be enabled because a compatible script debugger is not
// installed on this system.  Install a script debugger, or disable the script
// debugger option on the general tab of the plug-in's properties page and try
// again.%0
//
...
// MessageText:
//
// The plug-in cannot be loaded because it requires Windows Server 2003,
...
// MessageText:
//
// Another wizard is currently running. Please close the other wizard or wait
// until it finishes before attempting to run this wizard again.%0
//
...
// "http://servername/isapibackend.dll" .%0
//
...
// MessageText:
//
// The size of the data exceeded the limit the WMS HTTP Download Data Source
// plugin can handle.%0
//
#define NS_E_HTTP_TEXT_DATACONTAINER_SIZE_LIMIT_EXCEEDED                       \
  _HRESULT_TYPEDEF_(0xC00D1589L)
...
// permitted. Verify that other services or applications are not attempting to
// use the same port and then try to enable the plug-in again.%0
//
...
//
// One usage of each socket address (protocol/network address/port) is
// permitted. Verify that other services (such as IIS) or applications are not
// attempting to use the same port and then try to enable the plug-in again.%0
//
...
// MessageText:
//
// The WMS HTTP Download Data Source plugin was unable to receive the remote
// server's response.%0
//
#define NS_E_HTTP_TEXT_DATACONTAINER_INVALID_SERVER_RESPONSE                   \
  _HRESULT_TYPEDEF_(0xC00D158CL)
...
// MessageText:
//
// The mark-out time should be greater than the mark-in time and less than the
// file duration.%0
//
...
// MessageText:
//
// It is not possible to open the specified audio capture device because it is
// currently in use.%0
//
...
// MessageText:
//
// It is not possible to open the specified audio capture device because an
...
// MessageText:
//
// It is not possible to open the specified video capture device because it is
// currently in use.%0
//
...
// MessageText:
//
// It is not possible to open the specified video capture device because an
// unexpected error has occurred.%0
//
...
// MessageText:
//
// The video capture driver returned an unrecoverable error.  It is now in an
// unstable state.%0
//
...
// MessageText:
//
// The video source does not support the requested output format or color
// depth.%0
//
...
// MessageText:
//
// It was not possible to find a valid source plug-in for the specified
// source.%0
//
...
// MessageText:
//
// This source does not have a frame rate of 30 fps. Therefore, it is not
// possible to apply the inverse telecine filter to the source.%0
//
...
// MessageText:
//
// It is not possible to start encoding because the display size or color has
// changed since the current session was defined. Restore the previous settings
// or create a new session.%0
//
...
// MessageText:
//
// No audio data has been received for several seconds. Check the audio source
// and restart the encoder.%0
//
...
// sources are configured correctly.%0
//
...
// MessageText:
//
// The supplied configuration file is not supported by this version of the
// encoder.%0
//
...
// MessageText:
//
// The specified password is too long. Type a password with fewer than 8
// characters.%0
//
...
// MessageText:
//
// When you choose to maintain the interlacing in your video, the output video
// size must match the input video size.%0
//
...
// two-pass encoding with the input device.%0
//
...
// MessageText:
//
// The same source index in different audiences should have the same number of
// languages.%0
//
...
// MessageText:
//
// The same source index in different audiences should have the same
// languages.%0
//
...
// MessageText:
//
// The hard disk being used for temporary storage of content has reached the
// minimum allowed disk space. Create more space on the hard disk and restart
// encoding.%0
//
...
// MessageText:
//
// A device used in the current active source for device control is no longer
// available.%0
//
#define NS_E_ACTIVE_SG_DEVICE_CONTROL_DISCONNECTED                             \
  _HRESULT_TYPEDEF_(0xC00D1BA6L)
...
// MessageText:
//
// The voice codec optimization definition file can not be found or is
// corrupted.%0
//
...
// MessageText:
//
// The same source index in different audiences should have the same interlace
// mode.%0
//
...
// MessageText:
//
// The same source index in different audiences should have the same nonsquare
// pixel mode.%0
//
...
// MessageText:
//
// The same source index in different audiences should have the same time code
// mode.%0
//
...
// MessageText:
//
// Either the end of the tape has been reached or there is no tape. Check the
// device and tape.%0
//
...
// MessageText:
//
// You must specify at least one audio stream to be compatible with Windows
// Media Player 7.1.%0
//
...
// MessageText:
//
// It is not possible to use a VBR encoding mode with uncompressed audio or
// video.%0
//
...
// MessageText:
//
// The audio bit rate for an audience with a higher total bit rate must be
// greater than one with a lower total bit rate.%0
//
...
// MessageText:
//
// The audio peak bit rate setting must be greater than the audio bit rate
// setting.%0
//
...
// MessageText:
//
// All audiences should use the same video size to be compatible with Windows
// Media Player 7.1.%0
//
...
// MessageText:
//
// The video bit rate for an audience with a higher total bit rate must be
// greater than one with a lower total bit rate.%0
//
...
// MessageText:
//
// The video peak bit rate setting must be greater than the video bit rate
// setting.%0
//
...
// MessageText:
//
// The value of the video maximum buffer size setting must be greater than the
// video buffer size setting.%0
//
...
// MessageText:
//
// It is not possible to apply time compression to a session that is using
// two-pass encoding.%0
//
...
// MessageText:
//
// It is not possible to generate a time code when you are encoding content at
// multiple bit rates.%0
//
...
// MessageText:
//
// Maintaining interlacing in video is not compatible with Windows Media
// Player 7.1.%0
//
...
// MessageText:
//
// Allowing nonsquare pixel output is not compatible with Windows Media
// Player 7.1.%0
//
...
// Windows Media file generated after encoding to create the announcement
// file.%0
//
#define NS_E_CANNOT_GENERATE_BROADCAST_INFO_FOR_QUALITYVBR                     \
  _HRESULT_TYPEDEF_(0xC00D1BDFL)
...
// MessageText:
//
// It is not possible to create a DRM profile because the maximum number of
// profiles has been reached. You must delete some DRM profiles before creating
// new ones.%0
//
...
// MessageText:
//
// The device is in an unstable state. Check that the device is functioning
// properly and a tape is in place.
//
...
// MessageText:
//
// All streams with different languages in the same audience must have same
// properties.%0
//
#define NS_E_AUDIENCE__LANGUAGE_CONTENTTYPE_MISMATCH                           \
  _HRESULT_TYPEDEF_(0xC00D1BE3L)
...
// MessageText:
//
// The transform plug-in is not valid. It may be damaged or you may not have the
// required permissions to access the plug-in.%0
//
...
// MessageText:
//
// To use two-pass encoding, you must enable device control and setup an edit
// decision list (EDL) that has at least one entry.%0
//
...
//
// When you choose to maintain the interlacing in your video, the output video
// size must be a multiple of 4.%0
//
#define NS_E_INVALID_VIDEO_WIDTH_FOR_INTERLACED_ENCODING                       \
  _HRESULT_TYPEDEF_(0xC00D1BE8L)
...
// MessageText:
//
// A problem has occurred in the Digital Rights Management component. Contact
// product support for this application.%0
//
...
// MessageText:
//
// License acquisition did not work. Acquire a new license or contact the
// content provider for further assistance.%0
//
...
// MessageText:
//
// The media file is corrupted. Contact the content provider to get a new
// file.%0
//
...
// MessageText:
//
// Licenses cannot be copied from one computer to another. Use License
...
// Windows Media Digital Rights Management (DRM) components on your computer.%0.
//
...
// MessageText:
//
// You already have the latest security components. No upgrade is necessary at
// this time.%0
//
...
// MessageText:
//
// You cannot begin a new security upgrade until the current one has been
// completed.%0
//
...
// MessageText:
//
// The application has made an invalid call to the Digital Rights Management
// component. Contact product support for this application.%0
//
...
// MessageText:
//
// You cannot begin a new backup process until the current process has been
// completed.%0
//
...
// MessageText:
//
// The license is invalid. Contact the content provider for further
// assistance.%0
//
...
// MessageText:
//
// A required property was not set by the application. Contact product support
// for this application.%0.
//
...
// MessageText:
//
// A problem has occurred in the Digital Rights Management component of this
// application. Try to acquire a license again.%0
//
...
// MessageText:
//
// Windows Media Digital Rights Management (DRM) cannot play the protected file
// because you do not have the appropriate rights.%0
//
...
// MessageText:
//
// Certified driver components are required to play this media file. Contact
// Windows Update to see whether updated drivers are available for your
// hardware.%0
//
...
// MessageText:
//
// One or more of the Secure Audio Path components were not found or an entry
// point in those components was not found.%0
//
...
// MessageText:
//
// Certain driver functionality is required to play this media file. Contact
// Windows Update to see whether updated drivers are available for your
// hardware.%0
//
...
// MessageText:
//
// The licenses for your media files are corrupted. Contact Microsoft product
// support.%0
//
...
// MessageText:
//
// The Digital Rights Management security upgrade component could not be
// validated. Contact Microsoft product support.%0
//
#define NS_E_DRM_SECURITY_COMPONENT_SIGNATURE_INVALID                          \
  _HRESULT_TYPEDEF_(0xC00D2760L)
...
// MessageText:
//
// The Windows Media Digital Rights Management system cannot perform the
// requested action because your computer or network administrator has enabled
// the group policy Prevent Windows Media DRM Internet Access. For assistance,
...
// MessageText:
//
// The portable device does not have the security required to copy protected
// files to it. To obtain the additional security, try to copy the file to your
// portable device again. When a message appears, click OK.%0
//
...
// MessageText:
//
// Running this process under a debugger while using DRM content is not
// allowed.%0
//
...
// MessageText:
//
// The license you are using has associated output restrictions. This license is
// unusable until these restrictions are queried.%0
//
...
// MessageText:
//
// The specified track has exceeded it's specified playlist burn limit in this
// playlist.%0.
//
#define NS_E_DRM_TRACK_EXCEEDED_PLAYLIST_RESTICTION                            \
  _HRESULT_TYPEDEF_(0xC00D2770L)
...
// MessageText:
//
// A problem has occurred in obtaining the device's secure clock. Contact
// Microsoft product support.%0.
//
...
// MessageText:
//
// A problem has occurred in setting the device's secure clock. Contact
// Microsoft product support.%0.
//
...
// MessageText:
//
// A problem has occurred in obtaining the secure clock from server. Contact
// Microsoft product support.%0.
//
#define NS_E_DRM_UNABLE_TO_GET_SECURE_CLOCK_FROM_SERVER                        \
  _HRESULT_TYPEDEF_(0xC00D2775L)
...
// MessageText:
//
// The client application has been forcefully terminated during a DRM
// petition.%0.
//
#define NS_E_DRM_PROTOCOL_FORCEFUL_TERMINATION_ON_PETITION                     \
  _HRESULT_TYPEDEF_(0xC00D277DL)
...
// MessageText:
//
// Secure storage protection error.  Restore your licenses from a previous
// backup and try again.%0
//
...
// Contact Microsoft product support.%0
//
...
// MessageText:
//
// A problem has occurred in retrieving the Digital Rights Management machine
// identification. Contact Microsoft product support.%0
//
...
// file. Contact Microsoft product support.%0
//
...
// MessageText:
//
// The Digital Rights Management data storage is not functioning properly.
// Contact Microsoft product support.%0.
//
...
// MessageText:
//
// A problem has occurred in the Digital Rights Management component during
// license migration. Contact Microsoft product support.%0.
//
...
// MessageText:
//
// The Digital Rights Management component is in use during license migration.
// Contact Microsoft product support.%0.
//
...
// MessageText:
//
// Licenses are being migrated to a machine running XP or downlevel OS. This
// operation can only be performed on Windows Vista or a later OS. Contact
// Microsoft product support.%0.
//
#define NS_DRM_E_MIGRATION_TARGET_MACHINE_LESS_THAN_LH                         \
  _HRESULT_TYPEDEF_(0xC00D278DL)
...
// change has been detected by the Windows Media Digital Rights Management (DRM)
// components on your computer.%0.
//
...
// MessageText:
//
// The wrong stublib has been linked to an application or DLL using
// drmv2clt.dll.%0
//
...
// MessageText:
//
// A migration importer cannot be created for this media file. Reinstall the
// application.%0
//
#define NS_E_DRM_UNABLE_TO_CREATE_MIGRATION_IMPORTER_OBJECT                    \
  _HRESULT_TYPEDEF_(0xC00D2795L)
...
// MessageText:
//
// Migration object is already in use and cannot be called until the current
// operation completes.%0
//
...
// MessageText:
//
// The content header does not comply with DRM requirements and cannot be
// used.%0
//
...
// Error Codes why a license is not usable. Reserve 10200..10300 for this
// purpose. 10200..10249 is for license reported reasons. 10250..10300 is for
// client detected reasons.
//
...
// MessageText:
//
// The license for this file has expired and is no longer valid. Contact your
// content provider for further assistance.%0
//
...
// MessageText:
//
// The license cannot be stored as it requires security upgrade of Digital
// Rights Management component.%0.
//
...
// MessageText:
//
// The license for this file requires an upgraded version of your player or a
// different player.%0.
//
...
// correctly. Contact your content provider for further assistance. %0.
//
...
// MessageText:
//
// The content owner for the license you just acquired is no longer supporting
// their content. Contact the content owner for a newer version of the
// content.%0
//
...
// MessageText:
//
// The content owner for the license you just acquired requires your device to
// register to the current machine.%0
//
...
// current player or operating system. You can try with newer version of your
// current player or contact your content provider for further assistance.%0
//
...
// Contact your sound card manufacturer for further assistance.%0
//
...
// MessageText:
//
// The license for this file is not supported by your current player. You can
// try with newer version of your current player or contact your content
// provider for further assistance.%0
//
...
// MessageText:
//
// An updated version of your media player is required to play the selected
// content.%0
//
...
// product support for this application to get the latest version.%0
//
...
// MessageText:
//
// The DRM subsystem is currently locked by another application or user.  Try
// again later.%0
//
...
// upgrades has been exceeded. Try again tomorrow.%0
//
...
// MessageText:
//
// The security upgrade cannot be completed because the server is unable to
// perform the operation. Try again later.%0
//
...
// MessageText:
//
// Windows Media Player cannot restore your licenses because the server is not
// available. Try again later.%0
//
...
// MessageText:
//
// Windows Media Player cannot play the protected file. Verify that your
// computer's date is set correctly. If it is correct, on the Help menu, click
// Check for Player Updates to install the latest version of the Player.%0
//
...
// MessageText:
//
// The chained license cannot be created because the referenced uplink license
// does not exist.
//
...
// MessageText:
//
// The maximum number of devices in use has been reached. Unable to open
// additional devices.%0
//
...
// the transmitter in the network.%0
//
...
// MessageText:
//
// The certificate does not have an adequate security level for the requested
// action.%0
//
#define NS_E_DRM_CERTIFICATE_SECURITY_LEVEL_INADEQUATE                         \
  _HRESULT_TYPEDEF_(0xC00D28AEL)
...
// MessageText:
//
// The license blob passed in the cardea request is invalid. Contact Microsoft
// product support.%0
//
...
// MessageText:
//
// The requested operation can not be performed because the license does not
// contain an inclusion list.%0
//
...
// MessageText:
//
// Windows Media Player does not support the level of protection required for
// compressed digital video.%0
//
#define NS_E_COMPRESSED_DIGITAL_VIDEO_PROTECTION_LEVEL_UNSUPPORTED             \
  _HRESULT_TYPEDEF_(0xC00D2905L)
...
// MessageText:
//
// Windows Media Player does not support the scheme of output protection
// required by the content.%0
//
...
// best results, restart your computer.%0
//
...
// MessageText:
//
// Installation was successful; however, some file cleanup is not complete. To
// continue, you must restart your computer.%0
//
...
// MessageText:
//
// Installation was not successful and some file cleanup is not complete. For
// best results, restart your computer.%0
//
...
// MessageText:
//
// Installation was not successful. To continue, you must restart your
// computer.%0
//
...
// MessageText:
//
// Setup cannot migrate the Windows Media Digital Rights Management (DRM)
// components.%0.
//
...
//
// Setup cannot migrate the Windows Media Digital Rights Management (DRM)
// components. In addition, some skin or playlist components cannot be
// installed.%0.
//
#define NS_E_SETUP_DRM_MIGRATION_FAILED_AND_IGNORABLE_FAILURE                  \
  _HRESULT_TYPEDEF_(0xC00D2AFFL)
...
// MessageText:
//
// Installation is blocked because your computer does not meet one or more of
// the setup requirements.%0.
//
...
// MessageText:
//
// The proxy experienced an error while attempting to contact the media
// server.%0
//
...
// MessageText:
//
// The proxy did not receive a timely response while attempting to contact the
// media server.%0
//
...
// MessageText:
//
// The content cannot be streamed because the Multicast protocol has been
// disabled.%0
//
...
// MessageText:
//
// The MSBD protocol is no longer supported. Please use HTTP to connect to the
// Windows Media stream.%0
//
...
// MessageText:
//
// The proxy server could not be located. Please check your proxy server
// configuration.%0
//
...
// MessageText:
//
// The proxy server is denying access.  The username and/or password might be
// incorrect.%0
//
...
// MessageText:
//
// The proxy could not provide valid authentication credentials to the media
// server.%0
//
...
// by a filtering device, such as a network firewall.%0
//
...
// MessageText:
//
// The Windows Media server is denying access.  The username and/or password
...
// MessageText:
//
// The Publishing Point or file on the Windows Media Server is no longer
// available.%0
//
...
// MessageText:
//
// The response from the media server could not be understood. This might be
// caused by an incompatible proxy server or media server.%0
//
...
// manner. The media server may be down for maintenance, or it may be necessary
// to use a proxy server to access this media server.%0
//
...
// manner. Please check your proxy server configuration.%0
//
...
// is started and the HTTP Server control protocol is properly enabled.%0
//
...
// MessageText:
//
// The Server service that received the HTTP push request is not a compatible
// version of Windows Media Services (WMS).  This error may indicate the push
// request was received by IIS instead of WMS.  Ensure WMS is started and has
// the HTTP Server control protocol properly enabled and try again.%0
//
