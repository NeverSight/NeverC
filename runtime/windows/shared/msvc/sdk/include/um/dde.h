 ...
 */
LPARAM APIENTRY PackDDElParam(_In_ UINT msg, _In_ UINT_PTR uiLo,
                              _In_ UINT_PTR uiHi);
BOOL APIENTRY UnpackDDElParam(_In_ UINT msg, _In_ LPARAM lParam,
                              _Out_ PUINT_PTR puiLo, _Out_ PUINT_PTR puiHi);
BOOL APIENTRY FreeDDElParam(_In_ UINT msg, _In_ LPARAM lParam);
LPARAM APIENTRY ReuseDDElParam(LPARAM lParam, UINT msgIn, UINT msgOut,
