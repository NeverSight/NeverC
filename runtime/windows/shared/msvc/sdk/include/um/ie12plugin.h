...
typedef struct ISurfacePresenterFlipBufferVtbl {
  ...
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in ISurfacePresenterFlipBuffer *This);
...
#define ISurfacePresenterFlipBuffer_AddRef(This) ((This)->lpVtbl->AddRef(This))
...
typedef struct ISurfacePresenterFlipVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in ISurfacePresenterFlip *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in ISurfacePresenterFlip *This);

  DECLSPEC_XFGVIRT(ISurfacePresenterFlip, Present)
  HRESULT(STDMETHODCALLTYPE *Present)(__RPC__in ISurfacePresenterFlip *This);
...
#define ISurfacePresenterFlip_AddRef(This) ((This)->lpVtbl->AddRef(This))

#define ISurfacePresenterFlip_Release(This) ((This)->lpVtbl->Release(This))

#define ISurfacePresenterFlip_Present(This) ((This)->lpVtbl->Present(This))
...
typedef struct ISurfacePresenterFlip2Vtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in ISurfacePresenterFlip2 *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in ISurfacePresenterFlip2 *This);
...
#define ISurfacePresenterFlip2_AddRef(This) ((This)->lpVtbl->AddRef(This))

#define ISurfacePresenterFlip2_Release(This) ((This)->lpVtbl->Release(This))
...
public:
  virtual HRESULT STDMETHODCALLTYPE CreateSurfacePresenterFlip(
      ...
      /* [out][retval] */ __RPC__deref_out_opt ISurfacePresenterFlip *
          *ppSPFlip) = 0;
...
typedef struct IViewObjectPresentFlipSiteVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IViewObjectPresentFlipSite *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IViewObjectPresentFlipSite *This);
...
#define IViewObjectPresentFlipSite_AddRef(This) ((This)->lpVtbl->AddRef(This))

#define IViewObjectPresentFlipSite_Release(This) ((This)->lpVtbl->Release(This))

#define IViewObjectPresentFlipSite_CreateSurfacePresenterFlip(                 \
    This, pDevice, width, height, backBufferCount, format, mode, ppSPFlip)     \
  ((This)->lpVtbl->CreateSurfacePresenterFlip(                                 \
      This, pDevice, width, height, backBufferCount, format, mode, ppSPFlip))
...
#define IViewObjectPresentFlipSite_GetMetrics(This, pPos, pSize, pScaleX,      \
                                              pScaleY)                         \
...
typedef struct IViewObjectPresentFlipSite2Vtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IViewObjectPresentFlipSite2 *This);
...
#define IViewObjectPresentFlipSite2_AddRef(This) ((This)->lpVtbl->AddRef(This))

#define IViewObjectPresentFlipSite2_Release(This)                              \
  ((This)->lpVtbl->Release(This))

#define IViewObjectPresentFlipSite2_GetRotationForCurrentOutput(This,          \
                                                                pDxgiRotation) \
...
public:
  virtual HRESULT STDMETHODCALLTYPE NotifyRender(BOOL fRecreatePresenter) = 0;
...
typedef struct IViewObjectPresentFlipVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IViewObjectPresentFlip *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IViewObjectPresentFlip *This);

  DECLSPEC_XFGVIRT(IViewObjectPresentFlip, NotifyRender)
  HRESULT(STDMETHODCALLTYPE *NotifyRender)(
      __RPC__in IViewObjectPresentFlip *This, BOOL fRecreatePresenter);
...
#define IViewObjectPresentFlip_AddRef(This) ((This)->lpVtbl->AddRef(This))

#define IViewObjectPresentFlip_Release(This) ((This)->lpVtbl->Release(This))
...
typedef struct IViewObjectPresentFlip2Vtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IViewObjectPresentFlip2 *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IViewObjectPresentFlip2 *This);
...
#define IViewObjectPresentFlip2_AddRef(This) ((This)->lpVtbl->AddRef(This))

#define IViewObjectPresentFlip2_Release(This) ((This)->lpVtbl->Release(This))
...
typedef struct IActiveXUIHandlerSite2Vtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IActiveXUIHandlerSite2 *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IActiveXUIHandlerSite2 *This);
...
#define IActiveXUIHandlerSite2_AddRef(This) ((This)->lpVtbl->AddRef(This))

#define IActiveXUIHandlerSite2_Release(This) ((This)->lpVtbl->Release(This))
...
typedef struct ICaretPositionProviderVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in ICaretPositionProvider *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in ICaretPositionProvider *This);
...
#define ICaretPositionProvider_AddRef(This) ((This)->lpVtbl->AddRef(This))

#define ICaretPositionProvider_Release(This) ((This)->lpVtbl->Release(This))
...
typedef struct ITridentTouchInputVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in ITridentTouchInput *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in ITridentTouchInput *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in ITridentTouchInput *This);
...
#define ITridentTouchInput_AddRef(This) ((This)->lpVtbl->AddRef(This))

#define ITridentTouchInput_Release(This) ((This)->lpVtbl->Release(This))

#define ITridentTouchInput_OnPointerMessage(This, msg, wParam, lParam,         \
                                            pfAllowManipulations)              \
  ((This)->lpVtbl->OnPointerMessage(This, msg, wParam, lParam,                 \
                                    pfAllowManipulations))
...
typedef struct ITridentTouchInputSiteVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in ITridentTouchInputSite *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in ITridentTouchInputSite *This);
...
#define ITridentTouchInputSite_AddRef(This) ((This)->lpVtbl->AddRef(This))

#define ITridentTouchInputSite_Release(This) ((This)->lpVtbl->Release(This))
...
typedef enum MediaActivityNotifyType {
  MediaPlayback = 0,
...
typedef struct IMediaActivityNotifySiteVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IMediaActivityNotifySite *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IMediaActivityNotifySite *This);
...
#define IMediaActivityNotifySite_AddRef(This) ((This)->lpVtbl->AddRef(This))

#define IMediaActivityNotifySite_Release(This) ((This)->lpVtbl->Release(This))

#define IMediaActivityNotifySite_OnMediaActivityStarted(This,                  \
                                                        mediaActivityType)     \
  ((This)->lpVtbl->OnMediaActivityStarted(This, mediaActivityType))

#define IMediaActivityNotifySite_OnMediaActivityStopped(This,                  \
                                                        mediaActivityType)     \
...
typedef struct IAudioSessionSiteVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in IAudioSessionSite *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IAudioSessionSite *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IAudioSessionSite *This);
...
#define IAudioSessionSite_AddRef(This) ((This)->lpVtbl->AddRef(This))

#define IAudioSessionSite_Release(This) ((This)->lpVtbl->Release(This))
...
typedef struct IPrintTaskRequestHandlerVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(IPrintTaskRequestHandler *This,
                                             /* [in] */ REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(IPrintTaskRequestHandler *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(IPrintTaskRequestHandler *This);
...
#define IPrintTaskRequestHandler_AddRef(This) ((This)->lpVtbl->AddRef(This))

#define IPrintTaskRequestHandler_Release(This) ((This)->lpVtbl->Release(This))

#define IPrintTaskRequestHandler_HandlePrintTaskRequest(This,                  \
                                                        pPrintTaskRequest)     \
...
public:
  virtual HRESULT STDMETHODCALLTYPE CreatePrintTaskRequest(
      /* [in] */ __RPC__in_opt IPrintTaskRequestHandler *
      pPrintTaskRequestHandler) = 0;
};
...
typedef struct IPrintTaskRequestFactoryVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IPrintTaskRequestFactory *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IPrintTaskRequestFactory *This);

  DECLSPEC_XFGVIRT(IPrintTaskRequestFactory, CreatePrintTaskRequest)
  HRESULT(STDMETHODCALLTYPE *CreatePrintTaskRequest)(
      __RPC__in IPrintTaskRequestFactory *This,
      /* [in] */ __RPC__in_opt IPrintTaskRequestHandler
          *pPrintTaskRequestHandler);
...
#define IPrintTaskRequestFactory_AddRef(This) ((This)->lpVtbl->AddRef(This))

#define IPrintTaskRequestFactory_Release(This) ((This)->lpVtbl->Release(This))

#define IPrintTaskRequestFactory_CreatePrintTaskRequest(                       \
    This, pPrintTaskRequestHandler)                                            \
...
typedef struct IScrollableContextMenuVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IScrollableContextMenu *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IScrollableContextMenu *This);
  ...
  HRESULT(STDMETHODCALLTYPE *ShowModal)(__RPC__in IScrollableContextMenu *This,
                                        /* [in] */ int x,
                                        /* [in] */ int y,
...
#define IScrollableContextMenu_AddRef(This) ((This)->lpVtbl->AddRef(This))

#define IScrollableContextMenu_Release(This) ((This)->lpVtbl->Release(This))
...
typedef enum tagSCROLLABLECONTEXTMENU_PLACEMENT {
  SCMP_TOP = 0,
  SCMP_BOTTOM = 1,
  SCMP_LEFT = 2,
  SCMP_RIGHT = 3,
...
typedef struct IScrollableContextMenu2Vtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IScrollableContextMenu2 *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IScrollableContextMenu2 *This);
  ...
  DECLSPEC_XFGVIRT(IScrollableContextMenu, ShowModal)
  HRESULT(STDMETHODCALLTYPE *ShowModal)(__RPC__in IScrollableContextMenu2 *This,
                                        /* [in] */ int x,
                                        /* [in] */ int y,
                                        /* [out] */ __RPC__out DWORD *cmdID);
...
#define IScrollableContextMenu2_AddRef(This) ((This)->lpVtbl->AddRef(This))

#define IScrollableContextMenu2_Release(This) ((This)->lpVtbl->Release(This))
...
public:
  virtual HRESULT STDMETHODCALLTYPE CreateScrollableContextMenu(
      /* [out][retval] */ __RPC__deref_out_opt IScrollableContextMenu *
      *scrollableContextMenu) = 0;
...
typedef struct IActiveXUIHandlerSiteVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IActiveXUIHandlerSite *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IActiveXUIHandlerSite *This);
...
#define IActiveXUIHandlerSite_AddRef(This) ((This)->lpVtbl->AddRef(This))

#define IActiveXUIHandlerSite_Release(This) ((This)->lpVtbl->Release(This))

#define IActiveXUIHandlerSite_CreateScrollableContextMenu(                     \
    This, scrollableContextMenu)                                               \
  ((This)->lpVtbl->CreateScrollableContextMenu(This, scrollableContextMenu))

#define IActiveXUIHandlerSite_PickFileAndGetResult(                            \
    This, filePicker, allowMultipleSelections, result)                         \
  ((This)->lpVtbl->PickFileAndGetResult(This, filePicker,                      \
                                        allowMultipleSelections, result))
...
typedef struct IActiveXUIHandlerSite3Vtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IActiveXUIHandlerSite3 *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IActiveXUIHandlerSite3 *This);
...
#define IActiveXUIHandlerSite3_AddRef(This) ((This)->lpVtbl->AddRef(This))

#define IActiveXUIHandlerSite3_Release(This) ((This)->lpVtbl->Release(This))

#define IActiveXUIHandlerSite3_MessageBoxW(This, hwnd, text, caption, type,    \
                                           result)                             \
