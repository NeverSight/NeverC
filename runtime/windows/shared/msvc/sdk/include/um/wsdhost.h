...
HRESULT WINAPI WSDCreateDeviceHost(_In_ LPCWSTR pszLocalId,
...
HRESULT WINAPI WSDCreateDeviceHostAdvanced(
    ...
    DWORD dwHostAddressCount, _Outptr_ IWSDDeviceHost **ppDeviceHost);
#if (WINVER >= _WIN32_WINNT_WIN7)
HRESULT WINAPI WSDCreateDeviceHost2(_In_ LPCWSTR pszLocalId,
                                    IWSDXMLContext *pContext,
                                    _In_reads_opt_(dwConfigParamCount)
...
typedef struct IWSDDeviceHostVtbl {
  ...
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(IWSDDeviceHost *This,
                                             /* [in] */ REFIID riid,
  ...
  HRESULT(STDMETHODCALLTYPE *Init)(IWSDDeviceHost *This,
                                   /* [annotation][in] */
                                   _In_ LPCWSTR pszLocalId,
                                   /* [annotation][optional][in] */
                                   _In_opt_ IWSDXMLContext *pContext,
                                   /* [annotation][optional][in] */
                                   _In_reads_opt_(dwHostAddressCount)
...
interface IWSDDeviceHost { CONST_VTBL struct IWSDDeviceHostVtbl *lpVtbl; };
...
typedef struct IWSDDeviceHostNotifyVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IWSDDeviceHostNotify *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IWSDDeviceHostNotify *This);

  DECLSPEC_XFGVIRT(IWSDDeviceHostNotify, GetService)
  HRESULT(STDMETHODCALLTYPE *GetService)(__RPC__in IWSDDeviceHostNotify *This,
                                         /* [annotation][in] */
                                         _In_ LPCWSTR pszServiceId,
                                         /* [annotation][out] */
...
#define IWSDServiceMessaging_FaultRequest(This, pRequestHeader,                \
  ...
  ((This)->lpVtbl->FaultRequest(This, pRequestHeader, pMessageParameters,      \
                                pFault))
