...
public:
  ...
  virtual HRESULT STDMETHODCALLTYPE CompareItem(
      __RPC__in REFGUID guidKey, __RPC__in REFPROPVARIANT Value,
      /* [out] */ __RPC__out BOOL * pbResult) = 0;

  virtual HRESULT STDMETHODCALLTYPE Compare(
      __RPC__in_opt IMFAttributes * pTheirs, MF_ATTRIBUTES_MATCH_TYPE MatchType,
      /* [out] */ __RPC__out BOOL * pbResult) = 0;

  virtual HRESULT STDMETHODCALLTYPE GetUINT32(__RPC__in REFGUID guidKey,
                                              /* [out] */ __RPC__out UINT32 *
                                                  punValue) = 0;

  virtual HRESULT STDMETHODCALLTYPE GetUINT64(__RPC__in REFGUID guidKey,
                                              /* [out] */ __RPC__out UINT64 *
                                                  punValue) = 0;
  ...
  virtual HRESULT STDMETHODCALLTYPE GetGUID(__RPC__in REFGUID guidKey,
                                            /* [out] */ __RPC__out GUID *
                                                pguidValue) = 0;
  ...
  virtual HRESULT STDMETHODCALLTYPE GetBlobSize(__RPC__in REFGUID guidKey,
                                                /* [out] */ __RPC__out UINT32 *
                                                    pcbBlobSize) = 0;
  ...
  virtual HRESULT STDMETHODCALLTYPE GetUnknown(
      __RPC__in REFGUID guidKey, __RPC__in REFIID riid,
      /* [iid_is][out] */ __RPC__deref_out_opt LPVOID * ppv) = 0;

  virtual HRESULT STDMETHODCALLTYPE SetItem(__RPC__in REFGUID guidKey,
                                            __RPC__in REFPROPVARIANT Value) = 0;

  virtual HRESULT STDMETHODCALLTYPE DeleteItem(__RPC__in REFGUID guidKey) = 0;

  virtual HRESULT STDMETHODCALLTYPE DeleteAllItems(void) = 0;

  virtual HRESULT STDMETHODCALLTYPE SetUINT32(__RPC__in REFGUID guidKey,
                                              UINT32 unValue) = 0;

  virtual HRESULT STDMETHODCALLTYPE SetUINT64(__RPC__in REFGUID guidKey,
                                              UINT64 unValue) = 0;

  virtual HRESULT STDMETHODCALLTYPE SetDouble(__RPC__in REFGUID guidKey,
                                              double fValue) = 0;

  virtual HRESULT STDMETHODCALLTYPE SetGUID(__RPC__in REFGUID guidKey,
...
typedef struct IMFAttributesVtbl {
  ...
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in IMFAttributes *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IMFAttributes *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IMFAttributes *This);

  DECLSPEC_XFGVIRT(IMFAttributes, GetItem)
  HRESULT(STDMETHODCALLTYPE *GetItem)(
      __RPC__in IMFAttributes *This, __RPC__in REFGUID guidKey,
  ...
  HRESULT(STDMETHODCALLTYPE *Compare)(__RPC__in IMFAttributes *This,
  ...
  HRESULT(STDMETHODCALLTYPE *GetDouble)(__RPC__in IMFAttributes *This,
                                        __RPC__in REFGUID guidKey,
                                        /* [out] */ __RPC__out double *pfValue);

  DECLSPEC_XFGVIRT(IMFAttributes, GetGUID)
  HRESULT(STDMETHODCALLTYPE *GetGUID)(__RPC__in IMFAttributes *This,
                                      __RPC__in REFGUID guidKey,
  ...
  HRESULT(STDMETHODCALLTYPE *SetItem)(__RPC__in IMFAttributes *This,
                                      __RPC__in REFGUID guidKey,
                                      __RPC__in REFPROPVARIANT Value);

  DECLSPEC_XFGVIRT(IMFAttributes, DeleteItem)
  HRESULT(STDMETHODCALLTYPE *DeleteItem)(__RPC__in IMFAttributes *This,
                                         __RPC__in REFGUID guidKey);

  DECLSPEC_XFGVIRT(IMFAttributes, DeleteAllItems)
  HRESULT(STDMETHODCALLTYPE *DeleteAllItems)(__RPC__in IMFAttributes *This);

  DECLSPEC_XFGVIRT(IMFAttributes, SetUINT32)
  HRESULT(STDMETHODCALLTYPE *SetUINT32)(__RPC__in IMFAttributes *This,
                                        __RPC__in REFGUID guidKey,
                                        UINT32 unValue);

  DECLSPEC_XFGVIRT(IMFAttributes, SetUINT64)
  HRESULT(STDMETHODCALLTYPE *SetUINT64)(__RPC__in IMFAttributes *This,
                                        __RPC__in REFGUID guidKey,
                                        UINT64 unValue);

  DECLSPEC_XFGVIRT(IMFAttributes, SetDouble)
  HRESULT(STDMETHODCALLTYPE *SetDouble)(__RPC__in IMFAttributes *This,
                                        __RPC__in REFGUID guidKey,
                                        double fValue);

  DECLSPEC_XFGVIRT(IMFAttributes, SetGUID)
  HRESULT(STDMETHODCALLTYPE *SetGUID)(__RPC__in IMFAttributes *This,
                                      __RPC__in REFGUID guidKey,
  ...
  HRESULT(STDMETHODCALLTYPE *LockStore)(__RPC__in IMFAttributes *This);

  DECLSPEC_XFGVIRT(IMFAttributes, UnlockStore)
  HRESULT(STDMETHODCALLTYPE *UnlockStore)(__RPC__in IMFAttributes *This);

  DECLSPEC_XFGVIRT(IMFAttributes, GetCount)
  HRESULT(STDMETHODCALLTYPE *GetCount)(__RPC__in IMFAttributes *This,
                                       /* [out] */ __RPC__out UINT32 *pcItems);

  DECLSPEC_XFGVIRT(IMFAttributes, GetItemByIndex)
  HRESULT(STDMETHODCALLTYPE *GetItemByIndex)(
      __RPC__in IMFAttributes *This, UINT32 unIndex,
      /* [out] */ __RPC__out GUID *pguidKey,
      /* [full][out][in] */ __RPC__inout_opt PROPVARIANT *pValue);
...
interface IMFAttributes { CONST_VTBL struct IMFAttributesVtbl *lpVtbl; };
...
public:
  virtual HRESULT STDMETHODCALLTYPE Lock(
      /* [annotation][out] */
      _Outptr_result_bytebuffer_to_(*pcbMaxLength, *pcbCurrentLength) BYTE *
          *ppbBuffer,
      /* [annotation][out] */
...
typedef struct IMFMediaBufferVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(IMFMediaBuffer *This,
                                             /* [in] */ REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);
  ...
  HRESULT(STDMETHODCALLTYPE *Lock)(
      IMFMediaBuffer *This,
      /* [annotation][out] */
      _Outptr_result_bytebuffer_to_(*pcbMaxLength, *pcbCurrentLength)
          BYTE **ppbBuffer,
      /* [annotation][out] */
      _Out_opt_ DWORD *pcbMaxLength,
      /* [annotation][out] */
...
interface IMFMediaBuffer { CONST_VTBL struct IMFMediaBufferVtbl *lpVtbl; };
...
typedef struct IMFSampleVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(IMFSample *This,
                                             /* [in] */ REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);
  ...
  DECLSPEC_XFGVIRT(IMFAttributes, GetItem)
  HRESULT(STDMETHODCALLTYPE *GetItem)(
      IMFSample *This, REFGUID guidKey,
  ...
  DECLSPEC_XFGVIRT(IMFAttributes, GetCount)
  HRESULT(STDMETHODCALLTYPE *GetCount)(IMFSample *This,
                                       /* [out] */ UINT32 *pcItems);

  DECLSPEC_XFGVIRT(IMFAttributes, GetItemByIndex)
  HRESULT(STDMETHODCALLTYPE *GetItemByIndex)(
      IMFSample *This, UINT32 unIndex,
      /* [out] */ GUID *pguidKey,
      /* [full][out][in] */ PROPVARIANT *pValue);
  ...
  HRESULT(STDMETHODCALLTYPE *GetBufferByIndex)(IMFSample *This,
                                               /* [in] */ DWORD dwIndex,
                                               /* [annotation][out] */
...
interface IMFSample { CONST_VTBL struct IMFSampleVtbl *lpVtbl; };
...
typedef struct IMF2DBufferVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(IMF2DBuffer *This,
                                             /* [in] */ REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);
  ...
  HRESULT(STDMETHODCALLTYPE *ContiguousCopyTo)(IMF2DBuffer *This,
                                               /* [annotation][size_is][out] */
                                               _Out_writes_bytes_(cbDestBuffer)
                                                   BYTE *pbDestBuffer,
...
interface IMF2DBuffer { CONST_VTBL struct IMF2DBufferVtbl *lpVtbl; };
...
typedef struct IMF2DBuffer2Vtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(IMF2DBuffer2 *This,
                                             /* [in] */ REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);
...
interface IMF2DBuffer2 { CONST_VTBL struct IMF2DBuffer2Vtbl *lpVtbl; };
...
typedef struct IMFDXGIBufferVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(IMFDXGIBuffer *This,
                                             /* [in] */ REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);
  ...
  HRESULT(STDMETHODCALLTYPE *GetResource)(IMFDXGIBuffer *This,
                                          /* [annotation][in] */
                                          _In_ REFIID riid,
                                          /* [annotation][out] */
  ...
  HRESULT(STDMETHODCALLTYPE *GetUnknown)(IMFDXGIBuffer *This,
                                         /* [annotation][in] */
                                         _In_ REFIID guid,
                                         /* [annotation][in] */
                                         _In_ REFIID riid,
  ...
  HRESULT(STDMETHODCALLTYPE *SetUnknown)(IMFDXGIBuffer *This,
                                         /* [annotation][in] */
                                         _In_ REFIID guid,
                                         /* [annotation][in] */
...
interface IMFDXGIBuffer { CONST_VTBL struct IMFDXGIBufferVtbl *lpVtbl; };
...
typedef struct IMFDXGICrossAdapterBufferVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(IMFDXGICrossAdapterBuffer *This,
                                             /* [in] */ REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(IMFDXGICrossAdapterBuffer *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(IMFDXGICrossAdapterBuffer *This);
...
#define IMFDXGICrossAdapterBuffer_AddRef(This) ((This)->lpVtbl->AddRef(This))

#define IMFDXGICrossAdapterBuffer_Release(This) ((This)->lpVtbl->Release(This))

#define IMFDXGICrossAdapterBuffer_GetResourceForDevice(This, pUnkDevice, riid, \
                                                       ppvObject)              \
  ((This)->lpVtbl->GetResourceForDevice(This, pUnkDevice, riid, ppvObject))

#define IMFDXGICrossAdapterBuffer_GetSubresourceIndexForDevice(                \
    This, pUnkDevice, puSubresource)                                           \
  ((This)->lpVtbl->GetSubresourceIndexForDevice(This, pUnkDevice,              \
                                                puSubresource))

#define IMFDXGICrossAdapterBuffer_GetUnknownForDevice(This, pUnkDevice, guid,  \
                                                      riid, ppvObject)         \
  ((This)->lpVtbl->GetUnknownForDevice(This, pUnkDevice, guid, riid, ppvObject))

#define IMFDXGICrossAdapterBuffer_SetUnknownForDevice(This, pUnkDevice, guid,  \
                                                      pUnkData)                \
...
typedef struct IMFMediaTypeVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in IMFMediaType *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IMFMediaType *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IMFMediaType *This);

  DECLSPEC_XFGVIRT(IMFAttributes, GetItem)
  HRESULT(STDMETHODCALLTYPE *GetItem)(
      __RPC__in IMFMediaType *This, __RPC__in REFGUID guidKey,
      /* [full][out][in] */ __RPC__inout_opt PROPVARIANT *pValue);
  ...
  DECLSPEC_XFGVIRT(IMFAttributes, Compare)
  HRESULT(STDMETHODCALLTYPE *Compare)(__RPC__in IMFMediaType *This,
                                      __RPC__in_opt IMFAttributes *pTheirs,
                                      MF_ATTRIBUTES_MATCH_TYPE MatchType,
                                      /* [out] */ __RPC__out BOOL *pbResult);
  ...
  DECLSPEC_XFGVIRT(IMFAttributes, GetDouble)
  HRESULT(STDMETHODCALLTYPE *GetDouble)(__RPC__in IMFMediaType *This,
                                        __RPC__in REFGUID guidKey,
                                        /* [out] */ __RPC__out double *pfValue);

  DECLSPEC_XFGVIRT(IMFAttributes, GetGUID)
  HRESULT(STDMETHODCALLTYPE *GetGUID)(__RPC__in IMFMediaType *This,
                                      __RPC__in REFGUID guidKey,
                                      /* [out] */ __RPC__out GUID *pguidValue);
  ...
  DECLSPEC_XFGVIRT(IMFAttributes, SetItem)
  HRESULT(STDMETHODCALLTYPE *SetItem)(__RPC__in IMFMediaType *This,
                                      __RPC__in REFGUID guidKey,
                                      __RPC__in REFPROPVARIANT Value);

  DECLSPEC_XFGVIRT(IMFAttributes, DeleteItem)
  HRESULT(STDMETHODCALLTYPE *DeleteItem)(__RPC__in IMFMediaType *This,
                                         __RPC__in REFGUID guidKey);

  DECLSPEC_XFGVIRT(IMFAttributes, DeleteAllItems)
  HRESULT(STDMETHODCALLTYPE *DeleteAllItems)(__RPC__in IMFMediaType *This);

  DECLSPEC_XFGVIRT(IMFAttributes, SetUINT32)
  HRESULT(STDMETHODCALLTYPE *SetUINT32)(__RPC__in IMFMediaType *This,
                                        __RPC__in REFGUID guidKey,
                                        UINT32 unValue);

  DECLSPEC_XFGVIRT(IMFAttributes, SetUINT64)
  HRESULT(STDMETHODCALLTYPE *SetUINT64)(__RPC__in IMFMediaType *This,
                                        __RPC__in REFGUID guidKey,
                                        UINT64 unValue);

  DECLSPEC_XFGVIRT(IMFAttributes, SetDouble)
  HRESULT(STDMETHODCALLTYPE *SetDouble)(__RPC__in IMFMediaType *This,
                                        __RPC__in REFGUID guidKey,
                                        double fValue);

  DECLSPEC_XFGVIRT(IMFAttributes, SetGUID)
  HRESULT(STDMETHODCALLTYPE *SetGUID)(__RPC__in IMFMediaType *This,
                                      __RPC__in REFGUID guidKey,
                                      __RPC__in REFGUID guidValue);
  ...
  DECLSPEC_XFGVIRT(IMFAttributes, LockStore)
  HRESULT(STDMETHODCALLTYPE *LockStore)(__RPC__in IMFMediaType *This);

  DECLSPEC_XFGVIRT(IMFAttributes, UnlockStore)
  HRESULT(STDMETHODCALLTYPE *UnlockStore)(__RPC__in IMFMediaType *This);

  DECLSPEC_XFGVIRT(IMFAttributes, GetCount)
  HRESULT(STDMETHODCALLTYPE *GetCount)(__RPC__in IMFMediaType *This,
                                       /* [out] */ __RPC__out UINT32 *pcItems);

  DECLSPEC_XFGVIRT(IMFAttributes, GetItemByIndex)
  HRESULT(STDMETHODCALLTYPE *GetItemByIndex)(
      __RPC__in IMFMediaType *This, UINT32 unIndex,
      /* [out] */ __RPC__out GUID *pguidKey,
      /* [full][out][in] */ __RPC__inout_opt PROPVARIANT *pValue);
...
interface IMFMediaType { CONST_VTBL struct IMFMediaTypeVtbl *lpVtbl; };
...
#define IMFMediaType_GetRepresentation(This, guidRepresentation,               \
                                       ppvRepresentation)                      \
  ((This)->lpVtbl->GetRepresentation(This, guidRepresentation,                 \
                                     ppvRepresentation))
...
typedef struct IMFAudioMediaTypeVtbl {
  ...
  DECLSPEC_XFGVIRT(IMFAttributes, GetItem)
  HRESULT(STDMETHODCALLTYPE *GetItem)(
      IMFAudioMediaType *This, REFGUID guidKey,
      /* [full][out][in] */ PROPVARIANT *pValue);
  ...
  DECLSPEC_XFGVIRT(IMFAttributes, GetItemByIndex)
  HRESULT(STDMETHODCALLTYPE *GetItemByIndex)(
      IMFAudioMediaType *This, UINT32 unIndex,
      /* [out] */ GUID *pguidKey,
      /* [full][out][in] */ PROPVARIANT *pValue);
...
typedef /* [public][public] */
    struct __MIDL___MIDL_itf_mfobjects_0000_0009_0001 {
  DWORD biSize;
  LONG biWidth;
  LONG biHeight;
  WORD biPlanes;
...
typedef struct IMFVideoMediaTypeVtbl {
  ...
  DECLSPEC_XFGVIRT(IMFAttributes, GetItem)
  HRESULT(STDMETHODCALLTYPE *GetItem)(
      IMFVideoMediaType *This, REFGUID guidKey,
      /* [full][out][in] */ PROPVARIANT *pValue);
  ...
  DECLSPEC_XFGVIRT(IMFAttributes, GetItemByIndex)
  HRESULT(STDMETHODCALLTYPE *GetItemByIndex)(
      IMFVideoMediaType *This, UINT32 unIndex,
      /* [out] */ GUID *pguidKey,
      /* [full][out][in] */ PROPVARIANT *pValue);
...
typedef struct IMFAsyncResultVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in IMFAsyncResult *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IMFAsyncResult *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IMFAsyncResult *This);
  ...
  HRESULT(STDMETHODCALLTYPE *GetStatus)(__RPC__in IMFAsyncResult *This);

  DECLSPEC_XFGVIRT(IMFAsyncResult, SetStatus)
  HRESULT(STDMETHODCALLTYPE *SetStatus)(__RPC__in IMFAsyncResult *This,
                                        /* [in] */ HRESULT hrStatus);
...
interface IMFAsyncResult { CONST_VTBL struct IMFAsyncResultVtbl *lpVtbl; };
...
typedef struct IMFAsyncCallbackVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in IMFAsyncCallback *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IMFAsyncCallback *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IMFAsyncCallback *This);
...
interface IMFAsyncCallback { CONST_VTBL struct IMFAsyncCallbackVtbl *lpVtbl; };
...
typedef struct IMFMediaEventVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in IMFMediaEvent *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IMFMediaEvent *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IMFMediaEvent *This);

  DECLSPEC_XFGVIRT(IMFAttributes, GetItem)
  HRESULT(STDMETHODCALLTYPE *GetItem)(
      __RPC__in IMFMediaEvent *This, __RPC__in REFGUID guidKey,
      /* [full][out][in] */ __RPC__inout_opt PROPVARIANT *pValue);
  ...
  DECLSPEC_XFGVIRT(IMFAttributes, Compare)
  HRESULT(STDMETHODCALLTYPE *Compare)(__RPC__in IMFMediaEvent *This,
                                      __RPC__in_opt IMFAttributes *pTheirs,
                                      MF_ATTRIBUTES_MATCH_TYPE MatchType,
                                      /* [out] */ __RPC__out BOOL *pbResult);
  ...
  DECLSPEC_XFGVIRT(IMFAttributes, GetDouble)
  HRESULT(STDMETHODCALLTYPE *GetDouble)(__RPC__in IMFMediaEvent *This,
                                        __RPC__in REFGUID guidKey,
                                        /* [out] */ __RPC__out double *pfValue);

  DECLSPEC_XFGVIRT(IMFAttributes, GetGUID)
  HRESULT(STDMETHODCALLTYPE *GetGUID)(__RPC__in IMFMediaEvent *This,
                                      __RPC__in REFGUID guidKey,
                                      /* [out] */ __RPC__out GUID *pguidValue);
  ...
  DECLSPEC_XFGVIRT(IMFAttributes, SetItem)
  HRESULT(STDMETHODCALLTYPE *SetItem)(__RPC__in IMFMediaEvent *This,
                                      __RPC__in REFGUID guidKey,
                                      __RPC__in REFPROPVARIANT Value);

  DECLSPEC_XFGVIRT(IMFAttributes, DeleteItem)
  HRESULT(STDMETHODCALLTYPE *DeleteItem)(__RPC__in IMFMediaEvent *This,
                                         __RPC__in REFGUID guidKey);

  DECLSPEC_XFGVIRT(IMFAttributes, DeleteAllItems)
  HRESULT(STDMETHODCALLTYPE *DeleteAllItems)(__RPC__in IMFMediaEvent *This);

  DECLSPEC_XFGVIRT(IMFAttributes, SetUINT32)
  HRESULT(STDMETHODCALLTYPE *SetUINT32)(__RPC__in IMFMediaEvent *This,
                                        __RPC__in REFGUID guidKey,
                                        UINT32 unValue);

  DECLSPEC_XFGVIRT(IMFAttributes, SetUINT64)
  HRESULT(STDMETHODCALLTYPE *SetUINT64)(__RPC__in IMFMediaEvent *This,
                                        __RPC__in REFGUID guidKey,
                                        UINT64 unValue);

  DECLSPEC_XFGVIRT(IMFAttributes, SetDouble)
  HRESULT(STDMETHODCALLTYPE *SetDouble)(__RPC__in IMFMediaEvent *This,
                                        __RPC__in REFGUID guidKey,
                                        double fValue);

  DECLSPEC_XFGVIRT(IMFAttributes, SetGUID)
  HRESULT(STDMETHODCALLTYPE *SetGUID)(__RPC__in IMFMediaEvent *This,
                                      __RPC__in REFGUID guidKey,
                                      __RPC__in REFGUID guidValue);
  ...
  DECLSPEC_XFGVIRT(IMFAttributes, LockStore)
  HRESULT(STDMETHODCALLTYPE *LockStore)(__RPC__in IMFMediaEvent *This);

  DECLSPEC_XFGVIRT(IMFAttributes, UnlockStore)
  HRESULT(STDMETHODCALLTYPE *UnlockStore)(__RPC__in IMFMediaEvent *This);

  DECLSPEC_XFGVIRT(IMFAttributes, GetCount)
  HRESULT(STDMETHODCALLTYPE *GetCount)(__RPC__in IMFMediaEvent *This,
                                       /* [out] */ __RPC__out UINT32 *pcItems);

  DECLSPEC_XFGVIRT(IMFAttributes, GetItemByIndex)
  HRESULT(STDMETHODCALLTYPE *GetItemByIndex)(
      __RPC__in IMFMediaEvent *This, UINT32 unIndex,
      /* [out] */ __RPC__out GUID *pguidKey,
      /* [full][out][in] */ __RPC__inout_opt PROPVARIANT *pValue);
...
interface IMFMediaEvent { CONST_VTBL struct IMFMediaEventVtbl *lpVtbl; };
...
typedef struct IMFMediaEventGeneratorVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IMFMediaEventGenerator *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IMFMediaEventGenerator *This);
...
/* [call_as] */ HRESULT
STDMETHODCALLTYPE IMFMediaEventGenerator_RemoteBeginGetEvent_Proxy(
    __RPC__in IMFMediaEventGenerator *This,
...
IMFMediaEventGenerator_RemoteEndGetEvent_Proxy(
    __RPC__in IMFMediaEventGenerator *This,
...
typedef struct IMFRemoteAsyncCallbackVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IMFRemoteAsyncCallback *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IMFRemoteAsyncCallback *This);
...
typedef struct IMFByteStreamVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in IMFByteStream *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IMFByteStream *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IMFByteStream *This);
  ...
  HRESULT(STDMETHODCALLTYPE *SetLength)(__RPC__in IMFByteStream *This,
                                        /* [in] */ QWORD qwLength);
  ...
  HRESULT(STDMETHODCALLTYPE *SetCurrentPosition)(__RPC__in IMFByteStream *This,
                                                 /* [in] */ QWORD qwPosition);
  ...
  HRESULT(STDMETHODCALLTYPE *Flush)(__RPC__in IMFByteStream *This);

  DECLSPEC_XFGVIRT(IMFByteStream, Close)
  HRESULT(STDMETHODCALLTYPE *Close)(__RPC__in IMFByteStream *This);

  END_INTERFACE
} IMFByteStreamVtbl;

interface IMFByteStream { CONST_VTBL struct IMFByteStreamVtbl *lpVtbl; };
...
typedef struct IMFSampleOutputStreamVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IMFSampleOutputStream *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IMFSampleOutputStream *This);
  ...
  HRESULT(STDMETHODCALLTYPE *Close)(__RPC__in IMFSampleOutputStream *This);
...
typedef struct IMFCollectionVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in IMFCollection *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IMFCollection *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IMFCollection *This);
  ...
  HRESULT(STDMETHODCALLTYPE *RemoveAllElements)(__RPC__in IMFCollection *This);

  END_INTERFACE
} IMFCollectionVtbl;

interface IMFCollection { CONST_VTBL struct IMFCollectionVtbl *lpVtbl; };
...
typedef struct IMFMediaEventQueueVtbl {
  ...
  HRESULT(STDMETHODCALLTYPE *GetEvent)(IMFMediaEventQueue *This,
                                       /* [in] */ DWORD dwFlags,
                                       /* [annotation][out] */
                                       _Out_ IMFMediaEvent **ppEvent);
...
typedef struct IMFActivateVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in IMFActivate *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IMFActivate *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IMFActivate *This);

  DECLSPEC_XFGVIRT(IMFAttributes, GetItem)
  HRESULT(STDMETHODCALLTYPE *GetItem)(
      __RPC__in IMFActivate *This, __RPC__in REFGUID guidKey,
      /* [full][out][in] */ __RPC__inout_opt PROPVARIANT *pValue);
  ...
  DECLSPEC_XFGVIRT(IMFAttributes, Compare)
  HRESULT(STDMETHODCALLTYPE *Compare)(__RPC__in IMFActivate *This,
                                      __RPC__in_opt IMFAttributes *pTheirs,
                                      MF_ATTRIBUTES_MATCH_TYPE MatchType,
                                      /* [out] */ __RPC__out BOOL *pbResult);
  ...
  DECLSPEC_XFGVIRT(IMFAttributes, GetDouble)
  HRESULT(STDMETHODCALLTYPE *GetDouble)(__RPC__in IMFActivate *This,
                                        __RPC__in REFGUID guidKey,
                                        /* [out] */ __RPC__out double *pfValue);

  DECLSPEC_XFGVIRT(IMFAttributes, GetGUID)
  HRESULT(STDMETHODCALLTYPE *GetGUID)(__RPC__in IMFActivate *This,
                                      __RPC__in REFGUID guidKey,
                                      /* [out] */ __RPC__out GUID *pguidValue);
  ...
  DECLSPEC_XFGVIRT(IMFAttributes, SetItem)
  HRESULT(STDMETHODCALLTYPE *SetItem)(__RPC__in IMFActivate *This,
                                      __RPC__in REFGUID guidKey,
                                      __RPC__in REFPROPVARIANT Value);

  DECLSPEC_XFGVIRT(IMFAttributes, DeleteItem)
  HRESULT(STDMETHODCALLTYPE *DeleteItem)(__RPC__in IMFActivate *This,
                                         __RPC__in REFGUID guidKey);

  DECLSPEC_XFGVIRT(IMFAttributes, DeleteAllItems)
  HRESULT(STDMETHODCALLTYPE *DeleteAllItems)(__RPC__in IMFActivate *This);

  DECLSPEC_XFGVIRT(IMFAttributes, SetUINT32)
  HRESULT(STDMETHODCALLTYPE *SetUINT32)(__RPC__in IMFActivate *This,
                                        __RPC__in REFGUID guidKey,
                                        UINT32 unValue);

  DECLSPEC_XFGVIRT(IMFAttributes, SetUINT64)
  HRESULT(STDMETHODCALLTYPE *SetUINT64)(__RPC__in IMFActivate *This,
                                        __RPC__in REFGUID guidKey,
                                        UINT64 unValue);

  DECLSPEC_XFGVIRT(IMFAttributes, SetDouble)
  HRESULT(STDMETHODCALLTYPE *SetDouble)(__RPC__in IMFActivate *This,
                                        __RPC__in REFGUID guidKey,
                                        double fValue);

  DECLSPEC_XFGVIRT(IMFAttributes, SetGUID)
  HRESULT(STDMETHODCALLTYPE *SetGUID)(__RPC__in IMFActivate *This,
                                      __RPC__in REFGUID guidKey,
                                      __RPC__in REFGUID guidValue);
  ...
  DECLSPEC_XFGVIRT(IMFAttributes, LockStore)
  HRESULT(STDMETHODCALLTYPE *LockStore)(__RPC__in IMFActivate *This);

  DECLSPEC_XFGVIRT(IMFAttributes, UnlockStore)
  HRESULT(STDMETHODCALLTYPE *UnlockStore)(__RPC__in IMFActivate *This);

  DECLSPEC_XFGVIRT(IMFAttributes, GetCount)
  HRESULT(STDMETHODCALLTYPE *GetCount)(__RPC__in IMFActivate *This,
                                       /* [out] */ __RPC__out UINT32 *pcItems);

  DECLSPEC_XFGVIRT(IMFAttributes, GetItemByIndex)
  HRESULT(STDMETHODCALLTYPE *GetItemByIndex)(
      __RPC__in IMFActivate *This, UINT32 unIndex,
      /* [out] */ __RPC__out GUID *pguidKey,
      /* [full][out][in] */ __RPC__inout_opt PROPVARIANT *pValue);
  ...
  HRESULT(STDMETHODCALLTYPE *ShutdownObject)(__RPC__in IMFActivate *This);

  DECLSPEC_XFGVIRT(IMFActivate, DetachObject)
  HRESULT(STDMETHODCALLTYPE *DetachObject)(__RPC__in IMFActivate *This);

  END_INTERFACE
} IMFActivateVtbl;

interface IMFActivate { CONST_VTBL struct IMFActivateVtbl *lpVtbl; };
...
public:
  virtual HRESULT STDMETHODCALLTYPE GetPreferredClsid(DWORD pluginType,
                                                      /* [annotation] */
  ...
  virtual HRESULT STDMETHODCALLTYPE GetDisabledByIndex(DWORD pluginType,
                                                       DWORD index,
                                                       /* [annotation] */
                                                       _Out_ CLSID * clsid) = 0;

  virtual HRESULT STDMETHODCALLTYPE SetDisabled(
      DWORD pluginType, REFCLSID clsid, BOOL disabled) = 0;
};
...
interface IMFPluginControl { CONST_VTBL struct IMFPluginControlVtbl *lpVtbl; };
...
typedef struct IMFSecureBufferVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(IMFSecureBuffer *This,
                                             /* [in] */ REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(IMFSecureBuffer *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(IMFSecureBuffer *This);

  DECLSPEC_XFGVIRT(IMFSecureBuffer, GetIdentifier)
  HRESULT(STDMETHODCALLTYPE *GetIdentifier)(IMFSecureBuffer *This,
                                            /* [annotation][out] */
...
interface IMFSecureBuffer { CONST_VTBL struct IMFSecureBufferVtbl *lpVtbl; };
...
#define IMFSecureBuffer_AddRef(This) ((This)->lpVtbl->AddRef(This))

#define IMFSecureBuffer_Release(This) ((This)->lpVtbl->Release(This))
...
IMFMediaEventGenerator_BeginGetEvent_Proxy(
    IMFMediaEventGenerator *This,
    /* [in] */ IMFAsyncCallback *pCallback,
    /* [in] */ IUnknown *punkState);

/* [call_as] */ HRESULT STDMETHODCALLTYPE
IMFMediaEventGenerator_BeginGetEvent_Stub(
    __RPC__in IMFMediaEventGenerator *This,
    /* [in] */ __RPC__in_opt IMFRemoteAsyncCallback *pCallback);

/* [local] */ HRESULT STDMETHODCALLTYPE
IMFMediaEventGenerator_EndGetEvent_Proxy(IMFMediaEventGenerator *This,
                                         /* [in] */ IMFAsyncResult *pResult,
                                         /* [annotation][out] */
                                         _Out_ IMFMediaEvent **ppEvent);

/* [call_as] */ HRESULT STDMETHODCALLTYPE
IMFMediaEventGenerator_EndGetEvent_Stub(
    __RPC__in IMFMediaEventGenerator *This,
    /* [in] */ __RPC__in_opt IUnknown *pResult,
    /* [out] */ __RPC__out DWORD *pcbEvent,
    /* [size_is][size_is][out] */
...
/* [local] */ HRESULT STDMETHODCALLTYPE
IMFByteStream_BeginRead_Proxy(IMFByteStream *This,
                              /* [annotation][out] */
                              _Out_writes_bytes_(cb) BYTE *pb,
                              /* [in] */ ULONG cb,
                              /* [in] */ IMFAsyncCallback *pCallback,
...
/* [local] */ HRESULT STDMETHODCALLTYPE
IMFByteStream_EndRead_Proxy(IMFByteStream *This,
                            /* [in] */ IMFAsyncResult *pResult,
                            /* [annotation][out] */
                            _Out_ ULONG *pcbRead);

/* [call_as] */ HRESULT STDMETHODCALLTYPE
IMFByteStream_EndRead_Stub(__RPC__in IMFByteStream *This,
                           /* [in] */ __RPC__in_opt IUnknown *punkResult,
                           /* [length_is][size_is][out][in] */
                           __RPC__inout_ecount_part(cb, *pcbRead) BYTE *pb,
                           /* [in] */ ULONG cb,
...
/* [local] */ HRESULT STDMETHODCALLTYPE
IMFByteStream_BeginWrite_Proxy(IMFByteStream *This,
                               /* [annotation][in] */
                               _In_reads_bytes_(cb) const BYTE *pb,
                               /* [in] */ ULONG cb,
                               /* [in] */ IMFAsyncCallback *pCallback,
...
/* [local] */ HRESULT STDMETHODCALLTYPE
IMFByteStream_EndWrite_Proxy(IMFByteStream *This,
                             /* [in] */ IMFAsyncResult *pResult,
                             /* [annotation][out] */
                             _Out_ ULONG *pcbWritten);

/* [call_as] */ HRESULT STDMETHODCALLTYPE
IMFByteStream_EndWrite_Stub(__RPC__in IMFByteStream *This,
                            /* [in] */ __RPC__in_opt IUnknown *punkResult,
                            /* [out] */ __RPC__out ULONG *pcbWritten);
