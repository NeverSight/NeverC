...
typedef struct _HEAPALIGNMENT {
  ...
  DWORD dwReserved;
  SURFACEALIGNMENT
  ExecuteBuffer;                /* Surfaces tagged with DDSCAPS_EXECUTEBUFFER */
  ...
  SURFACEALIGNMENT FlipTarget;  /* Surfaces whose bits are potential primaries
                                   i.e. back buffers*/
} HEAPALIGNMENT;
...
typedef struct _VMEMHEAP {
  ...
  /*
   * These are analogous to VIDMEM.ddsCaps and VIDMEM.ddsCapsAlt. These values
   * are queried from the driver by a GetDriverInfo call. See the documentation
   * for GUID_DDMoreSurfaceCaps
   */
  DDSCAPSEX ddsCapsEx;
...
/*
 * This export can be used by drivers to allocate aligned surfaces from heaps
 * which they have previously exposed to DirectDraw. This function can allocate
 * from nonlocal heaps.
 */
