...
typedef struct IGenericDescriptorVtbl {
  ...
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(IGenericDescriptor *This,
                                             /* [in] */ REFIID riid,
  ...
  HRESULT(STDMETHODCALLTYPE *Initialize)(IGenericDescriptor *This,
                                         /* [in] */ BYTE *pbDesc,
                                         /* [in] */ INT bCount);

  DECLSPEC_XFGVIRT(IGenericDescriptor, GetTag)
  HRESULT(STDMETHODCALLTYPE *GetTag)(IGenericDescriptor *This,
                                     /* [out] */ BYTE *pbVal);

  DECLSPEC_XFGVIRT(IGenericDescriptor, GetLength)
  HRESULT(STDMETHODCALLTYPE *GetLength)(IGenericDescriptor *This,
                                        /* [out] */ BYTE *pbVal);

  DECLSPEC_XFGVIRT(IGenericDescriptor, GetBody)
  HRESULT(STDMETHODCALLTYPE *GetBody)(IGenericDescriptor *This,
                                      /* [out] */ BYTE **ppbVal);
...
typedef struct IGenericDescriptor2Vtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(IGenericDescriptor2 *This,
                                             /* [in] */ REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);
  ...
  DECLSPEC_XFGVIRT(IGenericDescriptor, Initialize)
  HRESULT(STDMETHODCALLTYPE *Initialize)(IGenericDescriptor2 *This,
                                         /* [in] */ BYTE *pbDesc,
                                         /* [in] */ INT bCount);

  DECLSPEC_XFGVIRT(IGenericDescriptor, GetTag)
  HRESULT(STDMETHODCALLTYPE *GetTag)(IGenericDescriptor2 *This,
                                     /* [out] */ BYTE *pbVal);

  DECLSPEC_XFGVIRT(IGenericDescriptor, GetLength)
  HRESULT(STDMETHODCALLTYPE *GetLength)(IGenericDescriptor2 *This,
                                        /* [out] */ BYTE *pbVal);

  DECLSPEC_XFGVIRT(IGenericDescriptor, GetBody)
  HRESULT(STDMETHODCALLTYPE *GetBody)(IGenericDescriptor2 *This,
                                      /* [out] */ BYTE **ppbVal);
...
typedef struct IPATVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(IPAT *This,
                                             /* [in] */ REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);
  ...
  HRESULT(STDMETHODCALLTYPE *Initialize)(IPAT *This,
                                         /* [in] */ ISectionList *pSectionList,
                                         /* [in] */ IMpeg2Data *pMPEGData);

  DECLSPEC_XFGVIRT(IPAT, GetTransportStreamId)
  HRESULT(STDMETHODCALLTYPE *GetTransportStreamId)(IPAT *This,
                                                   /* [out] */ WORD *pwVal);

  DECLSPEC_XFGVIRT(IPAT, GetVersionNumber)
  HRESULT(STDMETHODCALLTYPE *GetVersionNumber)(IPAT *This,
                                               /* [out] */ BYTE *pbVal);

  DECLSPEC_XFGVIRT(IPAT, GetCountOfRecords)
  HRESULT(STDMETHODCALLTYPE *GetCountOfRecords)(IPAT *This,
                                                /* [out] */ DWORD *pdwVal);

  DECLSPEC_XFGVIRT(IPAT, GetRecordProgramNumber)
  HRESULT(STDMETHODCALLTYPE *GetRecordProgramNumber)(IPAT *This,
                                                     /* [in] */ DWORD dwIndex,
                                                     /* [out] */ WORD *pwVal);

  DECLSPEC_XFGVIRT(IPAT, GetRecordProgramMapPid)
  HRESULT(STDMETHODCALLTYPE *GetRecordProgramMapPid)(IPAT *This,
                                                     /* [in] */ DWORD dwIndex,
                                                     /* [out] */ WORD *pwVal);
  ...
  HRESULT(STDMETHODCALLTYPE *GetNextTable)(IPAT *This,
                                           /* [out] */ IPAT **ppPAT);
...
interface IPAT { CONST_VTBL struct IPATVtbl *lpVtbl; };
...
typedef struct ICATVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(ICAT *This,
                                             /* [in] */ REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);
  ...
  HRESULT(STDMETHODCALLTYPE *Initialize)(ICAT *This,
                                         /* [in] */ ISectionList *pSectionList,
                                         /* [in] */ IMpeg2Data *pMPEGData);

  DECLSPEC_XFGVIRT(ICAT, GetVersionNumber)
  HRESULT(STDMETHODCALLTYPE *GetVersionNumber)(ICAT *This,
                                               /* [out] */ BYTE *pbVal);
  ...
  HRESULT(STDMETHODCALLTYPE *GetNextTable)(ICAT *This,
                                           /* [in] */ DWORD dwTimeout,
                                           /* [out] */ ICAT **ppCAT);
...
interface ICAT { CONST_VTBL struct ICATVtbl *lpVtbl; };
...
typedef struct IPMTVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(IPMT *This,
                                             /* [in] */ REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);
  ...
  HRESULT(STDMETHODCALLTYPE *Initialize)(IPMT *This,
                                         /* [in] */ ISectionList *pSectionList,
                                         /* [in] */ IMpeg2Data *pMPEGData);

  DECLSPEC_XFGVIRT(IPMT, GetProgramNumber)
  HRESULT(STDMETHODCALLTYPE *GetProgramNumber)(IPMT *This,
                                               /* [out] */ WORD *pwVal);

  DECLSPEC_XFGVIRT(IPMT, GetVersionNumber)
  HRESULT(STDMETHODCALLTYPE *GetVersionNumber)(IPMT *This,
                                               /* [out] */ BYTE *pbVal);

  DECLSPEC_XFGVIRT(IPMT, GetPcrPid)
  HRESULT(STDMETHODCALLTYPE *GetPcrPid)(IPMT *This,
                                        /* [out] */ PID *pPidVal);
  ...
  HRESULT(STDMETHODCALLTYPE *GetCountOfRecords)(IPMT *This,
                                                /* [out] */ WORD *pwVal);
  ...
  HRESULT(STDMETHODCALLTYPE *QueryMPEInfo)(IPMT *This,
                                           /* [out] */ MPE_ELEMENT **ppMPEList,
                                           /* [out] */ UINT *puiCount);
  ...
  HRESULT(STDMETHODCALLTYPE *GetNextTable)(IPMT *This,
                                           /* [out] */ IPMT **ppPMT);
...
interface IPMT { CONST_VTBL struct IPMTVtbl *lpVtbl; };
...
#define IPMT_GetRecordDescriptorByIndex(This, dwRecordIndex, dwDescIndex,      \
                                        ppDescriptor)                          \
  ((This)->lpVtbl->GetRecordDescriptorByIndex(This, dwRecordIndex,             \
                                              dwDescIndex, ppDescriptor))
...
typedef struct ITSDTVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(ITSDT *This,
                                             /* [in] */ REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);
  ...
  HRESULT(STDMETHODCALLTYPE *Initialize)(ITSDT *This,
                                         /* [in] */ ISectionList *pSectionList,
                                         /* [in] */ IMpeg2Data *pMPEGData);

  DECLSPEC_XFGVIRT(ITSDT, GetVersionNumber)
  HRESULT(STDMETHODCALLTYPE *GetVersionNumber)(ITSDT *This,
                                               /* [out] */ BYTE *pbVal);
  ...
  HRESULT(STDMETHODCALLTYPE *GetNextTable)(ITSDT *This,
                                           /* [out] */ ITSDT **ppTSDT);
...
interface ITSDT { CONST_VTBL struct ITSDTVtbl *lpVtbl; };
...
typedef struct IPSITablesVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in IPSITables *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IPSITables *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IPSITables *This);
...
interface IPSITables { CONST_VTBL struct IPSITablesVtbl *lpVtbl; };
