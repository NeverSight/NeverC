...
typedef struct IInkCommitRequestHandlerVtbl {
  ...
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IInkCommitRequestHandler *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IInkCommitRequestHandler *This);
...
#define IInkCommitRequestHandler_AddRef(This) ((This)->lpVtbl->AddRef(This))

#define IInkCommitRequestHandler_Release(This) ((This)->lpVtbl->Release(This))
...
typedef struct IInkPresenterDesktopVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IInkPresenterDesktop *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IInkPresenterDesktop *This);
  ...
  HRESULT(STDMETHODCALLTYPE *GetSize)(__RPC__in IInkPresenterDesktop *This,
                                      /* [out] */ __RPC__out float *width,
                                      /* [out] */ __RPC__out float *height);

  DECLSPEC_XFGVIRT(IInkPresenterDesktop, SetSize)
  HRESULT(STDMETHODCALLTYPE *SetSize)(__RPC__in IInkPresenterDesktop *This,
                                      /* [in] */ float width,
                                      /* [in] */ float height);
...
#define IInkPresenterDesktop_AddRef(This) ((This)->lpVtbl->AddRef(This))

#define IInkPresenterDesktop_Release(This) ((This)->lpVtbl->Release(This))
...
typedef struct IInkHostWorkItemVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in IInkHostWorkItem *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IInkHostWorkItem *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IInkHostWorkItem *This);

  DECLSPEC_XFGVIRT(IInkHostWorkItem, Invoke)
  HRESULT(STDMETHODCALLTYPE *Invoke)(__RPC__in IInkHostWorkItem *This);

  END_INTERFACE
} IInkHostWorkItemVtbl;

interface IInkHostWorkItem { CONST_VTBL struct IInkHostWorkItemVtbl *lpVtbl; };
...
#define IInkHostWorkItem_AddRef(This) ((This)->lpVtbl->AddRef(This))

#define IInkHostWorkItem_Release(This) ((This)->lpVtbl->Release(This))

#define IInkHostWorkItem_Invoke(This) ((This)->lpVtbl->Invoke(This))
...
typedef struct IInkDesktopHostVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in IInkDesktopHost *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IInkDesktopHost *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IInkDesktopHost *This);
...
interface IInkDesktopHost { CONST_VTBL struct IInkDesktopHostVtbl *lpVtbl; };
...
#define IInkDesktopHost_AddRef(This) ((This)->lpVtbl->AddRef(This))

#define IInkDesktopHost_Release(This) ((This)->lpVtbl->Release(This))
...
#define IInkDesktopHost_CreateAndInitializeInkPresenter(                       \
    This, rootVisual, width, height, riid, ppv)                                \
  ((This)->lpVtbl->CreateAndInitializeInkPresenter(This, rootVisual, width,    \
                                                   height, riid, ppv))
