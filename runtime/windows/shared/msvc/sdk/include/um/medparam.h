...
typedef struct IMediaParamInfoVtbl {
  ...
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in IMediaParamInfo *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IMediaParamInfo *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IMediaParamInfo *This);
...
typedef struct IMediaParamsVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in IMediaParams *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IMediaParams *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IMediaParams *This);

  DECLSPEC_XFGVIRT(IMediaParams, GetParam)
  HRESULT(STDMETHODCALLTYPE *GetParam)(__RPC__in IMediaParams *This,
                                       /* [in] */ DWORD dwParamIndex,
                                       /* [out] */ __RPC__out MP_DATA *pValue);

  DECLSPEC_XFGVIRT(IMediaParams, SetParam)
  HRESULT(STDMETHODCALLTYPE *SetParam)(__RPC__in IMediaParams *This,
                                       /* [in] */ DWORD dwParamIndex,
                                       /* [in] */ MP_DATA value);
  ...
  HRESULT(STDMETHODCALLTYPE *SetTimeFormat)(__RPC__in IMediaParams *This,
                                            /* [in] */ GUID guidTimeFormat,
...
#define IMediaParams_AddEnvelope(This, dwParamIndex, cSegments,                \
                                 pEnvelopeSegments)                            \
  ((This)->lpVtbl->AddEnvelope(This, dwParamIndex, cSegments,                  \
                               pEnvelopeSegments))
