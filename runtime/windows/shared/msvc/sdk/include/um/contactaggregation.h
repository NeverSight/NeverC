...
typedef interface IContactAggregationContactCollection
...
typedef interface IContactAggregationAggregateCollection
...
typedef interface IContactAggregationGroupCollection
...
typedef interface IContactAggregationLinkCollection
...
typedef interface IContactAggregationServerPerson
...
typedef interface IContactAggregationServerPersonCollection
...
DEFINE_GUID(CLSID_ContactAggregationManager, 0x96c8ad95, 0xc199, 0x44de, 0xb3,
            0x4e, 0xac, 0x33, 0xc4, 0x42, 0xdf, 0x39);
...
public:
  ...
  virtual HRESULT STDMETHODCALLTYPE CreateOrOpenGroup(
      ...
      /* [retval][out] */ __RPC__deref_out_opt IContactAggregationGroup *
          *ppGroup) = 0;

  virtual HRESULT STDMETHODCALLTYPE CreateExternalContact(
      /* [retval][out] */ __RPC__deref_out_opt IContactAggregationContact *
      *ppItem) = 0;

  virtual HRESULT STDMETHODCALLTYPE CreateServerPerson(
      /* [out] */ __RPC__deref_out_opt IContactAggregationServerPerson *
      *ppServerPerson) = 0;

  virtual HRESULT STDMETHODCALLTYPE CreateServerContactLink(
      /* [out] */ __RPC__deref_out_opt IContactAggregationLink *
      *ppServerContactLink) = 0;

  virtual HRESULT STDMETHODCALLTYPE Flush(void) = 0;

  virtual HRESULT STDMETHODCALLTYPE OpenAggregateContact(
      /* [in] */ __RPC__in LPCWSTR pItemId,
      /* [out] */ __RPC__deref_out_opt IContactAggregationAggregate *
          *ppItem) = 0;

  virtual HRESULT STDMETHODCALLTYPE OpenContact(
      /* [in] */ __RPC__in LPCWSTR pItemId,
      /* [out] */ __RPC__deref_out_opt IContactAggregationContact *
          *ppItem) = 0;
  ...
  virtual /* [propget] */ HRESULT STDMETHODCALLTYPE get_Contacts(
      ...
      /* [retval][out] */
      __RPC__deref_out_opt IContactAggregationContactCollection * *ppItems) = 0;

  virtual /* [propget] */ HRESULT STDMETHODCALLTYPE get_AggregateContacts(
      /* [in] */ CONTACT_AGGREGATION_COLLECTION_OPTIONS options,
      /* [out] */ __RPC__deref_out_opt IContactAggregationAggregateCollection *
          *ppAggregates) = 0;

  virtual /* [propget] */ HRESULT STDMETHODCALLTYPE get_Groups(
      /* [in] */ CONTACT_AGGREGATION_COLLECTION_OPTIONS options,
      /* [out] */ __RPC__deref_out_opt IContactAggregationGroupCollection *
          *ppGroups) = 0;

  virtual /* [propget] */ HRESULT STDMETHODCALLTYPE get_ServerPersons(
      /* [out] */
      __RPC__deref_out_opt IContactAggregationServerPersonCollection *
      *ppServerPersonCollection) = 0;

  virtual /* [propget] */ HRESULT STDMETHODCALLTYPE get_ServerContactLinks(
      /* [in] */ __RPC__in LPCWSTR pPersonItemId,
      /* [out] */ __RPC__deref_out_opt IContactAggregationLinkCollection *
          *ppServerContactLinkCollection) = 0;
};
...
typedef struct IContactAggregationManagerVtbl {
  ...
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IContactAggregationManager *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IContactAggregationManager *This);
  ...
  HRESULT(STDMETHODCALLTYPE *Flush)(__RPC__in IContactAggregationManager *This);
  ...
  /* [propget] */ HRESULT(STDMETHODCALLTYPE *get_AggregateContacts)(
      ...
      /* [in] */ CONTACT_AGGREGATION_COLLECTION_OPTIONS options,
      /* [out] */
      __RPC__deref_out_opt IContactAggregationAggregateCollection *
          *ppAggregates);
  ...
  /* [propget] */ HRESULT(STDMETHODCALLTYPE *get_ServerPersons)(
      __RPC__in IContactAggregationManager *This,
      /* [out] */ __RPC__deref_out_opt IContactAggregationServerPersonCollection
  ...
  /* [propget] */ HRESULT(STDMETHODCALLTYPE *get_ServerContactLinks)(
      ...
      /* [in] */ __RPC__in LPCWSTR pPersonItemId,
      /* [out] */
      __RPC__deref_out_opt IContactAggregationLinkCollection *
...
#define IContactAggregationManager_GetVersionInfo(This, plMajorVersion,        \
                                                  plMinorVersion)              \
  ((This)->lpVtbl->GetVersionInfo(This, plMajorVersion, plMinorVersion))

#define IContactAggregationManager_CreateOrOpenGroup(                          \
    This, pGroupName, options, pCreatedGroup, ppGroup)                         \
  ((This)->lpVtbl->CreateOrOpenGroup(This, pGroupName, options, pCreatedGroup, \
                                     ppGroup))
...
#define IContactAggregationManager_CreateServerContactLink(                    \
    This, ppServerContactLink)                                                 \
...
#define IContactAggregationManager_OpenServerContactLink(This, pItemId,        \
                                                         ppItem)               \
...
#define IContactAggregationManager_get_AggregateContacts(This, options,        \
                                                         ppAggregates)         \
...
#define IContactAggregationManager_get_ServerPersons(This,                     \
                                                     ppServerPersonCollection) \
  ((This)->lpVtbl->get_ServerPersons(This, ppServerPersonCollection))

#define IContactAggregationManager_get_ServerContactLinks(                     \
    This, pPersonItemId, ppServerContactLinkCollection)                        \
  ((This)->lpVtbl->get_ServerContactLinks(This, pPersonItemId,                 \
                                          ppServerContactLinkCollection))
...
public:
  ...
  virtual /* [propget] */ HRESULT STDMETHODCALLTYPE get_RemoteObjectId(
      /* [retval][out] */ __RPC__deref_out_opt CONTACT_AGGREGATION_BLOB *
      *ppRemoteObjectId) = 0;
  ...
  virtual /* [propget] */ HRESULT STDMETHODCALLTYPE get_SyncIdentityHash(
      /* [retval][out] */ __RPC__deref_out_opt CONTACT_AGGREGATION_BLOB *
      *ppSyncIdentityHash) = 0;

  virtual /* [propput] */ HRESULT STDMETHODCALLTYPE put_SyncIdentityHash(
      /* [in] */ __RPC__in const CONTACT_AGGREGATION_BLOB
          *pSyncIdentityHash) = 0;
};
...
typedef struct IContactAggregationContactVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IContactAggregationContact *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IContactAggregationContact *This);
  ...
  HRESULT(STDMETHODCALLTYPE *Save)(__RPC__in IContactAggregationContact *This);
...
#define IContactAggregationContact_get_NetworkSourceIdString(                  \
    This, ppNetworkSourceId)                                                   \
  ((This)->lpVtbl->get_NetworkSourceIdString(This, ppNetworkSourceId))

#define IContactAggregationContact_put_NetworkSourceIdString(This,             \
                                                             pNetworkSourceId) \
...
#define IContactAggregationContact_get_SyncIdentityHash(This,                  \
                                                        ppSyncIdentityHash)    \
  ((This)->lpVtbl->get_SyncIdentityHash(This, ppSyncIdentityHash))

#define IContactAggregationContact_put_SyncIdentityHash(This,                  \
                                                        pSyncIdentityHash)     \
...
public:
  ...
  virtual HRESULT STDMETHODCALLTYPE FindFirstByIdentityHash(
      ...
      /* [retval][out] */
      __RPC__deref_out_opt IContactAggregationContact **ppItem) = 0;
...
typedef struct IContactAggregationContactCollectionVtbl {
  ...
  DECLSPEC_XFGVIRT(IContactAggregationContactCollection,
                   FindFirstByIdentityHash)
...
#define IContactAggregationContactCollection_QueryInterface(This, riid,        \
                                                            ppvObject)         \
  ((This)->lpVtbl->QueryInterface(This, riid, ppvObject))
...
#define IContactAggregationContactCollection_FindFirstByIdentityHash(          \
    This, pSourceType, pAccountId, pIdentityHash, ppItem)                      \
  ((This)->lpVtbl->FindFirstByIdentityHash(This, pSourceType, pAccountId,      \
                                           pIdentityHash, ppItem))

#define IContactAggregationContactCollection_get_Count(This, pCount)           \
  ((This)->lpVtbl->get_Count(This, pCount))

#define IContactAggregationContactCollection_FindFirstByRemoteId(              \
    This, pSourceType, pAccountId, pRemoteObjectId, ppItem)                    \
  ((This)->lpVtbl->FindFirstByRemoteId(This, pSourceType, pAccountId,          \
                                       pRemoteObjectId, ppItem))
...
public:
  ...
  virtual HRESULT STDMETHODCALLTYPE GetComponentItems(
      /* [out] */ __RPC__deref_out_opt IContactAggregationContactCollection *
      *pComponentItems) = 0;
...
typedef struct IContactAggregationAggregateVtbl {
  ...
  HRESULT(STDMETHODCALLTYPE *Link)(__RPC__in IContactAggregationAggregate *This,
                                   /* [in] */ __RPC__in LPCWSTR pAggregateId);
...
public:
  virtual HRESULT STDMETHODCALLTYPE FindFirst(
      /* [retval][out] */ __RPC__deref_out_opt IContactAggregationAggregate *
      *ppAggregate) = 0;
...
typedef struct IContactAggregationAggregateCollectionVtbl {
  ...
  DECLSPEC_XFGVIRT(IContactAggregationAggregateCollection,
                   FindFirstByAntiLinkId)
...
#define IContactAggregationAggregateCollection_QueryInterface(This, riid,      \
                                                              ppvObject)       \
  ((This)->lpVtbl->QueryInterface(This, riid, ppvObject))
...
#define IContactAggregationAggregateCollection_FindFirstByAntiLinkId(          \
    This, pAntiLinkId, ppAggregate)                                            \
...
public:
  ...
  virtual /* [propget] */ HRESULT STDMETHODCALLTYPE get_Members(
      /* [retval][out] */
      __RPC__deref_out_opt IContactAggregationAggregateCollection *
      *ppAggregateContactCollection) = 0;
...
typedef struct IContactAggregationGroupVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IContactAggregationGroup *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IContactAggregationGroup *This);

  DECLSPEC_XFGVIRT(IContactAggregationGroup, Delete)
  HRESULT(STDMETHODCALLTYPE *Delete)(__RPC__in IContactAggregationGroup *This);

  DECLSPEC_XFGVIRT(IContactAggregationGroup, Save)
  HRESULT(STDMETHODCALLTYPE *Save)(__RPC__in IContactAggregationGroup *This);

  DECLSPEC_XFGVIRT(IContactAggregationGroup, Add)
  HRESULT(STDMETHODCALLTYPE *Add)(__RPC__in IContactAggregationGroup *This,
                                  /* [in] */ __RPC__in LPCWSTR pAggregateId);

  DECLSPEC_XFGVIRT(IContactAggregationGroup, Remove)
  HRESULT(STDMETHODCALLTYPE *Remove)(__RPC__in IContactAggregationGroup *This,
                                     /* [in] */ __RPC__in LPCWSTR pAggregateId);
...
#define IContactAggregationGroup_get_Members(This,                             \
                                             ppAggregateContactCollection)     \
...
typedef struct IContactAggregationGroupCollectionVtbl {
  ...
  DECLSPEC_XFGVIRT(IContactAggregationGroupCollection,
                   FindFirstByGlobalObjectId)
...
#define IContactAggregationGroupCollection_QueryInterface(This, riid,          \
                                                          ppvObject)           \
  ((This)->lpVtbl->QueryInterface(This, riid, ppvObject))
...
#define IContactAggregationGroupCollection_FindFirstByGlobalObjectId(          \
    This, pGlobalObjectId, ppGroup)                                            \
...
typedef struct IContactAggregationLinkVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IContactAggregationLink *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IContactAggregationLink *This);

  DECLSPEC_XFGVIRT(IContactAggregationLink, Delete)
  HRESULT(STDMETHODCALLTYPE *Delete)(__RPC__in IContactAggregationLink *This);

  DECLSPEC_XFGVIRT(IContactAggregationLink, Save)
  HRESULT(STDMETHODCALLTYPE *Save)(__RPC__in IContactAggregationLink *This);
...
#define IContactAggregationLink_get_NetworkSourceIdString(This,                \
                                                          ppNetworkSourceId)   \
  ((This)->lpVtbl->get_NetworkSourceIdString(This, ppNetworkSourceId))

#define IContactAggregationLink_put_NetworkSourceIdString(This,                \
                                                          pNetworkSourceId)    \
  ((This)->lpVtbl->put_NetworkSourceIdString(This, pNetworkSourceId))
...
#define IContactAggregationLink_get_ServerPersonBaseline(This,                 \
                                                         ppServerPersonId)     \
  ((This)->lpVtbl->get_ServerPersonBaseline(This, ppServerPersonId))

#define IContactAggregationLink_put_ServerPersonBaseline(This,                 \
                                                         pServerPersonId)      \
...
public:
  virtual HRESULT STDMETHODCALLTYPE FindFirst(
      /* [retval][out] */ __RPC__deref_out_opt IContactAggregationLink *
      *ppServerContactLink) = 0;
  ...
  virtual HRESULT STDMETHODCALLTYPE FindFirstByRemoteId(
      ...
      /* [retval][out] */
      __RPC__deref_out_opt IContactAggregationLink **ppServerContactLink) = 0;
...
#define IContactAggregationLinkCollection_QueryInterface(This, riid,           \
                                                         ppvObject)            \
  ((This)->lpVtbl->QueryInterface(This, riid, ppvObject))
...
#define IContactAggregationLinkCollection_FindFirstByRemoteId(                 \
    This, pSourceType, pAccountId, pRemoteId, ppServerContactLink)             \
  ((This)->lpVtbl->FindFirstByRemoteId(This, pSourceType, pAccountId,          \
                                       pRemoteId, ppServerContactLink))
...
public:
  ...
  virtual /* [propget] */ HRESULT STDMETHODCALLTYPE get_LinkedAggregateId(
      /* [retval][out] */ __RPC__deref_out_opt LPWSTR *
      ppLinkedAggregateId) = 0;
...
#define IContactAggregationServerPerson_get_FavoriteOrder(This,                \
                                                          pFavoriteOrder)      \
  ((This)->lpVtbl->get_FavoriteOrder(This, pFavoriteOrder))
...
#define IContactAggregationServerPerson_get_FavoriteOrderBaseline(             \
    This, pFavoriteOrder)                                                      \
  ((This)->lpVtbl->get_FavoriteOrderBaseline(This, pFavoriteOrder))

#define IContactAggregationServerPerson_put_FavoriteOrderBaseline(             \
    This, favoriteOrder)                                                       \
...
#define IContactAggregationServerPerson_get_LinkedAggregateId(                 \
    This, ppLinkedAggregateId)                                                 \
  ((This)->lpVtbl->get_LinkedAggregateId(This, ppLinkedAggregateId))

#define IContactAggregationServerPerson_put_LinkedAggregateId(                 \
    This, pLinkedAggregateId)                                                  \
...
public:
  virtual HRESULT STDMETHODCALLTYPE FindFirst(
      /* [retval][out] */ __RPC__deref_out_opt IContactAggregationServerPerson *
      *ppServerPerson) = 0;
...
typedef struct IContactAggregationServerPersonCollectionVtbl {
  ...
  DECLSPEC_XFGVIRT(IContactAggregationServerPersonCollection,
                   FindFirstByServerId)
...
#define IContactAggregationServerPersonCollection_QueryInterface(This, riid,   \
                                                                 ppvObject)    \
  ((This)->lpVtbl->QueryInterface(This, riid, ppvObject))
...
#define IContactAggregationServerPersonCollection_FindFirst(This,              \
                                                            ppServerPerson)    \
  ((This)->lpVtbl->FindFirst(This, ppServerPerson))

#define IContactAggregationServerPersonCollection_FindFirstByServerId(         \
    This, pServerId, ppServerPerson)                                           \
  ((This)->lpVtbl->FindFirstByServerId(This, pServerId, ppServerPerson))

#define IContactAggregationServerPersonCollection_FindFirstByAggregateId(      \
    This, pAggregateId, ppServerPerson)                                        \
  ((This)->lpVtbl->FindFirstByAggregateId(This, pAggregateId, ppServerPerson))

#define IContactAggregationServerPersonCollection_FindFirstByLinkedAggregateId( \
    This, pAggregateId, ppServerPerson)                                         \
  ((This)->lpVtbl->FindFirstByLinkedAggregateId(This, pAggregateId,             \
                                                ppServerPerson))

#define IContactAggregationServerPersonCollection_FindNext(This,               \
                                                           ppServerPerson)     \
