...
public:
  virtual HRESULT STDMETHODCALLTYPE CreateForWindow(
      ...
      /* [iid_is][retval][out] */
      __RPC__deref_out_opt void **holographicSpace) = 0;
};
...
typedef struct IHolographicSpaceInteropVtbl {
  ...
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IHolographicSpaceInterop *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IHolographicSpaceInterop *This);
...
#define IHolographicSpaceInterop_CreateForWindow(This, window, riid,           \
                                                 holographicSpace)             \
