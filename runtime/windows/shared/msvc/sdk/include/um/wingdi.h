...
#define NOMIRRORBITMAP                                                         \
  (DWORD)0x80000000                  /* Do not Mirror the bitmap in this call */
...
typedef struct tagNEWTEXTMETRICA {
  ...
  UINT ntmCellHeight;
  UINT ntmAvgWidth;
} NEWTEXTMETRICA, *PNEWTEXTMETRICA, NEAR *NPNEWTEXTMETRICA,
    FAR *LPNEWTEXTMETRICA;
typedef struct tagNEWTEXTMETRICW {
  ...
  UINT ntmCellHeight;
  UINT ntmAvgWidth;
} NEWTEXTMETRICW, *PNEWTEXTMETRICW, NEAR *NPNEWTEXTMETRICW,
    FAR *LPNEWTEXTMETRICW;
#ifdef UNICODE
...
#define TC_SF_X_YINDEP                                                         \
  0x00000020                     /* Can do ScaleFreedom      X_YINDEPENDENT    \
                                  */
...
#define DISPLAYCONFIG_MAXPATH                                                  \
  1024 // Maximum display path in system.
  ...
  union {
    struct {
      UINT32 advancedColorSupported
          : 1;                         // A type of advanced color is supported
      ...
      UINT32 advancedColorForceDisabled
          : 1; // Advanced color is force disabled due to system/OS policy
      UINT32 reserved : 28;
    } DUMMYSTRUCTNAME;
...
typedef enum _DISPLAYCONFIG_ADVANCED_COLOR_MODE {
  DISPLAYCONFIG_ADVANCED_COLOR_MODE_SDR, // RGB888 composition, display-referred
                                         // color, display-referred luminance
  DISPLAYCONFIG_ADVANCED_COLOR_MODE_WCG, // Advanced color (FP16 scRGB
                                         // composition), scene-referred color,
                                         // display-referred luminance
  DISPLAYCONFIG_ADVANCED_COLOR_MODE_HDR, // Advanced color (FP16 scRGB
                                         // composition), scene-referred color,
...
typedef struct _DISPLAYCONFIG_GET_ADVANCED_COLOR_INFO_2 {
  ...
  union {
    struct {
      UINT32 advancedColorSupported
          : 1; // A type of advanced color is supported
      UINT32 advancedColorActive
          : 1; // A type of advanced color is active (see currentColorMode for
               // the specific advanced color mode)
      UINT32 reserved1 : 1;
      UINT32 advancedColorLimitedByPolicy
          : 1; // System/OS policy is limiting advanced color options (see
               // currentColorMode for the current mode)

      UINT32 highDynamicRangeSupported : 1; // HDR is supported
      UINT32 highDynamicRangeUserEnabled
          : 1; // HDR is enabled by the user (but may not be active)

      UINT32 wideColorSupported : 1;   // Wide color gamut is supported
      UINT32 wideColorUserEnabled : 1; // Wide color gamut is enabled by the
                                       // user (but may not be active)
  ...
  DISPLAYCONFIG_ADVANCED_COLOR_MODE
  activeColorMode; // The active color mode for this monitor
...
typedef struct _OUTLINETEXTMETRICA {
  ...
  PSTR otmpStyleName;
  PSTR otmpFullName;
} OUTLINETEXTMETRICA, *POUTLINETEXTMETRICA, NEAR *NPOUTLINETEXTMETRICA,
    FAR *LPOUTLINETEXTMETRICA;
typedef struct _OUTLINETEXTMETRICW {
  ...
  PSTR otmpStyleName;
  PSTR otmpFullName;
} OUTLINETEXTMETRICW, *POUTLINETEXTMETRICW, NEAR *NPOUTLINETEXTMETRICW,
    FAR *LPOUTLINETEXTMETRICW;
#ifdef UNICODE
...
WINGDIAPI BOOL WINAPI AnimatePalette(_In_ HPALETTE hPal, _In_ UINT iStartIndex,
                                     _In_ UINT cEntries,
                                     _In_reads_(cEntries)
                                         CONST PALETTEENTRY *ppe);
WINGDIAPI BOOL WINAPI Arc(_In_ HDC hdc, _In_ int x1, _In_ int y1, _In_ int x2,
                          _In_ int y2, _In_ int x3, _In_ int y3, _In_ int x4,
                          _In_ int y4);
WINGDIAPI BOOL WINAPI BitBlt(_In_ HDC hdc, _In_ int x, _In_ int y, _In_ int cx,
                             _In_ int cy, _In_opt_ HDC hdcSrc, _In_ int x1,
                             _In_ int y1, _In_ DWORD rop);
WINGDIAPI BOOL WINAPI CancelDC(_In_ HDC hdc);
WINGDIAPI BOOL WINAPI Chord(_In_ HDC hdc, _In_ int x1, _In_ int y1, _In_ int x2,
                            _In_ int y2, _In_ int x3, _In_ int y3, _In_ int x4,
                            _In_ int y4);
WINGDIAPI int WINAPI ChoosePixelFormat(_In_ HDC hdc,
                                       _In_ CONST PIXELFORMATDESCRIPTOR *ppfd);
WINGDIAPI HMETAFILE WINAPI CloseMetaFile(_In_ HDC hdc);
WINGDIAPI int WINAPI CombineRgn(_In_opt_ HRGN hrgnDst, _In_opt_ HRGN hrgnSrc1,
                                _In_opt_ HRGN hrgnSrc2, _In_ int iMode);
...
#endif // !UNICODE
WINGDIAPI HBITMAP WINAPI CreateBitmap(_In_ int nWidth, _In_ int nHeight,
                                      _In_ UINT nPlanes, _In_ UINT nBitCount,
                                      _In_opt_ CONST VOID *lpBits);
...
WINGDIAPI HBITMAP WINAPI CreateCompatibleBitmap(_In_ HDC hdc, _In_ int cx,
                                                _In_ int cy);
WINGDIAPI HBITMAP WINAPI CreateDiscardableBitmap(_In_ HDC hdc, _In_ int cx,
                                                 _In_ int cy);
WINGDIAPI HDC WINAPI CreateCompatibleDC(_In_opt_ HDC hdc);
WINGDIAPI HDC WINAPI CreateDCA(_In_opt_ LPCSTR pwszDriver,
                               _In_opt_ LPCSTR pwszDevice,
                               _In_opt_ LPCSTR pszPort,
                               _In_opt_ CONST DEVMODEA *pdm);
WINGDIAPI HDC WINAPI CreateDCW(_In_opt_ LPCWSTR pwszDriver,
...
#endif // !UNICODE
WINGDIAPI HBITMAP WINAPI CreateDIBitmap(_In_ HDC hdc,
...
WINGDIAPI HBRUSH WINAPI CreateDIBPatternBrushPt(_In_ CONST VOID *lpPackedDIB,
                                                _In_ UINT iUsage);
WINGDIAPI HRGN WINAPI CreateEllipticRgn(_In_ int x1, _In_ int y1, _In_ int x2,
                                        _In_ int y2);
...
WINGDIAPI HFONT WINAPI CreateFontA(
    _In_ int cHeight, _In_ int cWidth, _In_ int cEscapement,
    _In_ int cOrientation, _In_ int cWeight, _In_ DWORD bItalic,
    _In_ DWORD bUnderline, _In_ DWORD bStrikeOut, _In_ DWORD iCharSet,
    _In_ DWORD iOutPrecision, _In_ DWORD iClipPrecision, _In_ DWORD iQuality,
    _In_ DWORD iPitchAndFamily, _In_opt_ LPCSTR pszFaceName);
WINGDIAPI HFONT WINAPI CreateFontW(
    _In_ int cHeight, _In_ int cWidth, _In_ int cEscapement,
    _In_ int cOrientation, _In_ int cWeight, _In_ DWORD bItalic,
    _In_ DWORD bUnderline, _In_ DWORD bStrikeOut, _In_ DWORD iCharSet,
    _In_ DWORD iOutPrecision, _In_ DWORD iClipPrecision, _In_ DWORD iQuality,
    _In_ DWORD iPitchAndFamily, _In_opt_ LPCWSTR pszFaceName);
#ifdef UNICODE
...
WINGDIAPI HDC WINAPI CreateICA(_In_opt_ LPCSTR pszDriver,
                               _In_opt_ LPCSTR pszDevice,
                               _In_opt_ LPCSTR pszPort,
                               _In_opt_ CONST DEVMODEA *pdm);
WINGDIAPI HDC WINAPI CreateICW(_In_opt_ LPCWSTR pszDriver,
...
#endif // !UNICODE
WINGDIAPI HPALETTE WINAPI CreatePalette(_In_reads_(_Inexpressible_(
    2 * sizeof(WORD) + plpal->palNumEntries * sizeof(PALETTEENTRY)))
                                            CONST LOGPALETTE *plpal);
WINGDIAPI HPEN WINAPI CreatePen(_In_ int iStyle, _In_ int cWidth,
                                _In_ COLORREF color);
...
WINGDIAPI HRGN WINAPI CreatePolyPolygonRgn(_In_ CONST POINT *pptl,
                                           ...
                                           _In_ int cPoly, _In_ int iMode);
WINGDIAPI HBRUSH WINAPI CreatePatternBrush(_In_ HBITMAP hbm);
WINGDIAPI HRGN WINAPI CreateRectRgn(_In_ int x1, _In_ int y1, _In_ int x2,
                                    _In_ int y2);
WINGDIAPI HRGN WINAPI CreateRectRgnIndirect(_In_ CONST RECT *lprect);
WINGDIAPI HRGN WINAPI CreateRoundRectRgn(_In_ int x1, _In_ int y1, _In_ int x2,
                                         _In_ int y2, _In_ int w, _In_ int h);
WINGDIAPI BOOL WINAPI CreateScalableFontResourceA(_In_ DWORD fdwHidden,
                                                  _In_ LPCSTR lpszFont,
                                                  _In_ LPCSTR lpszFile,
                                                  _In_opt_ LPCSTR lpszPath);
WINGDIAPI BOOL WINAPI CreateScalableFontResourceW(_In_ DWORD fdwHidden,
                                                  _In_ LPCWSTR lpszFont,
                                                  _In_ LPCWSTR lpszFile,
                                                  _In_opt_ LPCWSTR lpszPath);
#ifdef UNICODE
...
WINGDIAPI int WINAPI DescribePixelFormat(_In_ HDC hdc, _In_ int iPixelFormat,
                                         _In_ UINT nBytes,
...
WINSPOOLAPI
int WINAPI DeviceCapabilitiesA(_In_ LPCSTR pDevice, _In_opt_ LPCSTR pPort,
                               _In_ WORD fwCapability,
                               _Out_writes_opt_(_Inexpressible_(1))
                                   LPSTR pOutput,
                               _In_opt_ CONST DEVMODEA *pDevMode);
WINSPOOLAPI
int WINAPI DeviceCapabilitiesW(_In_ LPCWSTR pDevice, _In_opt_ LPCWSTR pPort,
                               _In_ WORD fwCapability,
                               _Out_writes_opt_(_Inexpressible_(1))
                                   LPWSTR pOutput,
...
WINGDIAPI int WINAPI DrawEscape(_In_ HDC hdc, _In_ int iEscape, _In_ int cjIn,
                                _In_reads_bytes_opt_(cjIn) LPCSTR lpIn);

WINGDIAPI BOOL WINAPI Ellipse(_In_ HDC hdc, _In_ int left, _In_ int top,
                              _In_ int right, _In_ int bottom);

#if (WINVER >= 0x0400)
WINGDIAPI int WINAPI EnumFontFamiliesExA(_In_ HDC hdc,
                                         _In_ LPLOGFONTA lpLogfont,
                                         _In_ FONTENUMPROCA lpProc,
                                         _In_ LPARAM lParam,
                                         _In_ DWORD dwFlags);
WINGDIAPI int WINAPI EnumFontFamiliesExW(_In_ HDC hdc,
...
WINGDIAPI int WINAPI EnumFontFamiliesA(_In_ HDC hdc, _In_opt_ LPCSTR lpLogfont,
                                       _In_ FONTENUMPROCA lpProc,
                                       _In_ LPARAM lParam);
WINGDIAPI int WINAPI EnumFontFamiliesW(_In_ HDC hdc, _In_opt_ LPCWSTR lpLogfont,
                                       _In_ FONTENUMPROCW lpProc,
                                       _In_ LPARAM lParam);
#ifdef UNICODE
...
#endif // !UNICODE
WINGDIAPI int WINAPI EnumFontsA(_In_ HDC hdc, _In_opt_ LPCSTR lpLogfont,
                                _In_ FONTENUMPROCA lpProc, _In_ LPARAM lParam);
WINGDIAPI int WINAPI EnumFontsW(_In_ HDC hdc, _In_opt_ LPCWSTR lpLogfont,
                                _In_ FONTENUMPROCW lpProc, _In_ LPARAM lParam);
#ifdef UNICODE
...
#ifdef STRICT
WINGDIAPI int WINAPI EnumObjects(_In_ HDC hdc, _In_ int nType,
                                 _In_ GOBJENUMPROC lpFunc, _In_ LPARAM lParam);
#else
WINGDIAPI int WINAPI EnumObjects(_In_ HDC hdc, _In_ int nType,
                                 _In_ GOBJENUMPROC lpFunc, _In_ LPVOID lParam);
#endif

WINGDIAPI BOOL WINAPI EqualRgn(_In_ HRGN hrgn1, _In_ HRGN hrgn2);
WINGDIAPI int WINAPI Escape(_In_ HDC hdc, _In_ int iEscape, _In_ int cjIn,
                            _In_reads_bytes_opt_(cjIn) LPCSTR pvIn,
                            _Out_opt_ LPVOID pvOut);
WINGDIAPI int WINAPI ExtEscape(_In_ HDC hdc, _In_ int iEscape, _In_ int cjInput,
                               _In_reads_bytes_opt_(cjInput) LPCSTR lpInData,
                               _In_ int cjOutput,
                               _Out_writes_bytes_opt_(cjOutput)
                                   LPSTR lpOutData);
WINGDIAPI int WINAPI ExcludeClipRect(_In_ HDC hdc, _In_ int left, _In_ int top,
                                     _In_ int right, _In_ int bottom);
WINGDIAPI HRGN WINAPI ExtCreateRegion(_In_opt_ CONST XFORM *lpx,
                                      _In_ DWORD nCount,
                                      _In_reads_bytes_(nCount)
                                          CONST RGNDATA *lpData);
WINGDIAPI BOOL WINAPI ExtFloodFill(_In_ HDC hdc, _In_ int x, _In_ int y,
                                   _In_ COLORREF color, _In_ UINT type);
WINGDIAPI BOOL WINAPI FillRgn(_In_ HDC hdc, _In_ HRGN hrgn, _In_ HBRUSH hbr);
WINGDIAPI BOOL WINAPI FloodFill(_In_ HDC hdc, _In_ int x, _In_ int y,
                                _In_ COLORREF color);
WINGDIAPI BOOL WINAPI FrameRgn(_In_ HDC hdc, _In_ HRGN hrgn, _In_ HBRUSH hbr,
...
WINGDIAPI
int WINAPI GetBkMode(_In_ HDC hdc);

WINGDIAPI
LONG WINAPI GetBitmapBits(_In_ HBITMAP hbit, _In_ LONG cb,
                          _Out_writes_bytes_(cb) LPVOID lpvBits);

WINGDIAPI BOOL WINAPI GetBitmapDimensionEx(_In_ HBITMAP hbit,
                                           _Out_ LPSIZE lpsize);
WINGDIAPI UINT WINAPI GetBoundsRect(_In_ HDC hdc, _Out_ LPRECT lprect,
                                    _In_ UINT flags);

WINGDIAPI BOOL WINAPI GetBrushOrgEx(_In_ HDC hdc, _Out_ LPPOINT lppt);

WINGDIAPI BOOL WINAPI GetCharWidthA(_In_ HDC hdc, _In_ UINT iFirst,
                                    _In_ UINT iLast,
                                    _Out_writes_(iLast + 1 - iFirst)
                                        LPINT lpBuffer);
WINGDIAPI BOOL WINAPI GetCharWidthW(_In_ HDC hdc, _In_ UINT iFirst,
                                    _In_ UINT iLast,
                                    _Out_writes_(iLast + 1 - iFirst)
                                        LPINT lpBuffer);
#ifdef UNICODE
...
#endif // !UNICODE
WINGDIAPI BOOL WINAPI GetCharWidth32A(_In_ HDC hdc, _In_ UINT iFirst,
                                      _In_ UINT iLast,
                                      _Out_writes_(iLast + 1 - iFirst)
                                          LPINT lpBuffer);
WINGDIAPI BOOL WINAPI GetCharWidth32W(_In_ HDC hdc, _In_ UINT iFirst,
                                      _In_ UINT iLast,
                                      _Out_writes_(iLast + 1 - iFirst)
                                          LPINT lpBuffer);
#ifdef UNICODE
...
#endif // !UNICODE
WINGDIAPI BOOL APIENTRY GetCharWidthFloatA(_In_ HDC hdc, _In_ UINT iFirst,
                                           _In_ UINT iLast,
                                           _Out_writes_(iLast + 1 - iFirst)
                                               PFLOAT lpBuffer);
WINGDIAPI BOOL APIENTRY GetCharWidthFloatW(_In_ HDC hdc, _In_ UINT iFirst,
                                           _In_ UINT iLast,
                                           _Out_writes_(iLast + 1 - iFirst)
                                               PFLOAT lpBuffer);
#ifdef UNICODE
...
WINGDIAPI BOOL APIENTRY GetCharABCWidthsA(_In_ HDC hdc, _In_ UINT wFirst,
                                          _In_ UINT wLast,
                                          _Out_writes_(wLast - wFirst + 1)
                                              LPABC lpABC);
WINGDIAPI BOOL APIENTRY GetCharABCWidthsW(_In_ HDC hdc, _In_ UINT wFirst,
                                          _In_ UINT wLast,
                                          _Out_writes_(wLast - wFirst + 1)
                                              LPABC lpABC);
#ifdef UNICODE
...
WINGDIAPI BOOL APIENTRY GetCharABCWidthsFloatA(_In_ HDC hdc, _In_ UINT iFirst,
                                               _In_ UINT iLast,
                                               _Out_writes_(iLast + 1 - iFirst)
                                                   LPABCFLOAT lpABC);
WINGDIAPI BOOL APIENTRY GetCharABCWidthsFloatW(_In_ HDC hdc, _In_ UINT iFirst,
                                               _In_ UINT iLast,
                                               _Out_writes_(iLast + 1 - iFirst)
                                                   LPABCFLOAT lpABC);
#ifdef UNICODE
...
WINGDIAPI int WINAPI GetDIBits(
    _In_ HDC hdc, _In_ HBITMAP hbm, _In_ UINT start, _In_ UINT cLines,
    _Out_opt_ LPVOID lpvBits,
    _At_((LPBITMAPINFOHEADER)lpbmi, _Inout_) LPBITMAPINFO lpbmi,
    _In_ UINT
        usage); // SAL actual size of lpbmi is computed from structure elements

_Success_(return != GDI_ERROR) WINGDIAPI DWORD WINAPI
    GetFontData(_In_ HDC hdc, _In_ DWORD dwTable, _In_ DWORD dwOffset,
                _Out_writes_bytes_to_opt_(cjBuffer, return) PVOID pvBuffer,
                _In_ DWORD cjBuffer);

WINGDIAPI DWORD WINAPI GetGlyphOutlineA(
    _In_ HDC hdc, _In_ UINT uChar, _In_ UINT fuFormat,
    _Out_ LPGLYPHMETRICS lpgm, _In_ DWORD cjBuffer,
    _Out_writes_bytes_opt_(cjBuffer) LPVOID pvBuffer, _In_ CONST MAT2 *lpmat2);
...
WINGDIAPI UINT WINAPI GetMetaFileBitsEx(_In_ HMETAFILE hMF, _In_ UINT cbBuffer,
                                        _Out_writes_bytes_opt_(cbBuffer)
                                            LPVOID lpData);
...
WINGDIAPI UINT WINAPI GetNearestPaletteIndex(_In_ HPALETTE h,
                                             _In_ COLORREF color);
_Post_satisfies_((return == 0) ||
                 (return >= GDI_MIN_OBJ_TYPE &&
                         return <= GDI_MAX_OBJ_TYPE)) WINGDIAPI DWORD WINAPI
    GetObjectType(_In_ HGDIOBJ h);

#ifndef NOTEXTMETRIC

WINGDIAPI UINT APIENTRY GetOutlineTextMetricsA(_In_ HDC hdc, _In_ UINT cjCopy,
                                               _Out_writes_bytes_opt_(cjCopy)
                                                   LPOUTLINETEXTMETRICA potm);
WINGDIAPI UINT APIENTRY GetOutlineTextMetricsW(_In_ HDC hdc, _In_ UINT cjCopy,
                                               _Out_writes_bytes_opt_(cjCopy)
...
_Ret_range_(0, cEntries) WINGDIAPI UINT WINAPI
    GetPaletteEntries(_In_ HPALETTE hpal, _In_ UINT iStart, _In_ UINT cEntries,
                      _Out_writes_to_opt_(cEntries, return)
...
WINGDIAPI BOOL WINAPI GetRasterizerCaps(_Out_writes_bytes_(cjBytes)
                                            LPRASTERIZER_STATUS lpraststat,
                                        _In_ UINT cjBytes);

WINGDIAPI int WINAPI GetRandomRgn(_In_ HDC hdc, _In_ HRGN hrgn, _In_ INT i);
WINGDIAPI DWORD WINAPI GetRegionData(_In_ HRGN hrgn, _In_ DWORD nCount,
                                     _Out_writes_bytes_to_opt_(nCount, return)
                                         LPRGNDATA lpRgnData);
...
WINGDIAPI
UINT WINAPI GetSystemPaletteEntries(_In_ HDC hdc, _In_ UINT iStart,
                                    _In_ UINT cEntries,
                                    _Out_writes_opt_(cEntries)
                                        LPPALETTEENTRY pPalEntries);
...
WINGDIAPI
BOOL APIENTRY GetTextExtentPointA(_In_ HDC hdc, _In_reads_(c) LPCSTR lpString,
                                  _In_ int c, _Out_ LPSIZE lpsz);
WINGDIAPI
BOOL APIENTRY GetTextExtentPointW(_In_ HDC hdc, _In_reads_(c) LPCWSTR lpString,
                                  _In_ int c, _Out_ LPSIZE lpsz);
#ifdef UNICODE
...
WINGDIAPI
BOOL APIENTRY GetTextExtentPoint32A(_In_ HDC hdc, _In_reads_(c) LPCSTR lpString,
                                    _In_ int c, _Out_ LPSIZE psizl);
WINGDIAPI
BOOL APIENTRY GetTextExtentPoint32W(_In_ HDC hdc,
                                    _In_reads_(c) LPCWSTR lpString, _In_ int c,
                                    _Out_ LPSIZE psizl);
#ifdef UNICODE
...
BOOL APIENTRY GetTextExtentExPointA(
    _In_ HDC hdc, _In_reads_(cchString) LPCSTR lpszString, _In_ int cchString,
    _In_ int nMaxExtent, _Out_opt_ LPINT lpnFit,
    _Out_writes_to_opt_(cchString, *lpnFit) LPINT lpnDx, _Out_ LPSIZE lpSize);
WINGDIAPI
BOOL APIENTRY GetTextExtentExPointW(
    _In_ HDC hdc, _In_reads_(cchString) LPCWSTR lpszString, _In_ int cchString,
    _In_ int nMaxExtent, _Out_opt_ LPINT lpnFit,
    _Out_writes_to_opt_(cchString, *lpnFit) LPINT lpnDx, _Out_ LPSIZE lpSize);
#ifdef UNICODE
...
WINGDIAPI int WINAPI GetTextCharsetInfo(_In_ HDC hdc,
                                        _Out_opt_ LPFONTSIGNATURE lpSig,
                                        _In_ DWORD dwFlags);
WINGDIAPI BOOL WINAPI TranslateCharsetInfo(_Inout_ DWORD FAR *lpSrc,
...
WINGDIAPI DWORD WINAPI GetCharacterPlacementA(
    _In_ HDC hdc, _In_reads_(nCount) LPCSTR lpString, _In_ int nCount,
    _In_ int nMexExtent, _Inout_ LPGCP_RESULTSA lpResults, _In_ DWORD dwFlags);
WINGDIAPI DWORD WINAPI GetCharacterPlacementW(
    _In_ HDC hdc, _In_reads_(nCount) LPCWSTR lpString, _In_ int nCount,
    _In_ int nMexExtent, _Inout_ LPGCP_RESULTSW lpResults, _In_ DWORD dwFlags);
#ifdef UNICODE
...
WINGDIAPI DWORD WINAPI GetFontUnicodeRanges(_In_ HDC hdc,
                                            _Out_opt_ LPGLYPHSET lpgs);
WINGDIAPI DWORD WINAPI GetGlyphIndicesA(_In_ HDC hdc,
                                        _In_reads_(c) LPCSTR lpstr, _In_ int c,
                                        _Out_writes_(c) LPWORD pgi,
                                        _In_ DWORD fl);
WINGDIAPI DWORD WINAPI GetGlyphIndicesW(_In_ HDC hdc,
                                        _In_reads_(c) LPCWSTR lpstr, _In_ int c,
                                        _Out_writes_(c) LPWORD pgi,
                                        _In_ DWORD fl);
#ifdef UNICODE
...
#endif // !UNICODE
WINGDIAPI BOOL WINAPI GetTextExtentPointI(_In_ HDC hdc,
                                          _In_reads_(cgi) LPWORD pgiIn,
                                          _In_ int cgi, _Out_ LPSIZE psize);
WINGDIAPI BOOL WINAPI GetTextExtentExPointI(
    _In_ HDC hdc, _In_reads_(cwchString) LPWORD lpwszString,
    _In_ int cwchString, _In_ int nMaxExtent, _Out_opt_ LPINT lpnFit,
    _Out_writes_to_opt_(cwchString, *lpnFit) LPINT lpnDx, _Out_ LPSIZE lpSize);

WINGDIAPI BOOL WINAPI GetCharWidthI(_In_ HDC hdc, _In_ UINT giFirst,
                                    _In_ UINT cgi,
                                    _In_reads_opt_(cgi) LPWORD pgi,
                                    _Out_writes_(cgi) LPINT piWidths);

WINGDIAPI BOOL WINAPI GetCharABCWidthsI(_In_ HDC hdc, _In_ UINT giFirst,
                                        _In_ UINT cgi,
                                        _In_reads_opt_(cgi) LPWORD pgi,
...
WINGDIAPI int WINAPI AddFontResourceExA(_In_ LPCSTR name, _In_ DWORD fl,
                                        _Reserved_ PVOID res);
WINGDIAPI int WINAPI AddFontResourceExW(_In_ LPCWSTR name, _In_ DWORD fl,
                                        _Reserved_ PVOID res);
#ifdef UNICODE
...
#endif // !UNICODE
WINGDIAPI BOOL WINAPI RemoveFontResourceExA(_In_ LPCSTR name, _In_ DWORD fl,
                                            _Reserved_ PVOID pdv);
WINGDIAPI BOOL WINAPI RemoveFontResourceExW(_In_ LPCWSTR name, _In_ DWORD fl,
                                            _Reserved_ PVOID pdv);
#ifdef UNICODE
...
#endif // !UNICODE
WINGDIAPI HANDLE WINAPI AddFontMemResourceEx(_In_reads_bytes_(cjSize)
                                                 PVOID pFileView,
                                             _In_ DWORD cjSize,
...
WINGDIAPI int WINAPI IntersectClipRect(_In_ HDC hdc, _In_ int left,
                                       _In_ int top, _In_ int right,
                                       _In_ int bottom);
WINGDIAPI BOOL WINAPI InvertRgn(_In_ HDC hdc, _In_ HRGN hrgn);
WINGDIAPI BOOL WINAPI LineDDA(_In_ int xStart, _In_ int yStart, _In_ int xEnd,
                              _In_ int yEnd, _In_ LINEDDAPROC lpProc,
                              _In_opt_ LPARAM data);
WINGDIAPI BOOL WINAPI LineTo(_In_ HDC hdc, _In_ int x, _In_ int y);
WINGDIAPI BOOL WINAPI MaskBlt(_In_ HDC hdcDest, _In_ int xDest, _In_ int yDest,
                              _In_ int width, _In_ int height, _In_ HDC hdcSrc,
                              _In_ int xSrc, _In_ int ySrc,
                              _In_ HBITMAP hbmMask, _In_ int xMask,
                              _In_ int yMask, _In_ DWORD rop);
WINGDIAPI BOOL WINAPI PlgBlt(_In_ HDC hdcDest,
                             _In_reads_(3) CONST POINT *lpPoint,
                             _In_ HDC hdcSrc, _In_ int xSrc, _In_ int ySrc,
                             _In_ int width, _In_ int height,
                             _In_opt_ HBITMAP hbmMask, _In_ int xMask,
                             _In_ int yMask);
...
WINGDIAPI BOOL WINAPI PatBlt(_In_ HDC hdc, _In_ int x, _In_ int y, _In_ int w,
                             _In_ int h, _In_ DWORD rop);
WINGDIAPI BOOL WINAPI Pie(_In_ HDC hdc, _In_ int left, _In_ int top,
                          _In_ int right, _In_ int bottom, _In_ int xr1,
                          _In_ int yr1, _In_ int xr2, _In_ int yr2);
...
WINGDIAPI BOOL WINAPI PolyPolygon(_In_ HDC hdc, _In_ CONST POINT *apt,
                                  _In_reads_(csz) CONST INT *asz, _In_ int csz);
...
WINGDIAPI BOOL WINAPI Rectangle(_In_ HDC hdc, _In_ int left, _In_ int top,
                                _In_ int right, _In_ int bottom);
...
#endif // !UNICODE
WINGDIAPI BOOL WINAPI RoundRect(_In_ HDC hdc, _In_ int left, _In_ int top,
                                _In_ int right, _In_ int bottom, _In_ int width,
                                _In_ int height);
...
WINGDIAPI int WINAPI ExtSelectClipRgn(_In_ HDC hdc, _In_opt_ HRGN hrgn,
                                      _In_ int mode);
WINGDIAPI int WINAPI SetMetaRgn(_In_ HDC hdc);
WINGDIAPI HGDIOBJ WINAPI SelectObject(_In_ HDC hdc, _In_ HGDIOBJ h);
WINGDIAPI HPALETTE WINAPI SelectPalette(_In_ HDC hdc, _In_ HPALETTE hPal,
                                        _In_ BOOL bForceBkgd);
...
WINGDIAPI
LONG WINAPI SetBitmapBits(_In_ HBITMAP hbm, _In_ DWORD cb,
                          _In_reads_bytes_(cb) CONST VOID *pvBits);

WINGDIAPI UINT WINAPI SetBoundsRect(_In_ HDC hdc, _In_opt_ CONST RECT *lprect,
                                    _In_ UINT flags);
WINGDIAPI int WINAPI SetDIBits(_In_opt_ HDC hdc, _In_ HBITMAP hbm,
                               _In_ UINT start, _In_ UINT cLines,
                               _In_ CONST VOID *lpBits,
                               _In_ CONST BITMAPINFO *lpbmi,
                               _In_ UINT ColorUse);
WINGDIAPI int WINAPI SetDIBitsToDevice(
    _In_ HDC hdc, _In_ int xDest, _In_ int yDest, _In_ DWORD w, _In_ DWORD h,
...
WINGDIAPI HMETAFILE WINAPI SetMetaFileBitsEx(_In_ UINT cbBuffer,
                                             _In_reads_bytes_(cbBuffer)
                                                 CONST BYTE *lpData);
WINGDIAPI UINT WINAPI SetPaletteEntries(_In_ HPALETTE hpal, _In_ UINT iStart,
                                        _In_ UINT cEntries,
                                        _In_reads_(cEntries)
                                            CONST PALETTEENTRY *pPalEntries);
WINGDIAPI COLORREF WINAPI SetPixel(_In_ HDC hdc, _In_ int x, _In_ int y,
                                   _In_ COLORREF color);
WINGDIAPI BOOL WINAPI SetPixelV(_In_ HDC hdc, _In_ int x, _In_ int y,
                                _In_ COLORREF color);
WINGDIAPI BOOL WINAPI SetPixelFormat(_In_ HDC hdc, _In_ int format,
                                     _In_ CONST PIXELFORMATDESCRIPTOR *ppfd);
WINGDIAPI int WINAPI SetPolyFillMode(_In_ HDC hdc, _In_ int mode);
WINGDIAPI BOOL WINAPI StretchBlt(_In_ HDC hdcDest, _In_ int xDest,
                                 _In_ int yDest, _In_ int wDest, _In_ int hDest,
                                 _In_opt_ HDC hdcSrc, _In_ int xSrc,
                                 _In_ int ySrc, _In_ int wSrc, _In_ int hSrc,
                                 _In_ DWORD rop);
WINGDIAPI BOOL WINAPI SetRectRgn(_In_ HRGN hrgn, _In_ int left, _In_ int top,
                                 _In_ int right, _In_ int bottom);
WINGDIAPI int WINAPI StretchDIBits(_In_ HDC hdc, _In_ int xDest, _In_ int yDest,
                                   _In_ int DestWidth, _In_ int DestHeight,
                                   _In_ int xSrc, _In_ int ySrc,
                                   _In_ int SrcWidth, _In_ int SrcHeight,
                                   _In_opt_ CONST VOID *lpBits,
                                   _In_ CONST BITMAPINFO *lpbmi,
                                   _In_ UINT iUsage, _In_ DWORD rop);
...
WINGDIAPI BOOL WINAPI SetTextJustification(_In_ HDC hdc, _In_ int extra,
                                           _In_ int count);
...
typedef HRESULT(WINAPI *DDRAWMARSHCALLBACKMARSHAL)(_In_ HGDIOBJ hGdiObj,
                                                   _In_ LPVOID pGdiRef,
                                                   _Out_ LPVOID *ppDDrawRef);
typedef HRESULT(WINAPI *DDRAWMARSHCALLBACKUNMARSHAL)(_In_ LPVOID pData,
                                                     _Out_ HDC *phdc,
                                                     _Out_ LPVOID *ppDDrawRef);
...
WINGDIAPI BOOL WINAPI GdiRegisterDdraw(_In_ PGDIREGISTERDDRAWPACKET pPacket,
                                       _Out_ GDIMARSHALLOC *ppfnGdiAlloc);

WINGDIAPI ULONG WINAPI GdiMarshalSize(VOID);
WINGDIAPI VOID WINAPI GdiMarshal(DWORD dwProcessIdTo, _In_ HGDIOBJ hGdiObj,
                                 _Inout_ PVOID pData, ULONG ulFlags);
...
WINGDIAPI BOOL WINAPI AlphaBlend(_In_ HDC hdcDest, _In_ int xoriginDest,
                                 _In_ int yoriginDest, _In_ int wDest,
                                 _In_ int hDest, _In_ HDC hdcSrc,
                                 _In_ int xoriginSrc, _In_ int yoriginSrc,
                                 _In_ int wSrc, _In_ int hSrc,
                                 _In_ BLENDFUNCTION ftn);

WINGDIAPI BOOL WINAPI TransparentBlt(_In_ HDC hdcDest, _In_ int xoriginDest,
                                     _In_ int yoriginDest, _In_ int wDest,
                                     _In_ int hDest, _In_ HDC hdcSrc,
                                     _In_ int xoriginSrc, _In_ int yoriginSrc,
                                     _In_ int wSrc, _In_ int hSrc,
...
WINGDIAPI
BOOL WINAPI GradientFill(_In_ HDC hdc, _In_reads_(nVertex) PTRIVERTEX pVertex,
                         _In_ ULONG nVertex, _In_ PVOID pMesh, _In_ ULONG nMesh,
                         _In_ ULONG ulMode);
...
WINGDIAPI BOOL WINAPI GdiAlphaBlend(_In_ HDC hdcDest, _In_ int xoriginDest,
                                    _In_ int yoriginDest, _In_ int wDest,
                                    _In_ int hDest, _In_ HDC hdcSrc,
                                    _In_ int xoriginSrc, _In_ int yoriginSrc,
                                    _In_ int wSrc, _In_ int hSrc,
...
WINGDIAPI BOOL WINAPI GdiTransparentBlt(_In_ HDC hdcDest, _In_ int xoriginDest,
                                        _In_ int yoriginDest, _In_ int wDest,
                                        _In_ int hDest, _In_ HDC hdcSrc,
                                        _In_ int xoriginSrc,
                                        _In_ int yoriginSrc, _In_ int wSrc,
                                        _In_ int hSrc, _In_ UINT crTransparent);
...
WINGDIAPI BOOL WINAPI GdiGradientFill(_In_ HDC hdc,
                                      ...
                                      _In_ ULONG nCount, _In_ ULONG ulMode);
...
typedef int(CALLBACK *MFENUMPROC)(_In_ HDC hdc,
                                  _In_reads_(nObj) HANDLETABLE FAR *lpht,
                                  _In_ METARECORD FAR *lpMR, _In_ int nObj,
                                  _In_opt_ LPARAM param);
WINGDIAPI BOOL WINAPI EnumMetaFile(_In_ HDC hdc, _In_ HMETAFILE hmf,
                                   _In_ MFENUMPROC proc, _In_opt_ LPARAM param);

typedef int(CALLBACK *ENHMFENUMPROC)(_In_ HDC hdc,
                                     _In_reads_(nHandles) HANDLETABLE FAR *lpht,
                                     _In_ CONST ENHMETARECORD *lpmr,
                                     _In_ int nHandles, _In_opt_ LPARAM data);

// Enhanced Metafile Function Declarations

WINGDIAPI HENHMETAFILE WINAPI CloseEnhMetaFile(_In_ HDC hdc);
WINGDIAPI HENHMETAFILE WINAPI CopyEnhMetaFileA(_In_ HENHMETAFILE hEnh,
                                               _In_opt_ LPCSTR lpFileName);
WINGDIAPI HENHMETAFILE WINAPI CopyEnhMetaFileW(_In_ HENHMETAFILE hEnh,
...
#endif // !UNICODE
WINGDIAPI HDC WINAPI CreateEnhMetaFileA(_In_opt_ HDC hdc,
                                        _In_opt_ LPCSTR lpFilename,
                                        _In_opt_ CONST RECT *lprc,
                                        _In_opt_ LPCSTR lpDesc);
WINGDIAPI HDC WINAPI CreateEnhMetaFileW(_In_opt_ HDC hdc,
                                        _In_opt_ LPCWSTR lpFilename,
                                        _In_opt_ CONST RECT *lprc,
                                        _In_opt_ LPCWSTR lpDesc);
#ifdef UNICODE
...
WINGDIAPI BOOL WINAPI EnumEnhMetaFile(_In_opt_ HDC hdc, _In_ HENHMETAFILE hmf,
                                      _In_ ENHMFENUMPROC proc,
...
WINGDIAPI UINT WINAPI GetWinMetaFileBits(_In_ HENHMETAFILE hemf,
                                         _In_ UINT cbData16,
                                         _Out_writes_bytes_opt_(cbData16)
                                             LPBYTE pData16,
                                         _In_ INT iMapMode, _In_ HDC hdcRef);
WINGDIAPI BOOL WINAPI PlayEnhMetaFile(_In_ HDC hdc, _In_ HENHMETAFILE hmf,
...
WINGDIAPI HENHMETAFILE WINAPI SetWinMetaFileBits(
    _In_ UINT nSize, _In_reads_bytes_(nSize) CONST BYTE *lpMeta16Data,
    _In_opt_ HDC hdcRef, _In_opt_ CONST METAFILEPICT *lpMFP);
WINGDIAPI BOOL WINAPI GdiComment(_In_ HDC hdc, _In_ UINT nSize,
...
WINGDIAPI BOOL WINAPI AngleArc(_In_ HDC hdc, _In_ int x, _In_ int y,
                               _In_ DWORD r, _In_ FLOAT StartAngle,
                               _In_ FLOAT SweepAngle);
WINGDIAPI BOOL WINAPI PolyPolyline(_In_ HDC hdc, _In_ CONST POINT *apt,
...
WINGDIAPI BOOL WINAPI ModifyWorldTransform(_In_ HDC hdc,
                                           _In_opt_ CONST XFORM *lpxf,
                                           _In_ DWORD mode);
WINGDIAPI BOOL WINAPI CombineTransform(_Out_ LPXFORM lpxfOut,
                                       _In_ CONST XFORM *lpxf1,
                                       _In_ CONST XFORM *lpxf2);
...
WINGDIAPI _Success_(return != NULL) HBITMAP WINAPI CreateDIBSection(
    _In_opt_ HDC hdc, _In_ CONST BITMAPINFO *pbmi, _In_ UINT usage,
    _When_((pbmi->bmiHeader.biBitCount != 0),
           _Outptr_result_bytebuffer_(
               _Inexpressible_(GDI_DIBSIZE((pbmi->bmiHeader)))))
        _When_((pbmi->bmiHeader.biBitCount == 0),
               _Outptr_result_bytebuffer_((pbmi->bmiHeader).biSizeImage))
            VOID **ppvBits,
    _In_opt_ HANDLE hSection, _In_ DWORD offset);

_Ret_range_(0, cEntries) WINGDIAPI UINT WINAPI
    GetDIBColorTable(_In_ HDC hdc, _In_ UINT iStart, _In_ UINT cEntries,
                     _Out_writes_to_(cEntries, return) RGBQUAD *prgbq);
WINGDIAPI UINT WINAPI SetDIBColorTable(_In_ HDC hdc, _In_ UINT iStart,
                                       _In_ UINT cEntries,
                                       _In_reads_(cEntries)
                                           CONST RGBQUAD *prgbq);
...
WINGDIAPI BOOL WINAPI SetColorAdjustment(_In_ HDC hdc,
                                         _In_ CONST COLORADJUSTMENT *lpca);
WINGDIAPI BOOL WINAPI GetColorAdjustment(_In_ HDC hdc,
                                         _Out_ LPCOLORADJUSTMENT lpca);
...
WINGDIAPI BOOL WINAPI ArcTo(_In_ HDC hdc, _In_ int left, _In_ int top,
                            _In_ int right, _In_ int bottom, _In_ int xr1,
                            _In_ int yr1, _In_ int xr2, _In_ int yr2);
...
WINGDIAPI int WINAPI GetPath(_In_ HDC hdc, _Out_writes_opt_(cpt) LPPOINT apt,
                             _Out_writes_opt_(cpt) LPBYTE aj, int cpt);
WINGDIAPI HRGN WINAPI PathToRegion(_In_ HDC hdc);
WINGDIAPI BOOL WINAPI PolyDraw(_In_ HDC hdc, _In_reads_(cpt) CONST POINT *apt,
                               _In_reads_(cpt) CONST BYTE *aj, _In_ int cpt);
...
WINGDIAPI BOOL WINAPI SetMiterLimit(_In_ HDC hdc, _In_ FLOAT limit,
                                    _Out_opt_ PFLOAT old);
...
WINGDIAPI HPEN WINAPI ExtCreatePen(_In_ DWORD iPenStyle, _In_ DWORD cWidth,
...
WINGDIAPI int WINAPI GetObjectA(_In_ HANDLE h, _In_ int c,
                                _Out_writes_bytes_opt_(c) LPVOID pv);
WINGDIAPI int WINAPI GetObjectW(_In_ HANDLE h, _In_ int c,
                                _Out_writes_bytes_opt_(c) LPVOID pv);
#ifdef UNICODE
...
WINGDIAPI BOOL WINAPI MoveToEx(_In_ HDC hdc, _In_ int x, _In_ int y,
                               _Out_opt_ LPPOINT lppt);
WINGDIAPI BOOL WINAPI TextOutA(_In_ HDC hdc, _In_ int x, _In_ int y,
                               _In_reads_(c) LPCSTR lpString, _In_ int c);
WINGDIAPI BOOL WINAPI TextOutW(_In_ HDC hdc, _In_ int x, _In_ int y,
                               _In_reads_(c) LPCWSTR lpString, _In_ int c);
#ifdef UNICODE
...
#endif // !UNICODE
WINGDIAPI BOOL WINAPI ExtTextOutA(_In_ HDC hdc, _In_ int x, _In_ int y,
                                  _In_ UINT options,
                                  _In_opt_ CONST RECT *lprect,
                                  _In_reads_opt_(c) LPCSTR lpString,
                                  _In_ UINT c,
                                  _In_reads_opt_(c) CONST INT *lpDx);
WINGDIAPI BOOL WINAPI ExtTextOutW(_In_ HDC hdc, _In_ int x, _In_ int y,
                                  _In_ UINT options,
                                  _In_opt_ CONST RECT *lprect,
...
#endif // !UNICODE
WINGDIAPI BOOL WINAPI PolyTextOutA(_In_ HDC hdc,
                                   _In_reads_(nstrings) CONST POLYTEXTA *ppt,
                                   _In_ int nstrings);
WINGDIAPI BOOL WINAPI PolyTextOutW(_In_ HDC hdc,
...
WINGDIAPI HRGN WINAPI CreatePolygonRgn(_In_reads_(cPoint) CONST POINT *pptl,
                                       _In_ int cPoint, _In_ int iMode);
WINGDIAPI BOOL WINAPI DPtoLP(_In_ HDC hdc, _Inout_updates_(c) LPPOINT lppt,
                             _In_ int c);
WINGDIAPI BOOL WINAPI LPtoDP(_In_ HDC hdc, _Inout_updates_(c) LPPOINT lppt,
                             _In_ int c);
WINGDIAPI BOOL WINAPI Polygon(_In_ HDC hdc, _In_reads_(cpt) CONST POINT *apt,
                              _In_ int cpt);
WINGDIAPI BOOL WINAPI Polyline(_In_ HDC hdc, _In_reads_(cpt) CONST POINT *apt,
                               _In_ int cpt);

WINGDIAPI BOOL WINAPI PolyBezier(_In_ HDC hdc, _In_reads_(cpt) CONST POINT *apt,
                                 _In_ DWORD cpt);
WINGDIAPI BOOL WINAPI PolyBezierTo(_In_ HDC hdc,
                                   _In_reads_(cpt) CONST POINT *apt,
                                   _In_ DWORD cpt);
WINGDIAPI BOOL WINAPI PolylineTo(_In_ HDC hdc, _In_reads_(cpt) CONST POINT *apt,
                                 _In_ DWORD cpt);

WINGDIAPI BOOL WINAPI SetViewportExtEx(_In_ HDC hdc, _In_ int x, _In_ int y,
                                       _Out_opt_ LPSIZE lpsz);
WINGDIAPI BOOL WINAPI SetViewportOrgEx(_In_ HDC hdc, _In_ int x, _In_ int y,
                                       _Out_opt_ LPPOINT lppt);
WINGDIAPI BOOL WINAPI SetWindowExtEx(_In_ HDC hdc, _In_ int x, _In_ int y,
                                     _Out_opt_ LPSIZE lpsz);
WINGDIAPI BOOL WINAPI SetWindowOrgEx(_In_ HDC hdc, _In_ int x, _In_ int y,
                                     _Out_opt_ LPPOINT lppt);

WINGDIAPI BOOL WINAPI OffsetViewportOrgEx(_In_ HDC hdc, _In_ int x, _In_ int y,
                                          _Out_opt_ LPPOINT lppt);
WINGDIAPI BOOL WINAPI OffsetWindowOrgEx(_In_ HDC hdc, _In_ int x, _In_ int y,
                                        _Out_opt_ LPPOINT lppt);
WINGDIAPI BOOL WINAPI ScaleViewportExtEx(_In_ HDC hdc, _In_ int xn, _In_ int dx,
                                         _In_ int yn, _In_ int yd,
                                         _Out_opt_ LPSIZE lpsz);
WINGDIAPI BOOL WINAPI ScaleWindowExtEx(_In_ HDC hdc, _In_ int xn, _In_ int xd,
                                       _In_ int yn, _In_ int yd,
                                       _Out_opt_ LPSIZE lpsz);
WINGDIAPI BOOL WINAPI SetBitmapDimensionEx(_In_ HBITMAP hbm, _In_ int w,
                                           _In_ int h, _Out_opt_ LPSIZE lpsz);
WINGDIAPI BOOL WINAPI SetBrushOrgEx(_In_ HDC hdc, _In_ int x, _In_ int y,
                                    _Out_opt_ LPPOINT lppt);

WINGDIAPI int WINAPI GetTextFaceA(_In_ HDC hdc, _In_ int c,
                                  _Out_writes_to_opt_(c, return) LPSTR lpName);
WINGDIAPI int WINAPI GetTextFaceW(_In_ HDC hdc, _In_ int c,
...
WINGDIAPI DWORD WINAPI GetKerningPairsA(_In_ HDC hdc, _In_ DWORD nPairs,
                                        _Out_writes_to_opt_(nPairs, return)
                                            LPKERNINGPAIR lpKernPair);
WINGDIAPI DWORD WINAPI GetKerningPairsW(_In_ HDC hdc, _In_ DWORD nPairs,
                                        _Out_writes_to_opt_(nPairs, return)
                                            LPKERNINGPAIR lpKernPair);
#ifdef UNICODE
...
WINGDIAPI BOOL WINAPI FixBrushOrgEx(_In_ HDC hdc, _In_ int x, _In_ int y,
                                    _In_opt_ LPPOINT ptl);
...
WINGDIAPI BOOL WINAPI CheckColorsInGamut(
    _In_ HDC hdc, _In_reads_(nCount) LPRGBTRIPLE lpRGBTriple,
    _Out_writes_bytes_(nCount) LPVOID dlpBuffer, _In_ DWORD nCount);
...
WINGDIAPI BOOL WINAPI GetICMProfileA(_In_ HDC hdc, _Inout_ LPDWORD pBufSize,
                                     _Out_writes_opt_(*pBufSize)
                                         LPSTR pszFilename);
WINGDIAPI BOOL WINAPI GetICMProfileW(_In_ HDC hdc, _Inout_ LPDWORD pBufSize,
                                     _Out_writes_opt_(*pBufSize)
                                         LPWSTR pszFilename);
#ifdef UNICODE
...
#endif // !UNICODE
WINGDIAPI BOOL WINAPI GetDeviceGammaRamp(_In_ HDC hdc,
                                         _Out_writes_bytes_(3 * 256 * 2)
                                             LPVOID lpRamp);
WINGDIAPI BOOL WINAPI SetDeviceGammaRamp(_In_ HDC hdc,
                                         _In_reads_bytes_(3 * 256 * 2)
                                             LPVOID lpRamp);
WINGDIAPI BOOL WINAPI ColorMatchToTarget(_In_ HDC hdc, _In_ HDC hdcTarget,
                                         _In_ DWORD action);
WINGDIAPI int WINAPI EnumICMProfilesA(_In_ HDC hdc, _In_ ICMENUMPROCA proc,
                                      _In_opt_ LPARAM param);
WINGDIAPI int WINAPI EnumICMProfilesW(_In_ HDC hdc, _In_ ICMENUMPROCW proc,
                                      _In_opt_ LPARAM param);
#ifdef UNICODE
...
#endif // !UNICODE
// The Win95 update API UpdateICMRegKeyA is deprecated to set last error to
// ERROR_NOT_SUPPORTED and return FALSE
WINGDIAPI BOOL WINAPI UpdateICMRegKeyA(_Reserved_ DWORD reserved,
                                       _In_ LPSTR lpszCMID,
                                       _In_ LPSTR lpszFileName,
                                       _In_ UINT command);
// The Win95 update API UpdateICMRegKeyW is deprecated to set last error to
// ERROR_NOT_SUPPORTED and return FALSE
WINGDIAPI BOOL WINAPI UpdateICMRegKeyW(_Reserved_ DWORD reserved,
                                       _In_ LPWSTR lpszCMID,
...
#if (WINVER >= 0x0500)
WINGDIAPI BOOL WINAPI ColorCorrectPalette(_In_ HDC hdc, _In_ HPALETTE hPal,
                                          _In_ DWORD deFirst, _In_ DWORD num);
#endif
