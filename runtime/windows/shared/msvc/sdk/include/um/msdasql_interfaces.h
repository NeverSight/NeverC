...
typedef struct IRowsetChangeExtInfoVtbl {
  ...
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(IRowsetChangeExtInfo *This,
                                             /* [in] */ REFIID riid,
  ...
  HRESULT(STDMETHODCALLTYPE *GetOriginalRow)(IRowsetChangeExtInfo *This,
                                             /* [in] */ HCHAPTER hReserved,
                                             /* [in] */ HROW hRow,
...
public:
  virtual HRESULT STDMETHODCALLTYPE RequestDiagFields(
      ...
      /* [size_is][in] */ __RPC__in_ecount_full(cDiagFields)
...
typedef struct ISQLRequestDiagFieldsVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in ISQLRequestDiagFields *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in ISQLRequestDiagFields *This);
...
typedef struct ISQLGetDiagFieldVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in ISQLGetDiagField *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in ISQLGetDiagField *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in ISQLGetDiagField *This);
...
interface ISQLGetDiagField { CONST_VTBL struct ISQLGetDiagFieldVtbl *lpVtbl; };
