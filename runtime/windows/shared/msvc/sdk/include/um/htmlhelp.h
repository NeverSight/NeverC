...
#define HH_SAFE_DISPLAY_TOPIC                                                  \
  0x0020 // private addition to the interface for InternetExplorer.
...
HWND WINAPI HtmlHelpA(_In_opt_ HWND hwndCaller, _In_ LPCSTR pszFile,
                      _In_ UINT uCommand, _In_ DWORD_PTR dwData);

HWND WINAPI HtmlHelpW(_In_opt_ HWND hwndCaller, _In_ LPCWSTR pszFile,
                      _In_ UINT uCommand, _In_ DWORD_PTR dwData);
#ifdef UNICODE
