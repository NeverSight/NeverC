...
GpStatus WINGDIPAPI GdipGetPathTypes(_In_ GpPath *path,
                                     _Out_writes_bytes_(count) BYTE *types,
                                     INT count);
...
GpStatus WINGDIPAPI GdipPathIterEnumerate(
    GpPathIterator *iterator, _Out_ INT *resultCount,
...
GpStatus WINGDIPAPI GdipGetRegionData(GpRegion *region,
                                      _Out_writes_to_(bufferSize, *sizeFilled)
                                          BYTE *buffer,
                                      UINT bufferSize,
                                      _Out_opt_ UINT *sizeFilled);
...
GpStatus WINGDIPAPI GdipGetPathGradientSurroundColorsWithCount(
    _In_ GpPathGradient *brush, _Out_writes_to_(*count, *count) ARGB *color,
    _Inout_ INT *count);
...
GpStatus WINGDIPAPI GdipGraphicsSetAbort(GpGraphics *pGraphics,
                                         GdiplusAbort *pIAbort);

GpStatus WINGDIPAPI GdipBitmapConvertFormat(
    IN GpBitmap *pInputBitmap, PixelFormat format, DitherType dithertype,
    PaletteType palettetype, ColorPalette *palette, REAL alphaThresholdPercent);
...
GpStatus WINGDIPAPI GdipBitmapGetHistogramSize(IN HistogramFormat format,
...
#if (GDIPVER >= 0x0110)
GpStatus WINGDIPAPI GdipDrawImageFX(GpGraphics *graphics, GpImage *image,
                                    GpRectF *source, GpMatrix *xForm,
                                    CGpEffect *effect,
...
GpStatus WINGDIPAPI GdipGetImageDecodersSize(
    _Out_ UINT *numDecoders,
    _Out_ _Out_range_(>=, (*numDecoders) * sizeof(ImageCodecInfo)) UINT *size);

GpStatus WINGDIPAPI GdipGetImageDecoders(_In_ UINT numDecoders, _In_ UINT size,
                                         _Out_writes_bytes_(size)
                                             ImageCodecInfo *decoders);

GpStatus WINGDIPAPI GdipGetImageEncodersSize(
    _Out_ UINT *numEncoders,
    _Out_ _Out_range_(>=, (*numEncoders) * sizeof(ImageCodecInfo)) UINT *size);

GpStatus WINGDIPAPI GdipGetImageEncoders(_In_ UINT numEncoders, _In_ UINT size,
                                         _Out_writes_bytes_(size)
...
GpStatus WINGDIPAPI GdipGetFontCollectionFamilyList(
    _In_ GpFontCollection *fontCollection, _In_ INT numSought,
...
#if (GDIPVER >= 0x0110)
GpStatus WINGDIPAPI GdipConvertToEmfPlus(const GpGraphics *refGraphics,
                                         GpMetafile *metafile,
