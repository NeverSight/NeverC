...
typedef interface IProofOfPossessionCookieInfoManager2
...
typedef interface IProofOfPossessionCookieInfoManager3
    IProofOfPossessionCookieInfoManager3;
...
typedef interface IProofOfPossessionCookieInfoManager4
...
__inline void FreeProofOfPossessionCookieInfoArray(
    _In_reads_(cookieInfoCount) ProofOfPossessionCookieInfo *cookieInfo,
...
extern RPC_IF_HANDLE
    __MIDL_itf_proofofpossessioncookieinfo_0000_0000_v0_0_c_ifspec;
extern RPC_IF_HANDLE
    __MIDL_itf_proofofpossessioncookieinfo_0000_0000_v0_0_s_ifspec;
...
public:
  virtual HRESULT STDMETHODCALLTYPE GetCookieInfoForUri(
      ...
      /* [size_is][size_is][out] */
      __RPC__deref_out_ecount_full_opt(*cookieInfoCount)
              ProofOfPossessionCookieInfo *
          *cookieInfo) = 0;
};
...
typedef struct IProofOfPossessionCookieInfoManager2Vtbl {
  ...
  DECLSPEC_XFGVIRT(IProofOfPossessionCookieInfoManager2,
...
#define IProofOfPossessionCookieInfoManager2_QueryInterface(This, riid,        \
                                                            ppvObject)         \
  ((This)->lpVtbl->QueryInterface(This, riid, ppvObject))
...
#define IProofOfPossessionCookieInfoManager2_GetCookieInfoWithUriForAccount(   \
    This, webAccount, uri, cookieInfoCount, cookieInfo)                        \
  ((This)->lpVtbl->GetCookieInfoWithUriForAccount(                             \
      This, webAccount, uri, cookieInfoCount, cookieInfo))
...
typedef struct IProofOfPossessionCookieInfoManager3Vtbl {
  ...
  DECLSPEC_XFGVIRT(IProofOfPossessionCookieInfoManager3,
...
#define IProofOfPossessionCookieInfoManager3_QueryInterface(This, riid,        \
                                                            ppvObject)         \
  ((This)->lpVtbl->QueryInterface(This, riid, ppvObject))
...
#define IProofOfPossessionCookieInfoManager3_GetCookieInfoForUriWithOptions(   \
    This, uri, options, cookieInfoCount, cookieInfo)                           \
  ((This)->lpVtbl->GetCookieInfoForUriWithOptions(                             \
      This, uri, options, cookieInfoCount, cookieInfo))
...
typedef struct IProofOfPossessionCookieInfoManager4Vtbl {
  ...
  DECLSPEC_XFGVIRT(IProofOfPossessionCookieInfoManager4,
...
#define IProofOfPossessionCookieInfoManager4_QueryInterface(This, riid,        \
                                                            ppvObject)         \
  ((This)->lpVtbl->QueryInterface(This, riid, ppvObject))
...
#define IProofOfPossessionCookieInfoManager4_GetCookieInfoForUriWithUserAgentId( \
    This, uri, uaClientId, cookieInfoCount, cookieInfo)                          \
  ((This)->lpVtbl->GetCookieInfoForUriWithUserAgentId(                           \
      This, uri, uaClientId, cookieInfoCount, cookieInfo))

#define IProofOfPossessionCookieInfoManager4_GetCookieInfoWithUriAndUserAgentIdForAccount( \
    This, webAccount, uri, uaClientId, cookieInfoCount, cookieInfo)                        \
  ((This)->lpVtbl->GetCookieInfoWithUriAndUserAgentIdForAccount(                           \
      This, webAccount, uri, uaClientId, cookieInfoCount, cookieInfo))
...
extern RPC_IF_HANDLE
    __MIDL_itf_proofofpossessioncookieinfo_0000_0005_v0_0_c_ifspec;
extern RPC_IF_HANDLE
    __MIDL_itf_proofofpossessioncookieinfo_0000_0005_v0_0_s_ifspec;
