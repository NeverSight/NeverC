...
typedef interface ILearningModelDeviceFactoryNative
...
typedef interface ILearningModelSessionOptionsNative
...
typedef interface ILearningModelSessionOptionsNative1
...
struct __declspec(uuid("1adaa23a-eb67-41f3-aad8-5d984e9bacd4"))
__declspec(novtable) ILearningModelOperatorProviderNative : IUnknown {
  STDMETHOD(GetRegistry)(IMLOperatorRegistry **ppOperatorRegistry) PURE;
};

extern RPC_IF_HANDLE
    __MIDL_itf_windows2Eai2Emachinelearning2Enative_0000_0000_v0_0_c_ifspec;
extern RPC_IF_HANDLE
    __MIDL_itf_windows2Eai2Emachinelearning2Enative_0000_0000_v0_0_s_ifspec;
...
typedef struct ITensorNativeVtbl {
  ...
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(ITensorNative *This,
                                             /* [in] */ REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(ITensorNative *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(ITensorNative *This);
...
interface ITensorNative { CONST_VTBL struct ITensorNativeVtbl *lpVtbl; };
...
#define ITensorNative_AddRef(This) ((This)->lpVtbl->AddRef(This))

#define ITensorNative_Release(This) ((This)->lpVtbl->Release(This))
...
public:
  virtual HRESULT STDMETHODCALLTYPE CreateFromD3D12Resource(
      ...
      /* [size_is] */ __int64 *shape, int shapeCount,
...
typedef struct ITensorStaticsNativeVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(ITensorStaticsNative *This,
                                             /* [in] */ REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(ITensorStaticsNative *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(ITensorStaticsNative *This);

  DECLSPEC_XFGVIRT(ITensorStaticsNative, CreateFromD3D12Resource)
  HRESULT(STDMETHODCALLTYPE *CreateFromD3D12Resource)(
      ITensorStaticsNative *This, ID3D12Resource *value,
      /* [size_is] */ __int64 *shape, int shapeCount,
      /* [out] */ IUnknown **result);
...
#define ITensorStaticsNative_AddRef(This) ((This)->lpVtbl->AddRef(This))

#define ITensorStaticsNative_Release(This) ((This)->lpVtbl->Release(This))

#define ITensorStaticsNative_CreateFromD3D12Resource(This, value, shape,       \
                                                     shapeCount, result)       \
  ((This)->lpVtbl->CreateFromD3D12Resource(This, value, shape, shapeCount,     \
                                           result))
...
typedef struct ILearningModelDeviceFactoryNativeVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(ILearningModelDeviceFactoryNative *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(ILearningModelDeviceFactoryNative *This);

  DECLSPEC_XFGVIRT(ILearningModelDeviceFactoryNative,
                   CreateFromD3D12CommandQueue)
  HRESULT(STDMETHODCALLTYPE *CreateFromD3D12CommandQueue)(
      ILearningModelDeviceFactoryNative *This, ID3D12CommandQueue *value,
      /* [out] */ IUnknown **result);
...
#define ILearningModelDeviceFactoryNative_QueryInterface(This, riid,           \
                                                         ppvObject)            \
  ((This)->lpVtbl->QueryInterface(This, riid, ppvObject))
...
#define ILearningModelDeviceFactoryNative_CreateFromD3D12CommandQueue(         \
    This, value, result)                                                       \
...
typedef struct ILearningModelSessionOptionsNativeVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(ILearningModelSessionOptionsNative *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(ILearningModelSessionOptionsNative *This);

  DECLSPEC_XFGVIRT(ILearningModelSessionOptionsNative,
                   SetIntraOpNumThreadsOverride)
  HRESULT(STDMETHODCALLTYPE *SetIntraOpNumThreadsOverride)(
      ILearningModelSessionOptionsNative *This, UINT32 intraOpNumThreads);
...
#define ILearningModelSessionOptionsNative_QueryInterface(This, riid,          \
                                                          ppvObject)           \
  ((This)->lpVtbl->QueryInterface(This, riid, ppvObject))
...
#define ILearningModelSessionOptionsNative_SetIntraOpNumThreadsOverride(       \
...
typedef struct ILearningModelSessionOptionsNative1Vtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(ILearningModelSessionOptionsNative1 *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(ILearningModelSessionOptionsNative1 *This);

  DECLSPEC_XFGVIRT(ILearningModelSessionOptionsNative1,
                   SetIntraOpThreadSpinning)
  HRESULT(STDMETHODCALLTYPE *SetIntraOpThreadSpinning)(
      ILearningModelSessionOptionsNative1 *This, boolean allowSpinning);
...
#define ILearningModelSessionOptionsNative1_QueryInterface(This, riid,         \
                                                           ppvObject)          \
  ((This)->lpVtbl->QueryInterface(This, riid, ppvObject))
...
#define ILearningModelSessionOptionsNative1_SetIntraOpThreadSpinning(          \
    This, allowSpinning)                                                       \
...
extern RPC_IF_HANDLE
    __MIDL_itf_windows2Eai2Emachinelearning2Enative_0000_0005_v0_0_c_ifspec;
extern RPC_IF_HANDLE
    __MIDL_itf_windows2Eai2Emachinelearning2Enative_0000_0005_v0_0_s_ifspec;
