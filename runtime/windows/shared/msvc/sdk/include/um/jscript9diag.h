...
// Frame is outside of the interpreter. For example, portions of the Js dll
// which are logically not part of the interpreter.
...
#define E_JsDEBUG_SOURCE_LOCATION_NOT_FOUND                                    \
  MAKE_HRESULT(1, FACILITY_JsDEBUG, 0x6)
// Runtime not in debug mode
#define E_JsDEBUG_RUNTIME_NOT_IN_DEBUG_MODE                                    \
  MAKE_HRESULT(1, FACILITY_JsDEBUG, 0x7)
...
typedef struct IJsDebugVtbl {
  ...
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(IJsDebug *This,
                                             /* [in] */ REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(IJsDebug *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(IJsDebug *This);
...
interface IJsDebug { CONST_VTBL struct IJsDebugVtbl *lpVtbl; };
...
#define IJsDebug_AddRef(This) ((This)->lpVtbl->AddRef(This))

#define IJsDebug_Release(This) ((This)->lpVtbl->Release(This))

#define IJsDebug_OpenVirtualProcess(This, processId, runtimeJsBaseAddress,     \
                                    pDataTarget, ppProcess)                    \
  ((This)->lpVtbl->OpenVirtualProcess(This, processId, runtimeJsBaseAddress,   \
                                      pDataTarget, ppProcess))
...
typedef struct IJsDebugProcessVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(IJsDebugProcess *This,
                                             /* [in] */ REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(IJsDebugProcess *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(IJsDebugProcess *This);
  ...
  HRESULT(STDMETHODCALLTYPE *PerformAsyncBreak)(IJsDebugProcess *This,
                                                /* [in] */ DWORD threadId);
...
interface IJsDebugProcess { CONST_VTBL struct IJsDebugProcessVtbl *lpVtbl; };
...
#define IJsDebugProcess_AddRef(This) ((This)->lpVtbl->AddRef(This))

#define IJsDebugProcess_Release(This) ((This)->lpVtbl->Release(This))
...
#define IJsDebugProcess_CreateBreakPoint(This, documentId, characterOffset,    \
                                         characterCount, isEnabled,            \
                                         ppDebugBreakPoint)                    \
  ((This)->lpVtbl->CreateBreakPoint(This, documentId, characterOffset,         \
                                    characterCount, isEnabled,                 \
                                    ppDebugBreakPoint))
...
typedef struct IJsDebugStackWalkerVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(IJsDebugStackWalker *This,
                                             /* [in] */ REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(IJsDebugStackWalker *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(IJsDebugStackWalker *This);

  DECLSPEC_XFGVIRT(IJsDebugStackWalker, GetNext)
  HRESULT(STDMETHODCALLTYPE *GetNext)(IJsDebugStackWalker *This,
...
#define IJsDebugStackWalker_AddRef(This) ((This)->lpVtbl->AddRef(This))

#define IJsDebugStackWalker_Release(This) ((This)->lpVtbl->Release(This))
...
typedef struct IJsDebugFrameVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(IJsDebugFrame *This,
                                             /* [in] */ REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(IJsDebugFrame *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(IJsDebugFrame *This);

  DECLSPEC_XFGVIRT(IJsDebugFrame, GetStackRange)
  HRESULT(STDMETHODCALLTYPE *GetStackRange)(IJsDebugFrame *This,
                                            /* [out] */ UINT64 *pStart,
                                            /* [out] */ UINT64 *pEnd);

  DECLSPEC_XFGVIRT(IJsDebugFrame, GetName)
  HRESULT(STDMETHODCALLTYPE *GetName)(IJsDebugFrame *This,
                                      /* [out] */ BSTR *pName);
...
interface IJsDebugFrame { CONST_VTBL struct IJsDebugFrameVtbl *lpVtbl; };
...
#define IJsDebugFrame_AddRef(This) ((This)->lpVtbl->AddRef(This))

#define IJsDebugFrame_Release(This) ((This)->lpVtbl->Release(This))
...
#define IJsDebugFrame_GetDocumentPositionWithId(                               \
    This, pDocumentId, pCharacterOffset, pStatementCharCount)                  \
  ((This)->lpVtbl->GetDocumentPositionWithId(                                  \
      This, pDocumentId, pCharacterOffset, pStatementCharCount))

#define IJsDebugFrame_GetDocumentPositionWithName(This, pDocumentName, pLine,  \
                                                  pColumn)                     \
  ((This)->lpVtbl->GetDocumentPositionWithName(This, pDocumentName, pLine,     \
                                               pColumn))
...
typedef struct IJsDebugPropertyVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(IJsDebugProperty *This,
                                             /* [in] */ REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(IJsDebugProperty *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(IJsDebugProperty *This);
...
interface IJsDebugProperty { CONST_VTBL struct IJsDebugPropertyVtbl *lpVtbl; };
...
#define IJsDebugProperty_AddRef(This) ((This)->lpVtbl->AddRef(This))

#define IJsDebugProperty_Release(This) ((This)->lpVtbl->Release(This))
...
typedef struct IJsEnumDebugPropertyVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(IJsEnumDebugProperty *This,
                                             /* [in] */ REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(IJsEnumDebugProperty *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(IJsEnumDebugProperty *This);
  ...
  HRESULT(STDMETHODCALLTYPE *GetCount)(IJsEnumDebugProperty *This,
                                       /* [out] */ ULONG *pCount);
...
#define IJsEnumDebugProperty_AddRef(This) ((This)->lpVtbl->AddRef(This))

#define IJsEnumDebugProperty_Release(This) ((This)->lpVtbl->Release(This))
...
typedef struct IJsDebugBreakPointVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(IJsDebugBreakPoint *This,
                                             /* [in] */ REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(IJsDebugBreakPoint *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(IJsDebugBreakPoint *This);

  DECLSPEC_XFGVIRT(IJsDebugBreakPoint, IsEnabled)
  HRESULT(STDMETHODCALLTYPE *IsEnabled)(IJsDebugBreakPoint *This,
                                        /* [out] */ BOOL *pIsEnabled);

  DECLSPEC_XFGVIRT(IJsDebugBreakPoint, Enable)
  HRESULT(STDMETHODCALLTYPE *Enable)(IJsDebugBreakPoint *This);

  DECLSPEC_XFGVIRT(IJsDebugBreakPoint, Disable)
  HRESULT(STDMETHODCALLTYPE *Disable)(IJsDebugBreakPoint *This);

  DECLSPEC_XFGVIRT(IJsDebugBreakPoint, Delete)
  HRESULT(STDMETHODCALLTYPE *Delete)(IJsDebugBreakPoint *This);
...
#define IJsDebugBreakPoint_AddRef(This) ((This)->lpVtbl->AddRef(This))

#define IJsDebugBreakPoint_Release(This) ((This)->lpVtbl->Release(This))

#define IJsDebugBreakPoint_IsEnabled(This, pIsEnabled)                         \
  ((This)->lpVtbl->IsEnabled(This, pIsEnabled))

#define IJsDebugBreakPoint_Enable(This) ((This)->lpVtbl->Enable(This))

#define IJsDebugBreakPoint_Disable(This) ((This)->lpVtbl->Disable(This))

#define IJsDebugBreakPoint_Delete(This) ((This)->lpVtbl->Delete(This))

#define IJsDebugBreakPoint_GetDocumentPosition(                                \
    This, pDocumentId, pCharacterOffset, pStatementCharCount)                  \
  ((This)->lpVtbl->GetDocumentPosition(This, pDocumentId, pCharacterOffset,    \
                                       pStatementCharCount))
...
typedef struct IEnumJsStackFramesVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(IEnumJsStackFrames *This,
                                             /* [in] */ REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(IEnumJsStackFrames *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(IEnumJsStackFrames *This);
  ...
  HRESULT(STDMETHODCALLTYPE *Reset)(IEnumJsStackFrames *This);
...
#define IEnumJsStackFrames_AddRef(This) ((This)->lpVtbl->AddRef(This))

#define IEnumJsStackFrames_Release(This) ((This)->lpVtbl->Release(This))

#define IEnumJsStackFrames_Next(This, cFrameCount, pFrames, pcFetched)         \
  ((This)->lpVtbl->Next(This, cFrameCount, pFrames, pcFetched))

#define IEnumJsStackFrames_Reset(This) ((This)->lpVtbl->Reset(This))
...
typedef struct IJsDebugDataTargetVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(IJsDebugDataTarget *This,
                                             /* [in] */ REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(IJsDebugDataTarget *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(IJsDebugDataTarget *This);
  ...
  HRESULT(STDMETHODCALLTYPE *FreeVirtualMemory)(IJsDebugDataTarget *This,
                                                /* [in] */ UINT64 address,
                                                /* [in] */ DWORD size,
                                                /* [in] */ DWORD freeType);

  DECLSPEC_XFGVIRT(IJsDebugDataTarget, GetTlsValue)
  HRESULT(STDMETHODCALLTYPE *GetTlsValue)(IJsDebugDataTarget *This,
                                          /* [in] */ DWORD threadId,
                                          /* [in] */ UINT32 tlsIndex,
                                          /* [out] */ UINT64 *pValue);

  DECLSPEC_XFGVIRT(IJsDebugDataTarget, ReadBSTR)
  HRESULT(STDMETHODCALLTYPE *ReadBSTR)(IJsDebugDataTarget *This,
                                       /* [in] */ UINT64 address,
                                       /* [out] */ BSTR *pString);
...
#define IJsDebugDataTarget_AddRef(This) ((This)->lpVtbl->AddRef(This))

#define IJsDebugDataTarget_Release(This) ((This)->lpVtbl->Release(This))

#define IJsDebugDataTarget_ReadMemory(This, address, flags, pBuffer, size,     \
                                      pBytesRead)                              \
...
#define IJsDebugDataTarget_AllocateVirtualMemory(                              \
    This, address, size, allocationType, pageProtection, pAllocatedAddress)    \
  ((This)->lpVtbl->AllocateVirtualMemory(This, address, size, allocationType,  \
                                         pageProtection, pAllocatedAddress))
...
#define IJsDebugDataTarget_ReadNullTerminatedString(                           \
    This, address, characterSize, maxCharacters, pString)                      \
  ((This)->lpVtbl->ReadNullTerminatedString(This, address, characterSize,      \
                                            maxCharacters, pString))

#define IJsDebugDataTarget_CreateStackFrameEnumerator(This, threadId,          \
                                                      ppEnumerator)            \
  ((This)->lpVtbl->CreateStackFrameEnumerator(This, threadId, ppEnumerator))

#define IJsDebugDataTarget_GetThreadContext(This, threadId, contextFlags,      \
                                            contextSize, pContext)             \
  ((This)->lpVtbl->GetThreadContext(This, threadId, contextFlags, contextSize, \
                                    pContext))
