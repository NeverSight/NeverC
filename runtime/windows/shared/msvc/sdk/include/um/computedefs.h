...
// Type of an operation. These correspond to the functions that invoke the
// operation.
...
typedef void(CALLBACK *HCS_OPERATION_COMPLETION)(_In_ HCS_OPERATION operation,
                                                 _In_opt_ void *context);

// Events indicated to callbacks registered by HcsRegisterComputeSystemCallback
// or HcsRegisterProcessCallback (since Windows 1809).
...
// Provides information about an event that occurred on a compute system or
// process.
...
typedef void(CALLBACK *HCS_EVENT_CALLBACK)(_In_ HCS_EVENT *event,
                                           _In_opt_ void *context);
...
// Notifications indicated to callbacks registered by
// HcsRegisterComputeSystemCallback or HcsRegisterProcessCallback (until Windows
// 1803).
...
// Struct containing information about a process created by
// HcsStartProcessInComputeSystem
typedef struct {
...
// Versions available for HCS_CREATE_OPTIONS used by
// HcsCreateComputeSystemInNamespace.
typedef enum HCS_CREATE_OPTIONS {
  HcsCreateOptions_1 = 0x00010000 // HCS_CREATE_OPTIONS_1
} HCS_CREATE_OPTIONS;

// Struct containing different options when creating a compute system with
// HcsCreateComputeSystemInNamespace. Header.Version should be initialized to
// HcsCreateOptions_1.
typedef struct {
