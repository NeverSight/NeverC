...
struct sqlite3_api_routines {
  ...
  int(SQLITE_APICALL *bind_blob)(sqlite3_stmt *, int, const void *, int n,
  ...
  int(SQLITE_APICALL *bind_text)(sqlite3_stmt *, int, const char *, int n,
                                 void(SQLITE_CALLBACK *)(void *));
  int(SQLITE_APICALL *bind_text16)(sqlite3_stmt *, int, const void *, int,
                                   void(SQLITE_CALLBACK *)(void *));
  int(SQLITE_APICALL *bind_value)(sqlite3_stmt *, int, const sqlite3_value *);
  int(SQLITE_APICALL *busy_handler)(sqlite3 *,
                                    int(SQLITE_CALLBACK *)(void *, int),
                                    void *);
  int(SQLITE_APICALL *busy_timeout)(sqlite3 *, int ms);
  int(SQLITE_APICALL *changes)(sqlite3 *);
  int(SQLITE_APICALL *close)(sqlite3 *);
  int(SQLITE_APICALL *collation_needed)(
      sqlite3 *, void *,
      void(SQLITE_CALLBACK *)(void *, sqlite3 *, int eTextRep, const char *));
  int(SQLITE_APICALL *collation_needed16)(
      sqlite3 *, void *,
  ...
  void *(SQLITE_APICALL *commit_hook)(sqlite3 *, int(SQLITE_CALLBACK *)(void *),
                                      void *);
  int(SQLITE_APICALL *complete)(const char *sql);
  int(SQLITE_APICALL *complete16)(const void *sql);
  int(SQLITE_APICALL *create_collation)(
      sqlite3 *, const char *, int, void *,
      int(SQLITE_CALLBACK *)(void *, int, const void *, int, const void *));
  int(SQLITE_APICALL *create_collation16)(
      sqlite3 *, const void *, int, void *,
      int(SQLITE_CALLBACK *)(void *, int, const void *, int, const void *));
  int(SQLITE_APICALL *create_function)(
  ...
  int(SQLITE_APICALL *create_function16)(
      sqlite3 *, const void *, int, int, void *,
      void(SQLITE_APICALL *xFunc)(sqlite3_context *, int, sqlite3_value **),
      void(SQLITE_APICALL *xStep)(sqlite3_context *, int, sqlite3_value **),
      void(SQLITE_APICALL *xFinal)(sqlite3_context *));
  int(SQLITE_APICALL *create_module)(sqlite3 *, const char *,
  ...
  int(SQLITE_APICALL *exec)(sqlite3 *, const char *, sqlite3_callback, void *,
                            char **);
  ...
  int(SQLITE_APICALL *get_table)(sqlite3 *, const char *, char ***, int *,
                                 int *, char **);
  ...
  int(SQLITE_APICALL *prepare)(sqlite3 *, const char *, int, sqlite3_stmt **,
                               const char **);
  int(SQLITE_APICALL *prepare16)(sqlite3 *, const void *, int, sqlite3_stmt **,
                                 const void **);
  void *(SQLITE_APICALL *profile)(sqlite3 *,
                                  void(SQLITE_CALLBACK *)(void *, const char *,
                                                          sqlite_uint64),
                                  void *);
  void(SQLITE_APICALL *progress_handler)(sqlite3 *, int,
                                         int(SQLITE_CALLBACK *)(void *),
                                         void *);
  void *(SQLITE_APICALL *realloc)(void *, int);
  int(SQLITE_APICALL *reset)(sqlite3_stmt *pStmt);
  void(SQLITE_APICALL *result_blob)(sqlite3_context *, const void *, int,
                                    void(SQLITE_CALLBACK *)(void *));
  ...
  void(SQLITE_APICALL *result_text)(sqlite3_context *, const char *, int,
                                    void(SQLITE_CALLBACK *)(void *));
  void(SQLITE_APICALL *result_text16)(sqlite3_context *, const void *, int,
                                      void(SQLITE_CALLBACK *)(void *));
  void(SQLITE_APICALL *result_text16be)(sqlite3_context *, const void *, int,
                                        void(SQLITE_CALLBACK *)(void *));
  void(SQLITE_APICALL *result_text16le)(sqlite3_context *, const void *, int,
                                        void(SQLITE_CALLBACK *)(void *));
  void(SQLITE_APICALL *result_value)(sqlite3_context *, sqlite3_value *);
  void *(SQLITE_APICALL *rollback_hook)(sqlite3 *,
                                        void(SQLITE_CALLBACK *)(void *),
                                        void *);
  int(SQLITE_APICALL *set_authorizer)(
      sqlite3 *,
      int(SQLITE_CALLBACK *)(void *, int, const char *, const char *,
                             const char *, const char *),
      void *);
  void(SQLITE_APICALL *set_auxdata)(sqlite3_context *, int, void *,
                                    void(SQLITE_CALLBACK *)(void *));
  char *(SQLITE_APICALL *xsnprintf)(int, char *, const char *, ...);
  int(SQLITE_APICALL *step)(sqlite3_stmt *);
  int(SQLITE_APICALL *table_column_metadata)(sqlite3 *, const char *,
                                             const char *, const char *,
                                             char const **, char const **,
                                             int *, int *, int *);
  void(SQLITE_APICALL *thread_cleanup)(void);
  int(SQLITE_APICALL *total_changes)(sqlite3 *);
  void *(SQLITE_APICALL *trace)(
      sqlite3 *, void(SQLITE_APICALL *xTrace)(void *, const char *), void *);
  int(SQLITE_APICALL *transfer_bindings)(sqlite3_stmt *, sqlite3_stmt *);
  void *(SQLITE_APICALL *update_hook)(sqlite3 *,
                                      void(SQLITE_CALLBACK *)(void *, int,
                                                              char const *,
                                                              char const *,
                                                              sqlite_int64),
                                      void *);
  ...
  /* Added ??? */
  int(SQLITE_APICALL *overload_function)(sqlite3 *, const char *zFuncName,
                                         int nArg);
  /* Added by 3.3.13 */
  int(SQLITE_APICALL *prepare_v2)(sqlite3 *, const char *, int, sqlite3_stmt **,
                                  const char **);
  int(SQLITE_APICALL *prepare16_v2)(sqlite3 *, const void *, int,
                                    sqlite3_stmt **, const void **);
  int(SQLITE_APICALL *clear_bindings)(sqlite3_stmt *);
  /* Added by 3.4.1 */
  int(SQLITE_APICALL *create_module_v2)(sqlite3 *, const char *,
                                        const sqlite3_module *, void *,
  ...
  int(SQLITE_APICALL *blob_open)(sqlite3 *, const char *, const char *,
                                 const char *, sqlite3_int64, int,
                                 sqlite3_blob **);
  int(SQLITE_APICALL *blob_read)(sqlite3_blob *, void *, int, int);
  int(SQLITE_APICALL *blob_write)(sqlite3_blob *, const void *, int, int);
  int(SQLITE_APICALL *create_collation_v2)(
      sqlite3 *, const char *, int, void *,
      int(SQLITE_CALLBACK *)(void *, int, const void *, int, const void *),
      void(SQLITE_CALLBACK *)(void *));
  ...
  sqlite3_backup *(SQLITE_APICALL *backup_init)(sqlite3 *, const char *,
                                                sqlite3 *, const char *);
  ...
  int(SQLITE_APICALL *create_function_v2)(
      sqlite3 *, const char *, int, int, void *,
      void(SQLITE_APICALL *xFunc)(sqlite3_context *, int, sqlite3_value **),
      void(SQLITE_APICALL *xStep)(sqlite3_context *, int, sqlite3_value **),
      void(SQLITE_APICALL *xFinal)(sqlite3_context *),
  ...
  int(SQLITE_APICALL *unlock_notify)(sqlite3 *,
                                     void(SQLITE_CALLBACK *)(void **, int),
                                     void *);
  int(SQLITE_APICALL *wal_autocheckpoint)(sqlite3 *, int);
  int(SQLITE_APICALL *wal_checkpoint)(sqlite3 *, const char *);
  void *(SQLITE_APICALL *wal_hook)(sqlite3 *,
                                   int(SQLITE_CALLBACK *)(void *, sqlite3 *,
                                                          const char *, int),
                                   void *);
  ...
  sqlite3_int64(SQLITE_APICALL *uri_int64)(const char *, const char *,
                                           sqlite3_int64);
  const char *(SQLITE_APICALL *uri_parameter)(const char *, const char *);
  char *(SQLITE_APICALL *xvsnprintf)(int, char *, const char *, va_list);
  int(SQLITE_APICALL *wal_checkpoint_v2)(sqlite3 *, const char *, int, int *,
                                         int *);
  /* Version 3.8.7 and later */
  int(SQLITE_APICALL *auto_extension)(void(SQLITE_CALLBACK *)(void));
  int(SQLITE_APICALL *bind_blob64)(sqlite3_stmt *, int, const void *,
                                   sqlite3_uint64,
                                   void(SQLITE_CALLBACK *)(void *));
  int(SQLITE_APICALL *bind_text64)(sqlite3_stmt *, int, const char *,
                                   sqlite3_uint64,
                                   void(SQLITE_CALLBACK *)(void *),
                                   unsigned char);
  int(SQLITE_APICALL *cancel_auto_extension)(void(SQLITE_CALLBACK *)(void));
  int(SQLITE_APICALL *load_extension)(sqlite3 *, const char *, const char *,
                                      char **);
  ...
  void(SQLITE_APICALL *result_blob64)(sqlite3_context *, const void *,
                                      sqlite3_uint64,
                                      void(SQLITE_CALLBACK *)(void *));
  void(SQLITE_APICALL *result_text64)(sqlite3_context *, const char *,
                                      sqlite3_uint64,
                                      void(SQLITE_CALLBACK *)(void *),
                                      unsigned char);
  ...
  int(SQLITE_APICALL *trace_v2)(sqlite3 *, unsigned,
                                int(SQLITE_CALLBACK *)(unsigned, void *, void *,
                                                       void *),
                                void *);
  ...
  int(SQLITE_APICALL *prepare16_v3)(sqlite3 *, const void *, int, unsigned int,
                                    sqlite3_stmt **, const void **);
  int(SQLITE_APICALL *bind_pointer)(sqlite3_stmt *, int, void *, const char *,
                                    void(SQLITE_CALLBACK *)(void *));
  void(SQLITE_APICALL *result_pointer)(sqlite3_context *, void *, const char *,
                                       void(SQLITE_CALLBACK *)(void *));
  ...
  void(SQLITE_APICALL *str_vappendf)(sqlite3_str *, const char *zFormat,
                                     va_list);
  ...
  int(SQLITE_APICALL *create_window_function)(
      sqlite3 *, const char *, int, int, void *,
      void(SQLITE_APICALL *xStep)(sqlite3_context *, int, sqlite3_value **),
      void(SQLITE_APICALL *xFinal)(sqlite3_context *),
  ...
  const char *(SQLITE_APICALL *create_filename)(const char *, const char *,
                                                const char *, int,
                                                const char **);
  ...
  int(SQLITE_APICALL *autovacuum_pages)(
      sqlite3 *,
  ...
  int(SQLITE_APICALL *vtab_rhs_value)(sqlite3_index_info *, int,
                                      sqlite3_value **);
  ...
  unsigned char *(SQLITE_APICALL *serialize)(sqlite3 *, const char *,
                                             sqlite3_int64 *, unsigned int);
  ...
  int(SQLITE_APICALL *set_clientdata)(sqlite3 *, const char *, void *,
                                      void(SQLITE_CALLBACK *)(void *));
  /* Version 3.50.0 and later */
  int(SQLITE_APICALL *setlk_timeout)(sqlite3 *, int, int);
  /* Version 3.51.0 and later */
  int(SQLITE_APICALL *set_errmsg)(sqlite3 *, int, const char *);
  int(SQLITE_APICALL *db_status64)(sqlite3 *, int, sqlite3_int64 *,
                                   sqlite3_int64 *, int);
