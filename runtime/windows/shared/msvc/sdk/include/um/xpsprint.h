...
typedef /* [public][public] */
    struct __MIDL___MIDL_itf_xpsprint_0000_0000_0002 {
  UINT32 jobId;
...
typedef struct IXpsPrintJobStreamVtbl {
  ...
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in IXpsPrintJobStream *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IXpsPrintJobStream *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IXpsPrintJobStream *This);
  ...
  /* [local] */ HRESULT(STDMETHODCALLTYPE *Write)(IXpsPrintJobStream *This,
                                                  /* [annotation] */
                                                  _In_reads_bytes_(cb)
                                                      const void *pv,
                                                  /* [annotation][in] */
  ...
  HRESULT(STDMETHODCALLTYPE *Close)(__RPC__in IXpsPrintJobStream *This);
...
typedef struct IXpsPrintJobVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in IXpsPrintJob *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IXpsPrintJob *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IXpsPrintJob *This);

  DECLSPEC_XFGVIRT(IXpsPrintJob, Cancel)
  HRESULT(STDMETHODCALLTYPE *Cancel)(__RPC__in IXpsPrintJob *This);
...
interface IXpsPrintJob { CONST_VTBL struct IXpsPrintJobVtbl *lpVtbl; };
...
#pragma deprecated(StartXpsPrintJob, StartXpsPrintJob1, IXpsPrintJob,          \
                   IXpsPrintStream, XPS_JOB_STATUS, XPS_JOB_COMPLETION)
