...
public:
  ...
  // initialize
  HRESULT STDMETHODCALLTYPE Initialize(DWORD dwSize, T *pBegin, T *pEnd) {
    int i;
    HRESULT hr;
    T *iter;
  ...
  HRESULT STDMETHODCALLTYPE get__NewEnum(IUnknown **retval)
...
public:
  ...
  // initialize
  HRESULT STDMETHODCALLTYPE Initialize(DWORD dwSize, BSTR *pBegin, BSTR *pEnd) {
    BSTR *i;
    DWORD dw = 0;
