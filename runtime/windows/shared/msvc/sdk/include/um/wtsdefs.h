...
typedef struct _WTS_TIME_ZONE_INFORMATION {
  ...
  LONG DaylightBias;
} _WTS_TIME_ZONE_INFORMATION, WTS_TIME_ZONE_INFORMATION,
...
typedef[switch_type(DWORD)] union _WTS_CACHE_STATS_UN {
  [case (1)] WTS_PROTOCOL_CACHE ProtocolCache[WTS_MAX_PROTOCOL_CACHE];
  [case (2)] ULONG TShareCacheStats;
  [case (3)] ULONG
      Reserved[WTS_MAX_CACHE_RESERVED]; // Protocol specific Reserved data
...
//          pPropertyEntriesIn[0].u.strVal.pstrVal = NAME of the inital app, ex.
//          notepad.exe pPropertyEntriesIn[0].u.strVal.size = Length of the name
//          string
//
//          pPropertyEntriesIn[1].Type = WTS_VALUE_TYPE_STRING;
//          pPropertyEntriesIn[1].u.strVal.pstrVal = PARAMETERS for the inital
//          app pPropertyEntriesIn[1].u.strVal.size = Length of the parameter
//          string
//
//          pPropertyEntriesIn[2].Type = WTS_VALUE_TYPE_ULONG;
//          pPropertyEntriesIn[2].u.ulVal = Reserved
//
// Output to this query - It passes 3 WTS_PROPERTY_VALUE structures. Protocol
// needs to set it to:
//          pPropertyEntriesOut[0].Type = WTS_VALUE_TYPE_STRING;
//          pPropertyEntriesOut[0].u.strVal.pstrVal = Full command line to
//          execute. Protocol should
//                                                    append current working dir
//                                                    to the app name and put
//                                                    here
//          pPropertyEntriesOut[0].u.strVal.size = Length of command line
//
//          pPropertyEntriesOut[1].Type = WTS_VALUE_TYPE_STRING;
//          pPropertyEntriesOut[1].u.strVal.pstrVal = PARAMETERS for the inital
//          app pPropertyEntriesOut[1].u.strVal.size = Length of the parameter
//          string
//
//      If protocol want to maintain the initial app and parameters passed in
//      input parameter, it should just copy them to the corresponding fields
//      (two above) in output paramters
//
//          pPropertyEntriesOut[2].Type = WTS_VALUE_TYPE_ULONG;
//          pPropertyEntriesOut[2].u.ulVal = 0 indicates don't allow initial app
//          to run, allow otherwise
//
EXTERN_C const __declspec(selectany) GUID
    WTS_QUERY_ALLOWED_INITIAL_APP = /*C77D1B30-5BE1-4c6b-A0E1-BD6D2E5C9FCC*/
    {0xc77d1b30,
     0x5be1,
     0x4c6b,
     {0xa0, 0xe1, 0xbd, 0x6d, 0x2e, 0x5c, 0x9f, 0xcc}};
...
//
// Output to this query - It passes 1 WTS_PROPERTY_VALUE structure. Protocol
// needs to set it to:
//          pPropertyEntriesOut[0].Type = WTS_VALUE_TYPE_ULONG;
//          pPropertyEntriesOut[0].u.strVal.pstrVal = Size of the LogonUI
//          screen.
//
// If protocol doesn't want to keep the default size of the LogonUI screen, it
// must fail this call with error E_NOTIMPL.
//
EXTERN_C const __declspec(selectany) GUID
    ...
    {0x8b8e0fe7,
     0x0804,
     0x4a0e,
     {0xb2, 0x79, 0x86, 0x60, 0xb1, 0xdf, 0x00, 0x49}};
...
//          pPropertyEntriesOut[0].Type = WTS_VALUE_TYPE_STRING;
//          pPropertyEntriesOut[0].u.strVal.pstrVal =  Remote audio enumerator
//          DLL name pPropertyEntriesOut[0].u.strVal.size = Length of DLL name
//
//
EXTERN_C const __declspec(selectany) GUID
    ...
    {0x9bf4fa97,
     0xc883,
     0x4c2a,
     {0x80, 0xab, 0x5a, 0x39, 0xc9, 0xaf, 0x00, 0xdb}};
...
//          pPropertyEntriesOut[0].u.bVal.size = Size of TSMF_SUPPORT_DATA_IN
//          structure.
//               This will vary based on the size of the variable data in the
//               structure.
//
...
//          structure pPropertyEntriesOut[0].u.bVal.size = Size of
...
//              UINT32      numEntries;
//              //
//              // variable length data. The data is of type
...
//              //
//              // variable length media format data. It should be read as a set
//              of TS_AM_MEDIA_TYPE structs.
//              // The format itself is of type FORMAT_WaveFormatEx for audio
//              and FORMAT_MFVideoFormat
//              // for video
//              //
...
//
//          //
//          // Structures used to format data output from RCM. This is the
//          format expected from protocol extension
//          //
//          typedef struct tagTSMF_SUPPORT_DATA_OUT {
//              GUID        guidMfSession; // must match the MF session guid in
//              input data UINT32      numEntries; // must match the number of
//              entries in input data
//
//              //
//              // variable length data. The data is of type
...
//              CLSID       clsidNewSink;
//              // 0 based index of the media type for which support is being
//              expressed. UINT32      supportedMediaTypeIndex;
//          } TSMF_SUPPORT_NODEDATA_OUT, *PTSMF_SUPPORT_NODEDATA_OUT;
//
//
//          // The following struct is used to express the media type. The
//          fields in this struct have the same meaning as AM_MEDIA_TYPE
//          // This struct is used to ensure consistency between 32-bit and
//          64-bit callers
//          //
...
EXTERN_C const __declspec(selectany) GUID
    ...
    {0x41869ad0,
     0x6332,
     0x4dc8,
     {0x95, 0xd5, 0xdb, 0x74, 0x9e, 0x2f, 0x1d, 0x94}};
...
EXTERN_C const __declspec(selectany) GUID
    WRDS_SERVICE_ID_GRAPHICS_GUID = /* d2993f4d-2cf-4280-8c48-1624b44f8706 */
    {0xd2993f4d,
     0x2cf,
     0x4280,
     {0x8c, 0x48, 0x16, 0x24, 0xb4, 0x4f, 0x87, 0x6}};
...
// Output to this query is a WTS_PROPERTY_VALUE structures containing
//          pPropertyEntriesOut[0].Type = WTS_VALUE_TYPE_BINARY;
//          pPropertyEntriesOut[0].u.bVal.pbVal =
//          WRDS_DYNAMIC_TIME_ZONE_INFORMATION structure
//          pPropertyEntriesOut[0].u.bVal.size = Size of
//          WRDS_DYNAMIC_TIME_ZONE_INFORMATION structure.
//
...
EXTERN_C const __declspec(selectany) GUID
    ...
    {0xcdfd28e,
     0xd0b9,
     0x4c1f,
     {0xa5, 0xeb, 0x6d, 0x1f, 0x6c, 0x65, 0x35, 0xb9}};

// ************************************************************************

// ************** PROPERTY_GET_FAST_RECONNECT ******************
//
// This is used to get what type of fast reconnect (if any) should be used based
// on the stack
//
// There are no inputs to this query.
//
...
// needs to set it to:
//          pPropertyEntriesOut[0].Type = WTS_VALUE_TYPE_ULONG;
//          pPropertyEntriesOut[0].u.ulVal = (0 = Don't do fast reconnect, 1 =
//          Basic Fast Reconnect, 2 = Enhanced Fast reconnect)
//
EXTERN_C const _declspec(selectany) GUID
    PROPERTY_TYPE_GET_FAST_RECONNECT = /* 6212d757-0043-4862-99c3-9f3059ac2a3b*/
    {0x6212d757,
     0x0043,
     0x4862,
     {0x99, 0xc3, 0x9f, 0x30, 0x59, 0xac, 0x2a, 0x3b}};

// ************************************************************************

// ************** PROPERTY_TYPE_GET_FAST_RECONNECT_USER_SID ******************
//
// This is used to get the User SID that should be used to filter for sessions
// to fast reconnect to. This is used only in the case of Enhanced Fast
// Reconnect
//
// There are no inputs to this query.
//
...
// needs to set it to:
//          pPropertyEntriesOut[0].Type = WTS_VALUE_TYPE_STRING;
//          pPropertyEntriesOut[0].u.strVal.pstrVal = User SID to be used as
//          filter pPropertyEntriesOut[0].u.strVal.size = Length of User SID
//
EXTERN_C const _declspec(selectany) GUID
    ...
    {0x197c427a,
     0x0135,
     0x4b6d,
     {0x9c, 0x5e, 0xe6, 0x57, 0x9a, 0x0a, 0xb6, 0x25}};
...
// ******************
//
// This is used to get whether Universal Apps should be enabled or not for
// Custom shells based on the stack
//
// There are no inputs to this query.
//
// Output to this query - It passes 1 WTS_PROPERTY_VALUE structure. Protocol
// needs to set it to:
//          pPropertyEntriesOut[0].Type = WTS_VALUE_TYPE_ULONG;
//          pPropertyEntriesOut[0].u.ulVal = (0 = Don't enable Universal Apps
//          for Custom Shell, 1 = Enable Universal Apps for Custom Shell)
//
EXTERN_C const _declspec(selectany) GUID
    ...
    {0xed2c3fda,
     0x338d,
     0x4d3f,
     {0x81, 0xa3, 0xe7, 0x67, 0x31, 0x0d, 0x90, 0x8e}};
 ...
 *
 * There are the GUIDS that can be passed in to Get/Set Settings under
...
EXTERN_C const _declspec(selectany) GUID
    ...
    {0x693F7FF5,
     0x0C4E,
     0x4D17,
     {0xB8, 0xE0, 0x1F, 0x70, 0x32, 0x5E, 0x5D, 0x58}};
...
EXTERN_C const _declspec(selectany) GUID
    ...
    {0x4B150580,
     0xFEA4,
     0x4D3C,
     {0x9D, 0xE4, 0x74, 0x33, 0xA6, 0x66, 0x18, 0xF7}};
...
#define WTS_LICENSE_CURRENT_PROTOCOL_VERSION                                   \
  WTS_LICENSE_PROTOCOL_VERSION | WTS_LICENSE_PREAMBLE_VERSION
...
//
// KeyExchangeAlg       - The key exchange algorithm: RSA or Diffie Helman (see
// defines above) ProtocolVer          - The supported licensing protocol.
...
// CertType             - Indicate the type of certificate that has already been
// transmitted
//                        to the client.
...
#define WTS_LICENSE_CLIENT_NAME_BYTE_LENGTH                                    \
  (WTS_CLIENTNAME_LENGTH + 1) * sizeof(WCHAR)
...
} _WTS_LICENSE_CAPABILITIES, WTS_LICENSE_CAPABILITIES,
...
#define WRDS_LOGON_ERR_HANDLED_DONT_SHOW_START_OVER                            \
  WTS_LOGON_ERR_HANDLED_DONT_SHOW_START_OVER

typedef WTS_LOGON_ERROR_REDIRECTOR_RESPONSE
...
#define WRDS_LICENSE_CURRENT_PROTOCOL_VERSION                                  \
  WTS_LICENSE_CURRENT_PROTOCOL_VERSION
...
#ifdef __midl
  [range(0, 16384)] ULONG SecurityDescriptorSize;
  [size_is(SecurityDescriptorSize)] PBYTE pSecurityDescriptor;
#else
...
typedef[switch_type(WRDS_LISTENER_SETTING_LEVEL)] union _WRDS_LISTENER_SETTING {
  [case (WRDS_LISTENER_SETTING_LEVEL_1)] WRDS_LISTENER_SETTINGS_1
...
typedef struct _WRDS_LISTENER_SETTINGS {
  ...
  [switch_is(
      WRdsListenerSettingLevel)] WRDS_LISTENER_SETTING WRdsListenerSetting;
...
#ifdef __midl
  [range(0, 16384)] ULONG ContextSize;
  [size_is(ContextSize)] PBYTE ContextData;
#else
  ULONG ContextSize;
  PBYTE ContextData;
#endif
...
typedef[switch_type(
    WRDS_CONNECTION_SETTING_LEVEL)] union _WRDS_CONNECTION_SETTING {
  [case (WRDS_CONNECTION_SETTING_LEVEL_1)] WRDS_CONNECTION_SETTINGS_1
...
typedef struct _WRDS_CONNECTION_SETTINGS {
  ...
  [switch_is(WRdsConnectionSettingLevel)] WRDS_CONNECTION_SETTING
...
typedef[switch_type(WRDS_SETTING_LEVEL)] union _WRDS_SETTING {
  [case (WRDS_SETTING_LEVEL_1)] WRDS_SETTINGS_1 WRdsSettings1;
...
typedef struct _WRDS_SETTINGS {
  ...
  [switch_is(WRdsSettingLevel)] WRDS_SETTING WRdsSetting;
...
typedef struct _WTS_SERIALIZED_USER_CREDENTIAL {
  ...
  [size_is(SerializationLength)] BYTE *Serialization;
    ...
    WRDS_SERIALIZED_USER_CREDENTIAL, *PWRDS_SERIALIZED_USER_CREDENTIAL;
#else
