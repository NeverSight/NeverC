...
#define MAX_MEM_REGISTERS                                                      \
  9 // Win95 compatibility--not applicable to 32-bit ConfigMgr
#define MAX_IO_PORTS                                                           \
  20               // Win95 compatibility--not applicable to 32-bit ConfigMgr
#define MAX_IRQS 7 // Win95 compatibility--not applicable to 32-bit ConfigMgr
#define MAX_DMA_CHANNELS                                                       \
  7 // Win95 compatibility--not applicable to 32-bit ConfigMgr
...
//
typedef _Null_terminated_ CHAR *DEVNODEID_A,
    *DEVINSTID_A; // Device ID ANSI name.
typedef _Null_terminated_ WCHAR *DEVNODEID_W,
    *DEVINSTID_W; // Device ID Unicode name.
#ifdef UNICODE
...
typedef struct _CONFLICT_DETAILS_A {
  ...
  DEVINST CD_dnDevInst; // filled with DevInst of conflicting device if
                        // CM_CDMASK_DEVINST set
  RES_DES
  CD_rdResDes;      // filled with a ResDes of conflict if CM_CDMASK_RESDES set
...
#define CM_CDMASK_DEVINST                                                      \
  (0x00000001) // mask to retrieve CD_dnDevInst attribute for conflict
#define CM_CDMASK_RESDES                                                       \
  (0x00000002) // mask to retrieve CD_rdResDes attribute for conflict
#define CM_CDMASK_FLAGS                                                        \
  (0x00000004) // mask to retrieve CD_ulFlags attribute for conflict
#define CM_CDMASK_DESCRIPTION                                                  \
  (0x00000008) // mask to retrieve CD_szDescription attribute for conflict
#define CM_CDMASK_VALID (0x0000000F) // valid bits

#define CM_CDFLAGS_DRIVER                                                      \
  (0x00000001) // CD_ulFlags: CD_szDescription reports back legacy driver name
#define CM_CDFLAGS_ROOT_OWNED (0x00000002) // CD_ulFlags: Root owned device
#define CM_CDFLAGS_RESERVED                                                    \
  (0x00000004) // CD_ulFlags: Specified range is not available for use
...
//
#define CM_RESDES_WIDTH_DEFAULT                                                \
  (0x00000000) // 32 or 64-bit IRQ_RESOURCE / IRQ_DES, based on client
...
#define mPCD_MEM_WS                                                            \
  (0x300) // Bitmask, for additional wait states on memory windows
...
#define mPCD_MEM1_WS                                                           \
  (0x03000000) // MEM window 1 Bitmask, for additional wait states on memory
               // windows
...
#define mPCD_MEM2_WS                                                           \
  (0x30000000) // MEM window 2 Bitmask, for additional wait states on memory
               // windows
...
typedef struct Connection_Des_s {
  ...
  LARGE_INTEGER
  COND_Id; // unique connection identifier for use by this connection
...
#define ResType_DoNotUse                                                       \
  (0x00000005) // Used as spacer to sync subsequent ResTypes w/NT
...
#define CM_DISABLE_HARDWARE                                                    \
  (0x00000002) // Don't ask the driver, and won't be restarteable
#define CM_DISABLE_UI_NOT_OK (0x00000004) // Don't popup any veto API
#define CM_DISABLE_PERSIST                                                     \
  (0x00000008) // Persists through restart by setting CONFIGFLAG_DISABLED in the
               // registry
...
//
#define CM_GET_DEVICE_INTERFACE_LIST_PRESENT                                   \
  (0x00000000) // only currently 'live' device interfaces
#define CM_GET_DEVICE_INTERFACE_LIST_ALL_DEVICES                               \
  (0x00000001) // all registered device interfaces, live or not
#define CM_GET_DEVICE_INTERFACE_LIST_BITS (0x00000001)

//
// Registry properties (specified in call to CM_Get_DevInst_Registry_Property or
// CM_Get_Class_Registry_Property, some are allowed in calls to
// CM_Set_DevInst_Registry_Property and CM_Set_Class_Registry_Property)
// CM_DRP_xxxx values should be used for CM_Get_DevInst_Registry_Property /
// CM_Set_DevInst_Registry_Property CM_CRP_xxxx values should be used for
// CM_Get_Class_Registry_Property / CM_Set_Class_Registry_Property DRP/CRP
// values that overlap must have a 1:1 correspondence with each other
//
...
#define CM_DRP_COMPATIBLEIDS                                                   \
  (0x00000003)                      // CompatibleIDs REG_MULTI_SZ property (RW)
...
#define CM_DRP_LOCATION_INFORMATION                                            \
  (0x0000000E) // LocationInformation REG_SZ property (RW)
#define CM_DRP_PHYSICAL_DEVICE_OBJECT_NAME                                     \
  (0x0000000F) // PhysicalDeviceObjectName REG_SZ property (R)
...
#define CM_DRP_UPPERFILTERS                                                    \
  (0x00000012) // UpperFilters REG_MULTI_SZ property (RW)

#if (WINVER >= _WIN32_WINNT_LONGHORN)
#define CM_CRP_UPPERFILTERS                                                    \
  CM_DRP_UPPERFILTERS // UpperFilters REG_MULTI_SZ property (RW)
#endif                // (WINVER >= _WIN32_WINNT_LONGHORN)

#define CM_DRP_LOWERFILTERS                                                    \
  (0x00000013) // LowerFilters REG_MULTI_SZ property (RW)

#if (WINVER >= _WIN32_WINNT_LONGHORN)
#define CM_CRP_LOWERFILTERS                                                    \
  CM_DRP_LOWERFILTERS // LowerFilters REG_MULTI_SZ property (RW)
#endif                // (WINVER >= _WIN32_WINNT_LONGHORN)

#define CM_DRP_BUSTYPEGUID (0x00000014) // Bus Type Guid, GUID, (R)
#define CM_DRP_LEGACYBUSTYPE                                                   \
  (0x00000015)                        // Legacy bus type, INTERFACE_TYPE, (R)
#define CM_DRP_BUSNUMBER (0x00000016) // Bus Number, DWORD, (R)
#define CM_DRP_ENUMERATOR_NAME                                                 \
  (0x00000017)                           // Enumerator Name REG_SZ property (R)
...
#define CM_DRP_CHARACTERISTICS                                                 \
  (0x0000001C) // Characteristics - Device Override (RW)
...
#define CM_DRP_UI_NUMBER_DESC_FORMAT                                           \
  (0x0000001E) // UINumberDescFormat REG_SZ property (RW)

#if (WINVER >= _WIN32_WINNT_WINXP)
#define CM_DRP_DEVICE_POWER_DATA                                               \
  (0x0000001F) // CM_POWER_DATA REG_BINARY property (R)
#define CM_DRP_REMOVAL_POLICY                                                  \
  (0x00000020) // CM_DEVICE_REMOVAL_POLICY REG_DWORD (R)
#define CM_DRP_REMOVAL_POLICY_HW_DEFAULT                                       \
  (0x00000021) // CM_DRP_REMOVAL_POLICY_HW_DEFAULT REG_DWORD (R)
#define CM_DRP_REMOVAL_POLICY_OVERRIDE                                         \
  (0x00000022) // CM_DRP_REMOVAL_POLICY_OVERRIDE REG_DWORD (RW)
#define CM_DRP_INSTALL_STATE (0x00000023) // CM_DRP_INSTALL_STATE REG_DWORD (R)
#endif                                    // (WINVER >= _WIN32_WINNT_WINXP)

#if (WINVER >= _WIN32_WINNT_WS03)
#define CM_DRP_LOCATION_PATHS                                                  \
  (0x00000024) // CM_DRP_LOCATION_PATHS REG_MULTI_SZ (R)
#endif         // (WINVER >= _WIN32_WINNT_WS03)

#if (WINVER >= _WIN32_WINNT_WIN7)
#define CM_DRP_BASE_CONTAINERID                                                \
  (0x00000025) // Base ContainerID REG_SZ property (R)
#endif         // (WINVER >= _WIN32_WINNT_WIN7)
...
//
#define CM_SET_DEVNODE_PROBLEM_NORMAL                                          \
  (0x00000000) // only set problem if currently no problem
#define CM_SET_DEVNODE_PROBLEM_OVERRIDE                                        \
  (0x00000001) // override current problem with new problem
...
#if (WINVER >= _WIN32_WINNT_WINXP)
#define CM_SETUP_DEVNODE_RESET                                                 \
  (0x00000004) // Reset problem devinst without starting
#define CM_SETUP_DEVINST_RESET CM_SETUP_DEVNODE_RESET
#endif // (WINVER >= _WIN32_WINNT_WINXP)
#if (WINVER >= _WIN32_WINNT_WIN8)
#define CM_SETUP_DEVNODE_CONFIG                                                \
  (0x00000005) // Configure devinst without (re)starting
#define CM_SETUP_DEVINST_CONFIG CM_SETUP_DEVNODE_CONFIG
#define CM_SETUP_DEVNODE_CONFIG_CLASS                                          \
  (0x00000006) // Configure devinst class without (re)starting
#define CM_SETUP_DEVINST_CONFIG_CLASS CM_SETUP_DEVNODE_CONFIG_CLASS
#endif // (WINVER >= _WIN32_WINNT_WIN8)
#if (WINVER >= _WIN32_WINNT_WINBLUE)
#define CM_SETUP_DEVNODE_CONFIG_EXTENSIONS                                     \
  (0x00000007) // Configure devinst extensions without (re)starting
#define CM_SETUP_DEVINST_CONFIG_EXTENSIONS CM_SETUP_DEVNODE_CONFIG_EXTENSIONS
#endif // (WINVER >= _WIN32_WINNT_WINBLUE)
#if (WINVER >= _WIN32_WINNT_WINTHRESHOLD)
#define CM_SETUP_DEVNODE_CONFIG_RESET                                          \
  (0x00000008) // Reset devinst configuration without (re)starting
...
_Pre_satisfies_(EventDataSize >=
                sizeof(CM_NOTIFY_EVENT_DATA)) typedef __callback
    DWORD(CALLBACK *PCM_NOTIFY_CALLBACK)(_In_ HCMNOTIFICATION hNotify,
                                         _In_opt_ PVOID Context,
                                         _In_ CM_NOTIFY_ACTION Action,
                                         _In_reads_bytes_(EventDataSize)
...
CONFIGRET
WINAPI
CM_Add_Empty_Log_Conf(_Out_ PLOG_CONF plcLogConf, _In_ DEVINST dnDevInst,
                      _In_ PRIORITY Priority, _In_ ULONG ulFlags);

CMAPI
CONFIGRET
WINAPI
CM_Add_Empty_Log_Conf_Ex(_Out_ PLOG_CONF plcLogConf, _In_ DEVINST dnDevInst,
                         _In_ PRIORITY Priority, _In_ ULONG ulFlags,
...
CONFIGRET
WINAPI
CM_Add_IDA(_In_ DEVINST dnDevInst, _In_ PSTR pszID, _In_ ULONG ulFlags);

CMAPI
CONFIGRET
WINAPI
CM_Add_IDW(_In_ DEVINST dnDevInst, _In_ PWSTR pszID, _In_ ULONG ulFlags);

CMAPI
CONFIGRET
WINAPI
CM_Add_ID_ExA(_In_ DEVINST dnDevInst, _In_ PSTR pszID, _In_ ULONG ulFlags,
              _In_opt_ HMACHINE hMachine);

CMAPI
CONFIGRET
WINAPI
CM_Add_ID_ExW(_In_ DEVINST dnDevInst, _In_ PWSTR pszID, _In_ ULONG ulFlags,
              _In_opt_ HMACHINE hMachine);
...
CONFIGRET
WINAPI
CM_Add_Range(_In_ DWORDLONG ullStartValue, _In_ DWORDLONG ullEndValue,
             _In_ RANGE_LIST rlh, _In_ ULONG ulFlags);

CMAPI
CONFIGRET
WINAPI
CM_Add_Res_Des(_Out_opt_ PRES_DES prdResDes, _In_ LOG_CONF lcLogConf,
               _In_ RESOURCEID ResourceID,
               _In_reads_bytes_(ResourceLen) PCVOID ResourceData,
               _In_ ULONG ResourceLen, _In_ ULONG ulFlags);

CMAPI
CONFIGRET
WINAPI
CM_Add_Res_Des_Ex(_Out_opt_ PRES_DES prdResDes, _In_ LOG_CONF lcLogConf,
                  _In_ RESOURCEID ResourceID,
                  _In_reads_bytes_(ResourceLen) PCVOID ResourceData,
                  _In_ ULONG ResourceLen, _In_ ULONG ulFlags,
                  _In_opt_ HMACHINE hMachine);
...
CONFIGRET
WINAPI
CM_Connect_MachineA(_In_opt_ PCSTR UNCServerName, _Out_ PHMACHINE phMachine);

CMAPI
CONFIGRET
WINAPI
CM_Connect_MachineW(_In_opt_ PCWSTR UNCServerName, _Out_ PHMACHINE phMachine);
#ifdef UNICODE
...
CONFIGRET
WINAPI
CM_Create_DevNodeA(_Out_ PDEVINST pdnDevInst, _In_ DEVINSTID_A pDeviceID,
                   _In_ DEVINST dnParent, _In_ ULONG ulFlags);

CMAPI
CONFIGRET
WINAPI
CM_Create_DevNodeW(_Out_ PDEVINST pdnDevInst, _In_ DEVINSTID_W pDeviceID,
                   _In_ DEVINST dnParent, _In_ ULONG ulFlags);

CMAPI
CONFIGRET
WINAPI
CM_Create_DevNode_ExA(_Out_ PDEVINST pdnDevInst, _In_ DEVINSTID_A pDeviceID,
                      _In_ DEVINST dnParent, _In_ ULONG ulFlags,
                      _In_opt_ HMACHINE hMachine);
...
CONFIGRET
WINAPI
CM_Create_DevNode_ExW(_Out_ PDEVINST pdnDevInst, _In_ DEVINSTID_W pDeviceID,
                      _In_ DEVINST dnParent, _In_ ULONG ulFlags,
                      _In_opt_ HMACHINE hMachine);
...
CONFIGRET
WINAPI
CM_Create_Range_List(_Out_ PRANGE_LIST prlh, _In_ ULONG ulFlags);
...
CONFIGRET
WINAPI
CM_Delete_Class_Key(_In_ LPGUID ClassGuid, _In_ ULONG ulFlags);
...
CONFIGRET
WINAPI
CM_Delete_Class_Key_Ex(_In_ LPGUID ClassGuid, _In_ ULONG ulFlags,
                       _In_opt_ HMACHINE hMachine);
...
CONFIGRET
WINAPI
CM_Delete_DevNode_Key(_In_ DEVNODE dnDevNode, _In_ ULONG ulHardwareProfile,
                      _In_ ULONG ulFlags);
...
CONFIGRET
WINAPI
CM_Delete_DevNode_Key_Ex(_In_ DEVNODE dnDevNode, _In_ ULONG ulHardwareProfile,
                         _In_ ULONG ulFlags, _In_opt_ HMACHINE hMachine);
...
CONFIGRET
WINAPI
CM_Delete_Range(_In_ DWORDLONG ullStartValue, _In_ DWORDLONG ullEndValue,
                _In_ RANGE_LIST rlh, _In_ ULONG ulFlags);

__drv_preferredFunction("CM_Query_Resource_Conflict_List",
                        "Obsolete") CMAPI CONFIGRET WINAPI
    CM_Detect_Resource_Conflict(_In_ DEVINST dnDevInst,
                                _In_ RESOURCEID ResourceID,
                                _In_reads_bytes_(ResourceLen)
                                    PCVOID ResourceData,
...
__drv_preferredFunction("CM_Query_Resource_Conflict_List",
    ...
    CM_Detect_Resource_Conflict_Ex(
        _In_ DEVINST dnDevInst, _In_ RESOURCEID ResourceID,
        _In_reads_bytes_(ResourceLen) PCVOID ResourceData,
        _In_ ULONG ResourceLen, _Out_ PBOOL pbConflictDetected,
        _In_ ULONG ulFlags, _In_opt_ HMACHINE hMachine);
...
CONFIGRET
WINAPI
CM_Disable_DevNode(_In_ DEVINST dnDevInst, _In_ ULONG ulFlags);
...
CONFIGRET
WINAPI
CM_Disable_DevNode_Ex(_In_ DEVINST dnDevInst, _In_ ULONG ulFlags,
                      _In_opt_ HMACHINE hMachine);
...
CONFIGRET
WINAPI
CM_Disconnect_Machine(_In_opt_ HMACHINE hMachine);

CMAPI
CONFIGRET
WINAPI
CM_Dup_Range_List(_In_ RANGE_LIST rlhOld, _In_ RANGE_LIST rlhNew,
                  _In_ ULONG ulFlags);
...
CONFIGRET
WINAPI
CM_Enable_DevNode(_In_ DEVINST dnDevInst, _In_ ULONG ulFlags);
...
CONFIGRET
WINAPI
CM_Enable_DevNode_Ex(_In_ DEVINST dnDevInst, _In_ ULONG ulFlags,
                     _In_opt_ HMACHINE hMachine);
...
CONFIGRET
WINAPI
CM_Enumerate_Classes(_In_ ULONG ulClassIndex, _Out_ LPGUID ClassGuid,
                     _In_ ULONG ulFlags);

CMAPI
CONFIGRET
WINAPI
CM_Enumerate_Classes_Ex(_In_ ULONG ulClassIndex, _Out_ LPGUID ClassGuid,
                        _In_ ULONG ulFlags, _In_opt_ HMACHINE hMachine);

CMAPI
CONFIGRET
WINAPI
CM_Enumerate_EnumeratorsA(_In_ ULONG ulEnumIndex,
                          _Out_writes_(*pulLength) PSTR Buffer,
                          _Inout_ PULONG pulLength, _In_ ULONG ulFlags);

CMAPI
CONFIGRET
WINAPI
CM_Enumerate_EnumeratorsW(_In_ ULONG ulEnumIndex,
...
CONFIGRET
WINAPI
CM_Enumerate_Enumerators_ExA(_In_ ULONG ulEnumIndex,
                             _Out_writes_(*pulLength) PSTR Buffer,
                             _Inout_ PULONG pulLength, _In_ ULONG ulFlags,
                             _In_opt_ HMACHINE hMachine);
...
CONFIGRET
WINAPI
CM_Enumerate_Enumerators_ExW(_In_ ULONG ulEnumIndex,
                             _Out_writes_(*pulLength) PWSTR Buffer,
                             _Inout_ PULONG pulLength, _In_ ULONG ulFlags,
                             _In_opt_ HMACHINE hMachine);
...
CONFIGRET
WINAPI
CM_Find_Range(_Out_ PDWORDLONG pullStart, _In_ DWORDLONG ullStart,
              _In_ ULONG ulLength, _In_ DWORDLONG ullAlignment,
              _In_ DWORDLONG ullEnd, _In_ RANGE_LIST rlh, _In_ ULONG ulFlags);

CMAPI
CONFIGRET
WINAPI
CM_First_Range(_In_ RANGE_LIST rlh, _Out_ PDWORDLONG pullStart,
               _Out_ PDWORDLONG pullEnd, _Out_ PRANGE_ELEMENT preElement,
               _In_ ULONG ulFlags);

CMAPI
CONFIGRET
WINAPI
CM_Free_Log_Conf(_In_ LOG_CONF lcLogConfToBeFreed, _In_ ULONG ulFlags);

CMAPI
CONFIGRET
WINAPI
CM_Free_Log_Conf_Ex(_In_ LOG_CONF lcLogConfToBeFreed, _In_ ULONG ulFlags,
                    _In_opt_ HMACHINE hMachine);

CMAPI
CONFIGRET
WINAPI
CM_Free_Log_Conf_Handle(_In_ LOG_CONF lcLogConf);

CMAPI
CONFIGRET
WINAPI
CM_Free_Range_List(_In_ RANGE_LIST rlh, _In_ ULONG ulFlags);

CMAPI
CONFIGRET
WINAPI
CM_Free_Res_Des(_Out_opt_ PRES_DES prdResDes, _In_ RES_DES rdResDes,
                _In_ ULONG ulFlags);

CMAPI
CONFIGRET
WINAPI
CM_Free_Res_Des_Ex(_Out_opt_ PRES_DES prdResDes, _In_ RES_DES rdResDes,
                   _In_ ULONG ulFlags, _In_opt_ HMACHINE hMachine);

CMAPI
CONFIGRET
WINAPI
CM_Free_Res_Des_Handle(_In_ RES_DES rdResDes);
...
CONFIGRET
WINAPI
CM_Get_Child(_Out_ PDEVINST pdnDevInst, _In_ DEVINST dnDevInst,
             _In_ ULONG ulFlags);
...
CONFIGRET
WINAPI
CM_Get_Child_Ex(_Out_ PDEVINST pdnDevInst, _In_ DEVINST dnDevInst,
                _In_ ULONG ulFlags, _In_opt_ HMACHINE hMachine);

CMAPI
CONFIGRET
WINAPI
CM_Get_Class_NameA(_In_ LPGUID ClassGuid,
...
CONFIGRET
WINAPI
CM_Get_Class_NameW(_In_ LPGUID ClassGuid,
...
CONFIGRET
WINAPI
CM_Get_Class_Name_ExA(_In_ LPGUID ClassGuid,
                      _Out_writes_opt_(*pulLength) PSTR Buffer,
                      _Inout_ PULONG pulLength, _In_ ULONG ulFlags,
                      _In_opt_ HMACHINE hMachine);
...
CONFIGRET
WINAPI
CM_Get_Class_Name_ExW(_In_ LPGUID ClassGuid,
                      _Out_writes_opt_(*pulLength) PWSTR Buffer,
                      _Inout_ PULONG pulLength, _In_ ULONG ulFlags,
                      _In_opt_ HMACHINE hMachine);
...
CONFIGRET
WINAPI
CM_Get_Class_Key_NameA(_In_ LPGUID ClassGuid,
...
CONFIGRET
WINAPI
CM_Get_Class_Key_NameW(_In_ LPGUID ClassGuid,
...
CONFIGRET
WINAPI
CM_Get_Class_Key_Name_ExA(_In_ LPGUID ClassGuid,
                          _Out_writes_opt_(*pulLength) LPSTR pszKeyName,
                          _Inout_ PULONG pulLength, _In_ ULONG ulFlags,
                          _In_opt_ HMACHINE hMachine);
...
CONFIGRET
WINAPI
CM_Get_Class_Key_Name_ExW(_In_ LPGUID ClassGuid,
                          _Out_writes_opt_(*pulLength) LPWSTR pszKeyName,
                          _Inout_ PULONG pulLength, _In_ ULONG ulFlags,
                          _In_opt_ HMACHINE hMachine);
...
CONFIGRET
WINAPI
CM_Get_Depth(_Out_ PULONG pulDepth, _In_ DEVINST dnDevInst, _In_ ULONG ulFlags);
...
CONFIGRET
WINAPI
CM_Get_Depth_Ex(_Out_ PULONG pulDepth, _In_ DEVINST dnDevInst,
                _In_ ULONG ulFlags, _In_opt_ HMACHINE hMachine);
...
CONFIGRET
WINAPI
CM_Get_Device_IDA(_In_ DEVINST dnDevInst, _Out_writes_(BufferLen) PSTR Buffer,
                  _In_ ULONG BufferLen, _In_ ULONG ulFlags);

CMAPI
CONFIGRET
WINAPI
CM_Get_Device_IDW(_In_ DEVINST dnDevInst, _Out_writes_(BufferLen) PWSTR Buffer,
                  _In_ ULONG BufferLen, _In_ ULONG ulFlags);
...
CONFIGRET
WINAPI
CM_Get_Device_ID_ExA(_In_ DEVINST dnDevInst,
                     _Out_writes_(BufferLen) PSTR Buffer, _In_ ULONG BufferLen,
                     _In_ ULONG ulFlags, _In_opt_ HMACHINE hMachine);

CMAPI
CONFIGRET
WINAPI
CM_Get_Device_ID_ExW(_In_ DEVINST dnDevInst,
                     _Out_writes_(BufferLen) PWSTR Buffer, _In_ ULONG BufferLen,
                     _In_ ULONG ulFlags, _In_opt_ HMACHINE hMachine);
...
CONFIGRET
WINAPI
CM_Get_Device_ID_ListA(_In_opt_ PCSTR pszFilter,
...
CONFIGRET
WINAPI
CM_Get_Device_ID_ListW(_In_opt_ PCWSTR pszFilter,
...
CONFIGRET
WINAPI
CM_Get_Device_ID_List_ExA(_In_opt_ PCSTR pszFilter,
                          _Out_writes_(BufferLen) PZZSTR Buffer,
                          _In_ ULONG BufferLen, _In_ ULONG ulFlags,
                          _In_opt_ HMACHINE hMachine);
...
CONFIGRET
WINAPI
CM_Get_Device_ID_List_ExW(_In_opt_ PCWSTR pszFilter,
                          _Out_writes_(BufferLen) PZZWSTR Buffer,
                          _In_ ULONG BufferLen, _In_ ULONG ulFlags,
                          _In_opt_ HMACHINE hMachine);
...
CONFIGRET
WINAPI
CM_Get_Device_ID_List_SizeA(_Out_ PULONG pulLen, _In_opt_ PCSTR pszFilter,
                            _In_ ULONG ulFlags);

CMAPI
CONFIGRET
WINAPI
CM_Get_Device_ID_List_SizeW(_Out_ PULONG pulLen, _In_opt_ PCWSTR pszFilter,
                            _In_ ULONG ulFlags);
...
CONFIGRET
WINAPI
CM_Get_Device_ID_List_Size_ExA(_Out_ PULONG pulLen, _In_opt_ PCSTR pszFilter,
                               _In_ ULONG ulFlags, _In_opt_ HMACHINE hMachine);

CMAPI
CONFIGRET
WINAPI
CM_Get_Device_ID_List_Size_ExW(_Out_ PULONG pulLen, _In_opt_ PCWSTR pszFilter,
                               _In_ ULONG ulFlags, _In_opt_ HMACHINE hMachine);
...
CONFIGRET
WINAPI
CM_Get_Device_ID_Size(_Out_ PULONG pulLen, _In_ DEVINST dnDevInst,
                      _In_ ULONG ulFlags);
...
CONFIGRET
WINAPI
CM_Get_Device_ID_Size_Ex(_Out_ PULONG pulLen, _In_ DEVINST dnDevInst,
                         _In_ ULONG ulFlags, _In_opt_ HMACHINE hMachine);
...
CONFIGRET
WINAPI
CM_Get_DevNode_PropertyW(_In_ DEVINST dnDevInst,
                         _In_ CONST DEVPROPKEY *PropertyKey,
                         _Out_ DEVPROPTYPE *PropertyType,
                         _Out_writes_bytes_opt_(*PropertyBufferSize)
                             PBYTE PropertyBuffer,
                         _Inout_ PULONG PropertyBufferSize, _In_ ULONG ulFlags);
...
CONFIGRET
WINAPI
CM_Get_DevNode_Property_ExW(_In_ DEVINST dnDevInst,
                            _In_ CONST DEVPROPKEY *PropertyKey,
                            _Out_ DEVPROPTYPE *PropertyType,
                            _Out_writes_bytes_opt_(*PropertyBufferSize)
                                PBYTE PropertyBuffer,
...
CONFIGRET
WINAPI
CM_Get_DevNode_Property_Keys(_In_ DEVINST dnDevInst,
                             _Out_writes_opt_(*PropertyKeyCount)
...
CONFIGRET
WINAPI
CM_Get_DevNode_Property_Keys_Ex(_In_ DEVINST dnDevInst,
                                _Out_writes_opt_(*PropertyKeyCount)
                                    DEVPROPKEY *PropertyKeyArray,
                                _Inout_ PULONG PropertyKeyCount,
                                _In_ ULONG ulFlags, _In_opt_ HMACHINE hMachine);
...
CONFIGRET
WINAPI
CM_Get_DevNode_Registry_PropertyA(_In_ DEVINST dnDevInst, _In_ ULONG ulProperty,
                                  _Out_opt_ PULONG pulRegDataType,
                                  _Out_writes_bytes_opt_(*pulLength)
                                      PVOID Buffer,
                                  _Inout_ PULONG pulLength, _In_ ULONG ulFlags);
...
CONFIGRET
WINAPI
CM_Get_DevNode_Registry_PropertyW(_In_ DEVINST dnDevInst, _In_ ULONG ulProperty,
                                  _Out_opt_ PULONG pulRegDataType,
                                  _Out_writes_bytes_opt_(*pulLength)
                                      PVOID Buffer,
                                  _Inout_ PULONG pulLength, _In_ ULONG ulFlags);
...
CM_Get_DevNode_Registry_Property_ExA(
    _In_ DEVINST dnDevInst, _In_ ULONG ulProperty,
    _Out_opt_ PULONG pulRegDataType,
    _Out_writes_bytes_opt_(*pulLength) PVOID Buffer, _Inout_ PULONG pulLength,
    _In_ ULONG ulFlags, _In_opt_ HMACHINE hMachine);
...
CONFIGRET
WINAPI
CM_Get_DevNode_Custom_PropertyA(_In_ DEVINST dnDevInst,
...
CONFIGRET
WINAPI
CM_Get_DevNode_Custom_PropertyW(_In_ DEVINST dnDevInst,
...
CONFIGRET
WINAPI
CM_Get_DevNode_Custom_Property_ExA(_In_ DEVINST dnDevInst,
                                   _In_ PCSTR pszCustomPropertyName,
                                   _Out_opt_ PULONG pulRegDataType,
                                   _Out_writes_bytes_opt_(*pulLength)
                                       PVOID Buffer,
...
CONFIGRET
WINAPI
CM_Get_DevNode_Custom_Property_ExW(_In_ DEVINST dnDevInst,
                                   _In_ PCWSTR pszCustomPropertyName,
                                   _Out_opt_ PULONG pulRegDataType,
                                   _Out_writes_bytes_opt_(*pulLength)
                                       PVOID Buffer,
...
CONFIGRET
WINAPI
CM_Get_DevNode_Status(_Out_ PULONG pulStatus, _Out_ PULONG pulProblemNumber,
                      _In_ DEVINST dnDevInst, _In_ ULONG ulFlags);
...
CONFIGRET
WINAPI
CM_Get_DevNode_Status_Ex(_Out_ PULONG pulStatus, _Out_ PULONG pulProblemNumber,
                         _In_ DEVINST dnDevInst, _In_ ULONG ulFlags,
                         _In_opt_ HMACHINE hMachine);
...
CONFIGRET
WINAPI
CM_Get_First_Log_Conf(_Out_opt_ PLOG_CONF plcLogConf, _In_ DEVINST dnDevInst,
                      _In_ ULONG ulFlags);

CMAPI
CONFIGRET
WINAPI
CM_Get_First_Log_Conf_Ex(_Out_opt_ PLOG_CONF plcLogConf, _In_ DEVINST dnDevInst,
                         _In_ ULONG ulFlags, _In_opt_ HMACHINE hMachine);

CMAPI
CONFIGRET
WINAPI
CM_Get_Global_State(_Out_ PULONG pulState, _In_ ULONG ulFlags);

CMAPI
CONFIGRET
WINAPI
CM_Get_Global_State_Ex(_Out_ PULONG pulState, _In_ ULONG ulFlags,
                       _In_opt_ HMACHINE hMachine);
...
#if (WINVER >= _WIN32_WINNT_WIN7)
#define CM_GLOBAL_STATE_REBOOT_REQUIRED                                        \
  (0x00000020) // system reboot is required
#endif         // (WINVER >= _WIN32_WINNT_WIN7)

CMAPI
CONFIGRET
WINAPI
CM_Get_Hardware_Profile_InfoA(_In_ ULONG ulIndex,
...
CONFIGRET
WINAPI
CM_Get_Hardware_Profile_Info_ExA(_In_ ULONG ulIndex,
                                 _Out_ PHWPROFILEINFO_A pHWProfileInfo,
                                 _In_ ULONG ulFlags,
                                 _In_opt_ HMACHINE hMachine);
CMAPI
CONFIGRET
WINAPI
CM_Get_Hardware_Profile_InfoW(_In_ ULONG ulIndex,
...
CONFIGRET
WINAPI
CM_Get_Hardware_Profile_Info_ExW(_In_ ULONG ulIndex,
                                 _Out_ PHWPROFILEINFO_W pHWProfileInfo,
                                 _In_ ULONG ulFlags,
                                 _In_opt_ HMACHINE hMachine);
...
CONFIGRET
WINAPI
CM_Get_HW_Prof_FlagsA(_In_ DEVINSTID_A pDeviceID, _In_ ULONG ulHardwareProfile,
                      _Out_ PULONG pulValue, _In_ ULONG ulFlags);

CMAPI
CONFIGRET
WINAPI
CM_Get_HW_Prof_FlagsW(_In_ DEVINSTID_W pDeviceID, _In_ ULONG ulHardwareProfile,
                      _Out_ PULONG pulValue, _In_ ULONG ulFlags);

CMAPI
CONFIGRET
WINAPI
CM_Get_HW_Prof_Flags_ExA(_In_ DEVINSTID_A pDeviceID,
                         _In_ ULONG ulHardwareProfile, _Out_ PULONG pulValue,
                         _In_ ULONG ulFlags, _In_opt_ HMACHINE hMachine);

CMAPI
CONFIGRET
WINAPI
CM_Get_HW_Prof_Flags_ExW(_In_ DEVINSTID_W pDeviceID,
                         _In_ ULONG ulHardwareProfile, _Out_ PULONG pulValue,
                         _In_ ULONG ulFlags, _In_opt_ HMACHINE hMachine);
...
CONFIGRET
WINAPI
CM_Get_Device_Interface_AliasA(_In_ LPCSTR pszDeviceInterface,
                               _In_ LPGUID AliasInterfaceGuid,
                               _Out_writes_(*pulLength)
...
CONFIGRET
WINAPI
CM_Get_Device_Interface_AliasW(_In_ LPCWSTR pszDeviceInterface,
                               _In_ LPGUID AliasInterfaceGuid,
                               _Out_writes_(*pulLength)
...
CONFIGRET
WINAPI
CM_Get_Device_Interface_Alias_ExA(_In_ LPCSTR pszDeviceInterface,
                                  _In_ LPGUID AliasInterfaceGuid,
                                  _Out_writes_(*pulLength)
                                      LPSTR pszAliasDeviceInterface,
                                  _Inout_ PULONG pulLength, _In_ ULONG ulFlags,
...
CONFIGRET
WINAPI
CM_Get_Device_Interface_Alias_ExW(_In_ LPCWSTR pszDeviceInterface,
                                  _In_ LPGUID AliasInterfaceGuid,
                                  _Out_writes_(*pulLength)
                                      LPWSTR pszAliasDeviceInterface,
                                  _Inout_ PULONG pulLength, _In_ ULONG ulFlags,
...
CONFIGRET
WINAPI
CM_Get_Device_Interface_ListA(_In_ LPGUID InterfaceClassGuid,
...
CONFIGRET
WINAPI
CM_Get_Device_Interface_ListW(_In_ LPGUID InterfaceClassGuid,
...
CONFIGRET
WINAPI
CM_Get_Device_Interface_List_ExA(_In_ LPGUID InterfaceClassGuid,
                                 _In_opt_ DEVINSTID_A pDeviceID,
                                 _Out_writes_(BufferLen) PZZSTR Buffer,
                                 _In_ ULONG BufferLen, _In_ ULONG ulFlags,
                                 _In_opt_ HMACHINE hMachine);
...
CONFIGRET
WINAPI
CM_Get_Device_Interface_List_ExW(_In_ LPGUID InterfaceClassGuid,
                                 _In_opt_ DEVINSTID_W pDeviceID,
                                 _Out_writes_(BufferLen) PZZWSTR Buffer,
                                 _In_ ULONG BufferLen, _In_ ULONG ulFlags,
                                 _In_opt_ HMACHINE hMachine);
...
CONFIGRET
WINAPI
CM_Get_Device_Interface_List_SizeA(_Out_ PULONG pulLen,
...
CONFIGRET
WINAPI
CM_Get_Device_Interface_List_SizeW(_Out_ PULONG pulLen,
                                   _In_ LPGUID InterfaceClassGuid,
                                   _In_opt_ DEVINSTID_W pDeviceID,
                                   _In_ ULONG ulFlags);
...
CONFIGRET
WINAPI
CM_Get_Device_Interface_List_Size_ExA(_Out_ PULONG pulLen,
                                      _In_ LPGUID InterfaceClassGuid,
                                      _In_opt_ DEVINSTID_A pDeviceID,
                                      _In_ ULONG ulFlags,
                                      _In_opt_ HMACHINE hMachine);
...
CONFIGRET
WINAPI
CM_Get_Device_Interface_List_Size_ExW(_Out_ PULONG pulLen,
                                      _In_ LPGUID InterfaceClassGuid,
                                      _In_opt_ DEVINSTID_W pDeviceID,
                                      _In_ ULONG ulFlags,
                                      _In_opt_ HMACHINE hMachine);
...
CONFIGRET
WINAPI
CM_Get_Device_Interface_PropertyW(_In_ LPCWSTR pszDeviceInterface,
                                  _In_ CONST DEVPROPKEY *PropertyKey,
                                  _Out_ DEVPROPTYPE *PropertyType,
                                  _Out_writes_bytes_opt_(*PropertyBufferSize)
                                      PBYTE PropertyBuffer,
...
CONFIGRET
WINAPI
CM_Get_Device_Interface_Property_ExW(_In_ LPCWSTR pszDeviceInterface,
                                     _In_ CONST DEVPROPKEY *PropertyKey,
                                     _Out_ DEVPROPTYPE *PropertyType,
                                     _Out_writes_bytes_opt_(*PropertyBufferSize)
                                         PBYTE PropertyBuffer,
...
CONFIGRET
WINAPI
CM_Get_Device_Interface_Property_KeysW(_In_ LPCWSTR pszDeviceInterface,
                                       _Out_writes_opt_(*PropertyKeyCount)
                                           DEVPROPKEY *PropertyKeyArray,
                                       _Inout_ PULONG PropertyKeyCount,
                                       _In_ ULONG ulFlags);
...
CONFIGRET
WINAPI
CM_Get_Device_Interface_Property_Keys_ExW(_In_ LPCWSTR pszDeviceInterface,
                                          _Out_writes_opt_(*PropertyKeyCount)
                                              DEVPROPKEY *PropertyKeyArray,
                                          _Inout_ PULONG PropertyKeyCount,
                                          _In_ ULONG ulFlags,
...
CONFIGRET
WINAPI
CM_Get_Log_Conf_Priority(_In_ LOG_CONF lcLogConf, _Out_ PPRIORITY pPriority,
                         _In_ ULONG ulFlags);

CMAPI
CONFIGRET
WINAPI
CM_Get_Log_Conf_Priority_Ex(_In_ LOG_CONF lcLogConf, _Out_ PPRIORITY pPriority,
                            _In_ ULONG ulFlags, _In_opt_ HMACHINE hMachine);

CMAPI
CONFIGRET
WINAPI
CM_Get_Next_Log_Conf(_Out_opt_ PLOG_CONF plcLogConf, _In_ LOG_CONF lcLogConf,
                     _In_ ULONG ulFlags);

CMAPI
CONFIGRET
WINAPI
CM_Get_Next_Log_Conf_Ex(_Out_opt_ PLOG_CONF plcLogConf, _In_ LOG_CONF lcLogConf,
                        _In_ ULONG ulFlags, _In_opt_ HMACHINE hMachine);
...
CONFIGRET
WINAPI
CM_Get_Parent(_Out_ PDEVINST pdnDevInst, _In_ DEVINST dnDevInst,
              _In_ ULONG ulFlags);
...
CONFIGRET
WINAPI
CM_Get_Parent_Ex(_Out_ PDEVINST pdnDevInst, _In_ DEVINST dnDevInst,
                 _In_ ULONG ulFlags, _In_opt_ HMACHINE hMachine);

CMAPI
CONFIGRET
WINAPI
CM_Get_Res_Des_Data(_In_ RES_DES rdResDes,
...
CONFIGRET
WINAPI
CM_Get_Res_Des_Data_Ex(_In_ RES_DES rdResDes,
                       _Out_writes_bytes_(BufferLen) PVOID Buffer,
                       _In_ ULONG BufferLen, _In_ ULONG ulFlags,
                       _In_opt_ HMACHINE hMachine);
...
CONFIGRET
WINAPI
CM_Get_Res_Des_Data_Size(_Out_ PULONG pulSize, _In_ RES_DES rdResDes,
                         _In_ ULONG ulFlags);

CMAPI
CONFIGRET
WINAPI
CM_Get_Res_Des_Data_Size_Ex(_Out_ PULONG pulSize, _In_ RES_DES rdResDes,
                            _In_ ULONG ulFlags, _In_opt_ HMACHINE hMachine);
...
CONFIGRET
WINAPI
CM_Get_Sibling(_Out_ PDEVINST pdnDevInst, _In_ DEVINST dnDevInst,
               _In_ ULONG ulFlags);
...
CONFIGRET
WINAPI
CM_Get_Sibling_Ex(_Out_ PDEVINST pdnDevInst, _In_ DEVINST dnDevInst,
                  _In_ ULONG ulFlags, _In_opt_ HMACHINE hMachine);
...
CONFIGRET
WINAPI
CM_Intersect_Range_List(_In_ RANGE_LIST rlhOld1, _In_ RANGE_LIST rlhOld2,
                        _In_ RANGE_LIST rlhNew, _In_ ULONG ulFlags);

CMAPI
CONFIGRET
WINAPI
CM_Invert_Range_List(_In_ RANGE_LIST rlhOld, _In_ RANGE_LIST rlhNew,
                     _In_ DWORDLONG ullMaxValue, _In_ ULONG ulFlags);
...
CONFIGRET
WINAPI
CM_Locate_DevNodeA(_Out_ PDEVINST pdnDevInst, _In_opt_ DEVINSTID_A pDeviceID,
                   _In_ ULONG ulFlags);

CMAPI
CONFIGRET
WINAPI
CM_Locate_DevNodeW(_Out_ PDEVINST pdnDevInst, _In_opt_ DEVINSTID_W pDeviceID,
                   _In_ ULONG ulFlags);
...
CONFIGRET
WINAPI
CM_Locate_DevNode_ExA(_Out_ PDEVINST pdnDevInst, _In_opt_ DEVINSTID_A pDeviceID,
                      _In_ ULONG ulFlags, _In_opt_ HMACHINE hMachine);
CMAPI
CONFIGRET
WINAPI
CM_Locate_DevNode_ExW(_Out_ PDEVINST pdnDevInst, _In_opt_ DEVINSTID_W pDeviceID,
                      _In_ ULONG ulFlags, _In_opt_ HMACHINE hMachine);
...
CONFIGRET
WINAPI
CM_Merge_Range_List(_In_ RANGE_LIST rlhOld1, _In_ RANGE_LIST rlhOld2,
                    _In_ RANGE_LIST rlhNew, _In_ ULONG ulFlags);

CMAPI
CONFIGRET
WINAPI
CM_Modify_Res_Des(_Out_ PRES_DES prdResDes, _In_ RES_DES rdResDes,
                  _In_ RESOURCEID ResourceID,
                  _In_reads_bytes_(ResourceLen) PCVOID ResourceData,
                  _In_ ULONG ResourceLen, _In_ ULONG ulFlags);
...
CONFIGRET
WINAPI
CM_Modify_Res_Des_Ex(_Out_ PRES_DES prdResDes, _In_ RES_DES rdResDes,
                     _In_ RESOURCEID ResourceID,
                     _In_reads_bytes_(ResourceLen) PCVOID ResourceData,
                     _In_ ULONG ResourceLen, _In_ ULONG ulFlags,
                     _In_opt_ HMACHINE hMachine);
...
CONFIGRET
WINAPI
CM_Move_DevNode(_In_ DEVINST dnFromDevInst, _In_ DEVINST dnToDevInst,
                _In_ ULONG ulFlags);

CMAPI
CONFIGRET
WINAPI
CM_Move_DevNode_Ex(_In_ DEVINST dnFromDevInst, _In_ DEVINST dnToDevInst,
                   _In_ ULONG ulFlags, _In_opt_ HMACHINE hMachine);
...
CONFIGRET
WINAPI
CM_Next_Range(_Inout_ PRANGE_ELEMENT preElement, _Out_ PDWORDLONG pullStart,
              _Out_ PDWORDLONG pullEnd, _In_ ULONG ulFlags);

CMAPI
CONFIGRET
WINAPI
CM_Get_Next_Res_Des(_Out_ PRES_DES prdResDes, _In_ RES_DES rdResDes,
                    _In_ RESOURCEID ForResource,
                    _Out_opt_ PRESOURCEID pResourceID, _In_ ULONG ulFlags);

CMAPI
CONFIGRET
WINAPI
CM_Get_Next_Res_Des_Ex(_Out_ PRES_DES prdResDes, _In_ RES_DES rdResDes,
                       _In_ RESOURCEID ForResource,
                       _Out_opt_ PRESOURCEID pResourceID, _In_ ULONG ulFlags,
                       _In_opt_ HMACHINE hMachine);
...
CONFIGRET
WINAPI
CM_Open_Class_KeyA(_In_opt_ LPGUID ClassGuid, _In_opt_ LPCSTR pszClassName,
                   _In_ REGSAM samDesired, _In_ REGDISPOSITION Disposition,
                   _Out_ PHKEY phkClass, _In_ ULONG ulFlags);

CMAPI
CONFIGRET
WINAPI
CM_Open_Class_KeyW(_In_opt_ LPGUID ClassGuid, _In_opt_ LPCWSTR pszClassName,
                   _In_ REGSAM samDesired, _In_ REGDISPOSITION Disposition,
                   _Out_ PHKEY phkClass, _In_ ULONG ulFlags);
...
CONFIGRET
WINAPI
CM_Open_Class_Key_ExA(_In_opt_ LPGUID ClassGuid, _In_opt_ LPCSTR pszClassName,
                      _In_ REGSAM samDesired, _In_ REGDISPOSITION Disposition,
                      _Out_ PHKEY phkClass, _In_ ULONG ulFlags,
                      _In_opt_ HMACHINE hMachine);
...
CONFIGRET
WINAPI
CM_Open_Class_Key_ExW(_In_opt_ LPGUID ClassGuid, _In_opt_ LPCWSTR pszClassName,
                      _In_ REGSAM samDesired, _In_ REGDISPOSITION Disposition,
                      _Out_ PHKEY phkClass, _In_ ULONG ulFlags,
                      _In_opt_ HMACHINE hMachine);
...
CONFIGRET
WINAPI
CM_Open_DevNode_Key(_In_ DEVINST dnDevNode, _In_ REGSAM samDesired,
                    _In_ ULONG ulHardwareProfile,
                    _In_ REGDISPOSITION Disposition, _Out_ PHKEY phkDevice,
                    _In_ ULONG ulFlags);
...
CONFIGRET
WINAPI
CM_Open_DevNode_Key_Ex(_In_ DEVINST dnDevNode, _In_ REGSAM samDesired,
                       _In_ ULONG ulHardwareProfile,
                       _In_ REGDISPOSITION Disposition, _Out_ PHKEY phkDevice,
                       _In_ ULONG ulFlags, _In_opt_ HMACHINE hMachine);
...
CONFIGRET
WINAPI
CM_Open_Device_Interface_KeyA(_In_ LPCSTR pszDeviceInterface,
...
CONFIGRET
WINAPI
CM_Open_Device_Interface_KeyW(_In_ LPCWSTR pszDeviceInterface,
                              _In_ REGSAM samDesired,
                              _In_ REGDISPOSITION Disposition,
                              _Out_ PHKEY phkDeviceInterface,
                              _In_ ULONG ulFlags);
...
CONFIGRET
WINAPI
CM_Open_Device_Interface_Key_ExA(_In_ LPCSTR pszDeviceInterface,
                                 _In_ REGSAM samDesired,
                                 _In_ REGDISPOSITION Disposition,
                                 _Out_ PHKEY phkDeviceInterface,
                                 _In_ ULONG ulFlags,
...
CONFIGRET
WINAPI
CM_Open_Device_Interface_Key_ExW(_In_ LPCWSTR pszDeviceInterface,
                                 _In_ REGSAM samDesired,
                                 _In_ REGDISPOSITION Disposition,
                                 _Out_ PHKEY phkDeviceInterface,
                                 _In_ ULONG ulFlags,
...
CONFIGRET
WINAPI
CM_Delete_Device_Interface_KeyA(_In_ LPCSTR pszDeviceInterface,
                                _In_ ULONG ulFlags);

CMAPI
CONFIGRET
WINAPI
CM_Delete_Device_Interface_KeyW(_In_ LPCWSTR pszDeviceInterface,
                                _In_ ULONG ulFlags);
...
CONFIGRET
WINAPI
CM_Delete_Device_Interface_Key_ExA(_In_ LPCSTR pszDeviceInterface,
                                   _In_ ULONG ulFlags,
                                   _In_opt_ HMACHINE hMachine);
...
CONFIGRET
WINAPI
CM_Delete_Device_Interface_Key_ExW(_In_ LPCWSTR pszDeviceInterface,
                                   _In_ ULONG ulFlags,
                                   _In_opt_ HMACHINE hMachine);
...
CONFIGRET
WINAPI
CM_Query_Arbitrator_Free_Data(_Out_writes_bytes_(DataLen) PVOID pData,
                              _In_ ULONG DataLen, _In_ DEVINST dnDevInst,
                              _In_ RESOURCEID ResourceID, _In_ ULONG ulFlags);

CMAPI
CONFIGRET
WINAPI
CM_Query_Arbitrator_Free_Data_Ex(_Out_writes_bytes_(DataLen) PVOID pData,
                                 _In_ ULONG DataLen, _In_ DEVINST dnDevInst,
                                 _In_ RESOURCEID ResourceID, _In_ ULONG ulFlags,
                                 _In_opt_ HMACHINE hMachine);
...
CONFIGRET
WINAPI
CM_Query_Arbitrator_Free_Size(_Out_ PULONG pulSize, _In_ DEVINST dnDevInst,
                              _In_ RESOURCEID ResourceID, _In_ ULONG ulFlags);

CMAPI
CONFIGRET
WINAPI
CM_Query_Arbitrator_Free_Size_Ex(_Out_ PULONG pulSize, _In_ DEVINST dnDevInst,
                                 _In_ RESOURCEID ResourceID, _In_ ULONG ulFlags,
                                 _In_opt_ HMACHINE hMachine);
...
CONFIGRET
WINAPI
CM_Query_Remove_SubTree(_In_ DEVINST dnAncestor, _In_ ULONG ulFlags);

CMAPI
CONFIGRET
WINAPI
CM_Query_Remove_SubTree_Ex(_In_ DEVINST dnAncestor, _In_ ULONG ulFlags,
                           _In_opt_ HMACHINE hMachine);
...
CONFIGRET
WINAPI
CM_Query_And_Remove_SubTreeA(_In_ DEVINST dnAncestor,
                             _Out_opt_ PPNP_VETO_TYPE pVetoType,
                             _Out_writes_opt_(ulNameLength) LPSTR pszVetoName,
                             _In_ ULONG ulNameLength, _In_ ULONG ulFlags);

CMAPI
CONFIGRET
WINAPI
CM_Query_And_Remove_SubTreeW(_In_ DEVINST dnAncestor,
                             _Out_opt_ PPNP_VETO_TYPE pVetoType,
...
CONFIGRET
WINAPI
CM_Query_And_Remove_SubTree_ExA(_In_ DEVINST dnAncestor,
                                _Out_opt_ PPNP_VETO_TYPE pVetoType,
                                _Out_writes_opt_(ulNameLength)
                                    LPSTR pszVetoName,
                                _In_ ULONG ulNameLength, _In_ ULONG ulFlags,
                                _In_opt_ HMACHINE hMachine);
...
CONFIGRET
WINAPI
CM_Query_And_Remove_SubTree_ExW(_In_ DEVINST dnAncestor,
                                _Out_opt_ PPNP_VETO_TYPE pVetoType,
                                _Out_writes_opt_(ulNameLength)
                                    LPWSTR pszVetoName,
                                _In_ ULONG ulNameLength, _In_ ULONG ulFlags,
...
CONFIGRET
WINAPI
CM_Request_Device_EjectA(_In_ DEVINST dnDevInst,
                         _Out_opt_ PPNP_VETO_TYPE pVetoType,
                         _Out_writes_opt_(ulNameLength) LPSTR pszVetoName,
                         _In_ ULONG ulNameLength, _In_ ULONG ulFlags);
...
CONFIGRET
WINAPI
CM_Request_Device_Eject_ExA(_In_ DEVINST dnDevInst,
                            _Out_opt_ PPNP_VETO_TYPE pVetoType,
                            _Out_writes_opt_(ulNameLength) LPSTR pszVetoName,
                            _In_ ULONG ulNameLength, _In_ ULONG ulFlags,
                            _In_opt_ HMACHINE hMachine);
...
CONFIGRET
WINAPI
CM_Request_Device_EjectW(_In_ DEVINST dnDevInst,
                         _Out_opt_ PPNP_VETO_TYPE pVetoType,
                         _Out_writes_opt_(ulNameLength) LPWSTR pszVetoName,
                         _In_ ULONG ulNameLength, _In_ ULONG ulFlags);
...
CONFIGRET
WINAPI
CM_Request_Device_Eject_ExW(_In_ DEVINST dnDevInst,
                            _Out_opt_ PPNP_VETO_TYPE pVetoType,
                            _Out_writes_opt_(ulNameLength) LPWSTR pszVetoName,
                            _In_ ULONG ulNameLength, _In_ ULONG ulFlags,
                            _In_opt_ HMACHINE hMachine);
...
CONFIGRET
WINAPI
CM_Reenumerate_DevNode(_In_ DEVINST dnDevInst, _In_ ULONG ulFlags);

CMAPI
CONFIGRET
WINAPI
CM_Reenumerate_DevNode_Ex(_In_ DEVINST dnDevInst, _In_ ULONG ulFlags,
                          _In_opt_ HMACHINE hMachine);
...
CONFIGRET
WINAPI
CM_Register_Device_InterfaceA(_In_ DEVINST dnDevInst,
                              _In_ LPGUID InterfaceClassGuid,
...
CONFIGRET
WINAPI
CM_Register_Device_InterfaceW(_In_ DEVINST dnDevInst,
                              _In_ LPGUID InterfaceClassGuid,
...
CONFIGRET
WINAPI
CM_Register_Device_Interface_ExA(_In_ DEVINST dnDevInst,
                                 _In_ LPGUID InterfaceClassGuid,
                                 _In_opt_ LPCSTR pszReference,
                                 _Out_writes_(*pulLength)
...
CONFIGRET
WINAPI
CM_Register_Device_Interface_ExW(_In_ DEVINST dnDevInst,
                                 _In_ LPGUID InterfaceClassGuid,
                                 _In_opt_ LPCWSTR pszReference,
                                 _Out_writes_(*pulLength)
                                     LPWSTR pszDeviceInterface,
...
CONFIGRET
WINAPI
CM_Set_DevNode_Problem_Ex(_In_ DEVINST dnDevInst, _In_ ULONG ulProblem,
                          _In_ ULONG ulFlags, _In_opt_ HMACHINE hMachine);

CMAPI
CONFIGRET
WINAPI
CM_Set_DevNode_Problem(_In_ DEVINST dnDevInst, _In_ ULONG ulProblem,
                       _In_ ULONG ulFlags);
...
CONFIGRET
WINAPI
CM_Unregister_Device_InterfaceA(_In_ LPCSTR pszDeviceInterface,
                                _In_ ULONG ulFlags);

CMAPI
CONFIGRET
WINAPI
CM_Unregister_Device_InterfaceW(_In_ LPCWSTR pszDeviceInterface,
                                _In_ ULONG ulFlags);

CMAPI
CONFIGRET
WINAPI
CM_Unregister_Device_Interface_ExA(_In_ LPCSTR pszDeviceInterface,
                                   _In_ ULONG ulFlags,
                                   _In_opt_ HMACHINE hMachine);
...
CONFIGRET
WINAPI
CM_Unregister_Device_Interface_ExW(_In_ LPCWSTR pszDeviceInterface,
                                   _In_ ULONG ulFlags,
                                   _In_opt_ HMACHINE hMachine);
...
CONFIGRET
WINAPI
CM_Register_Device_Driver(_In_ DEVINST dnDevInst, _In_ ULONG ulFlags);

CMAPI
CONFIGRET
WINAPI
CM_Register_Device_Driver_Ex(_In_ DEVINST dnDevInst, _In_ ULONG ulFlags,
                             _In_opt_ HMACHINE hMachine);

__drv_preferredFunction("CM_Query_And_Remove_Subtree",
                        "Obsolete") CMAPI CONFIGRET WINAPI
    CM_Remove_SubTree(_In_ DEVINST dnAncestor, _In_ ULONG ulFlags);

__drv_preferredFunction("CM_Query_And_Remove_Subtree_Ex",
                        "Obsolete") CMAPI CONFIGRET WINAPI
    CM_Remove_SubTree_Ex(_In_ DEVINST dnAncestor, _In_ ULONG ulFlags,
                         _In_opt_ HMACHINE hMachine);
...
CONFIGRET
WINAPI
CM_Set_DevNode_PropertyW(_In_ DEVINST dnDevInst,
                         _In_ CONST DEVPROPKEY *PropertyKey,
                         _In_ DEVPROPTYPE PropertyType,
                         _In_reads_bytes_opt_(PropertyBufferSize)
                             CONST PBYTE PropertyBuffer,
                         _In_ ULONG PropertyBufferSize, _In_ ULONG ulFlags);
...
CONFIGRET
WINAPI
CM_Set_DevNode_Property_ExW(_In_ DEVINST dnDevInst,
                            _In_ CONST DEVPROPKEY *PropertyKey,
                            _In_ DEVPROPTYPE PropertyType,
                            _In_reads_bytes_opt_(PropertyBufferSize)
                                CONST PBYTE PropertyBuffer,
...
CONFIGRET
WINAPI
CM_Set_DevNode_Registry_PropertyA(_In_ DEVINST dnDevInst, _In_ ULONG ulProperty,
                                  _In_reads_bytes_opt_(ulLength) PCVOID Buffer,
                                  _In_ ULONG ulLength, _In_ ULONG ulFlags);

CMAPI
CONFIGRET
WINAPI
CM_Set_DevNode_Registry_PropertyW(_In_ DEVINST dnDevInst, _In_ ULONG ulProperty,
                                  _In_reads_bytes_opt_(ulLength) PCVOID Buffer,
                                  _In_ ULONG ulLength, _In_ ULONG ulFlags);
...
CONFIGRET
WINAPI
CM_Set_DevNode_Registry_Property_ExA(_In_ DEVINST dnDevInst,
                                     _In_ ULONG ulProperty,
                                     _In_reads_bytes_opt_(ulLength)
                                         PCVOID Buffer,
                                     _In_ ULONG ulLength, _In_ ULONG ulFlags,
                                     _In_opt_ HMACHINE hMachine);
...
CONFIGRET
WINAPI
CM_Set_DevNode_Registry_Property_ExW(_In_ DEVINST dnDevInst,
                                     _In_ ULONG ulProperty,
                                     _In_reads_bytes_opt_(ulLength)
                                         PCVOID Buffer,
                                     _In_ ULONG ulLength, _In_ ULONG ulFlags,
...
CONFIGRET
WINAPI
CM_Set_Device_Interface_PropertyW(_In_ LPCWSTR pszDeviceInterface,
                                  _In_ CONST DEVPROPKEY *PropertyKey,
                                  _In_ DEVPROPTYPE PropertyType,
                                  _In_reads_bytes_opt_(PropertyBufferSize)
                                      CONST PBYTE PropertyBuffer,
...
CONFIGRET
WINAPI
CM_Set_Device_Interface_Property_ExW(_In_ LPCWSTR pszDeviceInterface,
                                     _In_ CONST DEVPROPKEY *PropertyKey,
                                     _In_ DEVPROPTYPE PropertyType,
                                     _In_reads_bytes_opt_(PropertyBufferSize)
                                         CONST PBYTE PropertyBuffer,
...
CONFIGRET
WINAPI
CM_Is_Dock_Station_Present(_Out_ PBOOL pbPresent);

CMAPI
CONFIGRET
WINAPI
CM_Is_Dock_Station_Present_Ex(_Out_ PBOOL pbPresent,
                              _In_opt_ HMACHINE hMachine);
...
CONFIGRET
WINAPI
CM_Request_Eject_PC_Ex(_In_opt_ HMACHINE hMachine);

CMAPI
CONFIGRET
WINAPI
CM_Set_HW_Prof_FlagsA(_In_ DEVINSTID_A pDeviceID, _In_ ULONG ulConfig,
                      _In_ ULONG ulValue, _In_ ULONG ulFlags);

CMAPI
CONFIGRET
WINAPI
CM_Set_HW_Prof_FlagsW(_In_ DEVINSTID_W pDeviceID, _In_ ULONG ulConfig,
                      _In_ ULONG ulValue, _In_ ULONG ulFlags);

CMAPI
CONFIGRET
WINAPI
CM_Set_HW_Prof_Flags_ExA(_In_ DEVINSTID_A pDeviceID, _In_ ULONG ulConfig,
                         _In_ ULONG ulValue, _In_ ULONG ulFlags,
                         _In_opt_ HMACHINE hMachine);
...
CONFIGRET
WINAPI
CM_Set_HW_Prof_Flags_ExW(_In_ DEVINSTID_W pDeviceID, _In_ ULONG ulConfig,
                         _In_ ULONG ulValue, _In_ ULONG ulFlags,
                         _In_opt_ HMACHINE hMachine);
...
CONFIGRET
WINAPI
CM_Setup_DevNode(_In_ DEVINST dnDevInst, _In_ ULONG ulFlags);
...
CONFIGRET
WINAPI
CM_Setup_DevNode_Ex(_In_ DEVINST dnDevInst, _In_ ULONG ulFlags,
                    _In_opt_ HMACHINE hMachine);
...
CONFIGRET
WINAPI
CM_Test_Range_Available(_In_ DWORDLONG ullStartValue,
                        _In_ DWORDLONG ullEndValue, _In_ RANGE_LIST rlh,
                        _In_ ULONG ulFlags);
...
CONFIGRET
WINAPI
CM_Uninstall_DevNode(_In_ DEVNODE dnDevInst, _In_ ULONG ulFlags);
...
CONFIGRET
WINAPI
CM_Uninstall_DevNode_Ex(_In_ DEVNODE dnDevInst, _In_ ULONG ulFlags,
                        _In_opt_ HMACHINE hMachine);
...
CONFIGRET
WINAPI
CM_Run_Detection(_In_ ULONG ulFlags);

CMAPI
CONFIGRET
WINAPI
CM_Run_Detection_Ex(_In_ ULONG ulFlags, _In_opt_ HMACHINE hMachine);
...
CONFIGRET
CM_Write_UserPowerKey(_In_opt_ CONST GUID *SchemeGuid,
                      _In_opt_ CONST GUID *SubGroupOfPowerSettingsGuid,
                      _In_opt_ CONST GUID *PowerSettingGuid,
                      _In_ ULONG AccessFlags, _In_ ULONG Type,
                      _In_reads_bytes_(BufferSize) UCHAR *Buffer,
                      _In_ DWORD BufferSize, _Out_ PDWORD Error);

CONFIGRET
CM_Set_ActiveScheme(_In_ CONST GUID *SchemeGuid, _Out_ PDWORD Error);

CONFIGRET
CM_Restore_DefaultPowerScheme(_In_ CONST GUID *SchemeGuid, _Out_ PDWORD Error);

CONFIGRET
CM_RestoreAll_DefaultPowerSchemes(_Out_ PDWORD Error);

CONFIGRET
CM_Duplicate_PowerScheme(_In_ CONST GUID *SourceSchemeGuid,
                         _Inout_ GUID **DestinationSchemeGuid,
                         _Out_ PDWORD Error);

CONFIGRET
CM_Delete_PowerScheme(_In_ CONST GUID *SchemeGuid, _Out_ PDWORD Error);

CONFIGRET
CM_Import_PowerScheme(_In_ LPCWSTR ImportFileNamePath,
                      _Inout_ GUID **DestinationSchemeGuid, _Out_ PDWORD Error);
...
CONFIGRET
WINAPI
CM_Set_HW_Prof(_In_ ULONG ulHardwareProfile, _In_ ULONG ulFlags);

CMAPI
CONFIGRET
WINAPI
CM_Set_HW_Prof_Ex(_In_ ULONG ulHardwareProfile, _In_ ULONG ulFlags,
                  _In_opt_ HMACHINE hMachine);

CMAPI
CONFIGRET
WINAPI
CM_Query_Resource_Conflict_List(_Out_ PCONFLICT_LIST pclConflictList,
...
CONFIGRET
WINAPI
CM_Free_Resource_Conflict_Handle(_In_ CONFLICT_LIST clConflictList);

CMAPI
CONFIGRET
WINAPI
CM_Get_Resource_Conflict_Count(_In_ CONFLICT_LIST clConflictList,
                               _Out_ PULONG pulCount);

CMAPI
CONFIGRET
WINAPI
CM_Get_Resource_Conflict_DetailsA(_In_ CONFLICT_LIST clConflictList,
                                  _In_ ULONG ulIndex,
...
CONFIGRET
WINAPI
CM_Get_Resource_Conflict_DetailsW(_In_ CONFLICT_LIST clConflictList,
                                  _In_ ULONG ulIndex,
...
CONFIGRET
WINAPI
CM_Get_Class_PropertyW(_In_ LPCGUID ClassGUID,
                       _In_ CONST DEVPROPKEY *PropertyKey,
                       _Out_ DEVPROPTYPE *PropertyType,
                       _Out_writes_bytes_opt_(*PropertyBufferSize)
                           PBYTE PropertyBuffer,
...
CONFIGRET
WINAPI
CM_Get_Class_Property_ExW(_In_ LPCGUID ClassGUID,
                          _In_ CONST DEVPROPKEY *PropertyKey,
                          _Out_ DEVPROPTYPE *PropertyType,
                          _Out_writes_bytes_opt_(*PropertyBufferSize)
                              PBYTE PropertyBuffer,
...
CONFIGRET
WINAPI
CM_Get_Class_Property_Keys(_In_ LPCGUID ClassGUID,
                           _Out_writes_opt_(*PropertyKeyCount)
                               DEVPROPKEY *PropertyKeyArray,
                           _Inout_ PULONG PropertyKeyCount, _In_ ULONG ulFlags);
...
CONFIGRET
WINAPI
CM_Get_Class_Property_Keys_Ex(_In_ LPCGUID ClassGUID,
                              _Out_writes_opt_(*PropertyKeyCount)
                                  DEVPROPKEY *PropertyKeyArray,
                              _Inout_ PULONG PropertyKeyCount,
                              _In_ ULONG ulFlags, _In_opt_ HMACHINE hMachine);
...
CONFIGRET
WINAPI
CM_Set_Class_PropertyW(_In_ LPCGUID ClassGUID,
                       _In_ CONST DEVPROPKEY *PropertyKey,
                       _In_ DEVPROPTYPE PropertyType,
                       _In_reads_bytes_opt_(PropertyBufferSize)
                           CONST PBYTE PropertyBuffer,
...
CONFIGRET
WINAPI
CM_Set_Class_Property_ExW(_In_ LPCGUID ClassGUID,
                          _In_ CONST DEVPROPKEY *PropertyKey,
                          _In_ DEVPROPTYPE PropertyType,
                          _In_reads_bytes_opt_(PropertyBufferSize)
                              CONST PBYTE PropertyBuffer,
...
CONFIGRET
WINAPI
CM_Get_Class_Registry_PropertyA(_In_ LPGUID ClassGuid, _In_ ULONG ulProperty,
                                _Out_opt_ PULONG pulRegDataType,
                                _Out_writes_bytes_opt_(*pulLength) PVOID Buffer,
                                _Inout_ PULONG pulLength, _In_ ULONG ulFlags,
                                _In_opt_ HMACHINE hMachine);
...
CONFIGRET
WINAPI
CM_Get_Class_Registry_PropertyW(_In_ LPGUID ClassGuid, _In_ ULONG ulProperty,
                                _Out_opt_ PULONG pulRegDataType,
                                _Out_writes_bytes_opt_(*pulLength) PVOID Buffer,
                                _Inout_ PULONG pulLength, _In_ ULONG ulFlags,
                                _In_opt_ HMACHINE hMachine);
...
CONFIGRET
WINAPI
CM_Set_Class_Registry_PropertyA(_In_ LPGUID ClassGuid, _In_ ULONG ulProperty,
                                _In_reads_bytes_opt_(ulLength) PCVOID Buffer,
                                _In_ ULONG ulLength, _In_ ULONG ulFlags,
                                _In_opt_ HMACHINE hMachine);
...
CONFIGRET
WINAPI
CM_Set_Class_Registry_PropertyW(_In_ LPGUID ClassGuid, _In_ ULONG ulProperty,
                                _In_reads_bytes_opt_(ulLength) PCVOID Buffer,
                                _In_ ULONG ulLength, _In_ ULONG ulFlags,
                                _In_opt_ HMACHINE hMachine);
...
DWORD
WINAPI
CM_WaitNoPendingInstallEvents(_In_ DWORD dwTimeout);
...
CONFIGRET
WINAPI
CM_Register_Notification(_In_ PCM_NOTIFY_FILTER pFilter,
...
CONFIGRET
WINAPI
CM_Unregister_Notification(_In_ HCMNOTIFICATION NotifyContext);
...
DWORD
WINAPI
CM_MapCrToWin32Err(_In_ CONFIGRET CmReturnCode, _In_ DWORD DefaultErr);
