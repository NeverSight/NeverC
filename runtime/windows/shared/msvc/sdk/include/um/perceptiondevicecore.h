...
// Common definitions that are shared between DDI interfaces and the perception
// device api.
...
// Required by the platform to fulfill state queries in the kernel filter
// driver.
...
// and refer to it with PERCEPTIONFIELD_StateStream_TimeStamps in the
// descriptor.
//
// Field data type: PERCEPTION_STATE_STREAM_TIMESTAMPS
//
// {AA886119-F32F-49BF-92CA-F9DDF784D297}
DEFINE_GUID(PERCEPTIONFIELD_StateStream_TimeStamps, 0xaa886119, 0xf32f, 0x49bf,
            0x92, 0xca, 0xf9, 0xdd, 0xf7, 0x84, 0xd2, 0x97);

#endif /* WINAPI_FAMILY_PARTITION(WINAPI_PARTITION_APP |                       \
          WINAPI_PARTITION_GAMES | WINAPI_FAMILY_SYSTEM) */
