...
MCIERROR
WINAPI
mciSendCommandA(_In_ MCIDEVICEID mciId, _In_ UINT uMsg,
                _In_opt_ DWORD_PTR dwParam1, _In_opt_ DWORD_PTR dwParam2);

WINMMAPI
MCIERROR
WINAPI
mciSendCommandW(_In_ MCIDEVICEID mciId, _In_ UINT uMsg,
                _In_opt_ DWORD_PTR dwParam1, _In_opt_ DWORD_PTR dwParam2);
...
MCIERROR
WINAPI
mciSendStringA(_In_ LPCSTR lpstrCommand,
               _Out_writes_opt_(uReturnLength) LPSTR lpstrReturnString,
               _In_ UINT uReturnLength, _In_opt_ HWND hwndCallback);

WINMMAPI
MCIERROR
WINAPI
mciSendStringW(_In_ LPCWSTR lpstrCommand,
...
MCIDEVICEID
WINAPI
mciGetDeviceIDA(_In_ LPCSTR pszDevice);

WINMMAPI
MCIDEVICEID
WINAPI
mciGetDeviceIDW(_In_ LPCWSTR pszDevice);
...
MCIDEVICEID
WINAPI
mciGetDeviceIDFromElementIDA(_In_ DWORD dwElementID, _In_ LPCSTR lpstrType);

WINMMAPI
MCIDEVICEID
WINAPI
mciGetDeviceIDFromElementIDW(_In_ DWORD dwElementID, _In_ LPCWSTR lpstrType);
...
#else
MCIERROR WINAPI mciSendCommand(MCIDEVICEID mciId, UINT uMsg, DWORD dwParam1,
                               DWORD dwParam2);
MCIERROR WINAPI mciSendString(LPCSTR lpstrCommand, LPSTR lpstrReturnString,
...
WINMMAPI
BOOL WINAPI mciSetYieldProc(_In_ MCIDEVICEID mciId,
...
HTASK
WINAPI
mciGetCreatorTask(_In_ MCIDEVICEID mciId);

WINMMAPI
YIELDPROC
WINAPI
mciGetYieldProc(_In_ MCIDEVICEID mciId, _In_ LPDWORD pdwYieldData);
...
DWORD_PTR
APIENTRY
mciGetDriverData(MCIDEVICEID wDeviceID);
