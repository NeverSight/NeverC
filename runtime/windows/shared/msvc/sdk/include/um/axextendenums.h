...
FLAGS TAG(AnalogVideoStandard){
    ...
    AnalogVideoMask_MCE_NTSC =
        AnalogVideo_NTSC_M | // add pal n, n combo, m and 60 since they can be
                             // done on a ntsc tuner
        AnalogVideo_NTSC_M_J | AnalogVideo_NTSC_433 | AnalogVideo_PAL_M |
        AnalogVideo_PAL_N | AnalogVideo_PAL_60 | AnalogVideo_PAL_N_COMBO,

    AnalogVideoMask_MCE_PAL =
        AnalogVideo_PAL_B | // pull out pal n, n combo, m and 60
        AnalogVideo_PAL_D | AnalogVideo_PAL_G | AnalogVideo_PAL_H |
        AnalogVideo_PAL_I,

    AnalogVideoMask_MCE_SECAM = AnalogVideo_SECAM_B | // secam looks ok
                                AnalogVideo_SECAM_D | AnalogVideo_SECAM_G |
                                AnalogVideo_SECAM_H | AnalogVideo_SECAM_K |
...
ENUM16 TAG(TunerInputType){TunerInputCable, TunerInputAntenna} TunerInputType;
