...
typedef /* [hidden] */
    enum DISPID_InkDivider {
      ...
      DISPID_IInkDivider_LineHeight =
          (DISPID_IInkDivider_RecognizerContext + 1),
...
typedef /* [hidden] */
    enum DISPID_InkDivisionUnit {
      ...
      DISPID_IInkDivisionUnit_RecognizedString =
          (DISPID_IInkDivisionUnit_DivisionType + 1),
      DISPID_IInkDivisionUnit_RotationTransform =
          (DISPID_IInkDivisionUnit_RecognizedString + 1)
...
public:
  ...
  virtual /* [helpcontext][helpstring][id][propputref] */ HRESULT
      STDMETHODCALLTYPE putref_RecognizerContext(
          /* [in] */ __RPC__in_opt IInkRecognizerContext *
          RecognizerContext) = 0;
  ...
  virtual /* [helpcontext][helpstring][id] */ HRESULT STDMETHODCALLTYPE Divide(
      /* [retval][out] */ __RPC__deref_out_opt IInkDivisionResult *
      *InkDivisionResult) = 0;
};
...
typedef struct IInkDividerVtbl {
  ...
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in IInkDivider *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IInkDivider *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IInkDivider *This);
  ...
  /* [helpcontext][helpstring][id][propget] */ HRESULT(
      STDMETHODCALLTYPE *get_RecognizerContext)(
      __RPC__in IInkDivider *This,
      /* [retval][out] */ __RPC__deref_out_opt IInkRecognizerContext *
          *RecognizerContext);
  ...
  /* [helpcontext][helpstring][id][propget] */ HRESULT(
      STDMETHODCALLTYPE *get_LineHeight)(
      __RPC__in IInkDivider *This,
  ...
  /* [helpcontext][helpstring][id][propput] */ HRESULT(
      STDMETHODCALLTYPE *put_LineHeight)(__RPC__in IInkDivider *This,
                                         /* [in] */ LONG LineHeight);
...
interface IInkDivider { CONST_VTBL struct IInkDividerVtbl *lpVtbl; };
...
#define IInkDivider_GetIDsOfNames(This, riid, rgszNames, cNames, lcid,         \
                                  rgDispId)                                    \
  ((This)->lpVtbl->GetIDsOfNames(This, riid, rgszNames, cNames, lcid, rgDispId))

#define IInkDivider_Invoke(This, dispIdMember, riid, lcid, wFlags,             \
...
public:
  ...
  ResultByType(
      ...
      /* [retval][out] */ __RPC__deref_out_opt IInkDivisionUnits *
          *InkDivisionUnits) = 0;
};
...
typedef struct IInkDivisionResultVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in IInkDivisionResult *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IInkDivisionResult *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IInkDivisionResult *This);
...
#define IInkDivisionResult_GetIDsOfNames(This, riid, rgszNames, cNames, lcid,  \
                                         rgDispId)                             \
  ((This)->lpVtbl->GetIDsOfNames(This, riid, rgszNames, cNames, lcid, rgDispId))

#define IInkDivisionResult_Invoke(This, dispIdMember, riid, lcid, wFlags,      \
...
public:
  ...
  virtual /* [helpcontext][helpstring][id][propget] */ HRESULT STDMETHODCALLTYPE
      get_RotationTransform(
          /* [retval][out] */ __RPC__deref_out_opt IInkTransform *
          *RotationTransform) = 0;
};
...
typedef struct IInkDivisionUnitVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in IInkDivisionUnit *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IInkDivisionUnit *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IInkDivisionUnit *This);
...
interface IInkDivisionUnit { CONST_VTBL struct IInkDivisionUnitVtbl *lpVtbl; };
...
#define IInkDivisionUnit_GetIDsOfNames(This, riid, rgszNames, cNames, lcid,    \
                                       rgDispId)                               \
  ((This)->lpVtbl->GetIDsOfNames(This, riid, rgszNames, cNames, lcid, rgDispId))

#define IInkDivisionUnit_Invoke(This, dispIdMember, riid, lcid, wFlags,        \
                                pDispParams, pVarResult, pExcepInfo, puArgErr) \
  ((This)->lpVtbl->Invoke(This, dispIdMember, riid, lcid, wFlags, pDispParams, \
                          pVarResult, pExcepInfo, puArgErr))
...
public:
  ...
  virtual /* [helpcontext][helpstring][id] */ HRESULT STDMETHODCALLTYPE Item(
      /* [in] */ long Index,
      /* [retval][out] */ __RPC__deref_out_opt IInkDivisionUnit *
          *InkDivisionUnit) = 0;
};
...
typedef struct IInkDivisionUnitsVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in IInkDivisionUnits *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IInkDivisionUnits *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IInkDivisionUnits *This);
  ...
  /* [helpcontext][helpstring][id][propget] */ HRESULT(
      STDMETHODCALLTYPE *get_Count)(__RPC__in IInkDivisionUnits *This,
...
#define IInkDivisionUnits_GetIDsOfNames(This, riid, rgszNames, cNames, lcid,   \
                                        rgDispId)                              \
  ((This)->lpVtbl->GetIDsOfNames(This, riid, rgszNames, cNames, lcid, rgDispId))

#define IInkDivisionUnits_Invoke(This, dispIdMember, riid, lcid, wFlags,       \
                                 pDispParams, pVarResult, pExcepInfo,          \
                                 puArgErr)                                     \
  ((This)->lpVtbl->Invoke(This, dispIdMember, riid, lcid, wFlags, pDispParams, \
                          pVarResult, pExcepInfo, puArgErr))
...
class DECLSPEC_UUID("8854F6A0-4683-4AE7-9191-752FE64612C3") InkDivider;
#endif
