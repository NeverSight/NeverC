...
WINBASEAPI
BOOL WINAPI QueueUserAPC2(_In_ PAPCFUNC ApcRoutine, _In_ HANDLE Thread,
                          _In_ ULONG_PTR Data, _In_ QUEUE_USER_APC_FLAGS Flags);
...
WINBASEAPI
_Ret_maybenull_ HANDLE WINAPI CreateThread(
    _In_opt_ LPSECURITY_ATTRIBUTES lpThreadAttributes, _In_ SIZE_T dwStackSize,
    _In_ LPTHREAD_START_ROUTINE lpStartAddress,
    _In_opt_ __drv_aliasesMem LPVOID lpParameter, _In_ DWORD dwCreationFlags,
...
#pragma region Application Family or OneCore Family or Games Family
                            ...
                            WINAPI_PARTITION_GAMES)
WINBASEAPI
_Ret_maybenull_ HANDLE WINAPI CreateRemoteThread(
    _In_ HANDLE hProcess, _In_opt_ LPSECURITY_ATTRIBUTES lpThreadAttributes,
...
WINBASEAPI
BOOL WINAPI SetThreadPriorityBoost(_In_ HANDLE hThread,
                                   _In_ BOOL bDisablePriorityBoost);

WINBASEAPI
BOOL WINAPI GetThreadPriorityBoost(_In_ HANDLE hThread,
...
#pragma region Desktop Family or OneCore Family or Games Family
                            ...
                            WINAPI_PARTITION_SYSTEM | WINAPI_PARTITION_GAMES)
WINBASEAPI
BOOL WINAPI TerminateThread(_In_ HANDLE hThread, _In_ DWORD dwExitCode);
...
_Success_(return != 0) BOOL WINAPI
    GetExitCodeThread(_In_ HANDLE hThread, _Out_ LPDWORD lpExitCode);

WINBASEAPI
DWORD
WINAPI
SuspendThread(_In_ HANDLE hThread);
...
WINBASEAPI
BOOL WINAPI CreateProcessA(_In_opt_ LPCSTR lpApplicationName,
...
WINBASEAPI
BOOL WINAPI CreateProcessW(_In_opt_ LPCWSTR lpApplicationName,
...
WINBASEAPI
BOOL WINAPI SetProcessShutdownParameters(_In_ DWORD dwLevel,
                                         _In_ DWORD dwFlags);

WINBASEAPI
DWORD
WINAPI
GetProcessVersion(_In_ DWORD ProcessId);
...
WINBASEAPI
VOID WINAPI GetStartupInfoW(_Out_ LPSTARTUPINFOW lpStartupInfo);
...
BOOL WINAPI CreateProcessAsUserW(
    _In_opt_ HANDLE hToken, _In_opt_ LPCWSTR lpApplicationName,
    _Inout_opt_ LPWSTR lpCommandLine,
    _In_opt_ LPSECURITY_ATTRIBUTES lpProcessAttributes,
    _In_opt_ LPSECURITY_ATTRIBUTES lpThreadAttributes,
...
FORCEINLINE
HANDLE
GetCurrentProcessToken(VOID) { return (HANDLE)(LONG_PTR)-4; }

FORCEINLINE
HANDLE
GetCurrentThreadToken(VOID) { return (HANDLE)(LONG_PTR)-5; }

FORCEINLINE
HANDLE
GetCurrentThreadEffectiveToken(VOID) { return (HANDLE)(LONG_PTR)-6; }

#endif // (_WIN32_WINNT >= _WIN32_WINNT_WIN8)
#endif // !defined(MIDL_PASS)

WINADVAPI
_Must_inspect_result_ BOOL APIENTRY SetThreadToken(_In_opt_ PHANDLE Thread,
...
WINADVAPI
BOOL WINAPI OpenThreadToken(_In_ HANDLE ThreadHandle, _In_ DWORD DesiredAccess,
                            _In_ BOOL OpenAsSelf, _Outptr_ PHANDLE TokenHandle);
...
DWORD
WINAPI
GetPriorityClass(_In_ HANDLE hProcess);
...
WINBASEAPI
BOOL WINAPI ProcessIdToSessionId(_In_ DWORD dwProcessId,
...
WINBASEAPI
_Success_(return != FALSE) BOOL WINAPI InitializeProcThreadAttributeList(
    _Out_writes_bytes_to_opt_(*lpSize, *lpSize)
        LPPROC_THREAD_ATTRIBUTE_LIST lpAttributeList,
    _In_ DWORD dwAttributeCount, _Reserved_ DWORD dwFlags,
...
WINBASEAPI
BOOL WINAPI SetProcessDynamicEHContinuationTargets(
    _In_ HANDLE Process, _In_ USHORT NumberOfTargets,
    _Inout_updates_(NumberOfTargets)
...
WINBASEAPI
BOOL WINAPI SetProcessDynamicEnforcedCetCompatibleRanges(
    _In_ HANDLE Process, _In_ USHORT NumberOfRanges,
    _Inout_updates_(NumberOfRanges)
...
WINBASEAPI
BOOL WINAPI SetProcessAffinityUpdateMode(_In_ HANDLE hProcess,
                                         _In_ DWORD dwFlags);

WINBASEAPI
BOOL WINAPI QueryProcessAffinityUpdateMode(_In_ HANDLE hProcess,
...
WINBASEAPI
_Ret_maybenull_ HANDLE WINAPI CreateRemoteThreadEx(
    _In_ HANDLE hProcess, _In_opt_ LPSECURITY_ATTRIBUTES lpThreadAttributes,
    _In_ SIZE_T dwStackSize, _In_ LPTHREAD_START_ROUTINE lpStartAddress,
    _In_opt_ LPVOID lpParameter, _In_ DWORD dwCreationFlags,
...
WINBASEAPI
VOID WINAPI GetCurrentThreadStackLimits(_Out_ PULONG_PTR LowLimit,
...
BOOL WINAPI GetProcessMitigationPolicy(
    ...
    _Out_writes_bytes_(dwLength) PVOID lpBuffer, _In_ SIZE_T dwLength);
...
WINBASEAPI
BOOL WINAPI SetThreadContext(_In_ HANDLE hThread,
...
BOOL WINAPI SetProcessMitigationPolicy(
    ...
    _In_reads_bytes_(dwLength) PVOID lpBuffer, _In_ SIZE_T dwLength);
...
WINBASEAPI
BOOL WINAPI FlushInstructionCache(_In_ HANDLE hProcess,
                                  _In_reads_bytes_opt_(dwSize)
...
WINBASEAPI
BOOL WINAPI GetThreadTimes(_In_ HANDLE hThread, _Out_ LPFILETIME lpCreationTime,
                           _Out_ LPFILETIME lpExitTime,
                           _Out_ LPFILETIME lpKernelTime,
                           _Out_ LPFILETIME lpUserTime);
...
WINBASEAPI
BOOL WINAPI GetProcessHandleCount(_In_ HANDLE hProcess,
...
WINBASEAPI
BOOL WINAPI SetThreadIdealProcessorEx(
    _In_ HANDLE hThread, _In_ PPROCESSOR_NUMBER lpIdealProcessor,
    _Out_opt_ PPROCESSOR_NUMBER lpPreviousIdealProcessor);

WINBASEAPI
BOOL WINAPI GetThreadIdealProcessorEx(_In_ HANDLE hThread,
...
WINBASEAPI
BOOL WINAPI GetProcessPriorityBoost(_In_ HANDLE hProcess,
                                    _Out_ PBOOL pDisablePriorityBoost);

WINBASEAPI
BOOL WINAPI SetProcessPriorityBoost(_In_ HANDLE hProcess,
                                    _In_ BOOL bDisablePriorityBoost);
...
WINBASEAPI
BOOL WINAPI GetThreadIOPendingFlag(_In_ HANDLE hThread,
...
WINBASEAPI
BOOL WINAPI GetSystemTimes(_Out_opt_ PFILETIME lpIdleTime,
...
WINBASEAPI
BOOL WINAPI SetProtectedPolicy(_In_ LPCGUID PolicyGuid,
                               _In_ ULONG_PTR PolicyValue,
                               _Out_opt_ PULONG_PTR OldPolicyValue);

WINBASEAPI
BOOL WINAPI QueryProtectedPolicy(_In_ LPCGUID PolicyGuid,
...
DWORD
WINAPI
SetThreadIdealProcessor(_In_ HANDLE hThread, _In_ DWORD dwIdealProcessor);
...
_Success_(return != FALSE) BOOL WINAPI
    GetSystemCpuSetInformation(_Out_writes_bytes_to_opt_(BufferLength,
                                                         *ReturnedLength)
                                   PSYSTEM_CPU_SET_INFORMATION Information,
                               _In_ ULONG BufferLength,
                               _Always_(_Out_) PULONG ReturnedLength,
                               _In_opt_ HANDLE Process, _Reserved_ ULONG Flags);
...
_Success_(return != FALSE) BOOL WINAPI GetProcessDefaultCpuSets(
    ...
    _In_ ULONG CpuSetIdCount, _Always_(_Out_) PULONG RequiredIdCount);

_Success_(return != FALSE) BOOL WINAPI
    SetProcessDefaultCpuSets(_In_ HANDLE Process,
                             _In_reads_opt_(CpuSetIdCount)
...
_Success_(return != FALSE) BOOL WINAPI
    SetThreadSelectedCpuSets(_In_ HANDLE Thread,
...
BOOL WINAPI CreateProcessAsUserA(
    _In_opt_ HANDLE hToken, _In_opt_ LPCSTR lpApplicationName,
    _Inout_opt_ LPSTR lpCommandLine,
    _In_opt_ LPSECURITY_ATTRIBUTES lpProcessAttributes,
    _In_opt_ LPSECURITY_ATTRIBUTES lpThreadAttributes,
    _In_ BOOL bInheritHandles, _In_ DWORD dwCreationFlags,
...
WINBASEAPI
BOOL WINAPI GetProcessShutdownParameters(_Out_ LPDWORD lpdwLevel,
...
_Success_(return != FALSE) BOOL WINAPI
    GetProcessDefaultCpuSetMasks(_In_ HANDLE Process,
                                 _Out_writes_to_opt_(CpuSetMaskCount,
                                                     *RequiredMaskCount)
...
_Success_(return != FALSE) BOOL WINAPI
    SetProcessDefaultCpuSetMasks(_In_ HANDLE Process,
                                 _In_reads_opt_(CpuSetMaskCount)
                                     PGROUP_AFFINITY CpuSetMasks,
                                 _In_ USHORT CpuSetMaskCount);

_Success_(return != FALSE) BOOL WINAPI
    GetThreadSelectedCpuSetMasks(_In_ HANDLE Thread,
                                 _Out_writes_to_opt_(CpuSetMaskCount,
                                                     *RequiredMaskCount)
                                     PGROUP_AFFINITY CpuSetMasks,
                                 _In_ USHORT CpuSetMaskCount,
...
_Success_(return != FALSE) BOOL WINAPI
    SetThreadSelectedCpuSetMasks(_In_ HANDLE Thread,
                                 _In_reads_opt_(CpuSetMaskCount)
                                     PGROUP_AFFINITY CpuSetMasks,
                                 _In_ USHORT CpuSetMaskCount);
...
HRESULT
WINAPI
GetMachineTypeAttributes(_In_ USHORT Machine,
...
LPVOID
WINAPI
TlsGetValue2(_In_ DWORD dwTlsIndex);
