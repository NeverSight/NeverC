...
typedef interface IAudioEndpointOffloadStreamVolume
...
typedef interface IAudioEndpointOffloadStreamMeter
...
typedef interface IAudioEndpointLastBufferControl
...
typedef struct IAudioEndpointVtbl {
  ...
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(IAudioEndpoint *This,
                                             /* [in] */ REFIID riid,
  ...
  HRESULT(STDMETHODCALLTYPE *GetLatency)(IAudioEndpoint *This,
                                         /* [out] */ HNSTIME *pLatency);

  DECLSPEC_XFGVIRT(IAudioEndpoint, SetStreamFlags)
  HRESULT(STDMETHODCALLTYPE *SetStreamFlags)(IAudioEndpoint *This,
                                             /* [in] */ DWORD streamFlags);

  DECLSPEC_XFGVIRT(IAudioEndpoint, SetEventHandle)
  HRESULT(STDMETHODCALLTYPE *SetEventHandle)(IAudioEndpoint *This,
                                             /* [in] */ HANDLE eventHandle);

  END_INTERFACE
} IAudioEndpointVtbl;

interface IAudioEndpoint { CONST_VTBL struct IAudioEndpointVtbl *lpVtbl; };
...
typedef struct IAudioEndpointRTVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(IAudioEndpointRT *This,
                                             /* [in] */ REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);
...
interface IAudioEndpointRT { CONST_VTBL struct IAudioEndpointRTVtbl *lpVtbl; };
...
typedef struct IAudioInputEndpointRTVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(IAudioInputEndpointRT *This,
                                             /* [in] */ REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);
...
#define IAudioInputEndpointRT_GetInputDataPointer(This, pConnectionProperty,   \
                                                  pAeTimeStamp)                \
...
typedef struct IAudioOutputEndpointRTVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(IAudioOutputEndpointRT *This,
                                             /* [in] */ REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);
...
typedef struct IAudioDeviceEndpointVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(IAudioDeviceEndpoint *This,
                                             /* [in] */ REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);
  ...
  HRESULT(STDMETHODCALLTYPE *GetRTCaps)(IAudioDeviceEndpoint *This,
  ...
  DECLSPEC_XFGVIRT(IAudioDeviceEndpoint,
...
typedef struct IAudioEndpointOffloadStreamVolumeVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(IAudioEndpointOffloadStreamVolume *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(IAudioEndpointOffloadStreamVolume *This);
...
#define IAudioEndpointOffloadStreamVolume_QueryInterface(This, riid,           \
                                                         ppvObject)            \
  ((This)->lpVtbl->QueryInterface(This, riid, ppvObject))
...
#define IAudioEndpointOffloadStreamVolume_GetVolumeChannelCount(               \
    This, pu32ChannelCount)                                                    \
  ((This)->lpVtbl->GetVolumeChannelCount(This, pu32ChannelCount))

#define IAudioEndpointOffloadStreamVolume_SetChannelVolumes(                   \
    This, u32ChannelCount, pf32Volumes, u32CurveType, pCurveDuration)          \
  ((This)->lpVtbl->SetChannelVolumes(This, u32ChannelCount, pf32Volumes,       \
                                     u32CurveType, pCurveDuration))

#define IAudioEndpointOffloadStreamVolume_GetChannelVolumes(                   \
    This, u32ChannelCount, pf32Volumes)                                        \
...
typedef struct IAudioEndpointOffloadStreamMuteVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(IAudioEndpointOffloadStreamMute *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(IAudioEndpointOffloadStreamMute *This);

  DECLSPEC_XFGVIRT(IAudioEndpointOffloadStreamMute, SetMute)
  HRESULT(STDMETHODCALLTYPE *SetMute)(IAudioEndpointOffloadStreamMute *This,
                                      /* [in] */ boolean bMuted);

  DECLSPEC_XFGVIRT(IAudioEndpointOffloadStreamMute, GetMute)
  HRESULT(STDMETHODCALLTYPE *GetMute)(IAudioEndpointOffloadStreamMute *This,
                                      /* [out] */ boolean *pbMuted);
...
typedef struct IAudioEndpointOffloadStreamMeterVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(IAudioEndpointOffloadStreamMeter *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(IAudioEndpointOffloadStreamMeter *This);
...
#define IAudioEndpointOffloadStreamMeter_GetMeterChannelCount(                 \
    This, pu32ChannelCount)                                                    \
  ((This)->lpVtbl->GetMeterChannelCount(This, pu32ChannelCount))

#define IAudioEndpointOffloadStreamMeter_GetMeteringData(                      \
    This, u32ChannelCount, pf32PeakValues)                                     \
...
typedef struct IAudioEndpointLastBufferControlVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(IAudioEndpointLastBufferControl *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(IAudioEndpointLastBufferControl *This);

  DECLSPEC_XFGVIRT(IAudioEndpointLastBufferControl,
...
#define IAudioEndpointLastBufferControl_ReleaseOutputDataPointerForLastBuffer( \
    This, pConnectionProperty)                                                 \
  ((This)->lpVtbl->ReleaseOutputDataPointerForLastBuffer(This,                 \
                                                         pConnectionProperty))
...
typedef struct IAudioLfxControlVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(IAudioLfxControl *This,
                                             /* [in] */ REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(IAudioLfxControl *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(IAudioLfxControl *This);

  DECLSPEC_XFGVIRT(IAudioLfxControl, SetLocalEffectsState)
  HRESULT(STDMETHODCALLTYPE *SetLocalEffectsState)(IAudioLfxControl *This,
                                                   /* [in] */ BOOL bEnabled);

  DECLSPEC_XFGVIRT(IAudioLfxControl, GetLocalEffectsState)
  HRESULT(STDMETHODCALLTYPE *GetLocalEffectsState)(IAudioLfxControl *This,
                                                   /* [out] */ BOOL *pbEnabled);

  END_INTERFACE
} IAudioLfxControlVtbl;

interface IAudioLfxControl { CONST_VTBL struct IAudioLfxControlVtbl *lpVtbl; };
...
#define IAudioLfxControl_AddRef(This) ((This)->lpVtbl->AddRef(This))

#define IAudioLfxControl_Release(This) ((This)->lpVtbl->Release(This))
...
typedef struct IHardwareAudioEngineBaseVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(IHardwareAudioEngineBase *This,
                                             /* [in] */ REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(IHardwareAudioEngineBase *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(IHardwareAudioEngineBase *This);
  ...
  HRESULT(STDMETHODCALLTYPE *SetGfxState)(IHardwareAudioEngineBase *This,
                                          /* [annotation][in] */
                                          _In_ IMMDevice *pDevice,
                                          /* [annotation][in] */
                                          _In_ BOOL _bEnable);
  ...
  HRESULT(STDMETHODCALLTYPE *GetGfxState)(IHardwareAudioEngineBase *This,
                                          /* [annotation][in] */
                                          _In_ IMMDevice *pDevice,
                                          /* [annotation][out] */
...
#define IHardwareAudioEngineBase_AddRef(This) ((This)->lpVtbl->AddRef(This))

#define IHardwareAudioEngineBase_Release(This) ((This)->lpVtbl->Release(This))

#define IHardwareAudioEngineBase_GetAvailableOffloadConnectorCount(            \
    This, _pwstrDeviceId, _uConnectorId, _pAvailableConnectorInstanceCount)    \
  ((This)->lpVtbl->GetAvailableOffloadConnectorCount(                          \
      This, _pwstrDeviceId, _uConnectorId, _pAvailableConnectorInstanceCount))

#define IHardwareAudioEngineBase_GetEngineFormat(                              \
    This, pDevice, _bRequestDeviceFormat, _ppwfxFormat)                        \
  ((This)->lpVtbl->GetEngineFormat(This, pDevice, _bRequestDeviceFormat,       \
                                   _ppwfxFormat))

#define IHardwareAudioEngineBase_SetEngineDeviceFormat(This, pDevice,          \
                                                       _pwfxFormat)            \
...
typedef struct IAudioEndpointControlVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IAudioEndpointControl *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IAudioEndpointControl *This);

  DECLSPEC_XFGVIRT(IAudioEndpointControl, Start)
  HRESULT(STDMETHODCALLTYPE *Start)(__RPC__in IAudioEndpointControl *This);

  DECLSPEC_XFGVIRT(IAudioEndpointControl, Reset)
  HRESULT(STDMETHODCALLTYPE *Reset)(__RPC__in IAudioEndpointControl *This);

  DECLSPEC_XFGVIRT(IAudioEndpointControl, Stop)
  HRESULT(STDMETHODCALLTYPE *Stop)(__RPC__in IAudioEndpointControl *This);
...
DEFINE_GUIDSTRUCT("9F2F7B66-65AC-4FA6-8AE4-123C78B89313",
                  DEVINTERFACE_AUDIOENDPOINTPLUGIN);
#define DEVINTERFACE_AUDIOENDPOINTPLUGIN                                       \
  DEFINE_GUIDNAMED(DEVINTERFACE_AUDIOENDPOINTPLUGIN)
DEFINE_PROPERTYKEY(DEVPKEY_AudioEndpointPlugin_FactoryCLSID, 0x12d83bd7, 0xcf12,
                   0x46be, 0x85, 0x40, 0x81, 0x27, 0x10, 0xd3, 0x2, 0x1c, 1);
DEFINE_PROPERTYKEY(DEVPKEY_AudioEndpointPlugin_DataFlow, 0x12d83bd7, 0xcf12,
                   0x46be, 0x85, 0x40, 0x81, 0x27, 0x10, 0xd3, 0x2, 0x1c, 2);
DEFINE_PROPERTYKEY(DEVPKEY_AudioEndpointPlugin_PnPInterface, 0x12d83bd7, 0xcf12,
                   0x46be, 0x85, 0x40, 0x81, 0x27, 0x10, 0xd3, 0x2, 0x1c, 3);
DEFINE_PROPERTYKEY(DEVPKEY_AudioEndpointPlugin2_FactoryCLSID, 0x12d83bd7,
                   0xcf12, 0x46be, 0x85, 0x40, 0x81, 0x27, 0x10, 0xd3, 0x2,
                   0x1c, 4);
