...
public:
  virtual HRESULT STDMETHODCALLTYPE GetVideoAcceleratorGUIDs(
      ...
      /* [annotation][out][in] */
      _Out_writes_to_opt_(*pdwNumGuidsSupported, *pdwNumGuidsSupported)
  ...
  virtual HRESULT STDMETHODCALLTYPE GetUncompFormatsSupported(
      ...
      /* [annotation][out][in] */
      _Out_writes_to_opt_(*pdwNumFormatsSupported, *pdwNumFormatsSupported)
  ...
  virtual HRESULT STDMETHODCALLTYPE GetCompBufferInfo(
      ...
      /* [annotation][out] */
      _Out_writes_to_opt_(*pdwNumTypesCompBuffers, *pdwNumTypesCompBuffers)
