...
typedef struct IAudioMediaTypeVtbl {
  ...
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(IAudioMediaType *This,
                                             /* [in] */ REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(IAudioMediaType *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(IAudioMediaType *This);

  DECLSPEC_XFGVIRT(IAudioMediaType, IsCompressedFormat)
  HRESULT(STDMETHODCALLTYPE *IsCompressedFormat)(IAudioMediaType *This,
                                                 /* [annotation][out] */
                                                 _Out_ BOOL *pfCompressed);

  DECLSPEC_XFGVIRT(IAudioMediaType, IsEqual)
  HRESULT(STDMETHODCALLTYPE *IsEqual)(IAudioMediaType *This,
                                      /* [annotation][in] */
                                      _In_ IAudioMediaType *pIAudioType,
                                      /* [annotation][out] */
...
interface IAudioMediaType { CONST_VTBL struct IAudioMediaTypeVtbl *lpVtbl; };
...
#define IAudioMediaType_GetUncompressedAudioFormat(This,                       \
...
//
STDAPI CreateAudioMediaType(const WAVEFORMATEX *pAudioFormat,
