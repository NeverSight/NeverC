...
#define WSE_DeliveryModeRequestedUnavailable                                   \
  WSDXML_NAME_ENCODING(1, NAMESPACE_ENCODING_EVENTING)
#define WSE_InvalidExpirationTime                                              \
  WSDXML_NAME_ENCODING(2, NAMESPACE_ENCODING_EVENTING)
#define WSE_UnsupportedExpirationTime                                          \
  WSDXML_NAME_ENCODING(3, NAMESPACE_ENCODING_EVENTING)
#define WSE_FilteringNotSupported                                              \
  WSDXML_NAME_ENCODING(4, NAMESPACE_ENCODING_EVENTING)
#define WSE_FilteringRequestedUnavailable                                      \
  WSDXML_NAME_ENCODING(5, NAMESPACE_ENCODING_EVENTING)
#define WSE_EventSourceUnableToProcess                                         \
  WSDXML_NAME_ENCODING(6, NAMESPACE_ENCODING_EVENTING)
...
#define WSE_SupportedDialect                                                   \
  WSDXML_NAME_ENCODING(9, NAMESPACE_ENCODING_EVENTING)
#define WSE_SupportedDeliveryMode                                              \
  WSDXML_NAME_ENCODING(10, NAMESPACE_ENCODING_EVENTING)
...
#define WSE_SubscribeResponse                                                  \
  WSDXML_NAME_ENCODING(13, NAMESPACE_ENCODING_EVENTING)
...
#define WSE_SubscriptionManager                                                \
  WSDXML_NAME_ENCODING(28, NAMESPACE_ENCODING_EVENTING)
...
#define WSE_GetStatusResponse                                                  \
  WSDXML_NAME_ENCODING(33, NAMESPACE_ENCODING_EVENTING)
#define WSE_Unsubscribe WSDXML_NAME_ENCODING(34, NAMESPACE_ENCODING_EVENTING)
#define WSE_UnsubscribeResponse                                                \
  WSDXML_NAME_ENCODING(35, NAMESPACE_ENCODING_EVENTING)
#define WSE_EventSink WSDXML_NAME_ENCODING(36, NAMESPACE_ENCODING_EVENTING)
#define WSE_SubscriptionEnd                                                    \
  WSDXML_NAME_ENCODING(37, NAMESPACE_ENCODING_EVENTING)
...
#define WSA_EndpointReference                                                  \
  WSDXML_NAME_ENCODING(0, NAMESPACE_ENCODING_ADDRESSING)
#define WSA_Address WSDXML_NAME_ENCODING(1, NAMESPACE_ENCODING_ADDRESSING)
#define WSA_ReferenceParameters                                                \
  WSDXML_NAME_ENCODING(2, NAMESPACE_ENCODING_ADDRESSING)
...
#define WSA_RelationshipType                                                   \
  WSDXML_NAME_ENCODING(8, NAMESPACE_ENCODING_ADDRESSING)
...
#define WSA_InvalidMessageInformationHeader                                    \
  WSDXML_NAME_ENCODING(16, NAMESPACE_ENCODING_ADDRESSING)
#define WSA_MessageInformationHeaderRequired                                   \
  WSDXML_NAME_ENCODING(17, NAMESPACE_ENCODING_ADDRESSING)
#define WSA_DestinationUnreachable                                             \
  WSDXML_NAME_ENCODING(18, NAMESPACE_ENCODING_ADDRESSING)
#define WSA_ActionNotSupported                                                 \
  WSDXML_NAME_ENCODING(19, NAMESPACE_ENCODING_ADDRESSING)
#define WSA_EndpointUnavailable                                                \
  WSDXML_NAME_ENCODING(20, NAMESPACE_ENCODING_ADDRESSING)
#define WSA_ReferenceProperties                                                \
  WSDXML_NAME_ENCODING(21, NAMESPACE_ENCODING_ADDRESSING)
...
#define WSDISCO_ProbeMatches                                                   \
  WSDXML_NAME_ENCODING(3, NAMESPACE_ENCODING_DISCOVERY)
...
#define WSDISCO_ResolveMatch                                                   \
  WSDXML_NAME_ENCODING(6, NAMESPACE_ENCODING_DISCOVERY)
...
#define WSDISCO_MetadataVersion                                                \
  WSDXML_NAME_ENCODING(9, NAMESPACE_ENCODING_DISCOVERY)
#define WSDISCO_Transport WSDXML_NAME_ENCODING(10, NAMESPACE_ENCODING_DISCOVERY)
#define WSDISCO_AppSequence                                                    \
  WSDXML_NAME_ENCODING(11, NAMESPACE_ENCODING_DISCOVERY)
#define WSDISCO_InstanceId                                                     \
  WSDXML_NAME_ENCODING(12, NAMESPACE_ENCODING_DISCOVERY)
#define WSDISCO_SequenceId                                                     \
  WSDXML_NAME_ENCODING(13, NAMESPACE_ENCODING_DISCOVERY)
#define WSDISCO_MessageNumber                                                  \
  WSDXML_NAME_ENCODING(14, NAMESPACE_ENCODING_DISCOVERY)
...
#define WSDISCO_DiscoveryProxy                                                 \
  WSDXML_NAME_ENCODING(17, NAMESPACE_ENCODING_DISCOVERY)
#define WSDISCO_TargetService                                                  \
  WSDXML_NAME_ENCODING(18, NAMESPACE_ENCODING_DISCOVERY)
#define WSDISCO_Element WSDXML_NAME_ENCODING(19, NAMESPACE_ENCODING_DISCOVERY)
#define WSDISCO_ResolveMatches                                                 \
  WSDXML_NAME_ENCODING(20, NAMESPACE_ENCODING_DISCOVERY)
...
#define WSD_FilterActionNotSupported                                           \
  WSDXML_NAME_ENCODING(1, NAMESPACE_ENCODING_DEVPROF)
...
#define SOAP_SupportedEnvelope                                                 \
  WSDXML_NAME_ENCODING(16, NAMESPACE_ENCODING_ENVELOPE)
#define SOAP_NotUnderstood WSDXML_NAME_ENCODING(17, NAMESPACE_ENCODING_ENVELOPE)
#define SOAP_VersionMismatch                                                   \
  WSDXML_NAME_ENCODING(18, NAMESPACE_ENCODING_ENVELOPE)
#define SOAP_MustUnderstand_1                                                  \
  WSDXML_NAME_ENCODING(19, NAMESPACE_ENCODING_ENVELOPE)
#define SOAP_DataEncodingUnknown                                               \
  WSDXML_NAME_ENCODING(20, NAMESPACE_ENCODING_ENVELOPE)
...
#define DPP_MetadataVersion                                                    \
  WSDXML_NAME_ENCODING(9, NAMESPACE_ENCODING_DISCOVERY11)
...
#define DPP_MessageNumber                                                      \
  WSDXML_NAME_ENCODING(14, NAMESPACE_ENCODING_DISCOVERY11)
...
#define DPP_DiscoveryProxy                                                     \
  WSDXML_NAME_ENCODING(17, NAMESPACE_ENCODING_DISCOVERY11)
#define DPP_TargetService                                                      \
  WSDXML_NAME_ENCODING(18, NAMESPACE_ENCODING_DISCOVERY11)
#define DPP_Element WSDXML_NAME_ENCODING(19, NAMESPACE_ENCODING_DISCOVERY11)
#define DPP_ResolveMatches                                                     \
  WSDXML_NAME_ENCODING(20, NAMESPACE_ENCODING_DISCOVERY11)
...
#define WSDRegisterNamespaces(pContext)                                        \
  pContext->SetNamespaces(                                                     \
      WSDNamespaces, (sizeof(WSDNamespaces) / sizeof(WSDNamespaces[0])), 0)
