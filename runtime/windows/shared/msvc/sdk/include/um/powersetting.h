...
DWORD
WINAPI
PowerReadACValue(_In_opt_ HKEY RootPowerKey, _In_opt_ CONST GUID *SchemeGuid,
                 _In_opt_ CONST GUID *SubGroupOfPowerSettingsGuid,
                 _In_opt_ CONST GUID *PowerSettingGuid, _Out_opt_ PULONG Type,
...
DWORD
WINAPI
PowerReadDCValue(_In_opt_ HKEY RootPowerKey, _In_opt_ CONST GUID *SchemeGuid,
                 _In_opt_ CONST GUID *SubGroupOfPowerSettingsGuid,
                 _In_opt_ CONST GUID *PowerSettingGuid, _Out_opt_ PULONG Type,
...
DWORD
WINAPI
PowerWriteACValueIndex(_In_opt_ HKEY RootPowerKey, _In_ CONST GUID *SchemeGuid,
                       _In_opt_ CONST GUID *SubGroupOfPowerSettingsGuid,
...
DWORD
WINAPI
PowerWriteDCValueIndex(_In_opt_ HKEY RootPowerKey, _In_ CONST GUID *SchemeGuid,
                       _In_opt_ CONST GUID *SubGroupOfPowerSettingsGuid,
                       _In_opt_ CONST GUID *PowerSettingGuid,
...
DWORD
WINAPI
PowerGetActiveScheme(_In_opt_ HKEY UserRootPowerKey,
...
DWORD
WINAPI
PowerSetActiveScheme(_In_opt_ HKEY UserRootPowerKey,
...
DWORD
WINAPI
PowerSettingRegisterNotification(_In_ LPCGUID SettingGuid, _In_ DWORD Flags,
...
DWORD
WINAPI
PowerSettingUnregisterNotification(_Inout_ HPOWERNOTIFY RegistrationHandle);
...
typedef _Function_class_(EFFECTIVE_POWER_MODE_CALLBACK) VOID WINAPI
    EFFECTIVE_POWER_MODE_CALLBACK(_In_ EFFECTIVE_POWER_MODE Mode,
...
_Must_inspect_result_
    HRESULT WINAPI PowerRegisterForEffectivePowerModeNotifications(
        _In_ ULONG Version, _In_ EFFECTIVE_POWER_MODE_CALLBACK *Callback,
        _In_opt_ PVOID Context, _Outptr_ PVOID *RegistrationHandle);
