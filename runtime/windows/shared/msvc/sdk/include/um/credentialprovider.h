...
typedef /* [v1_enum] */
    enum _CREDENTIAL_PROVIDER_GET_SERIALIZATION_RESPONSE {
      ...
      CPGSR_RETURN_NO_CREDENTIAL_FINISHED =
          (CPGSR_RETURN_CREDENTIAL_FINISHED + 1)
...
public:
  ...
  virtual HRESULT STDMETHODCALLTYPE GetComboBoxValueAt(
      /* [in] */ DWORD dwFieldID, DWORD dwItem,
      /* [annotation][string][out] */
...
typedef struct ICredentialProviderCredentialEventsVtbl {
  ...
  DECLSPEC_XFGVIRT(ICredentialProviderCredentialEvents,
...
typedef struct ICredentialProviderEventsVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in ICredentialProviderEvents *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in ICredentialProviderEvents *This);
...
typedef struct ICredentialProviderCredentialWithFieldOptionsVtbl {
  ...
  DECLSPEC_XFGVIRT(ICredentialProviderCredentialWithFieldOptions,
                   GetFieldOptions)
...
public:
  ...
  virtual HRESULT STDMETHODCALLTYPE GetAccountOptions(
      /* [annotation][out] */
      _Out_ CREDENTIAL_PROVIDER_ACCOUNT_OPTIONS *
