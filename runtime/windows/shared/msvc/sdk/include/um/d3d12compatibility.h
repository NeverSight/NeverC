...
public:
  ...
  virtual HRESULT STDMETHODCALLTYPE CreateSharedHeap(
      ...
      D3D12_COMPATIBILITY_SHARED_FLAGS CompatibilityFlags, REFIID riid,
...
typedef struct ID3D12CompatibilityDeviceVtbl {
  ...
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(ID3D12CompatibilityDevice *This,
                                             REFIID riid,
  ...
  HRESULT(STDMETHODCALLTYPE *CreateSharedHeap)(
      ID3D12CompatibilityDevice *This, _In_ const D3D12_HEAP_DESC *pHeapDesc,
      D3D12_COMPATIBILITY_SHARED_FLAGS CompatibilityFlags, REFIID riid,
  ...
  HRESULT(STDMETHODCALLTYPE *ReflectSharedProperties)(
      ID3D12CompatibilityDevice *This, _In_ ID3D12Object *pHeapOrResource,
      D3D12_REFLECT_SHARED_PROPERTY ReflectType,
...
#define ID3D12CompatibilityDevice_CreateSharedResource(                        \
    ...
    pOptimizedClearValue, pFlags11, CompatibilityFlags, pLifetimeTracker,      \
    pOwningSwapchain, riid, ppResource)                                        \
  ((This)->lpVtbl->CreateSharedResource(                                       \
      This, pHeapProperties, HeapFlags, pDesc, InitialResourceState,           \
      pOptimizedClearValue, pFlags11, CompatibilityFlags, pLifetimeTracker,    \
      pOwningSwapchain, riid, ppResource))

#define ID3D12CompatibilityDevice_CreateSharedHeap(                            \
    This, pHeapDesc, CompatibilityFlags, riid, ppHeap)                         \
  ((This)->lpVtbl->CreateSharedHeap(This, pHeapDesc, CompatibilityFlags, riid, \
                                    ppHeap))

#define ID3D12CompatibilityDevice_ReflectSharedProperties(                     \
    This, pHeapOrResource, ReflectType, pData, DataSize)                       \
  ((This)->lpVtbl->ReflectSharedProperties(This, pHeapOrResource, ReflectType, \
                                           pData, DataSize))
...
typedef struct D3D11On12CreatorIDVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(D3D11On12CreatorID *This,
                                             REFIID riid,
                                             _COM_Outptr_ void **ppvObject);
...
typedef struct D3D9On12CreatorIDVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(D3D9On12CreatorID *This,
                                             REFIID riid,
                                             _COM_Outptr_ void **ppvObject);
...
typedef struct OpenGLOn12CreatorIDVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(OpenGLOn12CreatorID *This,
                                             REFIID riid,
                                             _COM_Outptr_ void **ppvObject);
...
typedef struct OpenCLOn12CreatorIDVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(OpenCLOn12CreatorID *This,
                                             REFIID riid,
                                             _COM_Outptr_ void **ppvObject);
...
typedef struct VulkanOn12CreatorIDVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(VulkanOn12CreatorID *This,
                                             REFIID riid,
                                             _COM_Outptr_ void **ppvObject);
...
typedef struct DirectMLTensorFlowCreatorIDVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(DirectMLTensorFlowCreatorID *This,
                                             REFIID riid,
                                             _COM_Outptr_ void **ppvObject);
...
typedef struct DirectMLPyTorchCreatorIDVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(DirectMLPyTorchCreatorID *This,
                                             REFIID riid,
                                             _COM_Outptr_ void **ppvObject);
...
typedef struct DirectMLWebNNCreatorIDVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(DirectMLWebNNCreatorID *This,
                                             REFIID riid,
                                             _COM_Outptr_ void **ppvObject);
...
#pragma endregion
DEFINE_GUID(IID_ID3D12CompatibilityDevice, 0x8f1c0e3c, 0xfae3, 0x4a82, 0xb0,
            0x98, 0xbf, 0xe1, 0x70, 0x82, 0x07, 0xff);
DEFINE_GUID(IID_D3D11On12CreatorID, 0xedbf5678, 0x2960, 0x4e81, 0x84, 0x29,
            0x99, 0xd4, 0xb2, 0x63, 0x0c, 0x4e);
DEFINE_GUID(IID_D3D9On12CreatorID, 0xfffcbb7f, 0x15d3, 0x42a2, 0x84, 0x1e, 0x9d,
            0x8d, 0x32, 0xf3, 0x7d, 0xdd);
DEFINE_GUID(IID_OpenGLOn12CreatorID, 0x6bb3cd34, 0x0d19, 0x45ab, 0x97, 0xed,
            0xd7, 0x20, 0xba, 0x3d, 0xfc, 0x80);
DEFINE_GUID(IID_OpenCLOn12CreatorID, 0x3f76bb74, 0x91b5, 0x4a88, 0xb1, 0x26,
            0x20, 0xca, 0x03, 0x31, 0xcd, 0x60);
DEFINE_GUID(IID_VulkanOn12CreatorID, 0xbc806e01, 0x3052, 0x406c, 0xa3, 0xe8,
            0x9f, 0xc0, 0x7f, 0x04, 0x8f, 0x98);
DEFINE_GUID(IID_DirectMLTensorFlowCreatorID, 0xcb7490ac, 0x8a0f, 0x44ec, 0x9b,
            0x7b, 0x6f, 0x4c, 0xaf, 0xe8, 0xe9, 0xab);
DEFINE_GUID(IID_DirectMLPyTorchCreatorID, 0xaf029192, 0xfba1, 0x4b05, 0x91,
            0x16, 0x23, 0x5e, 0x06, 0x56, 0x03, 0x54);
DEFINE_GUID(IID_DirectMLWebNNCreatorID, 0xfdf01a76, 0x1e11, 0x450f, 0x90, 0x2b,
            0x74, 0xf0, 0x4e, 0xa0, 0x80, 0x94);
