...
#define LINEDISCONNECTMODE_DESTINATIONBARRED                                   \
  0x00100000 // TAPI v2.0, WINCE 5.1 AKU 3.X
#define LINEDISCONNECTMODE_FDNRESTRICT                                         \
  0x00200000 // TAPI v2.0, WINCE 5.1 AKU 3.X
#endif
...
LONG WINAPI lineAddProvider( // TAPI v1.4
    LPCSTR lpszProviderFilename, HWND hwndOwner,
...
LONG WINAPI lineAgentSpecific( // TAPI v2.0
    HLINE hLine, DWORD dwAddressID, DWORD dwAgentExtensionIDIndex,
...
LONG WINAPI lineCreateAgentW( // TAPI v2.2
    HLINE hLine, _In_opt_ LPCWSTR lpszAgentID, _In_opt_ LPCWSTR lpszAgentPIN,
    LPHAGENT lphAgent);

LONG WINAPI lineCreateAgentA( // TAPI v2.2
    HLINE hLine, _In_opt_ LPCSTR lpszAgentID, _In_opt_ LPCSTR lpszAgentPIN,
    LPHAGENT lphAgent);
...
LONG WINAPI lineGatherDigits(HCALL hCall, DWORD dwDigitModes,
...
#if WIN32
LONG WINAPI lineGatherDigitsA(HCALL hCall, DWORD dwDigitModes,
                              _Out_writes_opt_(dwNumDigits) LPSTR lpsDigits,
                              DWORD dwNumDigits, LPCSTR lpszTerminationDigits,
                              DWORD dwFirstDigitTimeout,
                              DWORD dwInterDigitTimeout);

LONG WINAPI lineGatherDigitsW(HCALL hCall, DWORD dwDigitModes,
...
LONG WINAPI lineGetAgentCapsA( // TAPI v2.0
    HLINEAPP hLineApp, DWORD dwDeviceID, DWORD dwAddressID,
    DWORD dwAppAPIVersion, LPLINEAGENTCAPS lpAgentCaps);
...
LONG WINAPI lineGetAgentSessionInfo( // TAPI v2.2
    HLINE hLine, HAGENTSESSION hAgentSession,
...
LONG WINAPI lineGetAppPriority( // TAPI v1.4
    LPCSTR lpszAppFilename, DWORD dwMediaMode, LPLINEEXTENSIONID lpExtensionID,
    DWORD dwRequestMode, LPVARSTRING lpExtensionName, LPDWORD lpdwPriority);
...
LONG WINAPI lineGetAppPriorityW( // TAPI v1.4
    LPCWSTR lpszAppFilename, DWORD dwMediaMode, LPLINEEXTENSIONID lpExtensionID,
    DWORD dwRequestMode, LPVARSTRING lpExtensionName, LPDWORD lpdwPriority);
...
LONG WINAPI lineGetProxyStatus( // TAPI v2.2
    HLINEAPP hLineApp, DWORD dwDeviceID, DWORD dwAppAPIVersion,
...
LONG WINAPI lineProxyMessage( // TAPI v2.0
    HLINE hLine, HCALL hCall, DWORD dwMsg, DWORD dwParam1, DWORD dwParam2,
    DWORD dwParam3);
...
LONG WINAPI lineSetAgentSessionState( // TAPI v2.2
    HLINE hLine, HAGENTSESSION hAgentSession, DWORD dwAgentSessionState,
...
LONG WINAPI lineSetAppPriority( // TAPI v1.4
    LPCSTR lpszAppFilename, DWORD dwMediaMode, LPLINEEXTENSIONID lpExtensionID,
    DWORD dwRequestMode, LPCSTR lpszExtensionName, DWORD dwPriority);
...
LONG WINAPI lineSetAppPriorityW( // TAPI v1.4
    LPCWSTR lpszAppFilename, DWORD dwMediaMode, LPLINEEXTENSIONID lpExtensionID,
    DWORD dwRequestMode, LPCWSTR lpszExtensionName, DWORD dwPriority);
...
LONG WINAPI lineSetCallQualityOfService( // TAPI v2.0
    HCALL hCall, LPVOID lpSendingFlowspec, DWORD dwSendingFlowspecSize,
...
LONG WINAPI lineTranslateDialog( // TAPI v1.4
    HLINEAPP hLineApp, DWORD dwDeviceID, DWORD dwAPIVersion, HWND hwndOwner,
...
LONG WINAPI tapiGetLocationInfo(_Out_writes_(8) LPSTR lpszCountryCode,
                                _Out_writes_(8) LPSTR lpszCityCode);

#if WIN32
LONG WINAPI tapiGetLocationInfoA(_Out_writes_(8) LPSTR lpszCountryCode,
                                 _Out_writes_(8) LPSTR lpszCityCode);

LONG WINAPI tapiGetLocationInfoW(_Out_writes_(8) LPWSTR lpszCountryCodeW,
