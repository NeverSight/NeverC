...
typedef struct ID3D11Device4Vtbl {
  ...
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(ID3D11Device4 *This,
                                             /* [in] */ REFIID riid,
  ...
  HRESULT(STDMETHODCALLTYPE *CheckFeatureSupport)(
      ID3D11Device4 *This, D3D11_FEATURE Feature,
      /* [annotation] */
...
interface ID3D11Device4 { CONST_VTBL struct ID3D11Device4Vtbl *lpVtbl; };
...
#define ID3D11Device4_CreateDeferredContext1(This, ContextFlags,               \
                                             ppDeferredContext)                \
  ((This)->lpVtbl->CreateDeferredContext1(This, ContextFlags,                  \
                                          ppDeferredContext))
...
#define ID3D11Device4_CreateDeferredContext2(This, ContextFlags,               \
                                             ppDeferredContext)                \
  ((This)->lpVtbl->CreateDeferredContext2(This, ContextFlags,                  \
                                          ppDeferredContext))

#define ID3D11Device4_GetResourceTiling(                                       \
    This, pTiledResource, pNumTilesForEntireResource, pPackedMipDesc,          \
...
#define ID3D11Device4_CheckMultisampleQualityLevels1(                          \
  ...
  ((This)->lpVtbl->CheckMultisampleQualityLevels1(This, Format, SampleCount,   \
                                                  Flags, pNumQualityLevels))

#define ID3D11Device4_CreateTexture2D1(This, pDesc1, pInitialData,             \
                                       ppTexture2D)                            \
  ((This)->lpVtbl->CreateTexture2D1(This, pDesc1, pInitialData, ppTexture2D))

#define ID3D11Device4_CreateTexture3D1(This, pDesc1, pInitialData,             \
                                       ppTexture3D)                            \
  ((This)->lpVtbl->CreateTexture3D1(This, pDesc1, pInitialData, ppTexture3D))

#define ID3D11Device4_CreateRasterizerState2(This, pRasterizerDesc,            \
                                             ppRasterizerState)                \
  ((This)->lpVtbl->CreateRasterizerState2(This, pRasterizerDesc,               \
                                          ppRasterizerState))

#define ID3D11Device4_CreateShaderResourceView1(This, pResource, pDesc1,       \
                                                ppSRView1)                     \
  ((This)->lpVtbl->CreateShaderResourceView1(This, pResource, pDesc1,          \
                                             ppSRView1))

#define ID3D11Device4_CreateUnorderedAccessView1(This, pResource, pDesc1,      \
                                                 ppUAView1)                    \
  ((This)->lpVtbl->CreateUnorderedAccessView1(This, pResource, pDesc1,         \
                                              ppUAView1))

#define ID3D11Device4_CreateRenderTargetView1(This, pResource, pDesc1,         \
                                              ppRTView1)                       \
...
#define ID3D11Device4_CreateDeferredContext3(This, ContextFlags,               \
                                             ppDeferredContext)                \
  ((This)->lpVtbl->CreateDeferredContext3(This, ContextFlags,                  \
                                          ppDeferredContext))

#define ID3D11Device4_WriteToSubresource(This, pDstResource, DstSubresource,   \
                                         pDstBox, pSrcData, SrcRowPitch,       \
                                         SrcDepthPitch)                        \
  ((This)->lpVtbl->WriteToSubresource(This, pDstResource, DstSubresource,      \
                                      pDstBox, pSrcData, SrcRowPitch,          \
                                      SrcDepthPitch))

#define ID3D11Device4_ReadFromSubresource(This, pDstData, DstRowPitch,         \
                                          DstDepthPitch, pSrcResource,         \
                                          SrcSubresource, pSrcBox)             \
  ((This)->lpVtbl->ReadFromSubresource(This, pDstData, DstRowPitch,            \
                                       DstDepthPitch, pSrcResource,            \
                                       SrcSubresource, pSrcBox))
...
typedef struct ID3D11Device5Vtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(ID3D11Device5 *This,
                                             /* [in] */ REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);
  ...
  DECLSPEC_XFGVIRT(ID3D11Device, CheckFeatureSupport)
  HRESULT(STDMETHODCALLTYPE *CheckFeatureSupport)(
      ID3D11Device5 *This, D3D11_FEATURE Feature,
      /* [annotation] */
      _Out_writes_bytes_(FeatureSupportDataSize) void *pFeatureSupportData,
      UINT FeatureSupportDataSize);
  ...
  DECLSPEC_XFGVIRT(ID3D11Device, SetPrivateData)
  HRESULT(STDMETHODCALLTYPE *SetPrivateData)(ID3D11Device5 *This,
                                             /* [annotation] */
                                             _In_ REFGUID guid,
                                             /* [annotation] */
                                             _In_ UINT DataSize,
  ...
  DECLSPEC_XFGVIRT(ID3D11Device3, WriteToSubresource)
  void(STDMETHODCALLTYPE *WriteToSubresource)(ID3D11Device5 *This,
                                              /* [annotation] */
                                              _In_ ID3D11Resource *pDstResource,
                                              /* [annotation] */
                                              _In_ UINT DstSubresource,
...
interface ID3D11Device5 { CONST_VTBL struct ID3D11Device5Vtbl *lpVtbl; };
...
#define ID3D11Device5_CreateDeferredContext2(This, ContextFlags,               \
                                             ppDeferredContext)                \
  ((This)->lpVtbl->CreateDeferredContext2(This, ContextFlags,                  \
                                          ppDeferredContext))
...
#define ID3D11Device5_CreateTexture2D1(This, pDesc1, pInitialData,             \
                                       ppTexture2D)                            \
  ((This)->lpVtbl->CreateTexture2D1(This, pDesc1, pInitialData, ppTexture2D))

#define ID3D11Device5_CreateTexture3D1(This, pDesc1, pInitialData,             \
                                       ppTexture3D)                            \
  ((This)->lpVtbl->CreateTexture3D1(This, pDesc1, pInitialData, ppTexture3D))

#define ID3D11Device5_CreateRasterizerState2(This, pRasterizerDesc,            \
                                             ppRasterizerState)                \
  ((This)->lpVtbl->CreateRasterizerState2(This, pRasterizerDesc,               \
                                          ppRasterizerState))

#define ID3D11Device5_CreateShaderResourceView1(This, pResource, pDesc1,       \
                                                ppSRView1)                     \
  ((This)->lpVtbl->CreateShaderResourceView1(This, pResource, pDesc1,          \
                                             ppSRView1))

#define ID3D11Device5_CreateUnorderedAccessView1(This, pResource, pDesc1,      \
                                                 ppUAView1)                    \
  ((This)->lpVtbl->CreateUnorderedAccessView1(This, pResource, pDesc1,         \
                                              ppUAView1))

#define ID3D11Device5_CreateRenderTargetView1(This, pResource, pDesc1,         \
                                              ppRTView1)                       \
  ((This)->lpVtbl->CreateRenderTargetView1(This, pResource, pDesc1, ppRTView1))
...
#define ID3D11Device5_CreateDeferredContext3(This, ContextFlags,               \
                                             ppDeferredContext)                \
  ((This)->lpVtbl->CreateDeferredContext3(This, ContextFlags,                  \
                                          ppDeferredContext))

#define ID3D11Device5_WriteToSubresource(This, pDstResource, DstSubresource,   \
                                         pDstBox, pSrcData, SrcRowPitch,       \
                                         SrcDepthPitch)                        \
  ((This)->lpVtbl->WriteToSubresource(This, pDstResource, DstSubresource,      \
                                      pDstBox, pSrcData, SrcRowPitch,          \
...
#define ID3D11Device5_ReadFromSubresource(This, pDstData, DstRowPitch,         \
                                          DstDepthPitch, pSrcResource,         \
                                          SrcSubresource, pSrcBox)             \
  ((This)->lpVtbl->ReadFromSubresource(This, pDstData, DstRowPitch,            \
                                       DstDepthPitch, pSrcResource,            \
...
#define ID3D11Device5_OpenSharedFence(This, hFence, ReturnedInterface,         \
                                      ppFence)                                 \
  ((This)->lpVtbl->OpenSharedFence(This, hFence, ReturnedInterface, ppFence))

#define ID3D11Device5_CreateFence(This, InitialValue, Flags,                   \
                                  ReturnedInterface, ppFence)                  \
  ((This)->lpVtbl->CreateFence(This, InitialValue, Flags, ReturnedInterface,   \
                               ppFence))
...
#define ID3D11VideoContext2_GetDecoderBuffer(This, pDecoder, Type,             \
                                             pBufferSize, ppBuffer)            \
  ((This)->lpVtbl->GetDecoderBuffer(This, pDecoder, Type, pBufferSize,         \
                                    ppBuffer))

#define ID3D11VideoContext2_ReleaseDecoderBuffer(This, pDecoder, Type)         \
  ((This)->lpVtbl->ReleaseDecoderBuffer(This, pDecoder, Type))

#define ID3D11VideoContext2_DecoderBeginFrame(This, pDecoder, pView,           \
                                              ContentKeySize, pContentKey)     \
  ((This)->lpVtbl->DecoderBeginFrame(This, pDecoder, pView, ContentKeySize,    \
                                     pContentKey))

#define ID3D11VideoContext2_DecoderEndFrame(This, pDecoder)                    \
  ((This)->lpVtbl->DecoderEndFrame(This, pDecoder))

#define ID3D11VideoContext2_SubmitDecoderBuffers(This, pDecoder, NumBuffers,   \
                                                 pBufferDesc)                  \
  ((This)->lpVtbl->SubmitDecoderBuffers(This, pDecoder, NumBuffers,            \
                                        pBufferDesc))
...
#define ID3D11VideoContext2_VideoProcessorSetOutputTargetRect(                 \
    This, pVideoProcessor, Enable, pRect)                                      \
  ((This)->lpVtbl->VideoProcessorSetOutputTargetRect(This, pVideoProcessor,    \
                                                     Enable, pRect))

#define ID3D11VideoContext2_VideoProcessorSetOutputBackgroundColor(            \
    This, pVideoProcessor, YCbCr, pColor)                                      \
  ((This)->lpVtbl->VideoProcessorSetOutputBackgroundColor(                     \
      This, pVideoProcessor, YCbCr, pColor))

#define ID3D11VideoContext2_VideoProcessorSetOutputColorSpace(                 \
    This, pVideoProcessor, pColorSpace)                                        \
  ((This)->lpVtbl->VideoProcessorSetOutputColorSpace(This, pVideoProcessor,    \
                                                     pColorSpace))
...
#define ID3D11VideoContext2_VideoProcessorSetOutputStereoMode(                 \
    This, pVideoProcessor, Enable)                                             \
  ((This)->lpVtbl->VideoProcessorSetOutputStereoMode(This, pVideoProcessor,    \
                                                     Enable))

#define ID3D11VideoContext2_VideoProcessorSetOutputExtension(                  \
    This, pVideoProcessor, pExtensionGuid, DataSize, pData)                    \
  ((This)->lpVtbl->VideoProcessorSetOutputExtension(                           \
      This, pVideoProcessor, pExtensionGuid, DataSize, pData))

#define ID3D11VideoContext2_VideoProcessorGetOutputTargetRect(                 \
    This, pVideoProcessor, Enabled, pRect)                                     \
  ((This)->lpVtbl->VideoProcessorGetOutputTargetRect(This, pVideoProcessor,    \
                                                     Enabled, pRect))
...
#define ID3D11VideoContext2_VideoProcessorGetOutputColorSpace(                 \
    This, pVideoProcessor, pColorSpace)                                        \
  ((This)->lpVtbl->VideoProcessorGetOutputColorSpace(This, pVideoProcessor,    \
                                                     pColorSpace))
...
#define ID3D11VideoContext2_VideoProcessorSetStreamOutputRate(                 \
  ...
  ((This)->lpVtbl->VideoProcessorSetStreamOutputRate(                          \
      This, pVideoProcessor, StreamIndex, OutputRate, RepeatFrame,             \
      pCustomRate))
...
#define ID3D11VideoContext2_VideoProcessorSetStreamLumaKey(                    \
  ...
  ((This)->lpVtbl->VideoProcessorSetStreamLumaKey(                             \
      This, pVideoProcessor, StreamIndex, Enable, Lower, Upper))

#define ID3D11VideoContext2_VideoProcessorSetStreamStereoFormat(               \
    This, pVideoProcessor, StreamIndex, Enable, Format, LeftViewFrame0,        \
...
#define ID3D11VideoContext2_VideoProcessorSetStreamFilter(                     \
  ...
  ((This)->lpVtbl->VideoProcessorSetStreamFilter(                              \
      This, pVideoProcessor, StreamIndex, Filter, Enable, Level))
...
#define ID3D11VideoContext2_VideoProcessorGetStreamFrameFormat(                \
  ...
  ((This)->lpVtbl->VideoProcessorGetStreamFrameFormat(                         \
      This, pVideoProcessor, StreamIndex, pFrameFormat))

#define ID3D11VideoContext2_VideoProcessorGetStreamColorSpace(                 \
    This, pVideoProcessor, StreamIndex, pColorSpace)                           \
  ((This)->lpVtbl->VideoProcessorGetStreamColorSpace(                          \
      This, pVideoProcessor, StreamIndex, pColorSpace))

#define ID3D11VideoContext2_VideoProcessorGetStreamOutputRate(                 \
    This, pVideoProcessor, StreamIndex, pOutputRate, pRepeatFrame,             \
    pCustomRate)                                                               \
...
#define ID3D11VideoContext2_VideoProcessorGetStreamLumaKey(                    \
  ...
  ((This)->lpVtbl->VideoProcessorGetStreamLumaKey(                             \
      This, pVideoProcessor, StreamIndex, pEnabled, pLower, pUpper))
...
#define ID3D11VideoContext2_VideoProcessorBlt(                                 \
  ...
  ((This)->lpVtbl->VideoProcessorBlt(This, pVideoProcessor, pView,             \
                                     OutputFrame, StreamCount, pStreams))

#define ID3D11VideoContext2_NegotiateCryptoSessionKeyExchange(                 \
    This, pCryptoSession, DataSize, pData)                                     \
  ((This)->lpVtbl->NegotiateCryptoSessionKeyExchange(This, pCryptoSession,     \
                                                     DataSize, pData))

#define ID3D11VideoContext2_EncryptionBlt(This, pCryptoSession, pSrcSurface,   \
                                          pDstSurface, IVSize, pIV)            \
  ((This)->lpVtbl->EncryptionBlt(This, pCryptoSession, pSrcSurface,            \
                                 pDstSurface, IVSize, pIV))

#define ID3D11VideoContext2_DecryptionBlt(                                     \
    This, pCryptoSession, pSrcSurface, pDstSurface, pEncryptedBlockInfo,       \
    ContentKeySize, pContentKey, IVSize, pIV)                                  \
  ((This)->lpVtbl->DecryptionBlt(This, pCryptoSession, pSrcSurface,            \
                                 pDstSurface, pEncryptedBlockInfo,             \
                                 ContentKeySize, pContentKey, IVSize, pIV))

#define ID3D11VideoContext2_StartSessionKeyRefresh(                            \
    This, pCryptoSession, RandomNumberSize, pRandomNumber)                     \
  ((This)->lpVtbl->StartSessionKeyRefresh(This, pCryptoSession,                \
...
#define ID3D11VideoContext2_GetEncryptionBltKey(This, pCryptoSession, KeySize, \
                                                pReadbackKey)                  \
  ((This)->lpVtbl->GetEncryptionBltKey(This, pCryptoSession, KeySize,          \
                                       pReadbackKey))

#define ID3D11VideoContext2_NegotiateAuthenticatedChannelKeyExchange(          \
    This, pChannel, DataSize, pData)                                           \
  ((This)->lpVtbl->NegotiateAuthenticatedChannelKeyExchange(This, pChannel,    \
                                                            DataSize, pData))

#define ID3D11VideoContext2_QueryAuthenticatedChannel(                         \
    This, pChannel, InputSize, pInput, OutputSize, pOutput)                    \
  ((This)->lpVtbl->QueryAuthenticatedChannel(This, pChannel, InputSize,        \
                                             pInput, OutputSize, pOutput))

#define ID3D11VideoContext2_ConfigureAuthenticatedChannel(                     \
    This, pChannel, InputSize, pInput, pOutput)                                \
  ((This)->lpVtbl->ConfigureAuthenticatedChannel(This, pChannel, InputSize,    \
                                                 pInput, pOutput))
...
#define ID3D11VideoContext2_SubmitDecoderBuffers1(This, pDecoder, NumBuffers,  \
                                                  pBufferDesc)                 \
  ((This)->lpVtbl->SubmitDecoderBuffers1(This, pDecoder, NumBuffers,           \
                                         pBufferDesc))

#define ID3D11VideoContext2_GetDataForNewHardwareKey(                          \
    This, pCryptoSession, PrivateInputSize, pPrivatInputData,                  \
    pPrivateOutputData)                                                        \
  ((This)->lpVtbl->GetDataForNewHardwareKey(                                   \
      This, pCryptoSession, PrivateInputSize, pPrivatInputData,                \
      pPrivateOutputData))

#define ID3D11VideoContext2_CheckCryptoSessionStatus(This, pCryptoSession,     \
                                                     pStatus)                  \
...
#define ID3D11VideoContext2_DecoderUpdateDownsampling(This, pDecoder,          \
                                                      pOutputDesc)             \
...
#define ID3D11VideoContext2_VideoProcessorSetOutputColorSpace1(                \
  ...
  ((This)->lpVtbl->VideoProcessorSetOutputColorSpace1(This, pVideoProcessor,   \
                                                      ColorSpace))

#define ID3D11VideoContext2_VideoProcessorSetOutputShaderUsage(                \
    This, pVideoProcessor, ShaderUsage)                                        \
  ((This)->lpVtbl->VideoProcessorSetOutputShaderUsage(This, pVideoProcessor,   \
                                                      ShaderUsage))

#define ID3D11VideoContext2_VideoProcessorGetOutputColorSpace1(                \
    This, pVideoProcessor, pColorSpace)                                        \
  ((This)->lpVtbl->VideoProcessorGetOutputColorSpace1(This, pVideoProcessor,   \
                                                      pColorSpace))

#define ID3D11VideoContext2_VideoProcessorGetOutputShaderUsage(                \
    This, pVideoProcessor, pShaderUsage)                                       \
  ((This)->lpVtbl->VideoProcessorGetOutputShaderUsage(This, pVideoProcessor,   \
                                                      pShaderUsage))
...
#define ID3D11VideoContext2_VideoProcessorSetStreamMirror(                     \
  ...
  ((This)->lpVtbl->VideoProcessorSetStreamMirror(                              \
      This, pVideoProcessor, StreamIndex, Enable, FlipHorizontal,              \
      FlipVertical))
...
#define ID3D11VideoContext2_VideoProcessorGetStreamMirror(                     \
    This, pVideoProcessor, StreamIndex, pEnable, pFlipHorizontal,              \
    pFlipVertical)                                                             \
...
#define ID3D11VideoContext2_VideoProcessorGetBehaviorHints(                    \
    This, pVideoProcessor, OutputWidth, OutputHeight, OutputFormat,            \
    StreamCount, pStreams, pBehaviorHints)                                     \
...
#define ID3D11VideoContext2_VideoProcessorSetOutputHDRMetaData(                \
  ...
  ((This)->lpVtbl->VideoProcessorSetOutputHDRMetaData(                         \
      This, pVideoProcessor, Type, Size, pHDRMetaData))

#define ID3D11VideoContext2_VideoProcessorGetOutputHDRMetaData(                \
    This, pVideoProcessor, pType, Size, pMetaData)                             \
  ((This)->lpVtbl->VideoProcessorGetOutputHDRMetaData(This, pVideoProcessor,   \
                                                      pType, Size, pMetaData))
...
typedef struct ID3D11VideoDevice2Vtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(ID3D11VideoDevice2 *This,
                                             /* [in] */ REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(ID3D11VideoDevice2 *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(ID3D11VideoDevice2 *This);
  ...
  HRESULT(STDMETHODCALLTYPE *SetPrivateData)(ID3D11VideoDevice2 *This,
                                             /* [annotation] */
                                             _In_ REFGUID guid,
                                             /* [annotation] */
                                             _In_ UINT DataSize,
  ...
  DECLSPEC_XFGVIRT(ID3D11VideoDevice1,
  ...
  HRESULT(STDMETHODCALLTYPE *CheckFeatureSupport)(
      ID3D11VideoDevice2 *This, D3D11_FEATURE_VIDEO Feature,
      /* [annotation] */
      _Out_writes_bytes_(FeatureSupportDataSize) void *pFeatureSupportData,
      UINT FeatureSupportDataSize);
...
#define ID3D11VideoDevice2_CreateVideoDecoderOutputView(This, pResource,       \
                                                        pDesc, ppVDOVView)     \
  ((This)->lpVtbl->CreateVideoDecoderOutputView(This, pResource, pDesc,        \
                                                ppVDOVView))

#define ID3D11VideoDevice2_CreateVideoProcessorInputView(                      \
    This, pResource, pEnum, pDesc, ppVPIView)                                  \
  ((This)->lpVtbl->CreateVideoProcessorInputView(This, pResource, pEnum,       \
                                                 pDesc, ppVPIView))

#define ID3D11VideoDevice2_CreateVideoProcessorOutputView(                     \
...
#define ID3D11VideoDevice2_GetVideoDecoderProfile(This, Index,                 \
                                                  pDecoderProfile)             \
  ((This)->lpVtbl->GetVideoDecoderProfile(This, Index, pDecoderProfile))

#define ID3D11VideoDevice2_CheckVideoDecoderFormat(This, pDecoderProfile,      \
                                                   Format, pSupported)         \
...
#define ID3D11VideoDevice2_GetContentProtectionCaps(This, pCryptoType,         \
                                                    pDecoderProfile, pCaps)    \
  ((This)->lpVtbl->GetContentProtectionCaps(This, pCryptoType,                 \
                                            pDecoderProfile, pCaps))

#define ID3D11VideoDevice2_CheckCryptoKeyExchange(                             \
...
#define ID3D11VideoDevice2_GetCryptoSessionPrivateDataSize(                    \
    This, pCryptoType, pDecoderProfile, pKeyExchangeType, pPrivateInputSize,   \
    pPrivateOutputSize)                                                        \
  ((This)->lpVtbl->GetCryptoSessionPrivateDataSize(                            \
      This, pCryptoType, pDecoderProfile, pKeyExchangeType, pPrivateInputSize, \
      pPrivateOutputSize))

#define ID3D11VideoDevice2_GetVideoDecoderCaps(                                \
    This, pDecoderProfile, SampleWidth, SampleHeight, pFrameRate, BitRate,     \
    pCryptoType, pDecoderCaps)                                                 \
  ((This)->lpVtbl->GetVideoDecoderCaps(This, pDecoderProfile, SampleWidth,     \
                                       SampleHeight, pFrameRate, BitRate,      \
                                       pCryptoType, pDecoderCaps))

#define ID3D11VideoDevice2_CheckVideoDecoderDownsampling(                      \
    This, pInputDesc, InputColorSpace, pInputConfig, pFrameRate, pOutputDesc,  \
    pSupported, pRealTimeHint)                                                 \
  ((This)->lpVtbl->CheckVideoDecoderDownsampling(                              \
      This, pInputDesc, InputColorSpace, pInputConfig, pFrameRate,             \
      pOutputDesc, pSupported, pRealTimeHint))

#define ID3D11VideoDevice2_RecommendVideoDecoderDownsampleParameters(          \
    This, pInputDesc, InputColorSpace, pInputConfig, pFrameRate,               \
...
#define ID3D11VideoDevice2_CheckFeatureSupport(                                \
    This, Feature, pFeatureSupportData, FeatureSupportDataSize)                \
  ((This)->lpVtbl->CheckFeatureSupport(This, Feature, pFeatureSupportData,     \
                                       FeatureSupportDataSize))

#define ID3D11VideoDevice2_NegotiateCryptoSessionKeyExchangeMT(                \
    This, pCryptoSession, flags, DataSize, pData)                              \
  ((This)->lpVtbl->NegotiateCryptoSessionKeyExchangeMT(                        \
      This, pCryptoSession, flags, DataSize, pData))
...
typedef struct D3D11_VIDEO_DECODER_BUFFER_DESC2 {
  ...
  UINT IVSize;
  /* [annotation] */
  _Field_size_opt_(SubSampleMappingCount)
...
public:
  virtual HRESULT STDMETHODCALLTYPE DecoderBeginFrame1(
      ...
      _In_reads_bytes_opt_(ContentKeySize) const void *pContentKey,
      /* [annotation] */
      _In_range_(0, D3D11_4_VIDEO_DECODER_MAX_HISTOGRAM_COMPONENTS)
          UINT NumComponentHistograms,
      /* [annotation] */
      _In_reads_opt_(NumComponentHistograms) const UINT *pHistogramOffsets,
      /* [annotation] */
      _In_reads_opt_(NumComponentHistograms)
...
typedef struct ID3D11VideoContext3Vtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(ID3D11VideoContext3 *This,
                                             /* [in] */ REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(ID3D11VideoContext3 *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(ID3D11VideoContext3 *This);

  DECLSPEC_XFGVIRT(ID3D11DeviceChild, GetDevice)
  void(STDMETHODCALLTYPE *GetDevice)(ID3D11VideoContext3 *This,
                                     /* [annotation] */
                                     _Outptr_ ID3D11Device **ppDevice);
  ...
  DECLSPEC_XFGVIRT(ID3D11DeviceChild, SetPrivateData)
  HRESULT(STDMETHODCALLTYPE *SetPrivateData)(ID3D11VideoContext3 *This,
                                             /* [annotation] */
                                             _In_ REFGUID guid,
                                             /* [annotation] */
                                             _In_ UINT DataSize,
...
#define ID3D11VideoContext3_GetDecoderBuffer(This, pDecoder, Type,             \
                                             pBufferSize, ppBuffer)            \
  ((This)->lpVtbl->GetDecoderBuffer(This, pDecoder, Type, pBufferSize,         \
                                    ppBuffer))
...
#define ID3D11VideoContext3_DecoderBeginFrame(This, pDecoder, pView,           \
                                              ContentKeySize, pContentKey)     \
  ((This)->lpVtbl->DecoderBeginFrame(This, pDecoder, pView, ContentKeySize,    \
                                     pContentKey))
...
#define ID3D11VideoContext3_SubmitDecoderBuffers(This, pDecoder, NumBuffers,   \
                                                 pBufferDesc)                  \
  ((This)->lpVtbl->SubmitDecoderBuffers(This, pDecoder, NumBuffers,            \
                                        pBufferDesc))
...
#define ID3D11VideoContext3_VideoProcessorSetOutputTargetRect(                 \
    This, pVideoProcessor, Enable, pRect)                                      \
  ((This)->lpVtbl->VideoProcessorSetOutputTargetRect(This, pVideoProcessor,    \
                                                     Enable, pRect))

#define ID3D11VideoContext3_VideoProcessorSetOutputBackgroundColor(            \
    This, pVideoProcessor, YCbCr, pColor)                                      \
  ((This)->lpVtbl->VideoProcessorSetOutputBackgroundColor(                     \
      This, pVideoProcessor, YCbCr, pColor))

#define ID3D11VideoContext3_VideoProcessorSetOutputColorSpace(                 \
    This, pVideoProcessor, pColorSpace)                                        \
  ((This)->lpVtbl->VideoProcessorSetOutputColorSpace(This, pVideoProcessor,    \
                                                     pColorSpace))

#define ID3D11VideoContext3_VideoProcessorSetOutputAlphaFillMode(              \
    This, pVideoProcessor, AlphaFillMode, StreamIndex)                         \
  ((This)->lpVtbl->VideoProcessorSetOutputAlphaFillMode(                       \
      This, pVideoProcessor, AlphaFillMode, StreamIndex))
...
#define ID3D11VideoContext3_VideoProcessorSetOutputStereoMode(                 \
    This, pVideoProcessor, Enable)                                             \
  ((This)->lpVtbl->VideoProcessorSetOutputStereoMode(This, pVideoProcessor,    \
                                                     Enable))

#define ID3D11VideoContext3_VideoProcessorSetOutputExtension(                  \
    This, pVideoProcessor, pExtensionGuid, DataSize, pData)                    \
  ((This)->lpVtbl->VideoProcessorSetOutputExtension(                           \
      This, pVideoProcessor, pExtensionGuid, DataSize, pData))

#define ID3D11VideoContext3_VideoProcessorGetOutputTargetRect(                 \
    This, pVideoProcessor, Enabled, pRect)                                     \
  ((This)->lpVtbl->VideoProcessorGetOutputTargetRect(This, pVideoProcessor,    \
                                                     Enabled, pRect))

#define ID3D11VideoContext3_VideoProcessorGetOutputBackgroundColor(            \
    This, pVideoProcessor, pYCbCr, pColor)                                     \
  ((This)->lpVtbl->VideoProcessorGetOutputBackgroundColor(                     \
      This, pVideoProcessor, pYCbCr, pColor))

#define ID3D11VideoContext3_VideoProcessorGetOutputColorSpace(                 \
    This, pVideoProcessor, pColorSpace)                                        \
  ((This)->lpVtbl->VideoProcessorGetOutputColorSpace(This, pVideoProcessor,    \
                                                     pColorSpace))

#define ID3D11VideoContext3_VideoProcessorGetOutputAlphaFillMode(              \
    This, pVideoProcessor, pAlphaFillMode, pStreamIndex)                       \
  ((This)->lpVtbl->VideoProcessorGetOutputAlphaFillMode(                       \
      This, pVideoProcessor, pAlphaFillMode, pStreamIndex))

#define ID3D11VideoContext3_VideoProcessorGetOutputConstriction(               \
    This, pVideoProcessor, pEnabled, pSize)                                    \
  ((This)->lpVtbl->VideoProcessorGetOutputConstriction(This, pVideoProcessor,  \
                                                       pEnabled, pSize))

#define ID3D11VideoContext3_VideoProcessorGetOutputStereoMode(                 \
    This, pVideoProcessor, pEnabled)                                           \
  ((This)->lpVtbl->VideoProcessorGetOutputStereoMode(This, pVideoProcessor,    \
                                                     pEnabled))

#define ID3D11VideoContext3_VideoProcessorGetOutputExtension(                  \
    This, pVideoProcessor, pExtensionGuid, DataSize, pData)                    \
  ((This)->lpVtbl->VideoProcessorGetOutputExtension(                           \
      This, pVideoProcessor, pExtensionGuid, DataSize, pData))

#define ID3D11VideoContext3_VideoProcessorSetStreamFrameFormat(                \
    This, pVideoProcessor, StreamIndex, FrameFormat)                           \
  ((This)->lpVtbl->VideoProcessorSetStreamFrameFormat(                         \
      This, pVideoProcessor, StreamIndex, FrameFormat))

#define ID3D11VideoContext3_VideoProcessorSetStreamColorSpace(                 \
    This, pVideoProcessor, StreamIndex, pColorSpace)                           \
  ((This)->lpVtbl->VideoProcessorSetStreamColorSpace(                          \
      This, pVideoProcessor, StreamIndex, pColorSpace))

#define ID3D11VideoContext3_VideoProcessorSetStreamOutputRate(                 \
    This, pVideoProcessor, StreamIndex, OutputRate, RepeatFrame, pCustomRate)  \
  ((This)->lpVtbl->VideoProcessorSetStreamOutputRate(                          \
      This, pVideoProcessor, StreamIndex, OutputRate, RepeatFrame,             \
      pCustomRate))

#define ID3D11VideoContext3_VideoProcessorSetStreamSourceRect(                 \
    This, pVideoProcessor, StreamIndex, Enable, pRect)                         \
  ((This)->lpVtbl->VideoProcessorSetStreamSourceRect(                          \
      This, pVideoProcessor, StreamIndex, Enable, pRect))

#define ID3D11VideoContext3_VideoProcessorSetStreamDestRect(                   \
    This, pVideoProcessor, StreamIndex, Enable, pRect)                         \
  ((This)->lpVtbl->VideoProcessorSetStreamDestRect(                            \
      This, pVideoProcessor, StreamIndex, Enable, pRect))

#define ID3D11VideoContext3_VideoProcessorSetStreamAlpha(                      \
    This, pVideoProcessor, StreamIndex, Enable, Alpha)                         \
  ((This)->lpVtbl->VideoProcessorSetStreamAlpha(This, pVideoProcessor,         \
                                                StreamIndex, Enable, Alpha))

#define ID3D11VideoContext3_VideoProcessorSetStreamPalette(                    \
    This, pVideoProcessor, StreamIndex, Count, pEntries)                       \
  ((This)->lpVtbl->VideoProcessorSetStreamPalette(                             \
      This, pVideoProcessor, StreamIndex, Count, pEntries))

#define ID3D11VideoContext3_VideoProcessorSetStreamPixelAspectRatio(           \
    This, pVideoProcessor, StreamIndex, Enable, pSourceAspectRatio,            \
    pDestinationAspectRatio)                                                   \
  ((This)->lpVtbl->VideoProcessorSetStreamPixelAspectRatio(                    \
      This, pVideoProcessor, StreamIndex, Enable, pSourceAspectRatio,          \
...
#define ID3D11VideoContext3_VideoProcessorSetStreamLumaKey(                    \
    This, pVideoProcessor, StreamIndex, Enable, Lower, Upper)                  \
  ((This)->lpVtbl->VideoProcessorSetStreamLumaKey(                             \
      This, pVideoProcessor, StreamIndex, Enable, Lower, Upper))

#define ID3D11VideoContext3_VideoProcessorSetStreamStereoFormat(               \
    This, pVideoProcessor, StreamIndex, Enable, Format, LeftViewFrame0,        \
    BaseViewFrame0, FlipMode, MonoOffset)                                      \
  ((This)->lpVtbl->VideoProcessorSetStreamStereoFormat(                        \
      This, pVideoProcessor, StreamIndex, Enable, Format, LeftViewFrame0,      \
...
#define ID3D11VideoContext3_VideoProcessorSetStreamAutoProcessingMode(         \
    This, pVideoProcessor, StreamIndex, Enable)                                \
  ((This)->lpVtbl->VideoProcessorSetStreamAutoProcessingMode(                  \
      This, pVideoProcessor, StreamIndex, Enable))

#define ID3D11VideoContext3_VideoProcessorSetStreamFilter(                     \
    This, pVideoProcessor, StreamIndex, Filter, Enable, Level)                 \
  ((This)->lpVtbl->VideoProcessorSetStreamFilter(                              \
      This, pVideoProcessor, StreamIndex, Filter, Enable, Level))

#define ID3D11VideoContext3_VideoProcessorSetStreamExtension(                  \
    This, pVideoProcessor, StreamIndex, pExtensionGuid, DataSize, pData)       \
  ((This)->lpVtbl->VideoProcessorSetStreamExtension(                           \
      This, pVideoProcessor, StreamIndex, pExtensionGuid, DataSize, pData))

#define ID3D11VideoContext3_VideoProcessorGetStreamFrameFormat(                \
    This, pVideoProcessor, StreamIndex, pFrameFormat)                          \
  ((This)->lpVtbl->VideoProcessorGetStreamFrameFormat(                         \
      This, pVideoProcessor, StreamIndex, pFrameFormat))

#define ID3D11VideoContext3_VideoProcessorGetStreamColorSpace(                 \
    This, pVideoProcessor, StreamIndex, pColorSpace)                           \
  ((This)->lpVtbl->VideoProcessorGetStreamColorSpace(                          \
      This, pVideoProcessor, StreamIndex, pColorSpace))

#define ID3D11VideoContext3_VideoProcessorGetStreamOutputRate(                 \
    This, pVideoProcessor, StreamIndex, pOutputRate, pRepeatFrame,             \
    pCustomRate)                                                               \
  ((This)->lpVtbl->VideoProcessorGetStreamOutputRate(                          \
      This, pVideoProcessor, StreamIndex, pOutputRate, pRepeatFrame,           \
...
#define ID3D11VideoContext3_VideoProcessorGetStreamSourceRect(                 \
    This, pVideoProcessor, StreamIndex, pEnabled, pRect)                       \
  ((This)->lpVtbl->VideoProcessorGetStreamSourceRect(                          \
      This, pVideoProcessor, StreamIndex, pEnabled, pRect))

#define ID3D11VideoContext3_VideoProcessorGetStreamDestRect(                   \
    This, pVideoProcessor, StreamIndex, pEnabled, pRect)                       \
  ((This)->lpVtbl->VideoProcessorGetStreamDestRect(                            \
      This, pVideoProcessor, StreamIndex, pEnabled, pRect))

#define ID3D11VideoContext3_VideoProcessorGetStreamAlpha(                      \
    This, pVideoProcessor, StreamIndex, pEnabled, pAlpha)                      \
  ((This)->lpVtbl->VideoProcessorGetStreamAlpha(                               \
      This, pVideoProcessor, StreamIndex, pEnabled, pAlpha))

#define ID3D11VideoContext3_VideoProcessorGetStreamPalette(                    \
    This, pVideoProcessor, StreamIndex, Count, pEntries)                       \
  ((This)->lpVtbl->VideoProcessorGetStreamPalette(                             \
      This, pVideoProcessor, StreamIndex, Count, pEntries))

#define ID3D11VideoContext3_VideoProcessorGetStreamPixelAspectRatio(           \
    This, pVideoProcessor, StreamIndex, pEnabled, pSourceAspectRatio,          \
    pDestinationAspectRatio)                                                   \
  ((This)->lpVtbl->VideoProcessorGetStreamPixelAspectRatio(                    \
      This, pVideoProcessor, StreamIndex, pEnabled, pSourceAspectRatio,        \
...
#define ID3D11VideoContext3_VideoProcessorGetStreamLumaKey(                    \
    This, pVideoProcessor, StreamIndex, pEnabled, pLower, pUpper)              \
  ((This)->lpVtbl->VideoProcessorGetStreamLumaKey(                             \
      This, pVideoProcessor, StreamIndex, pEnabled, pLower, pUpper))

#define ID3D11VideoContext3_VideoProcessorGetStreamStereoFormat(               \
    This, pVideoProcessor, StreamIndex, pEnable, pFormat, pLeftViewFrame0,     \
    pBaseViewFrame0, pFlipMode, MonoOffset)                                    \
  ((This)->lpVtbl->VideoProcessorGetStreamStereoFormat(                        \
      This, pVideoProcessor, StreamIndex, pEnable, pFormat, pLeftViewFrame0,   \
...
#define ID3D11VideoContext3_VideoProcessorGetStreamAutoProcessingMode(         \
    This, pVideoProcessor, StreamIndex, pEnabled)                              \
  ((This)->lpVtbl->VideoProcessorGetStreamAutoProcessingMode(                  \
      This, pVideoProcessor, StreamIndex, pEnabled))

#define ID3D11VideoContext3_VideoProcessorGetStreamFilter(                     \
    This, pVideoProcessor, StreamIndex, Filter, pEnabled, pLevel)              \
  ((This)->lpVtbl->VideoProcessorGetStreamFilter(                              \
      This, pVideoProcessor, StreamIndex, Filter, pEnabled, pLevel))

#define ID3D11VideoContext3_VideoProcessorGetStreamExtension(                  \
    This, pVideoProcessor, StreamIndex, pExtensionGuid, DataSize, pData)       \
  ((This)->lpVtbl->VideoProcessorGetStreamExtension(                           \
      This, pVideoProcessor, StreamIndex, pExtensionGuid, DataSize, pData))

#define ID3D11VideoContext3_VideoProcessorBlt(                                 \
    This, pVideoProcessor, pView, OutputFrame, StreamCount, pStreams)          \
  ((This)->lpVtbl->VideoProcessorBlt(This, pVideoProcessor, pView,             \
                                     OutputFrame, StreamCount, pStreams))

#define ID3D11VideoContext3_NegotiateCryptoSessionKeyExchange(                 \
    This, pCryptoSession, DataSize, pData)                                     \
  ((This)->lpVtbl->NegotiateCryptoSessionKeyExchange(This, pCryptoSession,     \
                                                     DataSize, pData))

#define ID3D11VideoContext3_EncryptionBlt(This, pCryptoSession, pSrcSurface,   \
                                          pDstSurface, IVSize, pIV)            \
  ((This)->lpVtbl->EncryptionBlt(This, pCryptoSession, pSrcSurface,            \
                                 pDstSurface, IVSize, pIV))

#define ID3D11VideoContext3_DecryptionBlt(                                     \
    This, pCryptoSession, pSrcSurface, pDstSurface, pEncryptedBlockInfo,       \
    ContentKeySize, pContentKey, IVSize, pIV)                                  \
  ((This)->lpVtbl->DecryptionBlt(This, pCryptoSession, pSrcSurface,            \
                                 pDstSurface, pEncryptedBlockInfo,             \
...
#define ID3D11VideoContext3_StartSessionKeyRefresh(                            \
    This, pCryptoSession, RandomNumberSize, pRandomNumber)                     \
  ((This)->lpVtbl->StartSessionKeyRefresh(This, pCryptoSession,                \
                                          RandomNumberSize, pRandomNumber))
...
#define ID3D11VideoContext3_GetEncryptionBltKey(This, pCryptoSession, KeySize, \
                                                pReadbackKey)                  \
  ((This)->lpVtbl->GetEncryptionBltKey(This, pCryptoSession, KeySize,          \
                                       pReadbackKey))

#define ID3D11VideoContext3_NegotiateAuthenticatedChannelKeyExchange(          \
    This, pChannel, DataSize, pData)                                           \
  ((This)->lpVtbl->NegotiateAuthenticatedChannelKeyExchange(This, pChannel,    \
                                                            DataSize, pData))

#define ID3D11VideoContext3_QueryAuthenticatedChannel(                         \
    This, pChannel, InputSize, pInput, OutputSize, pOutput)                    \
  ((This)->lpVtbl->QueryAuthenticatedChannel(This, pChannel, InputSize,        \
                                             pInput, OutputSize, pOutput))

#define ID3D11VideoContext3_ConfigureAuthenticatedChannel(                     \
    This, pChannel, InputSize, pInput, pOutput)                                \
  ((This)->lpVtbl->ConfigureAuthenticatedChannel(This, pChannel, InputSize,    \
                                                 pInput, pOutput))

#define ID3D11VideoContext3_VideoProcessorSetStreamRotation(                   \
    This, pVideoProcessor, StreamIndex, Enable, Rotation)                      \
  ((This)->lpVtbl->VideoProcessorSetStreamRotation(                            \
      This, pVideoProcessor, StreamIndex, Enable, Rotation))

#define ID3D11VideoContext3_VideoProcessorGetStreamRotation(                   \
    This, pVideoProcessor, StreamIndex, pEnable, pRotation)                    \
  ((This)->lpVtbl->VideoProcessorGetStreamRotation(                            \
      This, pVideoProcessor, StreamIndex, pEnable, pRotation))

#define ID3D11VideoContext3_SubmitDecoderBuffers1(This, pDecoder, NumBuffers,  \
                                                  pBufferDesc)                 \
  ((This)->lpVtbl->SubmitDecoderBuffers1(This, pDecoder, NumBuffers,           \
                                         pBufferDesc))

#define ID3D11VideoContext3_GetDataForNewHardwareKey(                          \
    This, pCryptoSession, PrivateInputSize, pPrivatInputData,                  \
    pPrivateOutputData)                                                        \
  ((This)->lpVtbl->GetDataForNewHardwareKey(                                   \
      This, pCryptoSession, PrivateInputSize, pPrivatInputData,                \
...
#define ID3D11VideoContext3_CheckCryptoSessionStatus(This, pCryptoSession,     \
                                                     pStatus)                  \
  ((This)->lpVtbl->CheckCryptoSessionStatus(This, pCryptoSession, pStatus))

#define ID3D11VideoContext3_DecoderEnableDownsampling(                         \
    This, pDecoder, InputColorSpace, pOutputDesc, ReferenceFrameCount)         \
  ((This)->lpVtbl->DecoderEnableDownsampling(                                  \
      This, pDecoder, InputColorSpace, pOutputDesc, ReferenceFrameCount))

#define ID3D11VideoContext3_DecoderUpdateDownsampling(This, pDecoder,          \
                                                      pOutputDesc)             \
  ((This)->lpVtbl->DecoderUpdateDownsampling(This, pDecoder, pOutputDesc))

#define ID3D11VideoContext3_VideoProcessorSetOutputColorSpace1(                \
    This, pVideoProcessor, ColorSpace)                                         \
  ((This)->lpVtbl->VideoProcessorSetOutputColorSpace1(This, pVideoProcessor,   \
                                                      ColorSpace))

#define ID3D11VideoContext3_VideoProcessorSetOutputShaderUsage(                \
    This, pVideoProcessor, ShaderUsage)                                        \
  ((This)->lpVtbl->VideoProcessorSetOutputShaderUsage(This, pVideoProcessor,   \
                                                      ShaderUsage))

#define ID3D11VideoContext3_VideoProcessorGetOutputColorSpace1(                \
    This, pVideoProcessor, pColorSpace)                                        \
  ((This)->lpVtbl->VideoProcessorGetOutputColorSpace1(This, pVideoProcessor,   \
                                                      pColorSpace))

#define ID3D11VideoContext3_VideoProcessorGetOutputShaderUsage(                \
    This, pVideoProcessor, pShaderUsage)                                       \
  ((This)->lpVtbl->VideoProcessorGetOutputShaderUsage(This, pVideoProcessor,   \
                                                      pShaderUsage))

#define ID3D11VideoContext3_VideoProcessorSetStreamColorSpace1(                \
    This, pVideoProcessor, StreamIndex, ColorSpace)                            \
  ((This)->lpVtbl->VideoProcessorSetStreamColorSpace1(                         \
      This, pVideoProcessor, StreamIndex, ColorSpace))

#define ID3D11VideoContext3_VideoProcessorSetStreamMirror(                     \
    This, pVideoProcessor, StreamIndex, Enable, FlipHorizontal, FlipVertical)  \
  ((This)->lpVtbl->VideoProcessorSetStreamMirror(                              \
      This, pVideoProcessor, StreamIndex, Enable, FlipHorizontal,              \
      FlipVertical))

#define ID3D11VideoContext3_VideoProcessorGetStreamColorSpace1(                \
    This, pVideoProcessor, StreamIndex, pColorSpace)                           \
  ((This)->lpVtbl->VideoProcessorGetStreamColorSpace1(                         \
      This, pVideoProcessor, StreamIndex, pColorSpace))

#define ID3D11VideoContext3_VideoProcessorGetStreamMirror(                     \
    This, pVideoProcessor, StreamIndex, pEnable, pFlipHorizontal,              \
    pFlipVertical)                                                             \
  ((This)->lpVtbl->VideoProcessorGetStreamMirror(                              \
      This, pVideoProcessor, StreamIndex, pEnable, pFlipHorizontal,            \
...
#define ID3D11VideoContext3_VideoProcessorGetBehaviorHints(                    \
    This, pVideoProcessor, OutputWidth, OutputHeight, OutputFormat,            \
    StreamCount, pStreams, pBehaviorHints)                                     \
  ((This)->lpVtbl->VideoProcessorGetBehaviorHints(                             \
      This, pVideoProcessor, OutputWidth, OutputHeight, OutputFormat,          \
...
#define ID3D11VideoContext3_VideoProcessorSetOutputHDRMetaData(                \
    This, pVideoProcessor, Type, Size, pHDRMetaData)                           \
  ((This)->lpVtbl->VideoProcessorSetOutputHDRMetaData(                         \
      This, pVideoProcessor, Type, Size, pHDRMetaData))

#define ID3D11VideoContext3_VideoProcessorGetOutputHDRMetaData(                \
    This, pVideoProcessor, pType, Size, pMetaData)                             \
  ((This)->lpVtbl->VideoProcessorGetOutputHDRMetaData(This, pVideoProcessor,   \
                                                      pType, Size, pMetaData))

#define ID3D11VideoContext3_VideoProcessorSetStreamHDRMetaData(                \
    This, pVideoProcessor, StreamIndex, Type, Size, pHDRMetaData)              \
  ((This)->lpVtbl->VideoProcessorSetStreamHDRMetaData(                         \
      This, pVideoProcessor, StreamIndex, Type, Size, pHDRMetaData))

#define ID3D11VideoContext3_VideoProcessorGetStreamHDRMetaData(                \
    This, pVideoProcessor, StreamIndex, pType, Size, pMetaData)                \
  ((This)->lpVtbl->VideoProcessorGetStreamHDRMetaData(                         \
      This, pVideoProcessor, StreamIndex, pType, Size, pMetaData))

#define ID3D11VideoContext3_DecoderBeginFrame1(                                \
    This, pDecoder, pView, ContentKeySize, pContentKey,                        \
    NumComponentHistograms, pHistogramOffsets, ppHistogramBuffers)             \
  ((This)->lpVtbl->DecoderBeginFrame1(This, pDecoder, pView, ContentKeySize,   \
                                      pContentKey, NumComponentHistograms,     \
                                      pHistogramOffsets, ppHistogramBuffers))

#define ID3D11VideoContext3_SubmitDecoderBuffers2(This, pDecoder, NumBuffers,  \
                                                  pBufferDesc)                 \
  ((This)->lpVtbl->SubmitDecoderBuffers2(This, pDecoder, NumBuffers,           \
                                         pBufferDesc))
...
DEFINE_GUID(IID_ID3D11VideoDevice2, 0x59C0CB01, 0x35F0, 0x4A70, 0x8F, 0x67,
            0x87, 0x90, 0x5C, 0x90, 0x6A, 0x53);
DEFINE_GUID(IID_ID3D11VideoContext3, 0xA9E2FAA0, 0xCB39, 0x418F, 0xA0, 0xB7,
            0xD8, 0xAA, 0xD4, 0xDE, 0x67, 0x2E);
