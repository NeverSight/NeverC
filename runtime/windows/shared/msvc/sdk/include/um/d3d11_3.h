...
struct CD3D11_TEXTURE2D_DESC1 : public D3D11_TEXTURE2D_DESC1 {
  ...
  explicit CD3D11_TEXTURE2D_DESC1(
      DXGI_FORMAT format, UINT width, UINT height, UINT arraySize = 1,
...
interface ID3D11Texture2D1 { CONST_VTBL struct ID3D11Texture2D1Vtbl *lpVtbl; };
...
interface ID3D11Texture3D1 { CONST_VTBL struct ID3D11Texture3D1Vtbl *lpVtbl; };
...
struct CD3D11_SHADER_RESOURCE_VIEW_DESC1
  ...
  explicit CD3D11_SHADER_RESOURCE_VIEW_DESC1(_In_ ID3D11Buffer *,
                                             DXGI_FORMAT format,
                                             UINT firstElement,
  ...
  explicit CD3D11_SHADER_RESOURCE_VIEW_DESC1(
      _In_ ID3D11Texture1D *pTex1D, D3D11_SRV_DIMENSION viewDimension,
  ...
  explicit CD3D11_SHADER_RESOURCE_VIEW_DESC1(
      _In_ ID3D11Texture2D *pTex2D, D3D11_SRV_DIMENSION viewDimension,
      DXGI_FORMAT format = DXGI_FORMAT_UNKNOWN, UINT mostDetailedMip = 0,
      UINT mipLevels = -1,
      UINT firstArraySlice = 0, // First2DArrayFace for TEXTURECUBEARRAY
      UINT arraySize = -1,      // NumCubes for TEXTURECUBEARRAY
  ...
  explicit CD3D11_SHADER_RESOURCE_VIEW_DESC1(
      _In_ ID3D11Texture3D *pTex3D, DXGI_FORMAT format = DXGI_FORMAT_UNKNOWN,
...
struct CD3D11_RENDER_TARGET_VIEW_DESC1 : public D3D11_RENDER_TARGET_VIEW_DESC1 {
  ...
  explicit CD3D11_RENDER_TARGET_VIEW_DESC1(_In_ ID3D11Buffer *,
                                           DXGI_FORMAT format,
                                           UINT firstElement,
                                           UINT numElements) {
    Format = format;
  ...
  explicit CD3D11_RENDER_TARGET_VIEW_DESC1(
      ...
      DXGI_FORMAT format = DXGI_FORMAT_UNKNOWN, UINT mipSlice = 0,
      UINT firstArraySlice = 0, UINT arraySize = -1, UINT planeSlice = 0) {
    ViewDimension = viewDimension;
    if (DXGI_FORMAT_UNKNOWN == format ||
        ((UINT)-1 == arraySize &&
...
struct CD3D11_UNORDERED_ACCESS_VIEW_DESC1
  ...
  explicit CD3D11_UNORDERED_ACCESS_VIEW_DESC1(_In_ ID3D11Buffer *,
                                              DXGI_FORMAT format,
                                              UINT firstElement,
                                              UINT numElements,
                                              UINT flags = 0) {
  ...
  explicit CD3D11_UNORDERED_ACCESS_VIEW_DESC1(
      _In_ ID3D11Texture1D *pTex1D, D3D11_UAV_DIMENSION viewDimension,
      DXGI_FORMAT format = DXGI_FORMAT_UNKNOWN, UINT mipSlice = 0,
      UINT firstArraySlice = 0, UINT arraySize = -1) {
    ViewDimension = viewDimension;
    if (DXGI_FORMAT_UNKNOWN == format ||
  ...
  explicit CD3D11_UNORDERED_ACCESS_VIEW_DESC1(
      _In_ ID3D11Texture2D *pTex2D, D3D11_UAV_DIMENSION viewDimension,
      DXGI_FORMAT format = DXGI_FORMAT_UNKNOWN, UINT mipSlice = 0,
      UINT firstArraySlice = 0, UINT arraySize = -1, UINT planeSlice = 0) {
    ViewDimension = viewDimension;
    if (DXGI_FORMAT_UNKNOWN == format ||
...
struct CD3D11_QUERY_DESC1 : public D3D11_QUERY_DESC1 {
  ...
  explicit CD3D11_QUERY_DESC1(
      D3D11_QUERY query, UINT miscFlags = 0,
...
typedef struct ID3D11Query1Vtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(ID3D11Query1 *This,
                                             /* [in] */ REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);
  ...
  DECLSPEC_XFGVIRT(ID3D11DeviceChild, SetPrivateData)
  HRESULT(STDMETHODCALLTYPE *SetPrivateData)(ID3D11Query1 *This,
                                             /* [annotation] */
                                             _In_ REFGUID guid,
                                             /* [annotation] */
                                             _In_ UINT DataSize,
  ...
  void(STDMETHODCALLTYPE *GetDesc)(ID3D11Query1 *This,
                                   /* [annotation] */
...
interface ID3D11Query1 { CONST_VTBL struct ID3D11Query1Vtbl *lpVtbl; };
...
public:
  virtual void STDMETHODCALLTYPE Flush1(D3D11_CONTEXT_TYPE ContextType,
                                        /* [annotation] */
...
typedef struct ID3D11DeviceContext3Vtbl {
  ...
  void(STDMETHODCALLTYPE *Draw)(ID3D11DeviceContext3 *This,
                                /* [annotation] */
  ...
  void(STDMETHODCALLTYPE *IASetPrimitiveTopology)(ID3D11DeviceContext3 *This,
                                                  /* [annotation] */
  ...
  void(STDMETHODCALLTYPE *UpdateSubresource)(ID3D11DeviceContext3 *This,
                                             /* [annotation] */
                                             _In_ ID3D11Resource *pDstResource,
                                             /* [annotation] */
                                             _In_ UINT DstSubresource,
  ...
  HRESULT(STDMETHODCALLTYPE *FinishCommandList)(
      ID3D11DeviceContext3 *This, BOOL RestoreDeferredContextState,
      /* [annotation] */
  ...
  void(STDMETHODCALLTYPE *UpdateSubresource1)(ID3D11DeviceContext3 *This,
                                              /* [annotation] */
                                              _In_ ID3D11Resource *pDstResource,
                                              /* [annotation] */
                                              _In_ UINT DstSubresource,
  ...
  void(STDMETHODCALLTYPE *UpdateTiles)(
      ...
      _In_ ID3D11Resource *pDestTiledResource,
      /* [annotation] */
      _In_ const D3D11_TILED_RESOURCE_COORDINATE
...
#define ID3D11DeviceContext3_UpdateTileMappings(                               \
    This, pTiledResource, NumTiledResourceRegions,                             \
...
#define ID3D11DeviceContext3_CopyTileMappings(                                 \
    This, pDestTiledResource, pDestRegionStartCoordinate,                      \
    pSourceTiledResource, pSourceRegionStartCoordinate, pTileRegionSize,       \
    Flags)                                                                     \
  ((This)->lpVtbl->CopyTileMappings(                                           \
      This, pDestTiledResource, pDestRegionStartCoordinate,                    \
      pSourceTiledResource, pSourceRegionStartCoordinate, pTileRegionSize,     \
      Flags))

#define ID3D11DeviceContext3_CopyTiles(                                        \
    This, pTiledResource, pTileRegionStartCoordinate, pTileRegionSize,         \
    pBuffer, BufferStartOffsetInBytes, Flags)                                  \
  ((This)->lpVtbl->CopyTiles(This, pTiledResource, pTileRegionStartCoordinate, \
                             pTileRegionSize, pBuffer,                         \
                             BufferStartOffsetInBytes, Flags))

#define ID3D11DeviceContext3_UpdateTiles(                                      \
    This, pDestTiledResource, pDestTileRegionStartCoordinate,                  \
    pDestTileRegionSize, pSourceTileData, Flags)                               \
  ((This)->lpVtbl->UpdateTiles(This, pDestTiledResource,                       \
                               pDestTileRegionStartCoordinate,                 \
                               pDestTileRegionSize, pSourceTileData, Flags))
...
#define ID3D11DeviceContext3_TiledResourceBarrier(                             \
    This, pTiledResourceOrViewAccessBeforeBarrier,                             \
...
#define ID3D11DeviceContext3_SetHardwareProtectionState(This,                  \
                                                        HwProtectionEnable)    \
  ((This)->lpVtbl->SetHardwareProtectionState(This, HwProtectionEnable))

#define ID3D11DeviceContext3_GetHardwareProtectionState(This,                  \
                                                        pHwProtectionEnable)   \
...
typedef struct ID3D11FenceVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(ID3D11Fence *This,
                                             /* [in] */ REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);
  ...
  DECLSPEC_XFGVIRT(ID3D11DeviceChild, SetPrivateData)
  HRESULT(STDMETHODCALLTYPE *SetPrivateData)(ID3D11Fence *This,
                                             /* [annotation] */
                                             _In_ REFGUID guid,
                                             /* [annotation] */
                                             _In_ UINT DataSize,
...
#define ID3D11Fence_CreateSharedHandle(This, pAttributes, dwAccess, lpName,    \
                                       pHandle)                                \
  ((This)->lpVtbl->CreateSharedHandle(This, pAttributes, dwAccess, lpName,     \
                                      pHandle))
...
typedef struct ID3D11DeviceContext4Vtbl {
  ...
  DECLSPEC_XFGVIRT(ID3D11DeviceContext, Draw)
  void(STDMETHODCALLTYPE *Draw)(ID3D11DeviceContext4 *This,
                                /* [annotation] */
                                _In_ UINT VertexCount,
                                /* [annotation] */
                                _In_ UINT StartVertexLocation);
  ...
  DECLSPEC_XFGVIRT(ID3D11DeviceContext, IASetPrimitiveTopology)
  void(STDMETHODCALLTYPE *IASetPrimitiveTopology)(ID3D11DeviceContext4 *This,
                                                  /* [annotation] */
                                                  _In_ D3D11_PRIMITIVE_TOPOLOGY
                                                      Topology);
  ...
  DECLSPEC_XFGVIRT(ID3D11DeviceContext, UpdateSubresource)
  void(STDMETHODCALLTYPE *UpdateSubresource)(ID3D11DeviceContext4 *This,
                                             /* [annotation] */
                                             _In_ ID3D11Resource *pDstResource,
                                             /* [annotation] */
                                             _In_ UINT DstSubresource,
  ...
  DECLSPEC_XFGVIRT(ID3D11DeviceContext, FinishCommandList)
  HRESULT(STDMETHODCALLTYPE *FinishCommandList)(
      ID3D11DeviceContext4 *This, BOOL RestoreDeferredContextState,
      /* [annotation] */
      _COM_Outptr_opt_ ID3D11CommandList **ppCommandList);
  ...
  DECLSPEC_XFGVIRT(ID3D11DeviceContext1, UpdateSubresource1)
  void(STDMETHODCALLTYPE *UpdateSubresource1)(ID3D11DeviceContext4 *This,
                                              /* [annotation] */
                                              _In_ ID3D11Resource *pDstResource,
                                              /* [annotation] */
                                              _In_ UINT DstSubresource,
  ...
  DECLSPEC_XFGVIRT(ID3D11DeviceContext2, IsAnnotationEnabled)
  BOOL(STDMETHODCALLTYPE *IsAnnotationEnabled)(ID3D11DeviceContext4 *This);
...
#define ID3D11DeviceContext4_CopyTiles(                                        \
    This, pTiledResource, pTileRegionStartCoordinate, pTileRegionSize,         \
    pBuffer, BufferStartOffsetInBytes, Flags)                                  \
  ((This)->lpVtbl->CopyTiles(This, pTiledResource, pTileRegionStartCoordinate, \
                             pTileRegionSize, pBuffer,                         \
...
#define ID3D11DeviceContext4_UpdateTiles(                                      \
    This, pDestTiledResource, pDestTileRegionStartCoordinate,                  \
    pDestTileRegionSize, pSourceTileData, Flags)                               \
  ((This)->lpVtbl->UpdateTiles(This, pDestTiledResource,                       \
                               pDestTileRegionStartCoordinate,                 \
...
#define ID3D11DeviceContext4_TiledResourceBarrier(                             \
    This, pTiledResourceOrViewAccessBeforeBarrier,                             \
    pTiledResourceOrViewAccessAfterBarrier)                                    \
  ((This)->lpVtbl->TiledResourceBarrier(                                       \
      This, pTiledResourceOrViewAccessBeforeBarrier,                           \
...
#define ID3D11DeviceContext4_SetHardwareProtectionState(This,                  \
                                                        HwProtectionEnable)    \
  ((This)->lpVtbl->SetHardwareProtectionState(This, HwProtectionEnable))

#define ID3D11DeviceContext4_GetHardwareProtectionState(This,                  \
                                                        pHwProtectionEnable)   \
  ((This)->lpVtbl->GetHardwareProtectionState(This, pHwProtectionEnable))
...
typedef struct ID3D11Device3Vtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(ID3D11Device3 *This,
                                             /* [in] */ REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);
  ...
  HRESULT(STDMETHODCALLTYPE *CheckFeatureSupport)(
      ID3D11Device3 *This, D3D11_FEATURE Feature,
      /* [annotation] */
  ...
  HRESULT(STDMETHODCALLTYPE *SetPrivateData)(ID3D11Device3 *This,
                                             /* [annotation] */
                                             _In_ REFGUID guid,
                                             /* [annotation] */
                                             _In_ UINT DataSize,
  ...
  void(STDMETHODCALLTYPE *WriteToSubresource)(ID3D11Device3 *This,
                                              /* [annotation] */
                                              _In_ ID3D11Resource *pDstResource,
                                              /* [annotation] */
                                              _In_ UINT DstSubresource,
...
interface ID3D11Device3 { CONST_VTBL struct ID3D11Device3Vtbl *lpVtbl; };
...
#define ID3D11Device3_CreateDeferredContext2(This, ContextFlags,               \
                                             ppDeferredContext)                \
...
#define ID3D11Device3_CreateTexture2D1(This, pDesc1, pInitialData,             \
                                       ppTexture2D)                            \
  ((This)->lpVtbl->CreateTexture2D1(This, pDesc1, pInitialData, ppTexture2D))

#define ID3D11Device3_CreateTexture3D1(This, pDesc1, pInitialData,             \
                                       ppTexture3D)                            \
  ((This)->lpVtbl->CreateTexture3D1(This, pDesc1, pInitialData, ppTexture3D))

#define ID3D11Device3_CreateRasterizerState2(This, pRasterizerDesc,            \
                                             ppRasterizerState)                \
  ((This)->lpVtbl->CreateRasterizerState2(This, pRasterizerDesc,               \
                                          ppRasterizerState))

#define ID3D11Device3_CreateShaderResourceView1(This, pResource, pDesc1,       \
                                                ppSRView1)                     \
  ((This)->lpVtbl->CreateShaderResourceView1(This, pResource, pDesc1,          \
                                             ppSRView1))

#define ID3D11Device3_CreateUnorderedAccessView1(This, pResource, pDesc1,      \
                                                 ppUAView1)                    \
  ((This)->lpVtbl->CreateUnorderedAccessView1(This, pResource, pDesc1,         \
                                              ppUAView1))

#define ID3D11Device3_CreateRenderTargetView1(This, pResource, pDesc1,         \
                                              ppRTView1)                       \
...
#define ID3D11Device3_CreateDeferredContext3(This, ContextFlags,               \
                                             ppDeferredContext)                \
  ((This)->lpVtbl->CreateDeferredContext3(This, ContextFlags,                  \
                                          ppDeferredContext))

#define ID3D11Device3_WriteToSubresource(This, pDstResource, DstSubresource,   \
                                         pDstBox, pSrcData, SrcRowPitch,       \
                                         SrcDepthPitch)                        \
...
#define ID3D11Device3_ReadFromSubresource(This, pDstData, DstRowPitch,         \
