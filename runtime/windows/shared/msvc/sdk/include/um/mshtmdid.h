...
/***********************************************************************************************
 ...
 directives that rely upon files not dropped. If in doubt - build iedev
  ...
  If you add comments please enclose in a ;begin_internal, ;end_internal block -
 such as this one!
...
// Adding a (DISPID) cast to address a subset of the warnings that used to be
// suppressed by -Wv:17. For more information, visit
// https://osgwiki.com/wiki/Dev_14_Migration VSTS 15061105: The unsigned values
// being stored in the signed DISPID data type overflow and present risks if
// used in comparisons.
...
// Divide collection dispid space into "named member" half and "ordinal access"
// half for stylesheets collection.
...
// The DISPID range used by the CCanvasPixelArray needs to be large to because
// it represents the byte array of an arbitrarily large bitmap.  We could go up
// to LONG_MAX, but there is no need to push to the boundary yet.
...
// DISPID_SVGELEMENT_BASE is used as the base dispid for types that inherit from
// CSVGElement.
...
#define DISPID_SVGLINEARGRADIENTELEMENT                                        \
  DISPID_SVGELEMENT_BASE + 20 // Leave some space for inherited DISPIDs
...
#define DISPID_SVGRADIALGRADIENTELEMENT                                        \
  DISPID_SVGELEMENT_BASE + 20 // Leave some space for inherited DISPIDs
...
#define DISPID_SVGTEXTCONTENTELEMENT_BASE                                      \
  (DISPID_SVGELEMENT_BASE +                                                    \
   20) // The base dispid for types that inherit from CSVGTextContentElement. It
       // avoids overlap of dispids for derived types.
#define DISPID_SVGTEXTPOSITIONINGELEMENT DISPID_SVGTEXTCONTENTELEMENT_BASE
#define DISPID_SVGTEXTPOSITIONINGELEMENT_BASE                                  \
  (DISPID_SVGTEXTCONTENTELEMENT_BASE +                                         \
   20) // The base dispid for types that inherit from
       // CSVGTextPositioningElement. It avoids overlap of dispids for derived
       // types.
...
//;begin_internal
// IE8 ELEMENT fits within DISPID_ELEMENT - DISPID_SITE + 200 (to account for
// ELEMENTS current interface DISPIDS) Only 37 DISPIDs were used for IE8 element
// interfaces (IHTMLElement5)
//;end_internal
...
//;begin_internal
// IE8 FRAMESITE fits within DISPID_FRAMSITE - WEBOC_DISPIDBASE + 20(account for
// FRAME/IFRAME interface DISPIDS)
//;end_internal
...
//;begin_internal
// IE8 OBJECT fits within DISPID_OBJECT - DISPID_STYLE + 30(account for OBJECT
// interface DISPIDS)
//;end_internal
...
#define DISPID_INTERNAL_INLINESTYLEAA                                          \
  (DISPID_A_FIRST + 106) // In line style Attr Array
#define DISPID_INTERNAL_CSTYLEPTRCACHE                                         \
  (DISPID_A_FIRST + 107) // Cached CStyle Ptr
#define DISPID_INTERNAL_CRUNTIMESTYLEPTRCACHE                                  \
  (DISPID_A_FIRST + 108) // runtime style ptr obj
#define DISPID_INTERNAL_INVOKECONTEXT                                          \
  (DISPID_A_FIRST + 109) // Cached Invoke context
...
#define DISPID_INTERNAL_FILTERPTRCACHE                                         \
  (DISPID_A_FIRST + 113) // FilterCollection in AttrArray
...
#define DISPID_A_UNICODEBIDI                                                   \
  (DISPID_A_FIRST + 118) // Complex Text support for CSS2 unicode-bidi
#define DISPID_A_DIRECTION                                                     \
  (DISPID_A_FIRST + 119) // Complex Text support for CSS2 direction
...
//;begin_internal
#define DISPID_INTERNAL_FILTERNATIVEINFOPTRCACHE                               \
  (DISPID_A_FIRST + 156) // CFilterNativeInfo in AttrArray
//;end_internal
...
#define DISPID_EVPROP_MSHTMLWEBVIEW_ONFRAMEDOMCONTENTLOADED                    \
  (DISPID_EVENTS + 220)
#define DISPID_EVPROP_MSHTMLWEBVIEW_ONFRAMECONTENTLOADING (DISPID_EVENTS + 221)
#define DISPID_EVPROP_MSHTMLWEBVIEW_ONFRAMENAVIGATIONSTARTING                  \
  (DISPID_EVENTS + 222)
#define DISPID_EVPROP_MSHTMLWEBVIEW_ONFRAMENAVIGATIONCOMPLETED                 \
  (DISPID_EVENTS + 223)
...
#define DISPID_EVPROP_MSHTMLWEBVIEW_ONUNSAFECONTENTWARNINGDISPLAYING           \
  (DISPID_EVENTS + 226)
#define DISPID_EVPROP_MSHTMLWEBVIEW_ONLONGRUNNINGSCRIPTDETECTED                \
  (DISPID_EVENTS + 227)
...
#define DISPID_EVPROP_MSHTMLWEBVIEW_ONCONTAINSFULLSCREENELEMENTCHANGED         \
  (DISPID_EVENTS + 247)
...
#define DISPID_EVPROP_ONWEBKITTRANSITIONEND                                    \
  (DISPID_EVENTS +                                                             \
   252) // webkit compat equivalent of DISPID_EVPROP_ONTRANSITIONEND
#define DISPID_EVPROP_ONWEBKITANIMATIONSTART                                   \
  (DISPID_EVENTS +                                                             \
   253) // webkit compat equivalent of DISPID_EVPROP_ONANIMATIONSTART
#define DISPID_EVPROP_ONWEBKITANIMATIONEND                                     \
  (DISPID_EVENTS +                                                             \
   254) // webkit compat equivalent of DISPID_EVPROP_ONANIMATIONEND
#define DISPID_EVPROP_ONWEBKITANIMATIONITERATION                               \
  (DISPID_EVENTS +                                                             \
   255) // webkit compat equivalent of DISPID_EVPROP_ONANIMATIONITERATION
#define DISPID_EVPROP_WEBGLCONTEXTCREATIONERROR (DISPID_EVENTS + 256)
#define DISPID_EVPROP_ONDOMFOCUSIN                                             \
  (DISPID_EVENTS + 257) // webkit compat equivalent of DISPID_EVPROP_ONFOCUSIN
#define DISPID_EVPROP_ONDOMFOCUSOUT                                            \
  (DISPID_EVENTS + 258) // webkit compat equivalent of DISPID_EVPROP_ONFOCUSOUT
...
#define DISPID_IHTMLCSSSTYLEDECLARATION3_BORDERIMAGESOURCE                     \
  DISPID_A_BORDERIMAGESOURCE
#define DISPID_IHTMLCSSSTYLEDECLARATION3_BORDERIMAGESLICE                      \
  DISPID_A_BORDERIMAGESLICE
#define DISPID_IHTMLCSSSTYLEDECLARATION3_BORDERIMAGEWIDTH                      \
  DISPID_A_BORDERIMAGEWIDTH
#define DISPID_IHTMLCSSSTYLEDECLARATION3_BORDERIMAGEOUTSET                     \
  DISPID_A_BORDERIMAGEOUTSET
#define DISPID_IHTMLCSSSTYLEDECLARATION3_BORDERIMAGEREPEAT                     \
  DISPID_A_BORDERIMAGEREPEAT
#define DISPID_IHTMLCSSSTYLEDECLARATION3_MSIMEALIGN DISPID_A_MS_IMEALIGN
#define DISPID_IHTMLCSSSTYLEDECLARATION3_MSTEXTCOMBINEHORIZONTAL               \
...
#define DISPID_IHTMLCSSSTYLEDECLARATION4_WEBKITAPPEARANCE                      \
  DISPID_A_WEBKIT_APPEARANCE
#define DISPID_IHTMLCSSSTYLEDECLARATION4_WEBKITUSERSELECT                      \
  DISPID_A_WEBKIT_USERSELECT
#define DISPID_IHTMLCSSSTYLEDECLARATION4_WEBKITBOXALIGN DISPID_A_WEBKIT_BOXALIGN
#define DISPID_IHTMLCSSSTYLEDECLARATION4_WEBKITBOXORDINALGROUP                 \
...
#define DISPID_IHTMLCSSSTYLEDECLARATION4_WEBKITBOXORIENT                       \
  DISPID_A_WEBKIT_BOXORIENT
#define DISPID_IHTMLCSSSTYLEDECLARATION4_WEBKITBOXDIRECTION                    \
  DISPID_A_WEBKIT_BOXDIRECTION
#define DISPID_IHTMLCSSSTYLEDECLARATION4_WEBKITTRANSFORM                       \
  DISPID_A_WEBKIT_TRANSFORM
#define DISPID_IHTMLCSSSTYLEDECLARATION4_WEBKITBACKGROUNDSIZE                  \
  DISPID_A_WEBKIT_BACKGROUNDSIZE
#define DISPID_IHTMLCSSSTYLEDECLARATION4_WEBKITBACKFACEVISIBILITY              \
  DISPID_A_WEBKIT_BACKFACEVISIBILITY
#define DISPID_IHTMLCSSSTYLEDECLARATION4_WEBKITANIMATION                       \
  DISPID_A_WEBKIT_ANIMATION
#define DISPID_IHTMLCSSSTYLEDECLARATION4_WEBKITTRANSITION                      \
  DISPID_A_WEBKIT_TRANSITION
#define DISPID_IHTMLCSSSTYLEDECLARATION4_WEBKITANIMATIONNAME                   \
  DISPID_A_WEBKIT_ANIMATIONNAME
#define DISPID_IHTMLCSSSTYLEDECLARATION4_WEBKITANIMATIONDURATION               \
  DISPID_A_WEBKIT_ANIMATIONDURATION
#define DISPID_IHTMLCSSSTYLEDECLARATION4_WEBKITANIMATIONTIMINGFUNCTION         \
  DISPID_A_WEBKIT_ANIMATIONTIMINGFUNCTION
#define DISPID_IHTMLCSSSTYLEDECLARATION4_WEBKITANIMATIONDELAY                  \
  DISPID_A_WEBKIT_ANIMATIONDELAY
#define DISPID_IHTMLCSSSTYLEDECLARATION4_WEBKITANIMATIONITERATIONCOUNT         \
  DISPID_A_WEBKIT_ANIMATIONITERATIONCOUNT
#define DISPID_IHTMLCSSSTYLEDECLARATION4_WEBKITANIMATIONDIRECTION              \
  DISPID_A_WEBKIT_ANIMATIONDIRECTION
#define DISPID_IHTMLCSSSTYLEDECLARATION4_WEBKITANIMATIONPLAYSTATE              \
  DISPID_A_WEBKIT_ANIMATIONPLAYSTATE
#define DISPID_IHTMLCSSSTYLEDECLARATION4_WEBKITTRANSITIONPROPERTY              \
...
#define DISPID_IHTMLCSSSTYLEDECLARATION4_WEBKITTRANSITIONDELAY                 \
  DISPID_A_WEBKIT_TRANSITIONDELAY
#define DISPID_IHTMLCSSSTYLEDECLARATION4_WEBKITBACKGROUNDATTACHMENT            \
  DISPID_A_WEBKIT_BACKGROUNDATTACHMENT
#define DISPID_IHTMLCSSSTYLEDECLARATION4_WEBKITBACKGROUNDCOLOR                 \
  DISPID_A_WEBKIT_BACKGROUNDCOLOR
#define DISPID_IHTMLCSSSTYLEDECLARATION4_WEBKITBACKGROUNDCLIP                  \
  DISPID_A_WEBKIT_BACKGROUNDCLIP
#define DISPID_IHTMLCSSSTYLEDECLARATION4_WEBKITBACKGROUNDIMAGE                 \
  DISPID_A_WEBKIT_BACKGROUNDIMAGE
#define DISPID_IHTMLCSSSTYLEDECLARATION4_WEBKITBACKGROUNDREPEAT                \
...
#define DISPID_IHTMLCSSSTYLEDECLARATION4_WEBKITBACKGROUNDPOSITION              \
  DISPID_A_WEBKIT_BACKGROUNDPOSITION
#define DISPID_IHTMLCSSSTYLEDECLARATION4_WEBKITBACKGROUNDPOSITIONX             \
  DISPID_A_WEBKIT_BACKGROUNDPOSITIONX
#define DISPID_IHTMLCSSSTYLEDECLARATION4_WEBKITBACKGROUNDPOSITIONY             \
  DISPID_A_WEBKIT_BACKGROUNDPOSITIONY
#define DISPID_IHTMLCSSSTYLEDECLARATION4_WEBKITBACKGROUND                      \
  DISPID_A_WEBKIT_BACKGROUND
#define DISPID_IHTMLCSSSTYLEDECLARATION4_WEBKITTRANSFORMORIGIN                 \
  DISPID_A_WEBKIT_TRANSFORMORIGIN
#define DISPID_IHTMLCSSSTYLEDECLARATION4_MSTEXTSIZEADJUST                      \
  DISPID_A_MS_TEXTSIZEADJUST
#define DISPID_IHTMLCSSSTYLEDECLARATION4_WEBKITTEXTSIZEADJUST                  \
  DISPID_A_WEBKIT_TEXTSIZEADJUST
#define DISPID_IHTMLCSSSTYLEDECLARATION4_WEBKITBORDERIMAGE                     \
  DISPID_A_WEBKIT_BORDERIMAGE
#define DISPID_IHTMLCSSSTYLEDECLARATION4_WEBKITBORDERIMAGESOURCE               \
  DISPID_A_WEBKIT_BORDERIMAGESOURCE
#define DISPID_IHTMLCSSSTYLEDECLARATION4_WEBKITBORDERIMAGESLICE                \
  DISPID_A_WEBKIT_BORDERIMAGESLICE
#define DISPID_IHTMLCSSSTYLEDECLARATION4_WEBKITBORDERIMAGEWIDTH                \
  DISPID_A_WEBKIT_BORDERIMAGEWIDTH
#define DISPID_IHTMLCSSSTYLEDECLARATION4_WEBKITBORDERIMAGEOUTSET               \
  DISPID_A_WEBKIT_BORDERIMAGEOUTSET
#define DISPID_IHTMLCSSSTYLEDECLARATION4_WEBKITBORDERIMAGEREPEAT               \
  DISPID_A_WEBKIT_BORDERIMAGEREPEAT
#define DISPID_IHTMLCSSSTYLEDECLARATION4_WEBKITBOXSIZING                       \
  DISPID_A_WEBKIT_BOXSIZING
#define DISPID_IHTMLCSSSTYLEDECLARATION4_WEBKITANIMATIONFILLMODE               \
...
#define DISPID_IPRINTMANAGERTEMPLATEPRINTER2_SHOWHEADERFOOTER                  \
  DISPID_PRINTMANAGER_TEMPLATE_PRINTER + 6
#define DISPID_IPRINTMANAGERTEMPLATEPRINTER2_SHRINKTOFIT                       \
  DISPID_PRINTMANAGER_TEMPLATE_PRINTER + 7
#define DISPID_IPRINTMANAGERTEMPLATEPRINTER2_PERCENTSCALE                      \
...
#define DISPID_IE9EVENTS_MSWEBVIEWDOMCONTENTLOADED                             \
  DISPID_EVPROP_MSHTMLWEBVIEW_ONDOMCONTENTLOADED
#define DISPID_IE9EVENTS_MSWEBVIEWCONTENTLOADING                               \
  DISPID_EVPROP_MSHTMLWEBVIEW_ONCONTENTLOADING
#define DISPID_IE9EVENTS_MSWEBVIEWNAVIGATIONSTARTING                           \
  DISPID_EVPROP_MSHTMLWEBVIEW_ONNAVIGATIONSTARTING
#define DISPID_IE9EVENTS_MSWEBVIEWNAVIGATIONCOMPLETED                          \
  DISPID_EVPROP_MSHTMLWEBVIEW_ONNAVIGATIONCOMPLETED
#define DISPID_IE9EVENTS_MSWEBVIEWFRAMEDOMCONTENTLOADED                        \
  DISPID_EVPROP_MSHTMLWEBVIEW_ONFRAMEDOMCONTENTLOADED
#define DISPID_IE9EVENTS_MSWEBVIEWFRAMECONTENTLOADING                          \
  DISPID_EVPROP_MSHTMLWEBVIEW_ONFRAMECONTENTLOADING
#define DISPID_IE9EVENTS_MSWEBVIEWFRAMENAVIGATIONSTARTING                      \
  DISPID_EVPROP_MSHTMLWEBVIEW_ONFRAMENAVIGATIONSTARTING
#define DISPID_IE9EVENTS_MSWEBVIEWFRAMENAVIGATIONCOMPLETED                     \
  DISPID_EVPROP_MSHTMLWEBVIEW_ONFRAMENAVIGATIONCOMPLETED
#define DISPID_IE9EVENTS_MSWEBVIEWSCRIPTNOTIFY                                 \
  DISPID_EVPROP_MSHTMLWEBVIEW_ONSCRIPTNOTIFY
#define DISPID_IE9EVENTS_MSWEBVIEWLONGRUNNINGSCRIPTDETECTED                    \
  DISPID_EVPROP_MSHTMLWEBVIEW_ONLONGRUNNINGSCRIPTDETECTED
#define DISPID_IE9EVENTS_MSWEBVIEWUNVIEWABLECONTENTIDENTIFIED                  \
  DISPID_EVPROP_MSHTMLWEBVIEW_ONUNVIEWABLECONTENT
#define DISPID_IE9EVENTS_MSWEBVIEWUNSAFECONTENTWARNINGDISPLAYING               \
  DISPID_EVPROP_MSHTMLWEBVIEW_ONUNSAFECONTENTWARNINGDISPLAYING
#define DISPID_IE9EVENTS_MSWEBVIEWCONTAINSFULLSCREENELEMENTCHANGED             \
...
#define DISPID_IE9EVENTS_WEBGLCONTEXTCREATIONERROR                             \
...
#define DISPID_IE9EVENTS_COMPASSNEEDSCALIBRATION                               \
...
#define DISPID_IE9EVENTS_MSCANDIDATEWINDOWSHOW                                 \
  DISPID_EVPROP_ONMSCANDIDATEWINDOWSHOW
#define DISPID_IE9EVENTS_MSCANDIDATEWINDOWUPDATE                               \
  DISPID_EVPROP_ONMSCANDIDATEWINDOWUPDATE
#define DISPID_IE9EVENTS_MSCANDIDATEWINDOWHIDE                                 \
  DISPID_EVPROP_ONMSCANDIDATEWINDOWHIDE
