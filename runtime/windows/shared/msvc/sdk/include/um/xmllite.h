...
STDAPI CreateXmlReader(_In_ REFIID riid, _Outptr_ void **ppvObject,
                       _In_opt_ IMalloc *pMalloc);
////////////////////////////////////////////////////////////////////////////////////////////////////////////
// XmlReaderInput Constructors
STDAPI CreateXmlReaderInputWithEncodingCodePage(
    _In_ IUnknown *pInputStream, _In_opt_ IMalloc *pMalloc,
    _In_ UINT nEncodingCodePage, _In_ BOOL fEncodingHint,
    _In_opt_ LPCWSTR pwszBaseUri, _Out_ IXmlReaderInput **ppInput);
STDAPI CreateXmlReaderInputWithEncodingName(_In_ IUnknown *pInputStream,
                                            _In_opt_ IMalloc *pMalloc,
...
STDAPI CreateXmlWriter(_In_ REFIID riid, _Out_ void **ppvObject,
                       _In_opt_ IMalloc *pMalloc);
////////////////////////////////////////////////////////////////////////////////////////////////////////////
// XmlWriterOutput Constructors
STDAPI CreateXmlWriterOutputWithEncodingCodePage(
    _In_ IUnknown *pOutputStream, _In_opt_ IMalloc *pMalloc,
    _In_ UINT nEncodingCodePage, _Out_ IXmlWriterOutput **ppOutput);
STDAPI CreateXmlWriterOutputWithEncodingName(_In_ IUnknown *pOutputStream,
                                             _In_opt_ IMalloc *pMalloc,
                                             _In_ LPCWSTR pwszEncodingName,
...
typedef enum XmlReaderProperty {
  ...
  XmlReaderProperty_MaxEntityExpansion =
      (XmlReaderProperty_MaxElementDepth + 1),
...
typedef enum XmlWriterProperty {
  ...
  XmlWriterProperty_ConformanceLevel =
      (XmlWriterProperty_OmitXmlDeclaration + 1),
  XmlWriterProperty_CompactEmptyElement =
      (XmlWriterProperty_ConformanceLevel + 1),
...
public:
  ...
  virtual HRESULT STDMETHODCALLTYPE GetQualifiedName(
      /* [annotation] */
      _Outptr_result_buffer_maybenull_(*pcwchQualifiedName + 1) LPCWSTR *
          ppwszQualifiedName,
      /* [annotation] */
  ...
  virtual HRESULT STDMETHODCALLTYPE GetNamespaceUri(
      /* [annotation] */
      _Outptr_result_buffer_maybenull_(*pcwchNamespaceUri + 1) LPCWSTR *
          ppwszNamespaceUri,
      /* [annotation] */
  ...
  virtual HRESULT STDMETHODCALLTYPE GetLocalName(
      /* [annotation] */
      _Outptr_result_buffer_maybenull_(*pcwchLocalName + 1) LPCWSTR *
          ppwszLocalName,
      /* [annotation] */
  ...
  virtual HRESULT STDMETHODCALLTYPE GetBaseUri(
      /* [annotation] */
      _Outptr_result_buffer_maybenull_(*pcwchBaseUri + 1) LPCWSTR *
          ppwszBaseUri,
      /* [annotation] */
...
typedef struct IXmlReaderVtbl {
  ...
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(IXmlReader *This,
                                             /* [in] */ REFIID riid,
  ...
  HRESULT(STDMETHODCALLTYPE *SetInput)(IXmlReader *This,
                                       /* [annotation] */
                                       _In_opt_ IUnknown *pInput);

  DECLSPEC_XFGVIRT(IXmlReader, GetProperty)
  HRESULT(STDMETHODCALLTYPE *GetProperty)(IXmlReader *This,
                                          /* [annotation] */
                                          _In_ UINT nProperty,
                                          /* [annotation] */
  ...
  HRESULT(STDMETHODCALLTYPE *SetProperty)(IXmlReader *This,
                                          /* [annotation] */
                                          _In_ UINT nProperty,
                                          /* [annotation] */
  ...
  HRESULT(STDMETHODCALLTYPE *Read)(IXmlReader *This,
                                   /* [annotation] */
  ...
  HRESULT(STDMETHODCALLTYPE *GetQualifiedName)(
      IXmlReader *This,
      /* [annotation] */
      _Outptr_result_buffer_maybenull_(*pcwchQualifiedName + 1)
  ...
  HRESULT(STDMETHODCALLTYPE *GetNamespaceUri)(
      IXmlReader *This,
      /* [annotation] */
      _Outptr_result_buffer_maybenull_(*pcwchNamespaceUri + 1)
  ...
  HRESULT(STDMETHODCALLTYPE *GetLocalName)(
      IXmlReader *This,
      /* [annotation] */
      _Outptr_result_buffer_maybenull_(*pcwchLocalName + 1)
  ...
  HRESULT(STDMETHODCALLTYPE *ReadValueChunk)(IXmlReader *This,
                                             /* [annotation] */
                                             _Out_writes_to_(cwchChunkSize,
                                                             *pcwchRead)
                                                 WCHAR *pwchBuffer,
                                             /* [annotation] */
                                             _In_ UINT cwchChunkSize,
  ...
  HRESULT(STDMETHODCALLTYPE *GetLineNumber)(IXmlReader *This,
                                            /* [annotation] */
  ...
  HRESULT(STDMETHODCALLTYPE *GetDepth)(IXmlReader *This,
                                       /* [annotation] */
                                       _Out_ UINT *pnDepth);
...
interface IXmlReader { CONST_VTBL struct IXmlReaderVtbl *lpVtbl; };
...
#define IXmlReader_MoveToAttributeByName(This, pwszLocalName,                  \
                                         pwszNamespaceUri)                     \
...
#define IXmlReader_GetQualifiedName(This, ppwszQualifiedName,                  \
                                    pcwchQualifiedName)                        \
  ((This)->lpVtbl->GetQualifiedName(This, ppwszQualifiedName,                  \
                                    pcwchQualifiedName))
...
typedef struct IXmlResolverVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(IXmlResolver *This,
                                             /* [in] */ REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);
  ...
  HRESULT(STDMETHODCALLTYPE *ResolveUri)(IXmlResolver *This,
                                         /* [annotation] */
                                         _In_opt_ LPCWSTR pwszBaseUri,
                                         /* [annotation] */
                                         _In_opt_ LPCWSTR pwszPublicIdentifier,
...
interface IXmlResolver { CONST_VTBL struct IXmlResolverVtbl *lpVtbl; };
...
#define IXmlResolver_ResolveUri(This, pwszBaseUri, pwszPublicIdentifier,       \
                                pwszSystemIdentifier, ppResolvedInput)         \
  ((This)->lpVtbl->ResolveUri(This, pwszBaseUri, pwszPublicIdentifier,         \
                              pwszSystemIdentifier, ppResolvedInput))
...
typedef struct IXmlWriterVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(IXmlWriter *This,
                                             /* [in] */ REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);
  ...
  HRESULT(STDMETHODCALLTYPE *SetOutput)(IXmlWriter *This,
                                        /* [annotation] */
                                        _In_opt_ IUnknown *pOutput);

  DECLSPEC_XFGVIRT(IXmlWriter, GetProperty)
  HRESULT(STDMETHODCALLTYPE *GetProperty)(IXmlWriter *This,
                                          /* [annotation] */
                                          _In_ UINT nProperty,
                                          /* [annotation] */
                                          _Out_ LONG_PTR *ppValue);
  ...
  HRESULT(STDMETHODCALLTYPE *SetProperty)(IXmlWriter *This,
                                          /* [annotation] */
                                          _In_ UINT nProperty,
                                          /* [annotation] */
                                          _In_opt_ LONG_PTR pValue);
  ...
  HRESULT(STDMETHODCALLTYPE *WriteCData)(IXmlWriter *This,
                                         /* [annotation] */
                                         _In_opt_ LPCWSTR pwszText);

  DECLSPEC_XFGVIRT(IXmlWriter, WriteCharEntity)
  HRESULT(STDMETHODCALLTYPE *WriteCharEntity)(IXmlWriter *This,
                                              /* [annotation] */
                                              _In_ WCHAR wch);

  DECLSPEC_XFGVIRT(IXmlWriter, WriteChars)
  HRESULT(STDMETHODCALLTYPE *WriteChars)(IXmlWriter *This,
                                         /* [annotation] */
                                         _In_reads_opt_(cwch) const WCHAR *pwch,
                                         /* [annotation] */
                                         _In_ UINT cwch);
  ...
  HRESULT(STDMETHODCALLTYPE *WriteDocType)(IXmlWriter *This,
                                           /* [annotation] */
                                           _In_opt_ LPCWSTR pwszName,
                                           /* [annotation] */
                                           _In_opt_ LPCWSTR pwszPublicId,
  ...
  HRESULT(STDMETHODCALLTYPE *WriteName)(IXmlWriter *This,
                                        /* [annotation] */
                                        _In_ LPCWSTR pwszName);
  ...
  HRESULT(STDMETHODCALLTYPE *WriteNode)(IXmlWriter *This,
                                        /* [annotation] */
                                        _In_ IXmlReader *pReader,
                                        /* [annotation] */
  ...
  HRESULT(STDMETHODCALLTYPE *WriteRaw)(IXmlWriter *This,
                                       /* [annotation] */
                                       _In_opt_ LPCWSTR pwszData);

  DECLSPEC_XFGVIRT(IXmlWriter, WriteRawChars)
  HRESULT(STDMETHODCALLTYPE *WriteRawChars)(IXmlWriter *This,
                                            /* [annotation] */
                                            _In_reads_opt_(cwch)
                                                const WCHAR *pwch,
                                            /* [annotation] */
  ...
  HRESULT(STDMETHODCALLTYPE *WriteString)(IXmlWriter *This,
                                          /* [annotation] */
                                          _In_opt_ LPCWSTR pwszText);
...
interface IXmlWriter { CONST_VTBL struct IXmlWriterVtbl *lpVtbl; };
...
typedef struct IXmlWriterLiteVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(IXmlWriterLite *This,
                                             /* [in] */ REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(IXmlWriterLite *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(IXmlWriterLite *This);

  DECLSPEC_XFGVIRT(IXmlWriterLite, SetOutput)
  HRESULT(STDMETHODCALLTYPE *SetOutput)(IXmlWriterLite *This,
                                        /* [annotation] */
                                        _In_opt_ IUnknown *pOutput);

  DECLSPEC_XFGVIRT(IXmlWriterLite, GetProperty)
  HRESULT(STDMETHODCALLTYPE *GetProperty)(IXmlWriterLite *This,
                                          /* [annotation] */
                                          _In_ UINT nProperty,
                                          /* [annotation] */
                                          _Out_ LONG_PTR *ppValue);
  ...
  HRESULT(STDMETHODCALLTYPE *SetProperty)(IXmlWriterLite *This,
                                          /* [annotation] */
                                          _In_ UINT nProperty,
                                          /* [annotation] */
                                          _In_opt_ LONG_PTR pValue);
  ...
  HRESULT(STDMETHODCALLTYPE *WriteAttributes)(IXmlWriterLite *This,
                                              /* [annotation] */
                                              _In_ IXmlReader *pReader,
                                              /* [annotation] */
                                              _In_ BOOL
  ...
  HRESULT(STDMETHODCALLTYPE *WriteAttributeString)(IXmlWriterLite *This,
                                                   /* [annotation] */
                                                   _In_reads_(cwszQName)
                                                       const WCHAR *pwszQName,
                                                   /* [annotation] */
                                                   _In_ UINT cwszQName,
                                                   /* [annotation] */
                                                   _In_reads_opt_(cwszValue)
                                                       const WCHAR *pwszValue,
                                                   /* [annotation] */
                                                   _In_ UINT cwszValue);

  DECLSPEC_XFGVIRT(IXmlWriterLite, WriteCData)
  HRESULT(STDMETHODCALLTYPE *WriteCData)(IXmlWriterLite *This,
                                         /* [annotation] */
                                         _In_opt_ LPCWSTR pwszText);

  DECLSPEC_XFGVIRT(IXmlWriterLite, WriteCharEntity)
  HRESULT(STDMETHODCALLTYPE *WriteCharEntity)(IXmlWriterLite *This,
                                              /* [annotation] */
                                              _In_ WCHAR wch);

  DECLSPEC_XFGVIRT(IXmlWriterLite, WriteChars)
  HRESULT(STDMETHODCALLTYPE *WriteChars)(IXmlWriterLite *This,
                                         /* [annotation] */
                                         _In_reads_opt_(cwch) const WCHAR *pwch,
                                         /* [annotation] */
                                         _In_ UINT cwch);
  ...
  HRESULT(STDMETHODCALLTYPE *WriteComment)(IXmlWriterLite *This,
                                           /* [annotation] */
                                           _In_opt_ LPCWSTR pwszComment);

  DECLSPEC_XFGVIRT(IXmlWriterLite, WriteDocType)
  HRESULT(STDMETHODCALLTYPE *WriteDocType)(IXmlWriterLite *This,
                                           /* [annotation] */
                                           _In_opt_ LPCWSTR pwszName,
                                           /* [annotation] */
                                           _In_opt_ LPCWSTR pwszPublicId,
  ...
  HRESULT(STDMETHODCALLTYPE *WriteElementString)(IXmlWriterLite *This,
                                                 /* [annotation] */
                                                 _In_reads_(cwszQName)
                                                     const WCHAR *pwszQName,
                                                 /* [annotation] */
  ...
  HRESULT(STDMETHODCALLTYPE *WriteEndDocument)(IXmlWriterLite *This);

  DECLSPEC_XFGVIRT(IXmlWriterLite, WriteEndElement)
  HRESULT(STDMETHODCALLTYPE *WriteEndElement)(IXmlWriterLite *This,
                                              /* [annotation] */
                                              _In_reads_(cwszQName)
                                                  const WCHAR *pwszQName,
                                              /* [annotation] */
  ...
  HRESULT(STDMETHODCALLTYPE *WriteEntityRef)(IXmlWriterLite *This,
                                             /* [annotation] */
                                             _In_ LPCWSTR pwszName);

  DECLSPEC_XFGVIRT(IXmlWriterLite, WriteFullEndElement)
  HRESULT(STDMETHODCALLTYPE *WriteFullEndElement)(IXmlWriterLite *This,
                                                  /* [annotation] */
                                                  _In_reads_(cwszQName)
                                                      const WCHAR *pwszQName,
                                                  /* [annotation] */
  ...
  HRESULT(STDMETHODCALLTYPE *WriteName)(IXmlWriterLite *This,
                                        /* [annotation] */
                                        _In_ LPCWSTR pwszName);

  DECLSPEC_XFGVIRT(IXmlWriterLite, WriteNmToken)
  HRESULT(STDMETHODCALLTYPE *WriteNmToken)(IXmlWriterLite *This,
                                           /* [annotation] */
                                           _In_ LPCWSTR pwszNmToken);

  DECLSPEC_XFGVIRT(IXmlWriterLite, WriteNode)
  HRESULT(STDMETHODCALLTYPE *WriteNode)(IXmlWriterLite *This,
                                        /* [annotation] */
                                        _In_ IXmlReader *pReader,
                                        /* [annotation] */
                                        _In_ BOOL fWriteDefaultAttributes);
  ...
  HRESULT(STDMETHODCALLTYPE *WriteNodeShallow)(IXmlWriterLite *This,
                                               /* [annotation] */
                                               _In_ IXmlReader *pReader,
                                               /* [annotation] */
                                               _In_ BOOL
  ...
  HRESULT(STDMETHODCALLTYPE *WriteProcessingInstruction)(IXmlWriterLite *This,
                                                         /* [annotation] */
                                                         _In_ LPCWSTR pwszName,
                                                         /* [annotation] */
                                                         _In_opt_ LPCWSTR
  ...
  HRESULT(STDMETHODCALLTYPE *WriteRaw)(IXmlWriterLite *This,
                                       /* [annotation] */
                                       _In_opt_ LPCWSTR pwszData);

  DECLSPEC_XFGVIRT(IXmlWriterLite, WriteRawChars)
  HRESULT(STDMETHODCALLTYPE *WriteRawChars)(IXmlWriterLite *This,
                                            /* [annotation] */
                                            _In_reads_opt_(cwch)
                                                const WCHAR *pwch,
                                            /* [annotation] */
  ...
  HRESULT(STDMETHODCALLTYPE *WriteStartDocument)(IXmlWriterLite *This,
                                                 /* [annotation] */
                                                 _In_ XmlStandalone standalone);

  DECLSPEC_XFGVIRT(IXmlWriterLite, WriteStartElement)
  HRESULT(STDMETHODCALLTYPE *WriteStartElement)(IXmlWriterLite *This,
                                                /* [annotation] */
                                                _In_reads_(cwszQName)
                                                    const WCHAR *pwszQName,
                                                /* [annotation] */
  ...
  HRESULT(STDMETHODCALLTYPE *WriteString)(IXmlWriterLite *This,
                                          /* [annotation] */
                                          _In_opt_ LPCWSTR pwszText);

  DECLSPEC_XFGVIRT(IXmlWriterLite, WriteSurrogateCharEntity)
  HRESULT(STDMETHODCALLTYPE *WriteSurrogateCharEntity)(IXmlWriterLite *This,
                                                       /* [annotation] */
                                                       _In_ WCHAR wchLow,
                                                       /* [annotation] */
                                                       _In_ WCHAR wchHigh);
  ...
  HRESULT(STDMETHODCALLTYPE *WriteWhitespace)(IXmlWriterLite *This,
                                              /* [annotation] */
                                              _In_opt_ LPCWSTR pwszWhitespace);

  DECLSPEC_XFGVIRT(IXmlWriterLite, Flush)
  HRESULT(STDMETHODCALLTYPE *Flush)(IXmlWriterLite *This);

  END_INTERFACE
} IXmlWriterLiteVtbl;

interface IXmlWriterLite { CONST_VTBL struct IXmlWriterLiteVtbl *lpVtbl; };
...
#define IXmlWriterLite_WriteAttributeString(This, pwszQName, cwszQName,        \
                                            pwszValue, cwszValue)              \
...
#define IXmlWriterLite_WriteDocType(This, pwszName, pwszPublicId,              \
                                    pwszSystemId, pwszSubset)                  \
  ((This)->lpVtbl->WriteDocType(This, pwszName, pwszPublicId, pwszSystemId,    \
                                pwszSubset))

#define IXmlWriterLite_WriteElementString(This, pwszQName, cwszQName,          \
                                          pwszValue)                           \
...
#define IXmlWriterLite_WriteNodeShallow(This, pReader,                         \
                                        fWriteDefaultAttributes)               \
  ((This)->lpVtbl->WriteNodeShallow(This, pReader, fWriteDefaultAttributes))
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////
// IID helpers
static const IID _IID_IXmlReader = {
    0x7279FC81,
    0x709D,
    0x4095,
    {0xB6, 0x3D, 0x69, 0xFE, 0x4B, 0x0D, 0x90, 0x30}};
static const IID _IID_IXmlWriter = {
    0x7279FC88,
    0x709D,
    0x4095,
    {0xB6, 0x3D, 0x69, 0xFE, 0x4B, 0x0D, 0x90, 0x30}};
static const IID _IID_IXmlResolver = {
    0x7279FC82,
    0x709D,
    0x4095,
    {0xB6, 0x3D, 0x69, 0xFE, 0x4B, 0x0D, 0x90, 0x30}};
