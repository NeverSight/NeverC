...
typedef struct ID3D10Device1Vtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(ID3D10Device1 *This,
                                             /* [in] */ REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);
  ...
  HRESULT(STDMETHODCALLTYPE *SetPrivateData)(ID3D10Device1 *This,
                                             /* [annotation] */
                                             _In_ REFGUID guid,
                                             /* [annotation] */
                                             _In_ UINT DataSize,
...
HRESULT WINAPI D3D10CreateDeviceAndSwapChain1(
    _In_opt_ IDXGIAdapter *pAdapter, D3D10_DRIVER_TYPE DriverType,
    ...
    _Out_opt_ IDXGISwapChain **ppSwapChain, _Out_opt_ ID3D10Device1 **ppDevice);
