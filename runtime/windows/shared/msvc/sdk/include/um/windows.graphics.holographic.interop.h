...
typedef interface IHolographicCameraRenderingParametersInterop
...
typedef interface IHolographicQuadLayerUpdateParametersInterop
...
extern RPC_IF_HANDLE
    __MIDL_itf_windows2Egraphics2Eholographic2Einterop_0000_0000_v0_0_c_ifspec;
extern RPC_IF_HANDLE
    __MIDL_itf_windows2Egraphics2Eholographic2Einterop_0000_0000_v0_0_s_ifspec;
...
public:
  virtual HRESULT STDMETHODCALLTYPE CreateDirect3D12BackBufferResource(
      ...
      /* [retval][out] */ __RPC__deref_out_opt ID3D12Resource *
          *ppCreatedTexture2DResource) = 0;

  virtual HRESULT STDMETHODCALLTYPE
      CreateDirect3D12HardwareProtectedBackBufferResource(
          /* [in] */ __RPC__in_opt ID3D12Device * pDevice,
          /* [in] */ __RPC__in D3D12_RESOURCE_DESC * pTexture2DDesc,
          /* [in] */ __RPC__in_opt ID3D12ProtectedResourceSession *
...
typedef struct IHolographicCameraInteropVtbl {
  ...
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IHolographicCameraInterop *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IHolographicCameraInterop *This);
  ...
  DECLSPEC_XFGVIRT(IHolographicCameraInterop,
  ...
  HRESULT(STDMETHODCALLTYPE *CreateDirect3D12BackBufferResource)(
      ...
      /* [in] */ __RPC__in D3D12_RESOURCE_DESC *pTexture2DDesc,
      /* [retval][out] */
      __RPC__deref_out_opt ID3D12Resource **ppCreatedTexture2DResource);

  DECLSPEC_XFGVIRT(IHolographicCameraInterop,
                   CreateDirect3D12HardwareProtectedBackBufferResource)
  HRESULT(
      STDMETHODCALLTYPE *CreateDirect3D12HardwareProtectedBackBufferResource)(
      __RPC__in IHolographicCameraInterop *This,
      /* [in] */ __RPC__in_opt ID3D12Device *pDevice,
      /* [in] */ __RPC__in D3D12_RESOURCE_DESC *pTexture2DDesc,
      /* [in] */
      __RPC__in_opt ID3D12ProtectedResourceSession *pProtectedResourceSession,
      /* [retval][out] */
      __RPC__deref_out_opt ID3D12Resource **ppCreatedTexture2DResource);
...
#define IHolographicCameraInterop_AddRef(This) ((This)->lpVtbl->AddRef(This))

#define IHolographicCameraInterop_Release(This) ((This)->lpVtbl->Release(This))
...
#define IHolographicCameraInterop_CreateDirect3D12BackBufferResource(          \
    This, pDevice, pTexture2DDesc, ppCreatedTexture2DResource)                 \
  ((This)->lpVtbl->CreateDirect3D12BackBufferResource(                         \
      This, pDevice, pTexture2DDesc, ppCreatedTexture2DResource))

#define IHolographicCameraInterop_CreateDirect3D12HardwareProtectedBackBufferResource( \
    This, pDevice, pTexture2DDesc, pProtectedResourceSession,                          \
    ppCreatedTexture2DResource)                                                        \
  ((This)->lpVtbl->CreateDirect3D12HardwareProtectedBackBufferResource(                \
      This, pDevice, pTexture2DDesc, pProtectedResourceSession,                        \
      ppCreatedTexture2DResource))

#define IHolographicCameraInterop_AcquireDirect3D12BufferResource(             \
    This, pResourceToAcquire, pCommandQueue)                                   \
  ((This)->lpVtbl->AcquireDirect3D12BufferResource(This, pResourceToAcquire,   \
                                                   pCommandQueue))

#define IHolographicCameraInterop_AcquireDirect3D12BufferResourceWithTimeout(  \
    This, pResourceToAcquire, pCommandQueue, duration)                         \
  ((This)->lpVtbl->AcquireDirect3D12BufferResourceWithTimeout(                 \
      This, pResourceToAcquire, pCommandQueue, duration))

#define IHolographicCameraInterop_UnacquireDirect3D12BufferResource(           \
    This, pResourceToUnacquire)                                                \
  ((This)->lpVtbl->UnacquireDirect3D12BufferResource(This,                     \
...
typedef struct IHolographicCameraRenderingParametersInteropVtbl {
  ...
  DECLSPEC_XFGVIRT(IHolographicCameraRenderingParametersInterop,
...
#define IHolographicCameraRenderingParametersInterop_QueryInterface(           \
    This, riid, ppvObject)                                                     \
  ((This)->lpVtbl->QueryInterface(This, riid, ppvObject))
...
#define IHolographicCameraRenderingParametersInterop_GetIids(This, iidCount,   \
                                                             iids)             \
  ((This)->lpVtbl->GetIids(This, iidCount, iids))

#define IHolographicCameraRenderingParametersInterop_GetRuntimeClassName(      \
    This, className)                                                           \
  ((This)->lpVtbl->GetRuntimeClassName(This, className))

#define IHolographicCameraRenderingParametersInterop_GetTrustLevel(This,       \
                                                                   trustLevel) \
  ((This)->lpVtbl->GetTrustLevel(This, trustLevel))

#define IHolographicCameraRenderingParametersInterop_CommitDirect3D12Resource( \
    This, pColorResourceToCommit, pColorResourceFence,                         \
    colorResourceFenceSignalValue)                                             \
  ((This)->lpVtbl->CommitDirect3D12Resource(This, pColorResourceToCommit,      \
                                            pColorResourceFence,               \
                                            colorResourceFenceSignalValue))

#define IHolographicCameraRenderingParametersInterop_CommitDirect3D12ResourceWithDepthData( \
    This, pColorResourceToCommit, pColorResourceFence,                                      \
    colorResourceFenceSignalValue, pDepthResourceToCommit,                                  \
    pDepthResourceFence, depthResourceFenceSignalValue)                                     \
  ((This)->lpVtbl->CommitDirect3D12ResourceWithDepthData(                                   \
      This, pColorResourceToCommit, pColorResourceFence,                                    \
      colorResourceFenceSignalValue, pDepthResourceToCommit,                                \
      pDepthResourceFence, depthResourceFenceSignalValue))
...
typedef struct IHolographicQuadLayerInteropVtbl {
  ...
  DECLSPEC_XFGVIRT(IHolographicQuadLayerInterop,
  ...
  HRESULT(STDMETHODCALLTYPE *CreateDirect3D12ContentBufferResource)(
      ...
      /* [in] */ __RPC__in D3D12_RESOURCE_DESC *pTexture2DDesc,
      /* [retval][out] */
      __RPC__deref_out_opt ID3D12Resource **ppTexture2DResource);
...
#define IHolographicQuadLayerInterop_AddRef(This) ((This)->lpVtbl->AddRef(This))
...
#define IHolographicQuadLayerInterop_CreateDirect3D12ContentBufferResource(    \
    This, pDevice, pTexture2DDesc, ppTexture2DResource)                        \
  ((This)->lpVtbl->CreateDirect3D12ContentBufferResource(                      \
      This, pDevice, pTexture2DDesc, ppTexture2DResource))

#define IHolographicQuadLayerInterop_CreateDirect3D12HardwareProtectedContentBufferResource( \
    This, pDevice, pTexture2DDesc, pProtectedResourceSession,                                \
    ppCreatedTexture2DResource)                                                              \
  ((This)->lpVtbl->CreateDirect3D12HardwareProtectedContentBufferResource(                   \
      This, pDevice, pTexture2DDesc, pProtectedResourceSession,                              \
      ppCreatedTexture2DResource))

#define IHolographicQuadLayerInterop_AcquireDirect3D12BufferResource(          \
    This, pResourceToAcquire, pCommandQueue)                                   \
  ((This)->lpVtbl->AcquireDirect3D12BufferResource(This, pResourceToAcquire,   \
                                                   pCommandQueue))

#define IHolographicQuadLayerInterop_AcquireDirect3D12BufferResourceWithTimeout( \
    This, pResourceToAcquire, pCommandQueue, duration)                           \
  ((This)->lpVtbl->AcquireDirect3D12BufferResourceWithTimeout(                   \
      This, pResourceToAcquire, pCommandQueue, duration))

#define IHolographicQuadLayerInterop_UnacquireDirect3D12BufferResource(        \
    This, pResourceToUnacquire)                                                \
  ((This)->lpVtbl->UnacquireDirect3D12BufferResource(This,                     \
                                                     pResourceToUnacquire))
...
typedef struct IHolographicQuadLayerUpdateParametersInteropVtbl {
  ...
  DECLSPEC_XFGVIRT(IHolographicQuadLayerUpdateParametersInterop,
                   CommitDirect3D12Resource)
  HRESULT(STDMETHODCALLTYPE *CommitDirect3D12Resource)(
      __RPC__in IHolographicQuadLayerUpdateParametersInterop *This,
      /* [in] */ __RPC__in_opt ID3D12Resource *pColorResourceToCommit,
...
#define IHolographicQuadLayerUpdateParametersInterop_QueryInterface(           \
    This, riid, ppvObject)                                                     \
  ((This)->lpVtbl->QueryInterface(This, riid, ppvObject))
...
#define IHolographicQuadLayerUpdateParametersInterop_GetIids(This, iidCount,   \
                                                             iids)             \
  ((This)->lpVtbl->GetIids(This, iidCount, iids))

#define IHolographicQuadLayerUpdateParametersInterop_GetRuntimeClassName(      \
    This, className)                                                           \
  ((This)->lpVtbl->GetRuntimeClassName(This, className))

#define IHolographicQuadLayerUpdateParametersInterop_GetTrustLevel(This,       \
                                                                   trustLevel) \
  ((This)->lpVtbl->GetTrustLevel(This, trustLevel))

#define IHolographicQuadLayerUpdateParametersInterop_CommitDirect3D12Resource( \
    This, pColorResourceToCommit, pColorResourceFence,                         \
    colorResourceFenceSignalValue)                                             \
  ((This)->lpVtbl->CommitDirect3D12Resource(This, pColorResourceToCommit,      \
                                            pColorResourceFence,               \
...
extern RPC_IF_HANDLE
    __MIDL_itf_windows2Egraphics2Eholographic2Einterop_0000_0004_v0_0_c_ifspec;
extern RPC_IF_HANDLE
    __MIDL_itf_windows2Egraphics2Eholographic2Einterop_0000_0004_v0_0_s_ifspec;
