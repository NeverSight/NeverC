...
typedef struct IQueryParserVtbl {
  ...
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in IQueryParser *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IQueryParser *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IQueryParser *This);
...
interface IQueryParser { CONST_VTBL struct IQueryParserVtbl *lpVtbl; };
...
typedef struct IConditionFactoryVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in IConditionFactory *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IConditionFactory *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IConditionFactory *This);
...
#define IConditionFactory_MakeLeaf(                                            \
    This, pszPropertyName, cop, pszValueType, ppropvar, pPropertyNameTerm,     \
    pOperationTerm, pValueTerm, fExpand, ppcResult)                            \
  ((This)->lpVtbl->MakeLeaf(This, pszPropertyName, cop, pszValueType,          \
                            ppropvar, pPropertyNameTerm, pOperationTerm,       \
                            pValueTerm, fExpand, ppcResult))

#define IConditionFactory_Resolve(This, pc, sqro, pstReferenceTime,            \
                                  ppcResolved)                                 \
...
typedef struct IQuerySolutionVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in IQuerySolution *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IQuerySolution *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IQuerySolution *This);
...
interface IQuerySolution { CONST_VTBL struct IQuerySolutionVtbl *lpVtbl; };
...
#define IQuerySolution_MakeLeaf(This, pszPropertyName, cop, pszValueType,      \
                                ppropvar, pPropertyNameTerm, pOperationTerm,   \
                                pValueTerm, fExpand, ppcResult)                \
  ((This)->lpVtbl->MakeLeaf(This, pszPropertyName, cop, pszValueType,          \
                            ppropvar, pPropertyNameTerm, pOperationTerm,       \
...
#define IQuerySolution_GetLexicalData(This, ppszInputString, ppTokens, plcid,  \
                                      ppWordBreaker)                           \
  ((This)->lpVtbl->GetLexicalData(This, ppszInputString, ppTokens, plcid,      \
                                  ppWordBreaker))
...
typedef struct IConditionFactory2Vtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(IConditionFactory2 *This,
                                             /* [in] */ REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);
...
#define IConditionFactory2_MakeLeaf(                                           \
    This, pszPropertyName, cop, pszValueType, ppropvar, pPropertyNameTerm,     \
    pOperationTerm, pValueTerm, fExpand, ppcResult)                            \
  ((This)->lpVtbl->MakeLeaf(This, pszPropertyName, cop, pszValueType,          \
                            ppropvar, pPropertyNameTerm, pOperationTerm,       \
...
#define IConditionFactory2_Resolve(This, pc, sqro, pstReferenceTime,           \
                                   ppcResolved)                                \
  ((This)->lpVtbl->Resolve(This, pc, sqro, pstReferenceTime, ppcResolved))
...
#define IConditionFactory2_CreateCompoundFromObjectArray(This, ct, poaSubs,    \
                                                         cco, riid, ppv)       \
  ((This)->lpVtbl->CreateCompoundFromObjectArray(This, ct, poaSubs, cco, riid, \
                                                 ppv))

#define IConditionFactory2_CreateCompoundFromArray(This, ct, ppcondSubs,       \
                                                   cSubs, cco, riid, ppv)      \
  ((This)->lpVtbl->CreateCompoundFromArray(This, ct, ppcondSubs, cSubs, cco,   \
                                           riid, ppv))

#define IConditionFactory2_CreateStringLeaf(This, propkey, cop, pszValue,      \
                                            pszLocaleName, cco, riid, ppv)     \
  ((This)->lpVtbl->CreateStringLeaf(This, propkey, cop, pszValue,              \
                                    pszLocaleName, cco, riid, ppv))

#define IConditionFactory2_CreateIntegerLeaf(This, propkey, cop, lValue, cco,  \
                                             riid, ppv)                        \
  ((This)->lpVtbl->CreateIntegerLeaf(This, propkey, cop, lValue, cco, riid,    \
                                     ppv))

#define IConditionFactory2_CreateBooleanLeaf(This, propkey, cop, fValue, cco,  \
                                             riid, ppv)                        \
  ((This)->lpVtbl->CreateBooleanLeaf(This, propkey, cop, fValue, cco, riid,    \
                                     ppv))

#define IConditionFactory2_CreateLeaf(                                         \
    This, propkey, cop, propvar, pszSemanticType, pszLocaleName,               \
    pPropertyNameTerm, pOperationTerm, pValueTerm, cco, riid, ppv)             \
  ((This)->lpVtbl->CreateLeaf(This, propkey, cop, propvar, pszSemanticType,    \
                              pszLocaleName, pPropertyNameTerm,                \
                              pOperationTerm, pValueTerm, cco, riid, ppv))

#define IConditionFactory2_ResolveCondition(This, pc, sqro, pstReferenceTime,  \
                                            riid, ppv)                         \
  ((This)->lpVtbl->ResolveCondition(This, pc, sqro, pstReferenceTime, riid,    \
                                    ppv))
...
typedef struct IConditionGeneratorVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IConditionGenerator *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IConditionGenerator *This);
...
#define IConditionGenerator_RecognizeNamedEntities(                            \
    This, pszInputString, lcidUserLocale, pTokenCollection, pNamedEntities)    \
  ((This)->lpVtbl->RecognizeNamedEntities(                                     \
      This, pszInputString, lcidUserLocale, pTokenCollection, pNamedEntities))

#define IConditionGenerator_GenerateForLeaf(                                   \
    This, pConditionFactory, pszPropertyName, cop, pszValueType, pszValue,     \
...
typedef struct IIntervalVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in IInterval *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IInterval *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IInterval *This);
...
interface IInterval { CONST_VTBL struct IIntervalVtbl *lpVtbl; };
...
typedef struct IMetaDataVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in IMetaData *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IMetaData *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IMetaData *This);
...
interface IMetaData { CONST_VTBL struct IMetaDataVtbl *lpVtbl; };
...
typedef struct IEntityVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in IEntity *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IEntity *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IEntity *This);

  DECLSPEC_XFGVIRT(IEntity, Name)
  /* [local] */ HRESULT(STDMETHODCALLTYPE *Name)(IEntity *This,
                                                 /* [retval][annotation][out] */
...
interface IEntity { CONST_VTBL struct IEntityVtbl *lpVtbl; };
...
typedef struct IRelationshipVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in IRelationship *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IRelationship *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IRelationship *This);

  DECLSPEC_XFGVIRT(IRelationship, Name)
  /* [local] */ HRESULT(STDMETHODCALLTYPE *Name)(IRelationship *This,
                                                 /* [retval][annotation][out] */
                                                 _Outptr_opt_ LPWSTR *ppszName);
...
interface IRelationship { CONST_VTBL struct IRelationshipVtbl *lpVtbl; };
...
typedef struct INamedEntityVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in INamedEntity *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in INamedEntity *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in INamedEntity *This);
...
interface INamedEntity { CONST_VTBL struct INamedEntityVtbl *lpVtbl; };
...
typedef struct ISchemaProviderVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in ISchemaProvider *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in ISchemaProvider *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in ISchemaProvider *This);
  ...
  HRESULT(STDMETHODCALLTYPE *SaveBinary)(__RPC__in ISchemaProvider *This,
...
interface ISchemaProvider { CONST_VTBL struct ISchemaProviderVtbl *lpVtbl; };
...
typedef struct ITokenCollectionVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in ITokenCollection *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in ITokenCollection *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in ITokenCollection *This);

  DECLSPEC_XFGVIRT(ITokenCollection, NumberOfTokens)
  HRESULT(STDMETHODCALLTYPE *NumberOfTokens)(__RPC__in ITokenCollection *This,
                                             __RPC__in ULONG *pCount);

  DECLSPEC_XFGVIRT(ITokenCollection, GetToken)
  /* [local] */ HRESULT(STDMETHODCALLTYPE *GetToken)(ITokenCollection *This,
                                                     /* [in] */ ULONG i,
                                                     /* [annotation][out] */
                                                     _Out_opt_ ULONG *pBegin,
                                                     /* [annotation][out] */
...
interface ITokenCollection { CONST_VTBL struct ITokenCollectionVtbl *lpVtbl; };
...
typedef struct INamedEntityCollectorVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in INamedEntityCollector *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in INamedEntityCollector *This);

  DECLSPEC_XFGVIRT(INamedEntityCollector, Add)
  HRESULT(STDMETHODCALLTYPE *Add)(__RPC__in INamedEntityCollector *This,
                                  /* [in] */ ULONG beginSpan,
                                  /* [in] */ ULONG endSpan,
                                  /* [in] */ ULONG beginActual,
                                  /* [in] */ ULONG endActual,
...
typedef struct ISchemaLocalizerSupportVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in ISchemaLocalizerSupport *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in ISchemaLocalizerSupport *This);
...
typedef struct IQueryParserManagerVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IQueryParserManager *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IQueryParserManager *This);
