...
// Compress data
//
HRESULT WINAPI Compress(IN OUT PVOID context,        // compression context
...
//
HRESULT WINAPI Compress2(IN OUT PVOID context,        // compression context
                         IN CONST BYTE *input_buffer, // input buffer
                         IN LONG input_buffer_size,   // size of input buffer
                         IN PBYTE output_buffer,      // output buffer
                         IN LONG output_buffer_size,  // size of output buffer
...
// Required export but not used on Windows Vista and Windows Server 2008 -
// IIS 7.0 Deprecated and not required export for Windows 7 and Windows Server
// 2008 R2 - IIS 7.5
//
HRESULT
WINAPI
