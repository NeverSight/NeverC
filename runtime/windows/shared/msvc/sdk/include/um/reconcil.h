...
#define REC_S_IDIDTHEUPDATES                                                   \
  MAKE_HRESULT(SEVERITY_SUCCESS, FACILITY_ITF, 0x1000)
#define REC_S_NOTCOMPLETE MAKE_HRESULT(SEVERITY_SUCCESS, FACILITY_ITF, 0x1001)
#define REC_S_NOTCOMPLETEBUTPROPAGATE                                          \
  MAKE_HRESULT(SEVERITY_SUCCESS, FACILITY_ITF, 0x1002)
...
#define REC_E_INEEDTODOTHEUPDATES                                              \
  MAKE_HRESULT(SEVERITY_ERROR, FACILITY_ITF, 0x1004)

#define IID_INotifyReplica __uuidof(INotifyReplica)
DECLARE_INTERFACE_IID_(INotifyReplica, IUnknown,
                       "99180163-DA16-101A-935C-444553540000") {
  // IUnknown

  IFACEMETHODIMP QueryInterface(THIS_ _In_ REFIID riid,
  ...
  STDMETHOD(YouAreAReplica)(THIS_ ULONG ulcOtherReplicas,
                            _Inout_updates_(ulcOtherReplicas) IMoniker *
                                *rgpmkOtherReplicas) PURE;
};

#define IID_IReconcileInitiator __uuidof(IReconcileInitiator)
DECLARE_INTERFACE_IID_(IReconcileInitiator, IUnknown,
  ...
  STDMETHOD(SetAbortCallback)(THIS_ _Inout_opt_ IUnknown * punkForAbort) PURE;
...
DECLARE_INTERFACE_IID_(IReconcilableObject, IUnknown,
  ...
  STDMETHOD(Reconcile)(
      THIS_ _Inout_ IReconcileInitiator * pInitiator, DWORD dwFlags,
      HWND hwndOwner, HWND hwndProgressFeedback, ULONG ulcInput,
      _Inout_updates_(ulcInput) IMoniker * *rgpmkOtherInput,
      _Out_ PLONG plOutIndex, _Inout_ IStorage * pstgNewResidues,
      _Reserved_ PVOID pvReserved) PURE;

  STDMETHOD(GetProgressFeedbackMaxEstimate)(THIS_ _Out_ PULONG pulProgressMax)
      PURE;
};

#define IID_IBriefcaseInitiator __uuidof(IBriefcaseInitiator)
DECLARE_INTERFACE_IID_(IBriefcaseInitiator, IUnknown,
                       "99180164-DA16-101A-935C-444553540000") {
  // IUnknown
  ...
  STDMETHOD(IsMonikerInBriefcase)(THIS_ _Inout_ IMoniker * pmk) PURE;
};
