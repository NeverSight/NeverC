...
// MessageText:
//
// The interface pointer passed to the method has an invalid underlying class.
// Only library classes are supported.
//
...
// MessageText:
//
// A content provider with the specified name is already registered on the
// server.
//
...
// MessageText:
//
// The specified content provider name is invalid. The name must be 1 to 255
// characters long and cannot contain a backslash (\) character.
//
...
// MessageText:
//
// The Windows Deployment Services Transport Server role service has not been
...
// MessageText:
//
// The specified namespace name is invalid. The name must be 1 to 255 characters
// long and cannot contain a backslash (\) character.
//
...
// MessageText:
//
// The namespace data cannot be modified because it is currently, or has been
// previously, registered on the server.
//
...
// MessageText:
//
// The specified diagnostics components mask contains invalid or unknown
// components.
//
...
// MessageText:
//
// The object contains unsaved changes. The object data cannot be refreshed
// until you commit or discard the changes.
//
...
// MessageText:
//
// The specified IP address range is invalid. The start and end IP addresses
// must be valid and the start IP address must be less than or equal to the end
// IP address.
//
...
// MessageText:
//
// The specified service port range is invalid. The start port must be less than
// or equal to the end port, and both values must be between 1025 and 65536,
// inclusive.
//
...
// MessageText:
//
// The specified IP address is invalid. The IP address must be a well formed
...
// MessageText:
//
// The specified IPv4 address is not valid for multicast. IPv4 multicast
// addresses must be in the range 224.0.1.0 to 239.255.255.255.
//
...
// MessageText:
//
// The specified IPv6 address is not valid for multicast. IPv6 multicast
// addresses must start with FF (for example, FF15::FF).
//
...
// MessageText:
//
// The specified IPv6 multicast address source is invalid. Transport Server only
// supports using IPv6 multicast addresses from a range.
//
#define WDSTPTMGMT_E_INVALID_IPV6_MULTICAST_ADDRESS_SOURCE                     \
  ((HRESULT)0xC110011AL)
...
// MessageText:
//
// The specified multistream stream count is invalid. The stream count must be
...
// MessageText:
//
// The specified AutoDisconnect threshold is invalid. The threshold must be set
// to a value between 1 KBps and 4194303 KBps, inclusive.
//
...
// MessageText:
//
// You cannot configure the multicast session policy on this Transport Server.
// This policy is only supported on Windows Server 2008 R2 and later.
//
#define WDSTPTMGMT_E_MULTICAST_SESSION_POLICY_NOT_SUPPORTED                    \
  ((HRESULT)0xC110011DL)
...
// MessageText:
//
// This Windows Deployment Services Transport Server does not support network
// profiles.
//
...
// MessageText:
//
// The Windows Deployment Services Transport Server does not support UDP port
// policy.
//
...
// MessageText:
//
// The Windows Deployment Services Transport Server does not support the TFTP
// maximum block size setting.
//
...
// MessageText:
//
// The specified TFTP maximum block size is invalid. It must be either 0 or
// between 512 and 65531, inclusive.
//
