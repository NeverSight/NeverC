...
typedef VOID (*PAPPSTATE_CHANGE_ROUTINE)(_In_ BOOLEAN Quiesced,
                                         _In_ PVOID Context);
...
ULONG
NTAPI
RegisterAppStateChangeNotification(_In_ PAPPSTATE_CHANGE_ROUTINE Routine,
...
typedef VOID (*PAPPCONSTRAIN_CHANGE_ROUTINE)(_In_ BOOLEAN Constrained,
                                             _In_ PVOID Context);
...
RegisterAppConstrainedChangeNotification(
    _In_ PAPPCONSTRAIN_CHANGE_ROUTINE Routine, _In_opt_ PVOID Context,
    _Out_ PAPPCONSTRAIN_REGISTRATION *Registration);

APICONTRACT
VOID NTAPI UnregisterAppConstrainedChangeNotification(
