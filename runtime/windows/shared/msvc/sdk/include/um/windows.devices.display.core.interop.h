...
extern RPC_IF_HANDLE
    __MIDL_itf_windows2Edevices2Edisplay2Ecore2Einterop_0000_0000_v0_0_c_ifspec;
extern RPC_IF_HANDLE
    __MIDL_itf_windows2Edevices2Edisplay2Ecore2Einterop_0000_0000_v0_0_s_ifspec;
...
typedef struct IDisplayDeviceInteropVtbl {
  ...
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(IDisplayDeviceInterop *This,
                                             /* [in] */ REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(IDisplayDeviceInterop *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(IDisplayDeviceInterop *This);
...
#define IDisplayDeviceInterop_AddRef(This) ((This)->lpVtbl->AddRef(This))

#define IDisplayDeviceInterop_Release(This) ((This)->lpVtbl->Release(This))

#define IDisplayDeviceInterop_CreateSharedHandle(                              \
    This, pObject, pSecurityAttributes, Access, Name, pHandle)                 \
  ((This)->lpVtbl->CreateSharedHandle(This, pObject, pSecurityAttributes,      \
                                      Access, Name, pHandle))
...
typedef struct IDisplayPathInteropVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(IDisplayPathInterop *This,
                                             /* [in] */ REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(IDisplayPathInterop *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(IDisplayPathInterop *This);
  ...
  HRESULT(STDMETHODCALLTYPE *GetSourceId)(IDisplayPathInterop *This,
...
#define IDisplayPathInterop_AddRef(This) ((This)->lpVtbl->AddRef(This))

#define IDisplayPathInterop_Release(This) ((This)->lpVtbl->Release(This))
...
extern RPC_IF_HANDLE
    __MIDL_itf_windows2Edevices2Edisplay2Ecore2Einterop_0000_0002_v0_0_c_ifspec;
extern RPC_IF_HANDLE
    __MIDL_itf_windows2Edevices2Edisplay2Ecore2Einterop_0000_0002_v0_0_s_ifspec;
