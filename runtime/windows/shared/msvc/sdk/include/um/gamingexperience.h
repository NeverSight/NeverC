...
// Abstract:
//
//    This header file provides API function signatures for gaming experience
//    apps.
//
...
BOOL WINAPI IsGamingFullScreenExperienceSupported();

BOOL WINAPI IsGamingFullScreenExperienceActive();

BOOL WINAPI CanSetGamingFullScreenExperience();

HRESULT
WINAPI
SetGamingFullScreenExperience(_In_ BOOL active);

typedef VOID(CALLBACK *PGAMING_FULL_SCREEN_EXPERIENCE_CHANGE_ROUTINE)(
    _In_ PVOID context);
...
VOID WINAPI UnregisterGamingFullScreenExperienceChangeNotification(
