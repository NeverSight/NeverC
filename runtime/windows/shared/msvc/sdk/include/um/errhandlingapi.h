...
VOID WINAPI RaiseException(_In_ DWORD dwExceptionCode,
                           ...
                           _In_reads_opt_(nNumberOfArguments)
...
__callback WINBASEAPI LONG WINAPI
UnhandledExceptionFilter(_In_ struct _EXCEPTION_POINTERS *ExceptionInfo);
...
WINBASEAPI
_Check_return_ _Post_equals_last_error_ DWORD WINAPI GetLastError(VOID);
...
WINBASEAPI
_Ret_maybenull_ PVOID WINAPI AddVectoredContinueHandler(
    _In_ ULONG First, _In_ PVECTORED_EXCEPTION_HANDLER Handler);
...
WINBASEAPI
VOID WINAPI RaiseFailFastException(_In_opt_ PEXCEPTION_RECORD pExceptionRecord,
...
WINBASEAPI
VOID WINAPI FatalAppExitW(_In_ UINT uAction, _In_ LPCWSTR lpMessageText);
...
WINBASEAPI
BOOL WINAPI SetThreadErrorMode(_In_ DWORD dwNewMode,
...
WINBASEAPI
VOID WINAPI
TerminateProcessOnMemoryExhaustion(_In_ SIZE_T FailedAllocationSize);
