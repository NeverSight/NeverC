...
typedef interface IDeviceRequestCompletionCallback
...
STDAPI
CreateDeviceAccessInstance(_In_ PCWSTR deviceInterfacePath,
                           _In_ DWORD desiredAccess,
                           _COM_Outptr_ ICreateDeviceAccessAsync **createAsync);
#endif
EXTERN_GUID(CLSID_DeviceIoControl, 0x12d3e372, 0x874b, 0x457d, 0x9f, 0xdf, 0x73,
            0x97, 0x77, 0x78, 0x68, 0x6c);
...
#define IDeviceRequestCompletionCallback_RequestCompletion(                    \
    This, requestResult, bytesReturned)                                        \
...
typedef struct IDeviceIoControlVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(IDeviceIoControl *This,
                                             /* [in] */ REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(IDeviceIoControl *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(IDeviceIoControl *This);
  ...
  HRESULT(STDMETHODCALLTYPE *CancelOperation)(IDeviceIoControl *This,
                                              /* [annotation][in] */
...
interface IDeviceIoControl { CONST_VTBL struct IDeviceIoControlVtbl *lpVtbl; };
...
#define IDeviceIoControl_AddRef(This) ((This)->lpVtbl->AddRef(This))

#define IDeviceIoControl_Release(This) ((This)->lpVtbl->Release(This))

#define IDeviceIoControl_DeviceIoControlSync(This, ioControlCode, inputBuffer, \
                                             inputBufferSize, outputBuffer,    \
                                             outputBufferSize, bytesReturned)  \
  ((This)->lpVtbl->DeviceIoControlSync(This, ioControlCode, inputBuffer,       \
                                       inputBufferSize, outputBuffer,          \
                                       outputBufferSize, bytesReturned))

#define IDeviceIoControl_DeviceIoControlAsync(                                 \
    This, ioControlCode, inputBuffer, inputBufferSize, outputBuffer,           \
    outputBufferSize, requestCompletionCallback, cancelContext)                \
  ((This)->lpVtbl->DeviceIoControlAsync(                                       \
      This, ioControlCode, inputBuffer, inputBufferSize, outputBuffer,         \
      outputBufferSize, requestCompletionCallback, cancelContext))
...
typedef struct ICreateDeviceAccessAsyncVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(ICreateDeviceAccessAsync *This,
                                             /* [in] */ REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(ICreateDeviceAccessAsync *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(ICreateDeviceAccessAsync *This);

  DECLSPEC_XFGVIRT(ICreateDeviceAccessAsync, Cancel)
  HRESULT(STDMETHODCALLTYPE *Cancel)(ICreateDeviceAccessAsync *This);

  DECLSPEC_XFGVIRT(ICreateDeviceAccessAsync, Wait)
  HRESULT(STDMETHODCALLTYPE *Wait)(ICreateDeviceAccessAsync *This,
                                   /* [annotation][in] */
                                   _In_ DWORD timeout);

  DECLSPEC_XFGVIRT(ICreateDeviceAccessAsync, Close)
  HRESULT(STDMETHODCALLTYPE *Close)(ICreateDeviceAccessAsync *This);

  DECLSPEC_XFGVIRT(ICreateDeviceAccessAsync, GetResult)
  HRESULT(STDMETHODCALLTYPE *GetResult)(ICreateDeviceAccessAsync *This,
                                        /* [annotation][in] */
                                        _In_ REFIID riid,
                                        /* [annotation][out] */
...
#define ICreateDeviceAccessAsync_AddRef(This) ((This)->lpVtbl->AddRef(This))

#define ICreateDeviceAccessAsync_Release(This) ((This)->lpVtbl->Release(This))

#define ICreateDeviceAccessAsync_Cancel(This) ((This)->lpVtbl->Cancel(This))

#define ICreateDeviceAccessAsync_Wait(This, timeout)                           \
  ((This)->lpVtbl->Wait(This, timeout))

#define ICreateDeviceAccessAsync_Close(This) ((This)->lpVtbl->Close(This))
