...
WINUSERAPI
int WINAPI wvsprintfA(_Out_ LPSTR, _In_ _Printf_format_string_ LPCSTR,
                      _In_ va_list arglist);
WINUSERAPI
int WINAPI wvsprintfW(_Out_ LPWSTR, _In_ _Printf_format_string_ LPCWSTR,
                      _In_ va_list arglist);
#ifdef UNICODE
...
WINUSERAPI
HKL WINAPI LoadKeyboardLayoutA(_In_ LPCSTR pwszKLID, _In_ UINT Flags);
WINUSERAPI
HKL WINAPI LoadKeyboardLayoutW(_In_ LPCWSTR pwszKLID, _In_ UINT Flags);
#ifdef UNICODE
...
#else
WINUSERAPI
BOOL WINAPI ActivateKeyboardLayout(_In_ HKL hkl, _In_ UINT Flags);
#endif /* WINVER >= 0x0400 */

#if (WINVER >= 0x0400)
WINUSERAPI
int WINAPI ToUnicodeEx(_In_ UINT wVirtKey, _In_ UINT wScanCode,
                       _In_reads_bytes_(256) CONST BYTE *lpKeyState,
                       _Out_writes_(cchBuff) LPWSTR pwszBuff, _In_ int cchBuff,
                       _In_ UINT wFlags, _In_opt_ HKL dwhkl);
#endif /* WINVER >= 0x0400 */
...
WINUSERAPI
BOOL WINAPI GetKeyboardLayoutNameA(_Out_writes_(KL_NAMELENGTH) LPSTR pwszKLID);
WINUSERAPI
BOOL WINAPI GetKeyboardLayoutNameW(_Out_writes_(KL_NAMELENGTH) LPWSTR pwszKLID);
#ifdef UNICODE
...
#if (WINVER >= 0x0400)
WINUSERAPI
int WINAPI GetKeyboardLayoutList(_In_ int nBuff,
                                 _Out_writes_to_opt_(nBuff, return)
                                     HKL FAR *lpList);
...
WINUSERAPI
int WINAPI GetMouseMovePointsEx(_In_ UINT cbSize, _In_ LPMOUSEMOVEPOINT lppt,
                                _Out_writes_(nBufPoints)
                                    LPMOUSEMOVEPOINT lpptBuf,
                                _In_ int nBufPoints, _In_ DWORD resolution);
...
HDESK
WINAPI
CreateDesktopA(_In_ LPCSTR lpszDesktop, _Reserved_ LPCSTR lpszDevice,
               _Reserved_ DEVMODEA *pDevmode, _In_ DWORD dwFlags,
               _In_ ACCESS_MASK dwDesiredAccess,
               _In_opt_ LPSECURITY_ATTRIBUTES lpsa);
WINUSERAPI
HDESK
WINAPI
CreateDesktopW(_In_ LPCWSTR lpszDesktop, _Reserved_ LPCWSTR lpszDevice,
               _Reserved_ DEVMODEW *pDevmode, _In_ DWORD dwFlags,
               _In_ ACCESS_MASK dwDesiredAccess,
               _In_opt_ LPSECURITY_ATTRIBUTES lpsa);
#ifdef UNICODE
...
HDESK
WINAPI
CreateDesktopExA(_In_ LPCSTR lpszDesktop, _Reserved_ LPCSTR lpszDevice,
                 _Reserved_ DEVMODEA *pDevmode, _In_ DWORD dwFlags,
                 _In_ ACCESS_MASK dwDesiredAccess,
                 _In_opt_ LPSECURITY_ATTRIBUTES lpsa, _In_ ULONG ulHeapSize,
                 _Reserved_ PVOID pvoid);
WINUSERAPI
HDESK
WINAPI
CreateDesktopExW(_In_ LPCWSTR lpszDesktop, _Reserved_ LPCWSTR lpszDevice,
                 _Reserved_ DEVMODEW *pDevmode, _In_ DWORD dwFlags,
                 _In_ ACCESS_MASK dwDesiredAccess,
                 _In_opt_ LPSECURITY_ATTRIBUTES lpsa, _In_ ULONG ulHeapSize,
                 _Reserved_ PVOID pvoid);
...
HDESK
WINAPI
OpenDesktopA(_In_ LPCSTR lpszDesktop, _In_ DWORD dwFlags, _In_ BOOL fInherit,
             _In_ ACCESS_MASK dwDesiredAccess);
WINUSERAPI
HDESK
WINAPI
OpenDesktopW(_In_ LPCWSTR lpszDesktop, _In_ DWORD dwFlags, _In_ BOOL fInherit,
             _In_ ACCESS_MASK dwDesiredAccess);
#ifdef UNICODE
...
HDESK
WINAPI
OpenInputDesktop(_In_ DWORD dwFlags, _In_ BOOL fInherit,
                 _In_ ACCESS_MASK dwDesiredAccess);

WINUSERAPI
BOOL WINAPI EnumDesktopsA(_In_opt_ HWINSTA hwinsta,
                          _In_ DESKTOPENUMPROCA lpEnumFunc, _In_ LPARAM lParam);
WINUSERAPI
BOOL WINAPI EnumDesktopsW(_In_opt_ HWINSTA hwinsta,
                          _In_ DESKTOPENUMPROCW lpEnumFunc, _In_ LPARAM lParam);
#ifdef UNICODE
...
WINUSERAPI
BOOL WINAPI EnumDesktopWindows(_In_opt_ HDESK hDesktop, _In_ WNDENUMPROC lpfn,
                               _In_ LPARAM lParam);
...
HDESK
WINAPI
GetThreadDesktop(_In_ DWORD dwThreadId);
...
HWINSTA
WINAPI
CreateWindowStationA(_In_opt_ LPCSTR lpwinsta, _In_ DWORD dwFlags,
                     _In_ ACCESS_MASK dwDesiredAccess,
                     _In_opt_ LPSECURITY_ATTRIBUTES lpsa);
WINUSERAPI
HWINSTA
WINAPI
CreateWindowStationW(_In_opt_ LPCWSTR lpwinsta, _In_ DWORD dwFlags,
                     _In_ ACCESS_MASK dwDesiredAccess,
                     _In_opt_ LPSECURITY_ATTRIBUTES lpsa);
#ifdef UNICODE
...
HWINSTA
WINAPI
OpenWindowStationA(_In_ LPCSTR lpszWinSta, _In_ BOOL fInherit,
                   _In_ ACCESS_MASK dwDesiredAccess);
WINUSERAPI
HWINSTA
WINAPI
OpenWindowStationW(_In_ LPCWSTR lpszWinSta, _In_ BOOL fInherit,
                   _In_ ACCESS_MASK dwDesiredAccess);
#ifdef UNICODE
...
WINUSERAPI
BOOL WINAPI EnumWindowStationsA(_In_ WINSTAENUMPROCA lpEnumFunc,
                                _In_ LPARAM lParam);
WINUSERAPI
BOOL WINAPI EnumWindowStationsW(_In_ WINSTAENUMPROCW lpEnumFunc,
                                _In_ LPARAM lParam);
#ifdef UNICODE
...
WINUSERAPI
BOOL WINAPI SetUserObjectSecurity(_In_ HANDLE hObj,
                                  _In_ PSECURITY_INFORMATION pSIRequested,
                                  _In_ PSECURITY_DESCRIPTOR pSID);

WINUSERAPI
BOOL WINAPI GetUserObjectSecurity(_In_ HANDLE hObj,
                                  _In_ PSECURITY_INFORMATION pSIRequested,
                                  _Out_writes_bytes_opt_(nLength)
...
WINUSERAPI
BOOL WINAPI GetUserObjectInformationA(_In_ HANDLE hObj, _In_ int nIndex,
                                      _Out_writes_bytes_opt_(nLength)
                                          PVOID pvInfo,
                                      _In_ DWORD nLength,
                                      _Out_opt_ LPDWORD lpnLengthNeeded);
WINUSERAPI
BOOL WINAPI GetUserObjectInformationW(_In_ HANDLE hObj, _In_ int nIndex,
                                      _Out_writes_bytes_opt_(nLength)
                                          PVOID pvInfo,
                                      _In_ DWORD nLength,
                                      _Out_opt_ LPDWORD lpnLengthNeeded);
...
WINUSERAPI
BOOL WINAPI SetUserObjectInformationA(_In_ HANDLE hObj, _In_ int nIndex,
                                      _In_reads_bytes_(nLength) PVOID pvInfo,
                                      _In_ DWORD nLength);
WINUSERAPI
BOOL WINAPI SetUserObjectInformationW(_In_ HANDLE hObj, _In_ int nIndex,
                                      _In_reads_bytes_(nLength) PVOID pvInfo,
                                      _In_ DWORD nLength);
#ifdef UNICODE
...
#define WS_EX_NOINHERITLAYOUT                                                  \
  0x00100000L // Disable inheritence of mirroring by children
#endif        /* WINVER >= 0x0500 */
...
WINUSERAPI
BOOL WINAPI DrawEdge(_In_ HDC hdc, _Inout_ LPRECT qrc, _In_ UINT edge,
                     _In_ UINT grfFlags);
...
WINUSERAPI
BOOL WINAPI DrawFrameControl(HDC hdc, _Inout_ LPRECT lprc, UINT uType,
                             UINT uState);
...
WINUSERAPI
BOOL WINAPI DrawCaption(_In_ HWND hwnd, _In_ HDC hdc, _In_ CONST RECT *lprect,
                        _In_ UINT flags);
...
WINUSERAPI
BOOL WINAPI DrawAnimatedRects(_In_opt_ HWND hwnd, _In_ int idAni,
...
WINUSERAPI
BOOL WINAPI GetMessageA(_Out_ LPMSG lpMsg, _In_opt_ HWND hWnd,
                        _In_ UINT wMsgFilterMin, _In_ UINT wMsgFilterMax);
WINUSERAPI
BOOL WINAPI GetMessageW(_Out_ LPMSG lpMsg, _In_opt_ HWND hWnd,
                        _In_ UINT wMsgFilterMin, _In_ UINT wMsgFilterMax);
#ifdef UNICODE
...
#if defined(_M_CEE)
#undef GetMessage
__inline BOOL GetMessage(LPMSG lpMsg, HWND hWnd, UINT wMsgFilterMin,
                         UINT wMsgFilterMax) {
#ifdef UNICODE
  return GetMessageW(
#else
...
LRESULT
WINAPI
DispatchMessageA(_In_ CONST MSG *lpMsg);
WINUSERAPI
LRESULT
WINAPI
DispatchMessageW(_In_ CONST MSG *lpMsg);
#ifdef UNICODE
...
WINUSERAPI
BOOL WINAPI SetMessageQueue(_In_ int cMessagesMax);
...
WINUSERAPI
BOOL WINAPI PeekMessageA(_Out_ LPMSG lpMsg, _In_opt_ HWND hWnd,
                         _In_ UINT wMsgFilterMin, _In_ UINT wMsgFilterMax,
...
WINUSERAPI
BOOL WINAPI RegisterHotKey(_In_opt_ HWND hWnd, _In_ int id,
                           _In_ UINT fsModifiers, _In_ UINT vk);
...
LPARAM
WINAPI
SetMessageExtraInfo(_In_ LPARAM lParam);
#endif /* WINVER >= 0x0400 */
...
LRESULT
WINAPI
SendMessageA(_In_ HWND hWnd, _In_ UINT Msg,
             _Pre_maybenull_ _Post_valid_ WPARAM wParam,
             _Pre_maybenull_ _Post_valid_ LPARAM lParam);
WINUSERAPI
LRESULT
WINAPI
SendMessageW(_In_ HWND hWnd, _In_ UINT Msg,
             _Pre_maybenull_ _Post_valid_ WPARAM wParam,
             _Pre_maybenull_ _Post_valid_ LPARAM lParam);
#ifdef UNICODE
...
#if defined(_M_CEE)
#undef SendMessage
__inline LRESULT SendMessage(HWND hWnd, UINT Msg, WPARAM wParam,
                             LPARAM lParam) {
#ifdef UNICODE
  return SendMessageW(
#else
...
LRESULT
WINAPI
SendMessageTimeoutA(_In_ HWND hWnd, _In_ UINT Msg, _In_ WPARAM wParam,
                    _In_ LPARAM lParam, _In_ UINT fuFlags, _In_ UINT uTimeout,
                    _Out_opt_ PDWORD_PTR lpdwResult);
WINUSERAPI
LRESULT
WINAPI
SendMessageTimeoutW(_In_ HWND hWnd, _In_ UINT Msg, _In_ WPARAM wParam,
                    _In_ LPARAM lParam, _In_ UINT fuFlags, _In_ UINT uTimeout,
                    _Out_opt_ PDWORD_PTR lpdwResult);
#ifdef UNICODE
...
WINUSERAPI
BOOL WINAPI SendNotifyMessageA(_In_ HWND hWnd, _In_ UINT Msg,
                               _In_ WPARAM wParam, _In_ LPARAM lParam);
WINUSERAPI
BOOL WINAPI SendNotifyMessageW(_In_ HWND hWnd, _In_ UINT Msg,
                               _In_ WPARAM wParam, _In_ LPARAM lParam);
#ifdef UNICODE
...
WINUSERAPI
BOOL WINAPI SendMessageCallbackA(_In_ HWND hWnd, _In_ UINT Msg,
                                 _In_ WPARAM wParam, _In_ LPARAM lParam,
                                 _In_ SENDASYNCPROC lpResultCallBack,
                                 _In_ ULONG_PTR dwData);
WINUSERAPI
BOOL WINAPI SendMessageCallbackW(_In_ HWND hWnd, _In_ UINT Msg,
                                 _In_ WPARAM wParam, _In_ LPARAM lParam,
                                 _In_ SENDASYNCPROC lpResultCallBack,
                                 _In_ ULONG_PTR dwData);
#ifdef UNICODE
...
WINUSERAPI
long WINAPI BroadcastSystemMessageExA(_In_ DWORD flags,
                                      _Inout_opt_ LPDWORD lpInfo, _In_ UINT Msg,
                                      _In_ WPARAM wParam, _In_ LPARAM lParam,
                                      _Out_opt_ PBSMINFO pbsmInfo);
WINUSERAPI
long WINAPI BroadcastSystemMessageExW(_In_ DWORD flags,
                                      _Inout_opt_ LPDWORD lpInfo, _In_ UINT Msg,
                                      _In_ WPARAM wParam, _In_ LPARAM lParam,
                                      _Out_opt_ PBSMINFO pbsmInfo);
#ifdef UNICODE
...
WINUSERAPI
long WINAPI BroadcastSystemMessageA(_In_ DWORD flags,
                                    _Inout_opt_ LPDWORD lpInfo, _In_ UINT Msg,
                                    _In_ WPARAM wParam, _In_ LPARAM lParam);
WINUSERAPI
long WINAPI BroadcastSystemMessageW(_In_ DWORD flags,
                                    _Inout_opt_ LPDWORD lpInfo, _In_ UINT Msg,
                                    _In_ WPARAM wParam, _In_ LPARAM lParam);
#ifdef UNICODE
...
WINUSERAPI
long WINAPI BroadcastSystemMessage(_In_ DWORD flags, _Inout_opt_ LPDWORD lpInfo,
                                   _In_ UINT Msg, _In_ WPARAM wParam,
                                   _In_ LPARAM lParam);
...
HDEVNOTIFY
WINAPI
RegisterDeviceNotificationA(_In_ HANDLE hRecipient,
                            _In_ LPVOID NotificationFilter, _In_ DWORD Flags);
WINUSERAPI
HDEVNOTIFY
WINAPI
RegisterDeviceNotificationW(_In_ HANDLE hRecipient,
                            _In_ LPVOID NotificationFilter, _In_ DWORD Flags);
#ifdef UNICODE
...
HPOWERNOTIFY
WINAPI
RegisterPowerSettingNotification(IN HANDLE hRecipient,
                                 IN LPCGUID PowerSettingGuid, IN DWORD Flags);

WINUSERAPI
BOOL WINAPI UnregisterPowerSettingNotification(IN HPOWERNOTIFY Handle);
...
WINUSERAPI
BOOL WINAPI UnregisterSuspendResumeNotification(IN HPOWERNOTIFY Handle);
...
WINUSERAPI
BOOL WINAPI PostMessageA(_In_opt_ HWND hWnd, _In_ UINT Msg, _In_ WPARAM wParam,
                         _In_ LPARAM lParam);
WINUSERAPI
BOOL WINAPI PostMessageW(_In_opt_ HWND hWnd, _In_ UINT Msg, _In_ WPARAM wParam,
                         _In_ LPARAM lParam);
#ifdef UNICODE
...
WINUSERAPI
BOOL WINAPI PostThreadMessageA(_In_ DWORD idThread, _In_ UINT Msg,
                               _In_ WPARAM wParam, _In_ LPARAM lParam);
WINUSERAPI
BOOL WINAPI PostThreadMessageW(_In_ DWORD idThread, _In_ UINT Msg,
                               _In_ WPARAM wParam, _In_ LPARAM lParam);
#ifdef UNICODE
...
DWORD
WINAPI
WaitForInputIdle(_In_ HANDLE hProcess, _In_ DWORD dwMilliseconds);
...
CALLBACK
#endif
DefWindowProcA(_In_ HWND hWnd, _In_ UINT Msg, _In_ WPARAM wParam,
               _In_ LPARAM lParam);
WINUSERAPI
#ifndef _MAC
LRESULT
...
CALLBACK
#endif
DefWindowProcW(_In_ HWND hWnd, _In_ UINT Msg, _In_ WPARAM wParam,
               _In_ LPARAM lParam);
#ifdef UNICODE
...
LRESULT
WINAPI
CallWindowProcA(_In_ WNDPROC lpPrevWndFunc, _In_ HWND hWnd, _In_ UINT Msg,
                _In_ WPARAM wParam, _In_ LPARAM lParam);
WINUSERAPI
LRESULT
WINAPI
CallWindowProcW(_In_ WNDPROC lpPrevWndFunc, _In_ HWND hWnd, _In_ UINT Msg,
                _In_ WPARAM wParam, _In_ LPARAM lParam);
#ifdef UNICODE
...
LRESULT
WINAPI
CallWindowProcA(_In_ FARPROC lpPrevWndFunc, _In_ HWND hWnd, _In_ UINT Msg,
                _In_ WPARAM wParam, _In_ LPARAM lParam);
WINUSERAPI
LRESULT
WINAPI
CallWindowProcW(_In_ FARPROC lpPrevWndFunc, _In_ HWND hWnd, _In_ UINT Msg,
                _In_ WPARAM wParam, _In_ LPARAM lParam);
#ifdef UNICODE
#define CallWindowProc CallWindowProcW
#else
...
DWORD
WINAPI
InSendMessageEx(_Reserved_ LPVOID lpReserved);
...
WINUSERAPI
BOOL WINAPI UnregisterClassA(_In_ LPCSTR lpClassName,
                             _In_opt_ HINSTANCE hInstance);
WINUSERAPI
BOOL WINAPI UnregisterClassW(_In_ LPCWSTR lpClassName,
                             _In_opt_ HINSTANCE hInstance);
#ifdef UNICODE
...
_Success_(return) WINUSERAPI BOOL WINAPI
    GetClassInfoA(_In_opt_ HINSTANCE hInstance, _In_ LPCSTR lpClassName,
                  _Out_ LPWNDCLASSA lpWndClass);
_Success_(return) WINUSERAPI BOOL WINAPI
    GetClassInfoW(_In_opt_ HINSTANCE hInstance, _In_ LPCWSTR lpClassName,
...
_Success_(return) WINUSERAPI BOOL WINAPI
    GetClassInfoExA(_In_opt_ HINSTANCE hInstance, _In_ LPCSTR lpszClass,
                    _Out_ LPWNDCLASSEXA lpwcx);
_Success_(return) WINUSERAPI BOOL WINAPI
    GetClassInfoExW(_In_opt_ HINSTANCE hInstance, _In_ LPCWSTR lpszClass,
...
#if (WINVER >= 0x0500)
WINUSERAPI
BOOL WINAPI AnimateWindow(_In_ HWND hWnd, _In_ DWORD dwTime,
                          _In_ DWORD dwFlags);
#endif /* WINVER >= 0x0500 */
...
WINUSERAPI
BOOL WINAPI UpdateLayeredWindow(_In_ HWND hWnd, _In_opt_ HDC hdcDst,
                                _In_opt_ POINT *pptDst, _In_opt_ SIZE *psize,
                                _In_opt_ HDC hdcSrc, _In_opt_ POINT *pptSrc,
                                _In_ COLORREF crKey,
...
typedef
    ...
    WINUSERAPI BOOL WINAPI UpdateLayeredWindowIndirect(
        _In_ HWND hWnd, _In_ const UPDATELAYEREDWINDOWINFO *pULWInfo);
...
WINUSERAPI
BOOL WINAPI GetLayeredWindowAttributes(_In_ HWND hwnd,
...
WINUSERAPI
BOOL WINAPI PrintWindow(_In_ HWND hwnd, _In_ HDC hdcBlt, _In_ UINT nFlags);
...
WINUSERAPI
BOOL WINAPI SetLayeredWindowAttributes(_In_ HWND hwnd, _In_ COLORREF crKey,
                                       _In_ BYTE bAlpha, _In_ DWORD dwFlags);
...
WINUSERAPI
BOOL WINAPI MoveWindow(_In_ HWND hWnd, _In_ int X, _In_ int Y, _In_ int nWidth,
                       _In_ int nHeight, _In_ BOOL bRepaint);

WINUSERAPI
BOOL WINAPI SetWindowPos(_In_ HWND hWnd, _In_opt_ HWND hWndInsertAfter,
                         _In_ int X, _In_ int Y, _In_ int cx, _In_ int cy,
                         _In_ UINT uFlags);
...
WINUSERAPI
BOOL WINAPI GetWindowPlacement(_In_ HWND hWnd,
                               _Inout_ WINDOWPLACEMENT *lpwndpl);

WINUSERAPI
BOOL WINAPI SetWindowPlacement(_In_ HWND hWnd,
...
WINUSERAPI
BOOL WINAPI GetWindowDisplayAffinity(_In_ HWND hWnd, _Out_ DWORD *pdwAffinity);
...
WINUSERAPI
HDWP WINAPI DeferWindowPos(_In_ HDWP hWinPosInfo, _In_ HWND hWnd,
                           _In_opt_ HWND hWndInsertAfter, _In_ int x,
                           _In_ int y, _In_ int cx, _In_ int cy,
                           _In_ UINT uFlags);
...
WINUSERAPI
HWND WINAPI CreateDialogParamA(_In_opt_ HINSTANCE hInstance,
                               _In_ LPCSTR lpTemplateName,
                               _In_opt_ HWND hWndParent,
                               _In_opt_ DLGPROC lpDialogFunc,
                               _In_ LPARAM dwInitParam);
WINUSERAPI
HWND WINAPI CreateDialogParamW(_In_opt_ HINSTANCE hInstance,
...
WINUSERAPI
HWND WINAPI CreateDialogIndirectParamA(_In_opt_ HINSTANCE hInstance,
                                       _In_ LPCDLGTEMPLATEA lpTemplate,
                                       _In_opt_ HWND hWndParent,
                                       _In_opt_ DLGPROC lpDialogFunc,
                                       _In_ LPARAM dwInitParam);
WINUSERAPI
HWND WINAPI CreateDialogIndirectParamW(_In_opt_ HINSTANCE hInstance,
...
INT_PTR
WINAPI
DialogBoxParamA(_In_opt_ HINSTANCE hInstance, _In_ LPCSTR lpTemplateName,
                _In_opt_ HWND hWndParent, _In_opt_ DLGPROC lpDialogFunc,
                _In_ LPARAM dwInitParam);
WINUSERAPI
INT_PTR
WINAPI
DialogBoxParamW(_In_opt_ HINSTANCE hInstance, _In_ LPCWSTR lpTemplateName,
                _In_opt_ HWND hWndParent, _In_opt_ DLGPROC lpDialogFunc,
                _In_ LPARAM dwInitParam);
#ifdef UNICODE
...
INT_PTR
WINAPI
DialogBoxIndirectParamA(_In_opt_ HINSTANCE hInstance,
...
INT_PTR
WINAPI
DialogBoxIndirectParamW(_In_opt_ HINSTANCE hInstance,
...
WINUSERAPI
BOOL WINAPI SetDlgItemInt(_In_ HWND hDlg, _In_ int nIDDlgItem, _In_ UINT uValue,
                          _In_ BOOL bSigned);

WINUSERAPI
UINT WINAPI GetDlgItemInt(_In_ HWND hDlg, _In_ int nIDDlgItem,
                          _Out_opt_ BOOL *lpTranslated, _In_ BOOL bSigned);

WINUSERAPI
BOOL WINAPI SetDlgItemTextA(_In_ HWND hDlg, _In_ int nIDDlgItem,
                            _In_ LPCSTR lpString);
WINUSERAPI
BOOL WINAPI SetDlgItemTextW(_In_ HWND hDlg, _In_ int nIDDlgItem,
...
_Ret_range_(0, cchMax) WINUSERAPI UINT WINAPI
    GetDlgItemTextA(_In_ HWND hDlg, _In_ int nIDDlgItem,
                    _Out_writes_(cchMax) LPSTR lpString, _In_ int cchMax);
_Ret_range_(0, cchMax) WINUSERAPI UINT WINAPI
    GetDlgItemTextW(_In_ HWND hDlg, _In_ int nIDDlgItem,
                    _Out_writes_(cchMax) LPWSTR lpString, _In_ int cchMax);
#ifdef UNICODE
...
WINUSERAPI
BOOL WINAPI CheckDlgButton(_In_ HWND hDlg, _In_ int nIDButton,
                           _In_ UINT uCheck);

WINUSERAPI
BOOL WINAPI CheckRadioButton(_In_ HWND hDlg, _In_ int nIDFirstButton,
                             _In_ int nIDLastButton, _In_ int nIDCheckButton);

WINUSERAPI
UINT WINAPI IsDlgButtonChecked(_In_ HWND hDlg, _In_ int nIDButton);

WINUSERAPI
LRESULT
WINAPI
SendDlgItemMessageA(_In_ HWND hDlg, _In_ int nIDDlgItem, _In_ UINT Msg,
                    _In_ WPARAM wParam, _In_ LPARAM lParam);
WINUSERAPI
LRESULT
WINAPI
SendDlgItemMessageW(_In_ HWND hDlg, _In_ int nIDDlgItem, _In_ UINT Msg,
                    _In_ WPARAM wParam, _In_ LPARAM lParam);
#ifdef UNICODE
...
WINUSERAPI
HWND WINAPI GetNextDlgGroupItem(_In_ HWND hDlg, _In_opt_ HWND hCtl,
                                _In_ BOOL bPrevious);

WINUSERAPI
HWND WINAPI GetNextDlgTabItem(_In_ HWND hDlg, _In_opt_ HWND hCtl,
                              _In_ BOOL bPrevious);

WINUSERAPI
int WINAPI GetDlgCtrlID(_In_ HWND hWnd);
...
CALLBACK
#endif
DefDlgProcA(_In_ HWND hDlg, _In_ UINT Msg, _In_ WPARAM wParam,
            _In_ LPARAM lParam);
WINUSERAPI
#ifndef _MAC
LRESULT
...
CALLBACK
#endif
DefDlgProcW(_In_ HWND hDlg, _In_ UINT Msg, _In_ WPARAM wParam,
            _In_ LPARAM lParam);
#ifdef UNICODE
...
BOOL WINAPI SetDialogControlDpiChangeBehavior(
    _In_ HWND hWnd, _In_ DIALOG_CONTROL_DPI_CHANGE_BEHAVIORS mask,
    _In_ DIALOG_CONTROL_DPI_CHANGE_BEHAVIORS values);

DIALOG_CONTROL_DPI_CHANGE_BEHAVIORS
WINAPI
GetDialogControlDpiChangeBehavior(_In_ HWND hWnd);
...
BOOL WINAPI SetDialogDpiChangeBehavior(_In_ HWND hDlg,
                                       _In_ DIALOG_DPI_CHANGE_BEHAVIORS mask,
                                       _In_ DIALOG_DPI_CHANGE_BEHAVIORS values);

DIALOG_DPI_CHANGE_BEHAVIORS
WINAPI
GetDialogDpiChangeBehavior(_In_ HWND hDlg);
...
WINUSERAPI
BOOL WINAPI CallMsgFilterA(_In_ LPMSG lpMsg, _In_ int nCode);
WINUSERAPI
BOOL WINAPI CallMsgFilterW(_In_ LPMSG lpMsg, _In_ int nCode);
#ifdef UNICODE
...
typedef struct tagGETCLIPBMETADATA {
  ...
  BOOL IsSynthetic; // Indicates if the data is produced on-demand from another
                    // format (some bitmap/text/metafile).

} GETCLIPBMETADATA, *PGETCLIPBMETADATA;

WINUSERAPI
BOOL WINAPI GetClipboardMetadata(UINT format,
...
WINUSERAPI
int WINAPI GetClipboardFormatNameA(_In_ UINT format,
                                   _Out_writes_(cchMaxCount)
                                       LPSTR lpszFormatName,
                                   _In_ int cchMaxCount);
WINUSERAPI
int WINAPI GetClipboardFormatNameW(_In_ UINT format,
                                   _Out_writes_(cchMaxCount)
...
WINUSERAPI
int WINAPI GetPriorityClipboardFormat(_In_reads_(cFormats)
...
WINUSERAPI
BOOL WINAPI GetUpdatedClipboardFormats(_Out_writes_(cFormats) PUINT lpuiFormats,
                                       _In_ UINT cFormats,
...
WINUSERAPI
BOOL WINAPI CharToOemA(_In_ LPCSTR pSrc,
                       _Out_writes_(_Inexpressible_(strlen(pSrc) + 1))
                           LPSTR pDst);
WINUSERAPI
BOOL WINAPI CharToOemW(_In_ LPCWSTR pSrc,
                       _Out_writes_(_Inexpressible_(strlen(pSrc) + 1))
                           LPSTR pDst);
#ifdef UNICODE
...
__drv_preferredFunction("OemToCharBuff",
                        "Does not validate buffer size") WINUSERAPI BOOL WINAPI
    OemToCharA(_In_ LPCSTR pSrc,
               _Out_writes_(_Inexpressible_(strlen(pSrc) + 1)) LPSTR pDst);
__drv_preferredFunction("OemToCharBuff",
                        "Does not validate buffer size") WINUSERAPI BOOL WINAPI
    OemToCharW(_In_ LPCSTR pSrc,
...
WINUSERAPI
BOOL WINAPI CharToOemBuffA(_In_ LPCSTR lpszSrc,
                           _Out_writes_(cchDstLength) LPSTR lpszDst,
                           _In_ DWORD cchDstLength);
WINUSERAPI
BOOL WINAPI CharToOemBuffW(_In_ LPCWSTR lpszSrc,
                           _Out_writes_(cchDstLength) LPSTR lpszDst,
                           _In_ DWORD cchDstLength);
#ifdef UNICODE
...
WINUSERAPI
BOOL WINAPI OemToCharBuffA(_In_ LPCSTR lpszSrc,
                           _Out_writes_(cchDstLength) LPSTR lpszDst,
                           _In_ DWORD cchDstLength);
WINUSERAPI
BOOL WINAPI OemToCharBuffW(_In_ LPCSTR lpszSrc,
...
LPSTR
WINAPI
CharUpperA(_Inout_ LPSTR lpsz);
WINUSERAPI
LPWSTR
WINAPI
CharUpperW(_Inout_ LPWSTR lpsz);
#ifdef UNICODE
...
DWORD
WINAPI
CharUpperBuffA(_Inout_updates_(cchLength) LPSTR lpsz, _In_ DWORD cchLength);
WINUSERAPI
DWORD
WINAPI
CharUpperBuffW(_Inout_updates_(cchLength) LPWSTR lpsz, _In_ DWORD cchLength);
#ifdef UNICODE
...
LPSTR
WINAPI
CharLowerA(_Inout_ LPSTR lpsz);
WINUSERAPI
LPWSTR
WINAPI
CharLowerW(_Inout_ LPWSTR lpsz);
#ifdef UNICODE
...
DWORD
WINAPI
CharLowerBuffA(_Inout_updates_(cchLength) LPSTR lpsz, _In_ DWORD cchLength);
WINUSERAPI
DWORD
WINAPI
CharLowerBuffW(_Inout_updates_(cchLength) LPWSTR lpsz, _In_ DWORD cchLength);
#ifdef UNICODE
...
LPSTR
WINAPI
CharNextA(_In_ LPCSTR lpsz);
WINUSERAPI
LPWSTR
WINAPI
CharNextW(_In_ LPCWSTR lpsz);
#ifdef UNICODE
...
LPSTR
WINAPI
CharPrevA(_In_ LPCSTR lpszStart, _In_ LPCSTR lpszCurrent);
WINUSERAPI
LPWSTR
WINAPI
CharPrevW(_In_ LPCWSTR lpszStart, _In_ LPCWSTR lpszCurrent);
#ifdef UNICODE
...
LPSTR
WINAPI
CharNextExA(_In_ WORD CodePage, _In_ LPCSTR lpCurrentChar, _In_ DWORD dwFlags);

WINUSERAPI
LPSTR
WINAPI
CharPrevExA(_In_ WORD CodePage, _In_ LPCSTR lpStart, _In_ LPCSTR lpCurrentChar,
            _In_ DWORD dwFlags);
#endif /* WINVER >= 0x0400 */
...
WINUSERAPI
BOOL WINAPI IsCharAlphaW(_In_ WCHAR ch);
#ifdef UNICODE
...
WINUSERAPI
BOOL WINAPI IsCharAlphaNumericA(_In_ CHAR ch);
WINUSERAPI
BOOL WINAPI IsCharAlphaNumericW(_In_ WCHAR ch);
#ifdef UNICODE
...
WINUSERAPI
BOOL WINAPI IsCharUpperA(_In_ CHAR ch);
WINUSERAPI
BOOL WINAPI IsCharUpperW(_In_ WCHAR ch);
#ifdef UNICODE
...
WINUSERAPI
BOOL WINAPI IsCharLowerA(_In_ CHAR ch);
WINUSERAPI
BOOL WINAPI IsCharLowerW(_In_ WCHAR ch);
#ifdef UNICODE
...
WINUSERAPI
BOOL WINAPI SetKeyboardState(_In_reads_(256) LPBYTE lpKeyState);
...
WINUSERAPI
int WINAPI GetKeyNameTextA(_In_ LONG lParam,
                           _Out_writes_(cchSize) LPSTR lpString,
                           _In_ int cchSize);
WINUSERAPI
int WINAPI GetKeyNameTextW(_In_ LONG lParam,
...
WINUSERAPI
int WINAPI ToAscii(_In_ UINT uVirtKey, _In_ UINT uScanCode,
                   _In_reads_opt_(256) CONST BYTE *lpKeyState,
                   _Out_ LPWORD lpChar, _In_ UINT uFlags);

#if (WINVER >= 0x0400)
WINUSERAPI
int WINAPI ToAsciiEx(_In_ UINT uVirtKey, _In_ UINT uScanCode,
                     _In_reads_opt_(256) CONST BYTE *lpKeyState,
                     _Out_ LPWORD lpChar, _In_ UINT uFlags, _In_opt_ HKL dwhkl);
#endif /* WINVER >= 0x0400 */

WINUSERAPI
int WINAPI ToUnicode(_In_ UINT wVirtKey, _In_ UINT wScanCode,
...
DWORD
WINAPI
OemKeyScan(_In_ WORD wOemChar);

WINUSERAPI
SHORT
WINAPI
VkKeyScanA(_In_ CHAR ch);
WINUSERAPI
SHORT
WINAPI
VkKeyScanW(_In_ WCHAR ch);
#ifdef UNICODE
...
SHORT
WINAPI
VkKeyScanExA(_In_ CHAR ch, _In_ HKL dwhkl);
WINUSERAPI
SHORT
WINAPI
VkKeyScanExW(_In_ WCHAR ch, _In_ HKL dwhkl);
#ifdef UNICODE
...
WINUSERAPI
VOID WINAPI keybd_event(_In_ BYTE bVk, _In_ BYTE bScan, _In_ DWORD dwFlags,
...
WINUSERAPI
VOID WINAPI mouse_event(_In_ DWORD dwFlags, _In_ DWORD dx, _In_ DWORD dy,
                        _In_ DWORD dwData, _In_ ULONG_PTR dwExtraInfo);
...
typedef struct tagKEYBDINPUT {
   ...
   * KEY_UNICODE_SEQUENCE_ITEM or KEY_UNICODE_SEQUENCE_END which are used by
   * InputService to distinguish injected unicode sequences. Those flags are
   * stored in low word. When dwFlags has KEYEVENTF_ATTRIBUTED_INPUT specified
   * this field carries in its high word ID of attributes associated with
   * injected input. This ID is assigned by InputService and recognized only by
   * it. For all other usage scenarios please refer to official documentation.
   */
  ULONG_PTR dwExtraInfo;
...
WINUSERAPI
UINT WINAPI SendInput(_In_ UINT cInputs, // number of input in the array
...
#define TOUCHINPUTMASKF_CONTACTAREA                                            \
  0x0004 // the cxContact and cyContact fields are valid
...
#define POINTER_FLAG_HASTRANSFORM                                              \
  0x00400000 // Input has a transform associated with it
...
WINUSERAPI
BOOL WINAPI InjectTouchInput(_In_ UINT32 count,
                             _In_reads_(count)
...
WINUSERAPI
BOOL WINAPI GetPointerType(_In_ UINT32 pointerId,
...
WINUSERAPI
BOOL WINAPI GetPointerInfo(_In_ UINT32 pointerId,
                           _Out_writes_(1) POINTER_INFO *pointerInfo);

WINUSERAPI
BOOL WINAPI GetPointerInfoHistory(_In_ UINT32 pointerId,
                                  _Inout_ UINT32 *entriesCount,
                                  _Out_writes_opt_(*entriesCount)
                                      POINTER_INFO *pointerInfo);

WINUSERAPI
BOOL WINAPI GetPointerFrameInfo(_In_ UINT32 pointerId,
                                _Inout_ UINT32 *pointerCount,
                                _Out_writes_opt_(*pointerCount)
                                    POINTER_INFO *pointerInfo);

WINUSERAPI
BOOL WINAPI GetPointerFrameInfoHistory(
    _In_ UINT32 pointerId, _Inout_ UINT32 *entriesCount,
    _Inout_ UINT32 *pointerCount,
    _Out_writes_opt_(*entriesCount **pointerCount) POINTER_INFO *pointerInfo);

WINUSERAPI
BOOL WINAPI GetPointerTouchInfo(_In_ UINT32 pointerId,
                                _Out_writes_(1) POINTER_TOUCH_INFO *touchInfo);

WINUSERAPI
BOOL WINAPI GetPointerTouchInfoHistory(_In_ UINT32 pointerId,
                                       _Inout_ UINT32 *entriesCount,
                                       _Out_writes_opt_(*entriesCount)
                                           POINTER_TOUCH_INFO *touchInfo);

WINUSERAPI
BOOL WINAPI GetPointerFrameTouchInfo(_In_ UINT32 pointerId,
                                     _Inout_ UINT32 *pointerCount,
                                     _Out_writes_opt_(*pointerCount)
                                         POINTER_TOUCH_INFO *touchInfo);
...
BOOL WINAPI GetPointerFrameTouchInfoHistory(
    _In_ UINT32 pointerId, _Inout_ UINT32 *entriesCount,
    _Inout_ UINT32 *pointerCount,
    _Out_writes_opt_(*entriesCount **pointerCount)
        POINTER_TOUCH_INFO *touchInfo);

WINUSERAPI
BOOL WINAPI GetPointerPenInfo(_In_ UINT32 pointerId,
                              _Out_writes_(1) POINTER_PEN_INFO *penInfo);

WINUSERAPI
BOOL WINAPI GetPointerPenInfoHistory(_In_ UINT32 pointerId,
                                     _Inout_ UINT32 *entriesCount,
                                     _Out_writes_opt_(*entriesCount)
                                         POINTER_PEN_INFO *penInfo);

WINUSERAPI
BOOL WINAPI GetPointerFramePenInfo(_In_ UINT32 pointerId,
                                   _Inout_ UINT32 *pointerCount,
                                   _Out_writes_opt_(*pointerCount)
                                       POINTER_PEN_INFO *penInfo);
...
WINUSERAPI
BOOL WINAPI RegisterPointerInputTarget(_In_ HWND hwnd,
                                       _In_ POINTER_INPUT_TYPE pointerType);

WINUSERAPI
BOOL WINAPI UnregisterPointerInputTarget(_In_ HWND hwnd,
                                         _In_ POINTER_INPUT_TYPE pointerType);

WINUSERAPI
BOOL WINAPI RegisterPointerInputTargetEx(_In_ HWND hwnd,
                                         _In_ POINTER_INPUT_TYPE pointerType,
                                         _In_ BOOL fObserve);

WINUSERAPI
BOOL WINAPI UnregisterPointerInputTargetEx(_In_ HWND hwnd,
                                           _In_ POINTER_INPUT_TYPE pointerType);
...
WINAPI
CreateSyntheticPointerDevice(_In_ POINTER_INPUT_TYPE pointerType,
                             _In_ ULONG maxCount,
...
BOOL WINAPI InjectSyntheticPointerInput(
    ...
    _In_reads_(count) CONST POINTER_TYPE_INFO *pointerInfo, _In_ UINT32 count);
...
WINUSERAPI
BOOL WINAPI EvaluateProximityToPolygon(
    UINT32 numVertices, _In_reads_(numVertices) const POINT *controlPolygon,
    _In_ const TOUCH_HIT_TESTING_INPUT *pHitTestingInput,
    _Out_ TOUCH_HIT_TESTING_PROXIMITY_EVALUATION *pProximityEval);
...
WINUSERAPI
BOOL WINAPI GetWindowFeedbackSetting(_In_ HWND hwnd,
                                     _In_ FEEDBACK_TYPE feedback,
                                     _In_ DWORD dwFlags, _Inout_ UINT32 *pSize,
                                     _Out_writes_bytes_opt_(*pSize)
                                         VOID *config);

WINUSERAPI
BOOL WINAPI SetWindowFeedbackSetting(_In_ HWND hwnd,
                                     _In_ FEEDBACK_TYPE feedback,
                                     _In_ DWORD dwFlags, _In_ UINT32 size,
...
WINUSERAPI
BOOL WINAPI GetPointerInputTransform(_In_ UINT32 pointerId,
                                     _In_ UINT32 historyCount,
                                     _Out_writes_(historyCount)
...
WINUSERAPI
UINT WINAPI MapVirtualKeyA(_In_ UINT uCode, _In_ UINT uMapType);
WINUSERAPI
UINT WINAPI MapVirtualKeyW(_In_ UINT uCode, _In_ UINT uMapType);
#ifdef UNICODE
...
#if (WINVER >= 0x0400)
WINUSERAPI
UINT WINAPI MapVirtualKeyExA(_In_ UINT uCode, _In_ UINT uMapType,
                             _In_opt_ HKL dwhkl);
WINUSERAPI
UINT WINAPI MapVirtualKeyExW(_In_ UINT uCode, _In_ UINT uMapType,
                             _In_opt_ HKL dwhkl);
#ifdef UNICODE
...
DWORD
WINAPI
GetQueueStatus(_In_ UINT flags);
...
DWORD
WINAPI
MsgWaitForMultipleObjects(_In_ DWORD nCount,
                          _In_reads_opt_(nCount) CONST HANDLE *pHandles,
                          _In_ BOOL fWaitAll, _In_ DWORD dwMilliseconds,
                          _In_ DWORD dwWakeMask);

WINUSERAPI
DWORD
WINAPI
MsgWaitForMultipleObjectsEx(_In_ DWORD nCount,
                            _In_reads_opt_(nCount) CONST HANDLE *pHandles,
                            _In_ DWORD dwMilliseconds, _In_ DWORD dwWakeMask,
                            _In_ DWORD dwFlags);
...
UINT_PTR
WINAPI
SetTimer(_In_opt_ HWND hWnd, _In_ UINT_PTR nIDEvent, _In_ UINT uElapse,
...
UINT_PTR
WINAPI
SetCoalescableTimer(_In_opt_ HWND hWnd, _In_ UINT_PTR nIDEvent,
...
HACCEL
WINAPI
LoadAcceleratorsA(_In_opt_ HINSTANCE hInstance, _In_ LPCSTR lpTableName);
WINUSERAPI
HACCEL
WINAPI
LoadAcceleratorsW(_In_opt_ HINSTANCE hInstance, _In_ LPCWSTR lpTableName);
#ifdef UNICODE
...
HACCEL
WINAPI
CreateAcceleratorTableA(_In_reads_(cAccel) LPACCEL paccel, _In_ int cAccel);
WINUSERAPI
HACCEL
WINAPI
CreateAcceleratorTableW(_In_reads_(cAccel) LPACCEL paccel, _In_ int cAccel);
#ifdef UNICODE
...
WINUSERAPI
int WINAPI CopyAcceleratorTableA(_In_ HACCEL hAccelSrc,
                                 _Out_writes_to_opt_(cAccelEntries, return)
                                     LPACCEL lpAccelDst,
                                 _In_ int cAccelEntries);
WINUSERAPI
int WINAPI CopyAcceleratorTableW(_In_ HACCEL hAccelSrc,
                                 _Out_writes_to_opt_(cAccelEntries, return)
                                     LPACCEL lpAccelDst,
                                 _In_ int cAccelEntries);
#ifdef UNICODE
...
WINUSERAPI
int WINAPI TranslateAcceleratorA(_In_ HWND hWnd, _In_ HACCEL hAccTable,
                                 _In_ LPMSG lpMsg);
WINUSERAPI
int WINAPI TranslateAcceleratorW(_In_ HWND hWnd, _In_ HACCEL hAccTable,
                                 _In_ LPMSG lpMsg);
#ifdef UNICODE
...
#define MENU_READ_ACCESS                                                       \
  (STANDARD_RIGHTS_READ | MENU_GET_ITEM_INFO | MENU_GET_ITEM_DATA |            \
   MENU_GET_SUBMENU)

#define MENU_WRITE_ACCESS                                                      \
  (STANDARD_RIGHTS_WRITE | MENU_INSERT_MENU | MENU_INSERT_ITEM |               \
   MENU_DELETE_MENU | MENU_SET_ITEM_INFO | MENU_ENABLE_ITEM |                  \
   MENU_CHECK_ITEM | MENU_SET_DEFAULT_ITEM | MENU_SET_ITEM_DATA |              \
   MENU_SET_SUBMENU)

#define MENU_EXECUTE_ACCESS (STANDARD_RIGHTS_EXECUTE)

#define MENU_ALL_ACCESS                                                        \
  (STANDARD_RIGHTS_ALL | MENU_READ_ACCESS | MENU_WRITE_ACCESS |                \
   MENU_EXECUTE_ACCESS)

WINUSERAPI
HMENU
WINAPI
LoadMenuA(_In_opt_ HINSTANCE hInstance, _In_ LPCSTR lpMenuName);
WINUSERAPI
HMENU
WINAPI
LoadMenuW(_In_opt_ HINSTANCE hInstance, _In_ LPCWSTR lpMenuName);
#ifdef UNICODE
...
HMENU
WINAPI
LoadMenuIndirectA(_In_ CONST MENUTEMPLATEA *lpMenuTemplate);
WINUSERAPI
HMENU
WINAPI
LoadMenuIndirectW(_In_ CONST MENUTEMPLATEW *lpMenuTemplate);
#ifdef UNICODE
...
HMENU
WINAPI
GetMenu(_In_ HWND hWnd);

WINUSERAPI
BOOL WINAPI SetMenu(_In_ HWND hWnd, _In_opt_ HMENU hMenu);

WINUSERAPI
BOOL WINAPI ChangeMenuA(_In_ HMENU hMenu, _In_ UINT cmd,
                        _In_opt_ LPCSTR lpszNewItem, _In_ UINT cmdInsert,
                        _In_ UINT flags);
WINUSERAPI
BOOL WINAPI ChangeMenuW(_In_ HMENU hMenu, _In_ UINT cmd,
                        _In_opt_ LPCWSTR lpszNewItem, _In_ UINT cmdInsert,
                        _In_ UINT flags);
#ifdef UNICODE
...
WINUSERAPI
BOOL WINAPI HiliteMenuItem(_In_ HWND hWnd, _In_ HMENU hMenu,
                           _In_ UINT uIDHiliteItem, _In_ UINT uHilite);

WINUSERAPI
int WINAPI GetMenuStringA(_In_ HMENU hMenu, _In_ UINT uIDItem,
                          _Out_writes_opt_(cchMax) LPSTR lpString,
                          _In_ int cchMax, _In_ UINT flags);
WINUSERAPI
int WINAPI GetMenuStringW(_In_ HMENU hMenu, _In_ UINT uIDItem,
...
HMENU
WINAPI
GetSystemMenu(_In_ HWND hWnd, _In_ BOOL bRevert);
...
DWORD
WINAPI
CheckMenuItem(_In_ HMENU hMenu, _In_ UINT uIDCheckItem, _In_ UINT uCheck);

WINUSERAPI
BOOL WINAPI EnableMenuItem(_In_ HMENU hMenu, _In_ UINT uIDEnableItem,
                           _In_ UINT uEnable);

WINUSERAPI
HMENU
WINAPI
GetSubMenu(_In_ HMENU hMenu, _In_ int nPos);

WINUSERAPI
UINT WINAPI GetMenuItemID(_In_ HMENU hMenu, _In_ int nPos);

WINUSERAPI
int WINAPI GetMenuItemCount(_In_opt_ HMENU hMenu);

WINUSERAPI
BOOL WINAPI InsertMenuA(_In_ HMENU hMenu, _In_ UINT uPosition, _In_ UINT uFlags,
                        _In_ UINT_PTR uIDNewItem, _In_opt_ LPCSTR lpNewItem);
WINUSERAPI
BOOL WINAPI InsertMenuW(_In_ HMENU hMenu, _In_ UINT uPosition, _In_ UINT uFlags,
                        _In_ UINT_PTR uIDNewItem, _In_opt_ LPCWSTR lpNewItem);
#ifdef UNICODE
...
WINUSERAPI
BOOL WINAPI AppendMenuA(_In_ HMENU hMenu, _In_ UINT uFlags,
                        _In_ UINT_PTR uIDNewItem, _In_opt_ LPCSTR lpNewItem);
WINUSERAPI
BOOL WINAPI AppendMenuW(_In_ HMENU hMenu, _In_ UINT uFlags,
                        _In_ UINT_PTR uIDNewItem, _In_opt_ LPCWSTR lpNewItem);
#ifdef UNICODE
...
WINUSERAPI
BOOL WINAPI ModifyMenuA(_In_ HMENU hMnu, _In_ UINT uPosition, _In_ UINT uFlags,
                        _In_ UINT_PTR uIDNewItem, _In_opt_ LPCSTR lpNewItem);
WINUSERAPI
BOOL WINAPI ModifyMenuW(_In_ HMENU hMnu, _In_ UINT uPosition, _In_ UINT uFlags,
                        _In_ UINT_PTR uIDNewItem, _In_opt_ LPCWSTR lpNewItem);
#ifdef UNICODE
...
WINUSERAPI
BOOL WINAPI RemoveMenu(_In_ HMENU hMenu, _In_ UINT uPosition, _In_ UINT uFlags);

WINUSERAPI
BOOL WINAPI DeleteMenu(_In_ HMENU hMenu, _In_ UINT uPosition, _In_ UINT uFlags);
...
WINUSERAPI
BOOL WINAPI TrackPopupMenu(_In_ HMENU hMenu, _In_ UINT uFlags, _In_ int x,
                           _In_ int y, _Reserved_ int nReserved, _In_ HWND hWnd,
...
WINUSERAPI
BOOL WINAPI TrackPopupMenuEx(_In_ HMENU hMenu, _In_ UINT uFlags, _In_ int x,
                             _In_ int y, _In_ HWND hwnd,
                             _In_opt_ LPTPMPARAMS lptpm);
#endif /* WINVER >= 0x0400 */

#if (_WIN32_WINNT >= 0x0601)
WINUSERAPI
BOOL WINAPI CalculatePopupWindowPosition(_In_ const POINT *anchorPoint,
...
WINUSERAPI
BOOL WINAPI InsertMenuItemA(_In_ HMENU hmenu, _In_ UINT item,
                            _In_ BOOL fByPosition, _In_ LPCMENUITEMINFOA lpmi);
WINUSERAPI
BOOL WINAPI InsertMenuItemW(_In_ HMENU hmenu, _In_ UINT item,
                            _In_ BOOL fByPosition, _In_ LPCMENUITEMINFOW lpmi);
#ifdef UNICODE
...
WINUSERAPI
BOOL WINAPI GetMenuItemInfoA(_In_ HMENU hmenu, _In_ UINT item,
                             _In_ BOOL fByPosition,
                             _Inout_ LPMENUITEMINFOA lpmii);
WINUSERAPI
BOOL WINAPI GetMenuItemInfoW(_In_ HMENU hmenu, _In_ UINT item,
                             _In_ BOOL fByPosition,
...
WINUSERAPI
BOOL WINAPI SetMenuItemInfoA(_In_ HMENU hmenu, _In_ UINT item,
                             _In_ BOOL fByPositon, _In_ LPCMENUITEMINFOA lpmii);
WINUSERAPI
BOOL WINAPI SetMenuItemInfoW(_In_ HMENU hmenu, _In_ UINT item,
                             _In_ BOOL fByPositon, _In_ LPCMENUITEMINFOW lpmii);
#ifdef UNICODE
...
WINUSERAPI
UINT WINAPI GetMenuDefaultItem(_In_ HMENU hMenu, _In_ UINT fByPos,
                               _In_ UINT gmdiFlags);

WINUSERAPI
BOOL WINAPI SetMenuDefaultItem(_In_ HMENU hMenu, _In_ UINT uItem,
                               _In_ UINT fByPos);

WINUSERAPI
BOOL WINAPI GetMenuItemRect(_In_opt_ HWND hWnd, _In_ HMENU hMenu,
                            _In_ UINT uItem, _Out_ LPRECT lprcItem);

WINUSERAPI
int WINAPI MenuItemFromPoint(_In_opt_ HWND hWnd, _In_ HMENU hMenu,
                             _In_ POINT ptScreen);
#endif /* WINVER >= 0x0400 */
...
DWORD
WINAPI
DragObject(_In_ HWND hwndParent, _In_ HWND hwndFrom, _In_ UINT fmt,
           _In_ ULONG_PTR data, _In_opt_ HCURSOR hcur);

WINUSERAPI
BOOL WINAPI DragDetect(_In_ HWND hwnd, _In_ POINT pt);
...
#define _In_bypassable_reads_or_z_(size)                                       \
  _When_(((size) == -1) || (_String_length_(_Curr_) < (size)), _In_z_) _When_( \
      ((size) != -1) && (_String_length_(_Curr_) >= (size)), _In_reads_(size))

#define _Inout_grows_updates_bypassable_or_z_(size, grows)                     \
  _When_(                                                                      \
      ((size) == -1) || (_String_length_(_Curr_) < (size)),                    \
      _Pre_z_ _Pre_valid_ _Out_writes_z_(_String_length_(_Curr_) + (grows)))   \
      _When_(((size) != -1) && (_String_length_(_Curr_) >= (size)),            \
             _Pre_count_(size) _Pre_valid_ _Out_writes_z_((size) + (grows)))

WINUSERAPI
_Success_(return) int WINAPI
    DrawTextA(_In_ HDC hdc,
              _When_((format & DT_MODIFYSTRING),
                     _At_((LPSTR)lpchText,
                          _Inout_grows_updates_bypassable_or_z_(cchText, 4)))
                  _When_((!(format & DT_MODIFYSTRING)),
                         _In_bypassable_reads_or_z_(cchText)) LPCSTR lpchText,
              _In_ int cchText, _Inout_ LPRECT lprc, _In_ UINT format);
WINUSERAPI
_Success_(return) int WINAPI
    DrawTextW(_In_ HDC hdc,
              _When_((format & DT_MODIFYSTRING),
                     _At_((LPWSTR)lpchText,
                          _Inout_grows_updates_bypassable_or_z_(cchText, 4)))
                  _When_((!(format & DT_MODIFYSTRING)),
                         _In_bypassable_reads_or_z_(cchText)) LPCWSTR lpchText,
              _In_ int cchText, _Inout_ LPRECT lprc, _In_ UINT format);
#ifdef UNICODE
...
#if defined(_M_CEE)
#undef DrawText
__inline int DrawText(HDC hdc, LPCTSTR lpchText, int cchText, LPRECT lprc,
                      UINT format) {
#ifdef UNICODE
  return DrawTextW(
#else
...
WINUSERAPI
_Success_(return) int WINAPI
    DrawTextExA(_In_ HDC hdc,
                _When_((cchText) < -1, _Unreferenced_parameter_)
                    _When_((format & DT_MODIFYSTRING),
                           _Inout_grows_updates_bypassable_or_z_(cchText, 4))
                        _When_((!(format & DT_MODIFYSTRING)),
                               _At_((LPCSTR)lpchText,
...
WINUSERAPI
_Success_(return) int WINAPI
    DrawTextExW(_In_ HDC hdc,
                _When_((cchText) < -1, _Unreferenced_parameter_)
                    _When_((format & DT_MODIFYSTRING),
                           _Inout_grows_updates_bypassable_or_z_(cchText, 4))
                        _When_((!(format & DT_MODIFYSTRING)),
                               _At_((LPCWSTR)lpchText,
                                    _In_bypassable_reads_or_z_(cchText)))
                            LPWSTR lpchText,
                _In_ int cchText, _Inout_ LPRECT lprc, _In_ UINT format,
                _In_opt_ LPDRAWTEXTPARAMS lpdtp);
...
WINUSERAPI
BOOL WINAPI GrayStringA(_In_ HDC hDC, _In_opt_ HBRUSH hBrush,
                        _In_opt_ GRAYSTRINGPROC lpOutputFunc,
                        _In_ LPARAM lpData, _In_ int nCount, _In_ int X,
                        _In_ int Y, _In_ int nWidth, _In_ int nHeight);
WINUSERAPI
BOOL WINAPI GrayStringW(_In_ HDC hDC, _In_opt_ HBRUSH hBrush,
                        _In_opt_ GRAYSTRINGPROC lpOutputFunc,
                        _In_ LPARAM lpData, _In_ int nCount, _In_ int X,
                        _In_ int Y, _In_ int nWidth, _In_ int nHeight);
#ifdef UNICODE
...
WINUSERAPI
BOOL WINAPI DrawStateA(_In_ HDC hdc, _In_opt_ HBRUSH hbrFore,
                       _In_opt_ DRAWSTATEPROC qfnCallBack, _In_ LPARAM lData,
                       _In_ WPARAM wData, _In_ int x, _In_ int y, _In_ int cx,
                       _In_ int cy, _In_ UINT uFlags);
WINUSERAPI
BOOL WINAPI DrawStateW(_In_ HDC hdc, _In_opt_ HBRUSH hbrFore,
                       _In_opt_ DRAWSTATEPROC qfnCallBack, _In_ LPARAM lData,
                       _In_ WPARAM wData, _In_ int x, _In_ int y, _In_ int cx,
                       _In_ int cy, _In_ UINT uFlags);
#ifdef UNICODE
...
WINUSERAPI
LONG WINAPI TabbedTextOutA(_In_ HDC hdc, _In_ int x, _In_ int y,
                           _In_reads_(chCount) LPCSTR lpString,
                           _In_ int chCount, _In_ int nTabPositions,
                           _In_reads_opt_(nTabPositions)
                               CONST INT *lpnTabStopPositions,
                           _In_ int nTabOrigin);
WINUSERAPI
LONG WINAPI TabbedTextOutW(_In_ HDC hdc, _In_ int x, _In_ int y,
...
DWORD
WINAPI
GetTabbedTextExtentA(_In_ HDC hdc, _In_reads_(chCount) LPCSTR lpString,
                     _In_ int chCount, _In_ int nTabPositions,
                     _In_reads_opt_(nTabPositions)
                         CONST INT *lpnTabStopPositions);
WINUSERAPI
DWORD
WINAPI
GetTabbedTextExtentW(_In_ HDC hdc, _In_reads_(chCount) LPCWSTR lpString,
                     _In_ int chCount, _In_ int nTabPositions,
                     _In_reads_opt_(nTabPositions)
                         CONST INT *lpnTabStopPositions);
#ifdef UNICODE
...
#if (WINVER >= 0x0400)
WINUSERAPI
BOOL WINAPI PaintDesktop(_In_ HDC hdc);

WINUSERAPI
VOID WINAPI SwitchToThisWindow(_In_ HWND hwnd, _In_ BOOL fUnknown);
#endif /* WINVER >= 0x0400 */
...
WINUSERAPI
HDC WINAPI GetDCEx(_In_opt_ HWND hWnd, _In_opt_ HRGN hrgnClip,
                   _In_ DWORD flags);
...
WINUSERAPI
HDC WINAPI GetWindowDC(_In_opt_ HWND hWnd);
...
WINUSERAPI
BOOL WINAPI GetUpdateRect(_In_ HWND hWnd, _Out_opt_ LPRECT lpRect,
                          _In_ BOOL bErase);

WINUSERAPI
int WINAPI GetUpdateRgn(_In_ HWND hWnd, _In_ HRGN hRgn, _In_ BOOL bErase);

WINUSERAPI
int WINAPI SetWindowRgn(_In_ HWND hWnd, _In_opt_ HRGN hRgn, _In_ BOOL bRedraw);
...
WINUSERAPI
int WINAPI GetWindowRgn(_In_ HWND hWnd, _In_ HRGN hRgn);

#if (_WIN32_WINNT >= 0x0501)

WINUSERAPI
int WINAPI GetWindowRgnBox(_In_ HWND hWnd, _Out_ LPRECT lprc);

#endif /* _WIN32_WINNT >= 0x0501 */

WINUSERAPI
int WINAPI ExcludeUpdateRgn(_In_ HDC hDC, _In_ HWND hWnd);

WINUSERAPI
BOOL WINAPI InvalidateRect(_In_opt_ HWND hWnd, _In_opt_ CONST RECT *lpRect,
                           _In_ BOOL bErase);

WINUSERAPI
BOOL WINAPI ValidateRect(_In_opt_ HWND hWnd, _In_opt_ CONST RECT *lpRect);

WINUSERAPI
BOOL WINAPI InvalidateRgn(_In_ HWND hWnd, _In_opt_ HRGN hRgn, _In_ BOOL bErase);

WINUSERAPI
BOOL WINAPI ValidateRgn(_In_ HWND hWnd, _In_opt_ HRGN hRgn);

WINUSERAPI
BOOL WINAPI RedrawWindow(_In_opt_ HWND hWnd, _In_opt_ CONST RECT *lprcUpdate,
                         _In_opt_ HRGN hrgnUpdate, _In_ UINT flags);
...
WINUSERAPI
BOOL WINAPI LockWindowUpdate(_In_opt_ HWND hWndLock);

WINUSERAPI
BOOL WINAPI ScrollWindow(_In_ HWND hWnd, _In_ int XAmount, _In_ int YAmount,
                         _In_opt_ CONST RECT *lpRect,
                         _In_opt_ CONST RECT *lpClipRect);

WINUSERAPI
BOOL WINAPI ScrollDC(_In_ HDC hDC, _In_ int dx, _In_ int dy,
                     _In_opt_ CONST RECT *lprcScroll,
                     _In_opt_ CONST RECT *lprcClip, _In_opt_ HRGN hrgnUpdate,
                     _Out_opt_ LPRECT lprcUpdate);

WINUSERAPI
int WINAPI ScrollWindowEx(_In_ HWND hWnd, _In_ int dx, _In_ int dy,
                          _In_opt_ CONST RECT *prcScroll,
                          _In_opt_ CONST RECT *prcClip,
                          _In_opt_ HRGN hrgnUpdate, _Out_opt_ LPRECT prcUpdate,
                          _In_ UINT flags);
...
WINUSERAPI
int WINAPI SetScrollPos(_In_ HWND hWnd, _In_ int nBar, _In_ int nPos,
                        _In_ BOOL bRedraw);

WINUSERAPI
int WINAPI GetScrollPos(_In_ HWND hWnd, _In_ int nBar);

WINUSERAPI
BOOL WINAPI SetScrollRange(_In_ HWND hWnd, _In_ int nBar, _In_ int nMinPos,
                           _In_ int nMaxPos, _In_ BOOL bRedraw);

WINUSERAPI
BOOL WINAPI GetScrollRange(_In_ HWND hWnd, _In_ int nBar, _Out_ LPINT lpMinPos,
                           _Out_ LPINT lpMaxPos);

WINUSERAPI
BOOL WINAPI ShowScrollBar(_In_ HWND hWnd, _In_ int wBar, _In_ BOOL bShow);

WINUSERAPI
BOOL WINAPI EnableScrollBar(_In_ HWND hWnd, _In_ UINT wSBflags,
                            _In_ UINT wArrows);
...
WINUSERAPI
BOOL WINAPI SetPropA(_In_ HWND hWnd, _In_ LPCSTR lpString,
                     _In_opt_ HANDLE hData);
WINUSERAPI
BOOL WINAPI SetPropW(_In_ HWND hWnd, _In_ LPCWSTR lpString,
                     _In_opt_ HANDLE hData);
#ifdef UNICODE
...
HANDLE
WINAPI
GetPropA(_In_ HWND hWnd, _In_ LPCSTR lpString);
WINUSERAPI
HANDLE
WINAPI
GetPropW(_In_ HWND hWnd, _In_ LPCWSTR lpString);
#ifdef UNICODE
...
HANDLE
WINAPI
RemovePropA(_In_ HWND hWnd, _In_ LPCSTR lpString);
WINUSERAPI
HANDLE
WINAPI
RemovePropW(_In_ HWND hWnd, _In_ LPCWSTR lpString);
#ifdef UNICODE
...
WINUSERAPI
int WINAPI EnumPropsExA(_In_ HWND hWnd, _In_ PROPENUMPROCEXA lpEnumFunc,
                        _In_ LPARAM lParam);
WINUSERAPI
int WINAPI EnumPropsExW(_In_ HWND hWnd, _In_ PROPENUMPROCEXW lpEnumFunc,
                        _In_ LPARAM lParam);
#ifdef UNICODE
...
WINUSERAPI
int WINAPI EnumPropsA(_In_ HWND hWnd, _In_ PROPENUMPROCA lpEnumFunc);
WINUSERAPI
int WINAPI EnumPropsW(_In_ HWND hWnd, _In_ PROPENUMPROCW lpEnumFunc);
#ifdef UNICODE
...
WINUSERAPI
BOOL WINAPI SetWindowTextA(_In_ HWND hWnd, _In_opt_ LPCSTR lpString);
WINUSERAPI
BOOL WINAPI SetWindowTextW(_In_ HWND hWnd, _In_opt_ LPCWSTR lpString);
#ifdef UNICODE
...
_Ret_range_(0, nMaxCount) WINUSERAPI int WINAPI
    GetWindowTextA(_In_ HWND hWnd, _Out_writes_(nMaxCount) LPSTR lpString,
                   _In_ int nMaxCount);
_Ret_range_(0, nMaxCount) WINUSERAPI int WINAPI
    GetWindowTextW(_In_ HWND hWnd, _Out_writes_(nMaxCount) LPWSTR lpString,
                   _In_ int nMaxCount);
#ifdef UNICODE
...
WINUSERAPI
int WINAPI GetWindowTextLengthW(_In_ HWND hWnd);
#ifdef UNICODE
...
WINUSERAPI
BOOL WINAPI AdjustWindowRect(_Inout_ LPRECT lpRect, _In_ DWORD dwStyle,
                             _In_ BOOL bMenu);

WINUSERAPI
BOOL WINAPI AdjustWindowRectEx(_Inout_ LPRECT lpRect, _In_ DWORD dwStyle,
                               _In_ BOOL bMenu, _In_ DWORD dwExStyle);
...
#if (WINVER >= 0x0605)
WINUSERAPI
BOOL WINAPI AdjustWindowRectExForDpi(_Inout_ LPRECT lpRect, _In_ DWORD dwStyle,
                                     _In_ BOOL bMenu, _In_ DWORD dwExStyle,
                                     _In_ UINT dpi);
#endif /* WINVER >= 0x0605 */
...
DWORD
WINAPI
GetWindowContextHelpId(_In_ HWND);
...
DWORD
WINAPI
GetMenuContextHelpId(_In_ HMENU);
...
#if defined(_M_CEE)
#undef MessageBox
__inline int MessageBox(HWND hWnd, LPCTSTR lpText, LPCTSTR lpCaption,
                        UINT uType) {
#ifdef UNICODE
  return MessageBoxW(
#else
...
WINUSERAPI
int WINAPI MessageBoxExA(_In_opt_ HWND hWnd, _In_opt_ LPCSTR lpText,
                         _In_opt_ LPCSTR lpCaption, _In_ UINT uType,
                         _In_ WORD wLanguageId);
WINUSERAPI
int WINAPI MessageBoxExW(_In_opt_ HWND hWnd, _In_opt_ LPCWSTR lpText,
                         _In_opt_ LPCWSTR lpCaption, _In_ UINT uType,
                         _In_ WORD wLanguageId);
#ifdef UNICODE
...
WINUSERAPI
BOOL WINAPI CreateCaret(_In_ HWND hWnd, _In_opt_ HBITMAP hBitmap,
...
#if (WINVER >= 0x0603)
WINUSERAPI
BOOL WINAPI LogicalToPhysicalPointForPerMonitorDPI(_In_opt_ HWND hWnd,
                                                   _Inout_ LPPOINT lpPoint);

WINUSERAPI
BOOL WINAPI PhysicalToLogicalPointForPerMonitorDPI(_In_opt_ HWND hWnd,
                                                   _Inout_ LPPOINT lpPoint);

#endif /* WINVER >= 0x0603 */

WINUSERAPI
int WINAPI MapWindowPoints(_In_opt_ HWND hWndFrom, _In_opt_ HWND hWndTo,
...
WINUSERAPI
HWND WINAPI ChildWindowFromPointEx(_In_ HWND hwnd, _In_ POINT pt,
                                   _In_ UINT flags);
...
DWORD
WINAPI
GetSysColor(_In_ int nIndex);

#if (WINVER >= 0x0400)
WINUSERAPI
HBRUSH
WINAPI
GetSysColorBrush(_In_ int nIndex);

#endif /* WINVER >= 0x0400 */

WINUSERAPI
BOOL WINAPI SetSysColors(_In_ int cElements,
...
WINUSERAPI
BOOL WINAPI DrawFocusRect(_In_ HDC hDC, _In_ CONST RECT *lprc);

WINUSERAPI
int WINAPI FillRect(_In_ HDC hDC, _In_ CONST RECT *lprc, _In_ HBRUSH hbr);

WINUSERAPI
int WINAPI FrameRect(_In_ HDC hDC, _In_ CONST RECT *lprc, _In_ HBRUSH hbr);

WINUSERAPI
BOOL WINAPI InvertRect(_In_ HDC hDC, _In_ CONST RECT *lprc);

WINUSERAPI
BOOL WINAPI SetRect(_Out_ LPRECT lprc, _In_ int xLeft, _In_ int yTop,
                    _In_ int xRight, _In_ int yBottom);

WINUSERAPI
BOOL WINAPI SetRectEmpty(_Out_ LPRECT lprc);

WINUSERAPI
BOOL WINAPI CopyRect(_Out_ LPRECT lprcDst, _In_ CONST RECT *lprcSrc);

WINUSERAPI
BOOL WINAPI InflateRect(_Inout_ LPRECT lprc, _In_ int dx, _In_ int dy);

WINUSERAPI
BOOL WINAPI IntersectRect(_Out_ LPRECT lprcDst, _In_ CONST RECT *lprcSrc1,
                          _In_ CONST RECT *lprcSrc2);

WINUSERAPI
BOOL WINAPI UnionRect(_Out_ LPRECT lprcDst, _In_ CONST RECT *lprcSrc1,
                      _In_ CONST RECT *lprcSrc2);

WINUSERAPI
BOOL WINAPI SubtractRect(_Out_ LPRECT lprcDst, _In_ CONST RECT *lprcSrc1,
                         _In_ CONST RECT *lprcSrc2);

WINUSERAPI
BOOL WINAPI OffsetRect(_Inout_ LPRECT lprc, _In_ int dx, _In_ int dy);

WINUSERAPI
BOOL WINAPI IsRectEmpty(_In_ CONST RECT *lprc);

WINUSERAPI
BOOL WINAPI EqualRect(_In_ CONST RECT *lprc1, _In_ CONST RECT *lprc2);

WINUSERAPI
BOOL WINAPI PtInRect(_In_ CONST RECT *lprc, _In_ POINT pt);

#ifndef NOWINOFFSETS

WINUSERAPI
WORD WINAPI GetWindowWord(_In_ HWND hWnd, _In_ int nIndex);

WINUSERAPI
WORD WINAPI SetWindowWord(_In_ HWND hWnd, _In_ int nIndex, _In_ WORD wNewWord);
...
WINUSERAPI
LONG WINAPI SetWindowLongA(_In_ HWND hWnd, _In_ int nIndex,
                           _In_ LONG dwNewLong);
WINUSERAPI
LONG WINAPI SetWindowLongW(_In_ HWND hWnd, _In_ int nIndex,
                           _In_ LONG dwNewLong);
#ifdef UNICODE
...
LONG_PTR
WINAPI
GetWindowLongPtrA(_In_ HWND hWnd, _In_ int nIndex);
WINUSERAPI
LONG_PTR
WINAPI
GetWindowLongPtrW(_In_ HWND hWnd, _In_ int nIndex);
#ifdef UNICODE
...
LONG_PTR
WINAPI
SetWindowLongPtrA(_In_ HWND hWnd, _In_ int nIndex, _In_ LONG_PTR dwNewLong);
WINUSERAPI
LONG_PTR
WINAPI
SetWindowLongPtrW(_In_ HWND hWnd, _In_ int nIndex, _In_ LONG_PTR dwNewLong);
#ifdef UNICODE
...
WINUSERAPI
WORD WINAPI GetClassWord(_In_ HWND hWnd, _In_ int nIndex);

WINUSERAPI
WORD WINAPI SetClassWord(_In_ HWND hWnd, _In_ int nIndex, _In_ WORD wNewWord);
...
WINUSERAPI
BOOL WINAPI EnumChildWindows(_In_opt_ HWND hWndParent,
                             _In_ WNDENUMPROC lpEnumFunc, _In_ LPARAM lParam);

WINUSERAPI
HWND WINAPI FindWindowA(_In_opt_ LPCSTR lpClassName,
                        _In_opt_ LPCSTR lpWindowName);
WINUSERAPI
HWND WINAPI FindWindowW(_In_opt_ LPCWSTR lpClassName,
...
#if (WINVER >= 0x0400)
WINUSERAPI
HWND WINAPI FindWindowExA(_In_opt_ HWND hWndParent,
                          _In_opt_ HWND hWndChildAfter,
                          _In_opt_ LPCSTR lpszClass,
                          _In_opt_ LPCSTR lpszWindow);
WINUSERAPI
HWND WINAPI FindWindowExW(_In_opt_ HWND hWndParent,
                          _In_opt_ HWND hWndChildAfter,
...
WINUSERAPI
BOOL WINAPI EnumThreadWindows(_In_ DWORD dwThreadId, _In_ WNDENUMPROC lpfn,
                              _In_ LPARAM lParam);
...
WINUSERAPI
int WINAPI GetClassNameA(_In_ HWND hWnd,
                         _Out_writes_to_(nMaxCount, return) LPSTR lpClassName,
                         _In_ int nMaxCount);
WINUSERAPI
int WINAPI GetClassNameW(_In_ HWND hWnd,
...
HHOOK
WINAPI
SetWindowsHookA(_In_ int nFilterType, _In_ HOOKPROC pfnFilterProc);
WINUSERAPI
HHOOK
WINAPI
SetWindowsHookW(_In_ int nFilterType, _In_ HOOKPROC pfnFilterProc);
#ifdef UNICODE
...
WINUSERAPI
BOOL WINAPI UnhookWindowsHook(_In_ int nCode, _In_ HOOKPROC pfnFilterProc);

WINUSERAPI
HHOOK
WINAPI
SetWindowsHookExA(_In_ int idHook, _In_ HOOKPROC lpfn, _In_opt_ HINSTANCE hmod,
                  _In_ DWORD dwThreadId);
WINUSERAPI
HHOOK
WINAPI
SetWindowsHookExW(_In_ int idHook, _In_ HOOKPROC lpfn, _In_opt_ HINSTANCE hmod,
                  _In_ DWORD dwThreadId);
#ifdef UNICODE
...
LRESULT
WINAPI
CallNextHookEx(_In_opt_ HHOOK hhk, _In_ int nCode, _In_ WPARAM wParam,
               _In_ LPARAM lParam);
...
WINUSERAPI
BOOL WINAPI CheckMenuRadioItem(_In_ HMENU hmenu, _In_ UINT first,
                               _In_ UINT last, _In_ UINT check,
                               _In_ UINT flags);
#endif /* WINVER >= 0x0400 */
...
HBITMAP
WINAPI
LoadBitmapA(_In_opt_ HINSTANCE hInstance, _In_ LPCSTR lpBitmapName);
WINUSERAPI
HBITMAP
WINAPI
LoadBitmapW(_In_opt_ HINSTANCE hInstance, _In_ LPCWSTR lpBitmapName);
#ifdef UNICODE
...
HCURSOR
WINAPI
LoadCursorA(_In_opt_ HINSTANCE hInstance, _In_ LPCSTR lpCursorName);
WINUSERAPI
HCURSOR
WINAPI
...
HCURSOR
WINAPI
LoadCursorFromFileA(_In_ LPCSTR lpFileName);
WINUSERAPI
HCURSOR
WINAPI
LoadCursorFromFileW(_In_ LPCWSTR lpFileName);
#ifdef UNICODE
...
HCURSOR
WINAPI
CreateCursor(_In_opt_ HINSTANCE hInst, _In_ int xHotSpot, _In_ int yHotSpot,
             _In_ int nWidth, _In_ int nHeight, _In_ CONST VOID *pvANDPlane,
...
HCURSOR
WINAPI
CopyCursor(_In_ HCURSOR hCursor);
#endif
...
HICON
WINAPI
LoadIconA(_In_opt_ HINSTANCE hInstance, _In_ LPCSTR lpIconName);
WINUSERAPI
HICON
WINAPI
LoadIconW(_In_opt_ HINSTANCE hInstance, _In_ LPCWSTR lpIconName);
#ifdef UNICODE
...
WINUSERAPI
UINT WINAPI PrivateExtractIconsA(_In_reads_(MAX_PATH) LPCSTR szFileName,
                                 _In_ int nIconIndex, _In_ int cxIcon,
                                 _In_ int cyIcon,
                                 _Out_writes_opt_(nIcons) HICON *phicon,
                                 _Out_writes_opt_(nIcons) UINT *piconid,
                                 _In_ UINT nIcons, _In_ UINT flags);
WINUSERAPI
UINT WINAPI PrivateExtractIconsW(_In_reads_(MAX_PATH) LPCWSTR szFileName,
                                 _In_ int nIconIndex, _In_ int cxIcon,
                                 _In_ int cyIcon,
                                 _Out_writes_opt_(nIcons) HICON *phicon,
                                 _Out_writes_opt_(nIcons) UINT *piconid,
...
HICON
WINAPI
CreateIcon(_In_opt_ HINSTANCE hInstance, _In_ int nWidth, _In_ int nHeight,
           _In_ BYTE cPlanes, _In_ BYTE cBitsPixel, _In_ CONST BYTE *lpbANDbits,
...
WINUSERAPI
int WINAPI LookupIconIdFromDirectory(_In_reads_bytes_(sizeof(WORD) * 3)
                                         PBYTE presbits,
                                     _In_ BOOL fIcon);

#if (WINVER >= 0x0400)
WINUSERAPI
int WINAPI LookupIconIdFromDirectoryEx(_In_reads_bytes_(sizeof(WORD) * 3)
                                           PBYTE presbits,
                                       _In_ BOOL fIcon, _In_ int cxDesired,
                                       _In_ int cyDesired, _In_ UINT Flags);
#endif /* WINVER >= 0x0400 */

WINUSERAPI
HICON
WINAPI
CreateIconFromResource(_In_reads_bytes_(dwResSize) PBYTE presbits,
                       _In_ DWORD dwResSize, _In_ BOOL fIcon, _In_ DWORD dwVer);

#if (WINVER >= 0x0400)
WINUSERAPI
HICON
WINAPI
CreateIconFromResourceEx(_In_reads_bytes_(dwResSize) PBYTE presbits,
                         _In_ DWORD dwResSize, _In_ BOOL fIcon,
                         _In_ DWORD dwVer, _In_ int cxDesired,
                         _In_ int cyDesired, _In_ UINT Flags);
...
WINUSERAPI
UINT WINAPI SetThreadCursorCreationScaling(UINT cursorDpi);
...
HANDLE
WINAPI
LoadImageA(_In_opt_ HINSTANCE hInst, _In_ LPCSTR name, _In_ UINT type,
           _In_ int cx, _In_ int cy, _In_ UINT fuLoad);
WINUSERAPI
HANDLE
WINAPI
LoadImageW(_In_opt_ HINSTANCE hInst, _In_ LPCWSTR name, _In_ UINT type,
           _In_ int cx, _In_ int cy, _In_ UINT fuLoad);
#ifdef UNICODE
...
HANDLE
WINAPI
CopyImage(_In_ HANDLE h, _In_ UINT type, _In_ int cx, _In_ int cy,
          _In_ UINT flags);
...
WINUSERAPI BOOL WINAPI DrawIconEx(_In_ HDC hdc, _In_ int xLeft, _In_ int yTop,
                                  _In_ HICON hIcon, _In_ int cxWidth,
                                  _In_ int cyWidth, _In_ UINT istepIfAniCur,
...
HICON
WINAPI
CreateIconIndirect(_In_ PICONINFO piconinfo);

WINUSERAPI
HICON
WINAPI
CopyIcon(_In_ HICON hIcon);
...
WINUSERAPI
BOOL WINAPI GetIconInfoExA(_In_ HICON hicon, _Inout_ PICONINFOEXA piconinfo);
WINUSERAPI
BOOL WINAPI GetIconInfoExW(_In_ HICON hicon, _Inout_ PICONINFOEXW piconinfo);
#ifdef UNICODE
...
WINUSERAPI
int WINAPI LoadStringA(_In_opt_ HINSTANCE hInstance, _In_ UINT uID,
                       _Out_writes_to_(cchBufferMax, return +1) LPSTR lpBuffer,
                       _In_ int cchBufferMax);
WINUSERAPI
int WINAPI LoadStringW(_In_opt_ HINSTANCE hInstance, _In_ UINT uID,
...
WINUSERAPI
BOOL WINAPI IsDialogMessageA(_In_ HWND hDlg, _In_ LPMSG lpMsg);
WINUSERAPI
BOOL WINAPI IsDialogMessageW(_In_ HWND hDlg, _In_ LPMSG lpMsg);
#ifdef UNICODE
...
WINUSERAPI
BOOL WINAPI MapDialogRect(_In_ HWND hDlg, _Inout_ LPRECT lpRect);

WINUSERAPI
int WINAPI DlgDirListA(_In_ HWND hDlg, _Inout_ LPSTR lpPathSpec,
                       _In_ int nIDListBox, _In_ int nIDStaticPath,
                       _In_ UINT uFileType);
WINUSERAPI
int WINAPI DlgDirListW(_In_ HWND hDlg, _Inout_ LPWSTR lpPathSpec,
                       _In_ int nIDListBox, _In_ int nIDStaticPath,
                       _In_ UINT uFileType);
#ifdef UNICODE
...
WINUSERAPI
BOOL WINAPI DlgDirSelectExA(_In_ HWND hwndDlg,
                            _Out_writes_(chCount) LPSTR lpString,
                            _In_ int chCount, _In_ int idListBox);
WINUSERAPI
BOOL WINAPI DlgDirSelectExW(_In_ HWND hwndDlg,
...
WINUSERAPI
int WINAPI DlgDirListComboBoxA(_In_ HWND hDlg, _Inout_ LPSTR lpPathSpec,
                               _In_ int nIDComboBox, _In_ int nIDStaticPath,
                               _In_ UINT uFiletype);
WINUSERAPI
int WINAPI DlgDirListComboBoxW(_In_ HWND hDlg, _Inout_ LPWSTR lpPathSpec,
                               _In_ int nIDComboBox, _In_ int nIDStaticPath,
                               _In_ UINT uFiletype);
#ifdef UNICODE
...
WINUSERAPI
BOOL WINAPI DlgDirSelectComboBoxExA(_In_ HWND hwndDlg,
                                    _Out_writes_(cchOut) LPSTR lpString,
                                    _In_ int cchOut, _In_ int idComboBox);
WINUSERAPI
BOOL WINAPI DlgDirSelectComboBoxExW(_In_ HWND hwndDlg,
...
#define DS_LOCALEDIT                                                           \
  0x20L /* 16-bit: Edit items get Local storage. 32-bit and up: meaningless.   \
         */
...
WINUSERAPI
int WINAPI SetScrollInfo(_In_ HWND hwnd, _In_ int nBar, _In_ LPCSCROLLINFO lpsi,
                         _In_ BOOL redraw);

WINUSERAPI
BOOL WINAPI GetScrollInfo(_In_ HWND hwnd, _In_ int nBar,
...
LRESULT
WINAPI
DefFrameProcA(_In_ HWND hWnd, _In_opt_ HWND hWndMDIClient, _In_ UINT uMsg,
              _In_ WPARAM wParam, _In_ LPARAM lParam);
WINUSERAPI
LRESULT
WINAPI
DefFrameProcW(_In_ HWND hWnd, _In_opt_ HWND hWndMDIClient, _In_ UINT uMsg,
              _In_ WPARAM wParam, _In_ LPARAM lParam);
#ifdef UNICODE
...
CALLBACK
#endif
DefMDIChildProcA(_In_ HWND hWnd, _In_ UINT uMsg, _In_ WPARAM wParam,
                 _In_ LPARAM lParam);
WINUSERAPI
#ifndef _MAC
LRESULT
...
CALLBACK
#endif
DefMDIChildProcW(_In_ HWND hWnd, _In_ UINT uMsg, _In_ WPARAM wParam,
                 _In_ LPARAM lParam);
#ifdef UNICODE
...
WINUSERAPI
HWND WINAPI CreateMDIWindowA(_In_ LPCSTR lpClassName, _In_ LPCSTR lpWindowName,
                             _In_ DWORD dwStyle, _In_ int X, _In_ int Y,
                             _In_ int nWidth, _In_ int nHeight,
                             _In_opt_ HWND hWndParent,
                             _In_opt_ HINSTANCE hInstance, _In_ LPARAM lParam);
WINUSERAPI
HWND WINAPI CreateMDIWindowW(_In_ LPCWSTR lpClassName,
                             _In_ LPCWSTR lpWindowName, _In_ DWORD dwStyle,
                             _In_ int X, _In_ int Y, _In_ int nWidth,
                             _In_ int nHeight, _In_opt_ HWND hWndParent,
                             _In_opt_ HINSTANCE hInstance, _In_ LPARAM lParam);
#ifdef UNICODE
...
#if (WINVER >= 0x0400)
WINUSERAPI
WORD WINAPI TileWindows(_In_opt_ HWND hwndParent, _In_ UINT wHow,
                        _In_opt_ CONST RECT *lpRect, _In_ UINT cKids,
                        _In_reads_opt_(cKids) const HWND FAR *lpKids);

WINUSERAPI
WORD WINAPI CascadeWindows(_In_opt_ HWND hwndParent, _In_ UINT wHow,
                           _In_opt_ CONST RECT *lpRect, _In_ UINT cKids,
                           _In_reads_opt_(cKids) const HWND FAR *lpKids);
...
WINUSERAPI
BOOL WINAPI WinHelpA(_In_opt_ HWND hWndMain, _In_opt_ LPCSTR lpszHelp,
                     _In_ UINT uCommand, _In_ ULONG_PTR dwData);
WINUSERAPI
BOOL WINAPI WinHelpW(_In_opt_ HWND hWndMain, _In_opt_ LPCWSTR lpszHelp,
                     _In_ UINT uCommand, _In_ ULONG_PTR dwData);
#ifdef UNICODE
...
DWORD
WINAPI
GetGuiResources(_In_ HANDLE hProcess, _In_ DWORD uiFlags);
#endif /* WINVER >= 0x0500 */
...
WINUSERAPI
LONG WINAPI ChangeDisplaySettingsA(_In_opt_ DEVMODEA *lpDevMode,
                                   _In_ DWORD dwFlags);
WINUSERAPI
LONG WINAPI ChangeDisplaySettingsW(_In_opt_ DEVMODEW *lpDevMode,
                                   _In_ DWORD dwFlags);
#ifdef UNICODE
...
WINUSERAPI
LONG WINAPI ChangeDisplaySettingsExA(_In_opt_ LPCSTR lpszDeviceName,
                                     _In_opt_ DEVMODEA *lpDevMode,
                                     _Reserved_ HWND hwnd, _In_ DWORD dwflags,
                                     _In_opt_ LPVOID lParam);
WINUSERAPI
LONG WINAPI ChangeDisplaySettingsExW(_In_opt_ LPCWSTR lpszDeviceName,
...
WINUSERAPI
BOOL WINAPI EnumDisplaySettingsA(_In_opt_ LPCSTR lpszDeviceName,
                                 _In_ DWORD iModeNum,
                                 _Inout_ DEVMODEA *lpDevMode);
WINUSERAPI
BOOL WINAPI EnumDisplaySettingsW(_In_opt_ LPCWSTR lpszDeviceName,
                                 _In_ DWORD iModeNum,
...
WINUSERAPI
BOOL WINAPI EnumDisplaySettingsExA(_In_opt_ LPCSTR lpszDeviceName,
                                   _In_ DWORD iModeNum,
                                   _Inout_ DEVMODEA *lpDevMode,
                                   _In_ DWORD dwFlags);
WINUSERAPI
BOOL WINAPI EnumDisplaySettingsExW(_In_opt_ LPCWSTR lpszDeviceName,
                                   _In_ DWORD iModeNum,
                                   _Inout_ DEVMODEW *lpDevMode,
                                   _In_ DWORD dwFlags);
#ifdef UNICODE
...
WINUSERAPI
BOOL WINAPI EnumDisplayDevicesA(_In_opt_ LPCSTR lpDevice, _In_ DWORD iDevNum,
                                _Inout_ PDISPLAY_DEVICEA lpDisplayDevice,
                                _In_ DWORD dwFlags);
WINUSERAPI
BOOL WINAPI EnumDisplayDevicesW(_In_opt_ LPCWSTR lpDevice, _In_ DWORD iDevNum,
...
WINUSERAPI
LONG WINAPI GetDisplayConfigBufferSizes(_In_ UINT32 flags,
                                        _Out_ UINT32 *numPathArrayElements,
                                        _Out_ UINT32 *numModeInfoArrayElements);

WINUSERAPI
LONG WINAPI SetDisplayConfig(_In_ UINT32 numPathArrayElements,
                             _In_reads_opt_(numPathArrayElements)
                                 DISPLAYCONFIG_PATH_INFO *pathArray,
                             _In_ UINT32 numModeInfoArrayElements,
                             _In_reads_opt_(numModeInfoArrayElements)
                                 DISPLAYCONFIG_MODE_INFO *modeInfoArray,
                             _In_ UINT32 flags);

WINUSERAPI
_Success_(return == ERROR_SUCCESS) LONG WINAPI QueryDisplayConfig(
    _In_ UINT32 flags, _Inout_ UINT32 *numPathArrayElements,
    _Out_writes_to_(*numPathArrayElements, *numPathArrayElements)
        DISPLAYCONFIG_PATH_INFO *pathArray,
    _Inout_ UINT32 *numModeInfoArrayElements,
    _Out_writes_to_(*numModeInfoArrayElements, *numModeInfoArrayElements)
        DISPLAYCONFIG_MODE_INFO *modeInfoArray,
...
WINUSERAPI
LONG WINAPI
DisplayConfigSetDeviceInfo(_In_ DISPLAYCONFIG_DEVICE_INFO_HEADER *setPacket);
...
_Success_(return != FALSE) BOOL WINAPI
    SystemParametersInfoA(_In_ UINT uiAction, _In_ UINT uiParam,
                          _Pre_maybenull_ _Post_valid_ PVOID pvParam,
                          _In_ UINT fWinIni);
WINUSERAPI
_Success_(return != FALSE) BOOL WINAPI
    SystemParametersInfoW(_In_ UINT uiAction, _In_ UINT uiParam,
                          _Pre_maybenull_ _Post_valid_ PVOID pvParam,
                          _In_ UINT fWinIni);
#ifdef UNICODE
...
WINUSERAPI
_Success_(return != FALSE) BOOL WINAPI
    SystemParametersInfoForDpi(_In_ UINT uiAction, _In_ UINT uiParam,
                               _Pre_maybenull_ _Post_valid_ PVOID pvParam,
                               _In_ UINT fWinIni, _In_ UINT dpi);
...
WINUSERAPI
VOID WINAPI SetDebugErrorLevel(_In_ DWORD dwLevel);
...
WINUSERAPI
VOID WINAPI SetLastErrorEx(_In_ DWORD dwErrCode, _In_ DWORD dwType);

WINUSERAPI
int WINAPI InternalGetWindowText(_In_ HWND hWnd,
                                 _Out_writes_to_(cchMaxCount, return +1)
                                     LPWSTR pString,
                                 _In_ int cchMaxCount);
...
WINUSERAPI
BOOL WINAPI CancelShutdown(VOID);
...
HMONITOR
WINAPI
MonitorFromPoint(_In_ POINT pt, _In_ DWORD dwFlags);

WINUSERAPI
HMONITOR
WINAPI
MonitorFromRect(_In_ LPCRECT lprc, _In_ DWORD dwFlags);

WINUSERAPI
HMONITOR
WINAPI
MonitorFromWindow(_In_ HWND hwnd, _In_ DWORD dwFlags);
...
WINUSERAPI
BOOL WINAPI EnumDisplayMonitors(_In_opt_ HDC hdc, _In_opt_ LPCRECT lprcClip,
...
WINUSERAPI
VOID WINAPI NotifyWinEvent(_In_ DWORD event, _In_ HWND hwnd, _In_ LONG idObject,
                           _In_ LONG idChild);
...
HWINEVENTHOOK
WINAPI
SetWinEventHook(_In_ DWORD eventMin, _In_ DWORD eventMax,
                _In_opt_ HMODULE hmodWinEventProc,
                _In_ WINEVENTPROC pfnWinEventProc, _In_ DWORD idProcess,
                _In_ DWORD idThread, _In_ DWORD dwFlags);
...
#define WINEVENT_SKIPOWNTHREAD                                                 \
  0x0001 // Don't call back for events on installer's thread
#define WINEVENT_SKIPOWNPROCESS                                                \
  0x0002 // Don't call back for events on installer's process
#define WINEVENT_INCONTEXT                                                     \
  0x0004 // Events are SYNC, this causes your dll to be injected into every
         // process
 ...
 *      idObject        is ID of control (OBJID_MENU, OBJID_SYSMENU, OBJID_SELF
 * for popup) idChild         is CHILDID_SELF
 *
 ...
 * being shown.
 *
 * For MENUPOPUP, hwnd+idObject+idChild refers to the NEW popup coming up, not
 * the parent item which is hierarchical.  You can get the parent menu/popup by
 ...
 *          use the child VARIANT.  You will ask the container for the
 * properties of the child identified by the VARIANT.  In other words, the child
 * in this case is accessible but not a full-blown object. Like a button on a
 * titlebar which is 'small' and has no children.
 */
...
#define EVENT_OBJECT_REORDER                                                   \
  0x8004 // hwnd + ID + idChild is parent of zordering children
/*
 * NOTE:
...
#define EVENT_OBJECT_SELECTION                                                 \
  0x8006 // hwnd + ID + idChild is selected item (if only one), or idChild is
         // OBJID_WINDOW if complex
#define EVENT_OBJECT_SELECTIONADD 0x8007 // hwnd + ID + idChild is item added
#define EVENT_OBJECT_SELECTIONREMOVE                                           \
  0x8008 // hwnd + ID + idChild is item removed
#define EVENT_OBJECT_SELECTIONWITHIN                                           \
  0x8009 // hwnd + ID + idChild is parent of changed selected items
...
#define EVENT_OBJECT_STATECHANGE                                               \
  0x800A // hwnd + ID + idChild is item w/ state change
/*
...
#define EVENT_OBJECT_LOCATIONCHANGE                                            \
  0x800B // hwnd + ID + idChild is moved/sized item
...
#define EVENT_OBJECT_NAMECHANGE                                                \
  0x800C // hwnd + ID + idChild is item w/ name change
#define EVENT_OBJECT_DESCRIPTIONCHANGE                                         \
  0x800D // hwnd + ID + idChild is item w/ desc change
#define EVENT_OBJECT_VALUECHANGE                                               \
  0x800E // hwnd + ID + idChild is item w/ value change
#define EVENT_OBJECT_PARENTCHANGE                                              \
  0x800F // hwnd + ID + idChild is item w/ new parent
#define EVENT_OBJECT_HELPCHANGE                                                \
  0x8010 // hwnd + ID + idChild is item w/ help change
#define EVENT_OBJECT_DEFACTIONCHANGE                                           \
  0x8011 // hwnd + ID + idChild is item w/ def action change
#define EVENT_OBJECT_ACCELERATORCHANGE                                         \
  0x8012 // hwnd + ID + idChild is item w/ keybd accel change

#if (_WIN32_WINNT >= 0x0600)
#define EVENT_OBJECT_INVOKED 0x8013 // hwnd + ID + idChild is item invoked
#define EVENT_OBJECT_TEXTSELECTIONCHANGED                                      \
  0x8014 // hwnd + ID + idChild is item w? test selection change
...
WINUSERAPI
BOOL WINAPI GetGUIThreadInfo(_In_ DWORD idThread, _Inout_ PGUITHREADINFO pgui);
...
DPI_AWARENESS
WINAPI
GetAwarenessFromDpiAwarenessContext(_In_ DPI_AWARENESS_CONTEXT value);

WINUSERAPI
UINT WINAPI GetDpiFromDpiAwarenessContext(_In_ DPI_AWARENESS_CONTEXT value);

WINUSERAPI
BOOL WINAPI
AreDpiAwarenessContextsEqual(_In_ DPI_AWARENESS_CONTEXT dpiContextA,
...
WINUSERAPI
UINT WINAPI GetSystemDpiForProcess(_In_ HANDLE hProcess);

WINUSERAPI
BOOL WINAPI EnableNonClientDpiScaling(_In_ HWND hwnd);

WINUSERAPI
BOOL WINAPI InheritWindowMonitor(_In_ HWND hwnd, _In_opt_ HWND hwndInherit);
...
DPI_AWARENESS_CONTEXT
WINAPI
GetDpiAwarenessContextForProcess(_In_ HANDLE hProcess);
...
WINAPI
SetThreadDpiHostingBehavior(_In_ DPI_HOSTING_BEHAVIOR value);
...
DPI_HOSTING_BEHAVIOR
WINAPI
GetWindowDpiHostingBehavior(_In_ HWND hwnd);

#endif /* WINVER >= 0x0606 */

WINUSERAPI
UINT WINAPI GetWindowModuleFileNameA(_In_ HWND hwnd,
                                     _Out_writes_to_(cchFileNameMax, return)
                                         LPSTR pszFileName,
                                     _In_ UINT cchFileNameMax);
WINUSERAPI
UINT WINAPI GetWindowModuleFileNameW(_In_ HWND hwnd,
                                     _Out_writes_to_(cchFileNameMax, return)
                                         LPWSTR pszFileName,
                                     _In_ UINT cchFileNameMax);
#ifdef UNICODE
...
WINUSERAPI
BOOL WINAPI GetMenuBarInfo(_In_ HWND hwnd, _In_ LONG idObject, _In_ LONG idItem,
...
WINUSERAPI
BOOL WINAPI GetScrollBarInfo(_In_ HWND hwnd, _In_ LONG idObject,
...
WINUSERAPI
BOOL WINAPI GetComboBoxInfo(_In_ HWND hwndCombo, _Inout_ PCOMBOBOXINFO pcbi);
 ...
 */
WINUSERAPI
HWND WINAPI RealChildWindowFromPoint(_In_ HWND hwndParent,
 ...
 */
WINUSERAPI
UINT WINAPI RealGetWindowClassA(_In_ HWND hwnd,
                                _Out_writes_to_(cchClassNameMax, return)
                                    LPSTR ptszClassName,
 ...
 */
WINUSERAPI
UINT WINAPI RealGetWindowClassW(_In_ HWND hwnd,
                                _Out_writes_to_(cchClassNameMax, return)
...
WINUSERAPI
BOOL WINAPI GetAltTabInfoA(_In_opt_ HWND hwnd, _In_ int iItem,
                           _Inout_ PALTTABINFO pati,
                           _Out_writes_opt_(cchItemText) LPSTR pszItemText,
                           _In_ UINT cchItemText);
WINUSERAPI
BOOL WINAPI GetAltTabInfoW(_In_opt_ HWND hwnd, _In_ int iItem,
                           _Inout_ PALTTABINFO pati,
...
WINUSERAPI
BOOL WINAPI UserHandleGrantAccess(_In_ HANDLE hUserHandle, _In_ HANDLE hJob,
                                  _In_ BOOL bGrant);
...
/*
 * If usButtonFlags has RI_MOUSE_WHEEL, the wheel delta is stored in
 * usButtonData. Take it as a signed value.
 */
...
#define MOUSE_VIRTUAL_DESKTOP                                                  \
  0x02 // the coordinates are mapped to the virtual desktop
...
WINUSERAPI
UINT WINAPI GetRawInputData(_In_ HRAWINPUT hRawInput, _In_ UINT uiCommand,
                            _Out_writes_bytes_to_opt_(*pcbSize, return)
                                LPVOID pData,
                            _Inout_ PUINT pcbSize, _In_ UINT cbSizeHeader);
...
#define RIDI_DEVICENAME                                                        \
  0x20000007 // the return valus is the character length, not the byte size
...
WINUSERAPI
UINT WINAPI GetRawInputDeviceInfoA(_In_opt_ HANDLE hDevice, _In_ UINT uiCommand,
                                   _Inout_updates_bytes_to_opt_(*pcbSize,
                                                                *pcbSize)
                                       LPVOID pData,
                                   _Inout_ PUINT pcbSize);
WINUSERAPI
UINT WINAPI GetRawInputDeviceInfoW(_In_opt_ HANDLE hDevice, _In_ UINT uiCommand,
                                   _Inout_updates_bytes_to_opt_(*pcbSize,
                                                                *pcbSize)
                                       LPVOID pData,
                                   _Inout_ PUINT pcbSize);
 ...
 */
WINUSERAPI
UINT WINAPI GetRawInputBuffer(_Out_writes_bytes_opt_(*pcbSize) PRAWINPUT pData,
                              _Inout_ PUINT pcbSize, _In_ UINT cbSizeHeader);
...
#define RIDEV_CAPTUREMOUSE                                                     \
  0x00000200 // effective when mouse nolegacy is specified, otherwise it would
             // be an error
...
WINUSERAPI
BOOL WINAPI RegisterRawInputDevices(_In_reads_(uiNumDevices)
                                        PCRAWINPUTDEVICE pRawInputDevices,
                                    _In_ UINT uiNumDevices, _In_ UINT cbSize);

WINUSERAPI
UINT WINAPI GetRegisteredRawInputDevices(_Out_writes_opt_(*puiNumDevices)
...
WINUSERAPI
UINT WINAPI GetRawInputDeviceList(_Out_writes_opt_(*puiNumDevices)
...
LRESULT
WINAPI
DefRawInputProc(_In_reads_(nInput) PRAWINPUT *paRawInput, _In_ INT nInput,
...
WINUSERAPI
BOOL WINAPI GetPointerDevices(_Inout_ UINT32 *deviceCount,
                              _Out_writes_opt_(*deviceCount)
                                  POINTER_DEVICE_INFO *pointerDevices);

WINUSERAPI
BOOL WINAPI GetPointerDevice(_In_ HANDLE device,
                             _Out_writes_(1)
                                 POINTER_DEVICE_INFO *pointerDevice);

WINUSERAPI
BOOL WINAPI
GetPointerDeviceProperties(_In_ HANDLE device, _Inout_ UINT32 *propertyCount,
                           _Out_writes_opt_(*propertyCount)
                               POINTER_DEVICE_PROPERTY *pointerProperties);

WINUSERAPI
BOOL WINAPI RegisterPointerDeviceNotifications(_In_ HWND window,
                                               _In_ BOOL notifyRange);

WINUSERAPI
BOOL WINAPI GetPointerDeviceRects(_In_ HANDLE device,
                                  _Out_writes_(1) RECT *pointerDeviceRect,
                                  _Out_writes_(1) RECT *displayRect);

WINUSERAPI
BOOL WINAPI GetPointerDeviceCursors(
    _In_ HANDLE device, _Inout_ UINT32 *cursorCount,
    _Out_writes_opt_(*cursorCount) POINTER_DEVICE_CURSOR_INFO *deviceCursors);

WINUSERAPI
BOOL WINAPI GetRawPointerDeviceData(_In_ UINT32 pointerId,
                                    _In_ UINT32 historyCount,
                                    _In_ UINT32 propertiesCount,
                                    _In_reads_(propertiesCount)
                                        POINTER_DEVICE_PROPERTY *pProperties,
                                    _Out_writes_(historyCount *propertiesCount)
                                        LONG *pValues);
...
// For a stable struct, use a numbered variant such as
// TOUCHPAD_PARAMETERS_VERSION_1 + TOUCHPAD_PARAMETERS_V1.
...
typedef struct TOUCHPAD_PARAMETERS_V1 {
  ...
  // These correspond to user settings and can be changed via
...
/*
 * Message filter action values (action parameter to
 ...
 *   - If cbExtraArgs is non-zero, pass the HGESTUREINFO received in the
 * WM_GESTURE message lParam into the GetGestureExtraArgs function to retrieve
 * extended argument information.
 */
typedef struct tagGESTUREINFO {
  UINT cbSize;   // size, in bytes, of this structure (including variable length
                 // Args field)
  ...
  ULONGLONG
  ullArguments;     // arguments for gestures whose arguments fit in 8 BYTES
  UINT cbExtraArgs; // size, in bytes, of extra arguments, if any, that
                    // accompany this gesture
 ...
 *   - The WM_GESTURENOTIFY message notifies a window that gesture recognition
 * is in progress and a gesture will be generated if one is recognized under the
 ...
 *   - HGESTUREINFO is received by a window in the lParam of a WM_GESTURE
 * message.
 */
WINUSERAPI
BOOL WINAPI GetGestureInfo(_In_ HGESTUREINFO hGestureInfo,
 ...
 *   - HGESTUREINFO is received by a window in the lParam of a WM_GESTURE
 * message.
 *   - Size, in bytes, of the extra argument data is available in the
 * cbExtraArgs field of the GESTUREINFO structure retrieved using the
 * GetGestureInfo function.
 */
WINUSERAPI
BOOL WINAPI GetGestureExtraArgs(_In_ HGESTUREINFO hGestureInfo,
                                _In_ UINT cbExtraArgs,
                                _Out_writes_bytes_(cbExtraArgs)
                                    PBYTE pExtraArgs);
...
/*
 * Two finger tap gesture configuration flags - set GESTURECONFIG.dwID to
 * GID_TWOFINGERTAP
 */
#define GC_TWOFINGERTAP 0x00000001

/*
 * PressAndTap gesture configuration flags - set GESTURECONFIG.dwID to
 * GID_PRESSANDTAP
 */
#define GC_PRESSANDTAP 0x00000001
#define GC_ROLLOVER GC_PRESSANDTAP

#define GESTURECONFIGMAXCOUNT                                                  \
  256 // Maximum number of gestures that can be included
...
BOOL WINAPI SetGestureConfig(
    ...
    _In_reads_(cIDs) PGESTURECONFIG
        pGestureConfig, // array of GESTURECONFIG structures, dwIDs will be
                        // processed in the order specified and repeated
                        // occurances will overwrite previous ones
    _In_ UINT cbSize);  // sizeof(GESTURECONFIG)

#define GCF_INCLUDE_ANCESTORS                                                  \
  0x00000001 // If specified, GetGestureConfig returns consolidated
             // configuration for the specified window and it's parent window
             // chain
...
BOOL WINAPI GetGestureConfig(
    ...
    _In_ PUINT pcIDs, // *pcIDs contains the size, in number of GESTURECONFIG
...
WINUSERAPI
BOOL WINAPI ShutdownBlockReasonQuery(_In_ HWND hWnd,
                                     _Out_writes_opt_(*pcchBuff)
                                         LPWSTR pwszBuff,
...
typedef enum tagINPUT_MESSAGE_ORIGIN_ID {
  ...
  IMO_HARDWARE =
      0x00000001, // from a hardware device or injected by a UIAccess app
...
WINUSERAPI
BOOL WINAPI
GetCurrentInputMessageSource(_Out_ INPUT_MESSAGE_SOURCE *inputMessageSource);

WINUSERAPI
BOOL WINAPI GetCIMSSM(_Out_ INPUT_MESSAGE_SOURCE *inputMessageSource);
...
WINUSERAPI
BOOL WINAPI
GetDisplayAutoRotationPreferences(_Out_ ORIENTATION_PREFERENCE *pOrientation);

WINUSERAPI
BOOL WINAPI GetDisplayAutoRotationPreferencesByProcessId(
    _In_ DWORD dwProcessId, _Out_ ORIENTATION_PREFERENCE *pOrientation,
    _Out_ BOOL *fRotateScreen);

WINUSERAPI
BOOL WINAPI
SetDisplayAutoRotationPreferences(_In_ ORIENTATION_PREFERENCE orientation);
...
WINUSERAPI
BOOL WINAPI SetProcessRestrictionExemption(_In_ BOOL fEnableExemption);
...
WINUSERAPI
BOOL WINAPI ConvertToInterceptWindow(HWND topLevelWindow);

WINUSERAPI
BOOL WINAPI IsInterceptWindow(HWND topLevelWindow, _Out_ BOOL *isIntercept);
...
typedef enum _WINDOW_ACTION_KINDS {
  ...
  WAK_COALESCEABLE = WAK_POSITION | WAK_SIZE | WAK_ACTIVATE | WAK_VISIBILITY |
                     WAK_INSERT_AFTER,
...
WINUSERAPI
BOOL WINAPI ApplyWindowAction(HWND hwnd, WINDOW_ACTION *pAction);
...
WINUSERAPI
BOOL WINAPI SetAdditionalForegroundBoostProcesses(
    HWND topLevelWindow, DWORD processHandleCount,
 ...
 *
 * TDF_REGISTER -   Used to register tooltip to receive notification of trigger
 * key combination via WM_TOOLTIPDISMISS.
 *
 * TDF_UNREGISTER - Used to unregister tooltip from receiving notification of
 * trigger key combination via WM_TOOLTIPDISMISS.
 */
...
WINUSERAPI
BOOL WINAPI
RegisterForTooltipDismissNotification(HWND hWnd, TOOLTIP_DISMISS_FLAGS tdFlags);

/*
 * Support for Accessibility Tooltip Dismissal API:
 *
 * This message notifies apps/frameworks that a trigger event has occurred and
 * they should dismiss the respective tooltip window. This is used with
...
#if (WINVER >= 0x0604)
WINUSERAPI
BOOL WINAPI IsWindowArranged(_In_ HWND hwnd);
...
WINUSERAPI
UINT WINAPI GetCurrentMonitorTopologyId(VOID);
...
//          DWM_CLOAKED_APP(0x0000001).The window was cloaked by its owner
//          application. DWM_CLOAKED_SHELL(0x0000002).The window was cloaked by
//          the Shell. 0 - window is not cloaked
//
// lParam - 0 (unused)
//
...
WINUSERAPI
BOOL WINAPI RegisterCloakedNotification(HWND hwnd, BOOL fRegister);
...
WINUSERAPI
BOOL WINAPI EnterMoveSizeLoop(HWND hwnd, POINT ptCursor,
