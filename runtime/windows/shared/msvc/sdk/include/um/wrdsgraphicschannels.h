...
EXTERN_C __declspec(selectany) const IID IID_IWRdsGraphicsChannelEvents = {
    0x67f2368c,
    0xd674,
    0x4fae,
    {0x66, 0xa5, 0xd2, 0x06, 0x28, 0xa6, 0x40, 0xd2}};
...
typedef struct IWRdsGraphicsChannelEventsVtbl {
  ...
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IWRdsGraphicsChannelEvents *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IWRdsGraphicsChannelEvents *This);
...
#define IWRdsGraphicsChannelEvents_OnChannelOpened(This, OpenResult,           \
                                                   pOpenContext)               \
  ((This)->lpVtbl->OnChannelOpened(This, OpenResult, pOpenContext))

#define IWRdsGraphicsChannelEvents_OnDataSent(This, pWriteContext, bCancelled, \
                                              pBuffer, cbBuffer)               \
  ((This)->lpVtbl->OnDataSent(This, pWriteContext, bCancelled, pBuffer,        \
                              cbBuffer))

#define IWRdsGraphicsChannelEvents_OnMetricsUpdate(This, bandwidth, RTT,       \
                                                   lastSentByteIndex)          \
...
EXTERN_C __declspec(selectany) const IID IID_IWRdsGraphicsChannel = {
    0x684b7a0b,
    0xedff,
    0x43ad,
    {0xd5, 0xa2, 0x4a, 0x8d, 0x53, 0x88, 0xf4, 0x01}};
...
typedef struct IWRdsGraphicsChannelVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IWRdsGraphicsChannel *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IWRdsGraphicsChannel *This);
  ...
  HRESULT(STDMETHODCALLTYPE *Close)(__RPC__in IWRdsGraphicsChannel *This);
...
EXTERN_C __declspec(selectany) const IID IID_IWRdsGraphicsChannelManager = {
    0x0fd57159,
    0xe83e,
    0x476a,
    {0xa8, 0xb9, 0x4a, 0x79, 0x76, 0xe7, 0x1e, 0x18}};
...
public:
  virtual HRESULT STDMETHODCALLTYPE CreateChannel(
      ...
      /* [retval][out] */
      __RPC__deref_out_opt IWRdsGraphicsChannel **ppVirtualChannel) = 0;
};
...
typedef struct IWRdsGraphicsChannelManagerVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IWRdsGraphicsChannelManager *This);
...
#define IWRdsGraphicsChannelManager_CreateChannel(                             \
    This, pszChannelName, channelType, ppVirtualChannel)                       \
  ((This)->lpVtbl->CreateChannel(This, pszChannelName, channelType,            \
                                 ppVirtualChannel))
...
#define RFX_GFX_MSG_TYPE_MOUSE_POINTER_SHAPE                                   \
  RFX_GFX_MSG_MAKE_16BIT_CODE(0x8B, 0x00)
#define RFX_GFX_MSG_TYPE_MOUSE_POINTER_POSITION                                \
  RFX_GFX_MSG_MAKE_16BIT_CODE(0x88, 0x00)
#define RFX_GFX_MSG_TYPE_MOUSE_POINTER_CACHED                                  \
  RFX_GFX_MSG_MAKE_16BIT_CODE(0x8A, 0x00)
#define RFX_GFX_MSG_TYPE_CLIENT_DESKTOP_INFO_REQUEST                           \
  RFX_GFX_MSG_MAKE_16BIT_CODE(RFX_GFX_MSG_PREFIX, 0x1)
#define RFX_GFX_MSG_TYPE_CLIENT_DESKTOP_INFO_RESPONSE                          \
  RFX_GFX_MSG_MAKE_16BIT_CODE(RFX_GFX_MSG_PREFIX, 0x2)
#define RFX_GFX_MSG_TYPE_DESKTOP_CONFIG_CHANGE_NOTIFY                          \
  RFX_GFX_MSG_MAKE_16BIT_CODE(RFX_GFX_MSG_PREFIX, 0x3)
#define RFX_GFX_MSG_TYPE_DESKTOP_CONFIG_CHANGE_CONFIRM                         \
  RFX_GFX_MSG_MAKE_16BIT_CODE(RFX_GFX_MSG_PREFIX, 0x4)
#define RFX_GFX_MSG_TYPE_DESKTOP_SIZE_CHANGE_NOTIFY                            \
  RFX_GFX_MSG_MAKE_16BIT_CODE(RFX_GFX_MSG_PREFIX, 0x5)
#define RFX_GFX_MSG_TYPE_DISCONNECT_NOTIFY                                     \
  RFX_GFX_MSG_MAKE_16BIT_CODE(RFX_GFX_MSG_PREFIX, 0x6)
#define RFX_GFX_MSG_TYPE_DESKTOP_RESEND_REQUEST                                \
  RFX_GFX_MSG_MAKE_16BIT_CODE(RFX_GFX_MSG_PREFIX, 0x7)
...
typedef RFX_GFX_MSG_CLIENT_DESKTOP_INFO_REQUEST RFX_GFX_UNALIGNED
    *PRFX_GFX_MSG_CLIENT_DESKTOP_INFO_REQUEST;
...
typedef RFX_GFX_MSG_CLIENT_DESKTOP_INFO_RESPONSE RFX_GFX_UNALIGNED
    *PRFX_GFX_MSG_CLIENT_DESKTOP_INFO_RESPONSE;
...
typedef RFX_GFX_MSG_DESKTOP_CONFIG_CHANGE_NOTIFY RFX_GFX_UNALIGNED
    *PRFX_GFX_MSG_DESKTOP_CONFIG_CHANGE_NOTIFY;
typedef struct tagRFX_GFX_MSG_DESKTOP_CONFIG_CHANGE_CONFIRM {
  RFX_GFX_MSG_HEADER channelHdr;
} RFX_GFX_MSG_DESKTOP_CONFIG_CHANGE_CONFIRM;

typedef RFX_GFX_MSG_DESKTOP_CONFIG_CHANGE_CONFIRM RFX_GFX_UNALIGNED
...
typedef RFX_GFX_MSG_DESKTOP_INPUT_RESET RFX_GFX_UNALIGNED
    *PRFX_GFX_MSG_DESKTOP_INPUT_RESET;
typedef struct tagRFX_GFX_MSG_DISCONNECT_NOTIFY {
  RFX_GFX_MSG_HEADER channelHdr;
  ULONG DisconnectReason;
} RFX_GFX_MSG_DISCONNECT_NOTIFY;

typedef RFX_GFX_MSG_DISCONNECT_NOTIFY RFX_GFX_UNALIGNED
    *PRFX_GFX_MSG_DISCONNECT_NOTIFY;
typedef struct tagRFX_GFX_MSG_DESKTOP_RESEND_REQUEST {
  RFX_GFX_MSG_HEADER channelHdr;
  RFX_GFX_RECT RedrawRect;
} RFX_GFX_MSG_DESKTOP_RESEND_REQUEST;

typedef RFX_GFX_MSG_DESKTOP_RESEND_REQUEST RFX_GFX_UNALIGNED
