...
typedef interface IWebAuthenticationCoreManagerInterop
...
extern RPC_IF_HANDLE
    __MIDL_itf_webauthenticationcoremanagerinterop_0000_0000_v0_0_c_ifspec;
extern RPC_IF_HANDLE
    __MIDL_itf_webauthenticationcoremanagerinterop_0000_0000_v0_0_s_ifspec;
...
typedef struct IWebAuthenticationCoreManagerInteropVtbl {
  ...
  ULONG(STDMETHODCALLTYPE *AddRef)(IWebAuthenticationCoreManagerInterop *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(IWebAuthenticationCoreManagerInterop *This);
  ...
  DECLSPEC_XFGVIRT(IWebAuthenticationCoreManagerInterop,
...
#define IWebAuthenticationCoreManagerInterop_QueryInterface(This, riid,        \
                                                            ppvObject)         \
...
#define IWebAuthenticationCoreManagerInterop_GetRuntimeClassName(This,         \
                                                                 className)    \
...
#define IWebAuthenticationCoreManagerInterop_RequestTokenForWindowAsync(       \
    This, appWindow, request, riid, asyncInfo)                                 \
  ((This)->lpVtbl->RequestTokenForWindowAsync(This, appWindow, request, riid,  \
                                              asyncInfo))

#define IWebAuthenticationCoreManagerInterop_RequestTokenWithWebAccountForWindowAsync( \
    This, appWindow, request, webAccount, riid, asyncInfo)                             \
  ((This)->lpVtbl->RequestTokenWithWebAccountForWindowAsync(                           \
      This, appWindow, request, webAccount, riid, asyncInfo))
...
extern RPC_IF_HANDLE
    __MIDL_itf_webauthenticationcoremanagerinterop_0000_0001_v0_0_c_ifspec;
extern RPC_IF_HANDLE
    __MIDL_itf_webauthenticationcoremanagerinterop_0000_0001_v0_0_s_ifspec;
