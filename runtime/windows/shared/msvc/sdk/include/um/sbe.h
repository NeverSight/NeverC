...
typedef struct IStreamBufferInitializeVtbl {
  ...
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(IStreamBufferInitialize *This,
                                             /* [in] */ REFIID riid,
  ...
  HRESULT(STDMETHODCALLTYPE *SetHKEY)(IStreamBufferInitialize *This,
                                      /* [in] */ HKEY hkeyRoot);

  DECLSPEC_XFGVIRT(IStreamBufferInitialize, SetSIDs)
  HRESULT(STDMETHODCALLTYPE *SetSIDs)(IStreamBufferInitialize *This,
                                      /* [in] */ DWORD cSIDs,
...
typedef struct IStreamBufferSinkVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in IStreamBufferSink *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IStreamBufferSink *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IStreamBufferSink *This);

  DECLSPEC_XFGVIRT(IStreamBufferSink, LockProfile)
  HRESULT(STDMETHODCALLTYPE *LockProfile)(__RPC__in IStreamBufferSink *This,
...
typedef struct IStreamBufferSink2Vtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in IStreamBufferSink2 *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IStreamBufferSink2 *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IStreamBufferSink2 *This);

  DECLSPEC_XFGVIRT(IStreamBufferSink, LockProfile)
  HRESULT(STDMETHODCALLTYPE *LockProfile)(__RPC__in IStreamBufferSink2 *This,
                                          /* [in] */ __RPC__in LPCWSTR
                                              pszStreamBufferFilename);
  ...
  HRESULT(STDMETHODCALLTYPE *UnlockProfile)(__RPC__in IStreamBufferSink2 *This);
...
#define IStreamBufferSink2_CreateRecorder(This, pszFilename, dwRecordType,     \
                                          pRecordingIUnknown)                  \
  ((This)->lpVtbl->CreateRecorder(This, pszFilename, dwRecordType,             \
                                  pRecordingIUnknown))
...
typedef struct IStreamBufferSink3Vtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in IStreamBufferSink3 *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IStreamBufferSink3 *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IStreamBufferSink3 *This);

  DECLSPEC_XFGVIRT(IStreamBufferSink, LockProfile)
  HRESULT(STDMETHODCALLTYPE *LockProfile)(__RPC__in IStreamBufferSink3 *This,
                                          /* [in] */ __RPC__in LPCWSTR
                                              pszStreamBufferFilename);
  ...
  DECLSPEC_XFGVIRT(IStreamBufferSink2, UnlockProfile)
  HRESULT(STDMETHODCALLTYPE *UnlockProfile)(__RPC__in IStreamBufferSink3 *This);
...
#define IStreamBufferSink3_CreateRecorder(This, pszFilename, dwRecordType,     \
                                          pRecordingIUnknown)                  \
  ((This)->lpVtbl->CreateRecorder(This, pszFilename, dwRecordType,             \
                                  pRecordingIUnknown))
...
typedef struct IStreamBufferSourceVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IStreamBufferSource *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IStreamBufferSource *This);
...
typedef struct IStreamBufferRecordControlVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IStreamBufferRecordControl *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IStreamBufferRecordControl *This);
  ...
  HRESULT(STDMETHODCALLTYPE *Stop)(__RPC__in IStreamBufferRecordControl *This,
...
typedef struct IStreamBufferRecCompVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IStreamBufferRecComp *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IStreamBufferRecComp *This);
  ...
  HRESULT(STDMETHODCALLTYPE *Append)(__RPC__in IStreamBufferRecComp *This,
                                     /* [in] */ __RPC__in LPCWSTR
                                         pszSBRecording);
  ...
  HRESULT(STDMETHODCALLTYPE *Close)(__RPC__in IStreamBufferRecComp *This);

  DECLSPEC_XFGVIRT(IStreamBufferRecComp, Cancel)
  HRESULT(STDMETHODCALLTYPE *Cancel)(__RPC__in IStreamBufferRecComp *This);
...
typedef /* [v1_enum][uuid] */ DECLSPEC_UUID(
    "99038221-f409-4d44-8313-bff73269a85e") enum STREAMBUFFER_ATTR_DATATYPE {
...
public:
  virtual HRESULT STDMETHODCALLTYPE SetAttribute(
      ...
      /* [size_is][in] */ __RPC__in_ecount_full(cbAttributeLength) BYTE *
          pbAttribute,
  ...
  virtual HRESULT STDMETHODCALLTYPE GetAttributeByName(
      ...
      /* [out] */ __RPC__out STREAMBUFFER_ATTR_DATATYPE *
          pStreamBufferAttributeType,
      /* [size_is][out] */ __RPC__out_ecount_full(*pcbLength) BYTE *
          pbAttribute,
  ...
  virtual HRESULT STDMETHODCALLTYPE EnumAttributes(
      /* [out] */ __RPC__deref_out_opt IEnumStreamBufferRecordingAttrib *
...
public:
  virtual HRESULT STDMETHODCALLTYPE Next(
      /* [in] */ ULONG cRequest,
      /* [size_is][out][in] */
      __RPC__inout_ecount_full(cRequest) STREAMBUFFER_ATTRIBUTE *
...
typedef struct IStreamBufferConfigureVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IStreamBufferConfigure *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IStreamBufferConfigure *This);
...
typedef struct IStreamBufferConfigure2Vtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IStreamBufferConfigure2 *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IStreamBufferConfigure2 *This);
...
#define IStreamBufferConfigure2_SetMultiplexedPacketSize(This,                 \
                                                         cbBytesPerPacket)     \
  ((This)->lpVtbl->SetMultiplexedPacketSize(This, cbBytesPerPacket))

#define IStreamBufferConfigure2_GetMultiplexedPacketSize(This,                 \
                                                         pcbBytesPerPacket)    \
  ((This)->lpVtbl->GetMultiplexedPacketSize(This, pcbBytesPerPacket))

#define IStreamBufferConfigure2_SetFFTransitionRates(This, dwMaxFullFrameRate, \
                                                     dwMaxNonSkippingRate)     \
  ((This)->lpVtbl->SetFFTransitionRates(This, dwMaxFullFrameRate,              \
                                        dwMaxNonSkippingRate))

#define IStreamBufferConfigure2_GetFFTransitionRates(                          \
    This, pdwMaxFullFrameRate, pdwMaxNonSkippingRate)                          \
  ((This)->lpVtbl->GetFFTransitionRates(This, pdwMaxFullFrameRate,             \
...
typedef struct IStreamBufferConfigure3Vtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IStreamBufferConfigure3 *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IStreamBufferConfigure3 *This);
...
#define IStreamBufferConfigure3_SetMultiplexedPacketSize(This,                 \
                                                         cbBytesPerPacket)     \
  ((This)->lpVtbl->SetMultiplexedPacketSize(This, cbBytesPerPacket))

#define IStreamBufferConfigure3_GetMultiplexedPacketSize(This,                 \
                                                         pcbBytesPerPacket)    \
  ((This)->lpVtbl->GetMultiplexedPacketSize(This, pcbBytesPerPacket))

#define IStreamBufferConfigure3_SetFFTransitionRates(This, dwMaxFullFrameRate, \
                                                     dwMaxNonSkippingRate)     \
  ((This)->lpVtbl->SetFFTransitionRates(This, dwMaxFullFrameRate,              \
                                        dwMaxNonSkippingRate))

#define IStreamBufferConfigure3_GetFFTransitionRates(                          \
    This, pdwMaxFullFrameRate, pdwMaxNonSkippingRate)                          \
  ((This)->lpVtbl->GetFFTransitionRates(This, pdwMaxFullFrameRate,             \
                                        pdwMaxNonSkippingRate))
...
typedef struct IStreamBufferMediaSeekingVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IStreamBufferMediaSeeking *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IStreamBufferMediaSeeking *This);
  ...
  HRESULT(STDMETHODCALLTYPE *SetRate)(__RPC__in IStreamBufferMediaSeeking *This,
                                      /* [in] */ double dRate);

  DECLSPEC_XFGVIRT(IMediaSeeking, GetRate)
  HRESULT(STDMETHODCALLTYPE *GetRate)(__RPC__in IStreamBufferMediaSeeking *This,
                                      /* [annotation][out] */
                                      _Out_ double *pdRate);
...
typedef struct IStreamBufferMediaSeeking2Vtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IStreamBufferMediaSeeking2 *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IStreamBufferMediaSeeking2 *This);
...
#define IStreamBufferMediaSeeking2_ConvertTimeFormat(                          \
    This, pTarget, pTargetFormat, Source, pSourceFormat)                       \
  ((This)->lpVtbl->ConvertTimeFormat(This, pTarget, pTargetFormat, Source,     \
                                     pSourceFormat))

#define IStreamBufferMediaSeeking2_SetPositions(                               \
...
typedef struct IStreamBufferDataCountersVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IStreamBufferDataCounters *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IStreamBufferDataCounters *This);
...
enum {
  ...
  //
  //  about to send playback rate change that is due to
  //  IMediaSeeking::SetPositions() call
  //      param1 = old_playback_rate * 10000 e.g. 2x is 20000
  //      param2 = new_playback_rate * 10000
  ...
  //      param2 = unused (set to 0 -- if uses are defined later, they will be
  //      non-0)
  STREAMBUFFER_EC_SETPOSITIONS_EVENTS_DONE,
};

// {8966A89E-F83E-4c0e-BC3B-BFA7649E04CB}
DEFINE_GUID(EVENTID_SBE2RecControlStarted, 0x8966a89e, 0xf83e, 0x4c0e, 0xbc,
            0x3b, 0xbf, 0xa7, 0x64, 0x9e, 0x4, 0xcb);
// {454B1EC8-0C9B-4caa-B1A1-1E7A2666F6C3}
DEFINE_GUID(EVENTID_SBE2RecControlStopped, 0x454b1ec8, 0xc9b, 0x4caa, 0xb1,
            0xa1, 0x1e, 0x7a, 0x26, 0x66, 0xf6, 0xc3);
DEFINE_GUID(SBE2_STREAM_DESC_EVENT, 0x2313a4ed, 0xbf2d, 0x454f, 0xad, 0x8a,
            0xd9, 0x5b, 0xa7, 0xf9, 0x1f, 0xee);
// {000FCF09-97F5-46ac-9769-7A83B35384FB}
DEFINE_GUID(SBE2_V1_STREAMS_CREATION_EVENT, 0xfcf09, 0x97f5, 0x46ac, 0x97, 0x69,
            0x7a, 0x83, 0xb3, 0x53, 0x84, 0xfb);
// {A72530A3-0344-4cab-A2D0-FE937DBDCAB3}
DEFINE_GUID(SBE2_V2_STREAMS_CREATION_EVENT, 0xa72530a3, 0x344, 0x4cab, 0xa2,
            0xd0, 0xfe, 0x93, 0x7d, 0xbd, 0xca, 0xb3);
typedef enum {
...
typedef struct ISBE2GlobalEventVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in ISBE2GlobalEvent *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in ISBE2GlobalEvent *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in ISBE2GlobalEvent *This);
...
interface ISBE2GlobalEvent { CONST_VTBL struct ISBE2GlobalEventVtbl *lpVtbl; };
...
#define ISBE2GlobalEvent_GetEvent(This, idEvt, param1, param2, param3, param4, \
                                  pSpanning, pcb, pb)                          \
  ((This)->lpVtbl->GetEvent(This, idEvt, param1, param2, param3, param4,       \
                            pSpanning, pcb, pb))
...
typedef struct ISBE2GlobalEvent2Vtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in ISBE2GlobalEvent2 *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in ISBE2GlobalEvent2 *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in ISBE2GlobalEvent2 *This);
...
#define ISBE2GlobalEvent2_GetEvent(This, idEvt, param1, param2, param3,        \
                                   param4, pSpanning, pcb, pb)                 \
  ((This)->lpVtbl->GetEvent(This, idEvt, param1, param2, param3, param4,       \
                            pSpanning, pcb, pb))

#define ISBE2GlobalEvent2_GetEventEx(This, idEvt, param1, param2, param3,      \
                                     param4, pSpanning, pcb, pb, pStreamTime)  \
  ((This)->lpVtbl->GetEventEx(This, idEvt, param1, param2, param3, param4,     \
                              pSpanning, pcb, pb, pStreamTime))
...
typedef struct ISBE2SpanningEventVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in ISBE2SpanningEvent *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in ISBE2SpanningEvent *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in ISBE2SpanningEvent *This);
...
typedef struct ISBE2CrossbarVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in ISBE2Crossbar *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in ISBE2Crossbar *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in ISBE2Crossbar *This);

  DECLSPEC_XFGVIRT(ISBE2Crossbar, EnableDefaultMode)
  HRESULT(STDMETHODCALLTYPE *EnableDefaultMode)(__RPC__in ISBE2Crossbar *This,
...
interface ISBE2Crossbar { CONST_VTBL struct ISBE2CrossbarVtbl *lpVtbl; };
...
#define ISBE2Crossbar_SetOutputProfile(This, pProfile, pcOutputPins,           \
                                       ppOutputPins)                           \
...
typedef struct ISBE2StreamMapVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in ISBE2StreamMap *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in ISBE2StreamMap *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in ISBE2StreamMap *This);

  DECLSPEC_XFGVIRT(ISBE2StreamMap, MapStream)
  HRESULT(STDMETHODCALLTYPE *MapStream)(__RPC__in ISBE2StreamMap *This,
                                        /* [in] */ SBE2_STREAM_ID Stream);

  DECLSPEC_XFGVIRT(ISBE2StreamMap, UnmapStream)
  HRESULT(STDMETHODCALLTYPE *UnmapStream)(__RPC__in ISBE2StreamMap *This,
                                          /* [in] */ SBE2_STREAM_ID Stream);
...
interface ISBE2StreamMap { CONST_VTBL struct ISBE2StreamMapVtbl *lpVtbl; };
...
typedef struct ISBE2EnumStreamVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in ISBE2EnumStream *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in ISBE2EnumStream *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in ISBE2EnumStream *This);

  DECLSPEC_XFGVIRT(ISBE2EnumStream, Next)
  HRESULT(STDMETHODCALLTYPE *Next)(__RPC__in ISBE2EnumStream *This,
                                   /* [in] */ ULONG cRequest,
                                   /* [size_is][out][in] */
                                   __RPC__inout_ecount_full(cRequest)
  ...
  HRESULT(STDMETHODCALLTYPE *Skip)(__RPC__in ISBE2EnumStream *This,
                                   /* [in] */ ULONG cRecords);

  DECLSPEC_XFGVIRT(ISBE2EnumStream, Reset)
  HRESULT(STDMETHODCALLTYPE *Reset)(__RPC__in ISBE2EnumStream *This);
...
interface ISBE2EnumStream { CONST_VTBL struct ISBE2EnumStreamVtbl *lpVtbl; };
...
typedef struct ISBE2MediaTypeProfileVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in ISBE2MediaTypeProfile *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in ISBE2MediaTypeProfile *This);
...
typedef struct ISBE2FileScanVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in ISBE2FileScan *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in ISBE2FileScan *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in ISBE2FileScan *This);

  DECLSPEC_XFGVIRT(ISBE2FileScan, RepairFile)
  HRESULT(STDMETHODCALLTYPE *RepairFile)(__RPC__in ISBE2FileScan *This,
                                         /* [in] */ __RPC__in LPCWSTR filename);

  END_INTERFACE
} ISBE2FileScanVtbl;

interface ISBE2FileScan { CONST_VTBL struct ISBE2FileScanVtbl *lpVtbl; };
