...
DECLARE_INTERFACE(ID3D12ShaderReflectionType) {
  ...
  STDMETHOD_(ID3D12ShaderReflectionType *,
  ...
  STDMETHOD(ImplementsInterface)(THIS_ _In_ ID3D12ShaderReflectionType * pBase)
      PURE;
};
...
DECLARE_INTERFACE(ID3D12ShaderReflectionConstantBuffer) {
  ...
  STDMETHOD_(ID3D12ShaderReflectionVariable *,
...
DECLARE_INTERFACE_(ID3D12ShaderReflection, IUnknown) {
  ...
  STDMETHOD(GetOutputParameterDesc)(THIS_ _In_ UINT ParameterIndex,
                                    _Out_ D3D12_SIGNATURE_PARAMETER_DESC *
                                        pDesc) PURE;
...
DECLARE_INTERFACE(ID3D12FunctionReflection) {
  ...
  STDMETHOD_(ID3D12FunctionParameterReflection *,
...
DEFINE_GUID(IID_ID3D12FunctionParameterReflection, 0xec25f42d, 0x7006, 0x4f2b,
            0xb3, 0x3e, 0x2, 0xcc, 0x33, 0x75, 0x73, 0x3f);
