...
// MessageText:
//
// The data specified for the media type is invalid, inconsistent, or not
...
// MessageText:
//
// This object needs to be initialized before the requested operation can be
// carried out.%0
//
...
// MessageText:
//
// An object ran out of media types to suggest therefore the requested chain of
// streaming objects cannot be completed.%0
//
...
// MessageText:
//
// This callback and state had already been passed in to this event generator
// earlier.%0
//
...
// MessageText:
//
// The Media Foundation platform is disabled when the system is running in Safe
// Mode.%0
//
...
// MessageText:
//
// Mutually exclusive flags have been specified to source resolver. This flag
// combination is invalid.%0
//
#define MF_E_SOURCERESOLVER_MUTUALLY_EXCLUSIVE_FLAGS                           \
  _HRESULT_TYPEDEF_(0xC00D36F1L)
...
// MessageText:
//
// The activate could not be created in the remote process for some reason it
// was replaced with empty one.%0
//
...
// MessageText:
//
// The data specified for the media type is supported, but would require a
...
// MessageText:
//
// The operation failed because an invalid combination of workqueue ID and flags
// was specified.%0
//
...
// MessageText:
//
// The attempted call or command is not supported with the DirectX version used
// by the component.%0
//
#define MF_E_OPERATION_UNSUPPORTED_AT_D3D_FEATURE_LEVEL                        \
  _HRESULT_TYPEDEF_(0xC00D3708L)
...
// MessageText:
//
// The specified media type is not supported with the DirectX version used by
// the component.%0
//
#define MF_E_UNSUPPORTED_MEDIATYPE_AT_D3D_FEATURE_LEVEL                        \
  _HRESULT_TYPEDEF_(0xC00D3709L)
...
// MessageText:
//
// The media stream cannot process any more samples because there are no more
// samples in the stream.%0
//
...
// duplicate removed
// MessageId=17011 Severity=Informational Facility=MEDIAFOUNDATION
// SymbolicName=MF_E_INVALID_REQUEST Language=English The request is invalid in
// the current state.%0
//.
//
...
// MessageText:
//
// This object has already been initialized and cannot be re-initialized at this
// time.%0
//
...
// MessageText:
//
// The requested action cannot be carried out until the object is flushed and
// the queue is emptied.%0
//
...
// MessageText:
//
// The index that is being generated needs to be committed before the requested
// action can be carried out.%0
//
...
// MessageText:
//
// The ASF leaky bucket parameters must be specified in order to carry out this
// request.%0
//
...
// MessageText:
//
// The stream id is invalid. The valid range for ASF stream id is from 1 to
// 127.%0
//
...
// MessageText:
//
// The various Stream Sinks in this Media Sink are too far out of sync for the
// requested action to take place.%0
//
...
// MessageText:
//
// Stream Sinks cannot be added to or removed from this Media Sink because its
// set of streams is fixed.%0
//
...
// MessageText:
//
// The sink has not been finalized before shut down. This may cause sink to
...
// MessageText:
//
// Sink could not create valid output file because required headers were not
// provided to the sink.%0
//
...
// MessageText:
//
// There is no available procamp hardware with which to perform color
// correction.%0
//
...
// MessageText:
//
// There is no available deinterlacing hardware with which to deinterlace the
// video stream.%0
//
...
// MessageText:
//
// A video stream requires copy protection to be enabled, but there was a
...
// MessageText:
//
// A component is attempting to access a surface for sharing that is not
// shared.%0
//
...
// MessageText:
//
// A component is attempting to access a shared device that is already locked by
// another component.%0
//
...
// MessageText:
//
// The device is no longer available. The handle should be closed and a new one
// opened.%0
//
...
// MessageText:
//
// A video sample is not currently queued on a stream that is required for
// mixing.%0
//
...
// MessageText:
//
// The audio renderer encountered an error trying to set the render buffer
// size.%0
//
...
// MessageText:
//
// The audio renderer encountered an error trying spoof the invalidated audio
// client.%0
//
...
// MessageText:
//
// The topology contains an invalid optional node.  Possible reasons are
// incorrect number of outputs and inputs or optional node is at the beginning
// or end of a segment.%0
//
...
// MessageText:
//
// The topology contains loops, which are unsupported in media foundation
// topologies.%0
//
...
// MessageText:
//
// A source stream node in the topology does not have a presentation
// descriptor.%0
//
...
// MessageText:
//
// A stream descriptor was set on a source stream node but it was not selected
// on the presentation descriptor.%0
//
...
// MessageText:
//
// A valid type has not been set for this stream or a stream that it depends
// on.%0
//
...
// MessageText:
//
// A stream change has occurred. Output cannot be produced until the streams
// have been renegotiated.%0
//
...
// MessageText:
//
// The transform cannot take the requested action until all of the input data it
// currently holds is processed or flushed.%0
//
...
// MessageText:
//
// The transform requires a profile but the supplied profile was invalid or
// corrupt.%0
//
...
// MessageText:
//
// The transform requires a profile but the supplied profile ended unexpectedly
// while parsing.%0
//
...
//
#define MF_E_TRANSFORM_PROPERTY_PID_NOT_RECOGNIZED                             \
  _HRESULT_TYPEDEF_(0xC00D6D66L)
...
//
#define MF_E_TRANSFORM_PROPERTY_VARIANT_TYPE_WRONG                             \
  _HRESULT_TYPEDEF_(0xC00D6D67L)
...
// MessageText:
//
// The property value is incompatible with some other property or mediatype set
// on the transform.%0
//
#define MF_E_TRANSFORM_PROPERTY_VALUE_INCOMPATIBLE                             \
  _HRESULT_TYPEDEF_(0xC00D6D6CL)
...
// MessageText:
//
// The requested operation is not supported for the currently set output
// mediatype.%0
//
#define MF_E_TRANSFORM_NOT_POSSIBLE_FOR_CURRENT_OUTPUT_MEDIATYPE               \
  _HRESULT_TYPEDEF_(0xC00D6D6DL)
...
// MessageText:
//
// The requested operation is not supported for the currently set input
// mediatype.%0
//
#define MF_E_TRANSFORM_NOT_POSSIBLE_FOR_CURRENT_INPUT_MEDIATYPE                \
  _HRESULT_TYPEDEF_(0xC00D6D6EL)
...
// MessageText:
//
// The requested operation is not supported for the currently set combination of
// mediatypes.%0
//
#define MF_E_TRANSFORM_NOT_POSSIBLE_FOR_CURRENT_MEDIATYPE_COMBINATION          \
  _HRESULT_TYPEDEF_(0xC00D6D6FL)
...
// MessageText:
//
// The requested feature is not supported in combination with some other
// currently enabled feature.%0
//
#define MF_E_TRANSFORM_CONFLICTS_WITH_OTHER_CURRENTLY_ENABLED_FEATURES         \
  _HRESULT_TYPEDEF_(0xC00D6D70L)
...
// MessageText:
//
// The requested operation is not supported for the current speaker
// configuration.%0
//
#define MF_E_TRANSFORM_NOT_POSSIBLE_FOR_CURRENT_SPKR_CONFIG                    \
  _HRESULT_TYPEDEF_(0xC00D6D73L)
...
// MessageText:
//
// The caller does not appear to support this transform's asynchronous
// capabilities.%0
//
...
// MessageText:
//
// An audio compression manager driver could not be initialized by the
// transform.%0
//
#define MF_E_TRANSFORM_CANNOT_INITIALIZE_ACM_DRIVER                            \
  _HRESULT_TYPEDEF_(0xC00D6D78L)
...
// MessageText:
//
// The input stream has invalid and illegal resolution. Output should stop on
// next ProcessOutput call after the invalid and illegal resolution is
// detected.%0
//
...
// MessageText:
//
// It is not supported in the current context to have the transform copy
...
// MessageText:
//
// The APP needs to provide IMFContentProtectionManager callback to access the
// protected media file.%0
//
...
// MessageText:
//
// The OPL that the license requires to be enforced are not supported by the
// Input Trust Authority.%0
//
...
// MessageText:
//
// Signature verification could not be completed successfully for this
// component.%0
//
...
// MessageText:
//
// Running this process under a debugger while using protected content is not
// allowed.%0
//
...
// MessageText:
//
// The current GRL on the machine does not meet the minimum version
// requirements.%0
//
...
// MessageText:
//
// The current GRL on the machine does not contain any renewal entries for the
// specified revocation.%0
//
...
// MessageText:
//
// The current GRL on the machine does not contain any extensible entries for
// the specified extension GUID.%0
//
...
// MessageText:
//
// Protection for this stream is not guaranteed to be enforced until the
...
// MessageText:
//
// This video stream is disabled because it is being sent to an unknown software
// output.%0
//
#define MF_S_VIDEO_DISABLED_WITH_UNKNOWN_SOFTWARE_OUTPUT                       \
  _HRESULT_TYPEDEF_(0x000D7169L)
...
// MessageText:
//
// The GRL file is not correctly formed, it may have been corrupted or
// overwritten.%0
//
...
// MessageText:
//
// The GRL was reloaded and required all processes that can run protected media
// to restart.%0
//
...
// MessageText:
//
// The Protected Environment Authorization service (PEAUTH) has not been
// started.%0
//
...
// MessageText:
//
// The sample protection algorithms supported by components are not
// compatible.%0
//
...
// MessageText:
//
// WMDRM ITA does not allow protected content with high security level for this
// release.%0
//
#define MF_E_HIGH_SECURITY_LEVEL_CONTENT_NOT_ALLOWED                           \
  _HRESULT_TYPEDEF_(0xC00D7178L)
...
// MessageText:
//
// WMDRM ITA cannot allow the requested action for the content as one or more
// components is not properly signed.%0
//
...
// MessageText:
//
// WMDRM ITA does not recognize the Explicite Analog Video Output Protection
// guid specified in the license.%0
//
#define MF_E_ITA_UNRECOGNIZED_ANALOG_VIDEO_PROTECTION_GUID                     \
  _HRESULT_TYPEDEF_(0xC00D717EL)
...
//
#define MF_E_ITA_UNRECOGNIZED_DIGITAL_VIDEO_OUTPUT                             \
  _HRESULT_TYPEDEF_(0xC00D7182L)
...
//
#define MF_E_CONTENT_PROTECTION_SYSTEM_NOT_ENABLED                             \
  _HRESULT_TYPEDEF_(0xC00D7185L)
...
//
#define MF_E_UNSUPPORTED_CONTENT_PROTECTION_SYSTEM                             \
  _HRESULT_TYPEDEF_(0xC00D7186L)
...
// MessageText:
//
// Timer::SetTimer returns this success code if called happened while timer is
// stopped. Timer is not going to be dispatched until clock is running.%0
//
...
// MessageText:
//
// The clock can't return a valid time because the audio position returned from
// the audio playback device is unexpected.%0
//
#define MF_E_CLOCK_AUDIO_DEVICE_POSITION_UNEXPECTED                            \
  _HRESULT_TYPEDEF_(0x000D9C45L)
...
// MessageText:
//
// The clock can't return a valid render time because the audio position
// specified to the clock is unexpected.%0
//
#define MF_E_CLOCK_AUDIO_RENDER_POSITION_UNEXPECTED                            \
  _HRESULT_TYPEDEF_(0x000D9C46L)
...
// MessageText:
//
// The clock can't return a valid render position because the timestamp
// specified to the clock is unexpected.%0
//
...
// MessageText:
//
// Quality Manager is in an invalid state. Quality Management is off at this
// moment.%0
//
...
// MessageText:
//
// The profile does not have a media type configuration for any selected source
// streams.%0
//
#define MF_E_TRANSCODE_PROFILE_NO_MATCHING_STREAMS                             \
  _HRESULT_TYPEDEF_(0xC00DA411L)
...
// MessageText:
//
// The effects previously added were incompatible with the new topology which
// caused all effects to be removed.%0
//
...
// MessageText:
//
// The capture source device has an asynchronous extended property operation in
// progress.%0
//
#define MF_E_CAPTURE_SOURCE_DEVICE_EXTENDEDPROP_OP_IN_PROGRESS                 \
  _HRESULT_TYPEDEF_(0xC00DABE9L)
...
// MessageText:
//
// Hardware accelerated thumbnail generation is not supported for the currently
// selected mediatype on the mediacapture stream.%0
//
#define MF_E_HW_ACCELERATED_THUMBNAIL_NOT_SUPPORTED                            \
  _HRESULT_TYPEDEF_(0xC00DABECL)
...
// MessageText:
//
// Capture device that is present on the system is not supported by Media
// Foundation.%0
//
...
// MessageText:
//
// Attaching Media Timeline Controller is blocked because of the current state
// of the object.%0
//
