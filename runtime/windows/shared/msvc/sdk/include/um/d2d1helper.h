...
static COM_DECLSPEC_NOTHROW inline FLOAT FloatMax() {
#ifdef FLT_MAX
  return FLT_MAX;
#else
...
COM_DECLSPEC_NOTHROW D2D1FORCEINLINE typename TypeTraits<Type>::Point
...
template <typename Type>
COM_DECLSPEC_NOTHROW D2D1FORCEINLINE typename TypeTraits<Type>::Size
...
template <typename Type>
COM_DECLSPEC_NOTHROW D2D1FORCEINLINE typename TypeTraits<Type>::Rect
...
D2D1FORCEINLINE
D2D1_ARC_SEGMENT
ArcSegment(_In_ CONST D2D1_POINT_2F &point, _In_ CONST D2D1_SIZE_F &size,
           _In_ FLOAT rotationAngle, _In_ D2D1_SWEEP_DIRECTION sweepDirection,
...
D2D1FORCEINLINE
D2D1_BEZIER_SEGMENT
BezierSegment(_In_ CONST D2D1_POINT_2F &point1,
...
QuadraticBezierSegment(_In_ CONST D2D1_POINT_2F &point1,
                       _In_ CONST D2D1_POINT_2F &point2) {
...
LinearGradientBrushProperties(_In_ CONST D2D1_POINT_2F &startPoint,
...
RadialGradientBrushProperties(_In_ CONST D2D1_POINT_2F &center,
...
D2D1FORCEINLINE
D2D1_PIXEL_FORMAT
PixelFormat(_In_ DXGI_FORMAT dxgiFormat = DXGI_FORMAT_UNKNOWN,
...
HwndRenderTargetProperties(
    _In_ HWND hwnd,
    _In_ D2D1_SIZE_U pixelSize = D2D1::Size(static_cast<UINT32>(0),
...
private:
  COM_DECLSPEC_NOTHROW
  D2D1FORCEINLINE
  void Init(UINT32 rgb, FLOAT alpha) {
...
public:
  ...
  //
  static COM_DECLSPEC_NOTHROW D2D1FORCEINLINE Matrix3x2F Identity() {
    Matrix3x2F identity;
  ...
  static COM_DECLSPEC_NOTHROW D2D1FORCEINLINE Matrix3x2F
  Translation(D2D1_SIZE_F size) {
  ...
  static COM_DECLSPEC_NOTHROW D2D1FORCEINLINE Matrix3x2F Translation(FLOAT x,
                                                                     FLOAT y) {
  ...
  //
  static COM_DECLSPEC_NOTHROW inline const Matrix3x2F *
  ReinterpretBaseType(const D2D1_MATRIX_3X2_F *pMatrix) {
    return static_cast<const Matrix3x2F *>(pMatrix);
  }

  static COM_DECLSPEC_NOTHROW inline Matrix3x2F *
