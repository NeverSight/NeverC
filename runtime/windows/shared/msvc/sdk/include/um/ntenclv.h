...
typedef struct _VBS_BASIC_ENCLAVE_THREAD_DESCRIPTOR32 {
  ...
  ULONG ExceptionActive;
    ...
    *PVBS_BASIC_ENCLAVE_THREAD_DESCRIPTOR32;
...
typedef struct _VBS_BASIC_ENCLAVE_THREAD_DESCRIPTOR64 {
  ...
  ULONG ExceptionActive;
    ...
    *PVBS_BASIC_ENCLAVE_THREAD_DESCRIPTOR64;

#ifdef _WIN64
typedef VBS_BASIC_ENCLAVE_THREAD_DESCRIPTOR64
    VBS_BASIC_ENCLAVE_THREAD_DESCRIPTOR;
typedef PVBS_BASIC_ENCLAVE_THREAD_DESCRIPTOR64
    PVBS_BASIC_ENCLAVE_THREAD_DESCRIPTOR;
#else
typedef VBS_BASIC_ENCLAVE_THREAD_DESCRIPTOR32
    VBS_BASIC_ENCLAVE_THREAD_DESCRIPTOR;
typedef PVBS_BASIC_ENCLAVE_THREAD_DESCRIPTOR32
    PVBS_BASIC_ENCLAVE_THREAD_DESCRIPTOR;
#endif
...
typedef VOID
VBS_BASIC_ENCLAVE_BASIC_CALL_RETURN_FROM_ENCLAVE(_In_ ULONG_PTR ReturnValue);

typedef LONG VBS_BASIC_ENCLAVE_BASIC_CALL_RETURN_FROM_EXCEPTION(
    _In_ PVBS_BASIC_ENCLAVE_EXCEPTION ExceptionRecord);

typedef LONG VBS_BASIC_ENCLAVE_BASIC_CALL_TERMINATE_THREAD(
    _In_ PVBS_BASIC_ENCLAVE_THREAD_DESCRIPTOR ThreadDescriptor);

typedef LONG VBS_BASIC_ENCLAVE_BASIC_CALL_INTERRUPT_THREAD(
    _In_ PVBS_BASIC_ENCLAVE_THREAD_DESCRIPTOR ThreadDescriptor);

typedef LONG VBS_BASIC_ENCLAVE_BASIC_CALL_COMMIT_PAGES(
    _In_ PVOID EnclaveAddress, _In_ SIZE_T NumberOfBytes,
    _In_opt_ PVOID SourceAddress, _In_ ULONG PageProtection);

typedef LONG
VBS_BASIC_ENCLAVE_BASIC_CALL_DECOMMIT_PAGES(_In_ PVOID EnclaveAddress,
                                            _In_ SIZE_T NumberOfBytes);

typedef LONG
VBS_BASIC_ENCLAVE_BASIC_CALL_PROTECT_PAGES(_In_ PVOID EnclaveAddress,
                                           _In_ SIZE_T NumberOfytes,
                                           _In_ ULONG PageProtection);

typedef LONG VBS_BASIC_ENCLAVE_BASIC_CALL_CREATE_THREAD(
    _In_ PVBS_BASIC_ENCLAVE_THREAD_DESCRIPTOR ThreadDescriptor);

typedef LONG VBS_BASIC_ENCLAVE_BASIC_CALL_GET_ENCLAVE_INFORMATION(
...
typedef LONG VBS_BASIC_ENCLAVE_BASIC_CALL_GENERATE_KEY(
...
typedef LONG VBS_BASIC_ENCLAVE_BASIC_CALL_GENERATE_REPORT(
...
typedef LONG VBS_BASIC_ENCLAVE_BASIC_CALL_VERIFY_REPORT(
    _In_reads_bytes_(ReportSize) const VOID *Report, _In_ UINT32 ReportSize);

typedef LONG VBS_BASIC_ENCLAVE_BASIC_CALL_GENERATE_RANDOM_DATA(
    _Out_writes_bytes_(NumberOfBytes) PUCHAR Buffer, _In_ ULONG NumberOfBytes,
