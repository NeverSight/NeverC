...
typedef struct IPNPXAssociationVtbl {
  ...
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in IPNPXAssociation *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IPNPXAssociation *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IPNPXAssociation *This);
...
interface IPNPXAssociation { CONST_VTBL struct IPNPXAssociationVtbl *lpVtbl; };
...
public:
  virtual HRESULT STDMETHODCALLTYPE Associate(
      ...
      /* [in] */ __RPC__in_opt IFunctionDiscoveryNotification
          *pIFunctionDiscoveryNotification) = 0;
...
typedef struct IPNPXDeviceAssociationVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IPNPXDeviceAssociation *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IPNPXDeviceAssociation *This);
...
#define IPNPXDeviceAssociation_Associate(This, pszSubCategory,                 \
                                         pIFunctionDiscoveryNotification)      \
  ((This)->lpVtbl->Associate(This, pszSubCategory,                             \
                             pIFunctionDiscoveryNotification))

#define IPNPXDeviceAssociation_Unassociate(This, pszSubCategory,               \
                                           pIFunctionDiscoveryNotification)    \
  ((This)->lpVtbl->Unassociate(This, pszSubCategory,                           \
                               pIFunctionDiscoveryNotification))

#define IPNPXDeviceAssociation_Delete(This, pszSubcategory,                    \
                                      pIFunctionDiscoveryNotification)         \
  ((This)->lpVtbl->Delete(This, pszSubcategory,                                \
                          pIFunctionDiscoveryNotification))
...
class DECLSPEC_UUID("cee8ccc9-4f6b-4469-a235-5a22869eef03") PNPXAssociation;
#endif
...
class DECLSPEC_UUID("B8A27942-ADE7-4085-AA6E-4FADC7ADA1EF") PNPXPairingHandler;
#endif
