...
// APIs
HRESULT WINAPI RegisterOnlineBackupWithWindowsServerBackup(
    _In_ IN WSB_OB_REGISTRATION_INFO *pOBRegistrationInfo);
HRESULT WINAPI
DeregisterOnlineBackupFromWindowsServerBackup(_In_ IN GUID guidSnapinId);
HRESULT WINAPI UpdateOBStatusInWindowsServerBackup(
    _In_ IN WSB_OB_STATUS_INFO *pOBRegistrationInfo);
