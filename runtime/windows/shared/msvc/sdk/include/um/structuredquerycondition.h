...
extern RPC_IF_HANDLE
    __MIDL_itf_structuredquerycondition_0000_0000_v0_0_c_ifspec;
extern RPC_IF_HANDLE
    __MIDL_itf_structuredquerycondition_0000_0000_v0_0_s_ifspec;
...
typedef struct IRichChunkVtbl {
  ...
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in IRichChunk *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IRichChunk *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IRichChunk *This);
...
interface IRichChunk { CONST_VTBL struct IRichChunkVtbl *lpVtbl; };
...
IRichChunk_RemoteGetData_Proxy(__RPC__in IRichChunk *This,
...
typedef struct IConditionVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in ICondition *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in ICondition *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in ICondition *This);
  ...
  HRESULT(STDMETHODCALLTYPE *IsDirty)(__RPC__in ICondition *This);
...
interface ICondition { CONST_VTBL struct IConditionVtbl *lpVtbl; };
...
/* [call_as] */ HRESULT
STDMETHODCALLTYPE ICondition_RemoteGetComparisonInfo_Proxy(
    __RPC__in ICondition *This,
...
typedef struct ICondition2Vtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in ICondition2 *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in ICondition2 *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in ICondition2 *This);
  ...
  DECLSPEC_XFGVIRT(IPersistStream, IsDirty)
  HRESULT(STDMETHODCALLTYPE *IsDirty)(__RPC__in ICondition2 *This);
...
interface ICondition2 { CONST_VTBL struct ICondition2Vtbl *lpVtbl; };
...
/* [call_as] */ HRESULT
STDMETHODCALLTYPE ICondition2_RemoteGetLeafConditionInfo_Proxy(
    __RPC__in ICondition2 *This,
...
extern RPC_IF_HANDLE
    __MIDL_itf_structuredquerycondition_0000_0003_v0_0_c_ifspec;
extern RPC_IF_HANDLE
    __MIDL_itf_structuredquerycondition_0000_0003_v0_0_s_ifspec;
...
IRichChunk_GetData_Proxy(IRichChunk *This,
                         /* [annotation][unique][out] */
                         _Out_opt_ ULONG *pFirstPos,
                         /* [annotation][unique][out] */
                         _Out_opt_ ULONG *pLength,
...
/* [call_as] */ HRESULT STDMETHODCALLTYPE
IRichChunk_GetData_Stub(__RPC__in IRichChunk *This,
                        /* [out] */ __RPC__out ULONG *pFirstPos,
                        /* [out] */ __RPC__out ULONG *pLength,
                        /* [out] */ __RPC__deref_out_opt LPWSTR *ppsz,
                        /* [out] */ __RPC__out PROPVARIANT *pValue);
...
/* [local] */ HRESULT STDMETHODCALLTYPE
ICondition_GetInputTerms_Proxy(ICondition *This,
                               /* [annotation][unique][out] */
                               _Out_opt_ IRichChunk **ppPropertyTerm,
                               /* [annotation][unique][out] */
                               _Out_opt_ IRichChunk **ppOperationTerm,
...
/* [local] */ HRESULT STDMETHODCALLTYPE
ICondition2_GetLeafConditionInfo_Proxy(ICondition2 *This,
                                       /* [annotation][out] */
                                       _Out_opt_ PROPERTYKEY *ppropkey,
                                       /* [annotation][out] */
                                       _Out_opt_ CONDITION_OPERATION *pcop,
