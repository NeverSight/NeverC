...
protected:
  ...
  const TRefPointerCollection<TYPED_PTR> &
  Copy(const TRefPointerCollection<TYPED_PTR> &);
...
//	Inputs:		None.
//
//	Outputs:	REFPTRCOLLECTION_POSITION&	pos - Position we
// retrieved.
//
...
template <class TYPED_PTR>
BOOL TRefPointerCollection<TYPED_PTR>::BeginEnum(
...
//				on the way out.  User must Release the pointer
// himself.
//
////////////////////////////////////////////////////////////////////////
...
template <class TYPED_PTR>
TYPED_PTR *
TRefPointerCollection<TYPED_PTR>::GetNext(REFPTRCOLLECTION_POSITION &pos) {
  TYPED_PTR *ptr = NULL;
...
template <class TYPED_PTR> void TRefPointerCollection<TYPED_PTR>::Empty(void) {
...
template <class TYPED_PTR>
const TRefPointerCollection<TYPED_PTR> &TRefPointerCollection<TYPED_PTR>::Copy(
    const TRefPointerCollection<TYPED_PTR> &collection) {
  // By default this is an infinite wait, so it best come back
  BeginWrite();
