...
DEFINE_UIPROPERTYKEY(UI_PKEY_StandardColorsTooltips, VT_VECTOR | VT_LPWSTR,
                     412);
...
typedef struct IUISimplePropertySetVtbl {
  ...
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(IUISimplePropertySet *This,
                                             /* [in] */ REFIID riid,
  ...
  /* [annotation] */
  _Check_return_
  HRESULT(STDMETHODCALLTYPE *GetValue)(IUISimplePropertySet *This,
                                       /* [in] */ REFPROPERTYKEY key,
...
public:
  virtual /* [annotation] */
      _Check_return_ HRESULT STDMETHODCALLTYPE GetHeight(
          /* [out] */ UINT32 * cy) = 0;

  virtual /* [annotation] */
      _Check_return_ HRESULT STDMETHODCALLTYPE LoadSettingsFromStream(
          /* [in] */ IStream * pStream) = 0;

  virtual /* [annotation] */
      _Check_return_ HRESULT STDMETHODCALLTYPE SaveSettingsToStream(
          /* [in] */ IStream * pStream) = 0;
};
...
typedef struct IUIRibbonVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(IUIRibbon *This,
                                             /* [in] */ REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);
  ...
  /* [annotation] */
  _Check_return_ HRESULT(STDMETHODCALLTYPE *GetHeight)(IUIRibbon *This,
                                                       /* [out] */ UINT32 *cy);
  ...
  /* [annotation] */
  _Check_return_
  HRESULT(STDMETHODCALLTYPE *SaveSettingsToStream)(IUIRibbon *This,
                                                   /* [in] */ IStream *pStream);

  END_INTERFACE
} IUIRibbonVtbl;

interface IUIRibbon { CONST_VTBL struct IUIRibbonVtbl *lpVtbl; };
...
public:
  ...
  virtual /* [annotation] */
      _Check_return_ HRESULT STDMETHODCALLTYPE
      GetView(UINT32 viewId, REFIID riid,
              /* [annotation][iid_is][out] */
              _Outptr_ void **ppv) = 0;

  virtual /* [annotation] */
      _Check_return_ HRESULT STDMETHODCALLTYPE
      GetUICommandProperty(UINT32 commandId,
                           /* [in] */ REFPROPERTYKEY key,
                           /* [out] */ PROPVARIANT * value) = 0;

  virtual /* [annotation] */
      _Check_return_ HRESULT STDMETHODCALLTYPE
      SetUICommandProperty(UINT32 commandId,
                           /* [in] */ REFPROPERTYKEY key,
                           /* [in] */ REFPROPVARIANT value) = 0;

  virtual /* [annotation] */
      _Check_return_ HRESULT STDMETHODCALLTYPE
      InvalidateUICommand(UINT32 commandId, UI_INVALIDATIONS flags,
                          /* [annotation][in] */
...
typedef struct IUIFrameworkVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(IUIFramework *This,
                                             /* [in] */ REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);
  ...
  /* [annotation] */
  _Check_return_ HRESULT(STDMETHODCALLTYPE *Initialize)(
      IUIFramework *This,
      /* [in] */ HWND frameWnd,
  ...
  /* [annotation] */
  _Check_return_
  HRESULT(STDMETHODCALLTYPE *LoadUI)(IUIFramework *This,
                                     /* [in] */ HINSTANCE instance,
  ...
  /* [annotation] */
  _Check_return_
  HRESULT(STDMETHODCALLTYPE *GetView)(IUIFramework *This, UINT32 viewId,
                                      REFIID riid,
                                      /* [annotation][iid_is][out] */
                                      _Outptr_ void **ppv);
  ...
  /* [annotation] */
  _Check_return_ HRESULT(STDMETHODCALLTYPE *GetUICommandProperty)(
      IUIFramework *This, UINT32 commandId,
      /* [in] */ REFPROPERTYKEY key,
      /* [out] */ PROPVARIANT *value);

  DECLSPEC_XFGVIRT(IUIFramework, SetUICommandProperty)
  /* [annotation] */
  _Check_return_ HRESULT(STDMETHODCALLTYPE *SetUICommandProperty)(
      IUIFramework *This, UINT32 commandId,
      /* [in] */ REFPROPERTYKEY key,
  ...
  /* [annotation] */
  _Check_return_ HRESULT(STDMETHODCALLTYPE *InvalidateUICommand)(
      IUIFramework *This, UINT32 commandId, UI_INVALIDATIONS flags,
      /* [annotation][in] */
  ...
  /* [annotation] */
  _Check_return_ HRESULT(STDMETHODCALLTYPE *SetModes)(IUIFramework *This,
                                                      INT32 iModes);

  END_INTERFACE
} IUIFrameworkVtbl;

interface IUIFramework { CONST_VTBL struct IUIFrameworkVtbl *lpVtbl; };
...
typedef struct IUIEventLoggerVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(IUIEventLogger *This,
                                             /* [in] */ REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(IUIEventLogger *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(IUIEventLogger *This);

  DECLSPEC_XFGVIRT(IUIEventLogger, OnUIEvent)
  void(STDMETHODCALLTYPE *OnUIEvent)(IUIEventLogger *This,
                                     /* [in] */ UI_EVENTPARAMS *pEventParams);

  END_INTERFACE
} IUIEventLoggerVtbl;

interface IUIEventLogger { CONST_VTBL struct IUIEventLoggerVtbl *lpVtbl; };
...
#define IUIEventLogger_AddRef(This) ((This)->lpVtbl->AddRef(This))

#define IUIEventLogger_Release(This) ((This)->lpVtbl->Release(This))
...
public:
  virtual /* [annotation] */
      _Check_return_ HRESULT STDMETHODCALLTYPE SetEventLogger(
...
typedef struct IUIEventingManagerVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(IUIEventingManager *This,
                                             /* [in] */ REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(IUIEventingManager *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(IUIEventingManager *This);
...
#define IUIEventingManager_AddRef(This) ((This)->lpVtbl->AddRef(This))

#define IUIEventingManager_Release(This) ((This)->lpVtbl->Release(This))
...
public:
  virtual /* [annotation] */
      _Check_return_ HRESULT STDMETHODCALLTYPE
      ShowAtLocation(INT32 x, INT32 y) = 0;
};
...
typedef struct IUIContextualUIVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(IUIContextualUI *This,
                                             /* [in] */ REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);
  ...
  /* [annotation] */
  _Check_return_
  HRESULT(STDMETHODCALLTYPE *ShowAtLocation)(IUIContextualUI *This, INT32 x,
                                             INT32 y);

  END_INTERFACE
} IUIContextualUIVtbl;

interface IUIContextualUI { CONST_VTBL struct IUIContextualUIVtbl *lpVtbl; };
...
public:
  virtual /* [annotation] */
      _Check_return_ HRESULT STDMETHODCALLTYPE GetCount(
          /* [out] */ UINT32 * count) = 0;

  virtual /* [annotation] */
      _Check_return_ HRESULT STDMETHODCALLTYPE
      GetItem(UINT32 index,
              /* [annotation][out] */
              _Outptr_ IUnknown * *item) = 0;

  virtual /* [annotation] */
      _Check_return_ HRESULT STDMETHODCALLTYPE Add(
          /* [in] */ IUnknown * item) = 0;
...
typedef struct IUICollectionVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(IUICollection *This,
                                             /* [in] */ REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);
  ...
  /* [annotation] */
  _Check_return_
  HRESULT(STDMETHODCALLTYPE *GetCount)(IUICollection *This,
                                       /* [out] */ UINT32 *count);

  DECLSPEC_XFGVIRT(IUICollection, GetItem)
  /* [annotation] */
  _Check_return_ HRESULT(STDMETHODCALLTYPE *GetItem)(IUICollection *This,
                                                     UINT32 index,
                                                     /* [annotation][out] */
  ...
  /* [annotation] */
  _Check_return_ HRESULT(STDMETHODCALLTYPE *Add)(IUICollection *This,
                                                 /* [in] */ IUnknown *item);

  DECLSPEC_XFGVIRT(IUICollection, Insert)
  /* [annotation] */
  _Check_return_ HRESULT(STDMETHODCALLTYPE *Insert)(IUICollection *This,
                                                    UINT32 index,
                                                    /* [in] */ IUnknown *item);

  DECLSPEC_XFGVIRT(IUICollection, RemoveAt)
  /* [annotation] */
  _Check_return_ HRESULT(STDMETHODCALLTYPE *RemoveAt)(IUICollection *This,
                                                      UINT32 index);

  DECLSPEC_XFGVIRT(IUICollection, Replace)
  /* [annotation] */
  _Check_return_
  HRESULT(STDMETHODCALLTYPE *Replace)(IUICollection *This, UINT32 indexReplaced,
                                      /* [in] */ IUnknown *itemReplaceWith);

  DECLSPEC_XFGVIRT(IUICollection, Clear)
  /* [annotation] */
  _Check_return_ HRESULT(STDMETHODCALLTYPE *Clear)(IUICollection *This);

  END_INTERFACE
} IUICollectionVtbl;

interface IUICollection { CONST_VTBL struct IUICollectionVtbl *lpVtbl; };
...
public:
  virtual /* [annotation] */
      _Check_return_ HRESULT STDMETHODCALLTYPE
      OnChanged(UI_COLLECTIONCHANGE action, UINT32 oldIndex,
                /* [annotation][in] */
                _In_opt_ IUnknown * oldItem, UINT32 newIndex,
                /* [annotation][in] */
...
typedef struct IUICollectionChangedEventVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(IUICollectionChangedEvent *This,
                                             /* [in] */ REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);
  ...
  /* [annotation] */
  _Check_return_ HRESULT(STDMETHODCALLTYPE *OnChanged)(
      IUICollectionChangedEvent *This, UI_COLLECTIONCHANGE action,
      UINT32 oldIndex,
      /* [annotation][in] */
      _In_opt_ IUnknown *oldItem, UINT32 newIndex,
      /* [annotation][in] */
...
#define IUICollectionChangedEvent_OnChanged(This, action, oldIndex, oldItem,   \
                                            newIndex, newItem)                 \
  ((This)->lpVtbl->OnChanged(This, action, oldIndex, oldItem, newIndex,        \
                             newItem))
...
public:
  virtual /* [annotation] */
      _Check_return_ HRESULT STDMETHODCALLTYPE
      Execute(UINT32 commandId, UI_EXECUTIONVERB verb,
              /* [annotation][in] */
              _In_opt_ const PROPERTYKEY *key,
              /* [annotation][in] */
  ...
  virtual /* [annotation] */
      _Check_return_ HRESULT STDMETHODCALLTYPE
      UpdateProperty(UINT32 commandId,
                     /* [in] */ REFPROPERTYKEY key,
                     /* [annotation][in] */
                     _In_opt_ const PROPVARIANT *currentValue,
...
typedef struct IUICommandHandlerVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(IUICommandHandler *This,
                                             /* [in] */ REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);
  ...
  /* [annotation] */
  _Check_return_ HRESULT(STDMETHODCALLTYPE *Execute)(
      IUICommandHandler *This, UINT32 commandId, UI_EXECUTIONVERB verb,
      /* [annotation][in] */
      _In_opt_ const PROPERTYKEY *key,
      /* [annotation][in] */
      _In_opt_ const PROPVARIANT *currentValue,
  ...
  /* [annotation] */
  _Check_return_ HRESULT(STDMETHODCALLTYPE *UpdateProperty)(
      IUICommandHandler *This, UINT32 commandId,
      /* [in] */ REFPROPERTYKEY key,
      /* [annotation][in] */
      _In_opt_ const PROPVARIANT *currentValue,
...
#define IUICommandHandler_Execute(This, commandId, verb, key, currentValue,    \
                                  commandExecutionProperties)                  \
  ((This)->lpVtbl->Execute(This, commandId, verb, key, currentValue,           \
                           commandExecutionProperties))

#define IUICommandHandler_UpdateProperty(This, commandId, key, currentValue,   \
                                         newValue)                             \
...
public:
  virtual /* [annotation] */
      _Check_return_ HRESULT STDMETHODCALLTYPE
      OnViewChanged(UINT32 viewId, UI_VIEWTYPE typeID,
                    /* [in] */ IUnknown * view, UI_VIEWVERB verb,
                    INT32 uReasonCode) = 0;
...
typedef struct IUIApplicationVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(IUIApplication *This,
                                             /* [in] */ REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);
  ...
  /* [annotation] */
  _Check_return_ HRESULT(STDMETHODCALLTYPE *OnViewChanged)(
      IUIApplication *This, UINT32 viewId, UI_VIEWTYPE typeID,
      /* [in] */ IUnknown *view, UI_VIEWVERB verb, INT32 uReasonCode);

  DECLSPEC_XFGVIRT(IUIApplication, OnCreateUICommand)
  /* [annotation] */
  _Check_return_ HRESULT(STDMETHODCALLTYPE *OnCreateUICommand)(
      IUIApplication *This, UINT32 commandId, UI_COMMANDTYPE typeID,
      /* [out] */ IUICommandHandler **commandHandler);

  DECLSPEC_XFGVIRT(IUIApplication, OnDestroyUICommand)
  /* [annotation] */
  _Check_return_ HRESULT(STDMETHODCALLTYPE *OnDestroyUICommand)(
      IUIApplication *This, UINT32 commandId, UI_COMMANDTYPE typeID,
      /* [annotation][in] */
...
interface IUIApplication { CONST_VTBL struct IUIApplicationVtbl *lpVtbl; };
...
#define IUIApplication_OnViewChanged(This, viewId, typeID, view, verb,         \
                                     uReasonCode)                              \
  ((This)->lpVtbl->OnViewChanged(This, viewId, typeID, view, verb, uReasonCode))

#define IUIApplication_OnCreateUICommand(This, commandId, typeID,              \
                                         commandHandler)                       \
  ((This)->lpVtbl->OnCreateUICommand(This, commandId, typeID, commandHandler))

#define IUIApplication_OnDestroyUICommand(This, commandId, typeID,             \
                                          commandHandler)                      \
...
public:
  virtual /* [annotation] */
      _Check_return_ HRESULT STDMETHODCALLTYPE GetBitmap(
...
typedef struct IUIImageVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(IUIImage *This,
                                             /* [in] */ REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);
  ...
  /* [annotation] */
  _Check_return_
  HRESULT(STDMETHODCALLTYPE *GetBitmap)(IUIImage *This,
                                        /* [out] */ HBITMAP *bitmap);

  END_INTERFACE
} IUIImageVtbl;

interface IUIImage { CONST_VTBL struct IUIImageVtbl *lpVtbl; };
...
public:
  virtual /* [annotation] */
      _Check_return_ HRESULT STDMETHODCALLTYPE
      CreateImage(
          /* [in] */ HBITMAP bitmap, UI_OWNERSHIP options,
...
typedef struct IUIImageFromBitmapVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(IUIImageFromBitmap *This,
                                             /* [in] */ REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);
  ...
  /* [annotation] */
  _Check_return_
  HRESULT(STDMETHODCALLTYPE *CreateImage)(IUIImageFromBitmap *This,
                                          /* [in] */ HBITMAP bitmap,
...
DEFINE_GUID(CLSID_UIRibbonFramework, 0x926749fa, 0x2615, 0x4987, 0x88, 0x45,
            0xc3, 0x3e, 0x65, 0xf2, 0xb9, 0x57);
DEFINE_GUID(CLSID_UIRibbonImageFromBitmapFactory, 0x0f7434b6, 0x59b6, 0x4250,
            0x99, 0x9e, 0xd1, 0x68, 0xd6, 0xae, 0x42, 0x93);
DEFINE_GUID(LIBID_UIRibbon, 0x942f35c2, 0xe83b, 0x45ef, 0xb0, 0x85, 0xac, 0x29,
            0x5d, 0xd6, 0x3d, 0x5b);
