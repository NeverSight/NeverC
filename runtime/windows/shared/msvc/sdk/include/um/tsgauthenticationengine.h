...
typedef struct ITSGAuthenticateUserSinkVtbl {
  ...
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in ITSGAuthenticateUserSink *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in ITSGAuthenticateUserSink *This);
...
#define ITSGAuthenticateUserSink_OnUserAuthenticated(                          \
    This, userName, userDomain, context, userToken)                            \
  ((This)->lpVtbl->OnUserAuthenticated(This, userName, userDomain, context,    \
                                       userToken))

#define ITSGAuthenticateUserSink_OnUserAuthenticationFailed(                   \
    This, context, genericErrorCode, specificErrorCode)                        \
  ((This)->lpVtbl->OnUserAuthenticationFailed(This, context, genericErrorCode, \
                                              specificErrorCode))
...
typedef struct ITSGAuthenticationEngineVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in ITSGAuthenticationEngine *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in ITSGAuthenticationEngine *This);
...
#define ITSGAuthenticationEngine_AuthenticateUser(                             \
    This, mainSessionId, cookieData, numCookieBytes, context, pSink)           \
  ((This)->lpVtbl->AuthenticateUser(This, mainSessionId, cookieData,           \
                                    numCookieBytes, context, pSink))

#define ITSGAuthenticationEngine_CancelAuthentication(This, mainSessionId,     \
                                                      context)                 \
