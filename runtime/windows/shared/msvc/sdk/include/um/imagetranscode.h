...
typedef struct ITranscodeImageVtbl {
  ...
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in ITranscodeImage *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in ITranscodeImage *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in ITranscodeImage *This);
...
interface ITranscodeImage { CONST_VTBL struct ITranscodeImageVtbl *lpVtbl; };
...
#define ITranscodeImage_TranscodeImage(This, pShellItem, uiMaxWidth,           \
                                       uiMaxHeight, flags, pvImage, puiWidth,  \
                                       puiHeight)                              \
  ((This)->lpVtbl->TranscodeImage(This, pShellItem, uiMaxWidth, uiMaxHeight,   \
                                  flags, pvImage, puiWidth, puiHeight))
...
class DECLSPEC_UUID("17B75166-928F-417d-9685-64AA135565C1") ImageTranscode;
#endif
