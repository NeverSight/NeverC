...
typedef struct IAttributeSetVtbl {
  ...
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in IAttributeSet *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IAttributeSet *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IAttributeSet *This);

  DECLSPEC_XFGVIRT(IAttributeSet, SetAttrib)
  HRESULT(STDMETHODCALLTYPE *SetAttrib)(__RPC__in IAttributeSet *This,
                                        /* [in] */ GUID guidAttribute,
                                        /* [in] */ __RPC__in BYTE *pbAttribute,
...
interface IAttributeSet { CONST_VTBL struct IAttributeSetVtbl *lpVtbl; };
...
#define IAttributeSet_SetAttrib(This, guidAttribute, pbAttribute,              \
                                dwAttributeLength)                             \
  ((This)->lpVtbl->SetAttrib(This, guidAttribute, pbAttribute,                 \
                             dwAttributeLength))
...
typedef struct IAttributeGetVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in IAttributeGet *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IAttributeGet *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IAttributeGet *This);

  DECLSPEC_XFGVIRT(IAttributeGet, GetCount)
  HRESULT(STDMETHODCALLTYPE *GetCount)(__RPC__in IAttributeGet *This,
...
interface IAttributeGet { CONST_VTBL struct IAttributeGetVtbl *lpVtbl; };
...
#define IAttributeGet_GetAttribIndexed(This, lIndex, pguidAttribute,           \
                                       pbAttribute, pdwAttributeLength)        \
  ((This)->lpVtbl->GetAttribIndexed(This, lIndex, pguidAttribute, pbAttribute, \
                                    pdwAttributeLength))

#define IAttributeGet_GetAttrib(This, guidAttribute, pbAttribute,              \
                                pdwAttributeLength)                            \
  ((This)->lpVtbl->GetAttrib(This, guidAttribute, pbAttribute,                 \
                             pdwAttributeLength))
...
#define PIC_SEQ_SAMPLE_ATTR_LEN(cOffsets)                                      \
  (sizeof(PIC_SEQ_SAMPLE) + (cOffsets) * sizeof(SAMPLE_SEQ_OFFSET))
// ------------------------------------------------------
...
typedef struct _TRANSPORT_PROPERTIES {
  ...
  union {
    struct _Others {
      LONGLONG
      TransportScramblingControl : 8, Reserved : 56;
    } Others;
    LONGLONG Value;
  } Fields;
