...
typedef LPVOID(WINAPI *PFNWOWGETVDMPOINTER)(DWORD vp, DWORD dwBytes,
                                            BOOL fProtectedMode);
...
typedef DWORD(WINAPI *PFNWOWGLOBALALLOCLOCK16)(WORD wFlag, DWORD cb,
                                               WORD *phMem);
...
typedef BOOL(WINAPI *PFNWOWCALLBACK16EX)(DWORD vpfn16, DWORD dwFlags,
                                         DWORD cbArgs, PVOID pArgs,
                                         PDWORD pdwRetCode);
...
BOOL WINAPI WOWCallback16Ex(DWORD vpfn16, DWORD dwFlags, DWORD cbArgs,
