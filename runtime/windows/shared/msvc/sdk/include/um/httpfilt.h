...
typedef struct _HTTP_FILTER_CONTEXT {
  ...
  BOOL(WINAPI *WriteClient)(struct _HTTP_FILTER_CONTEXT *pfc, LPVOID Buffer,
...
typedef struct _HTTP_FILTER_PREPROC_HEADERS {
  ...
  BOOL(WINAPI *GetHeader)(struct _HTTP_FILTER_CONTEXT *pfc, LPSTR lpszName,
  ...
  BOOL(WINAPI *SetHeader)(struct _HTTP_FILTER_CONTEXT *pfc, LPSTR lpszName,
                          LPSTR lpszValue);
  ...
  BOOL(WINAPI *AddHeader)(struct _HTTP_FILTER_CONTEXT *pfc, LPSTR lpszName,
                          LPSTR lpszValue);
