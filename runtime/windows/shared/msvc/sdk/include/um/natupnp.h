...
public:
  virtual /* [helpstring][id][propget] */ HRESULT STDMETHODCALLTYPE
      get_StaticPortMappingCollection(
          /* [retval][out] */
          __RPC__deref_out_opt IStaticPortMappingCollection * *ppSPMs) = 0;

  virtual /* [helpstring][id][propget] */ HRESULT STDMETHODCALLTYPE
      get_DynamicPortMappingCollection(
          /* [retval][out] */
          __RPC__deref_out_opt IDynamicPortMappingCollection * *ppDPMs) = 0;

  virtual /* [helpstring][id][propget] */ HRESULT STDMETHODCALLTYPE
      get_NATEventManager(
          /* [retval][out] */ __RPC__deref_out_opt INATEventManager *
          *ppNEM) = 0;
};
...
typedef struct IUPnPNATVtbl {
  ...
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in IUPnPNAT *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IUPnPNAT *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IUPnPNAT *This);
  ...
  /* [helpstring][id][propget] */ HRESULT(
      STDMETHODCALLTYPE *get_StaticPortMappingCollection)(
      __RPC__in IUPnPNAT *This,
      /* [retval][out] */ __RPC__deref_out_opt IStaticPortMappingCollection *
          *ppSPMs);

  DECLSPEC_XFGVIRT(IUPnPNAT, get_DynamicPortMappingCollection)
  /* [helpstring][id][propget] */ HRESULT(
      STDMETHODCALLTYPE *get_DynamicPortMappingCollection)(
      __RPC__in IUPnPNAT *This,
      /* [retval][out] */ __RPC__deref_out_opt IDynamicPortMappingCollection *
          *ppDPMs);

  DECLSPEC_XFGVIRT(IUPnPNAT, get_NATEventManager)
  /* [helpstring][id][propget] */ HRESULT(
      STDMETHODCALLTYPE *get_NATEventManager)(
      __RPC__in IUPnPNAT *This,
...
interface IUPnPNAT { CONST_VTBL struct IUPnPNATVtbl *lpVtbl; };
...
#define IUPnPNAT_Invoke(This, dispIdMember, riid, lcid, wFlags, pDispParams,   \
...
typedef struct INATEventManagerVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in INATEventManager *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in INATEventManager *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in INATEventManager *This);
  ...
  /* [helpstring][propput][id] */ HRESULT(
      STDMETHODCALLTYPE *put_ExternalIPAddressCallback)(
      __RPC__in INATEventManager *This,
      /* [in] */ __RPC__in_opt IUnknown *pUnk);

  DECLSPEC_XFGVIRT(INATEventManager, put_NumberOfEntriesCallback)
  /* [helpstring][propput][id] */ HRESULT(
      STDMETHODCALLTYPE *put_NumberOfEntriesCallback)(
      __RPC__in INATEventManager *This,
      /* [in] */ __RPC__in_opt IUnknown *pUnk);
...
interface INATEventManager { CONST_VTBL struct INATEventManagerVtbl *lpVtbl; };
...
#define INATEventManager_GetIDsOfNames(This, riid, rgszNames, cNames, lcid,    \
                                       rgDispId)                               \
  ((This)->lpVtbl->GetIDsOfNames(This, riid, rgszNames, cNames, lcid, rgDispId))

#define INATEventManager_Invoke(This, dispIdMember, riid, lcid, wFlags,        \
...
#define INATExternalIPAddressCallback_NewExternalIPAddress(                    \
    This, bstrNewExternalIPAddress)                                            \
...
typedef struct INATNumberOfEntriesCallbackVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in INATNumberOfEntriesCallback *This);
...
#define INATNumberOfEntriesCallback_NewNumberOfEntries(This,                   \
                                                       lNewNumberOfEntries)    \
...
#define IDynamicPortMappingCollection_GetIDsOfNames(This, riid, rgszNames,     \
                                                    cNames, lcid, rgDispId)    \
  ((This)->lpVtbl->GetIDsOfNames(This, riid, rgszNames, cNames, lcid, rgDispId))

#define IDynamicPortMappingCollection_Invoke(This, dispIdMember, riid, lcid,   \
...
#define IDynamicPortMappingCollection_get_Item(                                \
    This, bstrRemoteHost, lExternalPort, bstrProtocol, ppDPM)                  \
  ((This)->lpVtbl->get_Item(This, bstrRemoteHost, lExternalPort, bstrProtocol, \
                            ppDPM))

#define IDynamicPortMappingCollection_get_Count(This, pVal)                    \
  ((This)->lpVtbl->get_Count(This, pVal))

#define IDynamicPortMappingCollection_Remove(This, bstrRemoteHost,             \
                                             lExternalPort, bstrProtocol)      \
  ((This)->lpVtbl->Remove(This, bstrRemoteHost, lExternalPort, bstrProtocol))

#define IDynamicPortMappingCollection_Add(                                     \
    This, bstrRemoteHost, lExternalPort, bstrProtocol, lInternalPort,          \
    bstrInternalClient, bEnabled, bstrDescription, lLeaseDuration, ppDPM)      \
  ((This)->lpVtbl->Add(This, bstrRemoteHost, lExternalPort, bstrProtocol,      \
                       lInternalPort, bstrInternalClient, bEnabled,            \
                       bstrDescription, lLeaseDuration, ppDPM))
...
typedef struct IDynamicPortMappingVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IDynamicPortMapping *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IDynamicPortMapping *This);
  ...
  /* [helpstring][id][propget] */ HRESULT(
      STDMETHODCALLTYPE *get_ExternalIPAddress)(
      __RPC__in IDynamicPortMapping *This,
  ...
  /* [helpstring][id][propget] */ HRESULT(
      STDMETHODCALLTYPE *get_InternalClient)(
      __RPC__in IDynamicPortMapping *This,
      /* [retval][out] */ __RPC__deref_out_opt BSTR *pVal);
...
#define IDynamicPortMapping_GetIDsOfNames(This, riid, rgszNames, cNames, lcid, \
                                          rgDispId)                            \
  ((This)->lpVtbl->GetIDsOfNames(This, riid, rgszNames, cNames, lcid, rgDispId))

#define IDynamicPortMapping_Invoke(This, dispIdMember, riid, lcid, wFlags,     \
...
#define IDynamicPortMapping_RenewLease(This, lLeaseDurationDesired,            \
                                       pLeaseDurationReturned)                 \
  ((This)->lpVtbl->RenewLease(This, lLeaseDurationDesired,                     \
                              pLeaseDurationReturned))
...
#define IStaticPortMappingCollection_GetIDsOfNames(This, riid, rgszNames,      \
                                                   cNames, lcid, rgDispId)     \
  ((This)->lpVtbl->GetIDsOfNames(This, riid, rgszNames, cNames, lcid, rgDispId))

#define IStaticPortMappingCollection_Invoke(This, dispIdMember, riid, lcid,    \
                                            wFlags, pDispParams, pVarResult,   \
                                            pExcepInfo, puArgErr)              \
  ((This)->lpVtbl->Invoke(This, dispIdMember, riid, lcid, wFlags, pDispParams, \
                          pVarResult, pExcepInfo, puArgErr))
...
#define IStaticPortMappingCollection_get_Item(This, lExternalPort,             \
                                              bstrProtocol, ppSPM)             \
...
#define IStaticPortMappingCollection_Add(This, lExternalPort, bstrProtocol,    \
                                         lInternalPort, bstrInternalClient,    \
                                         bEnabled, bstrDescription, ppSPM)     \
  ((This)->lpVtbl->Add(This, lExternalPort, bstrProtocol, lInternalPort,       \
                       bstrInternalClient, bEnabled, bstrDescription, ppSPM))
...
typedef struct IStaticPortMappingVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in IStaticPortMapping *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IStaticPortMapping *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IStaticPortMapping *This);
...
#define IStaticPortMapping_GetIDsOfNames(This, riid, rgszNames, cNames, lcid,  \
                                         rgDispId)                             \
  ((This)->lpVtbl->GetIDsOfNames(This, riid, rgszNames, cNames, lcid, rgDispId))

#define IStaticPortMapping_Invoke(This, dispIdMember, riid, lcid, wFlags,      \
                                  pDispParams, pVarResult, pExcepInfo,         \
                                  puArgErr)                                    \
  ((This)->lpVtbl->Invoke(This, dispIdMember, riid, lcid, wFlags, pDispParams, \
                          pVarResult, pExcepInfo, puArgErr))
