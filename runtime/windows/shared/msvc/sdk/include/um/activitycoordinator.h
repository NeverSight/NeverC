/****************************************************************************************************
 *                                                                                                   *
 * activitycoordinator.h - ApiSet Contract for
 * ext-ms-win-resourcemanager-activitycoordinator-l1.lib *
 *                                                                                                   *
...
SubscribeActivityCoordinatorPolicy(
    _In_ ACTIVITY_COORDINATOR_POLICY policy,
    _In_ ACTIVITY_COORDINATOR_CALLBACK callback, _In_opt_ void *callbackContext,
    _Outptr_result_nullonfailure_ ACTIVITY_COORDINATOR_SUBSCRIPTION
        *subscription);
...
BOOL WINAPI IsActivityCoordinatorResourceSupported(
    _In_ ACTIVITY_COORDINATOR_RESOURCE Resource);
...
BOOLEAN
__stdcall IsCreateActivityCoordinatorPolicyPresent(VOID);

BOOLEAN
__stdcall IsSetActivityCoordinatorPolicyResourceConditionPresent(VOID);

BOOLEAN
__stdcall IsGetActivityCoordinatorPolicyResourceConditionPresent(VOID);

BOOLEAN
__stdcall IsDestroyActivityCoordinatorPolicyPresent(VOID);

BOOLEAN
__stdcall IsSubscribeActivityCoordinatorPolicyPresent(VOID);

BOOLEAN
__stdcall IsUnsubscribeActivityCoordinatorPolicyPresent(VOID);

BOOLEAN
__stdcall IsIsActivityCoordinatorResourceSupportedPresent(VOID);
