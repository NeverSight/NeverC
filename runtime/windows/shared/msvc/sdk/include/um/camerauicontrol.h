...
typedef struct ICameraUIControlEventCallbackVtbl {
  ...
  ULONG(STDMETHODCALLTYPE *AddRef)(ICameraUIControlEventCallback *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(ICameraUIControlEventCallback *This);
  ...
  void(STDMETHODCALLTYPE *OnItemCaptured)(ICameraUIControlEventCallback *This,
                                          /* [annotation][in] */
                                          _In_ LPCWSTR pszPath);

  DECLSPEC_XFGVIRT(ICameraUIControlEventCallback, OnItemDeleted)
  void(STDMETHODCALLTYPE *OnItemDeleted)(ICameraUIControlEventCallback *This,
                                         /* [annotation][in] */
                                         _In_ LPCWSTR pszPath);

  DECLSPEC_XFGVIRT(ICameraUIControlEventCallback, OnClosed)
  void(STDMETHODCALLTYPE *OnClosed)(ICameraUIControlEventCallback *This);
...
typedef struct ICameraUIControlVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(ICameraUIControl *This,
                                             /* [in] */ REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(ICameraUIControl *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(ICameraUIControl *This);
  ...
  HRESULT(STDMETHODCALLTYPE *Close)(ICameraUIControl *This);

  DECLSPEC_XFGVIRT(ICameraUIControl, Suspend)
  HRESULT(STDMETHODCALLTYPE *Suspend)(ICameraUIControl *This,
                                      /* [annotation][out] */
                                      _Out_ BOOL *pbDeferralRequired);

  DECLSPEC_XFGVIRT(ICameraUIControl, Resume)
  HRESULT(STDMETHODCALLTYPE *Resume)(ICameraUIControl *This);
  ...
  HRESULT(STDMETHODCALLTYPE *RemoveCapturedItem)(ICameraUIControl *This,
                                                 /* [annotation][in] */
                                                 _In_ LPCWSTR pszPath);
...
interface ICameraUIControl { CONST_VTBL struct ICameraUIControlVtbl *lpVtbl; };
...
#define ICameraUIControl_Show(This, pWindow, mode, selectionMode, captureMode, \
                              photoFormat, videoFormat, bHasCloseButton,       \
                              pEventCallback)                                  \
  ((This)->lpVtbl->Show(This, pWindow, mode, selectionMode, captureMode,       \
                        photoFormat, videoFormat, bHasCloseButton,             \
                        pEventCallback))
