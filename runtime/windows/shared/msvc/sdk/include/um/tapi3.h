...
typedef interface ITTAPIDispatchEventNotification
...
public:
  virtual /* [helpstring][hidden][id] */ HRESULT STDMETHODCALLTYPE
      EnumerateAgentSessions(
          /* [retval][out] */ __RPC__deref_out_opt IEnumAgentSession *
          *ppEnumAgentSession) = 0;
  ...
  virtual /* [helpstring][id] */ HRESULT STDMETHODCALLTYPE CreateSession(
      ...
      /* [retval][out] */ __RPC__deref_out_opt ITAgentSession *
          *ppAgentSession) = 0;
...
typedef struct ITAgentVtbl {
  ...
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in ITAgent *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in ITAgent *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in ITAgent *This);
  ...
  /* [helpstring][hidden][id] */ HRESULT(
      STDMETHODCALLTYPE *EnumerateAgentSessions)(
      __RPC__in ITAgent *This,
      /* [retval][out] */ __RPC__deref_out_opt IEnumAgentSession *
          *ppEnumAgentSession);
...
interface ITAgent { CONST_VTBL struct ITAgentVtbl *lpVtbl; };
...
public:
  ...
  virtual /* [helpstring][id][propget] */ HRESULT STDMETHODCALLTYPE
      get_ACDGroup(
          /* [retval][out] */ __RPC__deref_out_opt ITACDGroup *
          *ppACDGroup) = 0;
...
typedef struct ITAgentSessionVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in ITAgentSession *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in ITAgentSession *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in ITAgentSession *This);
  ...
  /* [helpstring][id][propget] */ HRESULT(
      STDMETHODCALLTYPE *get_AverageTalkTime)(
      __RPC__in ITAgentSession *This,
      /* [retval][out] */ __RPC__out long *plTalkTime);
  ...
  /* [helpstring][id][propget] */ HRESULT(
      STDMETHODCALLTYPE *get_AverageCallTime)(
      __RPC__in ITAgentSession *This,
      /* [retval][out] */ __RPC__out long *plCallTime);
  ...
  /* [helpstring][id][propget] */ HRESULT(
      STDMETHODCALLTYPE *get_AverageWrapUpTime)(
      __RPC__in ITAgentSession *This,
      /* [retval][out] */ __RPC__out long *plWrapUpTime);
...
interface ITAgentSession { CONST_VTBL struct ITAgentSessionVtbl *lpVtbl; };
...
public:
  ...
  virtual /* [helpstring][hidden][id] */ HRESULT STDMETHODCALLTYPE
      EnumerateQueues(
          /* [retval][out] */ __RPC__deref_out_opt IEnumQueue *
          *ppEnumQueue) = 0;
...
typedef struct ITACDGroupVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in ITACDGroup *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in ITACDGroup *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in ITACDGroup *This);
...
interface ITACDGroup { CONST_VTBL struct ITACDGroupVtbl *lpVtbl; };
...
typedef struct ITQueueVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in ITQueue *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in ITQueue *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in ITQueue *This);
  ...
  /* [helpstring][id][propput] */ HRESULT(
      STDMETHODCALLTYPE *put_MeasurementPeriod)(__RPC__in ITQueue *This,
                                                /* [in] */ long lPeriod);
...
interface ITQueue { CONST_VTBL struct ITQueueVtbl *lpVtbl; };
...
typedef struct ITAgentEventVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in ITAgentEvent *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in ITAgentEvent *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in ITAgentEvent *This);
...
interface ITAgentEvent { CONST_VTBL struct ITAgentEventVtbl *lpVtbl; };
...
typedef struct ITAgentSessionEventVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in ITAgentSessionEvent *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in ITAgentSessionEvent *This);
...
typedef struct ITACDGroupEventVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in ITACDGroupEvent *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in ITACDGroupEvent *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in ITACDGroupEvent *This);
...
interface ITACDGroupEvent { CONST_VTBL struct ITACDGroupEventVtbl *lpVtbl; };
...
typedef struct ITQueueEventVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in ITQueueEvent *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in ITQueueEvent *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in ITQueueEvent *This);
...
interface ITQueueEvent { CONST_VTBL struct ITQueueEventVtbl *lpVtbl; };
...
public:
  virtual /* [helpstring][id][propget] */ HRESULT STDMETHODCALLTYPE
      get_AgentHandler(
          /* [retval][out] */ __RPC__deref_out_opt ITAgentHandler *
          *ppAgentHandler) = 0;
...
typedef struct ITAgentHandlerEventVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in ITAgentHandlerEvent *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in ITAgentHandlerEvent *This);
...
public:
  virtual /* [helpstring][hidden][id] */ HRESULT STDMETHODCALLTYPE
      EnumerateAgentHandlers(
          /* [retval][out] */ __RPC__deref_out_opt IEnumAgentHandler *
          *ppEnumHandler) = 0;
...
typedef struct ITTAPICallCenterVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in ITTAPICallCenter *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in ITTAPICallCenter *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in ITTAPICallCenter *This);
  ...
  /* [helpstring][hidden][id] */ HRESULT(
      STDMETHODCALLTYPE *EnumerateAgentHandlers)(
      __RPC__in ITTAPICallCenter *This,
      /* [retval][out] */ __RPC__deref_out_opt IEnumAgentHandler *
          *ppEnumHandler);
...
interface ITTAPICallCenter { CONST_VTBL struct ITTAPICallCenterVtbl *lpVtbl; };
...
public:
  ...
  virtual /* [helpstring][hidden][id] */ HRESULT STDMETHODCALLTYPE
      EnumerateACDGroups(
          /* [retval][out] */ __RPC__deref_out_opt IEnumACDGroup *
          *ppEnumACDGroup) = 0;
...
typedef struct ITAgentHandlerVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in ITAgentHandler *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in ITAgentHandler *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in ITAgentHandler *This);
  ...
  /* [helpstring][hidden][id] */ HRESULT(
      STDMETHODCALLTYPE *EnumerateUsableAddresses)(
      __RPC__in ITAgentHandler *This,
  ...
  /* [helpstring][id][propget] */ HRESULT(
      STDMETHODCALLTYPE *get_UsableAddresses)(
      __RPC__in ITAgentHandler *This,
      /* [retval][out] */ __RPC__out VARIANT *pVariant);
...
interface ITAgentHandler { CONST_VTBL struct ITAgentHandlerVtbl *lpVtbl; };
...
typedef struct IEnumAgentVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in IEnumAgent *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IEnumAgent *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IEnumAgent *This);
  ...
  HRESULT(STDMETHODCALLTYPE *Reset)(__RPC__in IEnumAgent *This);

  DECLSPEC_XFGVIRT(IEnumAgent, Skip)
  HRESULT(STDMETHODCALLTYPE *Skip)(__RPC__in IEnumAgent *This,
                                   /* [in] */ ULONG celt);
...
interface IEnumAgent { CONST_VTBL struct IEnumAgentVtbl *lpVtbl; };
...
typedef struct IEnumAgentSessionVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in IEnumAgentSession *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IEnumAgentSession *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IEnumAgentSession *This);
  ...
  HRESULT(STDMETHODCALLTYPE *Reset)(__RPC__in IEnumAgentSession *This);

  DECLSPEC_XFGVIRT(IEnumAgentSession, Skip)
  HRESULT(STDMETHODCALLTYPE *Skip)(__RPC__in IEnumAgentSession *This,
                                   /* [in] */ ULONG celt);
...
typedef struct IEnumQueueVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in IEnumQueue *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IEnumQueue *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IEnumQueue *This);
  ...
  HRESULT(STDMETHODCALLTYPE *Reset)(__RPC__in IEnumQueue *This);

  DECLSPEC_XFGVIRT(IEnumQueue, Skip)
  HRESULT(STDMETHODCALLTYPE *Skip)(__RPC__in IEnumQueue *This,
                                   /* [in] */ ULONG celt);
...
interface IEnumQueue { CONST_VTBL struct IEnumQueueVtbl *lpVtbl; };
...
typedef struct IEnumACDGroupVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in IEnumACDGroup *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IEnumACDGroup *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IEnumACDGroup *This);
  ...
  HRESULT(STDMETHODCALLTYPE *Reset)(__RPC__in IEnumACDGroup *This);

  DECLSPEC_XFGVIRT(IEnumACDGroup, Skip)
  HRESULT(STDMETHODCALLTYPE *Skip)(__RPC__in IEnumACDGroup *This,
                                   /* [in] */ ULONG celt);
...
interface IEnumACDGroup { CONST_VTBL struct IEnumACDGroupVtbl *lpVtbl; };
...
typedef struct IEnumAgentHandlerVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in IEnumAgentHandler *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IEnumAgentHandler *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IEnumAgentHandler *This);
  ...
  HRESULT(STDMETHODCALLTYPE *Reset)(__RPC__in IEnumAgentHandler *This);

  DECLSPEC_XFGVIRT(IEnumAgentHandler, Skip)
  HRESULT(STDMETHODCALLTYPE *Skip)(__RPC__in IEnumAgentHandler *This,
                                   /* [in] */ ULONG celt);
...
typedef struct ITAMMediaFormatVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in ITAMMediaFormat *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in ITAMMediaFormat *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in ITAMMediaFormat *This);
...
interface ITAMMediaFormat { CONST_VTBL struct ITAMMediaFormatVtbl *lpVtbl; };
...
typedef struct ITAllocatorPropertiesVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in ITAllocatorProperties *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in ITAllocatorProperties *This);
...
public:
  ...
  virtual HRESULT STDMETHODCALLTYPE GetEvent(
      ...
      /* [size_is][out][in] */ __RPC__inout_ecount_full(*pdwSize) byte *
          pEventBuffer) = 0;
};
...
typedef struct ITMSPAddressVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in ITMSPAddress *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in ITMSPAddress *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in ITMSPAddress *This);

  DECLSPEC_XFGVIRT(ITMSPAddress, Initialize)
  HRESULT(STDMETHODCALLTYPE *Initialize)(__RPC__in ITMSPAddress *This,
                                         /* [in] */ __RPC__in MSP_HANDLE
                                             hEvent);

  DECLSPEC_XFGVIRT(ITMSPAddress, Shutdown)
  HRESULT(STDMETHODCALLTYPE *Shutdown)(__RPC__in ITMSPAddress *This);
...
interface ITMSPAddress { CONST_VTBL struct ITMSPAddressVtbl *lpVtbl; };
...
class DECLSPEC_UUID("21D6D48E-A88B-11D0-83DD-00AA003CCABD") TAPI;
#endif
...
class DECLSPEC_UUID("E9225296-C759-11d1-A02B-00C04FB6809F") DispatchMapper;
#endif
...
class DECLSPEC_UUID("AC48FFE0-F8C4-11d1-A030-00C04FB6809F") RequestMakeCall;
#endif
