...
typedef interface IFunctionInstanceCollectionQuery
...
typedef interface IFunctionInstanceCollectionQuery2
...
typedef interface IFunctionInstanceCollectionQueryCollection
    IFunctionInstanceCollectionQueryCollection;
...
typedef interface IFunctionDiscoveryProviderRefresh
    IFunctionDiscoveryProviderRefresh;
...
public:
  ...
  virtual HRESULT STDMETHODCALLTYPE GetInstance(
      ...
      /* [retval][out] */ __RPC__deref_out_opt IFunctionInstance *
          *ppIFunctionInstance) = 0;
  ...
  virtual HRESULT STDMETHODCALLTYPE CreateInstanceCollectionQuery(
      ...
      __RPC__deref_out_opt IFunctionInstanceCollectionQuery *
          *ppIFunctionInstanceCollectionQuery) = 0;
  ...
  virtual HRESULT STDMETHODCALLTYPE CreateInstanceQuery(
      ...
      __RPC__inout_opt FDQUERYCONTEXT *pfdqcQueryContext,
      /* [retval][out] */
      __RPC__deref_out_opt IFunctionInstanceQuery *
          *ppIFunctionInstanceQuery) = 0;
...
typedef struct IFunctionDiscoveryVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in IFunctionDiscovery *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IFunctionDiscovery *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IFunctionDiscovery *This);
...
public:
  virtual HRESULT STDMETHODCALLTYPE GetID(
      /* [retval][string][out] */ __RPC__deref_out_opt_string WCHAR *
      *ppszCoMemIdentity) = 0;

  virtual HRESULT STDMETHODCALLTYPE GetProviderInstanceID(
      /* [retval][string][out] */ __RPC__deref_out_opt_string WCHAR *
      *ppszCoMemProviderInstanceIdentity) = 0;
...
typedef struct IFunctionInstanceVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in IFunctionInstance *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IFunctionInstance *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IFunctionInstance *This);
...
#define IFunctionInstance_GetProviderInstanceID(                               \
    This, ppszCoMemProviderInstanceIdentity)                                   \
  ((This)->lpVtbl->GetProviderInstanceID(This,                                 \
                                         ppszCoMemProviderInstanceIdentity))
...
typedef struct IFunctionInstanceCollectionVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IFunctionInstanceCollection *This);
...
#define IFunctionInstanceCollection_Get(This, pszInstanceIdentity, pdwIndex,   \
                                        ppIFunctionInstance)                   \
  ((This)->lpVtbl->Get(This, pszInstanceIdentity, pdwIndex,                    \
                       ppIFunctionInstance))
...
public:
  ...
  virtual HRESULT STDMETHODCALLTYPE Get(
      ...
      /* [retval][out] */
      __RPC__deref_out_opt IPropertyStore **ppIPropertyStore) = 0;
...
typedef struct IPropertyStoreCollectionVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IPropertyStoreCollection *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IPropertyStoreCollection *This);

  DECLSPEC_XFGVIRT(IPropertyStoreCollection, GetCount)
  HRESULT(STDMETHODCALLTYPE *GetCount)(__RPC__in IPropertyStoreCollection *This,
                                       /* [retval][out] */ __RPC__out LPDWORD
                                           pdwCount);
  ...
  HRESULT(STDMETHODCALLTYPE *Delete)(__RPC__in IPropertyStoreCollection *This,
                                     /* [in] */ DWORD dwIndex);
...
#define IPropertyStoreCollection_Get(This, pszInstanceIdentity, pdwIndex,      \
                                     ppIPropertyStore)                         \
...
typedef struct IFunctionInstanceQueryVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IFunctionInstanceQuery *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IFunctionInstanceQuery *This);
