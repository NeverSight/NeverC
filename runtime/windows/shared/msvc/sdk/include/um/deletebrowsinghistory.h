...
DEFINE_GUID(CATID_DeleteBrowsingHistory, 0x31caf6e4, 0xd6aa, 0x4090, 0xa0, 0x50,
            0xa5, 0xac, 0x89, 0x72, 0xe9, 0xef);
EXTERN_C const GUID CATID_DeleteBrowsingHistory;
#define DELETE_BROWSING_HISTORY_HISTORY                                        \
  0x0001 // Indicates that the History checkbox was selected.
#define DELETE_BROWSING_HISTORY_COOKIES                                        \
  0x0002 // Indicates that the Cookies checkbox was selected.
#define DELETE_BROWSING_HISTORY_TIF                                            \
  0x0004 // Indicates that the Temporary Internet Files checkbox was selected.
#define DELETE_BROWSING_HISTORY_FORMDATA                                       \
  0x0008 // Indicates that the Form data checkbox was selected.
#define DELETE_BROWSING_HISTORY_PASSWORDS                                      \
  0x0010 // Indicates that the Passwords checkbox was selected.
#define DELETE_BROWSING_HISTORY_PRESERVEFAVORITES                              \
  0x0020 // Indicates that the Preseve Favorite website data checkbox is
         // selected.
#define DELETE_BROWSING_HISTORY_DOWNLOADHISTORY                                \
  0x0040 // Indicates that the Download History checkbox was selected.
...
public:
  virtual HRESULT STDMETHODCALLTYPE DeleteBrowsingHistory(DWORD dwFlags) = 0;
};
...
typedef struct IDeleteBrowsingHistoryVtbl {
  ...
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IDeleteBrowsingHistory *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IDeleteBrowsingHistory *This);

  DECLSPEC_XFGVIRT(IDeleteBrowsingHistory, DeleteBrowsingHistory)
  HRESULT(STDMETHODCALLTYPE *DeleteBrowsingHistory)(
      __RPC__in IDeleteBrowsingHistory *This, DWORD dwFlags);
