...
typedef struct IWPCProviderStateVtbl {
  ...
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in IWPCProviderState *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IWPCProviderState *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IWPCProviderState *This);

  DECLSPEC_XFGVIRT(IWPCProviderState, Enable)
  HRESULT(STDMETHODCALLTYPE *Enable)(__RPC__in IWPCProviderState *This);

  DECLSPEC_XFGVIRT(IWPCProviderState, Disable)
  HRESULT(STDMETHODCALLTYPE *Disable)(__RPC__in IWPCProviderState *This);
...
public:
  virtual HRESULT STDMETHODCALLTYPE GetUserSummary(
      ...
      /* [string][out] */ __RPC__deref_out_opt_string BSTR *
          pbstrUserSummary) = 0;
...
typedef struct IWPCProviderConfigVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in IWPCProviderConfig *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IWPCProviderConfig *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IWPCProviderConfig *This);
...
typedef struct IWPCSettingsVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in IWPCSettings *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IWPCSettings *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IWPCSettings *This);
...
interface IWPCSettings { CONST_VTBL struct IWPCSettingsVtbl *lpVtbl; };
...
typedef struct IWPCGamesSettingsVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in IWPCGamesSettings *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IWPCGamesSettings *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IWPCGamesSettings *This);
...
public:
  ...
  virtual HRESULT STDMETHODCALLTYPE RequestURLOverride(
      ...
      /* [in] */ DWORD cURLs,
      /* [unique][size_is][in] */ __RPC__in_ecount_full_opt(cURLs) LPCWSTR *
          ppcszSubURLs,
...
typedef struct IWPCWebSettingsVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in IWPCWebSettings *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IWPCWebSettings *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IWPCWebSettings *This);
...
interface IWPCWebSettings { CONST_VTBL struct IWPCWebSettingsVtbl *lpVtbl; };
...
#define IWPCWebSettings_RequestURLOverride(This, hWnd, pcszURL, cURLs,         \
  ...
  ((This)->lpVtbl->RequestURLOverride(This, hWnd, pcszURL, cURLs,              \
                                      ppcszSubURLs, pfChanged))
...
typedef struct IWindowsParentalControlsVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IWindowsParentalControls *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IWindowsParentalControls *This);
...
typedef struct IWPCProviderSupportVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IWPCProviderSupport *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IWPCProviderSupport *This);
...
class DECLSPEC_UUID("355DFFAA-3B9F-435c-B428-5D44290BC5F2") WpcSettingsProvider;
#endif
...
class DECLSPEC_UUID("BB18C7A0-2186-4be0-97D8-04847B628E02") WpcProviderSupport;
#endif
