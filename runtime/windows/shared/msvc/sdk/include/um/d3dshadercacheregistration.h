...
#pragma once
DEFINE_GUID(CLSID_D3DShaderCacheInstallerFactory, 0x16195a0b, 0x607c, 0x41f1,
            0xbf, 0x03, 0xc7, 0x69, 0x4d, 0x60, 0xa8, 0xd4);
typedef enum D3D_SHADER_CACHE_APP_REGISTRATION_SCOPE {
  ...
  D3D_SHADER_CACHE_APP_REGISTRATION_SCOPE_SYSTEM =
      (D3D_SHADER_CACHE_APP_REGISTRATION_SCOPE_USER + 1)
} D3D_SHADER_CACHE_APP_REGISTRATION_SCOPE;

extern RPC_IF_HANDLE
    __MIDL_itf_d3dshadercacheregistration_0000_0000_v0_0_c_ifspec;
extern RPC_IF_HANDLE
    __MIDL_itf_d3dshadercacheregistration_0000_0000_v0_0_s_ifspec;
...
public:
  ...
  virtual D3D_SHADER_CACHE_APP_REGISTRATION_SCOPE STDMETHODCALLTYPE
  GetInstallerScope(void) = 0;
...
typedef struct ID3DShaderCacheInstallerClientVtbl {
  ...
  HRESULT(STDMETHODCALLTYPE *GetInstallerName)(
      ID3DShaderCacheInstallerClient *This, _Inout_ SIZE_T *pNameLength,
...
#define ID3DShaderCacheInstallerClient_GetInstallerName(This, pNameLength,     \
                                                        pName)                 \
...
extern RPC_IF_HANDLE
    __MIDL_itf_d3dshadercacheregistration_0000_0001_v0_0_c_ifspec;
extern RPC_IF_HANDLE
    __MIDL_itf_d3dshadercacheregistration_0000_0001_v0_0_s_ifspec;
...
public:
  ...
  virtual HRESULT STDMETHODCALLTYPE GetPrecompiledCachePath(
      _In_ const wchar_t *pAdapterFamily, _Inout_ const wchar_t **pPath) = 0;
...
typedef struct ID3DShaderCacheComponentVtbl {
  ...
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(ID3DShaderCacheComponent *This,
                                             REFIID riid,
  ...
  HRESULT(STDMETHODCALLTYPE *GetComponentName)(ID3DShaderCacheComponent *This,
  ...
  HRESULT(STDMETHODCALLTYPE *GetStateObjectDatabasePath)(
      ID3DShaderCacheComponent *This, _Out_ const wchar_t **pPath);

  DECLSPEC_XFGVIRT(ID3DShaderCacheComponent, GetPrecompiledCachePath)
  HRESULT(STDMETHODCALLTYPE *GetPrecompiledCachePath)(
      ID3DShaderCacheComponent *This, _In_ const wchar_t *pAdapterFamily,
  ...
  HRESULT(STDMETHODCALLTYPE *GetPrecompiledShaderDatabases)(
      ID3DShaderCacheComponent *This, UINT ArraySize,
...
#define ID3DShaderCacheComponent_GetPrecompiledCachePath(This, pAdapterFamily, \
                                                         pPath)                \
...
#define ID3DShaderCacheComponent_GetPrecompiledShaderDatabases(                \
    This, ArraySize, pPSDBs)                                                   \
...
extern RPC_IF_HANDLE
    __MIDL_itf_d3dshadercacheregistration_0000_0002_v0_0_c_ifspec;
extern RPC_IF_HANDLE
    __MIDL_itf_d3dshadercacheregistration_0000_0002_v0_0_s_ifspec;
...
public:
  ...
  virtual HRESULT STDMETHODCALLTYPE RegisterComponent(
      _In_ const wchar_t *pName, _In_ const wchar_t *pStateObjectDBPath,
      _In_ UINT NumPSDB,
      _In_reads_(NumPSDB) const D3D_SHADER_CACHE_PSDB_PROPERTIES *pPSDBs,
      REFIID riid, _COM_Outptr_ void **ppvComponent) = 0;
  ...
  virtual HRESULT STDMETHODCALLTYPE GetComponent(
      _In_ UINT index, REFIID riid, _COM_Outptr_ void **ppvComponent) = 0;
...
typedef struct ID3DShaderCacheApplicationVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(ID3DShaderCacheApplication *This,
                                             REFIID riid,
                                             _COM_Outptr_ void **ppvObject);
  ...
  HRESULT(STDMETHODCALLTYPE *GetExePath)(ID3DShaderCacheApplication *This,
  ...
  HRESULT(STDMETHODCALLTYPE *RegisterComponent)(
      ID3DShaderCacheApplication *This, _In_ const wchar_t *pName,
      _In_ const wchar_t *pStateObjectDBPath, _In_ UINT NumPSDB,
      _In_reads_(NumPSDB) const D3D_SHADER_CACHE_PSDB_PROPERTIES *pPSDBs,
      REFIID riid, _COM_Outptr_ void **ppvComponent);
  ...
  HRESULT(STDMETHODCALLTYPE *GetComponent)(ID3DShaderCacheApplication *This,
                                           _In_ UINT index, REFIID riid,
...
#define ID3DShaderCacheApplication_RegisterComponent(                          \
    This, pName, pStateObjectDBPath, NumPSDB, pPSDBs, riid, ppvComponent)      \
  ((This)->lpVtbl->RegisterComponent(This, pName, pStateObjectDBPath, NumPSDB, \
                                     pPSDBs, riid, ppvComponent))
...
#define ID3DShaderCacheApplication_GetComponent(This, index, riid,             \
                                                ppvComponent)                  \
...
#define ID3DShaderCacheApplication_GetPrecompileTargets(This, ArraySize,       \
                                                        pArray, flags)         \
...
extern RPC_IF_HANDLE
    __MIDL_itf_d3dshadercacheregistration_0000_0003_v0_0_c_ifspec;
extern RPC_IF_HANDLE
    __MIDL_itf_d3dshadercacheregistration_0000_0003_v0_0_s_ifspec;
...
public:
  ...
  virtual HRESULT STDMETHODCALLTYPE RegisterApplication(
      ...
      REFIID riid, _COM_Outptr_ void **ppvApp) = 0;
  ...
  virtual HRESULT STDMETHODCALLTYPE GetApplication(
      _In_ UINT index, REFIID riid, _COM_Outptr_ void **ppvApp) = 0;
...
typedef struct ID3DShaderCacheInstallerVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(ID3DShaderCacheInstaller *This,
                                             REFIID riid,
                                             _COM_Outptr_ void **ppvObject);
  ...
  HRESULT(STDMETHODCALLTYPE *RegisterServiceDriverUpdateTrigger)(
      ID3DShaderCacheInstaller *This, SC_HANDLE hServiceHandle);

  DECLSPEC_XFGVIRT(ID3DShaderCacheInstaller,
  ...
  HRESULT(STDMETHODCALLTYPE *RegisterApplication)(
      ID3DShaderCacheInstaller *This, _In_ const wchar_t *pExePath,
      _In_ const D3D_SHADER_CACHE_APPLICATION_DESC *pApplicationDesc,
      REFIID riid, _COM_Outptr_ void **ppvApp);
  ...
  HRESULT(STDMETHODCALLTYPE *GetApplication)(ID3DShaderCacheInstaller *This,
                                             _In_ UINT index, REFIID riid,
...
#define ID3DShaderCacheInstaller_RegisterServiceDriverUpdateTrigger(           \
    This, hServiceHandle)                                                      \
  ((This)->lpVtbl->RegisterServiceDriverUpdateTrigger(This, hServiceHandle))

#define ID3DShaderCacheInstaller_UnregisterServiceDriverUpdateTrigger(         \
    This, hServiceHandle)                                                      \
  ((This)->lpVtbl->UnregisterServiceDriverUpdateTrigger(This, hServiceHandle))

#define ID3DShaderCacheInstaller_RegisterApplication(                          \
    This, pExePath, pApplicationDesc, riid, ppvApp)                            \
  ((This)->lpVtbl->RegisterApplication(This, pExePath, pApplicationDesc, riid, \
                                       ppvApp))
...
#define ID3DShaderCacheInstaller_GetPrecompileTargets(                         \
    This, pApplicationDesc, pArraySize, pArray, flags)                         \
  ((This)->lpVtbl->GetPrecompileTargets(This, pApplicationDesc, pArraySize,    \
                                        pArray, flags))
...
public:
  virtual HRESULT STDMETHODCALLTYPE GetApplicationFromExePath(
      _In_ const wchar_t *pFullExePath, REFIID riid,
...
typedef struct ID3DShaderCacheExplorerVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(ID3DShaderCacheExplorer *This,
                                             REFIID riid,
                                             _COM_Outptr_ void **ppvObject);
  ...
  HRESULT(STDMETHODCALLTYPE *GetApplicationFromExePath)(
      ID3DShaderCacheExplorer *This, _In_ const wchar_t *pFullExePath,
      REFIID riid, _COM_Outptr_ void **ppvApp);
...
#define ID3DShaderCacheExplorer_GetApplicationFromExePath(This, pFullExePath,  \
                                                          riid, ppvApp)        \
...
public:
  virtual HRESULT STDMETHODCALLTYPE CreateInstaller(
      _In_ ID3DShaderCacheInstallerClient * pClient, REFIID riid,
      _COM_Outptr_ void **ppvInstaller) = 0;

  virtual HRESULT STDMETHODCALLTYPE CreateExplorer(
      IUnknown * pUnknown, REFIID riid, _COM_Outptr_ void **ppvExplorer) = 0;
};
...
typedef struct ID3DShaderCacheInstallerFactoryVtbl {
  ...
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(
      ID3DShaderCacheInstallerFactory *This, REFIID riid,
      _COM_Outptr_ void **ppvObject);
  ...
  HRESULT(STDMETHODCALLTYPE *CreateExplorer)(
      ID3DShaderCacheInstallerFactory *This, IUnknown *pUnknown, REFIID riid,
...
#define ID3DShaderCacheInstallerFactory_CreateInstaller(This, pClient, riid,   \
                                                        ppvInstaller)          \
  ((This)->lpVtbl->CreateInstaller(This, pClient, riid, ppvInstaller))

#define ID3DShaderCacheInstallerFactory_CreateExplorer(This, pUnknown, riid,   \
                                                       ppvExplorer)            \
...
DEFINE_GUID(IID_ID3DShaderCacheInstallerClient, 0xa16ee930, 0xd9f6, 0x4222,
            0xa5, 0x14, 0x24, 0x44, 0x73, 0xe5, 0xd2, 0x66);
DEFINE_GUID(IID_ID3DShaderCacheComponent, 0xeed1bf00, 0xf5c7, 0x4cf7, 0x88,
            0x5c, 0xd0, 0xf9, 0xc0, 0xcb, 0x48, 0x28);
DEFINE_GUID(IID_ID3DShaderCacheApplication, 0xfc688ee2, 0x1b35, 0x4913, 0x93,
            0xbe, 0x1c, 0xa3, 0xfa, 0x7d, 0xf3, 0x9e);
DEFINE_GUID(IID_ID3DShaderCacheInstaller, 0xbbe30de1, 0x6318, 0x4526, 0xae,
            0x17, 0x77, 0x66, 0x93, 0x19, 0x1b, 0xb4);
DEFINE_GUID(IID_ID3DShaderCacheExplorer, 0x90432322, 0x32f5, 0x487f, 0x92, 0x64,
            0xe9, 0x39, 0x0f, 0xa5, 0x8b, 0x2a);
DEFINE_GUID(IID_ID3DShaderCacheInstallerFactory, 0x09b2dfe4, 0x840f, 0x401a,
            0x80, 0x4c, 0x0d, 0xd8, 0xaa, 0xdc, 0x9e, 0x9f);

extern RPC_IF_HANDLE
    __MIDL_itf_d3dshadercacheregistration_0000_0006_v0_0_c_ifspec;
extern RPC_IF_HANDLE
    __MIDL_itf_d3dshadercacheregistration_0000_0006_v0_0_s_ifspec;
