 ...
 */
DWORD
FAR PASCAL DxApi(DWORD dwFunctionNum, LPVOID lpvInBuffer, DWORD cbInBuffer,
                 LPVOID lpvOutBuffer, DWORD cbOutBuffer);

typedef DWORD(FAR PASCAL *LPDXAPI)(DWORD dwFunctionNum, LPVOID lpvInBuffer,
...
typedef ULONG(FAR PASCAL *LPDD_NOTIFYCALLBACK)(DWORD dwFlags, PVOID pContext,
