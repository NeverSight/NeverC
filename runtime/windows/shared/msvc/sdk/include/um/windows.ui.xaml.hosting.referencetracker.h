...
extern RPC_IF_HANDLE
    __MIDL_itf_windows2Eui2Examl2Ehosting2Ereferencetracker_0000_0000_v0_0_c_ifspec;
extern RPC_IF_HANDLE
    __MIDL_itf_windows2Eui2Examl2Ehosting2Ereferencetracker_0000_0000_v0_0_s_ifspec;
...
typedef struct IReferenceTrackerTargetVtbl {
  ...
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(IReferenceTrackerTarget *This,
                                             /* [in] */ REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(IReferenceTrackerTarget *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(IReferenceTrackerTarget *This);
  ...
  HRESULT(STDMETHODCALLTYPE *Peg)(IReferenceTrackerTarget *This);

  DECLSPEC_XFGVIRT(IReferenceTrackerTarget, Unpeg)
  HRESULT(STDMETHODCALLTYPE *Unpeg)(IReferenceTrackerTarget *This);
...
#define IReferenceTrackerTarget_AddRef(This) ((This)->lpVtbl->AddRef(This))

#define IReferenceTrackerTarget_Release(This) ((This)->lpVtbl->Release(This))
...
#define IReferenceTrackerTarget_Peg(This) ((This)->lpVtbl->Peg(This))

#define IReferenceTrackerTarget_Unpeg(This) ((This)->lpVtbl->Unpeg(This))
...
typedef struct IReferenceTrackerVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(IReferenceTracker *This,
                                             /* [in] */ REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(IReferenceTracker *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(IReferenceTracker *This);

  DECLSPEC_XFGVIRT(IReferenceTracker, ConnectFromTrackerSource)
  HRESULT(STDMETHODCALLTYPE *ConnectFromTrackerSource)(IReferenceTracker *This);
  ...
  HRESULT(STDMETHODCALLTYPE *AddRefFromTrackerSource)(IReferenceTracker *This);

  DECLSPEC_XFGVIRT(IReferenceTracker, ReleaseFromTrackerSource)
  HRESULT(STDMETHODCALLTYPE *ReleaseFromTrackerSource)(IReferenceTracker *This);

  DECLSPEC_XFGVIRT(IReferenceTracker, PegFromTrackerSource)
  HRESULT(STDMETHODCALLTYPE *PegFromTrackerSource)(IReferenceTracker *This);
...
#define IReferenceTracker_AddRef(This) ((This)->lpVtbl->AddRef(This))

#define IReferenceTracker_Release(This) ((This)->lpVtbl->Release(This))
...
typedef struct IReferenceTrackerManagerVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(IReferenceTrackerManager *This,
                                             /* [in] */ REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(IReferenceTrackerManager *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(IReferenceTrackerManager *This);
...
#define IReferenceTrackerManager_AddRef(This) ((This)->lpVtbl->AddRef(This))

#define IReferenceTrackerManager_Release(This) ((This)->lpVtbl->Release(This))
...
typedef struct IFindReferenceTargetsCallbackVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(IFindReferenceTargetsCallback *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(IFindReferenceTargetsCallback *This);
...
extern RPC_IF_HANDLE
    __MIDL_itf_windows2Eui2Examl2Ehosting2Ereferencetracker_0000_0004_v0_0_c_ifspec;
extern RPC_IF_HANDLE
    __MIDL_itf_windows2Eui2Examl2Ehosting2Ereferencetracker_0000_0004_v0_0_s_ifspec;
...
public:
  ...
  virtual HRESULT STDMETHODCALLTYPE ReleaseDisconnectedReferenceSources(
      void) = 0;

  virtual HRESULT STDMETHODCALLTYPE NotifyEndOfReferenceTrackingOnThread(
      void) = 0;

  virtual HRESULT STDMETHODCALLTYPE GetTrackerTarget(
      IUnknown * unknown, IReferenceTrackerTarget * *newReference) = 0;
...
typedef struct IReferenceTrackerHostVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(IReferenceTrackerHost *This,
                                             /* [in] */ REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(IReferenceTrackerHost *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(IReferenceTrackerHost *This);
  ...
  HRESULT(STDMETHODCALLTYPE *GetTrackerTarget)(
      IReferenceTrackerHost *This, IUnknown *unknown,
      IReferenceTrackerTarget **newReference);

  DECLSPEC_XFGVIRT(IReferenceTrackerHost, AddMemoryPressure)
  HRESULT(STDMETHODCALLTYPE *AddMemoryPressure)(IReferenceTrackerHost *This,
                                                UINT64 bytesAllocated);

  DECLSPEC_XFGVIRT(IReferenceTrackerHost, RemoveMemoryPressure)
  HRESULT(STDMETHODCALLTYPE *RemoveMemoryPressure)(IReferenceTrackerHost *This,
                                                   UINT64 bytesAllocated);
...
#define IReferenceTrackerHost_AddRef(This) ((This)->lpVtbl->AddRef(This))

#define IReferenceTrackerHost_Release(This) ((This)->lpVtbl->Release(This))
...
extern RPC_IF_HANDLE
    __MIDL_itf_windows2Eui2Examl2Ehosting2Ereferencetracker_0000_0005_v0_0_c_ifspec;
extern RPC_IF_HANDLE
    __MIDL_itf_windows2Eui2Examl2Ehosting2Ereferencetracker_0000_0005_v0_0_s_ifspec;
...
IReferenceTrackerExtension : public IUnknown{public : };
...
typedef struct IReferenceTrackerExtensionVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(IReferenceTrackerExtension *This,
                                             /* [in] */ REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(IReferenceTrackerExtension *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(IReferenceTrackerExtension *This);
...
#define IReferenceTrackerExtension_AddRef(This) ((This)->lpVtbl->AddRef(This))

#define IReferenceTrackerExtension_Release(This) ((This)->lpVtbl->Release(This))
...
extern RPC_IF_HANDLE
    __MIDL_itf_windows2Eui2Examl2Ehosting2Ereferencetracker_0000_0006_v0_0_c_ifspec;
extern RPC_IF_HANDLE
    __MIDL_itf_windows2Eui2Examl2Ehosting2Ereferencetracker_0000_0006_v0_0_s_ifspec;
...
typedef struct ITrackerOwnerVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(ITrackerOwner *This,
                                             /* [in] */ REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(ITrackerOwner *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(ITrackerOwner *This);
  ...
  HRESULT(STDMETHODCALLTYPE *SetTrackerValue)(ITrackerOwner *This,
                                              /* [in] */ TrackerHandle handle,
                                              /* [in] */ IUnknown *value);
...
interface ITrackerOwner { CONST_VTBL struct ITrackerOwnerVtbl *lpVtbl; };
...
#define ITrackerOwner_AddRef(This) ((This)->lpVtbl->AddRef(This))

#define ITrackerOwner_Release(This) ((This)->lpVtbl->Release(This))
...
extern RPC_IF_HANDLE
    __MIDL_itf_windows2Eui2Examl2Ehosting2Ereferencetracker_0000_0007_v0_0_c_ifspec;
extern RPC_IF_HANDLE
    __MIDL_itf_windows2Eui2Examl2Ehosting2Ereferencetracker_0000_0007_v0_0_s_ifspec;
