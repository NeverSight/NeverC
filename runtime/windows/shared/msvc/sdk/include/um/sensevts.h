...
typedef /* [uuid] */ DECLSPEC_UUID(
    "d597fad1-5b9f-11d1-8dd2-00aa004abd5e") struct SENS_QOCINFO {
  DWORD dwSize;
  DWORD dwFlags;
  DWORD dwOutSpeed;
  DWORD dwInSpeed;
...
typedef struct ISensNetworkVtbl {
  ...
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in ISensNetwork *This,
...
interface ISensNetwork { CONST_VTBL struct ISensNetworkVtbl *lpVtbl; };
...
typedef struct ISensOnNowVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in ISensOnNow *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in ISensOnNow *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in ISensOnNow *This);
  ...
  /* [id] */ HRESULT(STDMETHODCALLTYPE *OnACPower)(__RPC__in ISensOnNow *This);
...
interface ISensOnNow { CONST_VTBL struct ISensOnNowVtbl *lpVtbl; };
...
typedef struct ISensLogonVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in ISensLogon *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in ISensLogon *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in ISensLogon *This);
  ...
  /* [id] */ HRESULT(STDMETHODCALLTYPE *Logon)(__RPC__in ISensLogon *This,
                                               /* [in] */ __RPC__in BSTR
                                                   bstrUserName);

  DECLSPEC_XFGVIRT(ISensLogon, Logoff)
  /* [id] */ HRESULT(STDMETHODCALLTYPE *Logoff)(__RPC__in ISensLogon *This,
                                                /* [in] */ __RPC__in BSTR
                                                    bstrUserName);

  DECLSPEC_XFGVIRT(ISensLogon, StartShell)
  /* [id] */ HRESULT(STDMETHODCALLTYPE *StartShell)(__RPC__in ISensLogon *This,
                                                    /* [in] */ __RPC__in BSTR
                                                        bstrUserName);

  DECLSPEC_XFGVIRT(ISensLogon, DisplayLock)
  /* [id] */ HRESULT(STDMETHODCALLTYPE *DisplayLock)(__RPC__in ISensLogon *This,
                                                     /* [in] */ __RPC__in BSTR
                                                         bstrUserName);
...
interface ISensLogon { CONST_VTBL struct ISensLogonVtbl *lpVtbl; };
...
typedef struct ISensLogon2Vtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in ISensLogon2 *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in ISensLogon2 *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in ISensLogon2 *This);
...
interface ISensLogon2 { CONST_VTBL struct ISensLogon2Vtbl *lpVtbl; };
...
class DECLSPEC_UUID("d597cafe-5b9f-11d1-8dd2-00aa004abd5e") SENS;
#endif
