...
extern const __declspec(selectany) CLSID CLSID_AudioFrameNativeFactory = {
    ...
    0x9f65,
    0x4102,
    {0x93, 0x67, 0x2c, 0xda, 0x3a, 0x4f, 0x37, 0x2a}};
// {D194386A-04E3-4814-8100-B2B0AE6D78C7}
extern const __declspec(selectany) CLSID CLSID_VideoFrameNativeFactory = {
    0xd194386a, 0x4e3, 0x4814, {0x81, 0x0, 0xb2, 0xb0, 0xae, 0x6d, 0x78, 0xc7}};

extern RPC_IF_HANDLE
    __MIDL_itf_windows2Emedia2Ecore2Einterop_0000_0000_v0_0_c_ifspec;
extern RPC_IF_HANDLE
    __MIDL_itf_windows2Emedia2Ecore2Einterop_0000_0000_v0_0_s_ifspec;
...
typedef struct IAudioFrameNativeVtbl {
  ...
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(IAudioFrameNative *This,
                                             /* [in] */ REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(IAudioFrameNative *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(IAudioFrameNative *This);

  DECLSPEC_XFGVIRT(IInspectable, GetIids)
  HRESULT(STDMETHODCALLTYPE *GetIids)(IAudioFrameNative *This,
                                      /* [out] */ ULONG *iidCount,
  ...
  HRESULT(STDMETHODCALLTYPE *GetTrustLevel)(IAudioFrameNative *This,
                                            /* [out] */ TrustLevel *trustLevel);

  DECLSPEC_XFGVIRT(IAudioFrameNative, GetData)
  HRESULT(STDMETHODCALLTYPE *GetData)(IAudioFrameNative *This,
                                      /* [annotation][in] */
                                      _In_ REFIID riid,
                                      /* [annotation][iid_is][out] */
...
#define IAudioFrameNative_AddRef(This) ((This)->lpVtbl->AddRef(This))

#define IAudioFrameNative_Release(This) ((This)->lpVtbl->Release(This))
...
typedef struct IVideoFrameNativeVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(IVideoFrameNative *This,
                                             /* [in] */ REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(IVideoFrameNative *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(IVideoFrameNative *This);

  DECLSPEC_XFGVIRT(IInspectable, GetIids)
  HRESULT(STDMETHODCALLTYPE *GetIids)(IVideoFrameNative *This,
                                      /* [out] */ ULONG *iidCount,
                                      /* [size_is][size_is][out] */ IID **iids);
  ...
  DECLSPEC_XFGVIRT(IInspectable, GetTrustLevel)
  HRESULT(STDMETHODCALLTYPE *GetTrustLevel)(IVideoFrameNative *This,
                                            /* [out] */ TrustLevel *trustLevel);

  DECLSPEC_XFGVIRT(IVideoFrameNative, GetData)
  HRESULT(STDMETHODCALLTYPE *GetData)(IVideoFrameNative *This,
                                      /* [annotation][in] */
                                      _In_ REFIID riid,
                                      /* [annotation][iid_is][out] */
                                      _COM_Outptr_ LPVOID *ppv);
  ...
  HRESULT(STDMETHODCALLTYPE *GetDevice)(IVideoFrameNative *This,
                                        /* [annotation][in] */
                                        _In_ REFIID riid,
                                        /* [annotation][iid_is][out] */
                                        _COM_Outptr_ LPVOID *ppv);
...
#define IVideoFrameNative_AddRef(This) ((This)->lpVtbl->AddRef(This))

#define IVideoFrameNative_Release(This) ((This)->lpVtbl->Release(This))
...
typedef struct IAudioFrameNativeFactoryVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(IAudioFrameNativeFactory *This,
                                             /* [in] */ REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(IAudioFrameNativeFactory *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(IAudioFrameNativeFactory *This);

  DECLSPEC_XFGVIRT(IInspectable, GetIids)
  HRESULT(STDMETHODCALLTYPE *GetIids)(IAudioFrameNativeFactory *This,
                                      /* [out] */ ULONG *iidCount,
                                      /* [size_is][size_is][out] */ IID **iids);
  ...
  DECLSPEC_XFGVIRT(IInspectable, GetTrustLevel)
  HRESULT(STDMETHODCALLTYPE *GetTrustLevel)(IAudioFrameNativeFactory *This,
                                            /* [out] */ TrustLevel *trustLevel);

  DECLSPEC_XFGVIRT(IAudioFrameNativeFactory, CreateFromMFSample)
  HRESULT(STDMETHODCALLTYPE *CreateFromMFSample)(IAudioFrameNativeFactory *This,
                                                 /* [annotation][in] */
                                                 _In_ IMFSample *data,
                                                 /* [annotation][in] */
                                                 _In_ BOOL forceReadOnly,
...
#define IAudioFrameNativeFactory_AddRef(This) ((This)->lpVtbl->AddRef(This))

#define IAudioFrameNativeFactory_Release(This) ((This)->lpVtbl->Release(This))
...
#define IAudioFrameNativeFactory_CreateFromMFSample(This, data, forceReadOnly, \
                                                    riid, ppv)                 \
...
typedef struct IVideoFrameNativeFactoryVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(IVideoFrameNativeFactory *This,
                                             /* [in] */ REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(IVideoFrameNativeFactory *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(IVideoFrameNativeFactory *This);

  DECLSPEC_XFGVIRT(IInspectable, GetIids)
  HRESULT(STDMETHODCALLTYPE *GetIids)(IVideoFrameNativeFactory *This,
                                      /* [out] */ ULONG *iidCount,
                                      /* [size_is][size_is][out] */ IID **iids);
  ...
  DECLSPEC_XFGVIRT(IInspectable, GetTrustLevel)
  HRESULT(STDMETHODCALLTYPE *GetTrustLevel)(IVideoFrameNativeFactory *This,
                                            /* [out] */ TrustLevel *trustLevel);
...
#define IVideoFrameNativeFactory_AddRef(This) ((This)->lpVtbl->AddRef(This))

#define IVideoFrameNativeFactory_Release(This) ((This)->lpVtbl->Release(This))
...
#define IVideoFrameNativeFactory_CreateFromMFSample(                           \
    This, data, subtype, width, height, forceReadOnly, minDisplayAperture,     \
    device, riid, ppv)                                                         \
  ((This)->lpVtbl->CreateFromMFSample(This, data, subtype, width, height,      \
                                      forceReadOnly, minDisplayAperture,       \
                                      device, riid, ppv))
...
extern RPC_IF_HANDLE
    __MIDL_itf_windows2Emedia2Ecore2Einterop_0000_0004_v0_0_c_ifspec;
extern RPC_IF_HANDLE
    __MIDL_itf_windows2Emedia2Ecore2Einterop_0000_0004_v0_0_s_ifspec;
