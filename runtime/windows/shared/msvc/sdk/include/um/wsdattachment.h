...
HRESULT WINAPI
WSDCreateOutboundAttachment(_Outptr_ IWSDOutboundAttachment **ppAttachment);
...
IWSDAttachment : public IUnknown{public : };
...
typedef struct IWSDAttachmentVtbl {
  ...
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in IWSDAttachment *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IWSDAttachment *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IWSDAttachment *This);

  END_INTERFACE
} IWSDAttachmentVtbl;

interface IWSDAttachment { CONST_VTBL struct IWSDAttachmentVtbl *lpVtbl; };
...
#define IWSDOutboundAttachment_Write(This, pBuffer, dwBytesToWrite,            \
  ...
  ((This)->lpVtbl->Write(This, pBuffer, dwBytesToWrite,                        \
                         pdwNumberOfBytesWritten))
...
typedef struct IWSDInboundAttachmentVtbl {
  ...
  HRESULT(STDMETHODCALLTYPE *Read)(IWSDInboundAttachment *This,
                                   /* [annotation][length_is][size_is][out] */
                                   _Out_writes_to_(dwBytesToRead,
