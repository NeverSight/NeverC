...
typedef interface ITpmVirtualSmartCardManagerStatusCallback
...
#else
typedef struct RemoteTpmVirtualSmartCardManager
...
typedef /* [public][public][v1_enum] */
    enum __MIDL___MIDL_itf_tpmvscmgr_0000_0000_0001 {
      ...
      TPMVSCMGR_STATUS_VGIDSSIMULATOR_INITIALIZING =
          (TPMVSCMGR_STATUS_VTPMSMARTCARD_DESTROYING + 1),
      TPMVSCMGR_STATUS_VGIDSSIMULATOR_CREATING =
          (TPMVSCMGR_STATUS_VGIDSSIMULATOR_INITIALIZING + 1),
      TPMVSCMGR_STATUS_VGIDSSIMULATOR_DESTROYING =
          (TPMVSCMGR_STATUS_VGIDSSIMULATOR_CREATING + 1),
      TPMVSCMGR_STATUS_VREADER_INITIALIZING =
          (TPMVSCMGR_STATUS_VGIDSSIMULATOR_DESTROYING + 1),
      TPMVSCMGR_STATUS_VREADER_CREATING =
          (TPMVSCMGR_STATUS_VREADER_INITIALIZING + 1),
      TPMVSCMGR_STATUS_VREADER_DESTROYING =
          (TPMVSCMGR_STATUS_VREADER_CREATING + 1),
      TPMVSCMGR_STATUS_GENERATE_WAITING =
          (TPMVSCMGR_STATUS_VREADER_DESTROYING + 1),
      TPMVSCMGR_STATUS_GENERATE_AUTHENTICATING =
          (TPMVSCMGR_STATUS_GENERATE_WAITING + 1),
      TPMVSCMGR_STATUS_GENERATE_RUNNING =
          (TPMVSCMGR_STATUS_GENERATE_AUTHENTICATING + 1),
...
typedef /* [public][public][v1_enum] */
    enum __MIDL___MIDL_itf_tpmvscmgr_0000_0000_0002 {
      ...
      TPMVSCMGR_ERROR_TERMINAL_SERVICES_SESSION =
          (TPMVSCMGR_ERROR_READER_COUNT_LIMIT + 1),
      TPMVSCMGR_ERROR_VTPMSMARTCARD_INITIALIZE =
          (TPMVSCMGR_ERROR_TERMINAL_SERVICES_SESSION + 1),
      TPMVSCMGR_ERROR_VTPMSMARTCARD_CREATE =
          (TPMVSCMGR_ERROR_VTPMSMARTCARD_INITIALIZE + 1),
      TPMVSCMGR_ERROR_VTPMSMARTCARD_DESTROY =
          (TPMVSCMGR_ERROR_VTPMSMARTCARD_CREATE + 1),
      TPMVSCMGR_ERROR_VGIDSSIMULATOR_INITIALIZE =
          (TPMVSCMGR_ERROR_VTPMSMARTCARD_DESTROY + 1),
      TPMVSCMGR_ERROR_VGIDSSIMULATOR_CREATE =
          (TPMVSCMGR_ERROR_VGIDSSIMULATOR_INITIALIZE + 1),
      TPMVSCMGR_ERROR_VGIDSSIMULATOR_DESTROY =
          (TPMVSCMGR_ERROR_VGIDSSIMULATOR_CREATE + 1),
      TPMVSCMGR_ERROR_VGIDSSIMULATOR_WRITE_PROPERTY =
          (TPMVSCMGR_ERROR_VGIDSSIMULATOR_DESTROY + 1),
      TPMVSCMGR_ERROR_VGIDSSIMULATOR_READ_PROPERTY =
          (TPMVSCMGR_ERROR_VGIDSSIMULATOR_WRITE_PROPERTY + 1),
      TPMVSCMGR_ERROR_VREADER_INITIALIZE =
          (TPMVSCMGR_ERROR_VGIDSSIMULATOR_READ_PROPERTY + 1),
      ...
      TPMVSCMGR_ERROR_GENERATE_LOCATE_READER =
          (TPMVSCMGR_ERROR_VREADER_DESTROY + 1),
      TPMVSCMGR_ERROR_GENERATE_FILESYSTEM =
          (TPMVSCMGR_ERROR_GENERATE_LOCATE_READER + 1),
...
#define ITpmVirtualSmartCardManagerStatusCallback_QueryInterface(This, riid,   \
                                                                 ppvObject)    \
...
typedef struct ITpmVirtualSmartCardManagerVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in ITpmVirtualSmartCardManager *This);
...
#define ITpmVirtualSmartCardManager_AddRef(This) ((This)->lpVtbl->AddRef(This))

#define ITpmVirtualSmartCardManager_Release(This)                              \
  ((This)->lpVtbl->Release(This))

#define ITpmVirtualSmartCardManager_CreateVirtualSmartCard(                    \
    This, pszFriendlyName, bAdminAlgId, pbAdminKey, cbAdminKey, pbAdminKcv,    \
    cbAdminKcv, pbPuk, cbPuk, pbPin, cbPin, fGenerate, pStatusCallback,        \
    ppszInstanceId, pfNeedReboot)                                              \
  ((This)->lpVtbl->CreateVirtualSmartCard(                                     \
      This, pszFriendlyName, bAdminAlgId, pbAdminKey, cbAdminKey, pbAdminKcv,  \
      cbAdminKcv, pbPuk, cbPuk, pbPin, cbPin, fGenerate, pStatusCallback,      \
      ppszInstanceId, pfNeedReboot))

#define ITpmVirtualSmartCardManager_DestroyVirtualSmartCard(                   \
    This, pszInstanceId, pStatusCallback, pfNeedReboot)                        \
  ((This)->lpVtbl->DestroyVirtualSmartCard(This, pszInstanceId,                \
...
typedef struct ITpmVirtualSmartCardManager2Vtbl {
  ...
  DECLSPEC_XFGVIRT(ITpmVirtualSmartCardManager2,
...
#define ITpmVirtualSmartCardManager2_AddRef(This) ((This)->lpVtbl->AddRef(This))

#define ITpmVirtualSmartCardManager2_Release(This)                             \
  ((This)->lpVtbl->Release(This))

#define ITpmVirtualSmartCardManager2_CreateVirtualSmartCard(                   \
    This, pszFriendlyName, bAdminAlgId, pbAdminKey, cbAdminKey, pbAdminKcv,    \
    cbAdminKcv, pbPuk, cbPuk, pbPin, cbPin, fGenerate, pStatusCallback,        \
    ppszInstanceId, pfNeedReboot)                                              \
  ((This)->lpVtbl->CreateVirtualSmartCard(                                     \
...
#define ITpmVirtualSmartCardManager2_DestroyVirtualSmartCard(                  \
    This, pszInstanceId, pStatusCallback, pfNeedReboot)                        \
  ((This)->lpVtbl->DestroyVirtualSmartCard(This, pszInstanceId,                \
                                           pStatusCallback, pfNeedReboot))

#define ITpmVirtualSmartCardManager2_CreateVirtualSmartCardWithPinPolicy(      \
    This, pszFriendlyName, bAdminAlgId, pbAdminKey, cbAdminKey, pbAdminKcv,    \
    cbAdminKcv, pbPuk, cbPuk, pbPin, cbPin, pbPinPolicy, cbPinPolicy,          \
    fGenerate, pStatusCallback, ppszInstanceId, pfNeedReboot)                  \
  ((This)->lpVtbl->CreateVirtualSmartCardWithPinPolicy(                        \
      This, pszFriendlyName, bAdminAlgId, pbAdminKey, cbAdminKey, pbAdminKcv,  \
      cbAdminKcv, pbPuk, cbPuk, pbPin, cbPin, pbPinPolicy, cbPinPolicy,        \
      fGenerate, pStatusCallback, ppszInstanceId, pfNeedReboot))
...
public:
  virtual HRESULT STDMETHODCALLTYPE CreateVirtualSmartCardWithAttestation(
      ...
      __RPC__in_opt ITpmVirtualSmartCardManagerStatusCallback *pStatusCallback,
      /* [string][out] */
      __RPC__deref_out_opt_string LPWSTR *ppszInstanceId) = 0;
};
...
typedef struct ITpmVirtualSmartCardManager3Vtbl {
  ...
  DECLSPEC_XFGVIRT(ITpmVirtualSmartCardManager3,
...
#define ITpmVirtualSmartCardManager3_AddRef(This) ((This)->lpVtbl->AddRef(This))

#define ITpmVirtualSmartCardManager3_Release(This)                             \
  ((This)->lpVtbl->Release(This))

#define ITpmVirtualSmartCardManager3_CreateVirtualSmartCard(                   \
    This, pszFriendlyName, bAdminAlgId, pbAdminKey, cbAdminKey, pbAdminKcv,    \
    cbAdminKcv, pbPuk, cbPuk, pbPin, cbPin, fGenerate, pStatusCallback,        \
    ppszInstanceId, pfNeedReboot)                                              \
  ((This)->lpVtbl->CreateVirtualSmartCard(                                     \
...
#define ITpmVirtualSmartCardManager3_DestroyVirtualSmartCard(                  \
    This, pszInstanceId, pStatusCallback, pfNeedReboot)                        \
  ((This)->lpVtbl->DestroyVirtualSmartCard(This, pszInstanceId,                \
                                           pStatusCallback, pfNeedReboot))

#define ITpmVirtualSmartCardManager3_CreateVirtualSmartCardWithPinPolicy(      \
    This, pszFriendlyName, bAdminAlgId, pbAdminKey, cbAdminKey, pbAdminKcv,    \
    cbAdminKcv, pbPuk, cbPuk, pbPin, cbPin, pbPinPolicy, cbPinPolicy,          \
    fGenerate, pStatusCallback, ppszInstanceId, pfNeedReboot)                  \
  ((This)->lpVtbl->CreateVirtualSmartCardWithPinPolicy(                        \
...
#define ITpmVirtualSmartCardManager3_CreateVirtualSmartCardWithAttestation(    \
    This, pszFriendlyName, bAdminAlgId, pbAdminKey, cbAdminKey, pbAdminKcv,    \
    cbAdminKcv, pbPuk, cbPuk, pbPin, cbPin, pbPinPolicy, cbPinPolicy,          \
    attestationType, fGenerate, pStatusCallback, ppszInstanceId)               \
  ((This)->lpVtbl->CreateVirtualSmartCardWithAttestation(                      \
      This, pszFriendlyName, bAdminAlgId, pbAdminKey, cbAdminKey, pbAdminKcv,  \
      cbAdminKcv, pbPuk, cbPuk, pbPin, cbPin, pbPinPolicy, cbPinPolicy,        \
      attestationType, fGenerate, pStatusCallback, ppszInstanceId))
