...
#if (ODBCVER >= 0x0300)
__declspec(deprecated("ODBC API: SQLBindParam is deprecated. Please use "
                      "SQLBindParameter instead.")) SQLRETURN SQL_API
...
SQLRETURN SQL_API SQLColumns(
    SQLHSTMT StatementHandle, _In_reads_opt_(NameLength1) SQLCHAR *CatalogName,
    SQLSMALLINT NameLength1, _In_reads_opt_(NameLength2) SQLCHAR *SchemaName,
    SQLSMALLINT NameLength2, _In_reads_opt_(NameLength3) SQLCHAR *TableName,
    SQLSMALLINT NameLength3, _In_reads_opt_(NameLength4) SQLCHAR *ColumnName,
...
SQLRETURN SQL_API SQLDataSources(
    ...
    _Out_writes_opt_(BufferLength1) SQLCHAR *ServerName,
    SQLSMALLINT BufferLength1, _Out_opt_ SQLSMALLINT *NameLength1Ptr,
    _Out_writes_opt_(BufferLength2) SQLCHAR *Description,
    SQLSMALLINT BufferLength2, _Out_opt_ SQLSMALLINT *NameLength2Ptr);

SQLRETURN SQL_API SQLDescribeCol(
    SQLHSTMT StatementHandle, SQLUSMALLINT ColumnNumber,
    _Out_writes_opt_(BufferLength) SQLCHAR *ColumnName,
...
SQLRETURN SQL_API SQLError(SQLHENV EnvironmentHandle, SQLHDBC ConnectionHandle,
                           ...
                           _Out_writes_(6) SQLCHAR *Sqlstate,
                           _Out_opt_ SQLINTEGER *NativeError,
...
__declspec(deprecated("ODBC API: SQLGetConnectOption is deprecated. Please use "
                      "SQLGetConnectAttr instead."))
#endif
...
SQLRETURN SQL_API SQLGetDescRec(
    SQLHDESC DescriptorHandle, SQLSMALLINT RecNumber,
    _Out_writes_opt_(BufferLength) SQLCHAR *Name, SQLSMALLINT BufferLength,
    _Out_opt_ SQLSMALLINT *StringLengthPtr, _Out_opt_ SQLSMALLINT *TypePtr,
    _Out_opt_ SQLSMALLINT *SubTypePtr, _Out_opt_ SQLLEN *LengthPtr,
    _Out_opt_ SQLSMALLINT *PrecisionPtr, _Out_opt_ SQLSMALLINT *ScalePtr,
...
SQLRETURN SQL_API
SQLGetDiagRec(SQLSMALLINT HandleType, SQLHANDLE Handle, SQLSMALLINT RecNumber,
...
SQLRETURN SQL_API SQLGetStmtAttr(SQLHSTMT StatementHandle, SQLINTEGER Attribute,
                                 ...
                                 SQLINTEGER BufferLength,
                                 _Out_opt_ SQLINTEGER *StringLength);
__declspec(deprecated("ODBC API: SQLGetStmtOption is deprecated. Please use "
                      "SQLGetStmtAttr instead."))
#endif /* ODBCVER >= 0x0300 */
...
__declspec(deprecated("ODBC API: SQLSetConnectOption is deprecated. Please use "
                      "SQLSetConnectAttr instead."))
#endif /* ODBCVER >= 0x0300 */
...
SQLRETURN SQL_API SQLSetDescRec(
    ...
    SQLSMALLINT Scale, _Inout_updates_bytes_opt_(Length) SQLPOINTER Data,
...
__declspec(deprecated("ODBC API: SQLSetParam is deprecated. Please use "
                      "SQLBindParameter instead.")) SQLRETURN SQL_API
...
SQLRETURN SQL_API SQLSetStmtAttr(SQLHSTMT StatementHandle, SQLINTEGER Attribute,
                                 _In_reads_(_Inexpressible_(StringLength))
                                     SQLPOINTER Value,
                                 SQLINTEGER StringLength);
__declspec(deprecated("ODBC API: SQLSetStmtOption is deprecated. Please use "
...
SQLRETURN SQL_API SQLTables(
    ...
    SQLSMALLINT NameLength1, _In_reads_opt_(NameLength2) SQLCHAR *SchemaName,
    SQLSMALLINT NameLength2, _In_reads_opt_(NameLength3) SQLCHAR *TableName,
    SQLSMALLINT NameLength3, _In_reads_opt_(NameLength4) SQLCHAR *TableType,
    SQLSMALLINT NameLength4);
