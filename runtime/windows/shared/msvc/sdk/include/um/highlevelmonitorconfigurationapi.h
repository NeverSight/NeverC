...
******************************************************************************/
_BOOL WINAPI
GetMonitorCapabilities(HANDLE hMonitor, _Out_ LPDWORD pdwMonitorCapabilities,
...
_BOOL WINAPI GetMonitorColorTemperature(
    HANDLE hMonitor, _Out_ LPMC_COLOR_TEMPERATURE pctCurrentColorTemperature);
