...
typedef /* [v1_enum] */
    enum tagWCN_PASSWORD_TYPE {
      ...
      WCN_PASSWORD_TYPE_OOB_SPECIFIED =
          (WCN_PASSWORD_TYPE_PIN_REGISTRAR_SPECIFIED + 1),
...
public:
  virtual HRESULT STDMETHODCALLTYPE SetPassword(
      ...
      /* [size_is][in] */
      __RPC__in_ecount_full(dwPasswordLength) const BYTE pbPassword[]) = 0;
  ...
  virtual HRESULT STDMETHODCALLTYPE GetStringAttribute(
      ...
      /* [size_is][string][out] */
      __RPC__out_ecount_full_string(cchMaxString) WCHAR wszString[]) = 0;

  virtual HRESULT STDMETHODCALLTYPE GetNetworkProfile(
      /* [range][in] */ __RPC__in_range(0, WCN_API_MAX_BUFFER_SIZE)
          DWORD cchMaxStringLength,
      /* [size_is][out] */ __RPC__out_ecount_full(cchMaxStringLength)
          LPWSTR wszProfile) = 0;
  ...
  virtual HRESULT STDMETHODCALLTYPE SetVendorExtension(
      ...
      /* [size_is][in] */
      __RPC__in_ecount_full(cbBuffer) const BYTE pbBuffer[]) = 0;
  ...
  virtual HRESULT STDMETHODCALLTYPE SetNFCPasswordParams(
      ...
      /* [size_is][unique][in] */
      __RPC__in_ecount_full_opt(dwRemotePublicKeyHashLength)
          const BYTE pbRemotePublicKeyHash[],
      /* [in] */ DWORD dwDHKeyBlobLength,
      /* [size_is][unique][in] */
      __RPC__in_ecount_full_opt(dwDHKeyBlobLength)
          const BYTE pbDHKeyBlob[]) = 0;
};
...
typedef struct IWCNDeviceVtbl {
  ...
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in IWCNDevice *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IWCNDevice *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IWCNDevice *This);
  ...
  HRESULT(STDMETHODCALLTYPE *SetNetworkProfile)(__RPC__in IWCNDevice *This,
  ...
  HRESULT(STDMETHODCALLTYPE *Unadvise)(__RPC__in IWCNDevice *This);
...
interface IWCNDevice { CONST_VTBL struct IWCNDeviceVtbl *lpVtbl; };
...
#define IWCNDevice_GetAttribute(This, AttributeType, dwMaxBufferSize,          \
                                pbBuffer, pdwBufferUsed)                       \
  ((This)->lpVtbl->GetAttribute(This, AttributeType, dwMaxBufferSize,          \
                                pbBuffer, pdwBufferUsed))
...
#define IWCNDevice_GetStringAttribute(This, AttributeType, cchMaxString,       \
                                      wszString)                               \
  ((This)->lpVtbl->GetStringAttribute(This, AttributeType, cchMaxString,       \
                                      wszString))
...
#define IWCNDevice_GetVendorExtension(This, pVendorExtSpec, dwMaxBufferSize,   \
                                      pbBuffer, pdwBufferUsed)                 \
  ((This)->lpVtbl->GetVendorExtension(This, pVendorExtSpec, dwMaxBufferSize,   \
                                      pbBuffer, pdwBufferUsed))

#define IWCNDevice_SetVendorExtension(This, pVendorExtSpec, cbBuffer,          \
                                      pbBuffer)                                \
...
#define IWCNDevice_SetNFCPasswordParams(                                       \
    This, Type, dwOOBPasswordID, dwPasswordLength, pbPassword,                 \
    dwRemotePublicKeyHashLength, pbRemotePublicKeyHash, dwDHKeyBlobLength,     \
    pbDHKeyBlob)                                                               \
  ((This)->lpVtbl->SetNFCPasswordParams(                                       \
      This, Type, dwOOBPasswordID, dwPasswordLength, pbPassword,               \
      dwRemotePublicKeyHashLength, pbRemotePublicKeyHash, dwDHKeyBlobLength,   \
      pbDHKeyBlob))
...
typedef struct IWCNConnectNotifyVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in IWCNConnectNotify *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IWCNConnectNotify *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IWCNConnectNotify *This);
  ...
  HRESULT(STDMETHODCALLTYPE *ConnectFailed)(__RPC__in IWCNConnectNotify *This,
