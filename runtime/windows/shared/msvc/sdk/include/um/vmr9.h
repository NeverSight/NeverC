...
#define IVMRSurfaceAllocatorEx9_InitializeDevice(This, dwUserID, lpAllocInfo,  \
                                                 lpNumBuffers)                 \
  ((This)->lpVtbl->InitializeDevice(This, dwUserID, lpAllocInfo, lpNumBuffers))
...
#define IVMRSurfaceAllocatorEx9_GetSurface(This, dwUserID, SurfaceIndex,       \
                                           SurfaceFlags, lplpSurface)          \
  ((This)->lpVtbl->GetSurface(This, dwUserID, SurfaceIndex, SurfaceFlags,      \
                              lplpSurface))
...
#define IVMRSurfaceAllocatorEx9_GetSurfaceEx(                                  \
    This, dwUserID, SurfaceIndex, SurfaceFlags, lplpSurface, lprcDst)          \
  ((This)->lpVtbl->GetSurfaceEx(This, dwUserID, SurfaceIndex, SurfaceFlags,    \
                                lplpSurface, lprcDst))
...
typedef struct IVMRMixerControl9Vtbl {
  ...
  HRESULT(STDMETHODCALLTYPE *SetAlpha)(IVMRMixerControl9 *This,
                                       /* [in] */ DWORD dwStreamID,
                                       /* [in] */ float Alpha);

  DECLSPEC_XFGVIRT(IVMRMixerControl9, GetAlpha)
  HRESULT(STDMETHODCALLTYPE *GetAlpha)(IVMRMixerControl9 *This,
                                       /* [in] */ DWORD dwStreamID,
                                       /* [out] */ float *pAlpha);

  DECLSPEC_XFGVIRT(IVMRMixerControl9, SetZOrder)
  HRESULT(STDMETHODCALLTYPE *SetZOrder)(IVMRMixerControl9 *This,
                                        /* [in] */ DWORD dwStreamID,
                                        /* [in] */ DWORD dwZ);

  DECLSPEC_XFGVIRT(IVMRMixerControl9, GetZOrder)
  HRESULT(STDMETHODCALLTYPE *GetZOrder)(IVMRMixerControl9 *This,
                                        /* [in] */ DWORD dwStreamID,
                                        /* [out] */ DWORD *pZ);
...
typedef struct IVMRSurface9Vtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(IVMRSurface9 *This,
                                             /* [in] */ REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);
  ...
  HRESULT(STDMETHODCALLTYPE *LockSurface)(IVMRSurface9 *This,
                                          /* [out] */ BYTE **lpSurface);
...
typedef struct IVMRMonitorConfig9Vtbl {
  ...
  HRESULT(STDMETHODCALLTYPE *SetMonitor)(IVMRMonitorConfig9 *This,
                                         /* [in] */ UINT uDev);

  DECLSPEC_XFGVIRT(IVMRMonitorConfig9, GetMonitor)
  HRESULT(STDMETHODCALLTYPE *GetMonitor)(IVMRMonitorConfig9 *This,
                                         /* [out] */ UINT *puDev);
