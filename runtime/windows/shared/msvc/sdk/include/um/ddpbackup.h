...
public:
  ...
  virtual HRESULT STDMETHODCALLTYPE OrderContainersRestore(
      ...
      /* [size_is][in] */ __RPC__in_ecount_full(NumberOfContainers) BSTR *
          ContainerPaths,
      /* [out] */ __RPC__out ULONG * ReadPlanEntries,
      /* [size_is][size_is][out] */
      __RPC__deref_out_ecount_full_opt(*ReadPlanEntries)
              DEDUP_CONTAINER_EXTENT *
          *ReadPlan) = 0;
  ...
  virtual HRESULT STDMETHODCALLTYPE PreviewContainerRead(
      ...
      /* [size_is][in] */ __RPC__in_ecount_full(NumberOfReads) DDP_FILE_EXTENT *
          ReadOffsets) = 0;
};
...
typedef struct IDedupReadFileCallbackVtbl {
  ...
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IDedupReadFileCallback *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IDedupReadFileCallback *This);
...
#define IDedupReadFileCallback_AddRef(This) ((This)->lpVtbl->AddRef(This))

#define IDedupReadFileCallback_Release(This) ((This)->lpVtbl->Release(This))

#define IDedupReadFileCallback_ReadBackupFile(This, FileFullPath, FileOffset,  \
                                              SizeToRead, FileBuffer,          \
                                              ReturnedSize, Flags)             \
  ((This)->lpVtbl->ReadBackupFile(This, FileFullPath, FileOffset, SizeToRead,  \
                                  FileBuffer, ReturnedSize, Flags))

#define IDedupReadFileCallback_OrderContainersRestore(                         \
    This, NumberOfContainers, ContainerPaths, ReadPlanEntries, ReadPlan)       \
  ((This)->lpVtbl->OrderContainersRestore(                                     \
      This, NumberOfContainers, ContainerPaths, ReadPlanEntries, ReadPlan))

#define IDedupReadFileCallback_PreviewContainerRead(                           \
    This, FileFullPath, NumberOfReads, ReadOffsets)                            \
  ((This)->lpVtbl->PreviewContainerRead(This, FileFullPath, NumberOfReads,     \
                                        ReadOffsets))
...
public:
  virtual HRESULT STDMETHODCALLTYPE RestoreFiles(
      ...
      /* [size_is][in] */ __RPC__in_ecount_full(NumberOfFiles) BSTR *
          FileFullPaths,
      /* [in] */ __RPC__in_opt IDedupReadFileCallback * Store,
      /* [in] */ DWORD Flags,
      /* [size_is][out] */ __RPC__out_ecount_full(NumberOfFiles) HRESULT *
          FileResults) = 0;
};
...
typedef struct IDedupBackupSupportVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IDedupBackupSupport *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IDedupBackupSupport *This);
...
#define IDedupBackupSupport_AddRef(This) ((This)->lpVtbl->AddRef(This))

#define IDedupBackupSupport_Release(This) ((This)->lpVtbl->Release(This))

#define IDedupBackupSupport_RestoreFiles(This, NumberOfFiles, FileFullPaths,   \
                                         Store, Flags, FileResults)            \
  ((This)->lpVtbl->RestoreFiles(This, NumberOfFiles, FileFullPaths, Store,     \
                                Flags, FileResults))
...
class DECLSPEC_UUID("73D6B2AD-2984-4715-B2E3-924C149744DD") DedupBackupSupport;
#endif
