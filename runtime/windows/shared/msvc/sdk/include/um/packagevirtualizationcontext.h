/*******************************************************************************************************
 *                                                                                                      *
 * PackageVirtualizationContext.h -- ApiSet Contract for
...
STDAPI
ActivatePackageVirtualizationContext(_In_ PACKAGE_VIRTUALIZATION_CONTEXT_HANDLE
                                         context,
...
STDAPI_(VOID)
DeactivatePackageVirtualizationContext(_In_ ULONG_PTR cookie);
...
STDAPI
GetProcessesInVirtualizationContext(_In_ PCWSTR packageFamilyName,
                                    _Out_ UINT *count,
...
BOOLEAN
__stdcall IsCreatePackageVirtualizationContextPresent(VOID);

BOOLEAN
__stdcall IsActivatePackageVirtualizationContextPresent(VOID);

BOOLEAN
__stdcall IsReleasePackageVirtualizationContextPresent(VOID);

BOOLEAN
__stdcall IsDeactivatePackageVirtualizationContextPresent(VOID);

BOOLEAN
__stdcall IsDuplicatePackageVirtualizationContextPresent(VOID);

BOOLEAN
__stdcall IsGetCurrentPackageVirtualizationContextPresent(VOID);

BOOLEAN
__stdcall IsGetProcessesInVirtualizationContextPresent(VOID);
