...
HRESULT WINAPI WSDCreateDiscoveryProvider(
    IWSDXMLContext *pContext, _Outptr_ IWSDiscoveryProvider **ppProvider);
#if (WINVER >= _WIN32_WINNT_WIN7)
HRESULT WINAPI WSDCreateDiscoveryProvider2(
    IWSDXMLContext *pContext,
    _In_reads_opt_(dwConfigParamCount) WSD_CONFIG_PARAM *pConfigParams,
    DWORD dwConfigParamCount, _Outptr_ IWSDiscoveryProvider **ppProvider);
#endif
...
HRESULT WINAPI WSDCreateDiscoveryPublisher(
    IWSDXMLContext *pContext, _Outptr_ IWSDiscoveryPublisher **ppPublisher);
#if (WINVER >= _WIN32_WINNT_WIN7)
HRESULT WINAPI WSDCreateDiscoveryPublisher2(
    IWSDXMLContext *pContext,
    _In_reads_opt_(dwConfigParamCount) WSD_CONFIG_PARAM *pConfigParams,
    DWORD dwConfigParamCount, _Outptr_ IWSDiscoveryPublisher **ppPublisher);
#endif
...
typedef struct IWSDiscoveryPublisherVtbl {
  ...
  HRESULT(STDMETHODCALLTYPE *Publish)(IWSDiscoveryPublisher *This,
                                      /* [annotation][in] */
                                      _In_ LPCWSTR pszId,
                                      /* [in] */ ULONGLONG ullMetadataVersion,
                                      /* [in] */ ULONGLONG ullInstanceId,
