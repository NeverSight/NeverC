...
typedef interface IEnumNetSharingPublicConnection
...
typedef interface IEnumNetSharingPrivateConnection
...
typedef interface INetSharingPortMappingCollection
...
typedef interface INetSharingEveryConnectionCollection
...
typedef interface INetSharingPublicConnectionCollection
...
typedef interface INetSharingPrivateConnectionCollection
...
typedef struct IEnumNetConnectionVtbl {
  ...
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in IEnumNetConnection *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IEnumNetConnection *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IEnumNetConnection *This);

  DECLSPEC_XFGVIRT(IEnumNetConnection, Next)
  HRESULT(STDMETHODCALLTYPE *Next)(__RPC__in IEnumNetConnection *This,
                                   /* [in] */ ULONG celt,
                                   /* [length_is][size_is][out] */
  ...
  HRESULT(STDMETHODCALLTYPE *Skip)(__RPC__in IEnumNetConnection *This,
                                   /* [in] */ ULONG celt);

  DECLSPEC_XFGVIRT(IEnumNetConnection, Reset)
  HRESULT(STDMETHODCALLTYPE *Reset)(__RPC__in IEnumNetConnection *This);
...
typedef struct INetConnectionVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in INetConnection *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in INetConnection *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in INetConnection *This);

  DECLSPEC_XFGVIRT(INetConnection, Connect)
  HRESULT(STDMETHODCALLTYPE *Connect)(__RPC__in INetConnection *This);

  DECLSPEC_XFGVIRT(INetConnection, Disconnect)
  HRESULT(STDMETHODCALLTYPE *Disconnect)(__RPC__in INetConnection *This);

  DECLSPEC_XFGVIRT(INetConnection, Delete)
  HRESULT(STDMETHODCALLTYPE *Delete)(__RPC__in INetConnection *This);
  ...
  HRESULT(STDMETHODCALLTYPE *Rename)(__RPC__in INetConnection *This,
...
typedef struct INetConnectionManagerVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in INetConnectionManager *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in INetConnectionManager *This);
...
typedef struct INetConnectionConnectUiVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in INetConnectionConnectUi *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in INetConnectionConnectUi *This);
  ...
  HRESULT(STDMETHODCALLTYPE *Connect)(__RPC__in INetConnectionConnectUi *This,
                                      /* [in] */ __RPC__in HWND hwndParent,
                                      /* [in] */ DWORD dwFlags);
...
public:
  ...
  virtual HRESULT STDMETHODCALLTYPE Clone(
      /* [out] */ __RPC__deref_out_opt IEnumNetSharingPortMapping *
      *ppenum) = 0;
};
...
typedef struct IEnumNetSharingPortMappingVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IEnumNetSharingPortMapping *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IEnumNetSharingPortMapping *This);

  DECLSPEC_XFGVIRT(IEnumNetSharingPortMapping, Next)
  HRESULT(STDMETHODCALLTYPE *Next)(__RPC__in IEnumNetSharingPortMapping *This,
                                   /* [in] */ ULONG celt,
                                   /* [length_is][size_is][out] */
                                   __RPC__out_ecount_part(celt, *pceltFetched)
                                       VARIANT *rgVar,
  ...
  HRESULT(STDMETHODCALLTYPE *Skip)(__RPC__in IEnumNetSharingPortMapping *This,
                                   /* [in] */ ULONG celt);

  DECLSPEC_XFGVIRT(IEnumNetSharingPortMapping, Reset)
  HRESULT(STDMETHODCALLTYPE *Reset)(__RPC__in IEnumNetSharingPortMapping *This);
...
typedef struct INetSharingPortMappingPropsVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in INetSharingPortMappingProps *This);
  ...
  /* [helpstring][id][propget] */ HRESULT(
      STDMETHODCALLTYPE *get_TargetIPAddress)(
      __RPC__in INetSharingPortMappingProps *This,
...
public:
  ...
  virtual /* [helpstring][id][propget] */ HRESULT STDMETHODCALLTYPE
      get_Properties(
          /* [retval][out] */ __RPC__deref_out_opt INetSharingPortMappingProps *
          *ppNSPMP) = 0;
...
typedef struct INetSharingPortMappingVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in INetSharingPortMapping *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in INetSharingPortMapping *This);
...
public:
  ...
  virtual HRESULT STDMETHODCALLTYPE Clone(
      /* [out] */ __RPC__deref_out_opt IEnumNetSharingEveryConnection *
      *ppenum) = 0;
};
...
public:
  ...
  virtual HRESULT STDMETHODCALLTYPE Clone(
      /* [out] */ __RPC__deref_out_opt IEnumNetSharingPublicConnection *
      *ppenum) = 0;
};
...
public:
  ...
  virtual HRESULT STDMETHODCALLTYPE Clone(
      /* [out] */ __RPC__deref_out_opt IEnumNetSharingPrivateConnection *
      *ppenum) = 0;
};
...
typedef struct INetConnectionPropsVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in INetConnectionProps *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in INetConnectionProps *This);
...
public:
  ...
  virtual /* [helpstring][id] */ HRESULT STDMETHODCALLTYPE DisableSharing(
      void) = 0;
  ...
  DisableInternetFirewall(void) = 0;

  virtual /* [helpstring][id] */ HRESULT STDMETHODCALLTYPE
  EnableInternetFirewall(void) = 0;

  virtual /* [helpstring][id][propget] */ HRESULT STDMETHODCALLTYPE
  get_EnumPortMappings(
      /* [in] */ SHARINGCONNECTION_ENUM_FLAGS Flags,
      /* [retval][out] */
      __RPC__deref_out_opt INetSharingPortMappingCollection * *ppColl) = 0;
  ...
  virtual /* [helpstring][id] */ HRESULT STDMETHODCALLTYPE AddPortMapping(
      ...
      /* [retval][out] */ __RPC__deref_out_opt INetSharingPortMapping *
          *ppMapping) = 0;
...
typedef struct INetSharingConfigurationVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in INetSharingConfiguration *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in INetSharingConfiguration *This);
  ...
  /* [helpstring][id][propget] */ HRESULT(
      STDMETHODCALLTYPE *get_InternetFirewallEnabled)(
      __RPC__in INetSharingConfiguration *This,
      /* [retval][out] */ __RPC__out VARIANT_BOOL *pbEnabled);
  ...
  /* [helpstring][id][propget] */ HRESULT(
      STDMETHODCALLTYPE *get_EnumPortMappings)(
      __RPC__in INetSharingConfiguration *This,
      /* [in] */ SHARINGCONNECTION_ENUM_FLAGS Flags,
      /* [retval][out] */
...
public:
  ...
  get_EnumPublicConnections(
      /* [in] */ SHARINGCONNECTION_ENUM_FLAGS Flags,
      /* [retval][out] */
      __RPC__deref_out_opt INetSharingPublicConnectionCollection * *ppColl) = 0;

  virtual /* [helpstring][id][propget] */ HRESULT STDMETHODCALLTYPE
  get_EnumPrivateConnections(
      /* [in] */ SHARINGCONNECTION_ENUM_FLAGS Flags,
      /* [retval][out] */
      __RPC__deref_out_opt INetSharingPrivateConnectionCollection *
          *ppColl) = 0;

  virtual /* [helpstring][id][propget] */ HRESULT STDMETHODCALLTYPE
      get_INetSharingConfigurationForINetConnection(
          /* [in] */ __RPC__in_opt INetConnection * pNetConnection,
          /* [retval][out] */ __RPC__deref_out_opt INetSharingConfiguration *
              *ppNetSharingConfiguration) = 0;

  virtual /* [helpstring][id][propget] */ HRESULT STDMETHODCALLTYPE
      get_EnumEveryConnection(
          /* [retval][out] */
          __RPC__deref_out_opt INetSharingEveryConnectionCollection *
          *ppColl) = 0;

  virtual /* [helpstring][id][propget] */ HRESULT STDMETHODCALLTYPE
      get_NetConnectionProps(
          /* [in] */ __RPC__in_opt INetConnection * pNetConnection,
          /* [retval][out] */ __RPC__deref_out_opt INetConnectionProps *
              *ppProps) = 0;
};
...
typedef struct INetSharingManagerVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in INetSharingManager *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in INetSharingManager *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in INetSharingManager *This);
  ...
  /* [helpstring][id][propget] */ HRESULT(
      STDMETHODCALLTYPE *get_EnumPrivateConnections)(
      __RPC__in INetSharingManager *This,
      /* [in] */ SHARINGCONNECTION_ENUM_FLAGS Flags,
      /* [retval][out] */
      __RPC__deref_out_opt INetSharingPrivateConnectionCollection **ppColl);

  DECLSPEC_XFGVIRT(INetSharingManager,
                   get_INetSharingConfigurationForINetConnection)
  /* [helpstring][id][propget] */ HRESULT(
      STDMETHODCALLTYPE *get_INetSharingConfigurationForINetConnection)(
      __RPC__in INetSharingManager *This,
      /* [in] */ __RPC__in_opt INetConnection *pNetConnection,
      /* [retval][out] */
      __RPC__deref_out_opt INetSharingConfiguration *
          *ppNetSharingConfiguration);

  DECLSPEC_XFGVIRT(INetSharingManager, get_EnumEveryConnection)
  /* [helpstring][id][propget] */ HRESULT(
      STDMETHODCALLTYPE *get_EnumEveryConnection)(
      __RPC__in INetSharingManager *This,
      /* [retval][out] */
  ...
  /* [helpstring][id][propget] */ HRESULT(
      STDMETHODCALLTYPE *get_NetConnectionProps)(
      __RPC__in INetSharingManager *This,
      /* [in] */ __RPC__in_opt INetConnection *pNetConnection,
...
class DECLSPEC_UUID("5C63C1AD-3956-4FF8-8486-40034758315B") NetSharingManager;
#endif
