...
public:
  virtual /* [propget] */ HRESULT STDMETHODCALLTYPE get_State(
      /* [retval][out] */ __RPC__out RENDEZVOUS_SESSION_STATE *
      pSessionState) = 0;
...
typedef struct IRendezvousSessionVtbl {
  ...
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in IRendezvousSession *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IRendezvousSession *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IRendezvousSession *This);
  ...
  HRESULT(STDMETHODCALLTYPE *Terminate)(__RPC__in IRendezvousSession *This,
                                        /* [in] */ HRESULT hr,
...
typedef struct DRendezvousSessionEventsVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in DRendezvousSessionEvents *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in DRendezvousSessionEvents *This);
...
#define DRendezvousSessionEvents_GetIDsOfNames(This, riid, rgszNames, cNames,  \
                                               lcid, rgDispId)                 \
  ((This)->lpVtbl->GetIDsOfNames(This, riid, rgszNames, cNames, lcid, rgDispId))

#define DRendezvousSessionEvents_Invoke(This, dispIdMember, riid, lcid,        \
...
typedef struct IRendezvousApplicationVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IRendezvousApplication *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IRendezvousApplication *This);
