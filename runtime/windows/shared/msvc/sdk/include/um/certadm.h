...
typedef struct ICertAdminVtbl {
  ...
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in ICertAdmin *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in ICertAdmin *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in ICertAdmin *This);
...
interface ICertAdmin { CONST_VTBL struct ICertAdminVtbl *lpVtbl; };
...
typedef struct ICertAdmin2Vtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in ICertAdmin2 *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in ICertAdmin2 *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in ICertAdmin2 *This);
...
interface ICertAdmin2 { CONST_VTBL struct ICertAdmin2Vtbl *lpVtbl; };
...
typedef struct IOCSPPropertyVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in IOCSPProperty *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IOCSPProperty *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IOCSPProperty *This);
...
interface IOCSPProperty { CONST_VTBL struct IOCSPPropertyVtbl *lpVtbl; };
...
#define IOCSPProperty_GetIDsOfNames(This, riid, rgszNames, cNames, lcid,       \
                                    rgDispId)                                  \
  ((This)->lpVtbl->GetIDsOfNames(This, riid, rgszNames, cNames, lcid, rgDispId))

#define IOCSPProperty_Invoke(This, dispIdMember, riid, lcid, wFlags,           \
                             pDispParams, pVarResult, pExcepInfo, puArgErr)    \
  ((This)->lpVtbl->Invoke(This, dispIdMember, riid, lcid, wFlags, pDispParams, \
                          pVarResult, pExcepInfo, puArgErr))
...
typedef struct IOCSPPropertyCollectionVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IOCSPPropertyCollection *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IOCSPPropertyCollection *This);
...
#define IOCSPPropertyCollection_GetIDsOfNames(This, riid, rgszNames, cNames,   \
                                              lcid, rgDispId)                  \
  ((This)->lpVtbl->GetIDsOfNames(This, riid, rgszNames, cNames, lcid, rgDispId))

#define IOCSPPropertyCollection_Invoke(This, dispIdMember, riid, lcid, wFlags, \
...
#define IOCSPPropertyCollection_CreateProperty(This, bstrPropName,             \
                                               pVarPropValue, ppVal)           \
...
typedef struct IOCSPCAConfigurationVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IOCSPCAConfiguration *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IOCSPCAConfiguration *This);
  ...
  /* [helpstring][id][propget] */ HRESULT(
      STDMETHODCALLTYPE *get_ProviderProperties)(
      __RPC__in IOCSPCAConfiguration *This,
      /* [retval][out] */ __RPC__out VARIANT *pVal);

  DECLSPEC_XFGVIRT(IOCSPCAConfiguration, put_ProviderProperties)
  /* [helpstring][id][propput] */ HRESULT(
      STDMETHODCALLTYPE *put_ProviderProperties)(
      __RPC__in IOCSPCAConfiguration *This,
      /* [in] */ VARIANT newVal);
...
#define IOCSPCAConfiguration_GetIDsOfNames(This, riid, rgszNames, cNames,      \
                                           lcid, rgDispId)                     \
  ((This)->lpVtbl->GetIDsOfNames(This, riid, rgszNames, cNames, lcid, rgDispId))

#define IOCSPCAConfiguration_Invoke(This, dispIdMember, riid, lcid, wFlags,    \
                                    pDispParams, pVarResult, pExcepInfo,       \
                                    puArgErr)                                  \
  ((This)->lpVtbl->Invoke(This, dispIdMember, riid, lcid, wFlags, pDispParams, \
                          pVarResult, pExcepInfo, puArgErr))
...
public:
  ...
  CreateCAConfiguration(
      ...
      /* [retval][out] */
      __RPC__deref_out_opt IOCSPCAConfiguration **ppVal) = 0;
...
#define IOCSPCAConfigurationCollection_GetTypeInfo(This, iTInfo, lcid,         \
                                                   ppTInfo)                    \
  ((This)->lpVtbl->GetTypeInfo(This, iTInfo, lcid, ppTInfo))

#define IOCSPCAConfigurationCollection_GetIDsOfNames(This, riid, rgszNames,    \
                                                     cNames, lcid, rgDispId)   \
  ((This)->lpVtbl->GetIDsOfNames(This, riid, rgszNames, cNames, lcid, rgDispId))

#define IOCSPCAConfigurationCollection_Invoke(This, dispIdMember, riid, lcid,  \
...
#define IOCSPCAConfigurationCollection_get_ItemByName(This, bstrIdentifier,    \
                                                      pVal)                    \
  ((This)->lpVtbl->get_ItemByName(This, bstrIdentifier, pVal))

#define IOCSPCAConfigurationCollection_CreateCAConfiguration(                  \
    This, bstrIdentifier, varCACert, ppVal)                                    \
  ((This)->lpVtbl->CreateCAConfiguration(This, bstrIdentifier, varCACert,      \
                                         ppVal))

#define IOCSPCAConfigurationCollection_DeleteCAConfiguration(This,             \
                                                             bstrIdentifier)   \
...
public:
  virtual /* [helpstring][id][propget] */ HRESULT STDMETHODCALLTYPE
      get_OCSPServiceProperties(
          /* [retval][out] */ __RPC__deref_out_opt IOCSPPropertyCollection *
          *ppVal) = 0;

  virtual /* [helpstring][id][propget] */ HRESULT STDMETHODCALLTYPE
      get_OCSPCAConfigurationCollection(
          /* [retval][out] */
          __RPC__deref_out_opt IOCSPCAConfigurationCollection * *pVal) = 0;
...
typedef struct IOCSPAdminVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in IOCSPAdmin *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IOCSPAdmin *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IOCSPAdmin *This);
  ...
  /* [helpstring][id][propget] */ HRESULT(
      STDMETHODCALLTYPE *get_OCSPServiceProperties)(
      __RPC__in IOCSPAdmin *This,
  ...
  /* [helpstring][id][propget] */ HRESULT(
      STDMETHODCALLTYPE *get_OCSPCAConfigurationCollection)(
      __RPC__in IOCSPAdmin *This,
      /* [retval][out] */ __RPC__deref_out_opt IOCSPCAConfigurationCollection *
          *pVal);
...
interface IOCSPAdmin { CONST_VTBL struct IOCSPAdminVtbl *lpVtbl; };
...
#define IOCSPAdmin_GetIDsOfNames(This, riid, rgszNames, cNames, lcid,          \
                                 rgDispId)                                     \
  ((This)->lpVtbl->GetIDsOfNames(This, riid, rgszNames, cNames, lcid, rgDispId))
...
#define IOCSPAdmin_GetSigningCertificates(This, bstrServerName, pCACertVar,    \
                                          pVal)                                \
  ((This)->lpVtbl->GetSigningCertificates(This, bstrServerName, pCACertVar,    \
                                          pVal))
...
class DECLSPEC_UUID("D3F73511-92C9-47CB-8FF2-8D891A7C4DE4") OCSPAdmin;
#endif
