...
typedef struct ITravelEntryVtbl {
  ...
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in ITravelEntry *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in ITravelEntry *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in ITravelEntry *This);
...
interface ITravelEntry { CONST_VTBL struct ITravelEntryVtbl *lpVtbl; };
...
public:
  ...
  virtual /* [local][helpcontext][helpstring] */ HRESULT STDMETHODCALLTYPE
  GetTravelEntry(
      /* [annotation][in] */
      _In_ IUnknown * punk,
      /* [annotation][in] */
  ...
  virtual /* [local][helpcontext][helpstring] */ DWORD STDMETHODCALLTYPE
      CountEntries(
          /* [in] */ IUnknown * punk) = 0;

  virtual /* [helpcontext][helpstring] */ HRESULT STDMETHODCALLTYPE Revert(
      void) = 0;
};
...
typedef struct ITravelLogVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in ITravelLog *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in ITravelLog *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in ITravelLog *This);
  ...
  /* [local][helpcontext][helpstring] */ HRESULT(
      STDMETHODCALLTYPE *GetTravelEntry)(ITravelLog *This,
                                         /* [annotation][in] */
                                         _In_ IUnknown *punk,
                                         /* [annotation][in] */
                                         _In_ int iOffset,
...
interface ITravelLog { CONST_VTBL struct ITravelLogVtbl *lpVtbl; };
...
class CIE4ConnectionPoint : public IConnectionPoint {
  ...
  virtual HRESULT DoInvokeIE4(BOOL *pf, void **ppv, DISPID dispid,
                              DISPPARAMS *pdispparams) PURE;
  // This helper function does work that callers of DoInvoke often need done
  virtual HRESULT DoInvokePIDLIE4(DISPID dispid, PCIDLIST_ABSOLUTE pidl,
                                  BOOL fCanCancel) PURE;
};
#else // !__cplusplus
...
typedef struct IExpDispSupportXPVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(IExpDispSupportXP *This,
                                             /* [in] */ REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);
  ...
  HRESULT(STDMETHODCALLTYPE *OnTranslateAccelerator)(IExpDispSupportXP *This,
                                                     /* [annotation][in] */
                                                     _In_ MSG *pMsg,
                                                     /* [annotation][in] */
  ...
  HRESULT(STDMETHODCALLTYPE *OnInvoke)(IExpDispSupportXP *This,
                                       /* [annotation][in] */
                                       _In_ DISPID dispidMember,
                                       /* [annotation][in] */
                                       _In_ REFIID iid,
...
#define IExpDispSupportXP_OnInvoke(This, dispidMember, iid, lcid, wFlags,      \
                                   pdispparams, pVarResult, pexcepinfo,        \
                                   puArgErr)                                   \
  ((This)->lpVtbl->OnInvoke(This, dispidMember, iid, lcid, wFlags,             \
...
typedef struct IExpDispSupportVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(IExpDispSupport *This,
                                             /* [in] */ REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);
  ...
  HRESULT(STDMETHODCALLTYPE *OnTranslateAccelerator)(IExpDispSupport *This,
                                                     /* [annotation][in] */
                                                     _In_ MSG *pMsg,
                                                     /* [annotation][in] */
                                                     _In_ DWORD grfModifiers);
  ...
  HRESULT(STDMETHODCALLTYPE *OnInvoke)(IExpDispSupport *This,
                                       /* [annotation][in] */
                                       _In_ DISPID dispidMember,
                                       /* [annotation][in] */
                                       _In_ REFIID iid,
...
interface IExpDispSupport { CONST_VTBL struct IExpDispSupportVtbl *lpVtbl; };
...
#define HLNF_CALLERUNTRUSTED                                                   \
  0x00200000 // The navigate was possibly initiated by a web page by scripting
             // code already on the system
#define HLNF_TRUSTEDFORACTIVEX                                                 \
  0x00400000 // The navigate should allow ActiveX prompts.
#define HLNF_DISABLEWINDOWRESTRICTIONS                                         \
  0x00800000 // New window is created by url in zone that has the window
             // restrictions security mitigation disabled
#define HLNF_TRUSTFIRSTDOWNLOAD                                                \
  0x01000000 // New window is result of user initiated action.  Trust it if it
             // immediatly trys to download.
#define HLNF_UNTRUSTEDFORDOWNLOAD                                              \
  0x02000000 // Trident is navigating to an untrusted non-html file.  If we try
             // to download it, do not.
#define SHHLNF_NOAUTOSELECT                                                    \
  0x04000000 // This navigate should not automatically select History
             // ShellFolder
#define SHHLNF_WRITENOHISTORY                                                  \
  0x08000000 // This navigate should not go in the History ShellFolder
#define HLNF_EXTERNALNAVIGATE 0x10000000
#define HLNF_ALLOW_AUTONAVIGATE 0x20000000
#define HLNF_NEWWINDOWSMANAGED                                                 \
  0x80000000 // If this navigate results in a new window, it should be subject
             // to popup manager.
...
public:
  ...
  virtual /* [local] */ HRESULT STDMETHODCALLTYPE GetTitle(
      ...
      _Out_writes_(cchName) LPWSTR pszName, DWORD cchName) = 0;
  ...
  virtual /* [local] */ HRESULT STDMETHODCALLTYPE IEGetDisplayName(
      ...
      /* [annotation][out] */
      _Out_writes_(INTERNET_MAX_URL_LENGTH) LPWSTR pwszName, UINT uFlags) = 0;
  ...
  virtual /* [local] */ HRESULT STDMETHODCALLTYPE NavigateToPidl(
      /* [annotation][in] */
      _In_ PCIDLIST_ABSOLUTE pidl, DWORD grfHLNF) = 0;
  ...
  virtual /* [local] */ HRESULT STDMETHODCALLTYPE SetFlags(
      DWORD dwFlags, DWORD dwFlagMask) = 0;
  ...
  virtual /* [local] */ HRESULT STDMETHODCALLTYPE SetHistoryObject(
      /* [annotation][in] */
      _In_ IOleObject * pole, BOOL fIsLocalAnchor) = 0;
  ...
  virtual /* [local] */ HRESULT STDMETHODCALLTYPE OnHttpEquiv(
      /* [annotation][in] */
      _In_ IShellView * psv, BOOL fDone,
      /* [annotation][in] */
...
typedef struct IBrowserServiceVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in IBrowserService *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IBrowserService *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IBrowserService *This);
  ...
  /* [local] */ HRESULT(STDMETHODCALLTYPE *SetTitle)(IBrowserService *This,
                                                     /* [annotation][in] */
                                                     _In_ IShellView *psv,
                                                     /* [annotation][in] */
  ...
  /* [local] */ HRESULT(STDMETHODCALLTYPE *GetTitle)(
      ...
      _In_ IShellView *psv,
      /* [annotation][size_is][out] */
      _Out_writes_(cchName) LPWSTR pszName, DWORD cchName);
  ...
  /* [local] */ HRESULT(STDMETHODCALLTYPE *DisplayParseError)(
      IBrowserService *This, HRESULT hres,
      /* [annotation][in] */
      _In_ LPCWSTR pwszPath);
  ...
  /* [local] */ HRESULT(STDMETHODCALLTYPE *SetFlags)(IBrowserService *This,
                                                     DWORD dwFlags,
                                                     DWORD dwFlagMask);

  DECLSPEC_XFGVIRT(IBrowserService, GetFlags)
  /* [local] */ HRESULT(STDMETHODCALLTYPE *GetFlags)(IBrowserService *This,
                                                     /* [annotation][out] */
  ...
  /* [local] */ HRESULT(STDMETHODCALLTYPE *SetReferrer)(IBrowserService *This,
                                                        /* [annotation][in] */
  ...
  /* [local] */ HRESULT(STDMETHODCALLTYPE *GetBrowserByIndex)(
      IBrowserService *This, DWORD dwID,
      /* [annotation][out] */
  ...
  /* [local] */ HRESULT(STDMETHODCALLTYPE *SetHistoryObject)(
      IBrowserService *This,
      /* [annotation][in] */
      _In_ IOleObject *pole, BOOL fIsLocalAnchor);
  ...
  /* [local] */ HRESULT(STDMETHODCALLTYPE *GetPalette)(IBrowserService *This,
                                                       /* [annotation][out] */
                                                       _Out_ HPALETTE *hpal);

  DECLSPEC_XFGVIRT(IBrowserService, RegisterWindow)
  /* [local] */ HRESULT(STDMETHODCALLTYPE *RegisterWindow)(
      IBrowserService *This, BOOL fForceRegister, int swc);

  END_INTERFACE
} IBrowserServiceVtbl;

interface IBrowserService { CONST_VTBL struct IBrowserServiceVtbl *lpVtbl; };
...
typedef struct IShellServiceVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(IShellService *This,
                                             /* [in] */ REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);
  ...
  HRESULT(STDMETHODCALLTYPE *SetOwner)(IShellService *This,
                                       /* [annotation][unique][in] */
...
interface IShellService { CONST_VTBL struct IShellServiceVtbl *lpVtbl; };
...
#define VIEW_PRIORITY_RESTRICTED                                               \
  0x00000070 // a shell restriction is in place that forces this view to be the
             // one we use
#define VIEW_PRIORITY_CACHEHIT                                                 \
  0x00000050 // we have registry info for the view, so the user has been there
             // before
#define VIEW_PRIORITY_STALECACHEHIT                                            \
  0x00000045 // we have stale registry info for the view, so we fall back to the
             // 'all folders like this' default
#define VIEW_PRIORITY_USEASDEFAULT                                             \
  0x00000043 // 'Use As Default' is more important than shellext, but less than
             // a stale cache
#define VIEW_PRIORITY_SHELLEXT                                                 \
  0x00000040 // next we let the shell extension have its say
#define VIEW_PRIORITY_CACHEMISS                                                \
  0x00000030 // if we have a cache miss, then we fall back to the 'all folders
             // like this' default
#define VIEW_PRIORITY_INHERIT                                                  \
  0x00000020 // then try to inherit the view from the previous window
#define VIEW_PRIORITY_SHELLEXT_ASBACKUP                                        \
  0x0015 // If classic view state is enabled we want the shell to default to an
         // inheritted view
#define VIEW_PRIORITY_DESPERATE                                                \
  0x00000010 // just pick the last view that the window supports
...
typedef struct IBrowserService2Vtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(IBrowserService2 *This,
                                             /* [in] */ REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);
  ...
  DECLSPEC_XFGVIRT(IBrowserService, SetTitle)
  /* [local] */ HRESULT(STDMETHODCALLTYPE *SetTitle)(IBrowserService2 *This,
                                                     /* [annotation][in] */
                                                     _In_ IShellView *psv,
                                                     /* [annotation][in] */
                                                     _In_ LPCWSTR pszName);
  ...
  DECLSPEC_XFGVIRT(IBrowserService, GetTravelLog)
  HRESULT(STDMETHODCALLTYPE *GetTravelLog)(IBrowserService2 *This,
                                           /* [out] */ ITravelLog **pptl);

  DECLSPEC_XFGVIRT(IBrowserService, ShowControlWindow)
  /* [local] */ HRESULT(STDMETHODCALLTYPE *ShowControlWindow)(
      IBrowserService2 *This, UINT id, BOOL fShow);

  DECLSPEC_XFGVIRT(IBrowserService, IsControlWindowShown)
  /* [local] */ HRESULT(STDMETHODCALLTYPE *IsControlWindowShown)(
      IBrowserService2 *This, UINT id,
      /* [annotation][out] */
      _Out_ BOOL *pfShown);
  ...
  DECLSPEC_XFGVIRT(IBrowserService, IEParseDisplayName)
  /* [local] */ HRESULT(STDMETHODCALLTYPE *IEParseDisplayName)(
      IBrowserService2 *This, UINT uiCP,
      /* [annotation][in] */
      _In_ LPCWSTR pwszPath,
      /* [annotation][out] */
      _Outptr_ PIDLIST_ABSOLUTE *ppidlOut);
  ...
  DECLSPEC_XFGVIRT(IBrowserService, DisplayParseError)
  /* [local] */ HRESULT(STDMETHODCALLTYPE *DisplayParseError)(
      IBrowserService2 *This, HRESULT hres,
      /* [annotation][in] */
      _In_ LPCWSTR pwszPath);
  ...
  DECLSPEC_XFGVIRT(IBrowserService, SetNavigateState)
  /* [local] */ HRESULT(STDMETHODCALLTYPE *SetNavigateState)(
      IBrowserService2 *This, BNSTATE bnstate);
  ...
  DECLSPEC_XFGVIRT(IBrowserService, SetFlags)
  /* [local] */ HRESULT(STDMETHODCALLTYPE *SetFlags)(IBrowserService2 *This,
                                                     DWORD dwFlags,
                                                     DWORD dwFlagMask);

  DECLSPEC_XFGVIRT(IBrowserService, GetFlags)
  /* [local] */ HRESULT(STDMETHODCALLTYPE *GetFlags)(IBrowserService2 *This,
                                                     /* [annotation][out] */
                                                     _Out_ DWORD *pdwFlags);
  ...
  DECLSPEC_XFGVIRT(IBrowserService, SetReferrer)
  /* [local] */ HRESULT(STDMETHODCALLTYPE *SetReferrer)(IBrowserService2 *This,
                                                        /* [annotation][in] */
                                                        _In_ PCIDLIST_ABSOLUTE
                                                            pidl);
  ...
  DECLSPEC_XFGVIRT(IBrowserService, GetBrowserByIndex)
  /* [local] */ HRESULT(STDMETHODCALLTYPE *GetBrowserByIndex)(
      IBrowserService2 *This, DWORD dwID,
      /* [annotation][out] */
      _Outptr_ IUnknown **ppunk);
  ...
  DECLSPEC_XFGVIRT(IBrowserService, GetPalette)
  /* [local] */ HRESULT(STDMETHODCALLTYPE *GetPalette)(IBrowserService2 *This,
                                                       /* [annotation][out] */
                                                       _Out_ HPALETTE *hpal);

  DECLSPEC_XFGVIRT(IBrowserService, RegisterWindow)
  /* [local] */ HRESULT(STDMETHODCALLTYPE *RegisterWindow)(
      IBrowserService2 *This, BOOL fForceRegister, int swc);

  DECLSPEC_XFGVIRT(IBrowserService2, WndProcBS)
  LRESULT(STDMETHODCALLTYPE *WndProcBS)(IBrowserService2 *This,
                                        /* [annotation][in] */
                                        _In_ HWND hwnd,
                                        /* [annotation][in] */
                                        _In_ UINT uMsg,
  ...
  HRESULT(STDMETHODCALLTYPE *GetViewRect)(IBrowserService2 *This,
                                          /* [annotation][out] */
                                          _Out_ RECT *prc);

  DECLSPEC_XFGVIRT(IBrowserService2, OnSize)
  HRESULT(STDMETHODCALLTYPE *OnSize)(IBrowserService2 *This,
                                     /* [annotation][in] */
                                     _In_ WPARAM wParam);

  DECLSPEC_XFGVIRT(IBrowserService2, OnCreate)
  HRESULT(STDMETHODCALLTYPE *OnCreate)(IBrowserService2 *This,
                                       /* [annotation][in] */
                                       _In_ struct tagCREATESTRUCTW *pcs);

  DECLSPEC_XFGVIRT(IBrowserService2, OnCommand)
  LRESULT(STDMETHODCALLTYPE *OnCommand)(IBrowserService2 *This,
                                        /* [annotation][in] */
                                        _In_ WPARAM wParam,
                                        /* [annotation][in] */
                                        _In_ LPARAM lParam);
  ...
  LRESULT(STDMETHODCALLTYPE *OnNotify)(IBrowserService2 *This,
                                       /* [annotation][in] */
  ...
  HRESULT(STDMETHODCALLTYPE *OnFrameWindowActivateBS)(IBrowserService2 *This,
                                                      /* [annotation][in] */
                                                      _In_ BOOL fActive);
  ...
  HRESULT(STDMETHODCALLTYPE *CreateViewWindow)(IBrowserService2 *This,
                                               /* [annotation][in] */
                                               _In_ IShellView *psvNew,
                                               /* [annotation][in] */
                                               _In_ IShellView *psvOld,
  ...
  HRESULT(STDMETHODCALLTYPE *GetViewWindow)(IBrowserService2 *This,
                                            /* [annotation][out] */
  ...
  HRESULT(STDMETHODCALLTYPE *InitializeTravelLog)(IBrowserService2 *This,
                                                  /* [annotation][in] */
                                                  _In_ ITravelLog *ptl,
                                                  /* [annotation][in] */
                                                  _In_ DWORD dw);
  ...
  HRESULT(STDMETHODCALLTYPE *Offline)(IBrowserService2 *This,
                                      /* [annotation][in] */
                                      _In_ int iCmd);

  DECLSPEC_XFGVIRT(IBrowserService2, AllowViewResize)
  HRESULT(STDMETHODCALLTYPE *AllowViewResize)(IBrowserService2 *This,
                                              /* [annotation][in] */
                                              _In_ BOOL f);

  DECLSPEC_XFGVIRT(IBrowserService2, SetActivateState)
  HRESULT(STDMETHODCALLTYPE *SetActivateState)(IBrowserService2 *This,
                                               /* [annotation][in] */
                                               _In_ UINT u);

  DECLSPEC_XFGVIRT(IBrowserService2, UpdateSecureLockIcon)
  HRESULT(STDMETHODCALLTYPE *UpdateSecureLockIcon)(IBrowserService2 *This,
                                                   /* [annotation][in] */
  ...
  HRESULT(STDMETHODCALLTYPE *_Initialize)(IBrowserService2 *This,
                                          /* [annotation][in] */
                                          _In_ HWND hwnd,
                                          /* [annotation][in] */
                                          _In_ IUnknown *pauto);
  ...
  HRESULT(STDMETHODCALLTYPE *_PauseOrResumeView)(IBrowserService2 *This,
                                                 BOOL fPaused);
  ...
  HRESULT(STDMETHODCALLTYPE *_NavigateToPidl)(IBrowserService2 *This,
                                              /* [annotation][in] */
                                              _In_ PCIDLIST_ABSOLUTE pidl,
                                              /* [annotation][in] */
                                              _In_ DWORD grfHLNF,
  ...
  HRESULT(STDMETHODCALLTYPE *_TryShell2Rename)(IBrowserService2 *This,
                                               /* [annotation][in] */
                                               _In_ IShellView *psv,
                                               /* [annotation][in] */
  ...
  HRESULT(STDMETHODCALLTYPE *_ExecChildren)(IBrowserService2 *This,
                                            /* [annotation][in] */
                                            _In_ IUnknown *punkBar,
                                            /* [annotation][in] */
                                            _In_ BOOL fBroadcast,
  ...
  HRESULT(STDMETHODCALLTYPE *_SendChildren)(IBrowserService2 *This,
                                            /* [annotation][in] */
                                            _In_ HWND hwndBar,
                                            /* [annotation][in] */
                                            _In_ BOOL fBroadcast,
  ...
  HRESULT(STDMETHODCALLTYPE *_OnFocusChange)(IBrowserService2 *This,
                                             /* [annotation][in] */
                                             _In_ UINT itb);

  DECLSPEC_XFGVIRT(IBrowserService2, v_ShowHideChildWindows)
  HRESULT(STDMETHODCALLTYPE *v_ShowHideChildWindows)(IBrowserService2 *This,
                                                     /* [annotation][in] */
  ...
  HRESULT(STDMETHODCALLTYPE *_put_itbLastFocus)(IBrowserService2 *This,
                                                /* [annotation][in] */
                                                _In_ UINT itbLastFocus);

  DECLSPEC_XFGVIRT(IBrowserService2, _UIActivateView)
  HRESULT(STDMETHODCALLTYPE *_UIActivateView)(IBrowserService2 *This,
                                              /* [annotation][in] */
                                              _In_ UINT uState);

  DECLSPEC_XFGVIRT(IBrowserService2, _GetViewBorderRect)
  HRESULT(STDMETHODCALLTYPE *_GetViewBorderRect)(IBrowserService2 *This,
                                                 /* [out] */ RECT *prc);
  ...
  HRESULT(STDMETHODCALLTYPE *_ResizeNextBorder)(IBrowserService2 *This,
                                                /* [annotation][in] */
                                                _In_ UINT itb);
  ...
  HRESULT(STDMETHODCALLTYPE *_GetEffectiveClientArea)(IBrowserService2 *This,
                                                      /* [annotation][out] */
                                                      _Out_ LPRECT lprectBorder,
                                                      /* [annotation][in] */
                                                      _In_ HMONITOR hmon);
  ...
  LRESULT(STDMETHODCALLTYPE *ForwardViewMsg)(IBrowserService2 *This,
                                             /* [annotation][in] */
                                             _In_ UINT uMsg,
                                             /* [annotation][in] */
                                             _In_ WPARAM wParam,
  ...
  HRESULT(STDMETHODCALLTYPE *SetAcceleratorMenu)(IBrowserService2 *This,
                                                 /* [annotation][in] */
                                                 _In_ HACCEL hacc);
  ...
  LPTOOLBARITEM(STDMETHODCALLTYPE *_GetToolbarItem)(IBrowserService2 *This,
                                                    /* [annotation][in] */
                                                    _In_ int itb);

  DECLSPEC_XFGVIRT(IBrowserService2, _SaveToolbars)
  HRESULT(STDMETHODCALLTYPE *_SaveToolbars)(IBrowserService2 *This,
                                            /* [in] */ IStream *pstm);

  DECLSPEC_XFGVIRT(IBrowserService2, _LoadToolbars)
  HRESULT(STDMETHODCALLTYPE *_LoadToolbars)(IBrowserService2 *This,
                                            /* [annotation][in] */
                                            _In_ IStream *pstm);

  DECLSPEC_XFGVIRT(IBrowserService2, _CloseAndReleaseToolbars)
  HRESULT(STDMETHODCALLTYPE *_CloseAndReleaseToolbars)(IBrowserService2 *This,
                                                       BOOL fClose);
  ...
  HRESULT(STDMETHODCALLTYPE *_ResizeNextBorderHelper)(IBrowserService2 *This,
                                                      UINT itb,
                                                      BOOL bUseHmonitor);

  DECLSPEC_XFGVIRT(IBrowserService2, _FindTBar)
  UINT(STDMETHODCALLTYPE *_FindTBar)(IBrowserService2 *This,
                                     /* [annotation][in] */
                                     _In_ IUnknown *punkSrc);

  DECLSPEC_XFGVIRT(IBrowserService2, _SetFocus)
  HRESULT(STDMETHODCALLTYPE *_SetFocus)(IBrowserService2 *This,
                                        /* [annotation][in] */
                                        _In_ LPTOOLBARITEM ptbi,
                                        /* [annotation][in] */
                                        _In_ HWND hwnd,
  ...
  HRESULT(STDMETHODCALLTYPE *v_MayTranslateAccelerator)(IBrowserService2 *This,
                                                        /* [in] */ MSG *pmsg);

  DECLSPEC_XFGVIRT(IBrowserService2, _GetBorderDWHelper)
  HRESULT(STDMETHODCALLTYPE *_GetBorderDWHelper)(IBrowserService2 *This,
                                                 /* [annotation][in] */
                                                 _In_ IUnknown *punkSrc,
                                                 /* [annotation][out] */
                                                 _Out_ LPRECT lprectBorder,
  ...
  HRESULT(STDMETHODCALLTYPE *v_CheckZoneCrossing)(IBrowserService2 *This,
                                                  /* [annotation][in] */
                                                  _In_ PCIDLIST_ABSOLUTE pidl);
...
interface IBrowserService2 { CONST_VTBL struct IBrowserService2Vtbl *lpVtbl; };
...
#define IBrowserService2__SendChildren(This, hwndBar, fBroadcast, uMsg,        \
                                       wParam, lParam)                         \
  ((This)->lpVtbl->_SendChildren(This, hwndBar, fBroadcast, uMsg, wParam,      \
                                 lParam))
...
#define IBrowserService2__GetBorderDWHelper(This, punkSrc, lprectBorder,       \
                                            bUseHmonitor)                      \
  ((This)->lpVtbl->_GetBorderDWHelper(This, punkSrc, lprectBorder,             \
                                      bUseHmonitor))
...
typedef enum IEPDNFLAGS { IEPDN_BINDINGUI = 0x1 } IEPDNFLAGS;
...
typedef struct IBrowserService3Vtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(IBrowserService3 *This,
                                             /* [in] */ REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);
  ...
  DECLSPEC_XFGVIRT(IBrowserService, SetTitle)
  /* [local] */ HRESULT(STDMETHODCALLTYPE *SetTitle)(IBrowserService3 *This,
                                                     /* [annotation][in] */
                                                     _In_ IShellView *psv,
                                                     /* [annotation][in] */
                                                     _In_ LPCWSTR pszName);
  ...
  DECLSPEC_XFGVIRT(IBrowserService, GetTravelLog)
  HRESULT(STDMETHODCALLTYPE *GetTravelLog)(IBrowserService3 *This,
                                           /* [out] */ ITravelLog **pptl);

  DECLSPEC_XFGVIRT(IBrowserService, ShowControlWindow)
  /* [local] */ HRESULT(STDMETHODCALLTYPE *ShowControlWindow)(
      IBrowserService3 *This, UINT id, BOOL fShow);

  DECLSPEC_XFGVIRT(IBrowserService, IsControlWindowShown)
  /* [local] */ HRESULT(STDMETHODCALLTYPE *IsControlWindowShown)(
      IBrowserService3 *This, UINT id,
      /* [annotation][out] */
      _Out_ BOOL *pfShown);
  ...
  DECLSPEC_XFGVIRT(IBrowserService, IEParseDisplayName)
  /* [local] */ HRESULT(STDMETHODCALLTYPE *IEParseDisplayName)(
      IBrowserService3 *This, UINT uiCP,
      /* [annotation][in] */
      _In_ LPCWSTR pwszPath,
      /* [annotation][out] */
      _Outptr_ PIDLIST_ABSOLUTE *ppidlOut);
  ...
  DECLSPEC_XFGVIRT(IBrowserService, DisplayParseError)
  /* [local] */ HRESULT(STDMETHODCALLTYPE *DisplayParseError)(
      IBrowserService3 *This, HRESULT hres,
      /* [annotation][in] */
      _In_ LPCWSTR pwszPath);
  ...
  DECLSPEC_XFGVIRT(IBrowserService, SetNavigateState)
  /* [local] */ HRESULT(STDMETHODCALLTYPE *SetNavigateState)(
      IBrowserService3 *This, BNSTATE bnstate);
  ...
  DECLSPEC_XFGVIRT(IBrowserService, SetFlags)
  /* [local] */ HRESULT(STDMETHODCALLTYPE *SetFlags)(IBrowserService3 *This,
                                                     DWORD dwFlags,
                                                     DWORD dwFlagMask);

  DECLSPEC_XFGVIRT(IBrowserService, GetFlags)
  /* [local] */ HRESULT(STDMETHODCALLTYPE *GetFlags)(IBrowserService3 *This,
                                                     /* [annotation][out] */
                                                     _Out_ DWORD *pdwFlags);
  ...
  DECLSPEC_XFGVIRT(IBrowserService, SetReferrer)
  /* [local] */ HRESULT(STDMETHODCALLTYPE *SetReferrer)(IBrowserService3 *This,
                                                        /* [annotation][in] */
                                                        _In_ PCIDLIST_ABSOLUTE
                                                            pidl);
  ...
  DECLSPEC_XFGVIRT(IBrowserService, GetBrowserByIndex)
  /* [local] */ HRESULT(STDMETHODCALLTYPE *GetBrowserByIndex)(
      IBrowserService3 *This, DWORD dwID,
      /* [annotation][out] */
      _Outptr_ IUnknown **ppunk);
  ...
  DECLSPEC_XFGVIRT(IBrowserService, GetPalette)
  /* [local] */ HRESULT(STDMETHODCALLTYPE *GetPalette)(IBrowserService3 *This,
                                                       /* [annotation][out] */
                                                       _Out_ HPALETTE *hpal);

  DECLSPEC_XFGVIRT(IBrowserService, RegisterWindow)
  /* [local] */ HRESULT(STDMETHODCALLTYPE *RegisterWindow)(
      IBrowserService3 *This, BOOL fForceRegister, int swc);

  DECLSPEC_XFGVIRT(IBrowserService2, WndProcBS)
  LRESULT(STDMETHODCALLTYPE *WndProcBS)(IBrowserService3 *This,
                                        /* [annotation][in] */
                                        _In_ HWND hwnd,
                                        /* [annotation][in] */
                                        _In_ UINT uMsg,
  ...
  DECLSPEC_XFGVIRT(IBrowserService2, GetViewRect)
  HRESULT(STDMETHODCALLTYPE *GetViewRect)(IBrowserService3 *This,
                                          /* [annotation][out] */
                                          _Out_ RECT *prc);

  DECLSPEC_XFGVIRT(IBrowserService2, OnSize)
  HRESULT(STDMETHODCALLTYPE *OnSize)(IBrowserService3 *This,
                                     /* [annotation][in] */
                                     _In_ WPARAM wParam);

  DECLSPEC_XFGVIRT(IBrowserService2, OnCreate)
  HRESULT(STDMETHODCALLTYPE *OnCreate)(IBrowserService3 *This,
                                       /* [annotation][in] */
                                       _In_ struct tagCREATESTRUCTW *pcs);

  DECLSPEC_XFGVIRT(IBrowserService2, OnCommand)
  LRESULT(STDMETHODCALLTYPE *OnCommand)(IBrowserService3 *This,
                                        /* [annotation][in] */
                                        _In_ WPARAM wParam,
                                        /* [annotation][in] */
                                        _In_ LPARAM lParam);
  ...
  DECLSPEC_XFGVIRT(IBrowserService2, OnNotify)
  LRESULT(STDMETHODCALLTYPE *OnNotify)(IBrowserService3 *This,
                                       /* [annotation][in] */
                                       _In_ struct tagNMHDR *pnm);
  ...
  DECLSPEC_XFGVIRT(IBrowserService2, OnFrameWindowActivateBS)
  HRESULT(STDMETHODCALLTYPE *OnFrameWindowActivateBS)(IBrowserService3 *This,
                                                      /* [annotation][in] */
                                                      _In_ BOOL fActive);
  ...
  DECLSPEC_XFGVIRT(IBrowserService2, CreateViewWindow)
  HRESULT(STDMETHODCALLTYPE *CreateViewWindow)(IBrowserService3 *This,
                                               /* [annotation][in] */
                                               _In_ IShellView *psvNew,
                                               /* [annotation][in] */
                                               _In_ IShellView *psvOld,
  ...
  DECLSPEC_XFGVIRT(IBrowserService2, GetViewWindow)
  HRESULT(STDMETHODCALLTYPE *GetViewWindow)(IBrowserService3 *This,
                                            /* [annotation][out] */
                                            _Out_ HWND *phwndView);
  ...
  DECLSPEC_XFGVIRT(IBrowserService2, InitializeTravelLog)
  HRESULT(STDMETHODCALLTYPE *InitializeTravelLog)(IBrowserService3 *This,
                                                  /* [annotation][in] */
                                                  _In_ ITravelLog *ptl,
                                                  /* [annotation][in] */
                                                  _In_ DWORD dw);
  ...
  DECLSPEC_XFGVIRT(IBrowserService2, Offline)
  HRESULT(STDMETHODCALLTYPE *Offline)(IBrowserService3 *This,
                                      /* [annotation][in] */
                                      _In_ int iCmd);

  DECLSPEC_XFGVIRT(IBrowserService2, AllowViewResize)
  HRESULT(STDMETHODCALLTYPE *AllowViewResize)(IBrowserService3 *This,
                                              /* [annotation][in] */
                                              _In_ BOOL f);

  DECLSPEC_XFGVIRT(IBrowserService2, SetActivateState)
  HRESULT(STDMETHODCALLTYPE *SetActivateState)(IBrowserService3 *This,
                                               /* [annotation][in] */
                                               _In_ UINT u);

  DECLSPEC_XFGVIRT(IBrowserService2, UpdateSecureLockIcon)
  HRESULT(STDMETHODCALLTYPE *UpdateSecureLockIcon)(IBrowserService3 *This,
                                                   /* [annotation][in] */
                                                   _In_ int eSecureLock);
  ...
  DECLSPEC_XFGVIRT(IBrowserService2, _Initialize)
  HRESULT(STDMETHODCALLTYPE *_Initialize)(IBrowserService3 *This,
                                          /* [annotation][in] */
                                          _In_ HWND hwnd,
                                          /* [annotation][in] */
                                          _In_ IUnknown *pauto);
  ...
  DECLSPEC_XFGVIRT(IBrowserService2, _PauseOrResumeView)
  HRESULT(STDMETHODCALLTYPE *_PauseOrResumeView)(IBrowserService3 *This,
                                                 BOOL fPaused);
  ...
  DECLSPEC_XFGVIRT(IBrowserService2, _NavigateToPidl)
  HRESULT(STDMETHODCALLTYPE *_NavigateToPidl)(IBrowserService3 *This,
                                              /* [annotation][in] */
                                              _In_ PCIDLIST_ABSOLUTE pidl,
                                              /* [annotation][in] */
                                              _In_ DWORD grfHLNF,
  ...
  DECLSPEC_XFGVIRT(IBrowserService2, _TryShell2Rename)
  HRESULT(STDMETHODCALLTYPE *_TryShell2Rename)(IBrowserService3 *This,
                                               /* [annotation][in] */
                                               _In_ IShellView *psv,
                                               /* [annotation][in] */
                                               _In_ PCIDLIST_ABSOLUTE pidlNew);
  ...
  DECLSPEC_XFGVIRT(IBrowserService2, _ExecChildren)
  HRESULT(STDMETHODCALLTYPE *_ExecChildren)(IBrowserService3 *This,
                                            /* [annotation][in] */
                                            _In_ IUnknown *punkBar,
                                            /* [annotation][in] */
                                            _In_ BOOL fBroadcast,
  ...
  DECLSPEC_XFGVIRT(IBrowserService2, _SendChildren)
  HRESULT(STDMETHODCALLTYPE *_SendChildren)(IBrowserService3 *This,
                                            /* [annotation][in] */
                                            _In_ HWND hwndBar,
                                            /* [annotation][in] */
                                            _In_ BOOL fBroadcast,
  ...
  DECLSPEC_XFGVIRT(IBrowserService2, _OnFocusChange)
  HRESULT(STDMETHODCALLTYPE *_OnFocusChange)(IBrowserService3 *This,
                                             /* [annotation][in] */
                                             _In_ UINT itb);

  DECLSPEC_XFGVIRT(IBrowserService2, v_ShowHideChildWindows)
  HRESULT(STDMETHODCALLTYPE *v_ShowHideChildWindows)(IBrowserService3 *This,
                                                     /* [annotation][in] */
                                                     _In_ BOOL fChildOnly);
  ...
  DECLSPEC_XFGVIRT(IBrowserService2, _put_itbLastFocus)
  HRESULT(STDMETHODCALLTYPE *_put_itbLastFocus)(IBrowserService3 *This,
                                                /* [annotation][in] */
                                                _In_ UINT itbLastFocus);

  DECLSPEC_XFGVIRT(IBrowserService2, _UIActivateView)
  HRESULT(STDMETHODCALLTYPE *_UIActivateView)(IBrowserService3 *This,
                                              /* [annotation][in] */
                                              _In_ UINT uState);

  DECLSPEC_XFGVIRT(IBrowserService2, _GetViewBorderRect)
  HRESULT(STDMETHODCALLTYPE *_GetViewBorderRect)(IBrowserService3 *This,
                                                 /* [out] */ RECT *prc);
  ...
  DECLSPEC_XFGVIRT(IBrowserService2, _ResizeNextBorder)
  HRESULT(STDMETHODCALLTYPE *_ResizeNextBorder)(IBrowserService3 *This,
                                                /* [annotation][in] */
                                                _In_ UINT itb);
  ...
  DECLSPEC_XFGVIRT(IBrowserService2, _GetEffectiveClientArea)
  HRESULT(STDMETHODCALLTYPE *_GetEffectiveClientArea)(IBrowserService3 *This,
                                                      /* [annotation][out] */
                                                      _Out_ LPRECT lprectBorder,
                                                      /* [annotation][in] */
                                                      _In_ HMONITOR hmon);
  ...
  DECLSPEC_XFGVIRT(IBrowserService2, ForwardViewMsg)
  LRESULT(STDMETHODCALLTYPE *ForwardViewMsg)(IBrowserService3 *This,
                                             /* [annotation][in] */
                                             _In_ UINT uMsg,
                                             /* [annotation][in] */
                                             _In_ WPARAM wParam,
  ...
  DECLSPEC_XFGVIRT(IBrowserService2, SetAcceleratorMenu)
  HRESULT(STDMETHODCALLTYPE *SetAcceleratorMenu)(IBrowserService3 *This,
                                                 /* [annotation][in] */
                                                 _In_ HACCEL hacc);
  ...
  DECLSPEC_XFGVIRT(IBrowserService2, _GetToolbarItem)
  LPTOOLBARITEM(STDMETHODCALLTYPE *_GetToolbarItem)(IBrowserService3 *This,
                                                    /* [annotation][in] */
                                                    _In_ int itb);

  DECLSPEC_XFGVIRT(IBrowserService2, _SaveToolbars)
  HRESULT(STDMETHODCALLTYPE *_SaveToolbars)(IBrowserService3 *This,
                                            /* [in] */ IStream *pstm);

  DECLSPEC_XFGVIRT(IBrowserService2, _LoadToolbars)
  HRESULT(STDMETHODCALLTYPE *_LoadToolbars)(IBrowserService3 *This,
                                            /* [annotation][in] */
                                            _In_ IStream *pstm);

  DECLSPEC_XFGVIRT(IBrowserService2, _CloseAndReleaseToolbars)
  HRESULT(STDMETHODCALLTYPE *_CloseAndReleaseToolbars)(IBrowserService3 *This,
                                                       BOOL fClose);
  ...
  DECLSPEC_XFGVIRT(IBrowserService2, _ResizeNextBorderHelper)
  HRESULT(STDMETHODCALLTYPE *_ResizeNextBorderHelper)(IBrowserService3 *This,
                                                      UINT itb,
                                                      BOOL bUseHmonitor);

  DECLSPEC_XFGVIRT(IBrowserService2, _FindTBar)
  UINT(STDMETHODCALLTYPE *_FindTBar)(IBrowserService3 *This,
                                     /* [annotation][in] */
                                     _In_ IUnknown *punkSrc);

  DECLSPEC_XFGVIRT(IBrowserService2, _SetFocus)
  HRESULT(STDMETHODCALLTYPE *_SetFocus)(IBrowserService3 *This,
                                        /* [annotation][in] */
                                        _In_ LPTOOLBARITEM ptbi,
                                        /* [annotation][in] */
                                        _In_ HWND hwnd,
  ...
  DECLSPEC_XFGVIRT(IBrowserService2, v_MayTranslateAccelerator)
  HRESULT(STDMETHODCALLTYPE *v_MayTranslateAccelerator)(IBrowserService3 *This,
                                                        /* [in] */ MSG *pmsg);

  DECLSPEC_XFGVIRT(IBrowserService2, _GetBorderDWHelper)
  HRESULT(STDMETHODCALLTYPE *_GetBorderDWHelper)(IBrowserService3 *This,
                                                 /* [annotation][in] */
                                                 _In_ IUnknown *punkSrc,
                                                 /* [annotation][out] */
                                                 _Out_ LPRECT lprectBorder,
  ...
  DECLSPEC_XFGVIRT(IBrowserService2, v_CheckZoneCrossing)
  HRESULT(STDMETHODCALLTYPE *v_CheckZoneCrossing)(IBrowserService3 *This,
                                                  /* [annotation][in] */
                                                  _In_ PCIDLIST_ABSOLUTE pidl);

  DECLSPEC_XFGVIRT(IBrowserService3, _PositionViewWindow)
  HRESULT(STDMETHODCALLTYPE *_PositionViewWindow)(IBrowserService3 *This,
                                                  /* [annotation][in] */
                                                  _In_ HWND hwnd,
                                                  /* [annotation][in] */
                                                  _In_ LPRECT prc);
...
interface IBrowserService3 { CONST_VTBL struct IBrowserService3Vtbl *lpVtbl; };
...
#define IBrowserService3_IEParseDisplayNameEx(This, uiCP, pwszPath, dwFlags,   \
                                              ppidlOut)                        \
  ((This)->lpVtbl->IEParseDisplayNameEx(This, uiCP, pwszPath, dwFlags,         \
                                        ppidlOut))
...
typedef struct IBrowserService4Vtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(IBrowserService4 *This,
                                             /* [in] */ REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);
  ...
  DECLSPEC_XFGVIRT(IBrowserService, SetTitle)
  /* [local] */ HRESULT(STDMETHODCALLTYPE *SetTitle)(IBrowserService4 *This,
                                                     /* [annotation][in] */
                                                     _In_ IShellView *psv,
                                                     /* [annotation][in] */
                                                     _In_ LPCWSTR pszName);
  ...
  DECLSPEC_XFGVIRT(IBrowserService, GetTravelLog)
  HRESULT(STDMETHODCALLTYPE *GetTravelLog)(IBrowserService4 *This,
                                           /* [out] */ ITravelLog **pptl);

  DECLSPEC_XFGVIRT(IBrowserService, ShowControlWindow)
  /* [local] */ HRESULT(STDMETHODCALLTYPE *ShowControlWindow)(
      IBrowserService4 *This, UINT id, BOOL fShow);

  DECLSPEC_XFGVIRT(IBrowserService, IsControlWindowShown)
  /* [local] */ HRESULT(STDMETHODCALLTYPE *IsControlWindowShown)(
      IBrowserService4 *This, UINT id,
      /* [annotation][out] */
      _Out_ BOOL *pfShown);
  ...
  DECLSPEC_XFGVIRT(IBrowserService, IEParseDisplayName)
  /* [local] */ HRESULT(STDMETHODCALLTYPE *IEParseDisplayName)(
      IBrowserService4 *This, UINT uiCP,
      /* [annotation][in] */
      _In_ LPCWSTR pwszPath,
      /* [annotation][out] */
      _Outptr_ PIDLIST_ABSOLUTE *ppidlOut);
  ...
  DECLSPEC_XFGVIRT(IBrowserService, DisplayParseError)
  /* [local] */ HRESULT(STDMETHODCALLTYPE *DisplayParseError)(
      IBrowserService4 *This, HRESULT hres,
      /* [annotation][in] */
      _In_ LPCWSTR pwszPath);
  ...
  DECLSPEC_XFGVIRT(IBrowserService, SetNavigateState)
  /* [local] */ HRESULT(STDMETHODCALLTYPE *SetNavigateState)(
      IBrowserService4 *This, BNSTATE bnstate);
  ...
  DECLSPEC_XFGVIRT(IBrowserService, SetFlags)
  /* [local] */ HRESULT(STDMETHODCALLTYPE *SetFlags)(IBrowserService4 *This,
                                                     DWORD dwFlags,
                                                     DWORD dwFlagMask);

  DECLSPEC_XFGVIRT(IBrowserService, GetFlags)
  /* [local] */ HRESULT(STDMETHODCALLTYPE *GetFlags)(IBrowserService4 *This,
                                                     /* [annotation][out] */
                                                     _Out_ DWORD *pdwFlags);
  ...
  DECLSPEC_XFGVIRT(IBrowserService, SetReferrer)
  /* [local] */ HRESULT(STDMETHODCALLTYPE *SetReferrer)(IBrowserService4 *This,
                                                        /* [annotation][in] */
                                                        _In_ PCIDLIST_ABSOLUTE
                                                            pidl);
  ...
  DECLSPEC_XFGVIRT(IBrowserService, GetBrowserByIndex)
  /* [local] */ HRESULT(STDMETHODCALLTYPE *GetBrowserByIndex)(
      IBrowserService4 *This, DWORD dwID,
      /* [annotation][out] */
      _Outptr_ IUnknown **ppunk);
  ...
  DECLSPEC_XFGVIRT(IBrowserService, GetPalette)
  /* [local] */ HRESULT(STDMETHODCALLTYPE *GetPalette)(IBrowserService4 *This,
                                                       /* [annotation][out] */
                                                       _Out_ HPALETTE *hpal);

  DECLSPEC_XFGVIRT(IBrowserService, RegisterWindow)
  /* [local] */ HRESULT(STDMETHODCALLTYPE *RegisterWindow)(
      IBrowserService4 *This, BOOL fForceRegister, int swc);

  DECLSPEC_XFGVIRT(IBrowserService2, WndProcBS)
  LRESULT(STDMETHODCALLTYPE *WndProcBS)(IBrowserService4 *This,
                                        /* [annotation][in] */
                                        _In_ HWND hwnd,
                                        /* [annotation][in] */
                                        _In_ UINT uMsg,
  ...
  DECLSPEC_XFGVIRT(IBrowserService2, GetViewRect)
  HRESULT(STDMETHODCALLTYPE *GetViewRect)(IBrowserService4 *This,
                                          /* [annotation][out] */
                                          _Out_ RECT *prc);

  DECLSPEC_XFGVIRT(IBrowserService2, OnSize)
  HRESULT(STDMETHODCALLTYPE *OnSize)(IBrowserService4 *This,
                                     /* [annotation][in] */
                                     _In_ WPARAM wParam);

  DECLSPEC_XFGVIRT(IBrowserService2, OnCreate)
  HRESULT(STDMETHODCALLTYPE *OnCreate)(IBrowserService4 *This,
                                       /* [annotation][in] */
                                       _In_ struct tagCREATESTRUCTW *pcs);

  DECLSPEC_XFGVIRT(IBrowserService2, OnCommand)
  LRESULT(STDMETHODCALLTYPE *OnCommand)(IBrowserService4 *This,
                                        /* [annotation][in] */
                                        _In_ WPARAM wParam,
                                        /* [annotation][in] */
                                        _In_ LPARAM lParam);
  ...
  DECLSPEC_XFGVIRT(IBrowserService2, OnNotify)
  LRESULT(STDMETHODCALLTYPE *OnNotify)(IBrowserService4 *This,
                                       /* [annotation][in] */
                                       _In_ struct tagNMHDR *pnm);
  ...
  DECLSPEC_XFGVIRT(IBrowserService2, OnFrameWindowActivateBS)
  HRESULT(STDMETHODCALLTYPE *OnFrameWindowActivateBS)(IBrowserService4 *This,
                                                      /* [annotation][in] */
                                                      _In_ BOOL fActive);
  ...
  DECLSPEC_XFGVIRT(IBrowserService2, CreateViewWindow)
  HRESULT(STDMETHODCALLTYPE *CreateViewWindow)(IBrowserService4 *This,
                                               /* [annotation][in] */
                                               _In_ IShellView *psvNew,
                                               /* [annotation][in] */
                                               _In_ IShellView *psvOld,
  ...
  DECLSPEC_XFGVIRT(IBrowserService2, GetViewWindow)
  HRESULT(STDMETHODCALLTYPE *GetViewWindow)(IBrowserService4 *This,
                                            /* [annotation][out] */
                                            _Out_ HWND *phwndView);
  ...
  DECLSPEC_XFGVIRT(IBrowserService2, InitializeTravelLog)
  HRESULT(STDMETHODCALLTYPE *InitializeTravelLog)(IBrowserService4 *This,
                                                  /* [annotation][in] */
                                                  _In_ ITravelLog *ptl,
                                                  /* [annotation][in] */
                                                  _In_ DWORD dw);
  ...
  DECLSPEC_XFGVIRT(IBrowserService2, Offline)
  HRESULT(STDMETHODCALLTYPE *Offline)(IBrowserService4 *This,
                                      /* [annotation][in] */
                                      _In_ int iCmd);

  DECLSPEC_XFGVIRT(IBrowserService2, AllowViewResize)
  HRESULT(STDMETHODCALLTYPE *AllowViewResize)(IBrowserService4 *This,
                                              /* [annotation][in] */
                                              _In_ BOOL f);

  DECLSPEC_XFGVIRT(IBrowserService2, SetActivateState)
  HRESULT(STDMETHODCALLTYPE *SetActivateState)(IBrowserService4 *This,
                                               /* [annotation][in] */
                                               _In_ UINT u);

  DECLSPEC_XFGVIRT(IBrowserService2, UpdateSecureLockIcon)
  HRESULT(STDMETHODCALLTYPE *UpdateSecureLockIcon)(IBrowserService4 *This,
                                                   /* [annotation][in] */
                                                   _In_ int eSecureLock);
  ...
  DECLSPEC_XFGVIRT(IBrowserService2, _Initialize)
  HRESULT(STDMETHODCALLTYPE *_Initialize)(IBrowserService4 *This,
                                          /* [annotation][in] */
                                          _In_ HWND hwnd,
                                          /* [annotation][in] */
                                          _In_ IUnknown *pauto);
  ...
  DECLSPEC_XFGVIRT(IBrowserService2, _PauseOrResumeView)
  HRESULT(STDMETHODCALLTYPE *_PauseOrResumeView)(IBrowserService4 *This,
                                                 BOOL fPaused);
  ...
  DECLSPEC_XFGVIRT(IBrowserService2, _NavigateToPidl)
  HRESULT(STDMETHODCALLTYPE *_NavigateToPidl)(IBrowserService4 *This,
                                              /* [annotation][in] */
                                              _In_ PCIDLIST_ABSOLUTE pidl,
                                              /* [annotation][in] */
                                              _In_ DWORD grfHLNF,
  ...
  DECLSPEC_XFGVIRT(IBrowserService2, _TryShell2Rename)
  HRESULT(STDMETHODCALLTYPE *_TryShell2Rename)(IBrowserService4 *This,
                                               /* [annotation][in] */
                                               _In_ IShellView *psv,
                                               /* [annotation][in] */
                                               _In_ PCIDLIST_ABSOLUTE pidlNew);
  ...
  DECLSPEC_XFGVIRT(IBrowserService2, _ExecChildren)
  HRESULT(STDMETHODCALLTYPE *_ExecChildren)(IBrowserService4 *This,
                                            /* [annotation][in] */
                                            _In_ IUnknown *punkBar,
                                            /* [annotation][in] */
                                            _In_ BOOL fBroadcast,
  ...
  DECLSPEC_XFGVIRT(IBrowserService2, _SendChildren)
  HRESULT(STDMETHODCALLTYPE *_SendChildren)(IBrowserService4 *This,
                                            /* [annotation][in] */
                                            _In_ HWND hwndBar,
                                            /* [annotation][in] */
                                            _In_ BOOL fBroadcast,
  ...
  DECLSPEC_XFGVIRT(IBrowserService2, _OnFocusChange)
  HRESULT(STDMETHODCALLTYPE *_OnFocusChange)(IBrowserService4 *This,
                                             /* [annotation][in] */
                                             _In_ UINT itb);

  DECLSPEC_XFGVIRT(IBrowserService2, v_ShowHideChildWindows)
  HRESULT(STDMETHODCALLTYPE *v_ShowHideChildWindows)(IBrowserService4 *This,
                                                     /* [annotation][in] */
                                                     _In_ BOOL fChildOnly);
  ...
  DECLSPEC_XFGVIRT(IBrowserService2, _put_itbLastFocus)
  HRESULT(STDMETHODCALLTYPE *_put_itbLastFocus)(IBrowserService4 *This,
                                                /* [annotation][in] */
                                                _In_ UINT itbLastFocus);

  DECLSPEC_XFGVIRT(IBrowserService2, _UIActivateView)
  HRESULT(STDMETHODCALLTYPE *_UIActivateView)(IBrowserService4 *This,
                                              /* [annotation][in] */
                                              _In_ UINT uState);

  DECLSPEC_XFGVIRT(IBrowserService2, _GetViewBorderRect)
  HRESULT(STDMETHODCALLTYPE *_GetViewBorderRect)(IBrowserService4 *This,
                                                 /* [out] */ RECT *prc);
  ...
  DECLSPEC_XFGVIRT(IBrowserService2, _ResizeNextBorder)
  HRESULT(STDMETHODCALLTYPE *_ResizeNextBorder)(IBrowserService4 *This,
                                                /* [annotation][in] */
                                                _In_ UINT itb);
  ...
  DECLSPEC_XFGVIRT(IBrowserService2, _GetEffectiveClientArea)
  HRESULT(STDMETHODCALLTYPE *_GetEffectiveClientArea)(IBrowserService4 *This,
                                                      /* [annotation][out] */
                                                      _Out_ LPRECT lprectBorder,
                                                      /* [annotation][in] */
                                                      _In_ HMONITOR hmon);
  ...
  DECLSPEC_XFGVIRT(IBrowserService2, ForwardViewMsg)
  LRESULT(STDMETHODCALLTYPE *ForwardViewMsg)(IBrowserService4 *This,
                                             /* [annotation][in] */
                                             _In_ UINT uMsg,
                                             /* [annotation][in] */
                                             _In_ WPARAM wParam,
  ...
  DECLSPEC_XFGVIRT(IBrowserService2, SetAcceleratorMenu)
  HRESULT(STDMETHODCALLTYPE *SetAcceleratorMenu)(IBrowserService4 *This,
                                                 /* [annotation][in] */
                                                 _In_ HACCEL hacc);
  ...
  DECLSPEC_XFGVIRT(IBrowserService2, _GetToolbarItem)
  LPTOOLBARITEM(STDMETHODCALLTYPE *_GetToolbarItem)(IBrowserService4 *This,
                                                    /* [annotation][in] */
                                                    _In_ int itb);

  DECLSPEC_XFGVIRT(IBrowserService2, _SaveToolbars)
  HRESULT(STDMETHODCALLTYPE *_SaveToolbars)(IBrowserService4 *This,
                                            /* [in] */ IStream *pstm);

  DECLSPEC_XFGVIRT(IBrowserService2, _LoadToolbars)
  HRESULT(STDMETHODCALLTYPE *_LoadToolbars)(IBrowserService4 *This,
                                            /* [annotation][in] */
                                            _In_ IStream *pstm);

  DECLSPEC_XFGVIRT(IBrowserService2, _CloseAndReleaseToolbars)
  HRESULT(STDMETHODCALLTYPE *_CloseAndReleaseToolbars)(IBrowserService4 *This,
                                                       BOOL fClose);
  ...
  DECLSPEC_XFGVIRT(IBrowserService2, _ResizeNextBorderHelper)
  HRESULT(STDMETHODCALLTYPE *_ResizeNextBorderHelper)(IBrowserService4 *This,
                                                      UINT itb,
                                                      BOOL bUseHmonitor);

  DECLSPEC_XFGVIRT(IBrowserService2, _FindTBar)
  UINT(STDMETHODCALLTYPE *_FindTBar)(IBrowserService4 *This,
                                     /* [annotation][in] */
                                     _In_ IUnknown *punkSrc);

  DECLSPEC_XFGVIRT(IBrowserService2, _SetFocus)
  HRESULT(STDMETHODCALLTYPE *_SetFocus)(IBrowserService4 *This,
                                        /* [annotation][in] */
                                        _In_ LPTOOLBARITEM ptbi,
                                        /* [annotation][in] */
                                        _In_ HWND hwnd,
  ...
  DECLSPEC_XFGVIRT(IBrowserService2, v_MayTranslateAccelerator)
  HRESULT(STDMETHODCALLTYPE *v_MayTranslateAccelerator)(IBrowserService4 *This,
                                                        /* [in] */ MSG *pmsg);

  DECLSPEC_XFGVIRT(IBrowserService2, _GetBorderDWHelper)
  HRESULT(STDMETHODCALLTYPE *_GetBorderDWHelper)(IBrowserService4 *This,
                                                 /* [annotation][in] */
                                                 _In_ IUnknown *punkSrc,
                                                 /* [annotation][out] */
                                                 _Out_ LPRECT lprectBorder,
  ...
  DECLSPEC_XFGVIRT(IBrowserService2, v_CheckZoneCrossing)
  HRESULT(STDMETHODCALLTYPE *v_CheckZoneCrossing)(IBrowserService4 *This,
                                                  /* [annotation][in] */
                                                  _In_ PCIDLIST_ABSOLUTE pidl);

  DECLSPEC_XFGVIRT(IBrowserService3, _PositionViewWindow)
  HRESULT(STDMETHODCALLTYPE *_PositionViewWindow)(IBrowserService4 *This,
                                                  /* [annotation][in] */
                                                  _In_ HWND hwnd,
                                                  /* [annotation][in] */
                                                  _In_ LPRECT prc);
  ...
  HRESULT(STDMETHODCALLTYPE *ActivateView)(IBrowserService4 *This,
...
interface IBrowserService4 { CONST_VTBL struct IBrowserService4Vtbl *lpVtbl; };
...
#define IBrowserService4_CreateViewWindow(This, psvNew, psvOld, prcView,       \
                                          phwnd)                               \
  ((This)->lpVtbl->CreateViewWindow(This, psvNew, psvOld, prcView, phwnd))
...
#define IBrowserService4__ExecChildren(This, punkBar, fBroadcast,              \
                                       pguidCmdGroup, nCmdID, nCmdexecopt,     \
                                       pvarargIn, pvarargOut)                  \
  ((This)->lpVtbl->_ExecChildren(This, punkBar, fBroadcast, pguidCmdGroup,     \
                                 nCmdID, nCmdexecopt, pvarargIn, pvarargOut))

#define IBrowserService4__SendChildren(This, hwndBar, fBroadcast, uMsg,        \
                                       wParam, lParam)                         \
  ((This)->lpVtbl->_SendChildren(This, hwndBar, fBroadcast, uMsg, wParam,      \
                                 lParam))
...
#define IBrowserService4_v_MayGetNextToolbarFocus(This, lpMsg, itbNext, citb,  \
                                                  pptbi, phwnd)                \
  ((This)->lpVtbl->v_MayGetNextToolbarFocus(This, lpMsg, itbNext, citb, pptbi, \
                                            phwnd))
...
#define IBrowserService4__GetBorderDWHelper(This, punkSrc, lprectBorder,       \
                                            bUseHmonitor)                      \
  ((This)->lpVtbl->_GetBorderDWHelper(This, punkSrc, lprectBorder,             \
                                      bUseHmonitor))
...
#define IBrowserService4_IEParseDisplayNameEx(This, uiCP, pwszPath, dwFlags,   \
                                              ppidlOut)                        \
  ((This)->lpVtbl->IEParseDisplayNameEx(This, uiCP, pwszPath, dwFlags,         \
                                        ppidlOut))
...
public:
  virtual HRESULT STDMETHODCALLTYPE SetObscured(
      /* [in] */ HWND hwndTB,
      /* [in] */ IUnknown * punkBand, DWORD dwSMSetFlags) = 0;

  virtual HRESULT STDMETHODCALLTYPE Popup(
      /* [in] */ HWND hwnd,
      /* [in] */ POINTL * ppt,
      /* [in] */ RECTL * prcExclude, MP_POPUPFLAGS dwFlags) = 0;
};
...
typedef struct ITrackShellMenuVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(ITrackShellMenu *This,
                                             /* [in] */ REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);
  ...
  HRESULT(STDMETHODCALLTYPE *Initialize)(ITrackShellMenu *This,
                                         /* [annotation][unique][in] */
  ...
  HRESULT(STDMETHODCALLTYPE *SetShellFolder)(ITrackShellMenu *This,
                                             /* [annotation][unique][in] */
  ...
  HRESULT(STDMETHODCALLTYPE *GetShellFolder)(ITrackShellMenu *This,
                                             /* [annotation][out] */
                                             _Out_ DWORD *pdwFlags,
                                             /* [annotation][out] */
  ...
  HRESULT(STDMETHODCALLTYPE *SetMenu)(ITrackShellMenu *This,
                                      /* [annotation][unique][in] */
  ...
  HRESULT(STDMETHODCALLTYPE *GetMenu)(ITrackShellMenu *This,
                                      /* [annotation][out] */
  ...
  HRESULT(STDMETHODCALLTYPE *InvalidateItem)(ITrackShellMenu *This,
                                             /* [annotation][in] */
  ...
  HRESULT(STDMETHODCALLTYPE *GetState)(ITrackShellMenu *This,
                                       /* [annotation][out] */
                                       _Out_ LPSMDATA psmd);

  DECLSPEC_XFGVIRT(IShellMenu, SetMenuToolbar)
  HRESULT(STDMETHODCALLTYPE *SetMenuToolbar)(ITrackShellMenu *This,
                                             /* [annotation][in] */
                                             _In_ IUnknown *punk,
                                             /* [annotation][in] */
                                             _In_ DWORD dwFlags);
  ...
  HRESULT(STDMETHODCALLTYPE *SetObscured)(ITrackShellMenu *This,
                                          /* [in] */ HWND hwndTB,
                                          /* [in] */ IUnknown *punkBand,
                                          DWORD dwSMSetFlags);

  DECLSPEC_XFGVIRT(ITrackShellMenu, Popup)
  HRESULT(STDMETHODCALLTYPE *Popup)(ITrackShellMenu *This,
                                    /* [in] */ HWND hwnd,
                                    /* [in] */ POINTL *ppt,
                                    /* [in] */ RECTL *prcExclude,
...
interface ITrackShellMenu { CONST_VTBL struct ITrackShellMenuVtbl *lpVtbl; };
...
class DECLSPEC_UUID("8278F931-2A3E-11d2-838F-00C04FD918D0") TrackShellMenu;
#endif
...
unsigned long __RPC_USER HMENU_UserSize(__RPC__in unsigned long *,
                                        unsigned long, __RPC__in HMENU *);
unsigned char *__RPC_USER
HMENU_UserMarshal(__RPC__in unsigned long *,
                  __RPC__inout_xcount(0) unsigned char *, __RPC__in HMENU *);
unsigned char *__RPC_USER
HMENU_UserUnmarshal(__RPC__in unsigned long *,
                    __RPC__in_xcount(0) unsigned char *, __RPC__out HMENU *);
...
unsigned long __RPC_USER PIDLIST_ABSOLUTE_UserSize(
    __RPC__in unsigned long *, unsigned long, __RPC__in PIDLIST_ABSOLUTE *);
unsigned char *__RPC_USER PIDLIST_ABSOLUTE_UserMarshal(
    __RPC__in unsigned long *, __RPC__inout_xcount(0) unsigned char *,
    __RPC__in PIDLIST_ABSOLUTE *);
unsigned char *__RPC_USER PIDLIST_ABSOLUTE_UserUnmarshal(
    __RPC__in unsigned long *, __RPC__in_xcount(0) unsigned char *,
    __RPC__out PIDLIST_ABSOLUTE *);
void __RPC_USER PIDLIST_ABSOLUTE_UserFree(__RPC__in unsigned long *,
                                          __RPC__in PIDLIST_ABSOLUTE *);

unsigned long __RPC_USER HMENU_UserSize64(__RPC__in unsigned long *,
                                          unsigned long, __RPC__in HMENU *);
unsigned char *__RPC_USER
HMENU_UserMarshal64(__RPC__in unsigned long *,
                    __RPC__inout_xcount(0) unsigned char *, __RPC__in HMENU *);
unsigned char *__RPC_USER
HMENU_UserUnmarshal64(__RPC__in unsigned long *,
                      __RPC__in_xcount(0) unsigned char *, __RPC__out HMENU *);
...
unsigned long __RPC_USER PIDLIST_ABSOLUTE_UserSize64(
    __RPC__in unsigned long *, unsigned long, __RPC__in PIDLIST_ABSOLUTE *);
unsigned char *__RPC_USER PIDLIST_ABSOLUTE_UserMarshal64(
    __RPC__in unsigned long *, __RPC__inout_xcount(0) unsigned char *,
    __RPC__in PIDLIST_ABSOLUTE *);
unsigned char *__RPC_USER PIDLIST_ABSOLUTE_UserUnmarshal64(
    __RPC__in unsigned long *, __RPC__in_xcount(0) unsigned char *,
    __RPC__out PIDLIST_ABSOLUTE *);
void __RPC_USER PIDLIST_ABSOLUTE_UserFree64(__RPC__in unsigned long *,
                                            __RPC__in PIDLIST_ABSOLUTE *);

/* [local][helpcontext][helpstring] */ HRESULT STDMETHODCALLTYPE
ITravelLog_GetTravelEntry_Proxy(ITravelLog *This,
                                /* [annotation][in] */
                                _In_ IUnknown *punk,
                                /* [annotation][in] */
                                _In_ int iOffset,
