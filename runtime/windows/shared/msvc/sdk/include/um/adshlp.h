...
HRESULT WINAPI ADsBuildVarArrayStr(_In_reads_(dwPathNames) LPWSTR *lppPathNames,
                                   DWORD dwPathNames, VARIANT *pVar);
...
HRESULT WINAPI ADsGetLastError(OUT LPDWORD lpError,
                               _Out_writes_(dwErrorBufLen) LPWSTR lpErrorBuf,
                               IN DWORD dwErrorBufLen,
                               _Out_writes_(dwNameBufLen) LPWSTR lpNameBuf,
                               IN DWORD dwNameBufLen);

VOID WINAPI ADsSetLastError(IN DWORD dwErr, IN LPCWSTR pszError,
...
BOOL WINAPI FreeADsStr(_In_ LPWSTR pStr);

BOOL WINAPI ReallocADsStr(_Inout_ LPWSTR *ppStr, _In_ LPWSTR pStr);
