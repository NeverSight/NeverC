...
DEFINE_GUID(CLSID_MSAdminBase_W, 0xa9e69610, 0xb80d, 0x11d0, 0xb9, 0xb9, 0x00,
            0xa0, 0xc9, 0x22, 0xe7, 0x50);
DEFINE_GUID(IID_IMSAdminBase_W, 0x70b51430, 0xb6ca, 0x11d0, 0xb9, 0xb9, 0x00,
            0xa0, 0xc9, 0x22, 0xe7, 0x50);
...
DEFINE_GUID(IID_IMSAdminBaseSink_W, 0xa9e69612, 0xb80d, 0x11d0, 0xb9, 0xb9,
            0x00, 0xa0, 0xc9, 0x22, 0xe7, 0x50);
...
public:
  ...
  virtual HRESULT STDMETHODCALLTYPE GetDataPaths(
      ...
      /* [in] */ DWORD dwMDDataType,
      /* [in] */ DWORD dwMDBufferSize,
      /* [size_is][out] */ __RPC__out_ecount_full(dwMDBufferSize) WCHAR *
          pszBuffer,
  ...
  virtual /* [restricted][local] */ HRESULT STDMETHODCALLTYPE KeyExchangePhase1(
      void) = 0;

  virtual /* [restricted][local] */ HRESULT STDMETHODCALLTYPE KeyExchangePhase2(
      void) = 0;

  virtual HRESULT STDMETHODCALLTYPE Backup(
      /* [string][in][unique] */ __RPC__in_opt_string LPCWSTR
          pszMDBackupLocation,
  ...
  virtual HRESULT STDMETHODCALLTYPE EnumBackups(
      /* [size_is][out][in] */ __RPC__inout_ecount_full(256)
  ...
  virtual /* [restricted][local] */ HRESULT STDMETHODCALLTYPE GetServerGuid(
      void) = 0;
};
...
typedef struct IMSAdminBaseWVtbl {
  ...
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in IMSAdminBaseW *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IMSAdminBaseW *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IMSAdminBaseW *This);
  ...
  HRESULT(STDMETHODCALLTYPE *SaveData)(__RPC__in IMSAdminBaseW *This);
  ...
  HRESULT(STDMETHODCALLTYPE *Backup)(__RPC__in IMSAdminBaseW *This,
                                     /* [string][in][unique] */
                                     __RPC__in_opt_string LPCWSTR
                                         pszMDBackupLocation,
                                     /* [in] */ DWORD dwMDVersion,
                                     /* [in] */ DWORD dwMDFlags);
  ...
  HRESULT(STDMETHODCALLTYPE *DeleteBackup)(__RPC__in IMSAdminBaseW *This,
                                           /* [string][in][unique] */
                                           __RPC__in_opt_string LPCWSTR
                                               pszMDBackupLocation,
                                           /* [in] */ DWORD dwMDVersion);
...
interface IMSAdminBaseW { CONST_VTBL struct IMSAdminBaseWVtbl *lpVtbl; };
...
IMSAdminBaseW_R_KeyExchangePhase1_Proxy(
    __RPC__in IMSAdminBaseW *This,
    /* [in][unique] */
...
/* [call_as] */ HRESULT STDMETHODCALLTYPE
IMSAdminBaseW_R_GetServerGuid_Proxy(__RPC__in IMSAdminBaseW *This,
...
typedef struct IMSAdminBase2WVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in IMSAdminBase2W *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IMSAdminBase2W *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IMSAdminBase2W *This);
  ...
  DECLSPEC_XFGVIRT(IMSAdminBaseW, CloseKey)
  HRESULT(STDMETHODCALLTYPE *CloseKey)(__RPC__in IMSAdminBase2W *This,
                                       /* [in] */ METADATA_HANDLE hMDHandle);
  ...
  DECLSPEC_XFGVIRT(IMSAdminBaseW, SaveData)
  HRESULT(STDMETHODCALLTYPE *SaveData)(__RPC__in IMSAdminBase2W *This);
  ...
  DECLSPEC_XFGVIRT(IMSAdminBaseW, Backup)
  HRESULT(STDMETHODCALLTYPE *Backup)(__RPC__in IMSAdminBase2W *This,
                                     /* [string][in][unique] */
                                     __RPC__in_opt_string LPCWSTR
                                         pszMDBackupLocation,
                                     /* [in] */ DWORD dwMDVersion,
  ...
  DECLSPEC_XFGVIRT(IMSAdminBaseW, Restore)
  HRESULT(STDMETHODCALLTYPE *Restore)(__RPC__in IMSAdminBase2W *This,
                                      /* [string][in][unique] */
                                      __RPC__in_opt_string LPCWSTR
                                          pszMDBackupLocation,
                                      /* [in] */ DWORD dwMDVersion,
  ...
  DECLSPEC_XFGVIRT(IMSAdminBaseW, DeleteBackup)
  HRESULT(STDMETHODCALLTYPE *DeleteBackup)(__RPC__in IMSAdminBase2W *This,
                                           /* [string][in][unique] */
                                           __RPC__in_opt_string LPCWSTR
                                               pszMDBackupLocation,
                                           /* [in] */ DWORD dwMDVersion);
  ...
  HRESULT(STDMETHODCALLTYPE *RestoreHistory)(__RPC__in IMSAdminBase2W *This,
                                             /* [string][in][unique] */
                                             __RPC__in_opt_string LPCWSTR
                                                 pszMDHistoryLocation,
                                             /* [in] */ DWORD dwMDMajorVersion,
...
interface IMSAdminBase2W { CONST_VTBL struct IMSAdminBase2WVtbl *lpVtbl; };
...
#define IMSAdminBase2W_Export(This, pszPasswd, pszFileName, pszSourcePath,     \
                              dwMDFlags)                                       \
  ((This)->lpVtbl->Export(This, pszPasswd, pszFileName, pszSourcePath,         \
                          dwMDFlags))
...
#define IMSAdminBase2W_RestoreHistory(                                         \
  ...
  ((This)->lpVtbl->RestoreHistory(This, pszMDHistoryLocation,                  \
                                  dwMDMajorVersion, dwMDMinorVersion,          \
                                  dwMDFlags))
...
typedef struct IMSAdminBase3WVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in IMSAdminBase3W *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IMSAdminBase3W *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IMSAdminBase3W *This);
  ...
  DECLSPEC_XFGVIRT(IMSAdminBaseW, CloseKey)
  HRESULT(STDMETHODCALLTYPE *CloseKey)(__RPC__in IMSAdminBase3W *This,
                                       /* [in] */ METADATA_HANDLE hMDHandle);
  ...
  DECLSPEC_XFGVIRT(IMSAdminBaseW, SaveData)
  HRESULT(STDMETHODCALLTYPE *SaveData)(__RPC__in IMSAdminBase3W *This);
  ...
  DECLSPEC_XFGVIRT(IMSAdminBaseW, Backup)
  HRESULT(STDMETHODCALLTYPE *Backup)(__RPC__in IMSAdminBase3W *This,
                                     /* [string][in][unique] */
                                     __RPC__in_opt_string LPCWSTR
                                         pszMDBackupLocation,
                                     /* [in] */ DWORD dwMDVersion,
  ...
  DECLSPEC_XFGVIRT(IMSAdminBaseW, Restore)
  HRESULT(STDMETHODCALLTYPE *Restore)(__RPC__in IMSAdminBase3W *This,
                                      /* [string][in][unique] */
                                      __RPC__in_opt_string LPCWSTR
                                          pszMDBackupLocation,
                                      /* [in] */ DWORD dwMDVersion,
  ...
  DECLSPEC_XFGVIRT(IMSAdminBaseW, DeleteBackup)
  HRESULT(STDMETHODCALLTYPE *DeleteBackup)(__RPC__in IMSAdminBase3W *This,
                                           /* [string][in][unique] */
                                           __RPC__in_opt_string LPCWSTR
                                               pszMDBackupLocation,
                                           /* [in] */ DWORD dwMDVersion);
  ...
  DECLSPEC_XFGVIRT(IMSAdminBase2W, RestoreHistory)
  HRESULT(STDMETHODCALLTYPE *RestoreHistory)(__RPC__in IMSAdminBase3W *This,
                                             /* [string][in][unique] */
                                             __RPC__in_opt_string LPCWSTR
                                                 pszMDHistoryLocation,
                                             /* [in] */ DWORD dwMDMajorVersion,
...
interface IMSAdminBase3W { CONST_VTBL struct IMSAdminBase3WVtbl *lpVtbl; };
...
typedef struct IMSImpExpHelpWVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in IMSImpExpHelpW *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IMSImpExpHelpW *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IMSImpExpHelpW *This);
...
interface IMSImpExpHelpW { CONST_VTBL struct IMSImpExpHelpWVtbl *lpVtbl; };
...
public:
  virtual HRESULT STDMETHODCALLTYPE SinkNotify(
      ...
      /* [size_is][in] */ __RPC__in_ecount_full(dwMDNumElements)
...
typedef struct IMSAdminBaseSinkWVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in IMSAdminBaseSinkW *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IMSAdminBaseSinkW *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IMSAdminBaseSinkW *This);
  ...
  HRESULT(STDMETHODCALLTYPE *SinkNotify)(
      ...
      /* [in] */ DWORD dwMDNumElements,
      /* [size_is][in] */
      __RPC__in_ecount_full(dwMDNumElements)
          MD_CHANGE_OBJECT_W pcoChangeList[]);

  DECLSPEC_XFGVIRT(IMSAdminBaseSinkW, ShutdownNotify)
  HRESULT(STDMETHODCALLTYPE *ShutdownNotify)(__RPC__in IMSAdminBaseSinkW *This);
...
public:
  virtual HRESULT STDMETHODCALLTYPE Begin_SinkNotify(
      /* [in] */ DWORD dwMDNumElements,
      /* [size_is][in] */ __RPC__in_xcount_full(dwMDNumElements)
          MD_CHANGE_OBJECT_W pcoChangeList[]) = 0;
...
typedef struct AsyncIMSAdminBaseSinkWVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in AsyncIMSAdminBaseSinkW *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in AsyncIMSAdminBaseSinkW *This);
  ...
  HRESULT(STDMETHODCALLTYPE *Begin_SinkNotify)(
      ...
      /* [in] */ DWORD dwMDNumElements,
      /* [size_is][in] */
      __RPC__in_xcount_full(dwMDNumElements)
          MD_CHANGE_OBJECT_W pcoChangeList[]);
...
IMSAdminBaseW_SetData_Proxy(IMSAdminBaseW *This,
                            /* [in] */ METADATA_HANDLE hMDHandle,
                            /* [string][in][unique] */ LPCWSTR pszMDPath,
                            /* [in] */ PMETADATA_RECORD pmdrMDData);
...
/* [local] */ HRESULT STDMETHODCALLTYPE
IMSAdminBaseW_GetData_Proxy(IMSAdminBaseW *This,
                            /* [in] */ METADATA_HANDLE hMDHandle,
                            /* [string][in][unique] */ LPCWSTR pszMDPath,
                            /* [out][in] */ PMETADATA_RECORD pmdrMDData,
                            /* [out] */ DWORD *pdwMDRequiredDataLen);
...
/* [local] */ HRESULT STDMETHODCALLTYPE
IMSAdminBaseW_EnumData_Proxy(IMSAdminBaseW *This,
                             /* [in] */ METADATA_HANDLE hMDHandle,
                             /* [string][in][unique] */ LPCWSTR pszMDPath,
                             /* [out][in] */ PMETADATA_RECORD pmdrMDData,
                             /* [in] */ DWORD dwMDEnumDataIndex,
...
/* [local] */ HRESULT STDMETHODCALLTYPE
IMSAdminBaseW_GetAllData_Proxy(IMSAdminBaseW *This,
                               /* [in] */ METADATA_HANDLE hMDHandle,
                               /* [string][in][unique] */ LPCWSTR pszMDPath,
                               /* [in] */ DWORD dwMDAttributes,
                               /* [in] */ DWORD dwMDUserType,
...
IMSAdminBaseW_KeyExchangePhase1_Proxy(IMSAdminBaseW *This);
...
/* [restricted][local] */ HRESULT STDMETHODCALLTYPE
IMSAdminBaseW_KeyExchangePhase2_Proxy(IMSAdminBaseW *This);
...
/* [restricted][local] */ HRESULT STDMETHODCALLTYPE
IMSAdminBaseW_GetServerGuid_Proxy(IMSAdminBaseW *This);

/* [call_as] */ HRESULT STDMETHODCALLTYPE
IMSAdminBaseW_GetServerGuid_Stub(__RPC__in IMSAdminBaseW *This,
                                 /* [out] */ __RPC__out GUID *pServerGuid);
