...
/// <summary>
/// This defines the list of system properties present on the root effect
/// property interface.
/// </summary>
...
typedef enum D2D1_BITMAP_OPTIONS {
  ...
  /// <summary>
  /// The bitmap cannot be used as an input to DrawBitmap, DrawImage, in a
  /// bitmap brush or as an input to an effect.
  /// </summary>
...
/// <summary>
/// This specifies the precision that should be used in buffers allocated by
/// D2D.
/// </summary>
...
typedef enum D2D1_COLOR_SPACE {
  ...
  /// <summary>
  /// The color space is described by accompanying data, such as a color
  /// profile.
  /// </summary>
...
/// <summary>
/// Defines how the world transform, dots per inch (dpi), and stroke width
/// affect the shape of the pen used to stroke a primitive.
/// </summary>
typedef enum D2D1_STROKE_TRANSFORM_TYPE {
  ...
  /// <summary>
  /// The stroke does not respect the world transform, but it does respect the
  /// DPI and the stroke width.
  /// </summary>
...
/// <summary>
/// This specifies the threading mode used while simultaneously creating the
/// device, factory, and device context.
/// </summary>
typedef enum D2D1_THREADING_MODE {

  /// <summary>
  /// Resources may only be invoked serially.  Reference counts on resources are
  /// interlocked, however, resource and render target state is not protected
...
typedef struct D2D1_RENDERING_CONTROLS {
  ...
  /// <summary>
  /// The default buffer precision, used if the precision isn't otherwise
  /// specified.
  /// </summary>
...
typedef struct D2D1_EFFECT_INPUT_DESCRIPTION {
  ...
  /// <summary>
  /// The rectangle which would be available on the specified input connection
...
typedef enum D2D1_PRINT_FONT_SUBSET_MODE {
  ...
  /// <summary>
  /// Subset for used glyphs, send and discard font resource after every five
  /// pages
  /// </summary>
...
typedef struct D2D1_PRINT_CONTROL_PROPERTIES {
  ...
  /// <summary>
  /// DPI for rasterization of all unsupported D2D commands or options, defaults
  /// to 150.0
  /// </summary>
  FLOAT rasterDPI;
...
/// <summary>
/// This specifies the options while simultaneously creating the device,
...
/// </summary>
interface DX_DECLARE_INTERFACE("82237326-8111-4f7c-bcf4-b5c1175564fe")
...
/// </summary>
interface DX_DECLARE_INTERFACE("2f543dc3-cfc1-4211-864f-cfd91c6f3395")
...
/// <summary>
/// Caller-supplied implementation of an interface to receive the recorded
/// command list.
/// </summary>
interface DX_DECLARE_INTERFACE("54d7898a-a061-40a7-bec7-e465bcba2c4f")
  ...
  STDMETHOD(SetTextRenderingParams)(_In_opt_ IDWriteRenderingParams *
  ...
  STDMETHOD(DrawGeometry)(_In_ ID2D1Geometry * geometry,
                          _In_ ID2D1Brush * brush, FLOAT strokeWidth,
                          _In_opt_ ID2D1StrokeStyle * strokeStyle) PURE;

  STDMETHOD(DrawRectangle)(_In_ CONST D2D1_RECT_F * rect,
                           _In_ ID2D1Brush * brush, FLOAT strokeWidth,
                           _In_opt_ ID2D1StrokeStyle * strokeStyle) PURE;
  ...
  STDMETHOD(DrawBitmap)(
      ...
      _In_opt_ CONST D2D1_MATRIX_4X4_F * perspectiveTransform) PURE;

  STDMETHOD(DrawImage)(_In_ ID2D1Image * image,
  ...
  STDMETHOD(DrawGdiMetafile)(_In_ ID2D1GdiMetafile * gdiMetafile,
                             _In_opt_ CONST D2D1_POINT_2F * targetOffset) PURE;

  STDMETHOD(FillMesh)(_In_ ID2D1Mesh * mesh, _In_ ID2D1Brush * brush) PURE;

  STDMETHOD(FillOpacityMask)(_In_ ID2D1Bitmap * opacityMask,
                             _In_ ID2D1Brush * brush,
                             _In_opt_ CONST D2D1_RECT_F * destinationRectangle,
                             _In_opt_ CONST D2D1_RECT_F * sourceRectangle) PURE;

  STDMETHOD(FillGeometry)(_In_ ID2D1Geometry * geometry,
                          _In_ ID2D1Brush * brush,
                          _In_opt_ ID2D1Brush * opacityBrush) PURE;

  STDMETHOD(FillRectangle)(_In_ CONST D2D1_RECT_F * rect,
                           _In_ ID2D1Brush * brush) PURE;

  STDMETHOD(PushAxisAlignedClip)(_In_ CONST D2D1_RECT_F * clipRect,
                                 D2D1_ANTIALIAS_MODE antialiasMode) PURE;

  STDMETHOD(PushLayer)(_In_ CONST D2D1_LAYER_PARAMETERS1 * layerParameters1,
...
/// </summary>
interface DX_DECLARE_INTERFACE("b4f34a19-2383-4d76-94f6-ec343657c3dc")
...
/// </summary>
interface DX_DECLARE_INTERFACE("2c1d867d-c290-41c8-ae7e-34a98702e9a5")
    ID2D1PrintControl : public IUnknown {

  STDMETHOD(AddPage)(_In_ ID2D1CommandList * commandList, D2D_SIZE_F pageSize,
...
/// <summary>
/// Provides a brush that can take any effect, command list or bitmap and use it
/// to fill a 2D shape.
/// </summary>
interface DX_DECLARE_INTERFACE("fe9e984d-3f95-407c-b5db-cb94d4e8f87c")
  ...
  STDMETHOD_(void, SetSourceRectangle)(_In_ CONST D2D1_RECT_F * sourceRectangle)
      PURE;

  STDMETHOD_(void, GetImage)(_Outptr_result_maybenull_ ID2D1Image * *image)
      CONST PURE;
  ...
  STDMETHOD_(void, GetSourceRectangle)(_Out_ D2D1_RECT_F * sourceRectangle)
      CONST PURE;
...
/// </summary>
interface DX_DECLARE_INTERFACE("41343a53-e41a-49a2-91cd-21793bbb62e5")
...
/// </summary>
interface DX_DECLARE_INTERFACE("10a72a66-e91c-43f4-993f-ddf4b82b0b4a")
...
/// </summary>
interface DX_DECLARE_INTERFACE("62baa2d2-ab54-41b7-b872-787e0106a421")
  ...
  COM_DECLSPEC_NOTHROW
  HRESULT
  ComputePointAndSegmentAtLength(FLOAT length, UINT32 startSegment,
                                 CONST D2D1_MATRIX_3X2_F & worldTransform,
                                 _Out_ D2D1_POINT_DESCRIPTION *
                                     pointDescription) CONST {
    return ComputePointAndSegmentAtLength(length, startSegment, &worldTransform,
                                          D2D1_DEFAULT_FLATTENING_TOLERANCE,
                                          pointDescription);
  }
...
/// <summary>
/// Represents a set of run-time bindable and discoverable properties that allow
/// a data-driven application to modify the state of a Direct2D effect.
/// </summary>
interface DX_DECLARE_INTERFACE("483473d7-cd46-4f9d-9d3a-3112aa80159d")
  ...
  /// </summary>
  STDMETHOD(GetPropertyName)(UINT32 index, _Out_writes_(nameCount) PWSTR name,
                             UINT32 nameCount) CONST PURE;
  ...
  /// </summary>
  STDMETHOD(SetValueByName)(_In_ PCWSTR name, D2D1_PROPERTY_TYPE type,
  ...
  /// </summary>
  STDMETHOD(SetValue)(UINT32 index, D2D1_PROPERTY_TYPE type,
                      _In_reads_(dataSize) CONST BYTE * data, UINT32 dataSize)
      PURE;

  /// <summary>
  /// Retrieves the given property or sub-property by name. '.' is the delimiter
  /// for sub-properties.
  /// </summary>
  STDMETHOD(GetValueByName)(_In_ PCWSTR name, D2D1_PROPERTY_TYPE type,
                            _Out_writes_(dataSize) BYTE * data, UINT32 dataSize)
      CONST PURE;

  /// <summary>
  /// Retrieves the given value by index.
  /// </summary>
  STDMETHOD(GetValue)(UINT32 index, D2D1_PROPERTY_TYPE type,
                      _Out_writes_(dataSize) BYTE * data, UINT32 dataSize)
      CONST PURE;
  ...
  /// </summary>
  STDMETHOD(GetSubProperties)(UINT32 index,
                              _COM_Outptr_result_maybenull_ ID2D1Properties *
                                  *subProperties) CONST PURE;

  COM_DECLSPEC_NOTHROW
  HRESULT
  SetValueByName(_In_ PCWSTR name, _In_reads_(dataSize) CONST BYTE * data,
                 UINT32 dataSize) {
  ...
  COM_DECLSPEC_NOTHROW
  HRESULT
  SetValue(UINT32 index, _In_reads_(dataSize) CONST BYTE * data,
           UINT32 dataSize) {
  ...
  COM_DECLSPEC_NOTHROW
  HRESULT
  GetValueByName(_In_ PCWSTR name, _Out_writes_(dataSize) BYTE * data,
  ...
  COM_DECLSPEC_NOTHROW
  HRESULT
  GetValue(UINT32 index, _Out_writes_(dataSize) BYTE * data, UINT32 dataSize)
      CONST {
  ...
  template <typename T> T GetValueByName(_In_ PCWSTR propertyName) const {
    T value;
    HRESULT ignoreHr = GetValueByName(
        propertyName, reinterpret_cast<BYTE *>(&value), sizeof(value));
  ...
  template <typename U>
  HRESULT GetValue(U index, _Out_writes_(dataSize) BYTE * data, UINT32 dataSize)
      CONST {
  ...
  template <typename T, typename U> T GetValue(U index) const {
    T value;
    HRESULT ignoreHr =
        GetValue(static_cast<UINT32>(index), reinterpret_cast<BYTE *>(&value),
                 sizeof(value));
  ...
  template <typename U>
  HRESULT SetValue(U index, _In_reads_(dataSize) CONST BYTE * data,
                   UINT32 dataSize) {
  ...
  template <typename U>
  HRESULT GetPropertyName(U index, _Out_writes_(nameCount) PWSTR name,
  ...
  template <typename U>
  HRESULT GetSubProperties(U index, _Outptr_result_maybenull_ ID2D1Properties *
                                        *subProperties) CONST {
...
/// <summary>
/// The effect interface. Properties control how the effect is rendered. The
/// effect is Drawn with the DrawImage call.
/// </summary>
interface DX_DECLARE_INTERFACE("28211a43-7d89-476f-8181-2d6159b220ad")
    ID2D1Effect : public ID2D1Properties {

  /// <summary>
  /// Sets the input to the given effect. The input can be a concrete bitmap or
  /// the output of another effect.
  /// </summary>
  STDMETHOD_(void, SetInput)(UINT32 index, _In_opt_ ID2D1Image * input,
                             BOOL invalidate = TRUE) PURE;

  /// <summary>
  /// If the effect supports a variable number of inputs, this sets the number
  /// of input that are currently active on the effect.
  /// </summary>
  ...
  STDMETHOD_(void, GetInput)(
      UINT32 index, _Outptr_result_maybenull_ ID2D1Image * *input) CONST PURE;
  ...
  /// <summary>
  /// Returns the output image of the given effect. This can be set as the input
  /// to another effect or can be drawn with DrawImage.
  /// </summary>
  STDMETHOD_(void, GetOutput)(_Outptr_ ID2D1Image * *outputImage) CONST PURE;

  COM_DECLSPEC_NOTHROW
  void SetInputEffect(UINT32 index, _In_opt_ ID2D1Effect * inputEffect,
...
/// <summary>
/// Represents a bitmap that can be used as a surface for an ID2D1DeviceContext
/// or mapped into system memory, and can contain additional color context
/// information.
/// </summary>
interface DX_DECLARE_INTERFACE("a898a84c-3873-4588-b08b-ebbf978df041")
  ...
  STDMETHOD_(void, GetColorContext)(
      _Outptr_result_maybenull_ ID2D1ColorContext * *colorContext) CONST PURE;
  ...
  /// <summary>
  /// Retrieves the DXGI surface from the corresponding bitmap, if the bitmap
  /// was created from a device derived from a D3D device.
  /// </summary>
  STDMETHOD(GetSurface)(_COM_Outptr_result_maybenull_ IDXGISurface *
                        *dxgiSurface) CONST PURE;

  /// <summary>
  /// Maps the given bitmap into memory. The bitmap must have been created with
  /// the D2D1_BITMAP_OPTIONS_CPU_READ flag.
  /// </summary>
  STDMETHOD(Map)(D2D1_MAP_OPTIONS options, _Out_ D2D1_MAPPED_RECT * mappedRect)
      PURE;
...
/// </summary>
interface DX_DECLARE_INTERFACE("1c4820bb-5771-4518-a581-2fe4dd0ec657")
  ...
  /// </summary>
  STDMETHOD(GetProfile)(_Out_writes_(profileSize) BYTE * profile,
                        UINT32 profileSize) CONST PURE;
...
/// </summary>
interface DX_DECLARE_INTERFACE("ae1572f4-5dd0-4777-998b-9279472ae63b")
    ID2D1GradientStopCollection1 : public ID2D1GradientStopCollection {

  /// <summary>
  /// Copies the gradient stops from the collection into the caller's memory. If
  /// this object was created using
  /// ID2D1DeviceContext::CreateGradientStopCollection, this method returns the
  /// same values as were specified in the creation method. If this object was
  /// created using ID2D1RenderTarget::CreateGradientStopCollection, the stops
  /// returned here will first be transformed into the gamma space specified by
  ...
  /// <summary>
  /// Returns the color space colors will be converted to after interpolation
  /// occurs. If this object was created using
  ...
  /// <summary>
  /// Returns the buffer precision of this gradient. If this object was created
  /// using ID2D1RenderTarget::CreateGradientStopCollection, this method returns
...
/// </summary>
interface DX_DECLARE_INTERFACE("689f1f85-c72e-4e33-8f19-85754efd5ace")
  ...
  /// </summary>
  STDMETHOD_(void, GetDescription)(_Out_ D2D1_DRAWING_STATE_DESCRIPTION1 *
  ...
  /// </summary>
  STDMETHOD_(void, SetDescription)(_In_ CONST D2D1_DRAWING_STATE_DESCRIPTION1 *
...
/// <summary>
/// The device context represents a set of state and a command buffer that is
/// used to render to a target bitmap.
/// </summary>
interface DX_DECLARE_INTERFACE("e8f7fe7a-191c-466d-ad95-975678bda998")
    ID2D1DeviceContext : public ID2D1RenderTarget {

  /// <summary>
  /// Creates a bitmap with extended bitmap properties, potentially from a block
  /// of memory.
  /// </summary>
  STDMETHOD(CreateBitmap)(D2D1_SIZE_U size, _In_opt_ CONST void *sourceData,
                          UINT32 pitch,
                          _In_ CONST D2D1_BITMAP_PROPERTIES1 *bitmapProperties,
                          _COM_Outptr_ ID2D1Bitmap1 **bitmap) PURE;
  ...
  /// <summary>
  /// Creates a color context from a color space.  If the space is Custom, the
  /// context is initialized from the profile/profileSize arguments.  Otherwise
  /// the context is initialized with the profile bytes associated with the
  /// space and profile/profileSize are ignored.
  /// </summary>
  STDMETHOD(CreateColorContext)(
      D2D1_COLOR_SPACE space, _In_reads_opt_(profileSize) CONST BYTE * profile,
      UINT32 profileSize, _COM_Outptr_ ID2D1ColorContext * *colorContext) PURE;

  STDMETHOD(CreateColorContextFromFilename)(
      _In_ PCWSTR filename, _COM_Outptr_ ID2D1ColorContext * *colorContext)
      PURE;

  STDMETHOD(CreateColorContextFromWicColorContext)(
      _In_ IWICColorContext * wicColorContext,
      _COM_Outptr_ ID2D1ColorContext * *colorContext) PURE;
  ...
  /// <summary>
  /// Create a new effect, the effect must either be built in or previously
  /// registered through ID2D1Factory1::RegisterEffectFromStream or
  /// ID2D1Factory1::RegisterEffectFromString.
  /// </summary>
  STDMETHOD(CreateEffect)(_In_ REFCLSID effectId,
                          _COM_Outptr_ ID2D1Effect * *effect) PURE;
  ...
  /// and the space in which the color interpolation occurs.</param> <param
  /// name="postInterpolationSpace">Specifies the color space colors will be
  /// converted to after interpolation occurs.</param>
  /// <param name="bufferPrecision">Specifies the precision in which the
  /// gradient buffer will be held.</param> <param name="extendMode">Specifies
  /// how the gradient will be extended outside of the unit length.</param>
  /// <param name="colorInterpolationMode">Determines if colors will be
  /// interpolated in straight alpha or premultiplied alpha space.</param>
  STDMETHOD(CreateGradientStopCollection)(
      _In_reads_(straightAlphaGradientStopsCount) CONST D2D1_GRADIENT_STOP *
  ...
  /// including a bitmap, effect and a command list.
  /// </summary>
  ...
  /// </summary>
  STDMETHOD(CreateCommandList)(_COM_Outptr_ ID2D1CommandList * *commandList)
      PURE;
  ...
  /// <summary>
  /// This retrieves the local-space bounds in DIPs of the current image using
  /// the device context DPI.
  /// </summary>
  STDMETHOD(GetImageLocalBounds)(_In_ ID2D1Image * image,
                                 _Out_ D2D1_RECT_F * localBounds) CONST PURE;

  /// <summary>
  /// This retrieves the world-space bounds in DIPs of the current image using
  /// the device context DPI.
  /// </summary>
  STDMETHOD(GetImageWorldBounds)(_In_ ID2D1Image * image,
                                 _Out_ D2D1_RECT_F * worldBounds) CONST PURE;

  /// <summary>
  /// Retrieves the world-space bounds in DIPs of the glyph run using the device
  /// context DPI.
  /// </summary>
  STDMETHOD(GetGlyphRunWorldBounds)(D2D1_POINT_2F baselineOrigin,
  ...
  /// <summary>
  /// Sets the target for this device context to point to the given image. The
  /// image can be a command list or a bitmap created with the
  /// D2D1_BITMAP_OPTIONS_TARGET flag.
  /// </summary>
  ...
  /// </summary>
  STDMETHOD_(void, GetTarget)(_Outptr_result_maybenull_ ID2D1Image * *image)
      CONST PURE;

  /// <summary>
  /// Sets tuning parameters for internal rendering inside the device context.
  /// </summary>
  STDMETHOD_(void, SetRenderingControls)(_In_ CONST D2D1_RENDERING_CONTROLS *
  ...
  /// context.
  /// </summary>
  STDMETHOD_(void, GetRenderingControls)(_Out_ D2D1_RENDERING_CONTROLS *
  ...
  /// <summary>
  /// Draw an image to the device context. The image represents either a
  /// concrete bitmap or the output of an effect graph.
  /// </summary>
  STDMETHOD_(void, DrawImage)(_In_ ID2D1Image * image,
                              _In_opt_ CONST D2D1_POINT_2F *targetOffset = NULL,
                              _In_opt_ CONST D2D1_RECT_F *imageRectangle = NULL,
                              D2D1_INTERPOLATION_MODE interpolationMode =
                                  D2D1_INTERPOLATION_MODE_LINEAR,
                              D2D1_COMPOSITE_MODE compositeMode =
                                  D2D1_COMPOSITE_MODE_SOURCE_OVER) PURE;

  /// <summary>
  /// Draw a metafile to the device context.
  /// </summary>
  STDMETHOD_(void, DrawGdiMetafile)(_In_ ID2D1GdiMetafile * gdiMetafile,
                                    _In_opt_ CONST D2D1_POINT_2F *targetOffset =
                                        NULL) PURE;
  ...
  STDMETHOD_(void, DrawBitmap)(
      ...
      _In_opt_ CONST D2D1_MATRIX_4X4_F *perspectiveTransform = NULL) PURE;
  ...
  /// </summary>
  STDMETHOD_(void,
             PushLayer)(_In_ CONST D2D1_LAYER_PARAMETERS1 * layerParameters,
                        _In_opt_ ID2D1Layer * layer) PURE;

  using ID2D1RenderTarget::PushLayer;

  /// <summary>
  /// This indicates that a portion of an effect's input is invalid. This method
  /// can be called many times.
  /// </summary>
  STDMETHOD(InvalidateEffectInputRectangle)(
      _In_ ID2D1Effect * effect, UINT32 input,
      _In_ CONST D2D1_RECT_F * inputRectangle) PURE;

  /// <summary>
  /// Gets the number of invalid ouptut rectangles that have accumulated at the
  /// effect.
  /// </summary>
  STDMETHOD(GetEffectInvalidRectangleCount)(_In_ ID2D1Effect * effect,
                                            _Out_ UINT32 * rectangleCount) PURE;
  ...
  /// <summary>
  /// Gets the maximum region of each specified input which would be used during
  /// a subsequent rendering operation
  /// </summary>
  STDMETHOD(GetEffectRequiredInputRectangles)(
      _In_ ID2D1Effect * renderEffect,
      _In_opt_ CONST D2D1_RECT_F * renderImageRectangle,
      _In_reads_(inputCount) CONST D2D1_EFFECT_INPUT_DESCRIPTION *
          inputDescriptions,
  ...
  COM_DECLSPEC_NOTHROW
  HRESULT
  CreateBitmap(D2D1_SIZE_U size, _In_opt_ CONST void *sourceData, UINT32 pitch,
  ...
  COM_DECLSPEC_NOTHROW
  HRESULT
  CreateBitmapFromDxgiSurface(_In_ IDXGISurface * surface,
                              CONST D2D1_BITMAP_PROPERTIES1 & bitmapProperties,
                              _COM_Outptr_ ID2D1Bitmap1 * *bitmap) {
  ...
  COM_DECLSPEC_NOTHROW
  HRESULT
  CreateImageBrush(_In_opt_ ID2D1Image * image,
  ...
  /// </summary>
  COM_DECLSPEC_NOTHROW
  void DrawImage(_In_ ID2D1Effect * effect,
                 _In_opt_ CONST D2D1_POINT_2F *targetOffset = NULL,
                 _In_opt_ CONST D2D1_RECT_F *imageRectangle = NULL,
                 D2D1_INTERPOLATION_MODE interpolationMode =
                     D2D1_INTERPOLATION_MODE_LINEAR,
  ...
  COM_DECLSPEC_NOTHROW
  void DrawImage(
      _In_ ID2D1Image * image, D2D1_INTERPOLATION_MODE interpolationMode,
  ...
  COM_DECLSPEC_NOTHROW
  void DrawImage(
      _In_ ID2D1Effect * effect, D2D1_INTERPOLATION_MODE interpolationMode,
      D2D1_COMPOSITE_MODE compositeMode = D2D1_COMPOSITE_MODE_SOURCE_OVER) {
    DrawImage(effect, NULL, NULL, interpolationMode, compositeMode);
  }

  COM_DECLSPEC_NOTHROW
  void DrawImage(_In_ ID2D1Image * image, D2D1_POINT_2F targetOffset,
                 D2D1_INTERPOLATION_MODE interpolationMode =
                     D2D1_INTERPOLATION_MODE_LINEAR,
                 D2D1_COMPOSITE_MODE compositeMode =
                     D2D1_COMPOSITE_MODE_SOURCE_OVER) {
  ...
  COM_DECLSPEC_NOTHROW
  void DrawImage(_In_ ID2D1Effect * effect, D2D1_POINT_2F targetOffset,
                 D2D1_INTERPOLATION_MODE interpolationMode =
                     D2D1_INTERPOLATION_MODE_LINEAR,
                 D2D1_COMPOSITE_MODE compositeMode =
                     D2D1_COMPOSITE_MODE_SOURCE_OVER) {
  ...
  COM_DECLSPEC_NOTHROW
  void DrawBitmap(
      _In_ ID2D1Bitmap * bitmap, CONST D2D1_RECT_F & destinationRectangle,
...
/// <summary>
/// The device defines a resource domain whose objects and device contexts can
/// be used together.
/// </summary>
interface DX_DECLARE_INTERFACE("47dd575d-ac05-4cdd-8049-9b02cd16f44c")
  ...
  STDMETHOD(CreateDeviceContext)(D2D1_DEVICE_CONTEXT_OPTIONS options,
                                 _COM_Outptr_ ID2D1DeviceContext *
                                     *deviceContext) PURE;
  ...
  STDMETHOD(CreatePrintControl)(
      ...
      _COM_Outptr_ ID2D1PrintControl * *printControl) PURE;

  /// <summary>
  /// Sets the maximum amount of texture memory to maintain before evicting
  /// caches.
  /// </summary>
  STDMETHOD_(void, SetMaximumTextureMemory)(UINT64 maximumInBytes) PURE;

  /// <summary>
  /// Gets the maximum amount of texture memory to maintain before evicting
  /// caches.
  /// </summary>
  ...
  COM_DECLSPEC_NOTHROW
  HRESULT
  CreatePrintControl(_In_ IWICImagingFactory * wicFactory,
                     _In_ IPrintDocumentPackageTarget * documentTarget,
...
/// </summary>
interface DX_DECLARE_INTERFACE("bb12d362-daee-4b9a-aa1d-14ba401cfa1f")
  ...
  STDMETHOD(CreateDevice)(_In_ IDXGIDevice * dxgiDevice,
                          _COM_Outptr_ ID2D1Device * *d2dDevice) PURE;

  /// <summary>
  /// This creates a stroke style with the ability to preserve stroke width in
  /// various ways.
  /// </summary>
  STDMETHOD(CreateStrokeStyle)(
      ...
      _COM_Outptr_ ID2D1StrokeStyle1 * *strokeStyle) PURE;
  ...
  /// </summary>
  STDMETHOD(CreatePathGeometry)(_COM_Outptr_ ID2D1PathGeometry1 * *pathGeometry)
      PURE;
  ...
  STDMETHOD(CreateDrawingStateBlock)(
      ...
      _COM_Outptr_ ID2D1DrawingStateBlock1 * *drawingStateBlock) PURE;
  ...
  /// </summary>
  STDMETHOD(CreateGdiMetafile)(_In_ IStream * metafileStream,
                               _COM_Outptr_ ID2D1GdiMetafile * *metafile) PURE;

  /// <summary>
  /// This globally registers the given effect. The effect can later be
  /// instantiated by using the registered class id. The effect registration is
  /// reference counted.
  /// </summary>
  STDMETHOD(RegisterEffectFromStream)(
      _In_ REFCLSID classId, _In_ IStream * propertyXml,
  ...
  STDMETHOD(RegisterEffectFromString)(
      _In_ REFCLSID classId, _In_ PCWSTR propertyXml,
      _In_reads_opt_(bindingsCount) CONST D2D1_PROPERTY_BINDING * bindings,
      UINT32 bindingsCount, _In_ CONST PD2D1_EFFECT_FACTORY effectFactory) PURE;

  /// <summary>
  /// This unregisters the given effect by its class id, you need to call
  /// UnregisterEffect for every call to ID2D1Factory1::RegisterEffectFromStream
  /// and ID2D1Factory1::RegisterEffectFromString to completely unregister it.
  /// </summary>
  ...
  /// built-in effects.
  /// </summary>
  /// <param name="effectsReturned">The number of effects returned into the
  /// passed in effects array.</param> <param name="effectsRegistered">The
  /// number of effects currently registered in the system.</param>
  STDMETHOD(GetRegisteredEffects)(
      _Out_writes_to_opt_(effectsCount, *effectsReturned) CLSID * effects,
      UINT32 effectsCount, _Out_opt_ UINT32 * effectsReturned,
      _Out_opt_ UINT32 * effectsRegistered) CONST PURE;

  /// <summary>
  /// This retrieves the effect properties for the given effect, all of the
  /// effect properties will be set to a default value since an effect is not
  /// instantiated to implement the returned property interface.
  /// </summary>
  STDMETHOD(GetEffectProperties)(_In_ REFCLSID effectId,
                                 _COM_Outptr_ ID2D1Properties * *properties)
      CONST PURE;

  COM_DECLSPEC_NOTHROW
  HRESULT
  CreateStrokeStyle(CONST D2D1_STROKE_STYLE_PROPERTIES1 & strokeStyleProperties,
  ...
  COM_DECLSPEC_NOTHROW
  HRESULT
  CreateDrawingStateBlock(_COM_Outptr_ ID2D1DrawingStateBlock1 *
                          *drawingStateBlock) {
...
/// </summary>
interface DX_DECLARE_INTERFACE("31e6e7bc-e0ff-4d46-8c64-a0a8c41c15d3")
...
HRESULT WINAPI
D2D1CreateDevice(_In_ IDXGIDevice *dxgiDevice,
...
D2D1_COLOR_F WINAPI D2D1ConvertColorSpace(
    D2D1_COLOR_SPACE sourceColorSpace, D2D1_COLOR_SPACE destinationColorSpace,
...
inline HRESULT
D2D1CreateDeviceContext(_In_ IDXGISurface *dxgiSurface,
                        _In_ CONST D2D1_CREATION_PROPERTIES &creationProperties,
                        _Outptr_ ID2D1DeviceContext **d2dDeviceContext) {
  return D2D1CreateDeviceContext(dxgiSurface, &creationProperties,
                                 d2dDeviceContext);
}
