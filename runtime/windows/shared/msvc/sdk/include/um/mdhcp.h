...
typedef struct IMcastScopeVtbl {
  ...
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in IMcastScope *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IMcastScope *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IMcastScope *This);
  ...
  /* [helpstring][id][propget] */ HRESULT(
      STDMETHODCALLTYPE *get_ScopeDescription)(
      __RPC__in IMcastScope *This,
...
interface IMcastScope { CONST_VTBL struct IMcastScopeVtbl *lpVtbl; };
...
typedef struct IMcastLeaseInfoVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in IMcastLeaseInfo *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IMcastLeaseInfo *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IMcastLeaseInfo *This);
...
interface IMcastLeaseInfo { CONST_VTBL struct IMcastLeaseInfoVtbl *lpVtbl; };
...
typedef struct IEnumMcastScopeVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in IEnumMcastScope *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IEnumMcastScope *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IEnumMcastScope *This);
  ...
  HRESULT(STDMETHODCALLTYPE *Reset)(__RPC__in IEnumMcastScope *This);

  DECLSPEC_XFGVIRT(IEnumMcastScope, Skip)
  HRESULT(STDMETHODCALLTYPE *Skip)(__RPC__in IEnumMcastScope *This,
                                   /* [in] */ ULONG celt);
...
interface IEnumMcastScope { CONST_VTBL struct IEnumMcastScopeVtbl *lpVtbl; };
...
public:
  ...
  virtual /* [helpstring][hidden][id] */ HRESULT STDMETHODCALLTYPE
      EnumerateScopes(
          /* [out] */ __RPC__deref_out_opt IEnumMcastScope *
          *ppEnumMcastScope) = 0;
  ...
  virtual /* [helpstring][id] */ HRESULT STDMETHODCALLTYPE RequestAddress(
      ...
      /* [retval][out] */
      __RPC__deref_out_opt IMcastLeaseInfo **ppLeaseResponse) = 0;

  virtual /* [helpstring][id] */ HRESULT STDMETHODCALLTYPE RenewAddress(
      /* [in] */ long lReserved,
      /* [in] */ __RPC__in_opt IMcastLeaseInfo *pRenewRequest,
      /* [retval][out] */
      __RPC__deref_out_opt IMcastLeaseInfo **ppRenewResponse) = 0;
  ...
  CreateLeaseInfo(
      ...
      /* [retval][out] */ __RPC__deref_out_opt IMcastLeaseInfo *
          *ppReleaseRequest) = 0;
...
typedef struct IMcastAddressAllocationVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IMcastAddressAllocation *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IMcastAddressAllocation *This);
...
#define IMcastAddressAllocation_RenewAddress(This, lReserved, pRenewRequest,   \
                                             ppRenewResponse)                  \
  ((This)->lpVtbl->RenewAddress(This, lReserved, pRenewRequest,                \
                                ppRenewResponse))
