...
EXTERN_C const GUID DECLSPEC_SELECTANY CLSID_AudioVolumeMeter =
    __uuidof(AudioVolumeMeter);

class __declspec(uuid("C2633B16-471B-4498-B8C5-4F0959E2EC09")) AudioReverb;
EXTERN_C const GUID DECLSPEC_SELECTANY CLSID_AudioReverb =
    __uuidof(AudioReverb);
#else // __cplusplus
DEFINE_GUID(CLSID_AudioVolumeMeter, 0x4FC3B166, 0x972A, 0x40CF, 0xBC, 0x37,
            0x7D, 0xB0, 0x3D, 0xB2, 0xFB, 0xA3);
DEFINE_GUID(CLSID_AudioReverb, 0xC2633B16, 0x471B, 0x4498, 0xB8, 0xC5, 0x4F,
            0x09, 0x59, 0xE2, 0xEC, 0x09);
#endif
...
__inline void
ReverbConvertI3DL2ToNative(_In_ const XAUDIO2FX_REVERB_I3DL2_PARAMETERS *pI3DL2,
