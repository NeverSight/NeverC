...
typedef struct IMFASFProfileVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(IMFASFProfile *This,
                                             /* [in] */ REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);
  ...
  HRESULT(STDMETHODCALLTYPE *GetItem)(
      IMFASFProfile *This, REFGUID guidKey,
  ...
  HRESULT(STDMETHODCALLTYPE *GetCount)(IMFASFProfile *This,
                                       /* [out] */ UINT32 *pcItems);

  DECLSPEC_XFGVIRT(IMFAttributes, GetItemByIndex)
  HRESULT(STDMETHODCALLTYPE *GetItemByIndex)(
      IMFASFProfile *This, UINT32 unIndex,
      /* [out] */ GUID *pguidKey,
      /* [full][out][in] */ PROPVARIANT *pValue);
...
interface IMFASFProfile { CONST_VTBL struct IMFASFProfileVtbl *lpVtbl; };
...
typedef struct IMFASFStreamConfigVtbl {
  ...
  DECLSPEC_XFGVIRT(IMFAttributes, GetItem)
  HRESULT(STDMETHODCALLTYPE *GetItem)(
      IMFASFStreamConfig *This, REFGUID guidKey,
      /* [full][out][in] */ PROPVARIANT *pValue);
  ...
  DECLSPEC_XFGVIRT(IMFAttributes, GetItemByIndex)
  HRESULT(STDMETHODCALLTYPE *GetItemByIndex)(
      IMFASFStreamConfig *This, UINT32 unIndex,
      /* [out] */ GUID *pguidKey,
      /* [full][out][in] */ PROPVARIANT *pValue);
...
#define IMFASFStreamPrioritization_GetStream(This, dwStreamIndex,              \
  ...
  ((This)->lpVtbl->GetStream(This, dwStreamIndex, pwStreamNumber,              \
                             pwStreamFlags))
...
typedef struct IMFASFIndexerVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(IMFASFIndexer *This,
                                             /* [in] */ REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);
  ...
  HRESULT(STDMETHODCALLTYPE *SetFlags)(IMFASFIndexer *This,
                                       /* [in] */ DWORD dwFlags);

  DECLSPEC_XFGVIRT(IMFASFIndexer, GetFlags)
  HRESULT(STDMETHODCALLTYPE *GetFlags)(IMFASFIndexer *This,
                                       /* [out] */ DWORD *pdwFlags);
...
interface IMFASFIndexer { CONST_VTBL struct IMFASFIndexerVtbl *lpVtbl; };
...
typedef struct IMFASFSplitterVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(IMFASFSplitter *This,
                                             /* [in] */ REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);
  ...
  HRESULT(STDMETHODCALLTYPE *SetFlags)(IMFASFSplitter *This,
                                       /* [in] */ DWORD dwFlags);

  DECLSPEC_XFGVIRT(IMFASFSplitter, GetFlags)
  HRESULT(STDMETHODCALLTYPE *GetFlags)(IMFASFSplitter *This,
                                       /* [out] */ DWORD *pdwFlags);
...
interface IMFASFSplitter { CONST_VTBL struct IMFASFSplitterVtbl *lpVtbl; };
...
#define IMFASFSplitter_GetNextSample(This, pdwStatusFlags, pwStreamNumber,     \
                                     ppISample)                                \
  ((This)->lpVtbl->GetNextSample(This, pdwStatusFlags, pwStreamNumber,         \
                                 ppISample))
...
typedef struct IMFASFMultiplexerVtbl {
  ...
  HRESULT(STDMETHODCALLTYPE *SetFlags)(IMFASFMultiplexer *This,
                                       /* [in] */ DWORD dwFlags);
...
STDAPI
MFCreateASFMediaSink(IMFByteStream *pIByteStream, IMFMediaSink **ppIMediaSink);
...
HRESULT STDMETHODCALLTYPE MFCreateWMAEncoderActivate(
    ...
    IMFActivate **ppActivate);
STDAPI
MFCreateASFStreamingMediaSink(IMFByteStream *pIByteStream,
...
public:
  virtual HRESULT STDMETHODCALLTYPE ProcessLicenseRequest(
      /* [size_is][in] */ __RPC__in_ecount_full(cbLicenseRequest) BYTE *
          pLicenseRequest,
      /* [in] */ DWORD cbLicenseRequest,
      /* [size_is][size_is][out] */
      __RPC__deref_out_ecount_full_opt(*pcbLicenseResponse) BYTE *
          *ppLicenseResponse,
...
typedef struct IMFDRMNetHelperVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in IMFDRMNetHelper *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IMFDRMNetHelper *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IMFDRMNetHelper *This);
  ...
  HRESULT(STDMETHODCALLTYPE *ProcessLicenseRequest)(
      ...
      /* [in] */ DWORD cbLicenseRequest,
      /* [size_is][size_is][out] */
      __RPC__deref_out_ecount_full_opt(*pcbLicenseResponse)
...
interface IMFDRMNetHelper { CONST_VTBL struct IMFDRMNetHelperVtbl *lpVtbl; };
