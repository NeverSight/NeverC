...
typedef struct IThumbnailStreamCacheVtbl {
  ...
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IThumbnailStreamCache *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IThumbnailStreamCache *This);
...
#define IThumbnailStreamCache_AddRef(This) ((This)->lpVtbl->AddRef(This))

#define IThumbnailStreamCache_Release(This) ((This)->lpVtbl->Release(This))

#define IThumbnailStreamCache_GetThumbnailStream(                              \
    This, path, cacheId, options, requestedThumbnailSize, thumbnailSize,       \
    thumbnailStream)                                                           \
  ((This)->lpVtbl->GetThumbnailStream(This, path, cacheId, options,            \
                                      requestedThumbnailSize, thumbnailSize,   \
                                      thumbnailStream))

#define IThumbnailStreamCache_SetThumbnailStream(                              \
    This, path, cacheId, thumbnailSize, thumbnailStream)                       \
  ((This)->lpVtbl->SetThumbnailStream(This, path, cacheId, thumbnailSize,      \
                                      thumbnailStream))
