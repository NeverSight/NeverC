...
DEFINE_GUID(GUID_DEVINTERFACE_SIDESHOW, 0x152e5811, 0xfeb9, 0x4b00, 0x90, 0xf4,
            0xd3, 0x29, 0x47, 0xae, 0x16, 0x81);
...
DEFINE_GUID(SIDESHOW_CONTENT_MISSING_EVENT, 0x5007fba8, 0xd313, 0x439f, 0xbe,
            0xa2, 0xa5, 0x02, 0x01, 0xd3, 0xe9, 0xa8);

// {4CB572FA-1D3B-49b3-A17A-2E6BFF052854}
DEFINE_GUID(SIDESHOW_APPLICATION_EVENT, 0x4cb572fa, 0x1d3b, 0x49b3, 0xa1, 0x7a,
            0x2e, 0x6b, 0xff, 0x05, 0x28, 0x54);

// {5009673c-3f7d-4c7e-9971-eaa2e91f1575}
DEFINE_GUID(SIDESHOW_USER_CHANGE_REQUEST_EVENT, 0x5009673c, 0x3f7d, 0x4c7e,
            0x99, 0x71, 0xea, 0xa2, 0xe9, 0x1f, 0x15, 0x75);

// {57813854-2FC1-411C-A59F-F24927608804}
DEFINE_GUID(SIDESHOW_NEW_EVENT_DATA_AVAILABLE, 0x57813854, 0x2FC1, 0x411C, 0xA5,
            0x9F, 0xF2, 0x49, 0x27, 0x60, 0x88, 0x04);
...
//////////////////////////////////////////////////////////////////////////////
//
// This struct contains an event sent by the driver to the platform. It tells
// the API that the device has new event data available to be retrieved It does
// not describe the type of events, nor the quantity of events available
//
//////////////////////////////////////////////////////////////////////////////
...
// This will usually be followed by another struct that is specific to the
// guidEventType.
//      For Application Event GUID, the subsequent struct will be of type
//      APPLICATION_EVENT_DATA For Content Missing GUID, the subsequent struct
//      will be of type CONTENT_MISSING_EVENT_DATA
...
typedef struct _EVENT_DATA_HEADER {
  ...
  GUID guidEventType; // The GUID of the event type. This could be {"Application
                      // Event", "Content Missing", "Device Added", "Device
                      // Removed"}
  DWORD dwVersion;    // Always set to VERSION_1_WINDOWS_7 in Windows 7
