...
typedef BOOLEAN CALLBACK PWRSCHEMESENUMPROC_V1(
    _In_ UINT Index, _In_ DWORD NameSize,
    _In_reads_bytes_(NameSize) LPTSTR Name, _In_ DWORD DescriptionSize,
    _In_reads_bytes_(DescriptionSize) LPTSTR Description,
    _In_ PPOWER_POLICY Policy, _Inout_opt_ LPARAM Context);

typedef BOOLEAN CALLBACK PWRSCHEMESENUMPROC_V2(
    _In_ UINT Index, _In_ DWORD NameSize,
    _In_reads_bytes_(NameSize) LPWSTR Name, _In_ DWORD DescriptionSize,
...
STDAPI_(BOOLEAN)
GetPwrDiskSpindownRange(_Out_ PUINT puiMax, _Out_ PUINT puiMin);

STDAPI_(BOOLEAN)
EnumPwrSchemes(_In_ PWRSCHEMESENUMPROC lpfn, _In_ LPARAM lParam);

STDAPI_(BOOLEAN)
ReadGlobalPwrPolicy(_In_ PGLOBAL_POWER_POLICY pGlobalPowerPolicy);

STDAPI_(BOOLEAN)
ReadPwrScheme(_In_ UINT uiID, _Out_ PPOWER_POLICY pPowerPolicy);

STDAPI_(BOOLEAN)
WritePwrScheme(_In_ PUINT puiID, _In_ LPCWSTR lpszSchemeName,
               _In_opt_ LPCWSTR lpszDescription, _In_ PPOWER_POLICY lpScheme);

STDAPI_(BOOLEAN)
WriteGlobalPwrPolicy(_In_ PGLOBAL_POWER_POLICY pGlobalPowerPolicy);

STDAPI_(BOOLEAN)
DeletePwrScheme(_In_ UINT uiID);

STDAPI_(BOOLEAN)
GetActivePwrScheme(_Out_ PUINT puiID);

STDAPI_(BOOLEAN)
SetActivePwrScheme(_In_ UINT uiID,
...
STDAPI_(BOOLEAN)
IsAdminOverrideActive(_In_ PADMINISTRATOR_POWER_POLICY papp);

STDAPI_(BOOLEAN)
SetSuspendState(_In_ BOOLEAN bHibernate, _In_ BOOLEAN bForce,
                _In_ BOOLEAN bWakeupEventsDisabled);

STDAPI_(BOOLEAN)
GetCurrentPowerPolicies(_Out_ PGLOBAL_POWER_POLICY pGlobalPowerPolicy,
...
//
STDAPI_(BOOLEAN)
ReadProcessorPwrScheme(_In_ UINT uiID, _Out_ PMACHINE_PROCESSOR_POWER_POLICY
...
//
STDAPI_(BOOLEAN)
WriteProcessorPwrScheme(_In_ UINT uiID, _In_ PMACHINE_PROCESSOR_POWER_POLICY
                                            pMachineProcessorPowerPolicy);
#endif

STDAPI_(BOOLEAN)
ValidatePowerPolicies(_Inout_opt_ PGLOBAL_POWER_POLICY pGlobalPowerPolicy,
...
typedef ULONG CALLBACK DEVICE_NOTIFY_CALLBACK_ROUTINE(_In_opt_ PVOID Context,
                                                      _In_ ULONG Type,
                                                      _In_ PVOID Setting);
...
STDAPI_(BOOLEAN)
PowerIsSettingRangeDefined(_In_opt_ CONST GUID *SubKeyGuid OPTIONAL,
                           _In_opt_ CONST GUID *SettingGuid OPTIONAL);
#endif

#if (NTDDI_VERSION >= NTDDI_WIN7)
STDAPI_(DWORD)
PowerSettingAccessCheckEx(_In_ POWER_DATA_ACCESSOR AccessFlags,
...
#if (NTDDI_VERSION >= NTDDI_VISTA)
STDAPI_(DWORD)
PowerSettingAccessCheck(_In_ POWER_DATA_ACCESSOR AccessFlags,
                        _In_opt_ CONST GUID *PowerGuid);
#endif
...
STDAPI_(DWORD)
PowerGetUserConfiguredACPowerMode(_Out_ GUID *PowerModeGuid);

STDAPI_(DWORD)
PowerGetUserConfiguredDCPowerMode(_Out_ GUID *PowerModeGuid);

STDAPI_(DWORD)
PowerSetUserConfiguredACPowerMode(_In_ const GUID *PowerModeGuid);

STDAPI_(DWORD)
PowerSetUserConfiguredDCPowerMode(_In_ const GUID *PowerModeGuid);
...
#if (NTDDI_VERSION >= NTDDI_VISTA)
STDAPI_(DWORD)
PowerReadACValueIndex(_In_opt_ HKEY RootPowerKey,
...
#if (NTDDI_VERSION >= NTDDI_VISTA)
STDAPI_(DWORD)
PowerReadDCValueIndex(_In_opt_ HKEY RootPowerKey,
                      _In_opt_ CONST GUID *SchemeGuid,
                      _In_opt_ CONST GUID *SubGroupOfPowerSettingsGuid,
                      _In_opt_ CONST GUID *PowerSettingGuid,
...
#if (NTDDI_VERSION >= NTDDI_VISTA)
STDAPI_(DWORD)
PowerReadFriendlyName(_In_opt_ HKEY RootPowerKey,
                      _In_opt_ CONST GUID *SchemeGuid,
                      _In_opt_ CONST GUID *SubGroupOfPowerSettingsGuid,
                      _In_opt_ CONST GUID *PowerSettingGuid,
...
#if (NTDDI_VERSION >= NTDDI_VISTA)
STDAPI_(DWORD)
PowerReadDescription(_In_opt_ HKEY RootPowerKey,
                     _In_opt_ CONST GUID *SchemeGuid,
                     _In_opt_ CONST GUID *SubGroupOfPowerSettingsGuid,
                     _In_opt_ CONST GUID *PowerSettingGuid,
                     _Out_writes_bytes_opt_(*BufferSize) PUCHAR Buffer,
...
#if (NTDDI_VERSION >= NTDDI_VISTA)
STDAPI_(DWORD)
PowerReadPossibleValue(_In_opt_ HKEY RootPowerKey,
                       _In_opt_ CONST GUID *SubGroupOfPowerSettingsGuid,
                       _In_opt_ CONST GUID *PowerSettingGuid,
                       _Out_opt_ PULONG Type, _In_ ULONG PossibleSettingIndex,
                       _Out_writes_bytes_opt_(*BufferSize) PUCHAR Buffer,
                       _Inout_ LPDWORD BufferSize);
#endif
...
#if (NTDDI_VERSION >= NTDDI_VISTA)
STDAPI_(DWORD)
PowerReadPossibleFriendlyName(_In_opt_ HKEY RootPowerKey,
                              _In_opt_ CONST GUID *SubGroupOfPowerSettingsGuid,
                              _In_opt_ CONST GUID *PowerSettingGuid,
...
#if (NTDDI_VERSION >= NTDDI_VISTA)
STDAPI_(DWORD)
PowerReadPossibleDescription(_In_opt_ HKEY RootPowerKey,
                             _In_opt_ CONST GUID *SubGroupOfPowerSettingsGuid,
                             _In_opt_ CONST GUID *PowerSettingGuid,
                             _In_ ULONG PossibleSettingIndex,
                             _Out_writes_bytes_opt_(*BufferSize) PUCHAR Buffer,
...
#if (NTDDI_VERSION >= NTDDI_VISTA)
STDAPI_(DWORD)
PowerReadValueMin(_In_opt_ HKEY RootPowerKey,
                  _In_opt_ CONST GUID *SubGroupOfPowerSettingsGuid,
                  _In_opt_ CONST GUID *PowerSettingGuid,
...
#if (NTDDI_VERSION >= NTDDI_VISTA)
STDAPI_(DWORD)
PowerReadValueMax(_In_opt_ HKEY RootPowerKey,
                  _In_opt_ CONST GUID *SubGroupOfPowerSettingsGuid,
                  _In_opt_ CONST GUID *PowerSettingGuid,
...
#if (NTDDI_VERSION >= NTDDI_VISTA)
STDAPI_(DWORD)
PowerReadValueIncrement(_In_opt_ HKEY RootPowerKey,
                        _In_opt_ CONST GUID *SubGroupOfPowerSettingsGuid,
                        _In_opt_ CONST GUID *PowerSettingGuid,
...
#if (NTDDI_VERSION >= NTDDI_VISTA)
STDAPI_(DWORD)
PowerReadValueUnitsSpecifier(_In_opt_ HKEY RootPowerKey,
                             _In_opt_ CONST GUID *SubGroupOfPowerSettingsGuid,
                             _In_opt_ CONST GUID *PowerSettingGuid,
...
PowerReadACDefaultIndex(
    _In_opt_ HKEY RootPowerKey, _In_ CONST GUID *SchemePersonalityGuid,
    _In_opt_ CONST GUID *SubGroupOfPowerSettingsGuid OPTIONAL,
    _In_ CONST GUID *PowerSettingGuid, _Out_ LPDWORD AcDefaultIndex);
#endif

#if (NTDDI_VERSION >= NTDDI_VISTA)
STDAPI_(DWORD)
PowerReadDCDefaultIndex(_In_opt_ HKEY RootPowerKey,
...
#if (NTDDI_VERSION >= NTDDI_VISTA)
STDAPI_(DWORD)
PowerReadIconResourceSpecifier(_In_opt_ HKEY RootPowerKey,
                               _In_opt_ CONST GUID *SchemeGuid,
                               _In_opt_ CONST GUID *SubGroupOfPowerSettingsGuid,
                               _In_opt_ CONST GUID *PowerSettingGuid,
                               _Out_writes_bytes_opt_(*BufferSize)
                                   PUCHAR Buffer,
                               _Inout_ LPDWORD BufferSize);
#endif
...
#if (NTDDI_VERSION >= NTDDI_VISTA)
STDAPI_(DWORD)
PowerReadSettingAttributes(_In_opt_ CONST GUID *SubGroupGuid,
                           _In_opt_ CONST GUID *PowerSettingGuid);
#endif
...
#if (NTDDI_VERSION >= NTDDI_VISTA)
STDAPI_(DWORD)
PowerWritePossibleValue(_In_opt_ HKEY RootPowerKey,
                        _In_opt_ CONST GUID *SubGroupOfPowerSettingsGuid,
                        _In_opt_ CONST GUID *PowerSettingGuid, _In_ ULONG Type,
                        _In_ ULONG PossibleSettingIndex,
                        _In_reads_bytes_(BufferSize) UCHAR *Buffer,
                        _In_ DWORD BufferSize);
#endif
...
#if (NTDDI_VERSION >= NTDDI_VISTA)
STDAPI_(DWORD)
PowerWritePossibleFriendlyName(_In_opt_ HKEY RootPowerKey,
                               _In_opt_ CONST GUID *SubGroupOfPowerSettingsGuid,
                               _In_opt_ CONST GUID *PowerSettingGuid,
                               _In_ ULONG PossibleSettingIndex,
                               _In_reads_bytes_(BufferSize) UCHAR *Buffer,
...
#if (NTDDI_VERSION >= NTDDI_VISTA)
STDAPI_(DWORD)
PowerWritePossibleDescription(_In_opt_ HKEY RootPowerKey,
                              _In_opt_ CONST GUID *SubGroupOfPowerSettingsGuid,
                              _In_opt_ CONST GUID *PowerSettingGuid,
                              _In_ ULONG PossibleSettingIndex,
                              _In_reads_bytes_(BufferSize) UCHAR *Buffer,
...
#if (NTDDI_VERSION >= NTDDI_VISTA)
STDAPI_(DWORD)
PowerWriteValueMin(_In_opt_ HKEY RootPowerKey,
                   _In_opt_ CONST GUID *SubGroupOfPowerSettingsGuid,
                   _In_opt_ CONST GUID *PowerSettingGuid,
...
#if (NTDDI_VERSION >= NTDDI_VISTA)
STDAPI_(DWORD)
PowerWriteValueMax(_In_opt_ HKEY RootPowerKey,
                   _In_opt_ CONST GUID *SubGroupOfPowerSettingsGuid,
                   _In_opt_ CONST GUID *PowerSettingGuid,
...
#if (NTDDI_VERSION >= NTDDI_VISTA)
STDAPI_(DWORD)
PowerWriteValueIncrement(_In_opt_ HKEY RootPowerKey,
                         _In_opt_ CONST GUID *SubGroupOfPowerSettingsGuid,
                         _In_opt_ CONST GUID *PowerSettingGuid,
...
#if (NTDDI_VERSION >= NTDDI_VISTA)
STDAPI_(DWORD)
PowerWriteValueUnitsSpecifier(_In_opt_ HKEY RootPowerKey,
                              _In_opt_ CONST GUID *SubGroupOfPowerSettingsGuid,
                              _In_opt_ CONST GUID *PowerSettingGuid,
                              _In_reads_bytes_(BufferSize) UCHAR *Buffer,
                              _In_ DWORD BufferSize);
...
#if (NTDDI_VERSION >= NTDDI_VISTA)
STDAPI_(DWORD)
PowerWriteACDefaultIndex(_In_opt_ HKEY RootSystemPowerKey,
                         _In_ CONST GUID *SchemePersonalityGuid,
                         _In_opt_ CONST GUID *SubGroupOfPowerSettingsGuid,
                         _In_ CONST GUID *PowerSettingGuid,
...
#if (NTDDI_VERSION >= NTDDI_VISTA)
STDAPI_(DWORD)
PowerWriteDCDefaultIndex(_In_opt_ HKEY RootSystemPowerKey,
                         _In_ CONST GUID *SchemePersonalityGuid,
                         _In_opt_ CONST GUID *SubGroupOfPowerSettingsGuid,
                         _In_ CONST GUID *PowerSettingGuid,
...
PowerWriteIconResourceSpecifier(
    _In_opt_ HKEY RootPowerKey, _In_ CONST GUID *SchemeGuid,
    _In_opt_ CONST GUID *SubGroupOfPowerSettingsGuid,
    _In_opt_ CONST GUID *PowerSettingGuid,
...
#if (NTDDI_VERSION >= NTDDI_VISTA)
STDAPI_(DWORD)
PowerWriteSettingAttributes(_In_opt_ CONST GUID *SubGroupGuid,
                            _In_opt_ CONST GUID *PowerSettingGuid,
...
#if (NTDDI_VERSION >= NTDDI_VISTA)
STDAPI_(DWORD)
PowerDuplicateScheme(_In_opt_ HKEY RootPowerKey,
...
#if (NTDDI_VERSION >= NTDDI_VISTA)
STDAPI_(DWORD)
PowerImportPowerScheme(_In_opt_ HKEY RootPowerKey,
...
#if (NTDDI_VERSION >= NTDDI_VISTA)
STDAPI_(DWORD)
PowerRemovePowerSetting(_In_ CONST GUID *PowerSettingSubKeyGuid,
                        _In_ CONST GUID *PowerSettingGuid);
#endif

#if (NTDDI_VERSION >= NTDDI_VISTA)
STDAPI_(DWORD)
PowerCreateSetting(_In_opt_ HKEY RootSystemPowerKey,
...
#if (NTDDI_VERSION >= NTDDI_VISTA)
STDAPI_(DWORD)
PowerCreatePossibleSetting(_In_opt_ HKEY RootSystemPowerKey,
                           _In_ CONST GUID *SubGroupOfPowerSettingsGuid,
                           _In_ CONST GUID *PowerSettingGuid,
                           _In_ ULONG PossibleSettingIndex);
#endif
...
PowerEnumerate(_In_opt_ HKEY RootPowerKey, _In_opt_ CONST GUID *SchemeGuid,
               _In_opt_ CONST GUID *SubGroupOfPowerSettingsGuid,
               _In_ POWER_DATA_ACCESSOR AccessFlags, _In_ ULONG Index,
               _Out_writes_bytes_opt_(*BufferSize) UCHAR *Buffer,
...
#if (NTDDI_VERSION >= NTDDI_VISTA)
STDAPI_(DWORD)
PowerOpenUserPowerKey(_Out_ HKEY *phUserPowerKey, _In_ REGSAM Access,
                      _In_ BOOL OpenExisting);
#endif

#if (NTDDI_VERSION >= NTDDI_VISTA)
STDAPI_(DWORD)
PowerOpenSystemPowerKey(_Out_ HKEY *phSystemPowerKey, _In_ REGSAM Access,
                        _In_ BOOL OpenExisting);
#endif
...
#if (NTDDI_VERSION >= NTDDI_VISTA)
STDAPI_(DWORD)
PowerRestoreIndividualDefaultPowerScheme(_In_ CONST GUID *SchemeGuid);
#endif

#if (NTDDI_VERSION >= NTDDI_VISTA)
STDAPI_(DWORD)
PowerRestoreDefaultPowerSchemes(VOID);
#endif

#if (NTDDI_VERSION >= NTDDI_VISTA)
STDAPI_(DWORD)
PowerReplaceDefaultPowerSchemes(VOID);
#endif
...
STDAPI_(BOOLEAN)
DevicePowerEnumDevices(_In_ ULONG QueryIndex,
...
#if (NTDDI_VERSION >= NTDDI_WS03)
STDAPI_(DWORD)
DevicePowerSetDeviceState(_In_ LPCWSTR DeviceDescription, _In_ ULONG SetFlags,
                          _In_opt_ PVOID SetData);
#endif

#if (NTDDI_VERSION >= NTDDI_WS03)
STDAPI_(BOOLEAN)
DevicePowerOpen(_In_opt_ ULONG DebugMask);
#endif

#if (NTDDI_VERSION >= NTDDI_WS03)
STDAPI_(BOOLEAN)
DevicePowerClose(VOID);
#endif
...
STDAPI_(DWORD)
PowerReportThermalEvent(_In_ PTHERMAL_EVENT Event);
#endif
