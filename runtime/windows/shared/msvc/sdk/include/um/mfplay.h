...
STDAPI MFPCreateMediaPlayer(_In_opt_ LPCWSTR pwszURL, _In_ BOOL fStartPlayback,
...
typedef struct IMFPMediaPlayerVtbl {
  ...
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(IMFPMediaPlayer *This,
                                             /* [in] */ REFIID riid,
  ...
  HRESULT(STDMETHODCALLTYPE *SetRate)(IMFPMediaPlayer *This,
                                      /* [annotation][in] */
                                      _In_ float flRate);

  DECLSPEC_XFGVIRT(IMFPMediaPlayer, GetRate)
  HRESULT(STDMETHODCALLTYPE *GetRate)(IMFPMediaPlayer *This,
                                      /* [annotation][out] */
                                      _Out_ float *pflRate);
  ...
  HRESULT(STDMETHODCALLTYPE *SetVolume)(IMFPMediaPlayer *This,
                                        /* [annotation][in] */
                                        _In_ float flVolume);
  ...
  HRESULT(STDMETHODCALLTYPE *GetMute)(IMFPMediaPlayer *This,
                                      /* [annotation][out] */
                                      _Out_ BOOL *pfMute);

  DECLSPEC_XFGVIRT(IMFPMediaPlayer, SetMute)
  HRESULT(STDMETHODCALLTYPE *SetMute)(IMFPMediaPlayer *This,
                                      /* [annotation][in] */
                                      _In_ BOOL fMute);
...
interface IMFPMediaPlayer { CONST_VTBL struct IMFPMediaPlayerVtbl *lpVtbl; };
...
typedef struct IMFPMediaItemVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(IMFPMediaItem *This,
                                             /* [in] */ REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);
  ...
  HRESULT(STDMETHODCALLTYPE *GetURL)(IMFPMediaItem *This,
                                     /* [annotation][out] */
  ...
  HRESULT(STDMETHODCALLTYPE *HasVideo)(IMFPMediaItem *This,
                                       /* [annotation][out] */
                                       _Out_opt_ BOOL *pfHasVideo,
                                       /* [annotation][out] */
  ...
  HRESULT(STDMETHODCALLTYPE *HasAudio)(IMFPMediaItem *This,
                                       /* [annotation][out] */
                                       _Out_opt_ BOOL *pfHasAudio,
                                       /* [annotation][out] */
                                       _Out_opt_ BOOL *pfSelected);
...
interface IMFPMediaItem { CONST_VTBL struct IMFPMediaItemVtbl *lpVtbl; };
