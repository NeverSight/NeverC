...
typedef interface IRandomAccessStreamFileAccessMode
...
typedef interface IUnbufferedFileHandleOplockCallback
...
#define IRandomAccessStreamFileAccessMode_QueryInterface(This, riid,           \
                                                         ppvObject)            \
...
typedef struct IUnbufferedFileHandleOplockCallbackVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(IUnbufferedFileHandleOplockCallback *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(IUnbufferedFileHandleOplockCallback *This);
...
#define IUnbufferedFileHandleOplockCallback_QueryInterface(This, riid,         \
                                                           ppvObject)          \
  ((This)->lpVtbl->QueryInterface(This, riid, ppvObject))
...
public:
  virtual HRESULT STDMETHODCALLTYPE OpenUnbufferedFileHandle(
      /* [in] */ __RPC__in_opt IUnbufferedFileHandleOplockCallback *
          oplockBreakCallback,
...
#define IUnbufferedFileHandleProvider_OpenUnbufferedFileHandle(                \
    This, oplockBreakCallback, fileHandle)                                     \
  ((This)->lpVtbl->OpenUnbufferedFileHandle(This, oplockBreakCallback,         \
                                            fileHandle))
...
typedef struct IOplockBreakingHandlerVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IOplockBreakingHandler *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IOplockBreakingHandler *This);
...
#define IOplockBreakingHandler_AddRef(This) ((This)->lpVtbl->AddRef(This))

#define IOplockBreakingHandler_Release(This) ((This)->lpVtbl->Release(This))
...
public:
  virtual HRESULT STDMETHODCALLTYPE Create(
      ...
      /* [optional][in] */ __RPC__in_opt IOplockBreakingHandler *
          oplockBreakingHandler,
      /* [system_handle][retval][out] */ __RPC__deref_out_opt HANDLE *
          interopHandle) = 0;
};
...
typedef struct IStorageItemHandleAccessVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IStorageItemHandleAccess *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IStorageItemHandleAccess *This);
...
#define IStorageItemHandleAccess_AddRef(This) ((This)->lpVtbl->AddRef(This))

#define IStorageItemHandleAccess_Release(This) ((This)->lpVtbl->Release(This))

#define IStorageItemHandleAccess_Create(This, accessOptions, sharingOptions,   \
                                        options, oplockBreakingHandler,        \
                                        interopHandle)                         \
  ((This)->lpVtbl->Create(This, accessOptions, sharingOptions, options,        \
                          oplockBreakingHandler, interopHandle))
...
typedef struct IStorageFolderHandleAccessVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IStorageFolderHandleAccess *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IStorageFolderHandleAccess *This);
...
#define IStorageFolderHandleAccess_AddRef(This) ((This)->lpVtbl->AddRef(This))

#define IStorageFolderHandleAccess_Release(This) ((This)->lpVtbl->Release(This))

#define IStorageFolderHandleAccess_Create(                                     \
    This, fileName, creationOptions, accessOptions, sharingOptions, options,   \
    oplockBreakingHandler, interopHandle)                                      \
  ((This)->lpVtbl->Create(This, fileName, creationOptions, accessOptions,      \
                          sharingOptions, options, oplockBreakingHandler,      \
                          interopHandle))
...
typedef struct IDDEInitializerVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in IDDEInitializer *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IDDEInitializer *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IDDEInitializer *This);
...
interface IDDEInitializer { CONST_VTBL struct IDDEInitializerVtbl *lpVtbl; };
...
#define IDDEInitializer_AddRef(This) ((This)->lpVtbl->AddRef(This))

#define IDDEInitializer_Release(This) ((This)->lpVtbl->Release(This))

#define IDDEInitializer_Initialize(This, fileExtensionOrProtocol, method,      \
                                   currentDirectory, execTarget, site,         \
                                   application, targetFile, arguments, verb)   \
  ((This)->lpVtbl->Initialize(This, fileExtensionOrProtocol, method,           \
                              currentDirectory, execTarget, site, application, \
                              targetFile, arguments, verb))
