...
HRESULT WINAPI SetInputScopes(HWND hwnd, const InputScope *pInputScopes,
                              UINT cInputScopes,
                              _In_reads_(cPhrases) PWSTR *ppszPhraseList,
                              UINT cPhrases, _In_opt_ PWSTR pszRegExp,
                              _In_opt_ PWSTR pszSRGS);
...
public:
  virtual HRESULT STDMETHODCALLTYPE GetInputScopes(
      /* [size_is][size_is][out] */ __RPC__deref_out_ecount_full_opt(*pcCount)
              InputScope *
          *pprgInputScopes,
...
typedef struct ITfInputScopeVtbl {
  ...
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in ITfInputScope *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in ITfInputScope *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in ITfInputScope *This);
...
interface ITfInputScope { CONST_VTBL struct ITfInputScopeVtbl *lpVtbl; };
...
typedef struct ITfInputScope2Vtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in ITfInputScope2 *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in ITfInputScope2 *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in ITfInputScope2 *This);
...
interface ITfInputScope2 { CONST_VTBL struct ITfInputScope2Vtbl *lpVtbl; };
