...
typedef interface IAppHostElementSchemaCollection
...
typedef interface IAppHostPropertySchemaCollection
...
typedef interface IAppHostConstantValueCollection
...
typedef struct IAppHostMethodExtensionVtbl {
  ...
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IAppHostMethodExtension *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IAppHostMethodExtension *This);
...
#define IAppHostMethodExtension_ProvideMethod(This, pMethod, pMethodInstance,  \
                                              pElement)                        \
...
typedef struct IAppHostPropertyExtensionVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IAppHostPropertyExtension *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IAppHostPropertyExtension *This);
...
#define IAppHostPropertyExtension_ProvideGetProperty(This, pElement,           \
                                                     pProperty)                \
...
typedef struct IAppHostElementExtensionVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IAppHostElementExtension *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IAppHostElementExtension *This);
...
public:
  virtual HRESULT STDMETHODCALLTYPE GetSiteNameFromSiteId(
      /* [in] */ DWORD dwSiteId,
      /* [string][retval][out] */ __RPC__deref_out_opt_string BSTR *
          pbstrSiteName) = 0;
  ...
  virtual HRESULT STDMETHODCALLTYPE GetSiteElementFromSiteId(
      /* [in] */ DWORD dwSiteId,
      /* [retval][out] */ __RPC__deref_out_opt IAppHostElement *
          *ppSiteElement) = 0;
  ...
  virtual HRESULT STDMETHODCALLTYPE MapPath(
      ...
      /* [out] */ __RPC__deref_out_opt IAppHostElement *
          *ppVirtualDirectoryElement,
      /* [out] */ __RPC__deref_out_opt IAppHostElement *
          *ppApplicationElement) = 0;
};
...
typedef struct IAppHostMappingExtensionVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IAppHostMappingExtension *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IAppHostMappingExtension *This);
...
#define IAppHostMappingExtension_GetSiteNameFromSiteId(This, dwSiteId,         \
                                                       pbstrSiteName)          \
  ((This)->lpVtbl->GetSiteNameFromSiteId(This, dwSiteId, pbstrSiteName))

#define IAppHostMappingExtension_GetSiteIdFromSiteName(This, bstrSiteName,     \
                                                       pdwSiteId)              \
  ((This)->lpVtbl->GetSiteIdFromSiteName(This, bstrSiteName, pdwSiteId))

#define IAppHostMappingExtension_GetSiteElementFromSiteId(This, dwSiteId,      \
                                                          ppSiteElement)       \
  ((This)->lpVtbl->GetSiteElementFromSiteId(This, dwSiteId, ppSiteElement))

#define IAppHostMappingExtension_MapPath(                                      \
    This, bstrSiteName, bstrVirtualPath, pbstrPhysicalPath,                    \
    ppVirtualDirectoryElement, ppApplicationElement)                           \
  ((This)->lpVtbl->MapPath(This, bstrSiteName, bstrVirtualPath,                \
                           pbstrPhysicalPath, ppVirtualDirectoryElement,       \
...
public:
  ...
  virtual /* [id][propget] */ HRESULT STDMETHODCALLTYPE get_Item(
      /* [in] */ VARIANT cIndex,
      /* [retval][out] */ __RPC__deref_out_opt IAppHostProperty *
          *ppProperty) = 0;
};
...
typedef struct IAppHostPropertyCollectionVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IAppHostPropertyCollection *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IAppHostPropertyCollection *This);
...
public:
  ...
  virtual /* [id][propget] */ HRESULT STDMETHODCALLTYPE get_Item(
      /* [in] */ VARIANT varIndex,
      /* [retval][out] */ __RPC__deref_out_opt IAppHostConfigLocation *
          *ppLocation) = 0;
...
#define IAppHostConfigLocationCollection_AddLocation(This, bstrLocationPath,   \
                                                     ppNewLocation)            \
...
#define IAppHostConfigLocationCollection_RenameLocation(This, varIndex,        \
                                                        bstrLocationPath)      \
...
typedef struct IAppHostMethodCollectionVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IAppHostMethodCollection *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IAppHostMethodCollection *This);
...
public:
  ...
  virtual /* [id][propget] */ HRESULT STDMETHODCALLTYPE get_Item(
      /* [in] */ VARIANT cIndex,
      /* [retval][out] */ __RPC__deref_out_opt IAppHostElementSchema *
          *ppElementSchema) = 0;
};
...
#define IAppHostElementSchemaCollection_get_Item(This, cIndex,                 \
                                                 ppElementSchema)              \
...
public:
  ...
  virtual /* [id][propget] */ HRESULT STDMETHODCALLTYPE get_Item(
      /* [in] */ VARIANT cIndex,
      /* [retval][out] */ __RPC__deref_out_opt IAppHostPropertySchema *
          *ppPropertySchema) = 0;
};
...
#define IAppHostPropertySchemaCollection_get_Item(This, cIndex,                \
                                                  ppPropertySchema)            \
...
public:
  ...
  virtual /* [id][propget] */ HRESULT STDMETHODCALLTYPE get_Item(
      /* [in] */ VARIANT cIndex,
      /* [retval][out] */ __RPC__deref_out_opt IAppHostConstantValue *
          *ppConstantValue) = 0;
};
...
#define IAppHostConstantValueCollection_get_Item(This, cIndex,                 \
                                                 ppConstantValue)              \
...
typedef struct IAppHostConstantValueVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IAppHostConstantValue *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IAppHostConstantValue *This);
...
public:
  virtual /* [propget] */ HRESULT STDMETHODCALLTYPE get_Name(
      /* [retval][string][out] */ __RPC__deref_out_opt_string BSTR *
      pbstrName) = 0;
  ...
  virtual /* [propget] */ HRESULT STDMETHODCALLTYPE get_PossibleValues(
      /* [retval][out] */ __RPC__deref_out_opt IAppHostConstantValueCollection *
      *ppValues) = 0;
...
typedef struct IAppHostPropertySchemaVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IAppHostPropertySchema *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IAppHostPropertySchema *This);
...
#define IAppHostPropertySchema_get_ValidationParameter(                        \
...
typedef struct IAppHostCollectionSchemaVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IAppHostCollectionSchema *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IAppHostCollectionSchema *This);
...
#define IAppHostCollectionSchema_GetAddElementSchema(This, bstrElementName,    \
                                                     ppSchema)                 \
...
#define IAppHostCollectionSchema_get_DoesAllowDuplicates(This,                 \
                                                         pfAllowDuplicates)    \
...
public:
  ...
  virtual /* [propget] */ HRESULT STDMETHODCALLTYPE
      get_DoesAllowUnschematizedProperties(
          /* [retval][out] */ __RPC__out VARIANT_BOOL *
          pfAllowUnschematized) = 0;
  ...
  virtual /* [propget] */ HRESULT STDMETHODCALLTYPE get_CollectionSchema(
      /* [retval][out] */ __RPC__deref_out_opt IAppHostCollectionSchema *
      *ppCollectionSchema) = 0;

  virtual /* [propget] */ HRESULT STDMETHODCALLTYPE get_ChildElementSchemas(
      /* [retval][out] */ __RPC__deref_out_opt IAppHostElementSchemaCollection *
      *ppChildSchemas) = 0;
...
typedef struct IAppHostElementSchemaVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IAppHostElementSchema *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IAppHostElementSchema *This);
  ...
  /* [propget] */ HRESULT(
      STDMETHODCALLTYPE *get_DoesAllowUnschematizedProperties)(
      __RPC__in IAppHostElementSchema *This,
  ...
  /* [propget] */ HRESULT(STDMETHODCALLTYPE *get_PropertySchemas)(
      __RPC__in IAppHostElementSchema *This,
      /* [retval][out] */ __RPC__deref_out_opt IAppHostPropertySchemaCollection
          **ppPropertySchemas);
...
#define IAppHostElementSchema_get_DoesAllowUnschematizedProperties(            \
    This, pfAllowUnschematized)                                                \
  ((This)->lpVtbl->get_DoesAllowUnschematizedProperties(This,                  \
...
#define IAppHostElementSchema_get_IsCollectionDefault(This,                    \
...
typedef struct IAppHostMethodSchemaVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IAppHostMethodSchema *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IAppHostMethodSchema *This);
...
typedef struct IAppHostMethodInstanceVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IAppHostMethodInstance *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IAppHostMethodInstance *This);
  ...
  HRESULT(STDMETHODCALLTYPE *Execute)(__RPC__in IAppHostMethodInstance *This);
...
public:
  ...
  virtual /* [propget] */ HRESULT STDMETHODCALLTYPE get_Schema(
      /* [retval][out] */ __RPC__deref_out_opt IAppHostMethodSchema *
      *ppMethodSchema) = 0;

  virtual HRESULT STDMETHODCALLTYPE CreateInstance(
      /* [retval][out] */ __RPC__deref_out_opt IAppHostMethodInstance *
      *ppMethodInstance) = 0;
};
...
typedef struct IAppHostMethodVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in IAppHostMethod *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IAppHostMethod *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IAppHostMethod *This);
...
interface IAppHostMethod { CONST_VTBL struct IAppHostMethodVtbl *lpVtbl; };
...
typedef struct IAppHostConfigExceptionVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IAppHostConfigException *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IAppHostConfigException *This);
...
public:
  ...
  virtual /* [propget] */ HRESULT STDMETHODCALLTYPE get_ValidationFailureReason(
      /* [retval][string][out] */ __RPC__deref_out_opt_string BSTR *
      pbstrValidationReason) = 0;

  virtual /* [propget] */ HRESULT STDMETHODCALLTYPE
      get_ValidationFailureParameters(
...
typedef struct IAppHostPropertyExceptionVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IAppHostPropertyException *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IAppHostPropertyException *This);
...
#define IAppHostPropertyException_get_ValidationFailureReason(                 \
    This, pbstrValidationReason)                                               \
  ((This)->lpVtbl->get_ValidationFailureReason(This, pbstrValidationReason))

#define IAppHostPropertyException_get_ValidationFailureParameters(             \
    This, pParameterArray)                                                     \
...
typedef struct IAppHostElementCollectionVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IAppHostElementCollection *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IAppHostElementCollection *This);
  ...
  HRESULT(STDMETHODCALLTYPE *Clear)(__RPC__in IAppHostElementCollection *This);
...
#define IAppHostElementCollection_CreateNewElement(This, bstrElementName,      \
                                                   ppElement)                  \
...
public:
  ...
  virtual /* [propget] */ HRESULT STDMETHODCALLTYPE get_Collection(
      /* [retval][out] */ __RPC__deref_out_opt IAppHostElementCollection *
      *ppCollection) = 0;

  virtual /* [propget] */ HRESULT STDMETHODCALLTYPE get_Properties(
      /* [retval][out] */ __RPC__deref_out_opt IAppHostPropertyCollection *
      *ppProperties) = 0;

  virtual /* [propget] */ HRESULT STDMETHODCALLTYPE get_ChildElements(
      /* [retval][out] */ __RPC__deref_out_opt IAppHostChildElementCollection *
      *ppElements) = 0;
  ...
  virtual /* [propget] */ HRESULT STDMETHODCALLTYPE get_Methods(
      /* [retval][out] */ __RPC__deref_out_opt IAppHostMethodCollection *
      *ppMethods) = 0;
};
...
typedef struct IAppHostElementVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in IAppHostElement *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IAppHostElement *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IAppHostElement *This);
  ...
  HRESULT(STDMETHODCALLTYPE *Clear)(__RPC__in IAppHostElement *This);
...
interface IAppHostElement { CONST_VTBL struct IAppHostElementVtbl *lpVtbl; };
...
public:
  ...
  virtual /* [propget] */ HRESULT STDMETHODCALLTYPE get_Exception(
      /* [retval][out] */ __RPC__deref_out_opt IAppHostPropertyException *
      *ppException) = 0;
...
typedef struct IAppHostPropertyVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in IAppHostProperty *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IAppHostProperty *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IAppHostProperty *This);
  ...
  HRESULT(STDMETHODCALLTYPE *Clear)(__RPC__in IAppHostProperty *This);
...
interface IAppHostProperty { CONST_VTBL struct IAppHostPropertyVtbl *lpVtbl; };
...
typedef struct IAppHostConfigLocationVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IAppHostConfigLocation *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IAppHostConfigLocation *This);
...
#define IAppHostConfigLocation_AddConfigSection(This, bstrSectionName,         \
                                                ppAdminElement)                \
...
typedef struct IAppHostSectionDefinitionVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IAppHostSectionDefinition *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IAppHostSectionDefinition *This);
...
#define IAppHostSectionDefinition_get_OverrideModeDefault(                     \
    This, pbstrOverrideModeDefault)                                            \
  ((This)->lpVtbl->get_OverrideModeDefault(This, pbstrOverrideModeDefault))

#define IAppHostSectionDefinition_put_OverrideModeDefault(                     \
    This, bstrOverrideModeDefault)                                             \
  ((This)->lpVtbl->put_OverrideModeDefault(This, bstrOverrideModeDefault))

#define IAppHostSectionDefinition_get_AllowDefinition(This,                    \
                                                      pbstrAllowDefinition)    \
  ((This)->lpVtbl->get_AllowDefinition(This, pbstrAllowDefinition))

#define IAppHostSectionDefinition_put_AllowDefinition(This,                    \
                                                      bstrAllowDefinition)     \
...
#define IAppHostSectionDefinition_get_RequirePermission(This,                  \
                                                        pfRequirePermission)   \
  ((This)->lpVtbl->get_RequirePermission(This, pfRequirePermission))

#define IAppHostSectionDefinition_put_RequirePermission(This,                  \
                                                        pfRequirePermission)   \
...
public:
  ...
  virtual /* [id][propget] */ HRESULT STDMETHODCALLTYPE get_Item(
      /* [in] */ VARIANT varIndex,
      /* [retval][out] */ __RPC__deref_out_opt IAppHostSectionDefinition *
          *ppConfigSection) = 0;
...
#define IAppHostSectionDefinitionCollection_QueryInterface(This, riid,         \
                                                           ppvObject)          \
  ((This)->lpVtbl->QueryInterface(This, riid, ppvObject))
...
#define IAppHostSectionDefinitionCollection_get_Item(This, varIndex,           \
                                                     ppConfigSection)          \
  ((This)->lpVtbl->get_Item(This, varIndex, ppConfigSection))

#define IAppHostSectionDefinitionCollection_AddSection(This, bstrSectionName,  \
                                                       ppConfigSection)        \
...
public:
  ...
  virtual /* [id][propget] */ HRESULT STDMETHODCALLTYPE get_Item(
      /* [in] */ VARIANT varIndex,
      /* [retval][out] */ __RPC__deref_out_opt IAppHostSectionGroup *
          *ppSectionGroup) = 0;

  virtual /* [propget] */ HRESULT STDMETHODCALLTYPE get_Sections(
      /* [retval][out] */
      __RPC__deref_out_opt IAppHostSectionDefinitionCollection *
      *ppSections) = 0;
...
typedef struct IAppHostSectionGroupVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IAppHostSectionGroup *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IAppHostSectionGroup *This);
...
#define IAppHostSectionGroup_AddSectionGroup(This, bstrSectionGroupName,       \
                                             ppSectionGroup)                   \
...
public:
  ...
  virtual /* [propget] */ HRESULT STDMETHODCALLTYPE get_Locations(
      /* [retval][out] */
      __RPC__deref_out_opt IAppHostConfigLocationCollection * *ppLocations) = 0;
...
typedef struct IAppHostConfigFileVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in IAppHostConfigFile *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IAppHostConfigFile *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IAppHostConfigFile *This);
  ...
  /* [propget] */ HRESULT(STDMETHODCALLTYPE *get_Locations)(
      __RPC__in IAppHostConfigFile *This,
      /* [retval][out] */ __RPC__deref_out_opt IAppHostConfigLocationCollection
          **ppLocations);
...
#define IAppHostConfigFile_GetAdminSection(This, bstrSectionName, bstrPath,    \
                                           ppAdminSection)                     \
  ((This)->lpVtbl->GetAdminSection(This, bstrSectionName, bstrPath,            \
                                   ppAdminSection))
...
typedef struct IAppHostPathMapperVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in IAppHostPathMapper *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IAppHostPathMapper *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IAppHostPathMapper *This);
...
#define IAppHostPathMapper_MapPath(                                            \
    This, bstrConfigPath, bstrMappedPhysicalPath, pbstrNewPhysicalPath)        \
  ((This)->lpVtbl->MapPath(This, bstrConfigPath, bstrMappedPhysicalPath,       \
...
typedef struct IAppHostPathMapper2Vtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(IAppHostPathMapper2 *This,
                                             /* [in] */ REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);
...
#define IAppHostPathMapper2_MapPath(                                           \
    This, bstrConfigPath, bstrMappedPhysicalPath, pbstrNewPhysicalPath,        \
    phImpersonationToken)                                                      \
  ((This)->lpVtbl->MapPath(This, bstrConfigPath, bstrMappedPhysicalPath,       \
                           pbstrNewPhysicalPath, phImpersonationToken))
...
typedef struct IAppHostChangeHandlerVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IAppHostChangeHandler *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IAppHostChangeHandler *This);
...
#define IAppHostChangeHandler_OnSectionChanges(This, bstrSectionName,          \
                                               bstrConfigPath)                 \
...
public:
  ...
  virtual /* [propget] */ HRESULT STDMETHODCALLTYPE get_ConfigManager(
      /* [retval][out] */ __RPC__deref_out_opt IAppHostConfigManager *
      *ppConfigManager) = 0;
};
...
typedef struct IAppHostAdminManagerVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IAppHostAdminManager *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IAppHostAdminManager *This);
...
#define IAppHostAdminManager_GetAdminSection(This, bstrSectionName, bstrPath,  \
                                             ppAdminSection)                   \
  ((This)->lpVtbl->GetAdminSection(This, bstrSectionName, bstrPath,            \
                                   ppAdminSection))
...
#define IAppHostWritableAdminManager_GetAdminSection(This, bstrSectionName,    \
                                                     bstrPath, ppAdminSection) \
  ((This)->lpVtbl->GetAdminSection(This, bstrSectionName, bstrPath,            \
                                   ppAdminSection))

#define IAppHostWritableAdminManager_GetMetadata(This, bstrMetadataType,       \
                                                 pValue)                       \
  ((This)->lpVtbl->GetMetadata(This, bstrMetadataType, pValue))

#define IAppHostWritableAdminManager_SetMetadata(This, bstrMetadataType,       \
                                                 value)                        \
  ((This)->lpVtbl->SetMetadata(This, bstrMetadataType, value))
...
public:
  virtual HRESULT STDMETHODCALLTYPE GetConfigFile(
      /* [string][in] */ __RPC__in_string BSTR bstrConfigPath,
      /* [retval][out] */ __RPC__deref_out_opt IAppHostConfigFile *
          *ppConfigFile) = 0;
...
typedef struct IAppHostConfigManagerVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IAppHostConfigManager *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IAppHostConfigManager *This);
...
#define IAppHostConfigManager_GetConfigFile(This, bstrConfigPath,              \
                                            ppConfigFile)                      \
...
class DECLSPEC_UUID("228fb8f7-fb53-4fd5-8c7b-ff59de606c5b") AppHostAdminManager;
#endif
