...
// MessageText:
//
// The catalog is in a state where indexing continues, but queries are not
// allowed.
//
...
// MessageText:
//
// Weight must be between 0 and 1000 in short form queries and between 0.0
// and 1.0 in long form queries.
//
...
// MessageText:
//
// Wordlist has reached maximum size.  Additional documents should not be
// filtered.
//
...
// MessageText:
//
// The system is running out of one of more resources needed for filtering,
// usually memory.
//
...
// MessageText:
//
// A critical error occurred during document filtering.  Consult system
// administrator.
//
...
// MessageText:
//
// Retrival of hits as filter regions is not supported (by filter passed into
// Init).
//
...
// MessageText:
//
// A partial content scan of the disk needs to be scheduled for immediate
// execution.
//
...
// MessageText:
//
// A full content scan of the disk needs to be scheduled for immediate
// execution.
//
...
// MessageText:
//
// The content index is corrupt. A content scan will to be scheduled after
...
// MessageText:
//
// The document was too large to filter in its entirety.  Portions of the
// document were not emitted.
//
