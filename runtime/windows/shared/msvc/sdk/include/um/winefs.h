...
DWORD
WINAPI
QueryUsersOnEncryptedFile(_In_ LPCWSTR lpFileName,
...
DWORD
WINAPI
RemoveUsersFromEncryptedFile(_In_ LPCWSTR lpFileName,
                             _In_ PENCRYPTION_CERTIFICATE_HASH_LIST pHashes);

WINADVAPI
DWORD
WINAPI
AddUsersToEncryptedFile(_In_ LPCWSTR lpFileName,
                        _In_ PENCRYPTION_CERTIFICATE_LIST
...
DWORD
WINAPI
SetUserFileEncryptionKey(_In_ PENCRYPTION_CERTIFICATE pEncryptionCertificate);
...
SetUserFileEncryptionKeyEx(
    _In_opt_ PENCRYPTION_CERTIFICATE pEncryptionCertificate,
    DWORD dwCapabilities, DWORD dwFlags, _Reserved_ LPVOID pvReserved);
...
WINADVAPI
BOOL WINAPI EncryptionDisable(_In_ LPCWSTR DirPath, BOOL Disable);
...
DWORD
WINAPI
DuplicateEncryptionInfoFile(_In_ LPCWSTR SrcFileName, _In_ LPCWSTR DstFileName,
                            DWORD dwCreationDistribution, DWORD dwAttributes,
                            _In_opt_ CONST LPSECURITY_ATTRIBUTES
...
__declspec(deprecated) WINADVAPI DWORD WINAPI GetEncryptedFileMetadata(
    _In_ LPCWSTR lpFileName, _Out_ PDWORD pcbMetadata,
    _Outptr_result_bytebuffer_(*pcbMetadata) PBYTE *ppbMetadata);

__declspec(deprecated) WINADVAPI DWORD WINAPI SetEncryptedFileMetadata(
    _In_ LPCWSTR lpFileName, _In_opt_ PBYTE pbOldMetadata,
    _In_ PBYTE pbNewMetadata, _In_ PENCRYPTION_CERTIFICATE_HASH pOwnerHash,
    DWORD dwOperation,
    _In_opt_ PENCRYPTION_CERTIFICATE_HASH_LIST pCertificatesAdded);

__declspec(deprecated) WINADVAPI VOID WINAPI
FreeEncryptedFileMetadata(_In_ PBYTE pbMetadata);
