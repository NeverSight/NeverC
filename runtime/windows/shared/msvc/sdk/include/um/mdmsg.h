...
// MessageText:
//
// A specified metaobject path was not found. The metaobject and associated
...
// MessageText:
//
// A secure communications channel could not be established with the target
// server.
//
...
// MessageText:
//
// The path was not inserted into the string as requested. The probable cause is
// that the data is at an object at a higher level than the handle.
//
...
// MessageText:
//
// The METADATA_SECURE attribute cannot be removed from a data item via the
...
// MessageText:
//
// The metadata save prior to backup failed. The previous version of the data
// was backed up.
//
...
// MessageText:
//
// The schema information could not be loaded. A required key or property is
// missing from the metabase.
//
