...
public:
  ...
  static HRESULT CreateTerminal(IN CComPtr<IMoniker> pMoniker,
...
public:
  ...
  STDMETHODIMP DisconnectTerminal(IN IGraphBuilder *pGraph,
                                  IN DWORD dwReserved);
...
private:
  bool m_bResourceReserved; // keeps track of whether we need to unreserve
                            // WaveOut
