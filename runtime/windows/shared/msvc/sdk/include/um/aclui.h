...
#define SI_RESET                                                               \
  0x00000020L // equals to SI_RESET_DACL|SI_RESET_SACL|SI_RESET_OWNER
...
DECLARE_INTERFACE_IID_(ISecurityInformation2, IUnknown,
  ...
  STDMETHOD(LookupSids)(THIS_ IN ULONG cSids, IN PSID * rgpSids,
                        OUT LPDATAOBJECT * ppdo) PURE;
};
...
DECLARE_INTERFACE_IID_(ISecurityInformation3, IUnknown,
  ...
  STDMETHOD(OpenElevatedEditor)(THIS_ _In_ HWND hWnd, _In_ SI_PAGE_TYPE uPage)
      PURE;
};
...
typedef struct _EFFPERM_RESULT_LIST {
  ...
  _Field_size_(cObjectTypeListLength) OBJECT_TYPE_LIST *pObjectTypeList;
  _Field_size_(cObjectTypeListLength) ACCESS_MASK *pGrantedAccessList;
...
DECLARE_INTERFACE_IID_(ISecurityInformation4, IUnknown,
  ...
  STDMETHOD(GetSecondarySecurity)(
      THIS_ _Outptr_result_buffer_(*pSecurityObjectCount) PSECURITY_OBJECT *
          pSecurityObjects,
...
DECLARE_INTERFACE_IID_(IEffectivePermission2, IUnknown,
  ...
  STDMETHOD(ComputeEffectivePermissionWithSecondarySecurity)(
      THIS_ _In_ PSID pSid, _In_opt_ PSID pDeviceSid, _In_ PCWSTR pszServerName,
      _Inout_updates_(dwSecurityObjectCount) PSECURITY_OBJECT pSecurityObjects,
      _In_ DWORD dwSecurityObjectCount, _In_opt_ PTOKEN_GROUPS pUserGroups,
      _When_(pUserGroups != NULL &&
                 *pAuthzUserGroupsOperations != AUTHZ_SID_OPERATION_REPLACE_ALL,
             _In_reads_(pUserGroups->GroupCount))
          _In_opt_ PAUTHZ_SID_OPERATION pAuthzUserGroupsOperations,
      _In_opt_ PTOKEN_GROUPS pDeviceGroups,
      _When_(pDeviceGroups != NULL && *pAuthzDeviceGroupsOperations !=
                                          AUTHZ_SID_OPERATION_REPLACE_ALL,
             _In_reads_(pDeviceGroups->GroupCount))
...
BOOL ACLUIAPI EditSecurity(_In_ HWND hwndOwner, _In_ LPSECURITYINFO psi);
