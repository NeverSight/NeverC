...
typedef struct IFsrmReportManagerVtbl {
  ...
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in IFsrmReportManager *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IFsrmReportManager *This);
...
typedef struct IFsrmReportJobVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in IFsrmReportJob *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IFsrmReportJob *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IFsrmReportJob *This);
  ...
  /* [helpstring][id][propget] */ HRESULT(
      STDMETHODCALLTYPE *get_LastGeneratedInDirectory)(
      __RPC__in IFsrmReportJob *This,
      /* [retval][out] */ __RPC__deref_out_opt BSTR *path);
...
interface IFsrmReportJob { CONST_VTBL struct IFsrmReportJobVtbl *lpVtbl; };
...
typedef struct IFsrmReportVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in IFsrmReport *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IFsrmReport *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IFsrmReport *This);
  ...
  /* [helpstring][id][propget] */ HRESULT(
      STDMETHODCALLTYPE *get_LastGeneratedFileNamePrefix)(
      __RPC__in IFsrmReport *This,
...
interface IFsrmReport { CONST_VTBL struct IFsrmReportVtbl *lpVtbl; };
...
typedef struct IFsrmReportSchedulerVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IFsrmReportScheduler *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IFsrmReportScheduler *This);
...
public:
  ...
  EnumFileManagementJobs(
      /* [defaultvalue][in] */ FsrmEnumOptions options,
      /* [retval][out] */ __RPC__deref_out_opt IFsrmCollection *
          *fileManagementJobs) = 0;

  virtual /* [helpstring][id] */ HRESULT STDMETHODCALLTYPE
      CreateFileManagementJob(
          /* [retval][out] */ __RPC__deref_out_opt IFsrmFileManagementJob *
          *fileManagementJob) = 0;
...
typedef struct IFsrmFileManagementJobManagerVtbl {
  ...
  /* [helpstring][id][propget] */ HRESULT(
      STDMETHODCALLTYPE *get_ActionVariables)(
      __RPC__in IFsrmFileManagementJobManager *This,
      /* [retval][out] */ __RPC__deref_out_opt SAFEARRAY **variables);

  DECLSPEC_XFGVIRT(IFsrmFileManagementJobManager,
                   get_ActionVariableDescriptions)
  /* [helpstring][id][propget] */ HRESULT(
...
public:
  ...
  virtual /* [helpstring][id][propget] */ HRESULT STDMETHODCALLTYPE
      get_OperationType(
          /* [retval][out] */ __RPC__out FsrmFileManagementType *
          operationType) = 0;
  ...
  virtual /* [helpstring][id][propget] */ HRESULT STDMETHODCALLTYPE
      get_CustomAction(
          /* [retval][out] */ __RPC__deref_out_opt IFsrmActionCommand *
          *action) = 0;
  ...
  CreatePropertyCondition(
      /* [in] */ __RPC__in BSTR name,
      /* [retval][out] */ __RPC__deref_out_opt IFsrmPropertyCondition *
          *propertyCondition) = 0;
...
typedef struct IFsrmFileManagementJobVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IFsrmFileManagementJob *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IFsrmFileManagementJob *This);
  ...
  /* [helpstring][id][propget] */ HRESULT(
      STDMETHODCALLTYPE *get_LastReportPathWithoutExtension)(
      __RPC__in IFsrmFileManagementJob *This,
      /* [retval][out] */ __RPC__deref_out_opt BSTR *path);
...
typedef struct IFsrmPropertyConditionVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IFsrmPropertyCondition *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IFsrmPropertyCondition *This);
...
typedef struct IFsrmFileConditionVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in IFsrmFileCondition *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IFsrmFileCondition *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IFsrmFileCondition *This);
...
typedef struct IFsrmFileConditionPropertyVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IFsrmFileConditionProperty *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IFsrmFileConditionProperty *This);
