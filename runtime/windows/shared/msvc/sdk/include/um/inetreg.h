...
// setting to indicate whether or not IEAK launched this instance of inetcpl so
// extra info can be exposed reg key: HKCU\Software\Policies\Microsoft\Internet
...
#define REGSTR_VAL_TRUSTWARNINGLEVEL                                           \
  TEXT(SZTRUSTWARNLEVEL) //"none" will turn off WinVerifyTrust warnings.
...
#define REGSTR_VAL_SECURITYWARNONSENDALWAYS_TYPE                               \
  REG_BINARY // FALSE-Only if... TRUE-Always
...
#define REGSTR_PATH_QUICKCOMPLETE                                              \
  REGSTR_PATH_TOOLBAR TEXT("\\") TEXT("QuickComplete")
...
#define TSZINTERNETCLIENTSPATH                                                 \
  TEXT("Software\\Microsoft\\Internet Explorer\\Unix")
...
#define REGSTR_PATH_VSOURCECLIENTS                                             \
  TSZINTERNETCLIENTSPATH TEXT("\\VSourceCommand")
...
#define IE_USE_OE_PRESENT_KEY                                                  \
  TEXT("Software\\Microsoft\\Windows\\CurrentVersion\\app.paths\\msimn.exe")
...
#define REGSTR_VAL_FONT_SCRIPT_TYPE                                            \
  REG_SZ // friendly name of font if other than system
         // no default
...
#define REGSTR_VAL_DEF_ENCODING_TYPE                                           \
  REG_SZ // internal MIME table name
         // no default
...
#define REGSTR_VAL_FIXED_FONT_TYPE                                             \
  REG_SZ // must match a registered font name
         // no default

#define REGSTR_VAL_SCRIPT_FIXED_FONT TEXT("IEFixedFontName")
#define REGSTR_VAL_SCRIPT_FIXED_FONT_TYPE                                      \
  REG_SZ // must match a registered font name
         // no default

#define REGSTR_VAL_PROP_FONT TEXT("IEPropFontName")
#define REGSTR_VAL_PROP_FONT_TYPE                                              \
  REG_SZ // must match a registered font name
         // no default

#define REGSTR_VAL_SCRIPT_PROP_FONT TEXT("IEPropFontName")
#define REGSTR_VAL_SCRIPT_PROP_FONT_TYPE                                       \
  REG_SZ // must match a registered font name
         // no default
