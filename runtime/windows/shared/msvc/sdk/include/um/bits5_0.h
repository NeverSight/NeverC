...
#define BITS_COST_STATE_TRANSFER_NO_SURCHARGE                                  \
  (BITS_COST_OPTION_IGNORE_CONGESTION | BITS_COST_STATE_USAGE_BASED |          \
...
#define BITS_COST_STATE_TRANSFER_STANDARD                                      \
  (BITS_COST_OPTION_IGNORE_CONGESTION | BITS_COST_STATE_USAGE_BASED |          \
   BITS_COST_STATE_OVERCAP_THROTTLED | BITS_COST_STATE_BELOW_CAP |             \
   BITS_COST_STATE_CAPPED_USAGE_UNKNOWN | BITS_COST_STATE_UNRESTRICTED)
#define BITS_COST_STATE_TRANSFER_UNRESTRICTED                                  \
  (BITS_COST_OPTION_IGNORE_CONGESTION | BITS_COST_STATE_OVERCAP_THROTTLED |    \
   BITS_COST_STATE_UNRESTRICTED)
#define BITS_COST_STATE_TRANSFER_ALWAYS                                        \
  (BITS_COST_OPTION_IGNORE_CONGESTION | BITS_COST_STATE_ROAMING |              \
...
typedef /* [public][public][public][switch_type] */
    union __MIDL___MIDL_itf_bits5_0_0000_0000_0001 {
  /* [case()] */ DWORD Dword;
  /* [case()] */ GUID ClsID;
  /* [case()] */ BOOL Enable;
  /* [case()] */ UINT64 Uint64;
...
typedef /* [public][public][public][switch_type] */
    union __MIDL___MIDL_itf_bits5_0_0000_0000_0002 {
  /* [case()] */ LPWSTR String;
...
public:
  ...
  virtual HRESULT STDMETHODCALLTYPE GetProperty(
      /* [in] */ BITS_JOB_PROPERTY_ID PropertyId,
      /* [switch_is][out] */ __RPC__out BITS_JOB_PROPERTY_VALUE *
          PropertyValue) = 0;
};
...
typedef struct IBackgroundCopyJob5Vtbl {
  ...
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IBackgroundCopyJob5 *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IBackgroundCopyJob5 *This);

  DECLSPEC_XFGVIRT(IBackgroundCopyJob, AddFileSet)
  HRESULT(STDMETHODCALLTYPE *AddFileSet)(__RPC__in IBackgroundCopyJob5 *This,
                                         /* [in] */ ULONG cFileCount,
                                         /* [size_is][in] */
  ...
  HRESULT(STDMETHODCALLTYPE *AddFile)(__RPC__in IBackgroundCopyJob5 *This,
  ...
  HRESULT(STDMETHODCALLTYPE *Suspend)(__RPC__in IBackgroundCopyJob5 *This);

  DECLSPEC_XFGVIRT(IBackgroundCopyJob, Resume)
  HRESULT(STDMETHODCALLTYPE *Resume)(__RPC__in IBackgroundCopyJob5 *This);

  DECLSPEC_XFGVIRT(IBackgroundCopyJob, Cancel)
  HRESULT(STDMETHODCALLTYPE *Cancel)(__RPC__in IBackgroundCopyJob5 *This);

  DECLSPEC_XFGVIRT(IBackgroundCopyJob, Complete)
  HRESULT(STDMETHODCALLTYPE *Complete)(__RPC__in IBackgroundCopyJob5 *This);

  DECLSPEC_XFGVIRT(IBackgroundCopyJob, GetId)
  HRESULT(STDMETHODCALLTYPE *GetId)(__RPC__in IBackgroundCopyJob5 *This,
                                    /* [out] */ __RPC__out GUID *pVal);

  DECLSPEC_XFGVIRT(IBackgroundCopyJob, GetType)
  HRESULT(STDMETHODCALLTYPE *GetType)(__RPC__in IBackgroundCopyJob5 *This,
  ...
  HRESULT(STDMETHODCALLTYPE *SetPriority)(__RPC__in IBackgroundCopyJob5 *This,
  ...
  HRESULT(STDMETHODCALLTYPE *RemoveCredentials)(
      __RPC__in IBackgroundCopyJob5 *This, BG_AUTH_TARGET Target,
  ...
  HRESULT(STDMETHODCALLTYPE *SetPeerCachingFlags)(
      __RPC__in IBackgroundCopyJob5 *This, DWORD Flags);
  ...
  HRESULT(STDMETHODCALLTYPE *SetMaximumDownloadTime)(
      __RPC__in IBackgroundCopyJob5 *This, ULONG Timeout);
...
public:
  ...
  virtual HRESULT STDMETHODCALLTYPE GetProperty(
      /* [in] */ BITS_FILE_PROPERTY_ID PropertyId,
      /* [switch_is][out] */ __RPC__out BITS_FILE_PROPERTY_VALUE *
          PropertyValue) = 0;
};
...
typedef struct IBackgroundCopyFile5Vtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IBackgroundCopyFile5 *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IBackgroundCopyFile5 *This);
  ...
  HRESULT(STDMETHODCALLTYPE *SetRemoteName)(
      __RPC__in IBackgroundCopyFile5 *This, __RPC__in LPCWSTR Val);
...
#define IBackgroundCopyFile5_GetPeerDownloadStats(This, pFromOrigin,           \
                                                  pFromPeers)                  \
