...
#define UPNP_E_REQUIRED_ELEMENT_ERROR                                          \
  MAKE_HRESULT(SEVERITY_ERROR, FACILITY_ITF, 0xA020)
#define UPNP_E_DUPLICATE_NOT_ALLOWED                                           \
  MAKE_HRESULT(SEVERITY_ERROR, FACILITY_ITF, 0xA021)
#define UPNP_E_DUPLICATE_SERVICE_ID                                            \
  MAKE_HRESULT(SEVERITY_ERROR, FACILITY_ITF, 0xA022)
#define UPNP_E_INVALID_DESCRIPTION                                             \
  MAKE_HRESULT(SEVERITY_ERROR, FACILITY_ITF, 0xA023)
...
#define UPNP_E_INVALID_ROOT_NAMESPACE                                          \
  MAKE_HRESULT(SEVERITY_ERROR, FACILITY_ITF, 0xA027)
#define UPNP_E_SUFFIX_TOO_LONG                                                 \
  MAKE_HRESULT(SEVERITY_ERROR, FACILITY_ITF, 0xA028)
#define UPNP_E_URLBASE_PRESENT                                                 \
...
#define UPNP_E_DEVICE_NOTREGISTERED                                            \
  MAKE_HRESULT(SEVERITY_ERROR, FACILITY_ITF, 0xA032)
...
public:
  virtual /* [hidden][helpstring] */ HRESULT STDMETHODCALLTYPE OnStateChanged(
      /* [in] */ DWORD cChanges,
      /* [size_is][in] */ __RPC__in_ecount_full(cChanges)
          DISPID rgdispidChanges[]) = 0;
...
typedef struct IUPnPEventSinkVtbl {
  ...
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in IUPnPEventSink *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IUPnPEventSink *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IUPnPEventSink *This);
...
interface IUPnPEventSink { CONST_VTBL struct IUPnPEventSinkVtbl *lpVtbl; };
...
typedef struct IUPnPEventSourceVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in IUPnPEventSource *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IUPnPEventSource *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IUPnPEventSource *This);
...
interface IUPnPEventSource { CONST_VTBL struct IUPnPEventSourceVtbl *lpVtbl; };
...
typedef struct IUPnPRegistrarVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in IUPnPRegistrar *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IUPnPRegistrar *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IUPnPRegistrar *This);
...
interface IUPnPRegistrar { CONST_VTBL struct IUPnPRegistrarVtbl *lpVtbl; };
...
#define IUPnPRegistrar_RegisterDevice(                                         \
    This, bstrXMLDesc, bstrProgIDDeviceControlClass, bstrInitString,           \
    bstrContainerId, bstrResourcePath, nLifeTime, pbstrDeviceIdentifier)       \
  ((This)->lpVtbl->RegisterDevice(                                             \
      This, bstrXMLDesc, bstrProgIDDeviceControlClass, bstrInitString,         \
      bstrContainerId, bstrResourcePath, nLifeTime, pbstrDeviceIdentifier))

#define IUPnPRegistrar_RegisterRunningDevice(                                  \
    This, bstrXMLDesc, punkDeviceControl, bstrInitString, bstrResourcePath,    \
    nLifeTime, pbstrDeviceIdentifier)                                          \
  ((This)->lpVtbl->RegisterRunningDevice(This, bstrXMLDesc, punkDeviceControl, \
                                         bstrInitString, bstrResourcePath,     \
                                         nLifeTime, pbstrDeviceIdentifier))

#define IUPnPRegistrar_RegisterDeviceProvider(This, bstrProviderName,          \
                                              bstrProgIDProviderClass,         \
                                              bstrInitString, bstrContainerId) \
  ((This)->lpVtbl->RegisterDeviceProvider(This, bstrProviderName,              \
                                          bstrProgIDProviderClass,             \
                                          bstrInitString, bstrContainerId))

#define IUPnPRegistrar_GetUniqueDeviceName(This, bstrDeviceIdentifier,         \
                                           bstrTemplateUDN, pbstrUDN)          \
  ((This)->lpVtbl->GetUniqueDeviceName(This, bstrDeviceIdentifier,             \
                                       bstrTemplateUDN, pbstrUDN))

#define IUPnPRegistrar_UnregisterDevice(This, bstrDeviceIdentifier,            \
                                        fPermanent)                            \
...
typedef struct IUPnPReregistrarVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in IUPnPReregistrar *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IUPnPReregistrar *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IUPnPReregistrar *This);
...
interface IUPnPReregistrar { CONST_VTBL struct IUPnPReregistrarVtbl *lpVtbl; };
...
#define IUPnPReregistrar_ReregisterDevice(                                     \
    This, bstrDeviceIdentifier, bstrXMLDesc, bstrProgIDDeviceControlClass,     \
    bstrInitString, bstrContainerId, bstrResourcePath, nLifeTime)              \
  ((This)->lpVtbl->ReregisterDevice(                                           \
      This, bstrDeviceIdentifier, bstrXMLDesc, bstrProgIDDeviceControlClass,   \
      bstrInitString, bstrContainerId, bstrResourcePath, nLifeTime))

#define IUPnPReregistrar_ReregisterRunningDevice(                              \
    This, bstrDeviceIdentifier, bstrXMLDesc, punkDeviceControl,                \
    bstrInitString, bstrResourcePath, nLifeTime)                               \
  ((This)->lpVtbl->ReregisterRunningDevice(                                    \
      This, bstrDeviceIdentifier, bstrXMLDesc, punkDeviceControl,              \
      bstrInitString, bstrResourcePath, nLifeTime))
...
typedef struct IUPnPDeviceControlVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in IUPnPDeviceControl *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IUPnPDeviceControl *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IUPnPDeviceControl *This);
...
#define IUPnPDeviceControl_Initialize(This, bstrXMLDesc, bstrDeviceIdentifier, \
                                      bstrInitString)                          \
  ((This)->lpVtbl->Initialize(This, bstrXMLDesc, bstrDeviceIdentifier,         \
                              bstrInitString))

#define IUPnPDeviceControl_GetServiceObject(This, bstrUDN, bstrServiceId,      \
                                            ppdispService)                     \
  ((This)->lpVtbl->GetServiceObject(This, bstrUDN, bstrServiceId,              \
                                    ppdispService))
...
#define IUPnPDeviceControlHttpHeaders_GetAdditionalResponseHeaders(            \
    This, bstrHttpResponseHeaders)                                             \
...
typedef struct IUPnPDeviceProviderVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IUPnPDeviceProvider *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IUPnPDeviceProvider *This);

  DECLSPEC_XFGVIRT(IUPnPDeviceProvider, Start)
  HRESULT(STDMETHODCALLTYPE *Start)(__RPC__in IUPnPDeviceProvider *This,
                                    /* [in] */ __RPC__in BSTR bstrInitString);

  DECLSPEC_XFGVIRT(IUPnPDeviceProvider, Stop)
  HRESULT(STDMETHODCALLTYPE *Stop)(__RPC__in IUPnPDeviceProvider *This);
...
typedef struct IUPnPRemoteEndpointInfoVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IUPnPRemoteEndpointInfo *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IUPnPRemoteEndpointInfo *This);
...
#define IUPnPRemoteEndpointInfo_GetStringValue(This, bstrValueName,            \
                                               pbstrValue)                     \
...
class DECLSPEC_UUID("204810b9-73b2-11d4-bf42-00b0d0118b56") UPnPRegistrar;
#endif
