...
// MessageText:
//
// An invalid name request was made.  The name requested cannot be retrieved at
// this time.
//
...
// MessageText:
//
// The name requested was not found in Filter Manager's name cache and could not
