...
typedef interface IWICPlanarBitmapSourceTransform
...
typedef interface IWICBitmapCodecProgressNotification
...
DEFINE_GUID(CLSID_WICJpegXLDecoder, 0xfc6ceece, 0xaef5, 0x4a23, 0x96, 0xec,
            0x59, 0x84, 0xff, 0xb4, 0x86, 0xd9);
DEFINE_GUID(CLSID_WICJpegXLEncoder, 0x0e4ecd3b, 0x1ba6, 0x4636, 0x81, 0x98,
            0x56, 0xc7, 0x30, 0x40, 0x96, 0x4a);
...
DEFINE_GUID(GUID_ContainerFormatJpegXL, 0xfec14e3f, 0x427a, 0x4736, 0xaa, 0xe6,
            0x27, 0xed, 0x84, 0xf6, 0x93, 0x22);
...
DEFINE_GUID(GUID_WICPixelFormat8bppDepth, 0x4c9c9f45, 0x1d89, 0x4e31, 0x9b,
            0xc7, 0x69, 0x34, 0x3a, 0x0d, 0xca, 0x69);
DEFINE_GUID(GUID_WICPixelFormat8bppGain, 0xa884022a, 0xaf13, 0x4c16, 0xb7, 0x46,
            0x61, 0x9b, 0xf6, 0x18, 0xb8, 0x78);
DEFINE_GUID(GUID_WICPixelFormat24bppRGBGain, 0xa5022b24, 0x7109, 0x443b, 0x99,
            0x48, 0x25, 0xb6, 0xed, 0x8f, 0x39, 0xfd);
DEFINE_GUID(GUID_WICPixelFormat32bppBGRGain, 0x837d6738, 0x208a, 0x43e0, 0x89,
            0x95, 0x79, 0xab, 0x74, 0x40, 0x74, 0x02);
...
typedef struct IWICPaletteVtbl {
  ...
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in IWICPalette *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IWICPalette *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IWICPalette *This);
  ...
  HRESULT(STDMETHODCALLTYPE *HasAlpha)(__RPC__in IWICPalette *This,
                                       /* [out] */ __RPC__out BOOL *pfHasAlpha);

  END_INTERFACE
} IWICPaletteVtbl;

interface IWICPalette { CONST_VTBL struct IWICPaletteVtbl *lpVtbl; };
...
#define IWICPalette_InitializePredefined(This, ePaletteType,                   \
  ...
  ((This)->lpVtbl->InitializePredefined(This, ePaletteType,                    \
                                        fAddTransparentColor))

#define IWICPalette_InitializeCustom(This, pColors, cCount)                    \
  ((This)->lpVtbl->InitializeCustom(This, pColors, cCount))

#define IWICPalette_InitializeFromBitmap(This, pISurface, cCount,              \
                                         fAddTransparentColor)                 \
  ((This)->lpVtbl->InitializeFromBitmap(This, pISurface, cCount,               \
                                        fAddTransparentColor))
...
public:
  ...
  virtual HRESULT STDMETHODCALLTYPE CopyPixels(
      ...
      /* [size_is][out] */
      __RPC__out_ecount_full(cbBufferSize) BYTE *pbBuffer) = 0;
};
...
typedef struct IWICBitmapSourceVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in IWICBitmapSource *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IWICBitmapSource *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IWICBitmapSource *This);

  DECLSPEC_XFGVIRT(IWICBitmapSource, GetSize)
  HRESULT(STDMETHODCALLTYPE *GetSize)(__RPC__in IWICBitmapSource *This,
                                      /* [out] */ __RPC__out UINT *puiWidth,
...
interface IWICBitmapSource { CONST_VTBL struct IWICBitmapSourceVtbl *lpVtbl; };
...
typedef struct IWICFormatConverterVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IWICFormatConverter *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IWICFormatConverter *This);

  DECLSPEC_XFGVIRT(IWICBitmapSource, GetSize)
  HRESULT(STDMETHODCALLTYPE *GetSize)(__RPC__in IWICFormatConverter *This,
                                      /* [out] */ __RPC__out UINT *puiWidth,
                                      /* [out] */ __RPC__out UINT *puiHeight);
...
#define IWICFormatConverter_CanConvert(This, srcPixelFormat, dstPixelFormat,   \
                                       pfCanConvert)                           \
  ((This)->lpVtbl->CanConvert(This, srcPixelFormat, dstPixelFormat,            \
                              pfCanConvert))
...
public:
  ...
  virtual HRESULT STDMETHODCALLTYPE CanConvert(
      /* [size_is][in] */ __RPC__in_ecount_full(cSrcPlanes)
...
typedef struct IWICPlanarFormatConverterVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IWICPlanarFormatConverter *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IWICPlanarFormatConverter *This);

  DECLSPEC_XFGVIRT(IWICBitmapSource, GetSize)
  HRESULT(STDMETHODCALLTYPE *GetSize)(__RPC__in IWICPlanarFormatConverter *This,
                                      /* [out] */ __RPC__out UINT *puiWidth,
                                      /* [out] */ __RPC__out UINT *puiHeight);
  ...
  HRESULT(STDMETHODCALLTYPE *Initialize)(
      __RPC__in IWICPlanarFormatConverter *This,
      /* [size_is][in] */
      __RPC__in_ecount_full(cPlanes) IWICBitmapSource **ppPlanes, UINT cPlanes,
      /* [in] */ __RPC__in REFWICPixelFormatGUID dstFormat,
      /* [in] */ WICBitmapDitherType dither,
      /* [unique][in] */ __RPC__in_opt IWICPalette *pIPalette,
      /* [in] */ double alphaThresholdPercent,
  ...
  HRESULT(STDMETHODCALLTYPE *CanConvert)(
      __RPC__in IWICPlanarFormatConverter *This,
      /* [size_is][in] */
      __RPC__in_ecount_full(cSrcPlanes)
          const WICPixelFormatGUID *pSrcPixelFormats,
      UINT cSrcPlanes,
      /* [in] */ __RPC__in REFWICPixelFormatGUID dstPixelFormat,
      /* [out] */ __RPC__out BOOL *pfCanConvert);
...
#define IWICPlanarFormatConverter_CopyPixels(This, prc, cbStride,              \
                                             cbBufferSize, pbBuffer)           \
  ((This)->lpVtbl->CopyPixels(This, prc, cbStride, cbBufferSize, pbBuffer))

#define IWICPlanarFormatConverter_Initialize(                                  \
    This, ppPlanes, cPlanes, dstFormat, dither, pIPalette,                     \
    alphaThresholdPercent, paletteTranslate)                                   \
  ((This)->lpVtbl->Initialize(This, ppPlanes, cPlanes, dstFormat, dither,      \
                              pIPalette, alphaThresholdPercent,                \
                              paletteTranslate))

#define IWICPlanarFormatConverter_CanConvert(                                  \
    This, pSrcPixelFormats, cSrcPlanes, dstPixelFormat, pfCanConvert)          \
  ((This)->lpVtbl->CanConvert(This, pSrcPixelFormats, cSrcPlanes,              \
                              dstPixelFormat, pfCanConvert))
...
typedef struct IWICBitmapScalerVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in IWICBitmapScaler *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IWICBitmapScaler *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IWICBitmapScaler *This);

  DECLSPEC_XFGVIRT(IWICBitmapSource, GetSize)
  HRESULT(STDMETHODCALLTYPE *GetSize)(__RPC__in IWICBitmapScaler *This,
                                      /* [out] */ __RPC__out UINT *puiWidth,
                                      /* [out] */ __RPC__out UINT *puiHeight);
...
interface IWICBitmapScaler { CONST_VTBL struct IWICBitmapScalerVtbl *lpVtbl; };
...
typedef struct IWICBitmapClipperVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in IWICBitmapClipper *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IWICBitmapClipper *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IWICBitmapClipper *This);

  DECLSPEC_XFGVIRT(IWICBitmapSource, GetSize)
  HRESULT(STDMETHODCALLTYPE *GetSize)(__RPC__in IWICBitmapClipper *This,
                                      /* [out] */ __RPC__out UINT *puiWidth,
                                      /* [out] */ __RPC__out UINT *puiHeight);
...
typedef struct IWICBitmapFlipRotatorVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IWICBitmapFlipRotator *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IWICBitmapFlipRotator *This);

  DECLSPEC_XFGVIRT(IWICBitmapSource, GetSize)
  HRESULT(STDMETHODCALLTYPE *GetSize)(__RPC__in IWICBitmapFlipRotator *This,
                                      /* [out] */ __RPC__out UINT *puiWidth,
                                      /* [out] */ __RPC__out UINT *puiHeight);
...
typedef struct IWICBitmapToneMapperVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IWICBitmapToneMapper *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IWICBitmapToneMapper *This);

  DECLSPEC_XFGVIRT(IWICBitmapSource, GetSize)
  HRESULT(STDMETHODCALLTYPE *GetSize)(__RPC__in IWICBitmapToneMapper *This,
                                      /* [out] */ __RPC__out UINT *puiWidth,
                                      /* [out] */ __RPC__out UINT *puiHeight);
...
#define IWICBitmapToneMapper_AddRef(This) ((This)->lpVtbl->AddRef(This))

#define IWICBitmapToneMapper_Release(This) ((This)->lpVtbl->Release(This))
...
#define IWICBitmapToneMapper_CopyPixels(This, prc, cbStride, cbBufferSize,     \
                                        pbBuffer)                              \
  ((This)->lpVtbl->CopyPixels(This, prc, cbStride, cbBufferSize, pbBuffer))

#define IWICBitmapToneMapper_InitializeForHdrTarget(                           \
    This, pISource, guidDstFormat, fLuminanceInNits, fWhiteLevelInNits, mode)  \
  ((This)->lpVtbl->InitializeForHdrTarget(This, pISource, guidDstFormat,       \
                                          fLuminanceInNits, fWhiteLevelInNits, \
                                          mode))

#define IWICBitmapToneMapper_InitializeForSdrTarget(This, pISource,            \
                                                    guidDstFormat, mode)       \
...
public:
  ...
  virtual HRESULT STDMETHODCALLTYPE GetDataPointer(
      ...
      /* [size_is][size_is][out] */ __RPC__deref_out_ecount_full_opt(
          *pcbBufferSize) WICInProcPointer *
          ppbData) = 0;
...
typedef struct IWICBitmapLockVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in IWICBitmapLock *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IWICBitmapLock *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IWICBitmapLock *This);

  DECLSPEC_XFGVIRT(IWICBitmapLock, GetSize)
  HRESULT(STDMETHODCALLTYPE *GetSize)(__RPC__in IWICBitmapLock *This,
                                      /* [out] */ __RPC__out UINT *puiWidth,
                                      /* [out] */ __RPC__out UINT *puiHeight);

  DECLSPEC_XFGVIRT(IWICBitmapLock, GetStride)
  HRESULT(STDMETHODCALLTYPE *GetStride)(__RPC__in IWICBitmapLock *This,
  ...
  HRESULT(STDMETHODCALLTYPE *GetDataPointer)(
      ...
      /* [out] */ __RPC__out UINT *pcbBufferSize,
      /* [size_is][size_is][out] */
      __RPC__deref_out_ecount_full_opt(*pcbBufferSize)
...
interface IWICBitmapLock { CONST_VTBL struct IWICBitmapLockVtbl *lpVtbl; };
...
typedef struct IWICBitmapVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in IWICBitmap *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IWICBitmap *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IWICBitmap *This);

  DECLSPEC_XFGVIRT(IWICBitmapSource, GetSize)
  HRESULT(STDMETHODCALLTYPE *GetSize)(__RPC__in IWICBitmap *This,
                                      /* [out] */ __RPC__out UINT *puiWidth,
                                      /* [out] */ __RPC__out UINT *puiHeight);
  ...
  HRESULT(STDMETHODCALLTYPE *SetResolution)(__RPC__in IWICBitmap *This,
                                            /* [in] */ double dpiX,
                                            /* [in] */ double dpiY);
...
interface IWICBitmap { CONST_VTBL struct IWICBitmapVtbl *lpVtbl; };
...
public:
  ...
  virtual HRESULT STDMETHODCALLTYPE InitializeFromMemory(
      /* [size_is][in] */ __RPC__in_ecount_full(cbBufferSize)
          const BYTE *pbBuffer,
...
typedef struct IWICColorContextVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in IWICColorContext *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IWICColorContext *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IWICColorContext *This);
...
interface IWICColorContext { CONST_VTBL struct IWICColorContextVtbl *lpVtbl; };
...
typedef struct IWICColorTransformVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in IWICColorTransform *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IWICColorTransform *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IWICColorTransform *This);

  DECLSPEC_XFGVIRT(IWICBitmapSource, GetSize)
  HRESULT(STDMETHODCALLTYPE *GetSize)(__RPC__in IWICColorTransform *This,
                                      /* [out] */ __RPC__out UINT *puiWidth,
                                      /* [out] */ __RPC__out UINT *puiHeight);
...
public:
  ...
  virtual HRESULT STDMETHODCALLTYPE GetMetadataQueryWriter(
      /* [out] */ __RPC__deref_out_opt IWICMetadataQueryWriter *
      *ppIMetadataQueryWriter) = 0;
};
...
typedef struct IWICFastMetadataEncoderVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IWICFastMetadataEncoder *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IWICFastMetadataEncoder *This);

  DECLSPEC_XFGVIRT(IWICFastMetadataEncoder, Commit)
  HRESULT(STDMETHODCALLTYPE *Commit)(__RPC__in IWICFastMetadataEncoder *This);
...
typedef struct IWICStreamVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in IWICStream *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IWICStream *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IWICStream *This);
  ...
  /* [local] */ HRESULT(STDMETHODCALLTYPE *Write)(IWICStream *This,
                                                  /* [annotation] */
                                                  _In_reads_bytes_(cb)
                                                      const void *pv,
                                                  /* [annotation][in] */
  ...
  HRESULT(STDMETHODCALLTYPE *SetSize)(__RPC__in IWICStream *This,
  ...
  HRESULT(STDMETHODCALLTYPE *Commit)(__RPC__in IWICStream *This,
                                     /* [in] */ DWORD grfCommitFlags);

  DECLSPEC_XFGVIRT(IStream, Revert)
  HRESULT(STDMETHODCALLTYPE *Revert)(__RPC__in IWICStream *This);

  DECLSPEC_XFGVIRT(IStream, LockRegion)
  HRESULT(STDMETHODCALLTYPE *LockRegion)(__RPC__in IWICStream *This,
                                         /* [in] */ ULARGE_INTEGER libOffset,
                                         /* [in] */ ULARGE_INTEGER cb,
                                         /* [in] */ DWORD dwLockType);

  DECLSPEC_XFGVIRT(IStream, UnlockRegion)
  HRESULT(STDMETHODCALLTYPE *UnlockRegion)(__RPC__in IWICStream *This,
                                           /* [in] */ ULARGE_INTEGER libOffset,
                                           /* [in] */ ULARGE_INTEGER cb,
                                           /* [in] */ DWORD dwLockType);

  DECLSPEC_XFGVIRT(IStream, Stat)
  HRESULT(STDMETHODCALLTYPE *Stat)(__RPC__in IWICStream *This,
...
interface IWICStream { CONST_VTBL struct IWICStreamVtbl *lpVtbl; };
...
public:
  virtual HRESULT STDMETHODCALLTYPE Next(
      ...
      /* [size_is][out][in] */ __RPC__inout_ecount_full(celt) PROPVARIANT *
          rgeltId,
      /* [size_is][optional][out][in] */
  ...
  virtual HRESULT STDMETHODCALLTYPE Clone(
      /* [out] */ __RPC__deref_out_opt IWICEnumMetadataItem *
...
typedef struct IWICEnumMetadataItemVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IWICEnumMetadataItem *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IWICEnumMetadataItem *This);
  ...
  HRESULT(STDMETHODCALLTYPE *Skip)(__RPC__in IWICEnumMetadataItem *This,
                                   /* [in] */ ULONG celt);

  DECLSPEC_XFGVIRT(IWICEnumMetadataItem, Reset)
  HRESULT(STDMETHODCALLTYPE *Reset)(__RPC__in IWICEnumMetadataItem *This);
...
typedef struct IWICMetadataQueryReaderVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IWICMetadataQueryReader *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IWICMetadataQueryReader *This);
...
#define IWICMetadataQueryReader_GetLocation(This, cchMaxLength, wzNamespace,   \
                                            pcchActualLength)                  \
  ((This)->lpVtbl->GetLocation(This, cchMaxLength, wzNamespace,                \
                               pcchActualLength))
...
typedef struct IWICMetadataQueryWriterVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IWICMetadataQueryWriter *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IWICMetadataQueryWriter *This);
...
public:
  ...
  virtual HRESULT STDMETHODCALLTYPE GetEncoderInfo(
      /* [out] */ __RPC__deref_out_opt IWICBitmapEncoderInfo *
      *ppIEncoderInfo) = 0;

  virtual HRESULT STDMETHODCALLTYPE SetColorContexts(
      /* [in] */ UINT cCount,
      /* [size_is][in] */ __RPC__in_ecount_full(cCount) IWICColorContext *
          *ppIColorContext) = 0;
  ...
  virtual HRESULT STDMETHODCALLTYPE CreateNewFrame(
      ...
      /* [unique][out][in] */ __RPC__deref_opt_inout_opt IPropertyBag2 *
          *ppIEncoderOptions) = 0;
...
typedef struct IWICBitmapEncoderVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in IWICBitmapEncoder *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IWICBitmapEncoder *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IWICBitmapEncoder *This);
  ...
  HRESULT(STDMETHODCALLTYPE *Commit)(__RPC__in IWICBitmapEncoder *This);
...
public:
  ...
  virtual HRESULT STDMETHODCALLTYPE WritePixels(
      ...
      /* [in] */ UINT cbStride,
      /* [in] */ UINT cbBufferSize,
      /* [size_is][in] */ __RPC__in_ecount_full(cbBufferSize) BYTE *
          pbPixels) = 0;
...
typedef struct IWICBitmapFrameEncodeVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IWICBitmapFrameEncode *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IWICBitmapFrameEncode *This);
  ...
  HRESULT(STDMETHODCALLTYPE *SetSize)(__RPC__in IWICBitmapFrameEncode *This,
                                      /* [in] */ UINT uiWidth,
                                      /* [in] */ UINT uiHeight);
  ...
  HRESULT(STDMETHODCALLTYPE *Commit)(__RPC__in IWICBitmapFrameEncode *This);
...
#define IWICBitmapFrameEncode_WritePixels(This, lineCount, cbStride,           \
  ...
  ((This)->lpVtbl->WritePixels(This, lineCount, cbStride, cbBufferSize,        \
                               pbPixels))
...
public:
  virtual HRESULT STDMETHODCALLTYPE WritePixels(
      UINT lineCount,
      /* [size_is][in] */ __RPC__in_ecount_full(cPlanes) WICBitmapPlane *
          pPlanes,
      UINT cPlanes) = 0;
...
typedef struct IWICPlanarBitmapFrameEncodeVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IWICPlanarBitmapFrameEncode *This);
  ...
  HRESULT(STDMETHODCALLTYPE *WritePixels)(
      __RPC__in IWICPlanarBitmapFrameEncode *This, UINT lineCount,
      /* [size_is][in] */
      __RPC__in_ecount_full(cPlanes) WICBitmapPlane *pPlanes, UINT cPlanes);
...
#define IWICPlanarBitmapFrameEncode_WritePixels(This, lineCount, pPlanes,      \
                                                cPlanes)                       \
  ((This)->lpVtbl->WritePixels(This, lineCount, pPlanes, cPlanes))

#define IWICPlanarBitmapFrameEncode_WriteSource(This, ppPlanes, cPlanes,       \
                                                prcSource)                     \
...
interface IWICImageEncoder { CONST_VTBL struct IWICImageEncoderVtbl *lpVtbl; };
...
#define IWICImageEncoder_WriteFrame(This, pImage, pFrameEncode,                \
                                    pImageParameters)                          \
  ((This)->lpVtbl->WriteFrame(This, pImage, pFrameEncode, pImageParameters))

#define IWICImageEncoder_WriteFrameThumbnail(This, pImage, pFrameEncode,       \
                                             pImageParameters)                 \
  ((This)->lpVtbl->WriteFrameThumbnail(This, pImage, pFrameEncode,             \
                                       pImageParameters))

#define IWICImageEncoder_WriteThumbnail(This, pImage, pEncoder,                \
                                        pImageParameters)                      \
...
public:
  ...
  virtual HRESULT STDMETHODCALLTYPE GetDecoderInfo(
      /* [out] */ __RPC__deref_out_opt IWICBitmapDecoderInfo *
      *ppIDecoderInfo) = 0;
  ...
  virtual HRESULT STDMETHODCALLTYPE GetMetadataQueryReader(
      /* [out] */ __RPC__deref_out_opt IWICMetadataQueryReader *
      *ppIMetadataQueryReader) = 0;
  ...
  virtual HRESULT STDMETHODCALLTYPE GetFrame(
      /* [in] */ UINT index,
      /* [out] */ __RPC__deref_out_opt IWICBitmapFrameDecode *
          *ppIBitmapFrame) = 0;
};
...
typedef struct IWICBitmapDecoderVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in IWICBitmapDecoder *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IWICBitmapDecoder *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IWICBitmapDecoder *This);
...
typedef struct IWICBitmapSourceTransformVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IWICBitmapSourceTransform *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IWICBitmapSourceTransform *This);
...
#define IWICBitmapSourceTransform_CopyPixels(This, prc, uiWidth, uiHeight,     \
                                             pguidDstFormat, dstTransform,     \
                                             nStride, cbBufferSize, pbBuffer)  \
  ((This)->lpVtbl->CopyPixels(This, prc, uiWidth, uiHeight, pguidDstFormat,    \
                              dstTransform, nStride, cbBufferSize, pbBuffer))
...
#define IWICBitmapSourceTransform_DoesSupportTransform(This, dstTransform,     \
                                                       pfIsSupported)          \
...
public:
  virtual HRESULT STDMETHODCALLTYPE GetColorContextsForPixelFormat(
      ...
      /* [in] */ UINT cCount,
      /* [size_is][unique][in] */
      __RPC__in_ecount_full_opt(cCount) IWICColorContext * *ppIColorContexts,
      /* [out] */ __RPC__out UINT * pcActualCount) = 0;
};
...
typedef struct IWICBitmapSourceTransform2Vtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IWICBitmapSourceTransform2 *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IWICBitmapSourceTransform2 *This);
...
#define IWICBitmapSourceTransform2_AddRef(This) ((This)->lpVtbl->AddRef(This))

#define IWICBitmapSourceTransform2_Release(This) ((This)->lpVtbl->Release(This))

#define IWICBitmapSourceTransform2_CopyPixels(This, prc, uiWidth, uiHeight,    \
                                              pguidDstFormat, dstTransform,    \
                                              nStride, cbBufferSize, pbBuffer) \
  ((This)->lpVtbl->CopyPixels(This, prc, uiWidth, uiHeight, pguidDstFormat,    \
                              dstTransform, nStride, cbBufferSize, pbBuffer))
...
#define IWICBitmapSourceTransform2_DoesSupportTransform(This, dstTransform,    \
                                                        pfIsSupported)         \
  ((This)->lpVtbl->DoesSupportTransform(This, dstTransform, pfIsSupported))

#define IWICBitmapSourceTransform2_GetColorContextsForPixelFormat(             \
    This, pPixelFormat, cCount, ppIColorContexts, pcActualCount)               \
  ((This)->lpVtbl->GetColorContextsForPixelFormat(                             \
      This, pPixelFormat, cCount, ppIColorContexts, pcActualCount))
...
public:
  virtual HRESULT STDMETHODCALLTYPE DoesSupportTransform(
      ...
      /* [size_is][out] */
      __RPC__out_ecount_full(cPlanes)
          WICBitmapPlaneDescription *pPlaneDescriptions,
      UINT cPlanes,
      /* [out] */ __RPC__out BOOL *pfIsSupported) = 0;

  virtual HRESULT STDMETHODCALLTYPE CopyPixels(
      /* [unique][in] */ __RPC__in_opt const WICRect *prcSource, UINT uiWidth,
      UINT uiHeight, WICBitmapTransformOptions dstTransform,
...
#define IWICPlanarBitmapSourceTransform_DoesSupportTransform(                  \
    This, puiWidth, puiHeight, dstTransform, dstPlanarOptions,                 \
    pguidDstFormats, pPlaneDescriptions, cPlanes, pfIsSupported)               \
  ((This)->lpVtbl->DoesSupportTransform(                                       \
      This, puiWidth, puiHeight, dstTransform, dstPlanarOptions,               \
      pguidDstFormats, pPlaneDescriptions, cPlanes, pfIsSupported))

#define IWICPlanarBitmapSourceTransform_CopyPixels(                            \
    This, prcSource, uiWidth, uiHeight, dstTransform, dstPlanarOptions,        \
    pDstPlanes, cPlanes)                                                       \
  ((This)->lpVtbl->CopyPixels(This, prcSource, uiWidth, uiHeight,              \
                              dstTransform, dstPlanarOptions, pDstPlanes,      \
                              cPlanes))
...
typedef struct IWICBitmapFrameDecodeVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IWICBitmapFrameDecode *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IWICBitmapFrameDecode *This);

  DECLSPEC_XFGVIRT(IWICBitmapSource, GetSize)
  HRESULT(STDMETHODCALLTYPE *GetSize)(__RPC__in IWICBitmapFrameDecode *This,
                                      /* [out] */ __RPC__out UINT *puiWidth,
                                      /* [out] */ __RPC__out UINT *puiHeight);
...
typedef struct IWICBitmapFrameChainReaderVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IWICBitmapFrameChainReader *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IWICBitmapFrameChainReader *This);
...
#define IWICBitmapFrameChainReader_AddRef(This) ((This)->lpVtbl->AddRef(This))

#define IWICBitmapFrameChainReader_Release(This) ((This)->lpVtbl->Release(This))

#define IWICBitmapFrameChainReader_GetChainedFrameCount(This, chainType,       \
                                                        pCount)                \
  ((This)->lpVtbl->GetChainedFrameCount(This, chainType, pCount))

#define IWICBitmapFrameChainReader_GetChainedFrame(This, chainType, index,     \
                                                   ppIBitmapFrame)             \
...
typedef struct IWICBitmapFrameChainWriterVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IWICBitmapFrameChainWriter *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IWICBitmapFrameChainWriter *This);
...
#define IWICBitmapFrameChainWriter_AddRef(This) ((This)->lpVtbl->AddRef(This))

#define IWICBitmapFrameChainWriter_Release(This) ((This)->lpVtbl->Release(This))

#define IWICBitmapFrameChainWriter_AppendFrameToChain(                         \
    This, chainType, ppIFrameEncode, ppIEncoderOptions)                        \
  ((This)->lpVtbl->AppendFrameToChain(This, chainType, ppIFrameEncode,         \
                                      ppIEncoderOptions))

#define IWICBitmapFrameChainWriter_DoesSupportChainType(This, chainType,       \
                                                        pfIsSupported)         \
...
typedef struct IWICProgressiveLevelControlVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IWICProgressiveLevelControl *This);
...
typedef struct IWICDisplayAdaptationControlVtbl {
  ...
  DECLSPEC_XFGVIRT(IWICDisplayAdaptationControl,
                   DoesSupportChangingMaxLuminance)
...
#define IWICDisplayAdaptationControl_AddRef(This) ((This)->lpVtbl->AddRef(This))

#define IWICDisplayAdaptationControl_Release(This)                             \
  ((This)->lpVtbl->Release(This))

#define IWICDisplayAdaptationControl_DoesSupportChangingMaxLuminance(          \
    This, pguidDstFormat, pfIsSupported)                                       \
  ((This)->lpVtbl->DoesSupportChangingMaxLuminance(This, pguidDstFormat,       \
                                                   pfIsSupported))

#define IWICDisplayAdaptationControl_SetDisplayMaxLuminance(This,              \
                                                            fLuminanceInNits)  \
  ((This)->lpVtbl->SetDisplayMaxLuminance(This, fLuminanceInNits))

#define IWICDisplayAdaptationControl_GetDisplayMaxLuminance(This,              \
                                                            pfLuminanceInNits) \
...
#define IWICDisplayAdaptationControl2_DoesSupportChangingMaxLuminance(         \
    This, pguidDstFormat, pfIsSupported)                                       \
  ((This)->lpVtbl->DoesSupportChangingMaxLuminance(This, pguidDstFormat,       \
                                                   pfIsSupported))

#define IWICDisplayAdaptationControl2_SetDisplayMaxLuminance(This,             \
                                                             fLuminanceInNits) \
  ((This)->lpVtbl->SetDisplayMaxLuminance(This, fLuminanceInNits))

#define IWICDisplayAdaptationControl2_GetDisplayMaxLuminance(                  \
    This, pfLuminanceInNits)                                                   \
  ((This)->lpVtbl->GetDisplayMaxLuminance(This, pfLuminanceInNits))

#define IWICDisplayAdaptationControl2_SetSdrWhiteLevel(This,                   \
                                                       fWhiteLevelInNits)      \
  ((This)->lpVtbl->SetSdrWhiteLevel(This, fWhiteLevelInNits))

#define IWICDisplayAdaptationControl2_GetSdrWhiteLevel(This,                   \
                                                       pfWhiteLevelInNits)     \
...
#define IWICDisplayAdaptationControl2_DoesSupportToneMappingMode(              \
    This, mode, pfIsSupported)                                                 \
...
public:
  virtual HRESULT STDMETHODCALLTYPE GetTexture(
      ...
      /* [annotation] */
      _In_opt_ IPropertyBag2 * pID3DTextureOptions, REFIID riid,
      /* [annotation] */
      _Outptr_ void **ppTexture) = 0;

  virtual HRESULT STDMETHODCALLTYPE GetTransformedTexture(
      /* [annotation] */
      _In_opt_ const WICRect *prc, UINT uiWidth, UINT uiHeight,
      /* [annotation] */
...
typedef struct IWICD3DTextureSourceVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(IWICD3DTextureSource *This,
                                             /* [in] */ REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(IWICD3DTextureSource *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(IWICD3DTextureSource *This);
  ...
  HRESULT(STDMETHODCALLTYPE *DoesSupportD3DDeviceType)(
      IWICD3DTextureSource *This, REFIID riid,
      /* [annotation] */
...
#define IWICD3DTextureSource_AddRef(This) ((This)->lpVtbl->AddRef(This))

#define IWICD3DTextureSource_Release(This) ((This)->lpVtbl->Release(This))

#define IWICD3DTextureSource_GetTexture(This, pD3DDevice, pID3DTextureOptions, \
                                        riid, ppTexture)                       \
  ((This)->lpVtbl->GetTexture(This, pD3DDevice, pID3DTextureOptions, riid,     \
                              ppTexture))

#define IWICD3DTextureSource_GetTransformedTexture(                            \
    This, prc, uiWidth, uiHeight, pguidDstFormat, dstTransform, pD3DDevice,    \
    pID3DTextureOptions, riid, ppTexture)                                      \
  ((This)->lpVtbl->GetTransformedTexture(                                      \
      This, prc, uiWidth, uiHeight, pguidDstFormat, dstTransform, pD3DDevice,  \
      pID3DTextureOptions, riid, ppTexture))

#define IWICD3DTextureSource_DoesSupportD3DDeviceType(This, riid,              \
                                                      pfIsSupported)           \
...
typedef struct IWICProgressCallbackVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IWICProgressCallback *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IWICProgressCallback *This);

  DECLSPEC_XFGVIRT(IWICProgressCallback, Notify)
  HRESULT(STDMETHODCALLTYPE *Notify)(__RPC__in IWICProgressCallback *This,
                                     /* [in] */ ULONG uFrameNum,
                                     /* [in] */ WICProgressOperation operation,
...
typedef HRESULT(__stdcall *PFNProgressNotification)(
    __RPC__in LPVOID pvData, ULONG uFrameNum, WICProgressOperation operation,
    double dblProgress);
...
typedef struct IWICBitmapCodecProgressNotificationVtbl {
  ...
  DECLSPEC_XFGVIRT(IWICBitmapCodecProgressNotification,
...
#define IWICBitmapCodecProgressNotification_QueryInterface(This, riid,         \
                                                           ppvObject)          \
  ((This)->lpVtbl->QueryInterface(This, riid, ppvObject))
...
#define IWICBitmapCodecProgressNotification_RegisterProgressNotification(      \
    This, pfnProgressNotification, pvData, dwProgressFlags)                    \
  ((This)->lpVtbl->RegisterProgressNotification(This, pfnProgressNotification, \
                                                pvData, dwProgressFlags))
...
IWICBitmapCodecProgressNotification_Remote_RegisterProgressNotification_Proxy(
    __RPC__in IWICBitmapCodecProgressNotification *This,
    /* [unique][in] */ __RPC__in_opt IWICProgressCallback *pICallback,
    /* [in] */ DWORD dwProgressFlags);

void __RPC_STUB
IWICBitmapCodecProgressNotification_Remote_RegisterProgressNotification_Stub(
...
typedef struct IWICComponentInfoVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in IWICComponentInfo *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IWICComponentInfo *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IWICComponentInfo *This);
  ...
  HRESULT(STDMETHODCALLTYPE *GetCLSID)(__RPC__in IWICComponentInfo *This,
...
public:
  virtual HRESULT STDMETHODCALLTYPE GetPixelFormats(
      /* [in] */ UINT cFormats,
      /* [size_is][unique][out][in] */
      __RPC__inout_ecount_full_opt(cFormats) WICPixelFormatGUID *
          pPixelFormatGUIDs,
...
typedef struct IWICFormatConverterInfoVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IWICFormatConverterInfo *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IWICFormatConverterInfo *This);
  ...
  DECLSPEC_XFGVIRT(IWICComponentInfo, GetCLSID)
  HRESULT(STDMETHODCALLTYPE *GetCLSID)(__RPC__in IWICFormatConverterInfo *This,
                                       /* [out] */ __RPC__out CLSID *pclsid);
  ...
  HRESULT(STDMETHODCALLTYPE *GetPixelFormats)(
      ...
      /* [in] */ UINT cFormats,
      /* [size_is][unique][out][in] */
      __RPC__inout_ecount_full_opt(cFormats)
...
public:
  ...
  virtual HRESULT STDMETHODCALLTYPE GetColorManagementVersion(
      ...
      /* [size_is][unique][out][in] */
      __RPC__inout_ecount_full_opt(cchColorManagementVersion) WCHAR *
  ...
  virtual HRESULT STDMETHODCALLTYPE GetDeviceManufacturer(
      ...
      /* [size_is][unique][out][in] */
      __RPC__inout_ecount_full_opt(cchDeviceManufacturer) WCHAR *
...
typedef struct IWICBitmapCodecInfoVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IWICBitmapCodecInfo *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IWICBitmapCodecInfo *This);
  ...
  DECLSPEC_XFGVIRT(IWICComponentInfo, GetCLSID)
  HRESULT(STDMETHODCALLTYPE *GetCLSID)(__RPC__in IWICBitmapCodecInfo *This,
                                       /* [out] */ __RPC__out CLSID *pclsid);
  ...
  HRESULT(STDMETHODCALLTYPE *GetColorManagementVersion)(
      ...
      /* [in] */ UINT cchColorManagementVersion,
      /* [size_is][unique][out][in] */
      __RPC__inout_ecount_full_opt(cchColorManagementVersion)
  ...
  HRESULT(STDMETHODCALLTYPE *GetDeviceManufacturer)(
      ...
      /* [in] */ UINT cchDeviceManufacturer,
      /* [size_is][unique][out][in] */
      __RPC__inout_ecount_full_opt(cchDeviceManufacturer)
...
#define IWICBitmapCodecInfo_GetFileExtensions(This, cchFileExtensions,         \
  ...
  ((This)->lpVtbl->GetFileExtensions(This, cchFileExtensions,                  \
                                     wzFileExtensions, pcchActual))
...
public:
  virtual HRESULT STDMETHODCALLTYPE CreateInstance(
      /* [out] */ __RPC__deref_out_opt IWICBitmapEncoder *
      *ppIBitmapEncoder) = 0;
};
...
typedef struct IWICBitmapEncoderInfoVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IWICBitmapEncoderInfo *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IWICBitmapEncoderInfo *This);
  ...
  DECLSPEC_XFGVIRT(IWICComponentInfo, GetCLSID)
  HRESULT(STDMETHODCALLTYPE *GetCLSID)(__RPC__in IWICBitmapEncoderInfo *This,
                                       /* [out] */ __RPC__out CLSID *pclsid);
...
public:
  virtual /* [local] */ HRESULT STDMETHODCALLTYPE GetPatterns(
      ...
      _Out_writes_bytes_to_opt_(cbSizePatterns, *pcbPatternsActual)
              WICBitmapPattern *
          pPatterns,
  ...
  virtual HRESULT STDMETHODCALLTYPE CreateInstance(
      /* [out] */ __RPC__deref_out_opt IWICBitmapDecoder *
      *ppIBitmapDecoder) = 0;
};
...
typedef struct IWICBitmapDecoderInfoVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IWICBitmapDecoderInfo *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IWICBitmapDecoderInfo *This);
  ...
  DECLSPEC_XFGVIRT(IWICComponentInfo, GetCLSID)
  HRESULT(STDMETHODCALLTYPE *GetCLSID)(__RPC__in IWICBitmapDecoderInfo *This,
                                       /* [out] */ __RPC__out CLSID *pclsid);
...
/* [call_as] */ HRESULT
STDMETHODCALLTYPE IWICBitmapDecoderInfo_Remote_GetPatterns_Proxy(
    __RPC__in IWICBitmapDecoderInfo *This,
    /* [size_is][size_is][out] */
...
typedef struct IWICPixelFormatInfoVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IWICPixelFormatInfo *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IWICPixelFormatInfo *This);
  ...
  DECLSPEC_XFGVIRT(IWICComponentInfo, GetCLSID)
  HRESULT(STDMETHODCALLTYPE *GetCLSID)(__RPC__in IWICPixelFormatInfo *This,
                                       /* [out] */ __RPC__out CLSID *pclsid);
...
public:
  ...
  virtual HRESULT STDMETHODCALLTYPE GetNumericRepresentation(
      /* [out] */ __RPC__out WICPixelFormatNumericRepresentation *
      pNumericRepresentation) = 0;
};
...
typedef struct IWICPixelFormatInfo2Vtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IWICPixelFormatInfo2 *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IWICPixelFormatInfo2 *This);
  ...
  DECLSPEC_XFGVIRT(IWICComponentInfo, GetCLSID)
  HRESULT(STDMETHODCALLTYPE *GetCLSID)(__RPC__in IWICPixelFormatInfo2 *This,
                                       /* [out] */ __RPC__out CLSID *pclsid);
...
public:
  virtual HRESULT STDMETHODCALLTYPE CreateDecoderFromFilename(
      ...
      /* [retval][out] */
      __RPC__deref_out_opt IWICBitmapDecoder **ppIDecoder) = 0;
  ...
  virtual HRESULT STDMETHODCALLTYPE CreateEncoder(
      ...
      /* [unique][in] */ __RPC__in_opt const GUID *pguidVendor,
      /* [retval][out] */
      __RPC__deref_out_opt IWICBitmapEncoder **ppIEncoder) = 0;
  ...
  virtual HRESULT STDMETHODCALLTYPE CreateFormatConverter(
      /* [out] */ __RPC__deref_out_opt IWICFormatConverter *
      *ppIFormatConverter) = 0;
  ...
  virtual HRESULT STDMETHODCALLTYPE CreateFastMetadataEncoderFromDecoder(
      ...
      /* [out] */ __RPC__deref_out_opt IWICFastMetadataEncoder *
          *ppIFastEncoder) = 0;
  ...
  virtual HRESULT STDMETHODCALLTYPE CreateQueryWriter(
      ...
      /* [unique][in] */ __RPC__in_opt const GUID *pguidVendor,
      /* [out] */
      __RPC__deref_out_opt IWICMetadataQueryWriter **ppIQueryWriter) = 0;
...
typedef struct IWICImagingFactoryVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in IWICImagingFactory *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IWICImagingFactory *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IWICImagingFactory *This);
...
#define IWICImagingFactory_CreateBitmapFromMemory(                             \
    ...
    ppIBitmap)                                                                 \
  ((This)->lpVtbl->CreateBitmapFromMemory(This, uiWidth, uiHeight,             \
                                          pixelFormat, cbStride, cbBufferSize, \
                                          pbBuffer, ppIBitmap))
...
#define IWICImagingFactory2_CreateImageEncoder(This, pD2DDevice,               \
                                               ppWICImageEncoder)              \
...
public:
  virtual HRESULT STDMETHODCALLTYPE CreateBitmapToneMapper(
      /* [out] */ __RPC__deref_out_opt IWICBitmapToneMapper *
      *ppToneMapper) = 0;
};
...
typedef struct IWICImagingFactory3Vtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IWICImagingFactory3 *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IWICImagingFactory3 *This);
...
#define IWICImagingFactory3_AddRef(This) ((This)->lpVtbl->AddRef(This))

#define IWICImagingFactory3_Release(This) ((This)->lpVtbl->Release(This))

#define IWICImagingFactory3_CreateDecoderFromFilename(                         \
    This, wzFilename, pguidVendor, dwDesiredAccess, metadataOptions,           \
    ppIDecoder)                                                                \
  ((This)->lpVtbl->CreateDecoderFromFilename(This, wzFilename, pguidVendor,    \
                                             dwDesiredAccess, metadataOptions, \
...
#define IWICImagingFactory3_CreateDecoderFromStream(                           \
    This, pIStream, pguidVendor, metadataOptions, ppIDecoder)                  \
  ((This)->lpVtbl->CreateDecoderFromStream(This, pIStream, pguidVendor,        \
                                           metadataOptions, ppIDecoder))

#define IWICImagingFactory3_CreateDecoderFromFileHandle(                       \
    This, hFile, pguidVendor, metadataOptions, ppIDecoder)                     \
  ((This)->lpVtbl->CreateDecoderFromFileHandle(This, hFile, pguidVendor,       \
                                               metadataOptions, ppIDecoder))
...
#define IWICImagingFactory3_CreateDecoder(This, guidContainerFormat,           \
                                          pguidVendor, ppIDecoder)             \
  ((This)->lpVtbl->CreateDecoder(This, guidContainerFormat, pguidVendor,       \
                                 ppIDecoder))

#define IWICImagingFactory3_CreateEncoder(This, guidContainerFormat,           \
                                          pguidVendor, ppIEncoder)             \
  ((This)->lpVtbl->CreateEncoder(This, guidContainerFormat, pguidVendor,       \
                                 ppIEncoder))
...
#define IWICImagingFactory3_CreateBitmapFlipRotator(This,                      \
                                                    ppIBitmapFlipRotator)      \
  ((This)->lpVtbl->CreateBitmapFlipRotator(This, ppIBitmapFlipRotator))
...
#define IWICImagingFactory3_CreateBitmap(This, uiWidth, uiHeight, pixelFormat, \
                                         option, ppIBitmap)                    \
  ((This)->lpVtbl->CreateBitmap(This, uiWidth, uiHeight, pixelFormat, option,  \
                                ppIBitmap))

#define IWICImagingFactory3_CreateBitmapFromSource(This, pIBitmapSource,       \
                                                   option, ppIBitmap)          \
  ((This)->lpVtbl->CreateBitmapFromSource(This, pIBitmapSource, option,        \
                                          ppIBitmap))

#define IWICImagingFactory3_CreateBitmapFromSourceRect(                        \
    This, pIBitmapSource, x, y, width, height, ppIBitmap)                      \
  ((This)->lpVtbl->CreateBitmapFromSourceRect(This, pIBitmapSource, x, y,      \
                                              width, height, ppIBitmap))

#define IWICImagingFactory3_CreateBitmapFromMemory(                            \
    This, uiWidth, uiHeight, pixelFormat, cbStride, cbBufferSize, pbBuffer,    \
    ppIBitmap)                                                                 \
  ((This)->lpVtbl->CreateBitmapFromMemory(This, uiWidth, uiHeight,             \
                                          pixelFormat, cbStride, cbBufferSize, \
...
#define IWICImagingFactory3_CreateBitmapFromHBITMAP(This, hBitmap, hPalette,   \
                                                    options, ppIBitmap)        \
  ((This)->lpVtbl->CreateBitmapFromHBITMAP(This, hBitmap, hPalette, options,   \
                                           ppIBitmap))
...
#define IWICImagingFactory3_CreateComponentEnumerator(This, componentTypes,    \
                                                      options, ppIEnumUnknown) \
  ((This)->lpVtbl->CreateComponentEnumerator(This, componentTypes, options,    \
                                             ppIEnumUnknown))

#define IWICImagingFactory3_CreateFastMetadataEncoderFromDecoder(              \
    This, pIDecoder, ppIFastEncoder)                                           \
  ((This)->lpVtbl->CreateFastMetadataEncoderFromDecoder(This, pIDecoder,       \
                                                        ppIFastEncoder))

#define IWICImagingFactory3_CreateFastMetadataEncoderFromFrameDecode(          \
    This, pIFrameDecoder, ppIFastEncoder)                                      \
  ((This)->lpVtbl->CreateFastMetadataEncoderFromFrameDecode(                   \
      This, pIFrameDecoder, ppIFastEncoder))

#define IWICImagingFactory3_CreateQueryWriter(This, guidMetadataFormat,        \
                                              pguidVendor, ppIQueryWriter)     \
  ((This)->lpVtbl->CreateQueryWriter(This, guidMetadataFormat, pguidVendor,    \
                                     ppIQueryWriter))

#define IWICImagingFactory3_CreateQueryWriterFromReader(                       \
    This, pIQueryReader, pguidVendor, ppIQueryWriter)                          \
  ((This)->lpVtbl->CreateQueryWriterFromReader(This, pIQueryReader,            \
                                               pguidVendor, ppIQueryWriter))

#define IWICImagingFactory3_CreateImageEncoder(This, pD2DDevice,               \
                                               ppWICImageEncoder)              \
  ((This)->lpVtbl->CreateImageEncoder(This, pD2DDevice, ppWICImageEncoder))
...
HRESULT WINAPI WICConvertBitmapSource(
    ...
    _Outptr_ IWICBitmapSource *
        *ppIDst // Destination bitmap, a copy or addrefed source
);
HRESULT WINAPI WICCreateBitmapFromSection(
    _In_ UINT width, _In_ UINT height, _In_ REFWICPixelFormatGUID pixelFormat,
    _In_ HANDLE hSection, _In_ UINT stride, _In_ UINT offset,
...
HRESULT WINAPI WICCreateBitmapFromSectionEx(
    ...
    _Outptr_ IWICBitmap **ppIBitmap);
HRESULT WINAPI WICMapGuidToShortName(_In_ REFGUID guid, _In_ UINT cchName,
                                     _Inout_updates_opt_(cchName) WCHAR *wzName,
                                     _Out_ UINT *pcchActual);
HRESULT WINAPI WICMapShortNameToGuid(_In_ PCWSTR wzName, _Out_ GUID *pguid);
HRESULT WINAPI WICMapSchemaToName(_In_ REFGUID guidMetadataFormat,
                                  _In_ LPWSTR pwzSchema, _In_ UINT cchName,
                                  _Inout_updates_opt_(cchName) WCHAR *wzName,
                                  _Out_ UINT *pcchActual);
#define FACILITY_WINCODEC_ERR 0x898
#define WINCODEC_ERR_BASE 0x2000
#define MAKE_WINCODECHR(sev, code)                                             \
...
#define IWICDevelopRawNotificationCallback_QueryInterface(This, riid,          \
                                                          ppvObject)           \
  ((This)->lpVtbl->QueryInterface(This, riid, ppvObject))
...
public:
  ...
  virtual HRESULT STDMETHODCALLTYPE GetCurrentParameterSet(
      /* [out] */ __RPC__deref_out_opt IPropertyBag2 *
      *ppCurrentParameterSet) = 0;
  ...
  virtual /* [local] */ HRESULT STDMETHODCALLTYPE GetToneCurve(
      ...
      /* [annotation][unique][out] */
      _Out_writes_bytes_to_opt_(cbToneCurveBufferSize,
                                *pcbActualToneCurveBufferSize) WICRawToneCurve *
          pToneCurve,
      /* [annotation][unique][out] */
...
typedef struct IWICDevelopRawVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in IWICDevelopRaw *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IWICDevelopRaw *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IWICDevelopRaw *This);

  DECLSPEC_XFGVIRT(IWICBitmapSource, GetSize)
  HRESULT(STDMETHODCALLTYPE *GetSize)(__RPC__in IWICDevelopRaw *This,
                                      /* [out] */ __RPC__out UINT *puiWidth,
                                      /* [out] */ __RPC__out UINT *puiHeight);
  ...
  HRESULT(STDMETHODCALLTYPE *SetWhitePointRGB)(__RPC__in IWICDevelopRaw *This,
                                               /* [in] */ UINT Red,
                                               /* [in] */ UINT Green,
                                               /* [in] */ UINT Blue);
  ...
  HRESULT(STDMETHODCALLTYPE *SetContrast)(__RPC__in IWICDevelopRaw *This,
                                          /* [in] */ double Contrast);
  ...
  HRESULT(STDMETHODCALLTYPE *SetGamma)(__RPC__in IWICDevelopRaw *This,
                                       /* [in] */ double Gamma);

  DECLSPEC_XFGVIRT(IWICDevelopRaw, GetGamma)
  HRESULT(STDMETHODCALLTYPE *GetGamma)(__RPC__in IWICDevelopRaw *This,
                                       /* [out] */ __RPC__out double *pGamma);

  DECLSPEC_XFGVIRT(IWICDevelopRaw, SetSharpness)
  HRESULT(STDMETHODCALLTYPE *SetSharpness)(__RPC__in IWICDevelopRaw *This,
                                           /* [in] */ double Sharpness);
  ...
  HRESULT(STDMETHODCALLTYPE *SetSaturation)(__RPC__in IWICDevelopRaw *This,
  ...
  HRESULT(STDMETHODCALLTYPE *SetTint)(__RPC__in IWICDevelopRaw *This,
                                      /* [in] */ double Tint);

  DECLSPEC_XFGVIRT(IWICDevelopRaw, GetTint)
  HRESULT(STDMETHODCALLTYPE *GetTint)(__RPC__in IWICDevelopRaw *This,
  ...
  HRESULT(STDMETHODCALLTYPE *SetRotation)(__RPC__in IWICDevelopRaw *This,
                                          /* [in] */ double Rotation);
...
interface IWICDevelopRaw { CONST_VTBL struct IWICDevelopRawVtbl *lpVtbl; };
...
#define IWICDevelopRaw_GetColorContexts(This, cCount, ppIColorContexts,        \
                                        pcActualCount)                         \
  ((This)->lpVtbl->GetColorContexts(This, cCount, ppIColorContexts,            \
                                    pcActualCount))
...
#define IWICDevelopRaw_GetKelvinRangeInfo(                                     \
    This, pMinKelvinTemp, pMaxKelvinTemp, pKelvinTempStepValue)                \
  ((This)->lpVtbl->GetKelvinRangeInfo(This, pMinKelvinTemp, pMaxKelvinTemp,    \
...
#define IWICDevelopRaw_GetToneCurve(This, cbToneCurveBufferSize, pToneCurve,   \
                                    pcbActualToneCurveBufferSize)              \
  ((This)->lpVtbl->GetToneCurve(This, cbToneCurveBufferSize, pToneCurve,       \
                                pcbActualToneCurveBufferSize))
...
/* [call_as] */ HRESULT
STDMETHODCALLTYPE IWICDevelopRaw_Remote_QueryRawCapabilitiesInfo_Proxy(
    __RPC__in IWICDevelopRaw *This,
...
/* [call_as] */ HRESULT STDMETHODCALLTYPE
IWICDevelopRaw_Remote_SetToneCurve_Proxy(
    __RPC__in IWICDevelopRaw *This,
    /* [in] */ UINT cPoints,
    /* [size_is][in] */
...
/* [call_as] */ HRESULT STDMETHODCALLTYPE
IWICDevelopRaw_Remote_GetToneCurve_Proxy(
    __RPC__in IWICDevelopRaw *This,
    /* [out] */ __RPC__out UINT *pcPoints,
    /* [size_is][size_is][out] */
    __RPC__deref_out_ecount_full_opt(*pcPoints)
...
public:
  ...
  virtual HRESULT STDMETHODCALLTYPE GetFrame(
      ...
      /* [in] */ UINT mipLevel,
      /* [in] */ UINT sliceIndex,
      /* [retval][out] */ __RPC__deref_out_opt IWICBitmapFrameDecode *
          *ppIBitmapFrame) = 0;
};
...
typedef struct IWICDdsDecoderVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in IWICDdsDecoder *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IWICDdsDecoder *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IWICDdsDecoder *This);
...
interface IWICDdsDecoder { CONST_VTBL struct IWICDdsDecoderVtbl *lpVtbl; };
...
#define IWICDdsDecoder_GetFrame(This, arrayIndex, mipLevel, sliceIndex,        \
                                ppIBitmapFrame)                                \
  ((This)->lpVtbl->GetFrame(This, arrayIndex, mipLevel, sliceIndex,            \
                            ppIBitmapFrame))
...
typedef struct IWICDdsEncoderVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in IWICDdsEncoder *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IWICDdsEncoder *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IWICDdsEncoder *This);
...
interface IWICDdsEncoder { CONST_VTBL struct IWICDdsEncoderVtbl *lpVtbl; };
...
#define IWICDdsEncoder_CreateNewFrame(This, ppIFrameEncode, pArrayIndex,       \
                                      pMipLevel, pSliceIndex)                  \
  ((This)->lpVtbl->CreateNewFrame(This, ppIFrameEncode, pArrayIndex,           \
                                  pMipLevel, pSliceIndex))
...
typedef struct IWICDdsFrameDecodeVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in IWICDdsFrameDecode *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IWICDdsFrameDecode *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IWICDdsFrameDecode *This);
...
#define IWICDdsFrameDecode_GetSizeInBlocks(This, pWidthInBlocks,               \
                                           pHeightInBlocks)                    \
...
#define IWICDdsFrameDecode_CopyBlocks(This, prcBoundsInBlocks, cbStride,       \
                                      cbBufferSize, pbBuffer)                  \
...
public:
  ...
  virtual HRESULT STDMETHODCALLTYPE SetIndexing(
      WICJpegIndexingOptions options, UINT horizontalIntervalSize) = 0;
  ...
  virtual HRESULT STDMETHODCALLTYPE GetQuantizationTable(
      ...
      /* [range] */
      __RPC__in_range(0, WIC_JPEG_MAX_TABLE_INDEX) UINT tableIndex,
      /* [out] */ __RPC__out DXGI_JPEG_QUANTIZATION_TABLE *
          pQuantizationTable) = 0;
  ...
  virtual HRESULT STDMETHODCALLTYPE CopyScan(
      UINT scanIndex, UINT scanOffset,
      /* [in] */ UINT cbScanData,
  ...
  virtual HRESULT STDMETHODCALLTYPE CopyMinimalStream(
      ...
      /* [length_is][size_is][out] */
      __RPC__out_ecount_part(cbStreamData, *pcbStreamDataActual) BYTE *
          pbStreamData,
...
typedef struct IWICJpegFrameDecodeVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IWICJpegFrameDecode *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IWICJpegFrameDecode *This);
  ...
  HRESULT(STDMETHODCALLTYPE *SetIndexing)(__RPC__in IWICJpegFrameDecode *This,
  ...
  HRESULT(STDMETHODCALLTYPE *GetAcHuffmanTable)(
      __RPC__in IWICJpegFrameDecode *This, UINT scanIndex,
      /* [range] */
      __RPC__in_range(0, WIC_JPEG_MAX_TABLE_INDEX) UINT tableIndex,
  ...
  HRESULT(STDMETHODCALLTYPE *CopyScan)(
      __RPC__in IWICJpegFrameDecode *This, UINT scanIndex, UINT scanOffset,
      /* [in] */ UINT cbScanData,
      /* [length_is][size_is][out] */
      __RPC__out_ecount_part(cbScanData, *pcbScanDataActual) BYTE *pbScanData,
  ...
  HRESULT(STDMETHODCALLTYPE *CopyMinimalStream)(
      __RPC__in IWICJpegFrameDecode *This, UINT streamOffset,
      /* [in] */ UINT cbStreamData,
      /* [length_is][size_is][out] */
      __RPC__out_ecount_part(cbStreamData, *pcbStreamDataActual)
          BYTE *pbStreamData,
...
#define IWICJpegFrameDecode_AddRef(This) ((This)->lpVtbl->AddRef(This))

#define IWICJpegFrameDecode_Release(This) ((This)->lpVtbl->Release(This))
...
#define IWICJpegFrameDecode_GetAcHuffmanTable(This, scanIndex, tableIndex,     \
                                              pAcHuffmanTable)                 \
  ((This)->lpVtbl->GetAcHuffmanTable(This, scanIndex, tableIndex,              \
                                     pAcHuffmanTable))

#define IWICJpegFrameDecode_GetDcHuffmanTable(This, scanIndex, tableIndex,     \
                                              pDcHuffmanTable)                 \
  ((This)->lpVtbl->GetDcHuffmanTable(This, scanIndex, tableIndex,              \
                                     pDcHuffmanTable))

#define IWICJpegFrameDecode_GetQuantizationTable(This, scanIndex, tableIndex,  \
                                                 pQuantizationTable)           \
  ((This)->lpVtbl->GetQuantizationTable(This, scanIndex, tableIndex,           \
                                        pQuantizationTable))
...
#define IWICJpegFrameDecode_CopyScan(This, scanIndex, scanOffset, cbScanData,  \
                                     pbScanData, pcbScanDataActual)            \
  ((This)->lpVtbl->CopyScan(This, scanIndex, scanOffset, cbScanData,           \
                            pbScanData, pcbScanDataActual))

#define IWICJpegFrameDecode_CopyMinimalStream(                                 \
    This, streamOffset, cbStreamData, pbStreamData, pcbStreamDataActual)       \
  ((This)->lpVtbl->CopyMinimalStream(This, streamOffset, cbStreamData,         \
                                     pbStreamData, pcbStreamDataActual))
...
public:
  ...
  virtual HRESULT STDMETHODCALLTYPE WriteScan(
      /* [in] */ UINT cbScanData,
      /* [size_is][in] */ __RPC__in_ecount_full(cbScanData)
          const BYTE *pbScanData) = 0;
};
...
typedef struct IWICJpegFrameEncodeVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IWICJpegFrameEncode *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IWICJpegFrameEncode *This);

  DECLSPEC_XFGVIRT(IWICJpegFrameEncode, GetAcHuffmanTable)
  HRESULT(STDMETHODCALLTYPE *GetAcHuffmanTable)(
      __RPC__in IWICJpegFrameEncode *This, UINT scanIndex,
      /* [range] */
      __RPC__in_range(0, WIC_JPEG_MAX_TABLE_INDEX) UINT tableIndex,
      /* [out] */ __RPC__out DXGI_JPEG_AC_HUFFMAN_TABLE *pAcHuffmanTable);
  ...
  HRESULT(STDMETHODCALLTYPE *WriteScan)(__RPC__in IWICJpegFrameEncode *This,
                                        /* [in] */ UINT cbScanData,
                                        /* [size_is][in] */
                                        __RPC__in_ecount_full(cbScanData)
...
#define IWICJpegFrameEncode_AddRef(This) ((This)->lpVtbl->AddRef(This))

#define IWICJpegFrameEncode_Release(This) ((This)->lpVtbl->Release(This))

#define IWICJpegFrameEncode_GetAcHuffmanTable(This, scanIndex, tableIndex,     \
                                              pAcHuffmanTable)                 \
  ((This)->lpVtbl->GetAcHuffmanTable(This, scanIndex, tableIndex,              \
                                     pAcHuffmanTable))

#define IWICJpegFrameEncode_GetDcHuffmanTable(This, scanIndex, tableIndex,     \
                                              pDcHuffmanTable)                 \
  ((This)->lpVtbl->GetDcHuffmanTable(This, scanIndex, tableIndex,              \
                                     pDcHuffmanTable))

#define IWICJpegFrameEncode_GetQuantizationTable(This, scanIndex, tableIndex,  \
                                                 pQuantizationTable)           \
  ((This)->lpVtbl->GetQuantizationTable(This, scanIndex, tableIndex,           \
                                        pQuantizationTable))
...
unsigned long __RPC_USER HPALETTE_UserSize(__RPC__in unsigned long *,
                                           unsigned long, __RPC__in HPALETTE *);
unsigned char *__RPC_USER HPALETTE_UserMarshal(
    __RPC__in unsigned long *, __RPC__inout_xcount(0) unsigned char *,
    __RPC__in HPALETTE *);
unsigned char *__RPC_USER HPALETTE_UserUnmarshal(
    __RPC__in unsigned long *, __RPC__in_xcount(0) unsigned char *,
    __RPC__out HPALETTE *);
void __RPC_USER HPALETTE_UserFree(__RPC__in unsigned long *,
                                  __RPC__in HPALETTE *);
...
unsigned long __RPC_USER WICInProcPointer_UserSize(
    __RPC__in unsigned long *, unsigned long, __RPC__in WICInProcPointer *);
unsigned char *__RPC_USER WICInProcPointer_UserMarshal(
    __RPC__in unsigned long *, __RPC__inout_xcount(0) unsigned char *,
    __RPC__in WICInProcPointer *);
unsigned char *__RPC_USER WICInProcPointer_UserUnmarshal(
    __RPC__in unsigned long *, __RPC__in_xcount(0) unsigned char *,
    __RPC__out WICInProcPointer *);
void __RPC_USER WICInProcPointer_UserFree(__RPC__in unsigned long *,
                                          __RPC__in WICInProcPointer *);
...
/* [call_as] */ HRESULT STDMETHODCALLTYPE
IWICDevelopRaw_GetToneCurve_Stub(__RPC__in IWICDevelopRaw *This,
                                 /* [out] */ __RPC__out UINT *pcPoints,
                                 /* [size_is][size_is][out] */
                                 __RPC__deref_out_ecount_full_opt(*pcPoints)
                                     WICRawToneCurvePoint **paPoints);
