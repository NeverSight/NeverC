...
typedef interface IRadialControllerConfigurationInterop
...
typedef interface IRadialControllerIndependentInputSourceInterop
...
typedef struct IRadialControllerInteropVtbl {
  ...
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(IRadialControllerInterop *This,
                                             /* [in] */ REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(IRadialControllerInterop *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(IRadialControllerInterop *This);

  DECLSPEC_XFGVIRT(IInspectable, GetIids)
  HRESULT(STDMETHODCALLTYPE *GetIids)(IRadialControllerInterop *This,
                                      /* [out] */ ULONG *iidCount,
  ...
  HRESULT(STDMETHODCALLTYPE *GetTrustLevel)(IRadialControllerInterop *This,
                                            /* [out] */ TrustLevel *trustLevel);

  DECLSPEC_XFGVIRT(IRadialControllerInterop, CreateForWindow)
  HRESULT(STDMETHODCALLTYPE *CreateForWindow)(IRadialControllerInterop *This,
                                              /* [annotation][in] */
                                              _In_ HWND hwnd,
                                              /* [annotation][in] */
                                              _In_ REFIID riid,
...
typedef struct IRadialControllerConfigurationInteropVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(IRadialControllerConfigurationInterop *This);
...
#define IRadialControllerConfigurationInterop_QueryInterface(This, riid,       \
                                                             ppvObject)        \
  ((This)->lpVtbl->QueryInterface(This, riid, ppvObject))
...
#define IRadialControllerConfigurationInterop_GetRuntimeClassName(This,        \
                                                                  className)   \
  ((This)->lpVtbl->GetRuntimeClassName(This, className))
...
#define IRadialControllerConfigurationInterop_GetForWindow(This, hwnd, riid,   \
                                                           ppv)                \
...
typedef struct IRadialControllerIndependentInputSourceInteropVtbl {
  ...
  DECLSPEC_XFGVIRT(IRadialControllerIndependentInputSourceInterop,
                   CreateForWindow)
...
#define IRadialControllerIndependentInputSourceInterop_QueryInterface(         \
    This, riid, ppvObject)                                                     \
  ((This)->lpVtbl->QueryInterface(This, riid, ppvObject))
...
#define IRadialControllerIndependentInputSourceInterop_GetIids(This, iidCount, \
                                                               iids)           \
  ((This)->lpVtbl->GetIids(This, iidCount, iids))

#define IRadialControllerIndependentInputSourceInterop_GetRuntimeClassName(    \
    This, className)                                                           \
  ((This)->lpVtbl->GetRuntimeClassName(This, className))

#define IRadialControllerIndependentInputSourceInterop_GetTrustLevel(          \
    This, trustLevel)                                                          \
  ((This)->lpVtbl->GetTrustLevel(This, trustLevel))

#define IRadialControllerIndependentInputSourceInterop_CreateForWindow(        \
    This, hwnd, riid, ppv)                                                     \
  ((This)->lpVtbl->CreateForWindow(This, hwnd, riid, ppv))
