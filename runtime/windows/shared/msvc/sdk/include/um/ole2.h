...
//
//  File:       OLE2.h
//  Contents:   Main OLE2 header; Defines Linking and Emmebbeding interfaces,
//  and API's.
//              Also includes .h files for the compobj, and oleauto
//              subcomponents.
//
//----------------------------------------------------------------------------
#if !defined(_OLE2_H_)
...
_Check_return_ WINOLEAPI WriteFmtUserTypeStg(IN LPSTORAGE pstg,
                                             IN CLIPFORMAT cf,
                                             _In_z_ LPOLESTR lpszUserType);
WINOLEAPI
ReadFmtUserTypeStg(IN LPSTORAGE pstg, OUT CLIPFORMAT FAR *pcf,
                   _Outptr_opt_result_z_ LPOLESTR FAR *lplpszUserType);
...
_Check_return_ WINOLEAPI OleCreateEx(
    IN REFCLSID rclsid, IN REFIID riid, IN DWORD dwFlags, IN DWORD renderopt,
...
_Check_return_ WINOLEAPI OleCreateFromDataEx(
    IN LPDATAOBJECT pSrcDataObj, IN REFIID riid, IN DWORD dwFlags,
...
_Check_return_ WINOLEAPI OleCreateLinkFromDataEx(
    IN LPDATAOBJECT pSrcDataObj, IN REFIID riid, IN DWORD dwFlags,
    IN DWORD renderopt, IN ULONG cFormats, IN DWORD *rgAdvf,
    IN LPFORMATETC rgFormatEtc, IN IAdviseSink FAR *lpAdviseSink,
...
WINOLEAPI
OleCreateLinkEx(IN LPMONIKER pmkLinkSrc, IN REFIID riid, IN DWORD dwFlags,
                IN DWORD renderopt, IN ULONG cFormats, IN DWORD *rgAdvf,
                IN LPFORMATETC rgFormatEtc, IN IAdviseSink FAR *lpAdviseSink,
                OUT DWORD FAR *rgdwConnection, IN LPOLECLIENTSITE pClientSite,
                IN LPSTORAGE pStg, OUT LPVOID FAR *ppvObj);
...
WINOLEAPI OleCreateLinkToFileEx(IN LPCOLESTR lpszFileName, IN REFIID riid,
                                IN DWORD dwFlags, IN DWORD renderopt,
                                IN ULONG cFormats, IN DWORD *rgAdvf,
                                IN LPFORMATETC rgFormatEtc,
                                IN IAdviseSink FAR *lpAdviseSink,
                                OUT DWORD FAR *rgdwConnection,
                                IN LPOLECLIENTSITE pClientSite,
                                IN LPSTORAGE pStg, OUT LPVOID FAR *ppvObj);

WINOLEAPI OleCreateFromFile(IN REFCLSID rclsid, IN LPCOLESTR lpszFileName,
                            IN REFIID riid, IN DWORD renderopt,
                            IN LPFORMATETC lpFormatEtc,
                            IN LPOLECLIENTSITE pClientSite, IN LPSTORAGE pStg,
                            OUT LPVOID FAR *ppvObj);

_Check_return_ WINOLEAPI OleCreateFromFileEx(
    IN REFCLSID rclsid, IN LPCOLESTR lpszFileName, IN REFIID riid,
    IN DWORD dwFlags, IN DWORD renderopt, IN ULONG cFormats, IN DWORD *rgAdvf,
    IN LPFORMATETC rgFormatEtc, IN IAdviseSink FAR *lpAdviseSink,
    OUT DWORD FAR *rgdwConnection, IN LPOLECLIENTSITE pClientSite,
    IN LPSTORAGE pStg, OUT LPVOID FAR *ppvObj);

WINOLEAPI OleLoad(IN LPSTORAGE pStg, IN REFIID riid,
                  IN LPOLECLIENTSITE pClientSite, OUT LPVOID FAR *ppvObj);

WINOLEAPI OleSave(_In_ LPPERSISTSTORAGE pPS, _In_ LPSTORAGE pStg,
                  _In_ BOOL fSameAsLoad);

WINOLEAPI OleLoadFromStream(IN LPSTREAM pStm, IN REFIID iidInterface,
                            OUT LPVOID FAR *ppvObj);
...
WINOLEAPI OleGetClipboardWithEnterpriseInfo(
    _Outptr_result_nullonfailure_ IDataObject **dataObject,
...
WINOLEAPI_(HANDLE)
OleDuplicateData(IN HANDLE hSrc, IN CLIPFORMAT cfFormat, IN UINT uiFlags);
...
WINOLEAPI OleLockRunning(IN LPUNKNOWN pUnknown, IN BOOL fLock,
...
WINOLEAPI_(HGLOBAL)
OleGetIconOfFile(_In_ LPOLESTR lpszPath, IN BOOL fUseFileAsLabel);

WINOLEAPI_(HGLOBAL)
OleGetIconOfClass(IN REFCLSID rclsid, _In_opt_ LPOLESTR lpszLabel,
                  IN BOOL fUseTypeAsLabel);

WINOLEAPI_(HGLOBAL)
OleMetafilePictFromIconAndLabel(IN HICON hIcon, _In_ LPOLESTR lpszLabel,
                                _In_ LPOLESTR lpszSourceFile,
                                IN UINT iIconIndex);

/* Registration Database Helper APIs */

_Check_return_ WINOLEAPI OleRegGetUserType(IN REFCLSID clsid,
...
WINOLEAPI OleRegEnumVerbs(IN REFCLSID clsid,
                          _Outptr_ LPENUMOLEVERB FAR *ppenum);
...
typedef HRESULT(STDAPICALLTYPE *OLESTREAMQUERYCONVERTOLELINKCALLBACK)(
    _In_ LPCLSID pClsid, _In_ LPOLESTR szClass, _In_opt_ LPOLESTR szTopicName,
    _In_opt_ LPOLESTR szItemName, _In_opt_ LPOLESTR szUNCName,
    _In_opt_ ULONG linkUpdatingOption, _In_opt_ PVOID pvContext);
...
WINOLEAPI OleConvertOLESTREAMToIStorage2(
    _In_ LPOLESTREAM lpolestream, _Out_ LPSTORAGE pstg,
    _In_opt_ const DVTARGETDEVICE FAR *ptd, _In_opt_ DWORD opt,
...
WINOLEAPI
OleConvertOLESTREAMToIStorageEx(IN LPOLESTREAM polestm, OUT LPSTORAGE pstg,
...
WINOLEAPI OleConvertOLESTREAMToIStorageEx2(
    _In_ LPOLESTREAM polestm, _Out_ LPSTORAGE pstg,
    // Presentation data from OLESTREAM
    ...
    _In_opt_ DWORD opt, _In_opt_ PVOID pvCallbackContext,
    _In_opt_ OLESTREAMQUERYCONVERTOLELINKCALLBACK pQueryConvertOLELinkCallback);
