...
typedef interface IWTSProtocolLogonErrorRedirector
...
typedef interface IWRdsProtocolConnectionCallback
...
typedef interface IWRdsProtocolLogonErrorRedirector
...
typedef interface IWRdsProtocolConnectionSettings
...
typedef interface IWRdsEnhancedFastReconnectArbitrator
...
public:
  virtual HRESULT STDMETHODCALLTYPE CreateListener(
      ...
      /* [out] */ __RPC__deref_out_opt IWTSProtocolListener *
          *pProtocolListener) = 0;
...
typedef struct IWTSProtocolManagerVtbl {
  ...
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IWTSProtocolManager *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IWTSProtocolManager *This);
...
#define IWTSProtocolManager_CreateListener(This, wszListenerName,              \
                                           pProtocolListener)                  \
  ((This)->lpVtbl->CreateListener(This, wszListenerName, pProtocolListener))

#define IWTSProtocolManager_NotifyServiceStateChange(This,                     \
...
typedef struct IWTSProtocolListenerVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IWTSProtocolListener *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IWTSProtocolListener *This);
  ...
  HRESULT(STDMETHODCALLTYPE *StopListen)(__RPC__in IWTSProtocolListener *This);
...
public:
  virtual HRESULT STDMETHODCALLTYPE OnConnected(
      ...
      /* [out] */ __RPC__deref_out_opt IWTSProtocolConnectionCallback *
          *pCallback) = 0;
};
...
public:
  virtual HRESULT STDMETHODCALLTYPE GetLogonErrorRedirector(
      /* [out] */ __RPC__deref_out_opt IWTSProtocolLogonErrorRedirector *
      *ppLogonErrorRedir) = 0;
  ...
  virtual HRESULT STDMETHODCALLTYPE GetLicenseConnection(
      /* [out] */ __RPC__deref_out_opt IWTSProtocolLicenseConnection *
      *ppLicenseConnection) = 0;
  ...
  virtual HRESULT STDMETHODCALLTYPE SessionArbitrationEnumeration(
      ...
      /* [size_is][out] */
      __RPC__out_ecount_full(*pdwSessionIdentifierCount) ULONG *
          pSessionIdArray,
  ...
  virtual HRESULT STDMETHODCALLTYPE QueryProperty(
      ...
      /* [size_is][optional][in] */
      __RPC__in_ecount_full(ulNumEntriesIn)
          PWTS_PROPERTY_VALUE pPropertyEntriesIn,
      /* [size_is][optional][out] */
      __RPC__out_ecount_full(ulNumEntriesOut)
          PWTS_PROPERTY_VALUE pPropertyEntriesOut) = 0;

  virtual HRESULT STDMETHODCALLTYPE GetShadowConnection(
      /* [out] */ __RPC__deref_out_opt IWTSProtocolShadowConnection *
      *ppShadowConnection) = 0;
};
...
typedef struct IWTSProtocolConnectionVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IWTSProtocolConnection *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IWTSProtocolConnection *This);
  ...
  HRESULT(STDMETHODCALLTYPE *Close)(__RPC__in IWTSProtocolConnection *This);
  ...
  HRESULT(STDMETHODCALLTYPE *SendBeep)(__RPC__in IWTSProtocolConnection *This,
                                       /* [in] */ ULONG Frequency,
                                       /* [in] */ ULONG Duration);
...
#define IWTSProtocolConnection_GetLogonErrorRedirector(This,                   \
                                                       ppLogonErrorRedir)      \
...
#define IWTSProtocolConnection_GetProtocolHandles(                             \
    This, pKeyboardHandle, pMouseHandle, pBeepHandle, pVideoHandle)            \
  ((This)->lpVtbl->GetProtocolHandles(This, pKeyboardHandle, pMouseHandle,     \
                                      pBeepHandle, pVideoHandle))

#define IWTSProtocolConnection_ConnectNotify(This, SessionId)                  \
  ((This)->lpVtbl->ConnectNotify(This, SessionId))

#define IWTSProtocolConnection_IsUserAllowedToLogon(                           \
    This, SessionId, UserToken, pDomainName, pUserName)                        \
  ((This)->lpVtbl->IsUserAllowedToLogon(This, SessionId, UserToken,            \
                                        pDomainName, pUserName))

#define IWTSProtocolConnection_SessionArbitrationEnumeration(                  \
    This, hUserToken, bSingleSessionPerUserEnabled, pSessionIdArray,           \
    pdwSessionIdentifierCount)                                                 \
  ((This)->lpVtbl->SessionArbitrationEnumeration(                              \
      This, hUserToken, bSingleSessionPerUserEnabled, pSessionIdArray,         \
      pdwSessionIdentifierCount))

#define IWTSProtocolConnection_LogonNotify(This, hClientToken, wszUserName,    \
                                           wszDomainName, SessionId)           \
  ((This)->lpVtbl->LogonNotify(This, hClientToken, wszUserName, wszDomainName, \
                               SessionId))
...
#define IWTSProtocolConnection_CreateVirtualChannel(                           \
    This, szEndpointName, bStatic, RequestedPriority, phChannel)               \
  ((This)->lpVtbl->CreateVirtualChannel(This, szEndpointName, bStatic,         \
                                        RequestedPriority, phChannel))

#define IWTSProtocolConnection_QueryProperty(                                  \
    This, QueryType, ulNumEntriesIn, ulNumEntriesOut, pPropertyEntriesIn,      \
    pPropertyEntriesOut)                                                       \
  ((This)->lpVtbl->QueryProperty(This, QueryType, ulNumEntriesIn,              \
                                 ulNumEntriesOut, pPropertyEntriesIn,          \
                                 pPropertyEntriesOut))
...
public:
  virtual HRESULT STDMETHODCALLTYPE Start(
      ...
      /* [in] */ __RPC__in_opt IWTSProtocolShadowCallback *
          pShadowCallback) = 0;
...
#define IWTSProtocolShadowConnection_Start(This, pTargetServerName,            \
                                           TargetSessionId, HotKeyVk,          \
                                           HotkeyModifiers, pShadowCallback)   \
  ((This)->lpVtbl->Start(This, pTargetServerName, TargetSessionId, HotKeyVk,   \
                         HotkeyModifiers, pShadowCallback))

#define IWTSProtocolShadowConnection_Stop(This) ((This)->lpVtbl->Stop(This))

#define IWTSProtocolShadowConnection_DoTarget(                                 \
    This, pParam1, Param1Size, pParam2, Param2Size, pParam3, Param3Size,       \
    pParam4, Param4Size, pClientName)                                          \
  ((This)->lpVtbl->DoTarget(This, pParam1, Param1Size, pParam2, Param2Size,    \
                            pParam3, Param3Size, pParam4, Param4Size,          \
                            pClientName))
...
typedef struct IWTSProtocolShadowCallbackVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IWTSProtocolShadowCallback *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IWTSProtocolShadowCallback *This);
...
#define IWTSProtocolShadowCallback_InvokeTargetShadow(                         \
    This, pTargetServerName, TargetSessionId, pParam1, Param1Size, pParam2,    \
    Param2Size, pParam3, Param3Size, pParam4, Param4Size, pClientName)         \
  ((This)->lpVtbl->InvokeTargetShadow(                                         \
      This, pTargetServerName, TargetSessionId, pParam1, Param1Size, pParam2,  \
      Param2Size, pParam3, Param3Size, pParam4, Param4Size, pClientName))
...
public:
  ...
  virtual HRESULT STDMETHODCALLTYPE SendClientLicense(
      /* [size_is][in] */ __RPC__in_ecount_full(cbClientLicense)
          PBYTE pClientLicense,
...
#define IWTSProtocolLicenseConnection_RequestLicensingCapabilities(            \
    This, ppLicenseCapabilities, pcbLicenseCapabilities)                       \
  ((This)->lpVtbl->RequestLicensingCapabilities(This, ppLicenseCapabilities,   \
                                                pcbLicenseCapabilities))

#define IWTSProtocolLicenseConnection_SendClientLicense(This, pClientLicense,  \
                                                        cbClientLicense)       \
  ((This)->lpVtbl->SendClientLicense(This, pClientLicense, cbClientLicense))

#define IWTSProtocolLicenseConnection_RequestClientLicense(                    \
    This, Reserve1, Reserve2, ppClientLicense, pcbClientLicense)               \
  ((This)->lpVtbl->RequestClientLicense(This, Reserve1, Reserve2,              \
                                        ppClientLicense, pcbClientLicense))
...
public:
  ...
  virtual HRESULT STDMETHODCALLTYPE RedirectStatus(
      ...
      /* [out] */ __RPC__out WTS_LOGON_ERROR_REDIRECTOR_RESPONSE *
          pResponse) = 0;
...
#define IWTSProtocolLogonErrorRedirector_RedirectStatus(This, pszMessage,      \
                                                        pResponse)             \
  ((This)->lpVtbl->RedirectStatus(This, pszMessage, pResponse))

#define IWTSProtocolLogonErrorRedirector_RedirectMessage(                      \
    This, pszCaption, pszMessage, uType, pResponse)                            \
  ((This)->lpVtbl->RedirectMessage(This, pszCaption, pszMessage, uType,        \
                                   pResponse))

#define IWTSProtocolLogonErrorRedirector_RedirectLogonError(                   \
    This, ntsStatus, ntsSubstatus, pszCaption, pszMessage, uType, pResponse)   \
  ((This)->lpVtbl->RedirectLogonError(This, ntsStatus, ntsSubstatus,           \
                                      pszCaption, pszMessage, uType,           \
                                      pResponse))
...
public:
  ...
  virtual HRESULT STDMETHODCALLTYPE MergeSettings(
      ...
      /* [ref][out][in] */
      __RPC__inout PWRDS_CONNECTION_SETTINGS pWRdsConnectionSettings) = 0;
};
...
typedef struct IWRdsProtocolSettingsVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IWRdsProtocolSettings *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IWRdsProtocolSettings *This);
...
#define IWRdsProtocolSettings_AddRef(This) ((This)->lpVtbl->AddRef(This))

#define IWRdsProtocolSettings_Release(This) ((This)->lpVtbl->Release(This))

#define IWRdsProtocolSettings_GetSettings(This, WRdsSettingType,               \
                                          WRdsSettingLevel, pWRdsSettings)     \
  ((This)->lpVtbl->GetSettings(This, WRdsSettingType, WRdsSettingLevel,        \
                               pWRdsSettings))

#define IWRdsProtocolSettings_MergeSettings(                                   \
    This, pWRdsSettings, WRdsConnectionSettingLevel, pWRdsConnectionSettings)  \
  ((This)->lpVtbl->MergeSettings(This, pWRdsSettings,                          \
...
public:
  ...
  virtual HRESULT STDMETHODCALLTYPE CreateListener(
      /* [string][in] */ __RPC__in_string WCHAR * wszListenerName,
      /* [out] */ __RPC__deref_out_opt IWRdsProtocolListener *
          *pProtocolListener) = 0;
...
typedef struct IWRdsProtocolManagerVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IWRdsProtocolManager *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IWRdsProtocolManager *This);
...
#define IWRdsProtocolManager_AddRef(This) ((This)->lpVtbl->AddRef(This))

#define IWRdsProtocolManager_Release(This) ((This)->lpVtbl->Release(This))
...
#define IWRdsProtocolManager_CreateListener(This, wszListenerName,             \
                                            pProtocolListener)                 \
  ((This)->lpVtbl->CreateListener(This, wszListenerName, pProtocolListener))

#define IWRdsProtocolManager_NotifyServiceStateChange(This,                    \
                                                      pTSServiceStateChange)   \
  ((This)->lpVtbl->NotifyServiceStateChange(This, pTSServiceStateChange))
...
#define IWRdsProtocolManager_NotifySessionStateChange(This, SessionId,         \
                                                      EventId)                 \
  ((This)->lpVtbl->NotifySessionStateChange(This, SessionId, EventId))
...
public:
  virtual HRESULT STDMETHODCALLTYPE GetSettings(
      ...
      /* [ref][out] */ __RPC__out PWRDS_LISTENER_SETTINGS
          pWRdsListenerSettings) = 0;
...
typedef struct IWRdsProtocolListenerVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IWRdsProtocolListener *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IWRdsProtocolListener *This);
  ...
  HRESULT(STDMETHODCALLTYPE *StopListen)(__RPC__in IWRdsProtocolListener *This);
...
#define IWRdsProtocolListener_AddRef(This) ((This)->lpVtbl->AddRef(This))

#define IWRdsProtocolListener_Release(This) ((This)->lpVtbl->Release(This))

#define IWRdsProtocolListener_GetSettings(This, WRdsListenerSettingLevel,      \
                                          pWRdsListenerSettings)               \
  ((This)->lpVtbl->GetSettings(This, WRdsListenerSettingLevel,                 \
                               pWRdsListenerSettings))
...
public:
  virtual HRESULT STDMETHODCALLTYPE OnConnected(
      ...
      /* [out] */ __RPC__deref_out_opt IWRdsProtocolConnectionCallback *
          *pCallback) = 0;
};
...
#define IWRdsProtocolListenerCallback_OnConnected(                             \
    This, pConnection, pWRdsConnectionSettings, pCallback)                     \
  ((This)->lpVtbl->OnConnected(This, pConnection, pWRdsConnectionSettings,     \
                               pCallback))
...
public:
  virtual HRESULT STDMETHODCALLTYPE GetLogonErrorRedirector(
      /* [out] */ __RPC__deref_out_opt IWRdsProtocolLogonErrorRedirector *
      *ppLogonErrorRedir) = 0;
  ...
  virtual HRESULT STDMETHODCALLTYPE GetLicenseConnection(
      /* [out] */ __RPC__deref_out_opt IWRdsProtocolLicenseConnection *
      *ppLicenseConnection) = 0;
  ...
  virtual HRESULT STDMETHODCALLTYPE QueryProperty(
      ...
      /* [size_is][optional][in] */
      __RPC__in_ecount_full(ulNumEntriesIn)
          PWRDS_PROPERTY_VALUE pPropertyEntriesIn,
      /* [size_is][optional][out] */
      __RPC__out_ecount_full(ulNumEntriesOut)
          PWRDS_PROPERTY_VALUE pPropertyEntriesOut) = 0;

  virtual HRESULT STDMETHODCALLTYPE GetShadowConnection(
      /* [out] */ __RPC__deref_out_opt IWRdsProtocolShadowConnection *
      *ppShadowConnection) = 0;
...
typedef struct IWRdsProtocolConnectionVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IWRdsProtocolConnection *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IWRdsProtocolConnection *This);
  ...
  HRESULT(STDMETHODCALLTYPE *Close)(__RPC__in IWRdsProtocolConnection *This);
  ...
  HRESULT(STDMETHODCALLTYPE *QueryProperty)(
      ...
      /* [size_is][optional][out] */
      __RPC__out_ecount_full(ulNumEntriesOut)
          PWRDS_PROPERTY_VALUE pPropertyEntriesOut);
...
#define IWRdsProtocolConnection_AddRef(This) ((This)->lpVtbl->AddRef(This))

#define IWRdsProtocolConnection_Release(This) ((This)->lpVtbl->Release(This))

#define IWRdsProtocolConnection_GetLogonErrorRedirector(This,                  \
                                                        ppLogonErrorRedir)     \
  ((This)->lpVtbl->GetLogonErrorRedirector(This, ppLogonErrorRedir))
...
#define IWRdsProtocolConnection_GetClientMonitorData(This, pNumMonitors,       \
                                                     pPrimaryMonitor)          \
...
#define IWRdsProtocolConnection_GetLicenseConnection(This,                     \
                                                     ppLicenseConnection)      \
  ((This)->lpVtbl->GetLicenseConnection(This, ppLicenseConnection))
...
#define IWRdsProtocolConnection_NotifySessionId(This, SessionId,               \
                                                SessionHandle)                 \
  ((This)->lpVtbl->NotifySessionId(This, SessionId, SessionHandle))

#define IWRdsProtocolConnection_GetInputHandles(This, pKeyboardHandle,         \
                                                pMouseHandle, pBeepHandle)     \
  ((This)->lpVtbl->GetInputHandles(This, pKeyboardHandle, pMouseHandle,        \
                                   pBeepHandle))
...
#define IWRdsProtocolConnection_IsUserAllowedToLogon(                          \
    This, SessionId, UserToken, pDomainName, pUserName)                        \
  ((This)->lpVtbl->IsUserAllowedToLogon(This, SessionId, UserToken,            \
                                        pDomainName, pUserName))

#define IWRdsProtocolConnection_SessionArbitrationEnumeration(                 \
    This, hUserToken, bSingleSessionPerUserEnabled, pSessionIdArray,           \
    pdwSessionIdentifierCount)                                                 \
  ((This)->lpVtbl->SessionArbitrationEnumeration(                              \
      This, hUserToken, bSingleSessionPerUserEnabled, pSessionIdArray,         \
...
#define IWRdsProtocolConnection_LogonNotify(This, hClientToken, wszUserName,   \
                                            wszDomainName, SessionId,          \
                                            pWRdsConnectionSettings)           \
  ((This)->lpVtbl->LogonNotify(This, hClientToken, wszUserName, wszDomainName, \
                               SessionId, pWRdsConnectionSettings))
...
#define IWRdsProtocolConnection_Close(This) ((This)->lpVtbl->Close(This))
...
#define IWRdsProtocolConnection_CreateVirtualChannel(                          \
    This, szEndpointName, bStatic, RequestedPriority, phChannel)               \
  ((This)->lpVtbl->CreateVirtualChannel(This, szEndpointName, bStatic,         \
                                        RequestedPriority, phChannel))

#define IWRdsProtocolConnection_QueryProperty(                                 \
    This, QueryType, ulNumEntriesIn, ulNumEntriesOut, pPropertyEntriesIn,      \
    pPropertyEntriesOut)                                                       \
  ((This)->lpVtbl->QueryProperty(This, QueryType, ulNumEntriesIn,              \
                                 ulNumEntriesOut, pPropertyEntriesIn,          \
...
public:
  virtual HRESULT STDMETHODCALLTYPE Start(
      ...
      /* [in] */ BYTE HotKeyVk,
      /* [in] */ USHORT HotkeyModifiers,
      /* [in] */ __RPC__in_opt IWRdsProtocolShadowCallback *
          pShadowCallback) = 0;
...
#define IWRdsProtocolShadowConnection_Start(This, pTargetServerName,           \
                                            TargetSessionId, HotKeyVk,         \
                                            HotkeyModifiers, pShadowCallback)  \
  ((This)->lpVtbl->Start(This, pTargetServerName, TargetSessionId, HotKeyVk,   \
                         HotkeyModifiers, pShadowCallback))

#define IWRdsProtocolShadowConnection_Stop(This) ((This)->lpVtbl->Stop(This))

#define IWRdsProtocolShadowConnection_DoTarget(                                \
    This, pParam1, Param1Size, pParam2, Param2Size, pParam3, Param3Size,       \
    pParam4, Param4Size, pClientName)                                          \
  ((This)->lpVtbl->DoTarget(This, pParam1, Param1Size, pParam2, Param2Size,    \
                            pParam3, Param3Size, pParam4, Param4Size,          \
...
typedef struct IWRdsProtocolShadowCallbackVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IWRdsProtocolShadowCallback *This);
...
#define IWRdsProtocolShadowCallback_AddRef(This) ((This)->lpVtbl->AddRef(This))
...
#define IWRdsProtocolShadowCallback_InvokeTargetShadow(                        \
    This, pTargetServerName, TargetSessionId, pParam1, Param1Size, pParam2,    \
    Param2Size, pParam3, Param3Size, pParam4, Param4Size, pClientName)         \
  ((This)->lpVtbl->InvokeTargetShadow(                                         \
      This, pTargetServerName, TargetSessionId, pParam1, Param1Size, pParam2,  \
...
#define IWRdsProtocolLicenseConnection_RequestLicensingCapabilities(           \
    This, ppLicenseCapabilities, pcbLicenseCapabilities)                       \
  ((This)->lpVtbl->RequestLicensingCapabilities(This, ppLicenseCapabilities,   \
                                                pcbLicenseCapabilities))

#define IWRdsProtocolLicenseConnection_SendClientLicense(This, pClientLicense, \
                                                         cbClientLicense)      \
  ((This)->lpVtbl->SendClientLicense(This, pClientLicense, cbClientLicense))

#define IWRdsProtocolLicenseConnection_RequestClientLicense(                   \
    This, Reserve1, Reserve2, ppClientLicense, pcbClientLicense)               \
  ((This)->lpVtbl->RequestClientLicense(This, Reserve1, Reserve2,              \
                                        ppClientLicense, pcbClientLicense))
...
public:
  ...
  virtual HRESULT STDMETHODCALLTYPE RedirectStatus(
      /* [string][in] */ __RPC__in_string LPCWSTR pszMessage,
      /* [out] */ __RPC__out WRDS_LOGON_ERROR_REDIRECTOR_RESPONSE *
          pResponse) = 0;
...
#define IWRdsProtocolLogonErrorRedirector_QueryInterface(This, riid,           \
                                                         ppvObject)            \
  ((This)->lpVtbl->QueryInterface(This, riid, ppvObject))
...
#define IWRdsProtocolLogonErrorRedirector_RedirectStatus(This, pszMessage,     \
                                                         pResponse)            \
  ((This)->lpVtbl->RedirectStatus(This, pszMessage, pResponse))

#define IWRdsProtocolLogonErrorRedirector_RedirectMessage(                     \
    This, pszCaption, pszMessage, uType, pResponse)                            \
  ((This)->lpVtbl->RedirectMessage(This, pszCaption, pszMessage, uType,        \
                                   pResponse))

#define IWRdsProtocolLogonErrorRedirector_RedirectLogonError(                  \
    This, ntsStatus, ntsSubstatus, pszCaption, pszMessage, uType, pResponse)   \
  ((This)->lpVtbl->RedirectLogonError(This, ntsStatus, ntsSubstatus,           \
                                      pszCaption, pszMessage, uType,           \
                                      pResponse))
...
public:
  virtual HRESULT STDMETHODCALLTYPE GetHardwareId(
      /* [size_is][string][in] */ __RPC__in_ecount_full_string(Count) WCHAR *
...
typedef struct IWRdsWddmIddPropsVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in IWRdsWddmIddProps *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IWRdsWddmIddProps *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IWRdsWddmIddProps *This);

  DECLSPEC_XFGVIRT(IWRdsWddmIddProps, GetHardwareId)
  HRESULT(STDMETHODCALLTYPE *GetHardwareId)(__RPC__in IWRdsWddmIddProps *This,
                                            /* [size_is][string][in] */
                                            __RPC__in_ecount_full_string(Count)
                                                WCHAR *pDisplayDriverHardwareId,
                                            /* [in] */ DWORD Count);

  DECLSPEC_XFGVIRT(IWRdsWddmIddProps, OnDriverLoad)
  HRESULT(STDMETHODCALLTYPE *OnDriverLoad)(__RPC__in IWRdsWddmIddProps *This,
                                           /* [in] */ ULONG SessionId,
                                           /* [in] */ HANDLE_PTR DriverHandle);

  DECLSPEC_XFGVIRT(IWRdsWddmIddProps, OnDriverUnload)
  HRESULT(STDMETHODCALLTYPE *OnDriverUnload)(__RPC__in IWRdsWddmIddProps *This,
                                             /* [in] */ ULONG SessionId);

  DECLSPEC_XFGVIRT(IWRdsWddmIddProps, EnableWddmIdd)
  HRESULT(STDMETHODCALLTYPE *EnableWddmIdd)(__RPC__in IWRdsWddmIddProps *This,
                                            /* [in] */ BOOL Enabled);
...
#define IWRdsWddmIddProps_AddRef(This) ((This)->lpVtbl->AddRef(This))

#define IWRdsWddmIddProps_Release(This) ((This)->lpVtbl->Release(This))
...
typedef struct IWRdsWddmIddProps1Vtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in IWRdsWddmIddProps1 *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IWRdsWddmIddProps1 *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IWRdsWddmIddProps1 *This);

  DECLSPEC_XFGVIRT(IWRdsWddmIddProps1, GetHardwareId)
  HRESULT(STDMETHODCALLTYPE *GetHardwareId)(__RPC__in IWRdsWddmIddProps1 *This,
                                            /* [size_is][string][in] */
                                            __RPC__in_ecount_full_string(Count)
                                                WCHAR *pDisplayDriverHardwareId,
                                            /* [in] */ DWORD Count);
  ...
  HRESULT(STDMETHODCALLTYPE *OnDriverUnload)(__RPC__in IWRdsWddmIddProps1 *This,
                                             /* [in] */ ULONG SessionId);
...
#define IWRdsWddmIddProps1_AddRef(This) ((This)->lpVtbl->AddRef(This))

#define IWRdsWddmIddProps1_Release(This) ((This)->lpVtbl->Release(This))

#define IWRdsWddmIddProps1_GetHardwareId(This, pDisplayDriverHardwareId,       \
                                         Count)                                \
  ((This)->lpVtbl->GetHardwareId(This, pDisplayDriverHardwareId, Count))
...
#define IWRdsProtocolConnectionSettings_SetConnectionSetting(                  \
    This, PropertyID, pPropertyEntriesIn)                                      \
  ((This)->lpVtbl->SetConnectionSetting(This, PropertyID, pPropertyEntriesIn))

#define IWRdsProtocolConnectionSettings_GetConnectionSetting(                  \
    This, PropertyID, pPropertyEntriesOut)                                     \
...
typedef struct IWRdsEnhancedFastReconnectArbitratorVtbl {
  ...
  DECLSPEC_XFGVIRT(IWRdsEnhancedFastReconnectArbitrator,
...
#define IWRdsEnhancedFastReconnectArbitrator_QueryInterface(This, riid,        \
                                                            ppvObject)         \
  ((This)->lpVtbl->QueryInterface(This, riid, ppvObject))
...
#define IWRdsEnhancedFastReconnectArbitrator_GetSessionForEnhancedFastReconnect( \
    This, pSessionIdArray, dwSessionCount, pResultSessionId)                     \
  ((This)->lpVtbl->GetSessionForEnhancedFastReconnect(                           \
      This, pSessionIdArray, dwSessionCount, pResultSessionId))
...
public:
  virtual HRESULT STDMETHODCALLTYPE GetSerializedUserCredential(
      /* [out] */ __RPC__deref_out_opt WRDS_SERIALIZED_USER_CREDENTIAL *
      *userCredential) = 0;
};
...
typedef struct IWRdsProtocolConnection2Vtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IWRdsProtocolConnection2 *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IWRdsProtocolConnection2 *This);
  ...
  DECLSPEC_XFGVIRT(IWRdsProtocolConnection, Close)
  HRESULT(STDMETHODCALLTYPE *Close)(__RPC__in IWRdsProtocolConnection2 *This);
...
#define IWRdsProtocolConnection2_AddRef(This) ((This)->lpVtbl->AddRef(This))

#define IWRdsProtocolConnection2_Release(This) ((This)->lpVtbl->Release(This))

#define IWRdsProtocolConnection2_GetLogonErrorRedirector(This,                 \
                                                         ppLogonErrorRedir)    \
  ((This)->lpVtbl->GetLogonErrorRedirector(This, ppLogonErrorRedir))
...
#define IWRdsProtocolConnection2_GetClientMonitorData(This, pNumMonitors,      \
                                                      pPrimaryMonitor)         \
  ((This)->lpVtbl->GetClientMonitorData(This, pNumMonitors, pPrimaryMonitor))
...
#define IWRdsProtocolConnection2_GetLicenseConnection(This,                    \
                                                      ppLicenseConnection)     \
  ((This)->lpVtbl->GetLicenseConnection(This, ppLicenseConnection))
...
#define IWRdsProtocolConnection2_NotifySessionId(This, SessionId,              \
                                                 SessionHandle)                \
  ((This)->lpVtbl->NotifySessionId(This, SessionId, SessionHandle))

#define IWRdsProtocolConnection2_GetInputHandles(This, pKeyboardHandle,        \
                                                 pMouseHandle, pBeepHandle)    \
  ((This)->lpVtbl->GetInputHandles(This, pKeyboardHandle, pMouseHandle,        \
                                   pBeepHandle))
...
#define IWRdsProtocolConnection2_IsUserAllowedToLogon(                         \
    This, SessionId, UserToken, pDomainName, pUserName)                        \
  ((This)->lpVtbl->IsUserAllowedToLogon(This, SessionId, UserToken,            \
                                        pDomainName, pUserName))

#define IWRdsProtocolConnection2_SessionArbitrationEnumeration(                \
    This, hUserToken, bSingleSessionPerUserEnabled, pSessionIdArray,           \
    pdwSessionIdentifierCount)                                                 \
  ((This)->lpVtbl->SessionArbitrationEnumeration(                              \
      This, hUserToken, bSingleSessionPerUserEnabled, pSessionIdArray,         \
...
#define IWRdsProtocolConnection2_LogonNotify(This, hClientToken, wszUserName,  \
                                             wszDomainName, SessionId,         \
                                             pWRdsConnectionSettings)          \
  ((This)->lpVtbl->LogonNotify(This, hClientToken, wszUserName, wszDomainName, \
                               SessionId, pWRdsConnectionSettings))
...
#define IWRdsProtocolConnection2_Close(This) ((This)->lpVtbl->Close(This))
...
#define IWRdsProtocolConnection2_CreateVirtualChannel(                         \
    This, szEndpointName, bStatic, RequestedPriority, phChannel)               \
  ((This)->lpVtbl->CreateVirtualChannel(This, szEndpointName, bStatic,         \
                                        RequestedPriority, phChannel))

#define IWRdsProtocolConnection2_QueryProperty(                                \
    This, QueryType, ulNumEntriesIn, ulNumEntriesOut, pPropertyEntriesIn,      \
    pPropertyEntriesOut)                                                       \
  ((This)->lpVtbl->QueryProperty(This, QueryType, ulNumEntriesIn,              \
                                 ulNumEntriesOut, pPropertyEntriesIn,          \
...
#define IWRdsProtocolConnection2_GetSerializedUserCredential(This,             \
                                                             userCredential)   \
