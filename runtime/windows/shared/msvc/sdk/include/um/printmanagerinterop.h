...
typedef struct IPrintManagerInteropVtbl {
  ...
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IPrintManagerInterop *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IPrintManagerInterop *This);
...
#define IPrintManagerInterop_AddRef(This) ((This)->lpVtbl->AddRef(This))

#define IPrintManagerInterop_Release(This) ((This)->lpVtbl->Release(This))
...
#define IPrintManagerInterop_ShowPrintUIForWindowAsync(This, appWindow, riid,  \
                                                       asyncOperation)         \
