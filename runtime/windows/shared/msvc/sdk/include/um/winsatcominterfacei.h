...
#define IProvideWinSATAssessmentInfo_GetIDsOfNames(This, riid, rgszNames,      \
                                                   cNames, lcid, rgDispId)     \
  ((This)->lpVtbl->GetIDsOfNames(This, riid, rgszNames, cNames, lcid, rgDispId))

#define IProvideWinSATAssessmentInfo_Invoke(This, dispIdMember, riid, lcid,    \
...
public:
  virtual /* [id] */ HRESULT STDMETHODCALLTYPE GetAssessmentInfo(
      ...
      /* [retval][out] */ __RPC__deref_out_opt IProvideWinSATAssessmentInfo *
          *ppinfo) = 0;
...
typedef struct IProvideWinSATResultsInfoVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IProvideWinSATResultsInfo *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IProvideWinSATResultsInfo *This);
...
#define IProvideWinSATResultsInfo_GetIDsOfNames(This, riid, rgszNames, cNames, \
                                                lcid, rgDispId)                \
  ((This)->lpVtbl->GetIDsOfNames(This, riid, rgszNames, cNames, lcid, rgDispId))

#define IProvideWinSATResultsInfo_Invoke(This, dispIdMember, riid, lcid,       \
                                         wFlags, pDispParams, pVarResult,      \
                                         pExcepInfo, puArgErr)                 \
  ((This)->lpVtbl->Invoke(This, dispIdMember, riid, lcid, wFlags, pDispParams, \
                          pVarResult, pExcepInfo, puArgErr))
...
public:
  virtual /* [propget][id] */ HRESULT STDMETHODCALLTYPE get_XML(
      ...
      /* [retval][out] */ __RPC__deref_out_opt IXMLDOMNodeList *
          *ppDomNodeList) = 0;

  virtual /* [propget][id] */ HRESULT STDMETHODCALLTYPE get_Info(
      /* [retval][out] */ __RPC__deref_out_opt IProvideWinSATResultsInfo *
      *ppWinSATAssessmentInfo) = 0;
};
...
#define IQueryRecentWinSATAssessment_GetIDsOfNames(This, riid, rgszNames,      \
                                                   cNames, lcid, rgDispId)     \
  ((This)->lpVtbl->GetIDsOfNames(This, riid, rgszNames, cNames, lcid, rgDispId))

#define IQueryRecentWinSATAssessment_Invoke(This, dispIdMember, riid, lcid,    \
                                            wFlags, pDispParams, pVarResult,   \
                                            pExcepInfo, puArgErr)              \
  ((This)->lpVtbl->Invoke(This, dispIdMember, riid, lcid, wFlags, pDispParams, \
                          pVarResult, pExcepInfo, puArgErr))

#define IQueryRecentWinSATAssessment_get_XML(This, xPath, namespaces,          \
                                             ppDomNodeList)                    \
...
public:
  virtual HRESULT STDMETHODCALLTYPE get_Bitmap(
      /* [in] */ WINSAT_BITMAP_SIZE bitmapSize, WINSAT_ASSESSMENT_STATE state,
      float rating,
...
typedef struct IProvideWinSATVisualsVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IProvideWinSATVisuals *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IProvideWinSATVisuals *This);
...
#define IProvideWinSATVisuals_get_Bitmap(This, bitmapSize, state, rating,      \
                                         pBitmap)                              \
...
typedef struct IQueryAllWinSATAssessmentsVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IQueryAllWinSATAssessments *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IQueryAllWinSATAssessments *This);
...
#define IQueryAllWinSATAssessments_GetIDsOfNames(This, riid, rgszNames,        \
                                                 cNames, lcid, rgDispId)       \
  ((This)->lpVtbl->GetIDsOfNames(This, riid, rgszNames, cNames, lcid, rgDispId))

#define IQueryAllWinSATAssessments_Invoke(This, dispIdMember, riid, lcid,      \
                                          wFlags, pDispParams, pVarResult,     \
                                          pExcepInfo, puArgErr)                \
  ((This)->lpVtbl->Invoke(This, dispIdMember, riid, lcid, wFlags, pDispParams, \
                          pVarResult, pExcepInfo, puArgErr))

#define IQueryAllWinSATAssessments_get_AllXML(This, xPath, namespaces,         \
                                              ppDomNodeList)                   \
...
typedef struct IWinSATInitiateEventsVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IWinSATInitiateEvents *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IWinSATInitiateEvents *This);
...
#define IWinSATInitiateEvents_WinSATUpdate(This, uCurrentTick, uTickTotal,     \
                                           strCurrentState)                    \
  ((This)->lpVtbl->WinSATUpdate(This, uCurrentTick, uTickTotal,                \
                                strCurrentState))
...
public:
  virtual HRESULT STDMETHODCALLTYPE InitiateAssessment(
      ...
      /* [unique][optional][in] */ __RPC__in_opt IWinSATInitiateEvents *
          pCallbacks,
...
typedef struct IInitiateWinSATAssessmentVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IInitiateWinSATAssessment *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IInitiateWinSATAssessment *This);
...
#define IInitiateWinSATAssessment_InitiateAssessment(This, cmdLine,            \
                                                     pCallbacks, callerHwnd)   \
  ((This)->lpVtbl->InitiateAssessment(This, cmdLine, pCallbacks, callerHwnd))

#define IInitiateWinSATAssessment_InitiateFormalAssessment(This, pCallbacks,   \
                                                           callerHwnd)         \
...
typedef struct IAccessibleWinSATVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in IAccessibleWinSAT *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IAccessibleWinSAT *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IAccessibleWinSAT *This);
...
#define IAccessibleWinSAT_GetIDsOfNames(This, riid, rgszNames, cNames, lcid,   \
                                        rgDispId)                              \
  ((This)->lpVtbl->GetIDsOfNames(This, riid, rgszNames, cNames, lcid, rgDispId))

#define IAccessibleWinSAT_Invoke(This, dispIdMember, riid, lcid, wFlags,       \
...
#define IAccessibleWinSAT_get_accHelpTopic(This, pszHelpFile, varChild,        \
                                           pidTopic)                           \
  ((This)->lpVtbl->get_accHelpTopic(This, pszHelpFile, varChild, pidTopic))

#define IAccessibleWinSAT_get_accKeyboardShortcut(This, varChild,              \
                                                  pszKeyboardShortcut)         \
...
#define IAccessibleWinSAT_get_accDefaultAction(This, varChild,                 \
                                               pszDefaultAction)               \
...
#define IAccessibleWinSAT_accLocation(This, pxLeft, pyTop, pcxWidth,           \
                                      pcyHeight, varChild)                     \
...
public:
  virtual HRESULT STDMETHODCALLTYPE GetOEMPrePopulationInfo(
      /* [retval][out] */ __RPC__out WINSAT_OEM_CUSTOMIZATION_STATE *
      state) = 0;
};
...
class DECLSPEC_UUID("489331DC-F5E0-4528-9FDA-45331BF4A571") CInitiateWinSAT;
#endif
...
class DECLSPEC_UUID("F3BDFAD3-F276-49e9-9B17-C474F48F0764") CQueryWinSAT;
#endif
...
class DECLSPEC_UUID("05DF8D13-C355-47f4-A11E-851B338CEFB8") CQueryAllWinSAT;
#endif
...
class DECLSPEC_UUID("6e18f9c6-a3eb-495a-89b7-956482e19f7a") CAccessiblityWinSAT;
#endif
