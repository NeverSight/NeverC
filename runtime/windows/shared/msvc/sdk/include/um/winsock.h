...
int PASCAL FAR connect(_In_ SOCKET s,
                       _In_reads_bytes_(namelen)
                           const struct sockaddr FAR *name,
                       _In_ int namelen);

int PASCAL FAR ioctlsocket(_In_ SOCKET s, _In_ long cmd,
...
int PASCAL FAR getsockopt(_In_ SOCKET s, _In_ int level, _In_ int optname,
...
int PASCAL FAR recv(_In_ SOCKET s,
...
int PASCAL FAR select(_In_ int nfds, _Inout_opt_ fd_set FAR *readfds,
                      _Inout_opt_ fd_set FAR *writefds,
                      _Inout_opt_ fd_set FAR *exceptfds,
                      _In_opt_ const struct timeval FAR *timeout);

int PASCAL FAR send(_In_ SOCKET s, _In_reads_bytes_(len) const char FAR *buf,
                    _In_ int len, _In_ int flags);

int PASCAL FAR sendto(_In_ SOCKET s, _In_reads_bytes_(len) const char FAR *buf,
                      _In_ int len, _In_ int flags,
                      _In_reads_bytes_opt_(tolen) const struct sockaddr FAR *to,
                      _In_ int tolen);

int PASCAL FAR setsockopt(_In_ SOCKET s, _In_ int level, _In_ int optname,
...
struct hostent FAR *PASCAL FAR gethostbyaddr(_In_reads_bytes_(len)
                                                 const char FAR *addr,
                                             _In_ int len, _In_ int type);

struct hostent FAR *PASCAL FAR gethostbyname(_In_z_ const char FAR *name);

int PASCAL FAR gethostname(_Out_writes_bytes_to_(namelen,
...
HANDLE PASCAL FAR WSAAsyncGetHostByAddr(
    _In_ HWND hWnd, _In_ u_int wMsg, _In_ const char FAR *addr, _In_ int len,
    _In_ int type, _Out_writes_bytes_(buflen) char FAR *buf, _In_ int buflen);

int PASCAL FAR WSACancelAsyncRequest(_In_ HANDLE hAsyncTaskHandle);

int PASCAL FAR WSAAsyncSelect(_In_ SOCKET s, _In_ HWND hWnd, _In_ u_int wMsg,
                              _In_ long lEvent);
...
AcceptEx(_In_ SOCKET sListenSocket, _In_ SOCKET sAcceptSocket,
         _Out_writes_bytes_to_(dwReceiveDataLength + dwLocalAddressLength +
