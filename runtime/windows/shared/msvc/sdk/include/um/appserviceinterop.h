...
typedef interface IAppServiceConnectionExtendedExecution
...
typedef struct IAppServiceConnectionExtendedExecutionVtbl {
  ...
  DECLSPEC_XFGVIRT(IAppServiceConnectionExtendedExecution,
...
#define IAppServiceConnectionExtendedExecution_QueryInterface(This, riid,      \
                                                              ppvObject)       \
...
#define IAppServiceConnectionExtendedExecution_OpenForExtendedExecutionAsync(  \
    This, riid, operation)                                                     \
...
typedef struct ICorrelationVectorSourceVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in ICorrelationVectorSource *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in ICorrelationVectorSource *This);
...
#define ICorrelationVectorSource_AddRef(This) ((This)->lpVtbl->AddRef(This))

#define ICorrelationVectorSource_Release(This) ((This)->lpVtbl->Release(This))
