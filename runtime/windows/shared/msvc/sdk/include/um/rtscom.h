...
const GUID GUID_GESTURE_DATA = {
    0x41E4EC0F,
    0x26AA,
    0x455A,
    {0x9A, 0xA5, 0x2C, 0xD3, 0x6C, 0xF6, 0x3F, 0xB9}};
const GUID GUID_DYNAMIC_RENDERER_CACHED_DATA = {
    0xBF531B92,
    0x25BF,
    0x4A95,
    {0x89, 0xAD, 0x0E, 0x47, 0x6B, 0x34, 0xB4, 0xF5}};
...
typedef struct IRealTimeStylusVtbl {
  ...
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in IRealTimeStylus *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IRealTimeStylus *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IRealTimeStylus *This);
  ...
  /* [propputref] */ HRESULT(
      STDMETHODCALLTYPE *putref_ChildRealTimeStylusPlugin)(
      __RPC__in IRealTimeStylus *This,
  ...
  HRESULT(STDMETHODCALLTYPE *GetAllTabletContextIds)(
      ...
      /* [out][in] */ __RPC__inout ULONG *pcTcidCount,
      /* [size_is][size_is][out] */
      __RPC__deref_out_ecount_full_opt(*pcTcidCount)
  ...
  HRESULT(STDMETHODCALLTYPE *GetPacketDescriptionData)(
      ...
      /* [out][in] */ __RPC__inout ULONG *pcPacketProperties,
      /* [size_is][size_is][out] */
      __RPC__deref_out_ecount_full_opt(*pcPacketProperties)
          PACKET_PROPERTY **ppPacketProperties);

  END_INTERFACE
} IRealTimeStylusVtbl;

interface IRealTimeStylus { CONST_VTBL struct IRealTimeStylusVtbl *lpVtbl; };
...
#define IRealTimeStylus_AddCustomStylusDataToQueue(This, sq, pGuidId, cbData,  \
                                                   pbData)                     \
  ((This)->lpVtbl->AddCustomStylusDataToQueue(This, sq, pGuidId, cbData,       \
                                              pbData))
...
#define IRealTimeStylus_SetDesiredPacketDescription(This, cProperties,         \
                                                    pPropertyGuids)            \
  ((This)->lpVtbl->SetDesiredPacketDescription(This, cProperties,              \
                                               pPropertyGuids))

#define IRealTimeStylus_GetDesiredPacketDescription(This, pcProperties,        \
                                                    ppPropertyGuids)           \
  ((This)->lpVtbl->GetDesiredPacketDescription(This, pcProperties,             \
                                               ppPropertyGuids))

#define IRealTimeStylus_GetPacketDescriptionData(                              \
    This, tcid, pfInkToDeviceScaleX, pfInkToDeviceScaleY, pcPacketProperties,  \
    ppPacketProperties)                                                        \
  ((This)->lpVtbl->GetPacketDescriptionData(                                   \
      This, tcid, pfInkToDeviceScaleX, pfInkToDeviceScaleY,                    \
      pcPacketProperties, ppPacketProperties))
...
typedef struct IRealTimeStylus2Vtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in IRealTimeStylus2 *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IRealTimeStylus2 *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IRealTimeStylus2 *This);
...
interface IRealTimeStylus2 { CONST_VTBL struct IRealTimeStylus2Vtbl *lpVtbl; };
...
typedef struct IRealTimeStylus3Vtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in IRealTimeStylus3 *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IRealTimeStylus3 *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IRealTimeStylus3 *This);
...
interface IRealTimeStylus3 { CONST_VTBL struct IRealTimeStylus3Vtbl *lpVtbl; };
...
public:
  virtual HRESULT STDMETHODCALLTYPE CreateStroke(
      ...
      /* [size_is][in] */
      __RPC__in_ecount_full(cPacketProperties)
          const PACKET_PROPERTY *pPacketProperties,
  ...
  virtual HRESULT STDMETHODCALLTYPE BeginStroke(
      ...
      /* [in] */ FLOAT fInkToDeviceScaleY,
      /* [unique][out][in] */
      __RPC__deref_opt_inout_opt IInkStrokeDisp **ppIInkStroke) = 0;
  ...
  virtual HRESULT STDMETHODCALLTYPE AppendPackets(
      ...
      /* [size_is][in] */
      __RPC__in_ecount_full(cPktBuffLength) const LONG *pPackets) = 0;
...
typedef struct IStrokeBuilderVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in IStrokeBuilder *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IStrokeBuilder *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IStrokeBuilder *This);
...
interface IStrokeBuilder { CONST_VTBL struct IStrokeBuilderVtbl *lpVtbl; };
...
#define IStrokeBuilder_CreateStroke(                                           \
    This, cPktBuffLength, pPackets, cPacketProperties, pPacketProperties,      \
    fInkToDeviceScaleX, fInkToDeviceScaleY, ppIInkStroke)                      \
  ((This)->lpVtbl->CreateStroke(                                               \
      This, cPktBuffLength, pPackets, cPacketProperties, pPacketProperties,    \
      fInkToDeviceScaleX, fInkToDeviceScaleY, ppIInkStroke))

#define IStrokeBuilder_BeginStroke(                                            \
    This, tcid, sid, pPacket, cPacketProperties, pPacketProperties,            \
    fInkToDeviceScaleX, fInkToDeviceScaleY, ppIInkStroke)                      \
  ((This)->lpVtbl->BeginStroke(This, tcid, sid, pPacket, cPacketProperties,    \
                               pPacketProperties, fInkToDeviceScaleX,          \
                               fInkToDeviceScaleY, ppIInkStroke))

#define IStrokeBuilder_AppendPackets(This, tcid, sid, cPktBuffLength,          \
                                     pPackets)                                 \
...
public:
  virtual HRESULT STDMETHODCALLTYPE RealTimeStylusEnabled(
      ...
      /* [size_is][in] */
      __RPC__in_ecount_full(cTcidCount) const TABLET_CONTEXT_ID *pTcids) = 0;
  ...
  virtual HRESULT STDMETHODCALLTYPE CustomStylusDataAdded(
      ...
      /* [range][in] */ __RPC__in_range(0, 0x7fff) ULONG cbData,
      /* [unique][size_is][in] */
      __RPC__in_ecount_full_opt(cbData) const BYTE *pbData) = 0;
  ...
  virtual HRESULT STDMETHODCALLTYPE DataInterest(
      /* [retval][out] */ __RPC__out RealTimeStylusDataInterest *
      pDataInterest) = 0;
};
...
typedef struct IStylusPluginVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in IStylusPlugin *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IStylusPlugin *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IStylusPlugin *This);
...
interface IStylusPlugin { CONST_VTBL struct IStylusPluginVtbl *lpVtbl; };
...
#define IStylusPlugin_RealTimeStylusEnabled(This, piRtsSrc, cTcidCount,        \
                                            pTcids)                            \
  ((This)->lpVtbl->RealTimeStylusEnabled(This, piRtsSrc, cTcidCount, pTcids))

#define IStylusPlugin_RealTimeStylusDisabled(This, piRtsSrc, cTcidCount,       \
                                             pTcids)                           \
...
#define IStylusPlugin_StylusDown(This, piRtsSrc, pStylusInfo,                  \
                                 cPropCountPerPkt, pPacket, ppInOutPkt)        \
  ((This)->lpVtbl->StylusDown(This, piRtsSrc, pStylusInfo, cPropCountPerPkt,   \
                              pPacket, ppInOutPkt))

#define IStylusPlugin_StylusUp(This, piRtsSrc, pStylusInfo, cPropCountPerPkt,  \
                               pPacket, ppInOutPkt)                            \
  ((This)->lpVtbl->StylusUp(This, piRtsSrc, pStylusInfo, cPropCountPerPkt,     \
                            pPacket, ppInOutPkt))

#define IStylusPlugin_StylusButtonDown(This, piRtsSrc, sid, pGuidStylusButton, \
                                       pStylusPos)                             \
  ((This)->lpVtbl->StylusButtonDown(This, piRtsSrc, sid, pGuidStylusButton,    \
                                    pStylusPos))

#define IStylusPlugin_StylusButtonUp(This, piRtsSrc, sid, pGuidStylusButton,   \
                                     pStylusPos)                               \
  ((This)->lpVtbl->StylusButtonUp(This, piRtsSrc, sid, pGuidStylusButton,      \
                                  pStylusPos))

#define IStylusPlugin_InAirPackets(This, piRtsSrc, pStylusInfo, cPktCount,     \
                                   cPktBuffLength, pPackets, pcInOutPkts,      \
                                   ppInOutPkts)                                \
  ((This)->lpVtbl->InAirPackets(This, piRtsSrc, pStylusInfo, cPktCount,        \
                                cPktBuffLength, pPackets, pcInOutPkts,         \
                                ppInOutPkts))

#define IStylusPlugin_Packets(This, piRtsSrc, pStylusInfo, cPktCount,          \
                              cPktBuffLength, pPackets, pcInOutPkts,           \
                              ppInOutPkts)                                     \
  ((This)->lpVtbl->Packets(This, piRtsSrc, pStylusInfo, cPktCount,             \
                           cPktBuffLength, pPackets, pcInOutPkts,              \
                           ppInOutPkts))

#define IStylusPlugin_CustomStylusDataAdded(This, piRtsSrc, pGuidId, cbData,   \
                                            pbData)                            \
  ((This)->lpVtbl->CustomStylusDataAdded(This, piRtsSrc, pGuidId, cbData,      \
                                         pbData))
...
#define IStylusPlugin_Error(This, piRtsSrc, piPlugin, dataInterest,            \
                            hrErrorCode, lptrKey)                              \
  ((This)->lpVtbl->Error(This, piRtsSrc, piPlugin, dataInterest, hrErrorCode,  \
                         lptrKey))
...
IStylusSyncPlugin : public IStylusPlugin{public : };
...
typedef struct IStylusSyncPluginVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in IStylusSyncPlugin *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IStylusSyncPlugin *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IStylusSyncPlugin *This);
...
#define IStylusSyncPlugin_RealTimeStylusEnabled(This, piRtsSrc, cTcidCount,    \
                                                pTcids)                        \
  ((This)->lpVtbl->RealTimeStylusEnabled(This, piRtsSrc, cTcidCount, pTcids))

#define IStylusSyncPlugin_RealTimeStylusDisabled(This, piRtsSrc, cTcidCount,   \
                                                 pTcids)                       \
  ((This)->lpVtbl->RealTimeStylusDisabled(This, piRtsSrc, cTcidCount, pTcids))
...
#define IStylusSyncPlugin_StylusDown(This, piRtsSrc, pStylusInfo,              \
                                     cPropCountPerPkt, pPacket, ppInOutPkt)    \
  ((This)->lpVtbl->StylusDown(This, piRtsSrc, pStylusInfo, cPropCountPerPkt,   \
                              pPacket, ppInOutPkt))

#define IStylusSyncPlugin_StylusUp(This, piRtsSrc, pStylusInfo,                \
                                   cPropCountPerPkt, pPacket, ppInOutPkt)      \
  ((This)->lpVtbl->StylusUp(This, piRtsSrc, pStylusInfo, cPropCountPerPkt,     \
                            pPacket, ppInOutPkt))

#define IStylusSyncPlugin_StylusButtonDown(This, piRtsSrc, sid,                \
                                           pGuidStylusButton, pStylusPos)      \
  ((This)->lpVtbl->StylusButtonDown(This, piRtsSrc, sid, pGuidStylusButton,    \
                                    pStylusPos))

#define IStylusSyncPlugin_StylusButtonUp(This, piRtsSrc, sid,                  \
                                         pGuidStylusButton, pStylusPos)        \
  ((This)->lpVtbl->StylusButtonUp(This, piRtsSrc, sid, pGuidStylusButton,      \
                                  pStylusPos))

#define IStylusSyncPlugin_InAirPackets(This, piRtsSrc, pStylusInfo, cPktCount, \
                                       cPktBuffLength, pPackets, pcInOutPkts,  \
                                       ppInOutPkts)                            \
  ((This)->lpVtbl->InAirPackets(This, piRtsSrc, pStylusInfo, cPktCount,        \
                                cPktBuffLength, pPackets, pcInOutPkts,         \
...
#define IStylusSyncPlugin_Packets(This, piRtsSrc, pStylusInfo, cPktCount,      \
                                  cPktBuffLength, pPackets, pcInOutPkts,       \
                                  ppInOutPkts)                                 \
  ((This)->lpVtbl->Packets(This, piRtsSrc, pStylusInfo, cPktCount,             \
                           cPktBuffLength, pPackets, pcInOutPkts,              \
...
#define IStylusSyncPlugin_CustomStylusDataAdded(This, piRtsSrc, pGuidId,       \
                                                cbData, pbData)                \
  ((This)->lpVtbl->CustomStylusDataAdded(This, piRtsSrc, pGuidId, cbData,      \
                                         pbData))

#define IStylusSyncPlugin_SystemEvent(This, piRtsSrc, tcid, sid, event,        \
                                      eventdata)                               \
  ((This)->lpVtbl->SystemEvent(This, piRtsSrc, tcid, sid, event, eventdata))
...
#define IStylusSyncPlugin_Error(This, piRtsSrc, piPlugin, dataInterest,        \
                                hrErrorCode, lptrKey)                          \
  ((This)->lpVtbl->Error(This, piRtsSrc, piPlugin, dataInterest, hrErrorCode,  \
                         lptrKey))
...
IStylusAsyncPlugin : public IStylusPlugin{public : };
...
typedef struct IStylusAsyncPluginVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in IStylusAsyncPlugin *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IStylusAsyncPlugin *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IStylusAsyncPlugin *This);
...
#define IStylusAsyncPlugin_RealTimeStylusEnabled(This, piRtsSrc, cTcidCount,   \
                                                 pTcids)                       \
  ((This)->lpVtbl->RealTimeStylusEnabled(This, piRtsSrc, cTcidCount, pTcids))

#define IStylusAsyncPlugin_RealTimeStylusDisabled(This, piRtsSrc, cTcidCount,  \
                                                  pTcids)                      \
  ((This)->lpVtbl->RealTimeStylusDisabled(This, piRtsSrc, cTcidCount, pTcids))
...
#define IStylusAsyncPlugin_StylusDown(This, piRtsSrc, pStylusInfo,             \
                                      cPropCountPerPkt, pPacket, ppInOutPkt)   \
  ((This)->lpVtbl->StylusDown(This, piRtsSrc, pStylusInfo, cPropCountPerPkt,   \
                              pPacket, ppInOutPkt))

#define IStylusAsyncPlugin_StylusUp(This, piRtsSrc, pStylusInfo,               \
                                    cPropCountPerPkt, pPacket, ppInOutPkt)     \
  ((This)->lpVtbl->StylusUp(This, piRtsSrc, pStylusInfo, cPropCountPerPkt,     \
                            pPacket, ppInOutPkt))

#define IStylusAsyncPlugin_StylusButtonDown(This, piRtsSrc, sid,               \
                                            pGuidStylusButton, pStylusPos)     \
  ((This)->lpVtbl->StylusButtonDown(This, piRtsSrc, sid, pGuidStylusButton,    \
                                    pStylusPos))

#define IStylusAsyncPlugin_StylusButtonUp(This, piRtsSrc, sid,                 \
                                          pGuidStylusButton, pStylusPos)       \
  ((This)->lpVtbl->StylusButtonUp(This, piRtsSrc, sid, pGuidStylusButton,      \
                                  pStylusPos))

#define IStylusAsyncPlugin_InAirPackets(This, piRtsSrc, pStylusInfo,           \
...
#define IStylusAsyncPlugin_Packets(This, piRtsSrc, pStylusInfo, cPktCount,     \
                                   cPktBuffLength, pPackets, pcInOutPkts,      \
                                   ppInOutPkts)                                \
  ((This)->lpVtbl->Packets(This, piRtsSrc, pStylusInfo, cPktCount,             \
                           cPktBuffLength, pPackets, pcInOutPkts,              \
...
#define IStylusAsyncPlugin_CustomStylusDataAdded(This, piRtsSrc, pGuidId,      \
                                                 cbData, pbData)               \
  ((This)->lpVtbl->CustomStylusDataAdded(This, piRtsSrc, pGuidId, cbData,      \
                                         pbData))

#define IStylusAsyncPlugin_SystemEvent(This, piRtsSrc, tcid, sid, event,       \
                                       eventdata)                              \
  ((This)->lpVtbl->SystemEvent(This, piRtsSrc, tcid, sid, event, eventdata))
...
#define IStylusAsyncPlugin_Error(This, piRtsSrc, piPlugin, dataInterest,       \
                                 hrErrorCode, lptrKey)                         \
  ((This)->lpVtbl->Error(This, piRtsSrc, piPlugin, dataInterest, hrErrorCode,  \
                         lptrKey))
...
public:
  ...
  virtual HRESULT STDMETHODCALLTYPE ReleaseCachedData(ULONG strokeId) = 0;
...
typedef struct IDynamicRendererVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in IDynamicRenderer *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IDynamicRenderer *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IDynamicRenderer *This);
  ...
  HRESULT(STDMETHODCALLTYPE *ReleaseCachedData)(
      __RPC__in IDynamicRenderer *This, ULONG strokeId);

  DECLSPEC_XFGVIRT(IDynamicRenderer, Refresh)
  HRESULT(STDMETHODCALLTYPE *Refresh)(__RPC__in IDynamicRenderer *This);

  DECLSPEC_XFGVIRT(IDynamicRenderer, Draw)
  HRESULT(STDMETHODCALLTYPE *Draw)(__RPC__in IDynamicRenderer *This,
                                   /* [in] */ HANDLE_PTR hDC);

  END_INTERFACE
} IDynamicRendererVtbl;

interface IDynamicRenderer { CONST_VTBL struct IDynamicRendererVtbl *lpVtbl; };
...
public:
  ...
  virtual HRESULT STDMETHODCALLTYPE EnableGestures(
      ...
      /* [size_is][in] */ __RPC__in_ecount_full(cGestures)
          const int *pGestures) = 0;
...
typedef struct IGestureRecognizerVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in IGestureRecognizer *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IGestureRecognizer *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IGestureRecognizer *This);
  ...
  HRESULT(STDMETHODCALLTYPE *Reset)(__RPC__in IGestureRecognizer *This);
...
class DECLSPEC_UUID("ECD32AEA-746F-4dcb-BF68-082757FAFF18") DynamicRenderer;
#endif
...
class DECLSPEC_UUID("EA30C654-C62C-441f-AC00-95F9A196782C") GestureRecognizer;
#endif
...
class DECLSPEC_UUID("E810CEE7-6E51-4cb0-AA3A-0B985B70DAF7") StrokeBuilder;
#endif
