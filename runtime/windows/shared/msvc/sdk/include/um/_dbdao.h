...
*													*
*************************************************************************
** Copyright (C) 1996 by Microsoft Corporation 	* *		   All Rights
* Reserved
*		*
************************************************************************/
/*
...
inline CONSTRUCTOR CdbVariant::CdbVariant(SHORT s, BOOL bIsBool)
    : COleVariant(s) {
  if (bIsBool) {
    vt = VT_BOOL;
    boolVal = s;
...
public:
  ...
  LPUNKNOWN GetInterface(BOOL bAddRef = FALSE,
...
// Need some extra functions in CdbWorkspaces to support the delay in creating
// the default workspace needed to support the JET/ODBC option.
