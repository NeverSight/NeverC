...
//
// Class ID for OEM rendering component. All OEM rendering plugins need to use
// this ID.
//
// {6d6abf26-9f38-11d1-882a-00c04fb961ec}
//

DEFINE_GUID(CLSID_OEMRENDER, 0x6d6abf26, 0x9f38, 0x11d1, 0x88, 0x2a, 0x00, 0xc0,
            0x4f, 0xb9, 0x61, 0xec);
...
DEFINE_GUID(CLSID_OEMUI, 0xabce80d7, 0x9f46, 0x11d1, 0x88, 0x2a, 0x00, 0xc0,
            0x4f, 0xb9, 0x61, 0xec);
...
DEFINE_GUID(CLSID_OEMUIMXDC, 0x4e144300, 0x5b43, 0x4288, 0x93, 0x2a, 0x5e, 0x4d,
            0xd6, 0xd8, 0x2b, 0xed);

//
// Class ID for OEM Print Ticket support.  All OEM UI plugins need to use this
// ID.
//
// {91723892-45D2-48e2-9EC9-562379DAF992}
//

DEFINE_GUID(CLSID_OEMPTPROVIDER, 0x91723892, 0x45d2, 0x48e2, 0x9e, 0xc9, 0x56,
            0x23, 0x79, 0xda, 0xf9, 0x92);
...
DEFINE_GUID(IID_IPrintCoreHelper, 0xa89ec53e, 0x3905, 0x49c6, 0x9c, 0x1a, 0xc0,
            0xa8, 0x81, 0x17, 0xfd, 0xb6);
...
DEFINE_GUID(IID_IPrintCoreHelperUni, 0x7e8e51d6, 0xe5ee, 0x4426, 0x81, 0x7b,
            0x95, 0x8b, 0x94, 0x44, 0xeb, 0x79);
...
DEFINE_GUID(IID_IPrintCoreHelperPS, 0xc2c14f6f, 0x95d3, 0x4d63, 0x96, 0xcf,
            0x6b, 0xd9, 0xe6, 0xc9, 0x7, 0xc2);
...
//
DEFINE_GUID(IID_IPrintCoreHelperUni2, 0x6c8afdfc, 0xead0, 0x4d2d, 0x80, 0x71,
            0x9b, 0xf0, 0x17, 0x5a, 0x6c, 0x3a);
...
DEFINE_GUID(IID_IPrintOemCommon, 0x7f42285e, 0x91d5, 0x11d1, 0x88, 0x20, 0x00,
            0xc0, 0x4f, 0xb9, 0x61, 0xec);
...
DEFINE_GUID(IID_IPrintOemEngine, 0x63d17590, 0x91d8, 0x11d1, 0x88, 0x20, 0x00,
            0xc0, 0x4f, 0xb9, 0x61, 0xec);
...
DEFINE_GUID(IID_IPrintOemUI, 0xc6a7a9d0, 0x774c, 0x11d1, 0x94, 0x7f, 0x0, 0xa0,
            0xc9, 0x6, 0x40, 0xb8);
...
DEFINE_GUID(IID_IPrintOemUI2, 0x292515f9, 0xb54b, 0x489b, 0x92, 0x75, 0xba,
            0xb5, 0x68, 0x21, 0x39, 0x5e);
...
DEFINE_GUID(IID_IPrintOemUIMXDC, 0x7349d725, 0xe2c1, 0x4dca, 0xaf, 0xb5, 0xc1,
            0x3e, 0x91, 0xbc, 0x93, 0x6);
#endif // (NTDDI_VERSION >= NTDDI_VISTA)
...
DEFINE_GUID(IID_IPrintOemDriverUI, 0x92b05d50, 0x78bc, 0x11d1, 0x94, 0x80, 0x0,
            0xa0, 0xc9, 0x6, 0x40, 0xb8);
...
DEFINE_GUID(IID_IPrintCoreUI2, 0x85ccfca, 0x3adf, 0x4c9e, 0xb4, 0x91, 0xd8,
            0x51, 0xa6, 0xed, 0xc9, 0x97);
#endif // (NTDDI_VERSION >= NTDDI_WINXP)
...
DEFINE_GUID(IID_IPrintOemPS, 0x688342b5, 0x8e1a, 0x11d1, 0x88, 0x1f, 0x00, 0xc0,
            0x4f, 0xb9, 0x61, 0xec);
...
DEFINE_GUID(IID_IPrintOemPS2, 0xbecf7f34, 0x51b3, 0x46c9, 0x8a, 0x1c, 0x18,
            0x67, 0x9b, 0xd2, 0x1f, 0x36);
...
DEFINE_GUID(IID_IPrintOemDriverPS, 0xd90060c7, 0x8e1a, 0x11d1, 0x88, 0x1f, 0x00,
            0xc0, 0x4f, 0xb9, 0x61, 0xec);
...
DEFINE_GUID(IID_IPrintCorePS2, 0xcdbb0b0b, 0xa917, 0x40d7, 0x9f, 0xbf, 0x48,
            0x3b, 0x3b, 0xe7, 0xef, 0x22);
#endif // (NTDDI_VERSION >= NTDDI_WINXP)
...
DEFINE_GUID(IID_IPrintOemUni, 0xd67ebbf0, 0x78bf, 0x11d1, 0x94, 0x80, 0x0, 0xa0,
            0xc9, 0x6, 0x40, 0xb8);
...
DEFINE_GUID(IID_IPrintOemUni2, 0xb91220ac, 0x15cc, 0x4e7a, 0xa2, 0x1e, 0x95,
            0x91, 0xf3, 0x4d, 0x6f, 0x6c);
#endif // (NTDDI_VERSION >= NTDDI_WINXP)
...
DEFINE_GUID(IID_IPrintOemUni3, 0x4e4a7747, 0xbc76, 0x4aed, 0xac, 0xc8, 0xc7,
            0x6a, 0xf2, 0x2a, 0xad, 0x43);
#endif // (NTDDI_VERSION >= NTDDI_VISTA)
...
DEFINE_GUID(IID_IPrintOemDriverUni, 0xd67ebbf1, 0x78bf, 0x11d1, 0x94, 0x80, 0x0,
            0xa0, 0xc9, 0x6, 0x40, 0xb8);
...
//
DEFINE_GUID(IID_IPrintOemPrintTicketProvider, 0xbcf5e011, 0xf60a, 0x49ff, 0xab,
            0x2f, 0xe0, 0x6f, 0x4a, 0xbd, 0xf2, 0x81);
...
DECLARE_INTERFACE_(IPrintCoreHelper, IUnknown) {
  ...
  // IUnknown methods
  //
  STDMETHOD(QueryInterface)(THIS_ REFIID riid, _COM_Outptr_ LPVOID * ppvObj)
      PURE;
  ...
  STDMETHOD(GetOption)(
      THIS_ _In_reads_bytes_opt_(cbSize) CONST DEVMODE * pDevmode,
      OPTIONAL _In_ DWORD cbSize, _In_ PCSTR pszFeatureRequested,
  ...
  STDMETHOD(SetOptions)(
      THIS_ IN PDEVMODE pDevmode, OPTIONAL IN DWORD cbSize,
      IN BOOL bResolveConflicts, IN CONST PRINT_FEATURE_OPTION pFOPairs[],
      IN DWORD cPairs, OUT PDWORD pcPairsWritten, OUT PDWORD pdwResult) PURE;
  ...
  STDMETHOD(EnumConstrainedOptions)(
      THIS_ IN CONST DEVMODE * pDevmode, OPTIONAL IN DWORD cbSize,
      IN PCSTR pszFeatureKeyword, OUT PCSTR * pConstrainedOptionList[],
  ...
  STDMETHOD(WhyConstrained)(
      THIS_ _In_reads_bytes_opt_(cbSize) CONST DEVMODE * pDevmode,
      OPTIONAL _In_ DWORD cbSize, _In_ PCSTR pszFeatureKeyword,
      _In_ PCSTR pszOptionKeyword,
      _Outptr_result_buffer_(*pdwNumOptions) CONST PRINT_FEATURE_OPTION *
          *ppFOConstraints,
  ...
  STDMETHOD(EnumFeatures)(THIS_ _Outptr_result_buffer_(*pdwNumFeatures) PCSTR *
                              pFeatureList[],
  ...
  STDMETHOD(EnumOptions)(THIS_ _In_ PCSTR pszFeatureKeyword,
                         _Outptr_result_buffer_(*pdwNumOptions) PCSTR *
                             pOptionList[],
                         _Out_ DWORD * pdwNumOptions) PURE;
  ...
  STDMETHOD(GetFontSubstitution)(THIS_ IN PCWSTR pszTrueTypeFontName,
  ...
  STDMETHOD(SetFontSubstitution)(THIS_ IN PCWSTR pszTrueTypeFontName,
  ...
  STDMETHOD(CreateInstanceOfMSXMLObject)(
      THIS_ IN REFCLSID rclsid, IN LPUNKNOWN pUnkOuter, IN DWORD dwClsContext,
      IN REFIID riid, OUT LPVOID * ppv) PURE;
};
...
DECLARE_INTERFACE_(IPrintCoreHelperUni, IPrintCoreHelper) {
  ...
  STDMETHOD(CreateGDLSnapshot)(THIS_ IN PDEVMODE pDevmode,
                               OPTIONAL IN DWORD cbSize, IN DWORD dwFlags,
  ...
  STDMETHOD(CreateDefaultGDLSnapshot)(
      THIS_ _In_ DWORD dwFlags, _Outptr_ LPSTREAM * ppSnapshotStream) PURE;
};
...
DECLARE_INTERFACE_(IPrintCoreHelperUni2, IPrintCoreHelperUni) {
  ...
  STDMETHOD(CreateDefaultGDLSnapshot)(THIS_ IN DWORD dwFlags,
                                      OUT LPSTREAM * ppSnapshotStream) PURE;
  ...
  // GetNamedCommand
  //
  STDMETHOD(GetNamedCommand)(
      THIS_ _In_reads_bytes_opt_(cbSize) PDEVMODE pDevmode, DWORD cbSize,
      _In_ PCWSTR pszCommandName,
      _Outptr_result_bytebuffer_(*pcbCommandSize) PBYTE * ppCommandBytes,
...
DECLARE_INTERFACE_(IPrintCoreHelperPS, IPrintCoreHelper) {
  ...
  STDMETHOD(GetGlobalAttribute)(
      THIS_ _In_ PCSTR pszAttribute, _Out_ PDWORD pdwDataType,
      _Outptr_result_buffer_(*pcbSize) PBYTE * ppbData, _Out_ PDWORD pcbSize)
      PURE;
  ...
  STDMETHOD(GetFeatureAttribute)(
      THIS_ _In_ PCSTR pszFeatureKeyword, _In_ PCSTR pszAttribute,
  ...
  STDMETHOD(GetOptionAttribute)(
      THIS_ _In_ PCSTR pszFeatureKeyword, _In_ PCSTR pszOptionKeyword,
      _In_opt_ PCSTR pszAttribute, _Out_ PDWORD pdwDataType,
      _Outptr_result_buffer_(*pcbSize) PBYTE * ppbData, _Out_ PDWORD pcbSize)
      PURE;
};
...
DECLARE_INTERFACE_(IPrintOemCommon, IUnknown) {
  ...
  STDMETHOD(GetInfo)(THIS_ _In_ DWORD dwMode,
                     _Out_writes_bytes_to_(cbSize, *pcbNeeded) PVOID pBuffer,
                     _In_ DWORD cbSize, _Out_ PDWORD pcbNeeded) PURE;
  //
  // Method for OEM private devmode handling
  //

  STDMETHOD(DevMode)(THIS_ _In_ DWORD dwMode, _Inout_ POEMDMPARAM pOemDMParam)
      PURE;
};
...
DECLARE_INTERFACE_(IPrintOemUI, IPrintOemCommon) {
  ...
  STDMETHOD(CommonUIProp)(THIS_ _In_ DWORD dwMode,
                          _In_ POEMCUIPPARAM pOemCUIPParam) PURE;

  //
  // DocumentPropertySheets
  //

  STDMETHOD(DocumentPropertySheets)(THIS_ _Inout_ PPROPSHEETUI_INFO pPSUIInfo,
                                    _In_ LPARAM lParam) PURE;

  //
  // DevicePropertySheets
  //

  STDMETHOD(DevicePropertySheets)(THIS_ _In_ PPROPSHEETUI_INFO pPSUIInfo,
                                  _In_ LPARAM lParam) PURE;
  ...
  STDMETHOD(DevQueryPrintEx)(THIS_ _In_ POEMUIOBJ poemuiobj,
                             _In_ PDEVQUERYPRINT_INFO pDQPInfo,
                             _In_ PDEVMODE pPublicDM, _In_ PVOID pOEMDM) PURE;

  //
  // DeviceCapabilities
  //

  STDMETHOD(DeviceCapabilities)(
      THIS_ _Inout_ POEMUIOBJ poemuiobj, _In_ HANDLE hPrinter,
      _In_ PWSTR pDeviceName, _In_ WORD wCapability,
      _Out_writes_(_Inexpressible_("varies with wCapability")) PVOID pOutput,
      _In_ PDEVMODE pPublicDM, _In_ PVOID pOEMDM, _In_ DWORD dwOld,
      _Out_ DWORD * dwResult) PURE;

  //
  // UpgradePrinter
  //

  STDMETHOD(UpgradePrinter)(THIS_ _In_ DWORD dwLevel,
                            _At_((PDRIVER_UPGRADE_INFO_1)pDriverUpgradeInfo,
                                 _In_) PBYTE pDriverUpgradeInfo) PURE;

  //
  // PrinterEvent
  //

  STDMETHOD(PrinterEvent)(THIS_ _In_ PWSTR pPrinterName, _In_ INT iDriverEvent,
                          _In_ DWORD dwFlags, _In_ LPARAM lParam) PURE;

  //
  // DriverEvent
  //

  STDMETHOD(DriverEvent)(THIS_ _In_ DWORD dwDriverEvent, _In_ DWORD dwLevel,
  ...
  STDMETHOD(QueryColorProfile)(
      THIS_ _In_ HANDLE hPrinter, _In_ POEMUIOBJ poemuiobj,
      _In_ PDEVMODE pPublicDM, _In_ PVOID pOEMDM, _In_ ULONG ulQueryMode,
      _Out_writes_(*pcbProfileData) VOID * pvProfileData,
      _Inout_ ULONG * pcbProfileData, _Out_ FLONG * pflProfileData) PURE;

  //
  // FontInstallerDlgProc
  //

  STDMETHOD(FontInstallerDlgProc)(THIS_ _In_ HWND hWnd, _In_ UINT usMsg,
                                  _In_ WPARAM wParam, _In_ LPARAM lParam) PURE;

  //
  // UpdateExternalFonts
  //

  STDMETHOD(UpdateExternalFonts)(THIS_ _In_ HANDLE hPrinter, _In_ HANDLE hHeap,
                                 _In_ PWSTR pwstrCartridges) PURE;
};
...
DECLARE_INTERFACE_(IPrintOemUI2, IPrintOemUI) {
  ...
  STDMETHOD(QueryJobAttributes)(
      THIS_ _In_ HANDLE hPrinter, _In_ PDEVMODE pDevmode,
      _In_range_(1, 4) DWORD dwLevel,
      _In_reads_(_Inexpressible_("varies")) LPBYTE lpAttributeInfo) PURE;

  //
  // Hide Standard UI
  //

  STDMETHOD(HideStandardUI)(THIS_ DWORD dwMode) PURE;

  //
  // DocumentEvent
  //

  STDMETHOD(DocumentEvent)(THIS_ HANDLE hPrinter, HDC hdc, INT iEsc, ULONG cbIn,
                           PVOID pvIn, ULONG cbOut, PVOID pvOut, PINT piResult)
      PURE;
};
...
DECLARE_INTERFACE_(IPrintOemUIMXDC, IUnknown) {
  ...
  STDMETHOD(AdjustImageableArea)(
      THIS_ HANDLE hPrinter, DWORD cbDevMode, CONST PDEVMODE pDevMode,
      DWORD cbOEMDM, CONST PVOID pOEMDM, PRECTL prclImageableArea) PURE;

  STDMETHOD(AdjustImageCompression)(
      THIS_ HANDLE hPrinter, DWORD cbDevMode, CONST PDEVMODE pDevMode,
      DWORD cbOEMDM, CONST PVOID pOEMDM, PLONG pCompressionMode) PURE;

  STDMETHOD(AdjustDPI)(THIS_ HANDLE hPrinter, DWORD cbDevMode,
                       CONST PDEVMODE pDevMode, DWORD cbOEMDM,
                       CONST PVOID pOEMDM, PLONG pDPI) PURE;
};
...
DECLARE_INTERFACE_(IPrintOemDriverUI, IUnknown) {
  ...
  STDMETHOD(DrvGetDriverSetting)(THIS_ PVOID pci, PCSTR Feature, PVOID pOutput,
                                 DWORD cbSize, PDWORD pcbNeeded,
  ...
  STDMETHOD(DrvUpgradeRegistrySetting)(THIS_ HANDLE hPrinter, PCSTR pFeature,
                                       PCSTR pOption) PURE;
  ...
  STDMETHOD(DrvUpdateUISetting)(THIS_ PVOID pci, PVOID pOptItem,
                                DWORD dwPreviousSelection, DWORD dwMode) PURE;
};
...
DECLARE_INTERFACE_(IPrintCoreUI2, IPrintOemDriverUI) {
  ...
  //
  // Following four helper functions are only supported for UI plugins that
  // fully replace core driver's standard UI. They should only be called by the
  // UI plugin's DocumentPropertySheets, DevicePropertySheets and their property
  // sheet callback functions.
  //
  ...
  STDMETHOD(GetOptions)(
      THIS_ _In_ POEMUIOBJ poemuiobj, _Reserved_ DWORD dwFlags,
      _In_reads_bytes_opt_(cbIn) PCZZSTR pmszFeaturesRequested, _In_ DWORD cbIn,
      _Out_writes_bytes_to_opt_(cbSize, *pcbNeeded) PZZSTR pmszFeatureOptionBuf,
      _In_ DWORD cbSize,
  ...
  STDMETHOD(SetOptions)(THIS_ _In_ POEMUIOBJ poemuiobj, _In_ DWORD dwFlags,
                        _In_reads_bytes_(cbIn) PCZZSTR pmszFeatureOptionBuf,
                        _In_ DWORD cbIn, _Out_ PDWORD pdwResult) PURE;
  ...
  STDMETHOD(WhyConstrained)(
      THIS_ _In_ POEMUIOBJ poemuiobj, _Reserved_ DWORD dwFlags,
      _In_ PCSTR pszFeatureKeyword, _In_ PCSTR pszOptionKeyword,
      _Out_writes_bytes_to_opt_(cbSize, *pcbNeeded) PZZSTR pmszReasonList,
      _In_ DWORD cbSize,
      _Out_ _On_failure_(_When_(return == E_OUTOFMEMORY, _Post_valid_))
          PDWORD pcbNeeded) PURE;
  ...
  STDMETHOD(GetFeatureAttribute)(
      THIS_ _In_ POEMUIOBJ poemuiobj, _Reserved_ DWORD dwFlags,
      _In_ PCSTR pszFeatureKeyword, _In_opt_ PCSTR pszAttribute,
      _Out_ PDWORD pdwDataType,
      _Out_writes_bytes_to_opt_(cbSize, *pcbNeeded) PBYTE pbData,
      _In_ DWORD cbSize,
      _Out_ _On_failure_(_When_(return == E_OUTOFMEMORY, _Post_valid_))
  ...
  STDMETHOD(EnumFeatures)(
      THIS_ _In_ POEMUIOBJ poemuiobj, _Reserved_ DWORD dwFlags,
      _Out_writes_bytes_to_opt_(cbSize, *pcbNeeded) PZZSTR pmszFeatureList,
      _In_ DWORD cbSize,
      _Out_ _On_failure_(_When_(return == E_OUTOFMEMORY, _Post_valid_))
          PDWORD pcbNeeded) PURE;
  ...
  STDMETHOD(EnumOptions)(
      THIS_ _In_ POEMUIOBJ poemuiobj, _Reserved_ DWORD dwFlags,
      _In_ PCSTR pszFeatureKeyword,
      _Out_writes_bytes_to_opt_(cbSize, *pcbNeeded) PZZSTR pmszOptionList,
      _In_ DWORD cbSize,
      _Out_ _On_failure_(_When_(return == E_OUTOFMEMORY, _Post_valid_))
          PDWORD pcbNeeded) PURE;
  ...
  STDMETHOD(QuerySimulationSupport)(
      THIS_ _In_ HANDLE hPrinter, _In_ DWORD dwLevel,
...
DECLARE_INTERFACE_(IPrintOemPrintTicketProvider, IUnknown) {
  ...
  STDMETHOD(GetSupportedVersions)(THIS_ _In_ HANDLE hPrinter,
                                  _Outptr_result_buffer_(*cVersions) INT *
                                      ppVersions[],
                                  _Out_ INT * cVersions) PURE;

  STDMETHOD(BindPrinter)(THIS_ _In_ HANDLE hPrinter, INT version,
                         _Out_ POEMPTOPTS pOptions, _Out_ INT * cNamespaces,
                         _Outptr_result_buffer_maybenull_(*cNamespaces) BSTR *
                             *ppNamespaces) PURE;

  STDMETHOD(PublishPrintTicketHelperInterface)(THIS_ _In_ IUnknown * pHelper)
      PURE;

  STDMETHOD(QueryDeviceDefaultNamespace)(THIS_ OUT BSTR * pbstrNamespaceUri)
      PURE;

  STDMETHOD(ConvertPrintTicketToDevMode)(
      THIS_ _In_ IXMLDOMDocument2 * pPrintTicket, ULONG cbDevmode,
      _Inout_updates_bytes_(cbDevmode) PDEVMODE pDevmode,
      ULONG cbDrvPrivateSize, _Inout_ PVOID pPrivateDevmode) PURE;

  STDMETHOD(ConvertDevModeToPrintTicket)(
      THIS_ ULONG cbDevmode, _Inout_updates_bytes_(cbDevmode) PDEVMODE pDevmode,
      ULONG cbDrvPrivateSize, _Inout_ PVOID pPrivateDevmode,
      _Inout_ IXMLDOMDocument2 * pPrintTicket) PURE;

  STDMETHOD(CompletePrintCapabilities)(
      THIS_ _In_opt_ IXMLDOMDocument2 * pPrintTicket,
      _Inout_ IXMLDOMDocument2 * pCapabilities) PURE;

  STDMETHOD(ExpandIntentOptions)(THIS_ _Inout_ IXMLDOMDocument2 * pPrintTicket)
      PURE;

  STDMETHOD(ValidatePrintTicket)(THIS_ _Inout_ IXMLDOMDocument2 * pPrintTicket)
      PURE;
};
...
DECLARE_INTERFACE_(IPrintOemEngine, IPrintOemCommon) {
  ...
  STDMETHOD(EnableDriver)(THIS_ DWORD DriverVersion, DWORD cbSize,
  ...
  STDMETHOD(EnablePDEV)(THIS_ PDEVOBJ pdevobj, PWSTR pPrinterName,
                        ULONG cPatterns, HSURF * phsurfPatterns,
                        ULONG cjGdiInfo, GDIINFO * pGdiInfo, ULONG cjDevInfo,
                        DEVINFO * pDevInfo, DRVENABLEDATA * pded,
  ...
  STDMETHOD(ResetPDEV)(THIS_ PDEVOBJ pdevobjOld, PDEVOBJ pdevobjNew) PURE;
};
...
DECLARE_INTERFACE_(IPrintOemPS, IPrintOemEngine) {
  ...
  STDMETHOD(Command)(THIS_ PDEVOBJ pdevobj, DWORD dwIndex, PVOID pData,
                     DWORD cbSize, OUT DWORD * pdwResult) PURE;
};
...
DECLARE_INTERFACE_(IPrintOemPS2, IPrintOemPS) {
  ...
  STDMETHOD(WritePrinter)(THIS_ PDEVOBJ pdevobj, PVOID pBuf, DWORD cbBuffer,
  ...
  STDMETHOD(GetPDEVAdjustment)(THIS_ PDEVOBJ pdevobj, DWORD dwAdjustType,
                               PVOID pBuf, DWORD cbBuffer,
...
DECLARE_INTERFACE_(IPrintOemDriverPS, IUnknown) {
  ...
  STDMETHOD(DrvGetDriverSetting)(THIS_ PVOID pdriverobj, PCSTR Feature,
                                 PVOID pOutput, DWORD cbSize, PDWORD pcbNeeded,
                                 PDWORD pdwOptionsReturned) PURE;
  ...
  STDMETHOD(DrvWriteSpoolBuf)(THIS_ PDEVOBJ pdevobj, PVOID pBuffer,
                              DWORD cbSize, OUT DWORD * pdwResult) PURE;
};
...
DECLARE_INTERFACE_(IPrintCorePS2, IUnknown) {
  ...
  STDMETHOD(DrvWriteSpoolBuf)(THIS_ IN PDEVOBJ pdevobj, IN PVOID pBuffer,
                              IN DWORD cbSize, OUT DWORD * pdwResult) PURE;
  ...
  STDMETHOD(GetOptions)(
      THIS_ _In_ PDEVOBJ pdevobj, _Reserved_ DWORD dwFlags,
      _In_reads_bytes_opt_(cbIn) PCZZSTR pmszFeaturesRequested, _In_ DWORD cbIn,
      _Out_writes_bytes_to_opt_(cbSize, *pcbNeeded) PZZSTR pmszFeatureOptionBuf,
      _In_ DWORD cbSize,
      _Out_ _On_failure_(_When_(return == E_OUTOFMEMORY, _Post_valid_))
...
DECLARE_INTERFACE_(IPrintOemUni, IPrintOemEngine) {
  ...
  STDMETHOD(DriverDMS)(THIS_ PVOID pDevObj, PVOID pBuffer, DWORD cbSize,
                       PDWORD pcbNeeded) PURE;
  ...
  STDMETHOD(CommandCallback)(THIS_ PDEVOBJ pdevobj, DWORD dwCallbackID,
                             DWORD dwCount, PDWORD pdwParams,
  ...
  STDMETHOD(ImageProcessing)(THIS_ PDEVOBJ pdevobj, PBYTE pSrcBitmap,
                             PBITMAPINFOHEADER pBitmapInfoHeader,
                             PBYTE pColorTable, DWORD dwCallbackID,
                             PIPPARAMS pIPParams, OUT PBYTE * ppbResult) PURE;

  //
  // FilterGraphics
  //

  STDMETHOD(FilterGraphics)(THIS_ PDEVOBJ pdevobj, PBYTE pBuf, DWORD dwLen)
      PURE;
  ...
  STDMETHOD(Compression)(THIS_ PDEVOBJ pdevobj, PBYTE pInBuf, PBYTE pOutBuf,
                         DWORD dwInLen, DWORD dwOutLen, OUT INT * piResult)
      PURE;
  ...
  STDMETHOD(HalftonePattern)(THIS_ PDEVOBJ pdevobj, PBYTE pHTPattern,
                             DWORD dwHTPatternX, DWORD dwHTPatternY,
                             DWORD dwHTNumPatterns, DWORD dwCallbackID,
                             PBYTE pResource, DWORD dwResourceSize) PURE;

  //
  // MemoryUsage
  //

  STDMETHOD(MemoryUsage)(THIS_ PDEVOBJ pdevobj, POEMMEMORYUSAGE pMemoryUsage)
      PURE;
  ...
  STDMETHOD(TTYGetInfo)(THIS_ PDEVOBJ pdevobj, DWORD dwInfoIndex,
                        PVOID pOutputBuf, DWORD dwSize, DWORD * pcbcNeeded)
      PURE;
  //
  // DownloadFontheader
  //

  STDMETHOD(DownloadFontHeader)(THIS_ PDEVOBJ pdevobj, PUNIFONTOBJ pUFObj,
  ...
  STDMETHOD(DownloadCharGlyph)(THIS_ PDEVOBJ pdevobj, PUNIFONTOBJ pUFObj,
                               HGLYPH hGlyph, PDWORD pdwWidth,
                               OUT DWORD * pdwResult) PURE;
  ...
  STDMETHOD(TTDownloadMethod)(THIS_ PDEVOBJ pdevobj, PUNIFONTOBJ pUFObj,
                              OUT DWORD * pdwResult) PURE;
  ...
  STDMETHOD(OutputCharStr)(THIS_ PDEVOBJ pdevobj, PUNIFONTOBJ pUFObj,
                           DWORD dwType, DWORD dwCount, PVOID pGlyph) PURE;

  //
  // SendFontCmd
  //

  STDMETHOD(SendFontCmd)(THIS_ PDEVOBJ pdevobj, PUNIFONTOBJ pUFObj,
  ...
  STDMETHOD(TextOutAsBitmap)(
      THIS_ SURFOBJ * pso, STROBJ * pstro, FONTOBJ * pfo, CLIPOBJ * pco,
      RECTL * prclExtra, RECTL * prclOpaque, BRUSHOBJ * pboFore,
      BRUSHOBJ * pboOpaque, POINTL * pptlOrg, MIX mix) PURE;
};
...
DECLARE_INTERFACE_(IPrintOemUni3, IPrintOemUni2) {
  ...
  STDMETHOD(DownloadPattern)(THIS_ PDEVOBJ pdevobj, SURFOBJ * psoPattern,
  ...
  STDMETHOD(SetBandSize)(THIS_ PDEVOBJ pdevobj, INT iFormat,
                         DWORD dwPageWidthBytes, DWORD dwPageHeight,
                         DWORD dwMaxHeight, PDWORD pdwRequiredHeight) PURE;
};
...
DECLARE_INTERFACE_(IPrintOemDriverUni, IUnknown) {
  ...
  STDMETHOD(DrvXMoveTo)(THIS_ PDEVOBJ pdevobj, INT x, DWORD dwFlags,
                        OUT INT * piResult) PURE;

  STDMETHOD(DrvYMoveTo)(THIS_ PDEVOBJ pdevobj, INT y, DWORD dwFlags,
                        OUT INT * piResult) PURE;
  //
  // Unidrv specific. To get the standard variable value.
  //

  STDMETHOD(DrvGetStandardVariable)(THIS_ PDEVOBJ pdevobj, DWORD dwIndex,
                                    PVOID pBuffer, DWORD cbSize,
                                    PDWORD pcbNeeded) PURE;
  ...
  STDMETHOD(DrvGetGPDData)(
      THIS_ PDEVOBJ pdevobj,
  ...
  STDMETHOD(DrvUniTextOut)(THIS_ SURFOBJ * pso, STROBJ * pstro, FONTOBJ * pfo,
                           CLIPOBJ * pco, RECTL * prclExtra, RECTL * prclOpaque,
                           BRUSHOBJ * pboFore, BRUSHOBJ * pboOpaque,
                           POINTL * pptlBrushOrg, MIX mix) PURE;
  ...
  STDMETHOD(DrvWriteAbortBuf)(
      THIS_ PDEVOBJ pdevobj, PVOID pBuffer, DWORD cbSize,
