...
//
// Anywhere that NOINITALL is defined, warning 4845 should be disabled. This
// warning fires whenever __declspec(no_init_all) is found but /d1initall isn't
// set. This isn't helpful since this will be done intentionally (not all
// components opt-in).
//

#ifndef DECLSPEC_NOINITALL
#if (_MSC_VER >= 1915) && !defined(MIDL_PASS) && !defined(SORTPP_PASS) &&      \
    !defined(RC_INVOKED)
#define DECLSPEC_NOINITALL                                                     \
  __pragma(warning(push)) __pragma(warning(disable : 4845))                    \
...
#else
// some Macintosh compilers don't define wchar_t in a convenient location, or
// define it as a char
...
#define STDAPI_CHPE_PATCHABLE                                                  \
  EXTERN_C DECLSPEC_CHPE_PATCHABLE HRESULT STDAPICALLTYPE
#define STDAPI_(type) EXTERN_C type STDAPICALLTYPE
#define STDAPI_CHPE_PATCHABLE_(type)                                           \
  EXTERN_C DECLSPEC_CHPE_PATCHABLE type STDAPICALLTYPE
#define DEPRECATED_STDAPI(message)                                             \
  EXTERN_C __declspec(deprecated(message)) HRESULT STDAPICALLTYPE
#define DEPRECATED_NO_MESSAGE_STDAPI                                           \
  EXTERN_C __declspec(deprecated) HRESULT STDAPICALLTYPE
#define DEPRECATED_STDAPI_(type, message)                                      \
  EXTERN_C __declspec(deprecated(message)) type STDAPICALLTYPE
#define DEPRECATED_NO_MESSAGE_STDAPI_(type)                                    \
  EXTERN_C __declspec(deprecated) type STDAPICALLTYPE
...
#define DEPRECATED_STDAPIV(message)                                            \
  EXTERN_C __declspec(deprecated(message)) HRESULT STDAPIVCALLTYPE
#define DEPRECATED_NO_MESSAGE_STDAPIV                                          \
  EXTERN_C __declspec(deprecated) HRESULT STDAPIVCALLTYPE
#define DEPRECATED_STDAPIV_(type, message)                                     \
  EXTERN_C __declspec(deprecated(message)) type STDAPIVCALLTYPE
#define DEPRECATED_NO_MESSAGE_STDAPIV_(type)                                   \
  EXTERN_C __declspec(deprecated) type STDAPIVCALLTYPE
...
//
    ...
    defined(_68K_) || defined(_MPPC_) || defined(_M_IA64) ||                   \
...
#define UInt32x32To64(a, b)                                                    \
  (((unsigned __int64)((unsigned int)(a))) *                                   \
...
#define UInt32x32To64(a, b)                                                    \
  ((unsigned __int64)(((unsigned __int64)((unsigned int)(a))) *                \
                      ((unsigned int)(b))))

ULONGLONG
NTAPI
Int64ShllMod32(_In_ ULONGLONG Value, _In_ DWORD ShiftCount);

LONGLONG
NTAPI
Int64ShraMod32(_In_ LONGLONG Value, _In_ DWORD ShiftCount);

ULONGLONG
NTAPI
Int64ShrlMod32(_In_ ULONGLONG Value, _In_ DWORD ShiftCount);
...
__inline ULONGLONG NTAPI Int64ShllMod32(_In_ ULONGLONG Value,
...
__inline LONGLONG NTAPI Int64ShraMod32(_In_ LONGLONG Value,
                                       _In_ DWORD ShiftCount) {
  __asm {
        mov     ecx, ShiftCount
        mov     eax, dword ptr [Value]
...
__inline ULONGLONG NTAPI Int64ShrlMod32(_In_ ULONGLONG Value,
                                        _In_ DWORD ShiftCount) {
  __asm {
        mov     ecx, ShiftCount
        mov     eax, dword ptr [Value]
...
unsigned char __cdecl _rotl8(_In_ unsigned char Value,
                             _In_ unsigned char Shift);

unsigned short __cdecl _rotl16(_In_ unsigned short Value,
                               _In_ unsigned char Shift);

unsigned char __cdecl _rotr8(_In_ unsigned char Value,
                             _In_ unsigned char Shift);

unsigned short __cdecl _rotr16(_In_ unsigned short Value,
                               _In_ unsigned char Shift);
...
unsigned int __cdecl _rotl(_In_ unsigned int Value, _In_ int Shift);

unsigned __int64 __cdecl _rotl64(_In_ unsigned __int64 Value, _In_ int Shift);

unsigned int __cdecl _rotr(_In_ unsigned int Value, _In_ int Shift);

unsigned __int64 __cdecl _rotr64(_In_ unsigned __int64 Value, _In_ int Shift);
...
typedef _IRQL_requires_same_
    _Function_class_(EXCEPTION_ROUTINE) EXCEPTION_DISPOSITION NTAPI
    EXCEPTION_ROUTINE(_Inout_ struct _EXCEPTION_RECORD *ExceptionRecord,
...
#define LANG_BOSNIAN_NEUTRAL                                                   \
  0x781a // Use with the ConvertDefaultLocale function
...
#define LANG_CHINESE_SIMPLIFIED                                                \
  0x04 // Use with the ConvertDefaultLocale function
#define LANG_CHINESE_TRADITIONAL                                               \
  0x7c04 // Use with the ConvertDefaultLocale function
...
#define LANG_SERBIAN_NEUTRAL                                                   \
  0x7c1a // Use with the ConvertDefaultLocale function
...
#define SUBLANG_AFRIKAANS_SOUTH_AFRICA                                         \
  0x01                                // Afrikaans (South Africa) 0x0436 af-ZA
...
#define SUBLANG_AZERI_LATIN                                                    \
  0x01 // Azeri (Latin) - for Azerbaijani, SUBLANG_AZERBAIJANI_AZERBAIJAN_LATIN
       // preferred
#define SUBLANG_AZERI_CYRILLIC                                                 \
  0x02 // Azeri (Cyrillic) - for Azerbaijani,
       // SUBLANG_AZERBAIJANI_AZERBAIJAN_CYRILLIC preferred
#define SUBLANG_AZERBAIJANI_AZERBAIJAN_LATIN                                   \
  0x01 // Azerbaijani (Azerbaijan, Latin)
#define SUBLANG_AZERBAIJANI_AZERBAIJAN_CYRILLIC                                \
  0x02                                  // Azerbaijani (Azerbaijan, Cyrillic)
...
#define SUBLANG_BENGALI_INDIA                                                  \
  0x01 // Bengali (India) - Note some prefer SUBLANG_BANGLA_INDIA
#define SUBLANG_BENGALI_BANGLADESH                                             \
  0x02 // Bengali (Bangladesh) - Note some prefer SUBLANG_BANGLA_BANGLADESH
#define SUBLANG_BOSNIAN_BOSNIA_HERZEGOVINA_LATIN                               \
  0x05 // Bosnian (Bosnia and Herzegovina - Latin) 0x141a bs-BA-Latn
#define SUBLANG_BOSNIAN_BOSNIA_HERZEGOVINA_CYRILLIC                            \
  0x08 // Bosnian (Bosnia and Herzegovina - Cyrillic) 0x201a bs-BA-Cyrl
...
#define SUBLANG_CENTRAL_KURDISH_IRAQ                                           \
  0x01 // Central Kurdish (Iraq) 0x0492 ku-Arab-IQ
...
#define SUBLANG_CHINESE_HONGKONG                                               \
  0x03 // Chinese (Hong Kong S.A.R., P.R.C.) 0x0c04 zh-HK
...
#define SUBLANG_CROATIAN_BOSNIA_HERZEGOVINA_LATIN                              \
  0x04 // Croatian (Bosnia and Herzegovina - Latin) 0x101a hr-BA
...
#define SUBLANG_FAEROESE_FAROE_ISLANDS                                         \
  0x01 // Faroese (Faroe Islands) 0x0438 fo-FO
#define SUBLANG_FILIPINO_PHILIPPINES                                           \
  0x01                                   // Filipino (Philippines) 0x0464 fil-PH
...
#define SUBLANG_GREENLANDIC_GREENLAND                                          \
  0x01 // Greenlandic (Greenland) 0x046f kl-GL
#define SUBLANG_GUJARATI_INDIA                                                 \
  0x01 // Gujarati (India (Gujarati Script)) 0x0447 gu-IN
#define SUBLANG_HAUSA_NIGERIA_LATIN                                            \
  0x01                             // Hausa (Latin, Nigeria) 0x0468 ha-NG-Latn
...
#define SUBLANG_INUKTITUT_CANADA                                               \
  0x01 // Inuktitut (Syllabics) (Canada) 0x045d iu-CA-Cans
...
#define SUBLANG_KANNADA_INDIA                                                  \
  0x01 // Kannada (India (Kannada Script)) 0x044b kn-IN
...
#define SUBLANG_LOWER_SORBIAN_GERMANY                                          \
  0x02 // Lower Sorbian (Germany) 0x082e wee-DE
#define SUBLANG_LUXEMBOURGISH_LUXEMBOURG                                       \
  0x01 // Luxembourgish (Luxembourg) 0x046e lb-LU
#define SUBLANG_MACEDONIAN_MACEDONIA                                           \
  0x01 // Macedonian (Macedonia (FYROM)) 0x042f mk-MK
#define SUBLANG_MALAY_MALAYSIA 0x01          // Malay (Malaysia)
#define SUBLANG_MALAY_BRUNEI_DARUSSALAM 0x02 // Malay (Brunei Darussalam)
#define SUBLANG_MALAYALAM_INDIA                                                \
  0x01 // Malayalam (India (Malayalam Script) ) 0x044c ml-IN
...
#define SUBLANG_MONGOLIAN_CYRILLIC_MONGOLIA                                    \
  0x01                                 // Mongolian (Cyrillic, Mongolia)
...
#define SUBLANG_PULAR_SENEGAL                                                  \
  0x02 // Deprecated: Use SUBLANG_FULAH_SENEGAL instead
#define SUBLANG_PUNJABI_INDIA                                                  \
  0x01 // Punjabi (India (Gurmukhi Script)) 0x0446 pa-IN
#define SUBLANG_PUNJABI_PAKISTAN                                               \
  0x02 // Punjabi (Pakistan (Arabic Script)) 0x0846 pa-Arab-PK
...
#define SUBLANG_SOTHO_NORTHERN_SOUTH_AFRICA                                    \
  0x01                                  // Northern Sotho (South Africa)
...
#define SUBLANG_TAMAZIGHT_ALGERIA_LATIN                                        \
  0x02 // Tamazight (Latin, Algeria) 0x085f tzm-Latn-DZ
#define SUBLANG_TAMAZIGHT_MOROCCO_TIFINAGH                                     \
  0x04                               // Tamazight (Tifinagh) 0x105f tzm-Tfng-MA
...
#define SUBLANG_TIGRINYA_ERITREA                                               \
  0x02 // Tigrinya (Eritrea) 0x0873 ti-ER (preferred spelling)
#define SUBLANG_TIGRINYA_ETHIOPIA 0x01 // Tigrinya (Ethiopia) 0x0473 ti-ET
#define SUBLANG_TSWANA_BOTSWANA                                                \
  0x02 // Setswana / Tswana (Botswana) 0x0832 tn-BW
#define SUBLANG_TSWANA_SOUTH_AFRICA                                            \
  0x01 // Setswana / Tswana (South Africa) 0x0432 tn-ZA
...
#define SUBLANG_UPPER_SORBIAN_GERMANY                                          \
  0x01                              // Upper Sorbian (Germany) 0x042e wen-DE
#define SUBLANG_URDU_PAKISTAN 0x01  // Urdu (Pakistan)
#define SUBLANG_URDU_INDIA 0x02     // Urdu (India)
#define SUBLANG_UZBEK_LATIN 0x01    // Uzbek (Latin)
#define SUBLANG_UZBEK_CYRILLIC 0x02 // Uzbek (Cyrillic)
#define SUBLANG_VALENCIAN_VALENCIA                                             \
  0x02 // Valencian (Valencia) 0x0803 ca-ES-Valencia
...
#define SUBLANG_XHOSA_SOUTH_AFRICA                                             \
  0x01 // isiXhosa / Xhosa (South Africa) 0x0434 xh-ZA
#define SUBLANG_YAKUT_RUSSIA                                                   \
  0x01                      // Deprecated: use SUBLANG_SAKHA_RUSSIA instead
...
#define SUBLANG_ZULU_SOUTH_AFRICA                                              \
  0x01 // isiZulu / Zulu (South Africa) 0x0435 zu-ZA
...
#define SORT_JAPANESE_UNICODE                                                  \
  0x1 // Japanese Unicode order (no longer supported)
...
#define SORT_CHINESE_RADICALSTROKE                                             \
  0x4 // Traditional Chinese radical/stroke order.
...
//
//  WARNING: This pattern isn't always followed (es-ES_tradnl vs es-ES for
//  example)
//
...
//
//    MAKELCID            - construct the locale id from a language id and a
//    sort id. MAKESORTLCID        - construct the locale id from a language id,
//    sort id, and sort version. LANGIDFROMLCID      - extract the language id
//    from a locale id. SORTIDFROMLCID      - extract the sort id from a locale
//    id. SORTVERSIONFROMLCID - extract the sort version from a locale id.
//
//  Note that the LANG, SUBLANG construction is not always consistent.
//  The named locale APIs (eg GetLocaleInfoEx) are recommended.
//
...
// specifiers. BCP47 allows some variation, eg: en-US is preferred to
// en-Latn-US.
...
#define UNREFERENCED_PARAMETER(P)                                              \
  _Prefast_unreferenced_parameter_impl_("PREfast", ((void)(P), 0))
#define DBG_UNREFERENCED_PARAMETER(P)                                          \
  _Prefast_unreferenced_parameter_impl_("PREfast", ((void)(P), 0))
#define DBG_UNREFERENCED_LOCAL_VARIABLE(V)                                     \
  _Prefast_unreferenced_parameter_impl_("PREfast", ((void)(V), 0))
...
// <type_traits> header file, or on compiler-specific constructs.
extern "C++" {
...
#define DEFINE_ENUM_FLAG_OPERATORS(ENUMTYPE)                                   \
  extern "C++" {                                                               \
  inline _ENUM_FLAG_CONSTEXPR ENUMTYPE operator|(ENUMTYPE a,                   \
                                                 ENUMTYPE b) WIN_NOEXCEPT {    \
    return ENUMTYPE(((_ENUM_FLAG_SIZED_INTEGER<ENUMTYPE>::type)a) |            \
                    ((_ENUM_FLAG_SIZED_INTEGER<ENUMTYPE>::type)b));            \
  }                                                                            \
  inline ENUMTYPE &operator|=(ENUMTYPE &a, ENUMTYPE b) WIN_NOEXCEPT {          \
    return (ENUMTYPE &)(((_ENUM_FLAG_SIZED_INTEGER<ENUMTYPE>::type &)a) |=     \
                        ((_ENUM_FLAG_SIZED_INTEGER<ENUMTYPE>::type)b));        \
  }                                                                            \
  inline _ENUM_FLAG_CONSTEXPR ENUMTYPE operator&(ENUMTYPE a,                   \
  ...
  inline _ENUM_FLAG_CONSTEXPR ENUMTYPE operator~(ENUMTYPE a) WIN_NOEXCEPT {    \
    return ENUMTYPE(~((_ENUM_FLAG_SIZED_INTEGER<ENUMTYPE>::type)a));           \
  }                                                                            \
  inline _ENUM_FLAG_CONSTEXPR ENUMTYPE operator^(ENUMTYPE a,                   \
                                                 ENUMTYPE b) WIN_NOEXCEPT {    \
...
// macros below when you need to initialize global const data.  Without these
// macros the inline operators from DEFINE_ENUM_FLAG_OPERATORS force a runtime
// initialization rather than a compile time initialization.  This applies even
// if you have declared the data as const.
//
...
#define COMPILETIME_OR_6FLAGS(a, b, c, d, e, f)                                \
...
static_assert(__alignof(LARGE_INTEGER) == 8,
              "Windows headers require the default packing option. Changing "
...
#if defined(STATUS_SUCCESS) || (_WIN32_WINNT > 0x0500) ||                      \
...
_Must_inspect_result_ BOOLEAN _bittest(_In_reads_bytes_((Offset / 8) + 1)
                                           LONG const *Base,
                                       _In_range_(>=, 0) LONG Offset);

BOOLEAN
_bittestandcomplement(_Inout_updates_bytes_((Offset / 8) + 1) LONG *Base,
                      _In_range_(>=, 0) LONG Offset);

BOOLEAN
_bittestandset(_Inout_updates_bytes_((Offset / 8) + 1) LONG *Base,
               _In_range_(>=, 0) LONG Offset);

BOOLEAN
_bittestandreset(_Inout_updates_bytes_((Offset / 8) + 1) LONG *Base,
                 _In_range_(>=, 0) LONG Offset);

BOOLEAN
_interlockedbittestandset(_Inout_updates_bytes_((Offset / 8) + 1)
                              _Interlocked_operand_ LONG volatile *Base,
                          _In_range_(>=, 0) LONG Offset);

BOOLEAN
_interlockedbittestandreset(_Inout_updates_bytes_((Offset / 8) + 1)
                                _Interlocked_operand_ LONG volatile *Base,
                            _In_range_(>=, 0) LONG Offset);

BOOLEAN
_bittest64(_In_reads_bytes_((Offset / 8) + 1) LONG64 const *Base,
           _In_range_(>=, 0) LONG64 Offset);

BOOLEAN
_bittestandcomplement64(_Inout_updates_bytes_((Offset / 8) + 1) LONG64 *Base,
                        _In_range_(>=, 0) LONG64 Offset);

BOOLEAN
_bittestandset64(_Inout_updates_bytes_((Offset / 8) + 1) LONG64 *Base,
                 _In_range_(>=, 0) LONG64 Offset);

BOOLEAN
_bittestandreset64(_Inout_updates_bytes_((Offset / 8) + 1) LONG64 *Base,
                   _In_range_(>=, 0) LONG64 Offset);

BOOLEAN
_interlockedbittestandset64(_Inout_updates_bytes_((Offset / 8) + 1)
                                _Interlocked_operand_ LONG64 volatile *Base,
                            _In_range_(>=, 0) LONG64 Offset);

BOOLEAN
_interlockedbittestandreset64(_Inout_updates_bytes_((Offset / 8) + 1)
                                  _Interlocked_operand_ LONG64 volatile *Base,
                              _In_range_(>=, 0) LONG64 Offset);
...
_Success_(return != 0) BOOLEAN
    _BitScanForward(_Out_ DWORD *Index, _In_ DWORD Mask);

_Success_(return != 0) BOOLEAN
    _BitScanReverse(_Out_ DWORD *Index, _In_ DWORD Mask);

_Success_(return != 0) BOOLEAN
    _BitScanForward64(_Out_ DWORD *Index, _In_ DWORD64 Mask);

_Success_(return != 0) BOOLEAN
    _BitScanReverse64(_Out_ DWORD *Index, _In_ DWORD64 Mask);
...
#define InterlockedExchangeAddSizeTAcquire(a, b)                               \
  InterlockedExchangeAdd64((LONG64 *)a, b)
#define InterlockedExchangeAddSizeTNoFence(a, b)                               \
  InterlockedExchangeAdd64((LONG64 *)a, b)
...
SHORT
InterlockedIncrement16(_Inout_ _Interlocked_operand_ SHORT volatile *Addend);

SHORT
InterlockedDecrement16(_Inout_ _Interlocked_operand_ SHORT volatile *Addend);

SHORT
InterlockedCompareExchange16(_Inout_ _Interlocked_operand_
                                 SHORT volatile *Destination,
                             _In_ SHORT ExChange, _In_ SHORT Comperand);

LONG InterlockedAnd(_Inout_ _Interlocked_operand_ LONG volatile *Destination,
                    _In_ LONG Value);

LONG InterlockedOr(_Inout_ _Interlocked_operand_ LONG volatile *Destination,
                   _In_ LONG Value);

LONG InterlockedXor(_Inout_ _Interlocked_operand_ LONG volatile *Destination,
                    _In_ LONG Value);

LONG64
InterlockedAnd64(_Inout_ _Interlocked_operand_ LONG64 volatile *Destination,
                 _In_ LONG64 Value);

LONG64
InterlockedOr64(_Inout_ _Interlocked_operand_ LONG64 volatile *Destination,
                _In_ LONG64 Value);

LONG64
InterlockedXor64(_Inout_ _Interlocked_operand_ LONG64 volatile *Destination,
                 _In_ LONG64 Value);

LONG InterlockedIncrement(_Inout_ _Interlocked_operand_ LONG volatile *Addend);

LONG InterlockedDecrement(_Inout_ _Interlocked_operand_ LONG volatile *Addend);

LONG InterlockedExchange(_Inout_ _Interlocked_operand_ LONG volatile *Target,
                         _In_ LONG Value);

LONG InterlockedExchangeAdd(_Inout_ _Interlocked_operand_ LONG volatile *Addend,
                            _In_ LONG Value);

#if !defined(_X86AMD64_)

__forceinline LONG
InterlockedAdd(_Inout_ _Interlocked_operand_ LONG volatile *Addend,
               _In_ LONG Value)
...
LONG InterlockedCompareExchange(_Inout_ _Interlocked_operand_
                                    LONG volatile *Destination,
                                _In_ LONG ExChange, _In_ LONG Comperand);

LONG64
InterlockedIncrement64(_Inout_ _Interlocked_operand_ LONG64 volatile *Addend);

LONG64
InterlockedDecrement64(_Inout_ _Interlocked_operand_ LONG64 volatile *Addend);

LONG64
InterlockedExchange64(_Inout_ _Interlocked_operand_ LONG64 volatile *Target,
                      _In_ LONG64 Value);

LONG64
InterlockedExchangeAdd64(_Inout_ _Interlocked_operand_ LONG64 volatile *Addend,
                         _In_ LONG64 Value);

#if !defined(_X86AMD64_)

__forceinline LONG64
_InlineInterlockedAdd64(_Inout_ _Interlocked_operand_ LONG64 volatile *Addend,
                        _In_ LONG64 Value)
...
LONG64
InterlockedCompareExchange64(_Inout_ _Interlocked_operand_
                                 LONG64 volatile *Destination,
                             _In_ LONG64 ExChange, _In_ LONG64 Comperand);

BOOLEAN
InterlockedCompareExchange128(_Inout_ _Interlocked_operand_
                                  LONG64 volatile *Destination,
                              _In_ LONG64 ExchangeHigh, _In_ LONG64 ExchangeLow,
                              _Inout_ LONG64 *ComparandResult);

_Ret_writes_(_Inexpressible_(Unknown)) PVOID InterlockedCompareExchangePointer(
    ...
    _In_opt_ PVOID Exchange, _In_opt_ PVOID Comperand);

_Ret_writes_(_Inexpressible_(Unknown)) PVOID InterlockedExchangePointer(
    _Inout_ _At_(*Target,
                 _Pre_writable_byte_size_(_Inexpressible_(Unknown))
                     _Post_writable_byte_size_(_Inexpressible_(Unknown)))
...
CHAR InterlockedExchange8(_Inout_ _Interlocked_operand_ CHAR volatile *Target,
                          _In_ CHAR Value);

SHORT
InterlockedExchange16(_Inout_ _Interlocked_operand_ SHORT volatile *Destination,
                      _In_ SHORT ExChange);
...
char InterlockedExchangeAdd8(
    _Inout_ _Interlocked_operand_ char volatile *_Addend, _In_ char _Value);

char InterlockedAnd8(_Inout_ _Interlocked_operand_ char volatile *Destination,
                     _In_ char Value);

char InterlockedOr8(_Inout_ _Interlocked_operand_ char volatile *Destination,
                    _In_ char Value);

char InterlockedXor8(_Inout_ _Interlocked_operand_ char volatile *Destination,
                     _In_ char Value);

SHORT
InterlockedAnd16(_Inout_ _Interlocked_operand_ SHORT volatile *Destination,
                 _In_ SHORT Value);

SHORT
InterlockedOr16(_Inout_ _Interlocked_operand_ SHORT volatile *Destination,
                _In_ SHORT Value);

SHORT
InterlockedXor16(_Inout_ _Interlocked_operand_ SHORT volatile *Destination,
                 _In_ SHORT Value);
...
__forceinline unsigned __int64 __readmsr(_In_ unsigned long Register) {
  (Register); // reference to make compiler happy
  __fastfail(0);
  return 0;
}

__forceinline void __writemsr(_In_ unsigned long Register,
...
VOID _mm_clflush(_In_ VOID const *Address);
...
VOID _m_prefetchw(_In_ volatile CONST VOID *Source);
...
VOID _mm_setcsr(_In_ unsigned int MxCsr);
...
DWORD
__segmentlimit(_In_ DWORD Selector);
...
VOID __movsb(_Out_writes_all_(Count) PBYTE Destination,
             _In_reads_(Count) BYTE const *Source, _In_ SIZE_T Count);

VOID __movsw(_Out_writes_all_(Count) PWORD Destination,
             _In_reads_(Count) WORD const *Source, _In_ SIZE_T Count);

VOID __movsd(_Out_writes_all_(Count) PDWORD Destination,
             _In_reads_(Count) DWORD const *Source, _In_ SIZE_T Count);

VOID __movsq(_Out_writes_all_(Count) PDWORD64 Destination,
             _In_reads_(Count) DWORD64 const *Source, _In_ SIZE_T Count);
...
VOID __stosb(_Out_writes_all_(Count) PBYTE Destination, _In_ BYTE Value,
             _In_ SIZE_T Count);

VOID __stosw(_Out_writes_all_(Count) PWORD Destination, _In_ WORD Value,
             _In_ SIZE_T Count);

VOID __stosd(_Out_writes_all_(Count) PDWORD Destination, _In_ DWORD Value,
             _In_ SIZE_T Count);

VOID __stosq(_Out_writes_all_(Count) PDWORD64 Destination, _In_ DWORD64 Value,
             _In_ SIZE_T Count);
...
LONGLONG
MultiplyHigh(_In_ LONG64 Multiplier, _In_ LONG64 Multiplicand);

ULONGLONG
UnsignedMultiplyHigh(_In_ DWORD64 Multiplier, _In_ DWORD64 Multiplicand);
...
DWORD64
PopulationCount64(_In_ DWORD64 operand);
...
DWORD64
ShiftLeft128(_In_ DWORD64 LowPart, _In_ DWORD64 HighPart, _In_ BYTE Shift);

DWORD64
ShiftRight128(_In_ DWORD64 LowPart, _In_ DWORD64 HighPart, _In_ BYTE Shift);
...
LONG64
Multiply128(_In_ LONG64 Multiplier, _In_ LONG64 Multiplicand,
...
DWORD64
UnsignedMultiply128(_In_ DWORD64 Multiplier, _In_ DWORD64 Multiplicand,
...
__forceinline LONG64 MultiplyExtract128(_In_ LONG64 Multiplier,
...
__forceinline DWORD64 UnsignedMultiplyExtract128(_In_ DWORD64 Multiplier,
...
BYTE __readgsbyte(_In_ DWORD Offset);

WORD __readgsword(_In_ DWORD Offset);

DWORD
__readgsdword(_In_ DWORD Offset);

DWORD64
__readgsqword(_In_ DWORD Offset);

VOID __writegsbyte(_In_ DWORD Offset, _In_ BYTE Data);

VOID __writegsword(_In_ DWORD Offset, _In_ WORD Data);

VOID __writegsdword(_In_ DWORD Offset, _In_ DWORD Data);

VOID __writegsqword(_In_ DWORD Offset, _In_ DWORD64 Data);
...
VOID __incgsbyte(_In_ DWORD Offset);

VOID __addgsbyte(_In_ DWORD Offset, _In_ BYTE Value);

VOID __incgsword(_In_ DWORD Offset);

VOID __addgsword(_In_ DWORD Offset, _In_ WORD Value);

VOID __incgsdword(_In_ DWORD Offset);

VOID __addgsdword(_In_ DWORD Offset, _In_ DWORD Value);

VOID __incgsqword(_In_ DWORD Offset);

VOID __addgsqword(_In_ DWORD Offset, _In_ DWORD64 Value);
...
typedef _Function_class_(GET_RUNTIME_FUNCTION_CALLBACK) PRUNTIME_FUNCTION
    GET_RUNTIME_FUNCTION_CALLBACK(_In_ DWORD64 ControlPc,
                                  _In_opt_ PVOID Context);
typedef GET_RUNTIME_FUNCTION_CALLBACK *PGET_RUNTIME_FUNCTION_CALLBACK;

typedef _Function_class_(OUT_OF_PROCESS_FUNCTION_TABLE_CALLBACK) DWORD
    OUT_OF_PROCESS_FUNCTION_TABLE_CALLBACK(_In_ HANDLE Process,
...
_Success_(return != 0) FORCEINLINE BOOLEAN
    _InlineBitScanReverse64(_Out_ DWORD *Index, _In_ DWORD64 Mask) {
...
#define InterlockedIncrementSizeTNoFence(a)                                    \
  InterlockedIncrementNoFence((LONG *)a)
#define InterlockedDecrementSizeT(a) InterlockedDecrement((LONG *)a)
#define InterlockedDecrementSizeTNoFence(a)                                    \
  InterlockedDecrementNoFence((LONG *)a)
...
FORCEINLINE
VOID WriteRelease8(_Out_ _Interlocked_operand_ CHAR volatile *Destination,
                   _In_ CHAR Value)
...
FORCEINLINE
VOID WriteNoFence8(_Out_ _Interlocked_operand_ CHAR volatile *Destination,
                   _In_ CHAR Value)
...
FORCEINLINE
VOID WriteRelease16(_Out_ _Interlocked_operand_ SHORT volatile *Destination,
                    _In_ SHORT Value)
...
FORCEINLINE
VOID WriteNoFence16(_Out_ _Interlocked_operand_ SHORT volatile *Destination,
                    _In_ SHORT Value)
...
CFORCEINLINE
VOID WriteRelease(_Out_ _Interlocked_operand_ LONG volatile *Destination,
                  _In_ LONG Value)
...
FORCEINLINE
VOID WriteNoFence(_Out_ _Interlocked_operand_ LONG volatile *Destination,
                  _In_ LONG Value)
...
CFORCEINLINE
VOID WriteRelease64(_Out_ _Interlocked_operand_ LONG64 volatile *Destination,
                    _In_ LONG64 Value)
...
FORCEINLINE
VOID WriteNoFence64(_Out_ _Interlocked_operand_ LONG64 volatile *Destination,
                    _In_ LONG64 Value)
...
typedef _Function_class_(GET_RUNTIME_FUNCTION_CALLBACK) PRUNTIME_FUNCTION
    GET_RUNTIME_FUNCTION_CALLBACK(_In_ DWORD ControlPc, _In_opt_ PVOID Context);
typedef GET_RUNTIME_FUNCTION_CALLBACK *PGET_RUNTIME_FUNCTION_CALLBACK;
...
// 19.28.29395.7.
//
#if defined(_MSC_FULL_VER) && (_MSC_FULL_VER < 192829395 ||                    \
                               (_MSC_FULL_VER == 192829395 && _MSC_BUILD < 7))
...
FORCEINLINE
unsigned char _BitTest64(__int64 const *Base, __int64 Index) {
  return _bittest64(Base + (Index >> 6), Index & 63);
}

FORCEINLINE
unsigned char _BitTestAndComplement64(__int64 *Base, __int64 Index) {
  return _bittestandcomplement64(Base + (Index >> 6), Index & 63);
}

FORCEINLINE
unsigned char _BitTestAndReset64(__int64 *Base, __int64 Index) {
  return _bittestandreset64(Base + (Index >> 6), Index & 63);
}

FORCEINLINE
unsigned char _BitTestAndSet64(__int64 *Base, __int64 Index) {
...
#define InterlockedExchangeAddSizeT(a, b)                                      \
  InterlockedExchangeAdd64((LONG64 *)a, b)
#define InterlockedExchangeAddSizeTAcquire(a, b)                               \
  InterlockedExchangeAddAcquire64((LONG64 *)a, b)
#define InterlockedExchangeAddSizeTNoFence(a, b)                               \
  InterlockedExchangeAddNoFence64((LONG64 *)a, b)
#define InterlockedIncrementSizeT(a) InterlockedIncrement64((LONG64 *)a)
#define InterlockedIncrementSizeTNoFence(a)                                    \
  InterlockedIncrementNoFence64((LONG64 *)a)
#define InterlockedDecrementSizeT(a) InterlockedDecrement64((LONG64 *)a)
#define InterlockedDecrementSizeTNoFence(a)                                    \
  InterlockedDecrementNoFence64((LONG64 *)a)
...
#define ARM64_PREFETCH(a, b, c)                                                \
  (ARM64_PREFETCH_##a | ARM64_PREFETCH_##b | ARM64_PREFETCH_##c)
...
FORCEINLINE
VOID MemoryBarrier(VOID) { __dmb(_ARM64_BARRIER_SY); }

#define PreFetchCacheLine(l, a)                                                \
  __prefetch2((const void *)(a), ARM64_PREFETCH(PLD, L1, KEEP))
#define PrefetchForWrite(p)                                                    \
  __prefetch2((const void *)(p), ARM64_PREFETCH(PST, L1, KEEP))
#define ReadForWriteAccess(p)                                                  \
  (__prefetch2((const void *)(p), ARM64_PREFETCH(PST, L1, KEEP)), *(p))
...
#if defined(__clang__) && !defined(RUST_BINDGEN)
  __atomic_store_n((unsigned __int8 volatile *)Destination,
                   (unsigned __int8)Value, 3);
#else
...
#if defined(__clang__) && !defined(RUST_BINDGEN)
  __atomic_store_n((unsigned __int16 volatile *)Destination,
                   (unsigned __int16)Value, 3);
#else
...
#if defined(__clang__) && !defined(RUST_BINDGEN)
  __atomic_store_n((unsigned __int32 volatile *)Destination,
                   (unsigned __int32)Value, 3);
#else
...
#if defined(__clang__) && !defined(RUST_BINDGEN)
  __atomic_store_n((unsigned __int64 volatile *)Destination,
...
#define ARM64_SYSINSTR(op0, op1, crn, crm, op2)                                \
  (((op1 & 7) << 11) | ((crn & 15) << 7) | ((crm & 15) << 3) | ((op2 & 7) << 0))
...
#define ARM64_CNTVCT                                                           \
  ARM64_SYSREG(3, 3, 14, 0, 2) // Generic Timer counter register
#define ARM64_CNTVCT_EL0                                                       \
  ARM64_SYSREG(3, 3, 14, 0, 2) // Generic Timer counter register
#define ARM64_CNTFRQ_EL0                                                       \
  ARM64_SYSREG(3, 3, 14, 0, 0) // Counter-timer Frequency register
#define ARM64_PMCCNTR_EL0                                                      \
  ARM64_SYSREG(3, 3, 9, 13, 0) // Cycle Count Register [CP15_PMCCNTR]
...
#define ARM64_PMXEVCNTRn_EL0(n)                                                \
  ARM64_SYSREG(3, 3, 14, 8 + ((n) / 8),                                        \
               (n) % 8) // Direct Event Count Register [n/a]
#define ARM64_TPIDR_EL0                                                        \
  ARM64_SYSREG(3, 3, 13, 0,                                                    \
               2) // Thread ID Register, User Read/Write [CP15_TPIDRURW]
#define ARM64_TPIDRRO_EL0                                                      \
  ARM64_SYSREG(3, 3, 13, 0,                                                    \
               3) // Thread ID Register, User Read Only [CP15_TPIDRURO]
#define ARM64_TPIDR_EL1                                                        \
  ARM64_SYSREG(3, 0, 13, 0,                                                    \
               4) // Thread ID Register, Privileged Only [CP15_TPIDRPRW]
...
ReadPMC(_In_ DWORD Counter) {
  ...
  switch (Counter) {
  case 0:
    return (DWORD64)_ReadStatusReg(ARM64_PMXEVCNTRn_EL0(0));
  case 1:
    return (DWORD64)_ReadStatusReg(ARM64_PMXEVCNTRn_EL0(1));
  case 2:
    return (DWORD64)_ReadStatusReg(ARM64_PMXEVCNTRn_EL0(2));
  case 3:
    return (DWORD64)_ReadStatusReg(ARM64_PMXEVCNTRn_EL0(3));
  case 4:
    return (DWORD64)_ReadStatusReg(ARM64_PMXEVCNTRn_EL0(4));
  case 5:
    return (DWORD64)_ReadStatusReg(ARM64_PMXEVCNTRn_EL0(5));
  case 6:
    return (DWORD64)_ReadStatusReg(ARM64_PMXEVCNTRn_EL0(6));
  case 7:
    return (DWORD64)_ReadStatusReg(ARM64_PMXEVCNTRn_EL0(7));
  case 8:
    return (DWORD64)_ReadStatusReg(ARM64_PMXEVCNTRn_EL0(8));
  case 9:
    return (DWORD64)_ReadStatusReg(ARM64_PMXEVCNTRn_EL0(9));
  case 10:
    return (DWORD64)_ReadStatusReg(ARM64_PMXEVCNTRn_EL0(10));
  case 11:
    return (DWORD64)_ReadStatusReg(ARM64_PMXEVCNTRn_EL0(11));
  case 12:
    return (DWORD64)_ReadStatusReg(ARM64_PMXEVCNTRn_EL0(12));
  case 13:
    return (DWORD64)_ReadStatusReg(ARM64_PMXEVCNTRn_EL0(13));
  case 14:
    return (DWORD64)_ReadStatusReg(ARM64_PMXEVCNTRn_EL0(14));
  case 15:
    return (DWORD64)_ReadStatusReg(ARM64_PMXEVCNTRn_EL0(15));
  case 16:
    return (DWORD64)_ReadStatusReg(ARM64_PMXEVCNTRn_EL0(16));
  case 17:
    return (DWORD64)_ReadStatusReg(ARM64_PMXEVCNTRn_EL0(17));
  case 18:
    return (DWORD64)_ReadStatusReg(ARM64_PMXEVCNTRn_EL0(18));
  case 19:
    return (DWORD64)_ReadStatusReg(ARM64_PMXEVCNTRn_EL0(19));
  case 20:
    return (DWORD64)_ReadStatusReg(ARM64_PMXEVCNTRn_EL0(20));
  case 21:
    return (DWORD64)_ReadStatusReg(ARM64_PMXEVCNTRn_EL0(21));
  case 22:
    return (DWORD64)_ReadStatusReg(ARM64_PMXEVCNTRn_EL0(22));
  case 23:
    return (DWORD64)_ReadStatusReg(ARM64_PMXEVCNTRn_EL0(23));
  case 24:
    return (DWORD64)_ReadStatusReg(ARM64_PMXEVCNTRn_EL0(24));
  case 25:
    return (DWORD64)_ReadStatusReg(ARM64_PMXEVCNTRn_EL0(25));
  case 26:
    return (DWORD64)_ReadStatusReg(ARM64_PMXEVCNTRn_EL0(26));
  case 27:
    return (DWORD64)_ReadStatusReg(ARM64_PMXEVCNTRn_EL0(27));
  case 28:
    return (DWORD64)_ReadStatusReg(ARM64_PMXEVCNTRn_EL0(28));
  case 29:
    return (DWORD64)_ReadStatusReg(ARM64_PMXEVCNTRn_EL0(29));
  case 30:
    return (DWORD64)_ReadStatusReg(ARM64_PMXEVCNTRn_EL0(30));
  default:
    return 0;
  }
}
...
__forceinline DWORD64 PopulationCount64(_In_ DWORD64 operand) {
...
__forceinline DWORD64 ShiftLeft128(_In_ DWORD64 LowPart, _In_ DWORD64 HighPart,
                                   _In_ BYTE Shift) {
  Shift &= 63;
...
__forceinline DWORD64 ShiftRight128(_In_ DWORD64 LowPart, _In_ DWORD64 HighPart,
                                    _In_ BYTE Shift) {
  Shift &= 63;
...
__forceinline DWORD64 UnsignedMultiply128(_In_ DWORD64 Multiplier,
                                          _In_ DWORD64 Multiplicand,
                                          _Out_ DWORD64 *HighProduct)
...
__forceinline LONG64 Multiply128(_In_ LONG64 Multiplier,
                                 _In_ LONG64 Multiplicand,
                                 _Out_ LONG64 *HighProduct) {
#if (defined(_M_ARM64) || defined(_M_HYBRID_X86_ARM64) ||                      \
     defined(_M_ARM64EC)) &&                                                   \
  ...
  *HighProduct = MultiplyHigh(Multiplier, Multiplicand);
  ...
  LONG64 Result = (LONG64)UnsignedMultiply128(
      (DWORD64)Multiplier, (DWORD64)Multiplicand, (DWORD64 *)HighProduct);
...
#define CONTEXT_ARM64_ALL                                                      \
  (CONTEXT_ARM64_CONTROL | CONTEXT_ARM64_INTEGER |                             \
   ...
   CONTEXT_ARM64_X18 | CONTEXT_ARM64_FLOATING_POINT_LOW |                      \
...
C_ASSERT(FIELD_OFFSET(ARM64EC_NT_CONTEXT, Lr) ==
         FIELD_OFFSET(CONTEXT, FltSave.FloatRegisters));
...
C_ASSERT(sizeof(DISPATCHER_CONTEXT_NONVOLREG_ARM64) ==
         (NONVOL_INT_SIZE_ARM64 + NONVOL_FP_SIZE_ARM64));
...
typedef _Function_class_(GET_RUNTIME_FUNCTION_CALLBACK) PARM64_RUNTIME_FUNCTION
    GET_RUNTIME_FUNCTION_CALLBACK(_In_ DWORD64 ControlPc,
                                  _In_opt_ PVOID Context);
typedef GET_RUNTIME_FUNCTION_CALLBACK *PGET_RUNTIME_FUNCTION_CALLBACK;
...
typedef _Function_class_(OUT_OF_PROCESS_FUNCTION_TABLE_CALLBACK) DWORD
    OUT_OF_PROCESS_FUNCTION_TABLE_CALLBACK(
        _In_ HANDLE Process, _In_ PVOID TableAddress, _Out_ PDWORD Entries,
...
#if !defined(_DBGRAISEASSERTIONFAILURE_) && !defined(RC_INVOKED) &&            \
    !defined(MIDL_PASS)
...
__analysis_noreturn FORCEINLINE VOID DbgRaiseAssertionFailure(VOID);
...
#define ASSERT_BREAKPOINT                                                      \
  (BREAK_DEBUG_BASE +                                                          \
   3) // Cause a STATUS_ASSERTION_FAILURE exception to be raised.
...
#endif // !defined(_DBGRAISEASSERTIONFAILURE_) && !defined(RC_INVOKED) &&
       // !defined(MIDL_PASS)
...
_Success_(return != 0) FORCEINLINE BOOLEAN
    _InlineBitScanForward64(_Out_ DWORD *Index, _In_ DWORD64 Mask) {
...
LONG CDECL_NON_WVMPURE
InterlockedIncrement(_Inout_ _Interlocked_operand_ LONG volatile *Addend);

LONG CDECL_NON_WVMPURE
InterlockedDecrement(_Inout_ _Interlocked_operand_ LONG volatile *Addend);

LONG __cdecl
InterlockedExchange(_Inout_ _Interlocked_operand_ LONG volatile *Target,
                    _In_ LONG Value);

LONG __cdecl
InterlockedExchangeAdd(_Inout_ _Interlocked_operand_ LONG volatile *Addend,
                       _In_ LONG Value);

FORCEINLINE
LONG _InlineInterlockedAdd(_Inout_ _Interlocked_operand_ LONG volatile *Addend,
                           _In_ LONG Value)
...
FORCEINLINE
_Ret_writes_(_Inexpressible_(Unknown)) PVOID _InlineInterlockedExchangePointer(
    _Inout_ _At_(*Destination,
                 _Pre_writable_byte_size_(_Inexpressible_(Unknown))
                     _Post_writable_byte_size_(_Inexpressible_(Unknown)))
        _Interlocked_operand_ PVOID volatile *Destination,
...
SHORT
_InterlockedAnd16(_Inout_ _Interlocked_operand_ SHORT volatile *Destination,
                  _In_ SHORT Value);
...
SHORT
_InterlockedCompareExchange16(_Inout_ _Interlocked_operand_
                                  SHORT volatile *Destination,
                              _In_ SHORT ExChange, _In_ SHORT Comperand);

SHORT
_InterlockedOr16(_Inout_ _Interlocked_operand_ SHORT volatile *Destination,
                 _In_ SHORT Value);
...
FORCEINLINE
LONG64
_InlineInterlockedAnd64(_Inout_ _Interlocked_operand_
                            LONG64 volatile *Destination,
                        _In_ LONG64 Value) {
  LONG64 Old;
...
LONG _InterlockedXor(_Inout_ _Interlocked_operand_ LONG volatile *Target,
                     _In_ LONG Set);
...
LONGLONG
FORCEINLINE
_InlineInterlockedOr64(_Inout_ _Interlocked_operand_
...
FORCEINLINE
LONG64
_InlineInterlockedXor64(_Inout_ _Interlocked_operand_
                            LONG64 volatile *Destination,
                        _In_ LONG64 Value) {
  LONG64 Old;
...
FORCEINLINE
LONGLONG
_InlineInterlockedExchange64(_Inout_ _Interlocked_operand_
...
FORCEINLINE
LONGLONG
_InlineInterlockedExchangeAdd64(_Inout_ _Interlocked_operand_
...
VOID __incfsbyte(_In_ DWORD Offset);

VOID __addfsbyte(_In_ DWORD Offset, _In_ BYTE Value);

VOID __incfsword(_In_ DWORD Offset);

VOID __addfsword(_In_ DWORD Offset, _In_ WORD Value);

VOID __incfsdword(_In_ DWORD Offset);

VOID __addfsdword(_In_ DWORD Offset, _In_ DWORD Value);
...
BYTE __readfsbyte(_In_ DWORD Offset);

WORD __readfsword(_In_ DWORD Offset);

DWORD
__readfsdword(_In_ DWORD Offset);

VOID __writefsbyte(_In_ DWORD Offset, _In_ BYTE Data);

VOID __writefsword(_In_ DWORD Offset, _In_ WORD Data);

VOID __writefsdword(_In_ DWORD Offset, _In_ DWORD Data);
...
#define EXCEPTION_EXECUTE_FAULT                                                \
  8 // Access violation was caused by an instruction fetch
...
#define CONTEXT_EXTENDED_REGISTERS                                             \
  (CONTEXT_i386 | 0x00000020L) // cpu specific extensions
...
CHAR ReadRaw8(_In_ _Interlocked_operand_ CHAR const volatile *Source);

VOID WriteRaw8(_Out_ _Interlocked_operand_ CHAR volatile *Destination,
               _In_ CHAR Value);

SHORT
ReadRaw16(_In_ _Interlocked_operand_ SHORT const volatile *Source);

VOID WriteRaw16(_Out_ _Interlocked_operand_ SHORT volatile *Destination,
                _In_ SHORT Value);

LONG ReadRaw(_In_ _Interlocked_operand_ LONG const volatile *Source);

VOID WriteRaw(_Out_ _Interlocked_operand_ LONG volatile *Destination,
              _In_ LONG Value);

LONG64
ReadRaw64(_In_ _Interlocked_operand_ LONG64 const volatile *Source);

VOID WriteRaw64(_Out_ _Interlocked_operand_ LONG64 volatile *Destination,
                _In_ LONG64 Value);
...
FORCEINLINE
LONG AddRaw(_Inout_ _Interlocked_operand_ LONG volatile *Destination,
            _In_ LONG Value)
...
FORCEINLINE
DWORD
AddULongRaw(_Inout_ _Interlocked_operand_ DWORD volatile *Destination,
            _In_ DWORD Value)
...
FORCEINLINE
LONG IncrementRaw(_Inout_ _Interlocked_operand_ LONG volatile *Destination)
...
FORCEINLINE
DWORD
IncrementULongRaw(_Inout_ _Interlocked_operand_ DWORD volatile *Destination)
...
FORCEINLINE
BYTE ReadUCharAcquire(_In_ _Interlocked_operand_ BYTE const volatile *Source)
...
FORCEINLINE
BYTE ReadUCharNoFence(_In_ _Interlocked_operand_ BYTE const volatile *Source)
...
FORCEINLINE
BYTE ReadBooleanRaw(_In_ _Interlocked_operand_ BOOLEAN const volatile *Source)
...
FORCEINLINE
BYTE ReadUCharRaw(_In_ _Interlocked_operand_ BYTE const volatile *Source)
...
FORCEINLINE
VOID WriteUCharRelease(_Out_ _Interlocked_operand_ BYTE volatile *Destination,
                       _In_ BYTE Value)
...
FORCEINLINE
VOID WriteUCharNoFence(_Out_ _Interlocked_operand_ BYTE volatile *Destination,
                       _In_ BYTE Value)
...
FORCEINLINE
VOID WriteBooleanRelease(_Out_ _Interlocked_operand_
...
FORCEINLINE
VOID WriteBooleanNoFence(_Out_ _Interlocked_operand_
                             BOOLEAN volatile *Destination,
                         _In_ BOOLEAN Value)
...
FORCEINLINE
VOID WriteUCharRaw(_Out_ _Interlocked_operand_ BYTE volatile *Destination,
                   _In_ BYTE Value)
...
FORCEINLINE
WORD ReadUShortAcquire(_In_ _Interlocked_operand_ WORD const volatile *Source)
...
FORCEINLINE
WORD ReadUShortNoFence(_In_ _Interlocked_operand_ WORD const volatile *Source)
...
FORCEINLINE
WORD ReadUShortRaw(_In_ _Interlocked_operand_ WORD const volatile *Source)
...
FORCEINLINE
VOID WriteUShortRelease(_Out_ _Interlocked_operand_ WORD volatile *Destination,
                        _In_ WORD Value)
...
FORCEINLINE
VOID WriteUShortNoFence(_Out_ _Interlocked_operand_ WORD volatile *Destination,
                        _In_ WORD Value)
...
FORCEINLINE
VOID WriteUShortRaw(_Out_ _Interlocked_operand_ WORD volatile *Destination,
                    _In_ WORD Value)
...
FORCEINLINE
DWORD
ReadULongAcquire(_In_ _Interlocked_operand_ DWORD const volatile *Source)
...
FORCEINLINE
DWORD
ReadULongNoFence(_In_ _Interlocked_operand_ DWORD const volatile *Source)
...
FORCEINLINE
DWORD
ReadULongRaw(_In_ _Interlocked_operand_ DWORD const volatile *Source)
...
CFORCEINLINE
VOID WriteULongRelease(_Out_ _Interlocked_operand_ DWORD volatile *Destination,
                       _In_ DWORD Value)
...
FORCEINLINE
VOID WriteULongNoFence(_Out_ _Interlocked_operand_ DWORD volatile *Destination,
                       _In_ DWORD Value)
...
FORCEINLINE
VOID WriteULongRaw(_Out_ _Interlocked_operand_ DWORD volatile *Destination,
                   _In_ DWORD Value)
...
FORCEINLINE
INT32
ReadInt32Acquire(_In_ _Interlocked_operand_ INT32 const volatile *Source)
...
FORCEINLINE
INT32
ReadInt32NoFence(_In_ _Interlocked_operand_ INT32 const volatile *Source)
...
FORCEINLINE
INT32
ReadInt32Raw(_In_ _Interlocked_operand_ INT32 const volatile *Source)
...
CFORCEINLINE
VOID WriteInt32Release(_Out_ _Interlocked_operand_ INT32 volatile *Destination,
                       _In_ INT32 Value)
...
FORCEINLINE
VOID WriteInt32NoFence(_Out_ _Interlocked_operand_ INT32 volatile *Destination,
                       _In_ INT32 Value)
...
FORCEINLINE
VOID WriteInt32Raw(_Out_ _Interlocked_operand_ INT32 volatile *Destination,
                   _In_ INT32 Value)
...
FORCEINLINE
UINT32
ReadUInt32Acquire(_In_ _Interlocked_operand_ UINT32 const volatile *Source)
...
FORCEINLINE
UINT32
ReadUInt32NoFence(_In_ _Interlocked_operand_ UINT32 const volatile *Source)
...
FORCEINLINE
UINT32
ReadUInt32Raw(_In_ _Interlocked_operand_ UINT32 const volatile *Source)
...
VOID WriteUInt32Release(
    _Out_ _Interlocked_operand_ UINT32 volatile *Destination, _In_ UINT32 Value)
...
FORCEINLINE
VOID WriteUInt32Raw(_Out_ _Interlocked_operand_ UINT32 volatile *Destination,
                    _In_ UINT32 Value)
...
FORCEINLINE
DWORD64
ReadULong64Acquire(_In_ _Interlocked_operand_ DWORD64 const volatile *Source)
...
FORCEINLINE
DWORD64
ReadULong64NoFence(_In_ _Interlocked_operand_ DWORD64 const volatile *Source)
...
FORCEINLINE
DWORD64
ReadULong64Raw(_In_ _Interlocked_operand_ DWORD64 const volatile *Source)
...
CFORCEINLINE
VOID WriteULong64Release(_Out_ _Interlocked_operand_
...
FORCEINLINE
VOID WriteULong64NoFence(_Out_ _Interlocked_operand_
                             DWORD64 volatile *Destination,
                         _In_ DWORD64 Value)
...
FORCEINLINE
VOID WriteULong64Raw(_Out_ _Interlocked_operand_ DWORD64 volatile *Destination,
                     _In_ DWORD64 Value)
...
FORCEINLINE
LONG64
AddRaw64(_Inout_ _Interlocked_operand_ LONG64 volatile *Destination,
         _In_ LONG64 Value)
...
FORCEINLINE
DWORD64
AddULong64Raw(_Inout_ _Interlocked_operand_ DWORD64 volatile *Destination,
              _In_ DWORD64 Value)
...
FORCEINLINE
LONG64
IncrementRaw64(_Inout_ _Interlocked_operand_ LONG64 volatile *Destination)
...
FORCEINLINE
DWORD64
IncrementULong64Raw(_Inout_ _Interlocked_operand_ DWORD64 volatile *Destination)
...
VOID WritePointerRelease(
    _Out_ _Interlocked_operand_ PVOID volatile *Destination, _In_ PVOID Value)
...
FORCEINLINE
VOID WritePointerNoFence(_Out_ _Interlocked_operand_
...
FORCEINLINE
VOID WritePointerRaw(_Out_ _Interlocked_operand_ PVOID volatile *Destination,
                     _In_opt_ PVOID Value)
...
#define WOW64_CONTEXT_CONTROL                                                  \
  (WOW64_CONTEXT_i386 | 0x00000001L) // SS:SP, CS:IP, FLAGS, BP
#define WOW64_CONTEXT_INTEGER                                                  \
  (WOW64_CONTEXT_i386 | 0x00000002L) // AX, BX, CX, DX, SI, DI
#define WOW64_CONTEXT_SEGMENTS                                                 \
  (WOW64_CONTEXT_i386 | 0x00000004L) // DS, ES, FS, GS
#define WOW64_CONTEXT_FLOATING_POINT                                           \
  (WOW64_CONTEXT_i386 | 0x00000008L) // 387 state
#define WOW64_CONTEXT_DEBUG_REGISTERS                                          \
  (WOW64_CONTEXT_i386 | 0x00000010L) // DB 0-3,6,7
#define WOW64_CONTEXT_EXTENDED_REGISTERS                                       \
  (WOW64_CONTEXT_i386 | 0x00000020L) // cpu specific extensions
...
NTSYSAPI
VOID NTAPI RtlUnwind2(_In_opt_ FRAME_POINTERS TargetFrame,
                      _In_opt_ PVOID TargetIp,
                      _In_opt_ PEXCEPTION_RECORD ExceptionRecord,
                      _In_ PVOID ReturnValue, _In_ PCONTEXT ContextRecord);
...
#define SID_RECOMMENDED_SUB_AUTHORITIES                                        \
  (1) // Will change to around 6 in a future release.
...
#define SECURITY_SID_SIZE(SubAuthorityCount_)                                  \
  (sizeof(SID) - sizeof(DWORD) + (SubAuthorityCount_) * sizeof(DWORD))
...
//
// Virtual account logon is not limited to inbox callers.  Reserve base RID 0x6F
...
//
// Installer Capability Group Sid related. Currently Base RID is same as LOCAL
// DOMAIN.
//
...
#define SECURITY_MANDATORY_MEDIUM_PLUS_CREDUI_RID                              \
  (SECURITY_MANDATORY_MEDIUM_RID + 0xA)
...
typedef enum _ACCESS_REASON_TYPE {
  ...
  AccessReasonNone = 0x00000000, // Indicate no reason for the bit. The bit may
                                 // not be checked, or just no known reason.
  ...
  AccessReasonAllowedParentAce =
      0x00030000, // Granted a permission from parent ACE
  AccessReasonDeniedParentAce =
      0x00040000, // Denied a permission from parent ACE

  AccessReasonNotGrantedByCape =
      0x00050000, // A CAPE didn't grant the permission
  AccessReasonNotGrantedByParentCape =
      0x00060000, // A CAPE from the parent's SD didn't grant the permission

  AccessReasonNotGrantedToAppContainer =
      0x00070000, // This is an AppContainer and no ACE granted the permission.
  ...
  AccessReasonNoGrant =
      0x00800000, // this access bit is not granted by any ACE.

  AccessReasonTrustLabel =
      0x00900000, // The trust label ACE did not grant this access.

  AccessReasonFilterAce =
      0x00a00000 // The filtering ACE did not grant this access
} ACCESS_REASON_TYPE;
...
// (NOTE NOTE) The cache key can be constructed by SecurityDescriptorId, Token
// and PrincipalSelfSid. Watch how GenericMapping affects the cache results.
//
...
typedef struct _SE_ACCESS_REPLY {
  DWORD Size;
  DWORD ResultListCount; // Indicate the array size of GrantedAccess and
                         // AccessStatus, it only can be either 1 or
                         // ObjectTypeListCount.
...
#define SE_APP_SILO_PROMPT_FOR_ACCESS_CAPABILITY                               \
  L"isolatedWin32-promptForAccess"
#define SE_APP_SILO_ACCESS_TO_PUBLISHER_DIRECTORY_CAPABILITY                   \
...
#define TOKEN_TRUST_ALLOWED_MASK                                               \
...
//  value or composite type containing string value. For other types of value,
//  this flag will be ignored. Currently, it is valid with the two types:
...
typedef struct _JOB_SET_ARRAY {
  ...
  DWORD
  MemberLevel; // Level of this job in the set. Must be > 0. Can be sparse.
...
//
// N.B. The JOBOBJECT_SECURITY_LIMIT_INFORMATION information class is no longer
// supported.
//
...
#define JOB_OBJECT_NOTIFICATION_LIMIT_VALID_FLAGS                              \
  (JOB_OBJECT_LIMIT_JOB_READ_BYTES | JOB_OBJECT_LIMIT_JOB_WRITE_BYTES |        \
   JOB_OBJECT_LIMIT_JOB_TIME | JOB_OBJECT_LIMIT_JOB_MEMORY_LOW |               \
   JOB_OBJECT_LIMIT_JOB_MEMORY_HIGH | JOB_OBJECT_LIMIT_CPU_RATE_CONTROL |      \
...
// 10   PASID                               Supervisor
// 11   CET_U                               Supervisor
// 12   CET_S                               Supervisor (Cannot be used by NT!
// Only defined for SK intercept purposes!)
//
// 17   TILE_CONFIG
...
#define XSTATE_MASK_MPX                                                        \
  ((1ui64 << (XSTATE_MPX_BNDREGS)) | (1ui64 << (XSTATE_MPX_BNDCSR)))

#define XSTATE_MASK_AVX512                                                     \
  ((1ui64 << (XSTATE_AVX512_KMASK)) | (1ui64 << (XSTATE_AVX512_ZMM_H)) |       \
...
#define XSTATE_MASK_PERSISTENT                                                 \
  ((1ui64 << (XSTATE_MPX_BNDCSR)) | XSTATE_MASK_LWP)
...
#define XSTATE_MASK_AMD64_LEGACY                                               \
  (XSTATE_MASK_LEGACY_FLOATING_POINT | XSTATE_MASK_LEGACY_SSE)
...
typedef struct _RUNTIME_REPORT_PACKAGE_HEADER {
  ...
  //
  // Use RUNTIME_REPORT_TYPE_TO_MASK macro to convert enum values to bitmap
  // masks. Current valid report types:
  //      RuntimeReportTypeDriver = 0
  //
...
typedef struct _DRIVER_INFO_ENTRY {
  ...
  //
  //      - HotPatch - Set to 1 in case the image can be also loaded as
  //      Hotpatch;
  //
...
typedef struct _DRIVER_RUNTIME_REPORT {
  ...
  //
  // A list, of size zero up to MaximumDriversRecorded, containing driver
  // entries. Unloaded drivers are not removed from the list.
  //
...
#define SECTION_MAP_EXECUTE_EXPLICIT                                           \
  0x0020 // not included in SECTION_ALL_ACCESS
...
#define FILE_NAME_FLAGS_UNSPECIFIED                                            \
  0x80 // not specified by file system (do not combine with other flags)
...
//  as much as possible.  This will send a SYNC to the storage device to flush
//  its cache.  Not supported on volume or directory handles.
//
...
typedef struct _SCRUB_DATA_OUTPUT {
  ...
  //
  // Offset of the error range of the user data where the operational errors
  // were found. This value may be -1 if the error were found in non-user data
  // area
  //
  ...
  //
  // Length of the error range of the user data where the operational errors
  // were found. This value may be 0 if the error were found in non-user data
  // area
  //
...
typedef struct _SHARED_VIRTUAL_DISK_SUPPORT {
  //
  // One or more of the above SharedVirtualDiskSupportType flags that indicate
  // the level of shared virtual disk support on this file system.
  //
  SharedVirtualDiskSupportType SharedVirtualDiskSupport;

  //
  // The state of the current shared virtual disk handle.  This is one or more
  // of the above SharedVirtualDiskHandleState flags.
  //
...
// FSCTL_QUERY_SHARED_VIRTUAL_DISK_SUPPORT, indicates that the target virtual
// disk file is opened in shared mode.
//
#define IsVirtualDiskFileShared(HandleState)                                   \
...
//
// Maximum Power Savings - indicates that very aggressive power savings measures
...
//
// No Power Savings - indicates that almost no power savings measures will be
// used.
//
...
//
// This is a special GUID that represents "no subgroup" of settings.  That is,
// it indicates that settings that are in the root of the power policy hierarchy
// as opposed to settings that are buried under a subgroup of settings.  This
// should be used when querying for power settings that may not fall into a
// subgroup.
//
...
// indicates that any write to this power scheme should be reflected to every
// scheme present. This allows users to write a single setting once and have it
// apply to all schemes.  They can then apply custom settings to specific power
// schemes that they care about.
//
DEFINE_GUID(ALL_POWERSCHEMES_GUID, 0x68A1E95E, 0x13EA, 0x41E1, 0x80, 0x11, 0x0C,
            0x49, 0x6C, 0xA4, 0x90, 0xB0);

//
// This is a special GUID that represents a 'personality' that each power scheme
// will have. In other words, each power scheme will have this key indicating
// "I'm most like *this* base power scheme."  This individual setting will have
// one of three settings: GUID_MAX_POWER_SAVINGS GUID_MIN_POWER_SAVINGS
// GUID_TYPICAL_POWER_SAVINGS
//
// This allows several features:
// 1. Drivers and applications can register for notification of this GUID.  So
// when this power
//    scheme is activiated, this GUID's setting will be sent across the system
//    and drivers/applications can see "GUID_MAX_POWER_SAVINGS" which will tell
//    them in a generic fashion "get real aggressive about conserving power".
// 2. UserB may install a driver or application which creates power settings,
// and UserB may modify
//    those power settings.  Now UserA logs in.  How does he see those settings?
//    They simply don't exist in his private power key.  Well they do exist over
//    in the system power key.  When we enumerate all the power settings in this
//    system power key and don't find a corresponding entry in the user's
//    private power key, then we can go look at this "personality" key in the
//    users power scheme.  We can then go get a default value for the power
//    setting, depending on which "personality" power scheme is being operated
//    on.  Here's an example: A. UserB installs an application that creates a
//    power setting Seetting1 B. UserB changes Setting1 to have a value of 50
//    because that's one of the possible settings
...
//       setting1 in his private power key.
...
//    F. The power manager will see that UserA has no Setting1 power setting in
//    his private power scheme. G. The power manager will query UserA's power
//    scheme for its personality and retrieve
//       GUID_TYPICAL_POWER_SAVINGS.
...
DEFINE_GUID(GUID_POWER_MODE_BEST_EFFICIENCY, 0x961cc777, 0x2547, 0x4f9d, 0x81,
            0x74, 0x7d, 0x86, 0x18, 0x1b, 0x8a, 0x7a);
...
DEFINE_GUID(GUID_POWER_MODE_PERFORMANCE, 0x3af9b8d9, 0x7c97, 0x431d, 0xad, 0x78,
            0x34, 0xa8, 0xbf, 0xea, 0x43, 0x9f);
...
DEFINE_GUID(GUID_POWER_MODE_BEST_PERFORMANCE, 0xded574b5, 0x45a0, 0x4f42, 0x87,
            0x37, 0x46, 0x34, 0x5c, 0x9, 0xc2, 0x38);
...
DEFINE_GUID(GUID_DEEP_SLEEP_ENABLED, 0xd502f7ee, 0x1dc7, 0x4efd, 0xa5, 0x5d,
            0xf0, 0x4b, 0x6f, 0x5c, 0x5, 0x45);
...
DEFINE_GUID(GUID_DEEP_SLEEP_PLATFORM_STATE, 0xd23f2fb8, 0x9536, 0x4038, 0x9c,
            0x94, 0x1c, 0xe0, 0x2e, 0x5c, 0x21, 0x52);
...
//
DEFINE_GUID(GUID_ADVANCED_COLOR_QUALITY_BIAS, 0x684c3e69, 0xa4f7, 0x4014, 0x87,
            0x54, 0xd4, 0x51, 0x79, 0xa5, 0x61, 0x67);
...
DEFINE_GUID(GUID_ADAPTIVE_INPUT_CONTROLLER_STATE, 0xe98fae9, 0xf45a, 0x4de1,
            0xa7, 0x57, 0x60, 0x31, 0xf1, 0x97, 0xf6, 0xea);
...
//
DEFINE_GUID(GUID_DISK_MAX_POWER, 0x51dea550, 0xbb38, 0x4bc4, 0x99, 0x1b, 0xea,
            0xcf, 0x37, 0xbe, 0x5e, 0xc8);
...
//
// Specifies whether NVMe non-operational power state permissive mode is
// enabled.
//
DEFINE_GUID(GUID_DISK_NVME_NOPPME, 0xfc7372b6, 0xab2d, 0x43ee, 0x87, 0x97, 0x15,
            0xe9, 0x84, 0x1f, 0x2c, 0xca);
...
//
DEFINE_GUID(GUID_USER_PRESENCE_PREDICTION, 0x82011705, 0xfb95, 0x4d46, 0x8d,
            0x35, 0x40, 0x42, 0xb1, 0xd2, 0xd, 0xef);
...
//
DEFINE_GUID(GUID_STANDBY_BUDGET_GRACE_PERIOD, 0x60c07fe1, 0x0556, 0x45cf, 0x99,
            0x03, 0xd5, 0x6e, 0x32, 0x21, 0x2, 0x42);
...
//
DEFINE_GUID(GUID_STANDBY_BUDGET_PERCENT, 0x9fe527be, 0x1b70, 0x48da, 0x93, 0x0d,
            0x7b, 0xcf, 0x17, 0xb4, 0x49, 0x90);
...
//
DEFINE_GUID(GUID_STANDBY_BUDGET_REFRESH_COUNT, 0xACA8648E, 0xC4B1, 0x4BAA, 0x8C,
            0xCE, 0x93, 0x90, 0xAD, 0x64, 0x7F, 0x8C);
...
//
DEFINE_GUID(GUID_STANDBY_BUDGET_REFRESH_INTERVAL, 0x61F45DFE, 0x1919, 0x4180,
            0xBB, 0x46, 0x8C, 0xC7, 0x0E, 0x0B, 0x38, 0xF1);
...
//
DEFINE_GUID(GUID_STANDBY_RESERVE_GRACE_PERIOD, 0xc763ee92, 0x71e8, 0x4127, 0x84,
            0xeb, 0xf6, 0xed, 0x04, 0x3a, 0x3e, 0x3d);
...
//
DEFINE_GUID(GUID_STANDBY_RESERVE_TIME, 0x468FE7E5, 0x1158, 0x46EC, 0x88, 0xbc,
            0x5b, 0x96, 0xc9, 0xe4, 0x4f, 0xd0);
...
//
DEFINE_GUID(GUID_STANDBY_RESET_PERCENT, 0x49cb11a5, 0x56e2, 0x4afb, 0x9d, 0x38,
            0x3d, 0xf4, 0x78, 0x72, 0xe2, 0x1b);

//
// Defines a guid to control Human Presence Sensor Adaptive Away Display
// Timeout.
//
// {0A7D6AB6-AC83-4AD1-8282-ECA5B58308F3}
//
DEFINE_GUID(GUID_HUPR_ADAPTIVE_AWAY_DISPLAY_TIMEOUT, 0x0A7D6AB6, 0xAC83, 0x4AD1,
            0x82, 0x82, 0xEC, 0xA5, 0xB5, 0x83, 0x08, 0xF3);

#define GUID_HUPR_ADAPTIVE_DISPLAY_TIMEOUT                                     \
  GUID_HUPR_ADAPTIVE_AWAY_DISPLAY_TIMEOUT

//
// Defines a guid to control Human Presence Sensor Adaptive Inattentive Dim
// Timeout;
//
// {CF8C6097-12B8-4279-BBDD-44601EE5209D}
//

DEFINE_GUID(GUID_HUPR_ADAPTIVE_INATTENTIVE_DIM_TIMEOUT, 0xCF8C6097, 0x12B8,
            0x4279, 0xBB, 0xDD, 0x44, 0x60, 0x1E, 0xE5, 0x20, 0x9D);

#define GUID_HUPR_ADAPTIVE_DIM_TIMEOUT                                         \
  GUID_HUPR_ADAPTIVE_INATTENTIVE_DIM_TIMEOUT

//
// Defines a guid to control Human Presence Sensor Adaptive Inattentive Display
// Timeout.
//
// {EE16691E-6AB3-4619-BB48-1C77C9357E5A}
//
DEFINE_GUID(GUID_HUPR_ADAPTIVE_INATTENTIVE_DISPLAY_TIMEOUT, 0xEE16691E, 0x6AB3,
            0x4619, 0xBB, 0x48, 0x1C, 0x77, 0xC9, 0x35, 0x7E, 0x5A);
...
DEFINE_GUID(GUID_HUPR_ADAPTIVE_AWAY_DIM_TIMEOUT, 0xA79C8E0E, 0xF271, 0x482D,
            0x8F, 0x8A, 0x5D, 0xB9, 0xA1, 0x83, 0x12, 0xDE);
...
//
DEFINE_GUID(GUID_LEGACY_RTC_MITIGATION, 0x1A34BDC3, 0x7E6B, 0x442E, 0xA9, 0xD0,
            0x64, 0xB6, 0xEF, 0x37, 0x8E, 0x84);
...
//
DEFINE_GUID(GUID_POWER_SAVING_STATUS, 0xe00958c0, 0xc213, 0x4ace, 0xac, 0x77,
            0xfe, 0xcc, 0xed, 0x2e, 0xee, 0xa5);

//
// Energy Saver Settings
// ---------------------
//
// Defines a guid to indicate energy saver status (Off, Standard, or High
// Savings) from the ENERGY_SAVER_STATUS structure.
//
...
//
DEFINE_GUID(GUID_ENERGY_SAVER_STATUS, 0x550e8400, 0xe29b, 0x41d4, 0xa7, 0x16,
...
//
DEFINE_GUID(GUID_ENERGY_SAVER_BATTERY_THRESHOLD, 0xE69653CA, 0xCF7F, 0x4F05,
...
//
DEFINE_GUID(GUID_ENERGY_SAVER_BRIGHTNESS, 0x13D09884, 0xF74E, 0x474A, 0xA8,
            0x52, 0xB6, 0xBD, 0xE8, 0xAD, 0x03, 0xA8);
...
//
DEFINE_GUID(GUID_ENERGY_SAVER_POLICY, 0x5c5bb349, 0xad29, 0x4ee2, 0x9d, 0xb,
            0x2b, 0x25, 0x27, 0xf, 0x7a, 0x81);
...
#define PERFSTATE_POLICY_CHANGE_INCREASE_MAX                                   \
...
//
DEFINE_GUID(GUID_PROCESSOR_THROTTLE_MAXIMUM_2, 0xBC5038F7, 0x23E0, 0x4960, 0x96,
            0xDA, 0x33, 0xAB, 0xAF, 0x59, 0x35, 0xEE);
...
//
DEFINE_GUID(GUID_PROCESSOR_THROTTLE_MINIMUM_2, 0x893DEE8E, 0x2BEF, 0x41E0, 0x89,
            0xC6, 0xB5, 0x5D, 0x09, 0x29, 0x96, 0x4E);
...
DEFINE_GUID(GUID_PROCESSOR_FREQUENCY_LIMIT, 0x75b0ae3f, 0xbce0, 0x45a7, 0x8c,
            0x89, 0xc9, 0x61, 0x1c, 0x25, 0xe1, 0x00);

// {75B0AE3F-BCE0-45a7-8C89-C9611C25E101}
DEFINE_GUID(GUID_PROCESSOR_FREQUENCY_LIMIT_1, 0x75b0ae3f, 0xbce0, 0x45a7, 0x8c,
            0x89, 0xc9, 0x61, 0x1c, 0x25, 0xe1, 0x01);

// {75B0AE3F-BCE0-45a7-8C89-C9611C25E102}
DEFINE_GUID(GUID_PROCESSOR_FREQUENCY_LIMIT_2, 0x75b0ae3f, 0xbce0, 0x45a7, 0x8c,
            0x89, 0xc9, 0x61, 0x1c, 0x25, 0xe1, 0x02);
...
//
DEFINE_GUID(GUID_PROCESSOR_PERF_INCREASE_THRESHOLD_1, 0x06cadf0e, 0x64ed,
            0x448a, 0x89, 0x27, 0xce, 0x7b, 0xf9, 0x0e, 0xb3, 0x5e);
...
//
DEFINE_GUID(GUID_PROCESSOR_PERF_DECREASE_THRESHOLD_1, 0x12a0ab44, 0xfe28,
            0x4fa9, 0xb3, 0xbd, 0x4b, 0x64, 0xf4, 0x49, 0x60, 0xa7);
...
//
DEFINE_GUID(GUID_PROCESSOR_PERF_INCREASE_TIME_1, 0x984cf492, 0x3bed, 0x4488,
            0xa8, 0xf9, 0x42, 0x86, 0xc9, 0x7b, 0xf5, 0xab);
...
//
DEFINE_GUID(GUID_PROCESSOR_PERF_DECREASE_TIME_1, 0xd8edeb9b, 0x95cf, 0x4f95,
            0xa7, 0x3c, 0xb0, 0x61, 0x97, 0x36, 0x93, 0xc9);
...
//
DEFINE_GUID(GUID_PROCESSOR_PERF_AUTONOMOUS_MODE, 0x8baa4a8a, 0x14c6, 0x4451,
            0x8e, 0x8b, 0x14, 0xbd, 0xbd, 0x19, 0x75, 0x37);
...
DEFINE_GUID(GUID_PROCESSOR_PERF_ENERGY_PERFORMANCE_PREFERENCE, 0x36687f9e,
            0xe3a5, 0x4dbf, 0xb1, 0xdc, 0x15, 0xeb, 0x38, 0x1c, 0x68, 0x63);
...
DEFINE_GUID(GUID_PROCESSOR_PERF_ENERGY_PERFORMANCE_PREFERENCE_1, 0x36687f9e,
            0xe3a5, 0x4dbf, 0xb1, 0xdc, 0x15, 0xeb, 0x38, 0x1c, 0x68, 0x64);
...
DEFINE_GUID(GUID_PROCESSOR_PERF_ENERGY_PERFORMANCE_PREFERENCE_2, 0x36687f9e,
            0xe3a5, 0x4dbf, 0xb1, 0xdc, 0x15, 0xeb, 0x38, 0x1c, 0x68, 0x65);
...
DEFINE_GUID(GUID_PROCESSOR_PERF_AUTONOMOUS_ACTIVITY_WINDOW, 0xcfeda3d0, 0x7697,
            0x4566, 0xa9, 0x22, 0xa9, 0x8, 0x6c, 0xd4, 0x9d, 0xfa);
...
DEFINE_GUID(GUID_PROCESSOR_DUTY_CYCLING, 0x4e4450b3, 0x6179, 0x4e91, 0xb8, 0xf1,
            0x5b, 0xb9, 0x93, 0x8f, 0x81, 0xa1);
...
//
// Specifies the factor by which to decrease affinity history on each core after
// each check.
//
...
//
// Specifies the weighting given to each occurence where affinitized work was
// scheduled to a parked core.
//
...
//
// Specifies the factor by which to decrease the over utilization history on
// each core after the current performance check.
//
...
//
// Specifies the weighting given to each occurence where a parked core is found
// to be over utilized.
//
...
//
// Specifies, in percentage, the busy threshold that must be met before a parked
// core is considered over utilized.
//
...
//
DEFINE_GUID(GUID_PROCESSOR_PARKING_PERF_STATE_1, 0x447235c7, 0x6a8d, 0x4cc0,
            0x8e, 0x24, 0x9e, 0xaf, 0x70, 0xb9, 0x6e, 0x2c);
...
//
DEFINE_GUID(GUID_PROCESSOR_SOFT_PARKING_LATENCY, 0x97cfac41, 0x2217, 0x47eb,
            0x99, 0x2d, 0x61, 0x8b, 0x19, 0x77, 0xc9, 0x7);
...
//
DEFINE_GUID(GUID_PROCESSOR_PERF_HISTORY_1, 0x7d24baa7, 0x0b84, 0x480f, 0x84,
            0x0c, 0x1b, 0x07, 0x43, 0xc0, 0x0f, 0x60);
...
//
DEFINE_GUID(GUID_PROCESSOR_PERF_INCREASE_HISTORY, 0x99b3ef01, 0x752f, 0x46a1,
            0x80, 0xfb, 0x77, 0x30, 0x1, 0x1f, 0x23, 0x54);
...
//
DEFINE_GUID(GUID_PROCESSOR_PERF_DECREASE_HISTORY, 0x300f6f8, 0xabd6, 0x45a9,
            0xb7, 0x4f, 0x49, 0x8, 0x69, 0x1a, 0x40, 0xb5);
...
//
DEFINE_GUID(GUID_PROCESSOR_PERF_CORE_PARKING_HISTORY, 0x77d7f282, 0x8f1a,
            0x42cd, 0x85, 0x37, 0x45, 0x45, 0xa, 0x83, 0x9b, 0xe8);
...
//
DEFINE_GUID(GUID_PROCESSOR_PERF_LATENCY_HINT_PERF, 0x619b7505, 0x3b, 0x4e82,
            0xb7, 0xa6, 0x4d, 0xd2, 0x9c, 0x30, 0x9, 0x71);
...
//
DEFINE_GUID(GUID_PROCESSOR_PERF_LATENCY_HINT_PERF_2, 0x619b7505, 0x3b, 0x4e82,
            0xb7, 0xa6, 0x4d, 0xd2, 0x9c, 0x30, 0x9, 0x73);
...
//
DEFINE_GUID(GUID_PROCESSOR_PERF_LATENCY_HINT_EPP, 0x4b70f900, 0xcdd9, 0x4e66,
            0xaa, 0x26, 0xae, 0x84, 0x17, 0xf9, 0x81, 0x73);
...
//
DEFINE_GUID(GUID_PROCESSOR_PERF_LATENCY_HINT_EPP_1, 0x4b70f900, 0xcdd9, 0x4e66,
            0xaa, 0x26, 0xae, 0x84, 0x17, 0xf9, 0x81, 0x74);
...
//
DEFINE_GUID(GUID_PROCESSOR_PERF_LATENCY_HINT_EPP_2, 0x4b70f900, 0xcdd9, 0x4e66,
            0xaa, 0x26, 0xae, 0x84, 0x17, 0xf9, 0x81, 0x75);
...
//
DEFINE_GUID(GUID_PROCESSOR_LATENCY_HINT_MIN_UNPARK_1, 0x616cdaa5, 0x695e,
            0x4545, 0x97, 0xad, 0x97, 0xdc, 0x2d, 0x1b, 0xdd, 0x89);
...
//
DEFINE_GUID(GUID_PROCESSOR_MODULE_PARKING_POLICY, 0xb0deaf6b, 0x59c0, 0x4523,
            0x8a, 0x45, 0xca, 0x7f, 0x40, 0x24, 0x41, 0x14);
...
//
DEFINE_GUID(GUID_PROCESSOR_COMPLEX_PARKING_POLICY, 0xb669a5e9, 0x7b1d, 0x4132,
            0xba, 0xaa, 0x49, 0x19, 0xa, 0xbc, 0xfe, 0xb6);
...
DEFINE_GUID(GUID_PROCESSOR_SMT_UNPARKING_POLICY, 0xb28a6829, 0xc5f7, 0x444e,
            0x8f, 0x61, 0x10, 0xe2, 0x4e, 0x85, 0xc5, 0x32);
...
DEFINE_GUID(GUID_PROCESSOR_RESTRICTION_COUNT, 0x1a98ad09, 0xaf22, 0x42ca, 0x8e,
            0x61, 0xf0, 0xa5, 0x80, 0x2c, 0x27, 0x0a);
...
//
DEFINE_GUID(GUID_PROCESSOR_RESOURCE_PRIORITY, 0x603fe9ce, 0x8d01, 0x4b48, 0xa9,
            0x68, 0x1d, 0x70, 0x6c, 0x28, 0xfd, 0x5c);

//
// Specifies the processor resource priority for Processor Power Efficiency
// Class 1.
//
// {603fe9ce-8d01-4b48-a968-1d706c28df5d}
//
DEFINE_GUID(GUID_PROCESSOR_RESOURCE_PRIORITY_1, 0x603fe9ce, 0x8d01, 0x4b48,
            0xa9, 0x68, 0x1d, 0x70, 0x6c, 0x28, 0xfd, 0x5d);
...
//
DEFINE_GUID(GUID_PROCESSOR_RESOURCE_PRIORITY_2, 0x603fe9ce, 0x8d01, 0x4b48,
            0xa9, 0x68, 0x1d, 0x70, 0x6c, 0x28, 0xfd, 0x5e);
...
//
DEFINE_GUID(GUID_PROCESSOR_HETEROGENEOUS_POLICY, 0x7f2f5cfa, 0xf10c, 0x4823,
            0xb5, 0xe1, 0xe9, 0x3a, 0xe8, 0x5f, 0x46, 0xb5);
...
//
DEFINE_GUID(GUID_PROCESSOR_HETERO_DECREASE_TIME, 0x7f2492b6, 0x60b1, 0x45e5,
            0xae, 0x55, 0x77, 0x3f, 0x8c, 0xd5, 0xca, 0xec);
...
//
DEFINE_GUID(GUID_PROCESSOR_HETERO_INCREASE_TIME, 0x4009efa7, 0xe72d, 0x4cba,
            0x9e, 0xdf, 0x91, 0x08, 0x4e, 0xa8, 0xcb, 0xc3);
...
//
DEFINE_GUID(GUID_PROCESSOR_HETERO_CONTAINMENT_DECREASE_TIME, 0x6FF13AEB, 0x7897,
            0x4356, 0x99, 0x99, 0xDD, 0x99, 0x30, 0xAF, 0x06, 0x5F);
...
//
DEFINE_GUID(GUID_PROCESSOR_HETERO_CONTAINMENT_INCREASE_TIME, 0x64FCEE6B, 0x5B1F,
            0x45A4, 0xA7, 0x6A, 0x19, 0xB2, 0xC3, 0x6E, 0xE2, 0x90);
...
DEFINE_GUID(GUID_PROCESSOR_HETERO_CONTAINMENT_EFFICIENCY_THRESHOLD, 0x69439b22,
            0x221b, 0x4830, 0xbd, 0x34, 0xf7, 0xbc, 0xec, 0xe2, 0x45, 0x83);
...
DEFINE_GUID(GUID_PROCESSOR_HETERO_CONTAINMENT_HYBRID_THRESHOLD, 0x6788488b,
            0x1b90, 0x4d11, 0x8f, 0xa7, 0x97, 0x3e, 0x47, 0xd, 0xff, 0x47);

//
// Specify whether containment policy should be enable or disable.
//
// {60FBE21B-EFD9-49F2-B066-8674D8E9F423}
DEFINE_GUID(GUID_PROCESSOR_HETERO_CONTAINMENT_POLICY, 0x60fbe21b, 0xefd9,
            0x49f2, 0xb0, 0x66, 0x86, 0x74, 0xd8, 0xe9, 0xf4, 0x23);

//
// Specify the important utility percentage that once met, allow workload to
// move to hybrid containment zone.
//
// {6ece9e1f-b6dd-42bf-b1b7-5a512b10c092}
DEFINE_GUID(GUID_PROCESSOR_HETERO_CONTAINMENT_EFFICIENCY_IMP_UTIL_THRESHOLD,
            0x6ece9e1f, 0xb6dd, 0x42bf, 0xb1, 0xb7, 0x5a, 0x51, 0x2b, 0x10,
            0xc0, 0x92);

//
// Specify the important utility percentage that once met, allow workload to
// move to no containment zone.
//
// {12fd031f-53d2-4bf4-ac6d-c699fc9538c7}
DEFINE_GUID(GUID_PROCESSOR_HETERO_CONTAINMENT_HYBRID_IMP_UTIL_THRESHOLD,
            0x12fd031f, 0x53d2, 0x4bf4, 0xac, 0x6d, 0xc6, 0x99, 0xfc, 0x95,
            0x38, 0xc7);
...
DEFINE_GUID(GUID_PROCESSOR_WPS_MIN_EFFICIENCY_THRESHOLD, 0x5ba7419a, 0x295c,
            0x4b02, 0x84, 0x1b, 0x66, 0x79, 0x93, 0x88, 0xd6, 0xda);
...
//
DEFINE_GUID(GUID_PROCESSOR_HETERO_DECREASE_THRESHOLD, 0xf8861c27, 0x95e7,
            0x475c, 0x86, 0x5b, 0x13, 0xc0, 0xcb, 0x3f, 0x9d, 0x6b);
...
//
DEFINE_GUID(GUID_PROCESSOR_HETERO_DECREASE_THRESHOLD_1, 0xf8861c27, 0x95e7,
            0x475c, 0x86, 0x5b, 0x13, 0xc0, 0xcb, 0x3f, 0x9d, 0x6c);
...
//
DEFINE_GUID(GUID_PROCESSOR_HETERO_INCREASE_THRESHOLD, 0xb000397d, 0x9b0b,
            0x483d, 0x98, 0xc9, 0x69, 0x2a, 0x60, 0x60, 0xcf, 0xbf);
...
//
DEFINE_GUID(GUID_PROCESSOR_HETERO_INCREASE_THRESHOLD_1, 0xb000397d, 0x9b0b,
            0x483d, 0x98, 0xc9, 0x69, 0x2a, 0x60, 0x60, 0xcf, 0xc0);
...
//
DEFINE_GUID(GUID_PROCESSOR_CLASS1_INITIAL_PERF, 0x1facfc65, 0xa930, 0x4bc5,
            0x9f, 0x38, 0x50, 0x4e, 0xc0, 0x97, 0xbb, 0xc0);
...
//
DEFINE_GUID(GUID_PROCESSOR_THREAD_SCHEDULING_POLICY, 0x93b8b6dc, 0x698, 0x4d1c,
            0x9e, 0xe4, 0x6, 0x44, 0xe9, 0x0, 0xc8, 0x5d);
...
//
DEFINE_GUID(GUID_PROCESSOR_SHORT_THREAD_SCHEDULING_POLICY, 0xbae08b81, 0x2d5e,
            0x4688, 0xad, 0x6a, 0x13, 0x24, 0x33, 0x56, 0x65, 0x4b);
...
//
DEFINE_GUID(GUID_PROCESSOR_SHORT_THREAD_RUNTIME_THRESHOLD, 0xd92998c2, 0x6a48,
            0x49ca, 0x85, 0xd4, 0x8c, 0xce, 0xec, 0x29, 0x45, 0x70);
...
//
DEFINE_GUID(GUID_PROCESSOR_SHORT_THREAD_ARCH_CLASS_UPPER_THRESHOLD, 0x828423eb,
            0x8662, 0x4344, 0x90, 0xf7, 0x52, 0xbf, 0x15, 0x87, 0x0f, 0x5a);
...
//
DEFINE_GUID(GUID_PROCESSOR_SHORT_THREAD_ARCH_CLASS_LOWER_THRESHOLD, 0x53824d46,
            0x87bd, 0x4739, 0xaa, 0x1b, 0xaa, 0x79, 0x3f, 0xac, 0x36, 0xd6);
...
//
DEFINE_GUID(GUID_PROCESSOR_LONG_THREAD_ARCH_CLASS_UPPER_THRESHOLD, 0xbf903d33,
            0x9d24, 0x49d3, 0xa4, 0x68, 0xe6, 0x5e, 0x03, 0x25, 0x04, 0x6a);
...
//
DEFINE_GUID(GUID_PROCESSOR_LONG_THREAD_ARCH_CLASS_LOWER_THRESHOLD, 0x43f278bc,
            0x0f8a, 0x46d0, 0x8b, 0x31, 0x9a, 0x23, 0xe6, 0x15, 0xd7, 0x13);
...
//
DEFINE_GUID(GUID_PROCESSOR_RESPONSIVENESS_DISABLE_THRESHOLD, 0x38b8383d, 0xcce0,
            0x4c79, 0x9e, 0x3e, 0x56, 0xa4, 0xf1, 0x7c, 0xc4, 0x80);
...
//
DEFINE_GUID(GUID_PROCESSOR_RESPONSIVENESS_DISABLE_THRESHOLD_1, 0x38b8383d,
            0xcce0, 0x4c79, 0x9e, 0x3e, 0x56, 0xa4, 0xf1, 0x7c, 0xc4, 0x81);
...
DEFINE_GUID(GUID_PROCESSOR_RESPONSIVENESS_ENABLE_THRESHOLD, 0x3d44e256, 0x7222,
            0x4415, 0xa9, 0xed, 0x9c, 0x45, 0xfa, 0x3d, 0xd8, 0x30);
...
DEFINE_GUID(GUID_PROCESSOR_RESPONSIVENESS_ENABLE_THRESHOLD_1, 0x3d44e256,
            0x7222, 0x4415, 0xa9, 0xed, 0x9c, 0x45, 0xfa, 0x3d, 0xd8, 0x31);
...
DEFINE_GUID(GUID_PROCESSOR_RESPONSIVENESS_DISABLE_TIME, 0xf565999f, 0x3fb0,
            0x411a, 0xa2, 0x26, 0x3f, 0x1, 0x98, 0xde, 0xc1, 0x30);
...
DEFINE_GUID(GUID_PROCESSOR_RESPONSIVENESS_DISABLE_TIME_1, 0xf565999f, 0x3fb0,
            0x411a, 0xa2, 0x26, 0x3f, 0x1, 0x98, 0xde, 0xc1, 0x31);
...
DEFINE_GUID(GUID_PROCESSOR_RESPONSIVENESS_ENABLE_TIME, 0x3d915188, 0x7830,
            0x49ae, 0xa7, 0x9a, 0xf, 0xb0, 0xa1, 0xe5, 0xa2, 0x0);
...
DEFINE_GUID(GUID_PROCESSOR_RESPONSIVENESS_ENABLE_TIME_1, 0x3d915188, 0x7830,
            0x49ae, 0xa7, 0x9a, 0xf, 0xb0, 0xa1, 0xe5, 0xa2, 0x1);

//
// Specifies the ceiling placed on EPP when responsiveness hints are enabled.
//
// {4427C73B-9756-4a5c-B84B-C7BDA79C7320}
DEFINE_GUID(GUID_PROCESSOR_RESPONSIVENESS_EPP_CEILING, 0x4427c73b, 0x9756,
            0x4a5c, 0xb8, 0x4b, 0xc7, 0xbd, 0xa7, 0x9c, 0x73, 0x20);
...
DEFINE_GUID(GUID_PROCESSOR_RESPONSIVENESS_EPP_CEILING_1, 0x4427c73b, 0x9756,
            0x4a5c, 0xb8, 0x4b, 0xc7, 0xbd, 0xa7, 0x9c, 0x73, 0x21);
...
DEFINE_GUID(GUID_PROCESSOR_RESPONSIVENESS_PERF_FLOOR, 0xce8e92ee, 0x6a86,
            0x4572, 0xbf, 0xe0, 0x20, 0xc2, 0x1d, 0x3, 0xcd, 0x40);
...
DEFINE_GUID(GUID_PROCESSOR_RESPONSIVENESS_PERF_FLOOR_1, 0xce8e92ee, 0x6a86,
            0x4572, 0xbf, 0xe0, 0x20, 0xc2, 0x1d, 0x3, 0xcd, 0x41);
...
DEFINE_GUID(GUID_CONNECTIVITY_IN_STANDBY, 0xF15576E8, 0x98B7, 0x4186, 0xB9,
            0x44, 0xEA, 0xFA, 0x66, 0x44, 0x02, 0xD9);
...
DEFINE_GUID(GUID_DISCONNECTED_STANDBY_MODE, 0x68AFB2D9, 0xEE95, 0x47A8, 0x8F,
            0x50, 0x41, 0x15, 0x08, 0x80, 0x73, 0xB1);
...
DEFINE_GUID(GUID_LIDSWITCH_STATE_RELIABILITY, 0xAE4C4FF1, 0xD361, 0x43F4, 0x80,
            0xAA, 0xBB, 0xB6, 0xEB, 0x03, 0xDE, 0x94);
...
DEFINE_GUID(GUID_BATTERY_COUNT, 0x7d263f15, 0xfca4, 0x49e5, 0x85, 0x4b, 0xa9,
            0xf2, 0xbf, 0xbd, 0x5c, 0x24);
...
// display related to the given session is on/off/dim
//
...
DEFINE_GUID(GUID_INTSTEER_SUBGROUP, 0x48672f38, 0x7a9a, 0x4bb2, 0x8b, 0xf8,
            0x3d, 0x85, 0xbe, 0x19, 0xde, 0x4e);

// {2BFC24F9-5EA2-4801-8213-3DBAE01AA39D}
DEFINE_GUID(GUID_INTSTEER_MODE, 0x2bfc24f9, 0x5ea2, 0x4801, 0x82, 0x13, 0x3d,
            0xba, 0xe0, 0x1a, 0xa3, 0x9d);

// {73CDE64D-D720-4bb2-A860-C755AFE77EF2}
DEFINE_GUID(GUID_INTSTEER_LOAD_PER_PROC_TRIGGER, 0x73cde64d, 0xd720, 0x4bb2,
            0xa8, 0x60, 0xc7, 0x55, 0xaf, 0xe7, 0x7e, 0xf2);

// {D6BA4903-386F-4c2c-8ADB-5C21B3328D25}
DEFINE_GUID(GUID_INTSTEER_TIME_UNPARK_TRIGGER, 0xd6ba4903, 0x386f, 0x4c2c, 0x8a,
            0xdb, 0x5c, 0x21, 0xb3, 0x32, 0x8d, 0x25);
...
//
DEFINE_GUID(GUID_GRAPHICS_SUBGROUP, 0x5fb4938d, 0x1ee8, 0x4b0f, 0x9a, 0x3c,
            0x50, 0x36, 0xb0, 0xab, 0x99, 0x5c);

// Specifies the GPU preference policy.
//
// {DD848B2A-8A5D-4451-9AE2-39CD41658F6C}
//
DEFINE_GUID(GUID_GPU_PREFERENCE_POLICY, 0xdd848b2a, 0x8a5d, 0x4451, 0x9a, 0xe2,
            0x39, 0xcd, 0x41, 0x65, 0x8f, 0x6c);
...
DEFINE_GUID(GUID_MIXED_REALITY_MODE, 0x1e626b4e, 0xcf04, 0x4f8d, 0x9c, 0xc7,
            0xc9, 0x7c, 0x5b, 0xf, 0x23, 0x91);
...
DEFINE_GUID(GUID_SPR_ACTIVE_SESSION_CHANGE, 0xe24ce38, 0xc393, 0x4742, 0xbd,
            0xb1, 0x74, 0x4f, 0x4b, 0x9e, 0xe0, 0x8e);
...
typedef struct _POWER_SESSION_CONNECT {
  ...
  BOOLEAN
  Console; // TRUE - console, FALSE - TS (not used for Connected = FALSE)
...
typedef enum {
  ...
  MonitorRequestReasonSystemStateEntered, // When CS exit happens because system
                                          // transition to S4/S5, please note
                                          // this reason is different than
                                          // ReasonSxTransition.
...
#define POWER_ACTION_USER_NOTIFY                                               \
  0x00000010 // Indicate User-mode of an impending action.
...
#define POWER_USER_NOTIFY_SHUTDOWN                                             \
  0x00000010 // Application and Services are intimated of shutdown.
#define POWER_USER_NOTIFY_FORCED_SHUTDOWN                                      \
  0x00000020 // Immediate shutdown - Application and Services are not intimated.
...
//
// N.B. SYSTEM_POWER_SOURCE_STATE extends SYSTEM_BATTERY_STATE, with
// BatteryState
//      positioned at the beginning of the structure. This layout ensures that
//      unions or structures referencing SYSTEM_BATTERY_STATE will correctly
//      interpret BatteryState when accessing SYSTEM_POWER_SOURCE_STATE. The
//      assertion ensures that the BatteryState field has a zero offset,
//      confirming its position at the start of SYSTEM_POWER_SOURCE_STATE.
//
...
typedef struct _IMAGE_RELOCATION {
  union {
    DWORD VirtualAddress;
    DWORD RelocCount; // Set to the real count when IMAGE_SCN_LNK_NRELOC_OVFL is
                      // set
  } DUMMYUNIONNAME;
  DWORD SymbolTableIndex;
  WORD Type;
...
#define IMAGE_REL_ARM64_SECREL_LOW12A                                          \
  0x0009 // ADD/ADDS (immediate) with zero shift, for bit 0:11 of section offset
...
typedef struct _IMAGE_LINENUMBER {
  union {
    DWORD SymbolTableIndex; // Symbol table index of function name if Linenumber
                            // is 0.
...
typedef struct _IMAGE_IMPORT_CONTROL_TRANSFER_ARM64_RELOCATION {
  DWORD PageRelativeOffset : 10; // Offset to the call instruction shifted right
                                 // by 2 (4-byte aligned instruction)
  ...
  DWORD ImportType
      : 1; // 0 if this refers to a static import, 1 for delayload import
...
#define IMAGE_GUARD_CF_EXPORT_SUPPRESSION_INFO_PRESENT                         \
  0x00004000 // Module contains suppressed export information. This also infers
             // that the address taken taken IAT table is also present in the
             // load config.
...
typedef union IMAGE_ARM64_RUNTIME_FUNCTION_ENTRY_XDATA_EPILOG_SCOPE {
  ...
  struct {
    DWORD EpilogStartOffset
        : 18; // offset in bytes, divided by 4, of the epilog relative to the
              // start of the function.
    DWORD Res0 : 4;
    DWORD EpilogStartIndex
        : 10; // byte index of the first unwind code that describes this epilog.
  } DUMMYSTRUCTNAME;
...
NTSYSAPI
_Success_(return != 0) WORD NTAPI
    RtlCaptureStackBackTrace(_In_ DWORD FramesToSkip,
                             _In_ DWORD FramesToCapture,
                             _Out_writes_to_(FramesToCapture, return)
                                 PVOID *BackTrace,
...
NTSYSAPI
VOID NTAPI RtlCaptureContext2(_Inout_ PCONTEXT ContextRecord);
...
NTSYSAPI
VOID NTAPI RtlUnwind(_In_opt_ PVOID TargetFrame, _In_opt_ PVOID TargetIp,
                     _In_opt_ PEXCEPTION_RECORD ExceptionRecord,
...
NTSYSAPI
BOOLEAN
__cdecl RtlAddFunctionTable(_In_reads_(EntryCount)
                                PRUNTIME_FUNCTION FunctionTable,
                            _In_ DWORD EntryCount, _In_ DWORD64 BaseAddress);

NTSYSAPI
BOOLEAN
__cdecl RtlDeleteFunctionTable(_In_ PRUNTIME_FUNCTION FunctionTable);

NTSYSAPI
BOOLEAN
__cdecl RtlInstallFunctionTableCallback(
    _In_ DWORD64 TableIdentifier, _In_ DWORD64 BaseAddress, _In_ DWORD Length,
    _In_ PGET_RUNTIME_FUNCTION_CALLBACK Callback, _In_opt_ PVOID Context,
...
DWORD
NTAPI
RtlAddGrowableFunctionTable(_Out_ PVOID *DynamicTable,
                            _In_reads_(MaximumEntryCount)
                                PRUNTIME_FUNCTION FunctionTable,
                            _In_ DWORD EntryCount, _In_ DWORD MaximumEntryCount,
                            _In_ ULONG_PTR RangeBase, _In_ ULONG_PTR RangeEnd);

NTSYSAPI
VOID NTAPI RtlGrowFunctionTable(_Inout_ PVOID DynamicTable,
...
NTSYSAPI
VOID __cdecl
RtlRestoreContext(_In_ PCONTEXT ContextRecord,
                  _In_opt_ struct _EXCEPTION_RECORD *ExceptionRecord);

NTSYSAPI
VOID NTAPI RtlUnwindEx(_In_opt_ PVOID TargetFrame, _In_opt_ PVOID TargetIp,
                       _In_opt_ PEXCEPTION_RECORD ExceptionRecord,
                       _In_ PVOID ReturnValue, _In_ PCONTEXT ContextRecord,
...
PEXCEPTION_ROUTINE
NTAPI
RtlVirtualUnwind(_In_ DWORD HandlerType, _In_ DWORD64 ImageBase,
                 _In_ DWORD64 ControlPc, _In_ PRUNTIME_FUNCTION FunctionEntry,
                 _Inout_ PCONTEXT ContextRecord, _Out_ PVOID *HandlerData,
...
BOOLEAN
NTAPI
RtlIsEcCode(_In_ DWORD64 CodePointer);
...
__cdecl RtlAddFunctionTable(_In_reads_(EntryCount)
                                PRUNTIME_FUNCTION FunctionTable,
                            _In_ DWORD EntryCount, _In_ DWORD BaseAddress);
...
BOOLEAN
__cdecl RtlInstallFunctionTableCallback(
    _In_ DWORD TableIdentifier, _In_ DWORD BaseAddress, _In_ DWORD Length,
    _In_ PGET_RUNTIME_FUNCTION_CALLBACK Callback, _In_opt_ PVOID Context,
    _In_opt_ PCWSTR OutOfProcessCallbackDll);
...
PRUNTIME_FUNCTION
NTAPI
RtlLookupFunctionEntry(_In_ ULONG_PTR ControlPc, _Out_ PDWORD ImageBase,
                       _Inout_opt_ PUNWIND_HISTORY_TABLE HistoryTable);
...
PEXCEPTION_ROUTINE
NTAPI
RtlVirtualUnwind(_In_ DWORD HandlerType, _In_ DWORD ImageBase,
                 _In_ DWORD ControlPc, _In_ PRUNTIME_FUNCTION FunctionEntry,
                 _Inout_ PCONTEXT ContextRecord, _Out_ PVOID *HandlerData,
...
__cdecl RtlAddFunctionTable(_In_reads_(EntryCount)
                                PRUNTIME_FUNCTION FunctionTable,
                            _In_ DWORD EntryCount, _In_ ULONG_PTR BaseAddress);
...
BOOLEAN
__cdecl RtlInstallFunctionTableCallback(
    _In_ ULONG_PTR TableIdentifier, _In_ ULONG_PTR BaseAddress,
    _In_ DWORD Length, _In_ PGET_RUNTIME_FUNCTION_CALLBACK Callback,
    _In_opt_ PVOID Context, _In_opt_ PCWSTR OutOfProcessCallbackDll);
...
PRUNTIME_FUNCTION
NTAPI
RtlLookupFunctionEntry(_In_ ULONG_PTR ControlPc, _Out_ PULONG_PTR ImageBase,
                       _Inout_opt_ PUNWIND_HISTORY_TABLE HistoryTable);
...
PEXCEPTION_ROUTINE
NTAPI
RtlVirtualUnwind(_In_ DWORD HandlerType, _In_ ULONG_PTR ImageBase,
                 _In_ ULONG_PTR ControlPc, _In_ PRUNTIME_FUNCTION FunctionEntry,
                 _Inout_ PCONTEXT ContextRecord, _Out_ PVOID *HandlerData,
...
NTAPI
RtlLookupFunctionEntryCHPE(_In_ ULONG_PTR ControlPc, _Out_ PULONG_PTR ImageBase,
...
NTSYSAPI
VOID NTAPI RtlInitializeSListHead(_Out_ PSLIST_HEADER ListHead);

_Must_inspect_result_ NTSYSAPI PSLIST_ENTRY NTAPI
RtlFirstEntrySList(_In_ const SLIST_HEADER *ListHead);

NTSYSAPI
PSLIST_ENTRY
NTAPI
RtlInterlockedPopEntrySList(_Inout_ PSLIST_HEADER ListHead);

NTSYSAPI
PSLIST_ENTRY
NTAPI
RtlInterlockedPushEntrySList(_Inout_ PSLIST_HEADER ListHead,
                             _Inout_ __drv_aliasesMem PSLIST_ENTRY ListEntry);

NTSYSAPI
PSLIST_ENTRY
NTAPI
RtlInterlockedPushListSListEx(_Inout_ PSLIST_HEADER ListHead,
                              _Inout_ __drv_aliasesMem PSLIST_ENTRY List,
                              _Inout_ PSLIST_ENTRY ListEnd, _In_ DWORD Count);

NTSYSAPI
PSLIST_ENTRY
NTAPI
RtlInterlockedFlushSList(_Inout_ PSLIST_HEADER ListHead);

NTSYSAPI
WORD NTAPI RtlQueryDepthSList(_In_ PSLIST_HEADER ListHead);
...
// Include the more obscure SAL annotations (like __drv_aliasesMem) instead of
// assuming the crtdefs.h will include them.
#include <specstrings.h>
...
//       It is reserved for compatibility with previous handling of the
...
// - !analyze (onecore\sdktools\debuggers\exts\badev\extdll\uacommon.h &
// uexcep.cpp)
...
DECLSPEC_NORETURN
VOID __fastfail(_In_ unsigned int Code);
...
FORCEINLINE
DWORD
HEAP_MAKE_TAG_FLAGS(_In_ DWORD TagBase, _In_ DWORD Tag)
...
#if defined(_DBG_MEMCPY_INLINE_) && !defined(MIDL_PASS) &&                     \
    !defined(_MEMCPY_INLINE_) && !defined(_CRTBLD)
#define _MEMCPY_INLINE_
FORCEINLINE
PVOID
__cdecl memcpy_inline(_Out_writes_bytes_all_(size) void *dst,
...
RtlCopyDeviceMemory(_Out_writes_bytes_all_(Length) volatile void *Destination,
                    _In_reads_bytes_(Length) volatile const void *Source,
                    _In_ size_t Length);

volatile void *__cdecl
RtlCopyVolatileMemory(_Out_writes_bytes_all_(Length) volatile void *Destination,
                      _In_reads_bytes_(Length) volatile const void *Source,
                      _In_ size_t Length);

volatile void *__cdecl
RtlMoveVolatileMemory(_Out_writes_bytes_all_(Length) volatile void *Destination,
                      _In_reads_bytes_(Length) volatile const void *Source,
                      _In_ size_t Length);

volatile void *__cdecl
RtlSetVolatileMemory(_Out_writes_bytes_all_(Length) volatile void *Destination,
                     _In_ int Fill, _In_ size_t Length);

FORCEINLINE
volatile void *
RtlFillVolatileMemory(_Out_writes_bytes_all_(Length) volatile void *Destination,
                      _In_ size_t Length, _In_ int Fill) {
  return RtlSetVolatileMemory(Destination, Fill, Length);
}

FORCEINLINE
volatile void *
RtlZeroVolatileMemory(_Out_writes_bytes_all_(Length) volatile void *Destination,
                      _In_ size_t Length) {
...
FORCEINLINE
volatile void *
RtlSecureZeroMemory2(_Out_writes_bytes_all_(Length) volatile void *Destination,
                     _In_ size_t Length) {
...
volatile void *
RtlFillDeviceMemory(_Out_writes_bytes_all_(Length) volatile void *Destination,
                    _In_ size_t Length, _In_ int Fill);

#define RtlEqualDeviceMemory(Source1, Source2, Length)                         \
  (!_memcmp_strict_align((Source1), (Source2), (Length)))

SIZE_T
NTAPI
RtlCompareDeviceMemory(_In_reads_bytes_(Length) const VOID *Source1,
...
FORCEINLINE
volatile void *
RtlZeroDeviceMemory(_Out_writes_bytes_all_(Length) volatile void *Destination,
                    _In_ size_t Length) {
...
_Check_return_ FORCEINLINE int RtlConstantTimeEqualMemory(_In_reads_bytes_(len)
                                                              const void *v1,
  ...
  for (; i < len; i += 1) {
    ...
    // Faster is better even when constant time is required.  Optimize
    // performance by avoiding memory barrier generation for ARM.  The
    // parameters to this function are NOT volatile, so the caller must not
    // expect the generation of non-ISO volatile memory barriers regardless of
    // the compiler flags used. Instead, if the caller shares this memory with
    // other threads, it is responsible for synchronizing access with the
    // associated acquire barrier.
...
FORCEINLINE
PVOID
RtlSecureZeroMemory(_Out_writes_bytes_all_(cnt) PVOID ptr, _In_ SIZE_T cnt) {
...
ULONGLONG
NTAPI
VerSetConditionMask(_In_ ULONGLONG ConditionMask, _In_ DWORD TypeMask,
                    _In_ BYTE Condition);
...
BOOLEAN
NTAPI
RtlGetProductInfo(_In_ DWORD OSMajorVersion, _In_ DWORD OSMinorVersion,
                  _In_ DWORD SpMajorVersion, _In_ DWORD SpMinorVersion,
...
typedef _Function_class_(RTL_UMS_SCHEDULER_ENTRY_POINT) VOID NTAPI
    RTL_UMS_SCHEDULER_ENTRY_POINT(_In_ RTL_UMS_SCHEDULER_REASON Reason,
...
//
// Do not ignore kernel breaks when kernel debugging is disabled (debug builds
// only)
//
...
DWORD
NTAPI
RtlCrc32(_In_reads_bytes_(Size) const void *Buffer, _In_ size_t Size,
         _In_ DWORD InitialCrc);

NTSYSAPI
ULONGLONG
NTAPI
RtlCrc64(_In_reads_bytes_(Size) const void *Buffer, _In_ size_t Size,
...
OS_DEPLOYEMENT_STATE_VALUES
NTAPI
RtlOsDeploymentState(_In_ DWORD Flags /* No flags currently defined, passed 0 */
);
...
#define WRITE_NV_MEMORY_FLAG_PERSIST                                           \
...
#define FILL_NV_MEMORY_FLAG_PERSIST                                            \
  (FILL_NV_MEMORY_FLAG_FLUSH | FILL_NV_MEMORY_FLAG_NON_TEMPORAL)
#define FILL_NV_MEMORY_FLAG_NO_DRAIN (0x00000100)

#if defined(_WIN64)

_IRQL_requires_max_(APC_LEVEL) NTSYSAPI DWORD NTAPI
    RtlGetNonVolatileToken(_In_reads_bytes_(Size) PVOID NvBuffer,
                           _In_ SIZE_T Size, _Outptr_ PVOID *NvToken);

_IRQL_requires_max_(DPC_LEVEL) NTSYSAPI DWORD NTAPI
    RtlFreeNonVolatileToken(_In_ PVOID NvToken);

_IRQL_requires_max_(DPC_LEVEL) NTSYSAPI DWORD NTAPI
    RtlFlushNonVolatileMemory(_In_ PVOID NvToken,
                              _In_reads_bytes_(Size) PVOID NvBuffer,
                              _In_ SIZE_T Size, _In_ DWORD Flags);

_IRQL_requires_max_(DPC_LEVEL) NTSYSAPI DWORD NTAPI
    RtlDrainNonVolatileFlush(_In_ PVOID NvToken);

_IRQL_requires_max_(DPC_LEVEL) NTSYSAPI DWORD NTAPI RtlWriteNonVolatileMemory(
    _In_ PVOID NvToken, _Out_writes_bytes_(Size) VOID UNALIGNED *NvDestination,
    _In_reads_bytes_(Size) CONST VOID UNALIGNED *Source, _In_ SIZE_T Size,
    _In_ DWORD Flags);

#if (NTDDI_VERSION >= NTDDI_WIN10_19H1)

_IRQL_requires_max_(DPC_LEVEL) NTSYSAPI DWORD NTAPI RtlFillNonVolatileMemory(
    _In_ PVOID NvToken, _Out_writes_bytes_(Size) VOID UNALIGNED *NvDestination,
    _In_ SIZE_T Size, _In_ CONST BYTE Value, _In_ DWORD Flags);

#endif // (NTDDI_VERSION >= NTDDI_WIN10_19H1)

_IRQL_requires_max_(DPC_LEVEL) NTSYSAPI DWORD NTAPI
    RtlFlushNonVolatileMemoryRanges(_In_ PVOID NvToken,
                                    _In_reads_(NumRanges)
                                        PNV_MEMORY_RANGE NvRanges,
                                    _In_ SIZE_T NumRanges, _In_ DWORD Flags);
...
#define TraceLoggingCORRELATION_VECTOR(cv)                                     \
  TraceLoggingString((cv).Vector, "__TlgCV__")

NTSYSAPI
DWORD
NTAPI
RtlInitializeCorrelationVector(_Out_ PCORRELATION_VECTOR CorrelationVector,
                               _In_ int Version, _In_opt_ const GUID *Guid);
...
#if !defined(MIDL_PASS)
FORCEINLINE
VOID CUSTOM_SYSTEM_EVENT_TRIGGER_INIT(_Out_ PCUSTOM_SYSTEM_EVENT_TRIGGER_CONFIG
                                          Config,
...
_Must_inspect_result_ _IRQL_requires_max_(PASSIVE_LEVEL) DWORD NTAPI
...
#define IMAGE_POLICY_START(_ApplicationId_)                                    \
  ...
  const IMAGE_POLICY_METADATA IMAGE_POLICY_METADATA_NAME = {                   \
      IMAGE_POLICY_METADATA_VERSION, {0}, _ApplicationId_, {
...
BOOLEAN
NTAPI
RtlIsZeroMemory(_In_ PVOID Buffer, _In_ SIZE_T Length);

__drv_maxIRQL(APC_LEVEL) NTSYSAPI BOOLEAN NTAPI RtlNormalizeSecurityDescriptor(
    _Inout_ PSECURITY_DESCRIPTOR *SecurityDescriptor,
    _In_ DWORD SecurityDescriptorLength,
    _Out_opt_ PSECURITY_DESCRIPTOR *NewSecurityDescriptor,
    _Out_opt_ PDWORD NewSecurityDescriptorLength, _In_ BOOLEAN CheckOnly);
...
DWORD
NTAPI
RtlGetSystemGlobalData(_In_ RTL_SYSTEM_GLOBAL_DATA_ID DataId,
                       _Inout_ PVOID Buffer, _In_ DWORD Size);

NTSYSAPI
DWORD
NTAPI
RtlSetSystemGlobalData(_In_ RTL_SYSTEM_GLOBAL_DATA_ID DataId, _In_ PVOID Buffer,
                       _In_ DWORD Size);
...
//
// These flags define possible values stored in the Flags field of a critsec
// debuginfo.
//
...
typedef BOOLEAN(NTAPI *PSECURE_MEMORY_CACHE_CALLBACK)(_In_reads_bytes_(Range)
                                                          PVOID Addr,
                                                      _In_ SIZE_T Range);
...
VOID NTAPI RtlGetDeviceFamilyInfoEnum(_Out_opt_ ULONGLONG *pullUAPInfo,
...
DWORD
NTAPI
RtlSwitchedVVI(_In_ PRTL_OSVERSIONINFOEXW VersionInfo, _In_ DWORD TypeMask,
...
// data and pad bytes.
//
// TimeGenerated and TimeWritten are the time the event was put into the log at
// the server end.
//
...
struct
    ...
    __declspec(deprecated("struct EVENTSFORLOGFILE is deprecated and might not "
                          "work on all platforms. For more info, see MSDN."))
#endif
    _EVENTSFORLOGFILE {
  DWORD ulSize;
  WCHAR szLogicalLogFile
      [MAXLOGICALLOGNAMESIZE]; // name of the logical
                               // file-security/application/system
  DWORD ulNumRecords;
...
struct
#if (_MSC_VER > 1310) && !defined(MIDL_PASS)
    __declspec(deprecated("struct PACKEDEVENTINFO is deprecated and might not "
                          "work on all platforms. For more info, see MSDN."))
#endif
    _PACKEDEVENTINFO {
  DWORD ulSize; // total size of the structure
  DWORD
  ulNumEventsForLogFile; // number of EventsForLogFile structure that follow
  DWORD ulOffsets[];     // the offsets from the start of this structure to the
...
#define REG_OPTION_DONT_VIRTUALIZE                                             \
  (0x00000010L) // Disable Open/Read/Write
...
#define REG_FORCE_RESTORE                                                      \
  (0x00000008L) // Force the restore process even when we have open handles on
                // subkeys
#define REG_APP_HIVE                                                           \
  (0x00000010L) // Loads the hive visible to the calling process
#define REG_PROCESS_PRIVATE                                                    \
  (0x00000020L) // Hive cannot be mounted by any other process while in use
#define REG_START_JOURNAL (0x00000040L) // Starts Hive Journal
#define REG_HIVE_EXACT_FILE_GROWTH                                             \
  (0x00000080L) // Grow hive file in exact 4k increments
#define REG_HIVE_NO_RM                                                         \
  (0x00000100L) // No RM is started for this hive (no transactions)
#define REG_HIVE_SINGLE_LOG                                                    \
  (0x00000200L) // Legacy single logging is used for this hive
#define REG_BOOT_HIVE (0x00000400L) // This hive might be used by the OS loader
#define REG_LOAD_HIVE_OPEN_HANDLE                                              \
  (0x00000800L) // Load the hive and return a handle to its root kcb
#define REG_FLUSH_HIVE_FILE_GROWTH                                             \
  (0x00001000L) // Flush changes to primary hive file size as part of all
                // flushes
#define REG_OPEN_READ_ONLY                                                     \
  (0x00002000L) // Open a hive's files in read-only mode
#define REG_IMMUTABLE                                                          \
  (0x00004000L) // Load the hive, but don't allow any modification of it
#define REG_NO_IMPERSONATION_FALLBACK                                          \
  (0x00008000L) // Do not fall back to impersonating the caller if hive file
                // access fails
#define REG_APP_HIVE_OPEN_READ_ONLY                                            \
  (REG_OPEN_READ_ONLY) // Open an app hive's files in read-only mode (if the
                       // hive was not previously loaded)
...
#define REG_NOTIFY_THREAD_AGNOSTIC                                             \
  (0x10000000L) // Not associated with a calling thread, can only be used
...
#define SERVICE_USER_SHARE_PROCESS                                             \
  (SERVICE_USER_SERVICE | SERVICE_WIN32_SHARE_PROCESS)
#define SERVICE_USER_OWN_PROCESS                                               \
  (SERVICE_USER_SERVICE | SERVICE_WIN32_OWN_PROCESS)
...
#define SERVICE_TYPE_ALL                                                       \
  (SERVICE_WIN32 | SERVICE_ADAPTER | SERVICE_DRIVER |                          \
   ...
   SERVICE_USERSERVICE_INSTANCE | SERVICE_PKG_SERVICE)
...
typedef VOID NTAPI TP_SIMPLE_CALLBACK(_Inout_ PTP_CALLBACK_INSTANCE Instance,
...
typedef VOID NTAPI TP_CLEANUP_GROUP_CANCEL_CALLBACK(
    _Inout_opt_ PVOID ObjectContext, _Inout_opt_ PVOID CleanupContext);
...
FORCEINLINE
VOID TpSetCallbackThreadpool(_Inout_ PTP_CALLBACK_ENVIRON CallbackEnviron,
                             _In_ PTP_POOL Pool) {
  CallbackEnviron->Pool = Pool;
}

FORCEINLINE
VOID TpSetCallbackCleanupGroup(_Inout_ PTP_CALLBACK_ENVIRON CallbackEnviron,
                               _In_ PTP_CLEANUP_GROUP CleanupGroup,
                               _In_opt_ PTP_CLEANUP_GROUP_CANCEL_CALLBACK
...
VOID TpSetCallbackNoActivationContext(
  ...
  CallbackEnviron->ActivationContext =
      (struct _ACTIVATION_CONTEXT *)(LONG_PTR)-1; // INVALID_ACTIVATION_CONTEXT
}
...
FORCEINLINE
VOID TpSetCallbackRaceWithDll(_Inout_ PTP_CALLBACK_ENVIRON CallbackEnviron,
...
FORCEINLINE
VOID TpSetCallbackPriority(_Inout_ PTP_CALLBACK_ENVIRON CallbackEnviron,
...
typedef VOID NTAPI TP_WORK_CALLBACK(_Inout_ PTP_CALLBACK_INSTANCE Instance,
                                    _Inout_opt_ PVOID Context,
...
typedef VOID NTAPI TP_TIMER_CALLBACK(_Inout_ PTP_CALLBACK_INSTANCE Instance,
                                     _Inout_opt_ PVOID Context,
...
typedef VOID NTAPI TP_WAIT_CALLBACK(_Inout_ PTP_CALLBACK_INSTANCE Instance,
                                    _Inout_opt_ PVOID Context,
...
__forceinline unsigned char NtReadCurrentTebByte(unsigned int Offset) {
  return *((const volatile unsigned char *)__NtCurrentTebAddr(Offset));
}

__forceinline unsigned short NtReadCurrentTebUshort(unsigned int Offset) {
  return *((const volatile unsigned short *)__NtCurrentTebAddr(Offset));
}

__forceinline unsigned int NtReadCurrentTebUlong(unsigned int Offset) {
  return *((const volatile unsigned int *)__NtCurrentTebAddr(Offset));
}

__forceinline unsigned __int64 NtReadCurrentTebUlongPtr(unsigned int Offset) {
  return *((const volatile unsigned __int64 *)__NtCurrentTebAddr(Offset));
}

__forceinline void *NtReadCurrentTebPVOID(unsigned int Offset) {
  return (void *)NtReadCurrentTebUlongPtr(Offset);
}

__inline unsigned __int64 NtReadCurrentTebUlonglong(unsigned int Offset) {
  return *((const volatile unsigned __int64 *)__NtCurrentTebAddr(Offset));
}
...
__forceinline unsigned __int64 NtReadCurrentTebUlonglong(unsigned int Offset) {
  return __readgsqword(Offset);
}
...
#define NtReadCurrentTebByte(Offset)                                           \
  ((unsigned char)__iso_volatile_load8(                                        \
      (const volatile __int8 *)__NtCurrentTebAddr(Offset)))

#define NtReadCurrentTebUshort(Offset)                                         \
  ((unsigned short)__iso_volatile_load16(                                      \
      (const volatile __int16 *)__NtCurrentTebAddr(Offset)))

#define NtReadCurrentTebUlong(Offset)                                          \
  ((unsigned int)__iso_volatile_load32(                                        \
      (const volatile __int32 *)__NtCurrentTebAddr(Offset)))

#define NtReadCurrentTebUlongPtr(Offset)                                       \
  ((unsigned __int64)__iso_volatile_load64(                                    \
      (const volatile __int64 *)__NtCurrentTebAddr(Offset)))

#define NtReadCurrentTebPVOID(Offset)                                          \
  ((void *)__iso_volatile_load64(                                              \
      (const volatile __int64 *)__NtCurrentTebAddr(Offset)))
...
__inline unsigned char NtReadCurrentTebByte(unsigned int Offset) {
  return *((const volatile unsigned char *)__NtCurrentTebAddr(Offset));
}

__inline unsigned short NtReadCurrentTebUshort(unsigned int Offset) {
  return *((const volatile unsigned short *)__NtCurrentTebAddr(Offset));
}

__inline unsigned int NtReadCurrentTebUlong(unsigned int Offset) {
  return *((const volatile unsigned int *)__NtCurrentTebAddr(Offset));
}

__inline unsigned int NtReadCurrentTebUlongPtr(unsigned int Offset) {
  return NtReadCurrentTebUlong(Offset);
}

__inline void *NtReadCurrentTebPVOID(unsigned int Offset) {
  return (void *)NtReadCurrentTebUlongPtr(Offset);
}
...
__inline void *NtReadCurrentTebPVOID(unsigned int Offset) {
  return (void *)__readfsdword(Offset);
    ...
    ISOLATION_AWARE_ENABLED // winnt_only
