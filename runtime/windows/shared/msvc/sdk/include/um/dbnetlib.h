...
typedef enum { NLOPT_SET_ENCRYPT, NLOPT_SET_PACKET_SIZE } OPT_REQUEST;
...
IOINT ConnectionTransact(void *, BYTE *, BYTE *, IOINT, IOINT, IOINT, TIMEINT,
                         NETERR UNALIGNED *);
...
BOOL GenClientContext(DWORD dwKey, BYTE *pIn, DWORD cbIn, BYTE *pOut,
                      DWORD *pcbOut, BOOL *pfDone, CHAR *szUserName);
