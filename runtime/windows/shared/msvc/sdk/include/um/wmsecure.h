...
EXTERN_GUID(IID_IWMAuthorizer, 0xd9b67d36, 0xa9ad, 0x4eb4, 0xba, 0xef, 0xdb,
            0x28, 0x4e, 0xf5, 0x50, 0x4c);
EXTERN_GUID(IID_IWMSecureChannel, 0x2720598a, 0xd0f2, 0x4189, 0xbd, 0x10, 0x91,
            0xc4, 0x6e, 0xf0, 0x93, 0x6f);
EXTERN_GUID(IID_IWMGetSecureChannel, 0x94bc0598, 0xc3d2, 0x11d3, 0xbe, 0xdf,
...
typedef struct IWMAuthorizerVtbl {
  ...
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(IWMAuthorizer *This,
                                             /* [in] */ REFIID riid,
  ...
  HRESULT(STDMETHODCALLTYPE *GetCertCount)(IWMAuthorizer *This,
                                           /* [out] */ DWORD *pcCerts);

  DECLSPEC_XFGVIRT(IWMAuthorizer, GetCert)
  HRESULT(STDMETHODCALLTYPE *GetCert)(IWMAuthorizer *This,
                                      /* [in] */ DWORD dwIndex,
                                      /* [out] */ BYTE **ppbCertData);

  DECLSPEC_XFGVIRT(IWMAuthorizer, GetSharedData)
  HRESULT(STDMETHODCALLTYPE *GetSharedData)(IWMAuthorizer *This,
                                            /* [in] */ DWORD dwCertIndex,
                                            /* [in] */ const BYTE *pbSharedData,
                                            /* [in] */ BYTE *pbCert,
...
interface IWMAuthorizer { CONST_VTBL struct IWMAuthorizerVtbl *lpVtbl; };
...
#define IWMAuthorizer_GetSharedData(This, dwCertIndex, pbSharedData, pbCert,   \
                                    ppbSharedData)                             \
  ((This)->lpVtbl->GetSharedData(This, dwCertIndex, pbSharedData, pbCert,      \
                                 ppbSharedData))
...
typedef struct IWMSecureChannelVtbl {
  ...
  DECLSPEC_XFGVIRT(IWMAuthorizer, GetCert)
  HRESULT(STDMETHODCALLTYPE *GetCert)(IWMSecureChannel *This,
                                      /* [in] */ DWORD dwIndex,
                                      /* [out] */ BYTE **ppbCertData);

  DECLSPEC_XFGVIRT(IWMAuthorizer, GetSharedData)
  HRESULT(STDMETHODCALLTYPE *GetSharedData)(IWMSecureChannel *This,
                                            /* [in] */ DWORD dwCertIndex,
                                            /* [in] */ const BYTE *pbSharedData,
                                            /* [in] */ BYTE *pbCert,
                                            /* [out] */ BYTE **ppbSharedData);
  ...
  HRESULT(STDMETHODCALLTYPE *WMSC_Encrypt)(IWMSecureChannel *This,
                                           /* [in] */ BYTE *pbData,
                                           /* [in] */ DWORD cbData);

  DECLSPEC_XFGVIRT(IWMSecureChannel, WMSC_Decrypt)
  HRESULT(STDMETHODCALLTYPE *WMSC_Decrypt)(IWMSecureChannel *This,
                                           /* [in] */ BYTE *pbData,
                                           /* [in] */ DWORD cbData);
...
interface IWMSecureChannel { CONST_VTBL struct IWMSecureChannelVtbl *lpVtbl; };
...
#define IWMSecureChannel_GetSharedData(This, dwCertIndex, pbSharedData,        \
                                       pbCert, ppbSharedData)                  \
  ((This)->lpVtbl->GetSharedData(This, dwCertIndex, pbSharedData, pbCert,      \
                                 ppbSharedData))
...
#define IWMSecureChannel_WMSC_GetValidCertificate(This, ppbCertificate,        \
                                                  pdwSignature)                \
...
WMCreateSecureChannel_Certified(IWMSecureChannel **ppChannel);
HRESULT STDMETHODCALLTYPE
WMCreateSecureChannel_DES(IWMSecureChannel **ppChannel);
HRESULT STDMETHODCALLTYPE
WMCreateSecureChannel_Certified_DES(IWMSecureChannel **ppChannel);
