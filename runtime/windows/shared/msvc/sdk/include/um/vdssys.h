...
DWORD __stdcall OpenVirtualDisk(PVIRTUAL_STORAGE_TYPE VirtualStorageType,
                                PCWSTR Path,
...
DWORD __stdcall
CreateVirtualDisk(PVIRTUAL_STORAGE_TYPE VirtualStorageType, PCWSTR Path,
                  VIRTUAL_DISK_ACCESS_MASK VirtualDiskAccessMask,
...
DWORD __stdcall AttachVirtualDisk(HANDLE VirtualDiskHandle,
                                  PSECURITY_DESCRIPTOR SecurityDescriptor,
...
DWORD __stdcall DetachVirtualDisk(HANDLE VirtualDiskHandle,
                                  DETACH_VIRTUAL_DISK_FLAG Flags,
                                  ULONG ProviderSpecificFlags);

DWORD __stdcall GetVirtualDiskPhysicalPath(HANDLE VirtualDiskHandle,
                                           PULONG DiskPathSizeInBytes,
                                           PWSTR DiskPath);

DWORD __stdcall
GetAllAttachedVirtualDiskPhysicalPaths(PULONG PathsBufferSizeInBytes,
                                       PWSTR PathsBuffer);
...
DWORD __stdcall
GetVirtualDiskInformation(HANDLE VirtualDiskHandle, PULONG VirtualDiskInfoSize,
...
DWORD __stdcall
SetVirtualDiskInformation(HANDLE VirtualDiskHandle,
                          PSET_VIRTUAL_DISK_INFO VirtualDiskInfo);

DWORD __stdcall EnumerateVirtualDiskMetadata(HANDLE VirtualDiskHandle,
                                             PULONG NumberOfItems, GUID *Items);

DWORD __stdcall GetVirtualDiskMetadata(HANDLE VirtualDiskHandle,
                                       const GUID *Item, PULONG MetaDataSize,
                                       PVOID MetaData);

DWORD __stdcall SetVirtualDiskMetadata(HANDLE VirtualDiskHandle,
                                       const GUID *Item, ULONG MetaDataSize,
                                       const void *MetaData);

DWORD __stdcall DeleteVirtualDiskMetadata(HANDLE VirtualDiskHandle,
                                          const GUID *Item);
...
DWORD __stdcall
GetVirtualDiskOperationProgress(HANDLE VirtualDiskHandle,
                                LPOVERLAPPED Overlapped,
...
DWORD __stdcall CompactVirtualDisk(HANDLE VirtualDiskHandle,
...
DWORD __stdcall MergeVirtualDisk(HANDLE VirtualDiskHandle,
...
DWORD __stdcall ExpandVirtualDisk(HANDLE VirtualDiskHandle,
...
DWORD __stdcall ResizeVirtualDisk(HANDLE VirtualDiskHandle,
...
DWORD __stdcall MirrorVirtualDisk(HANDLE VirtualDiskHandle,
                                  MIRROR_VIRTUAL_DISK_FLAG Flags,
                                  PMIRROR_VIRTUAL_DISK_PARAMETERS Parameters,
                                  LPOVERLAPPED Overlapped);

DWORD __stdcall BreakMirrorVirtualDisk(HANDLE VirtualDiskHandle);

DWORD __stdcall AddVirtualDiskParent(HANDLE VirtualDiskHandle,
                                     PCWSTR ParentPath);
...
DWORD __stdcall
QueryChangesVirtualDisk(HANDLE VirtualDiskHandle, PCWSTR ChangeTrackingId,
                        ULONG64 ByteOffset, ULONG64 ByteLength,
                        QUERY_CHANGES_VIRTUAL_DISK_FLAG Flags,
                        PQUERY_CHANGES_VIRTUAL_DISK_RANGE Ranges,
                        PULONG RangeCount, PULONG64 ProcessedLength);

DWORD __stdcall
TakeSnapshotVhdSet(HANDLE VirtualDiskHandle,
...
DWORD __stdcall ModifyVhdSet(HANDLE VirtualDiskHandle,
...
DWORD __stdcall
RawSCSIVirtualDisk(HANDLE VirtualDiskHandle,
...
DWORD __stdcall ForkVirtualDisk(HANDLE VirtualDiskHandle,
                                FORK_VIRTUAL_DISK_FLAG Flags,
                                const FORK_VIRTUAL_DISK_PARAMETERS *Parameters,
                                LPOVERLAPPED Overlapped);

DWORD __stdcall CompleteForkVirtualDisk(HANDLE VirtualDiskHandle);
