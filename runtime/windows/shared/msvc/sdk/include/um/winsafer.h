...
BOOL WINAPI SaferGetPolicyInformation(
    _In_ DWORD dwScopeId, _In_ SAFER_POLICY_INFO_CLASS SaferPolicyInfoClass,
    _In_ DWORD InfoBufferSize,
    _Out_writes_bytes_(InfoBufferSize) PVOID InfoBuffer,
    _Out_ PDWORD InfoBufferRetSize, _Reserved_ LPVOID lpReserved);
...
WINADVAPI
BOOL WINAPI SaferCreateLevel(_In_ DWORD dwScopeId, _In_ DWORD dwLevelId,
...
WINADVAPI
BOOL WINAPI SaferIdentifyLevel(_In_ DWORD dwNumProperties,
                               _In_reads_opt_(dwNumProperties)
                                   PSAFER_CODE_PROPERTIES pCodeProperties,
                               _Outptr_ SAFER_LEVEL_HANDLE *pLevelHandle,
                               _In_opt_ LPVOID lpReserved);

WINADVAPI
BOOL WINAPI SaferComputeTokenFromLevel(_In_ SAFER_LEVEL_HANDLE LevelHandle,
...
WINADVAPI
BOOL WINAPI SaferGetLevelInformation(_In_ SAFER_LEVEL_HANDLE LevelHandle,
                                     _In_ SAFER_OBJECT_INFO_CLASS dwInfoType,
                                     _Out_writes_bytes_opt_(dwInBufferSize)
                                         LPVOID lpQueryBuffer,
                                     _In_ DWORD dwInBufferSize,
                                     _Out_ LPDWORD lpdwOutBufferSize);

WINADVAPI
BOOL WINAPI SaferSetLevelInformation(_In_ SAFER_LEVEL_HANDLE LevelHandle,
                                     _In_ SAFER_OBJECT_INFO_CLASS dwInfoType,
                                     _In_reads_bytes_(dwInBufferSize)
                                         LPVOID lpQueryBuffer,
                                     _In_ DWORD dwInBufferSize);
...
WINADVAPI
BOOL WINAPI SaferRecordEventLogEntry(_In_ SAFER_LEVEL_HANDLE hLevel,
                                     _In_ LPCWSTR szTargetPath,
                                     _Reserved_ LPVOID lpReserved);

WINADVAPI
BOOL WINAPI SaferiIsExecutableFileType(_In_ LPCWSTR szFullPathname,
