...
#define BEGIN_NESTED_SYSTEM_CHANGE                                             \
  102 // for Whistler only - use this to prevent nested restore pts
#define END_NESTED_SYSTEM_CHANGE                                               \
  103 // for Whistler only - use this to prevent nested restore pts
...
//
// ERROR_INVALID_DATA         If the cancel restore point is called with an
// invalid
//                            sequence number
//
...
//
// ERROR_DISK_FULL            If System Restore is frozen (Windows Whistler
// only)
//
...
BOOL __stdcall SRSetRestorePointW(_In_ PRESTOREPOINTINFOW pRestorePtSpec,
                                  _Out_ PSTATEMGRSTATUS pSMgrStatus);

BOOL __stdcall SRSetRestorePointInternal(_In_ PRESTOREPOINTINFOW pRestorePtSpec,
                                         _Out_ PSTATEMGRSTATUS pSMgrStatus,
