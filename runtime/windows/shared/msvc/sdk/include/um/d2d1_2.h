...
/// stroked geometry.
/// </summary>
interface DX_DECLARE_INTERFACE("a16907d7-bc02-4801-99e8-8cf7f485f774")
    ID2D1GeometryRealization
    : public ID2D1Resource{}; // interface ID2D1GeometryRealization

/// <summary>
/// Enables creation and drawing of geometry realization objects.
/// </summary>
interface DX_DECLARE_INTERFACE("d37f57e4-6908-459f-a199-e72f24f79987")
    ID2D1DeviceContext1 : public ID2D1DeviceContext {

  STDMETHOD(CreateFilledGeometryRealization)(
      _In_ ID2D1Geometry * geometry, FLOAT flatteningTolerance,
      _COM_Outptr_ ID2D1GeometryRealization * *geometryRealization) PURE;
  ...
  STDMETHOD_(void, DrawGeometryRealization)(_In_ ID2D1GeometryRealization *
                                                geometryRealization,
...
/// together.
/// </summary>
interface DX_DECLARE_INTERFACE("d21768e1-23a4-4823-a14b-7c3eba85d658")
  ...
  STDMETHOD_(void, SetRenderingPriority)(
      D2D1_RENDERING_PRIORITY renderingPriority) PURE;

  /// <summary>
  /// Creates a new device context with no initially assigned target.
  /// </summary>
  STDMETHOD(CreateDeviceContext)(D2D1_DEVICE_CONTEXT_OPTIONS options,
                                 _COM_Outptr_ ID2D1DeviceContext1 *
                                     *deviceContext1) PURE;
...
/// </summary>
interface DX_DECLARE_INTERFACE("94f81a73-9212-4376-9c58-b16a3a0d3992")
  ...
  STDMETHOD(CreateDevice)(_In_ IDXGIDevice * dxgiDevice,
                          _COM_Outptr_ ID2D1Device1 * *d2dDevice1) PURE;
...
/// ID2D1CommandSink interface. It also enables access to the new primitive
/// blend modes, MIN and ADD, through its SetPrimitiveBlend1 method.
/// </summary>
interface DX_DECLARE_INTERFACE("9eb767fd-4269-4467-b8c2-eb30cb305743")
  ...
  /// </summary>
  STDMETHOD(SetPrimitiveBlend1)(D2D1_PRIMITIVE_BLEND primitiveBlend) PURE;
...
FLOAT
WINAPI D2D1ComputeMaximumScaleFactor(_In_ CONST D2D1_MATRIX_3X2_F *matrix);
