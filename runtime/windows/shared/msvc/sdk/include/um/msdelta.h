...
#pragma region Desktop Family or CoreSetup Package
                            ...
                            WINAPI_PARTITION_PKG_CORESETUP)
...
/** File type set that distinguishes I386, IA64 and AMD64 Portable Executable
 * file and treats others as raw. */
#define DELTA_FILE_TYPE_SET_EXECUTABLES_1                                      \
  (DELTA_FILE_TYPE_RAW | DELTA_FILE_TYPE_I386 | DELTA_FILE_TYPE_IA64 |         \
   DELTA_FILE_TYPE_AMD64)

#define DELTA_FILE_TYPE_SET_EXECUTABLES DELTA_FILE_TYPE_SET_EXECUTABLES_1

/** File type set that distinguishes I386, IA64, ARM, and AMD64 Portable
 * Executable file and treats others as raw. */
#define DELTA_FILE_TYPE_SET_EXECUTABLES_2                                      \
  (DELTA_FILE_TYPE_RAW | DELTA_FILE_TYPE_CLI4_I386 | DELTA_FILE_TYPE_IA64 |    \
   DELTA_FILE_TYPE_CLI4_AMD64 | DELTA_FILE_TYPE_CLI4_ARM)

/** File type set that distinguishes I386, IA64, ARM, ARM64, and AMD64 Portable
 * Executable file and treats others as raw. */
#define DELTA_FILE_TYPE_SET_EXECUTABLES_3                                      \
  (DELTA_FILE_TYPE_RAW | DELTA_FILE_TYPE_CLI4_I386 | DELTA_FILE_TYPE_IA64 |    \
   DELTA_FILE_TYPE_CLI4_AMD64 | DELTA_FILE_TYPE_CLI4_ARM |                     \
...
#define DELTA_FLAG_I386_SMASHLOCK                                              \
  ((DELTA_FLAG_TYPE)0x00000040) /* flags[ 6 ]                                  \
                                 */
...
#define DELTA_FLAG_CLI_METADATA                                                \
  ((DELTA_FLAG_TYPE)0x00008000) /* flags[ 15 ]                                 \
                                 */
...
#define DELTA_FLAG_IGNORE_FILE_SIZE_LIMIT                                      \
  ((DELTA_FLAG_TYPE)0x00020000) /* flags[ 17 ] */

/** Allow options buffer or file to exceeed its default size limit. */
#define DELTA_FLAG_IGNORE_OPTIONS_SIZE_LIMIT                                   \
  ((DELTA_FLAG_TYPE)0x00040000) /* flags[ 18 ] */
...
#define DELTA_FLAG_CLI4_METADATA                                               \
  ((DELTA_FLAG_TYPE)0x00200000) /* flags[ 21 ]                                 \
                                 */
...
/** Transform instructions of source ARM PE. */
#define DELTA_FLAG_ARM64_DISASM                                                \
  ((DELTA_FLAG_TYPE)0x00800000) /* flags[ 23 ]                                 \
                                 */
...
#define DELTA_DEFAULT_FLAGS_I386                                               \
  (DELTA_FLAG_MARK | DELTA_FLAG_IMPORTS | DELTA_FLAG_EXPORTS |                 \
   DELTA_FLAG_RESOURCES | DELTA_FLAG_RELOCS | DELTA_FLAG_I386_SMASHLOCK |      \
   DELTA_FLAG_I386_JMPS | DELTA_FLAG_I386_CALLS | DELTA_FLAG_UNBIND |          \
   DELTA_FLAG_CLI_DISASM | DELTA_FLAG_CLI_METADATA)

#define DELTA_DEFAULT_FLAGS_IA64                                               \
  (DELTA_FLAG_MARK | DELTA_FLAG_IMPORTS | DELTA_FLAG_EXPORTS |                 \
   DELTA_FLAG_RESOURCES | DELTA_FLAG_RELOCS | DELTA_FLAG_IA64_DISASM |         \
   DELTA_FLAG_IA64_PDATA | DELTA_FLAG_UNBIND | DELTA_FLAG_CLI_DISASM |         \
   DELTA_FLAG_CLI_METADATA)

#define DELTA_DEFAULT_FLAGS_AMD64                                              \
  (DELTA_FLAG_MARK | DELTA_FLAG_IMPORTS | DELTA_FLAG_EXPORTS |                 \
   DELTA_FLAG_RESOURCES | DELTA_FLAG_RELOCS | DELTA_FLAG_AMD64_DISASM |        \
   DELTA_FLAG_AMD64_PDATA | DELTA_FLAG_UNBIND | DELTA_FLAG_CLI_DISASM |        \
   DELTA_FLAG_CLI_METADATA)

#define DELTA_CLI4_FLAGS_I386                                                  \
  (DELTA_FLAG_MARK | DELTA_FLAG_IMPORTS | DELTA_FLAG_EXPORTS |                 \
   DELTA_FLAG_RESOURCES | DELTA_FLAG_RELOCS | DELTA_FLAG_I386_SMASHLOCK |      \
   DELTA_FLAG_I386_JMPS | DELTA_FLAG_I386_CALLS | DELTA_FLAG_UNBIND |          \
   DELTA_FLAG_CLI4_DISASM | DELTA_FLAG_CLI4_METADATA)

#define DELTA_CLI4_FLAGS_AMD64                                                 \
  (DELTA_FLAG_MARK | DELTA_FLAG_IMPORTS | DELTA_FLAG_EXPORTS |                 \
   DELTA_FLAG_RESOURCES | DELTA_FLAG_RELOCS | DELTA_FLAG_AMD64_DISASM |        \
   DELTA_FLAG_AMD64_PDATA | DELTA_FLAG_UNBIND | DELTA_FLAG_CLI4_DISASM |       \
   DELTA_FLAG_CLI4_METADATA)

#define DELTA_CLI4_FLAGS_ARM                                                   \
  (DELTA_FLAG_MARK | DELTA_FLAG_IMPORTS | DELTA_FLAG_EXPORTS |                 \
   DELTA_FLAG_RESOURCES | DELTA_FLAG_RELOCS | DELTA_FLAG_ARM_DISASM |          \
   DELTA_FLAG_ARM_PDATA | DELTA_FLAG_UNBIND | DELTA_FLAG_CLI4_DISASM |         \
   DELTA_FLAG_CLI4_METADATA)

#define DELTA_CLI4_FLAGS_ARM64                                                 \
  (DELTA_FLAG_MARK | DELTA_FLAG_IMPORTS | DELTA_FLAG_EXPORTS |                 \
   DELTA_FLAG_RESOURCES | DELTA_FLAG_RELOCS | DELTA_FLAG_ARM64_DISASM |        \
   DELTA_FLAG_ARM64_PDATA | DELTA_FLAG_UNBIND | DELTA_FLAG_CLI4_DISASM |       \
   DELTA_FLAG_CLI4_METADATA)
 ...
 */
BOOL WINAPI GetDeltaInfoB(_In_ DELTA_INPUT Delta,
 ...
 * @return              TRUE if success, FALSE otherwise.
 */
BOOL WINAPI GetDeltaInfoA(_In_ LPCSTR lpDeltaName,
                          _Out_ LPDELTA_HEADER_INFO lpHeaderInfo);
 ...
 * @return              TRUE if success, FALSE otherwise.
 */
BOOL WINAPI GetDeltaInfoW(_In_ LPCWSTR lpDeltaName,
                          _Out_ LPDELTA_HEADER_INFO lpHeaderInfo);
...
/**
 * Applies a given delta to a given source file and creates the reverse delta to
 * the original. The resultant target file and reverse is put into allocated
 * memory.
 ...
 * @return                  TRUE if success, FALSE otherwise.
 */
BOOL WINAPI ApplyDeltaGetReverseB(_In_ DELTA_FLAG_TYPE ApplyFlags,
 ...
 * @param ApplyFlags    Apply-specific flags, such as
 ...
 * @return              TRUE if success, FALSE otherwise.
 */
BOOL WINAPI ApplyDeltaB(_In_ DELTA_FLAG_TYPE ApplyFlags,
                        _In_ DELTA_INPUT Source, _In_ DELTA_INPUT Delta,
                        _Out_ LPDELTA_OUTPUT lpTarget);
 ...
 * @param uTargetSize   Size of target memory block in bytes, caller needs to
 * call GetDeltaInfo to obtain it.
 * @return              TRUE if success, FALSE otherwise.
 */
BOOL WINAPI ApplyDeltaProvidedB(_In_ DELTA_FLAG_TYPE ApplyFlags,
                                _In_ DELTA_INPUT Source, _In_ DELTA_INPUT Delta,
                                _Inout_updates_bytes_(uTargetSize)
                                    LPVOID lpTarget,
                                _In_ SIZE_T uTargetSize);

/**
 * Applies a given delta to a given source file. The resultant target file is
 * written to disk. All files accessed by ASCII file names.
 * @param ApplyFlags    Apply-specific flags, such as
 * DELTA_APPLY_FLAG_ALLOW_PA19.
 ...
 * @return              TRUE if success, FALSE otherwise.
 */
BOOL WINAPI ApplyDeltaA(_In_ DELTA_FLAG_TYPE ApplyFlags,
                        _In_ LPCSTR lpSourceName, _In_ LPCSTR lpDeltaName,
                        _In_ LPCSTR lpTargetName);

/**
 * Applies a given delta to a given source file. The resultant target file is
 * written to disk. All files accessed by Unicode file names.
 * @param ApplyFlags    Apply-specific flags, such as
 * DELTA_APPLY_FLAG_ALLOW_PA19.
 ...
 * @return              TRUE if success, FALSE otherwise.
 */
BOOL WINAPI ApplyDeltaW(_In_ DELTA_FLAG_TYPE ApplyFlags,
                        _In_ LPCWSTR lpSourceName, _In_ LPCWSTR lpDeltaName,
 ...
 */
BOOL WINAPI CreateDeltaB(_In_ DELTA_FILE_TYPE FileTypeSet,
                         _In_ DELTA_FLAG_TYPE SetFlags,
                         _In_ DELTA_FLAG_TYPE ResetFlags,
                         _In_ DELTA_INPUT Source, _In_ DELTA_INPUT Target,
                         ...
                         _In_ ALG_ID HashAlgId, _Out_ LPDELTA_OUTPUT lpDelta);

/**
 * Creates a delta from a given source file to a given target file. The
 * resultant delta is written to disk All files accessed by ASCII file names.
 * @param FileTypeSet   File type set.
 * @param SetFlags      Set these flags.
 * @param ResetFlags    Reset (supress) these flags.
 * @param lpSourceName  Source file name, ASCII.
 * @param lpTargetName  Target file name, ASCII.
 * @param lpSourceOptionsName   Name of file with source-specific options,
 * ASCII.
 * @param lpTargetOptionsName   Name of file with target-specific options,
 * ASCII.
 * @param GlobalOptions Memory block with global options.
 * @param lpTargetFileTime  Target file time to use, null to use actual target
 * file time.
 * @param HashAlgId     Algorithm for hashing.
 * @param lpDeltaName   Result delta file name, ASCII.
 * @return              TRUE if sucess, FALSE otherwise.
 */
BOOL WINAPI CreateDeltaA(_In_ DELTA_FILE_TYPE FileTypeSet,
                         _In_ DELTA_FLAG_TYPE SetFlags,
                         _In_ DELTA_FLAG_TYPE ResetFlags,
                         _In_ LPCSTR lpSourceName, _In_ LPCSTR lpTargetName,
                         _In_opt_ LPCSTR lpSourceOptionsName,
                         _In_opt_ LPCSTR lpTargetOptionsName,
                         _In_ DELTA_INPUT GlobalOptions,
                         _In_opt_ const FILETIME *lpTargetFileTime,
                         _In_ ALG_ID HashAlgId, _In_ LPCSTR lpDeltaName);

/**
 * Creates a delta from a given source file to a given target file. The
 * resultant delta is written to disk All files accessed by Unicode file names.
 * @param FileTypeSet  File type set.
 * @param SetFlags      Set these flags.
 * @param ResetFlags    Reset (supress) these flags.
 * @param lpSourceName  Source file name, Unicode.
 ...
 * @return              TRUE if sucess, FALSE otherwise.
 */
BOOL WINAPI CreateDeltaW(_In_ DELTA_FILE_TYPE FileTypeSet,
                         _In_ DELTA_FLAG_TYPE SetFlags,
                         _In_ DELTA_FLAG_TYPE ResetFlags,
                         _In_ LPCWSTR lpSourceName, _In_ LPCWSTR lpTargetName,
                         _In_opt_ LPCWSTR lpSourceOptionsName,
                         _In_opt_ LPCWSTR lpTargetOptionsName,
                         _In_ DELTA_INPUT GlobalOptions,
                         _In_opt_ const FILETIME *lpTargetFileTime,
                         _In_ ALG_ID HashAlgId, _In_ LPCWSTR lpDeltaName);
 ...
 * @return              TRUE if success, FALSE otherwise.
 */
BOOL WINAPI GetDeltaSignatureB(_In_ DELTA_FILE_TYPE FileTypeSet,
                               _In_ ALG_ID HashAlgId, _In_ DELTA_INPUT Source,
 ...
 * @return              TRUE if success, FALSE otherwise.
 */
BOOL WINAPI GetDeltaSignatureA(_In_ DELTA_FILE_TYPE FileTypeSet,
                               _In_ ALG_ID HashAlgId, _In_ LPCSTR lpSourceName,
                               _Out_ LPDELTA_HASH lpHash);
 ...
 * @return              TRUE if success, FALSE otherwise.
 */
BOOL WINAPI GetDeltaSignatureW(_In_ DELTA_FILE_TYPE FileTypeSet,
                               _In_ ALG_ID HashAlgId, _In_ LPCWSTR lpSourceName,
                               _Out_ LPDELTA_HASH lpHash);
 ...
 * is determined automatically according to the given file type set.
 * @param FileTypeSet   File type set.
 ...
 * @return              TRUE if success, FALSE otherwise.
 */
BOOL WINAPI DeltaNormalizeProvidedB(_In_ DELTA_FILE_TYPE FileTypeSet,
                                    _In_ DELTA_FLAG_TYPE NormalizeFlags,
                                    _In_ DELTA_INPUT NormalizeOptions,
                                    _Inout_updates_bytes_(uSourceSize)
                                        LPVOID lpSource,
