...
#define IImePlugInDictDictionaryList_GetDictionariesInUse(                     \
    This, prgDictionaryGUID, prgDateCreated, prgfEncrypted)                    \
  ((This)->lpVtbl->GetDictionariesInUse(This, prgDictionaryGUID,               \
                                        prgDateCreated, prgfEncrypted))

#define IImePlugInDictDictionaryList_DeleteDictionary(This,                    \
                                                      bstrDictionaryGUID)      \
...
DEFINE_GUID(CLSID_ImePlugInDictDictionaryList_CHS, 0x7bf0129b, 0x5bef, 0x4de4,
            0x9b, 0x0b, 0x5e, 0xdb, 0x66, 0xac, 0x2f, 0xa6);
#define VIPROGID_ImePlugInDictDictionaryList_CHS                               \
  OLESTR("ImePlugInDictDictionaryList2052")
#define VDPROGID_ImePlugInDictDictionaryList_CHS                               \
  OLESTR("ImePlugInDictDictionaryList2052.15")
// {4FE2776B-B0F9-4396-B5FC-E9D4CF1EC195}
DEFINE_GUID(CLSID_ImePlugInDictDictionaryList_JPN, 0x4fe2776b, 0xb0f9, 0x4396,
            0xb5, 0xfc, 0xe9, 0xd4, 0xcf, 0x1e, 0xc1, 0x95);
#define VIPROGID_ImePlugInDictDictionaryList_JPN                               \
  OLESTR("ImePlugInDictDictionaryList1041")
#define VDPROGID_ImePlugInDictDictionaryList_JPN                               \
  OLESTR("ImePlugInDictDictionaryList1041.15")
