...
typedef _Must_inspect_result_ SOCKET(WSPAPI *LPWSPACCEPT)(
    _In_ SOCKET s,
    ...
    _In_opt_ DWORD_PTR dwCallbackData, _Out_ LPINT lpErrno);
...
typedef INT(WSPAPI *LPWSPADDRESSTOSTRING)(
    ...
    _Inout_ LPDWORD lpdwAddressStringLength, _Out_ LPINT lpErrno);

typedef int(WSPAPI *LPWSPASYNCSELECT)(_In_ SOCKET s, _In_ HWND hWnd,
                                      _In_ unsigned int wMsg, _In_ long lEvent,
                                      _Out_ LPINT lpErrno);

typedef int(WSPAPI *LPWSPBIND)(_In_ SOCKET s,
                               _In_reads_bytes_(namelen)
                                   const struct sockaddr FAR *name,
                               _In_ int namelen, _Out_ LPINT lpErrno);
...
typedef int(WSPAPI *LPWSPCONNECT)(
    ...
    _In_opt_ LPQOS lpGQOS, _Out_ LPINT lpErrno);

typedef int(WSPAPI *LPWSPDUPLICATESOCKET)(
    _In_ SOCKET s, _In_ DWORD dwProcessId,
    _Out_ LPWSAPROTOCOL_INFOW lpProtocolInfo, _Out_ LPINT lpErrno);

typedef int(WSPAPI *LPWSPENUMNETWORKEVENTS)(
    _In_ SOCKET s, _In_ WSAEVENT hEventObject,
    _Out_ LPWSANETWORKEVENTS lpNetworkEvents, _Out_ LPINT lpErrno);

typedef int(WSPAPI *LPWSPEVENTSELECT)(_In_ SOCKET s,
...
typedef int(WSPAPI *LPWSPGETPEERNAME)(
    ...
    _Inout_ LPINT namelen, _Out_ LPINT lpErrno);
...
typedef int(WSPAPI *LPWSPGETSOCKOPT)(
    ...
    _Out_writes_bytes_(*optlen) char FAR *optval, _Inout_ LPINT optlen,
    _Out_ LPINT lpErrno);

typedef BOOL(WSPAPI *LPWSPGETQOSBYNAME)(_In_ SOCKET s, _In_ LPWSABUF lpQOSName,
                                        _Out_ LPQOS lpQOS, _Out_ LPINT lpErrno);
...
typedef int(WSPAPI *LPWSPIOCTL)(
    ...
    _In_opt_ LPWSATHREADID lpThreadId, _Out_ LPINT lpErrno);

typedef SOCKET(WSPAPI *LPWSPJOINLEAF)(
    _In_ SOCKET s, _In_reads_bytes_(namelen) const struct sockaddr FAR *name,
    _In_ int namelen, _In_opt_ LPWSABUF lpCallerData,
    _Out_opt_ LPWSABUF lpCalleeData, _In_opt_ LPQOS lpSQOS,
    _In_opt_ LPQOS lpGQOS, _In_ DWORD dwFlags, _Out_ LPINT lpErrno);

typedef int(WSPAPI *LPWSPLISTEN)(_In_ SOCKET s, _In_ int backlog,
                                 _Out_ LPINT lpErrno);
...
typedef int(WSPAPI *LPWSPRECV)(
    ...
    _In_opt_ LPWSAOVERLAPPED_COMPLETION_ROUTINE lpCompletionRoutine,
    _In_opt_ LPWSATHREADID lpThreadId, _In_ LPINT lpErrno);

typedef int(WSPAPI *LPWSPRECVDISCONNECT)(
    _In_ SOCKET s, _In_opt_ LPWSABUF lpInboundDisconnectData,
    _Out_ LPINT lpErrno);
...
typedef int(WSPAPI *LPWSPSELECT)(_In_ int nfds, _Inout_opt_ fd_set FAR *readfds,
...
typedef int(WSPAPI *LPWSPSETSOCKOPT)(_In_ SOCKET s, _In_ int level,
                                     _In_ int optname,
                                     _In_reads_bytes_opt_(optlen)
                                         const char FAR *optval,
                                     _In_ int optlen, _Out_ LPINT lpErrno);

typedef int(WSPAPI *LPWSPSHUTDOWN)(_In_ SOCKET s, _In_ int how,
                                   _Out_ LPINT lpErrno);

typedef _Must_inspect_result_
SOCKET(WSPAPI *LPWSPSOCKET)(_In_ int af, _In_ int type, _In_ int protocol,
...
typedef INT(WSPAPI *LPWSPSTRINGTOADDRESS)(
    ...
    _Inout_ LPINT lpAddressLength, _Out_ LPINT lpErrno);
...
typedef BOOL(WSPAPI *LPWPUCLOSEEVENT)(_In_ WSAEVENT hEvent,
                                      _Out_ LPINT lpErrno);
...
typedef _Must_inspect_result_ SOCKET(WSPAPI *LPWPUCREATESOCKETHANDLE)(
    _In_ DWORD dwCatalogEntryId, _In_ DWORD_PTR dwContext, _Out_ LPINT lpErrno);

typedef int(WSPAPI *LPWPUFDISSET)(_In_ SOCKET s, _In_ fd_set FAR *fdset);

typedef int(WSPAPI *LPWPUGETPROVIDERPATH)(_In_ LPGUID lpProviderId,
                                          _Out_writes_(*lpProviderDllPathLen)
                                              WCHAR FAR *lpszProviderDllPath,
                                          _Inout_ LPINT lpProviderDllPathLen,
                                          _Out_ LPINT lpErrno);

typedef SOCKET(WSPAPI *LPWPUMODIFYIFSHANDLE)(_In_ DWORD dwCatalogEntryId,
                                             _In_ SOCKET ProposedHandle,
                                             _Out_ LPINT lpErrno);

typedef BOOL(WSPAPI *LPWPUPOSTMESSAGE)(_In_ HWND hWnd, _In_ UINT Msg,
                                       _In_ WPARAM wParam, _In_ LPARAM lParam);

typedef int(WSPAPI *LPWPUQUERYBLOCKINGCALLBACK)(
    _In_ DWORD dwCatalogEntryId, _Out_ LPBLOCKINGCALLBACK FAR *lplpfnCallback,
    _Out_ PDWORD_PTR lpdwContext, _Out_ LPINT lpErrno);

typedef int(WSPAPI *LPWPUQUERYSOCKETHANDLECONTEXT)(_In_ SOCKET s,
                                                   _Out_ PDWORD_PTR lpContext,
                                                   _Out_ LPINT lpErrno);

typedef int(WSPAPI *LPWPUQUEUEAPC)(_In_ LPWSATHREADID lpThreadId,
                                   _In_ LPWSAUSERAPC lpfnUserApc,
                                   _In_ DWORD_PTR dwContext,
                                   _Out_ LPINT lpErrno);

typedef BOOL(WSPAPI *LPWPURESETEVENT)(_In_ WSAEVENT hEvent,
                                      _Out_ LPINT lpErrno);

typedef BOOL(WSPAPI *LPWPUSETEVENT)(_In_ WSAEVENT hEvent, _Out_ LPINT lpErrno);

typedef int(WSPAPI *LPWPUOPENCURRENTTHREAD)(_Out_ LPWSATHREADID lpThreadId,
                                            _Out_ LPINT lpErrno);

typedef int(WSPAPI *LPWPUCLOSETHREAD)(_In_ LPWSATHREADID lpThreadId,
                                      _Out_ LPINT lpErrno);

// Available only directly from ws2_32.dll
typedef int(WSPAPI *LPWPUCOMPLETEOVERLAPPEDREQUEST)(
    _In_ SOCKET s, _Inout_ LPWSAOVERLAPPED lpOverlapped, _In_ DWORD dwError,
    _In_ DWORD cbTransferred, _Out_ LPINT lpErrno);
...
_Must_inspect_result_ int WSPAPI
WSPStartup(_In_ WORD wVersionRequested, _In_ LPWSPDATA lpWSPData,
           _In_ LPWSAPROTOCOL_INFOW lpProtocolInfo,
           _In_ WSPUPCALLTABLE UpcallTable, _Out_ LPWSPPROC_TABLE lpProcTable);

typedef _Must_inspect_result_ int(WSPAPI *LPWSPSTARTUP)(
    _In_ WORD wVersionRequested, _In_ LPWSPDATA lpWSPData,
    _In_ LPWSAPROTOCOL_INFOW lpProtocolInfo, _In_ WSPUPCALLTABLE UpcallTable,
...
typedef int(WSPAPI *LPWSCENUMPROTOCOLS)(
    ...
    _Out_writes_bytes_to_opt_(*lpdwBufferLength, *lpdwBufferlength)
        LPWSAPROTOCOL_INFOW lpProtocolBuffer,
    _Inout_ LPDWORD lpdwBufferLength, _Out_ LPINT lpErrno);
 ...
 */
int WSPAPI WSCEnumProtocols32(_In_opt_ LPINT lpiProtocols,
                              _Out_writes_bytes_(*lpdwBufferLength)
                                  LPWSAPROTOCOL_INFOW lpProtocolBuffer,
                              _Inout_ LPDWORD lpdwBufferLength,
                              _Out_ LPINT lpErrno);
...
typedef int(WSPAPI *LPWSCDEINSTALLPROVIDER)(_In_ LPGUID lpProviderId,
                                            _Out_ LPINT lpErrno);

#if (defined(_WIN64) && (_WIN32_WINNT >= 0x0501))

int WSPAPI WSCDeinstallProvider32(_In_ LPGUID lpProviderId,
                                  _Out_ LPINT lpErrno);
#endif //(defined(_WIN64) && _WIN32_WINNT >= 0x0501)

int WSPAPI WSCInstallProvider(_In_ LPGUID lpProviderId,
                              _In_z_ const WCHAR FAR *lpszProviderDllPath,
                              _In_reads_(dwNumberOfEntries)
                                  const LPWSAPROTOCOL_INFOW lpProtocolInfoList,
                              _In_ DWORD dwNumberOfEntries,
                              _Out_ LPINT lpErrno);

typedef int(WSPAPI *LPWSCINSTALLPROVIDER)(
    _In_ LPGUID lpProviderId, _In_z_ const WCHAR FAR *lpszProviderDllPath,
    _In_reads_(dwNumberOfEntries) const LPWSAPROTOCOL_INFOW lpProtocolInfoList,
    _In_ DWORD dwNumberOfEntries, _Out_ LPINT lpErrno);
...
int WSPAPI WSCGetProviderPath(_In_ LPGUID lpProviderId,
                              _Out_writes_to_(*lpProviderDllPathLen,
                                              *lpProviderDllPathLen)
                                  WCHAR FAR *lpszProviderDllPath,
                              _Inout_ LPINT lpProviderDllPathLen,
                              _Out_ LPINT lpErrno);

typedef int(WSPAPI *LPWSCGETPROVIDERPATH)(_In_ LPGUID lpProviderId,
                                          _Out_writes_to_(*lpProviderDllPathLen,
                                                          *lpProviderDllPathLen)
                                              WCHAR FAR *lpszProviderDllPath,
                                          _Inout_ LPINT lpProviderDllPathLen,
...
#if defined(_WIN64)
_Success_(return == 0) int WSPAPI
    WSCGetProviderPath32(_In_ LPGUID lpProviderId,
                         _Out_writes_to_(*lpProviderDllPathLen,
                                         *lpProviderDllPathLen)
                             WCHAR FAR *lpszProviderDllPath,
                         _Inout_ LPINT lpProviderDllPathLen,
...
int WSPAPI WSCUpdateProvider(_In_ LPGUID lpProviderId,
                             _In_z_ const WCHAR FAR *lpszProviderDllPath,
                             _In_reads_(dwNumberOfEntries)
                                 const LPWSAPROTOCOL_INFOW lpProtocolInfoList,
                             _In_ DWORD dwNumberOfEntries, _Out_ LPINT lpErrno);
...
#if defined(_WIN64)
int WSPAPI WSCUpdateProvider32(_In_ LPGUID lpProviderId,
                               _In_z_ const WCHAR FAR *lpszProviderDllPath,
                               _In_reads_(dwNumberOfEntries)
                                   const LPWSAPROTOCOL_INFOW lpProtocolInfoList,
                               _In_ DWORD dwNumberOfEntries,
...
int WSPAPI WSCInstallQOSTemplate(_In_ const LPGUID Guid, _In_ LPWSABUF QosName,
                                 _In_ LPQOS Qos);

typedef int(WSPAPI *LPWSCINSTALLQOSTEMPLATE)(_In_ const LPGUID Guid,
                                             _In_ LPWSABUF QosName,
                                             _In_ LPQOS Qos);

int WSPAPI WSCRemoveQOSTemplate(_In_ const LPGUID Guid, _In_ LPWSABUF QosName);

typedef int(WSPAPI *LPWSCREMOVEQOSTEMPLATE)(_In_ const LPGUID Guid,
                                            _In_ LPWSABUF QosName);
...
int WSPAPI WSCSetProviderInfo(_In_ LPGUID lpProviderId,
                              _In_ WSC_PROVIDER_INFO_TYPE InfoType,
                              _In_reads_bytes_(InfoSize) PBYTE Info,
                              _In_ size_t InfoSize, _In_ DWORD Flags,
                              _Out_ LPINT lpErrno);

int WSPAPI WSCGetProviderInfo(_In_ LPGUID lpProviderId,
                              _In_ WSC_PROVIDER_INFO_TYPE InfoType,
                              _Out_writes_bytes_to_(*InfoSize, *InfoSize)
                                  PBYTE Info,
                              _Inout_ size_t *InfoSize, _In_ DWORD Flags,
                              _Out_ LPINT lpErrno);

#if defined(_WIN64)

int WSPAPI WSCSetProviderInfo32(_In_ LPGUID lpProviderId,
                                _In_ WSC_PROVIDER_INFO_TYPE InfoType,
                                _In_reads_bytes_(InfoSize) PBYTE Info,
                                _In_ size_t InfoSize, _In_ DWORD Flags,
                                _Out_ LPINT lpErrno);

int WSPAPI WSCGetProviderInfo32(_In_ LPGUID lpProviderId,
                                _In_ WSC_PROVIDER_INFO_TYPE InfoType,
                                _Out_writes_bytes_to_(*InfoSize, *InfoSize)
                                    PBYTE Info,
                                _Inout_ size_t *InfoSize, _In_ DWORD Flags,
...
int WSPAPI WSCSetApplicationCategory(_In_reads_(PathLength) LPCWSTR Path,
...
int WSPAPI WSCGetApplicationCategory(_In_reads_(PathLength) LPCWSTR Path,
                                     _In_ DWORD PathLength,
                                     _In_reads_opt_(ExtraLength) LPCWSTR Extra,
                                     _In_ DWORD ExtraLength,
...
WSAEVENT
WSPAPI
WPUCreateEvent(_Out_ LPINT lpErrno);

SOCKET
WSPAPI
WPUCreateSocketHandle(_In_ DWORD dwCatalogEntryId, _In_ DWORD_PTR dwContext,
                      _Out_ LPINT lpErrno);
...
SOCKET
WSPAPI
WPUModifyIFSHandle(_In_ DWORD dwCatalogEntryId, _In_ SOCKET ProposedHandle,
                   _Out_ LPINT lpErrno);

BOOL WSPAPI WPUPostMessage(_In_ HWND hWnd, _In_ UINT Msg, _In_ WPARAM wParam,
                           _In_ LPARAM lParam);
...
int WSPAPI WPUQueueApc(_In_ LPWSATHREADID lpThreadId,
                       _In_ LPWSAUSERAPC lpfnUserApc, _In_ DWORD_PTR dwContext,
                       _Out_ LPINT lpErrno);
...
#if (_WIN32_WINNT >= 0x0501)
int WSPAPI WPUOpenCurrentThread(_Out_ LPWSATHREADID lpThreadId,
                                _Out_ LPINT lpErrno);
...
#if defined(_WIN64)
INT WSAAPI WSCEnumNameSpaceProviders32(_Inout_ LPDWORD lpdwBufferLength,
                                       _Out_writes_bytes_(*lpdwBufferLength)
...
INT WSPAPI WSCInstallNameSpace(_In_ LPWSTR lpszIdentifier,
                               _In_ LPWSTR lpszPathName, _In_ DWORD dwNameSpace,
                               _In_ DWORD dwVersion, _In_ LPGUID lpProviderId);

typedef INT(WSPAPI *LPWSCINSTALLNAMESPACE)(_In_ LPWSTR lpszIdentifier,
...
#if (defined(_WIN64) && (_WIN32_WINNT >= 0x0501))
INT WSPAPI WSCInstallNameSpace32(_In_ LPWSTR lpszIdentifier,
                                 _In_ LPWSTR lpszPathName,
                                 _In_ DWORD dwNameSpace, _In_ DWORD dwVersion,
                                 _In_ LPGUID lpProviderId);
#endif //(defined(_WIN64) && (_WIN32_WINNT >= 0x0501))
...
#if (_WIN32_WINNT >= 0x0600)
INT WSPAPI WSCInstallNameSpaceEx(_In_ LPWSTR lpszIdentifier,
                                 _In_ LPWSTR lpszPathName,
                                 _In_ DWORD dwNameSpace, _In_ DWORD dwVersion,
                                 _In_ LPGUID lpProviderId,
...
INT WSPAPI WSCInstallNameSpaceEx32(_In_ LPWSTR lpszIdentifier,
                                   _In_ LPWSTR lpszPathName,
                                   _In_ DWORD dwNameSpace, _In_ DWORD dwVersion,
                                   _In_ LPGUID lpProviderId,
                                   _In_ LPBLOB lpProviderSpecific);
...
#if (defined(_WIN64) && (_WIN32_WINNT >= 0x0501))
INT WSPAPI WSCUnInstallNameSpace32(_In_ LPGUID lpProviderId);
#endif //(defined(_WIN64) && (_WIN32_WINNT >= 0x0501))

INT WSPAPI WSCEnableNSProvider(_In_ LPGUID lpProviderId, _In_ BOOL fEnable);

typedef INT(WSPAPI *LPWSCENABLENSPROVIDER)(_In_ LPGUID lpProviderId,
                                           _In_ BOOL fEnable);

#if (defined(_WIN64) && (_WIN32_WINNT >= 0x0501))
INT WSPAPI WSCEnableNSProvider32(_In_ LPGUID lpProviderId, _In_ BOOL fEnable);
#endif //(defined(_WIN64) && (_WIN32_WINNT >= 0x0501))
...
#endif
    _In_ LPGUID lpProviderId, _In_ const LPWSTR lpszProviderDllPath,
#if defined(_WIN64)
    _In_ const LPWSTR lpszProviderDllPath32,
#endif
    _In_ const LPWSTR lpszLspName, _In_ DWORD dwServiceFlags,
    _Inout_updates_(dwNumberOfEntries) LPWSAPROTOCOL_INFOW lpProtocolInfoList,
    _In_ DWORD dwNumberOfEntries, _Out_opt_ LPDWORD lpdwCatalogEntryId,
    _Out_ LPINT lpErrno);
...
typedef INT(WSAAPI *LPNSPLOOKUPSERVICEBEGIN)(
    _In_ LPGUID lpProviderId, _In_ LPWSAQUERYSETW lpqsRestrictions,
    _In_ LPWSASERVICECLASSINFOW lpServiceClassInfo, _In_ DWORD dwControlFlags,
...
typedef INT(WSAAPI *LPNSPIOCTL)(
    ...
    _In_reads_bytes_(cbInBuffer) LPVOID lpvInBuffer, _In_ DWORD cbInBuffer,
    _Out_writes_bytes_to_(cbOutBuffer, *lpcbBytesReturned) LPVOID lpvOutBuffer,
    _In_ DWORD cbOutBuffer, _Out_ LPDWORD lpcbBytesReturned,
    _In_opt_ LPWSACOMPLETION lpCompletion, _In_ LPWSATHREADID lpThreadId);
#endif //(_WIN32_WINNT >= 0x0501)

typedef INT(WSAAPI *LPNSPLOOKUPSERVICEEND)(_In_ HANDLE hLookup);

typedef INT(WSAAPI *LPNSPSETSERVICE)(
    _In_ LPGUID lpProviderId, _In_ LPWSASERVICECLASSINFOW lpServiceClassInfo,
    _In_ LPWSAQUERYSETW lpqsRegInfo, _In_ WSAESETSERVICEOP essOperation,
    _In_ DWORD dwControlFlags);

typedef INT(WSAAPI *LPNSPINSTALLSERVICECLASS)(
    _In_ LPGUID lpProviderId, _In_ LPWSASERVICECLASSINFOW lpServiceClassInfo);

typedef INT(WSAAPI *LPNSPREMOVESERVICECLASS)(_In_ LPGUID lpProviderId,
                                             _In_ LPGUID lpServiceClassId);

typedef INT(WSAAPI *LPNSPGETSERVICECLASSINFO)(
    _In_ LPGUID lpProviderId, _In_ LPDWORD lpdwBufSize,
...
_Must_inspect_result_ INT WSAAPI
NSPStartup(_In_ LPGUID lpProviderId, _Inout_ LPNSP_ROUTINE lpnspRoutines);

typedef _Must_inspect_result_
INT(WSAAPI *LPNSPSTARTUP)(_In_ LPGUID lpProviderId,
                          _Inout_ LPNSP_ROUTINE lpnspRoutines);

typedef _Must_inspect_result_
INT(WSAAPI *LPNSPV2STARTUP)(_In_ LPGUID lpProviderId,
                            _Outptr_ LPVOID *ppvClientSessionArg);

typedef INT(WSAAPI *LPNSPV2CLEANUP)(_In_ LPGUID lpProviderId,
                                    _In_ LPVOID pvClientSessionArg);

typedef INT(WSAAPI *LPNSPV2LOOKUPSERVICEBEGIN)(
    _In_ LPGUID lpProviderId, _In_ LPWSAQUERYSET2W lpqsRestrictions,
    _In_ DWORD dwControlFlags, _In_ LPVOID lpvClientSessionArg,
    _Out_ LPHANDLE lphLookup);

typedef VOID(WSAAPI *LPNSPV2LOOKUPSERVICENEXTEX)(
    _In_ HANDLE hAsyncCall, _In_ HANDLE hLookup, _In_ DWORD dwControlFlags,
    _In_ LPDWORD lpdwBufferLength, _Out_ LPWSAQUERYSET2W lpqsResults);

typedef INT(WSAAPI *LPNSPV2LOOKUPSERVICEEND)(_In_ HANDLE hLookup);

typedef VOID(WSAAPI *LPNSPV2SETSERVICEEX)(_In_ HANDLE hAsyncCall,
                                          _In_ LPGUID lpProviderId,
...
typedef VOID(WSAAPI *LPNSPV2CLIENTSESSIONRUNDOWN)(
    _In_ LPGUID lpProviderId, _In_ LPVOID pvClientSessionArg);
...
INT WSAAPI WSAAdvertiseProvider(_In_ const GUID *puuidProviderId,
                                _In_ const LPCNSPV2_ROUTINE pNSPv2Routine);

INT WSAAPI WSAUnadvertiseProvider(_In_ const GUID *puuidProviderId);

INT WSAAPI WSAProviderCompleteAsyncCall(_In_ HANDLE hAsyncCall,
                                        _In_ INT iRetCode);
