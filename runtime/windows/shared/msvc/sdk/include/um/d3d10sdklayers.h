...
typedef struct ID3D10DebugVtbl {
  ...
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(ID3D10Debug *This,
                                             /* [in] */ REFIID riid,
...
DEFINE_GUID(DXGI_DEBUG_D3D10, 0x243b4c52, 0x3606, 0x4d3a, 0x99, 0xd7, 0xa7,
            0xe7, 0xb3, 0x3e, 0xd7, 0x6);
...
public:
  ...
  virtual HRESULT STDMETHODCALLTYPE GetStorageFilter(
      /* [annotation] */
      _Out_writes_bytes_opt_(*pFilterByteLength) D3D10_INFO_QUEUE_FILTER *
          pFilter,
      /* [annotation] */
...
typedef struct ID3D10InfoQueueVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(ID3D10InfoQueue *This,
                                             /* [in] */ REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);
  ...
  DECLSPEC_XFGVIRT(ID3D10InfoQueue,
  ...
  HRESULT(STDMETHODCALLTYPE *AddApplicationMessage)(ID3D10InfoQueue *This,
                                                    /* [annotation] */
                                                    _In_ D3D10_MESSAGE_SEVERITY
                                                        Severity,
                                                    /* [annotation] */
                                                    _In_ LPCSTR pDescription);

  DECLSPEC_XFGVIRT(ID3D10InfoQueue, SetBreakOnCategory)
  HRESULT(STDMETHODCALLTYPE *SetBreakOnCategory)(ID3D10InfoQueue *This,
                                                 /* [annotation] */
                                                 _In_ D3D10_MESSAGE_CATEGORY
                                                     Category,
                                                 /* [annotation] */
                                                 _In_ BOOL bEnable);

  DECLSPEC_XFGVIRT(ID3D10InfoQueue, SetBreakOnSeverity)
  HRESULT(STDMETHODCALLTYPE *SetBreakOnSeverity)(ID3D10InfoQueue *This,
                                                 /* [annotation] */
                                                 _In_ D3D10_MESSAGE_SEVERITY
                                                     Severity,
                                                 /* [annotation] */
  ...
  BOOL(STDMETHODCALLTYPE *GetBreakOnSeverity)(ID3D10InfoQueue *This,
                                              /* [annotation] */
                                              _In_ D3D10_MESSAGE_SEVERITY
                                                  Severity);

  DECLSPEC_XFGVIRT(ID3D10InfoQueue, GetBreakOnID)
  BOOL(STDMETHODCALLTYPE *GetBreakOnID)(ID3D10InfoQueue *This,
                                        /* [annotation] */
                                        _In_ D3D10_MESSAGE_ID ID);
