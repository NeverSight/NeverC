...
typedef HRESULT(WINAPI *PFN_PDF_CREATE_RENDERER)(_In_ IDXGIDevice *,
                                                 _Out_ IPdfRendererNative **);

HRESULT WINAPI PdfCreateRenderer(_In_ IDXGIDevice *pDevice,
...
static const D2D_COLOR_F sc_PdfRenderParamsDefaultBkColor = {1.f, 1.f, 1.f,
                                                             1.f};
__inline PDF_RENDER_PARAMS PdfRenderParams(
    _In_ CONST D2D_RECT_F &srcRect = sc_PdfRenderParamsDefaultSrcRect,
    _In_ UINT32 destinationWidth = 0.f, _In_ UINT32 destinationHeight = 0.f,
    _In_ CONST D2D_COLOR_F &bkColor = sc_PdfRenderParamsDefaultBkColor,
    _In_ BOOLEAN ignoreHighContrast = TRUE) {
  PDF_RENDER_PARAMS p = {srcRect, destinationWidth, destinationHeight, bkColor,
                         ignoreHighContrast};
  return p;
}
#endif
...
extern RPC_IF_HANDLE
    __MIDL_itf_windows2Edata2Epdf2Einterop_0000_0000_v0_0_c_ifspec;
extern RPC_IF_HANDLE
    __MIDL_itf_windows2Edata2Epdf2Einterop_0000_0000_v0_0_s_ifspec;
...
typedef struct IPdfRendererNativeVtbl {
  ...
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(IPdfRendererNative *This,
                                             /* [in] */ REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(IPdfRendererNative *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(IPdfRendererNative *This);
...
#define IPdfRendererNative_RenderPageToSurface(This, pdfPage, pSurface,        \
                                               offset, pRenderParams)          \
  ((This)->lpVtbl->RenderPageToSurface(This, pdfPage, pSurface, offset,        \
                                       pRenderParams))

#define IPdfRendererNative_RenderPageToDeviceContext(                          \
    This, pdfPage, pD2DDeviceContext, pRenderParams)                           \
  ((This)->lpVtbl->RenderPageToDeviceContext(This, pdfPage, pD2DDeviceContext, \
                                             pRenderParams))
...
extern RPC_IF_HANDLE
    __MIDL_itf_windows2Edata2Epdf2Einterop_0000_0001_v0_0_c_ifspec;
extern RPC_IF_HANDLE
    __MIDL_itf_windows2Edata2Epdf2Einterop_0000_0001_v0_0_s_ifspec;
