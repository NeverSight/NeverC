...
public:
  virtual HRESULT STDMETHODCALLTYPE GetIPortableDeviceValuesFromBuffer(
      /* [size_is][in] */ __RPC__in_ecount_full(dwInputBufferLength) BYTE *
          pBuffer,
  ...
  virtual HRESULT STDMETHODCALLTYPE WriteIPortableDeviceValuesToBuffer(
      ...
      __RPC__out_ecount_part(dwOutputBufferLength, *pdwBytesWritten) BYTE *
          pBuffer,
...
typedef struct IWpdSerializerVtbl {
  ...
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in IWpdSerializer *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IWpdSerializer *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IWpdSerializer *This);
  ...
  HRESULT(STDMETHODCALLTYPE *WriteIPortableDeviceValuesToBuffer)(
      ...
      /* [in] */ __RPC__in_opt IPortableDeviceValues *pResults,
      /* [length_is][size_is][out] */
      __RPC__out_ecount_part(dwOutputBufferLength, *pdwBytesWritten)
          BYTE *pBuffer,
...
interface IWpdSerializer { CONST_VTBL struct IWpdSerializerVtbl *lpVtbl; };
...
#define IWpdSerializer_GetIPortableDeviceValuesFromBuffer(                     \
    This, pBuffer, dwInputBufferLength, ppParams)                              \
  ((This)->lpVtbl->GetIPortableDeviceValuesFromBuffer(                         \
      This, pBuffer, dwInputBufferLength, ppParams))

#define IWpdSerializer_WriteIPortableDeviceValuesToBuffer(                     \
    This, dwOutputBufferLength, pResults, pBuffer, pdwBytesWritten)            \
  ((This)->lpVtbl->WriteIPortableDeviceValuesToBuffer(                         \
      This, dwOutputBufferLength, pResults, pBuffer, pdwBytesWritten))

#define IWpdSerializer_GetBufferFromIPortableDeviceValues(                     \
    This, pSource, ppBuffer, pdwBufferSize)                                    \
  ((This)->lpVtbl->GetBufferFromIPortableDeviceValues(This, pSource, ppBuffer, \
                                                      pdwBufferSize))
...
typedef struct IPortableDeviceValuesVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IPortableDeviceValues *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IPortableDeviceValues *This);

  DECLSPEC_XFGVIRT(IPortableDeviceValues, GetCount)
  HRESULT(STDMETHODCALLTYPE *GetCount)(__RPC__in IPortableDeviceValues *This,
  ...
  DECLSPEC_XFGVIRT(IPortableDeviceValues,
                   SetIPortableDevicePropVariantCollectionValue)
  ...
  HRESULT(STDMETHODCALLTYPE *RemoveValue)(__RPC__in IPortableDeviceValues *This,
  ...
  HRESULT(STDMETHODCALLTYPE *Clear)(__RPC__in IPortableDeviceValues *This);
...
typedef struct IPortableDeviceKeyCollectionVtbl {
  ...
  HRESULT(STDMETHODCALLTYPE *Add)(__RPC__in IPortableDeviceKeyCollection *This,
                                  /* [in] */ __RPC__in REFPROPERTYKEY Key);
