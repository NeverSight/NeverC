...
DECLARE_INTERFACE_(IMpegAudioDecoder, IUnknown) {
  ...
  STDMETHOD(get_FrequencyDivider)(
      THIS_ _Out_ unsigned long *pDivider /* [out] */
      ) PURE;
  ...
  STDMETHOD(get_DecoderAccuracy)(
      THIS_ _Out_ unsigned long *pAccuracy /* [out] */
      ) PURE;

  STDMETHOD(put_DecoderAccuracy)(THIS_ unsigned long Accuracy /* [in] */
                                 ) PURE;

  STDMETHOD(get_Stereo)(THIS_ _Out_ unsigned long *pStereo /* [out] */
                        ) PURE;
  ...
  STDMETHOD(get_DecoderWordSize)(
      THIS_ _Out_ unsigned long *pWordSize /* [out] */
      ) PURE;

  STDMETHOD(put_DecoderWordSize)(THIS_ unsigned long WordSize /* [in] */
                                 ) PURE;

  STDMETHOD(get_IntegerDecode)(THIS_ _Out_ unsigned long *pIntDecode /* [out] */
                               ) PURE;
  ...
  STDMETHOD(get_AudioFormat)(THIS_ _Out_ MPEG1WAVEFORMAT * lpFmt /* [out] */
                             ) PURE;
};
