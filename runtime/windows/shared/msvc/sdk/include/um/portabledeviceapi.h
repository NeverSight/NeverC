...
typedef struct IPortableDeviceManagerVtbl {
  ...
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IPortableDeviceManager *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IPortableDeviceManager *This);
...
#define IPortableDeviceManager_GetDeviceFriendlyName(                          \
    This, pszPnPDeviceID, pDeviceFriendlyName, pcchDeviceFriendlyName)         \
  ((This)->lpVtbl->GetDeviceFriendlyName(                                      \
      This, pszPnPDeviceID, pDeviceFriendlyName, pcchDeviceFriendlyName))

#define IPortableDeviceManager_GetDeviceDescription(                           \
    This, pszPnPDeviceID, pDeviceDescription, pcchDeviceDescription)           \
  ((This)->lpVtbl->GetDeviceDescription(                                       \
      This, pszPnPDeviceID, pDeviceDescription, pcchDeviceDescription))

#define IPortableDeviceManager_GetDeviceManufacturer(                          \
    This, pszPnPDeviceID, pDeviceManufacturer, pcchDeviceManufacturer)         \
  ((This)->lpVtbl->GetDeviceManufacturer(                                      \
      This, pszPnPDeviceID, pDeviceManufacturer, pcchDeviceManufacturer))

#define IPortableDeviceManager_GetDeviceProperty(                              \
    This, pszPnPDeviceID, pszDevicePropertyName, pData, pcbData, pdwType)      \
  ((This)->lpVtbl->GetDeviceProperty(                                          \
      This, pszPnPDeviceID, pszDevicePropertyName, pData, pcbData, pdwType))

#define IPortableDeviceManager_GetPrivateDevices(This, pPnPDeviceIDs,          \
                                                 pcPnPDeviceIDs)               \
...
public:
  ...
  virtual HRESULT STDMETHODCALLTYPE Capabilities(
      /* [out] */ __RPC__deref_out_opt IPortableDeviceCapabilities *
      *ppCapabilities) = 0;
...
typedef struct IPortableDeviceVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in IPortableDevice *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IPortableDevice *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IPortableDevice *This);
  ...
  HRESULT(STDMETHODCALLTYPE *Cancel)(__RPC__in IPortableDevice *This);

  DECLSPEC_XFGVIRT(IPortableDevice, Close)
  HRESULT(STDMETHODCALLTYPE *Close)(__RPC__in IPortableDevice *This);
  ...
  HRESULT(STDMETHODCALLTYPE *Unadvise)(__RPC__in IPortableDevice *This,
...
interface IPortableDevice { CONST_VTBL struct IPortableDeviceVtbl *lpVtbl; };
...
#define IPortableDevice_Advise(This, dwFlags, pCallback, pParameters,          \
                               ppszCookie)                                     \
...
public:
  ...
  virtual HRESULT STDMETHODCALLTYPE Delete(
      ...
      /* [unique][out][in] */
      __RPC__deref_opt_inout_opt IPortableDevicePropVariantCollection *
          *ppResults) = 0;

  virtual HRESULT STDMETHODCALLTYPE GetObjectIDsFromPersistentUniqueIDs(
      /* [in] */ __RPC__in_opt IPortableDevicePropVariantCollection *
          pPersistentUniqueIDs,
      /* [out] */ __RPC__deref_out_opt IPortableDevicePropVariantCollection *
          *ppObjectIDs) = 0;
...
typedef struct IPortableDeviceContentVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IPortableDeviceContent *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IPortableDeviceContent *This);
  ...
  HRESULT(STDMETHODCALLTYPE *Cancel)(__RPC__in IPortableDeviceContent *This);
...
#define IPortableDeviceContent_EnumObjects(This, dwFlags, pszParentObjectID,   \
                                           pFilter, ppEnum)                    \
  ((This)->lpVtbl->EnumObjects(This, dwFlags, pszParentObjectID, pFilter,      \
                               ppEnum))
...
#define IPortableDeviceContent_CreateObjectWithPropertiesOnly(This, pValues,   \
                                                              ppszObjectID)    \
...
#define IPortableDeviceContent_CreateObjectWithPropertiesAndData(              \
    This, pValues, ppData, pdwOptimalWriteBufferSize, ppszCookie)              \
...
#define IPortableDeviceContent_GetObjectIDsFromPersistentUniqueIDs(            \
    This, pPersistentUniqueIDs, ppObjectIDs)                                   \
  ((This)->lpVtbl->GetObjectIDsFromPersistentUniqueIDs(                        \
      This, pPersistentUniqueIDs, ppObjectIDs))

#define IPortableDeviceContent_Cancel(This) ((This)->lpVtbl->Cancel(This))

#define IPortableDeviceContent_Move(This, pObjectIDs,                          \
                                    pszDestinationFolderObjectID, ppResults)   \
  ((This)->lpVtbl->Move(This, pObjectIDs, pszDestinationFolderObjectID,        \
                        ppResults))

#define IPortableDeviceContent_Copy(This, pObjectIDs,                          \
                                    pszDestinationFolderObjectID, ppResults)   \
  ((This)->lpVtbl->Copy(This, pObjectIDs, pszDestinationFolderObjectID,        \
                        ppResults))
...
typedef struct IPortableDeviceContent2Vtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IPortableDeviceContent2 *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IPortableDeviceContent2 *This);
  ...
  DECLSPEC_XFGVIRT(IPortableDeviceContent, Cancel)
  HRESULT(STDMETHODCALLTYPE *Cancel)(__RPC__in IPortableDeviceContent2 *This);
...
#define IPortableDeviceContent2_EnumObjects(This, dwFlags, pszParentObjectID,  \
                                            pFilter, ppEnum)                   \
  ((This)->lpVtbl->EnumObjects(This, dwFlags, pszParentObjectID, pFilter,      \
                               ppEnum))
...
#define IPortableDeviceContent2_CreateObjectWithPropertiesOnly(This, pValues,  \
                                                               ppszObjectID)   \
  ((This)->lpVtbl->CreateObjectWithPropertiesOnly(This, pValues, ppszObjectID))
...
#define IPortableDeviceContent2_Move(This, pObjectIDs,                         \
                                     pszDestinationFolderObjectID, ppResults)  \
  ((This)->lpVtbl->Move(This, pObjectIDs, pszDestinationFolderObjectID,        \
                        ppResults))

#define IPortableDeviceContent2_Copy(This, pObjectIDs,                         \
                                     pszDestinationFolderObjectID, ppResults)  \
  ((This)->lpVtbl->Copy(This, pObjectIDs, pszDestinationFolderObjectID,        \
                        ppResults))

#define IPortableDeviceContent2_UpdateObjectWithPropertiesAndData(             \
    This, pszObjectID, pProperties, ppData, pdwOptimalWriteBufferSize)         \
...
public:
  ...
  virtual HRESULT STDMETHODCALLTYPE Clone(
      /* [out] */ __RPC__deref_out_opt IEnumPortableDeviceObjectIDs *
      *ppEnum) = 0;
...
typedef struct IEnumPortableDeviceObjectIDsVtbl {
  ...
  HRESULT(STDMETHODCALLTYPE *Skip)(__RPC__in IEnumPortableDeviceObjectIDs *This,
                                   /* [in] */ ULONG cObjects);
...
public:
  ...
  virtual HRESULT STDMETHODCALLTYPE GetPropertyAttributes(
      ...
      /* [out] */ __RPC__deref_out_opt IPortableDeviceValues *
          *ppAttributes) = 0;
...
typedef struct IPortableDevicePropertiesVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IPortableDeviceProperties *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IPortableDeviceProperties *This);
  ...
  HRESULT(STDMETHODCALLTYPE *Cancel)(__RPC__in IPortableDeviceProperties *This);
...
#define IPortableDeviceProperties_GetSupportedProperties(This, pszObjectID,    \
                                                         ppKeys)               \
  ((This)->lpVtbl->GetSupportedProperties(This, pszObjectID, ppKeys))

#define IPortableDeviceProperties_GetPropertyAttributes(This, pszObjectID,     \
                                                        Key, ppAttributes)     \
  ((This)->lpVtbl->GetPropertyAttributes(This, pszObjectID, Key, ppAttributes))

#define IPortableDeviceProperties_GetValues(This, pszObjectID, pKeys,          \
                                            ppValues)                          \
  ((This)->lpVtbl->GetValues(This, pszObjectID, pKeys, ppValues))

#define IPortableDeviceProperties_SetValues(This, pszObjectID, pValues,        \
                                            ppResults)                         \
...
typedef struct IPortableDeviceResourcesVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IPortableDeviceResources *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IPortableDeviceResources *This);
  ...
  HRESULT(STDMETHODCALLTYPE *Cancel)(__RPC__in IPortableDeviceResources *This);
...
#define IPortableDeviceResources_GetSupportedResources(This, pszObjectID,      \
                                                       ppKeys)                 \
  ((This)->lpVtbl->GetSupportedResources(This, pszObjectID, ppKeys))

#define IPortableDeviceResources_GetResourceAttributes(This, pszObjectID, Key, \
                                                       ppResourceAttributes)   \
  ((This)->lpVtbl->GetResourceAttributes(This, pszObjectID, Key,               \
                                         ppResourceAttributes))

#define IPortableDeviceResources_GetStream(This, pszObjectID, Key, dwMode,     \
                                           pdwOptimalBufferSize, ppStream)     \
  ((This)->lpVtbl->GetStream(This, pszObjectID, Key, dwMode,                   \
                             pdwOptimalBufferSize, ppStream))
...
#define IPortableDeviceResources_CreateResource(                               \
    This, pResourceAttributes, ppData, pdwOptimalWriteBufferSize, ppszCookie)  \
  ((This)->lpVtbl->CreateResource(This, pResourceAttributes, ppData,           \
                                  pdwOptimalWriteBufferSize, ppszCookie))
...
typedef struct IPortableDeviceCapabilitiesVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IPortableDeviceCapabilities *This);
  ...
  HRESULT(STDMETHODCALLTYPE *GetSupportedContentTypes)(
      ...
      /* [in] */ __RPC__in REFGUID Category,
      /* [out] */
      __RPC__deref_out_opt IPortableDevicePropVariantCollection *
          *ppContentTypes);
...
#define IPortableDeviceCapabilities_GetCommandOptions(This, Command,           \
                                                      ppOptions)               \
  ((This)->lpVtbl->GetCommandOptions(This, Command, ppOptions))

#define IPortableDeviceCapabilities_GetFunctionalCategories(This,              \
                                                            ppCategories)      \
...
#define IPortableDeviceCapabilities_GetSupportedFormats(This, ContentType,     \
                                                        ppFormats)             \
...
typedef struct IPortableDeviceDataStreamVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IPortableDeviceDataStream *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IPortableDeviceDataStream *This);
  ...
  HRESULT(STDMETHODCALLTYPE *SetSize)(__RPC__in IPortableDeviceDataStream *This,
  ...
  HRESULT(STDMETHODCALLTYPE *Commit)(__RPC__in IPortableDeviceDataStream *This,
                                     /* [in] */ DWORD grfCommitFlags);

  DECLSPEC_XFGVIRT(IStream, Revert)
  HRESULT(STDMETHODCALLTYPE *Revert)(__RPC__in IPortableDeviceDataStream *This);
  ...
  HRESULT(STDMETHODCALLTYPE *Stat)(__RPC__in IPortableDeviceDataStream *This,
  ...
  HRESULT(STDMETHODCALLTYPE *Cancel)(__RPC__in IPortableDeviceDataStream *This);
...
typedef struct IPortableDeviceUnitsStreamVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IPortableDeviceUnitsStream *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IPortableDeviceUnitsStream *This);
...
#define IPortableDeviceUnitsStream_SeekInUnits(This, dlibMove, units,          \
                                               dwOrigin, plibNewPosition)      \
  ((This)->lpVtbl->SeekInUnits(This, dlibMove, units, dwOrigin,                \
                               plibNewPosition))
...
/* [call_as] */ HRESULT
STDMETHODCALLTYPE IPortableDeviceUnitsStream_RemoteSeekInUnits_Proxy(
    __RPC__in IPortableDeviceUnitsStream *This,
    /* [in] */ LARGE_INTEGER dlibMove,
    /* [in] */ WPD_STREAM_UNITS units,
    /* [in] */ DWORD dwOrigin,
...
public:
  virtual HRESULT STDMETHODCALLTYPE QueueGetValuesByObjectList(
      /* [in] */ __RPC__in_opt IPortableDevicePropVariantCollection *
          pObjectIDs,
      /* [in] */ __RPC__in_opt IPortableDeviceKeyCollection * pKeys,
      /* [in] */ __RPC__in_opt IPortableDevicePropertiesBulkCallback *
          pCallback,
...
#define IPortableDevicePropertiesBulk_QueueGetValuesByObjectList(              \
    This, pObjectIDs, pKeys, pCallback, pContext)                              \
  ((This)->lpVtbl->QueueGetValuesByObjectList(This, pObjectIDs, pKeys,         \
                                              pCallback, pContext))

#define IPortableDevicePropertiesBulk_QueueGetValuesByObjectFormat(            \
    This, pguidObjectFormat, pszParentObjectID, dwDepth, pKeys, pCallback,     \
    pContext)                                                                  \
  ((This)->lpVtbl->QueueGetValuesByObjectFormat(This, pguidObjectFormat,       \
                                                pszParentObjectID, dwDepth,    \
                                                pKeys, pCallback, pContext))

#define IPortableDevicePropertiesBulk_QueueSetValuesByObjectList(              \
    This, pObjectValues, pCallback, pContext)                                  \
  ((This)->lpVtbl->QueueSetValuesByObjectList(This, pObjectValues, pCallback,  \
                                              pContext))
...
#define IPortableDevicePropertiesBulkCallback_OnProgress(This, pContext,       \
                                                         pResults)             \
...
#define IPortableDeviceServiceManager_GetDeviceServices(                       \
    This, pszPnPDeviceID, guidServiceCategory, pServices, pcServices)          \
  ((This)->lpVtbl->GetDeviceServices(                                          \
      This, pszPnPDeviceID, guidServiceCategory, pServices, pcServices))

#define IPortableDeviceServiceManager_GetDeviceForService(                     \
    This, pszPnPServiceID, ppszPnPDeviceID)                                    \
...
public:
  ...
  virtual HRESULT STDMETHODCALLTYPE Capabilities(
      /* [out] */ __RPC__deref_out_opt IPortableDeviceServiceCapabilities *
      *ppCapabilities) = 0;

  virtual HRESULT STDMETHODCALLTYPE Content(
      /* [out] */ __RPC__deref_out_opt IPortableDeviceContent2 *
      *ppContent) = 0;

  virtual HRESULT STDMETHODCALLTYPE Methods(
      /* [out] */ __RPC__deref_out_opt IPortableDeviceServiceMethods *
      *ppMethods) = 0;
...
typedef struct IPortableDeviceServiceVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IPortableDeviceService *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IPortableDeviceService *This);
  ...
  HRESULT(STDMETHODCALLTYPE *Cancel)(__RPC__in IPortableDeviceService *This);

  DECLSPEC_XFGVIRT(IPortableDeviceService, Close)
  HRESULT(STDMETHODCALLTYPE *Close)(__RPC__in IPortableDeviceService *This);
  ...
  HRESULT(STDMETHODCALLTYPE *Unadvise)(__RPC__in IPortableDeviceService *This,
                                       /* [in] */ __RPC__in LPCWSTR pszCookie);
...
#define IPortableDeviceService_Advise(This, dwFlags, pCallback, pParameters,   \
                                      ppszCookie)                              \
  ((This)->lpVtbl->Advise(This, dwFlags, pCallback, pParameters, ppszCookie))
...
#define IPortableDeviceService_SendCommand(This, dwFlags, pParameters,         \
                                           ppResults)                          \
  ((This)->lpVtbl->SendCommand(This, dwFlags, pParameters, ppResults))
...
public:
  ...
  virtual HRESULT STDMETHODCALLTYPE GetFormatRenderingProfiles(
      /* [in] */ __RPC__in REFGUID Format,
      /* [out] */ __RPC__deref_out_opt IPortableDeviceValuesCollection *
          *ppRenderingProfiles) = 0;
...
typedef struct IPortableDeviceServiceCapabilitiesVtbl {
  ...
  DECLSPEC_XFGVIRT(IPortableDeviceServiceCapabilities,
  ...
  HRESULT(STDMETHODCALLTYPE *GetFormatRenderingProfiles)(
      ...
      /* [in] */ __RPC__in REFGUID Format,
      /* [out] */
      __RPC__deref_out_opt IPortableDeviceValuesCollection *
          *ppRenderingProfiles);
...
#define IPortableDeviceServiceCapabilities_GetMethodParameterAttributes(       \
    This, Method, Parameter, ppAttributes)                                     \
  ((This)->lpVtbl->GetMethodParameterAttributes(This, Method, Parameter,       \
                                                ppAttributes))

#define IPortableDeviceServiceCapabilities_GetSupportedFormats(This,           \
                                                               ppFormats)      \
...
#define IPortableDeviceServiceCapabilities_GetFormatPropertyAttributes(        \
    This, Format, Property, ppAttributes)                                      \
...
#define IPortableDeviceServiceCapabilities_GetEventAttributes(This, Event,     \
                                                              ppAttributes)    \
...
#define IPortableDeviceServiceCapabilities_GetEventParameterAttributes(        \
    This, Event, Parameter, ppAttributes)                                      \
  ((This)->lpVtbl->GetEventParameterAttributes(This, Event, Parameter,         \
                                               ppAttributes))

#define IPortableDeviceServiceCapabilities_GetInheritedServices(               \
    This, dwInheritanceType, ppServices)                                       \
...
#define IPortableDeviceServiceCapabilities_GetFormatRenderingProfiles(         \
    This, Format, ppRenderingProfiles)                                         \
  ((This)->lpVtbl->GetFormatRenderingProfiles(This, Format,                    \
                                              ppRenderingProfiles))
...
public:
  virtual HRESULT STDMETHODCALLTYPE Invoke(
      /* [in] */ __RPC__in REFGUID Method,
      /* [unique][in] */ __RPC__in_opt IPortableDeviceValues * pParameters,
      /* [unique][out][in] */ __RPC__deref_opt_inout_opt IPortableDeviceValues *
          *ppResults) = 0;

  virtual HRESULT STDMETHODCALLTYPE InvokeAsync(
      /* [in] */ __RPC__in REFGUID Method,
      /* [unique][in] */ __RPC__in_opt IPortableDeviceValues * pParameters,
      /* [unique][in] */ __RPC__in_opt IPortableDeviceServiceMethodCallback *
          pCallback) = 0;
...
#define IPortableDeviceServiceMethods_Invoke(This, Method, pParameters,        \
                                             ppResults)                        \
  ((This)->lpVtbl->Invoke(This, Method, pParameters, ppResults))

#define IPortableDeviceServiceMethods_InvokeAsync(This, Method, pParameters,   \
                                                  pCallback)                   \
...
#define IPortableDeviceServiceMethodCallback_OnComplete(This, hrStatus,        \
                                                        pResults)              \
...
public:
  virtual HRESULT STDMETHODCALLTYPE OpenAsync(
      /* [in] */ __RPC__in LPCWSTR pszPnPServiceID,
      /* [in] */ __RPC__in_opt IPortableDeviceValues * pClientInfo,
      /* [in] */ __RPC__in_opt IPortableDeviceServiceOpenCallback *
          pCallback) = 0;
...
#define IPortableDeviceServiceActivation_OpenAsync(This, pszPnPServiceID,      \
                                                   pClientInfo, pCallback)     \
...
#define IPortableDeviceDispatchFactory_GetDeviceDispatch(This, pszPnPDeviceID, \
                                                         ppDeviceDispatch)     \
...
#define IPortableDeviceWebControl_GetDeviceFromIdAsync(                        \
    This, deviceId, pCompletionHandler, pErrorHandler)                         \
  ((This)->lpVtbl->GetDeviceFromIdAsync(This, deviceId, pCompletionHandler,    \
                                        pErrorHandler))
...
IPortableDeviceUnitsStream_SeekInUnits_Proxy(
    IPortableDeviceUnitsStream *This,
    /* [in] */ LARGE_INTEGER dlibMove,
    /* [in] */ WPD_STREAM_UNITS units,
    /* [in] */ DWORD dwOrigin,
...
IPortableDeviceUnitsStream_SeekInUnits_Stub(
    __RPC__in IPortableDeviceUnitsStream *This,
    /* [in] */ LARGE_INTEGER dlibMove,
    /* [in] */ WPD_STREAM_UNITS units,
    /* [in] */ DWORD dwOrigin,
