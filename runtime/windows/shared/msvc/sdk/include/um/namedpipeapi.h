...
WINBASEAPI
BOOL WINAPI SetNamedPipeHandleState(_In_ HANDLE hNamedPipe,
                                    _In_opt_ LPDWORD lpMode,
                                    _In_opt_ LPDWORD lpMaxCollectionCount,
                                    _In_opt_ LPDWORD lpCollectDataTimeout);

WINBASEAPI
BOOL WINAPI PeekNamedPipe(_In_ HANDLE hNamedPipe,
                          _Out_writes_bytes_to_opt_(nBufferSize, *lpBytesRead)
                              LPVOID lpBuffer,
                          _In_ DWORD nBufferSize, _Out_opt_ LPDWORD lpBytesRead,
...
HANDLE
WINAPI
CreateNamedPipeW(_In_ LPCWSTR lpName, _In_ DWORD dwOpenMode,
...
WINBASEAPI
BOOL WINAPI WaitNamedPipeW(_In_ LPCWSTR lpNamedPipeName, _In_ DWORD nTimeOut);
...
ImpersonateNamedPipeClient(_In_ HANDLE hNamedPipe);
...
WINBASEAPI
BOOL WINAPI GetNamedPipeInfo(_In_ HANDLE hNamedPipe, _Out_opt_ LPDWORD lpFlags,
