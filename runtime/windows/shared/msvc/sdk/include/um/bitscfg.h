...
typedef struct IBITSExtensionSetupVtbl {
  ...
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IBITSExtensionSetup *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IBITSExtensionSetup *This);
...
public:
  virtual /* [id] */ HRESULT STDMETHODCALLTYPE GetObject(
      ...
      /* [retval][out] */ __RPC__deref_out_opt IBITSExtensionSetup *
          *ppExtensionSetup) = 0;
};
...
typedef struct IBITSExtensionSetupFactoryVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IBITSExtensionSetupFactory *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IBITSExtensionSetupFactory *This);
