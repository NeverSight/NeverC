...
typedef /* [public][public] */
    struct __MIDL___MIDL_itf_tsgpolicyengine_0000_0000_0003 {
  BSTR userName;
  BSTR clientName;
...
typedef /* [public][public] */
    enum __MIDL___MIDL_itf_tsgpolicyengine_0000_0000_0004 {
      ...
      SESSION_TIMEOUT_ACTION_SILENT_REAUTH =
          (SESSION_TIMEOUT_ACTION_DISCONNECT + 1)
...
public:
  virtual /* [helpstring] */ HRESULT STDMETHODCALLTYPE OnConnectionAuthorized(
      ...
      /* [size_is][in] */ __RPC__in_ecount_full(cbSoHResponse) BYTE *
          pbSoHResponse,
      ...
      /* [in] */
      __RPC__in_ecount_full(20) PolicyAttributes policyAttributes) = 0;
};
...
typedef struct ITSGAuthorizeConnectionSinkVtbl {
  ...
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in ITSGAuthorizeConnectionSink *This);
...
#define ITSGAuthorizeConnectionSink_OnConnectionAuthorized(                    \
    This, hrIn, mainSessionId, cbSoHResponse, pbSoHResponse, idleTimeout,      \
    sessionTimeout, sessionTimeoutAction, trustClass, policyAttributes)        \
  ((This)->lpVtbl->OnConnectionAuthorized(                                     \
      This, hrIn, mainSessionId, cbSoHResponse, pbSoHResponse, idleTimeout,    \
      sessionTimeout, sessionTimeoutAction, trustClass, policyAttributes))
...
typedef struct ITSGAuthorizeResourceSinkVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in ITSGAuthorizeResourceSink *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in ITSGAuthorizeResourceSink *This);
...
#define ITSGAuthorizeResourceSink_OnChannelAuthorized(                         \
    This, hrIn, mainSessionId, subSessionId, allowedResourceNames,             \
    numAllowedResourceNames, failedResourceNames, numFailedResourceNames)      \
  ((This)->lpVtbl->OnChannelAuthorized(                                        \
      This, hrIn, mainSessionId, subSessionId, allowedResourceNames,           \
      numAllowedResourceNames, failedResourceNames, numFailedResourceNames))
...
public:
  virtual HRESULT STDMETHODCALLTYPE AuthorizeConnection(
      ...
      /* [size_is][in] */ __RPC__in_ecount_full(numCookieBytes) BYTE *
          cookieData,
  ...
  virtual HRESULT STDMETHODCALLTYPE AuthorizeResource(
      ...
      /* [size_is][in] */
      __RPC__in_ecount_full(numAlternateResourceName)
...
typedef struct ITSGPolicyEngineVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in ITSGPolicyEngine *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in ITSGPolicyEngine *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in ITSGPolicyEngine *This);
  ...
  HRESULT(STDMETHODCALLTYPE *Refresh)(__RPC__in ITSGPolicyEngine *This);
...
interface ITSGPolicyEngine { CONST_VTBL struct ITSGPolicyEngineVtbl *lpVtbl; };
...
#define ITSGPolicyEngine_AuthorizeConnection(                                  \
    This, mainSessionId, username, authType, clientMachineIP,                  \
    clientMachineName, sohData, numSOHBytes, cookieData, numCookieBytes,       \
    userToken, pSink)                                                          \
  ((This)->lpVtbl->AuthorizeConnection(                                        \
      This, mainSessionId, username, authType, clientMachineIP,                \
      clientMachineName, sohData, numSOHBytes, cookieData, numCookieBytes,     \
      userToken, pSink))

#define ITSGPolicyEngine_AuthorizeResource(                                    \
    This, mainSessionId, subSessionId, username, resourceNames, numResources,  \
    alternateResourceNames, numAlternateResourceName, portNumber, operation,   \
    cookie, numBytesInCookie, pSink)                                           \
  ((This)->lpVtbl->AuthorizeResource(                                          \
...
typedef struct ITSGAccountingEngineVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in ITSGAccountingEngine *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in ITSGAccountingEngine *This);
...
#define ITSGAccountingEngine_DoAccounting(This, accountingDataType,            \
                                          accountingData)                      \
