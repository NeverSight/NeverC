...
HRESULT WINAPI D3D10StateBlockMaskIntersect(
    _In_ D3D10_STATE_BLOCK_MASK *pA, _In_ D3D10_STATE_BLOCK_MASK *pB,
    _Out_ D3D10_STATE_BLOCK_MASK *pResult);
HRESULT WINAPI D3D10StateBlockMaskDifference(
    _In_ D3D10_STATE_BLOCK_MASK *pA, _In_ D3D10_STATE_BLOCK_MASK *pB,
    _Out_ D3D10_STATE_BLOCK_MASK *pResult);
HRESULT WINAPI D3D10StateBlockMaskEnableCapture(
    _Inout_ D3D10_STATE_BLOCK_MASK *pMask, D3D10_DEVICE_STATE_TYPES StateType,
    UINT RangeStart, UINT RangeLength);
HRESULT WINAPI D3D10StateBlockMaskDisableCapture(
    _Inout_ D3D10_STATE_BLOCK_MASK *pMask, D3D10_DEVICE_STATE_TYPES StateType,
    UINT RangeStart, UINT RangeLength);
HRESULT WINAPI
D3D10StateBlockMaskEnableAll(_Out_ D3D10_STATE_BLOCK_MASK *pMask);
HRESULT WINAPI
D3D10StateBlockMaskDisableAll(_Out_ D3D10_STATE_BLOCK_MASK *pMask);
...
HRESULT WINAPI D3D10CreateStateBlock(
    _In_ ID3D10Device *pDevice, _In_ D3D10_STATE_BLOCK_MASK *pStateBlockMask,
...
DECLARE_INTERFACE(ID3D10EffectVariable) {
  ...
  STDMETHOD(SetRawValue)(THIS_ _In_reads_bytes_(ByteCount) void *pData,
                         UINT Offset, UINT ByteCount) PURE;
  STDMETHOD(GetRawValue)(THIS_ _Out_writes_bytes_(ByteCount) void *pData,
                         UINT Offset, UINT ByteCount) PURE;
};
...
DECLARE_INTERFACE_(ID3D10EffectScalarVariable, ID3D10EffectVariable) {
  ...
  STDMETHOD(SetRawValue)(THIS_ _In_reads_bytes_(ByteCount) void *pData,
                         UINT ByteOffset, UINT ByteCount) PURE;
  STDMETHOD(GetRawValue)(THIS_ _Out_writes_bytes_(ByteCount) void *pData,
                         UINT ByteOffset, UINT ByteCount) PURE;
  ...
  STDMETHOD(SetFloatArray)(THIS_ _In_reads_(Count) float *pData, UINT Offset,
                           UINT Count) PURE;
  STDMETHOD(GetFloatArray)(THIS_ _Out_writes_(Count) float *pData, UINT Offset,
                           UINT Count) PURE;

  STDMETHOD(SetInt)(THIS_ int Value) PURE;
  STDMETHOD(GetInt)(THIS_ _Out_ int *pValue) PURE;

  STDMETHOD(SetIntArray)(THIS_ _In_reads_(Count) int *pData, UINT Offset,
                         UINT Count) PURE;
  STDMETHOD(GetIntArray)(THIS_ _Out_writes_(Count) int *pData, UINT Offset,
                         UINT Count) PURE;

  STDMETHOD(SetBool)(THIS_ BOOL Value) PURE;
  STDMETHOD(GetBool)(THIS_ _Out_ BOOL * pValue) PURE;

  STDMETHOD(SetBoolArray)(THIS_ _In_reads_(Count) BOOL * pData, UINT Offset,
                          UINT Count) PURE;
  STDMETHOD(GetBoolArray)(THIS_ _Out_writes_(Count) BOOL * pData, UINT Offset,
                          UINT Count) PURE;
};
...
DECLARE_INTERFACE_(ID3D10EffectMatrixVariable, ID3D10EffectVariable) {
  ...
  STDMETHOD(SetMatrixTransposeArray)(THIS_ float *pData, UINT Offset,
                                     UINT Count) PURE;
  STDMETHOD(GetMatrixTransposeArray)(THIS_ float *pData, UINT Offset,
                                     UINT Count) PURE;
};
...
DECLARE_INTERFACE_(ID3D10EffectStringVariable, ID3D10EffectVariable) {
  ...
  STDMETHOD(GetStringArray)(THIS_ _Out_writes_(Count) LPCSTR * ppStrings,
                            UINT Offset, UINT Count) PURE;
};
...
DECLARE_INTERFACE_(ID3D10EffectShaderResourceVariable, ID3D10EffectVariable) {
  ...
  STDMETHOD(SetResource)(THIS_ _In_opt_ ID3D10ShaderResourceView * pResource)
      PURE;
  STDMETHOD(GetResource)(THIS_ _Out_ ID3D10ShaderResourceView * *ppResource)
      PURE;

  STDMETHOD(SetResourceArray)(THIS_ _In_reads_(Count) ID3D10ShaderResourceView *
                                  *ppResources,
                              UINT Offset, UINT Count) PURE;
  STDMETHOD(GetResourceArray)(
      THIS_ _Out_writes_(Count) ID3D10ShaderResourceView * *ppResources,
      UINT Offset, UINT Count) PURE;
};
...
DECLARE_INTERFACE_(ID3D10EffectRenderTargetViewVariable, ID3D10EffectVariable) {
  ...
  STDMETHOD(SetRenderTarget)(THIS_ _In_opt_ ID3D10RenderTargetView * pResource)
      PURE;
  STDMETHOD(GetRenderTarget)(THIS_ _Out_ ID3D10RenderTargetView * *ppResource)
      PURE;

  STDMETHOD(SetRenderTargetArray)(
      THIS_ _In_reads_(Count) ID3D10RenderTargetView * *ppResources,
      UINT Offset, UINT Count) PURE;
  STDMETHOD(GetRenderTargetArray)(
      THIS_ _Out_writes_(Count) ID3D10RenderTargetView * *ppResources,
      UINT Offset, UINT Count) PURE;
};
...
DECLARE_INTERFACE_(ID3D10EffectDepthStencilViewVariable, ID3D10EffectVariable) {
  ...
  STDMETHOD(SetDepthStencil)(THIS_ _In_opt_ ID3D10DepthStencilView * pResource)
      PURE;
  STDMETHOD(GetDepthStencil)(THIS_ _Out_ ID3D10DepthStencilView * *ppResource)
      PURE;

  STDMETHOD(SetDepthStencilArray)(
      THIS_ _In_reads_(Count) ID3D10DepthStencilView * *ppResources,
      UINT Offset, UINT Count) PURE;
  STDMETHOD(GetDepthStencilArray)(
      THIS_ _Out_writes_(Count) ID3D10DepthStencilView * *ppResources,
      UINT Offset, UINT Count) PURE;
};
...
DECLARE_INTERFACE_(ID3D10EffectConstantBuffer, ID3D10EffectVariable) {
  ...
  STDMETHOD(SetConstantBuffer)(THIS_ _In_opt_ ID3D10Buffer * pConstantBuffer)
      PURE;
  STDMETHOD(GetConstantBuffer)(THIS_ _Out_ ID3D10Buffer * *ppConstantBuffer)
      PURE;

  STDMETHOD(SetTextureBuffer)(THIS_ _In_opt_ ID3D10ShaderResourceView *
                              pTextureBuffer) PURE;
  STDMETHOD(GetTextureBuffer)(THIS_ _Out_ ID3D10ShaderResourceView *
                              *ppTextureBuffer) PURE;
};
...
DECLARE_INTERFACE_(ID3D10EffectShaderVariable, ID3D10EffectVariable) {
  ...
  STDMETHOD(GetShaderDesc)(THIS_ UINT ShaderIndex,
                           _Out_ D3D10_EFFECT_SHADER_DESC * pDesc) PURE;

  STDMETHOD(GetVertexShader)(THIS_ UINT ShaderIndex,
                             _Out_ ID3D10VertexShader * *ppVS) PURE;
  STDMETHOD(GetGeometryShader)(THIS_ UINT ShaderIndex,
                               _Out_ ID3D10GeometryShader * *ppGS) PURE;
  STDMETHOD(GetPixelShader)(THIS_ UINT ShaderIndex,
                            _Out_ ID3D10PixelShader * *ppPS) PURE;

  STDMETHOD(GetInputSignatureElementDesc)(THIS_ UINT ShaderIndex, UINT Element,
                                          _Out_ D3D10_SIGNATURE_PARAMETER_DESC *
                                              pDesc) PURE;
  STDMETHOD(GetOutputSignatureElementDesc)(
      THIS_ UINT ShaderIndex, UINT Element,
      _Out_ D3D10_SIGNATURE_PARAMETER_DESC * pDesc) PURE;
};
...
DECLARE_INTERFACE_(ID3D10EffectDepthStencilVariable, ID3D10EffectVariable) {
  ...
  STDMETHOD(GetDepthStencilState)(
      THIS_ UINT Index, _Out_ ID3D10DepthStencilState * *ppDepthStencilState)
      PURE;
  STDMETHOD(GetBackingStore)(THIS_ UINT Index, _Out_ D3D10_DEPTH_STENCIL_DESC *
                                                   pDepthStencilDesc) PURE;
};
...
DECLARE_INTERFACE_(ID3D10EffectRasterizerVariable, ID3D10EffectVariable) {
  ...
  STDMETHOD(GetRasterizerState)(THIS_ UINT Index, _Out_ ID3D10RasterizerState *
                                                      *ppRasterizerState) PURE;
  STDMETHOD(GetBackingStore)(THIS_ UINT Index, _Out_ D3D10_RASTERIZER_DESC *
                                                   pRasterizerDesc) PURE;
};
...
DECLARE_INTERFACE_(ID3D10EffectSamplerVariable, ID3D10EffectVariable) {
  ...
  STDMETHOD(GetSampler)(THIS_ UINT Index, _Out_ ID3D10SamplerState * *ppSampler)
      PURE;
  STDMETHOD(GetBackingStore)(THIS_ UINT Index,
                             _Out_ D3D10_SAMPLER_DESC * pSamplerDesc) PURE;
};
...
DECLARE_INTERFACE(ID3D10EffectPass) {
  ...
  STDMETHOD(ComputeStateBlockMask)(THIS_ _Out_ D3D10_STATE_BLOCK_MASK *
...
DECLARE_INTERFACE_(ID3D10Effect, IUnknown) {
  ...
  STDMETHOD_(ID3D10EffectConstantBuffer *,
  ...
  STDMETHOD_(ID3D10EffectVariable *,
             GetVariableBySemantic)(THIS_ LPCSTR Semantic) PURE;
...
HRESULT WINAPI D3D10CompileEffectFromMemory(
    _In_reads_bytes_(DataLength) void *pData, SIZE_T DataLength,
    LPCSTR pSrcFileName, _In_opt_ CONST D3D10_SHADER_MACRO *pDefines,
...
HRESULT WINAPI D3D10CreateEffectFromMemory(
    _In_reads_bytes_(DataLength) void *pData, SIZE_T DataLength, UINT FXFlags,
    _In_ ID3D10Device *pDevice, _In_opt_ ID3D10EffectPool *pEffectPool,
    _Out_ ID3D10Effect **ppEffect);

HRESULT WINAPI D3D10CreateEffectPoolFromMemory(
    _In_reads_bytes_(DataLength) void *pData, SIZE_T DataLength, UINT FXFlags,
    _In_ ID3D10Device *pDevice, _Out_ ID3D10EffectPool **ppEffectPool);
