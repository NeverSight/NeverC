...
typedef _Struct_size_bytes_(
    dwSize + sizeof(MPR_CREDENTIALSEX_0)) struct _MPR_CREDENTIALSEX_0 {
  DWORD dwSize;
  LPBYTE lpbCredentialsInfo;
} MPR_CREDENTIALSEX_0, *PMPR_CREDENTIALSEX_0;

typedef _Struct_size_bytes_(
    dwSize + sizeof(MPR_CREDENTIALSEX_1)) struct _MPR_CREDENTIALSEX_1 {
  DWORD dwSize;
  LPBYTE lpbCredentialsInfo;
...
//
// values for dwFlags in MPR_SERVER_1. This enables the ports for Ras or
// Routing.
//
...
typedef struct _ROUTER_CUSTOM_IKEv2_POLICY0 {
  ...
  DWORD dwDhGroup;
    ...
    ROUTER_CUSTOM_L2TP_POLICY0, *PROUTER_CUSTOM_L2TP_POLICY0;
...
typedef struct _ROUTER_IKEv2_IF_CUSTOM_CONFIG2 {
  ...
  //    TrafficSelector Negotitated Traffic is allowed to go through and
  //    received
...
DWORD APIENTRY MprAdminConnectionEnumEx(
    _In_ RAS_SERVER_HANDLE hRasServer, _In_ PMPRAPI_OBJECT_HEADER pObjectHeader,
    _In_ DWORD dwPreferedMaxLen, _Out_ LPDWORD lpdwEntriesRead,
    _Out_ LPDWORD lpdwTotalEntries, _Out_ PRAS_CONNECTION_EX *ppRasConn,
    _In_ LPDWORD lpdwResumeHandle);

DWORD APIENTRY MprAdminConnectionGetInfoEx(
    _In_ RAS_SERVER_HANDLE hRasServer, _In_ HANDLE hRasConnection,
    _Out_ PRAS_CONNECTION_EX
        pRasConnection); // Use MprAdminBufferFree for freeing pRASCONN

// Router Admin Functions:
DWORD APIENTRY MprAdminServerGetInfoEx(_In_ MPR_SERVER_HANDLE hMprServer,
                                       _Out_ MPR_SERVER_EX *pServerInfo);

DWORD APIENTRY
MprAdminServerSetInfoEx(_In_ MPR_SERVER_HANDLE hMprServer,
                        _In_ MPR_SERVER_SET_CONFIG_EX *pServerInfo);

// Router Config Functions:

DWORD APIENTRY MprConfigServerGetInfoEx(_In_ HANDLE hMprConfig,
                                        _Out_ MPR_SERVER_EX *pServerInfo);

DWORD APIENTRY MprConfigServerSetInfoEx(
    _In_ HANDLE hMprConfig, _In_ MPR_SERVER_SET_CONFIG_EX *pSetServerConfig);
...
#define MPRAPI_ADMIN_DLL_VERSION_2                                             \
  0x2 // If the version is 2: it can use RAS_CONNECTION_EX supported in
      // Windows 7.0
...
typedef BOOL(APIENTRY *PMPRADMINACCEPTNEWCONNECTION)(RAS_CONNECTION_0 *,
                                                     RAS_CONNECTION_1 *);

typedef BOOL(APIENTRY *PMPRADMINACCEPTNEWCONNECTION2)(RAS_CONNECTION_0 *,
                                                      RAS_CONNECTION_1 *,
                                                      RAS_CONNECTION_2 *);

typedef BOOL(APIENTRY *PMPRADMINACCEPTNEWCONNECTION3)(RAS_CONNECTION_0 *,
                                                      RAS_CONNECTION_1 *,
                                                      RAS_CONNECTION_2 *,
                                                      RAS_CONNECTION_3 *);
...
typedef VOID(APIENTRY *PMPRADMINCONNECTIONHANGUPNOTIFICATION)(
    RAS_CONNECTION_0 *, RAS_CONNECTION_1 *);

typedef VOID(APIENTRY *PMPRADMINCONNECTIONHANGUPNOTIFICATION2)(
    RAS_CONNECTION_0 *, RAS_CONNECTION_1 *, RAS_CONNECTION_2 *);

typedef VOID(APIENTRY *PMPRADMINCONNECTIONHANGUPNOTIFICATION3)(
    RAS_CONNECTION_0 *, RAS_CONNECTION_1 *, RAS_CONNECTION_2 *,
    RAS_CONNECTION_3);
...
typedef BOOL(APIENTRY *PMPRADMINACCEPTREAUTHENTICATION)(RAS_CONNECTION_0 *,
                                                        RAS_CONNECTION_1 *,
                                                        RAS_CONNECTION_2 *,
                                                        RAS_CONNECTION_3 *);
...
typedef BOOL(APIENTRY *PMPRADMINACCEPTTUNNELENDPOINTCHANGEEX)(
    RAS_CONNECTION_EX *);

typedef VOID(APIENTRY *PMPRADMINCONNECTIONHANGUPNOTIFICATIONEX)(
    RAS_CONNECTION_EX *);

typedef DWORD(APIENTRY *PMPRADMINRASVALIDATEPREAUTHENTICATEDCONNECTIONEX)(
    AUTH_VALIDATION_EX *);
...
void APIENTRY
MprAdminConnectionHangupNotificationEx(RAS_CONNECTION_EX *pRasConn);

DWORD APIENTRY
MprAdminInitializeDllEx(PMPRAPI_ADMIN_DLL_CALLBACKS pAdminCallbacks);

DWORD APIENTRY MprAdminIsServiceInitialized(_In_ LPWSTR lpwsServerName,
...
DWORD APIENTRY MprAdminInterfaceSetCustomInfoEx(
    _In_ MPR_SERVER_HANDLE hMprServer, _In_ HANDLE hInterface,
...
DWORD APIENTRY MprConfigInterfaceGetCustomInfoEx(
    _In_ HANDLE hMprConfig, _In_ HANDLE hRouterInterface,
    _Out_ PMPR_IF_CUSTOMINFOEX pCustomInfo);
...
DWORD APIENTRY MprAdminConnectionEnum(
    _In_ RAS_SERVER_HANDLE hRasServer, _In_ DWORD dwLevel,
    _Outptr_result_bytebuffer_(
        (*lpdwEntriesRead) *
        (dwLevel == 0
             ? sizeof(RAS_CONNECTION_0)
             : (dwLevel == 1 ? sizeof(RAS_CONNECTION_1)
                             : (dwLevel == 2 ? sizeof(RAS_CONNECTION_2)
                                             : sizeof(RAS_CONNECTION_3)))))
        LPBYTE *lplpbBuffer,
    _In_ DWORD dwPrefMaxLen, _Out_ LPDWORD lpdwEntriesRead,
    _Out_ LPDWORD lpdwTotalEntries, _In_opt_ LPDWORD lpdwResumeHandle);

DWORD APIENTRY MprAdminPortEnum(
    _In_ RAS_SERVER_HANDLE hRasServer, _In_ DWORD dwLevel,
    _In_ HANDLE hRasConnection,
    _Outptr_result_bytebuffer_((*lpdwEntriesRead) * sizeof(RAS_PORT_0))
        LPBYTE *lplpbBuffer,
    _In_ DWORD dwPrefMaxLen, _Out_ LPDWORD lpdwEntriesRead,
    _Out_ LPDWORD lpdwTotalEntries, _In_opt_ LPDWORD lpdwResumeHandle);

DWORD APIENTRY MprAdminConnectionGetInfo(_In_ RAS_SERVER_HANDLE hRasServer,
                                         _In_ DWORD dwLevel,
                                         _In_ HANDLE hRasConnection,
                                         _Out_ LPBYTE *lplpbBuffer);

DWORD APIENTRY MprAdminPortGetInfo(_In_ RAS_SERVER_HANDLE hRasServer,
                                   _In_ DWORD dwLevel, _In_ HANDLE hPort,
                                   _Out_ LPBYTE *lplpbBuffer);

DWORD APIENTRY MprAdminConnectionClearStats(_In_ RAS_SERVER_HANDLE hRasServer,
                                            _In_ HANDLE hRasConnection);

DWORD APIENTRY MprAdminPortClearStats(_In_ RAS_SERVER_HANDLE hRasServer,
                                      _In_ HANDLE hPort);

DWORD APIENTRY MprAdminPortReset(_In_ RAS_SERVER_HANDLE hRasServer,
                                 _In_ HANDLE hPort);

DWORD APIENTRY MprAdminPortDisconnect(_In_ RAS_SERVER_HANDLE hRasServer,
                                      _In_ HANDLE hPort);

BOOL APIENTRY
MprAdminAcceptNewConnection(_In_ RAS_CONNECTION_0 *pRasConnection0,
                            _In_ RAS_CONNECTION_1 *pRasConnection1);

#if (WINVER >= 0x0500)

BOOL APIENTRY
MprAdminAcceptNewConnection2(_In_ RAS_CONNECTION_0 *pRasConnection0,
                             _In_ RAS_CONNECTION_1 *pRasConnection1,
...
BOOL APIENTRY
MprAdminAcceptNewConnection3(_In_ RAS_CONNECTION_0 *pRasConnection0,
                             _In_ RAS_CONNECTION_1 *pRasConnection1,
                             _In_ RAS_CONNECTION_2 *pRasConnection2,
                             _In_ RAS_CONNECTION_3 *pRasConnection3);

BOOL APIENTRY
MprAdminAcceptReauthentication(_In_ RAS_CONNECTION_0 *pRasConnection0,
                               _In_ RAS_CONNECTION_1 *pRasConnection1,
                               _In_ RAS_CONNECTION_2 *pRasConnection2,
                               _In_ RAS_CONNECTION_3 *pRasConnection3);
#endif /* WINVER >= 0x0600 */

BOOL APIENTRY MprAdminAcceptNewLink(_In_ RAS_PORT_0 *pRasPort0,
                                    _In_ RAS_PORT_1 *pRasPort1);

VOID APIENTRY
MprAdminConnectionHangupNotification(_In_ RAS_CONNECTION_0 *pRasConnection0,
                                     _In_ RAS_CONNECTION_1 *pRasConnection1);

#if (WINVER >= 0x0500)

VOID APIENTRY
MprAdminConnectionHangupNotification2(_In_ RAS_CONNECTION_0 *pRasConnection0,
                                      _In_ RAS_CONNECTION_1 *pRasConnection1,
                                      _In_ RAS_CONNECTION_2 *pRasConnection2);
...
VOID APIENTRY
MprAdminConnectionHangupNotification3(_In_ RAS_CONNECTION_0 *pRasConnection0,
                                      _In_ RAS_CONNECTION_1 *pRasConnection1,
                                      _In_ RAS_CONNECTION_2 *pRasConnection2,
                                      _In_ RAS_CONNECTION_3 *pRasConnection3);
...
DWORD APIENTRY MprAdminConnectionRemoveQuarantine(_In_ HANDLE hRasServer,
                                                  _In_ HANDLE hRasConnection,
                                                  _In_ BOOL fIsIpAddress);

#endif

VOID APIENTRY MprAdminLinkHangupNotification(_In_ RAS_PORT_0 *pRasPort0,
                                             _In_ RAS_PORT_1 *pRasPort1);

DWORD APIENTRY MprAdminGetIpAddressForUser(_In_ WCHAR *lpwszUserName,
                                           _In_ WCHAR *lpwszPortName,
                                           _Inout_ DWORD *lpdwIpAddress,
                                           _Out_ BOOL *bNotifyRelease);

VOID APIENTRY MprAdminReleaseIpAddress(_In_ WCHAR *lpszUserName,
...
DWORD APIENTRY MprAdminGetIpv6AddressForUser(
    _In_ WCHAR *lpwszUserName, _In_ WCHAR *lpwszPortName,
    _Inout_ IN6_ADDR
        *lpdwIpv6Address, /* Currently Only 64 Bit Identifier is supported */
    _Out_ BOOL *bNotifyRelease);

VOID MprAdminReleaseIpv6AddressForUser(_In_ WCHAR *lpszUserName,
                                       _In_ WCHAR *lpszPortName,
...
DWORD APIENTRY MprAdminUserGetInfo(
    _In_ LPCWSTR lpszServer, _In_ LPCWSTR lpszUser, _In_ DWORD dwLevel,
    _Out_writes_bytes_(dwLevel == 1 ? sizeof(RAS_USER_1) : sizeof(RAS_USER_0))
        LPBYTE lpbBuffer);

DWORD APIENTRY MprAdminUserSetInfo(
    _In_ LPCWSTR lpszServer, _In_ LPCWSTR lpszUser, _In_ DWORD dwLevel,
    _In_reads_bytes_(dwLevel == 1 ? sizeof(RAS_USER_1) : sizeof(RAS_USER_0))
        const LPBYTE lpbBuffer);

#if (WINVER >= 0x0500)

DWORD APIENTRY MprAdminSendUserMessage(_In_ MPR_SERVER_HANDLE hMprServer,
                                       _In_ HANDLE hConnection,
                                       _In_ LPWSTR lpwszMessage);

#endif /* WINVER >= 0x0500 */

DWORD APIENTRY MprAdminGetPDCServer(_In_ LPCWSTR lpszDomain,
                                    _In_ LPCWSTR lpszServer,
                                    _Out_writes_(UNCLEN + 1)
...
BOOL APIENTRY MprAdminIsServiceRunning(_In_ LPWSTR lpwsServerName);

DWORD APIENTRY MprAdminServerConnect(_In_opt_ LPWSTR lpwsServerName,
                                     _Out_ MPR_SERVER_HANDLE *phMprServer);

VOID APIENTRY MprAdminServerDisconnect(_In_ MPR_SERVER_HANDLE hMprServer);

#if (WINVER >= 0x501)
DWORD APIENTRY MprAdminServerGetCredentials(_In_ MPR_SERVER_HANDLE hMprServer,
                                            _In_ DWORD dwLevel,
                                            _In_ LPBYTE *lplpbBuffer);

DWORD APIENTRY MprAdminServerSetCredentials(_In_ MPR_SERVER_HANDLE hMprServer,
                                            _In_ DWORD dwLevel,
                                            _In_ LPBYTE lpbBuffer);

#endif

DWORD APIENTRY MprAdminBufferFree(_In_ LPVOID pBuffer);

DWORD APIENTRY MprAdminGetErrorString(_In_ DWORD dwError,
                                      _Out_ LPWSTR *lplpwsErrorString);

DWORD APIENTRY MprAdminServerGetInfo(_In_ MPR_SERVER_HANDLE hMprServer,
                                     _In_ DWORD dwLevel,
                                     _Out_ LPBYTE *lplpbBuffer);

#if (WINVER >= 0x501)
DWORD APIENTRY MprAdminServerSetInfo(
    _In_ MPR_SERVER_HANDLE hMprServer, _In_ DWORD dwLevel,
    _In_reads_bytes_(dwLevel == 1 ? sizeof(MPR_SERVER_1) : sizeof(MPR_SERVER_2))
        LPBYTE lpbBuffer);

DWORD APIENTRY MprAdminEstablishDomainRasServer(_In_ LPWSTR pszDomain,
                                                _In_ LPWSTR pszMachine,
                                                _In_ BOOL bEnable);

DWORD APIENTRY MprAdminIsDomainRasServer(_In_ LPWSTR pszDomain,
                                         _In_ LPWSTR pszMachine,
...
DWORD APIENTRY MprAdminTransportCreate(
    _In_ MPR_SERVER_HANDLE hMprServer, _In_ DWORD dwTransportId,
    _In_opt_ LPWSTR lpwsTransportName, _In_ LPBYTE pGlobalInfo,
    _In_ DWORD dwGlobalInfoSize, _In_opt_ LPBYTE pClientInterfaceInfo,
    _In_opt_ DWORD dwClientInterfaceInfoSize, _In_ LPWSTR lpwsDLLPath);

#endif /* WINVER >= 0x0500 */

DWORD APIENTRY MprAdminTransportSetInfo(_In_ MPR_SERVER_HANDLE hMprServer,
...
DWORD APIENTRY MprAdminTransportGetInfo(
    _In_ MPR_SERVER_HANDLE hMprServer, _In_ DWORD dwTransportId,
    _Out_opt_ LPBYTE *ppGlobalInfo, _Out_opt_ LPDWORD lpdwGlobalInfoSize,
    _Out_opt_ LPBYTE *ppClientInterfaceInfo,
    _Out_opt_ LPDWORD lpdwClientInterfaceInfoSize);

#if (WINVER >= 0x0500)

DWORD APIENTRY MprAdminDeviceEnum(_In_ MPR_SERVER_HANDLE hMprServer,
                                  _In_ DWORD dwLevel, _Out_ LPBYTE *lplpbBuffer,
                                  _Out_ LPDWORD lpdwTotalEntries);

#endif /* WINVER >= 0x0500 */

DWORD APIENTRY MprAdminInterfaceGetHandle(_In_ MPR_SERVER_HANDLE hMprServer,
                                          _In_ LPWSTR lpwsInterfaceName,
                                          _Out_ HANDLE *phInterface,
                                          _In_ BOOL fIncludeClientInterfaces);

DWORD APIENTRY MprAdminInterfaceCreate(_In_ MPR_SERVER_HANDLE hMprServer,
                                       _In_ DWORD dwLevel,
                                       _In_ LPBYTE lpbBuffer,
                                       _Out_ HANDLE *phInterface);

DWORD APIENTRY MprAdminInterfaceGetInfo(_In_ MPR_SERVER_HANDLE hMprServer,
                                        _In_ HANDLE hInterface,
                                        _In_ DWORD dwLevel,
                                        _In_ LPBYTE *lplpbBuffer);

DWORD APIENTRY MprAdminInterfaceSetInfo(_In_ MPR_SERVER_HANDLE hMprServer,
                                        _In_ HANDLE hInterface,
                                        _In_ DWORD dwLevel,
                                        _In_ LPBYTE lpbBuffer);

DWORD APIENTRY MprAdminInterfaceDelete(_In_ MPR_SERVER_HANDLE hMprServer,
                                       _In_ HANDLE hInterface);

#if (WINVER >= 0x0500)

DWORD APIENTRY MprAdminInterfaceDeviceGetInfo(_In_ MPR_SERVER_HANDLE hMprServer,
                                              _In_ HANDLE hInterface,
                                              _In_ DWORD dwIndex,
                                              _In_ DWORD dwLevel,
...
DWORD APIENTRY MprAdminInterfaceDeviceSetInfo(
    _In_ MPR_SERVER_HANDLE hMprServer, _In_ HANDLE hInterface,
    _In_ DWORD dwIndex, _In_ DWORD dwLevel,
    _In_reads_bytes_(dwLevel == 1 ? sizeof(MPR_DEVICE_1) : sizeof(MPR_DEVICE_0))
        LPBYTE lpbBuffer);

#endif /* WINVER >= 0x0500 */

DWORD
APIENTRY MprAdminInterfaceTransportRemove(_In_ MPR_SERVER_HANDLE hMprServer,
                                          _In_ HANDLE hInterface,
                                          _In_ DWORD dwTransportId);

DWORD APIENTRY MprAdminInterfaceTransportAdd(_In_ MPR_SERVER_HANDLE hMprServer,
                                             _In_ HANDLE hInterface,
                                             _In_ DWORD dwTransportId,
...
DWORD APIENTRY MprAdminInterfaceTransportGetInfo(
    _In_ MPR_SERVER_HANDLE hMprServer, _In_ HANDLE hInterface,
    _In_ DWORD dwTransportId, _Out_ LPBYTE *ppInterfaceInfo,
    _Out_opt_ LPDWORD lpdwInterfaceInfoSize);

DWORD APIENTRY MprAdminInterfaceTransportSetInfo(
    _In_ MPR_SERVER_HANDLE hMprServer, _In_ HANDLE hInterface,
    _In_ DWORD dwTransportId, _In_ LPBYTE pInterfaceInfo,
    _In_ DWORD dwInterfaceInfoSize);

DWORD APIENTRY MprAdminInterfaceEnum(
    _In_ MPR_SERVER_HANDLE hMprServer, _In_ DWORD dwLevel,
    _Outptr_result_bytebuffer_(
        dwLevel == 1 ? (sizeof(MPR_INTERFACE_1) * (*lpdwEntriesRead))
                     : (sizeof(MPR_INTERFACE_0) * (*lpdwEntriesRead)))
        LPBYTE *lplpbBuffer,
    _In_ DWORD dwPrefMaxLen, _Out_ LPDWORD lpdwEntriesRead,
    _Out_ LPDWORD lpdwTotalEntries, _In_opt_ LPDWORD lpdwResumeHandle);

DWORD APIENTRY MprSetupIpInIpInterfaceFriendlyNameEnum(
    _In_ PWCHAR pwszMachineName, _Out_ LPBYTE *lplpBuffer,
    _Out_ LPDWORD lpdwEntriesRead);

DWORD APIENTRY MprSetupIpInIpInterfaceFriendlyNameFree(_In_ LPVOID lpBuffer);

DWORD APIENTRY MprSetupIpInIpInterfaceFriendlyNameCreate(
    _In_ PWCHAR pwszMachineName, _In_ PMPR_IPINIP_INTERFACE_0 pNameInformation);

DWORD APIENTRY MprSetupIpInIpInterfaceFriendlyNameDelete(
    _In_ PWCHAR pwszMachineName, _In_ GUID *pGuid);

DWORD APIENTRY MprAdminInterfaceSetCredentials(_In_opt_ LPWSTR lpwsServer,
                                               _In_ LPWSTR lpwsInterfaceName,
...
DWORD APIENTRY MprAdminInterfaceGetCredentials(
    _In_opt_ LPWSTR lpwsServer, _In_ LPWSTR lpwsInterfaceName,
...
DWORD APIENTRY MprAdminInterfaceSetCredentialsEx(
    _In_ MPR_SERVER_HANDLE hMprServer, _In_ HANDLE hInterface,
    _In_ DWORD dwLevel, _In_ LPBYTE lpbBuffer);
...
DWORD APIENTRY MprAdminInterfaceConnect(_In_ MPR_SERVER_HANDLE hMprServer,
                                        _In_ HANDLE hInterface,
                                        _In_ HANDLE hEvent,
                                        _In_ BOOL fSynchronous);

DWORD APIENTRY MprAdminInterfaceDisconnect(_In_ MPR_SERVER_HANDLE hMprServer,
                                           _In_ HANDLE hInterface);

DWORD APIENTRY MprAdminInterfaceUpdateRoutes(_In_ MPR_SERVER_HANDLE hMprServer,
                                             _In_ HANDLE hInterface,
...
DWORD APIENTRY MprAdminInterfaceQueryUpdateResult(
    _In_ MPR_SERVER_HANDLE hMprServer, _In_ HANDLE hInterface,
    _In_ DWORD dwProtocolId, _Out_ LPDWORD lpdwUpdateResult);
...
DWORD APIENTRY MprAdminRegisterConnectionNotification(
    _In_ MPR_SERVER_HANDLE hMprServer, _In_ HANDLE hEventNotification);
...
DWORD APIENTRY MprAdminMIBServerConnect(_In_opt_ LPWSTR lpwsServerName,
                                        _Out_ MIB_SERVER_HANDLE *phMibServer);

VOID APIENTRY MprAdminMIBServerDisconnect(_In_ MIB_SERVER_HANDLE hMibServer);

DWORD APIENTRY MprAdminMIBEntryCreate(_In_ MIB_SERVER_HANDLE hMibServer,
                                      _In_ DWORD dwPid, _In_ DWORD dwRoutingPid,
                                      _In_ LPVOID lpEntry,
                                      _In_ DWORD dwEntrySize);

DWORD APIENTRY MprAdminMIBEntryDelete(_In_ MIB_SERVER_HANDLE hMibServer,
                                      _In_ DWORD dwProtocolId,
                                      _In_ DWORD dwRoutingPid,
                                      _In_ LPVOID lpEntry,
                                      _In_ DWORD dwEntrySize);

DWORD APIENTRY MprAdminMIBEntrySet(_In_ MIB_SERVER_HANDLE hMibServer,
                                   _In_ DWORD dwProtocolId,
                                   _In_ DWORD dwRoutingPid, _In_ LPVOID lpEntry,
                                   _In_ DWORD dwEntrySize);

DWORD APIENTRY MprAdminMIBEntryGet(
    _In_ MIB_SERVER_HANDLE hMibServer, _In_ DWORD dwProtocolId,
    _In_ DWORD dwRoutingPid, _In_ LPVOID lpInEntry, _In_ DWORD dwInEntrySize,
    _Out_ LPVOID *lplpOutEntry, _Out_ LPDWORD lpOutEntrySize);
...
DWORD APIENTRY MprAdminMIBGetTrapInfo(
    _In_ MIB_SERVER_HANDLE hMibServer, _In_ DWORD dwProtocolId,
    _In_ DWORD dwRoutingPid, _In_ LPVOID lpInData, _In_ DWORD dwInDataSize,
    _Out_ LPVOID *lplpOutData, _Inout_ LPDWORD lpOutDataSize);

DWORD APIENTRY MprAdminMIBSetTrapInfo(_In_ DWORD dwProtocolId,
                                      _In_ DWORD dwRoutingPid,
                                      _In_ HANDLE hEvent, _In_ LPVOID lpInData,
                                      _In_ DWORD dwInDataSize,
                                      _Out_ LPVOID *lplpOutData,
                                      _Inout_ LPDWORD lpOutDataSize);

DWORD APIENTRY MprAdminMIBBufferFree(_In_ LPVOID pBuffer);

//
// Configuration APIs
//

DWORD APIENTRY MprConfigServerInstall(_In_ DWORD dwLevel, _In_ PVOID pBuffer);

DWORD APIENTRY MprConfigServerConnect(_In_opt_ LPWSTR lpwsServerName,
                                      _Out_ HANDLE *phMprConfig);

VOID APIENTRY MprConfigServerDisconnect(_In_ HANDLE hMprConfig);

DWORD APIENTRY MprConfigServerRefresh(_In_ HANDLE hMprConfig);

DWORD APIENTRY MprConfigBufferFree(_In_ LPVOID pBuffer);

DWORD APIENTRY MprConfigServerGetInfo(_In_ HANDLE hMprConfig,
                                      _In_ DWORD dwLevel,
                                      _Out_ LPBYTE *lplpbBuffer);
...
DWORD APIENTRY MprConfigServerBackup(_In_ HANDLE hMprConfig,
                                     _In_ LPWSTR lpwsPath);

DWORD APIENTRY MprConfigServerRestore(_In_ HANDLE hMprConfig,
                                      _In_ IN LPWSTR lpwsPath);

DWORD APIENTRY MprConfigTransportCreate(
    _In_ HANDLE hMprConfig, _In_ DWORD dwTransportId,
    ...
    _In_opt_ DWORD dwClientInterfaceInfoSize, _In_opt_ LPWSTR lpwsDLLPath,
    _Out_ HANDLE *phRouterTransport);

DWORD APIENTRY MprConfigTransportDelete(_In_ HANDLE hMprConfig,
                                        _In_ HANDLE hRouterTransport);

DWORD APIENTRY MprConfigTransportGetHandle(_In_ HANDLE hMprConfig,
                                           _In_ DWORD dwTransportId,
                                           _Out_ HANDLE *phRouterTransport);

DWORD APIENTRY MprConfigTransportSetInfo(
    _In_ HANDLE hMprConfig, _In_ HANDLE hRouterTransport,
...
DWORD APIENTRY MprConfigTransportGetInfo(
    _In_ HANDLE hMprConfig, _In_ HANDLE hRouterTransport,
    _Inout_opt_ LPBYTE *ppGlobalInfo, _Out_opt_ LPDWORD lpdwGlobalInfoSize,
    _Inout_opt_ LPBYTE *ppClientInterfaceInfo,
    _Out_opt_ LPDWORD lpdwClientInterfaceInfoSize,
    _Outptr_opt_ _Inout_ LPWSTR *lplpwsDLLPath);

DWORD APIENTRY MprConfigTransportEnum(
    _In_ HANDLE hMprConfig, _In_ DWORD dwLevel,
    _Outptr_result_bytebuffer_maybenull_((*lpdwEntriesRead) *
                                         sizeof(MPR_TRANSPORT_0))
        LPBYTE *lplpBuffer,
    _In_ DWORD dwPrefMaxLen, _Out_ LPDWORD lpdwEntriesRead,
    _Out_ LPDWORD lpdwTotalEntries, _Inout_opt_ LPDWORD lpdwResumeHandle);

DWORD APIENTRY MprConfigInterfaceCreate(
    _In_ HANDLE hMprConfig, _In_ DWORD dwLevel,
    _In_reads_bytes_(dwLevel == 1 ? sizeof(MPR_INTERFACE_1)
                                  : sizeof(MPR_INTERFACE_0)) LPBYTE lpbBuffer,
    _Out_ HANDLE *phRouterInterface);

DWORD APIENTRY MprConfigInterfaceDelete(_In_ HANDLE hMprConfig,
                                        _In_ HANDLE hRouterInterface);

DWORD APIENTRY MprConfigInterfaceGetHandle(_In_ HANDLE hMprConfig,
                                           _In_ LPWSTR lpwsInterfaceName,
                                           _Out_ HANDLE *phRouterInterface);

DWORD APIENTRY MprConfigInterfaceGetInfo(_In_ HANDLE hMprConfig,
                                         _In_ HANDLE hRouterInterface,
                                         _In_ DWORD dwLevel,
...
DWORD APIENTRY MprConfigInterfaceSetInfo(
    _In_ HANDLE hMprConfig, _In_ HANDLE hRouterInterface, _In_ DWORD dwLevel,
    _In_reads_bytes_(dwLevel == 1 ? sizeof(MPR_INTERFACE_1)
                                  : sizeof(MPR_INTERFACE_0)) LPBYTE lpbBuffer);
...
DWORD APIENTRY MprConfigInterfaceTransportAdd(
    _In_ HANDLE hMprConfig, _In_ HANDLE hRouterInterface,
    _In_ DWORD dwTransportId, _In_opt_ LPWSTR lpwsTransportName,
    _In_reads_bytes_(dwInterfaceInfoSize) LPBYTE pInterfaceInfo,
    _In_ DWORD dwInterfaceInfoSize, _Out_ HANDLE *phRouterIfTransport);
...
DWORD APIENTRY MprConfigInterfaceTransportGetHandle(
    _In_ HANDLE hMprConfig, _In_ HANDLE hRouterInterface,
    _In_ DWORD dwTransportId, _Out_ HANDLE *phRouterIfTransport);

DWORD APIENTRY MprConfigInterfaceTransportGetInfo(
    _In_ HANDLE hMprConfig, _In_ HANDLE hRouterInterface,
    _In_ HANDLE hRouterIfTransport,
    _Outptr_opt_result_bytebuffer_(*lpdwInterfaceInfoSize)
...
DWORD APIENTRY MprConfigInterfaceTransportEnum(
    _In_ HANDLE hMprConfig, _In_ HANDLE hRouterInterface, _In_ DWORD dwLevel,
    _Outptr_result_bytebuffer_maybenull_((*lpdwEntriesRead) *
                                         sizeof(MPR_IFTRANSPORT_0))
        LPBYTE *lplpBuffer, // MPR_IFTRANSPORT_0
    _In_ DWORD dwPrefMaxLen, _Out_ LPDWORD lpdwEntriesRead,
    _Out_ LPDWORD lpdwTotalEntries, _Inout_opt_ LPDWORD lpdwResumeHandle);

DWORD APIENTRY MprConfigGetFriendlyName(_In_ HANDLE hMprConfig,
                                        _In_ PWSTR pszGuidName,
                                        _Out_writes_bytes_(dwBufferSize)
                                            PWCHAR pszBuffer,
                                        _In_ DWORD dwBufferSize);

DWORD APIENTRY MprConfigGetGuidName(_In_ HANDLE hMprConfig,
...
DWORD APIENTRY MprConfigFilterGetInfo(
    _In_ HANDLE hMprConfig, _In_ DWORD dwLevel, _In_ DWORD dwTransportId,
    _Inout_updates_bytes_(sizeof(MPR_FILTER_0)) LPBYTE lpBuffer);

DWORD APIENTRY MprConfigFilterSetInfo(_In_ HANDLE hMprConfig,
                                      _In_ DWORD dwLevel,
                                      _In_ DWORD dwTransportId,
...
DWORD APIENTRY MprInfoCreate(_In_ DWORD dwVersion, _Out_ LPVOID *lplpNewHeader);

DWORD APIENTRY MprInfoDelete(_In_ LPVOID lpHeader);

DWORD APIENTRY MprInfoRemoveAll(_In_ LPVOID lpHeader,
                                _Out_ LPVOID *lplpNewHeader);

DWORD APIENTRY MprInfoDuplicate(_In_ LPVOID lpHeader,
                                _Out_ LPVOID *lplpNewHeader);

DWORD APIENTRY MprInfoBlockAdd(_In_ LPVOID lpHeader, _In_ DWORD dwInfoType,
                               _In_ DWORD dwItemSize, _In_ DWORD dwItemCount,
                               _In_reads_bytes_(dwItemSize *dwItemCount)
                                   LPBYTE lpItemData,
                               _Out_ LPVOID *lplpNewHeader);

DWORD APIENTRY MprInfoBlockRemove(_In_ LPVOID lpHeader, _In_ DWORD dwInfoType,
                                  _Out_ LPVOID *lplpNewHeader);

DWORD APIENTRY MprInfoBlockSet(_In_ LPVOID lpHeader, _In_ DWORD dwInfoType,
                               _In_ DWORD dwItemSize, _In_ DWORD dwItemCount,
                               _In_reads_bytes_(dwItemSize *dwItemCount)
                                   LPBYTE lpItemData,
                               _Out_ LPVOID *lplpNewHeader);

DWORD APIENTRY MprInfoBlockFind(_In_ LPVOID lpHeader, _In_ DWORD dwInfoType,
                                _Out_ LPDWORD lpdwItemSize,  // OPTIONAL
                                _Out_ LPDWORD lpdwItemCount, // OPTIONAL
                                _Outptr_result_bytebuffer_((*lpdwItemSize) *
                                                           (*lpdwItemCount))
                                    LPBYTE *lplpItemData // OPTIONAL
);

DWORD APIENTRY MprInfoBlockQuerySize(_In_ LPVOID lpHeader);
