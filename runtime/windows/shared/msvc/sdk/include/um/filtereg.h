...
public:
  virtual HRESULT STDMETHODCALLTYPE LoadIFilter(
      ...
      /* [length_is][length_is][size_is][size_is][unique][out][in] */
      __RPC__deref_opt_inout_ecount_part_opt(
          (*SearchDecSize + 1), (*SearchDecSize + 1)) WCHAR **pwcsSearchDesc,
...
typedef struct ILoadFilterVtbl {
  ...
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in ILoadFilter *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in ILoadFilter *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in ILoadFilter *This);
  ...
  HRESULT(STDMETHODCALLTYPE *LoadIFilter)(
      ...
      /* [unique][out][in] */ __RPC__inout_opt int *SearchDecSize,
      /* [length_is][length_is][size_is][size_is][unique][out][in] */
      __RPC__deref_opt_inout_ecount_part_opt((*SearchDecSize + 1),
                                             (*SearchDecSize + 1))
...
interface ILoadFilter { CONST_VTBL struct ILoadFilterVtbl *lpVtbl; };
...
#define ILoadFilter_LoadIFilter(This, pwcsPath, pFilteredSources, pUnkOuter,   \
                                fUseDefault, pFilterClsid, SearchDecSize,      \
                                pwcsSearchDesc, ppIFilt)                       \
  ((This)->lpVtbl->LoadIFilter(This, pwcsPath, pFilteredSources, pUnkOuter,    \
                               fUseDefault, pFilterClsid, SearchDecSize,       \
                               pwcsSearchDesc, ppIFilt))

#define ILoadFilter_LoadIFilterFromStorage(                                    \
    This, pStg, pUnkOuter, pwcsOverride, fUseDefault, pFilterClsid,            \
    SearchDecSize, pwcsSearchDesc, ppIFilt)                                    \
  ((This)->lpVtbl->LoadIFilterFromStorage(                                     \
      This, pStg, pUnkOuter, pwcsOverride, fUseDefault, pFilterClsid,          \
      SearchDecSize, pwcsSearchDesc, ppIFilt))

#define ILoadFilter_LoadIFilterFromStream(                                     \
    This, pStm, pFilteredSources, pUnkOuter, fUseDefault, pFilterClsid,        \
    SearchDecSize, pwcsSearchDesc, ppIFilt)                                    \
  ((This)->lpVtbl->LoadIFilterFromStream(                                      \
      This, pStm, pFilteredSources, pUnkOuter, fUseDefault, pFilterClsid,      \
      SearchDecSize, pwcsSearchDesc, ppIFilt))
...
public:
  virtual HRESULT STDMETHODCALLTYPE LoadIFilterWithPrivateComActivation(
      ...
      /* [unique][out][in] */ __RPC__deref_opt_inout_opt IFilter *
          *filterObj) = 0;
};
...
typedef struct ILoadFilterWithPrivateComActivationVtbl {
  ...
  DECLSPEC_XFGVIRT(ILoadFilterWithPrivateComActivation,
...
#define ILoadFilterWithPrivateComActivation_QueryInterface(This, riid,         \
                                                           ppvObject)          \
  ((This)->lpVtbl->QueryInterface(This, riid, ppvObject))
...
#define ILoadFilterWithPrivateComActivation_LoadIFilter(                       \
    This, pwcsPath, pFilteredSources, pUnkOuter, fUseDefault, pFilterClsid,    \
    SearchDecSize, pwcsSearchDesc, ppIFilt)                                    \
  ((This)->lpVtbl->LoadIFilter(This, pwcsPath, pFilteredSources, pUnkOuter,    \
                               fUseDefault, pFilterClsid, SearchDecSize,       \
                               pwcsSearchDesc, ppIFilt))

#define ILoadFilterWithPrivateComActivation_LoadIFilterFromStorage(            \
    This, pStg, pUnkOuter, pwcsOverride, fUseDefault, pFilterClsid,            \
    SearchDecSize, pwcsSearchDesc, ppIFilt)                                    \
  ((This)->lpVtbl->LoadIFilterFromStorage(                                     \
      This, pStg, pUnkOuter, pwcsOverride, fUseDefault, pFilterClsid,          \
...
#define ILoadFilterWithPrivateComActivation_LoadIFilterFromStream(             \
    This, pStm, pFilteredSources, pUnkOuter, fUseDefault, pFilterClsid,        \
    SearchDecSize, pwcsSearchDesc, ppIFilt)                                    \
  ((This)->lpVtbl->LoadIFilterFromStream(                                      \
      This, pStm, pFilteredSources, pUnkOuter, fUseDefault, pFilterClsid,      \
...
#define ILoadFilterWithPrivateComActivation_LoadIFilterWithPrivateComActivation( \
    This, filteredSources, useDefault, filterClsid,                              \
    isFilterPrivateComActivated, filterObj)                                      \
  ((This)->lpVtbl->LoadIFilterWithPrivateComActivation(                          \
      This, filteredSources, useDefault, filterClsid,                            \
      isFilterPrivateComActivated, filterObj))
