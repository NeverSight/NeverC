...
typedef /* [public][public][public][public] */
    struct __MIDL_ItsPubPlugin2_0001 {
  WCHAR extName[256];
...
public:
  ...
  virtual HRESULT STDMETHODCALLTYPE GetResource2(
      /* [in] */ __RPC__in LPCWSTR alias, LONG flags,
  ...
  virtual HRESULT STDMETHODCALLTYPE ResolvePersonalDesktop(
      ...
      /* [string][out] */
      __RPC__out_ecount_full_string(256) wchar_t endPointName[256]) = 0;
...
typedef struct ItsPubPlugin2Vtbl {
  ...
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in ItsPubPlugin2 *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in ItsPubPlugin2 *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in ItsPubPlugin2 *This);
...
interface ItsPubPlugin2 { CONST_VTBL struct ItsPubPlugin2Vtbl *lpVtbl; };
...
#define ItsPubPlugin2_AddRef(This) ((This)->lpVtbl->AddRef(This))

#define ItsPubPlugin2_Release(This) ((This)->lpVtbl->Release(This))

#define ItsPubPlugin2_GetResourceList(This, userID, pceAppListSize,            \
                                      resourceList)                            \
...
#define ItsPubPlugin2_ResolveResource(This, resourceType, resourceLocation,    \
                                      endPointName, userID, alias)             \
  ((This)->lpVtbl->ResolveResource(This, resourceType, resourceLocation,       \
                                   endPointName, userID, alias))

#define ItsPubPlugin2_GetResource2List(This, userID, pceAppListSize,           \
                                       resourceList)                           \
...
#define ItsPubPlugin2_ResolvePersonalDesktop(                                  \
    This, userId, poolId, ePdResolutionType, pPdAssignmentType, endPointName)  \
  ((This)->lpVtbl->ResolvePersonalDesktop(This, userId, poolId,                \
                                          ePdResolutionType,                   \
                                          pPdAssignmentType, endPointName))

#define ItsPubPlugin2_DeletePersonalDesktopAssignment(This, userId, poolId,    \
                                                      endpointName)            \
  ((This)->lpVtbl->DeletePersonalDesktopAssignment(This, userId, poolId,       \
                                                   endpointName))
