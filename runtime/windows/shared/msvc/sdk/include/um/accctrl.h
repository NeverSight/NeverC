...
// this document.  See section 3.1, Object Types for a detailed definition of
// the supported object types, and their name formats.
//
...
// particular trustee.
// TRUSTEE_IS_SID       The trustee is identified with a SID rather than with a
// name. TRUSTEE_IS_NAME      The trustee is identified with a name.
//
...
// If the trustee is a multiple trustee, this enumerated type specifies the
// type. TRUSTEE_IS_IMPERSONATE       The trustee is an impersonate trustee and
// the multiple
//                          trustee field in the trustee points to another
//                          trustee that is a trustee for the server that will
//                          be doing the impersonation.
//
...
#else
  // This member is not null-terminated as it may be used to hold strings, which
  // are null-terminated or SIDs, which are not null-terminated.
  LPCH ptstrName;
#endif
...
#else
  // This member is not null-terminated as it may be used to hold strings, which
  // are null-terminated or SID, which are not null-terminated.
  LPWCH ptstrName;
#endif
...
//  control entries.  On output this field will be either SET_ACCESS,
//  DENY_ACCESS,
...
// SET_AUDIT_FAILURE - The trustee will be audited for failed opens of the
// object
...
// SUB_CONTAINERS_ONLY_INHERIT  The specific access permissions will be
// inherited
//                              and applied to sub containers created within the
//                              container, and will be applied to the container
//                              itself.
// SUB_OBJECTS_ONLY_INHERIT     The specific access permissions will only be
// inherited
//                              by objects created within the specific
//                              container. The access permissions will not be
//                              applied to the container itself.
// SUB_CONTAINERS_AND_OBJECTS_INHERIT   The specific access permissions will be
//                                      inherited by containers created within
//                                      the specific container, will be applied
//                                      to objects created within the container,
//                                      but will not be applied to the container
//                                      itself.
//
