...
typedef HRESULT(WINAPI *LPProviderInstanceCallback)(Provider *pProvider,
                                                    CInstance *pInstance,
...
// idea is that there is one MethodContext for each request from CIMOM or
// another provider pointers are passed around.
//////////////////////////////////////////////////////
...
class __declspec(uuid("9113D3B4-D114-11d2-B35D-00104BC97924"))
...
public:
  ExternalMethodContext(IWbemObjectSink __RPC_FAR *pResponseHandler,
                        ...
                        CWbemProviderGlue *pGlue, void *pReserved = NULL);
...
class __declspec(uuid("6AF4B074-D121-11d2-B35D-00104BC97924"))
...
class __declspec(uuid("D98A82E8-D121-11d2-B35D-00104BC97924"))
InternalMethodContextAsynch : public MethodContext {
public:
  InternalMethodContextAsynch(Provider *pThat,
                              LPProviderInstanceCallback pCallback,
                              IWbemContext __RPC_FAR *pContext,
                              MethodContext *pUsersContext, void *pUserData);
