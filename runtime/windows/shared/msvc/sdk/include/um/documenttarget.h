...
typedef struct IPrintDocumentPackageTargetVtbl {
  ...
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IPrintDocumentPackageTarget *This);
...
#define IPrintDocumentPackageTarget2_AddRef(This) ((This)->lpVtbl->AddRef(This))
...
#define IPrintDocumentPackageTarget2_GetTargetIppPrintDevice(This, riid,       \
                                                             ppvTarget)        \
...
public:
  ...
  CreateDocumentPackageTargetForPrintJob(
      ...
      /* [out] */ __RPC__deref_out_opt IPrintDocumentPackageTarget *
          *docPackageTarget) = 0;
};
...
typedef struct IPrintDocumentPackageTargetFactoryVtbl {
  ...
  DECLSPEC_XFGVIRT(IPrintDocumentPackageTargetFactory,
                   CreateDocumentPackageTargetForPrintJob)
  /* [helpstring] */ HRESULT(
      STDMETHODCALLTYPE *CreateDocumentPackageTargetForPrintJob)(
      __RPC__in IPrintDocumentPackageTargetFactory *This,
      /* [string][in] */ __RPC__in_string LPCWSTR printerName,
      /* [string][in] */ __RPC__in_string LPCWSTR jobName,
      /* [in] */ __RPC__in_opt IStream *jobOutputStream,
...
DEFINE_GUID(ID_DOCUMENTPACKAGETARGET_OPENXPS_WITH_3D, 0x63dbd720, 0x8b14,
            0x4577, 0xb0, 0x74, 0x7b, 0xb1, 0x1b, 0x59, 0x6d, 0x28);
