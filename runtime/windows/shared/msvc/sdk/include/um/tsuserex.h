...
class DECLSPEC_UUID("0910dd01-df8c-11d1-ae27-00c04fa35813") TSUserExInterfaces;
#endif
...
typedef struct IADsTSUserExVtbl {
  ...
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in IADsTSUserEx *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IADsTSUserEx *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IADsTSUserEx *This);
  ...
  /* [id][propget] */ HRESULT(
      STDMETHODCALLTYPE *get_ConnectClientDrivesAtLogon)(
      __RPC__in IADsTSUserEx *This,
      /* [retval][out] */ __RPC__out LONG *pNewVal);

  DECLSPEC_XFGVIRT(IADsTSUserEx, put_ConnectClientDrivesAtLogon)
  /* [id][propput] */ HRESULT(
      STDMETHODCALLTYPE *put_ConnectClientDrivesAtLogon)(
      __RPC__in IADsTSUserEx *This,
      /* [in] */ LONG NewVal);

  DECLSPEC_XFGVIRT(IADsTSUserEx, get_ConnectClientPrintersAtLogon)
  /* [id][propget] */ HRESULT(
      STDMETHODCALLTYPE *get_ConnectClientPrintersAtLogon)(
      __RPC__in IADsTSUserEx *This,
      /* [retval][out] */ __RPC__out LONG *pVal);

  DECLSPEC_XFGVIRT(IADsTSUserEx, put_ConnectClientPrintersAtLogon)
  /* [id][propput] */ HRESULT(
      STDMETHODCALLTYPE *put_ConnectClientPrintersAtLogon)(
      __RPC__in IADsTSUserEx *This,
      /* [in] */ LONG NewVal);
  ...
  /* [id][propget] */ HRESULT(
      STDMETHODCALLTYPE *get_TerminalServicesWorkDirectory)(
      __RPC__in IADsTSUserEx *This,
      /* [retval][out] */ __RPC__deref_out_opt BSTR *pVal);

  DECLSPEC_XFGVIRT(IADsTSUserEx, put_TerminalServicesWorkDirectory)
  /* [id][propput] */ HRESULT(
      STDMETHODCALLTYPE *put_TerminalServicesWorkDirectory)(
      __RPC__in IADsTSUserEx *This,
      /* [in] */ __RPC__in BSTR pNewVal);

  DECLSPEC_XFGVIRT(IADsTSUserEx, get_TerminalServicesInitialProgram)
  /* [id][propget] */ HRESULT(
      STDMETHODCALLTYPE *get_TerminalServicesInitialProgram)(
      __RPC__in IADsTSUserEx *This,
      /* [retval][out] */ __RPC__deref_out_opt BSTR *pVal);

  DECLSPEC_XFGVIRT(IADsTSUserEx, put_TerminalServicesInitialProgram)
  /* [id][propput] */ HRESULT(
      STDMETHODCALLTYPE *put_TerminalServicesInitialProgram)(
      __RPC__in IADsTSUserEx *This,
      /* [in] */ __RPC__in BSTR pNewVal);
...
interface IADsTSUserEx { CONST_VTBL struct IADsTSUserExVtbl *lpVtbl; };
...
class DECLSPEC_UUID("E2E9CAE6-1E7B-4B8E-BABD-E9BF6292AC29") ADsTSUserEx;
#endif
