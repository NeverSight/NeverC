...
DPAPI_IMP
BOOL WINAPI CryptProtectData(_In_ DATA_BLOB *pDataIn,
...
BOOL WINAPI CryptUnprotectDataNoUI(
    ...
    _In_opt_ CRYPTPROTECT_PROMPTSTRUCT *pPromptStruct, _In_ DWORD dwFlags,
    _In_reads_bytes_opt_(cbOptionalPassword) const BYTE *pbOptionalPassword,
    DWORD cbOptionalPassword, _Out_ DATA_BLOB *pDataOut);
#endif
...
DPAPI_IMP
BOOL WINAPI CryptUpdateProtectedState(_In_opt_ PSID pOldSid,
...
// eg: encrypted buffer passed across LPC to another process which calls
// CryptUnprotectMemory whilst impersonating.
//
