...
**     a function is in-line. For compilers that do not support in-lining,
* define
...
** MI_CallbackMode
**
**     This enumeration defines callback mode  for the CIM extensions for
* WriteError and PromptUser APIs.
**
**==============================================================================
*/
...
#define MI_FLAG_NOT_MODIFIED                                                   \
  (1 << 25) // indicates that the property is not modified
...
struct _MI_FilterFT {
  MI_Result(MI_CALL *Evaluate)(_In_ const MI_Filter *self,
 ...
 * param: on completion, result indicates whether the instance matched the
 * filter.
 *
...
MI_Filter_Evaluate(_In_ const MI_Filter *self, _In_ const MI_Instance *instance,
                   _Out_ MI_Boolean *result) {
  if (self && self->ft) {
 ...
 */
MI_INLINE MI_Result MI_INLINE_CALL
MI_Filter_GetExpression(_In_ const MI_Filter *self,
                        _Outptr_result_maybenull_z_ const MI_Char **queryLang,
                        _Outptr_result_maybenull_z_ const MI_Char **queryExpr) {
  if (self && self->ft) {
...
struct _MI_PropertySetFT {
  MI_Result(MI_CALL *GetElementCount)(_In_ const MI_PropertySet *self,
                                      _Out_ MI_Uint32 *count);

  MI_Result(MI_CALL *ContainsElement)(_In_ const MI_PropertySet *self,
                                      _In_z_ const MI_Char *name,
                                      _Out_ MI_Boolean *flag);

  MI_Result(MI_CALL *AddElement)(_Inout_ MI_PropertySet *self,
                                 _In_z_ const MI_Char *name);

  MI_Result(MI_CALL *GetElementAt)(_In_ const MI_PropertySet *self,
                                   MI_Uint32 index,
  ...
  MI_Result(MI_CALL *Clone)(_In_ const MI_PropertySet *self,
...
MI_INLINE MI_Result MI_INLINE_CALL MI_PropertySet_GetElementCount(
    _In_ const MI_PropertySet *self, _Out_ MI_Uint32 *count) {
  if (self && self->ft) {
...
MI_INLINE MI_Result MI_INLINE_CALL MI_PropertySet_ContainsElement(
    _In_ const MI_PropertySet *self, _In_z_ const MI_Char *name,
    _Out_ MI_Boolean *flag) {
  if (self && self->ft) {
...
MI_INLINE MI_Result MI_INLINE_CALL MI_PropertySet_AddElement(
    _Inout_ MI_PropertySet *self, _In_z_ const MI_Char *name) {
  if (self && self->ft) {
 ...
 */
MI_INLINE MI_Result MI_INLINE_CALL
MI_PropertySet_GetElementAt(_In_ const MI_PropertySet *self, MI_Uint32 index,
                            _Outptr_result_z_ const MI_Char **name) {
  if (self && self->ft) {
 ...
 */
MI_INLINE MI_Result MI_INLINE_CALL
MI_PropertySet_Clear(_Inout_ MI_PropertySet *self) {
  if (self && self->ft) {
 ...
 */
MI_INLINE MI_Result MI_INLINE_CALL
MI_PropertySet_Destruct(_Inout_ MI_PropertySet *self) {
  if (self && self->ft) {
 ...
 */
MI_INLINE MI_Result MI_INLINE_CALL
MI_PropertySet_Delete(_Inout_ MI_PropertySet *self) {
  if (self && self->ft) {
 ...
 * a successful return, new property set points to a newly created property set
 * object. The new property set should eventually be passed to
...
MI_INLINE MI_Result MI_INLINE_CALL MI_PropertySet_Clone(
    _In_ const MI_PropertySet *self, _Outptr_ MI_PropertySet **newPropertySet) {
  if (self && self->ft) {
...
struct _MI_ClassDecl /* extends MI_ObjectDecl */
{
  ...
  /* Owning MI_Class object, if any.  NULL if static classDecl, -1 is from a
   * dynamic instance */
...
typedef void(MI_CALL *MI_MethodDecl_Invoke)(
    _In_opt_ void *self, _In_ MI_Context *context,
    _In_z_ const MI_Char *nameSpace, _In_z_ const MI_Char *className,
    _In_z_ const MI_Char *methodName, _In_ const MI_Instance *instanceName,
 ...
 *
 */
typedef void(MI_CALL *MI_ProviderFT_Load)(_Outptr_ void **self,
 ...
 *
 */
typedef void(MI_CALL *MI_ProviderFT_Unload)(_In_opt_ void *self,
                                            _In_ MI_Context *context);
 ...
 *
 *  If the provider returns MI_RESULT_NOT_SUPPORTED (via MI_Context_PostResult),
 * the server attempts to satisfy the request by calling the provider's
 ...
 *  to MI_Context_PostInstance(). If GetInstance is unsuccessful, the provider
 * should return one of the results listed below (via MI_Context_PostResult).
 *
 *  param: self the provider state data
 *  param: context the request context
...
typedef void(MI_CALL *MI_ProviderFT_EnumerateInstances)(
    _In_opt_ void *self, _In_ MI_Context *context,
    _In_z_ const MI_Char *nameSpace, _In_z_ const MI_Char *className,
    _In_opt_ const MI_PropertySet *propertySet, MI_Boolean keysOnly,
...
typedef void(MI_CALL *MI_ProviderFT_ModifyInstance)(
    void *self, MI_Context *context, _In_z_ const MI_Char *nameSpace,
    _In_z_ const MI_Char *className, const MI_Instance *modifiedInstance,
...
typedef void(MI_CALL *MI_ProviderFT_AssociatorInstances)(
    _In_opt_ void *self, _In_ MI_Context *context,
    _In_z_ const MI_Char *nameSpace, _In_z_ const MI_Char *className,
    _In_ const MI_Instance *instanceName, _In_opt_z_ const MI_Char *resultClass,
    _In_opt_z_ const MI_Char *role, _In_opt_z_ const MI_Char *resultRole,
    _In_opt_ const MI_PropertySet *propertySet, MI_Boolean keysOnly,
    _In_opt_ const MI_Filter *filter);
...
typedef void(MI_CALL *MI_ProviderFT_ReferenceInstances)(
    _In_opt_ void *self, _In_ MI_Context *context,
    _In_z_ const MI_Char *nameSpace, _In_z_ const MI_Char *className,
    _In_ const MI_Instance *instanceName, _In_opt_z_ const MI_Char *role,
    _In_opt_ const MI_PropertySet *propertySet, MI_Boolean keysOnly,
    _In_opt_ const MI_Filter *filter);
...
typedef void(MI_CALL *MI_ProviderFT_EnableIndications)(
    _In_opt_ void *self, _In_ MI_Context *indicationsContext,
    _In_z_ const MI_Char *nameSpace, _In_z_ const MI_Char *className);
 ...
 * should create indication instances and pass them to
 * MI_Context_PostInstance(), with context provided by EnableIndications call.
 * See EnableIndications for details.
 *
 * Subscribe is called between calls to EnableIndications and
 * DisableIndications.
 *
 * param: self the provider state data.
...
typedef void(MI_CALL *MI_ProviderFT_Subscribe)(
    _In_opt_ void *self, _In_ MI_Context *context,
    _In_z_ const MI_Char *nameSpace, _In_z_ const MI_Char *className,
    _In_opt_ const MI_Filter *filter, _In_opt_z_ const MI_Char *bookmark,
...
typedef void(MI_CALL *MI_ProviderFT_Unsubscribe)(
    _In_opt_ void *self, _In_ MI_Context *context,
    _In_z_ const MI_Char *nameSpace, _In_z_ const MI_Char *className,
    MI_Uint64 subscriptionID, _In_opt_ void *subscriptionSelf);
 ...
 *
 */
typedef void(MI_CALL *MI_Module_Load)(_Out_ MI_Module_Self **self,
                                      _In_ MI_Context *context);
 ...
 *
 */
typedef void(MI_CALL *MI_Module_Unload)(_In_opt_ MI_Module_Self *self,
                                        _In_ MI_Context *context);
...
struct _MI_InstanceFT {
  MI_Result(MI_CALL *Clone)(_In_ const MI_Instance *self,
  ...
  MI_Result(MI_CALL *IsA)(_In_ const MI_Instance *self,
  ...
  MI_Result(MI_CALL *SetNameSpace)(_Inout_ MI_Instance *self,
  ...
  MI_Result(MI_CALL *GetElementCount)(_In_ const MI_Instance *self,
                                      _Out_ MI_Uint32 *count);

  MI_Result(MI_CALL *AddElement)(_Inout_ MI_Instance *self,
                                 _In_z_ const MI_Char *name,
                                 _In_opt_ const MI_Value *value, MI_Type type,
                                 MI_Uint32 flags);

  MI_Result(MI_CALL *SetElement)(_Inout_ MI_Instance *self,
                                 _In_z_ const MI_Char *name,
                                 _In_opt_ const MI_Value *value, MI_Type type,
                                 MI_Uint32 flags);

  MI_Result(MI_CALL *SetElementAt)(
      _Inout_ MI_Instance *self, MI_Uint32 index,
      _In_reads_opt_(_Inexpressible_("varies depending on type"))
          const MI_Value *value,
      MI_Type type, MI_Uint32 flags);

  MI_Result(MI_CALL *GetElement)(_In_ const MI_Instance *self,
                                 _In_z_ const MI_Char *name,
  ...
  MI_Result(MI_CALL *GetElementAt)(
      _In_ const MI_Instance *self, MI_Uint32 index,
      _Outptr_result_maybenull_z_ const MI_Char **name,
      _Out_opt_ MI_Value *value, _Out_opt_ MI_Type *type,
      _Out_opt_ MI_Uint32 *flags);

  MI_Result(MI_CALL *ClearElement)(_Inout_ MI_Instance *self,
                                   _In_z_ const MI_Char *name);

  MI_Result(MI_CALL *ClearElementAt)(_Inout_ MI_Instance *self,
                                     MI_Uint32 index);
  ...
  MI_Result(MI_CALL *SetServerName)(_Inout_ MI_Instance *self,
                                    _In_z_ const MI_Char *name);

  MI_Result(MI_CALL *GetClass)(_In_ const MI_Instance *self,
...
struct _MI_InstanceExFT {
  ...
  MI_Result(MI_CALL *Normalize)(_Inout_ MI_Instance **self);
};
 ...
 *
 *      - when provider sends instance to the server (PostResult,
 PostIndication)
...
MI_INLINE MI_Result MI_INLINE_CALL MI_Instance_Clone(
    _In_ const MI_Instance *self, _Outptr_ MI_Instance **newInstance) {
  if (self && self->ft) {
 ...
 */
MI_INLINE MI_Result MI_INLINE_CALL
MI_Instance_Destruct(_Inout_ MI_Instance *self) {
  if (self && self->ft) {
    return self->ft->Destruct(self);
  } else {
    return MI_RESULT_INVALID_PARAMETER;
 ...
 */
MI_INLINE MI_Result MI_INLINE_CALL
MI_Instance_Delete(_Inout_ MI_Instance *self) {
  if (self && self->ft) {
    return self->ft->Delete(self);
  } else {
    return MI_RESULT_INVALID_PARAMETER;
 ...
 */
MI_INLINE MI_Result MI_INLINE_CALL
MI_Instance_IsA(_In_ const MI_Instance *self,
                _In_ const MI_ClassDecl *classDecl, _Out_ MI_Boolean *flag) {
  if (self && self->ft) {
...
MI_INLINE MI_Result MI_INLINE_CALL MI_Instance_SetNameSpace(
    _Inout_ MI_Instance *self, _In_z_ const MI_Char *nameSpace) {
  if (self && self->ft) {
...
MI_INLINE MI_Result MI_INLINE_CALL MI_Instance_GetElementCount(
    _In_ const MI_Instance *self, _Out_ MI_Uint32 *count) {
  if (self && self->ft) {
    return self->ft->GetElementCount(self, count);
  } else {
    return MI_RESULT_INVALID_PARAMETER;
...
MI_INLINE MI_Result MI_INLINE_CALL MI_Instance_AddElement(
    _Inout_ MI_Instance *self, _In_z_ const MI_Char *name,
    _In_opt_ const MI_Value *value, MI_Type type, MI_Uint32 flags) {
  if (self && self->ft) {
 ...
 */
MI_INLINE MI_Result MI_INLINE_CALL
MI_Instance_GetElement(_In_ const MI_Instance *self, _In_z_ const MI_Char *name,
                       _Out_opt_ MI_Value *value, _Out_opt_ MI_Type *type,
                       _Out_opt_ MI_Uint32 *flags, _Out_opt_ MI_Uint32 *index) {
  if (self && self->ft) {
...
MI_INLINE MI_Result MI_INLINE_CALL MI_Instance_GetElementAt(
    _In_ const MI_Instance *self, MI_Uint32 index,
    _Outptr_result_maybenull_z_ const MI_Char **name, _Out_opt_ MI_Value *value,
    _Out_opt_ MI_Type *type, _Out_opt_ MI_Uint32 *flags) {
  if (self && self->ft) {
 ...
 */
MI_INLINE MI_Result MI_INLINE_CALL
MI_Instance_ClearElementAt(_Inout_ MI_Instance *self, MI_Uint32 index) {
  if (self && self->ft) {
 ...
 */
MI_INLINE MI_Result MI_INLINE_CALL
MI_Instance_GetServerName(_In_ const MI_Instance *self,
                          _Outptr_result_maybenull_z_ const MI_Char **name) {
  if (self && self->ft) {
...
MI_INLINE MI_Result MI_INLINE_CALL MI_Instance_GetClass(
    _In_ const MI_Instance *self, _Outptr_ MI_Class **instanceClass) {
  if (self && self->ft) {
...
MI_INLINE MI_Result MI_INLINE_CALL
MI_Instance_Normalize(_Inout_ MI_Instance **self) {
...
struct _MI_ContextFT {
  ...
  */
  ...
  MI_Result(MI_CALL *PostResult)(_In_ MI_Context *context, MI_Result result);

  MI_Result(MI_CALL *PostInstance)(_In_ MI_Context *context,
                                   _In_ const MI_Instance *instance);

  MI_Result(MI_CALL *PostIndication)(_In_ MI_Context *context,
  ...
  */
  ...
  MI_Result(MI_CALL *ConstructInstance)(_In_ MI_Context *context,
                                        _In_ const MI_ClassDecl *classDecl,
                                        _Out_ MI_Instance *instance);

  MI_Result(MI_CALL *ConstructParameters)(_In_ MI_Context *context,
                                          _In_ const MI_MethodDecl *methodDecl,
                                          _Out_ MI_Instance *instance);

  MI_Result(MI_CALL *NewInstance)(_In_ MI_Context *context,
                                  _In_ const MI_ClassDecl *classDecl,
                                  _Outptr_ MI_Instance **instance);

  MI_Result(MI_CALL *NewDynamicInstance)(_In_ MI_Context *context,
                                         _In_ const MI_Char *className,
                                         MI_Uint32 flags,
                                         _Outptr_ MI_Instance **instance);

  MI_Result(MI_CALL *NewParameters)(_In_ MI_Context *context,
                                    _In_ const MI_MethodDecl *methodDecl,
                                    _Outptr_ MI_Instance **instance);
  ...
  */
  ...
  MI_Result(MI_CALL *Canceled)(_In_ const MI_Context *context,
                               _Out_ MI_Boolean *flag);

  MI_Result(MI_CALL *GetLocale)(_In_ const MI_Context *context,
                                MI_LocaleType localeType,
                                _Out_writes_z_(MI_MAX_LOCALE_SIZE)
                                    MI_Char locale[MI_MAX_LOCALE_SIZE]);

  MI_Result(MI_CALL *RegisterCancel)(_In_ MI_Context *context,
  ...
  MI_Result(MI_CALL *GetLocalSession)(_In_ const MI_Context *context,
                                      _Out_ MI_Session *session);

  MI_Result(MI_CALL *SetStringOption)(_In_ MI_Context *context,
                                      _In_z_ const MI_Char *name,
  ...
  MI_Result(MI_CALL *GetStringOption)(_In_ MI_Context *context,
                                      _In_z_ const MI_Char *name,
                                      _Outptr_result_z_ const MI_Char **value);

  MI_Result(MI_CALL *GetNumberOption)(_In_ MI_Context *context,
                                      _In_z_ const MI_Char *name,
                                      _Out_opt_ MI_Uint32 *value);

  MI_Result(MI_CALL *GetCustomOption)(_In_ MI_Context *context,
                                      _In_z_ const MI_Char *name,
                                      _Out_opt_ MI_Type *valueType,
                                      _Out_opt_ MI_Value *value);

  MI_Result(MI_CALL *GetCustomOptionCount)(_In_ MI_Context *context,
                                           _Out_opt_ MI_Uint32 *count);

  MI_Result(MI_CALL *GetCustomOptionAt)(
      _In_ MI_Context *context, _In_ MI_Uint32 index,
      _Outptr_opt_result_maybenull_z_ const MI_Char **name,
      _Out_opt_ MI_Type *valueType, _Out_opt_ MI_Value *value);
  ...
  */
  ...
  MI_Result(MI_CALL *WriteMessage)(_In_ MI_Context *context, MI_Uint32 channel,
                                   _In_z_ const MI_Char *message);

  MI_Result(MI_CALL *WriteProgress)(_In_ MI_Context *context,
  ...
  MI_Result(MI_CALL *WriteStreamParameter)(_In_ MI_Context *context,
                                           _In_z_ const MI_Char *name,
                                           _In_ const MI_Value *value,
                                           _In_ MI_Type type,
                                           _In_ MI_Uint32 flags);

  MI_Result(MI_CALL *WriteCimError)(_In_ MI_Context *context,
                                    _In_ const MI_Instance *error,
                                    _Out_ MI_Boolean *flag);

  MI_Result(MI_CALL *PromptUser)(_In_ MI_Context *context,
                                 _In_z_ const MI_Char *message,
  ...
  */
  ...
  MI_Result(MI_CALL *ShouldProcess)(_In_ MI_Context *context,
                                    _In_z_ const MI_Char *target,
                                    _In_z_ const MI_Char *action,
                                    _Out_ MI_Boolean *result);

  MI_Result(MI_CALL *ShouldContinue)(_In_ MI_Context *context,
                                     _In_z_ const MI_Char *message,
                                     _Out_ MI_Boolean *result);
  ...
  */
  ...
  MI_Result(MI_CALL *PostError)(_In_ MI_Context *context, MI_Uint32 resultCode,
                                _In_z_ const MI_Char *resultType,
                                _In_z_ const MI_Char *errorMessage);

  MI_Result(MI_CALL *PostCimError)(_In_ MI_Context *context,
                                   _In_ const MI_Instance *error);

  MI_Result(MI_CALL *WriteError)(_In_ MI_Context *context, MI_Uint32 resultCode,
                                 _In_z_ const MI_Char *resultType,
                                 _In_z_ const MI_Char *errorMessage,
                                 _Out_ MI_Boolean *flag);
};
 ...
 */
MI_INLINE MI_Result MI_INLINE_CALL
MI_Context_PostResult(_In_ MI_Context *context, MI_Result result) {
...
MI_INLINE MI_Result MI_INLINE_CALL MI_Context_PostCimError(
    _In_ MI_Context *context, _In_ const MI_Instance *error) {
  if (context && context->ft) {
...
MI_INLINE MI_Result MI_INLINE_CALL MI_Context_PostError(
    _In_ MI_Context *context, MI_Uint32 resultCode,
    _In_z_ const MI_Char *resultType, _In_z_ const MI_Char *errorMessage) {
  if (context && context->ft) {
...
MI_INLINE MI_Result MI_INLINE_CALL MI_Context_PostInstance(
    _In_ MI_Context *context, _In_ const MI_Instance *instance) {
  if (context && context->ft) {
...
MI_INLINE MI_Result MI_INLINE_CALL MI_Context_PostIndication(
    _In_ MI_Context *context, _In_ const MI_Instance *indication,
    MI_Uint32 subscriptionIDCount, _In_opt_z_ const MI_Char *bookmark) {
  if (context && context->ft) {
...
MI_INLINE MI_Result MI_INLINE_CALL MI_Context_ConstructInstance(
    _In_ MI_Context *context, _In_ const MI_ClassDecl *classDecl,
    _Out_ MI_Instance *instance) {
  if (context && context->ft) {
...
MI_INLINE MI_Result MI_INLINE_CALL MI_Context_ConstructParameters(
    _In_ MI_Context *context, _In_ const MI_MethodDecl *methodDecl,
    _Out_ MI_Instance *instance) {
  if (context && context->ft) {
...
MI_INLINE MI_Result MI_INLINE_CALL MI_Context_NewDynamicInstance(
    _In_ MI_Context *context, _In_ const MI_Char *className, MI_Uint32 flags,
    _Outptr_ MI_Instance **instance) {
  if (context && context->ft) {
 ...
 */
MI_INLINE MI_Result MI_INLINE_CALL
MI_Context_Canceled(_In_ const MI_Context *context, _Out_ MI_Boolean *flag) {
  if (context && context->ft) {
...
MI_INLINE MI_Result MI_INLINE_CALL MI_Context_GetLocale(
    _In_ const MI_Context *context, MI_LocaleType localeType,
...
MI_INLINE MI_Result MI_INLINE_CALL MI_Context_RegisterCancel(
    _In_ MI_Context *context, _In_ MI_CancelCallback callback,
    _In_opt_ void *callbackData) {
  if (context && context->ft) {
 ...
 */
MI_INLINE MI_Result MI_INLINE_CALL
MI_Context_RequestUnload(_In_ MI_Context *context) {
  if (context && context->ft) {
 ...
 * its own lifetime. The provider may call MI_Context_RequestUnload() to request
 * an unload at any time. This function should be called with the load method.
 *
 * param: context the request context.
 *
 * return: MI_RESULT_OK, MI_RESULT_FAILED
 ...
 */
MI_INLINE MI_Result MI_INLINE_CALL
MI_Context_RefuseUnload(_In_ MI_Context *context) {
  if (context && context->ft) {
...
MI_INLINE MI_Result MI_INLINE_CALL MI_Context_GetLocalSession(
    _In_ const MI_Context *context, _Out_ MI_Session *session) {
  if (context && context->ft) {
 ...
 */
MI_INLINE MI_Result MI_INLINE_CALL
MI_Context_SetStringOption(_In_ MI_Context *context, _In_z_ const MI_Char *name,
                           _In_z_ const MI_Char *value) {
  if (context && context->ft) {
 ...
 */
MI_INLINE MI_Result MI_INLINE_CALL
MI_Context_GetStringOption(_In_ MI_Context *context, _In_z_ const MI_Char *name,
                           _Outptr_result_z_ const MI_Char **value) {
  if (context && context->ft) {
 ...
 */
MI_INLINE MI_Result MI_INLINE_CALL
MI_Context_GetNumberOption(_In_ MI_Context *context, _In_z_ const MI_Char *name,
                           _Out_opt_ MI_Uint32 *value) {
  if (context && context->ft) {
...
MI_INLINE MI_Result MI_INLINE_CALL MI_Context_GetCustomOption(
    _In_ MI_Context *context, _In_z_ const MI_Char *name,
    _Out_opt_ MI_Type *valueType, _Out_opt_ MI_Value *value) {
  if (context && context->ft) {
...
MI_INLINE MI_Result MI_INLINE_CALL MI_Context_GetCustomOptionCount(
    _In_ MI_Context *context, _Out_opt_ MI_Uint32 *count) {
  if (context && context->ft) {
 ...
 */
MI_INLINE MI_Result MI_INLINE_CALL
MI_Context_ShouldProcess(_In_ MI_Context *context, _In_z_ const MI_Char *target,
                         _In_z_ const MI_Char *action, _Out_ MI_Boolean *flag) {
  if (context && context->ft) {
...
MI_INLINE MI_Result MI_INLINE_CALL MI_Context_ShouldContinue(
    _In_ MI_Context *context, _In_z_ const MI_Char *message,
    _Out_ MI_Boolean *flag) {
  if (context && context->ft) {
 ...
 */
MI_INLINE MI_Result MI_INLINE_CALL
MI_Context_PromptUser(_In_ MI_Context *context, _In_z_ const MI_Char *message,
                      MI_PromptType promptType, _Out_ MI_Boolean *flag)
 ...
 */
MI_INLINE MI_Result MI_INLINE_CALL
MI_Context_WriteCimError(_In_ MI_Context *context,
                         _In_ const MI_Instance *error, _Out_ MI_Boolean *flag)
 ...
 */
MI_INLINE MI_Result MI_INLINE_CALL
MI_Context_WriteMessage(_In_ MI_Context *context, MI_Uint32 channel,
                        _In_z_ const MI_Char *message) {
  if (context && context->ft) {
...
MI_INLINE MI_Result MI_INLINE_CALL MI_Context_WriteProgress(
    _In_ MI_Context *context, _In_z_ const MI_Char *activity,
    _In_z_ const MI_Char *currentOperation,
    _In_z_ const MI_Char *statusDescription, MI_Uint32 percentComplete,
    MI_Uint32 secondsRemaining) {
  if (context && context->ft) {
...
MI_INLINE MI_Result MI_INLINE_CALL MI_Context_WriteStreamParameter(
    _In_ MI_Context *self, _In_z_ const MI_Char *name,
    _In_ const MI_Value *value, _In_ MI_Type type, _In_ MI_Uint32 flags) {
  if (self && self->ft) {
...
/**
 * This function implements the WriteWarning functionality of WriteMessage CIM
...
/**
 * This function implements the WriteVerbose functionality of WriteMessage CIM
 * Extensions operation.
 *
 * param: context the request context.
 * param: message
...
/**
 * This function implements the WriteDebug functionality of WriteMessage CIM
 * Extensions operation.
 *
 * param: context the request context.
 * param: message
 ...
 */
MI_INLINE MI_Result MI_INLINE_CALL
MI_Context_WriteDebug(_In_ MI_Context *context, _In_z_ const MI_Char *message) {
  if (context && context->ft) {
...
/* make sure ordering of methods and arguments is consistent with other function
 * tables */

typedef struct _MI_QualifierSetFT {
  MI_Result(MI_CALL *GetQualifierCount)(_In_ const MI_QualifierSet *self,
                                        _Out_ MI_Uint32 *count);

  MI_Result(MI_CALL *GetQualifierAt)(
      _In_ const MI_QualifierSet *self, MI_Uint32 index,
      _Outptr_result_z_ const MI_Char **name, _Out_ MI_Type *qualifierType,
      _Out_ MI_Uint32 *qualifierFlags, /* scope information */
      _Out_ MI_Value *qualifierValue);

  MI_Result(MI_CALL *GetQualifier)(
      _In_ const MI_QualifierSet *self, _In_z_ const MI_Char *name,
      _Out_ MI_Type *qualifierType,
      _Out_ MI_Uint32 *qualifierFlags, /* scope information */
      _Out_ MI_Value *qualifierValue, _Out_ MI_Uint32 *index);
} MI_QualifierSetFT;
...
typedef struct _MI_ParameterSetFT {
  MI_Result(MI_CALL *GetMethodReturnType)(_In_ const MI_ParameterSet *self,
                                          _Out_ MI_Type *returnType,
                                          _Out_ MI_QualifierSet *qualifierSet);

  MI_Result(MI_CALL *GetParameterCount)(_In_ const MI_ParameterSet *self,
                                        _Out_ MI_Uint32 *count);

  MI_Result(MI_CALL *GetParameterAt)(
      _In_ const MI_ParameterSet *self, MI_Uint32 index,
      _Outptr_result_z_ const MI_Char **name, MI_Type *parameterType,
      _Outptr_opt_result_maybenull_z_ MI_Char **referenceClass,
      _Out_ MI_QualifierSet *qualifierSet);

  MI_Result(MI_CALL *GetParameter)(
      _In_ const MI_ParameterSet *self, _In_z_ const MI_Char *name,
      _Out_ MI_Type *parameterType,
      _Outptr_opt_result_maybenull_z_ MI_Char **referenceClass,
      _Out_ MI_QualifierSet *qualifierSet, _Out_ MI_Uint32 *index);
...
typedef struct _MI_ClassFT {
  ...
  MI_Result(MI_CALL *GetElementCount)(_In_ const MI_Class *self,
                                      _Out_ MI_Uint32 *count);

  MI_Result(MI_CALL *GetElement)(
      _In_ const MI_Class *self, _In_z_ const MI_Char *name,
      _Out_opt_ MI_Value *value, _Out_opt_ MI_Boolean *valueExists,
      _Out_opt_ MI_Type *type,
      _Outptr_opt_result_maybenull_z_ MI_Char **referenceClass,
      _Out_opt_ MI_QualifierSet *qualifierSet, _Out_opt_ MI_Uint32 *flags,
      _Out_opt_ MI_Uint32 *index);

  MI_Result(MI_CALL *GetElementAt)(
      _In_ const MI_Class *self, MI_Uint32 index,
      _Outptr_opt_result_maybenull_z_ const MI_Char **name,
      _Out_opt_ MI_Value *value, _Out_opt_ MI_Boolean *valueExists,
      _Out_opt_ MI_Type *type,
      _Outptr_opt_result_maybenull_z_ MI_Char **referenceClass,
  ...
  MI_Result(MI_CALL *GetClassQualifierSet)(
      _In_ const MI_Class *self, _Out_opt_ MI_QualifierSet *qualifierSet);

  MI_Result(MI_CALL *GetMethodCount)(_In_ const MI_Class *self,
                                     _Out_ MI_Uint32 *count);

  MI_Result(MI_CALL *GetMethodAt)(_In_ const MI_Class *self, MI_Uint32 index,
                                  _Outptr_result_z_ const MI_Char **name,
                                  _Out_opt_ MI_QualifierSet *qualifierSet,
                                  _Out_opt_ MI_ParameterSet *parameterSet);

  MI_Result(MI_CALL *GetMethod)(_In_ const MI_Class *self,
                                _In_z_ const MI_Char *name,
                                _Out_opt_ MI_QualifierSet *qualifierSet,
                                _Out_opt_ MI_ParameterSet *parameterSet,
                                _Out_opt_ MI_Uint32 *index);
  ...
  MI_Result(MI_CALL *GetParentClass)(_In_ const MI_Class *self,
                                     _Outptr_ MI_Class **parentClass);

  MI_Result(MI_CALL *Delete)(_Inout_ MI_Class *self);

  MI_Result(MI_CALL *Clone)(_In_ const MI_Class *self,
...
typedef void(MI_CALL *MI_OperationCallback_PromptUser)(
    _In_ MI_Operation *operation, _In_opt_ void *callbackContext,
    _In_z_ const MI_Char *message, MI_PromptType promptType,
    _In_opt_ MI_Result(MI_CALL *promptUserResult)(
...
typedef void(MI_CALL *MI_OperationCallback_WriteError)(
    ...
    _In_opt_ MI_Result(MI_CALL *writeErrorResult)(
        _In_ MI_Operation *operation,
        MI_OperationCallback_ResponseType response));
...
typedef void(MI_CALL *MI_OperationCallback_WriteMessage)(
    _In_ MI_Operation *operation, _In_opt_ void *callbackContext,
    MI_Uint32 channel, _In_z_ const MI_Char *message);
/*
**=============================================================================
**
...
typedef void(MI_CALL *MI_OperationCallback_WriteProgress)(
    _In_ MI_Operation *operation, _In_opt_ void *callbackContext,
    _In_z_ const MI_Char *activity, _In_z_ const MI_Char *currentOperation,
    _In_z_ const MI_Char *statusDescription, MI_Uint32 percentageComplete,
    MI_Uint32 secondsRemaining);
...
typedef void(MI_CALL *MI_OperationCallback_Instance)(
    _In_opt_ MI_Operation *operation, _In_ void *callbackContext,
    _In_opt_ const MI_Instance *instance, MI_Boolean moreResults,
    _In_ MI_Result resultCode, _In_opt_z_ const MI_Char *errorString,
    _In_opt_ const MI_Instance *errorDetails,
    _In_opt_ MI_Result(MI_CALL *resultAcknowledgement)(
        _In_ MI_Operation *operation));
...
typedef void(MI_CALL *MI_OperationCallback_StreamedParameter)(
    _In_ MI_Operation *operation, _In_ void *callbackContext,
    _In_z_ const MI_Char *parameterName, _In_ MI_Type resultType,
...
typedef void(MI_CALL *MI_OperationCallback_Indication)(
    _In_opt_ MI_Operation *operation, _In_ void *callbackContext,
    _In_opt_ const MI_Instance *instance, _In_opt_z_ const MI_Char *bookmark,
    _In_opt_z_ const MI_Char *machineID, MI_Boolean moreResults,
    _In_ MI_Result resultCode, _In_opt_z_ const MI_Char *errorString,
    _In_opt_ const MI_Instance *errorDetails,
    _In_opt_ MI_Result(MI_CALL *resultAcknowledgement)(
        _In_ MI_Operation *operation));
...
typedef void(MI_CALL *MI_OperationCallback_Class)(
    _In_opt_ MI_Operation *operation, _In_ void *callbackContext,
    _In_opt_ const MI_Class *classResult, MI_Boolean moreResults,
    _In_ MI_Result resultCode, _In_opt_z_ const MI_Char *errorString,
    _In_opt_ const MI_Instance *errorDetails,
    _In_opt_ MI_Result(MI_CALL *resultAcknowledgement)(
        _In_ MI_Operation *operation));
...
typedef struct _MI_SessionCallbacks {
  ...
  **=========================================================================
  */
  void(MI_CALL *writeMessage)(_In_ MI_Application *application,
                              _In_opt_ void *callbackContext, MI_Uint32 channel,
                              _In_z_ const MI_Char *message);
  ...
  **=========================================================================
  */
  void(MI_CALL *writeError)(_In_ MI_Application *application,
 ...
 */
#define MI_OPERATIONFLAGS_NO_RTTI                                              \
  0x0400 /* All instance elements are string except embedded objects and       \
            references, but their elements will be strings also */
#define MI_OPERATIONFLAGS_BASIC_RTTI                                           \
  0x0002 /* All instance elements may be strings or the correct type */
#define MI_OPERATIONFLAGS_STANDARD_RTTI                                        \
  0x0800 /* All instance elements are of the correct type, but some hierarchy  \
            information may be lost due to optimizations */
#define MI_OPERATIONFLAGS_FULL_RTTI                                            \
  0x0004 /* All instance elements at every level of the instances class        \
            hierarchy will be accurate.  This may be very expensive */

/* If no RTTI flag is specified (i.e. 0 for relevant RTTI bits) then the
 * protocol handler itself will pick the best option */
...
**=============================================================================
*/
#define MI_AUTH_TYPE_DEFAULT                                                   \
  MI_T("Default") /* transport picks default specific to it. Ex: winrm uses    \
                     Kerberos and NegotiateWithoutCredentials as default*/
#define MI_AUTH_TYPE_NONE                                                      \
  MI_T("None") /* do not authenticate, most servers require some kind of       \
                  authentication */
#define MI_AUTH_TYPE_DIGEST MI_T("Digest") /* Needs username/password */
#define MI_AUTH_TYPE_NEGO_WITH_CREDS                                           \
  MI_T("NegoWithCreds") /* needs username/password */
#define MI_AUTH_TYPE_NEGO_NO_CREDS                                             \
  MI_T("NegoNoCreds") /* current thread user, need to trust destination! */
#define MI_AUTH_TYPE_BASIC MI_T("Basic") /* needs username/password */
#define MI_AUTH_TYPE_KERBEROS                                                  \
  MI_T("Kerberos") /* username/password optional                               \
                    */
#define MI_AUTH_TYPE_CLIENT_CERTS                                              \
  MI_T("ClientCerts")                        /* needs cert thumbprint */
...
#endif
#define MI_AUTH_TYPE_ISSUER_CERT                                               \
  MI_T("IssuerCert") /* Push/Source Initiated subscriptions only */
...
typedef struct _MI_SubscriptionDeliveryOptionsFT {
  MI_Result(MI_CALL *SetString)(_Inout_ MI_SubscriptionDeliveryOptions *options,
                                _In_z_ const MI_Char *optionName,
                                _In_z_ const MI_Char *value, MI_Uint32 flags);

  MI_Result(MI_CALL *SetNumber)(_Inout_ MI_SubscriptionDeliveryOptions *options,
                                _In_z_ const MI_Char *optionName,
                                _In_ MI_Uint32 value, MI_Uint32 flags);

  MI_Result(MI_CALL *SetDateTime)(
      _Inout_ MI_SubscriptionDeliveryOptions *options,
      _In_z_ const MI_Char *optionName, _In_ const MI_Datetime *value,
      MI_Uint32 flags);

  MI_Result(MI_CALL *SetInterval)(
      _Inout_ MI_SubscriptionDeliveryOptions *options,
      _In_z_ const MI_Char *optionName, _In_ const MI_Interval *value,
      MI_Uint32 flags);

  MI_Result(MI_CALL *AddCredentials)(
      _Inout_ MI_SubscriptionDeliveryOptions *options,
      _In_z_ const MI_Char *optionName,
      _In_ const MI_UserCredentials *credentials, MI_Uint32 flags);

  MI_Result(MI_CALL *Delete)(_Inout_ MI_SubscriptionDeliveryOptions *self);

  MI_Result(MI_CALL *GetString)(_In_ MI_SubscriptionDeliveryOptions *options,
                                _In_z_ const MI_Char *optionName,
                                _Outptr_result_z_ const MI_Char **value,
                                _Out_opt_ MI_Uint32 *index,
                                _Out_opt_ MI_Uint32 *flags);

  MI_Result(MI_CALL *GetNumber)(_In_ MI_SubscriptionDeliveryOptions *options,
                                _In_z_ const MI_Char *optionName,
                                _Out_ MI_Uint32 *value,
                                _Out_opt_ MI_Uint32 *index,
                                _Out_opt_ MI_Uint32 *flags);

  MI_Result(MI_CALL *GetDateTime)(_In_ MI_SubscriptionDeliveryOptions *options,
                                  _In_z_ const MI_Char *optionName,
                                  _Out_ MI_Datetime *value,
                                  _Out_opt_ MI_Uint32 *index,
                                  _Out_opt_ MI_Uint32 *flags);

  MI_Result(MI_CALL *GetInterval)(_In_ MI_SubscriptionDeliveryOptions *options,
                                  _In_z_ const MI_Char *optionName,
  ...
  MI_Result(MI_CALL *GetOptionCount)(
      _In_ MI_SubscriptionDeliveryOptions *options, _Out_opt_ MI_Uint32 *count);

  MI_Result(MI_CALL *GetOptionAt)(_In_ MI_SubscriptionDeliveryOptions *options,
                                  MI_Uint32 index,
                                  _Outptr_result_z_ const MI_Char **optionName,
                                  _Out_ MI_Value *value, _Out_ MI_Type *type,
                                  _Out_opt_ MI_Uint32 *flags);

  MI_Result(MI_CALL *GetOption)(_In_ MI_SubscriptionDeliveryOptions *options,
                                _In_z_ const MI_Char *optionName,
                                _Out_ MI_Value *value, _Out_ MI_Type *type,
                                _Out_opt_ MI_Uint32 *index,
                                _Out_opt_ MI_Uint32 *flags);
  ...
  MI_Result(MI_CALL *GetCredentialsCount)(
      _In_ MI_SubscriptionDeliveryOptions *options, _Out_ MI_Uint32 *count);

  MI_Result(MI_CALL *GetCredentialsAt)(
      _In_ MI_SubscriptionDeliveryOptions *options, MI_Uint32 index,
      _Outptr_result_z_ const MI_Char **optionName,
      _Out_ MI_UserCredentials *
          credentials, // output credentials always has password set to '******'
      _Out_opt_ MI_Uint32 *flags);
...
struct _MI_SerializerFT {
  ...
  MI_Result(MI_CALL *SerializeClass)(_Inout_ MI_Serializer *serializer,
                                     MI_Uint32 flags,
                                     _In_ const MI_Class *classObject,
                                     _Out_writes_bytes_(clientBufferLength)
                                         MI_Uint8 *clientBuffer,
                                     MI_Uint32 clientBufferLength,
                                     _Inout_ MI_Uint32 *clientBufferNeeded);

  MI_Result(MI_CALL *SerializeInstance)(_Inout_ MI_Serializer *serializer,
                                        MI_Uint32 flags,
...
**
** Callback function used to provider requested class object during
* deserialization.
**
**=============================================================================
*/
typedef MI_Result(MI_CALL *MI_Deserializer_ClassObjectNeeded)(
    _In_opt_ void *context, _In_opt_z_ const MI_Char *serverName,
    _In_opt_z_ const MI_Char *namespaceName, _In_z_ const MI_Char *className,
...
struct _MI_DeserializerFT {
  ...
  MI_Result(MI_CALL *DeserializeClass)(
      _Inout_ MI_Deserializer *deserializer, MI_Uint32 flags,
      _In_reads_(serializedBufferLength) MI_Uint8 *serializedBuffer,
      MI_Uint32 serializedBufferLength, _In_opt_ MI_Class *parentClass,
...
typedef struct _MI_ApplicationFT {
  ...
  MI_Result(MI_CALL *NewSession)(
      _In_ MI_Application *application, _In_opt_z_ const MI_Char *protocol,
  ...
  MI_Result(MI_CALL *NewHostedProvider)(
      _In_ MI_Application *application, _In_z_ const MI_Char *namespaceName,
      _In_z_ const MI_Char *providerName, _In_ MI_MainFunction mi_Main,
      _Outptr_opt_result_maybenull_ MI_Instance **extendedError,
      _Out_ MI_HostedProvider *provider);

  MI_Result(MI_CALL *NewInstance)(_In_ MI_Application *application,
                                  _In_z_ const MI_Char *className,
                                  _In_opt_ const MI_ClassDecl *classRTTI,
                                  _Outptr_ MI_Instance **instance);

  MI_Result(MI_CALL *NewDestinationOptions)(
      _In_ MI_Application *application, _Out_ MI_DestinationOptions *options);

  MI_Result(MI_CALL *NewOperationOptions)(_In_ MI_Application *application,
                                          _In_ MI_Boolean
  ...
  MI_Result(MI_CALL *NewSerializer)(_Inout_ MI_Application *application,
                                    MI_Uint32 flags, _In_z_ MI_Char *format,
                                    _Out_ MI_Serializer *serializer);

  MI_Result(MI_CALL *NewDeserializer)(_Inout_ MI_Application *application,
                                      MI_Uint32 flags, _In_z_ MI_Char *format,
                                      _Out_ MI_Deserializer *deserializer);

  MI_Result(MI_CALL *NewInstanceFromClass)(_In_ MI_Application *application,
                                           _In_z_ const MI_Char *className,
                                           _In_opt_ const MI_Class *classObject,
                                           _Outptr_ MI_Instance **instance);

  MI_Result(MI_CALL *NewClass)(_In_ MI_Application *application,
                               _In_ const MI_ClassDecl *classDecl,
...
typedef struct _MI_HostedProviderFT {
  ...
  MI_Result(MI_CALL *GetApplication)(_In_ MI_HostedProvider *hostedProvider,
...
typedef struct _MI_SessionFT {
  MI_Result(MI_CALL *Close)(_Inout_ MI_Session *session,
                            _In_opt_ void *completionContext,
                            _In_opt_ void(MI_CALL *completionCallback)(
                                _In_opt_ void *completionContext));

  MI_Result(MI_CALL *GetApplication)(_In_ MI_Session *session,
                                     _Out_ MI_Application *application);

  void(MI_CALL *GetInstance)(_In_ MI_Session *session, MI_Uint32 flags,
  ...
  void(MI_CALL *ModifyInstance)(_In_ MI_Session *session, MI_Uint32 flags,
                                _In_opt_ MI_OperationOptions *options,
                                _In_opt_z_ const MI_Char *namespaceName,
                                _In_ const MI_Instance *inboundInstance,
                                _In_opt_ MI_OperationCallbacks *callbacks,
  ...
  void(MI_CALL *CreateInstance)(_In_ MI_Session *session, MI_Uint32 flags,
                                _In_opt_ MI_OperationOptions *options,
                                _In_opt_z_ const MI_Char *namespaceName,
                                _In_ const MI_Instance *inboundInstance,
                                _In_opt_ MI_OperationCallbacks *callbacks,
  ...
  void(MI_CALL *DeleteInstance)(_In_ MI_Session *session, MI_Uint32 flags,
                                _In_opt_ MI_OperationOptions *options,
                                _In_opt_z_ const MI_Char *namespaceName,
                                _In_ const MI_Instance *inboundInstance,
                                _In_opt_ MI_OperationCallbacks *callbacks,
  ...
  void(MI_CALL *Invoke)(_In_ MI_Session *session, MI_Uint32 flags,
                        _In_opt_ MI_OperationOptions *options,
                        _In_opt_z_ const MI_Char *namespaceName,
  ...
  void(MI_CALL *EnumerateInstances)(_In_ MI_Session *session, MI_Uint32 flags,
                                    _In_opt_ MI_OperationOptions *options,
                                    _In_opt_z_ const MI_Char *namespaceName,
                                    _In_opt_z_ const MI_Char *className,
                                    MI_Boolean keysOnly,
  ...
  void(MI_CALL *QueryInstances)(_In_ MI_Session *session, MI_Uint32 flags,
                                _In_opt_ MI_OperationOptions *options,
                                _In_opt_z_ const MI_Char *namespaceName,
  ...
  void(MI_CALL *AssociatorInstances)(_In_ MI_Session *session, MI_Uint32 flags,
                                     _In_opt_ MI_OperationOptions *options,
                                     _In_opt_z_ const MI_Char *namespaceName,
  ...
  void(MI_CALL *ReferenceInstances)(_In_ MI_Session *session, MI_Uint32 flags,
                                    _In_opt_ MI_OperationOptions *options,
                                    _In_opt_z_ const MI_Char *namespaceName,
                                    _In_ const MI_Instance *instanceKeys,
                                    _In_opt_z_ const MI_Char *resultClass,
  ...
  void(MI_CALL *Subscribe)(
      _In_ MI_Session *session, MI_Uint32 flags,
      _In_opt_ MI_OperationOptions *options,
      _In_opt_z_ const MI_Char *namespaceName,
      _In_opt_z_ const MI_Char *queryDialect,
      _In_opt_z_ const MI_Char *queryExpression,
      _In_opt_ const MI_SubscriptionDeliveryOptions *deliverOptions,
      _In_opt_ MI_OperationCallbacks *callbacks, _Out_ MI_Operation *operation);

  void(MI_CALL *GetClass)(_In_ MI_Session *session, MI_Uint32 flags,
                          _In_opt_ MI_OperationOptions *options,
                          _In_opt_z_ const MI_Char *namespaceName,
                          _In_opt_z_ const MI_Char *className,
                          _In_opt_ MI_OperationCallbacks *callbacks,
  ...
  void(MI_CALL *EnumerateClasses)(_In_ MI_Session *session, MI_Uint32 flags,
                                  _In_opt_ MI_OperationOptions *options,
                                  _In_opt_z_ const MI_Char *namespaceName,
                                  _In_opt_z_ const MI_Char *className,
  ...
  void(MI_CALL *TestConnection)(_In_ MI_Session *session, MI_Uint32 flags,
                                _In_opt_ MI_OperationCallbacks *callbacks,
                                _Out_ MI_Operation *operation);
} MI_SessionFT;
...
typedef struct _MI_OperationFT {
  ...
  MI_Result(MI_CALL *Cancel)(_Inout_ MI_Operation *operation,
                             MI_CancellationReason reason);

  MI_Result(MI_CALL *GetSession)(_In_ MI_Operation *operation,
                                 _Out_ MI_Session *session);

  MI_Result(MI_CALL *GetInstance)(
      _In_ MI_Operation *operation,
      _Outptr_result_maybenull_ const MI_Instance **instance,
      _Out_opt_ MI_Boolean *moreResults, _Out_opt_ MI_Result *result,
...
typedef struct _MI_DestinationOptionsFT {
  void(MI_CALL *Delete)(_Inout_ MI_DestinationOptions *options);

  MI_Result(MI_CALL *SetString)(_Inout_ MI_DestinationOptions *options,
                                _In_z_ const MI_Char *optionName,
                                _In_z_ const MI_Char *value, MI_Uint32 flags);

  MI_Result(MI_CALL *SetNumber)(_Inout_ MI_DestinationOptions *options,
                                _In_z_ const MI_Char *optionName,
                                _In_ MI_Uint32 value, MI_Uint32 flags);

  MI_Result(MI_CALL *AddCredentials)(_Inout_ MI_DestinationOptions *options,
                                     _In_z_ const MI_Char *optionName,
                                     _In_ const MI_UserCredentials *credentials,
                                     MI_Uint32 flags);

  MI_Result(MI_CALL *GetString)(_In_ MI_DestinationOptions *options,
                                _In_z_ const MI_Char *optionName,
                                _Outptr_result_z_ const MI_Char **value,
                                _Out_opt_ MI_Uint32 *index,
                                _Out_opt_ MI_Uint32 *flags);

  MI_Result(MI_CALL *GetNumber)(_In_ MI_DestinationOptions *options,
                                _In_z_ const MI_Char *optionName,
                                _Out_ MI_Uint32 *value,
                                _Out_opt_ MI_Uint32 *index,
                                _Out_opt_ MI_Uint32 *flags);

  MI_Result(MI_CALL *GetOptionCount)(_In_ MI_DestinationOptions *options,
                                     _Out_ MI_Uint32 *count);

  MI_Result(MI_CALL *GetOptionAt)(_In_ MI_DestinationOptions *options,
                                  MI_Uint32 index,
                                  _Outptr_result_z_ const MI_Char **optionName,
                                  _Out_ MI_Value *value, _Out_ MI_Type *type,
                                  _Out_opt_ MI_Uint32 *flags);

  MI_Result(MI_CALL *GetOption)(_In_ MI_DestinationOptions *options,
                                _In_z_ const MI_Char *optionName,
                                _Out_ MI_Value *value, _Out_ MI_Type *type,
                                _Out_opt_ MI_Uint32 *index,
                                _Out_opt_ MI_Uint32 *flags);

  MI_Result(MI_CALL *GetCredentialsCount)(_In_ MI_DestinationOptions *options,
                                          _Out_ MI_Uint32 *count);

  MI_Result(MI_CALL *GetCredentialsAt)(
      _In_ MI_DestinationOptions *options, MI_Uint32 index,
      _Outptr_result_z_ const MI_Char **optionName,
      _Out_ MI_UserCredentials *
          credentials, // output credentials always has password set to '******'
      _Out_opt_ MI_Uint32 *flags);
  ...
  MI_Result(MI_CALL *Clone)(_In_ const MI_DestinationOptions *self,
                            _Out_ MI_DestinationOptions *newDestinationOptions);

  MI_Result(MI_CALL *SetInterval)(_Inout_ MI_DestinationOptions *options,
                                  _In_z_ const MI_Char *optionName,
                                  _In_ const MI_Interval *value,
                                  MI_Uint32 flags);

  MI_Result(MI_CALL *GetInterval)(_In_ MI_DestinationOptions *options,
                                  _In_z_ const MI_Char *optionName,
                                  _Out_ MI_Interval *value,
                                  _Out_opt_ MI_Uint32 *index,
                                  _Out_opt_ MI_Uint32 *flags);
...
typedef struct _MI_OperationOptionsFT {
  void(MI_CALL *Delete)(_Inout_ MI_OperationOptions *options);

  MI_Result(MI_CALL *SetString)(_Inout_ MI_OperationOptions *options,
                                _In_z_ const MI_Char *optionName,
                                _In_z_ const MI_Char *value, MI_Uint32 flags);

  MI_Result(MI_CALL *SetNumber)(_Inout_ MI_OperationOptions *options,
                                _In_z_ const MI_Char *optionName,
                                _In_ MI_Uint32 value, MI_Uint32 flags);

  MI_Result(MI_CALL *SetCustomOption)(_Inout_ MI_OperationOptions *options,
                                      _In_z_ const MI_Char *optionName,
                                      _In_ MI_Type valueType,
                                      _In_ const MI_Value *value,
                                      MI_Boolean mustComply, MI_Uint32 flags);

  MI_Result(MI_CALL *GetString)(_In_ MI_OperationOptions *options,
                                _In_z_ const MI_Char *optionName,
                                _Outptr_result_z_ const MI_Char **value,
                                _Out_opt_ MI_Uint32 *index,
                                _Out_opt_ MI_Uint32 *flags);

  MI_Result(MI_CALL *GetNumber)(_In_ MI_OperationOptions *options,
                                _In_z_ const MI_Char *optionName,
                                _Out_ MI_Uint32 *value,
                                _Out_opt_ MI_Uint32 *index,
                                _Out_opt_ MI_Uint32 *flags);

  MI_Result(MI_CALL *GetOptionCount)(_In_ MI_OperationOptions *options,
                                     _Out_ MI_Uint32 *count);

  MI_Result(MI_CALL *GetOptionAt)(_In_ MI_OperationOptions *options,
                                  MI_Uint32 index,
                                  _Outptr_result_z_ const MI_Char **optionName,
                                  _Out_ MI_Value *value, _Out_ MI_Type *type,
                                  _Out_opt_ MI_Uint32 *flags);

  MI_Result(MI_CALL *GetOption)(_In_ MI_OperationOptions *options,
                                _In_z_ const MI_Char *optionName,
                                _Out_ MI_Value *value, _Out_ MI_Type *type,
                                _Out_opt_ MI_Uint32 *index,
                                _Out_opt_ MI_Uint32 *flags);
  ...
  MI_Result(MI_CALL *GetEnabledChannels)(
      _In_ MI_OperationOptions *options, _In_z_ const MI_Char *optionName,
      _Out_writes_to_opt_(bufferLength, *channelCount) MI_Uint32 *channels,
      _In_ MI_Uint32 bufferLength, _Out_ MI_Uint32 *channelCount,
      _Out_opt_ MI_Uint32 *flags);

  MI_Result(MI_CALL *Clone)(_In_ const MI_OperationOptions *self,
                            _Out_ MI_OperationOptions *newOperationOptions);

  MI_Result(MI_CALL *SetInterval)(_Inout_ MI_OperationOptions *options,
                                  _In_z_ const MI_Char *optionName,
                                  _In_ const MI_Interval *value,
                                  MI_Uint32 flags);

  MI_Result(MI_CALL *GetInterval)(_In_ MI_OperationOptions *options,
                                  _In_z_ const MI_Char *optionName,
                                  _Out_ MI_Interval *value,
                                  _Out_opt_ MI_Uint32 *index,
                                  _Out_opt_ MI_Uint32 *flags);
...
typedef struct _MI_UtilitiesFT {
  MI_ErrorCategory(MI_CALL *MapErrorToMiErrorCategory)(
      _In_z_ MI_Char *errorType, MI_Uint32 error);
...
MI_Result MI_MAIN_CALL MI_Application_InitializeV1(
    MI_Uint32 flags, _In_opt_z_ const MI_Char *applicationID,
    _Outptr_opt_result_maybenull_ MI_Instance **extendedError,
    _Out_ MI_Application *application);
...
**=============================================================================
*/
MI_INLINE MI_Result MI_Application_Close(_Inout_ MI_Application *application) {
...
MI_INLINE MI_Result MI_Application_NewInstance(
    _In_ MI_Application *application, _In_z_ const MI_Char *className,
    _In_opt_ const MI_ClassDecl *classRTTI, _Outptr_ MI_Instance **instance) {
  if (application && application->ft) {
...
MI_INLINE MI_Result MI_Application_NewInstanceFromClass(
    _In_ MI_Application *application, _In_z_ const MI_Char *className,
    _In_opt_ const MI_Class *classObject, _Outptr_ MI_Instance **instance) {
  if (application && application->ft) {
...
MI_INLINE MI_Result MI_Application_NewClass(
    _In_ MI_Application *application, _In_ const MI_ClassDecl *classDecl,
    __in_z_opt const MI_Char *namespaceName,
    __in_z_opt const MI_Char *serverName, _Outptr_ MI_Class **classObject) {
  if (application && application->ft) {
...
MI_INLINE MI_Result MI_Application_NewParameterSet(
    _In_ MI_Application *application, _In_opt_ const MI_ClassDecl *classRTTI,
    _Outptr_ MI_Instance **instance) {
  if (application && application->ft) {
...
MI_INLINE MI_Result MI_Application_NewOperationOptions(
    _In_ MI_Application *application, MI_Boolean mustUnderstand,
    _Out_ MI_OperationOptions *options) {
  if (application && application->ft) {
...
MI_INLINE MI_Result MI_Application_NewSerializer(
    _Inout_ MI_Application *application, MI_Uint32 flags,
    _In_z_ MI_Char *format, _Out_ MI_Serializer *serializer) {
  if (application && application->ft) {
...
MI_INLINE MI_Result MI_Application_NewDeserializer(
    _Inout_ MI_Application *application, MI_Uint32 flags,
    _In_z_ MI_Char *format, _Out_ MI_Deserializer *deserializer) {
  if (application && application->ft) {
...
*/
MI_INLINE MI_Result
MI_HostedProvider_Close(_Inout_ MI_HostedProvider *hostedProvider) {
...
MI_INLINE MI_Result MI_HostedProvider_GetApplication(
    _In_ MI_HostedProvider *hostedProvider, _Out_ MI_Application *application) {
  if (hostedProvider && hostedProvider->ft) {
...
** operations must have their handles closed before the session finishes
* closing.
**
** This can be called from inside an asynchronous callback only if the callback
** is used.  Waiting for the completion of this callback from inside the
* callback
** will cause a deadlock, which is the same reason that calling this API
* synchronously
** will cause a deadlock on an asynchronous callback.
**
**=============================================================================
*/
MI_INLINE MI_Result MI_Session_Close(_Inout_ MI_Session *session,
                                     _In_opt_ void *completionContext,
                                     _In_opt_ void(MI_CALL *completionCallback)(
                                         _In_opt_ void *completionContext)) {
...
MI_INLINE MI_Result MI_Session_GetApplication(
    _In_ MI_Session *session, _Out_ MI_Application *application) {
  if (session && session->ft) {
...
**=============================================================================
*/
MI_INLINE void MI_Session_GetInstance(_In_ MI_Session *session, MI_Uint32 flags,
                                      _In_opt_ MI_OperationOptions *options,
                                      _In_opt_z_ const MI_Char *namespaceName,
                                      _In_ const MI_Instance *inboundInstance,
                                      _In_opt_ MI_OperationCallbacks *callbacks,
...
**
** Initiates a Modify operation.  If a result callback is specified, the
* callback
** will be called when the operation completes.  For synchronous, the client
** must call MI_Operation_GetInstance to receive the object and/or operation
** return code.  Even if the operation is cancelled the client must still
...
*/
MI_INLINE void
MI_Session_ModifyInstance(_In_ MI_Session *session, MI_Uint32 flags,
                          _In_opt_ MI_OperationOptions *options,
                          _In_opt_z_ const MI_Char *namespaceName,
                          _In_ const MI_Instance *inboundInstance,
                          _In_opt_ MI_OperationCallbacks *callbacks,
...
**
** Initiates a Create operation.  If a result callback is specified, the
* callback
** will be called when the operation completes.  For synchronous, the client
** must call MI_Operation_GetInstance to receive the object and/or operation
** return code.  Even if the operation is cancelled the client must still
...
*/
MI_INLINE void
MI_Session_CreateInstance(_In_ MI_Session *session, MI_Uint32 flags,
                          _In_opt_ MI_OperationOptions *options,
                          _In_opt_z_ const MI_Char *namespaceName,
                          _In_ const MI_Instance *inboundInstance,
                          _In_opt_ MI_OperationCallbacks *callbacks,
...
**
** Initiates a Delete operation.  If a result callback is specified, the
* callback
** will be called when the operation completes.  For synchronous, the client
...
*/
MI_INLINE void
MI_Session_DeleteInstance(_In_ MI_Session *session, MI_Uint32 flags,
                          _In_opt_ MI_OperationOptions *options,
                          _In_opt_z_ const MI_Char *namespaceName,
                          _In_ const MI_Instance *inboundInstance,
                          _In_opt_ MI_OperationCallbacks *callbacks,
...
**=============================================================================
*/
MI_INLINE void MI_Session_Invoke(_In_ MI_Session *session, MI_Uint32 flags,
                                 _In_opt_ MI_OperationOptions *options,
                                 _In_opt_z_ const MI_Char *namespaceName,
                                 _In_opt_z_ const MI_Char *className,
                                 _In_z_ const MI_Char *methodName,
...
**
** Initiates a Enumerate operation.  If a result callback is specified, the
* callback
...
** must call MI_Operation_GetInstance to receive the objects, once for each
* object
** until the operation return code is also included.  Even if the operation is
** cancelled the client must still call MI_Operation_GetInstance until the
* return
** code is given.
**
**=============================================================================
...
MI_INLINE void MI_Session_EnumerateInstances(
    ...
    _In_opt_ MI_OperationOptions *options,
    _In_opt_z_ const MI_Char *namespaceName,
    _In_opt_z_ const MI_Char *className, MI_Boolean keysOnly,
    _In_opt_ MI_OperationCallbacks *callbacks, _Out_ MI_Operation *operation) {
  if (session && session->ft) {
...
MI_INLINE void
MI_Session_QueryInstances(_In_ MI_Session *session, MI_Uint32 flags,
                          _In_opt_ MI_OperationOptions *options,
                          _In_opt_z_ const MI_Char *namespaceName,
                          _In_opt_z_ const MI_Char *queryDialect,
                          _In_opt_z_ const MI_Char *queryExpression,
...
MI_INLINE void MI_Session_AssociatorInstances(
    ...
    _In_opt_ MI_OperationOptions *options,
    _In_opt_z_ const MI_Char *namespaceName,
    _In_ const MI_Instance *instanceKey, _In_opt_z_ const MI_Char *assocClass,
    _In_opt_z_ const MI_Char *resultClass, _In_opt_z_ const MI_Char *role,
    _In_opt_z_ const MI_Char *resultRole, MI_Boolean keysOnly,
    _In_opt_ MI_OperationCallbacks *callbacks, _Out_ MI_Operation *operation) {
  if (session && session->ft) {
...
MI_INLINE void MI_Session_ReferenceInstances(
    ...
    _In_opt_ MI_OperationOptions *options,
    _In_opt_z_ const MI_Char *namespaceName,
    _In_ const MI_Instance *instanceKey, _In_opt_z_ const MI_Char *resultClass,
    _In_opt_z_ const MI_Char *role, MI_Boolean keysOnly,
    _In_opt_ MI_OperationCallbacks *callbacks, _Out_ MI_Operation *operation) {
  if (session && session->ft) {
...
** must call MI_Operation_GetIndication to receive the objects, once for each
* object
** until the operation return code is also included.  Even if the operation is
** cancelled the client must still call MI_Operation_GetIndication until the
* return
** code is given.
**
**=============================================================================
...
**=============================================================================
*/
MI_INLINE void MI_Session_GetClass(_In_ MI_Session *session, MI_Uint32 flags,
                                   _In_opt_ MI_OperationOptions *options,
                                   _In_opt_z_ const MI_Char *namespaceName,
                                   _In_opt_z_ const MI_Char *className,
                                   _In_opt_ MI_OperationCallbacks *callbacks,
...
MI_INLINE void MI_Session_EnumerateClasses(
    ...
    _In_opt_ MI_OperationOptions *options,
    _In_opt_z_ const MI_Char *namespaceName,
    _In_opt_z_ const MI_Char *className, MI_Boolean classNamesOnly,
    _In_opt_ MI_OperationCallbacks *callbacks, _Out_ MI_Operation *operation) {
  if (session && session->ft) {
...
MI_INLINE void
MI_Session_TestConnection(_In_ MI_Session *session, MI_Uint32 flags,
                          _In_opt_ MI_OperationCallbacks *callbacks,
                          _Out_ MI_Operation *operation) {
  if (session && session->ft) {
...
** operation.
** This is asynchronous if the operation is asynchronous, or synchronous and
* blocks
** if the operation is synchronous.
**
**=============================================================================
*/
MI_INLINE MI_Result MI_Operation_Close(_Inout_ MI_Operation *operation) {
  if (operation && operation->ft) {
...
** MI_Operation_Cancel()
**
** Cancels a running operation.  All results need to be consumed until
* moreResults
** returns MI_FALSE.  The operation also must still be closed with
* MI_Operation_Close.
**=============================================================================
*/
MI_INLINE MI_Result MI_Operation_Cancel(_Inout_ MI_Operation *operation,
                                        MI_CancellationReason reason) {
  if (operation && operation->ft) {
...
**=============================================================================
*/
MI_INLINE MI_Result MI_Operation_GetSession(_In_ MI_Operation *operation,
                                            _Out_ MI_Session *session) {
  if (session) {
    memset(session, 0, sizeof(MI_Session));
  }
...
*/
MI_INLINE void
MI_DestinationOptions_Delete(_Inout_ MI_DestinationOptions *options) {
...
MI_INLINE MI_Result MI_DestinationOptions_SetTimeout(
    _Inout_ MI_DestinationOptions *options, _In_ const MI_Interval *timeout) {
  if (options && options->ft) {
...
MI_INLINE MI_Result MI_DestinationOptions_GetTimeout(
    _In_ MI_DestinationOptions *options, _Out_ MI_Interval *timeout) {
  if (options && options->ft) {
...
MI_INLINE MI_Result MI_DestinationOptions_SetCertCACheck(
    _Inout_ MI_DestinationOptions *options, MI_Boolean check) {
  if (options && options->ft) {
...
MI_INLINE MI_Result MI_DestinationOptions_GetCertCACheck(
    _In_ MI_DestinationOptions *options, _Out_ MI_Boolean *check) {
  if (options && options->ft) {
    MI_Uint32 value;
...
MI_INLINE MI_Result MI_DestinationOptions_SetPacketPrivacy(
    _Inout_ MI_DestinationOptions *options, MI_Boolean privacy) {
  if (options && options->ft) {
    return options->ft->SetNumber(
...
MI_INLINE MI_Result MI_DestinationOptions_GetPacketPrivacy(
    _In_ MI_DestinationOptions *options, _Out_ MI_Boolean *privacy) {
  if (options && options->ft) {
    MI_Uint32 value;
    MI_Result result = options->ft->GetNumber(
...
MI_INLINE MI_Result MI_DestinationOptions_SetPacketIntegrity(
    _Inout_ MI_DestinationOptions *options, MI_Boolean integrity) {
  if (options && options->ft) {
    return options->ft->SetNumber(
...
MI_INLINE MI_Result MI_DestinationOptions_GetPacketIntegrity(
    _In_ MI_DestinationOptions *options, _Out_ MI_Boolean *integrity) {
  if (options && options->ft) {
    MI_Uint32 value;
    MI_Result result = options->ft->GetNumber(
...
MI_INLINE MI_Result MI_DestinationOptions_SetPacketEncoding(
    _Inout_ MI_DestinationOptions *options, _In_z_ const MI_Char *encoding) {
  if (options && options->ft) {
...
MI_INLINE MI_Result MI_DestinationOptions_SetDataLocale(
    _Inout_ MI_DestinationOptions *options, _In_z_ const MI_Char *locale) {
  if (options && options->ft) {
    return options->ft->SetString(
...
*/
MI_INLINE MI_Result
MI_DestinationOptions_GetDataLocale(_In_ MI_DestinationOptions *options,
...
*/
MI_INLINE MI_Result
MI_DestinationOptions_GetUILocale(_In_ MI_DestinationOptions *options,
                                  _Outptr_result_z_ const MI_Char **locale) {
  if (options && options->ft) {
    return options->ft->GetString(
...
MI_INLINE MI_Result MI_DestinationOptions_SetMaxEnvelopeSize(
    _Inout_ MI_DestinationOptions *options, MI_Uint32 sizeInKB) {
  if (options && options->ft) {
    return options->ft->SetNumber(
...
MI_INLINE MI_Result MI_DestinationOptions_GetMaxEnvelopeSize(
    _In_ MI_DestinationOptions *options, _Out_ MI_Uint32 *sizeInKB) {
  if (options && options->ft) {
...
MI_INLINE MI_Result MI_DestinationOptions_SetEncodePortInSPN(
    _Inout_ MI_DestinationOptions *options, MI_Boolean encodePort) {
  if (options && options->ft) {
    return options->ft->SetNumber(
...
MI_INLINE MI_Result MI_DestinationOptions_GetEncodePortInSPN(
    _In_ MI_DestinationOptions *options, _Out_ MI_Boolean *encodePort) {
  if (options && options->ft) {
    MI_Uint32 value;
    MI_Result result = options->ft->GetNumber(
...
**
**Specific to HTTP/HTTP based transports, WinRM default is /wsman, other
* transports are transports/protocols specific
**=============================================================================
*/
MI_INLINE MI_Result MI_DestinationOptions_SetHttpUrlPrefix(
    _Inout_ MI_DestinationOptions *options, _In_z_ const MI_Char *prefix) {
  if (options && options->ft) {
    return options->ft->SetString(
...
MI_INLINE MI_Result MI_DestinationOptions_SetDestinationPort(
    _Inout_ MI_DestinationOptions *options, MI_Uint32 port) {
  if (options && options->ft) {
    return options->ft->SetNumber(
...
MI_INLINE MI_Result MI_DestinationOptions_GetDestinationPort(
    _In_ MI_DestinationOptions *options, _Out_ MI_Uint32 *port) {
  if (options && options->ft) {
    return options->ft->GetNumber(
...
**=============================================================================
*/
/*Transports vary depending on protocol.  For WSMAN, HTTP and HTTPS are
 * supported */
...
MI_INLINE MI_Result MI_DestinationOptions_SetTransport(
    _Inout_ MI_DestinationOptions *options, _In_z_ const MI_Char *transport) {
  if (options && options->ft) {
    return options->ft->SetString(
...
MI_INLINE MI_Result MI_DestinationOptions_SetProxyType(
    _Inout_ MI_DestinationOptions *options, _In_z_ const MI_Char *proxyType) {
  if (options && options->ft) {
    return options->ft->SetString(
...
MI_INLINE MI_Result MI_DestinationOptions_SetString(
    _Inout_ MI_DestinationOptions *options, _In_z_ const MI_Char *optionName,
...
MI_INLINE MI_Result MI_DestinationOptions_GetString(
    _In_ MI_DestinationOptions *options, _In_z_ const MI_Char *optionName,
    _Outptr_result_z_ const MI_Char **optionValue, _Out_opt_ MI_Uint32 *index) {
  if (options && options->ft) {
...
MI_INLINE MI_Result MI_DestinationOptions_GetNumber(
    _In_ MI_DestinationOptions *options, _In_z_ const MI_Char *optionName,
    _Out_ MI_Uint32 *optionValue, _Out_opt_ MI_Uint32 *index) {
  if (options && options->ft) {
...
MI_INLINE MI_Result MI_DestinationOptions_GetOptionCount(
    _In_ MI_DestinationOptions *options, _Out_ MI_Uint32 *count) {
  if (options && options->ft) {
...
MI_INLINE MI_Result MI_DestinationOptions_GetOptionAt(
    _In_ MI_DestinationOptions *options, MI_Uint32 index,
    _Outptr_result_z_ const MI_Char **optionName, _Out_ MI_Value *value,
    _Out_ MI_Type *type, _Out_opt_ MI_Uint32 *flags) {
  if (options && options->ft) {
...
MI_INLINE MI_Result MI_DestinationOptions_GetOption(
    _In_ MI_DestinationOptions *options, _In_z_ const MI_Char *optionName,
    _Out_ MI_Value *value, _Out_ MI_Type *type, _Out_opt_ MI_Uint32 *index,
    _Out_opt_ MI_Uint32 *flags) {
  if (options && options->ft) {
...
** The new destination options should eventually be passed to
* MI_DestinationOptions_Delete().
**
** param: self pointer to the destination options to be cloned.
** param: newDestinationOptions a pointer to the new destination options upon
* return.
**
** return: MI_RESULT_OK, MI_RESULT_FAILED, MI_RESULT_INVALID_PARAMETER
**
...
*/
MI_INLINE void
MI_OperationOptions_Delete(_Inout_ MI_OperationOptions *options) {
  if (options && options->ft) {
    options->ft->Delete(options);
  }
}
...
MI_INLINE MI_Result MI_OperationOptions_SetWriteErrorMode(
    _Inout_ MI_OperationOptions *options, _In_ MI_CallbackMode mode) {
  if (options && options->ft) {
    return options->ft->SetNumber(
...
MI_INLINE MI_Result MI_OperationOptions_GetWriteErrorMode(
    _In_ MI_OperationOptions *options, _Out_ MI_CallbackMode *mode) {
  if (options && options->ft) {
    MI_Uint32 value;
    MI_Result result = options->ft->GetNumber(
...
MI_INLINE MI_Result MI_OperationOptions_GetPromptUserRegularMode(
    _Inout_ MI_OperationOptions *options, _Out_ MI_CallbackMode *mode,
...
MI_INLINE MI_Result MI_OperationOptions_SetProviderArchitecture(
    ...
    _In_ MI_ProviderArchitecture architecture, _In_ MI_Boolean mustComply) {
  if (options && options->ft) {
    MI_Result result = options->ft->SetNumber(
...
MI_INLINE MI_Result MI_OperationOptions_GetProviderArchitecture(
    ...
    _Out_ MI_ProviderArchitecture *architecture, _Out_ MI_Boolean *mustComply) {
  if (options && options->ft) {
...
MI_INLINE MI_Result MI_OperationOptions_EnableChannel(
    _Inout_ MI_OperationOptions *options, _In_ MI_Uint32 channel) {
  if (options && options->ft) {
    return options->ft->SetNumber(
...
MI_INLINE MI_Result MI_OperationOptions_SetTimeout(
    _Inout_ MI_OperationOptions *options, _In_ const MI_Interval *timeout) {
  if (options && options->ft) {
    return options->ft->SetInterval(
...
MI_INLINE MI_Result MI_OperationOptions_GetTimeout(
    _In_ MI_OperationOptions *options, _Out_ MI_Interval *timeout) {
  if (options && options->ft) {
    return options->ft->GetInterval(
...
MI_INLINE MI_Result MI_OperationOptions_SetResourceUriPrefix(
    _Inout_ MI_OperationOptions *options, _In_z_ const MI_Char *ruriPrefix) {
  if (options && options->ft) {
    return options->ft->SetString(
...
MI_INLINE MI_Result MI_OperationOptions_SetResourceUri(
    _Inout_ MI_OperationOptions *options, _In_z_ const MI_Char *rUri) {
  if (options && options->ft) {
    return options->ft->SetString(
...
MI_INLINE MI_Result MI_OperationOptions_GetResourceUri(
    _In_ MI_OperationOptions *options, _Outptr_result_z_ const MI_Char **rUri) {
  if (options && options->ft) {
    return options->ft->GetString(
...
MI_INLINE MI_Result MI_OperationOptions_SetUseMachineID(
    _Inout_ MI_OperationOptions *options, _In_ MI_Boolean machineID) {
  if (options && options->ft) {
    return options->ft->SetNumber(
...
MI_INLINE MI_Result MI_OperationOptions_GetUseMachineID(
    _In_ MI_OperationOptions *options, _Out_ MI_Boolean *machineID) {
  if (options && options->ft) {
    MI_Uint32 value;
    MI_Result result = options->ft->GetNumber(
...
MI_INLINE MI_Result MI_OperationOptions_SetCustomOption(
    _Inout_ MI_OperationOptions *options, _In_z_ const MI_Char *optionName,
    _In_ MI_Type optionValueType, _In_ const MI_Value *optionValue,
...
MI_INLINE MI_Result MI_OperationOptions_GetOptionCount(
    _In_ MI_OperationOptions *options, _Out_ MI_Uint32 *count) {
  if (options && options->ft) {
    return options->ft->GetOptionCount(options, count);
  } else {
    return MI_RESULT_INVALID_PARAMETER;
...
MI_INLINE MI_Result MI_OperationOptions_GetOptionAt(
    _In_ MI_OperationOptions *options, MI_Uint32 index,
    _Outptr_result_z_ const MI_Char **optionName, _Out_ MI_Value *value,
    _Out_ MI_Type *type, _Out_opt_ MI_Uint32 *flags) {
  if (options && options->ft) {
    return options->ft->GetOptionAt(options, index, optionName, value, type,
...
MI_INLINE MI_Result MI_OperationOptions_GetString(
    _In_ MI_OperationOptions *options, _In_z_ const MI_Char *optionName,
    _Outptr_result_z_ const MI_Char **value, _Out_opt_ MI_Uint32 *index,
    _Out_opt_ MI_Uint32 *flags) {
  if (options && options->ft) {
...
MI_INLINE MI_Result MI_OperationOptions_GetNumber(
    _In_ MI_OperationOptions *options, _In_z_ const MI_Char *optionName,
    _Out_ MI_Uint32 *value, _Out_opt_ MI_Uint32 *index,
    _Out_opt_ MI_Uint32 *flags) {
  if (options && options->ft) {
...
** The new operation options should eventually be passed to
* MI_OperationOptions_Delete().
**
** param: self pointer to the operation options to be cloned.
** param: newOperationOptions a pointer to the new operation options upon
* return.
**
** return: MI_RESULT_OK, MI_RESULT_FAILED, MI_RESULT_INVALID_PARAMETER
**
...
*/
MI_INLINE MI_Result MI_INLINE_CALL
MI_OperationOptions_Clone(_In_ const MI_OperationOptions *self,
                          _Out_ MI_OperationOptions *newOperationOptions) {
  if (self && self->ft) {
...
MI_INLINE MI_Result
MI_Class_GetClassName(_In_ const MI_Class *self,
                      _Outptr_result_maybenull_z_ const MI_Char **className) {
  if (self && self->ft) {
    return self->ft->GetClassName(self, className);
  } else {
...
MI_INLINE MI_Result
MI_Class_GetNameSpace(_In_ const MI_Class *self,
                      _Outptr_result_maybenull_z_ const MI_Char **nameSpace) {
  if (self && self->ft) {
    return self->ft->GetNameSpace(self, nameSpace);
  } else {
...
MI_INLINE MI_Result
MI_Class_GetServerName(_In_ const MI_Class *self,
                       _Outptr_result_maybenull_z_ const MI_Char **serverName) {
  if (self && self->ft) {
...
MI_INLINE MI_Result MI_Class_GetElementCount(_In_ const MI_Class *self,
                                             _Out_ MI_Uint32 *count) {
  if (self && self->ft) {
    return self->ft->GetElementCount(self, count);
  } else {
...
MI_INLINE MI_Result
MI_Class_GetElement(_In_ const MI_Class *self, _In_z_ const MI_Char *name,
                    _Out_opt_ MI_Value *value,
                    _Out_opt_ MI_Boolean *valueExists, _Out_opt_ MI_Type *type,
                    _Outptr_opt_result_maybenull_z_ MI_Char **referenceClass,
                    _Out_opt_ MI_QualifierSet *qualifierSet,
                    _Out_opt_ MI_Uint32 *flags, _Out_opt_ MI_Uint32 *index) {
  if (self && self->ft) {
...
MI_INLINE MI_Result MI_Class_GetMethodCount(_In_ const MI_Class *self,
                                            _Out_ MI_Uint32 *count) {
  if (self && self->ft) {
...
MI_INLINE MI_Result
MI_Class_GetMethodAt(_In_ const MI_Class *self, MI_Uint32 index,
                     _Outptr_result_z_ const MI_Char **name,
                     _Out_opt_ MI_QualifierSet *qualifierSet,
                     _Out_opt_ MI_ParameterSet *parameterSet) {
  if (self && self->ft) {
...
MI_INLINE MI_Result MI_Class_GetMethod(_In_ const MI_Class *self,
                                       _In_z_ const MI_Char *name,
                                       _Out_opt_ MI_QualifierSet *qualifierSet,
                                       _Out_opt_ MI_ParameterSet *parameterSet,
                                       _Out_opt_ MI_Uint32 *index) {
...
MI_INLINE MI_Result
MI_Class_GetParentClassName(_In_ const MI_Class *self,
                            _Outptr_result_maybenull_z_ const MI_Char **name) {
  if (self && self->ft) {
...
MI_INLINE MI_Result MI_Class_GetParentClass(_In_ const MI_Class *self,
                                            _Outptr_ MI_Class **parentClass) {
  if (self && self->ft) {
...
MI_INLINE MI_Result MI_Class_Delete(_Inout_ MI_Class *self) {
  if (self && self->ft) {
    return self->ft->Delete(self);
  } else {
    return MI_RESULT_INVALID_PARAMETER;
...
MI_INLINE MI_Result MI_INLINE_CALL
MI_Class_Clone(_In_ const MI_Class *self, _Outptr_ MI_Class **newClass) {
  if (self && self->ft) {
...
MI_INLINE MI_Result MI_ParameterSet_GetMethodReturnType(
    _In_ const MI_ParameterSet *self, _Out_ MI_Type *returnType,
    _Out_ MI_QualifierSet *qualifierSet) {
  if (self && self->ft) {
...
MI_INLINE MI_Result MI_ParameterSet_GetParameterCount(
    _In_ const MI_ParameterSet *self, _Out_ MI_Uint32 *count) {
  if (self && self->ft) {
...
MI_INLINE MI_Result MI_ParameterSet_GetParameterAt(
    _In_ const MI_ParameterSet *self, MI_Uint32 index,
    _Outptr_result_z_ const MI_Char **name, _Out_ MI_Type *parameterType,
    _Outptr_opt_result_maybenull_z_ MI_Char **referenceClass,
    _Out_ MI_QualifierSet *qualifierSet) {
  if (self && self->ft) {
...
MI_INLINE MI_Result MI_QualifierSet_GetQualifierCount(
    _In_ const MI_QualifierSet *self, _Out_ MI_Uint32 *count) {
  if (self && self->ft) {
...
MI_INLINE MI_Result MI_SubscriptionDeliveryOptions_SetMaximumLatency(
    _Inout_ MI_SubscriptionDeliveryOptions *self, _In_ MI_Interval *value) {
  if (self && self->ft) {
...
MI_INLINE MI_Result MI_SubscriptionDeliveryOptions_GetMaximumLatency(
    _In_ MI_SubscriptionDeliveryOptions *self, _Out_ MI_Interval *value) {
  if (self && self->ft) {
...
MI_INLINE MI_Result MI_SubscriptionDeliveryOptions_SetExpirationTime(
    _Inout_ MI_SubscriptionDeliveryOptions *self, _In_ MI_Datetime *value) {
  if (self && self->ft) {
...
MI_INLINE MI_Result MI_SubscriptionDeliveryOptions_GetExpirationTime(
    _Inout_ MI_SubscriptionDeliveryOptions *self, _Out_ MI_Datetime *value) {
  if (self && self->ft) {
 ...
 * To start delivering from the latest events only specify
 * MI_SUBSCRIBE_BOOKMARK_NEWEST. To start delivering from a previously sent
 * bookmark (if possible) pass in the boookmark value that was delivered with
 * the last event. If no bookmark is set then the providers may not deliver
 * bookmarks with the events.
 */
...
MI_INLINE MI_Result MI_SubscriptionDeliveryOptions_SetBookmark(
    _Inout_ MI_SubscriptionDeliveryOptions *self, _In_z_ const MI_Char *value) {
  if (self && self->ft) {
...
MI_INLINE MI_Result MI_SubscriptionDeliveryOptions_SetDeliveryPortNumber(
    _Inout_ MI_SubscriptionDeliveryOptions *self, _In_ MI_Uint32 value) {
  if (self && self->ft) {
...
MI_INLINE MI_Result MI_SubscriptionDeliveryOptions_GetDeliveryPortNumber(
    _In_ MI_SubscriptionDeliveryOptions *self, _Out_ MI_Uint32 *value) {
  if (self && self->ft) {
...
MI_INLINE MI_Result MI_SubscriptionDeliveryOptions_SetString(
    _Inout_ MI_SubscriptionDeliveryOptions *self,
    _In_z_ const MI_Char *optionName, _In_z_ const MI_Char *value,
    MI_Uint32 flags) {
  if (self && self->ft) {
...
MI_INLINE MI_Result MI_SubscriptionDeliveryOptions_SetNumber(
    _Inout_ MI_SubscriptionDeliveryOptions *self,
    _In_z_ const MI_Char *optionName, _In_ MI_Uint32 value, MI_Uint32 flags) {
  if (self && self->ft) {
...
MI_INLINE MI_Result MI_SubscriptionDeliveryOptions_GetString(
    _In_ MI_SubscriptionDeliveryOptions *self, _In_z_ const MI_Char *optionName,
    _Outptr_result_z_ const MI_Char **value, _Out_opt_ MI_Uint32 *index,
    _Out_opt_ MI_Uint32 *flags) {
  if (self && self->ft) {
...
MI_INLINE MI_Result MI_SubscriptionDeliveryOptions_GetNumber(
    _Inout_ MI_SubscriptionDeliveryOptions *self,
    _In_z_ const MI_Char *optionName, _Out_ MI_Uint32 *value,
    _Out_opt_ MI_Uint32 *index, _Out_opt_ MI_Uint32 *flags) {
  if (self && self->ft) {
...
MI_INLINE MI_Result MI_SubscriptionDeliveryOptions_GetDateTime(
    _In_ MI_SubscriptionDeliveryOptions *self, _In_z_ const MI_Char *optionName,
    _Out_ MI_Datetime *value, _Out_opt_ MI_Uint32 *index,
    _Out_opt_ MI_Uint32 *flags) {
  if (self && self->ft) {
...
MI_INLINE MI_Result MI_SubscriptionDeliveryOptions_GetInterval(
    _In_ MI_SubscriptionDeliveryOptions *self, _In_z_ const MI_Char *optionName,
    _Out_ MI_Interval *value, _Out_opt_ MI_Uint32 *index,
    _Out_opt_ MI_Uint32 *flags) {
  if (self && self->ft) {
...
MI_INLINE MI_Result MI_SubscriptionDeliveryOptions_GetOptionCount(
    _In_ MI_SubscriptionDeliveryOptions *self, _Out_opt_ MI_Uint32 *count) {
  if (self && self->ft) {
...
MI_INLINE MI_Result MI_SubscriptionDeliveryOptions_GetOptionAt(
    _In_ MI_SubscriptionDeliveryOptions *self, MI_Uint32 index,
    _Outptr_result_z_ const MI_Char **optionName, _Out_ MI_Value *value,
    _Out_ MI_Type *type, _Out_opt_ MI_Uint32 *flags) {
  if (self && self->ft) {
...
MI_INLINE MI_Result MI_SubscriptionDeliveryOptions_GetCredentialsCount(
    _In_ MI_SubscriptionDeliveryOptions *self, _Out_ MI_Uint32 *count) {
  if (self && self->ft) {
...
/**
 * This function creates a copy of the given MI_SubscriptionDeliveryOptions.
 * Upon a successful return, new MI_SubscriptionDeliveryOptions points to a
 * newly created delivery options. The new delivery options should eventually be
 * passed to MI_SubscriptionDeliveryOptions_Delete().
 *
 * param: self pointer to the delivery options to be cloned.
 * param: newSubscriptionDeliveryOptions a pointer to the new delivery options
 * upon return.
 *
 * return: MI_RESULT_OK, MI_RESULT_FAILED, MI_RESULT_INVALID_PARAMETER
 *
...
MI_INLINE MI_Result MI_Serializer_Close(_Inout_ MI_Serializer *serializer) {
  return mi_clientFT->serializerFT->Close(serializer);
}

MI_INLINE MI_Result MI_Serializer_SerializeClass(
    _Inout_ MI_Serializer *serializer, MI_Uint32 flags,
    _In_ const MI_Class *classObject,
    _Out_writes_bytes_(clientBufferLength) MI_Uint8 *clientBuffer,
    MI_Uint32 clientBufferLength, _Inout_ MI_Uint32 *clientBufferNeeded) {
...
MI_INLINE MI_Result
MI_Deserializer_Close(_Inout_ MI_Deserializer *deserializer) {
...
MI_INLINE MI_Result MI_Utilities_CimErrorFromErrorCode(
    MI_Uint32 error, _In_z_ const MI_Char *errorType,
    _In_z_ const MI_Char *errorMessage, _Outptr_ MI_Instance **cimError) {
