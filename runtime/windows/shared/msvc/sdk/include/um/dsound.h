...
extern _Check_return_ HRESULT WINAPI
DirectSoundCreate(_In_opt_ LPCGUID pcGuidDevice, _Outptr_ LPDIRECTSOUND *ppDS,
                  _Pre_null_ LPUNKNOWN pUnkOuter);
extern HRESULT WINAPI DirectSoundEnumerateA(
    _In_ LPDSENUMCALLBACKA pDSEnumCallback, _In_opt_ LPVOID pContext);
extern HRESULT WINAPI DirectSoundEnumerateW(
    _In_ LPDSENUMCALLBACKW pDSEnumCallback, _In_opt_ LPVOID pContext);

extern HRESULT WINAPI DirectSoundCaptureCreate(
    _In_opt_ LPCGUID pcGuidDevice, _Outptr_ LPDIRECTSOUNDCAPTURE *ppDSC,
    _Pre_null_ LPUNKNOWN pUnkOuter);
...
#if DIRECTSOUND_VERSION >= 0x0800
extern HRESULT WINAPI DirectSoundCreate8(_In_opt_ LPCGUID pcGuidDevice,
                                         _Outptr_ LPDIRECTSOUND8 *ppDS8,
                                         _Pre_null_ LPUNKNOWN pUnkOuter);
extern HRESULT WINAPI DirectSoundCaptureCreate8(
    _In_opt_ LPCGUID pcGuidDevice, _Outptr_ LPDIRECTSOUNDCAPTURE8 *ppDSC8,
    _Pre_null_ LPUNKNOWN pUnkOuter);
extern HRESULT WINAPI DirectSoundFullDuplexCreate(
    _In_opt_ LPCGUID pcGuidCaptureDevice, _In_opt_ LPCGUID pcGuidRenderDevice,
    _In_ LPCDSCBUFFERDESC pcDSCBufferDesc, _In_ LPCDSBUFFERDESC pcDSBufferDesc,
    HWND hWnd, DWORD dwLevel, _Outptr_ LPDIRECTSOUNDFULLDUPLEX *ppDSFD,
    _Outptr_ LPDIRECTSOUNDCAPTUREBUFFER8 *ppDSCBuffer8,
    _Outptr_ LPDIRECTSOUNDBUFFER8 *ppDSBuffer8, _Pre_null_ LPUNKNOWN pUnkOuter);
#define DirectSoundFullDuplexCreate8 DirectSoundFullDuplexCreate

extern HRESULT WINAPI GetDeviceID(_In_opt_ LPCGUID pGuidSrc,
...
DECLARE_INTERFACE_(IReferenceClock, IUnknown) {
  ...
  STDMETHOD(AdviseTime)(THIS_ REFERENCE_TIME rtBaseTime,
                        REFERENCE_TIME rtStreamTime, HANDLE hEvent,
                        _Out_ LPDWORD pdwAdviseCookie) PURE;
  STDMETHOD(AdvisePeriodic)(THIS_ REFERENCE_TIME rtStartTime,
                            REFERENCE_TIME rtPeriodTime, HANDLE hSemaphore,
                            _Out_ LPDWORD pdwAdviseCookie) PURE;
...
DECLARE_INTERFACE_(IDirectSound, IUnknown) {
  ...
  STDMETHOD(CreateSoundBuffer)(THIS_ _In_ LPCDSBUFFERDESC pcDSBufferDesc,
                               _Outptr_ LPDIRECTSOUNDBUFFER * ppDSBuffer,
                               _Pre_null_ LPUNKNOWN pUnkOuter) PURE;
  STDMETHOD(GetCaps)(THIS_ _Out_ LPDSCAPS pDSCaps) PURE;
  STDMETHOD(DuplicateSoundBuffer)(
      THIS_ _In_ LPDIRECTSOUNDBUFFER pDSBufferOriginal,
...
DECLARE_INTERFACE_(IDirectSound8, IDirectSound) {
  ...
  // IDirectSound methods
  STDMETHOD(CreateSoundBuffer)(THIS_ _In_ LPCDSBUFFERDESC pcDSBufferDesc,
                               _Out_ LPDIRECTSOUNDBUFFER * ppDSBuffer,
                               _Pre_null_ LPUNKNOWN pUnkOuter) PURE;
  STDMETHOD(GetCaps)(THIS_ _Out_ LPDSCAPS pDSCaps) PURE;
  STDMETHOD(DuplicateSoundBuffer)(
      THIS_ _In_ LPDIRECTSOUNDBUFFER pDSBufferOriginal,
...
DECLARE_INTERFACE_(IDirectSoundBuffer, IUnknown) {
  ...
  STDMETHOD(GetCurrentPosition)(THIS_ _Out_opt_ LPDWORD pdwCurrentPlayCursor,
                                _Out_opt_ LPDWORD pdwCurrentWriteCursor) PURE;
  STDMETHOD(GetFormat)(
      THIS_ _Out_writes_bytes_opt_(dwSizeAllocated) LPWAVEFORMATEX pwfxFormat,
      DWORD dwSizeAllocated, _Out_opt_ LPDWORD pdwSizeWritten) PURE;
  ...
  STDMETHOD(Initialize)(THIS_ _In_ LPDIRECTSOUND pDirectSound,
                        _In_ LPCDSBUFFERDESC pcDSBufferDesc) PURE;
  STDMETHOD(Lock)(
      THIS_ DWORD dwOffset, DWORD dwBytes,
      _Outptr_result_bytebuffer_(*pdwAudioBytes1) LPVOID * ppvAudioPtr1,
      _Out_ LPDWORD pdwAudioBytes1,
      _Outptr_opt_result_bytebuffer_(*pdwAudioBytes2) LPVOID * ppvAudioPtr2,
      _Out_opt_ LPDWORD pdwAudioBytes2, DWORD dwFlags) PURE;
  ...
  STDMETHOD(Unlock)(THIS_ _In_reads_bytes_(dwAudioBytes1) LPVOID pvAudioPtr1,
                    DWORD dwAudioBytes1,
                    _In_reads_bytes_opt_(dwAudioBytes2) LPVOID pvAudioPtr2,
...
DECLARE_INTERFACE_(IDirectSoundBuffer8, IDirectSoundBuffer) {
  ...
  STDMETHOD(SetFX)(THIS_ DWORD dwEffectsCount,
                   _In_reads_opt_(dwEffectsCount) LPDSEFFECTDESC pDSFXDesc,
                   _Out_writes_opt_(dwEffectsCount) LPDWORD pdwResultCodes)
      PURE;
  STDMETHOD(AcquireResources)(THIS_ DWORD dwFlags, DWORD dwEffectsCount,
                              _Out_writes_(dwEffectsCount)
                                  LPDWORD pdwResultCodes) PURE;
  STDMETHOD(GetObjectInPath)(THIS_ _In_ REFGUID rguidObject, DWORD dwIndex,
                             _In_ REFGUID rguidInterface,
                             _Outptr_ LPVOID * ppObject) PURE;
};
...
DECLARE_INTERFACE_(IDirectSound3DListener, IUnknown) {
  ...
  STDMETHOD(GetOrientation)(THIS_ _Out_ D3DVECTOR * pvOrientFront,
                            _Out_ D3DVECTOR * pvOrientTop) PURE;
  ...
  STDMETHOD(SetAllParameters)(THIS_ _In_ LPCDS3DLISTENER pcListener,
                              DWORD dwApply) PURE;
...
DECLARE_INTERFACE_(IDirectSound3DBuffer, IUnknown) {
  ...
  STDMETHOD(GetConeAngles)(THIS_ _Out_ LPDWORD pdwInsideConeAngle,
                           _Out_ LPDWORD pdwOutsideConeAngle) PURE;
  ...
  STDMETHOD(GetPosition)(THIS_ _Out_ D3DVECTOR * pvPosition) PURE;
  STDMETHOD(GetVelocity)(THIS_ _Out_ D3DVECTOR * pvVelocity) PURE;
  STDMETHOD(SetAllParameters)(THIS_ _In_ LPCDS3DBUFFER pcDs3dBuffer,
                              DWORD dwApply) PURE;
...
DECLARE_INTERFACE_(IDirectSoundCapture, IUnknown) {
  ...
  STDMETHOD(CreateCaptureBuffer)(THIS_ _In_ LPCDSCBUFFERDESC pcDSCBufferDesc,
                                 _Outptr_ LPDIRECTSOUNDCAPTUREBUFFER *
                                     ppDSCBuffer,
                                 _Pre_null_ LPUNKNOWN pUnkOuter) PURE;
...
DECLARE_INTERFACE_(IDirectSoundCaptureBuffer, IUnknown) {
  ...
  STDMETHOD(GetCurrentPosition)(THIS_ _Out_opt_ LPDWORD pdwCapturePosition,
                                _Out_opt_ LPDWORD pdwReadPosition) PURE;
  STDMETHOD(GetFormat)(
      THIS_ _Out_writes_bytes_opt_(dwSizeAllocated) LPWAVEFORMATEX pwfxFormat,
      DWORD dwSizeAllocated, _Out_opt_ LPDWORD pdwSizeWritten) PURE;
  STDMETHOD(GetStatus)(THIS_ _Out_ LPDWORD pdwStatus) PURE;
  STDMETHOD(Initialize)(THIS_ _In_ LPDIRECTSOUNDCAPTURE pDirectSoundCapture,
                        _In_ LPCDSCBUFFERDESC pcDSCBufferDesc) PURE;
  STDMETHOD(Lock)(
      THIS_ DWORD dwOffset, DWORD dwBytes,
      _Outptr_result_bytebuffer_(*pdwAudioBytes1) LPVOID * ppvAudioPtr1,
      _Out_ LPDWORD pdwAudioBytes1,
...
DECLARE_INTERFACE_(IDirectSoundCaptureBuffer8, IDirectSoundCaptureBuffer) {
  ...
  STDMETHOD(GetObjectInPath)(THIS_ _In_ REFGUID rguidObject, DWORD dwIndex,
                             _In_ REFGUID rguidInterface,
                             _Outptr_ LPVOID * ppObject) PURE;
  STDMETHOD(GetFXStatus)(DWORD dwEffectsCount,
                         _Out_writes_(dwEffectsCount) LPDWORD pdwFXStatus) PURE;
};
...
DECLARE_INTERFACE_(IDirectSoundNotify, IUnknown) {
  ...
  STDMETHOD(SetNotificationPositions)(
      ...
      _In_reads_(dwPositionNotifies) LPCDSBPOSITIONNOTIFY pcPositionNotifies)
      PURE;
};
...
DECLARE_INTERFACE_(IKsPropertySet, IUnknown) {
  ...
  STDMETHOD(Get)(THIS_ _In_ REFGUID rguidPropSet, ULONG ulId,
                 _In_reads_bytes_opt_(ulInstanceLength) LPVOID pInstanceData,
                 ULONG ulInstanceLength,
                 _Out_writes_bytes_(ulDataLength) LPVOID pPropertyData,
                 ULONG ulDataLength, _Out_opt_ PULONG pulBytesReturned) PURE;
  STDMETHOD(Set)(THIS_ _In_ REFGUID rguidPropSet, ULONG ulId,
                 _In_reads_bytes_opt_(ulInstanceLength) LPVOID pInstanceData,
                 ULONG ulInstanceLength,
                 _In_reads_bytes_(ulDataLength) LPVOID pPropertyData,
                 ULONG ulDataLength) PURE;
  STDMETHOD(QuerySupport)(THIS_ _In_ REFGUID rguidPropSet, ULONG ulId,
                          _Out_ PULONG pulTypeSupport) PURE;
};
...
DECLARE_INTERFACE_(IDirectSoundCaptureFXNoiseSuppress, IUnknown) {
  ...
  STDMETHOD(SetAllParameters)(
      THIS_ _In_ LPCDSCFXNoiseSuppress pcDscFxNoiseSuppress) PURE;
  STDMETHOD(GetAllParameters)(
      THIS_ _Out_ LPDSCFXNoiseSuppress pDscFxNoiseSuppress) PURE;
  STDMETHOD(Reset)(THIS) PURE;
};
...
DECLARE_INTERFACE_(IDirectSoundFullDuplex, IUnknown) {
  ...
  STDMETHOD(Initialize)(
      THIS_ _In_ LPCGUID pCaptureGuid, _In_ LPCGUID pRenderGuid,
      _In_ LPCDSCBUFFERDESC lpDscBufferDesc,
      _In_ LPCDSBUFFERDESC lpDsBufferDesc, HWND hWnd, DWORD dwLevel,
      _Outptr_ LPLPDIRECTSOUNDCAPTUREBUFFER8 lplpDirectSoundCaptureBuffer8,
      _Outptr_ LPLPDIRECTSOUNDBUFFER8 lplpDirectSoundBuffer8) PURE;
};
