...
typedef struct IInkD2DRendererVtbl {
  ...
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in IInkD2DRenderer *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IInkD2DRenderer *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IInkD2DRenderer *This);
...
interface IInkD2DRenderer { CONST_VTBL struct IInkD2DRendererVtbl *lpVtbl; };
...
#define IInkD2DRenderer_AddRef(This) ((This)->lpVtbl->AddRef(This))

#define IInkD2DRenderer_Release(This) ((This)->lpVtbl->Release(This))

#define IInkD2DRenderer_Draw(This, pD2D1DeviceContext, pInkStrokeIterable,     \
                             fHighContrast)                                    \
  ((This)->lpVtbl->Draw(This, pD2D1DeviceContext, pInkStrokeIterable,          \
                        fHighContrast))
...
typedef struct IInkD2DRenderer2Vtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in IInkD2DRenderer2 *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IInkD2DRenderer2 *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IInkD2DRenderer2 *This);
...
interface IInkD2DRenderer2 { CONST_VTBL struct IInkD2DRenderer2Vtbl *lpVtbl; };
...
#define IInkD2DRenderer2_AddRef(This) ((This)->lpVtbl->AddRef(This))

#define IInkD2DRenderer2_Release(This) ((This)->lpVtbl->Release(This))

#define IInkD2DRenderer2_Draw(This, pD2D1DeviceContext, pInkStrokeIterable,    \
...
class DECLSPEC_UUID("4044e60c-7b01-4671-a97c-04e0210a07a5") InkD2DRenderer;
#endif
