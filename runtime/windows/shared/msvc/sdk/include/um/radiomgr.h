...
typedef struct IMediaRadioManagerVtbl {
  ...
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(IMediaRadioManager *This,
                                             /* [in] */ REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(IMediaRadioManager *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(IMediaRadioManager *This);
...
#define IMediaRadioManager_OnSystemRadioStateChange(This, sysRadioState,       \
                                                    uTimeoutSec)               \
...
typedef struct IRadioInstanceCollectionVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(IRadioInstanceCollection *This,
                                             /* [in] */ REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(IRadioInstanceCollection *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(IRadioInstanceCollection *This);

  DECLSPEC_XFGVIRT(IRadioInstanceCollection, GetCount)
  HRESULT(STDMETHODCALLTYPE *GetCount)(IRadioInstanceCollection *This,
...
typedef struct IRadioInstanceVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(IRadioInstance *This,
                                             /* [in] */ REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(IRadioInstance *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(IRadioInstance *This);
  ...
  BOOL(STDMETHODCALLTYPE *IsMultiComm)(IRadioInstance *This);

  DECLSPEC_XFGVIRT(IRadioInstance, IsAssociatingDevice)
  BOOL(STDMETHODCALLTYPE *IsAssociatingDevice)(IRadioInstance *This);

  END_INTERFACE
} IRadioInstanceVtbl;

interface IRadioInstance { CONST_VTBL struct IRadioInstanceVtbl *lpVtbl; };
...
typedef struct IMediaRadioManagerNotifySinkVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(IMediaRadioManagerNotifySink *This,
                                             /* [in] */ REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(IMediaRadioManagerNotifySink *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(IMediaRadioManagerNotifySink *This);
...
#define IMediaRadioManagerNotifySink_OnInstanceRemove(This,                    \
                                                      bstrRadioInstanceId)     \
  ((This)->lpVtbl->OnInstanceRemove(This, bstrRadioInstanceId))

#define IMediaRadioManagerNotifySink_OnInstanceRadioChange(                    \
    This, bstrRadioInstanceId, radioState)                                     \
