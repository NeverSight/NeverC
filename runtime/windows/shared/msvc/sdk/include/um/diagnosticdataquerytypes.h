...
//--------------------------------------------------------------------------
//
//  IDL for defining Diagnostic API structures necessary for public consumption.
//  This, along with DiagnosticDataQueryTypes.h, are the only headers that
//  should be necessary for consuming the Diagnostic Data Query APIs. New
//  function definition must be added at the end of the file.
//
//--------------------------------------------------------------------------

extern RPC_IF_HANDLE
    RpcClient___MIDL_itf_diagnosticdataquerytypes_0000_0000_v0_0_c_ifspec;
extern RPC_IF_HANDLE
    __MIDL_itf_diagnosticdataquerytypes_0000_0000_v0_0_c_ifspec;
extern RPC_IF_HANDLE
    __MIDL_itf_diagnosticdataquerytypes_0000_0000_v0_0_s_ifspec;
...
typedef /* [ref] */ __RPC_ref_pointer DIAGNOSTIC_DATA_QUERY_SESSION
    *PDIAGNOSTIC_DATA_QUERY_SESSION;
