...
public:
  virtual /* [helpstring] */ HRESULT STDMETHODCALLTYPE RegisterTIFEx(
      ...
      /* [out][in] */ __RPC__deref_inout_opt IUnknown *
          *ppMpeg2DataControl) = 0;
...
typedef struct IBDA_TIF_REGISTRATIONVtbl {
  ...
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IBDA_TIF_REGISTRATION *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IBDA_TIF_REGISTRATION *This);
...
typedef struct IMPEG2_TIF_CONTROLVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in IMPEG2_TIF_CONTROL *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IMPEG2_TIF_CONTROL *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IMPEG2_TIF_CONTROL *This);
...
typedef struct ITuneRequestInfoVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in ITuneRequestInfo *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in ITuneRequestInfo *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in ITuneRequestInfo *This);
...
typedef struct ITuneRequestInfoExVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in ITuneRequestInfoEx *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in ITuneRequestInfoEx *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in ITuneRequestInfoEx *This);
...
#define ITuneRequestInfoEx_GetPreviousProgram(This, CurrentRequest,            \
                                              TuneRequest)                     \
  ((This)->lpVtbl->GetPreviousProgram(This, CurrentRequest, TuneRequest))
...
#define ITuneRequestInfoEx_GetPreviousLocator(This, CurrentRequest,            \
                                              TuneRequest)                     \
  ((This)->lpVtbl->GetPreviousLocator(This, CurrentRequest, TuneRequest))

#define ITuneRequestInfoEx_CreateComponentListEx(This, CurrentRequest,         \
                                                 ppCurPMT)                     \
...
typedef struct ISIInbandEPGEventVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in ISIInbandEPGEvent *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in ISIInbandEPGEvent *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in ISIInbandEPGEvent *This);
...
#define ISIInbandEPGEvent_SIObjectEvent(This, pIDVB_EIT, dwTable_ID,           \
                                        dwService_ID)                          \
...
typedef struct ISIInbandEPGVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in ISIInbandEPG *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in ISIInbandEPG *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in ISIInbandEPG *This);

  DECLSPEC_XFGVIRT(ISIInbandEPG, StartSIEPGScan)
  HRESULT(STDMETHODCALLTYPE *StartSIEPGScan)(__RPC__in ISIInbandEPG *This);

  DECLSPEC_XFGVIRT(ISIInbandEPG, StopSIEPGScan)
  HRESULT(STDMETHODCALLTYPE *StopSIEPGScan)(__RPC__in ISIInbandEPG *This);
...
interface ISIInbandEPG { CONST_VTBL struct ISIInbandEPGVtbl *lpVtbl; };
...
typedef struct IGuideDataEventVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in IGuideDataEvent *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IGuideDataEvent *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IGuideDataEvent *This);
...
typedef struct IGuideDataPropertyVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in IGuideDataProperty *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IGuideDataProperty *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IGuideDataProperty *This);
...
typedef struct IEnumGuideDataPropertiesVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IEnumGuideDataProperties *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IEnumGuideDataProperties *This);
  ...
  HRESULT(STDMETHODCALLTYPE *Skip)(__RPC__in IEnumGuideDataProperties *This,
                                   /* [in] */ unsigned long celt);

  DECLSPEC_XFGVIRT(IEnumGuideDataProperties, Reset)
  HRESULT(STDMETHODCALLTYPE *Reset)(__RPC__in IEnumGuideDataProperties *This);
...
typedef struct IEnumTuneRequestsVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in IEnumTuneRequests *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IEnumTuneRequests *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IEnumTuneRequests *This);
  ...
  HRESULT(STDMETHODCALLTYPE *Skip)(__RPC__in IEnumTuneRequests *This,
                                   /* [in] */ unsigned long celt);

  DECLSPEC_XFGVIRT(IEnumTuneRequests, Reset)
  HRESULT(STDMETHODCALLTYPE *Reset)(__RPC__in IEnumTuneRequests *This);
...
public:
  virtual /* [helpstring] */ HRESULT STDMETHODCALLTYPE GetServices(
      /* [retval][out] */ __RPC__deref_out_opt IEnumTuneRequests *
      *ppEnumTuneRequests) = 0;

  virtual /* [helpstring] */ HRESULT STDMETHODCALLTYPE GetServiceProperties(
      /* [in] */ __RPC__in_opt ITuneRequest * pTuneRequest,
      /* [retval][out] */ __RPC__deref_out_opt IEnumGuideDataProperties *
          *ppEnumProperties) = 0;
...
typedef struct IGuideDataVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in IGuideData *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IGuideData *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IGuideData *This);
...
typedef struct IGuideDataLoaderVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in IGuideDataLoader *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IGuideDataLoader *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IGuideDataLoader *This);
  ...
  HRESULT(STDMETHODCALLTYPE *Terminate)(__RPC__in IGuideDataLoader *This);
