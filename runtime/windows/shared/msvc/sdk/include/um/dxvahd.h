...
DEFINE_GUID(DXVAHD_STREAM_STATE_PRIVATE_IVTC, 0x9c601e3c, 0x0f33, 0x414c, 0xa7,
            0x39, 0x99, 0x54, 0x0e, 0xe4, 0x2d, 0xa5);
...
typedef struct IDXVAHD_DeviceVtbl {
  ...
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(IDXVAHD_Device *This,
                                             /* [in] */ REFIID riid,
...
interface IDXVAHD_Device { CONST_VTBL struct IDXVAHD_DeviceVtbl *lpVtbl; };
...
#define IDXVAHD_Device_CreateVideoSurface(This, Width, Height, Format, Pool,   \
  ...
  ((This)->lpVtbl->CreateVideoSurface(This, Width, Height, Format, Pool,       \
...
typedef HRESULT(CALLBACK *PDXVAHDSW_ProposeVideoPrivateFormat)(
    _In_ HANDLE hDevice, _Inout_ D3DFORMAT *pFormat);

typedef HRESULT(CALLBACK *PDXVAHDSW_GetVideoProcessorDeviceCaps)(
    _In_ HANDLE hDevice, _In_ const DXVAHD_CONTENT_DESC *pContentDesc,
    _In_ DXVAHD_DEVICE_USAGE Usage, _Out_ DXVAHD_VPDEVCAPS *pCaps);

typedef HRESULT(CALLBACK *PDXVAHDSW_GetVideoProcessorOutputFormats)(
    _In_ HANDLE hDevice, _In_ const DXVAHD_CONTENT_DESC *pContentDesc,
    _In_ DXVAHD_DEVICE_USAGE Usage, _In_ UINT Count,
    _Out_writes_(Count) D3DFORMAT *pFormats);
...
typedef HRESULT(CALLBACK *PDXVAHDSW_GetVideoProcessorCustomRates)(
    _In_ HANDLE hDevice, _In_ const GUID *pVPGuid, _In_ UINT Count,
    _Out_writes_(Count) DXVAHD_CUSTOM_RATE_DATA *pRates);

typedef HRESULT(CALLBACK *PDXVAHDSW_GetVideoProcessorFilterRange)(
    _In_ HANDLE hDevice, _In_ DXVAHD_FILTER Filter,
    _Out_ DXVAHD_FILTER_RANGE_DATA *pRange);

typedef HRESULT(CALLBACK *PDXVAHDSW_DestroyDevice)(_In_ HANDLE hDevice);

typedef HRESULT(CALLBACK *PDXVAHDSW_CreateVideoProcessor)(
    _In_ HANDLE hDevice, _In_ const GUID *pVPGuid,
    _Out_ HANDLE *phVideoProcessor);

typedef HRESULT(CALLBACK *PDXVAHDSW_SetVideoProcessBltState)(
    _In_ HANDLE hVideoProcessor, _In_ DXVAHD_BLT_STATE State,
    _In_ UINT DataSize, _In_reads_bytes_(DataSize) const void *pData);

typedef HRESULT(CALLBACK *PDXVAHDSW_GetVideoProcessBltStatePrivate)(
    _In_ HANDLE hVideoProcessor, _Inout_ DXVAHD_BLT_STATE_PRIVATE_DATA *pData);

typedef HRESULT(CALLBACK *PDXVAHDSW_SetVideoProcessStreamState)(
    _In_ HANDLE hVideoProcessor, _In_ UINT StreamNumber,
    _In_ DXVAHD_STREAM_STATE State, _In_ UINT DataSize,
    _In_reads_bytes_(DataSize) const void *pData);
...
typedef HRESULT(CALLBACK *PDXVAHDSW_VideoProcessBltHD)(
    _In_ HANDLE hVideoProcessor, _In_ IDirect3DSurface9 *pOutputSurface,
    _In_ UINT OutputFrame, _In_ UINT StreamCount,
    _In_reads_(StreamCount) const DXVAHD_STREAM_DATA *pStreams);
...
DEFINE_GUID(DXVAHDControlGuid, 0xa0386e75, 0xf70c, 0x464c, 0xa9, 0xce, 0x33,
            0xc4, 0x4e, 0x09, 0x16, 0x23); // DXVA2Trace_Control

DEFINE_GUID(DXVAHDETWGUID_CREATEVIDEOPROCESSOR, 0x681e3d1e, 0x5674, 0x4fb3,
            0xa5, 0x03, 0x2f, 0x20, 0x55, 0xe9, 0x1f, 0x60);
DEFINE_GUID(DXVAHDETWGUID_VIDEOPROCESSBLTSTATE, 0x76c94b5a, 0x193f, 0x4692,
            0x94, 0x84, 0xa4, 0xd9, 0x99, 0xda, 0x81, 0xa8);
DEFINE_GUID(DXVAHDETWGUID_VIDEOPROCESSSTREAMSTATE, 0x262c0b02, 0x209d, 0x47ed,
            0x94, 0xd8, 0x82, 0xae, 0x02, 0xb8, 0x4a, 0xa7);
DEFINE_GUID(DXVAHDETWGUID_VIDEOPROCESSBLTHD, 0xbef3d435, 0x78c7, 0x4de3, 0x97,
            0x07, 0xcd, 0x1b, 0x08, 0x3b, 0x16, 0x0a);
DEFINE_GUID(DXVAHDETWGUID_VIDEOPROCESSBLTHD_STREAM, 0x27ae473e, 0xa5fc, 0x4be5,
            0xb4, 0xe3, 0xf2, 0x49, 0x94, 0xd3, 0xc4, 0x95);
DEFINE_GUID(DXVAHDETWGUID_DESTROYVIDEOPROCESSOR, 0xf943f0a0, 0x3f16, 0x43e0,
            0x80, 0x93, 0x10, 0x5a, 0x98, 0x6a, 0xa5, 0xf1);
...
HRESULT WINAPI DXVAHD_CreateDevice(_In_ IDirect3DDevice9Ex *pD3DDevice,
...
typedef HRESULT(WINAPI *PDXVAHD_CreateDevice)(
    ...
    _In_ const DXVAHD_CONTENT_DESC *pContentDesc,
    _In_ DXVAHD_DEVICE_USAGE Usage, _In_opt_ PDXVAHDSW_Plugin pPlugin,
    _Outptr_ IDXVAHD_Device **ppDevice);
