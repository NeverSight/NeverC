...
RPC_STATUS
RPC_ENTRY
RpcCertGeneratePrincipalNameW(_In_ PCCERT_CONTEXT Context, _In_ DWORD Flags,
                              _Outptr_ RPC_WSTR *pBuffer);

RPCRTAPI
RPC_STATUS
RPC_ENTRY
RpcCertGeneratePrincipalNameA(_In_ PCCERT_CONTEXT Context, _In_ DWORD Flags,
...
RPC_STATUS
RPC_ENTRY
RpcCertGeneratePrincipalName(_In_ PCCERT_CONTEXT Context, _In_ DWORD Flags,
                             _Outptr_ RPC_CSTR *pBuffer);
