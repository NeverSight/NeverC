//@[contract("ntoskrnl-winbase"), comment("MVI_tracked -
// https://osgwiki.com/wiki/Microsoft_Virus_Initiative")];
...
#pragma warning(disable                                                        \
                : 4001) /* nonstandard extension : single line comment */
#pragma warning(                                                               \
...
//
//  These are flags supported through CreateFile (W7) and CreateFile2 (W8 and
//  beyond)
//
...
typedef enum FILE_FLUSH_MODE {
  FILE_FLUSH_DEFAULT = 0,  // same as WIN32 FlushFileBuffers(); Flushes data,
                           // metadata, AND sends a SYNC command to the hardware
...
_Success_(return != NULL)
    _Post_writable_byte_size_(dwBytes) DECLSPEC_ALLOCATOR HGLOBAL WINAPI
    GlobalAlloc(_In_ UINT uFlags, _In_ SIZE_T dwBytes);
...
WINBASEAPI
_Ret_reallocated_bytes_(hMem, dwBytes) DECLSPEC_ALLOCATOR HGLOBAL WINAPI
    GlobalReAlloc(_Frees_ptr_ HGLOBAL hMem, _In_ SIZE_T dwBytes,
                  _In_ UINT uFlags);
...
WINBASEAPI
_Ret_maybenull_ HGLOBAL WINAPI GlobalHandle(_In_ LPCVOID pMem);
...
WINBASEAPI
_Ret_maybenull_ _Success_(return == 0) HGLOBAL WINAPI
    GlobalFree(_Frees_ptr_opt_ HGLOBAL hMem);
...
SIZE_T
WINAPI
GlobalCompact(_In_ DWORD dwMinFree);

WINBASEAPI
VOID WINAPI GlobalFix(_In_ HGLOBAL hMem);

WINBASEAPI
VOID WINAPI GlobalUnfix(_In_ HGLOBAL hMem);

WINBASEAPI
LPVOID
WINAPI
GlobalWire(_In_ HGLOBAL hMem);

WINBASEAPI
BOOL WINAPI GlobalUnWire(_In_ HGLOBAL hMem);

__drv_preferredFunction("GlobalMemoryStatusEx",
                        "Deprecated. See MSDN for details")
...
WINBASEAPI
_Success_(return != NULL)
    _Post_writable_byte_size_(uBytes) DECLSPEC_ALLOCATOR HLOCAL WINAPI
    LocalAlloc(_In_ UINT uFlags, _In_ SIZE_T uBytes);

WINBASEAPI
_Ret_reallocated_bytes_(hMem, uBytes) DECLSPEC_ALLOCATOR HLOCAL WINAPI
    LocalReAlloc(_Frees_ptr_opt_ HLOCAL hMem, _In_ SIZE_T uBytes,
                 _In_ UINT uFlags);
...
WINBASEAPI
_Ret_maybenull_ LPVOID WINAPI LocalLock(_In_ HLOCAL hMem);
...
WINBASEAPI
_Ret_maybenull_ HLOCAL WINAPI LocalHandle(_In_ LPCVOID pMem);
...
WINBASEAPI
_Success_(return == 0) _Ret_maybenull_ HLOCAL WINAPI
    LocalFree(_Frees_ptr_opt_ HLOCAL hMem);
...
SIZE_T
WINAPI
LocalShrink(_In_ HLOCAL hMem, _In_ UINT cbNewSize);

WINBASEAPI
SIZE_T
WINAPI
LocalCompact(_In_ UINT uMinFree);
...
WINBASEAPI
BOOL WINAPI GetBinaryTypeA(_In_ LPCSTR lpApplicationName,
                           _Out_ LPDWORD lpBinaryType);
WINBASEAPI
BOOL WINAPI GetBinaryTypeW(_In_ LPCWSTR lpApplicationName,
                           _Out_ LPDWORD lpBinaryType);
#ifdef UNICODE
...
WINBASEAPI
_Success_(return != 0 && return < cchBuffer) DWORD WINAPI
    GetShortPathNameA(_In_ LPCSTR lpszLongPath,
                      _Out_writes_to_opt_(cchBuffer, return +1)
                          LPSTR lpszShortPath,
...
WINBASEAPI
_Success_(return != 0 && return < cchBuffer) DWORD WINAPI
    GetLongPathNameTransactedA(_In_ LPCSTR lpszShortPath,
                               _Out_writes_to_opt_(cchBuffer, return +1)
                                   LPSTR lpszLongPath,
                               _In_ DWORD cchBuffer, _In_ HANDLE hTransaction);
WINBASEAPI
_Success_(return != 0 && return < cchBuffer) DWORD WINAPI
    GetLongPathNameTransactedW(_In_ LPCWSTR lpszShortPath,
                               _Out_writes_to_opt_(cchBuffer, return +1)
                                   LPWSTR lpszLongPath,
                               _In_ DWORD cchBuffer, _In_ HANDLE hTransaction);
#ifdef UNICODE
...
WINBASEAPI
BOOL WINAPI GetProcessAffinityMask(_In_ HANDLE hProcess,
...
WINBASEAPI
BOOL WINAPI GetProcessIoCounters(_In_ HANDLE hProcess,
                                 _Out_ PIO_COUNTERS lpIoCounters);

WINBASEAPI
__analysis_noreturn VOID WINAPI FatalExit(_In_ int ExitCode);
...
WINBASEAPI
BOOL WINAPI
SetEnvironmentStringsA(_In_ _Pre_ _NullNull_terminated_ LPCH NewEnvironment);
#ifndef UNICODE
...
WINBASEAPI
_Ret_maybenull_ LPVOID WINAPI
CreateFiberEx(_In_ SIZE_T dwStackCommitSize, _In_ SIZE_T dwStackReserveSize,
              _In_ DWORD dwFlags, _In_ LPFIBER_START_ROUTINE lpStartAddress,
              _In_opt_ LPVOID lpParameter);

WINBASEAPI
_Ret_maybenull_ LPVOID WINAPI
ConvertThreadToFiberEx(_In_opt_ LPVOID lpParameter, _In_ DWORD dwFlags);
...
WINBASEAPI
_Ret_maybenull_ LPVOID WINAPI
CreateFiber(_In_ SIZE_T dwStackSize, _In_ LPFIBER_START_ROUTINE lpStartAddress,
            _In_opt_ LPVOID lpParameter);

WINBASEAPI
_Ret_maybenull_ LPVOID WINAPI ConvertThreadToFiber(_In_opt_ LPVOID lpParameter);
...
_Must_inspect_result_ WINBASEAPI BOOL WINAPI
CreateUmsCompletionList(_Outptr_ PUMS_COMPLETION_LIST *UmsCompletionList);

WINBASEAPI
BOOL WINAPI DequeueUmsCompletionListItems(
    _In_ PUMS_COMPLETION_LIST UmsCompletionList, _In_ DWORD WaitTimeOut,
    _Out_ PUMS_CONTEXT *UmsThreadList);

WINBASEAPI
BOOL WINAPI
GetUmsCompletionListEvent(_In_ PUMS_COMPLETION_LIST UmsCompletionList,
...
WINBASEAPI
BOOL WINAPI
DeleteUmsCompletionList(_In_ PUMS_COMPLETION_LIST UmsCompletionList);
...
PUMS_CONTEXT
WINAPI
GetNextUmsListItem(_Inout_ PUMS_CONTEXT UmsContext);

WINBASEAPI
BOOL WINAPI QueryUmsThreadInformation(
    _In_ PUMS_CONTEXT UmsThread, _In_ UMS_THREAD_INFO_CLASS UmsThreadInfoClass,
    _Out_writes_bytes_to_(UmsThreadInformationLength, *ReturnLength)
        PVOID UmsThreadInformation,
    _In_ ULONG UmsThreadInformationLength, _Out_opt_ PULONG ReturnLength);

WINBASEAPI
BOOL WINAPI SetUmsThreadInformation(
    _In_ PUMS_CONTEXT UmsThread, _In_ UMS_THREAD_INFO_CLASS UmsThreadInfoClass,
    _In_ PVOID UmsThreadInformation, _In_ ULONG UmsThreadInformationLength);

WINBASEAPI
BOOL WINAPI DeleteUmsThreadContext(_In_ PUMS_CONTEXT UmsThread);

WINBASEAPI
BOOL WINAPI CreateUmsThreadContext(_Outptr_ PUMS_CONTEXT *lpUmsThread);

WINBASEAPI
BOOL WINAPI
EnterUmsSchedulingMode(_In_ PUMS_SCHEDULER_STARTUP_INFO SchedulerStartupInfo);

WINBASEAPI
BOOL WINAPI GetUmsSystemThreadInformation(_In_ HANDLE ThreadHandle,
                                          _Inout_ PUMS_SYSTEM_THREAD_INFORMATION
                                              SystemThreadInfo);
...
DWORD_PTR
WINAPI
SetThreadAffinityMask(_In_ HANDLE hThread, _In_ DWORD_PTR dwThreadAffinityMask);
...
WINBASEAPI
BOOL WINAPI GetProcessDEPPolicy(_In_ HANDLE hProcess, _Out_ LPDWORD lpFlags,
                                _Out_ PBOOL lpPermanent);

#endif // _WIN32_WINNT >= 0x0600

WINBASEAPI
BOOL WINAPI RequestWakeupLatency(_In_ LATENCY_TIME latency);

WINBASEAPI
BOOL WINAPI IsSystemResumeAutomatic(VOID);

WINBASEAPI
BOOL WINAPI GetThreadSelectorEntry(_In_ HANDLE hThread, _In_ DWORD dwSelector,
                                   _Out_ LPLDT_ENTRY lpSelectorEntry);

WINBASEAPI
EXECUTION_STATE
WINAPI
SetThreadExecutionState(_In_ EXECUTION_STATE esFlags);
...
WINBASEAPI
BOOL WINAPI PowerSetRequest(_In_ HANDLE PowerRequest,
                            _In_ POWER_REQUEST_TYPE RequestType);

WINBASEAPI
BOOL WINAPI PowerClearRequest(_In_ HANDLE PowerRequest,
                              _In_ POWER_REQUEST_TYPE RequestType);
...
#if !defined(                                                                  \
    RC_INVOKED) // RC warns because "WINBASE_DECLARE_RESTORE_LAST_ERROR" is a
                // bit long.
// #if _WIN32_WINNT >= 0x0501 || defined(WINBASE_DECLARE_RESTORE_LAST_ERROR)
#if defined(WINBASE_DECLARE_RESTORE_LAST_ERROR)

WINBASEAPI
VOID WINAPI RestoreLastError(_In_ DWORD dwErrCode);
...
WINBASEAPI
BOOL WINAPI SetFileCompletionNotificationModes(_In_ HANDLE FileHandle,
                                               _In_ UCHAR Flags);
...
WINBASEAPI
BOOL WINAPI Wow64GetThreadSelectorEntry(_In_ HANDLE hThread,
...
WINBASEAPI
UINT WINAPI SetHandleCount(_In_ UINT uNumber);

WINBASEAPI
BOOL WINAPI RequestDeviceWakeup(_In_ HANDLE hDevice);

WINBASEAPI
BOOL WINAPI CancelDeviceWakeupRequest(_In_ HANDLE hDevice);

WINBASEAPI
BOOL WINAPI GetDevicePowerState(_In_ HANDLE hDevice, _Out_ BOOL *pfOn);

WINBASEAPI
BOOL WINAPI SetMessageWaitingIndicator(_In_ HANDLE hMsgIndicator,
                                       _In_ ULONG ulMsgCount);

WINBASEAPI
BOOL WINAPI SetFileShortNameA(_In_ HANDLE hFile, _In_ LPCSTR lpShortName);
WINBASEAPI
BOOL WINAPI SetFileShortNameW(_In_ HANDLE hFile, _In_ LPCWSTR lpShortName);
#ifdef UNICODE
...
DWORD
WINAPI
LoadModule(_In_ LPCSTR lpModuleName, _In_ LPVOID lpParameterBlock);

__drv_preferredFunction("CreateProcess", "Deprecated. See MSDN for details")
    WINBASEAPI UINT WINAPI WinExec(_In_ LPCSTR lpCmdLine, _In_ UINT uCmdShow);
...
#if WINAPI_FAMILY_PARTITION(WINAPI_PARTITION_DESKTOP |                         \
                            WINAPI_PARTITION_SYSTEM | WINAPI_PARTITION_APP)

WINBASEAPI
BOOL WINAPI ClearCommBreak(_In_ HANDLE hFile);

WINBASEAPI
BOOL WINAPI ClearCommError(_In_ HANDLE hFile, _Out_opt_ LPDWORD lpErrors,
                           _Out_opt_ LPCOMSTAT lpStat);

WINBASEAPI
BOOL WINAPI SetupComm(_In_ HANDLE hFile, _In_ DWORD dwInQueue,
...
_Success_(return != FALSE) BOOL WINAPI
    GetCommConfig(_In_ HANDLE hCommDev,
...
WINBASEAPI
BOOL WINAPI GetCommProperties(_In_ HANDLE hFile, _Inout_ LPCOMMPROP lpCommProp);
...
WINBASEAPI
BOOL WINAPI GetCommTimeouts(_In_ HANDLE hFile,
...
WINBASEAPI
BOOL WINAPI SetCommTimeouts(_In_ HANDLE hFile,
...
WINBASEAPI
BOOL WINAPI WaitCommEvent(_In_ HANDLE hFile, _Inout_ LPDWORD lpEvtMask,
...
HANDLE
WINAPI
OpenCommPort(_In_ ULONG uPortNumber, _In_ DWORD dwDesiredAccess,
...
ULONG
WINAPI
GetCommPorts(_Out_writes_(uPortNumbersCount) PULONG lpPortNumbers,
             _In_ ULONG uPortNumbersCount, _Out_ PULONG puPortNumbersFound);
...
DWORD
WINAPI
SetTapePosition(_In_ HANDLE hDevice, _In_ DWORD dwPositionMethod,
                _In_ DWORD dwPartition, _In_ DWORD dwOffsetLow,
                _In_ DWORD dwOffsetHigh, _In_ BOOL bImmediate);

WINBASEAPI
DWORD
WINAPI
GetTapePosition(_In_ HANDLE hDevice, _In_ DWORD dwPositionType,
                _Out_ LPDWORD lpdwPartition, _Out_ LPDWORD lpdwOffsetLow,
                _Out_ LPDWORD lpdwOffsetHigh);

WINBASEAPI
DWORD
WINAPI
PrepareTape(_In_ HANDLE hDevice, _In_ DWORD dwOperation, _In_ BOOL bImmediate);

WINBASEAPI
DWORD
WINAPI
EraseTape(_In_ HANDLE hDevice, _In_ DWORD dwEraseType, _In_ BOOL bImmediate);

WINBASEAPI
DWORD
WINAPI
CreateTapePartition(_In_ HANDLE hDevice, _In_ DWORD dwPartitionMethod,
                    _In_ DWORD dwCount, _In_ DWORD dwSize);

WINBASEAPI
DWORD
WINAPI
WriteTapemark(_In_ HANDLE hDevice, _In_ DWORD dwTapemarkType,
              _In_ DWORD dwTapemarkCount, _In_ BOOL bImmediate);

WINBASEAPI
DWORD
WINAPI
GetTapeStatus(_In_ HANDLE hDevice);

WINBASEAPI
DWORD
WINAPI
GetTapeParameters(_In_ HANDLE hDevice, _In_ DWORD dwOperation,
                  _Inout_ LPDWORD lpdwSize,
...
DWORD
WINAPI
SetTapeParameters(_In_ HANDLE hDevice, _In_ DWORD dwOperation,
...
WINBASEAPI
int WINAPI MulDiv(_In_ int nNumber, _In_ int nNumerator, _In_ int nDenominator);
...
WINBASEAPI
BOOL WINAPI GetSystemRegistryQuota(_Out_opt_ PDWORD pdwQuotaAllowed,
...
WINBASEAPI
BOOL WINAPI FileTimeToDosDateTime(_In_ CONST FILETIME *lpFileTime,
                                  _Out_ LPWORD lpFatDate,
                                  _Out_ LPWORD lpFatTime);

WINBASEAPI
BOOL WINAPI DosDateTimeToFileTime(_In_ WORD wFatDate, _In_ WORD wFatTime,
...
#if !defined(MIDL_PASS)
WINBASEAPI
_Success_(return != 0) DWORD WINAPI
    FormatMessageA(_In_ DWORD dwFlags, _In_opt_ LPCVOID lpSource,
                   _In_ DWORD dwMessageId, _In_ DWORD dwLanguageId,
                   _When_((dwFlags & FORMAT_MESSAGE_ALLOCATE_BUFFER) != 0,
                          _At_((LPSTR *)lpBuffer, _Outptr_result_z_))
                       _When_((dwFlags & FORMAT_MESSAGE_ALLOCATE_BUFFER) == 0,
                              _Out_writes_z_(nSize)) LPSTR lpBuffer,
                   _In_ DWORD nSize, _In_opt_ va_list *Arguments);
WINBASEAPI
_Success_(return != 0) DWORD WINAPI
    FormatMessageW(_In_ DWORD dwFlags, _In_opt_ LPCVOID lpSource,
                   _In_ DWORD dwMessageId, _In_ DWORD dwLanguageId,
                   _When_((dwFlags & FORMAT_MESSAGE_ALLOCATE_BUFFER) != 0,
                          _At_((LPWSTR *)lpBuffer, _Outptr_result_z_))
                       _When_((dwFlags & FORMAT_MESSAGE_ALLOCATE_BUFFER) == 0,
                              _Out_writes_z_(nSize)) LPWSTR lpBuffer,
                   _In_ DWORD nSize, _In_opt_ va_list *Arguments);
#ifdef UNICODE
...
#if defined(_M_CEE)
#undef FormatMessage
__inline DWORD FormatMessage(DWORD dwFlags, LPCVOID lpSource, DWORD dwMessageId,
...
HANDLE
WINAPI
CreateMailslotA(_In_ LPCSTR lpName, _In_ DWORD nMaxMessageSize,
                _In_ DWORD lReadTimeout,
                _In_opt_ LPSECURITY_ATTRIBUTES lpSecurityAttributes);
WINBASEAPI
HANDLE
WINAPI
CreateMailslotW(_In_ LPCWSTR lpName, _In_ DWORD nMaxMessageSize,
                _In_ DWORD lReadTimeout,
                _In_opt_ LPSECURITY_ATTRIBUTES lpSecurityAttributes);
#ifdef UNICODE
...
WINBASEAPI
BOOL WINAPI GetMailslotInfo(_In_ HANDLE hMailslot,
...
WINBASEAPI
BOOL WINAPI SetMailslotInfo(_In_ HANDLE hMailslot, _In_ DWORD lReadTimeout);
...
WINADVAPI
BOOL WINAPI EncryptFileA(_In_ LPCSTR lpFileName);
WINADVAPI
BOOL WINAPI EncryptFileW(_In_ LPCWSTR lpFileName);
#ifdef UNICODE
...
WINADVAPI
BOOL WINAPI DecryptFileA(_In_ LPCSTR lpFileName, _Reserved_ DWORD dwReserved);
WINADVAPI
BOOL WINAPI DecryptFileW(_In_ LPCWSTR lpFileName, _Reserved_ DWORD dwReserved);
#ifdef UNICODE
...
WINADVAPI
BOOL WINAPI FileEncryptionStatusA(_In_ LPCSTR lpFileName,
                                  _Out_ LPDWORD lpStatus);
WINADVAPI
BOOL WINAPI FileEncryptionStatusW(_In_ LPCWSTR lpFileName,
                                  _Out_ LPDWORD lpStatus);
#ifdef UNICODE
...
typedef DWORD(WINAPI *PFE_EXPORT_FUNC)(_In_reads_bytes_(ulLength) PBYTE pbData,
                                       _In_opt_ PVOID pvCallbackContext,
                                       _In_ ULONG ulLength);

typedef DWORD(WINAPI *PFE_IMPORT_FUNC)(
    _Out_writes_bytes_to_(*ulLength, *ulLength) PBYTE pbData,
    _In_opt_ PVOID pvCallbackContext, _Inout_ PULONG ulLength);
...
DWORD
WINAPI
OpenEncryptedFileRawA(_In_ LPCSTR lpFileName, _In_ ULONG ulFlags,
                      _Outptr_ PVOID *pvContext);
WINADVAPI
DWORD
WINAPI
OpenEncryptedFileRawW(_In_ LPCWSTR lpFileName, _In_ ULONG ulFlags,
                      _Outptr_ PVOID *pvContext);
#ifdef UNICODE
...
DWORD
WINAPI
ReadEncryptedFileRaw(_In_ PFE_EXPORT_FUNC pfExportCallback,
                     _In_opt_ PVOID pvCallbackContext, _In_ PVOID pvContext);

WINADVAPI
DWORD
WINAPI
WriteEncryptedFileRaw(_In_ PFE_IMPORT_FUNC pfImportCallback,
                      _In_opt_ PVOID pvCallbackContext, _In_ PVOID pvContext);

WINADVAPI
VOID WINAPI CloseEncryptedFileRaw(_In_ PVOID pvContext);
...
WINBASEAPI
int WINAPI lstrcmpA(_In_ LPCSTR lpString1, _In_ LPCSTR lpString2);
WINBASEAPI
int WINAPI lstrcmpW(_In_ LPCWSTR lpString1, _In_ LPCWSTR lpString2);
#ifdef UNICODE
...
WINBASEAPI
int WINAPI lstrcmpiA(_In_ LPCSTR lpString1, _In_ LPCSTR lpString2);
WINBASEAPI
int WINAPI lstrcmpiW(_In_ LPCWSTR lpString1, _In_ LPCWSTR lpString2);
#ifdef UNICODE
...
_Check_return_ _Success_(return != NULL)
    _Post_satisfies_(return == lpString1) _Ret_maybenull_ LPSTR WINAPI
    lstrcpynA(_Out_writes_(iMaxLength) LPSTR lpString1, _In_ LPCSTR lpString2,
              _In_ int iMaxLength);
WINBASEAPI
_Check_return_ _Success_(return != NULL)
    _Post_satisfies_(return == lpString1) _Ret_maybenull_ LPWSTR WINAPI
    lstrcpynW(_Out_writes_(iMaxLength) LPWSTR lpString1, _In_ LPCWSTR lpString2,
              _In_ int iMaxLength);
#ifdef UNICODE
...
LPSTR
WINAPI
lstrcpyA(_Out_writes_(_String_length_(lpString2) + 1)
             LPSTR lpString1, // deprecated: annotation is as good as it gets
         _In_ LPCSTR lpString2);
WINBASEAPI
LPWSTR
WINAPI
lstrcpyW(_Out_writes_(_String_length_(lpString2) + 1)
...
LPSTR
WINAPI
lstrcatA(_Inout_updates_z_(_String_length_(lpString1) +
...
LPWSTR
WINAPI
lstrcatW(_Inout_updates_z_(_String_length_(lpString1) +
                           _String_length_(lpString2) + 1)
             LPWSTR lpString1, // deprecated: annotation is as good as it gets
         _In_ LPCWSTR lpString2);
#ifdef UNICODE
...
WINBASEAPI
int WINAPI lstrlenA(_In_ LPCSTR lpString);
WINBASEAPI
int WINAPI lstrlenW(_In_ LPCWSTR lpString);
#ifdef UNICODE
...
HFILE
WINAPI
OpenFile(_In_ LPCSTR lpFileName, _Inout_ LPOFSTRUCT lpReOpenBuff,
         _In_ UINT uStyle);

WINBASEAPI
HFILE
WINAPI
_lopen(_In_ LPCSTR lpPathName, _In_ int iReadWrite);

WINBASEAPI
HFILE
WINAPI
_lcreat(_In_ LPCSTR lpPathName, _In_ int iAttribute);
...
WINBASEAPI
UINT WINAPI _lwrite(_In_ HFILE hFile, _In_reads_bytes_(uBytes) LPCCH lpBuffer,
                    _In_ UINT uBytes);
...
WINBASEAPI
long WINAPI _hwrite(_In_ HFILE hFile, _In_reads_bytes_(lBytes) LPCCH lpBuffer,
                    _In_ long lBytes);

WINBASEAPI
HFILE
WINAPI
_lclose(_In_ HFILE hFile);

WINBASEAPI
LONG WINAPI _llseek(_In_ HFILE hFile, _In_ LONG lOffset, _In_ int iOrigin);

WINADVAPI
BOOL WINAPI IsTextUnicode(_In_reads_bytes_(iSize) CONST VOID *lpv,
                          _In_ int iSize, _Inout_opt_ LPINT lpiResult);
...
DWORD
WINAPI
SignalObjectAndWait(_In_ HANDLE hObjectToSignal, _In_ HANDLE hObjectToWaitOn,
...
BOOL WINAPI BackupRead(_In_ HANDLE hFile,
                       _Out_writes_bytes_to_(nNumberOfBytesToRead,
                                             *lpNumberOfBytesRead)
                           LPBYTE lpBuffer,
                       _In_ DWORD nNumberOfBytesToRead,
                       _Out_ LPDWORD lpNumberOfBytesRead, _In_ BOOL bAbort,
                       _In_ BOOL bProcessSecurity, _Inout_ LPVOID *lpContext);

WINBASEAPI
BOOL WINAPI BackupSeek(_In_ HANDLE hFile, _In_ DWORD dwLowBytesToSeek,
...
BOOL WINAPI BackupWrite(_In_ HANDLE hFile,
                        ...
                        _Out_ LPDWORD lpNumberOfBytesWritten, _In_ BOOL bAbort,
                        _In_ BOOL bProcessSecurity, _Inout_ LPVOID *lpContext);
...
WINBASEAPI
_Ret_maybenull_ HANDLE WINAPI OpenMutexA(_In_ DWORD dwDesiredAccess,
...
WINBASEAPI
_Ret_maybenull_ HANDLE WINAPI CreateSemaphoreA(
    _In_opt_ LPSECURITY_ATTRIBUTES lpSemaphoreAttributes,
    _In_ LONG lInitialCount, _In_ LONG lMaximumCount, _In_opt_ LPCSTR lpName);
#ifndef UNICODE
...
WINBASEAPI
_Ret_maybenull_ HANDLE WINAPI OpenSemaphoreA(_In_ DWORD dwDesiredAccess,
                                             _In_ BOOL bInheritHandle,
                                             _In_ LPCSTR lpName);
#ifndef UNICODE
...
CreateWaitableTimerA(_In_opt_ LPSECURITY_ATTRIBUTES lpTimerAttributes,
                     _In_ BOOL bManualReset, _In_opt_ LPCSTR lpTimerName);
#ifndef UNICODE
#define CreateWaitableTimer CreateWaitableTimerA
#endif

WINBASEAPI
_Ret_maybenull_ HANDLE WINAPI OpenWaitableTimerA(_In_ DWORD dwDesiredAccess,
                                                 _In_ BOOL bInheritHandle,
...
WINBASEAPI
_Ret_maybenull_ HANDLE WINAPI CreateSemaphoreExA(
    _In_opt_ LPSECURITY_ATTRIBUTES lpSemaphoreAttributes,
    _In_ LONG lInitialCount, _In_ LONG lMaximumCount, _In_opt_ LPCSTR lpName,
    _Reserved_ DWORD dwFlags, _In_ DWORD dwDesiredAccess);
#ifndef UNICODE
...
WINBASEAPI
_Ret_maybenull_ HANDLE WINAPI
CreateWaitableTimerExA(_In_opt_ LPSECURITY_ATTRIBUTES lpTimerAttributes,
                       _In_opt_ LPCSTR lpTimerName, _In_ DWORD dwFlags,
...
WINBASEAPI
_Ret_maybenull_ HANDLE WINAPI CreateFileMappingA(
    _In_ HANDLE hFile, _In_opt_ LPSECURITY_ATTRIBUTES lpFileMappingAttributes,
    _In_ DWORD flProtect, _In_ DWORD dwMaximumSizeHigh,
    _In_ DWORD dwMaximumSizeLow, _In_opt_ LPCSTR lpName);
#ifndef UNICODE
...
WINBASEAPI
_Ret_maybenull_ HANDLE WINAPI CreateFileMappingNumaA(
    _In_ HANDLE hFile, _In_opt_ LPSECURITY_ATTRIBUTES lpFileMappingAttributes,
    _In_ DWORD flProtect, _In_ DWORD dwMaximumSizeHigh,
    _In_ DWORD dwMaximumSizeLow, _In_opt_ LPCSTR lpName,
...
HANDLE
WINAPI
OpenFileMappingA(_In_ DWORD dwDesiredAccess, _In_ BOOL bInheritHandle,
                 _In_ LPCSTR lpName);
#ifndef UNICODE
...
_Success_(return != 0 && return <= nBufferLength) DWORD WINAPI
    GetLogicalDriveStringsA(_In_ DWORD nBufferLength,
...
WINBASEAPI
_Ret_maybenull_ HMODULE WINAPI LoadPackagedLibrary(_In_ LPCWSTR lpwLibFileName,
...
WINBASEAPI
BOOL WINAPI QueryFullProcessImageNameA(_In_ HANDLE hProcess, _In_ DWORD dwFlags,
                                       _Out_writes_to_(*lpdwSize, *lpdwSize)
                                           LPSTR lpExeName,
                                       _Inout_ PDWORD lpdwSize);
WINBASEAPI
BOOL WINAPI QueryFullProcessImageNameW(_In_ HANDLE hProcess, _In_ DWORD dwFlags,
                                       _Out_writes_to_(*lpdwSize, *lpdwSize)
                                           LPWSTR lpExeName,
                                       _Inout_ PDWORD lpdwSize);
#ifdef UNICODE
...
#define PROC_THREAD_ATTRIBUTE_THREAD                                           \
  0x00010000 // Attribute may be used with thread creation
#define PROC_THREAD_ATTRIBUTE_INPUT 0x00020000 // Attribute is input only
#define PROC_THREAD_ATTRIBUTE_ADDITIVE                                         \
...
//
// Define Loader Integrity Continuity mitigation policy options.  This
// mitigation enforces OS signing levels for depenedent module loads.
//
...
//
// Define the strict Control Flow Guard (CFG) mitigation policy options. This
// mitigation requires all images that load in the process to be instrumented by
// CFG.
//
...
//
// Define the policy option that allows a broker to downgrade the dynamic code
...
//
// Define the user-mode CET set context instruction pointer validation
...
//
// Define the CET-related dynamic code validation data APIs out-of-proc
// mitigation policy options.
//
...
//
// Define the user-mode CET set context instruction pointer validation
// mitigation audit policy options.
//
...
WINBASEAPI
VOID WINAPI GetStartupInfoA(_Out_ LPSTARTUPINFOA lpStartupInfo);
#ifndef UNICODE
...
_Success_(return != 0 && return < nSize) __inline DWORD
    GetEnvironmentVariable(_In_opt_ LPCTSTR lpName,
                           _Out_writes_to_opt_(nSize, return +1)
                               LPTSTR lpBuffer,
                           _In_ DWORD nSize) {
#ifdef UNICODE
...
DWORD
WINAPI
GetFirmwareEnvironmentVariableA(_In_ LPCSTR lpName, _In_ LPCSTR lpGuid,
                                _Out_writes_bytes_to_opt_(nSize, return)
                                    PVOID pBuffer,
                                _In_ DWORD nSize);
WINBASEAPI
DWORD
WINAPI
GetFirmwareEnvironmentVariableW(_In_ LPCWSTR lpName, _In_ LPCWSTR lpGuid,
                                _Out_writes_bytes_to_opt_(nSize, return)
                                    PVOID pBuffer,
                                _In_ DWORD nSize);
#ifdef UNICODE
...
DWORD
WINAPI
GetFirmwareEnvironmentVariableExA(_In_ LPCSTR lpName, _In_ LPCSTR lpGuid,
                                  _Out_writes_bytes_to_opt_(nSize, return)
                                      PVOID pBuffer,
                                  _In_ DWORD nSize,
...
DWORD
WINAPI
GetFirmwareEnvironmentVariableExW(_In_ LPCWSTR lpName, _In_ LPCWSTR lpGuid,
                                  _Out_writes_bytes_to_opt_(nSize, return)
                                      PVOID pBuffer,
                                  _In_ DWORD nSize,
                                  _Out_opt_ PDWORD pdwAttribubutes);
...
#endif /* WINAPI_FAMILY_PARTITION(WINAPI_PARTITION_SYSTEM |                    \
...
WINBASEAPI
_Ret_maybenull_ HRSRC WINAPI FindResourceA(_In_opt_ HMODULE hModule,
                                           _In_ LPCSTR lpName,
                                           _In_ LPCSTR lpType);
#ifndef UNICODE
...
WINBASEAPI
_Ret_maybenull_ HRSRC WINAPI FindResourceExA(_In_opt_ HMODULE hModule,
                                             _In_ LPCSTR lpType,
                                             _In_ LPCSTR lpName,
                                             _In_ WORD wLanguage);
#ifndef UNICODE
...
WINBASEAPI
BOOL WINAPI EnumResourceTypesA(_In_opt_ HMODULE hModule,
                               _In_ ENUMRESTYPEPROCA lpEnumFunc,
                               _In_ LONG_PTR lParam);
WINBASEAPI
BOOL WINAPI EnumResourceTypesW(_In_opt_ HMODULE hModule,
...
WINBASEAPI
BOOL WINAPI EnumResourceLanguagesA(_In_opt_ HMODULE hModule, _In_ LPCSTR lpType,
                                   _In_ LPCSTR lpName,
                                   _In_ ENUMRESLANGPROCA lpEnumFunc,
                                   _In_ LONG_PTR lParam);
WINBASEAPI
BOOL WINAPI EnumResourceLanguagesW(_In_opt_ HMODULE hModule,
                                   _In_ LPCWSTR lpType, _In_ LPCWSTR lpName,
...
HANDLE
WINAPI
BeginUpdateResourceA(_In_ LPCSTR pFileName, _In_ BOOL bDeleteExistingResources);
WINBASEAPI
HANDLE
WINAPI
BeginUpdateResourceW(_In_ LPCWSTR pFileName,
...
WINBASEAPI
BOOL WINAPI UpdateResourceA(_In_ HANDLE hUpdate, _In_ LPCSTR lpType,
                            _In_ LPCSTR lpName, _In_ WORD wLanguage,
                            _In_reads_bytes_opt_(cb) LPVOID lpData,
                            _In_ DWORD cb);
WINBASEAPI
BOOL WINAPI UpdateResourceW(_In_ HANDLE hUpdate, _In_ LPCWSTR lpType,
                            _In_ LPCWSTR lpName, _In_ WORD wLanguage,
                            _In_reads_bytes_opt_(cb) LPVOID lpData,
                            _In_ DWORD cb);
#ifdef UNICODE
...
WINBASEAPI
BOOL WINAPI EndUpdateResourceA(_In_ HANDLE hUpdate, _In_ BOOL fDiscard);
WINBASEAPI
BOOL WINAPI EndUpdateResourceW(_In_ HANDLE hUpdate, _In_ BOOL fDiscard);
#ifdef UNICODE
...
WINBASEAPI
ATOM WINAPI GlobalAddAtomA(_In_opt_ LPCSTR lpString);
WINBASEAPI
ATOM WINAPI GlobalAddAtomW(_In_opt_ LPCWSTR lpString);
#ifdef UNICODE
...
WINBASEAPI
ATOM WINAPI GlobalAddAtomExA(_In_opt_ LPCSTR lpString, _In_ DWORD Flags);
WINBASEAPI
ATOM WINAPI GlobalAddAtomExW(_In_opt_ LPCWSTR lpString, _In_ DWORD Flags);
#ifdef UNICODE
...
WINBASEAPI
ATOM WINAPI GlobalFindAtomA(_In_opt_ LPCSTR lpString);
WINBASEAPI
ATOM WINAPI GlobalFindAtomW(_In_opt_ LPCWSTR lpString);
#ifdef UNICODE
...
UINT WINAPI GlobalGetAtomNameW(_In_ ATOM nAtom,
                               _Out_writes_to_(nSize, return +1)
                                   LPWSTR lpBuffer,
                               _In_ int nSize);
#ifdef UNICODE
...
WINBASEAPI
ATOM WINAPI AddAtomA(_In_opt_ LPCSTR lpString);
WINBASEAPI
ATOM WINAPI AddAtomW(_In_opt_ LPCWSTR lpString);
#ifdef UNICODE
...
WINBASEAPI
UINT WINAPI GetProfileIntA(_In_ LPCSTR lpAppName, _In_ LPCSTR lpKeyName,
                           _In_ INT nDefault);
WINBASEAPI
UINT WINAPI GetProfileIntW(_In_ LPCWSTR lpAppName, _In_ LPCWSTR lpKeyName,
                           _In_ INT nDefault);
#ifdef UNICODE
...
DWORD
WINAPI
GetProfileStringA(_In_opt_ LPCSTR lpAppName, _In_opt_ LPCSTR lpKeyName,
...
DWORD
WINAPI
GetProfileStringW(_In_opt_ LPCWSTR lpAppName, _In_opt_ LPCWSTR lpKeyName,
...
WINBASEAPI
BOOL WINAPI WriteProfileStringA(_In_opt_ LPCSTR lpAppName,
                                _In_opt_ LPCSTR lpKeyName,
                                _In_opt_ LPCSTR lpString);
WINBASEAPI
BOOL WINAPI WriteProfileStringW(_In_opt_ LPCWSTR lpAppName,
...
DWORD
WINAPI
GetProfileSectionA(_In_ LPCSTR lpAppName,
                   _Out_writes_to_opt_(nSize, return +1) LPSTR lpReturnedString,
                   _In_ DWORD nSize);
WINBASEAPI
DWORD
WINAPI
GetProfileSectionW(_In_ LPCWSTR lpAppName,
                   _Out_writes_to_opt_(nSize, return +1)
...
WINBASEAPI
BOOL WINAPI WriteProfileSectionA(_In_ LPCSTR lpAppName, _In_ LPCSTR lpString);
WINBASEAPI
BOOL WINAPI WriteProfileSectionW(_In_ LPCWSTR lpAppName, _In_ LPCWSTR lpString);
#ifdef UNICODE
...
WINBASEAPI
UINT WINAPI GetPrivateProfileIntA(_In_ LPCSTR lpAppName, _In_ LPCSTR lpKeyName,
                                  _In_ INT nDefault,
                                  _In_opt_ LPCSTR lpFileName);
WINBASEAPI
UINT WINAPI GetPrivateProfileIntW(_In_ LPCWSTR lpAppName,
                                  _In_ LPCWSTR lpKeyName, _In_ INT nDefault,
...
__inline UINT GetPrivateProfileInt(LPCTSTR lpAppName, LPCTSTR lpKeyName,
...
DWORD
WINAPI
GetPrivateProfileStringA(_In_opt_ LPCSTR lpAppName, _In_opt_ LPCSTR lpKeyName,
                         _In_opt_ LPCSTR lpDefault,
                         _Out_writes_to_opt_(nSize, return +1)
                             LPSTR lpReturnedString,
                         _In_ DWORD nSize, _In_opt_ LPCSTR lpFileName);
WINBASEAPI
DWORD
WINAPI
GetPrivateProfileStringW(_In_opt_ LPCWSTR lpAppName, _In_opt_ LPCWSTR lpKeyName,
                         _In_opt_ LPCWSTR lpDefault,
                         _Out_writes_to_opt_(nSize, return +1)
                             LPWSTR lpReturnedString,
                         _In_ DWORD nSize, _In_opt_ LPCWSTR lpFileName);
#ifdef UNICODE
...
__inline DWORD GetPrivateProfileString(LPCTSTR lpAppName, LPCTSTR lpKeyName,
                                       LPCTSTR lpDefault,
...
WINBASEAPI
BOOL WINAPI WritePrivateProfileStringA(_In_opt_ LPCSTR lpAppName,
                                       _In_opt_ LPCSTR lpKeyName,
                                       _In_opt_ LPCSTR lpString,
                                       _In_opt_ LPCSTR lpFileName);
WINBASEAPI
BOOL WINAPI WritePrivateProfileStringW(_In_opt_ LPCWSTR lpAppName,
                                       _In_opt_ LPCWSTR lpKeyName,
                                       _In_opt_ LPCWSTR lpString,
                                       _In_opt_ LPCWSTR lpFileName);
#ifdef UNICODE
...
DWORD
WINAPI
GetPrivateProfileSectionA(_In_ LPCSTR lpAppName,
                          _Out_writes_to_opt_(nSize, return +1)
                              LPSTR lpReturnedString,
                          _In_ DWORD nSize, _In_opt_ LPCSTR lpFileName);
WINBASEAPI
DWORD
WINAPI
GetPrivateProfileSectionW(_In_ LPCWSTR lpAppName,
                          _Out_writes_to_opt_(nSize, return +1)
                              LPWSTR lpReturnedString,
                          _In_ DWORD nSize, _In_opt_ LPCWSTR lpFileName);
#ifdef UNICODE
...
__inline DWORD GetPrivateProfileSection(LPCTSTR lpAppName,
                                        LPTSTR lpReturnedString, DWORD nSize,
                                        LPCTSTR lpFileName) {
#ifdef UNICODE
...
WINBASEAPI
BOOL WINAPI WritePrivateProfileSectionA(_In_opt_ LPCSTR lpAppName,
                                        _In_opt_ LPCSTR lpString,
                                        _In_opt_ LPCSTR lpFileName);
WINBASEAPI
BOOL WINAPI WritePrivateProfileSectionW(_In_opt_ LPCWSTR lpAppName,
                                        _In_opt_ LPCWSTR lpString,
                                        _In_opt_ LPCWSTR lpFileName);
#ifdef UNICODE
...
DWORD
WINAPI
GetPrivateProfileSectionNamesA(_Out_writes_to_opt_(nSize, return +1)
                                   LPSTR lpszReturnBuffer,
                               _In_ DWORD nSize, _In_opt_ LPCSTR lpFileName);
WINBASEAPI
DWORD
WINAPI
GetPrivateProfileSectionNamesW(_Out_writes_to_opt_(nSize, return +1)
...
__inline DWORD GetPrivateProfileSectionNames(LPTSTR lpszReturnBuffer,
...
BOOL WINAPI GetPrivateProfileStructA(_In_ LPCSTR lpszSection,
                                     _In_ LPCSTR lpszKey,
                                     _Out_writes_bytes_opt_(uSizeStruct)
                                         LPVOID lpStruct,
...
__inline BOOL GetPrivateProfileStruct(LPCTSTR lpszSection, LPCTSTR lpszKey,
...
__inline UINT GetTempFileName(LPCTSTR lpPathName, LPCTSTR lpPrefixString,
...
#if !defined(                                                                  \
    RC_INVOKED) // RC warns because "WINBASE_DECLARE_GET_SYSTEM_WOW64_DIRECTORY"
                // is a bit long.
#if _WIN32_WINNT >= 0x0501 ||                                                  \
    defined(WINBASE_DECLARE_GET_SYSTEM_WOW64_DIRECTORY)

//
// for GetProcAddress
//
typedef UINT(WINAPI *PGET_SYSTEM_WOW64_DIRECTORY_A)(
    _Out_writes_to_opt_(uSize, return +1) LPSTR lpBuffer, _In_ UINT uSize);
typedef UINT(WINAPI *PGET_SYSTEM_WOW64_DIRECTORY_W)(
    _Out_writes_to_opt_(uSize, return +1) LPWSTR lpBuffer, _In_ UINT uSize);
...
WINBASEAPI
BOOL WINAPI SetDllDirectoryA(_In_opt_ LPCSTR lpPathName);
WINBASEAPI
BOOL WINAPI SetDllDirectoryW(_In_opt_ LPCWSTR lpPathName);
#ifdef UNICODE
...
WINBASEAPI
_Success_(return != 0 && return < nBufferLength) DWORD WINAPI
    GetDllDirectoryA(_In_ DWORD nBufferLength,
                     _Out_writes_to_opt_(nBufferLength, return +1)
                         LPSTR lpBuffer);
WINBASEAPI
_Success_(return != 0 && return < nBufferLength) DWORD WINAPI
    GetDllDirectoryW(_In_ DWORD nBufferLength,
                     _Out_writes_to_opt_(nBufferLength, return +1)
                         LPWSTR lpBuffer);
#ifdef UNICODE
...
__inline BOOL CreateDirectory(LPCTSTR lpPathName,
...
WINBASEAPI
BOOL WINAPI
CreateDirectoryExA(_In_ LPCSTR lpTemplateDirectory, _In_ LPCSTR lpNewDirectory,
                   _In_opt_ LPSECURITY_ATTRIBUTES lpSecurityAttributes);
WINBASEAPI
BOOL WINAPI CreateDirectoryExW(
    _In_ LPCWSTR lpTemplateDirectory, _In_ LPCWSTR lpNewDirectory,
    _In_opt_ LPSECURITY_ATTRIBUTES lpSecurityAttributes);
#ifdef UNICODE
...
BOOL WINAPI CreateDirectoryTransactedA(
    _In_opt_ LPCSTR lpTemplateDirectory, _In_ LPCSTR lpNewDirectory,
    _In_opt_ LPSECURITY_ATTRIBUTES lpSecurityAttributes,
    _In_ HANDLE hTransaction);
WINBASEAPI
BOOL WINAPI CreateDirectoryTransactedW(
    _In_opt_ LPCWSTR lpTemplateDirectory, _In_ LPCWSTR lpNewDirectory,
    _In_opt_ LPSECURITY_ATTRIBUTES lpSecurityAttributes,
    _In_ HANDLE hTransaction);
#ifdef UNICODE
...
WINBASEAPI
BOOL WINAPI RemoveDirectoryTransactedA(_In_ LPCSTR lpPathName,
                                       _In_ HANDLE hTransaction);
WINBASEAPI
BOOL WINAPI RemoveDirectoryTransactedW(_In_ LPCWSTR lpPathName,
                                       _In_ HANDLE hTransaction);
#ifdef UNICODE
...
WINBASEAPI
_Success_(return != 0 && return < nBufferLength) DWORD WINAPI
    GetFullPathNameTransactedA(_In_ LPCSTR lpFileName, _In_ DWORD nBufferLength,
                               _Out_writes_to_opt_(nBufferLength, return +1)
                                   LPSTR lpBuffer,
...
WINBASEAPI
_Success_(return != 0 && return < nBufferLength) DWORD WINAPI
    GetFullPathNameTransactedW(_In_ LPCWSTR lpFileName,
...
WINBASEAPI
BOOL WINAPI DefineDosDeviceA(_In_ DWORD dwFlags, _In_ LPCSTR lpDeviceName,
...
DWORD
WINAPI
QueryDosDeviceA(_In_opt_ LPCSTR lpDeviceName,
...
HANDLE
WINAPI
CreateFileTransactedA(_In_ LPCSTR lpFileName, _In_ DWORD dwDesiredAccess,
                      _In_ DWORD dwShareMode,
                      _In_opt_ LPSECURITY_ATTRIBUTES lpSecurityAttributes,
                      _In_ DWORD dwCreationDisposition,
                      _In_ DWORD dwFlagsAndAttributes,
                      _In_opt_ HANDLE hTemplateFile, _In_ HANDLE hTransaction,
                      _In_opt_ PUSHORT pusMiniVersion,
                      _Reserved_ PVOID lpExtendedParameter);
WINBASEAPI
HANDLE
WINAPI
CreateFileTransactedW(_In_ LPCWSTR lpFileName, _In_ DWORD dwDesiredAccess,
                      _In_ DWORD dwShareMode,
                      _In_opt_ LPSECURITY_ATTRIBUTES lpSecurityAttributes,
                      _In_ DWORD dwCreationDisposition,
                      _In_ DWORD dwFlagsAndAttributes,
...
HANDLE
WINAPI
ReOpenFile(_In_ HANDLE hOriginalFile, _In_ DWORD dwDesiredAccess,
           _In_ DWORD dwShareMode, _In_ DWORD dwFlagsAndAttributes);
...
WINBASEAPI
BOOL WINAPI SetFileAttributesTransactedA(_In_ LPCSTR lpFileName,
                                         _In_ DWORD dwFileAttributes,
                                         _In_ HANDLE hTransaction);
WINBASEAPI
BOOL WINAPI SetFileAttributesTransactedW(_In_ LPCWSTR lpFileName,
                                         _In_ DWORD dwFileAttributes,
                                         _In_ HANDLE hTransaction);
#ifdef UNICODE
...
BOOL WINAPI GetFileAttributesTransactedA(
    _In_ LPCSTR lpFileName, _In_ GET_FILEEX_INFO_LEVELS fInfoLevelId,
    _Out_writes_bytes_(sizeof(WIN32_FILE_ATTRIBUTE_DATA))
        LPVOID lpFileInformation,
    _In_ HANDLE hTransaction);
WINBASEAPI
BOOL WINAPI GetFileAttributesTransactedW(
    _In_ LPCWSTR lpFileName, _In_ GET_FILEEX_INFO_LEVELS fInfoLevelId,
    _Out_writes_bytes_(sizeof(WIN32_FILE_ATTRIBUTE_DATA))
        LPVOID lpFileInformation,
    _In_ HANDLE hTransaction);
#ifdef UNICODE
...
DWORD
WINAPI
GetCompressedFileSizeTransactedA(_In_ LPCSTR lpFileName,
                                 _Out_opt_ LPDWORD lpFileSizeHigh,
                                 _In_ HANDLE hTransaction);
WINBASEAPI
DWORD
WINAPI
GetCompressedFileSizeTransactedW(_In_ LPCWSTR lpFileName,
                                 _Out_opt_ LPDWORD lpFileSizeHigh,
                                 _In_ HANDLE hTransaction);
#ifdef UNICODE
...
WINBASEAPI
BOOL WINAPI DeleteFileTransactedA(_In_ LPCSTR lpFileName,
                                  _In_ HANDLE hTransaction);
WINBASEAPI
BOOL WINAPI DeleteFileTransactedW(_In_ LPCWSTR lpFileName,
                                  _In_ HANDLE hTransaction);
#ifdef UNICODE
...
WINBASEAPI
BOOL WINAPI CheckNameLegalDOS8Dot3A(
    _In_ LPCSTR lpName, _Out_writes_opt_(OemNameSize) LPSTR lpOemName,
    _In_ DWORD OemNameSize, _Out_opt_ PBOOL pbNameContainsSpaces OPTIONAL,
    _Out_ PBOOL pbNameLegal);
WINBASEAPI
BOOL WINAPI CheckNameLegalDOS8Dot3W(
    _In_ LPCWSTR lpName, _Out_writes_opt_(OemNameSize) LPSTR lpOemName,
    _In_ DWORD OemNameSize, _Out_opt_ PBOOL pbNameContainsSpaces OPTIONAL,
    _Out_ PBOOL pbNameLegal);
#ifdef UNICODE
...
FindFirstFileTransactedA(
    _In_ LPCSTR lpFileName, _In_ FINDEX_INFO_LEVELS fInfoLevelId,
    ...
    _In_ DWORD dwAdditionalFlags, _In_ HANDLE hTransaction);
WINBASEAPI
HANDLE
WINAPI
FindFirstFileTransactedW(
    _In_ LPCWSTR lpFileName, _In_ FINDEX_INFO_LEVELS fInfoLevelId,
...
WINBASEAPI
BOOL WINAPI CopyFileA(_In_ LPCSTR lpExistingFileName, _In_ LPCSTR lpNewFileName,
                      _In_ BOOL bFailIfExists);
WINBASEAPI
BOOL WINAPI CopyFileW(_In_ LPCWSTR lpExistingFileName,
                      _In_ LPCWSTR lpNewFileName, _In_ BOOL bFailIfExists);
#ifdef UNICODE
...
#if defined(_M_CEE)
#undef CopyFile
__inline BOOL CopyFile(LPCTSTR lpExistingFileName, LPCTSTR lpNewFileName,
                       BOOL bFailIfExists) {
#ifdef UNICODE
  return CopyFileW(
#else
...
typedef DWORD(WINAPI *LPPROGRESS_ROUTINE)(
    _In_ LARGE_INTEGER TotalFileSize, _In_ LARGE_INTEGER TotalBytesTransferred,
    _In_ LARGE_INTEGER StreamSize, _In_ LARGE_INTEGER StreamBytesTransferred,
    _In_ DWORD dwStreamNumber, _In_ DWORD dwCallbackReason,
    _In_ HANDLE hSourceFile, _In_ HANDLE hDestinationFile,
    _In_opt_ LPVOID lpData);

WINBASEAPI
BOOL WINAPI CopyFileExA(
    _In_ LPCSTR lpExistingFileName, _In_ LPCSTR lpNewFileName,
    _In_opt_ LPPROGRESS_ROUTINE lpProgressRoutine, _In_opt_ LPVOID lpData,
    _When_(pbCancel != NULL, _Pre_satisfies_(*pbCancel == FALSE))
        _Inout_opt_ LPBOOL pbCancel,
    _In_ DWORD dwCopyFlags);
WINBASEAPI
BOOL WINAPI CopyFileExW(
    _In_ LPCWSTR lpExistingFileName, _In_ LPCWSTR lpNewFileName,
    _In_opt_ LPPROGRESS_ROUTINE lpProgressRoutine, _In_opt_ LPVOID lpData,
    _When_(pbCancel != NULL, _Pre_satisfies_(*pbCancel == FALSE))
        _Inout_opt_ LPBOOL pbCancel,
    _In_ DWORD dwCopyFlags);
...
BOOL WINAPI CopyFileTransactedA(
    _In_ LPCSTR lpExistingFileName, _In_ LPCSTR lpNewFileName,
    _In_opt_ LPPROGRESS_ROUTINE lpProgressRoutine, _In_opt_ LPVOID lpData,
    _In_opt_ LPBOOL pbCancel, _In_ DWORD dwCopyFlags, _In_ HANDLE hTransaction);
WINBASEAPI
...
//
// TODO: Win7 for now, when we roll over the version number this needs to be
// updated.
//
...
typedef struct COPYFILE2_MESSAGE {
  ...
  union {
    ...
    struct {
      ...
      ULARGE_INTEGER uliStreamSize;  // size of the current stream
      ULARGE_INTEGER
      uliStreamBytesTransferred;       // bytes copied for this stream so far
      ULARGE_INTEGER uliTotalFileSize; // size of all streams for this file
    ...
    struct {
      ...
      ULARGE_INTEGER
      uliTotalFileSize; // total size of all streams for this file
    } StreamStarted;
...
typedef COPYFILE2_MESSAGE_ACTION(CALLBACK *PCOPYFILE2_PROGRESS_ROUTINE)(
    _In_ const COPYFILE2_MESSAGE *pMessage, _In_opt_ PVOID pvCallbackContext);
...
//
//  Disable copying junctions (dwCopyFlagsV2 field of
//  COPYFILE2_EXTENDED_PARAMETERS_V2).
//
...
HRESULT
WINAPI
CopyFile2(_In_ PCWSTR pwszExistingFileName, _In_ PCWSTR pwszNewFileName,
...
WINBASEAPI
BOOL WINAPI MoveFileA(_In_ LPCSTR lpExistingFileName,
                      _In_ LPCSTR lpNewFileName);
WINBASEAPI
BOOL WINAPI MoveFileW(_In_ LPCWSTR lpExistingFileName,
...
WINBASEAPI
BOOL WINAPI MoveFileExA(_In_ LPCSTR lpExistingFileName,
                        _In_opt_ LPCSTR lpNewFileName, _In_ DWORD dwFlags);
WINBASEAPI
BOOL WINAPI MoveFileExW(_In_ LPCWSTR lpExistingFileName,
                        _In_opt_ LPCWSTR lpNewFileName, _In_ DWORD dwFlags);
#ifdef UNICODE
...
#if (_WIN32_WINNT >= 0x0500)
WINBASEAPI
BOOL WINAPI MoveFileWithProgressA(_In_ LPCSTR lpExistingFileName,
                                  _In_opt_ LPCSTR lpNewFileName,
                                  _In_opt_ LPPROGRESS_ROUTINE lpProgressRoutine,
                                  _In_opt_ LPVOID lpData, _In_ DWORD dwFlags);
WINBASEAPI
BOOL WINAPI MoveFileWithProgressW(_In_ LPCWSTR lpExistingFileName,
...
#if (_WIN32_WINNT >= 0x0600)
WINBASEAPI
BOOL WINAPI MoveFileTransactedA(_In_ LPCSTR lpExistingFileName,
                                _In_opt_ LPCSTR lpNewFileName,
                                _In_opt_ LPPROGRESS_ROUTINE lpProgressRoutine,
                                _In_opt_ LPVOID lpData, _In_ DWORD dwFlags,
                                _In_ HANDLE hTransaction);
WINBASEAPI
BOOL WINAPI MoveFileTransactedW(_In_ LPCWSTR lpExistingFileName,
                                _In_opt_ LPCWSTR lpNewFileName,
                                _In_opt_ LPPROGRESS_ROUTINE lpProgressRoutine,
                                _In_opt_ LPVOID lpData, _In_ DWORD dwFlags,
                                _In_ HANDLE hTransaction);
...
WINBASEAPI
BOOL WINAPI ReplaceFileA(_In_ LPCSTR lpReplacedFileName,
                         _In_ LPCSTR lpReplacementFileName,
                         _In_opt_ LPCSTR lpBackupFileName,
                         _In_ DWORD dwReplaceFlags, _Reserved_ LPVOID lpExclude,
                         _Reserved_ LPVOID lpReserved);
WINBASEAPI
BOOL WINAPI ReplaceFileW(_In_ LPCWSTR lpReplacedFileName,
...
WINBASEAPI
BOOL WINAPI
CreateHardLinkA(_In_ LPCSTR lpFileName, _In_ LPCSTR lpExistingFileName,
                _Reserved_ LPSECURITY_ATTRIBUTES lpSecurityAttributes);
WINBASEAPI
BOOL WINAPI
CreateHardLinkW(_In_ LPCWSTR lpFileName, _In_ LPCWSTR lpExistingFileName,
                _Reserved_ LPSECURITY_ATTRIBUTES lpSecurityAttributes);
#ifdef UNICODE
...
BOOL WINAPI CreateHardLinkTransactedA(
    _In_ LPCSTR lpFileName, _In_ LPCSTR lpExistingFileName,
    _Reserved_ LPSECURITY_ATTRIBUTES lpSecurityAttributes,
    _In_ HANDLE hTransaction);
WINBASEAPI
BOOL WINAPI CreateHardLinkTransactedW(
    _In_ LPCWSTR lpFileName, _In_ LPCWSTR lpExistingFileName,
    _Reserved_ LPSECURITY_ATTRIBUTES lpSecurityAttributes,
    _In_ HANDLE hTransaction);
#ifdef UNICODE
...
HANDLE
WINAPI
FindFirstStreamTransactedW(_In_ LPCWSTR lpFileName,
                           _In_ STREAM_INFO_LEVELS InfoLevel,
                           _Out_writes_bytes_(sizeof(WIN32_FIND_STREAM_DATA))
                               LPVOID lpFindStreamData,
                           _Reserved_ DWORD dwFlags, _In_ HANDLE hTransaction);

WINBASEAPI
HANDLE
WINAPI
FindFirstFileNameTransactedW(_In_ LPCWSTR lpFileName, _In_ DWORD dwFlags,
...
HANDLE
WINAPI
CreateNamedPipeA(_In_ LPCSTR lpName, _In_ DWORD dwOpenMode,
                 _In_ DWORD dwPipeMode, _In_ DWORD nMaxInstances,
                 _In_ DWORD nOutBufferSize, _In_ DWORD nInBufferSize,
...
BOOL WINAPI GetNamedPipeHandleStateA(_In_ HANDLE hNamedPipe,
                                     ...
                                     _Out_writes_opt_(nMaxUserNameSize)
                                         LPSTR lpUserName,
...
BOOL WINAPI CallNamedPipeA(
    ...
    _In_ DWORD nOutBufferSize, _Out_ LPDWORD lpBytesRead, _In_ DWORD nTimeOut);
...
WINBASEAPI
BOOL WINAPI WaitNamedPipeA(_In_ LPCSTR lpNamedPipeName, _In_ DWORD nTimeOut);
#ifndef UNICODE
...
WINBASEAPI
BOOL WINAPI GetNamedPipeClientComputerNameA(
    _In_ HANDLE Pipe,
...
WINBASEAPI
BOOL WINAPI GetNamedPipeClientProcessId(_In_ HANDLE Pipe,
                                        _Out_ PULONG ClientProcessId);

WINBASEAPI
BOOL WINAPI GetNamedPipeClientSessionId(_In_ HANDLE Pipe,
                                        _Out_ PULONG ClientSessionId);

WINBASEAPI
BOOL WINAPI GetNamedPipeServerProcessId(_In_ HANDLE Pipe,
                                        _Out_ PULONG ServerProcessId);

WINBASEAPI
BOOL WINAPI GetNamedPipeServerSessionId(_In_ HANDLE Pipe,
...
WINBASEAPI
BOOL WINAPI SetVolumeLabelA(_In_opt_ LPCSTR lpRootPathName,
                            _In_opt_ LPCSTR lpVolumeName);
WINBASEAPI
BOOL WINAPI SetVolumeLabelW(_In_opt_ LPCWSTR lpRootPathName,
...
WINBASEAPI
BOOL WINAPI SetFileBandwidthReservation(_In_ HANDLE hFile,
...
WINBASEAPI
BOOL WINAPI GetFileBandwidthReservation(_In_ HANDLE hFile,
...
_Success_(return != FALSE) WINADVAPI BOOL WINAPI
    ClearEventLogA(_In_ HANDLE hEventLog, _In_opt_ LPCSTR lpBackupFileName);
_Success_(return != FALSE) WINADVAPI BOOL WINAPI
    ClearEventLogW(_In_ HANDLE hEventLog, _In_opt_ LPCWSTR lpBackupFileName);
#ifdef UNICODE
...
_Success_(return != FALSE) WINADVAPI BOOL WINAPI
    BackupEventLogA(_In_ HANDLE hEventLog, _In_ LPCSTR lpBackupFileName);
_Success_(return != FALSE) WINADVAPI BOOL WINAPI
    BackupEventLogW(_In_ HANDLE hEventLog, _In_ LPCWSTR lpBackupFileName);
#ifdef UNICODE
...
_Success_(return != FALSE) WINADVAPI BOOL WINAPI
    CloseEventLog(_In_ HANDLE hEventLog);
...
_Success_(return != FALSE) WINADVAPI BOOL WINAPI
    DeregisterEventSource(_In_ HANDLE hEventLog);
...
_Success_(return != FALSE) WINADVAPI BOOL WINAPI
    NotifyChangeEventLog(_In_ HANDLE hEventLog, _In_ HANDLE hEvent);

_Success_(return != FALSE) WINADVAPI BOOL WINAPI
    GetNumberOfEventLogRecords(_In_ HANDLE hEventLog,
                               _Out_ PDWORD NumberOfRecords);

_Success_(return != FALSE) WINADVAPI BOOL WINAPI
    GetOldestEventLogRecord(_In_ HANDLE hEventLog, _Out_ PDWORD OldestRecord);

_Success_(return != FALSE) WINADVAPI HANDLE WINAPI
    OpenEventLogA(_In_opt_ LPCSTR lpUNCServerName, _In_ LPCSTR lpSourceName);
_Success_(return != FALSE) WINADVAPI HANDLE WINAPI
    OpenEventLogW(_In_opt_ LPCWSTR lpUNCServerName, _In_ LPCWSTR lpSourceName);
#ifdef UNICODE
...
_Success_(return != FALSE) WINADVAPI HANDLE WINAPI
    RegisterEventSourceA(_In_opt_ LPCSTR lpUNCServerName,
                         _In_ LPCSTR lpSourceName);
_Success_(return != FALSE) WINADVAPI HANDLE WINAPI
    RegisterEventSourceW(_In_opt_ LPCWSTR lpUNCServerName,
...
_Success_(return != FALSE) WINADVAPI HANDLE WINAPI
    OpenBackupEventLogA(_In_opt_ LPCSTR lpUNCServerName,
                        _In_ LPCSTR lpFileName);
_Success_(return != FALSE) WINADVAPI HANDLE WINAPI
    OpenBackupEventLogW(_In_opt_ LPCWSTR lpUNCServerName,
...
_Success_(return != FALSE) WINADVAPI BOOL WINAPI
    ReadEventLogA(_In_ HANDLE hEventLog, _In_ DWORD dwReadFlags,
                  _In_ DWORD dwRecordOffset,
                  _Out_writes_bytes_to_(nNumberOfBytesToRead, *pnBytesRead)
                      LPVOID lpBuffer,
                  _In_ DWORD nNumberOfBytesToRead, _Out_ DWORD *pnBytesRead,
                  _Out_ DWORD *pnMinNumberOfBytesNeeded);
_Success_(return != FALSE) WINADVAPI BOOL WINAPI
    ReadEventLogW(_In_ HANDLE hEventLog, _In_ DWORD dwReadFlags,
                  _In_ DWORD dwRecordOffset,
                  _Out_writes_bytes_to_(nNumberOfBytesToRead, *pnBytesRead)
                      LPVOID lpBuffer,
                  _In_ DWORD nNumberOfBytesToRead, _Out_ DWORD *pnBytesRead,
...
_Success_(return != FALSE) WINADVAPI BOOL WINAPI
    ReportEventA(_In_ HANDLE hEventLog, _In_ WORD wType, _In_ WORD wCategory,
                 _In_ DWORD dwEventID, _In_opt_ PSID lpUserSid,
                 _In_ WORD wNumStrings, _In_ DWORD dwDataSize,
                 _In_reads_opt_(wNumStrings) LPCSTR *lpStrings,
                 _In_reads_bytes_opt_(dwDataSize) LPVOID lpRawData);
_Success_(return != FALSE) WINADVAPI BOOL WINAPI
    ReportEventW(_In_ HANDLE hEventLog, _In_ WORD wType, _In_ WORD wCategory,
                 _In_ DWORD dwEventID, _In_opt_ PSID lpUserSid,
                 _In_ WORD wNumStrings, _In_ DWORD dwDataSize,
...
_Success_(return != FALSE) WINADVAPI BOOL WINAPI
    GetEventLogInformation(_In_ HANDLE hEventLog, _In_ DWORD dwInfoLevel,
                           _Out_writes_bytes_to_(cbBufSize, *pcbBytesNeeded)
                               LPVOID lpBuffer,
...
WINADVAPI
BOOL WINAPI
OperationStart(_In_ OPERATION_START_PARAMETERS *OperationStartParams);

WINADVAPI
BOOL WINAPI OperationEnd(_In_ OPERATION_END_PARAMETERS *OperationEndParams);
...
BOOL WINAPI AccessCheckAndAuditAlarmA(
    _In_ LPCSTR SubsystemName, _In_opt_ LPVOID HandleId,
    _In_ LPSTR ObjectTypeName, _In_opt_ LPSTR ObjectName,
    _In_ PSECURITY_DESCRIPTOR SecurityDescriptor, _In_ DWORD DesiredAccess,
    _In_ PGENERIC_MAPPING GenericMapping, _In_ BOOL ObjectCreation,
    _Out_ LPDWORD GrantedAccess, _Out_ LPBOOL AccessStatus,
...
WINADVAPI
BOOL WINAPI AccessCheckByTypeAndAuditAlarmA(
    _In_ LPCSTR SubsystemName, _In_ LPVOID HandleId, _In_ LPCSTR ObjectTypeName,
    _In_opt_ LPCSTR ObjectName, _In_ PSECURITY_DESCRIPTOR SecurityDescriptor,
    _In_opt_ PSID PrincipalSelfSid, _In_ DWORD DesiredAccess,
    _In_ AUDIT_EVENT_TYPE AuditType, _In_ DWORD Flags,
    _Inout_updates_opt_(ObjectTypeListLength) POBJECT_TYPE_LIST ObjectTypeList,
    _In_ DWORD ObjectTypeListLength, _In_ PGENERIC_MAPPING GenericMapping,
    _In_ BOOL ObjectCreation, _Out_ LPDWORD GrantedAccess,
    _Out_ LPBOOL AccessStatus, _Out_ LPBOOL pfGenerateOnClose);
#ifndef UNICODE
...
BOOL WINAPI AccessCheckByTypeResultListAndAuditAlarmByHandleA(
    ...
    _In_ LPCSTR ObjectTypeName, _In_opt_ LPCSTR ObjectName,
...
BOOL WINAPI ObjectOpenAuditAlarmA(
    _In_ LPCSTR SubsystemName, _In_ LPVOID HandleId, _In_ LPSTR ObjectTypeName,
    _In_opt_ LPSTR ObjectName, _In_ PSECURITY_DESCRIPTOR pSecurityDescriptor,
    _In_ HANDLE ClientToken, _In_ DWORD DesiredAccess, _In_ DWORD GrantedAccess,
    _In_opt_ PPRIVILEGE_SET Privileges, _In_ BOOL ObjectCreation,
    _In_ BOOL AccessGranted, _Out_ LPBOOL GenerateOnClose);
#ifndef UNICODE
#define ObjectOpenAuditAlarm ObjectOpenAuditAlarmA
#endif

WINADVAPI
BOOL WINAPI ObjectPrivilegeAuditAlarmA(_In_ LPCSTR SubsystemName,
...
WINADVAPI
BOOL WINAPI ObjectCloseAuditAlarmA(_In_ LPCSTR SubsystemName,
                                   _In_ LPVOID HandleId,
...
WINADVAPI
BOOL WINAPI ObjectDeleteAuditAlarmA(_In_ LPCSTR SubsystemName,
                                    _In_ LPVOID HandleId,
                                    _In_ BOOL GenerateOnClose);
#ifndef UNICODE
...
WINADVAPI
BOOL WINAPI PrivilegedServiceAuditAlarmA(_In_ LPCSTR SubsystemName,
...
#if (_WIN32_WINNT >= 0x0601)
WINADVAPI
BOOL WINAPI AddConditionalAce(_Inout_ PACL pAcl, _In_ DWORD dwAceRevision,
                              _In_ DWORD AceFlags, _In_ UCHAR AceType,
                              _In_ DWORD AccessMask, _In_ PSID pSid,
...
WINADVAPI
BOOL WINAPI SetFileSecurityA(_In_ LPCSTR lpFileName,
...
BOOL WINAPI GetFileSecurityA(_In_ LPCSTR lpFileName,
                             ...
                             _Out_writes_bytes_to_opt_(nLength,
                                                       *lpnLengthNeeded)
                                 PSECURITY_DESCRIPTOR pSecurityDescriptor,
                             _In_ DWORD nLength, _Out_ LPDWORD lpnLengthNeeded);
#ifndef UNICODE
...
BOOL WINAPI ReadDirectoryChangesW(
    ...
    _In_ DWORD nBufferLength, _In_ BOOL bWatchSubtree,
    _In_ DWORD dwNotifyFilter, _Out_opt_ LPDWORD lpBytesReturned,
    _Inout_opt_ LPOVERLAPPED lpOverlapped,
...
WINBASEAPI
_Ret_maybenull_ __out_data_source(FILE) LPVOID WINAPI
    MapViewOfFileExNuma(_In_ HANDLE hFileMappingObject,
                        _In_ DWORD dwDesiredAccess, _In_ DWORD dwFileOffsetHigh,
                        _In_ DWORD dwFileOffsetLow,
                        _In_ SIZE_T dwNumberOfBytesToMap,
                        _In_opt_ LPVOID lpBaseAddress, _In_ DWORD nndPreferred);

#endif // _WIN32_WINNT >= 0x0600

WINBASEAPI
BOOL WINAPI IsBadReadPtr(_In_opt_ CONST VOID *lp, _In_ UINT_PTR ucb);

WINBASEAPI
BOOL WINAPI IsBadWritePtr(_In_opt_ LPVOID lp, _In_ UINT_PTR ucb);

WINBASEAPI
BOOL WINAPI IsBadHugeReadPtr(_In_opt_ CONST VOID *lp, _In_ UINT_PTR ucb);

WINBASEAPI
BOOL WINAPI IsBadHugeWritePtr(_In_opt_ LPVOID lp, _In_ UINT_PTR ucb);

WINBASEAPI
BOOL WINAPI IsBadCodePtr(_In_opt_ FARPROC lpfn);

WINBASEAPI
BOOL WINAPI IsBadStringPtrA(_In_opt_ LPCSTR lpsz, _In_ UINT_PTR ucchMax);
WINBASEAPI
BOOL WINAPI IsBadStringPtrW(_In_opt_ LPCWSTR lpsz, _In_ UINT_PTR ucchMax);
#ifdef UNICODE
...
WINADVAPI
_Success_(return != FALSE) BOOL WINAPI
    LookupAccountSidA(_In_opt_ LPCSTR lpSystemName, _In_ PSID Sid,
                      _Out_writes_to_opt_(*cchName, *cchName + 1) LPSTR Name,
                      _Inout_ LPDWORD cchName,
                      _Out_writes_to_opt_(*cchReferencedDomainName,
...
WINADVAPI
_Success_(return != FALSE) BOOL WINAPI
    LookupAccountSidW(_In_opt_ LPCWSTR lpSystemName, _In_ PSID Sid,
...
WINADVAPI
_Success_(return != FALSE) BOOL WINAPI LookupAccountNameA(
    _In_opt_ LPCSTR lpSystemName, _In_ LPCSTR lpAccountName,
    _Out_writes_bytes_to_opt_(*cbSid, *cbSid) PSID Sid, _Inout_ LPDWORD cbSid,
    _Out_writes_to_opt_(*cchReferencedDomainName, *cchReferencedDomainName + 1)
        LPSTR ReferencedDomainName,
    _Inout_ LPDWORD cchReferencedDomainName, _Out_ PSID_NAME_USE peUse);
WINADVAPI
_Success_(return != FALSE) BOOL WINAPI LookupAccountNameW(
    _In_opt_ LPCWSTR lpSystemName, _In_ LPCWSTR lpAccountName,
    _Out_writes_bytes_to_opt_(*cbSid, *cbSid) PSID Sid, _Inout_ LPDWORD cbSid,
    _Out_writes_to_opt_(*cchReferencedDomainName, *cchReferencedDomainName + 1)
        LPWSTR ReferencedDomainName,
    _Inout_ LPDWORD cchReferencedDomainName, _Out_ PSID_NAME_USE peUse);
...
WINADVAPI
_Success_(return != FALSE) BOOL WINAPI LookupAccountNameLocalA(
    ...
    _Inout_ LPDWORD cchReferencedDomainName, _Out_ PSID_NAME_USE peUse);
WINADVAPI
_Success_(return != FALSE) BOOL WINAPI LookupAccountNameLocalW(
...
WINADVAPI
_Success_(return != FALSE) BOOL WINAPI LookupAccountSidLocalA(
    _In_ PSID Sid, _Out_writes_to_opt_(*cchName, *cchName + 1) LPSTR Name,
    _Inout_ LPDWORD cchName,
    _Out_writes_to_opt_(*cchReferencedDomainName, *cchReferencedDomainName + 1)
        LPSTR ReferencedDomainName,
    _Inout_ LPDWORD cchReferencedDomainName, _Out_ PSID_NAME_USE peUse);
WINADVAPI
_Success_(return != FALSE) BOOL WINAPI LookupAccountSidLocalW(
    _In_ PSID Sid, _Out_writes_to_opt_(*cchName, *cchName + 1) LPWSTR Name,
    _Inout_ LPDWORD cchName,
    _Out_writes_to_opt_(*cchReferencedDomainName, *cchReferencedDomainName + 1)
        LPWSTR ReferencedDomainName,
    _Inout_ LPDWORD cchReferencedDomainName, _Out_ PSID_NAME_USE peUse);
...
WINADVAPI
BOOL WINAPI LookupPrivilegeValueA(_In_opt_ LPCSTR lpSystemName,
                                  _In_ LPCSTR lpName, _Out_ PLUID lpLuid);
WINADVAPI
BOOL WINAPI LookupPrivilegeValueW(_In_opt_ LPCWSTR lpSystemName,
                                  _In_ LPCWSTR lpName, _Out_ PLUID lpLuid);
#ifdef UNICODE
...
WINADVAPI
_Success_(return != FALSE) BOOL WINAPI
    LookupPrivilegeNameA(_In_opt_ LPCSTR lpSystemName, _In_ PLUID lpLuid,
                         _Out_writes_to_opt_(*cchName, *cchName + 1)
                             LPSTR lpName,
                         _Inout_ LPDWORD cchName);
WINADVAPI
_Success_(return != FALSE) BOOL WINAPI
    LookupPrivilegeNameW(_In_opt_ LPCWSTR lpSystemName, _In_ PLUID lpLuid,
                         _Out_writes_to_opt_(*cchName, *cchName + 1)
                             LPWSTR lpName,
                         _Inout_ LPDWORD cchName);
#ifdef UNICODE
...
WINADVAPI
_Success_(return != FALSE) BOOL WINAPI LookupPrivilegeDisplayNameA(
    _In_opt_ LPCSTR lpSystemName, _In_ LPCSTR lpName,
    _Out_writes_to_opt_(*cchDisplayName, *cchDisplayName + 1)
        LPSTR lpDisplayName,
    _Inout_ LPDWORD cchDisplayName, _Out_ LPDWORD lpLanguageId);
WINADVAPI
_Success_(return != FALSE) BOOL WINAPI LookupPrivilegeDisplayNameW(
    _In_opt_ LPCWSTR lpSystemName, _In_ LPCWSTR lpName,
    _Out_writes_to_opt_(*cchDisplayName, *cchDisplayName + 1)
...
WINBASEAPI
BOOL WINAPI BuildCommDCBA(_In_ LPCSTR lpDef, _Out_ LPDCB lpDCB);
WINBASEAPI
BOOL WINAPI BuildCommDCBW(_In_ LPCWSTR lpDef, _Out_ LPDCB lpDCB);
#ifdef UNICODE
...
WINBASEAPI
BOOL WINAPI BuildCommDCBAndTimeoutsA(_In_ LPCSTR lpDef, _Out_ LPDCB lpDCB,
                                     _Out_ LPCOMMTIMEOUTS lpCommTimeouts);
WINBASEAPI
BOOL WINAPI BuildCommDCBAndTimeoutsW(_In_ LPCWSTR lpDef, _Out_ LPDCB lpDCB,
                                     _Out_ LPCOMMTIMEOUTS lpCommTimeouts);
#ifdef UNICODE
...
WINBASEAPI
BOOL WINAPI CommConfigDialogA(_In_ LPCSTR lpszName, _In_opt_ HWND hWnd,
                              _Inout_ LPCOMMCONFIG lpCC);
WINBASEAPI
BOOL WINAPI CommConfigDialogW(_In_ LPCWSTR lpszName, _In_opt_ HWND hWnd,
                              _Inout_ LPCOMMCONFIG lpCC);
#ifdef UNICODE
...
BOOL WINAPI GetDefaultCommConfigA(_In_ LPCSTR lpszName,
                                  _Out_writes_bytes_to_(*lpdwSize, *lpdwSize)
                                      LPCOMMCONFIG lpCC,
                                  _Inout_ LPDWORD lpdwSize);
WINBASEAPI
...
WINBASEAPI
_Success_(return != 0) BOOL WINAPI
    GetComputerNameA(_Out_writes_to_opt_(*nSize, *nSize + 1) LPSTR lpBuffer,
                     _Inout_ LPDWORD nSize);
WINBASEAPI
_Success_(return != 0) BOOL WINAPI
    GetComputerNameW(_Out_writes_to_opt_(*nSize, *nSize + 1) LPWSTR lpBuffer,
                     _Inout_ LPDWORD nSize);
#ifdef UNICODE
...
WINBASEAPI
_Success_(return != FALSE) BOOL WINAPI
    DnsHostnameToComputerNameA(_In_ LPCSTR Hostname,
                               _Out_writes_to_opt_(*nSize, *nSize + 1)
                                   LPSTR ComputerName,
                               _Inout_ LPDWORD nSize);
WINBASEAPI
_Success_(return != FALSE) BOOL WINAPI
    DnsHostnameToComputerNameW(_In_ LPCWSTR Hostname,
                               _Out_writes_to_opt_(*nSize, *nSize + 1)
                                   LPWSTR ComputerName,
                               _Inout_ LPDWORD nSize);
#ifdef UNICODE
...
WINADVAPI
BOOL WINAPI GetUserNameA(_Out_writes_to_opt_(*pcbBuffer, *pcbBuffer)
                             LPSTR lpBuffer,
                         _Inout_ LPDWORD pcbBuffer);
WINADVAPI
BOOL WINAPI GetUserNameW(_Out_writes_to_opt_(*pcbBuffer, *pcbBuffer)
                             LPWSTR lpBuffer,
                         _Inout_ LPDWORD pcbBuffer);
#ifdef UNICODE
...
WINADVAPI
BOOL WINAPI LogonUserA(_In_ LPCSTR lpszUsername, _In_opt_ LPCSTR lpszDomain,
                       _In_opt_ LPCSTR lpszPassword, _In_ DWORD dwLogonType,
                       _In_ DWORD dwLogonProvider, _Outptr_ PHANDLE phToken);
WINADVAPI
BOOL WINAPI LogonUserW(_In_ LPCWSTR lpszUsername, _In_opt_ LPCWSTR lpszDomain,
                       _In_opt_ LPCWSTR lpszPassword, _In_ DWORD dwLogonType,
                       _In_ DWORD dwLogonProvider, _Outptr_ PHANDLE phToken);
#ifdef UNICODE
...
WINADVAPI
BOOL WINAPI LogonUserExA(_In_ LPCSTR lpszUsername, _In_opt_ LPCSTR lpszDomain,
                         _In_opt_ LPCSTR lpszPassword, _In_ DWORD dwLogonType,
...
WINADVAPI
BOOL WINAPI LogonUserExW(_In_ LPCWSTR lpszUsername, _In_opt_ LPCWSTR lpszDomain,
                         _In_opt_ LPCWSTR lpszPassword, _In_ DWORD dwLogonType,
                         _In_ DWORD dwLogonProvider,
                         _Outptr_opt_ PHANDLE phToken,
                         _Outptr_opt_ PSID *ppLogonSid,
...
WINADVAPI
_Must_inspect_result_ BOOL WINAPI CreateProcessWithLogonW(
    _In_ LPCWSTR lpUsername, _In_opt_ LPCWSTR lpDomain, _In_ LPCWSTR lpPassword,
    _In_ DWORD dwLogonFlags, _In_opt_ LPCWSTR lpApplicationName,
    _Inout_opt_ LPWSTR lpCommandLine, _In_ DWORD dwCreationFlags,
    _In_opt_ LPVOID lpEnvironment, _In_opt_ LPCWSTR lpCurrentDirectory,
    _In_ LPSTARTUPINFOW lpStartupInfo,
    _Out_ LPPROCESS_INFORMATION lpProcessInformation);

WINADVAPI
_Must_inspect_result_ BOOL WINAPI CreateProcessWithTokenW(
    _In_ HANDLE hToken, _In_ DWORD dwLogonFlags,
...
WINADVAPI
BOOL WINAPI IsTokenUntrusted(_In_ HANDLE TokenHandle);
...
WINBASEAPI
BOOL WINAPI RegisterWaitForSingleObject(_Outptr_ PHANDLE phNewWaitObject,
                                        _In_ HANDLE hObject,
...
WINBASEAPI
_Must_inspect_result_ BOOL WINAPI UnregisterWait(_In_ HANDLE WaitHandle);

WINBASEAPI
BOOL WINAPI BindIoCompletionCallback(
    _In_ HANDLE FileHandle, _In_ LPOVERLAPPED_COMPLETION_ROUTINE Function,
    _In_ ULONG Flags);

WINBASEAPI
HANDLE
WINAPI
SetTimerQueueTimer(_In_opt_ HANDLE TimerQueue,
                   _In_ WAITORTIMERCALLBACK Callback, _In_opt_ PVOID Parameter,
                   _In_ DWORD DueTime, _In_ DWORD Period, _In_ BOOL PreferIo);

WINBASEAPI
_Must_inspect_result_ BOOL WINAPI
CancelTimerQueueTimer(_In_opt_ HANDLE TimerQueue, _In_ HANDLE Timer);
...
FORCEINLINE
VOID SetThreadpoolCallbackPool(_Inout_ PTP_CALLBACK_ENVIRON pcbe,
                               _In_ PTP_POOL ptpp) {
...
VOID SetThreadpoolCallbackCleanupGroup(
    _Inout_ PTP_CALLBACK_ENVIRON pcbe, _In_ PTP_CLEANUP_GROUP ptpcg,
...
FORCEINLINE
VOID SetThreadpoolCallbackLibrary(_Inout_ PTP_CALLBACK_ENVIRON pcbe,
                                  _In_ PVOID mod) {
...
FORCEINLINE
VOID SetThreadpoolCallbackPriority(_Inout_ PTP_CALLBACK_ENVIRON pcbe,
...
WINBASEAPI
_Ret_maybenull_ HANDLE WINAPI CreatePrivateNamespaceA(
    _In_opt_ LPSECURITY_ATTRIBUTES lpPrivateNamespaceAttributes,
    _In_ LPVOID lpBoundaryDescriptor, _In_ LPCSTR lpAliasPrefix);
...
WINBASEAPI
_Ret_maybenull_ HANDLE WINAPI OpenPrivateNamespaceA(
    _In_ LPVOID lpBoundaryDescriptor, _In_ LPCSTR lpAliasPrefix);
...
WINBASEAPI
_Ret_maybenull_ HANDLE APIENTRY CreateBoundaryDescriptorA(_In_ LPCSTR Name,
                                                          _In_ ULONG Flags);
...
BOOL WINAPI AddIntegrityLabelToBoundaryDescriptor(
    _Inout_ HANDLE *BoundaryDescriptor, _In_ PSID IntegrityLabel);
...
WINADVAPI
BOOL WINAPI GetCurrentHwProfileA(_Out_ LPHW_PROFILE_INFOA lpHwProfileInfo);
WINADVAPI
BOOL WINAPI GetCurrentHwProfileW(_Out_ LPHW_PROFILE_INFOW lpHwProfileInfo);
#ifdef UNICODE
...
WINBASEAPI
BOOL WINAPI VerifyVersionInfoA(_Inout_ LPOSVERSIONINFOEXA lpVersionInformation,
                               _In_ DWORD dwTypeMask,
                               _In_ DWORDLONG dwlConditionMask);
WINBASEAPI
BOOL WINAPI VerifyVersionInfoW(_Inout_ LPOSVERSIONINFOEXW lpVersionInformation,
                               _In_ DWORD dwTypeMask,
                               _In_ DWORDLONG dwlConditionMask);
#ifdef UNICODE
...
#define AC_LINE_BACKUP_POWER                                                   \
  0x02 // Deprecated value; Not used on any NT based version of Windows
...
WINBASEAPI
BOOL WINAPI
GetSystemPowerStatus(_Out_ LPSYSTEM_POWER_STATUS lpSystemPowerStatus);
...
WINBASEAPI
BOOL WINAPI MapUserPhysicalPagesScatter(_In_reads_(NumberOfPages)
                                            PVOID *VirtualAddresses,
                                        _In_ ULONG_PTR NumberOfPages,
                                        _In_reads_opt_(NumberOfPages)
...
WINBASEAPI
_Ret_maybenull_ HANDLE WINAPI CreateJobObjectA(
    _In_opt_ LPSECURITY_ATTRIBUTES lpJobAttributes, _In_opt_ LPCSTR lpName);
...
WINBASEAPI
_Ret_maybenull_ HANDLE WINAPI OpenJobObjectA(_In_ DWORD dwDesiredAccess,
                                             _In_ BOOL bInheritHandle,
                                             _In_ LPCSTR lpName);
...
WINBASEAPI
BOOL WINAPI CreateJobSet(_In_ ULONG NumJob,
...
HANDLE
WINAPI
FindFirstVolumeA(_Out_writes_(cchBufferLength) LPSTR lpszVolumeName,
...
WINBASEAPI
BOOL WINAPI FindNextVolumeA(_Inout_ HANDLE hFindVolume,
...
HANDLE
WINAPI
FindFirstVolumeMountPointA(_In_ LPCSTR lpszRootPathName,
                           _Out_writes_(cchBufferLength)
                               LPSTR lpszVolumeMountPoint,
                           _In_ DWORD cchBufferLength);
WINBASEAPI
HANDLE
WINAPI
FindFirstVolumeMountPointW(_In_ LPCWSTR lpszRootPathName,
                           _Out_writes_(cchBufferLength)
...
WINBASEAPI
BOOL WINAPI FindNextVolumeMountPointA(_In_ HANDLE hFindVolumeMountPoint,
                                      _Out_writes_(cchBufferLength)
                                          LPSTR lpszVolumeMountPoint,
                                      _In_ DWORD cchBufferLength);
WINBASEAPI
BOOL WINAPI FindNextVolumeMountPointW(_In_ HANDLE hFindVolumeMountPoint,
                                      _Out_writes_(cchBufferLength)
                                          LPWSTR lpszVolumeMountPoint,
                                      _In_ DWORD cchBufferLength);
#ifdef UNICODE
...
WINBASEAPI
BOOL WINAPI SetVolumeMountPointA(_In_ LPCSTR lpszVolumeMountPoint,
                                 _In_ LPCSTR lpszVolumeName);
WINBASEAPI
BOOL WINAPI SetVolumeMountPointW(_In_ LPCWSTR lpszVolumeMountPoint,
...
WINBASEAPI
BOOL WINAPI DeleteVolumeMountPointA(_In_ LPCSTR lpszVolumeMountPoint);
#ifndef UNICODE
...
WINBASEAPI
BOOL WINAPI GetVolumeNameForVolumeMountPointA(_In_ LPCSTR lpszVolumeMountPoint,
                                              _Out_writes_(cchBufferLength)
...
WINBASEAPI
BOOL WINAPI GetVolumePathNameA(_In_ LPCSTR lpszFileName,
                               _Out_writes_(cchBufferLength)
...
WINBASEAPI
BOOL WINAPI GetVolumePathNamesForVolumeNameA(
    _In_ LPCSTR lpszVolumeName,
    _Out_writes_to_opt_(cchBufferLength, *lpcchReturnLength)
        _Post_ _NullNull_terminated_ LPCH lpszVolumePathNames,
    _In_ DWORD cchBufferLength, _Out_ PDWORD lpcchReturnLength);
...
HANDLE
WINAPI
CreateActCtxA(_In_ PCACTCTXA pActCtx);
WINBASEAPI
HANDLE
WINAPI
CreateActCtxW(_In_ PCACTCTXW pActCtx);
#ifdef UNICODE
...
WINBASEAPI
VOID WINAPI AddRefActCtx(_Inout_ HANDLE hActCtx);

WINBASEAPI
VOID WINAPI ReleaseActCtx(_Inout_ HANDLE hActCtx);

WINBASEAPI
BOOL WINAPI ZombifyActCtx(_Inout_ HANDLE hActCtx);

_Success_(return) WINBASEAPI BOOL WINAPI
    ActivateActCtx(_Inout_opt_ HANDLE hActCtx, _Out_ ULONG_PTR *lpCookie);

#define DEACTIVATE_ACTCTX_FLAG_FORCE_EARLY_DEACTIVATION (0x00000001)

_Success_(return) WINBASEAPI BOOL WINAPI
    DeactivateActCtx(_In_ DWORD dwFlags, _In_ ULONG_PTR ulCookie);

WINBASEAPI
BOOL WINAPI GetCurrentActCtx(_Outptr_ HANDLE *lphActCtx);
...
_Success_(return) WINBASEAPI BOOL WINAPI
    FindActCtxSectionStringA(_In_ DWORD dwFlags,
                             _Reserved_ const GUID *lpExtensionGuid,
                             _In_ ULONG ulSectionId, _In_ LPCSTR lpStringToFind,
                             _Out_ PACTCTX_SECTION_KEYED_DATA ReturnedData);
_Success_(return) WINBASEAPI BOOL WINAPI
    FindActCtxSectionStringW(_In_ DWORD dwFlags,
                             _Reserved_ const GUID *lpExtensionGuid,
...
WINBASEAPI
BOOL WINAPI FindActCtxSectionGuid(
    _In_ DWORD dwFlags, _Reserved_ const GUID *lpExtensionGuid,
    _In_ ULONG ulSectionId, _In_opt_ const GUID *lpGuidToFind,
    _Out_ PACTCTX_SECTION_KEYED_DATA ReturnedData);
...
//      *pvSubInstance <
//      ACTIVATION_CONTEXT_DETAILED_INFORMATION::ulAssemblyCount
...
//      pvSubInstance->ulAssemblyIndex <
//      ACTIVATION_CONTEXT_DETAILED_INFORMATION::ulAssemblyCount
//      pvSubInstance->ulFileIndexInAssembly <
//      ACTIVATION_CONTEXT_ASSEMBLY_DETAILED_INFORMATION::ulFileCount
...
//
_Success_(return) WINBASEAPI BOOL WINAPI
    QueryActCtxW(_In_ DWORD dwFlags, _In_ HANDLE hActCtx,
                 _In_opt_ PVOID pvSubInstance, _In_ ULONG ulInfoClass,
                 _Out_writes_bytes_to_opt_(cbBuffer, *pcbWrittenOrRequired)
                     PVOID pvBuffer,
                 _In_ SIZE_T cbBuffer, _Out_opt_ SIZE_T *pcbWrittenOrRequired);

typedef _Success_(return) BOOL(WINAPI *PQUERYACTCTXW_FUNC)(
    _In_ DWORD dwFlags, _In_ HANDLE hActCtx, _In_opt_ PVOID pvSubInstance,
...
DWORD
WINAPI
GetActiveProcessorCount(_In_ WORD GroupNumber);

WINBASEAPI
DWORD
WINAPI
GetMaximumProcessorCount(_In_ WORD GroupNumber);
...
WINBASEAPI
BOOL WINAPI GetNumaNodeNumberFromHandle(_In_ HANDLE hFile,
...
WINBASEAPI
BOOL WINAPI GetNumaProcessorNodeEx(_In_ PPROCESSOR_NUMBER Processor,
                                   _Out_ PUSHORT NodeNumber);
...
WINBASEAPI
BOOL WINAPI GetNumaAvailableMemoryNodeEx(_In_ USHORT Node,
                                         _Out_ PULONGLONG AvailableBytes);
...
WINBASEAPI
BOOL WINAPI GetNumaProximityNode(_In_ ULONG ProximityId,
...
//
// Max length of commandline in characters (including the NULL character that
// can be registered for restart)
//
...
//
// Do not restart the process when the system is rebooted due to patch
// installations
//
...
RegisterApplicationRecoveryCallback(
    ...
    _In_opt_ PVOID pvParameter, _In_ DWORD dwPingInterval, _In_ DWORD dwFlags);
...
HRESULT
WINAPI
RegisterApplicationRestart(_In_opt_ PCWSTR pwzCommandline, _In_ DWORD dwFlags);
...
GetApplicationRecoveryCallback(
    ...
    _Out_opt_ PDWORD pdwPingInterval, _Out_opt_ PDWORD pdwFlags);

WINBASEAPI
HRESULT
WINAPI
GetApplicationRestartSettings(_In_ HANDLE hProcess,
...
HRESULT
WINAPI
ApplicationRecoveryInProgress(_Out_ PBOOL pbCancelled);
...
BOOL WINAPI GetFileInformationByName(
    _In_ PCWSTR FileName, _In_ FILE_INFO_BY_NAME_CLASS FileInformationClass,
...
HANDLE
WINAPI
OpenFileById(_In_ HANDLE hVolumeHint, _In_ LPFILE_ID_DESCRIPTOR lpFileId,
...
BOOLEAN
APIENTRY
CreateSymbolicLinkA(_In_ LPCSTR lpSymlinkFileName, _In_ LPCSTR lpTargetFileName,
                    _In_ DWORD dwFlags);
WINBASEAPI
BOOLEAN
APIENTRY
CreateSymbolicLinkW(_In_ LPCWSTR lpSymlinkFileName,
                    _In_ LPCWSTR lpTargetFileName, _In_ DWORD dwFlags);
#ifdef UNICODE
...
BOOL WINAPI QueryActCtxSettingsW(
    _In_opt_ DWORD dwFlags, _In_opt_ HANDLE hActCtx,
    _In_opt_ PCWSTR settingsNameSpace, _In_ PCWSTR settingName,
    _Out_writes_bytes_to_opt_(dwBuffer, *pdwWrittenOrRequired) PWSTR pvBuffer,
    _In_ SIZE_T dwBuffer, _Out_opt_ SIZE_T *pdwWrittenOrRequired);
...
BOOLEAN
APIENTRY
CreateSymbolicLinkTransactedA(_In_ LPCSTR lpSymlinkFileName,
                              _In_ LPCSTR lpTargetFileName, _In_ DWORD dwFlags,
                              _In_ HANDLE hTransaction);
WINBASEAPI
BOOLEAN
APIENTRY
CreateSymbolicLinkTransactedW(_In_ LPCWSTR lpSymlinkFileName,
                              _In_ LPCWSTR lpTargetFileName, _In_ DWORD dwFlags,
                              _In_ HANDLE hTransaction);
#ifdef UNICODE
...
WINBASEAPI
BOOL WINAPI ReplacePartitionUnit(_In_ PWSTR TargetPartition,
                                 _In_ PWSTR SparePartition, _In_ ULONG Flags);
...
_Must_inspect_result_
    WINBASEAPI BOOL WINAPI CopyContext(_Inout_ PCONTEXT Destination,
...
_Success_(return != FALSE) WINBASEAPI BOOL WINAPI
    InitializeContext(_Out_writes_bytes_opt_(*ContextLength) PVOID Buffer,
                      _In_ DWORD ContextFlags, _Out_ PCONTEXT *Context,
...
_Success_(return != FALSE) WINBASEAPI BOOL WINAPI
    InitializeContext2(_Out_writes_bytes_opt_(*ContextLength) PVOID Buffer,
                       _In_ DWORD ContextFlags, _Out_ PCONTEXT *Context,
                       _Inout_ PDWORD ContextLength,
...
_Must_inspect_result_ WINBASEAPI BOOL WINAPI
GetXStateFeaturesMask(_In_ PCONTEXT Context, _Out_ PDWORD64 FeatureMask);

_Success_(return != NULL) WINBASEAPI PVOID WINAPI
    LocateXStateFeature(_In_ PCONTEXT Context, _In_ DWORD FeatureId,
                        _Out_opt_ PDWORD Length);

_Must_inspect_result_ WINBASEAPI BOOL WINAPI
SetXStateFeaturesMask(_Inout_ PCONTEXT Context, _In_ DWORD64 FeatureMask);
...
_Must_inspect_result_ WINBASEAPI BOOL WINAPI
EnableProcessOptionalXStateFeatures(_In_ DWORD64 Features);
...
DWORD
APIENTRY
EnableThreadProfiling(_In_ HANDLE ThreadHandle, _In_ DWORD Flags,
...
DWORD
APIENTRY
DisableThreadProfiling(_In_ HANDLE PerformanceDataHandle);

WINBASEAPI
DWORD
APIENTRY
QueryThreadProfiling(_In_ HANDLE ThreadHandle, _Out_ PBOOLEAN Enabled);

WINBASEAPI
DWORD
APIENTRY
ReadThreadProfilingData(_In_ HANDLE PerformanceDataHandle, _In_ DWORD Flags,
...
FORCEINLINE
unsigned
InterlockedIncrement(_Inout_ _Interlocked_operand_ unsigned volatile *Addend) {
  return (unsigned)_InterlockedIncrement((volatile long *)Addend);
}

FORCEINLINE
unsigned long InterlockedIncrement(
...
// ARM64_WORKAROUND : should this work for managed code?
    ...
    ((_WIN32_WINNT >= 0x0502) && defined(_WINBASE_) && !defined(_MANAGED))

FORCEINLINE
unsigned __int64 InterlockedIncrement(
...
FORCEINLINE
unsigned
InterlockedDecrement(_Inout_ _Interlocked_operand_ unsigned volatile *Addend) {
  return (unsigned long)_InterlockedDecrement((volatile long *)Addend);
}

FORCEINLINE
unsigned long InterlockedDecrement(
    _Inout_ _Interlocked_operand_ unsigned long volatile *Addend) {
  return (unsigned long)_InterlockedDecrement((volatile long *)Addend);
}
...
FORCEINLINE
unsigned __int64 InterlockedDecrement(
    _Inout_ _Interlocked_operand_ unsigned __int64 volatile *Addend) {
...
FORCEINLINE
unsigned
InterlockedExchange(_Inout_ _Interlocked_operand_ unsigned volatile *Target,
                    _In_ unsigned Value) {
  return (unsigned)_InterlockedExchange((volatile long *)Target, (long)Value);
}

FORCEINLINE
unsigned long InterlockedExchange(
    _Inout_ _Interlocked_operand_ unsigned long volatile *Target,
    _In_ unsigned long Value) {
  return (unsigned long)_InterlockedExchange((volatile long *)Target,
                                             (long)Value);
}
...
FORCEINLINE
unsigned __int64 InterlockedExchange(
...
FORCEINLINE
unsigned
InterlockedExchangeAdd(_Inout_ _Interlocked_operand_ unsigned volatile *Addend,
                       _In_ unsigned Value) {
  return (unsigned)_InterlockedExchangeAdd((volatile long *)Addend,
                                           (long)Value);
}
...
FORCEINLINE
unsigned long InterlockedExchangeAdd(
    _Inout_ _Interlocked_operand_ unsigned long volatile *Addend,
    _In_ unsigned long Value) {
  return (unsigned long)_InterlockedExchangeAdd((volatile long *)Addend,
                                                (long)Value);
}
...
FORCEINLINE
unsigned __int64 InterlockedExchangeAdd(
    _Inout_ _Interlocked_operand_ unsigned __int64 volatile *Addend,
    _In_ unsigned __int64 Value) {
...
FORCEINLINE
unsigned __int64 InterlockedExchangeSubtract(
    _Inout_ _Interlocked_operand_ unsigned __int64 volatile *Addend,
    _In_ unsigned __int64 Value) {
  return (unsigned __int64)InterlockedExchangeAdd64((volatile __int64 *)Addend,
                                                    -(__int64)Value);
...
unsigned InterlockedCompareExchange(
    ...
    _In_ unsigned Exchange, _In_ unsigned Comperand) {
  return (unsigned)_InterlockedCompareExchange((volatile long *)Destination,
...
unsigned long InterlockedCompareExchange(
    ...
    _In_ unsigned long Exchange, _In_ unsigned long Comperand) {
  return (unsigned long)_InterlockedCompareExchange(
...
FORCEINLINE
unsigned __int64 InterlockedCompareExchange(
    _Inout_ _Interlocked_operand_ unsigned __int64 volatile *Destination,
    _In_ unsigned __int64 Exchange, _In_ unsigned __int64 Comperand) {
  return (unsigned __int64)_InterlockedCompareExchange64(
      (volatile __int64 *)Destination, (__int64)Exchange, (__int64)Comperand);
}

FORCEINLINE
unsigned __int64 InterlockedAnd(
    _Inout_ _Interlocked_operand_ unsigned __int64 volatile *Destination,
    _In_ unsigned __int64 Value) {
...
FORCEINLINE
unsigned __int64 InterlockedOr(
    _Inout_ _Interlocked_operand_ unsigned __int64 volatile *Destination,
    _In_ unsigned __int64 Value) {
...
FORCEINLINE
unsigned __int64 InterlockedXor(
    _Inout_ _Interlocked_operand_ unsigned __int64 volatile *Destination,
    _In_ unsigned __int64 Value) {
