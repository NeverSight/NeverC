...
#define FSRM_DISPID_FILESCREEN_BASE                                            \
  ((FSRM_DISPID_FEATURE_FILESCREEN | 0x300000))

#define FSRM_DISPID_FILESCREEN ((FSRM_DISPID_FILESCREEN_BASE | 0x10000))

#define FSRM_DISPID_FILESCREEN_TEMPLATE                                        \
  ((FSRM_DISPID_FILESCREEN_BASE | 0x20000))
...
typedef struct IFsrmFileGroupVtbl {
  ...
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in IFsrmFileGroup *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IFsrmFileGroup *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IFsrmFileGroup *This);
...
interface IFsrmFileGroup { CONST_VTBL struct IFsrmFileGroupVtbl *lpVtbl; };
...
typedef struct IFsrmFileGroupImportedVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IFsrmFileGroupImported *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IFsrmFileGroupImported *This);
...
typedef struct IFsrmFileGroupManagerVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IFsrmFileGroupManager *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IFsrmFileGroupManager *This);
...
typedef struct IFsrmFileScreenBaseVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IFsrmFileScreenBase *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IFsrmFileScreenBase *This);
...
typedef struct IFsrmFileScreenVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in IFsrmFileScreen *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IFsrmFileScreen *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IFsrmFileScreen *This);
  ...
  DECLSPEC_XFGVIRT(IFsrmFileScreenBase, put_FileScreenFlags)
  /* [helpstring][id][propput] */ HRESULT(
      STDMETHODCALLTYPE *put_FileScreenFlags)(__RPC__in IFsrmFileScreen *This,
                                              /* [in] */ long fileScreenFlags);
...
interface IFsrmFileScreen { CONST_VTBL struct IFsrmFileScreenVtbl *lpVtbl; };
...
typedef struct IFsrmFileScreenExceptionVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IFsrmFileScreenException *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IFsrmFileScreenException *This);
  ...
  /* [helpstring][id][propput] */ HRESULT(
      STDMETHODCALLTYPE *put_AllowedFileGroups)(
      __RPC__in IFsrmFileScreenException *This,
...
public:
  ...
  virtual /* [helpstring][id] */ HRESULT STDMETHODCALLTYPE CreateFileScreen(
      ...
      /* [retval][out] */ __RPC__deref_out_opt IFsrmFileScreen *
          *fileScreen) = 0;
  ...
  CreateFileScreenException(
      /* [in] */ __RPC__in BSTR path,
      /* [retval][out] */ __RPC__deref_out_opt IFsrmFileScreenException *
          *fileScreenException) = 0;
...
typedef struct IFsrmFileScreenManagerVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IFsrmFileScreenManager *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IFsrmFileScreenManager *This);
...
typedef struct IFsrmFileScreenTemplateVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IFsrmFileScreenTemplate *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IFsrmFileScreenTemplate *This);
...
public:
  virtual /* [helpstring][id] */ HRESULT STDMETHODCALLTYPE CreateTemplate(
      /* [retval][out] */ __RPC__deref_out_opt IFsrmFileScreenTemplate *
  ...
  virtual /* [helpstring][id] */ HRESULT STDMETHODCALLTYPE ExportTemplates(
      ...
      /* [retval][out] */ __RPC__deref_out_opt BSTR *
          serializedFileScreenTemplates) = 0;
