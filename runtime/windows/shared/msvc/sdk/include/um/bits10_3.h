...
typedef interface IBackgroundCopyServerCertificateValidationCallback
...
public:
  virtual HRESULT STDMETHODCALLTYPE ValidateServerCertificate(
      ...
      /* [size_is][in] */
      __RPC__in_ecount_full(certStoreLength) const BYTE certStoreData[]) = 0;
};
...
typedef struct IBackgroundCopyServerCertificateValidationCallbackVtbl {
  ...
  DECLSPEC_XFGVIRT(IBackgroundCopyServerCertificateValidationCallback,
...
interface IBackgroundCopyServerCertificateValidationCallback {
  CONST_VTBL struct IBackgroundCopyServerCertificateValidationCallbackVtbl
      *lpVtbl;
};

#ifdef COBJMACROS

#define IBackgroundCopyServerCertificateValidationCallback_QueryInterface(     \
    This, riid, ppvObject)                                                     \
...
#define IBackgroundCopyServerCertificateValidationCallback_ValidateServerCertificate( \
    This, job, file, certLength, certData, certEncodingType, certStoreLength,         \
    certStoreData)                                                                    \
  ((This)->lpVtbl->ValidateServerCertificate(This, job, file, certLength,             \
                                             certData, certEncodingType,              \
                                             certStoreLength, certStoreData))
...
typedef struct IBackgroundCopyJobHttpOptions3Vtbl {
  ...
  DECLSPEC_XFGVIRT(IBackgroundCopyJobHttpOptions3,
...
#define IBackgroundCopyJobHttpOptions3_SetClientCertificateByID(               \
    This, StoreLocation, StoreName, pCertHashBlob)                             \
  ((This)->lpVtbl->SetClientCertificateByID(This, StoreLocation, StoreName,    \
                                            pCertHashBlob))

#define IBackgroundCopyJobHttpOptions3_SetClientCertificateByName(             \
...
#define IBackgroundCopyJobHttpOptions3_GetClientCertificate(                   \
...
#define IBackgroundCopyJobHttpOptions3_SetServerCertificateValidationInterface( \
    This, certValidationCallback)                                               \
  ((This)->lpVtbl->SetServerCertificateValidationInterface(                     \
      This, certValidationCallback))
