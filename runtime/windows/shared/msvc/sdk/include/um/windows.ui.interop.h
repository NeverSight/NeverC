...
STDAPI GetWindowIdFromWindow(_In_ HWND hwnd,
                             _Out_ ABI::Windows::UI::WindowId *id);
STDAPI GetWindowFromWindowId(_In_ ABI::Windows::UI::WindowId id,
                             _Out_ HWND *hwnd);
#else
typedef struct __x_ABI_CWindows_CUI_CWindowId __x_ABI_CWindows_CUI_CWindowId;
STDAPI GetWindowIdFromWindow(_In_ HWND hwnd,
                             _Out_ __x_ABI_CWindows_CUI_CWindowId *id);
STDAPI GetWindowFromWindowId(_In_ __x_ABI_CWindows_CUI_CWindowId id,
                             _Out_ HWND *hwnd);
#endif
