...
typedef enum {
  ...
  AM_PROPERTY_COPY_ANALOG_COMPONENT =
      0x08, // GetOnly property, return data is a BOOL
...
#define AMCONTROL_COLORINFO_PRESENT                                            \
  0x00000080 // if set, indicates DXVA color info is present in the upper (24)
...
typedef enum {
  ...
  AM_RATE_ResetOnTimeDisc = 10,       // rw, use DWORD - indicates supports new
                                // 'timeline reset on time discontinuity' sample
