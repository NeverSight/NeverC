...
//
// Interface that the client 'record' class needs to support. The ADO Binding
// entries provide the implementation for this interface.
//
class CADORecordBinding {
public:
...
//
// Interface that allows a client to fetch a record of data into class data
// members.
//
