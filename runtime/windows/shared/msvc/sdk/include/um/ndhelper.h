...
public:
  virtual HRESULT STDMETHODCALLTYPE Initialize(
      /* [in] */ ULONG celt,
      /* [size_is][in] */ __RPC__in_ecount_full(celt)
          HELPER_ATTRIBUTE rgAttributes[]) = 0;
  ...
  virtual HRESULT STDMETHODCALLTYPE GetKeyAttributes(
      ...
      /* [size_is][size_is][out] */ __RPC__deref_out_ecount_full_opt(*pcelt)
              HELPER_ATTRIBUTE *
          *pprgAttributes) = 0;
  ...
  virtual HRESULT STDMETHODCALLTYPE GetRepairInfo(
      ...
      /* [out] */ __RPC__out ULONG * pcelt,
      /* [size_is][size_is][out] */
      __RPC__deref_out_ecount_full_opt(*pcelt) RepairInfo * *ppInfo) = 0;
...
typedef struct INetDiagHelperVtbl {
  ...
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in INetDiagHelper *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in INetDiagHelper *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in INetDiagHelper *This);

  DECLSPEC_XFGVIRT(INetDiagHelper, Initialize)
  HRESULT(STDMETHODCALLTYPE *Initialize)(__RPC__in INetDiagHelper *This,
                                         /* [in] */ ULONG celt,
                                         /* [size_is][in] */
                                         __RPC__in_ecount_full(celt)
  ...
  HRESULT(STDMETHODCALLTYPE *GetKeyAttributes)(
      ...
      /* [out] */ __RPC__out ULONG *pcelt,
      /* [size_is][size_is][out] */
      __RPC__deref_out_ecount_full_opt(*pcelt)
  ...
  HRESULT(STDMETHODCALLTYPE *SetLifeTime)(__RPC__in INetDiagHelper *This,
  ...
  HRESULT(STDMETHODCALLTYPE *Cancel)(__RPC__in INetDiagHelper *This);

  DECLSPEC_XFGVIRT(INetDiagHelper, Cleanup)
  HRESULT(STDMETHODCALLTYPE *Cleanup)(__RPC__in INetDiagHelper *This);

  END_INTERFACE
} INetDiagHelperVtbl;

interface INetDiagHelper { CONST_VTBL struct INetDiagHelperVtbl *lpVtbl; };
...
typedef struct INetDiagHelperUtilFactoryVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in INetDiagHelperUtilFactory *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in INetDiagHelperUtilFactory *This);
...
public:
  virtual HRESULT STDMETHODCALLTYPE ReconfirmLowHealth(
      /* [in] */ ULONG celt,
      /* [size_is][in] */ __RPC__in_ecount_full(celt) HypothesisResult *
          pResults,
...
typedef struct INetDiagHelperExVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in INetDiagHelperEx *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in INetDiagHelperEx *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in INetDiagHelperEx *This);
...
interface INetDiagHelperEx { CONST_VTBL struct INetDiagHelperExVtbl *lpVtbl; };
...
#define INetDiagHelperEx_ReconfirmLowHealth(                                   \
  ...
  ((This)->lpVtbl->ReconfirmLowHealth(                                         \
      This, celt, pResults, ppwszUpdatedDescription, pUpdatedStatus))
...
typedef struct INetDiagHelperInfoVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in INetDiagHelperInfo *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in INetDiagHelperInfo *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in INetDiagHelperInfo *This);
...
public:
  virtual HRESULT STDMETHODCALLTYPE ResolveAttributes(
      ...
      /* [out] */ __RPC__out ULONG * pcelt,
      /* [size_is][size_is][out] */
      __RPC__deref_out_ecount_full_opt(*pcelt) HELPER_ATTRIBUTE *
          *prgMatchValues) = 0;
};
...
typedef struct INetDiagExtensibleHelperVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in INetDiagExtensibleHelper *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in INetDiagExtensibleHelper *This);
...
#define INetDiagExtensibleHelper_ResolveAttributes(                            \
    This, celt, rgKeyAttributes, pcelt, prgMatchValues)                        \
  ((This)->lpVtbl->ResolveAttributes(This, celt, rgKeyAttributes, pcelt,       \
                                     prgMatchValues))
