...
unsigned char __RPC_FAR *__RPC_USER BSTR_UserMarshal(ULONG __RPC_FAR *,
                                                     unsigned char __RPC_FAR *,
                                                     BSTR __RPC_FAR *);
unsigned char __RPC_FAR *__RPC_USER BSTR_UserUnmarshal(
    ULONG __RPC_FAR *, unsigned char __RPC_FAR *, BSTR __RPC_FAR *);
void __RPC_USER BSTR_UserFree(ULONG __RPC_FAR *, BSTR __RPC_FAR *);

ULONG __RPC_USER LPSAFEARRAY_UserSize(ULONG __RPC_FAR *, ULONG,
                                      LPSAFEARRAY __RPC_FAR *);
unsigned char __RPC_FAR *__RPC_USER LPSAFEARRAY_UserMarshal(
    ULONG __RPC_FAR *, unsigned char __RPC_FAR *, LPSAFEARRAY __RPC_FAR *);
unsigned char __RPC_FAR *__RPC_USER LPSAFEARRAY_UserUnmarshal(
    ULONG __RPC_FAR *, unsigned char __RPC_FAR *, LPSAFEARRAY __RPC_FAR *);
void __RPC_USER LPSAFEARRAY_UserFree(ULONG __RPC_FAR *,
                                     LPSAFEARRAY __RPC_FAR *);
