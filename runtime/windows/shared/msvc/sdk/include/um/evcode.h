...
// (ULONG, void)
// Sent when a streaming media filter recieves a change in stream description
// information. the UI is expected to re-query for the changed property in
// response
...
// (void, void) : application
// sent to notify the application that the first video frame is about to be
// drawn
