...
#define WIA_DPS_ENDORSER_CHARACTERS                                            \
  3092 // 0xc14, superseded by WIA_IPS_PRINTER_ENDORSER_VALID_CHARACTERS
#define WIA_DPS_ENDORSER_CHARACTERS_STR L"Endorser Characters"

#define WIA_DPS_ENDORSER_STRING                                                \
  3093 // 0xc15, superseded by WIA_IPS_PRINTER_ENDORSER_STRING
...
#define WIA_DPS_TRANSPARENCY_CAPABILITIES_STR                                  \
  L"Transparency Adapter Capabilities"
...
//
// New properties, property names and values specific to WIA 2.0 (introduced in
// Windows Vista):
//
...
#define WIA_IPS_PRINTER_ENDORSER_XOFFSET_STR                                   \
  L"Printer/Endorser Horizontal Offset"
...
#define WIA_IPS_PRINTER_ENDORSER_VALID_CHARACTERS_STR                          \
  L"Printer/Endorser Valid Characters"

#define WIA_IPS_PRINTER_ENDORSER_VALID_FORMAT_SPECIFIERS 4139 // 0x102b
#define WIA_IPS_PRINTER_ENDORSER_VALID_FORMAT_SPECIFIERS_STR                   \
  L"Printer/Endorser Valid Format Specifiers"
...
#define WIA_IPS_PRINTER_ENDORSER_TEXT_DOWNLOAD_STR                             \
  L"Printer/Endorser Text Download"
...
#define WIA_IPS_PRINTER_ENDORSER_GRAPHICS_POSITION_STR                         \
  L"Printer/Endorser Graphics Position"

#define WIA_IPS_PRINTER_ENDORSER_GRAPHICS_MIN_WIDTH 4144 // 0x1030
#define WIA_IPS_PRINTER_ENDORSER_GRAPHICS_MIN_WIDTH_STR                        \
  L"Printer/Endorser Graphics Minimum Width"

#define WIA_IPS_PRINTER_ENDORSER_GRAPHICS_MAX_WIDTH 4145 // 0x1031
#define WIA_IPS_PRINTER_ENDORSER_GRAPHICS_MAX_WIDTH_STR                        \
  L"Printer/Endorser Graphics Maximum Width"

#define WIA_IPS_PRINTER_ENDORSER_GRAPHICS_MIN_HEIGHT 4146 // 0x1032
#define WIA_IPS_PRINTER_ENDORSER_GRAPHICS_MIN_HEIGHT_STR                       \
  L"Printer/Endorser Graphics Minimum Height"

#define WIA_IPS_PRINTER_ENDORSER_GRAPHICS_MAX_HEIGHT 4147 // 0x1033
#define WIA_IPS_PRINTER_ENDORSER_GRAPHICS_MAX_HEIGHT_STR                       \
  L"Printer/Endorser Graphics Maximum Height"

#define WIA_IPS_PRINTER_ENDORSER_GRAPHICS_UPLOAD 4148 // 0x1034
#define WIA_IPS_PRINTER_ENDORSER_GRAPHICS_UPLOAD_STR                           \
  L"Printer/Endorser Graphics Upload"

#define WIA_IPS_PRINTER_ENDORSER_GRAPHICS_DOWNLOAD 4149 // 0x1035
#define WIA_IPS_PRINTER_ENDORSER_GRAPHICS_DOWNLOAD_STR                         \
  L"Printer/Endorser Graphics Download"
...
#define WIA_IPS_PRINTER_ENDORSER_CHARACTER_ROTATION_STR                        \
  L"Printer/Endorser Character Rotation"

#define WIA_IPS_PRINTER_ENDORSER_MAX_CHARACTERS 4188 // 0x105C
#define WIA_IPS_PRINTER_ENDORSER_MAX_CHARACTERS_STR                            \
  L"Printer/Endorser Maximum Characters"

#define WIA_IPS_PRINTER_ENDORSER_MAX_GRAPHICS 4189 // 0x105D
#define WIA_IPS_PRINTER_ENDORSER_MAX_GRAPHICS_STR                              \
  L"Printer/Endorser Maximum Graphics"

#define WIA_IPS_PRINTER_ENDORSER_COUNTER_DIGITS 4190 // 0x105E
#define WIA_IPS_PRINTER_ENDORSER_COUNTER_DIGITS_STR                            \
  L"Printer/Endorser Counter Digits"
...
DEFINE_GUID(WIA_CATEGORY_FINISHED_FILE, 0xff2b77ca, 0xcf84, 0x432b, 0xa7, 0x35,
            0x3a, 0x13, 0x0d, 0xde, 0x2a, 0x88);
DEFINE_GUID(WIA_CATEGORY_FLATBED, 0xfb607b1f, 0x43f3, 0x488b, 0x85, 0x5b, 0xfb,
            0x70, 0x3e, 0xc3, 0x42, 0xa6);
DEFINE_GUID(WIA_CATEGORY_FEEDER, 0xfe131934, 0xf84c, 0x42ad, 0x8d, 0xa4, 0x61,
            0x29, 0xcd, 0xdd, 0x72, 0x88);
DEFINE_GUID(WIA_CATEGORY_FILM, 0xfcf65be7, 0x3ce3, 0x4473, 0xaf, 0x85, 0xf5,
            0xd3, 0x7d, 0x21, 0xb6, 0x8a);
DEFINE_GUID(WIA_CATEGORY_ROOT, 0xf193526f, 0x59b8, 0x4a26, 0x98, 0x88, 0xe1,
            0x6e, 0x4f, 0x97, 0xce, 0x10);
DEFINE_GUID(WIA_CATEGORY_FOLDER, 0xc692a446, 0x6f5a, 0x481d, 0x85, 0xbb, 0x92,
            0xe2, 0xe8, 0x6f, 0xd3, 0xa);
DEFINE_GUID(WIA_CATEGORY_FEEDER_FRONT, 0x4823175c, 0x3b28, 0x487b, 0xa7, 0xe6,
            0xee, 0xbc, 0x17, 0x61, 0x4f, 0xd1);
DEFINE_GUID(WIA_CATEGORY_FEEDER_BACK, 0x61ca74d4, 0x39db, 0x42aa, 0x89, 0xb1,
            0x8c, 0x19, 0xc9, 0xcd, 0x4c, 0x23);
DEFINE_GUID(WIA_CATEGORY_AUTO, 0xdefe5fd8, 0x6c97, 0x4dde, 0xb1, 0x1e, 0xcb,
            0x50, 0x9b, 0x27, 0x0e, 0x11);
DEFINE_GUID(WIA_CATEGORY_IMPRINTER, 0xfc65016d, 0x9202, 0x43dd, 0x91, 0xa7,
            0x64, 0xc2, 0x95, 0x4c, 0xfb, 0x8b);
DEFINE_GUID(WIA_CATEGORY_ENDORSER, 0x47102cc3, 0x127f, 0x4771, 0xad, 0xfc, 0x99,
            0x1a, 0xb8, 0xee, 0x1e, 0x97);
DEFINE_GUID(WIA_CATEGORY_BARCODE_READER, 0x36e178a0, 0x473f, 0x494b, 0xaf, 0x8f,
            0x6c, 0x3f, 0x6d, 0x74, 0x86, 0xfc);
DEFINE_GUID(WIA_CATEGORY_PATCH_CODE_READER, 0x8faa1a6d, 0x9c8a, 0x42cd, 0x98,
            0xb3, 0xee, 0x97, 0x00, 0xcb, 0xc7, 0x4f);
DEFINE_GUID(WIA_CATEGORY_MICR_READER, 0x3b86c1ec, 0x71bc, 0x4645, 0xb4, 0xd5,
            0x1b, 0x19, 0xda, 0x2b, 0xe9, 0x78);

//
// Default Segmentation Filter GUID
//

DEFINE_GUID(CLSID_WiaDefaultSegFilter, 0xD4F4D30B, 0x0B29, 0x4508, 0x89, 0x22,
            0x0C, 0x57, 0x97, 0xD4, 0x27, 0x65);
...
#define WIA_PRIVATE_DEVPROP                                                    \
  38914 // offset for private device (root) item properties
...
#if (_WIN32_WINNT >= 0x0600)
DEFINE_GUID(WiaImgFmt_RAW, 0x6f120719, 0xf1a8, 0x4e07, 0x9a, 0xde, 0x9b, 0x64,
            0xc6, 0x3a, 0x3d, 0xcc);
DEFINE_GUID(WiaImgFmt_JBIG, 0x41e8dd92, 0x2f0a, 0x43d4, 0x86, 0x36, 0xf1, 0x61,
            0x4b, 0xa1, 0x1e, 0x46);
DEFINE_GUID(WiaImgFmt_JBIG2, 0xbb8e7e67, 0x283c, 0x4235, 0x9e, 0x59, 0x0b, 0x9b,
            0xf9, 0x4c, 0xa6, 0x87);
#endif // #if (_WIN32_WINNT >= 0x0600)
...
DEFINE_GUID(WiaImgFmt_TXT, 0xfafd4d82, 0x723f, 0x421f, 0x93, 0x18, 0x30, 0x50,
            0x1a, 0xc4, 0x4b, 0x59);
#if (_WIN32_WINNT >= 0x0600)
DEFINE_GUID(WiaImgFmt_PDFA, 0x9980bd5b, 0x3463, 0x43c7, 0xbd, 0xca, 0x3c, 0xaa,
            0x14, 0x6f, 0x22, 0x9f);
DEFINE_GUID(WiaImgFmt_XPS, 0x700b4a0f, 0x2011, 0x411c, 0xb4, 0x30, 0xd1, 0xe0,
            0xb2, 0xe1, 0x0b, 0x28);
DEFINE_GUID(WiaImgFmt_OXPS, 0x2c7b1240, 0xc14d, 0x4109, 0x97, 0x55, 0x04, 0xb8,
            0x90, 0x25, 0x15, 0x3a);
DEFINE_GUID(WiaImgFmt_CSV, 0x355bda24, 0x5a9f, 0x4494, 0x80, 0xdc, 0xbe, 0x75,
            0x2c, 0xec, 0xbc, 0x8c);
#endif // #if (_WIN32_WINNT >= 0x0600)
...
DEFINE_GUID(WiaImgFmt_MPG, 0xecd757e4, 0xd2ec, 0x4f57, 0x95, 0x5d, 0xbc, 0xf8,
            0xa9, 0x7c, 0x4e, 0x52);
DEFINE_GUID(WiaImgFmt_AVI, 0x32f8ca14, 0x087c, 0x4908, 0xb7, 0xc4, 0x67, 0x57,
            0xfe, 0x7e, 0x90, 0xab);
...
DEFINE_GUID(WiaImgFmt_XMLBAR, 0x6235701c, 0x3a98, 0x484c, 0xb2, 0xa8, 0xfd,
            0xff, 0xd8, 0x7e, 0x6b, 0x16);
DEFINE_GUID(WiaImgFmt_RAWBAR, 0xda63f833, 0xd26e, 0x451e, 0x90, 0xd2, 0xea,
            0x55, 0xa1, 0x36, 0x5d, 0x62);
DEFINE_GUID(WiaImgFmt_XMLPAT, 0xf8986f55, 0xf052, 0x460d, 0x95, 0x23, 0x3a,
            0x7d, 0xfe, 0xdb, 0xb3, 0x3c);
DEFINE_GUID(WiaImgFmt_RAWPAT, 0x7760507c, 0x5064, 0x400c, 0x9a, 0x17, 0x57,
            0x56, 0x24, 0xd8, 0x82, 0x4b);
DEFINE_GUID(WiaImgFmt_XMLMIC, 0x2d164c61, 0xb9ae, 0x4b23, 0x89, 0x73, 0xc7,
            0x06, 0x7e, 0x1f, 0xbd, 0x31);
DEFINE_GUID(WiaImgFmt_RAWMIC, 0x22c4f058, 0x0d88, 0x409c, 0xac, 0x1c, 0xee,
            0xc1, 0x2b, 0x0e, 0xa6, 0x80);
...
DEFINE_GUID(WIA_EVENT_VOLUME_INSERT, 0x9638bbfd, 0xd1bd, 0x11d2, 0xb3, 0x1f,
            0x00, 0xc0, 0x4f, 0x68, 0xce, 0x61);
DEFINE_GUID(WIA_EVENT_SCAN_IMAGE, 0xa6c5a715, 0x8c6e, 0x11d2, 0x97, 0x7a, 0x00,
            0x00, 0xf8, 0x7a, 0x92, 0x6f);
DEFINE_GUID(WIA_EVENT_SCAN_PRINT_IMAGE, 0xb441f425, 0x8c6e, 0x11d2, 0x97, 0x7a,
            0x00, 0x00, 0xf8, 0x7a, 0x92, 0x6f);
...
DEFINE_GUID(WIA_EVENT_SCAN_IMAGE3, 0x154e27be, 0xb617, 0x4653, 0xac, 0xc5, 0x0f,
...
DEFINE_GUID(WIA_EVENT_DEVICE_NOT_READY, 0xd8962d7e, 0xe4dc, 0x4b4d, 0xba, 0x29,
            0x66, 0x8a, 0x87, 0xf4, 0x2e, 0x6f);
DEFINE_GUID(WIA_EVENT_DEVICE_READY, 0x7523ec6c, 0x988b, 0x419e, 0x9a, 0x0a,
            0x42, 0x5a, 0xc3, 0x1b, 0x37, 0xdc);
DEFINE_GUID(WIA_EVENT_FLATBED_LID_OPEN, 0xba0a0623, 0x437d, 0x4f03, 0xa9, 0x7d,
            0x77, 0x93, 0xb1, 0x23, 0x11, 0x3c);
DEFINE_GUID(WIA_EVENT_FLATBED_LID_CLOSED, 0xf879af0f, 0x9b29, 0x4283, 0xad,
            0x95, 0xd4, 0x12, 0x16, 0x4d, 0x39, 0xa9);
DEFINE_GUID(WIA_EVENT_FEEDER_LOADED, 0xcc8d701e, 0x9aba, 0x481d, 0xbf, 0x74,
            0x78, 0xf7, 0x63, 0xdc, 0x34, 0x2a);
DEFINE_GUID(WIA_EVENT_FEEDER_EMPTIED, 0xe70b4b82, 0x6dda, 0x46bb, 0x8f, 0xf9,
            0x53, 0xce, 0xb1, 0xa0, 0x3e, 0x35);
DEFINE_GUID(WIA_EVENT_COVER_OPEN, 0x19a12136, 0xfa1c, 0x4f66, 0x90, 0x0f, 0x8f,
            0x91, 0x4e, 0xc7, 0x4e, 0xc9);
DEFINE_GUID(WIA_EVENT_COVER_CLOSED, 0x6714a1e6, 0xe285, 0x468c, 0x9b, 0x8c,
            0xda, 0x7d, 0xc4, 0xcb, 0xaa, 0x05);
...
DEFINE_GUID(WIA_CMD_FORMAT, 0xc3a693aa, 0xf788, 0x4d34, 0xa5, 0xb0, 0xbe, 0x71,
            0x90, 0x75, 0x9a, 0x24);
...
#if (_WIN32_WINNT >= 0x0600)
DEFINE_GUID(WIA_CMD_START_FEEDER, 0x5a9df6c9, 0x5f2d, 0x4a39, 0x9d, 0x6c, 0x00,
            0x45, 0x6d, 0x04, 0x7f, 0x00);
DEFINE_GUID(WIA_CMD_STOP_FEEDER, 0xd847b06d, 0x3905, 0x459c, 0x95, 0x09, 0x9b,
            0x29, 0xcd, 0xb6, 0x91, 0xe7);
DEFINE_GUID(WIA_CMD_PAUSE_FEEDER, 0x50985e4d, 0xa5b2, 0x4b71, 0x9c, 0x95, 0x6d,
            0x7d, 0x7c, 0x46, 0x9a, 0x43);
#endif // #if (_WIN32_WINNT >= 0x0600)
...
#define WIA_ERROR_NETWORK_RESERVATION_FAILED                                   \
  MAKE_HRESULT(SEVERITY_ERROR, FACILITY_WIA, 19)
#if (_WIN32_WINNT >= 0x0600)
#define WIA_ERROR_MULTI_FEED MAKE_HRESULT(SEVERITY_ERROR, FACILITY_WIA, 20)
#define WIA_ERROR_MAXIMUM_PRINTER_ENDORSER_COUNTER                             \
  MAKE_HRESULT(SEVERITY_ERROR, FACILITY_WIA, 21)
#endif // #if (_WIN32_WINNT >= 0x0600)
#define WIA_STATUS_END_OF_MEDIA MAKE_HRESULT(SEVERITY_SUCCESS, FACILITY_WIA, 1)

//
// Definitions for errors and status codes passed to
// IWiaDataTransfer::BandedDataCallback as the lReason parameter. These codes
// are in addition to the errors defined above; in some cases the
// SEVERITY_SUCCESS version of an error is meant to replace the SEVERITY_ERROR
...
#define WIA_STATUS_RESERVING_NETWORK_DEVICE                                    \
  MAKE_HRESULT(SEVERITY_SUCCESS, FACILITY_WIA, 6)
#define WIA_STATUS_NETWORK_DEVICE_RESERVED                                     \
  MAKE_HRESULT(SEVERITY_SUCCESS, FACILITY_WIA, 7)
...
//
// The value is returned by Scansetting.dll when the user chooses to change the
// scanner in scandialog
//

#define WIA_S_CHANGE_DEVICE MAKE_HRESULT(SEVERITY_SUCCESS, FACILITY_WIA, 11)

//
// SelectDeviceDlg and SelectDeviceDlgID status code when there are no devices
// available
//
...
#define WIA_DEVICE_DIALOG_SINGLE_IMAGE                                         \
  0x00000002 // Only allow one image to be selected
#define WIA_DEVICE_DIALOG_USE_COMMON_UI                                        \
  0x00000004 // Give preference to the system-provided UI, if available
...
#define IT_STATUS_MASK                                                         \
  0x0007 // any status value that doesn't
...
//
// WIA_DPS_ENDORSER_STRING is superseded in WIA 2.0 by
// WIA_IPS_PRINTER_ENDORSER_STRING and these constant values are replaced by the
// WIA_IPS_PRINTER_ENDORSER_VALID_FORMAT_SPECIFIERS constants
//
...
const PROPID g_piDeviceInfo[WIA_NUM_DIP] = {
    WIA_DIP_DEV_ID,      WIA_DIP_VEND_DESC,
    WIA_DIP_DEV_DESC,    WIA_DIP_DEV_TYPE,
    WIA_DIP_PORT_NAME,   WIA_DIP_DEV_NAME,
    WIA_DIP_SERVER_NAME, WIA_DIP_REMOTE_DEV_ID,
    WIA_DIP_UI_CLSID,    WIA_DIP_HW_CONFIG,
    WIA_DIP_BAUDRATE,    WIA_DIP_STI_GEN_CAPABILITIES,
    WIA_DIP_WIA_VERSION, WIA_DIP_DRIVER_VERSION,
    WIA_DIP_PNP_ID,      WIA_DIP_STI_DRIVER_VERSION,
};
...
const PCWSTR g_pszDeviceInfo[WIA_NUM_DIP] = {
    ...
    WIA_DIP_PNP_ID_STR,      WIA_DIP_STI_DRIVER_VERSION_STR,
};
