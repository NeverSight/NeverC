...
EXTERN_GUID(IID_IWMPlayerTimestampHook, 0x28580dda, 0xd98e, 0x48d0, 0xb7, 0xae,
            0x69, 0xe4, 0x73, 0xa0, 0x28, 0x25);
EXTERN_GUID(IID_IWMCodecVideoAccelerator, 0x990641b0, 0x739f, 0x4e94, 0xa8,
            0x08, 0x98, 0x88, 0xda, 0x8f, 0x75, 0xaf);
EXTERN_GUID(IID_IWMCodecAMVideoAccelerator, 0xd98ee251, 0x34e0, 0x4a2d, 0x93,
            0x12, 0x9b, 0x4c, 0x78, 0x8d, 0x9f, 0xa1);
...
typedef struct IWMPlayerTimestampHookVtbl {
  ...
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(IWMPlayerTimestampHook *This,
                                             /* [in] */ REFIID riid,
  ...
  HRESULT(STDMETHODCALLTYPE *MapTimestamp)(IWMPlayerTimestampHook *This,
                                           /* [in] */ REFERENCE_TIME rtIn,
...
typedef struct IWMCodecAMVideoAcceleratorVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(IWMCodecAMVideoAccelerator *This,
                                             /* [in] */ REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);
...
typedef struct IWMCodecVideoAcceleratorVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(IWMCodecVideoAccelerator *This,
                                             /* [in] */ REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);
