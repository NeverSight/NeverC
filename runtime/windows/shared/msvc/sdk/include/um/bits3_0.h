...
typedef struct IBitsPeerCacheRecordVtbl {
  ...
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IBitsPeerCacheRecord *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IBitsPeerCacheRecord *This);

  DECLSPEC_XFGVIRT(IBitsPeerCacheRecord, GetId)
  HRESULT(STDMETHODCALLTYPE *GetId)(__RPC__in IBitsPeerCacheRecord *This,
...
public:
  virtual HRESULT STDMETHODCALLTYPE Next(
      ...
      __RPC__out_ecount_part(celt, pceltFetched ? *pceltFetched : celt)
...
typedef struct IEnumBitsPeerCacheRecordsVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IEnumBitsPeerCacheRecords *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IEnumBitsPeerCacheRecords *This);
  ...
  HRESULT(STDMETHODCALLTYPE *Skip)(__RPC__in IEnumBitsPeerCacheRecords *This,
                                   /* [in] */ ULONG celt);

  DECLSPEC_XFGVIRT(IEnumBitsPeerCacheRecords, Reset)
  HRESULT(STDMETHODCALLTYPE *Reset)(__RPC__in IEnumBitsPeerCacheRecords *This);
...
typedef struct IBitsPeerVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in IBitsPeer *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IBitsPeer *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IBitsPeer *This);
...
interface IBitsPeer { CONST_VTBL struct IBitsPeerVtbl *lpVtbl; };
...
typedef struct IEnumBitsPeersVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in IEnumBitsPeers *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IEnumBitsPeers *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IEnumBitsPeers *This);
  ...
  HRESULT(STDMETHODCALLTYPE *Skip)(__RPC__in IEnumBitsPeers *This,
                                   /* [in] */ ULONG celt);

  DECLSPEC_XFGVIRT(IEnumBitsPeers, Reset)
  HRESULT(STDMETHODCALLTYPE *Reset)(__RPC__in IEnumBitsPeers *This);
  ...
  HRESULT(STDMETHODCALLTYPE *GetCount)(__RPC__in IEnumBitsPeers *This,
                                       /* [out] */ __RPC__out ULONG *puCount);

  END_INTERFACE
} IEnumBitsPeersVtbl;

interface IEnumBitsPeers { CONST_VTBL struct IEnumBitsPeersVtbl *lpVtbl; };
...
typedef struct IBitsPeerCacheAdministrationVtbl {
  ...
  HRESULT(STDMETHODCALLTYPE *SetMaximumCacheSize)(
      __RPC__in IBitsPeerCacheAdministration *This, DWORD Bytes);
  ...
  HRESULT(STDMETHODCALLTYPE *SetMaximumContentAge)(
      __RPC__in IBitsPeerCacheAdministration *This, ULONG Seconds);
  ...
  HRESULT(STDMETHODCALLTYPE *SetConfigurationFlags)(
      __RPC__in IBitsPeerCacheAdministration *This, DWORD Flags);
...
typedef struct IBackgroundCopyJob4Vtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IBackgroundCopyJob4 *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IBackgroundCopyJob4 *This);

  DECLSPEC_XFGVIRT(IBackgroundCopyJob, AddFileSet)
  HRESULT(STDMETHODCALLTYPE *AddFileSet)(__RPC__in IBackgroundCopyJob4 *This,
                                         /* [in] */ ULONG cFileCount,
                                         /* [size_is][in] */
                                         __RPC__in_ecount_full(cFileCount)
                                             BG_FILE_INFO *pFileSet);

  DECLSPEC_XFGVIRT(IBackgroundCopyJob, AddFile)
  HRESULT(STDMETHODCALLTYPE *AddFile)(__RPC__in IBackgroundCopyJob4 *This,
  ...
  HRESULT(STDMETHODCALLTYPE *Suspend)(__RPC__in IBackgroundCopyJob4 *This);

  DECLSPEC_XFGVIRT(IBackgroundCopyJob, Resume)
  HRESULT(STDMETHODCALLTYPE *Resume)(__RPC__in IBackgroundCopyJob4 *This);

  DECLSPEC_XFGVIRT(IBackgroundCopyJob, Cancel)
  HRESULT(STDMETHODCALLTYPE *Cancel)(__RPC__in IBackgroundCopyJob4 *This);

  DECLSPEC_XFGVIRT(IBackgroundCopyJob, Complete)
  HRESULT(STDMETHODCALLTYPE *Complete)(__RPC__in IBackgroundCopyJob4 *This);

  DECLSPEC_XFGVIRT(IBackgroundCopyJob, GetId)
  HRESULT(STDMETHODCALLTYPE *GetId)(__RPC__in IBackgroundCopyJob4 *This,
                                    /* [out] */ __RPC__out GUID *pVal);

  DECLSPEC_XFGVIRT(IBackgroundCopyJob, GetType)
  HRESULT(STDMETHODCALLTYPE *GetType)(__RPC__in IBackgroundCopyJob4 *This,
  ...
  HRESULT(STDMETHODCALLTYPE *SetPriority)(__RPC__in IBackgroundCopyJob4 *This,
  ...
  HRESULT(STDMETHODCALLTYPE *RemoveCredentials)(
      __RPC__in IBackgroundCopyJob4 *This, BG_AUTH_TARGET Target,
  ...
  HRESULT(STDMETHODCALLTYPE *SetPeerCachingFlags)(
      __RPC__in IBackgroundCopyJob4 *This, DWORD Flags);
  ...
  HRESULT(STDMETHODCALLTYPE *SetMaximumDownloadTime)(
      __RPC__in IBackgroundCopyJob4 *This, ULONG Timeout);
...
#define IBackgroundCopyJob4_SetProxySettings(This, ProxyUsage, ProxyList,      \
                                             ProxyBypassList)                  \
  ((This)->lpVtbl->SetProxySettings(This, ProxyUsage, ProxyList,               \
                                    ProxyBypassList))
...
typedef struct IBackgroundCopyFile3Vtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IBackgroundCopyFile3 *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IBackgroundCopyFile3 *This);
  ...
  HRESULT(STDMETHODCALLTYPE *SetRemoteName)(
      __RPC__in IBackgroundCopyFile3 *This, __RPC__in LPCWSTR Val);
...
typedef struct IBackgroundCopyCallback2Vtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IBackgroundCopyCallback2 *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IBackgroundCopyCallback2 *This);
