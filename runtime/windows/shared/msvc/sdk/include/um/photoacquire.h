...
typedef interface IPhotoAcquireDeviceSelectionDialog
...
#ifdef __cplusplus
typedef class PhotoAcquireAutoPlayHWEventHandler
    PhotoAcquireAutoPlayHWEventHandler;
#else
typedef struct PhotoAcquireAutoPlayHWEventHandler
    PhotoAcquireAutoPlayHWEventHandler;
#endif /* __cplusplus */
...
#ifdef __cplusplus
typedef class PhotoAcquireDeviceSelectionDialog
    PhotoAcquireDeviceSelectionDialog;
#else
typedef struct PhotoAcquireDeviceSelectionDialog
    PhotoAcquireDeviceSelectionDialog;
#endif /* __cplusplus */
...
public:
  ...
  virtual HRESULT STDMETHODCALLTYPE GetSubItemAt(
      /* [in] */ UINT nItemIndex,
      /* [out] */ __RPC__deref_out_opt IPhotoAcquireItem *
          *ppPhotoAcquireItem) = 0;
};
...
typedef struct IPhotoAcquireItemVtbl {
  ...
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in IPhotoAcquireItem *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IPhotoAcquireItem *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IPhotoAcquireItem *This);
  ...
  HRESULT(STDMETHODCALLTYPE *Delete)(__RPC__in IPhotoAcquireItem *This);
...
typedef struct IUserInputStringVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in IUserInputString *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IUserInputString *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IUserInputString *This);
...
interface IUserInputString { CONST_VTBL struct IUserInputStringVtbl *lpVtbl; };
...
typedef struct IPhotoAcquireProgressCBVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IPhotoAcquireProgressCB *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IPhotoAcquireProgressCB *This);
  ...
  HRESULT(STDMETHODCALLTYPE *EndDelete)(__RPC__in IPhotoAcquireProgressCB *This,
                                        /* [in] */ HRESULT hr);
...
#define IPhotoAcquireProgressCB_StartItemTransfer(This, nItemIndex,            \
                                                  pPhotoAcquireItem)           \
...
#define IPhotoAcquireProgressCB_UpdateTransferPercent(This, fOverall,          \
                                                      nPercent)                \
  ((This)->lpVtbl->UpdateTransferPercent(This, fOverall, nPercent))

#define IPhotoAcquireProgressCB_EndItemTransfer(This, nItemIndex,              \
                                                pPhotoAcquireItem, hr)         \
...
#define IPhotoAcquireProgressCB_StartItemDelete(This, nItemIndex,              \
                                                pPhotoAcquireItem)             \
...
#define IPhotoAcquireProgressCB_EndItemDelete(This, nItemIndex,                \
                                              pPhotoAcquireItem, hr)           \
...
#define IPhotoAcquireProgressCB_GetDeleteAfterAcquire(This,                    \
                                                      pfDeleteAfterAcquire)    \
  ((This)->lpVtbl->GetDeleteAfterAcquire(This, pfDeleteAfterAcquire))

#define IPhotoAcquireProgressCB_ErrorAdvise(This, hr, pszErrorMessage,         \
                                            nMessageType, pnErrorAdviseResult) \
  ((This)->lpVtbl->ErrorAdvise(This, hr, pszErrorMessage, nMessageType,        \
                               pnErrorAdviseResult))

#define IPhotoAcquireProgressCB_GetUserInput(This, riidType, pUnknown,         \
                                             pPropVarResult, pPropVarDefault)  \
  ((This)->lpVtbl->GetUserInput(This, riidType, pUnknown, pPropVarResult,      \
                                pPropVarDefault))
...
public:
  virtual HRESULT STDMETHODCALLTYPE DoAction(__RPC__in HWND hWndParent) = 0;
};
...
typedef struct IPhotoProgressActionCBVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IPhotoProgressActionCB *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IPhotoProgressActionCB *This);

  DECLSPEC_XFGVIRT(IPhotoProgressActionCB, DoAction)
  HRESULT(STDMETHODCALLTYPE *DoAction)(__RPC__in IPhotoProgressActionCB *This,
...
typedef struct IPhotoProgressDialogVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IPhotoProgressDialog *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IPhotoProgressDialog *This);

  DECLSPEC_XFGVIRT(IPhotoProgressDialog, Create)
  HRESULT(STDMETHODCALLTYPE *Create)(__RPC__in IPhotoProgressDialog *This,
  ...
  HRESULT(STDMETHODCALLTYPE *Destroy)(__RPC__in IPhotoProgressDialog *This);
...
#define IPhotoProgressDialog_SetCheckboxText(This, nCheckboxId,                \
                                             pszCheckboxText)                  \
...
#define IPhotoProgressDialog_SetCheckboxTooltip(This, nCheckboxId,             \
                                                pszCheckboxTooltipText)        \
  ((This)->lpVtbl->SetCheckboxTooltip(This, nCheckboxId,                       \
                                      pszCheckboxTooltipText))
...
#define IPhotoProgressDialog_SetActionLinkCallback(This,                       \
...
#define IPhotoProgressDialog_GetUserInput(This, riidType, pUnknown,            \
                                          pPropVarResult, pPropVarDefault)     \
  ((This)->lpVtbl->GetUserInput(This, riidType, pUnknown, pPropVarResult,      \
                                pPropVarDefault))
...
public:
  ...
  virtual HRESULT STDMETHODCALLTYPE GetDeviceIcons(
      ...
      /* [unique][out][in] */ __RPC__deref_opt_inout_opt HICON *
          phSmallIcon) = 0;

  virtual HRESULT STDMETHODCALLTYPE InitializeItemList(
      /* [in] */ BOOL fForceEnumeration,
      /* [unique][in] */ __RPC__in_opt IPhotoAcquireProgressCB *
  ...
  virtual HRESULT STDMETHODCALLTYPE GetPhotoAcquireSettings(
      /* [out] */ __RPC__deref_out_opt IPhotoAcquireSettings *
      *ppPhotoAcquireSettings) = 0;
...
typedef struct IPhotoAcquireSourceVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IPhotoAcquireSource *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IPhotoAcquireSource *This);
...
#define IPhotoAcquireSource_GetDeviceIcons(This, nSize, phLargeIcon,           \
                                           phSmallIcon)                        \
  ((This)->lpVtbl->GetDeviceIcons(This, nSize, phLargeIcon, phSmallIcon))

#define IPhotoAcquireSource_InitializeItemList(                                \
    This, fForceEnumeration, pPhotoAcquireProgressCB, pnItemCount)             \
  ((This)->lpVtbl->InitializeItemList(This, fForceEnumeration,                 \
                                      pPhotoAcquireProgressCB, pnItemCount))
...
#define IPhotoAcquireSource_GetPhotoAcquireSettings(This,                      \
                                                    ppPhotoAcquireSettings)    \
...
public:
  virtual HRESULT STDMETHODCALLTYPE CreatePhotoSource(
      ...
      /* [out] */ __RPC__deref_out_opt IPhotoAcquireSource *
          *ppPhotoAcquireSource) = 0;
...
typedef struct IPhotoAcquireVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in IPhotoAcquire *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IPhotoAcquire *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IPhotoAcquire *This);
...
interface IPhotoAcquire { CONST_VTBL struct IPhotoAcquireVtbl *lpVtbl; };
...
#define IPhotoAcquire_Acquire(This, pPhotoAcquireSource, fShowProgress,        \
                              hWndParent, pszApplicationName,                  \
                              pPhotoAcquireProgressCB)                         \
  ((This)->lpVtbl->Acquire(This, pPhotoAcquireSource, fShowProgress,           \
                           hWndParent, pszApplicationName,                     \
                           pPhotoAcquireProgressCB))
...
// IPhotoAcquire::Acquire will return this value if a user operation requires a
// restart. If you receive this, you should discard all interfaces and restart
// completely. You can only receive this if you specify the
// PHOTOACQ_ABORT_ON_SETTINGS_UPDATE flag.
#define PHOTOACQ_ERROR_RESTART_REQUIRED                                        \
...
// PHOTOACQ_NO_GALLERY_LAUNCH suppresses the explorer window launched after
// acquisition. In versions of Windows that don't include Windows Photo Gallery,
// PHOTOACQ_DISABLE_DB_INTEGRATION and PHOTOACQ_DISABLE_DUPLICATE_DETECTION are
// implied.
...
typedef struct IPhotoAcquireSettingsVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IPhotoAcquireSettings *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IPhotoAcquireSettings *This);
  ...
  HRESULT(STDMETHODCALLTYPE *SetFlags)(__RPC__in IPhotoAcquireSettings *This,
...
typedef struct IPhotoAcquireOptionsDialogVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IPhotoAcquireOptionsDialog *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IPhotoAcquireOptionsDialog *This);
...
#define IPhotoAcquireDeviceSelectionDialog_QueryInterface(This, riid,          \
                                                          ppvObject)           \
  ((This)->lpVtbl->QueryInterface(This, riid, ppvObject))
...
#define IPhotoAcquireDeviceSelectionDialog_SetSubmitButtonText(                \
    This, pszSubmitButtonText)                                                 \
  ((This)->lpVtbl->SetSubmitButtonText(This, pszSubmitButtonText))

#define IPhotoAcquireDeviceSelectionDialog_DoModal(                            \
    This, hWndParent, dwDeviceFlags, pbstrDeviceId, pnDeviceType)              \
  ((This)->lpVtbl->DoModal(This, hWndParent, dwDeviceFlags, pbstrDeviceId,     \
                           pnDeviceType))
...
public:
  virtual HRESULT STDMETHODCALLTYPE Initialize(
      /* [in] */ __RPC__in_opt IPhotoAcquireSource * pPhotoAcquireSource,
      /* [in] */ __RPC__in_opt IPhotoAcquireProgressCB *
          pPhotoAcquireProgressCB) = 0;
...
typedef struct IPhotoAcquirePluginVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IPhotoAcquirePlugin *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IPhotoAcquirePlugin *This);
  ...
  HRESULT(STDMETHODCALLTYPE *DisplayConfigureDialog)(
      __RPC__in IPhotoAcquirePlugin *This, __RPC__in HWND hWndParent);
...
#define IPhotoAcquirePlugin_Initialize(This, pPhotoAcquireSource,              \
                                       pPhotoAcquireProgressCB)                \
  ((This)->lpVtbl->Initialize(This, pPhotoAcquireSource,                       \
                              pPhotoAcquireProgressCB))

#define IPhotoAcquirePlugin_ProcessItem(                                       \
    This, dwAcquireStage, pPhotoAcquireItem, pOriginalItemStream,              \
    pszFinalFilename, pPropertyStore)                                          \
  ((This)->lpVtbl->ProcessItem(This, dwAcquireStage, pPhotoAcquireItem,        \
                               pOriginalItemStream, pszFinalFilename,          \
                               pPropertyStore))
...
class DECLSPEC_UUID("00f26e02-e9f2-4a9f-9fdd-5a962fb26a98") PhotoAcquire;
#endif
...
class DECLSPEC_UUID("00f24ca0-748f-4e8a-894f-0e0357c6799f") PhotoProgressDialog;
#endif
