...
typedef enum D3D11_TRACE_REGISTER_TYPE {
  ...
  D3D11_TRACE_IMMEDIATE_CONSTANT_BUFFER =
      (D3D11_TRACE_INPUT_PRIMITIVE_ID_REGISTER + 1),
  ...
  D3D11_TRACE_INPUT_COVERAGE_MASK_REGISTER =
      (D3D11_TRACE_INPUT_THREAD_ID_IN_GROUP_REGISTER + 1),
...
typedef struct ID3D11ShaderTraceVtbl {
  ...
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(ID3D11ShaderTrace *This,
                                             /* [in] */ REFIID riid,
  ...
  ULONG(STDMETHODCALLTYPE *Release)(ID3D11ShaderTrace *This);

  DECLSPEC_XFGVIRT(ID3D11ShaderTrace, TraceReady)
  HRESULT(STDMETHODCALLTYPE *TraceReady)(ID3D11ShaderTrace *This,
                                         /* [annotation] */
  ...
  HRESULT(STDMETHODCALLTYPE *PSSelectStamp)(ID3D11ShaderTrace *This,
                                            /* [annotation] */
  ...
  HRESULT(STDMETHODCALLTYPE *GetStep)(ID3D11ShaderTrace *This,
                                      /* [annotation] */
                                      _In_ UINT stepIndex,
                                      /* [annotation] */
...
#define ID3D11ShaderTrace_AddRef(This) ((This)->lpVtbl->AddRef(This))

#define ID3D11ShaderTrace_Release(This) ((This)->lpVtbl->Release(This))

#define ID3D11ShaderTrace_TraceReady(This, pTestCount)                         \
  ((This)->lpVtbl->TraceReady(This, pTestCount))

#define ID3D11ShaderTrace_ResetTrace(This) ((This)->lpVtbl->ResetTrace(This))
...
#define ID3D11ShaderTrace_GetWrittenRegister(                                  \
    This, stepIndex, writtenRegisterIndex, pRegister, pValue)                  \
  ((This)->lpVtbl->GetWrittenRegister(This, stepIndex, writtenRegisterIndex,   \
                                      pRegister, pValue))

#define ID3D11ShaderTrace_GetReadRegister(This, stepIndex, readRegisterIndex,  \
                                          pRegister, pValue)                   \
  ((This)->lpVtbl->GetReadRegister(This, stepIndex, readRegisterIndex,         \
                                   pRegister, pValue))
...
typedef struct ID3D11ShaderTraceFactoryVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(ID3D11ShaderTraceFactory *This,
                                             /* [in] */ REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);
  ...
  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(ID3D11ShaderTraceFactory *This);
...
#define ID3D11ShaderTraceFactory_AddRef(This) ((This)->lpVtbl->AddRef(This))

#define ID3D11ShaderTraceFactory_Release(This) ((This)->lpVtbl->Release(This))

#define ID3D11ShaderTraceFactory_CreateShaderTrace(This, pShader, pTraceDesc,  \
                                                   ppShaderTrace)              \
...
HRESULT WINAPI D3DDisassemble11Trace(
    ...
    _In_ ID3D11ShaderTrace *pTrace, _In_ UINT StartStep, _In_ UINT NumSteps,
