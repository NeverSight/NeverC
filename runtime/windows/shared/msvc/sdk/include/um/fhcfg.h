...
typedef struct IFhTargetVtbl {
  ...
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in IFhTarget *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IFhTarget *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IFhTarget *This);
...
interface IFhTarget { CONST_VTBL struct IFhTargetVtbl *lpVtbl; };
...
#define IFhTarget_AddRef(This) ((This)->lpVtbl->AddRef(This))

#define IFhTarget_Release(This) ((This)->lpVtbl->Release(This))
...
typedef struct IFhScopeIteratorVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in IFhScopeIterator *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IFhScopeIterator *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IFhScopeIterator *This);

  DECLSPEC_XFGVIRT(IFhScopeIterator, MoveToNextItem)
  HRESULT(STDMETHODCALLTYPE *MoveToNextItem)(__RPC__in IFhScopeIterator *This);
...
interface IFhScopeIterator { CONST_VTBL struct IFhScopeIteratorVtbl *lpVtbl; };
...
#define IFhScopeIterator_AddRef(This) ((This)->lpVtbl->AddRef(This))

#define IFhScopeIterator_Release(This) ((This)->lpVtbl->Release(This))
...
typedef struct IFhConfigMgrVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in IFhConfigMgr *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IFhConfigMgr *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IFhConfigMgr *This);

  DECLSPEC_XFGVIRT(IFhConfigMgr, LoadConfiguration)
  HRESULT(STDMETHODCALLTYPE *LoadConfiguration)(__RPC__in IFhConfigMgr *This);
  ...
  HRESULT(STDMETHODCALLTYPE *SaveConfiguration)(__RPC__in IFhConfigMgr *This);
...
interface IFhConfigMgr { CONST_VTBL struct IFhConfigMgrVtbl *lpVtbl; };
...
#define IFhConfigMgr_AddRef(This) ((This)->lpVtbl->AddRef(This))

#define IFhConfigMgr_Release(This) ((This)->lpVtbl->Release(This))
...
#define IFhConfigMgr_QueryProtectionStatus(This, ProtectionState,              \
                                           ProtectedUntilTime)                 \
  ((This)->lpVtbl->QueryProtectionStatus(This, ProtectionState,                \
                                         ProtectedUntilTime))
...
typedef struct IFhReassociationVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in IFhReassociation *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IFhReassociation *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IFhReassociation *This);
...
interface IFhReassociation { CONST_VTBL struct IFhReassociationVtbl *lpVtbl; };
...
#define IFhReassociation_AddRef(This) ((This)->lpVtbl->AddRef(This))

#define IFhReassociation_Release(This) ((This)->lpVtbl->Release(This))
...
#define IFhReassociation_GetConfigurationDetails(This, Index, UserName,        \
                                                 PcName, BackupTime)           \
  ((This)->lpVtbl->GetConfigurationDetails(This, Index, UserName, PcName,      \
                                           BackupTime))
...
class DECLSPEC_UUID("ED43BB3C-09E9-498a-9DF6-2177244C6DB4") FhConfigMgr;
#endif
...
class DECLSPEC_UUID("4D728E35-16FA-4320-9E8B-BFD7100A8846") FhReassociation;
#endif
