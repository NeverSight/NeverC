...
public:
  ...
  virtual HRESULT STDMETHODCALLTYPE GetContactCollection(
      /* [out] */ __RPC__deref_out_opt IContactCollection *
      *ppContactCollection) = 0;
};
...
typedef struct IContactManagerVtbl {
  ...
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in IContactManager *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IContactManager *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IContactManager *This);
...
interface IContactManager { CONST_VTBL struct IContactManagerVtbl *lpVtbl; };
...
#define IContactManager_MergeContactIDs(This, pszNewContactID,                 \
                                        pszOldContactID)                       \
...
typedef struct IContactCollectionVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in IContactCollection *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IContactCollection *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IContactCollection *This);

  DECLSPEC_XFGVIRT(IContactCollection, Reset)
  HRESULT(STDMETHODCALLTYPE *Reset)(__RPC__in IContactCollection *This);

  DECLSPEC_XFGVIRT(IContactCollection, Next)
  HRESULT(STDMETHODCALLTYPE *Next)(__RPC__in IContactCollection *This);
...
public:
  ...
  virtual HRESULT STDMETHODCALLTYPE SetLabels(
      ...
      /* [unique][size_is][in] */
      __RPC__in_ecount_full_opt(dwLabelCount) LPCWSTR ppszLabels[]) = 0;

  virtual HRESULT STDMETHODCALLTYPE CreateArrayNode(
      /* [unique][string][in] */ __RPC__in_opt_string LPCWSTR pszArrayName,
      DWORD dwFlags, BOOL fAppend,
      /* [size_is][string][unique][out][in] */
      __RPC__inout_ecount_full_opt_string(cchNewArrayElementName)
          LPWSTR pszNewArrayElementName,
      DWORD cchNewArrayElementName,
      /* [unique][out][in] */ __RPC__inout_opt DWORD *
          pdwcchNewArrayElementNameRequired) = 0;
  ...
  virtual HRESULT STDMETHODCALLTYPE GetPropertyCollection(
      /* [out] */ __RPC__deref_out_opt IContactPropertyCollection *
...
typedef struct IContactPropertiesVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in IContactProperties *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IContactProperties *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IContactProperties *This);
  ...
  HRESULT(STDMETHODCALLTYPE *GetLabels)(
      __RPC__in IContactProperties *This,
      /* [unique][string][in] */
      __RPC__in_opt_string LPCWSTR pszArrayElementName, DWORD dwFlags,
      /* [size_is][unique][out][in] */
      __RPC__inout_ecount_full_opt(cchLabels) LPWSTR pszLabels,
      /* [in] */ DWORD cchLabels,
...
#define IContactProperties_GetString(This, pszPropertyName, dwFlags, pszValue, \
                                     cchValue, pdwcchPropertyValueRequired)    \
  ((This)->lpVtbl->GetString(This, pszPropertyName, dwFlags, pszValue,         \
                             cchValue, pdwcchPropertyValueRequired))

#define IContactProperties_GetDate(This, pszPropertyName, dwFlags,             \
                                   pftDateTime)                                \
  ((This)->lpVtbl->GetDate(This, pszPropertyName, dwFlags, pftDateTime))

#define IContactProperties_GetBinary(This, pszPropertyName, dwFlags,           \
                                     pszContentType, cchContentType,           \
                                     pdwcchContentTypeRequired, ppStream)      \
  ((This)->lpVtbl->GetBinary(This, pszPropertyName, dwFlags, pszContentType,   \
                             cchContentType, pdwcchContentTypeRequired,        \
                             ppStream))

#define IContactProperties_GetLabels(This, pszArrayElementName, dwFlags,       \
                                     pszLabels, cchLabels,                     \
                                     pdwcchLabelsRequired)                     \
  ((This)->lpVtbl->GetLabels(This, pszArrayElementName, dwFlags, pszLabels,    \
                             cchLabels, pdwcchLabelsRequired))
...
#define IContactProperties_SetBinary(This, pszPropertyName, dwFlags,           \
                                     pszContentType, pStream)                  \
  ((This)->lpVtbl->SetBinary(This, pszPropertyName, dwFlags, pszContentType,   \
                             pStream))

#define IContactProperties_SetLabels(This, pszArrayElementName, dwFlags,       \
                                     dwLabelCount, ppszLabels)                 \
  ((This)->lpVtbl->SetLabels(This, pszArrayElementName, dwFlags, dwLabelCount, \
                             ppszLabels))

#define IContactProperties_CreateArrayNode(                                    \
    This, pszArrayName, dwFlags, fAppend, pszNewArrayElementName,              \
    cchNewArrayElementName, pdwcchNewArrayElementNameRequired)                 \
  ((This)->lpVtbl->CreateArrayNode(                                            \
      This, pszArrayName, dwFlags, fAppend, pszNewArrayElementName,            \
      cchNewArrayElementName, pdwcchNewArrayElementNameRequired))
...
#define IContactProperties_GetPropertyCollection(                              \
    This, ppPropertyCollection, dwFlags, pszMultiValueName, dwLabelCount,      \
    ppszLabels, fAnyLabelMatches)                                              \
  ((This)->lpVtbl->GetPropertyCollection(This, ppPropertyCollection, dwFlags,  \
                                         pszMultiValueName, dwLabelCount,      \
                                         ppszLabels, fAnyLabelMatches))
...
public:
  virtual HRESULT STDMETHODCALLTYPE GetContactID(
      /* [size_is][string][out][in] */ __RPC__inout_ecount_full_string(
          cchContactID) LPWSTR pszContactID,
      /* [in] */ DWORD cchContactID,
      /* [unique][out][in] */ __RPC__inout_opt DWORD *
          pdwcchContactIDRequired) = 0;

  virtual HRESULT STDMETHODCALLTYPE GetPath(
      /* [size_is][string][out][in] */ __RPC__inout_ecount_full_string(cchPath)
          LPWSTR pszPath,
      /* [in] */ DWORD cchPath,
...
typedef struct IContactVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in IContact *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IContact *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IContact *This);

  DECLSPEC_XFGVIRT(IContact, GetContactID)
  HRESULT(STDMETHODCALLTYPE *GetContactID)(
      __RPC__in IContact *This,
      /* [size_is][string][out][in] */
  ...
  HRESULT(STDMETHODCALLTYPE *CommitChanges)(__RPC__in IContact *This,
                                            /* [in] */ DWORD dwCommitFlags);

  END_INTERFACE
} IContactVtbl;

interface IContact { CONST_VTBL struct IContactVtbl *lpVtbl; };
...
#define IContact_GetContactID(This, pszContactID, cchContactID,                \
                              pdwcchContactIDRequired)                         \
  ((This)->lpVtbl->GetContactID(This, pszContactID, cchContactID,              \
                                pdwcchContactIDRequired))
...
public:
  ...
  virtual HRESULT STDMETHODCALLTYPE GetPropertyName(
      /* [unique][size_is][string][unique][out][in] */
      __RPC__inout_ecount_full_opt_string(cchPropertyName)
          LPWSTR pszPropertyName,
      /* [in] */ DWORD cchPropertyName,
      /* [unique][out][in] */ __RPC__inout_opt DWORD *
          pdwcchPropertyNameRequired) = 0;
  ...
  virtual HRESULT STDMETHODCALLTYPE GetPropertyModificationDate(
      /* [unique][out][in] */ __RPC__inout_opt FILETIME *
      pftModificationDate) = 0;

  virtual HRESULT STDMETHODCALLTYPE GetPropertyArrayElementID(
      /* [unique][size_is][string][unique][out][in] */
      __RPC__inout_ecount_full_opt_string(cchArrayElementID)
          LPWSTR pszArrayElementID,
      /* [in] */ DWORD cchArrayElementID,
      /* [unique][out][in] */ __RPC__inout_opt DWORD *
          pdwcchArrayElementIDRequired) = 0;
};
...
typedef struct IContactPropertyCollectionVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IContactPropertyCollection *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IContactPropertyCollection *This);

  DECLSPEC_XFGVIRT(IContactPropertyCollection, Reset)
  HRESULT(STDMETHODCALLTYPE *Reset)(__RPC__in IContactPropertyCollection *This);

  DECLSPEC_XFGVIRT(IContactPropertyCollection, Next)
  HRESULT(STDMETHODCALLTYPE *Next)(__RPC__in IContactPropertyCollection *This);
...
#define IContactPropertyCollection_GetPropertyName(                            \
    This, pszPropertyName, cchPropertyName, pdwcchPropertyNameRequired)        \
  ((This)->lpVtbl->GetPropertyName(This, pszPropertyName, cchPropertyName,     \
...
#define IContactPropertyCollection_GetPropertyModificationDate(                \
...
#define IContactPropertyCollection_GetPropertyArrayElementID(                  \
  ...
  ((This)->lpVtbl->GetPropertyArrayElementID(This, pszArrayElementID,          \
                                             cchArrayElementID,                \
