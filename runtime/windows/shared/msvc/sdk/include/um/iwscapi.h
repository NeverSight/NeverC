...
public:
  ...
  virtual /* [helpstring][id][propget] */ HRESULT STDMETHODCALLTYPE
      get_SignatureStatus(
          /* [retval][out] */ __RPC__out WSC_SECURITY_SIGNATURE_STATUS *
          pVal) = 0;
...
typedef struct IWscProductVtbl {
  ...
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in IWscProduct *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IWscProduct *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IWscProduct *This);
  ...
  /* [helpstring][id][propget] */ HRESULT(
      STDMETHODCALLTYPE *get_ProductIsDefault)(
      __RPC__in IWscProduct *This,
...
interface IWscProduct { CONST_VTBL struct IWscProductVtbl *lpVtbl; };
...
public:
  virtual /* [id][propget] */ HRESULT STDMETHODCALLTYPE
      get_AntivirusScanSubstatus(
          /* [retval][out] */ __RPC__out WSC_SECURITY_PRODUCT_SUBSTATUS *
          peStatus) = 0;
...
typedef struct IWscProduct2Vtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in IWscProduct2 *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IWscProduct2 *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IWscProduct2 *This);
  ...
  /* [id][propget] */ HRESULT(
      STDMETHODCALLTYPE *get_AntivirusSettingsSubstatus)(
      __RPC__in IWscProduct2 *This,
      /* [retval][out] */ __RPC__out WSC_SECURITY_PRODUCT_SUBSTATUS *peStatus);

  DECLSPEC_XFGVIRT(IWscProduct2, get_AntivirusProtectionUpdateSubstatus)
  /* [id][propget] */ HRESULT(
      STDMETHODCALLTYPE *get_AntivirusProtectionUpdateSubstatus)(
      __RPC__in IWscProduct2 *This,
      /* [retval][out] */ __RPC__out WSC_SECURITY_PRODUCT_SUBSTATUS *peStatus);

  DECLSPEC_XFGVIRT(IWscProduct2, get_FirewallDomainProfileSubstatus)
  /* [id][propget] */ HRESULT(
      STDMETHODCALLTYPE *get_FirewallDomainProfileSubstatus)(
      __RPC__in IWscProduct2 *This,
      /* [retval][out] */ __RPC__out WSC_SECURITY_PRODUCT_SUBSTATUS *peStatus);

  DECLSPEC_XFGVIRT(IWscProduct2, get_FirewallPrivateProfileSubstatus)
  /* [id][propget] */ HRESULT(
      STDMETHODCALLTYPE *get_FirewallPrivateProfileSubstatus)(
      __RPC__in IWscProduct2 *This,
      /* [retval][out] */ __RPC__out WSC_SECURITY_PRODUCT_SUBSTATUS *peStatus);

  DECLSPEC_XFGVIRT(IWscProduct2, get_FirewallPublicProfileSubstatus)
  /* [id][propget] */ HRESULT(
      STDMETHODCALLTYPE *get_FirewallPublicProfileSubstatus)(
      __RPC__in IWscProduct2 *This,
      /* [retval][out] */ __RPC__out WSC_SECURITY_PRODUCT_SUBSTATUS *peStatus);
...
interface IWscProduct2 { CONST_VTBL struct IWscProduct2Vtbl *lpVtbl; };
...
typedef struct IWscProduct3Vtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in IWscProduct3 *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IWscProduct3 *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IWscProduct3 *This);
...
interface IWscProduct3 { CONST_VTBL struct IWscProduct3Vtbl *lpVtbl; };
...
typedef struct IWSCProductListVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in IWSCProductList *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IWSCProductList *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IWSCProductList *This);
...
interface IWSCProductList { CONST_VTBL struct IWSCProductListVtbl *lpVtbl; };
...
typedef struct IWSCDefaultProductVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in IWSCDefaultProduct *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IWSCDefaultProduct *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IWSCDefaultProduct *This);
