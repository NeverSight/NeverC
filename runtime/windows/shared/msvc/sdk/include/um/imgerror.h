...
typedef struct IImgErrorInfoVtbl {
  ...
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(IImgErrorInfo *This,
                                             /* [in] */ REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(IImgErrorInfo *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(IImgErrorInfo *This);

  DECLSPEC_XFGVIRT(IErrorInfo, GetGUID)
  HRESULT(STDMETHODCALLTYPE *GetGUID)(IImgErrorInfo *This,
                                      /* [out] */ GUID *pGUID);

  DECLSPEC_XFGVIRT(IErrorInfo, GetSource)
  HRESULT(STDMETHODCALLTYPE *GetSource)(IImgErrorInfo *This,
  ...
  HRESULT(STDMETHODCALLTYPE *GetHelpFile)(IImgErrorInfo *This,
                                          /* [out] */ BSTR *pBstrHelpFile);

  DECLSPEC_XFGVIRT(IErrorInfo, GetHelpContext)
  HRESULT(STDMETHODCALLTYPE *GetHelpContext)(IImgErrorInfo *This,
  ...
  HRESULT(STDMETHODCALLTYPE *GetUserErrorId)(IImgErrorInfo *This,
                                             /* [annotation][out] */
                                             _Out_ GUID *pErrorId);

  DECLSPEC_XFGVIRT(IImgErrorInfo, GetUserParameterCount)
  HRESULT(STDMETHODCALLTYPE *GetUserParameterCount)(IImgErrorInfo *This,
                                                    /* [annotation][out] */
                                                    _Out_ ULONG *pcUserParams);

  DECLSPEC_XFGVIRT(IImgErrorInfo, GetUserParameter)
  HRESULT(STDMETHODCALLTYPE *GetUserParameter)(IImgErrorInfo *This,
                                               /* [annotation][in] */
                                               _In_ ULONG cParam,
                                               /* [annotation][out] */
  ...
  HRESULT(STDMETHODCALLTYPE *GetUserFallback)(IImgErrorInfo *This,
                                              /* [annotation][out] */
                                              _Out_ BSTR *pbstrFallback);

  DECLSPEC_XFGVIRT(IImgErrorInfo, GetExceptionId)
  HRESULT(STDMETHODCALLTYPE *GetExceptionId)(IImgErrorInfo *This,
                                             /* [annotation][out] */
                                             _Out_ DWORD *pExceptionId);

  DECLSPEC_XFGVIRT(IImgErrorInfo, DetachErrorInfo)
  HRESULT(STDMETHODCALLTYPE *DetachErrorInfo)(IImgErrorInfo *This,
                                              /* [annotation][out] */
...
interface IImgErrorInfo { CONST_VTBL struct IImgErrorInfoVtbl *lpVtbl; };
...
typedef struct IImgCreateErrorInfoVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(IImgCreateErrorInfo *This,
                                             /* [in] */ REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(IImgCreateErrorInfo *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(IImgCreateErrorInfo *This);

  DECLSPEC_XFGVIRT(ICreateErrorInfo, SetGUID)
  HRESULT(STDMETHODCALLTYPE *SetGUID)(IImgCreateErrorInfo *This,
                                      /* [in] */ REFGUID rguid);

  DECLSPEC_XFGVIRT(ICreateErrorInfo, SetSource)
  HRESULT(STDMETHODCALLTYPE *SetSource)(IImgCreateErrorInfo *This,
                                        /* [in] */ LPOLESTR szSource);

  DECLSPEC_XFGVIRT(ICreateErrorInfo, SetDescription)
  HRESULT(STDMETHODCALLTYPE *SetDescription)(IImgCreateErrorInfo *This,
                                             /* [in] */ LPOLESTR szDescription);

  DECLSPEC_XFGVIRT(ICreateErrorInfo, SetHelpFile)
  HRESULT(STDMETHODCALLTYPE *SetHelpFile)(IImgCreateErrorInfo *This,
                                          /* [in] */ LPOLESTR szHelpFile);

  DECLSPEC_XFGVIRT(ICreateErrorInfo, SetHelpContext)
  HRESULT(STDMETHODCALLTYPE *SetHelpContext)(IImgCreateErrorInfo *This,
