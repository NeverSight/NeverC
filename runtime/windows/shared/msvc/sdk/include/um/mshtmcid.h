...
#define IDM_ADDDEBUGCALLBACKRECEIVER                                           \
  3804 // pvaIn: IDebugCallbackNotificationHandler*, pvaOut: cookie for
       // unregister
#define IDM_REMOVEDEBUGCALLBACKRECEIVER                                        \
  3805 // pvaIn: cookie from register, pvaOut: NULL
...
#define IDM_SETSCRIPTCONSOLE                                                   \
  15012 // no longer in use, use IDM_SETDEVTOOLBARCONSOLE
#define IDM_SETNAVIGATEEVENTSINK 15013
// <New in IE9>
// UNUSED :                             15014
// UNUSED :                             15015
#define IDM_SETDEVTOOLBARCONSOLE                                               \
  15016 // no longer in use, use IDM_ADDCONSOLEMESSAGERECEIVER &
