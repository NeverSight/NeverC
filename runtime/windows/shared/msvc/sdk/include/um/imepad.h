...
DEFINE_GUID(CATID_MSIME_IImePadApplet_VER7, 0x4a0f8e31, 0xc3ee, 0x11d1, 0xaf,
            0xef, 0x0, 0x80, 0x5f, 0xc, 0x8b, 0x6d);

//----------------------------------------------------------------
// ImePadApplet's Category ID version 8.0.0
//----------------------------------------------------------------
// {56F7A792-FEF1-11d3-8463-00C04F7A06E5}
DEFINE_GUID(CATID_MSIME_IImePadApplet_VER80, 0x56f7a792, 0xfef1, 0x11d3, 0x84,
            0x63, 0x0, 0xc0, 0x4f, 0x7a, 0x6, 0xe5);

//----------------------------------------------------------------
// ImePadApplet's Category ID version 8.1.0
//----------------------------------------------------------------
// {656520B0-BB88-11d4-84C0-00C04F7A06E5}
DEFINE_GUID(CATID_MSIME_IImePadApplet_VER81, 0x656520b0, 0xbb88, 0x11d4, 0x84,
            0xc0, 0x0, 0xc0, 0x4f, 0x7a, 0x6, 0xe5);

//----------------------------------------------------------------
// ImePadApplet's Category ID version 9.0.0
//----------------------------------------------------------------
// {FAAE51BF-5E5B-4A1D-8DE1-17C1D9E1728D}
DEFINE_GUID(CATID_MSIME_IImePadApplet900, 0xfaae51bf, 0x5e5b, 0x4a1d, 0x8d,
            0xe1, 0x17, 0xc1, 0xd9, 0xe1, 0x72, 0x8d);

//----------------------------------------------------------------
// ImePadApplet's Category ID version 10.0.0
//----------------------------------------------------------------
// {E081E1D6-2389-43cb-B66F-609F823D9F9C}
DEFINE_GUID(CATID_MSIME_IImePadApplet1000, 0xe081e1d6, 0x2389, 0x43cb, 0xb6,
            0x6f, 0x60, 0x9f, 0x82, 0x3d, 0x9f, 0x9c);

//----------------------------------------------------------------
// ImePadApplet's Category ID version 12.0.0
//----------------------------------------------------------------
// {A47FB5FC-7D15-4223-A789-B781BF9AE667}
DEFINE_GUID(CATID_MSIME_IImePadApplet1200, 0xa47fb5fc, 0x7d15, 0x4223, 0xa7,
            0x89, 0xb7, 0x81, 0xbf, 0x9a, 0xe6, 0x67);

//----------------------------------------------------------------
// ImePadApplet's Category ID version 14.0.0
//----------------------------------------------------------------
// {7566CAD1-4EC9-4478-9FE9-8ED766619EDF}
DEFINE_GUID(CATID_MSIME_IImePadApplet, 0x7566cad1, 0x4ec9, 0x4478, 0x9f, 0xe9,
            0x8e, 0xd7, 0x66, 0x61, 0x9e, 0xdf);

//----------------------------------------------------------------
// Interface ID
//----------------------------------------------------------------
// {5D8E643A-C3A9-11d1-AFEF-00805F0C8B6D}
DEFINE_GUID(IID_IImePad, 0x5d8e643a, 0xc3a9, 0x11d1, 0xaf, 0xef, 0x0, 0x80,
            0x5f, 0xc, 0x8b, 0x6d);

// {5D8E643B-C3A9-11d1-AFEF-00805F0C8B6D}
DEFINE_GUID(IID_IImePadApplet, 0x5d8e643b, 0xc3a9, 0x11d1, 0xaf, 0xef, 0x0,
            0x80, 0x5f, 0xc, 0x8b, 0x6d);

// {5D8E643C-C3A9-11d1-AFEF-00805F0C8B6D}
DEFINE_GUID(IID_IImeSpecifyApplets, 0x5d8e643c, 0xc3a9, 0x11d1, 0xaf, 0xef, 0x0,
            0x80, 0x5f, 0xc, 0x8b, 0x6d);
...
#define APPLETIDFROMCHARINFO(charInfo)                                         \
  (((DWORD)(charInfo) & CHARINFO_APPLETID_MASK) >> 24)
#define FEIDFROMCHARINFO(charInfo)                                             \
  (((DWORD)(charInfo) & CHARINFO_FEID_MASK) >> 20)
...
// wParam = (WPARAM)(LPIMESTRINGCANDIDATE)lpStrCand;    //address of
// IMESTRINGCANDIDATE lParam = 0;                                          //not
// used.
//----------------------------------------------------------------
...
#define IPAWS_SIZINGNOTIFY                                                     \
  0x00000004L // send IMEPN_SIZECHANGING(ED) notify to applet.
...
DECLARE_INTERFACE_(IImeSpecifyApplets, IUnknown) {
  ...
  STDMETHOD(GetAppletIIDList)(THIS_ REFIID refiid, LPAPPLETIDLIST lpIIDList)
      PURE;
};
...
DECLARE_INTERFACE_(IImePadApplet, IUnknown) {
  ...
  STDMETHOD(CreateUI)(THIS_ HWND hwndParent, LPIMEAPPLETUI lpImeAppletUI) PURE;
  STDMETHOD(Notify)(THIS_ IUnknown * lpImePad, INT notify, WPARAM wParam,
                    LPARAM lParam) PURE;
};
...
DECLARE_INTERFACE_(IImePad, IUnknown) {
  ...
  STDMETHOD_(ULONG, Release)(THIS) PURE;
  /*** IImePad methods ***/
  STDMETHOD(Request)(THIS_ IImePadApplet * pIImePadApplet, INT reqId,
