...
/// Effect description: This effect combines two images by adding weighted
/// pixels from input images. The formula can be expressed as output = weight *
/// Destination
/// + (1 - weight) * Source
/// </summary>
...
/// Effect description: This effect adjusts the white level of the source image
/// by multiplying the source image color by the ratio of the input and output
/// white levels. Input and output white levels are specified in nits.
/// </summary>
...
/// within the maximum output luminance supported. Input and output luminance
/// values are specified in nits. Note that the color space of the image is
/// assumed to be scRGB.
/// </summary>
