...
typedef interface ITPluggableTerminalInitialization
...
typedef interface ITPluggableTerminalClassRegistration
...
typedef interface ITPluggableTerminalSuperclassRegistration
...
public:
  ...
  CompleteConnectTerminal(void) = 0;

  virtual /* [helpstring][id] */ HRESULT STDMETHODCALLTYPE DisconnectTerminal(
      /* [in] */ __RPC__in_opt IGraphBuilder * pGraph,
      /* [in] */ DWORD dwReserved) = 0;

  virtual /* [helpstring][id] */ HRESULT STDMETHODCALLTYPE RunRenderFilter(
      void) = 0;

  virtual /* [helpstring][id] */ HRESULT STDMETHODCALLTYPE StopRenderFilter(
      void) = 0;
};
...
typedef struct ITTerminalControlVtbl {
  ...
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in ITTerminalControl *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in ITTerminalControl *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in ITTerminalControl *This);
...
typedef struct ITTerminalManagerVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in ITTerminalManager *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in ITTerminalManager *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in ITTerminalManager *This);
...
#define ITTerminalManager_GetDynamicTerminalClasses(                           \
  ...
  ((This)->lpVtbl->GetDynamicTerminalClasses(This, dwMediaTypes,               \
                                             pdwNumClasses, pTerminalClasses))

#define ITTerminalManager_CreateDynamicTerminal(                               \
    This, pOuterUnknown, iidTerminalClass, dwMediaType, Direction, htAddress,  \
    ppTerminal)                                                                \
  ((This)->lpVtbl->CreateDynamicTerminal(This, pOuterUnknown,                  \
                                         iidTerminalClass, dwMediaType,        \
                                         Direction, htAddress, ppTerminal))
...
typedef struct ITTerminalManager2Vtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in ITTerminalManager2 *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in ITTerminalManager2 *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in ITTerminalManager2 *This);
  ...
  /* [helpstring][id] */ HRESULT(
      STDMETHODCALLTYPE *GetPluggableTerminalClasses)(
      __RPC__in ITTerminalManager2 *This,
      /* [in] */ IID iidSuperclass,
      /* [in] */ DWORD dwMediaTypes,
      /* [out][in] */ __RPC__inout DWORD *pdwNumClasses,
...
public:
  ...
  virtual /* [helpstring][id] */ HRESULT STDMETHODCALLTYPE
  GetTerminalSuperclassInfo(void) = 0;

  virtual /* [helpstring][propget][id] */ HRESULT STDMETHODCALLTYPE
      get_TerminalClasses(
          /* [retval][out] */ __RPC__out VARIANT * pTerminals) = 0;

  virtual /* [hidden][helpstring][id] */ HRESULT STDMETHODCALLTYPE
...
typedef struct ITPluggableTerminalSuperclassRegistrationVtbl {
  ...
  DECLSPEC_XFGVIRT(ITPluggableTerminalSuperclassRegistration,
  ...
  /* [helpstring][propget][id] */ HRESULT(
      STDMETHODCALLTYPE *get_TerminalClasses)(
      __RPC__in ITPluggableTerminalSuperclassRegistration *This,
      /* [retval][out] */ __RPC__out VARIANT *pTerminals);

  DECLSPEC_XFGVIRT(ITPluggableTerminalSuperclassRegistration,
                   EnumerateTerminalClasses)
  /* [hidden][helpstring][id] */ HRESULT(
      STDMETHODCALLTYPE *EnumerateTerminalClasses)(
      __RPC__in ITPluggableTerminalSuperclassRegistration *This,
      /* [retval][out] */ __RPC__deref_out_opt IEnumTerminalClass *
          *ppTerminals);
...
class DECLSPEC_UUID("7170F2E0-9BE3-11D0-A009-00AA00B605A4") TerminalManager;
#endif
