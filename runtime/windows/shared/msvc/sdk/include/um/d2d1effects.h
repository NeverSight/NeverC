...
DEFINE_GUID(CLSID_D2D1Atlas, 0x913e2be4, 0xfdcf, 0x4fe2, 0xa5, 0xf0, 0x24, 0x54,
            0xf1, 0x4f, 0xf4, 0x8);
DEFINE_GUID(CLSID_D2D1BitmapSource, 0x5fb6c24d, 0xc6dd, 0x4231, 0x94, 0x4, 0x50,
            0xf4, 0xd5, 0xc3, 0x25, 0x2d);
...
DEFINE_GUID(CLSID_D2D1DisplacementMap, 0xedc48364, 0x417, 0x4111, 0x94, 0x50,
...
/// <summary>
/// Specifies the color channel the Displacement map effect extracts the
/// intensity from and uses it to spatially displace the image in the X or Y
/// direction.
/// </summary>
...
/// <summary>
/// Speficies whether a flip and/or rotation operation should be performed by
/// the Bitmap source effect
/// </summary>
...
/// Effect description: Applies a gaussian blur to a bitmap with the specified
...
/// Effect description: Applies a directional blur to a bitmap with the
/// specified blur radius and angle.
/// </summary>
...
/// Effect description: Blends a foreground and background using a pre-defined
/// blend mode.
/// </summary>
...
/// Effect description: Changes the Hue of a bitmap based on a user specified
/// Hue Rotation angle.
/// </summary>
...
/// Effect description: Applies a user specified color matrix to each channel of
/// the input bitmap.
/// </summary>
...
/// <summary>
/// The enumeration of the 3D Perspective Transform effect's top level
/// properties. Effect description: Applies a 3D perspective transform to a
/// bitmap.
/// </summary>
...
/// Effect description: Scales according to the input DPI and the current
/// context DPI
/// </summary>
...
/// Effect description: Creates a specular lighting effect with a spot light
/// source.
/// </summary>
...
/// Effect description: Creates a diffuse lighting effect with a point light
/// source.
/// </summary>
...
/// Effect description: Creates a diffuse lighting effect with a spot light
/// source.
/// </summary>
...
/// Effect description: Remaps the color intensities of the input bitmap based
/// on a user specified linear transfer function for each RGBA channel.
/// </summary>
...
/// Effect description: Remaps the color intensities of the input bitmap based
/// on a user specified gamma transfer function for each RGBA channel.
/// </summary>
...
/// Effect description: Remaps the color intensities of the input bitmap based
/// on a transfer function generated by a user specified list of values for each
/// RGBA channel.
/// </summary>
...
/// Effect description: Remaps the color intensities of the input bitmap based
/// on a discrete function generated by a user specified list of values for each
/// RGBA channel.
/// </summary>
...
/// Effect description: Adjusts the brightness of the image based on the
/// specified white and black point.
/// </summary>
...
/// rectangle. Provides an optimization for scenarios where a bitmap is used as
/// an atlas.
/// </summary>
