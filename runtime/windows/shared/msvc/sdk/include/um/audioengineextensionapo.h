...
typedef interface IAudioProcessingObjectRTQueueService
...
typedef interface IAudioProcessingObjectLoggingService
...
typedef interface IAudioProcessingObjectNotifications
...
public:
  virtual HRESULT STDMETHODCALLTYPE GetControllableSystemEffectsList(
      ...
      _Outptr_result_buffer_maybenull_(*numEffects) AUDIO_SYSTEMEFFECT *
          *effects,
      /* [annotation][out] */
...
typedef struct IAudioSystemEffects3Vtbl {
  ...
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(IAudioSystemEffects3 *This,
                                             /* [in] */ REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(IAudioSystemEffects3 *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(IAudioSystemEffects3 *This);
  ...
  HRESULT(STDMETHODCALLTYPE *GetControllableSystemEffectsList)(
      IAudioSystemEffects3 *This,
      /* [annotation][size_is][size_is][out] */
      _Outptr_result_buffer_maybenull_(*numEffects)
...
#define IAudioSystemEffects3_AddRef(This) ((This)->lpVtbl->AddRef(This))

#define IAudioSystemEffects3_Release(This) ((This)->lpVtbl->Release(This))

#define IAudioSystemEffects3_GetEffectsList(This, ppEffectsIds, pcEffects,     \
                                            Event)                             \
  ((This)->lpVtbl->GetEffectsList(This, ppEffectsIds, pcEffects, Event))

#define IAudioSystemEffects3_GetControllableSystemEffectsList(                 \
    This, effects, numEffects, event)                                          \
  ((This)->lpVtbl->GetControllableSystemEffectsList(This, effects, numEffects, \
                                                    event))
...
typedef struct IAudioProcessingObjectRTQueueServiceVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(IAudioProcessingObjectRTQueueService *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(IAudioProcessingObjectRTQueueService *This);
...
#define IAudioProcessingObjectRTQueueService_QueryInterface(This, riid,        \
                                                            ppvObject)         \
  ((This)->lpVtbl->QueryInterface(This, riid, ppvObject))
...
#define IAudioProcessingObjectRTQueueService_GetRealTimeWorkQueue(This,        \
                                                                  workQueueId) \
...
DEFINE_GUID(SID_AudioProcessingObjectRTQueue, 0x458c1a1f, 0x6899, 0x4c12, 0x99,
            0xac, 0xe2, 0xe6, 0xac, 0x25, 0x31, 0x4);
...
typedef struct IAudioProcessingObjectLoggingServiceVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(IAudioProcessingObjectLoggingService *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(IAudioProcessingObjectLoggingService *This);

  DECLSPEC_XFGVIRT(IAudioProcessingObjectLoggingService, ApoLog)
  void(STDMETHODCALLTYPE *ApoLog)(IAudioProcessingObjectLoggingService *This,
                                  /* [in] */ APO_LOG_LEVEL level,
                                  /* [annotation][in] */
                                  _In_ LPCWSTR format, ...);
...
#define IAudioProcessingObjectLoggingService_QueryInterface(This, riid,        \
                                                            ppvObject)         \
  ((This)->lpVtbl->QueryInterface(This, riid, ppvObject))
...
DEFINE_GUID(SID_AudioProcessingObjectLoggingService, 0x8b8008af, 0x9f9, 0x456e,
            0xa1, 0x73, 0xbd, 0xb5, 0x84, 0x99, 0xbc, 0xe7);
...
typedef enum DEVICE_ORIENTATION_TYPE {
  ...
  DEVICE_ROTATED_270_DEGREES_CLOCKWISE =
      (DEVICE_ROTATED_180_DEGREES_CLOCKWISE + 1)
...
DEFINE_PROPERTYKEY(PKEY_AudioEnvironment_SpatialAudioActive, 0x4AFB7B88, 0xA653,
                   0x44A5, 0x99, 0xDB, 0x68, 0x7F, 0xD7, 0x4A, 0xF0, 0xBB, 2);
...
typedef struct IAudioProcessingObjectPreferredFormatSupportVtbl {
  ...
  DECLSPEC_XFGVIRT(IAudioProcessingObjectPreferredFormatSupport,
...
#define IAudioProcessingObjectPreferredFormatSupport_QueryInterface(           \
    This, riid, ppvObject)                                                     \
  ((This)->lpVtbl->QueryInterface(This, riid, ppvObject))
...
#define IAudioProcessingObjectPreferredFormatSupport_GetPreferredInputFormat(  \
    This, outputFormat, preferredFormat)                                       \
  ((This)->lpVtbl->GetPreferredInputFormat(This, outputFormat, preferredFormat))

#define IAudioProcessingObjectPreferredFormatSupport_GetPreferredOutputFormat( \
    This, inputFormat, preferredFormat)                                        \
...
typedef struct IAudioProcessingObjectNotificationsVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(IAudioProcessingObjectNotifications *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(IAudioProcessingObjectNotifications *This);

  DECLSPEC_XFGVIRT(IAudioProcessingObjectNotifications,
...
#define IAudioProcessingObjectNotifications_QueryInterface(This, riid,         \
                                                           ppvObject)          \
  ((This)->lpVtbl->QueryInterface(This, riid, ppvObject))
...
#define IAudioProcessingObjectNotifications_GetApoNotificationRegistrationInfo( \
    This, apoNotifications, count)                                              \
  ((This)->lpVtbl->GetApoNotificationRegistrationInfo(This, apoNotifications,   \
                                                      count))

#define IAudioProcessingObjectNotifications_HandleNotification(                \
    This, apoNotification)                                                     \
...
typedef struct IAudioProcessingObjectNotifications2Vtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(IAudioProcessingObjectNotifications2 *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(IAudioProcessingObjectNotifications2 *This);
  ...
  DECLSPEC_XFGVIRT(IAudioProcessingObjectNotifications2,
...
#define IAudioProcessingObjectNotifications2_QueryInterface(This, riid,        \
                                                            ppvObject)         \
  ((This)->lpVtbl->QueryInterface(This, riid, ppvObject))
...
#define IAudioProcessingObjectNotifications2_GetApoNotificationRegistrationInfo( \
    This, apoNotifications, count)                                               \
  ((This)->lpVtbl->GetApoNotificationRegistrationInfo(This, apoNotifications,    \
                                                      count))

#define IAudioProcessingObjectNotifications2_HandleNotification(               \
    This, apoNotification)                                                     \
  ((This)->lpVtbl->HandleNotification(This, apoNotification))

#define IAudioProcessingObjectNotifications2_GetApoNotificationRegistrationInfo2( \
    This, maxApoNotificationTypeSupported, apoNotifications, count)               \
  ((This)->lpVtbl->GetApoNotificationRegistrationInfo2(                           \
      This, maxApoNotificationTypeSupported, apoNotifications, count))
