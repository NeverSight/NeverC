...
extern const __declspec(selectany) WCHAR
    CastingSourceInfo_Property_PreferredSourceUriScheme[] =
        L"PreferredSourceUriScheme";
extern const
    __declspec(selectany) WCHAR CastingSourceInfo_Property_CastingTypes[] =
        L"CastingTypes";
extern const
    __declspec(selectany) WCHAR CastingSourceInfo_Property_ProtectedMedia[] =
        L"ProtectedMedia";
...
typedef struct ICastingEventHandlerVtbl {
  ...
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in ICastingEventHandler *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in ICastingEventHandler *This);
...
#define ICastingEventHandler_AddRef(This) ((This)->lpVtbl->AddRef(This))

#define ICastingEventHandler_Release(This) ((This)->lpVtbl->Release(This))
...
typedef struct ICastingControllerVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in ICastingController *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in ICastingController *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in ICastingController *This);
  ...
  HRESULT(STDMETHODCALLTYPE *Connect)(__RPC__in ICastingController *This);

  DECLSPEC_XFGVIRT(ICastingController, Disconnect)
  HRESULT(STDMETHODCALLTYPE *Disconnect)(__RPC__in ICastingController *This);
  ...
  HRESULT(STDMETHODCALLTYPE *UnAdvise)(__RPC__in ICastingController *This,
                                       /* [in] */ DWORD cookie);
...
#define ICastingController_AddRef(This) ((This)->lpVtbl->AddRef(This))

#define ICastingController_Release(This) ((This)->lpVtbl->Release(This))
...
#define ICastingController_Connect(This) ((This)->lpVtbl->Connect(This))

#define ICastingController_Disconnect(This) ((This)->lpVtbl->Disconnect(This))
...
typedef struct ICastingSourceInfoVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in ICastingSourceInfo *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in ICastingSourceInfo *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in ICastingSourceInfo *This);
...
#define ICastingSourceInfo_AddRef(This) ((This)->lpVtbl->AddRef(This))

#define ICastingSourceInfo_Release(This) ((This)->lpVtbl->Release(This))
