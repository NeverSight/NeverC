...
__inline BOOL WMPNotifyPluginAddRemove() {
  return (::PostMessage(HWND_BROADCAST,
                        ::RegisterWindowMessageA("WMPlayer_PluginAddRemove"), 0,
                        0));
}
...
typedef struct IWMPPluginUIVtbl {
  ...
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(IWMPPluginUI *This,
                                             /* [in] */ REFIID riid,
  ...
  HRESULT(STDMETHODCALLTYPE *SetCore)(IWMPPluginUI *This,
                                      /* [in] */ IWMPCore *pCore);

  DECLSPEC_XFGVIRT(IWMPPluginUI, Create)
  HRESULT(STDMETHODCALLTYPE *Create)(IWMPPluginUI *This,
                                     /* [in] */ HWND hwndParent,
  ...
  HRESULT(STDMETHODCALLTYPE *DisplayPropertyPage)(IWMPPluginUI *This,
                                                  /* [in] */ HWND hwndParent);

  DECLSPEC_XFGVIRT(IWMPPluginUI, GetProperty)
  HRESULT(STDMETHODCALLTYPE *GetProperty)(IWMPPluginUI *This,
                                          /* [in] */ const WCHAR *pwszName,
  ...
  HRESULT(STDMETHODCALLTYPE *TranslateAccelerator)(IWMPPluginUI *This,
                                                   /* [in] */ LPMSG lpmsg);

  END_INTERFACE
} IWMPPluginUIVtbl;

interface IWMPPluginUI { CONST_VTBL struct IWMPPluginUIVtbl *lpVtbl; };
