...
typedef enum _EC_SUBSCRIPTION_PROPERTY_ID {
  ...
  EcSubscriptionConfigurationMode,   // EcVarTypeUInt32,
...
typedef enum _EC_SUBSCRIPTION_RUNTIME_STATUS_INFO_ID {
  EcSubscriptionRunTimeStatusActive =
      0, // EcVarTypeUInt32, EC_SUBSCRIPTION_RUNTIME_STATUS_ACTIVE_STATUS
...
BOOL WINAPI EcEnumNextSubscription(
    EC_HANDLE SubscriptionEnum, DWORD SubscriptionNameBufferSize,
...
BOOL WINAPI EcSetSubscriptionProperty(EC_HANDLE Subscription,
                                      EC_SUBSCRIPTION_PROPERTY_ID PropertyId,
                                      DWORD Flags, PEC_VARIANT PropertyValue);

BOOL WINAPI EcGetSubscriptionProperty(EC_HANDLE Subscription,
                                      EC_SUBSCRIPTION_PROPERTY_ID PropertyId,
                                      DWORD Flags,
...
BOOL WINAPI EcGetObjectArraySize(EC_OBJECT_ARRAY_PROPERTY_HANDLE ObjectArray,
...
BOOL WINAPI EcGetSubscriptionRunTimeStatus(
    ...
    PEC_VARIANT StatusValueBuffer, _Out_ PDWORD StatusValueBufferUsed);

BOOL WINAPI EcRetrySubscription(LPCWSTR SubscriptionName,
