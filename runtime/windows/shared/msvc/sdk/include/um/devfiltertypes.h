...
typedef
    ...
    enum _DEVPROP_OPERATOR {
      ...
      DEVPROP_OPERATOR_NOT_EXISTS =
          DEVPROP_OPERATOR_EXISTS | DEVPROP_OPERATOR_MODIFIER_NOT,
      ...
      DEVPROP_OPERATOR_BEGINS_WITH_IGNORE_CASE =
          DEVPROP_OPERATOR_BEGINS_WITH | DEVPROP_OPERATOR_MODIFIER_IGNORE_CASE,
      DEVPROP_OPERATOR_ENDS_WITH_IGNORE_CASE =
          DEVPROP_OPERATOR_ENDS_WITH | DEVPROP_OPERATOR_MODIFIER_IGNORE_CASE,
      DEVPROP_OPERATOR_CONTAINS_IGNORE_CASE =
          DEVPROP_OPERATOR_CONTAINS | DEVPROP_OPERATOR_MODIFIER_IGNORE_CASE,
