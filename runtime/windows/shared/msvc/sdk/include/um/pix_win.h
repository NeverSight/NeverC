...
inline void PIXSetMarker(ID3D12GraphicsCommandList *pCommandList,
                         UINT64 /*metadata*/, PCWSTR pFormat) {
...
inline void PIXSetMarker(ID3D12CommandQueue *pCommandQueue, UINT64 /*metadata*/,
                         PCWSTR pFormat) {
  using namespace DirectX::Detail;
  UINT size = static_cast<UINT>((wcslen(pFormat) + 1) * sizeof(pFormat[0]));
...
inline void PIXSetMarker(ID3D12GraphicsCommandList *pCommandList,
                         UINT64 /*metadata*/, PCWSTR pFormat, TArgs &&...args) {
  using namespace DirectX::Detail;

  wchar_t buf[PIX_STRING_BUFFER_COUNT];
  int count =
      _snwprintf_s(buf, _TRUNCATE, pFormat, std::forward<TArgs>(args)...) + 1;
...
template <typename... TArgs>
inline void PIXSetMarker(ID3D12GraphicsCommandList *pCommandList,
                         UINT64 /*metadata*/, PCSTR pFormat, TArgs &&...args) {
  using namespace DirectX::Detail;

  char buf[PIX_STRING_BUFFER_COUNT];
  int count =
      _snprintf_s(buf, _TRUNCATE, pFormat, std::forward<TArgs>(args)...) + 1;
  if (count == 0) // string was truncated
    count = PIX_STRING_BUFFER_COUNT;
...
template <typename... TArgs>
inline void PIXSetMarker(ID3D12CommandQueue *pQueue, UINT64 /*metadata*/,
                         PCSTR pFormat, TArgs &&...args) {
  using namespace DirectX::Detail;
...
inline void PIXSetMarker(ID3DUserDefinedAnnotation *pAnnotation,
                         UINT64 /*metadata*/, PCWSTR pFormat) {
...
inline void PIXSetMarker(ID3D11DeviceContext2 *pContext, UINT64 /*metadata*/,
                         PCWSTR pFormat) {
...
inline void PIXBeginEvent(ID3D12GraphicsCommandList *pCommandList,
                          UINT64 /*metadata*/, PCWSTR pFormat) {
  using namespace DirectX::Detail;
  UINT size = static_cast<UINT>((wcslen(pFormat) + 1) * sizeof(pFormat[0]));
...
inline void PIXBeginEvent(ID3D12CommandQueue *pCommandQueue,
                          UINT64 /*metadata*/, PCWSTR pFormat) {
  using namespace DirectX::Detail;
  UINT size = static_cast<UINT>((wcslen(pFormat) + 1) * sizeof(pFormat[0]));
...
inline void PIXBeginEvent(ID3DUserDefinedAnnotation *pAnnotation,
                          UINT64 /*metadata*/, PCWSTR pFormat) {
...
inline void PIXBeginEvent(ID3D11DeviceContext2 *pContext, UINT64 /*metadata*/,
                          PCWSTR pFormat) {
