...
HRESULT
WINAPI
CreateInteractionContext(_Out_writes_(1)
                             HINTERACTIONCONTEXT *interactionContext);

HRESULT
WINAPI
DestroyInteractionContext(_In_ HINTERACTIONCONTEXT interactionContext);
...
SetInteractionConfigurationInteractionContext(
    _In_ HINTERACTIONCONTEXT interactionContext, _In_ UINT32 configurationCount,
    _In_reads_(configurationCount)
...
GetInteractionConfigurationInteractionContext(
    _In_ HINTERACTIONCONTEXT interactionContext, _In_ UINT32 configurationCount,
    _Inout_updates_(configurationCount)
        INTERACTION_CONTEXT_CONFIGURATION *configuration);

HRESULT
WINAPI
SetPropertyInteractionContext(_In_ HINTERACTIONCONTEXT interactionContext,
                              _In_ INTERACTION_CONTEXT_PROPERTY contextProperty,
                              _In_ UINT32 value);

HRESULT
WINAPI
GetPropertyInteractionContext(_In_ HINTERACTIONCONTEXT interactionContext,
                              _In_ INTERACTION_CONTEXT_PROPERTY contextProperty,
...
SetInertiaParameterInteractionContext(
    _In_ HINTERACTIONCONTEXT interactionContext,
    _In_ INERTIA_PARAMETER inertiaParameter, _In_ float value);

HRESULT
WINAPI
GetInertiaParameterInteractionContext(
    _In_ HINTERACTIONCONTEXT interactionContext,
    _In_ INERTIA_PARAMETER inertiaParameter, _Out_writes_(1) float *value);

HRESULT
WINAPI
SetCrossSlideParametersInteractionContext(
    _In_ HINTERACTIONCONTEXT interactionContext, _In_ UINT32 parameterCount,
...
GetCrossSlideParameterInteractionContext(
    _In_ HINTERACTIONCONTEXT interactionContext,
    _In_ CROSS_SLIDE_THRESHOLD threshold, _Out_writes_(1) float *distance);
...
GetTapParameterInteractionContext(HINTERACTIONCONTEXT interactionContext,
                                  TAP_PARAMETER parameter, _Out_ float *value);
...
SetMouseWheelParameterInteractionContext(
    _In_ HINTERACTIONCONTEXT interactionContext,
    _In_ MOUSE_WHEEL_PARAMETER parameter, _In_ float value);

HRESULT
WINAPI
GetMouseWheelParameterInteractionContext(
    _In_ HINTERACTIONCONTEXT interactionContext,
    _In_ MOUSE_WHEEL_PARAMETER parameter, _Out_writes_(1) float *value);

HRESULT
WINAPI
ResetInteractionContext(_In_ HINTERACTIONCONTEXT interactionContext);

HRESULT
WINAPI
GetStateInteractionContext(_In_ HINTERACTIONCONTEXT interactionContext,
                           _In_opt_ const POINTER_INFO *pointerInfo,
                           _Out_writes_(1) INTERACTION_STATE *state);

HRESULT
WINAPI
AddPointerInteractionContext(_In_ HINTERACTIONCONTEXT interactionContext,
                             _In_ UINT32 pointerId);

HRESULT
WINAPI
RemovePointerInteractionContext(_In_ HINTERACTIONCONTEXT interactionContext,
                                _In_ UINT32 pointerId);

HRESULT
WINAPI
ProcessPointerFramesInteractionContext(
    _In_ HINTERACTIONCONTEXT interactionContext, _In_ UINT32 entriesCount,
...
HRESULT
WINAPI
ProcessInertiaInteractionContext(_In_ HINTERACTIONCONTEXT interactionContext);

HRESULT
WINAPI
StopInteractionContext(_In_ HINTERACTIONCONTEXT interactionContext);

HRESULT
WINAPI
SetPivotInteractionContext(_In_ HINTERACTIONCONTEXT interactionContext,
                           _In_ float x, _In_ float y, _In_ float radius);
