...
typedef struct AMSI_UAC_REQUEST_PACKAGED_APP_INFO
    *LPAMSI_UAC_REQUEST_PACKAGED_APP_INFO;
...
typedef struct IAmsiStreamVtbl {
  ...
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(IAmsiStream *This,
                                             /* [in] */ REFIID riid,
...
interface IAmsiStream { CONST_VTBL struct IAmsiStreamVtbl *lpVtbl; };
...
typedef struct IAntimalwareProviderVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(IAntimalwareProvider *This,
                                             /* [in] */ REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);
  ...
  HRESULT(STDMETHODCALLTYPE *Scan)(IAntimalwareProvider *This,
                                   /* [in] */ IAmsiStream *stream,
                                   /* [out] */ AMSI_RESULT *result);

  DECLSPEC_XFGVIRT(IAntimalwareProvider, CloseSession)
  void(STDMETHODCALLTYPE *CloseSession)(IAntimalwareProvider *This,
                                        /* [in] */ ULONGLONG session);

  DECLSPEC_XFGVIRT(IAntimalwareProvider, DisplayName)
  HRESULT(STDMETHODCALLTYPE *DisplayName)(IAntimalwareProvider *This,
                                          /* [annotation][string][out] */
...
typedef struct IAntimalwareUacProviderVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IAntimalwareUacProvider *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IAntimalwareUacProvider *This);
...
typedef struct IAntimalwareProvider2Vtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(IAntimalwareProvider2 *This,
                                             /* [in] */ REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(IAntimalwareProvider2 *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(IAntimalwareProvider2 *This);

  DECLSPEC_XFGVIRT(IAntimalwareProvider, Scan)
  HRESULT(STDMETHODCALLTYPE *Scan)(IAntimalwareProvider2 *This,
                                   /* [in] */ IAmsiStream *stream,
                                   /* [out] */ AMSI_RESULT *result);

  DECLSPEC_XFGVIRT(IAntimalwareProvider, CloseSession)
  void(STDMETHODCALLTYPE *CloseSession)(IAntimalwareProvider2 *This,
                                        /* [in] */ ULONGLONG session);

  DECLSPEC_XFGVIRT(IAntimalwareProvider, DisplayName)
  HRESULT(STDMETHODCALLTYPE *DisplayName)(IAntimalwareProvider2 *This,
                                          /* [annotation][string][out] */
                                          _Out_ LPWSTR *displayName);

  DECLSPEC_XFGVIRT(IAntimalwareProvider2, Notify)
  HRESULT(STDMETHODCALLTYPE *Notify)(IAntimalwareProvider2 *This,
                                     /* [in] */ PVOID buffer,
                                     /* [in] */ ULONG length,
                                     /* [in] */ LPCWSTR contentName,
                                     /* [in] */ LPCWSTR appName,
...
#define IAntimalwareProvider2_Notify(This, buffer, length, contentName,        \
                                     appName, pResult)                         \
...
typedef struct IAntimalwareVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(IAntimalware *This,
                                             /* [in] */ REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);
  ...
  HRESULT(STDMETHODCALLTYPE *Scan)(IAntimalware *This,
                                   /* [in] */ IAmsiStream *stream,
                                   /* [out] */ AMSI_RESULT *result,
                                   /* [out] */ IAntimalwareProvider **provider);

  DECLSPEC_XFGVIRT(IAntimalware, CloseSession)
  void(STDMETHODCALLTYPE *CloseSession)(IAntimalware *This,
                                        /* [in] */ ULONGLONG session);

  END_INTERFACE
} IAntimalwareVtbl;

interface IAntimalware { CONST_VTBL struct IAntimalwareVtbl *lpVtbl; };
...
typedef struct IAntimalware2Vtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(IAntimalware2 *This,
                                             /* [in] */ REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(IAntimalware2 *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(IAntimalware2 *This);

  DECLSPEC_XFGVIRT(IAntimalware, Scan)
  HRESULT(STDMETHODCALLTYPE *Scan)(IAntimalware2 *This,
                                   /* [in] */ IAmsiStream *stream,
                                   /* [out] */ AMSI_RESULT *result,
                                   /* [out] */ IAntimalwareProvider **provider);

  DECLSPEC_XFGVIRT(IAntimalware, CloseSession)
  void(STDMETHODCALLTYPE *CloseSession)(IAntimalware2 *This,
                                        /* [in] */ ULONGLONG session);

  DECLSPEC_XFGVIRT(IAntimalware2, Notify)
  HRESULT(STDMETHODCALLTYPE *Notify)(IAntimalware2 *This,
                                     /* [in] */ PVOID buffer,
                                     /* [in] */ ULONG length,
                                     /* [in] */ LPCWSTR contentName,
                                     /* [in] */ LPCWSTR appName,
...
interface IAntimalware2 { CONST_VTBL struct IAntimalware2Vtbl *lpVtbl; };
...
#define IAntimalware2_Notify(This, buffer, length, contentName, appName,       \
                             pResult)                                          \
  ((This)->lpVtbl->Notify(This, buffer, length, contentName, appName, pResult))
...
STDAPI AmsiInitialize(_In_ LPCWSTR appName, _Outptr_ HAMSICONTEXT *amsiContext);

STDAPI_(VOID) AmsiUninitialize(_In_ HAMSICONTEXT amsiContext);

STDAPI AmsiOpenSession(_In_ HAMSICONTEXT amsiContext,
                       _Out_ HAMSISESSION *amsiSession);

STDAPI_(VOID)
AmsiCloseSession(_In_ HAMSICONTEXT amsiContext, _In_ HAMSISESSION amsiSession);

STDAPI AmsiScanBuffer(_In_ HAMSICONTEXT amsiContext,
...
STDAPI AmsiNotifyOperation(_In_ HAMSICONTEXT amsiContext,
                           _In_reads_bytes_(length) PVOID buffer,
                           _In_ ULONG length, _In_opt_ LPCWSTR contentName,
                           _Out_ AMSI_RESULT *result);

STDAPI AmsiScanString(_In_ HAMSICONTEXT amsiContext, _In_ LPCWSTR string,
                      _In_opt_ LPCWSTR contentName,
                      _In_opt_ HAMSISESSION amsiSession,
                      _Out_ AMSI_RESULT *result);
