...
typedef struct IMFSpatialAudioObjectBufferVtbl {
  ...
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(IMFSpatialAudioObjectBuffer *This,
                                             /* [in] */ REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(IMFSpatialAudioObjectBuffer *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(IMFSpatialAudioObjectBuffer *This);
  ...
  HRESULT(STDMETHODCALLTYPE *Unlock)(IMFSpatialAudioObjectBuffer *This);
  ...
  HRESULT(STDMETHODCALLTYPE *GetMaxLength)(IMFSpatialAudioObjectBuffer *This,
                                           /* [annotation][out] */
                                           _Out_ DWORD *pcbMaxLength);

  DECLSPEC_XFGVIRT(IMFSpatialAudioObjectBuffer, SetID)
  HRESULT(STDMETHODCALLTYPE *SetID)(IMFSpatialAudioObjectBuffer *This,
                                    /* [annotation][in] */
                                    _In_ UINT32 u32ID);

  DECLSPEC_XFGVIRT(IMFSpatialAudioObjectBuffer, GetID)
  HRESULT(STDMETHODCALLTYPE *GetID)(IMFSpatialAudioObjectBuffer *This,
                                    /* [annotation][out] */
                                    _Out_ UINT32 *pu32ID);

  DECLSPEC_XFGVIRT(IMFSpatialAudioObjectBuffer, SetType)
  HRESULT(STDMETHODCALLTYPE *SetType)(IMFSpatialAudioObjectBuffer *This,
                                      /* [annotation][in] */
                                      _In_ AudioObjectType type);

  DECLSPEC_XFGVIRT(IMFSpatialAudioObjectBuffer, GetType)
  HRESULT(STDMETHODCALLTYPE *GetType)(IMFSpatialAudioObjectBuffer *This,
                                      /* [annotation][out] */
...
#define IMFSpatialAudioObjectBuffer_AddRef(This) ((This)->lpVtbl->AddRef(This))

#define IMFSpatialAudioObjectBuffer_Release(This)                              \
  ((This)->lpVtbl->Release(This))

#define IMFSpatialAudioObjectBuffer_Lock(This, ppbBuffer, pcbMaxLength,        \
                                         pcbCurrentLength)                     \
  ((This)->lpVtbl->Lock(This, ppbBuffer, pcbMaxLength, pcbCurrentLength))

#define IMFSpatialAudioObjectBuffer_Unlock(This) ((This)->lpVtbl->Unlock(This))
...
typedef struct IMFSpatialAudioSampleVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(IMFSpatialAudioSample *This,
                                             /* [in] */ REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(IMFSpatialAudioSample *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(IMFSpatialAudioSample *This);

  DECLSPEC_XFGVIRT(IMFAttributes, GetItem)
  HRESULT(STDMETHODCALLTYPE *GetItem)(
      IMFSpatialAudioSample *This, REFGUID guidKey,
      /* [full][out][in] */ PROPVARIANT *pValue);

  DECLSPEC_XFGVIRT(IMFAttributes, GetItemType)
  HRESULT(STDMETHODCALLTYPE *GetItemType)(IMFSpatialAudioSample *This,
                                          REFGUID guidKey,
                                          /* [out] */ MF_ATTRIBUTE_TYPE *pType);

  DECLSPEC_XFGVIRT(IMFAttributes, CompareItem)
  HRESULT(STDMETHODCALLTYPE *CompareItem)(IMFSpatialAudioSample *This,
                                          REFGUID guidKey, REFPROPVARIANT Value,
                                          /* [out] */ BOOL *pbResult);

  DECLSPEC_XFGVIRT(IMFAttributes, Compare)
  HRESULT(STDMETHODCALLTYPE *Compare)(IMFSpatialAudioSample *This,
                                      IMFAttributes *pTheirs,
                                      MF_ATTRIBUTES_MATCH_TYPE MatchType,
                                      /* [out] */ BOOL *pbResult);

  DECLSPEC_XFGVIRT(IMFAttributes, GetUINT32)
  HRESULT(STDMETHODCALLTYPE *GetUINT32)(IMFSpatialAudioSample *This,
                                        REFGUID guidKey,
                                        /* [out] */ UINT32 *punValue);

  DECLSPEC_XFGVIRT(IMFAttributes, GetUINT64)
  HRESULT(STDMETHODCALLTYPE *GetUINT64)(IMFSpatialAudioSample *This,
                                        REFGUID guidKey,
                                        /* [out] */ UINT64 *punValue);

  DECLSPEC_XFGVIRT(IMFAttributes, GetDouble)
  HRESULT(STDMETHODCALLTYPE *GetDouble)(IMFSpatialAudioSample *This,
                                        REFGUID guidKey,
                                        /* [out] */ double *pfValue);

  DECLSPEC_XFGVIRT(IMFAttributes, GetGUID)
  HRESULT(STDMETHODCALLTYPE *GetGUID)(IMFSpatialAudioSample *This,
                                      REFGUID guidKey,
                                      /* [out] */ GUID *pguidValue);

  DECLSPEC_XFGVIRT(IMFAttributes, GetStringLength)
  HRESULT(STDMETHODCALLTYPE *GetStringLength)(IMFSpatialAudioSample *This,
                                              REFGUID guidKey,
  ...
  HRESULT(STDMETHODCALLTYPE *GetBlobSize)(IMFSpatialAudioSample *This,
                                          REFGUID guidKey,
  ...
  HRESULT(STDMETHODCALLTYPE *GetUnknown)(IMFSpatialAudioSample *This,
                                         REFGUID guidKey, REFIID riid,
                                         /* [iid_is][out] */ LPVOID *ppv);

  DECLSPEC_XFGVIRT(IMFAttributes, SetItem)
  HRESULT(STDMETHODCALLTYPE *SetItem)(IMFSpatialAudioSample *This,
                                      REFGUID guidKey, REFPROPVARIANT Value);

  DECLSPEC_XFGVIRT(IMFAttributes, DeleteItem)
  HRESULT(STDMETHODCALLTYPE *DeleteItem)(IMFSpatialAudioSample *This,
                                         REFGUID guidKey);

  DECLSPEC_XFGVIRT(IMFAttributes, DeleteAllItems)
  HRESULT(STDMETHODCALLTYPE *DeleteAllItems)(IMFSpatialAudioSample *This);

  DECLSPEC_XFGVIRT(IMFAttributes, SetUINT32)
  HRESULT(STDMETHODCALLTYPE *SetUINT32)(IMFSpatialAudioSample *This,
                                        REFGUID guidKey, UINT32 unValue);

  DECLSPEC_XFGVIRT(IMFAttributes, SetUINT64)
  HRESULT(STDMETHODCALLTYPE *SetUINT64)(IMFSpatialAudioSample *This,
                                        REFGUID guidKey, UINT64 unValue);

  DECLSPEC_XFGVIRT(IMFAttributes, SetDouble)
  HRESULT(STDMETHODCALLTYPE *SetDouble)(IMFSpatialAudioSample *This,
                                        REFGUID guidKey, double fValue);

  DECLSPEC_XFGVIRT(IMFAttributes, SetGUID)
  HRESULT(STDMETHODCALLTYPE *SetGUID)(IMFSpatialAudioSample *This,
                                      REFGUID guidKey, REFGUID guidValue);

  DECLSPEC_XFGVIRT(IMFAttributes, SetString)
  HRESULT(STDMETHODCALLTYPE *SetString)(IMFSpatialAudioSample *This,
                                        REFGUID guidKey,
                                        /* [string][in] */ LPCWSTR wszValue);

  DECLSPEC_XFGVIRT(IMFAttributes, SetBlob)
  HRESULT(STDMETHODCALLTYPE *SetBlob)(IMFSpatialAudioSample *This,
                                      REFGUID guidKey,
                                      /* [size_is][in] */ const UINT8 *pBuf,
                                      UINT32 cbBufSize);

  DECLSPEC_XFGVIRT(IMFAttributes, SetUnknown)
  HRESULT(STDMETHODCALLTYPE *SetUnknown)(IMFSpatialAudioSample *This,
                                         REFGUID guidKey,
                                         /* [in] */ IUnknown *pUnknown);

  DECLSPEC_XFGVIRT(IMFAttributes, LockStore)
  HRESULT(STDMETHODCALLTYPE *LockStore)(IMFSpatialAudioSample *This);

  DECLSPEC_XFGVIRT(IMFAttributes, UnlockStore)
  HRESULT(STDMETHODCALLTYPE *UnlockStore)(IMFSpatialAudioSample *This);

  DECLSPEC_XFGVIRT(IMFAttributes, GetCount)
  HRESULT(STDMETHODCALLTYPE *GetCount)(IMFSpatialAudioSample *This,
                                       /* [out] */ UINT32 *pcItems);

  DECLSPEC_XFGVIRT(IMFAttributes, GetItemByIndex)
  HRESULT(STDMETHODCALLTYPE *GetItemByIndex)(
      IMFSpatialAudioSample *This, UINT32 unIndex,
      /* [out] */ GUID *pguidKey,
      /* [full][out][in] */ PROPVARIANT *pValue);

  DECLSPEC_XFGVIRT(IMFAttributes, CopyAllItems)
  HRESULT(STDMETHODCALLTYPE *CopyAllItems)(IMFSpatialAudioSample *This,
                                           /* [in] */ IMFAttributes *pDest);

  DECLSPEC_XFGVIRT(IMFSample, GetSampleFlags)
  HRESULT(STDMETHODCALLTYPE *GetSampleFlags)(IMFSpatialAudioSample *This,
                                             /* [annotation][out] */
                                             _Out_ DWORD *pdwSampleFlags);

  DECLSPEC_XFGVIRT(IMFSample, SetSampleFlags)
  HRESULT(STDMETHODCALLTYPE *SetSampleFlags)(IMFSpatialAudioSample *This,
                                             /* [in] */ DWORD dwSampleFlags);

  DECLSPEC_XFGVIRT(IMFSample, GetSampleTime)
  HRESULT(STDMETHODCALLTYPE *GetSampleTime)(IMFSpatialAudioSample *This,
                                            /* [annotation][out] */
                                            _Out_ LONGLONG *phnsSampleTime);

  DECLSPEC_XFGVIRT(IMFSample, SetSampleTime)
  HRESULT(STDMETHODCALLTYPE *SetSampleTime)(IMFSpatialAudioSample *This,
  ...
  HRESULT(STDMETHODCALLTYPE *GetBufferCount)(IMFSpatialAudioSample *This,
                                             /* [annotation][out] */
                                             _Out_ DWORD *pdwBufferCount);

  DECLSPEC_XFGVIRT(IMFSample, GetBufferByIndex)
  HRESULT(STDMETHODCALLTYPE *GetBufferByIndex)(IMFSpatialAudioSample *This,
                                               /* [in] */ DWORD dwIndex,
                                               /* [annotation][out] */
  ...
  HRESULT(STDMETHODCALLTYPE *AddBuffer)(IMFSpatialAudioSample *This,
                                        /* [in] */ IMFMediaBuffer *pBuffer);

  DECLSPEC_XFGVIRT(IMFSample, RemoveBufferByIndex)
  HRESULT(STDMETHODCALLTYPE *RemoveBufferByIndex)(IMFSpatialAudioSample *This,
                                                  /* [in] */ DWORD dwIndex);

  DECLSPEC_XFGVIRT(IMFSample, RemoveAllBuffers)
  HRESULT(STDMETHODCALLTYPE *RemoveAllBuffers)(IMFSpatialAudioSample *This);

  DECLSPEC_XFGVIRT(IMFSample, GetTotalLength)
  HRESULT(STDMETHODCALLTYPE *GetTotalLength)(IMFSpatialAudioSample *This,
                                             /* [annotation][out] */
                                             _Out_ DWORD *pcbTotalLength);

  DECLSPEC_XFGVIRT(IMFSample, CopyToBuffer)
  HRESULT(STDMETHODCALLTYPE *CopyToBuffer)(IMFSpatialAudioSample *This,
                                           /* [in] */ IMFMediaBuffer *pBuffer);

  DECLSPEC_XFGVIRT(IMFSpatialAudioSample, GetObjectCount)
  HRESULT(STDMETHODCALLTYPE *GetObjectCount)(IMFSpatialAudioSample *This,
                                             /* [annotation][out] */
...
#define IMFSpatialAudioSample_AddRef(This) ((This)->lpVtbl->AddRef(This))

#define IMFSpatialAudioSample_Release(This) ((This)->lpVtbl->Release(This))
...
#define IMFSpatialAudioSample_GetString(This, guidKey, pwszValue, cchBufSize,  \
                                        pcchLength)                            \
  ((This)->lpVtbl->GetString(This, guidKey, pwszValue, cchBufSize, pcchLength))

#define IMFSpatialAudioSample_GetAllocatedString(This, guidKey, ppwszValue,    \
                                                 pcchLength)                   \
...
#define IMFSpatialAudioSample_GetBlob(This, guidKey, pBuf, cbBufSize,          \
                                      pcbBlobSize)                             \
...
#define IMFSpatialAudioSample_LockStore(This) ((This)->lpVtbl->LockStore(This))
...
#define IMFSpatialAudioSample_GetSpatialAudioObjectByIndex(This, dwIndex,      \
                                                           ppAudioObjBuffer)   \
  ((This)->lpVtbl->GetSpatialAudioObjectByIndex(This, dwIndex,                 \
                                                ppAudioObjBuffer))
