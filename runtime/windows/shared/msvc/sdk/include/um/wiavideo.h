...
public:
  ...
  virtual /* [helpstring][id] */ HRESULT STDMETHODCALLTYPE DestroyVideo(
      void) = 0;
...
typedef struct IWiaVideoVtbl {
  ...
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in IWiaVideo *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IWiaVideo *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IWiaVideo *This);

  DECLSPEC_XFGVIRT(IWiaVideo, get_PreviewVisible)
  /* [helpstring][id][propget] */ HRESULT(
      STDMETHODCALLTYPE *get_PreviewVisible)(
...
interface IWiaVideo { CONST_VTBL struct IWiaVideoVtbl *lpVtbl; };
...
class DECLSPEC_UUID("3908C3CD-4478-4536-AF2F-10C25D4EF89A") WiaVideo;
#endif
