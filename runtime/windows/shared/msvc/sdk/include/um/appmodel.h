...
WINBASEAPI
_Success_(return == ERROR_SUCCESS) LONG WINAPI
    GetCurrentPackageId(_Inout_ UINT32 *bufferLength,
                        _Out_writes_bytes_opt_(*bufferLength) BYTE *buffer);

WINBASEAPI
_Success_(return == ERROR_SUCCESS) LONG WINAPI
    GetCurrentPackageFullName(_Inout_ UINT32 *packageFullNameLength,
                              _Out_writes_opt_(*packageFullNameLength)
                                  PWSTR packageFullName);

WINBASEAPI
_Success_(return == ERROR_SUCCESS) LONG WINAPI
    GetCurrentPackageFamilyName(_Inout_ UINT32 *packageFamilyNameLength,
                                _Out_writes_opt_(*packageFamilyNameLength)
                                    PWSTR packageFamilyName);

WINBASEAPI
_Success_(return == ERROR_SUCCESS) LONG WINAPI
    GetCurrentPackagePath(_Inout_ UINT32 *pathLength,
                          _Out_writes_opt_(*pathLength) PWSTR path);

WINBASEAPI
_Success_(return == ERROR_SUCCESS) LONG WINAPI
    GetPackageId(_In_ HANDLE hProcess, _Inout_ UINT32 *bufferLength,
                 _Out_writes_bytes_opt_(*bufferLength) BYTE *buffer);

WINBASEAPI
_Success_(return == ERROR_SUCCESS) LONG WINAPI
    GetPackageFullName(_In_ HANDLE hProcess,
...
_Check_return_ _Success_(return == ERROR_SUCCESS) LONG WINAPI
    GetPackageFullNameFromToken(_In_ HANDLE token,
                                _Inout_ UINT32 *packageFullNameLength,
                                _Out_writes_opt_(*packageFullNameLength)
                                    PWSTR packageFullName);
...
WINBASEAPI
_Success_(return == ERROR_SUCCESS) LONG WINAPI
    GetPackageFamilyName(_In_ HANDLE hProcess,
...
WINBASEAPI
_Check_return_ _Success_(return == ERROR_SUCCESS) LONG WINAPI
    GetPackageFamilyNameFromToken(_In_ HANDLE token,
                                  _Inout_ UINT32 *packageFamilyNameLength,
                                  _Out_writes_opt_(*packageFamilyNameLength)
                                      PWSTR packageFamilyName);
...
WINBASEAPI
_Success_(return == ERROR_SUCCESS) LONG WINAPI
    GetPackagePath(_In_ const PACKAGE_ID *packageId,
                   _Reserved_ const UINT32 reserved, _Inout_ UINT32 *pathLength,
                   _Out_writes_opt_(*pathLength) PWSTR path);

WINBASEAPI
_Success_(return == ERROR_SUCCESS) LONG WINAPI
    GetPackagePathByFullName(_In_ PCWSTR packageFullName,
                             _Inout_ UINT32 *pathLength,
                             _Out_writes_opt_(*pathLength) PWSTR path);

WINBASEAPI
_Success_(return == ERROR_SUCCESS) LONG WINAPI
    GetStagedPackagePathByFullName(_In_ PCWSTR packageFullName,
                                   _Inout_ UINT32 *pathLength,
                                   _Out_writes_opt_(*pathLength) PWSTR path);
...
WINBASEAPI
_Success_(return == ERROR_SUCCESS) LONG WINAPI
    GetPackagePathByFullName2(_In_ PCWSTR packageFullName,
...
WINBASEAPI
_Success_(return == ERROR_SUCCESS) LONG WINAPI
    GetStagedPackagePathByFullName2(_In_ PCWSTR packageFullName,
                                    _In_ PackagePathType packagePathType,
                                    _Inout_ UINT32 *pathLength,
                                    _Out_writes_opt_(*pathLength) PWSTR path);
...
WINBASEAPI
_Success_(return == ERROR_SUCCESS) LONG WINAPI
    GetCurrentPackageInfo2(_In_ const UINT32 flags,
                           _In_ PackagePathType packagePathType,
...
WINBASEAPI
_Success_(return == ERROR_SUCCESS) LONG WINAPI
    GetCurrentPackagePath2(_In_ PackagePathType packagePathType,
                           _Inout_ UINT32 *pathLength,
                           _Out_writes_opt_(*pathLength) PWSTR path);
...
WINBASEAPI
_Success_(return == ERROR_SUCCESS) LONG WINAPI GetCurrentApplicationUserModelId(
    _Inout_ UINT32 *applicationUserModelIdLength,
    _Out_writes_opt_(*applicationUserModelIdLength)
        PWSTR applicationUserModelId);

WINBASEAPI
_Success_(return == ERROR_SUCCESS) LONG WINAPI
    GetApplicationUserModelId(_In_ HANDLE hProcess,
                              _Inout_ UINT32 *applicationUserModelIdLength,
                              _Out_writes_opt_(*applicationUserModelIdLength)
                                  PWSTR applicationUserModelId);
...
_Check_return_ _Success_(return == ERROR_SUCCESS) LONG WINAPI
    GetApplicationUserModelIdFromToken(
        _In_ HANDLE token, _Inout_ UINT32 *applicationUserModelIdLength,
        _Out_writes_opt_(*applicationUserModelIdLength)
            PWSTR applicationUserModelId);
...
WINBASEAPI
_Check_return_ _Success_(return == ERROR_SUCCESS) LONG WINAPI
    VerifyPackageFullName(_In_ PCWSTR packageFullName);

WINBASEAPI
_Check_return_ _Success_(return == ERROR_SUCCESS) LONG WINAPI
    VerifyPackageFamilyName(_In_ PCWSTR packageFamilyName);

WINBASEAPI
_Check_return_ _Success_(return == ERROR_SUCCESS) LONG WINAPI
    VerifyPackageId(_In_ const PACKAGE_ID *packageId);

WINBASEAPI
_Check_return_ _Success_(return == ERROR_SUCCESS) LONG WINAPI
    VerifyApplicationUserModelId(_In_ PCWSTR applicationUserModelId);
...
WINBASEAPI
_Check_return_ _Success_(return == ERROR_SUCCESS) LONG WINAPI
    PackageIdFromFullName(_In_ PCWSTR packageFullName, _In_ const UINT32 flags,
                          _Inout_ UINT32 *bufferLength,
                          _Out_writes_bytes_opt_(*bufferLength) BYTE *buffer);

WINBASEAPI
_Check_return_ _Success_(return == ERROR_SUCCESS) LONG WINAPI
    PackageFullNameFromId(_In_ const PACKAGE_ID *packageId,
                          _Inout_ UINT32 *packageFullNameLength,
                          _Out_writes_opt_(*packageFullNameLength)
                              PWSTR packageFullName);
...
WINBASEAPI
_Check_return_ _Success_(return == ERROR_SUCCESS) LONG WINAPI
    PackageFamilyNameFromId(_In_ const PACKAGE_ID *packageId,
                            _Inout_ UINT32 *packageFamilyNameLength,
                            _Out_writes_opt_(*packageFamilyNameLength)
                                PWSTR packageFamilyName);
...
WINBASEAPI
_Check_return_ _Success_(return == ERROR_SUCCESS) LONG WINAPI
    PackageFamilyNameFromFullName(_In_ PCWSTR packageFullName,
                                  _Inout_ UINT32 *packageFamilyNameLength,
                                  _Out_writes_opt_(*packageFamilyNameLength)
                                      PWSTR packageFamilyName);
...
_Check_return_ _Success_(return == ERROR_SUCCESS) LONG WINAPI
    PackageNameAndPublisherIdFromFamilyName(
        _In_ PCWSTR packageFamilyName, _Inout_ UINT32 *packageNameLength,
...
WINBASEAPI
_Check_return_ _Success_(return == ERROR_SUCCESS) LONG WINAPI
    FormatApplicationUserModelId(_In_ PCWSTR packageFamilyName,
                                 _In_ PCWSTR packageRelativeApplicationId,
                                 _Inout_ UINT32 *applicationUserModelIdLength,
                                 _Out_writes_opt_(*applicationUserModelIdLength)
                                     PWSTR applicationUserModelId);
...
_Check_return_ _Success_(return == ERROR_SUCCESS) LONG WINAPI
    ParseApplicationUserModelId(
        ...
        _Out_writes_opt_(*packageRelativeApplicationIdLength)
...
_Check_return_ _Success_(return == ERROR_SUCCESS)
    _On_failure_(_Unchanged_(*count))
        _On_failure_(_Unchanged_(*bufferLength)) LONG WINAPI
    GetPackagesByPackageFamily(_In_ PCWSTR packageFamilyName,
...
_Check_return_ _Success_(return == ERROR_SUCCESS)
    ...
    FindPackagesByPackageFamily(
        _In_ PCWSTR packageFamilyName, _In_ UINT32 packageFilters,
        _Inout_ UINT32 *count, _Out_writes_opt_(*count) PWSTR *packageFullNames,
        _Inout_ UINT32 *bufferLength,
        _Out_writes_opt_(*bufferLength) WCHAR *buffer,
...
WINBASEAPI
_Check_return_ _Success_(return == ERROR_SUCCESS) LONG WINAPI
    GetStagedPackageOrigin(_In_ PCWSTR packageFullName,
...
// Use PACKAGE_FILTER_HEAD|PACKAGE_FILTER_DIRECT instead of
...
WINBASEAPI
_Success_(return == ERROR_SUCCESS) LONG WINAPI
    GetCurrentPackageInfo(_In_ const UINT32 flags, _Inout_ UINT32 *bufferLength,
                          _Out_writes_bytes_opt_(*bufferLength) BYTE *buffer,
                          _Out_opt_ UINT32 *count);

WINBASEAPI
_Success_(return == ERROR_SUCCESS) LONG WINAPI OpenPackageInfoByFullName(
    _In_ PCWSTR packageFullName, _Reserved_ const UINT32 reserved,
...
_Check_return_ _Success_(return == ERROR_SUCCESS) LONG WINAPI
    OpenPackageInfoByFullNameForUser(
        _In_opt_ PSID userSid, _In_ PCWSTR packageFullName,
        _Reserved_ const UINT32 reserved,
        _Out_ PACKAGE_INFO_REFERENCE *packageInfoReference);

WINBASEAPI
_Success_(return == ERROR_SUCCESS) LONG WINAPI
    ClosePackageInfo(_In_ PACKAGE_INFO_REFERENCE packageInfoReference);

WINBASEAPI
_Success_(return == ERROR_SUCCESS) LONG WINAPI
    GetPackageInfo(_In_ PACKAGE_INFO_REFERENCE packageInfoReference,
                   _In_ const UINT32 flags, _Inout_ UINT32 *bufferLength,
                   _Out_writes_bytes_opt_(*bufferLength) BYTE *buffer,
                   _Out_opt_ UINT32 *count);

WINBASEAPI
_Success_(return == ERROR_SUCCESS) LONG WINAPI
    GetPackageApplicationIds(_In_ PACKAGE_INFO_REFERENCE packageInfoReference,
                             _Inout_ UINT32 *bufferLength,
                             _Out_writes_bytes_opt_(*bufferLength) BYTE *buffer,
                             _Out_opt_ UINT32 *count);
...
WINBASEAPI
_Success_(return == ERROR_SUCCESS) LONG WINAPI
    GetPackageInfo2(_In_ PACKAGE_INFO_REFERENCE packageInfoReference,
...
WINBASEAPI
_Check_return_ HRESULT WINAPI CheckIsMSIXPackage(_In_ PCWSTR packageFullName,
...
///       as long as there's another package that satisfies the
///       PackageDependency. For example, if Fwk-v1 is installed and a
///       PackageDependency specifies MinVersion=1 and then Fwk-v2 is installed,
///       Deployment could remove Fwk-v1 because Fwk-v2 will satisfy the
///       PackageDependency. After Fwk-v1 is removed Deployment won't remove
///       Fwk-v2 because it's the only package satisfying the PackageDependency.
///       Thus Fwk-v1 and Fwk-v2 (and any other package matching the
///       PackageDependency) are 'loosely pinned'. Deployment guarantees it
///       won't remove a package if it would make a PackageDependency
///       unsatisfied.
///
/// A PackageDependency specifies criteria (package family, minimum version,
/// etc) and not a specific package. Deployment reserves the right to use a
/// different package (e.g. higher version) to satisfy the PackageDependency
/// if/when one becomes available.
///
/// @param user the user scope of the package dependency. If NULL the caller's
///        user context is used. MUST be NULL if
///        CreatePackageDependencyOptions_ScopeIsSystem is specified
/// @param lifetimeArtifact MUST be NULL if
/// lifetimeKind=PackageDependencyLifetimeKind_Process
/// @param packageDependencyId allocated via HeapAlloc; use HeapFree to
/// deallocate
///
/// @note TryCreatePackageDependency() fails if the PackageDependency cannot be
/// resolved to a specific
///       package. This package resolution check is skipped if
///       CreatePackageDependencyOptions_DoNotVerifyDependencyResolution is
///       specified. This is useful for installers running as user contexts
///       other than the target user (e.g. installers running as LocalSystem).
/// @see TryCreatePackageDependency2
WINBASEAPI
HRESULT
WINAPI
TryCreatePackageDependency(
    PSID user, _In_ PCWSTR packageFamilyName, PACKAGE_VERSION minVersion,
    PackageDependencyProcessorArchitectures
        packageDependencyProcessorArchitectures,
...
/// deallocate
///
/// @note TryCreatePackageDependency2() fails if the PackageDependency cannot be
/// resolved to a specific
///       package. This package resolution check is skipped if
///       CreatePackageDependencyOptions_DoNotVerifyDependencyResolution is
///       specified. This is useful for installers running as user contexts
...
/// Undefine a package dependency. Removing a pin on a PackageDependency is
/// typically done at uninstall-time. This implicitly occurs if the package
/// dependency's 'lifetime artifact' (specified via TryCreatePackageDependency)
/// is deleted. Packages that are not referenced by other packages and have no
/// pins are elegible to be removed.
///
/// @warn DeletePackageDependency() requires the caller have administrative
/// privileges
///       if the package dependency was pinned with
///       CreatePackageDependencyOptions_ScopeIsSystem.
WINBASEAPI
HRESULT
WINAPI
DeletePackageDependency(_In_ PCWSTR packageDependencyId);
...
/// the package dependency stays resolved for that user until the last reference
/// across all processes for that user is removed via RemovePackageDependency
/// (or process termination).
///
/// AddPackageDependency() adds the resolved package to the caller's package
/// graph, per the rank specified. A process' package graph is a list of
/// packages sorted by rank in ascending order (-infinity...0...+infinity). If
/// package(s) are present in the package graph with the same rank as the call
/// to AddPackageDependency the resolved package is (by default) added after
/// others of the same rank. To add a package before others o the same rank,
/// specify AddPackageDependencyOptions_PrependIfRankCollision.
///
/// Every AddPackageDependency can be balanced by a RemovePackageDependency
/// to remove the entry from the package graph. If the process terminates all
/// package references are removed, but any pins stay behind.
///
...
///
/// @param packageDependencyContext valid until passed to
...
HRESULT
WINAPI
AddPackageDependency(_In_ PCWSTR packageDependencyId, INT32 rank,
...
/// (or process termination).
///
/// AddPackageDependency2() adds the resolved package to the caller's package
/// graph, per the rank specified. A process' package graph is a list of
/// packages sorted by rank in ascending order (-infinity...0...+infinity). If
/// package(s) are present in the package graph with the same rank as the call
/// to AddPackageDependency2 the resolved package is (by default) added after
/// others of the same rank. To add a package before others o the same rank,
/// specify AddPackageDependencyOptions2_PrependIfRankCollision.
///
...
HRESULT
WINAPI
AddPackageDependency2(_In_ PCWSTR packageDependencyId, INT32 rank,
...
///
/// @param packageFullName allocated via HeapAlloc; use HeapFree to deallocate.
///                        If the package dependency cannot be resolved the
///                        function succeeds but packageFullName is NULL.
...
///
/// @param packageFullName allocated via HeapAlloc; use HeapFree to deallocate.
/// @return E_INVALIDARG if packageDependencyId is not a valid package
/// dependency.
...
/// @param packageDependencyId allocated via HeapAlloc; use HeapFree to
/// deallocate.
///                            If the package dependency context cannot be
///                            resolved the function succeeds but
///                            packageDependencyId is NULL.
WINBASEAPI
HRESULT
WINAPI
...
typedef struct FindPackageDependencyCriteria {
  ...
  /// Match package dependencies for the current user if NULL (and
  /// ScopeIsSystem=FALSE).
  /// @note This MUST be NULL if ScopeIsSystem=TRUE.
  /// @note Admin privilege is required if User is not NULL and not the current
  /// user.
  PSID User;

  /// Match package dependencies created with
  /// CreatePackageDependencyOptions_ScopeIsSystem this is TRUE.
  /// @note Admin privilege is required if ScopeIsSystem is TRUE.
  BOOL ScopeIsSystem;

  /// Match package dependencies with this package family. Ignore if NULL or
  /// empty ("").
...
/// @param packageDependencyIds allocated via HeapAlloc; use HeapFree to
/// deallocate
///
...
FindPackageDependency(
    ...
    _Outptr_result_buffer_maybenull_(*packageDependencyIdsCount)
...
/// @param lifetimeExpiration if specified, the value is zero if expiration date
/// is not set.
/// @note Admin privilege is required the package dependency was created with
/// CreatePackageDependencyOptions_ScopeIsSystem or user is not NULL and not the
/// current user.
...
GetPackageDependencyInformation(
    _In_ PCWSTR packageDependencyId, _Outptr_opt_result_maybenull_ PSID *user,
    _Outptr_opt_result_maybenull_ PWSTR *packageFamilyName,
    _Out_opt_ PACKAGE_VERSION *minVersion,
    _Out_opt_ PackageDependencyProcessorArchitectures
        *packageDependencyProcessorArchitectures,
...
/// @note Admin privilege is required if scopeIsSystem=TRUE or user is not NULL
...
GetProcessesUsingPackageDependency(
    _In_ PCWSTR packageDependencyId, _In_opt_ PSID user,
    _In_ BOOL scopeIsSystem, _Out_ UINT32 *processIdsCount,
...
WINBASEAPI
_Check_return_ _Success_(return == ERROR_SUCCESS) LONG WINAPI
    AppPolicyGetLifecycleManagement(_In_ HANDLE processToken,
...
WINBASEAPI
_Check_return_ _Success_(return == ERROR_SUCCESS) LONG WINAPI
    AppPolicyGetWindowingModel(_In_ HANDLE processToken,
...
WINBASEAPI
_Check_return_ _Success_(return == ERROR_SUCCESS) LONG WINAPI
    AppPolicyGetClrCompat(_In_ HANDLE processToken,
...
WINBASEAPI
_Check_return_ _Success_(return == ERROR_SUCCESS) LONG WINAPI
    AppPolicyGetCreateFileAccess(_In_ HANDLE processToken,
