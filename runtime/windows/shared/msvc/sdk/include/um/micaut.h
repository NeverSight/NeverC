...
typedef /* [public][uuid] */ DECLSPEC_UUID(
    "D7803AF6-B018-4a42-AE48-"
    "B2D2319BCB05") enum __MIDL___MIDL_itf_micaut_0000_0000_0001 {
...
typedef /* [public][uuid] */ DECLSPEC_UUID(
    "117F1516-9539-4e26-9CCF-"
    "CD7511AE9BF1") enum __MIDL___MIDL_itf_micaut_0000_0000_0002 {
...
typedef struct IMathInputControlVtbl {
  ...
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in IMathInputControl *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IMathInputControl *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IMathInputControl *This);
...
#define IMathInputControl_GetIDsOfNames(This, riid, rgszNames, cNames, lcid,   \
                                        rgDispId)                              \
  ((This)->lpVtbl->GetIDsOfNames(This, riid, rgszNames, cNames, lcid, rgDispId))

#define IMathInputControl_Invoke(This, dispIdMember, riid, lcid, wFlags,       \
...
typedef struct _IMathInputControlEventsVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in _IMathInputControlEvents *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in _IMathInputControlEvents *This);
...
#define _IMathInputControlEvents_GetIDsOfNames(This, riid, rgszNames, cNames,  \
                                               lcid, rgDispId)                 \
  ((This)->lpVtbl->GetIDsOfNames(This, riid, rgszNames, cNames, lcid, rgDispId))

#define _IMathInputControlEvents_Invoke(This, dispIdMember, riid, lcid,        \
...
class DECLSPEC_UUID("C561816C-14D8-4090-830C-98D994B21C7B") MathInputControl;
#endif
