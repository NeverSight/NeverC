 ...
 * Params  : PUINT puiMsh_MsgMouseWheel - address of UINT to contain returned
 * registered wheel message PUINT puiMsh_Msg3DSupport - address of UINT to
 * contain wheel support registered message PUINT puiMsh_MsgScrollLines -
 * address of UINT to contain Scroll lines registered message PBOOL pf3DSupport
 * - address of BOOL to contain returned flag for wheel support active PINT
 * piScrollLines - address of int to contain returned scroll lines Returns :
 * HWND handle to the MsWheel window Note    : The return value for pf3DSupport
 * and piScrollLines is dependant on the POINT32 module.  If POINT32 module is
 * not running then the values returned for these parameters will be FALSE and
 * 3, respectively.
 *********************************************************************/
__inline HWND HwndMSWheel(PUINT puiMsh_MsgMouseWheel, PUINT puiMsh_Msg3DSupport,
