...
extern RPC_IF_HANDLE
    __MIDL_itf_userconsentverifierinterop_0000_0000_v0_0_c_ifspec;
extern RPC_IF_HANDLE
    __MIDL_itf_userconsentverifierinterop_0000_0000_v0_0_s_ifspec;
...
typedef struct IUserConsentVerifierInteropVtbl {
  ...
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(IUserConsentVerifierInterop *This,
                                             /* [in] */ REFIID riid,
  ...
  HRESULT(STDMETHODCALLTYPE *GetIids)(IUserConsentVerifierInterop *This,
                                      /* [out] */ ULONG *iidCount,
  ...
  HRESULT(STDMETHODCALLTYPE *GetTrustLevel)(IUserConsentVerifierInterop *This,
                                            /* [out] */ TrustLevel *trustLevel);

  DECLSPEC_XFGVIRT(IUserConsentVerifierInterop,
...
#define IUserConsentVerifierInterop_AddRef(This) ((This)->lpVtbl->AddRef(This))
...
#define IUserConsentVerifierInterop_RequestVerificationForWindowAsync(         \
    This, appWindow, message, riid, asyncOperation)                            \
  ((This)->lpVtbl->RequestVerificationForWindowAsync(This, appWindow, message, \
                                                     riid, asyncOperation))
...
extern RPC_IF_HANDLE
    __MIDL_itf_userconsentverifierinterop_0000_0001_v0_0_c_ifspec;
extern RPC_IF_HANDLE
    __MIDL_itf_userconsentverifierinterop_0000_0001_v0_0_s_ifspec;
