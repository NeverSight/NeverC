...
typedef struct IWMPServicesVtbl {
  ...
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(IWMPServices *This,
                                             /* [in] */ REFIID riid,
...
interface IWMPServices { CONST_VTBL struct IWMPServicesVtbl *lpVtbl; };
...
EXTERN_GUID(CLSID_WMPMediaPluginRegistrar, 0x5569e7f5, 0x424b, 0x4b93, 0x89,
            0xca, 0x79, 0xd1, 0x79, 0x24, 0x68, 0x9a);
EXTERN_GUID(WMP_PLUGINTYPE_DSP, 0x6434baea, 0x4954, 0x498d, 0xab, 0xd5, 0x2b,
            0x7, 0x12, 0x3e, 0x1f, 0x4);
EXTERN_GUID(WMP_PLUGINTYPE_DSP_OUTOFPROC, 0xef29b174, 0xc347, 0x44cc, 0x9a,
            0x4f, 0x23, 0x99, 0x11, 0x8f, 0xf3, 0x8c);
EXTERN_GUID(WMP_PLUGINTYPE_RENDERING, 0xa8554541, 0x115d, 0x406a, 0xa4, 0xc7,
            0x51, 0x11, 0x1c, 0x33, 0x1, 0x83);
...
public:
  virtual HRESULT STDMETHODCALLTYPE WMPRegisterPlayerPlugin(
      ...
      /* [in] */ LPWSTR pwszUninstallString, DWORD dwPriority,
      GUID guidPluginType, CLSID clsid, UINT cMediaTypes,
      LPVOID pMediaTypes) = 0;

  virtual HRESULT STDMETHODCALLTYPE WMPUnRegisterPlayerPlugin(
      GUID guidPluginType, CLSID clsid) = 0;
};
...
typedef struct IWMPMediaPluginRegistrarVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(IWMPMediaPluginRegistrar *This,
                                             /* [in] */ REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);
  ...
  HRESULT(STDMETHODCALLTYPE *WMPRegisterPlayerPlugin)(
      ...
      /* [in] */ LPWSTR pwszDescription,
      /* [in] */ LPWSTR pwszUninstallString, DWORD dwPriority,
      GUID guidPluginType, CLSID clsid, UINT cMediaTypes, LPVOID pMediaTypes);

  DECLSPEC_XFGVIRT(IWMPMediaPluginRegistrar, WMPUnRegisterPlayerPlugin)
  HRESULT(STDMETHODCALLTYPE *WMPUnRegisterPlayerPlugin)(
      IWMPMediaPluginRegistrar *This, GUID guidPluginType, CLSID clsid);
...
#define IWMPMediaPluginRegistrar_WMPRegisterPlayerPlugin(                      \
    This, pwszFriendlyName, pwszDescription, pwszUninstallString, dwPriority,  \
    guidPluginType, clsid, cMediaTypes, pMediaTypes)                           \
  ((This)->lpVtbl->WMPRegisterPlayerPlugin(                                    \
      This, pwszFriendlyName, pwszDescription, pwszUninstallString,            \
      dwPriority, guidPluginType, clsid, cMediaTypes, pMediaTypes))

#define IWMPMediaPluginRegistrar_WMPUnRegisterPlayerPlugin(                    \
    This, guidPluginType, clsid)                                               \
...
public:
  ...
  virtual /* [helpstring] */ HRESULT STDMETHODCALLTYPE UnAdviseWMPServices(
      void) = 0;
};
...
typedef struct IWMPPluginVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(IWMPPlugin *This,
                                             /* [in] */ REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);
  ...
  /* [helpstring] */ HRESULT(STDMETHODCALLTYPE *Init)(
      IWMPPlugin *This, DWORD_PTR dwPlaybackContext);

  DECLSPEC_XFGVIRT(IWMPPlugin, Shutdown)
  /* [helpstring] */ HRESULT(STDMETHODCALLTYPE *Shutdown)(IWMPPlugin *This);
...
interface IWMPPlugin { CONST_VTBL struct IWMPPluginVtbl *lpVtbl; };
...
typedef struct IWMPPluginEnableVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(IWMPPluginEnable *This,
                                             /* [in] */ REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);
...
interface IWMPPluginEnable { CONST_VTBL struct IWMPPluginEnableVtbl *lpVtbl; };
...
#define IWMPGraphCreation_GraphCreationPreRender(This, pFilterGraph,           \
                                                 pReserved)                    \
...
typedef struct IWMPConvertVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(IWMPConvert *This,
                                             /* [in] */ REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);
  ...
  HRESULT(STDMETHODCALLTYPE *ConvertFile)(IWMPConvert *This,
                                          /* [in] */ BSTR bstrInputFile,
                                          /* [in] */ BSTR bstrDestinationFolder,
                                          /* [out] */ BSTR *pbstrOutputFile);

  DECLSPEC_XFGVIRT(IWMPConvert, GetErrorURL)
  HRESULT(STDMETHODCALLTYPE *GetErrorURL)(IWMPConvert *This,
                                          /* [out] */ BSTR *pbstrURL);

  END_INTERFACE
} IWMPConvertVtbl;

interface IWMPConvert { CONST_VTBL struct IWMPConvertVtbl *lpVtbl; };
...
#define IWMPConvert_ConvertFile(This, bstrInputFile, bstrDestinationFolder,    \
                                pbstrOutputFile)                               \
  ((This)->lpVtbl->ConvertFile(This, bstrInputFile, bstrDestinationFolder,     \
                               pbstrOutputFile))
...
typedef struct IWMPTranscodePolicyVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(IWMPTranscodePolicy *This,
                                             /* [in] */ REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);
...
typedef struct IWMPUserEventSinkVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(IWMPUserEventSink *This,
                                             /* [in] */ REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);
  ...
  HRESULT(STDMETHODCALLTYPE *NotifyUserEvent)(IWMPUserEventSink *This,
                                              /* [in] */ long EventCode);
