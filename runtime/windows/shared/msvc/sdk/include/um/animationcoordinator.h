...
#ifdef __cplusplus
typedef class ShowInputPaneAnimationCoordinator
...
#ifdef __cplusplus
typedef class HideInputPaneAnimationCoordinator
    HideInputPaneAnimationCoordinator;
#else
typedef struct HideInputPaneAnimationCoordinator
    HideInputPaneAnimationCoordinator;
#endif /* __cplusplus */
...
typedef struct IInputPaneAnimationCoordinatorVtbl {
  ...
  ULONG(STDMETHODCALLTYPE *AddRef)(IInputPaneAnimationCoordinator *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(IInputPaneAnimationCoordinator *This);
