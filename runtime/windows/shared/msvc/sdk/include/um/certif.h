...
typedef struct ICertServerPolicyVtbl {
  ...
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in ICertServerPolicy *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in ICertServerPolicy *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in ICertServerPolicy *This);
  ...
  HRESULT(STDMETHODCALLTYPE *SetContext)(__RPC__in ICertServerPolicy *This,
                                         /* [in] */ LONG Context);
...
typedef struct ICertServerExitVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in ICertServerExit *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in ICertServerExit *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in ICertServerExit *This);
  ...
  HRESULT(STDMETHODCALLTYPE *SetContext)(__RPC__in ICertServerExit *This,
                                         /* [in] */ LONG Context);
...
interface ICertServerExit { CONST_VTBL struct ICertServerExitVtbl *lpVtbl; };
