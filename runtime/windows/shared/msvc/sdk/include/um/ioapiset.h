...
WINBASEAPI
_Ret_maybenull_ HANDLE WINAPI CreateIoCompletionPort(
    _In_ HANDLE FileHandle, _In_opt_ HANDLE ExistingCompletionPort,
    _In_ ULONG_PTR CompletionKey, _In_ DWORD NumberOfConcurrentThreads);

WINBASEAPI
BOOL WINAPI GetQueuedCompletionStatus(_In_ HANDLE CompletionPort,
...
BOOL WINAPI GetQueuedCompletionStatusEx(
    ...
    _Out_writes_to_(ulCount, *ulNumEntriesRemoved)
...
WINBASEAPI
BOOL WINAPI PostQueuedCompletionStatus(_In_ HANDLE CompletionPort,
...
WINBASEAPI
BOOL WINAPI
DeviceIoControl(_In_ HANDLE hDevice, _In_ DWORD dwIoControlCode,
                _In_reads_bytes_opt_(nInBufferSize) LPVOID lpInBuffer,
                _In_ DWORD nInBufferSize,
                _Out_writes_bytes_to_opt_(nOutBufferSize, *lpBytesReturned)
                    LPVOID lpOutBuffer,
                _In_ DWORD nOutBufferSize, _Out_opt_ LPDWORD lpBytesReturned,
...
WINBASEAPI
BOOL WINAPI GetOverlappedResult(_In_ HANDLE hFile,
...
WINBASEAPI
BOOL WINAPI GetOverlappedResultEx(_In_ HANDLE hFile,
                                  _In_ LPOVERLAPPED lpOverlapped,
                                  _Out_ LPDWORD lpNumberOfBytesTransferred,
                                  _In_ DWORD dwMilliseconds,
