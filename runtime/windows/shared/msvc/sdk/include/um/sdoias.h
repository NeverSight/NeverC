...
typedef /* [public] */
    enum _ATTRIBUTEID {
      ...
      RADIUS_ATTRIBUTE_FRAMED_IP_ADDRESS =
          (RADIUS_ATTRIBUTE_FRAMED_PROTOCOL + 1),
      RADIUS_ATTRIBUTE_FRAMED_IP_NETMASK =
          (RADIUS_ATTRIBUTE_FRAMED_IP_ADDRESS + 1),
      ...
      RADIUS_ATTRIBUTE_LOGIN_IP_HOST =
          (RADIUS_ATTRIBUTE_FRAMED_COMPRESSION + 1),
      ...
      RADIUS_ATTRIBUTE_CALLING_STATION_ID =
          (RADIUS_ATTRIBUTE_CALLED_STATION_ID + 1),
      RADIUS_ATTRIBUTE_NAS_IDENTIFIER =
          (RADIUS_ATTRIBUTE_CALLING_STATION_ID + 1),
      ...
      RADIUS_ATTRIBUTE_TUNNEL_CLIENT_ENDPT =
          (RADIUS_ATTRIBUTE_TUNNEL_MEDIUM_TYPE + 1),
      RADIUS_ATTRIBUTE_TUNNEL_SERVER_ENDPT =
          (RADIUS_ATTRIBUTE_TUNNEL_CLIENT_ENDPT + 1),
      RADIUS_ATTRIBUTE_ACCT_TUNNEL_CONN =
          (RADIUS_ATTRIBUTE_TUNNEL_SERVER_ENDPT + 1),
      RADIUS_ATTRIBUTE_TUNNEL_PASSWORD =
          (RADIUS_ATTRIBUTE_ACCT_TUNNEL_CONN + 1),
      ...
      IAS_ATTRIBUTE_SAVED_RADIUS_CALLBACK_NUMBER =
          (IAS_ATTRIBUTE_SAVED_RADIUS_FRAMED_IP_ADDRESS + 1),
      IAS_ATTRIBUTE_NP_CALLING_STATION_ID =
          (IAS_ATTRIBUTE_SAVED_RADIUS_CALLBACK_NUMBER + 1),
      IAS_ATTRIBUTE_SAVED_NP_CALLING_STATION_ID =
          (IAS_ATTRIBUTE_NP_CALLING_STATION_ID + 1),
      IAS_ATTRIBUTE_SAVED_RADIUS_FRAMED_ROUTE =
          (IAS_ATTRIBUTE_SAVED_NP_CALLING_STATION_ID + 1),
      IAS_ATTRIBUTE_IGNORE_USER_DIALIN_PROPERTIES =
          (IAS_ATTRIBUTE_SAVED_RADIUS_FRAMED_ROUTE + 1),
      IAS_ATTRIBUTE_NP_TIME_OF_DAY =
          (IAS_ATTRIBUTE_IGNORE_USER_DIALIN_PROPERTIES + 1),
      ...
      IAS_ATTRIBUTE_NP_AUTHENTICATION_TYPE =
          (IAS_ATTRIBUTE_NP_ALLOWED_PORT_TYPES + 1),
      IAS_ATTRIBUTE_NP_ALLOWED_EAP_TYPE =
          (IAS_ATTRIBUTE_NP_AUTHENTICATION_TYPE + 1),
      ...
      IAS_ATTRIBUTE_CLIENT_PACKET_HEADER =
          (IAS_ATTRIBUTE_CLIENT_IP_ADDRESS + 1),
      ...
      IAS_ATTRIBUTE_FULLY_QUALIFIED_USER_NAME =
          (IAS_ATTRIBUTE_NT4_ACCOUNT_NAME + 1),
      ...
      MS_ATTRIBUTE_SECONDARY_NBNS_SERVER =
          (MS_ATTRIBUTE_PRIMARY_NBNS_SERVER + 1),
      IAS_ATTRIBUTE_PROXY_POLICY_NAME =
          (MS_ATTRIBUTE_SECONDARY_NBNS_SERVER + 1),
      ...
      IAS_ATTRIBUTE_USER_TOKEN_GROUPS =
          (IAS_ATTRIBUTE_MACHINE_TOKEN_GROUPS + 1),
      ...
      IAS_ATTRIBUTE_SAVED_RADIUS_FRAMED_IPv6_PREFIX =
          (IAS_ATTRIBUTE_SAVED_RADIUS_FRAMED_INTERFACE_ID + 1),
      IAS_ATTRIBUTE_SAVED_RADIUS_FRAMED_IPv6_ROUTE =
          (IAS_ATTRIBUTE_SAVED_RADIUS_FRAMED_IPv6_PREFIX + 1),
      MS_ATTRIBUTE_QUARANTINE_GRACE_TIME_CONFIGURATION =
          (IAS_ATTRIBUTE_SAVED_RADIUS_FRAMED_IPv6_ROUTE + 1),
      ...
      MS_ATTRIBUTE_IPV6_REMEDIATION_SERVERS =
          (MS_ATTRIBUTE_IPV4_REMEDIATION_SERVERS + 1),
      IAS_ATTRIBUTE_PROXY_RETRY_COUNT =
          (MS_ATTRIBUTE_IPV6_REMEDIATION_SERVERS + 1),
      ...
      IAS_ATTRIBUTE_EAP_TYPES_CONFIGURED_IN_PROXYPOLICY =
          (MS_ATTRIBUTE_QUARANTINE_SOH + 1),
      MS_ATTRIBUTE_HCAP_LOCATION_GROUP_NAME =
          (IAS_ATTRIBUTE_EAP_TYPES_CONFIGURED_IN_PROXYPOLICY + 1),
      MS_ATTRIBUTE_EXTENDED_QUARANTINE_STATE =
          (MS_ATTRIBUTE_HCAP_LOCATION_GROUP_NAME + 1),
      IAS_ATTRIBUTE_SOH_CARRIER_EAPTLV =
          (MS_ATTRIBUTE_EXTENDED_QUARANTINE_STATE + 1),
      MS_ATTRIBUTE_HCAP_USER_GROUPS = 8155,
      IAS_ATTRIBUTE_SAVED_MACHINE_HEALTHCHECK_ONLY =
          (MS_ATTRIBUTE_HCAP_USER_GROUPS + 1),
      IAS_ATTRIBUTE_POLICY_EVALUATED_SHV =
          (IAS_ATTRIBUTE_SAVED_MACHINE_HEALTHCHECK_ONLY + 1),
      MS_ATTRIBUTE_RAS_CORRELATION_ID =
          (IAS_ATTRIBUTE_POLICY_EVALUATED_SHV + 1),
      ...
      MS_ATTRIBUTE_TSG_DEVICE_REDIRECTION =
          (MS_ATTRIBUTE_USER_IPv6_ADDRESS + 1),
      IAS_ATTRIBUTE_ACCEPT_REASON_CODE =
          (MS_ATTRIBUTE_TSG_DEVICE_REDIRECTION + 1),
      ...
      IAS_ATTRIBUTE_RADIUS_USERNAME_ENCODING_ASCII =
          (IAS_ATTRIBUTE_SERVER_IPv6_ADDRESS + 1),
...
typedef /* [public] */
    enum _USERPROPERTIES {
      ...
      PROPERTY_USER_SAVED_CALLING_STATION_ID =
          (PROPERTY_USER_CALLING_STATION_ID + 1),
      PROPERTY_USER_RADIUS_CALLBACK_NUMBER =
          (PROPERTY_USER_SAVED_CALLING_STATION_ID + 1),
      PROPERTY_USER_RADIUS_FRAMED_ROUTE =
          (PROPERTY_USER_RADIUS_CALLBACK_NUMBER + 1),
      PROPERTY_USER_RADIUS_FRAMED_IP_ADDRESS =
          (PROPERTY_USER_RADIUS_FRAMED_ROUTE + 1),
      PROPERTY_USER_SAVED_RADIUS_CALLBACK_NUMBER =
          (PROPERTY_USER_RADIUS_FRAMED_IP_ADDRESS + 1),
      PROPERTY_USER_SAVED_RADIUS_FRAMED_ROUTE =
          (PROPERTY_USER_SAVED_RADIUS_CALLBACK_NUMBER + 1),
      PROPERTY_USER_SAVED_RADIUS_FRAMED_IP_ADDRESS =
          (PROPERTY_USER_SAVED_RADIUS_FRAMED_ROUTE + 1),
      PROPERTY_USER_ALLOW_DIALIN =
          (PROPERTY_USER_SAVED_RADIUS_FRAMED_IP_ADDRESS + 1),
      ...
      PROPERTY_USER_SAVED_RADIUS_FRAMED_IPV6_ROUTE =
          (PROPERTY_USER_RADIUS_FRAMED_IPV6_ROUTE + 1),
      PROPERTY_USER_RADIUS_FRAMED_INTERFACE_ID =
          (PROPERTY_USER_SAVED_RADIUS_FRAMED_IPV6_ROUTE + 1),
      PROPERTY_USER_SAVED_RADIUS_FRAMED_INTERFACE_ID =
          (PROPERTY_USER_RADIUS_FRAMED_INTERFACE_ID + 1),
      PROPERTY_USER_RADIUS_FRAMED_IPV6_PREFIX =
          (PROPERTY_USER_SAVED_RADIUS_FRAMED_INTERFACE_ID + 1),
      PROPERTY_USER_SAVED_RADIUS_FRAMED_IPV6_PREFIX =
          (PROPERTY_USER_RADIUS_FRAMED_IPV6_PREFIX + 1)
    } USERPROPERTIES;
...
typedef /* [public] */
    enum _DICTIONARYPROPERTIES {
      ...
      PROPERTY_DICTIONARY_LOCATION =
          (PROPERTY_DICTIONARY_ATTRIBUTES_COLLECTION + 1)
...
typedef /* [public] */
    enum _ATTRIBUTEPROPERTIES {
      ...
      PROPERTY_ATTRIBUTE_IS_ENUMERABLE =
          (PROPERTY_ATTRIBUTE_VENDOR_TYPE_ID + 1),
...
typedef /* [public] */
    enum _IASPROPERTIES {
      ...
      PROPERTY_IAS_POLICIES_COLLECTION =
          (PROPERTY_IAS_RADIUSSERVERGROUPS_COLLECTION + 1),
      PROPERTY_IAS_PROFILES_COLLECTION = (PROPERTY_IAS_POLICIES_COLLECTION + 1),
      PROPERTY_IAS_PROTOCOLS_COLLECTION =
          (PROPERTY_IAS_PROFILES_COLLECTION + 1),
      PROPERTY_IAS_AUDITORS_COLLECTION =
          (PROPERTY_IAS_PROTOCOLS_COLLECTION + 1),
      PROPERTY_IAS_REQUESTHANDLERS_COLLECTION =
          (PROPERTY_IAS_AUDITORS_COLLECTION + 1),
      PROPERTY_IAS_PROXYPOLICIES_COLLECTION =
          (PROPERTY_IAS_REQUESTHANDLERS_COLLECTION + 1),
      PROPERTY_IAS_PROXYPROFILES_COLLECTION =
          (PROPERTY_IAS_PROXYPOLICIES_COLLECTION + 1),
      PROPERTY_IAS_REMEDIATIONSERVERGROUPS_COLLECTION =
          (PROPERTY_IAS_PROXYPROFILES_COLLECTION + 1),
      PROPERTY_IAS_SHVTEMPLATES_COLLECTION =
          (PROPERTY_IAS_REMEDIATIONSERVERGROUPS_COLLECTION + 1)
    } IASPROPERTIES;
...
typedef /* [public] */
    enum _TEMPLATESPROPERTIES {
      ...
      PROPERTY_TEMPLATES_PROFILES_TEMPLATES =
          (PROPERTY_TEMPLATES_POLICIES_TEMPLATES + 1),
      PROPERTY_TEMPLATES_PROFILES_COLLECTION =
          (PROPERTY_TEMPLATES_PROFILES_TEMPLATES + 1),
      PROPERTY_TEMPLATES_PROXYPOLICIES_TEMPLATES =
          (PROPERTY_TEMPLATES_PROFILES_COLLECTION + 1),
      PROPERTY_TEMPLATES_PROXYPROFILES_TEMPLATES =
          (PROPERTY_TEMPLATES_PROXYPOLICIES_TEMPLATES + 1),
      PROPERTY_TEMPLATES_PROXYPROFILES_COLLECTION =
          (PROPERTY_TEMPLATES_PROXYPROFILES_TEMPLATES + 1),
      PROPERTY_TEMPLATES_REMEDIATIONSERVERGROUPS_TEMPLATES =
          (PROPERTY_TEMPLATES_PROXYPROFILES_COLLECTION + 1),
      PROPERTY_TEMPLATES_SHVTEMPLATES_TEMPLATES =
          (PROPERTY_TEMPLATES_REMEDIATIONSERVERGROUPS_TEMPLATES + 1),
      PROPERTY_TEMPLATES_CLIENTS_TEMPLATES =
          (PROPERTY_TEMPLATES_SHVTEMPLATES_TEMPLATES + 1),
      PROPERTY_TEMPLATES_RADIUSSERVERS_TEMPLATES =
          (PROPERTY_TEMPLATES_CLIENTS_TEMPLATES + 1),
      PROPERTY_TEMPLATES_SHAREDSECRETS_TEMPLATES =
          (PROPERTY_TEMPLATES_RADIUSSERVERS_TEMPLATES + 1),
      PROPERTY_TEMPLATES_IPFILTERS_TEMPLATES =
          (PROPERTY_TEMPLATES_SHAREDSECRETS_TEMPLATES + 1)
    } TEMPLATESPROPERTIES;
...
typedef /* [public] */
    enum _PROFILEPROPERTIES {
      ...
      PROPERTY_PROFILE_IPFILTER_TEMPLATE_GUID =
          (PROPERTY_PROFILE_ATTRIBUTES_COLLECTION + 1)
    } PROFILEPROPERTIES;
...
typedef /* [public] */
    enum _RADIUSSERVERPROPERTIES {
      ...
      PROPERTY_RADIUSSERVER_FORWARD_ACCT_ONOFF =
          (PROPERTY_RADIUSSERVER_ADDRESS + 1),
      PROPERTY_RADIUSSERVER_PRIORITY =
          (PROPERTY_RADIUSSERVER_FORWARD_ACCT_ONOFF + 1),
      ...
      PROPERTY_RADIUSSERVER_SEND_SIGNATURE =
          (PROPERTY_RADIUSSERVER_BLACKOUT + 1),
      PROPERTY_RADIUSSERVER_AUTH_SECRET_TEMPLATE_GUID =
          (PROPERTY_RADIUSSERVER_SEND_SIGNATURE + 1),
      PROPERTY_RADIUSSERVER_ACCT_SECRET_TEMPLATE_GUID =
          (PROPERTY_RADIUSSERVER_AUTH_SECRET_TEMPLATE_GUID + 1)
...
typedef /* [public] */
    enum _REMEDIATIONSERVERPROPERTIES {
      ...
      PROPERTY_REMEDIATIONSERVER_FRIENDLY_NAME =
          (PROPERTY_REMEDIATIONSERVER_ADDRESS + 1)
...
typedef /* [public] */
    enum _RADIUSPROPERTIES {
      ...
      PROPERTY_RADIUS_AUTHENTICATION_PORT =
          (PROPERTY_RADIUS_ACCOUNTING_PORT + 1),
      PROPERTY_RADIUS_CLIENTS_COLLECTION =
          (PROPERTY_RADIUS_AUTHENTICATION_PORT + 1),
      PROPERTY_RADIUS_VENDORS_COLLECTION =
          (PROPERTY_RADIUS_CLIENTS_COLLECTION + 1)
    } RADIUSPROPERTIES;
...
typedef /* [public] */
    enum _NTEVENTLOGPROPERTIES {
      ...
      PROPERTY_EVENTLOG_LOG_MALFORMED =
          (PROPERTY_EVENTLOG_LOG_APPLICATION_EVENTS + 1),
...
typedef /* [public] */
    enum _ACCOUNTINGPROPERTIES {
      ...
      PROPERTY_ACCOUNTING_LOG_ACCOUNTING_INTERIM =
          (PROPERTY_ACCOUNTING_LOG_ACCOUNTING + 1),
      PROPERTY_ACCOUNTING_LOG_AUTHENTICATION =
          (PROPERTY_ACCOUNTING_LOG_ACCOUNTING_INTERIM + 1),
      PROPERTY_ACCOUNTING_LOG_OPEN_NEW_FREQUENCY =
          (PROPERTY_ACCOUNTING_LOG_AUTHENTICATION + 1),
      PROPERTY_ACCOUNTING_LOG_OPEN_NEW_SIZE =
          (PROPERTY_ACCOUNTING_LOG_OPEN_NEW_FREQUENCY + 1),
      PROPERTY_ACCOUNTING_LOG_FILE_DIRECTORY =
          (PROPERTY_ACCOUNTING_LOG_OPEN_NEW_SIZE + 1),
      PROPERTY_ACCOUNTING_LOG_IAS1_FORMAT =
          (PROPERTY_ACCOUNTING_LOG_FILE_DIRECTORY + 1),
      PROPERTY_ACCOUNTING_LOG_ENABLE_LOGGING =
          (PROPERTY_ACCOUNTING_LOG_IAS1_FORMAT + 1),
      PROPERTY_ACCOUNTING_LOG_DELETE_IF_FULL =
          (PROPERTY_ACCOUNTING_LOG_ENABLE_LOGGING + 1),
      PROPERTY_ACCOUNTING_SQL_MAX_SESSIONS =
          (PROPERTY_ACCOUNTING_LOG_DELETE_IF_FULL + 1),
      PROPERTY_ACCOUNTING_LOG_AUTHENTICATION_INTERIM =
          (PROPERTY_ACCOUNTING_SQL_MAX_SESSIONS + 1),
      PROPERTY_ACCOUNTING_LOG_FILE_IS_BACKUP =
          (PROPERTY_ACCOUNTING_LOG_AUTHENTICATION_INTERIM + 1),
      PROPERTY_ACCOUNTING_DISCARD_REQUEST_ON_FAILURE =
          (PROPERTY_ACCOUNTING_LOG_FILE_IS_BACKUP + 1)
...
typedef /* [public] */
    enum _SHV_COMBINATION_TYPE {
      ...
      SHV_COMBINATION_TYPE_ONE_OR_MORE_FAIL =
          (SHV_COMBINATION_TYPE_ONE_OR_MORE_PASS + 1),
      SHV_COMBINATION_TYPE_ONE_OR_MORE_INFECTED =
          (SHV_COMBINATION_TYPE_ONE_OR_MORE_FAIL + 1),
      SHV_COMBINATION_TYPE_ONE_OR_MORE_TRANSITIONAL =
          (SHV_COMBINATION_TYPE_ONE_OR_MORE_INFECTED + 1),
      SHV_COMBINATION_TYPE_ONE_OR_MORE_UNKNOWN =
          (SHV_COMBINATION_TYPE_ONE_OR_MORE_TRANSITIONAL + 1),
...
typedef struct ISdoMachineVtbl {
  ...
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in ISdoMachine *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in ISdoMachine *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in ISdoMachine *This);
  ...
  /* [id] */ HRESULT(STDMETHODCALLTYPE *Attach)(__RPC__in ISdoMachine *This,
                                                /* [in] */ __RPC__in BSTR
                                                    bstrComputerName);
...
interface ISdoMachine { CONST_VTBL struct ISdoMachineVtbl *lpVtbl; };
...
#define ISdoMachine_GetServiceSDO(This, eDataStore, bstrServiceName,           \
                                  ppServiceSDO)                                \
  ((This)->lpVtbl->GetServiceSDO(This, eDataStore, bstrServiceName,            \
                                 ppServiceSDO))
...
typedef struct ISdoMachine2Vtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in ISdoMachine2 *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in ISdoMachine2 *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in ISdoMachine2 *This);
  ...
  DECLSPEC_XFGVIRT(ISdoMachine, Attach)
  /* [id] */ HRESULT(STDMETHODCALLTYPE *Attach)(__RPC__in ISdoMachine2 *This,
                                                /* [in] */ __RPC__in BSTR
                                                    bstrComputerName);
  ...
  /* [id] */ HRESULT(STDMETHODCALLTYPE *ImportRemoteTemplates)(
      __RPC__in ISdoMachine2 *This, __RPC__in_opt IUnknown *pLocalTemplatesRoot,
      __RPC__in BSTR bstrRemoteMachineName);

  DECLSPEC_XFGVIRT(ISdoMachine2, Reload)
  /* [id] */ HRESULT(STDMETHODCALLTYPE *Reload)(__RPC__in ISdoMachine2 *This);

  END_INTERFACE
} ISdoMachine2Vtbl;

interface ISdoMachine2 { CONST_VTBL struct ISdoMachine2Vtbl *lpVtbl; };
...
#define ISdoMachine2_GetIDsOfNames(This, riid, rgszNames, cNames, lcid,        \
                                   rgDispId)                                   \
  ((This)->lpVtbl->GetIDsOfNames(This, riid, rgszNames, cNames, lcid, rgDispId))

#define ISdoMachine2_Invoke(This, dispIdMember, riid, lcid, wFlags,            \
                            pDispParams, pVarResult, pExcepInfo, puArgErr)     \
  ((This)->lpVtbl->Invoke(This, dispIdMember, riid, lcid, wFlags, pDispParams, \
                          pVarResult, pExcepInfo, puArgErr))
...
#define ISdoMachine2_GetServiceSDO(This, eDataStore, bstrServiceName,          \
                                   ppServiceSDO)                               \
  ((This)->lpVtbl->GetServiceSDO(This, eDataStore, bstrServiceName,            \
                                 ppServiceSDO))
...
#define ISdoMachine2_SyncConfigAgainstTemplates(                               \
    This, bstrServiceName, ppConfigRoot, ppTemplatesRoot, bForcedSync)         \
  ((This)->lpVtbl->SyncConfigAgainstTemplates(                                 \
      This, bstrServiceName, ppConfigRoot, ppTemplatesRoot, bForcedSync))

#define ISdoMachine2_ImportRemoteTemplates(This, pLocalTemplatesRoot,          \
                                           bstrRemoteMachineName)              \
  ((This)->lpVtbl->ImportRemoteTemplates(This, pLocalTemplatesRoot,            \
                                         bstrRemoteMachineName))
...
typedef struct ISdoServiceControlVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in ISdoServiceControl *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in ISdoServiceControl *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in ISdoServiceControl *This);
...
typedef struct ISdoVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in ISdo *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in ISdo *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in ISdo *This);
  ...
  /* [id] */ HRESULT(STDMETHODCALLTYPE *ResetProperty)(__RPC__in ISdo *This,
                                                       /* [in] */ LONG Id);

  DECLSPEC_XFGVIRT(ISdo, Apply)
  /* [id] */ HRESULT(STDMETHODCALLTYPE *Apply)(__RPC__in ISdo *This);

  DECLSPEC_XFGVIRT(ISdo, Restore)
  /* [id] */ HRESULT(STDMETHODCALLTYPE *Restore)(__RPC__in ISdo *This);
...
interface ISdo { CONST_VTBL struct ISdoVtbl *lpVtbl; };
...
typedef struct ISdoCollectionVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in ISdoCollection *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in ISdoCollection *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in ISdoCollection *This);
  ...
  /* [id] */ HRESULT(STDMETHODCALLTYPE *Reload)(__RPC__in ISdoCollection *This);
...
interface ISdoCollection { CONST_VTBL struct ISdoCollectionVtbl *lpVtbl; };
...
typedef struct ITemplateSdoVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in ITemplateSdo *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in ITemplateSdo *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in ITemplateSdo *This);
  ...
  DECLSPEC_XFGVIRT(ISdo, Apply)
  /* [id] */ HRESULT(STDMETHODCALLTYPE *Apply)(__RPC__in ITemplateSdo *This);

  DECLSPEC_XFGVIRT(ISdo, Restore)
  /* [id] */ HRESULT(STDMETHODCALLTYPE *Restore)(__RPC__in ITemplateSdo *This);
...
interface ITemplateSdo { CONST_VTBL struct ITemplateSdoVtbl *lpVtbl; };
...
#define ITemplateSdo_GetIDsOfNames(This, riid, rgszNames, cNames, lcid,        \
                                   rgDispId)                                   \
  ((This)->lpVtbl->GetIDsOfNames(This, riid, rgszNames, cNames, lcid, rgDispId))

#define ITemplateSdo_Invoke(This, dispIdMember, riid, lcid, wFlags,            \
                            pDispParams, pVarResult, pExcepInfo, puArgErr)     \
  ((This)->lpVtbl->Invoke(This, dispIdMember, riid, lcid, wFlags, pDispParams, \
                          pVarResult, pExcepInfo, puArgErr))
...
typedef struct ISdoDictionaryOldVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in ISdoDictionaryOld *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in ISdoDictionaryOld *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in ISdoDictionaryOld *This);
...
class DECLSPEC_UUID("E9218AE7-9E91-11D1-BF60-0080C7846BC0") SdoMachine;
#endif
