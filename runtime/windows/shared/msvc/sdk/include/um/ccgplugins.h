...
typedef struct ICcgDomainAuthCredentialsVtbl {
  ...
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in ICcgDomainAuthCredentials *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in ICcgDomainAuthCredentials *This);
...
#define ICcgDomainAuthCredentials_GetPasswordCredentials(                      \
    This, pluginInput, domainName, username, password)                         \
  ((This)->lpVtbl->GetPasswordCredentials(This, pluginInput, domainName,       \
                                          username, password))
