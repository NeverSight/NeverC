...
typedef enum D2D1_OPACITY_MASK_CONTENT {
  ...
  /// <summary>
  /// The mask contains text rendered using one of the GDI compatible text
  /// modes.
  /// </summary>
...
/// <summary>
/// Enum which describes the manner in which we render edges of non-text
/// primitives.
/// </summary>
...
typedef enum D2D1_COMBINE_MODE {
  ...
  /// <summary>
  /// Produce a geometry representing the set of points contained in either the
  /// first or the second geometry.
  /// </summary>
  D2D1_COMBINE_MODE_UNION = 0,

  /// <summary>
  /// Produce a geometry representing the set of points common to the first and
...
/// <summary>
/// Specified options that can be applied when a layer resource is applied to
/// create a layer.
/// </summary>
typedef enum D2D1_LAYER_OPTIONS {
  ...
  /// ClearType. If the render target was set to ClearType and this option is
  /// not specified, the render target will be set to render gray-scale until
  /// the layer is popped. The caller can override this default by calling
...
typedef struct D2D1_LAYER_PARAMETERS {
  ...
  /// affected by the world transform. Content outside of the content bounds
  /// will not render.
  /// </summary>
  ...
  /// <summary>
  /// The opacity with which all of the content in the layer will be blended
  /// back to the target when the layer is popped.
  /// </summary>
  FLOAT opacity;
...
typedef enum D2D1_RENDER_TARGET_USAGE {
  ...
  /// <summary>
  /// The render target will allow a call to GetDC on the
  /// ID2D1GdiInteropRenderTarget interface. Rendering will also occur locally.
  /// </summary>
...
/// information, remoting options, and Direct3D support requirements for a
/// render target.
/// </summary>
...
/// <summary>
/// Specifies additional features supportable by a compatible render target when
/// it is created. This enumeration allows a bitwise combination of its member
/// values.
/// </summary>
typedef enum D2D1_COMPATIBLE_RENDER_TARGET_OPTIONS {
  ...
  /// ID2D1GdiInteropRenderTarget interface. This can be specified even if the
  /// parent render target is not GDI compatible.
  /// </summary>
...
typedef enum D2D1_FACTORY_TYPE {
  ...
  /// Reference counts on resources are interlocked, however, resource and
  /// render target state is not protected from multi-threaded access.
  /// </summary>
...
/// </summary>
interface DX_DECLARE_INTERFACE("2cd90691-12e2-11dc-9fed-001143a055f9")
...
/// </summary>
interface DX_DECLARE_INTERFACE("65019f75-8da2-497c-b32c-dfa34e48ede6")
    ID2D1Image : public ID2D1Resource{}; // interface ID2D1Image

/// <summary>
/// Root bitmap resource, linearly scaled on a draw call.
/// </summary>
interface DX_DECLARE_INTERFACE("a2296057-ea42-4099-983b-539fb6505426")
  ...
  STDMETHOD(CopyFromBitmap)(_In_opt_ CONST D2D1_POINT_2U * destPoint,
                            _In_ ID2D1Bitmap * bitmap,
                            _In_opt_ CONST D2D1_RECT_U * srcRect) PURE;

  STDMETHOD(CopyFromRenderTarget)(_In_opt_ CONST D2D1_POINT_2U * destPoint,
                                  _In_ ID2D1RenderTarget * renderTarget,
                                  _In_opt_ CONST D2D1_RECT_U * srcRect) PURE;

  STDMETHOD(CopyFromMemory)(_In_opt_ CONST D2D1_RECT_U * dstRect,
                            _In_ CONST void *srcData, UINT32 pitch) PURE;
...
/// </summary>
interface DX_DECLARE_INTERFACE("2cd906a7-12e2-11dc-9fed-001143a055f9")
  ...
  STDMETHOD_(void, GetGradientStops)(
      _Out_writes_to_(
          gradientStopsCount,
          _Inexpressible_("Retrieved through GetGradientStopCount()"))
              D2D1_GRADIENT_STOP *
          gradientStops,
...
/// </summary>
interface DX_DECLARE_INTERFACE("2cd906a8-12e2-11dc-9fed-001143a055f9")
  ...
  STDMETHOD_(void, GetTransform)(_Out_ D2D1_MATRIX_3X2_F * transform)
      CONST PURE;
...
/// </summary>
interface DX_DECLARE_INTERFACE("2cd906aa-12e2-11dc-9fed-001143a055f9")
  ...
  STDMETHOD_(void, GetBitmap)(_Outptr_result_maybenull_ ID2D1Bitmap * *bitmap)
      CONST PURE;
...
/// </summary>
interface DX_DECLARE_INTERFACE("2cd906a9-12e2-11dc-9fed-001143a055f9")
...
/// </summary>
interface DX_DECLARE_INTERFACE("2cd906ac-12e2-11dc-9fed-001143a055f9")
...
/// </summary>
interface DX_DECLARE_INTERFACE("2cd9069d-12e2-11dc-9fed-001143a055f9")
  ...
  /// </summary>
  STDMETHOD_(void, GetDashes)(_Out_writes_(dashesCount) FLOAT * dashes,
                              UINT32 dashesCount) CONST PURE;
...
/// </summary>
interface DX_DECLARE_INTERFACE("2cd906a1-12e2-11dc-9fed-001143a055f9")
    ID2D1Geometry : public ID2D1Resource {

  /// <summary>
  /// Retrieve the bounds of the geometry, with an optional applied transform.
  /// </summary>
  STDMETHOD(GetBounds)(_In_opt_ CONST D2D1_MATRIX_3X2_F * worldTransform,
  ...
  STDMETHOD(GetWidenedBounds)(
      FLOAT strokeWidth, _In_opt_ ID2D1StrokeStyle * strokeStyle,
      _In_opt_ CONST D2D1_MATRIX_3X2_F * worldTransform,
      FLOAT flatteningTolerance, _Out_ D2D1_RECT_F * bounds) CONST PURE;
  ...
  STDMETHOD(FillContainsPoint)(
      D2D1_POINT_2F point, _In_opt_ CONST D2D1_MATRIX_3X2_F * worldTransform,
      FLOAT flatteningTolerance, _Out_ BOOL * contains) CONST PURE;
  ...
  STDMETHOD(CompareWithGeometry)(
      ...
      FLOAT flatteningTolerance, _Out_ D2D1_GEOMETRY_RELATION * relation)
      CONST PURE;
  ...
  /// </summary>
  STDMETHOD(Tessellate)(_In_opt_ CONST D2D1_MATRIX_3X2_F * worldTransform,
                        FLOAT flatteningTolerance,
  ...
  STDMETHOD(CombineWithGeometry)(
      _In_ ID2D1Geometry * inputGeometry, D2D1_COMBINE_MODE combineMode,
      _In_opt_ CONST D2D1_MATRIX_3X2_F * inputGeometryTransform,
      FLOAT flatteningTolerance,
  ...
  /// </summary>
  STDMETHOD(Outline)(_In_opt_ CONST D2D1_MATRIX_3X2_F * worldTransform,
                     FLOAT flatteningTolerance,
                     _In_ ID2D1SimplifiedGeometrySink * geometrySink)
      CONST PURE;
  ...
  /// </summary>
  STDMETHOD(ComputeArea)(_In_opt_ CONST D2D1_MATRIX_3X2_F * worldTransform,
                         FLOAT flatteningTolerance, _Out_ FLOAT * area)
      CONST PURE;

  /// <summary>
  /// Computes the length of the geometry.
  /// </summary>
  STDMETHOD(ComputeLength)(_In_opt_ CONST D2D1_MATRIX_3X2_F * worldTransform,
                           FLOAT flatteningTolerance, _Out_ FLOAT * length)
      CONST PURE;
  ...
  STDMETHOD(ComputePointAtLength)(
      FLOAT length, _In_opt_ CONST D2D1_MATRIX_3X2_F * worldTransform,
      FLOAT flatteningTolerance, _Out_opt_ D2D1_POINT_2F * point,
      _Out_opt_ D2D1_POINT_2F * unitTangentVector) CONST PURE;

  /// <summary>
  /// Get the geometry and widen it as well as apply an optional pen style.
  /// </summary>
  STDMETHOD(Widen)(FLOAT strokeWidth, _In_opt_ ID2D1StrokeStyle * strokeStyle,
                   _In_opt_ CONST D2D1_MATRIX_3X2_F * worldTransform,
                   FLOAT flatteningTolerance,
                   _In_ ID2D1SimplifiedGeometrySink * geometrySink) CONST PURE;
  ...
  COM_DECLSPEC_NOTHROW
  HRESULT
  GetWidenedBounds(FLOAT strokeWidth, _In_opt_ ID2D1StrokeStyle * strokeStyle,
                   CONST D2D1_MATRIX_3X2_F & worldTransform,
                   FLOAT flatteningTolerance, _Out_ D2D1_RECT_F * bounds)
      CONST {
  ...
  COM_DECLSPEC_NOTHROW
  HRESULT
  CompareWithGeometry(_In_ ID2D1Geometry * inputGeometry,
  ...
  COM_DECLSPEC_NOTHROW
  HRESULT
  Tessellate(_In_opt_ CONST D2D1_MATRIX_3X2_F * worldTransform,
             _In_ ID2D1TessellationSink * tessellationSink) CONST {
  ...
  COM_DECLSPEC_NOTHROW
  HRESULT
  CombineWithGeometry(_In_ ID2D1Geometry * inputGeometry,
  ...
  COM_DECLSPEC_NOTHROW
  HRESULT
  Outline(_In_opt_ CONST D2D1_MATRIX_3X2_F * worldTransform,
          _In_ ID2D1SimplifiedGeometrySink * geometrySink) CONST {
  ...
  ComputeArea(CONST D2D1_MATRIX_3X2_F & worldTransform,
              FLOAT flatteningTolerance, _Out_ FLOAT * area) CONST {
  ...
  COM_DECLSPEC_NOTHROW
  HRESULT
  ComputeArea(_In_opt_ CONST D2D1_MATRIX_3X2_F * worldTransform,
  ...
  COM_DECLSPEC_NOTHROW
  HRESULT
  ComputeArea(CONST D2D1_MATRIX_3X2_F & worldTransform, _Out_ FLOAT * area)
      CONST {
  ...
  ComputeLength(CONST D2D1_MATRIX_3X2_F & worldTransform,
                FLOAT flatteningTolerance, _Out_ FLOAT * length) CONST {
  ...
  COM_DECLSPEC_NOTHROW
  HRESULT
  ComputeLength(_In_opt_ CONST D2D1_MATRIX_3X2_F * worldTransform,
  ...
  COM_DECLSPEC_NOTHROW
  HRESULT
  ComputeLength(CONST D2D1_MATRIX_3X2_F & worldTransform, _Out_ FLOAT * length)
      CONST {
    return ComputeLength(&worldTransform, D2D1_DEFAULT_FLATTENING_TOLERANCE,
                         length);
  }
  ...
  COM_DECLSPEC_NOTHROW
  HRESULT
  Widen(FLOAT strokeWidth, _In_opt_ ID2D1StrokeStyle * strokeStyle,
        CONST D2D1_MATRIX_3X2_F & worldTransform, FLOAT flatteningTolerance,
        _In_ ID2D1SimplifiedGeometrySink * geometrySink) CONST {
...
/// </summary>
interface DX_DECLARE_INTERFACE("2cd906a2-12e2-11dc-9fed-001143a055f9")
...
/// </summary>
interface DX_DECLARE_INTERFACE("2cd906a3-12e2-11dc-9fed-001143a055f9")
    ID2D1RoundedRectangleGeometry : public ID2D1Geometry {

  STDMETHOD_(void, GetRoundedRect)(_Out_ D2D1_ROUNDED_RECT * roundedRect)
      CONST PURE;
...
/// </summary>
interface DX_DECLARE_INTERFACE("2cd906a4-12e2-11dc-9fed-001143a055f9")
...
/// </summary>
interface DX_DECLARE_INTERFACE("2cd906a6-12e2-11dc-9fed-001143a055f9")
  ...
  STDMETHOD_(void, GetSourceGeometries)(
      ...
      UINT32 geometriesCount) CONST PURE;
}; // interface ID2D1GeometryGroup

/// <summary>
/// Represents a geometry that has been transformed.
/// </summary>
interface DX_DECLARE_INTERFACE("2cd906bb-12e2-11dc-9fed-001143a055f9")
    ID2D1TransformedGeometry : public ID2D1Geometry {

  STDMETHOD_(void, GetSourceGeometry)(_Outptr_ ID2D1Geometry * *sourceGeometry)
      CONST PURE;
...
/// arcs.
/// </summary>
interface DX_DECLARE_INTERFACE("2cd9069e-12e2-11dc-9fed-001143a055f9")
  ...
  STDMETHOD_(void, AddLines)(
      _In_reads_(pointsCount) CONST D2D1_POINT_2F * points, UINT32 pointsCount)
      PURE;
...
/// <summary>
/// Describes a geometric path that can contain lines, arcs, cubic Bezier
/// curves, and quadratic Bezier curves.
/// </summary>
interface DX_DECLARE_INTERFACE("2cd9069f-12e2-11dc-9fed-001143a055f9")
  ...
  STDMETHOD_(void, AddQuadraticBezier)(
      _In_ CONST D2D1_QUADRATIC_BEZIER_SEGMENT * bezier) PURE;
...
/// </summary>
interface DX_DECLARE_INTERFACE("2cd906a5-12e2-11dc-9fed-001143a055f9")
    ID2D1PathGeometry : public ID2D1Geometry {

  /// <summary>
  /// Opens a geometry sink that will be used to create this path geometry.
  /// </summary>
  STDMETHOD(Open)(_COM_Outptr_ ID2D1GeometrySink * *geometrySink) PURE;

  /// <summary>
  /// Retrieve the contents of this geometry. The caller passes an
  /// implementation of a ID2D1GeometrySink interface to receive the data.
  /// </summary>
...
/// </summary>
interface DX_DECLARE_INTERFACE("2cd906c2-12e2-11dc-9fed-001143a055f9") ID2D1Mesh
    : public ID2D1Resource {

  /// <summary>
  /// Opens the mesh for population.
  /// </summary>
  STDMETHOD(Open)(_COM_Outptr_ ID2D1TessellationSink * *tessellationSink) PURE;
}; // interface ID2D1Mesh

/// <summary>
/// Represents the backing store required to render a layer.
/// </summary>
interface DX_DECLARE_INTERFACE("2cd9069b-12e2-11dc-9fed-001143a055f9")
...
/// </summary>
interface DX_DECLARE_INTERFACE("28506e39-ebf6-46a1-bb47-fd85565ab957")
    ID2D1DrawingStateBlock : public ID2D1Resource {

  /// <summary>
  /// Retrieves the state currently contained within this state block resource.
  /// </summary>
  STDMETHOD_(void, GetDescription)(_Out_ D2D1_DRAWING_STATE_DESCRIPTION *
                                   stateDescription) CONST PURE;

  /// <summary>
  /// Sets the state description of this state block resource.
  /// </summary>
  STDMETHOD_(void, SetDescription)(_In_ CONST D2D1_DRAWING_STATE_DESCRIPTION *
  ...
  STDMETHOD_(void, SetTextRenderingParams)(
      _In_opt_ IDWriteRenderingParams *textRenderingParams = NULL) PURE;
...
/// inherit from ID2D1RenderTarget render the drawing commands they receive in
/// different ways.
/// </summary>
interface DX_DECLARE_INTERFACE("2cd90694-12e2-11dc-9fed-001143a055f9")
    ID2D1RenderTarget : public ID2D1Resource {

  /// <summary>
  /// Create a D2D bitmap by copying from memory, or create uninitialized.
  /// </summary>
  STDMETHOD(CreateBitmap)(D2D1_SIZE_U size, _In_opt_ CONST void *srcData,
                          UINT32 pitch,
                          _In_ CONST D2D1_BITMAP_PROPERTIES *bitmapProperties,
                          _COM_Outptr_ ID2D1Bitmap **bitmap) PURE;

  /// <summary>
  /// Create a D2D bitmap by copying a WIC bitmap.
  /// </summary>
  STDMETHOD(CreateBitmapFromWicBitmap)(_In_ IWICBitmapSource * wicBitmapSource,
                                       _In_opt_ CONST D2D1_BITMAP_PROPERTIES *
                                           bitmapProperties,
                                       _COM_Outptr_ ID2D1Bitmap * *bitmap) PURE;
  ...
  STDMETHOD(CreateSharedBitmap)(
      _In_ REFIID riid, _Inout_ void *data,
  ...
  STDMETHOD(CreateBitmapBrush)(
      ...
      _COM_Outptr_ ID2D1BitmapBrush * *bitmapBrush) PURE;

  STDMETHOD(CreateSolidColorBrush)(
      _In_ CONST D2D1_COLOR_F * color,
      _In_opt_ CONST D2D1_BRUSH_PROPERTIES * brushProperties,
      _COM_Outptr_ ID2D1SolidColorBrush * *solidColorBrush) PURE;
  ...
  /// <param name="extendMode">Specifies how the gradient will be extended
  /// outside of the unit length.</param>
  STDMETHOD(CreateGradientStopCollection)(
      ...
      _COM_Outptr_ ID2D1GradientStopCollection * *gradientStopCollection) PURE;

  STDMETHOD(CreateLinearGradientBrush)(
      _In_ CONST D2D1_LINEAR_GRADIENT_BRUSH_PROPERTIES *
          linearGradientBrushProperties,
      _In_opt_ CONST D2D1_BRUSH_PROPERTIES * brushProperties,
      _In_ ID2D1GradientStopCollection * gradientStopCollection,
      _COM_Outptr_ ID2D1LinearGradientBrush * *linearGradientBrush) PURE;

  STDMETHOD(CreateRadialGradientBrush)(
      _In_ CONST D2D1_RADIAL_GRADIENT_BRUSH_PROPERTIES *
          radialGradientBrushProperties,
      _In_opt_ CONST D2D1_BRUSH_PROPERTIES * brushProperties,
      _In_ ID2D1GradientStopCollection * gradientStopCollection,
      _COM_Outptr_ ID2D1RadialGradientBrush * *radialGradientBrush) PURE;

  /// <summary>
  /// Creates a bitmap render target whose bitmap can be used as a source for
  /// rendering in the API.
  /// </summary>
  /// <param name="desiredSize">The requested size of the target in DIPs. If the
  /// pixel size is not specified, the DPI is inherited from the parent target.
  /// However, the render target will never contain a fractional number of
  /// pixels.</param> <param name="desiredPixelSize">The requested size of the
  /// render target in pixels. If the DIP size is also specified, the DPI is
  /// calculated from these two values. If the desired size is not specified,
  /// the DPI is inherited from the parent render target. If neither value is
  /// specified, the compatible render target will be the same size and have the
  /// same DPI as the parent target.</param> <param name="desiredFormat">The
  /// desired pixel format. The format must be compatible with the parent render
  /// target type. If the format is not specified, it will be inherited from the
  /// parent render target.</param> <param name="options">Allows the caller to
  /// retrieve a GDI compatible render target.</param> <param
  /// name="bitmapRenderTarget">The returned bitmap render target.</param>
  STDMETHOD(CreateCompatibleRenderTarget)(
      ...
      _COM_Outptr_ ID2D1BitmapRenderTarget * *bitmapRenderTarget) PURE;

  /// <summary>
  /// Creates a layer resource that can be used on any target and which will
  /// resize under the covers if necessary.
  /// </summary>
  /// <param name="size">The resolution independent minimum size hint for the
  /// layer resource. Specify this to prevent unwanted reallocation of the layer
  /// backing store. The size is in DIPs, but, it is unaffected by the current
  /// world transform. If the size is unspecified, the returned resource is a
  /// placeholder and the backing store will be allocated to be the minimum size
  /// that can hold the content when the layer is pushed.</param>
  STDMETHOD(CreateLayer)(_In_opt_ CONST D2D1_SIZE_F * size,
                         _COM_Outptr_ ID2D1Layer * *layer) PURE;

  /// <summary>
  /// Create a D2D mesh.
  /// </summary>
  STDMETHOD(CreateMesh)(_COM_Outptr_ ID2D1Mesh * *mesh) PURE;

  STDMETHOD_(void, DrawLine)(D2D1_POINT_2F point0, D2D1_POINT_2F point1,
                             _In_ ID2D1Brush * brush, FLOAT strokeWidth = 1.0f,
                             _In_opt_ ID2D1StrokeStyle *strokeStyle = NULL)
      PURE;

  STDMETHOD_(void,
             DrawRectangle)(_In_ CONST D2D1_RECT_F * rect,
                            _In_ ID2D1Brush * brush, FLOAT strokeWidth = 1.0f,
                            _In_opt_ ID2D1StrokeStyle *strokeStyle = NULL) PURE;

  STDMETHOD_(void, FillRectangle)(_In_ CONST D2D1_RECT_F * rect,
                                  _In_ ID2D1Brush * brush) PURE;

  STDMETHOD_(void, DrawRoundedRectangle)(
      _In_ CONST D2D1_ROUNDED_RECT * roundedRect, _In_ ID2D1Brush * brush,
      FLOAT strokeWidth = 1.0f, _In_opt_ ID2D1StrokeStyle *strokeStyle = NULL)
      PURE;

  STDMETHOD_(void, FillRoundedRectangle)(
      _In_ CONST D2D1_ROUNDED_RECT * roundedRect, _In_ ID2D1Brush * brush) PURE;

  STDMETHOD_(void,
             DrawEllipse)(_In_ CONST D2D1_ELLIPSE * ellipse,
                          _In_ ID2D1Brush * brush, FLOAT strokeWidth = 1.0f,
                          _In_opt_ ID2D1StrokeStyle *strokeStyle = NULL) PURE;

  STDMETHOD_(void, FillEllipse)(_In_ CONST D2D1_ELLIPSE * ellipse,
                                _In_ ID2D1Brush * brush) PURE;

  STDMETHOD_(void,
             DrawGeometry)(_In_ ID2D1Geometry * geometry,
                           _In_ ID2D1Brush * brush, FLOAT strokeWidth = 1.0f,
                           _In_opt_ ID2D1StrokeStyle *strokeStyle = NULL) PURE;

  /// <param name="opacityBrush">An optionally specified opacity brush. Only the
  /// alpha channel of the corresponding brush will be sampled and will be
  /// applied to the entire fill of the geometry. If this brush is specified,
  /// the fill brush must be a bitmap brush with an extend mode of
  /// D2D1_EXTEND_MODE_CLAMP.</param>
  STDMETHOD_(void, FillGeometry)(_In_ ID2D1Geometry * geometry,
  ...
  /// </summary>
  STDMETHOD_(void, FillMesh)(_In_ ID2D1Mesh * mesh, _In_ ID2D1Brush * brush)
      PURE;

  /// <summary>
  /// Fill using the alpha channel of the supplied opacity mask bitmap. The
  /// brush opacity will be modulated by the mask. The render target
  /// antialiasing mode must be set to aliased.
  /// </summary>
  STDMETHOD_(void, FillOpacityMask)(
      _In_ ID2D1Bitmap * opacityMask, _In_ ID2D1Brush * brush,
  ...
  /// <summary>
  /// Draws the text within the given layout rectangle and by default also
  /// performs baseline snapping.
  /// </summary>
  STDMETHOD_(void, DrawText)(
      _In_reads_(stringLength) CONST WCHAR * string, UINT32 stringLength,
      _In_ IDWriteTextFormat * textFormat, _In_ CONST D2D1_RECT_F * layoutRect,
      _In_ ID2D1Brush * defaultFillBrush,
      D2D1_DRAW_TEXT_OPTIONS options = D2D1_DRAW_TEXT_OPTIONS_NONE,
      DWRITE_MEASURING_MODE measuringMode = DWRITE_MEASURING_MODE_NATURAL) PURE;

  /// <summary>
  /// Draw a text layout object. If the layout is not subsequently changed, this
  /// can be more efficient than DrawText when drawing the same layout
  /// repeatedly.
  /// </summary>
  /// <param name="options">The specified text options. If
  /// D2D1_DRAW_TEXT_OPTIONS_CLIP is used, the text is clipped to the layout
  /// bounds. These bounds are derived from the origin and the layout bounds of
  /// the corresponding IDWriteTextLayout object.
  /// </param>
  STDMETHOD_(void, DrawTextLayout)(
      D2D1_POINT_2F origin, _In_ IDWriteTextLayout * textLayout,
      _In_ ID2D1Brush * defaultFillBrush,
  ...
  /// rendering a primitive, the tags can be returned from the Flush or EndDraw
  /// call.
  /// </summary>
  ...
  /// </summary>
  STDMETHOD_(void, GetTags)(_Out_opt_ D2D1_TAG *tag1 = NULL,
                            _Out_opt_ D2D1_TAG *tag2 = NULL) CONST PURE;

  /// <summary>
  /// Start a layer of drawing calls. The way in which the layer must be
  /// resolved is specified first as well as the logical resource that stores
  /// the layer parameters. The supplied layer resource might grow if the
  /// specified content cannot fit inside it. The layer will grow monotonically
  /// on each axis.  If a NULL ID2D1Layer is provided, then a layer resource
  /// will be allocated automatically.
  /// </summary>
  STDMETHOD_(void,
             PushLayer)(_In_ CONST D2D1_LAYER_PARAMETERS * layerParameters,
                        _In_opt_ ID2D1Layer * layer) PURE;
  ...
  STDMETHOD(Flush)(_Out_opt_ D2D1_TAG *tag1 = NULL,
  ...
  /// IDrawingStatckBlock.
  /// </summary>
  STDMETHOD_(void, SaveDrawingState)(_Inout_ ID2D1DrawingStateBlock *
                                     drawingStateBlock) CONST PURE;

  /// <summary>
  /// Copies the state stored in the block interface.
  /// </summary>
  STDMETHOD_(void, RestoreDrawingState)(_In_ ID2D1DrawingStateBlock *
  ...
  /// </summary>
  STDMETHOD_(void, PushAxisAlignedClip)(_In_ CONST D2D1_RECT_F * clipRect,
  ...
  /// </summary>
  STDMETHOD(EndDraw)(_Out_opt_ D2D1_TAG *tag1 = NULL,
                     _Out_opt_ D2D1_TAG *tag2 = NULL) PURE;
  ...
  /// to be supported.
  /// </summary>
  STDMETHOD_(BOOL, IsSupported)(_In_ CONST D2D1_RENDER_TARGET_PROPERTIES *
                                renderTargetProperties) CONST PURE;

  COM_DECLSPEC_NOTHROW
  HRESULT
  CreateBitmap(D2D1_SIZE_U size, _In_opt_ CONST void *srcData, UINT32 pitch,
  ...
  COM_DECLSPEC_NOTHROW
  HRESULT
  CreateBitmapFromWicBitmap(_In_ IWICBitmapSource * wicBitmapSource,
                            CONST D2D1_BITMAP_PROPERTIES & bitmapProperties,
                            _COM_Outptr_ ID2D1Bitmap * *bitmap) {
  ...
  COM_DECLSPEC_NOTHROW
  HRESULT
  CreateBitmapBrush(_In_opt_ ID2D1Bitmap * bitmap,
  ...
  COM_DECLSPEC_NOTHROW
  HRESULT
  CreateCompatibleRenderTarget(_COM_Outptr_ ID2D1BitmapRenderTarget *
                               *bitmapRenderTarget) {
  ...
  CreateCompatibleRenderTarget(D2D1_SIZE_F desiredSize,
                               _COM_Outptr_ ID2D1BitmapRenderTarget *
                                   *bitmapRenderTarget) {
    return CreateCompatibleRenderTarget(
  ...
  COM_DECLSPEC_NOTHROW
  HRESULT
  CreateLayer(D2D1_SIZE_F size, _COM_Outptr_ ID2D1Layer * *layer) {
    return CreateLayer(&size, layer);
  }

  COM_DECLSPEC_NOTHROW
  HRESULT
  CreateLayer(_COM_Outptr_ ID2D1Layer * *layer) {
    return CreateLayer(NULL, layer);
  }

  COM_DECLSPEC_NOTHROW
  void DrawRectangle(CONST D2D1_RECT_F & rect, _In_ ID2D1Brush * brush,
  ...
  COM_DECLSPEC_NOTHROW
  void FillRectangle(CONST D2D1_RECT_F & rect, _In_ ID2D1Brush * brush) {
  ...
  COM_DECLSPEC_NOTHROW
  void DrawEllipse(CONST D2D1_ELLIPSE & ellipse, _In_ ID2D1Brush * brush,
                   FLOAT strokeWidth = 1.0f,
                   _In_opt_ ID2D1StrokeStyle *strokeStyle = NULL) {
  ...
  COM_DECLSPEC_NOTHROW
  void FillEllipse(CONST D2D1_ELLIPSE & ellipse, _In_ ID2D1Brush * brush) {
    FillEllipse(&ellipse, brush);
  }

  COM_DECLSPEC_NOTHROW
  void FillOpacityMask(_In_ ID2D1Bitmap * opacityMask, _In_ ID2D1Brush * brush,
                       D2D1_OPACITY_MASK_CONTENT content,
  ...
  COM_DECLSPEC_NOTHROW
  void DrawBitmap(_In_ ID2D1Bitmap * bitmap,
                  CONST D2D1_RECT_F & destinationRectangle,
                  FLOAT opacity = 1.0f,
                  D2D1_BITMAP_INTERPOLATION_MODE interpolationMode =
                      D2D1_BITMAP_INTERPOLATION_MODE_LINEAR,
  ...
  void DrawText(
      _In_reads_(stringLength) CONST WCHAR * string, UINT32 stringLength,
      _In_ IDWriteTextFormat * textFormat, CONST D2D1_RECT_F & layoutRect,
      _In_ ID2D1Brush * defaultFillBrush,
      D2D1_DRAW_TEXT_OPTIONS options = D2D1_DRAW_TEXT_OPTIONS_NONE,
...
/// </summary>
interface DX_DECLARE_INTERFACE("2cd90695-12e2-11dc-9fed-001143a055f9")
    ID2D1BitmapRenderTarget : public ID2D1RenderTarget {

  STDMETHOD(GetBitmap)(_COM_Outptr_ ID2D1Bitmap * *bitmap) PURE;
}; // interface ID2D1BitmapRenderTarget

/// <summary>
/// Renders drawing instructions to a window.
/// </summary>
interface DX_DECLARE_INTERFACE("2cd90698-12e2-11dc-9fed-001143a055f9")
  ...
  /// if there is insufficient video memory or system memory, or if the render
  ...
  /// will be returned from it when EndDraw is called. In addition an
  /// appropriate failure result will be returned from Resize.
  /// </summary>
...
/// </summary>
interface DX_DECLARE_INTERFACE("e0db51c3-6f77-4bae-b3d5-e47509b35838")
...
/// </summary>
interface DX_DECLARE_INTERFACE("1c51bc64-de61-46fd-9899-63a5d8f03950")
...
/// </summary>
interface DX_DECLARE_INTERFACE("06152247-6f50-465a-9245-118bfd3b6007")
  ...
  /// </summary>
  [[deprecated(
      "Deprecated. Use DisplayInformation::LogicalDpi for Windows "
      "Store Apps or GetDpiForWindow for desktop apps.")]] STDMETHOD_(void,
                                                                      GetDesktopDpi)(
      _Out_ FLOAT * dpiX, _Out_ FLOAT * dpiY) PURE;

  STDMETHOD(CreateRectangleGeometry)(_In_ CONST D2D1_RECT_F * rectangle,
                                     _COM_Outptr_ ID2D1RectangleGeometry *
                                         *rectangleGeometry) PURE;
  ...
  STDMETHOD(CreateEllipseGeometry)(_In_ CONST D2D1_ELLIPSE * ellipse,
                                   _COM_Outptr_ ID2D1EllipseGeometry *
                                       *ellipseGeometry) PURE;
  ...
  STDMETHOD(CreateGeometryGroup)(
      ...
      UINT32 geometriesCount, _COM_Outptr_ ID2D1GeometryGroup * *geometryGroup)
      PURE;

  STDMETHOD(CreateTransformedGeometry)(_In_ ID2D1Geometry * sourceGeometry,
                                       _In_ CONST D2D1_MATRIX_3X2_F * transform,
                                       _COM_Outptr_ ID2D1TransformedGeometry *
                                           *transformedGeometry) PURE;

  /// <summary>
  /// Returns an initially empty path geometry interface. A geometry sink is
  /// created off the interface to populate it.
  /// </summary>
  STDMETHOD(CreatePathGeometry)(_COM_Outptr_ ID2D1PathGeometry * *pathGeometry)
      PURE;
  ...
  STDMETHOD(CreateStrokeStyle)(
      ...
      _In_reads_opt_(dashesCount) CONST FLOAT * dashes, UINT32 dashesCount,
      _COM_Outptr_ ID2D1StrokeStyle * *strokeStyle) PURE;
  ...
  STDMETHOD(CreateDrawingStateBlock)(
      ...
      _COM_Outptr_ ID2D1DrawingStateBlock * *drawingStateBlock) PURE;
  ...
  STDMETHOD(CreateWicBitmapRenderTarget)(
      ...
      _COM_Outptr_ ID2D1RenderTarget * *renderTarget) PURE;
  ...
  STDMETHOD(CreateHwndRenderTarget)(
      _In_ CONST D2D1_RENDER_TARGET_PROPERTIES * renderTargetProperties,
      _In_ CONST D2D1_HWND_RENDER_TARGET_PROPERTIES *
          hwndRenderTargetProperties,
      _COM_Outptr_ ID2D1HwndRenderTarget * *hwndRenderTarget) PURE;
  ...
  STDMETHOD(CreateDCRenderTarget)(
      _In_ CONST D2D1_RENDER_TARGET_PROPERTIES * renderTargetProperties,
      _COM_Outptr_ ID2D1DCRenderTarget * *dcRenderTarget) PURE;
  ...
  CreateRoundedRectangleGeometry(CONST D2D1_ROUNDED_RECT & roundedRectangle,
                                 _COM_Outptr_ ID2D1RoundedRectangleGeometry *
  ...
  CreateTransformedGeometry(
      _In_ ID2D1Geometry * sourceGeometry, CONST D2D1_MATRIX_3X2_F & transform,
  ...
  COM_DECLSPEC_NOTHROW
  HRESULT
  CreateDrawingStateBlock(_COM_Outptr_ ID2D1DrawingStateBlock *
                          *drawingStateBlock) {
  ...
  COM_DECLSPEC_NOTHROW
  HRESULT
  CreateWicBitmapRenderTarget(_In_ IWICBitmap * target,
...
//
HRESULT WINAPI
D2D1CreateFactory(_In_ D2D1_FACTORY_TYPE factoryType, _In_ REFIID riid,
                  _In_opt_ CONST D2D1_FACTORY_OPTIONS *pFactoryOptions,
                  _Out_ void **ppIFactory);

void WINAPI D2D1MakeRotateMatrix(_In_ FLOAT angle, _In_ D2D1_POINT_2F center,
                                 _Out_ D2D1_MATRIX_3X2_F *matrix);

void WINAPI D2D1MakeSkewMatrix(_In_ FLOAT angleX, _In_ FLOAT angleY,
...
COM_DECLSPEC_NOTHROW
inline HRESULT D2D1CreateFactory(_In_ D2D1_FACTORY_TYPE factoryType,
                                 _In_ REFIID riid, _Out_ void **factory) {
  return D2D1CreateFactory(factoryType, riid, NULL, factory);
}

template <class Factory>
COM_DECLSPEC_NOTHROW HRESULT
D2D1CreateFactory(_In_ D2D1_FACTORY_TYPE factoryType, _Out_ Factory **factory) {
...
template <class Factory>
COM_DECLSPEC_NOTHROW HRESULT
D2D1CreateFactory(_In_ D2D1_FACTORY_TYPE factoryType,
