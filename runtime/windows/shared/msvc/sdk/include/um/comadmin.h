...
public:
  ...
  virtual /* [helpstring][id] */ HRESULT STDMETHODCALLTYPE RefreshRouter(
      void) = 0;

  virtual /* [helpstring][id] */ HRESULT STDMETHODCALLTYPE StartRouter(
      void) = 0;
  ...
  virtual /* [helpstring][id] */ HRESULT STDMETHODCALLTYPE RefreshComponents(
      void) = 0;
...
typedef struct ICOMAdminCatalogVtbl {
  ...
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in ICOMAdminCatalog *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in ICOMAdminCatalog *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in ICOMAdminCatalog *This);
  ...
  /* [helpstring][id] */ HRESULT(
      STDMETHODCALLTYPE *InstallMultipleEventClasses)(
      __RPC__in ICOMAdminCatalog *This,
      /* [in] */ __RPC__in BSTR bstrApplIdOrName,
      /* [in] */ __RPC__deref_in_opt SAFEARRAY **ppsaVarFileNames,
      /* [in] */ __RPC__deref_in_opt SAFEARRAY **ppsaVarCLSIDS);
...
interface ICOMAdminCatalog { CONST_VTBL struct ICOMAdminCatalogVtbl *lpVtbl; };
...
#define ICOMAdminCatalog_InstallMultipleEventClasses(                          \
    This, bstrApplIdOrName, ppsaVarFileNames, ppsaVarCLSIDS)                   \
  ((This)->lpVtbl->InstallMultipleEventClasses(                                \
      This, bstrApplIdOrName, ppsaVarFileNames, ppsaVarCLSIDS))
...
public:
  ...
  virtual /* [helpstring][id][propget] */ HRESULT STDMETHODCALLTYPE
      get_CurrentPartitionName(
          /* [retval][out] */ __RPC__deref_out_opt BSTR *
          pbstrPartitionName) = 0;

  virtual /* [helpstring][id][propget] */ HRESULT STDMETHODCALLTYPE
      get_GlobalPartitionID(
          /* [retval][out] */ __RPC__deref_out_opt BSTR *
          pbstrGlobalPartitionID) = 0;

  virtual /* [helpstring][id] */ HRESULT STDMETHODCALLTYPE FlushPartitionCache(
      void) = 0;
...
typedef struct ICOMAdminCatalog2Vtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in ICOMAdminCatalog2 *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in ICOMAdminCatalog2 *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in ICOMAdminCatalog2 *This);
  ...
  /* [helpstring][id] */ HRESULT(
      STDMETHODCALLTYPE *GetApplicationInstanceIDFromProcessID)(
      __RPC__in ICOMAdminCatalog2 *This,
      /* [in] */ long lProcessID,
      /* [retval][out] */
  ...
  /* [helpstring][id] */ HRESULT(
      STDMETHODCALLTYPE *ShutdownApplicationInstances)(
      __RPC__in ICOMAdminCatalog2 *This,
      /* [in] */ __RPC__in VARIANT *pVarApplicationInstanceID);
  ...
  /* [helpstring][id] */ HRESULT(
      STDMETHODCALLTYPE *RecycleApplicationInstances)(
      __RPC__in ICOMAdminCatalog2 *This,
      /* [in] */ __RPC__in VARIANT *pVarApplicationInstanceID,
      /* [in] */ long lReasonCode);
  ...
  /* [helpstring][id] */ HRESULT(
      STDMETHODCALLTYPE *AreApplicationInstancesPaused)(
      __RPC__in ICOMAdminCatalog2 *This,
      /* [in] */ __RPC__in VARIANT *pVarApplicationInstanceID,
  ...
  /* [helpstring][id] */ HRESULT(
      STDMETHODCALLTYPE *DeleteServiceForApplication)(
      __RPC__in ICOMAdminCatalog2 *This,
      /* [in] */ __RPC__in BSTR bstrApplicationIDOrName);
  ...
  /* [helpstring][id] */ HRESULT(
      STDMETHODCALLTYPE *ImportUnconfiguredComponents)(
      __RPC__in ICOMAdminCatalog2 *This,
      /* [in] */ __RPC__in BSTR bstrApplicationIDOrName,
      /* [in] */ __RPC__in VARIANT *pVarCLSIDOrProgID,
  ...
  /* [helpstring][id] */ HRESULT(
      STDMETHODCALLTYPE *PromoteUnconfiguredComponents)(
      __RPC__in ICOMAdminCatalog2 *This,
      /* [in] */ __RPC__in BSTR bstrApplicationIDOrName,
      /* [in] */ __RPC__in VARIANT *pVarCLSIDOrProgID,
      /* [optional][in] */ __RPC__in VARIANT *pVarComponentType);
  ...
  /* [helpstring][id][propget] */ HRESULT(
      STDMETHODCALLTYPE *get_Is64BitCatalogServer)(
      __RPC__in ICOMAdminCatalog2 *This,
...
#define ICOMAdminCatalog2_GetCollectionByQuery2(                               \
  ...
  ((This)->lpVtbl->GetCollectionByQuery2(                                      \
      This, bstrCollectionName, pVarQueryStrings, ppCatalogCollection))
...
#define ICOMAdminCatalog2_ShutdownApplicationInstances(                        \
  ...
  ((This)->lpVtbl->ShutdownApplicationInstances(This,                          \
...
#define ICOMAdminCatalog2_RecycleApplicationInstances(                         \
  ...
  ((This)->lpVtbl->RecycleApplicationInstances(                                \
      This, pVarApplicationInstanceID, lReasonCode))
...
#define ICOMAdminCatalog2_CreateServiceForApplication(                         \
  ...
  ((This)->lpVtbl->CreateServiceForApplication(                                \
      This, bstrApplicationIDOrName, bstrServiceName, bstrStartType,           \
      bstrErrorControl, bstrDependencies, bstrRunAs, bstrPassword,             \
      bDesktopOk))
...
typedef struct ICatalogObjectVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in ICatalogObject *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in ICatalogObject *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in ICatalogObject *This);
...
interface ICatalogObject { CONST_VTBL struct ICatalogObjectVtbl *lpVtbl; };
...
typedef struct ICatalogCollectionVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in ICatalogCollection *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in ICatalogCollection *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in ICatalogCollection *This);
  ...
  /* [helpstring][id][propget] */ HRESULT(
      STDMETHODCALLTYPE *get_DataStoreMajorVersion)(
      __RPC__in ICatalogCollection *This,
      /* [retval][out] */ __RPC__out long *plMajorVersion);

  DECLSPEC_XFGVIRT(ICatalogCollection, get_DataStoreMinorVersion)
  /* [helpstring][id][propget] */ HRESULT(
      STDMETHODCALLTYPE *get_DataStoreMinorVersion)(
      __RPC__in ICatalogCollection *This,
