...
typedef interface IAudioSystemEffectsPropertyChangeNotificationClient
...
typedef interface IAudioSystemEffectsPropertyStore
...
DEFINE_PROPERTYKEY(PKEY_AudioEndpoint_Default_VolumeInDb, 0x1da5d803, 0xd492,
                   0x4edd, 0x8c, 0x23, 0xe0, 0xc0, 0xff, 0xee, 0x7f, 0x0e, 9);
DEFINE_PROPERTYKEY(PKEY_AudioEndpoint_Max_VolumeInDb, 0x1da5d803, 0xd492,
                   0x4edd, 0x8c, 0x23, 0xe0, 0xc0, 0xff, 0xee, 0x7f, 0x0e, 10);
DEFINE_PROPERTYKEY(PKEY_AudioEndpoint_Min_VolumeInDb, 0x1da5d803, 0xd492,
                   0x4edd, 0x8c, 0x23, 0xe0, 0xc0, 0xff, 0xee, 0x7f, 0x0e, 11);
...
DEFINE_PROPERTYKEY(PKEY_AudioEngine_OEMFormat, 0xe4870e26, 0x3cc5, 0x4cd2, 0xba,
                   0x46, 0xca, 0xa, 0x9a, 0x70, 0xed, 0x4, 3);
DEFINE_PROPERTYKEY(PKEY_AudioEndpointLogo_IconEffects, 0xf1ab780d, 0x2010,
                   0x4ed3, 0xa3, 0xa6, 0x8b, 0x87, 0xf0, 0xf0, 0xc4, 0x76, 0);
DEFINE_PROPERTYKEY(PKEY_AudioEndpointLogo_IconPath, 0xf1ab780d, 0x2010, 0x4ed3,
                   0xa3, 0xa6, 0x8b, 0x87, 0xf0, 0xf0, 0xc4, 0x76, 1);
DEFINE_PROPERTYKEY(PKEY_AudioEndpointSettings_MenuText, 0x14242002, 0x0320,
                   0x4de4, 0x95, 0x55, 0xa7, 0xd8, 0x2b, 0x73, 0xc2, 0x86, 0);
DEFINE_PROPERTYKEY(PKEY_AudioEndpointSettings_LaunchContract, 0x14242002,
                   0x0320, 0x4de4, 0x95, 0x55, 0xa7, 0xd8, 0x2b, 0x73, 0xc2,
                   0x86, 1);
...
DEFINE_GUID(DEVINTERFACE_MIDI_OUTPUT, 0x6dc23320, 0xab33, 0x4ce4, 0x80, 0xd4,
            0xbb, 0xb3, 0xeb, 0xbf, 0x28, 0x14);
// {504BE32C-CCF6-4D2C-B73F-6F8B3747E22B}
DEFINE_GUID(DEVINTERFACE_MIDI_INPUT, 0x504be32c, 0xccf6, 0x4d2c, 0xb7, 0x3f,
            0x6f, 0x8b, 0x37, 0x47, 0xe2, 0x2b);
#endif
#endif /* WINAPI_FAMILY_PARTITION(WINAPI_PARTITION_APP) */
#pragma endregion
...
typedef struct IMMDeviceVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(IMMDevice *This,
                                             /* [in] */ REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);
...
typedef struct IMMEndpointVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(IMMEndpoint *This,
                                             /* [in] */ REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);
...
#define IActivateAudioInterfaceCompletionHandler_ActivateCompleted(            \
...
STDAPI ActivateAudioInterfaceAsync(
    _In_ LPCWSTR deviceInterfacePath, _In_ REFIID riid,
...
// The AUDIOCLIENT_ACTIVATION_PARAMS structure can be used when creating an
// IAudioClient. It is defined in AudioClientActivationParams.h
#endif /* WINAPI_FAMILY_PARTITION(WINAPI_PARTITION_APP |                       \
          WINAPI_PARTITION_GAMES) */
#pragma endregion
#pragma region Desktop Family
...
typedef struct IAudioSystemEffectsPropertyChangeNotificationClientVtbl {
  ...
  DECLSPEC_XFGVIRT(IAudioSystemEffectsPropertyChangeNotificationClient,
                   OnPropertyChanged)
...
interface IAudioSystemEffectsPropertyChangeNotificationClient {
  CONST_VTBL struct IAudioSystemEffectsPropertyChangeNotificationClientVtbl
      *lpVtbl;
};

#ifdef COBJMACROS

#define IAudioSystemEffectsPropertyChangeNotificationClient_QueryInterface(    \
    This, riid, ppvObject)                                                     \
  ((This)->lpVtbl->QueryInterface(This, riid, ppvObject))
...
#define IAudioSystemEffectsPropertyChangeNotificationClient_OnPropertyChanged( \
    This, type, key)                                                           \
...
typedef struct IAudioSystemEffectsPropertyStoreVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(IAudioSystemEffectsPropertyStore *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(IAudioSystemEffectsPropertyStore *This);
  ...
  DECLSPEC_XFGVIRT(IAudioSystemEffectsPropertyStore,
...
#define IAudioSystemEffectsPropertyStore_OpenDefaultPropertyStore(             \
    This, stgmAccess, propStore)                                               \
  ((This)->lpVtbl->OpenDefaultPropertyStore(This, stgmAccess, propStore))

#define IAudioSystemEffectsPropertyStore_OpenUserPropertyStore(                \
    This, stgmAccess, propStore)                                               \
  ((This)->lpVtbl->OpenUserPropertyStore(This, stgmAccess, propStore))

#define IAudioSystemEffectsPropertyStore_OpenVolatilePropertyStore(            \
    This, stgmAccess, propStore)                                               \
...
#define IAudioSystemEffectsPropertyStore_RegisterPropertyChangeNotification(   \
    This, callback)                                                            \
  ((This)->lpVtbl->RegisterPropertyChangeNotification(This, callback))

#define IAudioSystemEffectsPropertyStore_UnregisterPropertyChangeNotification( \
    This, callback)                                                            \
