...
// DigitalCable
template <class TUNINGSPACETYPE, class TUNEREQUESTTYPE>
class TNDigitalCableTuningSpaceHelper
    : public TNATSCTuningSpaceHelper<TUNINGSPACETYPE, TUNEREQUESTTYPE> {
public:
  TNDigitalCableTuningSpaceHelper() {}
  TNDigitalCableTuningSpaceHelper(const TUNINGSPACETYPE &a)
      : TNATSCTuningSpaceHelper<TUNINGSPACETYPE, TUNEREQUESTTYPE>(a) {}
  TNDigitalCableTuningSpaceHelper(IUnknown *p)
      : TNATSCTuningSpaceHelper<TUNINGSPACETYPE, TUNEREQUESTTYPE>(p) {}
  TNDigitalCableTuningSpaceHelper(
      const TNDigitalCableTuningSpaceHelper<TUNINGSPACETYPE, TUNEREQUESTTYPE>
          &a)
      : TNATSCTuningSpaceHelper<TUNINGSPACETYPE, TUNEREQUESTTYPE>(a) {}

  TNDigitalCableTuningSpaceHelper<TUNINGSPACETYPE, TUNEREQUESTTYPE> &operator=(
      TNDigitalCableTuningSpaceHelper<TUNINGSPACETYPE, TUNEREQUESTTYPE> &rhs) {
    TNATSCTuningSpaceHelper<TUNINGSPACETYPE, TUNEREQUESTTYPE>::operator=(rhs);
    return *this;
  }
  template <class TS, class TR>
  TNDigitalCableTuningSpaceHelper<TUNINGSPACETYPE, TUNEREQUESTTYPE> &
  operator=(TNTuningSpaceHelper<TS, TR> &rhs) {
...
typedef TNDigitalCableTuningSpaceHelper<PQDigitalCableTuningSpace,
                                        PQDigitalCableTuneRequest>
    TNDigitalCableTuningSpace;
...
class TNDigitalLocatorHelper : public TNLocatorHelper<LOCATORTYPE> {
public:
  TNDigitalLocatorHelper() {}
  TNDigitalLocatorHelper(const LOCATORTYPE &a)
      : TNLocatorHelper<LOCATORTYPE>(a) {}
  TNDigitalLocatorHelper(IUnknown *p) : TNLocatorHelper<LOCATORTYPE>(p) {}
  TNDigitalLocatorHelper(const TNDigitalLocatorHelper<LOCATORTYPE> &a)
      : TNLocatorHelper<LOCATORTYPE>(a) {}
  TNDigitalLocatorHelper(ILocator *p) : TNLocatorHelper<LOCATORTYPE>(p) {}
  TNDigitalLocatorHelper<LOCATORTYPE> &
  operator=(TNDigitalLocatorHelper<LOCATORTYPE> &rhs) {
    LOCATORTYPE::operator=(rhs);
    return *this;
  }
...
template <class LOCATORTYPE>
class TNATSCLocatorHelper : public TNDigitalLocatorHelper<LOCATORTYPE> {
public:
  TNATSCLocatorHelper() {}
  TNATSCLocatorHelper(const LOCATORTYPE &a)
      : TNDigitalLocatorHelper<LOCATORTYPE>(a) {}
  ...
  TNATSCLocatorHelper(const TNATSCLocatorHelper<LOCATORTYPE> &a)
      : TNDigitalLocatorHelper<LOCATORTYPE>(a) {}
  TNATSCLocatorHelper(IATSCLocator *p)
      : TNDigitalLocatorHelper<LOCATORTYPE>(p) {}
...
template <class LOCATORTYPE>
class TNDVBSLocatorHelper : public TNDigitalLocatorHelper<LOCATORTYPE> {
public:
  TNDVBSLocatorHelper() {}
  TNDVBSLocatorHelper(const LOCATORTYPE &a)
      : TNDigitalLocatorHelper<LOCATORTYPE>(a) {}
  ...
  TNDVBSLocatorHelper(const TNDVBSLocatorHelper<LOCATORTYPE> &a)
      : TNDigitalLocatorHelper<LOCATORTYPE>(a) {}
  TNDVBSLocatorHelper(IDVBSLocator *p)
      : TNDigitalLocatorHelper<LOCATORTYPE>(p) {}
...
template <class LOCATORTYPE>
class TNDVBSLocator2Helper : public TNDVBSLocatorHelper<LOCATORTYPE> {
public:
  TNDVBSLocator2Helper() {}

  TNDVBSLocator2Helper(const LOCATORTYPE &a)
      : TNDVBSLocatorHelper<LOCATORTYPE>(a) {}
  TNDVBSLocator2Helper(IUnknown *p) : TNDVBSLocatorHelper<LOCATORTYPE>(p) {}
  TNDVBSLocator2Helper(const TNDVBSLocator2Helper<LOCATORTYPE> &a)
      : TNDVBSLocatorHelper<LOCATORTYPE>(a) {}
  TNDVBSLocator2Helper(IDVBSLocator2 *p)
      : TNDVBSLocatorHelper<LOCATORTYPE>(p) {}

  TNDVBSLocator2Helper(const TNLocatorHelper<LOCATORTYPE> &a)
      : TNDVBSLocatorHelper<LOCATORTYPE>(a) {}

  TNDVBSLocator2Helper<LOCATORTYPE> &
  operator=(TNDVBSLocator2Helper<LOCATORTYPE> &rhs) {
...
template <class LOCATORTYPE>
class TNDVBTLocatorHelper : public TNDigitalLocatorHelper<LOCATORTYPE> {
public:
  TNDVBTLocatorHelper() {}
  TNDVBTLocatorHelper(const LOCATORTYPE &a)
      : TNDigitalLocatorHelper<LOCATORTYPE>(a) {}
  ...
  TNDVBTLocatorHelper(const TNDVBTLocatorHelper<LOCATORTYPE> &a)
      : TNDigitalLocatorHelper<LOCATORTYPE>(a) {}
  TNDVBTLocatorHelper(IDVBTLocator *p)
      : TNDigitalLocatorHelper<LOCATORTYPE>(p) {}
...
template <class LOCATORTYPE>
class TNDVBTLocator2Helper : public TNDVBTLocatorHelper<LOCATORTYPE> {
public:
  TNDVBTLocator2Helper() {}
  TNDVBTLocator2Helper(const LOCATORTYPE &a)
      : TNDVBTLocatorHelper<LOCATORTYPE>(a) {}
  TNDVBTLocator2Helper(IUnknown *p) : TNDVBTLocatorHelper<LOCATORTYPE>(p) {}
  TNDVBTLocator2Helper(const TNDVBTLocatorHelper<LOCATORTYPE> &a)
      : TNDVBTLocatorHelper<LOCATORTYPE>(a) {}
  TNDVBTLocator2Helper(IDVBTLocator2 *p)
      : TNDVBTLocatorHelper<LOCATORTYPE>(p) {}
  TNDVBTLocator2Helper(const TNLocatorHelper<LOCATORTYPE> &a)
      : TNDVBTLocatorHelper<LOCATORTYPE>(a) {}
  TNDVBTLocator2Helper<LOCATORTYPE> &
  operator=(TNDVBTLocator2Helper<LOCATORTYPE> &rhs) {
...
template <class LOCATORTYPE>
class TNDVBCLocatorHelper : public TNDigitalLocatorHelper<LOCATORTYPE> {
public:
  TNDVBCLocatorHelper() {}
  TNDVBCLocatorHelper(const LOCATORTYPE &a)
      : TNDigitalLocatorHelper<LOCATORTYPE>(a) {}
  ...
  TNDVBCLocatorHelper(const TNDVBCLocatorHelper<LOCATORTYPE> &a)
      : TNDigitalLocatorHelper<LOCATORTYPE>(a) {}
  TNDVBCLocatorHelper(IDVBCLocator *p)
      : TNDigitalLocatorHelper<LOCATORTYPE>(p) {}
...
template <class TUNEREQUESTTYPE, class LOCATORTYPE>
class TNChannelIDTuneRequestHelper
    : public TNTuneRequestHelper<TUNEREQUESTTYPE, LOCATORTYPE> {
public:
  TNChannelIDTuneRequestHelper() {}
  TNChannelIDTuneRequestHelper(const TNTuneRequest &a)
      : TNTuneRequestHelper<TUNEREQUESTTYPE, LOCATORTYPE>(a) {}
  TNChannelIDTuneRequestHelper(IChannelIDTuneRequest *p)
      : TNTuneRequestHelper<TUNEREQUESTTYPE, LOCATORTYPE>(p) {}
  TNChannelIDTuneRequestHelper(IUnknown *p)
      : TNTuneRequestHelper<TUNEREQUESTTYPE, LOCATORTYPE>(p) {}
  TNChannelIDTuneRequestHelper(
      const TNTuneRequestHelper<TUNEREQUESTTYPE, LOCATORTYPE> &a)
      : TNTuneRequestHelper<TUNEREQUESTTYPE, LOCATORTYPE>(a) {}
  TNChannelIDTuneRequestHelper(
      const TNChannelIDTuneRequestHelper<TUNEREQUESTTYPE, LOCATORTYPE> &a)
      : TNTuneRequestHelper<TUNEREQUESTTYPE, LOCATORTYPE>(a) {}
  TNChannelIDTuneRequestHelper<TUNEREQUESTTYPE, LOCATORTYPE> &
  operator=(TNChannelIDTuneRequestHelper<TUNEREQUESTTYPE, LOCATORTYPE> &rhs) {
    TNTuneRequestHelper<TUNEREQUESTTYPE, LOCATORTYPE>::operator=(rhs);
    return *this;
  }
  template <class TR, class LOC>
  ...
  TNChannelIDTuneRequestHelper<TUNEREQUESTTYPE, LOCATORTYPE> &
  operator=(IChannelIDTuneRequest *rhs) {
    TNTuneRequestHelper<TUNEREQUESTTYPE, LOCATORTYPE>::operator=(rhs);
    return *this;
  }
  TNChannelIDTuneRequestHelper<TUNEREQUESTTYPE, LOCATORTYPE> &
...
typedef TNChannelIDTuneRequestHelper<PQChannelIDTuneRequest, PQLocator>
    TNChannelIDTuneRequest;
...
// digital cable
template <class TUNEREQUESTTYPE, class LOCATORTYPE>
class TNDigitalCableTuneRequestHelper
    : public TNATSCChannelTuneRequestHelper<TUNEREQUESTTYPE, LOCATORTYPE> {
public:
  TNDigitalCableTuneRequestHelper() {}
  TNDigitalCableTuneRequestHelper(const TNTuneRequest &a)
      : TNATSCChannelTuneRequestHelper<TUNEREQUESTTYPE, LOCATORTYPE>(a) {}
  TNDigitalCableTuneRequestHelper(IDigitalCableTuneRequest *p)
      : TNATSCChannelTuneRequestHelper<TUNEREQUESTTYPE, LOCATORTYPE>(p) {}
  TNDigitalCableTuneRequestHelper(IUnknown *p)
      : TNATSCChannelTuneRequestHelper<TUNEREQUESTTYPE, LOCATORTYPE>(p) {}
  TNDigitalCableTuneRequestHelper(
      const TNATSCChannelTuneRequestHelper<TUNEREQUESTTYPE, LOCATORTYPE> &a)
      : TNATSCChannelTuneRequestHelper<TUNEREQUESTTYPE, LOCATORTYPE>(a) {}
  TNDigitalCableTuneRequestHelper(
      const TNDigitalCableTuneRequestHelper<TUNEREQUESTTYPE, LOCATORTYPE> &a)
      : TNATSCChannelTuneRequestHelper<TUNEREQUESTTYPE, LOCATORTYPE>(a) {}
  TNDigitalCableTuneRequestHelper<TUNEREQUESTTYPE, LOCATORTYPE> &operator=(
      TNDigitalCableTuneRequestHelper<TUNEREQUESTTYPE, LOCATORTYPE> &rhs) {
    TNATSCChannelTuneRequestHelper<TUNEREQUESTTYPE, LOCATORTYPE>::operator=(
        rhs);
    return *this;
  }
  template <class TR, class LOC>
  TNDigitalCableTuneRequestHelper<TUNEREQUESTTYPE, LOCATORTYPE> &
  operator=(TNTuneRequestHelper<TR, LOC> &rhs) {
    TNATSCChannelTuneRequestHelper<TUNEREQUESTTYPE, LOCATORTYPE>::operator=(
        TR(rhs));
    return *this;
  ...
  TNDigitalCableTuneRequestHelper<TUNEREQUESTTYPE, LOCATORTYPE> &
  operator=(IDigitalCableTuneRequest *rhs) {
    TNATSCChannelTuneRequestHelper<TUNEREQUESTTYPE, LOCATORTYPE>::operator=(
        rhs);
    return *this;
  }
...
typedef TNDigitalCableTuneRequestHelper<PQDigitalCableTuneRequest,
                                        PQATSCLocator>
    TNDigitalCableTuneRequest;
...
typedef TNDVBTuneRequestHelper<PQDVBTuneRequest, PQDigitalLocator>
    TNDVBTuneRequest;
