...
typedef interface ITransactionPhase0EnlistmentAsync
...
typedef interface IDtcLuRecoveryInitiatedByDtcTransWork
...
typedef interface IDtcLuRecoveryInitiatedByDtcStatusWork
...
typedef interface IDtcLuRecoveryInitiatedByLuWork
...
typedef struct xa_switch_t {
  ...
  int(__cdecl *xa_forget_entry)(XID *__MIDL____MIDL_itf_txdtc_0000_00000033,
                                int __MIDL____MIDL_itf_txdtc_0000_00000034,
                                long __MIDL____MIDL_itf_txdtc_0000_00000035);
  int(__cdecl *xa_complete_entry)(int *__MIDL____MIDL_itf_txdtc_0000_00000037,
...
typedef struct IXATransLookupVtbl {
  ...
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in IXATransLookup *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IXATransLookup *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IXATransLookup *This);
...
interface IXATransLookup { CONST_VTBL struct IXATransLookupVtbl *lpVtbl; };
...
typedef struct IXATransLookup2Vtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in IXATransLookup2 *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IXATransLookup2 *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IXATransLookup2 *This);
...
interface IXATransLookup2 { CONST_VTBL struct IXATransLookup2Vtbl *lpVtbl; };
...
typedef struct IResourceManagerSinkVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IResourceManagerSink *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IResourceManagerSink *This);

  DECLSPEC_XFGVIRT(IResourceManagerSink, TMDown)
  HRESULT(STDMETHODCALLTYPE *TMDown)(__RPC__in IResourceManagerSink *This);
...
public:
  virtual HRESULT STDMETHODCALLTYPE Enlist(
      ...
      /* [out] */ __RPC__deref_out_opt ITransactionEnlistmentAsync *
          *ppEnlist) = 0;
...
typedef struct IResourceManagerVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in IResourceManager *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IResourceManager *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IResourceManager *This);
...
typedef struct ILastResourceManagerVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in ILastResourceManager *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in ILastResourceManager *This);
...
typedef struct IResourceManager2Vtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in IResourceManager2 *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IResourceManager2 *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IResourceManager2 *This);
...
typedef struct IResourceManagerRejoinableVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IResourceManagerRejoinable *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IResourceManagerRejoinable *This);
...
#define IResourceManagerRejoinable_AddRef(This) ((This)->lpVtbl->AddRef(This))

#define IResourceManagerRejoinable_Release(This) ((This)->lpVtbl->Release(This))

#define IResourceManagerRejoinable_Enlist(This, pTransaction, pRes, pUOW,      \
                                          pisoLevel, ppEnlist)                 \
  ((This)->lpVtbl->Enlist(This, pTransaction, pRes, pUOW, pisoLevel, ppEnlist))

#define IResourceManagerRejoinable_Reenlist(This, pPrepInfo, cbPrepInfo,       \
                                            lTimeout, pXactStat)               \
  ((This)->lpVtbl->Reenlist(This, pPrepInfo, cbPrepInfo, lTimeout, pXactStat))
...
#define IResourceManagerRejoinable_GetDistributedTransactionManager(This, iid, \
                                                                    ppvObject) \
  ((This)->lpVtbl->GetDistributedTransactionManager(This, iid, ppvObject))

#define IResourceManagerRejoinable_Enlist2(This, pTransaction, pResAsync,      \
                                           pUOW, pisoLevel, pXid, ppEnlist)    \
  ((This)->lpVtbl->Enlist2(This, pTransaction, pResAsync, pUOW, pisoLevel,     \
                           pXid, ppEnlist))
...
#define IResourceManagerRejoinable_Rejoin(This, pPrepInfo, cbPrepInfo,         \
                                          lTimeout, pXactStat)                 \
...
typedef struct IXAConfigVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in IXAConfig *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IXAConfig *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IXAConfig *This);

  DECLSPEC_XFGVIRT(IXAConfig, Initialize)
  HRESULT(STDMETHODCALLTYPE *Initialize)(__RPC__in IXAConfig *This,
                                         /* [in] */ GUID clsidHelperDll);

  DECLSPEC_XFGVIRT(IXAConfig, Terminate)
  HRESULT(STDMETHODCALLTYPE *Terminate)(__RPC__in IXAConfig *This);

  END_INTERFACE
} IXAConfigVtbl;

interface IXAConfig { CONST_VTBL struct IXAConfigVtbl *lpVtbl; };
...
typedef struct IRMHelperVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(IRMHelper *This,
                                             /* [in] */ REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);
  ...
  HRESULT(STDMETHODCALLTYPE *RMCount)(IRMHelper *This,
                                      /* [in] */ DWORD dwcTotalNumberOfRMs);

  DECLSPEC_XFGVIRT(IRMHelper, RMInfo)
  HRESULT(STDMETHODCALLTYPE *RMInfo)(IRMHelper *This,
                                     /* [in] */ xa_switch_t *pXa_Switch,
                                     /* [in] */ BOOL fCDeclCallingConv,
                                     /* [annotation][string][in] */
                                     _Null_terminated_ char *pszOpenString,
...
interface IRMHelper { CONST_VTBL struct IRMHelperVtbl *lpVtbl; };
...
typedef struct IXAObtainRMInfoVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in IXAObtainRMInfo *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IXAObtainRMInfo *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IXAObtainRMInfo *This);
...
interface IXAObtainRMInfo { CONST_VTBL struct IXAObtainRMInfoVtbl *lpVtbl; };
...
typedef struct IResourceManagerFactoryVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IResourceManagerFactory *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IResourceManagerFactory *This);
...
typedef struct IResourceManagerFactory2Vtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IResourceManagerFactory2 *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IResourceManagerFactory2 *This);
...
typedef struct IPrepareInfoVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(IPrepareInfo *This,
                                             /* [in] */ REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);
  ...
  HRESULT(STDMETHODCALLTYPE *GetPrepareInfo)(IPrepareInfo *This,
                                             /* [out] */ byte *pPrepInfo);

  END_INTERFACE
} IPrepareInfoVtbl;

interface IPrepareInfo { CONST_VTBL struct IPrepareInfoVtbl *lpVtbl; };
...
public:
  ...
  virtual HRESULT STDMETHODCALLTYPE GetPrepareInfo(
      ...
      /* [size_is][out] */ __RPC__out_ecount_full(cbPrepareInfo) byte *
          pPrepInfo) = 0;
};
...
typedef struct IPrepareInfo2Vtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in IPrepareInfo2 *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IPrepareInfo2 *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IPrepareInfo2 *This);
...
interface IPrepareInfo2 { CONST_VTBL struct IPrepareInfo2Vtbl *lpVtbl; };
...
typedef struct IGetDispenserVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in IGetDispenser *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IGetDispenser *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IGetDispenser *This);
...
interface IGetDispenser { CONST_VTBL struct IGetDispenserVtbl *lpVtbl; };
...
public:
  virtual HRESULT STDMETHODCALLTYPE Create(
      ...
      /* [out] */ __RPC__deref_out_opt ITransactionVoterBallotAsync2 *
          *ppVoterBallot) = 0;
};
...
typedef struct ITransactionVoterFactory2Vtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in ITransactionVoterFactory2 *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in ITransactionVoterFactory2 *This);
...
public:
  virtual HRESULT STDMETHODCALLTYPE Phase0Request(BOOL fAbortingHint) = 0;
...
typedef struct ITransactionPhase0NotifyAsyncVtbl {
  ...
  HRESULT(STDMETHODCALLTYPE *Phase0Request)(
      __RPC__in ITransactionPhase0NotifyAsync *This, BOOL fAbortingHint);
...
public:
  virtual HRESULT STDMETHODCALLTYPE Create(
      ...
      /* [out] */ __RPC__deref_out_opt ITransactionPhase0EnlistmentAsync *
          *ppPhase0Enlistment) = 0;
};
...
typedef struct ITransactionPhase0FactoryVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in ITransactionPhase0Factory *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in ITransactionPhase0Factory *This);
  ...
  HRESULT(STDMETHODCALLTYPE *Create)(
      ...
      /* [in] */ __RPC__in_opt ITransactionPhase0NotifyAsync *pPhase0Notify,
      /* [out] */
      __RPC__deref_out_opt ITransactionPhase0EnlistmentAsync *
          *ppPhase0Enlistment);
...
public:
  ...
  virtual HRESULT STDMETHODCALLTYPE UnmarshalReturnToken(
      ...
      /* [size_is][in] */ __RPC__in_ecount_full(cbReturnToken) byte *
          rgbReturnToken) = 0;
...
typedef struct ITransactionTransmitterVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in ITransactionTransmitter *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in ITransactionTransmitter *This);
  ...
  HRESULT(STDMETHODCALLTYPE *Reset)(__RPC__in ITransactionTransmitter *This);
...
public:
  virtual HRESULT STDMETHODCALLTYPE Create(
      /* [out] */ __RPC__deref_out_opt ITransactionTransmitter *
      *ppTransmitter) = 0;
};
...
public:
  ...
  virtual HRESULT STDMETHODCALLTYPE MarshalReturnToken(
      /* [in] */ ULONG cbReturnToken,
      /* [size_is][out] */ __RPC__out_ecount_full(cbReturnToken) byte *
          rgbReturnToken,
      /* [out] */ __RPC__out ULONG * pcbUsed) = 0;
...
typedef struct ITransactionReceiverVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in ITransactionReceiver *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in ITransactionReceiver *This);
  ...
  HRESULT(STDMETHODCALLTYPE *Reset)(__RPC__in ITransactionReceiver *This);
...
typedef struct ITransactionReceiverFactoryVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in ITransactionReceiverFactory *This);
...
typedef struct IDtcLuConfigureVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in IDtcLuConfigure *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IDtcLuConfigure *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IDtcLuConfigure *This);
...
interface IDtcLuConfigure { CONST_VTBL struct IDtcLuConfigureVtbl *lpVtbl; };
...
IDtcLuRecovery : public IUnknown{public : };
...
typedef struct IDtcLuRecoveryVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in IDtcLuRecovery *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IDtcLuRecovery *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IDtcLuRecovery *This);

  END_INTERFACE
} IDtcLuRecoveryVtbl;

interface IDtcLuRecovery { CONST_VTBL struct IDtcLuRecoveryVtbl *lpVtbl; };
...
typedef struct IDtcLuRecoveryFactoryVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IDtcLuRecoveryFactory *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IDtcLuRecoveryFactory *This);
...
typedef enum _DtcLu_Xln_Confirmation {
  ...
  DTCLUXLNCONFIRMATION_COLDWARMMISMATCH =
      (DTCLUXLNCONFIRMATION_LOGNAMEMISMATCH + 1),
...
typedef struct IDtcLuRecoveryInitiatedByDtcTransWorkVtbl {
  ...
  DECLSPEC_XFGVIRT(IDtcLuRecoveryInitiatedByDtcTransWork,
...
typedef struct IDtcLuRecoveryInitiatedByDtcVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(IDtcLuRecoveryInitiatedByDtc *This,
                                             /* [in] */ REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);
...
typedef struct IDtcLuRecoveryInitiatedByLuWorkVtbl {
  ...
  DECLSPEC_XFGVIRT(IDtcLuRecoveryInitiatedByLuWork,
...
public:
  virtual HRESULT STDMETHODCALLTYPE GetObjectToHandleWorkFromLu(
      /* [out] */ __RPC__deref_out_opt IDtcLuRecoveryInitiatedByLuWork *
      *ppWork) = 0;
};
...
typedef struct IDtcLuRecoveryInitiatedByLuVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IDtcLuRecoveryInitiatedByLu *This);
...
typedef struct IDtcLuRmEnlistmentVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in IDtcLuRmEnlistment *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IDtcLuRmEnlistment *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IDtcLuRmEnlistment *This);

  DECLSPEC_XFGVIRT(IDtcLuRmEnlistment, Unplug)
  HRESULT(STDMETHODCALLTYPE *Unplug)(__RPC__in IDtcLuRmEnlistment *This,
                                     /* [in] */ BOOL fConversationLost);

  DECLSPEC_XFGVIRT(IDtcLuRmEnlistment, BackedOut)
  HRESULT(STDMETHODCALLTYPE *BackedOut)(__RPC__in IDtcLuRmEnlistment *This);

  DECLSPEC_XFGVIRT(IDtcLuRmEnlistment, BackOut)
  HRESULT(STDMETHODCALLTYPE *BackOut)(__RPC__in IDtcLuRmEnlistment *This);

  DECLSPEC_XFGVIRT(IDtcLuRmEnlistment, Committed)
  HRESULT(STDMETHODCALLTYPE *Committed)(__RPC__in IDtcLuRmEnlistment *This);

  DECLSPEC_XFGVIRT(IDtcLuRmEnlistment, Forget)
  HRESULT(STDMETHODCALLTYPE *Forget)(__RPC__in IDtcLuRmEnlistment *This);

  DECLSPEC_XFGVIRT(IDtcLuRmEnlistment, RequestCommit)
  HRESULT(STDMETHODCALLTYPE *RequestCommit)(__RPC__in IDtcLuRmEnlistment *This);
...
typedef struct IDtcLuRmEnlistmentSinkVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IDtcLuRmEnlistmentSink *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IDtcLuRmEnlistmentSink *This);

  DECLSPEC_XFGVIRT(IDtcLuRmEnlistmentSink, AckUnplug)
  HRESULT(STDMETHODCALLTYPE *AckUnplug)(__RPC__in IDtcLuRmEnlistmentSink *This);

  DECLSPEC_XFGVIRT(IDtcLuRmEnlistmentSink, TmDown)
  HRESULT(STDMETHODCALLTYPE *TmDown)(__RPC__in IDtcLuRmEnlistmentSink *This);
  ...
  HRESULT(STDMETHODCALLTYPE *BackedOut)(__RPC__in IDtcLuRmEnlistmentSink *This);

  DECLSPEC_XFGVIRT(IDtcLuRmEnlistmentSink, BackOut)
  HRESULT(STDMETHODCALLTYPE *BackOut)(__RPC__in IDtcLuRmEnlistmentSink *This);

  DECLSPEC_XFGVIRT(IDtcLuRmEnlistmentSink, Committed)
  HRESULT(STDMETHODCALLTYPE *Committed)(__RPC__in IDtcLuRmEnlistmentSink *This);

  DECLSPEC_XFGVIRT(IDtcLuRmEnlistmentSink, Forget)
  HRESULT(STDMETHODCALLTYPE *Forget)(__RPC__in IDtcLuRmEnlistmentSink *This);

  DECLSPEC_XFGVIRT(IDtcLuRmEnlistmentSink, Prepare)
  HRESULT(STDMETHODCALLTYPE *Prepare)(__RPC__in IDtcLuRmEnlistmentSink *This);
...
typedef struct IDtcLuRmEnlistmentFactoryVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(IDtcLuRmEnlistmentFactory *This,
                                             /* [in] */ REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);
...
typedef struct IDtcLuSubordinateDtcVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IDtcLuSubordinateDtc *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IDtcLuSubordinateDtc *This);

  DECLSPEC_XFGVIRT(IDtcLuSubordinateDtc, Unplug)
  HRESULT(STDMETHODCALLTYPE *Unplug)(__RPC__in IDtcLuSubordinateDtc *This,
                                     /* [in] */ BOOL fConversationLost);

  DECLSPEC_XFGVIRT(IDtcLuSubordinateDtc, BackedOut)
  HRESULT(STDMETHODCALLTYPE *BackedOut)(__RPC__in IDtcLuSubordinateDtc *This);

  DECLSPEC_XFGVIRT(IDtcLuSubordinateDtc, BackOut)
  HRESULT(STDMETHODCALLTYPE *BackOut)(__RPC__in IDtcLuSubordinateDtc *This);

  DECLSPEC_XFGVIRT(IDtcLuSubordinateDtc, Committed)
  HRESULT(STDMETHODCALLTYPE *Committed)(__RPC__in IDtcLuSubordinateDtc *This);

  DECLSPEC_XFGVIRT(IDtcLuSubordinateDtc, Forget)
  HRESULT(STDMETHODCALLTYPE *Forget)(__RPC__in IDtcLuSubordinateDtc *This);

  DECLSPEC_XFGVIRT(IDtcLuSubordinateDtc, Prepare)
  HRESULT(STDMETHODCALLTYPE *Prepare)(__RPC__in IDtcLuSubordinateDtc *This);
...
typedef struct IDtcLuSubordinateDtcSinkVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(IDtcLuSubordinateDtcSink *This,
                                             /* [in] */ REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);
...
typedef struct IDtcLuSubordinateDtcFactoryVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(IDtcLuSubordinateDtcFactory *This,
                                             /* [in] */ REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);
...
DEFINE_GUID(IID_IResourceManager, 0x13741d21, 0x87eb, 0x11ce, 0x80, 0x81, 0x00,
            0x80, 0xc7, 0x58, 0x52, 0x7e);
DEFINE_GUID(IID_IResourceManagerRejoinable, 0x6f6de620, 0xb5df, 0x4f3e, 0x9c,
            0xfa, 0xc8, 0xae, 0xbd, 0x05, 0x17, 0x2b);
...
#define IID_ITransactionVoterNotifyAsync2                                      \
  __uuidof(ITransactionVoterNotifyAsync2)
#define IID_ITransactionVoterBallotAsync2                                      \
  __uuidof(ITransactionVoterBallotAsync2)
#define IID_ITransactionVoterFactory2 __uuidof(ITransactionVoterFactory2)
#define IID_ITransactionPhase0EnlistmentAsync                                  \
  __uuidof(ITransactionPhase0EnlistmentAsync)
#define IID_ITransactionPhase0NotifyAsync                                      \
  __uuidof(ITransactionPhase0NotifyAsync)
...
#define IID_ITransactionTransmitterFactory                                     \
  __uuidof(ITransactionTransmitterFactory)
...
#define IID_IDtcLuRecoveryInitiatedByDtcTransWork                              \
  __uuidof(IDtcLuRecoveryInitiatedByDtcTransWork)
#define IID_IDtcLuRecoveryInitiatedByDtcStatusWork                             \
  __uuidof(IDtcLuRecoveryInitiatedByDtcStatusWork)
#define IID_IDtcLuRecoveryInitiatedByDtc __uuidof(IDtcLuRecoveryInitiatedByDtc)
#define IID_IDtcLuRecoveryInitiatedByLuWork                                    \
  __uuidof(IDtcLuRecoveryInitiatedByLuWork)
