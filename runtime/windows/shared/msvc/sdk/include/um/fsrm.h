...
#define FSRM_DISPID_INTERFACE_MASK                                             \
  ((((FSRM_DISPID_INTERFACE_A_MASK | FSRM_DISPID_INTERFACE_B_MASK) |           \
...
#define FSRM_DISPID_METHOD_MASK                                                \
  ((FSRM_DISPID_IS_PROPERTY | FSRM_DISPID_METHOD_NUM_MASK))
...
typedef struct IFsrmObjectVtbl {
  ...
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in IFsrmObject *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IFsrmObject *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IFsrmObject *This);
...
interface IFsrmObject { CONST_VTBL struct IFsrmObjectVtbl *lpVtbl; };
...
typedef struct IFsrmCollectionVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in IFsrmCollection *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IFsrmCollection *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IFsrmCollection *This);
...
interface IFsrmCollection { CONST_VTBL struct IFsrmCollectionVtbl *lpVtbl; };
...
public:
  ...
  virtual /* [helpstring][id] */ HRESULT STDMETHODCALLTYPE Clone(
      /* [retval][out] */ __RPC__deref_out_opt IFsrmMutableCollection *
      *collection) = 0;
};
...
typedef struct IFsrmMutableCollectionVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IFsrmMutableCollection *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IFsrmMutableCollection *This);
...
typedef struct IFsrmCommittableCollectionVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IFsrmCommittableCollection *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IFsrmCommittableCollection *This);
...
typedef struct IFsrmActionVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in IFsrmAction *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IFsrmAction *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IFsrmAction *This);
...
interface IFsrmAction { CONST_VTBL struct IFsrmActionVtbl *lpVtbl; };
...
typedef struct IFsrmActionEmailVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in IFsrmActionEmail *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IFsrmActionEmail *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IFsrmActionEmail *This);
  ...
  DECLSPEC_XFGVIRT(IFsrmAction, put_RunLimitInterval)
  /* [helpstring][id][propput] */ HRESULT(
      STDMETHODCALLTYPE *put_RunLimitInterval)(__RPC__in IFsrmActionEmail *This,
                                               /* [in] */ long minutes);
...
interface IFsrmActionEmail { CONST_VTBL struct IFsrmActionEmailVtbl *lpVtbl; };
...
typedef struct IFsrmActionEmail2Vtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in IFsrmActionEmail2 *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IFsrmActionEmail2 *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IFsrmActionEmail2 *This);
  ...
  DECLSPEC_XFGVIRT(IFsrmAction, put_RunLimitInterval)
  /* [helpstring][id][propput] */ HRESULT(
      STDMETHODCALLTYPE *put_RunLimitInterval)(
      __RPC__in IFsrmActionEmail2 *This,
      /* [in] */ long minutes);
...
typedef struct IFsrmActionReportVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in IFsrmActionReport *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IFsrmActionReport *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IFsrmActionReport *This);
...
typedef struct IFsrmActionEventLogVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IFsrmActionEventLog *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IFsrmActionEventLog *This);
...
typedef struct IFsrmActionCommandVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in IFsrmActionCommand *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IFsrmActionCommand *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IFsrmActionCommand *This);
  ...
  /* [helpstring][id][propget] */ HRESULT(
      STDMETHODCALLTYPE *get_ExecutablePath)(
      __RPC__in IFsrmActionCommand *This,
      /* [retval][out] */ __RPC__deref_out_opt BSTR *executablePath);

  DECLSPEC_XFGVIRT(IFsrmActionCommand, put_ExecutablePath)
  /* [helpstring][id][propput] */ HRESULT(
      STDMETHODCALLTYPE *put_ExecutablePath)(__RPC__in IFsrmActionCommand *This,
                                             /* [in] */ __RPC__in BSTR
                                                 executablePath);
...
typedef struct IFsrmSettingVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in IFsrmSetting *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IFsrmSetting *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IFsrmSetting *This);
...
interface IFsrmSetting { CONST_VTBL struct IFsrmSettingVtbl *lpVtbl; };
...
#define IFsrmSetting_SetActionRunLimitInterval(This, actionType,               \
                                               delayTimeMinutes)               \
  ((This)->lpVtbl->SetActionRunLimitInterval(This, actionType,                 \
                                             delayTimeMinutes))

#define IFsrmSetting_GetActionRunLimitInterval(This, actionType,               \
                                               delayTimeMinutes)               \
  ((This)->lpVtbl->GetActionRunLimitInterval(This, actionType,                 \
                                             delayTimeMinutes))
...
typedef struct IFsrmPathMapperVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in IFsrmPathMapper *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IFsrmPathMapper *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IFsrmPathMapper *This);
...
interface IFsrmPathMapper { CONST_VTBL struct IFsrmPathMapperVtbl *lpVtbl; };
...
public:
  ...
  virtual /* [helpstring][id] */ HRESULT STDMETHODCALLTYPE ImportFileGroups(
      ...
      /* [retval][out] */ __RPC__deref_out_opt IFsrmCommittableCollection *
          *fileGroups) = 0;
...
typedef struct IFsrmExportImportVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in IFsrmExportImport *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IFsrmExportImport *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IFsrmExportImport *This);
...
#define IFsrmExportImport_ExportQuotaTemplates(                                \
    This, filePath, templateNamesSafeArray, remoteHost)                        \
  ((This)->lpVtbl->ExportQuotaTemplates(This, filePath,                        \
                                        templateNamesSafeArray, remoteHost))

#define IFsrmExportImport_ImportQuotaTemplates(                                \
    This, filePath, templateNamesSafeArray, remoteHost, templates)             \
  ((This)->lpVtbl->ImportQuotaTemplates(                                       \
      This, filePath, templateNamesSafeArray, remoteHost, templates))
...
typedef struct IFsrmDerivedObjectsResultVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IFsrmDerivedObjectsResult *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IFsrmDerivedObjectsResult *This);
  ...
  /* [helpstring][id][propget] */ HRESULT(
      STDMETHODCALLTYPE *get_DerivedObjects)(
      __RPC__in IFsrmDerivedObjectsResult *This,
      /* [retval][out] */ __RPC__deref_out_opt IFsrmCollection *
          *derivedObjects);
