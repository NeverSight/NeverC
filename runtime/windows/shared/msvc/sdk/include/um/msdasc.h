...
typedef struct IServiceVtbl {
  ...
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in IService *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IService *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IService *This);
...
interface IService { CONST_VTBL struct IServiceVtbl *lpVtbl; };
...
typedef struct IDBPromptInitializeVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(IDBPromptInitialize *This,
                                             /* [in] */ REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);
...
public:
  virtual /* [helpstring] */ HRESULT STDMETHODCALLTYPE GetDataSource(
      ...
      /* [in] */ __RPC__in REFIID riid,
      /* [iid_is][out][in] */ __RPC__deref_inout_opt IUnknown *
          *ppDataSource) = 0;
  ...
  virtual /* [local][helpstring] */ HRESULT STDMETHODCALLTYPE
  CreateDBInstanceEx(
  ...
  virtual /* [helpstring] */ HRESULT STDMETHODCALLTYPE LoadStringFromStorage(
      ...
      /* [out] */ __RPC__deref_out_opt LPOLESTR *
          ppwszInitializationString) = 0;
...
typedef struct IDataInitializeVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in IDataInitialize *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IDataInitialize *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IDataInitialize *This);
...
interface IDataInitialize { CONST_VTBL struct IDataInitializeVtbl *lpVtbl; };
...
#define IDataInitialize_GetDataSource(                                         \
  ...
  ((This)->lpVtbl->GetDataSource(This, pUnkOuter, dwClsCtx,                    \
                                 pwszInitializationString, riid,               \
                                 ppDataSource))

#define IDataInitialize_GetInitializationString(                               \
    This, pDataSource, fIncludePassword, ppwszInitString)                      \
  ((This)->lpVtbl->GetInitializationString(This, pDataSource,                  \
                                           fIncludePassword, ppwszInitString))
...
#define IDataInitialize_CreateDBInstanceEx(This, clsidProvider, pUnkOuter,     \
  ...
  ((This)->lpVtbl->CreateDBInstanceEx(This, clsidProvider, pUnkOuter,          \
                                      dwClsCtx, pwszReserved, pServerInfo,     \
                                      cmq, rgmqResults))
...
/* [call_as] */ HRESULT
STDMETHODCALLTYPE IDataInitialize_RemoteCreateDBInstanceEx_Proxy(
    __RPC__in IDataInitialize *This,
    /* [in] */ __RPC__in REFCLSID clsidProvider,
    /* [in] */ __RPC__in_opt IUnknown *pUnkOuter,
    /* [in] */ DWORD dwClsCtx,
...
typedef struct IDataSourceLocatorVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in IDataSourceLocator *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IDataSourceLocator *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IDataSourceLocator *This);
...
class DECLSPEC_UUID("CCB4EC60-B9DC-11D1-AC80-00A0C9034873") PDPO;
#endif
...
class DECLSPEC_UUID("FF151822-B0BF-11D1-A80D-000000000000") RootBinder;
#endif
...
/* [local][helpstring] */ HRESULT STDMETHODCALLTYPE
IDataInitialize_CreateDBInstanceEx_Proxy(IDataInitialize *This,
                                         /* [in] */ REFCLSID clsidProvider,
                                         /* [annotation][in] */
                                         _In_opt_ IUnknown *pUnkOuter,
                                         /* [in] */ DWORD dwClsCtx,
...
IDataInitialize_CreateDBInstanceEx_Stub(
    __RPC__in IDataInitialize *This,
    /* [in] */ __RPC__in REFCLSID clsidProvider,
    /* [in] */ __RPC__in_opt IUnknown *pUnkOuter,
    /* [in] */ DWORD dwClsCtx,
