...
// MessageText:
//
// A callback was marked to be disconnected later because the request to
// disconnect the operation came while a callback was executing.
//
...
// MessageText:
//
// The operation completed successfully, but some updates were skipped because
...
// MessageText:
//
// The operation is skipped because the update service does not support the
...
// MessageText:
//
// A server configuration refresh resulted in metadata signature verification to
// be ignored.
//
#define WU_S_METADATA_IGNORED_SIGNATURE_VERIFICATION                           \
  _HRESULT_TYPEDEF_(0x00247102L)
...
// MessageText:
//
// Search operation completed successfully but one or more services were
// shedding load.
//
...
// MessageText:
//
// The update handler requested a byte range overlapping a previously requested
// range.
//
...
// MessageText:
//
// Another conflicting operation was in progress. Some operations such as
// installation cannot be performed twice simultaneously.
//
...
// MessageText:
//
// Windows Update Agent could not find required information in the update's XML
// data.
//
...
// MessageText:
//
// The operation could not be performed because the Windows Update Agent is
// self-updating.
//
...
// MessageText:
//
// The update could not be uninstalled because the request did not originate
// from a WSUS server.
//
...
// MessageText:
//
// Search may have missed some updates before there is an unlicensed application
// on the system.
//
...
// MessageText:
//
// A delta-compressed update could not be installed because it required the
// source.
//
...
// MessageText:
//
// Operation did not complete because the DisableWindowsUpdateAccess policy was
// set.
//
...
// MessageText:
//
// A search was attempted with a scope that is not currently supported for this
// type of search.
//
...
//
// This error (0x80240047) has been removed to avoid confusion with
// WU_E_NOT_SUPPORTED (note the underscore).
//
...
// MessageText:
//
// An update could not be installed because the system battery power level is
// too low.
//
...
// MessageText:
//
// A discovery call contributed to a non-zero operation count at idle timer
// shutdown.
//
...
// MessageText:
//
// A search call contributed to a non-zero operation count at idle timer
// shutdown.
//
...
// MessageText:
//
// A download call contributed to a non-zero operation count at idle timer
// shutdown.
//
...
// MessageText:
//
// An install call contributed to a non-zero operation count at idle timer
// shutdown.
//
...
// MessageText:
//
// An unspecified call contributed to a non-zero operation count at idle timer
// shutdown.
//
...
// MessageText:
//
// An interactive user cancelled this operation, which was started from the
// Windows Update Agent UI.
//
...
// MessageText:
//
// Automatic Updates cancelled this operation because it applies to an update
// that is no longer applicable to this computer.
//
...
// MessageText:
//
// The requested update download or install handler, or update applicability
// expression evaluator, is not provided by this Agent plugin.
//
...
// MessageText:
//
// The current network cost does not meet the conditions set by the network cost
// policy.
//
...
// MessageText:
//
// The call is cancelled because it applies to an update that is hidden (no
// longer applicable to this computer).
//
...
// MessageText:
//
// The call is cancelled because it applies to an update that is invalid (no
// longer applicable to this computer).
//
...
// MessageText:
//
// A service registration call contributed to a non-zero operation count at idle
// timer shutdown.
//
#define WU_E_IDLESHUTDOWN_OPCOUNT_SERVICEREGISTRATION                          \
  _HRESULT_TYPEDEF_(0x80240060L)
...
// MessageText:
//
// Signature validation of the file fails to find valid SHA2+ signature on MS
// signed payload.
//
...
// MessageText:
//
// The search call was cancelled by another interactive search against the same
// service.
//
...
// MessageText:
//
// Operation is not allowed because the device is in DC (Direct Current) and DS
...
// MessageText:
//
// Operation did not complete because the service process exited unexpectedly
// with a non-successful exit code.
//
...
// MessageText:
//
// Access was denied because the caller identity does not fit the requirements
// for this call.
//
...
// MessageText:
//
// Operation did not complete because the service is disabled and re-enabling it
// has failed as the access was denied.
//
...
// MessageText:
//
// Search may have missed some updates because the Windows Installer is less
// than version 3.1.
//
...
// MessageText:
//
// Search may have missed some updates because the Windows Installer is not
// configured.
//
...
// MessageText:
//
// Search may have missed some updates because policy has disabled Windows
// Installer patching.
//
...
// MessageText:
//
// Search may have missed some updates because there was a failure of the
// Windows Installer.
//
...
// MessageText:
//
// WU_E_PT_SOAPCLIENT_* error codes map to the SOAPCLIENT_ERROR enum of the ATL
// Server Library.
//
...
// MessageText:
//
// Same as SOAPCLIENT_INITIALIZE_ERROR - initialization of the SOAP client
// failed, possibly because of an MSXML installation failure.
//
...
// MessageText:
//
// Same as SOAPCLIENT_OUTOFMEMORY - SOAP client failed because it ran out of
// memory.
//
...
// MessageText:
//
// Same as SOAPCLIENT_GENERATE_ERROR - SOAP client failed to generate the
// request.
//
...
// MessageText:
//
// Same as SOAPCLIENT_CONNECT_ERROR - SOAP client failed to connect to the
// server.
//
...
// MessageText:
//
// Same as SOAPCLIENT_SEND_ERROR - SOAP client failed to send a message for
// reasons of WU_E_WINHTTP_* error codes.
//
...
// MessageText:
//
// Same as SOAPCLIENT_SERVER_ERROR - SOAP client failed because there was a
// server error.
//
...
// MessageText:
//
// Same as SOAPCLIENT_SOAPFAULT - SOAP client failed because there was a SOAP
// fault for reasons of WU_E_PT_SOAP_* error codes.
//
...
// MessageText:
//
// Same as SOAPCLIENT_PARSEFAULT_ERROR - SOAP client failed to parse a SOAP
// fault.
//
...
// MessageText:
//
// Same as SOAPCLIENT_READ_ERROR - SOAP client failed while reading the response
// from the server.
//
...
// MessageText:
//
// Same as SOAPCLIENT_PARSE_ERROR - SOAP client failed to parse the response
// from the server.
//
...
// MessageText:
//
// Same as SOAP_E_VERSION_MISMATCH - SOAP client found an unrecognizable
...
// MessageText:
//
// Same as SOAP_E_MUST_UNDERSTAND - SOAP client was unable to understand a
// header.
//
...
// MessageText:
//
// Same as SOAP_E_CLIENT - SOAP client found the message was malformed; fix
// before resending.
//
...
// MessageText:
//
// Same as SOAP_E_SERVER - The SOAP message could not be processed due to a
// server error; resend later.
//
...
// MessageText:
//
// The reply from the server indicates that the server was changed or the cookie
// was invalid; refresh the state of the internal cache and retry.
//
...
// MessageText:
//
// Same as HTTP status 401 - the requested resource requires user
// authentication.
//
...
// MessageText:
//
// Same as HTTP status 403 - server understood the request, but declined to
// fulfill it.
//
...
// MessageText:
//
// Same as HTTP status 404 - the server cannot find the requested URI (Uniform
// Resource Identifier).
//
//
...
// MessageText:
//
// Same as HTTP status 409 - the request was not completed due to a conflict
...
// MessageText:
//
// Same as HTTP status 410 - requested resource is no longer available at the
// server.
//
...
// MessageText:
//
// Same as HTTP status 500 - an error internal to the server prevented
...
// MessageText:
//
// Same as HTTP status 500 - server does not support the functionality required
...
// MessageText:
//
// Same as HTTP status 505 - the server does not support the HTTP protocol
...
// MessageText:
//
// Operation failed due to a changed file location; refresh internal state and
// resend.
//
...
// MessageText:
//
// Operation failed because Windows Update Agent does not support registration
...
// MessageText:
//
// The HTTP request could not be completed and the reason did not correspond to
// any of the WU_E_PT_HTTP_* error codes.
//
...
// MessageText:
//
// Same as ERROR_WINHTTP_NAME_NOT_RESOLVED - the proxy server or target server
...
// MessageText:
//
// Windows Update Agent is enforcing honoring the service load shedding
// interval.
//
...
// MessageText:
//
// Windows Update Agent failed to download a redirector cabinet file with a new
// redirectorId value from the server during the recovery.
//
...
//
#define WU_E_PT_ECP_FAILURE_TO_DECOMPRESS_CAB_FILE                             \
  _HRESULT_TYPEDEF_(0x80244034L)
...
// MessageText:
//
// The server does not support category-specific search; Full catalog search has
...
// MessageText:
//
// The operation is invalid because protocol talker is in an inappropriate
// state.
//
...
// MessageText:
//
// The client is data boundary restricted and needs to talk to a restricted
// endpoint.
//
...
// MessageText:
//
// The redirectorId in the downloaded redirector cab is less than in the cached
// cab.
//
...
// MessageText:
//
// The maximum number of name value pairs was exceeded by the attribute
// provider.
//
#define WU_E_REDIRECTOR_ATTRPROVIDER_EXCEEDED_MAX_NAMEVALUE                    \
  _HRESULT_TYPEDEF_(0x80245008L)
...
//
#define WU_E_REDIRECTOR_ATTRPROVIDER_INVALID_VALUE                             \
  _HRESULT_TYPEDEF_(0x8024500AL)
...
// MessageText:
//
// There was an error in connecting to or parsing the response from the Service
// Locator Service redirector server.
//
...
// MessageText:
//
// The redirector failed for reasons not covered by another WU_E_REDIRECTOR_*
// error code.
//
...
// MessageText:
//
// There were pending reboot actions, but cached SLS response was not found
// post-reboot.
//
#define WU_E_SIH_POST_REBOOT_NO_CACHED_SLS_RESPONSE                            \
  _HRESULT_TYPEDEF_(0x8024510AL)
...
// MessageText:
//
// The server-initiated healing engine encountered an exception not covered by
// another WU_E_SIH_* error code.
//
...
// MessageText:
//
// A property for the driver could not be found. It may not conform with
...
// MessageText:
//
// Information required for the synchronization of applicable printers is
// missing.
//
...
// MessageId 0xCE00 through 0xCEFF are reserved for post-install driver problem
// codes (see uhdriver.cpp)
//
...
// MessageText:
//
// The data store is missing required information or has a NULL in a table
// column that requires a non-null value.
//
...
// MessageText:
//
// The data store is missing required information or has a reference to missing
// license terms, file, localized property or linked row.
//
...
// MessageText:
//
// The update was not processed because its update handler could not be
// recognized.
//
...
// MessageText:
//
// The update was not deleted because it is still referenced by one or more
// services.
//
...
// MessageText:
//
// The category was not added because it contains no parent categories and is
// not a top-level category itself.
//
...
// MessageText:
//
// The data store could not be initialized because it was locked by another
// process.
//
...
// MessageText:
//
// The data store is not allowed to be registered with COM in the current
// process.
//
...
// MessageText:
//
// The server sent the same update to the client with two different revision
// IDs.
//
...
// MessageText:
//
// An operation did not complete because the registration of the service has
// expired.
//
...
// MessageText:
//
// A request to hide an update was declined because it is a mandatory update or
...
// MessageText:
//
// A request to remove the Windows Update service or to unregister it with
// Automatic Updates was declined because it is a built-in service and/or
// Automatic Updates cannot fall back to another service.
//
...
// MessageText:
//
// The schema of the current data store and the schema of a table in a backup
// XML document do not match.
//
...
// MessageText:
//
// The data store requires a session reset; release the session and retry with a
// new session.
//
...
// MessageText:
//
// A data store operation did not complete because it was requested with an
...
// MessageText:
//
// An operation against update metadata did not complete because the data was
...
//
// An operation against update metadata did not complete because the data was
// available but not loaded from datastore.
//
...
// MessageText:
//
// A data store operation did not complete because no such update revision is
// known.
//
...
// MessageText:
//
// A data store operation did not complete because an update's EULA information
// is missing.
//
...
// MessageText:
//
// A data store operation did not complete because a service's information is
// missing.
//
...
// MessageText:
//
// A data store operation did not complete because a service's synchronization
...
// MessageText:
//
// A data store operation did not complete because a timer's information is
// missing.
//
...
// MessageText:
//
// A data store operation did not complete because a download's information is
// missing.
//
...
// MessageText:
//
// A data store operation did not complete because a file's information is
// missing.
//
...
// MessageText:
//
// A data store operation did not complete because a download job's information
// is missing.
//
...
// MessageText:
//
// A data store operation did not complete because a service's timestamp
// information is missing.
//
...
// MessageText:
//
// The old version of the Automatic Updates client has stopped because the WSUS
...
// MessageText:
//
// Automatic Updates was unable to process incoming requests because it was
// paused.
//
...
// MessageText:
//
// Automatic Updates can't process incoming requests while Windows Welcome is
// running.
//
...
// MessageText:
//
// A request for a remote update handler could not be completed because no
...
// MessageText:
//
// A request for a remote update handler could not be completed because the
...
// MessageText:
//
// A handler operation could not be completed because the update contains
// invalid metadata.
//
...
// MessageText:
//
// An operation could not be completed because the installer exceeded the time
// limit.
//
...
// MessageText:
//
// An operation could not be completed because the handler-specific metadata is
// invalid.
//
...
// MessageText:
//
// A request to the handler to install an update could not be completed because
// the update requires user input.
//
...
// MessageText:
//
// The update handler should download self-contained content rather than
// delta-compressed content for the update.
//
...
// MessageText:
//
// The update handler failed to send notification of the status of the install
// (uninstall) operation.
//
...
// MessageText:
//
// The file names contained in the update metadata and in the update package are
// inconsistent.
//
...
// MessageText:
//
// The result of the post-reboot operation for the update could not be
// determined.
//
...
// MessageText:
//
// The OS servicing stack must be updated before this update is downloaded or
// installed.
//
...
// MessageText:
//
// The custom installer signature did not match the signature required by the
// update.
//
...
// MessageText:
//
// The update cannot be committed because it has not been previously installed
// or staged.
//
...
//
#define WU_E_UH_UA_SESSION_INFO_VERSION_NOT_SUPPORTED                          \
  _HRESULT_TYPEDEF_(0x80242025L)
...
// MessageText:
//
// This operation cannot be completed. You must install the baseline update(s)
// before you can install this update.
//
...
// MessageText:
//
// A download manager operation could not be completed because the requested
// file does not have a URL.
//
...
// MessageText:
//
// A download manager operation could not be completed because the file digest
// was not recognized.
//
...
// MessageText:
//
// A download manager operation could not be completed because the file metadata
// requested an unrecognized hash algorithm.
//
...
// MessageText:
//
// An operation could not be completed because a download request is required
// from the download handler.
//
...
// MessageText:
//
// A download manager operation could not be completed because the network
...
// MessageText:
//
// A download manager operation could not be completed because the version of
// Background Intelligent Transfer Service (BITS) is incompatible.
//
...
// MessageText:
//
// A download manager operation failed because the download manager was unable
// to connect the Background Intelligent Transfer Service (BITS).
//
...
// MessageText:
//
// A download must be restarted because the update content changed in a new
// revision.
//
...
// MessageText:
//
// A download failed because the current network limits downloads by update size
...
// MessageText:
//
// The download failed because the client was denied authorization to download
// the content.
//
...
// MessageText:
//
// The download failed because the user token associated with the BITS job no
// longer exists.
//
...
// MessageText:
//
// An attempt was made to access a downloaded update that has already been
// removed.
//
...
//
// The download failed because the client was denied authorization to download
// the content due to no user logged on.
//
...
// MessageText:
//
// The download failed because the local user was denied authorization to
...
// MessageText:
//
// The download failed because the domain user was denied authorization to
// download the content.
//
...
// MessageText:
//
// The download failed because the MSA account associated with the user was
// denied authorization to download the content.
//
...
// MessageText:
//
// The download will be continued by falling back to BITS to download the
// content.
//
...
// MessageText:
//
// Windows Update only supports one download type per update at one time. The
// download failure is by design here since the same update with different
// download type is operating. Please try again later.
//
...
// MessageText:
//
// There was a download manager error not covered by another WU_E_DM_* error
// code.
//
...
// MessageText:
//
// Windows Update Agent could not be updated because an INF file contains
// invalid information.
//
...
// MessageText:
//
// Windows Update Agent could not be updated because of an internal error that
// caused setup initialization to be performed twice.
//
...
// MessageText:
//
// Windows Update Agent could not be updated because setup initialization never
...
// MessageText:
//
// Windows Update Agent could not be updated because the versions specified in
// the INF do not match the actual source file versions.
//
...
// MessageText:
//
// Windows Update Agent could not be updated because a WUA file on the target
// system is newer than the corresponding source file.
//
...
// MessageText:
//
// Windows Update Agent could not be updated because regsvr32.exe returned an
// error.
//
...
// MessageText:
//
// An update to the Windows Update Agent was skipped because previous attempts
// to update have failed.
//
...
// MessageText:
//
// An update to the Windows Update Agent was skipped due to a directive in the
// wuident.cab file.
//
...
// MessageText:
//
// Windows Update Agent could not be updated because the current system
...
// MessageText:
//
// Windows Update Agent could not be updated because the system is configured to
// block the update.
//
...
// MessageText:
//
// Windows Update Agent could not be updated because a restart of the system is
// required.
//
...
// MessageText:
//
// Windows Update Agent setup package requires a reboot to complete
// installation.
//
...
// MessageText:
//
// Windows Update Agent could not be updated because the setup handler failed
// during execution.
//
...
// MessageText:
//
// Windows Update Agent could not be updated because the registry contains
// invalid information.
//
...
// MessageText:
//
// Windows Update Agent must be updated before search can continue.  An
// administrator is required to perform the operation.
//
...
// MessageText:
//
// Windows Update Agent could not be updated because the server does not contain
// update information for this version.
//
...
// MessageText:
//
// Windows Update Agent is successfully updated, but a reboot is required to
// complete the setup.
//
...
// MessageText:
//
// Windows Update Agent could not be updated because of an error not covered by
// another WU_E_SETUP_* error code.
//
...
// MessageText:
//
// An expression evaluator operation could not be completed because an
...
//
// An expression evaluator operation could not be completed because an
// expression contains an incorrect number of metadata nodes.
//
...
// MessageText:
//
// An expression evaluator operation could not be completed because the version
// of the serialized expression data is invalid.
//
...
// MessageText:
//
// An expression evaluator operation could not be completed because there was an
// invalid attribute.
//
...
// MessageText:
//
// An expression evaluator operation could not be completed because the cluster
// state of the computer could not be determined.
//
...
// MessageText:
//
// There was an expression evaluator error not covered by another WU_E_EE_*
// error code.
//
...
// MessageText:
//
// The results of download and installation could not be read from the registry
// due to an unrecognized data format version.
//
...
// MessageText:
//
// The results of download and installation are not available; the operation may
...
// MessageText:
//
// A failure occurred when trying to create an icon in the taskbar notification
// area.
//
...
// MessageText:
//
// Unable to show UI when in non-UI mode; WU client UI modules may not be
// installed.
//
...
// MessageText:
//
// There was a user interface error not covered by another WU_E_AUCLIENT_* error
// code.
//
...
// MessageText:
//
// An operation could not be completed because the scan package requires a
// greater version of the Windows Update Agent.
//
...
// MessageText:
//
// A metadata verification operation failed due to reasons not covered by
// another error code.
//
...
// MessageText:
//
// None of the update metadata had verification data, which may be disabled on
// the update server.
//
...
// MessageText:
//
// The fragment signing configuration used for verifying update metadata
// signatures was bad.
//
...
// MessageText:
//
// There was an unexpected operational failure while parsing fragment signing
// configuration.
//
#define WU_E_METADATA_FAILURE_PROCESSING_FRAGMENTSIGNING_CONFIG                \
  _HRESULT_TYPEDEF_(0x80247108L)
...
//
#define WU_E_METADATA_XML_INTERMEDIATECERT_MISSING                             \
  _HRESULT_TYPEDEF_(0x80247126L)
...
// MessageText:
//
// Required certificate base64CerData attribute was missing from xml
// configuration.
//
...
// MessageText:
//
// The metadata for an update was found to have a bad or invalid digital
// signature.
//
...
// MessageText:
//
// An failure occurred while verifying trust for metadata signing certificate
// chains.
//
#define WU_E_METADATATRUST_CERTIFICATECHAIN_VERIFICATION                       \
  _HRESULT_TYPEDEF_(0x80247150L)
...
// MessageText:
//
// A metadata signature timestamp token was no longer within the validity
// window.
//
#define WU_E_METADATA_TIMESTAMP_TOKEN_VALIDITY_WINDOW                          \
  _HRESULT_TYPEDEF_(0x80247163L)
...
// MessageText:
//
// A failure occurred when refreshing a missing timestamp token from the
// network.
//
#define WU_E_METADATA_TIMESTAMP_TOKEN_REFRESHONLINE                            \
  _HRESULT_TYPEDEF_(0x80247166L)
...
// MessageText:
//
// All update metadata verification timestamp tokens from the timestamp token
// cache are invalid.
//
...
// MessageText:
//
// No update metadata verification timestamp tokens exist in the timestamp token
// cache.
//
...
// MessageText:
//
// An error occurred during cache lookup of update metadata verification
// timestamp token.
//
...
// MessageText:
//
// An metadata timestamp token verification operation failed due to reasons not
...
// MessageText:
//
// The transport encoding of a metadata signing intermediate certificate was
// malformed.
//
#define WU_E_METADATA_INTCERT_BAD_TRANSPORT_ENCODING                           \
  _HRESULT_TYPEDEF_(0x80247182L)
...
// MessageText:
//
// The operation cannot be completed since the task status is currently
// disabled.
//
...
// MessageText:
//
// Unable to complete action due to WMI dependency, which isn't supported on
// this platform.
//
...
// MessageText:
//
// File signature validation fails to find valid RSA signature on infrastructure
// payload.
//
...
// MessageText:
//
// File signature validation fails to find valid ECC signature on infrastructure
// payload.
//
