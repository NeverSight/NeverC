...
typedef interface IStorageProviderPropertyHandler
...
public:
  virtual HRESULT STDMETHODCALLTYPE RetrieveProperties(
      /* [size_is][in] */ __RPC__in_ecount_full(propertiesToRetrieveCount)
          const PROPERTYKEY *propertiesToRetrieve,
      /* [in] */ ULONG propertiesToRetrieveCount,
      /* [out] */
      __RPC__deref_out_opt IPropertyStore **retrievedProperties) = 0;
...
typedef struct IStorageProviderPropertyHandlerVtbl {
  ...
  HRESULT(STDMETHODCALLTYPE *RetrieveProperties)(
      __RPC__in IStorageProviderPropertyHandler *This,
      /* [size_is][in] */
      __RPC__in_ecount_full(propertiesToRetrieveCount)
          const PROPERTYKEY *propertiesToRetrieve,
      /* [in] */ ULONG propertiesToRetrieveCount,
...
#define IStorageProviderPropertyHandler_RetrieveProperties(                    \
    This, propertiesToRetrieve, propertiesToRetrieveCount,                     \
    retrievedProperties)                                                       \
  ((This)->lpVtbl->RetrieveProperties(This, propertiesToRetrieve,              \
...
public:
  virtual HRESULT STDMETHODCALLTYPE GetPropertyHandlerFromPath(
      ...
      /* [out] */ __RPC__deref_out_opt IStorageProviderPropertyHandler *
          *propertyHandler) = 0;
...
typedef struct IStorageProviderHandlerVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IStorageProviderHandler *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IStorageProviderHandler *This);
...
#define IStorageProviderHandler_AddRef(This) ((This)->lpVtbl->AddRef(This))

#define IStorageProviderHandler_Release(This) ((This)->lpVtbl->Release(This))

#define IStorageProviderHandler_GetPropertyHandlerFromPath(This, path,         \
                                                           propertyHandler)    \
  ((This)->lpVtbl->GetPropertyHandlerFromPath(This, path, propertyHandler))

#define IStorageProviderHandler_GetPropertyHandlerFromUri(This, uri,           \
                                                          propertyHandler)     \
  ((This)->lpVtbl->GetPropertyHandlerFromUri(This, uri, propertyHandler))

#define IStorageProviderHandler_GetPropertyHandlerFromFileId(This, fileId,     \
                                                             propertyHandler)  \
