...
typedef struct IShellAppVtbl {
  ...
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in IShellApp *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IShellApp *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IShellApp *This);
  ...
  HRESULT(STDMETHODCALLTYPE *GetSlowAppInfo)(__RPC__in IShellApp *This,
                                             /* [out] */ __RPC__out PSLOWAPPINFO
                                                 psaid);
  ...
  HRESULT(STDMETHODCALLTYPE *IsInstalled)(__RPC__in IShellApp *This);

  END_INTERFACE
} IShellAppVtbl;

interface IShellApp { CONST_VTBL struct IShellAppVtbl *lpVtbl; };
...
typedef struct IPublishedAppVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in IPublishedApp *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IPublishedApp *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IPublishedApp *This);
  ...
  DECLSPEC_XFGVIRT(IShellApp, GetSlowAppInfo)
  HRESULT(STDMETHODCALLTYPE *GetSlowAppInfo)(__RPC__in IPublishedApp *This,
                                             /* [out] */ __RPC__out PSLOWAPPINFO
                                                 psaid);
  ...
  DECLSPEC_XFGVIRT(IShellApp, IsInstalled)
  HRESULT(STDMETHODCALLTYPE *IsInstalled)(__RPC__in IPublishedApp *This);
  ...
  HRESULT(STDMETHODCALLTYPE *Unschedule)(__RPC__in IPublishedApp *This);

  END_INTERFACE
} IPublishedAppVtbl;

interface IPublishedApp { CONST_VTBL struct IPublishedAppVtbl *lpVtbl; };
...
typedef struct IPublishedApp2Vtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in IPublishedApp2 *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IPublishedApp2 *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IPublishedApp2 *This);
  ...
  DECLSPEC_XFGVIRT(IShellApp, GetSlowAppInfo)
  HRESULT(STDMETHODCALLTYPE *GetSlowAppInfo)(__RPC__in IPublishedApp2 *This,
                                             /* [out] */ __RPC__out PSLOWAPPINFO
                                                 psaid);
  ...
  DECLSPEC_XFGVIRT(IShellApp, IsInstalled)
  HRESULT(STDMETHODCALLTYPE *IsInstalled)(__RPC__in IPublishedApp2 *This);
  ...
  DECLSPEC_XFGVIRT(IPublishedApp, Unschedule)
  HRESULT(STDMETHODCALLTYPE *Unschedule)(__RPC__in IPublishedApp2 *This);
...
interface IPublishedApp2 { CONST_VTBL struct IPublishedApp2Vtbl *lpVtbl; };
...
typedef struct IEnumPublishedAppsVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in IEnumPublishedApps *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IEnumPublishedApps *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IEnumPublishedApps *This);
  ...
  HRESULT(STDMETHODCALLTYPE *Reset)(__RPC__in IEnumPublishedApps *This);
...
typedef struct IAppPublisherVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in IAppPublisher *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IAppPublisher *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IAppPublisher *This);
...
interface IAppPublisher { CONST_VTBL struct IAppPublisherVtbl *lpVtbl; };
