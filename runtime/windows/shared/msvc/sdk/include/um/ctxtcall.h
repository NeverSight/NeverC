...
interface IContextCallback { CONST_VTBL struct IContextCallbackVtbl *lpVtbl; };
...
#define IContextCallback_ContextCallback(This, pfnCallback, pParam, riid,      \
                                         iMethod, pUnk)                        \
  ((This)->lpVtbl->ContextCallback(This, pfnCallback, pParam, riid, iMethod,   \
                                   pUnk))
