...
DEFINE_GUID(IID_IPrintAsyncNotifyChannel, 0x4a5031b1, 0x1f3f, 0x4db0, 0xa4,
            0x62, 0x45, 0x30, 0xed, 0x8b, 0x04, 0x51);
DEFINE_GUID(IID_IPrintAsyncNotifyCallback, 0x7def34c1, 0x9d92, 0x4c99, 0xb3,
            0xb3, 0xdb, 0x94, 0xa9, 0xd4, 0x19, 0x1b);
DEFINE_GUID(IID_IPrintAsyncNotifyDataObject, 0x77cf513e, 0x5d49, 0x4789, 0x9f,
            0x30, 0xd0, 0x82, 0x2b, 0x33, 0x5c, 0x0d);

DEFINE_GUID(NOTIFICATION_RELEASE, 0xba9a5027, 0xa70e, 0x4ae7, 0x9b, 0x7d, 0xeb,
            0x3e, 0x06, 0xad, 0x41, 0x57);

//
// Global Application Bidi Notification Channel
//   All Apps interested in Bidi Notifications from the Print subsystem should
//   register for notifications on this Channel GUID
//
// {2ABAD223-B994-4aca-82FC-4571B1B585AC}
DEFINE_GUID(PRINT_APP_BIDI_NOTIFY_CHANNEL, 0x2ABAD223, 0xB994, 0x4aca, 0x82,
            0xFC, 0x45, 0x71, 0xB1, 0xB5, 0x85, 0xAC);

//
// Global Port Monitor Bidi Notification Channel
//   This is the Global Channel GUID that all Bidi enabled Port Monitor should
//   open to send Bidi Schema notifications up
//
// {25DF3B0E-74A9-47f5-80CE-79B4B1EB5C58}
DEFINE_GUID(PRINT_PORT_MONITOR_NOTIFY_CHANNEL, 0x25df3b0e, 0x74a9, 0x47f5, 0x80,
            0xce, 0x79, 0xb4, 0xb1, 0xeb, 0x5c, 0x58);
...
DECLARE_INTERFACE_(IPrintAsyncNotifyDataObject, IUnknown) {
  ...
  STDMETHOD(AcquireData)(
      THIS_ _Outptr_opt_result_buffer_(*pSize) BYTE * *ppNotificationData,
      _Out_opt_ ULONG * pSize,
      _Outptr_opt_ PrintAsyncNotificationType * *ppSchema) PURE;
...
DECLARE_INTERFACE_(IPrintAsyncNotifyChannel, IUnknown) {
  ...
  STDMETHOD(SendNotification)(THIS_ _In_ IPrintAsyncNotifyDataObject * pData)
      PURE;

  STDMETHOD(CloseChannel)(THIS_ _In_ IPrintAsyncNotifyDataObject * pData) PURE;
};
...
DECLARE_INTERFACE_(IPrintAsyncNotifyCallback, IUnknown) {
  ...
  STDMETHOD(OnEventNotify)(THIS_ _In_ IPrintAsyncNotifyChannel * pChannel,
                           _In_ IPrintAsyncNotifyDataObject * pData) PURE;

  STDMETHOD(ChannelClosed)(THIS_ _In_ IPrintAsyncNotifyChannel * pChannel,
                           _In_ IPrintAsyncNotifyDataObject * pData) PURE;
};
...
RegisterForPrintAsyncNotifications(
    _In_opt_ PCWSTR pszName, _In_ PrintAsyncNotificationType *pNotificationType,
    PrintAsyncNotifyUserFilter eUserFilter,
    PrintAsyncNotifyConversationStyle eConversationStyle,
    _In_ IPrintAsyncNotifyCallback *pCallback, _Out_ HANDLE *phNotify);

HRESULT
WINAPI
UnRegisterForPrintAsyncNotifications(_In_ HANDLE);
