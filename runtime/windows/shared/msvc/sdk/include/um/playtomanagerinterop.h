...
public:
  virtual HRESULT STDMETHODCALLTYPE GetForWindow(
      ...
      /* [iid_is][retval][out] */
      __RPC__deref_out_opt void **playToManager) = 0;
...
typedef struct IPlayToManagerInteropVtbl {
  ...
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IPlayToManagerInterop *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IPlayToManagerInterop *This);
...
#define IPlayToManagerInterop_GetForWindow(This, appWindow, riid,              \
                                           playToManager)                      \
