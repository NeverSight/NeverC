...
DEFINE_DEVPROPKEY(DEVPKEY_DeviceInterface_IsVirtualCamera, 0x6EDC630D, 0xC2E3,
                  0x43B7, 0xB2, 0xD1, 0x20, 0x52, 0x5A, 0x1A, 0xF1, 0x20,
                  3); // DEVPROP_TYPE_BOOLEAN
/// {6EDC630D-C2E3-43B7-B2D1-20525A1AF120}, 4
DEFINE_DEVPROPKEY(DEVPKEY_DeviceInterface_IsWindowsCameraEffectAvailable,
                  0x6EDC630D, 0xC2E3, 0x43B7, 0xB2, 0xD1, 0x20, 0x52, 0x5A,
                  0x1A, 0xF1, 0x20, 4); // DEVPROP_TYPE_BOOLEAN
/// {6EDC630D-C2E3-43B7-B2D1-20525A1AF120}, 5
DEFINE_DEVPROPKEY(DEVPKEY_DeviceInterface_VirtualCameraAssociatedCameras,
                  0x6EDC630D, 0xC2E3, 0x43B7, 0xB2, 0xD1, 0x20, 0x52, 0x5A,
                  0x1A, 0xF1, 0x20, 5); // DEVPROP_TYPE_STRING_LIST
...
#endif
EXTERN_GUID(MF_DEVSOURCE_ATTRIBUTE_ENABLE_MS_CAMERA_EFFECTS, 0x28A5531A, 0x57DD,
            0x4FD5, 0xAA, 0xA7, 0x38, 0x5A, 0xBF, 0x57, 0xD7, 0x85);
EXTERN_GUID(MF_VIRTUALCAMERA_ASSOCIATED_CAMERA_SOURCES, 0x1BB79E7C, 0x5D83,
            0x438C, 0x94, 0xD8, 0xE5, 0xF0, 0xDF, 0x6D, 0x32, 0x79);
EXTERN_GUID(MF_VIRTUALCAMERA_PROVIDE_ASSOCIATED_CAMERA_SOURCES, 0xF0273718,
            0x4A4D, 0x4AC5, 0xA1, 0x5D, 0x30, 0x5E, 0xB5, 0xE9, 0x06, 0x67);
EXTERN_GUID(MF_VIRTUALCAMERA_CONFIGURATION_APP_PACKAGE_FAMILY_NAME, 0x658ABE51,
            0x8044, 0x462E, 0x97, 0xEA, 0xE6, 0x76, 0xFD, 0x72, 0x05, 0x5F);
EXTERN_GUID(MF_FRAMESERVER_VCAMEVENT_EXTENDED_SOURCE_INITIALIZE, 0xE52C4DFF,
            0xE46D, 0x4D0B, 0xBC, 0x75, 0xDD, 0xD4, 0xC8, 0x72, 0x3F, 0x96);
EXTERN_GUID(MF_FRAMESERVER_VCAMEVENT_EXTENDED_SOURCE_START, 0xB1EEB989, 0xB456,
            0x4F4A, 0xAE, 0x40, 0x07, 0x9C, 0x28, 0xE2, 0x4A, 0xF8);
EXTERN_GUID(MF_FRAMESERVER_VCAMEVENT_EXTENDED_SOURCE_STOP, 0xB7FE7A61, 0xFE91,
            0x415E, 0x86, 0x08, 0xD3, 0x7D, 0xED, 0xB1, 0xA5, 0x8B);
EXTERN_GUID(MF_FRAMESERVER_VCAMEVENT_EXTENDED_SOURCE_UNINITIALIZE, 0xA0EBABA7,
            0xA422, 0x4E33, 0x84, 0x01, 0xB3, 0x7D, 0x28, 0x00, 0xAA, 0x67);
EXTERN_GUID(MF_FRAMESERVER_VCAMEVENT_EXTENDED_PIPELINE_SHUTDOWN, 0x45A81B31,
            0x43F8, 0x4E5D, 0x8C, 0xE2, 0x22, 0xDC, 0xE0, 0x26, 0x99, 0x6D);
EXTERN_GUID(MF_FRAMESERVER_VCAMEVENT_EXTENDED_CUSTOM_EVENT, 0x6E59489C, 0x47D3,
            0x4467, 0x83, 0xEF, 0x12, 0xD3, 0x4E, 0x87, 0x16, 0x65);
typedef /* [public] */
...
typedef struct IMFCameraSyncObjectVtbl {
  ...
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(IMFCameraSyncObject *This,
                                             /* [in] */ REFIID riid,
  ...
  HRESULT(STDMETHODCALLTYPE *WaitOnSignal)(IMFCameraSyncObject *This,
                                           /* [annotation][in] */
...
#define IMFCameraSyncObject_AddRef(This) ((This)->lpVtbl->AddRef(This))

#define IMFCameraSyncObject_Release(This) ((This)->lpVtbl->Release(This))

#define IMFCameraSyncObject_WaitOnSignal(This, timeOutInMs)                    \
  ((This)->lpVtbl->WaitOnSignal(This, timeOutInMs))

#define IMFCameraSyncObject_Shutdown(This) ((This)->lpVtbl->Shutdown(This))
...
typedef struct IMFVirtualCameraVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(IMFVirtualCamera *This,
                                             /* [in] */ REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(IMFVirtualCamera *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(IMFVirtualCamera *This);

  DECLSPEC_XFGVIRT(IMFAttributes, GetItem)
  HRESULT(STDMETHODCALLTYPE *GetItem)(
      IMFVirtualCamera *This, REFGUID guidKey,
      /* [full][out][in] */ PROPVARIANT *pValue);

  DECLSPEC_XFGVIRT(IMFAttributes, GetItemType)
  HRESULT(STDMETHODCALLTYPE *GetItemType)(IMFVirtualCamera *This,
                                          REFGUID guidKey,
                                          /* [out] */ MF_ATTRIBUTE_TYPE *pType);

  DECLSPEC_XFGVIRT(IMFAttributes, CompareItem)
  HRESULT(STDMETHODCALLTYPE *CompareItem)(IMFVirtualCamera *This,
                                          REFGUID guidKey, REFPROPVARIANT Value,
                                          /* [out] */ BOOL *pbResult);

  DECLSPEC_XFGVIRT(IMFAttributes, Compare)
  HRESULT(STDMETHODCALLTYPE *Compare)(IMFVirtualCamera *This,
                                      IMFAttributes *pTheirs,
                                      MF_ATTRIBUTES_MATCH_TYPE MatchType,
                                      /* [out] */ BOOL *pbResult);

  DECLSPEC_XFGVIRT(IMFAttributes, GetUINT32)
  HRESULT(STDMETHODCALLTYPE *GetUINT32)(IMFVirtualCamera *This, REFGUID guidKey,
                                        /* [out] */ UINT32 *punValue);

  DECLSPEC_XFGVIRT(IMFAttributes, GetUINT64)
  HRESULT(STDMETHODCALLTYPE *GetUINT64)(IMFVirtualCamera *This, REFGUID guidKey,
                                        /* [out] */ UINT64 *punValue);

  DECLSPEC_XFGVIRT(IMFAttributes, GetDouble)
  HRESULT(STDMETHODCALLTYPE *GetDouble)(IMFVirtualCamera *This, REFGUID guidKey,
                                        /* [out] */ double *pfValue);

  DECLSPEC_XFGVIRT(IMFAttributes, GetGUID)
  HRESULT(STDMETHODCALLTYPE *GetGUID)(IMFVirtualCamera *This, REFGUID guidKey,
                                      /* [out] */ GUID *pguidValue);

  DECLSPEC_XFGVIRT(IMFAttributes, GetStringLength)
  HRESULT(STDMETHODCALLTYPE *GetStringLength)(IMFVirtualCamera *This,
                                              REFGUID guidKey,
  ...
  HRESULT(STDMETHODCALLTYPE *GetBlobSize)(IMFVirtualCamera *This,
                                          REFGUID guidKey,
  ...
  HRESULT(STDMETHODCALLTYPE *GetUnknown)(IMFVirtualCamera *This,
                                         REFGUID guidKey, REFIID riid,
                                         /* [iid_is][out] */ LPVOID *ppv);

  DECLSPEC_XFGVIRT(IMFAttributes, SetItem)
  HRESULT(STDMETHODCALLTYPE *SetItem)(IMFVirtualCamera *This, REFGUID guidKey,
                                      REFPROPVARIANT Value);

  DECLSPEC_XFGVIRT(IMFAttributes, DeleteItem)
  HRESULT(STDMETHODCALLTYPE *DeleteItem)(IMFVirtualCamera *This,
                                         REFGUID guidKey);

  DECLSPEC_XFGVIRT(IMFAttributes, DeleteAllItems)
  HRESULT(STDMETHODCALLTYPE *DeleteAllItems)(IMFVirtualCamera *This);

  DECLSPEC_XFGVIRT(IMFAttributes, SetUINT32)
  HRESULT(STDMETHODCALLTYPE *SetUINT32)(IMFVirtualCamera *This, REFGUID guidKey,
                                        UINT32 unValue);

  DECLSPEC_XFGVIRT(IMFAttributes, SetUINT64)
  HRESULT(STDMETHODCALLTYPE *SetUINT64)(IMFVirtualCamera *This, REFGUID guidKey,
                                        UINT64 unValue);

  DECLSPEC_XFGVIRT(IMFAttributes, SetDouble)
  HRESULT(STDMETHODCALLTYPE *SetDouble)(IMFVirtualCamera *This, REFGUID guidKey,
                                        double fValue);

  DECLSPEC_XFGVIRT(IMFAttributes, SetGUID)
  HRESULT(STDMETHODCALLTYPE *SetGUID)(IMFVirtualCamera *This, REFGUID guidKey,
                                      REFGUID guidValue);

  DECLSPEC_XFGVIRT(IMFAttributes, SetString)
  HRESULT(STDMETHODCALLTYPE *SetString)(IMFVirtualCamera *This, REFGUID guidKey,
                                        /* [string][in] */ LPCWSTR wszValue);

  DECLSPEC_XFGVIRT(IMFAttributes, SetBlob)
  HRESULT(STDMETHODCALLTYPE *SetBlob)(IMFVirtualCamera *This, REFGUID guidKey,
                                      /* [size_is][in] */ const UINT8 *pBuf,
                                      UINT32 cbBufSize);

  DECLSPEC_XFGVIRT(IMFAttributes, SetUnknown)
  HRESULT(STDMETHODCALLTYPE *SetUnknown)(IMFVirtualCamera *This,
                                         REFGUID guidKey,
                                         /* [in] */ IUnknown *pUnknown);

  DECLSPEC_XFGVIRT(IMFAttributes, LockStore)
  HRESULT(STDMETHODCALLTYPE *LockStore)(IMFVirtualCamera *This);

  DECLSPEC_XFGVIRT(IMFAttributes, UnlockStore)
  HRESULT(STDMETHODCALLTYPE *UnlockStore)(IMFVirtualCamera *This);

  DECLSPEC_XFGVIRT(IMFAttributes, GetCount)
  HRESULT(STDMETHODCALLTYPE *GetCount)(IMFVirtualCamera *This,
                                       /* [out] */ UINT32 *pcItems);

  DECLSPEC_XFGVIRT(IMFAttributes, GetItemByIndex)
  HRESULT(STDMETHODCALLTYPE *GetItemByIndex)(
      IMFVirtualCamera *This, UINT32 unIndex,
      /* [out] */ GUID *pguidKey,
      /* [full][out][in] */ PROPVARIANT *pValue);

  DECLSPEC_XFGVIRT(IMFAttributes, CopyAllItems)
  HRESULT(STDMETHODCALLTYPE *CopyAllItems)(IMFVirtualCamera *This,
                                           /* [in] */ IMFAttributes *pDest);

  DECLSPEC_XFGVIRT(IMFVirtualCamera, AddDeviceSourceInfo)
  HRESULT(STDMETHODCALLTYPE *AddDeviceSourceInfo)(IMFVirtualCamera *This,
                                                  /* [annotation][in] */
                                                  _In_z_ LPCWSTR
                                                      DeviceSourceInfo);

  DECLSPEC_XFGVIRT(IMFVirtualCamera, AddProperty)
  HRESULT(STDMETHODCALLTYPE *AddProperty)(IMFVirtualCamera *This,
                                          /* [annotation][in] */
                                          _In_ const DEVPROPKEY *pKey,
                                          /* [annotation][in] */
                                          _In_ DEVPROPTYPE Type,
  ...
  HRESULT(STDMETHODCALLTYPE *AddRegistryEntry)(IMFVirtualCamera *This,
                                               /* [annotation][in] */
                                               _In_z_ LPCWSTR EntryName,
                                               /* [annotation][in] */
                                               _In_opt_z_ LPCWSTR SubkeyPath,
  ...
  HRESULT(STDMETHODCALLTYPE *Start)(IMFVirtualCamera *This,
                                    /* [annotation][in] */
...
interface IMFVirtualCamera { CONST_VTBL struct IMFVirtualCameraVtbl *lpVtbl; };
...
#define IMFVirtualCamera_AddRef(This) ((This)->lpVtbl->AddRef(This))

#define IMFVirtualCamera_Release(This) ((This)->lpVtbl->Release(This))
...
#define IMFVirtualCamera_GetString(This, guidKey, pwszValue, cchBufSize,       \
                                   pcchLength)                                 \
  ((This)->lpVtbl->GetString(This, guidKey, pwszValue, cchBufSize, pcchLength))

#define IMFVirtualCamera_GetAllocatedString(This, guidKey, ppwszValue,         \
                                            pcchLength)                        \
...
#define IMFVirtualCamera_LockStore(This) ((This)->lpVtbl->LockStore(This))

#define IMFVirtualCamera_UnlockStore(This) ((This)->lpVtbl->UnlockStore(This))
...
#define IMFVirtualCamera_AddRegistryEntry(This, EntryName, SubkeyPath,         \
                                          dwRegType, pbData, cbData)           \
  ((This)->lpVtbl->AddRegistryEntry(This, EntryName, SubkeyPath, dwRegType,    \
                                    pbData, cbData))

#define IMFVirtualCamera_Start(This, pCallback)                                \
  ((This)->lpVtbl->Start(This, pCallback))

#define IMFVirtualCamera_Stop(This) ((This)->lpVtbl->Stop(This))

#define IMFVirtualCamera_Remove(This) ((This)->lpVtbl->Remove(This))

#define IMFVirtualCamera_GetMediaSource(This, ppMediaSource)                   \
  ((This)->lpVtbl->GetMediaSource(This, ppMediaSource))

#define IMFVirtualCamera_SendCameraProperty(                                   \
    This, propertySet, propertyId, propertyFlags, propertyPayload,             \
    propertyPayloadLength, data, dataLength, dataWritten)                      \
  ((This)->lpVtbl->SendCameraProperty(                                         \
      This, propertySet, propertyId, propertyFlags, propertyPayload,           \
      propertyPayloadLength, data, dataLength, dataWritten))

#define IMFVirtualCamera_CreateSyncEvent(                                      \
    This, kseventSet, kseventId, kseventFlags, eventHandle, cameraSyncObject)  \
  ((This)->lpVtbl->CreateSyncEvent(This, kseventSet, kseventId, kseventFlags,  \
                                   eventHandle, cameraSyncObject))

#define IMFVirtualCamera_CreateSyncSemaphore(                                  \
    This, kseventSet, kseventId, kseventFlags, semaphoreHandle,                \
    semaphoreAdjustment, cameraSyncObject)                                     \
  ((This)->lpVtbl->CreateSyncSemaphore(This, kseventSet, kseventId,            \
                                       kseventFlags, semaphoreHandle,          \
                                       semaphoreAdjustment, cameraSyncObject))

#define IMFVirtualCamera_Shutdown(This) ((This)->lpVtbl->Shutdown(This))
