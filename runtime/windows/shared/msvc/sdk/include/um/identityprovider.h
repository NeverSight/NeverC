...
typedef interface AsyncIAssociatedIdentityProvider
...
typedef interface AsyncIConnectedIdentityProvider
...
DEFINE_GUID(OID_OAssociatedIdentityProviderObject, 0x98c5a3dd, 0xdb68, 0x4f1a,
            0x8d, 0x2b, 0x90, 0x79, 0xcd, 0xfe, 0xaf, 0x61);
...
typedef struct IIdentityAdviseVtbl {
  ...
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in IIdentityAdvise *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IIdentityAdvise *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IIdentityAdvise *This);
...
interface IIdentityAdvise { CONST_VTBL struct IIdentityAdviseVtbl *lpVtbl; };
...
#define IIdentityAdvise_IdentityUpdated(This, dwIdentityUpdateEvents,          \
                                        lpszUniqueID)                          \
...
typedef struct AsyncIIdentityAdviseVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in AsyncIIdentityAdvise *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in AsyncIIdentityAdvise *This);
...
#define AsyncIIdentityAdvise_Begin_IdentityUpdated(                            \
    This, dwIdentityUpdateEvents, lpszUniqueID)                                \
  ((This)->lpVtbl->Begin_IdentityUpdated(This, dwIdentityUpdateEvents,         \
                                         lpszUniqueID))
...
typedef struct IIdentityProviderVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in IIdentityProvider *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IIdentityProvider *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IIdentityProvider *This);
  ...
  HRESULT(STDMETHODCALLTYPE *UnAdvise)(__RPC__in IIdentityProvider *This,
...
#define IIdentityProvider_GetIdentityEnum(This, eIdentityType, pFilterkey,     \
                                          pFilterPropVarValue, ppIdentityEnum) \
  ((This)->lpVtbl->GetIdentityEnum(This, eIdentityType, pFilterkey,            \
                                   pFilterPropVarValue, ppIdentityEnum))

#define IIdentityProvider_Create(This, lpszUserName, ppPropertyStore,          \
                                 pKeywordsToAdd)                               \
...
#define IIdentityProvider_Advise(This, pIdentityAdvise,                        \
                                 dwIdentityUpdateEvents, pdwCookie)            \
  ((This)->lpVtbl->Advise(This, pIdentityAdvise, dwIdentityUpdateEvents,       \
                          pdwCookie))
...
public:
  virtual HRESULT STDMETHODCALLTYPE Begin_GetIdentityEnum(
      ...
      /* [unique][in] */ __RPC__in_opt const PROPERTYKEY *pFilterkey,
      /* [unique][in] */
      __RPC__in_opt const PROPVARIANT *pFilterPropVarValue) = 0;
...
typedef struct AsyncIIdentityProviderVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in AsyncIIdentityProvider *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in AsyncIIdentityProvider *This);
...
#define AsyncIIdentityProvider_Begin_GetIdentityEnum(                          \
    This, eIdentityType, pFilterkey, pFilterPropVarValue)                      \
  ((This)->lpVtbl->Begin_GetIdentityEnum(This, eIdentityType, pFilterkey,      \
                                         pFilterPropVarValue))
...
#define AsyncIIdentityProvider_Begin_Create(This, lpszUserName,                \
                                            pKeywordsToAdd)                    \
...
#define AsyncIIdentityProvider_Begin_Delete(This, lpszUniqueID,                \
                                            pKeywordsToDelete)                 \
...
#define AsyncIIdentityProvider_Finish_GetProviderPropertyStore(                \
    This, ppPropertyStore)                                                     \
  ((This)->lpVtbl->Finish_GetProviderPropertyStore(This, ppPropertyStore))

#define AsyncIIdentityProvider_Begin_Advise(This, pIdentityAdvise,             \
...
typedef struct IAssociatedIdentityProviderVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IAssociatedIdentityProvider *This);
...
typedef struct AsyncIAssociatedIdentityProviderVtbl {
  ...
  DECLSPEC_XFGVIRT(AsyncIAssociatedIdentityProvider,
...
#define AsyncIAssociatedIdentityProvider_Begin_AssociateIdentity(This,         \
                                                                 hwndParent)   \
  ((This)->lpVtbl->Begin_AssociateIdentity(This, hwndParent))

#define AsyncIAssociatedIdentityProvider_Finish_AssociateIdentity(             \
    This, ppPropertyStore)                                                     \
  ((This)->lpVtbl->Finish_AssociateIdentity(This, ppPropertyStore))

#define AsyncIAssociatedIdentityProvider_Begin_DisassociateIdentity(           \
    This, hwndParent, lpszUniqueID)                                            \
...
#define AsyncIAssociatedIdentityProvider_Begin_ChangeCredential(               \
    This, hwndParent, lpszUniqueID)                                            \
...
public:
  virtual HRESULT STDMETHODCALLTYPE ConnectIdentity(
      /* [ref][size_is][in] */ __RPC__in_ecount_full(AuthBufferSize) BYTE *
          AuthBuffer,
...
typedef struct IConnectedIdentityProviderVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IConnectedIdentityProvider *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IConnectedIdentityProvider *This);
...
#define IConnectedIdentityProvider_AddRef(This) ((This)->lpVtbl->AddRef(This))

#define IConnectedIdentityProvider_Release(This) ((This)->lpVtbl->Release(This))

#define IConnectedIdentityProvider_ConnectIdentity(This, AuthBuffer,           \
                                                   AuthBufferSize)             \
...
#define IConnectedIdentityProvider_GetUrl(This, Identifier, Context, PostData, \
                                          Url)                                 \
...
public:
  virtual HRESULT STDMETHODCALLTYPE Begin_ConnectIdentity(
      /* [ref][size_is][in] */ __RPC__in_xcount_full(AuthBufferSize) BYTE *
          AuthBuffer,
      /* [in] */ ULONG AuthBufferSize) = 0;
...
#define AsyncIConnectedIdentityProvider_Begin_ConnectIdentity(                 \
    This, AuthBuffer, AuthBufferSize)                                          \
...
#define AsyncIConnectedIdentityProvider_Begin_GetUrl(This, Identifier,         \
                                                     Context)                  \
...
public:
  virtual HRESULT STDMETHODCALLTYPE SetIdentityCredential(
      /* [unique][size_is][in] */ __RPC__in_ecount_full_opt(CredBufferLength)
              BYTE *
          CredBuffer,
      /* [in] */ ULONG CredBufferLength) = 0;

  virtual HRESULT STDMETHODCALLTYPE ValidateIdentityCredential(
      /* [ref][size_is][in] */ __RPC__in_ecount_full(CredBufferLength) BYTE *
          CredBuffer,
      /* [in] */ ULONG CredBufferLength,
      /* [unique][out][in] */ __RPC__deref_opt_inout_opt IPropertyStore *
          *ppIdentityProperties) = 0;
};
...
typedef struct IIdentityAuthenticationVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IIdentityAuthentication *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IIdentityAuthentication *This);
...
#define IIdentityAuthentication_AddRef(This) ((This)->lpVtbl->AddRef(This))

#define IIdentityAuthentication_Release(This) ((This)->lpVtbl->Release(This))

#define IIdentityAuthentication_SetIdentityCredential(This, CredBuffer,        \
                                                      CredBufferLength)        \
  ((This)->lpVtbl->SetIdentityCredential(This, CredBuffer, CredBufferLength))

#define IIdentityAuthentication_ValidateIdentityCredential(                    \
    This, CredBuffer, CredBufferLength, ppIdentityProperties)                  \
  ((This)->lpVtbl->ValidateIdentityCredential(                                 \
      This, CredBuffer, CredBufferLength, ppIdentityProperties))
...
public:
  virtual HRESULT STDMETHODCALLTYPE Begin_SetIdentityCredential(
      /* [unique][size_is][in] */ __RPC__in_xcount_full_opt(CredBufferLength)
              BYTE *
          CredBuffer,
      /* [in] */ ULONG CredBufferLength) = 0;
  ...
  virtual HRESULT STDMETHODCALLTYPE Begin_ValidateIdentityCredential(
      /* [ref][size_is][in] */ __RPC__in_xcount_full(CredBufferLength) BYTE *
          CredBuffer,
      /* [in] */ ULONG CredBufferLength,
      /* [unique][out][in] */ __RPC__deref_opt_inout_opt IPropertyStore *
          *ppIdentityProperties) = 0;
...
typedef struct AsyncIIdentityAuthenticationVtbl {
  ...
  DECLSPEC_XFGVIRT(AsyncIIdentityAuthentication,
...
#define AsyncIIdentityAuthentication_AddRef(This) ((This)->lpVtbl->AddRef(This))

#define AsyncIIdentityAuthentication_Release(This)                             \
  ((This)->lpVtbl->Release(This))

#define AsyncIIdentityAuthentication_Begin_SetIdentityCredential(              \
    This, CredBuffer, CredBufferLength)                                        \
  ((This)->lpVtbl->Begin_SetIdentityCredential(This, CredBuffer,               \
                                               CredBufferLength))

#define AsyncIIdentityAuthentication_Finish_SetIdentityCredential(This)        \
  ((This)->lpVtbl->Finish_SetIdentityCredential(This))

#define AsyncIIdentityAuthentication_Begin_ValidateIdentityCredential(         \
    This, CredBuffer, CredBufferLength, ppIdentityProperties)                  \
  ((This)->lpVtbl->Begin_ValidateIdentityCredential(                           \
      This, CredBuffer, CredBufferLength, ppIdentityProperties))

#define AsyncIIdentityAuthentication_Finish_ValidateIdentityCredential(        \
    This, ppIdentityProperties)                                                \
  ((This)->lpVtbl->Finish_ValidateIdentityCredential(This,                     \
                                                     ppIdentityProperties))
