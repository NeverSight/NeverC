...
typedef enum _tagDVD_ERROR {
  ...
  DVD_ERROR_CopyProtectOutputFail =
      9, // DVD copy protection failed due to output display
  DVD_ERROR_CopyProtectOutputNotSupported =
      10, // DVD copy protection failed due to lack of driver
...
typedef enum _tagDVD_PB_STOPPED {
  ...
  DVD_PB_STOPPED_CopyProtectOutputFailure =
      14, // Copy protection failure due to non-compliant output device
  DVD_PB_STOPPED_CopyProtectOutputNotSupported =
      15 // Copy protection failure due to missing driver support to check
         // output device
} DVD_PB_STOPPED;
