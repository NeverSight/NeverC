...
typedef interface IDvbContentIdentifierDescriptor
...
typedef interface IDvbSatelliteDeliverySystemDescriptor
...
typedef interface IDvbCableDeliverySystemDescriptor
...
typedef interface IDvbTerrestrialDeliverySystemDescriptor
...
typedef interface IDvbTerrestrial2DeliverySystemDescriptor
...
typedef interface IDvbPrivateDataSpecifierDescriptor
...
typedef interface IDvbHDSimulcastLogicalChannelDescriptor
...
typedef interface IDvbMultilingualServiceNameDescriptor
...
typedef interface IIsdbTerrestrialDeliverySystemDescriptor
...
typedef interface IIsdbDigitalCopyControlDescriptor
...
typedef interface IIsdbCAContractInformationDescriptor
...
typedef interface IIsdbEmergencyInformationDescriptor
...
typedef struct IDvbSiParserVtbl {
  ...
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(IDvbSiParser *This,
                                             /* [in] */ REFIID riid,
  ...
  HRESULT(STDMETHODCALLTYPE *Initialize)(IDvbSiParser *This,
                                         /* [in] */ IUnknown *punkMpeg2Data);

  DECLSPEC_XFGVIRT(IDvbSiParser, GetPAT)
  HRESULT(STDMETHODCALLTYPE *GetPAT)(IDvbSiParser *This,
                                     /* [out] */ IPAT **ppPAT);

  DECLSPEC_XFGVIRT(IDvbSiParser, GetCAT)
  HRESULT(STDMETHODCALLTYPE *GetCAT)(IDvbSiParser *This,
                                     /* [in] */ DWORD dwTimeout,
                                     /* [out] */ ICAT **ppCAT);

  DECLSPEC_XFGVIRT(IDvbSiParser, GetPMT)
  HRESULT(STDMETHODCALLTYPE *GetPMT)(IDvbSiParser *This,
                                     /* [in] */ PID pid,
                                     /* [annotation][in] */
                                     _In_opt_ WORD *pwProgramNumber,
                                     /* [out] */ IPMT **ppPMT);
  ...
  HRESULT(STDMETHODCALLTYPE *GetTSDT)(IDvbSiParser *This,
                                      /* [out] */ ITSDT **ppTSDT);

  DECLSPEC_XFGVIRT(IDvbSiParser, GetNIT)
  HRESULT(STDMETHODCALLTYPE *GetNIT)(IDvbSiParser *This,
                                     /* [in] */ TID tableId,
                                     /* [annotation][in] */
                                     _In_opt_ WORD *pwNetworkId,
                                     /* [out] */ IDVB_NIT **ppNIT);
  ...
  HRESULT(STDMETHODCALLTYPE *GetSDT)(IDvbSiParser *This,
                                     /* [in] */ TID tableId,
                                     /* [annotation][in] */
                                     _In_opt_ WORD *pwTransportStreamId,
                                     /* [out] */ IDVB_SDT **ppSDT);
  ...
  HRESULT(STDMETHODCALLTYPE *GetEIT)(IDvbSiParser *This,
                                     /* [in] */ TID tableId,
                                     /* [annotation][in] */
                                     _In_opt_ WORD *pwServiceId,
                                     /* [out] */ IDVB_EIT **ppEIT);
  ...
  HRESULT(STDMETHODCALLTYPE *GetBAT)(IDvbSiParser *This,
                                     /* [annotation][in] */
                                     _In_opt_ WORD *pwBouquetId,
                                     /* [out] */ IDVB_BAT **ppBAT);

  DECLSPEC_XFGVIRT(IDvbSiParser, GetRST)
  HRESULT(STDMETHODCALLTYPE *GetRST)(IDvbSiParser *This,
                                     /* [in] */ DWORD dwTimeout,
                                     /* [out] */ IDVB_RST **ppRST);

  DECLSPEC_XFGVIRT(IDvbSiParser, GetST)
  HRESULT(STDMETHODCALLTYPE *GetST)(IDvbSiParser *This,
                                    /* [in] */ PID pid,
                                    /* [in] */ DWORD dwTimeout,
                                    /* [out] */ IDVB_ST **ppST);

  DECLSPEC_XFGVIRT(IDvbSiParser, GetTDT)
  HRESULT(STDMETHODCALLTYPE *GetTDT)(IDvbSiParser *This,
                                     /* [out] */ IDVB_TDT **ppTDT);

  DECLSPEC_XFGVIRT(IDvbSiParser, GetTOT)
  HRESULT(STDMETHODCALLTYPE *GetTOT)(IDvbSiParser *This,
                                     /* [out] */ IDVB_TOT **ppTOT);

  DECLSPEC_XFGVIRT(IDvbSiParser, GetDIT)
  HRESULT(STDMETHODCALLTYPE *GetDIT)(IDvbSiParser *This,
                                     /* [in] */ DWORD dwTimeout,
                                     /* [out] */ IDVB_DIT **ppDIT);

  DECLSPEC_XFGVIRT(IDvbSiParser, GetSIT)
  HRESULT(STDMETHODCALLTYPE *GetSIT)(IDvbSiParser *This,
                                     /* [in] */ DWORD dwTimeout,
                                     /* [out] */ IDVB_SIT **ppSIT);
...
interface IDvbSiParser { CONST_VTBL struct IDvbSiParserVtbl *lpVtbl; };
...
typedef struct IDvbSiParser2Vtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(IDvbSiParser2 *This,
                                             /* [in] */ REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);
  ...
  DECLSPEC_XFGVIRT(IDvbSiParser, Initialize)
  HRESULT(STDMETHODCALLTYPE *Initialize)(IDvbSiParser2 *This,
                                         /* [in] */ IUnknown *punkMpeg2Data);

  DECLSPEC_XFGVIRT(IDvbSiParser, GetPAT)
  HRESULT(STDMETHODCALLTYPE *GetPAT)(IDvbSiParser2 *This,
                                     /* [out] */ IPAT **ppPAT);

  DECLSPEC_XFGVIRT(IDvbSiParser, GetCAT)
  HRESULT(STDMETHODCALLTYPE *GetCAT)(IDvbSiParser2 *This,
                                     /* [in] */ DWORD dwTimeout,
                                     /* [out] */ ICAT **ppCAT);

  DECLSPEC_XFGVIRT(IDvbSiParser, GetPMT)
  HRESULT(STDMETHODCALLTYPE *GetPMT)(IDvbSiParser2 *This,
                                     /* [in] */ PID pid,
                                     /* [annotation][in] */
                                     _In_opt_ WORD *pwProgramNumber,
                                     /* [out] */ IPMT **ppPMT);
  ...
  DECLSPEC_XFGVIRT(IDvbSiParser, GetTSDT)
  HRESULT(STDMETHODCALLTYPE *GetTSDT)(IDvbSiParser2 *This,
                                      /* [out] */ ITSDT **ppTSDT);

  DECLSPEC_XFGVIRT(IDvbSiParser, GetNIT)
  HRESULT(STDMETHODCALLTYPE *GetNIT)(IDvbSiParser2 *This,
                                     /* [in] */ TID tableId,
                                     /* [annotation][in] */
                                     _In_opt_ WORD *pwNetworkId,
                                     /* [out] */ IDVB_NIT **ppNIT);
  ...
  DECLSPEC_XFGVIRT(IDvbSiParser, GetSDT)
  HRESULT(STDMETHODCALLTYPE *GetSDT)(IDvbSiParser2 *This,
                                     /* [in] */ TID tableId,
                                     /* [annotation][in] */
                                     _In_opt_ WORD *pwTransportStreamId,
                                     /* [out] */ IDVB_SDT **ppSDT);
  ...
  DECLSPEC_XFGVIRT(IDvbSiParser, GetEIT)
  HRESULT(STDMETHODCALLTYPE *GetEIT)(IDvbSiParser2 *This,
                                     /* [in] */ TID tableId,
                                     /* [annotation][in] */
                                     _In_opt_ WORD *pwServiceId,
                                     /* [out] */ IDVB_EIT **ppEIT);
  ...
  DECLSPEC_XFGVIRT(IDvbSiParser, GetBAT)
  HRESULT(STDMETHODCALLTYPE *GetBAT)(IDvbSiParser2 *This,
                                     /* [annotation][in] */
                                     _In_opt_ WORD *pwBouquetId,
                                     /* [out] */ IDVB_BAT **ppBAT);

  DECLSPEC_XFGVIRT(IDvbSiParser, GetRST)
  HRESULT(STDMETHODCALLTYPE *GetRST)(IDvbSiParser2 *This,
                                     /* [in] */ DWORD dwTimeout,
                                     /* [out] */ IDVB_RST **ppRST);

  DECLSPEC_XFGVIRT(IDvbSiParser, GetST)
  HRESULT(STDMETHODCALLTYPE *GetST)(IDvbSiParser2 *This,
                                    /* [in] */ PID pid,
                                    /* [in] */ DWORD dwTimeout,
                                    /* [out] */ IDVB_ST **ppST);

  DECLSPEC_XFGVIRT(IDvbSiParser, GetTDT)
  HRESULT(STDMETHODCALLTYPE *GetTDT)(IDvbSiParser2 *This,
                                     /* [out] */ IDVB_TDT **ppTDT);

  DECLSPEC_XFGVIRT(IDvbSiParser, GetTOT)
  HRESULT(STDMETHODCALLTYPE *GetTOT)(IDvbSiParser2 *This,
                                     /* [out] */ IDVB_TOT **ppTOT);

  DECLSPEC_XFGVIRT(IDvbSiParser, GetDIT)
  HRESULT(STDMETHODCALLTYPE *GetDIT)(IDvbSiParser2 *This,
                                     /* [in] */ DWORD dwTimeout,
                                     /* [out] */ IDVB_DIT **ppDIT);

  DECLSPEC_XFGVIRT(IDvbSiParser, GetSIT)
  HRESULT(STDMETHODCALLTYPE *GetSIT)(IDvbSiParser2 *This,
                                     /* [in] */ DWORD dwTimeout,
                                     /* [out] */ IDVB_SIT **ppSIT);

  DECLSPEC_XFGVIRT(IDvbSiParser2, GetEIT2)
  HRESULT(STDMETHODCALLTYPE *GetEIT2)(IDvbSiParser2 *This,
                                      /* [in] */ TID tableId,
                                      /* [annotation][in] */
                                      _In_opt_ WORD *pwServiceId,
                                      /* [annotation][in] */
...
interface IDvbSiParser2 { CONST_VTBL struct IDvbSiParser2Vtbl *lpVtbl; };
...
typedef struct IIsdbSiParser2Vtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(IIsdbSiParser2 *This,
                                             /* [in] */ REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);
  ...
  DECLSPEC_XFGVIRT(IDvbSiParser, Initialize)
  HRESULT(STDMETHODCALLTYPE *Initialize)(IIsdbSiParser2 *This,
                                         /* [in] */ IUnknown *punkMpeg2Data);

  DECLSPEC_XFGVIRT(IDvbSiParser, GetPAT)
  HRESULT(STDMETHODCALLTYPE *GetPAT)(IIsdbSiParser2 *This,
                                     /* [out] */ IPAT **ppPAT);

  DECLSPEC_XFGVIRT(IDvbSiParser, GetCAT)
  HRESULT(STDMETHODCALLTYPE *GetCAT)(IIsdbSiParser2 *This,
                                     /* [in] */ DWORD dwTimeout,
                                     /* [out] */ ICAT **ppCAT);

  DECLSPEC_XFGVIRT(IDvbSiParser, GetPMT)
  HRESULT(STDMETHODCALLTYPE *GetPMT)(IIsdbSiParser2 *This,
                                     /* [in] */ PID pid,
                                     /* [annotation][in] */
                                     _In_opt_ WORD *pwProgramNumber,
                                     /* [out] */ IPMT **ppPMT);
  ...
  DECLSPEC_XFGVIRT(IDvbSiParser, GetTSDT)
  HRESULT(STDMETHODCALLTYPE *GetTSDT)(IIsdbSiParser2 *This,
                                      /* [out] */ ITSDT **ppTSDT);

  DECLSPEC_XFGVIRT(IDvbSiParser, GetNIT)
  HRESULT(STDMETHODCALLTYPE *GetNIT)(IIsdbSiParser2 *This,
                                     /* [in] */ TID tableId,
                                     /* [annotation][in] */
                                     _In_opt_ WORD *pwNetworkId,
                                     /* [out] */ IDVB_NIT **ppNIT);
  ...
  DECLSPEC_XFGVIRT(IDvbSiParser, GetSDT)
  HRESULT(STDMETHODCALLTYPE *GetSDT)(IIsdbSiParser2 *This,
                                     /* [in] */ TID tableId,
                                     /* [annotation][in] */
                                     _In_opt_ WORD *pwTransportStreamId,
                                     /* [out] */ IDVB_SDT **ppSDT);
  ...
  DECLSPEC_XFGVIRT(IDvbSiParser, GetEIT)
  HRESULT(STDMETHODCALLTYPE *GetEIT)(IIsdbSiParser2 *This,
                                     /* [in] */ TID tableId,
                                     /* [annotation][in] */
                                     _In_opt_ WORD *pwServiceId,
                                     /* [out] */ IDVB_EIT **ppEIT);
  ...
  DECLSPEC_XFGVIRT(IDvbSiParser, GetBAT)
  HRESULT(STDMETHODCALLTYPE *GetBAT)(IIsdbSiParser2 *This,
                                     /* [annotation][in] */
                                     _In_opt_ WORD *pwBouquetId,
                                     /* [out] */ IDVB_BAT **ppBAT);

  DECLSPEC_XFGVIRT(IDvbSiParser, GetRST)
  HRESULT(STDMETHODCALLTYPE *GetRST)(IIsdbSiParser2 *This,
                                     /* [in] */ DWORD dwTimeout,
                                     /* [out] */ IDVB_RST **ppRST);

  DECLSPEC_XFGVIRT(IDvbSiParser, GetST)
  HRESULT(STDMETHODCALLTYPE *GetST)(IIsdbSiParser2 *This,
                                    /* [in] */ PID pid,
                                    /* [in] */ DWORD dwTimeout,
                                    /* [out] */ IDVB_ST **ppST);

  DECLSPEC_XFGVIRT(IDvbSiParser, GetTDT)
  HRESULT(STDMETHODCALLTYPE *GetTDT)(IIsdbSiParser2 *This,
                                     /* [out] */ IDVB_TDT **ppTDT);

  DECLSPEC_XFGVIRT(IDvbSiParser, GetTOT)
  HRESULT(STDMETHODCALLTYPE *GetTOT)(IIsdbSiParser2 *This,
                                     /* [out] */ IDVB_TOT **ppTOT);

  DECLSPEC_XFGVIRT(IDvbSiParser, GetDIT)
  HRESULT(STDMETHODCALLTYPE *GetDIT)(IIsdbSiParser2 *This,
                                     /* [in] */ DWORD dwTimeout,
                                     /* [out] */ IDVB_DIT **ppDIT);

  DECLSPEC_XFGVIRT(IDvbSiParser, GetSIT)
  HRESULT(STDMETHODCALLTYPE *GetSIT)(IIsdbSiParser2 *This,
                                     /* [in] */ DWORD dwTimeout,
                                     /* [out] */ IDVB_SIT **ppSIT);

  DECLSPEC_XFGVIRT(IDvbSiParser2, GetEIT2)
  HRESULT(STDMETHODCALLTYPE *GetEIT2)(IIsdbSiParser2 *This,
                                      /* [in] */ TID tableId,
                                      /* [annotation][in] */
                                      _In_opt_ WORD *pwServiceId,
                                      /* [annotation][in] */
  ...
  HRESULT(STDMETHODCALLTYPE *GetBIT)(IIsdbSiParser2 *This,
                                     /* [in] */ TID tableId,
                                     /* [annotation][in] */
                                     _In_opt_ WORD *pwOriginalNetworkId,
                                     /* [out] */ IISDB_BIT **ppBIT);
  ...
  HRESULT(STDMETHODCALLTYPE *GetNBIT)(IIsdbSiParser2 *This,
                                      /* [in] */ TID tableId,
                                      /* [annotation][in] */
                                      _In_opt_ WORD *pwOriginalNetworkId,
  ...
  HRESULT(STDMETHODCALLTYPE *GetLDT)(IIsdbSiParser2 *This,
                                     /* [in] */ TID tableId,
                                     /* [annotation][in] */
                                     _In_opt_ WORD *pwOriginalServiceId,
                                     /* [out] */ IISDB_LDT **ppLDT);
  ...
  HRESULT(STDMETHODCALLTYPE *GetSDTT)(IIsdbSiParser2 *This,
                                      /* [in] */ TID tableId,
                                      /* [annotation][in] */
                                      _In_opt_ WORD *pwTableIdExt,
  ...
  HRESULT(STDMETHODCALLTYPE *GetCDT)(IIsdbSiParser2 *This,
                                     /* [in] */ TID tableId,
                                     /* [in] */ BYTE bSectionNumber,
                                     /* [annotation][in] */
                                     _In_opt_ WORD *pwDownloadDataId,
  ...
  HRESULT(STDMETHODCALLTYPE *GetEMM)(IIsdbSiParser2 *This,
                                     /* [in] */ PID pid,
                                     /* [in] */ WORD wTableIdExt,
                                     /* [out] */ IISDB_EMM **ppEMM);
...
interface IIsdbSiParser2 { CONST_VTBL struct IIsdbSiParser2Vtbl *lpVtbl; };
...
#define IIsdbSiParser2_GetCDT(This, tableId, bSectionNumber, pwDownloadDataId, \
                              ppCDT)                                           \
  ((This)->lpVtbl->GetCDT(This, tableId, bSectionNumber, pwDownloadDataId,     \
                          ppCDT))
...
typedef struct IDVB_NITVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(IDVB_NIT *This,
                                             /* [in] */ REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);
  ...
  HRESULT(STDMETHODCALLTYPE *Initialize)(IDVB_NIT *This,
                                         /* [in] */ ISectionList *pSectionList,
                                         /* [in] */ IMpeg2Data *pMPEGData);

  DECLSPEC_XFGVIRT(IDVB_NIT, GetVersionNumber)
  HRESULT(STDMETHODCALLTYPE *GetVersionNumber)(IDVB_NIT *This,
                                               /* [out] */ BYTE *pbVal);

  DECLSPEC_XFGVIRT(IDVB_NIT, GetNetworkId)
  HRESULT(STDMETHODCALLTYPE *GetNetworkId)(IDVB_NIT *This,
                                           /* [out] */ WORD *pwVal);
  ...
  HRESULT(STDMETHODCALLTYPE *GetCountOfRecords)(IDVB_NIT *This,
                                                /* [out] */ DWORD *pdwVal);
  ...
  HRESULT(STDMETHODCALLTYPE *GetNextTable)(IDVB_NIT *This,
                                           /* [out] */ IDVB_NIT **ppNIT);
  ...
  HRESULT(STDMETHODCALLTYPE *GetVersionHash)(IDVB_NIT *This,
                                             /* [out] */ DWORD *pdwVersionHash);

  END_INTERFACE
} IDVB_NITVtbl;

interface IDVB_NIT { CONST_VTBL struct IDVB_NITVtbl *lpVtbl; };
...
typedef struct IDVB_SDTVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(IDVB_SDT *This,
                                             /* [in] */ REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);
  ...
  HRESULT(STDMETHODCALLTYPE *Initialize)(IDVB_SDT *This,
                                         /* [in] */ ISectionList *pSectionList,
                                         /* [in] */ IMpeg2Data *pMPEGData);

  DECLSPEC_XFGVIRT(IDVB_SDT, GetVersionNumber)
  HRESULT(STDMETHODCALLTYPE *GetVersionNumber)(IDVB_SDT *This,
                                               /* [out] */ BYTE *pbVal);

  DECLSPEC_XFGVIRT(IDVB_SDT, GetTransportStreamId)
  HRESULT(STDMETHODCALLTYPE *GetTransportStreamId)(IDVB_SDT *This,
                                                   /* [out] */ WORD *pwVal);

  DECLSPEC_XFGVIRT(IDVB_SDT, GetOriginalNetworkId)
  HRESULT(STDMETHODCALLTYPE *GetOriginalNetworkId)(IDVB_SDT *This,
                                                   /* [out] */ WORD *pwVal);

  DECLSPEC_XFGVIRT(IDVB_SDT, GetCountOfRecords)
  HRESULT(STDMETHODCALLTYPE *GetCountOfRecords)(IDVB_SDT *This,
                                                /* [out] */ DWORD *pdwVal);

  DECLSPEC_XFGVIRT(IDVB_SDT, GetRecordServiceId)
  HRESULT(STDMETHODCALLTYPE *GetRecordServiceId)(IDVB_SDT *This,
                                                 /* [in] */ DWORD dwRecordIndex,
                                                 /* [out] */ WORD *pwVal);
  ...
  HRESULT(STDMETHODCALLTYPE *GetNextTable)(IDVB_SDT *This,
                                           /* [out] */ IDVB_SDT **ppSDT);
  ...
  HRESULT(STDMETHODCALLTYPE *GetVersionHash)(IDVB_SDT *This,
                                             /* [out] */ DWORD *pdwVersionHash);

  END_INTERFACE
} IDVB_SDTVtbl;

interface IDVB_SDT { CONST_VTBL struct IDVB_SDTVtbl *lpVtbl; };
...
typedef struct IISDB_SDTVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(IISDB_SDT *This,
                                             /* [in] */ REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);
  ...
  DECLSPEC_XFGVIRT(IDVB_SDT, Initialize)
  HRESULT(STDMETHODCALLTYPE *Initialize)(IISDB_SDT *This,
                                         /* [in] */ ISectionList *pSectionList,
                                         /* [in] */ IMpeg2Data *pMPEGData);

  DECLSPEC_XFGVIRT(IDVB_SDT, GetVersionNumber)
  HRESULT(STDMETHODCALLTYPE *GetVersionNumber)(IISDB_SDT *This,
                                               /* [out] */ BYTE *pbVal);

  DECLSPEC_XFGVIRT(IDVB_SDT, GetTransportStreamId)
  HRESULT(STDMETHODCALLTYPE *GetTransportStreamId)(IISDB_SDT *This,
                                                   /* [out] */ WORD *pwVal);

  DECLSPEC_XFGVIRT(IDVB_SDT, GetOriginalNetworkId)
  HRESULT(STDMETHODCALLTYPE *GetOriginalNetworkId)(IISDB_SDT *This,
                                                   /* [out] */ WORD *pwVal);

  DECLSPEC_XFGVIRT(IDVB_SDT, GetCountOfRecords)
  HRESULT(STDMETHODCALLTYPE *GetCountOfRecords)(IISDB_SDT *This,
                                                /* [out] */ DWORD *pdwVal);

  DECLSPEC_XFGVIRT(IDVB_SDT, GetRecordServiceId)
  HRESULT(STDMETHODCALLTYPE *GetRecordServiceId)(IISDB_SDT *This,
                                                 /* [in] */ DWORD dwRecordIndex,
                                                 /* [out] */ WORD *pwVal);
  ...
  DECLSPEC_XFGVIRT(IDVB_SDT, GetNextTable)
  HRESULT(STDMETHODCALLTYPE *GetNextTable)(IISDB_SDT *This,
                                           /* [out] */ IDVB_SDT **ppSDT);
  ...
  DECLSPEC_XFGVIRT(IDVB_SDT, GetVersionHash)
  HRESULT(STDMETHODCALLTYPE *GetVersionHash)(IISDB_SDT *This,
                                             /* [out] */ DWORD *pdwVersionHash);
...
interface IISDB_SDT { CONST_VTBL struct IISDB_SDTVtbl *lpVtbl; };
...
#define IISDB_SDT_GetRecordDescriptorByIndex(This, dwRecordIndex, dwIndex,     \
                                             ppDescriptor)                     \
  ((This)->lpVtbl->GetRecordDescriptorByIndex(This, dwRecordIndex, dwIndex,    \
                                              ppDescriptor))

#define IISDB_SDT_GetRecordDescriptorByTag(This, dwRecordIndex, bTag,          \
                                           pdwCookie, ppDescriptor)            \
  ((This)->lpVtbl->GetRecordDescriptorByTag(This, dwRecordIndex, bTag,         \
                                            pdwCookie, ppDescriptor))
...
typedef struct IDVB_EITVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(IDVB_EIT *This,
                                             /* [in] */ REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);
  ...
  HRESULT(STDMETHODCALLTYPE *Initialize)(IDVB_EIT *This,
                                         /* [in] */ ISectionList *pSectionList,
                                         /* [in] */ IMpeg2Data *pMPEGData);

  DECLSPEC_XFGVIRT(IDVB_EIT, GetVersionNumber)
  HRESULT(STDMETHODCALLTYPE *GetVersionNumber)(IDVB_EIT *This,
                                               /* [out] */ BYTE *pbVal);

  DECLSPEC_XFGVIRT(IDVB_EIT, GetServiceId)
  HRESULT(STDMETHODCALLTYPE *GetServiceId)(IDVB_EIT *This,
                                           /* [out] */ WORD *pwVal);

  DECLSPEC_XFGVIRT(IDVB_EIT, GetTransportStreamId)
  HRESULT(STDMETHODCALLTYPE *GetTransportStreamId)(IDVB_EIT *This,
                                                   /* [out] */ WORD *pwVal);

  DECLSPEC_XFGVIRT(IDVB_EIT, GetOriginalNetworkId)
  HRESULT(STDMETHODCALLTYPE *GetOriginalNetworkId)(IDVB_EIT *This,
                                                   /* [out] */ WORD *pwVal);
  ...
  HRESULT(STDMETHODCALLTYPE *GetLastTableId)(IDVB_EIT *This,
                                             /* [out] */ BYTE *pbVal);

  DECLSPEC_XFGVIRT(IDVB_EIT, GetCountOfRecords)
  HRESULT(STDMETHODCALLTYPE *GetCountOfRecords)(IDVB_EIT *This,
                                                /* [out] */ DWORD *pdwVal);

  DECLSPEC_XFGVIRT(IDVB_EIT, GetRecordEventId)
  HRESULT(STDMETHODCALLTYPE *GetRecordEventId)(IDVB_EIT *This,
                                               /* [in] */ DWORD dwRecordIndex,
                                               /* [out] */ WORD *pwVal);
  ...
  HRESULT(STDMETHODCALLTYPE *GetNextTable)(IDVB_EIT *This,
                                           /* [out] */ IDVB_EIT **ppEIT);
  ...
  HRESULT(STDMETHODCALLTYPE *GetVersionHash)(IDVB_EIT *This,
                                             /* [out] */ DWORD *pdwVersionHash);

  END_INTERFACE
} IDVB_EITVtbl;

interface IDVB_EIT { CONST_VTBL struct IDVB_EITVtbl *lpVtbl; };
...
typedef struct IDVB_EIT2Vtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(IDVB_EIT2 *This,
                                             /* [in] */ REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);
  ...
  DECLSPEC_XFGVIRT(IDVB_EIT, Initialize)
  HRESULT(STDMETHODCALLTYPE *Initialize)(IDVB_EIT2 *This,
                                         /* [in] */ ISectionList *pSectionList,
                                         /* [in] */ IMpeg2Data *pMPEGData);

  DECLSPEC_XFGVIRT(IDVB_EIT, GetVersionNumber)
  HRESULT(STDMETHODCALLTYPE *GetVersionNumber)(IDVB_EIT2 *This,
                                               /* [out] */ BYTE *pbVal);

  DECLSPEC_XFGVIRT(IDVB_EIT, GetServiceId)
  HRESULT(STDMETHODCALLTYPE *GetServiceId)(IDVB_EIT2 *This,
                                           /* [out] */ WORD *pwVal);

  DECLSPEC_XFGVIRT(IDVB_EIT, GetTransportStreamId)
  HRESULT(STDMETHODCALLTYPE *GetTransportStreamId)(IDVB_EIT2 *This,
                                                   /* [out] */ WORD *pwVal);

  DECLSPEC_XFGVIRT(IDVB_EIT, GetOriginalNetworkId)
  HRESULT(STDMETHODCALLTYPE *GetOriginalNetworkId)(IDVB_EIT2 *This,
                                                   /* [out] */ WORD *pwVal);
  ...
  DECLSPEC_XFGVIRT(IDVB_EIT, GetLastTableId)
  HRESULT(STDMETHODCALLTYPE *GetLastTableId)(IDVB_EIT2 *This,
                                             /* [out] */ BYTE *pbVal);

  DECLSPEC_XFGVIRT(IDVB_EIT, GetCountOfRecords)
  HRESULT(STDMETHODCALLTYPE *GetCountOfRecords)(IDVB_EIT2 *This,
                                                /* [out] */ DWORD *pdwVal);

  DECLSPEC_XFGVIRT(IDVB_EIT, GetRecordEventId)
  HRESULT(STDMETHODCALLTYPE *GetRecordEventId)(IDVB_EIT2 *This,
                                               /* [in] */ DWORD dwRecordIndex,
                                               /* [out] */ WORD *pwVal);
  ...
  DECLSPEC_XFGVIRT(IDVB_EIT, GetNextTable)
  HRESULT(STDMETHODCALLTYPE *GetNextTable)(IDVB_EIT2 *This,
                                           /* [out] */ IDVB_EIT **ppEIT);
  ...
  DECLSPEC_XFGVIRT(IDVB_EIT, GetVersionHash)
  HRESULT(STDMETHODCALLTYPE *GetVersionHash)(IDVB_EIT2 *This,
                                             /* [out] */ DWORD *pdwVersionHash);

  DECLSPEC_XFGVIRT(IDVB_EIT2, GetSegmentInfo)
  HRESULT(STDMETHODCALLTYPE *GetSegmentInfo)(IDVB_EIT2 *This,
                                             /* [out] */ BYTE *pbTid,
                                             /* [out] */ BYTE *pbSegment);

  DECLSPEC_XFGVIRT(IDVB_EIT2, GetRecordSection)
  HRESULT(STDMETHODCALLTYPE *GetRecordSection)(IDVB_EIT2 *This,
                                               /* [in] */ DWORD dwRecordIndex,
                                               /* [out] */ BYTE *pbVal);
...
interface IDVB_EIT2 { CONST_VTBL struct IDVB_EIT2Vtbl *lpVtbl; };
...
typedef struct IDVB_BATVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(IDVB_BAT *This,
                                             /* [in] */ REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);
  ...
  HRESULT(STDMETHODCALLTYPE *Initialize)(IDVB_BAT *This,
                                         /* [in] */ ISectionList *pSectionList,
                                         /* [in] */ IMpeg2Data *pMPEGData);

  DECLSPEC_XFGVIRT(IDVB_BAT, GetVersionNumber)
  HRESULT(STDMETHODCALLTYPE *GetVersionNumber)(IDVB_BAT *This,
                                               /* [out] */ BYTE *pbVal);

  DECLSPEC_XFGVIRT(IDVB_BAT, GetBouquetId)
  HRESULT(STDMETHODCALLTYPE *GetBouquetId)(IDVB_BAT *This,
                                           /* [out] */ WORD *pwVal);
  ...
  HRESULT(STDMETHODCALLTYPE *GetCountOfRecords)(IDVB_BAT *This,
                                                /* [out] */ DWORD *pdwVal);
  ...
  HRESULT(STDMETHODCALLTYPE *GetNextTable)(IDVB_BAT *This,
                                           /* [out] */ IDVB_BAT **ppBAT);
...
interface IDVB_BAT { CONST_VTBL struct IDVB_BATVtbl *lpVtbl; };
...
typedef struct IDVB_RSTVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(IDVB_RST *This,
                                             /* [in] */ REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);
  ...
  HRESULT(STDMETHODCALLTYPE *Initialize)(IDVB_RST *This,
                                         /* [in] */ ISectionList *pSectionList);

  DECLSPEC_XFGVIRT(IDVB_RST, GetCountOfRecords)
  HRESULT(STDMETHODCALLTYPE *GetCountOfRecords)(IDVB_RST *This,
                                                /* [out] */ DWORD *pdwVal);
  ...
  HRESULT(STDMETHODCALLTYPE *GetRecordServiceId)(IDVB_RST *This,
                                                 /* [in] */ DWORD dwRecordIndex,
                                                 /* [out] */ WORD *pwVal);

  DECLSPEC_XFGVIRT(IDVB_RST, GetRecordEventId)
  HRESULT(STDMETHODCALLTYPE *GetRecordEventId)(IDVB_RST *This,
                                               /* [in] */ DWORD dwRecordIndex,
                                               /* [out] */ WORD *pwVal);
...
interface IDVB_RST { CONST_VTBL struct IDVB_RSTVtbl *lpVtbl; };
...
typedef struct IDVB_STVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(IDVB_ST *This,
                                             /* [in] */ REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);
  ...
  HRESULT(STDMETHODCALLTYPE *Initialize)(IDVB_ST *This,
                                         /* [in] */ ISectionList *pSectionList);

  DECLSPEC_XFGVIRT(IDVB_ST, GetDataLength)
  HRESULT(STDMETHODCALLTYPE *GetDataLength)(IDVB_ST *This,
                                            /* [out] */ WORD *pwVal);

  DECLSPEC_XFGVIRT(IDVB_ST, GetData)
  HRESULT(STDMETHODCALLTYPE *GetData)(IDVB_ST *This,
                                      /* [out] */ BYTE **ppData);

  END_INTERFACE
} IDVB_STVtbl;

interface IDVB_ST { CONST_VTBL struct IDVB_STVtbl *lpVtbl; };
...
typedef struct IDVB_TDTVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(IDVB_TDT *This,
                                             /* [in] */ REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);
  ...
  HRESULT(STDMETHODCALLTYPE *Initialize)(IDVB_TDT *This,
                                         /* [in] */ ISectionList *pSectionList);
...
interface IDVB_TDT { CONST_VTBL struct IDVB_TDTVtbl *lpVtbl; };
...
typedef struct IDVB_TOTVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(IDVB_TOT *This,
                                             /* [in] */ REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);
  ...
  HRESULT(STDMETHODCALLTYPE *Initialize)(IDVB_TOT *This,
                                         /* [in] */ ISectionList *pSectionList);
...
interface IDVB_TOT { CONST_VTBL struct IDVB_TOTVtbl *lpVtbl; };
...
typedef struct IDVB_DITVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(IDVB_DIT *This,
                                             /* [in] */ REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);
  ...
  HRESULT(STDMETHODCALLTYPE *Initialize)(IDVB_DIT *This,
                                         /* [in] */ ISectionList *pSectionList);

  DECLSPEC_XFGVIRT(IDVB_DIT, GetTransitionFlag)
  HRESULT(STDMETHODCALLTYPE *GetTransitionFlag)(IDVB_DIT *This,
                                                /* [out] */ BOOL *pfVal);

  END_INTERFACE
} IDVB_DITVtbl;

interface IDVB_DIT { CONST_VTBL struct IDVB_DITVtbl *lpVtbl; };
...
typedef struct IDVB_SITVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(IDVB_SIT *This,
                                             /* [in] */ REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);
  ...
  HRESULT(STDMETHODCALLTYPE *Initialize)(IDVB_SIT *This,
                                         /* [in] */ ISectionList *pSectionList,
                                         /* [in] */ IMpeg2Data *pMPEGData);

  DECLSPEC_XFGVIRT(IDVB_SIT, GetVersionNumber)
  HRESULT(STDMETHODCALLTYPE *GetVersionNumber)(IDVB_SIT *This,
                                               /* [out] */ BYTE *pbVal);
  ...
  HRESULT(STDMETHODCALLTYPE *GetCountOfRecords)(IDVB_SIT *This,
                                                /* [out] */ DWORD *pdwVal);

  DECLSPEC_XFGVIRT(IDVB_SIT, GetRecordServiceId)
  HRESULT(STDMETHODCALLTYPE *GetRecordServiceId)(IDVB_SIT *This,
                                                 /* [in] */ DWORD dwRecordIndex,
                                                 /* [out] */ WORD *pwVal);
  ...
  HRESULT(STDMETHODCALLTYPE *GetNextTable)(IDVB_SIT *This,
                                           /* [in] */ DWORD dwTimeout,
                                           /* [out] */ IDVB_SIT **ppSIT);
...
interface IDVB_SIT { CONST_VTBL struct IDVB_SITVtbl *lpVtbl; };
...
typedef struct IISDB_BITVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(IISDB_BIT *This,
                                             /* [in] */ REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);
  ...
  HRESULT(STDMETHODCALLTYPE *Initialize)(IISDB_BIT *This,
                                         /* [in] */ ISectionList *pSectionList,
                                         /* [in] */ IMpeg2Data *pMPEGData);

  DECLSPEC_XFGVIRT(IISDB_BIT, GetVersionNumber)
  HRESULT(STDMETHODCALLTYPE *GetVersionNumber)(IISDB_BIT *This,
                                               /* [out] */ BYTE *pbVal);

  DECLSPEC_XFGVIRT(IISDB_BIT, GetOriginalNetworkId)
  HRESULT(STDMETHODCALLTYPE *GetOriginalNetworkId)(IISDB_BIT *This,
                                                   /* [out] */ WORD *pwVal);
  ...
  HRESULT(STDMETHODCALLTYPE *GetCountOfRecords)(IISDB_BIT *This,
                                                /* [out] */ DWORD *pdwVal);
  ...
  HRESULT(STDMETHODCALLTYPE *GetVersionHash)(IISDB_BIT *This,
                                             /* [out] */ DWORD *pdwVersionHash);

  END_INTERFACE
} IISDB_BITVtbl;

interface IISDB_BIT { CONST_VTBL struct IISDB_BITVtbl *lpVtbl; };
...
#define IISDB_BIT_GetRecordDescriptorByIndex(This, dwRecordIndex, dwIndex,     \
                                             ppDescriptor)                     \
  ((This)->lpVtbl->GetRecordDescriptorByIndex(This, dwRecordIndex, dwIndex,    \
                                              ppDescriptor))

#define IISDB_BIT_GetRecordDescriptorByTag(This, dwRecordIndex, bTag,          \
                                           pdwCookie, ppDescriptor)            \
  ((This)->lpVtbl->GetRecordDescriptorByTag(This, dwRecordIndex, bTag,         \
                                            pdwCookie, ppDescriptor))
...
typedef struct IISDB_NBITVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(IISDB_NBIT *This,
                                             /* [in] */ REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);
  ...
  HRESULT(STDMETHODCALLTYPE *Initialize)(IISDB_NBIT *This,
                                         /* [in] */ ISectionList *pSectionList,
                                         /* [in] */ IMpeg2Data *pMPEGData);

  DECLSPEC_XFGVIRT(IISDB_NBIT, GetVersionNumber)
  HRESULT(STDMETHODCALLTYPE *GetVersionNumber)(IISDB_NBIT *This,
                                               /* [out] */ BYTE *pbVal);

  DECLSPEC_XFGVIRT(IISDB_NBIT, GetOriginalNetworkId)
  HRESULT(STDMETHODCALLTYPE *GetOriginalNetworkId)(IISDB_NBIT *This,
                                                   /* [out] */ WORD *pwVal);

  DECLSPEC_XFGVIRT(IISDB_NBIT, GetCountOfRecords)
  HRESULT(STDMETHODCALLTYPE *GetCountOfRecords)(IISDB_NBIT *This,
                                                /* [out] */ DWORD *pdwVal);
  ...
  HRESULT(STDMETHODCALLTYPE *GetRecordKeys)(IISDB_NBIT *This,
                                            /* [in] */ DWORD dwRecordIndex,
                                            /* [out] */ BYTE **pbKeys);
  ...
  HRESULT(STDMETHODCALLTYPE *GetVersionHash)(IISDB_NBIT *This,
                                             /* [out] */ DWORD *pdwVersionHash);

  END_INTERFACE
} IISDB_NBITVtbl;

interface IISDB_NBIT { CONST_VTBL struct IISDB_NBITVtbl *lpVtbl; };
...
#define IISDB_NBIT_GetRecordDescriptionBodyLocation(This, dwRecordIndex,       \
                                                    pbVal)                     \
...
#define IISDB_NBIT_GetRecordDescriptorByIndex(This, dwRecordIndex, dwIndex,    \
                                              ppDescriptor)                    \
  ((This)->lpVtbl->GetRecordDescriptorByIndex(This, dwRecordIndex, dwIndex,    \
                                              ppDescriptor))

#define IISDB_NBIT_GetRecordDescriptorByTag(This, dwRecordIndex, bTag,         \
                                            pdwCookie, ppDescriptor)           \
  ((This)->lpVtbl->GetRecordDescriptorByTag(This, dwRecordIndex, bTag,         \
                                            pdwCookie, ppDescriptor))
...
typedef struct IISDB_LDTVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(IISDB_LDT *This,
                                             /* [in] */ REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);
  ...
  HRESULT(STDMETHODCALLTYPE *Initialize)(IISDB_LDT *This,
                                         /* [in] */ ISectionList *pSectionList,
                                         /* [in] */ IMpeg2Data *pMPEGData);

  DECLSPEC_XFGVIRT(IISDB_LDT, GetVersionNumber)
  HRESULT(STDMETHODCALLTYPE *GetVersionNumber)(IISDB_LDT *This,
                                               /* [out] */ BYTE *pbVal);

  DECLSPEC_XFGVIRT(IISDB_LDT, GetOriginalServiceId)
  HRESULT(STDMETHODCALLTYPE *GetOriginalServiceId)(IISDB_LDT *This,
                                                   /* [out] */ WORD *pwVal);

  DECLSPEC_XFGVIRT(IISDB_LDT, GetTransportStreamId)
  HRESULT(STDMETHODCALLTYPE *GetTransportStreamId)(IISDB_LDT *This,
                                                   /* [out] */ WORD *pwVal);

  DECLSPEC_XFGVIRT(IISDB_LDT, GetOriginalNetworkId)
  HRESULT(STDMETHODCALLTYPE *GetOriginalNetworkId)(IISDB_LDT *This,
                                                   /* [out] */ WORD *pwVal);

  DECLSPEC_XFGVIRT(IISDB_LDT, GetCountOfRecords)
  HRESULT(STDMETHODCALLTYPE *GetCountOfRecords)(IISDB_LDT *This,
                                                /* [out] */ DWORD *pdwVal);
  ...
  HRESULT(STDMETHODCALLTYPE *GetVersionHash)(IISDB_LDT *This,
                                             /* [out] */ DWORD *pdwVersionHash);

  END_INTERFACE
} IISDB_LDTVtbl;

interface IISDB_LDT { CONST_VTBL struct IISDB_LDTVtbl *lpVtbl; };
...
#define IISDB_LDT_GetRecordDescriptorByIndex(This, dwRecordIndex, dwIndex,     \
                                             ppDescriptor)                     \
  ((This)->lpVtbl->GetRecordDescriptorByIndex(This, dwRecordIndex, dwIndex,    \
                                              ppDescriptor))

#define IISDB_LDT_GetRecordDescriptorByTag(This, dwRecordIndex, bTag,          \
                                           pdwCookie, ppDescriptor)            \
  ((This)->lpVtbl->GetRecordDescriptorByTag(This, dwRecordIndex, bTag,         \
                                            pdwCookie, ppDescriptor))
...
typedef struct IISDB_SDTTVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(IISDB_SDTT *This,
                                             /* [in] */ REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);
  ...
  HRESULT(STDMETHODCALLTYPE *Initialize)(IISDB_SDTT *This,
                                         /* [in] */ ISectionList *pSectionList,
                                         /* [in] */ IMpeg2Data *pMPEGData);

  DECLSPEC_XFGVIRT(IISDB_SDTT, GetVersionNumber)
  HRESULT(STDMETHODCALLTYPE *GetVersionNumber)(IISDB_SDTT *This,
                                               /* [out] */ BYTE *pbVal);

  DECLSPEC_XFGVIRT(IISDB_SDTT, GetTableIdExt)
  HRESULT(STDMETHODCALLTYPE *GetTableIdExt)(IISDB_SDTT *This,
                                            /* [out] */ WORD *pwVal);

  DECLSPEC_XFGVIRT(IISDB_SDTT, GetTransportStreamId)
  HRESULT(STDMETHODCALLTYPE *GetTransportStreamId)(IISDB_SDTT *This,
                                                   /* [out] */ WORD *pwVal);

  DECLSPEC_XFGVIRT(IISDB_SDTT, GetOriginalNetworkId)
  HRESULT(STDMETHODCALLTYPE *GetOriginalNetworkId)(IISDB_SDTT *This,
                                                   /* [out] */ WORD *pwVal);

  DECLSPEC_XFGVIRT(IISDB_SDTT, GetServiceId)
  HRESULT(STDMETHODCALLTYPE *GetServiceId)(IISDB_SDTT *This,
                                           /* [out] */ WORD *pwVal);

  DECLSPEC_XFGVIRT(IISDB_SDTT, GetCountOfRecords)
  HRESULT(STDMETHODCALLTYPE *GetCountOfRecords)(IISDB_SDTT *This,
                                                /* [out] */ DWORD *pdwVal);

  DECLSPEC_XFGVIRT(IISDB_SDTT, GetRecordGroup)
  HRESULT(STDMETHODCALLTYPE *GetRecordGroup)(IISDB_SDTT *This,
                                             /* [in] */ DWORD dwRecordIndex,
                                             /* [out] */ BYTE *pbVal);
  ...
  HRESULT(STDMETHODCALLTYPE *GetVersionHash)(IISDB_SDTT *This,
                                             /* [out] */ DWORD *pdwVersionHash);

  END_INTERFACE
} IISDB_SDTTVtbl;

interface IISDB_SDTT { CONST_VTBL struct IISDB_SDTTVtbl *lpVtbl; };
...
#define IISDB_SDTT_GetRecordScheduleTimeShiftInformation(This, dwRecordIndex,  \
                                                         pbVal)                \
  ((This)->lpVtbl->GetRecordScheduleTimeShiftInformation(This, dwRecordIndex,  \
                                                         pbVal))
...
#define IISDB_SDTT_GetRecordStartTimeByIndex(This, dwRecordIndex, dwIndex,     \
                                             pmdtVal)                          \
  ((This)->lpVtbl->GetRecordStartTimeByIndex(This, dwRecordIndex, dwIndex,     \
                                             pmdtVal))

#define IISDB_SDTT_GetRecordDurationByIndex(This, dwRecordIndex, dwIndex,      \
                                            pmdVal)                            \
  ((This)->lpVtbl->GetRecordDurationByIndex(This, dwRecordIndex, dwIndex,      \
                                            pmdVal))

#define IISDB_SDTT_GetRecordCountOfDescriptors(This, dwRecordIndex, pdwVal)    \
  ((This)->lpVtbl->GetRecordCountOfDescriptors(This, dwRecordIndex, pdwVal))

#define IISDB_SDTT_GetRecordDescriptorByIndex(This, dwRecordIndex, dwIndex,    \
                                              ppDescriptor)                    \
  ((This)->lpVtbl->GetRecordDescriptorByIndex(This, dwRecordIndex, dwIndex,    \
                                              ppDescriptor))

#define IISDB_SDTT_GetRecordDescriptorByTag(This, dwRecordIndex, bTag,         \
                                            pdwCookie, ppDescriptor)           \
  ((This)->lpVtbl->GetRecordDescriptorByTag(This, dwRecordIndex, bTag,         \
                                            pdwCookie, ppDescriptor))
...
typedef struct IISDB_CDTVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(IISDB_CDT *This,
                                             /* [in] */ REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);
  ...
  HRESULT(STDMETHODCALLTYPE *Initialize)(IISDB_CDT *This,
                                         /* [in] */ ISectionList *pSectionList,
                                         /* [in] */ IMpeg2Data *pMPEGData,
                                         /* [in] */ BYTE bSectionNumber);

  DECLSPEC_XFGVIRT(IISDB_CDT, GetVersionNumber)
  HRESULT(STDMETHODCALLTYPE *GetVersionNumber)(IISDB_CDT *This,
                                               /* [out] */ BYTE *pbVal);

  DECLSPEC_XFGVIRT(IISDB_CDT, GetDownloadDataId)
  HRESULT(STDMETHODCALLTYPE *GetDownloadDataId)(IISDB_CDT *This,
                                                /* [out] */ WORD *pwVal);

  DECLSPEC_XFGVIRT(IISDB_CDT, GetSectionNumber)
  HRESULT(STDMETHODCALLTYPE *GetSectionNumber)(IISDB_CDT *This,
                                               /* [out] */ BYTE *pbVal);

  DECLSPEC_XFGVIRT(IISDB_CDT, GetOriginalNetworkId)
  HRESULT(STDMETHODCALLTYPE *GetOriginalNetworkId)(IISDB_CDT *This,
                                                   /* [out] */ WORD *pwVal);

  DECLSPEC_XFGVIRT(IISDB_CDT, GetDataType)
  HRESULT(STDMETHODCALLTYPE *GetDataType)(IISDB_CDT *This,
                                          /* [out] */ BYTE *pbVal);
  ...
  HRESULT(STDMETHODCALLTYPE *GetSizeOfDataModule)(IISDB_CDT *This,
                                                  /* [out] */ DWORD *pdwVal);

  DECLSPEC_XFGVIRT(IISDB_CDT, GetDataModule)
  HRESULT(STDMETHODCALLTYPE *GetDataModule)(IISDB_CDT *This,
                                            /* [out] */ BYTE **pbData);

  DECLSPEC_XFGVIRT(IISDB_CDT, GetVersionHash)
  HRESULT(STDMETHODCALLTYPE *GetVersionHash)(IISDB_CDT *This,
                                             /* [out] */ DWORD *pdwVersionHash);

  END_INTERFACE
} IISDB_CDTVtbl;

interface IISDB_CDT { CONST_VTBL struct IISDB_CDTVtbl *lpVtbl; };
...
public:
  ...
  virtual HRESULT STDMETHODCALLTYPE GetSharedEmmMessage(WORD * pwLength,
                                                        BYTE * *ppbMessage) = 0;

  virtual HRESULT STDMETHODCALLTYPE GetIndividualEmmMessage(
      IUnknown * pUnknown, WORD * pwLength, BYTE * *ppbMessage) = 0;
...
typedef struct IISDB_EMMVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(IISDB_EMM *This,
                                             /* [in] */ REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);
  ...
  HRESULT(STDMETHODCALLTYPE *Initialize)(IISDB_EMM *This,
                                         /* [in] */ ISectionList *pSectionList,
                                         /* [in] */ IMpeg2Data *pMPEGData);

  DECLSPEC_XFGVIRT(IISDB_EMM, GetVersionNumber)
  HRESULT(STDMETHODCALLTYPE *GetVersionNumber)(IISDB_EMM *This,
                                               /* [out] */ BYTE *pbVal);

  DECLSPEC_XFGVIRT(IISDB_EMM, GetTableIdExtension)
  HRESULT(STDMETHODCALLTYPE *GetTableIdExtension)(IISDB_EMM *This,
                                                  /* [out] */ WORD *pwVal);

  DECLSPEC_XFGVIRT(IISDB_EMM, GetDataBytes)
  HRESULT(STDMETHODCALLTYPE *GetDataBytes)(IISDB_EMM *This,
                                           /* [out][in] */ WORD *pwBufferLength,
                                           /* [out] */ BYTE *pbBuffer);

  DECLSPEC_XFGVIRT(IISDB_EMM, GetSharedEmmMessage)
  HRESULT(STDMETHODCALLTYPE *GetSharedEmmMessage)(IISDB_EMM *This,
                                                  WORD *pwLength,
                                                  BYTE **ppbMessage);

  DECLSPEC_XFGVIRT(IISDB_EMM, GetIndividualEmmMessage)
  HRESULT(STDMETHODCALLTYPE *GetIndividualEmmMessage)(IISDB_EMM *This,
                                                      IUnknown *pUnknown,
                                                      WORD *pwLength,
                                                      BYTE **ppbMessage);

  DECLSPEC_XFGVIRT(IISDB_EMM, GetVersionHash)
  HRESULT(STDMETHODCALLTYPE *GetVersionHash)(IISDB_EMM *This,
                                             /* [out] */ DWORD *pdwVersionHash);

  END_INTERFACE
} IISDB_EMMVtbl;

interface IISDB_EMM { CONST_VTBL struct IISDB_EMMVtbl *lpVtbl; };
...
#define IISDB_EMM_GetIndividualEmmMessage(This, pUnknown, pwLength,            \
                                          ppbMessage)                          \
  ((This)->lpVtbl->GetIndividualEmmMessage(This, pUnknown, pwLength,           \
                                           ppbMessage))
...
typedef struct IDvbServiceAttributeDescriptorVtbl {
  ...
  HRESULT(STDMETHODCALLTYPE *GetTag)(IDvbServiceAttributeDescriptor *This,
                                     /* [out] */ BYTE *pbVal);

  DECLSPEC_XFGVIRT(IDvbServiceAttributeDescriptor, GetLength)
  HRESULT(STDMETHODCALLTYPE *GetLength)(IDvbServiceAttributeDescriptor *This,
                                        /* [out] */ BYTE *pbVal);
  ...
  DECLSPEC_XFGVIRT(IDvbServiceAttributeDescriptor,
                   GetRecordNumericSelectionFlag)
...
#define IDvbServiceAttributeDescriptor_GetRecordServiceId(This, bRecordIndex,  \
                                                          pwVal)               \
  ((This)->lpVtbl->GetRecordServiceId(This, bRecordIndex, pwVal))

#define IDvbServiceAttributeDescriptor_GetRecordNumericSelectionFlag(          \
    This, bRecordIndex, pfVal)                                                 \
  ((This)->lpVtbl->GetRecordNumericSelectionFlag(This, bRecordIndex, pfVal))

#define IDvbServiceAttributeDescriptor_GetRecordVisibleServiceFlag(            \
    This, bRecordIndex, pfVal)                                                 \
...
typedef struct IDvbContentIdentifierDescriptorVtbl {
  ...
  HRESULT(STDMETHODCALLTYPE *GetTag)(IDvbContentIdentifierDescriptor *This,
                                     /* [out] */ BYTE *pbVal);

  DECLSPEC_XFGVIRT(IDvbContentIdentifierDescriptor, GetLength)
  HRESULT(STDMETHODCALLTYPE *GetLength)(IDvbContentIdentifierDescriptor *This,
                                        /* [out] */ BYTE *pbVal);
...
typedef struct IDvbDefaultAuthorityDescriptorVtbl {
  ...
  HRESULT(STDMETHODCALLTYPE *GetTag)(IDvbDefaultAuthorityDescriptor *This,
                                     /* [out] */ BYTE *pbVal);

  DECLSPEC_XFGVIRT(IDvbDefaultAuthorityDescriptor, GetLength)
  HRESULT(STDMETHODCALLTYPE *GetLength)(IDvbDefaultAuthorityDescriptor *This,
                                        /* [out] */ BYTE *pbVal);
...
#define IDvbSatelliteDeliverySystemDescriptor_QueryInterface(This, riid,       \
                                                             ppvObject)        \
  ((This)->lpVtbl->QueryInterface(This, riid, ppvObject))
...
typedef struct IDvbCableDeliverySystemDescriptorVtbl {
  ...
  HRESULT(STDMETHODCALLTYPE *GetTag)(IDvbCableDeliverySystemDescriptor *This,
                                     /* [out] */ BYTE *pbVal);

  DECLSPEC_XFGVIRT(IDvbCableDeliverySystemDescriptor, GetLength)
  HRESULT(STDMETHODCALLTYPE *GetLength)(IDvbCableDeliverySystemDescriptor *This,
                                        /* [out] */ BYTE *pbVal);
...
#define IDvbCableDeliverySystemDescriptor_QueryInterface(This, riid,           \
                                                         ppvObject)            \
  ((This)->lpVtbl->QueryInterface(This, riid, ppvObject))
...
typedef struct IDvbTerrestrialDeliverySystemDescriptorVtbl {
  ...
  DECLSPEC_XFGVIRT(IDvbTerrestrialDeliverySystemDescriptor,
...
#define IDvbTerrestrialDeliverySystemDescriptor_QueryInterface(This, riid,     \
                                                               ppvObject)      \
  ((This)->lpVtbl->QueryInterface(This, riid, ppvObject))
...
#define IDvbTerrestrialDeliverySystemDescriptor_GetCentreFrequency(This,       \
                                                                   pdwVal)     \
...
#define IDvbTerrestrialDeliverySystemDescriptor_GetCodeRateHPStream(This,      \
                                                                    pbVal)     \
  ((This)->lpVtbl->GetCodeRateHPStream(This, pbVal))

#define IDvbTerrestrialDeliverySystemDescriptor_GetCodeRateLPStream(This,      \
                                                                    pbVal)     \
...
#define IDvbTerrestrialDeliverySystemDescriptor_GetTransmissionMode(This,      \
                                                                    pbVal)     \
...
typedef struct IDvbTerrestrial2DeliverySystemDescriptorVtbl {
  ...
  DECLSPEC_XFGVIRT(IDvbTerrestrial2DeliverySystemDescriptor,
...
#define IDvbTerrestrial2DeliverySystemDescriptor_QueryInterface(This, riid,    \
                                                                ppvObject)     \
  ((This)->lpVtbl->QueryInterface(This, riid, ppvObject))
...
#define IDvbTerrestrial2DeliverySystemDescriptor_GetCentreFrequency(This,      \
                                                                    pdwVal)    \
  ((This)->lpVtbl->GetCentreFrequency(This, pdwVal))
...
#define IDvbTerrestrial2DeliverySystemDescriptor_GetMultipleInputMode(This,    \
                                                                      pbVal)   \
...
#define IDvbTerrestrial2DeliverySystemDescriptor_GetTransmissionMode(This,     \
                                                                     pbVal)    \
  ((This)->lpVtbl->GetTransmissionMode(This, pbVal))
...
#define IDvbTerrestrial2DeliverySystemDescriptor_GetOtherFrequencyFlag(This,   \
                                                                       pbVal)  \
  ((This)->lpVtbl->GetOtherFrequencyFlag(This, pbVal))
...
typedef struct IDvbFrequencyListDescriptorVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(IDvbFrequencyListDescriptor *This,
                                             /* [in] */ REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);
  ...
  HRESULT(STDMETHODCALLTYPE *GetTag)(IDvbFrequencyListDescriptor *This,
                                     /* [out] */ BYTE *pbVal);

  DECLSPEC_XFGVIRT(IDvbFrequencyListDescriptor, GetLength)
  HRESULT(STDMETHODCALLTYPE *GetLength)(IDvbFrequencyListDescriptor *This,
                                        /* [out] */ BYTE *pbVal);

  DECLSPEC_XFGVIRT(IDvbFrequencyListDescriptor, GetCodingType)
  HRESULT(STDMETHODCALLTYPE *GetCodingType)(IDvbFrequencyListDescriptor *This,
                                            /* [out] */ BYTE *pbVal);
...
typedef struct IDvbPrivateDataSpecifierDescriptorVtbl {
  ...
  HRESULT(STDMETHODCALLTYPE *GetTag)(IDvbPrivateDataSpecifierDescriptor *This,
                                     /* [out] */ BYTE *pbVal);
...
typedef struct IDvbLogicalChannelDescriptorVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(IDvbLogicalChannelDescriptor *This,
                                             /* [in] */ REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);
  ...
  HRESULT(STDMETHODCALLTYPE *GetTag)(IDvbLogicalChannelDescriptor *This,
                                     /* [out] */ BYTE *pbVal);

  DECLSPEC_XFGVIRT(IDvbLogicalChannelDescriptor, GetLength)
  HRESULT(STDMETHODCALLTYPE *GetLength)(IDvbLogicalChannelDescriptor *This,
                                        /* [out] */ BYTE *pbVal);
...
typedef struct IDvbLogicalChannelDescriptor2Vtbl {
  ...
  DECLSPEC_XFGVIRT(IDvbLogicalChannelDescriptor, GetTag)
  HRESULT(STDMETHODCALLTYPE *GetTag)(IDvbLogicalChannelDescriptor2 *This,
                                     /* [out] */ BYTE *pbVal);

  DECLSPEC_XFGVIRT(IDvbLogicalChannelDescriptor, GetLength)
  HRESULT(STDMETHODCALLTYPE *GetLength)(IDvbLogicalChannelDescriptor2 *This,
                                        /* [out] */ BYTE *pbVal);
  ...
  DECLSPEC_XFGVIRT(IDvbLogicalChannelDescriptor2,
                   GetRecordLogicalChannelAndVisibility)
...
#define IDvbLogicalChannelDescriptor2_GetRecordLogicalChannelAndVisibility(    \
    This, bRecordIndex, pwVal)                                                 \
  ((This)->lpVtbl->GetRecordLogicalChannelAndVisibility(This, bRecordIndex,    \
                                                        pwVal))
...
typedef struct IDvbLogicalChannel2DescriptorVtbl {
  ...
  DECLSPEC_XFGVIRT(IDvbLogicalChannelDescriptor, GetTag)
  HRESULT(STDMETHODCALLTYPE *GetTag)(IDvbLogicalChannel2Descriptor *This,
                                     /* [out] */ BYTE *pbVal);

  DECLSPEC_XFGVIRT(IDvbLogicalChannelDescriptor, GetLength)
  HRESULT(STDMETHODCALLTYPE *GetLength)(IDvbLogicalChannel2Descriptor *This,
                                        /* [out] */ BYTE *pbVal);
  ...
  HRESULT(STDMETHODCALLTYPE *GetListId)(IDvbLogicalChannel2Descriptor *This,
                                        /* [in] */ BYTE bListIndex,
                                        /* [out] */ BYTE *pbVal);

  DECLSPEC_XFGVIRT(IDvbLogicalChannel2Descriptor, GetListNameW)
  HRESULT(STDMETHODCALLTYPE *GetListNameW)(IDvbLogicalChannel2Descriptor *This,
                                           /* [in] */ BYTE bListIndex,
                                           /* [in] */ DVB_STRCONV_MODE convMode,
                                           /* [out] */ BSTR *pbstrName);
  ...
  DECLSPEC_XFGVIRT(IDvbLogicalChannel2Descriptor,
                   GetListRecordLogicalChannelNumber)
  ...
  DECLSPEC_XFGVIRT(IDvbLogicalChannel2Descriptor,
                   GetListRecordLogicalChannelAndVisibility)
...
#define IDvbLogicalChannel2Descriptor_GetListRecordServiceId(                  \
  ...
  ((This)->lpVtbl->GetListRecordServiceId(This, bListIndex, bRecordIndex,      \
                                          pwVal))
...
IDvbHDSimulcastLogicalChannelDescriptor
    : public IDvbLogicalChannelDescriptor2{public : };
...
#define IDvbHDSimulcastLogicalChannelDescriptor_GetRecordLogicalChannelAndVisibility( \
    This, bRecordIndex, pwVal)                                                        \
  ((This)->lpVtbl->GetRecordLogicalChannelAndVisibility(This, bRecordIndex,           \
                                                        pwVal))
...
typedef struct IDvbDataBroadcastIDDescriptorVtbl {
  ...
  HRESULT(STDMETHODCALLTYPE *GetTag)(IDvbDataBroadcastIDDescriptor *This,
                                     /* [out] */ BYTE *pbVal);

  DECLSPEC_XFGVIRT(IDvbDataBroadcastIDDescriptor, GetLength)
  HRESULT(STDMETHODCALLTYPE *GetLength)(IDvbDataBroadcastIDDescriptor *This,
                                        /* [out] */ BYTE *pbVal);
...
typedef struct IDvbDataBroadcastDescriptorVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(IDvbDataBroadcastDescriptor *This,
                                             /* [in] */ REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);
  ...
  HRESULT(STDMETHODCALLTYPE *GetTag)(IDvbDataBroadcastDescriptor *This,
                                     /* [out] */ BYTE *pbVal);

  DECLSPEC_XFGVIRT(IDvbDataBroadcastDescriptor, GetLength)
  HRESULT(STDMETHODCALLTYPE *GetLength)(IDvbDataBroadcastDescriptor *This,
                                        /* [out] */ BYTE *pbVal);
  ...
  HRESULT(STDMETHODCALLTYPE *GetComponentTag)(IDvbDataBroadcastDescriptor *This,
                                              /* [out] */ BYTE *pbVal);
  ...
  HRESULT(STDMETHODCALLTYPE *GetLangID)(IDvbDataBroadcastDescriptor *This,
                                        /* [out] */ ULONG *pulVal);

  DECLSPEC_XFGVIRT(IDvbDataBroadcastDescriptor, GetTextLength)
  HRESULT(STDMETHODCALLTYPE *GetTextLength)(IDvbDataBroadcastDescriptor *This,
                                            /* [out] */ BYTE *pbVal);

  DECLSPEC_XFGVIRT(IDvbDataBroadcastDescriptor, GetText)
  HRESULT(STDMETHODCALLTYPE *GetText)(IDvbDataBroadcastDescriptor *This,
                                      /* [out][in] */ BYTE *pbLen,
                                      /* [out] */ BYTE *pbVal);
...
typedef struct IDvbLinkageDescriptorVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(IDvbLinkageDescriptor *This,
                                             /* [in] */ REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);
  ...
  HRESULT(STDMETHODCALLTYPE *GetTag)(IDvbLinkageDescriptor *This,
                                     /* [out] */ BYTE *pbVal);

  DECLSPEC_XFGVIRT(IDvbLinkageDescriptor, GetLength)
  HRESULT(STDMETHODCALLTYPE *GetLength)(IDvbLinkageDescriptor *This,
                                        /* [out] */ BYTE *pbVal);

  DECLSPEC_XFGVIRT(IDvbLinkageDescriptor, GetTSId)
  HRESULT(STDMETHODCALLTYPE *GetTSId)(IDvbLinkageDescriptor *This,
                                      /* [out] */ WORD *pwVal);

  DECLSPEC_XFGVIRT(IDvbLinkageDescriptor, GetONId)
  HRESULT(STDMETHODCALLTYPE *GetONId)(IDvbLinkageDescriptor *This,
                                      /* [out] */ WORD *pwVal);

  DECLSPEC_XFGVIRT(IDvbLinkageDescriptor, GetServiceId)
  HRESULT(STDMETHODCALLTYPE *GetServiceId)(IDvbLinkageDescriptor *This,
                                           /* [out] */ WORD *pwVal);

  DECLSPEC_XFGVIRT(IDvbLinkageDescriptor, GetLinkageType)
  HRESULT(STDMETHODCALLTYPE *GetLinkageType)(IDvbLinkageDescriptor *This,
                                             /* [out] */ BYTE *pbVal);

  DECLSPEC_XFGVIRT(IDvbLinkageDescriptor, GetPrivateDataLength)
  HRESULT(STDMETHODCALLTYPE *GetPrivateDataLength)(IDvbLinkageDescriptor *This,
                                                   /* [out] */ BYTE *pbVal);

  DECLSPEC_XFGVIRT(IDvbLinkageDescriptor, GetPrivateData)
  HRESULT(STDMETHODCALLTYPE *GetPrivateData)(IDvbLinkageDescriptor *This,
                                             /* [out][in] */ BYTE *pbLen,
                                             /* [out] */ BYTE *pbData);
...
typedef struct IDvbTeletextDescriptorVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(IDvbTeletextDescriptor *This,
                                             /* [in] */ REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);
  ...
  HRESULT(STDMETHODCALLTYPE *GetTag)(IDvbTeletextDescriptor *This,
                                     /* [out] */ BYTE *pbVal);

  DECLSPEC_XFGVIRT(IDvbTeletextDescriptor, GetLength)
  HRESULT(STDMETHODCALLTYPE *GetLength)(IDvbTeletextDescriptor *This,
                                        /* [out] */ BYTE *pbVal);

  DECLSPEC_XFGVIRT(IDvbTeletextDescriptor, GetCountOfRecords)
  HRESULT(STDMETHODCALLTYPE *GetCountOfRecords)(IDvbTeletextDescriptor *This,
                                                /* [out] */ BYTE *pbVal);

  DECLSPEC_XFGVIRT(IDvbTeletextDescriptor, GetRecordLangId)
  HRESULT(STDMETHODCALLTYPE *GetRecordLangId)(IDvbTeletextDescriptor *This,
                                              /* [in] */ BYTE bRecordIndex,
                                              /* [out] */ ULONG *pulVal);
  ...
  HRESULT(STDMETHODCALLTYPE *GetRecordPageNumber)(IDvbTeletextDescriptor *This,
                                                  /* [in] */ BYTE bRecordIndex,
                                                  /* [out] */ BYTE *pbVal);
...
typedef struct IDvbSubtitlingDescriptorVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(IDvbSubtitlingDescriptor *This,
                                             /* [in] */ REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);
  ...
  HRESULT(STDMETHODCALLTYPE *GetTag)(IDvbSubtitlingDescriptor *This,
                                     /* [out] */ BYTE *pbVal);

  DECLSPEC_XFGVIRT(IDvbSubtitlingDescriptor, GetLength)
  HRESULT(STDMETHODCALLTYPE *GetLength)(IDvbSubtitlingDescriptor *This,
                                        /* [out] */ BYTE *pbVal);

  DECLSPEC_XFGVIRT(IDvbSubtitlingDescriptor, GetCountOfRecords)
  HRESULT(STDMETHODCALLTYPE *GetCountOfRecords)(IDvbSubtitlingDescriptor *This,
                                                /* [out] */ BYTE *pbVal);

  DECLSPEC_XFGVIRT(IDvbSubtitlingDescriptor, GetRecordLangId)
  HRESULT(STDMETHODCALLTYPE *GetRecordLangId)(IDvbSubtitlingDescriptor *This,
                                              /* [in] */ BYTE bRecordIndex,
                                              /* [out] */ ULONG *pulVal);
...
typedef struct IDvbServiceDescriptorVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(IDvbServiceDescriptor *This,
                                             /* [in] */ REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);
  ...
  HRESULT(STDMETHODCALLTYPE *GetTag)(IDvbServiceDescriptor *This,
                                     /* [out] */ BYTE *pbVal);

  DECLSPEC_XFGVIRT(IDvbServiceDescriptor, GetLength)
  HRESULT(STDMETHODCALLTYPE *GetLength)(IDvbServiceDescriptor *This,
                                        /* [out] */ BYTE *pbVal);

  DECLSPEC_XFGVIRT(IDvbServiceDescriptor, GetServiceType)
  HRESULT(STDMETHODCALLTYPE *GetServiceType)(IDvbServiceDescriptor *This,
                                             /* [out] */ BYTE *pbVal);
  ...
  HRESULT(STDMETHODCALLTYPE *GetServiceName)(IDvbServiceDescriptor *This,
                                             /* [annotation][out] */
                                             _Outptr_ char **pszName);
...
typedef struct IDvbServiceDescriptor2Vtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(IDvbServiceDescriptor2 *This,
                                             /* [in] */ REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);
  ...
  DECLSPEC_XFGVIRT(IDvbServiceDescriptor, GetTag)
  HRESULT(STDMETHODCALLTYPE *GetTag)(IDvbServiceDescriptor2 *This,
                                     /* [out] */ BYTE *pbVal);

  DECLSPEC_XFGVIRT(IDvbServiceDescriptor, GetLength)
  HRESULT(STDMETHODCALLTYPE *GetLength)(IDvbServiceDescriptor2 *This,
                                        /* [out] */ BYTE *pbVal);

  DECLSPEC_XFGVIRT(IDvbServiceDescriptor, GetServiceType)
  HRESULT(STDMETHODCALLTYPE *GetServiceType)(IDvbServiceDescriptor2 *This,
                                             /* [out] */ BYTE *pbVal);
  ...
  DECLSPEC_XFGVIRT(IDvbServiceDescriptor, GetServiceName)
  HRESULT(STDMETHODCALLTYPE *GetServiceName)(IDvbServiceDescriptor2 *This,
                                             /* [annotation][out] */
                                             _Outptr_ char **pszName);
...
typedef struct IDvbServiceListDescriptorVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(IDvbServiceListDescriptor *This,
                                             /* [in] */ REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);
  ...
  HRESULT(STDMETHODCALLTYPE *GetTag)(IDvbServiceListDescriptor *This,
                                     /* [out] */ BYTE *pbVal);

  DECLSPEC_XFGVIRT(IDvbServiceListDescriptor, GetLength)
  HRESULT(STDMETHODCALLTYPE *GetLength)(IDvbServiceListDescriptor *This,
                                        /* [out] */ BYTE *pbVal);

  DECLSPEC_XFGVIRT(IDvbServiceListDescriptor, GetCountOfRecords)
  HRESULT(STDMETHODCALLTYPE *GetCountOfRecords)(IDvbServiceListDescriptor *This,
                                                /* [out] */ BYTE *pbVal);
...
typedef struct IDvbMultilingualServiceNameDescriptorVtbl {
  ...
  DECLSPEC_XFGVIRT(IDvbMultilingualServiceNameDescriptor,
                   GetRecordServiceProviderNameW)
...
#define IDvbMultilingualServiceNameDescriptor_GetRecordServiceNameW(           \
    This, bRecordIndex, convMode, pbstrName)                                   \
  ((This)->lpVtbl->GetRecordServiceNameW(This, bRecordIndex, convMode,         \
                                         pbstrName))
...
typedef struct IDvbNetworkNameDescriptorVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(IDvbNetworkNameDescriptor *This,
                                             /* [in] */ REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);
  ...
  HRESULT(STDMETHODCALLTYPE *GetTag)(IDvbNetworkNameDescriptor *This,
                                     /* [out] */ BYTE *pbVal);

  DECLSPEC_XFGVIRT(IDvbNetworkNameDescriptor, GetLength)
  HRESULT(STDMETHODCALLTYPE *GetLength)(IDvbNetworkNameDescriptor *This,
                                        /* [out] */ BYTE *pbVal);

  DECLSPEC_XFGVIRT(IDvbNetworkNameDescriptor, GetNetworkName)
  HRESULT(STDMETHODCALLTYPE *GetNetworkName)(IDvbNetworkNameDescriptor *This,
                                             /* [annotation][out] */
                                             _Outptr_ char **pszName);
...
typedef struct IDvbShortEventDescriptorVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(IDvbShortEventDescriptor *This,
                                             /* [in] */ REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);
  ...
  HRESULT(STDMETHODCALLTYPE *GetTag)(IDvbShortEventDescriptor *This,
                                     /* [out] */ BYTE *pbVal);

  DECLSPEC_XFGVIRT(IDvbShortEventDescriptor, GetLength)
  HRESULT(STDMETHODCALLTYPE *GetLength)(IDvbShortEventDescriptor *This,
                                        /* [out] */ BYTE *pbVal);

  DECLSPEC_XFGVIRT(IDvbShortEventDescriptor, GetLanguageCode)
  HRESULT(STDMETHODCALLTYPE *GetLanguageCode)(IDvbShortEventDescriptor *This,
                                              /* [annotation][out] */
                                              _Out_writes_(4) char *pszCode);
  ...
  HRESULT(STDMETHODCALLTYPE *GetTextW)(IDvbShortEventDescriptor *This,
                                       /* [in] */ DVB_STRCONV_MODE convMode,
                                       /* [out] */ BSTR *pbstrText);
...
typedef struct IDvbExtendedEventDescriptorVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(IDvbExtendedEventDescriptor *This,
                                             /* [in] */ REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);
  ...
  HRESULT(STDMETHODCALLTYPE *GetTag)(IDvbExtendedEventDescriptor *This,
                                     /* [out] */ BYTE *pbVal);

  DECLSPEC_XFGVIRT(IDvbExtendedEventDescriptor, GetLength)
  HRESULT(STDMETHODCALLTYPE *GetLength)(IDvbExtendedEventDescriptor *This,
                                        /* [out] */ BYTE *pbVal);
  ...
  HRESULT(STDMETHODCALLTYPE *GetLanguageCode)(IDvbExtendedEventDescriptor *This,
                                              /* [annotation][out] */
                                              _Out_writes_(4) char *pszCode);
  ...
  HRESULT(STDMETHODCALLTYPE *GetTextW)(IDvbExtendedEventDescriptor *This,
                                       /* [in] */ DVB_STRCONV_MODE convMode,
                                       /* [out] */ BSTR *pbstrText);
...
typedef struct IDvbComponentDescriptorVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(IDvbComponentDescriptor *This,
                                             /* [in] */ REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);
  ...
  HRESULT(STDMETHODCALLTYPE *GetTag)(IDvbComponentDescriptor *This,
                                     /* [out] */ BYTE *pbVal);

  DECLSPEC_XFGVIRT(IDvbComponentDescriptor, GetLength)
  HRESULT(STDMETHODCALLTYPE *GetLength)(IDvbComponentDescriptor *This,
                                        /* [out] */ BYTE *pbVal);

  DECLSPEC_XFGVIRT(IDvbComponentDescriptor, GetStreamContent)
  HRESULT(STDMETHODCALLTYPE *GetStreamContent)(IDvbComponentDescriptor *This,
                                               /* [out] */ BYTE *pbVal);

  DECLSPEC_XFGVIRT(IDvbComponentDescriptor, GetComponentType)
  HRESULT(STDMETHODCALLTYPE *GetComponentType)(IDvbComponentDescriptor *This,
                                               /* [out] */ BYTE *pbVal);

  DECLSPEC_XFGVIRT(IDvbComponentDescriptor, GetComponentTag)
  HRESULT(STDMETHODCALLTYPE *GetComponentTag)(IDvbComponentDescriptor *This,
                                              /* [out] */ BYTE *pbVal);

  DECLSPEC_XFGVIRT(IDvbComponentDescriptor, GetLanguageCode)
  HRESULT(STDMETHODCALLTYPE *GetLanguageCode)(IDvbComponentDescriptor *This,
                                              /* [annotation][out] */
                                              _Out_writes_(4) char *pszCode);

  DECLSPEC_XFGVIRT(IDvbComponentDescriptor, GetTextW)
  HRESULT(STDMETHODCALLTYPE *GetTextW)(IDvbComponentDescriptor *This,
                                       /* [in] */ DVB_STRCONV_MODE convMode,
                                       /* [out] */ BSTR *pbstrText);
...
typedef struct IDvbContentDescriptorVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(IDvbContentDescriptor *This,
                                             /* [in] */ REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);
  ...
  HRESULT(STDMETHODCALLTYPE *GetTag)(IDvbContentDescriptor *This,
                                     /* [out] */ BYTE *pbVal);

  DECLSPEC_XFGVIRT(IDvbContentDescriptor, GetLength)
  HRESULT(STDMETHODCALLTYPE *GetLength)(IDvbContentDescriptor *This,
                                        /* [out] */ BYTE *pbVal);

  DECLSPEC_XFGVIRT(IDvbContentDescriptor, GetCountOfRecords)
  HRESULT(STDMETHODCALLTYPE *GetCountOfRecords)(IDvbContentDescriptor *This,
                                                /* [out] */ BYTE *pbVal);
  ...
  HRESULT(STDMETHODCALLTYPE *GetRecordUserNibbles)(IDvbContentDescriptor *This,
                                                   /* [in] */ BYTE bRecordIndex,
                                                   /* [out] */ BYTE *pbVal1,
                                                   /* [out] */ BYTE *pbVal2);
...
typedef struct IDvbParentalRatingDescriptorVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(IDvbParentalRatingDescriptor *This,
                                             /* [in] */ REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);
  ...
  HRESULT(STDMETHODCALLTYPE *GetTag)(IDvbParentalRatingDescriptor *This,
                                     /* [out] */ BYTE *pbVal);

  DECLSPEC_XFGVIRT(IDvbParentalRatingDescriptor, GetLength)
  HRESULT(STDMETHODCALLTYPE *GetLength)(IDvbParentalRatingDescriptor *This,
                                        /* [out] */ BYTE *pbVal);
...
typedef struct IIsdbTerrestrialDeliverySystemDescriptorVtbl {
  ...
  DECLSPEC_XFGVIRT(IIsdbTerrestrialDeliverySystemDescriptor,
                   GetTransmissionMode)
  HRESULT(STDMETHODCALLTYPE *GetTransmissionMode)(
      IIsdbTerrestrialDeliverySystemDescriptor *This,
      /* [out] */ BYTE *pbVal);
...
#define IIsdbTerrestrialDeliverySystemDescriptor_QueryInterface(This, riid,    \
                                                                ppvObject)     \
  ((This)->lpVtbl->QueryInterface(This, riid, ppvObject))
...
#define IIsdbTerrestrialDeliverySystemDescriptor_GetTransmissionMode(This,     \
                                                                     pbVal)    \
  ((This)->lpVtbl->GetTransmissionMode(This, pbVal))

#define IIsdbTerrestrialDeliverySystemDescriptor_GetCountOfRecords(This,       \
                                                                   pbVal)      \
  ((This)->lpVtbl->GetCountOfRecords(This, pbVal))
...
typedef struct IIsdbTSInformationDescriptorVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(IIsdbTSInformationDescriptor *This,
                                             /* [in] */ REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);
  ...
  HRESULT(STDMETHODCALLTYPE *GetTag)(IIsdbTSInformationDescriptor *This,
                                     /* [out] */ BYTE *pbVal);

  DECLSPEC_XFGVIRT(IIsdbTSInformationDescriptor, GetLength)
  HRESULT(STDMETHODCALLTYPE *GetLength)(IIsdbTSInformationDescriptor *This,
                                        /* [out] */ BYTE *pbVal);
  ...
  HRESULT(STDMETHODCALLTYPE *GetTSNameW)(IIsdbTSInformationDescriptor *This,
                                         /* [in] */ DVB_STRCONV_MODE convMode,
                                         /* [out] */ BSTR *pbstrName);
...
#define IIsdbTSInformationDescriptor_GetRecordTransmissionTypeInfo(            \
    This, bRecordIndex, pbVal)                                                 \
  ((This)->lpVtbl->GetRecordTransmissionTypeInfo(This, bRecordIndex, pbVal))

#define IIsdbTSInformationDescriptor_GetRecordNumberOfServices(                \
    This, bRecordIndex, pbVal)                                                 \
  ((This)->lpVtbl->GetRecordNumberOfServices(This, bRecordIndex, pbVal))

#define IIsdbTSInformationDescriptor_GetRecordServiceIdByIndex(                \
    This, bRecordIndex, bServiceIndex, pdwVal)                                 \
  ((This)->lpVtbl->GetRecordServiceIdByIndex(This, bRecordIndex,               \
                                             bServiceIndex, pdwVal))
...
typedef struct IIsdbDigitalCopyControlDescriptorVtbl {
  ...
  HRESULT(STDMETHODCALLTYPE *GetTag)(IIsdbDigitalCopyControlDescriptor *This,
                                     /* [out] */ BYTE *pbVal);

  DECLSPEC_XFGVIRT(IIsdbDigitalCopyControlDescriptor, GetLength)
  HRESULT(STDMETHODCALLTYPE *GetLength)(IIsdbDigitalCopyControlDescriptor *This,
                                        /* [out] */ BYTE *pbVal);
...
#define IIsdbDigitalCopyControlDescriptor_QueryInterface(This, riid,           \
                                                         ppvObject)            \
  ((This)->lpVtbl->QueryInterface(This, riid, ppvObject))
...
#define IIsdbDigitalCopyControlDescriptor_GetCopyControl(                      \
    This, pbDigitalRecordingControlData, pbCopyControlType, pbAPSControlData,  \
    pbMaximumBitrate)                                                          \
  ((This)->lpVtbl->GetCopyControl(This, pbDigitalRecordingControlData,         \
                                  pbCopyControlType, pbAPSControlData,         \
                                  pbMaximumBitrate))
...
#define IIsdbDigitalCopyControlDescriptor_GetRecordCopyControl(                \
    This, bRecordIndex, pbComponentTag, pbDigitalRecordingControlData,         \
    pbCopyControlType, pbAPSControlData, pbMaximumBitrate)                     \
  ((This)->lpVtbl->GetRecordCopyControl(                                       \
      This, bRecordIndex, pbComponentTag, pbDigitalRecordingControlData,       \
      pbCopyControlType, pbAPSControlData, pbMaximumBitrate))
...
typedef struct IIsdbAudioComponentDescriptorVtbl {
  ...
  HRESULT(STDMETHODCALLTYPE *GetTag)(IIsdbAudioComponentDescriptor *This,
                                     /* [out] */ BYTE *pbVal);

  DECLSPEC_XFGVIRT(IIsdbAudioComponentDescriptor, GetLength)
  HRESULT(STDMETHODCALLTYPE *GetLength)(IIsdbAudioComponentDescriptor *This,
                                        /* [out] */ BYTE *pbVal);
  ...
  HRESULT(STDMETHODCALLTYPE *GetStreamType)(IIsdbAudioComponentDescriptor *This,
                                            /* [out] */ BYTE *pbVal);
  ...
  HRESULT(STDMETHODCALLTYPE *GetTextW)(IIsdbAudioComponentDescriptor *This,
                                       /* [in] */ DVB_STRCONV_MODE convMode,
                                       /* [out] */ BSTR *pbstrText);
...
typedef struct IIsdbDataContentDescriptorVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(IIsdbDataContentDescriptor *This,
                                             /* [in] */ REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);
  ...
  HRESULT(STDMETHODCALLTYPE *GetTag)(IIsdbDataContentDescriptor *This,
                                     /* [out] */ BYTE *pbVal);

  DECLSPEC_XFGVIRT(IIsdbDataContentDescriptor, GetLength)
  HRESULT(STDMETHODCALLTYPE *GetLength)(IIsdbDataContentDescriptor *This,
                                        /* [out] */ BYTE *pbVal);
  ...
  HRESULT(STDMETHODCALLTYPE *GetSelectorBytes)(IIsdbDataContentDescriptor *This,
                                               /* [in] */ BYTE bBufLength,
                                               /* [out] */ BYTE *pbBuf);
  ...
  HRESULT(STDMETHODCALLTYPE *GetLanguageCode)(IIsdbDataContentDescriptor *This,
                                              /* [annotation][out] */
                                              _Out_writes_(4) char *pszCode);

  DECLSPEC_XFGVIRT(IIsdbDataContentDescriptor, GetTextW)
  HRESULT(STDMETHODCALLTYPE *GetTextW)(IIsdbDataContentDescriptor *This,
                                       /* [in] */ DVB_STRCONV_MODE convMode,
                                       /* [out] */ BSTR *pbstrText);
...
#define IIsdbDataContentDescriptor_GetRecordComponentRef(This, bRecordIndex,   \
                                                         pbVal)                \
...
typedef struct IIsdbCAContractInformationDescriptorVtbl {
  ...
  HRESULT(STDMETHODCALLTYPE *GetTag)(IIsdbCAContractInformationDescriptor *This,
                                     /* [out] */ BYTE *pbVal);
  ...
  DECLSPEC_XFGVIRT(IIsdbCAContractInformationDescriptor,
...
#define IIsdbCAContractInformationDescriptor_QueryInterface(This, riid,        \
                                                            ppvObject)         \
  ((This)->lpVtbl->QueryInterface(This, riid, ppvObject))
...
#define IIsdbCAContractInformationDescriptor_GetContractVerificationInfoLength( \
    This, pbVal)                                                                \
...
#define IIsdbCAContractInformationDescriptor_GetFeeNameW(This, convMode,       \
                                                         pbstrName)            \
...
typedef struct IIsdbEventGroupDescriptorVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(IIsdbEventGroupDescriptor *This,
                                             /* [in] */ REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);
  ...
  HRESULT(STDMETHODCALLTYPE *GetTag)(IIsdbEventGroupDescriptor *This,
                                     /* [out] */ BYTE *pbVal);

  DECLSPEC_XFGVIRT(IIsdbEventGroupDescriptor, GetLength)
  HRESULT(STDMETHODCALLTYPE *GetLength)(IIsdbEventGroupDescriptor *This,
                                        /* [out] */ BYTE *pbVal);

  DECLSPEC_XFGVIRT(IIsdbEventGroupDescriptor, GetGroupType)
  HRESULT(STDMETHODCALLTYPE *GetGroupType)(IIsdbEventGroupDescriptor *This,
                                           /* [out] */ BYTE *pbVal);

  DECLSPEC_XFGVIRT(IIsdbEventGroupDescriptor, GetCountOfRecords)
  HRESULT(STDMETHODCALLTYPE *GetCountOfRecords)(IIsdbEventGroupDescriptor *This,
                                                /* [out] */ BYTE *pbVal);

  DECLSPEC_XFGVIRT(IIsdbEventGroupDescriptor, GetRecordEvent)
  HRESULT(STDMETHODCALLTYPE *GetRecordEvent)(IIsdbEventGroupDescriptor *This,
                                             /* [in] */ BYTE bRecordIndex,
                                             /* [out] */ WORD *pwServiceId,
                                             /* [out] */ WORD *pwEventId);
...
#define IIsdbEventGroupDescriptor_GetRecordEvent(This, bRecordIndex,           \
                                                 pwServiceId, pwEventId)       \
...
#define IIsdbEventGroupDescriptor_GetRefRecordEvent(                           \
    This, bRecordIndex, pwOriginalNetworkId, pwTransportStreamId, pwServiceId, \
    pwEventId)                                                                 \
  ((This)->lpVtbl->GetRefRecordEvent(This, bRecordIndex, pwOriginalNetworkId,  \
                                     pwTransportStreamId, pwServiceId,         \
                                     pwEventId))
...
typedef struct IIsdbComponentGroupDescriptorVtbl {
  ...
  HRESULT(STDMETHODCALLTYPE *GetTag)(IIsdbComponentGroupDescriptor *This,
                                     /* [out] */ BYTE *pbVal);

  DECLSPEC_XFGVIRT(IIsdbComponentGroupDescriptor, GetLength)
  HRESULT(STDMETHODCALLTYPE *GetLength)(IIsdbComponentGroupDescriptor *This,
                                        /* [out] */ BYTE *pbVal);
  ...
  DECLSPEC_XFGVIRT(IIsdbComponentGroupDescriptor,
...
#define IIsdbComponentGroupDescriptor_GetRecordGroupId(This, bRecordIndex,     \
                                                       pbVal)                  \
  ((This)->lpVtbl->GetRecordGroupId(This, bRecordIndex, pbVal))

#define IIsdbComponentGroupDescriptor_GetRecordNumberOfCAUnit(                 \
    This, bRecordIndex, pbVal)                                                 \
  ((This)->lpVtbl->GetRecordNumberOfCAUnit(This, bRecordIndex, pbVal))

#define IIsdbComponentGroupDescriptor_GetRecordCAUnitCAUnitId(                 \
    This, bRecordIndex, bCAUnitIndex, pbVal)                                   \
  ((This)->lpVtbl->GetRecordCAUnitCAUnitId(This, bRecordIndex, bCAUnitIndex,   \
                                           pbVal))

#define IIsdbComponentGroupDescriptor_GetRecordCAUnitNumberOfComponents(       \
    This, bRecordIndex, bCAUnitIndex, pbVal)                                   \
  ((This)->lpVtbl->GetRecordCAUnitNumberOfComponents(This, bRecordIndex,       \
                                                     bCAUnitIndex, pbVal))

#define IIsdbComponentGroupDescriptor_GetRecordCAUnitComponentTag(             \
    This, bRecordIndex, bCAUnitIndex, bComponentIndex, pbVal)                  \
  ((This)->lpVtbl->GetRecordCAUnitComponentTag(                                \
      This, bRecordIndex, bCAUnitIndex, bComponentIndex, pbVal))

#define IIsdbComponentGroupDescriptor_GetRecordTotalBitRate(                   \
    This, bRecordIndex, pbVal)                                                 \
  ((This)->lpVtbl->GetRecordTotalBitRate(This, bRecordIndex, pbVal))

#define IIsdbComponentGroupDescriptor_GetRecordTextW(This, bRecordIndex,       \
                                                     convMode, pbstrText)      \
...
typedef struct IIsdbSeriesDescriptorVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(IIsdbSeriesDescriptor *This,
                                             /* [in] */ REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);
  ...
  HRESULT(STDMETHODCALLTYPE *GetTag)(IIsdbSeriesDescriptor *This,
                                     /* [out] */ BYTE *pbVal);

  DECLSPEC_XFGVIRT(IIsdbSeriesDescriptor, GetLength)
  HRESULT(STDMETHODCALLTYPE *GetLength)(IIsdbSeriesDescriptor *This,
                                        /* [out] */ BYTE *pbVal);

  DECLSPEC_XFGVIRT(IIsdbSeriesDescriptor, GetSeriesId)
  HRESULT(STDMETHODCALLTYPE *GetSeriesId)(IIsdbSeriesDescriptor *This,
                                          /* [out] */ WORD *pwVal);

  DECLSPEC_XFGVIRT(IIsdbSeriesDescriptor, GetRepeatLabel)
  HRESULT(STDMETHODCALLTYPE *GetRepeatLabel)(IIsdbSeriesDescriptor *This,
                                             /* [out] */ BYTE *pbVal);

  DECLSPEC_XFGVIRT(IIsdbSeriesDescriptor, GetProgramPattern)
  HRESULT(STDMETHODCALLTYPE *GetProgramPattern)(IIsdbSeriesDescriptor *This,
                                                /* [out] */ BYTE *pbVal);
  ...
  HRESULT(STDMETHODCALLTYPE *GetEpisodeNumber)(IIsdbSeriesDescriptor *This,
                                               /* [out] */ WORD *pwVal);

  DECLSPEC_XFGVIRT(IIsdbSeriesDescriptor, GetLastEpisodeNumber)
  HRESULT(STDMETHODCALLTYPE *GetLastEpisodeNumber)(IIsdbSeriesDescriptor *This,
                                                   /* [out] */ WORD *pwVal);
...
typedef struct IIsdbDownloadContentDescriptorVtbl {
  ...
  HRESULT(STDMETHODCALLTYPE *GetTag)(IIsdbDownloadContentDescriptor *This,
                                     /* [out] */ BYTE *pbVal);

  DECLSPEC_XFGVIRT(IIsdbDownloadContentDescriptor, GetLength)
  HRESULT(STDMETHODCALLTYPE *GetLength)(IIsdbDownloadContentDescriptor *This,
                                        /* [out] */ BYTE *pbVal);

  DECLSPEC_XFGVIRT(IIsdbDownloadContentDescriptor, GetFlags)
  HRESULT(STDMETHODCALLTYPE *GetFlags)(IIsdbDownloadContentDescriptor *This,
                                       /* [out] */ BOOL *pfReboot,
                                       /* [out] */ BOOL *pfAddOn,
                                       /* [out] */ BOOL *pfCompatibility,
                                       /* [out] */ BOOL *pfModuleInfo,
  ...
  HRESULT(STDMETHODCALLTYPE *GetLeakRate)(IIsdbDownloadContentDescriptor *This,
                                          /* [out] */ DWORD *pdwVal);
  ...
  DECLSPEC_XFGVIRT(IIsdbDownloadContentDescriptor,
  ...
  HRESULT(STDMETHODCALLTYPE *GetTextW)(IIsdbDownloadContentDescriptor *This,
                                       /* [in] */ DVB_STRCONV_MODE convMode,
                                       /* [out] */ BSTR *pbstrName);
...
#define IIsdbDownloadContentDescriptor_GetFlags(                               \
    This, pfReboot, pfAddOn, pfCompatibility, pfModuleInfo, pfTextInfo)        \
  ((This)->lpVtbl->GetFlags(This, pfReboot, pfAddOn, pfCompatibility,          \
                            pfModuleInfo, pfTextInfo))
...
#define IIsdbDownloadContentDescriptor_GetCompatiblityDescriptor(This,         \
                                                                 ppbData)      \
...
#define IIsdbDownloadContentDescriptor_GetRecordModuleId(This, wRecordIndex,   \
                                                         pwVal)                \
  ((This)->lpVtbl->GetRecordModuleId(This, wRecordIndex, pwVal))

#define IIsdbDownloadContentDescriptor_GetRecordModuleSize(This, wRecordIndex, \
                                                           pdwVal)             \
  ((This)->lpVtbl->GetRecordModuleSize(This, wRecordIndex, pdwVal))

#define IIsdbDownloadContentDescriptor_GetRecordModuleInfoLength(              \
    This, wRecordIndex, pbVal)                                                 \
  ((This)->lpVtbl->GetRecordModuleInfoLength(This, wRecordIndex, pbVal))

#define IIsdbDownloadContentDescriptor_GetRecordModuleInfo(This, wRecordIndex, \
                                                           ppbData)            \
...
typedef struct IIsdbLogoTransmissionDescriptorVtbl {
  ...
  HRESULT(STDMETHODCALLTYPE *GetTag)(IIsdbLogoTransmissionDescriptor *This,
                                     /* [out] */ BYTE *pbVal);

  DECLSPEC_XFGVIRT(IIsdbLogoTransmissionDescriptor, GetLength)
  HRESULT(STDMETHODCALLTYPE *GetLength)(IIsdbLogoTransmissionDescriptor *This,
                                        /* [out] */ BYTE *pbVal);
  ...
  HRESULT(STDMETHODCALLTYPE *GetLogoId)(IIsdbLogoTransmissionDescriptor *This,
                                        /* [out] */ WORD *pwVal);
...
#define IIsdbLogoTransmissionDescriptor_GetLogoCharW(This, convMode,           \
                                                     pbstrChar)                \
...
typedef struct IIsdbSIParameterDescriptorVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(IIsdbSIParameterDescriptor *This,
                                             /* [in] */ REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);
  ...
  HRESULT(STDMETHODCALLTYPE *GetTag)(IIsdbSIParameterDescriptor *This,
                                     /* [out] */ BYTE *pbVal);

  DECLSPEC_XFGVIRT(IIsdbSIParameterDescriptor, GetLength)
  HRESULT(STDMETHODCALLTYPE *GetLength)(IIsdbSIParameterDescriptor *This,
                                        /* [out] */ BYTE *pbVal);
  ...
  HRESULT(STDMETHODCALLTYPE *GetUpdateTime)(IIsdbSIParameterDescriptor *This,
                                            /* [out] */ MPEG_DATE *pVal);
  ...
  HRESULT(STDMETHODCALLTYPE *GetTableId)(IIsdbSIParameterDescriptor *This,
                                         /* [in] */ BYTE bRecordIndex,
                                         /* [out] */ BYTE *pbVal);
...
#define IIsdbSIParameterDescriptor_GetTableDescriptionLength(                  \
    This, bRecordIndex, pbVal)                                                 \
  ((This)->lpVtbl->GetTableDescriptionLength(This, bRecordIndex, pbVal))

#define IIsdbSIParameterDescriptor_GetTableDescriptionBytes(                   \
    This, bRecordIndex, pbBufferLength, pbBuffer)                              \
  ((This)->lpVtbl->GetTableDescriptionBytes(This, bRecordIndex,                \
                                            pbBufferLength, pbBuffer))
...
typedef struct IIsdbEmergencyInformationDescriptorVtbl {
  ...
  HRESULT(STDMETHODCALLTYPE *GetTag)(IIsdbEmergencyInformationDescriptor *This,
                                     /* [out] */ BYTE *pbVal);
...
#define IIsdbEmergencyInformationDescriptor_QueryInterface(This, riid,         \
                                                           ppvObject)          \
  ((This)->lpVtbl->QueryInterface(This, riid, ppvObject))
...
#define IIsdbEmergencyInformationDescriptor_GetServiceId(This, bRecordIndex,   \
                                                         pwVal)                \
  ((This)->lpVtbl->GetServiceId(This, bRecordIndex, pwVal))

#define IIsdbEmergencyInformationDescriptor_GetStartEndFlag(                   \
    This, bRecordIndex, pVal)                                                  \
  ((This)->lpVtbl->GetStartEndFlag(This, bRecordIndex, pVal))

#define IIsdbEmergencyInformationDescriptor_GetSignalLevel(This, bRecordIndex, \
                                                           pbVal)              \
  ((This)->lpVtbl->GetSignalLevel(This, bRecordIndex, pbVal))

#define IIsdbEmergencyInformationDescriptor_GetAreaCode(                       \
    This, bRecordIndex, ppwVal, pbNumAreaCodes)                                \
...
typedef struct IIsdbCADescriptorVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(IIsdbCADescriptor *This,
                                             /* [in] */ REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);
  ...
  HRESULT(STDMETHODCALLTYPE *GetTag)(IIsdbCADescriptor *This,
                                     /* [out] */ BYTE *pbVal);

  DECLSPEC_XFGVIRT(IIsdbCADescriptor, GetLength)
  HRESULT(STDMETHODCALLTYPE *GetLength)(IIsdbCADescriptor *This,
                                        /* [out] */ BYTE *pbVal);

  DECLSPEC_XFGVIRT(IIsdbCADescriptor, GetCASystemId)
  HRESULT(STDMETHODCALLTYPE *GetCASystemId)(IIsdbCADescriptor *This,
                                            /* [out] */ WORD *pwVal);

  DECLSPEC_XFGVIRT(IIsdbCADescriptor, GetReservedBits)
  HRESULT(STDMETHODCALLTYPE *GetReservedBits)(IIsdbCADescriptor *This,
                                              /* [out] */ BYTE *pbVal);

  DECLSPEC_XFGVIRT(IIsdbCADescriptor, GetCAPID)
  HRESULT(STDMETHODCALLTYPE *GetCAPID)(IIsdbCADescriptor *This,
                                       /* [out] */ WORD *pwVal);
...
typedef struct IIsdbCAServiceDescriptorVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(IIsdbCAServiceDescriptor *This,
                                             /* [in] */ REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);
  ...
  HRESULT(STDMETHODCALLTYPE *GetTag)(IIsdbCAServiceDescriptor *This,
                                     /* [out] */ BYTE *pbVal);

  DECLSPEC_XFGVIRT(IIsdbCAServiceDescriptor, GetLength)
  HRESULT(STDMETHODCALLTYPE *GetLength)(IIsdbCAServiceDescriptor *This,
                                        /* [out] */ BYTE *pbVal);

  DECLSPEC_XFGVIRT(IIsdbCAServiceDescriptor, GetCASystemId)
  HRESULT(STDMETHODCALLTYPE *GetCASystemId)(IIsdbCAServiceDescriptor *This,
                                            /* [out] */ WORD *pwVal);
  ...
  HRESULT(STDMETHODCALLTYPE *GetMessageControl)(IIsdbCAServiceDescriptor *This,
                                                /* [out] */ BYTE *pbVal);
...
#define IIsdbCAServiceDescriptor_GetServiceIds(This, pbNumServiceIds,          \
                                               pwServiceIds)                   \
...
#define IIsdbHierarchicalTransmissionDescriptor_QueryInterface(This, riid,     \
                                                               ppvObject)      \
  ((This)->lpVtbl->QueryInterface(This, riid, ppvObject))
...
typedef struct IPBDASiParserVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(IPBDASiParser *This,
                                             /* [in] */ REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);
  ...
  HRESULT(STDMETHODCALLTYPE *Initialize)(IPBDASiParser *This,
                                         /* [in] */ IUnknown *punk);

  DECLSPEC_XFGVIRT(IPBDASiParser, GetEIT)
  HRESULT(STDMETHODCALLTYPE *GetEIT)(IPBDASiParser *This,
                                     /* [in] */ DWORD dwSize,
                                     /* [in] */ BYTE *pBuffer,
                                     /* [out] */ IPBDA_EIT **ppEIT);
...
interface IPBDASiParser { CONST_VTBL struct IPBDASiParserVtbl *lpVtbl; };
...
typedef struct IPBDA_EITVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(IPBDA_EIT *This,
                                             /* [in] */ REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);
  ...
  HRESULT(STDMETHODCALLTYPE *GetTableId)(IPBDA_EIT *This,
                                         /* [out] */ BYTE *pbVal);

  DECLSPEC_XFGVIRT(IPBDA_EIT, GetVersionNumber)
  HRESULT(STDMETHODCALLTYPE *GetVersionNumber)(IPBDA_EIT *This,
                                               /* [out] */ WORD *pwVal);

  DECLSPEC_XFGVIRT(IPBDA_EIT, GetServiceIdx)
  HRESULT(STDMETHODCALLTYPE *GetServiceIdx)(IPBDA_EIT *This,
                                            /* [out] */ ULONG64 *plwVal);

  DECLSPEC_XFGVIRT(IPBDA_EIT, GetCountOfRecords)
  HRESULT(STDMETHODCALLTYPE *GetCountOfRecords)(IPBDA_EIT *This,
                                                /* [out] */ DWORD *pdwVal);

  DECLSPEC_XFGVIRT(IPBDA_EIT, GetRecordEventId)
  HRESULT(STDMETHODCALLTYPE *GetRecordEventId)(IPBDA_EIT *This,
                                               /* [in] */ DWORD dwRecordIndex,
                                               /* [out] */ ULONG64 *plwVal);
...
interface IPBDA_EIT { CONST_VTBL struct IPBDA_EITVtbl *lpVtbl; };
...
#define IPBDA_EIT_GetRecordDescriptorByIndex(This, dwRecordIndex, dwIndex,     \
                                             ppDescriptor)                     \
  ((This)->lpVtbl->GetRecordDescriptorByIndex(This, dwRecordIndex, dwIndex,    \
                                              ppDescriptor))

#define IPBDA_EIT_GetRecordDescriptorByTag(This, dwRecordIndex, bTag,          \
                                           pdwCookie, ppDescriptor)            \
  ((This)->lpVtbl->GetRecordDescriptorByTag(This, dwRecordIndex, bTag,         \
                                            pdwCookie, ppDescriptor))
...
typedef struct IPBDA_ServicesVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(IPBDA_Services *This,
                                             /* [in] */ REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);
  ...
  HRESULT(STDMETHODCALLTYPE *Initialize)(IPBDA_Services *This,
                                         /* [in] */ DWORD size,
                                         /* [size_is][in] */ BYTE *pBuffer);

  DECLSPEC_XFGVIRT(IPBDA_Services, GetCountOfRecords)
  HRESULT(STDMETHODCALLTYPE *GetCountOfRecords)(IPBDA_Services *This,
                                                /* [out] */ DWORD *pdwVal);
...
interface IPBDA_Services { CONST_VTBL struct IPBDA_ServicesVtbl *lpVtbl; };
...
typedef struct IPBDAEntitlementDescriptorVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(IPBDAEntitlementDescriptor *This,
                                             /* [in] */ REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(IPBDAEntitlementDescriptor *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(IPBDAEntitlementDescriptor *This);

  DECLSPEC_XFGVIRT(IPBDAEntitlementDescriptor, GetTag)
  HRESULT(STDMETHODCALLTYPE *GetTag)(IPBDAEntitlementDescriptor *This,
                                     /* [out] */ BYTE *pbVal);

  DECLSPEC_XFGVIRT(IPBDAEntitlementDescriptor, GetLength)
  HRESULT(STDMETHODCALLTYPE *GetLength)(IPBDAEntitlementDescriptor *This,
                                        /* [out] */ WORD *pwVal);

  DECLSPEC_XFGVIRT(IPBDAEntitlementDescriptor, GetToken)
  HRESULT(STDMETHODCALLTYPE *GetToken)(IPBDAEntitlementDescriptor *This,
                                       /* [out] */ BYTE **ppbTokenBuffer,
...
#define IPBDAEntitlementDescriptor_GetToken(This, ppbTokenBuffer,              \
                                            pdwTokenLength)                    \
...
typedef struct IPBDAAttributesDescriptorVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(IPBDAAttributesDescriptor *This,
                                             /* [in] */ REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);
  ...
  HRESULT(STDMETHODCALLTYPE *GetTag)(IPBDAAttributesDescriptor *This,
                                     /* [out] */ BYTE *pbVal);

  DECLSPEC_XFGVIRT(IPBDAAttributesDescriptor, GetLength)
  HRESULT(STDMETHODCALLTYPE *GetLength)(IPBDAAttributesDescriptor *This,
                                        /* [out] */ WORD *pwVal);
...
#define IPBDAAttributesDescriptor_GetAttributePayload(                         \
    This, ppbAttributeBuffer, pdwAttributeLength)                              \
  ((This)->lpVtbl->GetAttributePayload(This, ppbAttributeBuffer,               \
                                       pdwAttributeLength))
