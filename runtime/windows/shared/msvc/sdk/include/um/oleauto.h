...
WINOLEAUTAPI_(INT)
SysReAllocString(_Inout_ _At_(*pbstr, _Pre_z_ _Post_z_ _Post_readable_size_(
                                          _String_length_(psz) + 1))
                     BSTR *pbstr,
                 _In_opt_z_ const OLECHAR *psz);
WINOLEAUTAPI_(_Ret_writes_maybenull_z_(ui + 1) BSTR)
SysAllocStringLen(_In_reads_opt_(ui) const OLECHAR *strIn, UINT ui);
_Check_return_ WINOLEAUTAPI_(INT) SysReAllocStringLen(
    _Inout_ _At_(*pbstr, _Pre_z_ _Post_z_ _Post_readable_size_(len + 1))
        BSTR *pbstr,
    _In_opt_z_ const OLECHAR *psz, _In_ unsigned int len);
...
WINOLEAUTAPI_(_Post_equal_to_(_String_length_(bstr) * sizeof(OLECHAR)) UINT)
SysStringByteLen(_In_opt_ BSTR bstr);
...
WINOLEAUTAPI_(INT)
DosDateTimeToVariantTime(_In_ USHORT wDosDate, _In_ USHORT wDosTime,
                         _Out_ DOUBLE *pvtime);

WINOLEAUTAPI_(INT)
VariantTimeToDosDateTime(_In_ DOUBLE vtime, _Out_ USHORT *pwDosDate,
                         _Out_ USHORT *pwDosTime);
...
WINOLEAUTAPI_(INT)
SystemTimeToVariantTime(_In_ LPSYSTEMTIME lpSystemTime, _Out_ DOUBLE *pvtime);
WINOLEAUTAPI_(INT)
VariantTimeToSystemTime(_In_ DOUBLE vtime, _Out_ LPSYSTEMTIME lpSystemTime);
...
WINOLEAUTAPI SafeArrayAllocDescriptor(_In_ UINT cDims,
                                      _Outptr_ SAFEARRAY **ppsaOut);
WINOLEAUTAPI SafeArrayAllocDescriptorEx(_In_ VARTYPE vt, _In_ UINT cDims,
                                        _Outptr_ SAFEARRAY **ppsaOut);
WINOLEAUTAPI SafeArrayAllocData(_In_ SAFEARRAY *psa);
WINOLEAUTAPI_(SAFEARRAY *)
SafeArrayCreate(_In_ VARTYPE vt, _In_ UINT cDims,
                _In_ SAFEARRAYBOUND *rgsabound);
WINOLEAUTAPI_(SAFEARRAY *)
SafeArrayCreateEx(_In_ VARTYPE vt, _In_ UINT cDims,
                  _In_ SAFEARRAYBOUND *rgsabound, _In_ PVOID pvExtra);
_Check_return_ WINOLEAUTAPI SafeArrayCopyData(_In_ SAFEARRAY *psaSource,
                                              _In_ SAFEARRAY *psaTarget);
...
WINOLEAUTAPI SafeArrayRedim(_Inout_ SAFEARRAY *psa,
...
WINOLEAUTAPI SafeArrayGetUBound(_In_ SAFEARRAY *psa, _In_ UINT nDim,
                                _Out_ LONG *plUbound);
WINOLEAUTAPI SafeArrayGetLBound(_In_ SAFEARRAY *psa, _In_ UINT nDim,
                                _Out_ LONG *plLbound);
WINOLEAUTAPI SafeArrayLock(_In_ SAFEARRAY *psa);
WINOLEAUTAPI SafeArrayUnlock(_In_ SAFEARRAY *psa);
WINOLEAUTAPI SafeArrayAccessData(
    _In_ SAFEARRAY *psa,
    _Outptr_result_buffer_(_Inexpressible_(psa->cbElements *product(
        psa->rgsabound[0..psa->cDims - 1]->cElements))) void HUGEP **ppvData);
WINOLEAUTAPI SafeArrayUnaccessData(_In_ SAFEARRAY *psa);
WINOLEAUTAPI SafeArrayGetElement(_In_ SAFEARRAY *psa,
                                 _In_reads_(_Inexpressible_(psa->cDims))
                                     LONG *rgIndices,
                                 _Out_ void *pv);
_Check_return_ WINOLEAUTAPI SafeArrayPutElement(
    _In_ SAFEARRAY *psa,
    _In_reads_(_Inexpressible_(psa->cDims)) LONG *rgIndices, _In_ void *pv);
_Check_return_ WINOLEAUTAPI SafeArrayCopy(_In_ SAFEARRAY *psa,
                                          _Outptr_ SAFEARRAY **ppsaOut);
WINOLEAUTAPI
SafeArrayPtrOfIndex(_In_ SAFEARRAY *psa, _In_reads_(psa->cDims) LONG *rgIndices,
                    _Outptr_result_bytebuffer_(psa->cbElements) void **ppvData);
WINOLEAUTAPI SafeArraySetRecordInfo(_In_ SAFEARRAY *psa,
                                    _In_ IRecordInfo *prinfo);
WINOLEAUTAPI SafeArrayGetRecordInfo(_In_ SAFEARRAY *psa,
                                    _Outptr_ IRecordInfo **prinfo);
...
WINOLEAUTAPI_(SAFEARRAY *)
SafeArrayCreateVectorEx(_In_ VARTYPE vt, _In_ LONG lLbound,
                        _In_ ULONG cElements, _In_ PVOID pvExtra);
...
_Check_return_ WINOLEAUTAPI VariantCopy(_Inout_ VARIANTARG *pvargDest,
                                        _In_ const VARIANTARG *pvargSrc);
_Check_return_ WINOLEAUTAPI VariantCopyInd(_Inout_ VARIANT *pvarDest,
                                           _In_ const VARIANTARG *pvargSrc);
_Check_return_ WINOLEAUTAPI VariantChangeType(_Inout_ VARIANTARG *pvargDest,
                                              _In_ const VARIANTARG *pvarSrc,
                                              _In_ USHORT wFlags,
                                              _In_ VARTYPE vt);
_Check_return_ WINOLEAUTAPI VariantChangeTypeEx(_Inout_ VARIANTARG *pvargDest,
                                                _In_ const VARIANTARG *pvarSrc,
                                                _In_ LCID lcid,
                                                _In_ USHORT wFlags,
                                                _In_ VARTYPE vt);
...
#define VARIANT_NOUSEROVERRIDE                                                 \
  0x04 // For conversions to/from VT_BSTR,
...
_Check_return_ WINOLEAUTAPI VectorFromBstr(_In_ BSTR bstr,
                                           _Outptr_ SAFEARRAY **ppsa);
_Check_return_ WINOLEAUTAPI BstrFromVector(_In_ SAFEARRAY *psa,
                                           _Out_ BSTR *pbstr);
...
WINOLEAUTAPI VarUI1FromStr(_In_ LPCOLESTR strIn, LCID lcid, ULONG dwFlags,
                           _Out_ BYTE *pbOut);
...
WINOLEAUTAPI VarI2FromStr(_In_ LPCOLESTR strIn, LCID lcid, ULONG dwFlags,
                          _Out_ SHORT *psOut);
...
WINOLEAUTAPI VarI4FromStr(_In_ LPCOLESTR strIn, LCID lcid, ULONG dwFlags,
                          _Out_ LONG *plOut);
WINOLEAUTAPI VarI4FromDisp(IDispatch *pdispIn, _In_ LCID lcid,
                           _Out_ LONG *plOut);
...
WINOLEAUTAPI VarI8FromStr(_In_ LPCOLESTR strIn, _In_ LCID lcid,
                          _In_ ULONG dwFlags, _Out_ LONG64 FAR *pi64Out);
WINOLEAUTAPI VarI8FromDisp(IDispatch FAR *pdispIn, _In_ LCID lcid,
                           _Out_ LONG64 FAR *pi64Out);
...
WINOLEAUTAPI VarI8FromDec(_In_ const DECIMAL *pdecIn,
                          _Out_ LONG64 FAR *pi64Out);
...
WINOLEAUTAPI VarR4FromStr(_In_ LPCOLESTR strIn, LCID lcid, ULONG dwFlags,
                          _Out_ FLOAT *pfltOut);
...
WINOLEAUTAPI VarR8FromStr(_In_ LPCOLESTR strIn, LCID lcid, ULONG dwFlags,
                          _Out_ DOUBLE *pdblOut);
WINOLEAUTAPI VarR8FromDisp(IDispatch *pdispIn, LCID lcid,
                           _Out_ DOUBLE *pdblOut);
...
WINOLEAUTAPI VarDateFromStr(_In_ LPCOLESTR strIn, _In_ LCID lcid,
                            _In_ ULONG dwFlags, _Out_ DATE *pdateOut);
WINOLEAUTAPI VarDateFromDisp(IDispatch *pdispIn, LCID lcid,
                             _Out_ DATE *pdateOut);
...
WINOLEAUTAPI VarCyFromStr(_In_ LPCOLESTR strIn, _In_ LCID lcid,
                          _In_ ULONG dwFlags, _Out_ CY *pcyOut);
WINOLEAUTAPI VarCyFromDisp(_In_ IDispatch *pdispIn, LCID lcid,
                           _Out_ CY *pcyOut);
...
WINOLEAUTAPI VarBstrFromI2(SHORT iVal, LCID lcid, ULONG dwFlags,
                           _Out_ BSTR *pbstrOut);
WINOLEAUTAPI VarBstrFromI4(LONG lIn, LCID lcid, ULONG dwFlags,
                           _Out_ BSTR *pbstrOut);
WINOLEAUTAPI VarBstrFromI8(LONG64 i64In, LCID lcid, ULONG dwFlags,
                           _Out_ BSTR FAR *pbstrOut);
...
WINOLEAUTAPI VarBstrFromR8(DOUBLE dblIn, LCID lcid, ULONG dwFlags,
                           _Out_ BSTR *pbstrOut);
WINOLEAUTAPI VarBstrFromCy(CY cyIn, LCID lcid, ULONG dwFlags,
                           _Out_ BSTR *pbstrOut);
WINOLEAUTAPI VarBstrFromDate(_In_ DATE dateIn, _In_ LCID lcid,
                             _In_ ULONG dwFlags, _Out_ BSTR *pbstrOut);
...
WINOLEAUTAPI VarBstrFromBool(VARIANT_BOOL boolIn, LCID lcid, ULONG dwFlags,
                             _Out_ BSTR *pbstrOut);
WINOLEAUTAPI VarBstrFromI1(CHAR cIn, LCID lcid, ULONG dwFlags,
                           _Out_ BSTR *pbstrOut);
...
WINOLEAUTAPI VarBstrFromUI4(ULONG ulIn, LCID lcid, ULONG dwFlags,
                            _Out_ BSTR *pbstrOut);
WINOLEAUTAPI VarBstrFromUI8(ULONG64 ui64In, LCID lcid, ULONG dwFlags,
                            _Out_ BSTR FAR *pbstrOut);
WINOLEAUTAPI VarBstrFromDec(_In_ const DECIMAL *pdecIn, _In_ LCID lcid,
                            _In_ ULONG dwFlags, _Out_ BSTR *pbstrOut);

WINOLEAUTAPI VarBoolFromUI1(BYTE bIn, _Out_ VARIANT_BOOL *pboolOut);
_Check_return_ WINOLEAUTAPI VarBoolFromI2(_In_ SHORT sIn,
                                          _Out_ VARIANT_BOOL *pboolOut);
...
WINOLEAUTAPI VarBoolFromStr(_In_ LPCOLESTR strIn, LCID lcid, ULONG dwFlags,
                            _Out_ VARIANT_BOOL *pboolOut);
...
WINOLEAUTAPI VarBoolFromDec(_In_ const DECIMAL *pdecIn,
                            _Out_ VARIANT_BOOL *pboolOut);

WINOLEAUTAPI
VarI1FromUI1(_In_ BYTE bIn, _Out_ CHAR *pcOut);

WINOLEAUTAPI
VarI1FromI2(_In_ SHORT uiIn, _Out_ CHAR *pcOut);

WINOLEAUTAPI
VarI1FromI4(_In_ LONG lIn, _Out_ CHAR *pcOut);

WINOLEAUTAPI
VarI1FromI8(_In_ LONG64 i64In, _Out_ CHAR *pcOut);

WINOLEAUTAPI
VarI1FromR4(_In_ FLOAT fltIn, _Out_ CHAR *pcOut);

WINOLEAUTAPI
VarI1FromR8(_In_ DOUBLE dblIn, _Out_ CHAR *pcOut);

WINOLEAUTAPI
VarI1FromDate(_In_ DATE dateIn, _Out_ CHAR *pcOut);

WINOLEAUTAPI
VarI1FromCy(_In_ CY cyIn, _Out_ CHAR *pcOut);

WINOLEAUTAPI
VarI1FromStr(_In_ LPCOLESTR strIn, _In_ LCID lcid, _In_ ULONG dwFlags,
             _Out_ CHAR *pcOut);

WINOLEAUTAPI
VarI1FromDisp(_In_ IDispatch *pdispIn, _In_ LCID lcid, _Out_ CHAR *pcOut);

WINOLEAUTAPI
VarI1FromBool(_In_ VARIANT_BOOL boolIn, _Out_ CHAR *pcOut);

WINOLEAUTAPI
VarI1FromUI2(_In_ USHORT uiIn, _Out_ CHAR *pcOut);

WINOLEAUTAPI
VarI1FromUI4(_In_ ULONG ulIn, _Out_ CHAR *pcOut);

WINOLEAUTAPI
VarI1FromUI8(_In_ ULONG64 i64In, _Out_ CHAR *pcOut);

WINOLEAUTAPI
VarI1FromDec(_In_ const DECIMAL *pdecIn, _Out_ CHAR *pcOut);
...
WINOLEAUTAPI VarUI2FromStr(_In_ LPCOLESTR strIn, _In_ LCID lcid,
                           _In_ ULONG dwFlags, _Out_ USHORT *puiOut);
WINOLEAUTAPI VarUI2FromDisp(_In_ IDispatch *pdispIn, LCID lcid,
                            _Out_ USHORT *puiOut);
...
WINOLEAUTAPI VarUI4FromStr(_In_ LPCOLESTR strIn, _In_ LCID lcid,
                           _In_ ULONG dwFlags, _Out_ ULONG *pulOut);
WINOLEAUTAPI VarUI4FromDisp(_In_ IDispatch *pdispIn, LCID lcid,
                            _Out_ ULONG *pulOut);
...
WINOLEAUTAPI VarUI8FromStr(_In_ LPCOLESTR strIn, _In_ LCID lcid,
                           _In_ ULONG dwFlags, _Out_ ULONG64 FAR *pi64Out);
WINOLEAUTAPI VarUI8FromDisp(_In_ IDispatch FAR *pdispIn, LCID lcid,
                            _Out_ ULONG64 FAR *pi64Out);
...
WINOLEAUTAPI VarUI8FromDec(_In_ const DECIMAL *pdecIn,
                           _Out_ ULONG64 FAR *pi64Out);
...
WINOLEAUTAPI VarDecFromStr(_In_ LPCOLESTR strIn, _In_ LCID lcid,
                           _In_ ULONG dwFlags, _Out_ DECIMAL *pdecOut);
WINOLEAUTAPI VarDecFromDisp(_In_ IDispatch *pdispIn, _In_ LCID lcid,
                            _Out_ DECIMAL *pdecOut);
...
_Check_return_ WINOLEAUTAPI VarParseNumFromStr(
    _In_ LPCOLESTR strIn, _In_ LCID lcid, _In_ ULONG dwFlags,
    _Inout_ NUMPARSE *pnumprs, _Out_writes_(pnumprs->cDig) BYTE *rgbDig);

_Check_return_ WINOLEAUTAPI VarNumFromParseNum(_In_ NUMPARSE *pnumprs,
                                               _In_reads_(pnumprs->cDig)
                                                   BYTE *rgbDig,
                                               _In_ ULONG dwVtBits,
                                               _Out_ VARIANT *pvar);
...
STDAPI VarAdd(_In_ LPVARIANT pvarLeft, _In_ LPVARIANT pvarRight,
              _Out_ LPVARIANT pvarResult);
STDAPI VarAnd(_In_ LPVARIANT pvarLeft, _In_ LPVARIANT pvarRight,
              _Out_ LPVARIANT pvarResult);
STDAPI VarCat(_In_ LPVARIANT pvarLeft, _In_ LPVARIANT pvarRight,
              _Out_ LPVARIANT pvarResult);
STDAPI VarDiv(_In_ LPVARIANT pvarLeft, _In_ LPVARIANT pvarRight,
              _Out_ LPVARIANT pvarResult);
STDAPI VarEqv(_In_ LPVARIANT pvarLeft, _In_ LPVARIANT pvarRight,
              _Out_ LPVARIANT pvarResult);
STDAPI VarIdiv(_In_ LPVARIANT pvarLeft, _In_ LPVARIANT pvarRight,
               _Out_ LPVARIANT pvarResult);
STDAPI VarImp(_In_ LPVARIANT pvarLeft, _In_ LPVARIANT pvarRight,
              _Out_ LPVARIANT pvarResult);
STDAPI VarMod(_In_ LPVARIANT pvarLeft, _In_ LPVARIANT pvarRight,
              _Out_ LPVARIANT pvarResult);
STDAPI VarMul(_In_ LPVARIANT pvarLeft, _In_ LPVARIANT pvarRight,
              _Out_ LPVARIANT pvarResult);
STDAPI VarOr(_In_ LPVARIANT pvarLeft, _In_ LPVARIANT pvarRight,
             _Out_ LPVARIANT pvarResult);
STDAPI VarPow(_In_ LPVARIANT pvarLeft, _In_ LPVARIANT pvarRight,
              _Out_ LPVARIANT pvarResult);
STDAPI VarSub(_In_ LPVARIANT pvarLeft, _In_ LPVARIANT pvarRight,
              _Out_ LPVARIANT pvarResult);
STDAPI VarXor(_In_ LPVARIANT pvarLeft, _In_ LPVARIANT pvarRight,
              _Out_ LPVARIANT pvarResult);
...
STDAPI VarRound(_In_ LPVARIANT pvarIn, _In_ int cDecimals,
                _Out_ LPVARIANT pvarResult);
...
STDAPI VarDecAdd(_In_ LPDECIMAL pdecLeft, _In_ LPDECIMAL pdecRight,
                 _Out_ LPDECIMAL pdecResult);
STDAPI VarDecDiv(_In_ LPDECIMAL pdecLeft, _In_ LPDECIMAL pdecRight,
                 _Out_ LPDECIMAL pdecResult);
STDAPI VarDecMul(_In_ LPDECIMAL pdecLeft, _In_ LPDECIMAL pdecRight,
                 _Out_ LPDECIMAL pdecResult);
STDAPI VarDecSub(_In_ LPDECIMAL pdecLeft, _In_ LPDECIMAL pdecRight,
                 _Out_ LPDECIMAL pdecResult);
...
STDAPI VarDecRound(_In_ LPDECIMAL pdecIn, int cDecimals,
                   _Out_ LPDECIMAL pdecResult);
...
//
STDAPI VarBstrCat(_In_ BSTR bstrLeft, _In_ BSTR bstrRight,
                  _Out_ LPBSTR pbstrResult);
STDAPI VarBstrCmp(_In_ BSTR bstrLeft, _In_ BSTR bstrRight, _In_ LCID lcid,
                  _In_ ULONG dwFlags); // dwFlags passed to CompareString
STDAPI VarR8Pow(_In_ double dblLeft, _In_ double dblRight,
                _Out_ double *pdblResult);
STDAPI VarR4CmpR8(_In_ float fltLeft, _In_ double dblRight);
STDAPI VarR8Round(_In_ double dblIn, _In_ int cDecimals,
                  _Out_ double *pdblResult);
...
_Check_return_ WINOLEAUTAPI VarDateFromUdate(_In_ UDATE *pudateIn,
                                             _In_ ULONG dwFlags,
                                             _Out_ DATE *pdateOut);
WINOLEAUTAPI VarDateFromUdateEx(_In_ UDATE *pudateIn, _In_ LCID lcid,
                                _In_ ULONG dwFlags, _Out_ DATE *pdateOut);
_Check_return_ WINOLEAUTAPI VarUdateFromDate(_In_ DATE dateIn,
                                             _In_ ULONG dwFlags,
                                             _Out_ UDATE *pudateOut);
...
*/
_Check_return_ WINOLEAUTAPI GetAltMonthNames(
    LCID lcid, _Outptr_result_buffer_maybenull_(13) LPOLESTR **prgp);
...
WINOLEAUTAPI VarFormat(_In_ LPVARIANT pvarIn, _In_opt_ LPOLESTR pstrFormat,
                       int iFirstDay, int iFirstWeek, ULONG dwFlags,
                       _Out_ BSTR *pbstrOut);

WINOLEAUTAPI VarFormatDateTime(_In_ LPVARIANT pvarIn, int iNamedFormat,
                               ULONG dwFlags, _Out_ BSTR *pbstrOut);

WINOLEAUTAPI VarFormatNumber(_In_ LPVARIANT pvarIn, int iNumDig, int iIncLead,
                             int iUseParens, int iGroup, ULONG dwFlags,
                             _Out_ BSTR *pbstrOut);

WINOLEAUTAPI VarFormatPercent(_In_ LPVARIANT pvarIn, int iNumDig, int iIncLead,
                              int iUseParens, int iGroup, ULONG dwFlags,
                              _Out_ BSTR *pbstrOut);

WINOLEAUTAPI VarFormatCurrency(_In_ LPVARIANT pvarIn, int iNumDig, int iIncLead,
                               int iUseParens, int iGroup, ULONG dwFlags,
                               _Out_ BSTR *pbstrOut);
...
WINOLEAUTAPI
VarFormatFromTokens(_In_ LPVARIANT pvarIn, _In_opt_ LPOLESTR pstrFormat,
                    _In_reads_(_Inexpressible_("from VarTokenizeFormatString"))
                        LPBYTE pbTokCur,
                    ULONG dwFlags, _Out_ BSTR *pbstrOut, LCID lcid);

WINOLEAUTAPI VarTokenizeFormatString(_In_opt_ LPOLESTR pstrFormat,
                                     _Inout_updates_(cbTok) LPBYTE rgbTok,
                                     int cbTok, int iFirstDay, int iFirstWeek,
                                     LCID lcid, _In_opt_ int *pcbActual);
 ...
 */
#if (defined(_WIN32) || defined(_WIN64))
_Check_return_ WINOLEAUTAPI_(ULONG)
...
_Check_return_ WINOLEAUTAPI LoadTypeLibEx(LPCOLESTR szFile, REGKIND regkind,
                                          ITypeLib **pptlib);

/* load registered typelib
 */
_Check_return_ WINOLEAUTAPI LoadRegTypeLib(REFGUID rguid, WORD wVerMajor,
 ...
 */
_Check_return_ WINOLEAUTAPI RegisterTypeLib(ITypeLib *ptlib,
                                            _In_ LPCOLESTR szFullPath,
                                            _In_opt_ LPCOLESTR szHelpDir);

/* remove typelib from registry
 */

_Check_return_ WINOLEAUTAPI UnRegisterTypeLib(REFGUID libID, WORD wVerMajor,
                                              WORD wVerMinor, LCID lcid,
                                              SYSKIND syskind);
 ...
 */
WINOLEAUTAPI UnRegisterTypeLibForUser(REFGUID libID, WORD wMajorVerNum,
                                      WORD wMinorVerNum, LCID lcid,
                                      SYSKIND syskind);

_Check_return_ WINOLEAUTAPI CreateTypeLib(SYSKIND syskind, LPCOLESTR szFile,
                                          ICreateTypeLib **ppctlib);

_Check_return_ WINOLEAUTAPI CreateTypeLib2(SYSKIND syskind, LPCOLESTR szFile,
 ...
 */
_Check_return_ WINOLEAUTAPI DispGetParam(_In_ DISPPARAMS *pdispparams,
                                         UINT position, VARTYPE vtTarg,
                                         _Out_ VARIANT *pvarResult,
                                         _Out_opt_ UINT *puArgErr);

/* Automatic TypeInfo driven implementation of IDispatch::GetIDsOfNames()
 */
_Check_return_ WINOLEAUTAPI
DispGetIDsOfNames(ITypeInfo *ptinfo, _In_reads_(cNames) LPOLESTR *rgszNames,
...
#pragma region Application Family or OneCore Family
    ...
    WINOLEAUTAPI DispInvoke(void *_this, ITypeInfo *ptinfo, DISPID dispidMember,
                            WORD wFlags, DISPPARAMS *pparams,
 ...
 */
_Check_return_ WINOLEAUTAPI CreateDispTypeInfo(INTERFACEDATA *pidata, LCID lcid,
                                               ITypeInfo **pptinfo);

/* Create an instance of the standard TypeInfo driven IDispatch
 * implementation.
 */
_Check_return_ WINOLEAUTAPI CreateStdDispatch(IUnknown *punkOuter, void *pvThis,
                                              ITypeInfo *ptinfo,
 ...
 */
WINOLEAUTAPI DispCallFunc(_In_opt_ void *pvInstance, ULONG_PTR oVft,
                          CALLCONV cc, VARTYPE vtReturn, UINT cActuals,
                          _In_reads_(cActuals) VARTYPE *prgvt,
                          _In_reads_(cActuals) VARIANTARG **prgpvarg,
                          _Out_ VARIANT *pvargResult);
...
_Check_return_ WINOLEAUTAPI RegisterActiveObject(IUnknown *punk,
                                                 REFCLSID rclsid, DWORD dwFlags,
                                                 DWORD *pdwRegister);
...
_Check_return_ WINOLEAUTAPI GetErrorInfo(_In_ ULONG dwReserved,
                                         _Outptr_ IErrorInfo **pperrinfo);
_Check_return_ WINOLEAUTAPI
CreateErrorInfo(_Outptr_ ICreateErrorInfo **pperrinfo);
