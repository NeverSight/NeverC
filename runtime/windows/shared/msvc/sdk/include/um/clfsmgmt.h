...
typedef struct _CLFS_MGMT_POLICY {
  ...
  union {
    ...
    struct {
      ...
      WCHAR ExtensionString[1]; // dynamic in length depending on
...
typedef NTSTATUS (*PCLFS_CLIENT_ADVANCE_TAIL_CALLBACK)(
    _In_ PLOG_FILE_OBJECT LogFile, _In_ PCLFS_LSN TargetLsn,
...
typedef VOID (*PCLFS_CLIENT_LFF_HANDLER_COMPLETE_CALLBACK)(
    _In_ PLOG_FILE_OBJECT LogFile, _In_ NTSTATUS OperationStatus,
    _In_ BOOLEAN LogIsPinned, _In_ PVOID ClientData);
#endif /* NTDDI_VERSION || _WIN32_WINNT */
...
typedef VOID (*PCLFS_CLIENT_LOG_UNPINNED_CALLBACK)(
    _In_ PLOG_FILE_OBJECT LogFile, _In_ PVOID ClientData);
#endif /* NTDDI_VERSION || _WIN32_WINNT */
...
CLFSUSER_API
NTSTATUS
ClfsMgmtRegisterManagedClient(_In_ PLOG_FILE_OBJECT LogFile,
                              _In_ PCLFS_MGMT_CLIENT_REGISTRATION
                                  RegistrationData,
...
CLFSUSER_API
NTSTATUS
ClfsMgmtTailAdvanceFailure(_In_ CLFS_MGMT_CLIENT Client, _In_ NTSTATUS Reason);
#endif /* NTDDI_VERSION || _WIN32_WINNT */

#if (NTDDI_VERSION >= NTDDI_WS03SP1) || (_WIN32_WINNT >= _WIN32_WINNT_WS03)
CLFSUSER_API
NTSTATUS
ClfsMgmtHandleLogFileFull(_In_ CLFS_MGMT_CLIENT Client);
#endif /* NTDDI_VERSION || _WIN32_WINNT */

#if (NTDDI_VERSION >= NTDDI_WS03SP1) || (_WIN32_WINNT >= _WIN32_WINNT_WS03)
CLFSUSER_API
NTSTATUS
ClfsMgmtInstallPolicy(_In_ PLOG_FILE_OBJECT LogFile,
...
CLFSUSER_API
NTSTATUS
ClfsMgmtQueryPolicy(_In_ PLOG_FILE_OBJECT LogFile,
...
CLFSUSER_API
NTSTATUS
ClfsMgmtRemovePolicy(_In_ PLOG_FILE_OBJECT LogFile,
                     _In_ CLFS_MGMT_POLICY_TYPE PolicyType);
#endif /* NTDDI_VERSION || _WIN32_WINNT */
...
ClfsMgmtSetLogFileSize(
    _In_ PLOG_FILE_OBJECT LogFile, _In_ PULONGLONG NewSizeInContainers,
...
ClfsMgmtSetLogFileSizeAsClient(
    _In_ PLOG_FILE_OBJECT LogFile, _In_opt_ CLFS_MGMT_CLIENT ClientCookie,
