...
// MessageText:
//
// The file may only have partial classification because a failure occurred
// while loading or classifying the file properties.
//
...
// MessageText:
//
// Classification failed on one or more volumes. Check the application event log
...
// MessageText:
//
// The version of the configuration file you are trying to import is not
// supported. You cannot import configuration files with database versions
// earlier than 2.0.
//
...
// MessageText:
//
// Auto apply quota configuration for one or more folders failed.  Check the
...
// MessageText:
//
// The File Server Resource Manager service could not send email due to an
// error. Check the application event log for more information.
//
...
// MessageText:
//
// A File Server Resource Manager XML configuration file or import-export file
// is corrupted.
//
...
// MessageText:
//
// File Server Resource Manager global configuration cannot be accessed since it
...
// MessageText:
//
// The volume does not reside on a cluster shared disk with an associated
// cluster resource.
//
...
// MessageText:
//
// There are at least two paths which reside on different cluster shared disks
// which are not in the same cluster resource group.
//
...
// MessageText:
//
// File Server Resource Manager cannot aggregate the value for the specified
// file property.
//
...
// MessageText:
//
// The limit of the number of messages that the current pipeline context can add
// to the property bag has been reached.
//
...
// MessageText:
//
// A new property definition cannot be created.  The maximum number of property
// definitions, {0}, has been reached.
//
...
// MessageText:
//
// A classification job is currently running.  Only one classification job can
...
// MessageText:
//
// Cannot perform a custom action on a file while running a file management
// task.
//
...
// MessageText:
//
// File Server Resource Manager failed to perform a secure link with a hosted
// module process.
//
...
// MessageText:
//
// The updating of last access times is disabled on this server.  To create a
// report or file management task that uses the last access time the updating of
// last access time must be enabled.
//
...
// MessageText:
//
// File Server Resource Manager failed to enumerate file properties because a
// failure occurred while loading or classifying the file properties.
//
...
// MessageText:
//
// File Server Resource Manager failed to set a file property to the file
// because a failure occurred while saving the file properties.
//
...
// MessageText:
//
// Classification properties will not be stored because a failure occurred while
// loading or classifying the file properties.
//
...
// MessageText:
//
// Classification is not supported on the specified reparse point. File Server
// Resource Manager does not recognize the reparse point's identifier tag for
...
// MessageText:
//
// The requested property was not found. The file may only have partial
// classification because a failure occurred while loading or classifying the
// file properties.
//
...
// MessageText:
//
// File Server Resource Manager failed to write the properties to the file
// because the file is either corrupt or protected by Rights Management
// Services.
//
...
// MessageText:
//
// The module will not process the specified file because it is unable to
// determine a compatible file format.
//
...
// MessageText:
//
// File Server Resource Manager could not access the file because it is
// encrypted.
//
...
// MessageText:
//
// The file management action completed successfully, but the exit code cannot
// be obtained.
//
...
// MessageText:
//
// The module encountered an invalid parameter or a valid parameter with an
// invalid value or an expected module parameter is not found. Check the
// application event log for more information.
//
...
// MessageText:
//
// The module initialization failed. Check the application event log for more
// information.
//
...
// MessageText:
//
// The module session initialization failed. Check the application event log for
// more information.
//
...
// MessageText:
//
// Classification failed on all volumes. Check the application event log for
// more information.
//
...
// MessageText:
//
// The file management task cannot be accessed because task conditions were
// modified by using WMI or Windows PowerShell interfaces. To access or edit the
// file management task, use the WMI or Windows PowerShell interfaces.
//
...
// MessageText:
//
// This object uses a property definition that is deprecated.  You must change
// it to use a non-deprecated property definition.
//
...
// MessageText:
//
// This object uses a property definition that doesn't exist.  You must change
// it to use an existing property definition.
//
...
// MessageText:
//
// File Server Resource Manager encountered an invalid resource claim in Active
// Directory.
//
...
// MessageText:
//
// File Server Resource Manager is rebuilding the index of Folder Usage property
// values.
//
...
// MessageText:
//
// The file is being used by another application and cannot be accessed at this
// time.
//
...
// MessageText:
//
// Access-denied assistance cannot send an email because an email address could
// not be found for the path specified, and sending email to the administrator
// is not enabled.
//
...
// MessageText:
//
// The current user has sent the maximum number of requests for access-denied
// assistance.
//
...
// MessageText:
//
// The RMS template used to configure the file management task no longer exists.
...
// MessageText:
//
// The computer hosting the file or folder does not support setting secure
// properties. This can occur if the computer is running Windows Server 2008 R2,
// Windows 7, or earlier, or if the computer is not running Windows.
//
...
// MessageText:
//
// File Server Resource Manager cannot run the file management task because no
// RMS protectors are installed.
//
...
// MessageText:
//
// File Server Resource Manager cannot protect the file because an RMS protector
...
// MessageText:
//
// File Server Resource Manager could not remove the read-only attribute from a
// file.
//
...
// MessageText:
//
// A continuous file management job cannot have conditions based on the file's
// last accessed/modified or created times and cannot define any notifications.
//
...
// MessageText:
//
// The object contains a schedule that was created by using an earlier version
// of File Server Resource Manager and that is incompatible with the current
// version of Windows Server. Edit the schedule on this computer to update it.
//
...
// MessageText:
//
// Cannot write to the specified expiration directory. Confirm that the
// permissions of the expiration directory grant Write permission to the
// computer account of the server performing the file expiration task.
//
...
// MessageText:
//
// The expiration directory must be on a volume formatted with the NTFS file
// system.
//
...
// MessageText:
//
// This file management job is deprecated. Please check the configuration of the
// file management job and verify that it is up-to-date.
//
...
// MessageText:
//
// A module was restarted due to excessive processing time of a file. Check the
// application event log for more information.
//
