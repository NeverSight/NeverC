...
public:
  ...
  virtual /* [helpcontext][helpstring][propget][id] */ HRESULT STDMETHODCALLTYPE
      get_BorderStyle(
          /* [retval][out] */ __RPC__out BorderStyleConstants *
          pBorderStyle) = 0;
  ...
  virtual /* [helpcontext][helpstring][bindable][propget][id] */ HRESULT
      STDMETHODCALLTYPE get_Font(
          /* [retval][out] */ __RPC__deref_out_opt IFontDisp * *ppFont) = 0;

  virtual /* [helpcontext][helpstring][bindable][propputref][id] */ HRESULT
      STDMETHODCALLTYPE putref_Font(
  ...
  virtual /* [helpcontext][helpstring][defaultbind][displaybind][bindable][propget][id]
           */
      HRESULT STDMETHODCALLTYPE get_TextRTF(
          /* [retval][out] */ __RPC__deref_out_opt BSTR * pbstrTextRTF) = 0;

  virtual /* [helpcontext][helpstring][displaybind][bindable][propput][id] */
...
typedef struct IInkEditVtbl {
  ...
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in IInkEdit *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IInkEdit *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IInkEdit *This);
  ...
  /* [helpcontext][helpstring][propget][id] */ HRESULT(
      STDMETHODCALLTYPE *get_RecognitionTimeout)(
      __RPC__in IInkEdit *This,
      /* [retval][out] */ __RPC__out long *pVal);

  DECLSPEC_XFGVIRT(IInkEdit, put_RecognitionTimeout)
  /* [helpcontext][helpstring][propput][id] */ HRESULT(
      STDMETHODCALLTYPE *put_RecognitionTimeout)(__RPC__in IInkEdit *This,
                                                 /* [in] */ long newVal);
  ...
  /* [helpcontext][helpstring][propput][id] */ HRESULT(
      STDMETHODCALLTYPE *put_BackColor)(__RPC__in IInkEdit *This,
                                        /* [in] */ OLE_COLOR clr);
  ...
  /* [helpcontext][helpstring][bindable][propget][id] */ HRESULT(
      STDMETHODCALLTYPE *get_Font)(
      __RPC__in IInkEdit *This,
      /* [retval][out] */ __RPC__deref_out_opt IFontDisp **ppFont);

  DECLSPEC_XFGVIRT(IInkEdit, putref_Font)
  /* [helpcontext][helpstring][bindable][propputref][id] */ HRESULT(
      STDMETHODCALLTYPE *putref_Font)(
      __RPC__in IInkEdit *This,
  ...
  /* [helpcontext][helpstring][propget][id] */ HRESULT(
      STDMETHODCALLTYPE *get_Locked)(
      __RPC__in IInkEdit *This,
      /* [retval][out] */ __RPC__out VARIANT_BOOL *pVal);

  DECLSPEC_XFGVIRT(IInkEdit, put_Locked)
  /* [helpcontext][helpstring][propput][id] */ HRESULT(
      STDMETHODCALLTYPE *put_Locked)(__RPC__in IInkEdit *This,
...
interface IInkEdit { CONST_VTBL struct IInkEditVtbl *lpVtbl; };
...
typedef struct _IInkEditEventsVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in _IInkEditEvents *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in _IInkEditEvents *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in _IInkEditEvents *This);
...
interface _IInkEditEvents { CONST_VTBL struct _IInkEditEventsVtbl *lpVtbl; };
...
#define _IInkEditEvents_GetIDsOfNames(This, riid, rgszNames, cNames, lcid,     \
                                      rgDispId)                                \
  ((This)->lpVtbl->GetIDsOfNames(This, riid, rgszNames, cNames, lcid, rgDispId))

#define _IInkEditEvents_Invoke(This, dispIdMember, riid, lcid, wFlags,         \
...
class DECLSPEC_UUID("E5CA59F5-57C4-4DD8-9BD6-1DEEEDD27AF4") InkEdit;
#endif
