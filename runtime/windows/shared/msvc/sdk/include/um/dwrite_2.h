...
/// such as underlines.
/// </summary>
interface DWRITE_DECLARE_INTERFACE("D3E0E934-22A0-427E-AAE4-7D9574B59DB1")
  ...
  ///     DWRITE_RENDERING_MODE_CLEARTYPE_NATURAL for
...
/// change.
/// </remarks>
interface DWRITE_DECLARE_INTERFACE("5F174B49-0D8B-4CFB-8BCA-F1CCE9D06C67")
    IDWriteTextFormat1 : public IDWriteTextFormat {
  /// <summary>
  /// Set the preferred orientation of glyphs when using a vertical reading
  /// direction.
  /// </summary>
  ...
  STDMETHOD(SetVerticalGlyphOrientation)(
      DWRITE_VERTICAL_GLYPH_ORIENTATION glyphOrientation) PURE;
  ...
  /// Standard HRESULT error code.
  /// </returns>
  STDMETHOD(SetLastLineWrapping)(BOOL isLastLineWrappingEnabled) PURE;
  ...
  /// Standard HRESULT error code.
  /// </returns>
  STDMETHOD(SetOpticalAlignment)(DWRITE_OPTICAL_ALIGNMENT opticalAlignment)
      PURE;
  ...
  /// Standard HRESULT error code.
  /// </returns>
  STDMETHOD(SetFontFallback)(IDWriteFontFallback * fontFallback) PURE;

  /// <summary>
  /// Get the current font fallback object.
  /// </summary>
  STDMETHOD(GetFontFallback)(__out IDWriteFontFallback * *fontFallback) PURE;
};
...
/// All coordinates are in device independent pixels (DIPs).
/// </summary>
interface DWRITE_DECLARE_INTERFACE("1093C18F-8D5E-43F0-B064-0917311B525E")
  ...
  /// </remarks>
  STDMETHOD(GetMetrics)(_Out_ DWRITE_TEXT_METRICS1 * textMetrics) PURE;
...
/// such as underlines.
/// </summary>
interface DWRITE_DECLARE_INTERFACE("553A9FF3-5693-4DF7-B52B-74806F7F2EB9")
  ...
  /// </summary>
  /// <param name="glyphOrientationAngle">The angle reported to one of the
  /// application callbacks,
  ///     including IDWriteTextAnalysisSink1::SetGlyphOrientation and
  ///     IDWriteTextRenderer1::Draw*.</param>
  /// <param name="isSideways">Whether the run's glyphs are sideways or
  /// not.</param> <param name="originX">X origin of the element, be it a glyph
  /// run or underline or other.</param> <param name="originY">Y origin of the
  /// element, be it a glyph run or underline or other.</param> <param
  /// name="transform">Returned transform.</param> <returns> Standard HRESULT
  /// error code.
  /// </returns>
  /// <remarks>
  /// This rotates around the given origin x and y, returning a translation
  /// component such that the glyph run, text decoration, or inline object is
  /// drawn with the right orientation at the expected coordinate.
  /// </remarks>
  STDMETHOD(GetGlyphOrientationTransform)(
      DWRITE_GLYPH_ORIENTATION_ANGLE glyphOrientationAngle, BOOL isSideways,
      FLOAT originX, FLOAT originY, _Out_ DWRITE_MATRIX * transform) PURE;

  /// <summary>
  /// Returns a list of typographic feature tags for the given script and
  /// language.
  /// </summary>
  ...
  STDMETHOD(GetTypographicFeatures)(
      IDWriteFontFace * fontFace, DWRITE_SCRIPT_ANALYSIS scriptAnalysis,
      _In_opt_z_ WCHAR const *localeName, UINT32 maxTagCount,
      _Out_ UINT32 *actualTagCount,
      _Out_writes_(maxTagCount) DWRITE_FONT_FEATURE_TAG *tags) PURE;

  /// <summary>
  /// Returns an array of which glyphs are affected by a given feature.
  /// </summary>
  /// <param name="fontFace">The font face to read glyph information
  /// from.</param> <param name="scriptAnalysis">Script analysis result from
  /// AnalyzeScript.</param> <param name="localeName">The locale to use when
  /// selecting the feature,
  ///     such en-us or ja-jp.</param>
  ...
  /// <param name="glyphIndices">Glyph indices to check for feature
  /// application.</param> <param name="featureApplies">Output of which glyphs
  /// are affected by the
  ...
  STDMETHOD(CheckTypographicFeature)(
      IDWriteFontFace * fontFace, DWRITE_SCRIPT_ANALYSIS scriptAnalysis,
      _In_opt_z_ WCHAR const *localeName, DWRITE_FONT_FEATURE_TAG featureTag,
      UINT32 glyphCount, _In_reads_(glyphCount) UINT16 const *glyphIndices,
      _Out_writes_(glyphCount) UINT8 *featureApplies) PURE;
...
/// supporting them.
/// </summary>
interface DWRITE_DECLARE_INTERFACE("EFA008F9-F7A1-48BF-B05C-F224713CC0FF")
  ...
  STDMETHOD(MapCharacters)(
      ...
      _In_opt_z_ wchar_t const *baseFamilyName, DWRITE_FONT_WEIGHT baseWeight,
...
/// </remarks>
interface DWRITE_DECLARE_INTERFACE("FD882D06-8ABA-4FB8-B849-8BE8B73E14DE")
    IDWriteFontFallbackBuilder : public IUnknown {
  /// <summary>
  /// Appends a single mapping to the list. Call this once for each additional
  /// mapping.
  /// </summary>
  /// <param name="ranges">Unicode ranges that apply to this mapping.</param>
  /// <param name="rangesCount">Number of Unicode ranges.</param>
  /// <param name="localeName">Locale of the context (e.g. document
  /// locale).</param> <param name="baseFamilyName">Base family name to match
  /// against, if applicable.</param> <param name="fontCollection">Explicit font
  /// collection for this mapping (optional).</param> <param
  /// name="targetFamilyNames">List of target family name strings.</param>
  /// <param name="targetFamilyNamesCount">Number of target family
  /// names.</param> <param name="scale">Scale factor to multiply the result
  /// target font by.</param> <returns> Standard HRESULT error code.
  /// </returns>
  STDMETHOD(AddMapping)(
      ...
      _In_opt_z_ WCHAR const *baseFamilyName = NULL, FLOAT scale = 1.0f) PURE;
  ...
  /// Standard HRESULT error code.
  /// </returns>
  STDMETHOD(AddMappings)(IDWriteFontFallback * fontFallback) PURE;
  ...
  /// Standard HRESULT error code.
  /// </returns>
  STDMETHOD(CreateFontFallback)(_COM_Outptr_ IDWriteFontFallback *
                                *fontFallback) PURE;
};
...
interface DWRITE_DECLARE_INTERFACE("29748ed6-8c9c-4a6a-be0b-d912e8538944")
  ...
  /// <summary>
  /// Returns TRUE if the font contains tables that can provide color
  /// information (including COLR, CPAL, SVG, CBDT, sbix  tables), or FALSE if
  /// not. Note that TRUE is returned even in the case when the font tables
  /// contain only grayscale images.
  /// </summary>
...
/// </summary>
interface DWRITE_DECLARE_INTERFACE("d8b768ff-64bc-4e66-982b-ec8e87f693f7")
  ...
  /// </summary>
  /// <param name="colorPaletteIndex">Zero-based index of the color palette. If
  /// the font does not have a palette with the specified index, the method
  /// returns DWRITE_E_NOCOLOR.<param> <param name="firstEntryIndex">Zero-based
  /// index of the first palette entry to read.</param> <param
  /// name="entryCount">Number of palette entries to read.</param> <param
  /// name="paletteEntries">Array that receives the color values.<param>
  /// <returns>
  /// Standard HRESULT error code.
  /// The return value is E_INVALIDARG if firstEntryIndex + entryCount is
  /// greater than the actual number of palette entries as returned by
  /// GetPaletteEntryCount. The return value is DWRITE_E_NOCOLOR if the font
  /// does not have a palette with the specified palette index.
  /// </returns>
  STDMETHOD(GetPaletteEntries)(
      UINT32 colorPaletteIndex, UINT32 firstEntryIndex, UINT32 entryCount,
      _Out_writes_(entryCount) DWRITE_COLOR_F * paletteEntries) PURE;
...
/// </summary>
interface DWRITE_DECLARE_INTERFACE("d31fbe17-f157-41a2-8d24-cb779e0560e8")
  ...
  /// Standard HRESULT error code.
  /// </returns>
  STDMETHOD(MoveNext)(_Out_ BOOL * hasRun) PURE;
  ...
  STDMETHOD(GetCurrentRun)(
      _Outptr_ DWRITE_COLOR_GLYPH_RUN const **colorGlyphRun) PURE;
};
...
/// </summary>
interface DWRITE_DECLARE_INTERFACE("F9D711C3-9777-40AE-87E8-3E5AF9BF0948")
...
/// </summary>
interface DWRITE_DECLARE_INTERFACE("0439fc60-ca44-4994-8dee-3a9af7b732ec")
  ...
  /// Standard HRESULT error code.
  /// </returns>
  STDMETHOD(GetSystemFontFallback)(_COM_Outptr_ IDWriteFontFallback *
                                   *fontFallback) PURE;
  ...
  /// Standard HRESULT error code.
  /// </returns>
  STDMETHOD(CreateFontFallbackBuilder)(_COM_Outptr_ IDWriteFontFallbackBuilder *
                                       *fontFallbackBuilder) PURE;
  ...
  /// DWRITE_E_NOCOLOR if the font has no color information, the base glyph run
  /// does not contain any color glyphs, or the specified color palette index is
  /// out of range. In this case, the client should render the base glyph run.
  ...
  STDMETHOD(TranslateColorGlyphRun)(
      ...
      _COM_Outptr_ IDWriteColorGlyphRunEnumerator **colorLayers) PURE;
  ...
  /// name="renderingParams">Holds the newly created rendering parameters
  ...
  STDMETHOD(CreateCustomRenderingParams)(
      ...
      _COM_Outptr_ IDWriteRenderingParams2 * *renderingParams) PURE;
  ...
  /// specified by the emSize and pixelsPerDip.</param> <param
  /// name="renderingMode">Specifies the rendering mode, which must be one of
  /// the raster rendering modes (i.e., not default and not outline).</param>
  /// <param name="measuringMode">Specifies the method to measure
  /// glyphs.</param> <param name="gridFitMode">How to grid-fit glyph outlines.
  /// This must be non-default.</param> <param name="baselineOriginX">Horizontal
  /// position of the baseline origin, in DIPs.</param> <param
  /// name="baselineOriginY">Vertical position of the baseline origin, in
  /// DIPs.</param> <param name="glyphRunAnalysis">Receives a pointer to the
  /// newly created object.</param> <returns> Standard HRESULT error code.
  /// </returns>
