...
typedef /* [unique] */ __RPC_unique_pointer ISyncMgrSynchronizeCallback
...
public:
  ...
  virtual HRESULT STDMETHODCALLTYPE ShowErrorCompleted(
      ...
      /* [in] */ ULONG cItems,
      /* [size_is][unique][in] */
      __RPC__in_ecount_full_opt(cItems) const GUID *pItemIDs) = 0;
  ...
  virtual HRESULT STDMETHODCALLTYPE Progress(
      ...
      /* [unique][in] */ __RPC__in_opt const SYNCMGRPROGRESSITEM
          *pSyncProgressItem) = 0;
  ...
  virtual HRESULT STDMETHODCALLTYPE LogError(
      ...
      /* [unique][in] */
      __RPC__in_opt const SYNCMGRLOGERRORINFO *pSyncLogError) = 0;
...
typedef struct ISyncMgrSynchronizeCallbackVtbl {
  ...
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in ISyncMgrSynchronizeCallback *This);
...
#define ISyncMgrSynchronizeCallback_ShowErrorCompleted(This, hr, cItems,       \
                                                       pItemIDs)               \
...
#define ISyncMgrSynchronizeCallback_LogError(This, dwErrorLevel, pszErrorText, \
                                             pSyncLogError)                    \
...
#define ISyncMgrSynchronizeCallback_EstablishConnection(This, pwszConnection,  \
                                                        dwReserved)            \
...
typedef /* [unique] */ __RPC_unique_pointer ISyncMgrEnumItems
    *LPSYNCMGRENUMITEMS;
...
typedef struct ISyncMgrEnumItemsVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in ISyncMgrEnumItems *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in ISyncMgrEnumItems *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in ISyncMgrEnumItems *This);

  DECLSPEC_XFGVIRT(ISyncMgrEnumItems, Next)
  HRESULT(STDMETHODCALLTYPE *Next)(__RPC__in ISyncMgrEnumItems *This,
                                   /* [in] */ ULONG celt,
                                   /* [length_is][size_is][out] */
  ...
  HRESULT(STDMETHODCALLTYPE *Skip)(__RPC__in ISyncMgrEnumItems *This,
                                   /* [in] */ ULONG celt);

  DECLSPEC_XFGVIRT(ISyncMgrEnumItems, Reset)
  HRESULT(STDMETHODCALLTYPE *Reset)(__RPC__in ISyncMgrEnumItems *This);
...
typedef /* [unique] */ __RPC_unique_pointer ISyncMgrSynchronize
    *LPSYNCMGROnSynchronize;
...
public:
  virtual HRESULT STDMETHODCALLTYPE Initialize(
      ...
      /* [in] */ DWORD cbCookie,
      /* [size_is][unique][in] */
      __RPC__in_ecount_full_opt(cbCookie) const BYTE *lpCookie) = 0;

  virtual HRESULT STDMETHODCALLTYPE GetHandlerInfo(
      /* [out] */ __RPC__deref_out_opt SYNCMGRHANDLERINFO *
      *ppSyncMgrHandlerInfo) = 0;

  virtual HRESULT STDMETHODCALLTYPE EnumSyncMgrItems(
      /* [out] */ __RPC__deref_out_opt ISyncMgrEnumItems *
      *ppSyncMgrEnumItems) = 0;
  ...
  virtual HRESULT STDMETHODCALLTYPE SetProgressCallback(
      /* [unique][in] */ __RPC__in_opt ISyncMgrSynchronizeCallback *
      lpCallBack) = 0;
...
typedef struct ISyncMgrSynchronizeVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in ISyncMgrSynchronize *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in ISyncMgrSynchronize *This);

  DECLSPEC_XFGVIRT(ISyncMgrSynchronize, Initialize)
  HRESULT(STDMETHODCALLTYPE *Initialize)(__RPC__in ISyncMgrSynchronize *This,
                                         /* [in] */ DWORD dwReserved,
                                         /* [in] */ DWORD dwSyncMgrFlags,
                                         /* [in] */ DWORD cbCookie,
                                         /* [size_is][unique][in] */
                                         __RPC__in_ecount_full_opt(cbCookie)
                                             const BYTE *lpCookie);
  ...
  HRESULT(STDMETHODCALLTYPE *Synchronize)(__RPC__in ISyncMgrSynchronize *This,
                                          /* [in] */ __RPC__in HWND hWndParent);
  ...
  HRESULT(STDMETHODCALLTYPE *ShowError)(__RPC__in ISyncMgrSynchronize *This,
                                        /* [in] */ __RPC__in HWND hWndParent,
                                        /* [in] */ __RPC__in REFGUID ErrorID);
...
typedef /* [unique] */ __RPC_unique_pointer ISyncMgrSynchronizeInvoke
    *LPSYNCMGRSYNCHRONIZEINVOKE;
...
public:
  virtual HRESULT STDMETHODCALLTYPE UpdateItems(
      ...
      /* [in] */ DWORD cbCookie,
      /* [size_is][unique][in] */
      __RPC__in_ecount_full_opt(cbCookie) const BYTE *pCookie) = 0;
...
typedef struct ISyncMgrSynchronizeInvokeVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in ISyncMgrSynchronizeInvoke *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in ISyncMgrSynchronizeInvoke *This);
...
#define ISyncMgrSynchronizeInvoke_UpdateItems(This, dwInvokeFlags, clsid,      \
                                              cbCookie, pCookie)               \
...
typedef struct ISyncMgrRegisterVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in ISyncMgrRegister *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in ISyncMgrRegister *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in ISyncMgrRegister *This);
...
interface ISyncMgrRegister { CONST_VTBL struct ISyncMgrRegisterVtbl *lpVtbl; };
...
#define ISyncMgrRegister_RegisterSyncMgrHandler(                               \
    This, clsidHandler, pwszDescription, dwSyncMgrRegisterFlags)               \
  ((This)->lpVtbl->RegisterSyncMgrHandler(This, clsidHandler, pwszDescription, \
                                          dwSyncMgrRegisterFlags))

#define ISyncMgrRegister_UnregisterSyncMgrHandler(This, clsidHandler,          \
                                                  dwReserved)                  \
  ((This)->lpVtbl->UnregisterSyncMgrHandler(This, clsidHandler, dwReserved))

#define ISyncMgrRegister_GetHandlerRegistrationInfo(This, clsidHandler,        \
                                                    pdwSyncMgrRegisterFlags)   \
  ((This)->lpVtbl->GetHandlerRegistrationInfo(This, clsidHandler,              \
                                              pdwSyncMgrRegisterFlags))
...
class DECLSPEC_UUID("6295DF27-35EE-11d1-8707-00C04FD93327") SyncMgr;
#endif
