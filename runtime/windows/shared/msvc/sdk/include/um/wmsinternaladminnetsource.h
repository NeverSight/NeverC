...
EXTERN_GUID(IID_IWMSInternalAdminNetSource, 0x8BB23E5F, 0xD127, 0x4afb, 0x8D,
            0x02, 0xAE, 0x5B, 0x66, 0xD5, 0x4C, 0x78);
EXTERN_GUID(IID_IWMSInternalAdminNetSource2, 0xE74D58C3, 0xCF77, 0x4b51, 0xAF,
            0x17, 0x74, 0x46, 0x87, 0xC4, 0x3E, 0xAE);
EXTERN_GUID(IID_IWMSInternalAdminNetSource3, 0x6b63d08e, 0x4590, 0x44af, 0x9e,
            0xb3, 0x57, 0xff, 0x1e, 0x73, 0xbf, 0x80);
typedef /* [uuid][public] */ DECLSPEC_UUID(
    "068A6457-4099-4c72-9AA9-"
    "9105C1C03177") enum NETSOURCE_URLCREDPOLICY_SETTINGS {
...
extern RPC_IF_HANDLE
    __MIDL_itf_wmsinternaladminnetsource_0000_0000_v0_0_c_ifspec;
extern RPC_IF_HANDLE
    __MIDL_itf_wmsinternaladminnetsource_0000_0000_v0_0_s_ifspec;
...
typedef struct IWMSInternalAdminNetSourceVtbl {
  ...
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(IWMSInternalAdminNetSource *This,
                                             /* [in] */ REFIID riid,
  ...
  HRESULT(STDMETHODCALLTYPE *SetCredentials)(IWMSInternalAdminNetSource *This,
                                             /* [in] */ BSTR bstrRealm,
                                             /* [in] */ BSTR bstrName,
                                             /* [in] */ BSTR bstrPassword,
                                             /* [in] */ BOOL fPersist,
  ...
  HRESULT(STDMETHODCALLTYPE *GetCredentials)(IWMSInternalAdminNetSource *This,
                                             /* [in] */ BSTR bstrRealm,
                                             /* [out] */ BSTR *pbstrName,
                                             /* [out] */ BSTR *pbstrPassword,
  ...
  HRESULT(STDMETHODCALLTYPE *IsUsingIE)(IWMSInternalAdminNetSource *This,
                                        /* [in] */ DWORD dwProxyContext,
...
#define IWMSInternalAdminNetSource_Initialize(                                 \
    This, pSharedNamespace, pNamespaceNode, pNetSourceCreator,                 \
    fEmbeddedInServer)                                                         \
  ((This)->lpVtbl->Initialize(This, pSharedNamespace, pNamespaceNode,          \
                              pNetSourceCreator, fEmbeddedInServer))

#define IWMSInternalAdminNetSource_GetNetSourceCreator(This,                   \
                                                       ppNetSourceCreator)     \
  ((This)->lpVtbl->GetNetSourceCreator(This, ppNetSourceCreator))

#define IWMSInternalAdminNetSource_SetCredentials(                             \
    This, bstrRealm, bstrName, bstrPassword, fPersist, fConfirmedGood)         \
  ((This)->lpVtbl->SetCredentials(This, bstrRealm, bstrName, bstrPassword,     \
                                  fPersist, fConfirmedGood))

#define IWMSInternalAdminNetSource_GetCredentials(                             \
    This, bstrRealm, pbstrName, pbstrPassword, pfConfirmedGood)                \
  ((This)->lpVtbl->GetCredentials(This, bstrRealm, pbstrName, pbstrPassword,   \
                                  pfConfirmedGood))
...
#define IWMSInternalAdminNetSource_FindProxyForURL(                            \
    This, bstrProtocol, bstrHost, pfProxyEnabled, pbstrProxyServer,            \
    pdwProxyPort, pdwProxyContext)                                             \
  ((This)->lpVtbl->FindProxyForURL(This, bstrProtocol, bstrHost,               \
                                   pfProxyEnabled, pbstrProxyServer,           \
                                   pdwProxyPort, pdwProxyContext))

#define IWMSInternalAdminNetSource_RegisterProxyFailure(This, hrParam,         \
                                                        dwProxyContext)        \
...
#define IWMSInternalAdminNetSource_IsUsingIE(This, dwProxyContext,             \
                                             pfIsUsingIE)                      \
...
typedef struct IWMSInternalAdminNetSource2Vtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(IWMSInternalAdminNetSource2 *This,
                                             /* [in] */ REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);
...
#define IWMSInternalAdminNetSource2_SetCredentialsEx(                          \
    This, bstrRealm, bstrUrl, fProxy, bstrName, bstrPassword, fPersist,        \
    fConfirmedGood)                                                            \
  ((This)->lpVtbl->SetCredentialsEx(This, bstrRealm, bstrUrl, fProxy,          \
                                    bstrName, bstrPassword, fPersist,          \
                                    fConfirmedGood))

#define IWMSInternalAdminNetSource2_GetCredentialsEx(                          \
    This, bstrRealm, bstrUrl, fProxy, pdwUrlPolicy, pbstrName, pbstrPassword,  \
    pfConfirmedGood)                                                           \
  ((This)->lpVtbl->GetCredentialsEx(This, bstrRealm, bstrUrl, fProxy,          \
                                    pdwUrlPolicy, pbstrName, pbstrPassword,    \
                                    pfConfirmedGood))

#define IWMSInternalAdminNetSource2_DeleteCredentialsEx(This, bstrRealm,       \
                                                        bstrUrl, fProxy)       \
  ((This)->lpVtbl->DeleteCredentialsEx(This, bstrRealm, bstrUrl, fProxy))

#define IWMSInternalAdminNetSource2_FindProxyForURLEx(                         \
    This, bstrProtocol, bstrHost, bstrUrl, pfProxyEnabled, pbstrProxyServer,   \
    pdwProxyPort, pdwProxyContext)                                             \
  ((This)->lpVtbl->FindProxyForURLEx(This, bstrProtocol, bstrHost, bstrUrl,    \
                                     pfProxyEnabled, pbstrProxyServer,         \
                                     pdwProxyPort, pdwProxyContext))
...
typedef struct IWMSInternalAdminNetSource3Vtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(IWMSInternalAdminNetSource3 *This,
                                             /* [in] */ REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);
  ...
  HRESULT(STDMETHODCALLTYPE *IsUsingIE2)(IWMSInternalAdminNetSource3 *This,
                                         /* [in] */ QWORD qwProxyContext,
                                         /* [out] */ BOOL *pfIsUsingIE);
...
#define IWMSInternalAdminNetSource3_SetCredentialsEx(                          \
    This, bstrRealm, bstrUrl, fProxy, bstrName, bstrPassword, fPersist,        \
    fConfirmedGood)                                                            \
  ((This)->lpVtbl->SetCredentialsEx(This, bstrRealm, bstrUrl, fProxy,          \
                                    bstrName, bstrPassword, fPersist,          \
...
#define IWMSInternalAdminNetSource3_GetCredentialsEx(                          \
    This, bstrRealm, bstrUrl, fProxy, pdwUrlPolicy, pbstrName, pbstrPassword,  \
    pfConfirmedGood)                                                           \
  ((This)->lpVtbl->GetCredentialsEx(This, bstrRealm, bstrUrl, fProxy,          \
                                    pdwUrlPolicy, pbstrName, pbstrPassword,    \
...
#define IWMSInternalAdminNetSource3_DeleteCredentialsEx(This, bstrRealm,       \
                                                        bstrUrl, fProxy)       \
  ((This)->lpVtbl->DeleteCredentialsEx(This, bstrRealm, bstrUrl, fProxy))

#define IWMSInternalAdminNetSource3_FindProxyForURLEx(                         \
    This, bstrProtocol, bstrHost, bstrUrl, pfProxyEnabled, pbstrProxyServer,   \
    pdwProxyPort, pdwProxyContext)                                             \
  ((This)->lpVtbl->FindProxyForURLEx(This, bstrProtocol, bstrHost, bstrUrl,    \
                                     pfProxyEnabled, pbstrProxyServer,         \
...
#define IWMSInternalAdminNetSource3_GetNetSourceCreator2(This,                 \
                                                         ppNetSourceCreator)   \
  ((This)->lpVtbl->GetNetSourceCreator2(This, ppNetSourceCreator))

#define IWMSInternalAdminNetSource3_FindProxyForURLEx2(                        \
    This, bstrProtocol, bstrHost, bstrUrl, pfProxyEnabled, pbstrProxyServer,   \
    pdwProxyPort, pqwProxyContext)                                             \
  ((This)->lpVtbl->FindProxyForURLEx2(This, bstrProtocol, bstrHost, bstrUrl,   \
                                      pfProxyEnabled, pbstrProxyServer,        \
                                      pdwProxyPort, pqwProxyContext))

#define IWMSInternalAdminNetSource3_RegisterProxyFailure2(This, hrParam,       \
                                                          qwProxyContext)      \
  ((This)->lpVtbl->RegisterProxyFailure2(This, hrParam, qwProxyContext))

#define IWMSInternalAdminNetSource3_ShutdownProxyContext2(This,                \
                                                          qwProxyContext)      \
  ((This)->lpVtbl->ShutdownProxyContext2(This, qwProxyContext))

#define IWMSInternalAdminNetSource3_IsUsingIE2(This, qwProxyContext,           \
                                               pfIsUsingIE)                    \
  ((This)->lpVtbl->IsUsingIE2(This, qwProxyContext, pfIsUsingIE))

#define IWMSInternalAdminNetSource3_SetCredentialsEx2(                         \
    This, bstrRealm, bstrUrl, fProxy, bstrName, bstrPassword, fPersist,        \
    fConfirmedGood, fClearTextAuthentication)                                  \
  ((This)->lpVtbl->SetCredentialsEx2(                                          \
      This, bstrRealm, bstrUrl, fProxy, bstrName, bstrPassword, fPersist,      \
      fConfirmedGood, fClearTextAuthentication))

#define IWMSInternalAdminNetSource3_GetCredentialsEx2(                         \
    This, bstrRealm, bstrUrl, fProxy, fClearTextAuthentication, pdwUrlPolicy,  \
    pbstrName, pbstrPassword, pfConfirmedGood)                                 \
  ((This)->lpVtbl->GetCredentialsEx2(                                          \
      This, bstrRealm, bstrUrl, fProxy, fClearTextAuthentication,              \
      pdwUrlPolicy, pbstrName, pbstrPassword, pfConfirmedGood))
...
extern RPC_IF_HANDLE
    __MIDL_itf_wmsinternaladminnetsource_0000_0003_v0_0_c_ifspec;
extern RPC_IF_HANDLE
    __MIDL_itf_wmsinternaladminnetsource_0000_0003_v0_0_s_ifspec;
