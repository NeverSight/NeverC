...
#if (_WIN32_WINDOWS >= 0x0501 || _WIN32_WINNT >= 0x0501 ||                     \
     (defined(NTDDI_VERSION) && NTDDI_VERSION >= NTDDI_WINXP))
#define MAX_COUNTER_PATH                                                       \
  256 // Maximum counter path length. This is an obsolute constance.

#if (_WIN32_WINDOWS >= 0x0502 || _WIN32_WINNT >= 0x0502 ||                     \
     (defined(NTDDI_VERSION) && NTDDI_VERSION >= NTDDI_WIN2003))
...
PDH_FUNCTION
PdhGetDllVersion(_Out_opt_ LPDWORD lpdwVersion);
...
PDH_FUNCTION
PdhOpenQueryW(_In_opt_ LPCWSTR szDataSource, _In_ DWORD_PTR dwUserData,
              _Out_ PDH_HQUERY *phQuery);

PDH_FUNCTION
PdhOpenQueryA(_In_opt_ LPCSTR szDataSource, _In_ DWORD_PTR dwUserData,
              _Out_ PDH_HQUERY *phQuery);

PDH_FUNCTION
PdhAddCounterW(_In_ PDH_HQUERY hQuery, _In_ LPCWSTR szFullCounterPath,
               _In_ DWORD_PTR dwUserData, _Out_ PDH_HCOUNTER *phCounter);

PDH_FUNCTION
PdhAddCounterA(_In_ PDH_HQUERY hQuery, _In_ LPCSTR szFullCounterPath,
               _In_ DWORD_PTR dwUserData, _Out_ PDH_HCOUNTER *phCounter);

#if (_WIN32_WINDOWS >= 0x0600 || _WIN32_WINNT >= 0x0600 ||                     \
     (defined(NTDDI_VERSION) && NTDDI_VERSION >= NTDDI_VISTA))
PDH_FUNCTION
PdhAddEnglishCounterW(_In_ PDH_HQUERY hQuery, _In_ LPCWSTR szFullCounterPath,
                      _In_ DWORD_PTR dwUserData, _Out_ PDH_HCOUNTER *phCounter);

PDH_FUNCTION
PdhAddEnglishCounterA(_In_ PDH_HQUERY hQuery, _In_ LPCSTR szFullCounterPath,
                      _In_ DWORD_PTR dwUserData, _Out_ PDH_HCOUNTER *phCounter);

PDH_FUNCTION
PdhCollectQueryDataWithTime(_Inout_ PDH_HQUERY hQuery,
                            _Out_ LONGLONG *pllTimeStamp);

PDH_FUNCTION
PdhValidatePathExW(_In_opt_ PDH_HLOG hDataSource,
                   _In_ LPCWSTR szFullPathBuffer);

PDH_FUNCTION
PdhValidatePathExA(_In_opt_ PDH_HLOG hDataSource, _In_ LPCSTR szFullPathBuffer);
#endif

PDH_FUNCTION
PdhRemoveCounter(_In_ PDH_HCOUNTER hCounter);

PDH_FUNCTION
PdhCollectQueryData(_Inout_ PDH_HQUERY hQuery);

PDH_FUNCTION
PdhCloseQuery(_Inout_ PDH_HQUERY hQuery);
...
PDH_FUNCTION
PdhGetFormattedCounterValue(_In_ PDH_HCOUNTER hCounter, _In_ DWORD dwFormat,
                            _Out_opt_ LPDWORD lpdwType,
                            _Out_ PPDH_FMT_COUNTERVALUE pValue);

_Success_(return == ERROR_SUCCESS) PDH_FUNCTION
    PdhGetFormattedCounterArrayA(_In_ PDH_HCOUNTER hCounter,
                                 _In_ DWORD dwFormat,
...
_Success_(return == ERROR_SUCCESS) PDH_FUNCTION
    PdhGetFormattedCounterArrayW(_In_ PDH_HCOUNTER hCounter,
                                 _In_ DWORD dwFormat,
                                 _Inout_ LPDWORD lpdwBufferSize,
                                 _Out_ LPDWORD lpdwItemCount,
                                 _Out_writes_bytes_opt_(*lpdwBufferSize)
...
PDH_FUNCTION
PdhGetRawCounterValue(_In_ PDH_HCOUNTER hCounter, _Out_opt_ LPDWORD lpdwType,
                      _Out_ PPDH_RAW_COUNTER pValue);

_Success_(return == ERROR_SUCCESS) PDH_FUNCTION
    PdhGetRawCounterArrayA(_In_ PDH_HCOUNTER hCounter,
                           _Inout_ LPDWORD lpdwBufferSize,
                           _Out_ LPDWORD lpdwItemCount,
                           _Out_writes_bytes_opt_(*lpdwBufferSize)
...
_Success_(return == ERROR_SUCCESS) PDH_FUNCTION
    PdhGetRawCounterArrayW(_In_ PDH_HCOUNTER hCounter,
                           _Inout_ LPDWORD lpdwBufferSize,
                           _Out_ LPDWORD lpdwItemCount,
                           _Out_writes_bytes_opt_(*lpdwBufferSize)
...
PDH_FUNCTION
PdhCalculateCounterFromRawValue(_In_ PDH_HCOUNTER hCounter, _In_ DWORD dwFormat,
                                _In_ PPDH_RAW_COUNTER rawValue1,
                                _In_ PPDH_RAW_COUNTER rawValue2,
                                _Out_ PPDH_FMT_COUNTERVALUE fmtValue);

PDH_FUNCTION
PdhComputeCounterStatistics(_In_ PDH_HCOUNTER hCounter, _In_ DWORD dwFormat,
                            _In_ DWORD dwFirstEntry, _In_ DWORD dwNumEntries,
                            _In_ PPDH_RAW_COUNTER lpRawValueArray,
                            _Out_ PPDH_STATISTICS data);

_Success_(return == ERROR_SUCCESS) PDH_FUNCTION
    PdhGetCounterInfoW(_In_ PDH_HCOUNTER hCounter,
                       _In_ BOOLEAN bRetrieveExplainText,
                       _Inout_ LPDWORD pdwBufferSize,
                       _Out_writes_bytes_opt_(*pdwBufferSize)
                           PPDH_COUNTER_INFO_W lpBuffer);

_Success_(return == ERROR_SUCCESS) PDH_FUNCTION
    PdhGetCounterInfoA(_In_ PDH_HCOUNTER hCounter,
                       _In_ BOOLEAN bRetrieveExplainText,
                       _Inout_ LPDWORD pdwBufferSize,
                       _Out_writes_bytes_opt_(*pdwBufferSize)
...
PDH_FUNCTION
PdhSetCounterScaleFactor(_Inout_ PDH_HCOUNTER hCounter, _In_ LONG lFactor);
//
//   Browsing and enumeration functions
//
PDH_FUNCTION
PdhConnectMachineW(_In_opt_ LPCWSTR szMachineName);

PDH_FUNCTION
PdhConnectMachineA(_In_opt_ LPCSTR szMachineName);

PDH_FUNCTION
PdhEnumMachinesW(_In_opt_ LPCWSTR szDataSource,
                 _Out_writes_opt_(*pcchBufferSize) PZZWSTR mszMachineList,
                 _Inout_ LPDWORD pcchBufferSize);

PDH_FUNCTION
PdhEnumMachinesA(_In_opt_ LPCSTR szDataSource,
                 _Out_writes_opt_(*pcchBufferSize) PZZSTR mszMachineList,
                 _Inout_ LPDWORD pcchBufferSize);

PDH_FUNCTION
PdhEnumObjectsW(_In_opt_ LPCWSTR szDataSource, _In_opt_ LPCWSTR szMachineName,
                _Out_writes_opt_(*pcchBufferSize) PZZWSTR mszObjectList,
                _Inout_ LPDWORD pcchBufferSize, _In_ DWORD dwDetailLevel,
                _In_ BOOL bRefresh);

PDH_FUNCTION
PdhEnumObjectsA(_In_opt_ LPCSTR szDataSource, _In_opt_ LPCSTR szMachineName,
                _Out_writes_opt_(*pcchBufferSize) PZZSTR mszObjectList,
                _Inout_ LPDWORD pcchBufferSize, _In_ DWORD dwDetailLevel,
                _In_ BOOL bRefresh);

PDH_FUNCTION
PdhEnumObjectItemsW(_In_opt_ LPCWSTR szDataSource,
                    _In_opt_ LPCWSTR szMachineName, _In_ LPCWSTR szObjectName,
                    _Out_writes_opt_(*pcchCounterListLength)
                        PZZWSTR mszCounterList,
                    _Inout_ LPDWORD pcchCounterListLength,
                    _Out_writes_opt_(*pcchInstanceListLength)
                        PZZWSTR mszInstanceList,
                    _Inout_ LPDWORD pcchInstanceListLength,
                    _In_ DWORD dwDetailLevel, _In_ DWORD dwFlags);

PDH_FUNCTION
PdhEnumObjectItemsA(_In_opt_ LPCSTR szDataSource, _In_opt_ LPCSTR szMachineName,
...
PDH_FUNCTION
PdhMakeCounterPathW(_In_ PPDH_COUNTER_PATH_ELEMENTS_W pCounterPathElements,
                    _Out_writes_opt_(*pcchBufferSize) LPWSTR szFullPathBuffer,
                    _Inout_ LPDWORD pcchBufferSize, _In_ DWORD dwFlags);

PDH_FUNCTION
PdhMakeCounterPathA(_In_ PPDH_COUNTER_PATH_ELEMENTS_A pCounterPathElements,
                    _Out_writes_opt_(*pcchBufferSize) LPSTR szFullPathBuffer,
                    _Inout_ LPDWORD pcchBufferSize, _In_ DWORD dwFlags);

_Success_(return == ERROR_SUCCESS) PDH_FUNCTION
    PdhParseCounterPathW(_In_ LPCWSTR szFullPathBuffer,
                         _Out_writes_bytes_opt_(*pdwBufferSize)
                             PPDH_COUNTER_PATH_ELEMENTS_W pCounterPathElements,
                         _Inout_ LPDWORD pdwBufferSize, _In_ DWORD dwFlags);

_Success_(return == ERROR_SUCCESS) PDH_FUNCTION
    PdhParseCounterPathA(_In_ LPCSTR szFullPathBuffer,
                         _Out_writes_bytes_opt_(*pdwBufferSize)
...
PDH_FUNCTION
PdhParseInstanceNameW(_In_ LPCWSTR szInstanceString,
                      _Out_writes_opt_(*pcchInstanceNameLength)
                          LPWSTR szInstanceName,
                      _Inout_ LPDWORD pcchInstanceNameLength,
                      _Out_writes_opt_(*pcchParentNameLength)
                          LPWSTR szParentName,
                      _Inout_ LPDWORD pcchParentNameLength,
                      _Out_ LPDWORD lpIndex);

PDH_FUNCTION
PdhParseInstanceNameA(_In_ LPCSTR szInstanceString,
                      _Out_writes_opt_(*pcchInstanceNameLength)
                          LPSTR szInstanceName,
                      _Inout_ LPDWORD pcchInstanceNameLength,
                      _Out_writes_opt_(*pcchParentNameLength)
...
PDH_FUNCTION
PdhValidatePathW(_In_ LPCWSTR szFullPathBuffer);

PDH_FUNCTION
PdhValidatePathA(_In_ LPCSTR szFullPathBuffer);

PDH_FUNCTION
PdhGetDefaultPerfObjectW(_In_opt_ LPCWSTR szDataSource,
                         _In_opt_ LPCWSTR szMachineName,
                         _Out_writes_opt_(*pcchBufferSize)
                             LPWSTR szDefaultObjectName,
                         _Inout_ LPDWORD pcchBufferSize);

PDH_FUNCTION
PdhGetDefaultPerfObjectA(_In_opt_ LPCSTR szDataSource,
...
PDH_FUNCTION
PdhGetDefaultPerfCounterW(_In_opt_ LPCWSTR szDataSource,
                          _In_opt_ LPCWSTR szMachineName,
...
PDH_FUNCTION
PdhGetDefaultPerfCounterA(_In_opt_ LPCSTR szDataSource,
                          _In_opt_ LPCSTR szMachineName,
                          _In_ LPCSTR szObjectName,
                          _Out_writes_opt_(*pcchBufferSize)
...
typedef struct _BrowseDlgConfig_W {
  ...
  DWORD bIncludeInstanceIndex : 1, bSingleCounterPerAdd : 1,
      bSingleCounterPerDialog : 1, bLocalCountersOnly : 1,
      bWildCardInstances : 1, bHideDetailBox : 1, bInitializePath : 1,
      bDisableMachineSelection : 1, bIncludeCostlyObjects : 1, bReserved : 23;
...
PDH_FUNCTION
PdhBrowseCountersW(_In_ PPDH_BROWSE_DLG_CONFIG_W pBrowseDlgData);

PDH_FUNCTION
PdhBrowseCountersA(_In_ PPDH_BROWSE_DLG_CONFIG_A pBrowseDlgData);

PDH_FUNCTION
PdhExpandCounterPathW(_In_ LPCWSTR szWildCardPath,
                      _Out_writes_opt_(*pcchPathListLength)
                          PZZWSTR mszExpandedPathList,
                      _Inout_ LPDWORD pcchPathListLength);

PDH_FUNCTION
PdhExpandCounterPathA(_In_ LPCSTR szWildCardPath,
                      _Out_writes_opt_(*pcchPathListLength)
...
//
PDH_FUNCTION
PdhLookupPerfNameByIndexW(_In_opt_ LPCWSTR szMachineName,
                          _In_ DWORD dwNameIndex,
                          _Out_writes_opt_(*pcchNameBufferSize)
                              LPWSTR szNameBuffer,
                          _Inout_ LPDWORD pcchNameBufferSize);

PDH_FUNCTION
PdhLookupPerfNameByIndexA(_In_opt_ LPCSTR szMachineName, _In_ DWORD dwNameIndex,
                          _Out_writes_opt_(*pcchNameBufferSize)
                              LPSTR szNameBuffer,
                          _Inout_ LPDWORD pcchNameBufferSize);

PDH_FUNCTION
PdhLookupPerfIndexByNameW(_In_opt_ LPCWSTR szMachineName,
                          _In_ LPCWSTR szNameBuffer, _Out_ LPDWORD pdwIndex);

PDH_FUNCTION
PdhLookupPerfIndexByNameA(_In_opt_ LPCSTR szMachineName,
                          _In_ LPCSTR szNameBuffer, _Out_ LPDWORD pdwIndex);
...
PDH_FUNCTION
PdhExpandWildCardPathA(_In_opt_ LPCSTR szDataSource, _In_ LPCSTR szWildCardPath,
                       _Out_writes_opt_(*pcchPathListLength)
                           PZZSTR mszExpandedPathList,
                       _Inout_ LPDWORD pcchPathListLength, _In_ DWORD dwFlags);

PDH_FUNCTION
PdhExpandWildCardPathW(_In_opt_ LPCWSTR szDataSource,
...
PDH_FUNCTION
PdhOpenLogW(_In_ LPCWSTR szLogFileName, _In_ DWORD dwAccessFlags,
            _Inout_ LPDWORD lpdwLogType, _In_opt_ PDH_HQUERY hQuery,
            _In_ DWORD dwMaxSize, _In_opt_ LPCWSTR szUserCaption,
            _Out_ PDH_HLOG *phLog);

PDH_FUNCTION
PdhOpenLogA(_In_ LPCSTR szLogFileName, _In_ DWORD dwAccessFlags,
            _Inout_ LPDWORD lpdwLogType, _In_opt_ PDH_HQUERY hQuery,
            _In_ DWORD dwMaxSize, _In_opt_ LPCSTR szUserCaption,
            _Out_ PDH_HLOG *phLog);

PDH_FUNCTION
PdhUpdateLogW(_In_ PDH_HLOG hLog, _In_opt_ LPCWSTR szUserString);

PDH_FUNCTION
PdhUpdateLogA(_In_ PDH_HLOG hLog, _In_opt_ LPCSTR szUserString);

PDH_FUNCTION
PdhUpdateLogFileCatalog(_In_ PDH_HLOG hLog);

PDH_FUNCTION
PdhGetLogFileSize(_In_ PDH_HLOG hLog, _Out_ LONGLONG *llSize);

PDH_FUNCTION
PdhCloseLog(_In_ PDH_HLOG hLog, _In_ DWORD dwFlags);
...
PDH_FUNCTION
PdhSelectDataSourceW(_In_ HWND hWndOwner, _In_ DWORD dwFlags,
                     _Inout_updates_(*pcchBufferLength) LPWSTR szDataSource,
                     _Inout_ LPDWORD pcchBufferLength);

PDH_FUNCTION
PdhSelectDataSourceA(_In_ HWND hWndOwner, _In_ DWORD dwFlags,
                     _Inout_updates_(*pcchBufferLength) LPSTR szDataSource,
                     _Inout_ LPDWORD pcchBufferLength);

BOOL __stdcall PdhIsRealTimeQuery(_In_ PDH_HQUERY hQuery);

PDH_FUNCTION
PdhSetQueryTimeRange(_In_ PDH_HQUERY hQuery, _In_ PPDH_TIME_INFO pInfo);

_Success_(return == ERROR_SUCCESS) PDH_FUNCTION
    PdhGetDataSourceTimeRangeW(_In_opt_ LPCWSTR szDataSource,
                               _Out_ LPDWORD pdwNumEntries,
                               _Out_writes_bytes_(*pdwBufferSize)
                                   PPDH_TIME_INFO pInfo,
                               _Inout_ LPDWORD pdwBufferSize);

_Success_(return == ERROR_SUCCESS) PDH_FUNCTION
    PdhGetDataSourceTimeRangeA(_In_opt_ LPCSTR szDataSource,
                               _Out_ LPDWORD pdwNumEntries,
                               _Out_writes_bytes_(*pdwBufferSize)
                                   PPDH_TIME_INFO pInfo,
                               _Inout_ LPDWORD pdwBufferSize);
...
PDH_FUNCTION
PdhCollectQueryDataEx(_In_ PDH_HQUERY hQuery, _In_ DWORD dwIntervalTime,
                      _In_ HANDLE hNewDataEvent);

PDH_FUNCTION
PdhFormatFromRawValue(_In_ DWORD dwCounterType, _In_ DWORD dwFormat,
...
PDH_FUNCTION
PdhGetCounterTimeBase(_In_ PDH_HCOUNTER hCounter, _Out_ LONGLONG *pTimeBase);

_Success_(return == ERROR_SUCCESS) PDH_FUNCTION
    PdhReadRawLogRecord(_In_ PDH_HLOG hLog, _In_ FILETIME ftRecord,
                        _Out_writes_bytes_opt_(*pdwBufferLength)
...
PDH_FUNCTION
PdhSetDefaultRealTimeDataSource(_In_ DWORD dwDataSourceId);
...
//
PDH_FUNCTION
PdhBindInputDataSourceW(_Out_ PDH_HLOG *phDataSource,
                        _In_opt_ LPCWSTR LogFileNameList);

PDH_FUNCTION
PdhBindInputDataSourceA(_Out_ PDH_HLOG *phDataSource,
                        _In_opt_ LPCSTR LogFileNameList);

PDH_FUNCTION
PdhOpenQueryH(_In_opt_ PDH_HLOG hDataSource, _In_ DWORD_PTR dwUserData,
              _Out_ PDH_HQUERY *phQuery);

PDH_FUNCTION
PdhEnumMachinesHW(_In_opt_ PDH_HLOG hDataSource,
                  _Out_writes_opt_(*pcchBufferSize) PZZWSTR mszMachineList,
                  _Inout_ LPDWORD pcchBufferSize);

PDH_FUNCTION
PdhEnumMachinesHA(_In_opt_ PDH_HLOG hDataSource,
                  _Out_writes_opt_(*pcchBufferSize) PZZSTR mszMachineList,
                  _Inout_ LPDWORD pcchBufferSize);

PDH_FUNCTION
PdhEnumObjectsHW(_In_opt_ PDH_HLOG hDataSource, _In_opt_ LPCWSTR szMachineName,
                 _Out_writes_opt_(*pcchBufferSize) PZZWSTR mszObjectList,
                 _Inout_ LPDWORD pcchBufferSize, _In_ DWORD dwDetailLevel,
                 _In_ BOOL bRefresh);

PDH_FUNCTION
PdhEnumObjectsHA(_In_opt_ PDH_HLOG hDataSource, _In_opt_ LPCSTR szMachineName,
                 _Out_writes_opt_(*pcchBufferSize) PZZSTR mszObjectList,
                 _Inout_ LPDWORD pcchBufferSize, _In_ DWORD dwDetailLevel,
                 _In_ BOOL bRefresh);

PDH_FUNCTION
PdhEnumObjectItemsHW(_In_opt_ PDH_HLOG hDataSource,
                     _In_opt_ LPCWSTR szMachineName, _In_ LPCWSTR szObjectName,
                     _Out_writes_opt_(*pcchCounterListLength)
                         PZZWSTR mszCounterList,
                     _Inout_ LPDWORD pcchCounterListLength,
...
PDH_FUNCTION
PdhEnumObjectItemsHA(_In_opt_ PDH_HLOG hDataSource,
                     _In_opt_ LPCSTR szMachineName, _In_ LPCSTR szObjectName,
                     _Out_writes_opt_(*pcchCounterListLength)
                         PZZSTR mszCounterList,
                     _Inout_ LPDWORD pcchCounterListLength,
                     _Out_writes_opt_(*pcchInstanceListLength)
...
PDH_FUNCTION
PdhExpandWildCardPathHW(_In_opt_ PDH_HLOG hDataSource,
                        _In_ LPCWSTR szWildCardPath,
                        _Out_writes_opt_(*pcchPathListLength)
                            PZZWSTR mszExpandedPathList,
                        _Inout_ LPDWORD pcchPathListLength, _In_ DWORD dwFlags);
...
PDH_FUNCTION
PdhExpandWildCardPathHA(_In_opt_ PDH_HLOG hDataSource,
...
_Success_(return == ERROR_SUCCESS) PDH_FUNCTION
    PdhGetDataSourceTimeRangeH(_Inout_opt_ PDH_HLOG hDataSource,
                               _Out_ LPDWORD pdwNumEntries,
                               _Out_writes_bytes_(*pdwBufferSize)
                                   PPDH_TIME_INFO pInfo,
                               _Inout_ LPDWORD pdwBufferSize);
...
PDH_FUNCTION
PdhGetDefaultPerfObjectHW(_In_opt_ PDH_HLOG hDataSource,
                          _In_opt_ LPCWSTR szMachineName,
                          _Out_writes_opt_(*pcchBufferSize)
                              LPWSTR szDefaultObjectName,
                          _Inout_ LPDWORD pcchBufferSize);
...
PDH_FUNCTION
PdhGetDefaultPerfObjectHA(_In_opt_ PDH_HLOG hDataSource,
                          _In_opt_ LPCSTR szMachineName,
                          _Out_writes_opt_(*pcchBufferSize)
                              LPSTR szDefaultObjectName,
                          _Inout_ LPDWORD pcchBufferSize);
...
PDH_FUNCTION
PdhGetDefaultPerfCounterHW(_In_opt_ PDH_HLOG hDataSource,
                           _In_opt_ LPCWSTR szMachineName,
                           _In_ LPCWSTR szObjectName,
                           _Out_writes_opt_(*pcchBufferSize)
                               LPWSTR szDefaultCounterName,
...
PDH_FUNCTION
PdhGetDefaultPerfCounterHA(_In_opt_ PDH_HLOG hDataSource,
                           _In_opt_ LPCSTR szMachineName,
                           _In_ LPCSTR szObjectName,
                           _Out_writes_opt_(*pcchBufferSize)
                               LPSTR szDefaultCounterName,
...
PDH_FUNCTION
PdhBrowseCountersHW(_In_ PPDH_BROWSE_DLG_CONFIG_HW pBrowseDlgData);

PDH_FUNCTION
PdhBrowseCountersHA(_In_ PPDH_BROWSE_DLG_CONFIG_HA pBrowseDlgData);

// Check that a DSN points to a database that contains the correct Perfmon
// tables.
PDH_FUNCTION
PdhVerifySQLDBW(_In_ LPCWSTR szDataSource);

PDH_FUNCTION
PdhVerifySQLDBA(_In_ LPCSTR szDataSource);

// Create the correct perfmon tables in the database pointed to by a DSN.
PDH_FUNCTION
PdhCreateSQLTablesW(_In_ LPCWSTR szDataSource);

PDH_FUNCTION
PdhCreateSQLTablesA(_In_ LPCSTR szDataSource);

// Return the list of Log set names in the database pointed to by the DSN.
PDH_FUNCTION
PdhEnumLogSetNamesW(_In_ LPCWSTR szDataSource,
                    _Out_writes_opt_(*pcchBufferLength)
                        PZZWSTR mszDataSetNameList,
                    _Inout_ LPDWORD pcchBufferLength);

PDH_FUNCTION
PdhEnumLogSetNamesA(_In_ LPCSTR szDataSource,
                    _Out_writes_opt_(*pcchBufferLength)
...
PDH_FUNCTION
PdhGetLogSetGUID(_In_ PDH_HLOG hLog, _Out_opt_ GUID *pGuid,
                 _Out_opt_ int *pRunId);

// Set the RunID for an open Log Set
PDH_FUNCTION
PdhSetLogSetRunID(_Inout_ PDH_HLOG hLog, _In_ int RunId);
#endif
...
#if (_WIN32_WINDOWS >= 0x0600 || _WINNT_WINNT >= 0x0600 ||                     \
     (defined(NTDDI_VERSION) && NTDDI_VERSION >= NTDDI_VISTA))
