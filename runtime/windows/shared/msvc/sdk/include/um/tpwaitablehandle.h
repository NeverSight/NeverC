...
typedef struct ISignalableNotifierVtbl {
  ...
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in ISignalableNotifier *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in ISignalableNotifier *This);
...
#define ISignalableNotifier_AttachToWaitHandle(                                \
    This, waitableHandle, handler, pUnkOuter, riid, SignalNotifier)            \
  ((This)->lpVtbl->AttachToWaitHandle(This, waitableHandle, handler,           \
                                      pUnkOuter, riid, SignalNotifier))

#define ISignalableNotifier_AttachToWaitHandleWithTimeout(                     \
    This, waitableHandle, handler, timeout, pUnkOuter, riid, SignalNotifier)   \
  ((This)->lpVtbl->AttachToWaitHandleWithTimeout(This, waitableHandle,         \
                                                 handler, timeout, pUnkOuter,  \
                                                 riid, SignalNotifier))
