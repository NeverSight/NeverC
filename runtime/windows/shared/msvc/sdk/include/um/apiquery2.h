...
APICONTRACT
BOOL APIENTRY IsApiSetImplemented(_In_ PCSTR Contract);

APICONTRACT
HRESULT
APIENTRY
GetApiSetModuleBaseName(_In_ PCSTR contractName, _In_ UINT32 bufferLength,
                        _Out_writes_to_(bufferLength, *actualNameLength)
