...
enum __MIDL___MIDL_itf_amstream_0000_0000_0001 { AMMSF_NOGRAPHTHREAD = 0x1 };
...
typedef struct IAMMultiMediaStreamVtbl {
  ...
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IAMMultiMediaStream *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IAMMultiMediaStream *This);
  ...
  HRESULT(STDMETHODCALLTYPE *SetState)(__RPC__in IAMMultiMediaStream *This,
  ...
  HRESULT(STDMETHODCALLTYPE *Seek)(__RPC__in IAMMultiMediaStream *This,
  ...
  HRESULT(STDMETHODCALLTYPE *OpenFile)(__RPC__in IAMMultiMediaStream *This,
                                       /* [in] */ __RPC__in LPCWSTR pszFileName,
                                       /* [in] */ DWORD dwFlags);
  ...
  HRESULT(STDMETHODCALLTYPE *Render)(__RPC__in IAMMultiMediaStream *This,
                                     /* [in] */ DWORD dwFlags);
...
typedef struct IAMMediaStreamVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in IAMMediaStream *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IAMMediaStream *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IAMMediaStream *This);
  ...
  HRESULT(STDMETHODCALLTYPE *SendEndOfStream)(__RPC__in IAMMediaStream *This,
                                              DWORD dwFlags);
  ...
  HRESULT(STDMETHODCALLTYPE *SetState)(__RPC__in IAMMediaStream *This,
...
typedef struct IAMMediaTypeSampleVtbl {
  ...
  HRESULT(STDMETHODCALLTYPE *SetActualDataLength)(
      IAMMediaTypeSample *This, long __MIDL__IAMMediaTypeSample0000);
...
#define IAMMediaTypeSample_SetActualDataLength(This,                           \
...
DEFINE_GUID(CLSID_AMMultiMediaStream, /* 49c47ce5-9ba4-11d0-8212-00c04fc32c45 */
            0x49c47ce5, 0x9ba4, 0x11d0, 0x82, 0x12, 0x00, 0xc0, 0x4f, 0xc3,
            0x2c, 0x45);
