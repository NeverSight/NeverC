...
typedef interface IPresentationFactory_SupportHdrAware
    IPresentationFactory_SupportHdrAware;
...
typedef interface IPresentStatusPresentStatistics
...
typedef interface ICompositionFramePresentStatistics
...
typedef interface IIndependentFlipFramePresentStatistics
...
typedef struct IPresentationBufferVtbl {
  ...
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(IPresentationBuffer *This,
                                             /* [in] */ REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(IPresentationBuffer *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(IPresentationBuffer *This);
...
#define IPresentationBuffer_AddRef(This) ((This)->lpVtbl->AddRef(This))

#define IPresentationBuffer_Release(This) ((This)->lpVtbl->Release(This))
...
typedef struct IPresentationContentVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(IPresentationContent *This,
                                             /* [in] */ REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(IPresentationContent *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(IPresentationContent *This);

  DECLSPEC_XFGVIRT(IPresentationContent, SetTag)
  void(STDMETHODCALLTYPE *SetTag)(IPresentationContent *This,
                                  /* [in] */ UINT_PTR tag);
...
#define IPresentationContent_AddRef(This) ((This)->lpVtbl->AddRef(This))

#define IPresentationContent_Release(This) ((This)->lpVtbl->Release(This))
...
typedef struct IPresentationSurfaceVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(IPresentationSurface *This,
                                             /* [in] */ REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(IPresentationSurface *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(IPresentationSurface *This);

  DECLSPEC_XFGVIRT(IPresentationContent, SetTag)
  void(STDMETHODCALLTYPE *SetTag)(IPresentationSurface *This,
                                  /* [in] */ UINT_PTR tag);
  ...
  HRESULT(STDMETHODCALLTYPE *SetSourceRect)(IPresentationSurface *This,
  ...
  HRESULT(STDMETHODCALLTYPE *RestrictToOutput)(IPresentationSurface *This,
                                               /* [in] */ IUnknown *output);

  DECLSPEC_XFGVIRT(IPresentationSurface, SetDisableReadback)
  HRESULT(STDMETHODCALLTYPE *SetDisableReadback)(IPresentationSurface *This,
                                                 /* [in] */ boolean value);
...
#define IPresentationSurface_AddRef(This) ((This)->lpVtbl->AddRef(This))

#define IPresentationSurface_Release(This) ((This)->lpVtbl->Release(This))
...
#define IPresentationSurface_SetLetterboxingMargins(                           \
    This, leftLetterboxSize, topLetterboxSize, rightLetterboxSize,             \
    bottomLetterboxSize)                                                       \
  ((This)->lpVtbl->SetLetterboxingMargins(                                     \
      This, leftLetterboxSize, topLetterboxSize, rightLetterboxSize,           \
      bottomLetterboxSize))
...
typedef struct IPresentationSurface2Vtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(IPresentationSurface2 *This,
                                             /* [in] */ REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(IPresentationSurface2 *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(IPresentationSurface2 *This);

  DECLSPEC_XFGVIRT(IPresentationContent, SetTag)
  void(STDMETHODCALLTYPE *SetTag)(IPresentationSurface2 *This,
                                  /* [in] */ UINT_PTR tag);
  ...
  DECLSPEC_XFGVIRT(IPresentationSurface, SetSourceRect)
  HRESULT(STDMETHODCALLTYPE *SetSourceRect)(IPresentationSurface2 *This,
                                            /* [in] */ const RECT *sourceRect);
  ...
  DECLSPEC_XFGVIRT(IPresentationSurface, RestrictToOutput)
  HRESULT(STDMETHODCALLTYPE *RestrictToOutput)(IPresentationSurface2 *This,
                                               /* [in] */ IUnknown *output);

  DECLSPEC_XFGVIRT(IPresentationSurface, SetDisableReadback)
  HRESULT(STDMETHODCALLTYPE *SetDisableReadback)(IPresentationSurface2 *This,
                                                 /* [in] */ boolean value);
  ...
  void(STDMETHODCALLTYPE *SetIsHdrContent)(IPresentationSurface2 *This,
...
#define IPresentationSurface2_AddRef(This) ((This)->lpVtbl->AddRef(This))

#define IPresentationSurface2_Release(This) ((This)->lpVtbl->Release(This))
...
#define IPresentationSurface2_SetLetterboxingMargins(                          \
    This, leftLetterboxSize, topLetterboxSize, rightLetterboxSize,             \
    bottomLetterboxSize)                                                       \
  ((This)->lpVtbl->SetLetterboxingMargins(                                     \
      This, leftLetterboxSize, topLetterboxSize, rightLetterboxSize,           \
...
typedef struct IPresentStatisticsVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(IPresentStatistics *This,
                                             /* [in] */ REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(IPresentStatistics *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(IPresentStatistics *This);

  DECLSPEC_XFGVIRT(IPresentStatistics, GetPresentId)
  UINT64(STDMETHODCALLTYPE *GetPresentId)(IPresentStatistics *This);

  DECLSPEC_XFGVIRT(IPresentStatistics, GetKind)
  PresentStatisticsKind(STDMETHODCALLTYPE *GetKind)(IPresentStatistics *This);
...
#define IPresentStatistics_AddRef(This) ((This)->lpVtbl->AddRef(This))

#define IPresentStatistics_Release(This) ((This)->lpVtbl->Release(This))

#define IPresentStatistics_GetPresentId(This)                                  \
  ((This)->lpVtbl->GetPresentId(This))

#define IPresentStatistics_GetKind(This) ((This)->lpVtbl->GetKind(This))
...
typedef struct IPresentationManagerVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(IPresentationManager *This,
                                             /* [in] */ REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(IPresentationManager *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(IPresentationManager *This);
  ...
  UINT64(STDMETHODCALLTYPE *GetNextPresentId)(IPresentationManager *This);
  ...
  HRESULT(STDMETHODCALLTYPE *Present)(IPresentationManager *This);
...
#define IPresentationManager_AddRef(This) ((This)->lpVtbl->AddRef(This))

#define IPresentationManager_Release(This) ((This)->lpVtbl->Release(This))

#define IPresentationManager_AddBufferFromResource(This, resource,             \
                                                   presentationBuffer)         \
  ((This)->lpVtbl->AddBufferFromResource(This, resource, presentationBuffer))

#define IPresentationManager_CreatePresentationSurface(                        \
    This, compositionSurfaceHandle, presentationSurface)                       \
  ((This)->lpVtbl->CreatePresentationSurface(This, compositionSurfaceHandle,   \
                                             presentationSurface))
...
#define IPresentationManager_SetPreferredPresentDuration(                      \
    This, preferredDuration, deviationTolerance)                               \
  ((This)->lpVtbl->SetPreferredPresentDuration(This, preferredDuration,        \
                                               deviationTolerance))
...
#define IPresentationManager_Present(This) ((This)->lpVtbl->Present(This))
...
#define IPresentationManager_GetPresentStatisticsAvailableEvent(               \
    This, presentStatisticsAvailableEventHandle)                               \
  ((This)->lpVtbl->GetPresentStatisticsAvailableEvent(                         \
      This, presentStatisticsAvailableEventHandle))

#define IPresentationManager_EnablePresentStatisticsKind(                      \
    This, presentStatisticsKind, enabled)                                      \
  ((This)->lpVtbl->EnablePresentStatisticsKind(This, presentStatisticsKind,    \
                                               enabled))

#define IPresentationManager_GetNextPresentStatistics(This,                    \
...
public:
  ...
  virtual boolean STDMETHODCALLTYPE IsPresentationSupportedWithIndependentFlip(
      void) = 0;
...
typedef struct IPresentationFactoryVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(IPresentationFactory *This,
                                             /* [in] */ REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(IPresentationFactory *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(IPresentationFactory *This);
  ...
  DECLSPEC_XFGVIRT(IPresentationFactory,
...
#define IPresentationFactory_AddRef(This) ((This)->lpVtbl->AddRef(This))

#define IPresentationFactory_Release(This) ((This)->lpVtbl->Release(This))
...
#define IPresentationFactory_CreatePresentationManager(This,                   \
...
IPresentationFactory_SupportHdrAware : public IUnknown{public : };
...
typedef struct IPresentationFactory_SupportHdrAwareVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(IPresentationFactory_SupportHdrAware *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(IPresentationFactory_SupportHdrAware *This);
...
#define IPresentationFactory_SupportHdrAware_QueryInterface(This, riid,        \
                                                            ppvObject)         \
  ((This)->lpVtbl->QueryInterface(This, riid, ppvObject))
...
typedef struct IPresentStatusPresentStatisticsVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(IPresentStatusPresentStatistics *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(IPresentStatusPresentStatistics *This);
...
typedef struct ICompositionFramePresentStatisticsVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(ICompositionFramePresentStatistics *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(ICompositionFramePresentStatistics *This);
...
#define ICompositionFramePresentStatistics_QueryInterface(This, riid,          \
                                                          ppvObject)           \
  ((This)->lpVtbl->QueryInterface(This, riid, ppvObject))
...
#define ICompositionFramePresentStatistics_GetDisplayInstanceArray(            \
    This, displayInstanceArrayCount, displayInstanceArray)                     \
  ((This)->lpVtbl->GetDisplayInstanceArray(This, displayInstanceArrayCount,    \
...
typedef struct IIndependentFlipFramePresentStatisticsVtbl {
  ...
  DECLSPEC_XFGVIRT(IIndependentFlipFramePresentStatistics,
...
#define IIndependentFlipFramePresentStatistics_QueryInterface(This, riid,      \
                                                              ppvObject)       \
  ((This)->lpVtbl->QueryInterface(This, riid, ppvObject))
...
SystemInterruptTime STDMETHODCALLTYPE
...
//
STDAPI CreatePresentationFactory(_In_ IUnknown *d3dDevice, _In_ REFIID riid,
