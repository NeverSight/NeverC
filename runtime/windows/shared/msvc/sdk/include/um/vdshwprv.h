...
typedef struct IVdsProviderPrivateVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IVdsProviderPrivate *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IVdsProviderPrivate *This);
...
typedef struct IVdsHwProviderPrivateVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IVdsHwProviderPrivate *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IVdsHwProviderPrivate *This);
...
#define IVdsHwProviderPrivate_QueryIfCreatedLun(This, pwszDevicePath,          \
                                                pVdsLunInformation, pLunId)    \
  ((This)->lpVtbl->QueryIfCreatedLun(This, pwszDevicePath, pVdsLunInformation, \
                                     pLunId))
...
typedef struct IVdsHwProviderPrivateMpioVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IVdsHwProviderPrivateMpio *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IVdsHwProviderPrivateMpio *This);
...
#define IVdsHwProviderPrivateMpio_SetAllPathStatusesFromHbaPort(               \
    This, hbaPortProp, status)                                                 \
...
public:
  virtual /* [helpstring] */ HRESULT STDMETHODCALLTYPE RegisterProvider(
      ...
      /* [disable_consistency_check][string][max_is][unique][in] */
...
typedef struct IVdsAdminVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in IVdsAdmin *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IVdsAdmin *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IVdsAdmin *This);
...
interface IVdsAdmin { CONST_VTBL struct IVdsAdminVtbl *lpVtbl; };
...
#define IVdsAdmin_RegisterProvider(This, providerId, providerClsid, pwszName,  \
                                   type, pwszMachineName, pwszVersion,         \
                                   guidVersionId)                              \
  ((This)->lpVtbl->RegisterProvider(This, providerId, providerClsid, pwszName, \
                                    type, pwszMachineName, pwszVersion,        \
                                    guidVersionId))
