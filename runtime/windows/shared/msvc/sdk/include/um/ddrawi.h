...
DEFINE_GUID(GUID_VideoPortCallbacks, 0xefd60cc1, 0x49e7, 0x11d0, 0x88, 0x9d,
            0x00, 0xaa, 0x00, 0xbb, 0xb7, 0x6a);
DEFINE_GUID(GUID_ColorControlCallbacks, 0xefd60cc2, 0x49e7, 0x11d0, 0x88, 0x9d,
            0x00, 0xaa, 0x00, 0xbb, 0xb7, 0x6a);
DEFINE_GUID(GUID_VideoPortCaps, 0xefd60cc3, 0x49e7, 0x11d0, 0x88, 0x9d, 0x00,
...
DEFINE_GUID(GUID_KernelCallbacks, 0x80863800, 0x6B06, 0x11D0, 0x9B, 0x06, 0x0,
            0xA0, 0xC9, 0x03, 0xA3, 0xB8);
DEFINE_GUID(GUID_KernelCaps, 0xFFAA7540, 0x7AA8, 0x11D0, 0x9B, 0x06, 0x00, 0xA0,
            0xC9, 0x03, 0xA3, 0xB8);
DEFINE_GUID(GUID_D3DExtendedCaps, 0x7de41f80, 0x9d93, 0x11d0, 0x89, 0xab, 0x0,
            0xa0, 0xc9, 0x5, 0x41, 0x29);
DEFINE_GUID(GUID_ZPixelFormats, 0x93869880, 0x36cf, 0x11d1, 0x9b, 0x1b, 0x0,
            0xaa, 0x0, 0xbb, 0xb8, 0xae);
DEFINE_GUID(GUID_DDMoreSurfaceCaps, 0x3b8a0466, 0xf269, 0x11d1, 0x88, 0x0b, 0x0,
            0xc0, 0x4f, 0xd9, 0x30, 0xc5);
DEFINE_GUID(GUID_DDStereoMode, 0xf828169c, 0xa8e8, 0x11d2, 0xa1, 0xf2, 0x0,
            0xa0, 0xc9, 0x83, 0xea, 0xf6);
DEFINE_GUID(GUID_OptSurfaceKmodeInfo, 0xe05c8472, 0x51d4, 0x11d1, 0x8c, 0xce,
            0x0, 0xa0, 0xc9, 0x6, 0x29, 0xa8);
DEFINE_GUID(GUID_OptSurfaceUmodeInfo, 0x9d792804, 0x5fa8, 0x11d1, 0x8c, 0xd0,
            0x0, 0xa0, 0xc9, 0x6, 0x29, 0xa8);
DEFINE_GUID(GUID_UserModeDriverInfo, 0xf0b0e8e2, 0x5f97, 0x11d1, 0x8c, 0xd0,
            0x0, 0xa0, 0xc9, 0x6, 0x29, 0xa8);
DEFINE_GUID(GUID_UserModeDriverPassword, 0x97f861b6, 0x60a1, 0x11d1, 0x8c, 0xd0,
            0x0, 0xa0, 0xc9, 0x6, 0x29, 0xa8);
DEFINE_GUID(GUID_D3DParseUnknownCommandCallback, 0x2e04ffa0, 0x98e4, 0x11d1,
            0x8c, 0xe1, 0x0, 0xa0, 0xc9, 0x6, 0x29, 0xa8);
DEFINE_GUID(GUID_MotionCompCallbacks, 0xb1122b40, 0x5dA5, 0x11d1, 0x8f, 0xcF,
...
/*
 * This DDPF flag is used by drivers to signify that this format is new and may
 * be a candidate for hiding from certain applications KEEP THIS DEFINITION IN
 * SYNC WITH THAT OF DDPF_RESERVED1 IN DDRAW.H
 */
...
// Indicates that this format supports neither texture coordinate wrap modes,
// nor mipmapping
...
/*
 * Indicates to the driver that the "execute" buffer that is to be created is
 * actually a vertex buffer. Used by CreateVertexBuffer in D3D
 */
#define DDSCAPS2_VERTEXBUFFER DDSCAPS2_RESERVED1

/*
 * Indicates to the driver that the "execute" buffer that is to be created is
 * actually a command buffer. Used by internally in D3D
 */
#define DDSCAPS2_COMMANDBUFFER DDSCAPS2_RESERVED2

/*
 * Indicates to the driver that the "execute" buffer that is to be created is
 * actually an index buffer.
 */
...
typedef struct _DDHAL_WAITFORVERTICALBLANKDATA FAR
...
typedef struct _DDHAL_SETOVERLAYPOSITIONDATA FAR
...
typedef struct _DDHAL_ADDATTACHEDSURFACEDATA FAR
...
typedef struct _DDHAL_GETVPORTINPUTFORMATDATA FAR
    *LPDDHAL_GETVPORTINPUTFORMATDATA;
typedef struct _DDHAL_GETVPORTOUTPUTFORMATDATA FAR
...
typedef struct _DDHAL_GETVPORTFLIPSTATUSDATA FAR
...
typedef struct _DDHAL_GETAVAILDRIVERMEMORYDATA FAR
    *LPDDHAL_GETAVAILDRIVERMEMORYDATA;
typedef struct _DDHAL_UPDATENONLOCALHEAPDATA FAR
 ...
 */
extern HRESULT DDAPI LateAllocateSurfaceMem(LPDIRECTDRAWSURFACE lpSurface,
...
#define VIDMEM_ISNONLOCAL                                                      \
  0x00000008l                   // heap populated with non-local video memory
...
#define HEAPALIASINFO_MAPPEDREAL                                               \
  0x00000001l // PRIVATE: heap aliases mapped to real video memory
#define HEAPALIASINFO_MAPPEDDUMMY                                              \
  0x00000002l // PRIVATE: heap aliased mapped to dummy memory
...
typedef struct _DDRAWI_DDRAWSURFACE_GBL_MORE FAR
...
typedef DWORD(FAR PASCAL *LPDDHAL_CANCREATESURFACE)(
    LPDDHAL_CANCREATESURFACEDATA);
typedef DWORD(FAR PASCAL *LPDDHAL_WAITFORVERTICALBLANK)(
    LPDDHAL_WAITFORVERTICALBLANKDATA);
...
typedef DWORD(FAR PASCAL *LPDDHAL_SETEXCLUSIVEMODE)(
    LPDDHAL_SETEXCLUSIVEMODEDATA);
typedef DWORD(FAR PASCAL *LPDDHAL_FLIPTOGDISURFACE)(
 ...
 */
typedef DWORD(FAR PASCAL *LPDDHALPALCB_DESTROYPALETTE)(
...
typedef DWORD(FAR PASCAL *LPDDHALSURFCB_UPDATEOVERLAY)(
    LPDDHAL_UPDATEOVERLAYDATA);
typedef DWORD(FAR PASCAL *LPDDHALSURFCB_SETOVERLAYPOSITION)(
    LPDDHAL_SETOVERLAYPOSITIONDATA);
...
typedef DWORD(FAR PASCAL *LPDDHALSURFCB_DESTROYSURFACE)(
    LPDDHAL_DESTROYSURFACEDATA);
typedef DWORD(FAR PASCAL *LPDDHALSURFCB_SETCLIPLIST)(LPDDHAL_SETCLIPLISTDATA);
typedef DWORD(FAR PASCAL *LPDDHALSURFCB_ADDATTACHEDSURFACE)(
    LPDDHAL_ADDATTACHEDSURFACEDATA);
...
typedef DWORD(FAR PASCAL *LPDDHALSURFCB_GETFLIPSTATUS)(
...
typedef DWORD(FAR PASCAL *LPDDHAL_GETAVAILDRIVERMEMORY)(
    LPDDHAL_GETAVAILDRIVERMEMORYDATA);
typedef DWORD(FAR PASCAL *LPDDHAL_UPDATENONLOCALHEAP)(
    LPDDHAL_UPDATENONLOCALHEAPDATA);
typedef DWORD(FAR PASCAL *LPDDHAL_GETHEAPALIGNMENT)(
 ...
 */
typedef DWORD(FAR PASCAL *LPDDHALEXEBUFCB_CANCREATEEXEBUF)(
    LPDDHAL_CANCREATESURFACEDATA);
typedef DWORD(FAR PASCAL *LPDDHALEXEBUFCB_CREATEEXEBUF)(
    LPDDHAL_CREATESURFACEDATA);
typedef DWORD(FAR PASCAL *LPDDHALEXEBUFCB_DESTROYEXEBUF)(
    LPDDHAL_DESTROYSURFACEDATA);
 ...
 */
typedef DWORD(FAR PASCAL *LPDDHALVPORTCB_CANCREATEVIDEOPORT)(
    LPDDHAL_CANCREATEVPORTDATA);
typedef DWORD(FAR PASCAL *LPDDHALVPORTCB_CREATEVIDEOPORT)(
    LPDDHAL_CREATEVPORTDATA);
typedef DWORD(FAR PASCAL *LPDDHALVPORTCB_FLIP)(LPDDHAL_FLIPVPORTDATA);
typedef DWORD(FAR PASCAL *LPDDHALVPORTCB_GETBANDWIDTH)(
    LPDDHAL_GETVPORTBANDWIDTHDATA);
typedef DWORD(FAR PASCAL *LPDDHALVPORTCB_GETINPUTFORMATS)(
    LPDDHAL_GETVPORTINPUTFORMATDATA);
typedef DWORD(FAR PASCAL *LPDDHALVPORTCB_GETOUTPUTFORMATS)(
    LPDDHAL_GETVPORTOUTPUTFORMATDATA);
...
typedef DWORD(FAR PASCAL *LPDDHALVPORTCB_GETVPORTCONNECT)(
    LPDDHAL_GETVPORTCONNECTDATA);
typedef DWORD(FAR PASCAL *LPDDHALVPORTCB_DESTROYVPORT)(
    LPDDHAL_DESTROYVPORTDATA);
typedef DWORD(FAR PASCAL *LPDDHALVPORTCB_GETFLIPSTATUS)(
    LPDDHAL_GETVPORTFLIPSTATUSDATA);
typedef DWORD(FAR PASCAL *LPDDHALVPORTCB_UPDATE)(LPDDHAL_UPDATEVPORTDATA);
typedef DWORD(FAR PASCAL *LPDDHALVPORTCB_WAITFORSYNC)(
    LPDDHAL_WAITFORVPORTSYNCDATA);
typedef DWORD(FAR PASCAL *LPDDHALVPORTCB_GETSIGNALSTATUS)(
 ...
 */
typedef DWORD(FAR PASCAL *LPDDHALCOLORCB_COLORCONTROL)(
...
typedef DWORD(FAR PASCAL *LPDDHALKERNELCB_SYNCVIDEOPORT)(
 ...
 *                      * these are values returned by the driver from the above
 * callback routines
 */
/*
...
/*
 * More driver surface capabilities (in addition to those described in
 * DDCORECAPS). This struct contains the caps bits added to the DDCAPS.ddsCaps
 * structure in DX6.
 */
typedef struct _DDMORESURFACECAPS {
   ...
   * Note the -1 accounts for the fact that DDMORESURFACECAPS is declared to
   * have 1 tagExtendedHeapRestrictions member.
   */
...
/*
 * DDRAW internal version of DIRECTDRAWPALETTE object; it has data after the
 * vtable
 */
typedef struct _DDRAWI_DDRAWPALETTE_GBL {
  ...
  union {
    ULONG_PTR dwReserved1; // reserved for use by display driver which created
                           // this object
 ...
 * (there may now be many owning surfaces). So the lpDDSurface is now
 * dwReserved0 (this mod. assumes that sizeof(DWORD) ==
...
#define DDRAWIPAL_STORED_8INDEX                                                \
  0x00001000l // palette stored as 8-bit index into dst palette
...
/*
 * DDRAW internal version of DIRECTDRAWCLIPPER object; it has data after the
 * vtable
 */
...
/*
 * (CMcC) As with palettes, the clipper no longer maintains a back pointer to
 * the owning surface (there may now be many owning surfaces). So the
 * lpDDSurface is now dwReserved0 (this mod. assumes that sizeof(DWORD) ==
 * sizeof(LPDDRAWI_DDRAWSURFACE_LCL). A fairly safe assumption I think.
 */
typedef struct _DDRAWI_DDRAWCLIPPER_LCL {
  ...
  IUnknown *pAddrefedThisOwner; // This is the ddraw object that created this
                                // clipper, if nonzero. Must Release it when
                                // clipper is released.
} DDRAWI_DDRAWCLIPPER_LCL;

#define DDRAWICLIP_WATCHWINDOW 0x00000001l
#define DDRAWICLIP_ISINITIALIZED 0x00000002l
#define DDRAWICLIP_INMASTERSPRITELIST                                          \
  0x00000004l // clipper is referenced in master sprite list
...
typedef struct _ATTACHLIST {
  ...
  struct _DDRAWI_DDRAWSURFACE_INT FAR
      *lpIAttached; // attached surface interface
} ATTACHLIST;
...
/*
 * ACCESSRECTLIST - internally used to all rectangles that are accessed on a
 * surface
 */
typedef struct _ACCESSRECTLIST {
  ...
  LPHEAPALIASINFO
  lpHeapAliasInfo; // PRIVATE: aliased heaps being used by this lock
} ACCESSRECTLIST;
typedef ACCESSRECTLIST FAR *LPACCESSRECTLIST;

#define ACCESSRECT_VRAMSTYLE                                                   \
  0x00000001L // PRIVATE: this lock is vram style (vidmem or implict sysmem)
#define ACCESSRECT_NOTHOLDINGWIN16LOCK                                         \
  0x00000002L // PRIVATE: this lock is not holding the Win16 lock
#define ACCESSRECT_BROKEN                                                      \
  0x00000004L // PRIVATE: this lock was broken by an invalidate - don't call HAL
              // on unlock

#ifndef WIN95
/*
 * Do not change the size of this struct. This will move various members of
 * surface and ddraw structs and will prevent binaries from running on old win2k
 * systems (or mismatched later NT builds)
 */
...
#define EQUAL_DISPLAYMODE(a, b)                                                \
  (0 == memcmp(&(a), &(b), sizeof(DISPLAYMODEINFO)))
#endif
...
/*
 * This is an extender structure that is allocated off the end of the
 * SURFACE_GBL structure. DO NOT place any structures whose size can change in
 * here.
 */
#define GET_LPDDRAWSURFACE_GBL_MORE(psurf_gbl)                                 \
  (*(LPDDRAWI_DDRAWSURFACE_GBL_MORE *)((BYTE *)psurf_gbl - sizeof(DWORD_PTR)))
...
/*
 * NOTE: This structure contains a set of fields for describing linear to
 * physical page mappings in the case of page locked system memory. It can also
 * contain the physical surface pointer of a surface in non-local memory. As
 * there is no point in having both a linear to physical page translation table
 * and a physical memory pointer for the same surface they are placed in a
 * union.
 */
typedef struct _DDRAWI_DDRAWSURFACE_GBL_MORE {
  DWORD dwSize;
  union {
    DWORD dwPhysicalPageTable; // Physical address of page table (array of
                               // physical addresses/one per 4K page)
    FLATPTR fpPhysicalVidMem;  // Physical address of surface (non-local video
                               // memory only)
  };
  ...
  ULONG_PTR dwDriverReserved; // Reserved for driver use (both system and video
                              // memory surfaces)
  ...
  DWORD dwContentsStamp; // Changes when surface data may have changed. 0 means
                         // no information
  LPVOID
  lpvUnswappedDriverReserved; // Reserved for use by display driver. Is not
                              // swapped when Flip is called on this surface
  LPVOID lpDDRAWReserved2;
  DWORD dwDDRAWReserved1;
  DWORD dwDDRAWReserved2;
  FLATPTR fpAliasOfVidMem; // PRIVATE: The original VidMem pointer of which
                           // fpAliasedVidMem is an alias of This is used to
                           // compare with a given fpVidMem to see if we can use
                           // the cached fpAliasedVidMem or if we need to call
                           // GetAliasedVidMem.
} DDRAWI_DDRAWSURFACE_GBL_MORE;

/*
 * a structure holding additional LCL surface information (can't simply be
 * appended to the LCL structure as that structure is of variable size).
 */
typedef struct _DDRAWI_DDRAWSURFACE_MORE {
  ...
  lpDDIClipper; // Interface to attached clipper object
  //------- Fields added in Version 5.0 -------
  LPHEAPALIASINFO
  lpHeapAliasInfo;      // PRIVATE: Aliased heaps being referenced by this lock
  DWORD dwOverlayFlags; // Current overlay flags
  VOID *rgjunc;         // Blitter function table for new blitter
  LPDDRAWI_DDVIDEOPORT_LCL
  lpVideoPort; // Video port currently writting data to this surface
 ...
 */
#define PFINDEX_UNINITIALIZED                                                  \
  (0UL) // pixel-format index is in uninitialized state
#define PFINDEX_UNSUPPORTED                                                    \
  (~0UL) // surface's pixel format is not supported by HEL
...
struct _DDRAWI_DDRAWSURFACE_LCL {
   ...
   */
  DWORD dwClrXparent; // the *actual* color key (override, colorkey, or
                      // CLR_INVALID)
...
#define DDRAWISURFGBL_SYSMEMREQUESTED                                          \
  0x00000002L // surface is in system memory at request of user
#define DDRAWISURFGBL_ISGDISURFACE                                             \
  0x00000004L // This surface represents what GDI thinks is front buffer
#define DDRAWISURFGBL_SOFTWAREAUTOFLIP                                         \
  0x00000008L // This surface is autoflipped using software
#define DDRAWISURFGBL_LOCKNOTHOLDINGWIN16LOCK                                  \
  0x00000010L // PRIVATE: a vram lock of the entire surface is not holding the
              // Win16 lock
#define DDRAWISURFGBL_LOCKVRAMSTYLE                                            \
  0x00000020L // PRIVATE: entire surface was locked with VRAM style lock
#define DDRAWISURFGBL_LOCKBROKEN                                               \
  0x00000040L // PRIVATE: a lock of the entire surface was broken by an
              // invalidate
#define DDRAWISURFGBL_IMPLICITHANDLE                                           \
  0x00000080L // This dwKernelHandle was created implicitly
#define DDRAWISURFGBL_ISCLIENTMEM                                              \
  0x00000100L // PRIVATE: the memory pointer to by fpVidMem was allocated by the
              // client
#define DDRAWISURFGBL_HARDWAREOPSOURCE                                         \
  0x00000200L // This surface was the source for an asynchronous hardware
              // operation
#define DDRAWISURFGBL_HARDWAREOPDEST                                           \
  0x00000400L // This surface was dest for an asynchronous hardware operation
#define DDRAWISURFGBL_HARDWAREOPSTARTED                                        \
  (DDRAWISURFGBL_HARDWAREOPSOURCE | DDRAWISURFGBL_HARDWAREOPDEST)
#define DDRAWISURFGBL_VPORTINTERLEAVED                                         \
  0x00000800L // This surface contains interleaved video port data
#define DDRAWISURFGBL_VPORTDATA                                                \
  0x00001000L // This surface received data from the video port
#define DDRAWISURFGBL_LATEALLOCATELINEAR                                       \
  0x00002000L // Optimized surface was allocated as a formless chunk. lPitch
              // invalid, dwLinearSize valid.
#define DDRAWISURFGBL_SYSMEMEXECUTEBUFFER                                      \
  0x00004000L // Driver sets this flag to tell ddraw that the surface was
              // allocated in system memory
#define DDRAWISURFGBL_FASTLOCKHELD                                             \
  0x00008000L // PRIVATE: indicates that InternLock took the fast path
#define DDRAWISURFGBL_READONLYLOCKHELD                                         \
  0x00010000L // PRIVATE: indicates that the application indicated read-only
              // lock
#define DDRAWISURFGBL_DX8SURFACE                                               \
  0x00080000L // PRIVATE: indicates that the surace was created using DX8
#define DDRAWISURFGBL_DDHELDONTFREE                                            \
  0x00100000L // PRIVATE: indicates that the surace memory should not be freed
              // by the HEL
#define DDRAWISURFGBL_NOTIFYWHENUNLOCKED                                       \
  0x00200000L // PRIVATE: indicates that the this surface help a NOSYSLOCK lock
              // when a mode change occured

/*
 * NOTE: This flag was previously DDRAWISURFGBL_INVALID. This flags has been
 * retired and replaced by DDRAWISURF_INVALID in the local object.
 */
...
#define DDRAWISURF_LOCKEXCLUDEDCURSOR                                          \
  0x00001000L // surface was locked and excluded cursor
#define DDRAWISURF_HASPIXELFORMAT                                              \
  0x00002000L // surface structure has pixel format data
#define DDRAWISURF_HASOVERLAYDATA                                              \
  0x00004000L                           // surface structure has overlay data
#define DDRAWISURF_SETGAMMA 0x00008000L // gamma ramp for this surface is active
#define DDRAWISURF_SW_CKEYDESTOVERLAY                                          \
  0x00010000L // surface expects to process colorkey in software
#define DDRAWISURF_SW_CKEYDESTBLT                                              \
  0x00020000L // surface expects to process colorkey in software
#define DDRAWISURF_SW_CKEYSRCOVERLAY                                           \
  0x00040000L // surface expects to process colorkey in software
#define DDRAWISURF_SW_CKEYSRCBLT                                               \
  0x00080000L // surface expects to process colorkey in software
#define DDRAWISURF_HW_CKEYDESTOVERLAY                                          \
  0x00100000L // surface expects to process colorkey in hardware
#define DDRAWISURF_HW_CKEYDESTBLT                                              \
  0x00200000L // surface expects to process colorkey in hardware
#define DDRAWISURF_HW_CKEYSRCOVERLAY                                           \
  0x00400000L // surface expects to process colorkey in hardware
#define DDRAWISURF_HW_CKEYSRCBLT                                               \
  0x00800000L // surface expects to process colorkey in hardware
#define DDRAWISURF_INMASTERSPRITELIST                                          \
  0x01000000l // surface is referenced in master sprite list
#define DDRAWISURF_HELCB                                                       \
  0x02000000L // surface is the ddhel cb. must call hel for lock/blt.
#define DDRAWISURF_FRONTBUFFER                                                 \
  0x04000000L // surface was originally a front buffer
#define DDRAWISURF_BACKBUFFER 0x08000000L // surface was originally backbuffer
#define DDRAWISURF_INVALID                                                     \
  0x10000000L // surface has been invalidated by mode set
#define DDRAWISURF_DCIBUSY                                                     \
  0x20000000L // HEL has turned off BUSY so DCI would work
#define DDRAWISURF_GETDCNULL                                                   \
  0x40000000L // getdc could not lock and so returned GetDC(NULL)

// #define DDRAWISURF_CANTLOCK             0x20000000L     // surface cannot be
// locked (primary created by HEL)
#define DDRAWISURF_STEREOSURFACELEFT                                           \
  0x20000000L // surface is left of stereo pair
#define DDRAWISURF_DRIVERMANAGED                                               \
  0x40000000L // Surface is a driver managed texture (D3D)
#define DDRAWISURF_DCILOCK                                                     \
  0x80000000L // Surface was locked using DCIBeginAccess
...
#define DDMODEINFO_MAXREFRESH                                                  \
  0x0010                         // refresh rate specified is the max supported
...
typedef struct _DDHAL_CALLBACKS {
  DDHAL_DDCALLBACKS
  cbDDCallbacks; // addresses in display driver for DIRECTDRAW object HAL
  DDHAL_DDSURFACECALLBACKS
  cbDDSurfaceCallbacks; // addresses in display driver for DIRECTDRAWSURFACE
                        // object HAL
  DDHAL_DDPALETTECALLBACKS
  cbDDPaletteCallbacks;    // addresses in display driver for DIRECTDRAWPALETTE
                           // object HAL
  ...
  DDHAL_DDEXEBUFCALLBACKS
  cbDDExeBufCallbacks; // addresses in display driver for DIRECTDRAWEXEBUF
                       // pseudo object HAL
  ...
  DDHAL_DDVIDEOPORTCALLBACKS
  cbDDVideoPortCallbacks; // addresses in display driver for VideoPort
                          // object HAL
  DDHAL_DDVIDEOPORTCALLBACKS
  HALDDVideoPort; // HAL for DIRECTDRAWVIDEOPORT psuedo object
  DDHAL_DDCOLORCONTROLCALLBACKS
  cbDDColorControlCallbacks; // addresses in display driver for color
                             // control object HAL
  DDHAL_DDCOLORCONTROLCALLBACKS
  HALDDColorControl; // HAL for DIRECTDRAWCOLORCONTROL psuedo object
...
typedef struct _DDRAWI_DIRECTDRAW_GBL {
  ...
  /*17c*/ LPDDRAWI_DDRAWCLIPPER_INT
  clipperList;                            // PRIVATE: list of all clippers
  ...
  /*3f8*/ LPDDRAWI_DIRECTDRAW_LCL
  lpExclusiveOwner;                   // PRIVATE: exclusive local object
  ...
  /*42c*/ DWORD
  dwAliasedLockCnt;              // PRIVATE: number of outstanding aliased locks
  ...
  /*   */ //------- Fields added in Version 5.0 -------
  /*5bc*/ LPDDVIDEOPORTCAPS
  lpDDVideoPortCaps; // Info returned by the HAL (an array if more than one
                     // video port)
  ...
  /*5f4*/ LPDDNONLOCALVIDMEMCAPS
  lpddNLVCaps; // hardware non-local to local vidmem caps
  /*5f8*/ LPDDNONLOCALVIDMEMCAPS
  lpddNLVHELCaps; // emulation layer non-local to local vidmem caps
  /*5fc*/ LPDDNONLOCALVIDMEMCAPS
  lpddNLVBothCaps; // logical AND of hardware and emulation non-local to
                   // local vidmem caps
  ...
  /*640*/ LPDDPIXELFORMAT
  lpZPixelFormats; // Pointer to array of z-buffer pixel formats
  /*644*/ LPDDRAWI_DDMOTIONCOMP_INT
  mcList;                        // PRIVATE: list of all motion comp objects
...
#define DDRAWILCL_DIRTYDC                                                      \
  0x00000400l // Set on ChangeDisplaySettings, cleared when device DC is
              // reinited
#define DDRAWILCL_DISABLEINACTIVATE 0x00000800l
#define DDRAWILCL_CURSORCLIPPED 0x00001000l
#define DDRAWILCL_EXPLICITMONITOR                                              \
  0x00002000l // device was chosen explicitly i.e. not DDrawCreate(NULL)
#define DDRAWILCL_MULTITHREADED 0x00004000l // App threaten to be multithreaded
#define DDRAWILCL_FPUSETUP                                                     \
  0x00008000l // D3D does not need to switch to single prec/exceptions disabled
              // each time
#define DDRAWILCL_POWEREDDOWN                                                  \
  0x00010000l // Private: indicates that screen saver is powered down
#define DDRAWILCL_DIRECTDRAW7                                                  \
  0x00020000l // PRIVATE: Marks if this is a IDirectDraw7 object
#define DDRAWILCL_ATTEMPTEDD3DCONTEXT                                          \
  0x00040000l // PRIVATE: Marks if this ddraw local has attempted to create a
              // d3d context
#define DDRAWILCL_FPUPRESERVE                                                  \
  0x00080000l // D3D needs to switch to single prec/exceptions disabled each
              // time
#define DDRAWILCL_DX8DRIVER                                                    \
  0x00100000l // PRIVATE: Set if this drvier can handle lightweight surfaces
#define DDRAWILCL_DIRECTDRAW8                                                  \
  0x00200000l // PRIVATE: Marks if this is a IDirectDraw8 object

#define DDRAWI_xxxxxxxxx1 0x00000001l // unused
#define DDRAWI_xxxxxxxxx2 0x00000002l // unused
#define DDRAWI_VIRTUALDESKTOP                                                  \
  0x00000008l // driver is really a multi-monitor virtual desktop
...
#define DDRAWI_HASGDIPALETTE                                                   \
  0x00002000l // GDI palette exists on primary surface
...
#define DDRAWI_MODEXILLEGAL                                                    \
  0x00010000l // modex is not supported by this hardware
#define DDRAWI_FLIPPEDTOGDI                                                    \
  0x00020000l // driver has been flipped to show GDI surface
#define DDRAWI_NEEDSWIN16FORVRAMLOCK                                           \
  0x00040000l // PRIVATE: Win16 lock must be taken when locking a VRAM surface
#define DDRAWI_PDEVICEVRAMBITCLEARED                                           \
  0x00080000l // PRIVATE: the PDEVICE's VRAM bit was cleared by a lock
#define DDRAWI_STANDARDVGA                                                     \
  0x00100000l // Device is using standard VGA mode (DDRAWI_MODEX will be set)
#define DDRAWI_EXTENDEDALIGNMENT                                               \
  0x00200000l // At least one heap has extended alignment. Ignore alignment in
              // VIDMEMINFO
#define DDRAWI_CHANGINGMODE                                                    \
  0x00400000l                     // Currently in the middle of a mode change
#define DDRAWI_GDIDRV 0x00800000l // Driver is a GDI driver
#define DDRAWI_ATTACHEDTODESKTOP                                               \
  0x01000000l                          // Device is attached to the desktop
#define DDRAWI_UMODELOADED 0x02000000l // User mode driver dll is loaded
#define DDRAWI_DDRAWDATANOTFETCHED                                             \
  0x04000000l // PRIVATE: Marks mode-change data fetched (NT)
#define DDRAWI_SECONDARYDRIVERLOADED                                           \
  0x08000000l // PRIVATE: Marks if a secndary PVR-style HAL was loaded
#define DDRAWI_TESTINGMODES 0x10000000l // PRIVATE: A mode test in is progress
#define DDRAWI_DRIVERINFO2                                                     \
  0x20000000l // PRIVATE: Driver supports GetDriverInfo2
#define DDRAWI_BADPDEV                                                         \
  0x40000000l // PRIVATE: Indiactes that we should not re-use this PDEV
...
typedef struct _DDRAWI_DDVIDEOPORT_LCL {
  ...
  *lpFlipInts;         // PRIVATE: surfaces currently being autoflipped
...
#define DDRAWIVPORT_SOFTWARE_AUTOFLIP                                          \
  0x00000002 // Video port cannot use hardware autoflip
#define DDRAWIVPORT_COLORKEYANDINTERP                                          \
  0x00000004 // Overlay cannot bob and colorkey at same time
#define DDRAWIVPORT_NOKERNELHANDLES                                            \
  0x00000008 // Unable to allocate kernel resources
#define DDRAWIVPORT_SOFTWARE_BOB                                               \
  0x00000010 // All bobbing must be performed in software
...
typedef struct _DDHALINFO {
  ...
  GetDriverInfo;              // callback to get arbitrary vtable from driver
  ...
  lpDDExeBufCallbacks; // Execute buffer pseudo object callbacks
} DDHALINFO;
...
#define DDHALINFO_ISPRIMARYDISPLAY                                             \
  0x00000001l // indicates driver is primary display driver
#define DDHALINFO_MODEXILLEGAL                                                 \
  0x00000002l // indicates this hardware does not support modex modes
#define DDHALINFO_GETDRIVERINFOSET                                             \
  0x00000004l // indicates that GetDriverInfo is set
#define DDHALINFO_GETDRIVERINFO2                                               \
  0x00000008l // indicates driver support GetDriverInfo2 variant
...
extern FLATPTR DDAPI DDHAL_VidMemAlloc(LPDDRAWI_DIRECTDRAW_GBL lpDD, int heap,
                                       DWORD dwWidth, DWORD dwHeight);
extern void DDAPI DDHAL_VidMemFree(LPDDRAWI_DIRECTDRAW_GBL lpDD, int heap,
                                   FLATPTR fpMem);
...
typedef struct _DDHAL_SETOVERLAYPOSITIONDATA {
  ...
  SetOverlayPosition; // PRIVATE: ptr to callback
...
typedef struct _DDHAL_ADDATTACHEDSURFACEDATA {
  ...
  AddAttachedSurface; // PRIVATE: ptr to callback
...
typedef struct _DDHAL_CANCREATEVPORTDATA {
  ...
  CanCreateVideoPort; // PRIVATE: ptr to callback
...
typedef struct _DDHAL_GETVPORTINPUTFORMATDATA {
  ...
  GetVideoPortInputFormats; // PRIVATE: ptr to callback
...
typedef struct _DDHAL_GETVPORTOUTPUTFORMATDATA {
  ...
  GetVideoPortOutputFormats; // PRIVATE: ptr to callback
...
typedef struct _DDHAL_GETVPORTCONNECTDATA {
  ...
  GetVideoPortConnectInfo; // PRIVATE: ptr to callback
...
typedef struct _DDHAL_GETVPORTFLIPSTATUSDATA {
  ...
  GetVideoPortFlipStatus; // PRIVATE: ptr to callback
...
typedef struct _DDHAL_UPDATEVPORTDATA {
  ...
  DWORD dwNumAutoflip;    // # of autoflip surfaces. If > 1, lpDDSurface and
                          // lpDDVBISurface are arrays.
  DWORD dwNumVBIAutoflip; // # of autoflip surfaces. If > 1, lpDDSurface and
                          // lpDDVBISurface are arrays.
  HRESULT ddRVal;         // return value
...
typedef struct _DDHAL_GETVPORTSIGNALDATA {
  ...
  GetVideoSignalStatus; // PRIVATE: ptr to callback
...
typedef struct _DDHAL_GETHEAPALIGNMENTDATA {
  ULONG_PTR
  dwInstance;     // driver context as returned from 32-bit driver init routine
...
/*
 * These are the only caps you can set in
 * DDHAL_GETHEAPALIGNMENTDATA.Alignment.ddsCaps. Any other caps will be rejected
 * by DirectDraw.
 */

#define DDHAL_ALIGNVALIDCAPS                                                   \
  (DDSCAPS_OFFSCREENPLAIN | DDSCAPS_EXECUTEBUFFER | DDSCAPS_OVERLAY |          \
   DDSCAPS_TEXTURE | DDSCAPS_ZBUFFER | DDSCAPS_ALPHA | DDSCAPS_FLIP)
...
typedef struct _DDMCCOMPBUFFERINFO {
  ...
  DWORD
  dwNumCompBuffers; // [out]  number of buffers required for compressed data
  ...
  DDPIXELFORMAT ddPixelFormat; // [out]  format to create surfaces to store
                               // compressed data
...
typedef struct _DDHAL_GETMOCOMPCOMPBUFFDATA {
  ...
  DWORD dwNumTypesCompBuffs;   // [in/out] number of memory types required for
                               // comp buffers
  LPDDMCCOMPBUFFERINFO lpCompBuffInfo; // [in]   driver supplied info regarding
                                       // comp buffers (allocated by client)
  HRESULT ddRVal;                      // [out]
  LPDDHALMOCOMPCB_GETCOMPBUFFINFO GetMoCompBuffInfo;
...
typedef struct _DDHAL_BEGINMOCOMPFRAMEDATA {
  ...
  lpDestSurface; // [in]  destination buffer in which to decoding this frame
  ...
  LPVOID
  lpOutputData;   // [in]  pointer to output misc data (allocated by client)
  HRESULT ddRVal; // [out]
  LPDDHALMOCOMPCB_BEGINFRAME BeginMoCompFrame;
...
typedef struct _DDMCBUFFERINFO {
  DWORD dwSize; // [in]    size of the struct
  LPDDRAWI_DDRAWSURFACE_LCL
  lpCompSurface;      // [in]    pointer to buffer containing compressed data
