...
typedef struct IXpsOMPackageWriter3DVtbl {
  ...
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(IXpsOMPackageWriter3D *This,
                                             /* [in] */ REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(IXpsOMPackageWriter3D *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(IXpsOMPackageWriter3D *This);
  ...
  HRESULT(STDMETHODCALLTYPE *AddResource)(IXpsOMPackageWriter3D *This,
                                          /* [in] */ IXpsOMResource *resource);

  DECLSPEC_XFGVIRT(IXpsOMPackageWriter, Close)
  HRESULT(STDMETHODCALLTYPE *Close)(IXpsOMPackageWriter3D *This);

  DECLSPEC_XFGVIRT(IXpsOMPackageWriter, IsClosed)
  HRESULT(STDMETHODCALLTYPE *IsClosed)(IXpsOMPackageWriter3D *This,
...
#define IXpsOMPackageWriter3D_AddRef(This) ((This)->lpVtbl->AddRef(This))

#define IXpsOMPackageWriter3D_Release(This) ((This)->lpVtbl->Release(This))

#define IXpsOMPackageWriter3D_StartNewDocument(                                \
...
#define IXpsOMPackageWriter3D_AddPage(                                         \
    This, page, advisoryPageDimensions, discardableResourceParts,              \
    storyFragments, pagePrintTicket, pageThumbnail)                            \
...
#define IXpsOMPackageWriter3D_Close(This) ((This)->lpVtbl->Close(This))

#define IXpsOMPackageWriter3D_IsClosed(This, isClosed)                         \
  ((This)->lpVtbl->IsClosed(This, isClosed))

#define IXpsOMPackageWriter3D_AddModelTexture(This, texturePartName,           \
                                              textureData)                     \
  ((This)->lpVtbl->AddModelTexture(This, texturePartName, textureData))

#define IXpsOMPackageWriter3D_SetModelPrintTicket(This, printTicketPartName,   \
                                                  printTicketData)             \
  ((This)->lpVtbl->SetModelPrintTicket(This, printTicketPartName,              \
                                       printTicketData))
...
typedef struct IXpsDocumentPackageTarget3DVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(IXpsDocumentPackageTarget3D *This,
                                             /* [in] */ REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(IXpsDocumentPackageTarget3D *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(IXpsDocumentPackageTarget3D *This);
...
#define IXpsDocumentPackageTarget3D_AddRef(This) ((This)->lpVtbl->AddRef(This))

#define IXpsDocumentPackageTarget3D_Release(This)                              \
  ((This)->lpVtbl->Release(This))

#define IXpsDocumentPackageTarget3D_GetXpsOMPackageWriter3D(                   \
    This, documentSequencePartName, discardControlPartName, modelPartName,     \
    modelData, packageWriter)                                                  \
  ((This)->lpVtbl->GetXpsOMPackageWriter3D(                                    \
      This, documentSequencePartName, discardControlPartName, modelPartName,   \
      modelData, packageWriter))
