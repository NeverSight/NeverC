...
public:
  ...
  virtual HRESULT STDMETHODCALLTYPE RevokeAccessRights(
      ...
      /* [in] */ ULONG cTrustees,
      /* [size_is][in] */
      __RPC__in_ecount_full(cTrustees) TRUSTEEW prgTrustees[]) = 0;

  virtual HRESULT STDMETHODCALLTYPE GetAllAccessRights(
      /* [in] */ __RPC__in LPWSTR lpProperty,
      /* [out] */ __RPC__deref_out_opt PACTRL_ACCESSW_ALLOCATE_ALL_NODES *
          ppAccessList,
...
typedef struct IAccessControlVtbl {
  ...
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in IAccessControl *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IAccessControl *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IAccessControl *This);
  ...
  HRESULT(STDMETHODCALLTYPE *SetOwner)(__RPC__in IAccessControl *This,
                                       /* [in] */ __RPC__in PTRUSTEEW pOwner,
...
interface IAccessControl { CONST_VTBL struct IAccessControlVtbl *lpVtbl; };
...
typedef struct IAuditControlVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in IAuditControl *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IAuditControl *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IAuditControl *This);
  ...
  HRESULT(STDMETHODCALLTYPE *SetAuditRights)(__RPC__in IAuditControl *This,
                                             /* [in] */ __RPC__in PACTRL_AUDITW
                                                 pAuditList);
...
interface IAuditControl { CONST_VTBL struct IAuditControlVtbl *lpVtbl; };
...
#define IAuditControl_IsAccessAudited(This, pTrustee, AuditRights,             \
                                      pfAccessAudited)                         \
  ((This)->lpVtbl->IsAccessAudited(This, pTrustee, AuditRights,                \
                                   pfAccessAudited))
