...
/* [local] */
// VSTS 15030784: Wv17: Cleanup C4091:
// onecore\enduser\databaseaccess\src\mdac\shared\ado. See work item for more
// details on this suppression.
...
typedef struct _ADOVtbl {
  ...
  /* [helpcontext][id][propget] */ HRESULT(STDMETHODCALLTYPE *get_Properties)(
      __RPC__in _ADO *This,
      /* [retval][out] */ __RPC__deref_out_opt struct ADOProperties *
          *ppvObject);
...
typedef struct ErrorVtbl {
  ...
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in struct ADOError *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             __RPC__deref_out void **ppvObject);

  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in struct ADOError *This);

  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in struct ADOError *This);
...
typedef struct ErrorsVtbl {
  ...
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in struct ADOErrors *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             __RPC__deref_out void **ppvObject);

  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in struct ADOErrors *This);

  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in struct ADOErrors *This);
...
typedef struct Command15Vtbl {
  ...
  /* [helpcontext][propget][id] */ HRESULT(
      ...
      __RPC__in Command15 *This,
      /* [retval][out] */ __RPC__deref_out_opt struct _ADOConnection *
          *ppvObject);
  ...
  /* [helpcontext][propget][id] */ HRESULT(STDMETHODCALLTYPE *get_Parameters)(
      __RPC__in Command15 *This,
      /* [retval][out] */ __RPC__deref_out_opt struct ADOParameters *
          *ppvObject);
...
typedef struct _CommandVtbl {
  ...
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in struct _ADOCommand *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             __RPC__deref_out void **ppvObject);

  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in struct _ADOCommand *This);

  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in struct _ADOCommand *This);
  ...
  /* [helpcontext][propput][id] */ HRESULT(
      STDMETHODCALLTYPE *put_CommandTimeout)(__RPC__in struct _ADOCommand *This,
                                             /* [in] */ LONG Timeout);
...
typedef struct _ConnectionVtbl {
  ...
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in struct _ADOConnection *This);

  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in struct _ADOConnection *This);
  ...
  /* [helpcontext][id][propput] */ HRESULT(
      STDMETHODCALLTYPE *put_CommandTimeout)(
      __RPC__in struct _ADOConnection *This,
      /* [in] */ LONG lTimeout);
  ...
  /* [helpcontext][id][propput] */ HRESULT(
      STDMETHODCALLTYPE *put_ConnectionTimeout)(
      __RPC__in struct _ADOConnection *This,
      /* [in] */ LONG lTimeout);
  ...
  /* [helpcontext][id][propput] */ HRESULT(
      STDMETHODCALLTYPE *put_DefaultDatabase)(
      __RPC__in struct _ADOConnection *This,
      /* [in] */ __RPC__in BSTR bstr);
...
typedef struct _RecordVtbl {
  ...
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in struct _ADORecord *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             __RPC__deref_out void **ppvObject);

  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in struct _ADORecord *This);

  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in struct _ADORecord *This);
...
typedef struct _StreamVtbl {
  ...
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in struct _ADOStream *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             __RPC__deref_out void **ppvObject);

  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in struct _ADOStream *This);

  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in struct _ADOStream *This);
...
typedef struct Recordset15Vtbl {
  ...
  /* [hidden] */ HRESULT(STDMETHODCALLTYPE *_xClone)(
      __RPC__in Recordset15 *This,
      /* [retval][out] */ __RPC__deref_out_opt struct _ADORecordset *
          *ppvObject);
...
typedef struct Recordset20Vtbl {
  ...
  /* [helpcontext][id] */ HRESULT(STDMETHODCALLTYPE *Clone)(
      ...
      /* [defaultvalue][in] */ LockTypeEnum LockType,
      /* [retval][out] */
      __RPC__deref_out_opt struct _ADORecordset **ppvObject);
...
typedef struct _RecordsetVtbl {
  ...
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in struct _ADORecordset *This);

  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in struct _ADORecordset *This);
...
typedef struct FieldVtbl {
  ...
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in struct ADOField *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             __RPC__deref_out void **ppvObject);

  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in struct ADOField *This);

  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in struct ADOField *This);
...
typedef struct FieldsVtbl {
  ...
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in struct ADOFields *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             __RPC__deref_out void **ppvObject);

  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in struct ADOFields *This);

  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in struct ADOFields *This);
...
typedef struct _ParameterVtbl {
  ...
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in struct _ADOParameter *This);

  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in struct _ADOParameter *This);
...
typedef struct ParametersVtbl {
  ...
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in struct ADOParameters *This);

  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in struct ADOParameters *This);
  ...
  /* [helpcontext][propget][id] */ HRESULT(STDMETHODCALLTYPE *get_Item)(
      ...
      /* [in] */ VARIANT Index,
      /* [retval][out] */
      __RPC__deref_out_opt struct _ADOParameter **ppvObject);
...
typedef struct PropertyVtbl {
  ...
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in struct ADOProperty *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             __RPC__deref_out void **ppvObject);

  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in struct ADOProperty *This);

  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in struct ADOProperty *This);
...
typedef struct PropertiesVtbl {
  ...
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in struct ADOProperties *This);

  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in struct ADOProperties *This);
