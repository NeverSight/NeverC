...
typedef /* [public][public][public][public][public][public][public] */
    struct __MIDL___MIDL_itf_mpeg2structs_0000_0000_0016 {
...
typedef /* [public][public][public][public][public][public][public] */
    struct __MIDL___MIDL_itf_mpeg2structs_0000_0000_0017 {
  BOOL fSpecifyEtmId;
  DWORD EtmId;
} ATSC_FILTER_OPTIONS;

typedef /* [public][public][public] */
    struct __MIDL___MIDL_itf_mpeg2structs_0000_0000_0018 {
  BOOL fSpecifySegment;
  BYTE bSegment;
} DVB_EIT_FILTER_OPTIONS;

typedef /* [public][public][public] */
    struct __MIDL___MIDL_itf_mpeg2structs_0000_0000_0019 {
  BYTE bVersionNumber;
  WORD wFilterSize;
...
typedef /* [public][public][public] */
    struct __MIDL___MIDL_itf_mpeg2structs_0000_0000_0024 {
  BYTE Hours;
  BYTE Minutes;
  BYTE Seconds;
} MPEG_TIME;
...
typedef /* [public][public] */
    struct __MIDL___MIDL_itf_mpeg2structs_0000_0000_0025 {
  BYTE Date;
  BYTE Month;
  WORD Year;
} MPEG_DATE;
...
typedef /* [public][public][public][public][public] */
    struct __MIDL___MIDL_itf_mpeg2structs_0000_0000_0028 {
  DWORD AVMGraphId;
} MPEG_BCS_DEMUX;

typedef /* [public][public][public][public][public] */
    struct __MIDL___MIDL_itf_mpeg2structs_0000_0000_0029 {
  DWORD AVMGraphId;
} MPEG_WINSOCK;

typedef /* [public][public][public] */
    struct __MIDL___MIDL_itf_mpeg2structs_0000_0000_0030 {
  ...
  {                                                                            \
    if (_pSection) {                                                           \
      SWAPBYTES((_pSection)->Header.W);                                        \
                                                                               \
      if (reinterpret_cast<PMPEG_HEADER_BITS>(                                 \
              &((reinterpret_cast<PLONG_SECTION>(_pSection)->Header.W)))       \
              ->SectionSyntaxIndicator ||                                      \
          (_pSection)->TableId == 0x00 || (_pSection)->TableId == 0x3A ||      \
          (_pSection)->TableId == 0x3B || (_pSection)->TableId == 0x3C ||      \
          (_pSection)->TableId == 0x3D || (_pSection)->TableId == 0x3E) {      \
        SWAPBYTES(                                                             \
            reinterpret_cast<PLONG_SECTION>(_pSection)->TableIdExtension);     \
      }                                                                        \
    }                                                                          \
  }
...
#define SWAP_MPEG_HEADER_BYTES(_pSection)                                      \
  {                                                                            \
    if (_pSection) {                                                           \
      ...
      if ((_pSection)->TableId == 0x3B || (_pSection)->TableId == 0x3C) {      \
  ...
  {                                                                            \
    if (_pSection) {                                                           \
      if ((_pSection)->TableId == 0x3B || (_pSection)->TableId == 0x3C) {      \
        SWAPBYTES((reinterpret_cast<PDSMCC_SECTION>(_pSection))->MessageId);   \
        SWAPWORDS(                                                             \
            (reinterpret_cast<PDSMCC_SECTION>(_pSection))->TransactionId);     \
        SWAPBYTES(                                                             \
            (reinterpret_cast<PDSMCC_SECTION>(_pSection))->MessageLength);     \
      }                                                                        \
