...
DWORD
WINAPI
GetNumberOfInterfaces(_Out_ PDWORD pdwNumIf);
...
DWORD
WINAPI
GetIfEntry(_Inout_ PMIB_IFROW pIfRow);
...
DWORD
WINAPI
GetIfTable(_Out_writes_bytes_opt_(*pdwSize) PMIB_IFTABLE pIfTable,
           _Inout_ PULONG pdwSize, _In_ BOOL bOrder);
...
DWORD
WINAPI
GetIpAddrTable(_Out_writes_bytes_opt_(*pdwSize) PMIB_IPADDRTABLE pIpAddrTable,
               _Inout_ PULONG pdwSize, _In_ BOOL bOrder);
...
ULONG
WINAPI
GetIpNetTable(_Out_writes_bytes_opt_(*SizePointer) PMIB_IPNETTABLE IpNetTable,
              _Inout_ PULONG SizePointer, _In_ BOOL Order);
...
DWORD
WINAPI
GetIpForwardTable(_Out_writes_bytes_opt_(*pdwSize)
...
ULONG
WINAPI
GetTcpTable(_Out_writes_bytes_opt_(*SizePointer) PMIB_TCPTABLE TcpTable,
            _Inout_ PULONG SizePointer, _In_ BOOL Order);
...
GetExtendedTcpTable(
    ...
    _Inout_ _When_(ulAf == AF_INET, _Deref_in_range_(>=, sizeof(MIB_TCPTABLE)))
        _When_((TableClass == TCP_TABLE_OWNER_PID_LISTENER ||
            ...
            _When_((TableClass == TCP_TABLE_OWNER_MODULE_LISTENER ||
                ...
                PDWORD pdwSize,
    _In_ BOOL bOrder, _In_ ULONG ulAf, _In_ TCP_TABLE_CLASS TableClass,
    _In_ ULONG Reserved);
...
DWORD
WINAPI
GetOwnerModuleFromTcpEntry(_In_ PMIB_TCPROW_OWNER_MODULE pTcpEntry,
...
ULONG
WINAPI
GetUdpTable(_Out_writes_bytes_opt_(*SizePointer) PMIB_UDPTABLE UdpTable,
            _Inout_ PULONG SizePointer, _In_ BOOL Order);

IPHLPAPI_DLL_LINKAGE
DWORD
WINAPI
GetExtendedUdpTable(_Out_writes_bytes_opt_(*pdwSize) PVOID pUdpTable,
                    _Inout_ PDWORD pdwSize, _In_ BOOL bOrder, _In_ ULONG ulAf,
                    _In_ UDP_TABLE_CLASS TableClass, _In_ ULONG Reserved);
...
DWORD
WINAPI
GetOwnerModuleFromUdpEntry(_In_ PMIB_UDPROW_OWNER_MODULE pUdpEntry,
                           _In_ TCPIP_OWNER_MODULE_INFO_CLASS Class,
                           _Out_writes_bytes_(*pdwSize) PVOID pBuffer,
                           _Inout_ PDWORD pdwSize);
...
ULONG
WINAPI
GetTcpTable2(_Out_writes_bytes_opt_(*SizePointer) PMIB_TCPTABLE2 TcpTable,
             _Inout_ PULONG SizePointer, _In_ BOOL Order);
...
DWORD
AllocateAndGetTcpExTableFromStack(_Outptr_ PVOID *ppTcpTable, _In_ BOOL bOrder,
                                  _In_ HANDLE hHeap, _In_ DWORD dwFlags,
                                  _In_ DWORD dwFamily);

DWORD
AllocateAndGetUdpExTableFromStack(_Outptr_ PVOID *ppUdpTable, _In_ BOOL bOrder,
                                  _In_ HANDLE hHeap, _In_ DWORD dwFlags,
                                  _In_ DWORD dwFamily);
...
ULONG
WINAPI
GetTcp6Table(_Out_writes_bytes_(*SizePointer) PMIB_TCP6TABLE TcpTable,
             _Inout_ PULONG SizePointer, _In_ BOOL Order);

IPHLPAPI_DLL_LINKAGE
ULONG
WINAPI
GetTcp6Table2(_Out_writes_bytes_(*SizePointer) PMIB_TCP6TABLE2 TcpTable,
              _Inout_ PULONG SizePointer, _In_ BOOL Order);
...
ULONG
WINAPI
GetPerTcpConnectionEStats(_In_ PMIB_TCPROW Row, _In_ TCP_ESTATS_TYPE EstatsType,
                          _Out_writes_bytes_opt_(RwSize) PUCHAR Rw,
                          _In_ ULONG RwVersion, _In_ ULONG RwSize,
                          _Out_writes_bytes_opt_(RosSize) PUCHAR Ros,
                          _In_ ULONG RosVersion, _In_ ULONG RosSize,
                          _Out_writes_bytes_opt_(RodSize) PUCHAR Rod,
                          _In_ ULONG RodVersion, _In_ ULONG RodSize);

IPHLPAPI_DLL_LINKAGE
ULONG
WINAPI
SetPerTcpConnectionEStats(_In_ PMIB_TCPROW Row, _In_ TCP_ESTATS_TYPE EstatsType,
...
ULONG
WINAPI
GetPerTcp6ConnectionEStats(_In_ PMIB_TCP6ROW Row,
...
ULONG
WINAPI
SetPerTcp6ConnectionEStats(_In_ PMIB_TCP6ROW Row,
                           _In_ TCP_ESTATS_TYPE EstatsType,
                           _In_reads_bytes_(RwSize) PUCHAR Rw,
                           _In_ ULONG RwVersion, _In_ ULONG RwSize,
                           _In_ ULONG Offset);
...
DWORD
WINAPI
GetOwnerModuleFromTcp6Entry(_In_ PMIB_TCP6ROW_OWNER_MODULE pTcpEntry,
                            _In_ TCPIP_OWNER_MODULE_INFO_CLASS Class,
                            _Out_writes_bytes_(*pdwSize) PVOID pBuffer,
                            _Inout_ PDWORD pdwSize);
...
ULONG
WINAPI
GetUdp6Table(_Out_writes_bytes_opt_(*SizePointer) PMIB_UDP6TABLE Udp6Table,
             _Inout_ PULONG SizePointer, _In_ BOOL Order);

IPHLPAPI_DLL_LINKAGE
DWORD
WINAPI
GetOwnerModuleFromUdp6Entry(_In_ PMIB_UDP6ROW_OWNER_MODULE pUdpEntry,
                            _In_ TCPIP_OWNER_MODULE_INFO_CLASS Class,
                            _Out_writes_bytes_(*pdwSize) PVOID pBuffer,
                            _Inout_ PDWORD pdwSize);
...
//
DWORD
GetOwnerModuleFromPidAndInfo(_In_ ULONG ulPid, _In_ ULONGLONG *pInfo,
                             _In_ TCPIP_OWNER_MODULE_INFO_CLASS Class,
                             _Out_writes_bytes_(*pdwSize) PVOID pBuffer,
                             _Inout_ PDWORD pdwSize);
...
ULONG
WINAPI
GetIpStatistics(_Out_ PMIB_IPSTATS Statistics);
#endif
...
ULONG
WINAPI
GetIcmpStatistics(_Out_ PMIB_ICMP Statistics);
#endif
...
ULONG
WINAPI
GetTcpStatistics(_Out_ PMIB_TCPSTATS Statistics);

IPHLPAPI_DLL_LINKAGE
ULONG
WINAPI
GetUdpStatistics(_Out_ PMIB_UDPSTATS Stats);
#endif
...
ULONG
WINAPI
SetIpStatisticsEx(_In_ PMIB_IPSTATS Statistics, _In_ ULONG Family);
#endif
...
ULONG
WINAPI
GetIpStatisticsEx(_Out_ PMIB_IPSTATS Statistics, _In_ ULONG Family);

IPHLPAPI_DLL_LINKAGE
ULONG
WINAPI
GetIcmpStatisticsEx(_Out_ PMIB_ICMP_EX Statistics, _In_ ULONG Family);

IPHLPAPI_DLL_LINKAGE
ULONG
WINAPI
GetTcpStatisticsEx(_Out_ PMIB_TCPSTATS Statistics, _In_ ULONG Family);

IPHLPAPI_DLL_LINKAGE
ULONG
WINAPI
GetUdpStatisticsEx(_Out_ PMIB_UDPSTATS Statistics, _In_ ULONG Family);
#endif
...
ULONG
WINAPI
GetTcpStatisticsEx2(_Out_ PMIB_TCPSTATS2 Statistics, _In_ ULONG Family);

IPHLPAPI_DLL_LINKAGE
ULONG
WINAPI
GetUdpStatisticsEx2(_Out_ PMIB_UDPSTATS2 Statistics, _In_ ULONG Family);
#endif
...
DWORD
WINAPI
CreateProxyArpEntry(_In_ DWORD dwAddress, _In_ DWORD dwMask,
                    _In_ DWORD dwIfIndex);

IPHLPAPI_DLL_LINKAGE
DWORD
WINAPI
DeleteProxyArpEntry(_In_ DWORD dwAddress, _In_ DWORD dwMask,
                    _In_ DWORD dwIfIndex);
...
DWORD
WINAPI
GetInterfaceInfo(_Out_writes_bytes_opt_(*dwOutBufLen)
...
DWORD
WINAPI
GetUniDirectionalAdapterInfo(_Out_writes_bytes_opt_(*dwOutBufLen)
...
NhpAllocateAndGetInterfaceInfoFromStack(
    _Outptr_ IP_INTERFACE_NAME_INFO **ppTable, _Out_ PDWORD pdwCount,
    _In_ BOOL bOrder, _In_ HANDLE hHeap, _In_ DWORD dwFlags);
...
DWORD
WINAPI
GetBestInterface(_In_ IPAddr dwDestAddr, _Out_ PDWORD pdwBestIfIndex);
...
DWORD
WINAPI
GetBestInterfaceEx(_In_ struct sockaddr *pDestAddr,
...
DWORD
WINAPI
GetBestRoute(_In_ DWORD dwDestAddr, _In_opt_ DWORD dwSourceAddr,
             _Out_ PMIB_IPFORWARDROW pBestRoute);

IPHLPAPI_DLL_LINKAGE
DWORD
WINAPI
NotifyAddrChange(_Out_ PHANDLE Handle, _In_ LPOVERLAPPED overlapped);

IPHLPAPI_DLL_LINKAGE
DWORD
WINAPI
NotifyRouteChange(_Out_ PHANDLE Handle, _In_ LPOVERLAPPED overlapped);

IPHLPAPI_DLL_LINKAGE
BOOL WINAPI CancelIPChangeNotify(_In_ LPOVERLAPPED notifyOverlapped);

IPHLPAPI_DLL_LINKAGE
DWORD
WINAPI
GetAdapterIndex(_In_ LPWSTR AdapterName, _Inout_ PULONG IfIndex);

IPHLPAPI_DLL_LINKAGE
DWORD
WINAPI
AddIPAddress(_In_ IPAddr Address, _In_ IPMask IpMask, _In_ DWORD IfIndex,
             _Out_ PULONG NTEContext, _Out_ PULONG NTEInstance);

IPHLPAPI_DLL_LINKAGE
DWORD
WINAPI
DeleteIPAddress(_In_ ULONG NTEContext);
...
DWORD
WINAPI
GetNetworkParams(_Out_writes_bytes_opt_(*pOutBufLen) PFIXED_INFO pFixedInfo,
...
ULONG
WINAPI
GetAdaptersInfo(_Out_writes_bytes_opt_(*SizePointer)
...
ULONG
WINAPI
GetAdaptersAddresses(_In_ ULONG Family, _In_ ULONG Flags,
                     _Reserved_ PVOID Reserved,
                     _Out_writes_bytes_opt_(*SizePointer)
...
DWORD
WINAPI
GetPerAdapterInfo(_In_ ULONG IfIndex,
                  _Out_writes_bytes_opt_(*pOutBufLen)
...
DWORD
WINAPI
GetInterfaceActiveTimestampCapabilities(_In_ CONST NET_LUID *InterfaceLuid,
                                        _Out_ PINTERFACE_TIMESTAMP_CAPABILITIES
...
INTERFACE_TIMESTAMP_CONFIG_CHANGE_CALLBACK(_In_ PVOID CallerContext);

typedef INTERFACE_TIMESTAMP_CONFIG_CHANGE_CALLBACK
...
RegisterInterfaceTimestampConfigChange(
    ...
    _In_opt_ PVOID CallerContext, _Out_ HIFTIMESTAMPCHANGE *NotificationHandle);

IPHLPAPI_DLL_LINKAGE
VOID WINAPI UnregisterInterfaceTimestampConfigChange(
...
DWORD
WINAPI
NotifyIfTimestampConfigChange(_In_opt_ PVOID CallerContext,
                              _In_ PINTERFACE_TIMESTAMP_CONFIG_CHANGE_CALLBACK
                                  Callback,
                              _Out_ HIFTIMESTAMPCHANGE *NotificationHandle);

IPHLPAPI_DLL_LINKAGE
VOID WINAPI
CancelIfTimestampConfigChange(_In_ HIFTIMESTAMPCHANGE NotificationHandle);
...
DWORD
WINAPI
IpReleaseAddress(_In_ PIP_ADAPTER_INDEX_MAP AdapterInfo);

IPHLPAPI_DLL_LINKAGE
DWORD
WINAPI
IpRenewAddress(_In_ PIP_ADAPTER_INDEX_MAP AdapterInfo);

IPHLPAPI_DLL_LINKAGE
DWORD
WINAPI
SendARP(_In_ IPAddr DestIP, _In_ IPAddr SrcIP,
        _Out_writes_bytes_(*PhyAddrLen) PVOID pMacAddr,
        _Inout_ PULONG PhyAddrLen);

IPHLPAPI_DLL_LINKAGE
BOOL WINAPI GetRTTAndHopCount(_In_ IPAddr DestIpAddress, _Out_ PULONG HopCount,
                              _In_ ULONG MaxHops, _Out_ PULONG RTT);

IPHLPAPI_DLL_LINKAGE
DWORD
WINAPI
GetFriendlyIfIndex(_In_ DWORD IfIndex);

IPHLPAPI_DLL_LINKAGE
DWORD
WINAPI
EnableRouter(_Out_ HANDLE *pHandle, _Out_ OVERLAPPED *pOverlapped);

IPHLPAPI_DLL_LINKAGE
DWORD
WINAPI
UnenableRouter(_In_ OVERLAPPED *pOverlapped, _Out_opt_ LPDWORD lpdwEnableCount);

IPHLPAPI_DLL_LINKAGE
DWORD
WINAPI
DisableMediaSense(_Out_ HANDLE *pHandle, _In_ OVERLAPPED *pOverLapped);

IPHLPAPI_DLL_LINKAGE
DWORD
WINAPI
RestoreMediaSense(_In_ OVERLAPPED *pOverlapped,
...
DWORD
WINAPI
GetIpErrorString(_In_ IP_STATUS ErrorCode,
                 _Out_writes_opt_(*Size + 1) PWSTR Buffer, _Inout_ PDWORD Size);
...
ULONG
WINAPI
ResolveNeighbor(_In_ SOCKADDR *NetworkAddress,
                _Out_writes_bytes_(*PhysicalAddressLength)
...
ULONG
WINAPI
CreatePersistentTcpPortReservation(_In_ USHORT StartPort,
...
ULONG
WINAPI
CreatePersistentUdpPortReservation(_In_ USHORT StartPort,
                                   _In_ USHORT NumberOfPorts,
                                   _Out_ PULONG64 Token);
...
ULONG
WINAPI
DeletePersistentTcpPortReservation(_In_ USHORT StartPort,
                                   _In_ USHORT NumberOfPorts);

IPHLPAPI_DLL_LINKAGE
ULONG
WINAPI
DeletePersistentUdpPortReservation(_In_ USHORT StartPort,
                                   _In_ USHORT NumberOfPorts);

IPHLPAPI_DLL_LINKAGE
ULONG
WINAPI
LookupPersistentTcpPortReservation(_In_ USHORT StartPort,
                                   _In_ USHORT NumberOfPorts,
                                   _Out_ PULONG64 Token);
...
ULONG
WINAPI
LookupPersistentUdpPortReservation(_In_ USHORT StartPort,
                                   _In_ USHORT NumberOfPorts,
                                   _Out_ PULONG64 Token);
...
DWORD
WINAPI
ParseNetworkString(_In_z_ CONST WCHAR *NetworkString, _In_ DWORD Types,
                   _Out_opt_ PNET_ADDRESS_INFO AddressInfo,
                   _Out_opt_ USHORT *PortNumber, _Out_opt_ BYTE *PrefixLength);
