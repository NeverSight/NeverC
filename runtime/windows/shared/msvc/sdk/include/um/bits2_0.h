...
public:
  ...
  virtual HRESULT STDMETHODCALLTYPE AddFileWithRanges(
      ...
      /* [in] */ DWORD RangeCount,
      /* [size_is][in] */
      __RPC__in_ecount_full(RangeCount) BG_FILE_RANGE Ranges[]) = 0;
...
typedef struct IBackgroundCopyJob3Vtbl {
  ...
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IBackgroundCopyJob3 *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IBackgroundCopyJob3 *This);

  DECLSPEC_XFGVIRT(IBackgroundCopyJob, AddFileSet)
  HRESULT(STDMETHODCALLTYPE *AddFileSet)(__RPC__in IBackgroundCopyJob3 *This,
                                         /* [in] */ ULONG cFileCount,
                                         /* [size_is][in] */
  ...
  HRESULT(STDMETHODCALLTYPE *AddFile)(__RPC__in IBackgroundCopyJob3 *This,
                                      /* [in] */ __RPC__in LPCWSTR RemoteUrl,
                                      /* [in] */ __RPC__in LPCWSTR LocalName);
  ...
  HRESULT(STDMETHODCALLTYPE *Suspend)(__RPC__in IBackgroundCopyJob3 *This);

  DECLSPEC_XFGVIRT(IBackgroundCopyJob, Resume)
  HRESULT(STDMETHODCALLTYPE *Resume)(__RPC__in IBackgroundCopyJob3 *This);

  DECLSPEC_XFGVIRT(IBackgroundCopyJob, Cancel)
  HRESULT(STDMETHODCALLTYPE *Cancel)(__RPC__in IBackgroundCopyJob3 *This);

  DECLSPEC_XFGVIRT(IBackgroundCopyJob, Complete)
  HRESULT(STDMETHODCALLTYPE *Complete)(__RPC__in IBackgroundCopyJob3 *This);

  DECLSPEC_XFGVIRT(IBackgroundCopyJob, GetId)
  HRESULT(STDMETHODCALLTYPE *GetId)(__RPC__in IBackgroundCopyJob3 *This,
                                    /* [out] */ __RPC__out GUID *pVal);

  DECLSPEC_XFGVIRT(IBackgroundCopyJob, GetType)
  HRESULT(STDMETHODCALLTYPE *GetType)(__RPC__in IBackgroundCopyJob3 *This,
  ...
  HRESULT(STDMETHODCALLTYPE *SetPriority)(__RPC__in IBackgroundCopyJob3 *This,
  ...
  HRESULT(STDMETHODCALLTYPE *RemoveCredentials)(
      __RPC__in IBackgroundCopyJob3 *This, BG_AUTH_TARGET Target,
...
public:
  virtual HRESULT STDMETHODCALLTYPE GetFileRanges(
      ...
      /* [size_is][size_is][out] */ __RPC__deref_out_ecount_full_opt(
          *RangeCount) BG_FILE_RANGE *
          *Ranges) = 0;

  virtual HRESULT STDMETHODCALLTYPE SetRemoteName(__RPC__in LPCWSTR Val) = 0;
};
...
typedef struct IBackgroundCopyFile2Vtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IBackgroundCopyFile2 *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IBackgroundCopyFile2 *This);
  ...
  HRESULT(STDMETHODCALLTYPE *SetRemoteName)(
      __RPC__in IBackgroundCopyFile2 *This, __RPC__in LPCWSTR Val);
