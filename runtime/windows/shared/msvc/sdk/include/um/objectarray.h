...
typedef struct IObjectArrayVtbl {
  ...
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in IObjectArray *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IObjectArray *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IObjectArray *This);

  DECLSPEC_XFGVIRT(IObjectArray, GetCount)
  HRESULT(STDMETHODCALLTYPE *GetCount)(__RPC__in IObjectArray *This,
...
interface IObjectArray { CONST_VTBL struct IObjectArrayVtbl *lpVtbl; };
...
typedef struct IObjectCollectionVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in IObjectCollection *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IObjectCollection *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IObjectCollection *This);

  DECLSPEC_XFGVIRT(IObjectArray, GetCount)
  HRESULT(STDMETHODCALLTYPE *GetCount)(__RPC__in IObjectCollection *This,
                                       /* [out] */ __RPC__out UINT *pcObjects);
  ...
  HRESULT(STDMETHODCALLTYPE *RemoveObjectAt)(__RPC__in IObjectCollection *This,
                                             /* [in] */ UINT uiIndex);

  DECLSPEC_XFGVIRT(IObjectCollection, Clear)
  HRESULT(STDMETHODCALLTYPE *Clear)(__RPC__in IObjectCollection *This);
