...
typedef interface ISpatialAudioObjectRenderStreamForHrtf
...
typedef enum SpatialAudioHrtfDirectivityType {
  ...
  SpatialAudioHrtfDirectivity_Cardioid =
      (SpatialAudioHrtfDirectivity_OmniDirectional + 1),
...
typedef enum SpatialAudioHrtfEnvironmentType {
  ...
  SpatialAudioHrtfEnvironment_Outdoors =
      (SpatialAudioHrtfEnvironment_Large + 1),
  SpatialAudioHrtfEnvironment_Average =
      (SpatialAudioHrtfEnvironment_Outdoors + 1)
...
typedef enum SpatialAudioHrtfDistanceDecayType {
  ...
  SpatialAudioHrtfDistanceDecay_CustomDecay =
      (SpatialAudioHrtfDistanceDecay_NaturalDecay + 1)
...
typedef struct ISpatialAudioObjectForHrtfVtbl {
  ...
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(ISpatialAudioObjectForHrtf *This,
                                             /* [in] */ REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(ISpatialAudioObjectForHrtf *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(ISpatialAudioObjectForHrtf *This);
  ...
  HRESULT(STDMETHODCALLTYPE *SetEndOfStream)(ISpatialAudioObjectForHrtf *This,
                                             /* [annotation][in] */
                                             _In_ UINT32 frameCount);

  DECLSPEC_XFGVIRT(ISpatialAudioObjectBase, IsActive)
  HRESULT(STDMETHODCALLTYPE *IsActive)(ISpatialAudioObjectForHrtf *This,
                                       /* [annotation][out] */
                                       _Out_ BOOL *isActive);
  ...
  HRESULT(STDMETHODCALLTYPE *SetPosition)(ISpatialAudioObjectForHrtf *This,
                                          /* [annotation][in] */
                                          _In_ float x,
                                          /* [annotation][in] */
                                          _In_ float y,
  ...
  HRESULT(STDMETHODCALLTYPE *SetGain)(ISpatialAudioObjectForHrtf *This,
                                      /* [annotation][in] */
                                      _In_ float gain);
...
#define ISpatialAudioObjectForHrtf_AddRef(This) ((This)->lpVtbl->AddRef(This))

#define ISpatialAudioObjectForHrtf_Release(This) ((This)->lpVtbl->Release(This))
...
typedef struct ISpatialAudioObjectRenderStreamForHrtfVtbl {
  ...
  DECLSPEC_XFGVIRT(ISpatialAudioObjectRenderStreamForHrtf,
...
#define ISpatialAudioObjectRenderStreamForHrtf_QueryInterface(This, riid,      \
                                                              ppvObject)       \
  ((This)->lpVtbl->QueryInterface(This, riid, ppvObject))
...
#define ISpatialAudioObjectRenderStreamForHrtf_GetAvailableDynamicObjectCount( \
    This, value)                                                               \
...
#define ISpatialAudioObjectRenderStreamForHrtf_BeginUpdatingAudioObjects(      \
...
#define ISpatialAudioObjectRenderStreamForHrtf_ActivateSpatialAudioObjectForHrtf( \
