...
HRESULT WINAPI WSDCreateDeviceProxy(_In_ LPCWSTR pszDeviceId,
...
HRESULT WINAPI WSDCreateDeviceProxyAdvanced(
    _In_ LPCWSTR pszDeviceId, IWSDAddress *pDeviceAddress,
    _In_ LPCWSTR pszLocalId, IWSDXMLContext *pContext,
    _Outptr_ IWSDDeviceProxy **ppDeviceProxy);
#if (WINVER >= _WIN32_WINNT_WIN7)
HRESULT WINAPI WSDCreateDeviceProxy2(
    _In_ LPCWSTR pszDeviceId, _In_ LPCWSTR pszLocalId, IWSDXMLContext *pContext,
    _In_reads_opt_(dwConfigParamCount) WSD_CONFIG_PARAM *pConfigParams,
    DWORD dwConfigParamCount, _Outptr_ IWSDDeviceProxy **ppDeviceProxy);
#endif
...
#define IWSDEndpointProxy_SendTwoWayRequestAsync(                              \
  ...
  ((This)->lpVtbl->SendTwoWayRequestAsync(This, pBody, pOperation,             \
...
interface IWSDServiceProxy { CONST_VTBL struct IWSDServiceProxyVtbl *lpVtbl; };
...
#define IWSDServiceProxy_SubscribeToOperation(This, pOperation, pUnknown,      \
                                              pAny, ppAny)                     \
  ((This)->lpVtbl->SubscribeToOperation(This, pOperation, pUnknown, pAny,      \
                                        ppAny))
...
typedef struct IWSDServiceProxyEventingVtbl {
  ...
  DECLSPEC_XFGVIRT(IWSDServiceProxyEventing,
...
#define IWSDServiceProxyEventing_RenewMultipleOperations(                      \
  ...
  ((This)->lpVtbl->RenewMultipleOperations(                                    \
      This, pOperations, dwOperationCount, pExpires, pAny, ppExpires, ppAny))
...
typedef struct IWSDDeviceProxyVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(IWSDDeviceProxy *This,
                                             /* [in] */ REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);
  ...
  HRESULT(STDMETHODCALLTYPE *Init)(IWSDDeviceProxy *This,
                                   /* [annotation][in] */
                                   _In_ LPCWSTR pszDeviceId,
                                   /* [in] */ IWSDAddress *pDeviceAddress,
                                   /* [annotation][in] */
...
interface IWSDDeviceProxy { CONST_VTBL struct IWSDDeviceProxyVtbl *lpVtbl; };
...
typedef struct IWSDAsyncResultVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(IWSDAsyncResult *This,
                                             /* [in] */ REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);
...
interface IWSDAsyncResult { CONST_VTBL struct IWSDAsyncResultVtbl *lpVtbl; };
...
typedef struct IWSDEventingStatusVtbl {
  ...
  void(STDMETHODCALLTYPE *SubscriptionRenewalFailed)(IWSDEventingStatus *This,
                                                     /* [annotation][in] */
                                                     _In_ LPCWSTR
                                                         pszSubscriptionAction,
                                                     /* [in] */ HRESULT hr);
