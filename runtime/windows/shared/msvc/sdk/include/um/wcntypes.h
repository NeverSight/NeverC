...
#define WCN_E_AUTHENTICATION_FAILED                                            \
  MAKE_HRESULT(SEVERITY_ERROR, FACILITY_ITF, 0x3C02)
#define WCN_E_CONNECTION_REJECTED                                              \
  MAKE_HRESULT(SEVERITY_ERROR, FACILITY_ITF, 0x3C03)
#define WCN_E_SESSION_TIMEDOUT                                                 \
  MAKE_HRESULT(SEVERITY_ERROR, FACILITY_ITF, 0x3C04)
...
typedef /* [v1_enum] */
    enum tagWCN_ATTRIBUTE_TYPE {
      ...
      WCN_TYPE_SELECTED_REGISTRAR_CONFIG_METHODS =
          (WCN_TYPE_PERMITTED_CONFIG_METHODS + 1),
      WCN_TYPE_PRIMARY_DEVICE_TYPE =
          (WCN_TYPE_SELECTED_REGISTRAR_CONFIG_METHODS + 1),
      ...
      WCN_TYPE_KEY_PROVIDED_AUTOMATICALLY =
          (WCN_TYPE_INITIALIZATION_VECTOR + 1),
      ...
      WCN_TYPE_PRIMARY_DEVICE_TYPE_SUBCATEGORY_OUI =
          (WCN_TYPE_PRIMARY_DEVICE_TYPE_CATEGORY + 1),
      WCN_TYPE_PRIMARY_DEVICE_TYPE_SUBCATEGORY =
          (WCN_TYPE_PRIMARY_DEVICE_TYPE_SUBCATEGORY_OUI + 1),
...
//
// Values for WCN_TYPE_VERSION/WCN_TYPE_VERSION2 (these refer to the WPS
// protocol version)
//
typedef /* [v1_enum] */
