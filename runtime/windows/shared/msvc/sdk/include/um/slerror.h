...
#define IS_SL_VGA_STRICT_ERROR(hr)                                             \
  (((hr & 0xF000) == SL_MSCH_ZONE) && ((hr & 0xFFF) >= 0x401) &&               \
   ((hr & 0xFFF) <= 0x496))
#define IS_SL_VGA_LITE_ERROR(hr)                                               \
  (((hr & 0xF000) == SL_MSCH_ZONE) && ((hr & 0xFFF) >= 0x497) &&               \
   ((hr & 0xFFF) <= 0x600))

#define IS_STORE_TOKEN_ERROR_RANGE(hr)                                         \
  (((SL_E_STORE_UPGRADE_TOKEN_REQUIRED <= hr) &&                               \
    (SL_E_STORE_UPGRADE_TOKEN_NOT_AUTHORIZED >= hr)))
...
// MessageText:
//
// The activation server reported that the computer could not connect to the
// activation server.
//
...
// MessageText:
//
// The activation server determined that required business token entry cannot be
// found.
//
...
// MessageText:
//
// The activation server determined that your computer clock time is not
// correct. You must correct your clock before you can activate.
//
...
// MessageText:
//
// The activation server determined there is a problem with the specified
// product key.
//
...
// MessageText:
//
// The activation server reported that the product key has exceeded its unlock
// limit.
//
...
// MessageText:
//
// The activation server reported that the Multiple Activation Key extension
...
// MessageText:
//
// The activation server reported that the specified product key cannot be used
...
// MessageText:
//
// The activation server reported that time based activation attempted before
// start date.
//
...
// MessageText:
//
// The activation server reported that time based activation attempted after end
// date.
//
...
// MessageText:
//
// The activation server reported that new time based activation is not
// available.
//
...
// MessageText:
//
// The activation server reported that the time based product key is not
...
// MessageText:
//
// The activation server reported that no business rules available to activate
...
// MessageText:
//
// The activation server determined the VGA service response is not available in
// the expected format.
//
...
// MessageText:
//
// The activation server reported that business rule cound not find required
// input.
//
...
// MessageText:
//
// The activation server reported that NULL value specified for business
...
// MessageText:
//
// The activation server reported that it failed to process input XML for
// product key bindings.
//
#define SL_E_CHPA_FAILED_TO_PROCESS_PRODUCT_KEY_BINDINGS_XML                   \
  ((HRESULT)0xC004C758L)
...
// MessageText:
//
// The activation server reported that the product key type is being used by
// another user.
//
...
// MessageText:
//
// Genuine Validation determined the validation input template identifier is
// invalid.
//
...
// MessageText:
//
// Genuine Validation determined the validation input data blob parameter is
// invalid.
//
...
// MessageText:
//
// Genuine Validation determined the validation template identifier is invalid
// for this version of the Windows operating system.
//
...
// MessageText:
//
// Genuine Validation determined the product key is invalid for this version of
...
// MessageText:
//
// Genuine Validation determined the specified product key has been blocked for
...
// MessageText:
//
// Genuine Validation determined the active directory activation data is
// invalid.
//
...
// MessageText:
//
// Genuine Validation determined the license state is in notification due to
// expired grace.
//
...
// MessageText:
//
// The Software Licensing Service determined that the specified context is
// invalid.
//
...
// MessageText:
//
// The Software Licensing Service reported that the license has not been
// evaluated.
//
...
// MessageText:
//
// The Software Licensing Service reported that the license contains invalid
// data.
//
...
// MessageText:
//
// The Software Licensing Service reported that the license store does not
// contain the requested license.
//
...
// MessageText:
//
// The Software Licensing Service reported that the license store is not
// initialized.
//
...
// MessageText:
//
// The Software Licensing Service reported that the license store is already
// initialized.
//
...
// MessageText:
//
// The Software Licensing Service reported that the license could not be opened
// or created.
//
...
// MessageText:
//
// The Software Licensing Service reported that the license could not be
// written.
//
...
// MessageText:
//
// The Software Licensing Service reported that the license store could not read
// the license file.
//
...
// MessageText:
//
// The Software Licensing Service reported that the license property is
// corrupted.
//
...
// MessageText:
//
// The Software Licensing Service reported that the license store contains an
...
// MessageText:
//
// The Software Licensing Service reported that the license store failed to
// start synchronization properly.
//
...
// MessageText:
//
// The Software Licensing Service determined that validation of the specified
// product key failed.
//
...
// MessageText:
//
// The Software Licensing Service reported that invalid add-on information was
// found.
//
...
// MessageText:
//
// The Software Licensing Service reported that not all hardware information
// could be collected.
//
...
// MessageText:
//
// The new product key cannot be used on this installation of Windows. Type a
// different product key. (CD-AB)
//
...
// MessageText:
//
// The Software Licensing Service reported that there is a mismatched between a
// policy value and information stored in the OtherInfo section.
//
...
// MessageText:
//
// The Software Licensing Service reported that the Genuine information
// contained in the license is not consistent.
//
...
// MessageText:
//
// The Software Licensing Service reported that the secure store id value in
// license does not match with the current value.
//
...
// MessageText:
//
// The Software Licensing Service reported that the notification rules appear to
// be invalid.
//
...
// MessageText:
//
// The Software Licensing Service reported that the reported machine data
...
// MessageText:
//
// The Software Licensing Service reported that the data hash does not
...
// MessageText:
//
// The Software Licensing Service reported that a valid product key for an
// add-on sku was entered where a Windows product key was expected.
//
...
// MessageText:
//
// The Software Licensing Service reported that the version of SPPSvc does not
// match the policy.
//
...
// MessageText:
//
// The Software Licensing Service reported that there is another activation
// attempt in progress for this sku.  Please wait for that attempt to complete
// before trying again.
//
...
// MessageText:
//
// The Software Licensing Service reported that the activated license requires a
// corresponding Store upgrade license in order to work.  Please visit the Store
// to purchase a new license or re-download an existing one.
//
...
// MessageText:
//
// The Software Licensing Service reported that the Store upgrade license is not
// enabled for the current OS edition.  Please visit the Store to purchase the
// appropriate license.
//
...
// MessageText:
//
// The Software Licensing Service reported that the Store upgrade license does
// not match the current active product key.  Please visit the Store to purchase
// a new license or re-download an existing one.
//
...
//
// The Software Licensing Service reported that the Store upgrade license does
// not match the current signing level for the installed Operating System.
// Please visit the Store to purchase a new license or re-download an existing
// one.
//
...
//
// The Software Licensing Service reported that the Store upgrade license does
// not enable the current version of the installed Operating System.  Please
// visit the Store to purchase a new license or re-download an existing one.
//
...
// MessageText:
//
// The Software Licensing Service reported that the Store upgrade license could
// not be authorized.  Please visit the Store to purchase a new license or
// re-download an existing one.
//
...
// MessageText:
//
// The Software Licensing Service reported that the Token Store file version is
// invalid.
//
...
// MessageText:
//
// The Software Licensing Service reported that the Token Store contains an
...
// MessageText:
//
// The Software Licensing Service reported that the Token Store contains a token
// with an invalid header/footer.
//
...
// MessageText:
//
// The Software Licensing Service reported that a Token Store token has an
// invalid name.
//
...
// MessageText:
//
// The Software Licensing Service reported that the Token Store contains a
// duplicate token.
//
...
// MessageText:
//
// The Software Licensing Service reported that a token in the Token Store has a
// size mismatch.
//
...
// MessageText:
//
// The Software Licensing Service reported that a token in the Token Store
// contains an invalid hash.
//
...
// MessageText:
//
// The Software Licensing Service reported that the Token Store was unable to
// read a token.
//
...
// MessageText:
//
// The Software Licensing Service reported that the Token Store attempted an
...
// MessageText:
//
// The Software Licensing Service reported that the Token Store file header is
// invalid.
//
...
// MessageText:
//
// The Software Licensing Service reported that a Token Store token descriptor
// is invalid.
//
...
// MessageText:
//
// The Software Licensing Service reported that the required license could not
// be found.
//
...
// MessageText:
//
// The Software Licensing Service reported that the product key does not match
// the range defined in the license.
//
...
//
// The Software Licensing Service reported that the product key does not match
// the product key for the license.
//
...
// MessageText:
//
// The Software Licensing Service reported that the signature file for the
...
// MessageText:
//
// The Software Licensing Service reported that the application ID does not
// match the application ID for the license.
//
...
// MessageText:
//
// The Software Licensing Service reported that the product identification data
// is not available.
//
...
// MessageText:
//
// The Software Licensing Service reported that the application is running
// within the valid grace period.
//
...
//
// The Software Licensing Service reported that the application is running
// within the valid out of tolerance grace period.
//
...
// MessageText:
//
// The Software Licensing Service determined that the license could not be used
// by the current version of the security processor component.
//
...
// MessageText:
//
// The Software Licensing Service reported that the hardware ID binding is
// beyond the level of tolerance.
//
...
// MessageText:
//
// The Software Licensing Service reported that the license file is not
// installed.
//
...
// MessageText:
//
// The Software Licensing Service reported that the call has failed because the
// value for the input key was not found.
//
...
// MessageText:
//
// The Software Licensing Service determined that there is no permission to run
// the software.
//
...
// MessageText:
//
// The Software Licensing Service reported that the product key is not
// available.
//
...
// MessageText:
//
// The Software Licensing Service reported that the license does not contain
// valid location data for the activation server.
//
...
// MessageText:
//
// The Software Licensing Service determined that the requested event ID is
// invalid.
//
...
// MessageText:
//
// The Software Licensing Service determined that the requested event is not
...
// MessageText:
//
// The Software Licensing Service reported that the event ID is already
// registered.
//
...
// MessageText:
//
// The Software Licensing Service reported that the verification of the license
// failed.
//
...
// MessageText:
//
// The Software Licensing Service determined that the input data type does not
// match the data type in the license.
//
...
// MessageText:
//
// The Software Licensing Service determined that the license package is
// invalid.
//
...
// MessageText:
//
// The Software Licensing Service reported that the validity period of the
// license has expired.
//
...
// MessageText:
//
// The Software Licensing Service reported that the license authorization
// failed.
//
...
// MessageText:
//
// The Software Licensing Service reported that the action requires
...
// MessageText:
//
// The Software Licensing Service reported that the format for the offline
...
// MessageText:
//
// The Software Licensing Service determined that the version of the offline
// Confirmation ID (CID) is incorrect.
//
...
//
// The Software Licensing Service determined that the version of the offline
// Confirmation ID (CID) is not supported.
//
...
// MessageText:
//
// The Software Licensing Service reported that the length of the offline
// Confirmation ID (CID) is incorrect.
//
...
// MessageText:
//
// The Software Licensing Service determined that the Installation ID (IID) or
// the Confirmation ID (CID) could not been saved.
//
...
// MessageText:
//
// The Installation ID (IID) and the Confirmation ID (CID) do not match. Please
// confirm the IID and reacquire a new CID if necessary.
//
...
// MessageText:
//
// The Software Licensing Service reported that the product key is not allowed
// to be installed. Please see the eventlog for details.
//
...
//
// The Software Licensing Service reported that the product could not be
// activated.  The Key Management Service (KMS) is not enabled.
//
...
// MessageText:
//
// The Software Licensing Service reported that the product was activated but
// the owner should verify the Product Use Rights.
//
...
// MessageText:
//
// The Software Licensing Service determined that the Key Management Service
// (KMS) is not activated. KMS needs to be activated. Please contact system
// administrator.
//
...
// MessageText:
//
// The Software Licensing Service reported that the proxy policy has not been
// updated.
//
...
//
// The Software Licensing Service determined that the Installation ID (IID) or
// the Confirmation ID (CID) is invalid.
//
...
// MessageText:
//
// The Software Licensing Service reported that license management information
// was not found in the licenses.
//
...
// license contains an override policy that is not configured properly.
//
...
//
// The Software Licensing Service reported that the product could not be
// activated using the Key Management Service (KMS).
//
...
// MessageText:
//
// The Software Licensing Service reported that the computer BIOS is missing a
// required license.
//
...
// MessageText:
//
// The Software Licensing Service reported that a license in the computer BIOS
// is invalid.
//
...
// MessageText:
//
// The Software Licensing Service determined that the version of the license
// package is invalid.
//
...
// MessageText:
//
// The Software Licensing Service determined that this specified product key can
...
// MessageText:
//
// The Software Licensing Service reported that a required license could not be
// found.
//
...
// MessageText:
//
// The Software Licensing Service reported that the computer is missing a
// required OEM license.
//
...
// MessageText:
//
// The Software Licensing Service reported that the non-genuine grace period
// expired.
//
...
//
// The Software Licensing Service reported that the application is running
// within the valid non-genuine grace period.
//
...
// MessageText:
//
// The Software Licensing Service reported that the genuine information property
// can not be set before dependent property been set.
//
...
//
// The Software Licensing Service reported that the application is running
// within the valid non-genuine grace period (type 2).
//
...
// MessageText:
//
// The Software Licensing Service reported that the requested operation is not
// allowed.
//
...
// MessageText:
//
// The Software Licensing Service determined that it is running in a virtual
// machine. The Key Management Service (KMS) is not supported in this mode.
//
...
//
// The Software Licensing Service reported that the product could not be
// activated. The Key Management Service (KMS) determined that the request
...
// MessageText:
//
// The Software Licensing Service reported that the plug-in manifest file is
// incorrect.
//
...
// MessageText:
//
// The Software Licensing Service reported that the license policies for fast
...
//
// The Software Licensing Service reported that the product could not be
// activated. No Key Management Service (KMS) could be contacted. Please see the
...
// MessageText:
//
// The Software Licensing Service reported that the operation cannot be
// completed because the service is stopping.
//
...
// MessageText:
//
// The Software Licensing Service reported that the requested plug-in cannot be
// found.
//
...
// MessageText:
//
// The Software Licensing Service determined incompatible version of
// authentication data.
//
...
// MessageText:
//
// The Software Licensing Service reported that the authentication data is not
// set.
//
...
// MessageText:
//
// The Software Licensing Service reported that the verification could not be
// done.
//
...
// MessageText:
//
// The requested operation is unavailable while the Software Licensing Service
// is running.
//
...
// MessageText:
//
// The Software Licensing Service determined that the version of the computer
// BIOS is invalid.
//
...
// MessageText:
//
// The Software Licensing Service reported that the product key cannot be used
...
// MessageText:
//
// The Installation ID (IID) and the Confirmation ID (CID) do not match the
// product key.
//
...
// MessageText:
//
// The Installation ID (IID) and the Confirmation ID (CID) are not bound to the
// current environment.
//
...
// MessageText:
//
// The Software Licensing Service reported that the license is not bound to the
// current environment.
//
...
// MessageText:
//
// The Software Licensing Service reported that the Active Directory Activation
// Object could not be found or was invalid.
//
...
// MessageText:
//
// The Software Licensing Service reported that the name specified for the
// Active Directory Activation Object is too long.
//
...
// MessageText:
//
// The Software Licensing Service reported that Active Directory-Based
// Activation is not supported in the current Active Directory schema.
//
...
// MessageText:
//
// The Software Licensing Service reported that the firmware on this device is
// corrupted.
//
...
// MessageText:
//
// The Software Licensing Service reported that the firmware on this device has
// invalid data
//
...
// MessageText:
//
// The Software Licensing Service reported that the product key in the firmware
// on this device is invalid
//
...
// MessageText:
//
// The Software Licensing Service was unable to cross check the edition of the
// product key using the DISM binaries available
//
...
// MessageText:
//
// The Software Licensing Service was unable to match the edition of the product
// key
//
...
// MessageText:
//
// The Software Licensing Service reported that the license edition does match
// the computer edition.
//
...
// MessageText:
//
// The Software Licensing Service reported that the hardware of the device may
// have changed.
//
...
// MessageText:
//
// The Software Licensing Service reported that the edition of the OEM key does
// not match the edition of Windows.
//
...
// MessageText:
//
// The Software Licensing Service reported that no product key was found on the
// system.
//
...
// MessageText:
//
// The Software Licensing Service reported a problem with the downlevel product
// key.
//
...
//
// The Software Licensing Service reported that the product could not be
// activated. The token-based activation challenge has expired.
//
...
// MessageText:
//
// The Software Licensing Service reported that Silent Activation failed. The
// Software Licensing Service reported that there are no certificates found in
// the system that could activate the product without user interaction.
//
...
// MessageText:
//
// The Software Licensing Service reported that the certificate chain could not
// be built or failed validation.
//
...
// MessageText:
//
// The Software Licensing Service reported that required license could not be
// found.
//
...
// MessageText:
//
// The Software Licensing Service reported that there are no certificates found
// in the system that could activate the product.
//
...
// MessageText:
//
// The Software Licensing Service reported that this software edition does not
// support token-based activation.
//
...
//
// The Software Licensing Service reported that the product could not be
// activated. Activation data is invalid.
//
...
//
// The Software Licensing Service reported that the product could not be
// activated. Activation data is tampered.
//
...
//
// The Software Licensing Service reported that the product could not be
// activated. Activation challenge and response do not match.
//
...
//
// The Software Licensing Service reported that the product could not be
// activated. The certificate does not match the conditions in the license.
//
...
// MessageText:
//
// The Software Licensing Service reported that the inserted smartcard could not
// be used to activate the product.
//
...
// MessageText:
//
// The Software Licensing Service reported that the token-based activation
...
//
// The Software Licensing Service reported that the product could not be
// activated. The thumbprint is invalid.
//
...
//
// The Software Licensing Service reported that the product could not be
// activated. The thumbprint does not match any certificate.
//
...
//
// The Software Licensing Service reported that the product could not be
// activated. The certificate does not match the criteria specified in the
// issuance license.
//
...
//
// The Software Licensing Service reported that the product could not be
// activated. The certificate does not match the trust point identifier (TPID)
// specified in the issuance license.
//
...
//
// The Software Licensing Service reported that the product could not be
// activated. A soft token cannot be used for activation.
//
...
//
// The Software Licensing Service reported that the product could not be
// activated. The certificate cannot be used because its private key is
// exportable.
//
...
// MessageText:
//
// The Software Licensing Service reported that the CNG encryption library could
// not be loaded.  The current certificate may not be available on this version
// of Windows.
//
...
// MessageText:
//
// The Software Licensing Service reported that the application has a store
// license.
//
...
//
// The Software Licensing Service reported that the application is running
// within the timebased validity period.
//
...
// MessageText:
//
// The Software Licensing Service reported that the application has a perpetual
// grace period.
//
...
//
// The Software Licensing Service reported that the application is running
// within the valid extended grace period.
//
...
// MessageText:
//
// You've reached the request limit for automatic virtual machine activation.
// Try again later.
//
...
// MessageText:
//
// Windows isn't running on a supported Microsoft Hyper-V virtualization
// platform.
//
...
// MessageText:
//
// Windows isn't activated on the host machine. Please contact your system
// administrator.
//
...
// MessageText:
//
// The host machine can't activate the edition of Windows on the virtual
// machine.
//
...
// MessageText:
//
// The Software Licensing Service reported that activation is required to
// recover from tampering of SL Service trusted store.
//
...
// MessageText:
//
// The security processor reported that the machine time is inconsistent with
// the trusted time.
//
...
// MessageText:
//
// The specified cipher mode is invalid. For example both encrypt and decrypt
// cannot be specified for symmetric keys.
//
...
//
#define SL_REMAPPING_SP_PUB_CRYPTO_INVALID_SIGNATURELENGTH                     \
  ((HRESULT)0xC004D20DL)
...
// MessageText:
//
// The security processor reported that entry key was not found in the trusted
// data store.
//
...
// MessageText:
//
// The security processor reported that the entry key already exists in the
// trusted data store.
//
...
// MessageText:
//
// The security processor reported that the entry key is too big to fit in the
// trusted data store.
//
...
// MessageText:
//
// The security processor reported that the maximum allowed number of re-arms
// has been exceeded.  You must re-install the OS before trying to re-arm again.
//
...
// MessageText:
//
// The security processor has reported that entry data size is too big to fit in
...
// MessageText:
//
// The security processor has reported that the machine has gone out of hardware
// tolerance.
//
...
//
#define SL_REMAPPING_SP_PUB_TS_TAMPERED_BREADCRUMB_LOAD_INVALID                \
  ((HRESULT)0xC004D317L)
...
// Trusted store tampered
//
#define SL_REMAPPING_SP_PUB_TS_TAMPERED_BREADCRUMB_GENERATION                  \
  ((HRESULT)0xC004D318L)
...
// Trusted store tampered
//
#define SL_REMAPPING_SP_PUB_TS_TAMPERED_DATA_BREADCRUMB_MISMATCH               \
  ((HRESULT)0xC004D31BL)
...
// Trusted store tampered
//
#define SL_REMAPPING_SP_PUB_TS_TAMPERED_DATA_VERSION_MISMATCH                  \
  ((HRESULT)0xC004D31CL)
...
// The security processor reported a system file mismatch error.
//
#define SL_REMAPPING_SP_PUB_TAMPER_SECURITY_PROCESSOR_PATCHED                  \
  ((HRESULT)0xC004D402L)
...
//
#define SL_REMAPPING_SP_PUB_KM_CACHE_TAMPER_RESTORE_FAILED                     \
  ((HRESULT)0xC004D502L)
...
// Owner, write description pls
//
#define SL_REMAPPING_SP_PUB_API_TOO_MANY_LOADED_ENVIRONMENTS                   \
  ((HRESULT)0xC004D00CL)
...
// limit has been exceeded.
//
#define SL_REMAPPING_MDOLLAR_DMAK_EXTENSION_LIMIT_EXCEEDED                     \
  ((HRESULT)0x803FA080L)
...
// MessageText:
//
// The activation server determined that the version of the offline Confirmation
// ID (CID) is incorrect.
//
...
// MessageText:
//
// The activation server reported that the format for the offline activation
// data is incorrect.
//
...
// MessageText:
//
// The activation server reported that the length of the offline Confirmation ID
// (CID) is incorrect.
//
...
// start date.
//
#define SL_REMAPPING_MDOLLAR_TIMEBASED_ACTIVATION_BEFORE_START_DATE            \
  ((HRESULT)0x803FA097L)
...
// date.
//
#define SL_REMAPPING_MDOLLAR_TIMEBASED_ACTIVATION_AFTER_END_DATE               \
  ((HRESULT)0x803FA098L)
...
// available.
//
#define SL_REMAPPING_MDOLLAR_TIMEBASED_ACTIVATION_NOT_AVAILABLE                \
  ((HRESULT)0x803FA099L)
...
// configured for activation.
//
#define SL_REMAPPING_MDOLLAR_TIMEBASED_PRODUCT_KEY_NOT_CONFIGURED              \
  ((HRESULT)0x803FA09AL)
...
// for this geographic location.
//
#define SL_REMAPPING_MDOLLAR_PRODUCT_KEY_BLOCKED_IPLOCATION                    \
  ((HRESULT)0x803FA0CBL)
...
// The activation server determined the license is invalid.
//
#define SL_REMAPPING_MDOLLAR_DIGITALMARKER_INVALID_BINDING                     \
  ((HRESULT)0x803FA0D3L)
...
// product key.
//
#define SL_REMAPPING_MDOLLAR_DIGITALMARKER_BINDING_NOT_CONFIGURED              \
  ((HRESULT)0x803FA0D4L)
...
// MessageText:
//
// Error indicating that the donor hardwareId does not own operating system
// entitlement.
//
#define SL_REMAPPING_MDOLLAR_OSR_DONOR_HWID_NO_ENTITLEMENT                     \
  ((HRESULT)0x803FABB8L)
...
// MessageText:
//
// Error code indicating that user not eligible for reactivation.(Generic error
// code)
//
...
// MessageText:
//
// Error code indicating that user not eligible for reactivation due to no
// association
//
...
// MessageText:
//
// Error code indicating that user not eligible for reactivation because user is
// not an admin on device
//
...
// MessageText:
//
// Error code indicating that user not eligible for reactivation because license
// is throttled.
//
...
// MessageText:
//
// Error code indicating that device is not eligible for reactivation because it
// is throttled.
//
...
// MessageText:
//
// Error code indicating that user not eligible for because policy does not
// allow it.
//
...
// MessageText:
//
// Error code indicating that the device is not eligible for reactivation
...
// MessageText:
//
// Error code indicating that the user is not eligible for reactivation because
// the user is blocked.
//
...
// MessageText:
//
// Error code indicating that the license is not eligible for transfer because
...
// MessageText:
//
// Error code indicating that the device is not eligible for transfer because
