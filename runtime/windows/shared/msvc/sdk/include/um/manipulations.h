...
DECLSPEC_SELECTANY extern const float NEGATIVE_INFINITY =
    ((float)(-1e308 * 10));
...
typedef struct _IManipulationEventsVtbl {
  ...
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in _IManipulationEvents *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in _IManipulationEvents *This);
...
#define _IManipulationEvents_ManipulationDelta(                                \
    This, x, y, translationDeltaX, translationDeltaY, scaleDelta,              \
    expansionDelta, rotationDelta, cumulativeTranslationX,                     \
    cumulativeTranslationY, cumulativeScale, cumulativeExpansion,              \
    cumulativeRotation)                                                        \
  ((This)->lpVtbl->ManipulationDelta(                                          \
      This, x, y, translationDeltaX, translationDeltaY, scaleDelta,            \
      expansionDelta, rotationDelta, cumulativeTranslationX,                   \
      cumulativeTranslationY, cumulativeScale, cumulativeExpansion,            \
      cumulativeRotation))

#define _IManipulationEvents_ManipulationCompleted(                            \
    This, x, y, cumulativeTranslationX, cumulativeTranslationY,                \
    cumulativeScale, cumulativeExpansion, cumulativeRotation)                  \
  ((This)->lpVtbl->ManipulationCompleted(                                      \
      This, x, y, cumulativeTranslationX, cumulativeTranslationY,              \
      cumulativeScale, cumulativeExpansion, cumulativeRotation))
...
typedef struct IInertiaProcessorVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in IInertiaProcessor *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IInertiaProcessor *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IInertiaProcessor *This);
  ...
  HRESULT(STDMETHODCALLTYPE *put_BoundaryTop)(__RPC__in IInertiaProcessor *This,
                                              /* [in] */ FLOAT top);
  ...
  HRESULT(STDMETHODCALLTYPE *Reset)(__RPC__in IInertiaProcessor *This);

  DECLSPEC_XFGVIRT(IInertiaProcessor, Process)
  HRESULT(STDMETHODCALLTYPE *Process)(__RPC__in IInertiaProcessor *This,
  ...
  HRESULT(STDMETHODCALLTYPE *Complete)(__RPC__in IInertiaProcessor *This);

  DECLSPEC_XFGVIRT(IInertiaProcessor, CompleteTime)
  HRESULT(STDMETHODCALLTYPE *CompleteTime)(__RPC__in IInertiaProcessor *This,
                                           /* [in] */ DWORD timestamp);
...
public:
  virtual HRESULT STDMETHODCALLTYPE get_SupportedManipulations(
      /* [out] */ __RPC__out MANIPULATION_PROCESSOR_MANIPULATIONS *
      manipulations) = 0;
...
typedef struct IManipulationProcessorVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IManipulationProcessor *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IManipulationProcessor *This);
  ...
  HRESULT(STDMETHODCALLTYPE *ProcessUp)(__RPC__in IManipulationProcessor *This,
                                        /* [in] */ MANIPULATOR_ID manipulatorId,
                                        /* [in] */ FLOAT x,
                                        /* [in] */ FLOAT y);
...
#define IManipulationProcessor_ProcessDownWithTime(This, manipulatorId, x, y,  \
                                                   timestamp)                  \
  ((This)->lpVtbl->ProcessDownWithTime(This, manipulatorId, x, y, timestamp))

#define IManipulationProcessor_ProcessMoveWithTime(This, manipulatorId, x, y,  \
                                                   timestamp)                  \
  ((This)->lpVtbl->ProcessMoveWithTime(This, manipulatorId, x, y, timestamp))

#define IManipulationProcessor_ProcessUpWithTime(This, manipulatorId, x, y,    \
                                                 timestamp)                    \
...
class DECLSPEC_UUID("abb27087-4ce0-4e58-a0cb-e24df96814be") InertiaProcessor;
#endif
