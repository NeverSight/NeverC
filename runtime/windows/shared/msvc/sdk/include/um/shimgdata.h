...
#define E_NOTVALIDFORANIMATEDIMAGE                                             \
  MAKE_HRESULT(SEVERITY_ERROR, FACILITY_ITF, 0x01)
...
typedef struct IShellImageDataFactoryVtbl {
  ...
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IShellImageDataFactory *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IShellImageDataFactory *This);
...
#define IShellImageDataFactory_GetDataFormatFromPath(This, pszPath,            \
                                                     pDataFormat)              \
...
typedef struct IShellImageDataVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(IShellImageData *This,
                                             /* [in] */ REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);
  ...
  HRESULT(STDMETHODCALLTYPE *Decode)(IShellImageData *This,
                                     /* [in] */ DWORD dwFlags,
                                     /* [in] */ ULONG cxDesired,
                                     /* [in] */ ULONG cyDesired);

  DECLSPEC_XFGVIRT(IShellImageData, Draw)
  HRESULT(STDMETHODCALLTYPE *Draw)(IShellImageData *This,
                                   /* [in] */ HDC hdc,
                                   /* [in] */ LPRECT prcDest,
                                   /* [in] */ LPRECT prcSrc);
  ...
  HRESULT(STDMETHODCALLTYPE *GetCurrentPage)(IShellImageData *This,
                                             /* [out] */ ULONG *pnPage);

  DECLSPEC_XFGVIRT(IShellImageData, GetPageCount)
  HRESULT(STDMETHODCALLTYPE *GetPageCount)(IShellImageData *This,
                                           /* [out] */ ULONG *pcPages);

  DECLSPEC_XFGVIRT(IShellImageData, SelectPage)
  HRESULT(STDMETHODCALLTYPE *SelectPage)(IShellImageData *This,
                                         /* [in] */ ULONG iPage);

  DECLSPEC_XFGVIRT(IShellImageData, GetSize)
  HRESULT(STDMETHODCALLTYPE *GetSize)(IShellImageData *This,
                                      /* [out] */ SIZE *pSize);

  DECLSPEC_XFGVIRT(IShellImageData, GetRawDataFormat)
  HRESULT(STDMETHODCALLTYPE *GetRawDataFormat)(IShellImageData *This,
                                               /* [out] */ GUID *pDataFormat);

  DECLSPEC_XFGVIRT(IShellImageData, GetPixelFormat)
  HRESULT(STDMETHODCALLTYPE *GetPixelFormat)(IShellImageData *This,
                                             /* [out] */ PixelFormat *pFormat);

  DECLSPEC_XFGVIRT(IShellImageData, GetDelay)
  HRESULT(STDMETHODCALLTYPE *GetDelay)(IShellImageData *This,
                                       /* [out] */ DWORD *pdwDelay);
  ...
  HRESULT(STDMETHODCALLTYPE *Rotate)(IShellImageData *This,
                                     /* [in] */ DWORD dwAngle);

  DECLSPEC_XFGVIRT(IShellImageData, Scale)
  HRESULT(STDMETHODCALLTYPE *Scale)(IShellImageData *This,
                                    /* [in] */ ULONG cx,
                                    /* [in] */ ULONG cy,
  ...
  HRESULT(STDMETHODCALLTYPE *GetResolution)(IShellImageData *This,
                                            /* [out] */ ULONG *puResolutionX,
  ...
  HRESULT(STDMETHODCALLTYPE *CloneFrame)(IShellImageData *This,
                                         /* [out] */ Image **ppImg);

  DECLSPEC_XFGVIRT(IShellImageData, ReplaceFrame)
  HRESULT(STDMETHODCALLTYPE *ReplaceFrame)(IShellImageData *This,
                                           /* [in] */ Image *pImg);

  END_INTERFACE
} IShellImageDataVtbl;

interface IShellImageData { CONST_VTBL struct IShellImageDataVtbl *lpVtbl; };
...
typedef struct IShellImageDataAbortVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IShellImageDataAbort *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IShellImageDataAbort *This);

  DECLSPEC_XFGVIRT(IShellImageDataAbort, QueryAbort)
  HRESULT(STDMETHODCALLTYPE *QueryAbort)(__RPC__in IShellImageDataAbort *This);
