...
typedef HRESULT(WINAPI *PFN_D3D11ON12_CREATE_DEVICE)(
    ...
    _In_reads_opt_(NumQueues) IUnknown * CONST *, UINT NumQueues, UINT,
...
typedef struct ID3D11On12DeviceVtbl {
  ...
  HRESULT(STDMETHODCALLTYPE *CreateWrappedResource)(
      ID3D11On12Device *This, _In_ IUnknown *pResource12,
      _In_ const D3D11_RESOURCE_FLAGS *pFlags11, D3D12_RESOURCE_STATES InState,
      D3D12_RESOURCE_STATES OutState, REFIID riid,
...
interface ID3D11On12Device { CONST_VTBL struct ID3D11On12DeviceVtbl *lpVtbl; };
...
#define ID3D11On12Device_CreateWrappedResource(                                \
    This, pResource12, pFlags11, InState, OutState, riid, ppResource11)        \
  ((This)->lpVtbl->CreateWrappedResource(This, pResource12, pFlags11, InState, \
                                         OutState, riid, ppResource11))

#define ID3D11On12Device_ReleaseWrappedResources(This, ppResources,            \
                                                 NumResources)                 \
  ((This)->lpVtbl->ReleaseWrappedResources(This, ppResources, NumResources))

#define ID3D11On12Device_AcquireWrappedResources(This, ppResources,            \
                                                 NumResources)                 \
...
public:
  virtual HRESULT STDMETHODCALLTYPE GetD3D12Device(
      REFIID riid, _COM_Outptr_ void **ppvDevice) = 0;
};
...
typedef struct ID3D11On12Device1Vtbl {
  ...
  DECLSPEC_XFGVIRT(ID3D11On12Device, CreateWrappedResource)
  HRESULT(STDMETHODCALLTYPE *CreateWrappedResource)(
      ID3D11On12Device1 *This, _In_ IUnknown *pResource12,
      _In_ const D3D11_RESOURCE_FLAGS *pFlags11, D3D12_RESOURCE_STATES InState,
      D3D12_RESOURCE_STATES OutState, REFIID riid,
      _COM_Outptr_opt_ void **ppResource11);
...
#define ID3D11On12Device1_CreateWrappedResource(                               \
    This, pResource12, pFlags11, InState, OutState, riid, ppResource11)        \
  ((This)->lpVtbl->CreateWrappedResource(This, pResource12, pFlags11, InState, \
                                         OutState, riid, ppResource11))

#define ID3D11On12Device1_ReleaseWrappedResources(This, ppResources,           \
                                                  NumResources)                \
  ((This)->lpVtbl->ReleaseWrappedResources(This, ppResources, NumResources))

#define ID3D11On12Device1_AcquireWrappedResources(This, ppResources,           \
                                                  NumResources)                \
  ((This)->lpVtbl->AcquireWrappedResources(This, ppResources, NumResources))
...
public:
  virtual HRESULT STDMETHODCALLTYPE UnwrapUnderlyingResource(
      ...
      _In_ ID3D12CommandQueue * pCommandQueue, REFIID riid,
      _COM_Outptr_ void **ppvResource12) = 0;

  virtual HRESULT STDMETHODCALLTYPE ReturnUnderlyingResource(
      _In_ ID3D11Resource * pResource11, UINT NumSync,
...
typedef struct ID3D11On12Device2Vtbl {
  ...
  DECLSPEC_XFGVIRT(ID3D11On12Device, CreateWrappedResource)
  HRESULT(STDMETHODCALLTYPE *CreateWrappedResource)(
      ID3D11On12Device2 *This, _In_ IUnknown *pResource12,
      _In_ const D3D11_RESOURCE_FLAGS *pFlags11, D3D12_RESOURCE_STATES InState,
      D3D12_RESOURCE_STATES OutState, REFIID riid,
      _COM_Outptr_opt_ void **ppResource11);
  ...
  HRESULT(STDMETHODCALLTYPE *UnwrapUnderlyingResource)(
      ID3D11On12Device2 *This, _In_ ID3D11Resource *pResource11,
      _In_ ID3D12CommandQueue *pCommandQueue, REFIID riid,
  ...
  HRESULT(STDMETHODCALLTYPE *ReturnUnderlyingResource)(
      ID3D11On12Device2 *This, _In_ ID3D11Resource *pResource11, UINT NumSync,
      _In_reads_(NumSync) UINT64 *pSignalValues,
...
#define ID3D11On12Device2_CreateWrappedResource(                               \
    This, pResource12, pFlags11, InState, OutState, riid, ppResource11)        \
  ((This)->lpVtbl->CreateWrappedResource(This, pResource12, pFlags11, InState, \
                                         OutState, riid, ppResource11))

#define ID3D11On12Device2_ReleaseWrappedResources(This, ppResources,           \
                                                  NumResources)                \
  ((This)->lpVtbl->ReleaseWrappedResources(This, ppResources, NumResources))

#define ID3D11On12Device2_AcquireWrappedResources(This, ppResources,           \
                                                  NumResources)                \
  ((This)->lpVtbl->AcquireWrappedResources(This, ppResources, NumResources))
...
#define ID3D11On12Device2_UnwrapUnderlyingResource(                            \
  ...
  ((This)->lpVtbl->UnwrapUnderlyingResource(This, pResource11, pCommandQueue,  \
                                            riid, ppvResource12))

#define ID3D11On12Device2_ReturnUnderlyingResource(This, pResource11, NumSync, \
                                                   pSignalValues, ppFences)    \
  ((This)->lpVtbl->ReturnUnderlyingResource(This, pResource11, NumSync,        \
                                            pSignalValues, ppFences))
