...
typedef interface IPrintWorkflowObjectModelSourceFileContentNative
...
typedef interface IPrintWorkflowXpsObjectModelTargetPackageNative
...
typedef interface IPrintWorkflowConfigurationNative
...
extern RPC_IF_HANDLE
    __MIDL_itf_windows2Egraphics2Eprinting2Eworkflow2Enative_0000_0000_v0_0_c_ifspec;
extern RPC_IF_HANDLE
    __MIDL_itf_windows2Egraphics2Eprinting2Eworkflow2Enative_0000_0000_v0_0_s_ifspec;
...
typedef struct IPrintWorkflowXpsReceiverVtbl {
  ...
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IPrintWorkflowXpsReceiver *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IPrintWorkflowXpsReceiver *This);
  ...
  HRESULT(STDMETHODCALLTYPE *Close)(__RPC__in IPrintWorkflowXpsReceiver *This);
...
#define IPrintWorkflowXpsReceiver_AddRef(This) ((This)->lpVtbl->AddRef(This))

#define IPrintWorkflowXpsReceiver_Release(This) ((This)->lpVtbl->Release(This))

#define IPrintWorkflowXpsReceiver_SetDocumentSequencePrintTicket(              \
    This, documentSequencePrintTicket)                                         \
  ((This)->lpVtbl->SetDocumentSequencePrintTicket(                             \
      This, documentSequencePrintTicket))

#define IPrintWorkflowXpsReceiver_SetDocumentSequenceUri(This,                 \
                                                         documentSequenceUri)  \
  ((This)->lpVtbl->SetDocumentSequenceUri(This, documentSequenceUri))

#define IPrintWorkflowXpsReceiver_AddDocumentData(                             \
    This, documentId, documentPrintTicket, documentUri)                        \
  ((This)->lpVtbl->AddDocumentData(This, documentId, documentPrintTicket,      \
                                   documentUri))

#define IPrintWorkflowXpsReceiver_AddPage(This, documentId, pageId,            \
                                          pageReference, pageUri)              \
  ((This)->lpVtbl->AddPage(This, documentId, pageId, pageReference, pageUri))

#define IPrintWorkflowXpsReceiver_Close(This) ((This)->lpVtbl->Close(This))
...
typedef struct IPrintWorkflowXpsReceiver2Vtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IPrintWorkflowXpsReceiver2 *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IPrintWorkflowXpsReceiver2 *This);
  ...
  DECLSPEC_XFGVIRT(IPrintWorkflowXpsReceiver, Close)
  HRESULT(STDMETHODCALLTYPE *Close)(__RPC__in IPrintWorkflowXpsReceiver2 *This);

  DECLSPEC_XFGVIRT(IPrintWorkflowXpsReceiver2, Failed)
  HRESULT(STDMETHODCALLTYPE *Failed)(__RPC__in IPrintWorkflowXpsReceiver2 *This,
                                     /* [in] */ HRESULT XpsError);
...
#define IPrintWorkflowXpsReceiver2_AddRef(This) ((This)->lpVtbl->AddRef(This))

#define IPrintWorkflowXpsReceiver2_Release(This) ((This)->lpVtbl->Release(This))

#define IPrintWorkflowXpsReceiver2_SetDocumentSequencePrintTicket(             \
    This, documentSequencePrintTicket)                                         \
  ((This)->lpVtbl->SetDocumentSequencePrintTicket(                             \
      This, documentSequencePrintTicket))

#define IPrintWorkflowXpsReceiver2_SetDocumentSequenceUri(This,                \
                                                          documentSequenceUri) \
  ((This)->lpVtbl->SetDocumentSequenceUri(This, documentSequenceUri))

#define IPrintWorkflowXpsReceiver2_AddDocumentData(                            \
    This, documentId, documentPrintTicket, documentUri)                        \
  ((This)->lpVtbl->AddDocumentData(This, documentId, documentPrintTicket,      \
                                   documentUri))

#define IPrintWorkflowXpsReceiver2_AddPage(This, documentId, pageId,           \
                                           pageReference, pageUri)             \
  ((This)->lpVtbl->AddPage(This, documentId, pageId, pageReference, pageUri))

#define IPrintWorkflowXpsReceiver2_Close(This) ((This)->lpVtbl->Close(This))
...
public:
  ...
  virtual /* [propget] */ HRESULT STDMETHODCALLTYPE get_ObjectFactory(
      /* [retval][out] */ __RPC__deref_out_opt IXpsOMObjectFactory1 *
      *value) = 0;
};
...
typedef struct IPrintWorkflowObjectModelSourceFileContentNativeVtbl {
  ...
  DECLSPEC_XFGVIRT(IPrintWorkflowObjectModelSourceFileContentNative,
...
interface IPrintWorkflowObjectModelSourceFileContentNative {
  CONST_VTBL struct IPrintWorkflowObjectModelSourceFileContentNativeVtbl
      *lpVtbl;
};

#ifdef COBJMACROS

#define IPrintWorkflowObjectModelSourceFileContentNative_QueryInterface(       \
    This, riid, ppvObject)                                                     \
  ((This)->lpVtbl->QueryInterface(This, riid, ppvObject))
...
#define IPrintWorkflowObjectModelSourceFileContentNative_StartXpsOMGeneration( \
    This, receiver)                                                            \
  ((This)->lpVtbl->StartXpsOMGeneration(This, receiver))

#define IPrintWorkflowObjectModelSourceFileContentNative_get_ObjectFactory(    \
    This, value)                                                               \
...
public:
  virtual /* [propget] */ HRESULT STDMETHODCALLTYPE get_DocumentPackageTarget(
      /* [retval][out] */ __RPC__deref_out_opt IXpsDocumentPackageTarget *
      *value) = 0;
};
...
typedef struct IPrintWorkflowXpsObjectModelTargetPackageNativeVtbl {
  ...
  DECLSPEC_XFGVIRT(IPrintWorkflowXpsObjectModelTargetPackageNative,
...
#define IPrintWorkflowXpsObjectModelTargetPackageNative_QueryInterface(        \
    This, riid, ppvObject)                                                     \
  ((This)->lpVtbl->QueryInterface(This, riid, ppvObject))
...
#define IPrintWorkflowXpsObjectModelTargetPackageNative_get_DocumentPackageTarget( \
    This, value)                                                                   \
...
public:
  ...
  virtual /* [propget] */ HRESULT STDMETHODCALLTYPE get_DriverProperties(
      /* [retval][out] */ __RPC__deref_out_opt IPrinterPropertyBag *
      *value) = 0;
...
#define IPrintWorkflowConfigurationNative_QueryInterface(This, riid,           \
                                                         ppvObject)            \
  ((This)->lpVtbl->QueryInterface(This, riid, ppvObject))
