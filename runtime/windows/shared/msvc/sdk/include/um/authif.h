...
typedef enum _RADIUS_ATTRIBUTE_TYPE {
  ...
  ratCertificateThumbprint =
      279, /* The thumbprint of client auth certificate */
...
typedef DWORD(WINAPI *PRADIUS_EXTENSION_PROCESS)(
    IN const RADIUS_ATTRIBUTE *pAttrs, OUT OPTIONAL PRADIUS_ACTION pfAction);
...
typedef DWORD(WINAPI *PRADIUS_EXTENSION_PROCESS_EX)(
    IN const RADIUS_ATTRIBUTE *pInAttrs, OUT PRADIUS_ATTRIBUTE *pOutAttrs,
...
typedef struct _RADIUS_ATTRIBUTE_ARRAY {
  ...
  DWORD(WINAPI *Add)(IN struct _RADIUS_ATTRIBUTE_ARRAY *This,
  ...
  const RADIUS_ATTRIBUTE *(WINAPI *AttributeAt)(
      IN const struct _RADIUS_ATTRIBUTE_ARRAY *This, IN DWORD dwIndex);

  /*
   * Returns the size of the array. Since indexes are zero-based, the size is
   * 1 greater than the largest index.
   */
  DWORD(WINAPI *GetSize)(IN const struct _RADIUS_ATTRIBUTE_ARRAY *This);
   ...
   */
  DWORD(WINAPI *InsertAt)(IN struct _RADIUS_ATTRIBUTE_ARRAY *This,
                          IN DWORD dwIndex, IN const RADIUS_ATTRIBUTE *pAttr);
   ...
   */
  DWORD(WINAPI *RemoveAt)(IN struct _RADIUS_ATTRIBUTE_ARRAY *This,
                          IN DWORD dwIndex);
   ...
   */
  DWORD(WINAPI *SetAt)(IN struct _RADIUS_ATTRIBUTE_ARRAY *This,
                       IN DWORD dwIndex, IN const RADIUS_ATTRIBUTE *pAttr);
