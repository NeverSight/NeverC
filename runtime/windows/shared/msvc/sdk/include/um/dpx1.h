...
typedef interface IEnumDpxContainerDirectoryEntries
...
typedef /* [public][public][public][public][public][public][public] */
    struct __MIDL___MIDL_itf_dpx1_0000_0000_0002 {
  ALG_ID AlgorithmId;
  UINT HashSize;
...
typedef /* [public][public][public][public][public] */
    struct __MIDL___MIDL_itf_dpx1_0000_0000_0003 {
  UINT64 Offset;
  UINT64 Length;
} DPX_BYTE_RANGE;
...
typedef /* [public][public][public][public][public][public][public][public][public][public][public][public]
         */
    struct __MIDL___MIDL_itf_dpx1_0000_0000_0005 {
  UINT64 Completed;
  UINT64 Remaining;
} DPX_PROGRESS_REMAIN;
...
#define DPX_COMPRESSION_ALGORITHM_OPTION_NAME                                  \
  L"postprocess_compression_algorithm"
...
public:
  ...
  virtual HRESULT STDMETHODCALLTYPE EnumContainers(
      /* [out] */ __RPC__deref_out_opt IEnumDpxContainers *
      *ppEnumContainers) = 0;

  virtual HRESULT STDMETHODCALLTYPE SetDownloadProvider(
      /* [unique][in] */ __RPC__in_opt IDpxDownloadProvider *
      pDownloadProvider) = 0;

  virtual HRESULT STDMETHODCALLTYPE GetDownloadProvider(
      /* [out] */ __RPC__deref_out_opt IDpxDownloadProvider *
      *ppDownloadProvider) = 0;

  virtual HRESULT STDMETHODCALLTYPE Resume(DPX_RESUME_TYPE eResumeType) = 0;
...
typedef struct IDpxJobVtbl {
  ...
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in IDpxJob *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IDpxJob *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IDpxJob *This);
  ...
  HRESULT(STDMETHODCALLTYPE *Resume)(__RPC__in IDpxJob *This,
                                     DPX_RESUME_TYPE eResumeType);

  DECLSPEC_XFGVIRT(IDpxJob, Suspend)
  HRESULT(STDMETHODCALLTYPE *Suspend)(__RPC__in IDpxJob *This);

  DECLSPEC_XFGVIRT(IDpxJob, Cancel)
  HRESULT(STDMETHODCALLTYPE *Cancel)(__RPC__in IDpxJob *This);
  ...
  HRESULT(STDMETHODCALLTYPE *SaveJobState)(__RPC__in IDpxJob *This);

  DECLSPEC_XFGVIRT(IDpxJob, SetUserValue)
  HRESULT(STDMETHODCALLTYPE *SetUserValue)(__RPC__in IDpxJob *This,
                                           /* [in] */ UINT64 UserValue);
...
interface IDpxJob { CONST_VTBL struct IDpxJobVtbl *lpVtbl; };
...
public:
  virtual HRESULT STDMETHODCALLTYPE GetFileHash(
      ...
      /* [in] */ UINT cbHashData,
      /* [size_is][out] */
      __RPC__out_ecount_full(cbHashData) BYTE pbHashData[]) = 0;
};
...
typedef struct IFileHashProviderCallbackVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IFileHashProviderCallback *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IFileHashProviderCallback *This);
...
#define IFileHashProviderCallback_GetFileHash(                                 \
    This, FilePath, algId, pDisposition, cbHashData, pbHashData)               \
  ((This)->lpVtbl->GetFileHash(This, FilePath, algId, pDisposition,            \
                               cbHashData, pbHashData))
...
typedef struct IDpxJob2Vtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in IDpxJob2 *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IDpxJob2 *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IDpxJob2 *This);
  ...
  DECLSPEC_XFGVIRT(IDpxJob, Resume)
  HRESULT(STDMETHODCALLTYPE *Resume)(__RPC__in IDpxJob2 *This,
                                     DPX_RESUME_TYPE eResumeType);

  DECLSPEC_XFGVIRT(IDpxJob, Suspend)
  HRESULT(STDMETHODCALLTYPE *Suspend)(__RPC__in IDpxJob2 *This);

  DECLSPEC_XFGVIRT(IDpxJob, Cancel)
  HRESULT(STDMETHODCALLTYPE *Cancel)(__RPC__in IDpxJob2 *This);
  ...
  DECLSPEC_XFGVIRT(IDpxJob, SaveJobState)
  HRESULT(STDMETHODCALLTYPE *SaveJobState)(__RPC__in IDpxJob2 *This);

  DECLSPEC_XFGVIRT(IDpxJob, SetUserValue)
  HRESULT(STDMETHODCALLTYPE *SetUserValue)(__RPC__in IDpxJob2 *This,
                                           /* [in] */ UINT64 UserValue);
...
interface IDpxJob2 { CONST_VTBL struct IDpxJob2Vtbl *lpVtbl; };
...
public:
  ...
  virtual HRESULT STDMETHODCALLTYPE ProvideContainerIndex(
      /* [in] */ UINT IndexSize,
      /* [size_is][in] */ __RPC__in_ecount_full(IndexSize)
          BYTE IndexData[]) = 0;
  ...
  virtual HRESULT STDMETHODCALLTYPE EnumDirectoryEntries(
      /* [out] */ __RPC__deref_out_opt IEnumDpxContainerDirectoryEntries *
      *ppEnumEntries) = 0;
...
typedef struct IDpxContainerVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in IDpxContainer *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IDpxContainer *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IDpxContainer *This);

  DECLSPEC_XFGVIRT(IDpxContainer, SetContainerPath)
  HRESULT(STDMETHODCALLTYPE *SetContainerPath)(__RPC__in IDpxContainer *This,
  ...
  HRESULT(STDMETHODCALLTYPE *ExtractAllFiles)(__RPC__in IDpxContainer *This);
  ...
  HRESULT(STDMETHODCALLTYPE *Remove)(__RPC__in IDpxContainer *This);

  DECLSPEC_XFGVIRT(IDpxContainer, SetUserValue)
  HRESULT(STDMETHODCALLTYPE *SetUserValue)(__RPC__in IDpxContainer *This,
                                           /* [in] */ UINT64 UserValue);
...
interface IDpxContainer { CONST_VTBL struct IDpxContainerVtbl *lpVtbl; };
...
#define IDpxContainer_AddFileToExtract(This, SourceFileName, TargetFileName,   \
                                       TargetFileHash)                         \
  ((This)->lpVtbl->AddFileToExtract(This, SourceFileName, TargetFileName,      \
                                    TargetFileHash))

#define IDpxContainer_AddFileToExtract2(This, SourceFileName, TargetFileName,  \
                                        ppFile)                                \
  ((This)->lpVtbl->AddFileToExtract2(This, SourceFileName, TargetFileName,     \
                                     ppFile))
...
typedef struct IDpxFileVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in IDpxFile *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IDpxFile *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IDpxFile *This);
  ...
  HRESULT(STDMETHODCALLTYPE *Remove)(__RPC__in IDpxFile *This);

  DECLSPEC_XFGVIRT(IDpxFile, SetUserValue)
  HRESULT(STDMETHODCALLTYPE *SetUserValue)(__RPC__in IDpxFile *This,
                                           /* [in] */ UINT64 UserValue);
...
interface IDpxFile { CONST_VTBL struct IDpxFileVtbl *lpVtbl; };
...
typedef struct IDpxFile2Vtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in IDpxFile2 *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IDpxFile2 *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IDpxFile2 *This);
  ...
  DECLSPEC_XFGVIRT(IDpxFile, Remove)
  HRESULT(STDMETHODCALLTYPE *Remove)(__RPC__in IDpxFile2 *This);

  DECLSPEC_XFGVIRT(IDpxFile, SetUserValue)
  HRESULT(STDMETHODCALLTYPE *SetUserValue)(__RPC__in IDpxFile2 *This,
                                           /* [in] */ UINT64 UserValue);
  ...
  HRESULT(STDMETHODCALLTYPE *GetSize)(__RPC__in IDpxFile2 *This,
                                      /* [out] */ __RPC__out UINT64 *pSize);

  END_INTERFACE
} IDpxFile2Vtbl;

interface IDpxFile2 { CONST_VTBL struct IDpxFile2Vtbl *lpVtbl; };
...
typedef struct IDpxContainerDirectoryEntryVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IDpxContainerDirectoryEntry *This);
...
public:
  ...
  virtual HRESULT STDMETHODCALLTYPE GetProvideDataCallback(
      /* [out] */ __RPC__deref_out_opt IDpxDownloadCallback *
      *ppProvideData) = 0;
  ...
  virtual HRESULT STDMETHODCALLTYPE AddRanges(
      ...
      /* [in] */ UINT RangeCount,
      /* [size_is][in] */
      __RPC__in_ecount_full(RangeCount) DPX_BYTE_RANGE RangeList[]) = 0;
  ...
  virtual HRESULT STDMETHODCALLTYPE GetRanges(
      ...
      /* [size_is][size_is][out] */
      __RPC__deref_out_ecount_full_opt(*RangeCount) DPX_BYTE_RANGE *
          *ppRangeArray) = 0;
...
typedef struct IDpxDownloadProviderVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IDpxDownloadProvider *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IDpxDownloadProvider *This);
  ...
  HRESULT(STDMETHODCALLTYPE *AddRanges)(__RPC__in IDpxDownloadProvider *This,
                                        /* [in] */ UINT64 ContainerId,
                                        /* [in] */ UINT RangeCount,
                                        /* [size_is][in] */
                                        __RPC__in_ecount_full(RangeCount)
  ...
  HRESULT(STDMETHODCALLTYPE *GetContainers)(
      ...
      /* [out] */ __RPC__out UINT *ContainerCount,
      /* [size_is][size_is][out] */
      __RPC__deref_out_ecount_full_opt(*ContainerCount)
  ...
  HRESULT(STDMETHODCALLTYPE *GetRanges)(
      ...
      /* [out] */ __RPC__out UINT *RangeCount,
      /* [size_is][size_is][out] */
      __RPC__deref_out_ecount_full_opt(*RangeCount)
          DPX_BYTE_RANGE **ppRangeArray);

  DECLSPEC_XFGVIRT(IDpxDownloadProvider, Resume)
  HRESULT(STDMETHODCALLTYPE *Resume)(__RPC__in IDpxDownloadProvider *This);

  DECLSPEC_XFGVIRT(IDpxDownloadProvider, Suspend)
  HRESULT(STDMETHODCALLTYPE *Suspend)(__RPC__in IDpxDownloadProvider *This);

  DECLSPEC_XFGVIRT(IDpxDownloadProvider, Cancel)
  HRESULT(STDMETHODCALLTYPE *Cancel)(__RPC__in IDpxDownloadProvider *This);
...
#define IDpxDownloadProvider_AddContainer(This, ContainerFilePath,             \
                                          ContainerId)                         \
  ((This)->lpVtbl->AddContainer(This, ContainerFilePath, ContainerId))

#define IDpxDownloadProvider_AddRanges(This, ContainerId, RangeCount,          \
                                       RangeList)                              \
  ((This)->lpVtbl->AddRanges(This, ContainerId, RangeCount, RangeList))

#define IDpxDownloadProvider_GetContainers(This, ContainerCount,               \
                                           ppContainerIdArray)                 \
  ((This)->lpVtbl->GetContainers(This, ContainerCount, ppContainerIdArray))

#define IDpxDownloadProvider_GetContainerPath(This, ContainerId,               \
                                              ContainerPath)                   \
  ((This)->lpVtbl->GetContainerPath(This, ContainerId, ContainerPath))

#define IDpxDownloadProvider_GetRanges(                                        \
    This, ContainerId, IncludeCompletedRanges, RangeCount, ppRangeArray)       \
  ((This)->lpVtbl->GetRanges(This, ContainerId, IncludeCompletedRanges,        \
                             RangeCount, ppRangeArray))
...
public:
  virtual HRESULT STDMETHODCALLTYPE ProvideRequestedData(
      ...
      /* [size_is][in] */
      __RPC__in_ecount_full(RangeCount) const BYTE *RangeData[]) = 0;
  ...
  virtual HRESULT STDMETHODCALLTYPE ProvideRequestedDataByFile(
      ...
      /* [size_is][in] */
      __RPC__in_ecount_full(RangeCount) UINT64 OffsetInResponseFile[]) = 0;
...
typedef struct IDpxDownloadCallbackVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IDpxDownloadCallback *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IDpxDownloadCallback *This);
...
#define IDpxDownloadCallback_ProvideRequestedData(                             \
    This, ContainerId, RangeCount, RangeList, RangeData)                       \
  ((This)->lpVtbl->ProvideRequestedData(This, ContainerId, RangeCount,         \
                                        RangeList, RangeData))

#define IDpxDownloadCallback_ProvideRequestedDataByFile(                       \
    This, ContainerId, ResponseFilePath, RangeCount, RangeArray,               \
    OffsetInResponseFile)                                                      \
  ((This)->lpVtbl->ProvideRequestedDataByFile(                                 \
      This, ContainerId, ResponseFilePath, RangeCount, RangeArray,             \
      OffsetInResponseFile))

#define IDpxDownloadCallback_ProvideRequestedDataByPackedRangeFile(            \
    This, ContainerId, ResponseFilePath)                                       \
  ((This)->lpVtbl->ProvideRequestedDataByPackedRangeFile(This, ContainerId,    \
                                                         ResponseFilePath))
...
public:
  virtual HRESULT STDMETHODCALLTYPE Next(
      ...
      __RPC__out_ecount_part(ItemCount, *pFetchedCount) IDpxContainer *
          *ppContainers,
...
typedef struct IEnumDpxContainersVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in IEnumDpxContainers *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IEnumDpxContainers *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IEnumDpxContainers *This);

  DECLSPEC_XFGVIRT(IEnumDpxContainers, Next)
  HRESULT(STDMETHODCALLTYPE *Next)(__RPC__in IEnumDpxContainers *This,
                                   /* [in] */ UINT ItemCount,
                                   /* [length_is][size_is][out] */
                                   __RPC__out_ecount_part(ItemCount,
                                                          *pFetchedCount)
                                       IDpxContainer **ppContainers,
                                   /* [out] */ __RPC__out UINT *pFetchedCount);

  DECLSPEC_XFGVIRT(IEnumDpxContainers, Skip)
  HRESULT(STDMETHODCALLTYPE *Skip)(__RPC__in IEnumDpxContainers *This,
                                   /* [in] */ UINT ItemCount);

  DECLSPEC_XFGVIRT(IEnumDpxContainers, Reset)
  HRESULT(STDMETHODCALLTYPE *Reset)(__RPC__in IEnumDpxContainers *This);
  ...
  HRESULT(STDMETHODCALLTYPE *GetCount)(__RPC__in IEnumDpxContainers *This,
...
typedef struct IEnumDpxFilesVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in IEnumDpxFiles *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IEnumDpxFiles *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IEnumDpxFiles *This);

  DECLSPEC_XFGVIRT(IEnumDpxFiles, Next)
  HRESULT(STDMETHODCALLTYPE *Next)(__RPC__in IEnumDpxFiles *This,
                                   /* [in] */ UINT ItemCount,
                                   /* [length_is][size_is][out] */
                                   __RPC__out_ecount_part(ItemCount,
                                                          *pFetchedCount)
  ...
  HRESULT(STDMETHODCALLTYPE *Skip)(__RPC__in IEnumDpxFiles *This,
                                   /* [in] */ UINT ItemCount);

  DECLSPEC_XFGVIRT(IEnumDpxFiles, Reset)
  HRESULT(STDMETHODCALLTYPE *Reset)(__RPC__in IEnumDpxFiles *This);
  ...
  HRESULT(STDMETHODCALLTYPE *GetCount)(__RPC__in IEnumDpxFiles *This,
                                       /* [out] */ __RPC__out UINT *pItemCount);

  END_INTERFACE
} IEnumDpxFilesVtbl;

interface IEnumDpxFiles { CONST_VTBL struct IEnumDpxFilesVtbl *lpVtbl; };
...
public:
  virtual HRESULT STDMETHODCALLTYPE Next(
      /* [in] */ UINT ItemCount,
      /* [length_is][size_is][out] */
      __RPC__out_ecount_part(ItemCount, *pFetchedCount)
              IDpxContainerDirectoryEntry *
          *ppDirectoryEntries,
      /* [out] */ __RPC__out UINT * pFetchedCount) = 0;
...
#define IEnumDpxContainerDirectoryEntries_QueryInterface(This, riid,           \
                                                         ppvObject)            \
  ((This)->lpVtbl->QueryInterface(This, riid, ppvObject))
...
#define IEnumDpxContainerDirectoryEntries_Next(                                \
    This, ItemCount, ppDirectoryEntries, pFetchedCount)                        \
...
public:
  virtual HRESULT STDMETHODCALLTYPE SetContainerDecryption(
      ...
      /* [size_is][in] */
      __RPC__in_ecount_full(DecryptionDataCount)
...
typedef struct IDpxEncryptedContainerVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IDpxEncryptedContainer *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IDpxEncryptedContainer *This);
  ...
  DECLSPEC_XFGVIRT(IDpxContainer, Remove)
  HRESULT(STDMETHODCALLTYPE *Remove)(__RPC__in IDpxEncryptedContainer *This);
...
#define IDpxEncryptedContainer_AddFileToExtract(                               \
    This, SourceFileName, TargetFileName, TargetFileHash)                      \
  ((This)->lpVtbl->AddFileToExtract(This, SourceFileName, TargetFileName,      \
                                    TargetFileHash))

#define IDpxEncryptedContainer_AddFileToExtract2(This, SourceFileName,         \
                                                 TargetFileName, ppFile)       \
  ((This)->lpVtbl->AddFileToExtract2(This, SourceFileName, TargetFileName,     \
                                     ppFile))
...
#define IDpxEncryptedContainer_SetExpectedContainerIndexHash(This,             \
                                                             pExpectedHash)    \
  ((This)->lpVtbl->SetExpectedContainerIndexHash(This, pExpectedHash))

#define IDpxEncryptedContainer_GetExpectedContainerIndexHash(This,             \
                                                             ppExpectedHash)   \
  ((This)->lpVtbl->GetExpectedContainerIndexHash(This, ppExpectedHash))

#define IDpxEncryptedContainer_ProvideContainerIndex(This, IndexSize,          \
                                                     IndexData)                \
  ((This)->lpVtbl->ProvideContainerIndex(This, IndexSize, IndexData))

#define IDpxEncryptedContainer_ProvideContainerIndexByFile(This,               \
                                                           IndexFileName)      \
  ((This)->lpVtbl->ProvideContainerIndexByFile(This, IndexFileName))
...
#define IDpxEncryptedContainer_SetContainerDecryption(                         \
    This, DecryptionDataCount, DecryptionData, EncryptionType)                 \
  ((This)->lpVtbl->SetContainerDecryption(This, DecryptionDataCount,           \
                                          DecryptionData, EncryptionType))
...
public:
  virtual HRESULT STDMETHODCALLTYPE AddPredecessorContainer(
      ...
      /* [size_is][in] */
      __RPC__in_ecount_full(PredecessorFilePathsCount)
...
typedef struct IDpxContainer2Vtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in IDpxContainer2 *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IDpxContainer2 *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IDpxContainer2 *This);

  DECLSPEC_XFGVIRT(IDpxContainer, SetContainerPath)
  HRESULT(STDMETHODCALLTYPE *SetContainerPath)(__RPC__in IDpxContainer2 *This,
                                               /* [in] */ __RPC__in LPCWSTR
                                                   ContainerPath);
  ...
  DECLSPEC_XFGVIRT(IDpxContainer, ExtractAllFiles)
  HRESULT(STDMETHODCALLTYPE *ExtractAllFiles)(__RPC__in IDpxContainer2 *This);
  ...
  DECLSPEC_XFGVIRT(IDpxContainer, Remove)
  HRESULT(STDMETHODCALLTYPE *Remove)(__RPC__in IDpxContainer2 *This);

  DECLSPEC_XFGVIRT(IDpxContainer, SetUserValue)
  HRESULT(STDMETHODCALLTYPE *SetUserValue)(__RPC__in IDpxContainer2 *This,
                                           /* [in] */ UINT64 UserValue);
...
interface IDpxContainer2 { CONST_VTBL struct IDpxContainer2Vtbl *lpVtbl; };
...
#define IDpxContainer2_AddFileToExtract(This, SourceFileName, TargetFileName,  \
                                        TargetFileHash)                        \
  ((This)->lpVtbl->AddFileToExtract(This, SourceFileName, TargetFileName,      \
                                    TargetFileHash))

#define IDpxContainer2_AddFileToExtract2(This, SourceFileName, TargetFileName, \
                                         ppFile)                               \
  ((This)->lpVtbl->AddFileToExtract2(This, SourceFileName, TargetFileName,     \
                                     ppFile))
...
#define IDpxContainer2_SetContainerDecryption(This, DecryptionDataCount,       \
                                              DecryptionData, EncryptionType)  \
  ((This)->lpVtbl->SetContainerDecryption(This, DecryptionDataCount,           \
                                          DecryptionData, EncryptionType))

#define IDpxContainer2_AddPredecessorContainer(                                \
    This, ContainerPath, PredecessorFilePathsCount, PredecessorFilePaths,      \
    ppContainer)                                                               \
  ((This)->lpVtbl->AddPredecessorContainer(This, ContainerPath,                \
                                           PredecessorFilePathsCount,          \
                                           PredecessorFilePaths, ppContainer))
...
typedef struct IDpxContainer3Vtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in IDpxContainer3 *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IDpxContainer3 *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IDpxContainer3 *This);

  DECLSPEC_XFGVIRT(IDpxContainer, SetContainerPath)
  HRESULT(STDMETHODCALLTYPE *SetContainerPath)(__RPC__in IDpxContainer3 *This,
                                               /* [in] */ __RPC__in LPCWSTR
                                                   ContainerPath);
  ...
  DECLSPEC_XFGVIRT(IDpxContainer, ExtractAllFiles)
  HRESULT(STDMETHODCALLTYPE *ExtractAllFiles)(__RPC__in IDpxContainer3 *This);
  ...
  DECLSPEC_XFGVIRT(IDpxContainer, Remove)
  HRESULT(STDMETHODCALLTYPE *Remove)(__RPC__in IDpxContainer3 *This);

  DECLSPEC_XFGVIRT(IDpxContainer, SetUserValue)
  HRESULT(STDMETHODCALLTYPE *SetUserValue)(__RPC__in IDpxContainer3 *This,
                                           /* [in] */ UINT64 UserValue);
...
interface IDpxContainer3 { CONST_VTBL struct IDpxContainer3Vtbl *lpVtbl; };
...
#define IDpxContainer3_AddFileToExtract(This, SourceFileName, TargetFileName,  \
                                        TargetFileHash)                        \
  ((This)->lpVtbl->AddFileToExtract(This, SourceFileName, TargetFileName,      \
                                    TargetFileHash))

#define IDpxContainer3_AddFileToExtract2(This, SourceFileName, TargetFileName, \
                                         ppFile)                               \
  ((This)->lpVtbl->AddFileToExtract2(This, SourceFileName, TargetFileName,     \
                                     ppFile))
...
#define IDpxContainer3_SetContainerDecryption(This, DecryptionDataCount,       \
                                              DecryptionData, EncryptionType)  \
  ((This)->lpVtbl->SetContainerDecryption(This, DecryptionDataCount,           \
                                          DecryptionData, EncryptionType))

#define IDpxContainer3_AddPredecessorContainer(                                \
    This, ContainerPath, PredecessorFilePathsCount, PredecessorFilePaths,      \
    ppContainer)                                                               \
  ((This)->lpVtbl->AddPredecessorContainer(This, ContainerPath,                \
                                           PredecessorFilePathsCount,          \
