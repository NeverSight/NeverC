...
typedef struct IPrinting3DManagerInteropVtbl {
  ...
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IPrinting3DManagerInterop *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IPrinting3DManagerInterop *This);
...
#define IPrinting3DManagerInterop_AddRef(This) ((This)->lpVtbl->AddRef(This))

#define IPrinting3DManagerInterop_Release(This) ((This)->lpVtbl->Release(This))
...
#define IPrinting3DManagerInterop_GetForWindow(This, appWindow, riid,          \
                                               printManager)                   \
  ((This)->lpVtbl->GetForWindow(This, appWindow, riid, printManager))

#define IPrinting3DManagerInterop_ShowPrintUIForWindowAsync(                   \
    This, appWindow, riid, asyncOperation)                                     \
  ((This)->lpVtbl->ShowPrintUIForWindowAsync(This, appWindow, riid,            \
                                             asyncOperation))
