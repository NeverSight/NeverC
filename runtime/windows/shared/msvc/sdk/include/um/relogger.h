...
typedef struct ITraceEventVtbl {
  ...
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(ITraceEvent *This,
                                             /* [in] */ REFIID riid,
  ...
  HRESULT(STDMETHODCALLTYPE *Clone)(ITraceEvent *This,
  ...
  HRESULT(STDMETHODCALLTYPE *SetPayload)(ITraceEvent *This,
                                         /* [size_is][in] */ BYTE *Payload,
  ...
  HRESULT(STDMETHODCALLTYPE *SetProcessId)(ITraceEvent *This,
                                           /* [in] */ ULONG ProcessId);
  ...
  HRESULT(STDMETHODCALLTYPE *SetThreadId)(ITraceEvent *This,
                                          /* [in] */ ULONG ThreadId);
...
interface ITraceEvent { CONST_VTBL struct ITraceEventVtbl *lpVtbl; };
...
typedef struct ITraceEventCallbackVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in ITraceEventCallback *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in ITraceEventCallback *This);
...
typedef struct ITraceReloggerVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(ITraceRelogger *This,
                                             /* [in] */ REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);
  ...
  HRESULT(STDMETHODCALLTYPE *Inject)(ITraceRelogger *This,
...
interface ITraceRelogger { CONST_VTBL struct ITraceReloggerVtbl *lpVtbl; };
...
EXTERN_GUID(CLSID_TraceRelogger, 0x7b40792d, 0x05ff, 0x44c4, 0x90, 0x58, 0xf4,
