...
//                 rednerHintData parameter. Currently following types are
//                 defined:
//
...
//                 These are in the client co-ordinates  w.r.t. hwndOwner
//                 paremeter. The hintDataSize MUST be sizeof(RECT)
/*------------------------------------------------------------------*/

HRESULT WINAPI WTSSetRenderHint(_Inout_ UINT64 *pRenderHintID,
                                _In_ HWND hwndOwner, _In_ DWORD renderHintType,
                                _In_ DWORD cbHintDataLength,
                                _In_reads_bytes_opt_(cbHintDataLength)
                                    BYTE *pHintData);
