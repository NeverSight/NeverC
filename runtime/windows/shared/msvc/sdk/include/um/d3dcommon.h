...
#define D3D_SHADER_FEATURE_COMPUTE_SHADERS_PLUS_RAW_AND_STRUCTURED_BUFFERS_VIA_SHADER_4_X \
  0x00002
...
#define D3D_SHADER_FEATURE_VIEWPORT_AND_RT_ARRAY_INDEX_FROM_ANY_SHADER_FEEDING_RASTERIZER \
  0x02000
...
#define D3D_SHADER_FEATURE_DERIVATIVES_IN_MESH_AND_AMPLIFICATION_SHADERS       \
  0x1000000
...
typedef struct ID3D10BlobVtbl {
  ...
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(ID3D10Blob *This,
                                             /* [in] */ REFIID riid,
...
#define ID3DDestructionNotifier_RegisterDestructionCallback(                   \
  ...
  ((This)->lpVtbl->RegisterDestructionCallback(This, callbackFn, pData,        \
                                               pCallbackID))
...
DEFINE_GUID(WKPDID_D3DDebugObjectNameW, 0x4cca5fd8, 0x921f, 0x42c8, 0x85, 0x66,
            0x70, 0xca, 0xf2, 0xa9, 0xb7, 0x41);
DEFINE_GUID(WKPDID_CommentStringW, 0xd0149dc0, 0x90e8, 0x4ec8, 0x81, 0x44, 0xe9,
            0x00, 0xad, 0x26, 0x6b, 0xb2);
DEFINE_GUID(WKPDID_D3D12UniqueObjectId, 0x1b39de15, 0xec04, 0x4bae, 0xba, 0x4d,
...
#define D3D_SET_OBJECT_NAME_A(pObject, pName)                                  \
...
#define D3D_SET_OBJECT_NAME_W(pObject, pName)                                  \
...
DEFINE_GUID(D3D_TEXTURE_LAYOUT_ROW_MAJOR, 0xb5dc234f, 0x72bb, 0x4bec, 0x97,
            0x05, 0x8c, 0xf2, 0x58, 0xdf, 0x6b, 0x6c);
DEFINE_GUID(D3D_TEXTURE_LAYOUT_64KB_STANDARD_SWIZZLE, 0x4c0f29e3, 0x3f5f,
            0x4d35, 0x84, 0xc9, 0xbc, 0x09, 0x83, 0xb6, 0x2c, 0x28);
