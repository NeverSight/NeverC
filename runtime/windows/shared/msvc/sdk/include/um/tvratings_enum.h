...
ENUM16 EnTvRat_System{
    ...
    TvRat_SystemDontKnow =
        255 // haven't gotten a data value yet... (perhaps change to 0)
} EnTvRat_System;

ENUM16 EnTvRat_GenericLevel // constraint is that must be in increasing order,
                            // and max < 2^8
    {
        TvRat_0 = 0,
        TvRat_1 = 1,
        ...
        TvRat_Unblock = -1,
        TvRat_LevelDontKnow =
            255 // haven't gotten a data value yet... (perhaps change to _7)
...
ENUM16 EnTvRat_MPAA{
    ...
    MPAA_NotRated = EHRECVR_MGD_NAMESPACE(RATLEVEL(TvRat_7))} EnTvRat_MPAA;
...
ENUM16 EnTvRat_US_TV{
    ...
    US_TV_None7 = EHRECVR_MGD_NAMESPACE(RATLEVEL(TvRat_7))} EnTvRat_US_TV;
...
ENUM16 EnTvRat_CAE_TV{
    ...
    CAE_TV_Reserved = EHRECVR_MGD_NAMESPACE(RATLEVEL(TvRat_7))} EnTvRat_CAE_TV;
...
ENUM16 EnTvRat_CAF_TV{
    ...
    CAF_TV_Reserved = EHRECVR_MGD_NAMESPACE(RATLEVEL(TvRat_7))} EnTvRat_CAF_TV;

// -------------------
FLAGS16 BfEnTvRat_GenericAttributes{
    BfAttrNone = 0,  // no bits set (for initialization)
    BfIsBlocked = 1, // if set,
    BfIsAttr_1 = 2,          BfIsAttr_2 = 4,   BfIsAttr_3 = 8, BfIsAttr_4 = 16,
    BfIsAttr_5 = 32, // no bits set...
    BfIsAttr_6 = 64,         BfIsAttr_7 = 128,
...
FLAGS16 BfEnTvRat_Attributes_US_TV{
    ...
    US_TV_IsSexuallySuggestiveDialog =
        EHRECVR_MGD_NAMESPACE(RATATTR(BfIsAttr_4)),
