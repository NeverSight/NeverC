...
UINT WINAPI DdeInitializeA(_Inout_ LPDWORD pidInst,
                           _In_ PFNCALLBACK pfnCallback, _In_ DWORD afCmd,
                           _Reserved_ DWORD ulRes);
UINT WINAPI DdeInitializeW(_Inout_ LPDWORD pidInst,
                           _In_ PFNCALLBACK pfnCallback, _In_ DWORD afCmd,
                           _Reserved_ DWORD ulRes);
#ifdef UNICODE
...
HCONVLIST
WINAPI
DdeConnectList(_In_ DWORD idInst, _In_ HSZ hszService, _In_ HSZ hszTopic,
               _In_ HCONVLIST hConvList, _In_opt_ PCONVCONTEXT pCC);

HCONV
WINAPI
DdeQueryNextServer(_In_ HCONVLIST hConvList, _In_ HCONV hConvPrev);
...
HCONV
WINAPI
DdeConnect(_In_ DWORD idInst, _In_ HSZ hszService, _In_ HSZ hszTopic,
...
HCONV
WINAPI
DdeReconnect(_In_ HCONV hConv);

UINT WINAPI DdeQueryConvInfo(_In_ HCONV hConv, _In_ DWORD idTransaction,
                             _Inout_ PCONVINFO pConvInfo);

BOOL WINAPI DdeSetUserHandle(_In_ HCONV hConv, _In_ DWORD id,
                             _In_ DWORD_PTR hUser);

BOOL WINAPI DdeAbandonTransaction(_In_ DWORD idInst, _In_ HCONV hConv,
                                  _In_ DWORD idTransaction);

/*
 * app server interface functions
 */
BOOL WINAPI DdePostAdvise(_In_ DWORD idInst, _In_ HSZ hszTopic,
                          _In_ HSZ hszItem);

BOOL WINAPI DdeEnableCallback(_In_ DWORD idInst, _In_ HCONV hConv,
                              _In_ UINT wCmd);
...
HDDEDATA
WINAPI
DdeNameService(_In_ DWORD idInst, _In_opt_ HSZ hsz1, _In_opt_ HSZ hsz2,
               _In_ UINT afCmd);
...
HDDEDATA
WINAPI
DdeClientTransaction(_In_opt_ LPBYTE pData, _In_ DWORD cbData, _In_ HCONV hConv,
                     _In_opt_ HSZ hszItem, _In_ UINT wFmt, _In_ UINT wType,
                     _In_ DWORD dwTimeout, _Out_opt_ LPDWORD pdwResult);
...
HDDEDATA
WINAPI
DdeCreateDataHandle(_In_ DWORD idInst, _In_reads_bytes_opt_(cb) LPBYTE pSrc,
                    _In_ DWORD cb, _In_ DWORD cbOff, _In_opt_ HSZ hszItem,
                    _In_ UINT wFmt, _In_ UINT afCmd);

HDDEDATA
WINAPI
DdeAddData(_In_ HDDEDATA hData, _In_reads_bytes_(cb) LPBYTE pSrc, _In_ DWORD cb,
           _In_ DWORD cbOff);

DWORD
WINAPI
DdeGetData(_In_ HDDEDATA hData, _Out_writes_bytes_opt_(cbMax) LPBYTE pDst,
           _In_ DWORD cbMax, _In_ DWORD cbOff);

LPBYTE
WINAPI
DdeAccessData(_In_ HDDEDATA hData, _Out_opt_ LPDWORD pcbDataSize);
...
HSZ WINAPI DdeCreateStringHandleA(_In_ DWORD idInst, _In_ LPCSTR psz,
                                  _In_ int iCodePage);
HSZ WINAPI DdeCreateStringHandleW(_In_ DWORD idInst, _In_ LPCWSTR psz,
                                  _In_ int iCodePage);
#ifdef UNICODE
...
DWORD
WINAPI
DdeQueryStringA(_In_ DWORD idInst, _In_ HSZ hsz,
                _Out_writes_opt_(cchMax) LPSTR psz, _In_ DWORD cchMax,
                _In_ int iCodePage);
DWORD
WINAPI
DdeQueryStringW(_In_ DWORD idInst, _In_ HSZ hsz,
                _Out_writes_opt_(cchMax) LPWSTR psz, _In_ DWORD cchMax,
                _In_ int iCodePage);
#ifdef UNICODE
...
BOOL WINAPI DdeFreeStringHandle(_In_ DWORD idInst, _In_ HSZ hsz);

BOOL WINAPI DdeKeepStringHandle(_In_ DWORD idInst, _In_ HSZ hsz);

int WINAPI DdeCmpStringHandles(_In_ HSZ hsz1, _In_ HSZ hsz2);
