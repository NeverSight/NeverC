...
int PASCAL FAR WSARecvEx(_In_ SOCKET s,
                         ...
                         _In_ int len, _Inout_ int FAR *flags);
...
BOOL PASCAL FAR TransmitFile(_In_ SOCKET hSocket, _In_ HANDLE hFile,
...
BOOL PASCAL FAR
AcceptEx(_In_ SOCKET sListenSocket, _In_ SOCKET sAcceptSocket,
...
VOID PASCAL FAR GetAcceptExSockaddrs(
    _In_reads_bytes_(dwReceiveDataLength + dwLocalAddressLength +
                     dwRemoteAddressLength) PVOID lpOutputBuffer,
    _In_ DWORD dwReceiveDataLength, _In_ DWORD dwLocalAddressLength,
    _In_ DWORD dwRemoteAddressLength,
    _Outptr_result_bytebuffer_(
        *LocalSockaddrLength) struct sockaddr **LocalSockaddr,
    _Out_ LPINT LocalSockaddrLength,
    _Outptr_result_bytebuffer_(
        *RemoteSockaddrLength) struct sockaddr **RemoteSockaddr,
...
typedef BOOL(PASCAL FAR *LPFN_TRANSMITFILE)(
    _In_ SOCKET hSocket, _In_ HANDLE hFile, _In_ DWORD nNumberOfBytesToWrite,
    _In_ DWORD nNumberOfBytesPerSend, _Inout_opt_ LPOVERLAPPED lpOverlapped,
    _In_opt_ LPTRANSMIT_FILE_BUFFERS lpTransmitBuffers, _In_ DWORD dwReserved);

#define WSAID_TRANSMITFILE                                                     \
  {0xb5367df0, 0xcbac, 0x11cf, {0x95, 0xca, 0x00, 0x80, 0x5f, 0x48, 0xa1, 0x92}}

typedef BOOL(PASCAL FAR *LPFN_ACCEPTEX)(
    _In_ SOCKET sListenSocket, _In_ SOCKET sAcceptSocket,
    _Out_writes_bytes_(dwReceiveDataLength + dwLocalAddressLength +
                       dwRemoteAddressLength) PVOID lpOutputBuffer,
    _In_ DWORD dwReceiveDataLength, _In_ DWORD dwLocalAddressLength,
    _In_ DWORD dwRemoteAddressLength, _Out_ LPDWORD lpdwBytesReceived,
...
typedef BOOL(PASCAL FAR *LPFN_TRANSMITPACKETS)(
    _In_ SOCKET hSocket, _In_opt_ LPTRANSMIT_PACKETS_ELEMENT lpPacketArray,
    _In_ DWORD nElementCount, _In_ DWORD nSendSize,
    _Inout_opt_ LPOVERLAPPED lpOverlapped, _In_ DWORD dwFlags);
...
typedef BOOL(PASCAL FAR *LPFN_DISCONNECTEX)(
    _In_ SOCKET s, _Inout_opt_ LPOVERLAPPED lpOverlapped, _In_ DWORD dwFlags,
    _In_ DWORD dwReserved);
...
typedef INT(PASCAL FAR *LPFN_WSARECVMSG)(
    _In_ SOCKET s, _Inout_ LPWSAMSG lpMsg,
 ...
 * This is not used by any Winsock extension function and should not be
 * intercepted by Winsock LSPs.
 */
 ...
 */
typedef INT(PASCAL FAR *LPFN_WSASENDMSG)(
    _In_ SOCKET s, _In_ LPWSAMSG lpMsg, _In_ DWORD dwFlags,
...
// WSAPoll
//
typedef INT(WSAAPI *LPFN_WSAPOLL)(_Inout_ LPWSAPOLLFD fdarray, _In_ ULONG nfds,
                                  _In_ INT timeout);
...
typedef BOOL(PASCAL FAR *LPFN_RIORECEIVE)(_In_ RIO_RQ SocketQueue,
...
typedef int(PASCAL FAR *LPFN_RIORECEIVEEX)(
    ...
    _In_opt_ PRIO_BUF pFlags, _In_ DWORD Flags, _In_opt_ PVOID RequestContext);

typedef BOOL(PASCAL FAR *LPFN_RIOSEND)(_In_ RIO_RQ SocketQueue,
                                       _In_reads_(DataBufferCount)
                                           PRIO_BUF pData,
                                       _In_ ULONG DataBufferCount,
                                       _In_ DWORD Flags,
