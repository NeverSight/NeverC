...
typedef struct IAMPlayListItemVtbl {
  ...
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in IAMPlayListItem *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IAMPlayListItem *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IAMPlayListItem *This);

  DECLSPEC_XFGVIRT(IAMPlayListItem, GetFlags)
  HRESULT(STDMETHODCALLTYPE *GetFlags)(__RPC__in IAMPlayListItem *This,
...
interface IAMPlayListItem { CONST_VTBL struct IAMPlayListItemVtbl *lpVtbl; };
...
typedef struct IAMPlayListVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in IAMPlayList *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IAMPlayList *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IAMPlayList *This);

  DECLSPEC_XFGVIRT(IAMPlayList, GetFlags)
  HRESULT(STDMETHODCALLTYPE *GetFlags)(__RPC__in IAMPlayList *This,
                                       /* [out] */ __RPC__out DWORD *pdwFlags);
...
interface IAMPlayList { CONST_VTBL struct IAMPlayListVtbl *lpVtbl; };
...
typedef struct ISpecifyParticularPagesVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in ISpecifyParticularPages *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in ISpecifyParticularPages *This);
...
typedef struct IAMRebuildVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(IAMRebuild *This,
                                             /* [in] */ REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(IAMRebuild *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(IAMRebuild *This);

  DECLSPEC_XFGVIRT(IAMRebuild, RebuildNow)
  HRESULT(STDMETHODCALLTYPE *RebuildNow)(IAMRebuild *This);

  END_INTERFACE
} IAMRebuildVtbl;

interface IAMRebuild { CONST_VTBL struct IAMRebuildVtbl *lpVtbl; };
...
public:
  virtual HRESULT STDMETHODCALLTYPE GetBufferingTime(DWORD *
                                                     pdwMilliseconds) = 0;

  virtual HRESULT STDMETHODCALLTYPE SetBufferingTime(DWORD dwMilliseconds) = 0;
};
...
typedef struct IBufferingTimeVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(IBufferingTime *This,
                                             /* [in] */ REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(IBufferingTime *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(IBufferingTime *This);

  DECLSPEC_XFGVIRT(IBufferingTime, GetBufferingTime)
  HRESULT(STDMETHODCALLTYPE *GetBufferingTime)(IBufferingTime *This,
                                               DWORD *pdwMilliseconds);

  DECLSPEC_XFGVIRT(IBufferingTime, SetBufferingTime)
  HRESULT(STDMETHODCALLTYPE *SetBufferingTime)(IBufferingTime *This,
                                               DWORD dwMilliseconds);

  END_INTERFACE
} IBufferingTimeVtbl;

interface IBufferingTime { CONST_VTBL struct IBufferingTimeVtbl *lpVtbl; };
...
#define IBufferingTime_AddRef(This) ((This)->lpVtbl->AddRef(This))

#define IBufferingTime_Release(This) ((This)->lpVtbl->Release(This))
...
EXTERN_GUID(IID_IBufferingTime, 0x1e00486a, 0x78dd, 0x11d2, 0x8d, 0xd3, 0x0,
            0x60, 0x97, 0xc9, 0xa2, 0xb2);
