...
DEFINE_GUID(WMDM_DEVICE_PROTOCOL_MTP, 0x979e54e5, 0xafc, 0x4604, 0x8d, 0x93,
            0xdc, 0x79, 0x8a, 0x4b, 0xcf, 0x45);
#endif
#ifndef _DEFINE_WMDM_DEVICE_PROTOCOL_RAPI
#define _DEFINE_WMDM_DEVICE_PROTOCOL_RAPI
// {2A11ED91-8C8F-41e4-82D1-8386E003561C}
DEFINE_GUID(WMDM_DEVICE_PROTOCOL_RAPI, 0x2a11ed91, 0x8c8f, 0x41e4, 0x82, 0xd1,
            0x83, 0x86, 0xe0, 0x3, 0x56, 0x1c);
#endif
#ifndef _DEFINE_WMDM_DEVICE_PROTOCOL_MSC
#define _DEFINE_WMDM_DEVICE_PROTOCOL_MSC
// {A4D2C26C-A881-44bb-BD5D-1F703C71F7A9}
DEFINE_GUID(WMDM_DEVICE_PROTOCOL_MSC, 0xa4d2c26c, 0xa881, 0x44bb, 0xbd, 0x5d,
            0x1f, 0x70, 0x3c, 0x71, 0xf7, 0xa9);
#endif
...
DEFINE_GUID(WMDM_SERVICE_PROVIDER_VENDOR_MICROSOFT, 0x7de8686d, 0x78ee, 0x43ea,
            0xa4, 0x96, 0xc6, 0x25, 0xac, 0x91, 0xcc, 0x5d);
#endif
...
public:
  virtual HRESULT STDMETHODCALLTYPE AddItem(
      ...
      /* [unique][size_is][in] */ __RPC__in_ecount_full_opt(iLength) BYTE *
          pValue,
      /* [in] */ UINT iLength) = 0;
...
typedef struct IWMDMMetaDataVtbl {
  ...
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in IWMDMMetaData *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IWMDMMetaData *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IWMDMMetaData *This);
  ...
  HRESULT(STDMETHODCALLTYPE *GetItemCount)(__RPC__in IWMDMMetaData *This,
                                           /* [out] */ __RPC__out UINT *iCount);

  END_INTERFACE
} IWMDMMetaDataVtbl;

interface IWMDMMetaData { CONST_VTBL struct IWMDMMetaDataVtbl *lpVtbl; };
...
#define IWMDMMetaData_QueryByIndex(This, iIndex, ppwszName, pType, ppValue,    \
                                   pcbLength)                                  \
  ((This)->lpVtbl->QueryByIndex(This, iIndex, ppwszName, pType, ppValue,       \
                                pcbLength))
...
typedef struct IWMDeviceManagerVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in IWMDeviceManager *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IWMDeviceManager *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IWMDeviceManager *This);
...
interface IWMDeviceManager { CONST_VTBL struct IWMDeviceManagerVtbl *lpVtbl; };
...
typedef struct IWMDeviceManager2Vtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in IWMDeviceManager2 *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IWMDeviceManager2 *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IWMDeviceManager2 *This);
  ...
  HRESULT(STDMETHODCALLTYPE *Reinitialize)(__RPC__in IWMDeviceManager2 *This);
...
#define IWMDeviceManager2_GetDeviceFromCanonicalName(This, pwszCanonicalName,  \
                                                     ppDevice)                 \
  ((This)->lpVtbl->GetDeviceFromCanonicalName(This, pwszCanonicalName,         \
                                              ppDevice))
...
typedef struct IWMDeviceManager3Vtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in IWMDeviceManager3 *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IWMDeviceManager3 *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IWMDeviceManager3 *This);
  ...
  DECLSPEC_XFGVIRT(IWMDeviceManager2, Reinitialize)
  HRESULT(STDMETHODCALLTYPE *Reinitialize)(__RPC__in IWMDeviceManager3 *This);
...
#define IWMDeviceManager3_GetDeviceFromCanonicalName(This, pwszCanonicalName,  \
                                                     ppDevice)                 \
  ((This)->lpVtbl->GetDeviceFromCanonicalName(This, pwszCanonicalName,         \
                                              ppDevice))
...
public:
  ...
  virtual HRESULT STDMETHODCALLTYPE GetSerialNumber(
      ...
      /* [out][in] */ __RPC__inout_ecount_full(WMDM_MAC_LENGTH)
          BYTE abMac[8]) = 0;
...
typedef struct IWMDMStorageGlobalsVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IWMDMStorageGlobals *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IWMDMStorageGlobals *This);
...
#define IWMDMStorageGlobals_GetTotalSize(This, pdwTotalSizeLow,                \
                                         pdwTotalSizeHigh)                     \
...
public:
  ...
  virtual HRESULT STDMETHODCALLTYPE GetStorageGlobals(
      /* [out] */ __RPC__deref_out_opt IWMDMStorageGlobals *
      *ppStorageGlobals) = 0;
  ...
  virtual HRESULT STDMETHODCALLTYPE GetName(
      /* [size_is][string][out] */ __RPC__out_ecount_full_string(nMaxChars)
          LPWSTR pwszName,
      /* [in] */ UINT nMaxChars) = 0;
  ...
  virtual HRESULT STDMETHODCALLTYPE GetRights(
      /* [size_is][size_is][out] */ __RPC__deref_out_ecount_full_opt(
          *pnRightsCount) PWMDMRIGHTS *
          ppRights,
      /* [out] */ __RPC__out UINT * pnRightsCount,
      /* [out][in] */
      __RPC__inout_ecount_full(WMDM_MAC_LENGTH) BYTE abMac[8]) = 0;
...
typedef struct IWMDMStorageVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in IWMDMStorage *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IWMDMStorage *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IWMDMStorage *This);
  ...
  HRESULT(STDMETHODCALLTYPE *GetName)(__RPC__in IWMDMStorage *This,
                                      /* [size_is][string][out] */
                                      __RPC__out_ecount_full_string(nMaxChars)
                                          LPWSTR pwszName,
                                      /* [in] */ UINT nMaxChars);

  DECLSPEC_XFGVIRT(IWMDMStorage, GetDate)
  HRESULT(STDMETHODCALLTYPE *GetDate)(__RPC__in IWMDMStorage *This,
                                      /* [out] */ __RPC__out PWMDMDATETIME
                                          pDateTimeUTC);
...
interface IWMDMStorage { CONST_VTBL struct IWMDMStorageVtbl *lpVtbl; };
...
public:
  ...
  virtual HRESULT STDMETHODCALLTYPE GetAttributes2(
      ...
      /* [unique][out][in] */ __RPC__inout_opt _VIDEOINFOHEADER *
          pVideoFormat) = 0;
};
...
typedef struct IWMDMStorage2Vtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in IWMDMStorage2 *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IWMDMStorage2 *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IWMDMStorage2 *This);
  ...
  DECLSPEC_XFGVIRT(IWMDMStorage, GetName)
  HRESULT(STDMETHODCALLTYPE *GetName)(__RPC__in IWMDMStorage2 *This,
                                      /* [size_is][string][out] */
                                      __RPC__out_ecount_full_string(nMaxChars)
                                          LPWSTR pwszName,
                                      /* [in] */ UINT nMaxChars);
  ...
  DECLSPEC_XFGVIRT(IWMDMStorage, GetDate)
  HRESULT(STDMETHODCALLTYPE *GetDate)(__RPC__in IWMDMStorage2 *This,
                                      /* [out] */ __RPC__out PWMDMDATETIME
                                          pDateTimeUTC);
...
interface IWMDMStorage2 { CONST_VTBL struct IWMDMStorage2Vtbl *lpVtbl; };
...
#define IWMDMStorage2_SetAttributes2(This, dwAttributes, dwAttributesEx,       \
                                     pFormat, pVideoFormat)                    \
  ((This)->lpVtbl->SetAttributes2(This, dwAttributes, dwAttributesEx, pFormat, \
                                  pVideoFormat))

#define IWMDMStorage2_GetAttributes2(This, pdwAttributes, pdwAttributesEx,     \
                                     pAudioFormat, pVideoFormat)               \
  ((This)->lpVtbl->GetAttributes2(This, pdwAttributes, pdwAttributesEx,        \
                                  pAudioFormat, pVideoFormat))
...
public:
  ...
  virtual HRESULT STDMETHODCALLTYPE SetEnumPreference(
      ...
      /* [in] */ DWORD nViews,
      /* [unique][size_is][in] */
      __RPC__in_ecount_full_opt(nViews) WMDMMetadataView * pViews) = 0;
};
...
typedef struct IWMDMStorage3Vtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in IWMDMStorage3 *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IWMDMStorage3 *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IWMDMStorage3 *This);
  ...
  DECLSPEC_XFGVIRT(IWMDMStorage, GetName)
  HRESULT(STDMETHODCALLTYPE *GetName)(__RPC__in IWMDMStorage3 *This,
                                      /* [size_is][string][out] */
                                      __RPC__out_ecount_full_string(nMaxChars)
                                          LPWSTR pwszName,
                                      /* [in] */ UINT nMaxChars);
  ...
  DECLSPEC_XFGVIRT(IWMDMStorage, GetDate)
  HRESULT(STDMETHODCALLTYPE *GetDate)(__RPC__in IWMDMStorage3 *This,
                                      /* [out] */ __RPC__out PWMDMDATETIME
                                          pDateTimeUTC);
...
interface IWMDMStorage3 { CONST_VTBL struct IWMDMStorage3Vtbl *lpVtbl; };
...
#define IWMDMStorage3_SetAttributes2(This, dwAttributes, dwAttributesEx,       \
                                     pFormat, pVideoFormat)                    \
  ((This)->lpVtbl->SetAttributes2(This, dwAttributes, dwAttributesEx, pFormat, \
                                  pVideoFormat))

#define IWMDMStorage3_GetAttributes2(This, pdwAttributes, pdwAttributesEx,     \
                                     pAudioFormat, pVideoFormat)               \
  ((This)->lpVtbl->GetAttributes2(This, pdwAttributes, pdwAttributesEx,        \
                                  pAudioFormat, pVideoFormat))
...
public:
  virtual HRESULT STDMETHODCALLTYPE SetReferences(
      /* [in] */ DWORD dwRefs,
      /* [size_is][unique][in] */ __RPC__in_ecount_full_opt(dwRefs)
              IWMDMStorage *
          *ppIWMDMStorage) = 0;

  virtual HRESULT STDMETHODCALLTYPE GetReferences(
      /* [out] */ __RPC__out DWORD * pdwRefs,
      /* [size_is][size_is][out] */ __RPC__deref_out_ecount_full_opt(*pdwRefs)
              IWMDMStorage *
          **pppIWMDMStorage) = 0;
  ...
  virtual HRESULT STDMETHODCALLTYPE GetSpecifiedMetadata(
      ...
      /* [size_is][in] */ __RPC__in_ecount_full(cProperties) LPCWSTR *
          ppwszPropNames,
      /* [out] */ __RPC__deref_out_opt IWMDMMetaData * *ppMetadata) = 0;
...
typedef struct IWMDMStorage4Vtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in IWMDMStorage4 *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IWMDMStorage4 *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IWMDMStorage4 *This);
  ...
  DECLSPEC_XFGVIRT(IWMDMStorage, GetName)
  HRESULT(STDMETHODCALLTYPE *GetName)(__RPC__in IWMDMStorage4 *This,
                                      /* [size_is][string][out] */
                                      __RPC__out_ecount_full_string(nMaxChars)
                                          LPWSTR pwszName,
                                      /* [in] */ UINT nMaxChars);
  ...
  DECLSPEC_XFGVIRT(IWMDMStorage, GetDate)
  HRESULT(STDMETHODCALLTYPE *GetDate)(__RPC__in IWMDMStorage4 *This,
                                      /* [out] */ __RPC__out PWMDMDATETIME
                                          pDateTimeUTC);
  ...
  HRESULT(STDMETHODCALLTYPE *SetReferences)(__RPC__in IWMDMStorage4 *This,
                                            /* [in] */ DWORD dwRefs,
                                            /* [size_is][unique][in] */
                                            __RPC__in_ecount_full_opt(dwRefs)
  ...
  HRESULT(STDMETHODCALLTYPE *GetReferences)(
      ...
      /* [out] */ __RPC__out DWORD *pdwRefs,
      /* [size_is][size_is][out] */
      __RPC__deref_out_ecount_full_opt(*pdwRefs)
...
interface IWMDMStorage4 { CONST_VTBL struct IWMDMStorage4Vtbl *lpVtbl; };
...
#define IWMDMStorage4_SetAttributes2(This, dwAttributes, dwAttributesEx,       \
                                     pFormat, pVideoFormat)                    \
  ((This)->lpVtbl->SetAttributes2(This, dwAttributes, dwAttributesEx, pFormat, \
                                  pVideoFormat))

#define IWMDMStorage4_GetAttributes2(This, pdwAttributes, pdwAttributesEx,     \
                                     pAudioFormat, pVideoFormat)               \
  ((This)->lpVtbl->GetAttributes2(This, pdwAttributes, pdwAttributesEx,        \
                                  pAudioFormat, pVideoFormat))
...
#define IWMDMStorage4_GetRightsWithProgress(This, pIProgressCallback,          \
                                            ppRights, pnRightsCount)           \
  ((This)->lpVtbl->GetRightsWithProgress(This, pIProgressCallback, ppRights,   \
                                         pnRightsCount))

#define IWMDMStorage4_GetSpecifiedMetadata(This, cProperties, ppwszPropNames,  \
                                           ppMetadata)                         \
  ((This)->lpVtbl->GetSpecifiedMetadata(This, cProperties, ppwszPropNames,     \
                                        ppMetadata))
...
public:
  ...
  virtual HRESULT STDMETHODCALLTYPE SetObjectName(
      /* [size_is][string][in] */ __RPC__in_ecount_full_string(nMaxChars)
          LPWSTR pwszName,
      /* [in] */ UINT nMaxChars) = 0;
...
typedef struct IWMDMOperationVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in IWMDMOperation *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IWMDMOperation *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IWMDMOperation *This);

  DECLSPEC_XFGVIRT(IWMDMOperation, BeginRead)
  HRESULT(STDMETHODCALLTYPE *BeginRead)(__RPC__in IWMDMOperation *This);

  DECLSPEC_XFGVIRT(IWMDMOperation, BeginWrite)
  HRESULT(STDMETHODCALLTYPE *BeginWrite)(__RPC__in IWMDMOperation *This);
  ...
  HRESULT(STDMETHODCALLTYPE *SetObjectTotalSize)(__RPC__in IWMDMOperation *This,
                                                 /* [in] */ DWORD dwSize,
                                                 /* [in] */ DWORD dwSizeHigh);
...
interface IWMDMOperation { CONST_VTBL struct IWMDMOperationVtbl *lpVtbl; };
...
typedef struct IWMDMOperation2Vtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in IWMDMOperation2 *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IWMDMOperation2 *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IWMDMOperation2 *This);

  DECLSPEC_XFGVIRT(IWMDMOperation, BeginRead)
  HRESULT(STDMETHODCALLTYPE *BeginRead)(__RPC__in IWMDMOperation2 *This);

  DECLSPEC_XFGVIRT(IWMDMOperation, BeginWrite)
  HRESULT(STDMETHODCALLTYPE *BeginWrite)(__RPC__in IWMDMOperation2 *This);
...
interface IWMDMOperation2 { CONST_VTBL struct IWMDMOperation2Vtbl *lpVtbl; };
...
#define IWMDMOperation2_SetObjectAttributes2(                                  \
    This, dwAttributes, dwAttributesEx, pFormat, pVideoFormat)                 \
  ((This)->lpVtbl->SetObjectAttributes2(This, dwAttributes, dwAttributesEx,    \
                                        pFormat, pVideoFormat))

#define IWMDMOperation2_GetObjectAttributes2(                                  \
    This, pdwAttributes, pdwAttributesEx, pAudioFormat, pVideoFormat)          \
  ((This)->lpVtbl->GetObjectAttributes2(This, pdwAttributes, pdwAttributesEx,  \
                                        pAudioFormat, pVideoFormat))
...
typedef struct IWMDMOperation3Vtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in IWMDMOperation3 *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IWMDMOperation3 *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IWMDMOperation3 *This);

  DECLSPEC_XFGVIRT(IWMDMOperation, BeginRead)
  HRESULT(STDMETHODCALLTYPE *BeginRead)(__RPC__in IWMDMOperation3 *This);

  DECLSPEC_XFGVIRT(IWMDMOperation, BeginWrite)
  HRESULT(STDMETHODCALLTYPE *BeginWrite)(__RPC__in IWMDMOperation3 *This);
...
interface IWMDMOperation3 { CONST_VTBL struct IWMDMOperation3Vtbl *lpVtbl; };
...
typedef struct IWMDMProgressVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in IWMDMProgress *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IWMDMProgress *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IWMDMProgress *This);

  DECLSPEC_XFGVIRT(IWMDMProgress, Begin)
  HRESULT(STDMETHODCALLTYPE *Begin)(__RPC__in IWMDMProgress *This,
                                    /* [in] */ DWORD dwEstimatedTicks);

  DECLSPEC_XFGVIRT(IWMDMProgress, Progress)
  HRESULT(STDMETHODCALLTYPE *Progress)(__RPC__in IWMDMProgress *This,
                                       /* [in] */ DWORD dwTranspiredTicks);

  DECLSPEC_XFGVIRT(IWMDMProgress, End)
  HRESULT(STDMETHODCALLTYPE *End)(__RPC__in IWMDMProgress *This);

  END_INTERFACE
} IWMDMProgressVtbl;

interface IWMDMProgress { CONST_VTBL struct IWMDMProgressVtbl *lpVtbl; };
...
typedef struct IWMDMProgress2Vtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in IWMDMProgress2 *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IWMDMProgress2 *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IWMDMProgress2 *This);

  DECLSPEC_XFGVIRT(IWMDMProgress, Begin)
  HRESULT(STDMETHODCALLTYPE *Begin)(__RPC__in IWMDMProgress2 *This,
                                    /* [in] */ DWORD dwEstimatedTicks);

  DECLSPEC_XFGVIRT(IWMDMProgress, Progress)
  HRESULT(STDMETHODCALLTYPE *Progress)(__RPC__in IWMDMProgress2 *This,
                                       /* [in] */ DWORD dwTranspiredTicks);

  DECLSPEC_XFGVIRT(IWMDMProgress, End)
  HRESULT(STDMETHODCALLTYPE *End)(__RPC__in IWMDMProgress2 *This);

  DECLSPEC_XFGVIRT(IWMDMProgress2, End2)
  HRESULT(STDMETHODCALLTYPE *End2)(__RPC__in IWMDMProgress2 *This,
                                   /* [in] */ HRESULT hrCompletionCode);

  END_INTERFACE
} IWMDMProgress2Vtbl;

interface IWMDMProgress2 { CONST_VTBL struct IWMDMProgress2Vtbl *lpVtbl; };
...
typedef struct IWMDMProgress3Vtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in IWMDMProgress3 *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IWMDMProgress3 *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IWMDMProgress3 *This);

  DECLSPEC_XFGVIRT(IWMDMProgress, Begin)
  HRESULT(STDMETHODCALLTYPE *Begin)(__RPC__in IWMDMProgress3 *This,
                                    /* [in] */ DWORD dwEstimatedTicks);

  DECLSPEC_XFGVIRT(IWMDMProgress, Progress)
  HRESULT(STDMETHODCALLTYPE *Progress)(__RPC__in IWMDMProgress3 *This,
                                       /* [in] */ DWORD dwTranspiredTicks);

  DECLSPEC_XFGVIRT(IWMDMProgress, End)
  HRESULT(STDMETHODCALLTYPE *End)(__RPC__in IWMDMProgress3 *This);

  DECLSPEC_XFGVIRT(IWMDMProgress2, End2)
  HRESULT(STDMETHODCALLTYPE *End2)(__RPC__in IWMDMProgress3 *This,
                                   /* [in] */ HRESULT hrCompletionCode);
...
interface IWMDMProgress3 { CONST_VTBL struct IWMDMProgress3Vtbl *lpVtbl; };
...
public:
  ...
  virtual HRESULT STDMETHODCALLTYPE GetFormatSupport(
      /* [size_is][size_is][out] */ __RPC__deref_out_ecount_full_opt(
          *pnFormatCount) _WAVEFORMATEX *
          *ppFormatEx,
      /* [out] */ __RPC__out UINT * pnFormatCount,
      /* [size_is][size_is][out] */
      __RPC__deref_out_ecount_full_opt(*pnMimeTypeCount) LPWSTR *
          *pppwszMimeType,
...
typedef struct IWMDMDeviceVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in IWMDMDevice *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IWMDMDevice *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IWMDMDevice *This);

  DECLSPEC_XFGVIRT(IWMDMDevice, GetName)
  HRESULT(STDMETHODCALLTYPE *GetName)(__RPC__in IWMDMDevice *This,
                                      /* [size_is][string][out] */
                                      __RPC__out_ecount_full_string(nMaxChars)
                                          LPWSTR pwszName,
                                      /* [in] */ UINT nMaxChars);
  ...
  HRESULT(STDMETHODCALLTYPE *GetType)(__RPC__in IWMDMDevice *This,
  ...
  HRESULT(STDMETHODCALLTYPE *GetFormatSupport)(
      __RPC__in IWMDMDevice *This,
      /* [size_is][size_is][out] */
      __RPC__deref_out_ecount_full_opt(*pnFormatCount)
          _WAVEFORMATEX **ppFormatEx,
      /* [out] */ __RPC__out UINT *pnFormatCount,
      /* [size_is][size_is][out] */
      __RPC__deref_out_ecount_full_opt(*pnMimeTypeCount)
...
interface IWMDMDevice { CONST_VTBL struct IWMDMDeviceVtbl *lpVtbl; };
...
#define IWMDMDevice_GetFormatSupport(This, ppFormatEx, pnFormatCount,          \
                                     pppwszMimeType, pnMimeTypeCount)          \
  ((This)->lpVtbl->GetFormatSupport(This, ppFormatEx, pnFormatCount,           \
                                    pppwszMimeType, pnMimeTypeCount))
...
public:
  ...
  virtual HRESULT STDMETHODCALLTYPE GetFormatSupport2(
      /* [in] */ DWORD dwFlags,
      /* [size_is][size_is][out] */
      __RPC__deref_out_ecount_full_opt(*pnAudioFormatCount) _WAVEFORMATEX *
          *ppAudioFormatEx,
      /* [ref][out] */ __RPC__out UINT * pnAudioFormatCount,
      /* [size_is][size_is][out] */
      __RPC__deref_out_ecount_full_opt(*pnVideoFormatCount) _VIDEOINFOHEADER *
          *ppVideoFormatEx,
      /* [ref][out] */ __RPC__out UINT * pnVideoFormatCount,
      /* [size_is][size_is][out] */
      __RPC__deref_out_ecount_full_opt(*pnFileTypeCount) WMFILECAPABILITIES *
          *ppFileType,
      /* [ref][out] */ __RPC__out UINT * pnFileTypeCount) = 0;

  virtual HRESULT STDMETHODCALLTYPE GetSpecifyPropertyPages(
      /* [ref][out] */ __RPC__deref_out_opt ISpecifyPropertyPages *
          *ppSpecifyPropPages,
      /* [size_is][size_is][ref][out] */
...
typedef struct IWMDMDevice2Vtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in IWMDMDevice2 *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IWMDMDevice2 *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IWMDMDevice2 *This);

  DECLSPEC_XFGVIRT(IWMDMDevice, GetName)
  HRESULT(STDMETHODCALLTYPE *GetName)(__RPC__in IWMDMDevice2 *This,
                                      /* [size_is][string][out] */
                                      __RPC__out_ecount_full_string(nMaxChars)
                                          LPWSTR pwszName,
                                      /* [in] */ UINT nMaxChars);
  ...
  DECLSPEC_XFGVIRT(IWMDMDevice, GetType)
  HRESULT(STDMETHODCALLTYPE *GetType)(__RPC__in IWMDMDevice2 *This,
                                      /* [out] */ __RPC__out DWORD *pdwType);
  ...
  HRESULT(STDMETHODCALLTYPE *GetFormatSupport2)(
      ...
      /* [in] */ DWORD dwFlags,
      /* [size_is][size_is][out] */
      __RPC__deref_out_ecount_full_opt(*pnAudioFormatCount)
          _WAVEFORMATEX **ppAudioFormatEx,
      /* [ref][out] */ __RPC__out UINT *pnAudioFormatCount,
      /* [size_is][size_is][out] */
      __RPC__deref_out_ecount_full_opt(*pnVideoFormatCount)
          _VIDEOINFOHEADER **ppVideoFormatEx,
      /* [ref][out] */ __RPC__out UINT *pnVideoFormatCount,
      /* [size_is][size_is][out] */
      __RPC__deref_out_ecount_full_opt(*pnFileTypeCount)
...
interface IWMDMDevice2 { CONST_VTBL struct IWMDMDevice2Vtbl *lpVtbl; };
...
#define IWMDMDevice2_GetFormatSupport(This, ppFormatEx, pnFormatCount,         \
                                      pppwszMimeType, pnMimeTypeCount)         \
  ((This)->lpVtbl->GetFormatSupport(This, ppFormatEx, pnFormatCount,           \
                                    pppwszMimeType, pnMimeTypeCount))
...
#define IWMDMDevice2_GetFormatSupport2(                                        \
    This, dwFlags, ppAudioFormatEx, pnAudioFormatCount, ppVideoFormatEx,       \
    pnVideoFormatCount, ppFileType, pnFileTypeCount)                           \
  ((This)->lpVtbl->GetFormatSupport2(                                          \
      This, dwFlags, ppAudioFormatEx, pnAudioFormatCount, ppVideoFormatEx,     \
      pnVideoFormatCount, ppFileType, pnFileTypeCount))

#define IWMDMDevice2_GetSpecifyPropertyPages(This, ppSpecifyPropPages,         \
                                             pppUnknowns, pcUnks)              \
  ((This)->lpVtbl->GetSpecifyPropertyPages(This, ppSpecifyPropPages,           \
                                           pppUnknowns, pcUnks))
...
public:
  ...
  virtual HRESULT STDMETHODCALLTYPE DeviceIoControl(
      ...
      /* [size_is][in] */ __RPC__in_ecount_full(nInBufferSize) BYTE *
          lpInBuffer,
      /* [in] */ DWORD nInBufferSize,
      /* [size_is][out] */ __RPC__out_ecount_full(*pnOutBufferSize) BYTE *
          lpOutBuffer,
...
typedef struct IWMDMDevice3Vtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in IWMDMDevice3 *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IWMDMDevice3 *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IWMDMDevice3 *This);

  DECLSPEC_XFGVIRT(IWMDMDevice, GetName)
  HRESULT(STDMETHODCALLTYPE *GetName)(__RPC__in IWMDMDevice3 *This,
                                      /* [size_is][string][out] */
                                      __RPC__out_ecount_full_string(nMaxChars)
                                          LPWSTR pwszName,
                                      /* [in] */ UINT nMaxChars);
  ...
  DECLSPEC_XFGVIRT(IWMDMDevice, GetType)
  HRESULT(STDMETHODCALLTYPE *GetType)(__RPC__in IWMDMDevice3 *This,
                                      /* [out] */ __RPC__out DWORD *pdwType);
...
interface IWMDMDevice3 { CONST_VTBL struct IWMDMDevice3Vtbl *lpVtbl; };
...
#define IWMDMDevice3_GetFormatSupport(This, ppFormatEx, pnFormatCount,         \
                                      pppwszMimeType, pnMimeTypeCount)         \
  ((This)->lpVtbl->GetFormatSupport(This, ppFormatEx, pnFormatCount,           \
                                    pppwszMimeType, pnMimeTypeCount))
...
#define IWMDMDevice3_GetFormatSupport2(                                        \
    This, dwFlags, ppAudioFormatEx, pnAudioFormatCount, ppVideoFormatEx,       \
    pnVideoFormatCount, ppFileType, pnFileTypeCount)                           \
  ((This)->lpVtbl->GetFormatSupport2(                                          \
      This, dwFlags, ppAudioFormatEx, pnAudioFormatCount, ppVideoFormatEx,     \
...
#define IWMDMDevice3_GetSpecifyPropertyPages(This, ppSpecifyPropPages,         \
                                             pppUnknowns, pcUnks)              \
  ((This)->lpVtbl->GetSpecifyPropertyPages(This, ppSpecifyPropPages,           \
                                           pppUnknowns, pcUnks))
...
#define IWMDMDevice3_DeviceIoControl(This, dwIoControlCode, lpInBuffer,        \
                                     nInBufferSize, lpOutBuffer,               \
                                     pnOutBufferSize)                          \
  ((This)->lpVtbl->DeviceIoControl(This, dwIoControlCode, lpInBuffer,          \
                                   nInBufferSize, lpOutBuffer,                 \
                                   pnOutBufferSize))
...
public:
  virtual HRESULT STDMETHODCALLTYPE BeginSession(
      ...
      /* [unique][size_is][in] */ __RPC__in_ecount_full_opt(dwSizeCtx) BYTE *
          pCtx,
...
typedef struct IWMDMDeviceSessionVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in IWMDMDeviceSession *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IWMDMDeviceSession *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IWMDMDeviceSession *This);

  DECLSPEC_XFGVIRT(IWMDMDeviceSession, BeginSession)
  HRESULT(STDMETHODCALLTYPE *BeginSession)(__RPC__in IWMDMDeviceSession *This,
                                           /* [in] */ WMDM_SESSION_TYPE type,
                                           /* [unique][size_is][in] */
                                           __RPC__in_ecount_full_opt(dwSizeCtx)
                                               BYTE *pCtx,
                                           /* [in] */ DWORD dwSizeCtx);

  DECLSPEC_XFGVIRT(IWMDMDeviceSession, EndSession)
  HRESULT(STDMETHODCALLTYPE *EndSession)(__RPC__in IWMDMDeviceSession *This,
                                         /* [in] */ WMDM_SESSION_TYPE type,
                                         /* [unique][size_is][in] */
                                         __RPC__in_ecount_full_opt(dwSizeCtx)
                                             BYTE *pCtx,
...
typedef struct IWMDMEnumDeviceVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in IWMDMEnumDevice *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IWMDMEnumDevice *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IWMDMEnumDevice *This);

  DECLSPEC_XFGVIRT(IWMDMEnumDevice, Next)
  HRESULT(STDMETHODCALLTYPE *Next)(__RPC__in IWMDMEnumDevice *This,
                                   /* [in] */ ULONG celt,
                                   /* [length_is][size_is][out] */
                                   __RPC__out_ecount_part(celt, *pceltFetched)
                                       IWMDMDevice **ppDevice,
                                   /* [out] */ __RPC__out ULONG *pceltFetched);

  DECLSPEC_XFGVIRT(IWMDMEnumDevice, Skip)
  HRESULT(STDMETHODCALLTYPE *Skip)(__RPC__in IWMDMEnumDevice *This,
                                   /* [in] */ ULONG celt,
                                   /* [out] */ __RPC__out ULONG *pceltFetched);

  DECLSPEC_XFGVIRT(IWMDMEnumDevice, Reset)
  HRESULT(STDMETHODCALLTYPE *Reset)(__RPC__in IWMDMEnumDevice *This);
...
interface IWMDMEnumDevice { CONST_VTBL struct IWMDMEnumDeviceVtbl *lpVtbl; };
...
typedef struct IWMDMDeviceControlVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in IWMDMDeviceControl *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IWMDMDeviceControl *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IWMDMDeviceControl *This);
  ...
  HRESULT(STDMETHODCALLTYPE *Play)(__RPC__in IWMDMDeviceControl *This);
  ...
  HRESULT(STDMETHODCALLTYPE *Pause)(__RPC__in IWMDMDeviceControl *This);

  DECLSPEC_XFGVIRT(IWMDMDeviceControl, Resume)
  HRESULT(STDMETHODCALLTYPE *Resume)(__RPC__in IWMDMDeviceControl *This);

  DECLSPEC_XFGVIRT(IWMDMDeviceControl, Stop)
  HRESULT(STDMETHODCALLTYPE *Stop)(__RPC__in IWMDMDeviceControl *This);

  DECLSPEC_XFGVIRT(IWMDMDeviceControl, Seek)
  HRESULT(STDMETHODCALLTYPE *Seek)(__RPC__in IWMDMDeviceControl *This,
                                   /* [in] */ UINT fuMode,
                                   /* [in] */ int nOffset);
...
typedef struct IWMDMEnumStorageVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in IWMDMEnumStorage *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IWMDMEnumStorage *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IWMDMEnumStorage *This);

  DECLSPEC_XFGVIRT(IWMDMEnumStorage, Next)
  HRESULT(STDMETHODCALLTYPE *Next)(__RPC__in IWMDMEnumStorage *This,
                                   /* [in] */ ULONG celt,
                                   /* [length_is][size_is][out] */
                                   __RPC__out_ecount_part(celt, *pceltFetched)
  ...
  HRESULT(STDMETHODCALLTYPE *Skip)(__RPC__in IWMDMEnumStorage *This,
                                   /* [in] */ ULONG celt,
                                   /* [out] */ __RPC__out ULONG *pceltFetched);

  DECLSPEC_XFGVIRT(IWMDMEnumStorage, Reset)
  HRESULT(STDMETHODCALLTYPE *Reset)(__RPC__in IWMDMEnumStorage *This);
...
interface IWMDMEnumStorage { CONST_VTBL struct IWMDMEnumStorageVtbl *lpVtbl; };
...
typedef struct IWMDMStorageControlVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IWMDMStorageControl *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IWMDMStorageControl *This);
...
#define IWMDMStorageControl_Insert(This, fuMode, pwszFile, pOperation,         \
                                   pProgress, ppNewObject)                     \
  ((This)->lpVtbl->Insert(This, fuMode, pwszFile, pOperation, pProgress,       \
                          ppNewObject))
...
#define IWMDMStorageControl_Read(This, fuMode, pwszFile, pProgress,            \
                                 pOperation)                                   \
...
public:
  virtual HRESULT STDMETHODCALLTYPE Insert2(
      ...
      /* [unique][out][in] */ __RPC__deref_opt_inout_opt IWMDMStorage *
          *ppNewObject) = 0;
};
...
typedef struct IWMDMStorageControl2Vtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IWMDMStorageControl2 *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IWMDMStorageControl2 *This);
...
#define IWMDMStorageControl2_Insert(This, fuMode, pwszFile, pOperation,        \
                                    pProgress, ppNewObject)                    \
  ((This)->lpVtbl->Insert(This, fuMode, pwszFile, pOperation, pProgress,       \
                          ppNewObject))
...
#define IWMDMStorageControl2_Read(This, fuMode, pwszFile, pProgress,           \
                                  pOperation)                                  \
  ((This)->lpVtbl->Read(This, fuMode, pwszFile, pProgress, pOperation))
...
#define IWMDMStorageControl2_Insert2(This, fuMode, pwszFileSource,             \
                                     pwszFileDest, pOperation, pProgress,      \
                                     pUnknown, ppNewObject)                    \
  ((This)->lpVtbl->Insert2(This, fuMode, pwszFileSource, pwszFileDest,         \
                           pOperation, pProgress, pUnknown, ppNewObject))
...
typedef struct IWMDMStorageControl3Vtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IWMDMStorageControl3 *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IWMDMStorageControl3 *This);
...
#define IWMDMStorageControl3_Insert(This, fuMode, pwszFile, pOperation,        \
                                    pProgress, ppNewObject)                    \
  ((This)->lpVtbl->Insert(This, fuMode, pwszFile, pOperation, pProgress,       \
                          ppNewObject))
...
#define IWMDMStorageControl3_Read(This, fuMode, pwszFile, pProgress,           \
                                  pOperation)                                  \
  ((This)->lpVtbl->Read(This, fuMode, pwszFile, pProgress, pOperation))
...
#define IWMDMStorageControl3_Insert2(This, fuMode, pwszFileSource,             \
                                     pwszFileDest, pOperation, pProgress,      \
                                     pUnknown, ppNewObject)                    \
  ((This)->lpVtbl->Insert2(This, fuMode, pwszFileSource, pwszFileDest,         \
                           pOperation, pProgress, pUnknown, ppNewObject))

#define IWMDMStorageControl3_Insert3(This, fuMode, fuType, pwszFileSource,     \
                                     pwszFileDest, pOperation, pProgress,      \
                                     pMetaData, pUnknown, ppNewObject)         \
  ((This)->lpVtbl->Insert3(This, fuMode, fuType, pwszFileSource, pwszFileDest, \
                           pOperation, pProgress, pMetaData, pUnknown,         \
                           ppNewObject))
...
typedef struct IWMDMObjectInfoVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in IWMDMObjectInfo *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IWMDMObjectInfo *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IWMDMObjectInfo *This);
  ...
  HRESULT(STDMETHODCALLTYPE *SetPlayLength)(__RPC__in IWMDMObjectInfo *This,
                                            /* [in] */ DWORD dwLength);
  ...
  HRESULT(STDMETHODCALLTYPE *SetPlayOffset)(__RPC__in IWMDMObjectInfo *This,
                                            /* [in] */ DWORD dwOffset);
...
interface IWMDMObjectInfo { CONST_VTBL struct IWMDMObjectInfoVtbl *lpVtbl; };
...
public:
  virtual HRESULT STDMETHODCALLTYPE GetRevocationURL(
      /* [size_is][size_is][string][out][in] */
      __RPC__deref_inout_ecount_full_opt_string(*pdwBufferLen) LPWSTR *
          ppwszRevocationURL,
...
typedef struct IWMDMRevokedVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in IWMDMRevoked *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IWMDMRevoked *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IWMDMRevoked *This);

  DECLSPEC_XFGVIRT(IWMDMRevoked, GetRevocationURL)
  HRESULT(STDMETHODCALLTYPE *GetRevocationURL)(
      __RPC__in IWMDMRevoked *This,
      /* [size_is][size_is][string][out][in] */
      __RPC__deref_inout_ecount_full_opt_string(*pdwBufferLen)
...
interface IWMDMRevoked { CONST_VTBL struct IWMDMRevokedVtbl *lpVtbl; };
...
#define IWMDMRevoked_GetRevocationURL(This, ppwszRevocationURL, pdwBufferLen,  \
                                      pdwRevokedBitFlag)                       \
...
typedef struct IWMDMNotificationVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in IWMDMNotification *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IWMDMNotification *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IWMDMNotification *This);
...
// Type: LPCWSTR, WMDM_TAG_DATATYPE: WMDM_TYPE_STRING
static const WCHAR *g_wszWMDMMediaClassSecondaryID =
    L"WMDM/MediaClassSecondaryID";
// Type: DWORD, WMDM_TAG_DATATYPE: WMDM_TYPE_DWORD
...
// Type: LPCWSTR, WMDM_TAG_DATATYPE: WMDM_TYPE_STRING
static const WCHAR *g_wszWMDMMediaOriginalChannel =
    L"WMDM/MediaOriginalChannel";
// Type: WMDMDATETIME, WMDM_TAG_DATATYPE: WMDM_TYPE_DATETIME
static const WCHAR *g_wszWMDMMediaOriginalBroadcastDateTime =
    L"WMDM/MediaOriginalBroadcastDateTime";
// Type: LPCWSTR, WMDM_TAG_DATATYPE: WMDM_TYPE_STRING
...
static const WCHAR *g_wszWMDMSupportedDeviceProperties =
    L"WMDM/SupportedDeviceProperties";
...
static const WCHAR *g_wszWMDMFormatsSupportedAreOrdered =
    L"WMDM/FormatsSupportedAreOrdered";
// PROPVARIANT vt = VT_BSTR
...
// PROPVARIANT vt = VT_BSTR
static const WCHAR *g_wszWMDMDeviceFirmwareVersion =
    L"WMDM/DeviceFirmwareVersion";
// PROPVARIANT vt = VT_BSTR
static const WCHAR *g_wszWMDMDeviceVendorExtension =
    L"WMDM/DeviceVendorExtension";
// PROPVARIANT vt = VT_CLSID
static const WCHAR *g_wszWMDMDeviceProtocol = L"WMDM/DeviceProtocol";
// PROPVARIANT vt = VT_CLSID
static const WCHAR *g_wszWMDMDeviceServiceProviderVendor =
    L"WMDM/DeviceServiceProviderVendor";
// PROPVARIANT vt = VT_BSTR
static const WCHAR *g_wszWMDMDeviceRevocationInfo =
    L"WMDM/DeviceRevocationInfo";
// PROPVARIANT vt = VT_BSTR
...
// Type: BYTE*, WMDM_TAG_DATATYPE: WMDM_TYPE_BINARY
static const WCHAR *g_wszWPDPassthroughPropertyValues =
    L"WPD/PassthroughPropertyValues";
...
#define WMDM_MAXLEN_PROPERTYNAME                                               \
  (sizeof(WMDMDetermineMaxPropStringLen) / sizeof(WCHAR))
// Open Mode Flags
...
typedef struct IMDServiceProviderVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in IMDServiceProvider *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IMDServiceProvider *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IMDServiceProvider *This);
...
public:
  virtual HRESULT STDMETHODCALLTYPE CreateDevice(
      ...
      /* [out] */ __RPC__out DWORD * pdwCount,
      /* [size_is][size_is][out] */
      __RPC__deref_out_ecount_full_opt(*pdwCount) IMDSPDevice *
          **pppDeviceArray) = 0;
};
...
typedef struct IMDServiceProvider2Vtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IMDServiceProvider2 *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IMDServiceProvider2 *This);
  ...
  HRESULT(STDMETHODCALLTYPE *CreateDevice)(
      ...
      /* [out] */ __RPC__out DWORD *pdwCount,
      /* [size_is][size_is][out] */
      __RPC__deref_out_ecount_full_opt(*pdwCount)
...
#define IMDServiceProvider2_CreateDevice(This, pwszDevicePath, pdwCount,       \
                                         pppDeviceArray)                       \
...
typedef struct IMDServiceProvider3Vtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IMDServiceProvider3 *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IMDServiceProvider3 *This);
...
#define IMDServiceProvider3_CreateDevice(This, pwszDevicePath, pdwCount,       \
                                         pppDeviceArray)                       \
  ((This)->lpVtbl->CreateDevice(This, pwszDevicePath, pdwCount, pppDeviceArray))
...
typedef struct IMDSPEnumDeviceVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in IMDSPEnumDevice *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IMDSPEnumDevice *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IMDSPEnumDevice *This);

  DECLSPEC_XFGVIRT(IMDSPEnumDevice, Next)
  HRESULT(STDMETHODCALLTYPE *Next)(__RPC__in IMDSPEnumDevice *This,
                                   /* [in] */ ULONG celt,
                                   /* [length_is][size_is][out] */
                                   __RPC__out_ecount_part(celt, *pceltFetched)
  ...
  HRESULT(STDMETHODCALLTYPE *Skip)(__RPC__in IMDSPEnumDevice *This,
                                   /* [in] */ ULONG celt,
                                   /* [out] */ __RPC__out ULONG *pceltFetched);

  DECLSPEC_XFGVIRT(IMDSPEnumDevice, Reset)
  HRESULT(STDMETHODCALLTYPE *Reset)(__RPC__in IMDSPEnumDevice *This);
...
interface IMDSPEnumDevice { CONST_VTBL struct IMDSPEnumDeviceVtbl *lpVtbl; };
...
typedef struct IMDSPDeviceVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in IMDSPDevice *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IMDSPDevice *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IMDSPDevice *This);

  DECLSPEC_XFGVIRT(IMDSPDevice, GetName)
  HRESULT(STDMETHODCALLTYPE *GetName)(__RPC__in IMDSPDevice *This,
                                      /* [size_is][string][out] */
                                      __RPC__out_ecount_full_string(nMaxChars)
                                          LPWSTR pwszName,
                                      /* [in] */ UINT nMaxChars);
  ...
  HRESULT(STDMETHODCALLTYPE *GetType)(__RPC__in IMDSPDevice *This,
                                      /* [out] */ __RPC__out DWORD *pdwType);
...
interface IMDSPDevice { CONST_VTBL struct IMDSPDeviceVtbl *lpVtbl; };
...
#define IMDSPDevice_GetFormatSupport(This, pFormatEx, pnFormatCount,           \
                                     pppwszMimeType, pnMimeTypeCount)          \
  ((This)->lpVtbl->GetFormatSupport(This, pFormatEx, pnFormatCount,            \
                                    pppwszMimeType, pnMimeTypeCount))
...
typedef struct IMDSPDevice2Vtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in IMDSPDevice2 *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IMDSPDevice2 *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IMDSPDevice2 *This);

  DECLSPEC_XFGVIRT(IMDSPDevice, GetName)
  HRESULT(STDMETHODCALLTYPE *GetName)(__RPC__in IMDSPDevice2 *This,
                                      /* [size_is][string][out] */
                                      __RPC__out_ecount_full_string(nMaxChars)
                                          LPWSTR pwszName,
                                      /* [in] */ UINT nMaxChars);
  ...
  DECLSPEC_XFGVIRT(IMDSPDevice, GetType)
  HRESULT(STDMETHODCALLTYPE *GetType)(__RPC__in IMDSPDevice2 *This,
                                      /* [out] */ __RPC__out DWORD *pdwType);
...
interface IMDSPDevice2 { CONST_VTBL struct IMDSPDevice2Vtbl *lpVtbl; };
...
#define IMDSPDevice2_GetFormatSupport(This, pFormatEx, pnFormatCount,          \
                                      pppwszMimeType, pnMimeTypeCount)         \
  ((This)->lpVtbl->GetFormatSupport(This, pFormatEx, pnFormatCount,            \
                                    pppwszMimeType, pnMimeTypeCount))
...
#define IMDSPDevice2_GetFormatSupport2(                                        \
    This, dwFlags, ppAudioFormatEx, pnAudioFormatCount, ppVideoFormatEx,       \
    pnVideoFormatCount, ppFileType, pnFileTypeCount)                           \
  ((This)->lpVtbl->GetFormatSupport2(                                          \
      This, dwFlags, ppAudioFormatEx, pnAudioFormatCount, ppVideoFormatEx,     \
...
#define IMDSPDevice2_GetSpecifyPropertyPages(This, ppSpecifyPropPages,         \
                                             pppUnknowns, pcUnks)              \
  ((This)->lpVtbl->GetSpecifyPropertyPages(This, ppSpecifyPropPages,           \
                                           pppUnknowns, pcUnks))
...
typedef struct IMDSPDevice3Vtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in IMDSPDevice3 *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IMDSPDevice3 *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IMDSPDevice3 *This);

  DECLSPEC_XFGVIRT(IMDSPDevice, GetName)
  HRESULT(STDMETHODCALLTYPE *GetName)(__RPC__in IMDSPDevice3 *This,
                                      /* [size_is][string][out] */
                                      __RPC__out_ecount_full_string(nMaxChars)
                                          LPWSTR pwszName,
                                      /* [in] */ UINT nMaxChars);
  ...
  DECLSPEC_XFGVIRT(IMDSPDevice, GetType)
  HRESULT(STDMETHODCALLTYPE *GetType)(__RPC__in IMDSPDevice3 *This,
                                      /* [out] */ __RPC__out DWORD *pdwType);
...
interface IMDSPDevice3 { CONST_VTBL struct IMDSPDevice3Vtbl *lpVtbl; };
...
#define IMDSPDevice3_GetFormatSupport(This, pFormatEx, pnFormatCount,          \
                                      pppwszMimeType, pnMimeTypeCount)         \
  ((This)->lpVtbl->GetFormatSupport(This, pFormatEx, pnFormatCount,            \
                                    pppwszMimeType, pnMimeTypeCount))
...
#define IMDSPDevice3_GetFormatSupport2(                                        \
    This, dwFlags, ppAudioFormatEx, pnAudioFormatCount, ppVideoFormatEx,       \
    pnVideoFormatCount, ppFileType, pnFileTypeCount)                           \
  ((This)->lpVtbl->GetFormatSupport2(                                          \
      This, dwFlags, ppAudioFormatEx, pnAudioFormatCount, ppVideoFormatEx,     \
...
#define IMDSPDevice3_GetSpecifyPropertyPages(This, ppSpecifyPropPages,         \
                                             pppUnknowns, pcUnks)              \
  ((This)->lpVtbl->GetSpecifyPropertyPages(This, ppSpecifyPropPages,           \
                                           pppUnknowns, pcUnks))
...
#define IMDSPDevice3_DeviceIoControl(This, dwIoControlCode, lpInBuffer,        \
                                     nInBufferSize, lpOutBuffer,               \
                                     pnOutBufferSize)                          \
  ((This)->lpVtbl->DeviceIoControl(This, dwIoControlCode, lpInBuffer,          \
                                   nInBufferSize, lpOutBuffer,                 \
...
typedef struct IMDSPDeviceControlVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in IMDSPDeviceControl *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IMDSPDeviceControl *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IMDSPDeviceControl *This);
  ...
  HRESULT(STDMETHODCALLTYPE *Play)(__RPC__in IMDSPDeviceControl *This);
  ...
  HRESULT(STDMETHODCALLTYPE *Pause)(__RPC__in IMDSPDeviceControl *This);

  DECLSPEC_XFGVIRT(IMDSPDeviceControl, Resume)
  HRESULT(STDMETHODCALLTYPE *Resume)(__RPC__in IMDSPDeviceControl *This);

  DECLSPEC_XFGVIRT(IMDSPDeviceControl, Stop)
  HRESULT(STDMETHODCALLTYPE *Stop)(__RPC__in IMDSPDeviceControl *This);

  DECLSPEC_XFGVIRT(IMDSPDeviceControl, Seek)
  HRESULT(STDMETHODCALLTYPE *Seek)(__RPC__in IMDSPDeviceControl *This,
                                   /* [in] */ UINT fuMode,
                                   /* [in] */ int nOffset);
...
typedef struct IMDSPEnumStorageVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in IMDSPEnumStorage *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IMDSPEnumStorage *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IMDSPEnumStorage *This);

  DECLSPEC_XFGVIRT(IMDSPEnumStorage, Next)
  HRESULT(STDMETHODCALLTYPE *Next)(__RPC__in IMDSPEnumStorage *This,
                                   /* [in] */ ULONG celt,
                                   /* [length_is][size_is][out] */
                                   __RPC__out_ecount_part(celt, *pceltFetched)
  ...
  HRESULT(STDMETHODCALLTYPE *Skip)(__RPC__in IMDSPEnumStorage *This,
                                   /* [in] */ ULONG celt,
                                   /* [out] */ __RPC__out ULONG *pceltFetched);

  DECLSPEC_XFGVIRT(IMDSPEnumStorage, Reset)
  HRESULT(STDMETHODCALLTYPE *Reset)(__RPC__in IMDSPEnumStorage *This);
...
interface IMDSPEnumStorage { CONST_VTBL struct IMDSPEnumStorageVtbl *lpVtbl; };
...
public:
  ...
  virtual HRESULT STDMETHODCALLTYPE GetStorageGlobals(
      /* [out] */ __RPC__deref_out_opt IMDSPStorageGlobals *
      *ppStorageGlobals) = 0;
...
typedef struct IMDSPStorageVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in IMDSPStorage *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IMDSPStorage *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IMDSPStorage *This);
  ...
  HRESULT(STDMETHODCALLTYPE *GetName)(__RPC__in IMDSPStorage *This,
                                      /* [size_is][string][out] */
                                      __RPC__out_ecount_full_string(nMaxChars)
                                          LPWSTR pwszName,
                                      /* [in] */ UINT nMaxChars);
  ...
  HRESULT(STDMETHODCALLTYPE *GetDate)(__RPC__in IMDSPStorage *This,
                                      /* [out] */ __RPC__out PWMDMDATETIME
                                          pDateTimeUTC);
...
interface IMDSPStorage { CONST_VTBL struct IMDSPStorageVtbl *lpVtbl; };
...
#define IMDSPStorage_CreateStorage(This, dwAttributes, pFormat, pwszName,      \
                                   ppNewStorage)                               \
  ((This)->lpVtbl->CreateStorage(This, dwAttributes, pFormat, pwszName,        \
                                 ppNewStorage))
...
typedef struct IMDSPStorage2Vtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in IMDSPStorage2 *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IMDSPStorage2 *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IMDSPStorage2 *This);
  ...
  DECLSPEC_XFGVIRT(IMDSPStorage, GetName)
  HRESULT(STDMETHODCALLTYPE *GetName)(__RPC__in IMDSPStorage2 *This,
                                      /* [size_is][string][out] */
                                      __RPC__out_ecount_full_string(nMaxChars)
                                          LPWSTR pwszName,
                                      /* [in] */ UINT nMaxChars);
  ...
  DECLSPEC_XFGVIRT(IMDSPStorage, GetDate)
  HRESULT(STDMETHODCALLTYPE *GetDate)(__RPC__in IMDSPStorage2 *This,
                                      /* [out] */ __RPC__out PWMDMDATETIME
                                          pDateTimeUTC);
...
interface IMDSPStorage2 { CONST_VTBL struct IMDSPStorage2Vtbl *lpVtbl; };
...
#define IMDSPStorage2_CreateStorage(This, dwAttributes, pFormat, pwszName,     \
                                    ppNewStorage)                              \
  ((This)->lpVtbl->CreateStorage(This, dwAttributes, pFormat, pwszName,        \
                                 ppNewStorage))
...
#define IMDSPStorage2_CreateStorage2(This, dwAttributes, dwAttributesEx,       \
                                     pAudioFormat, pVideoFormat, pwszName,     \
                                     qwFileSize, ppNewStorage)                 \
  ((This)->lpVtbl->CreateStorage2(This, dwAttributes, dwAttributesEx,          \
                                  pAudioFormat, pVideoFormat, pwszName,        \
                                  qwFileSize, ppNewStorage))

#define IMDSPStorage2_SetAttributes2(This, dwAttributes, dwAttributesEx,       \
                                     pAudioFormat, pVideoFormat)               \
  ((This)->lpVtbl->SetAttributes2(This, dwAttributes, dwAttributesEx,          \
                                  pAudioFormat, pVideoFormat))

#define IMDSPStorage2_GetAttributes2(This, pdwAttributes, pdwAttributesEx,     \
                                     pAudioFormat, pVideoFormat)               \
  ((This)->lpVtbl->GetAttributes2(This, pdwAttributes, pdwAttributesEx,        \
                                  pAudioFormat, pVideoFormat))
...
typedef struct IMDSPStorage3Vtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in IMDSPStorage3 *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IMDSPStorage3 *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IMDSPStorage3 *This);
  ...
  DECLSPEC_XFGVIRT(IMDSPStorage, GetName)
  HRESULT(STDMETHODCALLTYPE *GetName)(__RPC__in IMDSPStorage3 *This,
                                      /* [size_is][string][out] */
                                      __RPC__out_ecount_full_string(nMaxChars)
                                          LPWSTR pwszName,
                                      /* [in] */ UINT nMaxChars);
  ...
  DECLSPEC_XFGVIRT(IMDSPStorage, GetDate)
  HRESULT(STDMETHODCALLTYPE *GetDate)(__RPC__in IMDSPStorage3 *This,
                                      /* [out] */ __RPC__out PWMDMDATETIME
                                          pDateTimeUTC);
...
interface IMDSPStorage3 { CONST_VTBL struct IMDSPStorage3Vtbl *lpVtbl; };
...
#define IMDSPStorage3_CreateStorage(This, dwAttributes, pFormat, pwszName,     \
                                    ppNewStorage)                              \
  ((This)->lpVtbl->CreateStorage(This, dwAttributes, pFormat, pwszName,        \
                                 ppNewStorage))
...
#define IMDSPStorage3_CreateStorage2(This, dwAttributes, dwAttributesEx,       \
                                     pAudioFormat, pVideoFormat, pwszName,     \
                                     qwFileSize, ppNewStorage)                 \
  ((This)->lpVtbl->CreateStorage2(This, dwAttributes, dwAttributesEx,          \
                                  pAudioFormat, pVideoFormat, pwszName,        \
...
#define IMDSPStorage3_SetAttributes2(This, dwAttributes, dwAttributesEx,       \
                                     pAudioFormat, pVideoFormat)               \
  ((This)->lpVtbl->SetAttributes2(This, dwAttributes, dwAttributesEx,          \
                                  pAudioFormat, pVideoFormat))

#define IMDSPStorage3_GetAttributes2(This, pdwAttributes, pdwAttributesEx,     \
                                     pAudioFormat, pVideoFormat)               \
  ((This)->lpVtbl->GetAttributes2(This, pdwAttributes, pdwAttributesEx,        \
                                  pAudioFormat, pVideoFormat))
...
typedef struct IMDSPStorage4Vtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in IMDSPStorage4 *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IMDSPStorage4 *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IMDSPStorage4 *This);
  ...
  DECLSPEC_XFGVIRT(IMDSPStorage, GetName)
  HRESULT(STDMETHODCALLTYPE *GetName)(__RPC__in IMDSPStorage4 *This,
                                      /* [size_is][string][out] */
                                      __RPC__out_ecount_full_string(nMaxChars)
                                          LPWSTR pwszName,
                                      /* [in] */ UINT nMaxChars);
  ...
  DECLSPEC_XFGVIRT(IMDSPStorage, GetDate)
  HRESULT(STDMETHODCALLTYPE *GetDate)(__RPC__in IMDSPStorage4 *This,
                                      /* [out] */ __RPC__out PWMDMDATETIME
                                          pDateTimeUTC);
  ...
  HRESULT(STDMETHODCALLTYPE *SetReferences)(__RPC__in IMDSPStorage4 *This,
                                            /* [in] */ DWORD dwRefs,
                                            /* [size_is][unique][in] */
                                            __RPC__in_ecount_full_opt(dwRefs)
                                                IMDSPStorage **ppISPStorage);
...
interface IMDSPStorage4 { CONST_VTBL struct IMDSPStorage4Vtbl *lpVtbl; };
...
#define IMDSPStorage4_CreateStorage(This, dwAttributes, pFormat, pwszName,     \
                                    ppNewStorage)                              \
  ((This)->lpVtbl->CreateStorage(This, dwAttributes, pFormat, pwszName,        \
                                 ppNewStorage))
...
#define IMDSPStorage4_CreateStorage2(This, dwAttributes, dwAttributesEx,       \
                                     pAudioFormat, pVideoFormat, pwszName,     \
                                     qwFileSize, ppNewStorage)                 \
  ((This)->lpVtbl->CreateStorage2(This, dwAttributes, dwAttributesEx,          \
                                  pAudioFormat, pVideoFormat, pwszName,        \
...
#define IMDSPStorage4_SetAttributes2(This, dwAttributes, dwAttributesEx,       \
                                     pAudioFormat, pVideoFormat)               \
  ((This)->lpVtbl->SetAttributes2(This, dwAttributes, dwAttributesEx,          \
                                  pAudioFormat, pVideoFormat))

#define IMDSPStorage4_GetAttributes2(This, pdwAttributes, pdwAttributesEx,     \
                                     pAudioFormat, pVideoFormat)               \
  ((This)->lpVtbl->GetAttributes2(This, pdwAttributes, pdwAttributesEx,        \
                                  pAudioFormat, pVideoFormat))
...
#define IMDSPStorage4_CreateStorageWithMetadata(                               \
    This, dwAttributes, pwszName, pMetadata, qwFileSize, ppNewStorage)         \
  ((This)->lpVtbl->CreateStorageWithMetadata(                                  \
      This, dwAttributes, pwszName, pMetadata, qwFileSize, ppNewStorage))

#define IMDSPStorage4_GetSpecifiedMetadata(This, cProperties, ppwszPropNames,  \
                                           pMetadata)                          \
  ((This)->lpVtbl->GetSpecifiedMetadata(This, cProperties, ppwszPropNames,     \
                                        pMetadata))
...
typedef struct IMDSPStorageGlobalsVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IMDSPStorageGlobals *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IMDSPStorageGlobals *This);
...
#define IMDSPStorageGlobals_GetTotalSize(This, pdwTotalSizeLow,                \
                                         pdwTotalSizeHigh)                     \
  ((This)->lpVtbl->GetTotalSize(This, pdwTotalSizeLow, pdwTotalSizeHigh))
...
typedef struct IMDSPObjectInfoVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in IMDSPObjectInfo *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IMDSPObjectInfo *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IMDSPObjectInfo *This);
  ...
  HRESULT(STDMETHODCALLTYPE *SetPlayLength)(__RPC__in IMDSPObjectInfo *This,
                                            /* [in] */ DWORD dwLength);
  ...
  HRESULT(STDMETHODCALLTYPE *SetPlayOffset)(__RPC__in IMDSPObjectInfo *This,
                                            /* [in] */ DWORD dwOffset);
...
interface IMDSPObjectInfo { CONST_VTBL struct IMDSPObjectInfoVtbl *lpVtbl; };
...
typedef struct IMDSPObjectVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in IMDSPObject *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IMDSPObject *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IMDSPObject *This);

  DECLSPEC_XFGVIRT(IMDSPObject, Open)
  HRESULT(STDMETHODCALLTYPE *Open)(__RPC__in IMDSPObject *This,
                                   /* [in] */ UINT fuMode);
  ...
  HRESULT(STDMETHODCALLTYPE *Seek)(__RPC__in IMDSPObject *This,
                                   /* [in] */ UINT fuFlags,
                                   /* [in] */ DWORD dwOffset);
  ...
  HRESULT(STDMETHODCALLTYPE *Close)(__RPC__in IMDSPObject *This);

  END_INTERFACE
} IMDSPObjectVtbl;

interface IMDSPObject { CONST_VTBL struct IMDSPObjectVtbl *lpVtbl; };
...
typedef struct IMDSPObject2Vtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in IMDSPObject2 *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IMDSPObject2 *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IMDSPObject2 *This);

  DECLSPEC_XFGVIRT(IMDSPObject, Open)
  HRESULT(STDMETHODCALLTYPE *Open)(__RPC__in IMDSPObject2 *This,
                                   /* [in] */ UINT fuMode);
  ...
  DECLSPEC_XFGVIRT(IMDSPObject, Seek)
  HRESULT(STDMETHODCALLTYPE *Seek)(__RPC__in IMDSPObject2 *This,
                                   /* [in] */ UINT fuFlags,
                                   /* [in] */ DWORD dwOffset);
  ...
  DECLSPEC_XFGVIRT(IMDSPObject, Close)
  HRESULT(STDMETHODCALLTYPE *Close)(__RPC__in IMDSPObject2 *This);
...
interface IMDSPObject2 { CONST_VTBL struct IMDSPObject2Vtbl *lpVtbl; };
...
public:
  virtual HRESULT STDMETHODCALLTYPE TransferToDevice(
      /* [string][unique][in] */ __RPC__in_opt_string LPCWSTR
          pwszSourceFilePath,
...
typedef struct IMDSPDirectTransferVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IMDSPDirectTransfer *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IMDSPDirectTransfer *This);
...
#define IMDSPDirectTransfer_TransferToDevice(                                  \
    This, pwszSourceFilePath, pSourceOperation, fuFlags, pwszDestinationName,  \
    pSourceMetaData, pTransferProgress, ppNewObject)                           \
  ((This)->lpVtbl->TransferToDevice(                                           \
      This, pwszSourceFilePath, pSourceOperation, fuFlags,                     \
      pwszDestinationName, pSourceMetaData, pTransferProgress, ppNewObject))
...
typedef struct IMDSPRevokedVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in IMDSPRevoked *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IMDSPRevoked *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IMDSPRevoked *This);
...
interface IMDSPRevoked { CONST_VTBL struct IMDSPRevokedVtbl *lpVtbl; };
...
DEFINE_GUID(SCP_EVENTID_ACQSECURECLOCK, 0x86248cc9, 0x4a59, 0x43e2, 0x91, 0x46,
            0x48, 0xa7, 0xf3, 0xf4, 0x14, 0xc);
//
// {87A507C7-B469-4386-B976-D5D1CE538A6F}
DEFINE_GUID(SCP_EVENTID_NEEDTOINDIV, 0x87a507c7, 0xb469, 0x4386, 0xb9, 0x76,
            0xd5, 0xd1, 0xce, 0x53, 0x8a, 0x6f);
// this event ID is used to notify the player the version DRM header found in
// the content {213DD287-41D2-432b-9E3F-3B4F7B3581DD}
DEFINE_GUID(SCP_EVENTID_DRMINFO, 0x213dd287, 0x41d2, 0x432b, 0x9e, 0x3f, 0x3b,
            0x4f, 0x7b, 0x35, 0x81, 0xdd);
// this parameter ID is used when notifying SCP_EVENTID_DRMINFO message
// {41D0155D-7CC7-4217-ADA9-005074624DA4}
DEFINE_GUID(SCP_PARAMID_DRMVERSION, 0x41d0155d, 0x7cc7, 0x4217, 0xad, 0xa9,
            0x00, 0x50, 0x74, 0x62, 0x4d, 0xa4);
#endif
...
typedef struct ISCPSecureAuthenticateVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in ISCPSecureAuthenticate *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in ISCPSecureAuthenticate *This);
...
typedef struct ISCPSecureAuthenticate2Vtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in ISCPSecureAuthenticate2 *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in ISCPSecureAuthenticate2 *This);
...
public:
  ...
  virtual HRESULT STDMETHODCALLTYPE MakeDecision(
      ...
      /* [in] */ DWORD dwSize,
      /* [in] */ DWORD dwAppSec,
      /* [size_is][in] */ __RPC__in_ecount_full(dwSessionKeyLen) BYTE *
          pbSPSessionKey,
...
typedef struct ISCPSecureQueryVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in ISCPSecureQuery *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in ISCPSecureQuery *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in ISCPSecureQuery *This);
...
interface ISCPSecureQuery { CONST_VTBL struct ISCPSecureQueryVtbl *lpVtbl; };
...
#define ISCPSecureQuery_GetDataDemands(This, pfuFlags, pdwMinRightsData,       \
                                       pdwMinExamineData, pdwMinDecideData,    \
                                       abMac)                                  \
  ((This)->lpVtbl->GetDataDemands(This, pfuFlags, pdwMinRightsData,            \
                                  pdwMinExamineData, pdwMinDecideData, abMac))

#define ISCPSecureQuery_ExamineData(This, fuFlags, pwszExtension, pData,       \
                                    dwSize, abMac)                             \
  ((This)->lpVtbl->ExamineData(This, fuFlags, pwszExtension, pData, dwSize,    \
                               abMac))

#define ISCPSecureQuery_MakeDecision(This, fuFlags, pData, dwSize, dwAppSec,   \
                                     pbSPSessionKey, dwSessionKeyLen,          \
                                     pStorageGlobals, ppExchange, abMac)       \
  ((This)->lpVtbl->MakeDecision(This, fuFlags, pData, dwSize, dwAppSec,        \
                                pbSPSessionKey, dwSessionKeyLen,               \
                                pStorageGlobals, ppExchange, abMac))

#define ISCPSecureQuery_GetRights(This, pData, dwSize, pbSPSessionKey,         \
                                  dwSessionKeyLen, pStgGlobals, ppRights,      \
                                  pnRightsCount, abMac)                        \
  ((This)->lpVtbl->GetRights(This, pData, dwSize, pbSPSessionKey,              \
                             dwSessionKeyLen, pStgGlobals, ppRights,           \
                             pnRightsCount, abMac))
...
public:
  virtual HRESULT STDMETHODCALLTYPE MakeDecision2(
      ...
      /* [in] */ DWORD dwSessionKeyLen,
      /* [in] */ __RPC__in_opt IMDSPStorageGlobals * pStorageGlobals,
      /* [size_is][in] */ __RPC__in_ecount_full(dwAppCertAppLen) BYTE *
          pAppCertApp,
      /* [in] */ DWORD dwAppCertAppLen,
      /* [size_is][in] */ __RPC__in_ecount_full(dwAppCertSPLen) BYTE *
          pAppCertSP,
      /* [in] */ DWORD dwAppCertSPLen,
      /* [size_is][size_is][string][out][in] */
      __RPC__deref_inout_ecount_full_opt_string(*pdwRevocationURLLen) LPWSTR *
          pszRevocationURL,
...
typedef struct ISCPSecureQuery2Vtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in ISCPSecureQuery2 *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in ISCPSecureQuery2 *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in ISCPSecureQuery2 *This);
  ...
  HRESULT(STDMETHODCALLTYPE *MakeDecision2)(
      ...
      /* [in] */ DWORD dwAppCertSPLen,
      /* [size_is][size_is][string][out][in] */
      __RPC__deref_inout_ecount_full_opt_string(*pdwRevocationURLLen)
...
interface ISCPSecureQuery2 { CONST_VTBL struct ISCPSecureQuery2Vtbl *lpVtbl; };
...
#define ISCPSecureQuery2_GetDataDemands(This, pfuFlags, pdwMinRightsData,      \
                                        pdwMinExamineData, pdwMinDecideData,   \
                                        abMac)                                 \
  ((This)->lpVtbl->GetDataDemands(This, pfuFlags, pdwMinRightsData,            \
                                  pdwMinExamineData, pdwMinDecideData, abMac))

#define ISCPSecureQuery2_ExamineData(This, fuFlags, pwszExtension, pData,      \
                                     dwSize, abMac)                            \
  ((This)->lpVtbl->ExamineData(This, fuFlags, pwszExtension, pData, dwSize,    \
                               abMac))

#define ISCPSecureQuery2_MakeDecision(This, fuFlags, pData, dwSize, dwAppSec,  \
                                      pbSPSessionKey, dwSessionKeyLen,         \
                                      pStorageGlobals, ppExchange, abMac)      \
  ((This)->lpVtbl->MakeDecision(This, fuFlags, pData, dwSize, dwAppSec,        \
                                pbSPSessionKey, dwSessionKeyLen,               \
...
#define ISCPSecureQuery2_GetRights(This, pData, dwSize, pbSPSessionKey,        \
                                   dwSessionKeyLen, pStgGlobals, ppRights,     \
                                   pnRightsCount, abMac)                       \
  ((This)->lpVtbl->GetRights(This, pData, dwSize, pbSPSessionKey,              \
                             dwSessionKeyLen, pStgGlobals, ppRights,           \
...
#define ISCPSecureQuery2_MakeDecision2(                                        \
    This, fuFlags, pData, dwSize, dwAppSec, pbSPSessionKey, dwSessionKeyLen,   \
    pStorageGlobals, pAppCertApp, dwAppCertAppLen, pAppCertSP, dwAppCertSPLen, \
    pszRevocationURL, pdwRevocationURLLen, pdwRevocationBitFlag, pqwFileSize,  \
    pUnknown, ppExchange, abMac)                                               \
  ((This)->lpVtbl->MakeDecision2(                                              \
      This, fuFlags, pData, dwSize, dwAppSec, pbSPSessionKey, dwSessionKeyLen, \
      pStorageGlobals, pAppCertApp, dwAppCertAppLen, pAppCertSP,               \
      dwAppCertSPLen, pszRevocationURL, pdwRevocationURLLen,                   \
      pdwRevocationBitFlag, pqwFileSize, pUnknown, ppExchange, abMac))
...
typedef struct ISCPSecureExchangeVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in ISCPSecureExchange *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in ISCPSecureExchange *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in ISCPSecureExchange *This);
...
#define ISCPSecureExchange_TransferContainerData(This, pData, dwSize,          \
                                                 pfuReadyFlags, abMac)         \
  ((This)->lpVtbl->TransferContainerData(This, pData, dwSize, pfuReadyFlags,   \
                                         abMac))
...
typedef struct ISCPSecureExchange2Vtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in ISCPSecureExchange2 *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in ISCPSecureExchange2 *This);
...
#define ISCPSecureExchange2_TransferContainerData(This, pData, dwSize,         \
                                                  pfuReadyFlags, abMac)        \
  ((This)->lpVtbl->TransferContainerData(This, pData, dwSize, pfuReadyFlags,   \
                                         abMac))
...
#define ISCPSecureExchange2_TransferContainerData2(                            \
    This, pData, dwSize, pProgressCallback, pfuReadyFlags, abMac)              \
  ((This)->lpVtbl->TransferContainerData2(                                     \
      This, pData, dwSize, pProgressCallback, pfuReadyFlags, abMac))
...
typedef struct ISCPSecureExchange3Vtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in ISCPSecureExchange3 *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in ISCPSecureExchange3 *This);
...
#define ISCPSecureExchange3_TransferContainerData(This, pData, dwSize,         \
                                                  pfuReadyFlags, abMac)        \
  ((This)->lpVtbl->TransferContainerData(This, pData, dwSize, pfuReadyFlags,   \
                                         abMac))
...
#define ISCPSecureExchange3_TransferContainerData2(                            \
    This, pData, dwSize, pProgressCallback, pfuReadyFlags, abMac)              \
  ((This)->lpVtbl->TransferContainerData2(                                     \
      This, pData, dwSize, pProgressCallback, pfuReadyFlags, abMac))

#define ISCPSecureExchange3_TransferContainerDataOnClearChannel(               \
    This, pDevice, pData, dwSize, pProgressCallback, pfuReadyFlags)            \
  ((This)->lpVtbl->TransferContainerDataOnClearChannel(                        \
      This, pDevice, pData, dwSize, pProgressCallback, pfuReadyFlags))

#define ISCPSecureExchange3_GetObjectDataOnClearChannel(This, pDevice, pData,  \
                                                        pdwSize)               \
...
typedef struct ISCPSessionVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in ISCPSession *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in ISCPSession *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in ISCPSession *This);
...
interface ISCPSession { CONST_VTBL struct ISCPSessionVtbl *lpVtbl; };
...
typedef struct ISCPSecureQuery3Vtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in ISCPSecureQuery3 *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in ISCPSecureQuery3 *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in ISCPSecureQuery3 *This);
...
interface ISCPSecureQuery3 { CONST_VTBL struct ISCPSecureQuery3Vtbl *lpVtbl; };
...
#define ISCPSecureQuery3_GetDataDemands(This, pfuFlags, pdwMinRightsData,      \
                                        pdwMinExamineData, pdwMinDecideData,   \
                                        abMac)                                 \
  ((This)->lpVtbl->GetDataDemands(This, pfuFlags, pdwMinRightsData,            \
                                  pdwMinExamineData, pdwMinDecideData, abMac))

#define ISCPSecureQuery3_ExamineData(This, fuFlags, pwszExtension, pData,      \
                                     dwSize, abMac)                            \
  ((This)->lpVtbl->ExamineData(This, fuFlags, pwszExtension, pData, dwSize,    \
                               abMac))

#define ISCPSecureQuery3_MakeDecision(This, fuFlags, pData, dwSize, dwAppSec,  \
                                      pbSPSessionKey, dwSessionKeyLen,         \
                                      pStorageGlobals, ppExchange, abMac)      \
  ((This)->lpVtbl->MakeDecision(This, fuFlags, pData, dwSize, dwAppSec,        \
                                pbSPSessionKey, dwSessionKeyLen,               \
...
#define ISCPSecureQuery3_GetRights(This, pData, dwSize, pbSPSessionKey,        \
                                   dwSessionKeyLen, pStgGlobals, ppRights,     \
                                   pnRightsCount, abMac)                       \
  ((This)->lpVtbl->GetRights(This, pData, dwSize, pbSPSessionKey,              \
                             dwSessionKeyLen, pStgGlobals, ppRights,           \
...
#define ISCPSecureQuery3_MakeDecision2(                                        \
    This, fuFlags, pData, dwSize, dwAppSec, pbSPSessionKey, dwSessionKeyLen,   \
    pStorageGlobals, pAppCertApp, dwAppCertAppLen, pAppCertSP, dwAppCertSPLen, \
    pszRevocationURL, pdwRevocationURLLen, pdwRevocationBitFlag, pqwFileSize,  \
    pUnknown, ppExchange, abMac)                                               \
...
#define ISCPSecureQuery3_GetRightsOnClearChannel(                              \
    This, pData, dwSize, pbSPSessionKey, dwSessionKeyLen, pStgGlobals,         \
    pProgressCallback, ppRights, pnRightsCount)                                \
  ((This)->lpVtbl->GetRightsOnClearChannel(                                    \
      This, pData, dwSize, pbSPSessionKey, dwSessionKeyLen, pStgGlobals,       \
      pProgressCallback, ppRights, pnRightsCount))

#define ISCPSecureQuery3_MakeDecisionOnClearChannel(                           \
    This, fuFlags, pData, dwSize, dwAppSec, pbSPSessionKey, dwSessionKeyLen,   \
    pStorageGlobals, pProgressCallback, pAppCertApp, dwAppCertAppLen,          \
    pAppCertSP, dwAppCertSPLen, pszRevocationURL, pdwRevocationURLLen,         \
    pdwRevocationBitFlag, pqwFileSize, pUnknown, ppExchange)                   \
  ((This)->lpVtbl->MakeDecisionOnClearChannel(                                 \
      This, fuFlags, pData, dwSize, dwAppSec, pbSPSessionKey, dwSessionKeyLen, \
      pStorageGlobals, pProgressCallback, pAppCertApp, dwAppCertAppLen,        \
      pAppCertSP, dwAppCertSPLen, pszRevocationURL, pdwRevocationURLLen,       \
      pdwRevocationBitFlag, pqwFileSize, pUnknown, ppExchange))
...
typedef struct IComponentAuthenticateVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IComponentAuthenticate *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IComponentAuthenticate *This);
...
#define IComponentAuthenticate_SACAuth(This, dwProtocolID, dwPass, pbDataIn,   \
                                       dwDataInLen, ppbDataOut, pdwDataOutLen) \
  ((This)->lpVtbl->SACAuth(This, dwProtocolID, dwPass, pbDataIn, dwDataInLen,  \
                           ppbDataOut, pdwDataOutLen))

#define IComponentAuthenticate_SACGetProtocols(This, ppdwProtocols,            \
                                               pdwProtocolCount)               \
...
const GUID EVENT_WMDM_CONTENT_TRANSFER = {
    0x339C9BF4,
    0xBCFE,
    0x4ED8,
    {0x94, 0xDF, 0xEA, 0xF8, 0xC2, 0x6A, 0xB6, 0x1B}};
...
class DECLSPEC_UUID("25BAAD81-3560-11D3-8471-00C04F79DBC0") MediaDevMgr;
#endif
...
class DECLSPEC_UUID("807B3CDF-357A-11d3-8471-00C04F79DBC0") WMDMDevice;
#endif
...
class DECLSPEC_UUID("807B3CE0-357A-11d3-8471-00C04F79DBC0") WMDMStorage;
#endif
...
class DECLSPEC_UUID("807B3CE1-357A-11d3-8471-00C04F79DBC0") WMDMStorageGlobal;
#endif
...
class DECLSPEC_UUID("430E35AF-3971-11D3-8474-00C04F79DBC0") WMDMDeviceEnum;
#endif
...
class DECLSPEC_UUID("EB401A3B-3AF7-11d3-8474-00C04F79DBC0") WMDMStorageEnum;
#endif
