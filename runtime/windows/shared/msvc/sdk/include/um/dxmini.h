...
DEFINE_GUID(GUID_DxApi, 0x8a79bef0, 0xb915, 0x11d0, 0x91, 0x44, 0x08, 0x00,
            0x36, 0xd2, 0xef, 0x02);
...
#define MDL_MAPPING_FLAGS                                                      \
  (MDL_MAPPED_TO_SYSTEM_VA | MDL_PAGES_LOCKED | MDL_SOURCE_IS_NONPAGED_POOL |  \
   MDL_PARTIAL_HAS_BEEN_MAPPED | MDL_PARENT_MAPPED_SYSTEM_VA | MDL_LOCK_HELD | \
...
typedef DWORD (*PDX_GETPOLARITY)(PVOID, PDDGETPOLARITYININFO,
                                 PDDGETPOLARITYOUTINFO);
typedef DWORD (*PDX_GETCURRENTAUTOFLIP)(PVOID, PDDGETCURRENTAUTOFLIPININFO,
                                        PDDGETCURRENTAUTOFLIPOUTINFO);
typedef DWORD (*PDX_GETPREVIOUSAUTOFLIP)(PVOID, PDDGETPREVIOUSAUTOFLIPININFO,
