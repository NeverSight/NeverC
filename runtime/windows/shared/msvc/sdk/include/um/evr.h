...
interface IMFVideoDeviceID { CONST_VTBL struct IMFVideoDeviceIDVtbl *lpVtbl; };
...
typedef struct IMFVideoDisplayControlVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IMFVideoDisplayControl *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IMFVideoDisplayControl *This);
...
interface IMFDesiredSample { CONST_VTBL struct IMFDesiredSampleVtbl *lpVtbl; };
...
typedef struct IMFVideoMixerControlVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IMFVideoMixerControl *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IMFVideoMixerControl *This);
...
typedef struct IMFVideoMixerControl2Vtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IMFVideoMixerControl2 *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IMFVideoMixerControl2 *This);
...
interface IMFVideoRenderer { CONST_VTBL struct IMFVideoRendererVtbl *lpVtbl; };
...
interface IEVRFilterConfig { CONST_VTBL struct IEVRFilterConfigVtbl *lpVtbl; };
...
typedef struct IEVRFilterConfigExVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in IEVRFilterConfigEx *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IEVRFilterConfigEx *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IEVRFilterConfigEx *This);
  ...
  HRESULT(STDMETHODCALLTYPE *SetConfigPrefs)(__RPC__in IEVRFilterConfigEx *This,
...
EVRPUBLIC(MFCreateVideoPresenter)(
    _In_opt_ IUnknown *pOwner, REFIID riidDevice, REFIID riid,
    _Outptr_result_maybenull_ void **ppVideoPresenter);
EVRPUBLIC(MFCreateVideoMixer)(_In_opt_ IUnknown *pOwner, REFIID riidDevice,
                              REFIID riid, _Outptr_ void **ppv);
EVRPUBLIC(MFCreateVideoMixerAndPresenter)(_In_opt_ IUnknown *pMixerOwner,
...
EVRPUBLIC(MFCreateVideoRenderer)(
    REFIID riidRenderer, _Outptr_result_maybenull_ void **ppVideoRenderer);
EVRPUBLIC(MFCreateVideoSampleFromSurface)(_In_ IUnknown *pUnkSurface,
                                          _Out_ IMFSample **ppSample);
EVRPUBLIC(MFCreateVideoSampleAllocator)(_In_ REFIID riid,
