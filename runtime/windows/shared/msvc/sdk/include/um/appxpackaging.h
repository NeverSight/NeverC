...
typedef interface IAppxManifestDriverDependenciesEnumerator
...
typedef interface IAppxManifestDriverConstraintsEnumerator
...
typedef interface IAppxManifestOSPackageDependenciesEnumerator
...
typedef interface IAppxManifestOSPackageDependency
...
typedef interface IAppxManifestHostRuntimeDependency
...
typedef interface IAppxManifestHostRuntimeDependency2
...
typedef interface IAppxManifestOptionalPackageInfo
...
typedef interface IAppxManifestMainPackageDependenciesEnumerator
...
typedef interface IAppxManifestMainPackageDependency
...
typedef interface IAppxManifestTargetDeviceFamiliesEnumerator
...
typedef interface IAppxManifestTargetDeviceFamily
...
typedef interface IAppxManifestPackageDependenciesEnumerator
...
typedef interface IAppxManifestPackageDependency2
...
typedef interface IAppxManifestPackageDependency3
...
typedef interface IAppxManifestResourcesEnumerator
...
typedef interface IAppxManifestCapabilitiesEnumerator
...
typedef interface IAppxManifestApplicationsEnumerator
...
typedef interface IAppxManifestQualifiedResourcesEnumerator
...
typedef interface IAppxBundleManifestPackageInfoEnumerator
...
typedef interface IAppxBundleManifestPackageInfo2
...
typedef interface IAppxBundleManifestPackageInfo3
...
typedef interface IAppxBundleManifestPackageInfo4
...
typedef interface IAppxBundleManifestOptionalBundleInfoEnumerator
...
typedef interface IAppxBundleManifestOptionalBundleInfo
...
typedef interface IAppxContentGroupFilesEnumerator
...
typedef interface IAppxSourceContentGroupMapReader
...
typedef interface IAppxPackagingDiagnosticEventSink
...
typedef interface IAppxPackagingDiagnosticEventSinkManager
...
#ifdef __cplusplus
typedef class AppxPackagingDiagnosticEventSinkManager
    AppxPackagingDiagnosticEventSinkManager;
#else
typedef struct AppxPackagingDiagnosticEventSinkManager
    AppxPackagingDiagnosticEventSinkManager;
#endif /* __cplusplus */
...
public:
  virtual HRESULT STDMETHODCALLTYPE CreatePackageWriter(
      ...
      /* [retval][out] */ __RPC__deref_out_opt IAppxPackageWriter *
          *packageWriter) = 0;

  virtual HRESULT STDMETHODCALLTYPE CreatePackageReader(
      /* [in] */ __RPC__in_opt IStream * inputStream,
      /* [retval][out] */ __RPC__deref_out_opt IAppxPackageReader *
          *packageReader) = 0;

  virtual HRESULT STDMETHODCALLTYPE CreateManifestReader(
      /* [in] */ __RPC__in_opt IStream * inputStream,
      /* [retval][out] */ __RPC__deref_out_opt IAppxManifestReader *
          *manifestReader) = 0;

  virtual HRESULT STDMETHODCALLTYPE CreateBlockMapReader(
      /* [in] */ __RPC__in_opt IStream * inputStream,
      /* [retval][out] */ __RPC__deref_out_opt IAppxBlockMapReader *
          *blockMapReader) = 0;
...
typedef struct IAppxFactoryVtbl {
  ...
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in IAppxFactory *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IAppxFactory *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IAppxFactory *This);
...
interface IAppxFactory { CONST_VTBL struct IAppxFactoryVtbl *lpVtbl; };
...
#define IAppxFactory_CreatePackageWriter(This, outputStream, settings,         \
                                         packageWriter)                        \
  ((This)->lpVtbl->CreatePackageWriter(This, outputStream, settings,           \
                                       packageWriter))
...
#define IAppxFactory_CreateValidatedBlockMapReader(                            \
    This, blockMapStream, signatureFileName, blockMapReader)                   \
  ((This)->lpVtbl->CreateValidatedBlockMapReader(                              \
      This, blockMapStream, signatureFileName, blockMapReader))
...
public:
  virtual HRESULT STDMETHODCALLTYPE CreateContentGroupMapReader(
      /* [in] */ __RPC__in_opt IStream * inputStream,
      /* [retval][out] */ __RPC__deref_out_opt IAppxContentGroupMapReader *
          *contentGroupMapReader) = 0;

  virtual HRESULT STDMETHODCALLTYPE CreateSourceContentGroupMapReader(
      /* [in] */ __RPC__in_opt IStream * inputStream,
      /* [retval][out] */
      __RPC__deref_out_opt IAppxSourceContentGroupMapReader * *reader) = 0;

  virtual HRESULT STDMETHODCALLTYPE CreateContentGroupMapWriter(
      /* [in] */ __RPC__in_opt IStream * stream,
      /* [retval][out] */ __RPC__deref_out_opt IAppxContentGroupMapWriter *
          *contentGroupMapWriter) = 0;
};
...
typedef struct IAppxFactory2Vtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in IAppxFactory2 *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IAppxFactory2 *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IAppxFactory2 *This);
...
interface IAppxFactory2 { CONST_VTBL struct IAppxFactory2Vtbl *lpVtbl; };
...
#define IAppxFactory2_CreateContentGroupMapReader(This, inputStream,           \
                                                  contentGroupMapReader)       \
  ((This)->lpVtbl->CreateContentGroupMapReader(This, inputStream,              \
                                               contentGroupMapReader))

#define IAppxFactory2_CreateSourceContentGroupMapReader(This, inputStream,     \
                                                        reader)                \
  ((This)->lpVtbl->CreateSourceContentGroupMapReader(This, inputStream, reader))

#define IAppxFactory2_CreateContentGroupMapWriter(This, stream,                \
                                                  contentGroupMapWriter)       \
  ((This)->lpVtbl->CreateContentGroupMapWriter(This, stream,                   \
                                               contentGroupMapWriter))
...
public:
  ...
  virtual HRESULT STDMETHODCALLTYPE CreateAppInstallerReader(
      /* [in] */ __RPC__in_opt IStream * inputStream,
      /* [optional][in] */ __RPC__in LPCWSTR expectedDigest,
      /* [retval][out] */ __RPC__deref_out_opt IAppxAppInstallerReader *
          *appInstallerReader) = 0;
};
...
typedef struct IAppxFactory3Vtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in IAppxFactory3 *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IAppxFactory3 *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IAppxFactory3 *This);
  ...
  HRESULT(STDMETHODCALLTYPE *CreateAppInstallerReader)(
      ...
      /* [optional][in] */ __RPC__in LPCWSTR expectedDigest,
      /* [retval][out] */
      __RPC__deref_out_opt IAppxAppInstallerReader **appInstallerReader);

  END_INTERFACE
} IAppxFactory3Vtbl;

interface IAppxFactory3 { CONST_VTBL struct IAppxFactory3Vtbl *lpVtbl; };
...
#define IAppxFactory3_AddRef(This) ((This)->lpVtbl->AddRef(This))

#define IAppxFactory3_Release(This) ((This)->lpVtbl->Release(This))

#define IAppxFactory3_CreatePackageReader2(This, inputStream, expectedDigest,  \
                                           packageReader)                      \
  ((This)->lpVtbl->CreatePackageReader2(This, inputStream, expectedDigest,     \
                                        packageReader))

#define IAppxFactory3_CreateManifestReader2(This, inputStream, expectedDigest, \
                                            manifestReader)                    \
  ((This)->lpVtbl->CreateManifestReader2(This, inputStream, expectedDigest,    \
                                         manifestReader))

#define IAppxFactory3_CreateAppInstallerReader(                                \
    This, inputStream, expectedDigest, appInstallerReader)                     \
  ((This)->lpVtbl->CreateAppInstallerReader(This, inputStream, expectedDigest, \
                                            appInstallerReader))
...
typedef struct IAppxFactory4Vtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in IAppxFactory4 *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IAppxFactory4 *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IAppxFactory4 *This);
...
interface IAppxFactory4 { CONST_VTBL struct IAppxFactory4Vtbl *lpVtbl; };
...
#define IAppxFactory4_AddRef(This) ((This)->lpVtbl->AddRef(This))

#define IAppxFactory4_Release(This) ((This)->lpVtbl->Release(This))

#define IAppxFactory4_CreatePackageReaderFromSourceUri(                        \
    This, uri, expectedDigest, packageReader)                                  \
  ((This)->lpVtbl->CreatePackageReaderFromSourceUri(This, uri, expectedDigest, \
                                                    packageReader))
...
public:
  ...
  virtual HRESULT STDMETHODCALLTYPE GetPayloadFiles(
      /* [retval][out] */ __RPC__deref_out_opt IAppxFilesEnumerator *
      *filesEnumerator) = 0;
...
typedef struct IAppxPackageReaderVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in IAppxPackageReader *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IAppxPackageReader *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IAppxPackageReader *This);
...
typedef struct IAppxPackageWriterVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in IAppxPackageWriter *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IAppxPackageWriter *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IAppxPackageWriter *This);
  ...
  HRESULT(STDMETHODCALLTYPE *Close)(__RPC__in IAppxPackageWriter *This,
...
#define IAppxPackageWriter_AddPayloadFile(This, fileName, contentType,         \
                                          compressionOption, inputStream)      \
  ((This)->lpVtbl->AddPayloadFile(This, fileName, contentType,                 \
                                  compressionOption, inputStream))
...
typedef struct IAppxPackageWriter2Vtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IAppxPackageWriter2 *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IAppxPackageWriter2 *This);
...
public:
  virtual HRESULT STDMETHODCALLTYPE AddPayloadFiles(
      /* [in] */ UINT32 fileCount,
      /* [size_is][in] */
      __RPC__in_ecount_full(fileCount) APPX_PACKAGE_WRITER_PAYLOAD_STREAM *
          payloadFiles,
...
typedef struct IAppxPackageWriter3Vtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IAppxPackageWriter3 *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IAppxPackageWriter3 *This);
  ...
  HRESULT(STDMETHODCALLTYPE *AddPayloadFiles)(
      ...
      /* [in] */ UINT32 fileCount,
      /* [size_is][in] */
      __RPC__in_ecount_full(fileCount)
...
#define IAppxPackageWriter3_AddPayloadFiles(This, fileCount, payloadFiles,     \
                                            memoryLimit)                       \
...
public:
  virtual HRESULT STDMETHODCALLTYPE GetCompressionOption(
      /* [retval][out] */ __RPC__out APPX_COMPRESSION_OPTION *
      compressionOption) = 0;
...
typedef struct IAppxFileVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in IAppxFile *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IAppxFile *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IAppxFile *This);
...
interface IAppxFile { CONST_VTBL struct IAppxFileVtbl *lpVtbl; };
...
typedef struct IAppxFile2Vtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in IAppxFile2 *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IAppxFile2 *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IAppxFile2 *This);
...
interface IAppxFile2 { CONST_VTBL struct IAppxFile2Vtbl *lpVtbl; };
...
#define IAppxFile2_AddRef(This) ((This)->lpVtbl->AddRef(This))

#define IAppxFile2_Release(This) ((This)->lpVtbl->Release(This))
...
#define IAppxFile2_GetSize(This, size) ((This)->lpVtbl->GetSize(This, size))
...
typedef struct IAppxFilesEnumeratorVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IAppxFilesEnumerator *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IAppxFilesEnumerator *This);
...
public:
  ...
  virtual HRESULT STDMETHODCALLTYPE GetFiles(
      /* [retval][out] */ __RPC__deref_out_opt IAppxBlockMapFilesEnumerator *
      *enumerator) = 0;
...
typedef struct IAppxBlockMapReaderVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IAppxBlockMapReader *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IAppxBlockMapReader *This);
...
public:
  virtual HRESULT STDMETHODCALLTYPE GetBlocks(
      /* [retval][out] */ __RPC__deref_out_opt IAppxBlockMapBlocksEnumerator *
      *blocks) = 0;
...
typedef struct IAppxBlockMapFileVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in IAppxBlockMapFile *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IAppxBlockMapFile *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IAppxBlockMapFile *This);
...
typedef struct IAppxBlockMapFile2Vtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in IAppxBlockMapFile2 *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IAppxBlockMapFile2 *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IAppxBlockMapFile2 *This);
...
#define IAppxBlockMapFile2_AddRef(This) ((This)->lpVtbl->AddRef(This))

#define IAppxBlockMapFile2_Release(This) ((This)->lpVtbl->Release(This))
...
public:
  virtual HRESULT STDMETHODCALLTYPE GetHash(
      ...
      /* [retval][size_is][size_is][out] */ __RPC__deref_out_ecount_full_opt(
          *bufferSize) BYTE *
          *buffer) = 0;
...
typedef struct IAppxBlockMapBlockVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in IAppxBlockMapBlock *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IAppxBlockMapBlock *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IAppxBlockMapBlock *This);

  DECLSPEC_XFGVIRT(IAppxBlockMapBlock, GetHash)
  HRESULT(STDMETHODCALLTYPE *GetHash)(
      __RPC__in IAppxBlockMapBlock *This,
      /* [out] */ __RPC__out UINT32 *bufferSize,
      /* [retval][size_is][size_is][out] */
...
public:
  virtual HRESULT STDMETHODCALLTYPE GetPackageId(
      /* [retval][out] */ __RPC__deref_out_opt IAppxManifestPackageId *
      *packageId) = 0;

  virtual HRESULT STDMETHODCALLTYPE GetProperties(
      /* [retval][out] */ __RPC__deref_out_opt IAppxManifestProperties *
      *packageProperties) = 0;

  virtual HRESULT STDMETHODCALLTYPE GetPackageDependencies(
      /* [retval][out] */
      __RPC__deref_out_opt IAppxManifestPackageDependenciesEnumerator *
      *dependencies) = 0;
  ...
  virtual HRESULT STDMETHODCALLTYPE GetResources(
      /* [retval][out] */
      __RPC__deref_out_opt IAppxManifestResourcesEnumerator * *resources) = 0;
  ...
  virtual HRESULT STDMETHODCALLTYPE GetApplications(
      /* [retval][out] */
      __RPC__deref_out_opt IAppxManifestApplicationsEnumerator *
      *applications) = 0;
...
typedef struct IAppxManifestReaderVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IAppxManifestReader *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IAppxManifestReader *This);
  ...
  HRESULT(STDMETHODCALLTYPE *GetResources)(
      __RPC__in IAppxManifestReader *This,
      /* [retval][out] */ __RPC__deref_out_opt IAppxManifestResourcesEnumerator
          **resources);
...
typedef struct IAppxManifestReader2Vtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IAppxManifestReader2 *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IAppxManifestReader2 *This);
...
public:
  virtual HRESULT STDMETHODCALLTYPE GetCapabilitiesByCapabilityClass(
      ...
      /* [retval][out] */
      __RPC__deref_out_opt IAppxManifestCapabilitiesEnumerator *
          *capabilities) = 0;

  virtual HRESULT STDMETHODCALLTYPE GetTargetDeviceFamilies(
      /* [retval][out] */
      __RPC__deref_out_opt IAppxManifestTargetDeviceFamiliesEnumerator *
      *targetDeviceFamilies) = 0;
};
...
typedef struct IAppxManifestReader3Vtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IAppxManifestReader3 *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IAppxManifestReader3 *This);
...
#define IAppxManifestReader3_GetCapabilitiesByCapabilityClass(                 \
    This, capabilityClass, capabilities)                                       \
  ((This)->lpVtbl->GetCapabilitiesByCapabilityClass(This, capabilityClass,     \
                                                    capabilities))

#define IAppxManifestReader3_GetTargetDeviceFamilies(This,                     \
                                                     targetDeviceFamilies)     \
...
public:
  virtual HRESULT STDMETHODCALLTYPE GetOptionalPackageInfo(
      /* [retval][out] */
      __RPC__deref_out_opt IAppxManifestOptionalPackageInfo *
      *optionalPackageInfo) = 0;
};
...
typedef struct IAppxManifestReader4Vtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IAppxManifestReader4 *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IAppxManifestReader4 *This);
  ...
  HRESULT(STDMETHODCALLTYPE *GetOptionalPackageInfo)(
      __RPC__in IAppxManifestReader4 *This,
      /* [retval][out] */ __RPC__deref_out_opt IAppxManifestOptionalPackageInfo
          **optionalPackageInfo);
...
#define IAppxManifestReader4_GetCapabilitiesByCapabilityClass(                 \
    This, capabilityClass, capabilities)                                       \
  ((This)->lpVtbl->GetCapabilitiesByCapabilityClass(This, capabilityClass,     \
                                                    capabilities))

#define IAppxManifestReader4_GetTargetDeviceFamilies(This,                     \
                                                     targetDeviceFamilies)     \
  ((This)->lpVtbl->GetTargetDeviceFamilies(This, targetDeviceFamilies))
...
typedef struct IAppxManifestReader5Vtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IAppxManifestReader5 *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IAppxManifestReader5 *This);
...
#define IAppxManifestReader5_GetMainPackageDependencies(                       \
...
typedef struct IAppxManifestReader6Vtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IAppxManifestReader6 *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IAppxManifestReader6 *This);
...
#define IAppxManifestReader6_GetIsNonQualifiedResourcePackage(                 \
    This, isNonQualifiedResourcePackage)                                       \
  ((This)->lpVtbl->GetIsNonQualifiedResourcePackage(                           \
      This, isNonQualifiedResourcePackage))
...
public:
  virtual HRESULT STDMETHODCALLTYPE GetDriverDependencies(
      /* [retval][out] */
      __RPC__deref_out_opt IAppxManifestDriverDependenciesEnumerator *
      *driverDependencies) = 0;

  virtual HRESULT STDMETHODCALLTYPE GetOSPackageDependencies(
      /* [retval][out] */
      __RPC__deref_out_opt IAppxManifestOSPackageDependenciesEnumerator *
      *osPackageDependencies) = 0;

  virtual HRESULT STDMETHODCALLTYPE GetHostRuntimeDependencies(
      /* [retval][out] */
      __RPC__deref_out_opt IAppxManifestHostRuntimeDependenciesEnumerator *
      *hostRuntimeDependencies) = 0;
};
...
typedef struct IAppxManifestReader7Vtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IAppxManifestReader7 *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IAppxManifestReader7 *This);
...
#define IAppxManifestReader7_GetOSPackageDependencies(This,                    \
                                                      osPackageDependencies)   \
  ((This)->lpVtbl->GetOSPackageDependencies(This, osPackageDependencies))

#define IAppxManifestReader7_GetHostRuntimeDependencies(                       \
...
public:
  virtual HRESULT STDMETHODCALLTYPE GetCurrent(
      /* [retval][out] */ __RPC__deref_out_opt IAppxManifestDriverDependency *
      *driverDependency) = 0;
...
#define IAppxManifestDriverDependenciesEnumerator_QueryInterface(This, riid,   \
                                                                 ppvObject)    \
  ((This)->lpVtbl->QueryInterface(This, riid, ppvObject))
...
#define IAppxManifestDriverDependenciesEnumerator_GetCurrent(This,             \
                                                             driverDependency) \
  ((This)->lpVtbl->GetCurrent(This, driverDependency))

#define IAppxManifestDriverDependenciesEnumerator_GetHasCurrent(This,          \
                                                                hasCurrent)    \
  ((This)->lpVtbl->GetHasCurrent(This, hasCurrent))
...
public:
  virtual HRESULT STDMETHODCALLTYPE GetDriverConstraints(
      /* [retval][out] */
      __RPC__deref_out_opt IAppxManifestDriverConstraintsEnumerator *
      *driverConstraints) = 0;
};
...
#define IAppxManifestDriverDependency_GetDriverConstraints(This,               \
                                                           driverConstraints)  \
...
public:
  virtual HRESULT STDMETHODCALLTYPE GetCurrent(
      /* [retval][out] */ __RPC__deref_out_opt IAppxManifestDriverConstraint *
      *driverConstraint) = 0;
...
#define IAppxManifestDriverConstraintsEnumerator_QueryInterface(This, riid,    \
                                                                ppvObject)     \
  ((This)->lpVtbl->QueryInterface(This, riid, ppvObject))
...
#define IAppxManifestDriverConstraintsEnumerator_GetCurrent(This,              \
                                                            driverConstraint)  \
  ((This)->lpVtbl->GetCurrent(This, driverConstraint))

#define IAppxManifestDriverConstraintsEnumerator_GetHasCurrent(This,           \
                                                               hasCurrent)     \
  ((This)->lpVtbl->GetHasCurrent(This, hasCurrent))
...
public:
  virtual HRESULT STDMETHODCALLTYPE GetCurrent(
      /* [retval][out] */
      __RPC__deref_out_opt IAppxManifestOSPackageDependency *
      *osPackageDependency) = 0;
...
typedef struct IAppxManifestOSPackageDependenciesEnumeratorVtbl {
  ...
  HRESULT(STDMETHODCALLTYPE *GetCurrent)(
      __RPC__in IAppxManifestOSPackageDependenciesEnumerator *This,
      /* [retval][out] */ __RPC__deref_out_opt IAppxManifestOSPackageDependency
          **osPackageDependency);
...
#define IAppxManifestOSPackageDependenciesEnumerator_QueryInterface(           \
    This, riid, ppvObject)                                                     \
  ((This)->lpVtbl->QueryInterface(This, riid, ppvObject))
...
#define IAppxManifestOSPackageDependenciesEnumerator_GetCurrent(               \
    This, osPackageDependency)                                                 \
  ((This)->lpVtbl->GetCurrent(This, osPackageDependency))

#define IAppxManifestOSPackageDependenciesEnumerator_GetHasCurrent(This,       \
                                                                   hasCurrent) \
  ((This)->lpVtbl->GetHasCurrent(This, hasCurrent))
...
public:
  virtual HRESULT STDMETHODCALLTYPE GetCurrent(
      /* [retval][out] */
      __RPC__deref_out_opt IAppxManifestHostRuntimeDependency *
      *hostRuntimeDependency) = 0;
...
typedef struct IAppxManifestHostRuntimeDependenciesEnumeratorVtbl {
  ...
  DECLSPEC_XFGVIRT(IAppxManifestHostRuntimeDependenciesEnumerator,
                   GetHasCurrent)
  HRESULT(STDMETHODCALLTYPE *GetHasCurrent)(
      __RPC__in IAppxManifestHostRuntimeDependenciesEnumerator *This,
      /* [retval][out] */ __RPC__out BOOL *hasCurrent);
...
#define IAppxManifestHostRuntimeDependenciesEnumerator_QueryInterface(         \
    This, riid, ppvObject)                                                     \
  ((This)->lpVtbl->QueryInterface(This, riid, ppvObject))
...
#define IAppxManifestHostRuntimeDependenciesEnumerator_GetCurrent(             \
    This, hostRuntimeDependency)                                               \
  ((This)->lpVtbl->GetCurrent(This, hostRuntimeDependency))

#define IAppxManifestHostRuntimeDependenciesEnumerator_GetHasCurrent(          \
    This, hasCurrent)                                                          \
  ((This)->lpVtbl->GetHasCurrent(This, hasCurrent))
...
#define IAppxManifestHostRuntimeDependency_QueryInterface(This, riid,          \
                                                          ppvObject)           \
  ((This)->lpVtbl->QueryInterface(This, riid, ppvObject))
...
#define IAppxManifestHostRuntimeDependency2_QueryInterface(This, riid,         \
                                                           ppvObject)          \
  ((This)->lpVtbl->QueryInterface(This, riid, ppvObject))
...
#define IAppxManifestHostRuntimeDependency2_GetPackageFamilyName(              \
...
#define IAppxManifestOptionalPackageInfo_GetIsOptionalPackage(                 \
    This, isOptionalPackage)                                                   \
  ((This)->lpVtbl->GetIsOptionalPackage(This, isOptionalPackage))

#define IAppxManifestOptionalPackageInfo_GetMainPackageName(This,              \
                                                            mainPackageName)   \
...
public:
  virtual HRESULT STDMETHODCALLTYPE GetCurrent(
      /* [retval][out] */
      __RPC__deref_out_opt IAppxManifestMainPackageDependency *
      *mainPackageDependency) = 0;
...
typedef struct IAppxManifestMainPackageDependenciesEnumeratorVtbl {
  ...
  DECLSPEC_XFGVIRT(IAppxManifestMainPackageDependenciesEnumerator,
                   GetHasCurrent)
  HRESULT(STDMETHODCALLTYPE *GetHasCurrent)(
      __RPC__in IAppxManifestMainPackageDependenciesEnumerator *This,
      /* [retval][out] */ __RPC__out BOOL *hasCurrent);
...
#define IAppxManifestMainPackageDependenciesEnumerator_QueryInterface(         \
    This, riid, ppvObject)                                                     \
  ((This)->lpVtbl->QueryInterface(This, riid, ppvObject))
...
#define IAppxManifestMainPackageDependenciesEnumerator_GetCurrent(             \
    This, mainPackageDependency)                                               \
  ((This)->lpVtbl->GetCurrent(This, mainPackageDependency))

#define IAppxManifestMainPackageDependenciesEnumerator_GetHasCurrent(          \
    This, hasCurrent)                                                          \
  ((This)->lpVtbl->GetHasCurrent(This, hasCurrent))
...
#define IAppxManifestMainPackageDependency_QueryInterface(This, riid,          \
                                                          ppvObject)           \
  ((This)->lpVtbl->QueryInterface(This, riid, ppvObject))
...
#define IAppxManifestMainPackageDependency_GetPackageFamilyName(               \
    This, packageFamilyName)                                                   \
  ((This)->lpVtbl->GetPackageFamilyName(This, packageFamilyName))
...
public:
  ...
  virtual HRESULT STDMETHODCALLTYPE GetArchitecture(
      /* [retval][out] */ __RPC__out APPX_PACKAGE_ARCHITECTURE *
      architecture) = 0;
...
typedef struct IAppxManifestPackageIdVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IAppxManifestPackageId *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IAppxManifestPackageId *This);
...
public:
  virtual HRESULT STDMETHODCALLTYPE GetArchitecture2(
      /* [retval][out] */ __RPC__out APPX_PACKAGE_ARCHITECTURE2 *
      architecture) = 0;
};
...
typedef struct IAppxManifestPackageId2Vtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IAppxManifestPackageId2 *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IAppxManifestPackageId2 *This);
...
typedef struct IAppxManifestPropertiesVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IAppxManifestProperties *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IAppxManifestProperties *This);
...
public:
  virtual HRESULT STDMETHODCALLTYPE GetCurrent(
      /* [retval][out] */ __RPC__deref_out_opt IAppxManifestTargetDeviceFamily *
      *targetDeviceFamily) = 0;
...
#define IAppxManifestTargetDeviceFamiliesEnumerator_QueryInterface(This, riid, \
                                                                   ppvObject)  \
  ((This)->lpVtbl->QueryInterface(This, riid, ppvObject))
...
#define IAppxManifestTargetDeviceFamiliesEnumerator_GetCurrent(                \
    This, targetDeviceFamily)                                                  \
  ((This)->lpVtbl->GetCurrent(This, targetDeviceFamily))

#define IAppxManifestTargetDeviceFamiliesEnumerator_GetHasCurrent(This,        \
                                                                  hasCurrent)  \
  ((This)->lpVtbl->GetHasCurrent(This, hasCurrent))
...
#define IAppxManifestTargetDeviceFamily_GetMaxVersionTested(This,              \
                                                            maxVersionTested)  \
...
public:
  virtual HRESULT STDMETHODCALLTYPE GetCurrent(
      /* [retval][out] */ __RPC__deref_out_opt IAppxManifestPackageDependency *
      *dependency) = 0;
...
#define IAppxManifestPackageDependenciesEnumerator_QueryInterface(This, riid,  \
                                                                  ppvObject)   \
  ((This)->lpVtbl->QueryInterface(This, riid, ppvObject))
...
#define IAppxManifestPackageDependenciesEnumerator_GetCurrent(This,            \
                                                              dependency)      \
  ((This)->lpVtbl->GetCurrent(This, dependency))

#define IAppxManifestPackageDependenciesEnumerator_GetHasCurrent(This,         \
                                                                 hasCurrent)   \
  ((This)->lpVtbl->GetHasCurrent(This, hasCurrent))
...
#define IAppxManifestPackageDependency2_GetMaxMajorVersionTested(              \
    This, maxMajorVersionTested)                                               \
...
#define IAppxManifestDeviceCapabilitiesEnumerator_QueryInterface(This, riid,   \
                                                                 ppvObject)    \
  ((This)->lpVtbl->QueryInterface(This, riid, ppvObject))
...
#define IAppxManifestDeviceCapabilitiesEnumerator_GetCurrent(This,             \
                                                             deviceCapability) \
  ((This)->lpVtbl->GetCurrent(This, deviceCapability))

#define IAppxManifestDeviceCapabilitiesEnumerator_GetHasCurrent(This,          \
                                                                hasCurrent)    \
  ((This)->lpVtbl->GetHasCurrent(This, hasCurrent))
...
#define IAppxManifestCapabilitiesEnumerator_QueryInterface(This, riid,         \
                                                           ppvObject)          \
  ((This)->lpVtbl->QueryInterface(This, riid, ppvObject))
...
public:
  virtual HRESULT STDMETHODCALLTYPE GetCurrent(
      /* [retval][out] */ __RPC__deref_out_opt IAppxManifestApplication *
      *application) = 0;
...
#define IAppxManifestApplicationsEnumerator_QueryInterface(This, riid,         \
                                                           ppvObject)          \
  ((This)->lpVtbl->QueryInterface(This, riid, ppvObject))
...
typedef struct IAppxManifestApplicationVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IAppxManifestApplication *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IAppxManifestApplication *This);
...
public:
  virtual HRESULT STDMETHODCALLTYPE GetCurrent(
      /* [retval][out] */ __RPC__deref_out_opt IAppxManifestQualifiedResource *
      *resource) = 0;
...
#define IAppxManifestQualifiedResourcesEnumerator_QueryInterface(This, riid,   \
                                                                 ppvObject)    \
  ((This)->lpVtbl->QueryInterface(This, riid, ppvObject))
...
#define IAppxManifestQualifiedResourcesEnumerator_GetHasCurrent(This,          \
                                                                hasCurrent)    \
  ((This)->lpVtbl->GetHasCurrent(This, hasCurrent))
...
public:
  virtual HRESULT STDMETHODCALLTYPE CreateBundleWriter(
      ...
      /* [retval][out] */ __RPC__deref_out_opt IAppxBundleWriter *
          *bundleWriter) = 0;

  virtual HRESULT STDMETHODCALLTYPE CreateBundleReader(
      /* [in] */ __RPC__in_opt IStream * inputStream,
      /* [retval][out] */ __RPC__deref_out_opt IAppxBundleReader *
          *bundleReader) = 0;

  virtual HRESULT STDMETHODCALLTYPE CreateBundleManifestReader(
      /* [in] */ __RPC__in_opt IStream * inputStream,
      /* [retval][out] */ __RPC__deref_out_opt IAppxBundleManifestReader *
          *manifestReader) = 0;
};
...
typedef struct IAppxBundleFactoryVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in IAppxBundleFactory *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IAppxBundleFactory *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IAppxBundleFactory *This);
...
#define IAppxBundleFactory_CreateBundleWriter(This, outputStream,              \
                                              bundleVersion, bundleWriter)     \
  ((This)->lpVtbl->CreateBundleWriter(This, outputStream, bundleVersion,       \
                                      bundleWriter))
...
#define IAppxBundleFactory_CreateBundleManifestReader(This, inputStream,       \
                                                      manifestReader)          \
  ((This)->lpVtbl->CreateBundleManifestReader(This, inputStream,               \
                                              manifestReader))
...
typedef struct IAppxBundleFactory2Vtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IAppxBundleFactory2 *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IAppxBundleFactory2 *This);
...
#define IAppxBundleFactory2_AddRef(This) ((This)->lpVtbl->AddRef(This))

#define IAppxBundleFactory2_Release(This) ((This)->lpVtbl->Release(This))

#define IAppxBundleFactory2_CreateBundleReader2(This, inputStream,             \
                                                expectedDigest, bundleReader)  \
  ((This)->lpVtbl->CreateBundleReader2(This, inputStream, expectedDigest,      \
                                       bundleReader))
...
typedef struct IAppxBundleFactory3Vtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IAppxBundleFactory3 *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IAppxBundleFactory3 *This);
...
#define IAppxBundleFactory3_AddRef(This) ((This)->lpVtbl->AddRef(This))

#define IAppxBundleFactory3_Release(This) ((This)->lpVtbl->Release(This))

#define IAppxBundleFactory3_CreateBundleReaderFromSourceUri(                   \
    This, uri, expectedDigest, bundleReader)                                   \
  ((This)->lpVtbl->CreateBundleReaderFromSourceUri(This, uri, expectedDigest,  \
                                                   bundleReader))
...
typedef struct IAppxBundleWriterVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in IAppxBundleWriter *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IAppxBundleWriter *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IAppxBundleWriter *This);
  ...
  HRESULT(STDMETHODCALLTYPE *Close)(__RPC__in IAppxBundleWriter *This);
...
typedef struct IAppxBundleWriter2Vtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in IAppxBundleWriter2 *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IAppxBundleWriter2 *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IAppxBundleWriter2 *This);
...
#define IAppxBundleWriter2_AddExternalPackageReference(This, fileName,         \
                                                       inputStream)            \
...
typedef struct IAppxBundleWriter3Vtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in IAppxBundleWriter3 *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IAppxBundleWriter3 *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IAppxBundleWriter3 *This);
  ...
  HRESULT(STDMETHODCALLTYPE *Close)(__RPC__in IAppxBundleWriter3 *This,
                                    /* [string][in] */ __RPC__in_string LPCWSTR
                                        hashMethodString);
...
typedef struct IAppxBundleWriter4Vtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in IAppxBundleWriter4 *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IAppxBundleWriter4 *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IAppxBundleWriter4 *This);
...
#define IAppxBundleWriter4_AddPayloadPackage(This, fileName, packageStream,    \
                                             isDefaultApplicablePackage)       \
  ((This)->lpVtbl->AddPayloadPackage(This, fileName, packageStream,            \
                                     isDefaultApplicablePackage))

#define IAppxBundleWriter4_AddPackageReference(This, fileName, inputStream,    \
                                               isDefaultApplicablePackage)     \
  ((This)->lpVtbl->AddPackageReference(This, fileName, inputStream,            \
                                       isDefaultApplicablePackage))

#define IAppxBundleWriter4_AddExternalPackageReference(                        \
...
typedef struct IAppxBundleReaderVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in IAppxBundleReader *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IAppxBundleReader *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IAppxBundleReader *This);
...
typedef struct IAppxBundleReader2Vtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in IAppxBundleReader2 *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IAppxBundleReader2 *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IAppxBundleReader2 *This);
  ...
  HRESULT(STDMETHODCALLTYPE *GetPayloadPackageReader)(
      ...
      /* [string][in] */ __RPC__in_string LPCWSTR fileName,
      /* [retval][out] */
      __RPC__deref_out_opt IAppxPackageReader **payloadPackageReader);
...
#define IAppxBundleReader2_AddRef(This) ((This)->lpVtbl->AddRef(This))

#define IAppxBundleReader2_Release(This) ((This)->lpVtbl->Release(This))

#define IAppxBundleReader2_GetPayloadPackageReader(This, fileName,             \
                                                   payloadPackageReader)       \
  ((This)->lpVtbl->GetPayloadPackageReader(This, fileName,                     \
                                           payloadPackageReader))
...
typedef struct IAppxBundleManifestReaderVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IAppxBundleManifestReader *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IAppxBundleManifestReader *This);
...
public:
  virtual HRESULT STDMETHODCALLTYPE GetOptionalBundles(
      /* [retval][out] */
      __RPC__deref_out_opt IAppxBundleManifestOptionalBundleInfoEnumerator *
      *optionalBundles) = 0;
};
...
typedef struct IAppxBundleManifestReader2Vtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IAppxBundleManifestReader2 *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IAppxBundleManifestReader2 *This);
...
public:
  virtual HRESULT STDMETHODCALLTYPE GetCurrent(
      /* [retval][out] */ __RPC__deref_out_opt IAppxBundleManifestPackageInfo *
      *packageInfo) = 0;
...
#define IAppxBundleManifestPackageInfoEnumerator_QueryInterface(This, riid,    \
                                                                ppvObject)     \
  ((This)->lpVtbl->QueryInterface(This, riid, ppvObject))
...
#define IAppxBundleManifestPackageInfoEnumerator_GetHasCurrent(This,           \
                                                               hasCurrent)     \
  ((This)->lpVtbl->GetHasCurrent(This, hasCurrent))
...
public:
  virtual HRESULT STDMETHODCALLTYPE GetPackageType(
      /* [retval][out] */ __RPC__out APPX_BUNDLE_PAYLOAD_PACKAGE_TYPE *
      packageType) = 0;
...
#define IAppxBundleManifestPackageInfo2_GetIsPackageReference(                 \
    This, isPackageReference)                                                  \
  ((This)->lpVtbl->GetIsPackageReference(This, isPackageReference))

#define IAppxBundleManifestPackageInfo2_GetIsNonQualifiedResourcePackage(      \
    This, isNonQualifiedResourcePackage)                                       \
  ((This)->lpVtbl->GetIsNonQualifiedResourcePackage(                           \
      This, isNonQualifiedResourcePackage))

#define IAppxBundleManifestPackageInfo2_GetIsDefaultApplicablePackage(         \
    This, isDefaultApplicablePackage)                                          \
  ((This)->lpVtbl->GetIsDefaultApplicablePackage(This,                         \
                                                 isDefaultApplicablePackage))
...
#define IAppxBundleManifestPackageInfo3_GetTargetDeviceFamilies(               \
...
typedef struct IAppxBundleManifestOptionalBundleInfoEnumeratorVtbl {
  ...
  DECLSPEC_XFGVIRT(IAppxBundleManifestOptionalBundleInfoEnumerator,
                   GetHasCurrent)
  HRESULT(STDMETHODCALLTYPE *GetHasCurrent)(
      __RPC__in IAppxBundleManifestOptionalBundleInfoEnumerator *This,
      /* [retval][out] */ __RPC__out BOOL *hasCurrent);
...
#define IAppxBundleManifestOptionalBundleInfoEnumerator_QueryInterface(        \
    This, riid, ppvObject)                                                     \
  ((This)->lpVtbl->QueryInterface(This, riid, ppvObject))
...
#define IAppxBundleManifestOptionalBundleInfoEnumerator_GetCurrent(            \
    This, optionalBundle)                                                      \
  ((This)->lpVtbl->GetCurrent(This, optionalBundle))

#define IAppxBundleManifestOptionalBundleInfoEnumerator_GetHasCurrent(         \
    This, hasCurrent)                                                          \
  ((This)->lpVtbl->GetHasCurrent(This, hasCurrent))

#define IAppxBundleManifestOptionalBundleInfoEnumerator_MoveNext(This,         \
                                                                 hasNext)      \
  ((This)->lpVtbl->MoveNext(This, hasNext))
...
#define IAppxBundleManifestOptionalBundleInfo_QueryInterface(This, riid,       \
                                                             ppvObject)        \
  ((This)->lpVtbl->QueryInterface(This, riid, ppvObject))
...
#define IAppxBundleManifestOptionalBundleInfo_GetPackageInfoItems(             \
...
public:
  ...
  virtual HRESULT STDMETHODCALLTYPE GetFiles(
      /* [retval][out] */
      __RPC__deref_out_opt IAppxContentGroupFilesEnumerator * *enumerator) = 0;
};
...
typedef struct IAppxContentGroupVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in IAppxContentGroup *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IAppxContentGroup *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IAppxContentGroup *This);
  ...
  HRESULT(STDMETHODCALLTYPE *GetFiles)(
      __RPC__in IAppxContentGroup *This,
      /* [retval][out] */ __RPC__deref_out_opt IAppxContentGroupFilesEnumerator
          **enumerator);
...
public:
  virtual HRESULT STDMETHODCALLTYPE GetRequiredGroup(
      /* [retval][out] */ __RPC__deref_out_opt IAppxContentGroup *
      *requiredGroup) = 0;

  virtual HRESULT STDMETHODCALLTYPE GetAutomaticGroups(
      /* [retval][out] */ __RPC__deref_out_opt IAppxContentGroupsEnumerator *
      *automaticGroupsEnumerator) = 0;
};
...
typedef struct IAppxContentGroupMapReaderVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IAppxContentGroupMapReader *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IAppxContentGroupMapReader *This);
...
#define IAppxContentGroupMapReader_GetAutomaticGroups(                         \
...
#define IAppxSourceContentGroupMapReader_GetAutomaticGroups(                   \
    This, automaticGroupsEnumerator)                                           \
  ((This)->lpVtbl->GetAutomaticGroups(This, automaticGroupsEnumerator))
...
typedef struct IAppxContentGroupMapWriterVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IAppxContentGroupMapWriter *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IAppxContentGroupMapWriter *This);
  ...
  HRESULT(STDMETHODCALLTYPE *Close)(__RPC__in IAppxContentGroupMapWriter *This);
...
#define IAppxPackagingDiagnosticEventSink_QueryInterface(This, riid,           \
                                                         ppvObject)            \
  ((This)->lpVtbl->QueryInterface(This, riid, ppvObject))
...
#define IAppxPackagingDiagnosticEventSink_ReportContextChange(                 \
    This, changeType, contextId, contextName, contextMessage, detailsMessage)  \
  ((This)->lpVtbl->ReportContextChange(This, changeType, contextId,            \
                                       contextName, contextMessage,            \
                                       detailsMessage))
...
#define IAppxPackagingDiagnosticEventSinkManager_QueryInterface(This, riid,    \
                                                                ppvObject)     \
  ((This)->lpVtbl->QueryInterface(This, riid, ppvObject))
...
typedef struct IAppxAppInstallerReaderVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IAppxAppInstallerReader *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IAppxAppInstallerReader *This);
...
#define IAppxAppInstallerReader_AddRef(This) ((This)->lpVtbl->AddRef(This))

#define IAppxAppInstallerReader_Release(This) ((This)->lpVtbl->Release(This))
...
typedef struct IAppxDigestProviderVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IAppxDigestProvider *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IAppxDigestProvider *This);
...
#define IAppxDigestProvider_AddRef(This) ((This)->lpVtbl->AddRef(This))

#define IAppxDigestProvider_Release(This) ((This)->lpVtbl->Release(This))
...
public:
  ...
  virtual HRESULT STDMETHODCALLTYPE CreateEncryptedPackageWriter(
      ...
      /* [retval][out] */
      __RPC__deref_out_opt IAppxEncryptedPackageWriter **packageWriter) = 0;

  virtual HRESULT STDMETHODCALLTYPE CreateEncryptedPackageReader(
      /* [in] */ __RPC__in_opt IStream * inputStream,
      /* [in] */ __RPC__in const APPX_KEY_INFO *keyInfo,
      /* [retval][out] */
      __RPC__deref_out_opt IAppxPackageReader **packageReader) = 0;
  ...
  virtual HRESULT STDMETHODCALLTYPE CreateEncryptedBundleWriter(
      ...
      /* [in] */ __RPC__in const APPX_ENCRYPTED_EXEMPTIONS *exemptedFiles,
      /* [retval][out] */
      __RPC__deref_out_opt IAppxEncryptedBundleWriter **bundleWriter) = 0;

  virtual HRESULT STDMETHODCALLTYPE CreateEncryptedBundleReader(
      /* [in] */ __RPC__in_opt IStream * inputStream,
      /* [in] */ __RPC__in const APPX_KEY_INFO *keyInfo,
      /* [retval][out] */
      __RPC__deref_out_opt IAppxBundleReader **bundleReader) = 0;
};
...
typedef struct IAppxEncryptionFactoryVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IAppxEncryptionFactory *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IAppxEncryptionFactory *This);
...
#define IAppxEncryptionFactory_EncryptPackage(                                 \
    This, inputStream, outputStream, settings, keyInfo, exemptedFiles)         \
  ((This)->lpVtbl->EncryptPackage(This, inputStream, outputStream, settings,   \
                                  keyInfo, exemptedFiles))

#define IAppxEncryptionFactory_DecryptPackage(This, inputStream, outputStream, \
                                              keyInfo)                         \
  ((This)->lpVtbl->DecryptPackage(This, inputStream, outputStream, keyInfo))

#define IAppxEncryptionFactory_CreateEncryptedPackageWriter(                   \
    This, outputStream, manifestStream, settings, keyInfo, exemptedFiles,      \
    packageWriter)                                                             \
  ((This)->lpVtbl->CreateEncryptedPackageWriter(                               \
      This, outputStream, manifestStream, settings, keyInfo, exemptedFiles,    \
      packageWriter))

#define IAppxEncryptionFactory_CreateEncryptedPackageReader(                   \
    This, inputStream, keyInfo, packageReader)                                 \
  ((This)->lpVtbl->CreateEncryptedPackageReader(This, inputStream, keyInfo,    \
                                                packageReader))

#define IAppxEncryptionFactory_EncryptBundle(This, inputStream, outputStream,  \
                                             settings, keyInfo, exemptedFiles) \
  ((This)->lpVtbl->EncryptBundle(This, inputStream, outputStream, settings,    \
                                 keyInfo, exemptedFiles))

#define IAppxEncryptionFactory_DecryptBundle(This, inputStream, outputStream,  \
                                             keyInfo)                          \
  ((This)->lpVtbl->DecryptBundle(This, inputStream, outputStream, keyInfo))

#define IAppxEncryptionFactory_CreateEncryptedBundleWriter(                    \
    This, outputStream, bundleVersion, settings, keyInfo, exemptedFiles,       \
    bundleWriter)                                                              \
  ((This)->lpVtbl->CreateEncryptedBundleWriter(                                \
      This, outputStream, bundleVersion, settings, keyInfo, exemptedFiles,     \
      bundleWriter))

#define IAppxEncryptionFactory_CreateEncryptedBundleReader(                    \
    This, inputStream, keyInfo, bundleReader)                                  \
  ((This)->lpVtbl->CreateEncryptedBundleReader(This, inputStream, keyInfo,     \
                                               bundleReader))
...
typedef struct IAppxEncryptionFactory2Vtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IAppxEncryptionFactory2 *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IAppxEncryptionFactory2 *This);
...
#define IAppxEncryptionFactory2_CreateEncryptedPackageWriter(                  \
    This, outputStream, manifestStream, contentGroupMapStream, settings,       \
    keyInfo, exemptedFiles, packageWriter)                                     \
  ((This)->lpVtbl->CreateEncryptedPackageWriter(                               \
      This, outputStream, manifestStream, contentGroupMapStream, settings,     \
      keyInfo, exemptedFiles, packageWriter))
...
typedef struct IAppxEncryptionFactory3Vtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IAppxEncryptionFactory3 *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IAppxEncryptionFactory3 *This);
...
#define IAppxEncryptionFactory3_EncryptPackage(                                \
    This, inputStream, outputStream, settings, keyInfo, exemptedFiles)         \
  ((This)->lpVtbl->EncryptPackage(This, inputStream, outputStream, settings,   \
                                  keyInfo, exemptedFiles))

#define IAppxEncryptionFactory3_CreateEncryptedPackageWriter(                  \
    This, outputStream, manifestStream, contentGroupMapStream, settings,       \
    keyInfo, exemptedFiles, packageWriter)                                     \
  ((This)->lpVtbl->CreateEncryptedPackageWriter(                               \
      This, outputStream, manifestStream, contentGroupMapStream, settings,     \
...
#define IAppxEncryptionFactory3_EncryptBundle(                                 \
    This, inputStream, outputStream, settings, keyInfo, exemptedFiles)         \
  ((This)->lpVtbl->EncryptBundle(This, inputStream, outputStream, settings,    \
                                 keyInfo, exemptedFiles))

#define IAppxEncryptionFactory3_CreateEncryptedBundleWriter(                   \
    This, outputStream, bundleVersion, settings, keyInfo, exemptedFiles,       \
    bundleWriter)                                                              \
  ((This)->lpVtbl->CreateEncryptedBundleWriter(                                \
      This, outputStream, bundleVersion, settings, keyInfo, exemptedFiles,     \
...
typedef struct IAppxEncryptionFactory4Vtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IAppxEncryptionFactory4 *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IAppxEncryptionFactory4 *This);
...
#define IAppxEncryptionFactory4_EncryptPackage(                                \
    This, inputStream, outputStream, settings, keyInfo, exemptedFiles,         \
    memoryLimit)                                                               \
  ((This)->lpVtbl->EncryptPackage(This, inputStream, outputStream, settings,   \
                                  keyInfo, exemptedFiles, memoryLimit))
...
typedef struct IAppxEncryptionFactory5Vtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IAppxEncryptionFactory5 *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IAppxEncryptionFactory5 *This);
...
#define IAppxEncryptionFactory5_AddRef(This) ((This)->lpVtbl->AddRef(This))

#define IAppxEncryptionFactory5_Release(This) ((This)->lpVtbl->Release(This))

#define IAppxEncryptionFactory5_CreateEncryptedPackageReader2(                 \
    This, inputStream, keyInfo, expectedDigest, packageReader)                 \
  ((This)->lpVtbl->CreateEncryptedPackageReader2(                              \
      This, inputStream, keyInfo, expectedDigest, packageReader))

#define IAppxEncryptionFactory5_CreateEncryptedBundleReader2(                  \
    This, inputStream, keyInfo, expectedDigest, bundleReader)                  \
  ((This)->lpVtbl->CreateEncryptedBundleReader2(This, inputStream, keyInfo,    \
                                                expectedDigest, bundleReader))
...
typedef struct IAppxEncryptedPackageWriterVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IAppxEncryptedPackageWriter *This);
...
#define IAppxEncryptedPackageWriter_AddPayloadFileEncrypted(                   \
    This, fileName, compressionOption, inputStream)                            \
  ((This)->lpVtbl->AddPayloadFileEncrypted(This, fileName, compressionOption,  \
                                           inputStream))
...
#define IAppxEncryptedPackageWriter2_AddPayloadFilesEncrypted(                 \
    This, fileCount, payloadFiles, memoryLimit)                                \
  ((This)->lpVtbl->AddPayloadFilesEncrypted(This, fileCount, payloadFiles,     \
                                            memoryLimit))
...
typedef struct IAppxEncryptedBundleWriterVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IAppxEncryptedBundleWriter *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IAppxEncryptedBundleWriter *This);
  ...
  HRESULT(STDMETHODCALLTYPE *Close)(__RPC__in IAppxEncryptedBundleWriter *This);
...
#define IAppxEncryptedBundleWriter_AddPayloadPackageEncrypted(This, fileName,  \
                                                              packageStream)   \
...
typedef struct IAppxEncryptedBundleWriter2Vtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IAppxEncryptedBundleWriter2 *This);
...
#define IAppxEncryptedBundleWriter2_AddExternalPackageReference(               \
...
typedef struct IAppxEncryptedBundleWriter3Vtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IAppxEncryptedBundleWriter3 *This);
...
#define IAppxEncryptedBundleWriter3_AddPayloadPackageEncrypted(                \
    This, fileName, packageStream, isDefaultApplicablePackage)                 \
  ((This)->lpVtbl->AddPayloadPackageEncrypted(This, fileName, packageStream,   \
                                              isDefaultApplicablePackage))

#define IAppxEncryptedBundleWriter3_AddExternalPackageReference(               \
    This, fileName, inputStream, isDefaultApplicablePackage)                   \
  ((This)->lpVtbl->AddExternalPackageReference(This, fileName, inputStream,    \
                                               isDefaultApplicablePackage))
...
typedef struct IAppxPackageEditorVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in IAppxPackageEditor *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IAppxPackageEditor *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IAppxPackageEditor *This);
...
#define IAppxPackageEditor_CreateDeltaPackage(                                 \
    This, updatedPackageStream, baselinePackageStream, deltaPackageStream)     \
  ((This)->lpVtbl->CreateDeltaPackage(                                         \
      This, updatedPackageStream, baselinePackageStream, deltaPackageStream))
...
#define IAppxPackageEditor_UpdatePackage(This, baselinePackageStream,          \
                                         deltaPackageStream, updateOption)     \
  ((This)->lpVtbl->UpdatePackage(This, baselinePackageStream,                  \
                                 deltaPackageStream, updateOption))

#define IAppxPackageEditor_UpdateEncryptedPackage(                             \
    This, baselineEncryptedPackageStream, deltaPackageStream, updateOption,    \
    settings, keyInfo)                                                         \
  ((This)->lpVtbl->UpdateEncryptedPackage(                                     \
      This, baselineEncryptedPackageStream, deltaPackageStream, updateOption,  \
      settings, keyInfo))

#define IAppxPackageEditor_UpdatePackageManifest(                              \
    This, packageStream, updatedManifestStream, isPackageEncrypted, options)   \
  ((This)->lpVtbl->UpdatePackageManifest(This, packageStream,                  \
                                         updatedManifestStream,                \
                                         isPackageEncrypted, options))
