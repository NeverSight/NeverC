...
public:
  virtual HRESULT STDMETHODCALLTYPE Init(__RPC__in REFCLSID clsidDMO,
...
typedef struct IDMOWrapperFilterVtbl {
  ...
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in IDMOWrapperFilter *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IDMOWrapperFilter *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IDMOWrapperFilter *This);

  DECLSPEC_XFGVIRT(IDMOWrapperFilter, Init)
  HRESULT(STDMETHODCALLTYPE *Init)(__RPC__in IDMOWrapperFilter *This,
