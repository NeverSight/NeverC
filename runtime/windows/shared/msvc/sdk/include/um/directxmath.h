...
#if defined(_MSC_VER) && defined(_GAMING_XBOX) && defined(_M_X64) &&           \
    !defined(_XM_F16C_INTRINSICS_) && !defined(_XM_NO_INTRINSICS_)
...
inline XMVECTOR XM_CALLCONV XMVectorPermute(FXMVECTOR V1,
  ...
  return Internal::PermuteHelper<Shuffle, WhichX, WhichY, WhichZ,
