...
typedef struct IBidiRequestVtbl {
  ...
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in IBidiRequest *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IBidiRequest *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IBidiRequest *This);

  DECLSPEC_XFGVIRT(IBidiRequest, SetSchema)
  HRESULT(STDMETHODCALLTYPE *SetSchema)(__RPC__in IBidiRequest *This,
                                        /* [in] */ __RPC__in const LPCWSTR
                                            pszSchema);
  ...
  HRESULT(STDMETHODCALLTYPE *GetResult)(__RPC__in IBidiRequest *This,
...
interface IBidiRequest { CONST_VTBL struct IBidiRequestVtbl *lpVtbl; };
...
typedef struct IBidiRequestContainerVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IBidiRequestContainer *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IBidiRequestContainer *This);
...
typedef struct IBidiSplVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in IBidiSpl *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IBidiSpl *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IBidiSpl *This);
  ...
  HRESULT(STDMETHODCALLTYPE *UnbindDevice)(__RPC__in IBidiSpl *This);
...
interface IBidiSpl { CONST_VTBL struct IBidiSplVtbl *lpVtbl; };
...
typedef struct IBidiSpl2Vtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in IBidiSpl2 *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IBidiSpl2 *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IBidiSpl2 *This);
  ...
  HRESULT(STDMETHODCALLTYPE *UnbindDevice)(__RPC__in IBidiSpl2 *This);
...
interface IBidiSpl2 { CONST_VTBL struct IBidiSpl2Vtbl *lpVtbl; };
...
class DECLSPEC_UUID("B9162A23-45F9-47cc-80F5-FE0FE9B9E1A2") BidiRequest;
#endif
...
class DECLSPEC_UUID("2A614240-A4C5-4c33-BD87-1BC709331639") BidiSpl;
#endif
