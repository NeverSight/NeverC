...
typedef interface ITPluggableTerminalSuperclassInfo
...
typedef interface IEnumPluggableTerminalClassInfo
...
public:
  ...
  virtual /* [helpstring][hidden][id] */ HRESULT STDMETHODCALLTYPE
      EnumerateAddresses(
          /* [retval][out] */ __RPC__deref_out_opt IEnumAddress *
          *ppEnumAddress) = 0;
  ...
  virtual /* [helpstring][hidden][id] */ HRESULT STDMETHODCALLTYPE
      EnumerateCallHubs(
          /* [retval][out] */ __RPC__deref_out_opt IEnumCallHub *
          *ppEnumCallHub) = 0;
  ...
  virtual /* [hidden][id] */ HRESULT STDMETHODCALLTYPE
...
typedef struct ITTAPIVtbl {
  ...
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in ITTAPI *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in ITTAPI *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in ITTAPI *This);
  ...
  /* [helpstring][id][propget] */ HRESULT(
      STDMETHODCALLTYPE *get_PrivateTAPIObjects)(
      __RPC__in ITTAPI *This,
      /* [retval][out] */ __RPC__out VARIANT *pVariant);
  ...
  /* [helpstring][id] */ HRESULT(
      STDMETHODCALLTYPE *SetAssistedTelephonyPriority)(
      __RPC__in ITTAPI *This,
      /* [in] */ __RPC__in BSTR pAppFilename,
...
interface ITTAPI { CONST_VTBL struct ITTAPIVtbl *lpVtbl; };
...
public:
  ...
  virtual /* [helpstring][hidden][id] */ HRESULT STDMETHODCALLTYPE
      EnumeratePhones(
          /* [retval][out] */ __RPC__deref_out_opt IEnumPhone *
          *ppEnumPhone) = 0;

  virtual /* [helpstring][id] */ HRESULT STDMETHODCALLTYPE
      CreateEmptyCollectionObject(
          /* [retval][out] */ __RPC__deref_out_opt ITCollection2 *
          *ppCollection) = 0;
};
...
typedef struct ITTAPI2Vtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in ITTAPI2 *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in ITTAPI2 *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in ITTAPI2 *This);
  ...
  /* [helpstring][id] */ HRESULT(
      STDMETHODCALLTYPE *CreateEmptyCollectionObject)(
      __RPC__in ITTAPI2 *This,
...
interface ITTAPI2 { CONST_VTBL struct ITTAPI2Vtbl *lpVtbl; };
...
typedef struct ITMediaSupportVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in ITMediaSupport *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in ITMediaSupport *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in ITMediaSupport *This);
...
interface ITMediaSupport { CONST_VTBL struct ITMediaSupportVtbl *lpVtbl; };
...
public:
  ...
  virtual /* [helpstring][hidden][id] */ HRESULT STDMETHODCALLTYPE
      EnumerateStaticTerminals(
          /* [retval][out] */ __RPC__deref_out_opt IEnumTerminal *
          *ppTerminalEnumerator) = 0;
  ...
  virtual /* [helpstring][hidden][id] */ HRESULT STDMETHODCALLTYPE
      EnumerateDynamicTerminalClasses(
          /* [retval][out] */ __RPC__deref_out_opt IEnumTerminalClass *
          *ppTerminalClassEnumerator) = 0;
...
typedef struct ITTerminalSupportVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in ITTerminalSupport *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in ITTerminalSupport *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in ITTerminalSupport *This);
  ...
  /* [helpstring][id][propget] */ HRESULT(
      STDMETHODCALLTYPE *get_StaticTerminals)(
      __RPC__in ITTerminalSupport *This,
      /* [retval][out] */ __RPC__out VARIANT *pVariant);

  DECLSPEC_XFGVIRT(ITTerminalSupport, EnumerateStaticTerminals)
  /* [helpstring][hidden][id] */ HRESULT(
      STDMETHODCALLTYPE *EnumerateStaticTerminals)(
      __RPC__in ITTerminalSupport *This,
      /* [retval][out] */ __RPC__deref_out_opt IEnumTerminal *
  ...
  /* [helpstring][id][propget] */ HRESULT(
      STDMETHODCALLTYPE *get_DynamicTerminalClasses)(
      __RPC__in ITTerminalSupport *This,
      /* [retval][out] */ __RPC__out VARIANT *pVariant);

  DECLSPEC_XFGVIRT(ITTerminalSupport, EnumerateDynamicTerminalClasses)
  /* [helpstring][hidden][id] */ HRESULT(
      STDMETHODCALLTYPE *EnumerateDynamicTerminalClasses)(
      __RPC__in ITTerminalSupport *This,
      /* [retval][out] */ __RPC__deref_out_opt IEnumTerminalClass *
...
public:
  ...
  virtual /* [helpstring][hidden][id] */ HRESULT STDMETHODCALLTYPE
      EnumeratePluggableSuperclasses(
          /* [retval][out] */
          __RPC__deref_out_opt IEnumPluggableSuperclassInfo *
          *ppSuperclassEnumerator) = 0;
  ...
  EnumeratePluggableTerminalClasses(
      ...
      /* [in] */ long lMediaType,
      /* [retval][out] */
      __RPC__deref_out_opt IEnumPluggableTerminalClassInfo *
          *ppClassEnumerator) = 0;
};
...
typedef struct ITTerminalSupport2Vtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in ITTerminalSupport2 *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in ITTerminalSupport2 *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in ITTerminalSupport2 *This);
  ...
  /* [helpstring][id][propget] */ HRESULT(
      STDMETHODCALLTYPE *get_PluggableSuperclasses)(
      __RPC__in ITTerminalSupport2 *This,
      /* [retval][out] */ __RPC__out VARIANT *pVariant);

  DECLSPEC_XFGVIRT(ITTerminalSupport2, EnumeratePluggableSuperclasses)
  /* [helpstring][hidden][id] */ HRESULT(
      STDMETHODCALLTYPE *EnumeratePluggableSuperclasses)(
      __RPC__in ITTerminalSupport2 *This,
      /* [retval][out] */ __RPC__deref_out_opt IEnumPluggableSuperclassInfo *
          *ppSuperclassEnumerator);

  DECLSPEC_XFGVIRT(ITTerminalSupport2, get_PluggableTerminalClasses)
  /* [helpstring][id][propget] */ HRESULT(
      STDMETHODCALLTYPE *get_PluggableTerminalClasses)(
      __RPC__in ITTerminalSupport2 *This,
      /* [in] */ __RPC__in BSTR bstrTerminalSuperclass,
      /* [in] */ long lMediaType,
      /* [retval][out] */ __RPC__out VARIANT *pVariant);
  ...
  /* [helpstring][hidden][id] */ HRESULT(
      STDMETHODCALLTYPE *EnumeratePluggableTerminalClasses)(
      __RPC__in ITTerminalSupport2 *This,
      /* [in] */ CLSID iidTerminalSuperclass,
      /* [in] */ long lMediaType,
      /* [retval][out] */
...
public:
  ...
  virtual /* [helpstring][id] */ HRESULT STDMETHODCALLTYPE
      CreateForwardInfoObject(
          /* [retval][out] */ __RPC__deref_out_opt ITForwardInformation *
          *ppForwardInfo) = 0;
...
typedef struct ITAddressVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in ITAddress *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in ITAddress *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in ITAddress *This);
  ...
  /* [helpstring][id][propget] */ HRESULT(
      STDMETHODCALLTYPE *get_ServiceProviderName)(
      __RPC__in ITAddress *This,
      /* [retval][out] */ __RPC__deref_out_opt BSTR *ppName);
  ...
  /* [helpstring][id][propget] */ HRESULT(
      STDMETHODCALLTYPE *get_DialableAddress)(
      __RPC__in ITAddress *This,
  ...
  /* [helpstring][id][propget] */ HRESULT(
      STDMETHODCALLTYPE *get_CurrentForwardInfo)(
      __RPC__in ITAddress *This,
      /* [retval][out] */ __RPC__deref_out_opt ITForwardInformation *
          *ppForwardInfo);
...
interface ITAddress { CONST_VTBL struct ITAddressVtbl *lpVtbl; };
...
typedef struct ITAddress2Vtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in ITAddress2 *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in ITAddress2 *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in ITAddress2 *This);
  ...
  /* [helpstring][id][propget] */ HRESULT(
      STDMETHODCALLTYPE *get_PreferredPhones)(
      __RPC__in ITAddress2 *This,
      /* [retval][out] */ __RPC__out VARIANT *pPhones);

  DECLSPEC_XFGVIRT(ITAddress2, EnumeratePreferredPhones)
  /* [helpstring][hidden][id] */ HRESULT(
      STDMETHODCALLTYPE *EnumeratePreferredPhones)(
      __RPC__in ITAddress2 *This,
      /* [retval][out] */ __RPC__deref_out_opt IEnumPhone **ppEnumPhone);
...
interface ITAddress2 { CONST_VTBL struct ITAddress2Vtbl *lpVtbl; };
...
public:
  ...
  virtual /* [hidden][id] */ HRESULT STDMETHODCALLTYPE EnumerateCallTreatments(
      /* [retval][out] */ __RPC__deref_out_opt IEnumBstr *
      *ppEnumCallTreatment) = 0;
...
typedef struct ITAddressCapabilitiesVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in ITAddressCapabilities *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in ITAddressCapabilities *This);
  ...
  /* [helpstring][id][propget] */ HRESULT(
      STDMETHODCALLTYPE *get_AddressCapability)(
      __RPC__in ITAddressCapabilities *This,
      /* [in] */ ADDRESS_CAPABILITY AddressCap,
  ...
  /* [helpstring][id][propget] */ HRESULT(
      STDMETHODCALLTYPE *get_AddressCapabilityString)(
      __RPC__in ITAddressCapabilities *This,
      /* [in] */ ADDRESS_CAPABILITY_STRING AddressCapString,
  ...
  /* [helpstring][id][propget] */ HRESULT(
      STDMETHODCALLTYPE *get_CallTreatments)(
      __RPC__in ITAddressCapabilities *This,
      /* [retval][out] */ __RPC__out VARIANT *pVariant);
  ...
  /* [helpstring][id][propget] */ HRESULT(
      STDMETHODCALLTYPE *get_CompletionMessages)(
      __RPC__in ITAddressCapabilities *This,
      /* [retval][out] */ __RPC__out VARIANT *pVariant);
...
public:
  ...
  get_ButtonFunction(
      /* [in] */ long lButtonID,
      /* [retval][out] */ __RPC__out PHONE_BUTTON_FUNCTION
          *pButtonFunction) = 0;
  ...
  get_HookSwitchState(
      ...
      /* [retval][out] */ __RPC__out PHONE_HOOK_SWITCH_STATE *
          pHookSwitchState) = 0;
...
typedef struct ITPhoneVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in ITPhone *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in ITPhone *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in ITPhone *This);
  ...
  /* [helpstring][id][propget] */ HRESULT(
      STDMETHODCALLTYPE *get_PhoneCapsString)(
      __RPC__in ITPhone *This,
      /* [in] */ PHONECAPS_STRING pcsCap,
  ...
  /* [helpstring][id][propget] */ HRESULT(
      STDMETHODCALLTYPE *get_ButtonFunction)(
      __RPC__in ITPhone *This,
      /* [in] */ long lButtonID,
  ...
  /* [helpstring][id][propput] */ HRESULT(
      STDMETHODCALLTYPE *put_ButtonFunction)(
      __RPC__in ITPhone *This,
      /* [in] */ long lButtonID,
  ...
  /* [helpstring][id][propget] */ HRESULT(
      STDMETHODCALLTYPE *get_HookSwitchState)(
      __RPC__in ITPhone *This,
      /* [in] */ PHONE_HOOK_SWITCH_DEVICE HookSwitchDevice,
  ...
  /* [helpstring][id][propput] */ HRESULT(
      STDMETHODCALLTYPE *put_HookSwitchState)(
      __RPC__in ITPhone *This,
      /* [in] */ PHONE_HOOK_SWITCH_DEVICE HookSwitchDevice,
  ...
  /* [helpstring][id][propget] */ HRESULT(
      STDMETHODCALLTYPE *get_PhoneCapsBuffer)(
      __RPC__in ITPhone *This,
      /* [in] */ PHONECAPS_BUFFER pcbCaps,
  ...
  /* [helpstring][id][propget] */ HRESULT(
      STDMETHODCALLTYPE *get_PreferredAddresses)(
      __RPC__in ITPhone *This,
      /* [retval][out] */ __RPC__out VARIANT *pAddresses);

  DECLSPEC_XFGVIRT(ITPhone, EnumeratePreferredAddresses)
  /* [helpstring][hidden][id] */ HRESULT(
      STDMETHODCALLTYPE *EnumeratePreferredAddresses)(
      __RPC__in ITPhone *This,
      /* [retval][out] */ __RPC__deref_out_opt IEnumAddress **ppEnumAddress);
...
interface ITPhone { CONST_VTBL struct ITPhoneVtbl *lpVtbl; };
...
#define ITPhone_get_HookSwitchState(This, HookSwitchDevice, pHookSwitchState)  \
  ((This)->lpVtbl->get_HookSwitchState(This, HookSwitchDevice,                 \
                                       pHookSwitchState))
...
#define ITPhone_GetPhoneCapsBuffer(This, pcbCaps, pdwSize, ppPhoneCapsBuffer)  \
  ((This)->lpVtbl->GetPhoneCapsBuffer(This, pcbCaps, pdwSize,                  \
                                      ppPhoneCapsBuffer))
...
typedef struct ITAutomatedPhoneControlVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in ITAutomatedPhoneControl *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in ITAutomatedPhoneControl *This);
  ...
  /* [helpstring][hidden][id] */ HRESULT(
      STDMETHODCALLTYPE *EnumerateSelectedCalls)(
      __RPC__in ITAutomatedPhoneControl *This,
      /* [retval][out] */ __RPC__deref_out_opt IEnumCall **ppCallEnum);
...
public:
  ...
  virtual /* [helpstring][id] */ HRESULT STDMETHODCALLTYPE RemoveFromConference(
      void) = 0;
};
...
typedef struct ITBasicCallControlVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in ITBasicCallControl *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in ITBasicCallControl *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in ITBasicCallControl *This);
...
public:
  ...
  virtual /* [hidden][id] */ HRESULT STDMETHODCALLTYPE GetCallInfoBuffer(
      ...
      /* [out] */ __RPC__out DWORD * pdwSize,
      /* [size_is][size_is][out] */
      __RPC__deref_out_ecount_full_opt(*pdwSize) BYTE * *ppCallInfoBuffer) = 0;

  virtual /* [hidden][id] */ HRESULT STDMETHODCALLTYPE SetCallInfoBuffer(
      /* [in] */ CALLINFO_BUFFER CallInfoBuffer,
      /* [in] */ DWORD dwSize,
      /* [size_is][in] */ __RPC__in_ecount_full(dwSize) BYTE *
          pCallInfoBuffer) = 0;

  virtual /* [helpstring][id] */ HRESULT STDMETHODCALLTYPE ReleaseUserUserInfo(
      void) = 0;
};
...
typedef struct ITCallInfoVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in ITCallInfo *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in ITCallInfo *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in ITCallInfo *This);
  ...
  /* [helpstring][id][propget] */ HRESULT(
      STDMETHODCALLTYPE *get_CallInfoString)(
      __RPC__in ITCallInfo *This,
      /* [in] */ CALLINFO_STRING CallInfoString,
  ...
  /* [helpstring][id][propput] */ HRESULT(
      STDMETHODCALLTYPE *put_CallInfoString)(
      __RPC__in ITCallInfo *This,
      /* [in] */ CALLINFO_STRING CallInfoString,
  ...
  /* [helpstring][id][propget] */ HRESULT(
      STDMETHODCALLTYPE *get_CallInfoBuffer)(
      __RPC__in ITCallInfo *This,
      /* [in] */ CALLINFO_BUFFER CallInfoBuffer,
  ...
  /* [helpstring][id][propput] */ HRESULT(
      STDMETHODCALLTYPE *put_CallInfoBuffer)(
      __RPC__in ITCallInfo *This,
      /* [in] */ CALLINFO_BUFFER CallInfoBuffer,
...
interface ITCallInfo { CONST_VTBL struct ITCallInfoVtbl *lpVtbl; };
...
typedef struct ITCallInfo2Vtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in ITCallInfo2 *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in ITCallInfo2 *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in ITCallInfo2 *This);
...
interface ITCallInfo2 { CONST_VTBL struct ITCallInfo2Vtbl *lpVtbl; };
...
typedef struct ITTerminalVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in ITTerminal *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in ITTerminal *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in ITTerminal *This);
...
interface ITTerminal { CONST_VTBL struct ITTerminalVtbl *lpVtbl; };
...
public:
  ...
  virtual /* [helpstring][id][propget] */ HRESULT STDMETHODCALLTYPE
      get_DirectionsInUse(
          /* [retval][out] */ __RPC__out TERMINAL_DIRECTION *
          plDirectionsInUsed) = 0;
...
typedef struct ITMultiTrackTerminalVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in ITMultiTrackTerminal *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in ITMultiTrackTerminal *This);
  ...
  /* [helpstring][id][propget] */ HRESULT(
      STDMETHODCALLTYPE *get_TrackTerminals)(
      __RPC__in ITMultiTrackTerminal *This,
      /* [retval][out] */ __RPC__out VARIANT *pVariant);

  DECLSPEC_XFGVIRT(ITMultiTrackTerminal, EnumerateTrackTerminals)
  /* [helpstring][hidden][id] */ HRESULT(
      STDMETHODCALLTYPE *EnumerateTrackTerminals)(
      __RPC__in ITMultiTrackTerminal *This,
      /* [retval][out] */ __RPC__deref_out_opt IEnumTerminal **ppEnumTerminal);
...
public:
  virtual /* [helpstring][hidden][id][propget] */ HRESULT STDMETHODCALLTYPE
      get_Format(
          /* [retval][out] */ __RPC__deref_out_opt AM_MEDIA_TYPE * *ppmt) = 0;

  virtual /* [helpstring][hidden][id][propput] */ HRESULT STDMETHODCALLTYPE
  put_Format(
      /* [in] */ __RPC__in const AM_MEDIA_TYPE *pmt) = 0;

  virtual /* [helpstring][id][propget] */ HRESULT STDMETHODCALLTYPE
      get_ControllingTerminal(
          /* [retval][out] */ __RPC__deref_out_opt ITTerminal *
          *ppControllingTerminal) = 0;

  virtual /* [helpstring][id][propget] */ HRESULT STDMETHODCALLTYPE
      get_AudioFormatForScripting(
          /* [retval][out] */ __RPC__deref_out_opt ITScriptableAudioFormat *
          *ppAudioFormat) = 0;
...
typedef struct ITFileTrackVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in ITFileTrack *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in ITFileTrack *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in ITFileTrack *This);
  ...
  /* [helpstring][id][propget] */ HRESULT(
      STDMETHODCALLTYPE *get_AudioFormatForScripting)(
      __RPC__in ITFileTrack *This,
      /* [retval][out] */ __RPC__deref_out_opt ITScriptableAudioFormat *
          *ppAudioFormat);
...
interface ITFileTrack { CONST_VTBL struct ITFileTrackVtbl *lpVtbl; };
...
typedef struct ITMediaPlaybackVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in ITMediaPlayback *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in ITMediaPlayback *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in ITMediaPlayback *This);
...
interface ITMediaPlayback { CONST_VTBL struct ITMediaPlaybackVtbl *lpVtbl; };
...
typedef struct ITMediaRecordVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in ITMediaRecord *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in ITMediaRecord *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in ITMediaRecord *This);
...
interface ITMediaRecord { CONST_VTBL struct ITMediaRecordVtbl *lpVtbl; };
...
public:
  ...
  virtual /* [helpstring][id][propget] */ HRESULT STDMETHODCALLTYPE
      get_MediaState(
          /* [retval][out] */ __RPC__out TERMINAL_MEDIA_STATE *
          pTerminalMediaState) = 0;
};
...
typedef struct ITMediaControlVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in ITMediaControl *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in ITMediaControl *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in ITMediaControl *This);
...
interface ITMediaControl { CONST_VTBL struct ITMediaControlVtbl *lpVtbl; };
...
typedef struct ITBasicAudioTerminalVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in ITBasicAudioTerminal *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in ITBasicAudioTerminal *This);
...
typedef struct ITStaticAudioTerminalVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in ITStaticAudioTerminal *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in ITStaticAudioTerminal *This);
...
typedef struct ITCallHubVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in ITCallHub *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in ITCallHub *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in ITCallHub *This);
...
interface ITCallHub { CONST_VTBL struct ITCallHubVtbl *lpVtbl; };
...
public:
  virtual /* [hidden][id] */ HRESULT STDMETHODCALLTYPE GetID(
      ...
      /* [out] */ __RPC__out DWORD * pdwSize,
      /* [size_is][size_is][out] */
      __RPC__deref_out_ecount_full_opt(*pdwSize) BYTE * *ppDeviceID) = 0;

  virtual /* [hidden][id] */ HRESULT STDMETHODCALLTYPE GetDevConfig(
      /* [in] */ __RPC__in BSTR pDeviceClass,
      /* [out] */ __RPC__out DWORD * pdwSize,
      /* [size_is][size_is][out] */
      __RPC__deref_out_ecount_full_opt(*pdwSize) BYTE * *ppDeviceConfig) = 0;
...
typedef struct ITLegacyAddressMediaControlVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in ITLegacyAddressMediaControl *This);
...
typedef struct ITPrivateEventVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in ITPrivateEvent *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in ITPrivateEvent *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in ITPrivateEvent *This);
  ...
  /* [helpstring][id][propget] */ HRESULT(
      STDMETHODCALLTYPE *get_EventInterface)(
      __RPC__in ITPrivateEvent *This,
...
interface ITPrivateEvent { CONST_VTBL struct ITPrivateEventVtbl *lpVtbl; };
...
public:
  ...
  virtual /* [hidden][id] */ HRESULT STDMETHODCALLTYPE ConfigDialogEdit(
      ...
      /* [in] */ __RPC__in BSTR pDeviceClass,
      /* [in] */ DWORD dwSizeIn,
      /* [size_is][in] */ __RPC__in_ecount_full(dwSizeIn) BYTE *
          pDeviceConfigIn,
      /* [out] */ __RPC__out DWORD * pdwSizeOut,
      /* [size_is][size_is][out] */
      __RPC__deref_out_ecount_full_opt(*pdwSizeOut) BYTE *
          *ppDeviceConfigOut) = 0;
};
...
typedef struct ITLegacyCallMediaControlVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in ITLegacyCallMediaControl *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in ITLegacyCallMediaControl *This);
...
public:
  ...
  virtual /* [helpstring][id] */ HRESULT STDMETHODCALLTYPE
      CreateDetectToneObject(
          /* [retval][out] */ __RPC__deref_out_opt ITDetectTone *
          *ppDetectTone) = 0;

  virtual /* [helpstring][id] */ HRESULT STDMETHODCALLTYPE
      CreateCustomToneObject(
          /* [retval][out] */ __RPC__deref_out_opt ITCustomTone *
          *ppCustomTone) = 0;
...
typedef struct ITLegacyCallMediaControl2Vtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in ITLegacyCallMediaControl2 *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in ITLegacyCallMediaControl2 *This);
  ...
  /* [helpstring][hidden][id] */ HRESULT(
      STDMETHODCALLTYPE *GenerateCustomTones)(
      __RPC__in ITLegacyCallMediaControl2 *This,
      /* [in] */ __RPC__in TAPI_CUSTOMTONE *pToneList,
      /* [in] */ long lNumTones,
      /* [in] */ long lDuration);
  ...
  /* [helpstring][id] */ HRESULT(
      STDMETHODCALLTYPE *GenerateCustomTonesByCollection)(
      __RPC__in ITLegacyCallMediaControl2 *This,
      /* [in] */ __RPC__in_opt ITCollection2 *pCustomToneCollection,
      /* [in] */ long lDuration);
...
#define ITLegacyCallMediaControl2_GenerateCustomTonesByCollection(             \
  ...
  ((This)->lpVtbl->GenerateCustomTonesByCollection(                            \
      This, pCustomToneCollection, lDuration))
...
typedef struct ITDetectToneVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in ITDetectTone *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in ITDetectTone *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in ITDetectTone *This);
...
interface ITDetectTone { CONST_VTBL struct ITDetectToneVtbl *lpVtbl; };
...
typedef struct ITCustomToneVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in ITCustomTone *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in ITCustomTone *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in ITCustomTone *This);
...
interface ITCustomTone { CONST_VTBL struct ITCustomToneVtbl *lpVtbl; };
...
typedef struct IEnumPhoneVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in IEnumPhone *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IEnumPhone *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IEnumPhone *This);
  ...
  HRESULT(STDMETHODCALLTYPE *Reset)(__RPC__in IEnumPhone *This);

  DECLSPEC_XFGVIRT(IEnumPhone, Skip)
  HRESULT(STDMETHODCALLTYPE *Skip)(__RPC__in IEnumPhone *This,
                                   /* [in] */ ULONG celt);
...
interface IEnumPhone { CONST_VTBL struct IEnumPhoneVtbl *lpVtbl; };
...
typedef struct IEnumTerminalVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in IEnumTerminal *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IEnumTerminal *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IEnumTerminal *This);
  ...
  HRESULT(STDMETHODCALLTYPE *Reset)(__RPC__in IEnumTerminal *This);

  DECLSPEC_XFGVIRT(IEnumTerminal, Skip)
  HRESULT(STDMETHODCALLTYPE *Skip)(__RPC__in IEnumTerminal *This,
                                   /* [in] */ ULONG celt);
...
interface IEnumTerminal { CONST_VTBL struct IEnumTerminalVtbl *lpVtbl; };
...
typedef struct IEnumTerminalClassVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in IEnumTerminalClass *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IEnumTerminalClass *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IEnumTerminalClass *This);
  ...
  HRESULT(STDMETHODCALLTYPE *Reset)(__RPC__in IEnumTerminalClass *This);

  DECLSPEC_XFGVIRT(IEnumTerminalClass, Skip)
  HRESULT(STDMETHODCALLTYPE *Skip)(__RPC__in IEnumTerminalClass *This,
                                   /* [in] */ ULONG celt);
...
typedef struct IEnumCallVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in IEnumCall *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IEnumCall *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IEnumCall *This);
  ...
  HRESULT(STDMETHODCALLTYPE *Reset)(__RPC__in IEnumCall *This);

  DECLSPEC_XFGVIRT(IEnumCall, Skip)
  HRESULT(STDMETHODCALLTYPE *Skip)(__RPC__in IEnumCall *This,
                                   /* [in] */ ULONG celt);
...
interface IEnumCall { CONST_VTBL struct IEnumCallVtbl *lpVtbl; };
...
typedef struct IEnumAddressVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in IEnumAddress *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IEnumAddress *This);
  ...
  HRESULT(STDMETHODCALLTYPE *Reset)(__RPC__in IEnumAddress *This);
...
interface IEnumAddress { CONST_VTBL struct IEnumAddressVtbl *lpVtbl; };
...
typedef struct IEnumCallHubVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in IEnumCallHub *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IEnumCallHub *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IEnumCallHub *This);
  ...
  HRESULT(STDMETHODCALLTYPE *Reset)(__RPC__in IEnumCallHub *This);

  DECLSPEC_XFGVIRT(IEnumCallHub, Skip)
  HRESULT(STDMETHODCALLTYPE *Skip)(__RPC__in IEnumCallHub *This,
                                   /* [in] */ ULONG celt);
...
interface IEnumCallHub { CONST_VTBL struct IEnumCallHubVtbl *lpVtbl; };
...
typedef struct IEnumBstrVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in IEnumBstr *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IEnumBstr *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IEnumBstr *This);
  ...
  HRESULT(STDMETHODCALLTYPE *Reset)(__RPC__in IEnumBstr *This);

  DECLSPEC_XFGVIRT(IEnumBstr, Skip)
  HRESULT(STDMETHODCALLTYPE *Skip)(__RPC__in IEnumBstr *This,
                                   /* [in] */ ULONG celt);
...
interface IEnumBstr { CONST_VTBL struct IEnumBstrVtbl *lpVtbl; };
...
public:
  ...
  virtual HRESULT STDMETHODCALLTYPE Clone(
      /* [retval][out] */ __RPC__deref_out_opt IEnumPluggableTerminalClassInfo *
      *ppEnum) = 0;
};
...
public:
  virtual HRESULT STDMETHODCALLTYPE Next(
      /* [in] */ ULONG celt,
      /* [size_is][out] */
      __RPC__out_ecount_full(celt) ITPluggableTerminalSuperclassInfo *
          *ppElements,
      /* [full][out][in] */ __RPC__inout_opt ULONG * pceltFetched) = 0;
...
typedef struct IEnumPluggableSuperclassInfoVtbl {
  ...
  HRESULT(STDMETHODCALLTYPE *Skip)(__RPC__in IEnumPluggableSuperclassInfo *This,
                                   /* [in] */ ULONG celt);
...
public:
  ...
  virtual /* [helpstring][id][propget] */ HRESULT STDMETHODCALLTYPE
      get_HookSwitchDevice(
          /* [retval][out] */ __RPC__out PHONE_HOOK_SWITCH_DEVICE *
          pDevice) = 0;
...
typedef struct ITPhoneEventVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in ITPhoneEvent *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in ITPhoneEvent *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in ITPhoneEvent *This);
  ...
  /* [helpstring][id][propget] */ HRESULT(
      STDMETHODCALLTYPE *get_HookSwitchDevice)(
      __RPC__in ITPhoneEvent *This,
  ...
  /* [helpstring][id][propget] */ HRESULT(
      STDMETHODCALLTYPE *get_NumberGathered)(
      __RPC__in ITPhoneEvent *This,
...
interface ITPhoneEvent { CONST_VTBL struct ITPhoneEventVtbl *lpVtbl; };
...
typedef struct ITCallStateEventVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in ITCallStateEvent *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in ITCallStateEvent *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in ITCallStateEvent *This);
  ...
  /* [helpstring][id][propget] */ HRESULT(
      STDMETHODCALLTYPE *get_CallbackInstance)(
      __RPC__in ITCallStateEvent *This,
...
interface ITCallStateEvent { CONST_VTBL struct ITCallStateEventVtbl *lpVtbl; };
...
typedef struct ITPhoneDeviceSpecificEventVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in ITPhoneDeviceSpecificEvent *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in ITPhoneDeviceSpecificEvent *This);
...
typedef struct ITCallMediaEventVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in ITCallMediaEvent *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in ITCallMediaEvent *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in ITCallMediaEvent *This);
...
interface ITCallMediaEvent { CONST_VTBL struct ITCallMediaEventVtbl *lpVtbl; };
...
typedef struct ITDigitDetectionEventVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in ITDigitDetectionEvent *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in ITDigitDetectionEvent *This);
...
typedef struct ITDigitGenerationEventVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in ITDigitGenerationEvent *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in ITDigitGenerationEvent *This);
  ...
  /* [helpstring][id][propget] */ HRESULT(
      STDMETHODCALLTYPE *get_GenerationTermination)(
      __RPC__in ITDigitGenerationEvent *This,
...
public:
  ...
  virtual /* [helpstring][id][propget] */ HRESULT STDMETHODCALLTYPE
      get_GatherTermination(
          /* [retval][out] */ __RPC__out TAPI_GATHERTERM *
          pGatherTermination) = 0;
...
typedef struct ITDigitsGatheredEventVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in ITDigitsGatheredEvent *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in ITDigitsGatheredEvent *This);
  ...
  /* [helpstring][id][propget] */ HRESULT(
      STDMETHODCALLTYPE *get_GatherTermination)(
      __RPC__in ITDigitsGatheredEvent *This,
...
typedef struct ITToneDetectionEventVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in ITToneDetectionEvent *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in ITToneDetectionEvent *This);
...
typedef struct ITTAPIObjectEventVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in ITTAPIObjectEvent *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in ITTAPIObjectEvent *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in ITTAPIObjectEvent *This);
...
typedef struct ITTAPIObjectEvent2Vtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in ITTAPIObjectEvent2 *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in ITTAPIObjectEvent2 *This);
...
typedef struct ITTAPIEventNotificationVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in ITTAPIEventNotification *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in ITTAPIEventNotification *This);
...
typedef struct ITCallHubEventVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in ITCallHubEvent *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in ITCallHubEvent *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in ITCallHubEvent *This);
...
interface ITCallHubEvent { CONST_VTBL struct ITCallHubEventVtbl *lpVtbl; };
...
typedef struct ITAddressEventVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in ITAddressEvent *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in ITAddressEvent *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in ITAddressEvent *This);
...
interface ITAddressEvent { CONST_VTBL struct ITAddressEventVtbl *lpVtbl; };
...
public:
  ...
  virtual /* [helpstring][id][propget] */ HRESULT STDMETHODCALLTYPE get_Track(
      /* [retval][out] */ __RPC__deref_out_opt ITFileTrack *
      *ppTrackTerminal) = 0;
...
typedef struct ITFileTerminalEventVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in ITFileTerminalEvent *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in ITFileTerminalEvent *This);
...
typedef struct ITTTSTerminalEventVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in ITTTSTerminalEvent *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in ITTTSTerminalEvent *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in ITTTSTerminalEvent *This);
...
typedef struct ITASRTerminalEventVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in ITASRTerminalEvent *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in ITASRTerminalEvent *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in ITASRTerminalEvent *This);
...
typedef struct ITToneTerminalEventVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in ITToneTerminalEvent *This);
...
typedef struct ITQOSEventVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in ITQOSEvent *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in ITQOSEvent *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in ITQOSEvent *This);
...
interface ITQOSEvent { CONST_VTBL struct ITQOSEventVtbl *lpVtbl; };
...
typedef struct ITCallInfoChangeEventVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in ITCallInfoChangeEvent *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in ITCallInfoChangeEvent *This);
...
typedef struct ITRequestVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in ITRequest *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in ITRequest *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in ITRequest *This);
...
interface ITRequest { CONST_VTBL struct ITRequestVtbl *lpVtbl; };
...
#define ITRequest_MakeCall(This, pDestAddress, pAppName, pCalledParty,         \
                           pComment)                                           \
  ((This)->lpVtbl->MakeCall(This, pDestAddress, pAppName, pCalledParty,        \
                            pComment))
...
typedef struct ITRequestEventVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in ITRequestEvent *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in ITRequestEvent *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in ITRequestEvent *This);
  ...
  /* [helpstring][id][propget] */ HRESULT(
      STDMETHODCALLTYPE *get_RegistrationInstance)(
      __RPC__in ITRequestEvent *This,
...
interface ITRequestEvent { CONST_VTBL struct ITRequestEventVtbl *lpVtbl; };
...
typedef struct ITCollectionVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in ITCollection *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in ITCollection *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in ITCollection *This);
...
interface ITCollection { CONST_VTBL struct ITCollectionVtbl *lpVtbl; };
...
typedef struct ITCollection2Vtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in ITCollection2 *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in ITCollection2 *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in ITCollection2 *This);
...
interface ITCollection2 { CONST_VTBL struct ITCollection2Vtbl *lpVtbl; };
...
typedef struct ITForwardInformationVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in ITForwardInformation *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in ITForwardInformation *This);
  ...
  /* [helpstring][id][propput] */ HRESULT(
      STDMETHODCALLTYPE *put_NumRingsNoAnswer)(
      __RPC__in ITForwardInformation *This,
      /* [in] */ long lNumRings);

  DECLSPEC_XFGVIRT(ITForwardInformation, get_NumRingsNoAnswer)
  /* [helpstring][id][propget] */ HRESULT(
      STDMETHODCALLTYPE *get_NumRingsNoAnswer)(
      __RPC__in ITForwardInformation *This,
  ...
  /* [helpstring][id][propget] */ HRESULT(
      STDMETHODCALLTYPE *get_ForwardTypeDestination)(
      __RPC__in ITForwardInformation *This,
      /* [in] */ long ForwardType,
      /* [retval][out] */ __RPC__deref_out_opt BSTR *ppDestAddress);
  ...
  /* [helpstring][id][propget] */ HRESULT(
      STDMETHODCALLTYPE *get_ForwardTypeCaller)(
      __RPC__in ITForwardInformation *This,
      /* [in] */ long Forwardtype,
...
typedef struct ITForwardInformation2Vtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in ITForwardInformation2 *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in ITForwardInformation2 *This);
  ...
  /* [helpstring][id][propget] */ HRESULT(
      STDMETHODCALLTYPE *get_ForwardTypeDestinationAddressType)(
      __RPC__in ITForwardInformation2 *This,
      /* [in] */ long ForwardType,
  ...
  /* [helpstring][id][propget] */ HRESULT(
      STDMETHODCALLTYPE *get_ForwardTypeCallerAddressType)(
      __RPC__in ITForwardInformation2 *This,
      /* [in] */ long Forwardtype,
...
public:
  virtual /* [helpstring][id] */ HRESULT STDMETHODCALLTYPE TranslateAddress(
      ...
      /* [retval][out] */
      __RPC__deref_out_opt ITAddressTranslationInfo **ppTranslated) = 0;
  ...
  virtual /* [helpstring][hidden][id] */ HRESULT STDMETHODCALLTYPE
      EnumerateLocations(
          /* [retval][out] */ __RPC__deref_out_opt IEnumLocation *
          *ppEnumLocation) = 0;
  ...
  virtual /* [helpstring][hidden][id] */ HRESULT STDMETHODCALLTYPE
      EnumerateCallingCards(
          /* [retval][out] */ __RPC__deref_out_opt IEnumCallingCard *
          *ppEnumCallingCard) = 0;
...
typedef struct ITAddressTranslationVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in ITAddressTranslation *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in ITAddressTranslation *This);
  ...
  /* [helpstring][hidden][id] */ HRESULT(
      STDMETHODCALLTYPE *EnumerateCallingCards)(
      __RPC__in ITAddressTranslation *This,
      /* [retval][out] */ __RPC__deref_out_opt IEnumCallingCard *
          *ppEnumCallingCard);
...
typedef struct ITAddressTranslationInfoVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in ITAddressTranslationInfo *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in ITAddressTranslationInfo *This);
...
typedef struct ITLocationInfoVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in ITLocationInfo *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in ITLocationInfo *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in ITLocationInfo *This);
  ...
  /* [helpstring][id][propget] */ HRESULT(
      STDMETHODCALLTYPE *get_PermanentLocationID)(
      __RPC__in ITLocationInfo *This,
  ...
  /* [helpstring][id][propget] */ HRESULT(
      STDMETHODCALLTYPE *get_PreferredCardID)(
      __RPC__in ITLocationInfo *This,
...
interface ITLocationInfo { CONST_VTBL struct ITLocationInfoVtbl *lpVtbl; };
...
typedef struct IEnumLocationVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in IEnumLocation *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IEnumLocation *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IEnumLocation *This);
  ...
  HRESULT(STDMETHODCALLTYPE *Reset)(__RPC__in IEnumLocation *This);

  DECLSPEC_XFGVIRT(IEnumLocation, Skip)
  HRESULT(STDMETHODCALLTYPE *Skip)(__RPC__in IEnumLocation *This,
                                   /* [in] */ ULONG celt);
...
interface IEnumLocation { CONST_VTBL struct IEnumLocationVtbl *lpVtbl; };
...
typedef struct ITCallingCardVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in ITCallingCard *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in ITCallingCard *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in ITCallingCard *This);
  ...
  /* [helpstring][id][propget] */ HRESULT(
      STDMETHODCALLTYPE *get_PermanentCardID)(
      __RPC__in ITCallingCard *This,
      /* [retval][out] */ __RPC__out long *plCardID);

  DECLSPEC_XFGVIRT(ITCallingCard, get_NumberOfDigits)
  /* [helpstring][id][propget] */ HRESULT(
      STDMETHODCALLTYPE *get_NumberOfDigits)(
      __RPC__in ITCallingCard *This,
...
interface ITCallingCard { CONST_VTBL struct ITCallingCardVtbl *lpVtbl; };
...
typedef struct IEnumCallingCardVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in IEnumCallingCard *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IEnumCallingCard *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IEnumCallingCard *This);
  ...
  HRESULT(STDMETHODCALLTYPE *Reset)(__RPC__in IEnumCallingCard *This);

  DECLSPEC_XFGVIRT(IEnumCallingCard, Skip)
  HRESULT(STDMETHODCALLTYPE *Skip)(__RPC__in IEnumCallingCard *This,
                                   /* [in] */ ULONG celt);
...
interface IEnumCallingCard { CONST_VTBL struct IEnumCallingCardVtbl *lpVtbl; };
...
public:
  ...
  virtual /* [helpstring][id][propget] */ HRESULT STDMETHODCALLTYPE get_Event(
      /* [retval][out] */ __RPC__out CALL_NOTIFICATION_EVENT *
      pCallNotificationEvent) = 0;
...
typedef struct ITCallNotificationEventVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in ITCallNotificationEvent *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in ITCallNotificationEvent *This);
...
typedef struct ITDispatchMapperVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in ITDispatchMapper *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in ITDispatchMapper *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in ITDispatchMapper *This);
...
interface ITDispatchMapper { CONST_VTBL struct ITDispatchMapperVtbl *lpVtbl; };
...
typedef struct ITStreamControlVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in ITStreamControl *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in ITStreamControl *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in ITStreamControl *This);
...
interface ITStreamControl { CONST_VTBL struct ITStreamControlVtbl *lpVtbl; };
...
public:
  ...
  virtual /* [helpstring][id] */ HRESULT STDMETHODCALLTYPE StartStream(
      void) = 0;

  virtual /* [helpstring][id] */ HRESULT STDMETHODCALLTYPE PauseStream(
      void) = 0;
...
typedef struct ITStreamVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in ITStream *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in ITStream *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in ITStream *This);
...
interface ITStream { CONST_VTBL struct ITStreamVtbl *lpVtbl; };
...
typedef struct IEnumStreamVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in IEnumStream *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IEnumStream *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IEnumStream *This);
  ...
  HRESULT(STDMETHODCALLTYPE *Reset)(__RPC__in IEnumStream *This);

  DECLSPEC_XFGVIRT(IEnumStream, Skip)
  HRESULT(STDMETHODCALLTYPE *Skip)(__RPC__in IEnumStream *This,
                                   /* [in] */ ULONG celt);
...
interface IEnumStream { CONST_VTBL struct IEnumStreamVtbl *lpVtbl; };
...
typedef struct ITSubStreamControlVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in ITSubStreamControl *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in ITSubStreamControl *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in ITSubStreamControl *This);
...
public:
  virtual /* [helpstring][id] */ HRESULT STDMETHODCALLTYPE StartSubStream(
      void) = 0;

  virtual /* [helpstring][id] */ HRESULT STDMETHODCALLTYPE PauseSubStream(
      void) = 0;

  virtual /* [helpstring][id] */ HRESULT STDMETHODCALLTYPE StopSubStream(
      void) = 0;
...
typedef struct ITSubStreamVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in ITSubStream *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in ITSubStream *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in ITSubStream *This);
...
interface ITSubStream { CONST_VTBL struct ITSubStreamVtbl *lpVtbl; };
...
typedef struct IEnumSubStreamVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in IEnumSubStream *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IEnumSubStream *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IEnumSubStream *This);
  ...
  HRESULT(STDMETHODCALLTYPE *Reset)(__RPC__in IEnumSubStream *This);

  DECLSPEC_XFGVIRT(IEnumSubStream, Skip)
  HRESULT(STDMETHODCALLTYPE *Skip)(__RPC__in IEnumSubStream *This,
                                   /* [in] */ ULONG celt);
...
interface IEnumSubStream { CONST_VTBL struct IEnumSubStreamVtbl *lpVtbl; };
...
typedef struct ITLegacyWaveSupportVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in ITLegacyWaveSupport *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in ITLegacyWaveSupport *This);
...
typedef struct ITBasicCallControl2Vtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in ITBasicCallControl2 *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in ITBasicCallControl2 *This);
...
typedef struct ITScriptableAudioFormatVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in ITScriptableAudioFormat *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in ITScriptableAudioFormat *This);
