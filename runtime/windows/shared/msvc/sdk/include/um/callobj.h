...
typedef struct ICallFrameVtbl {
  ...
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(ICallFrame *This,
                                             /* [in] */ REFIID riid,
  ...
  HRESULT(STDMETHODCALLTYPE *GetInfo)(ICallFrame *This,
                                      /* [out] */ CALLFRAMEINFO *pInfo);

  DECLSPEC_XFGVIRT(ICallFrame, GetIIDAndMethod)
  HRESULT(STDMETHODCALLTYPE *GetIIDAndMethod)(ICallFrame *This,
                                              /* [out] */ IID *pIID,
                                              /* [out] */ ULONG *piMethod);
  ...
  void(STDMETHODCALLTYPE *SetStackLocation)(ICallFrame *This,
                                            /* [in] */ PVOID pvStack);

  DECLSPEC_XFGVIRT(ICallFrame, SetReturnValue)
  void(STDMETHODCALLTYPE *SetReturnValue)(ICallFrame *This,
                                          /* [in] */ HRESULT hr);
  ...
  HRESULT(STDMETHODCALLTYPE *SetParam)(ICallFrame *This,
                                       /* [in] */ ULONG iparam,
                                       /* [in] */ VARIANT *pvar);

  DECLSPEC_XFGVIRT(ICallFrame, GetParam)
  HRESULT(STDMETHODCALLTYPE *GetParam)(ICallFrame *This,
                                       /* [in] */ ULONG iparam,
                                       /* [out] */ VARIANT *pvar);

  DECLSPEC_XFGVIRT(ICallFrame, Copy)
  HRESULT(STDMETHODCALLTYPE *Copy)(ICallFrame *This,
                                   /* [in] */ CALLFRAME_COPY copyControl,
                                   /* [in] */ ICallFrameWalker *pWalker,
                                   /* [out] */ ICallFrame **ppFrame);

  DECLSPEC_XFGVIRT(ICallFrame, Free)
  HRESULT(STDMETHODCALLTYPE *Free)(ICallFrame *This,
                                   /* [in] */ ICallFrame *pframeArgsDest,
                                   /* [in] */ ICallFrameWalker *pWalkerDestFree,
                                   /* [in] */ ICallFrameWalker *pWalkerCopy,
                                   /* [in] */ DWORD freeFlags,
  ...
  HRESULT(STDMETHODCALLTYPE *WalkFrame)(ICallFrame *This,
                                        /* [in] */ DWORD walkWhat,
                                        /* [in] */ ICallFrameWalker *pWalker);
  ...
  HRESULT(STDMETHODCALLTYPE *Invoke)(ICallFrame *This,
                                     /* [in] */ void *pvReceiver, ...);

  END_INTERFACE
} ICallFrameVtbl;

interface ICallFrame { CONST_VTBL struct ICallFrameVtbl *lpVtbl; };
...
typedef struct ICallIndirectVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(ICallIndirect *This,
                                             /* [in] */ REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);
  ...
  HRESULT(STDMETHODCALLTYPE *CallIndirect)(ICallIndirect *This,
                                           /* [out] */ HRESULT *phrReturn,
                                           /* [in] */ ULONG iMethod,
                                           /* [in] */ void *pvArgs,
                                           /* [out] */ ULONG *cbArgs);
  ...
  HRESULT(STDMETHODCALLTYPE *GetStackSize)(ICallIndirect *This,
                                           /* [in] */ ULONG iMethod,
                                           /* [out] */ ULONG *cbArgs);
...
interface ICallIndirect { CONST_VTBL struct ICallIndirectVtbl *lpVtbl; };
...
typedef struct ICallInterceptorVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(ICallInterceptor *This,
                                             /* [in] */ REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);
  ...
  DECLSPEC_XFGVIRT(ICallIndirect, CallIndirect)
  HRESULT(STDMETHODCALLTYPE *CallIndirect)(ICallInterceptor *This,
                                           /* [out] */ HRESULT *phrReturn,
                                           /* [in] */ ULONG iMethod,
                                           /* [in] */ void *pvArgs,
                                           /* [out] */ ULONG *cbArgs);
  ...
  DECLSPEC_XFGVIRT(ICallIndirect, GetStackSize)
  HRESULT(STDMETHODCALLTYPE *GetStackSize)(ICallInterceptor *This,
                                           /* [in] */ ULONG iMethod,
                                           /* [out] */ ULONG *cbArgs);
  ...
  HRESULT(STDMETHODCALLTYPE *RegisterSink)(ICallInterceptor *This,
...
interface ICallInterceptor { CONST_VTBL struct ICallInterceptorVtbl *lpVtbl; };
...
typedef struct ICallFrameEventsVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(ICallFrameEvents *This,
                                             /* [in] */ REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);
  ...
  HRESULT(STDMETHODCALLTYPE *OnCall)(ICallFrameEvents *This,
                                     /* [in] */ ICallFrame *pFrame);

  END_INTERFACE
} ICallFrameEventsVtbl;

interface ICallFrameEvents { CONST_VTBL struct ICallFrameEventsVtbl *lpVtbl; };
...
typedef struct ICallUnmarshalVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(ICallUnmarshal *This,
                                             /* [in] */ REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);
...
interface ICallUnmarshal { CONST_VTBL struct ICallUnmarshalVtbl *lpVtbl; };
...
typedef struct ICallFrameWalkerVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(ICallFrameWalker *This,
                                             /* [in] */ REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);
  ...
  HRESULT(STDMETHODCALLTYPE *OnWalkInterface)(ICallFrameWalker *This,
                                              /* [in] */ REFIID iid,
                                              /* [in] */ PVOID *ppvInterface,
                                              /* [in] */ BOOL fIn,
                                              /* [in] */ BOOL fOut);
...
interface ICallFrameWalker { CONST_VTBL struct ICallFrameWalkerVtbl *lpVtbl; };
...
typedef struct IInterfaceRelatedVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(IInterfaceRelated *This,
                                             /* [in] */ REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);
  ...
  HRESULT(STDMETHODCALLTYPE *SetIID)(IInterfaceRelated *This,
                                     /* [in] */ REFIID iid);

  DECLSPEC_XFGVIRT(IInterfaceRelated, GetIID)
  HRESULT(STDMETHODCALLTYPE *GetIID)(IInterfaceRelated *This,
                                     /* [out] */ IID *piid);
