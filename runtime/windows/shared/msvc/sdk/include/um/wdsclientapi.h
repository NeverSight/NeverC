...
typedef struct tagWDS_CLI_CRED {
  PCWSTR pwszUserName, pwszDomain, pwszPassword;
...
HRESULT
WDSCLIAPI
WdsCliClose(_In_ HANDLE Handle);

typedef VOID(WDSCLIAPI *PFN_WdsCliTraceFunction)(_In_ LPCWSTR pwszFormat,
                                                 _In_ va_list Params);

HRESULT
WDSCLIAPI
WdsCliRegisterTrace(_In_opt_ PFN_WdsCliTraceFunction pfn);

HRESULT
WDSCLIAPI
WdsCliFreeStringArray(_Inout_updates_opt_(ulCount) PWSTR *ppwszArray,
                      _In_ ULONG ulCount);
...
HRESULT
WDSCLIAPI
WdsCliFindFirstImage(_In_ HANDLE hSession, _Out_ PHANDLE phFindHandle);

HRESULT
WDSCLIAPI
WdsCliFindNextImage(_In_ HANDLE Handle);

HRESULT
WDSCLIAPI
WdsCliGetEnumerationFlags(_In_ HANDLE Handle, _Out_ PDWORD pdwFlags);

HRESULT
WDSCLIAPI
WdsCliGetImageHandleFromFindHandle(_In_ HANDLE FindHandle,
                                   _Out_ PHANDLE phImageHandle);

HRESULT
WDSCLIAPI
WdsCliGetImageHandleFromTransferHandle(_In_ HANDLE hTransfer,
                                       _Out_ PHANDLE phImageHandle);
...
HRESULT
WDSCLIAPI
WdsCliCreateSession(_In_ PWSTR pwszServer, _In_opt_ PWDS_CLI_CRED pCred,
                    _Out_ PHANDLE phSession);

HRESULT
WDSCLIAPI
WdsCliAuthorizeSession(_Inout_ HANDLE hSession, _In_opt_ PWDS_CLI_CRED pCred);
...
HRESULT
WDSCLIAPI
WdsCliInitializeLog(_In_ HANDLE hSession, _In_ ULONG ulClientArchitecture,
                    _In_ PWSTR pwszClientId, _In_ PWSTR pwszClientAddress);

HRESULT
WDSCLIAPI
WdsCliLog(_In_ HANDLE hSession, _In_ ULONG ulLogLevel, _In_ ULONG ulMessageCode,
          ...);
...
HRESULT
WDSCLIAPI
WdsCliGetImageName(_In_ HANDLE hIfh, _Out_ PWSTR *ppwszValue);

HRESULT
WDSCLIAPI
WdsCliGetImageDescription(_In_ HANDLE hIfh, _Out_ PWSTR *ppwszValue);

HRESULT
WDSCLIAPI
WdsCliGetImageType(_In_ HANDLE hIfh, _Out_ PWDS_CLI_IMAGE_TYPE pImageType);

HRESULT
WDSCLIAPI
WdsCliGetImageFiles(_In_ HANDLE hIfh,
                    _Outptr_result_buffer_(*pdwCount) LPWSTR **pppwszFiles,
                    _Out_ PDWORD pdwCount);

HRESULT
WDSCLIAPI
WdsCliGetImageLanguage(_In_ HANDLE hIfh, _Out_ PWSTR *ppwszValue);

HRESULT
WDSCLIAPI
WdsCliGetImageLanguages(_In_ HANDLE hIfh,
                        _Outptr_result_buffer_(*pdwNumValues)
                            PTSTR **pppszValues,
                        _Out_ PDWORD pdwNumValues);

HRESULT
WDSCLIAPI
WdsCliGetImageVersion(_In_ HANDLE hIfh, _Out_ PWSTR *ppwszValue);

HRESULT
WDSCLIAPI
WdsCliGetImagePath(_In_ HANDLE hIfh, _Out_ PWSTR *ppwszValue);

HRESULT
WDSCLIAPI
WdsCliGetImageIndex(_In_ HANDLE hIfh, _Out_ PDWORD pdwValue);

HRESULT
WDSCLIAPI
WdsCliGetImageArchitecture(_In_ HANDLE hIfh, _Out_ PDWORD pdwValue);

HRESULT
WDSCLIAPI
WdsCliGetImageLastModifiedTime(_In_ HANDLE hIfh,
                               _Out_ PSYSTEMTIME *ppSysTimeValue);

HRESULT
WDSCLIAPI
WdsCliGetImageSize(_In_ HANDLE hIfh, _Out_ PULONGLONG pullValue);

HRESULT
WDSCLIAPI
WdsCliGetImageHalName(_In_ HANDLE hIfh, _Out_ PWSTR *ppwszValue);

HRESULT
WDSCLIAPI
WdsCliGetImageGroup(_In_ HANDLE hIfh, _Out_ PWSTR *ppwszValue);

HRESULT
WDSCLIAPI
WdsCliGetImageNamespace(_In_ HANDLE hIfh, _Out_ PWSTR *ppwszValue);

HRESULT
WDSCLIAPI
WdsCliGetImageParameter(_In_ HANDLE hIfh,
...
typedef VOID(WDSCLIAPI *PFN_WdsCliCallback)(DWORD dwMessageId,
...
HRESULT
WDSCLIAPI
WdsCliGetTransferSize(_In_ HANDLE hIfh, _Out_ PULONGLONG pullValue);
...
VOID WDSCLIAPI WdsCliSetTransferBufferSize(_In_ ULONG ulSizeInBytes);

HRESULT
WDSCLIAPI
WdsCliTransferImage(_In_ HANDLE hImage, _In_ PWSTR pwszLocalPath,
                    _In_ DWORD dwFlags, _In_ DWORD dwReserved,
                    _In_opt_ PFN_WdsCliCallback pfnWdsCliCallback,
                    _In_opt_ PVOID pvUserData, _Out_ PHANDLE phTransfer);

HRESULT
WDSCLIAPI
WdsCliTransferFile(_In_ PCWSTR pwszServer, _In_ PCWSTR pwszNamespace,
                   _In_ PCWSTR pwszRemoteFilePath,
                   _In_ PCWSTR pwszLocalFilePath, _In_ DWORD dwFlags,
...
HRESULT
WDSCLIAPI
WdsCliCancelTransfer(_In_ HANDLE hTransfer);

HRESULT
WDSCLIAPI
WdsCliWaitForTransfer(_In_ HANDLE hTransfer);
...
HRESULT
WDSCLIAPI
WdsCliObtainDriverPackages(_In_ HANDLE hImage, _Outptr_ PWSTR *ppwszServerName,
                           _Outptr_result_buffer_(*pulCount)
                               PWSTR **pppwszDriverPackages,
                           _Out_ ULONG *pulCount);

HRESULT
WDSCLIAPI
WdsCliObtainDriverPackagesEx(_In_ HANDLE hSession, _In_ PWSTR pwszMachineInfo,
...
HRESULT
WDSCLIAPI
WdsCliGetDriverQueryXml(_In_opt_ PWSTR pwszWinDirPath,
