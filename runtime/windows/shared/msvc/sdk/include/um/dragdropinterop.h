...
typedef struct IDragDropManagerInteropVtbl {
  ...
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(IDragDropManagerInterop *This,
                                             /* [in] */ REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(IDragDropManagerInterop *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(IDragDropManagerInterop *This);

  DECLSPEC_XFGVIRT(IInspectable, GetIids)
  HRESULT(STDMETHODCALLTYPE *GetIids)(IDragDropManagerInterop *This,
                                      /* [out] */ ULONG *iidCount,
  ...
  HRESULT(STDMETHODCALLTYPE *GetTrustLevel)(IDragDropManagerInterop *This,
                                            /* [out] */ TrustLevel *trustLevel);

  DECLSPEC_XFGVIRT(IDragDropManagerInterop, GetForWindow)
  HRESULT(STDMETHODCALLTYPE *GetForWindow)(IDragDropManagerInterop *This,
                                           /* [in] */ HWND hwnd,
                                           /* [in] */ REFIID riid,
                                           /* [iid_is][out] */ void **ppv);
