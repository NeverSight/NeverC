...
inline Status GetImageDecodersSize(
...
inline Status GetImageDecoders(_In_ UINT numDecoders, _In_ UINT size,
                               _Out_writes_bytes_(size)
                                   ImageCodecInfo *decoders) {
  return DllExports::GdipGetImageDecoders(numDecoders, size, decoders);
}

inline Status GetImageEncodersSize(
...
inline Status GetImageEncoders(_In_ UINT numEncoders, _In_ IN UINT size,
                               _Out_writes_bytes_(size)
