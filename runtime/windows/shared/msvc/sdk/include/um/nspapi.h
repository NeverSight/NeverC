...
//
typedef VOID (*LPSERVICE_CALLBACK_PROC)(_In_ LPARAM lParam,
...
//
INT APIENTRY EnumProtocolsA(_In_opt_ LPINT lpiProtocols,
...
// Public NSP API prototypes.
//
INT APIENTRY EnumProtocolsW(_In_opt_ LPINT lpiProtocols,
                            _Out_writes_bytes_(*lpdwBufferLength)
                                LPVOID lpProtocolBuffer,
                            _Inout_ LPDWORD lpdwBufferLength);
#ifdef UNICODE
...
INT APIENTRY GetAddressByNameA(
    _In_ DWORD dwNameSpace, _In_ LPGUID lpServiceType,
    _In_opt_ LPSTR lpServiceName, _In_opt_ LPINT lpiProtocols,
    _In_ DWORD dwResolution, _In_opt_ LPSERVICE_ASYNC_INFO lpServiceAsyncInfo,
...
INT APIENTRY GetAddressByNameW(
    _In_ DWORD dwNameSpace, _In_ LPGUID lpServiceType,
    _In_opt_ LPWSTR lpServiceName, _In_opt_ LPINT lpiProtocols,
    _In_ DWORD dwResolution, _In_opt_ LPSERVICE_ASYNC_INFO lpServiceAsyncInfo,
    _Out_writes_bytes_(*lpdwBufferLength) LPVOID lpCsaddrBuffer,
    _Inout_ LPDWORD lpdwBufferLength,
...
INT APIENTRY GetTypeByNameA(_In_ LPSTR lpServiceName,
                            _Inout_ LPGUID lpServiceType);
INT APIENTRY GetTypeByNameW(_In_ LPWSTR lpServiceName,
                            _Inout_ LPGUID lpServiceType);
#ifdef UNICODE
...
INT APIENTRY GetNameByTypeA(_In_ LPGUID lpServiceType,
                            _Out_writes_bytes_(dwNameLength)
                                LPSTR lpServiceName,
                            _In_ DWORD dwNameLength);
INT APIENTRY GetNameByTypeW(_In_ LPGUID lpServiceType,
                            _Out_writes_bytes_(dwNameLength)
                                LPWSTR lpServiceName,
                            _In_ DWORD dwNameLength);
#ifdef UNICODE
...
INT APIENTRY SetServiceA(_In_ DWORD dwNameSpace, _In_ DWORD dwOperation,
                         _In_ DWORD dwFlags, _In_ LPSERVICE_INFOA lpServiceInfo,
                         _In_opt_ LPSERVICE_ASYNC_INFO lpServiceAsyncInfo,
                         _Out_ LPDWORD lpdwStatusFlags);
INT APIENTRY SetServiceW(_In_ DWORD dwNameSpace, _In_ DWORD dwOperation,
                         _In_ DWORD dwFlags, _In_ LPSERVICE_INFOW lpServiceInfo,
                         _In_opt_ LPSERVICE_ASYNC_INFO lpServiceAsyncInfo,
                         _Out_ LPDWORD lpdwStatusFlags);
#ifdef UNICODE
...
INT APIENTRY GetServiceA(_In_ DWORD dwNameSpace, _In_ LPGUID lpGuid,
                         _In_ LPSTR lpServiceName, _In_ DWORD dwProperties,
                         _Out_writes_bytes_(*lpdwBufferSize) LPVOID lpBuffer,
                         _Inout_ LPDWORD lpdwBufferSize,
                         _In_opt_ LPSERVICE_ASYNC_INFO lpServiceAsyncInfo);
INT APIENTRY GetServiceW(_In_ DWORD dwNameSpace, _In_ LPGUID lpGuid,
                         _In_ LPWSTR lpServiceName, _In_ DWORD dwProperties,
                         _Out_writes_bytes_(*lpdwBufferSize) LPVOID lpBuffer,
                         _Inout_ LPDWORD lpdwBufferSize,
                         _In_opt_ LPSERVICE_ASYNC_INFO lpServiceAsyncInfo);
#ifdef UNICODE
