...
#pragma pack(push, 1)
DEFINE_GUID(OPM_GET_CURRENT_HDCP_SRM_VERSION, 0x99c5ceff, 0x5f1d, 0x4879, 0x81,
            0xc1, 0xc5, 0x24, 0x43, 0xc9, 0x48, 0x2b);
DEFINE_GUID(OPM_GET_CONNECTED_HDCP_DEVICE_INFORMATION, 0x0db59d74, 0xa992,
            0x492e, 0xa0, 0xbd, 0xc2, 0x3f, 0xda, 0x56, 0x4e, 0x00);
DEFINE_GUID(OPM_GET_ACP_AND_CGMSA_SIGNALING, 0x6629a591, 0x3b79, 0x4cf3, 0x92,
            0x4a, 0x11, 0xe8, 0xe7, 0x81, 0x16, 0x71);
DEFINE_GUID(OPM_GET_CONNECTOR_TYPE, 0x81d0bfd5, 0x6afe, 0x48c2, 0x99, 0xc0,
            0x95, 0xa0, 0x8f, 0x97, 0xc5, 0xda);
DEFINE_GUID(OPM_GET_SUPPORTED_PROTECTION_TYPES, 0x38f2a801, 0x9a6c, 0x48bb,
            0x91, 0x07, 0xb6, 0x69, 0x6e, 0x6f, 0x17, 0x97);
DEFINE_GUID(OPM_GET_VIRTUAL_PROTECTION_LEVEL, 0xb2075857, 0x3eda, 0x4d5d, 0x88,
            0xdb, 0x74, 0x8f, 0x8c, 0x1a, 0x05, 0x49);
DEFINE_GUID(OPM_GET_ACTUAL_PROTECTION_LEVEL, 0x1957210a, 0x7766, 0x452a, 0xb9,
            0x9a, 0xd2, 0x7a, 0xed, 0x54, 0xf0, 0x3a);
DEFINE_GUID(OPM_GET_ACTUAL_OUTPUT_FORMAT, 0xd7bf1ba3, 0xad13, 0x4f8e, 0xaf,
            0x98, 0x0d, 0xcb, 0x3c, 0xa2, 0x04, 0xcc);
DEFINE_GUID(OPM_GET_ADAPTER_BUS_TYPE, 0xc6f4d673, 0x6174, 0x4184, 0x8e, 0x35,
            0xf6, 0xdb, 0x52, 0x0, 0xbc, 0xba);
DEFINE_GUID(OPM_GET_OUTPUT_ID, 0x72cb6df3, 0x244f, 0x40ce, 0xb0, 0x9e, 0x20,
            0x50, 0x6a, 0xf6, 0x30, 0x2f);
DEFINE_GUID(OPM_GET_DVI_CHARACTERISTICS, 0xa470b3bb, 0x5dd7, 0x4172, 0x83, 0x9c,
            0x3d, 0x37, 0x76, 0xe0, 0xeb, 0xf5);
DEFINE_GUID(OPM_GET_CODEC_INFO, 0x4f374491, 0x8f5f, 0x4445, 0x9d, 0xba, 0x95,
            0x58, 0x8f, 0x6b, 0x58, 0xb4);
DEFINE_GUID(OPM_GET_OUTPUT_HARDWARE_PROTECTION_SUPPORT, 0x3b129589, 0x2af8,
            0x4ef0, 0x96, 0xa2, 0x70, 0x4a, 0x84, 0x5a, 0x21, 0x8e);
DEFINE_GUID(OPM_SET_PROTECTION_LEVEL, 0x9bb9327c, 0x4eb5, 0x4727, 0x9f, 0x00,
            0xb4, 0x2b, 0x09, 0x19, 0xc0, 0xda);
DEFINE_GUID(OPM_SET_ACP_AND_CGMSA_SIGNALING, 0x09a631a5, 0xd684, 0x4c60, 0x8e,
            0x4d, 0xd3, 0xbb, 0x0f, 0x0b, 0xe3, 0xee);
DEFINE_GUID(OPM_SET_HDCP_SRM, 0x8b5ef5d1, 0xc30d, 0x44ff, 0x84, 0xa5, 0xea,
            0x71, 0xdc, 0xe7, 0x8f, 0x13);
...
DEFINE_GUID(IID_IOPMVideoOutput, 0x0A15159D, 0x41C7, 0x4456, 0x93, 0xE1, 0x28,
            0x4C, 0xD6, 0x1D, 0x4E, 0x8D);
...
public:
  ...
  virtual HRESULT STDMETHODCALLTYPE Configure(
      ...
      /* [annotation][in] */
      _In_reads_bytes_opt_(ulAdditionalParametersSize)
...
typedef struct IOPMVideoOutputVtbl {
  ...
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(IOPMVideoOutput *This,
                                             /* [in] */ REFIID riid,
...
interface IOPMVideoOutput { CONST_VTBL struct IOPMVideoOutputVtbl *lpVtbl; };
...
DEFINE_GUIDSTRUCT("06F414BB-F43A-4fe2-A566-774B4C81F0DB",
...
typedef enum {
  ...
  //  Use KsMethod - both input and output in the buffer (not after the KSMETHOD
  //  structure)
  KSMETHOD_OPMVIDEOOUTPUT_GETINFORMATION = 2
} KSMETHOD_OPMVIDEOOUTPUT;
#endif
#define GetBusType(ulBusTypeAndImplementation)                                 \
  ((ulBusTypeAndImplementation) & OPM_BUS_TYPE_MASK)
#define GetBusImplementation(ulBusTypeAndImplementation)                       \
  (((ulBusTypeAndImplementation) & OPM_BUS_IMPLEMENTATION_MODIFIER_MASK) >> 16)
#define IsNonStandardBusImplementation(ulBusTypeAndImplementation)             \
  ((ulBusTypeAndImplementation) & OPM_BUS_IMPLEMENTATION_MODIFIER_NON_STANDARD)
STDAPI
OPMGetVideoOutputsFromHMONITOR(_In_ HMONITOR hMonitor,
                               _In_ OPM_VIDEO_OUTPUT_SEMANTICS vos,
                               _Out_ ULONG *pulNumVideoOutputs,
                               _Outptr_result_buffer_(*pulNumVideoOutputs)
                                   IOPMVideoOutput ***pppOPMVideoOutputArray);
STDAPI
OPMGetVideoOutputForTarget(_In_ LUID *pAdapterLuid, _In_ ULONG VidPnTarget,
                           _In_ OPM_VIDEO_OUTPUT_SEMANTICS vos,
...
STDAPI OPMGetVideoOutputsFromIDirect3DDevice9Object(
    ...
    _In_ OPM_VIDEO_OUTPUT_SEMANTICS vos, _Out_ ULONG *pulNumVideoOutputs,
    _Outptr_result_buffer_(*pulNumVideoOutputs)
        IOPMVideoOutput ***pppOPMVideoOutputArray);
#endif // DO_NOT_USE_DIRECTX_OR_DXVA2
#pragma pack(pop)
