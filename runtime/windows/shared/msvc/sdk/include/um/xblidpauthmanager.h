...
typedef enum _XBL_IDP_AUTH_TOKEN_STATUS {
  ...
  XBL_IDP_AUTH_TOKEN_STATUS_OFFLINE_SUCCESS =
      (XBL_IDP_AUTH_TOKEN_STATUS_SUCCESS + 1),
  ...
  XBL_IDP_AUTH_TOKEN_STATUS_XBOX_VETO =
      (XBL_IDP_AUTH_TOKEN_STATUS_LOAD_MSA_ACCOUNT_FAILED + 1),
  XBL_IDP_AUTH_TOKEN_STATUS_MSA_INTERRUPT =
      (XBL_IDP_AUTH_TOKEN_STATUS_XBOX_VETO + 1),
  XBL_IDP_AUTH_TOKEN_STATUS_OFFLINE_NO_CONSENT =
      (XBL_IDP_AUTH_TOKEN_STATUS_MSA_INTERRUPT + 1),
  XBL_IDP_AUTH_TOKEN_STATUS_VIEW_NOT_SET =
      (XBL_IDP_AUTH_TOKEN_STATUS_OFFLINE_NO_CONSENT + 1),
...
public:
  ...
  virtual HRESULT STDMETHODCALLTYPE GetTokenAndSignatureWithTokenResult(
      ...
      /* [size_is][unique][in] */ __RPC__in_ecount_full_opt(bodySize) BYTE *
          body,
      /* [in] */ DWORD bodySize,
...
typedef struct IXblIdpAuthManagerVtbl {
  ...
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in IXblIdpAuthManager *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IXblIdpAuthManager *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IXblIdpAuthManager *This);
...
#define IXblIdpAuthManager_GetTokenAndSignatureWithTokenResult(                \
    This, msaAccountId, appSid, msaTarget, msaPolicy, httpMethod, uri,         \
    headers, body, bodySize, forceRefresh, result)                             \
  ((This)->lpVtbl->GetTokenAndSignatureWithTokenResult(                        \
      This, msaAccountId, appSid, msaTarget, msaPolicy, httpMethod, uri,       \
      headers, body, bodySize, forceRefresh, result))
...
typedef struct IXblIdpAuthManager2Vtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IXblIdpAuthManager2 *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IXblIdpAuthManager2 *This);

  DECLSPEC_XFGVIRT(IXblIdpAuthManager2,
...
#define IXblIdpAuthManager2_AddRef(This) ((This)->lpVtbl->AddRef(This))

#define IXblIdpAuthManager2_Release(This) ((This)->lpVtbl->Release(This))

#define IXblIdpAuthManager2_GetUserlessTokenAndSignatureWithTokenResult(       \
    This, appSid, msaTarget, msaPolicy, httpMethod, uri, headers, body,        \
    bodySize, forceRefresh, result)                                            \
  ((This)->lpVtbl->GetUserlessTokenAndSignatureWithTokenResult(                \
      This, appSid, msaTarget, msaPolicy, httpMethod, uri, headers, body,      \
      bodySize, forceRefresh, result))
...
typedef struct IXblIdpAuthTokenResultVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IXblIdpAuthTokenResult *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IXblIdpAuthTokenResult *This);
...
typedef struct IXblIdpAuthTokenResult2Vtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IXblIdpAuthTokenResult2 *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IXblIdpAuthTokenResult2 *This);
