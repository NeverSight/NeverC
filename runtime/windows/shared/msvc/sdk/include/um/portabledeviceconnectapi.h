...
// Property set by the MTP Bluetooth Enumerator indicate whether the device is
// connected DEVPKEY_MTPBTH_IsConnected, DEVPROP_TYPE_BOOLEAN
//
// {ea1237fa-589d-4472-84e4-0abe36fd62ef}.2
DEFINE_DEVPROPKEY(DEVPKEY_MTPBTH_IsConnected, 0xea1237fa, 0x589d, 0x4472, 0x84,
                  0xe4, 0x0a, 0xbe, 0x36, 0xfd, 0x62, 0xef, 2);

extern RPC_IF_HANDLE
    __MIDL_itf_PortableDeviceConnectApi_0000_0000_v0_0_c_ifspec;
extern RPC_IF_HANDLE
    __MIDL_itf_PortableDeviceConnectApi_0000_0000_v0_0_s_ifspec;
...
public:
  virtual HRESULT STDMETHODCALLTYPE Next(
      ...
      __RPC__out_ecount_part(cRequested, *pcFetched) IPortableDeviceConnector *
          *pConnectors,
  ...
  virtual HRESULT STDMETHODCALLTYPE Clone(
      /* [out] */ __RPC__deref_out_opt IEnumPortableDeviceConnectors *
      *ppEnum) = 0;
};
...
typedef struct IEnumPortableDeviceConnectorsVtbl {
  ...
  HRESULT(STDMETHODCALLTYPE *Next)(
      ...
      /* [in] */ UINT32 cRequested,
      /* [length_is][size_is][out] */
      __RPC__out_ecount_part(cRequested, *pcFetched)
...
#define IEnumPortableDeviceConnectors_Next(This, cRequested, pConnectors,      \
                                           pcFetched)                          \
...
typedef struct IPortableDeviceConnectorVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IPortableDeviceConnector *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IPortableDeviceConnector *This);
...
#define IPortableDeviceConnector_GetProperty(This, pPropertyKey,               \
                                             pPropertyType, ppData, pcbData)   \
  ((This)->lpVtbl->GetProperty(This, pPropertyKey, pPropertyType, ppData,      \
                               pcbData))

#define IPortableDeviceConnector_SetProperty(This, pPropertyKey, PropertyType, \
                                             pData, cbData)                    \
...
typedef struct IConnectionRequestCallbackVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IConnectionRequestCallback *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IConnectionRequestCallback *This);
...
extern RPC_IF_HANDLE
    __MIDL_itf_PortableDeviceConnectApi_0000_0004_v0_0_c_ifspec;
extern RPC_IF_HANDLE
    __MIDL_itf_PortableDeviceConnectApi_0000_0004_v0_0_s_ifspec;
