...
// For more information on the ICU breaking change to use char16_t by default,
// please see the page here: https://go.microsoft.com/fwlink/?linkid=851033

#pragma message(                                                               \
    "The wchar_t versions of the ICU headers are no longer being updated, please use the char16_t based header icu.h instead; see https://go.microsoft.com/fwlink/?linkid=851033 for more info. To suppress this warning, define the macro SUPPRESS_LEGACY_ICU_HEADER_WARNINGS before including this header.")
...
typedef enum UTimeZoneFormatStyle {
   ...
   * or the UTC indicator. For example, "-0500", "+052538", and "Z"(UTC). This
   * style is equivalent to the LDML date format pattern "XXXX".
   * @stable ICU 51
   */
   ...
   * "Z"(UTC). This style is equivalent to the LDML date format pattern "XXXXX".
   * @stable ICU 51
   */
...
enum UCalendarDateFields {
   ...
   * <em>exactly</em> like a composite of all time-related fields, not including
   * the zone fields.  As such, it also reflects discontinuities of those fields
   * on DST transition days.  On a day of DST onset, it will jump forward.  On a
   * day of DST cessation, it will jump backward.  This reflects the fact that
   * it must be combined with the DST_OFFSET field to obtain a unique local time
   * value.
   * @stable ICU 2.8
   */
  ...
  /**
   * Whether or not the current month is a leap month (0 or 1). See the Chinese
   * calendar for an example of this.
   */
  UCAL_IS_LEAP_MONTH,
 ...
 * @stable ICU 2.0
 */
U_STABLE UCalendar *U_EXPORT2 ucal_open(const UChar *zoneID, int32_t len,
 ...
 * @stable ICU 2.0
 */
U_STABLE void U_EXPORT2 ucal_setTimeZone(UCalendar *cal, const UChar *zoneID,
 ...
 * @stable ICU 3.6
 */
U_STABLE void U_EXPORT2 ucal_setGregorianChange(UCalendar *cal, UDate date,
 ...
 * @stable ICU 2.0
 */
U_STABLE void U_EXPORT2 ucal_setMillis(UCalendar *cal, UDate dateTime,
                                       UErrorCode *status);
 ...
 * @stable ICU 2.0
 */
U_STABLE void U_EXPORT2 ucal_setDate(UCalendar *cal, int32_t year,
 ...
 * @stable ICU 2.0
 */
U_STABLE void U_EXPORT2 ucal_setDateTime(UCalendar *cal, int32_t year,
                                         int32_t month, int32_t date,
 ...
 * @stable ICU 2.0
 */
U_STABLE void U_EXPORT2 ucal_add(UCalendar *cal, UCalendarDateFields field,
 ...
 * @stable ICU 2.0
 */
U_STABLE void U_EXPORT2 ucal_roll(UCalendar *cal, UCalendarDateFields field,
                                  int32_t amount, UErrorCode *status);
 ...
 * @stable ICU 2.0
 */
U_STABLE void U_EXPORT2 ucal_set(UCalendar *cal, UCalendarDateFields field,
                                 int32_t value);
 ...
 * @stable ICU 4.0
 */
U_STABLE int32_t U_EXPORT2 ucal_getCanonicalTimeZoneID(
 ...
 * @stable ICU 4.4
 */
U_STABLE UCalendarWeekdayType U_EXPORT2 ucal_getDayOfWeekType(
    const UCalendar *cal, UCalendarDaysOfWeek dayOfWeek, UErrorCode *status);
 ...
 * @stable ICU 4.4
 */
U_STABLE int32_t U_EXPORT2 ucal_getWeekendTransition(
    const UCalendar *cal, UCalendarDaysOfWeek dayOfWeek, UErrorCode *status);
 ...
 * @stable ICU 4.4
 */
U_STABLE UBool U_EXPORT2 ucal_isWeekend(const UCalendar *cal, UDate date,
                                        UErrorCode *status);
 ...
 * @stable ICU 4.8
 */
U_STABLE int32_t U_EXPORT2 ucal_getFieldDifference(UCalendar *cal, UDate target,
                                                   UCalendarDateFields field,
                                                   UErrorCode *status);
 ...
 * @stable ICU 50
 */
U_STABLE UBool U_EXPORT2 ucal_getTimeZoneTransitionDate(
 ...
 * @stable ICU 52
 */
U_STABLE int32_t U_EXPORT2 ucal_getTimeZoneIDForWindowsID(
 ...
 * @stable ICU 2.0
 */
U_STABLE UCollator *U_EXPORT2 ucol_openRules(
 ...
 * @stable ICU 3.4
 */
U_STABLE void U_EXPORT2 ucol_getContractionsAndExpansions(const UCollator *coll,
                                                          USet *contractions,
                                                          USet *expansions,
                                                          UBool addPrefixes,
                                                          UErrorCode *status);
 ...
 * @stable ICU 2.0
 */
U_STABLE UBool U_EXPORT2 ucol_equal(const UCollator *coll, const UChar *source,
...
ucol_getEquivalentReorderCodes(int32_t reorderCode, int32_t *dest,
...
U_STABLE int32_t U_EXPORT2 ucol_getFunctionalEquivalent(
    char *result, int32_t resultCapacity, const char *keyword,
...
U_STABLE int32_t U_EXPORT2 ucol_getBound(const uint8_t *source,
                                         ...
                                         uint32_t noOfLevels, uint8_t *result,
                                         int32_t resultLength,
                                         UErrorCode *status);
...
U_STABLE int32_t U_EXPORT2 ucol_mergeSortkeys(const uint8_t *src1,
                                              int32_t src1Length,
                                              const uint8_t *src2,
                                              int32_t src2Length, uint8_t *dest,
                                              int32_t destCapacity);
 ...
 * @stable ICU 2.0
 */
U_STABLE void U_EXPORT2 ucol_setAttribute(UCollator *coll, UColAttribute attr,
...
U_STABLE int32_t U_EXPORT2 ucol_getRulesEx(const UCollator *coll,
                                           UColRuleOption delta, UChar *buffer,
                                           int32_t bufferLen);
 ...
 * @stable ICU 2.0
 */
U_STABLE int32_t U_EXPORT2 ucol_getMaxExpansion(const UCollationElements *elems,
                                                int32_t order);
 ...
 * @stable ICU 3.6
 */
U_STABLE const UCharsetMatch **U_EXPORT2 ucsdet_detectAll(
    UCharsetDetector *ucsd, int32_t *matchesFound, UErrorCode *status);
 ...
 *  @stable ICU 3.6
 */
U_STABLE UEnumeration *U_EXPORT2 ucsdet_getAllDetectableCharsets(
    const UCharsetDetector *ucsd, UErrorCode *status);
 ...
 */
U_STABLE int32_t U_EXPORT2
udtitvfmt_format(const UDateIntervalFormat *formatter, UDate fromDate,
                 UDate toDate, UChar *result, int32_t resultCapacity,
...
U_STABLE int32_t U_EXPORT2 udatpg_getBestPattern(
    UDateTimePatternGenerator *dtpg, const UChar *skeleton, int32_t length,
 ...
 * @stable ICU 4.4
 */
U_STABLE int32_t U_EXPORT2 udatpg_getBestPatternWithOptions(
    UDateTimePatternGenerator *dtpg, const UChar *skeleton, int32_t length,
    UDateTimePatternMatchOptions options, UChar *bestPattern, int32_t capacity,
    UErrorCode *pErrorCode);
...
U_STABLE int32_t U_EXPORT2 udatpg_getSkeleton(
    UDateTimePatternGenerator *unusedDtpg, const UChar *pattern, int32_t length,
    UChar *skeleton, int32_t capacity, UErrorCode *pErrorCode);
 ...
 * @stable ICU 3.8
 */
U_STABLE int32_t U_EXPORT2 udatpg_getBaseSkeleton(
    UDateTimePatternGenerator *unusedDtpg, const UChar *pattern, int32_t length,
    UChar *baseSkeleton, int32_t capacity, UErrorCode *pErrorCode);
 ...
 * @stable ICU 3.8
 */
U_STABLE UDateTimePatternConflict U_EXPORT2 udatpg_addPattern(
    UDateTimePatternGenerator *dtpg, const UChar *pattern,
    int32_t patternLength, UBool override, UChar *conflictingPattern,
    int32_t capacity, int32_t *pLength, UErrorCode *pErrorCode);
 ...
 * @stable ICU 3.8
 */
U_STABLE void U_EXPORT2 udatpg_setAppendItemFormat(
    UDateTimePatternGenerator *dtpg, UDateTimePatternField field,
 ...
 * @stable ICU 3.8
 */
U_STABLE void U_EXPORT2 udatpg_setAppendItemName(
    UDateTimePatternGenerator *dtpg, UDateTimePatternField field,
    const UChar *value, int32_t length);
 ...
 * @stable ICU 3.8
 */
U_STABLE const UChar *U_EXPORT2 udatpg_getDateTimeFormat(
    const UDateTimePatternGenerator *dtpg, int32_t *pLength);
 ...
 * @stable ICU 3.8
 */
U_STABLE int32_t U_EXPORT2 udatpg_replaceFieldTypes(
    UDateTimePatternGenerator *dtpg, const UChar *pattern,
    int32_t patternLength, const UChar *skeleton, int32_t skeletonLength,
 ...
 * @stable ICU 4.4
 */
U_STABLE int32_t U_EXPORT2 udatpg_replaceFieldTypesWithOptions(
    UDateTimePatternGenerator *dtpg, const UChar *pattern,
    int32_t patternLength, const UChar *skeleton, int32_t skeletonLength,
    UDateTimePatternMatchOptions options, UChar *dest, int32_t destCapacity,
    UErrorCode *pErrorCode);
 ...
 * @stable ICU 3.8
 */
U_STABLE UEnumeration *U_EXPORT2 udatpg_openSkeletons(
    const UDateTimePatternGenerator *dtpg, UErrorCode *pErrorCode);
 ...
 * @stable ICU 3.8
 */
U_STABLE UEnumeration *U_EXPORT2 udatpg_openBaseSkeletons(
    const UDateTimePatternGenerator *dtpg, UErrorCode *pErrorCode);
 ...
 * @stable ICU 3.8
 */
U_STABLE const UChar *U_EXPORT2 udatpg_getPatternForSkeleton(
    const UDateTimePatternGenerator *dtpg, const UChar *skeleton,
    int32_t skeletonLength, int32_t *pLength);
...
typedef enum UFormattableType {
  UFMT_DATE =
      0, /**< ufmt_getDate() will return without conversion. @see ufmt_getDate*/
 ...
 */
U_STABLE const UChar *U_EXPORT2 ufmt_getUChars(UFormattable *fmt, int32_t *len,
                                               UErrorCode *status);
...
ulocdata_getExemplarSet(ULocaleData *uld, USet *fillIn, uint32_t options,
                        ULocaleDataExemplarSetType extype, UErrorCode *status);
 ...
 */
U_STABLE int32_t U_EXPORT2
ulocdata_getLocaleDisplayPattern(ULocaleData *uld, UChar *pattern,
                                 int32_t patternCapacity, UErrorCode *status);
 ...
 */
U_STABLE int32_t U_EXPORT2
ulocdata_getLocaleSeparator(ULocaleData *uld, UChar *separator,
                            int32_t separatorCapacity, UErrorCode *status);
#endif
...
U_STABLE int32_t U_EXPORT2 u_formatMessage(const char *locale,
                                           const UChar *pattern,
                                           int32_t patternLength, UChar *result,
                                           int32_t resultLength,
                                           UErrorCode *status, ...);
 ...
 * @stable ICU 2.0
 */
U_STABLE void U_EXPORT2 u_parseMessage(const char *locale, const UChar *pattern,
                                       int32_t patternLength,
                                       const UChar *source,
 ...
 * @stable ICU 2.0
 */
U_STABLE void U_EXPORT2 u_vparseMessage(
    const char *locale, const UChar *pattern, int32_t patternLength,
    const UChar *source, int32_t sourceLength, va_list ap, UErrorCode *status);
 ...
 * @stable ICU 2.0
 */
U_STABLE int32_t U_EXPORT2 u_formatMessageWithError(
    const char *locale, const UChar *pattern, int32_t patternLength,
    UChar *result, int32_t resultLength, UParseError *parseError,
    UErrorCode *status, ...);
 ...
 * @stable ICU 2.0
 */
U_STABLE int32_t U_EXPORT2 u_vformatMessageWithError(
    const char *locale, const UChar *pattern, int32_t patternLength,
    UChar *result, int32_t resultLength, UParseError *parseError, va_list ap,
    UErrorCode *status);
 ...
 * @stable ICU 2.0
 */
U_STABLE void U_EXPORT2 u_parseMessageWithError(
    const char *locale, const UChar *pattern, int32_t patternLength,
    const UChar *source, int32_t sourceLength, UParseError *parseError,
    UErrorCode *status, ...);
 ...
 * @stable ICU 2.0
 */
U_STABLE void U_EXPORT2 u_vparseMessageWithError(
    const char *locale, const UChar *pattern, int32_t patternLength,
    const UChar *source, int32_t sourceLength, va_list ap,
    UParseError *parseError, UErrorCode *status);
 ...
 * @stable ICU 2.0
 */
U_STABLE int32_t U_EXPORT2 umsg_format(const UMessageFormat *fmt, UChar *result,
...
typedef enum UNumberFormatStyle {
   ...
   * using unum_setTextAttribute with UNUM_DEFAULT_RULESET; the available public
   * rulesets can be listed using unum_getTextAttribute with
 ...
 * @stable ICU 2.0
 */
U_STABLE int32_t U_EXPORT2 unum_format(const UNumberFormat *fmt, int32_t number,
                                       UChar *result, int32_t resultLength,
...
unum_formatDouble(const UNumberFormat *fmt, double number, UChar *result,
                  int32_t resultLength, UFieldPosition *pos, /* 0 if ignore */
                  UErrorCode *status);
 ...
 * @stable ICU 4.4
 */
U_STABLE int32_t U_EXPORT2 unum_formatDecimal(
    const UNumberFormat *fmt, const char *number, int32_t length, UChar *result,
    int32_t resultLength, UFieldPosition *pos, /* 0 if ignore */
    UErrorCode *status);
...
U_STABLE int32_t U_EXPORT2 unum_formatDoubleCurrency(
    const UNumberFormat *fmt, double number, UChar *currency, UChar *result,
...
U_STABLE int32_t U_EXPORT2 unum_formatUFormattable(
    const UNumberFormat *fmt, const UFormattable *number, UChar *result,
    int32_t resultLength, UFieldPosition *pos, UErrorCode *status);
...
unum_parseDoubleCurrency(const UNumberFormat *fmt, const UChar *text,
                         int32_t textLength, int32_t *parsePos, /* 0 = start */
 ...
 * @stable ICU 52
 */
U_STABLE UFormattable *U_EXPORT2 unum_parseToUFormattable(
    const UNumberFormat *fmt, UFormattable *result, const UChar *text,
    int32_t textLength, int32_t *parsePos, /* 0 = start */
    UErrorCode *status);
...
U_STABLE void U_EXPORT2 unum_applyPattern(UNumberFormat *format,
                                          UBool localized, const UChar *pattern,
                                          int32_t patternLength,
                                          UParseError *parseError,
                                          UErrorCode *status);
...
typedef enum UNumberFormatAttribute {
   ...
   * UNUM_NO (skip fastpath), or UNUM_MAYBE (heuristic). This is an internal ICU
   * API. Do not use.
   * @internal
   */
  ...
  /* The following cannot be #ifndef U_HIDE_INTERNAL_API, needed in .h file
   ...
   * truncate a value, set an error status rather than silently truncating. For
   * example,  formatting the value 1234 with 4 max int digits would succeed,
   * but formatting 12345 would fail. There is no effect on parsing. Default: 0
   * (not set)
   * @stable ICU 50
   */
   ...
   * decimal mark the input is required to have one. If this attribute is set to
   * 0, specifies that input does not have to contain a decimal mark. Has no
...
udat_open(UDateFormatStyle timeStyle, UDateFormatStyle dateStyle,
          const char *locale, const UChar *tzID, int32_t tzIDLength,
...
udat_getBooleanAttribute(const UDateFormat *fmt,
                         UDateFormatBooleanAttribute attr, UErrorCode *status);
 ...
 * @stable ICU 55
 */
U_STABLE int32_t U_EXPORT2 udat_formatCalendar(const UDateFormat *format,
                                               UCalendar *calendar,
                                               UChar *result, int32_t capacity,
                                               UFieldPosition *position,
                                               UErrorCode *status);
 ...
 * @stable ICU 55
 */
U_STABLE int32_t U_EXPORT2 udat_formatForFields(
    const UDateFormat *format, UDate dateToFormat, UChar *result,
...
U_STABLE int32_t U_EXPORT2 udat_formatCalendarForFields(
    const UDateFormat *format, UCalendar *calendar, UChar *result,
    int32_t capacity, UFieldPositionIterator *fpositer, UErrorCode *status);
...
U_STABLE void U_EXPORT2 udat_parseCalendar(
    const UDateFormat *format, UCalendar *calendar, const UChar *text,
    int32_t textLength, int32_t *parsePos, UErrorCode *status);
 ...
 * @stable ICU 54
 */
U_STABLE void U_EXPORT2 udat_adoptNumberFormatForFields(
    UDateFormat *fmt, const UChar *fields, UNumberFormat *numberFormatToSet,
    UErrorCode *status);
/**
 ...
 */
U_STABLE void U_EXPORT2
udat_setNumberFormat(UDateFormat *fmt, const UNumberFormat *numberFormatToSet);
/**
 ...
 * @stable ICU 2.0
 */
U_STABLE void U_EXPORT2 udat_set2DigitYearStart(UDateFormat *fmt, UDate d,
                                                UErrorCode *status);
 ...
 * @stable ICU 2.0
 */
U_STABLE void U_EXPORT2 udat_applyPattern(UDateFormat *format, UBool localized,
                                          const UChar *pattern,
                                          int32_t patternLength);
...
U_STABLE int32_t U_EXPORT2 udat_getSymbols(const UDateFormat *fmt,
                                           ...
                                           int32_t symbolIndex, UChar *result,
                                           int32_t resultLength,
                                           UErrorCode *status);
...
U_STABLE void U_EXPORT2 udat_setSymbols(UDateFormat *format,
                                        UDateFormatSymbolType type,
                                        int32_t symbolIndex, UChar *value,
                                        int32_t valueLength,
                                        UErrorCode *status);
 ...
 * @stable ICU 51
 */
U_DRAFT void U_EXPORT2 udat_setContext(UDateFormat *fmt, UDisplayContext value,
                                       UErrorCode *status);
 ...
 * @stable ICU 53
 */
U_STABLE UDisplayContext U_EXPORT2 udat_getContext(const UDateFormat *fmt,
                                                   UDisplayContextType type,
                                                   UErrorCode *status);
 ...
 * @stable ICU 4.8
 */
U_STABLE UPluralRules *U_EXPORT2 uplrules_open(const char *locale,
                                               UErrorCode *status);
 ...
 * @stable ICU 50
 */
U_DRAFT UPluralRules *U_EXPORT2 uplrules_openForType(const char *locale,
                                                     UPluralType type,
                                                     UErrorCode *status);
 ...
 * @stable ICU 4.8
 */
U_STABLE int32_t U_EXPORT2 uplrules_select(const UPluralRules *uplrules,
                                           double number, UChar *keyword,
                                           int32_t capacity,
                                           UErrorCode *status);
 ...
 * @stable ICU 3.0
 */
U_STABLE const UChar *U_EXPORT2 uregex_pattern(const URegularExpression *regexp,
                                               int32_t *patLength,
                                               UErrorCode *status);
 ...
 * @stable ICU 4.6
 */
U_STABLE void U_EXPORT2 uregex_setUText(URegularExpression *regexp, UText *text,
                                        UErrorCode *status);
...
U_STABLE UBool U_EXPORT2 uregex_matches(URegularExpression *regexp,
                                        int32_t startIndex, UErrorCode *status);
 ...
 */
U_STABLE int32_t U_EXPORT2
uregex_groupNumberFromName(URegularExpression *regexp, const UChar *groupName,
 ...
 */
U_STABLE int32_t U_EXPORT2
uregex_groupNumberFromCName(URegularExpression *regexp, const char *groupName,
                            int32_t nameLength, UErrorCode *status);
...
U_STABLE int32_t U_EXPORT2 uregex_start(URegularExpression *regexp,
                                        int32_t groupNum, UErrorCode *status);
 ...
 *    @stable ICU 3.0
 */
U_STABLE void U_EXPORT2 uregex_reset(URegularExpression *regexp, int32_t index,
                                     UErrorCode *status);
...
U_STABLE void U_EXPORT2 uregex_reset64(URegularExpression *regexp,
                                       int64_t index, UErrorCode *status);
 ...
 * @stable ICU 4.0
 */
U_STABLE UBool U_EXPORT2 uregex_hasTransparentBounds(
 ...
 */
U_STABLE UBool U_EXPORT2
uregex_hasAnchoringBounds(const URegularExpression *regexp, UErrorCode *status);
 ...
 *
 */
U_STABLE int32_t U_EXPORT2 uregex_appendReplacement(
    URegularExpression *regexp, const UChar *replacementText,
    int32_t replacementLength, UChar **destBuf, int32_t *destCapacity,
    UErrorCode *status);
 ...
 *   @stable ICU 4.6
 */
U_STABLE void U_EXPORT2 uregex_appendReplacementUText(
    URegularExpression *regexp, UText *replacementText, UText *dest,
    UErrorCode *status);
 ...
 * @stable ICU 4.0
 */
U_STABLE int32_t U_EXPORT2 uregex_getTimeLimit(const URegularExpression *regexp,
                                               UErrorCode *status);
 ...
 * @stable ICU 4.0
 */
U_STABLE void U_EXPORT2 uregex_getMatchCallback(
    const URegularExpression *regexp, URegexMatchCallback **callback,
 ...
 * @stable ICU 4.6
 */
U_STABLE void U_EXPORT2 uregex_setFindProgressCallback(
    URegularExpression *regexp, URegexFindProgressCallback *callback,
    const void *context, UErrorCode *status);
 ...
 * @stable ICU 4.6
 */
U_STABLE void U_EXPORT2 uregex_getFindProgressCallback(
    const URegularExpression *regexp, URegexFindProgressCallback **callback,
    const void **context, UErrorCode *status);
 ...
 * @stable ICU 52
 */
U_STABLE UEnumeration *U_EXPORT2 uregion_getContainedRegionsOfType(
    const URegion *uregion, URegionType type, UErrorCode *status);
...
usearch_open(const UChar *pattern, int32_t patternlength, const UChar *text,
             int32_t textlength, const char *locale, UBreakIterator *breakiter,
             UErrorCode *status);
...
U_STABLE UStringSearch *U_EXPORT2 usearch_openFromCollator(
    const UChar *pattern, int32_t patternlength, const UChar *text,
    int32_t textlength, const UCollator *collator, UBreakIterator *breakiter,
    UErrorCode *status);
 ...
 * @stable ICU 2.4
 */
U_STABLE const UChar *U_EXPORT2 usearch_getPattern(const UStringSearch *strsrch,
                                                   int32_t *length);
 ...
 * confusable. This does not consider whether either of strings is potentially
 ...
 *   -#  Configure the USPoofChecker for the desired set of tests.  The tests
 * that will be performed are specified by a set of USpoofChecks flags.
 *   -#  Perform the checks using the pre-configured USpoofChecker.  The results
 * indicate which (if any) of the selected tests have identified possible
 * problems with the identifier. Results are reported as a set of USpoofChecks
 * flags;  this mirrors the form in which the set of tests to perform was
 * originally specified to the USpoofChecker.
 *
 * A USpoofChecker may be used repeatedly to perform checks on any number of
 * identifiers.
 *
 * Thread Safety: The test functions for checking a single identifier, or for
 * testing whether two identifiers are possible confusable, are thread safe.
 ...
 * non-const USpoofChecier are not thread safe.
 *
 *
 * Descriptions of the available checks.
 *
 * When testing whether pairs of identifiers are confusable, with the
 * uspoof_areConfusable() family of functions, the relevant tests are
 *
 *   -# USPOOF_SINGLE_SCRIPT_CONFUSABLE:  All of the characters from the two
 * identifiers are from a single script, and the two identifiers are visually
 * confusable.
 *   -# USPOOF_MIXED_SCRIPT_CONFUSABLE:  At least one of the identifiers
 * contains characters from more than one script, and the two identifiers are
 * visually confusable.
 *   -# USPOOF_WHOLE_SCRIPT_CONFUSABLE: Each of the two identifiers is of a
 * single script, but the two identifiers are from different scripts, and they
 * are visually confusable.
 *
 * The safest approach is to enable all three of these checks as a group.
 *
 * USPOOF_ANY_CASE is a modifier for the above tests.  If the identifiers being
 * checked can be of mixed case and are used in a case-sensitive manner, this
 * option should be specified.
 *
 * If the identifiers being checked are used in a case-insensitive manner, and
 * if they are displayed to users in lower-case form only, the USPOOF_ANY_CASE
 * option should not be specified.  Confusabality issues involving upper case
 * letters will not be reported.
 *
 * When performing tests on a single identifier, with the uspoof_check() family
 * of functions, the relevant tests are:
 *
 *    -# USPOOF_MIXED_SCRIPT_CONFUSABLE: the identifier contains characters from
 * multiple scripts, and there exists an identifier of a single script that is
 * visually confusable.
 *    -# USPOOF_WHOLE_SCRIPT_CONFUSABLE: the identifier consists of characters
 * from a single script, and there exists a visually confusable identifier. The
 * visually confusable identifier also consists of characters from a single
 * script. but not the same script as the identifier being checked.
 *    -# USPOOF_ANY_CASE: modifies the mixed script and whole script confusables
 * tests.  If specified, the checks will consider confusable characters of any
 * case.  If this flag is not set, the test is performed assuming case folded
 * identifiers.
 *    -# USPOOF_SINGLE_SCRIPT: check that the identifier contains only
 * characters from a single script.  (Characters from the 'common' and
 * 'inherited' scripts are ignored.) This is not a test for confusable
 * identifiers
 *    -# USPOOF_INVISIBLE: check an identifier for the presence of invisible
 ...
 * This check does not test the input string as a whole for conformance to any
 * particular syntax for identifiers.
 *    -# USPOOF_CHAR_LIMIT: check that an identifier contains only characters
 * from a specified set of acceptable characters.  See uspoof_setAllowedChars()
 * and uspoof_setAllowedLocales().
 *
 *  Note on Scripts:
 *     Characters from the Unicode Scripts "Common" and "Inherited" are ignored
 * when considering the script of an identifier. Common characters include
 * digits and symbols that are normally used with text from more than one
 * script.
 *
 *  Identifier Skeletons:  A skeleton is a transformation of an identifier, such
 * that all identifiers that are confusable with each other have the same
 * skeleton. Using skeletons, it is possible to build a dictionary data
 * structure for a set of identifiers, and then quickly test whether a new
 * identifier is confusable with an identifier already in the set.  The
 * uspoof_getSkeleton() family of functions will produce the skeleton from an
 * identifier.
 *
 *  Note that skeletons are not guaranteed to be stable between versions
 *  of Unicode or ICU, so an applications should not rely on creating a
 * permanent, or difficult to update, database of skeletons.  Instabilities
 * result from identifying new pairs or sequences of characters that are
 * visually confusable, and thus must be mapped to the same skeleton
 * character(s).
 *
 *  Skeletons are computed using the algorithm and data describe in Unicode
 * UAX 39. The latest proposed update, UAX 39 Version 8 draft 1, says "the
 * tables SL, SA, and ML were still problematic, and discouraged from use in
 * [Uniocde] 7.0. They were thus removed from version 8.0"
 *
 ...
 *  (Single Script, Any Case), (Single Script, Lower Case) and (Multi Script,
 * Lower Case).
 */
...
typedef enum USpoofChecks {
   ...
   *   When testing whether two identifiers are confusable, report that they are
   * if both are from the same script and they are visually confusable. Note:
   * this test is not applicable to a check of a single identifier.
   */
   ...
   *  When testing whether two identifiers are confusable, report that they are
   * if the two IDs are visually confusable, and at least one contains
   ...
   *  When testing whether two identifiers are confusable, report that they are
   * if each is of a single script, the scripts of the two identifiers are
   * different, and the identifiers are visually confusable.
   */
  USPOOF_WHOLE_SCRIPT_CONFUSABLE = 4,

  /** Any Case Modifier for confusable identifier tests.
      If specified, consider all characters, of any case, when looking for
     confusables. If USPOOF_ANY_CASE is not specified, identifiers being checked
     are assumed to have been case folded.  Upper case confusable characters
     will not be checked. Selects between Lower Case Confusable and Any Case
     Confusable.   */
  USPOOF_ANY_CASE = 8,

  /**
   * Check that an identifier is no looser than the specified RestrictionLevel.
   * The default if uspoof_setRestrctionLevel() is not called is
   * HIGHLY_RESTRICTIVE.
   *
   ...
   *
   * If this "check" is not enabled, the results of uspoof_check() will be zero
   * when an identifier passes all of the enabled checks.
   *
   * If this "check" is enabled, (uspoof_check() & USPOOF_ALL_CHECKS) will be
   * zero when an identifier passes all checks.
   *
   * @stable ICU 51
   */
...
typedef enum URestrictionLevel {
   ...
   * combinations: Latin + Han + Hiragana + Katakana; Latin + Han + Bopomofo; or
   * Latin + Han + Hangul. Note that this level will satisfy the vast majority
   * of Latin-script users; also that TR36 has ASCII instead of Latin.
   *
   * @stable ICU 51
   */
  USPOOF_HIGHLY_RESTRICTIVE = 0x30000000,
  /**
   * Allow Latin with other scripts except Cyrillic, Greek, Cherokee Otherwise,
   * the same as Highly Restrictive
   *
   * @stable ICU 51
   */
  USPOOF_MODERATELY_RESTRICTIVE = 0x40000000,
  /**
   * Allow arbitrary mixtures of scripts. Otherwise, the same as Moderately
   * Restrictive.
   *
   * @stable ICU 51
   */
...
uspoof_openFromSerialized(const void *data, int32_t length,
 ...
 *                    as found in the file confusablesWholeScript.txt from
 * unicode.org.
 * @param confusablesWholeScriptLen The length of the whole script confusables
 * text, or -1 if the input string is zero terminated.
 ...
 * @stable ICU 4.2
 */
U_STABLE USpoofChecker *U_EXPORT2 uspoof_openFromSource(
    const char *confusables, int32_t confusablesLen,
 ...
 *
 */
U_STABLE void U_EXPORT2 uspoof_setChecks(USpoofChecker *sc, int32_t checks,
                                         UErrorCode *status);
 ...
 * @stable ICU 51
 */
U_STABLE void U_EXPORT2 uspoof_setRestrictionLevel(
    USpoofChecker *sc, URestrictionLevel restrictionLevel);
 ...
 *                Originally, the index of the first string position that failed
 * a check. Now, always returns zero. This parameter may be null.
 ...
 */
U_STABLE int32_t U_EXPORT2
uspoof_areConfusable(const USpoofChecker *sc, const UChar *id1, int32_t length1,
                     const UChar *id2, int32_t length2, UErrorCode *status);
 ...
 * @stable ICU 4.2
 */
U_STABLE int32_t U_EXPORT2 uspoof_areConfusableUTF8(
    const USpoofChecker *sc, const char *id1, int32_t length1, const char *id2,
...
U_STABLE int32_t U_EXPORT2 uspoof_getSkeleton(const USpoofChecker *sc,
                                              uint32_t type, const UChar *id,
                                              int32_t length, UChar *dest,
                                              int32_t destCapacity,
                                              UErrorCode *status);
 ...
 * Identifiers, as defined in Unicode UAX #31,
 ...
 * @stable ICU 4.2
 */
U_STABLE int32_t U_EXPORT2 uspoof_serialize(USpoofChecker *sc, void *data,
                                            int32_t capacity,
                                            UErrorCode *status);
...
typedef enum UDateTimeScale {
  ...
  /**
   * Used on Unix systems. Data is <code>int32_t</code> or <code>int64_t</code>.
 ...
 * @stable ICU 2.8
 */
U_STABLE UTransliterator *U_EXPORT2 utrans_openU(
    const UChar *id, int32_t idLength, UTransDirection dir, const UChar *rules,
 ...
 * @stable ICU 2.0
 */
U_STABLE void U_EXPORT2 utrans_transIncremental(const UTransliterator *trans,
                                                UReplaceable *rep,
                                                UReplaceableCallbacks *repFunc,
                                                UTransPosition *pos,
                                                UErrorCode *status);
...
U_STABLE void U_EXPORT2 utrans_transIncrementalUChars(
    const UTransliterator *trans, UChar *text, int32_t *textLength,
    int32_t textCapacity, UTransPosition *pos, UErrorCode *status);
...
U_STABLE USet *U_EXPORT2 utrans_getSourceSet(const UTransliterator *trans,
                                             UBool ignoreFilter, USet *fillIn,
                                             UErrorCode *status);
