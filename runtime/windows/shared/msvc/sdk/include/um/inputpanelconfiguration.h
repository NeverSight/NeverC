...
typedef interface IInputPanelInvocationConfiguration
...
public:
  virtual /* [helpstring] */ HRESULT STDMETHODCALLTYPE EnableFocusTracking(
      void) = 0;
};
...
typedef struct IInputPanelConfigurationVtbl {
  ...
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IInputPanelConfiguration *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IInputPanelConfiguration *This);
...
#define IInputPanelConfiguration_AddRef(This) ((This)->lpVtbl->AddRef(This))

#define IInputPanelConfiguration_Release(This) ((This)->lpVtbl->Release(This))
...
public:
  ...
  RequireTouchInEditControl(void) = 0;
};
...
typedef struct IInputPanelInvocationConfigurationVtbl {
  ...
  DECLSPEC_XFGVIRT(IInputPanelInvocationConfiguration,
...
#define IInputPanelInvocationConfiguration_QueryInterface(This, riid,          \
                                                          ppvObject)           \
  ((This)->lpVtbl->QueryInterface(This, riid, ppvObject))
