...
EXTERN_C typedef HRESULT(STDAPICALLTYPE *LPDAOBINDFUNC)(ULONG cb, DWORD dwUser,
                                                        LPVOID *ppData);
...
// Get rows errors
#define errVtoFetchBuffTooSmall                                                \
  -30028 // 3640	The fetch buffer was too small for the amount of data
         // you requested.
#define errVtoEOFDuringFetch                                                   \
  -30029 // 3641	There are fewer records remaining in the recordset than
         // you requested.
#define errVtoSilentCancel                                                     \
  -30030 // 3642	A cancel was performed on the operation.
#define errVtoRecordDeleted                                                    \
  -30031 // 3643	One of the records in the recordset was deleted by
         // another process.
#define errVtoRowLenTooSmall                                                   \
  -30032 // 3646	The specified row length is shorter than the sum of the
         // column lengths.
#define errVtoBadBindInfo                                                      \
  -30033 // 3645	One of the binding parameters is incorrect.
#define errVtoColumnMissing                                                    \
  -30034 // 3647	A column requested is not being returned to the
         // recordset.
