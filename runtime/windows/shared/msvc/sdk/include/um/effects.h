...
#define FREQUENCY_INDEX(FREQ)                                                  \
  (int)(((FREQ) - kfltTimedLevelMinimumFrequency) /                            \
        (((kfltTimedLevelMaximumFrequency - kfltTimedLevelMinimumFrequency) /  \
          SA_BUFFER_SIZE)))
...
typedef struct IWMPEffectsVtbl {
  ...
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(IWMPEffects *This,
                                             /* [in] */ REFIID riid,
...
interface IWMPEffects { CONST_VTBL struct IWMPEffectsVtbl *lpVtbl; };
...
typedef struct IWMPEffects2Vtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(IWMPEffects2 *This,
                                             /* [in] */ REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);
  ...
  HRESULT(STDMETHODCALLTYPE *SetCore)(IWMPEffects2 *This,
                                      /* [in] */ IWMPCore *pPlayer);

  DECLSPEC_XFGVIRT(IWMPEffects2, Create)
  HRESULT(STDMETHODCALLTYPE *Create)(IWMPEffects2 *This,
                                     /* [in] */ HWND hwndParent);
  ...
  HRESULT(STDMETHODCALLTYPE *NotifyNewMedia)(IWMPEffects2 *This,
                                             /* [in] */ IWMPMedia *pMedia);
  ...
  HRESULT(STDMETHODCALLTYPE *RenderWindowed)(IWMPEffects2 *This,
                                             /* [in] */ TimedLevel *pData,
...
interface IWMPEffects2 { CONST_VTBL struct IWMPEffects2Vtbl *lpVtbl; };
