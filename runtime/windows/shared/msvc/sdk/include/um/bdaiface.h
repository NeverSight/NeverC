...
typedef struct IBDA_NetworkProviderVtbl {
  ...
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IBDA_NetworkProvider *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IBDA_NetworkProvider *This);
...
public:
  ...
  virtual HRESULT STDMETHODCALLTYPE PutMulticastList(
      ...
      /* [size_is][in] */ __RPC__in_ecount_full(ulcbAddresses)
          BYTE pAddressList[]) = 0;

  virtual HRESULT STDMETHODCALLTYPE GetMulticastList(
      /* [out][in] */ __RPC__inout ULONG * pulcbAddresses,
      /* [size_is][out][in] */ __RPC__inout_ecount_full(*pulcbAddresses)
          BYTE pAddressList[]) = 0;
...
typedef struct IBDA_EthernetFilterVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IBDA_EthernetFilter *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IBDA_EthernetFilter *This);
...
public:
  ...
  virtual HRESULT STDMETHODCALLTYPE GetMulticastList(
      /* [out][in] */ __RPC__inout ULONG * pulcbAddresses,
      /* [size_is][out] */ __RPC__out_ecount_full(*pulcbAddresses)
          BYTE pAddressList[]) = 0;
...
typedef struct IBDA_IPV4FilterVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in IBDA_IPV4Filter *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IBDA_IPV4Filter *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IBDA_IPV4Filter *This);
  ...
  HRESULT(STDMETHODCALLTYPE *PutMulticastMode)(__RPC__in IBDA_IPV4Filter *This,
                                               /* [in] */ ULONG ulModeMask);
...
typedef struct IBDA_IPV6FilterVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in IBDA_IPV6Filter *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IBDA_IPV6Filter *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IBDA_IPV6Filter *This);
  ...
  HRESULT(STDMETHODCALLTYPE *PutMulticastMode)(__RPC__in IBDA_IPV6Filter *This,
                                               /* [in] */ ULONG ulModeMask);
...
typedef struct IBDA_DeviceControlVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in IBDA_DeviceControl *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IBDA_DeviceControl *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IBDA_DeviceControl *This);

  DECLSPEC_XFGVIRT(IBDA_DeviceControl, StartChanges)
  HRESULT(STDMETHODCALLTYPE *StartChanges)(__RPC__in IBDA_DeviceControl *This);

  DECLSPEC_XFGVIRT(IBDA_DeviceControl, CheckChanges)
  HRESULT(STDMETHODCALLTYPE *CheckChanges)(__RPC__in IBDA_DeviceControl *This);

  DECLSPEC_XFGVIRT(IBDA_DeviceControl, CommitChanges)
  HRESULT(STDMETHODCALLTYPE *CommitChanges)(__RPC__in IBDA_DeviceControl *This);
...
typedef struct IBDA_PinControlVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in IBDA_PinControl *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IBDA_PinControl *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IBDA_PinControl *This);
...
typedef struct IBDA_SignalPropertiesVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IBDA_SignalProperties *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IBDA_SignalProperties *This);
...
typedef struct IBDA_SignalStatisticsVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IBDA_SignalStatistics *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IBDA_SignalStatistics *This);
...
public:
  virtual HRESULT STDMETHODCALLTYPE GetNodeTypes(
      ...
      /* [size_is][out][in] */
      __RPC__inout_ecount_full(ulcNodeTypesMax) ULONG rgulNodeTypes[]) = 0;
  ...
  virtual HRESULT STDMETHODCALLTYPE GetNodeDescriptors(
      ...
      /* [size_is][out][in] */
      __RPC__inout_ecount_full(ulcNodeDescriptorsMax)
  ...
  virtual HRESULT STDMETHODCALLTYPE GetNodeInterfaces(
      ...
      /* [size_is][out][in] */
      __RPC__inout_ecount_full(ulcInterfacesMax) GUID rgguidInterfaces[]) = 0;

  virtual HRESULT STDMETHODCALLTYPE GetPinTypes(
      /* [out][in] */ __RPC__inout ULONG * pulcPinTypes,
      /* [in] */ ULONG ulcPinTypesMax,
      /* [size_is][out][in] */
      __RPC__inout_ecount_full(ulcPinTypesMax) ULONG rgulPinTypes[]) = 0;
  ...
  virtual HRESULT STDMETHODCALLTYPE GetTemplateConnections(
      ...
      /* [size_is][out][in] */
      __RPC__inout_ecount_full(ulcConnectionsMax)
...
typedef struct IBDA_TopologyVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in IBDA_Topology *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IBDA_Topology *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IBDA_Topology *This);
  ...
  HRESULT(STDMETHODCALLTYPE *DeletePin)(__RPC__in IBDA_Topology *This,
                                        /* [in] */ ULONG ulPinId);
  ...
  HRESULT(STDMETHODCALLTYPE *CreateTopology)(__RPC__in IBDA_Topology *This,
                                             /* [in] */ ULONG ulInputPinId,
                                             /* [in] */ ULONG ulOutputPinId);
...
#define IBDA_Topology_GetNodeDescriptors(                                      \
  ...
  ((This)->lpVtbl->GetNodeDescriptors(                                         \
      This, ulcNodeDescriptors, ulcNodeDescriptorsMax, rgNodeDescriptors))
...
#define IBDA_Topology_GetPinTypes(This, pulcPinTypes, ulcPinTypesMax,          \
                                  rgulPinTypes)                                \
  ((This)->lpVtbl->GetPinTypes(This, pulcPinTypes, ulcPinTypesMax,             \
                               rgulPinTypes))
...
typedef struct IBDA_VoidTransformVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in IBDA_VoidTransform *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IBDA_VoidTransform *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IBDA_VoidTransform *This);

  DECLSPEC_XFGVIRT(IBDA_VoidTransform, Start)
  HRESULT(STDMETHODCALLTYPE *Start)(__RPC__in IBDA_VoidTransform *This);

  DECLSPEC_XFGVIRT(IBDA_VoidTransform, Stop)
  HRESULT(STDMETHODCALLTYPE *Stop)(__RPC__in IBDA_VoidTransform *This);
...
typedef struct IBDA_NullTransformVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in IBDA_NullTransform *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IBDA_NullTransform *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IBDA_NullTransform *This);

  DECLSPEC_XFGVIRT(IBDA_NullTransform, Start)
  HRESULT(STDMETHODCALLTYPE *Start)(__RPC__in IBDA_NullTransform *This);

  DECLSPEC_XFGVIRT(IBDA_NullTransform, Stop)
  HRESULT(STDMETHODCALLTYPE *Stop)(__RPC__in IBDA_NullTransform *This);
...
typedef struct IBDA_FrequencyFilterVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IBDA_FrequencyFilter *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IBDA_FrequencyFilter *This);

  DECLSPEC_XFGVIRT(IBDA_FrequencyFilter, put_Autotune)
  HRESULT(STDMETHODCALLTYPE *put_Autotune)(__RPC__in IBDA_FrequencyFilter *This,
  ...
  HRESULT(STDMETHODCALLTYPE *put_Polarity)(__RPC__in IBDA_FrequencyFilter *This,
  ...
  HRESULT(STDMETHODCALLTYPE *put_Range)(__RPC__in IBDA_FrequencyFilter *This,
                                        /* [in] */ ULONG ulRange);
...
typedef struct IBDA_LNBInfoVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in IBDA_LNBInfo *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IBDA_LNBInfo *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IBDA_LNBInfo *This);
...
public:
  ...
  virtual HRESULT STDMETHODCALLTYPE put_DiseqSendCommand(
      ...
      /* [size_is][in] */ __RPC__in_ecount_full(ulcbCommandLen) BYTE *
          pbCommand) = 0;
  ...
  virtual HRESULT STDMETHODCALLTYPE get_DiseqResponse(
      ...
      /* [size_is][out][in] */
      __RPC__inout_ecount_full(*pulcbResponseLen) BYTE pbResponse[]) = 0;
};
...
typedef struct IBDA_DiseqCommandVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in IBDA_DiseqCommand *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IBDA_DiseqCommand *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IBDA_DiseqCommand *This);
...
typedef struct IBDA_AutoDemodulateVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IBDA_AutoDemodulate *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IBDA_AutoDemodulate *This);
...
typedef struct IBDA_AutoDemodulateExVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IBDA_AutoDemodulateEx *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IBDA_AutoDemodulateEx *This);
...
typedef struct IBDA_DigitalDemodulatorVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IBDA_DigitalDemodulator *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IBDA_DigitalDemodulator *This);
...
typedef struct IBDA_DigitalDemodulator2Vtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IBDA_DigitalDemodulator2 *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IBDA_DigitalDemodulator2 *This);
...
typedef struct IBDA_DigitalDemodulator3Vtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IBDA_DigitalDemodulator3 *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IBDA_DigitalDemodulator3 *This);
...
typedef struct ICCSubStreamFilteringVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in ICCSubStreamFiltering *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in ICCSubStreamFiltering *This);
...
typedef struct IBDA_IPSinkControlVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in IBDA_IPSinkControl *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IBDA_IPSinkControl *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IBDA_IPSinkControl *This);
...
public:
  virtual HRESULT STDMETHODCALLTYPE get_MulticastList(
      /* [out][in] */ __RPC__inout ULONG * pulcbAddresses,
      /* [size_is][out] */ __RPC__out_ecount_full(*pulcbAddresses) BYTE *
          *ppbAddressList) = 0;
...
typedef struct IBDA_IPSinkInfoVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in IBDA_IPSinkInfo *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IBDA_IPSinkInfo *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IBDA_IPSinkInfo *This);
...
public:
  virtual HRESULT STDMETHODCALLTYPE Next(
      /* [in] */ ULONG cRequest,
      /* [size_is][out][in] */ __RPC__inout_ecount_full(cRequest) PID_MAP *
          pPIDMap,
...
typedef struct IEnumPIDMapVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in IEnumPIDMap *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IEnumPIDMap *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IEnumPIDMap *This);

  DECLSPEC_XFGVIRT(IEnumPIDMap, Next)
  HRESULT(STDMETHODCALLTYPE *Next)(__RPC__in IEnumPIDMap *This,
                                   /* [in] */ ULONG cRequest,
                                   /* [size_is][out][in] */
                                   __RPC__inout_ecount_full(cRequest)
                                       PID_MAP *pPIDMap,
                                   /* [out] */ __RPC__out ULONG *pcReceived);

  DECLSPEC_XFGVIRT(IEnumPIDMap, Skip)
  HRESULT(STDMETHODCALLTYPE *Skip)(__RPC__in IEnumPIDMap *This,
                                   /* [in] */ ULONG cRecords);

  DECLSPEC_XFGVIRT(IEnumPIDMap, Reset)
  HRESULT(STDMETHODCALLTYPE *Reset)(__RPC__in IEnumPIDMap *This);
...
typedef struct IMPEG2PIDMapVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in IMPEG2PIDMap *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IMPEG2PIDMap *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IMPEG2PIDMap *This);
  ...
  HRESULT(STDMETHODCALLTYPE *UnmapPID)(__RPC__in IMPEG2PIDMap *This,
                                       /* [in] */ ULONG culPID,
                                       /* [in] */ __RPC__in ULONG *pulPID);
...
public:
  virtual /* [helpstring] */ HRESULT STDMETHODCALLTYPE get_FrequencyMapping(
      ...
      /* [size_is][size_is][out] */ __RPC__out_ecount_full(1) ULONG *
          *ppulList) = 0;
...
typedef struct IFrequencyMapVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in IFrequencyMap *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IFrequencyMap *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IFrequencyMap *This);
...
typedef struct IBDA_EasMessageVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in IBDA_EasMessage *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IBDA_EasMessage *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IBDA_EasMessage *This);
...
interface IBDA_EasMessage { CONST_VTBL struct IBDA_EasMessageVtbl *lpVtbl; };
...
typedef struct IBDA_TransportStreamInfoVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IBDA_TransportStreamInfo *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IBDA_TransportStreamInfo *This);
...
public:
  ...
  get_SmartCardApplications(
      ...
      /* [size_is][out][in] */
      __RPC__inout_ecount_full(ulcApplicationsMax)
...
typedef struct IBDA_ConditionalAccessVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IBDA_ConditionalAccess *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IBDA_ConditionalAccess *This);
...
IBDA_DiagnosticProperties : public IPropertyBag{public : };
...
typedef struct IBDA_DiagnosticPropertiesVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IBDA_DiagnosticProperties *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IBDA_DiagnosticProperties *This);
  ...
  HRESULT(STDMETHODCALLTYPE *Write)(__RPC__in IBDA_DiagnosticProperties *This,
...
public:
  ...
  virtual HRESULT STDMETHODCALLTYPE PerformDRMPairing(BOOL fSync) = 0;
};
...
typedef struct IBDA_DRMVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in IBDA_DRM *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IBDA_DRM *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IBDA_DRM *This);
  ...
  HRESULT(STDMETHODCALLTYPE *PerformDRMPairing)(__RPC__in IBDA_DRM *This,
                                                BOOL fSync);

  END_INTERFACE
} IBDA_DRMVtbl;

interface IBDA_DRM { CONST_VTBL struct IBDA_DRMVtbl *lpVtbl; };
...
typedef struct IBDA_NameValueServiceVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IBDA_NameValueService *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IBDA_NameValueService *This);
...
public:
  virtual /* [helpstring] */ HRESULT STDMETHODCALLTYPE CheckEntitlementToken(
      ...
      /* [size_is][in] */ __RPC__in_ecount_full(ulcbEntitlementTokenLen) BYTE *
          pbEntitlementToken,
  ...
  virtual /* [helpstring] */ HRESULT STDMETHODCALLTYPE SetCaptureToken(
      ...
      /* [size_is][in] */ __RPC__in_ecount_full(ulcbCaptureTokenLen) BYTE *
          pbCaptureToken) = 0;
...
typedef struct IBDA_ConditionalAccessExVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IBDA_ConditionalAccessEx *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IBDA_ConditionalAccessEx *This);
...
#define IBDA_ConditionalAccessEx_OpenBroadcastMmi(This, ulDialogRequest,       \
  ...
  ((This)->lpVtbl->OpenBroadcastMmi(This, ulDialogRequest, bstrLanguage,       \
                                    EventId))
...
public:
  virtual /* [helpstring] */ HRESULT STDMETHODCALLTYPE SetIsdbCasRequest(
      ...
      /* [size_is][in] */ __RPC__in_ecount_full(ulcbRequestBufferLen) BYTE *
          pbRequestBuffer) = 0;
};
...
typedef struct IBDA_ISDBConditionalAccessVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IBDA_ISDBConditionalAccess *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IBDA_ISDBConditionalAccess *This);
...
typedef struct IBDA_EventingServiceVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IBDA_EventingService *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IBDA_EventingService *This);
...
typedef struct IBDA_AUXVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in IBDA_AUX *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IBDA_AUX *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IBDA_AUX *This);
...
interface IBDA_AUX { CONST_VTBL struct IBDA_AUXVtbl *lpVtbl; };
...
DEFINE_GUID(CLSID_PBDA_AUX_DATA_TYPE, /* fd456373-3323-4090-adca-8ed45f55cf10 */
            0xfd456373, 0x3323, 0x4090, 0xad, 0xca, 0x8e, 0xd4, 0x5f, 0x55,
            0xcf, 0x10);
...
typedef struct IBDA_EncoderVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in IBDA_Encoder *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IBDA_Encoder *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IBDA_Encoder *This);
...
interface IBDA_Encoder { CONST_VTBL struct IBDA_EncoderVtbl *lpVtbl; };
...
#define IBDA_Encoder_EnumAudioCapability(This, FmtIndex, MethodID,             \
  ...
  ((This)->lpVtbl->EnumAudioCapability(This, FmtIndex, MethodID,               \
                                       AlgorithmType, SamplingRate, BitDepth,  \
                                       NumChannels))
...
DEFINE_GUID(CLSID_PBDA_FDC_DATA_TYPE, /* E7DBF9A0-22AB-4047-8E67-EF9AD504E729 */
            0xe7dbf9a0, 0x22ab, 0x4047, 0x8e, 0x67, 0xef, 0x9a, 0xd5, 0x4, 0xe7,
            0x29);
...
typedef struct IBDA_FDCVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in IBDA_FDC *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IBDA_FDC *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IBDA_FDC *This);
...
interface IBDA_FDC { CONST_VTBL struct IBDA_FDCVtbl *lpVtbl; };
...
public:
  ...
  virtual /* [helpstring] */ HRESULT STDMETHODCALLTYPE RequestGuideDataUpdate(
      void) = 0;
...
typedef struct IBDA_DRMServiceVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in IBDA_DRMService *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IBDA_DRMService *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IBDA_DRMService *This);
...
interface IBDA_DRMService { CONST_VTBL struct IBDA_DRMServiceVtbl *lpVtbl; };
...
public:
  ...
  virtual /* [helpstring] */ HRESULT STDMETHODCALLTYPE SetRevInfo(
      ...
      /* [size_is][in] */ __RPC__in_ecount_full(ulRevInfoLen) BYTE *
          pbRevInfo) = 0;
  ...
  virtual /* [helpstring] */ HRESULT STDMETHODCALLTYPE RenewLicense(
      ...
      /* [size_is][in] */ __RPC__in_ecount_full(ulInXmrLicenseLen) BYTE *
          pbInXmrLicense,
      /* [in] */ ULONG ulEntitlementTokenLen,
      /* [size_is][in] */ __RPC__in_ecount_full(ulEntitlementTokenLen) BYTE *
          pbEntitlementToken,
      /* [out] */ __RPC__out ULONG * pulDescrambleStatus,
...
typedef struct IBDA_WMDRMSessionVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in IBDA_WMDRMSession *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IBDA_WMDRMSession *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IBDA_WMDRMSession *This);
...
#define IBDA_WMDRMSession_TransactMessage(This, ulcbRequest, pbRequest,        \
  ...
  ((This)->lpVtbl->TransactMessage(This, ulcbRequest, pbRequest,               \
                                   pulcbResponse, pbResponse))
...
public:
  virtual /* [helpstring] */ HRESULT STDMETHODCALLTYPE PurchaseEntitlement(
      ...
      /* [size_is][in] */ __RPC__in_ecount_full(ulPurchaseTokenLen) BYTE *
          pbPurchaseToken,
      /* [out] */ __RPC__out ULONG * pulDescrambleStatus,
  ...
  virtual /* [helpstring] */ HRESULT STDMETHODCALLTYPE CancelCaptureToken(
      ...
      /* [size_is][in] */ __RPC__in_ecount_full(ulCaptureTokenLen) BYTE *
          pbCaptureToken) = 0;
...
typedef struct IBDA_WMDRMTunerVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in IBDA_WMDRMTuner *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IBDA_WMDRMTuner *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IBDA_WMDRMTuner *This);
...
interface IBDA_WMDRMTuner { CONST_VTBL struct IBDA_WMDRMTunerVtbl *lpVtbl; };
...
#define IBDA_WMDRMTuner_PurchaseEntitlement(                                   \
  ...
  ((This)->lpVtbl->PurchaseEntitlement(This, ulDialogRequest, bstrLanguage,    \
                                       ...
                                       pulDescrambleStatus,                    \
                                       pulCaptureTokenLen, pbCaptureToken))
...
public:
  ...
  virtual /* [helpstring] */ HRESULT STDMETHODCALLTYPE GetPairingStatus(
      /* [out][in] */ __RPC__inout BDA_DrmPairingError *
...
typedef struct IBDA_DRIDRMServiceVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in IBDA_DRIDRMService *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IBDA_DRIDRMService *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IBDA_DRIDRMService *This);
...
public:
  ...
  virtual /* [helpstring] */ HRESULT STDMETHODCALLTYPE ProcessLicenseChallenge(
      ...
      /* [size_is][in] */ __RPC__in_ecount_full(dwcbLicenseMessage) BYTE *
          pbLicenseMessage,
      /* [out][in] */ __RPC__inout DWORD * pdwcbLicenseResponse,
      /* [size_is][out][in] */
      __RPC__inout_ecount_full(*pdwcbLicenseResponse) BYTE *
          *ppbLicenseResponse) = 0;

  virtual /* [helpstring] */ HRESULT STDMETHODCALLTYPE
  ProcessRegistrationChallenge(
      /* [in] */ DWORD dwcbRegistrationMessage,
      /* [size_is][in] */ __RPC__in_ecount_full(dwcbRegistrationMessage) BYTE *
          pbRegistrationMessage,
      /* [out][in] */ __RPC__inout DWORD * pdwcbRegistrationResponse,
      /* [out][in] */ __RPC__deref_inout_opt BYTE *
          *ppbRegistrationResponse) = 0;
  ...
  virtual /* [helpstring] */ HRESULT STDMETHODCALLTYPE GetHMSAssociationData(
      void) = 0;
...
typedef struct IBDA_DRIWMDRMSessionVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IBDA_DRIWMDRMSession *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IBDA_DRIWMDRMSession *This);
  ...
  /* [helpstring] */ HRESULT(STDMETHODCALLTYPE *ProcessLicenseChallenge)(
      ...
      /* [out][in] */ __RPC__inout DWORD *pdwcbLicenseResponse,
      /* [size_is][out][in] */
      __RPC__inout_ecount_full(*pdwcbLicenseResponse)
  ...
  /* [helpstring] */ HRESULT(STDMETHODCALLTYPE *ProcessRegistrationChallenge)(
      ...
      /* [in] */ DWORD dwcbRegistrationMessage,
      /* [size_is][in] */
      __RPC__in_ecount_full(dwcbRegistrationMessage)
...
public:
  virtual /* [helpstring] */ HRESULT STDMETHODCALLTYPE SetPidList(
      ...
      /* [size_is][in] */ __RPC__in_ecount_full(ulPidListCount)
              BDA_MUX_PIDLISTITEM *
          pbPidListBuffer) = 0;
...
typedef struct IBDA_MUXVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in IBDA_MUX *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IBDA_MUX *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IBDA_MUX *This);
  ...
  /* [helpstring] */ HRESULT(STDMETHODCALLTYPE *SetPidList)(
      ...
      /* [in] */ ULONG ulPidListCount,
      /* [size_is][in] */
      __RPC__in_ecount_full(ulPidListCount)
...
interface IBDA_MUX { CONST_VTBL struct IBDA_MUXVtbl *lpVtbl; };
...
public:
  ...
  virtual /* [helpstring] */ HRESULT STDMETHODCALLTYPE GetTSInformation(
      ...
      /* [size_is][out] */ __RPC__out_ecount_full(*pulTSInformationBufferLen)
              BYTE *
          pbTSInformationBuffer) = 0;
};
...
typedef struct IBDA_TransportStreamSelectorVtbl {
  ...
  /* [helpstring] */ HRESULT(STDMETHODCALLTYPE *GetTSInformation)(
      ...
      /* [out][in] */ __RPC__inout ULONG *pulTSInformationBufferLen,
      /* [size_is][out] */
      __RPC__out_ecount_full(*pulTSInformationBufferLen)
...
public:
  ...
  virtual /* [helpstring] */ HRESULT STDMETHODCALLTYPE UserActivityDetected(
      void) = 0;
};
...
typedef struct IBDA_UserActivityServiceVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IBDA_UserActivityService *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IBDA_UserActivityService *This);
...
typedef struct IESEventVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in IESEvent *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IESEvent *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IESEvent *This);
  ...
  HRESULT(STDMETHODCALLTYPE *SetCompletionStatus)(__RPC__in IESEvent *This,
                                                  /* [in] */ DWORD dwResult);
...
interface IESEvent { CONST_VTBL struct IESEventVtbl *lpVtbl; };
...
typedef struct IESEventsVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in IESEvents *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IESEvents *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IESEvents *This);
...
interface IESEvents { CONST_VTBL struct IESEventsVtbl *lpVtbl; };
...
typedef struct IBroadcastEventVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in IBroadcastEvent *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IBroadcastEvent *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IBroadcastEvent *This);

  DECLSPEC_XFGVIRT(IBroadcastEvent, Fire)
  HRESULT(STDMETHODCALLTYPE *Fire)(__RPC__in IBroadcastEvent *This,
                                   /* [in] */ GUID EventID);
...
typedef struct IBroadcastEventExVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in IBroadcastEventEx *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IBroadcastEventEx *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IBroadcastEventEx *This);

  DECLSPEC_XFGVIRT(IBroadcastEvent, Fire)
  HRESULT(STDMETHODCALLTYPE *Fire)(__RPC__in IBroadcastEventEx *This,
                                   /* [in] */ GUID EventID);

  DECLSPEC_XFGVIRT(IBroadcastEventEx, FireEx)
  HRESULT(STDMETHODCALLTYPE *FireEx)(__RPC__in IBroadcastEventEx *This,
                                     /* [in] */ GUID EventID,
                                     /* [in] */ ULONG Param1,
                                     /* [in] */ ULONG Param2,
                                     /* [in] */ ULONG Param3,
