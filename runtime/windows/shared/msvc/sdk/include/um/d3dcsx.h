...
DECLARE_INTERFACE_(ID3DX11Scan, IUnknown) {
  ...
  //=============================================================================
  STDMETHOD(Scan)(THIS_ D3DX11_SCAN_DATA_TYPE ElementType,
                  D3DX11_SCAN_OPCODE OpCode, UINT ElementScanSize,
                  _In_ ID3D11UnorderedAccessView * pSrc,
                  _In_ ID3D11UnorderedAccessView * pDst) PURE;
  ...
  //  scans pDst                output sequence on the device
  //=============================================================================
  STDMETHOD(Multiscan)(THIS_ D3DX11_SCAN_DATA_TYPE ElementType,
                       D3DX11_SCAN_OPCODE OpCode, UINT ElementScanSize,
                       UINT ElementScanPitch, UINT ScanCount,
                       _In_ ID3D11UnorderedAccessView * pSrc,
                       _In_ ID3D11UnorderedAccessView * pDst) PURE;
};
...
DECLARE_INTERFACE_(ID3DX11SegmentedScan, IUnknown) {
  ...
  //  scans pDst                output sequence on the device
  //=============================================================================
  STDMETHOD(SegScan)(THIS_ D3DX11_SCAN_DATA_TYPE ElementType,
                     D3DX11_SCAN_OPCODE OpCode, UINT ElementScanSize,
...
HRESULT WINAPI D3DX11CreateSegmentedScan(
    _In_ ID3D11DeviceContext *pDeviceContext, UINT MaxElementScanSize,
...
DECLARE_INTERFACE_(ID3DX11FFT, IUnknown) {
  ...
  STDMETHOD(AttachBuffersAndPrecompute)(
      THIS_ _In_range_(0, D3DX11_FFT_MAX_TEMP_BUFFERS) UINT NumTempBuffers,
      _In_reads_(NumTempBuffers)
          ID3D11UnorderedAccessView *const *ppTempBuffers,
      _In_range_(0, D3DX11_FFT_MAX_PRECOMPUTE_BUFFERS)
          UINT NumPrecomputeBuffers,
      _In_reads_(NumPrecomputeBuffers)
  ...
  STDMETHOD(ForwardTransform)(
      THIS_ _In_ const ID3D11UnorderedAccessView *pInputBuffer,
...
typedef struct D3DX11_FFT_BUFFER_INFO {
  ...
  _Field_range_(0, D3DX11_FFT_MAX_PRECOMPUTE_BUFFERS) UINT
...
HRESULT WINAPI D3DX11CreateFFT(ID3D11DeviceContext *pDeviceContext,
                               _In_ const D3DX11_FFT_DESC *pDesc, UINT Flags,
...
HRESULT WINAPI D3DX11CreateFFT1DComplex(
    ...
    _Out_ D3DX11_FFT_BUFFER_INFO *pBufferInfo, _Out_ ID3DX11FFT **ppFFT);
