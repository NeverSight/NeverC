...
typedef struct IIdentityStoreVtbl {
  ...
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in IIdentityStore *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IIdentityStore *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IIdentityStore *This);
  ...
  HRESULT(STDMETHODCALLTYPE *Reset)(__RPC__in IIdentityStore *This);

  END_INTERFACE
} IIdentityStoreVtbl;

interface IIdentityStore { CONST_VTBL struct IIdentityStoreVtbl *lpVtbl; };
...
#define IIdentityStore_ConvertToSid(This, lpszUniqueID, ProviderGUID, cbSid,   \
                                    pSid, pcbRequiredSid)                      \
  ((This)->lpVtbl->ConvertToSid(This, lpszUniqueID, ProviderGUID, cbSid, pSid, \
                                pcbRequiredSid))

#define IIdentityStore_EnumerateIdentities(                                    \
    This, eIdentityType, pFilterkey, pFilterPropVarValue, ppIdentityEnum)      \
  ((This)->lpVtbl->EnumerateIdentities(This, eIdentityType, pFilterkey,        \
...
public:
  ...
  virtual HRESULT STDMETHODCALLTYPE Begin_ConvertToSid(
      ...
      /* [in] */ USHORT cbSid,
      /* [size_is][unique][out][in] */
      __RPC__inout_xcount_full_opt(cbSid) BYTE * pSid) = 0;

  virtual HRESULT STDMETHODCALLTYPE Finish_ConvertToSid(
      /* [size_is][unique][out][in] */ __RPC__inout_xcount_full_opt(cbSid)
              BYTE *
          pSid,
      /* [out] */ __RPC__out USHORT * pcbRequiredSid) = 0;
...
typedef struct AsyncIIdentityStoreVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in AsyncIIdentityStore *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in AsyncIIdentityStore *This);
  ...
  HRESULT(STDMETHODCALLTYPE *Begin_Reset)(__RPC__in AsyncIIdentityStore *This);

  DECLSPEC_XFGVIRT(AsyncIIdentityStore, Finish_Reset)
  HRESULT(STDMETHODCALLTYPE *Finish_Reset)(__RPC__in AsyncIIdentityStore *This);
...
#define AsyncIIdentityStore_Begin_ConvertToSid(This, lpszUniqueID,             \
                                               ProviderGUID, cbSid, pSid)      \
  ((This)->lpVtbl->Begin_ConvertToSid(This, lpszUniqueID, ProviderGUID, cbSid, \
                                      pSid))
...
#define AsyncIIdentityStore_Begin_EnumerateIdentities(                         \
    This, eIdentityType, pFilterkey, pFilterPropVarValue)                      \
  ((This)->lpVtbl->Begin_EnumerateIdentities(This, eIdentityType, pFilterkey,  \
                                             pFilterPropVarValue))
...
typedef struct IIdentityStoreExVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in IIdentityStoreEx *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IIdentityStoreEx *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IIdentityStoreEx *This);
...
interface IIdentityStoreEx { CONST_VTBL struct IIdentityStoreExVtbl *lpVtbl; };
...
#define IIdentityStoreEx_AddRef(This) ((This)->lpVtbl->AddRef(This))

#define IIdentityStoreEx_Release(This) ((This)->lpVtbl->Release(This))

#define IIdentityStoreEx_CreateConnectedIdentity(This, LocalName,              \
                                                 ConnectedName, ProviderGUID)  \
  ((This)->lpVtbl->CreateConnectedIdentity(This, LocalName, ConnectedName,     \
                                           ProviderGUID))

#define IIdentityStoreEx_DeleteConnectedIdentity(This, ConnectedName,          \
                                                 ProviderGUID)                 \
...
typedef struct AsyncIIdentityStoreExVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in AsyncIIdentityStoreEx *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in AsyncIIdentityStoreEx *This);
...
#define AsyncIIdentityStoreEx_AddRef(This) ((This)->lpVtbl->AddRef(This))

#define AsyncIIdentityStoreEx_Release(This) ((This)->lpVtbl->Release(This))

#define AsyncIIdentityStoreEx_Begin_CreateConnectedIdentity(                   \
    This, LocalName, ConnectedName, ProviderGUID)                              \
  ((This)->lpVtbl->Begin_CreateConnectedIdentity(This, LocalName,              \
                                                 ConnectedName, ProviderGUID))

#define AsyncIIdentityStoreEx_Finish_CreateConnectedIdentity(This)             \
  ((This)->lpVtbl->Finish_CreateConnectedIdentity(This))

#define AsyncIIdentityStoreEx_Begin_DeleteConnectedIdentity(                   \
    This, ConnectedName, ProviderGUID)                                         \
  ((This)->lpVtbl->Begin_DeleteConnectedIdentity(This, ConnectedName,          \
                                                 ProviderGUID))
