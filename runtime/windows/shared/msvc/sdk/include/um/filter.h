...
typedef struct IFilterVtbl {
  ...
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(IFilter *This,
                                             /* [in] */ REFIID riid,
  ...
  SCODE(STDMETHODCALLTYPE *GetChunk)(IFilter *This,
                                     /* [out] */ STAT_CHUNK *pStat);

  DECLSPEC_XFGVIRT(IFilter, GetText)
  SCODE(STDMETHODCALLTYPE *GetText)(IFilter *This,
                                    /* [out][in] */ ULONG *pcwcBuffer,
                                    /* [size_is][out] */ WCHAR *awcBuffer);

  DECLSPEC_XFGVIRT(IFilter, GetValue)
  SCODE(STDMETHODCALLTYPE *GetValue)(IFilter *This,
                                     /* [out] */ PROPVARIANT **ppPropValue);

  DECLSPEC_XFGVIRT(IFilter, BindRegion)
  SCODE(STDMETHODCALLTYPE *BindRegion)(IFilter *This,
                                       /* [in] */ FILTERREGION origPos,
                                       /* [in] */ REFIID riid,
                                       /* [out] */ void **ppunk);
...
interface IFilter { CONST_VTBL struct IFilterVtbl *lpVtbl; };
...
public:
  ...
  virtual HRESULT STDMETHODCALLTYPE GetPixelsForImage(
      ...
      /* [size_is][out] */
      __RPC__out_ecount_full(pixelBufferSize) BYTE *pixelBuffer) = 0;
};
...
typedef struct IPixelFilterVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in IPixelFilter *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IPixelFilter *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IPixelFilter *This);

  DECLSPEC_XFGVIRT(IFilter, Init)
  SCODE(STDMETHODCALLTYPE *Init)(__RPC__in IPixelFilter *This,
                                 /* [in] */ ULONG grfFlags,
                                 /* [in] */ ULONG cAttributes,
                                 /* [size_is][in] */
                                 __RPC__in_ecount_full(cAttributes)
                                     const FULLPROPSPEC *aAttributes,
                                 /* [out] */ __RPC__out ULONG *pFlags);

  DECLSPEC_XFGVIRT(IFilter, GetChunk)
  SCODE(STDMETHODCALLTYPE *GetChunk)(__RPC__in IPixelFilter *This,
  ...
  SCODE(STDMETHODCALLTYPE *GetText)(
      ...
      /* [size_is][out] */
      __RPC__out_ecount_full(*pcwcBuffer) WCHAR *awcBuffer);
  ...
  HRESULT(STDMETHODCALLTYPE *GetPixelsForImage)(
      ...
      /* [in] */ ULONG pixelBufferSize,
      /* [size_is][out] */
      __RPC__out_ecount_full(pixelBufferSize) BYTE *pixelBuffer);

  END_INTERFACE
} IPixelFilterVtbl;

interface IPixelFilter { CONST_VTBL struct IPixelFilterVtbl *lpVtbl; };
...
#define IPixelFilter_AddRef(This) ((This)->lpVtbl->AddRef(This))

#define IPixelFilter_Release(This) ((This)->lpVtbl->Release(This))
...
#define IPixelFilter_GetPixelsForImage(This, scalingFactor, sourceRect,        \
                                       pixelBufferSize, pixelBuffer)           \
  ((This)->lpVtbl->GetPixelsForImage(This, scalingFactor, sourceRect,          \
                                     pixelBufferSize, pixelBuffer))
