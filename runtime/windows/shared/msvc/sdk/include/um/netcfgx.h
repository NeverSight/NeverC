...
public:
  virtual HRESULT STDMETHODCALLTYPE Next(
      ...
      _At_(*rgelt, _Out_writes_to_(celt, *pceltFetched))
              INetCfgBindingInterface *
          *rgelt,
      /* [annotation][out] */
      _When_(celt == 1, _Out_opt_) _When_(celt != 1, _Out_) ULONG *
          pceltFetched) = 0;
...
public:
  virtual HRESULT STDMETHODCALLTYPE Next(
      ...
      _In_range_(>=, 1) ULONG celt,
      /* [annotation][length_is][size_is][out] */
      _At_(*rgelt, _Out_writes_to_(celt, *pceltFetched)) INetCfgBindingPath *
          *rgelt,
      /* [annotation][out] */
      _When_(celt == 1, _Out_opt_) _When_(celt != 1, _Out_) ULONG *
          pceltFetched) = 0;
...
typedef struct IEnumNetCfgBindingPathVtbl {
  ...
  HRESULT(STDMETHODCALLTYPE *Skip)(IEnumNetCfgBindingPath *This,
                                   /* [annotation][in] */
                                   _In_range_(>=, 1) ULONG celt);
...
public:
  virtual HRESULT STDMETHODCALLTYPE Next(
      ...
      _In_range_(>=, 1) ULONG celt,
      /* [annotation][length_is][size_is][out] */
      _At_(*rgelt, _Out_writes_to_(celt, *pceltFetched)) INetCfgComponent *
          *rgelt,
      /* [annotation][out] */
      _When_(celt == 1, _Out_opt_) _When_(celt != 1, _Out_) ULONG *
          pceltFetched) = 0;
...
typedef struct IEnumNetCfgComponentVtbl {
  ...
  HRESULT(STDMETHODCALLTYPE *Next)(IEnumNetCfgComponent *This,
                                   /* [annotation][in] */
                                   _In_range_(>=, 1) ULONG celt,
                                   /* [annotation][length_is][size_is][out] */
                                   _At_(*rgelt,
  ...
  HRESULT(STDMETHODCALLTYPE *Skip)(IEnumNetCfgComponent *This,
                                   /* [annotation][in] */
                                   _In_range_(>=, 1) ULONG celt);
...
public:
  ...
  virtual HRESULT STDMETHODCALLTYPE EnumComponents(
      ...
      /* [annotation][out] */
      _At_(*ppenumComponent, _Out_opt_)
...
typedef struct INetCfgVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(INetCfg *This,
                                             /* [in] */ REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);
  ...
  HRESULT(STDMETHODCALLTYPE *Initialize)(INetCfg *This,
                                         /* [annotation][in] */
  ...
  HRESULT(STDMETHODCALLTYPE *FindComponent)(INetCfg *This,
                                            /* [annotation][string][in] */
                                            _In_ LPCWSTR pszwInfId,
                                            /* [annotation][out] */
                                            _At_(*pComponent, _Out_opt_)
...
interface INetCfg { CONST_VTBL struct INetCfgVtbl *lpVtbl; };
...
public:
  virtual HRESULT STDMETHODCALLTYPE AcquireWriteLock(
      ...
      _At_(*ppszwClientDescription, _Out_opt_) LPWSTR *
...
typedef struct INetCfgLockVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(INetCfgLock *This,
                                             /* [in] */ REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);
...
interface INetCfgLock { CONST_VTBL struct INetCfgLockVtbl *lpVtbl; };
...
typedef struct INetCfgBindingInterfaceVtbl {
  ...
  HRESULT(STDMETHODCALLTYPE *GetName)(INetCfgBindingInterface *This,
                                      /* [annotation][string][out] */
                                      _At_(*ppszwInterfaceName, _Out_opt_)
...
public:
  ...
  virtual HRESULT STDMETHODCALLTYPE EnumBindingInterfaces(
      /* [annotation][out] */
      _At_(*ppenumInterface, _Out_opt_) IEnumNetCfgBindingInterface *
      *ppenumInterface) = 0;
};
...
typedef struct INetCfgBindingPathVtbl {
  ...
  HRESULT(STDMETHODCALLTYPE *Enable)(INetCfgBindingPath *This,
                                     /* [annotation][in] */
                                     _In_ BOOL fEnable);
  ...
  HRESULT(STDMETHODCALLTYPE *EnumBindingInterfaces)(
      ...
      /* [annotation][out] */
      _At_(*ppenumInterface, _Out_opt_)
...
public:
  ...
  virtual HRESULT STDMETHODCALLTYPE EnumComponents(
      /* [annotation][out] */
      _At_(*ppenumComponent, _Out_opt_) IEnumNetCfgComponent *
      *ppenumComponent) = 0;
};
...
typedef struct INetCfgClassVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(INetCfgClass *This,
                                             /* [in] */ REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);
...
interface INetCfgClass { CONST_VTBL struct INetCfgClassVtbl *lpVtbl; };
...
typedef struct INetCfgClassSetupVtbl {
  ...
  HRESULT(STDMETHODCALLTYPE *Install)(INetCfgClassSetup *This,
                                      /* [annotation][string][in] */
                                      _In_ LPCWSTR pszwInfId,
                                      /* [annotation][in] */
                                      _In_opt_ OBO_TOKEN *pOboToken,
  ...
  HRESULT(STDMETHODCALLTYPE *DeInstall)(INetCfgClassSetup *This,
                                        ...
                                        _In_opt_ OBO_TOKEN *pOboToken,
                                        /* [annotation][out] */
                                        _Inout_opt_ _At_(*pmszwRefs, _Out_opt_)
                                            LPWSTR *pmszwRefs);
...
typedef struct INetCfgClassSetup2Vtbl {
  ...
  DECLSPEC_XFGVIRT(INetCfgClassSetup, Install)
  HRESULT(STDMETHODCALLTYPE *Install)(INetCfgClassSetup2 *This,
                                      /* [annotation][string][in] */
                                      _In_ LPCWSTR pszwInfId,
                                      /* [annotation][in] */
                                      _In_opt_ OBO_TOKEN *pOboToken,
...
typedef struct INetCfgComponentVtbl {
  ...
  HRESULT(STDMETHODCALLTYPE *GetDisplayName)(INetCfgComponent *This,
                                             /* [annotation][string][out] */
                                             _At_(*ppszwDisplayName, _Out_opt_)
  ...
  HRESULT(STDMETHODCALLTYPE *GetHelpText)(INetCfgComponent *This,
                                          /* [annotation][string][out] */
                                          _At_(*pszwHelpText, _Out_opt_)
                                              LPWSTR *pszwHelpText);

  DECLSPEC_XFGVIRT(INetCfgComponent, GetId)
  HRESULT(STDMETHODCALLTYPE *GetId)(INetCfgComponent *This,
                                    /* [annotation][string][out] */
  ...
  HRESULT(STDMETHODCALLTYPE *GetPnpDevNodeId)(INetCfgComponent *This,
                                              /* [annotation][string][out] */
                                              _At_(*ppszwDevNodeId, _Out_opt_)
                                                  LPWSTR *ppszwDevNodeId);

  DECLSPEC_XFGVIRT(INetCfgComponent, GetClassGuid)
  HRESULT(STDMETHODCALLTYPE *GetClassGuid)(INetCfgComponent *This,
                                           /* [annotation][out] */
                                           _Out_opt_ GUID *pGuid);
  ...
  HRESULT(STDMETHODCALLTYPE *OpenParamKey)(INetCfgComponent *This,
                                           /* [annotation][out] */
...
interface INetCfgComponent { CONST_VTBL struct INetCfgComponentVtbl *lpVtbl; };
...
typedef struct INetCfgSysPrepVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(INetCfgSysPrep *This,
                                             /* [in] */ REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);
...
interface INetCfgSysPrep { CONST_VTBL struct INetCfgSysPrepVtbl *lpVtbl; };
