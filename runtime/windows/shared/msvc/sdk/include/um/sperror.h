 ...
 * -2147201012 The phrase ID specified does not exist or is out of range.
 */
#define SPERR_INVALID_PHRASE_ID MAKE_SAPI_ERROR(0x00c)

/*** SPERR_BUFFER_TOO_SMALL                                0x8004500d
 * -2147201011 The caller provided a buffer too small to return a result.
 */
#define SPERR_BUFFER_TOO_SMALL MAKE_SAPI_ERROR(0x00d)

/*** SPERR_FORMAT_NOT_SPECIFIED                            0x8004500e
 * -2147201010 Caller did not specify a format prior to opening a stream.
 */
#define SPERR_FORMAT_NOT_SPECIFIED MAKE_SAPI_ERROR(0x00e)

/*** SPERR_AUDIO_STOPPED                                   0x8004500f
 * -2147201009 This method is deprecated. Use SP_AUDIO_STOPPED instead.
 */
 ...
 * -2147201007 Invalid rule name passed to ActivateGrammar.
 */
#define SPERR_RULE_NOT_FOUND MAKE_SAPI_ERROR(0x011)

/*** SPERR_TTS_ENGINE_EXCEPTION                            0x80045012
 * -2147201006 An exception was raised during a call to the current TTS driver.
 */
#define SPERR_TTS_ENGINE_EXCEPTION MAKE_SAPI_ERROR(0x012)

/*** SPERR_TTS_NLP_EXCEPTION                               0x80045013
 * -2147201005 An exception was raised during a call to an application sentence
 * filter.
 */
#define SPERR_TTS_NLP_EXCEPTION MAKE_SAPI_ERROR(0x013)

/*** SPERR_ENGINE_BUSY                                     0x80045014
 * -2147201004 In speech recognition, the current method can not be performed
 * while a grammar rule is active.
 */
 ...
 * -2147201001 Can not create a new object instance for the specified object
 * category.
 */
 ...
 * -2147200999 The word does not exist in the lexicon.
 */
 ...
 * -2147200985 A grammar rule was defined with a null path through the rule.
 * That is, it is possible to satisfy the rule conditions with no words.
 */
#define SPERR_ALL_WORDS_OPTIONAL MAKE_SAPI_ERROR(0x027)

/*** SPERR_INSTANCE_CHANGE_INVALID                         0x80045028
 * -2147200984 It is not possible to change the current engine or input.  This
 ...
 * -2147200977 This will only be returned on input (read) streams when the
 ...
 * -2147200976 The result does not contain any audio, nor does the portion of
 * the element chain of the result contain any audio.
 */
#define SPERR_NO_AUDIO_DATA MAKE_SAPI_ERROR(0x030)

/*** SPERR_DEAD_ALTERNATE                                  0x80045031
 * -2147200975 This alternate is no longer a valid alternate to the result it
 * was obtained from. Returned from ISpPhraseAlt methods.
 */
#define SPERR_DEAD_ALTERNATE MAKE_SAPI_ERROR(0x031)

/*** SPERR_HIGH_LOW_CONFIDENCE                             0x80045032
 * -2147200974 The result does not contain any audio, nor does the portion of
 * the element chain of the result contain any audio.  Returned from
 ...
 * -2147200973 The XML format string for this RULEREF is invalid, e.g. not a
 * GUID or REFCLSID.
 */
 ...
 * -2147200971 The operation is invalid for all but newly created application
 * lexicons.
 */
 ...
 * -2147200968 An operation was attempted on a stream object that has been
 * closed.
 */
 ...
 * -2147200953 Exported rules cannot refer directly or indirectly to a dynamic
 * rule.
 */
#define SPERR_EXPORT_DYNAMIC_RULE MAKE_SAPI_ERROR(0x047)

/*** SPERR_STGF_ERROR                                      0x80045048
 * -2147200952 Error parsing the SAPI Text Grammar Format (XML grammar).
 */
#define SPERR_STGF_ERROR MAKE_SAPI_ERROR(0x048)

/*** SPERR_WORDFORMAT_ERROR                                0x80045049
 * -2147200951 Incorrect word format, probably due to incorrect pronunciation
 * string.
 */
#define SPERR_WORDFORMAT_ERROR MAKE_SAPI_ERROR(0x049)

/*** SPERR_STREAM_NOT_ACTIVE                               0x8004504a
 * -2147200950 Methods associated with active audio stream cannot be called
 * unless stream is active.
 */
#define SPERR_STREAM_NOT_ACTIVE MAKE_SAPI_ERROR(0x04a)

/*** SPERR_ENGINE_RESPONSE_INVALID                         0x8004504b
 * -2147200949 Arguments or data supplied by the engine are in an invalid format
 * or are inconsistent.
 */
#define SPERR_ENGINE_RESPONSE_INVALID MAKE_SAPI_ERROR(0x04b)

/*** SPERR_SR_ENGINE_EXCEPTION                             0x8004504c
 * -2147200948 An exception was raised during a call to the current SR engine.
 */
#define SPERR_SR_ENGINE_EXCEPTION MAKE_SAPI_ERROR(0x04c)

/*** SPERR_STREAM_POS_INVALID                              0x8004504d
 * -2147200947 Stream position information supplied from engine is inconsistent.
 */
#define SPERR_STREAM_POS_INVALID MAKE_SAPI_ERROR(0x04d)

/*** SP_RECOGNIZER_INACTIVE                                0x0004504e    282702
 *   Operation could not be completed because the recognizer is inactive. It is
 * inactive either because the recognition state is currently inactive or
 ...
 * -2147200933 This will only be returned on input (read) streams when the real
 * time audio device stops returning data for a long period of time.
 */
 ...
 * -2147200931 The SR engine is unable to add this word to a grammar. The
 * application may need to supply an explicit pronunciation for this word.
 */
#define SPERR_NO_WORD_PRONUNCIATION MAKE_SAPI_ERROR(0x05d)

/*** SPERR_ALTERNATES_WOULD_BE_INCONSISTENT                0x8004505e
 * -2147200930 An attempt to call ScaleAudio on a recognition result having
 * previously called GetAlternates. Allowing the call to succeed would result in
 ...
 * -2147200929 The method called is not supported for the shared recognizer. For
 ...
 * -2147200928 A task could not complete because the SR engine had timed out.
 */
#define SPERR_TIMEOUT MAKE_SAPI_ERROR(0x060)

/*** SPERR_REENTER_SYNCHRONIZE                             0x80045061
 * -2147200927 A SR engine called synchronize while inside of a synchronize
 * call.
 */
#define SPERR_REENTER_SYNCHRONIZE MAKE_SAPI_ERROR(0x061)

/*** SPERR_STATE_WITH_NO_ARCS                              0x80045062
 * -2147200926 The grammar contains a node no arcs.
 */
#define SPERR_STATE_WITH_NO_ARCS MAKE_SAPI_ERROR(0x062)

/*** SPERR_NOT_ACTIVE_SESSION                              0x80045063
 * -2147200925 Neither audio output and input is supported for non-active
 * console sessions.
 */
#define SPERR_NOT_ACTIVE_SESSION MAKE_SAPI_ERROR(0x063)

/*** SPERR_ALREADY_DELETED                                 0x80045064
 * -2147200924 The object is a stale reference and is invalid to use. For
 * example having a ISpeechGrammarRule object reference and then calling
 ...
 *   This can be returned from Read or Write calls audio streams when the stream
 * is stopped.
 */
#define SP_AUDIO_STOPPED MAKE_SAPI_SCODE(0x065)

/*** SPERR_RECOXML_GENERATION_FAIL                             0x80045066
 * -2147200922 The Recognition Parse Tree couldn't be genrated. For example,
 * that the rule name begins with a digit. XML parser doesn't allow element name
 * beginning with a digit.
 */
#define SPERR_RECOXML_GENERATION_FAIL MAKE_SAPI_ERROR(0x066)

/*** SPERR_SML_GENERATION_FAIL                             0x80045067
 * -2147200921 The SML couldn't be genrated. For example, the transformation
 * xslt template is not well formed.
 */
#define SPERR_SML_GENERATION_FAIL MAKE_SAPI_ERROR(0x067)

/*** SPERR_NOT_PROMPT_VOICE                                0x80045068
 * -2147200920 The current voice is not a prompt voice, so the ISpPromptVoice
 *   functions don't work.
 */
#define SPERR_NOT_PROMPT_VOICE MAKE_SAPI_ERROR(0x068)

/*** SPERR_ROOTRULE_ALREADY_DEFINED                        0x80045069
 * -2147200919 There is already a root rule for this grammar Defining another
 * root rule will fail.
 */
#define SPERR_ROOTRULE_ALREADY_DEFINED MAKE_SAPI_ERROR(0x069)

/*** SPERR_SCRIPT_DISALLOWED                               0x80045070
 * -2147200912 Support for embedded script not supported because browser
 * security settings have disabled it
 */
#define SPERR_SCRIPT_DISALLOWED MAKE_SAPI_ERROR(0x070)

/*** SPERR_REMOTE_CALL_TIMED_OUT_START                     0x80045071
 * -2147200911 A time out occurred starting the sapi server
 */
#define SPERR_REMOTE_CALL_TIMED_OUT_START MAKE_SAPI_ERROR(0x071)

/*** SPERR_REMOTE_CALL_TIMED_OUT_CONNECT                   0x80045072
 * -2147200910 A timeout occurred obtaining the lock for starting or connecting
 * to sapi server
 */
#define SPERR_REMOTE_CALL_TIMED_OUT_CONNECT MAKE_SAPI_ERROR(0x072)

/*** SPERR_SECMGR_CHANGE_NOT_ALLOWED                       0x80045073
 * -2147200909 When there is a cfg grammar loaded, we don't allow changing the
 * security manager
 */
 ...
 * -2147200899 The word passed to the GetPronunciations interface needs
 * normalizing first
 */
#define SPERR_WORD_NEEDS_NORMALIZATION MAKE_SAPI_ERROR(0x07D)

/*** SPERR_CANNOT_NORMALIZE                                0x8004507E
 * -2147200898 The word passed to the normalize interface cannot be normalized
 */
#define SPERR_CANNOT_NORMALIZE MAKE_SAPI_ERROR(0x07E)

/*** S_LIMIT_REACHED                                       0x0004507F    282751
 *   The word being normalized has generated more than the maximum number of
 * allowed normalized results Indicates that returned list is not exhaustive,
 * but contains as many alternatives as the engine is willing to provide.
 */
 ...
 *   The operation cannot be carried out due to overload and should be attempted
 * again.
 */
