...
DECLARE_INTERFACE_(IDirectInputDevice2W, IDirectInputDeviceW) {
  ...
  STDMETHOD(CreateEffect)(THIS_ REFGUID, LPCDIEFFECT, LPDIRECTINPUTEFFECT *,
                          LPUNKNOWN) PURE;
...
DECLARE_INTERFACE_(IDirectInputDevice7W, IDirectInputDevice2W) {
  ...
  STDMETHOD(EnumEffectsInFile)(THIS_ LPCWSTR, LPDIENUMEFFECTSINFILECALLBACK,
                               LPVOID, DWORD) PURE;
...
DECLARE_INTERFACE_(IDirectInputDevice7A, IDirectInputDevice2A) {
  ...
  STDMETHOD(EnumEffectsInFile)(THIS_ LPCSTR, LPDIENUMEFFECTSINFILECALLBACK,
                               LPVOID, DWORD) PURE;
...
DECLARE_INTERFACE_(IDirectInput8W, IUnknown) {
  ...
  STDMETHOD(EnumDevicesBySemantics)(THIS_ LPCWSTR, LPDIACTIONFORMATW,
                                    LPDIENUMDEVICESBYSEMANTICSCBW, LPVOID,
                                    DWORD) PURE;
  STDMETHOD(ConfigureDevices)(THIS_ LPDICONFIGUREDEVICESCALLBACK,
                              LPDICONFIGUREDEVICESPARAMSW, DWORD, LPVOID) PURE;
};
...
DECLARE_INTERFACE_(IDirectInput8A, IUnknown) {
  ...
  STDMETHOD(EnumDevicesBySemantics)(THIS_ LPCSTR, LPDIACTIONFORMATA,
                                    LPDIENUMDEVICESBYSEMANTICSCBA, LPVOID,
                                    DWORD) PURE;
  STDMETHOD(ConfigureDevices)(THIS_ LPDICONFIGUREDEVICESCALLBACK,
                              LPDICONFIGUREDEVICESPARAMSA, DWORD, LPVOID) PURE;
};
