...
typedef interface ITransactionLastEnlistmentAsync
...
typedef struct ITransactionResourceAsyncVtbl {
  ...
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in ITransactionResourceAsync *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in ITransactionResourceAsync *This);
  ...
  HRESULT(STDMETHODCALLTYPE *TMDown)(__RPC__in ITransactionResourceAsync *This);
...
typedef struct ITransactionResourceVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in ITransactionResource *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in ITransactionResource *This);
  ...
  HRESULT(STDMETHODCALLTYPE *TMDown)(__RPC__in ITransactionResource *This);
...
typedef struct ITransactionEnlistmentAsyncVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in ITransactionEnlistmentAsync *This);
...
public:
  ...
  virtual HRESULT STDMETHODCALLTYPE Create(
      ...
      /* [size_is][in] */ __RPC__in_ecount_full(cbWhereabouts) byte *
          rgbWhereabouts,
...
typedef struct ITransactionExportFactoryVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in ITransactionExportFactory *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in ITransactionExportFactory *This);
...
/* [call_as] */ HRESULT
STDMETHODCALLTYPE ITransactionImportWhereabouts_RemoteGetWhereabouts_Proxy(
    __RPC__in ITransactionImportWhereabouts *This,
...
typedef struct ITransactionExportVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in ITransactionExport *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in ITransactionExport *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in ITransactionExport *This);
...
/* [call_as] */ HRESULT
STDMETHODCALLTYPE ITransactionExport_RemoteGetTransactionCookie_Proxy(
    __RPC__in ITransactionExport *This,
    /* [in] */ __RPC__in_opt IUnknown *punkTransaction,
    /* [out] */ __RPC__out ULONG *pcbUsed,
    /* [in] */ ULONG cbTransactionCookie,
    /* [length_is][size_is][out] */
    __RPC__out_ecount_part(cbTransactionCookie, *pcbUsed)
...
public:
  virtual HRESULT STDMETHODCALLTYPE Import(
      /* [in] */ ULONG cbTransactionCookie,
      /* [size_is][in] */ __RPC__in_ecount_full(cbTransactionCookie) byte *
...
typedef struct ITransactionImportVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in ITransactionImport *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in ITransactionImport *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in ITransactionImport *This);
...
typedef struct ITipTransactionVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in ITipTransaction *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in ITipTransaction *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in ITipTransaction *This);
...
interface ITipTransaction { CONST_VTBL struct ITipTransactionVtbl *lpVtbl; };
...
typedef struct ITipHelperVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in ITipHelper *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in ITipHelper *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in ITipHelper *This);
...
interface ITipHelper { CONST_VTBL struct ITipHelperVtbl *lpVtbl; };
...
#define ITipHelper_PullAsync(This, i_pszTxUrl, i_pTipPullSink,                 \
                             o_ppITransaction)                                 \
  ((This)->lpVtbl->PullAsync(This, i_pszTxUrl, i_pTipPullSink,                 \
                             o_ppITransaction))
...
typedef struct ITipPullSinkVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in ITipPullSink *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in ITipPullSink *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in ITipPullSink *This);

  DECLSPEC_XFGVIRT(ITipPullSink, PullComplete)
  HRESULT(STDMETHODCALLTYPE *PullComplete)(__RPC__in ITipPullSink *This,
                                           /* [in] */ HRESULT i_hrPull);

  END_INTERFACE
} ITipPullSinkVtbl;

interface ITipPullSink { CONST_VTBL struct ITipPullSinkVtbl *lpVtbl; };
...
typedef struct IDtcNetworkAccessConfigVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IDtcNetworkAccessConfig *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IDtcNetworkAccessConfig *This);
...
typedef struct IDtcNetworkAccessConfig2Vtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IDtcNetworkAccessConfig2 *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IDtcNetworkAccessConfig2 *This);
...
typedef struct IDtcNetworkAccessConfig3Vtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IDtcNetworkAccessConfig3 *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IDtcNetworkAccessConfig3 *This);
...
#define IDtcNetworkAccessConfig3_GetNetworkAdministrationAccess(               \
    This, pbNetworkAdministrationAccess)                                       \
  ((This)->lpVtbl->GetNetworkAdministrationAccess(                             \
      This, pbNetworkAdministrationAccess))

#define IDtcNetworkAccessConfig3_SetNetworkAdministrationAccess(               \
    This, bNetworkAdministrationAccess)                                        \
  ((This)->lpVtbl->SetNetworkAdministrationAccess(                             \
      This, bNetworkAdministrationAccess))

#define IDtcNetworkAccessConfig3_GetNetworkTransactionAccess(                  \
    This, pbNetworkTransactionAccess)                                          \
  ((This)->lpVtbl->GetNetworkTransactionAccess(This,                           \
                                               pbNetworkTransactionAccess))

#define IDtcNetworkAccessConfig3_SetNetworkTransactionAccess(                  \
    This, bNetworkTransactionAccess)                                           \
  ((This)->lpVtbl->SetNetworkTransactionAccess(This, bNetworkTransactionAccess))

#define IDtcNetworkAccessConfig3_GetNetworkClientAccess(This,                  \
                                                        pbNetworkClientAccess) \
  ((This)->lpVtbl->GetNetworkClientAccess(This, pbNetworkClientAccess))

#define IDtcNetworkAccessConfig3_SetNetworkClientAccess(This,                  \
                                                        bNetworkClientAccess)  \
  ((This)->lpVtbl->SetNetworkClientAccess(This, bNetworkClientAccess))
...
#define IID_ITransactionLastResourceAsync                                      \
  __uuidof(ITransactionLastResourceAsync)
...
#define IID_ITransactionLastEnlistmentAsync                                    \
  __uuidof(ITransactionLastEnlistmentAsync)
#define IID_ITransactionExportFactory __uuidof(ITransactionExportFactory)
#define IID_ITransactionImportWhereabouts                                      \
...
ITransactionImportWhereabouts_GetWhereabouts_Stub(
    __RPC__in ITransactionImportWhereabouts *This,
    /* [out] */ __RPC__out ULONG *pcbUsed,
    /* [in] */ ULONG cbWhereabouts,
    /* [length_is][size_is][out] */
...
/* [call_as] */ HRESULT STDMETHODCALLTYPE
ITransactionExport_GetTransactionCookie_Stub(
    __RPC__in ITransactionExport *This,
    /* [in] */ __RPC__in_opt IUnknown *punkTransaction,
    /* [out] */ __RPC__out ULONG *pcbUsed,
    /* [in] */ ULONG cbTransactionCookie,
