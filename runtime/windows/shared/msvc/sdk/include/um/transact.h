...
typedef struct ITransactionVtbl {
  ...
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in ITransaction *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in ITransaction *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in ITransaction *This);

  DECLSPEC_XFGVIRT(ITransaction, Commit)
  HRESULT(STDMETHODCALLTYPE *Commit)(__RPC__in ITransaction *This,
                                     /* [in] */ BOOL fRetaining,
                                     /* [in] */ DWORD grfTC,
                                     /* [in] */ DWORD grfRM);
...
interface ITransaction { CONST_VTBL struct ITransactionVtbl *lpVtbl; };
...
typedef struct ITransactionClonerVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in ITransactionCloner *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in ITransactionCloner *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in ITransactionCloner *This);

  DECLSPEC_XFGVIRT(ITransaction, Commit)
  HRESULT(STDMETHODCALLTYPE *Commit)(__RPC__in ITransactionCloner *This,
                                     /* [in] */ BOOL fRetaining,
                                     /* [in] */ DWORD grfTC,
                                     /* [in] */ DWORD grfRM);
...
typedef struct ITransaction2Vtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in ITransaction2 *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in ITransaction2 *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in ITransaction2 *This);

  DECLSPEC_XFGVIRT(ITransaction, Commit)
  HRESULT(STDMETHODCALLTYPE *Commit)(__RPC__in ITransaction2 *This,
                                     /* [in] */ BOOL fRetaining,
                                     /* [in] */ DWORD grfTC,
                                     /* [in] */ DWORD grfRM);
...
interface ITransaction2 { CONST_VTBL struct ITransaction2Vtbl *lpVtbl; };
...
typedef struct ITransactionDispenserVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in ITransactionDispenser *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in ITransactionDispenser *This);
...
typedef struct ITransactionOptionsVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in ITransactionOptions *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in ITransactionOptions *This);
...
typedef struct ITransactionOutcomeEventsVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in ITransactionOutcomeEvents *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in ITransactionOutcomeEvents *This);
...
typedef struct ITmNodeNameVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in ITmNodeName *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in ITmNodeName *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in ITmNodeName *This);
...
interface ITmNodeName { CONST_VTBL struct ITmNodeNameVtbl *lpVtbl; };
...
typedef struct IKernelTransactionVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(IKernelTransaction *This,
                                             /* [in] */ REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);
  ...
  HRESULT(STDMETHODCALLTYPE *GetHandle)(IKernelTransaction *This,
                                        /* [out] */ HANDLE *pHandle);
...
DEFINE_GUID(IID_ITmNodeName, 0x30274F88, 0x6EE4, 0x474e, 0x9B, 0x95, 0x78, 0x07,
            0xBC, 0x9E, 0xF8, 0xCF);
DEFINE_GUID(IID_IKernelTransaction, 0x79427a2b, 0xf895, 0x40e0, 0xbe, 0x79,
            0xb5, 0x7d, 0xc8, 0x2e, 0xd2, 0x31);
