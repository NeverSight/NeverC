...
typedef interface IComprehensiveSpellCheckProvider
...
typedef struct ISpellCheckProviderVtbl {
  ...
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in ISpellCheckProvider *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in ISpellCheckProvider *This);
...
#define ISpellCheckProvider_AddRef(This) ((This)->lpVtbl->AddRef(This))

#define ISpellCheckProvider_Release(This) ((This)->lpVtbl->Release(This))
...
public:
  ...
  virtual HRESULT STDMETHODCALLTYPE CreateSpellCheckProvider(
      /* [in] */ __RPC__in LPCWSTR languageTag,
      /* [retval][out] */ __RPC__deref_out_opt ISpellCheckProvider *
          *value) = 0;
};
...
typedef struct ISpellCheckProviderFactoryVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in ISpellCheckProviderFactory *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in ISpellCheckProviderFactory *This);
...
#define ISpellCheckProviderFactory_AddRef(This) ((This)->lpVtbl->AddRef(This))

#define ISpellCheckProviderFactory_Release(This) ((This)->lpVtbl->Release(This))
...
#define ISpellCheckProviderFactory_CreateSpellCheckProvider(This, languageTag, \
                                                            value)             \
