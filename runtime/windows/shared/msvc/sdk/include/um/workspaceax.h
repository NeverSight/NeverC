...
typedef struct IWorkspaceResTypeRegistryVtbl {
  ...
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IWorkspaceResTypeRegistry *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IWorkspaceResTypeRegistry *This);
  ...
  /* [helpstring][id] */ HRESULT(
      STDMETHODCALLTYPE *GetRegisteredFileExtensions)(
      __RPC__in IWorkspaceResTypeRegistry *This,
      /* [in] */ VARIANT_BOOL fMachineWide,
...
#define IWorkspaceResTypeRegistry_GetIDsOfNames(This, riid, rgszNames, cNames, \
                                                lcid, rgDispId)                \
  ((This)->lpVtbl->GetIDsOfNames(This, riid, rgszNames, cNames, lcid, rgDispId))

#define IWorkspaceResTypeRegistry_Invoke(This, dispIdMember, riid, lcid,       \
                                         wFlags, pDispParams, pVarResult,      \
                                         pExcepInfo, puArgErr)                 \
  ((This)->lpVtbl->Invoke(This, dispIdMember, riid, lcid, wFlags, pDispParams, \
                          pVarResult, pExcepInfo, puArgErr))

#define IWorkspaceResTypeRegistry_AddResourceType(                             \
    This, fMachineWide, bstrFileExtension, bstrLauncher)                       \
  ((This)->lpVtbl->AddResourceType(This, fMachineWide, bstrFileExtension,      \
                                   bstrLauncher))

#define IWorkspaceResTypeRegistry_DeleteResourceType(This, fMachineWide,       \
                                                     bstrFileExtension)        \
  ((This)->lpVtbl->DeleteResourceType(This, fMachineWide, bstrFileExtension))

#define IWorkspaceResTypeRegistry_GetRegisteredFileExtensions(                 \
    This, fMachineWide, psaFileExtensions)                                     \
  ((This)->lpVtbl->GetRegisteredFileExtensions(This, fMachineWide,             \
                                               psaFileExtensions))

#define IWorkspaceResTypeRegistry_GetResourceTypeInfo(                         \
    This, fMachineWide, bstrFileExtension, pbstrLauncher)                      \
  ((This)->lpVtbl->GetResourceTypeInfo(This, fMachineWide, bstrFileExtension,  \
                                       pbstrLauncher))

#define IWorkspaceResTypeRegistry_ModifyResourceType(                          \
    This, fMachineWide, bstrFileExtension, bstrLauncher)                       \
  ((This)->lpVtbl->ModifyResourceType(This, fMachineWide, bstrFileExtension,   \
                                      bstrLauncher))
