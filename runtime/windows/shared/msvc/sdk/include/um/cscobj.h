...
typedef interface IOfflineFilesSyncConflictHandler
...
typedef interface IOfflineFilesTransparentCacheInfo
...
typedef enum tagOFFLINEFILES_CONNECT_STATE {
  ...
  OFFLINEFILES_CONNECT_STATE_TRANSPARENTLY_CACHED =
      (OFFLINEFILES_CONNECT_STATE_ONLINE + 1),
  OFFLINEFILES_CONNECT_STATE_PARTLY_TRANSPARENTLY_CACHED =
      (OFFLINEFILES_CONNECT_STATE_TRANSPARENTLY_CACHED + 1)
...
typedef enum tagOFFLINEFILES_OFFLINE_REASON {
  ...
  OFFLINEFILES_OFFLINE_REASON_NOT_APPLICABLE =
      (OFFLINEFILES_OFFLINE_REASON_UNKNOWN + 1),
  ...
  OFFLINEFILES_OFFLINE_REASON_CONNECTION_SLOW =
      (OFFLINEFILES_OFFLINE_REASON_CONNECTION_FORCED + 1),
  OFFLINEFILES_OFFLINE_REASON_CONNECTION_ERROR =
      (OFFLINEFILES_OFFLINE_REASON_CONNECTION_SLOW + 1),
  OFFLINEFILES_OFFLINE_REASON_ITEM_VERSION_CONFLICT =
      (OFFLINEFILES_OFFLINE_REASON_CONNECTION_ERROR + 1),
  OFFLINEFILES_OFFLINE_REASON_ITEM_SUSPENDED =
      (OFFLINEFILES_OFFLINE_REASON_ITEM_VERSION_CONFLICT + 1)
...
typedef enum tagOFFLINEFILES_CACHING_MODE {
  ...
  OFFLINEFILES_CACHING_MODE_AUTO_PROGANDDOC =
      (OFFLINEFILES_CACHING_MODE_AUTO_DOC + 1)
...
typedef enum tagOFFLINEFILES_EVENTS {
  ...
  OFFLINEFILES_EVENT_SYNCCONFLICTRECADDED =
      (OFFLINEFILES_EVENT_SYNCFILERESULT + 1),
  OFFLINEFILES_EVENT_SYNCCONFLICTRECUPDATED =
      (OFFLINEFILES_EVENT_SYNCCONFLICTRECADDED + 1),
  OFFLINEFILES_EVENT_SYNCCONFLICTRECREMOVED =
      (OFFLINEFILES_EVENT_SYNCCONFLICTRECUPDATED + 1),
  ...
  OFFLINEFILES_EVENT_BACKGROUNDSYNCEND =
      (OFFLINEFILES_EVENT_BACKGROUNDSYNCBEGIN + 1),
  OFFLINEFILES_EVENT_NETTRANSPORTARRIVED =
      (OFFLINEFILES_EVENT_BACKGROUNDSYNCEND + 1),
  OFFLINEFILES_EVENT_NONETTRANSPORTS =
      (OFFLINEFILES_EVENT_NETTRANSPORTARRIVED + 1),
  OFFLINEFILES_EVENT_ITEMDISCONNECTED =
      (OFFLINEFILES_EVENT_NONETTRANSPORTS + 1),
  OFFLINEFILES_EVENT_ITEMRECONNECTED =
      (OFFLINEFILES_EVENT_ITEMDISCONNECTED + 1),
  OFFLINEFILES_EVENT_ITEMAVAILABLEOFFLINE =
      (OFFLINEFILES_EVENT_ITEMRECONNECTED + 1),
  OFFLINEFILES_EVENT_ITEMNOTAVAILABLEOFFLINE =
      (OFFLINEFILES_EVENT_ITEMAVAILABLEOFFLINE + 1),
  OFFLINEFILES_EVENT_ITEMPINNED =
      (OFFLINEFILES_EVENT_ITEMNOTAVAILABLEOFFLINE + 1),
  ...
  OFFLINEFILES_EVENT_ITEMDELETEDFROMCACHE =
      (OFFLINEFILES_EVENT_ITEMADDEDTOCACHE + 1),
  OFFLINEFILES_EVENT_ITEMRENAMED =
      (OFFLINEFILES_EVENT_ITEMDELETEDFROMCACHE + 1),
...
typedef enum tagOFFLINEFILES_PATHFILTER_MATCH {
  ...
  OFFLINEFILES_PATHFILTER_SELFORCHILD =
      (OFFLINEFILES_PATHFILTER_DESCENDENT + 1),
  OFFLINEFILES_PATHFILTER_SELFORDESCENDENT =
      (OFFLINEFILES_PATHFILTER_SELFORCHILD + 1)
...
typedef enum tagOFFLINEFILES_SYNC_CONFLICT_RESOLVE {
  ...
  OFFLINEFILES_SYNC_CONFLICT_RESOLVE_KEEPLOCAL =
      (OFFLINEFILES_SYNC_CONFLICT_RESOLVE_NONE + 1),
  ...
  OFFLINEFILES_SYNC_CONFLICT_RESOLVE_KEEPALLCHANGES =
      (OFFLINEFILES_SYNC_CONFLICT_RESOLVE_KEEPREMOTE + 1),
  OFFLINEFILES_SYNC_CONFLICT_RESOLVE_KEEPLATEST =
      (OFFLINEFILES_SYNC_CONFLICT_RESOLVE_KEEPALLCHANGES + 1),
  OFFLINEFILES_SYNC_CONFLICT_RESOLVE_LOG =
      (OFFLINEFILES_SYNC_CONFLICT_RESOLVE_KEEPLATEST + 1),
  OFFLINEFILES_SYNC_CONFLICT_RESOLVE_SKIP =
      (OFFLINEFILES_SYNC_CONFLICT_RESOLVE_LOG + 1),
  OFFLINEFILES_SYNC_CONFLICT_ABORT =
      (OFFLINEFILES_SYNC_CONFLICT_RESOLVE_SKIP + 1),
  OFFLINEFILES_SYNC_CONFLICT_RESOLVE_NUMCODES =
      (OFFLINEFILES_SYNC_CONFLICT_ABORT + 1)
} OFFLINEFILES_SYNC_CONFLICT_RESOLVE;

#define OFFLINEFILES_SYNC_CONFLICT_RESOLVE_LATER                               \
  OFFLINEFILES_SYNC_CONFLICT_RESOLVE_LOG
...
#define OFFLINEFILES_ITEM_FILTER_FLAGS                                           \
...
#define OFFLINEFILES_ITEM_QUERY_FLAGS                                          \
...
#define OFFLINEFILES_ENUM_FLAGS                                                \
  ((OFFLINEFILES_ENUM_FLAT | OFFLINEFILES_ENUM_FLAT_FILESONLY))
...
typedef enum tagOFFLINEFILES_SETTING_VALUE_TYPE {
  ...
  OFFLINEFILES_SETTING_VALUE_2DIM_ARRAY_BSTR_UI4 =
      (OFFLINEFILES_SETTING_VALUE_BSTR_DBLNULTERM + 1),
  OFFLINEFILES_SETTING_VALUE_2DIM_ARRAY_BSTR_BSTR =
      (OFFLINEFILES_SETTING_VALUE_2DIM_ARRAY_BSTR_UI4 + 1)
...
#define OFFLINEFILES_SYNC_CONTROL_FLAGS                                        \
...
#define OFFLINEFILES_PIN_CONTROL_FLAG_FORUSER                                  \
  (OFFLINEFILES_SYNC_CONTROL_FLAG_PINFORUSER)

#define OFFLINEFILES_PIN_CONTROL_FLAG_FORUSER_POLICY                           \
  (OFFLINEFILES_SYNC_CONTROL_FLAG_PINFORUSER_POLICY)

#define OFFLINEFILES_PIN_CONTROL_FLAG_FORALL                                   \
  (OFFLINEFILES_SYNC_CONTROL_FLAG_PINFORALL)

#define OFFLINEFILES_PIN_CONTROL_FLAG_FORREDIR                                 \
  (OFFLINEFILES_SYNC_CONTROL_FLAG_PINFORREDIR)

#define OFFLINEFILES_PIN_CONTROL_FLAG_FILL                                     \
  (OFFLINEFILES_SYNC_CONTROL_FLAG_FILLSPARSE)

#define OFFLINEFILES_PIN_CONTROL_FLAG_LOWPRIORITY                              \
  (OFFLINEFILES_SYNC_CONTROL_FLAG_LOWPRIORITY)

#define OFFLINEFILES_PIN_CONTROL_FLAG_ASYNCPROGRESS                            \
  (OFFLINEFILES_SYNC_CONTROL_FLAG_ASYNCPROGRESS)

#define OFFLINEFILES_PIN_CONTROL_FLAG_INTERACTIVE                              \
  (OFFLINEFILES_SYNC_CONTROL_FLAG_INTERACTIVE)

#define OFFLINEFILES_PIN_CONTROL_FLAG_CONSOLE                                  \
  (OFFLINEFILES_SYNC_CONTROL_FLAG_CONSOLE)

#define OFFLINEFILES_PIN_CONTROL_FLAG_PINLINKTARGETS                           \
  (OFFLINEFILES_SYNC_CONTROL_FLAG_PINLINKTARGETS)

#define OFFLINEFILES_PIN_CONTROL_FLAG_BACKGROUND                               \
  (OFFLINEFILES_SYNC_CONTROL_FLAG_BACKGROUND)
...
#define OFFLINEFILES_ENCRYPTION_CONTROL_FLAG_ASYNCPROGRESS                     \
  (OFFLINEFILES_SYNC_CONTROL_FLAG_ASYNCPROGRESS)

#define OFFLINEFILES_ENCRYPTION_CONTROL_FLAG_INTERACTIVE                       \
  (OFFLINEFILES_SYNC_CONTROL_FLAG_INTERACTIVE)

#define OFFLINEFILES_ENCRYPTION_CONTROL_FLAG_CONSOLE                           \
  (OFFLINEFILES_SYNC_CONTROL_FLAG_CONSOLE)

#define OFFLINEFILES_ENCRYPTION_CONTROL_FLAG_BACKGROUND                        \
  (OFFLINEFILES_SYNC_CONTROL_FLAG_BACKGROUND)

#define OFFLINEFILES_ENCRYPTION_CONTROL_FLAGS                                  \
...
#define OFFLINEFILES_DELETE_FLAGS                                              \
...
#define OFFLINEFILES_TRANSITION_FLAGS                                          \
...
typedef enum tagOFFLINEFILES_SYNC_OPERATION {
  ...
  OFFLINEFILES_SYNC_OPERATION_CREATE_COPY_ON_CLIENT =
      (OFFLINEFILES_SYNC_OPERATION_CREATE_COPY_ON_SERVER + 1),
  ...
  OFFLINEFILES_SYNC_OPERATION_SYNC_TO_CLIENT =
      (OFFLINEFILES_SYNC_OPERATION_SYNC_TO_SERVER + 1),
  OFFLINEFILES_SYNC_OPERATION_DELETE_SERVER_COPY =
      (OFFLINEFILES_SYNC_OPERATION_SYNC_TO_CLIENT + 1),
  OFFLINEFILES_SYNC_OPERATION_DELETE_CLIENT_COPY =
      (OFFLINEFILES_SYNC_OPERATION_DELETE_SERVER_COPY + 1),
  OFFLINEFILES_SYNC_OPERATION_PIN =
      (OFFLINEFILES_SYNC_OPERATION_DELETE_CLIENT_COPY + 1),
...
typedef enum tagOFFLINEFILES_SYNC_STATE {
  ...
  OFFLINEFILES_SYNC_STATE_FileOnClient_DirOnServer =
      (OFFLINEFILES_SYNC_STATE_Stable + 1),
  ...
  OFFLINEFILES_SYNC_STATE_DirOnClient_FileOnServer =
      (OFFLINEFILES_SYNC_STATE_FileOnClient_NoServerCopy + 1),
  OFFLINEFILES_SYNC_STATE_DirOnClient_FileChangedOnServer =
      (OFFLINEFILES_SYNC_STATE_DirOnClient_FileOnServer + 1),
  OFFLINEFILES_SYNC_STATE_DirOnClient_NoServerCopy =
      (OFFLINEFILES_SYNC_STATE_DirOnClient_FileChangedOnServer + 1),
  OFFLINEFILES_SYNC_STATE_FileCreatedOnClient_NoServerCopy =
      (OFFLINEFILES_SYNC_STATE_DirOnClient_NoServerCopy + 1),
  OFFLINEFILES_SYNC_STATE_FileCreatedOnClient_FileChangedOnServer =
      (OFFLINEFILES_SYNC_STATE_FileCreatedOnClient_NoServerCopy + 1),
  OFFLINEFILES_SYNC_STATE_FileCreatedOnClient_DirChangedOnServer =
      (OFFLINEFILES_SYNC_STATE_FileCreatedOnClient_FileChangedOnServer + 1),
  OFFLINEFILES_SYNC_STATE_FileCreatedOnClient_FileOnServer =
      (OFFLINEFILES_SYNC_STATE_FileCreatedOnClient_DirChangedOnServer + 1),
  OFFLINEFILES_SYNC_STATE_FileCreatedOnClient_DirOnServer =
      (OFFLINEFILES_SYNC_STATE_FileCreatedOnClient_FileOnServer + 1),
  OFFLINEFILES_SYNC_STATE_FileCreatedOnClient_DeletedOnServer =
      (OFFLINEFILES_SYNC_STATE_FileCreatedOnClient_DirOnServer + 1),
  OFFLINEFILES_SYNC_STATE_FileChangedOnClient_ChangedOnServer =
      (OFFLINEFILES_SYNC_STATE_FileCreatedOnClient_DeletedOnServer + 1),
  OFFLINEFILES_SYNC_STATE_FileChangedOnClient_DirOnServer =
      (OFFLINEFILES_SYNC_STATE_FileChangedOnClient_ChangedOnServer + 1),
  OFFLINEFILES_SYNC_STATE_FileChangedOnClient_DirChangedOnServer =
      (OFFLINEFILES_SYNC_STATE_FileChangedOnClient_DirOnServer + 1),
  OFFLINEFILES_SYNC_STATE_FileChangedOnClient_DeletedOnServer =
      (OFFLINEFILES_SYNC_STATE_FileChangedOnClient_DirChangedOnServer + 1),
  OFFLINEFILES_SYNC_STATE_FileSparseOnClient_ChangedOnServer =
      (OFFLINEFILES_SYNC_STATE_FileChangedOnClient_DeletedOnServer + 1),
  OFFLINEFILES_SYNC_STATE_FileSparseOnClient_DeletedOnServer =
      (OFFLINEFILES_SYNC_STATE_FileSparseOnClient_ChangedOnServer + 1),
  OFFLINEFILES_SYNC_STATE_FileSparseOnClient_DirOnServer =
      (OFFLINEFILES_SYNC_STATE_FileSparseOnClient_DeletedOnServer + 1),
  OFFLINEFILES_SYNC_STATE_FileSparseOnClient_DirChangedOnServer =
      (OFFLINEFILES_SYNC_STATE_FileSparseOnClient_DirOnServer + 1),
  OFFLINEFILES_SYNC_STATE_DirCreatedOnClient_NoServerCopy =
      (OFFLINEFILES_SYNC_STATE_FileSparseOnClient_DirChangedOnServer + 1),
  OFFLINEFILES_SYNC_STATE_DirCreatedOnClient_DirOnServer =
      (OFFLINEFILES_SYNC_STATE_DirCreatedOnClient_NoServerCopy + 1),
  OFFLINEFILES_SYNC_STATE_DirCreatedOnClient_FileOnServer =
      (OFFLINEFILES_SYNC_STATE_DirCreatedOnClient_DirOnServer + 1),
  OFFLINEFILES_SYNC_STATE_DirCreatedOnClient_FileChangedOnServer =
      (OFFLINEFILES_SYNC_STATE_DirCreatedOnClient_FileOnServer + 1),
  OFFLINEFILES_SYNC_STATE_DirCreatedOnClient_DirChangedOnServer =
      (OFFLINEFILES_SYNC_STATE_DirCreatedOnClient_FileChangedOnServer + 1),
  OFFLINEFILES_SYNC_STATE_DirCreatedOnClient_DeletedOnServer =
      (OFFLINEFILES_SYNC_STATE_DirCreatedOnClient_DirChangedOnServer + 1),
  OFFLINEFILES_SYNC_STATE_DirChangedOnClient_FileOnServer =
      (OFFLINEFILES_SYNC_STATE_DirCreatedOnClient_DeletedOnServer + 1),
  OFFLINEFILES_SYNC_STATE_DirChangedOnClient_FileChangedOnServer =
      (OFFLINEFILES_SYNC_STATE_DirChangedOnClient_FileOnServer + 1),
  OFFLINEFILES_SYNC_STATE_DirChangedOnClient_ChangedOnServer =
      (OFFLINEFILES_SYNC_STATE_DirChangedOnClient_FileChangedOnServer + 1),
  OFFLINEFILES_SYNC_STATE_DirChangedOnClient_DeletedOnServer =
      (OFFLINEFILES_SYNC_STATE_DirChangedOnClient_ChangedOnServer + 1),
  OFFLINEFILES_SYNC_STATE_NoClientCopy_FileOnServer =
      (OFFLINEFILES_SYNC_STATE_DirChangedOnClient_DeletedOnServer + 1),
  OFFLINEFILES_SYNC_STATE_NoClientCopy_DirOnServer =
      (OFFLINEFILES_SYNC_STATE_NoClientCopy_FileOnServer + 1),
  OFFLINEFILES_SYNC_STATE_NoClientCopy_FileChangedOnServer =
      (OFFLINEFILES_SYNC_STATE_NoClientCopy_DirOnServer + 1),
  OFFLINEFILES_SYNC_STATE_NoClientCopy_DirChangedOnServer =
      (OFFLINEFILES_SYNC_STATE_NoClientCopy_FileChangedOnServer + 1),
  OFFLINEFILES_SYNC_STATE_DeletedOnClient_FileOnServer =
      (OFFLINEFILES_SYNC_STATE_NoClientCopy_DirChangedOnServer + 1),
  OFFLINEFILES_SYNC_STATE_DeletedOnClient_DirOnServer =
      (OFFLINEFILES_SYNC_STATE_DeletedOnClient_FileOnServer + 1),
  OFFLINEFILES_SYNC_STATE_DeletedOnClient_FileChangedOnServer =
      (OFFLINEFILES_SYNC_STATE_DeletedOnClient_DirOnServer + 1),
  OFFLINEFILES_SYNC_STATE_DeletedOnClient_DirChangedOnServer =
      (OFFLINEFILES_SYNC_STATE_DeletedOnClient_FileChangedOnServer + 1),
  OFFLINEFILES_SYNC_STATE_FileSparseOnClient =
      (OFFLINEFILES_SYNC_STATE_DeletedOnClient_DirChangedOnServer + 1),
  OFFLINEFILES_SYNC_STATE_FileChangedOnClient =
      (OFFLINEFILES_SYNC_STATE_FileSparseOnClient + 1),
  OFFLINEFILES_SYNC_STATE_FileRenamedOnClient =
      (OFFLINEFILES_SYNC_STATE_FileChangedOnClient + 1),
  OFFLINEFILES_SYNC_STATE_DirSparseOnClient =
      (OFFLINEFILES_SYNC_STATE_FileRenamedOnClient + 1),
  OFFLINEFILES_SYNC_STATE_DirChangedOnClient =
      (OFFLINEFILES_SYNC_STATE_DirSparseOnClient + 1),
  OFFLINEFILES_SYNC_STATE_DirRenamedOnClient =
      (OFFLINEFILES_SYNC_STATE_DirChangedOnClient + 1),
  OFFLINEFILES_SYNC_STATE_FileChangedOnServer =
      (OFFLINEFILES_SYNC_STATE_DirRenamedOnClient + 1),
  OFFLINEFILES_SYNC_STATE_FileRenamedOnServer =
      (OFFLINEFILES_SYNC_STATE_FileChangedOnServer + 1),
  OFFLINEFILES_SYNC_STATE_FileDeletedOnServer =
      (OFFLINEFILES_SYNC_STATE_FileRenamedOnServer + 1),
  OFFLINEFILES_SYNC_STATE_DirChangedOnServer =
      (OFFLINEFILES_SYNC_STATE_FileDeletedOnServer + 1),
  OFFLINEFILES_SYNC_STATE_DirRenamedOnServer =
      (OFFLINEFILES_SYNC_STATE_DirChangedOnServer + 1),
  OFFLINEFILES_SYNC_STATE_DirDeletedOnServer =
      (OFFLINEFILES_SYNC_STATE_DirRenamedOnServer + 1),
  OFFLINEFILES_SYNC_STATE_FileReplacedAndDeletedOnClient_FileOnServer =
      (OFFLINEFILES_SYNC_STATE_DirDeletedOnServer + 1),
  OFFLINEFILES_SYNC_STATE_FileReplacedAndDeletedOnClient_FileChangedOnServer =
      (OFFLINEFILES_SYNC_STATE_FileReplacedAndDeletedOnClient_FileOnServer + 1),
  ...
  OFFLINEFILES_SYNC_STATE_FileReplacedAndDeletedOnClient_DirChangedOnServer =
      (OFFLINEFILES_SYNC_STATE_FileReplacedAndDeletedOnClient_DirOnServer + 1),
...
typedef struct IOfflineFilesEventsVtbl {
  ...
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IOfflineFilesEvents *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IOfflineFilesEvents *This);
  ...
  HRESULT(STDMETHODCALLTYPE *CacheIsFull)(__RPC__in IOfflineFilesEvents *This);
  ...
  HRESULT(STDMETHODCALLTYPE *Enabled)(__RPC__in IOfflineFilesEvents *This,
                                      /* [in] */ BOOL bEnabled);
  ...
  HRESULT(STDMETHODCALLTYPE *SyncBegin)(__RPC__in IOfflineFilesEvents *This,
                                        /* [in] */ __RPC__in REFGUID rSyncId);
  ...
  HRESULT(STDMETHODCALLTYPE *SyncEnd)(__RPC__in IOfflineFilesEvents *This,
                                      /* [in] */ __RPC__in REFGUID rSyncId,
                                      /* [in] */ HRESULT hrResult);
  ...
  HRESULT(STDMETHODCALLTYPE *DataLost)(__RPC__in IOfflineFilesEvents *This);

  DECLSPEC_XFGVIRT(IOfflineFilesEvents, Ping)
  HRESULT(STDMETHODCALLTYPE *Ping)(__RPC__in IOfflineFilesEvents *This);
...
#define IOfflineFilesEvents_EncryptionChanged(                                 \
    This, bWasEncrypted, bWasPartial, bIsEncrypted, bIsPartial)                \
  ((This)->lpVtbl->EncryptionChanged(This, bWasEncrypted, bWasPartial,         \
                                     bIsEncrypted, bIsPartial))
...
#define IOfflineFilesEvents_SyncConflictRecAdded(                              \
    This, pszConflictPath, pftConflictDateTime, ConflictSyncState)             \
  ((This)->lpVtbl->SyncConflictRecAdded(                                       \
      This, pszConflictPath, pftConflictDateTime, ConflictSyncState))

#define IOfflineFilesEvents_SyncConflictRecUpdated(                            \
    This, pszConflictPath, pftConflictDateTime, ConflictSyncState)             \
  ((This)->lpVtbl->SyncConflictRecUpdated(                                     \
      This, pszConflictPath, pftConflictDateTime, ConflictSyncState))

#define IOfflineFilesEvents_SyncConflictRecRemoved(                            \
    This, pszConflictPath, pftConflictDateTime, ConflictSyncState)             \
  ((This)->lpVtbl->SyncConflictRecRemoved(                                     \
      This, pszConflictPath, pftConflictDateTime, ConflictSyncState))
...
#define IOfflineFilesEvents_ItemModified(This, pszPath, ItemType,              \
                                         bModifiedData, bModifiedAttributes)   \
  ((This)->lpVtbl->ItemModified(This, pszPath, ItemType, bModifiedData,        \
                                bModifiedAttributes))
...
#define IOfflineFilesEvents_ItemRenamed(This, pszOldPath, pszNewPath,          \
                                        ItemType)                              \
...
typedef struct IOfflineFilesEvents2Vtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IOfflineFilesEvents2 *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IOfflineFilesEvents2 *This);
  ...
  DECLSPEC_XFGVIRT(IOfflineFilesEvents, CacheIsFull)
  HRESULT(STDMETHODCALLTYPE *CacheIsFull)(__RPC__in IOfflineFilesEvents2 *This);
  ...
  DECLSPEC_XFGVIRT(IOfflineFilesEvents, Enabled)
  HRESULT(STDMETHODCALLTYPE *Enabled)(__RPC__in IOfflineFilesEvents2 *This,
                                      /* [in] */ BOOL bEnabled);
  ...
  DECLSPEC_XFGVIRT(IOfflineFilesEvents, SyncBegin)
  HRESULT(STDMETHODCALLTYPE *SyncBegin)(__RPC__in IOfflineFilesEvents2 *This,
                                        /* [in] */ __RPC__in REFGUID rSyncId);
  ...
  DECLSPEC_XFGVIRT(IOfflineFilesEvents, SyncEnd)
  HRESULT(STDMETHODCALLTYPE *SyncEnd)(__RPC__in IOfflineFilesEvents2 *This,
                                      /* [in] */ __RPC__in REFGUID rSyncId,
                                      /* [in] */ HRESULT hrResult);
  ...
  DECLSPEC_XFGVIRT(IOfflineFilesEvents, DataLost)
  HRESULT(STDMETHODCALLTYPE *DataLost)(__RPC__in IOfflineFilesEvents2 *This);

  DECLSPEC_XFGVIRT(IOfflineFilesEvents, Ping)
  HRESULT(STDMETHODCALLTYPE *Ping)(__RPC__in IOfflineFilesEvents2 *This);
...
#define IOfflineFilesEvents2_EncryptionChanged(                                \
    This, bWasEncrypted, bWasPartial, bIsEncrypted, bIsPartial)                \
  ((This)->lpVtbl->EncryptionChanged(This, bWasEncrypted, bWasPartial,         \
                                     bIsEncrypted, bIsPartial))
...
#define IOfflineFilesEvents2_SyncConflictRecAdded(                             \
    This, pszConflictPath, pftConflictDateTime, ConflictSyncState)             \
  ((This)->lpVtbl->SyncConflictRecAdded(                                       \
      This, pszConflictPath, pftConflictDateTime, ConflictSyncState))

#define IOfflineFilesEvents2_SyncConflictRecUpdated(                           \
    This, pszConflictPath, pftConflictDateTime, ConflictSyncState)             \
  ((This)->lpVtbl->SyncConflictRecUpdated(                                     \
      This, pszConflictPath, pftConflictDateTime, ConflictSyncState))

#define IOfflineFilesEvents2_SyncConflictRecRemoved(                           \
    This, pszConflictPath, pftConflictDateTime, ConflictSyncState)             \
  ((This)->lpVtbl->SyncConflictRecRemoved(                                     \
      This, pszConflictPath, pftConflictDateTime, ConflictSyncState))
...
#define IOfflineFilesEvents2_ItemModified(This, pszPath, ItemType,             \
                                          bModifiedData, bModifiedAttributes)  \
  ((This)->lpVtbl->ItemModified(This, pszPath, ItemType, bModifiedData,        \
                                bModifiedAttributes))
...
#define IOfflineFilesEvents2_ItemRenamed(This, pszOldPath, pszNewPath,         \
                                         ItemType)                             \
  ((This)->lpVtbl->ItemRenamed(This, pszOldPath, pszNewPath, ItemType))
...
typedef struct IOfflineFilesEvents3Vtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IOfflineFilesEvents3 *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IOfflineFilesEvents3 *This);
  ...
  DECLSPEC_XFGVIRT(IOfflineFilesEvents, CacheIsFull)
  HRESULT(STDMETHODCALLTYPE *CacheIsFull)(__RPC__in IOfflineFilesEvents3 *This);
  ...
  DECLSPEC_XFGVIRT(IOfflineFilesEvents, Enabled)
  HRESULT(STDMETHODCALLTYPE *Enabled)(__RPC__in IOfflineFilesEvents3 *This,
                                      /* [in] */ BOOL bEnabled);
  ...
  DECLSPEC_XFGVIRT(IOfflineFilesEvents, SyncBegin)
  HRESULT(STDMETHODCALLTYPE *SyncBegin)(__RPC__in IOfflineFilesEvents3 *This,
                                        /* [in] */ __RPC__in REFGUID rSyncId);
  ...
  DECLSPEC_XFGVIRT(IOfflineFilesEvents, SyncEnd)
  HRESULT(STDMETHODCALLTYPE *SyncEnd)(__RPC__in IOfflineFilesEvents3 *This,
                                      /* [in] */ __RPC__in REFGUID rSyncId,
                                      /* [in] */ HRESULT hrResult);
  ...
  DECLSPEC_XFGVIRT(IOfflineFilesEvents, DataLost)
  HRESULT(STDMETHODCALLTYPE *DataLost)(__RPC__in IOfflineFilesEvents3 *This);

  DECLSPEC_XFGVIRT(IOfflineFilesEvents, Ping)
  HRESULT(STDMETHODCALLTYPE *Ping)(__RPC__in IOfflineFilesEvents3 *This);
...
#define IOfflineFilesEvents3_EncryptionChanged(                                \
    This, bWasEncrypted, bWasPartial, bIsEncrypted, bIsPartial)                \
  ((This)->lpVtbl->EncryptionChanged(This, bWasEncrypted, bWasPartial,         \
                                     bIsEncrypted, bIsPartial))
...
#define IOfflineFilesEvents3_SyncConflictRecAdded(                             \
    This, pszConflictPath, pftConflictDateTime, ConflictSyncState)             \
  ((This)->lpVtbl->SyncConflictRecAdded(                                       \
      This, pszConflictPath, pftConflictDateTime, ConflictSyncState))

#define IOfflineFilesEvents3_SyncConflictRecUpdated(                           \
    This, pszConflictPath, pftConflictDateTime, ConflictSyncState)             \
  ((This)->lpVtbl->SyncConflictRecUpdated(                                     \
      This, pszConflictPath, pftConflictDateTime, ConflictSyncState))

#define IOfflineFilesEvents3_SyncConflictRecRemoved(                           \
    This, pszConflictPath, pftConflictDateTime, ConflictSyncState)             \
  ((This)->lpVtbl->SyncConflictRecRemoved(                                     \
      This, pszConflictPath, pftConflictDateTime, ConflictSyncState))
...
#define IOfflineFilesEvents3_ItemModified(This, pszPath, ItemType,             \
                                          bModifiedData, bModifiedAttributes)  \
  ((This)->lpVtbl->ItemModified(This, pszPath, ItemType, bModifiedData,        \
                                bModifiedAttributes))
...
#define IOfflineFilesEvents3_ItemRenamed(This, pszOldPath, pszNewPath,         \
                                         ItemType)                             \
  ((This)->lpVtbl->ItemRenamed(This, pszOldPath, pszNewPath, ItemType))
...
#define IOfflineFilesEvents3_TransparentCacheItemNotify(                       \
    This, pszPath, EventType, ItemType, bModifiedData, bModifiedAttributes,    \
    pzsOldPath)                                                                \
  ((This)->lpVtbl->TransparentCacheItemNotify(                                 \
      This, pszPath, EventType, ItemType, bModifiedData, bModifiedAttributes,  \
      pzsOldPath))
...
typedef struct IOfflineFilesEvents4Vtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IOfflineFilesEvents4 *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IOfflineFilesEvents4 *This);
  ...
  DECLSPEC_XFGVIRT(IOfflineFilesEvents, CacheIsFull)
  HRESULT(STDMETHODCALLTYPE *CacheIsFull)(__RPC__in IOfflineFilesEvents4 *This);
  ...
  DECLSPEC_XFGVIRT(IOfflineFilesEvents, Enabled)
  HRESULT(STDMETHODCALLTYPE *Enabled)(__RPC__in IOfflineFilesEvents4 *This,
                                      /* [in] */ BOOL bEnabled);
  ...
  DECLSPEC_XFGVIRT(IOfflineFilesEvents, SyncBegin)
  HRESULT(STDMETHODCALLTYPE *SyncBegin)(__RPC__in IOfflineFilesEvents4 *This,
                                        /* [in] */ __RPC__in REFGUID rSyncId);
  ...
  DECLSPEC_XFGVIRT(IOfflineFilesEvents, SyncEnd)
  HRESULT(STDMETHODCALLTYPE *SyncEnd)(__RPC__in IOfflineFilesEvents4 *This,
                                      /* [in] */ __RPC__in REFGUID rSyncId,
                                      /* [in] */ HRESULT hrResult);
  ...
  DECLSPEC_XFGVIRT(IOfflineFilesEvents, DataLost)
  HRESULT(STDMETHODCALLTYPE *DataLost)(__RPC__in IOfflineFilesEvents4 *This);

  DECLSPEC_XFGVIRT(IOfflineFilesEvents, Ping)
  HRESULT(STDMETHODCALLTYPE *Ping)(__RPC__in IOfflineFilesEvents4 *This);
...
#define IOfflineFilesEvents4_AddRef(This) ((This)->lpVtbl->AddRef(This))

#define IOfflineFilesEvents4_Release(This) ((This)->lpVtbl->Release(This))
...
#define IOfflineFilesEvents4_EncryptionChanged(                                \
    This, bWasEncrypted, bWasPartial, bIsEncrypted, bIsPartial)                \
  ((This)->lpVtbl->EncryptionChanged(This, bWasEncrypted, bWasPartial,         \
                                     bIsEncrypted, bIsPartial))
...
#define IOfflineFilesEvents4_SyncConflictRecAdded(                             \
    This, pszConflictPath, pftConflictDateTime, ConflictSyncState)             \
  ((This)->lpVtbl->SyncConflictRecAdded(                                       \
      This, pszConflictPath, pftConflictDateTime, ConflictSyncState))

#define IOfflineFilesEvents4_SyncConflictRecUpdated(                           \
    This, pszConflictPath, pftConflictDateTime, ConflictSyncState)             \
  ((This)->lpVtbl->SyncConflictRecUpdated(                                     \
      This, pszConflictPath, pftConflictDateTime, ConflictSyncState))

#define IOfflineFilesEvents4_SyncConflictRecRemoved(                           \
    This, pszConflictPath, pftConflictDateTime, ConflictSyncState)             \
  ((This)->lpVtbl->SyncConflictRecRemoved(                                     \
      This, pszConflictPath, pftConflictDateTime, ConflictSyncState))
...
#define IOfflineFilesEvents4_ItemModified(This, pszPath, ItemType,             \
                                          bModifiedData, bModifiedAttributes)  \
  ((This)->lpVtbl->ItemModified(This, pszPath, ItemType, bModifiedData,        \
                                bModifiedAttributes))
...
#define IOfflineFilesEvents4_ItemRenamed(This, pszOldPath, pszNewPath,         \
                                         ItemType)                             \
  ((This)->lpVtbl->ItemRenamed(This, pszOldPath, pszNewPath, ItemType))

#define IOfflineFilesEvents4_DataLost(This) ((This)->lpVtbl->DataLost(This))

#define IOfflineFilesEvents4_Ping(This) ((This)->lpVtbl->Ping(This))
...
#define IOfflineFilesEvents4_TransparentCacheItemNotify(                       \
    This, pszPath, EventType, ItemType, bModifiedData, bModifiedAttributes,    \
    pzsOldPath)                                                                \
  ((This)->lpVtbl->TransparentCacheItemNotify(                                 \
      This, pszPath, EventType, ItemType, bModifiedData, bModifiedAttributes,  \
...
#define IOfflineFilesEvents4_PrefetchCloseHandleEnd(                           \
    This, dwClosedHandleCount, dwOpenHandleCount, hrResult)                    \
  ((This)->lpVtbl->PrefetchCloseHandleEnd(This, dwClosedHandleCount,           \
                                          dwOpenHandleCount, hrResult))
...
public:
  ...
  virtual HRESULT STDMETHODCALLTYPE GetIncludedEvents(
      ...
      __RPC__out_ecount_part(cElements, *pcEvents) OFFLINEFILES_EVENTS *
          prgEvents,
...
typedef struct IOfflineFilesEventsFilterVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IOfflineFilesEventsFilter *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IOfflineFilesEventsFilter *This);
  ...
  HRESULT(STDMETHODCALLTYPE *GetIncludedEvents)(
      ...
      /* [in] */ ULONG cElements,
      /* [length_is][size_is][out] */
      __RPC__out_ecount_part(cElements, *pcEvents)
          OFFLINEFILES_EVENTS *prgEvents,
...
#define IOfflineFilesEventsFilter_GetIncludedEvents(This, cElements,           \
                                                    prgEvents, pcEvents)       \
  ((This)->lpVtbl->GetIncludedEvents(This, cElements, prgEvents, pcEvents))

#define IOfflineFilesEventsFilter_GetExcludedEvents(This, cElements,           \
                                                    prgEvents, pcEvents)       \
...
typedef struct IOfflineFilesErrorInfoVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IOfflineFilesErrorInfo *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IOfflineFilesErrorInfo *This);
...
#define IOfflineFilesSyncErrorItemInfo_GetFileTimes(This, pftLastWrite,        \
                                                    pftChange)                 \
...
public:
  ...
  virtual HRESULT STDMETHODCALLTYPE GetLocalInfo(
      /* [out] */ __RPC__deref_out_opt IOfflineFilesSyncErrorItemInfo *
      *ppInfo) = 0;
...
typedef struct IOfflineFilesSyncErrorInfoVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IOfflineFilesSyncErrorInfo *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IOfflineFilesSyncErrorInfo *This);
...
#define IOfflineFilesSyncErrorInfo_GetItemChangeFlags(This,                    \
                                                      pdwItemChangeFlags)      \
  ((This)->lpVtbl->GetItemChangeFlags(This, pdwItemChangeFlags))

#define IOfflineFilesSyncErrorInfo_InfoEnumerated(                             \
    This, pbLocalEnumerated, pbRemoteEnumerated, pbOriginalEnumerated)         \
  ((This)->lpVtbl->InfoEnumerated(This, pbLocalEnumerated, pbRemoteEnumerated, \
                                  pbOriginalEnumerated))

#define IOfflineFilesSyncErrorInfo_InfoAvailable(This, pbLocalInfo,            \
                                                 pbRemoteInfo, pbOriginalInfo) \
  ((This)->lpVtbl->InfoAvailable(This, pbLocalInfo, pbRemoteInfo,              \
                                 pbOriginalInfo))
...
typedef struct IOfflineFilesProgressVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IOfflineFilesProgress *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IOfflineFilesProgress *This);

  DECLSPEC_XFGVIRT(IOfflineFilesProgress, Begin)
  HRESULT(STDMETHODCALLTYPE *Begin)(__RPC__in IOfflineFilesProgress *This,
                                    /* [out] */ __RPC__out BOOL *pbAbort);

  DECLSPEC_XFGVIRT(IOfflineFilesProgress, QueryAbort)
  HRESULT(STDMETHODCALLTYPE *QueryAbort)(__RPC__in IOfflineFilesProgress *This,
                                         /* [out] */ __RPC__out BOOL *pbAbort);

  DECLSPEC_XFGVIRT(IOfflineFilesProgress, End)
  HRESULT(STDMETHODCALLTYPE *End)(__RPC__in IOfflineFilesProgress *This,
                                  /* [in] */ HRESULT hrResult);
...
typedef struct IOfflineFilesSimpleProgressVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IOfflineFilesSimpleProgress *This);
  ...
  DECLSPEC_XFGVIRT(IOfflineFilesProgress, Begin)
  HRESULT(STDMETHODCALLTYPE *Begin)(__RPC__in IOfflineFilesSimpleProgress *This,
                                    /* [out] */ __RPC__out BOOL *pbAbort);
  ...
  DECLSPEC_XFGVIRT(IOfflineFilesProgress, End)
  HRESULT(STDMETHODCALLTYPE *End)(__RPC__in IOfflineFilesSimpleProgress *This,
                                  /* [in] */ HRESULT hrResult);
...
#define IOfflineFilesSimpleProgress_ItemResult(This, pszFile, hrResult,        \
                                               pResponse)                      \
...
typedef struct IOfflineFilesSyncProgressVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IOfflineFilesSyncProgress *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IOfflineFilesSyncProgress *This);

  DECLSPEC_XFGVIRT(IOfflineFilesProgress, Begin)
  HRESULT(STDMETHODCALLTYPE *Begin)(__RPC__in IOfflineFilesSyncProgress *This,
                                    /* [out] */ __RPC__out BOOL *pbAbort);
  ...
  DECLSPEC_XFGVIRT(IOfflineFilesProgress, End)
  HRESULT(STDMETHODCALLTYPE *End)(__RPC__in IOfflineFilesSyncProgress *This,
                                  /* [in] */ HRESULT hrResult);
...
#define IOfflineFilesSyncProgress_SyncItemResult(This, pszFile, hrResult,      \
                                                 pErrorInfo, pResponse)        \
  ((This)->lpVtbl->SyncItemResult(This, pszFile, hrResult, pErrorInfo,         \
                                  pResponse))
...
public:
  virtual HRESULT STDMETHODCALLTYPE ResolveConflict(
      ...
      /* [out] */ __RPC__out OFFLINEFILES_SYNC_CONFLICT_RESOLVE *
          pConflictResolution,
...
#define IOfflineFilesSyncConflictHandler_ResolveConflict(                      \
    This, pszPath, fStateKnown, state, fChangeDetails, pConflictResolution,    \
    ppszNewName)                                                               \
  ((This)->lpVtbl->ResolveConflict(This, pszPath, fStateKnown, state,          \
                                   fChangeDetails, pConflictResolution,        \
                                   ppszNewName))
...
public:
  ...
  virtual HRESULT STDMETHODCALLTYPE GetPatternFilter(
      /* [size_is][string][out] */ __RPC__out_ecount_full_string(cchPattern)
          LPWSTR pszPattern,
...
typedef struct IOfflineFilesItemFilterVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IOfflineFilesItemFilter *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IOfflineFilesItemFilter *This);
...
#define IOfflineFilesItemFilter_GetTimeFilter(This, pftTime, pbEvalTimeOfDay,  \
                                              pTimeType, pCompare)             \
  ((This)->lpVtbl->GetTimeFilter(This, pftTime, pbEvalTimeOfDay, pTimeType,    \
                                 pCompare))
...
typedef struct IOfflineFilesItemVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in IOfflineFilesItem *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IOfflineFilesItem *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IOfflineFilesItem *This);
  ...
  HRESULT(STDMETHODCALLTYPE *Refresh)(__RPC__in IOfflineFilesItem *This,
...
IOfflineFilesServerItem : public IOfflineFilesItem{public : };
...
typedef struct IOfflineFilesServerItemVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IOfflineFilesServerItem *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IOfflineFilesServerItem *This);
  ...
  DECLSPEC_XFGVIRT(IOfflineFilesItem, Refresh)
  HRESULT(STDMETHODCALLTYPE *Refresh)(__RPC__in IOfflineFilesServerItem *This,
                                      /* [in] */ DWORD dwQueryFlags);
...
IOfflineFilesShareItem : public IOfflineFilesItem{public : };
...
typedef struct IOfflineFilesShareItemVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IOfflineFilesShareItem *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IOfflineFilesShareItem *This);
  ...
  DECLSPEC_XFGVIRT(IOfflineFilesItem, Refresh)
  HRESULT(STDMETHODCALLTYPE *Refresh)(__RPC__in IOfflineFilesShareItem *This,
                                      /* [in] */ DWORD dwQueryFlags);
...
IOfflineFilesDirectoryItem : public IOfflineFilesItem{public : };
...
typedef struct IOfflineFilesDirectoryItemVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IOfflineFilesDirectoryItem *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IOfflineFilesDirectoryItem *This);
...
#define IOfflineFilesDirectoryItem_IsMarkedForDeletion(This,                   \
                                                       pbMarkedForDeletion)    \
  ((This)->lpVtbl->IsMarkedForDeletion(This, pbMarkedForDeletion))
...
typedef struct IOfflineFilesFileItemVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IOfflineFilesFileItem *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IOfflineFilesFileItem *This);
  ...
  DECLSPEC_XFGVIRT(IOfflineFilesItem, Refresh)
  HRESULT(STDMETHODCALLTYPE *Refresh)(__RPC__in IOfflineFilesFileItem *This,
                                      /* [in] */ DWORD dwQueryFlags);
  ...
  HRESULT(STDMETHODCALLTYPE *IsSparse)(__RPC__in IOfflineFilesFileItem *This,
...
typedef struct IEnumOfflineFilesItemsVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IEnumOfflineFilesItems *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IEnumOfflineFilesItems *This);

  DECLSPEC_XFGVIRT(IEnumOfflineFilesItems, Next)
  HRESULT(STDMETHODCALLTYPE *Next)(__RPC__in IEnumOfflineFilesItems *This,
                                   /* [in] */ ULONG celt,
                                   /* [length_is][size_is][out] */
                                   __RPC__out_ecount_part(celt, *pceltFetched)
                                       IOfflineFilesItem **rgelt,
                                   /* [out] */ __RPC__out ULONG *pceltFetched);

  DECLSPEC_XFGVIRT(IEnumOfflineFilesItems, Skip)
  HRESULT(STDMETHODCALLTYPE *Skip)(__RPC__in IEnumOfflineFilesItems *This,
                                   /* [in] */ ULONG celt);

  DECLSPEC_XFGVIRT(IEnumOfflineFilesItems, Reset)
  HRESULT(STDMETHODCALLTYPE *Reset)(__RPC__in IEnumOfflineFilesItems *This);
...
public:
  ...
  virtual HRESULT STDMETHODCALLTYPE EnumItemsEx(
      /* [unique][in] */ __RPC__in_opt IOfflineFilesItemFilter *
          pIncludeFileFilter,
      /* [unique][in] */ __RPC__in_opt IOfflineFilesItemFilter *
          pIncludeDirFilter,
      /* [unique][in] */ __RPC__in_opt IOfflineFilesItemFilter *
...
typedef struct IOfflineFilesItemContainerVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IOfflineFilesItemContainer *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IOfflineFilesItemContainer *This);
...
#define IOfflineFilesItemContainer_EnumItemsEx(                                \
    This, pIncludeFileFilter, pIncludeDirFilter, pExcludeFileFilter,           \
    pExcludeDirFilter, dwEnumFlags, dwQueryFlags, ppenum)                      \
  ((This)->lpVtbl->EnumItemsEx(This, pIncludeFileFilter, pIncludeDirFilter,    \
                               pExcludeFileFilter, pExcludeDirFilter,          \
                               dwEnumFlags, dwQueryFlags, ppenum))
...
typedef struct IOfflineFilesChangeInfoVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IOfflineFilesChangeInfo *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IOfflineFilesChangeInfo *This);

  DECLSPEC_XFGVIRT(IOfflineFilesChangeInfo, IsDirty)
  HRESULT(STDMETHODCALLTYPE *IsDirty)(__RPC__in IOfflineFilesChangeInfo *This,
...
#define IOfflineFilesChangeInfo_IsLocallyModifiedData(This,                    \
                                                      pbLocallyModifiedData)   \
  ((This)->lpVtbl->IsLocallyModifiedData(This, pbLocallyModifiedData))

#define IOfflineFilesChangeInfo_IsLocallyModifiedAttributes(                   \
    This, pbLocallyModifiedAttributes)                                         \
  ((This)->lpVtbl->IsLocallyModifiedAttributes(This,                           \
                                               pbLocallyModifiedAttributes))

#define IOfflineFilesChangeInfo_IsLocallyModifiedTime(This,                    \
...
typedef struct IOfflineFilesDirtyInfoVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IOfflineFilesDirtyInfo *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IOfflineFilesDirtyInfo *This);
...
typedef struct IOfflineFilesFileSysInfoVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IOfflineFilesFileSysInfo *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IOfflineFilesFileSysInfo *This);
...
#define IOfflineFilesFileSysInfo_GetTimes(This, copy, pftCreationTime,         \
                                          pftLastWriteTime, pftChangeTime,     \
                                          pftLastAccessTime)                   \
...
typedef struct IOfflineFilesPinInfoVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IOfflineFilesPinInfo *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IOfflineFilesPinInfo *This);

  DECLSPEC_XFGVIRT(IOfflineFilesPinInfo, IsPinned)
  HRESULT(STDMETHODCALLTYPE *IsPinned)(__RPC__in IOfflineFilesPinInfo *This,
...
#define IOfflineFilesPinInfo_IsPinnedForUserByPolicy(This, pbPinnedForUser,    \
                                                     pbInherit)                \
  ((This)->lpVtbl->IsPinnedForUserByPolicy(This, pbPinnedForUser, pbInherit))

#define IOfflineFilesPinInfo_IsPinnedForComputer(This, pbPinnedForComputer,    \
                                                 pbInherit)                    \
  ((This)->lpVtbl->IsPinnedForComputer(This, pbPinnedForComputer, pbInherit))

#define IOfflineFilesPinInfo_IsPinnedForFolderRedirection(                     \
    This, pbPinnedForFolderRedirection, pbInherit)                             \
  ((This)->lpVtbl->IsPinnedForFolderRedirection(                               \
      This, pbPinnedForFolderRedirection, pbInherit))
...
typedef struct IOfflineFilesPinInfo2Vtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IOfflineFilesPinInfo2 *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IOfflineFilesPinInfo2 *This);

  DECLSPEC_XFGVIRT(IOfflineFilesPinInfo, IsPinned)
  HRESULT(STDMETHODCALLTYPE *IsPinned)(__RPC__in IOfflineFilesPinInfo2 *This,
                                       /* [out] */ __RPC__out BOOL *pbPinned);
...
#define IOfflineFilesPinInfo2_IsPinnedForUser(This, pbPinnedForUser,           \
                                              pbInherit)                       \
  ((This)->lpVtbl->IsPinnedForUser(This, pbPinnedForUser, pbInherit))

#define IOfflineFilesPinInfo2_IsPinnedForUserByPolicy(This, pbPinnedForUser,   \
                                                      pbInherit)               \
  ((This)->lpVtbl->IsPinnedForUserByPolicy(This, pbPinnedForUser, pbInherit))

#define IOfflineFilesPinInfo2_IsPinnedForComputer(This, pbPinnedForComputer,   \
                                                  pbInherit)                   \
  ((This)->lpVtbl->IsPinnedForComputer(This, pbPinnedForComputer, pbInherit))
...
#define IOfflineFilesTransparentCacheInfo_QueryInterface(This, riid,           \
                                                         ppvObject)            \
  ((This)->lpVtbl->QueryInterface(This, riid, ppvObject))
...
#define IOfflineFilesTransparentCacheInfo_IsTransparentlyCached(               \
    This, pbTransparentlyCached)                                               \
...
typedef struct IOfflineFilesGhostInfoVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IOfflineFilesGhostInfo *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IOfflineFilesGhostInfo *This);

  DECLSPEC_XFGVIRT(IOfflineFilesGhostInfo, IsGhosted)
  HRESULT(STDMETHODCALLTYPE *IsGhosted)(__RPC__in IOfflineFilesGhostInfo *This,
...
typedef struct IOfflineFilesConnectionInfoVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IOfflineFilesConnectionInfo *This);
...
#define IOfflineFilesConnectionInfo_GetConnectState(This, pConnectState,       \
                                                    pOfflineReason)            \
  ((This)->lpVtbl->GetConnectState(This, pConnectState, pOfflineReason))

#define IOfflineFilesConnectionInfo_SetConnectState(This, hwndParent, dwFlags, \
                                                    ConnectState)              \
  ((This)->lpVtbl->SetConnectState(This, hwndParent, dwFlags, ConnectState))

#define IOfflineFilesConnectionInfo_TransitionOnline(This, hwndParent,         \
                                                     dwFlags)                  \
  ((This)->lpVtbl->TransitionOnline(This, hwndParent, dwFlags))

#define IOfflineFilesConnectionInfo_TransitionOffline(                         \
    This, hwndParent, dwFlags, bForceOpenFilesClosed,                          \
    pbOpenFilesPreventedTransition)                                            \
  ((This)->lpVtbl->TransitionOffline(This, hwndParent, dwFlags,                \
...
public:
  virtual HRESULT STDMETHODCALLTYPE GetShareItem(
      /* [out] */ __RPC__deref_out_opt IOfflineFilesShareItem *
      *ppShareItem) = 0;
...
typedef struct IOfflineFilesShareInfoVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IOfflineFilesShareInfo *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IOfflineFilesShareInfo *This);
...
typedef struct IOfflineFilesSuspendVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IOfflineFilesSuspend *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IOfflineFilesSuspend *This);

  DECLSPEC_XFGVIRT(IOfflineFilesSuspend, SuspendRoot)
  HRESULT(STDMETHODCALLTYPE *SuspendRoot)(__RPC__in IOfflineFilesSuspend *This,
                                          /* [in] */ BOOL bSuspend);
...
typedef struct IOfflineFilesSuspendInfoVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IOfflineFilesSuspendInfo *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IOfflineFilesSuspendInfo *This);
...
#define IOfflineFilesSuspendInfo_IsSuspended(This, pbSuspended,                \
                                             pbSuspendedRoot)                  \
...
typedef struct IOfflineFilesSettingVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IOfflineFilesSetting *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IOfflineFilesSetting *This);
...
typedef struct IEnumOfflineFilesSettingsVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IEnumOfflineFilesSettings *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IEnumOfflineFilesSettings *This);

  DECLSPEC_XFGVIRT(IEnumOfflineFilesSettings, Next)
  HRESULT(STDMETHODCALLTYPE *Next)(__RPC__in IEnumOfflineFilesSettings *This,
                                   /* [in] */ ULONG celt,
                                   /* [length_is][size_is][out] */
                                   __RPC__out_ecount_part(celt, *pceltFetched)
                                       IOfflineFilesSetting **rgelt,
                                   /* [out] */ __RPC__out ULONG *pceltFetched);

  DECLSPEC_XFGVIRT(IEnumOfflineFilesSettings, Skip)
  HRESULT(STDMETHODCALLTYPE *Skip)(__RPC__in IEnumOfflineFilesSettings *This,
                                   /* [in] */ ULONG celt);

  DECLSPEC_XFGVIRT(IEnumOfflineFilesSettings, Reset)
  HRESULT(STDMETHODCALLTYPE *Reset)(__RPC__in IEnumOfflineFilesSettings *This);
...
public:
  virtual HRESULT STDMETHODCALLTYPE Synchronize(
      /* [unique][in] */ __RPC__in_opt HWND hwndParent,
      /* [string][size_is][in] */ __RPC__in_ecount_full(cPaths) LPCWSTR *
          rgpszPaths,
      /* [in] */ ULONG cPaths,
      /* [in] */ BOOL bAsync,
      /* [in] */ DWORD dwSyncControl,
      /* [unique][in] */ __RPC__in_opt IOfflineFilesSyncConflictHandler *
  ...
  virtual HRESULT STDMETHODCALLTYPE DeleteItems(
      ...
      /* [in] */ DWORD dwFlags,
      /* [in] */ BOOL bAsync,
      /* [unique][in] */ __RPC__in_opt IOfflineFilesSimpleProgress *
          pIProgress) = 0;
  ...
  virtual HRESULT STDMETHODCALLTYPE Pin(
      ...
      /* [unique][in] */ __RPC__in_opt IOfflineFilesSyncProgress *
          pIProgress) = 0;
...
typedef struct IOfflineFilesCacheVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in IOfflineFilesCache *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IOfflineFilesCache *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IOfflineFilesCache *This);
...
#define IOfflineFilesCache_Synchronize(                                        \
    This, hwndParent, rgpszPaths, cPaths, bAsync, dwSyncControl,               \
    pISyncConflictHandler, pIProgress, pSyncId)                                \
  ((This)->lpVtbl->Synchronize(This, hwndParent, rgpszPaths, cPaths, bAsync,   \
                               dwSyncControl, pISyncConflictHandler,           \
                               pIProgress, pSyncId))

#define IOfflineFilesCache_DeleteItems(This, rgpszPaths, cPaths, dwFlags,      \
                                       bAsync, pIProgress)                     \
  ((This)->lpVtbl->DeleteItems(This, rgpszPaths, cPaths, dwFlags, bAsync,      \
                               pIProgress))

#define IOfflineFilesCache_DeleteItemsForUser(                                 \
    This, pszUser, rgpszPaths, cPaths, dwFlags, bAsync, pIProgress)            \
  ((This)->lpVtbl->DeleteItemsForUser(This, pszUser, rgpszPaths, cPaths,       \
                                      dwFlags, bAsync, pIProgress))

#define IOfflineFilesCache_Pin(This, hwndParent, rgpszPaths, cPaths, bDeep,    \
                               bAsync, dwPinControlFlags, pIProgress)          \
  ((This)->lpVtbl->Pin(This, hwndParent, rgpszPaths, cPaths, bDeep, bAsync,    \
                       dwPinControlFlags, pIProgress))

#define IOfflineFilesCache_Unpin(This, hwndParent, rgpszPaths, cPaths, bDeep,  \
                                 bAsync, dwPinControlFlags, pIProgress)        \
  ((This)->lpVtbl->Unpin(This, hwndParent, rgpszPaths, cPaths, bDeep, bAsync,  \
                         dwPinControlFlags, pIProgress))
...
#define IOfflineFilesCache_Encrypt(                                            \
    This, hwndParent, bEncrypt, dwEncryptionControlFlags, bAsync, pIProgress)  \
  ((This)->lpVtbl->Encrypt(This, hwndParent, bEncrypt,                         \
                           dwEncryptionControlFlags, bAsync, pIProgress))
...
#define IOfflineFilesCache_FindItemEx(This, pszPath, pIncludeFileFilter,       \
                                      pIncludeDirFilter, pExcludeFileFilter,   \
                                      pExcludeDirFilter, dwQueryFlags, ppItem) \
  ((This)->lpVtbl->FindItemEx(This, pszPath, pIncludeFileFilter,               \
                              pIncludeDirFilter, pExcludeFileFilter,           \
                              pExcludeDirFilter, dwQueryFlags, ppItem))

#define IOfflineFilesCache_RenameItem(This, pszPathOriginal, pszPathNew,       \
                                      bReplaceIfExists)                        \
  ((This)->lpVtbl->RenameItem(This, pszPathOriginal, pszPathNew,               \
                              bReplaceIfExists))

#define IOfflineFilesCache_GetLocation(This, ppszPath)                         \
  ((This)->lpVtbl->GetLocation(This, ppszPath))

#define IOfflineFilesCache_GetDiskSpaceInformation(                            \
    This, pcbVolumeTotal, pcbLimit, pcbUsed, pcbUnpinnedLimit,                 \
    pcbUnpinnedUsed)                                                           \
  ((This)->lpVtbl->GetDiskSpaceInformation(This, pcbVolumeTotal, pcbLimit,     \
                                           pcbUsed, pcbUnpinnedLimit,          \
                                           pcbUnpinnedUsed))
...
#define IOfflineFilesCache_ProcessAdminPinPolicy(This, pPinProgress,           \
                                                 pUnpinProgress)               \
...
#define IOfflineFilesCache_IsPathCacheable(This, pszPath, pbCacheable,         \
                                           pShareCachingMode)                  \
  ((This)->lpVtbl->IsPathCacheable(This, pszPath, pbCacheable,                 \
                                   pShareCachingMode))
...
typedef struct IOfflineFilesCache2Vtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IOfflineFilesCache2 *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IOfflineFilesCache2 *This);
...
#define IOfflineFilesCache2_AddRef(This) ((This)->lpVtbl->AddRef(This))

#define IOfflineFilesCache2_Release(This) ((This)->lpVtbl->Release(This))

#define IOfflineFilesCache2_Synchronize(                                       \
    This, hwndParent, rgpszPaths, cPaths, bAsync, dwSyncControl,               \
    pISyncConflictHandler, pIProgress, pSyncId)                                \
  ((This)->lpVtbl->Synchronize(This, hwndParent, rgpszPaths, cPaths, bAsync,   \
                               dwSyncControl, pISyncConflictHandler,           \
...
#define IOfflineFilesCache2_DeleteItems(This, rgpszPaths, cPaths, dwFlags,     \
                                        bAsync, pIProgress)                    \
  ((This)->lpVtbl->DeleteItems(This, rgpszPaths, cPaths, dwFlags, bAsync,      \
                               pIProgress))

#define IOfflineFilesCache2_DeleteItemsForUser(                                \
    This, pszUser, rgpszPaths, cPaths, dwFlags, bAsync, pIProgress)            \
  ((This)->lpVtbl->DeleteItemsForUser(This, pszUser, rgpszPaths, cPaths,       \
                                      dwFlags, bAsync, pIProgress))

#define IOfflineFilesCache2_Pin(This, hwndParent, rgpszPaths, cPaths, bDeep,   \
                                bAsync, dwPinControlFlags, pIProgress)         \
  ((This)->lpVtbl->Pin(This, hwndParent, rgpszPaths, cPaths, bDeep, bAsync,    \
                       dwPinControlFlags, pIProgress))

#define IOfflineFilesCache2_Unpin(This, hwndParent, rgpszPaths, cPaths, bDeep, \
                                  bAsync, dwPinControlFlags, pIProgress)       \
  ((This)->lpVtbl->Unpin(This, hwndParent, rgpszPaths, cPaths, bDeep, bAsync,  \
                         dwPinControlFlags, pIProgress))
...
#define IOfflineFilesCache2_Encrypt(                                           \
    This, hwndParent, bEncrypt, dwEncryptionControlFlags, bAsync, pIProgress)  \
  ((This)->lpVtbl->Encrypt(This, hwndParent, bEncrypt,                         \
                           dwEncryptionControlFlags, bAsync, pIProgress))
...
#define IOfflineFilesCache2_FindItemEx(                                        \
    This, pszPath, pIncludeFileFilter, pIncludeDirFilter, pExcludeFileFilter,  \
    pExcludeDirFilter, dwQueryFlags, ppItem)                                   \
  ((This)->lpVtbl->FindItemEx(This, pszPath, pIncludeFileFilter,               \
                              pIncludeDirFilter, pExcludeFileFilter,           \
                              pExcludeDirFilter, dwQueryFlags, ppItem))

#define IOfflineFilesCache2_RenameItem(This, pszPathOriginal, pszPathNew,      \
                                       bReplaceIfExists)                       \
  ((This)->lpVtbl->RenameItem(This, pszPathOriginal, pszPathNew,               \
                              bReplaceIfExists))
...
#define IOfflineFilesCache2_GetDiskSpaceInformation(                           \
    This, pcbVolumeTotal, pcbLimit, pcbUsed, pcbUnpinnedLimit,                 \
    pcbUnpinnedUsed)                                                           \
  ((This)->lpVtbl->GetDiskSpaceInformation(This, pcbVolumeTotal, pcbLimit,     \
                                           pcbUsed, pcbUnpinnedLimit,          \
...
#define IOfflineFilesCache2_ProcessAdminPinPolicy(This, pPinProgress,          \
                                                  pUnpinProgress)              \
  ((This)->lpVtbl->ProcessAdminPinPolicy(This, pPinProgress, pUnpinProgress))
...
#define IOfflineFilesCache2_IsPathCacheable(This, pszPath, pbCacheable,        \
                                            pShareCachingMode)                 \
  ((This)->lpVtbl->IsPathCacheable(This, pszPath, pbCacheable,                 \
                                   pShareCachingMode))

#define IOfflineFilesCache2_RenameItemEx(This, pszPathOriginal, pszPathNew,    \
                                         bReplaceIfExists)                     \
  ((This)->lpVtbl->RenameItemEx(This, pszPathOriginal, pszPathNew,             \
                                bReplaceIfExists))
...
class DECLSPEC_UUID("FD3659E9-A920-4123-AD64-7FC76C7AACDF") OfflineFilesSetting;
#endif
...
class DECLSPEC_UUID("48C6BE7C-3871-43cc-B46F-1449A1BB2FF3") OfflineFilesCache;
#endif
