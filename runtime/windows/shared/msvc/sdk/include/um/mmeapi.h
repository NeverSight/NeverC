...
MMRESULT
WINAPI
waveOutGetDevCapsA(_In_ UINT_PTR uDeviceID, _Out_ LPWAVEOUTCAPSA pwoc,
                   _In_ UINT cbwoc);

WINMMAPI
MMRESULT
WINAPI
waveOutGetDevCapsW(_In_ UINT_PTR uDeviceID, _Out_ LPWAVEOUTCAPSW pwoc,
                   _In_ UINT cbwoc);
...
MMRESULT
WINAPI
waveOutGetVolume(_In_opt_ HWAVEOUT hwo, _Out_ LPDWORD pdwVolume);

WINMMAPI
MMRESULT
WINAPI
waveOutSetVolume(_In_opt_ HWAVEOUT hwo, _In_ DWORD dwVolume);
...
MMRESULT
WINAPI
waveOutGetErrorTextA(_In_ MMRESULT mmrError,
                     _Out_writes_(cchText) LPSTR pszText, _In_ UINT cchText);

WINMMAPI
MMRESULT
WINAPI
waveOutGetErrorTextW(_In_ MMRESULT mmrError,
                     _Out_writes_(cchText) LPWSTR pszText, _In_ UINT cchText);
...
#else
MMRESULT WINAPI waveOutGetErrorText(MMRESULT mmrError, LPSTR pszText,
                                    UINT cchText);
#endif
...
MMRESULT
WINAPI
waveOutOpen(_Out_opt_ LPHWAVEOUT phwo, _In_ UINT uDeviceID,
            _In_ LPCWAVEFORMATEX pwfx, _In_opt_ DWORD_PTR dwCallback,
            _In_opt_ DWORD_PTR dwInstance, _In_ DWORD fdwOpen);

WINMMAPI
MMRESULT
WINAPI
waveOutClose(_In_ HWAVEOUT hwo);

WINMMAPI
MMRESULT
WINAPI
waveOutPrepareHeader(_In_ HWAVEOUT hwo,
                     _Inout_updates_bytes_(cbwh) LPWAVEHDR pwh, _In_ UINT cbwh);

WINMMAPI
MMRESULT
WINAPI
waveOutUnprepareHeader(_In_ HWAVEOUT hwo,
...
MMRESULT
WINAPI
waveOutWrite(_In_ HWAVEOUT hwo, _Inout_updates_bytes_(cbwh) LPWAVEHDR pwh,
             _In_ UINT cbwh);

WINMMAPI
MMRESULT
WINAPI
waveOutPause(_In_ HWAVEOUT hwo);

WINMMAPI
MMRESULT
WINAPI
waveOutRestart(_In_ HWAVEOUT hwo);

WINMMAPI
MMRESULT
WINAPI
waveOutReset(_In_ HWAVEOUT hwo);

WINMMAPI
MMRESULT
WINAPI
waveOutBreakLoop(_In_ HWAVEOUT hwo);

WINMMAPI
MMRESULT
WINAPI
waveOutGetPosition(_In_ HWAVEOUT hwo,
                   _Inout_updates_bytes_(cbmmt) LPMMTIME pmmt, _In_ UINT cbmmt);

WINMMAPI
MMRESULT
WINAPI
waveOutGetPitch(_In_ HWAVEOUT hwo, _Out_ LPDWORD pdwPitch);

WINMMAPI
MMRESULT
WINAPI
waveOutSetPitch(_In_ HWAVEOUT hwo, _In_ DWORD dwPitch);

WINMMAPI
MMRESULT
WINAPI
waveOutGetPlaybackRate(_In_ HWAVEOUT hwo, _Out_ LPDWORD pdwRate);

WINMMAPI
MMRESULT
WINAPI
waveOutSetPlaybackRate(_In_ HWAVEOUT hwo, _In_ DWORD dwRate);

WINMMAPI
MMRESULT
WINAPI
waveOutGetID(_In_ HWAVEOUT hwo, _Out_ LPUINT puDeviceID);
...
MMRESULT
WINAPI
waveOutMessage(_In_opt_ HWAVEOUT hwo, _In_ UINT uMsg, _In_ DWORD_PTR dw1,
               _In_ DWORD_PTR dw2);
...
MMRESULT
WINAPI
waveInGetDevCapsA(_In_ UINT_PTR uDeviceID,
...
MMRESULT
WINAPI
waveInGetDevCapsW(_In_ UINT_PTR uDeviceID,
...
MMRESULT
WINAPI
waveInGetErrorTextA(_In_ MMRESULT mmrError, _Out_writes_(cchText) LPSTR pszText,
                    _In_ UINT cchText);

WINMMAPI
MMRESULT
WINAPI
waveInGetErrorTextW(_In_ MMRESULT mmrError,
                    _Out_writes_(cchText) LPWSTR pszText, _In_ UINT cchText);
...
#else
MMRESULT WINAPI waveInGetErrorText(MMRESULT mmrError, LPSTR pszText,
                                   UINT cchText);
#endif
...
MMRESULT
WINAPI
waveInOpen(_Out_opt_ LPHWAVEIN phwi, _In_ UINT uDeviceID,
           _In_ LPCWAVEFORMATEX pwfx, _In_opt_ DWORD_PTR dwCallback,
           _In_opt_ DWORD_PTR dwInstance, _In_ DWORD fdwOpen);
...
MMRESULT
WINAPI
waveInClose(_In_ HWAVEIN hwi);

WINMMAPI
MMRESULT
WINAPI
waveInPrepareHeader(_In_ HWAVEIN hwi, _Inout_updates_bytes_(cbwh) LPWAVEHDR pwh,
                    _In_ UINT cbwh);

WINMMAPI
MMRESULT
WINAPI
waveInUnprepareHeader(_In_ HWAVEIN hwi,
                      _Inout_updates_bytes_(cbwh) LPWAVEHDR pwh,
                      _In_ UINT cbwh);
...
MMRESULT
WINAPI
waveInAddBuffer(_In_ HWAVEIN hwi, _Inout_updates_bytes_(cbwh) LPWAVEHDR pwh,
                _In_ UINT cbwh);

WINMMAPI
MMRESULT
WINAPI
waveInStart(_In_ HWAVEIN hwi);

WINMMAPI
MMRESULT
WINAPI
waveInStop(_In_ HWAVEIN hwi);

WINMMAPI
MMRESULT
WINAPI
waveInReset(_In_ HWAVEIN hwi);

WINMMAPI
MMRESULT
WINAPI
waveInGetPosition(_In_ HWAVEIN hwi, _Inout_updates_bytes_(cbmmt) LPMMTIME pmmt,
                  _In_ UINT cbmmt);

WINMMAPI
MMRESULT
WINAPI
waveInGetID(_In_ HWAVEIN hwi, _In_ LPUINT puDeviceID);
...
MMRESULT
WINAPI
waveInMessage(_In_opt_ HWAVEIN hwi, _In_ UINT uMsg, _In_opt_ DWORD_PTR dw1,
...
#define MIDIERR_BADOPENMODE                                                    \
  (MIDIERR_BASE + 6) /* operation unsupported w/ open mode */
#define MIDIERR_DONT_CONTINUE                                                  \
  (MIDIERR_BASE + 7) /* thru device 'eating' a message */
...
MMRESULT
WINAPI
midiStreamOpen(_Out_ LPHMIDISTRM phms, _Inout_updates_(cMidi) LPUINT puDeviceID,
               _In_ DWORD cMidi, _In_opt_ DWORD_PTR dwCallback,
               _In_opt_ DWORD_PTR dwInstance, _In_ DWORD fdwOpen);

WINMMAPI
MMRESULT
WINAPI
midiStreamClose(_In_ HMIDISTRM hms);

WINMMAPI
MMRESULT
WINAPI
midiStreamProperty(_In_ HMIDISTRM hms,
                   _Inout_updates_bytes_(sizeof(DWORD) + sizeof(DWORD))
                       LPBYTE lppropdata,
...
MMRESULT
WINAPI
midiStreamPosition(_In_ HMIDISTRM hms, _Out_writes_bytes_(cbmmt) LPMMTIME lpmmt,
                   _In_ UINT cbmmt);

WINMMAPI
MMRESULT
WINAPI
midiStreamOut(_In_ HMIDISTRM hms, _Out_writes_bytes_(cbmh) LPMIDIHDR pmh,
              _In_ UINT cbmh);

WINMMAPI
MMRESULT
WINAPI
midiStreamPause(_In_ HMIDISTRM hms);

WINMMAPI
MMRESULT
WINAPI
midiStreamRestart(_In_ HMIDISTRM hms);

WINMMAPI
MMRESULT
WINAPI
midiStreamStop(_In_ HMIDISTRM hms);

#ifdef _WIN32
WINMMAPI
MMRESULT
WINAPI
midiConnect(_In_ HMIDI hmi, _In_ HMIDIOUT hmo, _In_opt_ LPVOID pReserved);

WINMMAPI
MMRESULT
WINAPI
midiDisconnect(_In_ HMIDI hmi, _In_ HMIDIOUT hmo, _In_opt_ LPVOID pReserved);
...
MMRESULT
WINAPI
midiOutGetDevCapsA(_In_ UINT_PTR uDeviceID,
...
MMRESULT
WINAPI
midiOutGetDevCapsW(_In_ UINT_PTR uDeviceID,
...
#else
MMRESULT WINAPI midiOutGetDevCaps(UINT uDeviceID, LPMIDIOUTCAPS pmoc,
                                  UINT cbmoc);
#endif
...
MMRESULT
WINAPI
midiOutGetVolume(_In_opt_ HMIDIOUT hmo, _Out_ LPDWORD pdwVolume);

WINMMAPI
MMRESULT
WINAPI
midiOutSetVolume(_In_opt_ HMIDIOUT hmo, _In_ DWORD dwVolume);
...
MMRESULT
WINAPI
midiOutGetErrorTextA(_In_ MMRESULT mmrError,
                     _Out_writes_(cchText) LPSTR pszText, _In_ UINT cchText);

WINMMAPI
MMRESULT
WINAPI
midiOutGetErrorTextW(_In_ MMRESULT mmrError,
                     _Out_writes_(cchText) LPWSTR pszText, _In_ UINT cchText);
...
#else
WINMMAPI MMRESULT WINAPI midiOutGetErrorText(MMRESULT mmrError, LPSTR pszText,
                                             UINT cchText);
#endif
...
MMRESULT
WINAPI
midiOutOpen(_Out_ LPHMIDIOUT phmo, _In_ UINT uDeviceID,
            _In_opt_ DWORD_PTR dwCallback, _In_opt_ DWORD_PTR dwInstance,
            _In_ DWORD fdwOpen);

WINMMAPI
MMRESULT
WINAPI
midiOutClose(_In_ HMIDIOUT hmo);

WINMMAPI
MMRESULT
WINAPI
midiOutPrepareHeader(_In_ HMIDIOUT hmo,
                     _Inout_updates_bytes_(cbmh) LPMIDIHDR pmh, _In_ UINT cbmh);

WINMMAPI
MMRESULT
WINAPI
midiOutUnprepareHeader(_In_ HMIDIOUT hmo,
...
MMRESULT
WINAPI
midiOutShortMsg(_In_ HMIDIOUT hmo, _In_ DWORD dwMsg);

WINMMAPI
MMRESULT
WINAPI
midiOutLongMsg(_In_ HMIDIOUT hmo, _In_reads_bytes_(cbmh) LPMIDIHDR pmh,
               _In_ UINT cbmh);

WINMMAPI
MMRESULT
WINAPI
midiOutReset(_In_ HMIDIOUT hmo);

WINMMAPI
MMRESULT
WINAPI
midiOutCachePatches(_In_ HMIDIOUT hmo, _In_ UINT uBank,
                    _In_reads_(MIDIPATCHSIZE) LPWORD pwpa, _In_ UINT fuCache);

WINMMAPI
MMRESULT
WINAPI
midiOutCacheDrumPatches(_In_ HMIDIOUT hmo, _In_ UINT uPatch,
...
MMRESULT
WINAPI
midiOutGetID(_In_ HMIDIOUT hmo, _Out_ LPUINT puDeviceID);
...
MMRESULT
WINAPI
midiOutMessage(_In_opt_ HMIDIOUT hmo, _In_ UINT uMsg, _In_opt_ DWORD_PTR dw1,
               _In_opt_ DWORD_PTR dw2);
...
MMRESULT
WINAPI
midiInGetDevCapsA(_In_ UINT_PTR uDeviceID,
...
MMRESULT
WINAPI
midiInGetDevCapsW(_In_ UINT_PTR uDeviceID,
...
MMRESULT
WINAPI
midiInGetErrorTextA(_In_ MMRESULT mmrError, _Out_writes_(cchText) LPSTR pszText,
                    _In_ UINT cchText);

WINMMAPI
MMRESULT
WINAPI
midiInGetErrorTextW(_In_ MMRESULT mmrError,
                    _Out_writes_(cchText) LPWSTR pszText, _In_ UINT cchText);
...
WINMMAPI MMRESULT WINAPI midiInGetErrorText(MMRESULT mmrError,
...
MMRESULT
WINAPI
midiInOpen(_Out_ LPHMIDIIN phmi, _In_ UINT uDeviceID,
           _In_opt_ DWORD_PTR dwCallback, _In_opt_ DWORD_PTR dwInstance,
           _In_ DWORD fdwOpen);
...
MMRESULT
WINAPI
midiInClose(_In_ HMIDIIN hmi);

WINMMAPI
MMRESULT
WINAPI
midiInPrepareHeader(_In_ HMIDIIN hmi, _Inout_updates_bytes_(cbmh) LPMIDIHDR pmh,
                    _In_ UINT cbmh);

WINMMAPI
MMRESULT
WINAPI
midiInUnprepareHeader(_In_ HMIDIIN hmi,
                      _Inout_updates_bytes_(cbmh) LPMIDIHDR pmh,
                      _In_ UINT cbmh);
...
MMRESULT
WINAPI
midiInAddBuffer(_In_ HMIDIIN hmi, _Out_writes_bytes_(cbmh) LPMIDIHDR pmh,
                _In_ UINT cbmh);

WINMMAPI
MMRESULT
WINAPI
midiInStart(_In_ HMIDIIN hmi);

WINMMAPI
MMRESULT
WINAPI
midiInStop(_In_ HMIDIIN hmi);

WINMMAPI
MMRESULT
WINAPI
midiInReset(_In_ HMIDIIN hmi);

WINMMAPI
MMRESULT
WINAPI
midiInGetID(_In_ HMIDIIN hmi, _Out_ LPUINT puDeviceID);
...
MMRESULT
WINAPI
midiInMessage(_In_opt_ HMIDIIN hmi, _In_ UINT uMsg, _In_opt_ DWORD_PTR dw1,
              _In_opt_ DWORD_PTR dw2);
...
MMRESULT
WINAPI
auxGetDevCapsA(_In_ UINT_PTR uDeviceID, _Out_writes_bytes_(cbac) LPAUXCAPSA pac,
               _In_ UINT cbac);

WINMMAPI
MMRESULT
WINAPI
auxGetDevCapsW(_In_ UINT_PTR uDeviceID, _Out_writes_bytes_(cbac) LPAUXCAPSW pac,
               _In_ UINT cbac);
...
MMRESULT
WINAPI
auxSetVolume(_In_ UINT uDeviceID, _In_ DWORD dwVolume);

WINMMAPI
MMRESULT
WINAPI
auxGetVolume(_In_ UINT uDeviceID, _Out_ LPDWORD pdwVolume);
...
MMRESULT
WINAPI
auxOutMessage(_In_ UINT uDeviceID, _In_ UINT uMsg, _In_opt_ DWORD_PTR dw1,
              _In_opt_ DWORD_PTR dw2);
...
MMRESULT
WINAPI
mixerGetDevCapsA(_In_ UINT_PTR uMxId,
...
MMRESULT
WINAPI
mixerGetDevCapsW(_In_ UINT_PTR uMxId,
...
MMRESULT
WINAPI
mixerOpen(_Out_opt_ LPHMIXER phmx, _In_ UINT uMxId,
          _In_opt_ DWORD_PTR dwCallback, _In_opt_ DWORD_PTR dwInstance,
          _In_ DWORD fdwOpen);
...
MMRESULT
WINAPI
mixerClose(_In_ HMIXER hmx);

WINMMAPI
DWORD
WINAPI
mixerMessage(_In_opt_ HMIXER hmx, _In_ UINT uMsg, _In_opt_ DWORD_PTR dwParam1,
...
MMRESULT
WINAPI
mixerGetLineInfoA(_In_opt_ HMIXEROBJ hmxobj, _Inout_ LPMIXERLINEA pmxl,
                  _In_ DWORD fdwInfo);

WINMMAPI
MMRESULT
WINAPI
mixerGetLineInfoW(_In_opt_ HMIXEROBJ hmxobj, _Inout_ LPMIXERLINEW pmxl,
                  _In_ DWORD fdwInfo);
...
#else
MMRESULT WINAPI mixerGetLineInfo(HMIXEROBJ hmxobj, LPMIXERLINE pmxl,
                                 DWORD fdwInfo);
#endif
...
MMRESULT
WINAPI
mixerGetID(_In_opt_ HMIXEROBJ hmxobj, _Out_ UINT FAR *puMxId, _In_ DWORD fdwId);
...
MMRESULT
WINAPI
mixerGetLineControlsA(_In_opt_ HMIXEROBJ hmxobj,
...
MMRESULT
WINAPI
mixerGetLineControlsW(_In_opt_ HMIXEROBJ hmxobj,
...
#else
MMRESULT WINAPI mixerGetLineControls(HMIXEROBJ hmxobj,
...
MMRESULT
WINAPI
mixerGetControlDetailsA(_In_opt_ HMIXEROBJ hmxobj,
...
MMRESULT
WINAPI
mixerGetControlDetailsW(_In_opt_ HMIXEROBJ hmxobj,
                        _Inout_ LPMIXERCONTROLDETAILS pmxcd,
                        _In_ DWORD fdwDetails);
...
#else
MMRESULT WINAPI mixerGetControlDetails(HMIXEROBJ hmxobj,
...
MMRESULT
WINAPI
mixerSetControlDetails(_In_opt_ HMIXEROBJ hmxobj,
                       _In_ LPMIXERCONTROLDETAILS pmxcd, _In_ DWORD fdwDetails);
