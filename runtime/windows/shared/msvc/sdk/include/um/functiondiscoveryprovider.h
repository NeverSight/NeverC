...
typedef interface IFunctionDiscoveryProviderQuery
...
typedef interface IProviderQueryConstraintCollection
...
typedef interface IProviderPropertyConstraintCollection
...
typedef interface IFunctionDiscoveryServiceProvider
...
extern RPC_IF_HANDLE
    __MIDL_itf_functiondiscoveryprovider_0000_0000_v0_0_c_ifspec;
extern RPC_IF_HANDLE
    __MIDL_itf_functiondiscoveryprovider_0000_0000_v0_0_s_ifspec;
...
public:
  virtual HRESULT STDMETHODCALLTYPE Initialize(
      /* [in] */ __RPC__in_opt IFunctionDiscoveryProviderFactory *
  ...
  virtual HRESULT STDMETHODCALLTYPE Query(
      /* [in] */ __RPC__in_opt IFunctionDiscoveryProviderQuery *
          pIFunctionDiscoveryProviderQuery,
      /* [out] */ __RPC__deref_out_opt IFunctionInstanceCollection *
          *ppIFunctionInstanceCollection) = 0;
...
typedef struct IFunctionDiscoveryProviderVtbl {
  ...
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IFunctionDiscoveryProvider *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IFunctionDiscoveryProvider *This);

  DECLSPEC_XFGVIRT(IFunctionDiscoveryProvider, Initialize)
  HRESULT(STDMETHODCALLTYPE *Initialize)(
      __RPC__in IFunctionDiscoveryProvider *This,
      /* [in] */
      __RPC__in_opt IFunctionDiscoveryProviderFactory
          *pIFunctionDiscoveryProviderFactory,
      /* [in] */
      __RPC__in_opt IFunctionDiscoveryNotification
          *pIFunctionDiscoveryNotification,
      /* [in] */ LCID lcidUserDefault,
  ...
  HRESULT(STDMETHODCALLTYPE *Query)(
      __RPC__in IFunctionDiscoveryProvider *This,
      /* [in] */
      __RPC__in_opt IFunctionDiscoveryProviderQuery
          *pIFunctionDiscoveryProviderQuery,
      /* [out] */
  ...
  DECLSPEC_XFGVIRT(IFunctionDiscoveryProvider,
...
#define IFunctionDiscoveryProvider_Initialize(                                 \
    This, pIFunctionDiscoveryProviderFactory, pIFunctionDiscoveryNotification, \
    lcidUserDefault, pdwStgAccessCapabilities)                                 \
  ((This)->lpVtbl->Initialize(This, pIFunctionDiscoveryProviderFactory,        \
                              pIFunctionDiscoveryNotification,                 \
                              lcidUserDefault, pdwStgAccessCapabilities))

#define IFunctionDiscoveryProvider_Query(                                      \
    This, pIFunctionDiscoveryProviderQuery, ppIFunctionInstanceCollection)     \
  ((This)->lpVtbl->Query(This, pIFunctionDiscoveryProviderQuery,               \
                         ppIFunctionInstanceCollection))

#define IFunctionDiscoveryProvider_EndQuery(This)                              \
  ((This)->lpVtbl->EndQuery(This))

#define IFunctionDiscoveryProvider_InstancePropertyStoreValidateAccess(        \
    This, pIFunctionInstance, iProviderInstanceContext, dwStgAccess)           \
  ((This)->lpVtbl->InstancePropertyStoreValidateAccess(                        \
      This, pIFunctionInstance, iProviderInstanceContext, dwStgAccess))

#define IFunctionDiscoveryProvider_InstancePropertyStoreOpen(                  \
    This, pIFunctionInstance, iProviderInstanceContext, dwStgAccess,           \
    ppIPropertyStore)                                                          \
  ((This)->lpVtbl->InstancePropertyStoreOpen(This, pIFunctionInstance,         \
                                             iProviderInstanceContext,         \
                                             dwStgAccess, ppIPropertyStore))

#define IFunctionDiscoveryProvider_InstancePropertyStoreFlush(                 \
    This, pIFunctionInstance, iProviderInstanceContext)                        \
  ((This)->lpVtbl->InstancePropertyStoreFlush(This, pIFunctionInstance,        \
                                              iProviderInstanceContext))

#define IFunctionDiscoveryProvider_InstanceQueryService(                       \
    This, pIFunctionInstance, iProviderInstanceContext, guidService, riid,     \
    ppIUnknown)                                                                \
  ((This)->lpVtbl->InstanceQueryService(This, pIFunctionInstance,              \
                                        iProviderInstanceContext, guidService, \
                                        riid, ppIUnknown))

#define IFunctionDiscoveryProvider_InstanceReleased(This, pIFunctionInstance,  \
                                                    iProviderInstanceContext)  \
  ((This)->lpVtbl->InstanceReleased(This, pIFunctionInstance,                  \
                                    iProviderInstanceContext))
...
typedef struct IProviderPropertiesVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IProviderProperties *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IProviderProperties *This);
...
#define IProviderProperties_GetCount(This, pIFunctionInstance,                 \
                                     iProviderInstanceContext, pdwCount)       \
  ((This)->lpVtbl->GetCount(This, pIFunctionInstance,                          \
                            iProviderInstanceContext, pdwCount))

#define IProviderProperties_GetAt(This, pIFunctionInstance,                    \
                                  iProviderInstanceContext, dwIndex, pKey)     \
  ((This)->lpVtbl->GetAt(This, pIFunctionInstance, iProviderInstanceContext,   \
                         dwIndex, pKey))

#define IProviderProperties_GetValue(This, pIFunctionInstance,                 \
                                     iProviderInstanceContext, Key, ppropVar)  \
  ((This)->lpVtbl->GetValue(This, pIFunctionInstance,                          \
                            iProviderInstanceContext, Key, ppropVar))

#define IProviderProperties_SetValue(This, pIFunctionInstance,                 \
                                     iProviderInstanceContext, Key, ppropVar)  \
  ((This)->lpVtbl->SetValue(This, pIFunctionInstance,                          \
                            iProviderInstanceContext, Key, ppropVar))
...
public:
  virtual HRESULT STDMETHODCALLTYPE CreateInstance(
      ...
      /* [out] */
      __RPC__deref_out_opt IFunctionInstance **ppIFunctionInstance) = 0;
  ...
  virtual HRESULT STDMETHODCALLTYPE RemoveInstance(
      ...
      __RPC__in_opt_string const WCHAR *pszSubCategory,
      /* [string][in] */
      __RPC__in_string const WCHAR *pszProviderInstanceIdentity) = 0;
};
...
typedef struct IProviderPublishingVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IProviderPublishing *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IProviderPublishing *This);
...
#define IProviderPublishing_CreateInstance(                                    \
    This, enumVisibilityFlags, pszSubCategory, pszProviderInstanceIdentity,    \
    ppIFunctionInstance)                                                       \
  ((This)->lpVtbl->CreateInstance(This, enumVisibilityFlags, pszSubCategory,   \
                                  pszProviderInstanceIdentity,                 \
                                  ppIFunctionInstance))

#define IProviderPublishing_RemoveInstance(                                    \
    This, enumVisibilityFlags, pszSubCategory, pszProviderInstanceIdentity)    \
  ((This)->lpVtbl->RemoveInstance(This, enumVisibilityFlags, pszSubCategory,   \
                                  pszProviderInstanceIdentity))
...
typedef struct IFunctionDiscoveryProviderFactoryVtbl {
  ...
  DECLSPEC_XFGVIRT(IFunctionDiscoveryProviderFactory,
...
#define IFunctionDiscoveryProviderFactory_QueryInterface(This, riid,           \
                                                         ppvObject)            \
  ((This)->lpVtbl->QueryInterface(This, riid, ppvObject))
...
#define IFunctionDiscoveryProviderFactory_CreatePropertyStore(                 \
    This, ppIPropertyStore)                                                    \
  ((This)->lpVtbl->CreatePropertyStore(This, ppIPropertyStore))

#define IFunctionDiscoveryProviderFactory_CreateInstance(                      \
    This, pszSubCategory, pszProviderInstanceIdentity,                         \
    iProviderInstanceContext, pIPropertyStore, pIFunctionDiscoveryProvider,    \
    ppIFunctionInstance)                                                       \
  ((This)->lpVtbl->CreateInstance(                                             \
      This, pszSubCategory, pszProviderInstanceIdentity,                       \
      iProviderInstanceContext, pIPropertyStore, pIFunctionDiscoveryProvider,  \
      ppIFunctionInstance))

#define IFunctionDiscoveryProviderFactory_CreateFunctionInstanceCollection(    \
    This, ppIFunctionInstanceCollection)                                       \
  ((This)->lpVtbl->CreateFunctionInstanceCollection(                           \
      This, ppIFunctionInstanceCollection))
...
public:
  ...
  virtual HRESULT STDMETHODCALLTYPE GetQueryConstraints(
      /* [out] */ __RPC__deref_out_opt IProviderQueryConstraintCollection *
      *ppIProviderQueryConstraints) = 0;

  virtual HRESULT STDMETHODCALLTYPE GetPropertyConstraints(
      /* [out] */ __RPC__deref_out_opt IProviderPropertyConstraintCollection *
      *ppIProviderPropertyConstraints) = 0;
};
...
#define IFunctionDiscoveryProviderQuery_IsInstanceQuery(                       \
    This, pisInstanceQuery, ppszConstraintValue)                               \
  ((This)->lpVtbl->IsInstanceQuery(This, pisInstanceQuery, ppszConstraintValue))

#define IFunctionDiscoveryProviderQuery_IsSubcategoryQuery(                    \
    This, pisSubcategoryQuery, ppszConstraintValue)                            \
  ((This)->lpVtbl->IsSubcategoryQuery(This, pisSubcategoryQuery,               \
                                      ppszConstraintValue))

#define IFunctionDiscoveryProviderQuery_GetQueryConstraints(                   \
    This, ppIProviderQueryConstraints)                                         \
  ((This)->lpVtbl->GetQueryConstraints(This, ppIProviderQueryConstraints))

#define IFunctionDiscoveryProviderQuery_GetPropertyConstraints(                \
    This, ppIProviderPropertyConstraints)                                      \
...
#define IProviderQueryConstraintCollection_QueryInterface(This, riid,          \
                                                          ppvObject)           \
  ((This)->lpVtbl->QueryInterface(This, riid, ppvObject))
...
#define IProviderQueryConstraintCollection_Get(This, pszConstraintName,        \
                                               ppszConstraintValue)            \
  ((This)->lpVtbl->Get(This, pszConstraintName, ppszConstraintValue))

#define IProviderQueryConstraintCollection_Item(                               \
    This, dwIndex, ppszConstraintName, ppszConstraintValue)                    \
  ((This)->lpVtbl->Item(This, dwIndex, ppszConstraintName, ppszConstraintValue))

#define IProviderQueryConstraintCollection_Next(This, ppszConstraintName,      \
                                                ppszConstraintValue)           \
...
#define IProviderPropertyConstraintCollection_QueryInterface(This, riid,       \
                                                             ppvObject)        \
  ((This)->lpVtbl->QueryInterface(This, riid, ppvObject))
...
#define IProviderPropertyConstraintCollection_Get(This, Key, pPropVar,         \
                                                  pdwPropertyConstraint)       \
  ((This)->lpVtbl->Get(This, Key, pPropVar, pdwPropertyConstraint))

#define IProviderPropertyConstraintCollection_Item(                            \
    This, dwIndex, pKey, pPropVar, pdwPropertyConstraint)                      \
  ((This)->lpVtbl->Item(This, dwIndex, pKey, pPropVar, pdwPropertyConstraint))

#define IProviderPropertyConstraintCollection_Next(This, pKey, pPropVar,       \
                                                   pdwPropertyConstraint)      \
...
#define IFunctionDiscoveryServiceProvider_QueryInterface(This, riid,           \
                                                         ppvObject)            \
  ((This)->lpVtbl->QueryInterface(This, riid, ppvObject))
...
#define IFunctionDiscoveryServiceProvider_Initialize(This, pIFunctionInstance, \
                                                     riid, ppv)                \
...
extern RPC_IF_HANDLE
    __MIDL_itf_functiondiscoveryprovider_0000_0008_v0_0_c_ifspec;
extern RPC_IF_HANDLE
    __MIDL_itf_functiondiscoveryprovider_0000_0008_v0_0_s_ifspec;
