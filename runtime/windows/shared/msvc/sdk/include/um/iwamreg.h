...
DEFINE_GUID(IID_IIISApplicationAdmin2, 0xd643717a, 0xfc87, 0x4260, 0x88, 0xac,
            0x6c, 0xe3, 0x5f, 0x0e, 0xc1, 0x4e);
...
typedef struct IWamAdminVtbl {
  ...
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(IWamAdmin *This,
                                             /* [in] */ REFIID riid,
...
interface IWamAdmin { CONST_VTBL struct IWamAdminVtbl *lpVtbl; };
...
typedef struct IWamAdmin2Vtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(IWamAdmin2 *This,
                                             /* [in] */ REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);
...
interface IWamAdmin2 { CONST_VTBL struct IWamAdmin2Vtbl *lpVtbl; };
...
typedef struct IIISApplicationAdminVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(IIISApplicationAdmin *This,
                                             /* [in] */ REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);
...
class DECLSPEC_UUID("61738644-F196-11D0-9953-00C04FD919C1") WamAdmin;
#endif
