...
DEFINE_GUID(IID_ITaskTrigger, 0x148BD52BL, 0xA2AB, 0x11CE, 0xB1, 0x1F, 0x00,
...
typedef struct ITaskTriggerVtbl {
  ...
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(ITaskTrigger *This,
                                             /* [in] */ REFIID riid,
  ...
  HRESULT(STDMETHODCALLTYPE *GetTrigger)(ITaskTrigger *This,
                                         /* [out] */ PTASK_TRIGGER pTrigger);

  DECLSPEC_XFGVIRT(ITaskTrigger, GetTriggerString)
  HRESULT(STDMETHODCALLTYPE *GetTriggerString)(ITaskTrigger *This,
                                               /* [annotation][out] */
...
interface ITaskTrigger { CONST_VTBL struct ITaskTriggerVtbl *lpVtbl; };
...
DEFINE_GUID(IID_IScheduledWorkItem, 0xa6b952f0L, 0xa4b1, 0x11d0, 0x99, 0x7d,
...
typedef struct IScheduledWorkItemVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(IScheduledWorkItem *This,
                                             /* [in] */ REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);
  ...
  HRESULT(STDMETHODCALLTYPE *DeleteTrigger)(IScheduledWorkItem *This,
                                            /* [in] */ WORD iTrigger);

  DECLSPEC_XFGVIRT(IScheduledWorkItem, GetTriggerCount)
  HRESULT(STDMETHODCALLTYPE *GetTriggerCount)(IScheduledWorkItem *This,
                                              /* [out] */ WORD *pwCount);

  DECLSPEC_XFGVIRT(IScheduledWorkItem, GetTrigger)
  HRESULT(STDMETHODCALLTYPE *GetTrigger)(IScheduledWorkItem *This,
                                         /* [in] */ WORD iTrigger,
                                         /* [out] */ ITaskTrigger **ppTrigger);

  DECLSPEC_XFGVIRT(IScheduledWorkItem, GetTriggerString)
  HRESULT(STDMETHODCALLTYPE *GetTriggerString)(IScheduledWorkItem *This,
                                               /* [in] */ WORD iTrigger,
                                               /* [annotation][out] */
                                               _Outptr_ LPWSTR *ppwszTrigger);
  ...
  HRESULT(STDMETHODCALLTYPE *SetIdleWait)(IScheduledWorkItem *This,
                                          /* [in] */ WORD wIdleMinutes,
                                          /* [in] */ WORD wDeadlineMinutes);

  DECLSPEC_XFGVIRT(IScheduledWorkItem, GetIdleWait)
  HRESULT(STDMETHODCALLTYPE *GetIdleWait)(IScheduledWorkItem *This,
                                          /* [out] */ WORD *pwIdleMinutes,
  ...
  HRESULT(STDMETHODCALLTYPE *EditWorkItem)(IScheduledWorkItem *This,
                                           /* [in] */ HWND hParent,
                                           /* [in] */ DWORD dwReserved);
  ...
  HRESULT(STDMETHODCALLTYPE *GetStatus)(IScheduledWorkItem *This,
                                        /* [out] */ HRESULT *phrStatus);

  DECLSPEC_XFGVIRT(IScheduledWorkItem, GetExitCode)
  HRESULT(STDMETHODCALLTYPE *GetExitCode)(IScheduledWorkItem *This,
                                          /* [out] */ DWORD *pdwExitCode);

  DECLSPEC_XFGVIRT(IScheduledWorkItem, SetComment)
  HRESULT(STDMETHODCALLTYPE *SetComment)(IScheduledWorkItem *This,
                                         /* [in] */ LPCWSTR pwszComment);

  DECLSPEC_XFGVIRT(IScheduledWorkItem, GetComment)
  HRESULT(STDMETHODCALLTYPE *GetComment)(IScheduledWorkItem *This,
                                         /* [annotation][out] */
                                         _Outptr_ LPWSTR *ppwszComment);

  DECLSPEC_XFGVIRT(IScheduledWorkItem, SetCreator)
  HRESULT(STDMETHODCALLTYPE *SetCreator)(IScheduledWorkItem *This,
                                         /* [in] */ LPCWSTR pwszCreator);

  DECLSPEC_XFGVIRT(IScheduledWorkItem, GetCreator)
  HRESULT(STDMETHODCALLTYPE *GetCreator)(IScheduledWorkItem *This,
                                         /* [annotation][out] */
                                         _Outptr_ LPWSTR *ppwszCreator);

  DECLSPEC_XFGVIRT(IScheduledWorkItem, SetWorkItemData)
  HRESULT(STDMETHODCALLTYPE *SetWorkItemData)(IScheduledWorkItem *This,
                                              /* [in] */ WORD cbData,
                                              /* [in] */ BYTE rgbData[]);

  DECLSPEC_XFGVIRT(IScheduledWorkItem, GetWorkItemData)
  HRESULT(STDMETHODCALLTYPE *GetWorkItemData)(IScheduledWorkItem *This,
                                              /* [out] */ WORD *pcbData,
                                              /* [out] */ BYTE **prgbData);

  DECLSPEC_XFGVIRT(IScheduledWorkItem, SetErrorRetryCount)
  HRESULT(STDMETHODCALLTYPE *SetErrorRetryCount)(IScheduledWorkItem *This,
                                                 /* [in] */ WORD wRetryCount);
  ...
  HRESULT(STDMETHODCALLTYPE *SetFlags)(IScheduledWorkItem *This,
                                       /* [in] */ DWORD dwFlags);

  DECLSPEC_XFGVIRT(IScheduledWorkItem, GetFlags)
  HRESULT(STDMETHODCALLTYPE *GetFlags)(IScheduledWorkItem *This,
                                       /* [out] */ DWORD *pdwFlags);
...
DEFINE_GUID(IID_ITask, 0x148BD524L, 0xA2AB, 0x11CE, 0xB1, 0x1F, 0x00, 0xAA,
            0x00, 0x53, 0x05, 0x03);
...
typedef struct ITaskVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(ITask *This,
                                             /* [in] */ REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);
  ...
  DECLSPEC_XFGVIRT(IScheduledWorkItem, DeleteTrigger)
  HRESULT(STDMETHODCALLTYPE *DeleteTrigger)(ITask *This,
                                            /* [in] */ WORD iTrigger);

  DECLSPEC_XFGVIRT(IScheduledWorkItem, GetTriggerCount)
  HRESULT(STDMETHODCALLTYPE *GetTriggerCount)(ITask *This,
                                              /* [out] */ WORD *pwCount);

  DECLSPEC_XFGVIRT(IScheduledWorkItem, GetTrigger)
  HRESULT(STDMETHODCALLTYPE *GetTrigger)(ITask *This,
                                         /* [in] */ WORD iTrigger,
                                         /* [out] */ ITaskTrigger **ppTrigger);

  DECLSPEC_XFGVIRT(IScheduledWorkItem, GetTriggerString)
  HRESULT(STDMETHODCALLTYPE *GetTriggerString)(ITask *This,
                                               /* [in] */ WORD iTrigger,
                                               /* [annotation][out] */
                                               _Outptr_ LPWSTR *ppwszTrigger);
  ...
  DECLSPEC_XFGVIRT(IScheduledWorkItem, SetIdleWait)
  HRESULT(STDMETHODCALLTYPE *SetIdleWait)(ITask *This,
                                          /* [in] */ WORD wIdleMinutes,
                                          /* [in] */ WORD wDeadlineMinutes);

  DECLSPEC_XFGVIRT(IScheduledWorkItem, GetIdleWait)
  HRESULT(STDMETHODCALLTYPE *GetIdleWait)(ITask *This,
                                          /* [out] */ WORD *pwIdleMinutes,
                                          /* [out] */ WORD *pwDeadlineMinutes);
  ...
  DECLSPEC_XFGVIRT(IScheduledWorkItem, EditWorkItem)
  HRESULT(STDMETHODCALLTYPE *EditWorkItem)(ITask *This,
                                           /* [in] */ HWND hParent,
                                           /* [in] */ DWORD dwReserved);
  ...
  DECLSPEC_XFGVIRT(IScheduledWorkItem, GetStatus)
  HRESULT(STDMETHODCALLTYPE *GetStatus)(ITask *This,
                                        /* [out] */ HRESULT *phrStatus);

  DECLSPEC_XFGVIRT(IScheduledWorkItem, GetExitCode)
  HRESULT(STDMETHODCALLTYPE *GetExitCode)(ITask *This,
                                          /* [out] */ DWORD *pdwExitCode);

  DECLSPEC_XFGVIRT(IScheduledWorkItem, SetComment)
  HRESULT(STDMETHODCALLTYPE *SetComment)(ITask *This,
                                         /* [in] */ LPCWSTR pwszComment);

  DECLSPEC_XFGVIRT(IScheduledWorkItem, GetComment)
  HRESULT(STDMETHODCALLTYPE *GetComment)(ITask *This,
                                         /* [annotation][out] */
                                         _Outptr_ LPWSTR *ppwszComment);

  DECLSPEC_XFGVIRT(IScheduledWorkItem, SetCreator)
  HRESULT(STDMETHODCALLTYPE *SetCreator)(ITask *This,
                                         /* [in] */ LPCWSTR pwszCreator);

  DECLSPEC_XFGVIRT(IScheduledWorkItem, GetCreator)
  HRESULT(STDMETHODCALLTYPE *GetCreator)(ITask *This,
                                         /* [annotation][out] */
                                         _Outptr_ LPWSTR *ppwszCreator);

  DECLSPEC_XFGVIRT(IScheduledWorkItem, SetWorkItemData)
  HRESULT(STDMETHODCALLTYPE *SetWorkItemData)(ITask *This,
                                              /* [in] */ WORD cbData,
                                              /* [in] */ BYTE rgbData[]);

  DECLSPEC_XFGVIRT(IScheduledWorkItem, GetWorkItemData)
  HRESULT(STDMETHODCALLTYPE *GetWorkItemData)(ITask *This,
                                              /* [out] */ WORD *pcbData,
                                              /* [out] */ BYTE **prgbData);

  DECLSPEC_XFGVIRT(IScheduledWorkItem, SetErrorRetryCount)
  HRESULT(STDMETHODCALLTYPE *SetErrorRetryCount)(ITask *This,
                                                 /* [in] */ WORD wRetryCount);
  ...
  DECLSPEC_XFGVIRT(IScheduledWorkItem, SetFlags)
  HRESULT(STDMETHODCALLTYPE *SetFlags)(ITask *This,
                                       /* [in] */ DWORD dwFlags);

  DECLSPEC_XFGVIRT(IScheduledWorkItem, GetFlags)
  HRESULT(STDMETHODCALLTYPE *GetFlags)(ITask *This,
                                       /* [out] */ DWORD *pdwFlags);
  ...
  HRESULT(STDMETHODCALLTYPE *SetParameters)(ITask *This,
  ...
  HRESULT(STDMETHODCALLTYPE *SetPriority)(ITask *This,
                                          /* [in] */ DWORD dwPriority);

  DECLSPEC_XFGVIRT(ITask, GetPriority)
  HRESULT(STDMETHODCALLTYPE *GetPriority)(ITask *This,
                                          /* [out] */ DWORD *pdwPriority);

  DECLSPEC_XFGVIRT(ITask, SetTaskFlags)
  HRESULT(STDMETHODCALLTYPE *SetTaskFlags)(ITask *This,
                                           /* [in] */ DWORD dwFlags);

  DECLSPEC_XFGVIRT(ITask, GetTaskFlags)
  HRESULT(STDMETHODCALLTYPE *GetTaskFlags)(ITask *This,
                                           /* [out] */ DWORD *pdwFlags);

  DECLSPEC_XFGVIRT(ITask, SetMaxRunTime)
  HRESULT(STDMETHODCALLTYPE *SetMaxRunTime)(ITask *This,
                                            /* [in] */ DWORD dwMaxRunTimeMS);

  DECLSPEC_XFGVIRT(ITask, GetMaxRunTime)
  HRESULT(STDMETHODCALLTYPE *GetMaxRunTime)(ITask *This,
                                            /* [out] */ DWORD *pdwMaxRunTimeMS);

  END_INTERFACE
} ITaskVtbl;

interface ITask { CONST_VTBL struct ITaskVtbl *lpVtbl; };
...
DEFINE_GUID(IID_IEnumWorkItems, 0x148BD528L, 0xA2AB, 0x11CE, 0xB1, 0x1F, 0x00,
            0xAA, 0x00, 0x53, 0x05, 0x03);
...
typedef struct IEnumWorkItemsVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(IEnumWorkItems *This,
                                             /* [in] */ REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);
  ...
  HRESULT(STDMETHODCALLTYPE *Next)(IEnumWorkItems *This,
                                   /* [in] */ ULONG celt,
                                   /* [out] */ LPWSTR **rgpwszNames,
                                   /* [out] */ ULONG *pceltFetched);

  DECLSPEC_XFGVIRT(IEnumWorkItems, Skip)
  HRESULT(STDMETHODCALLTYPE *Skip)(IEnumWorkItems *This,
                                   /* [in] */ ULONG celt);
...
interface IEnumWorkItems { CONST_VTBL struct IEnumWorkItemsVtbl *lpVtbl; };
...
DEFINE_GUID(IID_ITaskScheduler, 0x148BD527L, 0xA2AB, 0x11CE, 0xB1, 0x1F, 0x00,
            0xAA, 0x00, 0x53, 0x05, 0x03);
...
typedef struct ITaskSchedulerVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(ITaskScheduler *This,
                                             /* [in] */ REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);
  ...
  HRESULT(STDMETHODCALLTYPE *Activate)(ITaskScheduler *This,
                                       /* [in] */ LPCWSTR pwszName,
                                       /* [in] */ REFIID riid,
                                       /* [out] */ IUnknown **ppUnk);

  DECLSPEC_XFGVIRT(ITaskScheduler, Delete)
  HRESULT(STDMETHODCALLTYPE *Delete)(ITaskScheduler *This,
                                     /* [in] */ LPCWSTR pwszName);

  DECLSPEC_XFGVIRT(ITaskScheduler, NewWorkItem)
  HRESULT(STDMETHODCALLTYPE *NewWorkItem)(ITaskScheduler *This,
                                          /* [in] */ LPCWSTR pwszTaskName,
                                          /* [in] */ REFCLSID rclsid,
                                          /* [in] */ REFIID riid,
                                          /* [out] */ IUnknown **ppUnk);
  ...
  HRESULT(STDMETHODCALLTYPE *IsOfType)(ITaskScheduler *This,
                                       /* [in] */ LPCWSTR pwszName,
                                       /* [in] */ REFIID riid);
...
interface ITaskScheduler { CONST_VTBL struct ITaskSchedulerVtbl *lpVtbl; };
...
DEFINE_GUID(IID_IProvideTaskPage, 0x4086658aL, 0xcbbb, 0x11cf, 0xb6, 0x04, 0x00,
...
typedef struct IProvideTaskPageVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(IProvideTaskPage *This,
                                             /* [in] */ REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);
  ...
  HRESULT(STDMETHODCALLTYPE *GetPage)(IProvideTaskPage *This,
                                      /* [in] */ TASKPAGE tpType,
                                      /* [in] */ BOOL fPersistChanges,
...
interface IProvideTaskPage { CONST_VTBL struct IProvideTaskPageVtbl *lpVtbl; };
