...
typedef struct IDtcToXaMapperVtbl {
  ...
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in IDtcToXaMapper *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IDtcToXaMapper *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IDtcToXaMapper *This);
...
interface IDtcToXaMapper { CONST_VTBL struct IDtcToXaMapperVtbl *lpVtbl; };
...
typedef struct IDtcToXaHelperFactoryVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IDtcToXaHelperFactory *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IDtcToXaHelperFactory *This);
...
typedef struct IDtcToXaHelperVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in IDtcToXaHelper *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IDtcToXaHelper *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IDtcToXaHelper *This);

  DECLSPEC_XFGVIRT(IDtcToXaHelper, Close)
  HRESULT(STDMETHODCALLTYPE *Close)(__RPC__in IDtcToXaHelper *This,
...
interface IDtcToXaHelper { CONST_VTBL struct IDtcToXaHelperVtbl *lpVtbl; };
...
typedef struct IDtcToXaHelperSinglePipeVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(IDtcToXaHelperSinglePipe *This,
                                             /* [in] */ REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);
  ...
  HRESULT(STDMETHODCALLTYPE *XARMCreate)(IDtcToXaHelperSinglePipe *This,
                                         /* [annotation][string][in] */
                                         _Null_terminated_ char *pszDSN,
                                         /* [annotation][string][in] */
                                         _Null_terminated_ char *pszClientDll,
  ...
  HRESULT(STDMETHODCALLTYPE *ConvertTridToXID)(IDtcToXaHelperSinglePipe *This,
                                               /* [in] */ DWORD *pdwITrans,
                                               /* [in] */ DWORD dwRMCookie,
                                               /* [out][in] */ XID *pxid);
  ...
  void(STDMETHODCALLTYPE *ReleaseRMCookie)(IDtcToXaHelperSinglePipe *This,
                                           /* [in] */ DWORD i_dwRMCookie,
                                           /* [in] */ BOOL i_fNormal);
