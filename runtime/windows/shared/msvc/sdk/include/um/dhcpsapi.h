...
#define ELEMENT_MASK(E)                                                        \
  ((((E) <= DhcpIpRangesBootpOnly) && (DhcpIpRangesDhcpOnly <= (E))) ? (0)     \
                                                                     : (E))

typedef struct _DHCP_SUBNET_ELEMENT_DATA {
  DHCP_SUBNET_ELEMENT_TYPE ElementType;
#if defined(MIDL_PASS)
  [switch_is(ELEMENT_MASK(ElementType)),
   switch_type(DHCP_SUBNET_ELEMENT_TYPE)] union _DHCP_SUBNET_ELEMENT_UNION {
...
#if defined(MIDL_PASS)
  [switch_is(OptionType),
   switch_type(DHCP_OPTION_DATA_TYPE)] union _DHCP_OPTION_ELEMENT_UNION {
...
#if defined(MIDL_PASS)
  [switch_is(ScopeType),
   switch_type(DHCP_OPTION_SCOPE_TYPE)] union _DHCP_OPTION_SCOPE_UNION {
...
#if defined(MIDL_PASS)
  [switch_is(ScopeType),
   switch_type(DHCP_OPTION_SCOPE_TYPE6)] union _DHCP_OPTION_SCOPE_UNION6 {
...
#if defined(MIDL_PASS)
  [switch_is(SearchType),
   switch_type(DHCP_SEARCH_INFO_TYPE)] union _DHCP_CLIENT_SEARCH_UNION {
...
#if defined(MIDL_PASS)
  [switch_is(Type),
   switch_type(DHCP_PROPERTY_TYPE)] union _DHCP_PROPERTY_VALUE_UNION {
...
#if defined(MIDL_PASS)
  [switch_is(ELEMENT_MASK(ElementType)),
   switch_type(DHCP_SUBNET_ELEMENT_TYPE)] union _DHCP_SUBNET_ELEMENT_UNION_V4 {
    [case (DhcpIpRanges)] DHCP_IP_RANGE *IpRange;
    [case (DhcpSecondaryHosts)] DHCP_HOST_INFO *SecondaryHost;
...
typedef union _DHCP_SUBNET_ELEMENT_UNION_V4 DHCP_SUBNET_ELEMENT_UNION_V4,
    *LPDHCP_SUBNET_ELEMENT_UNION_V4;
#endif
...
typedef struct _DHCP_ALL_OPTION_VALUES {
  ...
  [size_is(NumElements)]
      ...
      struct /* anonymous */ {
        ...
        OptionsArray; // list of options for the above pair: (vendor,user)
      } *
...
#if defined(MIDL_PASS)
  [switch_is(DhcpAttribType), switch_type(ULONG)] union {
...
#if defined(MIDL_PASS)
  [switch_is(ELEMENT_MASK(ElementType)),
   switch_type(DHCP_SUBNET_ELEMENT_TYPE)] union _DHCP_SUBNET_ELEMENT_UNION_V5 {
...
typedef struct _DHCP_SUBNET_ELEMENT_DATA_V6 {
  ...
  [switch_is(ELEMENT_MASK(ElementType)),
   switch_type(
       DHCP_SUBNET_ELEMENT_TYPE_V6)] union _DHCP_SUBNET_ELEMENT_UNION_V6 {
...
typedef union _DHCP_SUBNET_ELEMENT_UNION_V6 DHCP_SUBNET_ELEMENT_UNION_V6,
    *LPDHCP_SUBNET_ELEMENT_UNION_V6;
#endif
...
#if defined(MIDL_PASS)
  [switch_is(SearchType),
   switch_type(DHCP_SEARCH_INFO_TYPE_V6)] union _DHCP_CLIENT_SEARCH_UNION_V6 {
...
DhcpAddFilterV4(_In_opt_z_ DHCP_CONST WCHAR *ServerIpAddress,
                _In_ DHCP_FILTER_ADD_INFO *AddFilterInfo, _In_ BOOL ForceFlag);

DWORD DHCP_API_FUNCTION
DhcpDeleteFilterV4(_In_opt_z_ DHCP_CONST WCHAR *ServerIpAddress,
                   _In_ DHCP_ADDR_PATTERN *DeleteFilterInfo);

DWORD DHCP_API_FUNCTION
DhcpSetFilterV4(_In_opt_z_ DHCP_CONST WCHAR *ServerIpAddress,
                _In_ DHCP_FILTER_GLOBAL_INFO *GlobalFilterInfo);

DWORD DHCP_API_FUNCTION
DhcpGetFilterV4(_In_opt_z_ DHCP_CONST WCHAR *ServerIpAddress,
...
DWORD DHCP_API_FUNCTION DhcpEnumFilterV4(
    ...
    _Inout_ LPDHCP_ADDR_PATTERN ResumeHandle, _In_ DWORD PreferredMaximum,
    _In_ DHCP_FILTER_LIST_TYPE ListType,
    _Out_ LPDHCP_FILTER_ENUM_INFO *EnumFilterInfo, _Out_ DWORD *ElementsRead,
...
DWORD DHCP_API_FUNCTION DhcpCreateSubnet(
    _In_opt_z_ DHCP_CONST WCHAR *ServerIpAddress, DHCP_IP_ADDRESS SubnetAddress,
...
DWORD DHCP_API_FUNCTION
DhcpEnumSubnets(_In_opt_z_ DHCP_CONST WCHAR *ServerIpAddress,
                _Inout_ DHCP_RESUME_HANDLE *ResumeHandle,
                _In_ DWORD PreferredMaximum, _Inout_ LPDHCP_IP_ARRAY *EnumInfo,
                _Out_ DWORD *ElementsRead, _Out_ DWORD *ElementsTotal);
...
DWORD DHCP_API_FUNCTION DhcpEnumSubnetElements(
    _In_opt_z_ DHCP_CONST WCHAR *ServerIpAddress, DHCP_IP_ADDRESS SubnetAddress,
    DHCP_SUBNET_ELEMENT_TYPE EnumElementType, DHCP_RESUME_HANDLE *ResumeHandle,
    DWORD PreferredMaximum, LPDHCP_SUBNET_ELEMENT_INFO_ARRAY *EnumElementInfo,
...
DWORD DHCP_API_FUNCTION
DhcpDeleteSubnet(_In_opt_z_ DHCP_CONST WCHAR *ServerIpAddress,
                 DHCP_IP_ADDRESS SubnetAddress, DHCP_FORCE_FLAG ForceFlag);
...
DWORD DHCP_API_FUNCTION
DhcpCreateOption(_In_opt_z_ DHCP_CONST WCHAR *ServerIpAddress,
                 DHCP_OPTION_ID OptionID, DHCP_CONST DHCP_OPTION *OptionInfo);

DWORD DHCP_API_FUNCTION
DhcpSetOptionInfo(_In_opt_z_ DHCP_CONST WCHAR *ServerIpAddress,
                  DHCP_OPTION_ID OptionID, DHCP_CONST DHCP_OPTION *OptionInfo);

DWORD DHCP_API_FUNCTION
DhcpGetOptionInfo(_In_opt_z_ DHCP_CONST WCHAR *ServerIpAddress,
                  DHCP_OPTION_ID OptionID, LPDHCP_OPTION *OptionInfo);
...
DWORD DHCP_API_FUNCTION DhcpRemoveOption(
    _In_opt_z_ DHCP_CONST WCHAR *ServerIpAddress, DHCP_OPTION_ID OptionID);
...
DWORD DHCP_API_FUNCTION
DhcpSetOptionValues(_In_opt_z_ DHCP_CONST WCHAR *ServerIpAddress,
                    DHCP_CONST DHCP_OPTION_SCOPE_INFO *ScopeInfo,
...
DWORD DHCP_API_FUNCTION
DhcpEnumOptionValues(_In_opt_z_ DHCP_CONST WCHAR *ServerIpAddress,
                     DHCP_CONST DHCP_OPTION_SCOPE_INFO *ScopeInfo,
                     DHCP_RESUME_HANDLE *ResumeHandle, DWORD PreferredMaximum,
...
//
DWORD DHCP_API_FUNCTION
DhcpCreateClientInfoVQ(_In_opt_z_ DHCP_CONST WCHAR *ServerIpAddress,
                       DHCP_CONST DHCP_CLIENT_INFO_VQ *ClientInfo);

DWORD DHCP_API_FUNCTION
DhcpSetClientInfoVQ(_In_opt_z_ DHCP_CONST WCHAR *ServerIpAddress,
                    DHCP_CONST DHCP_CLIENT_INFO_VQ *ClientInfo);

DWORD DHCP_API_FUNCTION DhcpGetClientInfoVQ(
    _In_opt_z_ DHCP_CONST WCHAR *ServerIpAddress,
    DHCP_CONST DHCP_SEARCH_INFO *SearchInfo, LPDHCP_CLIENT_INFO_VQ *ClientInfo);

DWORD DHCP_API_FUNCTION DhcpEnumSubnetClientsVQ(
    _In_opt_z_ DHCP_CONST WCHAR *ServerIpAddress, DHCP_IP_ADDRESS SubnetAddress,
    DHCP_RESUME_HANDLE *ResumeHandle, DWORD PreferredMaximum,
    LPDHCP_CLIENT_INFO_ARRAY_VQ *ClientInfo, DWORD *ClientsRead,
    DWORD *ClientsTotal);

DWORD DHCP_API_FUNCTION DhcpEnumSubnetClientsFilterStatusInfo(
    _In_opt_z_ DHCP_CONST WCHAR *ServerIpAddress, DHCP_IP_ADDRESS SubnetAddress,
    DHCP_RESUME_HANDLE *ResumeHandle, DWORD PreferredMaximum,
    LPDHCP_CLIENT_FILTER_STATUS_INFO_ARRAY *ClientInfo, DWORD *ClientsRead,
    DWORD *ClientsTotal);

DWORD DHCP_API_FUNCTION
DhcpCreateClientInfo(_In_opt_z_ DHCP_CONST WCHAR *ServerIpAddress,
                     DHCP_CONST DHCP_CLIENT_INFO *ClientInfo);

DWORD DHCP_API_FUNCTION
DhcpSetClientInfo(_In_opt_z_ DHCP_CONST WCHAR *ServerIpAddress,
                  DHCP_CONST DHCP_CLIENT_INFO *ClientInfo);

DWORD DHCP_API_FUNCTION DhcpGetClientInfo(
    _In_opt_z_ DHCP_CONST WCHAR *ServerIpAddress,
    DHCP_CONST DHCP_SEARCH_INFO *SearchInfo, LPDHCP_CLIENT_INFO *ClientInfo);

DWORD DHCP_API_FUNCTION
DhcpDeleteClientInfo(_In_opt_z_ DHCP_CONST WCHAR *ServerIpAddress,
                     DHCP_CONST DHCP_SEARCH_INFO *ClientInfo);

DWORD DHCP_API_FUNCTION DhcpEnumSubnetClients(
    _In_opt_z_ DHCP_CONST WCHAR *ServerIpAddress, DHCP_IP_ADDRESS SubnetAddress,
    DHCP_RESUME_HANDLE *ResumeHandle, DWORD PreferredMaximum,
    LPDHCP_CLIENT_INFO_ARRAY *ClientInfo, DWORD *ClientsRead,
    DWORD *ClientsTotal);

DWORD DHCP_API_FUNCTION DhcpGetClientOptions(
    _In_opt_z_ DHCP_CONST WCHAR *ServerIpAddress,
    DHCP_IP_ADDRESS ClientIpAddress, DHCP_IP_MASK ClientSubnetMask,
    LPDHCP_OPTION_LIST *ClientOptions);

DWORD DHCP_API_FUNCTION DhcpGetMibInfo(
    _In_opt_z_ DHCP_CONST WCHAR *ServerIpAddress, LPDHCP_MIB_INFO *MibInfo);

DWORD DHCP_API_FUNCTION
DhcpServerSetConfig(_In_opt_z_ DHCP_CONST WCHAR *ServerIpAddress,
                    DWORD FieldsToSet, LPDHCP_SERVER_CONFIG_INFO ConfigInfo);

DWORD DHCP_API_FUNCTION
DhcpServerGetConfig(_In_opt_z_ DHCP_CONST WCHAR *ServerIpAddress,
                    LPDHCP_SERVER_CONFIG_INFO *ConfigInfo);

DWORD DHCP_API_FUNCTION DhcpScanDatabase(
    _In_opt_z_ DHCP_CONST WCHAR *ServerIpAddress, DHCP_IP_ADDRESS SubnetAddress,
    DWORD FixFlag, LPDHCP_SCAN_LIST *ScanList);

VOID DHCP_API_FUNCTION DhcpRpcFreeMemory(PVOID BufferPointer);

DWORD DHCP_API_FUNCTION DhcpGetVersion(_In_opt_ LPWSTR ServerIpAddress,
...
DWORD DHCP_API_FUNCTION DhcpEnumSubnetElementsV4(
    ...
    LPDHCP_SUBNET_ELEMENT_INFO_ARRAY_V4 *EnumElementInfo, DWORD *ElementsRead,
    DWORD *ElementsTotal);
...
DWORD DHCP_API_FUNCTION
DhcpCreateClientInfoV4(_In_opt_z_ DHCP_CONST WCHAR *ServerIpAddress,
                       DHCP_CONST DHCP_CLIENT_INFO_V4 *ClientInfo);

DWORD DHCP_API_FUNCTION
DhcpSetClientInfoV4(_In_opt_z_ DHCP_CONST WCHAR *ServerIpAddress,
                    DHCP_CONST DHCP_CLIENT_INFO_V4 *ClientInfo);

DWORD DHCP_API_FUNCTION DhcpGetClientInfoV4(
    _In_opt_z_ DHCP_CONST WCHAR *ServerIpAddress,
    DHCP_CONST DHCP_SEARCH_INFO *SearchInfo, LPDHCP_CLIENT_INFO_V4 *ClientInfo);

DWORD DHCP_API_FUNCTION DhcpEnumSubnetClientsV4(
    _In_opt_z_ DHCP_CONST WCHAR *ServerIpAddress, DHCP_IP_ADDRESS SubnetAddress,
    DHCP_RESUME_HANDLE *ResumeHandle, DWORD PreferredMaximum,
    LPDHCP_CLIENT_INFO_ARRAY_V4 *ClientInfo, DWORD *ClientsRead,
    DWORD *ClientsTotal);

DWORD DHCP_API_FUNCTION DhcpServerSetConfigV4(
    _In_opt_z_ DHCP_CONST WCHAR *ServerIpAddress, DWORD FieldsToSet,
    LPDHCP_SERVER_CONFIG_INFO_V4 ConfigInfo);

DWORD DHCP_API_FUNCTION
DhcpServerGetConfigV4(_In_opt_z_ DHCP_CONST WCHAR *ServerIpAddress,
                      LPDHCP_SERVER_CONFIG_INFO_V4 *ConfigInfo);

DWORD
DhcpSetSuperScopeV4(_In_opt_z_ DHCP_CONST WCHAR *ServerIpAddress,
                    DHCP_CONST DHCP_IP_ADDRESS SubnetAddress,
                    _In_opt_ DHCP_CONST LPWSTR SuperScopeName,
                    DHCP_CONST BOOL ChangeExisting);

DWORD
DhcpDeleteSuperScopeV4(_In_opt_z_ DHCP_CONST WCHAR *ServerIpAddress,
                       _In_ DHCP_CONST LPWSTR SuperScopeName);

DWORD
DhcpGetSuperScopeInfoV4(_In_opt_z_ DHCP_CONST WCHAR *ServerIpAddress,
                        LPDHCP_SUPER_SCOPE_TABLE *SuperScopeTable);

DWORD DHCP_API_FUNCTION DhcpEnumSubnetClientsV5(
    _In_opt_z_ DHCP_CONST WCHAR *ServerIpAddress, DHCP_IP_ADDRESS SubnetAddress,
    DHCP_RESUME_HANDLE *ResumeHandle, DWORD PreferredMaximum,
    LPDHCP_CLIENT_INFO_ARRAY_V5 *ClientInfo, DWORD *ClientsRead,
    DWORD *ClientsTotal);

DWORD
DhcpCreateOptionV5(_In_opt_ IN LPWSTR ServerIpAddress, IN DWORD Flags,
                   IN DHCP_OPTION_ID OptionId, _In_opt_ IN LPWSTR ClassName,
                   _In_opt_ IN LPWSTR VendorName, IN LPDHCP_OPTION OptionInfo);

DWORD                // ERROR_DHCP_OPTION_NOT_PRESENT if option does not exist
DhcpSetOptionInfoV5( // Modify existing option's fields
    _In_opt_ IN LPWSTR ServerIpAddress, IN DWORD Flags,
    IN DHCP_OPTION_ID OptionID, _In_opt_ IN LPWSTR ClassName,
    _In_opt_ IN LPWSTR VendorName, IN LPDHCP_OPTION OptionInfo);
...
DhcpEnumOptionsV5( // enumerate the options defined
    _In_opt_ IN LPWSTR ServerIpAddress, IN DWORD Flags,
    _In_opt_ IN LPWSTR ClassName, _In_opt_ IN LPWSTR VendorName,
    IN OUT DHCP_RESUME_HANDLE *ResumeHandle, IN DWORD PreferredMaximum,
    OUT LPDHCP_OPTION_ARRAY *Options, OUT DWORD *OptionsRead,
...
DhcpSetOptionValueV5( // replace or add a new option value
    _In_opt_ IN LPWSTR ServerIpAddress, IN DWORD Flags,
    IN DHCP_OPTION_ID OptionId, _In_opt_ IN LPWSTR ClassName,
    _In_opt_ IN LPWSTR VendorName, IN LPDHCP_OPTION_SCOPE_INFO ScopeInfo,
    IN LPDHCP_OPTION_DATA OptionValue);

DWORD
DhcpSetOptionValuesV5(_In_opt_ IN LPWSTR ServerIpAddress, IN DWORD Flags,
...
DhcpGetOptionValueV6( // fetch the required option at required level
    _In_opt_ IN LPWSTR ServerIpAddress, IN DWORD Flags,
    IN DHCP_OPTION_ID OptionID, _In_opt_ IN LPWSTR ClassName,
    _In_opt_ IN LPWSTR VendorName, IN LPDHCP_OPTION_SCOPE_INFO6 ScopeInfo,
    OUT LPDHCP_OPTION_VALUE *OptionValue);

DWORD
DhcpEnumOptionValuesV5(_In_opt_ IN LPWSTR ServerIpAddress, IN DWORD Flags,
                       _In_opt_ IN LPWSTR ClassName,
                       _In_opt_ IN LPWSTR VendorName,
                       IN LPDHCP_OPTION_SCOPE_INFO ScopeInfo,
                       ...
                       OUT DWORD *OptionsRead, OUT DWORD *OptionsTotal);

DWORD
DhcpRemoveOptionValueV5(_In_opt_ IN LPWSTR ServerIpAddress, IN DWORD Flags,
...
DWORD
DhcpCreateClass(_In_opt_ IN LPWSTR ServerIpAddress, IN DWORD ReservedMustBeZero,
                IN LPDHCP_CLASS_INFO ClassInfo);

DWORD
DhcpModifyClass(_In_opt_ IN LPWSTR ServerIpAddress, IN DWORD ReservedMustBeZero,
                IN LPDHCP_CLASS_INFO ClassInfo);

DWORD
DhcpDeleteClass(_In_opt_ IN LPWSTR ServerIpAddress, IN DWORD ReservedMustBeZero,
                _In_ IN LPWSTR ClassName);

DWORD
DhcpGetClassInfo(_In_opt_ IN LPWSTR ServerIpAddress,
                 IN DWORD ReservedMustBeZero,
                 IN LPDHCP_CLASS_INFO PartialClassInfo,
                 OUT LPDHCP_CLASS_INFO *FilledClassInfo);

DWORD
DhcpEnumClasses(_In_opt_ IN LPWSTR ServerIpAddress, IN DWORD ReservedMustBeZero,
                IN OUT DHCP_RESUME_HANDLE *ResumeHandle,
                IN DWORD PreferredMaximum,
                OUT LPDHCP_CLASS_INFO_ARRAY *ClassInfoArray, OUT DWORD *nRead,
                OUT DWORD *nTotal);
...
DWORD
DhcpGetAllOptionValues(_In_opt_ IN LPWSTR ServerIpAddress, IN DWORD Flags,
                       IN LPDHCP_OPTION_SCOPE_INFO ScopeInfo,
                       OUT LPDHCP_ALL_OPTION_VALUES *Values);

DWORD DHCP_API_FUNCTION
DhcpGetAllOptionValuesV6(_In_opt_ LPWSTR ServerIpAddress, IN DWORD Flags,
                         IN LPDHCP_OPTION_SCOPE_INFO6 ScopeInfo,
                         OUT LPDHCP_ALL_OPTION_VALUES *Values);

// DOC DhcpEnumServers enumerates the list of servers found in the DS.  If the
// DS DOC is not accessible, it returns an error. The only currently used
// parameter DOC is the out parameter Servers.  This is a SLOW call.
DWORD
DhcpEnumServers(IN DWORD Flags,                        // must be zero
...
// DOC DhcpAddServer tries to add a new server to the existing list of servers
// in DOC the DS. The function returns error if the Server already exists in the
// DS. DOC The function tries to upload the server configuration to the DS.. DOC
// This is a SLOW call.  Currently, the DsLocation and DsLocType are not valid
// DOC fields in the NewServer and they'd be ignored. Version must be zero.
DWORD
DhcpAddServer(IN DWORD Flags,                  // must be zero
              IN LPVOID IdInfo,                // must be NULL
...
// DOC DhcpDeleteServer tries to delete the server from DS. It is an error if
// the DOC server does not already exist.  This also deletes any objects related
// to DOC this server in the DS (like subnet, reservations etc.).
DWORD
DhcpDeleteServer(IN DWORD Flags,                  // must be zero
                 IN LPVOID IdInfo,                // must be NULL
                 IN LPDHCP_SERVER_INFO NewServer, // input server information
                 IN LPVOID CallbackFn,            // must be NULL
                 IN LPVOID CallbackData           // must be NULL
...
DWORD DHCP_API_FUNCTION DhcpGetServerBindingInfo(
    _In_opt_z_ DHCP_CONST WCHAR *ServerIpAddress, ULONG Flags,
...
DWORD DHCP_API_FUNCTION DhcpEnumSubnetElementsV5(
    ...
    DHCP_SUBNET_ELEMENT_TYPE EnumElementType, DHCP_RESUME_HANDLE *ResumeHandle,
    DWORD PreferredMaximum,
    LPDHCP_SUBNET_ELEMENT_INFO_ARRAY_V5 *EnumElementInfo, DWORD *ElementsRead,
    DWORD *ElementsTotal);
...
DWORD DHCP_API_FUNCTION DhcpV4EnumSubnetReservations(
    ...
    _Inout_ DHCP_RESUME_HANDLE *ResumeHandle, _In_ DWORD PreferredMaximum,
    _Out_ LPDHCP_RESERVATION_INFO_ARRAY *EnumElementInfo,
    _Out_ DWORD *ElementsRead, _Out_ DWORD *ElementsTotal);

// V6 Api's
DWORD DHCP_API_FUNCTION DhcpCreateOptionV6(_In_opt_ IN LPWSTR ServerIpAddress,
                                           IN DWORD Flags,
                                           IN DHCP_OPTION_ID OptionId,
                                           _In_opt_ IN LPWSTR ClassName,
                                           _In_opt_ IN LPWSTR VendorName,
                                           IN LPDHCP_OPTION OptionInfo);
DWORD DHCP_API_FUNCTION DhcpRemoveOptionV6(_In_opt_ IN LPWSTR ServerIpAddress,
                                           IN DWORD Flags,
                                           IN DHCP_OPTION_ID OptionID,
                                           _In_opt_ IN LPWSTR ClassName,
                                           _In_opt_ IN LPWSTR VendorName);
DWORD DHCP_API_FUNCTION
DhcpEnumOptionsV6(_In_opt_ IN LPWSTR ServerIpAddress, IN DWORD Flags,
                  _In_opt_ IN LPWSTR ClassName, _In_opt_ IN LPWSTR VendorName,
                  IN OUT DHCP_RESUME_HANDLE *ResumeHandle,
                  IN DWORD PreferredMaximum, OUT LPDHCP_OPTION_ARRAY *Options,
                  OUT DWORD *OptionsRead, OUT DWORD *OptionsTotal);

DWORD DHCP_API_FUNCTION DhcpRemoveOptionValueV6(
    _In_opt_ LPWSTR ServerIpAddress, IN DWORD Flags, IN DHCP_OPTION_ID OptionID,
    _In_opt_ LPWSTR ClassName, _In_opt_ LPWSTR VendorName,
    IN LPDHCP_OPTION_SCOPE_INFO6 ScopeInfo);
DWORD DHCP_API_FUNCTION DhcpGetOptionInfoV6(_In_opt_ LPWSTR ServerIpAddress,
                                            IN DWORD Flags,
                                            IN DHCP_OPTION_ID OptionID,
...
DWORD DHCP_API_FUNCTION DhcpSetOptionInfoV6(_In_opt_ LPWSTR ServerIpAddress,
                                            IN DWORD Flags,
                                            IN DHCP_OPTION_ID OptionID,
                                            _In_opt_ LPWSTR ClassName,
                                            _In_opt_ LPWSTR VendorName,
...
DWORD DHCP_API_FUNCTION DhcpSetOptionValueV6(
    _In_opt_ LPWSTR ServerIpAddress, IN DWORD Flags, IN DHCP_OPTION_ID OptionId,
    _In_opt_ LPWSTR ClassName, _In_opt_ LPWSTR VendorName,
    IN LPDHCP_OPTION_SCOPE_INFO6 ScopeInfo, IN LPDHCP_OPTION_DATA OptionValue);
...
DWORD DHCP_API_FUNCTION DhcpEnumOptionValuesV6(
    _In_opt_z_ DHCP_CONST WCHAR *ServerIpAddress, DWORD Flags,
    _In_opt_ LPWSTR ClassName, _In_opt_ LPWSTR VendorName,
    LPDHCP_OPTION_SCOPE_INFO6 ScopeInfo, DHCP_RESUME_HANDLE *ResumeHandle,
...
// DOC DhcpDsCleanup undoes the effect of any DhcpDsInit.  This function should
// be DOC called exactly once for each process, and only at termination.  Note
// that DOC it is safe to call this function even if DhcpDsInit does not
// succeed.
...
// DOC DhcpGetThreadOptions retrieves the current thread options as set by
// DhcpSetThreadOptions. DOC If none were set, the return value is zero.
DWORD
...
DWORD
DhcpAuditLogGetParams(_In_opt_ IN LPWSTR ServerIpAddress, IN DWORD Flags,
                      _Outptr_result_maybenull_ OUT LPWSTR *AuditLogDir,
                      OUT DWORD *DiskCheckInterval, OUT DWORD *MaxLogFilesSize,
                      OUT DWORD *MinSpaceOnDisk);

DWORD
DhcpServerQueryDnsRegCredentials(_In_opt_ IN LPWSTR ServerIpAddress,
...
DWORD
DhcpServerSetDnsRegCredentials(_In_opt_ IN LPWSTR ServerIpAddress,
                               _In_opt_ IN LPWSTR Uname,
                               _In_opt_ IN LPWSTR Domain,
                               _In_opt_ IN LPWSTR Passwd);

DWORD
DhcpServerSetDnsRegCredentialsV5(_In_opt_ IN LPWSTR ServerIpAddress,
                                 _In_opt_ IN LPWSTR Uname,
                                 _In_opt_ IN LPWSTR Domain,
                                 _In_opt_ IN LPWSTR Passwd);

DWORD
DhcpServerBackupDatabase(_In_opt_ IN LPWSTR ServerIpAddress,
                         _In_ IN LPWSTR Path);

DWORD
DhcpServerRestoreDatabase(_In_opt_ IN LPWSTR ServerIpAddress,
                          _In_ IN LPWSTR Path);
...
DWORD DHCP_API_FUNCTION
DhcpServerGetConfigVQ(_In_opt_z_ DHCP_CONST WCHAR *ServerIpAddress,
                      LPDHCP_SERVER_CONFIG_INFO_VQ *ConfigInfo);
...
DhcpServerAuditlogParamsFree(DHCP_SERVER_CONFIG_INFO_VQ *ConfigInfo);

DWORD DHCP_API_FUNCTION DhcpCreateSubnetV6(_In_opt_ LPWSTR ServerIpAddress,
                                           DHCP_IPV6_ADDRESS SubnetAddress,
                                           LPDHCP_SUBNET_INFO_V6 SubnetInfo);

DWORD DHCP_API_FUNCTION DhcpDeleteSubnetV6(_In_opt_ LPWSTR ServerIpAddress,
                                           DHCP_IPV6_ADDRESS SubnetAddress,
                                           DHCP_FORCE_FLAG ForceFlag);
...
DWORD DHCP_API_FUNCTION DhcpEnumSubnetsV6(
    _In_opt_z_ DHCP_CONST WCHAR *ServerIpAddress,
    DHCP_RESUME_HANDLE *ResumeHandle, DWORD PreferredMaximum,
    LPDHCPV6_IP_ARRAY *EnumInfo, DWORD *ElementsRead, DWORD *ElementsTotal);

DWORD DHCP_API_FUNCTION DhcpAddSubnetElementV6(
    _In_opt_ LPWSTR ServerIpAddress, DHCP_IPV6_ADDRESS SubnetAddress,
    LPDHCP_SUBNET_ELEMENT_DATA_V6 AddElementInfo);

DWORD DHCP_API_FUNCTION DhcpRemoveSubnetElementV6(
    _In_opt_ LPWSTR ServerIpAddress, DHCP_IPV6_ADDRESS SubnetAddress,
    LPDHCP_SUBNET_ELEMENT_DATA_V6 RemoveElementInfo, DHCP_FORCE_FLAG ForceFlag);
...
DWORD DHCP_API_FUNCTION DhcpGetSubnetInfoV6(_In_opt_ LPWSTR ServerIpAddress,
                                            DHCP_IPV6_ADDRESS SubnetAddress,
                                            LPDHCP_SUBNET_INFO_V6 *SubnetInfo);

DWORD DHCP_API_FUNCTION DhcpEnumSubnetClientsV6(
    _In_opt_z_ DHCP_CONST WCHAR *ServerIpAddress,
    DHCP_IPV6_ADDRESS SubnetAddress, DHCP_RESUME_IPV6_HANDLE *ResumeHandle,
    DWORD PreferredMaximum, LPDHCP_CLIENT_INFO_ARRAY_V6 *ClientInfo,
    DWORD *ClientsRead, DWORD *ClientsTotal);

DWORD DHCP_API_FUNCTION
DhcpServerGetConfigV6(_In_opt_z_ DHCP_CONST WCHAR *ServerIpAddress,
                      LPDHCP_OPTION_SCOPE_INFO6 ScopeInfo,
                      LPDHCP_SERVER_CONFIG_INFO_V6 *ConfigInfo);

DWORD DHCP_API_FUNCTION
DhcpServerSetConfigV6(_In_opt_z_ DHCP_CONST WCHAR *ServerIpAddress,
                      LPDHCP_OPTION_SCOPE_INFO6 ScopeInfo, DWORD FieldsToSet,
                      LPDHCP_SERVER_CONFIG_INFO_V6 ConfigInfo);

DWORD
DhcpSetSubnetInfoV6(_In_opt_z_ DHCP_CONST WCHAR *ServerIpAddress,
                    DHCP_IPV6_ADDRESS SubnetAddress,
                    LPDHCP_SUBNET_INFO_V6 SubnetInfo);
DWORD
DhcpGetMibInfoV6(_In_opt_z_ DHCP_CONST WCHAR *ServerIpAddress,
...
DWORD DHCP_API_FUNCTION
DhcpSetClientInfoV6(_In_opt_z_ DHCP_CONST WCHAR *ServerIpAddress,
                    DHCP_CONST DHCP_CLIENT_INFO_V6 *ClientInfo);

DWORD DHCP_API_FUNCTION
DhcpGetClientInfoV6(_In_opt_z_ DHCP_CONST WCHAR *ServerIpAddress,
                    DHCP_CONST DHCP_SEARCH_INFO_V6 *SearchInfo,
                    LPDHCP_CLIENT_INFO_V6 *ClientInfo);

DWORD DHCP_API_FUNCTION
DhcpDeleteClientInfoV6(_In_opt_z_ DHCP_CONST WCHAR *ServerIpAddress,
                       DHCP_CONST DHCP_SEARCH_INFO_V6 *ClientInfo);

DWORD DHCP_API_FUNCTION DhcpCreateClassV6(_In_opt_ IN LPWSTR ServerIpAddress,
                                          IN DWORD ReservedMustBeZero,
                                          IN LPDHCP_CLASS_INFO_V6 ClassInfo);

DWORD DHCP_API_FUNCTION DhcpModifyClassV6(_In_opt_ IN LPWSTR ServerIpAddress,
                                          IN DWORD ReservedMustBeZero,
                                          IN LPDHCP_CLASS_INFO_V6 ClassInfo);

DWORD DHCP_API_FUNCTION DhcpDeleteClassV6(_In_opt_ IN LPWSTR ServerIpAddress,
                                          IN DWORD ReservedMustBeZero,
                                          _In_ IN LPWSTR ClassName);

DWORD DHCP_API_FUNCTION DhcpEnumClassesV6(
    _In_opt_ IN LPWSTR ServerIpAddress, IN DWORD ReservedMustBeZero,
    IN OUT DHCP_RESUME_HANDLE *ResumeHandle, IN DWORD PreferredMaximum,
    OUT LPDHCP_CLASS_INFO_ARRAY_V6 *ClassInfoArray, OUT DWORD *nRead,
    OUT DWORD *nTotal);

DWORD DHCP_API_FUNCTION DhcpSetSubnetDelayOffer(
    _In_opt_ IN LPWSTR ServerIpAddress, IN DHCP_IP_ADDRESS SubnetAddress,
...
DWORD DHCP_API_FUNCTION
DhcpGetMibInfoV5(_In_opt_z_ DHCP_CONST WCHAR *ServerIpAddress,
                 OUT LPDHCP_MIB_INFO_V5 *MibInfo);

DWORD DHCP_API_FUNCTION DhcpAddSecurityGroup(_In_opt_ LPWSTR pServer);

DWORD DHCP_API_FUNCTION DhcpV4GetOptionValue(
    _In_opt_ IN LPWSTR ServerIpAddress, IN DWORD Flags,
    IN DHCP_OPTION_ID OptionID, _In_opt_ IN LPWSTR PolicyName,
    _In_opt_ IN LPWSTR VendorName, IN LPDHCP_OPTION_SCOPE_INFO ScopeInfo,
    OUT LPDHCP_OPTION_VALUE *OptionValue);
...
DWORD DHCP_API_FUNCTION DhcpV4SetOptionValues(
    _In_opt_ IN LPWSTR ServerIpAddress, IN DWORD Flags,
    _In_opt_ IN LPWSTR PolicyName, _In_opt_ IN LPWSTR VendorName,
    IN LPDHCP_OPTION_SCOPE_INFO ScopeInfo,
    IN LPDHCP_OPTION_VALUE_ARRAY OptionValues);
...
DWORD DHCP_API_FUNCTION
DhcpV4GetAllOptionValues(_In_opt_ IN LPWSTR ServerIpAddress, IN DWORD Flags,
                         IN LPDHCP_OPTION_SCOPE_INFO ScopeInfo,
...
typedef enum _FSM_STATE // enumeration defining all the states of the failover
                        // servers.
{ NO_STATE = 0,
  INIT,
  STARTUP,
...
typedef struct _DHCPV4_FAILOVER_CLIENT_INFO_ARRAY {
  ...
  [size_is(NumElements)]
#endif // MIDL_PASS
      _Field_size_(NumElements)
          LPDHCPV4_FAILOVER_CLIENT_INFO *Clients; // array of pointers
...
DWORD DHCP_API_FUNCTION
DhcpV4FailoverSetRelationship(_In_opt_ LPWSTR ServerIpAddress, _In_ DWORD Flags,
                              _In_ LPDHCP_FAILOVER_RELATIONSHIP pRelationship);

DWORD DHCP_API_FUNCTION DhcpV4FailoverDeleteRelationship(
    _In_opt_ LPWSTR ServerIpAddress, _In_ LPWSTR pRelationshipName);
...
DWORD DHCP_API_FUNCTION DhcpV4FailoverEnumRelationship(
    _In_opt_ LPWSTR ServerIpAddress, _Inout_ DHCP_RESUME_HANDLE *ResumeHandle,
    _In_ DWORD PreferredMaximum,
    _Out_ LPDHCP_FAILOVER_RELATIONSHIP_ARRAY *pRelationship,
    _Out_ LPDWORD RelationshipRead, _Out_ LPDWORD RelationshipTotal);
...
DWORD DHCP_API_FUNCTION DhcpV4FailoverGetScopeRelationship(
    _In_opt_ LPWSTR ServerIpAddress, _In_ DHCP_IP_ADDRESS ScopeId,
    _Out_ LPDHCP_FAILOVER_RELATIONSHIP *pRelationship);
...
DWORD DHCP_API_FUNCTION
DhcpV4FailoverGetClientInfo(_In_opt_ LPWSTR ServerIpAddress,
...
DWORD DHCP_API_FUNCTION DhcpV4FailoverGetSystemTime(
    _In_opt_ LPWSTR ServerIpAddress, _Out_ LPDWORD pTime,
    _Out_ LPDWORD pMaxAllowedDeltaTime);

DWORD DHCP_API_FUNCTION DhcpV4FailoverGetAddressStatus(
    _In_opt_ LPWSTR ServerIpAddress, _In_ DHCP_IP_ADDRESS SubnetAddress,
    _Inout_ LPDWORD pStatus);

DWORD DHCP_API_FUNCTION DhcpV4FailoverTriggerAddrAllocation(
    _In_opt_ LPWSTR ServerIpAddress, _In_ LPWSTR pFailRelName);

// Policy Functions Defn start

DWORD DHCP_API_FUNCTION DhcpHlprCreateV4Policy(
    _In_ LPWSTR PolicyName, _In_ BOOL fGlobalPolicy,
    _In_ DHCP_IP_ADDRESS Subnet, _In_ DWORD ProcessingOrder,
    _In_ DHCP_POL_LOGIC_OPER RootOperator, _In_ LPWSTR Description,
    _In_ BOOL Enabled, _Out_ LPDHCP_POLICY *Policy);

DWORD DHCP_API_FUNCTION DhcpHlprCreateV4PolicyEx(
    _In_ LPWSTR PolicyName, _In_ BOOL fGlobalPolicy,
    _In_ DHCP_IP_ADDRESS Subnet, _In_ DWORD ProcessingOrder,
    _In_ DHCP_POL_LOGIC_OPER RootOperator, _In_ LPWSTR Description,
    _In_ BOOL Enabled, _Out_ LPDHCP_POLICY_EX *Policy);

DWORD DHCP_API_FUNCTION DhcpHlprAddV4PolicyExpr(
    _Inout_ LPDHCP_POLICY Policy, _In_ DWORD ParentExpr,
    _In_ DHCP_POL_LOGIC_OPER Operator, _Out_ DWORD *ExprIndex);

DWORD DHCP_API_FUNCTION DhcpHlprAddV4PolicyCondition(
    _Inout_ LPDHCP_POLICY Policy, _In_ DWORD ParentExpr,
    _In_ DHCP_POL_ATTR_TYPE Type, _In_ DWORD OptionID, _In_ DWORD SubOptionID,
    _In_opt_ LPWSTR VendorName, _In_ DHCP_POL_COMPARATOR Operator,
    _In_reads_bytes_(ValueLength) LPBYTE Value, _In_ DWORD ValueLength,
    _Out_ DWORD *ConditionIndex);

DWORD DHCP_API_FUNCTION DhcpHlprAddV4PolicyRange(_Inout_ LPDHCP_POLICY Policy,
                                                 _In_ LPDHCP_IP_RANGE Range);

DWORD DHCP_API_FUNCTION DhcpHlprResetV4PolicyExpr(_Inout_ LPDHCP_POLICY Policy);

DWORD DHCP_API_FUNCTION DhcpHlprModifyV4PolicyExpr(
    _Inout_ LPDHCP_POLICY Policy, _In_ DHCP_POL_LOGIC_OPER Operator);

VOID DHCP_API_FUNCTION DhcpHlprFreeV4Policy(_Inout_ LPDHCP_POLICY Policy);

VOID DHCP_API_FUNCTION
DhcpHlprFreeV4PolicyArray(_Inout_ LPDHCP_POLICY_ARRAY PolicyArray);

VOID DHCP_API_FUNCTION
DhcpHlprFreeV4PolicyEx(_Inout_ LPDHCP_POLICY_EX PolicyEx);

VOID DHCP_API_FUNCTION
DhcpHlprFreeV4PolicyExArray(_Inout_ LPDHCP_POLICY_EX_ARRAY PolicyExArray);

VOID DHCP_API_FUNCTION
DhcpHlprFreeV4DhcpProperty(_Inout_ LPDHCP_PROPERTY Property);

VOID DHCP_API_FUNCTION
DhcpHlprFreeV4DhcpPropertyArray(_Inout_ LPDHCP_PROPERTY_ARRAY PropertyArray);

LPDHCP_PROPERTY
DhcpHlprFindV4DhcpProperty(_In_ LPDHCP_PROPERTY_ARRAY PropertyArray,
                           _In_ DHCP_PROPERTY_ID ID,
                           _In_ DHCP_PROPERTY_TYPE Type);

BOOL DHCP_API_FUNCTION DhcpHlprIsV4PolicySingleUC(_In_ LPDHCP_POLICY Policy);

DWORD DHCP_API_FUNCTION DhcpV4QueryPolicyEnforcement(
    _In_opt_ LPWSTR ServerIpAddress, _In_ BOOL fGlobalPolicy,
    _In_ DHCP_IP_ADDRESS SubnetAddress, _Out_ BOOL *Enabled);

DWORD DHCP_API_FUNCTION DhcpV4SetPolicyEnforcement(
    _In_opt_ LPWSTR ServerIpAddress, _In_ BOOL fGlobalPolicy,
    _In_ DHCP_IP_ADDRESS SubnetAddress, _In_ BOOL Enable);

BOOL DHCP_API_FUNCTION DhcpHlprIsV4PolicyWellFormed(_In_ LPDHCP_POLICY pPolicy);

DWORD DHCP_API_FUNCTION DhcpHlprIsV4PolicyValid(_In_ LPDHCP_POLICY pPolicy);

DWORD DHCP_API_FUNCTION DhcpV4CreatePolicy(_In_opt_ LPWSTR ServerIpAddress,
                                           _In_ LPDHCP_POLICY pPolicy);

DWORD DHCP_API_FUNCTION DhcpV4GetPolicy(_In_opt_ LPWSTR ServerIpAddress,
                                        _In_ BOOL fGlobalPolicy,
                                        _In_ DHCP_IP_ADDRESS SubnetAddress,
                                        _In_ LPWSTR PolicyName,
                                        _Out_ LPDHCP_POLICY *Policy);

DWORD DHCP_API_FUNCTION DhcpV4SetPolicy(_In_opt_ LPWSTR ServerIpAddress,
...
DWORD DHCP_API_FUNCTION DhcpV4DeletePolicy(_In_opt_ LPWSTR ServerIpAddress,
                                           _In_ BOOL fGlobalPolicy,
                                           _In_ DHCP_IP_ADDRESS SubnetAddress,
                                           _In_ LPWSTR PolicyName);
...
DWORD DHCP_API_FUNCTION DhcpV4EnumPolicies(
    ...
    _In_ DWORD PreferredMaximum, _In_ BOOL fGlobalPolicy,
    _In_ DHCP_IP_ADDRESS SubnetAddress, _Out_ LPDHCP_POLICY_ARRAY *EnumInfo,
    _Out_ DWORD *ElementsRead, _Out_ DWORD *ElementsTotal);

DWORD DHCP_API_FUNCTION DhcpV4AddPolicyRange(_In_opt_ LPWSTR ServerIpAddress,
                                             _In_ DHCP_IP_ADDRESS SubnetAddress,
                                             _In_ LPWSTR PolicyName,
                                             _In_ LPDHCP_IP_RANGE Range);
...
DWORD DHCP_API_FUNCTION DhcpV4RemovePolicyRange(
    _In_opt_ LPWSTR ServerIpAddress, _In_ DHCP_IP_ADDRESS SubnetAddress,
    _In_ LPWSTR PolicyName, _In_ LPDHCP_IP_RANGE Range);

// Stateless Client Inventory API functions

DWORD DHCP_API_FUNCTION DhcpV6SetStatelessStoreParams(
    _In_opt_ LPWSTR ServerIpAddress, _In_ BOOL fServerLevel,
    _In_ DHCP_IPV6_ADDRESS SubnetAddress, _In_ DWORD FieldModified,
...
DWORD DHCP_API_FUNCTION
DhcpV6GetStatelessStatistics(_In_opt_ LPWSTR ServerIpAddress,
                             _Out_ LPDHCPV6_STATELESS_STATS *StatelessStats);

// More client APIs
DWORD DHCP_API_FUNCTION
DhcpV4CreateClientInfo(_In_opt_z_ DHCP_CONST WCHAR *ServerIpAddress,
...
DWORD DHCP_API_FUNCTION DhcpV4EnumSubnetClients(
    ...
    _In_ DHCP_IP_ADDRESS SubnetAddress,
    _Inout_ DHCP_RESUME_HANDLE *ResumeHandle, _In_ DWORD PreferredMaximum,
    _Out_ LPDHCP_CLIENT_INFO_PB_ARRAY *ClientInfo, _Out_ DWORD *ClientsRead,
    _Out_ DWORD *ClientsTotal);

DWORD DHCP_API_FUNCTION
DhcpV4GetClientInfo(_In_opt_z_ DHCP_CONST WCHAR *ServerIpAddress,
                    _In_ DHCP_CONST DHCP_SEARCH_INFO *SearchInfo,
                    _Out_ LPDHCP_CLIENT_INFO_PB *ClientInfo);

DWORD DHCP_API_FUNCTION
DhcpV6CreateClientInfo(_In_opt_z_ DHCP_CONST WCHAR *ServerIpAddress,
                       _In_ DHCP_CONST LPDHCP_CLIENT_INFO_V6 ClientInfo);

DWORD DHCP_API_FUNCTION DhcpV4GetFreeIPAddress(
    _In_opt_ LPWSTR ServerIpAddress, _In_ DHCP_IP_ADDRESS ScopeId,
    _In_ DHCP_IP_ADDRESS StartIP, _In_ DHCP_IP_ADDRESS EndIP,
    _In_ DWORD NumFreeAddrReq, _Out_ LPDHCP_IP_ARRAY *IPAddrList);

DWORD DHCP_API_FUNCTION DhcpV6GetFreeIPAddress(
    _In_opt_ LPWSTR ServerIpAddress, _In_ DHCP_IPV6_ADDRESS ScopeId,
    _In_ DHCP_IPV6_ADDRESS StartIP, _In_ DHCP_IPV6_ADDRESS EndIP,
    _In_ DWORD NumFreeAddrReq, _Out_ LPDHCPV6_IP_ARRAY *IPAddrList);

DWORD DHCP_API_FUNCTION
DhcpV4CreateClientInfoEx(_In_opt_z_ DHCP_CONST WCHAR *ServerIpAddress,
                         _In_ DHCP_CONST LPDHCP_CLIENT_INFO_EX ClientInfo);

DWORD DHCP_API_FUNCTION DhcpV4EnumSubnetClientsEx(
    _In_opt_z_ DHCP_CONST WCHAR *ServerIpAddress,
    _In_ DHCP_IP_ADDRESS SubnetAddress,
    _Inout_ DHCP_RESUME_HANDLE *ResumeHandle, _In_ DWORD PreferredMaximum,
    _Out_ LPDHCP_CLIENT_INFO_EX_ARRAY *ClientInfo, _Out_ DWORD *ClientsRead,
    _Out_ DWORD *ClientsTotal);

DWORD DHCP_API_FUNCTION
DhcpV4GetClientInfoEx(_In_opt_z_ DHCP_CONST WCHAR *ServerIpAddress,
                      _In_ DHCP_CONST DHCP_SEARCH_INFO *SearchInfo,
                      _Out_ LPDHCP_CLIENT_INFO_EX *ClientInfo);

DWORD DHCP_API_FUNCTION DhcpV4CreatePolicyEx(_In_opt_ LPWSTR ServerIpAddress,
                                             _In_ LPDHCP_POLICY_EX PolicyEx);

DWORD DHCP_API_FUNCTION DhcpV4GetPolicyEx(_In_opt_ LPWSTR ServerIpAddress,
...
DWORD DHCP_API_FUNCTION DhcpV4SetPolicyEx(_In_opt_ LPWSTR ServerIpAddress,
                                          _In_ DWORD FieldsModified,
                                          _In_ BOOL GlobalPolicy,
                                          _In_ DHCP_IP_ADDRESS SubnetAddress,
                                          _In_ LPWSTR PolicyName,
...
DWORD DHCP_API_FUNCTION DhcpV4EnumPoliciesEx(
    _In_opt_ LPWSTR ServerIpAddress, _Inout_ LPDWORD ResumeHandle,
    _In_ DWORD PreferredMaximum, _In_ BOOL GlobalPolicy,
    _In_ DHCP_IP_ADDRESS SubnetAddress, _Out_ LPDHCP_POLICY_EX_ARRAY *EnumInfo,
    _Out_ DWORD *ElementsRead, _Out_ DWORD *ElementsTotal);
