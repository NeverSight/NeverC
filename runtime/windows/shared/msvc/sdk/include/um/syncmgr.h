...
typedef interface ISyncMgrScheduleWizardUIOperation
...
typedef interface ISyncMgrConflictResolutionItems
...
typedef struct ISyncMgrHandlerCollectionVtbl {
  ...
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in ISyncMgrHandlerCollection *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in ISyncMgrHandlerCollection *This);
...
public:
  ...
  virtual HRESULT STDMETHODCALLTYPE GetHandlerInfo(
      /* [out] */ __RPC__deref_out_opt ISyncMgrHandlerInfo *
      *ppHandlerInfo) = 0;
  ...
  virtual HRESULT STDMETHODCALLTYPE Synchronize(
      /* [size_is][string][ref][in] */ __RPC__in_ecount_full(cItems) LPCWSTR *
          ppszItemIDs,
      /* [in] */ ULONG cItems,
...
typedef struct ISyncMgrHandlerVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in ISyncMgrHandler *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in ISyncMgrHandler *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in ISyncMgrHandler *This);
  ...
  HRESULT(STDMETHODCALLTYPE *Activate)(__RPC__in ISyncMgrHandler *This,
                                       /* [in] */ BOOL fActivate);

  DECLSPEC_XFGVIRT(ISyncMgrHandler, Enable)
  HRESULT(STDMETHODCALLTYPE *Enable)(__RPC__in ISyncMgrHandler *This,
                                     /* [in] */ BOOL fEnable);

  DECLSPEC_XFGVIRT(ISyncMgrHandler, Synchronize)
  HRESULT(STDMETHODCALLTYPE *Synchronize)(
      __RPC__in ISyncMgrHandler *This,
      /* [size_is][string][ref][in] */
...
interface ISyncMgrHandler { CONST_VTBL struct ISyncMgrHandlerVtbl *lpVtbl; };
...
#define ISyncMgrHandler_Synchronize(This, ppszItemIDs, cItems, hwndOwner,      \
                                    pSessionCreator, punk)                     \
  ((This)->lpVtbl->Synchronize(This, ppszItemIDs, cItems, hwndOwner,           \
                               pSessionCreator, punk))
...
typedef struct ISyncMgrHandlerInfoVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in ISyncMgrHandlerInfo *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in ISyncMgrHandlerInfo *This);
  ...
  HRESULT(STDMETHODCALLTYPE *IsActive)(__RPC__in ISyncMgrHandlerInfo *This);

  DECLSPEC_XFGVIRT(ISyncMgrHandlerInfo, IsEnabled)
  HRESULT(STDMETHODCALLTYPE *IsEnabled)(__RPC__in ISyncMgrHandlerInfo *This);

  DECLSPEC_XFGVIRT(ISyncMgrHandlerInfo, IsConnected)
  HRESULT(STDMETHODCALLTYPE *IsConnected)(__RPC__in ISyncMgrHandlerInfo *This);
...
typedef struct ISyncMgrSyncItemContainerVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in ISyncMgrSyncItemContainer *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in ISyncMgrSyncItemContainer *This);
...
typedef struct ISyncMgrSyncItemVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in ISyncMgrSyncItem *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in ISyncMgrSyncItem *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in ISyncMgrSyncItem *This);
  ...
  HRESULT(STDMETHODCALLTYPE *Enable)(__RPC__in ISyncMgrSyncItem *This,
                                     /* [in] */ BOOL fEnable);

  DECLSPEC_XFGVIRT(ISyncMgrSyncItem, Delete)
  HRESULT(STDMETHODCALLTYPE *Delete)(__RPC__in ISyncMgrSyncItem *This);

  END_INTERFACE
} ISyncMgrSyncItemVtbl;

interface ISyncMgrSyncItem { CONST_VTBL struct ISyncMgrSyncItemVtbl *lpVtbl; };
...
typedef struct ISyncMgrSyncItemInfoVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in ISyncMgrSyncItemInfo *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in ISyncMgrSyncItemInfo *This);
  ...
  HRESULT(STDMETHODCALLTYPE *IsEnabled)(__RPC__in ISyncMgrSyncItemInfo *This);

  DECLSPEC_XFGVIRT(ISyncMgrSyncItemInfo, IsConnected)
  HRESULT(STDMETHODCALLTYPE *IsConnected)(__RPC__in ISyncMgrSyncItemInfo *This);
...
typedef struct IEnumSyncMgrSyncItemsVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IEnumSyncMgrSyncItems *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IEnumSyncMgrSyncItems *This);

  DECLSPEC_XFGVIRT(IEnumSyncMgrSyncItems, Next)
  HRESULT(STDMETHODCALLTYPE *Next)(__RPC__in IEnumSyncMgrSyncItems *This,
                                   /* [in] */ ULONG celt,
                                   /* [length_is][size_is][out] */
  ...
  HRESULT(STDMETHODCALLTYPE *Skip)(__RPC__in IEnumSyncMgrSyncItems *This,
                                   /* [in] */ ULONG celt);

  DECLSPEC_XFGVIRT(IEnumSyncMgrSyncItems, Reset)
  HRESULT(STDMETHODCALLTYPE *Reset)(__RPC__in IEnumSyncMgrSyncItems *This);
...
typedef struct ISyncMgrSessionCreatorVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in ISyncMgrSessionCreator *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in ISyncMgrSessionCreator *This);
...
#define ISyncMgrSessionCreator_CreateSession(This, pszHandlerID, ppszItemIDs,  \
                                             cItems, ppCallback)               \
  ((This)->lpVtbl->CreateSession(This, pszHandlerID, ppszItemIDs, cItems,      \
                                 ppCallback))
...
public:
  virtual HRESULT STDMETHODCALLTYPE ReportProgress(
      ...
      /* [in] */ ULONG uMaxStep,
      /* [unique][out][in] */ __RPC__inout_opt SYNCMGR_CANCEL_REQUEST *
          pnCancelRequest) = 0;
...
typedef struct ISyncMgrSyncCallbackVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in ISyncMgrSyncCallback *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in ISyncMgrSyncCallback *This);
...
#define ISyncMgrSyncCallback_ReportProgress(This, pszItemID, pszProgressText,  \
                                            nStatus, uCurrentStep, uMaxStep,   \
                                            pnCancelRequest)                   \
  ((This)->lpVtbl->ReportProgress(This, pszItemID, pszProgressText, nStatus,   \
                                  uCurrentStep, uMaxStep, pnCancelRequest))

#define ISyncMgrSyncCallback_SetHandlerProgressText(This, pszProgressText,     \
                                                    pnCancelRequest)           \
  ((This)->lpVtbl->SetHandlerProgressText(This, pszProgressText,               \
                                          pnCancelRequest))

#define ISyncMgrSyncCallback_ReportEvent(                                      \
    This, pszItemID, nLevel, nFlags, pszName, pszDescription, pszLinkText,     \
    pszLinkReference, pszContext, pguidEventID)                                \
  ((This)->lpVtbl->ReportEvent(This, pszItemID, nLevel, nFlags, pszName,       \
                               pszDescription, pszLinkText, pszLinkReference,  \
                               pszContext, pguidEventID))

#define ISyncMgrSyncCallback_CanContinue(This, pszItemID)                      \
  ((This)->lpVtbl->CanContinue(This, pszItemID))

#define ISyncMgrSyncCallback_QueryForAdditionalItems(This, ppenumItemIDs,      \
                                                     ppenumPunks)              \
...
typedef struct ISyncMgrUIOperationVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in ISyncMgrUIOperation *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in ISyncMgrUIOperation *This);

  DECLSPEC_XFGVIRT(ISyncMgrUIOperation, Run)
  HRESULT(STDMETHODCALLTYPE *Run)(__RPC__in ISyncMgrUIOperation *This,
...
typedef struct ISyncMgrEventLinkUIOperationVtbl {
  ...
  DECLSPEC_XFGVIRT(ISyncMgrUIOperation, Run)
  HRESULT(STDMETHODCALLTYPE *Run)(__RPC__in ISyncMgrEventLinkUIOperation *This,
                                  /* [unique][in] */ __RPC__in_opt HWND
                                      hwndOwner);
...
#define ISyncMgrScheduleWizardUIOperation_QueryInterface(This, riid,           \
                                                         ppvObject)            \
  ((This)->lpVtbl->QueryInterface(This, riid, ppvObject))
...
typedef struct ISyncMgrSyncResultVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in ISyncMgrSyncResult *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in ISyncMgrSyncResult *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in ISyncMgrSyncResult *This);

  DECLSPEC_XFGVIRT(ISyncMgrSyncResult, Result)
  HRESULT(STDMETHODCALLTYPE *Result)(__RPC__in ISyncMgrSyncResult *This,
                                     /* [in] */ SYNCMGR_PROGRESS_STATUS nStatus,
                                     /* [in] */ UINT cError,
                                     /* [in] */ UINT cConflicts);
...
typedef struct ISyncMgrControlVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in ISyncMgrControl *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in ISyncMgrControl *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in ISyncMgrControl *This);
  ...
  HRESULT(STDMETHODCALLTYPE *StartSyncAll)(__RPC__in ISyncMgrControl *This,
                                           /* [unique][in] */ __RPC__in_opt HWND
                                               hwndOwner);
  ...
  HRESULT(STDMETHODCALLTYPE *StopSyncAll)(__RPC__in ISyncMgrControl *This);
...
interface ISyncMgrControl { CONST_VTBL struct ISyncMgrControlVtbl *lpVtbl; };
...
#define ISyncMgrControl_StartHandlerSync(This, pszHandlerID, hwndOwner, punk,  \
                                         nSyncControlFlags, pResult)           \
  ((This)->lpVtbl->StartHandlerSync(This, pszHandlerID, hwndOwner, punk,       \
                                    nSyncControlFlags, pResult))

#define ISyncMgrControl_StartItemSync(This, pszHandlerID, ppszItemIDs, cItems, \
                                      hwndOwner, punk, nSyncControlFlags,      \
                                      pResult)                                 \
  ((This)->lpVtbl->StartItemSync(This, pszHandlerID, ppszItemIDs, cItems,      \
                                 hwndOwner, punk, nSyncControlFlags, pResult))
...
#define ISyncMgrControl_UpdateHandlerCollection(This, rclsidCollectionID,      \
                                                nControlFlags)                 \
  ((This)->lpVtbl->UpdateHandlerCollection(This, rclsidCollectionID,           \
                                           nControlFlags))
...
#define ISyncMgrControl_UpdateItem(This, pszHandlerID, pszItemID,              \
                                   nControlFlags)                              \
  ((This)->lpVtbl->UpdateItem(This, pszHandlerID, pszItemID, nControlFlags))

#define ISyncMgrControl_UpdateEvents(This, pszHandlerID, pszItemID,            \
                                     nControlFlags)                            \
  ((This)->lpVtbl->UpdateEvents(This, pszHandlerID, pszItemID, nControlFlags))

#define ISyncMgrControl_UpdateConflict(This, pszHandlerID, pszItemID,          \
                                       pConflict, nReason)                     \
  ((This)->lpVtbl->UpdateConflict(This, pszHandlerID, pszItemID, pConflict,    \
                                  nReason))

#define ISyncMgrControl_UpdateConflicts(This, pszHandlerID, pszItemID,         \
                                        nControlFlags)                         \
  ((This)->lpVtbl->UpdateConflicts(This, pszHandlerID, pszItemID,              \
                                   nControlFlags))

#define ISyncMgrControl_ActivateHandler(This, fActivate, pszHandlerID,         \
                                        hwndOwner, nControlFlags)              \
  ((This)->lpVtbl->ActivateHandler(This, fActivate, pszHandlerID, hwndOwner,   \
                                   nControlFlags))

#define ISyncMgrControl_EnableHandler(This, fEnable, pszHandlerID, hwndOwner,  \
                                      nControlFlags)                           \
  ((This)->lpVtbl->EnableHandler(This, fEnable, pszHandlerID, hwndOwner,       \
                                 nControlFlags))

#define ISyncMgrControl_EnableItem(This, fEnable, pszHandlerID, pszItemID,     \
                                   hwndOwner, nControlFlags)                   \
  ((This)->lpVtbl->EnableItem(This, fEnable, pszHandlerID, pszItemID,          \
                              hwndOwner, nControlFlags))
...
public:
  ...
  virtual HRESULT STDMETHODCALLTYPE RemoveEvent(
      /* [size_is][ref][in] */ __RPC__in_ecount_full(cEvents) GUID *
          pguidEventIDs,
      /* [in] */ ULONG cEvents) = 0;
};
...
typedef struct ISyncMgrEventStoreVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in ISyncMgrEventStore *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in ISyncMgrEventStore *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in ISyncMgrEventStore *This);
  ...
  HRESULT(STDMETHODCALLTYPE *RemoveEvent)(__RPC__in ISyncMgrEventStore *This,
                                          /* [size_is][ref][in] */
                                          __RPC__in_ecount_full(cEvents)
                                              GUID *pguidEventIDs,
                                          /* [in] */ ULONG cEvents);
...
public:
  ...
  virtual HRESULT STDMETHODCALLTYPE GetHandlerID(
      /* [string][ref][out] */ __RPC__deref_out_opt_string LPWSTR *
      ppszHandlerID) = 0;
...
typedef struct ISyncMgrEventVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in ISyncMgrEvent *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in ISyncMgrEvent *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in ISyncMgrEvent *This);
...
interface ISyncMgrEvent { CONST_VTBL struct ISyncMgrEventVtbl *lpVtbl; };
...
typedef struct IEnumSyncMgrEventsVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in IEnumSyncMgrEvents *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IEnumSyncMgrEvents *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IEnumSyncMgrEvents *This);

  DECLSPEC_XFGVIRT(IEnumSyncMgrEvents, Next)
  HRESULT(STDMETHODCALLTYPE *Next)(__RPC__in IEnumSyncMgrEvents *This,
                                   /* [in] */ ULONG celt,
                                   /* [length_is][size_is][out] */
                                   __RPC__out_ecount_part(celt, *pceltFetched)
                                       ISyncMgrEvent **rgelt,
  ...
  HRESULT(STDMETHODCALLTYPE *Skip)(__RPC__in IEnumSyncMgrEvents *This,
                                   /* [in] */ ULONG celt);

  DECLSPEC_XFGVIRT(IEnumSyncMgrEvents, Reset)
  HRESULT(STDMETHODCALLTYPE *Reset)(__RPC__in IEnumSyncMgrEvents *This);
...
public:
  ...
  virtual HRESULT STDMETHODCALLTYPE RemoveConflicts(
      /* [size_is][in] */ __RPC__in_ecount_full(cConflicts)
          const SYNCMGR_CONFLICT_ID_INFO *rgConflictIdInfo,
...
typedef struct ISyncMgrConflictStoreVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in ISyncMgrConflictStore *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in ISyncMgrConflictStore *This);
  ...
  HRESULT(STDMETHODCALLTYPE *RemoveConflicts)(
      __RPC__in ISyncMgrConflictStore *This,
      /* [size_is][in] */
      __RPC__in_ecount_full(cConflicts)
          const SYNCMGR_CONFLICT_ID_INFO *rgConflictIdInfo,
      /* [in] */ DWORD cConflicts);
...
#define ISyncMgrConflictStore_EnumConflicts(This, pszHandlerID, pszItemID,     \
                                            ppEnum)                            \
...
#define ISyncMgrConflictStore_RemoveConflicts(This, rgConflictIdInfo,          \
                                              cConflicts)                      \
  ((This)->lpVtbl->RemoveConflicts(This, rgConflictIdInfo, cConflicts))

#define ISyncMgrConflictStore_GetCount(This, pszHandlerID, pszItemID,          \
                                       pnConflicts)                            \
...
typedef struct IEnumSyncMgrConflictVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IEnumSyncMgrConflict *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IEnumSyncMgrConflict *This);

  DECLSPEC_XFGVIRT(IEnumSyncMgrConflict, Next)
  HRESULT(STDMETHODCALLTYPE *Next)(__RPC__in IEnumSyncMgrConflict *This,
                                   /* [in] */ ULONG celt,
                                   /* [length_is][size_is][out] */
                                   __RPC__out_ecount_part(celt, *pceltFetched)
  ...
  HRESULT(STDMETHODCALLTYPE *Skip)(__RPC__in IEnumSyncMgrConflict *This,
                                   /* [in] */ ULONG celt);

  DECLSPEC_XFGVIRT(IEnumSyncMgrConflict, Reset)
  HRESULT(STDMETHODCALLTYPE *Reset)(__RPC__in IEnumSyncMgrConflict *This);
...
typedef struct ISyncMgrConflictVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in ISyncMgrConflict *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in ISyncMgrConflict *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in ISyncMgrConflict *This);
...
interface ISyncMgrConflict { CONST_VTBL struct ISyncMgrConflictVtbl *lpVtbl; };
...
#define ISyncMgrConflict_GetResolutionHandler(This, riid,                      \
...
public:
  virtual HRESULT STDMETHODCALLTYPE QueryAbilities(
      /* [out] */ __RPC__out SYNCMGR_RESOLUTION_ABILITIES_FLAGS *
      pdwAbilities) = 0;
...
typedef struct ISyncMgrResolutionHandlerVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in ISyncMgrResolutionHandler *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in ISyncMgrResolutionHandler *This);
...
typedef struct ISyncMgrConflictPresenterVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in ISyncMgrConflictPresenter *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in ISyncMgrConflictPresenter *This);
...
#define ISyncMgrConflictPresenter_PresentConflict(This, pConflict,             \
                                                  pResolveInfo)                \
...
typedef struct ISyncMgrConflictResolveInfoVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(ISyncMgrConflictResolveInfo *This,
                                             /* [in] */ REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);
  ...
  HRESULT(STDMETHODCALLTYPE *GetItemChoice)(ISyncMgrConflictResolveInfo *This,
                                            /* [in] */ UINT iChoice,
...
#define ISyncMgrConflictResolveInfo_GetIterationInfo(                          \
    This, pnCurrentConflict, pcConflicts, pcRemainingForApplyToAll)            \
  ((This)->lpVtbl->GetIterationInfo(This, pnCurrentConflict, pcConflicts,      \
                                    pcRemainingForApplyToAll))

#define ISyncMgrConflictResolveInfo_GetPresenterNextStep(This,                 \
                                                         pnPresenterNextStep)  \
  ((This)->lpVtbl->GetPresenterNextStep(This, pnPresenterNextStep))

#define ISyncMgrConflictResolveInfo_GetPresenterChoice(                        \
...
#define ISyncMgrConflictResolveInfo_GetItemChoice(This, iChoice,               \
                                                  piChoiceIndex)               \
  ((This)->lpVtbl->GetItemChoice(This, iChoice, piChoiceIndex))

#define ISyncMgrConflictResolveInfo_SetPresenterNextStep(This,                 \
                                                         nPresenterNextStep)   \
  ((This)->lpVtbl->SetPresenterNextStep(This, nPresenterNextStep))

#define ISyncMgrConflictResolveInfo_SetPresenterChoice(This, nPresenterChoice, \
                                                       fApplyToAll)            \
  ((This)->lpVtbl->SetPresenterChoice(This, nPresenterChoice, fApplyToAll))

#define ISyncMgrConflictResolveInfo_SetItemChoices(                            \
...
typedef struct ISyncMgrConflictFolderVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(ISyncMgrConflictFolder *This,
                                             /* [in] */ REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);
...
#define ISyncMgrConflictFolder_GetConflictIDList(This, pConflict,              \
                                                 ppidlConflict)                \
...
typedef struct ISyncMgrConflictItemsVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in ISyncMgrConflictItems *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in ISyncMgrConflictItems *This);

  DECLSPEC_XFGVIRT(ISyncMgrConflictItems, GetCount)
  HRESULT(STDMETHODCALLTYPE *GetCount)(__RPC__in ISyncMgrConflictItems *This,
...
class DECLSPEC_UUID("1202db60-1dac-42c5-aed5-1abdd432248e") SyncMgrClient;
#endif
...
class DECLSPEC_UUID("1a1f4206-0688-4e7f-be03-d82ec69df9a5") SyncMgrControl;
#endif
...
class DECLSPEC_UUID("9c73f5e5-7ae7-4e32-a8e8-8d23b85255bf") SyncMgrFolder;
#endif
...
class DECLSPEC_UUID("2e9e59c0-b437-4981-a647-9c34b9b90891") SyncSetupFolder;
#endif
...
class DECLSPEC_UUID("289978ac-a101-4341-a817-21eba7fd046d") ConflictFolder;
#endif
...
class DECLSPEC_UUID("71d99464-3b6b-475c-b241-e15883207529") SyncResultsFolder;
#endif
