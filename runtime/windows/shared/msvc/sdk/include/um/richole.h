...
#define REO_CANROTATE                                                          \
  (0x00000080L) // Object knows how to display itself rotated
...
#define REO_ALIGNTORIGHT                                                       \
  (0x00000100L) // Align object to view's right side
...
DECLARE_INTERFACE_(IRichEditOleCallback, IUnknown) {
  ...
  STDMETHOD(GetContextMenu)(THIS_ WORD seltype, LPOLEOBJECT lpoleobj,
                            CHARRANGE FAR * lpchrg, HMENU FAR * lphmenu) PURE;
};
