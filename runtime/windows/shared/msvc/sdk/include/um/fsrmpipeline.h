...
typedef interface IFsrmClassifierModuleDefinition
...
typedef interface IFsrmPipelineModuleImplementation
...
typedef interface IFsrmClassifierModuleImplementation
...
typedef interface IFsrmStorageModuleImplementation
...
#define FSRM_DISPID_PROPERTY_DEFINITION                                        \
  ((FSRM_DISPID_FEATURE_CLASSIFICATION | 0x100000))

#define FSRM_DISPID_PROPERTY_DEFINITION2                                       \
  ((FSRM_DISPID_PROPERTY_DEFINITION | 0x10000))
...
#define FSRM_DISPID_PIPELINE_MODULE_DEFINITION                                 \
  ((FSRM_DISPID_FEATURE_CLASSIFICATION | 0x400000))

#define FSRM_DISPID_CLASSIFIER_MODULE_DEFINITION                               \
  ((FSRM_DISPID_PIPELINE_MODULE_DEFINITION | 0x10000))

#define FSRM_DISPID_STORAGE_MODULE_DEFINITION                                  \
  ((FSRM_DISPID_PIPELINE_MODULE_DEFINITION | 0x20000))

#define FSRM_DISPID_CLASSIFICATION_MANAGER                                     \
  ((FSRM_DISPID_FEATURE_CLASSIFICATION | 0x500000))

#define FSRM_DISPID_CLASSIFICATION_MANAGER2                                    \
  ((FSRM_DISPID_CLASSIFICATION_MANAGER | 0x10000))

#define FSRM_DISPID_CLASSIFICATION_EVENTS                                      \
  ((FSRM_DISPID_FEATURE_CLASSIFICATION | 0x600000))

#define FSRM_DISPID_PROPERTY_DEFINITION_VALUE                                  \
...
#define FSRM_DISPID_PIPELINE_MODULE_IMPLEMENTATION                             \
  ((FSRM_DISPID_FEATURE_PIPELINE | 0x200000))

#define FSRM_DISPID_CLASSIFIER_MODULE_IMPLEMENTATION                           \
  ((FSRM_DISPID_PIPELINE_MODULE_IMPLEMENTATION | 0x10000))

#define FSRM_DISPID_STORAGE_MODULE_IMPLEMENTATION                              \
  ((FSRM_DISPID_PIPELINE_MODULE_IMPLEMENTATION | 0x20000))

#define FSRM_DISPID_PIPELINE_MODULE_CONNECTOR                                  \
  ((FSRM_DISPID_FEATURE_PIPELINE | 0x300000))
...
typedef struct IFsrmPropertyDefinitionVtbl {
  ...
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IFsrmPropertyDefinition *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IFsrmPropertyDefinition *This);
  ...
  /* [helpstring][id][propget] */ HRESULT(
      STDMETHODCALLTYPE *get_PossibleValues)(
      __RPC__in IFsrmPropertyDefinition *This,
  ...
  /* [helpstring][id][propput] */ HRESULT(
      STDMETHODCALLTYPE *put_ValueDescriptions)(
      __RPC__in IFsrmPropertyDefinition *This,
...
#define IFsrmPropertyDefinition_GetIDsOfNames(This, riid, rgszNames, cNames,   \
                                              lcid, rgDispId)                  \
  ((This)->lpVtbl->GetIDsOfNames(This, riid, rgszNames, cNames, lcid, rgDispId))

#define IFsrmPropertyDefinition_Invoke(This, dispIdMember, riid, lcid, wFlags, \
...
public:
  ...
  virtual /* [helpstring][id][propget] */ HRESULT STDMETHODCALLTYPE
      get_ValueDefinitions(
          /* [retval][out] */ __RPC__deref_out_opt IFsrmCollection *
          *valueDefinitions) = 0;
};
...
typedef struct IFsrmPropertyDefinition2Vtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IFsrmPropertyDefinition2 *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IFsrmPropertyDefinition2 *This);
  ...
  /* [helpstring][id][propget] */ HRESULT(
      STDMETHODCALLTYPE *get_PropertyDefinitionFlags)(
      __RPC__in IFsrmPropertyDefinition2 *This,
  ...
  /* [helpstring][id][propget] */ HRESULT(
      STDMETHODCALLTYPE *get_ValueDefinitions)(
      __RPC__in IFsrmPropertyDefinition2 *This,
      /* [retval][out] */ __RPC__deref_out_opt IFsrmCollection *
          *valueDefinitions);
...
#define IFsrmPropertyDefinition2_GetIDsOfNames(This, riid, rgszNames, cNames,  \
                                               lcid, rgDispId)                 \
  ((This)->lpVtbl->GetIDsOfNames(This, riid, rgszNames, cNames, lcid, rgDispId))

#define IFsrmPropertyDefinition2_Invoke(This, dispIdMember, riid, lcid,        \
...
#define IFsrmPropertyDefinition2_get_ValueDescriptions(This,                   \
                                                       valueDescriptions)      \
  ((This)->lpVtbl->get_ValueDescriptions(This, valueDescriptions))

#define IFsrmPropertyDefinition2_put_ValueDescriptions(This,                   \
                                                       valueDescriptions)      \
  ((This)->lpVtbl->put_ValueDescriptions(This, valueDescriptions))
...
#define IFsrmPropertyDefinition2_get_PropertyDefinitionFlags(                  \
    This, propertyDefinitionFlags)                                             \
...
#define IFsrmPropertyDefinitionValue_GetIDsOfNames(This, riid, rgszNames,      \
                                                   cNames, lcid, rgDispId)     \
  ((This)->lpVtbl->GetIDsOfNames(This, riid, rgszNames, cNames, lcid, rgDispId))

#define IFsrmPropertyDefinitionValue_Invoke(This, dispIdMember, riid, lcid,    \
                                            wFlags, pDispParams, pVarResult,   \
                                            pExcepInfo, puArgErr)              \
  ((This)->lpVtbl->Invoke(This, dispIdMember, riid, lcid, wFlags, pDispParams, \
                          pVarResult, pExcepInfo, puArgErr))
...
typedef struct IFsrmPropertyVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in IFsrmProperty *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IFsrmProperty *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IFsrmProperty *This);
...
interface IFsrmProperty { CONST_VTBL struct IFsrmPropertyVtbl *lpVtbl; };
...
#define IFsrmProperty_GetIDsOfNames(This, riid, rgszNames, cNames, lcid,       \
                                    rgDispId)                                  \
  ((This)->lpVtbl->GetIDsOfNames(This, riid, rgszNames, cNames, lcid, rgDispId))

#define IFsrmProperty_Invoke(This, dispIdMember, riid, lcid, wFlags,           \
...
typedef struct IFsrmRuleVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in IFsrmRule *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IFsrmRule *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IFsrmRule *This);
...
interface IFsrmRule { CONST_VTBL struct IFsrmRuleVtbl *lpVtbl; };
...
public:
  virtual /* [helpstring][id][propget] */ HRESULT STDMETHODCALLTYPE
      get_ExecutionOption(
          /* [retval][out] */ __RPC__out FsrmExecutionOption *
          executionOption) = 0;
...
typedef struct IFsrmClassificationRuleVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IFsrmClassificationRule *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IFsrmClassificationRule *This);
  ...
  DECLSPEC_XFGVIRT(IFsrmRule, put_ModuleDefinitionName)
  /* [helpstring][id][propput] */ HRESULT(
      STDMETHODCALLTYPE *put_ModuleDefinitionName)(
      __RPC__in IFsrmClassificationRule *This,
...
#define IFsrmClassificationRule_GetIDsOfNames(This, riid, rgszNames, cNames,   \
                                              lcid, rgDispId)                  \
  ((This)->lpVtbl->GetIDsOfNames(This, riid, rgszNames, cNames, lcid, rgDispId))

#define IFsrmClassificationRule_Invoke(This, dispIdMember, riid, lcid, wFlags, \
                                       pDispParams, pVarResult, pExcepInfo,    \
                                       puArgErr)                               \
  ((This)->lpVtbl->Invoke(This, dispIdMember, riid, lcid, wFlags, pDispParams, \
                          pVarResult, pExcepInfo, puArgErr))
...
#define IFsrmClassificationRule_get_ModuleDefinitionName(This,                 \
                                                         moduleDefinitionName) \
  ((This)->lpVtbl->get_ModuleDefinitionName(This, moduleDefinitionName))

#define IFsrmClassificationRule_put_ModuleDefinitionName(This,                 \
                                                         moduleDefinitionName) \
  ((This)->lpVtbl->put_ModuleDefinitionName(This, moduleDefinitionName))
...
public:
  ...
  virtual /* [helpstring][id][propget] */ HRESULT STDMETHODCALLTYPE
      get_ModuleType(
          /* [retval][out] */ __RPC__out FsrmPipelineModuleType *
          moduleType) = 0;
...
typedef struct IFsrmPipelineModuleDefinitionVtbl {
  ...
  /* [helpstring][id][propget] */ HRESULT(
      STDMETHODCALLTYPE *get_SupportedExtensions)(
      __RPC__in IFsrmPipelineModuleDefinition *This,
  ...
  /* [helpstring][id][propput] */ HRESULT(
      STDMETHODCALLTYPE *put_SupportedExtensions)(
      __RPC__in IFsrmPipelineModuleDefinition *This,
...
#define IFsrmPipelineModuleDefinition_GetIDsOfNames(This, riid, rgszNames,     \
                                                    cNames, lcid, rgDispId)    \
  ((This)->lpVtbl->GetIDsOfNames(This, riid, rgszNames, cNames, lcid, rgDispId))

#define IFsrmPipelineModuleDefinition_Invoke(This, dispIdMember, riid, lcid,   \
                                             wFlags, pDispParams, pVarResult,  \
                                             pExcepInfo, puArgErr)             \
  ((This)->lpVtbl->Invoke(This, dispIdMember, riid, lcid, wFlags, pDispParams, \
                          pVarResult, pExcepInfo, puArgErr))
...
#define IFsrmPipelineModuleDefinition_get_NeedsFileContent(This,               \
                                                           needsFileContent)   \
  ((This)->lpVtbl->get_NeedsFileContent(This, needsFileContent))

#define IFsrmPipelineModuleDefinition_put_NeedsFileContent(This,               \
                                                           needsFileContent)   \
...
#define IFsrmPipelineModuleDefinition_get_SupportedExtensions(                 \
    This, supportedExtensions)                                                 \
  ((This)->lpVtbl->get_SupportedExtensions(This, supportedExtensions))

#define IFsrmPipelineModuleDefinition_put_SupportedExtensions(                 \
    This, supportedExtensions)                                                 \
...
typedef struct IFsrmClassifierModuleDefinitionVtbl {
  ...
  /* [helpstring][id][propget] */ HRESULT(
      STDMETHODCALLTYPE *get_PropertiesAffected)(
      __RPC__in IFsrmClassifierModuleDefinition *This,
  ...
  /* [helpstring][id][propput] */ HRESULT(
      STDMETHODCALLTYPE *put_NeedsExplicitValue)(
      __RPC__in IFsrmClassifierModuleDefinition *This,
...
#define IFsrmClassifierModuleDefinition_GetTypeInfo(This, iTInfo, lcid,        \
                                                    ppTInfo)                   \
  ((This)->lpVtbl->GetTypeInfo(This, iTInfo, lcid, ppTInfo))

#define IFsrmClassifierModuleDefinition_GetIDsOfNames(This, riid, rgszNames,   \
                                                      cNames, lcid, rgDispId)  \
  ((This)->lpVtbl->GetIDsOfNames(This, riid, rgszNames, cNames, lcid, rgDispId))
...
#define IFsrmClassifierModuleDefinition_get_NeedsFileContent(This,             \
                                                             needsFileContent) \
  ((This)->lpVtbl->get_NeedsFileContent(This, needsFileContent))

#define IFsrmClassifierModuleDefinition_put_NeedsFileContent(This,             \
                                                             needsFileContent) \
  ((This)->lpVtbl->put_NeedsFileContent(This, needsFileContent))
...
#define IFsrmClassifierModuleDefinition_get_SupportedExtensions(               \
    This, supportedExtensions)                                                 \
  ((This)->lpVtbl->get_SupportedExtensions(This, supportedExtensions))

#define IFsrmClassifierModuleDefinition_put_SupportedExtensions(               \
    This, supportedExtensions)                                                 \
  ((This)->lpVtbl->put_SupportedExtensions(This, supportedExtensions))
...
#define IFsrmClassifierModuleDefinition_get_PropertiesAffected(                \
    This, propertiesAffected)                                                  \
  ((This)->lpVtbl->get_PropertiesAffected(This, propertiesAffected))

#define IFsrmClassifierModuleDefinition_put_PropertiesAffected(                \
    This, propertiesAffected)                                                  \
  ((This)->lpVtbl->put_PropertiesAffected(This, propertiesAffected))

#define IFsrmClassifierModuleDefinition_get_PropertiesUsed(This,               \
                                                           propertiesUsed)     \
  ((This)->lpVtbl->get_PropertiesUsed(This, propertiesUsed))

#define IFsrmClassifierModuleDefinition_put_PropertiesUsed(This,               \
                                                           propertiesUsed)     \
  ((This)->lpVtbl->put_PropertiesUsed(This, propertiesUsed))

#define IFsrmClassifierModuleDefinition_get_NeedsExplicitValue(                \
    This, needsExplicitValue)                                                  \
...
public:
  virtual /* [helpstring][id][propget] */ HRESULT STDMETHODCALLTYPE
      get_Capabilities(
          /* [retval][out] */ __RPC__out FsrmStorageModuleCaps *
          capabilities) = 0;
  ...
  virtual /* [helpstring][id][propget] */ HRESULT STDMETHODCALLTYPE
      get_StorageType(
          /* [retval][out] */ __RPC__out FsrmStorageModuleType *
          storageType) = 0;
...
typedef struct IFsrmStorageModuleDefinitionVtbl {
  ...
  /* [helpstring][id][propget] */ HRESULT(
      STDMETHODCALLTYPE *get_UpdatesFileContent)(
      __RPC__in IFsrmStorageModuleDefinition *This,
  ...
  /* [helpstring][id][propput] */ HRESULT(
      STDMETHODCALLTYPE *put_UpdatesFileContent)(
      __RPC__in IFsrmStorageModuleDefinition *This,
...
#define IFsrmStorageModuleDefinition_GetIDsOfNames(This, riid, rgszNames,      \
                                                   cNames, lcid, rgDispId)     \
  ((This)->lpVtbl->GetIDsOfNames(This, riid, rgszNames, cNames, lcid, rgDispId))

#define IFsrmStorageModuleDefinition_Invoke(This, dispIdMember, riid, lcid,    \
                                            wFlags, pDispParams, pVarResult,   \
                                            pExcepInfo, puArgErr)              \
  ((This)->lpVtbl->Invoke(This, dispIdMember, riid, lcid, wFlags, pDispParams, \
                          pVarResult, pExcepInfo, puArgErr))
...
#define IFsrmStorageModuleDefinition_get_NeedsFileContent(This,                \
                                                          needsFileContent)    \
  ((This)->lpVtbl->get_NeedsFileContent(This, needsFileContent))

#define IFsrmStorageModuleDefinition_put_NeedsFileContent(This,                \
                                                          needsFileContent)    \
  ((This)->lpVtbl->put_NeedsFileContent(This, needsFileContent))
...
#define IFsrmStorageModuleDefinition_get_SupportedExtensions(                  \
    This, supportedExtensions)                                                 \
  ((This)->lpVtbl->get_SupportedExtensions(This, supportedExtensions))

#define IFsrmStorageModuleDefinition_put_SupportedExtensions(                  \
    This, supportedExtensions)                                                 \
  ((This)->lpVtbl->put_SupportedExtensions(This, supportedExtensions))
...
#define IFsrmStorageModuleDefinition_get_UpdatesFileContent(                   \
    This, updatesFileContent)                                                  \
  ((This)->lpVtbl->get_UpdatesFileContent(This, updatesFileContent))

#define IFsrmStorageModuleDefinition_put_UpdatesFileContent(                   \
    This, updatesFileContent)                                                  \
...
public:
  ...
  virtual /* [helpstring][id][propget] */ HRESULT STDMETHODCALLTYPE
      get_ClassificationRunningStatus(
          /* [retval][out] */ __RPC__out FsrmReportRunningStatus *
          runningStatus) = 0;
  ...
  virtual /* [helpstring][id] */ HRESULT STDMETHODCALLTYPE
      CreatePropertyDefinition(
          /* [retval][out] */ __RPC__deref_out_opt IFsrmPropertyDefinition *
  ...
  CreateModuleDefinition(
      /* [in] */ FsrmPipelineModuleType moduleType,
      /* [retval][out] */ __RPC__deref_out_opt IFsrmPipelineModuleDefinition *
          *moduleDefinition) = 0;
  ...
  virtual /* [helpstring][id] */ HRESULT STDMETHODCALLTYPE CancelClassification(
      void) = 0;
...
typedef struct IFsrmClassificationManagerVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IFsrmClassificationManager *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IFsrmClassificationManager *This);
  ...
  /* [helpstring][id][propget] */ HRESULT(
      STDMETHODCALLTYPE *get_ClassificationReportFormats)(
      __RPC__in IFsrmClassificationManager *This,
  ...
  /* [helpstring][id][propput] */ HRESULT(
      STDMETHODCALLTYPE *put_ClassificationReportFormats)(
      __RPC__in IFsrmClassificationManager *This,
  ...
  /* [helpstring][id][propput] */ HRESULT(
      STDMETHODCALLTYPE *put_ClassificationReportEnabled)(
      __RPC__in IFsrmClassificationManager *This,
      /* [in] */ VARIANT_BOOL reportEnabled);

  DECLSPEC_XFGVIRT(IFsrmClassificationManager,
                   get_ClassificationLastReportPathWithoutExtension)
  /* [helpstring][id][propget] */ HRESULT(
      STDMETHODCALLTYPE *get_ClassificationLastReportPathWithoutExtension)(
      __RPC__in IFsrmClassificationManager *This,
  ...
  /* [helpstring][id][propget] */ HRESULT(
      STDMETHODCALLTYPE *get_ClassificationLastError)(
      __RPC__in IFsrmClassificationManager *This,
  ...
  /* [helpstring][id][propget] */ HRESULT(
      STDMETHODCALLTYPE *get_ClassificationRunningStatus)(
      __RPC__in IFsrmClassificationManager *This,
  ...
  /* [helpstring][id] */ HRESULT(
      STDMETHODCALLTYPE *WaitForClassificationCompletion)(
      __RPC__in IFsrmClassificationManager *This,
      /* [in] */ long waitSeconds,
...
#define IFsrmClassificationManager_GetIDsOfNames(This, riid, rgszNames,        \
                                                 cNames, lcid, rgDispId)       \
  ((This)->lpVtbl->GetIDsOfNames(This, riid, rgszNames, cNames, lcid, rgDispId))

#define IFsrmClassificationManager_Invoke(This, dispIdMember, riid, lcid,      \
                                          wFlags, pDispParams, pVarResult,     \
                                          pExcepInfo, puArgErr)                \
  ((This)->lpVtbl->Invoke(This, dispIdMember, riid, lcid, wFlags, pDispParams, \
                          pVarResult, pExcepInfo, puArgErr))

#define IFsrmClassificationManager_get_ClassificationReportFormats(This,       \
                                                                   formats)    \
  ((This)->lpVtbl->get_ClassificationReportFormats(This, formats))

#define IFsrmClassificationManager_put_ClassificationReportFormats(This,       \
                                                                   formats)    \
...
#define IFsrmClassificationManager_get_ClassificationReportMailTo(This,        \
                                                                  mailTo)      \
  ((This)->lpVtbl->get_ClassificationReportMailTo(This, mailTo))

#define IFsrmClassificationManager_put_ClassificationReportMailTo(This,        \
                                                                  mailTo)      \
  ((This)->lpVtbl->put_ClassificationReportMailTo(This, mailTo))

#define IFsrmClassificationManager_get_ClassificationReportEnabled(            \
    This, reportEnabled)                                                       \
  ((This)->lpVtbl->get_ClassificationReportEnabled(This, reportEnabled))

#define IFsrmClassificationManager_put_ClassificationReportEnabled(            \
    This, reportEnabled)                                                       \
  ((This)->lpVtbl->put_ClassificationReportEnabled(This, reportEnabled))

#define IFsrmClassificationManager_get_ClassificationLastReportPathWithoutExtension( \
    This, lastReportPath)                                                            \
  ((This)->lpVtbl->get_ClassificationLastReportPathWithoutExtension(                 \
      This, lastReportPath))

#define IFsrmClassificationManager_get_ClassificationLastError(This,           \
                                                               lastError)      \
  ((This)->lpVtbl->get_ClassificationLastError(This, lastError))

#define IFsrmClassificationManager_get_ClassificationRunningStatus(            \
    This, runningStatus)                                                       \
  ((This)->lpVtbl->get_ClassificationRunningStatus(This, runningStatus))

#define IFsrmClassificationManager_EnumPropertyDefinitions(                    \
    This, options, propertyDefinitions)                                        \
  ((This)->lpVtbl->EnumPropertyDefinitions(This, options, propertyDefinitions))

#define IFsrmClassificationManager_CreatePropertyDefinition(                   \
    This, propertyDefinition)                                                  \
  ((This)->lpVtbl->CreatePropertyDefinition(This, propertyDefinition))

#define IFsrmClassificationManager_GetPropertyDefinition(This, propertyName,   \
                                                         propertyDefinition)   \
  ((This)->lpVtbl->GetPropertyDefinition(This, propertyName,                   \
                                         propertyDefinition))
...
#define IFsrmClassificationManager_EnumModuleDefinitions(                      \
    This, moduleType, options, moduleDefinitions)                              \
  ((This)->lpVtbl->EnumModuleDefinitions(This, moduleType, options,            \
                                         moduleDefinitions))

#define IFsrmClassificationManager_CreateModuleDefinition(This, moduleType,    \
                                                          moduleDefinition)    \
  ((This)->lpVtbl->CreateModuleDefinition(This, moduleType, moduleDefinition))

#define IFsrmClassificationManager_GetModuleDefinition(                        \
    This, moduleName, moduleType, moduleDefinition)                            \
  ((This)->lpVtbl->GetModuleDefinition(This, moduleName, moduleType,           \
                                       moduleDefinition))
...
#define IFsrmClassificationManager_WaitForClassificationCompletion(            \
    This, waitSeconds, completed)                                              \
  ((This)->lpVtbl->WaitForClassificationCompletion(This, waitSeconds,          \
                                                   completed))

#define IFsrmClassificationManager_CancelClassification(This)                  \
  ((This)->lpVtbl->CancelClassification(This))

#define IFsrmClassificationManager_EnumFileProperties(This, filePath, options, \
                                                      fileProperties)          \
  ((This)->lpVtbl->EnumFileProperties(This, filePath, options, fileProperties))

#define IFsrmClassificationManager_GetFileProperty(                            \
    This, filePath, propertyName, options, property)                           \
  ((This)->lpVtbl->GetFileProperty(This, filePath, propertyName, options,      \
                                   property))

#define IFsrmClassificationManager_SetFileProperty(                            \
    This, filePath, propertyName, propertyValue)                               \
...
typedef struct IFsrmClassificationManager2Vtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IFsrmClassificationManager2 *This);
...
#define IFsrmClassificationManager2_GetIDsOfNames(This, riid, rgszNames,       \
                                                  cNames, lcid, rgDispId)      \
  ((This)->lpVtbl->GetIDsOfNames(This, riid, rgszNames, cNames, lcid, rgDispId))

#define IFsrmClassificationManager2_Invoke(This, dispIdMember, riid, lcid,     \
                                           wFlags, pDispParams, pVarResult,    \
                                           pExcepInfo, puArgErr)               \
  ((This)->lpVtbl->Invoke(This, dispIdMember, riid, lcid, wFlags, pDispParams, \
                          pVarResult, pExcepInfo, puArgErr))

#define IFsrmClassificationManager2_get_ClassificationReportFormats(This,      \
                                                                    formats)   \
  ((This)->lpVtbl->get_ClassificationReportFormats(This, formats))

#define IFsrmClassificationManager2_put_ClassificationReportFormats(This,      \
                                                                    formats)   \
  ((This)->lpVtbl->put_ClassificationReportFormats(This, formats))
...
#define IFsrmClassificationManager2_get_ClassificationReportMailTo(This,       \
                                                                   mailTo)     \
  ((This)->lpVtbl->get_ClassificationReportMailTo(This, mailTo))

#define IFsrmClassificationManager2_put_ClassificationReportMailTo(This,       \
                                                                   mailTo)     \
  ((This)->lpVtbl->put_ClassificationReportMailTo(This, mailTo))

#define IFsrmClassificationManager2_get_ClassificationReportEnabled(           \
    This, reportEnabled)                                                       \
  ((This)->lpVtbl->get_ClassificationReportEnabled(This, reportEnabled))

#define IFsrmClassificationManager2_put_ClassificationReportEnabled(           \
    This, reportEnabled)                                                       \
  ((This)->lpVtbl->put_ClassificationReportEnabled(This, reportEnabled))

#define IFsrmClassificationManager2_get_ClassificationLastReportPathWithoutExtension( \
    This, lastReportPath)                                                             \
  ((This)->lpVtbl->get_ClassificationLastReportPathWithoutExtension(                  \
      This, lastReportPath))

#define IFsrmClassificationManager2_get_ClassificationLastError(This,          \
                                                                lastError)     \
  ((This)->lpVtbl->get_ClassificationLastError(This, lastError))

#define IFsrmClassificationManager2_get_ClassificationRunningStatus(           \
    This, runningStatus)                                                       \
  ((This)->lpVtbl->get_ClassificationRunningStatus(This, runningStatus))

#define IFsrmClassificationManager2_EnumPropertyDefinitions(                   \
    This, options, propertyDefinitions)                                        \
  ((This)->lpVtbl->EnumPropertyDefinitions(This, options, propertyDefinitions))

#define IFsrmClassificationManager2_CreatePropertyDefinition(                  \
    This, propertyDefinition)                                                  \
  ((This)->lpVtbl->CreatePropertyDefinition(This, propertyDefinition))

#define IFsrmClassificationManager2_GetPropertyDefinition(This, propertyName,  \
                                                          propertyDefinition)  \
  ((This)->lpVtbl->GetPropertyDefinition(This, propertyName,                   \
                                         propertyDefinition))
...
#define IFsrmClassificationManager2_EnumModuleDefinitions(                     \
    This, moduleType, options, moduleDefinitions)                              \
  ((This)->lpVtbl->EnumModuleDefinitions(This, moduleType, options,            \
                                         moduleDefinitions))

#define IFsrmClassificationManager2_CreateModuleDefinition(This, moduleType,   \
                                                           moduleDefinition)   \
  ((This)->lpVtbl->CreateModuleDefinition(This, moduleType, moduleDefinition))

#define IFsrmClassificationManager2_GetModuleDefinition(                       \
    This, moduleName, moduleType, moduleDefinition)                            \
  ((This)->lpVtbl->GetModuleDefinition(This, moduleName, moduleType,           \
                                       moduleDefinition))
...
#define IFsrmClassificationManager2_WaitForClassificationCompletion(           \
    This, waitSeconds, completed)                                              \
  ((This)->lpVtbl->WaitForClassificationCompletion(This, waitSeconds,          \
                                                   completed))
...
#define IFsrmClassificationManager2_EnumFileProperties(                        \
    This, filePath, options, fileProperties)                                   \
  ((This)->lpVtbl->EnumFileProperties(This, filePath, options, fileProperties))

#define IFsrmClassificationManager2_GetFileProperty(                           \
    This, filePath, propertyName, options, property)                           \
  ((This)->lpVtbl->GetFileProperty(This, filePath, propertyName, options,      \
                                   property))

#define IFsrmClassificationManager2_SetFileProperty(                           \
    This, filePath, propertyName, propertyValue)                               \
  ((This)->lpVtbl->SetFileProperty(This, filePath, propertyName, propertyValue))

#define IFsrmClassificationManager2_ClearFileProperty(This, filePath,          \
                                                      property)                \
  ((This)->lpVtbl->ClearFileProperty(This, filePath, property))

#define IFsrmClassificationManager2_ClassifyFiles(                             \
    This, filePaths, propertyNames, propertyValues, options)                   \
  ((This)->lpVtbl->ClassifyFiles(This, filePaths, propertyNames,               \
...
public:
  ...
  virtual /* [helpstring][id] */ HRESULT STDMETHODCALLTYPE GetFileProperty(
      /* [in] */ __RPC__in BSTR name,
      /* [retval][out] */ __RPC__deref_out_opt IFsrmProperty *
          *fileProperty) = 0;
...
typedef struct IFsrmPropertyBagVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in IFsrmPropertyBag *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IFsrmPropertyBag *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IFsrmPropertyBag *This);
  ...
  /* [helpstring][id][propget] */ HRESULT(
      STDMETHODCALLTYPE *get_RelativeNamespaceRoot)(
      __RPC__in IFsrmPropertyBag *This,
  ...
  /* [helpstring][id][propget] */ HRESULT(
      STDMETHODCALLTYPE *get_ParentDirectoryId)(
      __RPC__in IFsrmPropertyBag *This,
  ...
  /* [helpstring][id][propget] */ HRESULT(
      STDMETHODCALLTYPE *get_FilePropertyNames)(
      __RPC__in IFsrmPropertyBag *This,
  ...
  /* [helpstring][id][propget] */ HRESULT(
      STDMETHODCALLTYPE *get_PropertyBagFlags)(
      __RPC__in IFsrmPropertyBag *This,
...
interface IFsrmPropertyBag { CONST_VTBL struct IFsrmPropertyBagVtbl *lpVtbl; };
...
#define IFsrmPropertyBag_GetIDsOfNames(This, riid, rgszNames, cNames, lcid,    \
                                       rgDispId)                               \
  ((This)->lpVtbl->GetIDsOfNames(This, riid, rgszNames, cNames, lcid, rgDispId))

#define IFsrmPropertyBag_Invoke(This, dispIdMember, riid, lcid, wFlags,        \
                                pDispParams, pVarResult, pExcepInfo, puArgErr) \
  ((This)->lpVtbl->Invoke(This, dispIdMember, riid, lcid, wFlags, pDispParams, \
                          pVarResult, pExcepInfo, puArgErr))
...
#define IFsrmPropertyBag_get_RelativeNamespaceRoot(This,                       \
...
#define IFsrmPropertyBag_GetFileStreamInterface(                               \
    This, accessMode, interfaceType, pStreamInterface)                         \
  ((This)->lpVtbl->GetFileStreamInterface(This, accessMode, interfaceType,     \
                                          pStreamInterface))
...
typedef struct IFsrmPropertyBag2Vtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(__RPC__in IFsrmPropertyBag2 *This,
                                             /* [in] */ __RPC__in REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IFsrmPropertyBag2 *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IFsrmPropertyBag2 *This);
  ...
  /* [helpstring][id] */ HRESULT(
      STDMETHODCALLTYPE *GetUntrustedInFileProperties)(
      __RPC__in IFsrmPropertyBag2 *This,
...
#define IFsrmPropertyBag2_GetIDsOfNames(This, riid, rgszNames, cNames, lcid,   \
                                        rgDispId)                              \
  ((This)->lpVtbl->GetIDsOfNames(This, riid, rgszNames, cNames, lcid, rgDispId))

#define IFsrmPropertyBag2_Invoke(This, dispIdMember, riid, lcid, wFlags,       \
                                 pDispParams, pVarResult, pExcepInfo,          \
                                 puArgErr)                                     \
  ((This)->lpVtbl->Invoke(This, dispIdMember, riid, lcid, wFlags, pDispParams, \
                          pVarResult, pExcepInfo, puArgErr))
...
#define IFsrmPropertyBag2_get_RelativeNamespaceRoot(This,                      \
                                                    relativeNamespaceRoot)     \
  ((This)->lpVtbl->get_RelativeNamespaceRoot(This, relativeNamespaceRoot))
...
#define IFsrmPropertyBag2_GetFileStreamInterface(                              \
    This, accessMode, interfaceType, pStreamInterface)                         \
  ((This)->lpVtbl->GetFileStreamInterface(This, accessMode, interfaceType,     \
                                          pStreamInterface))
...
public:
  virtual /* [helpstring][id] */ HRESULT STDMETHODCALLTYPE OnLoad(
      ...
      /* [out] */ __RPC__deref_out_opt IFsrmPipelineModuleConnector *
          *moduleConnector) = 0;
...
#define IFsrmPipelineModuleImplementation_QueryInterface(This, riid,           \
                                                         ppvObject)            \
  ((This)->lpVtbl->QueryInterface(This, riid, ppvObject))
...
#define IFsrmPipelineModuleImplementation_GetTypeInfo(This, iTInfo, lcid,      \
                                                      ppTInfo)                 \
  ((This)->lpVtbl->GetTypeInfo(This, iTInfo, lcid, ppTInfo))

#define IFsrmPipelineModuleImplementation_GetIDsOfNames(                       \
    This, riid, rgszNames, cNames, lcid, rgDispId)                             \
  ((This)->lpVtbl->GetIDsOfNames(This, riid, rgszNames, cNames, lcid, rgDispId))

#define IFsrmPipelineModuleImplementation_Invoke(                              \
    This, dispIdMember, riid, lcid, wFlags, pDispParams, pVarResult,           \
    pExcepInfo, puArgErr)                                                      \
  ((This)->lpVtbl->Invoke(This, dispIdMember, riid, lcid, wFlags, pDispParams, \
                          pVarResult, pExcepInfo, puArgErr))

#define IFsrmPipelineModuleImplementation_OnLoad(This, moduleDefinition,       \
                                                 moduleConnector)              \
...
#define IFsrmClassifierModuleImplementation_QueryInterface(This, riid,         \
                                                           ppvObject)          \
  ((This)->lpVtbl->QueryInterface(This, riid, ppvObject))
...
#define IFsrmClassifierModuleImplementation_GetTypeInfo(This, iTInfo, lcid,    \
                                                        ppTInfo)               \
  ((This)->lpVtbl->GetTypeInfo(This, iTInfo, lcid, ppTInfo))

#define IFsrmClassifierModuleImplementation_GetIDsOfNames(                     \
    This, riid, rgszNames, cNames, lcid, rgDispId)                             \
  ((This)->lpVtbl->GetIDsOfNames(This, riid, rgszNames, cNames, lcid, rgDispId))

#define IFsrmClassifierModuleImplementation_Invoke(                            \
    This, dispIdMember, riid, lcid, wFlags, pDispParams, pVarResult,           \
    pExcepInfo, puArgErr)                                                      \
  ((This)->lpVtbl->Invoke(This, dispIdMember, riid, lcid, wFlags, pDispParams, \
                          pVarResult, pExcepInfo, puArgErr))

#define IFsrmClassifierModuleImplementation_OnLoad(This, moduleDefinition,     \
                                                   moduleConnector)            \
  ((This)->lpVtbl->OnLoad(This, moduleDefinition, moduleConnector))
...
#define IFsrmClassifierModuleImplementation_get_LastModified(This,             \
                                                             lastModified)     \
  ((This)->lpVtbl->get_LastModified(This, lastModified))

#define IFsrmClassifierModuleImplementation_UseRulesAndDefinitions(            \
    This, rules, propertyDefinitions)                                          \
  ((This)->lpVtbl->UseRulesAndDefinitions(This, rules, propertyDefinitions))

#define IFsrmClassifierModuleImplementation_OnBeginFile(This, propertyBag,     \
                                                        arrayRuleIds)          \
  ((This)->lpVtbl->OnBeginFile(This, propertyBag, arrayRuleIds))

#define IFsrmClassifierModuleImplementation_DoesPropertyValueApply(            \
    This, property, value, applyValue, idRule, idPropDef)                      \
  ((This)->lpVtbl->DoesPropertyValueApply(This, property, value, applyValue,   \
                                          idRule, idPropDef))

#define IFsrmClassifierModuleImplementation_GetPropertyValueToApply(           \
    This, property, value, idRule, idPropDef)                                  \
  ((This)->lpVtbl->GetPropertyValueToApply(This, property, value, idRule,      \
                                           idPropDef))
...
#define IFsrmStorageModuleImplementation_GetTypeInfo(This, iTInfo, lcid,       \
                                                     ppTInfo)                  \
  ((This)->lpVtbl->GetTypeInfo(This, iTInfo, lcid, ppTInfo))

#define IFsrmStorageModuleImplementation_GetIDsOfNames(This, riid, rgszNames,  \
                                                       cNames, lcid, rgDispId) \
  ((This)->lpVtbl->GetIDsOfNames(This, riid, rgszNames, cNames, lcid, rgDispId))

#define IFsrmStorageModuleImplementation_Invoke(                               \
    This, dispIdMember, riid, lcid, wFlags, pDispParams, pVarResult,           \
    pExcepInfo, puArgErr)                                                      \
  ((This)->lpVtbl->Invoke(This, dispIdMember, riid, lcid, wFlags, pDispParams, \
                          pVarResult, pExcepInfo, puArgErr))

#define IFsrmStorageModuleImplementation_OnLoad(This, moduleDefinition,        \
                                                moduleConnector)               \
  ((This)->lpVtbl->OnLoad(This, moduleDefinition, moduleConnector))
...
#define IFsrmStorageModuleImplementation_UseDefinitions(This,                  \
                                                        propertyDefinitions)   \
...
public:
  virtual /* [helpstring][id][propget] */ HRESULT STDMETHODCALLTYPE
      get_ModuleImplementation(
          /* [retval][out] */
          __RPC__deref_out_opt IFsrmPipelineModuleImplementation *
          *pipelineModuleImplementation) = 0;
  ...
  virtual /* [helpstring][id] */ HRESULT STDMETHODCALLTYPE Bind(
      /* [in] */ __RPC__in_opt IFsrmPipelineModuleDefinition * moduleDefinition,
      /* [in] */ __RPC__in_opt IFsrmPipelineModuleImplementation *
          moduleImplementation) = 0;
};
...
typedef struct IFsrmPipelineModuleConnectorVtbl {
  ...
  /* [helpstring][id][propget] */ HRESULT(
      STDMETHODCALLTYPE *get_ModuleImplementation)(
      __RPC__in IFsrmPipelineModuleConnector *This,
      /* [retval][out] */ __RPC__deref_out_opt IFsrmPipelineModuleImplementation
...
#define IFsrmPipelineModuleConnector_GetIDsOfNames(This, riid, rgszNames,      \
                                                   cNames, lcid, rgDispId)     \
  ((This)->lpVtbl->GetIDsOfNames(This, riid, rgszNames, cNames, lcid, rgDispId))

#define IFsrmPipelineModuleConnector_Invoke(This, dispIdMember, riid, lcid,    \
                                            wFlags, pDispParams, pVarResult,   \
                                            pExcepInfo, puArgErr)              \
  ((This)->lpVtbl->Invoke(This, dispIdMember, riid, lcid, wFlags, pDispParams, \
                          pVarResult, pExcepInfo, puArgErr))

#define IFsrmPipelineModuleConnector_get_ModuleImplementation(                 \
    This, pipelineModuleImplementation)                                        \
...
#define IFsrmPipelineModuleConnector_Bind(This, moduleDefinition,              \
