...
typedef struct IWMPNodeRealEstateVtbl {
  ...
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(IWMPNodeRealEstate *This,
                                             /* [in] */ REFIID riid,
  ...
  HRESULT(STDMETHODCALLTYPE *GetDesiredSize)(IWMPNodeRealEstate *This,
                                             /* [out] */ LPSIZE pSize);

  DECLSPEC_XFGVIRT(IWMPNodeRealEstate, SetRects)
  HRESULT(STDMETHODCALLTYPE *SetRects)(IWMPNodeRealEstate *This,
                                       /* [in] */ const RECT *pSrc,
                                       /* [in] */ const RECT *pDest,
                                       /* [in] */ const RECT *pClip);

  DECLSPEC_XFGVIRT(IWMPNodeRealEstate, GetRects)
  HRESULT(STDMETHODCALLTYPE *GetRects)(IWMPNodeRealEstate *This,
                                       /* [out] */ RECT *pSrc,
                                       /* [out] */ RECT *pDest,
                                       /* [out] */ RECT *pClip);

  DECLSPEC_XFGVIRT(IWMPNodeRealEstate, SetWindowless)
  HRESULT(STDMETHODCALLTYPE *SetWindowless)(IWMPNodeRealEstate *This,
                                            /* [in] */ BOOL fWindowless);

  DECLSPEC_XFGVIRT(IWMPNodeRealEstate, GetWindowless)
  HRESULT(STDMETHODCALLTYPE *GetWindowless)(IWMPNodeRealEstate *This,
                                            /* [out] */ BOOL *pfWindowless);

  DECLSPEC_XFGVIRT(IWMPNodeRealEstate, SetFullScreen)
  HRESULT(STDMETHODCALLTYPE *SetFullScreen)(IWMPNodeRealEstate *This,
                                            /* [in] */ BOOL fFullScreen);

  DECLSPEC_XFGVIRT(IWMPNodeRealEstate, GetFullScreen)
  HRESULT(STDMETHODCALLTYPE *GetFullScreen)(IWMPNodeRealEstate *This,
...
typedef struct IWMPNodeRealEstateHostVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(IWMPNodeRealEstateHost *This,
                                             /* [in] */ REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);
  ...
  HRESULT(STDMETHODCALLTYPE *OnDesiredSizeChange)(IWMPNodeRealEstateHost *This,
                                                  /* [in] */ LPSIZE pSize);
...
typedef struct IWMPNodeWindowedVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(IWMPNodeWindowed *This,
                                             /* [in] */ REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);
  ...
  HRESULT(STDMETHODCALLTYPE *SetOwnerWindow)(IWMPNodeWindowed *This,
                                             /* [in] */ OLE_HWND hwnd);

  DECLSPEC_XFGVIRT(IWMPNodeWindowed, GetOwnerWindow)
  HRESULT(STDMETHODCALLTYPE *GetOwnerWindow)(IWMPNodeWindowed *This,
                                             /* [out] */ OLE_HWND *phwnd);

  END_INTERFACE
} IWMPNodeWindowedVtbl;

interface IWMPNodeWindowed { CONST_VTBL struct IWMPNodeWindowedVtbl *lpVtbl; };
...
typedef struct IWMPNodeWindowedHostVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(IWMPNodeWindowedHost *This,
                                             /* [in] */ REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);
...
#define IWMPNodeWindowedHost_OnWindowMessageFromRenderer(                      \
    This, uMsg, wparam, lparam, plRet, pfHandled)                              \
  ((This)->lpVtbl->OnWindowMessageFromRenderer(This, uMsg, wparam, lparam,     \
                                               plRet, pfHandled))
...
public:
  virtual HRESULT STDMETHODCALLTYPE OnWindowMessage(
      UINT uMsg, WPARAM wparam, LPARAM lparam, LRESULT * plRet,
      BOOL * pfHandled) = 0;
};
...
typedef struct IWMPWindowMessageSinkVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(IWMPWindowMessageSink *This,
                                             /* [in] */ REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);
  ...
  HRESULT(STDMETHODCALLTYPE *OnWindowMessage)(IWMPWindowMessageSink *This,
                                              UINT uMsg, WPARAM wparam,
                                              LPARAM lparam, LRESULT *plRet,
                                              BOOL *pfHandled);
...
#define IWMPWindowMessageSink_OnWindowMessage(This, uMsg, wparam, lparam,      \
                                              plRet, pfHandled)                \
  ((This)->lpVtbl->OnWindowMessage(This, uMsg, wparam, lparam, plRet,          \
                                   pfHandled))
...
typedef struct IWMPNodeWindowlessVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(IWMPNodeWindowless *This,
                                             /* [in] */ REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);
  ...
  DECLSPEC_XFGVIRT(IWMPWindowMessageSink, OnWindowMessage)
  HRESULT(STDMETHODCALLTYPE *OnWindowMessage)(IWMPNodeWindowless *This,
                                              UINT uMsg, WPARAM wparam,
                                              LPARAM lparam, LRESULT *plRet,
                                              BOOL *pfHandled);

  DECLSPEC_XFGVIRT(IWMPNodeWindowless, OnDraw)
  HRESULT(STDMETHODCALLTYPE *OnDraw)(IWMPNodeWindowless *This,
                                     /* [in] */ OLE_HDC hdc,
...
#define IWMPNodeWindowless_OnWindowMessage(This, uMsg, wparam, lparam, plRet,  \
                                           pfHandled)                          \
  ((This)->lpVtbl->OnWindowMessage(This, uMsg, wparam, lparam, plRet,          \
                                   pfHandled))
...
typedef struct IWMPNodeWindowlessHostVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(IWMPNodeWindowlessHost *This,
                                             /* [in] */ REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);
  ...
  HRESULT(STDMETHODCALLTYPE *InvalidateRect)(IWMPNodeWindowlessHost *This,
                                             /* [in] */ const RECT *prc,
                                             /* [in] */ BOOL fErase);
...
typedef struct IWMPAudioRenderConfigVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(IWMPAudioRenderConfig *This,
                                             /* [in] */ REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);
...
interface IWMPRenderConfig { CONST_VTBL struct IWMPRenderConfigVtbl *lpVtbl; };
