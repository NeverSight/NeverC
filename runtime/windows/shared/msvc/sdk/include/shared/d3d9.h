...
DECLARE_INTERFACE_(IDirect3DDevice9, IUnknown) {
  ...
  STDMETHOD_(void, SetGammaRamp)(THIS_ UINT iSwapChain, DWORD Flags,
  ...
  STDMETHOD(ColorFill)(THIS_ IDirect3DSurface9 * pSurface, CONST RECT * pRect,
                       D3DCOLOR color) PURE;
  ...
  STDMETHOD(Clear)(THIS_ DWORD Count, CONST D3DRECT * pRects, DWORD Flags,
  ...
  STDMETHOD(SetPaletteEntries)(THIS_ UINT PaletteNumber,
  ...
  STDMETHOD(CreateVertexShader)(THIS_ CONST DWORD * pFunction,
                                IDirect3DVertexShader9 * *ppShader) PURE;
  STDMETHOD(SetVertexShader)(THIS_ IDirect3DVertexShader9 * pShader) PURE;
  STDMETHOD(GetVertexShader)(THIS_ IDirect3DVertexShader9 * *ppShader) PURE;
  STDMETHOD(SetVertexShaderConstantF)(THIS_ UINT StartRegister,
  ...
  STDMETHOD(SetVertexShaderConstantI)(THIS_ UINT StartRegister,
  ...
  STDMETHOD(SetVertexShaderConstantB)(THIS_ UINT StartRegister,
  ...
  STDMETHOD(CreatePixelShader)(THIS_ CONST DWORD * pFunction,
                               IDirect3DPixelShader9 * *ppShader) PURE;
  STDMETHOD(SetPixelShader)(THIS_ IDirect3DPixelShader9 * pShader) PURE;
  STDMETHOD(GetPixelShader)(THIS_ IDirect3DPixelShader9 * *ppShader) PURE;
  STDMETHOD(SetPixelShaderConstantF)(THIS_ UINT StartRegister,
                                     CONST float *pConstantData,
                                     UINT Vector4fCount) PURE;
  STDMETHOD(GetPixelShaderConstantF)(
      THIS_ UINT StartRegister, float *pConstantData, UINT Vector4fCount) PURE;
  STDMETHOD(SetPixelShaderConstantI)(THIS_ UINT StartRegister,
                                     CONST int *pConstantData,
                                     UINT Vector4iCount) PURE;
  STDMETHOD(GetPixelShaderConstantI)(
      THIS_ UINT StartRegister, int *pConstantData, UINT Vector4iCount) PURE;
  STDMETHOD(SetPixelShaderConstantB)(THIS_ UINT StartRegister,
                                     CONST BOOL * pConstantData, UINT BoolCount)
      PURE;
  STDMETHOD(GetPixelShaderConstantB)(THIS_ UINT StartRegister,
                                     BOOL * pConstantData, UINT BoolCount) PURE;
...
DECLARE_INTERFACE_(IDirect3DVertexDeclaration9, IUnknown) {
  ...
  STDMETHOD(GetDevice)(THIS_ IDirect3DDevice9 * *ppDevice) PURE;
  STDMETHOD(GetDeclaration)(THIS_ D3DVERTEXELEMENT9 * pElement,
                            UINT * pNumElements) PURE;
...
DECLARE_INTERFACE_(IDirect3DTexture9, IDirect3DBaseTexture9) {
  ...
  STDMETHOD(LockRect)(THIS_ UINT Level, D3DLOCKED_RECT * pLockedRect,
...
DECLARE_INTERFACE_(IDirect3DVolumeTexture9, IDirect3DBaseTexture9) {
  ...
  STDMETHOD(LockBox)(THIS_ UINT Level, D3DLOCKED_BOX * pLockedVolume,
                     CONST D3DBOX * pBox, DWORD Flags) PURE;
...
DECLARE_INTERFACE_(IDirect3DCubeTexture9, IDirect3DBaseTexture9) {
  ...
  STDMETHOD(AddDirtyRect)(THIS_ D3DCUBEMAP_FACES FaceType,
...
DECLARE_INTERFACE_(IDirect3DVolume9, IUnknown) {
  ...
  STDMETHOD(LockBox)(THIS_ D3DLOCKED_BOX * pLockedVolume, CONST D3DBOX * pBox,
                     DWORD Flags) PURE;
...
DECLARE_INTERFACE_(IDirect3D9Ex, IDirect3D9) {
  ...
  STDMETHOD(EnumAdapterModesEx)(THIS_ UINT Adapter,
                                CONST D3DDISPLAYMODEFILTER * pFilter, UINT Mode,
                                D3DDISPLAYMODEEX * pMode) PURE;
  STDMETHOD(GetAdapterDisplayModeEx)(THIS_ UINT Adapter,
...
DECLARE_INTERFACE_(IDirect3DDevice9Ex, IDirect3DDevice9) {
  ...
  STDMETHOD(PresentEx)(THIS_ CONST RECT * pSourceRect, CONST RECT * pDestRect,
                       HWND hDestWindowOverride, CONST RGNDATA * pDirtyRegion,
                       DWORD dwFlags) PURE;
  ...
  STDMETHOD(CheckResourceResidency)(THIS_ IDirect3DResource9 * *pResourceArray,
                                    UINT32 NumResources) PURE;
  ...
  STDMETHOD(CreateDepthStencilSurfaceEx)(
      ...
      D3DMULTISAMPLE_TYPE MultiSample, DWORD MultisampleQuality, BOOL Discard,
      IDirect3DSurface9 * *ppSurface, HANDLE * pSharedHandle, DWORD Usage) PURE;
  STDMETHOD(ResetEx)(THIS_ D3DPRESENT_PARAMETERS * pPresentationParameters,
                     D3DDISPLAYMODEEX * pFullscreenDisplayMode) PURE;
  STDMETHOD(GetDisplayModeEx)(THIS_ UINT iSwapChain, D3DDISPLAYMODEEX * pMode,
                              D3DDISPLAYROTATION * pRotation) PURE;
};
...
DECLARE_INTERFACE_(IDirect3DSwapChain9Ex, IDirect3DSwapChain9) {
  ...
  STDMETHOD(GetPresentStats)(THIS_ D3DPRESENTSTATS * pPresentationStatistics)
      PURE;
  STDMETHOD(GetDisplayModeEx)(THIS_ D3DDISPLAYMODEEX * pMode,
                              D3DDISPLAYROTATION * pRotation) PURE;
};
...
DECLARE_INTERFACE_(IDirect3D9ExOverlayExtension, IUnknown) {
  ...
  STDMETHOD(CheckDeviceOverlayType)(
      ...
      UINT OverlayHeight, D3DFORMAT OverlayFormat,
      D3DDISPLAYMODEEX * pDisplayMode, D3DDISPLAYROTATION DisplayRotation,
      D3DOVERLAYCAPS * pOverlayCaps) PURE;
};
...
DECLARE_INTERFACE_(IDirect3DDevice9Video, IUnknown) {
  ...
  STDMETHOD(GetContentProtectionCaps)(THIS_ CONST GUID * pCryptoType,
...
DECLARE_INTERFACE_(IDirect3DAuthenticatedChannel9, IUnknown) {
  ...
  STDMETHOD(Query)(THIS_ UINT InputSize, CONST VOID * pInput, UINT OutputSize,
                   VOID * pOutput) PURE;
...
DECLARE_INTERFACE_(IDirect3DCryptoSession9, IUnknown) {
  ...
  STDMETHOD(GetCertificate)(THIS_ UINT CertifacteSize, BYTE * ppCertificate)
      PURE;
  STDMETHOD(NegotiateKeyExchange)(THIS_ UINT DataSize, VOID * pData) PURE;
  STDMETHOD(EncryptionBlt)(THIS_ IDirect3DSurface9 * pSrcSurface,
                           IDirect3DSurface9 * pDstSurface, UINT DstSurfaceSize,
                           VOID * pIV) PURE;
  STDMETHOD(DecryptionBlt)(THIS_ IDirect3DSurface9 * pSrcSurface,
  ...
  STDMETHOD(GetSurfacePitch)(THIS_ IDirect3DSurface9 * pSrcSurface,
                             UINT * pSurfacePitch) PURE;
  STDMETHOD(StartSessionKeyRefresh)(THIS_ VOID * pRandomNumber,
                                    UINT RandomNumberSize) PURE;
