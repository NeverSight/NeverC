...
typedef interface ITfDetermineProximateHandwritingTargetArgs
...
typedef interface IHandwritingInputRoutingCallback
...
typedef /* [v1_enum] */
    enum TfHandwritingFocusTargetResponse {
      ...
      TF_HANDWRITING_TARGET_FOCUSED_NO_CORRECTIONS =
          (TF_HANDWRITING_TARGET_FOCUSED + 1),
      TF_PERFORM_SYSTEM_TARGETING =
          (TF_HANDWRITING_TARGET_FOCUSED_NO_CORRECTIONS + 1)
...
typedef struct ITfDetermineProximateHandwritingTargetArgsVtbl {
  ...
  DECLSPEC_XFGVIRT(ITfDetermineProximateHandwritingTargetArgs,
...
#define ITfDetermineProximateHandwritingTargetArgs_QueryInterface(This, riid,  \
                                                                  ppvObject)   \
...
#define ITfDetermineProximateHandwritingTargetArgs_GetPointerTargetInfo(       \
    This, targetWindow, targetScreenPoint, distanceThreshold)                  \
  ((This)->lpVtbl->GetPointerTargetInfo(This, targetWindow, targetScreenPoint, \
                                        distanceThreshold))
...
typedef struct ITfFocusHandwritingTargetArgsVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(ITfFocusHandwritingTargetArgs *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(ITfFocusHandwritingTargetArgs *This);
...
#define ITfFocusHandwritingTargetArgs_GetPointerTargetInfo(                    \
    This, targetWindow, targetScreenArea, distanceThreshold)                   \
  ((This)->lpVtbl->GetPointerTargetInfo(This, targetWindow, targetScreenArea,  \
                                        distanceThreshold))
...
public:
  virtual HRESULT STDMETHODCALLTYPE DetermineProximateHandwritingTarget(
      /* [in] */ ITfDetermineProximateHandwritingTargetArgs *
      determineProximateHandwritingTargetArgs) = 0;

  virtual HRESULT STDMETHODCALLTYPE FocusHandwritingTarget(
      /* [in] */ ITfFocusHandwritingTargetArgs *
      focusHandwritingTargetArgs) = 0;
};
...
typedef struct ITfHandwritingSinkVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(ITfHandwritingSink *This,
                                             /* [in] */ REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(ITfHandwritingSink *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(ITfHandwritingSink *This);
...
#define ITfHandwritingSink_AddRef(This) ((This)->lpVtbl->AddRef(This))

#define ITfHandwritingSink_Release(This) ((This)->lpVtbl->Release(This))

#define ITfHandwritingSink_DetermineProximateHandwritingTarget(                \
    This, determineProximateHandwritingTargetArgs)                             \
  ((This)->lpVtbl->DetermineProximateHandwritingTarget(                        \
      This, determineProximateHandwritingTargetArgs))

#define ITfHandwritingSink_FocusHandwritingTarget(This,                        \
                                                  focusHandwritingTargetArgs)  \
...
typedef struct ITfHandwritingRequestVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(ITfHandwritingRequest *This,
                                             /* [in] */ REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(ITfHandwritingRequest *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(ITfHandwritingRequest *This);

  DECLSPEC_XFGVIRT(ITfHandwritingRequest, SetInputEvaluation)
  HRESULT(STDMETHODCALLTYPE *SetInputEvaluation)(
      ITfHandwritingRequest *This, TfInputEvaluation inputEvaluation);
...
#define ITfHandwritingRequest_AddRef(This) ((This)->lpVtbl->AddRef(This))

#define ITfHandwritingRequest_Release(This) ((This)->lpVtbl->Release(This))
...
public:
  ...
  virtual HRESULT STDMETHODCALLTYPE RequestHandwritingForPointer(
      UINT32 pointerId, UINT64 handwritingStrokeId,
...
typedef struct ITfHandwritingVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(ITfHandwriting *This,
                                             /* [in] */ REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);

  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(ITfHandwriting *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(ITfHandwriting *This);
  ...
  HRESULT(STDMETHODCALLTYPE *SetHandwritingState)(
      ITfHandwriting *This, TfHandwritingState handwritingState);

  DECLSPEC_XFGVIRT(ITfHandwriting, RequestHandwritingForPointer)
  HRESULT(STDMETHODCALLTYPE *RequestHandwritingForPointer)(
      ITfHandwriting *This, UINT32 pointerId, UINT64 handwritingStrokeId,
      /* [out] */ BOOL *requestAccepted,
...
interface ITfHandwriting { CONST_VTBL struct ITfHandwritingVtbl *lpVtbl; };
...
#define ITfHandwriting_AddRef(This) ((This)->lpVtbl->AddRef(This))

#define ITfHandwriting_Release(This) ((This)->lpVtbl->Release(This))
...
#define ITfHandwriting_RequestHandwritingForPointer(                           \
    This, pointerId, handwritingStrokeId, requestAccepted, request)            \
  ((This)->lpVtbl->RequestHandwritingForPointer(                               \
      This, pointerId, handwritingStrokeId, requestAccepted, request))

#define ITfHandwriting_GetHandwritingDistanceThreshold(                        \
    This, distanceThresholdPixels)                                             \
  ((This)->lpVtbl->GetHandwritingDistanceThreshold(This,                       \
...
public:
  virtual HRESULT STDMETHODCALLTYPE GetThreadIdForInput(
      UINT32 pointerId, POINT * targetScreenPoint, HWND targetHWnd,
...
typedef struct IHandwritingInputRoutingCallbackVtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, AddRef)
  ULONG(STDMETHODCALLTYPE *AddRef)(IHandwritingInputRoutingCallback *This);

  DECLSPEC_XFGVIRT(IUnknown, Release)
  ULONG(STDMETHODCALLTYPE *Release)(IHandwritingInputRoutingCallback *This);

  DECLSPEC_XFGVIRT(IHandwritingInputRoutingCallback, GetThreadIdForInput)
  HRESULT(STDMETHODCALLTYPE *GetThreadIdForInput)(
      IHandwritingInputRoutingCallback *This, UINT32 pointerId,
      POINT *targetScreenPoint, HWND targetHWnd,
...
#define IHandwritingInputRoutingCallback_GetThreadIdForInput(                  \
    This, pointerId, targetScreenPoint, targetHWnd, uiThreadId)                \
  ((This)->lpVtbl->GetThreadIdForInput(This, pointerId, targetScreenPoint,     \
                                       targetHWnd, uiThreadId))
...
HRESULT WINAPI RegisterHandwritingInputRoutingCallback(
    IHandwritingInputRoutingCallback *callback);
HRESULT WINAPI GetHandwritingStrokeIdForPointer(
    _In_ UINT32 pointerId, _Out_ UINT64 *handwritingStrokeId);
