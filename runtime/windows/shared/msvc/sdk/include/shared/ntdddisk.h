...
#define IOCTL_DISK_SET_CACHE_SETTING                                           \
  CTL_CODE(IOCTL_DISK_BASE, 0x0039, METHOD_BUFFERED,                           \
           FILE_READ_ACCESS | FILE_WRITE_ACCESS)
...
#define IOCTL_DISK_COPY_DATA                                                   \
  CTL_CODE(IOCTL_DISK_BASE, 0x0019, METHOD_BUFFERED,                           \
           FILE_READ_ACCESS | FILE_WRITE_ACCESS)
...
#define DiskGeometryGetDetect(Geometry)                                        \
  ((PDISK_DETECTION_INFO)((                                                    \
      (ULONG_PTR)DiskGeometryGetPartition(Geometry) +                          \
      DiskGeometryGetPartition(Geometry)->SizeOfPartitionInfo)))
#endif
...
#define IOCTL_DISK_SET_PARTITION_ATTRIBUTES                                    \
  CTL_CODE(IOCTL_DISK_BASE, 0x003b, METHOD_BUFFERED,                           \
           FILE_READ_ACCESS | FILE_WRITE_ACCESS)
...
#define IOCTL_DISK_SET_SAN_SETTINGS                                            \
  CTL_CODE(IOCTL_DISK_BASE, 0x0081, METHOD_BUFFERED,                           \
           FILE_READ_ACCESS | FILE_WRITE_ACCESS)
...
#define IOCTL_DISK_SET_SNAPSHOT_INFO                                           \
  CTL_CODE(IOCTL_DISK_BASE, 0x0083, METHOD_BUFFERED,                           \
           FILE_READ_ACCESS | FILE_WRITE_ACCESS)
...
#define IOCTL_DISK_SET_CLUSTER_INFO                                            \
  CTL_CODE(IOCTL_DISK_BASE, 0x0086, METHOD_BUFFERED,                           \
           FILE_READ_ACCESS | FILE_WRITE_ACCESS)
...
#define IOCTL_DISK_VOLUMES_ARE_READY                                           \
  CTL_CODE(IOCTL_DISK_BASE, 0x0088, METHOD_BUFFERED,                           \
           FILE_READ_ACCESS | FILE_WRITE_ACCESS)
...
#define IOCTL_DISK_SIMBAD                                                      \
  CTL_CODE(IOCTL_DISK_BASE, 0x0400, METHOD_BUFFERED,                           \
           FILE_READ_ACCESS | FILE_WRITE_ACCESS)
