...
DEFINE_GUID(GUID_BTHPORT_DEVICE_INTERFACE, 0x850302a, 0xb344, 0x4fda, 0x9b,
            0xe9, 0x90, 0x57, 0x6b, 0x8d, 0x46, 0xf0);

// RFCOMM device interface GUID for RFCOMM services
// {b142fc3e-fa4e-460b-8abc-072b628b3c70}
DEFINE_GUID(GUID_BTH_RFCOMM_SERVICE_DEVICE_INTERFACE, 0xb142fc3e, 0xfa4e,
            0x460b, 0x8a, 0xbc, 0x07, 0x2b, 0x62, 0x8b, 0x3c, 0x70);
...
DEFINE_GUID(GUID_BLUETOOTH_AUTHENTICATION_REQUEST, 0x5DC9136D, 0x996C, 0x46DB,
            0x84, 0xF5, 0x32, 0xC0, 0xA3, 0xF4, 0x73, 0x52);

// {D668DFCD-0F4E-4EFC-BFE0-392EEEC5109C}
DEFINE_GUID(GUID_BLUETOOTH_KEYPRESS_EVENT, 0xD668DFCD, 0x0F4E, 0x4EFC, 0xBF,
            0xE0, 0x39, 0x2E, 0xEE, 0xC5, 0x10, 0x9C);

// {547247e6-45bb-4c33-af8c-c00efe15a71d}
DEFINE_GUID(GUID_BLUETOOTH_HCI_VENDOR_EVENT, 0x547247e6, 0x45bb, 0x4c33, 0xaf,
            0x8c, 0xc0, 0x0e, 0xfe, 0x15, 0xa7, 0x1d);
...
#define DEFINE_BLUETOOTH_UUID128(name, shortId)                                \
  DEFINE_GUID(name, shortId, 0x0000, 0x1000, 0x80, 0x00, 0x00, 0x80, 0x5F,     \
              0x9B, 0x34, 0xFB)
...
DEFINE_BLUETOOTH_UUID128(UDI_C_PLANE_PROTOCOL_UUID,
...
//
#define VideoConferencingServiceClass_UUID                                     \
  AVRemoteControlControllerServiceClass_UUID
#define VideoConferencingServiceClassID_UUID16                                 \
  AVRemoteControlControllerServiceClass_UUID16
...
//
#define CommonISDNAccessServiceClass_UUID16                                    \
  CommonISDNAccessServiceClassID_UUID16
#define VideoConferencingGWServiceClass_UUID16                                 \
  VideoConferencingGWServiceClassID_UUID16
...
#define AdvancedAudioDistributionServiceClassID_UUID16                         \
  AdvancedAudioDistributionProfileID_UUID16
...
#define HardcopyCableReplacementServiceClassID_UUID16                          \
  HardcopyCableReplacementProfileID_UUID16

#define AdvancedAudioDistributionServiceClass_UUID                             \
...
#define HardcopyCableReplacementServiceClass_UUID                              \
...
#define GET_NAP(_bth_addr)                                                     \
  ((USHORT)(((_bth_addr) & NAP_MASK) >> NAP_BIT_OFFSET))
...
#define GET_COD_SERVICE(_cod)                                                  \
  (((_cod) & COD_SERVICE_MASK) >> COD_SERVICE_BIT_OFFSET)

#define SET_COD_MINOR(_cod, _minor)                                            \
  (_cod) = ((_cod) & ~COD_MINOR_MASK) | ((_minor) << COD_MINOR_BIT_OFFSET)
#define SET_COD_MAJOR(_cod, _major)                                            \
  (_cod) = ((_cod) & ~COD_MAJOR_MASK) | ((_major) << COD_MAJOR_BIT_OFFSET)
#define SET_COD_SERVICE(_cod, _service)                                        \
  (_cod) = ((_cod) & ~COD_SERVICE_MASK) | ((_service) << COD_SERVICE_BIT_OFFSET)
...
#define GET_COD_LAN_MINOR(_cod)                                                \
  (((_cod) & COD_LAN_MINOR_MASK) >> COD_MINOR_BIT_OFFSET)
#define GET_COD_LAN_ACCESS(_cod)                                               \
  (((_cod) & COD_LAN_ACCESS_MASK) >> COD_LAN_ACCESS_BIT_OFFSET)
