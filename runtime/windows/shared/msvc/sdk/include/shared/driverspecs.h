...
#define _Landmark_(name)                                                       \
  _SAL_L_Source_(_Landmark_, (name), _SA_annotes1(SAL_landmark, #name))

#define __drv_Mode_impl(x)                                                     \
  _Landmark_(x) __inline void __GENSYM(__SAL_dummy_)(void) {}
...
#define __drv_unit(p)                                                          \
  typedef int ___drv_unit_##p __GENSYM(__prefast_flag_kernel_driver_mode);

// Internal macros for convenience
#define ___drv_unit_internal_kernel_driver                                     \
  _SAL_L_Source_(__drv_unit_internal_kernel_driver, (),                        \
...
#define __drv_functionClass(x)                                                 \
  _SAL1_Source_(__drv_functionClass, (x), _Function_class_(x))
...
#define _Kernel_acquires_resource_(kind)                                       \
  _SAL2_Source_(_Kernel_acquires_resource_, (#kind),                           \
...
#define _Kernel_releases_resource_(kind)                                       \
  _SAL2_Source_(_Kernel_releases_resource_, (#kind),                           \
...
#define _Kernel_requires_resource_held_(kind)                                  \
  _SAL2_Source_(_Kernel_requires_resource_held_, (#kind),                      \
...
#define __drv_innerMustHoldGlobal(kind, param)                                 \
  _SAL_L_Source_(__drv_innerMustHoldGlobal, (#kind, param\t),                  \
                 _Pre_ _SA_annotes2(SAL_mustHoldGlobal, #kind, param\t))
#define __drv_mustHoldGlobal(kind, param)                                      \
  _SAL1_1_Source_(__drv_mustHoldGlobal, (kind, param),                         \
...
#define _Kernel_requires_resource_not_held_(kind)                              \
  _SAL2_Source_(_Kernel_requires_resource_not_held_, (#kind),                  \
...
#define __drv_neverHoldGlobal(kind, param)                                     \
  _SAL1_1_Source_(__drv_neverHoldGlobal, (kind, param),                        \
                  _Requires_lock_not_held_(param))

// Predicates to determine if a resource is held
__PRIMOP(int, _Holds_resource_(__In_impl_ __deferTypecheck char *,
                               __In_impl_ char *);)
...
#define __drv_raisesIRQL                                                       \
  _SAL1_1_Source_(__drv_raisesIRQL, (), _IRQL_raises_) /* legacy */
...
#define __drv_requiresIRQL(irql)                                               \
  _SAL1_1_Source_(__drv_requiresIRQL, (irql),                                  \
                  _IRQL_requires_(irql)) /* legacy */
...
#define __drv_maxIRQL(irql)                                                    \
  _SAL1_1_Source_(__drv_maxIRQL, (irql), _IRQL_requires_max_(irql)) /* legacy  \
                                                                     */
...
#define __drv_minIRQL(irql)                                                    \
  _SAL1_1_Source_(__drv_minIRQL, (irql), _IRQL_requires_min_(irql)) /* legacy  \
                                                                     */
...
#define __drv_savesIRQL                                                        \
  _SAL1_1_Source_(__drv_savesIRQL, (), _IRQL_saves_) /* legacy */
...
#define __drv_savesIRQLGlobal(kind, param)                                     \
  _SAL1_1_Source_(__drv_savesIRQLGlobal, (kind, param),                        \
                  _IRQL_saves_global_(kind, param)) /* legacy */
...
#define __drv_restoresIRQL                                                     \
  _SAL1_1_Source_(__drv_restoresIRQL, (), _IRQL_restores_) /* legacy */
...
#define __drv_restoresIRQLGlobal(kind, param)                                  \
  _SAL1_1_Source_(__drv_restoresIRQLGlobal, (kind, param),                     \
                  _IRQL_restores_global_(kind, param)) /* legacy */
...
#define __drv_minFunctionIRQL(irql)                                            \
  _SAL1_1_Source_(__drv_minFunctionIRQL, (irql),                               \
                  _IRQL_always_function_min_(irql)) /* legacy */
...
#define __drv_maxFunctionIRQL(irql)                                            \
  _SAL1_1_Source_(__drv_maxFunctionIRQL, (irql),                               \
                  _IRQL_always_function_max_(irql)) /* legacy */
...
#define __drv_sameIRQL                                                         \
  _SAL1_1_Source_(__drv_sameIRQL, (), _IRQL_requires_same_) /* legacy */
...
#define __drv_useCancelIRQL                                                    \
  _SAL1_1_Source_(__drv_usesCancelIRQL, (), _IRQL_uses_cancel_) /* legacy */

//
// The annotated parameter is an IRQL that will be restored and a new (probably
// the same) value will be inserted.  (Use this in preference to directly coding
// it.)
#undef _IRQL_inout_
...
#define _Kernel_clear_do_init_(yesNo)                                          \
  _SAL2_Source_(_Kernel_clear_do_init_, (yesNo),                               \
                _Post_ _SA_annotes1(SAL_clearDoInit, yesNo))
#define __drv_clearDoInit(yesNo)                                               \
  _SAL1_1_Source_(__drv_clearDoInit, (yesNo),                                  \
                  _Kernel_clear_do_init_(yesNo)) /* legacy */
...
#define _Kernel_IoGetDmaAdapter_                                               \
  _SAL2_Source_(_Kernel_IoGetDmaAdapter_, (),                                  \
                _Post_ _SA_annotes0(SAL_IoGetDmaAdapter))
#define __drv_IoGetDmaAdapter                                                  \
  _SAL1_1_Source_(__drv_IoGetDmaAdapter, (),                                   \
                  _Kernel_IoGetDmaAdapter_) /* legacy */
...
#define __drv_valueIs(arglist)                                                 \
  _SAL1_1_Source_(__drv_valueIs, (arglist),                                    \
...
#define __drv_strictTypeMatch(mode)                                            \
  _SAL1_1_Source_(__drv_strictTypeMatch, (mode),                               \
...
//
__ANNOTATION(
    SAL_strictType(__In_impl_ __AuToQuOtE char *);) // currently 1/2 args
#define __drv_strictType(typename, mode)                                       \
  _SAL1_1_Source_(__drv_strictType, (typename, mode),                          \
...
#define __drv_notPointer                                                       \
  _SAL1_1_Source_(__drv_notPointer, (),                                        \
                  _Pre_ _SA_annotes1(SAL_mayBePointer, __no))

//
// Convenience for the most common form of the above.
#define __drv_isObjectPointer                                                  \
  _SAL1_1_Source_(__drv_isObjectPointer, (), _Points_to_data_)
...
#define __drv_aliasesMem                                                       \
  _SAL_L_Source_(__drv_aliasesMem, (), _Post_ _SA_annotes0(SAL_IsAliased))
...
#define __drv_allocatesMem(kind)                                               \
  _SAL_L_Source_(__drv_allocatesMem, (kind),                                   \
                 _Post_ _SA_annotes1(SAL_NeedsRelease, __yes))

#define __drv_freesMem(kind)                                                   \
  _SAL_L_Source_(__drv_freesMem, (kind),                                       \
                 _Post_ _SA_annotes1(SAL_NeedsRelease, __no))
...
#define __drv_preferredFunction(func, why)                                     \
  _SAL_L_Source_(__drv_preferredFunction, (func, why),                         \
...
#define _Kernel_float_saved_                                                   \
  _SAL2_Source_(_Kernel_float_saved_, (), _Post_ _SA_annotes0(SAL_floatSaved))
#define __drv_floatSaved                                                       \
  _SAL1_1_Source_(__drv_floatSaved, (), _Kernel_float_saved_) /* legacy */

//
// The floating point hardware was restored (no longer available)
__ANNOTATION(SAL_floatRestored(void);)
#define _Kernel_float_restored_                                                \
  _SAL2_Source_(_Kernel_float_restored_, (),                                   \
                _Post_ _SA_annotes0(SAL_floatRestored))
#define __drv_floatRestored                                                    \
  _SAL1_1_Source_(__drv_floatRestored, (), _Kernel_float_restored_) /* legacy  \
                                                                     */
...
#define _Kernel_float_used_                                                    \
  _SAL2_Source_(_Kernel_float_used_, (), _Post_ _SA_annotes0(SAL_floatUsed))
#define __drv_floatUsed                                                        \
  _SAL1_1_Source_(__drv_floatUsed, (), _Kernel_float_used_) /* legacy */
...
#define __drv_interlocked                                                      \
  _SAL1_1_Source_(__drv_interlocked, (), _Interlocked_operand_)

// The function must be called inside a try block
#define __drv_inTry                                                            \
  _SAL_L_Source_(__drv_inTry, (), _Pre_ _SA_annotes1(SAL_inTry, __yes))

// The function must not be called inside a try block
#define __drv_notInTry                                                         \
  _SAL_L_Source_(__drv_notInTry, (), _Pre_ _SA_annotes1(SAL_inTry, __no))
...
#define __drv_formatString(kind)                                               \
  _SAL1_1_Source_(__drv_formatString, (kind),                                  \
...
#define _Dispatch_type_(x)                                                     \
  _SAL2_Source_(Dispatch_type_, (x), _SA_annotes1(SAL_functionClassNew, #x))

// Legacy function class for driver dispatch functions:
#define __drv_dispatchType(x)                                                  \
  _SAL1_1_Source_(__drv_displatchType, (x),                                    \
                  _SA_annotes1(SAL_functionClassNew, #x))

// Legacy function class for driver dispatch functions - special case:
#define __drv_dispatchType_other                                               \
  _SAL1_1_Source_(__drv_dispatchType_other, (),                                \
...
#define __drv_completionType(kindlist)                                         \
  _SAL1_1_Source_(__drv_completionType, (kindlist),                            \
...
#define __drv_callbackType(kind)                                               \
  _SAL1_1_Source_(__drv_callbackType, (kind),                                  \
...
#define __drv_acquiresCriticalRegion                                           \
  _SAL1_Source_(__drv_acquiresCriticalRegion, (kind),                          \
                _Acquires_lock_(_Global_critical_region_))

#define __drv_releasesCriticalRegion                                           \
  _SAL1_Source_(__drv_releasesCriticalRegion, (kind),                          \
                _Releases_lock_(_Global_critical_region_))

#define __drv_mustHoldCriticalRegion                                           \
  _SAL1_Source_(__drv_mustHoldCriticalRegion, (kind),                          \
                _Requires_lock_held_(_Global_critical_region_))

#define __drv_neverHoldCriticalRegion                                          \
  _SAL1_Source_(__drv_neverHoldCriticalRegion, (kind),                         \
                _Requires_lock_not_held_(_Global_critical_region_))

#define __drv_holdsCriticalRegion()                                            \
  _SAL1_Source_(__drv_holdsCriticalRegion, (kind),                             \
