...
NTSTATUS
DiskRegistrySet(_In_ PDISK_REGISTRY Buffer);
...
NTSTATUS
DiskRegistryAddNewDisk(_In_ PDISK_DESCRIPTION Buffer);
...
NTSTATUS
DiskRegistryGet(_Out_ PDISK_REGISTRY Buffer, _Out_ PULONG LengthReturned);
...
VOID DiskRegistryInitializeSet(_In_ USHORT FtType, _In_ USHORT FtGroup);

//
// Cause an FT set member to be regenerated at the earliest possible moment.
//

VOID DiskRegistryRegenerateSet(_In_ USHORT FtType, _In_ USHORT FtGroup,
...
BOOLEAN
DiskRegistryAssignDriveLetter(_In_ ULONG Signature,
...
NTSTATUS
DiskRegistryDblSpaceRemovable(_In_ BOOLEAN Automount);
...
NTSTATUS
DiskRegistryAssignDblSpaceLetter(_In_ PWSTR CvfName, _In_ WCHAR DriveLetter);
...
NTSTATUS
DiskRegistryAssignCdRomLetter(_In_ PWSTR CdromName, _In_ WCHAR DriveLetter);
