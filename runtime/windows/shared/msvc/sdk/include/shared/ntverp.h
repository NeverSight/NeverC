...
#define LVER_PRODUCTVERSION_STR4(x)                                            \
  LVER_PRODUCTVERSION_STRING L"." LVER_BPAD L## #x
...
#define VER_PRODUCTVERSION_STRING_THREE_PARTS                                  \
  VER_PRODUCTVERSION_STR3(VER_PRODUCTBUILD)
...
#define LVER_PRODUCTVERSION_STRING_THREE_PARTS                                 \
  LVER_PRODUCTVERSION_STR3(VER_PRODUCTBUILD)
