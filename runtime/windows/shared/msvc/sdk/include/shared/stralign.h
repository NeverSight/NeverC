...
ua_wcscpy(_Out_writes_(_Inexpressible_("Sufficient length")) PUWSTR Destination,
          _In_ PCUWSTR Source) {
#pragma warning(push)
...
#pragma warning(disable : 28719) // This function (ua_wcscpy) is also tagged as
...
PUWSTR
__cdecl uaw_wcscpy(_Out_writes_(_Inexpressible_("Sufficient length"))
                       PUWSTR Destination,
                   _In_ PCUWSTR Source);
...
__inline PUWSTR static _WINDOWS_INSECURE_DEPRECATE
ua_wcschr(_In_ PUWSTR String, _In_ WCHAR Character) {
  if (WSTR_ALIGNED(String)) {
#pragma warning(push)
#pragma warning(disable : 4995)
#pragma warning(disable : 4996)
...
__inline PUWSTR static ua_wcscpy_s(_Out_writes_(DestinationSize)
                                       PUWSTR Destination,
