...
typedef struct IDXGISwapChain3Vtbl {
  ...
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(IDXGISwapChain3 *This,
                                             /* [in] */ REFIID riid,
  ...
  HRESULT(STDMETHODCALLTYPE *SetMatrixTransform)(
      IDXGISwapChain3 *This, const DXGI_MATRIX_3X2_F *pMatrix);
...
interface IDXGISwapChain3 { CONST_VTBL struct IDXGISwapChain3Vtbl *lpVtbl; };
...
#define IDXGISwapChain3_ResizeBuffers(This, BufferCount, Width, Height,        \
...
#define IDXGISwapChain3_CheckColorSpaceSupport(This, ColorSpace,               \
                                               pColorSpaceSupport)             \
...
#define IDXGISwapChain3_ResizeBuffers1(This, BufferCount, Width, Height,       \
...
typedef struct IDXGIOutput4Vtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(IDXGIOutput4 *This,
                                             /* [in] */ REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);
  ...
  DECLSPEC_XFGVIRT(IDXGIObject, SetPrivateData)
  HRESULT(STDMETHODCALLTYPE *SetPrivateData)(IDXGIOutput4 *This,
                                             /* [annotation][in] */
                                             _In_ REFGUID Name,
                                             /* [in] */ UINT DataSize,
                                             /* [annotation][in] */
  ...
  DECLSPEC_XFGVIRT(IDXGIObject, GetParent)
  HRESULT(STDMETHODCALLTYPE *GetParent)(IDXGIOutput4 *This,
                                        /* [annotation][in] */
                                        _In_ REFIID riid,
                                        /* [annotation][retval][out] */
                                        _COM_Outptr_ void **ppParent);
  ...
  HRESULT(STDMETHODCALLTYPE *GetGammaControl)(IDXGIOutput4 *This,
                                              /* [annotation][out] */
...
interface IDXGIOutput4 { CONST_VTBL struct IDXGIOutput4Vtbl *lpVtbl; };
...
#define IDXGIOutput4_GetDisplayModeList(This, EnumFormat, Flags, pNumModes,    \
                                        pDesc)                                 \
  ((This)->lpVtbl->GetDisplayModeList(This, EnumFormat, Flags, pNumModes,      \
                                      pDesc))

#define IDXGIOutput4_FindClosestMatchingMode(This, pModeToMatch,               \
...
#define IDXGIOutput4_GetDisplayModeList1(This, EnumFormat, Flags, pNumModes,   \
                                         pDesc)                                \
  ((This)->lpVtbl->GetDisplayModeList1(This, EnumFormat, Flags, pNumModes,     \
                                       pDesc))

#define IDXGIOutput4_FindClosestMatchingMode1(This, pModeToMatch,              \
                                              pClosestMatch, pConcernedDevice) \
...
#define IDXGIOutput4_CheckOverlaySupport(This, EnumFormat, pConcernedDevice,   \
                                         pFlags)                               \
  ((This)->lpVtbl->CheckOverlaySupport(This, EnumFormat, pConcernedDevice,     \
                                       pFlags))

#define IDXGIOutput4_CheckOverlayColorSpaceSupport(This, Format, ColorSpace,   \
...
typedef struct IDXGIFactory4Vtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(IDXGIFactory4 *This,
                                             /* [in] */ REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);
...
interface IDXGIFactory4 { CONST_VTBL struct IDXGIFactory4Vtbl *lpVtbl; };
...
typedef struct IDXGIAdapter3Vtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(IDXGIAdapter3 *This,
                                             /* [in] */ REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);
  ...
  DECLSPEC_XFGVIRT(IDXGIObject, GetParent)
  HRESULT(STDMETHODCALLTYPE *GetParent)(IDXGIAdapter3 *This,
                                        /* [annotation][in] */
                                        _In_ REFIID riid,
                                        /* [annotation][retval][out] */
                                        _COM_Outptr_ void **ppParent);
...
interface IDXGIAdapter3 { CONST_VTBL struct IDXGIAdapter3Vtbl *lpVtbl; };
