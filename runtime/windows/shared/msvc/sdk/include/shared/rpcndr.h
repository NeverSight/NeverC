...
_Ret_maybenull_ _Post_writable_byte_size_(size) void *__RPC_USER
    I_RpcDefaultAllocate(handle_t bh, size_t size, void *(*RealAlloc)(size_t));
...
RPC_BINDING_HANDLE
RPC_ENTRY
NDRCContextBinding(_In_ NDR_CCONTEXT CContext);

RPCRTAPI
void RPC_ENTRY NDRCContextMarshall(_In_opt_ NDR_CCONTEXT CContext,
                                   _Out_ void *pBuff);

RPCRTAPI
void RPC_ENTRY NDRCContextUnmarshall(_Inout_opt_ NDR_CCONTEXT *pCContext,
                                     _In_ RPC_BINDING_HANDLE hBinding,
                                     _In_ void *pBuff,
                                     _In_ unsigned long DataRepresentation);

RPCRTAPI
void RPC_ENTRY NDRCContextUnmarshall2(_Inout_opt_ NDR_CCONTEXT *pCContext,
                                      _In_ RPC_BINDING_HANDLE hBinding,
                                      _In_ void *pBuff,
                                      _In_ unsigned long DataRepresentation);

RPCRTAPI
void RPC_ENTRY NDRSContextMarshall(_In_ NDR_SCONTEXT CContext,
                                   _Out_ void *pBuff,
...
NDR_SCONTEXT
RPC_ENTRY
NDRSContextUnmarshall(_In_ void *pBuff, _In_ unsigned long DataRepresentation);

RPCRTAPI
void RPC_ENTRY NDRSContextMarshallEx(_In_ RPC_BINDING_HANDLE BindingHandle,
                                     _In_ NDR_SCONTEXT CContext,
                                     _Out_ void *pBuff,
                                     _In_ NDR_RUNDOWN userRunDownIn);

RPCRTAPI
void RPC_ENTRY NDRSContextMarshall2(_In_ RPC_BINDING_HANDLE BindingHandle,
                                    _In_ NDR_SCONTEXT CContext,
                                    _Out_ void *pBuff,
                                    _In_ NDR_RUNDOWN userRunDownIn,
...
NDR_SCONTEXT
RPC_ENTRY
NDRSContextUnmarshallEx(_In_ RPC_BINDING_HANDLE BindingHandle, _In_ void *pBuff,
                        _In_ unsigned long DataRepresentation);

RPCRTAPI
NDR_SCONTEXT
RPC_ENTRY
NDRSContextUnmarshall2(_In_ RPC_BINDING_HANDLE BindingHandle,
                       _In_opt_ void *pBuff,
                       _In_ unsigned long DataRepresentation,
                       _In_opt_ void *CtxGuard, _In_ unsigned long Flags);

RPCRTAPI
void RPC_ENTRY RpcSsDestroyClientContext(_In_ void **ContextHandle);
 ...
 ****************************************************************************/
    ...
    defined(__RPC_ARM32__) || defined(__RPC_ARM64__)
...
#define NdrMarshConfStringHdr(p, s, l)                                         \
  (_midl_ma4(p, unsigned long) = s, _midl_ma4(p, unsigned long) = 0,           \
...
#define NdrFieldPad(s, f, p, t)                                                \
  ((unsigned long)(NdrFieldOffset(s, f) - NdrFieldOffset(s, p)) - sizeof(t))
...
typedef unsigned char *(__RPC_USER *USER_MARSHAL_MARSHALLING_ROUTINE)(
    unsigned long *, unsigned char *, void *);

typedef unsigned char *(__RPC_USER *USER_MARSHAL_UNMARSHALLING_ROUTINE)(
    unsigned long *, unsigned char *, void *);
...
typedef void(__RPC_USER *CS_TYPE_NET_SIZE_ROUTINE)(
    RPC_BINDING_HANDLE hBinding, unsigned long ulNetworkCodeSet,
...
typedef void(__RPC_USER *CS_TYPE_LOCAL_SIZE_ROUTINE)(
    RPC_BINDING_HANDLE hBinding, unsigned long ulNetworkCodeSet,
    unsigned long ulNetworkBufferSize, IDL_CS_CONVERT *conversionType,
    unsigned long *pulLocalBufferSize, error_status_t *pStatus);

typedef void(__RPC_USER *CS_TYPE_TO_NETCS_ROUTINE)(
    RPC_BINDING_HANDLE hBinding, unsigned long ulNetworkCodeSet,
    void *pLocalData, unsigned long ulLocalDataLength, byte *pNetworkData,
    unsigned long *pulNetworkDataLength, error_status_t *pStatus);
...
typedef void(__RPC_USER *CS_TAG_GETTING_ROUTINE)(
    RPC_BINDING_HANDLE hBinding, int fServerSide, unsigned long *pulSendingTag,
    unsigned long *pulDesiredReceivingTag, unsigned long *pulReceivingTag,
    error_status_t *pStatus);

void __RPC_USER RpcCsGetTags(RPC_BINDING_HANDLE hBinding, int fServerSide,
...
RPC_STATUS RPC_ENTRY NdrClientGetSupportedSyntaxes(
    _In_ RPC_CLIENT_INTERFACE *pInf, _Out_ unsigned long *pCount,
    _Out_ MIDL_SYNTAX_INFO **pArr);

RPC_STATUS RPC_ENTRY NdrServerGetSupportedSyntaxes(
    _In_ RPC_SERVER_INTERFACE *pInf, _Out_ unsigned long *pCount,
    _Out_ MIDL_SYNTAX_INFO **pArr, _Out_ unsigned long *pPreferSyntaxIndex);
...
RPCRTAPI
unsigned char *RPC_ENTRY NdrCsArrayMarshall(PMIDL_STUB_MESSAGE pStubMsg,
                                            unsigned char *pMemory,
                                            PFORMAT_STRING pFormat);

RPCRTAPI
unsigned char *RPC_ENTRY NdrCsTagMarshall(PMIDL_STUB_MESSAGE pStubMsg,
                                          unsigned char *pMemory,
                                          PFORMAT_STRING pFormat);
...
RPCRTAPI
unsigned char *RPC_ENTRY NdrConformantVaryingStructMarshall(
...
RPCRTAPI
unsigned char *RPC_ENTRY NdrConformantVaryingArrayMarshall(
    PMIDL_STUB_MESSAGE pStubMsg, unsigned char *pMemory,
    PFORMAT_STRING pFormat);
...
void RPC_ENTRY NdrClientContextMarshall(PMIDL_STUB_MESSAGE pStubMsg,
                                        NDR_CCONTEXT ContextHandle, int fCheck);
...
RPCRTAPI
unsigned char *RPC_ENTRY NdrCsArrayUnmarshall(PMIDL_STUB_MESSAGE pStubMsg,
                                              unsigned char **ppMemory,
                                              PFORMAT_STRING pFormat,
                                              unsigned char fMustAlloc);

RPCRTAPI
unsigned char *RPC_ENTRY NdrCsTagUnmarshall(PMIDL_STUB_MESSAGE pStubMsg,
                                            unsigned char **ppMemory,
                                            PFORMAT_STRING pFormat,
                                            unsigned char fMustAlloc);

RPCRTAPI
unsigned char *RPC_ENTRY NdrRangeUnmarshall(PMIDL_STUB_MESSAGE pStubMsg,
                                            unsigned char **ppMemory,
                                            PFORMAT_STRING pFormat,
                                            unsigned char fMustAlloc);

RPCRTAPI
void RPC_ENTRY NdrCorrelationInitialize(PMIDL_STUB_MESSAGE pStubMsg,
                                        void *pMemory, unsigned long CacheSize,
                                        unsigned long flags);
...
RPCRTAPI
unsigned char *RPC_ENTRY NdrConformantStructUnmarshall(
    PMIDL_STUB_MESSAGE pStubMsg, unsigned char **ppMemory,
    PFORMAT_STRING pFormat, unsigned char fMustAlloc);

RPCRTAPI
unsigned char *RPC_ENTRY NdrConformantVaryingStructUnmarshall(
    PMIDL_STUB_MESSAGE pStubMsg, unsigned char **ppMemory,
    PFORMAT_STRING pFormat, unsigned char fMustAlloc);
...
RPCRTAPI
unsigned char *RPC_ENTRY NdrConformantArrayUnmarshall(
    PMIDL_STUB_MESSAGE pStubMsg, unsigned char **ppMemory,
    PFORMAT_STRING pFormat, unsigned char fMustAlloc);

RPCRTAPI
unsigned char *RPC_ENTRY NdrConformantVaryingArrayUnmarshall(
    PMIDL_STUB_MESSAGE pStubMsg, unsigned char **ppMemory,
    PFORMAT_STRING pFormat, unsigned char fMustAlloc);
...
RPCRTAPI
unsigned char *RPC_ENTRY NdrNonConformantStringUnmarshall(
    PMIDL_STUB_MESSAGE pStubMsg, unsigned char **ppMemory,
    PFORMAT_STRING pFormat, unsigned char fMustAlloc);

RPCRTAPI
unsigned char *RPC_ENTRY NdrConformantStringUnmarshall(
    PMIDL_STUB_MESSAGE pStubMsg, unsigned char **ppMemory,
    PFORMAT_STRING pFormat, unsigned char fMustAlloc);
...
RPCRTAPI
unsigned char *RPC_ENTRY NdrEncapsulatedUnionUnmarshall(
    PMIDL_STUB_MESSAGE pStubMsg, unsigned char **ppMemory,
    PFORMAT_STRING pFormat, unsigned char fMustAlloc);

RPCRTAPI
unsigned char *RPC_ENTRY NdrNonEncapsulatedUnionUnmarshall(
    PMIDL_STUB_MESSAGE pStubMsg, unsigned char **ppMemory,
    PFORMAT_STRING pFormat, unsigned char fMustAlloc);
...
RPCRTAPI
unsigned char *RPC_ENTRY NdrByteCountPointerUnmarshall(
    PMIDL_STUB_MESSAGE pStubMsg, unsigned char **ppMemory,
    PFORMAT_STRING pFormat, unsigned char fMustAlloc);
...
RPCRTAPI
unsigned char *RPC_ENTRY NdrInterfacePointerUnmarshall(
    PMIDL_STUB_MESSAGE pStubMsg, unsigned char **ppMemory,
    PFORMAT_STRING pFormat, unsigned char fMustAlloc);
...
NDR_SCONTEXT
RPC_ENTRY
NdrContextHandleInitialize(_In_ PMIDL_STUB_MESSAGE pStubMsg,
                           _In_reads_(_Inexpressible_(2))
                               PFORMAT_STRING pFormat);

RPCRTAPI
NDR_SCONTEXT
RPC_ENTRY
NdrServerContextNewUnmarshall(_In_ PMIDL_STUB_MESSAGE pStubMsg,
                              _In_reads_(_Inexpressible_(2))
                                  PFORMAT_STRING pFormat);
...
RPCRTAPI
void RPC_ENTRY NdrCsArrayBufferSize(PMIDL_STUB_MESSAGE pStubMsg,
                                    unsigned char *pMemory,
                                    PFORMAT_STRING pFormat);

RPCRTAPI
void RPC_ENTRY NdrCsTagBufferSize(PMIDL_STUB_MESSAGE pStubMsg,
                                  unsigned char *pMemory,
                                  PFORMAT_STRING pFormat);
...
RPCRTAPI
unsigned long RPC_ENTRY NdrContextHandleMemorySize(PMIDL_STUB_MESSAGE pStubMsg,
                                                   PFORMAT_STRING pFormat);

/* cs_char things */

RPCRTAPI
unsigned long RPC_ENTRY NdrCsArrayMemorySize(PMIDL_STUB_MESSAGE pStubMsg,
                                             PFORMAT_STRING pFormat);

RPCRTAPI
unsigned long RPC_ENTRY NdrCsTagMemorySize(PMIDL_STUB_MESSAGE pStubMsg,
                                           PFORMAT_STRING pFormat);
...
RPCRTAPI
unsigned long RPC_ENTRY NdrConformantStructMemorySize(
    PMIDL_STUB_MESSAGE pStubMsg, PFORMAT_STRING pFormat);

RPCRTAPI
unsigned long RPC_ENTRY NdrConformantVaryingStructMemorySize(
    PMIDL_STUB_MESSAGE pStubMsg, PFORMAT_STRING pFormat);
...
RPCRTAPI
unsigned long RPC_ENTRY NdrConformantArrayMemorySize(
    PMIDL_STUB_MESSAGE pStubMsg, PFORMAT_STRING pFormat);

RPCRTAPI
unsigned long RPC_ENTRY NdrConformantVaryingArrayMemorySize(
    PMIDL_STUB_MESSAGE pStubMsg, PFORMAT_STRING pFormat);
...
RPCRTAPI
unsigned long RPC_ENTRY NdrConformantStringMemorySize(
    PMIDL_STUB_MESSAGE pStubMsg, PFORMAT_STRING pFormat);

RPCRTAPI
unsigned long RPC_ENTRY NdrNonConformantStringMemorySize(
    PMIDL_STUB_MESSAGE pStubMsg, PFORMAT_STRING pFormat);
...
RPCRTAPI
unsigned long RPC_ENTRY NdrNonEncapsulatedUnionMemorySize(
    PMIDL_STUB_MESSAGE pStubMsg, PFORMAT_STRING pFormat);
...
RPCRTAPI
unsigned long RPC_ENTRY NdrInterfacePointerMemorySize(
    PMIDL_STUB_MESSAGE pStubMsg, PFORMAT_STRING pFormat);
...
RPCRTAPI
void RPC_ENTRY NdrCsArrayFree(PMIDL_STUB_MESSAGE pStubMsg,
                              unsigned char *pMemory, PFORMAT_STRING pFormat);
...
RPCRTAPI
void RPC_ENTRY NdrConvert2(PMIDL_STUB_MESSAGE pStubMsg, PFORMAT_STRING pFormat,
                           long NumberParams);
...
RPCRTAPI
unsigned char *RPC_ENTRY NdrUserMarshalSimpleTypeConvert(
    unsigned long *pFlags, unsigned char *pBuffer, unsigned char FormatChar);
...
RPCRTAPI
void RPC_ENTRY NdrClientInitializeNew(PRPC_MESSAGE pRpcMsg,
                                      PMIDL_STUB_MESSAGE pStubMsg,
...
RPCRTAPI
void RPC_ENTRY NdrServerInitializePartial(PRPC_MESSAGE pRpcMsg,
                                          PMIDL_STUB_MESSAGE pStubMsg,
                                          PMIDL_STUB_DESC pStubDescriptor,
                                          unsigned long RequestedBufferSize);

RPCRTAPI
void RPC_ENTRY NdrClientInitialize(PRPC_MESSAGE pRpcMsg,
                                   PMIDL_STUB_MESSAGE pStubMsg,
                                   PMIDL_STUB_DESC pStubDescriptor,
                                   unsigned int ProcNum);

RPCRTAPI
unsigned char *RPC_ENTRY NdrServerInitialize(PRPC_MESSAGE pRpcMsg,
                                             PMIDL_STUB_MESSAGE pStubMsg,
                                             PMIDL_STUB_DESC pStubDescriptor);

RPCRTAPI
unsigned char *RPC_ENTRY NdrServerInitializeUnmarshall(
    PMIDL_STUB_MESSAGE pStubMsg, PMIDL_STUB_DESC pStubDescriptor,
    PRPC_MESSAGE pRpcMsg);

RPCRTAPI
void RPC_ENTRY NdrServerInitializeMarshall(PRPC_MESSAGE pRpcMsg,
                                           PMIDL_STUB_MESSAGE pStubMsg);

RPCRTAPI
unsigned char *RPC_ENTRY NdrGetBuffer(PMIDL_STUB_MESSAGE pStubMsg,
                                      unsigned long BufferLength,
                                      RPC_BINDING_HANDLE Handle);

RPCRTAPI
unsigned char *RPC_ENTRY NdrNsGetBuffer(PMIDL_STUB_MESSAGE pStubMsg,
                                        unsigned long BufferLength,
                                        RPC_BINDING_HANDLE Handle);

RPCRTAPI
unsigned char *RPC_ENTRY NdrSendReceive(PMIDL_STUB_MESSAGE pStubMsg,
                                        unsigned char *pBufferEnd);

RPCRTAPI
unsigned char *RPC_ENTRY NdrNsSendReceive(PMIDL_STUB_MESSAGE pStubMsg,
                                          unsigned char *pBufferEnd,
...
CLIENT_CALL_RETURN RPC_VAR_ENTRY NdrClientCall4(PMIDL_STUB_DESC pStubDescriptor,
                                                PFORMAT_STRING pFormat, ...);
...
NdrMesProcEncodeDecode4(handle_t Handle, const MIDL_STUB_DESC *pStubDescriptor,
                        PFORMAT_STRING pFormat, ...);
...
CLIENT_CALL_RETURN
RPC_VAR_ENTRY NdrDcomAsyncClientCall(PMIDL_STUB_DESC pStubDescriptor,
                                     PFORMAT_STRING pFormat, ...);

#if (!defined(_WIN64) && !defined(_ARM_))

CLIENT_CALL_RETURN
RPC_VAR_ENTRY NdrDcomAsyncClientCall2(PMIDL_STUB_DESC pStubDescriptor,
                                      PFORMAT_STRING pFormat, ...);
...
// async uuid
RPCRTAPI
long RPC_ENTRY NdrDcomAsyncStubCall(struct IRpcStubBuffer *pThis,
                                    struct IRpcChannelBuffer *pChannel,
                                    PRPC_MESSAGE pRpcMsg,
                                    unsigned long *pdwStubPhase);
...
RPCRTAPI
long RPC_ENTRY NdrStubCall2(void *pThis,    // struct IRpcStubBuffer
...
RPCRTAPI
long RPC_ENTRY NdrStubCall(void *pThis,    // struct IRpcStubBuffer
                           void *pChannel, // struct IRpcChannelBuffer
                           PRPC_MESSAGE pRpcMsg, unsigned long *pdwStubPhase);
...
RPCRTAPI
int RPC_ENTRY NdrServerUnmarshall(
    void *pChannel, // Converted to struct IRpcChannelBuffer
    PRPC_MESSAGE pRpcMsg, PMIDL_STUB_MESSAGE pStubMsg,
    PMIDL_STUB_DESC pStubDescriptor, PFORMAT_STRING pFormat, void *pParamList);

RPCRTAPI
void RPC_ENTRY
NdrServerMarshall(void *pThis,    // Converted to struct IRpcStubBuffer
                  void *pChannel, // Converted to struct IRpcChannelBuffer
                  PMIDL_STUB_MESSAGE pStubMsg, PFORMAT_STRING pFormat);
...
NdrMapCommAndFaultStatus(PMIDL_STUB_MESSAGE pStubMsg,
                         ...
                         unsigned long *pFaultStatus, RPC_STATUS Status);
...
typedef void *__RPC_API RPC_CLIENT_ALLOC(_In_ size_t Size);

typedef void __RPC_API RPC_CLIENT_FREE(_In_ void *Ptr);
...
RPCRTAPI
void *RPC_ENTRY RpcSsAllocate(_In_ size_t Size);
...
RPCRTAPI
void RPC_ENTRY RpcSsFree(_In_ void *NodeToFree);
...
RPCRTAPI
void RPC_ENTRY RpcSsSetClientAllocFree(_In_ RPC_CLIENT_ALLOC *ClientAlloc,
                                       _In_ RPC_CLIENT_FREE *ClientFree);

RPCRTAPI
void RPC_ENTRY RpcSsSetThreadHandle(_In_ RPC_SS_THREAD_HANDLE Id);

RPCRTAPI
void RPC_ENTRY RpcSsSwapClientAllocFree(_In_ RPC_CLIENT_ALLOC *ClientAlloc,
                                        _In_ RPC_CLIENT_FREE *ClientFree,
...
RPCRTAPI
void *RPC_ENTRY RpcSmAllocate(_In_ size_t Size, _Out_ RPC_STATUS *pStatus);

RPCRTAPI
RPC_STATUS
RPC_ENTRY
RpcSmClientFree(_In_ void *pNodeToFree);

RPCRTAPI
RPC_STATUS
RPC_ENTRY
RpcSmDestroyClientContext(_In_ void **ContextHandle);
...
RPC_STATUS
RPC_ENTRY
RpcSmFree(_In_ void *NodeToFree);

RPCRTAPI
RPC_SS_THREAD_HANDLE
RPC_ENTRY
RpcSmGetThreadHandle(_Out_ RPC_STATUS *pStatus);

RPCRTAPI
RPC_STATUS
RPC_ENTRY
RpcSmSetClientAllocFree(_In_ RPC_CLIENT_ALLOC *ClientAlloc,
                        _In_ RPC_CLIENT_FREE *ClientFree);

RPCRTAPI
RPC_STATUS
RPC_ENTRY
RpcSmSetThreadHandle(_In_ RPC_SS_THREAD_HANDLE Id);

RPCRTAPI
RPC_STATUS
RPC_ENTRY
RpcSmSwapClientAllocFree(_In_ RPC_CLIENT_ALLOC *ClientAlloc,
                         _In_ RPC_CLIENT_FREE *ClientFree,
                         _Out_ RPC_CLIENT_ALLOC **OldClientAlloc,
                         _Out_ RPC_CLIENT_FREE **OldClientFree);
...
RPCRTAPI
void *RPC_ENTRY NdrRpcSmClientAllocate(_In_ size_t Size);

RPCRTAPI
void RPC_ENTRY NdrRpcSmClientFree(_In_ void *NodeToFree);

RPCRTAPI
void *RPC_ENTRY NdrRpcSsDefaultAllocate(_In_ size_t Size);

RPCRTAPI
void RPC_ENTRY NdrRpcSsDefaultFree(_In_ void *NodeToFree);
...
void RPC_ENTRY NdrClearOutParameters(PMIDL_STUB_MESSAGE pStubMsg,
                                     PFORMAT_STRING pFormat, void *ArgAddr);
...
RPCRTAPI
void *RPC_ENTRY NdrOleAllocate(_In_ size_t Size);
...
#if (_MSC_VER >= 1100)
#define MIDL_CONSTINIT_CONST_INLINE_VARIABLE                                   \
  EXTERN_C const __declspec(selectany)
#else
...
RPC_STATUS
RPC_ENTRY
NdrGetUserMarshalInfo(_In_ unsigned long *pFlags,
...
RPC_STATUS RPC_ENTRY NdrCreateServerInterfaceFromStub(
    _In_ struct IRpcStubBuffer *pStub, _Inout_ RPC_SERVER_INTERFACE *pServerIf);

/*
 * Interpreter calls
 */
CLIENT_CALL_RETURN RPC_VAR_ENTRY
NdrClientCall3(MIDL_STUBLESS_PROXY_INFO *pProxyInfo, unsigned long nProcNum,
               void *pReturnValue, ...);
...
CLIENT_CALL_RETURN
RPC_VAR_ENTRY Ndr64DcomAsyncClientCall(MIDL_STUBLESS_PROXY_INFO *pProxyInfo,
...
RPCRTAPI
long RPC_ENTRY Ndr64AsyncStubCall(struct IRpcStubBuffer *pThis,
                                  struct IRpcChannelBuffer *pChannel,
                                  PRPC_MESSAGE pRpcMsg,
                                  unsigned long *pdwStubPhase);
...
/* async uuid */
RPCRTAPI
long RPC_ENTRY Ndr64DcomAsyncStubCall(struct IRpcStubBuffer *pThis,
                                      struct IRpcChannelBuffer *pChannel,
                                      PRPC_MESSAGE pRpcMsg,
                                      unsigned long *pdwStubPhase);
...
RPCRTAPI
long RPC_ENTRY NdrStubCall3(void *pThis,    // struct IRpcStubBuffer
                            void *pChannel, // struct IRpcChannelBuffer
                            PRPC_MESSAGE pRpcMsg, unsigned long *pdwStubPhase);
...
RPCRTAPI
void RPC_ENTRY NdrPartialIgnoreClientMarshall(PMIDL_STUB_MESSAGE pStubMsg,
                                              void *pMemory);

RPCRTAPI
void RPC_ENTRY NdrPartialIgnoreServerUnmarshall(PMIDL_STUB_MESSAGE pStubMsg,
                                                void **ppMemory);

RPCRTAPI
void RPC_ENTRY NdrPartialIgnoreClientBufferSize(PMIDL_STUB_MESSAGE pStubMsg,
                                                void *pMemory);

RPCRTAPI
void RPC_ENTRY NdrPartialIgnoreServerInitialize(PMIDL_STUB_MESSAGE pStubMsg,
                                                void **ppMemory,
                                                PFORMAT_STRING pFormat);
