...
#if !defined(_MAC) && (defined(_M_MRX000) || defined(_WIN64)) &&               \
    (_MSC_VER >= 1100) && !(defined(MIDL_PASS) || defined(RC_INVOKED))
...
#if !defined(__midl)
__inline void *POINTER_64 PtrToPtr64(const void *p) {
  return ((void *POINTER_64)(unsigned __int64)(ULONG_PTR)p);
}

__inline void *Ptr64ToPtr(const void *POINTER_64 p) {
  return ((void *)(ULONG_PTR)(unsigned __int64)p);
}

__inline HANDLE64 HandleToHandle64(const void *h) {
  return ((HANDLE64)(__int64)(LONG_PTR)h);
}

__inline void *Handle64ToHandle(const HANDLE64 h) {
