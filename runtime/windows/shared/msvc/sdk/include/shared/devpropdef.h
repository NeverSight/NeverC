...
#define DEVPROP_TYPE_CURRENCY                                                  \
  0x0000000E // 64 bit signed int currency value (CURRENCY)
...
#define DEVPROP_TYPE_STRING_LIST                                               \
  (DEVPROP_TYPE_STRING | DEVPROP_TYPEMOD_LIST) // multi-sz string list
#define DEVPROP_TYPE_SECURITY_DESCRIPTOR                                       \
  0x00000013 // self-relative binary SECURITY_DESCRIPTOR
#define DEVPROP_TYPE_SECURITY_DESCRIPTOR_STRING                                \
  0x00000014 // security descriptor string (SDDL format)
#define DEVPROP_TYPE_DEVPROPKEY 0x00000015 // device property key (DEVPROPKEY)
#define DEVPROP_TYPE_DEVPROPTYPE                                               \
  0x00000016 // device property type (DEVPROPTYPE)
#define DEVPROP_TYPE_BINARY                                                    \
  (DEVPROP_TYPE_BYTE | DEVPROP_TYPEMOD_ARRAY) // custom binary data
...
#define DEVPROP_TYPE_STRING_INDIRECT                                           \
  0x00000019 // string resource (@[path\]<dllname>,-<strId>)
...
#define DEVPROP_MASK_TYPEMOD                                                   \
  0x0000F000 // mask for DEVPROP_TYPEMOD_ type modifiers
...
extern "C++" {
inline bool operator==(const DEVPROPKEY &a, const DEVPROPKEY &b) {
...
#ifdef _SYS_GUID_OPERATOR_EQ_
extern "C++" {
inline bool operator==(const DEVPROPCOMPKEY &a, const DEVPROPCOMPKEY &b) {
...
// greater than DEVPROPID_FIRST_USABLE.
//
