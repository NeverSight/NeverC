...
//@[contract("rpcdcep"), comment("MVI_tracked -
...
typedef RPC_STATUS RPC_ENTRY RPC_FORWARD_FUNCTION(
    IN UUID __RPC_FAR *InterfaceId, IN RPC_VERSION __RPC_FAR *InterfaceVersion,
...
RPC_STATUS
RPC_ENTRY
I_RpcGetBufferWithObject(IN OUT RPC_MESSAGE __RPC_FAR *Message,
                         IN UUID *ObjectUuid);
...
RPCRTAPI
_Must_inspect_result_ RPC_STATUS RPC_ENTRY
I_RpcReallocPipeBuffer(_In_ PRPC_MESSAGE Message, unsigned int NewSize);
...
RPCRTAPI
unsigned long RPC_ENTRY I_RpcFreeSystemHandleCollection(
    _Inout_ void *CallObj, _In_ unsigned long FreeFlags);

RPCRTAPI
RPC_STATUS
RPC_ENTRY
I_RpcSetSystemHandle(_In_ void *Handle, _In_ unsigned char Type,
                     _In_ unsigned long AccessMask, _Inout_ void *CallObj,
                     _Out_ unsigned long *HandleIndex);

RPCRTAPI
RPC_STATUS
RPC_ENTRY
I_RpcGetSystemHandle(_Out_writes_bytes_(sizeof(HANDLE)) unsigned char *pMemory,
                     _In_ unsigned char Type, _In_ unsigned long AccessMask,
                     _In_ unsigned long HandleIndex, _Inout_ void *CallObj);

RPCRTAPI
void RPC_ENTRY I_RpcFreeSystemHandle(_In_ unsigned char Type,
                                     _In_ void *Handle);
...
I_RpcSystemHandleTypeSpecificWork(
    _Inout_ void *Handle, _In_ unsigned char ActualType,
...
RPCRTAPI
_Must_inspect_result_ RPC_STATUS RPC_ENTRY
I_RpcMonitorAssociation(IN RPC_BINDING_HANDLE Handle,
                        IN PRPC_RUNDOWN RundownRoutine, IN void *Context);
...
RPCRTAPI
_Must_inspect_result_ RPC_STATUS RPC_ENTRY
I_RpcGetAssociationContext(IN RPC_BINDING_HANDLE BindingHandle,
...
RPCRTAPI
void RPC_ENTRY I_RpcSetServerContextList(IN RPC_BINDING_HANDLE BindingHandle,
                                         OUT void *ServerContextList);

RPCRTAPI
RPC_STATUS
RPC_ENTRY
I_RpcNsInterfaceExported(IN unsigned long EntryNameSyntax,
...
RPC_STATUS
RPC_ENTRY
I_RpcNsInterfaceUnexported(IN unsigned long EntryNameSyntax,
                           IN unsigned short *EntryName,
                           IN RPC_SERVER_INTERFACE *RpcInterfaceInformation);
...
RPC_STATUS
RPC_ENTRY
I_RpcBindingToStaticStringBindingW(IN RPC_BINDING_HANDLE Binding,
                                   OUT unsigned short **StringBinding);

RPCRTAPI
RPC_STATUS
RPC_ENTRY
I_RpcBindingInqSecurityContext(IN RPC_BINDING_HANDLE Binding,
...
RPC_STATUS
RPC_ENTRY
I_RpcBindingInqSecurityContextKeyInfo(_In_opt_ RPC_BINDING_HANDLE Binding,
...
RPC_STATUS
RPC_ENTRY
I_RpcBindingInqWireIdForSnego(_In_ RPC_BINDING_HANDLE Binding,
...
I_RpcBindingInqMarshalledTargetInfo(
    ...
    _Outptr_result_bytebuffer_(*MarshalledTargetInfoSize)
...
RPC_STATUS
RPC_ENTRY
I_RpcBindingInqLocalClientPID(IN RPC_BINDING_HANDLE Binding,
                              OUT unsigned long *Pid);

RPCRTAPI
RPC_STATUS
RPC_ENTRY
I_RpcBindingHandleToAsyncHandle(IN RPC_BINDING_HANDLE Binding,
...
RPCRTAPI
_Must_inspect_result_ RPC_STATUS RPC_ENTRY I_RpcNsBindingSetEntryNameW(
    _In_ RPC_BINDING_HANDLE Binding, _In_ unsigned long EntryNameSyntax,
    _In_ RPC_WSTR EntryName);

RPCRTAPI
_Must_inspect_result_ RPC_STATUS RPC_ENTRY I_RpcNsBindingSetEntryNameA(
    _In_ RPC_BINDING_HANDLE Binding, _In_ unsigned long EntryNameSyntax,
...
RPC_STATUS
RPC_ENTRY
I_RpcServerUseProtseqEp2A(_In_opt_ RPC_CSTR NetworkAddress,
...
RPC_STATUS
RPC_ENTRY
I_RpcServerUseProtseqEp2W(_In_opt_ RPC_WSTR NetworkAddress,
...
RPC_STATUS
RPC_ENTRY
I_RpcServerUseProtseq2W(_In_opt_ RPC_WSTR NetworkAddress, _In_ RPC_WSTR Protseq,
...
RPC_STATUS
RPC_ENTRY
I_RpcServerUseProtseq2A(_In_opt_ RPC_CSTR NetworkAddress, _In_ RPC_CSTR Protseq,
                        _In_ unsigned int MaxCalls,
                        _In_opt_ void __RPC_FAR *SecurityDescriptor,
                        _In_ void *Policy);
...
RPC_STATUS
RPC_ENTRY
I_RpcNsBindingSetEntryName(_In_ RPC_BINDING_HANDLE Binding,
...
RPC_STATUS
RPC_ENTRY
I_RpcServerUseProtseq2(_In_ RPC_CSTR NetworkAddress, _In_ RPC_CSTR Protseq,
                       _In_ unsigned int MaxCalls,
...
RPC_STATUS
RPC_ENTRY
I_RpcServerUseProtseqEp2(_In_ RPC_CSTR NetworkAddress, _In_ RPC_CSTR Protseq,
                         _In_ unsigned int MaxCalls, _In_ RPC_CSTR Endpoint,
                         _In_ void __RPC_FAR *SecurityDescriptor,
                         _In_ void *Policy);
#endif
...
RPC_STATUS
RPC_ENTRY
I_RpcServerStartService(_In_ RPC_WSTR Protseq, _In_ RPC_WSTR Endpoint,
                        _In_ RPC_IF_HANDLE IfSpec);

#ifdef RPC_UNICODE_SUPPORTED

RPCRTAPI
_Must_inspect_result_ RPC_STATUS RPC_ENTRY I_RpcBindingInqDynamicEndpointW(
    _In_ RPC_BINDING_HANDLE Binding,
    _Outptr_result_maybenull_ RPC_WSTR __RPC_FAR *DynamicEndpoint);

RPCRTAPI
_Must_inspect_result_ RPC_STATUS RPC_ENTRY I_RpcBindingInqDynamicEndpointA(
    _In_ RPC_BINDING_HANDLE Binding,
...
RPCRTAPI
_Must_inspect_result_ RPC_STATUS RPC_ENTRY I_RpcBindingInqDynamicEndpoint(
    _In_ RPC_BINDING_HANDLE Binding,
    _Outptr_result_maybenull_ RPC_CSTR __RPC_FAR *DynamicEndpoint);
...
RPC_STATUS
RPC_ENTRY
I_RpcServerCheckClientRestriction(IN RPC_BINDING_HANDLE Context);
#endif // (NTDDI_VERSION >= NTDDI_WINXP)
...
//@[comment("MVI_tracked")]
RPCRTAPI
_Must_inspect_result_ RPC_STATUS RPC_ENTRY I_RpcBindingInqTransportType(
    IN RPC_BINDING_HANDLE Binding, OUT unsigned int __RPC_FAR *Type);
...
RPCRTAPI
_Must_inspect_result_ RPC_STATUS RPC_ENTRY
I_RpcIfInqTransferSyntaxes(IN RPC_IF_HANDLE RpcIfHandle,
...
RPCRTAPI
void RPC_ENTRY I_RpcUninitializeNdrOle(void);

RPCRTAPI
_Must_inspect_result_ RPC_STATUS RPC_ENTRY
I_RpcBindingCopy(IN RPC_BINDING_HANDLE SourceBinding,
                 OUT RPC_BINDING_HANDLE __RPC_FAR *DestinationBinding);

RPCRTAPI
RPC_STATUS
RPC_ENTRY
I_RpcBindingIsClientLocal(IN OPTIONAL RPC_BINDING_HANDLE BindingHandle,
                          OUT unsigned int __RPC_FAR *ClientLocalFlag);

RPCRTAPI
RPC_STATUS
RPC_ENTRY
I_RpcBindingInqConnId(IN RPC_BINDING_HANDLE Binding, OUT void **ConnId,
                      OUT int *pfFirstCall);

RPCRTAPI
RPC_STATUS
RPC_ENTRY
I_RpcBindingCreateNP(_In_ RPC_WSTR ServerName, _In_ RPC_WSTR ServiceName,
...
I_RpcServerSetAddressChangeFn(IN RPC_ADDRESS_CHANGE_FN *pAddressChangeFn);
...
RPC_STATUS
RPC_ENTRY
I_RpcServerInqLocalConnAddress(IN RPC_BINDING_HANDLE Binding,
                               IN OUT void *Buffer,
...
RPC_STATUS
RPC_ENTRY
I_RpcServerInqRemoteConnAddress(IN RPC_BINDING_HANDLE Binding,
                                IN OUT void *Buffer,
                                IN OUT unsigned long *BufferSize,
                                OUT unsigned long *AddressFormat);

RPCRTAPI
void RPC_ENTRY I_RpcSessionStrictContextHandle(void);
...
RPCRTAPI
_Must_inspect_result_ RPC_STATUS RPC_ENTRY I_RpcConnectionSetSockBuffSize(
    IN unsigned long RecvBuffSize, IN unsigned long SendBuffSize);

typedef void (*RPCLT_PDU_FILTER_FUNC)(IN void *Buffer,
...
RPCRTAPI
_Must_inspect_result_ RPC_STATUS RPC_ENTRY I_RpcServerStopListening(void);

typedef RPC_STATUS (*RPC_BLOCKING_FN)(IN void *hWnd, IN void *Context,
                                      IN OPTIONAL void *hSyncEvent);

RPCRTAPI
_Must_inspect_result_ RPC_STATUS RPC_ENTRY
I_RpcBindingSetAsync(IN RPC_BINDING_HANDLE Binding,
                     IN RPC_BLOCKING_FN BlockingFn, IN unsigned long ServerTid);

RPCRTAPI
_Must_inspect_result_ RPC_STATUS RPC_ENTRY
I_RpcSetThreadParams(IN int fClientFree, IN OPTIONAL void *Context,
                     IN OPTIONAL void *hWndClient);

RPCRTAPI
unsigned int RPC_ENTRY I_RpcWindowProc(IN void *hWnd, IN unsigned int Message,
                                       IN unsigned int wParam,
                                       IN unsigned long lParam);

RPCRTAPI
_Must_inspect_result_ RPC_STATUS RPC_ENTRY
I_RpcServerUnregisterEndpointA(_In_ RPC_CSTR Protseq, _In_ RPC_CSTR Endpoint);

RPCRTAPI
_Must_inspect_result_ RPC_STATUS RPC_ENTRY
I_RpcServerUnregisterEndpointW(_In_ RPC_WSTR Protseq, _In_ RPC_WSTR Endpoint);
...
typedef struct _RDR_CALLOUT_STATE {
  ...
  void *CertContext; // Contains PCCERT_CONTEXT if cert is used for
                     // authentication. NULL otherwise. If allocated,
                     // CertFreeCertificateContext needs to be called on it when
                     // done
} RDR_CALLOUT_STATE;
#endif // (NTDDI_VERSION >= NTDDI_WS03)
...
typedef RPC_STATUS(RPC_ENTRY *I_RpcProxyIsValidMachineFn)(
    _In_ RPC_WSTR Machine, _In_ RPC_WSTR DotMachine,
...
typedef RPC_STATUS(RPC_ENTRY *I_RpcPerformCalloutFn)(
    IN void *Context, IN RDR_CALLOUT_STATE *CallOutState,
...
typedef RPC_STATUS(RPC_ENTRY *I_RpcProxyGetClientSessionAndResourceUUID)(
    _In_ void *Context, _Out_opt_ int *SessionIdPresent,
    _Out_opt_ UUID *SessionId, _Out_ int *ResourceIdPresent,
...
typedef RPC_STATUS(RPC_ENTRY *I_RpcProxyFilterIfFn)(
    _In_ void *Context, _In_ UUID *IfUuid, _In_ unsigned short IfMajorVersion,
    _Out_ int *fAllow);

typedef enum RpcProxyPerfCounters {
  RpcCurrentUniqueUser = 1,     // Current Number of Unique Users
  RpcBackEndConnectionAttempts, // Number of Back-End Connection Attempts per
                                // Second
  RpcBackEndConnectionFailed,   // Number of Failed Back-End Connection Attempts
                                // per Second
  RpcRequestsPerSecond,         // RPC/HTTP Requests per Second
  RpcIncomingConnections,       // Current Number of Incoming RPC over HTTP
                                // Connections
  ...
  RpcAttemptedLbsMessages,  // Attempted RPC Load Balancing Broker Requests per
                            // Second
...
typedef void(RPC_ENTRY *I_RpcProxyUpdatePerfCounterFn)(
    _In_ RpcPerfCounters Counter, _In_ int ModifyTrend,
    _In_ unsigned long Size);

typedef void(RPC_ENTRY *I_RpcProxyUpdatePerfCounterBackendServerFn)(
    _In_ unsigned short *MachineName, _In_ int IsConnectEvent);
...
RPC_STATUS
RPC_ENTRY
I_RpcProxyNewConnection(IN unsigned long ConnectionType,
...
RPC_STATUS
RPC_ENTRY
I_RpcReplyToClientWithStatus(IN void *ConnectionParameter,
                             IN RPC_STATUS RpcStatus);

RPCRTAPI
void RPC_ENTRY I_RpcRecordCalloutFailure(IN RPC_STATUS RpcStatus,
                                         IN RDR_CALLOUT_STATE *CallOutState,
...
RPC_STATUS
RPC_ENTRY
I_RpcGetDefaultSD(_Out_ void __RPC_FAR **ppSecurityDescriptor);
#endif // (NTDDI_VERSION >= NTDDI_WIN7)
...
RPC_STATUS
RPC_ENTRY
I_RpcOpenClientProcess(_In_opt_ RPC_BINDING_HANDLE Binding,
...
RPC_STATUS
RPC_ENTRY
I_RpcBindingIsServerLocal(_In_ RPC_BINDING_HANDLE Binding,
                          _Out_ unsigned int *ServerLocalFlag);

RPC_STATUS RPC_ENTRY I_RpcBindingSetPrivateOption(
    _In_ RPC_BINDING_HANDLE hBinding, _In_ unsigned long option,
...
I_RpcServerSubscribeForDisconnectNotification(
    _In_opt_ RPC_BINDING_HANDLE Binding, _In_opt_ void *hEvent);

RPC_STATUS
RPC_ENTRY
I_RpcServerGetAssociationID(_In_opt_ RPC_BINDING_HANDLE Binding,
                            _Out_ unsigned long *AssociationID);

RPCRTAPI
long RPC_ENTRY I_RpcServerDisableExceptionFilter(void);
...
I_RpcServerSubscribeForDisconnectNotification2(
    _In_opt_ RPC_BINDING_HANDLE Binding, _In_ void *hEvent,
    _Out_ UUID *SubscriptionId);

RPC_STATUS
RPC_ENTRY
I_RpcServerUnsubscribeForDisconnectNotification(
    _In_opt_ RPC_BINDING_HANDLE Binding, _In_ UUID SubscriptionId);
...
#define I_RRPCUNINITIALIZENDROLE_EXPORT_NAME                                   \
  reinterpret_cast<LPCSTR>(static_cast<ULONG_PTR>(1000))
#else
