...
typedef /* [v1_enum] */
    enum FWP_NETWORK_CONNECTION_POLICY_SETTING_TYPE_ {
      ...
      FWP_NETWORK_CONNECTION_POLICY_NEXT_HOP_INTERFACE =
          (FWP_NETWORK_CONNECTION_POLICY_SOURCE_ADDRESS + 1),
      ...
      FWP_NETWORK_CONNECTION_POLICY_MAX =
          (FWP_NETWORK_CONNECTION_POLICY_NEXT_HOP + 1)
...
typedef /* [v1_enum] */
    enum FWP_VSWITCH_NETWORK_TYPE_ {
      ...
      FWP_VSWITCH_NETWORK_TYPE_EXTERNAL =
          (FWP_VSWITCH_NETWORK_TYPE_INTERNAL + 1)
