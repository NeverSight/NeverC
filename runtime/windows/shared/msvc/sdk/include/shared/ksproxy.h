...
DECLARE_INTERFACE_(IKsClockPropertySet, IUnknown) {
  STDMETHOD(KsGetTime)(THIS_ _Out_ LONGLONG * Time) PURE;
  STDMETHOD(KsSetTime)(THIS_ _In_ LONGLONG Time) PURE;
  STDMETHOD(KsGetPhysicalTime)(THIS_ _Out_ LONGLONG * Time) PURE;
  STDMETHOD(KsSetPhysicalTime)(THIS_ _In_ LONGLONG Time) PURE;
  STDMETHOD(KsGetCorrelatedTime)(THIS_ _Out_ KSCORRELATED_TIME * CorrelatedTime)
      PURE;
  STDMETHOD(KsSetCorrelatedTime)(THIS_ _In_ KSCORRELATED_TIME * CorrelatedTime)
      PURE;
  STDMETHOD(KsGetCorrelatedPhysicalTime)(THIS_ _Out_ KSCORRELATED_TIME *
                                         CorrelatedTime) PURE;
  STDMETHOD(KsSetCorrelatedPhysicalTime)(THIS_ _In_ KSCORRELATED_TIME *
                                         CorrelatedTime) PURE;
  STDMETHOD(KsGetResolution)(THIS_ _Out_ KSRESOLUTION * Resolution) PURE;
  STDMETHOD(KsGetState)(THIS_ _Out_ KSSTATE * State) PURE;
};
...
DECLARE_INTERFACE_(IKsAllocator, IUnknown) {
  ...
  STDMETHOD(KsGetAllocatorStatus)(
      THIS_ _Out_ PKSSTREAMALLOCATOR_STATUS AllocatorStatus) PURE;
  STDMETHOD_(VOID, KsSetAllocatorMode)(THIS_ _In_ KSALLOCATORMODE Mode) PURE;
};
...
DECLARE_INTERFACE_(IKsAllocatorEx, IKsAllocator) {
  ...
  STDMETHOD_(VOID, KsSetProperties)(THIS_ _In_ PALLOCATOR_PROPERTIES_EX) PURE;
  STDMETHOD_(VOID, KsSetAllocatorHandle)(THIS_ _In_ HANDLE AllocatorHandle)
      PURE;
  STDMETHOD_(HANDLE, KsCreateAllocatorAndGetHandle)(THIS_ _In_ IKsPin * KsPin)
      PURE;
};
...
DECLARE_INTERFACE_(IKsPin, IUnknown) {
  STDMETHOD(KsQueryMediums)(THIS_ _Outptr_ PKSMULTIPLE_ITEM * MediumList) PURE;
  STDMETHOD(KsQueryInterfaces)(THIS_ _Outptr_ PKSMULTIPLE_ITEM * InterfaceList)
      PURE;
  STDMETHOD(KsCreateSinkPinHandle)(THIS_ _In_ KSPIN_INTERFACE & Interface,
                                   _In_ KSPIN_MEDIUM & Medium) PURE;
  STDMETHOD(KsGetCurrentCommunication)(THIS_ _Out_opt_ KSPIN_COMMUNICATION *
                                           Communication,
                                       _Out_opt_ KSPIN_INTERFACE * Interface,
                                       _Out_opt_ KSPIN_MEDIUM * Medium) PURE;
  STDMETHOD(KsPropagateAcquire)(THIS) PURE;
  STDMETHOD(KsDeliver)(THIS_ _In_ IMediaSample * Sample, _In_ ULONG Flags) PURE;
  STDMETHOD(KsMediaSamplesCompleted)(THIS_ _In_ PKSSTREAM_SEGMENT StreamSegment)
      PURE;
  STDMETHOD_(IMemAllocator *,
             KsPeekAllocator)(THIS_ _In_ KSPEEKOPERATION Operation) PURE;
  STDMETHOD(KsReceiveAllocator)(THIS_ _In_opt_ IMemAllocator * MemAllocator)
      PURE;
  ...
  STDMETHOD(KsQualityNotify)(THIS_ _In_ ULONG Proportion,
                             _In_ REFERENCE_TIME TimeDelta) PURE;
};
...
DECLARE_INTERFACE_(IKsPinEx, IKsPin) {
  STDMETHOD_(VOID, KsNotifyError)(THIS_ _In_ IMediaSample * Sample,
                                  _In_ HRESULT hr) PURE;
};
...
DECLARE_INTERFACE_(IKsPinPipe, IUnknown) {
  STDMETHOD(KsGetPinFramingCache)(
      THIS_ _Out_ PKSALLOCATOR_FRAMING_EX * FramingEx,
      _Out_ PFRAMING_PROP FramingProp, _In_ FRAMING_CACHE_OPS Option) PURE;
  STDMETHOD(KsSetPinFramingCache)(THIS_ _In_ PKSALLOCATOR_FRAMING_EX FramingEx,
                                  _In_ PFRAMING_PROP FramingProp,
                                  _In_ FRAMING_CACHE_OPS Option) PURE;
  STDMETHOD_(IPin *, KsGetConnectedPin)(THIS) PURE;
  STDMETHOD_(IKsAllocatorEx *, KsGetPipe)(THIS_ _In_ KSPEEKOPERATION Operation)
      PURE;
  STDMETHOD(KsSetPipe)(THIS_ _In_ IKsAllocatorEx * KsAllocator) PURE;
  STDMETHOD_(ULONG, KsGetPipeAllocatorFlag)(THIS) PURE;
  STDMETHOD(KsSetPipeAllocatorFlag)(THIS_ _In_ ULONG Flag) PURE;
  STDMETHOD_(GUID, KsGetPinBusCache)(THIS) PURE;
  STDMETHOD(KsSetPinBusCache)(THIS_ _In_ GUID Bus) PURE;
  //
...
DECLARE_INTERFACE_(IKsPinFactory, IUnknown) {
  STDMETHOD(KsPinFactory)(THIS_ _Out_ ULONG * PinFactory) PURE;
};
...
DECLARE_INTERFACE_(IKsDataTypeHandler, IUnknown) {
  STDMETHOD(KsCompleteIoOperation)(
      THIS_ _Inout_ IMediaSample * Sample, _Inout_ PVOID StreamHeader,
      _In_ KSIOOPERATION IoOperation, _In_ BOOL Cancelled) PURE;
  STDMETHOD(KsIsMediaTypeInRanges)(THIS_ _In_ PVOID DataRanges) PURE;
  STDMETHOD(KsPrepareIoOperation)(THIS_ _Inout_ IMediaSample * Sample,
                                  _Inout_ PVOID StreamHeader,
                                  _In_ KSIOOPERATION IoOperation) PURE;
  STDMETHOD(KsQueryExtendedSize)(THIS_ _Out_ ULONG * ExtendedSize) PURE;
  STDMETHOD(KsSetMediaType)(THIS_ _In_ const AM_MEDIA_TYPE *AmMediaType) PURE;
};
...
DECLARE_INTERFACE_(IKsDataTypeCompletion, IUnknown) {
  STDMETHOD(KsCompleteMediaType)(THIS_ _In_ HANDLE FilterHandle,
                                 _In_ ULONG PinFactoryId,
                                 _Inout_ AM_MEDIA_TYPE * AmMediaType) PURE;
};
...
DECLARE_INTERFACE_(IKsInterfaceHandler, IUnknown) {
  STDMETHOD(KsSetPin)(THIS_ _In_ IKsPin * KsPin) PURE;
  STDMETHOD(KsProcessMediaSamples)(
      THIS_ _In_ IKsDataTypeHandler * KsDataTypeHandler,
      _In_reads_(SampleCount) IMediaSample * *SampleList,
      _Inout_ PLONG SampleCount, _In_ KSIOOPERATION IoOperation,
      _Out_ PKSSTREAM_SEGMENT * StreamSegment) PURE;
  STDMETHOD(KsCompleteIo)(THIS_ _Inout_ PKSSTREAM_SEGMENT StreamSegment) PURE;
};
...
DECLARE_INTERFACE_(IKsQualityForwarder, IKsObject) {
  STDMETHOD_(VOID, KsFlushClient)(THIS_ _In_ IKsPin * Pin) PURE;
};
...
DECLARE_INTERFACE_(IKsNotifyEvent, IUnknown) {
  STDMETHOD(KsNotifyEvent)(THIS_ _In_ ULONG Event, _In_ ULONG_PTR lParam1,
                           _In_ ULONG_PTR lParam2) PURE;
};
...
HRESULT
WINAPI
KsResolveRequiredAttributes(_In_ PKSDATARANGE DataRange,
                            _In_opt_ PKSMULTIPLE_ITEM Attributes);

KSDDKAPI
HRESULT
WINAPI
KsOpenDefaultDevice(_In_ REFGUID Category, _In_ ACCESS_MASK Access,
                    _Out_ PHANDLE DeviceHandle);
KSDDKAPI
HRESULT
WINAPI
KsSynchronousDeviceControl(_In_ HANDLE Handle, _In_ ULONG IoControl,
...
HRESULT
WINAPI
KsGetMultiplePinFactoryItems(_In_ HANDLE FilterHandle, _In_ ULONG PinFactoryId,
                             _In_ ULONG PropertyId, _Outptr_ PVOID *Items);
KSDDKAPI
HRESULT
WINAPI
KsGetMediaTypeCount(_In_ HANDLE FilterHandle, _In_ ULONG PinFactoryId,
                    _Out_ ULONG *MediaTypeCount);
KSDDKAPI
HRESULT
WINAPI
KsGetMediaType(_In_ int Position, _Out_ AM_MEDIA_TYPE *AmMediaType,
               _In_ HANDLE FilterHandle, _In_ ULONG PinFactoryId);
...
DECLARE_INTERFACE_(IKsPropertySet, IUnknown) {
  STDMETHOD(Set)(THIS_ _In_ REFGUID PropSet, _In_ ULONG Id,
                 ...
                 _In_ ULONG DataLength) PURE;

  STDMETHOD(Get)(THIS_ _In_ REFGUID PropSet, _In_ ULONG Id,
                 _In_reads_bytes_(InstanceLength) LPVOID InstanceData,
                 _In_ ULONG InstanceLength,
                 _Out_writes_bytes_(DataLength) LPVOID PropertyData,
                 _In_ ULONG DataLength, _Out_ ULONG * BytesReturned) PURE;

  STDMETHOD(QuerySupported)(THIS_ _In_ REFGUID PropSet, _In_ ULONG Id,
                            _Out_ ULONG * TypeSupport) PURE;
};
...
DECLARE_INTERFACE_(IKsControl, IUnknown) {
  STDMETHOD(KsProperty)(
      ...
      _In_ ULONG DataLength, _Inout_opt_ ULONG * BytesReturned) PURE;
  STDMETHOD(KsMethod)(THIS_ _In_reads_bytes_(MethodLength) PKSMETHOD Method,
                      _In_ ULONG MethodLength,
                      _Inout_updates_bytes_(DataLength) LPVOID MethodData,
                      _In_ ULONG DataLength, _Inout_opt_ ULONG * BytesReturned)
      PURE;
  STDMETHOD(KsEvent)(THIS_ _In_reads_bytes_opt_(EventLength) PKSEVENT Event,
...
DECLARE_INTERFACE_(IKsAggregateControl, IUnknown) {
  STDMETHOD(KsAddAggregate)(THIS_ _In_ REFGUID AggregateClass) PURE;
  STDMETHOD(KsRemoveAggregate)(THIS_ _In_ REFGUID AggregateClass) PURE;
};
...
DECLARE_INTERFACE_(IKsTopology, IUnknown) {
  STDMETHOD(CreateNodeInstance)(
      THIS_ _In_ ULONG NodeId, _In_ ULONG Flags, _In_ ACCESS_MASK DesiredAccess,
      _In_opt_ IUnknown * UnkOuter, _In_ REFGUID InterfaceId,
      _Out_ LPVOID * Interface) PURE;
};
