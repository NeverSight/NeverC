...
#define CLSCTX_VALID_MASK                                                      \
  (CLSCTX_INPROC_SERVER | CLSCTX_INPROC_HANDLER | CLSCTX_LOCAL_SERVER |        \
   ...
   CLSCTX_FROM_DEFAULT_CONTEXT | CLSCTX_ACTIVATE_X86_SERVER |                  \
   CLSCTX_ACTIVATE_64_BIT_SERVER | CLSCTX_ENABLE_CLOAKING |                    \
   CLSCTX_APPCONTAINER | CLSCTX_ACTIVATE_AAA_AS_IU | CLSCTX_RESERVED6 |        \
   CLSCTX_ACTIVATE_ARM32_SERVER | CLSCTX_ALLOW_LOWER_TRUST_REGISTRATION |      \
   CLSCTX_DO_NOT_ELEVATE_SERVER |                                              \
   CLSCTX_SERVER_MUST_BE_EQUAL_OR_GREATER_PRIVILEGE | CLSCTX_PS_DLL)
...
typedef /* [unique] */ __RPC_unique_pointer FLAGGED_BYTE_BLOB
...
typedef /* [unique] */ __RPC_unique_pointer FLAGGED_WORD_BLOB
