...
#if !defined(_W64)
#if !defined(__midl) &&                                                        \
    (defined(_X86_) || defined(_M_IX86) || defined(_ARM_) ||                   \
     defined(_M_ARM)) &&                                                       \
    (_MSC_VER >= 1300)
#define _W64 __w64
#else
...
#if !defined(_M_CEE) && ((defined(_M_X64) && !defined(_M_ARM64EC)) ||          \
                         (defined(_ARM64_MULT_INTRINS_SUPPORTED) &&            \
...
ULONG64
__UnsignedMultiply128(_In_ ULONG64 Multiplicand, _In_ ULONG64 Multiplier,
                      _Out_ _Deref_out_range_(==, Multiplicand *Multiplier)
                          ULONG64 *HighProduct);
...
ULONG64
__umulh(_In_ ULONG64 Multiplicand, _In_ ULONG64 Multiplier);
...
#define INTSAFE_E_ARITHMETIC_OVERFLOW                                          \
  ((HRESULT)0x80070216L) // 0x216 = 534 = ERROR_ARITHMETIC_OVERFLOW
#ifndef SORTPP_PASS
...
//
_Must_inspect_result_ __inline HRESULT
Int8ToUChar(_In_ INT8 i8Operand,
...
//
_Must_inspect_result_ __inline HRESULT
Int8ToUInt8(_In_ INT8 i8Operand,
...
//
_Must_inspect_result_ __inline HRESULT
Int8ToUShort(_In_ INT8 i8Operand,
...
//
_Must_inspect_result_ __inline HRESULT
Int8ToUInt(_In_ INT8 i8Operand,
...
//
_Must_inspect_result_ __inline HRESULT
Int8ToUIntPtr(_In_ INT8 i8Operand,
...
//
_Must_inspect_result_ __inline HRESULT
Int8ToULong(_In_ INT8 i8Operand,
...
//
_Must_inspect_result_ __inline HRESULT
Int8ToULongPtr(_In_ INT8 i8Operand,
...
//
_Must_inspect_result_ __inline HRESULT
Int8ToULongLong(_In_ INT8 i8Operand,
...
//
_Must_inspect_result_ __inline HRESULT
UInt8ToInt8(_In_ UINT8 u8Operand,
...
//
__forceinline HRESULT UInt8ToChar(_In_ UINT8 u8Operand,
                                  _Out_ _Deref_out_range_(==, u8Operand)
                                      CHAR *pch) {
...
//
__forceinline HRESULT ByteToChar(_In_ BYTE bOperand,
                                 _Out_ _Deref_out_range_(==, bOperand)
                                     CHAR *pch) {
#ifdef _CHAR_UNSIGNED
  *pch = (CHAR)bOperand;
  return S_OK;
...
//
_Must_inspect_result_ __inline HRESULT
ShortToInt8(_In_ SHORT sOperand,
...
//
_Must_inspect_result_ __inline HRESULT
ShortToUChar(_In_ SHORT sOperand,
...
//
__forceinline HRESULT ShortToChar(_In_ SHORT sOperand,
                                  _Out_ _Deref_out_range_(==, sOperand)
                                      CHAR *pch) {
#ifdef _CHAR_UNSIGNED
...
//
_Must_inspect_result_ __inline HRESULT
ShortToUInt8(_In_ SHORT sOperand,
...
//
_Must_inspect_result_ __inline HRESULT
ShortToUShort(_In_ SHORT sOperand,
...
//
_Must_inspect_result_ __inline HRESULT
ShortToUInt(_In_ SHORT sOperand,
...
//
_Must_inspect_result_ __inline HRESULT
ShortToUIntPtr(_In_ SHORT sOperand,
...
//
_Must_inspect_result_ __inline HRESULT
ShortToULong(_In_ SHORT sOperand,
...
//
_Must_inspect_result_ __inline HRESULT
ShortToULongPtr(_In_ SHORT sOperand,
...
//
_Must_inspect_result_ __inline HRESULT
ShortToDWordPtr(_In_ SHORT sOperand,
...
//
_Must_inspect_result_ __inline HRESULT
ShortToULongLong(_In_ SHORT sOperand,
...
//
_Must_inspect_result_ __inline HRESULT
UShortToInt8(_In_ USHORT usOperand,
...
//
_Must_inspect_result_ __inline HRESULT
UShortToUChar(_In_ USHORT usOperand,
...
//
__forceinline HRESULT UShortToChar(_In_ USHORT usOperand,
                                   _Out_ _Deref_out_range_(==, usOperand)
                                       CHAR *pch) {
#ifdef _CHAR_UNSIGNED
...
//
_Must_inspect_result_ __inline HRESULT
UShortToUInt8(_In_ USHORT usOperand,
...
//
_Must_inspect_result_ __inline HRESULT
UShortToShort(_In_ USHORT usOperand,
...
IntToChar(_In_ INT iOperand, _Out_ _Deref_out_range_(==, iOperand) CHAR *pch) {
#ifdef _CHAR_UNSIGNED
...
//
_Must_inspect_result_ __inline HRESULT
IntToULongLong(_In_ INT iOperand,
...
//
_Must_inspect_result_ __inline HRESULT
IntPtrToInt8(_In_ INT_PTR iOperand,
             _Out_ _Deref_out_range_(==, iOperand) INT8 *pi8Result) {
  HRESULT hr;
...
//
_Must_inspect_result_ __inline HRESULT
IntPtrToUChar(_In_ INT_PTR iOperand,
              _Out_ _Deref_out_range_(==, iOperand) UCHAR *pch) {
  HRESULT hr;
...
//
__forceinline HRESULT IntPtrToChar(_In_ INT_PTR iOperand,
                                   _Out_ _Deref_out_range_(==, iOperand)
                                       CHAR *pch) {
#ifdef _CHAR_UNSIGNED
...
//
_Must_inspect_result_ __inline HRESULT
IntPtrToUInt8(_In_ INT_PTR iOperand,
              _Out_ _Deref_out_range_(==, iOperand) UINT8 *pui8Result) {
  HRESULT hr;
...
//
_Must_inspect_result_ __inline HRESULT
IntPtrToShort(_In_ INT_PTR iOperand,
              _Out_ _Deref_out_range_(==, iOperand) SHORT *psResult) {
  HRESULT hr;
...
//
_Must_inspect_result_ __inline HRESULT
IntPtrToUShort(_In_ INT_PTR iOperand,
               _Out_ _Deref_out_range_(==, iOperand) USHORT *pusResult) {
  HRESULT hr;
...
#else
_Must_inspect_result_ __inline HRESULT
IntPtrToInt(_In_ INT_PTR iOperand,
...
#else
_Must_inspect_result_ __inline HRESULT
IntPtrToUInt(_In_ INT_PTR iOperand,
             _Out_ _Deref_out_range_(==, iOperand) UINT *puResult) {
  HRESULT hr;
...
#else
_Must_inspect_result_ __inline HRESULT
IntPtrToUIntPtr(_In_ INT_PTR iOperand,
...
#else
_Must_inspect_result_ __inline HRESULT
IntPtrToLong(_In_ INT_PTR iOperand,
...
//
_Must_inspect_result_ __inline HRESULT
IntPtrToLongPtr(_In_ INT_PTR iOperand,
...
#else
_Must_inspect_result_ __inline HRESULT
IntPtrToULong(_In_ INT_PTR iOperand,
              _Out_ _Deref_out_range_(==, iOperand) ULONG *pulResult) {
  HRESULT hr;
...
#else
_Must_inspect_result_ __inline HRESULT
IntPtrToULongPtr(_In_ INT_PTR iOperand,
...
#else
_Must_inspect_result_ __inline HRESULT
IntPtrToULongLong(_In_ INT_PTR iOperand,
                  _Out_ _Deref_out_range_(==, iOperand) ULONGLONG *pullResult) {
  HRESULT hr;
...
//
_Must_inspect_result_ __inline HRESULT
UIntToUChar(_In_ UINT uOperand,
...
//
__forceinline HRESULT UIntToChar(_In_ UINT uOperand,
                                 _Out_ _Deref_out_range_(==, uOperand)
                                     CHAR *pch) {
#ifdef _CHAR_UNSIGNED
...
//
_Must_inspect_result_ __inline HRESULT
UIntToUInt8(_In_ UINT uOperand,
...
//
_Must_inspect_result_ __inline HRESULT
UIntToShort(_In_ UINT uOperand,
...
//
_Must_inspect_result_ __inline HRESULT
UIntToUShort(_In_ UINT uOperand,
...
#ifdef _WIN64
_Must_inspect_result_ __inline HRESULT
UIntToIntPtr(_In_ UINT uOperand,
...
#ifdef _WIN64
_Must_inspect_result_ __inline HRESULT
UIntToLongPtr(_In_ UINT uOperand,
...
//
_Must_inspect_result_ __inline HRESULT
UIntPtrToInt8(_In_ UINT_PTR uOperand,
              _Out_ _Deref_out_range_(==, uOperand) INT8 *pi8Result) {
  HRESULT hr;
...
//
_Must_inspect_result_ __inline HRESULT
UIntPtrToUChar(_In_ UINT_PTR uOperand,
               _Out_ _Deref_out_range_(==, uOperand) UCHAR *pch) {
  HRESULT hr;
...
//
__forceinline HRESULT UIntPtrToChar(_In_ UINT_PTR uOperand,
                                    _Out_ _Deref_out_range_(==, uOperand)
                                        CHAR *pch) {
#ifdef _CHAR_UNSIGNED
...
//
_Must_inspect_result_ __inline HRESULT
UIntPtrToUInt8(_In_ UINT_PTR uOperand,
...
//
_Must_inspect_result_ __inline HRESULT
UIntPtrToShort(_In_ UINT_PTR uOperand,
               _Out_ _Deref_out_range_(==, uOperand) SHORT *psResult) {
  HRESULT hr;
...
//
_Must_inspect_result_ __inline HRESULT
UIntPtrToInt16(_In_ UINT_PTR uOperand,
...
//
_Must_inspect_result_ __inline HRESULT
UIntPtrToUShort(_In_ UINT_PTR uOperand,
                _Out_ _Deref_out_range_(==, uOperand) USHORT *pusResult) {
  HRESULT hr;
...
//
_Must_inspect_result_ __inline HRESULT
UIntPtrToUInt16(_In_ UINT_PTR uOperand,
...
//
_Must_inspect_result_ __inline HRESULT
UIntPtrToInt(_In_ UINT_PTR uOperand,
             _Out_ _Deref_out_range_(==, uOperand) INT *piResult) {
  HRESULT hr;
...
//
_Must_inspect_result_ __inline HRESULT
UIntPtrToIntPtr(_In_ UINT_PTR uOperand,
                _Out_ _Deref_out_range_(==, uOperand) INT_PTR *piResult) {
  HRESULT hr;
...
#else
_Must_inspect_result_ __inline HRESULT
UIntPtrToUInt(_In_ UINT_PTR uOperand,
...
//
_Must_inspect_result_ __inline HRESULT
UIntPtrToLong(_In_ UINT_PTR uOperand,
              _Out_ _Deref_out_range_(==, uOperand) LONG *plResult) {
  HRESULT hr;
...
//
_Must_inspect_result_ __inline HRESULT
UIntPtrToLongPtr(_In_ UINT_PTR uOperand,
                 _Out_ _Deref_out_range_(==, uOperand) LONG_PTR *plResult) {
  HRESULT hr;
...
#else
_Must_inspect_result_ __inline HRESULT
UIntPtrToULong(_In_ UINT_PTR uOperand,
...
#else
_Must_inspect_result_ __inline HRESULT
UIntPtrToLongLong(_In_ UINT_PTR uOperand,
...
//
_Must_inspect_result_ __inline HRESULT
LongToUChar(_In_ LONG lOperand,
...
//
__forceinline HRESULT LongToChar(_In_ LONG lOperand,
                                 _Out_ _Deref_out_range_(==, lOperand)
                                     CHAR *pch) {
#ifdef _CHAR_UNSIGNED
...
//
_Must_inspect_result_ __inline HRESULT
LongToUInt8(_In_ LONG lOperand,
...
//
_Must_inspect_result_ __inline HRESULT
LongToShort(_In_ LONG lOperand,
...
//
_Must_inspect_result_ __inline HRESULT
LongToUShort(_In_ LONG lOperand,
...
#ifdef _WIN64
_Must_inspect_result_ __inline HRESULT
LongToIntPtr(_In_ LONG lOperand,
...
#ifdef _WIN64
_Must_inspect_result_ __inline HRESULT
LongToUIntPtr(_In_ LONG lOperand,
...
//
_Must_inspect_result_ __inline HRESULT
LongToULong(_In_ LONG lOperand,
...
#ifdef _WIN64
_Must_inspect_result_ __inline HRESULT
LongToULongPtr(_In_ LONG lOperand,
...
//
_Must_inspect_result_ __inline HRESULT
LongToULongLong(_In_ LONG lOperand,
...
//
_Must_inspect_result_ __inline HRESULT
LongPtrToInt8(_In_ LONG_PTR lOperand,
              _Out_ _Deref_out_range_(==, lOperand) INT8 *pi8Result) {
  HRESULT hr;
...
//
_Must_inspect_result_ __inline HRESULT
LongPtrToUChar(_In_ LONG_PTR lOperand,
               _Out_ _Deref_out_range_(==, lOperand) UCHAR *pch) {
  HRESULT hr;
...
//
__forceinline HRESULT LongPtrToChar(_In_ LONG_PTR lOperand,
                                    _Out_ _Deref_out_range_(==, lOperand)
                                        CHAR *pch) {
#ifdef _CHAR_UNSIGNED
...
//
_Must_inspect_result_ __inline HRESULT
LongPtrToUInt8(_In_ LONG_PTR lOperand,
               _Out_ _Deref_out_range_(==, lOperand) UINT8 *pui8Result) {
  HRESULT hr;
...
//
_Must_inspect_result_ __inline HRESULT
LongPtrToShort(_In_ LONG_PTR lOperand,
               _Out_ _Deref_out_range_(==, lOperand) SHORT *psResult) {
  HRESULT hr;
...
//
_Must_inspect_result_ __inline HRESULT
LongPtrToUShort(_In_ LONG_PTR lOperand,
                _Out_ _Deref_out_range_(==, lOperand) USHORT *pusResult) {
  HRESULT hr;
...
#else
_Must_inspect_result_ __inline HRESULT
LongPtrToInt(_In_ LONG_PTR lOperand,
             _Out_ _Deref_out_range_(==, lOperand) INT *piResult) {
...
//
_Must_inspect_result_ __inline HRESULT
LongPtrToIntPtr(_In_ LONG_PTR lOperand,
                _Out_ _Deref_out_range_(==, lOperand) INT_PTR *piResult) {
...
#else
_Must_inspect_result_ __inline HRESULT
LongPtrToUInt(_In_ LONG_PTR lOperand,
              _Out_ _Deref_out_range_(==, lOperand) UINT *puResult) {
  HRESULT hr;
...
//
_Must_inspect_result_ __inline HRESULT
LongPtrToUIntPtr(_In_ LONG_PTR lOperand,
                 _Out_ _Deref_out_range_(==, lOperand) UINT_PTR *puResult) {
  HRESULT hr;
...
#else
_Must_inspect_result_ __inline HRESULT
LongPtrToLong(_In_ LONG_PTR lOperand,
...
#else
_Must_inspect_result_ __inline HRESULT
LongPtrToULong(_In_ LONG_PTR lOperand,
               _Out_ _Deref_out_range_(==, lOperand) ULONG *pulResult) {
  HRESULT hr;
...
//
_Must_inspect_result_ __inline HRESULT
LongPtrToULongPtr(_In_ LONG_PTR lOperand,
                  _Out_ _Deref_out_range_(==, lOperand) ULONG_PTR *pulResult) {
  HRESULT hr;
...
//
_Must_inspect_result_ __inline HRESULT
LongPtrToULongLong(_In_ LONG_PTR lOperand, _Out_ _Deref_out_range_(==, lOperand)
...
//
_Must_inspect_result_ __inline HRESULT
ULongToInt8(_In_ ULONG ulOperand,
...
//
_Must_inspect_result_ __inline HRESULT
ULongToUChar(_In_ ULONG ulOperand,
...
//
__forceinline HRESULT ULongToChar(_In_ ULONG ulOperand,
                                  _Out_ _Deref_out_range_(==, ulOperand)
                                      CHAR *pch) {
#ifdef _CHAR_UNSIGNED
...
//
_Must_inspect_result_ __inline HRESULT
ULongToUInt8(_In_ ULONG ulOperand,
...
//
_Must_inspect_result_ __inline HRESULT
ULongToShort(_In_ ULONG ulOperand,
...
//
_Must_inspect_result_ __inline HRESULT
ULongToUShort(_In_ ULONG ulOperand,
...
//
_Must_inspect_result_ __inline HRESULT
ULongToInt(_In_ ULONG ulOperand,
...
#ifdef _WIN64
_Must_inspect_result_ __inline HRESULT
ULongToIntPtr(_In_ ULONG ulOperand,
...
//
_Must_inspect_result_ __inline HRESULT
ULongToUInt(_In_ ULONG ulOperand,
...
#ifdef _WIN64
_Must_inspect_result_ __inline HRESULT
ULongToUIntPtr(_In_ ULONG ulOperand,
...
//
_Must_inspect_result_ __inline HRESULT
ULongToLong(_In_ ULONG ulOperand,
...
#ifdef _WIN64
_Must_inspect_result_ __inline HRESULT
ULongToLongPtr(_In_ ULONG ulOperand,
...
//
_Must_inspect_result_ __inline HRESULT
ULongPtrToInt8(_In_ ULONG_PTR ulOperand,
               _Out_ _Deref_out_range_(==, ulOperand) INT8 *pi8Result) {
  HRESULT hr;
...
//
_Must_inspect_result_ __inline HRESULT
ULongPtrToUChar(_In_ ULONG_PTR ulOperand,
                _Out_ _Deref_out_range_(==, ulOperand) UCHAR *pch) {
  HRESULT hr;
...
//
__forceinline HRESULT ULongPtrToChar(_In_ ULONG_PTR ulOperand,
                                     _Out_ _Deref_out_range_(==, ulOperand)
                                         CHAR *pch) {
#ifdef _CHAR_UNSIGNED
...
//
_Must_inspect_result_ __inline HRESULT
ULongPtrToUInt8(_In_ ULONG_PTR ulOperand,
                _Out_ _Deref_out_range_(==, ulOperand) UINT8 *pui8Result) {
  HRESULT hr;
...
//
_Must_inspect_result_ __inline HRESULT
ULongPtrToShort(_In_ ULONG_PTR ulOperand,
                _Out_ _Deref_out_range_(==, ulOperand) SHORT *psResult) {
  HRESULT hr;
...
//
_Must_inspect_result_ __inline HRESULT
ULongPtrToUShort(_In_ ULONG_PTR ulOperand,
                 _Out_ _Deref_out_range_(==, ulOperand) USHORT *pusResult) {
  HRESULT hr;
...
//
_Must_inspect_result_ __inline HRESULT
ULongPtrToInt(_In_ ULONG_PTR ulOperand,
              _Out_ _Deref_out_range_(==, ulOperand) INT *piResult) {
  HRESULT hr;
...
//
_Must_inspect_result_ __inline HRESULT
ULongPtrToIntPtr(_In_ ULONG_PTR ulOperand,
                 _Out_ _Deref_out_range_(==, ulOperand) INT_PTR *piResult) {
  HRESULT hr;
...
#else
_Must_inspect_result_ __inline HRESULT
ULongPtrToUInt(_In_ ULONG_PTR ulOperand,
               _Out_ _Deref_out_range_(==, ulOperand) UINT *puResult) {
...
//
_Must_inspect_result_ __inline HRESULT
ULongPtrToUIntPtr(_In_ ULONG_PTR ulOperand,
...
//
_Must_inspect_result_ __inline HRESULT
ULongPtrToLong(_In_ ULONG_PTR ulOperand,
               _Out_ _Deref_out_range_(==, ulOperand) LONG *plResult) {
  HRESULT hr;
...
//
_Must_inspect_result_ __inline HRESULT
ULongPtrToLongPtr(_In_ ULONG_PTR ulOperand,
                  _Out_ _Deref_out_range_(==, ulOperand) LONG_PTR *plResult) {
  HRESULT hr;
...
#else
_Must_inspect_result_ __inline HRESULT
ULongPtrToULong(_In_ ULONG_PTR ulOperand,
...
#else
_Must_inspect_result_ __inline HRESULT
ULongPtrToLongLong(_In_ ULONG_PTR ulOperand,
...
//
_Must_inspect_result_ __inline HRESULT
LongLongToInt8(_In_ LONGLONG llOperand,
...
//
_Must_inspect_result_ __inline HRESULT
LongLongToUChar(_In_ LONGLONG llOperand,
...
//
__forceinline HRESULT LongLongToChar(_In_ LONGLONG llOperand,
                                     _Out_ _Deref_out_range_(==, llOperand)
                                         CHAR *pch) {
#ifdef _CHAR_UNSIGNED
...
//
_Must_inspect_result_ __inline HRESULT
LongLongToUInt8(_In_ LONGLONG llOperand,
...
//
_Must_inspect_result_ __inline HRESULT
LongLongToShort(_In_ LONGLONG llOperand,
...
//
_Must_inspect_result_ __inline HRESULT
LongLongToUShort(_In_ LONGLONG llOperand,
...
//
_Must_inspect_result_ __inline HRESULT
LongLongToInt(_In_ LONGLONG llOperand,
...
#ifdef _WIN64
_Must_inspect_result_ __inline HRESULT
LongLongToIntPtr(_In_ LONGLONG llOperand,
...
//
_Must_inspect_result_ __inline HRESULT
LongLongToUInt(_In_ LONGLONG llOperand,
...
//
_Must_inspect_result_ __inline HRESULT
LongLongToLong(_In_ LONGLONG llOperand,
...
#ifdef _WIN64
_Must_inspect_result_ __inline HRESULT
LongLongToLongPtr(_In_ LONGLONG llOperand,
...
//
_Must_inspect_result_ __inline HRESULT
LongLongToULong(_In_ LONGLONG llOperand,
...
//
_Must_inspect_result_ __inline HRESULT
LongLongToULongLong(_In_ LONGLONG llOperand,
                    _Out_ _Deref_out_range_(==, llOperand)
                        ULONGLONG *pullResult) {
  HRESULT hr;
...
//
_Must_inspect_result_ __inline HRESULT
ULongLongToInt8(_In_ ULONGLONG ullOperand,
...
//
_Must_inspect_result_ __inline HRESULT
ULongLongToUChar(_In_ ULONGLONG ullOperand,
...
//
__forceinline HRESULT ULongLongToChar(_In_ ULONGLONG ullOperand,
                                      _Out_ _Deref_out_range_(==, ullOperand)
                                          CHAR *pch) {
#ifdef _CHAR_UNSIGNED
...
//
_Must_inspect_result_ __inline HRESULT
ULongLongToUInt8(_In_ ULONGLONG ullOperand,
...
//
_Must_inspect_result_ __inline HRESULT
ULongLongToShort(_In_ ULONGLONG ullOperand,
...
//
_Must_inspect_result_ __inline HRESULT
ULongLongToUShort(_In_ ULONGLONG ullOperand,
...
//
_Must_inspect_result_ __inline HRESULT
ULongLongToInt(_In_ ULONGLONG ullOperand,
...
//
_Must_inspect_result_ __inline HRESULT
ULongLongToUInt(_In_ ULONGLONG ullOperand,
...
#ifdef _WIN64
_Must_inspect_result_ __inline HRESULT
ULongLongToUIntPtr(_In_ ULONGLONG ullOperand,
...
//
_Must_inspect_result_ __inline HRESULT
ULongLongToLong(_In_ ULONGLONG ullOperand,
...
//
_Must_inspect_result_ __inline HRESULT
ULongLongToLongPtr(_In_ ULONGLONG ullOperand,
...
//
_Must_inspect_result_ __inline HRESULT
ULongLongToULong(_In_ ULONGLONG ullOperand,
...
#ifdef _WIN64
_Must_inspect_result_ __inline HRESULT
ULongLongToULongPtr(_In_ ULONGLONG ullOperand,
                    _Out_ _Deref_out_range_(==, ullOperand)
                        ULONG_PTR *pulResult) {
...
//
_Must_inspect_result_ __inline HRESULT
ULongLongToLongLong(_In_ ULONGLONG ullOperand,
                    _Out_ _Deref_out_range_(==, ullOperand)
                        LONGLONG *pllResult) {
  HRESULT hr;
...
//
_Must_inspect_result_ __inline HRESULT
UInt8Add(_In_ UINT8 u8Augend, _In_ UINT8 u8Addend,
...
//
_Must_inspect_result_ __inline HRESULT
UShortAdd(_In_ USHORT usAugend, _In_ USHORT usAddend,
...
//
_Must_inspect_result_ __inline HRESULT
UIntAdd(_In_ UINT uAugend, _In_ UINT uAddend,
...
#else
_Must_inspect_result_ __inline HRESULT
UIntPtrAdd(_In_ UINT_PTR uAugend, _In_ UINT_PTR uAddend,
...
//
_Must_inspect_result_ __inline HRESULT
ULongAdd(_In_ ULONG ulAugend, _In_ ULONG ulAddend,
...
#else
_Must_inspect_result_ __inline HRESULT
ULongPtrAdd(_In_ ULONG_PTR ulAugend, _In_ ULONG_PTR ulAddend,
            _Out_ _Deref_out_range_(==, ulAugend + ulAddend)
                ULONG_PTR *pulResult) {
  HRESULT hr;
...
#else
_Must_inspect_result_ __inline HRESULT
DWordPtrAdd(_In_ DWORD_PTR dwAugend, _In_ DWORD_PTR dwAddend,
            _Out_ _Deref_out_range_(==, dwAugend + dwAddend)
                DWORD_PTR *pdwResult) {
  HRESULT hr;
...
//
_Must_inspect_result_ __inline HRESULT
SizeTAdd(_In_ size_t Augend, _In_ size_t Addend,
...
//
_Must_inspect_result_ __inline HRESULT
ULongLongAdd(_In_ ULONGLONG ullAugend, _In_ ULONGLONG ullAddend,
             _Out_ _Deref_out_range_(==, ullAugend + ullAddend)
                 ULONGLONG *pullResult) {
  HRESULT hr;
...
//
_Must_inspect_result_ __inline HRESULT
UInt8Sub(_In_ UINT8 u8Minuend, _In_ UINT8 u8Subtrahend,
         _Out_ _Deref_out_range_(==, u8Minuend - u8Subtrahend)
             UINT8 *pu8Result) {
  HRESULT hr;
...
//
_Must_inspect_result_ __inline HRESULT
UShortSub(_In_ USHORT usMinuend, _In_ USHORT usSubtrahend,
          _Out_ _Deref_out_range_(==, usMinuend - usSubtrahend)
              USHORT *pusResult) {
  HRESULT hr;
...
//
_Must_inspect_result_ __inline HRESULT
UIntSub(_In_ UINT uMinuend, _In_ UINT uSubtrahend,
...
#else
_Must_inspect_result_ __inline HRESULT
UIntPtrSub(_In_ UINT_PTR uMinuend, _In_ UINT_PTR uSubtrahend,
           _Out_ _Deref_out_range_(==, uMinuend - uSubtrahend)
               UINT_PTR *puResult) {
  HRESULT hr;
...
//
_Must_inspect_result_ __inline HRESULT
ULongSub(_In_ ULONG ulMinuend, _In_ ULONG ulSubtrahend,
         _Out_ _Deref_out_range_(==, ulMinuend - ulSubtrahend)
             ULONG *pulResult) {
  HRESULT hr;
...
#else
_Must_inspect_result_ __inline HRESULT
ULongPtrSub(_In_ ULONG_PTR ulMinuend, _In_ ULONG_PTR ulSubtrahend,
            _Out_ _Deref_out_range_(==, ulMinuend - ulSubtrahend)
                ULONG_PTR *pulResult) {
  HRESULT hr;
...
#else
_Must_inspect_result_ __inline HRESULT
DWordPtrSub(_In_ DWORD_PTR dwMinuend, _In_ DWORD_PTR dwSubtrahend,
            _Out_ _Deref_out_range_(==, dwMinuend - dwSubtrahend)
                DWORD_PTR *pdwResult) {
  HRESULT hr;
...
//
_Must_inspect_result_ __inline HRESULT
SizeTSub(_In_ size_t Minuend, _In_ size_t Subtrahend,
...
//
_Must_inspect_result_ __inline HRESULT
ULongLongSub(_In_ ULONGLONG ullMinuend, _In_ ULONGLONG ullSubtrahend,
             _Out_ _Deref_out_range_(==, ullMinuend - ullSubtrahend)
                 ULONGLONG *pullResult) {
  HRESULT hr;
...
//
_Must_inspect_result_ __inline HRESULT
UInt8Mult(_In_ UINT8 u8Multiplicand, _In_ UINT8 u8Multiplier,
          _Out_ _Deref_out_range_(==, u8Multiplicand *u8Multiplier)
              UINT8 *pu8Result) {
...
//
_Must_inspect_result_ __inline HRESULT
UShortMult(_In_ USHORT usMultiplicand, _In_ USHORT usMultiplier,
           _Out_ _Deref_out_range_(==, usMultiplicand *usMultiplier)
               USHORT *pusResult) {
...
//
_Must_inspect_result_ __inline HRESULT
UIntMult(_In_ UINT uMultiplicand, _In_ UINT uMultiplier,
         _Out_ _Deref_out_range_(==, uMultiplicand *uMultiplier)
             UINT *puResult) {
...
#else
_Must_inspect_result_ __inline HRESULT
UIntPtrMult(_In_ UINT_PTR uMultiplicand, _In_ UINT_PTR uMultiplier,
            _Out_ _Deref_out_range_(==, uMultiplicand *uMultiplier)
                UINT_PTR *puResult) {
  ULONGLONG ull64Result = UInt32x32To64(uMultiplicand, uMultiplier);
...
//
_Must_inspect_result_ __inline HRESULT
ULongMult(_In_ ULONG ulMultiplicand, _In_ ULONG ulMultiplier,
          _Out_ _Deref_out_range_(==, ulMultiplicand *ulMultiplier)
              ULONG *pulResult) {
...
#else
_Must_inspect_result_ __inline HRESULT
ULongPtrMult(_In_ ULONG_PTR ulMultiplicand, _In_ ULONG_PTR ulMultiplier,
             _Out_ _Deref_out_range_(==, ulMultiplicand *ulMultiplier)
                 ULONG_PTR *pulResult) {
  ULONGLONG ull64Result = UInt32x32To64(ulMultiplicand, ulMultiplier);
...
#else
_Must_inspect_result_ __inline HRESULT
DWordPtrMult(_In_ DWORD_PTR dwMultiplicand, _In_ DWORD_PTR dwMultiplier,
             _Out_ _Deref_out_range_(==, dwMultiplicand *dwMultiplier)
                 DWORD_PTR *pdwResult) {
...
#else
_Must_inspect_result_ __inline HRESULT
SizeTMult(_In_ size_t Multiplicand, _In_ size_t Multiplier,
          _Out_ _Deref_out_range_(==, Multiplicand *Multiplier)
              size_t *pResult) {
...
//
_Must_inspect_result_ __inline HRESULT
ULongLongMult(_In_ ULONGLONG ullMultiplicand, _In_ ULONGLONG ullMultiplier,
              _Out_ _Deref_out_range_(==, ullMultiplicand *ullMultiplier)
                  ULONGLONG *pullResult) {
  HRESULT hr;
#if defined(_USE_INTRINSIC_MULTIPLY128)
  ...
  ullResultLow =
      __UnsignedMultiply128(ullMultiplicand, ullMultiplier, &ullResultHigh);
  if (ullResultHigh == 0) {
  ...
  if ((dw_a == 0) && (dw_c == 0)) {
    ...
    *pullResult = (((ULONGLONG)dw_b) * (ULONGLONG)dw_d);
    ...
    if ((dw_a == 0) || (dw_c == 0)) {
      ...
      // a * d must be less than 2^32 or there would be bits set in the high
      // 64-bits
      ad = (((ULONGLONG)dw_a) * (ULONGLONG)dw_d);
      if ((ad & 0xffffffff00000000) == 0) {
        dw_b = (DWORD)ullMultiplicand;

        // b * c must be less than 2^32 or there would be bits set in the high
        // 64-bits
...
LONG64
__Multiply128(_In_ LONG64 Multiplier, _In_ LONG64 Multiplicand,
...
__inline LONG64 __Multiply128(_In_ LONG64 Multiplier, _In_ LONG64 Multiplicand,
...
//
_Must_inspect_result_ __inline HRESULT
Int8Add(_In_ INT8 i8Augend, _In_ INT8 i8Addend,
...
//
_Must_inspect_result_ __inline HRESULT
ShortAdd(_In_ SHORT sAugend, _In_ SHORT sAddend,
...
//
_Must_inspect_result_ __inline HRESULT
IntAdd(_In_ INT iAugend, _In_ INT iAddend,
...
#else
_Must_inspect_result_ __inline HRESULT
IntPtrAdd(_In_ INT_PTR iAugend, _In_ INT_PTR iAddend,
...
//
_Must_inspect_result_ __inline HRESULT
LongAdd(_In_ LONG lAugend, _In_ LONG lAddend,
...
#else
_Must_inspect_result_ __inline HRESULT
LongPtrAdd(_In_ LONG_PTR lAugend, _In_ LONG_PTR lAddend,
...
//
_Must_inspect_result_ __inline HRESULT
LongLongAdd(_In_ LONGLONG llAugend, _In_ LONGLONG llAddend,
            _Out_ _Deref_out_range_(==, llAugend + llAddend)
                LONGLONG *pllResult) {
  HRESULT hr;
...
#else
_Must_inspect_result_ __inline HRESULT
PtrdiffTAdd(_In_ ptrdiff_t Augend, _In_ ptrdiff_t Addend,
...
#else
_Must_inspect_result_ __inline HRESULT
SSIZETAdd(_In_ SSIZE_T Augend, _In_ SSIZE_T Addend,
...
//
_Must_inspect_result_ __inline HRESULT
Int8Sub(_In_ INT8 i8Minuend, _In_ INT8 i8Subtrahend,
...
//
_Must_inspect_result_ __inline HRESULT
ShortSub(_In_ SHORT sMinuend, _In_ SHORT sSubtrahend,
...
//
_Must_inspect_result_ __inline HRESULT
IntSub(_In_ INT iMinuend, _In_ INT iSubtrahend,
       _Out_ _Deref_out_range_(==, iMinuend - iSubtrahend) INT *piResult) {
  C_ASSERT(sizeof(LONGLONG) > sizeof(INT));
  return LongLongToInt(((LONGLONG)iMinuend) - ((LONGLONG)iSubtrahend),
                       piResult);
}
...
#else
_Must_inspect_result_ __inline HRESULT
IntPtrSub(_In_ INT_PTR iMinuend, _In_ INT_PTR iSubtrahend,
          _Out_ _Deref_out_range_(==, iMinuend - iSubtrahend)
              INT_PTR *piResult) {
  C_ASSERT(sizeof(LONGLONG) > sizeof(INT_PTR));
  return LongLongToIntPtr(((LONGLONG)iMinuend) - ((LONGLONG)iSubtrahend),
                          piResult);
}
#endif
...
//
_Must_inspect_result_ __inline HRESULT
LongSub(_In_ LONG lMinuend, _In_ LONG lSubtrahend,
        _Out_ _Deref_out_range_(==, lMinuend - lSubtrahend) LONG *plResult) {
  C_ASSERT(sizeof(LONGLONG) > sizeof(LONG));
  return LongLongToLong(((LONGLONG)lMinuend) - ((LONGLONG)lSubtrahend),
                        plResult);
}
...
#else
_Must_inspect_result_ __inline HRESULT
LongPtrSub(_In_ LONG_PTR lMinuend, _In_ LONG_PTR lSubtrahend,
           _Out_ _Deref_out_range_(==, lMinuend - lSubtrahend)
               LONG_PTR *plResult) {
  C_ASSERT(sizeof(LONGLONG) > sizeof(LONG_PTR));
  return LongLongToLongPtr(((LONGLONG)lMinuend) - ((LONGLONG)lSubtrahend),
                           plResult);
}
#endif
...
//
_Must_inspect_result_ __inline HRESULT
LongLongSub(_In_ LONGLONG llMinuend, _In_ LONGLONG llSubtrahend,
            _Out_ _Deref_out_range_(==, llMinuend - llSubtrahend)
                LONGLONG *pllResult) {
  HRESULT hr;
  ...
  // positive result. If you subtract a positive number from a negative number,
  // you expect a negative result. Overflow if inputs vary in sign and the
  // output does not have the same sign as the first input. Unsigned greater
  // than signed maximum, cast to signed, will be negative.
  //
...
#else
_Must_inspect_result_ __inline HRESULT
PtrdiffTSub(_In_ ptrdiff_t Minuend, _In_ ptrdiff_t Subtrahend,
            _Out_ _Deref_out_range_(==, Minuend - Subtrahend)
                ptrdiff_t *pResult) {
  C_ASSERT(sizeof(LONGLONG) > sizeof(ptrdiff_t));
  return LongLongToPtrdiffT(((LONGLONG)Minuend) - ((LONGLONG)Subtrahend),
                            pResult);
}
#endif
...
#else
_Must_inspect_result_ __inline HRESULT
SSIZETSub(_In_ SSIZE_T Minuend, _In_ SSIZE_T Subtrahend,
          _Out_ _Deref_out_range_(==, Minuend - Subtrahend) SSIZE_T *pResult) {
  C_ASSERT(sizeof(LONGLONG) > sizeof(SSIZE_T));
  return LongLongToSSIZET(((LONGLONG)Minuend) - ((LONGLONG)Subtrahend),
                          pResult);
}
#endif
...
//
_Must_inspect_result_ __inline HRESULT
Int8Mult(_In_ INT8 i8Multiplicand, _In_ INT8 i8Multiplier,
         _Out_ _Deref_out_range_(==, i8Multiplicand *i8Multiplier)
             INT8 *pi8Result) {
  C_ASSERT(sizeof(LONG) > sizeof(INT8));
...
//
_Must_inspect_result_ __inline HRESULT
ShortMult(_In_ SHORT sMultiplicand, _In_ SHORT sMultiplier,
          _Out_ _Deref_out_range_(==, sMultiplicand *sMultiplier)
              SHORT *psResult) {
  C_ASSERT(sizeof(LONG) > sizeof(SHORT));
...
//
_Must_inspect_result_ __inline HRESULT
IntMult(_In_ INT iMultiplicand, _In_ INT iMultiplier,
        _Out_ _Deref_out_range_(==, iMultiplicand *iMultiplier) INT *piResult) {
  C_ASSERT(sizeof(LONGLONG) > sizeof(INT));
  return LongLongToInt(((LONGLONG)iMultiplicand) * ((LONGLONG)iMultiplier),
                       piResult);
}
...
#else
_Must_inspect_result_ __inline HRESULT
IntPtrMult(_In_ INT_PTR iMultiplicand, _In_ INT_PTR iMultiplier,
           _Out_ _Deref_out_range_(==, iMultiplicand *iMultiplier)
               INT_PTR *piResult) {
  C_ASSERT(sizeof(LONGLONG) > sizeof(INT_PTR));
  return LongLongToIntPtr(((LONGLONG)iMultiplicand) * ((LONGLONG)iMultiplier),
                          piResult);
}
#endif
...
//
_Must_inspect_result_ __inline HRESULT
LongMult(_In_ LONG lMultiplicand, _In_ LONG lMultiplier,
         _Out_ _Deref_out_range_(==, lMultiplicand *lMultiplier)
             LONG *plResult) {
  C_ASSERT(sizeof(LONGLONG) > sizeof(LONG));
  return LongLongToLong(((LONGLONG)lMultiplicand) * ((LONGLONG)lMultiplier),
                        plResult);
}
...
#else
_Must_inspect_result_ __inline HRESULT
LongPtrMult(_In_ LONG_PTR lMultiplicand, _In_ LONG_PTR lMultiplier,
            _Out_ _Deref_out_range_(==, lMultiplicand *lMultiplier)
                LONG_PTR *plResult) {
  C_ASSERT(sizeof(LONGLONG) > sizeof(LONG_PTR));
  return LongLongToLongPtr(((LONGLONG)lMultiplicand) * ((LONGLONG)lMultiplier),
                           plResult);
}
#endif
...
//
_Must_inspect_result_ __inline HRESULT
LongLongMult(_In_ LONGLONG llMultiplicand, _In_ LONGLONG llMultiplier,
             _Out_ _Deref_out_range_(==, llMultiplicand *llMultiplier)
                 LONGLONG *pllResult) {
  HRESULT hr;
  ...
  ULONGLONG ullResult;
  const ULONGLONG LONGLONG_MIN_MAGNITUDE =
      ((((ULONGLONG) - (LONGLONG_MIN + 1))) + 1);
...
#else
_Must_inspect_result_ __inline HRESULT
PtrdiffTMult(_In_ ptrdiff_t Multiplicand, _In_ ptrdiff_t Multiplier,
             _Out_ _Deref_out_range_(==, Multiplicand *Multiplier)
                 ptrdiff_t *pResult) {
  C_ASSERT(sizeof(LONGLONG) > sizeof(ptrdiff_t));
  return LongLongToPtrdiffT(((LONGLONG)Multiplicand) * ((LONGLONG)Multiplier),
                            pResult);
}
#endif
...
#else
_Must_inspect_result_ __inline HRESULT
SSIZETMult(_In_ SSIZE_T Multiplicand, _In_ SSIZE_T Multiplier,
           _Out_ _Deref_out_range_(==, Multiplicand *Multiplier)
               SSIZE_T *pResult) {
  C_ASSERT(sizeof(LONGLONG) > sizeof(SSIZE_T));
  return LongLongToSSIZET(((LONGLONG)Multiplicand) * ((LONGLONG)Multiplier),
                          pResult);
}
#endif
