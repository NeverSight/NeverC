...
{ NET_IF_OPER_STATUS_UP = 1,
  ...
  NET_IF_OPER_STATUS_LOWER_LAYER_DOWN = 7 } NET_IF_OPER_STATUS,
    *PNET_IF_OPER_STATUS;
...
{ NET_IF_ADMIN_STATUS_UP = 1,
  ...
  NET_IF_ADMIN_STATUS_TESTING = 3 } NET_IF_ADMIN_STATUS,
...
#define NET_IF_OID_IF_ALIAS                                                    \
  0x00000001 // identifies the ifAlias string for an interface
#define NET_IF_OID_COMPARTMENT_ID                                              \
  0x00000002 // identifies the compartment ID for an interface.
#define NET_IF_OID_NETWORK_GUID                                                \
  0x00000003 // identifies the NetworkGuid for an interface.
#define NET_IF_OID_IF_ENTRY                                                    \
  0x00000004 // identifies statistics for an interface.
...
{ NET_IF_RCV_ADDRESS_TYPE_OTHER = 1,
  ...
  NET_IF_RCV_ADDRESS_TYPE_NON_VOLATILE = 3 } NET_IF_RCV_ADDRESS_TYPE,
...
typedef struct _IF_COUNTED_STRING_LH {
  _Field_range_(0, (IF_MAX_STRING_SIZE + 1) *
                       sizeof(WCHAR)) USHORT Length; // in -Bytes-
...
typedef struct _IF_PHYSICAL_ADDRESS_LH {
  _Field_range_(0, IF_MAX_PHYS_ADDRESS_LENGTH) USHORT Length;
...
typedef struct _NDIS_INTERFACE_INFORMATION {
  ...
  // OID_GEN_STATISTICS
  //
  ULONG64 ifInDiscards; // OID_GEN_RCV_DISCARDS = OID_GEN_RCV_ERROR +
                        // OID_GEN_RCV_NO_BUFFER
  ULONG64 ifInErrors;   // OID_GEN_RCV_ERROR
  ULONG64
  ifHCInOctets; // OID_GEN_BYTES_RCV = OID_GEN_DIRECTED_BYTES_RCV +
  ...
  ULONG64 ifHCOutOctets; // OID_GEN_BYTES_XMIT = OID_GEN_DIRECTED_BYTES_XMIT +
