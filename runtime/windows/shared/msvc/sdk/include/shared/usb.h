...
#define USBD_PF_VALID_MASK                                                     \
  (USBD_PF_CHANGE_MAX_PACKET | USBD_PF_SHORT_PACKET_OPT |                      \
   ...
   USBD_PF_INTERACTIVE_PRIORITY | USBD_PF_HANDLES_SSP_HIGH_BANDWIDTH_ISOCH)
...
C_ASSERT(sizeof(USBD_ENDPOINT_OFFLOAD_INFORMATION_V2) >
         sizeof(USBD_ENDPOINT_OFFLOAD_INFORMATION_V1));
C_ASSERT(sizeof(USBD_ENDPOINT_OFFLOAD_INFORMATION) >
         sizeof(USBD_ENDPOINT_OFFLOAD_INFORMATION_V1));
