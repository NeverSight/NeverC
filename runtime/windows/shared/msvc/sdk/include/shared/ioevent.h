...
DEFINE_GUID(GUID_IO_VOLUME_CHANGE, 0x7373654aL, 0x812a, 0x11d0, 0xbe, 0xc7,
...
DEFINE_GUID(GUID_IO_VOLUME_DISMOUNT, 0xd16a55e8L, 0x1059, 0x11d2, 0x8f, 0xfd,
            0x00, 0xa0, 0xc9, 0xa0, 0x6d, 0x32);

//
//  Volume dismount failed event.  This event is signalled when a volume
//  dismount fails. There is no additional data.
//

DEFINE_GUID(GUID_IO_VOLUME_DISMOUNT_FAILED, 0xe3c5b178L, 0x105d, 0x11d2, 0x8f,
...
DEFINE_GUID(GUID_IO_VOLUME_MOUNT, 0xb5804878L, 0x1a96, 0x11d2, 0x8f, 0xfd, 0x00,
...
DEFINE_GUID(GUID_IO_VOLUME_LOCK, 0x50708874L, 0xc9af, 0x11d1, 0x8f, 0xef, 0x00,
            0xa0, 0xc9, 0xa0, 0x6d, 0x32);

//
//  Volume lock failed event.  This event is signalled when an attempt is made
//  to lock a volume, but it fails.  There is no additional data.
//

DEFINE_GUID(GUID_IO_VOLUME_LOCK_FAILED, 0xae2eed10L, 0x0ba8, 0x11d2, 0x8f, 0xfb,
            0x00, 0xa0, 0xc9, 0xa0, 0x6d, 0x32);
...
DEFINE_GUID(GUID_IO_VOLUME_UNLOCK, 0x9a8c3d68L, 0xd0cb, 0x11d1, 0x8f, 0xef,
            0x00, 0xa0, 0xc9, 0xa0, 0x6d, 0x32);
...
DEFINE_GUID(GUID_IO_VOLUME_NEED_CHKDSK, 0x799a0960, 0x0a0b, 0x4e03, 0xad, 0x88,
            0x2f, 0xa7, 0xc6, 0xce, 0x74, 0x8a);

//
//  WORK near full event. Send when a wolume with write-once-read-many
//  characteristics (e.g. CD-R) is becoming full (on these media modifying
//  existing file data consumes space) so that the user can be notified.
//

DEFINE_GUID(GUID_IO_VOLUME_WORM_NEAR_FULL, 0xf3bfff82, 0xf3de, 0x48d2, 0xaf,
            0x95, 0x45, 0x7f, 0x80, 0xb7, 0x63, 0xf2);
...
DEFINE_GUID(GUID_IO_VOLUME_WEARING_OUT, 0x873113ca, 0x1486, 0x4508, 0x82, 0xac,
            0xc3, 0xb2, 0xe5, 0x29, 0x7a, 0xaa);
...
DEFINE_GUID(GUID_IO_VOLUME_FORCE_CLOSED, 0x411ad84f, 0x433e, 0x4dc2, 0xa5, 0xae,
            0x4a, 0x2d, 0x1a, 0x2d, 0xe6, 0x54);

//
//  Notify make compatible function available. Sent after the user removes a
//  disc which may not be readable in all drives in it's current state (e.g.
//  CD-R with open session).
//

DEFINE_GUID(GUID_IO_VOLUME_INFO_MAKE_COMPAT, 0x3ab9a0d2, 0xef80, 0x45cf, 0x8c,
            0xdc, 0xcb, 0xe0, 0x2a, 0x21, 0x29, 0x06);

//
//  Notify that the drive is preparing the disc for eject (e.g. stopping a
//  background format).
//

DEFINE_GUID(GUID_IO_VOLUME_PREPARING_EJECT, 0xc79eb16e, 0x0dac, 0x4e7a, 0xa8,
            0x6c, 0xb2, 0x5c, 0xee, 0xaa, 0x88, 0xf6);

//
//  Notify that a background format has been initiated on the disc.
//

DEFINE_GUID(GUID_IO_VOLUME_BACKGROUND_FORMAT, 0xa2e5fc86, 0xd5cd, 0x4038, 0xb2,
            0xe3, 0x44, 0x45, 0x6, 0x5c, 0x23, 0x77);
...
DEFINE_GUID(GUID_IO_VOLUME_PREPARE_DELETE, 0xac0707fb, 0x4a9a, 0x4c81, 0x9e,
            0x2e, 0x38, 0x5b, 0x79, 0xa8, 0xfd, 0x28);
...
DEFINE_GUID(GUID_IO_VOLUME_UNIQUE_ID_CHANGE, 0xaf39da42, 0x6622, 0x41f5, 0x97,
            0xb, 0x13, 0x9d, 0x9, 0x2f, 0xa3, 0xd9);
...
DEFINE_GUID(GUID_IO_VOLUME_FVE_STATUS_CHANGE, 0x062998b2, 0xee1f, 0x4b6a, 0xb8,
            0x57, 0xe7, 0x6c, 0xbb, 0xe9, 0xa6, 0xda);
...
DEFINE_GUID(GUID_IO_VOLUME_CHANGE_SIZE, 0x3a1625be, 0xad03, 0x49f1, 0x8e, 0xf8,
            0x6b, 0xba, 0xc1, 0x82, 0xd1, 0xfd);
...
DEFINE_GUID(GUID_IO_CDROM_EXCLUSIVE_LOCK, 0xbc56c139, 0x7a10, 0x47ee, 0xa2,
            0x94, 0x4c, 0x6a, 0x38, 0xf0, 0x14, 0x9a);
DEFINE_GUID(GUID_IO_CDROM_EXCLUSIVE_UNLOCK, 0xa3b6d27d, 0x5e35, 0x4885, 0x81,
            0xe5, 0xee, 0x18, 0xc0, 0xe, 0xd7, 0x79);
...
DEFINE_GUID(GUID_IO_DISK_HEALTH_NOTIFICATION, 0xf1bd644, 0x3916, 0x49c5, 0xb0,
            0x63, 0x99, 0x19, 0x40, 0x11, 0x8f, 0xb2);
