...
typedef struct _FT_PARTITION_CONFIGURATION_INFORMATION {
  ...
  ULONG DiskNumber;
  LONGLONG ByteOffset;
} FT_PARTITION_CONFIGURATION_INFORMATION,
...
typedef struct _FT_STRIPE_SET_CONFIGURATION_INFORMATION {
  ULONG StripeSize;
} FT_STRIPE_SET_CONFIGURATION_INFORMATION,
    *PFT_STRIPE_SET_CONFIGURATION_INFORMATION;
...
typedef struct _FT_MIRROR_SET_CONFIGURATION_INFORMATION {
  LONGLONG MemberSize;
} FT_MIRROR_SET_CONFIGURATION_INFORMATION,
    *PFT_MIRROR_SET_CONFIGURATION_INFORMATION;
...
typedef struct _FT_STRIPE_SET_WITH_PARITY_CONFIGURATION_INFORMATION {
  LONGLONG MemberSize;
  ULONG StripeSize;
} FT_STRIPE_SET_WITH_PARITY_CONFIGURATION_INFORMATION,
    *PFT_STRIPE_SET_WITH_PARITY_CONFIGURATION_INFORMATION;
...
} FT_REDISTRIBUTION_CONFIGURATION_INFORMATION,
