...
// MessageText:
//
// The Target Mapping Address passed is out of range for the adapter
// configuration.
//
...
// MessageText:
//
// The preshared key for the target or IKE identification payload is not
// available.
//
...
// MessageText:
//
// The Internet Storage Name Server (iSNS) server was not found or is
// unavailable.
//
...
// MessageText:
//
// The operation was successful but requires a driver reload or reboot to become
// effective.
//
...
// MessageText:
//
// The Microsoft iSCSI Initiator Service is not running. Please start the
// service and retry.
//
...
// MessageText:
//
// The session cannot be logged out since a device on that session is currently
// being used.
//
...
// MessageText:
//
// The specified CHAP secret is less than 96 bits and will not be usable for
...
// MessageText:
//
// CHAP secret given does not conform to the standard. Please see system event
...
// Minimum size is 12 bytes if IPSec is not used.
//
...
// MessageText:
//
// Initiator CHAP secret given is invalid. Maximum size of CHAP secret is 16
// bytes. Minimum size is 12 bytes if IPSec is not used.
//
...
// MessageText:
//
// The version number returned from the Internet Storage Name Server (iSNS)
// server is not compatible with this version of the iSNS client.
//
...
// MessageText:
//
// Initiator failed to configure IPSec for the given connection. This could be
...
// MessageText:
//
// Number of paths specified in Set Load Balance Policy does not match the
// number of paths to the target.
//
...
// MessageText:
//
// The device specified does not originate from an iSCSI disk or a persistent
// iSCSI login.
//
...
// MessageText:
//
// The operation cannot be performed since it does not conform with the group
// policy assigned to this computer.
//
...
// MessageText:
//
// The operation cannot be performed since the Internet Storage Name Server
