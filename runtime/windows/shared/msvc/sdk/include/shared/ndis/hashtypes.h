...
//
// Typedef to use as flags holder to correlate to the NDIS_HAS_ prefixed flags
// above.
//
...
inline ULONG NDIS_RSS_HASH_FUNC_FROM_HASH_INFO(_In_ ULONG HashInfo) {
  return HashInfo & NDIS_HASH_FUNCTION_MASK;
}

inline ULONG NDIS_RSS_HASH_TYPE_FROM_HASH_INFO(_In_ ULONG HashInfo) {
  return HashInfo & NDIS_HASH_TYPE_MASK;
}

inline ULONG NDIS_RSS_HASH_INFO_FROM_TYPE_AND_FUNC(_In_ ULONG HashType,
