...
#define NET_BUFFER_LIST_UDP_COALESCED_SEG_COUNT(_NBL)                          \
  (((NDIS_UDP_RSC_OFFLOAD_NET_BUFFER_LIST_INFO *)&(_NBL)                       \
        ->NetBufferListInfo[UdpRecvSegCoalesceOffloadInfo])                    \
       ->Receive.SegCount)
...
#define NET_BUFFER_LIST_IS_URO_SET(_NBL)                                       \
  ((((UINT_PTR)((NDIS_UDP_RSC_OFFLOAD_NET_BUFFER_LIST_INFO const *)&(_NBL)     \
                    ->NetBufferListInfo[UdpRecvSegCoalesceOffloadInfo])        \
         ->Value) &                                                            \
    0xFFFFFFFF) != 0)
...
inline UINT32 &
NET_BUFFER_LIST_UDP_COALESCED_SEG_COUNT(_In_ NET_BUFFER_LIST *Nbl) {
  NDIS_UDP_RSC_OFFLOAD_NET_BUFFER_LIST_INFO *Info =
      (NDIS_UDP_RSC_OFFLOAD_NET_BUFFER_LIST_INFO *)&Nbl
          ->NetBufferListInfo[UdpRecvSegCoalesceOffloadInfo];
  return Info->Receive.SegCount;
}

inline UINT32 const &
NET_BUFFER_LIST_UDP_COALESCED_SEG_COUNT(_In_ NET_BUFFER_LIST const *Nbl) {
  NDIS_UDP_RSC_OFFLOAD_NET_BUFFER_LIST_INFO const *Info =
      (NDIS_UDP_RSC_OFFLOAD_NET_BUFFER_LIST_INFO const *)&Nbl
          ->NetBufferListInfo[UdpRecvSegCoalesceOffloadInfo];
  return Info->Receive.SegCount;
}

inline UINT32 &
NET_BUFFER_LIST_UDP_COALESCED_SEG_SIZE(_In_ NET_BUFFER_LIST *Nbl) {
  NDIS_UDP_RSC_OFFLOAD_NET_BUFFER_LIST_INFO *Info =
      (NDIS_UDP_RSC_OFFLOAD_NET_BUFFER_LIST_INFO *)&Nbl
          ->NetBufferListInfo[UdpRecvSegCoalesceOffloadInfo];
...
inline UINT32 const &
NET_BUFFER_LIST_UDP_COALESCED_SEG_SIZE(_In_ NET_BUFFER_LIST const *Nbl) {
  NDIS_UDP_RSC_OFFLOAD_NET_BUFFER_LIST_INFO const *Info =
      (NDIS_UDP_RSC_OFFLOAD_NET_BUFFER_LIST_INFO const *)&Nbl
          ->NetBufferListInfo[UdpRecvSegCoalesceOffloadInfo];
  return Info->Receive.SegSize;
...
inline BOOLEAN NET_BUFFER_LIST_IS_URO_SET(_In_ NET_BUFFER_LIST const *Nbl) {
  NDIS_UDP_RSC_OFFLOAD_NET_BUFFER_LIST_INFO const *Info =
      (NDIS_UDP_RSC_OFFLOAD_NET_BUFFER_LIST_INFO const *)&Nbl
          ->NetBufferListInfo[UdpRecvSegCoalesceOffloadInfo];
