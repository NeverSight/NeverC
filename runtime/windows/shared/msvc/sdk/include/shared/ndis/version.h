...
#pragma once
    ...
    (defined(NDIS_PLATFORM) &&                                                 \
     (defined(NDIS689) || defined(NDIS689_MINIPORT))) ||                       \
...
#define NDIS_SUPPORT_NDIS689 1
    ...
    (defined(NDIS_PLATFORM) &&                                                 \
     (defined(NDIS688) || defined(NDIS688_MINIPORT))) ||                       \
...
#define NDIS_SUPPORT_NDIS688 1
    ...
    (defined(NDIS_PLATFORM) &&                                                 \
     (defined(NDIS687) || defined(NDIS687_MINIPORT))) ||                       \
...
#define NDIS_SUPPORT_NDIS687 1
    ...
    (defined(NDIS_PLATFORM) &&                                                 \
     (defined(NDIS686) || defined(NDIS686_MINIPORT))) ||                       \
...
#define NDIS_SUPPORT_NDIS686 1
    ...
    (defined(NDIS_PLATFORM) &&                                                 \
     (defined(NDIS685) || defined(NDIS685_MINIPORT))) ||                       \
...
#define NDIS_SUPPORT_NDIS685 1
    ...
    (defined(NDIS_PLATFORM) &&                                                 \
     (defined(NDIS684) || defined(NDIS684_MINIPORT))) ||                       \
...
#define NDIS_SUPPORT_NDIS684 1
    ...
    (defined(NDIS_PLATFORM) &&                                                 \
     (defined(NDIS683) || defined(NDIS683_MINIPORT))) ||                       \
...
#define NDIS_SUPPORT_NDIS683 1
    ...
    (defined(NDIS_PLATFORM) &&                                                 \
     (defined(NDIS682) || defined(NDIS682_MINIPORT))) ||                       \
...
#define NDIS_SUPPORT_NDIS682 1
    ...
    (defined(NDIS_PLATFORM) &&                                                 \
     (defined(NDIS681) || defined(NDIS681_MINIPORT))) ||                       \
...
#define NDIS_SUPPORT_NDIS681 1
    ...
    (defined(NDIS_PLATFORM) &&                                                 \
     (defined(NDIS680) || defined(NDIS680_MINIPORT))) ||                       \
...
#define NDIS_SUPPORT_NDIS680 1
    ...
    (defined(NDIS_PLATFORM) &&                                                 \
     (defined(NDIS670) || defined(NDIS670_MINIPORT))) ||                       \
...
#define NDIS_SUPPORT_NDIS670 1
    ...
    (defined(NDIS_PLATFORM) &&                                                 \
     (defined(NDIS660) || defined(NDIS660_MINIPORT))) ||                       \
...
#define NDIS_SUPPORT_NDIS660 1
    ...
    (defined(NDIS_PLATFORM) &&                                                 \
     (defined(NDIS651) || defined(NDIS651_MINIPORT))) ||                       \
...
#define NDIS_SUPPORT_NDIS651 1
    ...
    (defined(NDIS_PLATFORM) &&                                                 \
     (defined(NDIS650) || defined(NDIS650_MINIPORT))) ||                       \
...
#define NDIS_SUPPORT_NDIS650 1
    ...
    (defined(NDIS_PLATFORM) &&                                                 \
     (defined(NDIS640) || defined(NDIS640_MINIPORT))) ||                       \
...
#define NDIS_SUPPORT_NDIS640 1
    ...
    (defined(NDIS_PLATFORM) &&                                                 \
     (defined(NDIS630) || defined(NDIS630_MINIPORT))) ||                       \
...
#define NDIS_SUPPORT_NDIS630 1
    ...
    (defined(NDIS_PLATFORM) &&                                                 \
     (defined(NDIS620) || defined(NDIS620_MINIPORT))) ||                       \
...
#define NDIS_SUPPORT_NDIS620 1
    ...
    (defined(NDIS_PLATFORM) &&                                                 \
     (defined(NDIS61) || defined(NDIS61_MINIPORT))) ||                         \
...
#define NDIS_SUPPORT_NDIS61 1
    ...
    (defined(NDIS_PLATFORM) &&                                                 \
     (defined(NDIS60) || defined(NDIS60_MINIPORT))) ||                         \
