...
typedef struct IDXGIOutput5Vtbl {
  ...
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(IDXGIOutput5 *This,
                                             /* [in] */ REFIID riid,
  ...
  HRESULT(STDMETHODCALLTYPE *SetPrivateData)(IDXGIOutput5 *This,
                                             /* [annotation][in] */
                                             _In_ REFGUID Name,
                                             /* [in] */ UINT DataSize,
                                             /* [annotation][in] */
  ...
  HRESULT(STDMETHODCALLTYPE *GetParent)(IDXGIOutput5 *This,
                                        /* [annotation][in] */
                                        _In_ REFIID riid,
  ...
  HRESULT(STDMETHODCALLTYPE *GetGammaControl)(IDXGIOutput5 *This,
                                              /* [annotation][out] */
...
interface IDXGIOutput5 { CONST_VTBL struct IDXGIOutput5Vtbl *lpVtbl; };
...
#define IDXGIOutput5_GetDisplayModeList(This, EnumFormat, Flags, pNumModes,    \
                                        pDesc)                                 \
  ((This)->lpVtbl->GetDisplayModeList(This, EnumFormat, Flags, pNumModes,      \
                                      pDesc))

#define IDXGIOutput5_FindClosestMatchingMode(This, pModeToMatch,               \
...
#define IDXGIOutput5_GetDisplayModeList1(This, EnumFormat, Flags, pNumModes,   \
                                         pDesc)                                \
  ((This)->lpVtbl->GetDisplayModeList1(This, EnumFormat, Flags, pNumModes,     \
                                       pDesc))

#define IDXGIOutput5_FindClosestMatchingMode1(This, pModeToMatch,              \
                                              pClosestMatch, pConcernedDevice) \
...
#define IDXGIOutput5_CheckOverlaySupport(This, EnumFormat, pConcernedDevice,   \
                                         pFlags)                               \
  ((This)->lpVtbl->CheckOverlaySupport(This, EnumFormat, pConcernedDevice,     \
                                       pFlags))

#define IDXGIOutput5_CheckOverlayColorSpaceSupport(This, Format, ColorSpace,   \
                                                   pConcernedDevice, pFlags)   \
  ((This)->lpVtbl->CheckOverlayColorSpaceSupport(This, Format, ColorSpace,     \
                                                 pConcernedDevice, pFlags))

#define IDXGIOutput5_DuplicateOutput1(This, pDevice, Flags,                    \
...
typedef struct IDXGISwapChain4Vtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(IDXGISwapChain4 *This,
                                             /* [in] */ REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);
  ...
  HRESULT(STDMETHODCALLTYPE *SetMatrixTransform)(
      IDXGISwapChain4 *This, const DXGI_MATRIX_3X2_F *pMatrix);
...
interface IDXGISwapChain4 { CONST_VTBL struct IDXGISwapChain4Vtbl *lpVtbl; };
...
#define IDXGISwapChain4_ResizeBuffers(This, BufferCount, Width, Height,        \
...
#define IDXGISwapChain4_CheckColorSpaceSupport(This, ColorSpace,               \
                                               pColorSpaceSupport)             \
...
#define IDXGISwapChain4_ResizeBuffers1(This, BufferCount, Width, Height,       \
                                       Format, SwapChainFlags,                 \
                                       pCreationNodeMask, ppPresentQueue)      \
  ((This)->lpVtbl->ResizeBuffers1(This, BufferCount, Width, Height, Format,    \
...
typedef struct IDXGIDevice4Vtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(IDXGIDevice4 *This,
                                             /* [in] */ REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);
...
interface IDXGIDevice4 { CONST_VTBL struct IDXGIDevice4Vtbl *lpVtbl; };
...
#define IDXGIDevice4_CreateSurface(This, pDesc, NumSurfaces, Usage,            \
                                   pSharedResource, ppSurface)                 \
  ((This)->lpVtbl->CreateSurface(This, pDesc, NumSurfaces, Usage,              \
                                 pSharedResource, ppSurface))

#define IDXGIDevice4_QueryResourceResidency(This, ppResources,                 \
...
#define IDXGIDevice4_OfferResources1(This, NumResources, ppResources,          \
                                     Priority, Flags)                          \
  ((This)->lpVtbl->OfferResources1(This, NumResources, ppResources, Priority,  \
                                   Flags))

#define IDXGIDevice4_ReclaimResources1(This, NumResources, ppResources,        \
                                       pResults)                               \
...
typedef struct IDXGIFactory5Vtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(IDXGIFactory5 *This,
                                             /* [in] */ REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);
  ...
  HRESULT(STDMETHODCALLTYPE *CheckFeatureSupport)(
      IDXGIFactory5 *This, DXGI_FEATURE Feature,
      /* [annotation] */
      _Inout_updates_bytes_(FeatureSupportDataSize) void *pFeatureSupportData,
...
interface IDXGIFactory5 { CONST_VTBL struct IDXGIFactory5Vtbl *lpVtbl; };
...
#define IDXGIFactory5_CheckFeatureSupport(This, Feature, pFeatureSupportData,  \
