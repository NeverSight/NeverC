...
typedef struct IDXGIAdapter4Vtbl {
  ...
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(IDXGIAdapter4 *This,
                                             /* [in] */ REFIID riid,
  ...
  HRESULT(STDMETHODCALLTYPE *SetPrivateData)(IDXGIAdapter4 *This,
                                             /* [annotation][in] */
                                             _In_ REFGUID Name,
                                             /* [in] */ UINT DataSize,
                                             /* [annotation][in] */
  ...
  HRESULT(STDMETHODCALLTYPE *GetParent)(IDXGIAdapter4 *This,
                                        /* [annotation][in] */
                                        _In_ REFIID riid,
  ...
  HRESULT(STDMETHODCALLTYPE *EnumOutputs)(IDXGIAdapter4 *This,
                                          /* [in] */ UINT Output,
                                          /* [annotation][out][in] */
  ...
  DECLSPEC_XFGVIRT(IDXGIAdapter3,
...
interface IDXGIAdapter4 { CONST_VTBL struct IDXGIAdapter4Vtbl *lpVtbl; };
...
#define IDXGIAdapter4_QueryVideoMemoryInfo(                                    \
    This, NodeIndex, MemorySegmentGroup, pVideoMemoryInfo)                     \
  ((This)->lpVtbl->QueryVideoMemoryInfo(This, NodeIndex, MemorySegmentGroup,   \
                                        pVideoMemoryInfo))

#define IDXGIAdapter4_SetVideoMemoryReservation(                               \
    This, NodeIndex, MemorySegmentGroup, Reservation)                          \
  ((This)->lpVtbl->SetVideoMemoryReservation(This, NodeIndex,                  \
                                             MemorySegmentGroup, Reservation))
...
#define IDXGIAdapter4_UnregisterVideoMemoryBudgetChangeNotification(This,      \
                                                                    dwCookie)  \
  ((This)->lpVtbl->UnregisterVideoMemoryBudgetChangeNotification(This,         \
                                                                 dwCookie))
...
typedef struct IDXGIOutput6Vtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(IDXGIOutput6 *This,
                                             /* [in] */ REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);
  ...
  DECLSPEC_XFGVIRT(IDXGIObject, SetPrivateData)
  HRESULT(STDMETHODCALLTYPE *SetPrivateData)(IDXGIOutput6 *This,
                                             /* [annotation][in] */
                                             _In_ REFGUID Name,
                                             /* [in] */ UINT DataSize,
                                             /* [annotation][in] */
  ...
  DECLSPEC_XFGVIRT(IDXGIObject, GetParent)
  HRESULT(STDMETHODCALLTYPE *GetParent)(IDXGIOutput6 *This,
                                        /* [annotation][in] */
                                        _In_ REFIID riid,
                                        /* [annotation][retval][out] */
                                        _COM_Outptr_ void **ppParent);
  ...
  HRESULT(STDMETHODCALLTYPE *GetGammaControl)(IDXGIOutput6 *This,
                                              /* [annotation][out] */
...
interface IDXGIOutput6 { CONST_VTBL struct IDXGIOutput6Vtbl *lpVtbl; };
...
#define IDXGIOutput6_GetDisplayModeList(This, EnumFormat, Flags, pNumModes,    \
                                        pDesc)                                 \
  ((This)->lpVtbl->GetDisplayModeList(This, EnumFormat, Flags, pNumModes,      \
                                      pDesc))

#define IDXGIOutput6_FindClosestMatchingMode(This, pModeToMatch,               \
...
#define IDXGIOutput6_GetDisplayModeList1(This, EnumFormat, Flags, pNumModes,   \
                                         pDesc)                                \
  ((This)->lpVtbl->GetDisplayModeList1(This, EnumFormat, Flags, pNumModes,     \
                                       pDesc))

#define IDXGIOutput6_FindClosestMatchingMode1(This, pModeToMatch,              \
                                              pClosestMatch, pConcernedDevice) \
  ((This)->lpVtbl->FindClosestMatchingMode1(This, pModeToMatch, pClosestMatch, \
                                            pConcernedDevice))
...
#define IDXGIOutput6_CheckOverlaySupport(This, EnumFormat, pConcernedDevice,   \
                                         pFlags)                               \
  ((This)->lpVtbl->CheckOverlaySupport(This, EnumFormat, pConcernedDevice,     \
                                       pFlags))

#define IDXGIOutput6_CheckOverlayColorSpaceSupport(This, Format, ColorSpace,   \
                                                   pConcernedDevice, pFlags)   \
  ((This)->lpVtbl->CheckOverlayColorSpaceSupport(This, Format, ColorSpace,     \
                                                 pConcernedDevice, pFlags))

#define IDXGIOutput6_DuplicateOutput1(This, pDevice, Flags,                    \
                                      SupportedFormatsCount,                   \
                                      pSupportedFormats, ppOutputDuplication)  \
  ((This)->lpVtbl->DuplicateOutput1(This, pDevice, Flags,                      \
                                    SupportedFormatsCount, pSupportedFormats,  \
                                    ppOutputDuplication))
...
typedef struct IDXGIFactory6Vtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(IDXGIFactory6 *This,
                                             /* [in] */ REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);
  ...
  DECLSPEC_XFGVIRT(IDXGIObject, SetPrivateData)
  HRESULT(STDMETHODCALLTYPE *SetPrivateData)(IDXGIFactory6 *This,
                                             /* [annotation][in] */
                                             _In_ REFGUID Name,
                                             /* [in] */ UINT DataSize,
                                             /* [annotation][in] */
  ...
  DECLSPEC_XFGVIRT(IDXGIObject, GetParent)
  HRESULT(STDMETHODCALLTYPE *GetParent)(IDXGIFactory6 *This,
                                        /* [annotation][in] */
                                        _In_ REFIID riid,
                                        /* [annotation][retval][out] */
                                        _COM_Outptr_ void **ppParent);
  ...
  BOOL(STDMETHODCALLTYPE *IsCurrent)(IDXGIFactory6 *This);

  DECLSPEC_XFGVIRT(IDXGIFactory2, IsWindowedStereoEnabled)
  BOOL(STDMETHODCALLTYPE *IsWindowedStereoEnabled)(IDXGIFactory6 *This);
  ...
  HRESULT(STDMETHODCALLTYPE *EnumAdapterByLuid)(IDXGIFactory6 *This,
                                                /* [annotation] */
  ...
  HRESULT(STDMETHODCALLTYPE *EnumWarpAdapter)(IDXGIFactory6 *This,
                                              /* [annotation] */
                                              _In_ REFIID riid,
                                              /* [annotation] */
                                              _COM_Outptr_ void **ppvAdapter);
  ...
  HRESULT(STDMETHODCALLTYPE *CheckFeatureSupport)(
      IDXGIFactory6 *This, DXGI_FEATURE Feature,
      /* [annotation] */
...
interface IDXGIFactory6 { CONST_VTBL struct IDXGIFactory6Vtbl *lpVtbl; };
...
#define IDXGIFactory6_CheckFeatureSupport(This, Feature, pFeatureSupportData,  \
                                          FeatureSupportDataSize)              \
  ((This)->lpVtbl->CheckFeatureSupport(This, Feature, pFeatureSupportData,     \
                                       FeatureSupportDataSize))

#define IDXGIFactory6_EnumAdapterByGpuPreference(This, Adapter, GpuPreference, \
                                                 riid, ppvAdapter)             \
  ((This)->lpVtbl->EnumAdapterByGpuPreference(This, Adapter, GpuPreference,    \
                                              riid, ppvAdapter))
...
typedef struct IDXGIFactory7Vtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(IDXGIFactory7 *This,
                                             /* [in] */ REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);
  ...
  DECLSPEC_XFGVIRT(IDXGIObject, SetPrivateData)
  HRESULT(STDMETHODCALLTYPE *SetPrivateData)(IDXGIFactory7 *This,
                                             /* [annotation][in] */
                                             _In_ REFGUID Name,
                                             /* [in] */ UINT DataSize,
                                             /* [annotation][in] */
  ...
  DECLSPEC_XFGVIRT(IDXGIObject, GetParent)
  HRESULT(STDMETHODCALLTYPE *GetParent)(IDXGIFactory7 *This,
                                        /* [annotation][in] */
                                        _In_ REFIID riid,
                                        /* [annotation][retval][out] */
                                        _COM_Outptr_ void **ppParent);
  ...
  DECLSPEC_XFGVIRT(IDXGIFactory1, IsCurrent)
  BOOL(STDMETHODCALLTYPE *IsCurrent)(IDXGIFactory7 *This);

  DECLSPEC_XFGVIRT(IDXGIFactory2, IsWindowedStereoEnabled)
  BOOL(STDMETHODCALLTYPE *IsWindowedStereoEnabled)(IDXGIFactory7 *This);
  ...
  DECLSPEC_XFGVIRT(IDXGIFactory4, EnumAdapterByLuid)
  HRESULT(STDMETHODCALLTYPE *EnumAdapterByLuid)(IDXGIFactory7 *This,
                                                /* [annotation] */
                                                _In_ LUID AdapterLuid,
                                                /* [annotation] */
                                                _In_ REFIID riid,
  ...
  DECLSPEC_XFGVIRT(IDXGIFactory4, EnumWarpAdapter)
  HRESULT(STDMETHODCALLTYPE *EnumWarpAdapter)(IDXGIFactory7 *This,
                                              /* [annotation] */
                                              _In_ REFIID riid,
                                              /* [annotation] */
                                              _COM_Outptr_ void **ppvAdapter);
  ...
  DECLSPEC_XFGVIRT(IDXGIFactory5, CheckFeatureSupport)
  HRESULT(STDMETHODCALLTYPE *CheckFeatureSupport)(
      IDXGIFactory7 *This, DXGI_FEATURE Feature,
      /* [annotation] */
      _Inout_updates_bytes_(FeatureSupportDataSize) void *pFeatureSupportData,
      UINT FeatureSupportDataSize);
...
interface IDXGIFactory7 { CONST_VTBL struct IDXGIFactory7Vtbl *lpVtbl; };
...
#define IDXGIFactory7_CheckFeatureSupport(This, Feature, pFeatureSupportData,  \
                                          FeatureSupportDataSize)              \
  ((This)->lpVtbl->CheckFeatureSupport(This, Feature, pFeatureSupportData,     \
                                       FeatureSupportDataSize))

#define IDXGIFactory7_EnumAdapterByGpuPreference(This, Adapter, GpuPreference, \
                                                 riid, ppvAdapter)             \
  ((This)->lpVtbl->EnumAdapterByGpuPreference(This, Adapter, GpuPreference,    \
                                              riid, ppvAdapter))
