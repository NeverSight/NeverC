...
//
// NOTE: The definition of FEATURE_DATA_REMOVABLE_MEDIUM is based on MMC 6
// rev 2.
//       MMC 5 rev 4, section 5.3.4, specified bit 4 after feature header as
//       reserved. MMC 6 rev 2, section 5.3.4, specifies this bit as the Load
//       bit.
//
...
typedef struct _FEATURE_DATA_INCREMENTAL_STREAMING_WRITABLE {
  FEATURE_HEADER Header;
  UCHAR DataTypeSupported[2]; // [0] == MSB, [1] == LSB // see also
