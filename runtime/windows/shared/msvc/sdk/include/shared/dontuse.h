...
#undef lstrcpyA
#define lstrcpyA                                                               \
  lstrcpyA_instead_use_strcpy_s_or_StringCchCopyA_or_StringCbCopyA
#undef lstrcpyW
#define lstrcpyW                                                               \
  lstrcpyW_instead_use_wcscpy_s_or_StringCchCopyW_or_StringCbCopyW

#undef lstrcpyn
#define lstrcpyn                                                               \
  lstrcpyn_instead_use_strncpy_s_or_StringCchCopyN_or_StringCbCopyN
#undef lstrcpynA
#define lstrcpynA                                                              \
  lstrcpynA_instead_use_strncpy_s_or_StringCchCopyNA_or_StringCbCopyNA
#undef lstrcpynW
#define lstrcpynW                                                              \
  lstrcpynW_instead_use_wcsncpy_s_or_StringCchCopyNW_or_StringCbCopyNW
...
#undef lstrcatnA
#define lstrcatnA                                                              \
  lstrcatnA_instead_use_strncat_s_or_StringCchCatNA_or_StringCbCatNA
#undef lstrcatnW
#define lstrcatnW                                                              \
  lstrcatnW_instead_use_wcsncat_s_or_StringCchCatNW_or_StringCbCatNW

#undef wsprintf
#define wsprintf                                                               \
  wsprintf_instead_use_sprintf_s_or_StringCchPrintf_or_StringCbPrintf
#undef wsprintfA
#define wsprintfA                                                              \
  wsprintfA_instead_use_sprintf_s_or_StringCchPrintfA_or_StringCbPrintfA
#undef wsprintfW
#define wsprintfW                                                              \
  wsprintfW_instead_use_sprintf_s_or_StringCchPrintfW_or_StringCbPrintfW

#undef wvsprintf
#define wvsprintf                                                              \
  wvsprintf_instead_use_vsprintf_s_or_StringCchVPrintf_or_StringCbVPrintf
#undef wvsprintfA
#define wvsprintfA                                                             \
  wvsprintfA_instead_use_vsprintf_s_or_StringCchVPrintfA_or_StringCbVPrintfA
#undef wvsprintfW
#define wvsprintfW                                                             \
  wvsprintfW_instead_use_swprintf_s_or_StringCchVPrintfW_or_StringCbVPrintfW
...
#undef StrNCpyA
#define StrNCpyA                                                               \
  StrNCpyA_instead_use_strncpy_s_or_StringCchCopyNA_or_StringCbCopyNA
#undef StrNCpyW
#define StrNCpyW                                                               \
  StrNCpyW_instead_use_wcsncpy_s_or_StringCchCopyNW_or_StringCbCopyNW

#undef StrCpyN
#define StrCpyN StrCpyN_instead_use_strncpy_s_or_StringCchCopyN_or_StringCbCopyN
#undef StrCpyNA
#define StrCpyNA                                                               \
  StrCpyNA_instead_use_strncpy_s_or_StringCchCopyNA_or_StringCbCopyNA
#undef StrCpyNW
#define StrCpyNW                                                               \
  StrCpyNW_instead_use_wcsncpy_s_or_StringCchCopyNW_or_StringCbCopyNW
...
#undef StrNCatA
#define StrNCatA                                                               \
  StrNCatA_instead_use_strncat_s_or_StringCchCatNA_or_StringCbCatNA
#undef StrNCatW
#define StrNCatW                                                               \
  StrNCatW_instead_use_wcsncat_s_or_StringCchCatNW_or_StringCbCatNW

#undef StrCatN
#define StrCatN StrCatN_instead_use_strncat_s_or_StringCchCatN_or_StringCbCatN
#undef StrCatNA
#define StrCatNA                                                               \
  StrCatNA_instead_use_strncat_s_or_StringCchCatNA_or_StringCbCatNA
#undef StrCatNW
#define StrCatNW                                                               \
  StrCatNW_instead_use_wcsncat_s_or_StringCchCatNW_or_StringCbCatNW

#undef wnsprintf
#define wnsprintf                                                              \
  wnsprintf_instead_use_vsprintf_s_or_StringCchPrintf_or_StringCbPrintf
#undef wnsprintfA
#define wnsprintfA                                                             \
  wnsprintfA_instead_use_vsprintf_s_or_StringCchPrintfA_or_StringCbPrintfA
#undef wnsprintfW
#define wnsprintfW                                                             \
  wnsprintfW_instead_use_vswprintf_s_or_StringCchPrintfW_or_StringCbPrintfW

#undef wvnsprintf
#define wvnsprintf                                                             \
  wvnsprintf_instead_use_vsprintf_s_or_StringCchVPrintf_or_StringCbVPrintf
#undef wvnsprintfA
#define wvnsprintfA                                                            \
  wvnsprintfA_instead_use_vsprintf_s_or_StringCchVPrintfA_or_StringCbVPrintfA
#undef wvnsprintfW
#define wvnsprintfW                                                            \
  wvnsprintfW_instead_use_vswprintf_s_or_StringCchVPrintfW_or_StringCbVPrintfW

#undef StrCatBuff
#define StrCatBuff                                                             \
  StrCatBuff_instead_use_strcat_s_or_StringCchCat_or_StringCbCat
#undef StrCatBuffA
#define StrCatBuffA                                                            \
  StrCatBuffA_instead_use_strcat_s_or_StringCchCatA_or_StringCbCatA
#undef StrCatBuffW
#define StrCatBuffW                                                            \
  StrCatBuffW_instead_use_strcat_s_or_StringCchCatW_or_StringCbCatW
...
#undef _snprintf
#define _snprintf                                                              \
  _snprintf_instead_use_snprintf_s_or_StringCchPrintf_or_StringCbPrintf
#undef _snwprintf
#define _snwprintf                                                             \
  _snwprintf_instead_use_snwprintf_s_or_StringCchPrintfW_or_StringCbPrintfW
#undef _sntprintf
#define _sntprintf                                                             \
  _sntprintf_instead_use_sprintf_s_or_StringCchPrintf_or_StringCbPrintf

#undef _vsnprintf
#define _vsnprintf                                                             \
  _vsnprintf_instead_use_vsnprintf_s_or_StringCchVPrintf_or_StringCbVPrintf
#undef _vsnwprintf
#define _vsnwprintf                                                            \
  _vsnwprintf_instead_use_vsnwprintf_s_or_StringCchVPrintfW_or_StringCbVPrintfW
#undef _vsntprintf
#define _vsntprintf                                                            \
  _vsntprintf_instead_use_vsprintf_s_or_StringCchVPrintf_or_StringCbVPrintf

#undef vsprintf
#define vsprintf                                                               \
  vsprintf_instead_use_vsprintf_s_or_StringCchVPrintf_or_StringCbVPrintf
#undef vswprintf
#define vswprintf                                                              \
  vswprintf_instead_use_vswprintf_s_or_StringCchVPrintfW_or_StringCbVPrintfW
#undef _vstprintf
#define _vstprintf                                                             \
  _vstprintf_instead_use_vsprintf_s_or_StringCchVPrintf_or_StringCbVPrintf

#undef sprintf
#define sprintf                                                                \
  sprintf_instead_use_sprintf_s_or_StringCchPrintf_or_StringCbPrintf
#undef swprintf
#define swprintf                                                               \
  swprintf_instead_use_swprintf_s_or_StringCchPrintfW_or_StringCbPrintfW
#undef _stprintf
#define _stprintf                                                              \
  _stprintf_instead_use_vsprintf_s_or_StringCchPrintf_or_StringCbPrintf
...
#undef _fstrncat
#define _fstrncat                                                              \
  _fstrncat_instead_use_strncat_s_or_StringCchCatN_or_StringCbCatN
#undef _fstrncpy
#define _fstrncpy                                                              \
  _fstrncpy_instead_use_strncpy_s_or_StringCchCpyN_or_StringCbCpyN

// MISC

#undef sprintfA
#define sprintfA                                                               \
  sprintfA_instead_use_sprintf_s_or_StringCchPrintfA_or_StringCbPrintfA
#undef sprintfW
#define sprintfW                                                               \
  sprintfW_instead_use_swprintf_s_or_StringCchPrintfW_or_StringCbPrintfW
...
#undef nsprintf
#define nsprintf                                                               \
  nsprintf_instead_use_vsprintf_s_or_StringCchPrintf_or_StringCbPrintf
