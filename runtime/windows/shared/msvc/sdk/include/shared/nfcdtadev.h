...
DEFINE_GUID(GUID_DEVINTERFACE_NFCDTA, 0x7fd3f30b, 0x5e49, 0x4be1, 0xb3, 0xaa,
            0xaf, 0x06, 0x26, 0x0d, 0x23, 0x6a);
...
#define IOCTL_NFCDTA_CONFIG_RF_DISCOVERY                                       \
  CTL_CODE(FILE_DEVICE_UNKNOWN, 0x0500, METHOD_BUFFERED,                       \
           FILE_ANY_ACCESS) // Input: NFC_RF_DISCOVERY_CONFIG
#define IOCTL_NFCDTA_REMOTE_DEV_GET_NEXT                                       \
  CTL_CODE(FILE_DEVICE_UNKNOWN, 0x0501, METHOD_BUFFERED,                       \
           FILE_ANY_ACCESS) // Output: NFC_REMOTE_DEV_INFO
#define IOCTL_NFCDTA_REMOTE_DEV_CONNECT                                        \
  CTL_CODE(FILE_DEVICE_UNKNOWN, 0x0502, METHOD_BUFFERED,                       \
           FILE_ANY_ACCESS) // Input: NFC_REMOTE_DEV_HANDLE
#define IOCTL_NFCDTA_REMOTE_DEV_DISCONNECT                                     \
  CTL_CODE(FILE_DEVICE_UNKNOWN, 0x0503, METHOD_BUFFERED,                       \
           FILE_ANY_ACCESS) // Input: NFC_REMOTE_DEVICE_DISCONNET
#define IOCTL_NFCDTA_REMOTE_DEV_TRANSCEIVE                                     \
  CTL_CODE(FILE_DEVICE_UNKNOWN, 0x0504, METHOD_BUFFERED,                       \
           FILE_ANY_ACCESS) // Input: NFC_REMOTE_DEV_SEND_INFO Output:
                            // NFC_REMOTE_DEV_RECV_INFO
#define IOCTL_NFCDTA_REMOTE_DEV_RECV                                           \
  CTL_CODE(FILE_DEVICE_UNKNOWN, 0x0505, METHOD_BUFFERED,                       \
           FILE_ANY_ACCESS) // Output: NFC_REMOTE_DEV_RECV_INFO
#define IOCTL_NFCDTA_REMOTE_DEV_SEND                                           \
  CTL_CODE(FILE_DEVICE_UNKNOWN, 0x0506, METHOD_BUFFERED,                       \
           FILE_ANY_ACCESS) // Input: NFC_REMOTE_DEV_SEND_INFO
#define IOCTL_NFCDTA_REMOTE_DEV_CHECK_PRESENCE                                 \
  CTL_CODE(FILE_DEVICE_UNKNOWN, 0x0507, METHOD_BUFFERED,                       \
           FILE_ANY_ACCESS) // Input: NFC_REMOTE_DEV_HANDLE
#define IOCTL_NFCDTA_CONFIG_P2P_PARAM                                          \
  CTL_CODE(FILE_DEVICE_UNKNOWN, 0x0508, METHOD_BUFFERED,                       \
           FILE_ANY_ACCESS) // Input: NFC_P2P_PARAM_CONFIG
#define IOCTL_NFCDTA_SET_RF_CONFIG                                             \
  CTL_CODE(FILE_DEVICE_UNKNOWN, 0x0509, METHOD_BUFFERED,                       \
           FILE_ANY_ACCESS) // Input: TLV-encoded BYTE array, 1st byte contains
...
#define IOCTL_NFCDTA_REMOTE_DEV_NDEF_WRITE                                     \
  CTL_CODE(FILE_DEVICE_UNKNOWN, 0x0510, METHOD_BUFFERED,                       \
           FILE_ANY_ACCESS) // Input: NFC_REMOTE_DEV_SEND_INFO
#define IOCTL_NFCDTA_REMOTE_DEV_NDEF_READ                                      \
  CTL_CODE(FILE_DEVICE_UNKNOWN, 0x0511, METHOD_BUFFERED,                       \
           FILE_ANY_ACCESS) // Input: NFC_REMOTE_DEV_HANDLE Output:
                            // NFC_REMOTE_DEV_RECV_INFO
#define IOCTL_NFCDTA_REMOTE_DEV_NDEF_CONVERT_READ_ONLY                         \
  CTL_CODE(FILE_DEVICE_UNKNOWN, 0x0512, METHOD_BUFFERED,                       \
           FILE_ANY_ACCESS) // Input: NFC_REMOTE_DEV_HANDLE
#define IOCTL_NFCDTA_REMOTE_DEV_NDEF_CHECK                                     \
  CTL_CODE(                                                                    \
      FILE_DEVICE_UNKNOWN, 0x0513, METHOD_BUFFERED,                            \
      FILE_ANY_ACCESS) // Input: NFC_REMOTE_DEV_HANDLE Output: NFC_NDEF_INFO

//
// LLCP
//
#define IOCTL_NFCDTA_LLCP_CONFIG                                               \
  CTL_CODE(FILE_DEVICE_UNKNOWN, 0x0520, METHOD_BUFFERED,                       \
           FILE_ANY_ACCESS) // Input: NFC_LLCP_CONFIG
#define IOCTL_NFCDTA_LLCP_ACTIVATE                                             \
  CTL_CODE(FILE_DEVICE_UNKNOWN, 0x0521, METHOD_BUFFERED,                       \
           FILE_ANY_ACCESS) // Input: NFC_REMOTE_DEV_HANDLE
#define IOCTL_NFCDTA_LLCP_DEACTIVATE                                           \
  CTL_CODE(FILE_DEVICE_UNKNOWN, 0x0522, METHOD_BUFFERED,                       \
           FILE_ANY_ACCESS) // Input: NFC_REMOTE_DEV_HANDLE
#define IOCTL_NFCDTA_LLCP_DISCOVER_SERVICES                                    \
  CTL_CODE(FILE_DEVICE_UNKNOWN, 0x0523, METHOD_BUFFERED,                       \
           FILE_ANY_ACCESS) // Input: NFC_LLCP_SERVICE_DISCOVER_REQUEST Output:
                            // NFC_LLCP_SERVICE_DISCOVER_SAP
#define IOCTL_NFCDTA_LLCP_LINK_STATUS_CHECK                                    \
  CTL_CODE(FILE_DEVICE_UNKNOWN, 0x0524, METHOD_BUFFERED,                       \
           FILE_ANY_ACCESS) // Input: NFC_REMOTE_DEV_HANDLE
#define IOCTL_NFCDTA_LLCP_GET_NEXT_LINK_STATUS                                 \
  CTL_CODE(FILE_DEVICE_UNKNOWN, 0x0525, METHOD_BUFFERED,                       \
           FILE_ANY_ACCESS) // Output: NFC_LLCP_LINK_STATUS
#define IOCTL_NFCDTA_LLCP_SOCKET_CREATE                                        \
  CTL_CODE(FILE_DEVICE_UNKNOWN, 0x0526, METHOD_BUFFERED,                       \
           FILE_ANY_ACCESS) // Input: NFC_LLCP_SOCKET_INFO Output:
                            // NFC_LLCP_SOCKET_HANDLE
#define IOCTL_NFCDTA_LLCP_SOCKET_CLOSE                                         \
  CTL_CODE(FILE_DEVICE_UNKNOWN, 0x0527, METHOD_BUFFERED,                       \
           FILE_ANY_ACCESS) // Input: NFC_LLCP_SOCKET_HANDLE
#define IOCTL_NFCDTA_LLCP_SOCKET_BIND                                          \
  CTL_CODE(FILE_DEVICE_UNKNOWN, 0x0528, METHOD_BUFFERED,                       \
           FILE_ANY_ACCESS) // Input: NFC_LLCP_SOCKET_SERVICE_INFO
#define IOCTL_NFCDTA_LLCP_SOCKET_LISTEN                                        \
  CTL_CODE(FILE_DEVICE_UNKNOWN, 0x0529, METHOD_BUFFERED,                       \
           FILE_ANY_ACCESS) // Input: NFC_LLCP_SOCKET_HANDLE Output:
                            // NFC_LLCP_SOCKET_HANDLE
#define IOCTL_NFCDTA_LLCP_SOCKET_ACCEPT                                        \
  CTL_CODE(FILE_DEVICE_UNKNOWN, 0x052a, METHOD_BUFFERED,                       \
           FILE_ANY_ACCESS) // Input: NFC_LLCP_SOCKET_ACCEPT_INFO
#define IOCTL_NFCDTA_LLCP_SOCKET_CONNECT                                       \
  CTL_CODE(FILE_DEVICE_UNKNOWN, 0x052b, METHOD_BUFFERED,                       \
           FILE_ANY_ACCESS) // Input: NFC_LLCP_SOCKET_CONNECT_INFO
#define IOCTL_NFCDTA_LLCP_SOCKET_DISCONNECT                                    \
  CTL_CODE(FILE_DEVICE_UNKNOWN, 0x052c, METHOD_BUFFERED,                       \
           FILE_ANY_ACCESS) // Input: NFC_LLCP_SOCKET_HANDLE
#define IOCTL_NFCDTA_LLCP_SOCKET_RECV                                          \
  CTL_CODE(FILE_DEVICE_UNKNOWN, 0x052d, METHOD_BUFFERED,                       \
           FILE_ANY_ACCESS) // Input: NFC_LLCP_SOCKET_HANDLE Output:
                            // NFC_LLCP_SOCKET_PAYLOAD
#define IOCTL_NFCDTA_LLCP_SOCKET_RECV_FROM                                     \
  CTL_CODE(FILE_DEVICE_UNKNOWN, 0x052e, METHOD_BUFFERED,                       \
           FILE_ANY_ACCESS) // Input: NFC_LLCP_SOCKET_HANDLE Output:
                            // NFC_LLCP_SOCKET_PAYLOAD
#define IOCTL_NFCDTA_LLCP_SOCKET_SEND                                          \
  CTL_CODE(FILE_DEVICE_UNKNOWN, 0x052f, METHOD_BUFFERED,                       \
           FILE_ANY_ACCESS) // Input: NFC_LLCP_SOCKET_PAYLOAD
#define IOCTL_NFCDTA_LLCP_SOCKET_SNED_TO                                       \
  CTL_CODE(FILE_DEVICE_UNKNOWN, 0x0530, METHOD_BUFFERED,                       \
           FILE_ANY_ACCESS) // Input: NFC_LLCP_SOCKET_CL_PAYLOAD
#define IOCTL_NFCDTA_LLCP_SOCKET_GET_NEXT_ERROR                                \
  CTL_CODE(FILE_DEVICE_UNKNOWN, 0x0531, METHOD_BUFFERED,                       \
           FILE_ANY_ACCESS) // Input: NFC_LLCP_SOCKET_HANDLE Output:
                            // NFC_LLCP_SOCKET_ERROR_INFO

//
// SNEP Server
//
#define IOCTL_NFCDTA_SNEP_INIT_SERVER                                          \
  CTL_CODE(FILE_DEVICE_UNKNOWN, 0x0540, METHOD_BUFFERED,                       \
           FILE_ANY_ACCESS) // Input: NFC_SNEP_SERVER_INFO Output:
                            // NFC_SNEP_SERVER_HANDLE
#define IOCTL_NFCDTA_SNEP_DEINIT_SERVER                                        \
  CTL_CODE(FILE_DEVICE_UNKNOWN, 0x0541, METHOD_BUFFERED,                       \
           FILE_ANY_ACCESS) // Input: NFC_SNEP_SERVER_HANDLE
#define IOCTL_NFCDTA_SNEP_SERVER_GET_NEXT_CONNECTION                           \
  CTL_CODE(FILE_DEVICE_UNKNOWN, 0x0542, METHOD_BUFFERED,                       \
           FILE_ANY_ACCESS) // Input: NFC_SNEP_SERVER_HANDLE Output:
                            // NFC_SNEP_SERVER_CONNECTION_HANDLE
#define IOCTL_NFCDTA_SNEP_SERVER_ACCEPT                                        \
  CTL_CODE(FILE_DEVICE_UNKNOWN, 0x0543, METHOD_BUFFERED,                       \
           FILE_ANY_ACCESS) // Input: NFC_SNEP_SERVER_ACCEPT_INFO
#define IOCTL_NFCDTA_SNEP_SERVER_GET_NEXT_REQUEST                              \
  CTL_CODE(FILE_DEVICE_UNKNOWN, 0x0544, METHOD_BUFFERED,                       \
           FILE_ANY_ACCESS) // Input: NFC_SNEP_SERVER_HANDLE Output:
                            // NFC_SNEP_SERVER_REQUEST
#define IOCTL_NFCDTA_SNEP_SERVER_SEND_RESPONSE                                 \
  CTL_CODE(FILE_DEVICE_UNKNOWN, 0x0545, METHOD_BUFFERED,                       \
           FILE_ANY_ACCESS) // Input: NFC_SNEP_SERVER_RESPONSE_INFO Output:
                            // NFC_SNEP_SERVER_RESPONSE_INFO

//
// SNEP Client
//
#define IOCTL_NFCDTA_SNEP_INIT_CLIENT                                          \
  CTL_CODE(FILE_DEVICE_UNKNOWN, 0x0550, METHOD_BUFFERED,                       \
           FILE_ANY_ACCESS) // Input: NFC_SNEP_CLIENT_INFO Output:
                            // NFC_SNEP_CLIENT_HANDLE
#define IOCTL_NFCDTA_SNEP_DEINIT_CLIENT                                        \
  CTL_CODE(FILE_DEVICE_UNKNOWN, 0x0551, METHOD_BUFFERED,                       \
           FILE_ANY_ACCESS) // Input: NFC_SNEP_CLIENT_HANDLE
#define IOCTL_NFCDTA_SNEP_CLIENT_PUT                                           \
  CTL_CODE(FILE_DEVICE_UNKNOWN, 0x0552, METHOD_BUFFERED,                       \
           FILE_ANY_ACCESS) // Input: NFC_SNEP_CLIENT_PUT_INFO
#define IOCTL_NFCDTA_SNEP_CLIENT_GET                                           \
  CTL_CODE(FILE_DEVICE_UNKNOWN, 0x0553, METHOD_BUFFERED,                       \
           FILE_ANY_ACCESS) // Input: NFC_SNEP_CLIENT_GET_INFO Output:
                            // NFC_SNEP_CLIENT_DATA_BUFFER

//
// SE
//
#define IOCTL_NFCDTA_SE_ENUMERATE                                              \
  CTL_CODE(FILE_DEVICE_UNKNOWN, 0x0560, METHOD_BUFFERED,                       \
           FILE_ANY_ACCESS) // Output: NFC_SE_LIST
#define IOCTL_NFCDTA_SE_SET_EMULATION_MODE                                     \
  CTL_CODE(FILE_DEVICE_UNKNOWN, 0x0561, METHOD_BUFFERED,                       \
           FILE_ANY_ACCESS) // Input: NFC_SE_EMULATION_MODE_INFO
#define IOCTL_NFCDTA_SE_SET_ROUTING_TABLE                                      \
  CTL_CODE(FILE_DEVICE_UNKNOWN, 0x0562, METHOD_BUFFERED,                       \
           FILE_ANY_ACCESS) // Input: NFC_SE_ROUTING_TABLE
#define IOCTL_NFCDTA_SE_GET_NEXT_EVENT                                         \
  CTL_CODE(FILE_DEVICE_UNKNOWN, 0x0563, METHOD_BUFFERED,                       \
           FILE_ANY_ACCESS) // Output: NFC_SE_EVENT_INFO
...
typedef struct _NFC_LLCP_SERVICE_DISCOVER_REQUEST {
  ...
  _Field_size_(NumberOfEntries)
      NFC_LLCP_SERVICE_NAME_ENTRY ServiceNameEntries[ANYSIZE_ARRAY];
...
#define NFC_LLCP_SERVICE_DISCOVER_SAP_HEADER                                   \
  offsetof(NFC_LLCP_SERVICE_DISCOVER_SAP, SAPEntries)
...
typedef HANDLE NFC_SNEP_SERVER_CONNECTION_HANDLE,
    *PNFC_SNEP_SERVER_CONNECTION_HANDLE;
typedef NFC_LLCP_SOCKET_OPTION NFC_SNEP_SOCKET_OPTION, *PNFC_SNEP_SOCKET_OPTION;
typedef struct _NFC_LLCP_SERVICE_NAME_ENTRY NFC_SNEP_SERVICE_NAME,
    *PNFC_SNEP_SERVICE_NAME;
...
typedef NFC_DATA_BUFFER NFC_SNEP_CLIENT_DATA_BUFFER,
    *PNFC_SNEP_CLIENT_DATA_BUFFER;
...
#define NFC_SNEP_CLIENT_PUT_HEADER                                             \
  offsetof(NFC_SNEP_CLIENT_PUT_INFO, sPutPayload) +                            \
      offsetof(NFC_DATA_BUFFER, pbBuffer)
...
#define NFC_SNEP_CLIENT_GET_HEADER                                             \
  offsetof(NFC_SNEP_CLIENT_GET_INFO, sGetPayload) +                            \
      offsetof(NFC_DATA_BUFFER, pbBuffer)
