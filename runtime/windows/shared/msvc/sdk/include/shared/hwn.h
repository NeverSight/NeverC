...
#define IOCTL_HWN_GET_STATE                                                    \
  CTL_CODE(FILE_DEVICE_UNKNOWN, 1, METHOD_BUFFERED,                            \
           FILE_READ_ACCESS | FILE_WRITE_ACCESS)

DEFINE_GUID(HWN_DEVINTERFACE, 0x81ca6602, 0xdae3, 0x476f, 0x8e, 0x3a, 0x60,
            0x76, 0x6b, 0x2f, 0xff, 0x1b);

DEFINE_GUID(HWN_DEVINTERFACE_VIBRATOR, 0x825e8fd3, 0x6467, 0x4a5b, 0xab, 0xfb,
            0xbb, 0x01, 0x07, 0x34, 0xff, 0x4d);

DEFINE_GUID(HWN_DEVINTERFACE_NLED, 0x6b2a25e2, 0xaaf5, 0x482c, 0x99, 0xa5, 0x62,
            0x05, 0xcd, 0xcc, 0x17, 0x6a);
