...
/*
    Function codes for kernel mode IOCTLs with DeviceType : DEVICE_TYPE_USB
   (a.k.a DEVICE_TYPE_UNKNOWN)
...
DEFINE_GUID(GUID_DEVINTERFACE_USB_BILLBOARD, 0x5e9adaef, 0xf879, 0x473f, 0xb8,
            0x07, 0x4e, 0x5e, 0xa7, 0x7d, 0x1b, 0x1c);
...
DEFINE_GUID(GUID_USB_WMI_STD_DATA, 0x4E623B20L, 0xCB14, 0x11D1, 0xB3, 0x31,
            0x00, 0xA0, 0xC9, 0x59, 0xBB, 0xD2);

/* 4E623B20-CB14-11D1-B331-00A0C959BBD2 */
DEFINE_GUID(GUID_USB_WMI_STD_NOTIFICATION, 0x4E623B20L, 0xCB14, 0x11D1, 0xB3,
...
_IRQL_requires_max_(PASSIVE_LEVEL) typedef VOID (*USB_IDLE_CALLBACK)(
    _In_ PVOID Context);
