...
typedef struct IKEEXT_CERTIFICATE_AUTHENTICATION0_ {
  ...
  /* [switch_is][switch_type] */ union {
    ...
    /* [case()][unique] */ IKEEXT_CERT_ROOT_CONFIG0
...
typedef struct IKEEXT_CERTIFICATE_AUTHENTICATION2_ {
  ...
  /* [switch_is][switch_type] */ union {
    ...
    /* [case()] */ struct {
      ...
      /* [unique][size_is] */ IKEEXT_CERTIFICATE_CRITERIA0
...
typedef struct IKEEXT_AUTHENTICATION_METHOD0_ {
  ...
  /* [switch_is][switch_type] */ union {
    /* [case()] */ IKEEXT_PRESHARED_KEY_AUTHENTICATION0
...
typedef struct IKEEXT_AUTHENTICATION_METHOD1_ {
  IKEEXT_AUTHENTICATION_METHOD_TYPE authenticationMethodType;
  /* [switch_is][switch_type] */ union {
    /* [case()] */ IKEEXT_PRESHARED_KEY_AUTHENTICATION1
    presharedKeyAuthentication;
