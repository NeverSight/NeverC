...
// USAGE:
//
// in your whatever.h file that defines the enums use ENUM or FLAGS(for enums
// defining bitmasks/flags) at the top of the file include this .h at the bottom
// of the file include unexposeenums2managed.h(resets the macro state)
//
...
#define ANALOG_VIDEO_STANDARD_NAMESPACE(x)                                     \
  EHRECVR_MGD_NAMESPACE(AnalogVideoStandard::##x)
#else
