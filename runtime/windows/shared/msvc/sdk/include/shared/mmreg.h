...
#define MM_SPECTRUM_SIGNAL_PROCESSING                                          \
...
#define MM_MSFT_WSS_OEM_FMSYNTH_STEREO                                         \
  20                                 /*  MS OEM Audio Board Stereo FM Synth  */
...
#define MM_MSFT_VMDMS_LINE_WAVEOUT                                             \
  81 /* Voice Modem Serial Line Wave Output                                    \
      */
#define MM_MSFT_VMDMS_HANDSET_WAVEIN                                           \
  82 /* Voice Modem Serial Handset Wave Input */
#define MM_MSFT_VMDMS_HANDSET_WAVEOUT                                          \
  83 /* Voice Modem Serial Handset Wave Output */
#define MM_MSFT_VMDMW_LINE_WAVEIN 84 /* Voice Modem Wrapper Line Wave Input */
#define MM_MSFT_VMDMW_LINE_WAVEOUT                                             \
  85 /* Voice Modem Wrapper Line Wave Output                                   \
      */
#define MM_MSFT_VMDMW_HANDSET_WAVEIN                                           \
  86 /* Voice Modem Wrapper Handset Wave Input */
#define MM_MSFT_VMDMW_HANDSET_WAVEOUT                                          \
  87                           /* Voice Modem Wrapper Handset Wave Output */
#define MM_MSFT_VMDMW_MIXER 88 /* Voice Modem Wrapper Mixer */
#define MM_MSFT_VMDM_GAME_WAVEOUT                                              \
  89 /* Voice Modem Game Compatible Wave Device */
#define MM_MSFT_VMDM_GAME_WAVEIN                                               \
  90 /* Voice Modem Game Compatible Wave Device */
...
#define MM_WANGLABS_WAVEIN1                                                    \
  1 /*  Input audio wave on CPU board models: Exec 4010, 4030, 3450; PC        \
       251/25c, pc 461/25s , pc 461/33c  */
...
#define MM_MOSCOM_VPC2400_IN                                                   \
  1 /*  Four Port Voice Processing / Voice Recognition Board  */
...
#define MM_SILICONSOFT_SC2_WAVEIN                                              \
  3 /*  Waveform in 2 channels, high sample rate  */
#define MM_SILICONSOFT_SC2_WAVEOUT                                             \
  4 /*  Waveform out 2 channels, high sample rate  */
#define MM_SILICONSOFT_SOUNDJR2_WAVEOUT                                        \
  5 /*  Waveform out, self powered, efficient  */
#define MM_SILICONSOFT_SOUNDJR2PR_WAVEIN                                       \
  6 /*  Waveform in, self powered, efficient  */
#define MM_SILICONSOFT_SOUNDJR2PR_WAVEOUT                                      \
  7 /*  Waveform out 2 channels, self powered, efficient  */
#define MM_SILICONSOFT_SOUNDJR3_WAVEOUT                                        \
  8 /*  Waveform in 2 channels, self powered, efficient  */
...
#define MM_BTV_DIGITALIN                                                       \
  9 /* Brooktree PCM Wave in with subcode information                          \
     */
#define MM_BTV_DIGITALOUT                                                      \
  10 /* Brooktree PCM Wave out with subcode information */
...
#define MM_OKSORI_OSR16_WAVEOUT                                                \
  MM_OKSORI_BASE + 3                              /* Oksori 16 bit Wave out    \
                                                   */
...
#define MM_OKSORI_MIX_MASTER                                                   \
  MM_OKSORI_BASE + 6 /* Oksori DSP Mixer - Master Volume */
#define MM_OKSORI_MIX_WAVE                                                     \
  MM_OKSORI_BASE + 7                        /* Oksori DSP Mixer - Wave Volume */
#define MM_OKSORI_MIX_FM MM_OKSORI_BASE + 8 /* Oksori DSP Mixer - FM Volume */
#define MM_OKSORI_MIX_LINE                                                     \
  MM_OKSORI_BASE + 9 /* Oksori DSP Mixer - Line Volume */
#define MM_OKSORI_MIX_CD                                                       \
  MM_OKSORI_BASE + 10 /* Oksori DSP Mixer - CD Volume                          \
                       */
#define MM_OKSORI_MIX_MIC                                                      \
  MM_OKSORI_BASE + 11 /* Oksori DSP Mixer - MIC Volume */
#define MM_OKSORI_MIX_ECHO                                                     \
  MM_OKSORI_BASE + 12 /* Oksori DSP Mixer - Echo Volume */
#define MM_OKSORI_MIX_AUX1                                                     \
  MM_OKSORI_BASE + 13 /* Oksori AD1848 - AUX1 Volume                           \
                       */
#define MM_OKSORI_MIX_LINE1                                                    \
  MM_OKSORI_BASE + 14 /* Oksori AD1848 - LINE1 Volume */
#define MM_OKSORI_EXT_MIC1                                                     \
  MM_OKSORI_BASE + 15 /* Oksori External - One Mic Connect */
#define MM_OKSORI_EXT_MIC2                                                     \
  MM_OKSORI_BASE + 16 /* Oksori External - Two Mic Connect */
...
#define MM_OKSORI_MPEG_CDVISION                                                \
  MM_OKSORI_BASE + 19 /* Oksori CD-Vision MPEG Decoder */
...
#define RIFFINFO_ICRD                                                          \
  mmioFOURCC('I', 'C', 'R', 'D') /*Creation date of subject  */
...
#define RIFFINFO_IPLT                                                          \
  mmioFOURCC('I', 'P', 'L',                                                    \
             'T') /*Palette Settings. No. of colors requested.   */
#define RIFFINFO_IPRD mmioFOURCC('I', 'P', 'R', 'D') /*Product  */
#define RIFFINFO_ISBJ mmioFOURCC('I', 'S', 'B', 'J') /*Subject description  */
#define RIFFINFO_ISFT                                                          \
  mmioFOURCC('I', 'S', 'F',                                                    \
             'T') /*Software. Name of package used to create file.  */
#define RIFFINFO_ISHP mmioFOURCC('I', 'S', 'H', 'P') /*Sharpness.  */
#define RIFFINFO_ISRC mmioFOURCC('I', 'S', 'R', 'C') /*Source.   */
#define RIFFINFO_ISRF                                                          \
  mmioFOURCC('I', 'S', 'R', 'F') /*Source Form. ie slide, paper  */
#define RIFFINFO_ITCH                                                          \
  mmioFOURCC('I', 'T', 'C', 'H') /*Technician who digitized the subject.  */
...
#define RIFFINFO_ITRK                                                          \
  mmioFOURCC('I', 'T', 'R', 'K') /*ASCIIZ representation of the 1-based track  \
                                    number of the content.  */
#define RIFFINFO_ITOC                                                          \
  mmioFOURCC('I', 'T', 'O', 'C') /*A dump of the table of contents from the CD \
...
/* ==========================================================================
 ...
 HE-AAC v1/v2 streams. When setting media type attributes in Media Foundation
 (MF) objects, this will appear in conjunction with major type MFMediaType_Audio
 and sub type MFAudioFormat_AAC (=MEDIASUBTYPE_MPEG_HEAAC). The format block
 structure HEAACWAVEFORMAT is defined below.  It starts with the structure
 HEAACWAVEINFO (which is an extension of WAVEFORMATEX), followed by
 AudioSpecificConfig() as defined by ISO/IEC 14496-3 (MPEG-4 audio). Since the
 length of AudioSpecificConfig() may vary from one stream to another, this is a
 variable size format block.
 ...
 wfx.nChannels - Total number of channels in core AAC stream (including LFE if
 exists). This might be different than the decoded number of channels if the
 MPEG-4 Parametric Stereo (PS) tool exists. If unknown, set to zero.

 wfx.nSamplesPerSec - Sampling rate of core AAC stream. This will be one of the
 12 supported sampling rate between 8000 and 96000 Hz, as defined in MPEG-2.
 This might be different than the decoded sampling rate if the MPEG-4 Spectral
 Band Replication (SBR) tool exists. If not know in advance, the sampling rate
 ...
 average bit rate of the compressed stream. This value may be used by parsers to
 seek into a particular time offset in the stream. It may also be used by
 applications to determine roughly how much buffer length to allocate. If this
 is not known in advance, this value can be estimated by parsing some (or all)
 of the compressed HE-AAC frames and calculating bit rate based on average
 compressed frame size. If unknown, set to zero.

 wfx.nBlockAlign - Set this to 1.

 wfx.wBitsPerSample - Desired bit depth of the decoded PCM. If unknown, set to
 zero.

 wfx.cbSize - Set this to 12 (=sizeof(HEAACWAVEINFO)-sizeof(WAVEFORMATEX)) plus
 the size of AudioSpecificConfig() in bytes.
 ...
 if ( 0 == pwfInfo->wStructType)
 {
    ...
    // and call:
    //
    DWORD dwASCLen = pwf->wfInfo.wfx.cbSize - sizeof(HEAACWAVEINFO) +
 sizeof(WAVEFORMATEX);
...
typedef struct heaacwaveinfo_tag {
  ...
  // profile. If unknown, set to zero or 0xFE ("no audio profile specified").
  WORD wAudioProfileLevelIndication;

  // Defines the data that follows this structure. Currently only one data type
  // is supported: 0- AudioSpecificConfig() (as defined by MPEG-4 Audio, ISO/IEC
  // 14496-3) will follow this structure.
  //    wfx.cbSize will indicate the total length including
  //    AudioSpecificConfig(). Use HEAACWAVEFORMAT to gain easy access to the
  //    address of the first byte of AudioSpecificConfig() for parsing. Typical
  //    values for the size of AudioSpecificConfig (ASC) are:
  ...
  //    field in ASC is zero, which means program_config_element() is present in
  //    ASC.
  //
  // All other codes are reserved.
  WORD wStructType;
...
typedef struct msaudio1waveformat_tag {
  WAVEFORMATEX wfx;
  WORD wSamplesPerBlock; // only counting "new" samples "= half of what will be
                         // used due to overlapping
  WORD wEncodeOptions;
} MSAUDIO1WAVEFORMAT;
...
typedef struct wmaudio2waveformat_tag {
  WAVEFORMATEX wfx;
  DWORD dwSamplesPerBlock; // only counting "new" samples "= half of what will
                           // be used due to overlapping
  WORD wEncodeOptions;
  DWORD dwSuperBlockAlign; // the big size...  should be multiples of
                           // wfx.nBlockAlign.
} WMAUDIO2WAVEFORMAT;
...
/* New DIB Compression Defines */
#define JPEG_DIB                                                               \
  mmioFOURCC('J', 'P', 'E', 'G') /* Still image JPEG DIB biCompression */
#define MJPG_DIB                                                               \
  mmioFOURCC('M', 'J', 'P', 'G') /* Motion JPEG DIB biCompression     */
