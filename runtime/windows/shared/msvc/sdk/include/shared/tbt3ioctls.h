...
Abstract:
    ...
    Common header file for all user-mode IOCTLs defined for Thunderbolt 3
routers
...
DEFINE_GUID(GUID_TBT3_FW_UPDATE_INTERFACE, 0x9013316D, 0x7092, 0x4E8E, 0x8F,
            0x9D, 0x24, 0x21, 0x49, 0x77, 0xAD, 0xCE);
...
#define IOCTL_TBT3_GET_UUID                                                    \
  CTL_CODE(FILE_DEVICE_USB4, TBT3_GET_UUID, METHOD_BUFFERED, FILE_ANY_ACCESS)

#define IOCTL_TBT3_NVM_WRITE                                                   \
  CTL_CODE(FILE_DEVICE_USB4, TBT3_NVM_WRITE, METHOD_BUFFERED, FILE_ANY_ACCESS)

#define IOCTL_TBT3_NVM_WRITE_AUTHENTICATE                                      \
  CTL_CODE(FILE_DEVICE_USB4, TBT3_NVM_WRITE_AUTHENTICATE, METHOD_BUFFERED,     \
           FILE_ANY_ACCESS)

#define IOCTL_TBT3_NVM_READ                                                    \
  CTL_CODE(FILE_DEVICE_USB4, TBT3_NVM_READ, METHOD_BUFFERED, FILE_ANY_ACCESS)

#define IOCTL_TBT3_NVM_POWER_CYCLE                                             \
  CTL_CODE(FILE_DEVICE_USB4, TBT3_NVM_POWER_CYCLE, METHOD_BUFFERED,            \
           FILE_ANY_ACCESS)
