...
// the IP header of transmitted packets, with the value in the object.
// Otherwise, hosts may select a value based on the standard Intserv mapping of
// ServiceType to DS Field
//
...
//
// This structure is used to create DiffServ Flows. This creates flows in the
// packet scheduler and allows it to classify to packets based on a particular
// DS field. This structure takes a variable length array of QOS_DIFFSERV_RULE,
// where each DS field is specified by a QOS_DIFFSERV_RULE
//
...
// mappings for the flow have to be set to the system defaults for TCP traffic.
// If this object is passed, the ServiceType ==> DSField mapping, ServiceType
// ==> UserPriorityMapping, QOS_OBJECT_DS_CLASS and QOS_OBJECT_TRAFFIC_CLASS
// will be ignored.
//
