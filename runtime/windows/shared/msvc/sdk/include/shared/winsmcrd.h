...
// Since using the optimal parameters is the default case no bit is defined to
// be 1
//
...
#define SCARD_ATTR_VENDOR_SPECIFIC_INFO                                        \
  SCARD_ATTR_VALUE(SCARD_CLASS_VENDOR_DEFINED, 0xA008)
