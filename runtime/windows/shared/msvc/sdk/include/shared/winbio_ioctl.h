...
//
DEFINE_GUID(GUID_DEVINTERFACE_BIOMETRIC_READER, 0xe2b5183a, 0x99ea, 0x4cc3,
            0xad, 0x6b, 0x80, 0xca, 0x8d, 0x71, 0x5b, 0x80);
...
typedef struct _WINBIO_SENSOR_ATTRIBUTES {
  ...
  SupportedFormat[1]; // Defined as a length of 1 to avoid compiler warning.
...
//
// IN payload for IOCTL_BIOMETRIC_CONNECT_SECURE is a
// WINBIO_SECURE_CONNECTION_PARAMS structure
//

//
// OUT payload for IOCTL_BIOMETRIC_CONNECT_SECURE is a
// WINBIO_SECURE_CONNECTION_DATA structure
//
...
//
// OUT payload for IOCTL_BIOMETRIC_CAPTURE_ENCRYPTED_DATA is a
