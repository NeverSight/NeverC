...
#ifdef MIDL_PASS
  [size_is(
      bCertificateAssociationDataLength)] BYTE bCertificateAssociationData[];
#else
...
#ifdef MIDL_PASS
  [size_is(cWinsServerCount)] IP4_ADDRESS WinsServers[];
#else
...
#pragma warning(push)
#pragma warning(disable : 4201) // nameless struct/union (anonymous union for
                                // SVCB parameter variants)
...
typedef _Struct_size_bytes_(FIELD_OFFSET(struct _DnsRecordW, Data) +
                            wDataLength) struct _DnsRecordW {
...
typedef _Struct_size_bytes_(FIELD_OFFSET(struct _DnsRecordA, Data) +
                            wDataLength) struct _DnsRecordA {
...
#pragma warning(push)
#pragma warning(disable : 4201) // nameless struct/union (anonymous unions for
                                // DNS_CUSTOM_SERVER representation variants)
...
typedef struct _DNS_CUSTOM_SERVER {
  ...
  [switch_type(DWORD)][switch_is(dwServerType)] union {
