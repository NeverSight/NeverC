...
#pragma warning(disable                                                        \
                : 4201) /* Disable warning C4201:nameless struct/union */
#pragma warning(                                                               \
    disable : 4214) /* Disable warning C4201:bit field types other than int */
#endif
...
// DEFINE_GUID(GUID_DISPLAY_OUTPUT_INTERFACE_STANDARD,  0x96304D9F, 0x54b5,
// 0x11d1, 0x8b, 0x0f, 0x00, 0xa0, 0xc9, 0x06, 0x8f, 0xf3);
...
DEFINE_GUID(GUID_DEVINTERFACE_MONITOR, 0xe6f07b5f, 0xee97, 0x4a90, 0xb0, 0x76,
...
// This includes Display only, Full graphics adapters, etc., but excludes MCDM
// (Compute only devices). {1CA05180-A699-450A-9A0C-DE4FBE3DDD89}
//

DEFINE_GUID(GUID_DISPLAY_DEVICE_ARRIVAL, 0x1CA05180, 0xA699, 0x450A, 0x9A, 0x0C,
            0xDE, 0x4F, 0xBE, 0x3D, 0xDD, 0x89);
...
DEFINE_GUID(GUID_DEVINTERFACE_VIDEO_OUTPUT_ARRIVAL, 0x1AD9E4F0, 0xF88D, 0x4360,
            0xBA, 0xB9, 0x4C, 0x2D, 0x55, 0xE5, 0x64, 0xCD);
...
DEFINE_GUID(GUID_DEVINTERFACE_DISPLAYMUX, 0x93c33929, 0x3180, 0x46d3, 0x8a,
            0xab, 0x00, 0x8c, 0x84, 0xad, 0x1e, 0x6e);

#ifdef DEFINE_DEVPROPKEY

//
// Property on a display class device's DevNode indicating that it is a indirect
// display
//

DEFINE_DEVPROPKEY(DEVPKEY_IndirectDisplay, 0xc50a3f10, 0xaa5c, 0x4247, 0xb8,
                  0x30, 0xd6, 0xa6, 0xf8, 0xea, 0xa3, 0x10, 0x01);
DEFINE_DEVPROPKEY(DEVPKEY_Device_TerminalLuid, 0xc50a3f10, 0xaa5c, 0x4247, 0xb8,
                  0x30, 0xd6, 0xa6, 0xf8, 0xea, 0xa3, 0x10,
                  0x02); // DEVPROP_TYPE_BINARY
DEFINE_DEVPROPKEY(DEVPKEY_Device_AdapterLuid, 0xc50a3f10, 0xaa5c, 0x4247, 0xb8,
                  0x30, 0xd6, 0xa6, 0xf8, 0xea, 0xa3, 0x10,
                  0x03); // DEVPROP_TYPE_BINARY
DEFINE_DEVPROPKEY(DEVPKEY_Device_ActivityId, 0xc50a3f10, 0xaa5c, 0x4247, 0xb8,
                  0x30, 0xd6, 0xa6, 0xf8, 0xea, 0xa3, 0x10,
                  0x04); // DEVPROP_TYPE_BINARY
...
#define INDIRECT_DISPLAY_INFO_FLAGS_CREATED_IDDCX_ADAPTER                      \
  0x1 // This indirect display device created a IddCx adapter
#define INDIRECT_DISPLAY_INFO_FLAGS_SUPPORT_FP16                               \
  0x2 // This indirect display device supports FP16
...
DEFINE_DEVPROPKEY(DEVPKEY_DisplayMux_InitStatus, 0xfefa7434, 0xe0fd, 0x4b2a,
                  0x90, 0x5a, 0x7d, 0x01, 0x27, 0xa9, 0xf0, 0x1c, 1); //
DEFINE_DEVPROPKEY(DEVPKEY_DisplayMux_SupportLevel, 0xfefa7434, 0xe0fd, 0x4b2a,
                  0x90, 0x5a, 0x7d, 0x01, 0x27, 0xa9, 0xf0, 0x1c,
                  2); // DEVPROP_TYPE_UINT32
DEFINE_DEVPROPKEY(DEVPKEY_DisplayMux_MuxTarget1, 0xfefa7434, 0xe0fd, 0x4b2a,
                  0x90, 0x5a, 0x7d, 0x01, 0x27, 0xa9, 0xf0, 0x1c,
                  3); // DEVPROP_TYPE_BINARY
DEFINE_DEVPROPKEY(DEVPKEY_DisplayMux_MuxTarget2, 0xfefa7434, 0xe0fd, 0x4b2a,
                  0x90, 0x5a, 0x7d, 0x01, 0x27, 0xa9, 0xf0, 0x1c,
                  4); // DEVPROP_TYPE_BINARY
DEFINE_DEVPROPKEY(DEVPKEY_DisplayMux_CurrentTarget, 0xfefa7434, 0xe0fd, 0x4b2a,
                  0x90, 0x5a, 0x7d, 0x01, 0x27, 0xa9, 0xf0, 0x1c,
                  5); // DEVPROP_TYPE_BINARY
...
// WARNING: New code should use the new WMI interface, old code should be
// updated to use WMI interfaces
...
//
// All these IOCTL's were handled by the East Asia Full Screen Video driver but
// are no longer supported
//

#define IOCTL_FSVIDEO_COPY_FRAME_BUFFER                                        \
  CTL_CODE(FILE_DEVICE_FULLSCREEN_VIDEO, 0x200, METHOD_BUFFERED,               \
           FILE_ANY_ACCESS)

#define IOCTL_FSVIDEO_WRITE_TO_FRAME_BUFFER                                    \
  CTL_CODE(FILE_DEVICE_FULLSCREEN_VIDEO, 0x201, METHOD_BUFFERED,               \
           FILE_ANY_ACCESS)

#define IOCTL_FSVIDEO_REVERSE_MOUSE_POINTER                                    \
  CTL_CODE(FILE_DEVICE_FULLSCREEN_VIDEO, 0x202, METHOD_BUFFERED,               \
           FILE_ANY_ACCESS)

#define IOCTL_FSVIDEO_SET_CURRENT_MODE                                         \
  CTL_CODE(FILE_DEVICE_FULLSCREEN_VIDEO, 0x203, METHOD_BUFFERED,               \
           FILE_ANY_ACCESS)

#define IOCTL_FSVIDEO_SET_SCREEN_INFORMATION                                   \
  CTL_CODE(FILE_DEVICE_FULLSCREEN_VIDEO, 0x204, METHOD_BUFFERED,               \
           FILE_ANY_ACCESS)

#define IOCTL_FSVIDEO_SET_CURSOR_POSITION                                      \
  CTL_CODE(FILE_DEVICE_FULLSCREEN_VIDEO, 0x205, METHOD_BUFFERED,               \
           FILE_ANY_ACCESS)

//
// Panel control IOCLTs must/can be handled by the monitor, oem-panel,
...
//
// Colorspace Transform control IOCLTs must/can be handled by the monitor,
// oem-panel, port/miniport driver
//
...
typedef struct tagVIDEO_MONITOR_DESCRIPTOR {
  ...
  UCHAR Descriptor[1]; // Start of descriptor data (actual size is determined by
                       // DescriptorSize)
...
#define DXGK_WIN32K_PARAM_FLAG_UPDATEREGISTRY                                  \
  1 // Saves the mode switch information into the registry.
#define DXGK_WIN32K_PARAM_FLAG_MODESWITCH 2 // Performs the mode switch.
#define DXGK_WIN32K_PARAM_FLAG_DISABLEVIEW                                     \
  4 // Disables the view which we're interested in.
...
// Used by WDDM infrastructure to determine whether a device is the VGA one or
// not.
...
//
// BasicAttribContOffset - Offset, in bytes, from the beginning of the
// structure,
//    to an array of fields containing the register values for the basic
...
//    latches of the VGA.
//
// ExtendedSequencerOffset - Offset, in bytes, from the beginning of the
// structure,
//    to an array of fields containing the registers values for the extended
//    sequencer register set of the VGA.
//
// ExtendedCrtContOffset - Offset, in bytes, from the beginning of the
// structure,
//    to an array of fields containing the registers values for the extended
//    CRT register set of the VGA.
//
// ExtendedGraphContOffset - Offset, in bytes, from the beginning of the
// structure,
//    to an array of fields containing the registers values for the extended
//    graphics controller register set of the VGA.
//
// ExtendedAttribContOffset - Offset, in bytes, from the beginning of the
// structure,
//    to an array of fields containing the registers values for the extended
//    attribute controller register set of the VGA.
//
...
//    DOS apps.
//
// ExtendedMiscDataOffset - Offset, in bytes, from the beginning of the
// structure,
...
//
// IOCTL_VIDEO_SET_COLOR_LUT_DATA - Confugure color look up table on video
// adaptor.
//
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
//
// WARNING: Supported only for backwards compatibility with XPSP1 and should be
// retired - new code should use the new WMI interface
//
// IOCTL_VIDEO_QUERY_SUPPORTED_BRIGHTNESS - Queries via _BCL the available
// backlight
//                                          levels.
// IOCTL_VIDEO_QUERY_DISPLAY_BRIGHTNESS   - Queries the current AC/DC backlight
// levels
//                                          and indicates the current power
//                                          state per ucDisplayPolicy.
// IOCTL_VIDEO_SET_DISPLAY_BRIGHTNESS     - Sets via _BCM the AC/DC brightness
// of the
//                                          backlight for the power states
//                                          indicated in ucDisplayPolicy.
//
...
#define COMMON_LVB_GRID_HORIZONTAL                                             \
  0x0400 // DBCS: Grid attribute: top horizontal.
#define COMMON_LVB_GRID_LVERTICAL 0x0800 // DBCS: Grid attribute: left vertical.
#define COMMON_LVB_GRID_RVERTICAL                                              \
  0x1000 // DBCS: Grid attribute: right vertical.
#define COMMON_LVB_REVERSE_VIDEO                                               \
  0x4000 // DBCS: Reverse fore/back ground attribute.
...
// Share of consrv.h
//
#define SCREEN_BUFFER_POINTER(X, Y, XSIZE, CELLSIZE)                           \
  (((XSIZE * (Y)) + (X)) * (ULONG)CELLSIZE)
...
//
// IOCTL_FSVIDEO_REVERSE_MOUSE_POINTER - Reverse to the frame buffer for mouse
// pointer.
//
// dwType as follows:
...
//
// IOCTL_FSVIDEO_SET_SCREEN_INFORMATION - Set the information for current
// console screen
//
...
typedef struct _COLORSPACE_TRANSFORM_DATA_CAP {
  ...
  union {
    struct {
      ULONG BitCountOfInteger
          : 6; // Bit count of integer if DataType is
               // fixed-point(COLORSPACE_TRANSFORM_DATA_TYPE_FIXED_POINT)
      ULONG BitCountOfFraction
          : 6; // Bit count of fraction if DataType is
               // fixed-point(COLORSPACE_TRANSFORM_DATA_TYPE_FIXED_POINT)
    };

    struct {
      ULONG BitCountOfExponent
          : 6; // Bit count of exponent if the DataType is
               // float(COLORSPACE_TRANSFORM_DATA_TYPE_FLOAT)
      ULONG BitCountOfMantissa
          : 6; // Bit count of mantissa if the DataType is
               // float(COLORSPACE_TRANSFORM_DATA_TYPE_FLOAT)
    };
  ...
  float NumericRangeMax; // Maximum number of gamma data
                         // Examples: [-4, 4]:    NumericRangeMin =   -4;
                         // NumericRangeMax = 4
                         //           [0,  1]:    NumericRangeMin =    0;
                         //           NumericRangeMax = 1
                         //           [-1.5, 2.5]:NumericRangeMin = -1.5;
                         //           NumericRangeMax = 2.5 [0, 65504]:
                         //           NumericRangeMin =    0; NumericRangeMax =
                         //           65504
...
typedef struct _COLORSPACE_TRANSFORM {
  ...
  union {
    GAMMA_RAMP_RGB256x3x16
        Rgb256x3x16;         // Type == COLORSPACE_TRANSFORM_TYPE_RGB256x3x16.
    GAMMA_RAMP_DXGI_1 Dxgi1; // Type == COLORSPACE_TRANSFORM_TYPE_DXGI_1.
    COLORSPACE_TRANSFORM_3x4
        T3x4; // Type == COLORSPACE_TRANSFORM_TYPE_MATRIX_3x4.
    COLORSPACE_TRANSFORM_MATRIX_V2
    MatrixV2; // Type == COLORSPACE_TRANSFORM_TYPE_MATRIX_V2.
  } Data;
...
typedef struct _MIPI_DSI_TRANSMISSION {
  ...
  _Field_size_(PacketCount) MIPI_DSI_PACKET Packets[1]; // inout
...
typedef MIPI_DSI_TRANSMISSION MIPI_DSI_TRANSMISSION_INPUT,
    *PMIPI_DSI_TRANSMISSION_INPUT;
typedef MIPI_DSI_TRANSMISSION MIPI_DSI_TRANSMISSION_OUTPUT,
    *PMIPI_DSI_TRANSMISSION_OUTPUT;
...
DEFINE_GUID(GUID_MONITOR_OVERRIDE_PSEUDO_SPECIALIZED, 0xf196c02f, 0xf86f,
            0x4f9a, 0xaa, 0x15, 0xe9, 0xce, 0xbd, 0xfe, 0x3b, 0x96);

// {0457E531-3CB9-4A07-83C1-A79146C64DB3}
DEFINE_GUID(GUID_MONITOR_OVERRIDE_TEST_SPECIALIZED, 0x457e531, 0x3cb9, 0x4a07,
            0x83, 0xc1, 0xa7, 0x91, 0x46, 0xc6, 0x4d, 0xb3);
