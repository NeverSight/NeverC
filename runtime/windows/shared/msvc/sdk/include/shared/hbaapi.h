...
typedef struct HBA_RSCN_EventInfo {
  HBA_UINT32 PortFcId; /* Port which this event occurred */
  HBA_UINT32
  NPortPage; /* Reference FC-FS for RSCN ELS "Affected N-Port Pages"*/
...
HBA_STATUS HBA_API HBA_GetAdapterName(_In_ HBA_UINT32 AdapterIndex,
                                      _Inout_updates_(MAX_NAME)
                                          PSTR AdapterName);

HBA_HANDLE HBA_API HBA_OpenAdapter(_In_ PSTR AdapterName);

void HBA_API HBA_CloseAdapter(IN HBA_HANDLE handle);

HBA_STATUS HBA_API HBA_GetAdapterAttributes(
    IN HBA_HANDLE Handle, OUT HBA_ADAPTERATTRIBUTES *HbaAttributes);

HBA_STATUS HBA_API
HBA_GetAdapterPortAttributes(IN HBA_HANDLE Handle, IN HBA_UINT32 PortIndex,
                             OUT HBA_PORTATTRIBUTES *PortAttributes);

HBA_STATUS HBA_API
HBA_GetPortStatistics(IN HBA_HANDLE Handle, IN HBA_UINT32 PortIndex,
                      OUT HBA_PORTSTATISTICS *PortStatistics);

HBA_STATUS HBA_API HBA_GetDiscoveredPortAttributes(
    IN HBA_HANDLE Handle, IN HBA_UINT32 PortIndex,
    IN HBA_UINT32 DiscoveredPortIndex, OUT HBA_PORTATTRIBUTES *PortAttributes);

HBA_STATUS HBA_API
HBA_GetPortAttributesByWWN(IN HBA_HANDLE Handle, IN HBA_WWN PortWWN,
                           OUT HBA_PORTATTRIBUTES *PortAttributes);

HBA_STATUS HBA_API HBA_SendCTPassThru(IN HBA_HANDLE Handle, IN void *pReqBuffer,
                                      IN HBA_UINT32 ReqBufferSize,
                                      OUT void *pRspBuffer,
                                      IN HBA_UINT32 RspBufferSize);

HBA_STATUS HBA_API HBA_GetEventBuffer(IN HBA_HANDLE Handle,
                                      OUT PHBA_EVENTINFO EventBuffer,
                                      IN OUT HBA_UINT32 *EventCount);

HBA_STATUS HBA_API HBA_SetRNIDMgmtInfo(IN HBA_HANDLE Handle,
                                       IN HBA_MGMTINFO *pInfo);

HBA_STATUS HBA_API HBA_GetRNIDMgmtInfo(IN HBA_HANDLE Handle,
                                       OUT HBA_MGMTINFO *pInfo);

HBA_STATUS HBA_API HBA_SendRNID(IN HBA_HANDLE Handle, IN HBA_WWN Wwn,
                                IN HBA_WWNTYPE WnnType, OUT void *pRspBuffer,
                                IN OUT HBA_UINT32 *RspBufferSize);

HBA_STATUS HBA_API HBA_GetFcpTargetMapping(
    IN HBA_HANDLE Handle, IN OUT PHBA_FCPTARGETMAPPING Mapping);

HBA_STATUS HBA_API HBA_GetFcpPersistentBinding(IN HBA_HANDLE Handle,
                                               IN OUT PHBA_FCPBINDING Binding);

HBA_STATUS HBA_API HBA_SendScsiInquiry(IN HBA_HANDLE Handle, IN HBA_WWN PortWWN,
                                       IN HBA_UINT64 FcLUN, IN HBA_UINT8 EVPD,
...
HBA_STATUS HBA_API HBA_SendReportLUNs(IN HBA_HANDLE Handle, IN HBA_WWN PortWWN,
                                      OUT void *pRspBuffer,
                                      IN HBA_UINT32 RspBufferSize,
                                      OUT void *pSenseBuffer,
                                      IN HBA_UINT32 SenseBufferSize);

HBA_STATUS HBA_API HBA_SendReadCapacity(IN HBA_HANDLE Handle,
                                        IN HBA_WWN PortWWN, IN HBA_UINT64 FcLUN,
                                        OUT void *pRspBuffer,
                                        IN HBA_UINT32 RspBufferSize,
                                        OUT void *pSenseBuffer,
                                        IN HBA_UINT32 SenseBufferSize);

void HBA_API HBA_RefreshInformation(IN HBA_HANDLE Handle);

void HBA_API HBA_ResetStatistics(IN HBA_HANDLE Handle, IN HBA_UINT32 PortIndex);
...
HBA_STATUS HBA_API HBA_RemoveCallback(IN HBA_CALLBACKHANDLE callbackHandle);

HBA_STATUS HBA_API HBA_RegisterForAdapterAddEvents(
    IN void (*callback)(void *pData, HBA_WWN PortWWN, HBA_UINT32 eventType),
    IN void *pUserData, OUT HBA_CALLBACKHANDLE *pCallbackHandle);

HBA_STATUS HBA_API HBA_RegisterForAdapterEvents(
    IN void (*callback)(void *pData, HBA_WWN PortWWN, HBA_UINT32 eventType),
    IN void *pUserData, IN HBA_HANDLE Handle,
    OUT HBA_CALLBACKHANDLE *pCallbackHandle);

HBA_STATUS HBA_API HBA_RegisterForAdapterPortEvents(
    IN void (*callback)(void *pData, HBA_WWN PortWWN, HBA_UINT32 eventType,
                        HBA_UINT32 fabricPortID),
    IN void *UserData, IN HBA_HANDLE Handle, IN HBA_WWN PortWWN,
    OUT HBA_CALLBACKHANDLE *pCallbackHandle);

HBA_STATUS HBA_API HBA_RegisterForAdapterPortStatEvents(
    IN void (*callback)(void *pData, HBA_WWN PortWWN, HBA_UINT32 eventType),
    IN void *pUserData, IN HBA_HANDLE Handle, IN HBA_WWN PortWWN,
    IN HBA_PORTSTATISTICS stats, IN HBA_UINT32 statType,
    OUT HBA_CALLBACKHANDLE *pCallbackHandle);

HBA_STATUS HBA_API HBA_RegisterForTargetEvents(
    IN void (*callback)(void *pData, HBA_WWN hbaPortWWN,
                        HBA_WWN discoveredPortWWN, HBA_UINT32 eventType),
    IN void *pUserData, IN HBA_HANDLE Handle, IN HBA_WWN HbaPortWWN,
    IN HBA_WWN DiscoveredPortWWN, OUT HBA_CALLBACKHANDLE *pCallbackHandle,
...
HBA_STATUS HBA_API HBA_RegisterForLinkEvents(
    ...
    IN void *userData, IN void *pRLIRBuffer, IN HBA_UINT32 RLIRBufferSize,
    IN HBA_HANDLE Handle, OUT HBA_CALLBACKHANDLE *pCallbackHandle);

HBA_STATUS HBA_API HBA_OpenAdapterByWWN(OUT HBA_HANDLE *HbaHandle,
                                        IN HBA_WWN Wwn);

void HBA_API HBA_RefreshAdapterConfiguration();

HBA_STATUS HBA_API HBA_SendCTPassThruV2(IN HBA_HANDLE Handle,
...
HBA_STATUS HBA_API HBA_SendRNIDV2(IN HBA_HANDLE Handle, IN HBA_WWN HbaPortWWN,
                                  IN HBA_WWN DestWWN, IN HBA_UINT32 DestFCID,
                                  IN HBA_UINT32 NodeIdDataFormat,
                                  OUT void *pRspBuffer,
                                  IN OUT HBA_UINT32 *pRspBufferSize);

HBA_STATUS HBA_API HBA_SendRPL(IN HBA_HANDLE Handle, IN HBA_WWN HbaPortWWN,
                               IN HBA_WWN Agent_wwn, IN HBA_UINT32 Agent_domain,
                               IN HBA_UINT32 PortIndex, OUT void *pRspBuffer,
                               IN OUT HBA_UINT32 *pRspBufferSize);

HBA_STATUS HBA_API HBA_SendRPS(IN HBA_HANDLE Handle, IN HBA_WWN HbaPortWWN,
                               IN HBA_WWN Agent_wwn, IN HBA_UINT32 Agent_domain,
...
HBA_STATUS HBA_API HBA_SendSRL(IN HBA_HANDLE Handle, IN HBA_WWN HbaPortWWN,
                               IN HBA_WWN Wwn, IN HBA_UINT32 Domain,
                               OUT void *pRspBuffer,
                               IN OUT HBA_UINT32 *pRspBufferSize);

HBA_STATUS HBA_API HBA_SendLIRR(IN HBA_HANDLE Handle, IN HBA_WWN SourceWWN,
                                IN HBA_WWN DestWWN, IN HBA_UINT8 Function,
                                IN HBA_UINT8 Type, OUT void *pRspBuffer,
                                IN OUT HBA_UINT32 *pRspBufferSize);

HBA_STATUS HBA_API HBA_SendRLS(IN HBA_HANDLE HbaHandle, IN HBA_WWN HbaPortWWN,
                               IN HBA_WWN DestWWN, OUT void *pRspBuffer,
                               IN OUT HBA_UINT32 *pRspBufferSize);

HBA_STATUS HBA_API HBA_GetFC4Statistics(IN HBA_HANDLE Handle,
                                        IN HBA_WWN PortWWN,
                                        IN HBA_UINT8 FC4type,
                                        OUT HBA_FC4STATISTICS *Statistics);

HBA_STATUS HBA_API HBA_GetFCPStatistics(IN HBA_HANDLE Handle,
...
HBA_UINT32 HBA_API
HBA_GetWrapperLibraryAttributes(OUT HBA_LIBRARYATTRIBUTES *Attributes);

HBA_UINT32 HBA_API HBA_GetVendorLibraryAttributes(
    IN HBA_UINT32 AdapterIndex, OUT HBA_LIBRARYATTRIBUTES *Attributes);

HBA_STATUS HBA_API HBA_ScsiReadCapacityV2(
    IN HBA_HANDLE HbaHandle, IN HBA_WWN HbaPortWWN,
    IN HBA_WWN DiscoveredPortWWN, IN HBA_UINT64 FcLUN, OUT void *pRespBuffer,
    IN OUT HBA_UINT32 *pRespBufferSize, OUT HBA_UINT8 *pScsiStatus,
    OUT void *pSenseBuffer, IN OUT HBA_UINT32 *pSenseBufferSize);

HBA_STATUS HBA_API HBA_ScsiReportLUNsV2(
    IN HBA_HANDLE Hbahandle, IN HBA_WWN HbaPortWWN,
    IN HBA_WWN DiscoveredPortWWN, OUT void *pRespBuffer,
    IN OUT HBA_UINT32 *pRespBufferSize, OUT HBA_UINT8 *pScsiStatus,
    OUT void *pSenseBuffer, IN OUT HBA_UINT32 *pSenseBufferSize);

HBA_STATUS HBA_API HBA_ScsiInquiryV2(
    IN HBA_HANDLE HbaHandle, IN HBA_WWN HbaPortWWN,
    IN HBA_WWN DiscoveredPortWWN, IN HBA_UINT64 FcLUN, IN HBA_UINT8 CDB_Byte1,
    IN HBA_UINT8 CDB_Byte2, OUT void *pRespBuffer,
    IN OUT HBA_UINT32 *pRespBufferSize, OUT HBA_UINT8 *pScsiStatus,
    OUT void *pSenseBuffer, IN OUT HBA_UINT32 *pSenseBufferSize);

HBA_STATUS HBA_API
HBA_GetFcpTargetMappingV2(IN HBA_HANDLE HbaHandle, IN HBA_WWN HbaPortWWN,
                          IN OUT HBA_FCPTARGETMAPPINGV2 *Mapping);

HBA_STATUS HBA_API HBA_GetBindingCapability(IN HBA_HANDLE Handle,
                                            IN HBA_WWN HbaPortWWN,
                                            OUT HBA_BIND_CAPABILITY *Flags);

HBA_STATUS HBA_API HBA_GetBindingSupport(IN HBA_HANDLE Handle,
                                         IN HBA_WWN HbaPortWWN,
                                         OUT HBA_BIND_CAPABILITY *Flags);

HBA_STATUS HBA_API HBA_SetBindingSupport(IN HBA_HANDLE Handle,
                                         IN HBA_WWN HbaPortWWN,
                                         IN HBA_BIND_CAPABILITY Flags);

HBA_STATUS HBA_API HBA_GetPersistentBindingV2(IN HBA_HANDLE Handle,
                                              IN HBA_WWN HbaPortWWN,
                                              IN OUT PHBA_FCPBINDING2 Binding);

HBA_STATUS HBA_API HBA_SetPersistentBindingV2(IN HBA_HANDLE Handle,
                                              IN HBA_WWN HbaPortWWN,
                                              IN PHBA_FCPBINDING2 Binding);

HBA_STATUS HBA_API HBA_RemovePersistentBinding(IN HBA_HANDLE Handle,
                                               IN HBA_WWN HbaPortWWN,
                                               IN PHBA_FCPBINDING2 Binding);

HBA_STATUS HBA_API HBA_RemoveAllPersistentBindings(IN HBA_HANDLE Handle,
                                                   IN HBA_WWN HbaPortWWN);
...
HBA_UINT32 HBA_API
SMHBA_GetWrapperLibraryAttributes(OUT SMHBA_LIBRARYATTRIBUTES *Attributes);

HBA_UINT32 HBA_API SMHBA_GetVendorLibraryAttributes(
    IN HBA_UINT32 AdapterIndex, OUT SMHBA_LIBRARYATTRIBUTES *Attributes);

//
// SM-HBA Adapter, FC_Port and SAS_Port Information Functions
//

HBA_STATUS HBA_API SMHBA_GetProtocolStatistics(
    IN HBA_HANDLE Handle, IN HBA_UINT32 PortIndex, IN HBA_UINT32 ProtocolType,
    OUT SMHBA_PROTOCOLSTATISTICS *ProtocolStatistics);

HBA_STATUS HBA_API SMHBA_GetNumberOfPorts(IN HBA_HANDLE Handle,
                                          OUT HBA_UINT32 *NumberOfPorts);

HBA_STATUS HBA_API SMHBA_GetAdapterAttributes(
    IN HBA_HANDLE Handle, OUT SMHBA_ADAPTERATTRIBUTES *AdapterAttributes);

HBA_STATUS HBA_API SMHBA_GetPhyStatistics(
    IN HBA_HANDLE Handle, IN HBA_UINT32 PortIndex, IN HBA_UINT32 PhyIndex,
    OUT SMHBA_PHYSTATISTICS *PhyStatistics);

HBA_STATUS HBA_API
SMHBA_GetDiscoveredPortAttributes(IN HBA_HANDLE Handle, IN HBA_UINT32 PortIndex,
                                  IN HBA_UINT32 DiscoveredPortIndex,
                                  OUT SMHBA_PORTATTRIBUTES *PortAttributes);

HBA_STATUS HBA_API SMHBA_GetPortAttributesByWWN(
    IN HBA_HANDLE Handle, IN HBA_WWN PortWWN, IN HBA_WWN DomainPortWWN,
    OUT SMHBA_PORTATTRIBUTES *PortAttributes);

HBA_STATUS HBA_API SMHBA_GetPortType(IN HBA_HANDLE Handle,
                                     IN HBA_UINT32 PortIndex,
                                     OUT HBA_PORTTYPE *PortType);

HBA_STATUS HBA_API
SMHBA_GetAdapterPortAttributes(IN HBA_HANDLE Handle, IN HBA_UINT32 PortIndex,
                               OUT SMHBA_PORTATTRIBUTES *PortAttributes);

HBA_STATUS HBA_API SMHBA_GetFCPhyAttributes(IN HBA_HANDLE Handle,
                                            IN HBA_UINT32 PortIndex,
                                            IN HBA_UINT32 PhyIndex,
                                            OUT SMHBA_FC_PHY *PhyType);

HBA_STATUS HBA_API SMHBA_GetSASPhyAttributes(IN HBA_HANDLE Handle,
                                             IN HBA_UINT32 PortIndex,
                                             IN HBA_UINT32 PhyIndex,
...
HBA_STATUS HBA_API
SMHBA_GetLUNStatistics(IN HBA_HANDLE Handle, IN const HBA_SCSIID *Lunit,
                       OUT SMHBA_PROTOCOLSTATISTICS *ProtocolStatistics);

HBA_STATUS HBA_API SMHBA_GetTargetMapping(IN HBA_HANDLE HbaHandle,
                                          IN HBA_WWN HbaPortWWN,
                                          IN HBA_WWN DomainPortWWN,
                                          IN OUT SMHBA_TARGETMAPPING *Mapping);

HBA_STATUS HBA_API SMHBA_GetBindingCapability(IN HBA_HANDLE Handle,
                                              IN HBA_WWN HbaPortWWN,
                                              IN HBA_WWN DomainPortWWN,
                                              OUT SMHBA_BIND_CAPABILITY *Flags);

HBA_STATUS HBA_API SMHBA_GetBindingSupport(IN HBA_HANDLE Handle,
                                           IN HBA_WWN HbaPortWWN,
                                           IN HBA_WWN DomainPortWWN,
                                           OUT SMHBA_BIND_CAPABILITY *Flags);

HBA_STATUS HBA_API SMHBA_SetBindingSupport(IN HBA_HANDLE Handle,
                                           IN HBA_WWN HbaPortWWN,
                                           IN HBA_WWN DomainPortWWN,
                                           IN SMHBA_BIND_CAPABILITY Flags);

HBA_STATUS HBA_API SMHBA_GetPersistentBinding(IN HBA_HANDLE Handle,
                                              IN HBA_WWN HbaPortWWN,
                                              IN HBA_WWN DomainPortWWN,
                                              IN OUT SMHBA_BINDING *Binding);

HBA_STATUS HBA_API SMHBA_SetPersistentBinding(IN HBA_HANDLE Handle,
                                              IN HBA_WWN HbaPortWWN,
                                              IN HBA_WWN DomainPortWWN,
                                              IN OUT SMHBA_BINDING *Binding);

HBA_STATUS HBA_API SMHBA_RemovePersistentBinding(
    IN HBA_HANDLE Handle, IN HBA_WWN HbaPortWWN, IN HBA_WWN DomainPortWWN,
    IN const SMHBA_BINDING *Binding);

HBA_STATUS HBA_API SMHBA_RemoveAllPersistentBindings(IN HBA_HANDLE Handle,
                                                     IN HBA_WWN HbaPortWWN,
                                                     IN HBA_WWN DomainPortWWN);
...
HBA_STATUS HBA_API SMHBA_ScsiInquiry(
    IN HBA_HANDLE HbaHandle, IN HBA_WWN HbaPortWWN,
    IN HBA_WWN DiscoveredPortWWN, IN HBA_WWN DomainPortWWN,
    IN HBA_SCSILUN SmhbaLUN, IN HBA_UINT8 CDB_Byte1, IN HBA_UINT8 CDB_Byte2,
    OUT void *pRespBuffer, IN OUT HBA_UINT32 *pRespBufferSize,
    OUT HBA_UINT8 *pScsiStatus, OUT void *pSenseBuffer,
    IN OUT HBA_UINT32 *pSenseBufferSize);

HBA_STATUS HBA_API
SMHBA_ScsiReportLuns(IN HBA_HANDLE Hbahandle, IN HBA_WWN HbaPortWWN,
                     IN HBA_WWN DiscoveredPortWWN, IN HBA_WWN DomainPortWWN,
                     OUT void *pRespBuffer, IN OUT HBA_UINT32 *pRespBufferSize,
                     OUT HBA_UINT8 *pScsiStatus, OUT void *pSenseBuffer,
                     IN OUT HBA_UINT32 *pSenseBufferSize);
...
HBA_STATUS HBA_API SMHBA_ScsiReadCapacity(
    IN HBA_HANDLE HbaHandle, IN HBA_WWN HbaPortWWN,
    IN HBA_WWN DiscoveredPortWWN, IN HBA_WWN DomainPortWWN,
    IN HBA_SCSILUN SmhbaLUN, OUT void *pRespBuffer,
    IN OUT HBA_UINT32 *pRespBufferSize, OUT HBA_UINT8 *pScsiStatus,
    OUT void *pSenseBuffer, IN OUT HBA_UINT32 *pSenseBufferSize);
...
HBA_STATUS HBA_API SMHBA_SendTEST(IN HBA_HANDLE Handle, IN HBA_WWN HbaPortWWN,
                                  IN HBA_WWN DestWWN, IN HBA_UINT32 DestFCID,
                                  IN void *ReqBuffer,
                                  IN HBA_UINT32 ReqBufferSize);
...
HBA_STATUS HBA_API SMHBA_SendECHO(IN HBA_HANDLE Handle, IN HBA_WWN HbaPortWWN,
                                  IN HBA_WWN DestWWN, IN HBA_UINT32 DestFCID,
                                  IN void *ReqBuffer,
                                  IN HBA_UINT32 ReqBufferSize,
                                  OUT void *RspBuffer,
...
HBA_STATUS HBA_API SMHBA_SendSMPPassThru(
    IN HBA_HANDLE Handle, IN HBA_WWN HbaPortWWN, IN HBA_WWN DestPortWWN,
    IN HBA_WWN DomainPortWWN, IN void *ReqBuffer, IN HBA_UINT32 ReqBufferSize,
    OUT void *RspBuffer, IN OUT HBA_UINT32 *RspBufferSize);
...
HBA_STATUS HBA_API SMHBA_RegisterForAdapterPortEvents(
    IN void (*callback)(void *pData, HBA_WWN PortWWN, HBA_UINT32 eventType,
                        HBA_UINT32 fabricPortID),
    IN void *pUserData, IN HBA_HANDLE Handle, IN HBA_WWN PortWWN,
    IN HBA_UINT32 SpecificEventType, OUT HBA_CALLBACKHANDLE *pCallbackHandle);

HBA_STATUS HBA_API SMHBA_RegisterForAdapterPortStatEvents(
    IN void (*callback)(void *pData, HBA_WWN PortWWN, HBA_UINT32 ProtocolType,
                        HBA_UINT32 EventType),
    IN void *pUserData, IN HBA_HANDLE Handle, IN HBA_WWN PortWWN,
    IN HBA_UINT32 ProtocolType, IN SMHBA_PROTOCOLSTATISTICS Stats,
    IN HBA_UINT32 StatType, OUT HBA_CALLBACKHANDLE *pCallbackHandle);

HBA_STATUS HBA_API SMHBA_RegisterForAdapterPhyStatEvents(
    IN void (*callback)(void *pData, HBA_WWN PortWWN, HBA_UINT32 PhyIndex,
                        HBA_UINT32 EventType),
    IN void *pUserData, IN HBA_HANDLE Handle, IN HBA_WWN PortWWN,
    IN HBA_UINT32 PhyIndex, IN SMHBA_PHYSTATISTICS Stats,
    IN HBA_UINT32 StatType, OUT HBA_CALLBACKHANDLE *pCallbackHandle);

HBA_STATUS HBA_API SMHBA_RegisterForTargetEvents(
    IN void (*callback)(void *pData, HBA_WWN HbaPortWWN,
                        HBA_WWN DiscoveredPortWWN, HBA_WWN DomainPortWWN,
                        HBA_UINT32 EventType),
    IN void *pUserData, IN HBA_HANDLE Handle, IN HBA_WWN HbaPortWWN,
    IN HBA_WWN DiscoveredPortWWN, IN HBA_WWN DomainPortWWN,
    OUT HBA_CALLBACKHANDLE *pCallbackHandle, IN HBA_UINT32 AllTargets);
