...
#define FWPM_NETWORK_CONNECTION_POLICY_SETTING                                 \
  FWPM_NETWORK_CONNECTION_POLICY_SETTING0
#define FWPM_NETWORK_CONNECTION_POLICY_SETTINGS                                \
...
#endif
#if (NTDDI_VERSION >= NTDDI_WIN7)
#define IKEEXT_IP_VERSION_SPECIFIC_KEYMODULE_STATISTICS                        \
...
#endif
#if (NTDDI_VERSION >= NTDDI_WIN7)
#define IKEEXT_IP_VERSION_SPECIFIC_COMMON_STATISTICS                           \
...
#if (NTDDI_VERSION >= NTDDI_WIN7)
#define IPSEC_AGGREGATE_DROP_PACKET_STATISTICS                                 \
...
#define IPSEC_SA_AUTH_AND_CIPHER_INFORMATION                                   \
...
#if (NTDDI_VERSION >= NTDDI_WIN8)
#define IPSEC_KEY_MANAGER_KEY_DICTATION_CHECK                                  \
...
#define FWPS_CALLOUT_BOOTTIME_CALLOUT_DELETE_NOTIFY_FN                         \
...
#define FWPS_VSWITCH_RUNTIME_STATE_SAVE_CALLBACK                               \
  FWPS_VSWITCH_RUNTIME_STATE_SAVE_CALLBACK0
#define FWPS_VSWITCH_RUNTIME_STATE_RESTORE_CALLBACK                            \
...
#define FWPS_PACKET_LIST_INBOUND_IPSEC_INFORMATION                             \
  FWPS_PACKET_LIST_INBOUND_IPSEC_INFORMATION0
#define FWPS_PACKET_LIST_OUTBOUND_IPSEC_INFORMATION                            \
...
#define FwpsGetPacketListSecurityInformation                                   \
...
#define FwpsAllocateNetBufferAndNetBufferList                                  \
...
#define FwpsConstructIpHeaderForTransportPacket                                \
...
#define FwpsInjectvSwitchEthernetIngressAsync                                  \
...
#define FwpsQueryConnectionSioFormatRedirectRecords                            \
