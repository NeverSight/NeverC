...
// MessageText:
//
// Device %1 is not correctly processing some write requests. In Device Manager,
// ensure that the Write Cache option is disabled for this device or data
// corruption may occur.
//
...
// MessageText:
//
// Disk %2 has crossed a capacity utilization threshold and used %3 bytes. When
// the threshold was crossed, there were %4 bytes of remaining capacity.
//
...
//
// Disk %2 has crossed a capacity utilization threshold and used %3 bytes. When
// the threshold was crossed, the disk had %4 bytes of remaining capacity.
//
...
//
// Disk %2 has crossed a capacity utilization threshold and used %3 bytes. When
// the threshold was crossed, the pool had %4 bytes of remaining capacity.
//
...
// MessageText:
//
// Disk %2 has crossed a capacity utilization threshold. When the threshold was
// crossed, %3 bytes from the pool were used and the disk had %4 bytes of
// remaining capacity.
//
...
//
// Disk %2 has crossed a capacity utilization threshold. When the threshold was
// crossed, %3 bytes from the pool were used and the pool had %4 bytes of
// remaining capacity.
//
...
// MessageText:
//
// The IO operation at logical block address %2 for Disk %3 (PDO name: %4) was
// retried.
//
...
// MessageText:
//
// Disk %2 has the same disk identifiers as one or more disks connected to the
// system. Go to Microsoft's support website (http://support.microsoft.com) and
// search for KB2983588 to resolve the issue.
//
...
// MessageText:
//
// The driver for device %1 delayed non-paging Io requests for %2 ms to recover
...
// Windows was unable to save all the data for the file %2. The data has been
...
// {Delayed Write Failed}
// Windows was unable to save all the data for the file %2; the data has been
// lost. This error may be caused by network connectivity issues. Please try to
...
// {Delayed Write Failed}
// Windows was unable to save all the data for the file %2; the data has been
// lost. This error was returned by the server on which the file exists. Please
...
// {Delayed Write Failed}
// Windows was unable to save all the data for the file %2; the data has been
// lost. This error may be caused if the device has been removed or the media is
// write-protected.
//
#define IO_LOST_DELAYED_WRITE_NETWORK_LOCAL_DISK_ERROR ((NTSTATUS)0x8004008DL)

// codes 0x8e-0x95, 0x97-0x99, 0x9b defined in
// minkernel\nlsmsg_base\ntiologc_base.mc
...
// overlapping memory regions. Driver %2, with device <%3>, claimed a memory
// range with starting address in data address 0x28 and 0x2c, and length in data
// address 0x30.
//
...
//
// A conflict has been detected between two drivers which claimed two
// overlapping Io port regions. Driver %2, with device <%3>, claimed an IO port
// range with starting address in data address 0x28 and 0x2c, and length in data
// address 0x30.
//
...
// channels.
// Driver %2, with device <%3>, claimed the DMA Channel in data address 0x28,
// with optinal port in data address 0x2c.
//
...
// MessageText:
//
// A conflict has been detected between two drivers which claimed equivalent
// IRQs. Driver %2, with device <%3>, claimed an interrupt with Level in data
...
// To ensure accuracy, the file system quota information on the device %1 with
// label "%2" will be rebuilt.
//
...
// MessageText:
//
// Direct dump configuration failed. Validate the filename and make sure the
// target device is not a Fault Tolerant set member, remote, or floppy device.
// The failure may be because there is not enough room on the dump device to
...
// MessageText:
//
// The driver for device %1 detected a port timeout due to prolonged inactivity.
...
// MessageText:
//
// Dump file creation failed due to error during dump creation. BugCheckProgress
// was: %2
//
...
// dump file path is set correctly, or the disk has enough space to create the
// dump file.
//
...
// MessageText:
//
// Machine Check Event reported is a CPU thermal throttling event reported from
// CPU %1. The CPU has dropped below the temperature limit and throttling has
// been removed. %2 additional error(s) are contained within the record.
//
...
// MessageText:
//
// The maximum number of Machine Check Event corrected error events that can be
// saved to the Event Log has been reached. Logging of these events has been
// disabled.
//
...
// MessageText:
//
// The memory page at physical address %1 has encountered multiple corrected
// hardware error events. As a result it will no longer be used by Windows.
//
...
// MessageText:
//
// Machine Check Event reported is a corrected level %3 Cache error reported to
...
// MessageText:
//
// Machine Check Event reported is a corrected level %3 translation Buffer error
// reported to CPU %1. %2 additional error(s) are contained within the record.
//
...
// error reported to CPU %1. %2 additional error(s) are contained within the
// record.
//
...
// MessageText:
//
// Machine Check Event reported is a corrected ECC memory error at an unknown
// physical address reported to CPU %1. %2 additional error(s) are contained
// within the record.
//
...
// address %3 reported to CPU %1. %2 additional error(s) are contained within
// the record.
//
...
//
// Machine Check Event reported is a corrected ECC memory error at physical
// address %3 on memory module %4 reported to CPU %1. %2 additional error(s) are
...
// MessageText:
//
// Machine Check Event reported is a corrected System Event error reported to
// CPU %1. %2 additional error(s) are contained within the record.
//
...
// MessageText:
//
// Machine Check Event reported is a corrected PCI bus Parity error during a
...
// MessageText:
//
// Machine Check Event reported is a corrected PCI bus Parity error reported to
// CPU %1. %2 additional error(s) are contained within the record.
//
...
// MessageText:
//
// Machine Check Event reported is a corrected PCI bus SERR error reported to
// CPU %1. %2 additional error(s) are contained within the record.
//
...
// MessageText:
//
// Machine Check Event reported is a corrected PCI bus Master abort error during
...
// MessageText:
//
// Machine Check Event reported is a corrected PCI bus Timeout error during a
// transaction type %3 at address %4 on PCI bus %5 reported to CPU %1. %2
// additional error(s) are contained within the record.
//
...
// MessageText:
//
// Machine Check Event reported is a corrected PCI bus Timeout error reported to
// CPU %1. %2 additional error(s) are contained within the record.
//
...
// MessageText:
//
// Machine Check Event reported is an unknown corrected PCI bus error reported
...
// MessageText:
//
// Machine Check Event reported is a corrected PCI component error reported to
// CPU %1. %2 additional error(s) are contained within the record.
//
...
// MessageText:
//
// Machine Check Event reported is a corrected Platform Specific error reported
// to CPU %1. %2 additional error(s) are contained within the record.
//
...
// MessageText:
//
// Corrected Platform Error Interrupt threshold exceeded. Interrupt has been
// disabled. Polling mode has been enabled.
//
...
//
// Machine Check Event reported is a CPU thermal throttling event reported from
// CPU %1. The CPU has exceeded the temperature limit and has been throttled
// down. %2 additional error(s) are contained within the record.
//
...
// MessageText:
//
// Machine Check Event reported is a corrected CPU error reported from CPU %1.
...
// MessageText:
//
// Machine Check Event reported is a fatal level %3 Cache error reported to CPU
...
// MessageText:
//
// Machine Check Event reported is a fatal level %3 translation Buffer error
// reported to CPU %1. %2 additional error(s) are contained within the record.
//
...
// MessageText:
//
// Machine Check Event reported is a fatal External/Internal bus error reported
// to CPU %1. %2 additional error(s) are contained within the record.
//
...
// MessageText:
//
// Machine Check Event reported is a fatal internal CPU register access error
// reported to CPU %1. %2 additional error(s) are contained within the record.
//
...
// MessageText:
//
// Machine Check Event reported is a fatal Micro Architecture Structure error
// reported to CPU %1. %2 additional error(s) are contained within the record.
//
...
// MessageText:
//
// Machine Check Event reported is a fatal ECC memory error at physical address
// %3 reported to CPU %1. %2 additional error(s) are contained within the
// record.
//
...
//
// Machine Check Event reported is a fatal ECC memory error at physical address
// %3 on memory module %4 reported to CPU %1. %2 additional error(s) are
// contained within the record.
//
...
//
// Machine Check Event reported is a fatal ECC memory error at physical address
// %3 on memory module %4 on memory card %5 reported to CPU %1. %2 additional
...
// MessageText:
//
// Machine Check Event reported is a fatal System Event error reported to CPU
// %1. %2 additional error(s) are contained within the record.
//
...
// MessageText:
//
// Machine Check Event reported is a fatal PCI bus Parity error reported to CPU
// %1. %2 additional error(s) are contained within the record.
//
...
// MessageText:
//
// Machine Check Event reported is a fatal PCI bus SERR error reported to CPU
// %1. %2 additional error(s) are contained within the record.
//
...
// MessageText:
//
// Machine Check Event reported is a fatal PCI bus Master abort error during a
// transaction type %3 at address %4 on PCI bus %5 reported to CPU %1. %2
// additional error(s) are contained within the record.
//
...
// MessageText:
//
// Machine Check Event reported is a fatal PCI bus Master abort error reported
// to CPU %1. %2 additional error(s) are contained within the record.
//
...
// MessageText:
//
// Machine Check Event reported is a fatal PCI bus Timeout error reported to CPU
// %1. %2 additional error(s) are contained within the record.
//
...
// MessageText:
//
// Machine Check Event reported is an unknown fatal PCI bus error reported to
// CPU %1. %2 additional error(s) are contained within the record.
//
...
// MessageText:
//
// Machine Check Event reported is a fatal PCI component error reported to CPU
// %1. %2 additional error(s) are contained within the record.
//
...
// MessageText:
//
// Machine Check Event reported is a fatal SMBIOS Device Type %3 error reported
// to CPU %1. %2 additional error(s) are contained within the record.
//
...
// MessageText:
//
// Machine Check Event reported is a fatal Platform Specific error reported to
// CPU %1. %2 additional error(s) are contained within the record.
//
...
// MessageText:
//
// Machine Check Event reported is a fatal memory hierarchy error.%r Trasaction
// Type: %1%r Memory Hierarchy Level: %2%r Request Type: %3%r Address: %4
//
...
// MessageText:
//
// Machine Check Event reported is a fatal TLB error.%r Transaction Type: %1%r
// Memory Hierarchy Level: %2%r Address: %3
//
...
// MessageText:
//
// Machine Check Event reported is a fatal Bus or Interconnect error.%r Memory
// Hierarchy Level: %1%r Participation: %2%r Request Type: %3%r Memory/IO: %4%r
// Address: %5
//
...
// MessageText:
//
// Machine Check Event reported is a fatal condition. A processor received an
// external signal that an unrecoverable error has occurred.
//
