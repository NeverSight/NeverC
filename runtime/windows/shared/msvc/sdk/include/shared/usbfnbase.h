...
//
#define KREGUSBFNENUMPATH                                                      \
  L"\\Registry\\Machine\\SYSTEM\\CurrentControlSet\\Control\\USBFN\\"
#define UREGUSBFNENUMPATH                                                      \
  L"HKEY_LOCAL_MACHINE\\SYSTEM\\CurrentControlSet\\Control\\USBFN\\"

//
// Registry path for the USBFn Enumeration keys (manufacturing mode)
//
#define KREGMANUSBFNENUMPATH                                                   \
  L"\\Registry\\Machine\\SYSTEM\\CurrentControlSet\\Control\\ManufacturingMod" \
  L"e\\Current\\USBFN\\"
#define UREGMANUSBFNENUMPATH                                                   \
  L"HKEY_LOCAL_"                                                               \
  L"MACHINE\\SYSTEM\\CurrentControlSet\\Control\\ManufacturingMode\\Current\\" \
  L"USBFN\\"
...
// the device. That translates into 16 pipes, including the pipe belonging to
// EP0.
//
...
#define MAX_INTERFACE_GUID_SIZE                                                \
  (sizeof(L"{xxxxxxxx-xxxx-xxxx-xxxx-xxxxxxxxxxxx}"))
