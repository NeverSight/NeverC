 ...
 * uses its parameters - the assumptions it makes about them, and the guarantees
 * it makes upon finishing. This file redefines all those annotation macros to
 * be harmless. It is designed for use in down-level build environments where
 * the tooling may be unhappy with the standard SAL2 macro definitions.
 *
 *       [Public]
 *
 ****/
