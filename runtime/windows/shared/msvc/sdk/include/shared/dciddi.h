...
typedef struct _DCIENUMINPUT {
  ...
  void(CALLBACK *EnumCallback)(LPDCISURFACEINFO,
                               LPVOID); /* callback for supported formats */
  LPVOID lpContext;
...
typedef struct _DCIOFFSCREEN {
  ...
  DCIRVAL(CALLBACK *SetDestination)(LPVOID, LPRECT,
                                    LPRECT); /* SetDestination callback       */
