...
// MessageText:
//
// An enrollment transaction could not be started because another enrollment is
// already in progress.
//
...
// MessageText:
//
// The biometric unit is not in the proper state to perform the specified
// operation.
//
...
// MessageText:
//
// The biometric unit's storage adapter was unable to create a database because
...
// MessageText:
//
// The biometric unit's storage adapter was unable to add a record to the
// database because the database is full.
//
...
// MessageText:
//
// No records were deleted because the specified identity and sub-factor are not
...
// MessageText:
//
// The sensor adapter doesn't support the sensor mode specified in the
// configuration.
//
...
// MessageText:
//
// The data in a biometric template matches another template already in the
// database.
//
...
// MessageText:
//
// The requested operation is not valid for the current state of the session or
// biometric unit.
//
...
// MessageText:
//
// The session cannot begin a new operation because another operation is already
// in progress.
//
...
// MessageText:
//
// System policy settings have disabled the Windows biometric credential
// provider.
//
...
// MessageText:
//
// A private pool cannot be created because one or more biometric units are not
// available.
//
...
// MessageText:
//
// There is already an active event monitor associated with the specified
// session.
//
...
// MessageText:
//
// Biometric authentication has been disabled because of too many unregistered
// fingerpint scans.
//
...
// MessageText:
//
// The biometric unt is unable to provide data for this property at the present
// time.
//
...
// MessageText:
//
// Policy protection is not available because a TPM 2.0 device is either not
...
// MessageText:
//
// The Windows Biometric Service canceled the enrollment because the platform
...
// MessageText:
//
// Return data includes multiple status values, which must be checked
// separately.
//
...
// MessageText:
//
// The fingerprint reader could not capture a good sample. Check to be sure the
// sensor is clean.
//
