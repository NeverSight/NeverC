...
#define __drv_raisesIRQL(irql)                                                 \
  _SAL1_Source_(__drv_raisesIRQL, (), _IRQL_raises_(irql)) /* legacy */
...
#define __drv_requiresIRQL(irql)                                               \
  _SAL1_Source_(__drv_requiresIRQL, (), _IRQL_requires_(irql)) /* legacy */
...
#define _IRQL_requires_max_(irql)                                              \
  _SAL2_Source_(_IRQL_requires_max_, (irql),                                   \
                _Pre_ _SA_annotes1(SAL_maxIRQL, irql))
#undef __drv_maxIRQL
#define __drv_maxIRQL(irql)                                                    \
  _SAL1_Source_(__drv_maxIRQL, (), _IRQL_requires_max_(irql)) /* legacy */
...
#define _IRQL_requires_min_(irql)                                              \
  _SAL2_Source_(_IRQL_requires_min_, (irql),                                   \
                _Pre_ _SA_annotes1(SAL_minIRQL, irql))
#undef __drv_minIRQL
#define __drv_minIRQL(irql)                                                    \
  _SAL1_Source_(__drv_minIRQL, (), _IRQL_requires_min_(irql)) /* legacy */
...
#define __drv_savesIRQL                                                        \
  _SAL1_Source_(__drv_savesIRQL, (), _IRQL_saves_) /* legacy */
...
#define __drv_restoresIRQL                                                     \
  _SAL1_Source_(__drv_restoresIRQL, (), _IRQL_restores_) /* legacy */
...
#define _IRQL_restores_global_(kind, param)                                    \
  _SAL2_Source_(_IRQL_restores_global_, (kind, param),                         \
...
#define __drv_restoresIRQLGlobal(kind, param)                                  \
  _SAL1_Source_(__drv_restoresIRQLGlobal, (),                                  \
...
#define __drv_sameIRQL                                                         \
  _SAL1_Source_(__drv_sameIRQL, (), _IRQL_requires_same_) /* legacy */
...
#define __drv_useCancelIRQL                                                    \
  _SAL1_Source_(__drv_useCancelIRQL, (), _IRQL_uses_cancel_) /* legacy */
...
#define __drv_isCancelIRQL                                                     \
  _SAL1_Source_(__drv_isCancelIRQL, (), _IRQL_is_cancel_) /* legacy */
#endif
