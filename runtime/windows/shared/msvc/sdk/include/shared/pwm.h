...
//
DEFINE_GUID(GUID_DEVINTERFACE_PWM_CONTROLLER, 0x60824b4c, 0xeed1, 0x4c9c, 0xb4,
            0x9c, 0x1b, 0x96, 0x14, 0x61, 0xa8, 0x19);
#define GUID_DEVINTERFACE_PWM_CONTROLLER_WSZ                                   \
  L"{60824B4C-EED1-4C9C-B49C-1B961461A819}"

//
// PWM wave period in picoseconds, where 1 picosecond is the period of a wave
// with frequency equals to 1 Terahertz(THz).
//
...
//
// To convert from PWM_PERCENTAGE to floating-point value divide by
// PWM_PERCENTAGE_MAX. To convert from floating-point to PWM_PERCENTAGE value
// multiply by PWM_PERCENTAGE_MAX.
//
...
typedef struct _PWM_CONTROLLER_INFO {
  ...
  //
  _Field_range_(==, sizeof(PWM_CONTROLLER_INFO)) SIZE_T Size;
...
#define IOCTL_PWM_CONTROLLER_GET_INFO                                          \
  CTL_CODE(FILE_DEVICE_CONTROLLER, PWM_IOCTL_ID_CONTROLLER_GET_INFO,           \
...
#define IOCTL_PWM_CONTROLLER_GET_ACTUAL_PERIOD                                 \
  CTL_CODE(FILE_DEVICE_CONTROLLER, PWM_IOCTL_ID_CONTROLLER_GET_ACTUAL_PERIOD,  \
           METHOD_BUFFERED, FILE_ANY_ACCESS)
...
#define IOCTL_PWM_CONTROLLER_SET_DESIRED_PERIOD                                \
  CTL_CODE(FILE_DEVICE_CONTROLLER, PWM_IOCTL_ID_CONTROLLER_SET_DESIRED_PERIOD, \
...
#define IOCTL_PWM_PIN_GET_ACTIVE_DUTY_CYCLE_PERCENTAGE                         \
  CTL_CODE(FILE_DEVICE_CONTROLLER,                                             \
           PWM_IOCTL_ID_PIN_GET_ACTIVE_DUTY_CYCLE_PERCENTAGE, METHOD_BUFFERED, \
           FILE_ANY_ACCESS)
...
#define IOCTL_PWM_PIN_SET_ACTIVE_DUTY_CYCLE_PERCENTAGE                         \
  CTL_CODE(FILE_DEVICE_CONTROLLER,                                             \
           PWM_IOCTL_ID_PIN_SET_ACTIVE_DUTY_CYCLE_PERCENTAGE, METHOD_BUFFERED, \
           FILE_WRITE_DATA)
...
#define IOCTL_PWM_PIN_GET_POLARITY                                             \
  CTL_CODE(FILE_DEVICE_CONTROLLER, PWM_IOCTL_ID_PIN_GET_POLARITY,              \
           METHOD_BUFFERED, FILE_ANY_ACCESS)
...
#define IOCTL_PWM_PIN_SET_POLARITY                                             \
  CTL_CODE(FILE_DEVICE_CONTROLLER, PWM_IOCTL_ID_PIN_SET_POLARITY,              \
           METHOD_BUFFERED, FILE_WRITE_DATA)
...
#define IOCTL_PWM_PIN_START                                                    \
  CTL_CODE(FILE_DEVICE_CONTROLLER, PWM_IOCTL_ID_PIN_START, METHOD_NEITHER,     \
           FILE_WRITE_DATA)
...
#define IOCTL_PWM_PIN_STOP                                                     \
  CTL_CODE(FILE_DEVICE_CONTROLLER, PWM_IOCTL_ID_PIN_STOP, METHOD_NEITHER,      \
           FILE_WRITE_DATA)
...
#define IOCTL_PWM_PIN_IS_STARTED                                               \
  CTL_CODE(FILE_DEVICE_CONTROLLER, PWM_IOCTL_ID_PIN_IS_STARTED,                \
           METHOD_BUFFERED, FILE_ANY_ACCESS)
