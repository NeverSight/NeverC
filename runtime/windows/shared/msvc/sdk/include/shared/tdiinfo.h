...
typedef struct tcp_request_query_information_ex32_xp {
  ...
  ULONG32 Context[CONTEXT_SIZE / sizeof(ULONG32)];
    ...
    *PTCP_REQUEST_QUERY_INFORMATION_EX32_XP;
#endif // _WIN64
...
#if defined(_WIN64)
typedef TCP_REQUEST_QUERY_INFORMATION_EX32_XP
    TCP_REQUEST_QUERY_INFORMATION_EX32;
