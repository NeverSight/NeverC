...
DEFINE_GUIDSTRUCT("DFF21BE0-F70F-11D0-B917-00A0C9223196",
...
DEFINE_GUIDSTRUCT("DFF21CE0-F70F-11D0-B917-00A0C9223196",
                  KSNODETYPE_OUTPUT_UNDEFINED);
#define KSNODETYPE_OUTPUT_UNDEFINED                                            \
...
DEFINE_GUIDSTRUCT("DFF21DE0-F70F-11D0-B917-00A0C9223196",
                  KSNODETYPE_BIDIRECTIONAL_UNDEFINED);
#define KSNODETYPE_BIDIRECTIONAL_UNDEFINED                                     \
...
DEFINE_GUIDSTRUCT("DFF21EE0-F70F-11D0-B917-00A0C9223196",
                  KSNODETYPE_TELEPHONY_UNDEFINED);
#define KSNODETYPE_TELEPHONY_UNDEFINED                                         \
...
DEFINE_GUIDSTRUCT("DFF21FE0-F70F-11D0-B917-00A0C9223196",
                  KSNODETYPE_EXTERNAL_UNDEFINED);
#define KSNODETYPE_EXTERNAL_UNDEFINED                                          \
...
DEFINE_GUIDSTRUCT("DFF220E0-F70F-11D0-B917-00A0C9223196",
                  KSNODETYPE_EMBEDDED_UNDEFINED);
#define KSNODETYPE_EMBEDDED_UNDEFINED                                          \
...
DEFINE_GUIDSTRUCT("D1B9CC2A-F519-417f-91C9-55FA65481001",
...
DEFINE_GUIDSTRUCT("E47E4031-3EA6-418d-8F9B-B73843CCBA97",
                  KSNODETYPE_DISPLAYPORT_INTERFACE);
#define KSNODETYPE_DISPLAYPORT_INTERFACE                                       \
...
DEFINE_GUIDSTRUCT("8F42C0B2-91CE-4BCF-9CCD-0E599037AB35",
...
DEFINE_GUIDSTRUCT("3817E0B8-DF58-4375-B669-C49634331F9D",
                  KSNODETYPE_AUDIO_KEYWORDDETECTOR);
#define KSNODETYPE_AUDIO_KEYWORDDETECTOR                                       \
...
DEFINE_GUIDSTRUCT("45AAB42E-CAEB-4052-8AA9-B38CB5109619",
...
DEFINE_GUIDSTRUCT("01C6FE66-6E48-4c65-AC9B-52DB5D656C7E",
...
DEFINE_GUIDSTRUCT("35CAF6E4-F3B3-4168-BB4B-55E77A461C7E",
...
DEFINE_GUIDSTRUCT("28E04F87-4DBE-4f8d-8589-025D209DFB4A",
                  KSNODETYPE_SPEAKERS_STATIC_JACK);
#define KSNODETYPE_SPEAKERS_STATIC_JACK                                        \
...
DEFINE_GUIDSTRUCT("21FBB329-1A4A-48da-A076-2318A3C59B26",
...
DEFINE_GUIDSTRUCT("686D7CC0-D903-4258-B443-3A3D3580741C",
...
typedef struct {
  UINT64
  u64PositionInBlocks; // The block offset from the start of the stream to
                       // the current post-decoded uncompressed position in
                       // the stream, where a block is the group of channels
                       // in the same sample; for a PCM stream,
  // a block is same as a frame. For compressed formats, a block is a single
  // sample within a frame (eg. each MP3 frame has 1152 samples or 1152 blocks)
  UINT64 u64QPCPosition; // The value of the performance counter at the time
                         // that the audio endpoint device read the device
                         // position (*pu64Position) in response to the
                         // KSAUDIO_PRESENTATION_POSITION call.
...
DEFINE_DEVPROPKEY(DEVPKEY_KsAudio_PacketSize_Constraints, 0x13e004d6, 0xb066,
                  0x43bd, 0x91, 0x3b, 0xa4, 0x15, 0xcd, 0x13, 0xda, 0x87,
                  2); // DEVPROP_TYPE_BINARY
#endif

#if (NTDDI_VERSION >= NTDDI_WIN10_RS5)
#ifdef DEFINE_DEVPROPKEY
// {13E004D6-B066-43BD-913B-A415CD13DA87},3
// This property is the symbolic link to an interface of type
// 'GUID_KSCATEGORY_AUDIO_CONTROLLER_INTERFACE' published by the KS Filter or
// miniport drivers on the KSCATEGORY_AUDIO interface to indicate the audio
// system about the 'controller' device interface symbolic link that will
// provide extended information about this audio endpoint
DEFINE_DEVPROPKEY(DEVPKEY_KsAudio_Controller_DeviceInterface_Path, 0x13e004d6,
                  0xb066, 0x43bd, 0x91, 0x3b, 0xa4, 0x15, 0xcd, 0x13, 0xda,
                  0x87, 3); // DEVPROP_TYPE_STRING
...
typedef struct _KSAUDIO_PACKETSIZE_CONSTRAINTS {
  ...
  _Field_size_(NumProcessingModeConstraints)
      KSAUDIO_PACKETSIZE_PROCESSINGMODE_CONSTRAINT
...
DEFINE_DEVPROPKEY(DEVPKEY_KsAudio_PacketSize_Constraints2, 0x9404f781, 0x7191,
                  0x409b, 0x8b, 0xb, 0x80, 0xbf, 0x6e, 0xc2, 0x29, 0xae,
                  2); // DEVPROP_TYPE_BINARY
#endif
...
DEFINE_GUIDSTRUCT("113C425E-FD17-4057-B422-ED4074F1AFDF",
...
DEFINE_GUIDSTRUCT("FE07E322-450C-4BD5-84CA-A948500EA6AA",
...
DEFINE_GUIDSTRUCT("E9EBE550-D619-4C0A-976B-7062322B3006",
                  KSPROPSETID_InterleavedAudio);
#define KSPROPSETID_InterleavedAudio                                           \
  DEFINE_GUIDNAMED(KSPROPSETID_InterleavedAudio)
...
DEFINE_GUIDSTRUCT("69785C9B-FC2D-49D6-AC32-4799F87DE9F6",
...
DEFINE_GUIDSTRUCT("6389D844-BB32-4C4C-A802-F4B4B77AFEAD",
                  KSNOTIFICATIONID_SoundDetector);
#define KSNOTIFICATIONID_SoundDetector                                         \
  DEFINE_GUIDNAMED(KSNOTIFICATIONID_SoundDetector)
#endif // (NTDDI_VERSION >= NTDDI_WIN10_19H1)
...
#if (NTDDI_VERSION >= NTDDI_WIN10_RS1)
  ,
  KSPROPERTY_AUDIO_MIC_SENSITIVITY // deprecated in favor of
...
DEFINE_GUIDSTRUCT("B6DF7EB1-D099-489F-A6A0-C0106F0887A7",
                  KSPROPSETID_TelephonyControl);
#define KSPROPSETID_TelephonyControl                                           \
...
DEFINE_GUIDSTRUCT("ABF25C7E-0E64-4E32-B190-D0F6D7C53E97",
                  KSPROPSETID_TelephonyTopology);
#define KSPROPSETID_TelephonyTopology                                          \
...
typedef struct _tagKSTOPOLOGY_ENDPOINTID {
  WCHAR TopologyName[MAX_PATH]; // Reference string for topology filter of an
                                // endpoint
...
DEFINE_GUIDSTRUCT("0C46CE8F-DC2D-4204-9DC9-F58963366563",
...
DEFINE_GUIDSTRUCT("947BBA3A-E8EE-4786-90C4-8428185F05BE",
                  KSPROPSETID_FMRXControl);
#define KSPROPSETID_FMRXControl DEFINE_GUIDNAMED(KSPROPSETID_FMRXControl)

typedef enum { KSPROPERTY_FMRX_STATE = 0 } KSPROPERTY_FMRX_CONTROL;
...
DEFINE_GUIDSTRUCT("B77F12B4-CEB4-4484-8D5E-52C1E7D8762D",
                  KSEVENTSETID_Telephony);
#define KSEVENTSETID_Telephony DEFINE_GUIDNAMED(KSEVENTSETID_Telephony)

typedef enum { KSEVENT_TELEPHONY_ENDPOINTPAIRS_CHANGED } KSEVENT_TELEPHONY;
...
DEFINE_GUIDSTRUCT("19BB3A6A-CE2B-4442-87EC-6727C3CAB477",
                  KSNODETYPE_PARAMETRIC_EQUALIZER);
#define KSNODETYPE_PARAMETRIC_EQUALIZER                                        \
...
DEFINE_GUIDSTRUCT("B7EDC5CF-7B63-4ee2-A100-29EE2CB6B2DE",
...
DEFINE_GUIDSTRUCT("08C8A6A8-601F-4af8-8793-D905FF4CA97D",
                  KSNODETYPE_DYN_RANGE_COMPRESSOR);
#define KSNODETYPE_DYN_RANGE_COMPRESSOR                                        \
...
#define KSNODETYPE_SURROUND_ENCODER                                            \
...
DEFINE_GUIDSTRUCT("FBFFD49E-CE26-464A-9DFC-FEE42456C81C",
                  KSDATAFORMAT_SUBTYPE_UNIVERSALMIDIPACKET);
#define KSDATAFORMAT_SUBTYPE_UNIVERSALMIDIPACKET                               \
  DEFINE_GUIDNAMED(KSDATAFORMAT_SUBTYPE_UNIVERSALMIDIPACKET)

#define STATIC_KSPROPSETID_MidiLoopedStreaming                                 \
  0x1f306ba6, 0xfd9b, 0x427a, 0xbc, 0xb3, 0x27, 0xcb, 0xcf, 0xe, 0xf, 0x19
DEFINE_GUIDSTRUCT("1F306BA6-FD9B-427A-BCB3-27CBCF0E0F19",
                  KSPROPSETID_MidiLoopedStreaming);
#define KSPROPSETID_MidiLoopedStreaming                                        \
  DEFINE_GUIDNAMED(KSPROPSETID_MidiLoopedStreaming)
...
#define KSDATAFORMAT_SUBTYPE_IEC61937_WMA_PRO                                  \
...
DEFINE_GUIDSTRUCT("00000003-0cea-0010-8000-00aa00389b71",
                  KSDATAFORMAT_SUBTYPE_IEC61937_MPEG1);
#define KSDATAFORMAT_SUBTYPE_IEC61937_MPEG1                                    \
...
DEFINE_GUIDSTRUCT("00000004-0cea-0010-8000-00aa00389b71",
                  KSDATAFORMAT_SUBTYPE_IEC61937_MPEG2);
#define KSDATAFORMAT_SUBTYPE_IEC61937_MPEG2                                    \
...
DEFINE_GUIDSTRUCT("00000005-0cea-0010-8000-00aa00389b71",
                  KSDATAFORMAT_SUBTYPE_IEC61937_MPEG3);
#define KSDATAFORMAT_SUBTYPE_IEC61937_MPEG3                                    \
...
DEFINE_GUIDSTRUCT("00000006-0cea-0010-8000-00aa00389b71",
                  KSDATAFORMAT_SUBTYPE_IEC61937_AAC);
#define KSDATAFORMAT_SUBTYPE_IEC61937_AAC                                      \
...
DEFINE_GUIDSTRUCT("00000008-0cea-0010-8000-00aa00389b71",
                  KSDATAFORMAT_SUBTYPE_IEC61937_ATRAC);
#define KSDATAFORMAT_SUBTYPE_IEC61937_ATRAC                                    \
...
DEFINE_GUIDSTRUCT("00000009-0cea-0010-8000-00aa00389b71",
                  KSDATAFORMAT_SUBTYPE_IEC61937_ONE_BIT_AUDIO);
#define KSDATAFORMAT_SUBTYPE_IEC61937_ONE_BIT_AUDIO                            \
...
DEFINE_GUIDSTRUCT("0000010a-0cea-0010-8000-00aa00389b71",
                  KSDATAFORMAT_SUBTYPE_IEC61937_DOLBY_DIGITAL_PLUS_ATMOS);
#define KSDATAFORMAT_SUBTYPE_IEC61937_DOLBY_DIGITAL_PLUS_ATMOS                 \
...
DEFINE_GUIDSTRUCT("0000010b-0cea-0010-8000-00aa00389b71",
                  KSDATAFORMAT_SUBTYPE_IEC61937_DTSX_E1);
#define KSDATAFORMAT_SUBTYPE_IEC61937_DTSX_E1                                  \
  DEFINE_GUIDNAMED(KSDATAFORMAT_SUBTYPE_IEC61937_DTSX_E1)

#define STATIC_KSDATAFORMAT_SUBTYPE_IEC61937_DTSX_E2                           \
  0x0000030bL, 0x0cea, 0x0010, 0x80, 0x00, 0x00, 0xaa, 0x00, 0x38, 0x9b, 0x71
DEFINE_GUIDSTRUCT("0000030b-0cea-0010-8000-00aa00389b71",
                  KSDATAFORMAT_SUBTYPE_IEC61937_DTSX_E2);
#define KSDATAFORMAT_SUBTYPE_IEC61937_DTSX_E2                                  \
  DEFINE_GUIDNAMED(KSDATAFORMAT_SUBTYPE_IEC61937_DTSX_E2)
...
DEFINE_GUIDSTRUCT("0000010c-0cea-0010-8000-00aa00389b71",
                  KSDATAFORMAT_SUBTYPE_IEC61937_DOLBY_MAT20);
#define KSDATAFORMAT_SUBTYPE_IEC61937_DOLBY_MAT20                              \
...
DEFINE_GUIDSTRUCT("0000030c-0cea-0010-8000-00aa00389b71",
                  KSDATAFORMAT_SUBTYPE_IEC61937_DOLBY_MAT21);
#define KSDATAFORMAT_SUBTYPE_IEC61937_DOLBY_MAT21                              \
...
DEFINE_GUIDSTRUCT("0000070c-0cea-0010-8000-00aa00389b71",
                  KSDATAFORMAT_SUBTYPE_IEC61937_DOLBY_MAT21_PROFILE4);
#define KSDATAFORMAT_SUBTYPE_IEC61937_DOLBY_MAT21_PROFILE4                     \
  DEFINE_GUIDNAMED(KSDATAFORMAT_SUBTYPE_IEC61937_DOLBY_MAT21_PROFILE4)

#define STATIC_KSDATAFORMAT_SUBTYPE_IEC61937_DST                               \
  0x0000000dL, 0x0cea, 0x0010, 0x80, 0x00, 0x00, 0xaa, 0x00, 0x38, 0x9b, 0x71
DEFINE_GUIDSTRUCT("0000000d-0cea-0010-8000-00aa00389b71",
                  KSDATAFORMAT_SUBTYPE_IEC61937_DST);
#define KSDATAFORMAT_SUBTYPE_IEC61937_DST                                      \
...
DEFINE_GUIDSTRUCT("000110bf-0cea-0010-8000-00aa00389b71",
                  KSDATAFORMAT_SUBTYPE_IEC61937_MPEGH_LEVEL1_LC);
#define KSDATAFORMAT_SUBTYPE_IEC61937_MPEGH_LEVEL1_LC                          \
  DEFINE_GUIDNAMED(KSDATAFORMAT_SUBTYPE_IEC61937_MPEGH_LEVEL1_LC)
...
DEFINE_GUIDSTRUCT("000120bf-0cea-0010-8000-00aa00389b71",
                  KSDATAFORMAT_SUBTYPE_IEC61937_MPEGH_LEVEL2_LC);
#define KSDATAFORMAT_SUBTYPE_IEC61937_MPEGH_LEVEL2_LC                          \
  DEFINE_GUIDNAMED(KSDATAFORMAT_SUBTYPE_IEC61937_MPEGH_LEVEL2_LC)
...
DEFINE_GUIDSTRUCT("000130bf-0cea-0010-8000-00aa00389b71",
                  KSDATAFORMAT_SUBTYPE_IEC61937_MPEGH_LEVEL3_LC);
#define KSDATAFORMAT_SUBTYPE_IEC61937_MPEGH_LEVEL3_LC                          \
  DEFINE_GUIDNAMED(KSDATAFORMAT_SUBTYPE_IEC61937_MPEGH_LEVEL3_LC)
...
DEFINE_GUIDSTRUCT("000140bf-0cea-0010-8000-00aa00389b71",
                  KSDATAFORMAT_SUBTYPE_IEC61937_MPEGH_LEVEL4_LC);
#define KSDATAFORMAT_SUBTYPE_IEC61937_MPEGH_LEVEL4_LC                          \
  DEFINE_GUIDNAMED(KSDATAFORMAT_SUBTYPE_IEC61937_MPEGH_LEVEL4_LC)
...
DEFINE_GUIDSTRUCT("000150bf-0cea-0010-8000-00aa00389b71",
                  KSDATAFORMAT_SUBTYPE_IEC61937_MPEGH_LEVEL5_LC);
#define KSDATAFORMAT_SUBTYPE_IEC61937_MPEGH_LEVEL5_LC                          \
  DEFINE_GUIDNAMED(KSDATAFORMAT_SUBTYPE_IEC61937_MPEGH_LEVEL5_LC)
...
DEFINE_GUIDSTRUCT("000210bf-0cea-0010-8000-00aa00389b71",
                  KSDATAFORMAT_SUBTYPE_IEC61937_MPEGH_LEVEL1_BL);
#define KSDATAFORMAT_SUBTYPE_IEC61937_MPEGH_LEVEL1_BL                          \
  DEFINE_GUIDNAMED(KSDATAFORMAT_SUBTYPE_IEC61937_MPEGH_LEVEL1_BL)
...
DEFINE_GUIDSTRUCT("000220bf-0cea-0010-8000-00aa00389b71",
                  KSDATAFORMAT_SUBTYPE_IEC61937_MPEGH_LEVEL2_BL);
#define KSDATAFORMAT_SUBTYPE_IEC61937_MPEGH_LEVEL2_BL                          \
  DEFINE_GUIDNAMED(KSDATAFORMAT_SUBTYPE_IEC61937_MPEGH_LEVEL2_BL)
...
DEFINE_GUIDSTRUCT("000230bf-0cea-0010-8000-00aa00389b71",
                  KSDATAFORMAT_SUBTYPE_IEC61937_MPEGH_LEVEL3_BL);
#define KSDATAFORMAT_SUBTYPE_IEC61937_MPEGH_LEVEL3_BL                          \
  DEFINE_GUIDNAMED(KSDATAFORMAT_SUBTYPE_IEC61937_MPEGH_LEVEL3_BL)
...
DEFINE_GUIDSTRUCT("000240bf-0cea-0010-8000-00aa00389b71",
                  KSDATAFORMAT_SUBTYPE_IEC61937_MPEGH_LEVEL4_BL);
#define KSDATAFORMAT_SUBTYPE_IEC61937_MPEGH_LEVEL4_BL                          \
  DEFINE_GUIDNAMED(KSDATAFORMAT_SUBTYPE_IEC61937_MPEGH_LEVEL4_BL)
...
DEFINE_GUIDSTRUCT("000250bf-0cea-0010-8000-00aa00389b71",
                  KSDATAFORMAT_SUBTYPE_IEC61937_MPEGH_LEVEL5_BL);
#define KSDATAFORMAT_SUBTYPE_IEC61937_MPEGH_LEVEL5_BL                          \
  DEFINE_GUIDNAMED(KSDATAFORMAT_SUBTYPE_IEC61937_MPEGH_LEVEL5_BL)

// MP3
#define STATIC_KSDATAFORMAT_SUBTYPE_MPEGLAYER3                                 \
  DEFINE_WAVEFORMATEX_GUID(WAVE_FORMAT_MPEGLAYER3)
DEFINE_GUIDSTRUCT("00000055-0000-0010-8000-00aa00389b71",
                  KSDATAFORMAT_SUBTYPE_MPEGLAYER3);
#define KSDATAFORMAT_SUBTYPE_MPEGLAYER3                                        \
...
DEFINE_GUIDSTRUCT("00001610-0000-0010-8000-00aa00389b71",
                  KSDATAFORMAT_SUBTYPE_MPEG_HEAAC);
#define KSDATAFORMAT_SUBTYPE_MPEG_HEAAC                                        \
...
DEFINE_GUIDSTRUCT("00000161-0000-0010-8000-00aa00389b71",
                  KSDATAFORMAT_SUBTYPE_WMAUDIO2);
#define KSDATAFORMAT_SUBTYPE_WMAUDIO2                                          \
...
DEFINE_GUIDSTRUCT("00000162-0000-0010-8000-00aa00389b71",
                  KSDATAFORMAT_SUBTYPE_WMAUDIO3);
#define KSDATAFORMAT_SUBTYPE_WMAUDIO3                                          \
...
DEFINE_GUIDSTRUCT("00000163-0000-0010-8000-00aa00389b71",
                  KSDATAFORMAT_SUBTYPE_WMAUDIO_LOSSLESS);
#define KSDATAFORMAT_SUBTYPE_WMAUDIO_LOSSLESS                                  \
...
DEFINE_GUIDSTRUCT("2017be05-6629-4248-aaed-7e1a47bc9b9c",
                  KSDATAFORMAT_SPECIFIER_H264_VIDEO);
#define KSDATAFORMAT_SPECIFIER_H264_VIDEO                                      \
...
DEFINE_GUIDSTRUCT("692fa379-d3e8-4651-b5b4-0b94b013eeaf",
                  KSDATAFORMAT_SPECIFIER_JPEG_IMAGE);
#define KSDATAFORMAT_SPECIFIER_JPEG_IMAGE                                      \
...
#define KSDATAFORMAT_SPECIFIER_IMAGE                                           \
...
DEFINE_GUIDSTRUCT("72178c23-e45b-11d5-bc2a-00b0d0f3f4ab",
...
DEFINE_GUIDSTRUCT("19e4a5aa-5662-4fc5-a0c0-1758028e1057",
...
DEFINE_GUIDSTRUCT("00000016-0000-0010-8000-00aa00389b71",
                  KSDATAFORMAT_SUBTYPE_IMAGE_RGB32);
#define KSDATAFORMAT_SUBTYPE_IMAGE_RGB32                                       \
...
DEFINE_GUIDSTRUCT("00000032-0000-0010-8000-00aa00389b71",
                  KSDATAFORMAT_SUBTYPE_L8);
...
DEFINE_GUIDSTRUCT("00000032-0002-0010-8000-00aa00389b71",
                  KSDATAFORMAT_SUBTYPE_L8_IR);
...
DEFINE_GUIDSTRUCT("00000032-8000-0010-8000-00aa00389b71",
                  KSDATAFORMAT_SUBTYPE_L8_CUSTOM);
#define KSDATAFORMAT_SUBTYPE_L8_CUSTOM                                         \
...
DEFINE_GUIDSTRUCT("00000051-0000-0010-8000-00aa00389b71",
                  KSDATAFORMAT_SUBTYPE_L16);
...
DEFINE_GUIDSTRUCT("00000051-0002-0010-8000-00aa00389b71",
                  KSDATAFORMAT_SUBTYPE_L16_IR);
#define KSDATAFORMAT_SUBTYPE_L16_IR                                            \
...
DEFINE_GUIDSTRUCT("00000050-0004-0010-8000-00aa00389b71",
                  KSDATAFORMAT_SUBTYPE_D16);
...
DEFINE_GUIDSTRUCT("00000051-8000-0010-8000-00aa00389b71",
                  KSDATAFORMAT_SUBTYPE_L16_CUSTOM);
#define KSDATAFORMAT_SUBTYPE_L16_CUSTOM                                        \
...
DEFINE_GUIDSTRUCT("47504a4d-0002-0010-8000-00aa00389b71",
                  KSDATAFORMAT_SUBTYPE_MJPG_IR);
#define KSDATAFORMAT_SUBTYPE_MJPG_IR                                           \
...
DEFINE_GUIDSTRUCT("47504a4d-0004-0010-8000-00aa00389b71",
                  KSDATAFORMAT_SUBTYPE_MJPG_DEPTH);
#define KSDATAFORMAT_SUBTYPE_MJPG_DEPTH                                        \
...
DEFINE_GUIDSTRUCT("47504a4d-8000-0010-8000-00aa00389b71",
                  KSDATAFORMAT_SUBTYPE_MJPG_CUSTOM);
#define KSDATAFORMAT_SUBTYPE_MJPG_CUSTOM                                       \
...
#define KS_COPYPROTECT_RestrictDuplication                                     \
...
#define KS_MPEG2_WidescreenAnalogOut                                           \
...
typedef struct tagKS_VIDEOINFOHEADER2 {
  ...
  DWORD dwCopyProtectFlags; // use KS_COPYPROTECT_* defines. Reject connection
...
typedef enum {
  ...
  KS_CAPTURE_ALLOC_SYSTEM_AGP =
      0x0004, // surface in system memory tagged as AGP accessible
  KS_CAPTURE_ALLOC_VRAM_MAPPED =
      0x0008, // surface in system memory mapped into VRAM address space
...
typedef enum {
  ...
  KSPROPERTY_PREFERRED_CAPTURE_SURFACE, // Returns the memory surface preferred
                                        // by that pin
  KSPROPERTY_CURRENT_CAPTURE_SURFACE,   // Sets/Gets currently selected capture
                                        // surface
  KSPROPERTY_MAP_CAPTURE_HANDLE_TO_VRAM_ADDRESS // Maps VRAM surface handle to
...
DEFINE_GUIDSTRUCT("AE53FC6E-8D89-4488-9D2E-4D008731C5FD",
                  KS_SECURE_CAMERA_SCENARIO_ID);
#define KS_SECURE_CAMERA_SCENARIO_ID                                           \
...
DEFINE_GUIDSTRUCT("FF6C4BFA-07A9-4c7b-A237-672F9D68065F",
                  KSPROPSETID_MPEG4_MediaType_Attributes);
#define KSPROPSETID_MPEG4_MediaType_Attributes                                 \
...
DEFINE_GUIDSTRUCT("162AC456-83D7-4239-96DF-C75FFA138BC6",
                  KSEVENTSETID_DynamicFormatChange);
#define KSEVENTSETID_DynamicFormatChange                                       \
  DEFINE_GUIDNAMED(KSEVENTSETID_DynamicFormatChange)

typedef enum { KSEVENT_DYNAMIC_FORMAT_CHANGE = 0 } KSEVENT_DYNAMICFORMATCHANGE;
...
DEFINE_GUIDSTRUCT("FC9D87B5-0B02-438E-89B0-E241FCE889AD",
                  KSATTRIBUTEID_VIDEOFORMAT_DX12);
#define KSATTRIBUTEID_VIDEOFORMAT_DX12                                         \
  DEFINE_GUIDNAMED(KSATTRIBUTEID_VIDEOFORMAT_DX12)
...
typedef enum {
  ...
  KSPROPERTY_TUNER_NETWORKTYPE_SCAN_CAPS // R -network type specific tuner
                                         // capabilities
} KSPROPERTY_TUNER;
...
typedef enum _TunerDecoderLockType {
  Tuner_LockType_None =
      0x00, // Not locked on a signal. Can be returned at end of scan.
  Tuner_LockType_Within_Scan_Sensing_Range =
      0x01, // Signal is near by, not able to report exact frequency. Can be
            // returned at end of scan.
  Tuner_LockType_Locked =
      0x02 // Fine tune signal lock established. Can be returned at end of scan.
} TunerLockType;
...
typedef struct {
  ULONG Mode;                 // IN -KSPROPERTY_TUNER_MODE
  ULONG StandardsSupported;   // KS_AnalogVideo_* (defined in
                              // KS_AnalogVideoStandard)
  ULONG MinFrequency;         // R -Hz
  ULONG MaxFrequency;         // R -Hz
  ULONG TuningGranularity;    // R -Hz
  ULONG SettlingTime;         // R -milliSeconds
  ULONG ScanSensingRange;     // R -max range (Hz) in which tuner can detect
                              // presence of a signal
  ULONG FineTuneSensingRange; // R -max range (Hz) in which tuner can detect
                              // actual frequency of a signal
...
// Get specific network type capabilities structure (such as TUNER_ANALOG_CAPS_S
// for example)
typedef struct {
  KSPROPERTY Property;
  GUID NetworkType;               // R  -one of the interested GUIDs returned in
...
DEFINE_GUIDSTRUCT("22A11754-9701-4088-B33F-6B9CBC52DF5E",
                  KSEVENTSETID_CameraAsyncControl);
#define KSEVENTSETID_CameraAsyncControl                                        \
...
DEFINE_GUIDSTRUCT("785E8F49-63A2-4144-AB70-FFB278FA26CE",
                  PROPSETID_VIDCAP_CAMERACONTROL_FLASH);
#define PROPSETID_VIDCAP_CAMERACONTROL_FLASH                                   \
...
DEFINE_GUIDSTRUCT("43964BD3-7716-404e-8BE1-D299B20E50FD",
                  PROPSETID_VIDCAP_CAMERACONTROL_VIDEO_STABILIZATION);
#define PROPSETID_VIDCAP_CAMERACONTROL_VIDEO_STABILIZATION                     \
...
#define KSPROPERTY_CAMERACONTROL_VIDEOSTABILIZATION_MODE_FLAGS_MANUAL          \
  0x00000002L
...
DEFINE_GUIDSTRUCT("9D12D198-F86C-4fed-B023-5D87653DA793",
                  PROPSETID_VIDCAP_CAMERACONTROL_REGION_OF_INTEREST);
#define PROPSETID_VIDCAP_CAMERACONTROL_REGION_OF_INTEREST                      \
...
DEFINE_GUIDSTRUCT("2FDFFC5D-C732-4BA6-B5DF-6B4D7FC88B8B",
                  EVENTSETID_VIDCAP_CAMERACONTROL_REGION_OF_INTEREST);
#define EVENTSETID_VIDCAP_CAMERACONTROL_REGION_OF_INTEREST                     \
...
DEFINE_GUIDSTRUCT("9D3D7BBF-5C6D-4138-BB00-584EDD20F7C5",
                  PROPSETID_VIDCAP_CAMERACONTROL_IMAGE_PIN_CAPABILITY);
#define PROPSETID_VIDCAP_CAMERACONTROL_IMAGE_PIN_CAPABILITY                    \
...
#define KSPROPERTY_CAMERACONTROL_IMAGE_PIN_CAPABILITY_EXCLUSIVE_WITH_RECORD    \
  0x00000001L
#define KSPROPERTY_CAMERACONTROL_IMAGE_PIN_CAPABILITY_SEQUENCE_EXCLUSIVE_WITH_RECORD \
  0x00000002L
...
typedef enum {
  ...
  KSPROPERTY_CAMERACONTROL_EXTENDED_END, // All new controls must be before
                                         // this!
...
DEFINE_GUIDSTRUCT("1CB79112-C0D2-4213-9CA6-CD4FDB927972",
                  KSPROPERTYSETID_ExtendedCameraControl);
#define KSPROPERTYSETID_ExtendedCameraControl                                  \
...
DEFINE_GUIDSTRUCT("571C92C9-13A2-47E3-A649-D2A778166384",
                  KSEVENTSETID_ExtendedCameraControl);
#define KSEVENTSETID_ExtendedCameraControl                                     \
...
DEFINE_GUIDSTRUCT("7899B2E0-6B43-4964-9D2A-A21F4061F576",
...
// Property set implemented exclusively by Windows Studio camera effect pack
// (also known as MEP)
#if (NTDDI_VERSION >= NTDDI_WIN11_ZN)
#define STATIC_KSPROPERTYSETID_WindowsCameraEffect                             \
  0x1666d655, 0x21a6, 0x4982, 0x97, 0x28, 0x52, 0xc3, 0x9e, 0x86, 0x9f, 0x90
DEFINE_GUIDSTRUCT("1666D655-21A6-4982-9728-52C39E869F90",
                  KSPROPERTYSETID_WindowsCameraEffect);
#define KSPROPERTYSETID_WindowsCameraEffect                                    \
  DEFINE_GUIDNAMED(KSPROPERTYSETID_WindowsCameraEffect)
#endif // (NTDDI_VERSION >= NTDDI_WIN11_ZN)
...
// EXTENDEDPROP capability flags defined below must NOT use the upper 8 bits.
...
#define KSCAMERA_EXTENDEDPROP_FLASH_MODE_MASK                                  \
...
#define KSCAMERA_EXTENDEDPROP_OPTIMIZATION_PERF_MASK                           \
...
#define KSCAMERA_EXTENDEDPROP_OPTIMIZATION_PRIMARYUSE_MASK                     \
...
#define KSCAMERA_EXTENDEDPROP_VIDEOPROCFLAG_MASK                               \
...
// flag.
#define KSCAMERA_EXTENDEDPROP_FOCUS_MODE_MASK                                  \
...
#define KSCAMERA_EXTENDEDPROP_FOCUS_RANGE_MASK                                 \
...
#define KSCAMERA_EXTENDEDPROP_FOCUS_DISTANCE_MASK                              \
...
#define KSCAMERA_EXTENDEDPROP_FOCUS_MODE_ADVANCED_MASK                         \
...
#define KSCAMERA_EXTENDEDPROP_FLASH_ASSISTANT_MASK                             \
...
// fields are provided by the application, the preview/capture FPS fields are
// filled in by the driver to indicate the maximum sensor frame rate.
...
typedef struct tagKSCAMERA_EXTENDEDPROP_ROI_INFO {
  RECT Region;     // Relative coordinates on the frame that face detection is
                   // running (Q31 format)
  ULONGLONG Flags; // VIDEOPROCFLAG flags indicating the op mode for the ISP
                   // control. Default is 0 for focus
  LONG Weight;     // Weight of the region   (0 -100)
  LONG RegionOfInterestType; // KSCAMERA_EXTENDEDPROP_ROITYPE_FACE, if the
                             // region is a face; Unknown otherwise
...
DEFINE_GUIDSTRUCT("F1F3E261-DEE6-4537-BFF5-EE206DB54AAC",
                  KSPROPERTYSETID_PerFrameSettingControl);
#define KSPROPERTYSETID_PerFrameSettingControl                                 \
...
#define KSCAMERA_EXTENDEDPROP_FACEDETECTION_MASK                               \
...
#define KSCAMERA_EXTENDEDPROP_FACEDETECTION_ADVANCED_MASK                      \
...
#define KSCAMERA_EXTENDEDPROP_FACEAUTH_MODE_ALTERNATIVE_FRAME_ILLUMINATION     \
  0x0000000000000002
#define KSCAMERA_EXTENDEDPROP_FACEAUTH_MODE_BACKGROUND_SUBTRACTION             \
  0x0000000000000004
...
#define KSCAMERA_EXTENDEDPROP_IRTORCHMODE_ALTERNATING_FRAME_ILLUMINATION       \
  0x0000000000000004
...
#define KSCAMERA_EXTENDEDPROP_RELATIVEPANELOPTIMIZATION_DYNAMIC                \
  0x0000000000000002

#define KSCAMERA_EXTENDEDPROP_RELATIVEPANELOPTIMIZATION_MASK                   \
...
#if (NTDDI_VERSION >= NTDDI_WIN10_NI)
#define KSCAMERA_EXTENDEDPROP_BACKGROUNDSEGMENTATION_SHALLOWFOCUS              \
  0x0000000000000004
#endif //  (NTDDI_VERSION >= NTDDI_WIN10_NI)
...
#define KSCAMERA_EXTENDEDPROP_DIGITALWINDOW_MASK                               \
...
typedef struct tagKSCAMERA_EXTENDEDPROP_FIELDOFVIEW2_CONFIGCAPS {
  WORD DefaultDiagonalFieldOfViewInDegrees; // This is the default Field of View
                                            // value in degrees.
  WORD
      DiscreteFoVStopsCount; // Count of used entries in DiscreteFoVStops array.
...
typedef struct tagKSCAMERA_EXTENDEDPROP_BACKGROUNDSEGMENTATION_CONFIGCAPS {
  ...
  // to zero, all streams conforming the Resolution and MaxFrameRate will
  // support background segmentation with the specified MaskResolution.
  GUID SubType;
...
typedef struct tagKSCAMERA_METADATA_BACKGROUNDSEGMENTATIONMASK {
  ...
  BYTE MaskData[1]; // Array of mask data of dimension MaskResolution.cx *
                    // MaskResolution.cy
...
DEFINE_GUIDSTRUCT("B4894D81-62B7-4EEC-8740-80658C4A9D3E",
...
DEFINE_GUIDSTRUCT("A0E517E8-8F8C-4F6F-9A57-46FC2F647EC0",
                  KSCAMERAPROFILE_VideoRecording);
#define KSCAMERAPROFILE_VideoRecording                                         \
...
DEFINE_GUIDSTRUCT("32440725-961B-4CA3-B5B2-854E719D9E1B",
                  KSCAMERAPROFILE_HighQualityPhoto);
#define KSCAMERAPROFILE_HighQualityPhoto                                       \
...
DEFINE_GUIDSTRUCT("6B52B017-42C7-4A21-BFE3-23F009149887",
                  KSCAMERAPROFILE_BalancedVideoAndPhoto);
#define KSCAMERAPROFILE_BalancedVideoAndPhoto                                  \
...
DEFINE_GUIDSTRUCT("C5444A88-E1BF-4597-B2DD-9E1EAD864BB8",
                  KSCAMERAPROFILE_VideoConferencing);
#define KSCAMERAPROFILE_VideoConferencing                                      \
...
DEFINE_GUIDSTRUCT("02399D9D-4EE8-49BA-BC07-5FF156531413",
                  KSCAMERAPROFILE_PhotoSequence);
#define KSCAMERAPROFILE_PhotoSequence                                          \
...
DEFINE_GUIDSTRUCT("81361B22-700B-4546-A2D4-C52E907BFC27",
                  KSCAMERAPROFILE_FaceAuth_Mode);
#define KSCAMERAPROFILE_FaceAuth_Mode                                          \
...
DEFINE_GUIDSTRUCT("566E6113-8C35-48E7-B89F-D23FDC1219DC",
                  KSCAMERAPROFILE_HighFrameRate);
#define KSCAMERAPROFILE_HighFrameRate                                          \
...
DEFINE_GUIDSTRUCT("4B27C336-4924-4989-B994-FDAF1DC7CD85",
                  KSCAMERAPROFILE_HDRWithWCGVideo);
#define KSCAMERAPROFILE_HDRWithWCGVideo                                        \
...
DEFINE_GUIDSTRUCT("9BF6F1FF-B555-4625-B326-A46DEF318FB7",
                  KSCAMERAPROFILE_HDRWithWCGPhoto);
#define KSCAMERAPROFILE_HDRWithWCGPhoto                                        \
...
DEFINE_GUIDSTRUCT("9FF2CB56-E75A-49B1-A928-9985D5946F87",
                  KSCAMERAPROFILE_VariablePhotoSequence);
#define KSCAMERAPROFILE_VariablePhotoSequence                                  \
...
DEFINE_GUIDSTRUCT("D4F3F4EC-BDFF-4314-B1D4-008E281F74E7",
...
DEFINE_GUIDSTRUCT("0E34CDC1-27AD-437F-ABDE-02B629F37B44",
                  KSCAMERAPROFILE_CompressedCamera);
#define KSCAMERAPROFILE_CompressedCamera                                       \
  DEFINE_GUIDNAMED(KSCAMERAPROFILE_CompressedCamera)
#endif
...
DEFINE_GUIDSTRUCT("0E780F09-5745-4E3A-BC9F-F226EA43A6EC",
                  KSPROPERTYSETID_NetworkCameraControl);
#define KSPROPERTYSETID_NetworkCameraControl                                   \
  DEFINE_GUIDNAMED(KSPROPERTYSETID_NetworkCameraControl)
...
typedef struct {
  ...
  ULONG Active; // R - returns whether an active signal is present on the given
                // input
...
{ KS_PixAspectRatio_NTSC4x3,
  ...
  KS_PixAspectRatio_PAL16x9 } KS_AMPixAspectRatio;
...
typedef struct _tagKSJACK_DESCRIPTION2 {
  DWORD DeviceStateInfo;  // Top 16 bits: Report current device state, active,
                          // streaming, idle, or hardware not ready Bottom 16
                          // bits: detailed reason to further explain state in
                          // top 16 bits
  DWORD JackCapabilities; // Report jack capabilities such as jack presence
                          // detection capability or dynamic format changing
                          // capability
} KSJACK_DESCRIPTION2, *PKSJACK_DESCRIPTION2;

#if (NTDDI_VERSION >= NTDDI_WIN10_NI)
typedef struct _tagKSJACK_DESCRIPTION3 {
  ULONG ConfigId; // Driver defined bitmask or enum describing the current
                  // configuration, changing this value causes
                  // audioendpointbuilder to refresh the cache to ensure that
                  // the published endpoint matches the current config.
...
DEFINE_GUIDSTRUCT("A3FB7B0D-474E-4F51-A379-51282DD4FA8F",
...
DEFINE_GUIDSTRUCT("4E73C07F-23CC-4955-A7EA-3DA502496290",
                  KSPROPSETID_AudioBufferDuration);
#define KSPROPSETID_AudioBufferDuration                                        \
...
DEFINE_GUIDSTRUCT("3A2F82DC-886F-4BAA-9EB4-082B9025C536",
...
DEFINE_GUIDSTRUCT("4F67B528-30C9-40DE-B2FB-859DDD1F3470",
                  KSPROPSETID_AudioSignalProcessing);
#define KSPROPSETID_AudioSignalProcessing                                      \
...
#define STATIC_KSATTRIBUTEID_AUDIOSIGNALPROCESSING_MODE                        \
  0xe1f89eb5, 0x5f46, 0x419b, 0x96, 0x7b, 0xff, 0x67, 0x70, 0xb9, 0x84, 0x1
DEFINE_GUIDSTRUCT("E1F89EB5-5F46-419B-967B-FF6770B98401",
                  KSATTRIBUTEID_AUDIOSIGNALPROCESSING_MODE);
#define KSATTRIBUTEID_AUDIOSIGNALPROCESSING_MODE                               \
...
#define STATIC_AUDIO_SIGNALPROCESSINGMODE_DEFAULT                              \
  0xc18e2f7e, 0x933d, 0x4965, 0xb7, 0xd1, 0x1e, 0xef, 0x22, 0x8d, 0x2a, 0xf3
DEFINE_GUIDSTRUCT("C18E2F7E-933D-4965-B7D1-1EEF228D2AF3",
                  AUDIO_SIGNALPROCESSINGMODE_DEFAULT);
#define AUDIO_SIGNALPROCESSINGMODE_DEFAULT                                     \
  DEFINE_GUIDNAMED(AUDIO_SIGNALPROCESSINGMODE_DEFAULT)

#define STATIC_AUDIO_SIGNALPROCESSINGMODE_RAW                                  \
  0x9e90ea20, 0xb493, 0x4fd1, 0xa1, 0xa8, 0x7e, 0x13, 0x61, 0xa9, 0x56, 0xcf
DEFINE_GUIDSTRUCT("9E90EA20-B493-4FD1-A1A8-7E1361A956CF",
...
#define STATIC_KSPROPSETID_AudioLoopback                                       \
  0xb3648bc8, 0x5b91, 0x468a, 0xb9, 0x4d, 0xf4, 0x64, 0x12, 0x50, 0x91, 0x7c
DEFINE_GUIDSTRUCT("B3648BC8-5B91-468A-B94D-F4641250917C",
...
#define STATIC_KSATTRIBUTEID_AUDIOLOOPBACK_TAPPOINT                            \
  0x2795a0f7, 0x1688, 0x44fe, 0xbc, 0x14, 0xbf, 0x82, 0x73, 0x99, 0x21, 0x41
DEFINE_GUIDSTRUCT("2795A0F7-1688-44FE-BC14-BF8273992141",
                  KSATTRIBUTEID_AUDIOLOOPBACK_TAPPOINT);
#define KSATTRIBUTEID_AUDIOLOOPBACK_TAPPOINT                                   \
  DEFINE_GUIDNAMED(KSATTRIBUTEID_AUDIOLOOPBACK_TAPPOINT)
...
DEFINE_GUIDSTRUCT("D0B305E1-B2CC-484C-8F23-E5D28AD9CF88",
                  KSPROPSETID_AudioResourceManagement);
#define KSPROPSETID_AudioResourceManagement                                    \
  DEFINE_GUIDNAMED(KSPROPSETID_AudioResourceManagement)
...
DEFINE_GUIDSTRUCT("03B80E5A-EDE8-4B33-A751-6CE34EC4C700",
                  BLUETOOTHLE_MIDI_SERVICE_UUID);
#define BLUETOOTHLE_MIDI_SERVICE_UUID                                          \
...
DEFINE_GUIDSTRUCT("7772E5DB-3868-4112-A1A9-F2669D106BF3",
                  BLUETOOTH_MIDI_DATAIO_CHARACTERISTIC);
#define BLUETOOTH_MIDI_DATAIO_CHARACTERISTIC                                   \
...
DEFINE_GUIDSTRUCT("C166523C-FE0C-4A94-A586-F1A80CFBBF3E",
...
// Communications mode specifies that the application expects VoIP specific
// signal processing at the lowest latency and the hardware preferred sample
// rate for wideband speech (such as 16 kHz). For both Capture and Render.
#define STATIC_AUDIO_SIGNALPROCESSINGMODE_COMMUNICATIONS                       \
  0x98951333, 0xb9cd, 0x48b1, 0xa0, 0xa3, 0xff, 0x40, 0x68, 0x2d, 0x73, 0xf7
DEFINE_GUIDSTRUCT("98951333-B9CD-48B1-A0A3-FF40682D73F7",
                  AUDIO_SIGNALPROCESSINGMODE_COMMUNICATIONS);
#define AUDIO_SIGNALPROCESSINGMODE_COMMUNICATIONS                              \
  DEFINE_GUIDNAMED(AUDIO_SIGNALPROCESSINGMODE_COMMUNICATIONS)

// Speech mode specifies that the application expects speech recognition
// specific signal processing at the lowest latency and the hardware preferred
// sample rate for wideband speech (such as 16 kHz). For Capture only.
#define STATIC_AUDIO_SIGNALPROCESSINGMODE_SPEECH                               \
  0xfc1cfc9b, 0xb9d6, 0x4cfa, 0xb5, 0xe0, 0x4b, 0xb2, 0x16, 0x68, 0x78, 0xb2
DEFINE_GUIDSTRUCT("FC1CFC9B-B9D6-4CFA-B5E0-4BB2166878B2",
...
#define STATIC_AUDIO_SIGNALPROCESSINGMODE_NOTIFICATION                         \
  0x9cf2a70b, 0xf377, 0x403b, 0xbd, 0x6b, 0x36, 0x8, 0x63, 0xe0, 0x35, 0x5c
DEFINE_GUIDSTRUCT("9CF2A70B-F377-403B-BD6B-360863E0355C",
                  AUDIO_SIGNALPROCESSINGMODE_NOTIFICATION);
#define AUDIO_SIGNALPROCESSINGMODE_NOTIFICATION                                \
  DEFINE_GUIDNAMED(AUDIO_SIGNALPROCESSINGMODE_NOTIFICATION)

// Media Mode specifies that the application expects post processing suitable
// for media content if available or else the same treatments as Default mode.
// For Render only.
#define STATIC_AUDIO_SIGNALPROCESSINGMODE_MEDIA                                \
  0x4780004e, 0x7133, 0x41d8, 0x8c, 0x74, 0x66, 0x0d, 0xad, 0xd2, 0xc0, 0xee
DEFINE_GUIDSTRUCT("4780004E-7133-41D8-8C74-660DADD2C0EE",
                  AUDIO_SIGNALPROCESSINGMODE_MEDIA);
#define AUDIO_SIGNALPROCESSINGMODE_MEDIA                                       \
  DEFINE_GUIDNAMED(AUDIO_SIGNALPROCESSINGMODE_MEDIA)

// Movie Mode specifies that the application expects post processing suitable
// for movie or video content if available or else the same treatments as
// Default mode.
#define STATIC_AUDIO_SIGNALPROCESSINGMODE_MOVIE                                \
  0xb26feb0d, 0xec94, 0x477c, 0x94, 0x94, 0xd1, 0xab, 0x8e, 0x75, 0x3f, 0x6e
DEFINE_GUIDSTRUCT("B26FEB0D-EC94-477C-9494-D1AB8E753F6E",
                  AUDIO_SIGNALPROCESSINGMODE_MOVIE);
#define AUDIO_SIGNALPROCESSINGMODE_MOVIE                                       \
...
// Far-Field speech mode specifies that the application expects speech
// recognition from the far-field For capture only
#define STATIC_AUDIO_SIGNALPROCESSINGMODE_FAR_FIELD_SPEECH                     \
  0x28941cba, 0x3be6, 0x4a78, 0x9a, 0x76, 0x30, 0xfd, 0x91, 0x55, 0x9b, 0x64
DEFINE_GUIDSTRUCT("28941CBA-3BE6-4A78-9A76-30FD91559B64",
                  AUDIO_SIGNALPROCESSINGMODE_FAR_FIELD_SPEECH);
#define AUDIO_SIGNALPROCESSINGMODE_FAR_FIELD_SPEECH                            \
  DEFINE_GUIDNAMED(AUDIO_SIGNALPROCESSINGMODE_FAR_FIELD_SPEECH)

#endif // (NTDDI_VERSION >= NTDDI_WIN10_FE)

#define STATIC_AUDIO_EFFECT_TYPE_ACOUSTIC_ECHO_CANCELLATION                    \
  0x6f64adbe, 0x8211, 0x11e2, 0x8c, 0x70, 0x2c, 0x27, 0xd7, 0xf0, 0x01, 0xfa
DEFINE_GUIDSTRUCT("6f64adbe-8211-11e2-8c70-2c27d7f001fa",
...
#define STATIC_AUDIO_EFFECT_TYPE_NOISE_SUPPRESSION                             \
  0x6f64adbf, 0x8211, 0x11e2, 0x8c, 0x70, 0x2c, 0x27, 0xd7, 0xf0, 0x01, 0xfa
DEFINE_GUIDSTRUCT("6f64adbf-8211-11e2-8c70-2c27d7f001fa",
                  AUDIO_EFFECT_TYPE_NOISE_SUPPRESSION);
#define AUDIO_EFFECT_TYPE_NOISE_SUPPRESSION                                    \
  DEFINE_GUIDNAMED(AUDIO_EFFECT_TYPE_NOISE_SUPPRESSION)

#define STATIC_AUDIO_EFFECT_TYPE_AUTOMATIC_GAIN_CONTROL                        \
  0x6f64adc0, 0x8211, 0x11e2, 0x8c, 0x70, 0x2c, 0x27, 0xd7, 0xf0, 0x01, 0xfa
DEFINE_GUIDSTRUCT("6f64adc0-8211-11e2-8c70-2c27d7f001fa",
                  AUDIO_EFFECT_TYPE_AUTOMATIC_GAIN_CONTROL);
#define AUDIO_EFFECT_TYPE_AUTOMATIC_GAIN_CONTROL                               \
  DEFINE_GUIDNAMED(AUDIO_EFFECT_TYPE_AUTOMATIC_GAIN_CONTROL)

#define STATIC_AUDIO_EFFECT_TYPE_BEAMFORMING                                   \
  0x6f64adc1, 0x8211, 0x11e2, 0x8c, 0x70, 0x2c, 0x27, 0xd7, 0xf0, 0x01, 0xfa
DEFINE_GUIDSTRUCT("6f64adc1-8211-11e2-8c70-2c27d7f001fa",
                  AUDIO_EFFECT_TYPE_BEAMFORMING);
#define AUDIO_EFFECT_TYPE_BEAMFORMING                                          \
  DEFINE_GUIDNAMED(AUDIO_EFFECT_TYPE_BEAMFORMING)

#define STATIC_AUDIO_EFFECT_TYPE_CONSTANT_TONE_REMOVAL                         \
  0x6f64adc2, 0x8211, 0x11e2, 0x8c, 0x70, 0x2c, 0x27, 0xd7, 0xf0, 0x01, 0xfa
DEFINE_GUIDSTRUCT("6f64adc2-8211-11e2-8c70-2c27d7f001fa",
                  AUDIO_EFFECT_TYPE_CONSTANT_TONE_REMOVAL);
#define AUDIO_EFFECT_TYPE_CONSTANT_TONE_REMOVAL                                \
  DEFINE_GUIDNAMED(AUDIO_EFFECT_TYPE_CONSTANT_TONE_REMOVAL)

#define STATIC_AUDIO_EFFECT_TYPE_EQUALIZER                                     \
  0x6f64adc3, 0x8211, 0x11e2, 0x8c, 0x70, 0x2c, 0x27, 0xd7, 0xf0, 0x01, 0xfa
DEFINE_GUIDSTRUCT("6f64adc3-8211-11e2-8c70-2c27d7f001fa",
                  AUDIO_EFFECT_TYPE_EQUALIZER);
#define AUDIO_EFFECT_TYPE_EQUALIZER                                            \
  DEFINE_GUIDNAMED(AUDIO_EFFECT_TYPE_EQUALIZER)

#define STATIC_AUDIO_EFFECT_TYPE_LOUDNESS_EQUALIZER                            \
  0x6f64adc4, 0x8211, 0x11e2, 0x8c, 0x70, 0x2c, 0x27, 0xd7, 0xf0, 0x01, 0xfa
DEFINE_GUIDSTRUCT("6f64adc4-8211-11e2-8c70-2c27d7f001fa",
                  AUDIO_EFFECT_TYPE_LOUDNESS_EQUALIZER);
#define AUDIO_EFFECT_TYPE_LOUDNESS_EQUALIZER                                   \
  DEFINE_GUIDNAMED(AUDIO_EFFECT_TYPE_LOUDNESS_EQUALIZER)

#define STATIC_AUDIO_EFFECT_TYPE_BASS_BOOST                                    \
  0x6f64adc5, 0x8211, 0x11e2, 0x8c, 0x70, 0x2c, 0x27, 0xd7, 0xf0, 0x01, 0xfa
DEFINE_GUIDSTRUCT("6f64adc5-8211-11e2-8c70-2c27d7f001fa",
                  AUDIO_EFFECT_TYPE_BASS_BOOST);
#define AUDIO_EFFECT_TYPE_BASS_BOOST                                           \
  DEFINE_GUIDNAMED(AUDIO_EFFECT_TYPE_BASS_BOOST)

#define STATIC_AUDIO_EFFECT_TYPE_VIRTUAL_SURROUND                              \
  0x6f64adc6, 0x8211, 0x11e2, 0x8c, 0x70, 0x2c, 0x27, 0xd7, 0xf0, 0x01, 0xfa
DEFINE_GUIDSTRUCT("6f64adc6-8211-11e2-8c70-2c27d7f001fa",
                  AUDIO_EFFECT_TYPE_VIRTUAL_SURROUND);
#define AUDIO_EFFECT_TYPE_VIRTUAL_SURROUND                                     \
  DEFINE_GUIDNAMED(AUDIO_EFFECT_TYPE_VIRTUAL_SURROUND)

#define STATIC_AUDIO_EFFECT_TYPE_VIRTUAL_HEADPHONES                            \
  0x6f64adc7, 0x8211, 0x11e2, 0x8c, 0x70, 0x2c, 0x27, 0xd7, 0xf0, 0x01, 0xfa
DEFINE_GUIDSTRUCT("6f64adc7-8211-11e2-8c70-2c27d7f001fa",
                  AUDIO_EFFECT_TYPE_VIRTUAL_HEADPHONES);
#define AUDIO_EFFECT_TYPE_VIRTUAL_HEADPHONES                                   \
  DEFINE_GUIDNAMED(AUDIO_EFFECT_TYPE_VIRTUAL_HEADPHONES)

#define STATIC_AUDIO_EFFECT_TYPE_SPEAKER_FILL                                  \
  0x6f64adc8, 0x8211, 0x11e2, 0x8c, 0x70, 0x2c, 0x27, 0xd7, 0xf0, 0x01, 0xfa
DEFINE_GUIDSTRUCT("6f64adc8-8211-11e2-8c70-2c27d7f001fa",
                  AUDIO_EFFECT_TYPE_SPEAKER_FILL);
#define AUDIO_EFFECT_TYPE_SPEAKER_FILL                                         \
  DEFINE_GUIDNAMED(AUDIO_EFFECT_TYPE_SPEAKER_FILL)

#define STATIC_AUDIO_EFFECT_TYPE_ROOM_CORRECTION                               \
  0x6f64adc9, 0x8211, 0x11e2, 0x8c, 0x70, 0x2c, 0x27, 0xd7, 0xf0, 0x01, 0xfa
DEFINE_GUIDSTRUCT("6f64adc9-8211-11e2-8c70-2c27d7f001fa",
                  AUDIO_EFFECT_TYPE_ROOM_CORRECTION);
#define AUDIO_EFFECT_TYPE_ROOM_CORRECTION                                      \
  DEFINE_GUIDNAMED(AUDIO_EFFECT_TYPE_ROOM_CORRECTION)

#define STATIC_AUDIO_EFFECT_TYPE_BASS_MANAGEMENT                               \
  0x6f64adca, 0x8211, 0x11e2, 0x8c, 0x70, 0x2c, 0x27, 0xd7, 0xf0, 0x01, 0xfa
DEFINE_GUIDSTRUCT("6f64adca-8211-11e2-8c70-2c27d7f001fa",
                  AUDIO_EFFECT_TYPE_BASS_MANAGEMENT);
#define AUDIO_EFFECT_TYPE_BASS_MANAGEMENT                                      \
  DEFINE_GUIDNAMED(AUDIO_EFFECT_TYPE_BASS_MANAGEMENT)

#define STATIC_AUDIO_EFFECT_TYPE_ENVIRONMENTAL_EFFECTS                         \
  0x6f64adcb, 0x8211, 0x11e2, 0x8c, 0x70, 0x2c, 0x27, 0xd7, 0xf0, 0x01, 0xfa
DEFINE_GUIDSTRUCT("6f64adcb-8211-11e2-8c70-2c27d7f001fa",
                  AUDIO_EFFECT_TYPE_ENVIRONMENTAL_EFFECTS);
#define AUDIO_EFFECT_TYPE_ENVIRONMENTAL_EFFECTS                                \
  DEFINE_GUIDNAMED(AUDIO_EFFECT_TYPE_ENVIRONMENTAL_EFFECTS)

#define STATIC_AUDIO_EFFECT_TYPE_SPEAKER_PROTECTION                            \
  0x6f64adcc, 0x8211, 0x11e2, 0x8c, 0x70, 0x2c, 0x27, 0xd7, 0xf0, 0x01, 0xfa
DEFINE_GUIDSTRUCT("6f64adcc-8211-11e2-8c70-2c27d7f001fa",
                  AUDIO_EFFECT_TYPE_SPEAKER_PROTECTION);
#define AUDIO_EFFECT_TYPE_SPEAKER_PROTECTION                                   \
  DEFINE_GUIDNAMED(AUDIO_EFFECT_TYPE_SPEAKER_PROTECTION)

#define STATIC_AUDIO_EFFECT_TYPE_SPEAKER_COMPENSATION                          \
  0x6f64adcd, 0x8211, 0x11e2, 0x8c, 0x70, 0x2c, 0x27, 0xd7, 0xf0, 0x01, 0xfa
DEFINE_GUIDSTRUCT("6f64adcd-8211-11e2-8c70-2c27d7f001fa",
                  AUDIO_EFFECT_TYPE_SPEAKER_COMPENSATION);
#define AUDIO_EFFECT_TYPE_SPEAKER_COMPENSATION                                 \
  DEFINE_GUIDNAMED(AUDIO_EFFECT_TYPE_SPEAKER_COMPENSATION)

#define STATIC_AUDIO_EFFECT_TYPE_DYNAMIC_RANGE_COMPRESSION                     \
  0x6f64adce, 0x8211, 0x11e2, 0x8c, 0x70, 0x2c, 0x27, 0xd7, 0xf0, 0x01, 0xfa
DEFINE_GUIDSTRUCT("6f64adce-8211-11e2-8c70-2c27d7f001fa",
...
#define STATIC_AUDIO_EFFECT_TYPE_FAR_FIELD_BEAMFORMING                         \
  0x6f64adcf, 0x8211, 0x11e2, 0x8c, 0x70, 0x2c, 0x27, 0xd7, 0xf0, 0x01, 0xfa
DEFINE_GUIDSTRUCT("6f64adcf-8211-11e2-8c70-2c27d7f001fa",
                  AUDIO_EFFECT_TYPE_FAR_FIELD_BEAMFORMING);
#define AUDIO_EFFECT_TYPE_FAR_FIELD_BEAMFORMING                                \
  DEFINE_GUIDNAMED(AUDIO_EFFECT_TYPE_FAR_FIELD_BEAMFORMING)

#define STATIC_AUDIO_EFFECT_TYPE_DEEP_NOISE_SUPPRESSION                        \
  0x6f64add0, 0x8211, 0x11e2, 0x8c, 0x70, 0x2c, 0x27, 0xd7, 0xf0, 0x01, 0xfa
DEFINE_GUIDSTRUCT("6f64add0-8211-11e2-8c70-2c27d7f001fa",
                  AUDIO_EFFECT_TYPE_DEEP_NOISE_SUPPRESSION);
#define AUDIO_EFFECT_TYPE_DEEP_NOISE_SUPPRESSION                               \
  DEFINE_GUIDNAMED(AUDIO_EFFECT_TYPE_DEEP_NOISE_SUPPRESSION)
...
DEFINE_GUIDSTRUCT("C034FDB0-FF75-47C8-AA3C-EE46716B50C6",
...
DEFINE_GUIDSTRUCT("9C2220F0-D9A6-4D5C-A036-573857FD50D2",
                  KSNOTIFICATIONID_AudioModule);
#define KSNOTIFICATIONID_AudioModule                                           \
