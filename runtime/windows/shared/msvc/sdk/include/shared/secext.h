...
_Success_(return != 0) BOOLEAN SEC_ENTRY
    GetUserNameExA(_In_ EXTENDED_NAME_FORMAT NameFormat,
                   _Out_writes_to_opt_(*nSize, *nSize) LPSTR lpNameBuffer,
                   _Inout_ PULONG nSize);

_Success_(return != 0) BOOLEAN SEC_ENTRY
    GetUserNameExW(_In_ EXTENDED_NAME_FORMAT NameFormat,
...
BOOLEAN
SEC_ENTRY
GetComputerObjectNameA(_In_ EXTENDED_NAME_FORMAT NameFormat,
                       _Out_writes_to_opt_(*nSize, *nSize) LPSTR lpNameBuffer,
                       _Inout_ PULONG nSize);
BOOLEAN
SEC_ENTRY
GetComputerObjectNameW(_In_ EXTENDED_NAME_FORMAT NameFormat,
                       _Out_writes_to_opt_(*nSize, *nSize) LPWSTR lpNameBuffer,
                       _Inout_ PULONG nSize);
...
BOOLEAN
SEC_ENTRY
TranslateNameA(_In_ LPCSTR lpAccountName,
...
BOOLEAN
SEC_ENTRY
TranslateNameW(_In_ LPCWSTR lpAccountName,
               _In_ EXTENDED_NAME_FORMAT AccountNameFormat,
               _In_ EXTENDED_NAME_FORMAT DesiredNameFormat,
