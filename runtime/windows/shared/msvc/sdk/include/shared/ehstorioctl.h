...
#define IOCTL_EHSTOR_DEVICE_SET_QUEUE_STATE                                    \
  CTL_CODE(IOCTL_STORAGE_BASE, 0x508, METHOD_BUFFERED,                         \
...
#define IOCTL_EHSTOR_DRIVER_REPORT_CAPABILITIES                                \
  CTL_CODE(IOCTL_STORAGE_BASE, 0x510, METHOD_BUFFERED,                         \
           FILE_READ_ACCESS | FILE_WRITE_ACCESS)
#define IOCTL_EHSTOR_DRIVER_UPDATE_LBA_FILTER_TABLE                            \
  CTL_CODE(IOCTL_STORAGE_BASE, 0x511, METHOD_BUFFERED,                         \
           FILE_READ_ACCESS | FILE_WRITE_ACCESS)
#define IOCTL_EHSTOR_DRIVER_PERFORM_AUTHZ                                      \
  CTL_CODE(IOCTL_STORAGE_BASE, 0x512, METHOD_BUFFERED,                         \
           FILE_READ_ACCESS | FILE_WRITE_ACCESS)

//
// Enhanced Storage GUIDs
//
DEFINE_GUID(GUID_EHSTOR_SILO_INTERFACE, 0x7c2bcf57, 0x2bea, 0x46da, 0xad, 0x26,
            0x78, 0xfd, 0xc8, 0x3c, 0xee, 0x46);
DEFINE_GUID(GUID_EHSTOR_CONTROL_INTERFACE, 0x4f40006f, 0xb933, 0x4550, 0xb5,
            0x32, 0x2b, 0x58, 0xce, 0xe6, 0x14, 0xd3);
