...
inline NET_FRAGMENT_VIRTUAL_ADDRESS *
NetExtensionGetFragmentVirtualAddress(NET_EXTENSION const *Extension,
                                      UINT32 Index) {
  return (NET_FRAGMENT_VIRTUAL_ADDRESS *)NetExtensionGetData(Extension, Index);
}

inline void *
NetExtensionGetFragmentVirtualAddressOffset(NET_FRAGMENT const *Fragment,
...
inline NET_FRAGMENT_WDFMEMORY *
NetExtensionGetFragmentWdfMemory(NET_EXTENSION const *Extension, UINT32 Index) {
