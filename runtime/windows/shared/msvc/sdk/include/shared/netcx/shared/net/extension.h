...
inline void *NetExtensionGetData(NET_EXTENSION const *Extension, UINT32 Index) {
  return (void *)((unsigned char *)(Extension->Reserved[0]) +
                  (SIZE_T)Extension->Reserved[1] * Index);
}
