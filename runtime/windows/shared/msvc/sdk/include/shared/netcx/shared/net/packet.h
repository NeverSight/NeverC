...
inline BOOLEAN NetPacketIsIpv4(const NET_PACKET *packet) {
...
inline BOOLEAN NetPacketIsIpv6(const NET_PACKET *packet) {
...
inline void *NetPacketGetExtension(const NET_PACKET *packet, SIZE_T offset) {
