...
typedef struct _DOT11_OI {
  USHORT
  OILength; // Must be between DOT11_OI_MIN_LENGTH and DOT11_OI_MAX_LENGTH
  UCHAR OI[DOT11_OI_MAX_LENGTH];
} DOT11_OI, *PDOT11_OI;

//
//  Similar to DOT11_INTERWORKING_ACCESSNETWORKOPTIONS, but it doesn't have bit
//  fields, which are not allowed for RPC interfaces
//
