...
#define IN6ADDR_LINKLOCALPREFIX_INIT                                           \
  {                                                                            \
      0xfe,                                                                    \
      0x80,                                                                    \
  }
...
#define IN6ADDR_6TO4PREFIX_INIT                                                \
  {                                                                            \
      0x20,                                                                    \
      0x02,                                                                    \
  }

#define IN6ADDR_TEREDOPREFIX_INIT                                              \
  {                                                                            \
      0x20,                                                                    \
      0x01,                                                                    \
      0x00,                                                                    \
...
#define IN6ADDR_TEREDOPREFIX_INIT_OLD                                          \
  {                                                                            \
      0x3f,                                                                    \
      0xfe,                                                                    \
      0x83,                                                                    \
...
IN6_IS_ADDR_UNSPECIFIED(CONST IN6_ADDR *a) {
  ...
  //
  return (BOOLEAN)((a->s6_words[0] == 0) && (a->s6_words[1] == 0) &&
...
IN6_IS_ADDR_SUBNET_ROUTER_ANYCAST(CONST IN6_ADDR *a) {
  return (BOOLEAN)(IN6_IS_ADDR_EUI64(a) && (a->s6_words[4] == 0) &&
...
IN6_IS_ADDR_SUBNET_RESERVED_ANYCAST(CONST IN6_ADDR *a) {
  return (BOOLEAN)(IN6_IS_ADDR_EUI64(a) && (a->s6_words[4] == 0xfffd) &&
                   (a->s6_words[5] == 0xffff) && (a->s6_words[6] == 0xffff) &&
...
IN6_IS_ADDR_V4TRANSLATED(CONST IN6_ADDR *a) {
  return (BOOLEAN)((a->s6_words[0] == 0) && (a->s6_words[1] == 0) &&
                   (a->s6_words[2] == 0) && (a->s6_words[3] == 0) &&
                   (a->s6_words[4] == 0xffff) && (a->s6_words[5] == 0));
}
...
//
typedef enum { MCAST_INCLUDE = 0, MCAST_EXCLUDE } MULTICAST_MODE_TYPE;
...
#define PROTECTION_LEVEL_EDGERESTRICTED                                        \
  20                                   // Same as unrestricted. Except for
                                       // Teredo.
