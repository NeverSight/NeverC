...
_IRQL_requires_max_(PASSIVE_LEVEL) IPHLPAPI_DLL_LINKAGE _NETIOAPI_SUCCESS_
...
_IRQL_requires_max_(PASSIVE_LEVEL)
    ...
    GetIfEntry2Ex(_In_ MIB_IF_ENTRY_LEVEL Level, _Inout_ PMIB_IF_ROW2 Row);
/*++
...
_IRQL_requires_max_(PASSIVE_LEVEL) IPHLPAPI_DLL_LINKAGE _NETIOAPI_SUCCESS_
    NETIOAPI_API GetIfTable2(_Outptr_ PMIB_IF_TABLE2 *Table);
/*++
...
_IRQL_requires_max_(PASSIVE_LEVEL) IPHLPAPI_DLL_LINKAGE _NETIOAPI_SUCCESS_
    NETIOAPI_API GetIfTable2Ex(_In_ MIB_IF_TABLE_LEVEL Level,
...
typedef VOID(NETIOAPI_API_ *PIPINTERFACE_CHANGE_CALLBACK)(
    _In_ PVOID CallerContext, _In_ PMIB_IPINTERFACE_ROW Row OPTIONAL,
...
_IRQL_requires_max_(PASSIVE_LEVEL) IPHLPAPI_DLL_LINKAGE _NETIOAPI_SUCCESS_
    NETIOAPI_API GetIfStackTable(_Outptr_ PMIB_IFSTACK_TABLE *Table);

_IRQL_requires_max_(PASSIVE_LEVEL)
    IPHLPAPI_DLL_LINKAGE _NETIOAPI_SUCCESS_ NETIOAPI_API
    GetInvertedIfStackTable(_Outptr_ PMIB_INVERTEDIFSTACK_TABLE *Table);
...
_IRQL_requires_max_(PASSIVE_LEVEL) IPHLPAPI_DLL_LINKAGE _NETIOAPI_SUCCESS_
    NETIOAPI_API GetIpInterfaceTable(_In_ ADDRESS_FAMILY Family,
...
_IRQL_requires_max_(PASSIVE_LEVEL) IPHLPAPI_DLL_LINKAGE VOID NETIOAPI_API_
    InitializeIpInterfaceEntry(_Inout_ PMIB_IPINTERFACE_ROW Row);
/*++
...
_IRQL_requires_max_(PASSIVE_LEVEL)
    IPHLPAPI_DLL_LINKAGE _NETIOAPI_SUCCESS_ NETIOAPI_API
    NotifyIpInterfaceChange(_In_ ADDRESS_FAMILY Family,
...
_IRQL_requires_max_(PASSIVE_LEVEL) IPHLPAPI_DLL_LINKAGE _NETIOAPI_SUCCESS_
    NETIOAPI_API SetIpInterfaceEntry(_Inout_ PMIB_IPINTERFACE_ROW Row);
/*++
...
_IRQL_requires_max_(PASSIVE_LEVEL) IPHLPAPI_DLL_LINKAGE _NETIOAPI_SUCCESS_
    NETIOAPI_API GetIpNetworkConnectionBandwidthEstimates(
        _In_ NET_IFINDEX InterfaceIndex, _In_ ADDRESS_FAMILY AddressFamily,
        _Out_ PMIB_IP_NETWORK_CONNECTION_BANDWIDTH_ESTIMATES
            BandwidthEstimates);
/*++
...
typedef VOID(NETIOAPI_API_ *PUNICAST_IPADDRESS_CHANGE_CALLBACK)(
    _In_ PVOID CallerContext, _In_opt_ PMIB_UNICASTIPADDRESS_ROW Row,
    _In_ MIB_NOTIFICATION_TYPE NotificationType);
...
_IRQL_requires_max_(PASSIVE_LEVEL)
    IPHLPAPI_DLL_LINKAGE _NETIOAPI_SUCCESS_ NETIOAPI_API
    CreateUnicastIpAddressEntry(_In_ CONST MIB_UNICASTIPADDRESS_ROW *Row);
/*++
...
_IRQL_requires_max_(PASSIVE_LEVEL)
    IPHLPAPI_DLL_LINKAGE _NETIOAPI_SUCCESS_ NETIOAPI_API
    DeleteUnicastIpAddressEntry(_In_ CONST MIB_UNICASTIPADDRESS_ROW *Row);
/*++
...
_IRQL_requires_max_(PASSIVE_LEVEL)
    IPHLPAPI_DLL_LINKAGE _NETIOAPI_SUCCESS_ NETIOAPI_API
    GetUnicastIpAddressEntry(_Inout_ PMIB_UNICASTIPADDRESS_ROW Row);
/*++
...
_IRQL_requires_max_(PASSIVE_LEVEL)
    IPHLPAPI_DLL_LINKAGE _NETIOAPI_SUCCESS_ NETIOAPI_API
    GetUnicastIpAddressTable(_In_ ADDRESS_FAMILY Family,
...
_IRQL_requires_max_(PASSIVE_LEVEL) IPHLPAPI_DLL_LINKAGE VOID NETIOAPI_API_
    InitializeUnicastIpAddressEntry(_Out_ PMIB_UNICASTIPADDRESS_ROW Row);
/*++
...
_IRQL_requires_max_(PASSIVE_LEVEL) IPHLPAPI_DLL_LINKAGE _NETIOAPI_SUCCESS_
    NETIOAPI_API NotifyUnicastIpAddressChange(
        ...
        _In_opt_ PVOID CallerContext, _In_ BOOLEAN InitialNotification,
        _Inout_ HANDLE *NotificationHandle);
/*++
...
typedef VOID(NETIOAPI_API_ *PSTABLE_UNICAST_IPADDRESS_TABLE_CALLBACK)(
    _In_ PVOID CallerContext, _In_ PMIB_UNICASTIPADDRESS_TABLE AddressTable);

_IRQL_requires_max_(PASSIVE_LEVEL) IPHLPAPI_DLL_LINKAGE _NETIOAPI_SUCCESS_
    NETIOAPI_API NotifyStableUnicastIpAddressTable(
        _In_ ADDRESS_FAMILY Family, _Outptr_ PMIB_UNICASTIPADDRESS_TABLE *Table,
        _In_ PSTABLE_UNICAST_IPADDRESS_TABLE_CALLBACK CallerCallback,
        _In_ PVOID CallerContext, _Inout_ HANDLE *NotificationHandle);
...
_IRQL_requires_max_(PASSIVE_LEVEL)
    IPHLPAPI_DLL_LINKAGE _NETIOAPI_SUCCESS_ NETIOAPI_API
    SetUnicastIpAddressEntry(_In_ CONST MIB_UNICASTIPADDRESS_ROW *Row);
/*++
...
_IRQL_requires_max_(PASSIVE_LEVEL)
    IPHLPAPI_DLL_LINKAGE _NETIOAPI_SUCCESS_ NETIOAPI_API
    CreateAnycastIpAddressEntry(_In_ CONST MIB_ANYCASTIPADDRESS_ROW *Row);
/*++
...
_IRQL_requires_max_(PASSIVE_LEVEL)
    IPHLPAPI_DLL_LINKAGE _NETIOAPI_SUCCESS_ NETIOAPI_API
    DeleteAnycastIpAddressEntry(_In_ CONST MIB_ANYCASTIPADDRESS_ROW *Row);
/*++
...
_IRQL_requires_max_(PASSIVE_LEVEL)
    IPHLPAPI_DLL_LINKAGE _NETIOAPI_SUCCESS_ NETIOAPI_API
    GetAnycastIpAddressEntry(_Inout_ PMIB_ANYCASTIPADDRESS_ROW Row);
/*++
...
_IRQL_requires_max_(PASSIVE_LEVEL)
    IPHLPAPI_DLL_LINKAGE _NETIOAPI_SUCCESS_ NETIOAPI_API
    GetAnycastIpAddressTable(_In_ ADDRESS_FAMILY Family,
...
_IRQL_requires_max_(PASSIVE_LEVEL)
    IPHLPAPI_DLL_LINKAGE _NETIOAPI_SUCCESS_ NETIOAPI_API
    GetMulticastIpAddressEntry(_Inout_ PMIB_MULTICASTIPADDRESS_ROW Row);
/*++
...
_IRQL_requires_max_(PASSIVE_LEVEL)
    IPHLPAPI_DLL_LINKAGE _NETIOAPI_SUCCESS_ NETIOAPI_API
    GetMulticastIpAddressTable(_In_ ADDRESS_FAMILY Family,
...
typedef VOID(NETIOAPI_API_ *PIPFORWARD_CHANGE_CALLBACK)(
    _In_ PVOID CallerContext, _In_opt_ PMIB_IPFORWARD_ROW2 Row,
    _In_ MIB_NOTIFICATION_TYPE NotificationType);

_IRQL_requires_max_(PASSIVE_LEVEL) IPHLPAPI_DLL_LINKAGE _NETIOAPI_SUCCESS_
    NETIOAPI_API CreateIpForwardEntry2(_In_ CONST MIB_IPFORWARD_ROW2 *Row);
/*++
...
_IRQL_requires_max_(PASSIVE_LEVEL) IPHLPAPI_DLL_LINKAGE _NETIOAPI_SUCCESS_
    NETIOAPI_API DeleteIpForwardEntry2(_In_ CONST MIB_IPFORWARD_ROW2 *Row);
/*++
...
_IRQL_requires_max_(PASSIVE_LEVEL) IPHLPAPI_DLL_LINKAGE _NETIOAPI_SUCCESS_
    NETIOAPI_API GetBestRoute2(_In_opt_ NET_LUID *InterfaceLuid,
...
_IRQL_requires_max_(PASSIVE_LEVEL) IPHLPAPI_DLL_LINKAGE _NETIOAPI_SUCCESS_
    NETIOAPI_API GetIpForwardTable2(_In_ ADDRESS_FAMILY Family,
...
_IRQL_requires_max_(PASSIVE_LEVEL) IPHLPAPI_DLL_LINKAGE VOID NETIOAPI_API_
    InitializeIpForwardEntry(_Out_ PMIB_IPFORWARD_ROW2 Row);
/*++
...
_IRQL_requires_max_(PASSIVE_LEVEL) IPHLPAPI_DLL_LINKAGE _NETIOAPI_SUCCESS_
    NETIOAPI_API NotifyRouteChange2(_In_ ADDRESS_FAMILY AddressFamily,
...
_IRQL_requires_max_(PASSIVE_LEVEL) IPHLPAPI_DLL_LINKAGE _NETIOAPI_SUCCESS_
    NETIOAPI_API SetIpForwardEntry2(_In_ CONST MIB_IPFORWARD_ROW2 *Route);
/*++
...
_IRQL_requires_max_(PASSIVE_LEVEL) IPHLPAPI_DLL_LINKAGE _NETIOAPI_SUCCESS_
    NETIOAPI_API FlushIpPathTable(_In_ ADDRESS_FAMILY Family);
/*++
...
_IRQL_requires_max_(PASSIVE_LEVEL) IPHLPAPI_DLL_LINKAGE _NETIOAPI_SUCCESS_
    NETIOAPI_API GetIpPathTable(_In_ ADDRESS_FAMILY Family,
...
_IRQL_requires_max_(PASSIVE_LEVEL) IPHLPAPI_DLL_LINKAGE _NETIOAPI_SUCCESS_
    NETIOAPI_API CreateIpNetEntry2(_In_ CONST MIB_IPNET_ROW2 *Row);
/*++
...
_IRQL_requires_max_(PASSIVE_LEVEL) IPHLPAPI_DLL_LINKAGE _NETIOAPI_SUCCESS_
    NETIOAPI_API DeleteIpNetEntry2(_In_ CONST MIB_IPNET_ROW2 *Row);
/*++
...
_IRQL_requires_max_(PASSIVE_LEVEL) IPHLPAPI_DLL_LINKAGE _NETIOAPI_SUCCESS_
    NETIOAPI_API FlushIpNetTable2(_In_ ADDRESS_FAMILY Family,
                                  _In_ NET_IFINDEX InterfaceIndex);
/*++
...
_IRQL_requires_max_(PASSIVE_LEVEL) IPHLPAPI_DLL_LINKAGE _NETIOAPI_SUCCESS_
    NETIOAPI_API GetIpNetEntry2(_Inout_ PMIB_IPNET_ROW2 Row);
/*++
...
_IRQL_requires_max_(PASSIVE_LEVEL) IPHLPAPI_DLL_LINKAGE _NETIOAPI_SUCCESS_
    NETIOAPI_API GetIpNetTable2(_In_ ADDRESS_FAMILY Family,
...
_IRQL_requires_max_(PASSIVE_LEVEL)
    IPHLPAPI_DLL_LINKAGE _NETIOAPI_SUCCESS_ NETIOAPI_API
    ResolveIpNetEntry2(_Inout_ PMIB_IPNET_ROW2 Row,
                       _In_opt_ CONST SOCKADDR_INET *SourceAddress);
/*++
...
typedef VOID(NETIOAPI_API_ *PTEREDO_PORT_CHANGE_CALLBACK)(
    _In_ PVOID CallerContext, _In_ USHORT Port,
    _Inout_ MIB_NOTIFICATION_TYPE NotificationType);

_IRQL_requires_max_(PASSIVE_LEVEL)
    IPHLPAPI_DLL_LINKAGE _NETIOAPI_SUCCESS_ NETIOAPI_API
    NotifyTeredoPortChange(_In_ PTEREDO_PORT_CHANGE_CALLBACK Callback,
                           _In_ PVOID CallerContext,
                           _In_ BOOLEAN InitialNotification,
                           _Inout_ HANDLE *NotificationHandle);

_IRQL_requires_max_(PASSIVE_LEVEL) IPHLPAPI_DLL_LINKAGE _NETIOAPI_SUCCESS_
    NETIOAPI_API GetTeredoPort(_Out_ USHORT *Port);
/*++
...
_IRQL_requires_max_(PASSIVE_LEVEL) IPHLPAPI_DLL_LINKAGE NETIOAPI_API
...
_IRQL_requires_max_(PASSIVE_LEVEL)
    IPHLPAPI_DLL_LINKAGE _NETIOAPI_SUCCESS_ NETIOAPI_API
    CreateSortedAddressPairs(_In_opt_ const PSOCKADDR_IN6 SourceAddressList,
...
_IRQL_requires_max_(PASSIVE_LEVEL)
    IPHLPAPI_DLL_LINKAGE _NETIOAPI_SUCCESS_ NETIOAPI_API
    ConvertCompartmentGuidToId(_In_ CONST GUID *CompartmentGuid,
...
_IRQL_requires_max_(PASSIVE_LEVEL)
    IPHLPAPI_DLL_LINKAGE _NETIOAPI_SUCCESS_ NETIOAPI_API
    ConvertCompartmentIdToGuid(_In_ NET_IF_COMPARTMENT_ID CompartmentId,
...
_IRQL_requires_max_(PASSIVE_LEVEL) IPHLPAPI_DLL_LINKAGE _NETIOAPI_SUCCESS_
    NETIOAPI_API ConvertInterfaceNameToLuidA(_In_z_ CONST CHAR *InterfaceName,
...
_IRQL_requires_max_(PASSIVE_LEVEL) IPHLPAPI_DLL_LINKAGE _NETIOAPI_SUCCESS_
    NETIOAPI_API ConvertInterfaceNameToLuidW(_In_z_ CONST WCHAR *InterfaceName,
                                             _Out_ NET_LUID *InterfaceLuid);
/*++
...
_IRQL_requires_max_(PASSIVE_LEVEL)
    IPHLPAPI_DLL_LINKAGE _NETIOAPI_SUCCESS_ NETIOAPI_API
    ConvertInterfaceLuidToNameA(_In_ CONST NET_LUID *InterfaceLuid,
...
_IRQL_requires_max_(PASSIVE_LEVEL)
    IPHLPAPI_DLL_LINKAGE _NETIOAPI_SUCCESS_ NETIOAPI_API
    ConvertInterfaceLuidToNameW(_In_ CONST NET_LUID *InterfaceLuid,
...
_IRQL_requires_max_(PASSIVE_LEVEL) IPHLPAPI_DLL_LINKAGE _NETIOAPI_SUCCESS_
    NETIOAPI_API ConvertInterfaceLuidToIndex(_In_ CONST NET_LUID *InterfaceLuid,
...
_IRQL_requires_max_(PASSIVE_LEVEL) IPHLPAPI_DLL_LINKAGE _NETIOAPI_SUCCESS_
    NETIOAPI_API ConvertInterfaceIndexToLuid(_In_ NET_IFINDEX InterfaceIndex,
...
_IRQL_requires_max_(PASSIVE_LEVEL)
    IPHLPAPI_DLL_LINKAGE _NETIOAPI_SUCCESS_ NETIOAPI_API
    ConvertInterfaceLuidToAlias(_In_ CONST NET_LUID *InterfaceLuid,
...
_IRQL_requires_max_(PASSIVE_LEVEL) IPHLPAPI_DLL_LINKAGE _NETIOAPI_SUCCESS_
    NETIOAPI_API ConvertInterfaceAliasToLuid(_In_z_ CONST WCHAR *InterfaceAlias,
                                             _Out_ PNET_LUID InterfaceLuid);
/*++
...
_IRQL_requires_max_(PASSIVE_LEVEL) IPHLPAPI_DLL_LINKAGE _NETIOAPI_SUCCESS_
    NETIOAPI_API ConvertInterfaceLuidToGuid(_In_ CONST NET_LUID *InterfaceLuid,
...
_IRQL_requires_max_(PASSIVE_LEVEL) IPHLPAPI_DLL_LINKAGE _NETIOAPI_SUCCESS_
    NETIOAPI_API ConvertInterfaceGuidToLuid(_In_ CONST GUID *InterfaceGuid,
                                            _Out_ PNET_LUID InterfaceLuid);
/*++
...
_IRQL_requires_max_(PASSIVE_LEVEL) IPHLPAPI_DLL_LINKAGE NET_IFINDEX
    NETIOAPI_API_ if_nametoindex(_In_ PCSTR InterfaceName);
/*++
...
_IRQL_requires_max_(PASSIVE_LEVEL) IPHLPAPI_DLL_LINKAGE PCHAR NETIOAPI_API_
    if_indextoname(_In_ NET_IFINDEX InterfaceIndex,
...
_IRQL_requires_max_(PASSIVE_LEVEL) IPHLPAPI_DLL_LINKAGE NET_IF_COMPARTMENT_ID
    NETIOAPI_API_ GetCurrentThreadCompartmentId(VOID);
/*++
...
_IRQL_requires_max_(PASSIVE_LEVEL)
    IPHLPAPI_DLL_LINKAGE _NETIOAPI_SUCCESS_ NETIOAPI_API
    SetCurrentThreadCompartmentId(_In_ NET_IF_COMPARTMENT_ID CompartmentId);
/*++
...
_IRQL_requires_max_(PASSIVE_LEVEL) IPHLPAPI_DLL_LINKAGE _NETIOAPI_SUCCESS_
    NETIOAPI_API SetCurrentThreadCompartmentScope(
...
_IRQL_requires_max_(PASSIVE_LEVEL) IPHLPAPI_DLL_LINKAGE NET_IF_COMPARTMENT_ID
    NETIOAPI_API_ GetJobCompartmentId(_In_ HANDLE JobHandle);
/*++
...
_IRQL_requires_max_(PASSIVE_LEVEL) IPHLPAPI_DLL_LINKAGE _NETIOAPI_SUCCESS_
    NETIOAPI_API SetJobCompartmentId(_In_ HANDLE JobHandle,
...
_IRQL_requires_max_(PASSIVE_LEVEL) IPHLPAPI_DLL_LINKAGE NET_IF_COMPARTMENT_ID
    NETIOAPI_API_ GetSessionCompartmentId(_In_ ULONG SessionId);
/*++
...
_IRQL_requires_max_(PASSIVE_LEVEL)
    IPHLPAPI_DLL_LINKAGE _NETIOAPI_SUCCESS_ NETIOAPI_API
    SetSessionCompartmentId(_In_ ULONG SessionId,
                            _In_ NET_IF_COMPARTMENT_ID CompartmentId);
/*++
...
_IRQL_requires_max_(PASSIVE_LEVEL) IPHLPAPI_DLL_LINKAGE NET_IF_COMPARTMENT_ID
    NETIOAPI_API_ GetDefaultCompartmentId(VOID);
/*++
...
_IRQL_requires_max_(PASSIVE_LEVEL)
    IPHLPAPI_DLL_LINKAGE _NETIOAPI_SUCCESS_ NETIOAPI_API
    GetNetworkInformation(_In_ CONST NET_IF_NETWORK_GUID *NetworkGuid,
                          _Out_ PNET_IF_COMPARTMENT_ID CompartmentId,
                          _Out_ PULONG SiteId,
...
_IRQL_requires_max_(PASSIVE_LEVEL)
    IPHLPAPI_DLL_LINKAGE _NETIOAPI_SUCCESS_ NETIOAPI_API
    SetNetworkInformation(_In_ CONST NET_IF_NETWORK_GUID *NetworkGuid,
                          _In_ NET_IF_COMPARTMENT_ID CompartmentId,
...
IPHLPAPI_DLL_LINKAGE
NETIOAPI_API
ConvertLengthToIpv4Mask(_In_ ULONG MaskLength, _Out_ PULONG Mask);
/*++
...
IPHLPAPI_DLL_LINKAGE
NETIOAPI_API
ConvertIpv4MaskToLength(_In_ ULONG Mask, _Out_ PUINT8 MaskLength);
/*++
...
#ifdef MIDL_PASS
typedef[switch_type(
    DNS_SERVER_PROPERTY_TYPE)] union _DNS_SERVER_PROPERTY_TYPES {
...
NETIOAPI_API
GetDnsSettings(_Inout_ DNS_SETTINGS *Settings);
/*++
...
VOID NETIOAPI_API_ FreeDnsSettings(_Inout_ DNS_SETTINGS *Settings);
/*++
...
NETIOAPI_API
SetDnsSettings(_In_ const DNS_SETTINGS *Settings);
/*++
...
NETIOAPI_API
GetInterfaceDnsSettings(_In_ GUID Interface,
...
VOID NETIOAPI_API_
FreeInterfaceDnsSettings(_Inout_ DNS_INTERFACE_SETTINGS *Settings);
/*++
...
NETIOAPI_API
SetInterfaceDnsSettings(_In_ GUID Interface,
...
_IRQL_requires_max_(PASSIVE_LEVEL) IPHLPAPI_DLL_LINKAGE _NETIOAPI_SUCCESS_
    NETIOAPI_API GetNetworkConnectivityHint(
...
_IRQL_requires_max_(PASSIVE_LEVEL) IPHLPAPI_DLL_LINKAGE _NETIOAPI_SUCCESS_
    NETIOAPI_API GetNetworkConnectivityHintForInterface(
        _In_ NET_IFINDEX InterfaceIndex,
        _Out_ NL_NETWORK_CONNECTIVITY_HINT *ConnectivityHint);
/*++
...
_IRQL_requires_max_(PASSIVE_LEVEL) IPHLPAPI_DLL_LINKAGE _NETIOAPI_SUCCESS_
    NETIOAPI_API NotifyNetworkConnectivityHintChange(
...
_IRQL_requires_max_(PASSIVE_LEVEL)
    IPHLPAPI_DLL_LINKAGE _NETIOAPI_SUCCESS_ NETIOAPI_API
    CreateFlVirtualInterface(_In_ CONST MIB_FL_VIRTUAL_INTERFACE_ROW *Row);
/*++
...
_IRQL_requires_max_(PASSIVE_LEVEL)
    IPHLPAPI_DLL_LINKAGE _NETIOAPI_SUCCESS_ NETIOAPI_API
    DeleteFlVirtualInterface(_In_ CONST MIB_FL_VIRTUAL_INTERFACE_ROW *Row);
/*++
...
_IRQL_requires_max_(PASSIVE_LEVEL) IPHLPAPI_DLL_LINKAGE VOID
    InitializeFlVirtualInterfaceEntry(_Out_ PMIB_FL_VIRTUAL_INTERFACE_ROW Row);
/*++
...
_IRQL_requires_max_(PASSIVE_LEVEL)
    IPHLPAPI_DLL_LINKAGE _NETIOAPI_SUCCESS_ NETIOAPI_API
    SetFlVirtualInterface(_In_ CONST MIB_FL_VIRTUAL_INTERFACE_ROW *Row);
/*++
...
_IRQL_requires_max_(PASSIVE_LEVEL)
    IPHLPAPI_DLL_LINKAGE _NETIOAPI_SUCCESS_ NETIOAPI_API
    GetFlVirtualInterface(_Inout_ PMIB_FL_VIRTUAL_INTERFACE_ROW Row);
/*++
...
_IRQL_requires_max_(PASSIVE_LEVEL)
    IPHLPAPI_DLL_LINKAGE _NETIOAPI_SUCCESS_ NETIOAPI_API
    GetFlVirtualInterfaceTable(_In_ ADDRESS_FAMILY Family,
...
Arguments:
    ...
    Table - Returns the table of FL virtual interfaces in a
        PMIB_FL_VIRTUAL_INTERFACE_TABLE structure.  Use FreeMibTable to free
this buffer.
