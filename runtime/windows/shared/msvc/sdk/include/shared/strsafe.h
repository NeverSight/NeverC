...
#pragma warning(                                                               \
    disable                                                                    \
    : 28210) // Because not all PREFast versions like _Always_ equally.
...
// The user may override STRSAFE_MAX_CCH, but it must always be less than
// INT_MAX
...
#define STRSAFE_MAX_LENGTH                                                     \
  (STRSAFE_MAX_CCH - 1) // max buffer length, in characters, that we support

// Flags for controling the Ex functions
//
//      STRSAFE_FILL_BYTE(0xFF)                         0x000000FF  // bottom
//      byte specifies fill pattern
#define STRSAFE_IGNORE_NULLS                                                   \
  0x00000100 // treat null string pointers as TEXT("") -- don't fault on NULL
             // buffers
#define STRSAFE_FILL_BEHIND_NULL                                               \
  0x00000200 // on success, fill in extra space behind the null terminator with
             // fill pattern
...
#define STRSAFE_FILL_BYTE(x)                                                   \
  ((DWORD)((x & 0x000000FF) | STRSAFE_FILL_BEHIND_NULL))
#define STRSAFE_FAILURE_BYTE(x)                                                \
  ((DWORD)((x & 0x000000FF) | STRSAFE_FILL_ON_FAILURE))
...
// Deprecated, use the non STRSAFE_ prefixed types instead (e.g. LPSTR or PSTR)
// as they are the same as these.
...
// Strings where the string is NOT guaranteed to be null terminated (does not
// have _Null_terminated_).
...
STRSAFEWORKERAPI
StringLengthWorkerA(_In_reads_or_z_(cchMax) STRSAFE_PCNZCH psz,
...
STRSAFEWORKERAPI
StringLengthWorkerW(_In_reads_or_z_(cchMax) STRSAFE_PCNZWCH psz,
                    _In_ _In_range_(<=, STRSAFE_MAX_CCH) size_t cchMax,
                    _Out_opt_ _Deref_out_range_(<, cchMax)
                        _Deref_out_range_(<=, _String_length_(psz))
                            size_t *pcchLength);
...
STRSAFEWORKERAPI
UnalignedStringLengthWorkerW(_In_reads_or_z_(cchMax) STRSAFE_PCUNZWCH psz,
                             _In_ _In_range_(<=, STRSAFE_MAX_CCH) size_t cchMax,
                             _Out_opt_ _Deref_out_range_(<, cchMax)
                                 size_t *pcchLength);
...
_When_(_Old_(*ppszSrc) != NULL, _Unchanged_(*ppszSrc))
    _When_(_Old_(*ppszSrc) == NULL, _At_(*ppszSrc, _Post_z_)) STRSAFEWORKERAPI
    StringExValidateSrcA(_Inout_ _Deref_post_notnull_ STRSAFE_PCNZCH *ppszSrc,
                         _Inout_opt_ _Deref_out_range_(<, cchMax)
                             _Deref_out_range_(<=, _Old_(*pcchToRead))
                                 size_t *pcchToRead,
                         _In_ const size_t cchMax, _In_ DWORD dwFlags);

_When_(_Old_(*ppszSrc) != NULL, _Unchanged_(*ppszSrc))
    _When_(_Old_(*ppszSrc) == NULL, _At_(*ppszSrc, _Post_z_)) STRSAFEWORKERAPI
    StringExValidateSrcW(_Inout_ _Deref_post_notnull_ STRSAFE_PCNZWCH *ppszSrc,
                         _Inout_opt_ _Deref_out_range_(<, cchMax)
                             _Deref_out_range_(<=, _Old_(*pcchToRead))
                                 size_t *pcchToRead,
                         _In_ const size_t cchMax, _In_ DWORD dwFlags);

_Post_satisfies_(cchDest > 0 && cchDest <= cchMax) STRSAFEWORKERAPI
    StringValidateDestA(_In_reads_opt_(cchDest) STRSAFE_PCNZCH pszDest,
                        _In_ size_t cchDest, _In_ const size_t cchMax);

_Post_satisfies_(cchDest > 0 && cchDest <= cchMax) STRSAFEWORKERAPI
    StringValidateDestAndLengthA(_In_reads_opt_(cchDest) STRSAFE_LPCSTR pszDest,
                                 _In_ size_t cchDest,
                                 _Out_ _Deref_out_range_(0, cchDest - 1)
                                     size_t *pcchDestLength,
                                 _In_ const size_t cchMax);

_Post_satisfies_(cchDest > 0 && cchDest <= cchMax) STRSAFEWORKERAPI
    StringValidateDestW(_In_reads_opt_(cchDest) STRSAFE_PCNZWCH pszDest,
                        _In_ size_t cchDest, _In_ const size_t cchMax);

_Post_satisfies_(cchDest > 0 && cchDest <= cchMax) STRSAFEWORKERAPI
    StringValidateDestAndLengthW(_In_reads_opt_(cchDest)
...
STRSAFEWORKERAPI
StringExValidateDestA(_In_reads_opt_(cchDest) STRSAFE_PCNZCH pszDest,
                      _In_ size_t cchDest, _In_ const size_t cchMax,
                      _In_ DWORD dwFlags);

STRSAFEWORKERAPI
StringExValidateDestAndLengthA(
    _In_reads_opt_(cchDest) STRSAFE_LPCSTR pszDest, _In_ size_t cchDest,
    _Out_ _Deref_out_range_(0, (cchDest > 0 ? cchDest - 1 : 0))
        size_t *pcchDestLength,
    _In_ const size_t cchMax, _In_ DWORD dwFlags);

STRSAFEWORKERAPI
StringExValidateDestW(_In_reads_opt_(cchDest) STRSAFE_PCNZWCH pszDest,
                      _In_ size_t cchDest, _In_ const size_t cchMax,
                      _In_ DWORD dwFlags);

STRSAFEWORKERAPI
StringExValidateDestAndLengthW(
    _In_reads_opt_(cchDest) STRSAFE_LPCWSTR pszDest, _In_ size_t cchDest,
    _Out_ _Deref_out_range_(0, (cchDest > 0 ? cchDest - 1 : 0))
        size_t *pcchDestLength,
    _In_ const size_t cchMax, _In_ DWORD dwFlags);

STRSAFEWORKERAPI
StringCopyWorkerA(_Out_writes_(cchDest) _Always_(_Post_z_)
                      STRSAFE_LPSTR pszDest,
                  _In_ _In_range_(1, STRSAFE_MAX_CCH) size_t cchDest,
                  _Always_(_Out_opt_ _Deref_out_range_(<=, (cchToCopy < cchDest)
                                                               ? cchToCopy
                                                               : (cchDest - 1)))
...
STRSAFEWORKERAPI
StringCopyWorkerW(_Out_writes_(cchDest) _Always_(_Post_z_)
...
STRSAFEWORKERAPI
StringVPrintfWorkerA(_Out_writes_(cchDest) _Always_(_Post_z_)
                         STRSAFE_LPSTR pszDest,
                     _In_ _In_range_(1, STRSAFE_MAX_CCH) size_t cchDest,
...
StringVPrintf_lWorkerA(_Out_writes_(cchDest) STRSAFE_LPSTR pszDest,
                       _In_ _In_range_(1, STRSAFE_MAX_CCH) size_t cchDest,
                       _Out_opt_ _Deref_out_range_(<=, cchDest - 1)
                           size_t *pcchNewDestLength,
                       _In_ _Printf_format_string_params_(2)
                           STRSAFE_LPCSTR pszFormat,
                       _In_ _locale_t locale, _In_ va_list argList);
#endif // STRSAFE_LOCALE_FUNCTIONS

STRSAFEWORKERAPI
StringVPrintfWorkerW(_Out_writes_(cchDest) _Always_(_Post_z_)
                         STRSAFE_LPWSTR pszDest,
                     _In_ _In_range_(1, STRSAFE_MAX_CCH) size_t cchDest,
                     _Always_(_Out_opt_ _Deref_out_range_(<=, cchDest - 1))
                         size_t *pcchNewDestLength,
...
#ifdef STRSAFE_LOCALE_FUNCTIONS
STRSAFELOCALEWORKERAPI
StringVPrintf_lWorkerW(_Out_writes_(cchDest) STRSAFE_LPWSTR pszDest,
                       _In_ _In_range_(1, STRSAFE_MAX_CCH) size_t cchDest,
                       _Out_opt_ _Deref_out_range_(<=, cchDest - 1)
                           size_t *pcchNewDestLength,
                       _In_ _Printf_format_string_params_(2)
...
STRSAFEAPI
StringGetsWorkerA(_Out_writes_(cchDest) _Always_(_Post_z_)
                      STRSAFE_LPSTR pszDest,
                  _In_ _In_range_(1, STRSAFE_MAX_CCH) size_t cchDest,
                  _Always_(_Out_opt_ _Deref_out_range_(<, cchDest > 0 ? cchDest
                                                                      : 1))
                      size_t *pcchNewDestLength);

STRSAFEAPI
StringGetsWorkerW(_Out_writes_(cchDest) _Always_(_Post_z_)
                      STRSAFE_LPWSTR pszDest,
                  _In_ _In_range_(1, STRSAFE_MAX_CCH) size_t cchDest,
                  _Always_(_Out_opt_ _Deref_out_range_(<=, cchDest - 1))
                      size_t *pcchNewDestLength);
...
STRSAFEWORKERAPI
StringExHandleFillBehindNullA(_Inout_updates_bytes_(cbRemaining)
                                  STRSAFE_LPSTR pszDestEnd,
                              _In_ size_t cbRemaining, _In_ DWORD dwFlags);

STRSAFEWORKERAPI
StringExHandleFillBehindNullW(_Inout_updates_bytes_(cbRemaining)
                                  STRSAFE_LPWSTR pszDestEnd,
                              _In_ size_t cbRemaining, _In_ DWORD dwFlags);

_Success_(1) // always succeeds, no exit tests needed
    STRSAFEWORKERAPI StringExHandleOtherFlagsA(
        _Out_writes_bytes_(cbDest) STRSAFE_LPSTR pszDest,
        _In_ _In_range_(1, STRSAFE_MAX_CCH * sizeof(char)) size_t cbDest,
        _In_ _In_range_(0,
                        cbDest > sizeof(char) ? (cbDest / sizeof(char)) - 1 : 0)
...
_Success_(1) // always succeeds, no exit tests needed
    STRSAFEWORKERAPI StringExHandleOtherFlagsW(
        _Out_writes_bytes_(cbDest) STRSAFE_LPWSTR pszDest,
        _In_ _In_range_(1, STRSAFE_MAX_CCH * sizeof(wchar_t)) size_t cbDest,
        _In_ _In_range_(0, cbDest > sizeof(wchar_t)
                               ? (cbDest / sizeof(wchar_t)) - 1
                               : 0) size_t cchOriginalDestLength,
        _Outptr_result_buffer_(*pcchRemaining) STRSAFE_LPWSTR *ppszDestEnd,
        _Out_ _Deref_out_range_(0, cbDest / sizeof(wchar_t))
...
#pragma warning(                                                               \
    disable                                                                    \
    : 4616) // turn off warning out of range so prefast pragmas won't show
...
STRSAFEAPI
StringCchCopyA(_Out_writes_(cchDest) _Always_(_Post_z_) STRSAFE_LPSTR pszDest,
               _In_ size_t cchDest, _In_ STRSAFE_LPCSTR pszSrc) {
  HRESULT hr;

  hr = StringValidateDestA(pszDest, cchDest, STRSAFE_MAX_CCH);

  if (SUCCEEDED(hr)) {
    hr = StringCopyWorkerA(pszDest, cchDest, NULL, pszSrc, STRSAFE_MAX_LENGTH);
  } else if (cchDest > 0) {
    *pszDest = '\0';
  }
...
STRSAFEAPI
StringCchCopyW(_Out_writes_(cchDest) _Always_(_Post_z_) STRSAFE_LPWSTR pszDest,
               _In_ size_t cchDest, _In_ STRSAFE_LPCWSTR pszSrc) {
  HRESULT hr;

  hr = StringValidateDestW(pszDest, cchDest, STRSAFE_MAX_CCH);

  if (SUCCEEDED(hr)) {
    hr = StringCopyWorkerW(pszDest, cchDest, NULL, pszSrc, STRSAFE_MAX_LENGTH);
  } else if (cchDest > 0) {
    *pszDest = L'\0';
  }
...
STRSAFEAPI
StringCbCopyA(_Out_writes_bytes_(cbDest) _Always_(_Post_z_)
                  STRSAFE_LPSTR pszDest,
              _In_ size_t cbDest, _In_ STRSAFE_LPCSTR pszSrc) {
  HRESULT hr;
...
STRSAFEAPI
StringCbCopyW(_Out_writes_bytes_(cbDest) _Always_(_Post_z_)
                  STRSAFE_LPWSTR pszDest,
              _In_ size_t cbDest, _In_ STRSAFE_LPCWSTR pszSrc) {
  HRESULT hr;
...
STRSAFEAPI
StringCchCopyExA(_Out_writes_(cchDest) _Always_(_Post_z_) STRSAFE_LPSTR pszDest,
                 _In_ size_t cchDest, _In_ STRSAFE_LPCSTR pszSrc,
                 _Outptr_opt_result_buffer_(*pcchRemaining)
                     STRSAFE_LPSTR *ppszDestEnd,
                 _Out_opt_ size_t *pcchRemaining, _In_ DWORD dwFlags) {
  HRESULT hr;
  ...
  if (SUCCEEDED(hr)) {
    ...
    if (SUCCEEDED(hr)) {
      if (dwFlags & (~STRSAFE_VALID_FLAGS)) {
        ...
        hr = StringCopyWorkerA(pszDest, cchDest, &cchCopied, pszSrc,
                               STRSAFE_MAX_LENGTH);
    ...
    if (FAILED(hr) &&
        (dwFlags & (STRSAFE_NO_TRUNCATION | STRSAFE_FILL_ON_FAILURE |
                    STRSAFE_NULL_ON_FAILURE)) &&
        (cchDest != 0)) {
      size_t cbDest;
      ...
      // handle the STRSAFE_FILL_ON_FAILURE, STRSAFE_NULL_ON_FAILURE, and
      // STRSAFE_NO_TRUNCATION flags
      StringExHandleOtherFlagsA(pszDest, cbDest, 0, &pszDestEnd, &cchRemaining,
                                dwFlags);
    }
...
STRSAFEAPI
StringCchCopyExW(_Out_writes_(cchDest) _Always_(_Post_z_)
                     STRSAFE_LPWSTR pszDest,
                 _In_ size_t cchDest, _In_ STRSAFE_LPCWSTR pszSrc,
                 _Outptr_opt_result_buffer_(*pcchRemaining)
  ...
  if (SUCCEEDED(hr)) {
    ...
    if (SUCCEEDED(hr)) {
      if (dwFlags & (~STRSAFE_VALID_FLAGS)) {
        ...
        hr = StringCopyWorkerW(pszDest, cchDest, &cchCopied, pszSrc,
                               STRSAFE_MAX_LENGTH);
    ...
    if (FAILED(hr) &&
      ...
      // handle the STRSAFE_FILL_ON_FAILURE, STRSAFE_NULL_ON_FAILURE, and
      // STRSAFE_NO_TRUNCATION flags
      StringExHandleOtherFlagsW(pszDest, cbDest, 0, &pszDestEnd, &cchRemaining,
                                dwFlags);
    }
...
/*++
  ...
  STDAPI
  StringCbCopyEx(
  _Out_writes_bytes_(cbDest) _Always_(_Post_z_) LPTSTR  pszDest OPTIONAL, _In_
size_t  cbDest, _In_  LPCTSTR pszSrc          OPTIONAL,
...
STRSAFEAPI
StringCbCopyExA(_Out_writes_bytes_(cbDest) _Always_(_Post_z_)
                    STRSAFE_LPSTR pszDest,
                _In_ size_t cbDest, _In_ STRSAFE_LPCSTR pszSrc,
                _Outptr_opt_result_bytebuffer_(*pcbRemaining)
                    STRSAFE_LPSTR *ppszDestEnd,
                _Out_opt_ size_t *pcbRemaining, _In_ DWORD dwFlags) {
  HRESULT hr;
  size_t cchDest = cbDest / sizeof(char);
...
STRSAFEAPI
StringCbCopyExW(_Out_writes_bytes_(cbDest) _Always_(_Post_z_)
                    STRSAFE_LPWSTR pszDest,
                _In_ size_t cbDest, _In_ STRSAFE_LPCWSTR pszSrc,
                _Outptr_opt_result_bytebuffer_(*pcbRemaining)
                    STRSAFE_LPWSTR *ppszDestEnd,
...
STRSAFEAPI
StringCchCopyNA(_Out_writes_(cchDest) _Always_(_Post_z_) STRSAFE_LPSTR pszDest,
                _In_ size_t cchDest,
                _In_reads_or_z_(cchToCopy) STRSAFE_PCNZCH pszSrc,
                _In_ size_t cchToCopy) {
  HRESULT hr;
...
STRSAFEAPI
StringCchCopyNW(_Out_writes_(cchDest) _Always_(_Post_z_) STRSAFE_LPWSTR pszDest,
                _In_ size_t cchDest,
                _In_reads_or_z_(cchToCopy) STRSAFE_PCNZWCH pszSrc,
                _In_ size_t cchToCopy) {
  HRESULT hr;
...
STRSAFEAPI
StringCbCopyNA(_Out_writes_bytes_(cbDest) STRSAFE_LPSTR pszDest,
               _In_ size_t cbDest,
...
STRSAFEAPI
StringCbCopyNW(_Out_writes_bytes_(cbDest) STRSAFE_LPWSTR pszDest,
               _In_ size_t cbDest,
...
STRSAFEAPI
StringCchCopyNExA(_Out_writes_(cchDest) _Always_(_Post_z_)
                      STRSAFE_LPSTR pszDest,
                  _In_ size_t cchDest,
                  _In_reads_or_z_(cchToCopy) STRSAFE_PCNZCH pszSrc,
                  _In_ size_t cchToCopy,
...
STRSAFEAPI
StringCchCopyNExW(_Out_writes_(cchDest) _Always_(_Post_z_)
                      STRSAFE_LPWSTR pszDest,
                  _In_ size_t cchDest,
                  _In_reads_or_z_(cchToCopy) STRSAFE_PCNZWCH pszSrc,
                  _In_ size_t cchToCopy,
...
STRSAFEAPI
StringCbCopyNExA(_Out_writes_bytes_(cbDest) STRSAFE_LPSTR pszDest,
                 _In_ size_t cbDest,
                 _In_reads_bytes_(cbToCopy) STRSAFE_PCNZCH pszSrc,
                 _In_ size_t cbToCopy,
                 _Outptr_opt_result_bytebuffer_(*pcbRemaining)
...
STRSAFEAPI
StringCbCopyNExW(_Out_writes_bytes_(cbDest) STRSAFE_LPWSTR pszDest,
                 _In_ size_t cbDest,
                 _In_reads_bytes_(cbToCopy) STRSAFE_PCNZWCH pszSrc,
                 _In_ size_t cbToCopy,
                 _Outptr_opt_result_bytebuffer_(*pcbRemaining)
...
STRSAFEAPI
StringCchCatA(_Inout_updates_(cchDest) _Always_(_Post_z_) STRSAFE_LPSTR pszDest,
              _In_ size_t cchDest, _In_ STRSAFE_LPCSTR pszSrc) {
  HRESULT hr;
  size_t cchDestLength;

  hr = StringValidateDestAndLengthA(pszDest, cchDest, &cchDestLength,
                                    STRSAFE_MAX_CCH);

  if (SUCCEEDED(hr)) {
    hr = StringCopyWorkerA(pszDest + cchDestLength, cchDest - cchDestLength,
                           NULL, pszSrc, STRSAFE_MAX_LENGTH);
  }
...
STRSAFEAPI
StringCchCatW(_Inout_updates_(cchDest) _Always_(_Post_z_)
                  STRSAFE_LPWSTR pszDest,
              _In_ size_t cchDest, _In_ STRSAFE_LPCWSTR pszSrc) {
  HRESULT hr;
  size_t cchDestLength;

  hr = StringValidateDestAndLengthW(pszDest, cchDest, &cchDestLength,
                                    STRSAFE_MAX_CCH);
...
STRSAFEAPI
StringCbCatA(_Inout_updates_bytes_(cbDest) _Always_(_Post_z_)
                 STRSAFE_LPSTR pszDest,
             _In_ size_t cbDest, _In_ STRSAFE_LPCSTR pszSrc) {
  HRESULT hr;
  size_t cchDestLength;
...
STRSAFEAPI
StringCbCatW(_Inout_updates_bytes_(cbDest) _Always_(_Post_z_)
                 STRSAFE_LPWSTR pszDest,
             _In_ size_t cbDest, _In_ STRSAFE_LPCWSTR pszSrc) {
  HRESULT hr;
  size_t cchDestLength;
...
STRSAFEAPI
StringCchCatExA(_Inout_updates_(cchDest) _Always_(_Post_z_)
                    STRSAFE_LPSTR pszDest,
                _In_ size_t cchDest, _In_ STRSAFE_LPCSTR pszSrc,
                _Outptr_opt_result_buffer_(*pcchRemaining)
                    STRSAFE_LPSTR *ppszDestEnd,
  ...
  hr = StringExValidateDestAndLengthA(pszDest, cchDest, &cchDestLength,
                                      STRSAFE_MAX_CCH, dwFlags);
  ...
  if (SUCCEEDED(hr)) {
    ...
    if (SUCCEEDED(hr)) {
      if (dwFlags & (~STRSAFE_VALID_FLAGS)) {
        ...
        hr = StringCopyWorkerA(pszDestEnd, cchRemaining, &cchCopied, pszSrc,
                               STRSAFE_MAX_LENGTH);
    ...
    if (FAILED(hr) &&
      ...
      // handle the STRSAFE_FILL_ON_FAILURE, STRSAFE_NULL_ON_FAILURE, and
      // STRSAFE_NO_TRUNCATION flags
      StringExHandleOtherFlagsA(pszDest, cbDest, cchDestLength, &pszDestEnd,
...
STRSAFEAPI
StringCchCatExW(_Inout_updates_(cchDest) _Always_(_Post_z_)
                    STRSAFE_LPWSTR pszDest,
                _In_ size_t cchDest, _In_ STRSAFE_LPCWSTR pszSrc,
                _Outptr_opt_result_buffer_(*pcchRemaining)
                    STRSAFE_LPWSTR *ppszDestEnd,
  ...
  hr = StringExValidateDestAndLengthW(pszDest, cchDest, &cchDestLength,
                                      STRSAFE_MAX_CCH, dwFlags);
  ...
  if (SUCCEEDED(hr)) {
    ...
    if (SUCCEEDED(hr)) {
      if (dwFlags & (~STRSAFE_VALID_FLAGS)) {
        ...
        hr = StringCopyWorkerW(pszDestEnd, cchRemaining, &cchCopied, pszSrc,
                               STRSAFE_MAX_LENGTH);
    ...
    if (FAILED(hr) &&
      ...
      // handle the STRSAFE_FILL_ON_FAILURE, STRSAFE_NULL_ON_FAILURE, and
      // STRSAFE_NO_TRUNCATION flags
      StringExHandleOtherFlagsW(pszDest, cbDest, cchDestLength, &pszDestEnd,
                                &cchRemaining, dwFlags);
    }
...
STRSAFEAPI
StringCbCatExA(_Inout_updates_bytes_(cbDest) _Always_(_Post_z_)
                   STRSAFE_LPSTR pszDest,
               _In_ size_t cbDest, _In_ STRSAFE_LPCSTR pszSrc,
               _Outptr_opt_result_bytebuffer_(*pcbRemaining)
                   STRSAFE_LPSTR *ppszDestEnd,
...
STRSAFEAPI
StringCbCatExW(_Inout_updates_bytes_(cbDest) _Always_(_Post_z_)
                   STRSAFE_LPWSTR pszDest,
               _In_ size_t cbDest, _In_ STRSAFE_LPCWSTR pszSrc,
               _Outptr_opt_result_bytebuffer_(*pcbRemaining)
                   STRSAFE_LPWSTR *ppszDestEnd,
...
STRSAFEAPI
StringCchCatNA(_Inout_updates_(cchDest) _Always_(_Post_z_)
                   STRSAFE_LPSTR pszDest,
               _In_ size_t cchDest,
...
STRSAFEAPI
StringCchCatNW(_Inout_updates_(cchDest) _Always_(_Post_z_)
                   STRSAFE_LPWSTR pszDest,
               _In_ size_t cchDest,
...
cbDest          -   size of destination buffer in bytes.
length must be ((_tcslen(pszDest) + min(cbToAppend / sizeof(TCHAR),
_tcslen(pszSrc)) + 1) * sizeof(TCHAR) to hold all of the combine string plus the
null terminator.
...
STRSAFEAPI
StringCbCatNA(_Inout_updates_bytes_(cbDest) _Always_(_Post_z_)
                  STRSAFE_LPSTR pszDest,
              _In_ size_t cbDest,
...
STRSAFEAPI
StringCbCatNW(_Inout_updates_bytes_(cbDest) _Always_(_Post_z_)
                  STRSAFE_LPWSTR pszDest,
              _In_ size_t cbDest,
...
STRSAFEAPI
StringCchCatNExA(_Inout_updates_(cchDest) _Always_(_Post_z_)
                     STRSAFE_LPSTR pszDest,
                 _In_ size_t cchDest,
                 _In_reads_or_z_(cchToAppend) STRSAFE_PCNZCH pszSrc,
                 _In_ size_t cchToAppend,
...
STRSAFEAPI
StringCchCatNExW(_Inout_updates_(cchDest) _Always_(_Post_z_)
                     STRSAFE_LPWSTR pszDest,
                 _In_ size_t cchDest,
                 _In_reads_or_z_(cchToAppend) STRSAFE_PCNZWCH pszSrc,
                 _In_ size_t cchToAppend,
...
STRSAFEAPI
StringCbCatNExA(_Inout_updates_bytes_(cbDest) _Always_(_Post_z_)
                    STRSAFE_LPSTR pszDest,
                _In_ size_t cbDest,
                _In_reads_bytes_(cbToAppend) STRSAFE_PCNZCH pszSrc,
                _In_ size_t cbToAppend,
...
STRSAFEAPI
StringCbCatNExW(_Inout_updates_bytes_(cbDest) _Always_(_Post_z_)
                    STRSAFE_LPWSTR pszDest,
                _In_ size_t cbDest,
                _In_reads_bytes_(cbToAppend) STRSAFE_PCNZWCH pszSrc,
                _In_ size_t cbToAppend,
...
STRSAFEAPI
StringCchVPrintfA(_Out_writes_(cchDest) _Always_(_Post_z_)
                      STRSAFE_LPSTR pszDest,
                  _In_ size_t cchDest,
                  _In_ _Printf_format_string_ STRSAFE_LPCSTR pszFormat,
                  _In_ va_list argList) {
...
STRSAFEAPI
StringCchVPrintfW(_Out_writes_(cchDest) _Always_(_Post_z_)
                      STRSAFE_LPWSTR pszDest,
                  _In_ size_t cchDest,
                  _In_ _Printf_format_string_ STRSAFE_LPCWSTR pszFormat,
                  _In_ va_list argList) {
  ...
  if (SUCCEEDED(hr)) {
    hr = StringVPrintfWorkerW(pszDest, cchDest, NULL, pszFormat, argList);
  } else if (cchDest > 0) {
    *pszDest = L'\0';
  }
...
STRSAFEAPI
StringCchVPrintf_lA(_Out_writes_(cchDest) _Always_(_Post_z_)
                        STRSAFE_LPSTR pszDest,
                    _In_ size_t cchDest,
                    _In_ _Printf_format_string_params_(2)
                        STRSAFE_LPCSTR pszFormat,
  ...
  if (SUCCEEDED(hr)) {
    hr = StringVPrintf_lWorkerA(pszDest, cchDest, NULL, pszFormat, locale,
                                argList);
  }
...
STRSAFEAPI
StringCchVPrintf_lW(_Out_writes_(cchDest) _Always_(_Post_z_)
                        STRSAFE_LPWSTR pszDest,
                    _In_ size_t cchDest,
                    _In_ _Printf_format_string_params_(2)
                        STRSAFE_LPCWSTR pszFormat,
  ...
  if (SUCCEEDED(hr)) {
    hr = StringVPrintf_lWorkerW(pszDest, cchDest, NULL, pszFormat, locale,
                                argList);
  }
...
STRSAFEAPI
StringCbVPrintfA(_Out_writes_bytes_(cbDest) _Always_(_Post_z_)
                     STRSAFE_LPSTR pszDest,
                 _In_ size_t cbDest,
                 _In_ _Printf_format_string_ STRSAFE_LPCSTR pszFormat,
                 _In_ va_list argList) {
...
STRSAFEAPI
StringCbVPrintfW(_Out_writes_bytes_(cbDest) _Always_(_Post_z_)
                     STRSAFE_LPWSTR pszDest,
                 _In_ size_t cbDest,
                 _In_ _Printf_format_string_ STRSAFE_LPCWSTR pszFormat,
                 _In_ va_list argList) {
...
STRSAFEAPI
StringCbVPrintf_lA(_Out_writes_bytes_(cbDest) _Always_(_Post_z_)
                       STRSAFE_LPSTR pszDest,
                   _In_ size_t cbDest,
                   _In_ _Printf_format_string_params_(2)
                       STRSAFE_LPCSTR pszFormat,
...
STRSAFEAPI
StringCbVPrintf_lW(_Out_writes_bytes_(cbDest) _Always_(_Post_z_)
                       STRSAFE_LPWSTR pszDest,
                   _In_ size_t cbDest,
                   _In_ _Printf_format_string_params_(2)
                       STRSAFE_LPCWSTR pszFormat,
...
STRSAFEAPI
StringCchPrintfW(_Out_writes_(cchDest) _Always_(_Post_z_)
                     STRSAFE_LPWSTR pszDest,
                 _In_ size_t cchDest,
                 _In_ _Printf_format_string_ STRSAFE_LPCWSTR pszFormat, ...) {
  HRESULT hr;
...
STRSAFEAPI
StringCchPrintf_lA(_Out_writes_(cchDest) _Always_(_Post_z_)
                       STRSAFE_LPSTR pszDest,
                   _In_ size_t cchDest,
                   _In_ _Printf_format_string_params_(2)
                       STRSAFE_LPCSTR pszFormat,
...
STRSAFEAPI
StringCchPrintf_lW(_Out_writes_(cchDest) _Always_(_Post_z_)
                       STRSAFE_LPWSTR pszDest,
                   _In_ size_t cchDest,
                   _In_ _Printf_format_string_params_(2)
                       STRSAFE_LPCWSTR pszFormat,
...
STRSAFEAPI
StringCbPrintfA(_Out_writes_bytes_(cbDest) _Always_(_Post_z_)
                    STRSAFE_LPSTR pszDest,
                _In_ size_t cbDest,
                _In_ _Printf_format_string_ STRSAFE_LPCSTR pszFormat, ...) {
  HRESULT hr;
...
STRSAFEAPI
StringCbPrintfW(_Out_writes_bytes_(cbDest) _Always_(_Post_z_)
                    STRSAFE_LPWSTR pszDest,
                _In_ size_t cbDest,
                _In_ _Printf_format_string_ STRSAFE_LPCWSTR pszFormat, ...) {
  HRESULT hr;
...
STRSAFEAPI
StringCbPrintf_lA(_Out_writes_bytes_(cbDest) _Always_(_Post_z_)
                      STRSAFE_LPSTR pszDest,
                  _In_ size_t cbDest,
                  _In_ _Printf_format_string_params_(2)
                      STRSAFE_LPCSTR pszFormat,
...
STRSAFEAPI
StringCbPrintf_lW(_Out_writes_bytes_(cbDest) _Always_(_Post_z_)
                      STRSAFE_LPWSTR pszDest,
                  _In_ size_t cbDest,
                  _In_ _Printf_format_string_params_(2)
                      STRSAFE_LPCWSTR pszFormat,
...
STRSAFEAPI
StringCchPrintfExA(_Out_writes_(cchDest) _Always_(_Post_z_)
                       STRSAFE_LPSTR pszDest,
                   _In_ size_t cchDest,
                   _Outptr_opt_result_buffer_(*pcchRemaining)
                       STRSAFE_LPSTR *ppszDestEnd,
  ...
  if (SUCCEEDED(hr)) {
    ...
    if (SUCCEEDED(hr)) {
      if (dwFlags & (~STRSAFE_VALID_FLAGS)) {
        ...
        hr = StringVPrintfWorkerA(pszDest, cchDest, &cchNewDestLength,
                                  pszFormat, argList);
...
STRSAFEAPI
StringCchPrintfExW(_Out_writes_(cchDest) _Always_(_Post_z_)
                       STRSAFE_LPWSTR pszDest,
                   _In_ size_t cchDest,
                   _Outptr_opt_result_buffer_(*pcchRemaining)
                       STRSAFE_LPWSTR *ppszDestEnd,
  ...
  if (SUCCEEDED(hr)) {
    ...
    if (SUCCEEDED(hr)) {
      if (dwFlags & (~STRSAFE_VALID_FLAGS)) {
        ...
        hr = StringVPrintfWorkerW(pszDest, cchDest, &cchNewDestLength,
                                  pszFormat, argList);
...
STRSAFEAPI
StringCchPrintf_lExA(_Out_writes_(cchDest) _Always_(_Post_z_)
                         STRSAFE_LPSTR pszDest,
                     _In_ size_t cchDest,
                     _Outptr_opt_result_buffer_(*pcchRemaining)
                         STRSAFE_LPSTR *ppszDestEnd,
  ...
  if (SUCCEEDED(hr)) {
    ...
    if (SUCCEEDED(hr)) {
      if (dwFlags & (~STRSAFE_VALID_FLAGS)) {
        ...
        hr = StringVPrintf_lWorkerA(pszDest, cchDest, &cchNewDestLength,
                                    pszFormat, locale, argList);
...
STRSAFEAPI
StringCchPrintf_lExW(_Out_writes_(cchDest) _Always_(_Post_z_)
                         STRSAFE_LPWSTR pszDest,
                     _In_ size_t cchDest,
                     _Outptr_opt_result_buffer_(*pcchRemaining)
                         STRSAFE_LPWSTR *ppszDestEnd,
  ...
  if (SUCCEEDED(hr)) {
    ...
    if (SUCCEEDED(hr)) {
      if (dwFlags & (~STRSAFE_VALID_FLAGS)) {
        ...
        hr = StringVPrintf_lWorkerW(pszDest, cchDest, &cchNewDestLength,
                                    pszFormat, locale, argList);
...
/*++
  ...
  StringCbPrintfEx(
  _Out_writes_bytes_(cbDest) _Always_(_Post_z_) LPTSTR  pszDest OPTIONAL, _In_
size_t  cbDest, _Outptr_opt_result_bytebuffer_(*pcbRemaining) LPTSTR*
ppszDestEnd     OPTIONAL, _Out_opt_ size_t* pcbRemaining    OPTIONAL, _In_ DWORD
dwFlags, _In_ _Printf_format_string_ LPCTSTR pszFormat       OPTIONAL,
  ...
  );
...
STRSAFEAPI
StringCbPrintfExA(_Out_writes_bytes_(cbDest) _Always_(_Post_z_)
                      STRSAFE_LPSTR pszDest,
                  _In_ size_t cbDest,
                  _Outptr_opt_result_bytebuffer_(*pcbRemaining)
                      STRSAFE_LPSTR *ppszDestEnd,
...
STRSAFEAPI
StringCbPrintfExW(_Out_writes_bytes_(cbDest) _Always_(_Post_z_)
                      STRSAFE_LPWSTR pszDest,
                  _In_ size_t cbDest,
                  _Outptr_opt_result_bytebuffer_(*pcbRemaining)
                      STRSAFE_LPWSTR *ppszDestEnd,
...
/*++
  ...
  _Out_writes_bytes_(cbDest) _Always_(_Post_z_) LPTSTR  pszDest OPTIONAL, _In_
  size_t  cbDest, _Outptr_opt_result_bytebuffer_(*pcbRemaining) LPTSTR*
  ppszDestEnd     OPTIONAL, _Out_opt_ size_t* pcbRemaining    OPTIONAL, _In_
  DWORD   dwFlags, _In_ _Printf_format_string_params_(2) LPCTSTR pszFormat
  OPTIONAL, _In_ locale_t locale,
  ...
  );
...
STRSAFEAPI
StringCbPrintf_lExA(_Out_writes_bytes_(cbDest) _Always_(_Post_z_)
                        STRSAFE_LPSTR pszDest,
                    _In_ size_t cbDest,
                    _Outptr_opt_result_bytebuffer_(*pcbRemaining)
                        STRSAFE_LPSTR *ppszDestEnd,
...
STRSAFEAPI
StringCbPrintf_lExW(_Out_writes_bytes_(cbDest) _Always_(_Post_z_)
                        STRSAFE_LPWSTR pszDest,
                    _In_ size_t cbDest,
                    _Outptr_opt_result_bytebuffer_(*pcbRemaining)
                        STRSAFE_LPWSTR *ppszDestEnd,
...
STRSAFEAPI
StringCchVPrintfExA(_Out_writes_(cchDest) _Always_(_Post_z_)
                        STRSAFE_LPSTR pszDest,
                    _In_ size_t cchDest,
                    _Outptr_opt_result_buffer_(*pcchRemaining)
                        STRSAFE_LPSTR *ppszDestEnd,
...
STRSAFEAPI
StringCchVPrintfExW(_Out_writes_(cchDest) _Always_(_Post_z_)
                        STRSAFE_LPWSTR pszDest,
                    _In_ size_t cchDest,
                    _Outptr_opt_result_buffer_(*pcchRemaining)
                        STRSAFE_LPWSTR *ppszDestEnd,
...
STRSAFEAPI
StringCchVPrintf_lExA(_Out_writes_(cchDest) _Always_(_Post_z_)
                          STRSAFE_LPSTR pszDest,
                      _In_ size_t cchDest,
                      _Outptr_opt_result_buffer_(*pcchRemaining)
                          STRSAFE_LPSTR *ppszDestEnd,
...
STRSAFEAPI
StringCchVPrintf_lExW(_Out_writes_(cchDest) _Always_(_Post_z_)
                          STRSAFE_LPWSTR pszDest,
                      _In_ size_t cchDest,
                      _Outptr_opt_result_buffer_(*pcchRemaining)
                          STRSAFE_LPWSTR *ppszDestEnd,
...
STRSAFEAPI
StringCbVPrintfExA(_Out_writes_bytes_(cbDest) STRSAFE_LPSTR pszDest,
                   _In_ size_t cbDest,
                   _Outptr_opt_result_bytebuffer_(*pcbRemaining)
                       STRSAFE_LPSTR *ppszDestEnd,
                   _Out_opt_ size_t *pcbRemaining, _In_ DWORD dwFlags,
...
STRSAFEAPI
StringCbVPrintfExW(_Out_writes_bytes_(cbDest) STRSAFE_LPWSTR pszDest,
                   _In_ size_t cbDest,
                   _Outptr_opt_result_bytebuffer_(*pcbRemaining)
                       STRSAFE_LPWSTR *ppszDestEnd,
                   _Out_opt_ size_t *pcbRemaining, _In_ DWORD dwFlags,
...
STRSAFEAPI
StringCbVPrintf_lExA(_Out_writes_bytes_(cbDest) STRSAFE_LPSTR pszDest,
                     _In_ size_t cbDest,
                     _Outptr_opt_result_bytebuffer_(*pcbRemaining)
                         STRSAFE_LPSTR *ppszDestEnd,
                     _Out_opt_ size_t *pcbRemaining, _In_ DWORD dwFlags,
...
STRSAFEAPI
StringCbVPrintf_lExW(_Out_writes_bytes_(cbDest) STRSAFE_LPWSTR pszDest,
                     _In_ size_t cbDest,
                     _Outptr_opt_result_bytebuffer_(*pcbRemaining)
                         STRSAFE_LPWSTR *ppszDestEnd,
                     _Out_opt_ size_t *pcbRemaining, _In_ DWORD dwFlags,
...
STRSAFEAPI
StringCchGetsA(_Out_writes_(cchDest) _Always_(_Post_z_) STRSAFE_LPSTR pszDest,
               _In_ size_t cchDest) {
  HRESULT hr;
...
STRSAFEAPI
StringCchGetsW(_Out_writes_(cchDest) _Always_(_Post_z_) STRSAFE_LPWSTR pszDest,
               _In_ size_t cchDest) {
  HRESULT hr;
...
STRSAFEAPI
StringCbGetsA(_Out_writes_bytes_(cbDest) _Always_(_Post_z_)
                  STRSAFE_LPSTR pszDest,
              _In_ size_t cbDest) {
  HRESULT hr;
  size_t cchDest = cbDest / sizeof(char);
...
STRSAFEAPI
StringCbGetsW(_Out_writes_bytes_(cbDest) _Always_(_Post_z_)
                  STRSAFE_LPWSTR pszDest,
              _In_ size_t cbDest) {
  HRESULT hr;
  size_t cchDest = cbDest / sizeof(wchar_t);
...
STRSAFEAPI
StringCchGetsExA(_Out_writes_(cchDest) _Always_(_Post_z_) STRSAFE_LPSTR pszDest,
                 _In_ size_t cchDest,
                 _Outptr_opt_result_buffer_(*pcchRemaining)
                     STRSAFE_LPSTR *ppszDestEnd,
                 _Out_opt_ size_t *pcchRemaining, _In_ DWORD dwFlags) {
...
STRSAFEAPI
StringCchGetsExW(_Out_writes_(cchDest) _Always_(_Post_z_)
                     STRSAFE_LPWSTR pszDest,
                 _In_ size_t cchDest,
                 _Outptr_opt_result_buffer_(*pcchRemaining)
                     STRSAFE_LPWSTR *ppszDestEnd,
...
STRSAFEAPI
StringCbGetsExA(_Out_writes_bytes_(cbDest) _Always_(_Post_z_)
                    STRSAFE_LPSTR pszDest,
                _In_ size_t cbDest,
                _Outptr_opt_result_bytebuffer_(*pcbRemaining)
                    STRSAFE_LPSTR *ppszDestEnd,
...
STRSAFEAPI
StringCbGetsExW(_Out_writes_bytes_(cbDest) _Always_(_Post_z_)
                    STRSAFE_LPWSTR pszDest,
                _In_ size_t cbDest,
                _Outptr_opt_result_bytebuffer_(*pcbRemaining)
                    STRSAFE_LPWSTR *ppszDestEnd,
...
_String_length_(psz)) size_t* pcchLength  OPTIONAL
  );
...
_Must_inspect_result_ STRSAFEAPI StringCchLengthW(
...
_Must_inspect_result_ STRSAFEAPI
StringCbLengthA(_In_reads_or_z_(cbMax) STRSAFE_PCNZCH psz,
  ...
  if (pcbLength) {
    if (SUCCEEDED(hr)) {
      // safe to multiply cchLength * sizeof(char) since cchLength <
      // STRSAFE_MAX_CCH and sizeof(char) is 1
...
_Must_inspect_result_ STRSAFEAPI StringCbLengthW(
  ...
  if (pcbLength) {
    if (SUCCEEDED(hr)) {
      // safe to multiply cchLength * sizeof(wchar_t) since cchLength <
      // STRSAFE_MAX_CCH and sizeof(wchar_t) is 2
...
/*++
  ...
  This routine is a version of StringCchLength that accepts an unaligned string
pointer.
...
#ifdef ALIGNMENT_MACHINE
_Must_inspect_result_ STRSAFEAPI UnalignedStringCchLengthW(
...
/*++
  ...
  This routine is a version of StringCbLength that accepts an unaligned string
pointer.
...
#ifdef ALIGNMENT_MACHINE
_Must_inspect_result_ STRSAFEAPI UnalignedStringCbLengthW(
...
#pragma warning(                                                               \
    disable : __WARNING_UNSAFE_STRING_FUNCTION) // call to dangerous string
                                                // function '_vsnprintf'.
...
_Success_(1) // always succeeds, no exit tests needed
  ...
  _Analysis_assume_(dwFlags & (STRSAFE_NO_TRUNCATION | STRSAFE_FILL_ON_FAILURE |
                               STRSAFE_NULL_ON_FAILURE));
...
#pragma warning(                                                               \
    pop) // ignore false positives due to complexity of bitflag usage
...
#define UnalignedStringLengthWorkerW                                           \
  UnalignedStringLengthWorkerW_instead_use_UnalignedStringCchLengthW
...
#define StringValidateDestAndLengthA                                           \
  StringValidateDestAndLengthA_do_not_call_this_function
#define StringValidateDestW StringValidateDestW_do_not_call_this_function
#define StringValidateDestAndLengthW                                           \
  StringValidateDestAndLengthW_do_not_call_this_function
#define StringExValidateDestA StringExValidateDestA_do_not_call_this_function
#define StringExValidateDestAndLengthA                                         \
  StringExValidateDestAndLengthA_do_not_call_this_function
#define StringExValidateDestW StringExValidateDestW_do_not_call_this_function
#define StringExValidateDestAndLengthW                                         \
  StringExValidateDestAndLengthW_do_not_call_this_function
#define StringCopyWorkerA                                                      \
  StringCopyWorkerA_instead_use_StringCchCopyA_or_StringCbCopyA
#define StringCopyWorkerW                                                      \
  StringCopyWorkerW_instead_use_StringCchCopyW_or_StringCbCopyW
#define StringVPrintfWorkerA                                                   \
  StringVPrintfWorkerA_instead_use_StringCchVPrintfA_or_StringCbVPrintfA
#define StringVPrintfWorkerW                                                   \
  StringVPrintfWorkerW_instead_use_StringCchVPrintfW_or_StringCbVPrintfW
#define StringGetsWorkerA                                                      \
  StringGetsWorkerA_instead_use_StringCchGetsA_or_StringCbGetsA
#define StringGetsWorkerW                                                      \
  StringGetsWorkerW_instead_use_StringCchGetsW_or_StringCbGetsW
#define StringExHandleFillBehindNullA                                          \
  StringExHandleFillBehindNullA_do_not_call_this_function
#define StringExHandleFillBehindNullW                                          \
  StringExHandleFillBehindNullW_do_not_call_this_function
#define StringExHandleOtherFlagsA                                              \
  StringExHandleOtherFlagsA_do_not_call_this_function
#define StringExHandleOtherFlagsW                                              \
  StringExHandleOtherFlagsW_do_not_call_this_function
