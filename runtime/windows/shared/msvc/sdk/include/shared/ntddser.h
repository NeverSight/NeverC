...
//   #include <ntddser.h> in that source file a second time to instantiate the
//   GUIDs
//
...
DEFINE_DEVPROPKEY(DEVPKEY_DeviceInterface_Serial_UsbVendorId, 0X4C6BF15C,
...
DEFINE_DEVPROPKEY(DEVPKEY_DeviceInterface_Serial_UsbProductId, 0X4C6BF15C,
                  0X4C03, 0X4AAC, 0X91, 0XF5, 0X64, 0XC0, 0XF8, 0X52, 0XBC,
                  0XF4, 3);
...
DEFINE_DEVPROPKEY(DEVPKEY_DeviceInterface_Serial_PortName, 0X4C6BF15C, 0X4C03,
...
#define IOCTL_SERIAL_APPLY_DEFAULT_CONFIGURATION                               \
...
typedef UCHAR (*PSERENUM_READPORT)(_In_ PVOID SerPortAddress);

typedef VOID (*PSERENUM_WRITEPORT)(_In_ PVOID SerPortAddress, _In_ UCHAR Value);
