...
// The AKMs are defined in the IEEE 802.11 spec in Table 9-188-AKM suite
// selectors The mappings are defined in Table 12-11-Integrity and key wrap
// algorithms The KCK length for SAE is defined in the IEEE 802.11 spec in Table
// 12-1-Hash algorithm based on length of prime
...
typedef enum {
  ...
  rsna_akm_ft_psk_sha256 =
      AKM_FROM_TYPE(RSNA_OUI_PREFIX, 4),                    // FT_PSK + SHA-256
  ...
  rsna_akm_ft_sae_pmk256 =
      AKM_FROM_TYPE(RSNA_OUI_PREFIX, 9), // FT_SAE + [PMK = 256]
  rsna_akm_peerkey_sha256 = AKM_FROM_TYPE(RSNA_OUI_PREFIX, 10),
  rsna_akm_1x_suite_b_sha256 =
      AKM_FROM_TYPE(RSNA_OUI_PREFIX, 11), // 1X_Suite_B + SHA-256
  rsna_akm_1x_suite_b_sha384 =
      AKM_FROM_TYPE(RSNA_OUI_PREFIX, 12), // 1X_Suite_B/CSNA + SHA-384
  rsna_akm_ft_1x_sha384_cmp_256 =
      AKM_FROM_TYPE(RSNA_OUI_PREFIX, 13), // FT_1X + SHA-384 + CCMP-256/GCMP-256
  ...
  rsna_akm_ft_psk_sha384 =
      AKM_FROM_TYPE(RSNA_OUI_PREFIX, 19),                   // FT_PSK + SHA-384
  ...
  rsna_akm_ft_sae_pmk384 =
      AKM_FROM_TYPE(RSNA_OUI_PREFIX, 25), // FT_SAE + [PMK = 384]
...
// The ciphers are defined in the IEEE 802.11 spec in Table 9-186-Cipher suite
// selectors
...
typedef struct _DOT11_RATE_SET {
  ...
  _Field_size_part_(DOT11_RATE_SET_MAX_LENGTH,
                    uRateSetLength) UCHAR ucRateSet[DOT11_RATE_SET_MAX_LENGTH];
...
typedef struct _DOT11_WFD_SESSION_INFO {
  _Field_range_(<=,
                DOT11_WFD_SESSION_INFO_MAX_LENGTH) USHORT uSessionInfoLength;
  _Field_size_part_(DOT11_WFD_SESSION_INFO_MAX_LENGTH, uSessionInfoLength) UCHAR
      ucSessionInfo[DOT11_WFD_SESSION_INFO_MAX_LENGTH];
...
#define OID_DOT11_AUTO_CONFIG_ENABLED                                          \
  NWF_DEFINE_OID(0x78, NWF_OPERATIONAL_OID, NWF_MANDATORY_OID)
// ULONG
...
#define OID_DOT11_ENUM_BSS_LIST                                                \
  NWF_DEFINE_OID(0x79, NWF_OPERATIONAL_OID, NWF_MANDATORY_OID)
...
#define OID_DOT11_FLUSH_BSS_LIST                                               \
  NWF_DEFINE_OID(0x7A, NWF_OPERATIONAL_OID, NWF_MANDATORY_OID)
// VOID

#define OID_DOT11_POWER_MGMT_REQUEST                                           \
  NWF_DEFINE_OID(0x7B, NWF_OPERATIONAL_OID, NWF_MANDATORY_OID)
// ULONG
...
#define OID_DOT11_DESIRED_SSID_LIST                                            \
  NWF_DEFINE_OID(0x7C, NWF_OPERATIONAL_OID, NWF_MANDATORY_OID)
...
#define OID_DOT11_EXCLUDED_MAC_ADDRESS_LIST                                    \
  NWF_DEFINE_OID(0x7D, NWF_OPERATIONAL_OID, NWF_MANDATORY_OID)
// A list of DOT11_MAC_ADDRESS
...
#define OID_DOT11_DESIRED_BSSID_LIST                                           \
  NWF_DEFINE_OID(0x7E, NWF_OPERATIONAL_OID, NWF_MANDATORY_OID)

#define OID_DOT11_DESIRED_BSS_TYPE                                             \
  NWF_DEFINE_OID(0x7F, NWF_OPERATIONAL_OID, NWF_MANDATORY_OID)
// DOT11_BSS_TYPE

#define OID_DOT11_PMKID_LIST                                                   \
  NWF_DEFINE_OID(0x80, NWF_OPERATIONAL_OID, NWF_OPTIONAL_OID)
...
#define OID_DOT11_CONNECT_REQUEST                                              \
  NWF_DEFINE_OID(0x81, NWF_OPERATIONAL_OID, NWF_MANDATORY_OID)
// no data type

#define OID_DOT11_EXCLUDE_UNENCRYPTED                                          \
  NWF_DEFINE_OID(0x82, NWF_OPERATIONAL_OID, NWF_MANDATORY_OID)
// BOOLEAN

#define OID_DOT11_STATISTICS                                                   \
  NWF_DEFINE_OID(0x83, NWF_STATISTICS_OID, NWF_MANDATORY_OID)
...
#define OID_DOT11_PRIVACY_EXEMPTION_LIST                                       \
  NWF_DEFINE_OID(0x84, NWF_OPERATIONAL_OID, NWF_MANDATORY_OID)
...
#define OID_DOT11_ENABLED_AUTHENTICATION_ALGORITHM                             \
  NWF_DEFINE_OID(0x85, NWF_OPERATIONAL_OID, NWF_MANDATORY_OID)
...
#define OID_DOT11_SUPPORTED_UNICAST_ALGORITHM_PAIR                             \
  NWF_DEFINE_OID(0x86, NWF_OPERATIONAL_OID, NWF_MANDATORY_OID)
...
#define OID_DOT11_ENABLED_UNICAST_CIPHER_ALGORITHM                             \
  NWF_DEFINE_OID(0x87, NWF_OPERATIONAL_OID, NWF_MANDATORY_OID)
...
#define OID_DOT11_SUPPORTED_MULTICAST_ALGORITHM_PAIR                           \
  NWF_DEFINE_OID(0x88, NWF_OPERATIONAL_OID, NWF_MANDATORY_OID)

#define OID_DOT11_ENABLED_MULTICAST_CIPHER_ALGORITHM                           \
  NWF_DEFINE_OID(0x89, NWF_OPERATIONAL_OID, NWF_MANDATORY_OID)
// DOT11_CIPHER_ALGORITHM_LIST

#define OID_DOT11_CIPHER_DEFAULT_KEY_ID                                        \
  NWF_DEFINE_OID(0x8A, NWF_OPERATIONAL_OID, NWF_MANDATORY_OID)
// ULONG

#define OID_DOT11_CIPHER_DEFAULT_KEY                                           \
  NWF_DEFINE_OID(0x8B, NWF_OPERATIONAL_OID, NWF_MANDATORY_OID)
...
#define OID_DOT11_CIPHER_KEY_MAPPING_KEY                                       \
  NWF_DEFINE_OID(0x8C, NWF_OPERATIONAL_OID, NWF_MANDATORY_OID)
// DOT11_BYTE_ARRAY
...
#define OID_DOT11_ENUM_ASSOCIATION_INFO                                        \
  NWF_DEFINE_OID(0x8D, NWF_OPERATIONAL_OID, NWF_MANDATORY_OID)
...
#define OID_DOT11_DISCONNECT_REQUEST                                           \
  NWF_DEFINE_OID(0x8E, NWF_OPERATIONAL_OID, NWF_MANDATORY_OID)

#define OID_DOT11_UNICAST_USE_GROUP_ENABLED                                    \
  NWF_DEFINE_OID(0x8F, NWF_OPERATIONAL_OID, NWF_MANDATORY_OID)
// BOOLEAN

#define OID_DOT11_HARDWARE_PHY_STATE                                           \
  NWF_DEFINE_OID(0x90, NWF_OPERATIONAL_OID, NWF_MANDATORY_OID)
// BOOLEAN

#define OID_DOT11_DESIRED_PHY_LIST                                             \
  NWF_DEFINE_OID(0x91, NWF_OPERATIONAL_OID, NWF_MANDATORY_OID)
// DOT11_PHY_ID_LIST
...
#define OID_DOT11_CURRENT_PHY_ID                                               \
  NWF_DEFINE_OID(0x92, NWF_OPERATIONAL_OID, NWF_MANDATORY_OID)
// ULONG

#define OID_DOT11_MEDIA_STREAMING_ENABLED                                      \
  NWF_DEFINE_OID(0x93, NWF_OPERATIONAL_OID, NWF_MANDATORY_OID)
// BOOLEAN

#define OID_DOT11_UNREACHABLE_DETECTION_THRESHOLD                              \
  NWF_DEFINE_OID(0x94, NWF_OPERATIONAL_OID, NWF_MANDATORY_OID)
// ULONG

#define OID_DOT11_ACTIVE_PHY_LIST                                              \
  NWF_DEFINE_OID(0x95, NWF_OPERATIONAL_OID, NWF_MANDATORY_OID)
// DOT11_PHY_ID_LIST

#define OID_DOT11_EXTSTA_CAPABILITY                                            \
  NWF_DEFINE_OID(0x96, NWF_OPERATIONAL_OID, NWF_MANDATORY_OID)
...
#define OID_DOT11_DATA_RATE_MAPPING_TABLE                                      \
  NWF_DEFINE_OID(0x97, NWF_OPERATIONAL_OID, NWF_MANDATORY_OID)
...
#define DOT11_DATA_RATE_MAPPING_TABLE_REVISION_1 1
  ...
  _Field_size_part_(DOT11_RATE_SET_MAX_LENGTH,
                    uDataRateMappingLength) DOT11_DATA_RATE_MAPPING_ENTRY
...
#define OID_DOT11_SUPPORTED_COUNTRY_OR_REGION_STRING                           \
  NWF_DEFINE_OID(0x98, NWF_OPERATIONAL_OID, NWF_MANDATORY_OID)
...
#define OID_DOT11_DESIRED_COUNTRY_OR_REGION_STRING                             \
  NWF_DEFINE_OID(0x99, NWF_OPERATIONAL_OID, NWF_MANDATORY_OID)
// DOT11_COUNTRY_OR_REGION_STRING

#define OID_DOT11_PORT_STATE_NOTIFICATION                                      \
  NWF_DEFINE_OID(0x9A, NWF_OPERATIONAL_OID, NWF_OPTIONAL_OID)
...
#define OID_DOT11_IBSS_PARAMS                                                  \
  NWF_DEFINE_OID(0x9B, NWF_OPERATIONAL_OID, NWF_MANDATORY_OID)
// DOT11_IBSS_PARAMS
...
#define OID_DOT11_QOS_PARAMS                                                   \
  NWF_DEFINE_OID(0x9C, NWF_OPERATIONAL_OID, NWF_OPTIONAL_OID)
...
#define OID_DOT11_SAFE_MODE_ENABLED                                            \
  NWF_DEFINE_OID(0x9D, NWF_OPERATIONAL_OID, NWF_MANDATORY_OID)
// BOOLEAN

#define OID_DOT11_HIDDEN_NETWORK_ENABLED                                       \
  NWF_DEFINE_OID(0x9E, NWF_OPERATIONAL_OID, NWF_MANDATORY_OID)
// BOOLEAN

#define OID_DOT11_ASSOCIATION_PARAMS                                           \
  NWF_DEFINE_OID(0x9F, NWF_OPERATIONAL_OID, NWF_MANDATORY_OID)
...
#define OID_DOT11_SAFE_MODE_HT_ENABLED                                         \
  NWF_DEFINE_OID(0xA0, NWF_OPERATIONAL_OID, NWF_MANDATORY_OID)
// BOOLEAN
...
#if (defined(_NDIS_) ||                                                        \
     defined(NDIS_WRAPPER)) // To avoid build break since NDIS_PACKET isn't
                            // defined for user mode app.
...
#define DOT11_ASSOCIATION_COMPLETION_PARAMETERS_REVISION_2 2
  ...
  // It is zero or combination of DOT11_QOS_PROTOCOL_FLAG_WMM and/or
...
// For uStatus in DOT11_CONNECTION_COMPLETION_PARAMETERS and
...
typedef struct _DOT11_WFD_ADVERTISED_SERVICE_LIST {
  USHORT ServiceCount;
#ifdef __midl
  [size_is(ServiceCount)] DOT11_WFD_ADVERTISED_SERVICE_DESCRIPTOR
      AdvertisedService[*];
#else
...
#define DOT11_SIZEOF_ANQP_QUERY_COMPLETE_PARAMETERS_REVISION_1                 \
...
typedef struct _DOT11_WFD_GROUP_OWNER_CAPABILITY_CONFIG_V2 {
  ...
  BOOLEAN bEapolKeyIpAddressAllocationSupported;
    ...
    *PDOT11_WFD_GROUP_OWNER_CAPABILITY_CONFIG_V2;

#define DOT11_SIZEOF_WFD_GROUP_CAPABILITY_CONFIG_2                             \
  sizeof(DOT11_WFD_GROUP_OWNER_CAPABILITY_CONFIG_V2)
...
#define DOT11_WFD_DEVICE_ENTRY_GET_DEVICE_SIZE(_device_)                       \
  (sizeof(DOT11_WFD_DEVICE_ENTRY) + (_device_)->uBeaconIEsLength +             \
   (_device_)->uProbeResponseIEsLength)
...
#define DOT11_WFD_ADDITIONAL_IE_SET_BEACON_IE(_addie_, _beacon_)               \
  (_addie_)->uBeaconIEsOffset =                                                \
      (DWORD)(((SIZE_T)(_beacon_)) - ((SIZE_T)(_addie_)))
...
#define DOT11_WFD_ADDITIONAL_IE_GET_BEACON_IE_END(_addie_)                     \
  (((PCHAR)(_addie_)) + (_addie_)->uBeaconIEsOffset +                          \
   DOT11_WFD_ADDITIONAL_IE_GET_BEACON_IE_SIZE(_addie_))
...
#define DOT11_WFD_ADDITIONAL_IE_SET_PROBE_RESPONSE_IE(_addie_, _response_)     \
  (_addie_)->uProbeResponseIEsOffset =                                         \
      (DWORD)(((SIZE_T)(_response_)) - ((SIZE_T)(_addie_)))
...
#define DOT11_WFD_ADDITIONAL_IE_GET_PROBE_RESPONSE_IE_END(_addie_)             \
  (((PCHAR)(_addie_)) + (_addie_)->uProbeResponseIEsOffset +                   \
   DOT11_WFD_ADDITIONAL_IE_GET_PROBE_RESPONSE_IE_SIZE(_addie_))
...
#define DOT11_WFD_ADDITIONAL_IE_SET_PROBE_REQUEST_IE(_addie_, _request_)       \
  (_addie_)->uDefaultRequestIEsOffset =                                        \
      (DWORD)(((SIZE_T)(_request_)) - ((SIZE_T)(_addie_)))
...
#define DOT11_WFD_ADDITIONAL_IE_GET_ALL_IE_SIZE(_addie_)                       \
  ((_addie_)->uBeaconIEsLength + (_addie_)->uProbeResponseIEsLength +          \
   (_addie_)->uDefaultRequestIEsLength)
...
#define OID_DOT11_WFD_ENABLE_HRDSSS_DEVICES                                    \
...
#define DOT11_NLO_FLAG_STOP_NLO_INDICATION                                     \
  0x00000001 // stop NLO scan and NLO discovery indications
#define DOT11_NLO_FLAG_SCAN_ON_AOAC_PLATFORM                                   \
  0x00000002 // typically used on AOAC platform in connected standby
#define DOT11_NLO_FLAG_SCAN_AT_SYSTEM_RESUME                                   \
  0x00000004 // used at system resume once for instant connect
...
//
// when NLO has 0 entry, the minimum size is this. Drivers can safely access
// fields except entries.
//
...
//
// OID_DOT11_SET_FT_REASSOCIATION_PARAMETERS is a new Oid for WDI.  It is
// defined here because it is a Direct Oid that needs to be visible to Ndis
//
#define OID_DOT11_SET_FT_REASSOCIATION_PARAMETERS                              \
  NWF_DEFINE_OID(0x68, NWF_OPERATIONAL_OID, NWF_MANDATORY_OID)
...
//
#define OID_DOT11_SET_SAE_AUTH_PARAMS                                          \
  NWF_DEFINE_OID(0x72, NWF_OPERATIONAL_OID, NWF_MANDATORY_OID)

//
// OID_DOT11_SET_NWF_PMKID_LIST is used for returning PmkIds computed by nwifi.
// It is defined here because it is a Direct Oid that needs to be visible to
// Ndis
//
#define OID_DOT11_SET_NWF_PMKID_LIST                                           \
  NWF_DEFINE_OID(0x75, NWF_OPERATIONAL_OID, NWF_MANDATORY_OID)
