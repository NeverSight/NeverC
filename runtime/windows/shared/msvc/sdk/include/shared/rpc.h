...
#if (defined(_M_MRX000) || defined(_M_IX86) || defined(_M_IA64) ||             \
...
// rpcasync.h is now RPC_NO_WINDOWS_H aware, but we can't start including it
// always as it does still require windef.h which could clash with another
// header.
//
// Parsing of the below test:
// don't include rpcasync.h if either RPC_NO_WINDOWS_H or __RPC_MAC__ is set,
// except that setting RPC_NEED_RPCASYNC_H overrides RPC_NO_WINDOWS_H. In any
// case, if _KRPCENV_ is set, include rpcasync.h regardless of any of the above
// being set.
