...
DEFINE_GUID(GUID_DEVICE_BATTERY, 0x72631e54L, 0x78A4, 0x11d0, 0xbc, 0xf7, 0x00,
            0xaa, 0x00, 0xb7, 0xb3, 0x2a);
DEFINE_GUID(GUID_DEVICE_APPLICATIONLAUNCH_BUTTON, 0x629758eel, 0x986e, 0x4d9e,
...
DEFINE_GUID(GUID_DEVICE_THERMAL_ZONE, 0x4AFA3D51L, 0x74A7, 0x11d0, 0xbe, 0x5e,
            0x00, 0xA0, 0xC9, 0x06, 0x28, 0x57);
DEFINE_GUID(GUID_DEVICE_FAN, 0x05ecd13dL, 0x81da, 0x4a2a, 0x8a, 0x4c, 0x52,
            0x4f, 0x23, 0xdd, 0x4d, 0xc9);
...
DEFINE_GUID(GUID_DEVICE_ACPI_TIME, 0x97f99bf6L, 0x4497, 0x4f18, 0xbb, 0x22,
            0x4b, 0x9f, 0xb2, 0xfb, 0xef, 0x9c);
DEFINE_GUID(GUID_DEVICE_MESSAGE_INDICATOR, 0XCD48A365L, 0xfa94, 0x4ce2, 0xa2,
            0x32, 0xa1, 0xb7, 0x64, 0xe5, 0xd8, 0xb4);
DEFINE_GUID(GUID_DEVICE_POWER_ADAPTER, 0xf76c6c62L, 0x7dea, 0x43cd, 0x86, 0x89,
            0xd9, 0xa4, 0xaf, 0x3d, 0x85, 0x57);
...
DEFINE_GUID(GUID_DEVINTERFACE_THERMAL_COOLING, 0xdbe4373d, 0x3c81, 0x40cb, 0xac,
            0xe4, 0xe0, 0xe5, 0xd0, 0x5f, 0xc, 0x9f);

// {927EC093-69A4-4bc0-BD02-711664714463}
DEFINE_GUID(GUID_DEVINTERFACE_THERMAL_MANAGER, 0x927ec093, 0x69a4, 0x4bc0, 0xbd,
            0x2, 0x71, 0x16, 0x64, 0x71, 0x44, 0x63);

// {8f366301-091e-4056-b92f-958b27625fce}
DEFINE_GUID(GUID_DEVINTERFACE_POWER_LIMIT, 0x8f366301, 0x091e, 0x4056, 0xb9,
            0x2f, 0x95, 0x8b, 0x27, 0x62, 0x5f, 0xce);

// {2a6c8538-7895-4d56-8567-795d3844858a}
DEFINE_GUID(GUID_DEVINTERFACE_TEMPERATURE_SENSOR, 0x2a6c8538, 0x7895, 0x4d56,
            0x85, 0x67, 0x79, 0x5d, 0x38, 0x44, 0x85, 0x8a);

// {2ed8544a-8eef-4033-b2a0-04aaa507cecb}
DEFINE_GUID(GUID_DEVINTERFACE_CUSTOMIZED_IO, 0x2ed8544a, 0x8eef, 0x4033, 0xb2,
            0xa0, 0x04, 0xaa, 0xa5, 0x07, 0xce, 0xcb);
...
//
// BATTERY_USB_CHARGER_STATUS.Flags field.
// Indicates Type-C port has established an explicit contract of Power Delivery
// with the port partner.
//
...
// - If an adapter that delivers less than MinimumPower it will not charge the
// device.
...
//
// Thermal Zone driver interface (devices of registrying as
...
typedef _Function_class_(DEVICE_ACTIVE_COOLING) VOID
    DEVICE_ACTIVE_COOLING(_Inout_opt_ PVOID Context, _In_ BOOLEAN Engaged);

typedef DEVICE_ACTIVE_COOLING *PDEVICE_ACTIVE_COOLING;

typedef _Function_class_(DEVICE_PASSIVE_COOLING) VOID
    DEVICE_PASSIVE_COOLING(_Inout_opt_ PVOID Context, _In_ ULONG Percentage);
...
typedef _Function_class_(QUERY_POWER_LIMIT_ATTRIBUTES) NTSTATUS
    QUERY_POWER_LIMIT_ATTRIBUTES(_Inout_opt_ PVOID Context,
...
typedef _Function_class_(SET_POWER_LIMIT) NTSTATUS
    SET_POWER_LIMIT(_Inout_opt_ PVOID Context, _In_ ULONG ValueCount,
                    _In_ PVOID Values);

typedef SET_POWER_LIMIT *PSET_POWER_LIMIT;

typedef _Function_class_(QUERY_POWER_LIMIT) NTSTATUS
    QUERY_POWER_LIMIT(_Inout_opt_ PVOID Context, _In_ ULONG ValueCount,
                      _Inout_ PVOID Values);

typedef QUERY_POWER_LIMIT *PQUERY_POWER_LIMIT;

//
// Power limit client interface (devices implementing
