...
public:
  ...
  virtual HRESULT STDMETHODCALLTYPE GetFrameDirtyRects(
      ...
      /* [annotation][out] */
      _Out_writes_bytes_to_(DirtyRectsBufferSize,
                            *pDirtyRectsBufferSizeRequired) RECT *
          pDirtyRectsBuffer,
      /* [annotation][out] */
...
#define IDXGIOutputDuplication_AcquireNextFrame(This, TimeoutInMilliseconds,   \
                                                pFrameInfo, ppDesktopResource) \
  ((This)->lpVtbl->AcquireNextFrame(This, TimeoutInMilliseconds, pFrameInfo,   \
                                    ppDesktopResource))

#define IDXGIOutputDuplication_GetFrameDirtyRects(                             \
    This, DirtyRectsBufferSize, pDirtyRectsBuffer,                             \
    pDirtyRectsBufferSizeRequired)                                             \
  ((This)->lpVtbl->GetFrameDirtyRects(This, DirtyRectsBufferSize,              \
                                      pDirtyRectsBuffer,                       \
                                      pDirtyRectsBufferSizeRequired))

#define IDXGIOutputDuplication_GetFrameMoveRects(                              \
    This, MoveRectsBufferSize, pMoveRectBuffer, pMoveRectsBufferSizeRequired)  \
  ((This)->lpVtbl->GetFrameMoveRects(This, MoveRectsBufferSize,                \
                                     pMoveRectBuffer,                          \
                                     pMoveRectsBufferSizeRequired))

#define IDXGIOutputDuplication_GetFramePointerShape(                           \
    This, PointerShapeBufferSize, pPointerShapeBuffer,                         \
...
typedef struct IDXGISurface2Vtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(IDXGISurface2 *This,
                                             /* [in] */ REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);
  ...
  DECLSPEC_XFGVIRT(IDXGIObject, SetPrivateData)
  HRESULT(STDMETHODCALLTYPE *SetPrivateData)(IDXGISurface2 *This,
                                             /* [annotation][in] */
                                             _In_ REFGUID Name,
                                             /* [in] */ UINT DataSize,
                                             /* [annotation][in] */
  ...
  DECLSPEC_XFGVIRT(IDXGIObject, GetParent)
  HRESULT(STDMETHODCALLTYPE *GetParent)(IDXGISurface2 *This,
                                        /* [annotation][in] */
                                        _In_ REFIID riid,
                                        /* [annotation][retval][out] */
                                        _COM_Outptr_ void **ppParent);
  ...
  HRESULT(STDMETHODCALLTYPE *GetDevice)(IDXGISurface2 *This,
                                        /* [annotation][in] */
                                        _In_ REFIID riid,
                                        /* [annotation][retval][out] */
  ...
  HRESULT(STDMETHODCALLTYPE *GetDC)(IDXGISurface2 *This,
                                    /* [in] */ BOOL Discard,
                                    /* [annotation][out] */
                                    _Out_ HDC *phdc);

  DECLSPEC_XFGVIRT(IDXGISurface1, ReleaseDC)
  HRESULT(STDMETHODCALLTYPE *ReleaseDC)(IDXGISurface2 *This,
                                        /* [annotation][in] */
                                        _In_opt_ RECT *pDirtyRect);

  DECLSPEC_XFGVIRT(IDXGISurface2, GetResource)
  HRESULT(STDMETHODCALLTYPE *GetResource)(IDXGISurface2 *This,
                                          /* [annotation][in] */
                                          _In_ REFIID riid,
                                          /* [annotation][out] */
                                          _COM_Outptr_ void **ppParentResource,
...
#define IDXGISurface2_GetResource(This, riid, ppParentResource,                \
                                  pSubresourceIndex)                           \
...
typedef struct IDXGIResource1Vtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(IDXGIResource1 *This,
                                             /* [in] */ REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);
  ...
  DECLSPEC_XFGVIRT(IDXGIObject, SetPrivateData)
  HRESULT(STDMETHODCALLTYPE *SetPrivateData)(IDXGIResource1 *This,
                                             /* [annotation][in] */
                                             _In_ REFGUID Name,
                                             /* [in] */ UINT DataSize,
                                             /* [annotation][in] */
  ...
  DECLSPEC_XFGVIRT(IDXGIObject, GetParent)
  HRESULT(STDMETHODCALLTYPE *GetParent)(IDXGIResource1 *This,
                                        /* [annotation][in] */
                                        _In_ REFIID riid,
                                        /* [annotation][retval][out] */
                                        _COM_Outptr_ void **ppParent);
  ...
  DECLSPEC_XFGVIRT(IDXGIDeviceSubObject, GetDevice)
  HRESULT(STDMETHODCALLTYPE *GetDevice)(IDXGIResource1 *This,
                                        /* [annotation][in] */
                                        _In_ REFIID riid,
                                        /* [annotation][retval][out] */
                                        _COM_Outptr_ void **ppDevice);
...
#define IDXGIResource1_CreateSharedHandle(This, pAttributes, dwAccess, lpName, \
                                          pHandle)                             \
...
typedef struct IDXGIDevice2Vtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(IDXGIDevice2 *This,
                                             /* [in] */ REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);
  ...
  DECLSPEC_XFGVIRT(IDXGIObject, SetPrivateData)
  HRESULT(STDMETHODCALLTYPE *SetPrivateData)(IDXGIDevice2 *This,
                                             /* [annotation][in] */
                                             _In_ REFGUID Name,
                                             /* [in] */ UINT DataSize,
                                             /* [annotation][in] */
  ...
  DECLSPEC_XFGVIRT(IDXGIObject, GetParent)
  HRESULT(STDMETHODCALLTYPE *GetParent)(IDXGIDevice2 *This,
                                        /* [annotation][in] */
                                        _In_ REFIID riid,
                                        /* [annotation][retval][out] */
                                        _COM_Outptr_ void **ppParent);
...
#define IDXGIDevice2_CreateSurface(This, pDesc, NumSurfaces, Usage,            \
                                   pSharedResource, ppSurface)                 \
  ((This)->lpVtbl->CreateSurface(This, pDesc, NumSurfaces, Usage,              \
                                 pSharedResource, ppSurface))

#define IDXGIDevice2_QueryResourceResidency(This, ppResources,                 \
...
typedef struct IDXGISwapChain1Vtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(IDXGISwapChain1 *This,
                                             /* [in] */ REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);
...
#define IDXGISwapChain1_ResizeBuffers(This, BufferCount, Width, Height,        \
...
typedef struct IDXGIFactory2Vtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(IDXGIFactory2 *This,
                                             /* [in] */ REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);
...
typedef struct IDXGIAdapter2Vtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(IDXGIAdapter2 *This,
                                             /* [in] */ REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);
  ...
  DECLSPEC_XFGVIRT(IDXGIObject, SetPrivateData)
  HRESULT(STDMETHODCALLTYPE *SetPrivateData)(IDXGIAdapter2 *This,
                                             /* [annotation][in] */
                                             _In_ REFGUID Name,
                                             /* [in] */ UINT DataSize,
                                             /* [annotation][in] */
  ...
  DECLSPEC_XFGVIRT(IDXGIObject, GetParent)
  HRESULT(STDMETHODCALLTYPE *GetParent)(IDXGIAdapter2 *This,
                                        /* [annotation][in] */
                                        _In_ REFIID riid,
                                        /* [annotation][retval][out] */
                                        _COM_Outptr_ void **ppParent);
  ...
  HRESULT(STDMETHODCALLTYPE *EnumOutputs)(IDXGIAdapter2 *This,
                                          /* [in] */ UINT Output,
                                          /* [annotation][out][in] */
                                          _COM_Outptr_ IDXGIOutput **ppOutput);
...
typedef struct IDXGIOutput1Vtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(IDXGIOutput1 *This,
                                             /* [in] */ REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);
  ...
  DECLSPEC_XFGVIRT(IDXGIObject, SetPrivateData)
  HRESULT(STDMETHODCALLTYPE *SetPrivateData)(IDXGIOutput1 *This,
                                             /* [annotation][in] */
                                             _In_ REFGUID Name,
                                             /* [in] */ UINT DataSize,
                                             /* [annotation][in] */
  ...
  DECLSPEC_XFGVIRT(IDXGIObject, GetParent)
  HRESULT(STDMETHODCALLTYPE *GetParent)(IDXGIOutput1 *This,
                                        /* [annotation][in] */
                                        _In_ REFIID riid,
                                        /* [annotation][retval][out] */
                                        _COM_Outptr_ void **ppParent);
  ...
  HRESULT(STDMETHODCALLTYPE *GetGammaControl)(IDXGIOutput1 *This,
                                              /* [annotation][out] */
...
#define IDXGIOutput1_GetDisplayModeList(This, EnumFormat, Flags, pNumModes,    \
                                        pDesc)                                 \
  ((This)->lpVtbl->GetDisplayModeList(This, EnumFormat, Flags, pNumModes,      \
                                      pDesc))

#define IDXGIOutput1_FindClosestMatchingMode(This, pModeToMatch,               \
...
#define IDXGIOutput1_GetDisplayModeList1(This, EnumFormat, Flags, pNumModes,   \
                                         pDesc)                                \
  ((This)->lpVtbl->GetDisplayModeList1(This, EnumFormat, Flags, pNumModes,     \
                                       pDesc))

#define IDXGIOutput1_FindClosestMatchingMode1(This, pModeToMatch,              \
                                              pClosestMatch, pConcernedDevice) \
