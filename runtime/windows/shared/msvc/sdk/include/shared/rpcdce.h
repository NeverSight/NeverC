...
// Client: RpcBindingSetOption() values for the Falcon/RPC transport (some are
// deprecated from Vista)
...
typedef void __RPC_USER RPC_OBJECT_INQ_FN(_In_ UUID __RPC_FAR *ObjectUuid,
                                          _Out_ UUID __RPC_FAR *TypeUuid,
                                          _Out_ RPC_STATUS __RPC_FAR *Status);

_Success_(return == 0) /*RPC_S_OK*/
    typedef RPC_STATUS RPC_ENTRY
    RPC_IF_CALLBACK_FN(_In_ RPC_IF_HANDLE InterfaceUuid, _In_ void *Context);

typedef void RPC_ENTRY RPC_SECURITY_CALLBACK_FN(_In_ void *Context);
...
/* client */
RPCRTAPI
_Must_inspect_result_ RPC_STATUS RPC_ENTRY
RpcBindingCopy(_In_ RPC_BINDING_HANDLE SourceBinding,
...
RPCRTAPI
_Must_inspect_result_ RPC_STATUS RPC_ENTRY
RpcBindingSetOption(_In_ RPC_BINDING_HANDLE hBinding, _In_ unsigned long option,
                    _In_ ULONG_PTR optionValue);

/* client */
RPCRTAPI
_Must_inspect_result_ RPC_STATUS RPC_ENTRY
RpcBindingInqOption(_In_ RPC_BINDING_HANDLE hBinding, _In_ unsigned long option,
...
RPCRTAPI
_Must_inspect_result_ RPC_STATUS RPC_ENTRY RpcBindingFromStringBindingA(
    _In_ RPC_CSTR StringBinding, _Out_ RPC_BINDING_HANDLE __RPC_FAR *Binding);

RPCRTAPI
_Must_inspect_result_ RPC_STATUS RPC_ENTRY RpcBindingFromStringBindingW(
    _In_ RPC_WSTR StringBinding, _Out_ RPC_BINDING_HANDLE __RPC_FAR *Binding);
...
RPC_STATUS
RPC_ENTRY
RpcBindingFromStringBinding(_In_ RPC_CSTR StringBinding,
...
RPC_STATUS
RPC_ENTRY
RpcSsGetContextBinding(_In_ void *ContextHandle,
                       _Out_ RPC_BINDING_HANDLE __RPC_FAR *Binding);
...
/* client/server */
RPCRTAPI
_Must_inspect_result_ RPC_STATUS RPC_ENTRY RpcBindingInqMaxCalls(
    _In_ RPC_BINDING_HANDLE Binding, _Out_ unsigned int *MaxCalls);

/* client/server */
RPCRTAPI
_Must_inspect_result_ RPC_STATUS RPC_ENTRY RpcBindingInqObject(
    _In_ RPC_BINDING_HANDLE Binding, _Out_ UUID __RPC_FAR *ObjectUuid);

/* client */
RPCRTAPI
_Must_inspect_result_ RPC_STATUS RPC_ENTRY
RpcBindingReset(_In_ RPC_BINDING_HANDLE Binding);
...
/* client */
RPCRTAPI
_Must_inspect_result_ RPC_STATUS RPC_ENTRY RpcBindingSetObject(
    _In_ RPC_BINDING_HANDLE Binding, _In_ UUID __RPC_FAR *ObjectUuid);
...
/* client/server */
RPCRTAPI
_Must_inspect_result_ RPC_STATUS RPC_ENTRY RpcMgmtInqDefaultProtectLevel(
    _In_ unsigned long AuthnSvc, _Out_ unsigned long __RPC_FAR *AuthnLevel);
...
RPCRTAPI
_Must_inspect_result_ RPC_STATUS RPC_ENTRY
RpcBindingToStringBindingA(_In_ RPC_BINDING_HANDLE Binding,
                           _Outptr_ RPC_CSTR __RPC_FAR *StringBinding);

RPCRTAPI
_Must_inspect_result_ RPC_STATUS RPC_ENTRY
RpcBindingToStringBindingW(_In_ RPC_BINDING_HANDLE Binding,
...
RPC_STATUS
RPC_ENTRY
RpcBindingToStringBinding(_In_ RPC_BINDING_HANDLE Binding,
                          _Outptr_ RPC_CSTR __RPC_FAR *StringBinding);
...
RPC_STATUS
RPC_ENTRY
RpcBindingVectorFree(_Inout_ RPC_BINDING_VECTOR __RPC_FAR * __RPC_FAR *
                     BindingVector);
...
RPCRTAPI
_Must_inspect_result_ RPC_STATUS RPC_ENTRY RpcStringBindingComposeA(
    _In_opt_ RPC_CSTR ObjUuid, _In_opt_ RPC_CSTR ProtSeq,
    _In_opt_ RPC_CSTR NetworkAddr, _In_opt_ RPC_CSTR Endpoint,
    _In_opt_ RPC_CSTR Options, _Outptr_opt_ RPC_CSTR __RPC_FAR *StringBinding);

RPCRTAPI
_Must_inspect_result_ RPC_STATUS RPC_ENTRY RpcStringBindingComposeW(
    _In_opt_ RPC_WSTR ObjUuid, _In_opt_ RPC_WSTR ProtSeq,
    _In_opt_ RPC_WSTR NetworkAddr, _In_opt_ RPC_WSTR Endpoint,
    _In_opt_ RPC_WSTR Options, _Outptr_opt_ RPC_WSTR __RPC_FAR *StringBinding);
...
RPC_STATUS
RPC_ENTRY
RpcStringBindingCompose(_In_opt_ RPC_CSTR ObjUuid, _In_opt_ RPC_CSTR ProtSeq,
                        _In_opt_ RPC_CSTR NetworkAddr,
                        _In_opt_ RPC_CSTR Endpoint, _In_opt_ RPC_CSTR Options,
...
RPCRTAPI
_Must_inspect_result_ RPC_STATUS RPC_ENTRY RpcStringBindingParseA(
    _In_ RPC_CSTR StringBinding, _Outptr_opt_ RPC_CSTR __RPC_FAR *ObjUuid,
...
RPCRTAPI
_Must_inspect_result_ RPC_STATUS RPC_ENTRY RpcStringBindingParseW(
    _In_ RPC_WSTR StringBinding, _Outptr_opt_ RPC_WSTR __RPC_FAR *ObjUuid,
...
RPC_STATUS
RPC_ENTRY
RpcStringBindingParse(_In_ RPC_CSTR StringBinding,
...
RPC_STATUS
RPC_ENTRY
RpcStringFreeA(_Inout_ RPC_CSTR __RPC_FAR *String);

RPCRTAPI
RPC_STATUS
RPC_ENTRY
RpcStringFreeW(_Inout_ RPC_WSTR __RPC_FAR *String);
...
RPC_STATUS
RPC_ENTRY
RpcStringFree(_At_(*_Curr_, _Frees_ptr_opt_)
...
RPCRTAPI
_Must_inspect_result_ RPC_STATUS RPC_ENTRY
RpcIfInqId(_In_ RPC_IF_HANDLE RpcIfHandle, _Out_ RPC_IF_ID __RPC_FAR *RpcIfId);
...
RPCRTAPI
_Must_inspect_result_ RPC_STATUS RPC_ENTRY
RpcNetworkIsProtseqValidA(_In_ RPC_CSTR Protseq);

RPCRTAPI
_Must_inspect_result_ RPC_STATUS RPC_ENTRY
RpcNetworkIsProtseqValidW(_In_ RPC_WSTR Protseq);
...
RPC_STATUS
RPC_ENTRY
RpcNetworkIsProtseqValid(_In_ RPC_CSTR Protseq);
...
/* client */
RPCRTAPI
_Must_inspect_result_ RPC_STATUS RPC_ENTRY RpcMgmtInqComTimeout(
    _In_ RPC_BINDING_HANDLE Binding, _Out_ unsigned int __RPC_FAR *Timeout);
...
/* client */
RPCRTAPI
_Must_inspect_result_ RPC_STATUS RPC_ENTRY RpcMgmtSetComTimeout(
    _In_ RPC_BINDING_HANDLE Binding, _In_ unsigned int Timeout);

/* client */
RPCRTAPI
_Must_inspect_result_ RPC_STATUS RPC_ENTRY
RpcMgmtSetCancelTimeout(_In_ long Timeout);
...
RPCRTAPI
_Must_inspect_result_ RPC_STATUS RPC_ENTRY RpcNetworkInqProtseqsA(
    _Outptr_ RPC_PROTSEQ_VECTORA __RPC_FAR * __RPC_FAR * ProtseqVector);

RPCRTAPI
_Must_inspect_result_ RPC_STATUS RPC_ENTRY RpcNetworkInqProtseqsW(
...
RPC_STATUS
RPC_ENTRY
RpcNetworkInqProtseqs(_Outptr_ RPC_PROTSEQ_VECTOR __RPC_FAR * __RPC_FAR *
                      ProtseqVector);
...
/* server */
RPCRTAPI
_Must_inspect_result_ RPC_STATUS RPC_ENTRY RpcObjectInqType(
    _In_ UUID __RPC_FAR *ObjUuid, _Out_opt_ OPTIONAL UUID __RPC_FAR *TypeUuid);

/* server */
RPCRTAPI
_Must_inspect_result_ RPC_STATUS RPC_ENTRY
RpcObjectSetInqFn(_In_ RPC_OBJECT_INQ_FN __RPC_FAR *InquiryFn);

/* server */
RPCRTAPI
_Must_inspect_result_ RPC_STATUS RPC_ENTRY RpcObjectSetType(
    _In_ UUID __RPC_FAR *ObjUuid, _In_opt_ OPTIONAL UUID __RPC_FAR *TypeUuid);
...
RPC_STATUS
RPC_ENTRY
RpcProtseqVectorFreeA(_Inout_ RPC_PROTSEQ_VECTORA __RPC_FAR * __RPC_FAR *
                      ProtseqVector);

RPCRTAPI
RPC_STATUS
RPC_ENTRY
RpcProtseqVectorFreeW(_Inout_ RPC_PROTSEQ_VECTORW __RPC_FAR * __RPC_FAR *
                      ProtseqVector);
...
RPC_STATUS
RPC_ENTRY
RpcProtseqVectorFree(_Inout_ RPC_PROTSEQ_VECTOR __RPC_FAR * __RPC_FAR *
                     ProtseqVector);
...
/* server */
RPCRTAPI
_Must_inspect_result_ RPC_STATUS RPC_ENTRY RpcServerInqBindings(
    _Outptr_ RPC_BINDING_VECTOR __RPC_FAR * __RPC_FAR * BindingVector);

/* server */
RPCRTAPI
_Must_inspect_result_ RPC_STATUS RPC_ENTRY RpcServerInqBindingsEx(
...
RPCRTAPI
_Must_inspect_result_ RPC_STATUS RPC_ENTRY
RpcServerInqIf(_In_ RPC_IF_HANDLE IfSpec, _In_opt_ UUID __RPC_FAR *MgrTypeUuid,
               _Outptr_ RPC_MGR_EPV __RPC_FAR * __RPC_FAR * MgrEpv);

/* server */
RPCRTAPI
_Must_inspect_result_ RPC_STATUS RPC_ENTRY
RpcServerListen(_In_ unsigned int MinimumCallThreads,
                _In_ unsigned int MaxCalls, _In_ unsigned int DontWait);

/* server */
RPCRTAPI
_Must_inspect_result_ RPC_STATUS RPC_ENTRY RpcServerRegisterIf(
    _In_ RPC_IF_HANDLE IfSpec, _In_opt_ UUID __RPC_FAR *MgrTypeUuid,
    _In_opt_ RPC_MGR_EPV __RPC_FAR *MgrEpv);

/* server */
RPCRTAPI
_Must_inspect_result_ RPC_STATUS RPC_ENTRY RpcServerRegisterIfEx(
    _In_ RPC_IF_HANDLE IfSpec, _In_opt_ UUID __RPC_FAR *MgrTypeUuid,
    _In_opt_ RPC_MGR_EPV __RPC_FAR *MgrEpv, _In_ unsigned int Flags,
...
RPC_STATUS
RPC_ENTRY
RpcServerRegisterIf2(_In_ RPC_IF_HANDLE IfSpec, _In_opt_ UUID *MgrTypeUuid,
                     _In_opt_ RPC_MGR_EPV *MgrEpv, _In_ unsigned int Flags,
                     _In_ unsigned int MaxCalls, _In_ unsigned int MaxRpcSize,
...
RPC_STATUS
RPC_ENTRY
RpcServerRegisterIf3(_In_ RPC_IF_HANDLE IfSpec,
                     _In_opt_ UUID __RPC_FAR *MgrTypeUuid,
                     _In_opt_ RPC_MGR_EPV __RPC_FAR *MgrEpv,
                     _In_ unsigned int Flags, _In_ unsigned int MaxCalls,
...
/* server */
RPCRTAPI
_Must_inspect_result_ RPC_STATUS RPC_ENTRY RpcServerUnregisterIf(
    _In_opt_ RPC_IF_HANDLE IfSpec, _In_opt_ UUID __RPC_FAR *MgrTypeUuid,
...
RPC_STATUS
RPC_ENTRY
RpcServerUnregisterIfEx(_In_opt_ RPC_IF_HANDLE IfSpec,
                        _In_opt_ UUID __RPC_FAR *MgrTypeUuid,
...
/* server */
RPCRTAPI
_Must_inspect_result_ RPC_STATUS RPC_ENTRY RpcServerUseAllProtseqs(
    _In_ unsigned int MaxCalls, _In_opt_ void __RPC_FAR *SecurityDescriptor);

/* server */
RPCRTAPI
_Must_inspect_result_ RPC_STATUS RPC_ENTRY RpcServerUseAllProtseqsEx(
    _In_ unsigned int MaxCalls, _In_opt_ void __RPC_FAR *SecurityDescriptor,
...
RPCRTAPI
_Must_inspect_result_ RPC_STATUS RPC_ENTRY
RpcServerUseAllProtseqsIf(_In_ unsigned int MaxCalls, _In_ RPC_IF_HANDLE IfSpec,
                          _In_opt_ void __RPC_FAR *SecurityDescriptor);

/* server */
RPCRTAPI
_Must_inspect_result_ RPC_STATUS RPC_ENTRY RpcServerUseAllProtseqsIfEx(
    _In_ unsigned int MaxCalls, _In_ RPC_IF_HANDLE IfSpec,
    _In_opt_ void __RPC_FAR *SecurityDescriptor, _In_ PRPC_POLICY Policy);
...
RPCRTAPI
_Must_inspect_result_ RPC_STATUS RPC_ENTRY
RpcServerUseProtseqA(_In_ RPC_CSTR Protseq, _In_ unsigned int MaxCalls,
                     _In_opt_ void __RPC_FAR *SecurityDescriptor);

RPCRTAPI
_Must_inspect_result_ RPC_STATUS RPC_ENTRY RpcServerUseProtseqExA(
    _In_ RPC_CSTR Protseq, _In_ unsigned int MaxCalls,
    _In_opt_ void __RPC_FAR *SecurityDescriptor, _In_ PRPC_POLICY Policy);

RPCRTAPI
_Must_inspect_result_ RPC_STATUS RPC_ENTRY
RpcServerUseProtseqW(_In_ RPC_WSTR Protseq, _In_ unsigned int MaxCalls,
                     _In_opt_ void __RPC_FAR *SecurityDescriptor);

RPCRTAPI
_Must_inspect_result_ RPC_STATUS RPC_ENTRY RpcServerUseProtseqExW(
    _In_ RPC_WSTR Protseq, _In_ unsigned int MaxCalls,
    _In_opt_ void __RPC_FAR *SecurityDescriptor, _In_ PRPC_POLICY Policy);
...
RPC_STATUS
RPC_ENTRY
RpcServerUseProtseq(_In_ RPC_CSTR Protseq, _In_ unsigned int MaxCalls,
                    _In_opt_ void __RPC_FAR *SecurityDescriptor);

RPCRTAPI
RPC_STATUS
RPC_ENTRY
RpcServerUseProtseqEx(_In_ RPC_CSTR Protseq, _In_ unsigned int MaxCalls,
                      _In_opt_ void __RPC_FAR *SecurityDescriptor,
                      _In_ PRPC_POLICY Policy);
...
RPCRTAPI
_Must_inspect_result_ RPC_STATUS RPC_ENTRY RpcServerUseProtseqEpA(
    _In_ RPC_CSTR Protseq, _In_ unsigned int MaxCalls, _In_ RPC_CSTR Endpoint,
    _In_opt_ void __RPC_FAR *SecurityDescriptor);

RPCRTAPI
_Must_inspect_result_ RPC_STATUS RPC_ENTRY RpcServerUseProtseqEpExA(
    _In_ RPC_CSTR Protseq, _In_ unsigned int MaxCalls, _In_ RPC_CSTR Endpoint,
    _In_opt_ void __RPC_FAR *SecurityDescriptor, _In_ PRPC_POLICY Policy);

RPCRTAPI
_Must_inspect_result_ RPC_STATUS RPC_ENTRY RpcServerUseProtseqEpW(
    _In_ RPC_WSTR Protseq, _In_ unsigned int MaxCalls, _In_ RPC_WSTR Endpoint,
    _In_opt_ void __RPC_FAR *SecurityDescriptor);

RPCRTAPI
_Must_inspect_result_ RPC_STATUS RPC_ENTRY RpcServerUseProtseqEpExW(
    _In_ RPC_WSTR Protseq, _In_ unsigned int MaxCalls, _In_ RPC_WSTR Endpoint,
    _In_opt_ void __RPC_FAR *SecurityDescriptor, _In_ PRPC_POLICY Policy);
...
RPC_STATUS
RPC_ENTRY
RpcServerUseProtseqEp(_In_ RPC_CSTR Protseq, _In_ unsigned int MaxCalls,
...
RPC_STATUS
RPC_ENTRY
RpcServerUseProtseqEpEx(_In_ RPC_WSTR Protseq, _In_ unsigned int MaxCalls,
...
RPCRTAPI
_Must_inspect_result_ RPC_STATUS RPC_ENTRY RpcServerUseProtseqIfA(
    _In_ RPC_CSTR Protseq, _In_ unsigned int MaxCalls,
    _In_ RPC_IF_HANDLE IfSpec, _In_opt_ void __RPC_FAR *SecurityDescriptor);

RPCRTAPI
_Must_inspect_result_ RPC_STATUS RPC_ENTRY RpcServerUseProtseqIfExA(
    _In_ RPC_CSTR Protseq, _In_ unsigned int MaxCalls,
    _In_ RPC_IF_HANDLE IfSpec, _In_opt_ void __RPC_FAR *SecurityDescriptor,
    _In_ PRPC_POLICY Policy);

RPCRTAPI
_Must_inspect_result_ RPC_STATUS RPC_ENTRY RpcServerUseProtseqIfW(
    _In_ RPC_WSTR Protseq, _In_ unsigned int MaxCalls,
    _In_ RPC_IF_HANDLE IfSpec, _In_opt_ void __RPC_FAR *SecurityDescriptor);

RPCRTAPI
_Must_inspect_result_ RPC_STATUS RPC_ENTRY RpcServerUseProtseqIfExW(
    _In_ RPC_WSTR Protseq, _In_ unsigned int MaxCalls,
    _In_ RPC_IF_HANDLE IfSpec, _In_opt_ void __RPC_FAR *SecurityDescriptor,
    _In_ PRPC_POLICY Policy);
...
RPC_STATUS
RPC_ENTRY
RpcServerUseProtseqIf(_In_ RPC_CSTR Protseq, _In_ unsigned int MaxCalls,
...
RPC_STATUS
RPC_ENTRY
RpcServerUseProtseqIfEx(_In_ RPC_CSTR Protseq, _In_ unsigned int MaxCalls,
                        _In_ RPC_IF_HANDLE IfSpec,
                        _In_ void __RPC_FAR *SecurityDescriptor,
                        _In_ PRPC_POLICY Policy);
...
RPCRTAPI
void RPC_ENTRY RpcServerYield(void);

/* server */
RPCRTAPI
RPC_STATUS
RPC_ENTRY
RpcMgmtStatsVectorFree(_Inout_ RPC_STATS_VECTOR **StatsVector);
...
RPCRTAPI
_Must_inspect_result_ RPC_STATUS RPC_ENTRY
RpcMgmtInqStats(_In_opt_ RPC_BINDING_HANDLE Binding,
                _Outptr_ RPC_STATS_VECTOR **Statistics);

/* server */
RPCRTAPI
_Must_inspect_result_ RPC_STATUS RPC_ENTRY
RpcMgmtIsServerListening(_In_opt_ RPC_BINDING_HANDLE Binding);
...
RPCRTAPI
_Must_inspect_result_ RPC_STATUS RPC_ENTRY
RpcMgmtStopServerListening(_In_opt_ RPC_BINDING_HANDLE Binding);

/* server */
RPCRTAPI
_Must_inspect_result_ RPC_STATUS RPC_ENTRY RpcMgmtWaitServerListen(void);

/* server */
RPCRTAPI
_Must_inspect_result_ RPC_STATUS RPC_ENTRY
RpcMgmtSetServerStackSize(_In_ unsigned long ThreadStackSize);
...
/* client */
RPCRTAPI
_Must_inspect_result_ RPC_STATUS RPC_ENTRY RpcMgmtEnableIdleCleanup(void);

RPCRTAPI
_Must_inspect_result_ RPC_STATUS RPC_ENTRY
RpcMgmtInqIfIds(_In_opt_ RPC_BINDING_HANDLE Binding,
                _Outptr_ RPC_IF_ID_VECTOR __RPC_FAR * __RPC_FAR * IfIdVector);

RPCRTAPI
RPC_STATUS
RPC_ENTRY
RpcIfIdVectorFree(_Inout_ RPC_IF_ID_VECTOR __RPC_FAR * __RPC_FAR * IfIdVector);
...
RPCRTAPI
_Must_inspect_result_ RPC_STATUS RPC_ENTRY RpcMgmtInqServerPrincNameA(
    _In_opt_ RPC_BINDING_HANDLE Binding, _In_ unsigned long AuthnSvc,
    _Outptr_ RPC_CSTR __RPC_FAR *ServerPrincName);

RPCRTAPI
_Must_inspect_result_ RPC_STATUS RPC_ENTRY RpcMgmtInqServerPrincNameW(
    _In_opt_ RPC_BINDING_HANDLE Binding, _In_ unsigned long AuthnSvc,
...
RPC_STATUS
RPC_ENTRY
RpcMgmtInqServerPrincName(_In_ RPC_BINDING_HANDLE Binding,
...
RPCRTAPI
_Must_inspect_result_ RPC_STATUS RPC_ENTRY RpcServerInqDefaultPrincNameA(
    _In_ unsigned long AuthnSvc, _Outptr_ RPC_CSTR __RPC_FAR *PrincName);

RPCRTAPI
_Must_inspect_result_ RPC_STATUS RPC_ENTRY RpcServerInqDefaultPrincNameW(
    _In_ unsigned long AuthnSvc, _Outptr_ RPC_WSTR __RPC_FAR *PrincName);
...
RPC_STATUS
RPC_ENTRY
RpcServerInqDefaultPrincName(_In_ unsigned long AuthnSvc,
...
RPCRTAPI
_Must_inspect_result_ RPC_STATUS RPC_ENTRY
RpcEpResolveBinding(_In_ RPC_BINDING_HANDLE Binding, _In_ RPC_IF_HANDLE IfSpec);
...
RPCRTAPI
_Must_inspect_result_ RPC_STATUS RPC_ENTRY RpcNsBindingInqEntryNameA(
    _In_ RPC_BINDING_HANDLE Binding, _In_ unsigned long EntryNameSyntax,
    _Outptr_ RPC_CSTR __RPC_FAR *EntryName);

RPCRTAPI
_Must_inspect_result_ RPC_STATUS RPC_ENTRY RpcNsBindingInqEntryNameW(
    _In_ RPC_BINDING_HANDLE Binding, _In_ unsigned long EntryNameSyntax,
...
RPC_STATUS
RPC_ENTRY
RpcNsBindingInqEntryName(_In_ RPC_BINDING_HANDLE Binding,
...
typedef struct _SEC_WINNT_AUTH_IDENTITY_W {
  _Field_size_bytes_((UserLength + 1) *
                     sizeof(WCHAR)) unsigned short __RPC_FAR *User;
  unsigned long UserLength;
  _Field_size_bytes_((DomainLength + 1) *
                     sizeof(WCHAR)) unsigned short __RPC_FAR *Domain;
  unsigned long DomainLength;
  _Field_size_bytes_((PasswordLength + 1) *
                     sizeof(WCHAR)) unsigned short __RPC_FAR *Password;
...
RPC_STATUS
RPC_ENTRY
RpcBindingCreateA(_In_ RPC_BINDING_HANDLE_TEMPLATE_V1_A *Template,
...
RPC_STATUS
RPC_ENTRY
RpcBindingCreateW(_In_ RPC_BINDING_HANDLE_TEMPLATE_V1_W *Template,
...
RPC_STATUS
RPC_ENTRY
RpcBindingGetTrainingContextHandle(_In_ RPC_BINDING_HANDLE Binding,
                                   _Outptr_ void **ContextHandle);

RPCRTAPI
RPC_STATUS
RPC_ENTRY
RpcServerInqBindingHandle(_Out_ RPC_BINDING_HANDLE *Binding);
...
typedef RPC_STATUS(__RPC_USER *RPC_NEW_HTTP_PROXY_CHANNEL)(
    _In_ RPC_HTTP_REDIRECTOR_STAGE RedirectorStage, _In_ RPC_WSTR ServerName,
    _In_ RPC_WSTR ServerPort, _In_opt_ RPC_WSTR RemoteUser,
    _In_opt_ RPC_WSTR AuthType, _Inout_ void __RPC_FAR *ResourceUuid,
    _Inout_ void __RPC_FAR *SessionId, _In_opt_ void __RPC_FAR *Interface,
    _In_opt_ void __RPC_FAR *Reserved, _In_ unsigned long Flags,
...
typedef void(__RPC_USER *RPC_HTTP_PROXY_FREE_STRING)(_In_ RPC_WSTR String);
...
RPCRTAPI
_Must_inspect_result_ RPC_STATUS RPC_ENTRY
RpcImpersonateClient(_In_opt_ RPC_BINDING_HANDLE BindingHandle);

RPCRTAPI
RPC_STATUS
RPC_ENTRY
RpcImpersonateClient2(_In_opt_ RPC_BINDING_HANDLE BindingHandle);

RPCRTAPI
_Must_inspect_result_ RPC_STATUS RPC_ENTRY
RpcRevertToSelfEx(_In_opt_ RPC_BINDING_HANDLE BindingHandle);

RPCRTAPI
_Must_inspect_result_ RPC_STATUS RPC_ENTRY RpcRevertToSelf(void);

RPCRTAPI
_Must_inspect_result_ RPC_STATUS RPC_ENTRY
RpcImpersonateClientContainer(_In_opt_ RPC_BINDING_HANDLE BindingHandle);

RPCRTAPI
_Must_inspect_result_ RPC_STATUS RPC_ENTRY
RpcRevertContainerImpersonation(void);
...
RPCRTAPI
_Must_inspect_result_ RPC_STATUS RPC_ENTRY
RpcBindingInqAuthClientA(_In_opt_ RPC_BINDING_HANDLE ClientBinding,
...
RPCRTAPI
_Must_inspect_result_ RPC_STATUS RPC_ENTRY
RpcBindingInqAuthClientW(_In_opt_ RPC_BINDING_HANDLE ClientBinding,
                         _Out_ RPC_AUTHZ_HANDLE __RPC_FAR *Privs,
...
RPC_STATUS
RPC_ENTRY
RpcBindingInqAuthClientExA(_In_opt_ RPC_BINDING_HANDLE ClientBinding,
                           _Out_ RPC_AUTHZ_HANDLE __RPC_FAR *Privs,
                           _Outptr_opt_ RPC_CSTR __RPC_FAR *ServerPrincName,
                           _Out_opt_ unsigned long __RPC_FAR *AuthnLevel,
                           _Out_opt_ unsigned long __RPC_FAR *AuthnSvc,
...
RPC_STATUS
RPC_ENTRY
RpcBindingInqAuthClientExW(_In_opt_ RPC_BINDING_HANDLE ClientBinding,
                           _Out_ RPC_AUTHZ_HANDLE __RPC_FAR *Privs,
                           _Outptr_opt_ RPC_WSTR __RPC_FAR *ServerPrincName,
                           _Out_opt_ unsigned long __RPC_FAR *AuthnLevel,
                           _Out_opt_ unsigned long __RPC_FAR *AuthnSvc,
...
RPCRTAPI
_Must_inspect_result_ RPC_STATUS RPC_ENTRY RpcBindingInqAuthInfoA(
...
RPCRTAPI
_Must_inspect_result_ RPC_STATUS RPC_ENTRY RpcBindingInqAuthInfoW(
    _In_ RPC_BINDING_HANDLE Binding,
    _Outptr_opt_ RPC_WSTR __RPC_FAR *ServerPrincName,
    _Out_opt_ unsigned long __RPC_FAR *AuthnLevel,
    _Out_opt_ unsigned long __RPC_FAR *AuthnSvc,
...
RPCRTAPI
_Must_inspect_result_ RPC_STATUS RPC_ENTRY RpcBindingSetAuthInfoA(
    _In_ RPC_BINDING_HANDLE Binding, _In_opt_ RPC_CSTR ServerPrincName,
    _In_ unsigned long AuthnLevel, _In_ unsigned long AuthnSvc,
    _In_opt_ RPC_AUTH_IDENTITY_HANDLE AuthIdentity,
    _In_ unsigned long AuthzSvc);

RPCRTAPI
_Must_inspect_result_ RPC_STATUS RPC_ENTRY RpcBindingSetAuthInfoExA(
    _In_ RPC_BINDING_HANDLE Binding, _In_opt_ RPC_CSTR ServerPrincName,
    _In_ unsigned long AuthnLevel, _In_ unsigned long AuthnSvc,
    _In_opt_ RPC_AUTH_IDENTITY_HANDLE AuthIdentity, _In_ unsigned long AuthzSvc,
    _In_opt_ RPC_SECURITY_QOS *SecurityQos);

RPCRTAPI
_Must_inspect_result_ RPC_STATUS RPC_ENTRY RpcBindingSetAuthInfoW(
    _In_ RPC_BINDING_HANDLE Binding, _In_opt_ RPC_WSTR ServerPrincName,
    _In_ unsigned long AuthnLevel, _In_ unsigned long AuthnSvc,
    _In_opt_ RPC_AUTH_IDENTITY_HANDLE AuthIdentity,
    _In_ unsigned long AuthzSvc);

RPCRTAPI
_Must_inspect_result_ RPC_STATUS RPC_ENTRY RpcBindingSetAuthInfoExW(
    _In_ RPC_BINDING_HANDLE Binding, _In_opt_ RPC_WSTR ServerPrincName,
    _In_ unsigned long AuthnLevel, _In_ unsigned long AuthnSvc,
    _In_opt_ RPC_AUTH_IDENTITY_HANDLE AuthIdentity, _In_ unsigned long AuthzSvc,
    _In_opt_ RPC_SECURITY_QOS *SecurityQOS);
...
RPCRTAPI
_Must_inspect_result_ RPC_STATUS RPC_ENTRY RpcBindingInqAuthInfoExA(
    _In_ RPC_BINDING_HANDLE Binding,
    _Outptr_opt_ RPC_CSTR __RPC_FAR *ServerPrincName,
    _Out_opt_ unsigned long __RPC_FAR *AuthnLevel,
    _Out_opt_ unsigned long __RPC_FAR *AuthnSvc,
    _Out_opt_ RPC_AUTH_IDENTITY_HANDLE __RPC_FAR *AuthIdentity,
    _Out_opt_ unsigned long __RPC_FAR *AuthzSvc,
    _In_ unsigned long RpcQosVersion, _Out_opt_ RPC_SECURITY_QOS *SecurityQOS);

RPCRTAPI
_Must_inspect_result_ RPC_STATUS RPC_ENTRY RpcBindingInqAuthInfoExW(
    _In_ RPC_BINDING_HANDLE Binding,
    _Outptr_opt_ RPC_WSTR __RPC_FAR *ServerPrincName,
    _Out_opt_ unsigned long __RPC_FAR *AuthnLevel,
    _Out_opt_ unsigned long __RPC_FAR *AuthnSvc,
...
typedef void(__RPC_USER *RPC_AUTH_KEY_RETRIEVAL_FN)(
    _In_ void __RPC_FAR *Arg, _In_ RPC_WSTR ServerPrincName,
    _In_ unsigned long KeyVer, _Outptr_ void __RPC_FAR * __RPC_FAR * Key,
    _Out_ RPC_STATUS __RPC_FAR *Status);

RPCRTAPI
RPC_STATUS
RPC_ENTRY
RpcServerCompleteSecurityCallback(_In_ RPC_BINDING_HANDLE BindingHandle,
                                  _In_ RPC_STATUS Status);

RPCRTAPI
_Must_inspect_result_ RPC_STATUS RPC_ENTRY RpcServerRegisterAuthInfoA(
    _In_opt_ RPC_CSTR ServerPrincName, _In_ unsigned long AuthnSvc,
    _In_opt_ RPC_AUTH_KEY_RETRIEVAL_FN GetKeyFn, _In_opt_ void __RPC_FAR *Arg);

RPCRTAPI
_Must_inspect_result_ RPC_STATUS RPC_ENTRY RpcServerRegisterAuthInfoW(
    _In_opt_ RPC_WSTR ServerPrincName, _In_ unsigned long AuthnSvc,
    _In_opt_ RPC_AUTH_KEY_RETRIEVAL_FN GetKeyFn, _In_opt_ void __RPC_FAR *Arg);
...
RPC_STATUS
RPC_ENTRY
RpcBindingInqAuthClient(_In_opt_ RPC_BINDING_HANDLE ClientBinding,
                        _Out_ RPC_AUTHZ_HANDLE __RPC_FAR *Privs,
                        _Outptr_opt_ RPC_WSTR __RPC_FAR *ServerPrincName,
                        _Out_opt_ unsigned long __RPC_FAR *AuthnLevel,
                        _Out_opt_ unsigned long __RPC_FAR *AuthnSvc,
...
RPC_STATUS
RPC_ENTRY
RpcBindingInqAuthClientEx(_In_opt_ RPC_BINDING_HANDLE ClientBinding,
                          _Out_ RPC_AUTHZ_HANDLE __RPC_FAR *Privs,
                          _Outptr_opt_ RPC_CSTR __RPC_FAR *ServerPrincName,
                          _Out_opt_ unsigned long __RPC_FAR *AuthnLevel,
                          _Out_opt_ unsigned long __RPC_FAR *AuthnSvc,
...
RPC_STATUS
RPC_ENTRY
RpcBindingSetAuthInfo(_In_ RPC_BINDING_HANDLE Binding,
...
typedef void(__RPC_USER *RPC_AUTH_KEY_RETRIEVAL_FN)(
    _In_ void __RPC_FAR *Arg, _In_ unsigned char __RPC_FAR *ServerPrincName,
    _In_ unsigned long KeyVer, _Out_ void __RPC_FAR * __RPC_FAR * Key,
    _Out_ RPC_STATUS __RPC_FAR *Status);

RPCRTAPI
RPC_STATUS
RPC_ENTRY
RpcServerRegisterAuthInfo(_In_ RPC_CSTR ServerPrincName,
                          _In_ unsigned long AuthnSvc,
...
RPCRTAPI
_Must_inspect_result_ RPC_STATUS RPC_ENTRY
RpcBindingServerFromClient(_In_opt_ RPC_BINDING_HANDLE ClientBinding,
...
RPCRTAPI
DECLSPEC_NORETURN
void RPC_ENTRY RpcRaiseException(_In_ RPC_STATUS exception);

RPCRTAPI
_Must_inspect_result_ RPC_STATUS RPC_ENTRY RpcTestCancel(void);
...
RPCRTAPI
_Must_inspect_result_ RPC_STATUS RPC_ENTRY
RpcServerTestCancel(_In_opt_ RPC_BINDING_HANDLE BindingHandle);

RPCRTAPI
_Must_inspect_result_ RPC_STATUS RPC_ENTRY RpcCancelThread(_In_ void *Thread);

RPCRTAPI
RPC_STATUS
RPC_ENTRY
RpcCancelThreadEx(_In_ void *Thread, _In_ long Timeout);
...
RPCRTAPI
_Must_inspect_result_ RPC_STATUS RPC_ENTRY
UuidCreate(_Out_ UUID __RPC_FAR *Uuid);

/* client/server */
RPCRTAPI
RPC_STATUS
RPC_ENTRY
UuidCreateSequential(_Out_ UUID __RPC_FAR *Uuid);

#ifdef RPC_UNICODE_SUPPORTED

/* client/server */
RPCRTAPI
_Must_inspect_result_ RPC_STATUS RPC_ENTRY UuidToStringA(
    _In_ const UUID __RPC_FAR *Uuid, _Outptr_ RPC_CSTR __RPC_FAR *StringUuid);

/* client/server */
RPCRTAPI
_Must_inspect_result_ RPC_STATUS RPC_ENTRY
UuidFromStringA(_In_opt_ RPC_CSTR StringUuid, _Out_ UUID __RPC_FAR *Uuid);

/* client/server */
RPCRTAPI
_Must_inspect_result_ RPC_STATUS RPC_ENTRY UuidToStringW(
    _In_ const UUID __RPC_FAR *Uuid, _Outptr_ RPC_WSTR __RPC_FAR *StringUuid);

/* client/server */
RPCRTAPI
_Must_inspect_result_ RPC_STATUS RPC_ENTRY
UuidFromStringW(_In_opt_ RPC_WSTR StringUuid, _Out_ UUID __RPC_FAR *Uuid);
...
RPC_STATUS
RPC_ENTRY
UuidToString(_In_ const UUID __RPC_FAR *Uuid,
...
RPC_STATUS
RPC_ENTRY
UuidFromString(_In_opt_ RPC_CSTR StringUuid, _Out_ UUID __RPC_FAR *Uuid);

#endif /* RPC_UNICODE_SUPPORTED */

RPCRTAPI
signed int RPC_ENTRY UuidCompare(_In_ UUID __RPC_FAR *Uuid1,
                                 _In_ UUID __RPC_FAR *Uuid2,
                                 _Out_ RPC_STATUS __RPC_FAR *Status);

RPCRTAPI
_Must_inspect_result_ RPC_STATUS RPC_ENTRY
UuidCreateNil(_Out_ UUID __RPC_FAR *NilUuid);

RPCRTAPI
int RPC_ENTRY UuidEqual(_In_ UUID __RPC_FAR *Uuid1, _In_ UUID __RPC_FAR *Uuid2,
                        _Out_ RPC_STATUS __RPC_FAR *Status);

RPCRTAPI
unsigned short RPC_ENTRY UuidHash(_In_ UUID __RPC_FAR *Uuid,
                                  _Out_ RPC_STATUS __RPC_FAR *Status);

RPCRTAPI
int RPC_ENTRY UuidIsNil(_In_ UUID __RPC_FAR *Uuid,
                        _Out_ RPC_STATUS __RPC_FAR *Status);
...
RPCRTAPI
_Must_inspect_result_ RPC_STATUS RPC_ENTRY RpcEpRegisterNoReplaceA(
    _In_ RPC_IF_HANDLE IfSpec, _In_ RPC_BINDING_VECTOR *BindingVector,
    _In_opt_ UUID_VECTOR *UuidVector, _In_opt_ RPC_CSTR Annotation);

RPCRTAPI
_Must_inspect_result_ RPC_STATUS RPC_ENTRY RpcEpRegisterNoReplaceW(
    _In_ RPC_IF_HANDLE IfSpec, _In_ RPC_BINDING_VECTOR *BindingVector,
    _In_opt_ UUID_VECTOR *UuidVector, _In_opt_ RPC_WSTR Annotation);

RPCRTAPI
_Must_inspect_result_ RPC_STATUS RPC_ENTRY RpcEpRegisterA(
    _In_ RPC_IF_HANDLE IfSpec, _In_ RPC_BINDING_VECTOR *BindingVector,
    _In_opt_ UUID_VECTOR *UuidVector, _In_opt_ RPC_CSTR Annotation);

RPCRTAPI
_Must_inspect_result_ RPC_STATUS RPC_ENTRY RpcEpRegisterW(
    _In_ RPC_IF_HANDLE IfSpec, _In_ RPC_BINDING_VECTOR *BindingVector,
    _In_opt_ UUID_VECTOR *UuidVector, _In_opt_ RPC_WSTR Annotation);
...
RPC_STATUS
RPC_ENTRY
RpcEpRegisterNoReplace(_In_ RPC_IF_HANDLE IfSpec,
...
RPC_STATUS
RPC_ENTRY
RpcEpRegister(_In_ RPC_IF_HANDLE IfSpec, _In_ RPC_BINDING_VECTOR *BindingVector,
              _In_opt_ UUID_VECTOR *UuidVector, _In_opt_ RPC_CSTR Annotation);

#endif /* RPC_UNICODE_SUPPORTED */

RPCRTAPI
_Must_inspect_result_ RPC_STATUS RPC_ENTRY RpcEpUnregister(
    _In_ RPC_IF_HANDLE IfSpec, _In_ RPC_BINDING_VECTOR *BindingVector,
    _In_opt_ UUID_VECTOR *UuidVector);
...
RPCRTAPI
_Must_inspect_result_ RPC_STATUS RPC_ENTRY
DceErrorInqTextA(_In_ RPC_STATUS RpcStatus,
                 _Out_writes_(DCE_C_ERROR_STRING_LEN) RPC_CSTR ErrorText);

RPCRTAPI
_Must_inspect_result_ RPC_STATUS RPC_ENTRY
DceErrorInqTextW(_In_ RPC_STATUS RpcStatus,
...
RPC_STATUS
RPC_ENTRY
DceErrorInqText(_In_ RPC_STATUS RpcStatus,
                _Out_writes_(DCE_C_ERROR_STRING_LEN) RPC_CSTR ErrorText);
...
RPCRTAPI
_Must_inspect_result_ RPC_STATUS RPC_ENTRY RpcMgmtEpEltInqBegin(
    _In_opt_ OPTIONAL RPC_BINDING_HANDLE EpBinding,
    _In_ unsigned long InquiryType, _In_opt_ RPC_IF_ID __RPC_FAR *IfId,
    _In_opt_ unsigned long VersOption, _In_opt_ UUID __RPC_FAR *ObjectUuid,
    _Out_ RPC_EP_INQ_HANDLE __RPC_FAR *InquiryContext);

RPCRTAPI
_Must_inspect_result_ RPC_STATUS RPC_ENTRY
RpcMgmtEpEltInqDone(_Inout_ RPC_EP_INQ_HANDLE __RPC_FAR *InquiryContext);

#ifdef RPC_UNICODE_SUPPORTED

RPCRTAPI
_Must_inspect_result_ RPC_STATUS RPC_ENTRY RpcMgmtEpEltInqNextA(
    _In_ RPC_EP_INQ_HANDLE InquiryContext, _Out_ RPC_IF_ID __RPC_FAR *IfId,
...
RPCRTAPI
_Must_inspect_result_ RPC_STATUS RPC_ENTRY RpcMgmtEpEltInqNextW(
    _In_ RPC_EP_INQ_HANDLE InquiryContext, _Out_ RPC_IF_ID __RPC_FAR *IfId,
    _Out_opt_ RPC_BINDING_HANDLE __RPC_FAR *Binding,
    _Out_opt_ UUID __RPC_FAR *ObjectUuid,
...
RPC_STATUS
RPC_ENTRY
RpcMgmtEpEltInqNext(_In_ RPC_EP_INQ_HANDLE InquiryContext,
...
RPCRTAPI
_Must_inspect_result_ RPC_STATUS RPC_ENTRY RpcMgmtEpUnregister(
    _In_opt_ RPC_BINDING_HANDLE EpBinding, _In_ RPC_IF_ID __RPC_FAR *IfId,
    _In_ RPC_BINDING_HANDLE Binding, _In_opt_ UUID __RPC_FAR *ObjectUuid);
...
RPCRTAPI
_Must_inspect_result_ RPC_STATUS RPC_ENTRY
RpcMgmtSetAuthorizationFn(_In_ RPC_MGMT_AUTHORIZATION_FN AuthorizationFn);
...
#if (NTDDI_VERSION >= NTDDI_VISTA)
RPCRTAPI
int RPC_ENTRY RpcExceptionFilter(_In_ unsigned long ExceptionCode);
#endif // (NTDDI_VERSION >= NTDDI_VISTA)
...
typedef void RPC_ENTRY RPC_INTERFACE_GROUP_IDLE_CALLBACK_FN(
    _In_ RPC_INTERFACE_GROUP IfGroup, _In_ void *IdleCallbackContext,
...
RpcServerInterfaceGroupCreateW(
    ...
    _In_ unsigned long NumEndpoints, _In_ unsigned long IdlePeriod,
    _In_ RPC_INTERFACE_GROUP_IDLE_CALLBACK_FN IdleCallbackFn,
    _In_ void *IdleCallbackContext, _Out_ PRPC_INTERFACE_GROUP IfGroup);
...
RPC_STATUS
RPC_ENTRY
RpcServerInterfaceGroupClose(_In_ RPC_INTERFACE_GROUP IfGroup);

RPCRTAPI
RPC_STATUS
RPC_ENTRY
RpcServerInterfaceGroupActivate(_In_ RPC_INTERFACE_GROUP IfGroup);

RPCRTAPI
RPC_STATUS
RPC_ENTRY
RpcServerInterfaceGroupDeactivate(_In_ RPC_INTERFACE_GROUP IfGroup,
                                  _In_ unsigned long ForceDeactivation);

RPCRTAPI
RPC_STATUS
RPC_ENTRY
RpcServerInterfaceGroupInqBindings(_In_ RPC_INTERFACE_GROUP IfGroup,
                                   _Outptr_ RPC_BINDING_VECTOR __RPC_FAR *
                                       __RPC_FAR * BindingVector);
