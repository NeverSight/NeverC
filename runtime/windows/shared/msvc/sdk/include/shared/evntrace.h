...
#define ETW_APP_DECLSPEC_DEPRECATED                                            \
  __declspec(deprecated(                                                       \
      "This API is not recommended for general usage in Windows Store Apps "   \
      "or Games and may not be supported in future versions of Windows"))
#else
#define ETW_APP_DECLSPEC_DEPRECATED
...
DEFINE_GUID(/* 68fdd900-4a3e-11d1-84f4-0000f80464e3 */
            EventTraceGuid, 0x68fdd900, 0x4a3e, 0x11d1, 0x84, 0xf4, 0x00, 0x00,
            0xf8, 0x04, 0x64, 0xe3);
...
DEFINE_GUID(/* 9e814aad-3204-11d2-9a82-006008a86939 */
            SystemTraceControlGuid, 0x9e814aad, 0x3204, 0x11d2, 0x9a, 0x82,
...
DEFINE_GUID(/* 01853a65-418f-4f36-aefc-dc0f1d2fd235 */
            EventTraceConfigGuid, 0x01853a65, 0x418f, 0x4f36, 0xae, 0xfc, 0xdc,
...
DEFINE_GUID(/* 0811c1af-7a07-4a06-82ed-869455cdf713 */
            DefaultTraceSecurityGuid, 0x0811c1af, 0x7a07, 0x4a06, 0x82, 0xed,
...
DEFINE_GUID(/* 3595ab5c-042a-4c8e-b942-2d059bfeb1b1 */
            PrivateLoggerNotificationGuid, 0x3595ab5c, 0x042a, 0x4c8e, 0xb9,
            0x42, 0x2d, 0x05, 0x9b, 0xfe, 0xb1, 0xb1);
...
DEFINE_GUID(/* fbd09363-9e22-4661-b8bf-e7a34b535b8c */
            SystemIoFilterProviderGuid, 0xfbd09363, 0x9e22, 0x4661, 0xb8, 0xbf,
            0xe7, 0xa3, 0x4b, 0x53, 0x5b, 0x8c);

DEFINE_GUID(/* febd7460-3d1d-47eb-af49-c9eeb1e146f2 */
            SystemObjectProviderGuid, 0xfebd7460, 0x3d1d, 0x47eb, 0xaf, 0x49,
            0xc9, 0xee, 0xb1, 0xe1, 0x46, 0xf2);

DEFINE_GUID(/* c134884a-32d5-4488-80e5-14ed7abb8269 */
            SystemPowerProviderGuid, 0xc134884a, 0x32d5, 0x4488, 0x80, 0xe5,
            0x14, 0xed, 0x7a, 0xbb, 0x82, 0x69);

DEFINE_GUID(/* bafa072a-918a-4bed-b622-bc152097098f */
            SystemHypervisorProviderGuid, 0xbafa072a, 0x918a, 0x4bed, 0xb6,
            0x22, 0xbc, 0x15, 0x20, 0x97, 0x9, 0x8f);

DEFINE_GUID(/* 721ddfd3-dacc-4e1e-b26a-a2cb31d4705a */
            SystemLockProviderGuid, 0x721ddfd3, 0xdacc, 0x4e1e, 0xb2, 0x6a,
            0xa2, 0xcb, 0x31, 0xd4, 0x70, 0x5a);

DEFINE_GUID(/* fef3a8b6-318d-4b67-a96a-3b0f6b8f18fe */
            SystemConfigProviderGuid, 0xfef3a8b6, 0x318d, 0x4b67, 0xa9, 0x6a,
            0x3b, 0xf, 0x6b, 0x8f, 0x18, 0xfe);

DEFINE_GUID(/* c6c5265f-eae8-4650-aae4-9d48603d8510 */
            SystemCpuProviderGuid, 0xc6c5265f, 0xeae8, 0x4650, 0xaa, 0xe4, 0x9d,
            0x48, 0x60, 0x3d, 0x85, 0x10);

DEFINE_GUID(/* 599a2a76-4d91-4910-9ac7-7d33f2e97a6c */
            SystemSchedulerProviderGuid, 0x599a2a76, 0x4d91, 0x4910, 0x9a, 0xc7,
            0x7d, 0x33, 0xf2, 0xe9, 0x7a, 0x6c);

DEFINE_GUID(/* bfeb0324-1cee-496f-a409-2ac2b48a6322 */
            SystemProfileProviderGuid, 0xbfeb0324, 0x1cee, 0x496f, 0xa4, 0x9,
            0x2a, 0xc2, 0xb4, 0x8a, 0x63, 0x22);

DEFINE_GUID(/* 3d5c43e3-0f1c-4202-b817-174c0070dc79 */
            SystemIoProviderGuid, 0x3d5c43e3, 0xf1c, 0x4202, 0xb8, 0x17, 0x17,
            0x4c, 0x0, 0x70, 0xdc, 0x79);

DEFINE_GUID(/* 82958ca9-b6cd-47f8-a3a8-03ae85a4bc24 */
            SystemMemoryProviderGuid, 0x82958ca9, 0xb6cd, 0x47f8, 0xa3, 0xa8,
            0x3, 0xae, 0x85, 0xa4, 0xbc, 0x24);

DEFINE_GUID(/* 16156bd9-fab4-4cfa-a232-89d1099058e3 */
            SystemRegistryProviderGuid, 0x16156bd9, 0xfab4, 0x4cfa, 0xa2, 0x32,
            0x89, 0xd1, 0x9, 0x90, 0x58, 0xe3);

DEFINE_GUID(/* 151f55dc-467d-471f-83b5-5f889d46ff66 */
            SystemProcessProviderGuid, 0x151f55dc, 0x467d, 0x471f, 0x83, 0xb5,
            0x5f, 0x88, 0x9d, 0x46, 0xff, 0x66);

DEFINE_GUID(/* fcb9baaf-e529-4980-92e9-ced1a6aadfdf */
            SystemAlpcProviderGuid, 0xfcb9baaf, 0xe529, 0x4980, 0x92, 0xe9,
            0xce, 0xd1, 0xa6, 0xaa, 0xdf, 0xdf);

DEFINE_GUID(/* 434286f7-6f1b-45bb-b37e-95f623046c7c */
            SystemSyscallProviderGuid, 0x434286f7, 0x6f1b, 0x45bb, 0xb3, 0x7e,
            0x95, 0xf6, 0x23, 0x04, 0x6c, 0x7c);

DEFINE_GUID(/* d4bbee17-b545-4888-858b-744169015b25 */
            SystemInterruptProviderGuid, 0xd4bbee17, 0xb545, 0x4888, 0x85, 0x8b,
            0x74, 0x41, 0x69, 0x01, 0x5b, 0x25);

DEFINE_GUID(/* 4f061568-e215-499f-ab2e-eda0ae890a5b */
            SystemTimerProviderGuid, 0x4f061568, 0xe215, 0x499f, 0xab, 0x2e,
            0xed, 0xa0, 0xae, 0x89, 0x0a, 0x5b);

DEFINE_GUID(/* 99134383-5248-43fc-834b-529454e75df3 */
            LastBranchRecordProviderGuid, 0x99134383, 0x5248, 0x43fc, 0x83,
            0x4b, 0x52, 0x94, 0x54, 0xe7, 0x5d, 0xf3);
...
#define EVENT_TRACE_TYPE_REGSETSECURITY                                        \
  0x1C // SetSecurityDescriptor (KeyObject)
#define EVENT_TRACE_TYPE_REGQUERYSECURITY                                      \
  0x1D // QuerySecurityDescriptor (KeyObject)
#define EVENT_TRACE_TYPE_REGCOMMIT                                             \
  0x1E // CmKtmNotification (TRANSACTION_NOTIFY_COMMIT)
#define EVENT_TRACE_TYPE_REGPREPARE                                            \
  0x1F // CmKtmNotification (TRANSACTION_NOTIFY_PREPARE)
#define EVENT_TRACE_TYPE_REGROLLBACK                                           \
  0x20 // CmKtmNotification (TRANSACTION_NOTIFY_ROLLBACK)
#define EVENT_TRACE_TYPE_REGMOUNTHIVE                                          \
  0x21 // NtLoadKey variations + system hives
...
#define EVENT_TRACE_TYPE_CONFIG_PHYSICALDISK_EX                                \
  0x13 // Physical Disk Extended Configuration

#define EVENT_TRACE_TYPE_CONFIG_IRQ 0x15 // IRQ assigned to devices
#define EVENT_TRACE_TYPE_CONFIG_PNP 0x16 // PnP device info
#define EVENT_TRACE_TYPE_CONFIG_IDECHANNEL                                     \
  0x17 // Primary/Secondary IDE channel Configuration
...
#define EVENT_TRACE_TYPE_CONFIG_PROCESSORGROUP                                 \
  0x1A // Processor Group Configuration
#define EVENT_TRACE_TYPE_CONFIG_PROCESSORNUMBER                                \
  0x1B                                   // ProcessorIndex -> ProcNumber mapping
#define EVENT_TRACE_TYPE_CONFIG_DPI 0x1C // Display DPI Configuration
#define EVENT_TRACE_TYPE_CONFIG_CI_INFO                                        \
  0x1D // Display System Code Integrity Information
#define EVENT_TRACE_TYPE_CONFIG_MACHINEID 0x1E // SQM Machine Id
#define EVENT_TRACE_TYPE_CONFIG_DEFRAG                                         \
  0x1F // Logical Disk Defragmenter Information
#define EVENT_TRACE_TYPE_CONFIG_MOBILEPLATFORM                                 \
  0x20 // Mobile Platform Configuration
...
#define EVENT_TRACE_TYPE_CONFIG_VIRTUALIZATION                                 \
  0x24                                    // virtualization config info
...
#define EVENT_TRACE_TYPE_FLT_PREOP_COMPLETION                                  \
  0x62 // Minifilter preop completion
#define EVENT_TRACE_TYPE_FLT_POSTOP_COMPLETION                                 \
  0x63                                           // Minifilter postop completion
...
#define EVENT_TRACE_FLAG_DEBUG_EVENTS                                          \
  0x00400000 // debugger events (break/continue/...)
...
#define EVENT_TRACE_NONSTOPPABLE_MODE                                          \
  0x00000040 // Session cannot be stopped (Autologger only)
#define EVENT_TRACE_SECURE_MODE 0x00000080 // Secure session
#define EVENT_TRACE_USE_KBYTES_FOR_SIZE                                        \
  0x00002000                                   // Use KBytes as file size unit
#define EVENT_TRACE_PRIVATE_IN_PROC 0x00020000 // In process private logger

#define EVENT_TRACE_MODE_RESERVED                                              \
  0x00100000 // Reserved bit, used to signal Heap/Critsec tracing

//
// Logger Mode flags on Win7 and above
//

#define EVENT_TRACE_NO_PER_PROCESSOR_BUFFERING                                 \
  0x10000000 // Use this for low frequency sessions.

//
// Logger Mode flags on Win8 and above
//

#define EVENT_TRACE_SYSTEM_LOGGER_MODE                                         \
  0x02000000 // Receive events from SystemTraceProvider
#define EVENT_TRACE_ADDTO_TRIAGE_DUMP                                          \
  0x80000000 // Add ETW buffers to triage dumps
#define EVENT_TRACE_STOP_ON_HYBRID_SHUTDOWN                                    \
  0x00400000 // Stop on hybrid shutdown
#define EVENT_TRACE_PERSIST_ON_HYBRID_SHUTDOWN                                 \
  0x00800000 // Persist on hybrid shutdown
...
#define EVENT_TRACE_INDEPENDENT_SESSION_MODE                                   \
  0x08000000 // Independent logger session
...
#define EVENT_TRACE_CONTROL_INCREMENT_FILE                                     \
  4 // Causes a session with EVENT_TRACE_FILE_MODE_NEWFILE
...
#define EVENT_TRACE_CONTROL_CONVERT_TO_REALTIME                                \
  5 // Transitions from file mode tracing to real-time.

//
// Flags used by WMI Trace Message
// Note that the order or value of these flags should NOT be changed as they are
...
#define TRACE_MESSAGE_PERFORMANCE_TIMESTAMP                                    \
  16 // *Obsolete* Clock type is controlled by the logger
#define TRACE_MESSAGE_SYSTEMINFO                                               \
  32 // Message includes system information TID,PID
...
#pragma warning(                                                               \
    disable                                                                    \
    : 4214) /* nonstandard extension used : bit field other than int */
...
typedef enum TRACE_LBR_CONFIGURATION {
  ...
  TRACE_LBR_CONFIGURATION_EXCLUDE_KERNEL =
      0x1, // exclude branches in kernel privilege
  TRACE_LBR_CONFIGURATION_EXCLUDE_USER =
      0x2, // exclude branches in user privilege
  TRACE_LBR_CONFIGURATION_EXCLUDE_JCC = 0x4, // exclude conditional branches
  TRACE_LBR_CONFIGURATION_EXCLUDE_NEAR_REL_CALL =
      0x8, // exclude near relative calls
  TRACE_LBR_CONFIGURATION_EXCLUDE_NEAR_IND_CALL =
      0x10, // exclude near indirect calls
  TRACE_LBR_CONFIGURATION_EXCLUDE_NEAR_RET = 0x20, // exclude near returns
  TRACE_LBR_CONFIGURATION_EXCLUDE_NEAR_IND_JMP =
      0x40, // exclude near indirect jumps
  TRACE_LBR_CONFIGURATION_EXCLUDE_NEAR_REL_JMP =
      0x80, // exclude near relative jumps
  TRACE_LBR_CONFIGURATION_EXCLUDE_FAR_BRANCH =
      0x100, // exclude far ("other") branches
  TRACE_LBR_CONFIGURATION_CALLSTACK_ENABLE =
      0x200, // record branches in callstack (LIFO) mode
  TRACE_LBR_CONFIGURATION_SAMPLED =
      0x400, // record sample-based LBR (ARM64 only)
...
typedef struct ETW_BUFFER_HEADER {
  ...
  ULONG Reserved3;
  ULONG FilledBytes; // Number of bytes written to the buffer.  Essentially the
...
typedef VOID(WINAPI *PETW_BUFFER_COMPLETION_CALLBACK)(
    _In_ const ETW_BUFFER_HEADER *Buffer, _In_opt_ void *CallbackContext);
...
typedef ULONG(
    ...
    WINAPI
#endif
        *WMIDPREQUEST)(_In_ WMIDPREQUESTCODE RequestCode,
                       _In_ PVOID RequestContext, _Inout_ ULONG *BufferSize,
...
ULONG
WMIAPI
StartTraceW(_Out_ CONTROLTRACE_ID *TraceId, _In_ LPCWSTR InstanceName,
...
ULONG
WMIAPI
StartTraceA(_Out_ CONTROLTRACE_ID *TraceId, _In_ LPCSTR InstanceName,
            _Inout_ PEVENT_TRACE_PROPERTIES Properties);
...
ULONG
WMIAPI
StopTraceW(_In_ CONTROLTRACE_ID TraceId, _In_opt_ LPCWSTR InstanceName,
           _Inout_ PEVENT_TRACE_PROPERTIES Properties);
...
ULONG
WMIAPI
StopTraceA(_In_ CONTROLTRACE_ID TraceId, _In_opt_ LPCSTR InstanceName,
           _Inout_ PEVENT_TRACE_PROPERTIES Properties);
...
ULONG
WMIAPI
QueryTraceW(_In_ CONTROLTRACE_ID TraceId, _In_opt_ LPCWSTR InstanceName,
            _Inout_ PEVENT_TRACE_PROPERTIES Properties);
...
ULONG
WMIAPI
QueryTraceA(_In_ CONTROLTRACE_ID TraceId, _In_opt_ LPCSTR InstanceName,
            _Inout_ PEVENT_TRACE_PROPERTIES Properties);
...
ULONG
WMIAPI
UpdateTraceW(_In_ CONTROLTRACE_ID TraceId, _In_opt_ LPCWSTR InstanceName,
             _Inout_ PEVENT_TRACE_PROPERTIES Properties);

EXTERN_C
ULONG
WMIAPI
UpdateTraceA(_In_ CONTROLTRACE_ID TraceId, _In_opt_ LPCSTR InstanceName,
             _Inout_ PEVENT_TRACE_PROPERTIES Properties);
...
ULONG
WMIAPI
FlushTraceW(_In_ CONTROLTRACE_ID TraceId, _In_opt_ LPCWSTR InstanceName,
            _Inout_ PEVENT_TRACE_PROPERTIES Properties);
#endif
...
ULONG
WMIAPI
FlushTraceA(_In_ CONTROLTRACE_ID TraceId, _In_opt_ LPCSTR InstanceName,
            _Inout_ PEVENT_TRACE_PROPERTIES Properties);
#endif
...
ULONG
WMIAPI
ControlTraceW(_In_ CONTROLTRACE_ID TraceId, _In_opt_ LPCWSTR InstanceName,
              _Inout_ PEVENT_TRACE_PROPERTIES Properties,
...
ULONG
WMIAPI
ControlTraceA(_In_ CONTROLTRACE_ID TraceId, _In_opt_ LPCSTR InstanceName,
              _Inout_ PEVENT_TRACE_PROPERTIES Properties,
              _In_ ULONG ControlCode);
...
ULONG
WMIAPI
QueryAllTracesW(_Out_writes_(PropertyArrayCount)
                    PEVENT_TRACE_PROPERTIES *PropertyArray,
                _In_ ULONG PropertyArrayCount, _Out_ PULONG LoggerCount);

EXTERN_C
ULONG
WMIAPI
QueryAllTracesA(_Out_writes_(PropertyArrayCount)
                    PEVENT_TRACE_PROPERTIES *PropertyArray,
                _In_ ULONG PropertyArrayCount, _Out_ PULONG LoggerCount);
...
ULONG
WMIAPI
EnableTrace(_In_ ULONG Enable, _In_ ULONG EnableFlag, _In_ ULONG EnableLevel,
            _In_ LPCGUID ControlGuid, _In_ CONTROLTRACE_ID TraceId);
...
ULONG
WMIAPI
EnableTraceEx(_In_ LPCGUID ProviderId, _In_opt_ LPCGUID SourceId,
              _In_ CONTROLTRACE_ID TraceId, _In_ ULONG IsEnabled,
              _In_ UCHAR Level, _In_ ULONGLONG MatchAnyKeyword,
              _In_ ULONGLONG MatchAllKeyword, _In_ ULONG EnableProperty,
...
ULONG
WMIAPI
EnableTraceEx2(_In_ CONTROLTRACE_ID TraceId, _In_ LPCGUID ProviderId,
               _In_ ULONG ControlCode, _In_ UCHAR Level,
...
// ETW query/set APIs: EnumerateTraceGuidsEx, TraceSetInformation,
...
typedef enum _TRACE_QUERY_INFO_CLASS {
  ...
  //      Returns a list of provider GUIDs that are currently registered with
  //      the kernel.
  ...
  // TraceGuidQueryList:
  // - EnumerateTraceGuidsEx.
  //      Returns the current registration and enablement information for the
  //      input GUID.
  //
  //      Input Format: GUID
  //      Output Format: TRACE_GUID_INFO followed by
  //      TRACE_GUID_INFO.InstanceCount
  //                     TRACE_PROVIDER_INSTANCE_INFO structs, each bundled with
  //                     TRACE_PROVIDER_INSTANCE_INFO.EnableCount
  //                     TRACE_ENABLE_INFO.
  //                For example, a GUID with two provider registrations, the
  //                first enabled
  //                  by two loggers and the second by three loggers would look
  //                  like:
  //                  {
  ...
  // - EnumerateTraceGuidsEx.
  //      Returns a list of provider GUIDs that are registered in the current
  //      process.
  //      Note: This is not the same thing as having an installed manifest.
  //
  //      Input Format: None.
  ...
  // - TraceSetInformation.
  //      Turns on stack trace collection for the specified kernel events for
  //      the specified logger.
  //      It also turns off stack tracing for all kernel events not on this
  //      list, regardless of prior status.
  //
  ...
  //
  // - TraceQueryInformation
  //      Queries the current Group Mask state for the specified logging
  //      session.
  //
  ...
  // - TraceSetInformation
  //      Updates the list of kernel events for which PMC counters will be
  //      collected
  //      for the specified logger.  This can only be set once per logger and
  //      cannot
  //      be updated.
  ...
  // TraceGroupQueryInfo:
  // - EnumerateTraceGuidsEx.
  //      Returns the current enablement information and list of member
  //      providers
  //      for the input Group GUID.
  //
  //      Input Format: GUID
  //      Output Format:  a) ULONG - Length of the following TRACE_ENABLE_INFO
  //      array.
  //                      b) Array of TRACE_ENABLE_INFO. Size of the array is
  //                      inferred from (a)
  //                      c) ULONG - Count of the Number of Unique Providers
  //                      that belong to this Group
  //                      d) Array of GUID - Size of the array is specified by
  //                      (c)
  //
  //                  PseudoStructure -
  ...
  //                          TRACE_ENABLE_INFO
  //                          TraceEnableInfos[TraceEnableInfoSize];
  //                          ULONG GuidArraySize;
  ...
  //      If a NULL input buffer is specified, then the current periodic capture
  //      state
  //      settings are cleared.
  //
  //      Input Format: TRACE_PERIODIC_CAPTURE_STATE_INFO followed by an array
  //      of ProviderCount
  ...
  // - TraceQueryInformation
  //      Queries the limits of periodic capture settings on this system,
  //      including
  //      the minimum time frequency and the maximum number of providers that
  //      can be
  ...
  // - TraceSetInformation
  //      Instructs ETW to begin tracking binaries for all providers that are
  //      enabled
  //      to the session. The tracking applies retroactively for providers that
  //      were
  //      enabled to the session prior to the call, as well as for all future
  //      providers
  //      that are enabled to the session.
  //
  //      ETW fabricates tracking events for these tracked providers that
  //      contain a
  //      mapping between provider GUID(s). ETW also fabricates the file path
  //      that describes
  //      where the registered provider is located on disk. If the session is in
  //      realtime,
  //      the events are provided live in the realtime buffers. If the session
  //      is file-based
  //      (i.e. trace is saved to an .etl file), the events are aggregated and
  //      written to the
  //      file header; they will be among some of the first events the ETW
  //      runtime provides
  //      when the .etl file is played back.
  //
  //      The binary tracking events will come from the EventTraceGuid provider,
  //      with an opcode
  ...
  // - TraceQueryInformation
  //      Queries the maximum number of system-wide loggers that can be running
  //      at a time
  //      on this system.
  //      Does not use the TraceId parameter.
  //
  ...
  // - TraceSetInformation
  //      Sets a bitfield of configuration options for Last Branch Record
  //      tracing.
  //
  //      Input Format: ULONG
  //
  ...
  //      Expects 0 for the TraceId parameter.
  //
  //      Input Format: ETW_PMC_COUNTER_OWNERSHIP_STATUS with ProcessorNumber
  //      set to an
  //                    appropriate processor index. The input buffer must be of
  //                    size at least
  //                    RTL_SIZEOF_THROUGH_FIELD(ETW_PMC_COUNTER_OWNERSHIP_STATUS,
  //                    NumberOfCounters) +
  //                    (sizeof(ETW_PMC_COUNTER_OWNER) * EtwMaxPmcCounters),
  //                    where EtwMaxPmcCounters
  //                    is the result of a
  //                    TraceQueryInformation(TraceMaxPmcCounterQuery, ...)
  //                    operation.
  //
  //      Output Format: ETW_PMC_COUNTER_OWNERSHIP_STATUS with CounterOwners
  //      filled out. NumberOfCounters is
  //                     set to the number of items in the CounterOwners array.
  //                     If a counter owner's OwnershipType is
  //                     EtwPmcOwnerTagged, then OwnerTag contains
  ...
  //      Expects 0 for the TraceId parameter.
  //
  //      Output Format: The supplied output buffer will be set to a blob of
  //      filled out ETW_PMC_SESSION_INFO.
  //                     The NextEntryOffset member of each item will be set to
  //                     the offset from the start of
  //                     the current item to the next item, or 0 if there are no
  //                     more items.
  //                     The ProfileSourceCount and HookId count members will be
  //                     set to the number of items that
  //                     exist in the ProfileSources array and HookIds arrays,
  //                     respectively.
  //
  ...
  // - TraceSetInformation.
  //      Turns on context register tracing for the specified System Trace
  //      Provider events for the specified logger.
  //      It also turns off context register tracing for all kernel events not
  //      on this list, regardless of prior status.
  //
  //      Input Format: A TRACE_CONTEXT_REGISTER_INFO structure, followed by an
  //      array of up to
  //                    ETW_MAX_CONTEXT_REGISTER_EVENTS number of
  //                    CLASSIC_EVENT_ID structures.
  //
...
ULONG
WMIAPI
EnumerateTraceGuidsEx(_In_ TRACE_QUERY_INFO_CLASS TraceQueryInfoClass,
                      _In_reads_bytes_opt_(InBufferSize) PVOID InBuffer,
                      _In_ ULONG InBufferSize,
                      _Out_writes_bytes_opt_(OutBufferSize) PVOID OutBuffer,
                      _In_ ULONG OutBufferSize, _Out_ PULONG ReturnLength);
#endif
...
ULONG
WMIAPI
TraceSetInformation(_In_ CONTROLTRACE_ID TraceId,
...
ULONG
WMIAPI
TraceQueryInformation(_In_ CONTROLTRACE_ID TraceId,
                      _In_ TRACE_INFO_CLASS InformationClass,
...
EXTERN_C
_Success_(return == ERROR_SUCCESS) ULONG TraceConfigureLastBranchRecord(
    _In_ CONTROLTRACE_ID TraceId, _In_ TRACE_LBR_CONFIGURATION LbrConfiguration,
...
ULONG
WMIAPI
CreateTraceInstanceId(_In_ HANDLE RegHandle,
...
ULONG
WMIAPI
TraceEvent(_In_ TRACELOGGER_HANDLE TraceHandle,
...
ULONG
WMIAPI
TraceEventInstance(_In_ TRACELOGGER_HANDLE TraceHandle,
...
ULONG
WMIAPI
RegisterTraceGuidsW(_In_ WMIDPREQUEST RequestAddress,
                    _In_opt_ PVOID RequestContext, _In_ LPCGUID ControlGuid,
                    _In_ ULONG GuidCount,
                    _In_reads_opt_(GuidCount)
...
ULONG
WMIAPI
RegisterTraceGuidsA(_In_ WMIDPREQUEST RequestAddress,
                    _In_opt_ PVOID RequestContext, _In_ LPCGUID ControlGuid,
                    _In_ ULONG GuidCount,
                    _In_reads_opt_(GuidCount)
                        PTRACE_GUID_REGISTRATION TraceGuidReg,
...
ULONG
WMIAPI
EnumerateTraceGuids(_Inout_updates_(PropertyArrayCount)
                        PTRACE_GUID_PROPERTIES *GuidPropertiesArray,
                    _In_ ULONG PropertyArrayCount, _Out_ PULONG GuidCount);
#endif
...
ULONG
WMIAPI
UnregisterTraceGuids(_In_ TRACEGUID_HANDLE RegistrationHandle);

EXTERN_C
TRACELOGGER_HANDLE
WMIAPI
GetTraceLoggerHandle(_In_ PVOID Buffer);

EXTERN_C
UCHAR
WMIAPI
GetTraceEnableLevel(_In_ TRACELOGGER_HANDLE TraceHandle);

EXTERN_C
ULONG
WMIAPI
GetTraceEnableFlags(_In_ TRACELOGGER_HANDLE TraceHandle);
...
ULONG
WMIAPI
ProcessTrace(_In_reads_(HandleCount) PROCESSTRACE_HANDLE *HandleArray,
             _In_ ULONG HandleCount, _In_opt_ LPFILETIME StartTime,
...
ULONG
WMIAPI
CloseTrace(_In_ PROCESSTRACE_HANDLE TraceHandle);

EXTERN_C
ETW_APP_DECLSPEC_DEPRECATED
_Success_(return != INVALID_PROCESSTRACE_HANDLE) PROCESSTRACE_HANDLE WMIAPI
    OpenTraceFromBufferStream(_In_ const ETW_OPEN_TRACE_OPTIONS *Options,
                              _In_ PETW_BUFFER_COMPLETION_CALLBACK
...
ETW_APP_DECLSPEC_DEPRECATED
_Success_(return != INVALID_PROCESSTRACE_HANDLE) PROCESSTRACE_HANDLE WMIAPI
    OpenTraceFromRealTimeLogger(_In_ PCWSTR LoggerName,
...
_Success_(return != INVALID_PROCESSTRACE_HANDLE) PROCESSTRACE_HANDLE WMIAPI
    OpenTraceFromRealTimeLoggerWithAllocationOptions(
        _In_ PCWSTR LoggerName, _In_ const ETW_OPEN_TRACE_OPTIONS *Options,
        _In_ ULONG_PTR AllocationSize, _In_opt_ HANDLE MemoryPartitionHandle,
        _Out_opt_ TRACE_LOGFILE_HEADER *LogFileHeader);

EXTERN_C
ETW_APP_DECLSPEC_DEPRECATED
_Success_(return != INVALID_PROCESSTRACE_HANDLE) PROCESSTRACE_HANDLE WMIAPI
    OpenTraceFromFile(_In_ PCWSTR LogFileName,
                      _In_ const ETW_OPEN_TRACE_OPTIONS *Options,
                      _Out_opt_ TRACE_LOGFILE_HEADER *LogFileHeader);

EXTERN_C
ETW_APP_DECLSPEC_DEPRECATED
_Success_(return == ERROR_SUCCESS) ULONG WMIAPI
    ProcessTraceBufferIncrementReference(_In_ PROCESSTRACE_HANDLE TraceHandle,
                                         _In_ const ETW_BUFFER_HEADER *Buffer);

EXTERN_C
ETW_APP_DECLSPEC_DEPRECATED
_Success_(return == ERROR_SUCCESS) ULONG WMIAPI
    ProcessTraceBufferDecrementReference(_In_ const ETW_BUFFER_HEADER *Buffer);

EXTERN_C
ETW_APP_DECLSPEC_DEPRECATED
_Success_(return == ERROR_SUCCESS) ULONG WMIAPI
    ProcessTraceAddBufferToBufferStream(_In_ PROCESSTRACE_HANDLE TraceHandle,
...
ULONG
WMIAPI
QueryTraceProcessingHandle(_In_ PROCESSTRACE_HANDLE ProcessingHandle,
                           _In_ ETW_PROCESS_HANDLE_INFO_TYPE InformationClass,
                           _In_opt_ PVOID InBuffer, _In_ ULONG InBufferSize,
                           _Out_opt_ PVOID OutBuffer, _In_ ULONG OutBufferSize,
...
PROCESSTRACE_HANDLE
WMIAPI
OpenTraceA(_Inout_ PEVENT_TRACE_LOGFILEA Logfile);

EXTERN_C
ULONG
WMIAPI
SetTraceCallback(_In_ LPCGUID pGuid, _In_ PEVENT_CALLBACK EventCallback);

EXTERN_C
ULONG
WMIAPI
RemoveTraceCallback(_In_ LPCGUID pGuid);
...
EXTERN_C
ULONG
__cdecl TraceMessage(_In_ TRACELOGGER_HANDLE LoggerHandle,
                     _In_ ULONG MessageFlags, _In_ LPCGUID MessageGuid,
...
EXTERN_C
ULONG
TraceMessageVa(_In_ TRACELOGGER_HANDLE LoggerHandle, _In_ ULONG MessageFlags,
               _In_ LPCGUID MessageGuid, _In_ USHORT MessageNumber,
