...
HRESULT WINAPI CreateDXGIFactory2(UINT Flags, REFIID riid,
                                  _COM_Outptr_ void **ppFactory);
HRESULT WINAPI DXGIGetDebugInterface1(UINT Flags, REFIID riid,
...
typedef struct IDXGIDevice3Vtbl {
  ...
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(IDXGIDevice3 *This,
                                             /* [in] */ REFIID riid,
  ...
  HRESULT(STDMETHODCALLTYPE *SetPrivateData)(IDXGIDevice3 *This,
                                             /* [annotation][in] */
                                             _In_ REFGUID Name,
                                             /* [in] */ UINT DataSize,
                                             /* [annotation][in] */
  ...
  HRESULT(STDMETHODCALLTYPE *GetParent)(IDXGIDevice3 *This,
                                        /* [annotation][in] */
                                        _In_ REFIID riid,
...
interface IDXGIDevice3 { CONST_VTBL struct IDXGIDevice3Vtbl *lpVtbl; };
...
#define IDXGIDevice3_CreateSurface(This, pDesc, NumSurfaces, Usage,            \
                                   pSharedResource, ppSurface)                 \
  ((This)->lpVtbl->CreateSurface(This, pDesc, NumSurfaces, Usage,              \
                                 pSharedResource, ppSurface))

#define IDXGIDevice3_QueryResourceResidency(This, ppResources,                 \
...
#define IDXGIDevice3_ReclaimResources(This, NumResources, ppResources,         \
                                      pDiscarded)                              \
  ((This)->lpVtbl->ReclaimResources(This, NumResources, ppResources,           \
                                    pDiscarded))
...
typedef struct IDXGISwapChain2Vtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(IDXGISwapChain2 *This,
                                             /* [in] */ REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);
  ...
  HRESULT(STDMETHODCALLTYPE *SetMatrixTransform)(
      IDXGISwapChain2 *This, const DXGI_MATRIX_3X2_F *pMatrix);
...
interface IDXGISwapChain2 { CONST_VTBL struct IDXGISwapChain2Vtbl *lpVtbl; };
...
#define IDXGISwapChain2_ResizeBuffers(This, BufferCount, Width, Height,        \
...
#define IDXGISwapChain2_Present1(This, SyncInterval, PresentFlags,             \
                                 pPresentParameters)                           \
  ((This)->lpVtbl->Present1(This, SyncInterval, PresentFlags,                  \
                            pPresentParameters))
...
typedef struct IDXGIOutput2Vtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(IDXGIOutput2 *This,
                                             /* [in] */ REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);
  ...
  DECLSPEC_XFGVIRT(IDXGIObject, SetPrivateData)
  HRESULT(STDMETHODCALLTYPE *SetPrivateData)(IDXGIOutput2 *This,
                                             /* [annotation][in] */
                                             _In_ REFGUID Name,
                                             /* [in] */ UINT DataSize,
                                             /* [annotation][in] */
  ...
  DECLSPEC_XFGVIRT(IDXGIObject, GetParent)
  HRESULT(STDMETHODCALLTYPE *GetParent)(IDXGIOutput2 *This,
                                        /* [annotation][in] */
                                        _In_ REFIID riid,
                                        /* [annotation][retval][out] */
                                        _COM_Outptr_ void **ppParent);
  ...
  HRESULT(STDMETHODCALLTYPE *GetGammaControl)(IDXGIOutput2 *This,
                                              /* [annotation][out] */
...
interface IDXGIOutput2 { CONST_VTBL struct IDXGIOutput2Vtbl *lpVtbl; };
...
#define IDXGIOutput2_GetDisplayModeList(This, EnumFormat, Flags, pNumModes,    \
                                        pDesc)                                 \
  ((This)->lpVtbl->GetDisplayModeList(This, EnumFormat, Flags, pNumModes,      \
                                      pDesc))

#define IDXGIOutput2_FindClosestMatchingMode(This, pModeToMatch,               \
...
#define IDXGIOutput2_GetDisplayModeList1(This, EnumFormat, Flags, pNumModes,   \
                                         pDesc)                                \
  ((This)->lpVtbl->GetDisplayModeList1(This, EnumFormat, Flags, pNumModes,     \
                                       pDesc))

#define IDXGIOutput2_FindClosestMatchingMode1(This, pModeToMatch,              \
                                              pClosestMatch, pConcernedDevice) \
...
typedef struct IDXGIFactory3Vtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(IDXGIFactory3 *This,
                                             /* [in] */ REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);
...
interface IDXGIFactory3 { CONST_VTBL struct IDXGIFactory3Vtbl *lpVtbl; };
...
public:
  virtual HRESULT STDMETHODCALLTYPE PresentBuffer(
      UINT BufferToPresent, UINT SyncInterval, UINT Flags) = 0;

  virtual HRESULT STDMETHODCALLTYPE SetSourceRect(const RECT *pRect) = 0;

  virtual HRESULT STDMETHODCALLTYPE SetTargetRect(const RECT *pRect) = 0;
...
#define IDXGIDecodeSwapChain_PresentBuffer(This, BufferToPresent,              \
                                           SyncInterval, Flags)                \
...
typedef struct IDXGIFactoryMediaVtbl {
  ...
  DECLSPEC_XFGVIRT(IDXGIFactoryMedia,
...
#define IDXGIFactoryMedia_CreateDecodeSwapChainForCompositionSurfaceHandle(    \
    This, pDevice, hSurface, pDesc, pYuvDecodeBuffers, pRestrictToOutput,      \
    ppSwapChain)                                                               \
...
typedef struct IDXGISwapChainMediaVtbl {
  ...
  HRESULT(STDMETHODCALLTYPE *CheckPresentDurationSupport)(
      IDXGISwapChainMedia *This, UINT DesiredPresentDuration,
      /* [annotation][out] */
      _Out_ UINT *pClosestSmallerPresentDuration,
      /* [annotation][out] */
...
#define IDXGISwapChainMedia_CheckPresentDurationSupport(                       \
    This, DesiredPresentDuration, pClosestSmallerPresentDuration,              \
    pClosestLargerPresentDuration)                                             \
  ((This)->lpVtbl->CheckPresentDurationSupport(This, DesiredPresentDuration,   \
...
typedef struct IDXGIOutput3Vtbl {
  ...
  DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(IDXGIOutput3 *This,
                                             /* [in] */ REFIID riid,
                                             /* [annotation][iid_is][out] */
                                             _COM_Outptr_ void **ppvObject);
  ...
  DECLSPEC_XFGVIRT(IDXGIObject, SetPrivateData)
  HRESULT(STDMETHODCALLTYPE *SetPrivateData)(IDXGIOutput3 *This,
                                             /* [annotation][in] */
                                             _In_ REFGUID Name,
                                             /* [in] */ UINT DataSize,
                                             /* [annotation][in] */
  ...
  DECLSPEC_XFGVIRT(IDXGIObject, GetParent)
  HRESULT(STDMETHODCALLTYPE *GetParent)(IDXGIOutput3 *This,
                                        /* [annotation][in] */
                                        _In_ REFIID riid,
                                        /* [annotation][retval][out] */
                                        _COM_Outptr_ void **ppParent);
  ...
  DECLSPEC_XFGVIRT(IDXGIOutput, GetGammaControl)
  HRESULT(STDMETHODCALLTYPE *GetGammaControl)(IDXGIOutput3 *This,
                                              /* [annotation][out] */
                                              _Out_ DXGI_GAMMA_CONTROL *pArray);
...
interface IDXGIOutput3 { CONST_VTBL struct IDXGIOutput3Vtbl *lpVtbl; };
...
#define IDXGIOutput3_GetDisplayModeList(This, EnumFormat, Flags, pNumModes,    \
                                        pDesc)                                 \
  ((This)->lpVtbl->GetDisplayModeList(This, EnumFormat, Flags, pNumModes,      \
                                      pDesc))

#define IDXGIOutput3_FindClosestMatchingMode(This, pModeToMatch,               \
                                             pClosestMatch, pConcernedDevice)  \
  ((This)->lpVtbl->FindClosestMatchingMode(This, pModeToMatch, pClosestMatch,  \
                                           pConcernedDevice))
...
#define IDXGIOutput3_GetDisplayModeList1(This, EnumFormat, Flags, pNumModes,   \
                                         pDesc)                                \
  ((This)->lpVtbl->GetDisplayModeList1(This, EnumFormat, Flags, pNumModes,     \
                                       pDesc))

#define IDXGIOutput3_FindClosestMatchingMode1(This, pModeToMatch,              \
                                              pClosestMatch, pConcernedDevice) \
  ((This)->lpVtbl->FindClosestMatchingMode1(This, pModeToMatch, pClosestMatch, \
                                            pConcernedDevice))
...
#define IDXGIOutput3_CheckOverlaySupport(This, EnumFormat, pConcernedDevice,   \
                                         pFlags)                               \
