...
#define IOCTL_EHSTOR_BANDMGMT_QUERY_CAPABILITIES                               \
  CTL_CODE(IOCTL_STORAGE_BASE, 0x520, METHOD_BUFFERED, FILE_ANY_ACCESS)
...
#define IOCTL_EHSTOR_BANDMGMT_ENUMERATE_BANDS                                  \
  CTL_CODE(IOCTL_STORAGE_BASE, 0x523, METHOD_BUFFERED, FILE_ANY_ACCESS)
...
#define IOCTL_EHSTOR_BANDMGMT_GET_BAND_METADATA                                \
  CTL_CODE(IOCTL_STORAGE_BASE, 0x527, METHOD_BUFFERED, FILE_ANY_ACCESS)
