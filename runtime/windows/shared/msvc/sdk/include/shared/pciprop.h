...
#define DEFINE_PCI_ROOT_BUS_DEVPKEY(_DevPkeyName, _Pid)                        \
  DEFINE_DEVPROPKEY((_DevPkeyName), 0xd817fc28, 0x793e, 0x4b9e, 0x99, 0x70,    \
                    0x46, 0x9d, 0x8b, 0xe6, 0x30, 0x73, (_Pid))
...
DEFINE_PCI_ROOT_BUS_DEVPKEY(DEVPKEY_PciRootBus_SecondaryInterface,
...
DEFINE_PCI_ROOT_BUS_DEVPKEY(DEVPKEY_PciRootBus_CurrentSpeedAndMode,
...
DEFINE_PCI_ROOT_BUS_DEVPKEY(DEVPKEY_PciRootBus_SupportedSpeedsAndModes,
...
DEFINE_PCI_ROOT_BUS_DEVPKEY(DEVPKEY_PciRootBus_DeviceIDMessagingCapable,
...
DEFINE_PCI_ROOT_BUS_DEVPKEY(DEVPKEY_PciRootBus_SecondaryBusWidth,
...
DEFINE_PCI_ROOT_BUS_DEVPKEY(DEVPKEY_PciRootBus_ExtendedConfigAvailable,
...
DEFINE_PCI_ROOT_BUS_DEVPKEY(DEVPKEY_PciRootBus_ASPMSupport,
...
DEFINE_PCI_ROOT_BUS_DEVPKEY(DEVPKEY_PciRootBus_ClockPowerManagementSupport,
...
DEFINE_PCI_ROOT_BUS_DEVPKEY(DEVPKEY_PciRootBus_PCISegmentGroupsSupport,
...
DEFINE_PCI_ROOT_BUS_DEVPKEY(DEVPKEY_PciRootBus_MSISupport,
                            11); // DEVPROP_TYPE_BOOLEAN
...
DEFINE_PCI_ROOT_BUS_DEVPKEY(DEVPKEY_PciRootBus_SHPCNativeHotPlugControl,
...
DEFINE_PCI_ROOT_BUS_DEVPKEY(DEVPKEY_PciRootBus_PCIExpressNativePMEControl,
                            14); // DEVPROP_TYPE_BOOLEAN
...
DEFINE_PCI_ROOT_BUS_DEVPKEY(DEVPKEY_PciRootBus_PCIExpressAERControl,
                            15); // DEVPROP_TYPE_BOOLEAN
...
DEFINE_PCI_ROOT_BUS_DEVPKEY(DEVPKEY_PciRootBus_PCIExpressCapabilityControl,
...
DEFINE_PCI_ROOT_BUS_DEVPKEY(DEVPKEY_PciRootBus_NativePciExpressControl,
...
DEFINE_PCI_ROOT_BUS_DEVPKEY(DEVPKEY_PciRootBus_SystemMsiSupport,
...
#define DEFINE_PCI_DEVICE_DEVPKEY(_DevPkeyName, _Pid)                          \
  DEFINE_DEVPROPKEY((_DevPkeyName), 0x3ab22e31, 0x8264, 0x4b4e, 0x9a, 0xf5,    \
                    0xa8, 0xd2, 0xd8, 0xe3, 0x3e, 0x62, (_Pid))
...
#define DevProp_PciDevice_NonPrefetchable_MemoryBarCount(_PropertyData)        \
  (((_PropertyData) >> 8) & 0xFF)
#define DevProp_PciDevice_32BitPrefetchable_MemoryBarCount(_PropertyData)      \
  (((_PropertyData) >> 16) & 0xFF)
#define DevProp_PciDevice_64BitPrefetchable_MemoryBarCount(_PropertyData)      \
...
//
// This property contains bitmask of the D3.cold state and reason for that
// state.
//
...
//
// This property contains the port type that is read from the USB4 DVSEC
// Capability.
//
...
//
// This property contains the port specific attributes read from the USB4 DVSEC
// Capability.
//
