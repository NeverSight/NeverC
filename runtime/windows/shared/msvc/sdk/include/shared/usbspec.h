...
//
// USBPD Rev2.0: 9.3.1 Class-specific Device Requests, Table 9-8 PD. Class
// Feature Selectors
//
...
//
// USB 1.1: 9.4.5 Get Status, Figure 9-4. Information Returned by a GetStatus()
// Request to a Device USB 2.0: 9.4.5 Get Status, Figure 9-4. Information
// Returned by a GetStatus() Request to a Device
//
#define USB_GETSTATUS_SELF_POWERED 0x01
#define USB_GETSTATUS_REMOTE_WAKEUP_ENABLED 0x02
//
// USB 3.0: 9.4.5 Get Status, Figure 9-5. Information Returned by a GetStatus()
// Request to a Device
//
...
//
// USB 3.0: 9.4.5 Get Status, Figure 9-6. Information Returned by a GetStatus()
...
//
// USB 1.1: 9.4.5 Get Status, Figure 9-6. Information Returned by a GetStatus()
// Request to an Endpoint USB 2.0: 9.4.5 Get Status, Figure 9-6. Information
// Returned by a GetStatus() Request to an Endpoint USB 3.0: 9.4.5 Get Status,
...
//
// USB 3.1: 9.6.2 Binary Device Object Store (BOS), Table 9-14. Device
...
//
// USBPD Rev2.0: 9.2.1 USB Power Delivery Capability Descriptor, Table 9-2. USB
// Power Delivery Capability Descriptor
//
...
//
// USBPD Rev2.0: 9.2.3 PD Consumer Port Capability Descriptor, Table 9-4. PD
// Consumer Port Descriptor
//
...
//
// USB 3.0: 9.6.2.2 SuperSpeed USB Device Capability, Table 9-13. SuperSpeed
...
//
// USB Billboard 1.0: Section 3.1.5.2, Table 3-6. Billboard Capability
// Descriptor
//
...
//
// USB 3.0: 9.6.2 Binary Device Object Store, Table 9-10. Device Capability
// Descriptor
//
...
//
// USB 2.0 ECN: USB ECN : Interface Association Descriptor, 9.X.Y Interface
// Association,
//     Table 9-Z. Standard Interface Association Descriptor
// USB 3.0: 9.6.4 Interface Association, Table 9-16. Standard Interface
...
//
// USB 3.0: 9.6.7 SuperSpeed Endpoint Companion, Table 9-20. SuperSpeed Endpoint
...
//
// USB 3.1: 9.6.8 SuperSpeedPlus Isoch Endpoint Companion, Table 9-27.
// SuperSpeedPlus Isoch Endpoint Companion Descriptor
//
...
//
// USB 2.0: 9.6.6.1	eUSB2 Isochronous Endpoint Companion Descriptor, Table
// 9-X. eUSB2 Isochronous Endpoint Companion Descriptor
//
typedef struct _EUSB2_ISOCH_ENDPOINT_COMPANION_DESCRIPTOR {
  ...
  ULONG dwBytesPerInterval;
    ...
    *PEUSB2_ISOCH_ENDPOINT_COMPANION_DESCRIPTOR;
...
// Chapter 10 Hub, Host Downstream Port, and Device Upstream Port Specification
// (3.0)
//
...
//
// USB 1.1: 11.16.2 Class-specific Requests, Table 11-11. Hub Class Request
// Codes
//
#define USB_REQUEST_GET_STATE 0x02
//
// USB 2.0: 11.24.2 Class-specific Requests, Table 11-16. Hub Class Request
// Codes
//
...
//
// USB 1.1: 11.16.2 Class-specific Requests, Table 11-12. Hub Class Feature
// Selectors USB 2.0: 11.24.2 Class-specific Requests, Table 11-17. Hub Class
// Feature Selectors USB 3.0: 10.14.2 Class-specific Requests, Table 10-7. Hub
...
//
// USB 1.1: 11.16.2.6.1 Port Status Bits, Table 11-15. Port Status Field,
// wPortStatus USB 2.0: 11.24.2.7.1 Port Status Bits, Table 11-21. Port Status
// Field, wPortStatus
//
...
//
// USB 1.1: 11.16.2.6.2 Port Status Change Bits, Table 11-16. Port Change Field,
// wPortChange USB 2.0: 11.24.2.7.2 Port Status Change Bits, Table 11-22. Port
...
//
// USB 3.0: 10.14.2.6.1 Port Status Bits, Table 10-10. Port Status Field,
// wPortStatus
//
...
//
// USB 3.0: 10.14.2.6.2 Port Status Change Bits, Table 10-11. Port Change Field,
// wPortChange
//
...
//
// USB 3.0: 10.14.2.10 Set Port Feature, Table 10-14. Downstream Port Remote
// Wake Mask Encoding
//
