...
DEFINE_GUID(GUID_DEVINTERFACE_NFCSE, 0x8dc7c854, 0xf5e5, 0x4bed, 0x81, 0x5d,
            0xc, 0x85, 0xad, 0x4, 0x77, 0x25);
...
#define IOCTL_NFCSE_ENUM_ENDPOINTS                                             \
  CTL_CODE(FILE_DEVICE_UNKNOWN, 0x0200, METHOD_BUFFERED,                       \
           FILE_ANY_ACCESS) // Output: SECURE_ELEMENT_ENDPOINT_LIST
#define IOCTL_NFCSE_SUBSCRIBE_FOR_EVENT                                        \
  CTL_CODE(FILE_DEVICE_UNKNOWN, 0x0201, METHOD_BUFFERED,                       \
           FILE_ANY_ACCESS) // Input: SECURE_ELEMENT_EVENT_SUBSCRIPTION_INFO
#define IOCTL_NFCSE_GET_NEXT_EVENT                                             \
  CTL_CODE(FILE_DEVICE_UNKNOWN, 0x0202, METHOD_BUFFERED,                       \
           FILE_ANY_ACCESS) // Output: SECURE_ELEMENT_EVENT_INFO
#define IOCTL_NFCSE_SET_CARD_EMULATION_MODE                                    \
  CTL_CODE(                                                                    \
      FILE_DEVICE_UNKNOWN, 0x0203, METHOD_BUFFERED,                            \
      FILE_ANY_ACCESS) // Input: SECURE_ELEMENT_SET_CARD_EMULATION_MODE_INFO
#define IOCTL_NFCSE_GET_NFCC_CAPABILITIES                                      \
  CTL_CODE(FILE_DEVICE_UNKNOWN, 0x0204, METHOD_BUFFERED,                       \
           FILE_ANY_ACCESS) // Output: SECURE_ELEMENT_NFCC_CAPABILITIES
#define IOCTL_NFCSE_GET_ROUTING_TABLE                                          \
  CTL_CODE(FILE_DEVICE_UNKNOWN, 0x0205, METHOD_BUFFERED,                       \
           FILE_ANY_ACCESS) // Output: SECURE_ELEMENT_ROUTING_TABLE
#define IOCTL_NFCSE_SET_ROUTING_TABLE                                          \
  CTL_CODE(FILE_DEVICE_UNKNOWN, 0x0206, METHOD_BUFFERED,                       \
           FILE_ANY_ACCESS) // Input: SECURE_ELEMENT_ROUTING_TABLE
#define IOCTL_NFCSE_HCE_REMOTE_RECV                                            \
  CTL_CODE(FILE_DEVICE_UNKNOWN, 0x0250, METHOD_BUFFERED,                       \
           FILE_ANY_ACCESS) // Output: SECURE_ELEMENT_HCE_DATA_PACKET
#define IOCTL_NFCSE_HCE_REMOTE_SEND                                            \
  CTL_CODE(FILE_DEVICE_UNKNOWN, 0x0251, METHOD_BUFFERED,                       \
           FILE_ANY_ACCESS) // Input: SECURE_ELEMENT_HCE_DATA_PACKET
#define IOCTL_NFCSE_SET_POWER_MODE                                             \
  CTL_CODE(FILE_DEVICE_UNKNOWN, 0x0252, METHOD_BUFFERED,                       \
           FILE_ANY_ACCESS) // Input: SECURE_ELEMENT_SET_POWER_MODE_INFO

//
// EVT_TRANSACTION TLV definitions, from ETSI/HCI v12.1, Section 11.2.2.4
// EVT_TRANSACTION
...
typedef enum _SECURE_ELEMENT_EVENT_TYPE {
  // Signals that an external reader has been discovered and the initial
  // protocol handshake has occured.
...
#define SECURE_ELEMENT_EVENT_INFO_HEADER                                       \
  offsetof(SECURE_ELEMENT_EVENT_INFO, pbEventData)
...
#define SECURE_ELEMENT_HCE_DATA_PACKET_HEADER                                  \
  offsetof(SECURE_ELEMENT_HCE_DATA_PACKET, pbPayload)
