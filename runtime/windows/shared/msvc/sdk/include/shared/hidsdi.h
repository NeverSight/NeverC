...
_Must_inspect_result_ _Success_(return == TRUE) BOOLEAN __stdcall
HidD_GetAttributes(_In_ HANDLE HidDeviceObject,
...
_Must_inspect_result_ _Success_(return == TRUE) BOOLEAN __stdcall
HidD_GetPreparsedData(_In_ HANDLE HidDeviceObject,
...
--*/
_Success_(return == TRUE) BOOLEAN __stdcall
HidD_FreePreparsedData(_In_ __drv_freesMem(Mem)
                           PHIDP_PREPARSED_DATA PreparsedData);

_Success_(return == TRUE) BOOLEAN __stdcall
HidD_FlushQueue(_In_ HANDLE HidDeviceObject);
/*++
Routine Description:
...
--*/
_Must_inspect_result_ _Success_(return == TRUE) BOOLEAN __stdcall
HidD_GetConfiguration(_In_ HANDLE HidDeviceObject,
                      _Out_writes_bytes_(ConfigurationLength)
...
--*/
_Must_inspect_result_ _Success_(return == TRUE) BOOLEAN __stdcall
HidD_SetConfiguration(_In_ HANDLE HidDeviceObject,
                      _In_reads_bytes_(ConfigurationLength)
                          PHIDD_CONFIGURATION Configuration,
                      _In_ ULONG ConfigurationLength);
/*++
Routine Description:
...
--*/
_Must_inspect_result_ _Success_(return == TRUE) BOOLEAN __stdcall
HidD_GetFeature(_In_ HANDLE HidDeviceObject,
...
--*/
_Must_inspect_result_ _Success_(return == TRUE) BOOLEAN __stdcall
HidD_SetFeature(_In_ HANDLE HidDeviceObject,
...
_Must_inspect_result_ _Success_(return == TRUE) BOOLEAN
    __stdcall HidD_GetInputReport(_In_ HANDLE HidDeviceObject,
...
--*/
_Must_inspect_result_ _Success_(return == TRUE) BOOLEAN __stdcall
HidD_SetOutputReport(_In_ HANDLE HidDeviceObject,
                     _In_reads_bytes_(ReportBufferLength) PVOID ReportBuffer,
                     _In_ ULONG ReportBufferLength);
/*++
Routine Description:
...
#endif
_Must_inspect_result_ _Success_(return == TRUE) BOOLEAN
    __stdcall HidD_GetNumInputBuffers(_In_ HANDLE HidDeviceObject,
...
--*/
_Must_inspect_result_ _Success_(return == TRUE) BOOLEAN __stdcall
HidD_SetNumInputBuffers(_In_ HANDLE HidDeviceObject, _In_ ULONG NumberBuffers);
/*++
...
--*/
_Must_inspect_result_ _Success_(return == TRUE) BOOLEAN __stdcall
HidD_GetPhysicalDescriptor(_In_ HANDLE HidDeviceObject,
...
--*/
_Must_inspect_result_ _Success_(return == TRUE) BOOLEAN __stdcall
HidD_GetManufacturerString(_In_ HANDLE HidDeviceObject,
                           _Out_writes_bytes_(BufferLength) PVOID Buffer,
                           _In_ ULONG BufferLength);
/*++
Routine Description:
...
--*/
_Must_inspect_result_ _Success_(return == TRUE) BOOLEAN __stdcall
HidD_GetProductString(_In_ HANDLE HidDeviceObject,
                      _Out_writes_bytes_(BufferLength) PVOID Buffer,
                      _In_ ULONG BufferLength);
/*++
Routine Description:
...
--*/
_Must_inspect_result_ _Success_(return == TRUE) BOOLEAN __stdcall
HidD_GetIndexedString(_In_ HANDLE HidDeviceObject, _In_ ULONG StringIndex,
                      _Out_writes_bytes_(BufferLength) PVOID Buffer,
                      _In_ ULONG BufferLength);
/*++
Routine Description:
...
--*/
_Must_inspect_result_ _Success_(return == TRUE) BOOLEAN __stdcall
HidD_GetSerialNumberString(_In_ HANDLE HidDeviceObject,
                           _Out_writes_bytes_(BufferLength) PVOID Buffer,
                           _In_ ULONG BufferLength);
/*++
Routine Description:
...
#if (NTDDI_VERSION >= NTDDI_WINXP)
_Must_inspect_result_ _Success_(return == TRUE) BOOLEAN
    __stdcall HidD_GetMsGenreDescriptor(_In_ HANDLE HidDeviceObject,
