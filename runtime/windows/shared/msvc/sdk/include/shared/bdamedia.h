...
typedef struct _KSM_BDA_WMDRMTUNER_PURCHASEENTITLEMENT {
  ...
  BYTE argbDataBuffer[MIN_DIMENSION]; // Language Buffer before PurchaseToken
    ...
    *PKSM_BDA_WMDRMTUNER_PURCHASEENTITLEMENT;
...
DEFINE_GUIDSTRUCT("83183C03-C09E-45c4-A719-807A94952BF9",
...
DEFINE_GUIDSTRUCT("9F02D3D0-9F06-4369-9F1E-3AD6CA19807E",
                  EVENTID_CandidatePostTuneData);
#define EVENTID_CandidatePostTuneData                                          \
...
DEFINE_GUIDSTRUCT("C87EC52D-CD18-404a-A076-C02A273D3DE7",
...
DEFINE_GUIDSTRUCT("D10DF9D5-C261-4b85-9E8A-517B3299CAB2",
...
// dwPara4 - program number for PMT, Segment#|SID for EIT, but not used for
// others {1B9C3703-D447-4e16-97BB-01799FC031ED}
...
// This event is broadcasted with FireEx when the capture graph recognized that
// a current tuning channel has been terminated by broadcaster. The four
// parameters are: dwPara1 - TSID dwPara2 - ONID|SID dwPara3 - channel frequency
...
DEFINE_GUIDSTRUCT("0A1D591C-E0D2-4f8e-8960-2335BEF45CCB",
...
DEFINE_GUIDSTRUCT("A265FAEA-F874-4b38-9FF7-C53D02969996",
...
DEFINE_GUIDSTRUCT("000906F5-F0D1-41d6-A7DF-4028697669F6",
                  EVENTID_DRMParingStatusChanged);
#define EVENTID_DRMParingStatusChanged                                         \
  DEFINE_GUIDNAMED(EVENTID_DRMParingStatusChanged)
// The 1st parameter to this event is a BDA_DRMPairingStatus and 2nd is the
// error code.
...
DEFINE_GUIDSTRUCT("5B2EBF78-B752-4420-B41E-A472DC95828E",
                  EVENTID_DRMParingStepComplete);
#define EVENTID_DRMParingStepComplete                                          \
...
DEFINE_GUIDSTRUCT("9071AD5D-2359-4c95-8694-AFA81D70BFD5",
...
DEFINE_GUIDSTRUCT("17C4D730-D0F0-413a-8C99-500469DE35AD",
...
DEFINE_GUIDSTRUCT("5CA51711-5DDC-41a6-9430-E41B8B3BBC5B",
                  EVENTID_BDAEventingServicePendingEvent);
#define EVENTID_BDAEventingServicePendingEvent                                 \
...
DEFINE_GUIDSTRUCT("EFC3A459-AE8B-4b4a-8FE9-79A0D097F3EA",
                  EVENTID_BDAConditionalAccessTAG);
#define EVENTID_BDAConditionalAccessTAG                                        \
...
DEFINE_GUIDSTRUCT("B2127D42-7BE5-4f4b-9130-6679899F4F4B",
                  EVENTTYPE_CASDescrambleFailureEvent);
#define EVENTTYPE_CASDescrambleFailureEvent                                    \
...
DEFINE_GUIDSTRUCT("EAD831AE-5529-4d1f-AFCE-0D8CD1257D30",
                  EVENTID_CASFailureSpanningEvent);
#define EVENTID_CASFailureSpanningEvent                                        \
  DEFINE_GUIDNAMED(EVENTID_CASFailureSpanningEvent)

typedef enum {
  ChannelChangeSpanningEvent_Start =
      0, // Same as MSNP_EVENT_CHANGING defined in ehtraceguids.h
  ChannelChangeSpanningEvent_End =
      2 // Same as MSNP_EVENT_COMPLETED defined in ehtraceguids.h
} ChannelChangeSpanningEvent_State;

// {9067C5E5-4C5C-4205-86C8-7AFE20FE1EFA} same as __uuidof(EH_MSNP_TUNING_EVENT)
...
DEFINE_GUIDSTRUCT("9067C5E5-4C5C-4205-86C8-7AFE20FE1EFA",
                  EVENTID_ChannelChangeSpanningEvent);
#define EVENTID_ChannelChangeSpanningEvent                                     \
...
DEFINE_GUIDSTRUCT("72ab1d51-87d2-489b-ba11-0e08dc210243",
                  EVENTID_ChannelTypeSpanningEvent);
#define EVENTID_ChannelTypeSpanningEvent                                       \
...
DEFINE_GUIDSTRUCT("41F36D80-4132-4cc2-B121-01A43219D81B",
                  EVENTID_ChannelInfoSpanningEvent);
#define EVENTID_ChannelInfoSpanningEvent                                       \
  DEFINE_GUIDNAMED(EVENTID_ChannelInfoSpanningEvent)

// F6CFC8F4-DA93-4f2f-BFF8-BA1EE6FCA3A2 same as __uuidof(EH_RRT_EVENT) defined
// in ehtraceguids.h
#define STATIC_EVENTID_RRTSpanningEvent                                        \
  0xf6cfc8f4, 0xda93, 0x4f2f, 0xbf, 0xf8, 0xba, 0x1e, 0xe6, 0xfc, 0xa3, 0xa2
DEFINE_GUIDSTRUCT("F6CFC8F4-DA93-4f2f-BFF8-BA1EE6FCA3A2",
                  EVENTID_RRTSpanningEvent);
#define EVENTID_RRTSpanningEvent DEFINE_GUIDNAMED(EVENTID_RRTSpanningEvent)

// Data sturcture for both CaptionServiceDescriptor and Content Advisory
// descriptor
typedef struct _SpanningEventDescriptor {
  WORD wDataLen;       // Total length of the
                       // data(2*sizeof(WORD)+lengthof(bDescriptor))
...
DEFINE_GUIDSTRUCT("EFE779D9-97F0-4786-800D-95CF505DDC66",
                  EVENTID_CSDescriptorSpanningEvent);
#define EVENTID_CSDescriptorSpanningEvent                                      \
...
DEFINE_GUIDSTRUCT("3AB4A2E6-4247-4b34-896C-30AFA5D21C24",
                  EVENTID_CtxADescriptorSpanningEvent);
#define EVENTID_CtxADescriptorSpanningEvent                                    \
...
DEFINE_GUIDSTRUCT("4BD4E1C4-90A1-4109-8236-27F00E7DCC5B",
                  EVENTID_DVBScramblingControlSpanningEvent);
#define EVENTID_DVBScramblingControlSpanningEvent                              \
...
typedef enum {
  ...
  SignalAndServiceStatusSpanningEvent_Clear =
      0, // same as MSNP_EVENT_SIGNALANDSERVICE_TYPE in ehtraceguids.h
...
DEFINE_GUIDSTRUCT("8068C5CB-3C04-492b-B47D-0308820DCE51",
                  EVENTID_SignalAndServiceStatusSpanningEvent);
#define EVENTID_SignalAndServiceStatusSpanningEvent                            \
  DEFINE_GUIDNAMED(EVENTID_SignalAndServiceStatusSpanningEvent)

#define EVENTID_SignalAndServiceStatusEvent                                    \
  EVENTID_SignalAndServiceStatusSpanningEvent

// Data structure for EmmMessageSpanningEvent
typedef struct _SpanningEventEmmMessage {
  BYTE bCAbroadcasterGroupId; // CA Broadcaster Group ID from
                              // CA_service_descriptor (ARIB STD-B25)
  BYTE bMessageControl;   // Message Control from CA_service_descriptor (ARIB
                          // STD-B25)
...
// {6BF00268-4F7E-4294-AA87-E9E953E43F14} same as __uuidof(EH_EmmMessage_EVENT)
// defined in ehtraceguids.h
#define STATIC_EVENTID_EmmMessageSpanningEvent                                 \
  0x6bf00268, 0x4f7e, 0x4294, 0xaa, 0x87, 0xe9, 0xe9, 0x53, 0xe4, 0x3f, 0x14
DEFINE_GUIDSTRUCT("6BF00268-4F7E-4294-AA87-E9E953E43F14",
                  EVENTID_EmmMessageSpanningEvent);
#define EVENTID_EmmMessageSpanningEvent                                        \
...
DEFINE_GUIDSTRUCT("501CBFBE-B849-42ce-9BE9-3DB869FB82B3",
                  EVENTID_AudioTypeSpanningEvent);
#define EVENTID_AudioTypeSpanningEvent                                         \
  DEFINE_GUIDNAMED(EVENTID_AudioTypeSpanningEvent)
// AC 3 audio type and ISO639 language descriptor audio type are slight
// different. The AudioType values defined here is for the convenience of the
// user of audio type info and the conversion from the original spec to these
// values is done in capture.
//
...
DEFINE_GUIDSTRUCT("82af2ebc-30a6-4264-a80b-ad2e1372ac60",
                  EVENTID_StreamTypeSpanningEvent);
#define EVENTID_StreamTypeSpanningEvent                                        \
...
DEFINE_GUIDSTRUCT("3A954083-93D0-463e-90B2-0742C496EDF0",
                  EVENTID_ARIBcontentSpanningEvent);
#define EVENTID_ARIBcontentSpanningEvent                                       \
...
DEFINE_GUIDSTRUCT("E292666D-9C02-448d-AA8D-781A93FDC395",
                  EVENTID_LanguageSpanningEvent);
#define EVENTID_LanguageSpanningEvent                                          \
...
DEFINE_GUIDSTRUCT("A9A29B56-A84B-488c-89D5-0D4E7657C8CE",
                  EVENTID_DualMonoSpanningEvent);
#define EVENTID_DualMonoSpanningEvent                                          \
...
DEFINE_GUIDSTRUCT("47FC8F65-E2BB-4634-9CEF-FDBFE6261D5C",
                  EVENTID_PIDListSpanningEvent);
#define EVENTID_PIDListSpanningEvent                                           \
...
DEFINE_GUIDSTRUCT("107BD41C-A6DA-4691-8369-11B2CDAA288E",
                  EVENTID_AudioDescriptorSpanningEvent);
#define EVENTID_AudioDescriptorSpanningEvent                                   \
...
DEFINE_GUIDSTRUCT("5DCEC048-D0B9-4163-872C-4F32223BE88A",
                  EVENTID_SubtitleSpanningEvent);
#define EVENTID_SubtitleSpanningEvent                                          \
...
DEFINE_GUIDSTRUCT("9599D950-5F33-4617-AF7C-1E54B510DAA3",
                  EVENTID_TeletextSpanningEvent);
#define EVENTID_TeletextSpanningEvent                                          \
...
DEFINE_GUIDSTRUCT("CAF1AB68-E153-4d41-A6B3-A7C998DB75EE",
                  EVENTID_StreamIDSpanningEvent);
#define EVENTID_StreamIDSpanningEvent                                          \
...
DEFINE_GUIDSTRUCT("F947AA85-FB52-48e8-B9C5-E1E1F411A51A",
                  EVENTID_PBDAParentalControlEvent);
#define EVENTID_PBDAParentalControlEvent                                       \
...
#define REQUIRED_PARENTAL_CONTROL_TIME_RANGE                                   \
  0x00000002 // Required Parental Control Time Range
#define PARENTAL_CONTROL_CONTENT_RATING                                        \
  0x00000100 // Rating   (overall/primary content rating)
...
typedef struct _PBDAParentalControl {
  ULONG rating_system_count;     // number of rating systems in PBDA parenatl
                                 // control table
...
DEFINE_GUIDSTRUCT("D97287B2-2DFD-436a-9485-99D7D4AB5A69",
...
DEFINE_GUIDSTRUCT("6F8AA455-5EE1-48ab-A27C-4C8D70B9AEBA",
                  EVENTID_TuneFailureSpanningEvent);
#define EVENTID_TuneFailureSpanningEvent                                       \
...
DEFINE_GUIDSTRUCT("2A67A58D-ECA5-4eac-ABCB-E734D3776D0A",
                  EVENTID_DvbParentalRatingDescriptor);
#define EVENTID_DvbParentalRatingDescriptor                                    \
...
DEFINE_GUIDSTRUCT("F5689FFE-55F9-4bb3-96BE-AE971C63BAE0",
                  EVENTID_DFNWithNoActualAVData);
#define EVENTID_DFNWithNoActualAVData                                          \
...
#define DEFINE_KSPROPERTY_ITEM_BDA_SIGNAL_LOCK_CAPS(GetHandler)                \
  DEFINE_KSPROPERTY_ITEM(KSPROPERTY_BDA_SIGNAL_LOCK_CAPS, (GetHandler),        \
                         sizeof(KSP_NODE), sizeof(BOOL), NULL, NULL, 0, NULL,  \
                         NULL, 0)
...
#define DEFINE_KSPROPERTY_ITEM_BDA_SIGNAL_LOCK_TYPE(GetHandler)                \
  DEFINE_KSPROPERTY_ITEM(KSPROPERTY_BDA_SIGNAL_LOCK_TYPE, (GetHandler),        \
                         sizeof(KSP_NODE), sizeof(BDA_LockType), NULL, NULL,   \
                         0, NULL, NULL, 0)
...
//
// The BDA_DigitalSignalStandard enumeration is tentatively put out for Beta
// review Based on feedback, this may be updated or entirely removed in a later
// release
//
typedef enum {
...
typedef struct {
  ...
  ULONG SettlingTime; // R - milliSeconds to settle for any sort of update to
                      // the tuner
  ULONG AnalogSensingRange;  // R - max range (kHz) in which tuner can detect an
                             // analog signal
  ULONG DigitalSensingRange; // R - max range (kHz) in which tuner can detect an
                             // digital signal
  ULONG MilliSecondsPerMHz;  // R - max time to lock in to a signal 1MHz away
                             // assuming the signal has been detected, but its
                             // offset is unknown
...
typedef struct {
  KSP_NODE Property;
  BDA_SignalType
      SignalType; // RW - specifies whether the signal is Analog or Digital.
                  // this is required to interpret the SignalStandard field
  ULONG SignalStandard; // RW - current signal standard (KS_AnalogVideo_* or
                        // Bda_DigitalStandard_*) set by the application or
                        // detected by the device
} KSPROPERTY_BDA_RF_TUNER_STANDARD_S, *PKSPROPERTY_BDA_RF_TUNER_STANDARD_S;

typedef struct {
  KSP_NODE Property;
  BOOL AutoDetect; // RW - specifies whether the driver is in auto-detect mode
                   // for the signal standard
...
DEFINE_GUIDSTRUCT("AAB59E17-01C9-4ebf-93F2-FC3B79B46F91",
                  KSEVENTSETID_BdaTunerEvent);
#define KSEVENTSETID_BdaTunerEvent DEFINE_GUIDNAMED(KSEVENTSETID_BdaTunerEvent)

typedef enum { KSEVENT_BDA_TUNER_SCAN = 0 } KSEVENT_BDA_TUNER;

typedef struct {
  KSEVENTDATA EventData;
  ULONG StartFrequency; // W - initial frequency for the scan
  ULONG EndFrequency; // W - final frequency for the scan, can be less than the
                      // initial value indicating a "scan down" is requested
  BDA_LockType
      LockRequested; // W - whether the device should look for just a PLL lock,
                     // decoder lock, etc. should be a supported lock type.
...
DEFINE_GUIDSTRUCT("F84E2AB0-3C6B-45e3-A0FC-8669D4B81F11",
                  KSPROPSETID_BdaDiseqCommand);
#define KSPROPSETID_BdaDiseqCommand                                            \
...
#define DEFINE_KSPROPERTY_ITEM_BDA_DISEQC_ENABLE(GetHandler, SetHandler)       \
  DEFINE_KSPROPERTY_ITEM(KSPROPERTY_BDA_DISEQC_ENABLE, (GetHandler),           \
                         sizeof(KSP_NODE), sizeof(BOOL), (SetHandler), NULL,   \
                         0, NULL, NULL, 0)

#define DEFINE_KSPROPERTY_ITEM_BDA_DISEQC_LNB_SOURCE(GetHandler, SetHandler)   \
  DEFINE_KSPROPERTY_ITEM(KSPROPERTY_BDA_DISEQC_LNB_SOURCE, (GetHandler),       \
                         sizeof(KSP_NODE), sizeof(ULONG), (SetHandler), NULL,  \
                         0, NULL, NULL, 0)

#define DEFINE_KSPROPERTY_ITEM_BDA_DISEQC_USETONEBURST(GetHandler, SetHandler) \
  DEFINE_KSPROPERTY_ITEM(KSPROPERTY_BDA_DISEQC_USETONEBURST, (GetHandler),     \
                         sizeof(KSP_NODE), sizeof(BOOL), (SetHandler), NULL,   \
                         0, NULL, NULL, 0)

#define DEFINE_KSPROPERTY_ITEM_BDA_DISEQC_REPEATS(GetHandler, SetHandler)      \
  DEFINE_KSPROPERTY_ITEM(KSPROPERTY_BDA_DISEQC_REPEATS, (GetHandler),          \
                         sizeof(KSP_NODE), sizeof(ULONG), (SetHandler), NULL,  \
                         0, NULL, NULL, 0)

#define DEFINE_KSPROPERTY_ITEM_BDA_DISEQC_SEND(GetHandler, SetHandler)         \
  DEFINE_KSPROPERTY_ITEM(KSPROPERTY_BDA_DISEQC_SEND, (GetHandler),             \
                         sizeof(KSP_NODE), sizeof(BDA_DISEQC_SEND),            \
                         (SetHandler), NULL, 0, NULL, NULL, 0)

#define DEFINE_KSPROPERTY_ITEM_BDA_DISEQC_RESPONSE(GetHandler)                 \
  DEFINE_KSPROPERTY_ITEM(KSPROPERTY_BDA_DISEQC_RESPONSE, (GetHandler),         \
                         sizeof(KSP_NODE), sizeof(BDA_DISEQC_RESPONSE), NULL,  \
                         NULL, 0, NULL, NULL, 0)
...
DEFINE_GUIDSTRUCT("8B19BBF0-4184-43ac-AD3C-0C889BE4C212",
                  KSEVENTSETID_BdaDiseqCEvent);
#define KSEVENTSETID_BdaDiseqCEvent                                            \
...
#define DEFINE_KSEVENT_BDA_DISEQC_DATA_RECEIVED(AddHandler, RemoveHandler,     \
                                                SupportHandler)                \
  DEFINE_KSEVENT_ITEM(KSEVENT_BDA_DISEQC_DATA_RECEIVED, sizeof(KSEVENTDATA),   \
...
#define DEFINE_KSPROPERTY_ITEM_BDA_ROLL_OFF(GetHandler, SetHandler)            \
  DEFINE_KSPROPERTY_ITEM(KSPROPERTY_BDA_ROLL_OFF, (GetHandler),                \
                         sizeof(KSP_NODE), sizeof(RollOff), (SetHandler),      \
                         NULL, 0, NULL, NULL, 0)

#define DEFINE_KSPROPERTY_ITEM_BDA_PILOT(GetHandler, SetHandler)               \
  DEFINE_KSPROPERTY_ITEM(KSPROPERTY_BDA_PILOT, (GetHandler), sizeof(KSP_NODE), \
                         sizeof(Pilot), (SetHandler), NULL, 0, NULL, NULL, 0)

#define DEFINE_KSPROPERTY_ITEM_BDA_SIGNALTIMEOUTS(GetHandler, SetHandler)      \
  DEFINE_KSPROPERTY_ITEM(KSPROPERTY_BDA_SIGNALTIMEOUTS, (GetHandler),          \
                         sizeof(KSP_NODE), sizeof(BDA_SIGNAL_TIMEOUTS),        \
                         (SetHandler), NULL, 0, NULL, NULL, 0)

#define DEFINE_KSPROPERTY_ITEM_BDA_PLP_NUMBER(GetHandler, SetHandler)          \
  DEFINE_KSPROPERTY_ITEM(KSPROPERTY_BDA_PLP_NUMBER, (GetHandler),              \
                         sizeof(KSP_NODE), sizeof(ULONG), (SetHandler), NULL,  \
                         0, NULL, NULL, 0)
...
DEFINE_GUIDSTRUCT("BFF6B5BB-B0AE-484c-9DCA-73528FB0B46E",
                  KSMETHODSETID_BdaDrmService);
#define KSMETHODSETID_BdaDrmService                                            \
...
#define DEFINE_KSMETHOD_BDA_DRM_SETDRM(MethodHandler, SupportHandler)          \
  DEFINE_KSMETHOD_ITEM(KSMETHOD_BDA_DRM_CURRENT,                               \
                       KSMETHOD_TYPE_MODIFY | KSMETHOD_TYPE_SOURCE,            \
                       (MethodHandler), sizeof(KSM_BDA_DRM_SETDRM),            \
                       sizeof(PBDARESULT), SupportHandler)

#define DEFINE_KSMETHOD_BDA_DRM_DRMSTATUS(MethodHandler, SupportHandler)       \
  DEFINE_KSMETHOD_ITEM(KSMETHOD_BDA_DRM_DRMSTATUS,                             \
                       KSMETHOD_TYPE_MODIFY | KSMETHOD_TYPE_SOURCE,            \
                       (MethodHandler), sizeof(KSM_NODE),                      \
                       sizeof(BDA_DRM_DRMSTATUS), SupportHandler)
...
DEFINE_GUIDSTRUCT("4BE6FA3D-07CD-4139-8B80-8C18BA3AEC88",
                  KSMETHODSETID_BdaWmdrmSession);
#define KSMETHODSETID_BdaWmdrmSession                                          \
...
#define DEFINE_KSMETHOD_BDA_WMDRM_STATUS(MethodHandler, SupportHandler)        \
  DEFINE_KSMETHOD_ITEM(KSMETHOD_BDA_WMDRM_STATUS,                              \
                       KSMETHOD_TYPE_MODIFY | KSMETHOD_TYPE_SOURCE,            \
                       (MethodHandler), sizeof(KSM_NODE),                      \
                       sizeof(BDA_WMDRM_STATUS), SupportHandler)

#define DEFINE_KSMETHOD_BDA_WMDRM_REVINFO(MethodHandler, SupportHandler)       \
  DEFINE_KSMETHOD_ITEM(KSMETHOD_BDA_WMDRM_REVINFO,                             \
                       KSMETHOD_TYPE_MODIFY | KSMETHOD_TYPE_SOURCE,            \
                       (MethodHandler), sizeof(KSM_BDA_BUFFER),                \
                       sizeof(PBDARESULT), SupportHandler)

#define DEFINE_KSMETHOD_BDA_WMDRM_CRL(MethodHandler, SupportHandler)           \
  DEFINE_KSMETHOD_ITEM(KSMETHOD_BDA_WMDRM_CRL,                                 \
                       KSMETHOD_TYPE_MODIFY | KSMETHOD_TYPE_SOURCE,            \
                       (MethodHandler), sizeof(KSM_BDA_BUFFER),                \
                       sizeof(PBDARESULT), SupportHandler)

#define DEFINE_KSMETHOD_BDA_WMDRM_TRANSACTMESSAGE(MethodHandler,               \
                                                  SupportHandler)              \
  DEFINE_KSMETHOD_ITEM(KSMETHOD_BDA_WMDRM_MESSAGE,                             \
                       KSMETHOD_TYPE_MODIFY | KSMETHOD_TYPE_SOURCE,            \
                       (MethodHandler), sizeof(KSM_BDA_BUFFER),                \
                       sizeof(BDA_BUFFER), SupportHandler)

#define DEFINE_KSMETHOD_BDA_WMDRM_REISSUELICENSE(MethodHandler,                \
                                                 SupportHandler)               \
  DEFINE_KSMETHOD_ITEM(KSMETHOD_BDA_WMDRM_REISSUELICENSE,                      \
                       KSMETHOD_TYPE_MODIFY | KSMETHOD_TYPE_SOURCE,            \
                       (MethodHandler), sizeof(KSM_BDA_WMDRM_LICENSE),         \
                       sizeof(PBDARESULT), SupportHandler)

#define DEFINE_KSMETHOD_BDA_WMDRM_RENEWLICENSE(MethodHandler, SupportHandler)  \
  DEFINE_KSMETHOD_ITEM(KSMETHOD_BDA_WMDRM_RENEWLICENSE,                        \
                       KSMETHOD_TYPE_MODIFY | KSMETHOD_TYPE_SOURCE,            \
                       (MethodHandler), sizeof(KSM_BDA_WMDRM_RENEWLICENSE),    \
                       sizeof(BDA_WMDRM_RENEWLICENSE), SupportHandler)

#define DEFINE_KSMETHOD_BDA_WMDRM_GETLICENSE(MethodHandler, SupportHandler)    \
  DEFINE_KSMETHOD_ITEM(KSMETHOD_BDA_WMDRM_LICENSE,                             \
                       KSMETHOD_TYPE_MODIFY | KSMETHOD_TYPE_SOURCE,            \
                       (MethodHandler), sizeof(KSM_BDA_WMDRM_LICENSE),         \
                       sizeof(BDA_BUFFER), SupportHandler)

#define DEFINE_KSMETHOD_BDA_WMDRM_KEYINFO(MethodHandler, SupportHandler)       \
  DEFINE_KSMETHOD_ITEM(KSMETHOD_BDA_WMDRM_KEYINFO,                             \
                       KSMETHOD_TYPE_MODIFY | KSMETHOD_TYPE_SOURCE,            \
                       (MethodHandler), sizeof(KSM_NODE),                      \
                       sizeof(BDA_WMDRM_KEYINFOLIST), SupportHandler)
...
DEFINE_GUIDSTRUCT("86D979CF-A8A7-4f94-B5FB-14C0ACA68FE6",
                  KSMETHODSETID_BdaWmdrmTuner);
#define KSMETHODSETID_BdaWmdrmTuner                                            \
...
#define DEFINE_KSMETHOD_BDA_WMDRMTUNER_CANCELCAPTURETOKEN(MethodHandler,       \
                                                          SupportHandler)      \
  DEFINE_KSMETHOD_ITEM(KSMETHOD_BDA_WMDRMTUNER_CANCELCAPTURETOKEN,             \
                       KSMETHOD_TYPE_MODIFY | KSMETHOD_TYPE_SOURCE,            \
                       (MethodHandler), sizeof(KSM_BDA_BUFFER),                \
                       sizeof(PBDARESULT), SupportHandler)

#define DEFINE_KSMETHOD_BDA_WMDRMTUNER_SETPIDPROTECTION(MethodHandler,         \
                                                        SupportHandler)        \
  DEFINE_KSMETHOD_ITEM(KSMETHOD_BDA_WMDRMTUNER_SETPIDPROTECTION,               \
                       KSMETHOD_TYPE_MODIFY | KSMETHOD_TYPE_SOURCE,            \
                       (MethodHandler),                                        \
                       sizeof(KSM_BDA_WMDRMTUNER_SETPIDPROTECTION),            \
                       sizeof(PBDARESULT), SupportHandler)

#define DEFINE_KSMETHOD_BDA_WMDRMTUNER_GETPIDPROTECTION(MethodHandler,         \
                                                        SupportHandler)        \
  DEFINE_KSMETHOD_ITEM(KSMETHOD_BDA_WMDRMTUNER_GETPIDPROTECTION,               \
                       KSMETHOD_TYPE_MODIFY | KSMETHOD_TYPE_SOURCE,            \
                       (MethodHandler),                                        \
                       sizeof(KSM_BDA_WMDRMTUNER_GETPIDPROTECTION),            \
                       sizeof(BDA_WMDRMTUNER_PIDPROTECTION), SupportHandler)

#define DEFINE_KSMETHOD_BDA_WMDRMTUNER_SETSYNCVALUE(MethodHandler,             \
                                                    SupportHandler)            \
  DEFINE_KSMETHOD_ITEM(KSMETHOD_BDA_WMDRMTUNER_SETSYNCVALUE,                   \
                       KSMETHOD_TYPE_MODIFY | KSMETHOD_TYPE_SOURCE,            \
                       (MethodHandler), sizeof(KSM_BDA_WMDRMTUNER_SYNCVALUE),  \
                       sizeof(PBDARESULT), SupportHandler)

#define DEFINE_KSMETHOD_BDA_WMDRMTUNER_STARTCODEPROFILE(MethodHandler,         \
                                                        SupportHandler)        \
  DEFINE_KSMETHOD_ITEM(KSMETHOD_BDA_WMDRMTUNER_STARTCODEPROFILE,               \
                       KSMETHOD_TYPE_MODIFY | KSMETHOD_TYPE_SOURCE,            \
                       (MethodHandler), sizeof(KSP_NODE), sizeof(BDA_BUFFER),  \
                       SupportHandler)

#define DEFINE_KSMETHOD_BDA_WMDRMTUNER_PURCHASE_ENTITLEMENT(MethodHandler,     \
                                                            SupportHandler)    \
  DEFINE_KSMETHOD_ITEM(                                                        \
      KSMETHOD_BDA_WMDRMTUNER_PURCHASE_ENTITLEMENT,                            \
      KSMETHOD_TYPE_MODIFY | KSMETHOD_TYPE_SOURCE, (MethodHandler),            \
      sizeof(KSM_BDA_WMDRMTUNER_PURCHASEENTITLEMENT),                          \
      sizeof(BDA_WMDRMTUNER_PURCHASEENTITLEMENT), SupportHandler)
...
DEFINE_GUIDSTRUCT("f99492da-6193-4eb0-8690-6686cbff713e",
...
#define DEFINE_KSMETHOD_ITEM_BDA_EVENT_DATA(MethodHandler, SupportHandler)     \
  DEFINE_KSMETHOD_ITEM(KSMETHOD_BDA_EVENT_DATA,                                \
                       KSMETHOD_TYPE_MODIFY | KSMETHOD_TYPE_SOURCE,            \
                       (MethodHandler), sizeof(KSMETHOD),                      \
                       sizeof(BDA_EVENT_DATA), SupportHandler)

#define DEFINE_KSMETHOD_ITEM_BDA_EVENT_COMPLETE(MethodHandler, SupportHandler) \
  DEFINE_KSMETHOD_ITEM(KSMETHOD_BDA_EVENT_COMPLETE,                            \
                       KSMETHOD_TYPE_MODIFY | KSMETHOD_TYPE_SOURCE,            \
                       (MethodHandler), sizeof(KSM_BDA_EVENT_COMPLETE),        \
                       sizeof(LONG), SupportHandler)
...
DEFINE_GUIDSTRUCT("ae7e55b2-96d7-4e29-908f-62f95b2a1679",
                  KSEVENTSETID_BdaEvent);
#define KSEVENTSETID_BdaEvent DEFINE_GUIDNAMED(KSEVENTSETID_BdaEvent)

typedef enum { KSEVENT_BDA_EVENT_PENDINGEVENT = 0 } KSEVENT_BDA_EVENT_TYPE;

#define DEFINE_KSEVENT_ITEM_BDA_PENDINGEVENT(AddHandler, RemoveHandler,        \
                                             SupportHandler)                   \
  DEFINE_KSEVENT_ITEM(KSEVENT_BDA_EVENT_PENDINGEVENT, sizeof(KSEVENTDATA), 0,  \
                      (AddHandler), (RemoveHandler), (SupportHandler))
...
DEFINE_GUIDSTRUCT("0d4a90ec-c69d-4ee2-8c5a-fb1f63a50da1",
...
#define DEFINE_KSMETHOD_ITEM_BDA_DEBUG_LEVEL(MethodHandler, SupportHandler)    \
  DEFINE_KSMETHOD_ITEM(KSMETHOD_BDA_DEBUG_LEVEL,                               \
                       KSMETHOD_TYPE_MODIFY | KSMETHOD_TYPE_SOURCE,            \
                       (MethodHandler), sizeof(KSM_BDA_DEBUG_LEVEL),           \
                       sizeof(LONG), SupportHandler)

#define DEFINE_KSMETHOD_ITEM_BDA_DEBUG_DATA(MethodHandler, SupportHandler)     \
  DEFINE_KSMETHOD_ITEM(KSMETHOD_BDA_DEBUG_DATA, KSMETHOD_TYPE_MODIFY,          \
                       (MethodHandler), sizeof(KSMETHOD), 0, SupportHandler)
...
DEFINE_GUIDSTRUCT("b774102f-ac07-478a-8228-2742d961fa7e",
...
#define DEFINE_KSMETHOD_ITEM_BDA_TUNER_SETTUNER(MethodHandler, SupportHandler) \
  DEFINE_KSMETHOD_ITEM(KSMETHOD_BDA_TUNER_SETTUNER,                            \
                       KSMETHOD_TYPE_MODIFY | KSMETHOD_TYPE_SOURCE,            \
                       (MethodHandler), sizeof(KSM_BDA_TUNER_TUNEREQUEST),     \
                       sizeof(PBDARESULT), SupportHandler)

#define DEFINE_KSMETHOD_ITEM_BDA_TUNER_GETTUNERSTATE(MethodHandler,            \
                                                     SupportHandler)           \
  DEFINE_KSMETHOD_ITEM(KSMETHOD_BDA_TUNER_GETTUNERSTATE,                       \
                       KSMETHOD_TYPE_MODIFY | KSMETHOD_TYPE_SOURCE,            \
                       (MethodHandler), sizeof(KSMETHOD),                      \
                       sizeof(BDA_TUNER_TUNERSTATE), SupportHandler)

#define DEFINE_KSMETHOD_ITEM_BDA_TUNER_SIGNALNOISERATIO(MethodHandler,         \
                                                        SupportHandler)        \
  DEFINE_KSMETHOD_ITEM(KSMETHOD_BDA_TUNER_SIGNALNOISERATIO,                    \
                       KSMETHOD_TYPE_MODIFY | KSMETHOD_TYPE_SOURCE,            \
                       (MethodHandler), sizeof(KSMETHOD),                      \
                       sizeof(BDA_TUNER_DIAGNOSTICS), SupportHandler)
...
DEFINE_GUIDSTRUCT("0c24096d-5ff5-47de-a856-062e587e3727",
                  KSMETHODSETID_BdaNameValueA);
#define KSMETHODSETID_BdaNameValueA                                            \
...
DEFINE_GUIDSTRUCT("36e07304-9f0d-4e88-9118-ac0ba317b7f2",
...
#define DEFINE_KSMETHOD_ITEM_BDA_GPNV_GETVALUE(MethodHandler, SupportHandler)  \
  DEFINE_KSMETHOD_ITEM(KSMETHOD_BDA_GPNV_GETVALUE,                             \
                       KSMETHOD_TYPE_MODIFY | KSMETHOD_TYPE_SOURCE,            \
                       (MethodHandler), sizeof(KSM_BDA_GPNV_GETVALUE),         \
                       sizeof(BDA_STRING), SupportHandler)

#define DEFINE_KSMETHOD_ITEM_BDA_GPNV_SETVALUE(MethodHandler, SupportHandler)  \
  DEFINE_KSMETHOD_ITEM(KSMETHOD_BDA_GPNV_SETVALUE,                             \
                       KSMETHOD_TYPE_MODIFY | KSMETHOD_TYPE_SOURCE,            \
                       (MethodHandler), sizeof(KSM_BDA_GPNV_SETVALUE),         \
                       sizeof(PBDARESULT), SupportHandler)

#define DEFINE_KSMETHOD_ITEM_BDA_GPNV_NAMEFROMINDEX(MethodHandler,             \
                                                    SupportHandler)            \
  DEFINE_KSMETHOD_ITEM(KSMETHOD_BDA_GPNV_NAMEFROMINDEX,                        \
                       KSMETHOD_TYPE_MODIFY | KSMETHOD_TYPE_SOURCE,            \
                       (MethodHandler), sizeof(KSM_BDA_GPNV_NAMEINDEX),        \
                       sizeof(BDA_STRING), SupportHandler)

#define DEFINE_KSMETHOD_ITEM_BDA_GPNV_GETVALUEUPDATENAME(MethodHandler,        \
                                                         SupportHandler)       \
  DEFINE_KSMETHOD_ITEM(KSMETHOD_BDA_GPNV_GETVALUEUPDATENAME,                   \
                       KSMETHOD_TYPE_MODIFY | KSMETHOD_TYPE_SOURCE,            \
                       (MethodHandler), sizeof(KSMETHOD), sizeof(BDA_STRING),  \
                       SupportHandler)
...
#define DEFINE_KSMETHOD_ITEM_BDA_MUX_GETPIDLIST(MethodHandler, SupportHandler) \
  DEFINE_KSMETHOD_ITEM(KSMETHOD_BDA_MUX_GETPIDLIST,                            \
                       KSMETHOD_TYPE_MODIFY | KSMETHOD_TYPE_SOURCE,            \
                       (MethodHandler), sizeof(KSM_NODE), sizeof(BDA_BUFFER),  \
                       SupportHandler)

#define DEFINE_KSMETHOD_ITEM_BDA_MUX_SETPIDLIST(MethodHandler, SupportHandler) \
  DEFINE_KSMETHOD_ITEM(KSMETHOD_BDA_MUX_SETPIDLIST,                            \
                       KSMETHOD_TYPE_MODIFY | KSMETHOD_TYPE_SOURCE,            \
                       (MethodHandler), sizeof(KSM_BDA_BUFFER),                \
                       sizeof(PBDARESULT), SupportHandler)
...
DEFINE_GUIDSTRUCT("12EB49DF-6249-47f3-B190-E21E6E2F8A9C",
...
#define DEFINE_KSMETHOD_ITEM_BDA_SCAN_CAPABILTIES(MethodHandler,               \
                                                  SupportHandler)              \
  DEFINE_KSMETHOD_ITEM(KSMETHOD_BDA_SCAN_CAPABILTIES,                          \
                       KSMETHOD_TYPE_MODIFY | KSMETHOD_TYPE_SOURCE,            \
                       (MethodHandler), sizeof(KSM_BDA_SCAN_CAPABILTIES),      \
                       sizeof(BDA_SCAN_CAPABILTIES), SupportHandler)

#define DEFINE_KSMETHOD_ITEM_BDA_SCANNING_STATE(MethodHandler, SupportHandler) \
  DEFINE_KSMETHOD_ITEM(KSMETHOD_BDA_SCANNING_STATE,                            \
                       KSMETHOD_TYPE_MODIFY | KSMETHOD_TYPE_SOURCE,            \
                       (MethodHandler), sizeof(KSMETHOD),                      \
                       sizeof(BDA_SCAN_STATE), SupportHandler)

#define DEFINE_KSMETHOD_ITEM_BDA_SCAN_FILTER(MethodHandler, SupportHandler)    \
  DEFINE_KSMETHOD_ITEM(KSMETHOD_BDA_SCAN_FILTER,                               \
                       KSMETHOD_TYPE_MODIFY | KSMETHOD_TYPE_SOURCE,            \
                       (MethodHandler), sizeof(KSM_BDA_SCAN_FILTER),           \
                       sizeof(PBDARESULT), SupportHandler)

#define DEFINE_KSMETHOD_ITEM_BDA_SCAN_START(MethodHandler, SupportHandler)     \
  DEFINE_KSMETHOD_ITEM(KSMETHOD_BDA_SCAN_START,                                \
                       KSMETHOD_TYPE_MODIFY | KSMETHOD_TYPE_SOURCE,            \
                       (MethodHandler), sizeof(KSM_BDA_SCAN_START),            \
                       sizeof(PBDARESULT), SupportHandler)

#define DEFINE_KSMETHOD_ITEM_BDA_SCAN_RESUME(MethodHandler, SupportHandler)    \
  DEFINE_KSMETHOD_ITEM(                                                        \
      KSMETHOD_BDA_SCAN_RESUME, KSMETHOD_TYPE_MODIFY | KSMETHOD_TYPE_SOURCE,   \
      (MethodHandler), sizeof(KSMETHOD), sizeof(PBDARESULT), SupportHandler)

#define DEFINE_KSMETHOD_ITEM_BDA_SCAN_STOP(MethodHandler, SupportHandler)      \
  DEFINE_KSMETHOD_ITEM(                                                        \
      KSMETHOD_BDA_SCAN_STOP, KSMETHOD_TYPE_MODIFY | KSMETHOD_TYPE_SOURCE,     \
      (MethodHandler), sizeof(KSMETHOD), sizeof(PBDARESULT), SupportHandler)
...
DEFINE_GUIDSTRUCT("8D9D5562-1589-417d-99CE-AC531DDA19F9",
                  KSMETHODSETID_BdaGuideDataDeliveryService);
#define KSMETHODSETID_BdaGuideDataDeliveryService                              \
...
#define DEFINE_KSMETHOD_ITEM_BDA_GDDS_DATATYPE(MethodHandler, SupportHandler)  \
  DEFINE_KSMETHOD_ITEM(KSMETHOD_BDA_GDDS_DATATYPE,                             \
                       KSMETHOD_TYPE_MODIFY | KSMETHOD_TYPE_SOURCE,            \
                       (MethodHandler), sizeof(KSMETHOD),                      \
                       sizeof(BDA_GDDS_DATATYPE), SupportHandler)

#define DEFINE_KSMETHOD_ITEM_BDA_GDDS_DATA(MethodHandler, SupportHandler)      \
  DEFINE_KSMETHOD_ITEM(KSMETHOD_BDA_GDDS_DATA,                                 \
                       KSMETHOD_TYPE_MODIFY | KSMETHOD_TYPE_SOURCE,            \
                       (MethodHandler), sizeof(KSMETHOD),                      \
                       sizeof(BDA_GDDS_DATA), SupportHandler)

#define DEFINE_KSMETHOD_ITEM_BDA_GDDS_TUNEXMLFROMIDX(MethodHandler,            \
                                                     SupportHandler)           \
  DEFINE_KSMETHOD_ITEM(KSMETHOD_BDA_GDDS_TUNEXMLFROMIDX,                       \
                       KSMETHOD_TYPE_MODIFY | KSMETHOD_TYPE_SOURCE,            \
                       (MethodHandler), sizeof(KSM_BDA_GDDS_TUNEXMLFROMIDX),   \
                       sizeof(BDA_STRING), SupportHandler)

#define DEFINE_KSMETHOD_ITEM_BDA_GDDS_GETSERVICES(MethodHandler,               \
                                                  SupportHandler)              \
  DEFINE_KSMETHOD_ITEM(KSMETHOD_BDA_GDDS_GETSERVICES,                          \
                       KSMETHOD_TYPE_MODIFY | KSMETHOD_TYPE_SOURCE,            \
                       (MethodHandler), sizeof(KSMETHOD), sizeof(BDA_BUFFER),  \
                       SupportHandler)

#define DEFINE_KSMETHOD_ITEM_BDA_GDDS_SERVICEFROMTUNEXML(MethodHandler,        \
                                                         SupportHandler)       \
  DEFINE_KSMETHOD_ITEM(KSMETHOD_BDA_GDDS_SERVICEFROMTUNEXML,                   \
                       KSMETHOD_TYPE_MODIFY | KSMETHOD_TYPE_SOURCE,            \
                       (MethodHandler),                                        \
                       sizeof(KSM_BDA_GDDS_SERVICEFROMTUNEXML),                \
                       sizeof(BDA_STRING), SupportHandler)

#define DEFINE_KSMETHOD_ITEM_BDA_GDDS_DATAUPDATE(MethodHandler,                \
                                                 SupportHandler)               \
  DEFINE_KSMETHOD_ITEM(KSMETHOD_BDA_GDDS_DATAUPDATE,                           \
                       KSMETHOD_TYPE_MODIFY | KSMETHOD_TYPE_SOURCE,            \
                       (MethodHandler), sizeof(KSMETHOD), sizeof(PBDARESULT),  \
                       SupportHandler)
...
DEFINE_GUIDSTRUCT("10CED3B4-320B-41bf-9824-1B2E68E71EB9",
                  KSMETHODSETID_BdaConditionalAccessService);
#define KSMETHODSETID_BdaConditionalAccessService                              \
...
#define DEFINE_KSMETHOD_ITEM_BDA_CAS_CHECKENTITLEMENTTOKEN(MethodHandler,      \
                                                           SupportHandler)     \
  DEFINE_KSMETHOD_ITEM(KSMETHOD_BDA_CAS_CHECKENTITLEMENTTOKEN,                 \
                       KSMETHOD_TYPE_MODIFY | KSMETHOD_TYPE_SOURCE,            \
                       (MethodHandler), sizeof(KSM_BDA_CAS_ENTITLEMENTTOKEN),  \
                       sizeof(BDA_CAS_CHECK_ENTITLEMENTTOKEN), SupportHandler)

#define DEFINE_KSMETHOD_ITEM_BDA_CAS_SETCAPTURETOKEN(MethodHandler,            \
                                                     SupportHandler)           \
  DEFINE_KSMETHOD_ITEM(KSMETHOD_BDA_CAS_SETCAPTURETOKEN,                       \
                       KSMETHOD_TYPE_MODIFY | KSMETHOD_TYPE_SOURCE,            \
                       (MethodHandler), sizeof(KSM_BDA_CAS_CAPTURETOKEN),      \
                       sizeof(PBDARESULT), SupportHandler)

#define DEFINE_KSMETHOD_ITEM_BDA_CAS_OPENBROADCASTMMI(MethodHandler,           \
                                                      SupportHandler)          \
  DEFINE_KSMETHOD_ITEM(KSMETHOD_BDA_CAS_OPENBROADCASTMMI,                      \
                       KSMETHOD_TYPE_MODIFY | KSMETHOD_TYPE_SOURCE,            \
                       (MethodHandler), sizeof(KSM_BDA_CAS_OPENBROADCASTMMI),  \
                       sizeof(PBDARESULT), SupportHandler)

#define DEFINE_KSMETHOD_ITEM_BDA_CAS_CLOSEMMIDIALOG(MethodHandler,             \
                                                    SupportHandler)            \
  DEFINE_KSMETHOD_ITEM(KSMETHOD_BDA_CAS_CLOSEMMIDIALOG,                        \
                       KSMETHOD_TYPE_MODIFY | KSMETHOD_TYPE_SOURCE,            \
                       (MethodHandler), sizeof(KSM_BDA_CAS_CLOSEMMIDIALOG),    \
                       sizeof(BDA_CAS_CLOSE_MMIDIALOG), SupportHandler)
...
DEFINE_GUIDSTRUCT("5E68C627-16C2-4e6c-B1E2-D00170CDAA0F",
                  KSMETHODSETID_BdaIsdbConditionalAccess);
#define KSMETHODSETID_BdaIsdbConditionalAccess                                 \
...
#define DEFINE_KSMETHOD_ITEM_BDA_ISDBCAS_SETREQUEST(MethodHandler,             \
                                                    SupportHandler)            \
  DEFINE_KSMETHOD_ITEM(KSMETHOD_BDA_ISDBCAS_SETREQUEST,                        \
                       KSMETHOD_TYPE_MODIFY | KSMETHOD_TYPE_SOURCE,            \
                       (MethodHandler), sizeof(KSM_BDA_ISDBCAS_REQUEST),       \
                       sizeof(PBDARESULT), SupportHandler)

#define DEFINE_KSMETHOD_ITEM_BDA_ISDBCAS_RESPONSEDATA(MethodHandler,           \
                                                      SupportHandler)          \
  DEFINE_KSMETHOD_ITEM(KSMETHOD_BDA_ISDBCAS_RESPONSEDATA,                      \
                       KSMETHOD_TYPE_MODIFY | KSMETHOD_TYPE_SOURCE,            \
                       (MethodHandler), sizeof(KSM_NODE),                      \
                       sizeof(BDA_ISDBCAS_RESPONSEDATA), SupportHandler)
...
DEFINE_GUIDSTRUCT("1DCFAFE9-B45E-41b3-BB2A-561EB129AE98",
                  KSMETHODSETID_BdaTSSelector);
#define KSMETHODSETID_BdaTSSelector                                            \
...
#define DEFINE_KSMETHOD_ITEM_BDA_TS_SELECTOR_SETTSID(MethodHandler,            \
                                                     SupportHandler)           \
  DEFINE_KSMETHOD_ITEM(KSMETHOD_BDA_TS_SELECTOR_SETTSID,                       \
                       KSMETHOD_TYPE_MODIFY | KSMETHOD_TYPE_SOURCE,            \
                       (MethodHandler), sizeof(KSM_BDA_TS_SELECTOR_SETTSID),   \
                       sizeof(ULONG), SupportHandler)

#define DEFINE_KSMETHOD_ITEM_BDA_TS_SELECTOR_GETTSINFORMATION(MethodHandler,   \
                                                              SupportHandler)  \
  DEFINE_KSMETHOD_ITEM(KSMETHOD_BDA_TS_SELECTOR_GETTSINFORMATION,              \
                       KSMETHOD_TYPE_MODIFY | KSMETHOD_TYPE_SOURCE,            \
                       (MethodHandler), sizeof(KSM_NODE),                      \
                       sizeof(BDA_TS_SELECTORINFO), SupportHandler)
...
DEFINE_GUIDSTRUCT("EDA5C834-4531-483c-BE0A-94E6C96FF396",
                  KSMETHODSETID_BdaUserActivity);
#define KSMETHODSETID_BdaUserActivity                                          \
...
#define DEFINE_KSMETHOD_ITEM_BDA_USERACTIVITY_USEREASON(MethodHandler,         \
                                                        SupportHandler)        \
  DEFINE_KSMETHOD_ITEM(KSMETHOD_BDA_USERACTIVITY_USEREASON,                    \
                       KSMETHOD_TYPE_MODIFY | KSMETHOD_TYPE_SOURCE,            \
                       (MethodHandler),                                        \
                       sizeof(KSM_BDA_USERACTIVITY_USEREASON),                 \
                       sizeof(PBDARESULT), SupportHandler)

#define DEFINE_KSMETHOD_ITEM_BDA_USERACTIVITY_INTERVAL(MethodHandler,          \
                                                       SupportHandler)         \
  DEFINE_KSMETHOD_ITEM(KSMETHOD_BDA_USERACTIVITY_INTERVAL,                     \
                       KSMETHOD_TYPE_MODIFY | KSMETHOD_TYPE_SOURCE,            \
                       (MethodHandler), sizeof(KSMETHOD),                      \
                       sizeof(BDA_USERACTIVITY_INTERVAL), SupportHandler)

#define DEFINE_KSMETHOD_ITEM_BDA_USERACTIVITY_DETECTED(MethodHandler,          \
                                                       SupportHandler)         \
  DEFINE_KSMETHOD_ITEM(KSMETHOD_BDA_USERACTIVITY_DETECTED,                     \
                       KSMETHOD_TYPE_MODIFY | KSMETHOD_TYPE_SOURCE,            \
                       (MethodHandler), sizeof(KSMETHOD), sizeof(PBDARESULT),  \
                       SupportHandler)
...
//
// Typical usage of the node categories to define supported tuner device
// standards.
//
// Analog (only)
//   KSNODE_BDA_RF_TUNER
...
//   KSNODE_BDA_RF_TUNER & KSNODE_BDA_QAM_DEMODULATOR & KSNODE_BDA_OPENCABLE_POD
//   nodes
//
...
DEFINE_GUIDSTRUCT("634DB199-27DD-46b8-ACFB-ECC98E61A2AD",
                  KSNODE_BDA_ANALOG_DEMODULATOR);
#define KSNODE_BDA_ANALOG_DEMODULATOR                                          \
...
DEFINE_GUIDSTRUCT("E957A0E7-DD98-4A3C-810B-3525157AB62E",
                  KSNODE_BDA_8PSK_DEMODULATOR);
#define KSNODE_BDA_8PSK_DEMODULATOR                                            \
...
DEFINE_GUIDSTRUCT("fcea3ae3-2cb2-464d-8f5d-305c0bb778a2",
                  KSNODE_BDA_ISDB_T_DEMODULATOR);
#define KSNODE_BDA_ISDB_T_DEMODULATOR                                          \
...
DEFINE_GUIDSTRUCT("edde230a-9086-432d-b8a5-6670263807e9",
                  KSNODE_BDA_ISDB_S_DEMODULATOR);
#define KSNODE_BDA_ISDB_S_DEMODULATOR                                          \
...
DEFINE_GUIDSTRUCT("345812A0-FB7C-4790-AA7E-B1DB88AC19C9",
...
DEFINE_GUIDSTRUCT("d98429e3-65c9-4ac4-93aa-766782833b7a",
...
DEFINE_GUIDSTRUCT("F2CF2AB3-5B9D-40ae-AB7C-4E7AD0BD1C52",
...
DEFINE_GUIDSTRUCT("AA5E8286-593C-4979-9494-46A2A9DFE076",
...
DEFINE_GUIDSTRUCT("5EDDF185-FED1-4f45-9685-BBB73C323CFC",
...
DEFINE_GUIDSTRUCT("143827AB-F77B-498d-81CA-5A007AEC28BF",
...
DEFINE_GUIDSTRUCT("B820D87E-E0E3-478f-8A38-4E13F7B3DF42",
...
DEFINE_GUIDSTRUCT("742EF867-09E1-40A3-82D3-9669BA35325F",
...
DEFINE_GUIDSTRUCT("7728087B-2BB9-4E30-8078-449476E59DBB",
...
DEFINE_GUIDSTRUCT("95037F6F-3AC7-4452-B6C4-45A9CE9292A2",
                  ISDB_TERRESTRIAL_TV_NETWORK_TYPE);
#define ISDB_TERRESTRIAL_TV_NETWORK_TYPE                                       \
...
DEFINE_GUIDSTRUCT("B0A4E6A0-6A1A-4B83-BB5B-903E1D90E6B6",
                  ISDB_SATELLITE_TV_NETWORK_TYPE);
#define ISDB_SATELLITE_TV_NETWORK_TYPE                                         \
...
DEFINE_GUIDSTRUCT("C974DDB5-41FE-4B25-9741-92F049F1D5D1",
...
DEFINE_GUIDSTRUCT("93B66FB5-93D4-4323-921C-C1F52DF61D3F",
                  DIRECT_TV_SATELLITE_TV_NETWORK_TYPE);
#define DIRECT_TV_SATELLITE_TV_NETWORK_TYPE                                    \
...
DEFINE_GUIDSTRUCT("C4F6B31B-C6BF-4759-886F-A7386DCA27A0",
                  ECHOSTAR_SATELLITE_TV_NETWORK_TYPE);
#define ECHOSTAR_SATELLITE_TV_NETWORK_TYPE                                     \
...
DEFINE_GUIDSTRUCT("0DAD2FDD-5FD7-11D3-8F50-00C04F7971E2",
                  ATSC_TERRESTRIAL_TV_NETWORK_TYPE);
#define ATSC_TERRESTRIAL_TV_NETWORK_TYPE                                       \
...
DEFINE_GUIDSTRUCT("216C62DF-6D7F-4E9A-8571-05F14EDB766A",
                  DVB_TERRESTRIAL_TV_NETWORK_TYPE);
#define DVB_TERRESTRIAL_TV_NETWORK_TYPE                                        \
...
DEFINE_GUIDSTRUCT("9E9E46C6-3ABA-4f08-AD0E-CC5AC8148C2B",
                  BSKYB_TERRESTRIAL_TV_NETWORK_TYPE);
#define BSKYB_TERRESTRIAL_TV_NETWORK_TYPE                                      \
...
DEFINE_GUIDSTRUCT("FA4B375A-45B4-4D45-8440-263957B11623",
                  DVB_SATELLITE_TV_NETWORK_TYPE);
#define DVB_SATELLITE_TV_NETWORK_TYPE                                          \
...
DEFINE_GUIDSTRUCT("DC0C0FE7-0485-4266-B93F-68FBF80ED834",
...
DEFINE_GUIDSTRUCT("69C24F54-9983-497e-B415-282BE4C555FB",
...
DEFINE_GUIDSTRUCT("a806e767-de5c-430c-80bf-a21ebe06c748",
...
DEFINE_GUIDSTRUCT("D4CB1966-41BC-4ced-9A20-FDCEAC78F70D",
                  EVENTID_BDA_IsdbCASResponse);
#define EVENTID_BDA_IsdbCASResponse                                            \
...
DEFINE_GUIDSTRUCT("CF39A9D8-F5D3-4685-BE57-ED81DBA46B27",
                  EVENTID_BDA_CASRequestTuner);
#define EVENTID_BDA_CASRequestTuner                                            \
...
DEFINE_GUIDSTRUCT("20C1A16B-441F-49a5-BB5C-E9A04495C6C1",
                  EVENTID_BDA_CASReleaseTuner);
#define EVENTID_BDA_CASReleaseTuner                                            \
...
DEFINE_GUIDSTRUCT("85DAC915-E593-410d-8471-D6812105F28E",
...
DEFINE_GUIDSTRUCT("5D0F550F-DE2E-479d-8345-EC0E9557E8A2",
...
DEFINE_GUIDSTRUCT("676876F0-1132-404c-A7CA-E72069A9D54F",
                  EVENTID_BDA_CASBroadcastMMI);
#define EVENTID_BDA_CASBroadcastMMI                                            \
...
DEFINE_GUIDSTRUCT("1872E740-F573-429b-A00E-D9C1E408AF09",
                  EVENTID_BDA_TunerSignalLock);
#define EVENTID_BDA_TunerSignalLock                                            \
...
DEFINE_GUIDSTRUCT("E29B382B-1EDD-4930-BC46-682FD72D2DFB",
...
DEFINE_GUIDSTRUCT("FF75C68C-F416-4e7e-BF17-6D55C5DF1575",
                  EVENTID_BDA_GPNVValueUpdate);
#define EVENTID_BDA_GPNVValueUpdate                                            \
...
DEFINE_GUIDSTRUCT("65A6F681-1462-473b-88CE-CB731427BDB5",
                  EVENTID_BDA_UpdateDrmStatus);
#define EVENTID_BDA_UpdateDrmStatus                                            \
...
DEFINE_GUIDSTRUCT("55702B50-7B49-42B8-A82F-4AFB691B0628",
                  EVENTID_BDA_UpdateScanState);
#define EVENTID_BDA_UpdateScanState                                            \
...
DEFINE_GUIDSTRUCT("98DB717A-478A-4cd4-92D0-95F66B89E5B1",
                  EVENTID_BDA_GuideDataAvailable);
#define EVENTID_BDA_GuideDataAvailable                                         \
...
DEFINE_GUIDSTRUCT("A1C3EA2B-175F-4458-B735-507D22DB23A6",
                  EVENTID_BDA_GuideServiceInformationUpdated);
#define EVENTID_BDA_GuideServiceInformationUpdated                             \
...
DEFINE_GUIDSTRUCT("AC33C448-6F73-4fd7-B341-594C360D8D74",
...
DEFINE_GUIDSTRUCT("EFA628F8-1F2C-4b67-9EA5-ACF6FA9A1F36",
                  EVENTID_BDA_DiseqCResponseAvailable);
#define EVENTID_BDA_DiseqCResponseAvailable                                    \
...
DEFINE_GUIDSTRUCT("356207B2-6F31-4eb0-A271-B3FA6BB7680F",
                  EVENTID_BDA_LbigsOpenConnection);
#define EVENTID_BDA_LbigsOpenConnection                                        \
...
DEFINE_GUIDSTRUCT("1123277B-F1C6-4154-8B0D-48E6157059AA",
...
DEFINE_GUIDSTRUCT("C2F08B99-65EF-4314-9671-E99D4CCE0BAE",
                  EVENTID_BDA_LbigsCloseConnectionHandle);
#define EVENTID_BDA_LbigsCloseConnectionHandle                                 \
...
DEFINE_GUIDSTRUCT("5EC90EB9-39FA-4CFC-B93F-00BB11077F5E",
                  EVENTID_BDA_EncoderSignalLock);
#define EVENTID_BDA_EncoderSignalLock                                          \
...
DEFINE_GUIDSTRUCT("05F25366-D0EB-43d2-BC3C-682B863DF142",
...
DEFINE_GUIDSTRUCT("6A0CD757-4CE3-4e5b-9444-7187B87152C5",
                  EVENTID_BDA_FdcTableSection);
#define EVENTID_BDA_FdcTableSection                                            \
...
DEFINE_GUIDSTRUCT("C40F9F85-09D0-489c-9E9C-0ABBB56951B0",
                  EVENTID_BDA_TransprtStreamSelectorInfo);
#define EVENTID_BDA_TransprtStreamSelectorInfo                                 \
...
DEFINE_GUIDSTRUCT("C6E048C0-C574-4C26-BCDA-2F4D35EB5E85",
...
DEFINE_GUIDSTRUCT("1E1D7141-583F-4ac2-B019-1F430EDA0F4C",
