...
//   #include <ntddpar.h>  in that source file a second time to instantiate the
//   GUIDs
//
// #ifdef WANT_WDM
#ifndef FAR
...
DEFINE_GUID(GUID_PARALLEL_DEVICE, 0x97F76EF0, 0xF883, 0x11D0, 0xAF, 0x1F, 0x00,
            0x00, 0xF8, 0x00, 0x84, 0x5C);
DEFINE_GUID(GUID_PARCLASS_DEVICE, 0x811FC6A5, 0xF728, 0x11D0, 0xA5, 0x37, 0x00,
...
// returns Location of the port - generally of the form: LPTx or LPTx.y or
// LPTx.y-z
