...
#else
#define AfxUnionRgn(hrgnResult, hrgnA, hrgnB)                                  \
  CombineRgn(hrgnResult, hrgnA, hrgnB, RGN_OR)
#define AfxXorRgn(hrgnResult, hrgnA, hrgnB)                                    \
  CombineRgn(hrgnResult, hrgnA, hrgnB, RGN_XOR)
#endif
...
#define FORWARD_WM_SHOWWINDOW(hwnd, fShow, status, fn)                         \
  (void)(fn)((hwnd), WM_SHOWWINDOW, (WPARAM)(BOOL)(fShow),                     \
             (LPARAM)(UINT)(status))
...
#define FORWARD_WM_WINDOWPOSCHANGED(hwnd, lpwpos, fn)                          \
  (void)(fn)((hwnd), WM_WINDOWPOSCHANGED, 0L,                                  \
...
/* UINT Cls_OnNCCalcSize(HWND hwnd, BOOL fCalcValidRects, NCCALCSIZE_PARAMS *
 * lpcsp) */
#define HANDLE_WM_NCCALCSIZE(hwnd, wParam, lParam, fn)                         \
  (LRESULT)(DWORD)(UINT)(fn)((hwnd), (BOOL)(wParam),                           \
...
/* void Cls_OnActivate(HWND hwnd, UINT state, HWND hwndActDeact, BOOL
 * fMinimized) */
...
/* BOOL Cls_OnNCActivate(HWND hwnd, BOOL fActive, HWND hwndActDeact, BOOL
 * fMinimized) */
...
/* void Cls_OnLButtonDown(HWND hwnd, BOOL fDoubleClick, int x, int y, UINT
 * keyFlags) */
...
/* void Cls_OnRButtonDown(HWND hwnd, BOOL fDoubleClick, int x, int y, UINT
 * keyFlags) */
...
/* void Cls_OnMButtonDown(HWND hwnd, BOOL fDoubleClick, int x, int y, UINT
 * keyFlags) */
...
/* int Cls_OnMouseActivate(HWND hwnd, HWND hwndTopLevel, UINT codeHitTest, UINT
 * msg) */
...
/* void Cls_OnMenuSelect(HWND hwnd, HMENU hmenu, int item, HMENU hmenuPopup,
 * UINT flags) */
...
#define HANDLE_WM_MDIACTIVATE(hwnd, wParam, lParam, fn)                        \
  ((fn)((hwnd), (BOOL)(lParam == (LPARAM)hwnd), (HWND)(lParam),                \
        (HWND)(wParam)),                                                       \
   0L)
...
#define HANDLE_WM_MDISETMENU(hwnd, wParam, lParam, fn)                         \
  (LRESULT)(UINT_PTR)(fn)((hwnd), (BOOL)(wParam), (HMENU)(wParam),             \
                          (HMENU)(lParam))
...
#define HANDLE_WM_CONTEXTMENU(hwnd, wParam, lParam, fn)                        \
  ((fn)((hwnd), (HWND)(wParam), (int)(short)LOWORD(lParam),                    \
        (int)(short)HIWORD(lParam)),                                           \
   0L)
...
#define FORWARD_WM_COPYDATA(hwnd, hwndFrom, pcds, fn)                          \
  (BOOL)(UINT)(DWORD)(fn)((hwnd), WM_COPYDATA, (WPARAM)(hwndFrom),             \
                          (LPARAM)(pcds))
...
#define Static_SetIcon(hwndCtl, hIcon)                                         \
  ((HICON)(UINT_PTR)SNDMSG((hwndCtl), STM_SETICON, (WPARAM)(HICON)(hIcon), 0L))
#define Static_GetIcon(hwndCtl, hIcon)                                         \
  ((HICON)(UINT_PTR)SNDMSG((hwndCtl), STM_GETICON, 0L, 0L))
...
#define Button_SetCheck(hwndCtl, check)                                        \
  ((void)SNDMSG((hwndCtl), BM_SETCHECK, (WPARAM)(int)(check), 0L))

#define Button_GetState(hwndCtl)                                               \
  ((int)(DWORD)SNDMSG((hwndCtl), BM_GETSTATE, 0L, 0L))
#define Button_SetState(hwndCtl, state)                                        \
  ((UINT)(DWORD)SNDMSG((hwndCtl), BM_SETSTATE, (WPARAM)(int)(state), 0L))
...
#define Edit_GetLineCount(hwndCtl)                                             \
  ((int)(DWORD)SNDMSG((hwndCtl), EM_GETLINECOUNT, 0L, 0L))
#ifndef _MAC
...
#define Edit_GetRect(hwndCtl, lprc)                                            \
  ((void)SNDMSG((hwndCtl), EM_GETRECT, 0L, (LPARAM)(RECT *)(lprc)))
#define Edit_SetRect(hwndCtl, lprc)                                            \
  ((void)SNDMSG((hwndCtl), EM_SETRECT, 0L, (LPARAM)(const RECT *)(lprc)))
#define Edit_SetRectNoPaint(hwndCtl, lprc)                                     \
  ((void)SNDMSG((hwndCtl), EM_SETRECTNP, 0L, (LPARAM)(const RECT *)(lprc)))
...
#define Edit_ReplaceSel(hwndCtl, lpszReplace)                                  \
  ((void)SNDMSG((hwndCtl), EM_REPLACESEL, 0L, (LPARAM)(LPCTSTR)(lpszReplace)))

#define Edit_GetModify(hwndCtl)                                                \
  ((BOOL)(DWORD)SNDMSG((hwndCtl), EM_GETMODIFY, 0L, 0L))
#define Edit_SetModify(hwndCtl, fModified)                                     \
  ((void)SNDMSG((hwndCtl), EM_SETMODIFY, (WPARAM)(UINT)(fModified), 0L))

#define Edit_ScrollCaret(hwndCtl)                                              \
  ((BOOL)(DWORD)SNDMSG((hwndCtl), EM_SCROLLCARET, 0, 0L))

#define Edit_LineFromChar(hwndCtl, ich)                                        \
  ((int)(DWORD)SNDMSG((hwndCtl), EM_LINEFROMCHAR, (WPARAM)(int)(ich), 0L))
#define Edit_LineIndex(hwndCtl, line)                                          \
  ((int)(DWORD)SNDMSG((hwndCtl), EM_LINEINDEX, (WPARAM)(int)(line), 0L))
#define Edit_LineLength(hwndCtl, line)                                         \
  ((int)(DWORD)SNDMSG((hwndCtl), EM_LINELENGTH, (WPARAM)(int)(line), 0L))

#define Edit_Scroll(hwndCtl, dv, dh)                                           \
  ((void)SNDMSG((hwndCtl), EM_LINESCROLL, (WPARAM)(dh), (LPARAM)(dv)))

#define Edit_CanUndo(hwndCtl)                                                  \
  ((BOOL)(DWORD)SNDMSG((hwndCtl), EM_CANUNDO, 0L, 0L))
...
#define Edit_SetPasswordChar(hwndCtl, ch)                                      \
  ((void)SNDMSG((hwndCtl), EM_SETPASSWORDCHAR, (WPARAM)(UINT)(ch), 0L))
...
#define Edit_FmtLines(hwndCtl, fAddEOL)                                        \
  ((BOOL)(DWORD)SNDMSG((hwndCtl), EM_FMTLINES, (WPARAM)(BOOL)(fAddEOL), 0L))

#define Edit_GetHandle(hwndCtl)                                                \
  ((HLOCAL)(UINT_PTR)SNDMSG((hwndCtl), EM_GETHANDLE, 0L, 0L))
#define Edit_SetHandle(hwndCtl, h)                                             \
  ((void)SNDMSG((hwndCtl), EM_SETHANDLE, (WPARAM)(UINT_PTR)(HLOCAL)(h), 0L))

#if (WINVER >= 0x030a)
#define Edit_GetFirstVisibleLine(hwndCtl)                                      \
  ((int)(DWORD)SNDMSG((hwndCtl), EM_GETFIRSTVISIBLELINE, 0L, 0L))

#define Edit_SetReadOnly(hwndCtl, fReadOnly)                                   \
  ((BOOL)(DWORD)SNDMSG((hwndCtl), EM_SETREADONLY, (WPARAM)(BOOL)(fReadOnly),   \
                       0L))

#define Edit_GetPasswordChar(hwndCtl)                                          \
  ((TCHAR)(DWORD)SNDMSG((hwndCtl), EM_GETPASSWORDCHAR, 0L, 0L))

#define Edit_SetWordBreakProc(hwndCtl, lpfnWordBreak)                          \
  ((void)SNDMSG((hwndCtl), EM_SETWORDBREAKPROC, 0L,                            \
                (LPARAM)(EDITWORDBREAKPROC)(lpfnWordBreak)))
#define Edit_GetWordBreakProc(hwndCtl)                                         \
  ((EDITWORDBREAKPROC)SNDMSG((hwndCtl), EM_GETWORDBREAKPROC, 0L, 0L))
#endif /* WINVER >= 0x030a */
...
#define ListBox_SetSel(hwndCtl, fSelect, index)                                \
  ((int)(DWORD)SNDMSG((hwndCtl), LB_SETSEL, (WPARAM)(BOOL)(fSelect),           \
                      (LPARAM)(index)))
#define ListBox_SelItemRange(hwndCtl, fSelect, first, last)                    \
  ((int)(DWORD)SNDMSG((hwndCtl), LB_SELITEMRANGE, (WPARAM)(BOOL)(fSelect),     \
...
#define ListBox_SetTabStops(hwndCtl, cTabs, lpTabs)                            \
  ((BOOL)(DWORD)SNDMSG((hwndCtl), LB_SETTABSTOPS, (WPARAM)(int)(cTabs),        \
                       (LPARAM)(int *)(lpTabs)))
...
#define ComboBox_LimitText(hwndCtl, cchLimit)                                  \
  ((int)(DWORD)SNDMSG((hwndCtl), CB_LIMITTEXT, (WPARAM)(int)(cchLimit), 0L))

#define ComboBox_GetEditSel(hwndCtl)                                           \
  ((DWORD)SNDMSG((hwndCtl), CB_GETEDITSEL, 0L, 0L))
#define ComboBox_SetEditSel(hwndCtl, ichStart, ichEnd)                         \
  ((int)(DWORD)SNDMSG((hwndCtl), CB_SETEDITSEL, 0L,                            \
                      MAKELPARAM((ichStart), (ichEnd))))

#define ComboBox_GetCount(hwndCtl)                                             \
  ((int)(DWORD)SNDMSG((hwndCtl), CB_GETCOUNT, 0L, 0L))
...
#define ComboBox_AddItemData(hwndCtl, data)                                    \
  ((int)(DWORD)SNDMSG((hwndCtl), CB_ADDSTRING, 0L, (LPARAM)(data)))
#define ComboBox_InsertItemData(hwndCtl, index, data)                          \
  ((int)(DWORD)SNDMSG((hwndCtl), CB_INSERTSTRING, (WPARAM)(int)(index),        \
                      (LPARAM)(data)))

#define ComboBox_DeleteString(hwndCtl, index)                                  \
  ((int)(DWORD)SNDMSG((hwndCtl), CB_DELETESTRING, (WPARAM)(int)(index), 0L))

#define ComboBox_GetLBTextLen(hwndCtl, index)                                  \
  ((int)(DWORD)SNDMSG((hwndCtl), CB_GETLBTEXTLEN, (WPARAM)(int)(index), 0L))
...
#define ComboBox_GetCurSel(hwndCtl)                                            \
  ((int)(DWORD)SNDMSG((hwndCtl), CB_GETCURSEL, 0L, 0L))
...
#define ComboBox_ShowDropdown(hwndCtl, fShow)                                  \
  ((BOOL)(DWORD)SNDMSG((hwndCtl), CB_SHOWDROPDOWN, (WPARAM)(BOOL)(fShow), 0L))
...
#define ComboBox_GetDroppedState(hwndCtl)                                      \
  ((BOOL)(DWORD)SNDMSG((hwndCtl), CB_GETDROPPEDSTATE, 0L, 0L))
#define ComboBox_GetDroppedControlRect(hwndCtl, lprc)                          \
  ((void)SNDMSG((hwndCtl), CB_GETDROPPEDCONTROLRECT, 0L,                       \
                (LPARAM)(RECT *)(lprc)))

#define ComboBox_GetItemHeight(hwndCtl)                                        \
  ((int)(DWORD)SNDMSG((hwndCtl), CB_GETITEMHEIGHT, 0L, 0L))
...
#define ComboBox_GetExtendedUI(hwndCtl)                                        \
  ((UINT)(DWORD)SNDMSG((hwndCtl), CB_GETEXTENDEDUI, 0L, 0L))
#define ComboBox_SetExtendedUI(hwndCtl, flags)                                 \
  ((int)(DWORD)SNDMSG((hwndCtl), CB_SETEXTENDEDUI, (WPARAM)(UINT)(flags), 0L))
#endif /* WINVER >= 0x030a */
