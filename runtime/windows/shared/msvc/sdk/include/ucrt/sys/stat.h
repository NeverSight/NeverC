...
#if !defined RC_INVOKED && !defined __midl && !__STDC__ &&                     \
    !defined _CRT_NO_TIME_T
#ifdef _USE_32BIT_TIME_T

static __inline int __CRTDECL fstat(int const _FileHandle,
...
static __inline int __CRTDECL stat(char const *const _FileName,
                                   struct stat *const _Stat) {
  _STATIC_ASSERT(sizeof(struct stat) == sizeof(struct _stat32));
