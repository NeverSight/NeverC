...
//
// Predefine _CRT_STDIO_LEGACY_WIDE_SPECIFIERS to use VC++ 2013 and earlier
// behavior for the wide string printf and scanf functions (%s, %c, and %[]
// specifiers).
//
...
#pragma comment(linker, "/include:" _CRT_INTERNAL_STDIO_SYMBOL_PREFIX          \
                        "__PLEASE_LINK_WITH_iso_stdio_wide_specifiers.lib")
#endif
