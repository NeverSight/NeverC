...
template <typename T> class DependentFalse {
public:
  enum { value = false };
};
...
template <typename T> class NumericType {
public:
  enum { isBool = false, isFloat = false, isInt = false };
};

template <typename T> class IntTraits {
public:
  static_assert(NumericType<T>::isInt || NumericType<T>::isBool,
                "non-integral type T");
  enum {
...
#pragma warning(disable : 4310)
  const static T maxInt =
      isSigned ? ((T) ~((T)1 << (T)(bitCount - 1))) : ((T)(~(T)0));
...
template <typename T, int Method = GetAbsMethod<T>::method>
...
public:
  static T Abs(T t) throw() {
    ...
    _ASSERTE(("AbsValueHelper::Abs should not be called with an unsigned "
              "integer type",
              0));
    return t;
  }
...
class NegationHelper<T, E, true> // Signed
{
public:
...
template <typename T, typename E>
class NegationHelper<T, E, false> // unsigned
{
public:
  ...
  enum {
    method = (IntTraits<FromType>::isBool && !IntTraits<ToType>::isBool)
             ...
             (!IntTraits<FromType>::isBool && IntTraits<ToType>::isBool)
                 ? CastToBool
             : (NumericType<FromType>::isFloat && !NumericType<ToType>::isFloat)
                 ? CastFromFloat
             :

             (SafeIntCompare<ToType, FromType>::isCastOK ||
              (NumericType<ToType>::isFloat && !NumericType<FromType>::isFloat))
                 ? CastOK
             :
...
template <typename T, typename U, typename E,
          int Method = GetCastMethod<T, U>::method>
...
template <typename T, typename U, int Method = ValidComparison<T, U>::method>
class EqualityTest;
...
template <typename T, typename U, typename E,
          int Method = ValidComparison<T, U>::method>
class ModulusHelper;
...
template <typename T, typename U, typename E,
          int Method = MultiplicationMethod<T, U>::method>
...
public:
  static SafeIntError RegMultiply(const unsigned __int64 &a,
...
public:
  static SafeIntError RegMultiply(const unsigned __int64 &a, unsigned __int32 b,
                                  unsigned __int64 &ret) {
...
public:
  static SafeIntError RegMultiply(const unsigned __int64 &a, signed __int32 b,
                                  unsigned __int64 &ret) {
    if (b < 0 && a != 0) {
      E::SafeIntOnOverflow();
      return SafeIntArithmeticOverflow;
    ...
    return LargeIntRegMultiply<unsigned __int64, unsigned __int32,
                               E>::RegMultiply(a, (unsigned __int32)b, ret);
  }
};
...
public:
  static SafeIntError RegMultiply(const unsigned __int64 &a, signed __int64 b,
                                  unsigned __int64 &ret) {
    if (b < 0 && a != 0) {
      E::SafeIntOnOverflow();
      return SafeIntArithmeticOverflow;
    ...
    return LargeIntRegMultiply<unsigned __int64, unsigned __int64,
                               E>::RegMultiply(a, (unsigned __int64)b, ret);
  }
};
...
public:
  static SafeIntError RegMultiply(signed __int32 a, const unsigned __int64 &b,
                                  signed __int32 &ret) {
...
public:
  static SafeIntError RegMultiply(unsigned __int32 a, const unsigned __int64 &b,
...
public:
  static SafeIntError RegMultiply(unsigned __int32 a, const signed __int64 &b,
                                  unsigned __int32 &ret) {
    if (b < 0 && a != 0) {
      E::SafeIntOnOverflow();
      return SafeIntArithmeticOverflow;
    ...
    return LargeIntRegMultiply<unsigned __int32, unsigned __int64,
                               E>::RegMultiply(a, (unsigned __int64)b, ret);
  }
};
...
public:
  static SafeIntError RegMultiply(const signed __int64 &a,
    ...
    if (LargeIntRegMultiply<unsigned __int64, unsigned __int64, E>::RegMultiply(
            (unsigned __int64)a1, (unsigned __int64)b1,
...
public:
  static SafeIntError RegMultiply(const signed __int64 &a, unsigned __int32 b,
                                  signed __int64 &ret) {
    bool aNegative = false;
    unsigned __int64 tmp;
    __int64 a1 = a;
    ...
    if (LargeIntRegMultiply<unsigned __int64, unsigned __int32, E>::RegMultiply(
            (unsigned __int64)a1, b, tmp) == SafeIntNoError) {
      // The unsigned multiplication didn't overflow
      if (aNegative) {
        // Result must be negative
        if (tmp <= (unsigned __int64)IntTraits<signed __int64>::minInt) {
...
public:
  static SafeIntError RegMultiply(const signed __int64 &a, signed __int32 b,
                                  signed __int64 &ret) {
    bool aNegative = false;
    bool bNegative = false;
    ...
    if (LargeIntRegMultiply<unsigned __int64, unsigned __int32, E>::RegMultiply(
            (unsigned __int64)a1, (unsigned __int32)b1,
            (unsigned __int64)tmp) == SafeIntNoError) {
      // The unsigned multiplication didn't overflow
      if (aNegative ^ bNegative) {
        // Result must be negative
...
public:
  static SafeIntError RegMultiply(signed __int32 a, const signed __int64 &b,
                                  signed __int32 &ret) {
    bool aNegative = false;
    bool bNegative = false;
    ...
    if (LargeIntRegMultiply<unsigned __int32, unsigned __int64, E>::RegMultiply(
            (unsigned __int32)a, (unsigned __int64)b1, tmp) == SafeIntNoError) {
      // The unsigned multiplication didn't overflow
      if (aNegative ^ bNegative) {
        // Result must be negative
...
public:
  static SafeIntError RegMultiply(const signed __int64 &a,
    ...
    if (LargeIntRegMultiply<unsigned __int64, unsigned __int64, E>::RegMultiply(
            (unsigned __int64)a1, (unsigned __int64)b, tmp) == SafeIntNoError) {
      // The unsigned multiplication didn't overflow
      if (aNegative) {
        // Result must be negative
        if (tmp <= (unsigned __int64)IntTraits<signed __int64>::minInt) {
...
template <typename E>
class MultiplicationHelper<unsigned __int64, unsigned __int64, E,
                           MultiplicationState_Uint64Uint64> {
public:
  static SafeIntError Multiply(const unsigned __int64 &t,
                               const unsigned __int64 &u,
                               unsigned __int64 &ret) {
    return LargeIntRegMultiply<unsigned __int64, unsigned __int64,
                               E>::RegMultiply(t, u, ret);
  }
};

template <typename U, typename E>
class MultiplicationHelper<unsigned __int64, U, E,
                           MultiplicationState_Uint64Uint> {
public:
  // U is any unsigned int 32-bit or less
  static SafeIntError Multiply(const unsigned __int64 &t, const U &u,
                               unsigned __int64 &ret) {
    return LargeIntRegMultiply<unsigned __int64, unsigned __int32,
                               E>::RegMultiply(t, (unsigned __int32)u, ret);
  }
};

// converse of the previous function
template <typename T, typename E>
class MultiplicationHelper<T, unsigned __int64, E,
                           MultiplicationState_UintUint64> {
public:
  ...
  static SafeIntError Multiply(const T &t, const unsigned __int64 &u, T &ret) {
    ...
    if (LargeIntRegMultiply<unsigned __int32, unsigned __int64, E>::RegMultiply(
            t, u, tmp) == SafeIntNoError &&
        SafeCastHelper<T, unsigned __int32, E>::Cast(tmp, ret) ==
            SafeIntNoError) {
      return SafeIntNoError;
    }
...
public:
  ...
  static SafeIntError Multiply(const unsigned __int64 &t, const U &u,
                               unsigned __int64 &ret) {
    return LargeIntRegMultiply<unsigned __int64, signed __int32,
                               E>::RegMultiply(t, (signed __int32)u, ret);
  }
};

template <typename E>
class MultiplicationHelper<unsigned __int64, __int64, E,
                           MultiplicationState_Uint64Int64> {
public:
  static SafeIntError Multiply(const unsigned __int64 &t, const __int64 &u,
                               unsigned __int64 &ret) {
    return LargeIntRegMultiply<unsigned __int64, __int64, E>::RegMultiply(t, u,
                                                                          ret);
  }
};
...
public:
  ...
  static SafeIntError Multiply(const T &t, const __int64 &u, T &ret) {
    ...
    if (LargeIntRegMultiply<unsigned __int32, __int64, E>::RegMultiply(
            (unsigned __int32)t, u, tmp) == SafeIntNoError &&
        SafeCastHelper<T, unsigned __int32, E>::Cast(tmp, ret) ==
            SafeIntNoError) {
      return SafeIntNoError;
    }
...
public:
  ...
  static SafeIntError Multiply(const __int64 &t, const U &u, __int64 &ret) {
    return LargeIntRegMultiply<__int64, unsigned __int32, E>::RegMultiply(
        t, (unsigned __int32)u, ret);
  }
};

template <typename E>
class MultiplicationHelper<__int64, __int64, E,
                           MultiplicationState_Int64Int64> {
public:
  static SafeIntError Multiply(const __int64 &t, const __int64 &u,
                               __int64 &ret) {
...
public:
  ...
  static SafeIntError Multiply(const __int64 &t, U u, __int64 &ret) {
    return LargeIntRegMultiply<__int64, __int32, E>::RegMultiply(t, (__int32)u,
                                                                 ret);
  }
};
...
public:
  ...
  static SafeIntError Multiply(T t, const unsigned __int64 &u, T &ret) {
    ...
    if (LargeIntRegMultiply<__int32, unsigned __int64, E>::RegMultiply(
            (__int32)t, u, tmp) == SafeIntNoError &&
...
template <typename E>
class MultiplicationHelper<__int64, unsigned __int64, E,
                           MultiplicationState_Int64Uint64> {
public:
  // U is signed up to 32-bit
  static SafeIntError Multiply(const __int64 &t, const unsigned __int64 &u,
                               __int64 &ret) {
    return LargeIntRegMultiply<__int64, unsigned __int64, E>::RegMultiply(t, u,
                                                                          ret);
  }
};
...
public:
  ...
  static SafeIntError Multiply(T t, const __int64 &u, T &ret) {
    ...
    if (LargeIntRegMultiply<__int32, __int64, E>::RegMultiply(
            (__int32)t, u, tmp) == SafeIntNoError &&
        SafeCastHelper<T, __int32, E>::Cast(tmp, ret) == SafeIntNoError) {
      return SafeIntNoError;
    }
...
template <typename T, typename U, typename E,
          int Method = DivisionMethod<T, U>::method>
...
template <typename T, typename U, typename E,
          int Method = AdditionMethod<T, U>::method>
...
public:
  static SafeIntError Addition(const T &lhs, const U &rhs, T &result) {
    ...
    if (rhs < 0) {
      if (lhs >=
          (unsigned __int64)(-rhs)) // negation is safe, since rhs is 64-bit
      {
        result = (T)(lhs + rhs);
        return SafeIntNoError;
      }
...
public:
  static SafeIntError Addition(const T &lhs, const U &rhs, T &result) {
    ...
    if (AdditionHelper<__int64, __int64, E,
                       AdditionState_CastInt64CheckOverflow>::Addition((__int64)
                                                                           lhs,
                                                                       (__int64)
                                                                           rhs,
                                                                       tmp) ==
...
template <typename E>
class AdditionHelper<__int64, unsigned __int64, E,
                     AdditionState_ManualCheckInt64Uint64> {
public:
  static SafeIntError Addition(const __int64 &lhs, const unsigned __int64 &rhs,
                               __int64 &result) throw() {
...
template <typename T, typename U, typename E,
          int Method = SubtractionMethod<T, U>::method>
...
template <typename E>
class SubtractionHelper<__int64, unsigned __int64, E,
                        SubtractionState_Int64Uint64> {
public:
  static SafeIntError Subtract(const __int64 &lhs, const unsigned __int64 &rhs,
                               __int64 &result) {
...
template <typename T, typename U, int Method = BinaryMethod<T, U>::method>
