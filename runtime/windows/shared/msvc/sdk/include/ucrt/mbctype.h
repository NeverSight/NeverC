...
#define _ismbbalnum(_c)                                                        \
  (((_pctype)[(unsigned char)(_c)] & (_ALPHA | _DIGIT)) || _ismbbkalnum(_c))
#define _ismbbalpha(_c)                                                        \
  (((_pctype)[(unsigned char)(_c)] & (_ALPHA)) || _ismbbkalnum(_c))
#define _ismbbgraph(_c)                                                        \
  (((_pctype)[(unsigned char)(_c)] & (_PUNCT | _ALPHA | _DIGIT)) ||            \
   _ismbbkprint(_c))
#define _ismbbprint(_c)                                                        \
  (((_pctype)[(unsigned char)(_c)] & (_BLANK | _PUNCT | _ALPHA | _DIGIT)) ||   \
   _ismbbkprint(_c))
#define _ismbbpunct(_c)                                                        \
  (((_pctype)[(unsigned char)(_c)] & (_PUNCT)) || _ismbbkpunct(_c))
#define _ismbbblank(_c)                                                        \
  (((_c) == '\t') ? _BLANK : (_pctype)[(unsigned char)(_c)] & _BLANK)
