...
_Success_(return == 0) _Check_return_ _DCRTIMP
    unsigned __cdecl _getdiskfree(_In_ unsigned _Drive,
...
_Success_(return != 0) _Check_return_ _Ret_maybenull_z_ _ACRTIMP _CRTALLOCATOR
    char *__cdecl _getcwd(_Out_writes_opt_z_(_SizeInBytes) char *_DstBuf,
                          _In_ int _SizeInBytes);

_Success_(return != 0) _Check_return_ _Ret_maybenull_z_ _ACRTIMP _CRTALLOCATOR
    char *__cdecl
    _getdcwd(_In_ int _Drive, _Out_writes_opt_z_(_SizeInBytes) char *_DstBuf,
             _In_ int _SizeInBytes);
...
_Success_(return != 0) _Check_return_ _Ret_maybenull_z_
    _CRT_NONSTDC_DEPRECATE(_getcwd)
_DCRTIMP char *__cdecl getcwd(_Out_writes_opt_z_(_SizeInBytes) char *_DstBuf,
                              _In_ int _SizeInBytes);

#pragma pop_macro("getcwd")

_Check_return_ _CRT_NONSTDC_DEPRECATE(_chdir)
_DCRTIMP int __cdecl chdir(_In_z_ char const *_Path);
...
_ACRTIMP int __cdecl mkdir(_In_z_ char const *_Path);

_Check_return_ _CRT_NONSTDC_DEPRECATE(_rmdir)
_ACRTIMP int __cdecl rmdir(_In_z_ char const *_Path);
