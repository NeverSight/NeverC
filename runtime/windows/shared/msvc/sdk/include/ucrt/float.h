...
#ifdef _M_CEE
#define _CRT_MANAGED_FP_DEPRECATE                                              \
  _CRT_DEPRECATE_TEXT("Direct floating point control is not supported or "     \
                      "reliable from within managed code. ")
#else
#define _CRT_MANAGED_FP_DEPRECATE
#endif
#endif
...
// fenv_access/fp_contract #pragmas may alter the actual floating point
// evaluation method, which may in turn invalidate the value of FLT_EVAL_METHOD.
#ifdef _M_FP_FAST
...
#define _DN_FLUSH_OPERANDS_SAVE_RESULTS                                        \
  0x02000000 // flush operands to zero and save results
#define _DN_SAVE_OPERANDS_FLUSH_RESULTS                                        \
  0x03000000 // save operands and flush results to zero
...
_ACRTIMP unsigned int __cdecl _controlfp(_In_ unsigned int _NewValue,
                                         _In_ unsigned int _Mask);

#pragma warning(pop)

_CRT_MANAGED_FP_DEPRECATE
_ACRTIMP void __cdecl _set_controlfp(_In_ unsigned int _NewValue,
                                     _In_ unsigned int _Mask);

_CRT_MANAGED_FP_DEPRECATE
_ACRTIMP errno_t __cdecl _controlfp_s(_Out_opt_ unsigned int *_CurrentState,
...
_CRT_MANAGED_FP_DEPRECATE
_ACRTIMP void __cdecl _statusfp2(_Out_opt_ unsigned int *_X86Status,
...
_CRT_MANAGED_FP_DEPRECATE
_ACRTIMP unsigned int __cdecl _control87(_In_ unsigned int _NewValue,
                                         _In_ unsigned int _Mask);

#ifdef _M_IX86
_CRT_MANAGED_FP_DEPRECATE
_ACRTIMP int __cdecl __control87_2(_In_ unsigned int _NewValue,
                                   _In_ unsigned int _Mask,
