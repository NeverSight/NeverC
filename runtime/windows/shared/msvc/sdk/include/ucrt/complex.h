...
//
//-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+
inline _Dcomplex __CRTDECL acos(_In_ _Dcomplex _X) throw() { return cacos(_X); }

inline _Dcomplex __CRTDECL acosh(_In_ _Dcomplex _X) throw() {
  return cacosh(_X);
}

inline _Dcomplex __CRTDECL asin(_In_ _Dcomplex _X) throw() { return casin(_X); }

inline _Dcomplex __CRTDECL asinh(_In_ _Dcomplex _X) throw() {
  return casinh(_X);
}

inline _Dcomplex __CRTDECL atan(_In_ _Dcomplex _X) throw() { return catan(_X); }

inline _Dcomplex __CRTDECL atanh(_In_ _Dcomplex _X) throw() {
  return catanh(_X);
}

inline _Dcomplex __CRTDECL cos(_In_ _Dcomplex _X) throw() { return ccos(_X); }

inline _Dcomplex __CRTDECL cosh(_In_ _Dcomplex _X) throw() { return ccosh(_X); }

inline _Dcomplex __CRTDECL proj(_In_ _Dcomplex _X) throw() { return cproj(_X); }

inline _Dcomplex __CRTDECL exp(_In_ _Dcomplex _X) throw() { return cexp(_X); }

inline _Dcomplex __CRTDECL log(_In_ _Dcomplex _X) throw() { return clog(_X); }
...
inline _Dcomplex __CRTDECL sin(_In_ _Dcomplex _X) throw() { return csin(_X); }

inline _Dcomplex __CRTDECL sinh(_In_ _Dcomplex _X) throw() { return csinh(_X); }

inline _Dcomplex __CRTDECL sqrt(_In_ _Dcomplex _X) throw() { return csqrt(_X); }

inline _Dcomplex __CRTDECL tan(_In_ _Dcomplex _X) throw() { return ctan(_X); }

inline _Dcomplex __CRTDECL tanh(_In_ _Dcomplex _X) throw() { return ctanh(_X); }

inline double __CRTDECL abs(_In_ _Dcomplex _X) throw() { return cabs(_X); }

inline double __CRTDECL arg(_In_ _Dcomplex _X) throw() { return carg(_X); }

inline double __CRTDECL imag(_In_ _Dcomplex _X) throw() { return cimag(_X); }

inline double __CRTDECL real(_In_ _Dcomplex _X) throw() { return creal(_X); }
...
inline _Fcomplex __CRTDECL conj(_In_ _Fcomplex _X) throw() { return conjf(_X); }

inline _Fcomplex __CRTDECL cos(_In_ _Fcomplex _X) throw() { return ccosf(_X); }
...
inline _Fcomplex __CRTDECL exp(_In_ _Fcomplex _X) throw() { return cexpf(_X); }

inline _Fcomplex __CRTDECL log(_In_ _Fcomplex _X) throw() { return clogf(_X); }

inline _Fcomplex __CRTDECL log10(_In_ _Fcomplex _X) throw() {
  return clog10f(_X);
}

inline float __CRTDECL norm(_In_ _Fcomplex _X) throw() { return normf(_X); }

inline _Fcomplex __CRTDECL pow(_In_ _Fcomplex _X, _In_ _Fcomplex _Y) throw() {
  return cpowf(_X, _Y);
}

inline _Fcomplex __CRTDECL sin(_In_ _Fcomplex _X) throw() { return csinf(_X); }
...
inline _Fcomplex __CRTDECL tan(_In_ _Fcomplex _X) throw() { return ctanf(_X); }

inline _Fcomplex __CRTDECL tanh(_In_ _Fcomplex _X) throw() {
  return ctanhf(_X);
}

inline float __CRTDECL abs(_In_ _Fcomplex _X) throw() { return cabsf(_X); }

inline float __CRTDECL arg(_In_ _Fcomplex _X) throw() { return cargf(_X); }

inline float __CRTDECL carg(_In_ _Fcomplex _X) throw() { return cargf(_X); }

inline float __CRTDECL cimag(_In_ _Fcomplex _X) throw() { return cimagf(_X); }

inline float __CRTDECL creal(_In_ _Fcomplex _X) throw() { return crealf(_X); }

inline float __CRTDECL imag(_In_ _Fcomplex _X) throw() { return cimagf(_X); }

inline float __CRTDECL real(_In_ _Fcomplex _X) throw() { return crealf(_X); }
...
inline _Lcomplex __CRTDECL conj(_In_ _Lcomplex _X) throw() { return conjl(_X); }

inline _Lcomplex __CRTDECL cos(_In_ _Lcomplex _X) throw() { return ccosl(_X); }
...
inline _Lcomplex __CRTDECL exp(_In_ _Lcomplex _X) throw() { return cexpl(_X); }

inline _Lcomplex __CRTDECL log(_In_ _Lcomplex _X) throw() { return clogl(_X); }
...
inline _Lcomplex __CRTDECL sin(_In_ _Lcomplex _X) throw() { return csinl(_X); }
...
inline _Lcomplex __CRTDECL tan(_In_ _Lcomplex _X) throw() { return ctanl(_X); }
