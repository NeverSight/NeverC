...
_When_(_Param_(1) == 0, _Post_equal_to_(0)) _Check_return_ _ACRTIMP int __cdecl
...
_iswctype_l(_In_ wint_t _C, _In_ wctype_t _Type, _In_opt_ _locale_t _Locale);

#ifdef _CRT_USE_WINAPI_FAMILY_DESKTOP_APP
_Check_return_ _ACRTIMP int __cdecl isleadbyte(_In_ int _C);
_Check_return_ _ACRTIMP int __cdecl _isleadbyte_l(_In_ int _C,
                                                  _In_opt_ _locale_t _Locale);

_CRT_OBSOLETE(iswctype)
_DCRTIMP int __cdecl is_wctype(_In_ wint_t _C, _In_ wctype_t _Type);
#endif
...
// #else
//    #ifndef _CTYPE_DISABLE_MACROS
//        inline int __cdecl iswalpha (_In_ wint_t _C) { return iswctype(_C,
//        _ALPHA); } inline int __cdecl iswupper (_In_ wint_t _C) { return
//        iswctype(_C, _UPPER); } inline int __cdecl iswlower (_In_ wint_t _C) {
//        return iswctype(_C, _LOWER); } inline int __cdecl iswdigit (_In_
//        wint_t _C) { return iswctype(_C, _DIGIT); } inline int __cdecl
//        iswxdigit(_In_ wint_t _C) { return iswctype(_C, _HEX); } inline int
//        __cdecl iswspace (_In_ wint_t _C) { return iswctype(_C, _SPACE); }
//        inline int __cdecl iswpunct (_In_ wint_t _C) { return iswctype(_C,
//        _PUNCT); } inline int __cdecl iswblank (_In_ wint_t _C) { return
//        (((_C) == '\t') ? _BLANK : iswctype(_C,_BLANK)); } inline int __cdecl
//        iswalnum (_In_ wint_t _C) { return iswctype(_C, _ALPHA | _DIGIT); }
//        inline int __cdecl iswprint (_In_ wint_t _C) { return iswctype(_C,
//        _BLANK | _PUNCT | _ALPHA | _DIGIT); } inline int __cdecl iswgraph
//        (_In_ wint_t _C) { return iswctype(_C, _PUNCT | _ALPHA | _DIGIT); }
//        inline int __cdecl iswcntrl (_In_ wint_t _C) { return iswctype(_C,
//        _CONTROL); } inline int __cdecl iswascii (_In_ wint_t _C) { return
//        (unsigned)(_C) < 0x80; }
//
//        inline int __cdecl _iswalpha_l (_In_ wint_t _C, _In_opt_ _locale_t) {
//        return iswctype(_C, _ALPHA); } inline int __cdecl _iswupper_l (_In_
//        wint_t _C, _In_opt_ _locale_t) { return iswctype(_C, _UPPER); } inline
//        int __cdecl _iswlower_l (_In_ wint_t _C, _In_opt_ _locale_t) { return
//        iswctype(_C, _LOWER); } inline int __cdecl _iswdigit_l (_In_ wint_t
//        _C, _In_opt_ _locale_t) { return iswctype(_C, _DIGIT); } inline int
//        __cdecl _iswxdigit_l(_In_ wint_t _C, _In_opt_ _locale_t) { return
//        iswctype(_C, _HEX); } inline int __cdecl _iswspace_l (_In_ wint_t _C,
//        _In_opt_ _locale_t) { return iswctype(_C, _SPACE); } inline int
//        __cdecl _iswpunct_l (_In_ wint_t _C, _In_opt_ _locale_t) { return
//        iswctype(_C, _PUNCT); } inline int __cdecl _iswblank_l (_In_ wint_t
//        _C, _In_opt_ _locale_t) { return iswctype(_C, _BLANK); } inline int
//        __cdecl _iswalnum_l (_In_ wint_t _C, _In_opt_ _locale_t) { return
//        iswctype(_C, _ALPHA | _DIGIT); } inline int __cdecl _iswprint_l (_In_
//        wint_t _C, _In_opt_ _locale_t) { return iswctype(_C, _BLANK | _PUNCT |
//        _ALPHA | _DIGIT); } inline int __cdecl _iswgraph_l (_In_ wint_t _C,
//        _In_opt_ _locale_t) { return iswctype(_C, _PUNCT | _ALPHA | _DIGIT); }
//        inline int __cdecl _iswcntrl_l (_In_ wint_t _C, _In_opt_ _locale_t) {
