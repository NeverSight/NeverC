...
_Ret_notnull_ _Post_writable_byte_size_(_Size) void *__cdecl
_alloca(_In_ size_t _Size);
...
#define _malloca(size)                                                         \
  __pragma(warning(suppress : 6255 6386))(                                     \
      _MallocaComputeSize(size) != 0                                           \
          ? _MarkAllocaS(malloc(_MallocaComputeSize(size)),                    \
  ...
  __pragma(warning(suppress : 6255 6386))(                                     \
      _MallocaComputeSize(size) != 0                                           \
          ? (((_MallocaComputeSize(size) <= _ALLOCA_S_THRESHOLD)               \
                  ? _MarkAllocaS(_alloca(_MallocaComputeSize(size)),           \
