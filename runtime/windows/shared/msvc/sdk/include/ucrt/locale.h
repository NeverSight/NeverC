...
_Check_return_opt_ _ACRTIMP char *__cdecl
setlocale(_In_ int _Category, _In_opt_z_ char const *_Locale);
...
_create_locale(_In_ int _Category, _In_z_ char const *_Locale);
