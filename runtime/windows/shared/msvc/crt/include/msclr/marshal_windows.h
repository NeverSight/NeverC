...
template <> inline System::String ^ marshal_as(const _bstr_t &_from_object) {
...
template <> inline _bstr_t marshal_as(System::String ^ const &_from_object) {
...
template <> inline System::IntPtr marshal_as(const HANDLE &_from_object) {
...
template <> inline HANDLE marshal_as(System::IntPtr _from_object) {
...
template <>
ref class context_node<BSTR, System::String ^> : public context_node_base {
private:
  System::IntPtr _ip;
