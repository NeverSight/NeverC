...
_CRTIMP2_PURE _Thrd_result __cdecl
_Mtx_unlock(_Mtx_t) noexcept; // TRANSITION, ABI: Always succeeds
...
_CRTIMP2_PURE _Thrd_result __cdecl
_Cnd_wait(_Cnd_t, _Mtx_t) noexcept; // TRANSITION, ABI: Always succeeds
_CRTIMP2_PURE _Thrd_result __cdecl
_Cnd_broadcast(_Cnd_t) noexcept; // TRANSITION, ABI: Always succeeds
_CRTIMP2_PURE _Thrd_result __cdecl
_Cnd_signal(_Cnd_t) noexcept; // TRANSITION, ABI: Always succeeds
_CRTIMP2_PURE void __cdecl _Cnd_register_at_thread_exit(_Cnd_t, _Mtx_t,
                                                        int *) noexcept;
...
// '_unchecked' means it is not checked against the 'steady_clock', so may
// report timeout prematurely
_Thrd_result __stdcall _Cnd_timedwait_for_unchecked(_Cnd_t, _Mtx_t,
...
extern "C++" [[noreturn]] _CRTIMP2_PURE void __cdecl
_Throw_Cpp_error(int _Code);
_STD_END
