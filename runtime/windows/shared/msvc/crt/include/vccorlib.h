...
#pragma detect_mismatch(                                                       \
    "_VCCORLIB_VER",                                                           \
    "1800." _STRINGIZE(__cplusplus_winrt)) // Detect vccorlib mismatch
...
//    This is a force-include file which is used by all /ZW compilations, and
//    akin to a typesrc file. /ZW should be usable to build any existing body of
//    C++ code (including Windows, SQL, Office etc.) As such, the following
//    rules should be observed:
//        * Do not include any header files that have any behavior that can be
//        changed by the user (e.g. #ifdef)
//        * Do not declare a method or typename that can conflict with an
//        existing method or type that comes from a header
//          if the header may modify that type based on user #defines.
//    General rules:
//        * Keep PDB sizes small. Don't overuse templates, and keep identifiers
//        short.
// </InternalComment>
...
__abi_translateCurrentException(bool reserved);
#endif
...
long __stdcall __getActivationFactoryByPCWSTR(void *, ::Platform::Guid &,
                                              void **);
long __stdcall __getIids(int, unsigned long *, const __s_GUID *,
                         ::Platform::Guid **);
} // namespace __winRT
...
struct __abi_WinClassInstrumentation {
  ...
  void
  __abi_SetInstrumentationData(__abi_WinClassInstrumentation *__callbackArg) {
...
/// play unless the user static_casts an implementation type to one of these,
/// but / the WinRT implementation types are hidden.
__interface
    __declspec(uuid("00000000-0000-0000-C000-000000000046")) __abi_IUnknown {
public:
...
__interface
    __declspec(uuid("3C5C94E8-83BB-4622-B76A-B505AE96E0DF")) __abi_Module {
public:
...
__interface
    __declspec(uuid("00000003-0000-0000-C000-000000000046")) __abi_IMarshal;
...
extern "C" void *_InterlockedCompareExchangePointer(void *volatile *, void *,
                                                    void *);
...
public:
  ...
  inline unsigned long Decrement() volatile {
    unsigned long __refCountLoc =
        static_cast<unsigned long>(_InterlockedDecrement(&__refcount));
    if (__refCountLoc == 0) {
      // When destructing objects at the end of the program, we might be freeing
      // objects across dlls, and the dll this object is in might have already
      // freed its module object.
      if (__abi_module != nullptr) {
        __abi_module->__abi_DecrementObjectCount();
      }
    }
...
__interface
    __declspec(uuid("AF86E2E0-B12D-4c6a-9C5A-D7AA65101E90")) __abi_IInspectable
    : public __abi_IUnknown {
  virtual long __stdcall __abi_GetIids(unsigned long *,
                                       ::Platform::Guid **) = 0;
...
__interface
    __declspec(uuid("00000001-0000-0000-C000-000000000046")) __abi_IClassFactory
    : public __abi_IUnknown {
  virtual long __stdcall __abi_CreateInstance(__abi_IUnknown *,
                                              ::Platform::Guid &, void **) = 0;
  virtual long __stdcall __abi_LockServer(int) = 0;
};

__interface __declspec(uuid(
    "00000035-0000-0000-C000-000000000046")) __abi_IActivationFactory
    : public __abi_IInspectable {
  virtual long __stdcall __abi_ActivateInstance(__abi_IInspectable **) = 0;
};

__interface __declspec(uuid(
    "00000037-0000-0000-C000-000000000046")) __abi_IWeakReference
    : public __abi_IUnknown {
  virtual long __stdcall __abi_Resolve(::Platform::Guid &,
                                       __abi_IInspectable **) = 0;
};
...
template <typename T> EventLock *GetStaticEventLock() {
...
// <InternalComment>
// Initialize a set of PCH global roots from some of the types defined above
// this point. Preconditions: The following types must be defined before this
// point:
//                     __abi_IUnknown
//                     __abi_IInspectable
//                     __abi_IClassFactory
...
//                  * From this point on WinRT types can be declared using 'ref
//                  class', 'interface class' etc. BUT must have
//                  __declspec(no_weak_ref)
...
__declspec(no_refcount) void __abi_delete_String(::Platform::String ^);

#if !defined(VCWINRT_DLL)
__declspec(dllimport) __declspec(non_user_code)
    __declspec(no_refcount) ::Platform::Object ^
    __stdcall __abi_cast_String_to_Object(::Platform::String ^);

__declspec(dllimport) __declspec(non_user_code) ::Platform::String ^
    __stdcall __abi_cast_Object_to_String(bool, ::Platform::Object ^);

__declspec(dllimport) __declspec(non_user_code) ::Platform::String ^
    __stdcall __abi_ObjectToString(::Platform::Object ^ o, bool useIPrintable);
...
__declspec(dllexport) __declspec(non_user_code) ::Platform::String ^
    __stdcall __abi_cast_Object_to_String(bool, ::Platform::Object ^);
...
__declspec(no_release_return) inline void *
__abi_winrt_ptr_ctor(const volatile ::Platform::Object ^ const __objArg) {
  __abi_IUnknown *__pUnknown = reinterpret_cast<__abi_IUnknown *>(
      const_cast<::Platform::Object ^>(__objArg));
  if (__pUnknown) {
...
__declspec(non_user_code) __declspec(no_refcount) inline void
__abi_winrt_ptr_dtor(const volatile ::Platform::Object ^ const __objArg) {
  __abi_IUnknown *__pUnknown = reinterpret_cast<__abi_IUnknown *>(
      const_cast<::Platform::Object ^>(__objArg));
  if (__pUnknown) {
...
__declspec(non_user_code) __declspec(no_refcount)
__declspec(no_release_return) inline void *
__abi_winrt_ptr_assign(void **__ppTargetArg,
                       const volatile ::Platform::Object ^ __objArg) {
  __abi_IUnknown *__pUnknown = reinterpret_cast<__abi_IUnknown *>(
      const_cast<::Platform::Object ^>(__objArg));
  __abi_IUnknown **__ppTargetUnknown =
      reinterpret_cast<__abi_IUnknown **>(__ppTargetArg);
...
__declspec(non_user_code) __declspec(no_refcount)
__declspec(no_release_return) inline void *
__abi_winrt_ptrto_delegate_ctor(const volatile T ^ __objArg) {
  return __abi_winrt_ptr_ctor(
      reinterpret_cast<const volatile ::Platform::Object ^>(__objArg));
}

template <typename T>
__declspec(non_user_code) __declspec(no_refcount)
__declspec(no_release_return) inline void
__abi_winrt_ptrto_delegate_dtor(const volatile T ^ __objArg) {
  __abi_winrt_ptr_dtor(
      reinterpret_cast<const volatile ::Platform::Object ^>(__objArg));
}
...
__declspec(non_user_code) __declspec(no_refcount)
__declspec(no_release_return) inline void *
__abi_winrt_ptrto_delegate_assign(void **__ppTargetArg,
                                  const volatile T ^ __objArg) {
  return __abi_winrt_ptr_assign(
      __ppTargetArg,
      reinterpret_cast<const volatile ::Platform::Object ^>(__objArg));
}

// Used for handle which is inside '__declspec(no_refcount)' function but still
// needs Release.
...
public:
  __declspec(non_user_code)
  __abi_dtor_helper(const volatile ::Platform::Object ^ __objArg) {
    __pUnknown = reinterpret_cast<__abi_IUnknown *>(
        const_cast<::Platform::Object ^>(__objArg));
  }
...
// The exceptions are split out explicitly in order to make them obvious from
// callstacks.
#if !defined(VCWINRT_DLL)
__declspec(dllimport)
__declspec(noreturn) void __stdcall __abi_WinRTraiseNotImplementedException();
...
__declspec(dllimport) __declspec(noreturn) void __stdcall
__abi_WinRTraiseCOMException(long);
#else
__declspec(dllexport)
__declspec(noreturn) void __stdcall __abi_WinRTraiseNotImplementedException();
__declspec(dllexport) __declspec(noreturn) void __stdcall
__abi_WinRTraiseInvalidCastException();
__declspec(dllexport) __declspec(noreturn) void __stdcall
__abi_WinRTraiseNullReferenceException();
__declspec(dllexport) __declspec(noreturn) void __stdcall
...
__declspec(non_user_code) __declspec(no_refcount) inline ::Platform::Object ^
    __abi_winrt_cast_to(bool __isDynamicCastArg, ::Platform::Object ^ __objArg,
                        const _GUID &__guidArg) {
  void *__pTo = nullptr;
  __abi_IUnknown *__pUnknown = reinterpret_cast<__abi_IUnknown *>(__objArg);

  if (__pUnknown) {
    // Cast to ::Platform::Guid instead of using conversion in order to avoid
    // copy to temporary
    long __hr = __pUnknown->__abi_QueryInterface(
        reinterpret_cast<::Platform::Guid &>(const_cast<_GUID &>(__guidArg)),
        &__pTo);
...
__declspec(non_user_code) __declspec(no_refcount) inline ::Platform::String ^
    __abi_winrt_cast_to_string(bool __isDynamicCast,
                               ::Platform::Object ^ __objArg) {
  return __abi_details::__abi_cast_Object_to_String(__isDynamicCast, __objArg);
}

__declspec(non_user_code) __declspec(no_refcount) inline ::Platform::Object ^
    __abi_winrt_cast_from_string_to_object(bool /*__isDynamicCastArg*/,
                                           ::Platform::String ^ __objArg) {
  return __abi_details::__abi_cast_String_to_Object(__objArg);
}

__declspec(non_user_code) __declspec(no_refcount) inline ::Platform::Object ^
    __abi_winrt_cast_from_string_to_other(bool /*__isDynamicCastArg*/,
                                          ::Platform::String ^
                                          /*__objArg*/) {
  __abi_WinRTraiseInvalidCastException();
}
...
template <typename T>
    __declspec(non_user_code) __declspec(no_refcount) inline T ^
    __abi_winrt_cast_from_object_to_delegate(bool __isDynamicCast,
                                             ::Platform::Object ^ __objArg);

template <typename T>
    __declspec(non_user_code)
    __declspec(no_refcount) inline ::Platform::Object ^
    __abi_winrt_cast_from_delegate_to_object(bool __isDynamicCastArg,
                                             T ^ __objArg);

template <typename T>
    __declspec(non_user_code)
    __declspec(no_refcount) inline ::Platform::Object ^
    __abi_winrt_cast_from_delegate_to_other(bool __isDynamicCastArg,
                                            T ^ __objArg,
                                            const _GUID &__guidArg) {
  return __abi_winrt_cast_to(__isDynamicCastArg,
                             reinterpret_cast<::Platform::Object ^>(__objArg),
                             __guidArg);
}
...
__declspec(non_user_code) __declspec(no_refcount) inline void
__abi_winrt_ptrto_string_dtor(const volatile ::Platform::String ^
                              const __objArg) {
  __abi_details::__abi_delete_String(
      const_cast<::Platform::String ^>(__objArg));
}

__declspec(non_user_code) inline void
__abi_winrt_throw_on_disposed(bool isDisposed) {
  if (isDisposed) {
    __abi_WinRTraiseObjectDisposedException();
  }
}
...
__Platform_CoCreateFreeThreadedMarshaler(::Platform::Object ^,
                                         ::Platform::Object ^ *);
#endif
...
template <typename __TArg, unsigned int __dimension = 1> ref class Array;
} // namespace Platform

template <typename __TArg, unsigned int __dimension>
__declspec(non_user_code) __declspec(no_refcount)
__declspec(no_release_return) void *
__abi_winrt_ptrto_array_ctor(
    const volatile ::Platform::Array<__TArg, __dimension> ^ const);

template <typename __TArg, unsigned int __dimension>
__declspec(non_user_code) __declspec(no_refcount)
__declspec(no_release_return) void *
__abi_winrt_ptrto_array_assign(
    void **, const volatile ::Platform::Array<__TArg, __dimension> ^);

__declspec(non_user_code) __declspec(no_refcount) inline ::Platform::Object ^
    __abi_winrt_cast_use_helper(bool __isDynamicArg, void *__fromArg,
                                const _GUID &__guidArg,
                                __abi_IUnknown *__useresultArg) {
  if (__useresultArg) {
    return reinterpret_cast<::Platform::Object ^>(__useresultArg);
  }

  return __abi_winrt_cast_to(__isDynamicArg,
                             reinterpret_cast<::Platform::Object ^>(__fromArg),
                             __guidArg);
}
...
__declspec(non_user_code) __declspec(no_refcount) inline void
__abi_winrt_ptr_dispose(const volatile ::Platform::Object ^ const __objArg) {
  ::Platform::IDisposable ^ __dispose = dynamic_cast<::Platform::IDisposable ^>(
      const_cast<::Platform::Object ^>(__objArg));
  if (__dispose) {
...
__declspec(non_user_code) __declspec(no_refcount) inline void
__abi_winrt_ptr_dispose_dtor(const volatile ::Platform::Object ^
                             const __objArg) {
...
private:
  ...
  __abi_IUnknown *__target; // we shouldn't hold a strong reference to target,
                            // so grab an unaddref'd reference here.
...
public:
  // IWeakReference
  virtual long __stdcall __abi_QueryInterface(::Platform::Guid &__riid,
                                              void **__ppvObject);
  ...
  virtual unsigned long __stdcall __abi_Release() {
    unsigned long __ref =
        static_cast<unsigned long>(_InterlockedDecrement(&__weakRefCount));
    if (__ref == 0) {
...
#if !defined(VCWINRT_DLL)
  __declspec(dllimport) virtual long __stdcall
  __abi_Resolve(::Platform::Guid &__riid,
                __abi_IInspectable **__objectReference);
#else
  __declspec(dllexport) virtual long __stdcall
  __abi_Resolve(::Platform::Guid &__riid,
                __abi_IInspectable **__objectReference);
#endif
...
private:
  unsigned long __stdcall IncrementStrongReference() {
    // InterlockedIncrement calls _InterlockedIncrement intrinsic thus we call
    // directly _InterlockedIncrement to save the call
    return static_cast<unsigned long>(_InterlockedIncrement(&__strongRefCount));
  }

  unsigned long __stdcall DecrementStrongReference() {
    // InterlockedDecrement calls _InterlockedDecrement intrinsic thus we call
    // directly _InterlockedDecrement to save the call
    unsigned long __ref =
        static_cast<unsigned long>(_InterlockedDecrement(&__strongRefCount));
    if (__ref == 0) {
  ...
  inline long __stdcall GetRefcount() { return __strongRefCount; }

  ControlBlock() {}

#if !defined(VCWINRT_DLL)
  __declspec(dllimport) void
  InitControlBlock(void *__object, bool __bSingleAllocationParam = true,
  ...
  friend void *Details::Heap::AlignedAllocate(::Platform::SizeT,
                                              ::Platform::SizeT,
                                              ::Platform::SizeT);
  friend void *Details::Heap::AllocateException(::Platform::SizeT __rcOffset,
                                                ::Platform::SizeT __sizeArg);
  friend void *
  Details::Heap::AlignedAllocateException(::Platform::SizeT __rcOffset,
                                          ::Platform::SizeT __sizeArg,
...
public:
  __declspec(non_user_code) __abi_FTMWeakRefData(::Platform::Object ^
                                                 __targetArg) {
  ...
  __abi_FTMWeakRefData(::Platform::Object ^ __targetArg,
                       ::Platform::CallbackContext __contextArg) {
  ...
  inline ::Platform::Details::IWeakReference ^ GetWeakReference() {
    return reinterpret_cast<::Platform::Details::IWeakReference ^>(
        __weakRefSource);
  }
...
// <InternalComment>
// Initialize a set of PCH global roots from some of the types defined above
// this point. Preconditions: See initialize_winrt_types_phase1 preconditions:
//                     __abi_FTMWeakRefData is now defined
// Postconditions:  * From this point on WinRT types can be declared using 'ref
// class', 'interface class' etc.
//                  * ParsingInitTypes is still set
// </InternalComment>
...
namespace Platform {
template <typename __TArg, unsigned int __dimension = 1> class ArrayReference;

namespace Details {
template <typename __HighLevelType, unsigned int __dimension>
    ::Platform::Array<__HighLevelType, __dimension> ^
    __abi_array_attach(void *__src, unsigned int __size, bool __isFastPass,
                       bool __needsInit);

template <typename __HighLevelType, unsigned int __dimension>
void __abi_array_copy_to_and_release(
    ::Platform::Array<__HighLevelType, __dimension> ^ __arr, void **__dest,
    unsigned int *__size);

template <typename __LowLevelType, typename __HighLevelType,
          unsigned int __dimension>
__LowLevelType *
__abi_array_to_raw(const ::Platform::Array<__HighLevelType, __dimension> ^);

template <typename __TArg, bool = __is_enum(__TArg)> struct array_helper;
} // namespace Details

#pragma warning(push)
#pragma warning(disable : 4487)
// Partial specialization of one-dimensional Array
template <typename __TArg> private ref class WriteOnlyArray<__TArg, 1> {
protected
private:
  ...
  internal : __TArg &set(unsigned int __indexArg, __TArg __valueArg);
...
private:
  ...
  static __TArg *AllocateAndCopyElements(const __TArg *__srcArg,
                                         unsigned int __countArg);

#if defined(_PREFIX_) || defined(_PREFAST_)
  internal : __TArg &operator[](unsigned int __indexArg) const;
...
private ref class Array<__TArg, 1> sealed
    : public WriteOnlyArray<__TArg, 1>,
      public[::Windows::Foundation::Metadata::Default]
            [::Platform::Metadata::RuntimeClassName] ::Platform::IBoxArray<
                __TArg> {
public:
  virtual property Array ^ Value { virtual Array ^ get(); }

  internal : Array(const Array<__TArg, 1> ^ __source);
...
private:
  ...
  template <typename __HighLevelType, unsigned int __dimension>
      friend ::Platform::Array<__HighLevelType, __dimension> ^
      ::Platform::Details::__abi_array_attach(void *__src, unsigned int __size,
                                              bool __isFastPass,
                                              bool __needsInit);

  template <typename __HighLevelType, unsigned int __dimension>
  friend void ::Platform::Details::__abi_array_copy_to_and_release(
      ::Platform::Array<__HighLevelType, __dimension> ^ __arrArg,
      void **__destArg, unsigned int *__sizeArg);
  template <typename __TArg, unsigned int __dimension>
  friend class ArrayReference;

  void ArrayReferenceInit() { __vtable_initialize(Array<__TArg, 1>); }
...
__declspec(no_release_return) inline void *
__abi_winrt_ptrto_array_ctor(
    const volatile ::Platform::Array<__TArg, __dimension> ^ const __arrArg) {
  __abi_IUnknown *__pUnknown = reinterpret_cast<__abi_IUnknown *>(
      const_cast<::Platform::Array<__TArg, __dimension> ^>(__arrArg));
  if (__pUnknown) {
    auto __localArray = const_cast<::Platform::Array<__TArg, __dimension> ^>(
        const_cast<::Platform::Array<__TArg, __dimension> ^>(__arrArg));
    if (__localArray->FastPass) {
      auto __ret = ref new ::Platform::Array<__TArg, __dimension>(
          __localArray->Data, __localArray->Length);
      __pUnknown = reinterpret_cast<__abi_IUnknown *>(
          const_cast<::Platform::Array<__TArg, __dimension> ^>(__ret));
    } else {
      __pUnknown->__abi_AddRef();
    }
  }
...
__abi_winrt_ptrto_array_assign(
    void **__ppTarget,
    const volatile ::Platform::Array<__TArg, __dimension> ^ __arrArg) {
  __abi_IUnknown *__pUnknown = reinterpret_cast<__abi_IUnknown *>(
      const_cast<::Platform::Array<__TArg, __dimension> ^>(__arrArg));
  __abi_IUnknown **__ppTargetUnknown =
      reinterpret_cast<__abi_IUnknown **>(__ppTarget);
  if (__pUnknown != *__ppTargetUnknown) {
    if (__pUnknown) {
      auto __localArray =
          const_cast<::Platform::Array<__TArg, __dimension> ^>(__arrArg);
      if (__localArray->FastPass) {
        auto __ret = ref new ::Platform::Array<__TArg>(__localArray->Data,
                                                       __localArray->Length);
        __pUnknown = reinterpret_cast<__abi_IUnknown *>(
            const_cast<::Platform::Array<__TArg, __dimension> ^>(__ret));
      } else {
...
template <typename __TArg> inline __TArg __winrt_Empty_Struct() {
...
__declspec(selectany) __abi___FactoryCache __abi_no_factory_cache = {nullptr,
                                                                     0};

struct __abi___classObjectEntry {
  // Factory creator function
  long(__stdcall *__factoryCreator)(unsigned int *, __abi___classObjectEntry *,
                                    ::Platform::Guid &, __abi_IUnknown **);
  // Object id
...
__declspec(noreturn) inline void __stdcall
__abi_WinRTraiseException(long __hrArg) {
  switch (__hrArg) {
...
__declspec(non_user_code) ::Platform::String ^
    __abi_winrt_CreateSystemStringFromLiteral(const __wchar_t *);
__declspec(non_user_code) ::Platform::String ^
    __abi_winrt_CreateSystemStringFromLiteral(const unsigned short *);

#if defined(VCWINRT_DLL)
#define __Platform_CoCreateFreeThreadedMarshaler(__punkOuter, __ppunkMarshal)  \
  CoCreateFreeThreadedMarshaler(reinterpret_cast<IUnknown *>(__punkOuter),     \
                                reinterpret_cast<IUnknown **>(__ppunkMarshal))
#endif
...
// This prevents pulling in the headers
extern "C" {
long __stdcall __Platform_WindowsCreateString(const ::default ::char16 *,
                                              unsigned int, __abi_HSTRING *);
...
long __stdcall __Platform_WindowsDuplicateString(__abi_HSTRING,
                                                 __abi_HSTRING *);
const ::default ::char16 *__stdcall
__Platform_WindowsGetStringRawBuffer(__abi_HSTRING, unsigned int *);
...
long __stdcall __Platform_WindowsCompareStringOrdinal(__abi_HSTRING,
                                                      __abi_HSTRING, int *);
long __stdcall __Platform_WindowsCreateStringReference(
    const ::default ::char16 *, unsigned int,
    __Platform_Details_HSTRING_HEADER *, __abi_HSTRING *);
long __stdcall __Platform_WindowsConcatString(__abi_HSTRING, __abi_HSTRING,
                                              __abi_HSTRING *);
...
namespace Details {
inline void CreateString(const ::default ::char16 *__bufferArg,
                         unsigned int __lengthArg, __abi_HSTRING *__destArg) {
  __abi_ThrowIfFailed(__Platform_WindowsCreateString(
      (const ::default ::char16 *)__bufferArg, __lengthArg, __destArg));
}

inline void CreateString(const ::default ::char16 *__sourceStringArg,
                         __abi_HSTRING *__destArg) {
  __abi_ThrowIfFailed(__Platform_WindowsCreateString(
      (const ::default ::char16 *)__sourceStringArg,
      __sourceStringArg ? static_cast<unsigned int>(__Platform_wcslen(
                              (const ::default ::char16 *)__sourceStringArg))
                        : 0u,
      __destArg));
}

inline void DuplicateString(__abi_HSTRING __sourceArg,
                            __abi_HSTRING *__destArg) {
  ...
  __abi_ThrowIfFailed(
      __Platform_WindowsDuplicateString(__sourceArg, __destArg));
}

inline void
CreateStringReference(const ::default ::char16 *__sourceStringArg,
                      unsigned int __lengthArg,
                      __Platform_Details_HSTRING_HEADER *__hstringHeaderArg,
                      __abi_HSTRING *__stringArg) {
  __abi_ThrowIfFailed(__Platform_WindowsCreateStringReference(
      __sourceStringArg, __lengthArg, __hstringHeaderArg, __stringArg));
}
} // namespace Details
...
public:
  ~StringReference() { Free(); }
  StringReference() { Init(); }
  StringReference(const StringReference &__fstrArg) { Init(__fstrArg); }
  ...
  __declspec(no_refcount) operator ::Platform::String ^() const {
    return reinterpret_cast<::Platform::String ^>(__hString);
  }
  __declspec(no_release_return) __declspec(no_refcount) ::Platform::String ^
      GetString() const {
    return reinterpret_cast<::Platform::String ^>(__hString);
  }
  __abi_HSTRING GetHSTRING() const { return __hString; }

private:
  void Free() { __Platform_WindowsDeleteString(__hString); }
  void Init() { __Platform_memset(this, 0, sizeof(StringReference)); }
  void Init(const StringReference &__fstrArg) {
    unsigned int __length = 0;
    const ::default ::char16 *__source =
        __Platform_WindowsGetStringRawBuffer(__fstrArg.GetHSTRING(), &__length);
  ...
  void Init(const ::default ::char16 *__strArg, unsigned __int64 __lenArg) {
    if ((__strArg == nullptr) || (__lenArg == 0))
      Init();
             ...
             0xffffffffLL) // check if it exceeds the size of an integer
      __abi_WinRTraiseInvalidArgumentException();
    else {
      unsigned int __length = (unsigned int)(__lenArg & 0xffffffffLL);
      ::Platform::Details::CreateStringReference(__strArg, __length, &__header,
                                                 &__hString);
    }
  }
  void Init(const ::default ::char16 *__strArg, unsigned int __lenArg) {
    if ((__strArg == nullptr) || (__lenArg == 0))
      ...
      ::Platform::Details::CreateStringReference(__strArg, __lenArg, &__header,
                                                 &__hString);
    }
  }
...
__declspec(non_user_code) __declspec(no_refcount)
__declspec(no_release_return) inline void *
__abi_winrt_ptrto_string_ctor(const volatile ::Platform::String ^ __strArg) {
  if (__strArg) {
    __abi_HSTRING __hstr;
    auto __pRaw = reinterpret_cast<__abi_HSTRING>(
        (const_cast<::Platform::String ^>(__strArg)));
...
__declspec(non_user_code) __declspec(no_refcount)
__declspec(no_release_return) inline void *
__abi_winrt_ptrto_string_assign(void **__ppTargetArg,
                                const volatile ::Platform::String ^
                                    __pSourceArg) {
  auto __pRaw = reinterpret_cast<__abi_HSTRING>(
      (const_cast<::Platform::String ^>(__pSourceArg)));
  if (*__ppTargetArg != reinterpret_cast<void *>(__pRaw)) {
    if (*__ppTargetArg) {
      __abi_details::__abi_delete_String(
          reinterpret_cast<::Platform::String ^>(*__ppTargetArg));
    }
...
__declspec(non_user_code) __declspec(no_refcount) inline void
__abi_delete_String(::Platform::String ^ __strArg) {
...
#if !defined(VCWINRT_DLL)
__declspec(dllimport) ::Platform::Type ^
    __stdcall __abi_make_type_id(const __abi_type_descriptor &);
#else
__declspec(dllexport) ::Platform::Type ^
    __stdcall __abi_make_type_id(const __abi_type_descriptor &);
#endif

inline Platform::String ^ __abi_CustomToString(void *) { return nullptr; }
...
__declspec(dllexport) long __stdcall
ReCreateFromException(::Platform::Exception ^);
__declspec(dllexport) ::Platform::Object ^
    __stdcall CreateValue(::Platform::TypeCode, const void *);
__declspec(dllexport) void *__stdcall GetIBoxArrayVtable(void *);
__declspec(dllexport) void *__stdcall GetIBoxVtable(void *);

template <typename T>
ref class __declspec(no_empty_identity_interface) CustomBox sealed
    : public[::Windows::Foundation::Metadata::Default]
            [::Platform::Metadata::RuntimeClassName] ::Platform::IBox<T>,
...
public:
  CustomBox(T value) : value_(value) {
    *reinterpret_cast<void **>(static_cast<::Platform::IValueType ^>(this)) =
        GetIBoxVtable(
            reinterpret_cast<void *>(static_cast<::Platform::IBox<T> ^>(this)));
  }
...
private:
  template <bool isEnum> Platform::String ^ ToStringInternal();

  template <> Platform::String ^ ToStringInternal<true>() {
  ...
  template <> Platform::String ^ ToStringInternal<false>() {
...
template <bool __isEnum> struct BoxValueType {
  typedef CustomValueType Type;
};

template <> struct BoxValueType<true> {
  typedef CustomEnum Type;
};

template <typename __TArg> struct RemoveConst {
  typedef __TArg Type;
};

template <typename __TArg> struct RemoveConst<const __TArg> {
  typedef __TArg Type;
};

template <typename __TArg> struct RemoveVolatile {
  typedef __TArg Type;
};

template <typename __TArg> struct RemoveVolatile<volatile __TArg> {
  typedef __TArg Type;
};

template <typename __TArg> struct RemoveCV {
  typedef
      typename RemoveConst<typename RemoveVolatile<__TArg>::Type>::Type Type;
};

template <typename __TArg, typename __TArg2> struct IsSame {
  static const bool value = false;
};

template <typename __TArg> struct IsSame<__TArg, __TArg> {
...
template <typename T> struct RemoveHat<T ^> {
  typedef T type;
};
} // namespace Details

template <typename __TArg>
ref class __declspec(one_phase_constructed) __declspec(layout_as_external)
__declspec(no_empty_identity_interface) Box abstract
    : public ::Platform::IBox<
          typename ::Platform::Details::RemoveCV<__TArg>::Type>,
      public Details::BoxValueType<__is_enum(__TArg)>::Type {
  static_assert(__is_enum(__TArg) ||
                    ::Platform::Details::IsSame<
                        typename ::Platform::Details::RemoveCV<__TArg>::Type,
                        ::Platform::String ^>::value ||
                    __is_value_class(__TArg) || __is_trivial(__TArg),
                "__TArg type of Box<__TArg> must be either value, enum or "
                "Platform::String^ type");

  typedef typename ::Platform::Details::RemoveCV<__TArg>::Type __TBoxValue;
  internal : Box(__TBoxValue __valueArg) {
    static auto __typeCode = ::Platform::Type::GetTypeCode(
        ::Platform::Details::RemoveHat<__TBoxValue>::type::typeid);
    ::Platform::Object ^ __boxValue =
        Details::CreateValue(__typeCode, &__valueArg);
...
operator Box<const __TBoxValue> ^
    ...
    static
    operator Box<__TArg> ^
    (::Platform::IBox<__TArg> ^ __boxValueArg) {
      return reinterpret_cast<Box<__TArg> ^>(__boxValueArg);
    }

    public : virtual property __TBoxValue Value {
    __TBoxValue get() {
      if (this == nullptr) {
        throw ref new ::Platform::NullReferenceException();
      }
...
////////////////////////////////////////////////////////////////////////////////
inline Guid::Guid()
    : __a(0), __b(0), __c(0), __d(0), __e(0), __f(0), __g(0), __h(0), __i(0),
      __j(0), __k(0) {}
...
inline bool ::Platform::Guid::Equals(::Platform::Guid __guidArg) {
  ...
  return (__al[0] == __bl[0] && __al[1] == __bl[1] && __al[2] == __bl[2] &&
          __al[3] == __bl[3]);
}
...
inline bool ::Platform::Guid::operator==(::Platform::Guid __aArg,
                                         ::Platform::Guid __bArg) {
...
inline Guid::Guid(unsigned int __aArg, unsigned short __bArg,
    ...
    : __a(__aArg), __b(__bArg), __c(__cArg), __d(__dArg), __e(__eArg),
      __f(__fArg), __g(__gArg), __h(__hArg), __i(__iArg), __j(__jArg),
      __k(__kArg) {}

inline Guid::Guid(unsigned int __aArg, unsigned short __bArg,
                  unsigned short __cArg,
                  const ::Platform::Array<unsigned __int8> ^ __dArg)
...
__declspec(selectany) ::Platform::Guid __winrt_GUID_NULL = {
    0x00000000, 0x0000, 0x0000, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00};

////////////////////////////////////////////////////////////////////////////////
inline void *Details::Heap::Allocate(::Platform::SizeT /*__sizeArg*/,
                                     void *__pPlacementArg) {
  return __pPlacementArg;
}

inline void *Details::Heap::Allocate(::Platform::SizeT /*__rcOffset*/,
                                     ::Platform::SizeT /*__sizeArg*/,
                                     void *__pPlacementArg) {
  return __pPlacementArg;
}

inline void Details::Heap::PlacementFree(void * /*__pArg*/,
                                         void * /*__placementArg*/) {}
} // namespace Platform

template <typename __TArg>
    Platform::Box<typename ::Platform::Details::RemoveCV<__TArg>::Type> ^
...
template <typename T>
    __declspec(non_user_code) inline T ^
    __abi_winrt_cast_from_object_to_delegate(bool __isDynamicCastArg,
                                             ::Platform::Object ^ __objArg) {
  if (__objArg == nullptr) {
    return nullptr;
  }
...
inline long __stdcall __abi_FTMWeakRefData::__abi_QueryInterface(
    ::Platform::Guid &__guid, void **__pOut) {
  if (__pUnkMarshal == nullptr ||
      __guid.Equals(__uuidof(__abi_IMarshal)) == false) {
    return 0x80004002;
  }
...
#if !defined(VCWINRT_DLL)
    long __hr = ::__Platform_CoCreateFreeThreadedMarshaler(
        reinterpret_cast<::Platform::Object ^>(__weakRefSource->__target),
        reinterpret_cast<::Platform::Object ^ *>(&__pUnkMarshalLocal));
#else
    long __hr = ::CoCreateFreeThreadedMarshaler(
        reinterpret_cast<IUnknown *>(__weakRefSource->__target),
        reinterpret_cast<IUnknown **>(&__pUnkMarshalLocal));
#endif
    __abi_ThrowIfFailed(__hr);

    if (::_InterlockedCompareExchangePointer(
            reinterpret_cast<void *volatile *>(&__pUnkMarshal),
            __pUnkMarshalLocal,
...
inline long __stdcall ::Platform::Details::ControlBlock::__abi_QueryInterface(
    ::Platform::Guid &__riid, void **__ppvObject) {
...
__declspec(no_refcount) __declspec(no_release_return) inline String::String() {
  return nullptr;
}

__declspec(no_refcount) inline String::String(__abi_HSTRING __hstrArg) {
  __abi_HSTRING __hstr;
  Details::DuplicateString(__hstrArg, &__hstr);
  return *reinterpret_cast<String ^ *>(&__hstr);
}

__declspec(no_refcount) inline String::String(
    const ::default ::char16 *__strArg) {
  if (__strArg == nullptr)
    return nullptr;

  __abi_HSTRING __hstr = nullptr;
  ::Platform::Details::CreateString(
      __strArg, (unsigned int)__Platform_wcslen(__strArg), &__hstr);
  return *reinterpret_cast<String ^ *>(&__hstr);
}

__declspec(no_refcount) inline String::String(
    const ::default ::char16 *__strArg, unsigned int __lenArg) {
  if ((__strArg == nullptr) || (__lenArg == 0))
    return nullptr;
...
inline const ::default ::char16 *String::Begin() { return Data(); }
inline const ::default ::char16 *String::End() { return Data() + Length(); }
...
inline const ::default ::char16 *String::Data() {
  return __Platform_WindowsGetStringRawBuffer(
      reinterpret_cast<__abi_HSTRING>(this), nullptr);
}
...
inline bool String::IsEmpty() {
  return __Platform_WindowsIsStringEmpty(reinterpret_cast<__abi_HSTRING>(this))
             ? true
             : false;
}

inline bool String::IsFastPass() { return false; }

inline bool String::Equals(Object ^ __strArg) {
  int __result = 0;
  __Platform_WindowsCompareStringOrdinal(
      reinterpret_cast<__abi_HSTRING>(this),
      reinterpret_cast<__abi_HSTRING>(((String ^) __strArg)), &__result);
  return (__result == 0);
}
...
inline bool String::Equals(String ^ __str1Arg) {
  ...
  __Platform_WindowsCompareStringOrdinal(
      reinterpret_cast<__abi_HSTRING>(this),
      reinterpret_cast<__abi_HSTRING>(__str1Arg), &__result);
  return (__result == 0);
}
inline int String::CompareOrdinal(String ^ __str1Arg, String ^ __str2Arg) {
  int __result = 0;
  __Platform_WindowsCompareStringOrdinal(
      reinterpret_cast<__abi_HSTRING>(__str1Arg),
      reinterpret_cast<__abi_HSTRING>(__str2Arg), &__result);
  return __result;
}
...
inline bool ::Platform::String::operator==(::Platform::String ^ __str1Arg,
                                           ::Platform::String ^ __str2Arg) {
  int __result = 0;
  __Platform_WindowsCompareStringOrdinal(
      reinterpret_cast<__abi_HSTRING>(__str1Arg),
      reinterpret_cast<__abi_HSTRING>(__str2Arg), &__result);
...
inline ::Platform::String ^
    ::Platform::String::Concat(::Platform::String ^ __str1Arg,
                               ::Platform::String ^ __str2Arg) {
  String ^ __str = nullptr;
  __abi_ThrowIfFailed(__Platform_WindowsConcatString(
      reinterpret_cast<__abi_HSTRING>(__str1Arg),
      reinterpret_cast<__abi_HSTRING>(__str2Arg),
      reinterpret_cast<__abi_HSTRING *>(&__str)));
  return __str;
}

inline ::Platform::String ^
    ::Platform::String::Concat(::Platform::Object ^ __str1Arg,
                               ::Platform::Object ^ __str2Arg) {
  String ^ __str = nullptr;
#pragma warning(suppress                                                       \
                : 6011) // False positive because __str?Arg not evaluated
  __abi_ThrowIfFailed(__Platform_WindowsConcatString(
      reinterpret_cast<__abi_HSTRING>(__str1Arg->ToString()),
      reinterpret_cast<__abi_HSTRING>(__str2Arg->ToString()),
      reinterpret_cast<__abi_HSTRING *>(&__str)));
  return __str;
}
...
__declspec(non_user_code) inline ::Platform::String ^
    __abi_winrt_CreateSystemStringFromLiteral(
        const ::default ::char16 *__strArg) {
  return ref new ::Platform::String(__strArg);
}

template <typename __TArg>
    inline ::Platform::Array<__TArg, 1> ^
    __abi_winrt_CreateArray(unsigned int __sizeArg) {
      return ref new ::Platform::Array<__TArg, 1>(__sizeArg);
    }

    inline __declspec(no_refcount)
    __declspec(no_release_return) ::Platform::String
    ^
    __abi_winrt_CreateFastPassSystemStringFromLiteral(
        const ::default ::char16 *__strArg, unsigned int __lenArg,
        __Platform_Details_HSTRING_HEADER *__psheaderArg) {
  __abi_HSTRING __hstr;
  ::Platform::Details::CreateStringReference(__strArg, __lenArg, __psheaderArg,
                                             &__hstr);
...
inline __declspec(no_refcount)
    __declspec(no_release_return) ::Platform::String ^
    __abi_winrt_CreateFastPassSystemStringFromLiteral(
        const unsigned short *__strArg, unsigned int __lenArg,
        __Platform_Details_HSTRING_HEADER *__psheaderArg) {
  return __abi_winrt_CreateFastPassSystemStringFromLiteral(
      reinterpret_cast<const ::default ::char16 *>(__strArg), __lenArg,
      __psheaderArg);
}
...
template <typename __HighLevelType, unsigned int __dimension>
    __declspec(no_refcount) ::Platform::Array<__HighLevelType, __dimension> ^
    __abi_array_attach(void *__srcArg, unsigned int __elementcountArg,
                       bool __isFastPassArg, bool __needsInitArg) {
      if (static_cast<unsigned int>(-1) / sizeof(__HighLevelType) <
          __elementcountArg) {
        __abi_WinRTraiseInvalidArgumentException();
      }
      auto __arr =
          ref new ::Platform::Array<__HighLevelType, __dimension>(nullptr, 0);

      if (__needsInitArg) {
        __Platform_memset(__srcArg, 0,
                          sizeof(__HighLevelType) * __elementcountArg);
      }
      if (!__isFastPassArg) {
        __arr->Attach(reinterpret_cast<__HighLevelType *>(__srcArg),
                      __elementcountArg);
      } else {
        __arr->AttachFastPass(reinterpret_cast<__HighLevelType *>(__srcArg),
                              __elementcountArg);
      }
  ...
  __HighLevelType **__destHigh =
      reinterpret_cast<__HighLevelType **>(__destArg);
  ...
  reinterpret_cast<__abi_IUnknown *>(
      static_cast<::Platform::Object ^>(__arrArg))
      ->__abi_Release();
...
template <typename __TArg> struct array_helper<__TArg, true> {
  static void DestructElementsAndFree(__TArg *__srcArg, unsigned int) {
    __Platform_CoTaskMemFree(__srcArg);
  }
};

template <typename __TArg> struct array_helper<__TArg, false> {
  static void DestructElementsAndFree(__TArg *__srcArg,
                                      unsigned int __countArg) {
...
template <typename __TArg> class ArrayReference<__TArg, 1> {
  default ::uint8 __data[sizeof(Array<__TArg>)];
  void Init(__TArg *__dataArg, unsigned int __sizeArg,
            bool __needsInitArg = false) {
    __Platform_memset(__data, 0, sizeof(Array<__TArg>));
    ArrayReference *__pThis = this;
    Array<__TArg> ^ *__pArrayThis =
        reinterpret_cast<Array<__TArg> ^ *>(&__pThis);
...
public:
  ArrayReference(__TArg *__dataArg, unsigned int __sizeArg,
                 bool __needsInitArg = false) {
    Init(__dataArg, __sizeArg, __needsInitArg);
  }

  ArrayReference(ArrayReference &&__otherArg) {
    Array<__TArg> ^ *__pOther =
        reinterpret_cast<Array<__TArg> ^ *>(&__otherArg);
...
__declspec(no_refcount) __declspec(no_release_return) operator Array<__TArg> ^
    () {
      ...
      return *__pArrayThis;
    } private : ArrayReference(const ArrayReference &);
...
inline WriteOnlyArray<__TArg, 1>::WriteOnlyArray()
    : __size(0), __fastpassflag(false), __data(nullptr) {}

template <typename __TArg>
inline WriteOnlyArray<__TArg, 1>::WriteOnlyArray(unsigned int __sizeArg)
    : __size(0), __fastpassflag(false), __data(nullptr) {
  if (__sizeArg == 0) {
    return;
  }
...
template <typename __TArg>
inline WriteOnlyArray<__TArg, 1>::WriteOnlyArray(__TArg *__dataArg,
...
template <typename __TArg> inline WriteOnlyArray<__TArg, 1>::~WriteOnlyArray() {
  if ((__fastpassflag == false) && (__data != nullptr)) {
    ::Platform::Details::array_helper<__TArg>::DestructElementsAndFree(__data,
                                                                       __size);
  }
  Clear();
}
...
template <typename __TArg>
inline __TArg &WriteOnlyArray<__TArg, 1>::set(unsigned int __positionArg,
                                              __TArg __valueArg) {
  if (__data == nullptr) {
    __abi_WinRTraiseNullReferenceException();
  }
...
template <typename __TArg>
inline __TArg &
WriteOnlyArray<__TArg, 1>::get(unsigned int __positionArg) const {
  if (__data == nullptr) {
    __abi_WinRTraiseNullReferenceException();
  }
...
template <typename __TArg>
inline __TArg &
WriteOnlyArray<__TArg, 1>::operator[](unsigned int __positionArg) const {
  if (__data == nullptr) {
    __abi_WinRTraiseNullReferenceException();
  }
...
template <typename __TArg> inline void WriteOnlyArray<__TArg, 1>::Clear() {
  __size = 0;
...
template <typename __TArg>
inline __TArg *
WriteOnlyArray<__TArg, 1>::AllocateAndZeroInitialize(unsigned int __countArg) {
...
template <typename __TArg>
inline __TArg *
WriteOnlyArray<__TArg, 1>::AllocateAndCopyElements(const __TArg *__srcArg,
                                                   unsigned int __countArg) {
...
inline Array<__TArg, 1>::Array() : WriteOnlyArray<__TArg, 1>() {
  *reinterpret_cast<void **>(static_cast<::Platform::IValueType ^>(this)) =
      Details::GetIBoxArrayVtable(reinterpret_cast<void *>(
          static_cast<::Platform::IBoxArray<__TArg> ^>(this)));
}

template <typename __TArg>
inline Array<__TArg, 1>::Array(const Array<__TArg, 1> ^ __source)
    : WriteOnlyArray<__TArg, 1>(__source ? __source->Data : nullptr,
                                __source ? __source->Length : 0) {
  *reinterpret_cast<void **>(static_cast<::Platform::IValueType ^>(this)) =
      Details::GetIBoxArrayVtable(reinterpret_cast<void *>(
          static_cast<::Platform::IBoxArray<__TArg> ^>(this)));
}
...
template <typename __TArg>
inline Array<__TArg, 1>::Array(unsigned int __sizeArg)
    : WriteOnlyArray<__TArg, 1>(__sizeArg) {
  *reinterpret_cast<void **>(static_cast<::Platform::IValueType ^>(this)) =
      Details::GetIBoxArrayVtable(reinterpret_cast<void *>(
          static_cast<::Platform::IBoxArray<__TArg> ^>(this)));
}
...
template <typename __TArg>
inline Array<__TArg, 1>::Array(__TArg *__dataArg, unsigned int __sizeArg)
    : WriteOnlyArray<__TArg, 1>(__dataArg, __sizeArg) {
  *reinterpret_cast<void **>(static_cast<::Platform::IValueType ^>(this)) =
      Details::GetIBoxArrayVtable(reinterpret_cast<void *>(
          static_cast<::Platform::IBoxArray<__TArg> ^>(this)));
}
...
template <typename __TArg>
inline void Array<__TArg, 1>::AttachFastPass(__TArg *__srcArg,
                                             unsigned int __sizeArg) {
  // Precondition:
  //    default constructed object
  // Postcondition:
...
template <typename __TArg>
inline void Array<__TArg, 1>::CopyToOrDetach(__TArg **__destArg,
                                             unsigned int *__sizeArg) {
  // Postcondition:
...
template <class __TArg> __TArg *begin(const Array<__TArg, 1> ^ __arrArg) {
  return __arrArg->begin();
}

template <class __TArg> __TArg *end(const Array<__TArg, 1> ^ __arrArg) {
  return __arrArg->end();
}
#pragma endregion
} // namespace Platform
...
__declspec(dllimport) void *__stdcall EventSourceGetTargetArray(void *,
                                                                EventLock *);
__declspec(dllimport) unsigned int __stdcall
EventSourceGetTargetArraySize(void *);
__declspec(dllimport) void *__stdcall
EventSourceGetTargetArrayEvent(void *, unsigned int, const void *, __int64 *);
__declspec(dllimport) ::Windows::Foundation::EventRegistrationToken __stdcall
EventSourceAdd(void **, EventLock *, ::Platform::Delegate ^);
__declspec(dllimport) void __stdcall
EventSourceRemove(void **, EventLock *,
                  ::Windows::Foundation::EventRegistrationToken);
__declspec(dllimport) __abi_IUnknown *__stdcall
GetWeakReference(const volatile ::Platform::Object ^ const other);
__declspec(dllimport) __declspec(no_refcount) ::Platform::Object ^
    __stdcall ResolveWeakReference(const ::_GUID &guid,
                                   __abi_IUnknown **weakRef);
#else
...
__declspec(dllexport) void *__stdcall EventSourceGetTargetArray(void *,
                                                                EventLock *);
__declspec(dllexport) unsigned int __stdcall
EventSourceGetTargetArraySize(void *);
__declspec(dllexport) void *__stdcall
EventSourceGetTargetArrayEvent(void *, unsigned int, const void *, __int64 *);
__declspec(dllexport) ::Windows::Foundation::EventRegistrationToken __stdcall
EventSourceAdd(void **, EventLock *, ::Platform::Delegate ^);
__declspec(dllexport) void __stdcall
EventSourceRemove(void **, EventLock *,
                  ::Windows::Foundation::EventRegistrationToken);
__declspec(dllexport) __abi_IUnknown *__stdcall
GetWeakReference(const volatile ::Platform::Object ^ const other);
__declspec(dllexport) __declspec(no_refcount) ::Platform::Object ^
    __stdcall ResolveWeakReference(const ::_GUID &guid,
                                   __abi_IUnknown **weakRef);
#endif
} // namespace Details
...
class EventSource {
public:
  EventSource() { Details::EventSourceInitialize(&__targets); }

  ~EventSource() { Details::EventSourceUninitialize(&__targets); }

  ::Windows::Foundation::EventRegistrationToken
  Add(Details::EventLock *__lockArg,
      ::Platform::Object ^ __delegateInterfaceArg) {
    return Details::EventSourceAdd(
        &__targets, __lockArg,
        reinterpret_cast<::Platform::Delegate ^>(__delegateInterfaceArg));
  }

  void Remove(Details::EventLock *__lockArg,
              ::Windows::Foundation::EventRegistrationToken __tokenArg) {
    Details::EventSourceRemove(&__targets, __lockArg, __tokenArg);
  }

private:
  // __TInvokeMethod is a functor that performs the appropriate invoke,
  // depending on the number of arguments specified.
  template <typename __TDelegate, typename __TReturnType,
            typename __TInvokeMethod>
  typename __TReturnType DoInvoke(Details::EventLock *__lockArg,
    ...
    // The _targetsPointerLock protects the acquisition of an AddRef'd pointer
    // to "current list".  An Add/Remove operation may occur during the firing
    // of events (but occurs on a copy of the list).  i.e. both DoInvoke/invoke
    // and Add/Remove are readers of the "current list". NOTE:
    // EventSource::Invoke(...) must never take the _addRemoveLock.
    ::Platform::Object ^ __targetsLoc;
    // Attaching Array without AddRef'ing

    // In order to prevent a load of __targets while unprotected by
    // __targetsLock, we must take the lock externally to the call to
    // EventSourceGetTargetArray. We then pass in a dummy lock instead of the
    // real lock in order to prevent recursive acquisition. This fix was made to
    // avoid modifying vccorlib.dll. On the next binary breaking change, the
    // Details::EventSourceGetTargetArray call interface should be modified to
    // take __targets by pointer instead of by value.
    Details::EventLock __dummylock = {nullptr, nullptr};
    __Platform_AcquireSRWLockShared(&__lockArg->__targetsLock);
    void *__EvSrcGTA_ret =
        Details::EventSourceGetTargetArray(__targets, &__dummylock);
    ...
    *reinterpret_cast<void **>(&__targetsLoc) = __EvSrcGTA_ret;
    ...
    if (__targetsLoc != nullptr) {
      const unsigned int __size = Details::EventSourceGetTargetArraySize(
      ...
      for (unsigned int __index = 0; __index < __size; __index++) {
        ...
        try {
          ...
          *reinterpret_cast<void **>(&__element) =
              Details::EventSourceGetTargetArrayEvent(
                  reinterpret_cast<void *>(__targetsLoc), __index,
  ...
  void DoInvokeVoid(Details::EventLock *__lockArg,
                    __TInvokeMethod __invokeOneArg) {
    // lock pointer exhange
    //        targets = _targets
    // unlock pointer exhange
    ...
    // The _targetsPointerLock protects the acquisition of an AddRef'd pointer
    // to "current list".  An Add/Remove operation may occur during the firing
    // of events (but occurs on a copy of the list).  i.e. both Invoke/invoke
    // and Add/Remove are readers of the "current list". NOTE:
    // EventSource::Invoke(...) must never take the _addRemoveLock.
    ::Platform::Object ^ __targetsLoc;
    // Attaching Array without AddRef'ing
...
public:
  ...
  void InvokeVoid(Details::EventLock *__lockArg, __TArgs... __args) {
    DoInvokeVoid<__TLambda>(
        __lockArg,
        [__args...](__TLambda ^ __lambda) -> void { __lambda(__args...); });
  }
  ...
  __TReturnType Invoke(Details::EventLock *__lockArg, __TArgs... __args) {
    return DoInvoke<__TLambda, __TReturnType>(
        __lockArg, [__args...](__TLambda ^ __lambda) -> __TReturnType {
...
public:
  ...
  static ::Platform::Object ^
      __stdcall RegisterFactories(UnregisterCallback callback = nullptr);
  static void __stdcall
  RunServer(const ::default ::char16 *__serverName = nullptr);
  static ::Platform::Details::IActivationFactory ^
      __stdcall GetActivationFactory(::Platform::String ^);
  static bool __stdcall CanUnloadNow();
  static void __stdcall FlushFactoryCache();
};

inline ::default ::int32 Exception::HResult::get() { return __hresult; }
...
public:
  ...
  ~WeakReference() throw() { InternalRelease(); }
  ...
  WeakReference &operator=(const volatile ::Platform::Object ^
                           const __otherArg) {
  ...
  template <typename __TArg> __declspec(no_refcount) __TArg ^ Resolve() const {
    return reinterpret_cast<__TArg ^>(
...
inline bool operator==(const WeakReference &__aArg,
                       const WeakReference &__bArg) throw() {
  return __aArg.__weakPtr == __bArg.__weakPtr;
}

inline bool operator==(const WeakReference &__aArg,
                       decltype(__nullptr)) throw() {
  return __aArg.__weakPtr == nullptr;
}

inline bool operator==(decltype(__nullptr),
                       const WeakReference &__bArg) throw() {
...
inline bool Size::IsEmpty::get() { return Width < 0; }

inline bool Size::operator==(Size __size1Arg, Size __size2Arg) {
  return __size1Arg.Height == __size2Arg.Height &&
         __size1Arg.Width == __size2Arg.Width;
}
...
inline Rect::Rect(float __xArg, float __yArg, float __widthArg,
                  float __heightArg) {
  if (__widthArg < 0 || __heightArg < 0) {
    __abi_WinRTraiseInvalidArgumentException();
  }
...
inline bool Rect::IsEmpty::get() { return Width < 0; }

inline float Rect::Left::get() { return X; }

inline float Rect::Top::get() { return Y; }

inline bool Rect::operator==(Rect __rect1Arg, Rect __rect2Arg) {
  return __rect1Arg.X == __rect2Arg.X && __rect1Arg.Y == __rect2Arg.Y &&
...
inline Thickness::Thickness(double __leftArg, double __topArg,
                            double __rightArg, double __bottomArg) {
  Left = __leftArg;
  Top = __topArg;
  Right = __rightArg;
  Bottom = __bottomArg;
...
inline bool Thickness::operator==(Thickness __thickness1Arg,
                                  Thickness __thickness2Arg) {
...
inline CornerRadius::CornerRadius(double __topLeftArg, double __topRightArg,
...
inline bool CornerRadius::operator==(CornerRadius __cornerRadius1Arg,
...
namespace Media {
inline Matrix Matrix::Identity::get() { return Matrix(1, 0, 0, 1, 0, 0); }

inline bool Matrix::IsIdentity::get() {
  return M11 == 1 && M12 == 0 && M21 == 0 && M22 == 1 && OffsetX == 0 &&
         OffsetY == 0;
}

inline Windows::Foundation::Point
Matrix::Transform(Windows::Foundation::Point __pointArg) {
...
inline Matrix::Matrix(double __m11Arg, double __m12Arg, double __m21Arg,
                      double __m22Arg, double __offsetXArg,
                      double __offsetYArg) {
  M11 = __m11Arg;
  M12 = __m12Arg;
  M21 = __m21Arg;
...
inline bool Matrix::operator==(Matrix __matrix1Arg, Matrix __matrix2Arg) {
  return __matrix1Arg.M11 == __matrix2Arg.M11 &&
...
inline bool Matrix3D::IsIdentity::get() {
  return M11 == 1 && M12 == 0 && M13 == 0 && M14 == 0 && M21 == 0 && M22 == 1 &&
         M23 == 0 && M24 == 0 && M31 == 0 && M32 == 0 && M33 == 1 && M34 == 0 &&
         OffsetX == 0 && OffsetY == 0 && OffsetZ == 0 && M44 == 1;
}

inline Matrix3D::Matrix3D(double __m11Arg, double __m12Arg, double __m13Arg,
                          double __m14Arg, double __m21Arg, double __m22Arg,
                          double __m23Arg, double __m24Arg, double __m31Arg,
                          double __m32Arg, double __m33Arg, double __m34Arg,
                          double __offsetXArg, double __offsetYArg,
                          double __offsetZArg, double __m44Arg) {
  M11 = __m11Arg;
  M12 = __m12Arg;
  M13 = __m13Arg;
  M14 = __m14Arg;
...
inline RepeatBehavior::RepeatBehavior(
    Windows::Foundation::TimeSpan __durationArg) {
...
inline double RepeatBehavior::Count::get() { return __count; }

inline Windows::Foundation::TimeSpan RepeatBehavior::Duration::get() {
  return __duration;
}

inline RepeatBehaviorType RepeatBehavior::Type::get() { return __type; }
...
inline bool RepeatBehavior::operator==(RepeatBehavior __repeatBehavior1Arg,
                                       RepeatBehavior __repeatBehavior2Arg) {
  if (__repeatBehavior1Arg.__type == __repeatBehavior2Arg.__type) {
    ...
    case RepeatBehaviorType::Duration:
      ...
      return __repeatBehavior1Arg.__duration.Duration ==
             __repeatBehavior2Arg.__duration.Duration;
...
inline double GridLength::Value::get() {
  return (__unitType == Windows::UI::Xaml::GridUnitType::Auto)
             ? GridLength(1.0, Windows::UI::Xaml::GridUnitType::Auto)
                   .__unitValue
             : __unitValue;
}
...
inline bool GridLength::operator==(GridLength __gridLength1Arg,
                                   GridLength __gridLength2Arg) {
  if (__gridLength1Arg.GridUnitType == __gridLength2Arg.GridUnitType) {
    if (__gridLength1Arg.IsAuto ||
        __gridLength1Arg.__unitValue == __gridLength2Arg.__unitValue) {
      return true;
    }
  }
  return false;
...
#else
#pragma comment(                                                               \
    linker, "/EXPORT:DllGetActivationFactory=DllGetActivationFactory,PRIVATE")
