...
_Const_array_view_projection_helper<_T, _R>::_Project0(
    const array_view<const _T, _R> *_Arr_view, int _I) __GPU {
...
_Array_view_projection_helper<_T, _R>::_Project0(
    const array_view<_T, _R> *_Arr_view, int _I) __GPU {
...
_Const_array_view_projection_helper<_T, 1>::_Project0(
    const array_view<const _T, 1> *_Arr_view, int _I) __GPU {
  return _Arr_view->operator[](index<1>(_I));
}

template <typename _T>
/*static*/ inline typename _Projection_result_type<_T, 1>::_Result_type
_Array_view_projection_helper<_T, 1>::_Project0(
    const array_view<_T, 1> *_Arr_view, int _I) __GPU {
  return _Arr_view->operator[](index<1>(_I));
}

template <typename _T, int _R>
/*static*/ inline typename _Projection_result_type<_T, _R>::_Const_result_type
_Const_array_projection_helper<_T, _R>::_Project0(const array<_T, _R> *_Array,
                                                  int _I) __GPU {
...
template <typename _T, int _R>
/*static*/ inline typename _Projection_result_type<_T, _R>::_Result_type
_Array_projection_helper<_T, _R>::_Project0(_In_ array<_T, _R> *_Array,
                                            int _I) __GPU {
...
template <typename _T>
/*static*/ inline typename _Projection_result_type<_T, 1>::_Const_result_type
_Const_array_projection_helper<_T, 1>::_Project0(const array<_T, 1> *_Array,
                                                 int _I) __GPU {
...
template <typename _T>
/*static*/ inline typename _Projection_result_type<_T, 1>::_Result_type
_Array_projection_helper<_T, 1>::_Project0(_In_ array<_T, 1> *_Array,
                                           int _I) __GPU {
  return _Array->operator[](index<1>(_I));
}
...
template <>
inline extent<1> _Get_extent_at_level_unsafe<1>(const extent<1> &_Base_extent,
                                                unsigned int _Level) __GPU {
...
template <>
inline extent<2> _Get_extent_at_level_unsafe<2>(const extent<2> &_Base_extent,
                                                unsigned int _Level) __GPU {
...
template <>
inline extent<3> _Get_extent_at_level_unsafe<3>(const extent<3> &_Base_extent,
                                                unsigned int _Level) __GPU {
