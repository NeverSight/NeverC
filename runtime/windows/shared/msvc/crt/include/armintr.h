...
unsigned int __arm_gen_u_Rd_RdRn(const unsigned int, unsigned int,
                                 unsigned int);
unsigned int __arm_gen_u_Rd_RdRm(const unsigned int, unsigned int,
                                 unsigned int);
unsigned int __arm_gen_u_Rd_RnRm_g(const unsigned int, unsigned int,
                                   unsigned int);
unsigned int __arm_gen_u_Rd_Rn(const unsigned int, unsigned int);
unsigned int __arm_gen_u_Rd_RnRm(const unsigned int, unsigned int,
                                 unsigned int);
...
unsigned __int64 __arm_gen_u_Rdn_RdnRmRs(const unsigned int, unsigned __int64,
                                         unsigned int, unsigned int);
unsigned __int64 __arm_gen_u_Rdn_RmRs(const unsigned int, unsigned int,
                                      unsigned int);
unsigned int __arm_gen_u_Rn_RmRs(const unsigned int, unsigned int,
                                 unsigned int);
unsigned int __arm_gen_u_Rn_RmRsRd(const unsigned int, unsigned int,
                                   unsigned int, unsigned int);
...
#define _ARMINTR_ASSERT_RANGE(val, low, high, name)                            \
  (_ARMINTR_ASSERT(_ARMINTR_IN_RANGE((val), (low), (high)),                    \
                   name " is out of range '" #low " - " #high "'"))
...
#define _ARMINTR_ASSERT_SAT_BIT(sat_bit, low, high)                            \
  (_ARMINTR_ASSERT_RANGE((sat_bit), low, high,                                 \
                         "saturation bit position")) // low, high intentionally
                                                     // not in (parentheses)

#if defined(_M_THUMB)
#define _ARMINTR_ASSERT_SAT_SHIFT(type, amt)                                   \
  (_ARMINTR_ASSERT(((type) == _ARM_LSL) || ((type) == _ARM_ASR),               \
                   "shift type must be _ARM_LSL or _ARM_ASR"),                 \
   _ARMINTR_ASSERT(((type) != _ARM_LSL) || _ARMINTR_IN_RANGE((amt), 0, 31),    \
                   "shift is out of range '0 - 31'"),                          \
   _ARMINTR_ASSERT(((type) != _ARM_ASR) || _ARMINTR_IN_RANGE((amt), 1, 31),    \
                   "shift is out of range '1 - 31'"))
...
#define _ARMINTR_ASSERT_SAT_SHIFT(type, amt)                                   \
  (_ARMINTR_ASSERT(((type) == _ARM_LSL) || ((type) == _ARM_ASR),               \
   ...
   _ARMINTR_ASSERT(((type) != _ARM_LSL) || _ARMINTR_IN_RANGE((amt), 0, 31),    \
                   "shift is out of range '0 - 31'"),                          \
   _ARMINTR_ASSERT(((type) != _ARM_ASR) || _ARMINTR_IN_RANGE((amt), 1, 32),    \
                   "shift is out of range '1 - 32'"))
#endif /* defined (_M_THUMB) */

#if defined(_M_THUMB)

#define _ARMINTR_ENCODE_XTROT(rot) (((rot) & 0x18U) << 17)
#define _ARMINTR_ENCODE_PKHSHIFT(shift)                                        \
  ((((shift) & 0x1CU) << 26) | (((shift) & 0x3U) << 22))
#define _ARMINTR_ENCODE_IMM5_16(imm) (((imm) & 0x1FU) << 16)
#define _ARMINTR_ENCODE_IMM5_7(imm)                                            \
  ((((imm) & 0x1CU) << 26) | (((imm) & 0x3U) << 22))
#define _ARMINTR_ENCODE_SAT_SH(type, amt)                                      \
  ((((type) & 2U) << 4) | _ARMINTR_ENCODE_IMM5_7(amt))
...
#define _ARMINTR_ENCODE_SAT_SH(type, amt)                                      \
  ((((type) & 2U) << 5) | _ARMINTR_ENCODE_IMM5_7(amt))
#define _ARMINTR_ENCODE_IMM4_16(bit) (((bit) & 0xFU) << 16)
...
#define _arm_smlal(_RdHiLo, _Rn, _Rm)                                          \
  (__arm_gen_s_Rdn_RdnRmRs(_ARMINTR_SMLAL, (_RdHiLo), (_Rn), (_Rm)))
#define _arm_umlal(_RdHiLo, _Rn, _Rm)                                          \
  (__arm_gen_u_Rdn_RdnRmRs(_ARMINTR_UMLAL, (_RdHiLo), (_Rn), (_Rm)))
...
#define _arm_qdadd(_Rm, _Rn)                                                   \
  (__arm_gen_s_Rd_RnRm_q(_ARMINTR_QDADD, (_Rn), (_Rm)))
#define _arm_qdsub(_Rm, _Rn)                                                   \
  (__arm_gen_s_Rd_RnRm_q(_ARMINTR_QDSUB, (_Rn), (_Rm)))
#define _arm_qsub(_Rm, _Rn) (__arm_gen_s_Rd_RnRm_q(_ARMINTR_QSUB, (_Rn), (_Rm)))

#define _arm_smlabb(_Rn, _Rm, _Ra)                                             \
  (__arm_gen_s_Rn_RmRsRd(_ARMINTR_SMLABB, (_Rn), (_Rm), (_Ra)))
#define _arm_smlabt(_Rn, _Rm, _Ra)                                             \
  (__arm_gen_s_Rn_RmRsRd(_ARMINTR_SMLABT, (_Rn), (_Rm), (_Ra)))
#define _arm_smlatb(_Rn, _Rm, _Ra)                                             \
  (__arm_gen_s_Rn_RmRsRd(_ARMINTR_SMLATB, (_Rn), (_Rm), (_Ra)))
#define _arm_smlatt(_Rn, _Rm, _Ra)                                             \
  (__arm_gen_s_Rn_RmRsRd(_ARMINTR_SMLATT, (_Rn), (_Rm), (_Ra)))

#define _arm_smlalbb(_RdHiLo, _Rn, _Rm)                                        \
  (__arm_gen_s_Rdn_RdnRmRs(_ARMINTR_SMLALBB, (_RdHiLo), (_Rn), (_Rm)))
#define _arm_smlalbt(_RdHiLo, _Rn, _Rm)                                        \
  (__arm_gen_s_Rdn_RdnRmRs(_ARMINTR_SMLALBT, (_RdHiLo), (_Rn), (_Rm)))
#define _arm_smlaltb(_RdHiLo, _Rn, _Rm)                                        \
  (__arm_gen_s_Rdn_RdnRmRs(_ARMINTR_SMLALTB, (_RdHiLo), (_Rn), (_Rm)))
#define _arm_smlaltt(_RdHiLo, _Rn, _Rm)                                        \
  (__arm_gen_s_Rdn_RdnRmRs(_ARMINTR_SMLALTT, (_RdHiLo), (_Rn), (_Rm)))

#define _arm_smlawb(_Rn, _Rm, _Ra)                                             \
  (__arm_gen_s_Rn_RmRsRd(_ARMINTR_SMLAWB, (_Rn), (_Rm), (_Ra)))
#define _arm_smlawt(_Rn, _Rm, _Ra)                                             \
  (__arm_gen_s_Rn_RmRsRd(_ARMINTR_SMLAWT, (_Rn), (_Rm), (_Ra)))

#define _arm_smulbb(_Rn, _Rm)                                                  \
  (__arm_gen_s_Rn_RmRs(_ARMINTR_SMULBB, (_Rn), (_Rm)))
#define _arm_smulbt(_Rn, _Rm)                                                  \
  (__arm_gen_s_Rn_RmRs(_ARMINTR_SMULBT, (_Rn), (_Rm)))
#define _arm_smultb(_Rn, _Rm)                                                  \
  (__arm_gen_s_Rn_RmRs(_ARMINTR_SMULTB, (_Rn), (_Rm)))
#define _arm_smultt(_Rn, _Rm)                                                  \
  (__arm_gen_s_Rn_RmRs(_ARMINTR_SMULTT, (_Rn), (_Rm)))

#define _arm_smulwb(_Rn, _Rm)                                                  \
  (__arm_gen_s_Rn_RmRs(_ARMINTR_SMULWB, (_Rn), (_Rm)))
#define _arm_smulwt(_Rn, _Rm)                                                  \
  (__arm_gen_s_Rn_RmRs(_ARMINTR_SMULWT, (_Rn), (_Rm)))

/* ARMv6 */

#define _arm_sadd16(_Rn, _Rm)                                                  \
  (__arm_gen_s_Rd_RnRm_g(_ARMINTR_SADD16, (_Rn), (_Rm)))
#define _arm_sadd8(_Rn, _Rm)                                                   \
  (__arm_gen_s_Rd_RnRm_g(_ARMINTR_SADD8, (_Rn), (_Rm)))
...
#define _arm_ssub16(_Rn, _Rm)                                                  \
  (__arm_gen_s_Rd_RnRm_g(_ARMINTR_SSUB16, (_Rn), (_Rm)))
#define _arm_ssub8(_Rn, _Rm)                                                   \
  (__arm_gen_s_Rd_RnRm_g(_ARMINTR_SSUB8, (_Rn), (_Rm)))

#define _arm_shadd16(_Rn, _Rm)                                                 \
  (__arm_gen_s_Rd_RnRm(_ARMINTR_SHADD16, (_Rn), (_Rm)))
#define _arm_shadd8(_Rn, _Rm)                                                  \
  (__arm_gen_s_Rd_RnRm(_ARMINTR_SHADD8, (_Rn), (_Rm)))
...
#define _arm_shsub16(_Rn, _Rm)                                                 \
  (__arm_gen_s_Rd_RnRm(_ARMINTR_SHSUB16, (_Rn), (_Rm)))
#define _arm_shsub8(_Rn, _Rm)                                                  \
  (__arm_gen_s_Rd_RnRm(_ARMINTR_SHSUB8, (_Rn), (_Rm)))

#define _arm_qadd16(_Rn, _Rm)                                                  \
  (__arm_gen_s_Rd_RnRm(_ARMINTR_QADD16, (_Rn), (_Rm)))
...
#define _arm_qsub16(_Rn, _Rm)                                                  \
  (__arm_gen_s_Rd_RnRm(_ARMINTR_QSUB16, (_Rn), (_Rm)))
#define _arm_qsub8(_Rn, _Rm) (__arm_gen_s_Rd_RnRm(_ARMINTR_QSUB8, (_Rn), (_Rm)))

#define _arm_uadd16(_Rn, _Rm)                                                  \
  (__arm_gen_u_Rd_RnRm_g(_ARMINTR_UADD16, (_Rn), (_Rm)))
#define _arm_uadd8(_Rn, _Rm)                                                   \
  (__arm_gen_u_Rd_RnRm_g(_ARMINTR_UADD8, (_Rn), (_Rm)))
...
#define _arm_usub16(_Rn, _Rm)                                                  \
  (__arm_gen_u_Rd_RnRm_g(_ARMINTR_USUB16, (_Rn), (_Rm)))
#define _arm_usub8(_Rn, _Rm)                                                   \
  (__arm_gen_u_Rd_RnRm_g(_ARMINTR_USUB8, (_Rn), (_Rm)))

#define _arm_uhadd16(_Rn, _Rm)                                                 \
  (__arm_gen_u_Rd_RnRm(_ARMINTR_UHADD16, (_Rn), (_Rm)))
#define _arm_uhadd8(_Rn, _Rm)                                                  \
  (__arm_gen_u_Rd_RnRm(_ARMINTR_UHADD8, (_Rn), (_Rm)))
...
#define _arm_uhsub16(_Rn, _Rm)                                                 \
  (__arm_gen_u_Rd_RnRm(_ARMINTR_UHSUB16, (_Rn), (_Rm)))
#define _arm_uhsub8(_Rn, _Rm)                                                  \
  (__arm_gen_u_Rd_RnRm(_ARMINTR_UHSUB8, (_Rn), (_Rm)))

#define _arm_uqadd16(_Rn, _Rm)                                                 \
  (__arm_gen_u_Rd_RnRm(_ARMINTR_UQADD16, (_Rn), (_Rm)))
#define _arm_uqadd8(_Rn, _Rm)                                                  \
  (__arm_gen_u_Rd_RnRm(_ARMINTR_UQADD8, (_Rn), (_Rm)))
...
#define _arm_uqsub16(_Rn, _Rm)                                                 \
  (__arm_gen_u_Rd_RnRm(_ARMINTR_UQSUB16, (_Rn), (_Rm)))
#define _arm_uqsub8(_Rn, _Rm)                                                  \
  (__arm_gen_u_Rd_RnRm(_ARMINTR_UQSUB8, (_Rn), (_Rm)))

#define _arm_sxtab(_Rn, _Rm, _Rotation)                                        \
  (_ARMINTR_ASSERT_ROT(_Rotation),                                             \
   __arm_gen_s_Rd_RnRm(_ARMINTR_SXTAB | _ARMINTR_ENCODE_XTROT(_Rotation),      \
                       (_Rn), (_Rm)))
#define _arm_sxtab16(_Rn, _Rm, _Rotation)                                      \
  (_ARMINTR_ASSERT_ROT(_Rotation),                                             \
   __arm_gen_s_Rd_RnRm(_ARMINTR_SXTAB16 | _ARMINTR_ENCODE_XTROT(_Rotation),    \
                       (_Rn), (_Rm)))
#define _arm_sxtah(_Rn, _Rm, _Rotation)                                        \
  (_ARMINTR_ASSERT_ROT(_Rotation),                                             \
   __arm_gen_s_Rd_RnRm(_ARMINTR_SXTAH | _ARMINTR_ENCODE_XTROT(_Rotation),      \
                       (_Rn), (_Rm)))

#define _arm_uxtab(_Rn, _Rm, _Rotation)                                        \
  (_ARMINTR_ASSERT_ROT(_Rotation),                                             \
   __arm_gen_u_Rd_RnRm(_ARMINTR_UXTAB | _ARMINTR_ENCODE_XTROT(_Rotation),      \
                       (_Rn), (_Rm)))
#define _arm_uxtab16(_Rn, _Rm, _Rotation)                                      \
  (_ARMINTR_ASSERT_ROT(_Rotation),                                             \
   __arm_gen_u_Rd_RnRm(_ARMINTR_UXTAB16 | _ARMINTR_ENCODE_XTROT(_Rotation),    \
                       (_Rn), (_Rm)))
#define _arm_uxtah(_Rn, _Rm, _Rotation)                                        \
  (_ARMINTR_ASSERT_ROT(_Rotation),                                             \
   __arm_gen_u_Rd_RnRm(_ARMINTR_UXTAH | _ARMINTR_ENCODE_XTROT(_Rotation),      \
                       (_Rn), (_Rm)))

#define _arm_sxtb(_Rn, _Rotation)                                              \
  (_ARMINTR_ASSERT_ROT(_Rotation),                                             \
   __arm_gen_s_Rd_Rm(_ARMINTR_SXTB | _ARMINTR_ENCODE_XTROT(_Rotation), (_Rn)))
#define _arm_sxtb16(_Rn, _Rotation)                                            \
  (_ARMINTR_ASSERT_ROT(_Rotation),                                             \
   __arm_gen_s_Rd_Rm(_ARMINTR_SXTB16 | _ARMINTR_ENCODE_XTROT(_Rotation),       \
                     (_Rn)))
#define _arm_sxth(_Rn, _Rotation)                                              \
  (_ARMINTR_ASSERT_ROT(_Rotation),                                             \
   __arm_gen_s_Rd_Rm(_ARMINTR_SXTH | _ARMINTR_ENCODE_XTROT(_Rotation), (_Rn)))

#define _arm_uxtb(_Rn, _Rotation)                                              \
  (_ARMINTR_ASSERT_ROT(_Rotation),                                             \
   __arm_gen_u_Rd_Rm(_ARMINTR_UXTB | _ARMINTR_ENCODE_XTROT(_Rotation), (_Rn)))
#define _arm_uxtb16(_Rn, _Rotation)                                            \
  (_ARMINTR_ASSERT_ROT(_Rotation),                                             \
   __arm_gen_u_Rd_Rm(_ARMINTR_UXTB16 | _ARMINTR_ENCODE_XTROT(_Rotation),       \
                     (_Rn)))
#define _arm_uxth(_Rn, _Rotation)                                              \
  (_ARMINTR_ASSERT_ROT(_Rotation),                                             \
   __arm_gen_u_Rd_Rm(_ARMINTR_UXTBH | _ARMINTR_ENCODE_XTROT(_Rotation),        \
                     (_Rn)))

#define _arm_pkhbt(_Rn, _Rm, _Lsl_imm)                                         \
  (_ARMINTR_ASSERT_RANGE((_Lsl_imm), 0, 31, "logical left shift"),             \
   __arm_gen_s_Rd_RnRm(_ARMINTR_PKHBT | _ARMINTR_ENCODE_PKHSHIFT(_Lsl_imm),    \
                       (_Rn), (_Rm)))
#define _arm_pkhtb(_Rn, _Rm, _Asr_imm)                                         \
  (_ARMINTR_ASSERT_RANGE((_Asr_imm), 1, 32, "arithmetic right shift"),         \
   __arm_gen_s_Rd_RnRm(_ARMINTR_PKHTB | _ARMINTR_ENCODE_PKHSHIFT(_Asr_imm),    \
                       (_Rn), (_Rm)))

#define _arm_usad8(_Rn, _Rm) (__arm_gen_u_Rn_RmRs(_ARMINTR_USAD8, (_Rn), (_Rm)))

#define _arm_usada8(_Rn, _Rm, _Ra)                                             \
  (__arm_gen_u_Rn_RmRsRd(_ARMINTR_USADA8, (_Rn), (_Rm), (_Ra)))

#define _arm_ssat(_Sat_imm, _Rn, _Shift_type, _Shift_imm)                      \
  (_ARMINTR_ASSERT_SAT_BIT((_Sat_imm), 1, 32),                                 \
   _ARMINTR_ASSERT_SAT_SHIFT((_Shift_type), (_Shift_imm)),                     \
   _ARMINTR_S_DMx(_ARMINTR_SSAT | _ARMINTR_ENCODE_IMM5_16((_Sat_imm) - 1) |    \
                      _ARMINTR_ENCODE_SAT_SH((_Shift_type), (_Shift_imm)),     \
                  (_Rn)))
#define _arm_usat(_Sat_imm, _Rn, _Shift_type, _Shift_imm)                      \
  (_ARMINTR_ASSERT_SAT_BIT((_Sat_imm), 0, 31),                                 \
   _ARMINTR_ASSERT_SAT_SHIFT((_Shift_type), (_Shift_imm)),                     \
   _ARMINTR_S_DMx(_ARMINTR_USAT | _ARMINTR_ENCODE_IMM5_16(_Sat_imm) |          \
                      _ARMINTR_ENCODE_SAT_SH((_Shift_type), (_Shift_imm)),     \
                  (_Rn)))

#define _arm_ssat16(_Sat_imm, _Rn)                                             \
  (_ARMINTR_ASSERT_SAT_BIT((_Sat_imm), 1, 16),                                 \
   _ARMINTR_S_DMx(_ARMINTR_SSAT16 | _ARMINTR_ENCODE_IMM4_16((_Sat_imm) - 1),   \
                  (_Rn)))
#define _arm_usat16(_Sat_imm, _Rn)                                             \
  (_ARMINTR_ASSERT_SAT_BIT((_Sat_imm), 0, 15),                                 \
...
#define _arm_smlad(_Rn, _Rm, _Ra)                                              \
  (__arm_gen_s_Rn_RmRsRd(_ARMINTR_SMLAD, (_Rn), (_Rm), (_Ra)))
#define _arm_smladx(_Rn, _Rm, _Ra)                                             \
  (__arm_gen_s_Rn_RmRsRd(_ARMINTR_SMLADX, (_Rn), (_Rm), (_Ra)))
#define _arm_smlsd(_Rn, _Rm, _Ra)                                              \
  (__arm_gen_s_Rn_RmRsRd(_ARMINTR_SMLSD, (_Rn), (_Rm), (_Ra)))
#define _arm_smlsdx(_Rn, _Rm, _Ra)                                             \
  (__arm_gen_s_Rn_RmRsRd(_ARMINTR_SMLSDX, (_Rn), (_Rm), (_Ra)))

#define _arm_smmla(_Rn, _Rm, _Ra)                                              \
  (__arm_gen_s_Rn_RmRsRd(_ARMINTR_SMMLA, (_Rn), (_Rm), (_Ra)))
#define _arm_smmlar(_Rn, _Rm, _Ra)                                             \
  (__arm_gen_s_Rn_RmRsRd(_ARMINTR_SMMLAR, (_Rn), (_Rm), (_Ra)))
#define _arm_smmls(_Rn, _Rm, _Ra)                                              \
  (__arm_gen_s_Rn_RmRsRd(_ARMINTR_SMMLS, (_Rn), (_Rm), (_Ra)))
#define _arm_smmlsr(_Rn, _Rm, _Ra)                                             \
  (__arm_gen_s_Rn_RmRsRd(_ARMINTR_SMMLSR, (_Rn), (_Rm), (_Ra)))

#define _arm_smmul(_Rn, _Rm) (__arm_gen_s_Rn_RmRs(_ARMINTR_SMMUL, (_Rn), (_Rm)))
#define _arm_smmulr(_Rn, _Rm)                                                  \
  (__arm_gen_s_Rn_RmRs(_ARMINTR_SMMULR, (_Rn), (_Rm)))

#define _arm_smlald(_RdHiLo, _Rn, _Rm)                                         \
  (__arm_gen_s_Rdn_RdnRmRs(_ARMINTR_SMLALD, (_RdHiLo), (_Rn), (_Rm)))
#define _arm_smlaldx(_RdHiLo, _Rn, _Rm)                                        \
  (__arm_gen_s_Rdn_RdnRmRs(_ARMINTR_SMLALDX, (_RdHiLo), (_Rn), (_Rm)))
#define _arm_smlsld(_RdHiLo, _Rn, _Rm)                                         \
  (__arm_gen_s_Rdn_RdnRmRs(_ARMINTR_SMLSLD, (_RdHiLo), (_Rn), (_Rm)))
#define _arm_smlsldx(_RdHiLo, _Rn, _Rm)                                        \
  (__arm_gen_s_Rdn_RdnRmRs(_ARMINTR_SMLSLDX, (_RdHiLo), (_Rn), (_Rm)))

#define _arm_smuad(_Rn, _Rm) (__arm_gen_s_Rn_RmRs(_ARMINTR_SMUAD, (_Rn), (_Rm)))
#define _arm_smuadx(_Rn, _Rm)                                                  \
  (__arm_gen_s_Rn_RmRs(_ARMINTR_SMUADX, (_Rn), (_Rm)))
#define _arm_smusd(_Rn, _Rm) (__arm_gen_s_Rn_RmRs(_ARMINTR_SMUSD, (_Rn), (_Rm)))
#define _arm_smusdx(_Rn, _Rm)                                                  \
  (__arm_gen_s_Rn_RmRs(_ARMINTR_SMUSDX, (_Rn), (_Rm)))

#define _arm_smull(_Rn, _Rm)                                                   \
  (__arm_gen_s_Rdn_RmRs(_ARMINTR_SMULL, (_Rn), (_Rm)))
#define _arm_umull(_Rn, _Rm)                                                   \
  (__arm_gen_u_Rdn_RmRs(_ARMINTR_UMULL, (_Rn), (_Rm)))

#define _arm_umaal(_RdLo, _RdHi, _Rn, _Rm)                                     \
  (__arm_gen_u_Rdn_RdnRmRs(_ARMINTR_UMAAL,                                     \
                           ((unsigned __int64)(_RdHi) << 32) | (_RdLo), (_Rn), \
                           (_Rm)))

/* ARMv6T2 */

#define _arm_bfc(_Rd, _Lsb, _Width)                                            \
  (_ARMINTR_ASSERT_RANGE((_Lsb), 0, 31, "least significant bit"),              \
   _ARMINTR_ASSERT_RANGE((_Width), 1, 32 - (_Lsb), "width"),                   \
   __arm_gen_u_Rd_Rd(_ARMINTR_BFC | _ARMINTR_ENCODE_IMM5_7(_Lsb) |             \
                         _ARMINTR_ENCODE_IMM5_16((_Lsb) + (_Width) - 1),       \
                     (_Rd)))
#define _arm_bfi(_Rd, _Rn, _Lsb, _Width)                                       \
  (_ARMINTR_ASSERT_RANGE((_Lsb), 0, 31, "least significant bit"),              \
   _ARMINTR_ASSERT_RANGE((_Width), 1, 32 - (_Lsb), "width"),                   \
   _ARMINTR_U_DDMx(_ARMINTR_BFI | _ARMINTR_ENCODE_IMM5_7(_Lsb) |               \
                       _ARMINTR_ENCODE_IMM5_16((_Lsb) + (_Width) - 1),         \
                   (_Rd), (_Rn)))

#define _arm_rbit(_Rm) (__arm_gen_u_Rd_Rm2(_ARMINTR_RBIT, (_Rm)))

#define _arm_sbfx(_Rn, _Lsb, _Width)                                           \
  (_ARMINTR_ASSERT_RANGE((_Lsb), 0, 31, "least significant bit"),              \
   _ARMINTR_ASSERT_RANGE((_Width), 1, 32 - (_Lsb), "width"),                   \
   _ARMINTR_S_DMx(_ARMINTR_SBFX | _ARMINTR_ENCODE_IMM5_7(_Lsb) |               \
                      _ARMINTR_ENCODE_IMM5_16((_Width) - 1),                   \
                  (_Rn)))
#define _arm_ubfx(_Rn, _Lsb, _Width)                                           \
  (_ARMINTR_ASSERT_RANGE((_Lsb), 0, 31, "least significant bit"),              \
   _ARMINTR_ASSERT_RANGE((_Width), 1, 32 - (_Lsb), "width"),                   \
   _ARMINTR_U_DMx(_ARMINTR_UBFX | _ARMINTR_ENCODE_IMM5_7(_Lsb) |               \
                      _ARMINTR_ENCODE_IMM5_16((_Width) - 1),                   \
                  (_Rn)))
