...
int __cdecl _mtx_timedlock32(mtx_t *__restrict _Mtx,
                             const struct _timespec32 *__restrict _Ts);
int __cdecl _mtx_timedlock64(mtx_t *__restrict _Mtx,
                             const struct _timespec64 *__restrict _Ts);

#ifndef _CRT_NO_TIME_T
#ifdef _USE_32BIT_TIME_T
static inline int __cdecl mtx_timedlock(mtx_t *__restrict _Mtx,
                                        const struct timespec *__restrict _Ts) {
...
int __cdecl _cnd_timedwait32(cnd_t *_Cond, mtx_t *_Mtx,
                             const struct _timespec32 *_Ts);
int __cdecl _cnd_timedwait64(cnd_t *_Cond, mtx_t *_Mtx,
                             const struct _timespec64 *_Ts);

#ifndef _CRT_NO_TIME_T
#ifdef _USE_32BIT_TIME_T
static inline int __cdecl cnd_timedwait(cnd_t *_Cond, mtx_t *_Mtx,
...
_Success_(return == thrd_success) int __cdecl
thrd_create(_Out_ thrd_t *_Thr, thrd_start_t _Func, void *_Arg);
...
int __cdecl _thrd_sleep32(const struct _timespec32 *duration,
                          struct _timespec32 *remaining);
int __cdecl _thrd_sleep64(const struct _timespec64 *duration,
                          struct _timespec64 *remaining);

#ifndef _CRT_NO_TIME_T
#ifdef _USE_32BIT_TIME_T
static inline int __cdecl thrd_sleep(const struct timespec *duration,
                                     struct timespec *remaining) {
  return _thrd_sleep32((struct _timespec32 *)duration,
                       (struct _timespec32 *)remaining);
}
#else
static inline int __cdecl thrd_sleep(const struct timespec *duration,
                                     struct timespec *remaining) {
  return _thrd_sleep64((struct _timespec64 *)duration,
                       (struct _timespec64 *)remaining);
}
#endif
#endif
