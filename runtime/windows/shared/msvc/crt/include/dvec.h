...
/*
 *  Definition of a C++ class interface to Intel(R) Pentium(R) 4 processor SSE2
 * intrinsics.
 *
...
_ACRTIMP void __cdecl _wassert(_In_z_ const wchar_t *_Message,
...
public:
  ...
  M128 &operator&=(const M128 &_A) {
    return *this = (M128)_mm_and_si128(vec, _A);
  }
  M128 &operator|=(const M128 &_A) {
    return *this = (M128)_mm_or_si128(vec, _A);
  }
  M128 &operator^=(const M128 &_A) {
    return *this = (M128)_mm_xor_si128(vec, _A);
  }
};

inline M128 operator&(const M128 &_A, const M128 &_B) {
...
inline M128 andnot(const M128 &_A, const M128 &_B) {
...
public:
  ...
  I128vec1 &operator&=(const M128 &_A) {
    return *this = (I128vec1)_mm_and_si128(vec, _A);
  }
  I128vec1 &operator|=(const M128 &_A) {
    return *this = (I128vec1)_mm_or_si128(vec, _A);
  }
  I128vec1 &operator^=(const M128 &_A) {
    return *this = (I128vec1)_mm_xor_si128(vec, _A);
  }
};
...
public:
  ...
  I64vec2 &operator&=(const M128 &_A) {
    return *this = (I64vec2)_mm_and_si128(vec, _A);
  }
  I64vec2 &operator|=(const M128 &_A) {
    return *this = (I64vec2)_mm_or_si128(vec, _A);
  }
  I64vec2 &operator^=(const M128 &_A) {
    return *this = (I64vec2)_mm_xor_si128(vec, _A);
  }

  /* Addition & Subtraction Assignment Operators */
  I64vec2 &operator+=(const I64vec2 &_A) {
    return *this = (I64vec2)_mm_add_epi64(vec, _A);
  }
  I64vec2 &operator-=(const I64vec2 &_A) {
    return *this = (I64vec2)_mm_sub_epi64(vec, _A);
  }
  ...
  I64vec2 &operator<<=(const I64vec2 &_A) {
    return *this = (I64vec2)_mm_sll_epi64(vec, _A);
  }
  I64vec2 &operator<<=(int _Count) {
    return *this = (I64vec2)_mm_slli_epi64(vec, _Count);
  }
  ...
  I64vec2 &operator>>=(const I64vec2 &_A) {
    return *this = (I64vec2)_mm_srl_epi64(vec, _A);
  }
  I64vec2 &operator>>=(int _Count) {
    return *this = (I64vec2)_mm_srli_epi64(vec, _Count);
  }

  /* Element Access for Debug, No data modified */
  const __int64 &operator[](int _I) const {
    _VEC_ASSERT(static_cast<unsigned int>(_I) <
                2); /* Only 2 elements to access */
...
/* Unpacks */
inline I64vec2 unpack_low(const I64vec2 &_A, const I64vec2 &_B) {
  return _mm_unpacklo_epi64(_A, _B);
}
inline I64vec2 unpack_high(const I64vec2 &_A, const I64vec2 &_B) {
  return _mm_unpackhi_epi64(_A, _B);
}
...
public:
  ...
  I32vec4(int _I3, int _I2, int _I1, int _I0) {
    vec = _mm_set_epi32(_I3, _I2, _I1, _I0);
  }
  ...
  I32vec4 &operator&=(const M128 &_A) {
    return *this = (I32vec4)_mm_and_si128(vec, _A);
  }
  I32vec4 &operator|=(const M128 &_A) {
    return *this = (I32vec4)_mm_or_si128(vec, _A);
  }
  I32vec4 &operator^=(const M128 &_A) {
    return *this = (I32vec4)_mm_xor_si128(vec, _A);
  }

  /* Addition & Subtraction Assignment Operators */
  I32vec4 &operator+=(const I32vec4 &_A) {
    return *this = (I32vec4)_mm_add_epi32(vec, _A);
  }
  I32vec4 &operator-=(const I32vec4 &_A) {
    return *this = (I32vec4)_mm_sub_epi32(vec, _A);
  }
  ...
  I32vec4 &operator<<=(const I32vec4 &_A) {
    return *this = (I32vec4)_mm_sll_epi32(vec, _A);
  }
  I32vec4 &operator<<=(int _Count) {
    return *this = (I32vec4)_mm_slli_epi32(vec, _Count);
  }
};

inline I32vec4 cmpeq(const I32vec4 &_A, const I32vec4 &_B) {
  return _mm_cmpeq_epi32(_A, _B);
}
inline I32vec4 cmpneq(const I32vec4 &_A, const I32vec4 &_B) {
  return _mm_andnot_si128(_mm_cmpeq_epi32(_A, _B), get_mask128());
}

inline I32vec4 unpack_low(const I32vec4 &_A, const I32vec4 &_B) {
  return _mm_unpacklo_epi32(_A, _B);
}
inline I32vec4 unpack_high(const I32vec4 &_A, const I32vec4 &_B) {
  return _mm_unpackhi_epi32(_A, _B);
}
...
public:
  ...
  Is32vec4 &operator&=(const M128 &_A) {
    return *this = (Is32vec4)_mm_and_si128(vec, _A);
  }
  Is32vec4 &operator|=(const M128 &_A) {
    return *this = (Is32vec4)_mm_or_si128(vec, _A);
  }
  Is32vec4 &operator^=(const M128 &_A) {
    return *this = (Is32vec4)_mm_xor_si128(vec, _A);
  }

  /* Addition & Subtraction Assignment Operators */
  Is32vec4 &operator+=(const I32vec4 &_A) {
    return *this = (Is32vec4)_mm_add_epi32(vec, _A);
  }
  Is32vec4 &operator-=(const I32vec4 &_A) {
    return *this = (Is32vec4)_mm_sub_epi32(vec, _A);
  }
  ...
  Is32vec4 &operator<<=(const M128 &_A) {
    return *this = (Is32vec4)_mm_sll_epi32(vec, _A);
  }
  Is32vec4 &operator<<=(int _Count) {
    return *this = (Is32vec4)_mm_slli_epi32(vec, _Count);
  }
  ...
  Is32vec4 &operator>>=(const M128 &_A) {
    return *this = (Is32vec4)_mm_sra_epi32(vec, _A);
  }
  Is32vec4 &operator>>=(int _Count) {
    return *this = (Is32vec4)_mm_srai_epi32(vec, _Count);
  }

#if defined(_ENABLE_VEC_DEBUG)
  /* Output for Debug */
  friend std::ostream &operator<<(std::ostream &_Os, const Is32vec4 &_A) {
    _Os << "[3]:" << _MM_4DW(3, _A) << " [2]:" << _MM_4DW(2, _A)
        << " [1]:" << _MM_4DW(1, _A) << " [0]:" << _MM_4DW(0, _A);
    return _Os;
  }
#endif /* defined (_ENABLE_VEC_DEBUG) */
...
/* Compares */
inline Is32vec4 cmpeq(const Is32vec4 &_A, const Is32vec4 &_B) {
  return _mm_cmpeq_epi32(_A, _B);
}
inline Is32vec4 cmpneq(const Is32vec4 &_A, const Is32vec4 &_B) {
  return _mm_andnot_si128(_mm_cmpeq_epi32(_A, _B), get_mask128());
}
inline Is32vec4 cmpgt(const Is32vec4 &_A, const Is32vec4 &_B) {
  return _mm_cmpgt_epi32(_A, _B);
}
inline Is32vec4 cmplt(const Is32vec4 &_A, const Is32vec4 &_B) {
  return _mm_cmpgt_epi32(_B, _A);
}

/* Unpacks */
inline Is32vec4 unpack_low(const Is32vec4 &_A, const Is32vec4 &_B) {
  return _mm_unpacklo_epi32(_A, _B);
}
inline Is32vec4 unpack_high(const Is32vec4 &_A, const Is32vec4 &_B) {
  return _mm_unpackhi_epi32(_A, _B);
}
...
public:
  ...
  Iu32vec4(unsigned int _Ui3, unsigned int _Ui2, unsigned int _Ui1,
           unsigned int _Ui0)
  ...
  Iu32vec4 &operator&=(const M128 &_A) {
    return *this = (Iu32vec4)_mm_and_si128(vec, _A);
  }
  Iu32vec4 &operator|=(const M128 &_A) {
    return *this = (Iu32vec4)_mm_or_si128(vec, _A);
  }
  Iu32vec4 &operator^=(const M128 &_A) {
    return *this = (Iu32vec4)_mm_xor_si128(vec, _A);
  }

  /* Addition & Subtraction Assignment Operators */
  Iu32vec4 &operator+=(const I32vec4 &_A) {
    return *this = (Iu32vec4)_mm_add_epi32(vec, _A);
  }
  Iu32vec4 &operator-=(const I32vec4 &_A) {
    return *this = (Iu32vec4)_mm_sub_epi32(vec, _A);
  }
  ...
  Iu32vec4 &operator<<=(const M128 &_A) {
    return *this = (Iu32vec4)_mm_sll_epi32(vec, _A);
  }
  Iu32vec4 &operator<<=(int _Count) {
    return *this = (Iu32vec4)_mm_slli_epi32(vec, _Count);
  }
  Iu32vec4 operator>>(const M128 &_A) { return _mm_srl_epi32(vec, _A); }
  Iu32vec4 operator>>(int _Count) { return _mm_srli_epi32(vec, _Count); }
  Iu32vec4 &operator>>=(const M128 &_A) {
    return *this = (Iu32vec4)_mm_srl_epi32(vec, _A);
  }
  Iu32vec4 &operator>>=(int _Count) {
    return *this = (Iu32vec4)_mm_srli_epi32(vec, _Count);
  }

#if defined(_ENABLE_VEC_DEBUG)
  /* Output for Debug */
  friend std::ostream &operator<<(std::ostream &_Os, const Iu32vec4 &_A) {
    _Os << "[3]:" << _MM_4UDW(3, _A) << " [2]:" << _MM_4UDW(2, _A)
        << " [1]:" << _MM_4UDW(1, _A) << " [0]:" << _MM_4UDW(0, _A);
    return _Os;
  }
#endif /* defined (_ENABLE_VEC_DEBUG) */
...
inline I64vec2 operator*(const Iu32vec4 &_A, const Iu32vec4 &_B) {
  return _mm_mul_epu32(_A, _B);
}
inline Iu32vec4 cmpeq(const Iu32vec4 &_A, const Iu32vec4 &_B) {
  return _mm_cmpeq_epi32(_A, _B);
}
inline Iu32vec4 cmpneq(const Iu32vec4 &_A, const Iu32vec4 &_B) {
  return _mm_andnot_si128(_mm_cmpeq_epi32(_A, _B), get_mask128());
}

inline Iu32vec4 unpack_low(const Iu32vec4 &_A, const Iu32vec4 &_B) {
  return _mm_unpacklo_epi32(_A, _B);
}
inline Iu32vec4 unpack_high(const Iu32vec4 &_A, const Iu32vec4 &_B) {
  return _mm_unpackhi_epi32(_A, _B);
}
...
public:
  ...
  I16vec8(short _S7, short _S6, short _S5, short _S4, short _S3, short _S2,
          short _S1, short _S0) {
  ...
  I16vec8 &operator&=(const M128 &_A) {
    return *this = (I16vec8)_mm_and_si128(vec, _A);
  }
  I16vec8 &operator|=(const M128 &_A) {
    return *this = (I16vec8)_mm_or_si128(vec, _A);
  }
  I16vec8 &operator^=(const M128 &_A) {
    return *this = (I16vec8)_mm_xor_si128(vec, _A);
  }

  /* Addition & Subtraction Assignment Operators */
  I16vec8 &operator+=(const I16vec8 &_A) {
    return *this = (I16vec8)_mm_add_epi16(vec, _A);
  }
  I16vec8 &operator-=(const I16vec8 &_A) {
    return *this = (I16vec8)_mm_sub_epi16(vec, _A);
  }
  I16vec8 &operator*=(const I16vec8 &_A) {
    return *this = (I16vec8)_mm_mullo_epi16(vec, _A);
  }
  ...
  I16vec8 &operator<<=(const M128 &_A) {
    return *this = (I16vec8)_mm_sll_epi16(vec, _A);
  }
  I16vec8 &operator<<=(int _Count) {
    return *this = (I16vec8)_mm_slli_epi16(vec, _Count);
  }
};

inline I16vec8 operator*(const I16vec8 &_A, const I16vec8 &_B) {
  return _mm_mullo_epi16(_A, _B);
}

inline I16vec8 cmpeq(const I16vec8 &_A, const I16vec8 &_B) {
  return _mm_cmpeq_epi16(_A, _B);
}
inline I16vec8 cmpneq(const I16vec8 &_A, const I16vec8 &_B) {
  return _mm_andnot_si128(_mm_cmpeq_epi16(_A, _B), get_mask128());
}

inline I16vec8 unpack_low(const I16vec8 &_A, const I16vec8 &_B) {
  return _mm_unpacklo_epi16(_A, _B);
}
inline I16vec8 unpack_high(const I16vec8 &_A, const I16vec8 &_B) {
  return _mm_unpackhi_epi16(_A, _B);
}
...
public:
  ...
  Is16vec8 &operator&=(const M128 &_A) {
    return *this = (Is16vec8)_mm_and_si128(vec, _A);
  }
  Is16vec8 &operator|=(const M128 &_A) {
    return *this = (Is16vec8)_mm_or_si128(vec, _A);
  }
  Is16vec8 &operator^=(const M128 &_A) {
    return *this = (Is16vec8)_mm_xor_si128(vec, _A);
  }

  /* Addition & Subtraction Assignment Operators */
  Is16vec8 &operator+=(const I16vec8 &_A) {
    return *this = (Is16vec8)_mm_add_epi16(vec, _A);
  }
  Is16vec8 &operator-=(const I16vec8 &_A) {
    return *this = (Is16vec8)_mm_sub_epi16(vec, _A);
  }
  Is16vec8 &operator*=(const I16vec8 &_A) {
    return *this = (Is16vec8)_mm_mullo_epi16(vec, _A);
  }
  ...
  Is16vec8 &operator<<=(const M128 &_A) {
    return *this = (Is16vec8)_mm_sll_epi16(vec, _A);
  }
  Is16vec8 &operator<<=(int _Count) {
    return *this = (Is16vec8)_mm_slli_epi16(vec, _Count);
  }
  ...
  Is16vec8 &operator>>=(const M128 &_A) {
    return *this = (Is16vec8)_mm_sra_epi16(vec, _A);
  }
  Is16vec8 &operator>>=(int _Count) {
    return *this = (Is16vec8)_mm_srai_epi16(vec, _Count);
  }

#if defined(_ENABLE_VEC_DEBUG)
  /* Output for Debug */
  friend std::ostream &operator<<(std::ostream &_Os, const Is16vec8 &_A) {
    _Os << "[7]:" << _MM_8W(7, _A) << " [6]:" << _MM_8W(6, _A)
        << " [5]:" << _MM_8W(5, _A) << " [4]:" << _MM_8W(4, _A)
        << " [3]:" << _MM_8W(3, _A) << " [2]:" << _MM_8W(2, _A)
        << " [1]:" << _MM_8W(1, _A) << " [0]:" << _MM_8W(0, _A);
    return _Os;
  }
#endif /* defined (_ENABLE_VEC_DEBUG) */
...
inline Is16vec8 operator*(const Is16vec8 &_A, const Is16vec8 &_B) {
  return _mm_mullo_epi16(_A, _B);
}

/* Additional Is16vec8 functions: compares, unpacks, sat add/sub */
inline Is16vec8 cmpeq(const Is16vec8 &_A, const Is16vec8 &_B) {
  return _mm_cmpeq_epi16(_A, _B);
}
inline Is16vec8 cmpneq(const Is16vec8 &_A, const Is16vec8 &_B) {
  return _mm_andnot_si128(_mm_cmpeq_epi16(_A, _B), get_mask128());
}
inline Is16vec8 cmpgt(const Is16vec8 &_A, const Is16vec8 &_B) {
  return _mm_cmpgt_epi16(_A, _B);
}
inline Is16vec8 cmplt(const Is16vec8 &_A, const Is16vec8 &_B) {
  return _mm_cmpgt_epi16(_B, _A);
}

inline Is16vec8 unpack_low(const Is16vec8 &_A, const Is16vec8 &_B) {
  return _mm_unpacklo_epi16(_A, _B);
}
inline Is16vec8 unpack_high(const Is16vec8 &_A, const Is16vec8 &_B) {
  return _mm_unpackhi_epi16(_A, _B);
}

inline Is16vec8 mul_high(const Is16vec8 &_A, const Is16vec8 &_B) {
  return _mm_mulhi_epi16(_A, _B);
}
inline Is32vec4 mul_add(const Is16vec8 &_A, const Is16vec8 &_B) {
  return _mm_madd_epi16(_A, _B);
}

inline Is16vec8 sat_add(const Is16vec8 &_A, const Is16vec8 &_B) {
  return _mm_adds_epi16(_A, _B);
}
inline Is16vec8 sat_sub(const Is16vec8 &_A, const Is16vec8 &_B) {
  return _mm_subs_epi16(_A, _B);
}

inline Is16vec8 simd_max(const Is16vec8 &_A, const Is16vec8 &_B) {
  return _mm_max_epi16(_A, _B);
}
inline Is16vec8 simd_min(const Is16vec8 &_A, const Is16vec8 &_B) {
  return _mm_min_epi16(_A, _B);
}
...
public:
  ...
  Iu16vec8 &operator&=(const M128 &_A) {
    return *this = (Iu16vec8)_mm_and_si128(vec, _A);
  }
  Iu16vec8 &operator|=(const M128 &_A) {
    return *this = (Iu16vec8)_mm_or_si128(vec, _A);
  }
  Iu16vec8 &operator^=(const M128 &_A) {
    return *this = (Iu16vec8)_mm_xor_si128(vec, _A);
  }
  /* Addition & Subtraction Assignment Operators */
  Iu16vec8 &operator+=(const I16vec8 &_A) {
    return *this = (Iu16vec8)_mm_add_epi16(vec, _A);
  }
  Iu16vec8 &operator-=(const I16vec8 &_A) {
    return *this = (Iu16vec8)_mm_sub_epi16(vec, _A);
  }
  Iu16vec8 &operator*=(const I16vec8 &_A) {
    return *this = (Iu16vec8)_mm_mullo_epi16(vec, _A);
  }
  ...
  Iu16vec8 &operator<<=(const M128 &_A) {
    return *this = (Iu16vec8)_mm_sll_epi16(vec, _A);
  }
  Iu16vec8 &operator<<=(int _Count) {
    return *this = (Iu16vec8)_mm_slli_epi16(vec, _Count);
  }
  Iu16vec8 operator>>(const M128 &_A) { return _mm_srl_epi16(vec, _A); }
  Iu16vec8 operator>>(int _Count) { return _mm_srli_epi16(vec, _Count); }
  Iu16vec8 &operator>>=(const M128 &_A) {
    return *this = (Iu16vec8)_mm_srl_epi16(vec, _A);
  }
  Iu16vec8 &operator>>=(int _Count) {
    return *this = (Iu16vec8)_mm_srli_epi16(vec, _Count);
  }
...
inline Iu16vec8 operator*(const Iu16vec8 &_A, const Iu16vec8 &_B) {
  return _mm_mullo_epi16(_A, _B);
}

/* Additional Iu16vec8 functions: cmpeq,cmpneq, unpacks, sat add/sub */
inline Iu16vec8 cmpeq(const Iu16vec8 &_A, const Iu16vec8 &_B) {
  return _mm_cmpeq_epi16(_A, _B);
}
inline Iu16vec8 cmpneq(const Iu16vec8 &_A, const Iu16vec8 &_B) {
  return _mm_andnot_si128(_mm_cmpeq_epi16(_A, _B), get_mask128());
}

inline Iu16vec8 unpack_low(const Iu16vec8 &_A, const Iu16vec8 &_B) {
  return _mm_unpacklo_epi16(_A, _B);
}
inline Iu16vec8 unpack_high(const Iu16vec8 &_A, const Iu16vec8 &_B) {
  return _mm_unpackhi_epi16(_A, _B);
}

inline Iu16vec8 sat_add(const Iu16vec8 &_A, const Iu16vec8 &_B) {
  return _mm_adds_epu16(_A, _B);
}
inline Iu16vec8 sat_sub(const Iu16vec8 &_A, const Iu16vec8 &_B) {
  return _mm_subs_epu16(_A, _B);
}

inline Iu16vec8 simd_avg(const Iu16vec8 &_A, const Iu16vec8 &_B) {
  return _mm_avg_epu16(_A, _B);
}
inline I16vec8 mul_high(const Iu16vec8 &_A, const Iu16vec8 &_B) {
  return _mm_mulhi_epu16(_A, _B);
}
...
public:
  ...
  I8vec16(char _S15, char _S14, char _S13, char _S12, char _S11, char _S10,
          char _S9, char _S8, char _S7, char _S6, char _S5, char _S4, char _S3,
          char _S2, char _S1, char _S0) {
    vec = _mm_set_epi8(_S15, _S14, _S13, _S12, _S11, _S10, _S9, _S8, _S7, _S6,
                       _S5, _S4, _S3, _S2, _S1, _S0);
  }
  ...
  I8vec16 &operator&=(const M128 &_A) {
    return *this = (I8vec16)_mm_and_si128(vec, _A);
  }
  I8vec16 &operator|=(const M128 &_A) {
    return *this = (I8vec16)_mm_or_si128(vec, _A);
  }
  I8vec16 &operator^=(const M128 &_A) {
    return *this = (I8vec16)_mm_xor_si128(vec, _A);
  }

  /* Addition & Subtraction Assignment Operators */
  I8vec16 &operator+=(const I8vec16 &_A) {
    return *this = (I8vec16)_mm_add_epi8(vec, _A);
  }
  I8vec16 &operator-=(const I8vec16 &_A) {
    return *this = (I8vec16)_mm_sub_epi8(vec, _A);
  }
};

inline I8vec16 cmpeq(const I8vec16 &_A, const I8vec16 &_B) {
  return _mm_cmpeq_epi8(_A, _B);
}
inline I8vec16 cmpneq(const I8vec16 &_A, const I8vec16 &_B) {
  return _mm_andnot_si128(_mm_cmpeq_epi8(_A, _B), get_mask128());
}

inline I8vec16 unpack_low(const I8vec16 &_A, const I8vec16 &_B) {
  return _mm_unpacklo_epi8(_A, _B);
}
inline I8vec16 unpack_high(const I8vec16 &_A, const I8vec16 &_B) {
  return _mm_unpackhi_epi8(_A, _B);
}
...
public:
  ...
  Is8vec16(char _S15, char _S14, char _S13, char _S12, char _S11, char _S10,
           char _S9, char _S8, char _S7, char _S6, char _S5, char _S4, char _S3,
           char _S2, char _S1, char _S0)
      : I8vec16(_S15, _S14, _S13, _S12, _S11, _S10, _S9, _S8, _S7, _S6, _S5,
                _S4, _S3, _S2, _S1, _S0) {}
  ...
  Is8vec16 &operator&=(const M128 &_A) {
    return *this = (Is8vec16)_mm_and_si128(vec, _A);
  }
  Is8vec16 &operator|=(const M128 &_A) {
    return *this = (Is8vec16)_mm_or_si128(vec, _A);
  }
  Is8vec16 &operator^=(const M128 &_A) {
    return *this = (Is8vec16)_mm_xor_si128(vec, _A);
  }

  /* Addition & Subtraction Assignment Operators */
  Is8vec16 &operator+=(const I8vec16 &_A) {
    return *this = (Is8vec16)_mm_add_epi8(vec, _A);
  }
  Is8vec16 &operator-=(const I8vec16 &_A) {
    return *this = (Is8vec16)_mm_sub_epi8(vec, _A);
  }
  ...
  friend std::ostream &operator<<(std::ostream &_Os, const Is8vec16 &_A) {
    _Os << "[15]:" << short(_MM_16B(15, _A))
        ...
        << " [9]:" << short(_MM_16B(9, _A)) << " [8]:" << short(_MM_16B(8, _A))
        << " [7]:" << short(_MM_16B(7, _A)) << " [6]:" << short(_MM_16B(6, _A))
        << " [5]:" << short(_MM_16B(5, _A)) << " [4]:" << short(_MM_16B(4, _A))
        << " [3]:" << short(_MM_16B(3, _A)) << " [2]:" << short(_MM_16B(2, _A))
        << " [1]:" << short(_MM_16B(1, _A)) << " [0]:" << short(_MM_16B(0, _A));
    return _Os;
  }
#endif /* defined (_ENABLE_VEC_DEBUG) */
...
inline Is8vec16 cmpeq(const Is8vec16 &_A, const Is8vec16 &_B) {
  return _mm_cmpeq_epi8(_A, _B);
}
inline Is8vec16 cmpneq(const Is8vec16 &_A, const Is8vec16 &_B) {
  return _mm_andnot_si128(_mm_cmpeq_epi8(_A, _B), get_mask128());
}
inline Is8vec16 cmpgt(const Is8vec16 &_A, const Is8vec16 &_B) {
  return _mm_cmpgt_epi8(_A, _B);
}
inline Is8vec16 cmplt(const Is8vec16 &_A, const Is8vec16 &_B) {
  return _mm_cmplt_epi8(_A, _B);
}

inline Is8vec16 unpack_low(const Is8vec16 &_A, const Is8vec16 &_B) {
  return _mm_unpacklo_epi8(_A, _B);
}
inline Is8vec16 unpack_high(const Is8vec16 &_A, const Is8vec16 &_B) {
  return _mm_unpackhi_epi8(_A, _B);
}

inline Is8vec16 sat_add(const Is8vec16 &_A, const Is8vec16 &_B) {
  return _mm_adds_epi8(_A, _B);
}
inline Is8vec16 sat_sub(const Is8vec16 &_A, const Is8vec16 &_B) {
  return _mm_subs_epi8(_A, _B);
}
...
public:
  ...
  Iu8vec16(unsigned char _U15, unsigned char _U14, unsigned char _U13,
           ...
           unsigned char _U0)
      : I8vec16(_U15, _U14, _U13, _U12, _U11, _U10, _U9, _U8, _U7, _U6, _U5,
                _U4, _U3, _U2, _U1, _U0) {}
  ...
  Iu8vec16 &operator&=(const M128 &_A) {
    return *this = (Iu8vec16)_mm_and_si128(vec, _A);
  }
  Iu8vec16 &operator|=(const M128 &_A) {
    return *this = (Iu8vec16)_mm_or_si128(vec, _A);
  }
  Iu8vec16 &operator^=(const M128 &_A) {
    return *this = (Iu8vec16)_mm_xor_si128(vec, _A);
  }

  /* Addition & Subtraction Assignment Operators */
  Iu8vec16 &operator+=(const I8vec16 &_A) {
    return *this = (Iu8vec16)_mm_add_epi8(vec, _A);
  }
  Iu8vec16 &operator-=(const I8vec16 &_A) {
    return *this = (Iu8vec16)_mm_sub_epi8(vec, _A);
  }
...
inline Iu8vec16 cmpeq(const Iu8vec16 &_A, const Iu8vec16 &_B) {
  return _mm_cmpeq_epi8(_A, _B);
}
inline Iu8vec16 cmpneq(const Iu8vec16 &_A, const Iu8vec16 &_B) {
  return _mm_andnot_si128(_mm_cmpeq_epi8(_A, _B), get_mask128());
}

inline Iu8vec16 unpack_low(const Iu8vec16 &_A, const Iu8vec16 &_B) {
  return _mm_unpacklo_epi8(_A, _B);
}
inline Iu8vec16 unpack_high(const Iu8vec16 &_A, const Iu8vec16 &_B) {
  return _mm_unpackhi_epi8(_A, _B);
}

inline Iu8vec16 sat_add(const Iu8vec16 &_A, const Iu8vec16 &_B) {
  return _mm_adds_epu8(_A, _B);
}
inline Iu8vec16 sat_sub(const Iu8vec16 &_A, const Iu8vec16 &_B) {
  return _mm_subs_epu8(_A, _B);
}

inline I64vec2 sum_abs(const Iu8vec16 &_A, const Iu8vec16 &_B) {
  return _mm_sad_epu8(_A, _B);
}

inline Iu8vec16 simd_avg(const Iu8vec16 &_A, const Iu8vec16 &_B) {
  return _mm_avg_epu8(_A, _B);
}
inline Iu8vec16 simd_max(const Iu8vec16 &_A, const Iu8vec16 &_B) {
  return _mm_max_epu8(_A, _B);
}
inline Iu8vec16 simd_min(const Iu8vec16 &_A, const Iu8vec16 &_B) {
  return _mm_min_epu8(_A, _B);
}

/* Pack & Saturates */

inline Is16vec8 pack_sat(const Is32vec4 &_A, const Is32vec4 &_B) {
  return _mm_packs_epi32(_A, _B);
}
inline Is8vec16 pack_sat(const Is16vec8 &_A, const Is16vec8 &_B) {
  return _mm_packs_epi16(_A, _B);
}
inline Iu8vec16 packu_sat(const Is16vec8 &_A, const Is16vec8 &_B) {
  return _mm_packus_epi16(_A, _B);
}

/********************************* Logicals
 * ****************************************/
#define IVEC128_LOGICALS(vect, element)                                        \
  inline I##vect##vec##element operator&(const I##vect##vec##element &_A,      \
                                         const I##vect##vec##element &_B) {    \
    return _mm_and_si128(_A, _B);                                              \
  }                                                                            \
  inline I##vect##vec##element operator|(const I##vect##vec##element &_A,      \
                                         const I##vect##vec##element &_B) {    \
  ...
  inline I##vect##vec##element andnot(const I##vect##vec##element &_A,         \
                                      const I##vect##vec##element &_B) {       \
    return _mm_andnot_si128(_A, _B);                                           \
  }
...
#define IVEC128_SELECT(vect12, vect34, element, selop)                         \
  inline I##vect34##vec##element select_##selop(                               \
      const I##vect12##vec##element &_A, const I##vect12##vec##element &_B,    \
      const I##vect34##vec##element &_C, const I##vect34##vec##element &_D) {  \
...
public:
  ...
  friend F64vec2 operator&(const F64vec2 &_A, const F64vec2 &_B) {
    return _mm_and_pd(_A, _B);
  }
  friend F64vec2 operator|(const F64vec2 &_A, const F64vec2 &_B) {
    return _mm_or_pd(_A, _B);
  }
  friend F64vec2 operator^(const F64vec2 &_A, const F64vec2 &_B) {
    return _mm_xor_pd(_A, _B);
  }
...
#define F64vec2_COMP(op)                                                       \
  friend F64vec2 cmp##op(const F64vec2 &_A, const F64vec2 &_B) {               \
    return _mm_cmp##op##_pd(_A, _B);                                           \
  }
...
#undef F64vec2_COMP
      ...
      /* Min and Max */
      friend F64vec2 simd_min(const F64vec2 &_A, const F64vec2 &_B) {
    return _mm_min_pd(_A, _B);
  }
  friend F64vec2 simd_max(const F64vec2 &_A, const F64vec2 &_B) {
    return _mm_max_pd(_A, _B);
  }
...
#define F64vec2_COMI(op)                                                       \
  friend int comi##op(const F64vec2 &_A, const F64vec2 &_B) {                  \
    return _mm_comi##op##_sd(_A, _B);                                          \
  }
...
#define F64vec2_UCOMI(op)                                                      \
  friend int ucomi##op(const F64vec2 &_A, const F64vec2 &_B) {                 \
...
#undef F64vec2_UCOMI
  ...
  const double &operator[](int _I) const {
    ...
    _VEC_ASSERT((0 <= _I) &&
                (_I <= 1)); /* User should only access elements 0-1 */
 ...
 */
inline int move_mask(const F64vec2 &_A) { return _mm_movemask_pd(_A); }

/* Data Motion Functions */

/* Load Unaligned loadu_pd: Unaligned */
inline void loadu(F64vec2 &_A, double *_P) { _A = _mm_loadu_pd(_P); }

/* Store Temporal storeu_pd: Unaligned */
inline void storeu(double *_P, const F64vec2 &_A) { _mm_storeu_pd(_P, _A); }

/* Cacheability Support */

/* Non-Temporal Store */
inline void store_nta(double *_P, F64vec2 &_A) { _mm_stream_pd(_P, _A); }

#define F64vec2_SELECT(op)                                                     \
  inline F64vec2 select_##op(const F64vec2 &_A, const F64vec2 &_B,             \
                             const F64vec2 &_C, const F64vec2 &_D) {           \
...
#undef F64vec2_SELECT
    ...
    /* Convert the lower DP FP value of a to a 32 bit signed integer using
       Truncate*/
...
inline F64vec2 F32vec4ToF64vec2(const F32vec4 &_A) { return _mm_cvtps_pd(_A); }

/* Convert the 2 DP FP values of a to SP FP values */
inline F32vec4 F64vec2ToF32vec4(const F64vec2 &_A) { return _mm_cvtpd_ps(_A); }

/* Convert the signed int in b to a DP FP value.  Upper DP FP value in a passed
 * through */
 ...
 * class F32vec8
 *
 * Represents 256-bit vector composed of 8 single precision floating point
 * elements.
 */
class F32vec8 {
protected:
...
public:
  ...
  F32vec8(float _F7, float _F6, float _F5, float _F4, float _F3, float _F2,
          float _F1, float _F0) {
  ...
  F32vec8 &operator+=(const F32vec8 &_A) {
    return *this = _mm256_add_ps(vec, _A);
  }
  F32vec8 &operator-=(const F32vec8 &_A) {
    return *this = _mm256_sub_ps(vec, _A);
  }
  F32vec8 &operator*=(const F32vec8 &_A) {
    return *this = _mm256_mul_ps(vec, _A);
  }
  F32vec8 &operator/=(const F32vec8 &_A) {
    return *this = _mm256_div_ps(vec, _A);
  }
  F32vec8 &operator&=(const F32vec8 &_A) {
    return *this = _mm256_and_ps(vec, _A);
  }
  F32vec8 &operator|=(const F32vec8 &_A) {
    return *this = _mm256_or_ps(vec, _A);
  }
  F32vec8 &operator^=(const F32vec8 &_A) {
    return *this = _mm256_xor_ps(vec, _A);
  }
  ...
  friend float add_horizontal(const F32vec8 &_A) {
    ...
    return _mm_cvtss_f32(_mm_add_ss(_mm256_castps256_ps128(_Temp),
                                    _mm256_extractf128_ps(_Temp, 1)));
  }

  /* And Not */
  friend F32vec8 andnot(const F32vec8 &_A, const F32vec8 &_B) {
    return _mm256_andnot_ps(_A, _B);
  }
  ...
  friend F32vec8 rcp_nr(const F32vec8 &_A) {
    ...
    return _mm256_sub_ps(_mm256_add_ps(_Ra0, _Ra0),
                         _mm256_mul_ps(_mm256_mul_ps(_Ra0, _A), _Ra0));
  }
...
#if defined(_ENABLE_VEC_DEBUG)
  /* Output */
  friend DVEC_STD ostream &operator<<(DVEC_STD ostream &_Os,
                                      const F32vec8 &_A) {
 ...
 */
inline int move_mask(const F32vec8 &_A) { return _mm256_movemask_ps(_A); }

/* Data Motion Functions */

/* Load Unaligned loadu_ps: Unaligned */
inline void loadu(F32vec8 &_A, const float *_P) { _A = _mm256_loadu_ps(_P); }

/* Store Unaligned storeu_ps: Unaligned */
inline void storeu(float *_P, const F32vec8 &_A) { _mm256_storeu_ps(_P, _A); }
...
inline F32vec8 select_eq(const F32vec8 &_A, const F32vec8 &_B,
                         const F32vec8 &_C, const F32vec8 &_D) {
  return _mm256_blendv_ps(_D, _C, _mm256_cmp_ps(_A, _B, _CMP_EQ_OQ));
}

inline F32vec8 select_lt(const F32vec8 &_A, const F32vec8 &_B,
                         const F32vec8 &_C, const F32vec8 &_D) {
  return _mm256_blendv_ps(_D, _C, _mm256_cmp_ps(_A, _B, _CMP_LT_OS));
}

inline F32vec8 select_le(const F32vec8 &_A, const F32vec8 &_B,
                         const F32vec8 &_C, const F32vec8 &_D) {
  return _mm256_blendv_ps(_D, _C, _mm256_cmp_ps(_A, _B, _CMP_LE_OS));
}

inline F32vec8 select_gt(const F32vec8 &_A, const F32vec8 &_B,
                         const F32vec8 &_C, const F32vec8 &_D) {
  return _mm256_blendv_ps(_D, _C, _mm256_cmp_ps(_A, _B, _CMP_GT_OS));
}

inline F32vec8 select_ge(const F32vec8 &_A, const F32vec8 &_B,
                         const F32vec8 &_C, const F32vec8 &_D) {
  return _mm256_blendv_ps(_D, _C, _mm256_cmp_ps(_A, _B, _CMP_GE_OS));
}

inline F32vec8 select_neq(const F32vec8 &_A, const F32vec8 &_B,
                          const F32vec8 &_C, const F32vec8 &_D) {
  return _mm256_blendv_ps(_D, _C, _mm256_cmp_ps(_A, _B, _CMP_NEQ_UQ));
}

inline F32vec8 select_nlt(const F32vec8 &_A, const F32vec8 &_B,
                          const F32vec8 &_C, const F32vec8 &_D) {
  return _mm256_blendv_ps(_D, _C, _mm256_cmp_ps(_A, _B, _CMP_NLT_US));
}

inline F32vec8 select_nle(const F32vec8 &_A, const F32vec8 &_B,
                          const F32vec8 &_C, const F32vec8 &_D) {
  return _mm256_blendv_ps(_D, _C, _mm256_cmp_ps(_A, _B, _CMP_NLE_US));
}

inline F32vec8 select_ngt(const F32vec8 &_A, const F32vec8 &_B,
                          const F32vec8 &_C, const F32vec8 &_D) {
  return _mm256_blendv_ps(_D, _C, _mm256_cmp_ps(_A, _B, _CMP_NGT_US));
}

inline F32vec8 select_nge(const F32vec8 &_A, const F32vec8 &_B,
                          const F32vec8 &_C, const F32vec8 &_D) {
 ...
 * class F64vec4
 *
 * Represents 256-bit vector composed of 4 double precision floating point
 * elements.
 */
class F64vec4 {
protected:
...
public:
  ...
  friend F64vec4 operator&(const F64vec4 &_A, const F64vec4 &_B) {
    return _mm256_and_pd(_A, _B);
  }
  friend F64vec4 operator|(const F64vec4 &_A, const F64vec4 &_B) {
    return _mm256_or_pd(_A, _B);
  }
  friend F64vec4 operator^(const F64vec4 &_A, const F64vec4 &_B) {
    return _mm256_xor_pd(_A, _B);
  }
  ...
  friend F64vec4 operator/(const F64vec4 &_A, const F64vec4 &_B) {
    return _mm256_div_pd(_A, _B);
  }

  F64vec4 &operator+=(const F64vec4 &_A) {
    return *this = _mm256_add_pd(vec, _A);
  }
  F64vec4 &operator-=(const F64vec4 &_A) {
    return *this = _mm256_sub_pd(vec, _A);
  }
  F64vec4 &operator*=(const F64vec4 &_A) {
    return *this = _mm256_mul_pd(vec, _A);
  }
  F64vec4 &operator/=(const F64vec4 &_A) {
    return *this = _mm256_div_pd(vec, _A);
  }
  F64vec4 &operator&=(const F64vec4 &_A) {
    return *this = _mm256_and_pd(vec, _A);
  }
  F64vec4 &operator|=(const F64vec4 &_A) {
    return *this = _mm256_or_pd(vec, _A);
  }
  F64vec4 &operator^=(const F64vec4 &_A) {
    return *this = _mm256_xor_pd(vec, _A);
  }

  /* Horizontal Add */
  friend double add_horizontal(const F64vec4 &_A) {
    F64vec4 _Temp = _mm256_add_pd(_A, _mm256_permute_pd(_A, 0x05));
    return _mm_cvtsd_f64(_mm_add_sd(_mm256_castpd256_pd128(_Temp),
                                    _mm256_extractf128_pd(_Temp, 1)));
  }

  /* And Not */
  friend F64vec4 andnot(const F64vec4 &_A, const F64vec4 &_B) {
    return _mm256_andnot_pd(_A, _B);
  }
...
/* Move Mask to Integer returns 4 bit mask formed of most significant bits of a
 */
inline int move_mask(const F64vec4 &_A) { return _mm256_movemask_pd(_A); }

/* Data Motion Functions */

/* Load Unaligned loadu_pd: Unaligned */
inline void loadu(F64vec4 &_A, double *_P) { _A = _mm256_loadu_pd(_P); }

/* Store Unaligned storeu_pd: Unaligned */
inline void storeu(double *_P, const F64vec4 &_A) { _mm256_storeu_pd(_P, _A); }
...
inline F64vec4 select_eq(const F64vec4 &_A, const F64vec4 &_B,
                         const F64vec4 &_C, const F64vec4 &_D) {
  return _mm256_blendv_pd(_D, _C, _mm256_cmp_pd(_A, _B, _CMP_EQ_OQ));
}

inline F64vec4 select_lt(const F64vec4 &_A, const F64vec4 &_B,
                         const F64vec4 &_C, const F64vec4 &_D) {
  return _mm256_blendv_pd(_D, _C, _mm256_cmp_pd(_A, _B, _CMP_LT_OS));
}

inline F64vec4 select_le(const F64vec4 &_A, const F64vec4 &_B,
                         const F64vec4 &_C, const F64vec4 &_D) {
  return _mm256_blendv_pd(_D, _C, _mm256_cmp_pd(_A, _B, _CMP_LE_OS));
}

inline F64vec4 select_gt(const F64vec4 &_A, const F64vec4 &_B,
                         const F64vec4 &_C, const F64vec4 &_D) {
  return _mm256_blendv_pd(_D, _C, _mm256_cmp_pd(_A, _B, _CMP_GT_OS));
}

inline F64vec4 select_ge(const F64vec4 &_A, const F64vec4 &_B,
                         const F64vec4 &_C, const F64vec4 &_D) {
  return _mm256_blendv_pd(_D, _C, _mm256_cmp_pd(_A, _B, _CMP_GE_OS));
}

inline F64vec4 select_neq(const F64vec4 &_A, const F64vec4 &_B,
                          const F64vec4 &_C, const F64vec4 &_D) {
  return _mm256_blendv_pd(_D, _C, _mm256_cmp_pd(_A, _B, _CMP_NEQ_UQ));
}

inline F64vec4 select_nlt(const F64vec4 &_A, const F64vec4 &_B,
                          const F64vec4 &_C, const F64vec4 &_D) {
  return _mm256_blendv_pd(_D, _C, _mm256_cmp_pd(_A, _B, _CMP_NLT_US));
}

inline F64vec4 select_nle(const F64vec4 &_A, const F64vec4 &_B,
                          const F64vec4 &_C, const F64vec4 &_D) {
  return _mm256_blendv_pd(_D, _C, _mm256_cmp_pd(_A, _B, _CMP_NLE_US));
}

inline F64vec4 select_ngt(const F64vec4 &_A, const F64vec4 &_B,
                          const F64vec4 &_C, const F64vec4 &_D) {
  return _mm256_blendv_pd(_D, _C, _mm256_cmp_pd(_A, _B, _CMP_NGT_US));
}

inline F64vec4 select_nge(const F64vec4 &_A, const F64vec4 &_B,
                          const F64vec4 &_C, const F64vec4 &_D) {
