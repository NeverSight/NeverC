...
#if _RTTI_RELATIVE_TYPEINFO
  int pClassDescriptor; // Image relative offset of
                        // _RTTIClassHierarchyDescriptor
#else
...
#define BCD_PCHD_IB(bcd, ib)                                                   \
  ((_RTTIClassHierarchyDescriptor *)((ib) + (bcd).pClassDescriptor))
...
#if _RTTI_RELATIVE_TYPEINFO
  int arrayOfBaseClassDescriptors[]; // Image relative offset of
                                     // _RTTIBaseClassDescriptor
#else
...
#if _RTTI_RELATIVE_TYPEINFO
#define CHD_PBCA_IB(chd, ib)                                                   \
  ((_RTTIBaseClassArray *)((ib) + (chd).pBaseClassArray))
...
#define COL_PCHD_IB(col, ib)                                                   \
  ((_RTTIClassHierarchyDescriptor *)((ib) + (col).pClassDescriptor))
#endif // _RTTI_RELATIVE_TYPEINFO
...
extern "C" void *
#ifdef prepifdef
    prepifdef _M_CEE_PURE __clrcall prepelse __cdecl prependif // _M_CEE_PURE
#else
    __CLRCALL_OR_CDECL
#endif
    __RTDynamicCast(void *,               // ptr to vfptr
