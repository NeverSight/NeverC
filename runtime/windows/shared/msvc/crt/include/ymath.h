...
_CRTIMP2_PURE short __CLRCALL_PURE_OR_CDECL _Exp(double *, double,
                                                 short) noexcept;
...
_CRTIMP2_PURE short __CLRCALL_PURE_OR_CDECL _FExp(float *, float,
                                                  short) noexcept;
...
_CRTIMP2_PURE long double __CLRCALL_PURE_OR_CDECL _LSinh(long double,
                                                         long double) noexcept;
_CRTIMP2_PURE short __CLRCALL_PURE_OR_CDECL _LExp(long double *, long double,
                                                  short) noexcept;
