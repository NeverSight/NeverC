...
extern __m128 _mm_insert_ps(__m128 /* dst */, __m128 /* src */,
                            const int /* index */);
...
#define _MM_PICK_OUT_PS(src, num)                                              \
  _mm_insert_ps(_mm_setzero_ps(), (src), _MM_MK_INSERTPS_NDX((num), 0, 0x0e))

// Insert integer into packed integer array element
// selected by index

extern __m128i _mm_insert_epi8(__m128i /* dst */, int /* src */,
                               const int /* index */);
extern __m128i _mm_insert_epi32(__m128i /* dst */, int /* src */,
                                const int /* index */);

#if defined(_M_X64)
extern __m128i _mm_insert_epi64(__m128i /* dst */, __int64 /* src */,
                                const int /* index */);
...
extern __m128d _mm_round_sd(__m128d /* dst */, __m128d /* val */,
                            int /* iRoundMode */);

// Packed/single float single precision rounding

extern __m128 _mm_round_ps(__m128 /* val */, int /* iRoundMode */);
extern __m128 _mm_round_ss(__m128 /* dst */, __m128 /* val */,
                           int /* iRoundMode */);
...
extern __m128i _mm_mpsadbw_epu8(__m128i /* s1 */, __m128i /* s2 */,
                                const int /* mask */);
