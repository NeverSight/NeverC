...
// xkeycheck.h assumes that it's being included by yvals_core.h in a specific
// order. Nothing else should include xkeycheck.h.
...
// not checking "unlikely" because it is commonly defined as a function-like
// macro
