...
#pragma warning(disable : 4643) // Forward declaring 'meow' in namespace std is
...
_VCRTIMP void __cdecl
__std_exception_copy(_In_ __std_exception_data const *_From,
                     _Inout_ __std_exception_data *_To);

_VCRTIMP void __cdecl
__std_exception_destroy(_Inout_ __std_exception_data *_Data);
...
_VCRT_EXPORT_STD class _NODISCARD bad_exception : public exception {
public:
...
_VCRT_EXPORT_STD class _NODISCARD bad_alloc : public exception {
public:
...
_VCRT_EXPORT_STD class _NODISCARD bad_array_new_length : public bad_alloc {
public:
