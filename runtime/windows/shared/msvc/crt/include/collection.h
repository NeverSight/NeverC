...
#pragma warning(                                                               \
    disable : 4451) // Usage of ref class 'Meow' inside this context can lead to
...
inline void ValidateCounter(const ::std::shared_ptr<unsigned int> &ctr,
...
template <typename T> struct AlwaysFalse : public ::std::false_type {};
...
template <typename T> inline const T &MakeWrap(const T &t) { return t; }

template <typename T>
inline typename ::std::enable_if<!__is_winrt_agile(T), Agile<T ^>>::type
MakeWrap(T ^ const &t) {
  return Agile<T ^>(t);
}

template <typename T> inline const T &Unwrap(const T &t) { return t; }

template <typename T> inline T ^ Unwrap(const Agile<T ^> &a) { return a.Get(); }

template <typename T, typename U>
struct VectorEnableIf
    : public ::std::enable_if<
          ::std::is_same<T, U>::value ||
              ::std::is_same<typename Wrap<T>::type, U>::value,
          void **> {};

template <typename X>
inline void Init(::std::shared_ptr<unsigned int> &ctr,
                 ::std::shared_ptr<X> &sp) {
  try {
  ...
  inline void Init(::std::shared_ptr<unsigned int> & ctr,
    ...
    inline void Init(::std::shared_ptr<unsigned int> & ctr,
      ...
      inline void Init(::std::shared_ptr<unsigned int> & ctr,
                       ::std::shared_ptr<X> & sp, A && a, B && b, C && c) {
        try {
          ctr = ::std::make_shared<unsigned int>(0);
          sp = ::std::make_shared<X>(::std::forward<A>(a), ::std::forward<B>(b),
                                     ::std::forward<C>(c));
        ...
        template <typename X, typename A>
        inline void InitMoveVector(::std::shared_ptr<unsigned int> & ctr,
                                   ::std::shared_ptr<X> & sp, A && a) {
        ...
        template <typename X>
        inline void InitMoveVector(::std::shared_ptr<unsigned int> & ctr,
                                   ::std::shared_ptr<X> & sp, X && x) {
          Init(ctr, sp, ::std::move(x));
        }

        template <typename K, typename V, typename M, typename InIt>
        inline void EmplaceWrappedRange(M & m, InIt first, InIt last) {
        ...
        template <typename K, typename V, typename X, typename A>
        inline void InitMoveMap(::std::shared_ptr<unsigned int> & ctr,
                                ::std::shared_ptr<X> & sp, A && a) {
        ...
        ref class VectorChangedEventArgs sealed
            : public _COLLECTION_ATTRIBUTES WFC::IVectorChangedEventArgs {
          internal : VectorChangedEventArgs(WFC::CollectionChange change,
                                            unsigned int index)
              : m_change(change), m_index(index) {}

        public:
          virtual property WFC::CollectionChange CollectionChange {
            virtual WFC::CollectionChange get() { return m_change; }
          }
        ...
        template <typename K>
        ref class MapChangedEventArgsReset sealed
        ...
        public:
          ...
          virtual property K Key {
            virtual K get() { throw ref new FailureException; }
          }
        };

        template <typename K>
        ref class MapChangedEventArgs sealed
            : public _COLLECTION_ATTRIBUTES WFC::IMapChangedEventArgs<K> {
          internal : MapChangedEventArgs(WFC::CollectionChange change, K key)
        ...
        public:
          ...
          virtual property K Key {
            virtual K get() { return Unwrap(m_key); }
          }
        ...
        inline bool VectorIndexOf(
            const ::std::vector<typename Wrap<T>::type> &v, T value,
            unsigned int *index) {
          auto pred = [&](const typename Wrap<T>::type &elem) {
        ...
        inline bool VectorBindableIndexOf(
            ::std::false_type, const ::std::vector<typename Wrap<T>::type> &v,
            Object ^ o, unsigned int *index) {
        ...
        template <typename T, typename E>
        inline bool VectorBindableIndexOf(
            ::std::true_type, const ::std::vector<typename Wrap<T>::type> &v,
            Object ^ o, unsigned int *index) {
        ...
        template <typename T, typename E>
        inline bool VectorBindableIndexOf(
            const ::std::vector<typename Wrap<T>::type> &v, Object ^ o,
            unsigned int *index) {
        ...
        template <typename T>
        inline unsigned int VectorGetMany(
            const ::std::vector<typename Wrap<T>::type> &v,
        ...
        template <typename T>
        ref class IteratorForVectorView sealed
        ...
        private:
          ...
          internal : IteratorForVectorView(
                         const ::std::shared_ptr<unsigned int> &ctr,
                         const ::std::shared_ptr<WrappedVector> &vec)
      ...
      template <typename T, typename E> ref class VectorView<T, E, false> {
        static_assert(Details::AlwaysFalse<T>::value,
                      "Platform::Collections::VectorView<T, E> requires T to "
                      "be a valid Windows Runtime type.");
      };
      ...
      private:
        ...
        explicit VectorView(
            ...
            typename Details::VectorEnableIf<T, U>::type = nullptr) {
      ...
      public:
        ...
        virtual unsigned int GetMany(unsigned int startIndex,
                                     WriteOnlyArray<T> ^ dest) {
          Details::ValidateCounter(m_ctr, m_good_ctr);
      ...
      private:
        ...
        VectorView(const ::std::shared_ptr<unsigned int> &ctr,
                   const ::std::shared_ptr<WrappedVector> &vec)
            : m_ctr(ctr), m_vec(vec), m_good_ctr(*ctr) {}

#if _COLLECTION_WUXI
        virtual Details::WUXI::IBindableIterator ^
            BindableFirst() = WUXI_Base::First {
        ...
        virtual bool BindableIndexOf(Object ^ value,
      ...
      template <typename T, typename E> ref class Vector<T, E, false> {
        static_assert(Details::AlwaysFalse<T>::value,
                      "Platform::Collections::Vector<T, E> requires T to be a "
                      "valid Windows Runtime type.");
      };
      ...
      public:
        ...
        virtual void SetAt(unsigned int index, T item) = WFC_Base::SetAt {
          ...
          virtual void InsertAt(unsigned int index,
                                T item) = WFC_Base::InsertAt {
            try {
              Details::IncrementCounter(m_ctr);
            ...
            virtual void Append(T item) = WFC_Base::Append {
              ...
              virtual void RemoveAt(unsigned int index) {
                ...
                virtual void RemoveAtEnd() {
                  ...
                  virtual void Clear() {
                    ...
                    virtual void ReplaceAll(const Array<T> ^ arr) {
                      ...
                      virtual event WFC_Handler ^
                          VectorChanged{
                              virtual Details::Token add(WFC_Handler ^ e) =
                                  WFC_Base::VectorChanged::add{m_observed =
                                                                   true;
                      return m_wfc_event += e;
                    }

                    virtual void remove(
                        Details::Token t) = WFC_Base::VectorChanged::remove {
                      m_wfc_event -= t;
                    }
                  };
                ...
                private:
                  ...
                  void Notify(Details::WFC::CollectionChange change,
                              unsigned int index) {
                    if (m_observed) {
                      auto args = ref new Details::VectorChangedEventArgs(
                          change, index);
                  ...
                  virtual Details::WUXI::IBindableIterator ^
                      BindableFirst() = WUXI_Base::First {
                    return safe_cast<Details::WUXI::IBindableIterator ^>(
                        First());
                  }

                  virtual Object ^
                      BindableGetAt(unsigned int index) = WUXI_Base::GetAt {
                    return GetAt(index);
                  }

                  virtual bool BindableIndexOf(
                      Object ^ value,
                      unsigned int *index) = WUXI_Base::IndexOf {
                    *index = 0;

                    return Details::VectorBindableIndexOf<T, E>(*m_vec, value,
                                                                index);
                  }

                  virtual Details::WUXI::IBindableVectorView ^
                      BindableGetView() = WUXI_Base::GetView {
                    return safe_cast<Details::WUXI::IBindableVectorView ^>(
                        GetView());
                  }

                  virtual void BindableSetAt(unsigned int index,
                                             Object ^ item) = WUXI_Base::SetAt {
                    SetAt(index, safe_cast<T>(item));
                  }

                  virtual void BindableInsertAt(
                      unsigned int index, Object ^ item) = WUXI_Base::InsertAt {
                    InsertAt(index, safe_cast<T>(item));
                  }

                  virtual void BindableAppend(Object ^
                                              item) = WUXI_Base::Append {
                    Append(safe_cast<T>(item));
                  }

                  virtual Details::Token BindableEventAdd(
                      WUXI_Handler ^ e) = WUXI_Base::VectorChanged::add {
                    m_observed = true;
                    return m_wuxi_event += e;
                  }

                  virtual void BindableEventRemove(
                      Details::Token t) = WUXI_Base::VectorChanged::remove {
                    m_wuxi_event -= t;
                  }
#endif // _COLLECTION_WUXI
                ...
                ref class KeyValuePair sealed
                    : public _COLLECTION_ATTRIBUTES WFC::IKeyValuePair<K, V> {
                  internal : KeyValuePair(const typename Wrap<K>::type &key,
                ...
                public:
                  ...
                  virtual property V Value {
                    virtual V get() { return Unwrap(m_value); }
                  }
                ...
                template <typename K, typename F,
                          bool =
                              ::std::is_same<typename Wrap<K>::type, K>::value>
                class WrapFunc {
                public:
                  typedef F type;
                };
                ...
                public:
                  ...
                  WrapFunc(const F &func) : m_func(func) {}
                ...
                template <typename K, typename V, typename C> struct WrapMap {
                  typedef ::std::map<typename Wrap<K>::type,
                                     typename Wrap<V>::type,
                                     typename WrapFunc<K, C>::type>
                      type;
                };

                template <typename K, typename V, typename H, typename P>
                struct WrapUnorderedMap {
                  typedef ::std::unordered_map<typename Wrap<K>::type,
                                               typename Wrap<V>::type,
                                               typename WrapFunc<K, H>::type,
                                               typename WrapFunc<K, P>::type>
                      type;
                };

                template <typename K, typename V, typename WrappedMap>
                ref class IteratorForAnyMapView sealed
                    : public _COLLECTION_ATTRIBUTES
                          WFC::IIterator<WFC::IKeyValuePair<K, V> ^> {

                  internal : IteratorForAnyMapView(
                                 const ::std::shared_ptr<unsigned int> &ctr,
                                 const ::std::shared_ptr<WrappedMap> &m)
                      : m_ctr(ctr),
                        m_map(m),
                        m_good_ctr(*ctr),
                        m_iter(m->begin()) {}
                ...
                public:
                  virtual property WFC::IKeyValuePair<K, V> ^
                      Current {
                        virtual WFC::IKeyValuePair<K, V> ^ get() {
                          ...
                          return ref new KeyValuePair<K, V>(m_iter->first,
                                                            m_iter->second);
                        }
                      }
                  ...
                  GetMany(WriteOnlyArray<WFC::IKeyValuePair<K, V> ^> ^ dest) {
                    ValidateCounter(m_ctr, m_good_ctr);
                    ...
                    while (capacity > 0 && m_iter != m_map->end()) {
                      dest->set(actual, ref new KeyValuePair<K, V>(
                ...
                template <typename K, typename V, typename C = ::std::less<K>,
                          bool = __is_valid_winrt_type(K),
                          bool = __is_valid_winrt_type(V)>
                ref class Map;
                template <typename K, typename V, typename C = ::std::less<K>,
                          bool = __is_valid_winrt_type(K),
                          bool = __is_valid_winrt_type(V)>
                ...
                ref class MapView<K, V, C, false, false> {
                  static_assert(
                      Details::AlwaysFalse<K>::value,
                      "Platform::Collections::MapView<K, V, C> requires K and "
                      "V to be valid Windows Runtime types.");
                };
                ...
                ref class MapView<K, V, C, false, true> {
                  static_assert(
                      Details::AlwaysFalse<K>::value,
                      "Platform::Collections::MapView<K, V, C> requires K to "
                      "be a valid Windows Runtime type.");
                };
                ...
                ref class MapView<K, V, C, true, false> {
                  static_assert(
                      Details::AlwaysFalse<K>::value,
                      "Platform::Collections::MapView<K, V, C> requires V to "
                      "be a valid Windows Runtime type.");
                };

                template <typename K, typename V, typename C, bool, bool>
                ref class MapView sealed : public _COLLECTION_ATTRIBUTES
                                               Details::WFC::IMapView<K, V> {
                private:
                  typedef typename Details::WrapMap<K, V, C>::type WrappedMap;
                  typedef Details::IteratorForAnyMapView<K, V, WrappedMap>
                      MyIterator;
                  friend ref class Map<K, V, C>;

                  internal : explicit MapView(const C &comp = C()) {
                  ...
                  explicit MapView(const ::std::map<K, V, C> &m) {
                    ...
                    Details::EmplaceWrappedRange<K, V>(*m_map, m.begin(),
                                                       m.end());
                  ...
                  MapView(InIt first, InIt last, const C &comp = C()) {
                    Details::Init(m_ctr, m_map, comp);
                  ...
                  MapView(::std::initializer_list<::std::pair<const K, V>> il,
                          const C &comp = C()) {
                    Details::Init(m_ctr, m_map, comp);

                    Details::EmplaceWrappedRange<K, V>(*m_map, il.begin(),
                                                       il.end());
                ...
                public:
                  virtual Details::WFC::IIterator<
                      Details::WFC::IKeyValuePair<K, V> ^> ^
                      First() {
                        Details::ValidateCounter(m_ctr, m_good_ctr);
                  ...
                  virtual void
                  Split(Details::WFC::IMapView<K, V> ^ *firstPartition,
                        Details::WFC::IMapView<K, V> ^ *secondPartition) {
                ...
                private:
                  MapView(const ::std::shared_ptr<unsigned int> &ctr,
                          const ::std::shared_ptr<WrappedMap> &m)
                ...
                ref class UnorderedMapView<K, V, H, P, false, false> {
                  static_assert(
                      Details::AlwaysFalse<K>::value,
                      "Platform::Collections::UnorderedMapView<K, V, H, P> "
                      "requires K and V to be valid Windows Runtime types.");
                };
                ...
                ref class UnorderedMapView<K, V, H, P, false, true> {
                  static_assert(
                      Details::AlwaysFalse<K>::value,
                      "Platform::Collections::UnorderedMapView<K, V, H, P> "
                      "requires K to be a valid Windows Runtime type.");
                };
                ...
                ref class UnorderedMapView<K, V, H, P, true, false> {
                  static_assert(
                      Details::AlwaysFalse<K>::value,
                      "Platform::Collections::UnorderedMapView<K, V, H, P> "
                      "requires V to be a valid Windows Runtime type.");
                };

                template <typename K, typename V, typename H, typename P, bool,
                          bool>
                ref class UnorderedMapView sealed
                    : public _COLLECTION_ATTRIBUTES
                          Details::WFC::IMapView<K, V> {
                private:
                  typedef typename Details::WrapUnorderedMap<K, V, H, P>::type
                      WrappedMap;
                  typedef Details::IteratorForAnyMapView<K, V, WrappedMap>
                      MyIterator;
                  friend ref class UnorderedMap<K, V, H, P>;

                  internal : UnorderedMapView() {
                  ...
                  explicit UnorderedMapView(
                    ...
                    Details::Init(m_ctr, m_map, m.bucket_count(),
                  ...
                  template <typename InIt>
                  UnorderedMapView(InIt first, InIt last) {
                    Details::Init(m_ctr, m_map);
                  ...
                  template <typename InIt>
                  UnorderedMapView(InIt first, InIt last, size_t n) {
                    Details::Init(m_ctr, m_map, n, H(), P());
                  ...
                  template <typename InIt>
                  UnorderedMapView(InIt first, InIt last, size_t n, const H &h,
                                   const P &p) {
                    Details::Init(m_ctr, m_map, n, h, p);
                ...
                private:
                  UnorderedMapView(const ::std::shared_ptr<unsigned int> &ctr,
                                   const ::std::shared_ptr<WrappedMap> &m)
                      : m_ctr(ctr), m_map(m), m_good_ctr(*ctr) {}
                ...
                ref class Map<K, V, C, false, false> {
                  static_assert(Details::AlwaysFalse<K>::value,
                                "Platform::Collections::Map<K, V, C> requires "
                                "K and V to be valid Windows Runtime types.");
                };
                ...
                ref class Map<K, V, C, false, true> {
                  static_assert(Details::AlwaysFalse<K>::value,
                                "Platform::Collections::Map<K, V, C> requires "
                                "K to be a valid Windows Runtime type.");
                };
                ...
                ref class Map<K, V, C, true, false> {
                  static_assert(Details::AlwaysFalse<K>::value,
                                "Platform::Collections::Map<K, V, C> requires "
                                "V to be a valid Windows Runtime type.");
                };

                template <typename K, typename V, typename C, bool, bool>
                ref class Map sealed : public _COLLECTION_ATTRIBUTES
                                           Details::WFC::IObservableMap<K, V> {
                private:
                  typedef typename Details::WrapMap<K, V, C>::type WrappedMap;
                  typedef Details::IteratorForAnyMapView<K, V, WrappedMap>
                      MyIterator;
                  typedef MapView<K, V, C> MyView;
                  typedef Details::WFC::MapChangedEventHandler<K, V>
                      WFC_Handler;

                  internal : explicit Map(const C &comp = C()) {
                    Details::Init(m_ctr, m_map, comp);
                  ...
                  template <typename InIt>
                  Map(InIt first, InIt last, const C &comp = C()) {
                    Details::Init(m_ctr, m_map, comp);
                ...
                public:
                  virtual Details::WFC::IIterator<
                      Details::WFC::IKeyValuePair<K, V> ^> ^
                      First() { return ref new MyIterator(m_ctr, m_map); }
                  ...
                  virtual Details::WFC::IMapView<K, V> ^
                      GetView() { return ref new MyView(m_ctr, m_map); }
                    ...
                    try {
                      ...
                      auto p = m_map->emplace(Details::MakeWrap(key),
                                              Details::MakeWrap(value));
                    ...
                    virtual void Remove(K key) {
                      try {
                        ...
                        Details::ValidateBounds(
                            m_map->erase(Details::MakeWrap(key)) == 1);
                      ...
                      virtual void Clear() {
                        ...
                        virtual event WFC_Handler ^
                            MapChanged{virtual Details::Token add(
                                WFC_Handler ^ e){m_observed = true;
                        return m_wfc_event += e;
                      }
                  ...
                  private:
                    void NotifyReset() {
                      if (m_observed) {
                        m_wfc_event(
                            this, ref new Details::MapChangedEventArgsReset<K>);
                      }
                    }
                    ...
                    void NotifyInserted(K key) {
                      if (m_observed) {
                        m_wfc_event(
                            this,
                            ref new Details::MapChangedEventArgs<K>(
                                Details::WFC::CollectionChange::ItemInserted,
                                key));
                      }
                    }
                    ...
                    void NotifyRemoved(K key) {
                      if (m_observed) {
                        m_wfc_event(
                            this,
                            ref new Details::MapChangedEventArgs<K>(
                                Details::WFC::CollectionChange::ItemRemoved,
                                key));
                      }
                    }
                    ...
                    void NotifyChanged(K key) {
                      if (m_observed) {
                        m_wfc_event(
                            this,
                            ref new Details::MapChangedEventArgs<K>(
                                Details::WFC::CollectionChange::ItemChanged,
                                key));
                      }
                    }
                  ...
                  ref class UnorderedMap<K, V, H, P, false, false> {
                    static_assert(
                        Details::AlwaysFalse<K>::value,
                        "Platform::Collections::UnorderedMap<K, V, H, P> "
                        "requires K and V to be valid Windows Runtime types.");
                  };
                  ...
                  private:
                    ...
                    template <typename InIt>
                    UnorderedMap(InIt first, InIt last, size_t n) {
                      Details::Init(m_ctr, m_map, n, H(), P());
                    ...
                    template <typename InIt>
                    UnorderedMap(InIt first, InIt last, size_t n, const H &h) {
                      Details::Init(m_ctr, m_map, n, h, P());
                ...
                namespace Platform {
                  ...
                  public:
                    ...
                    operator T() const { return m_v->GetAt(m_i); }

                    T operator->() const { return m_v->GetAt(m_i); }
                  ...
                  template <typename T>
                  inline void swap(const VectorProxy<T> &l,
                                   const VectorProxy<T> &r) {
                    l.swap(r);
                  }

                  template <typename T>
                  inline void swap(const VectorProxy<T> &p, T &t) {
                    p.swap(t);
                  }

                  template <typename T>
                  inline void swap(T &t, const VectorProxy<T> &p) {
                    p.swap(t);
                  }
                  ...
                  template <typename T>
                  inline bool operator==(const VectorProxy<T> &l, const T &t) {
                  ...
                  public:
                    explicit ArrowProxy(T t) : m_val(t) {}
                  ...
                  public:
                    ...
                    VectorIterator() : m_v(nullptr), m_i(0) {}

                    explicit VectorIterator(Details::WFC::IVector<T> ^ v)
                        : m_v(v), m_i(0) {}

                    reference operator*() const { return reference(m_v, m_i); }

                    Details::ArrowProxy<T> operator->() const {
                      return Details::ArrowProxy<T>(
                          m_v->GetAt(static_cast<unsigned int>(m_i)));
                    }
                    ...
                    difference_type
                    operator-(const VectorIterator &other) const {
                  ...
                  operator+(ptrdiff_t n, const VectorIterator<T> &i) {
                    return i + n;
                  }
                  ...
                  public:
                    ...
                    VectorViewIterator() : m_v(nullptr), m_i(0) {}

                    explicit VectorViewIterator(Details::WFC::IVectorView<T> ^
                                                v)
                        : m_v(v), m_i(0) {}
                    ...
                    difference_type
                    operator-(const VectorViewIterator &other) const {
                      return m_i - other.m_i;
                    }
                  ...
                  operator+(ptrdiff_t n, const VectorViewIterator<T> &i) {
                    return i + n;
                  }
                  ...
                  public:
                    ...
                    explicit BackInsertIterator(Details::WFC::IVector<T> ^ v)
                        : m_v(v) {}
                  ...
                  inline ::std::vector<T> ToVector(I ^ v) {
                ...
                namespace Collections {
                template <typename X>
                inline ::Platform::Collections::InputIterator<X>
                begin(IIterable<X> ^ i) {
                ...
                template <typename T>
                inline ::Platform::Collections::VectorIterator<T>
                begin(IVector<T> ^ v) {
                ...
                template <typename T>
                inline ::Platform::Collections::VectorViewIterator<T>
                ...
                template <typename T>
                inline ::Platform::Collections::BackInsertIterator<T>
                ...
                namespace Collections {
                template <typename T, typename E>
                inline BackInsertIterator<T> back_inserter(Vector<T, E> ^ v) {
                ...
                template <> struct ::std::hash<::Platform::String ^> {
                  ...
                  size_t operator()(::Platform::String ^ s) const {
                    return ::std::_Hash_array_representation(s->Data(),
                                                             s->Length());
                  }
                };
