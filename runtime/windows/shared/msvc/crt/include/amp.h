...
///
/// The index&lt;N&gt; type represents an N-dimensional vector of int which
/// specifies a unique position in an N-dimensional space.  The values in the
/// coordinate vector are ordered from most-significant to least-significant.
/// Thus, in 2-dimensional space, the index vector (5,3) represents the position
/// at row 5, column 3.
///
...
///
/// <param name="_Rank">
///    The dimensionality space into which this index applies, can be any
...
public:
  ...
  template <typename _Value_type, int _Rank_other> friend class array;
  ...
  /// </summary>
  index() __GPU {
    details::_compound_assign_op_loop_helper<index<_Rank>,
                                             details::opAssign>::func(*this, 0);
  }
  ...
  ///     array of int component values.  If the coordinate array length is not
  ...
  /// </returns>
  int operator[](unsigned _Index) const __GPU { return _M_base[_Index]; }
  ...
  /// </returns>
  int &operator[](unsigned _Index) __GPU { return _M_base[_Index]; }
...
private:
  ...
  friend _Tuple_type details::_Create_uninitialized_tuple() __GPU;
...
/// <summary>
///   The extent&lt;N&gt; type represents an N-dimensional vector of int which
///   specifies the bounds of an N-dimensional space with an origin of 0.  The
///   values in the coordinate vector are ordered from most-significant to
///   least-significant. Thus, in 2-dimensional space, the extent vector (5,3)
///   represents a space with 5 rows and 3 columns.
///
...
public:
  ...
  /// </summary>
  extent() __GPU {
    details::_compound_assign_op_loop_helper<extent<_Rank>,
                                             details::opAssign>::func(*this, 0);
  }

  /// <summary>
  ///     Copy constructor. Constructs a new extent from the supplied argument
  ///     _Other.
  /// </summary>
  /// <param name="_Other">
  ...
  ///     The corresponding value stored at _Index.
  /// </returns>
  int operator[](unsigned int _Index) const __GPU { return _M_base[_Index]; }
  ...
  /// </returns>
  int &operator[](unsigned int _Index) __GPU { return _M_base[_Index]; }
  ...
  unsigned int size() const __GPU {
    return static_cast<unsigned int>(
        _product_helper<extent<_Rank>>::func(_M_base));
  }

  /// <summary>
  ///     Tests whether the index "_Index" is properly contained within this
  ///     extent.
  /// </summary>
  bool contains(const index<rank> &_Index) const __GPU {
    return details::_contains<extent<rank>, index<rank>, rank>::func(*this,
                                                                     _Index);
  }
  ...
  tiled_extent<_Dim0, _Dim1, _Dim2> tile() const __GPU {
    ...
    static_assert(_Dim0 > 0 && _Dim1 > 0 && _Dim2 > 0,
                  "All tile dimensions must be positive");
  ...
  extent<_Rank> operator+(const index<_Rank> &_Rhs) const __GPU {
    ...
    details::_arithmetic_op_loop_helper<extent<_Rank>, details::opAdd>::func(
        new_extent, *this, _Rhs);
    return new_extent;
  }
  ...
  extent<_Rank> operator-(const index<_Rank> &_Rhs) const __GPU {
    extent<_Rank> new_extent(details::_do_not_initialize);
    details::_arithmetic_op_loop_helper<extent<_Rank>, details::opSub>::func(
        new_extent, *this, _Rhs);
    return new_extent;
  }
...
template <int N> struct _Is_extent_or_index<index<N>> : std::true_type {};

template <int N> struct _Is_extent_or_index<extent<N>> : std::true_type {};
} // namespace details

template <int _Rank, template <int> class _Tuple_type>
typename std::enable_if<details::_Is_extent_or_index<_Tuple_type<_Rank>>::value,
                        bool>::type
operator==(const _Tuple_type<_Rank> &_Lhs,
           const _Tuple_type<_Rank> &_Rhs) __GPU {
  return details::_cmp_op_loop_helper<_Tuple_type<_Rank>, details::opEq>::func(
      _Lhs, _Rhs);
}
...
template <int _Rank, template <int> class _Tuple_type>
typename std::enable_if<details::_Is_extent_or_index<_Tuple_type<_Rank>>::value,
                        _Tuple_type<_Rank>>::type
operator+(const _Tuple_type<_Rank> &_Lhs,
          const _Tuple_type<_Rank> &_Rhs) __GPU {
  _Tuple_type<_Rank> new_Tuple =
      details::_Create_uninitialized_tuple<_Tuple_type<_Rank>>();
  details::_arithmetic_op_loop_helper<_Tuple_type<_Rank>, opAdd>::func(
      new_Tuple, _Lhs, _Rhs);
  return new_Tuple;
}
...
operator-(const _Tuple_type<_Rank> &_Lhs,
  ...
  _Tuple_type<_Rank> new_Tuple =
      details::_Create_uninitialized_tuple<_Tuple_type<_Rank>>();
  details::_arithmetic_op_loop_helper<_Tuple_type<_Rank>, opSub>::func(
      new_Tuple, _Lhs, _Rhs);
  return new_Tuple;
}
...
typename std::enable_if<details::_Is_extent_or_index<_Tuple_type<_Rank>>::value,
                        _Tuple_type<_Rank>>::type
operator+(const _Tuple_type<_Rank> &_Lhs,
          typename _Tuple_type<_Rank>::value_type _Rhs) __GPU {
  _Tuple_type<_Rank> new_Tuple =
      details::_Create_uninitialized_tuple<_Tuple_type<_Rank>>();
  details::_arithmetic_op_loop_helper<_Tuple_type<_Rank>, opAdd>::func(
      new_Tuple, _Lhs, _Rhs);
...
typename std::enable_if<details::_Is_extent_or_index<_Tuple_type<_Rank>>::value,
                        _Tuple_type<_Rank>>::type
operator+(typename _Tuple_type<_Rank>::value_type _Lhs,
          const _Tuple_type<_Rank> &_Rhs) __GPU {
  _Tuple_type<_Rank> new_Tuple =
      details::_Create_uninitialized_tuple<_Tuple_type<_Rank>>();
  details::_arithmetic_op_loop_helper<_Tuple_type<_Rank>, opAdd>::func(
...
operator*(const _Tuple_type<_Rank> &_Lhs,
  ...
  _Tuple_type<_Rank> new_Tuple =
      details::_Create_uninitialized_tuple<_Tuple_type<_Rank>>();
  details::_arithmetic_op_loop_helper<_Tuple_type<_Rank>, opMul>::func(
      new_Tuple, _Lhs, _Rhs);
  return new_Tuple;
}
...
operator/(const _Tuple_type<_Rank> &_Lhs,
  ...
  _Tuple_type<_Rank> new_Tuple =
      details::_Create_uninitialized_tuple<_Tuple_type<_Rank>>();
  details::_arithmetic_op_loop_helper<_Tuple_type<_Rank>, opDiv>::func(
      new_Tuple, _Lhs, _Rhs);
  return new_Tuple;
}
...
operator%(const _Tuple_type<_Rank> &_Lhs,
  ...
  _Tuple_type<_Rank> new_Tuple =
      details::_Create_uninitialized_tuple<_Tuple_type<_Rank>>();
  details::_arithmetic_op_loop_helper<_Tuple_type<_Rank>, opMod>::func(
      new_Tuple, _Lhs, _Rhs);
  return new_Tuple;
}
...
#pragma warning(suppress : 4100) // unreferenced formal parameter
  ...
  /// <summary>
  ///     Blocks execution of all threads in a tile until all threads in the
  ///     tile have reached this call. Ensures that memory accesses are visible
  ///     to other threads in the thread tile, and are executed according to
  ///     program order
  /// </summary>
  ...
  /// <summary>
  ///     Blocks execution of all threads in a tile until all threads in the
  ///     tile have reached this call. Ensures that global memory accesses are
  ///     visible to other threads in the thread tile, and are executed
  ...
  /// <summary>
  ///     Blocks execution of all threads in a tile until all threads in the
  ///     tile have reached this call. Ensures that tile_static memory accesses
  ///     are visible to other threads in the thread tile, and are executed
  ///     according to program order
  /// </summary>
...
/// <summary>
///     A _Tiled_index_base is the base class of all three kinds of tiled_index
...
public:
  ...
  /// <summary>
  ///     An index that represents the relative index within the current tile of
  ///     a tiled_extent.
  /// </summary>
  const index<rank> local;

  /// <summary>
  ///     An index that represents the coordinates of the current tile of a
  ///     tiled_extent.
  /// </summary>
  const index<rank> tile;

  /// <summary>
  ///     An index that represents the global coordinates of the origin of the
  ///     current tile within a tiled_extent.
  /// </summary>
  ...
  /// </param>
  _Tiled_index_base(const index<rank> &_Global, const index<rank> &_Local,
                    const index<rank> &_Tile, const index<rank> &_Tile_origin,
                    const tile_barrier &_Barrier) __GPU
      : global(_Global),
        local(_Local),
        tile(_Tile),
        tile_origin(_Tile_origin),
        barrier(_Barrier) {}
  ...
  /// <summary>
  ///     Implicit conversion operator that converts a tiled_index into an
  ///     index. The implicit conversion converts to the .global index member.
  /// </summary>
  operator const index<rank>() const __GPU { return global; }
...
///     subdivided into 1-, 2-, or 3-dimensional tiles in a tiled_extent.  It
///     has three specialized forms:  tiled_index&lt;_Dim0&gt;,
///     tiled_index&lt;_Dim0, _Dim1&gt;, and tiled_index&lt;_Dim0, _Dim1,
///     _Dim2&gt;, where _Dim0-2 specify the length of the tile along the each
///     dimension, with _Dim0 being the most-significant dimension and _Dim2
...
public:
  ...
  ///     The barrier to be copied from
  /// </param>
  tiled_index(const index<rank> &_Global, const index<rank> &_Local,
              const index<rank> &_Tile, const index<rank> &_Tile_origin,
              const tile_barrier &_Barrier) __GPU
  ...
  ///     The tile_index instance to be copied from .
  /// </param>
  tiled_index(const tiled_index &_Other) __GPU : _Tiled_index_base(_Other) {}

  /// <summary>
  ///     Returns an instance of an extent that captures the values of the
  ///     tiled_index template arguments _Dim0, _Dim1, _Dim2
  /// </summary>
  __declspec(property(get = get_tile_extent)) extent<rank> tile_extent;
  extent<rank> get_tile_extent() const __GPU {
    return extent<rank>(_Dim0, _Dim1, _Dim2);
  }
...
public:
  ...
  /// <summary>
  ///     Returns an instance of an extent that captures the values of the
  ///     tiled_index template arguments _Dim0, _Dim1
  /// </summary>
  __declspec(property(get = get_tile_extent)) extent<rank> tile_extent;
  extent<rank> get_tile_extent() const __GPU {
    return extent<rank>(_Dim0, _Dim1);
  }
...
public:
  ...
  /// <summary>
  ///     Returns an instance of an extent that captures the values of the
  ///     tiled_index template argument _Dim0
  /// </summary>
  __declspec(property(get = get_tile_extent)) extent<rank> tile_extent;
...
/// <summary>
///     A tiled_extent is an extent of 1 to 3 dimensions which also subdivides
///     the extent space into 1-, 2-, or 3-dimensional tiles. It has three
///     specialized forms:  tiled_extent&lt;_Dim0&gt;,
///     tiled_extent&lt;_Dim0,_Dim1&gt;, and
///     tiled_extent&lt;_Dim0,_Dim1,_Dim2&gt;, where _Dim0-2 specify the length
///     of the tile along each dimension, with _Dim0 being the most-significant
///     dimension and _Dim2 being the least-significant.
/// </summary>
template <int _Dim0, int _Dim1 /*=0*/, int _Dim2 /*=0*/>
...
public:
  ...
  tiled_extent(const Concurrency::extent<rank> &_Other) __GPU
      : Concurrency::extent<rank>(_Other) {}
  ...
  /// <summary>
  ///     Returns an instance of an extent that captures the values of the
  ///     tiled_extent template arguments _Dim0, _Dim1, _Dim2.
  /// </summary>
  __declspec(property(get = get_tile_extent)) Concurrency::extent<rank>
      tile_extent;
  ...
  /// <summary>
  ///     Returns a new tiled_extent with extents adjusted up to be evenly
  ///     divisible by the tile dimensions.
  /// </summary>
  tiled_extent pad() const __GPU {
    Concurrency::extent<rank> _New_extent(
        ((static_cast<unsigned int>((*this)[0]) + _Dim0 - 1) / _Dim0) * _Dim0,
  ...
  /// <summary>
  ///     Returns a new tiled_extent with extents adjusted down to be evenly
  ///     divisible by the tile dimensions.
  /// </summary>
  ...
  /// <summary>
  ///     These constants allow access to the template arguments of
  ///     tiled_extent.
  /// </summary>
  static const int tile_dim0 = _Dim0;
  static const int tile_dim1 = _Dim1;
  ...
  // Given the local index, the tile index, the global index, in the 0-based
  // domain that has same extents as 'this', and a barrier object, return a
  // tiled_index<_Dim0, _Dim1, _Dim2> into the 'this' tiled_extent domain.
  tiled_index<_Dim0, _Dim1, _Dim2>
  _map_index(const index<rank> &_Local, const index<rank> &_Tile,
             const index<rank> &_Global, tile_barrier &_Barrier) const __GPU {
    index<rank> _Tile_origin =
        details::_Create_uninitialized_tuple<index<rank>>();
    details::_arithmetic_op_loop_helper<index<rank>, details::opMul>::func(
        _Tile_origin, _Tile, tile_extent);
    return tiled_index<_Dim0, _Dim1, _Dim2>(_Global, _Local, _Tile,
                                            _Tile_origin, _Barrier);
  }
...
public:
  ...
  /// <summary>
  ///     Returns an instance of an extent that captures the values of the
  ///     tiled_extent template arguments _Dim0, _Dim1.
  /// </summary>
  __declspec(property(get = get_tile_extent)) Concurrency::extent<rank>
      tile_extent;
  Concurrency::extent<rank> get_tile_extent() const __GPU {
  ...
  // Given the local index, the tile index, the global index, in the 0-based
  // domain that has same extents as 'this', and a barrier object, return a
  // tiled_index<_Dim0, _Dim1> into the 'this' tiled_extent domain.
  tiled_index<_Dim0, _Dim1> _map_index(const index<rank> &_Local,
                                       const index<rank> &_Tile,
                                       const index<rank> &_Global,
                                       tile_barrier &_Barrier) const __GPU {
    index<rank> _Tile_origin =
        details::_Create_uninitialized_tuple<index<rank>>();
    details::_arithmetic_op_loop_helper<index<rank>, details::opMul>::func(
        _Tile_origin, _Tile, tile_extent);
    return tiled_index<_Dim0, _Dim1>(_Global, _Local, _Tile, _Tile_origin,
                                     _Barrier);
  }
  // implementation details (compiler helpers) - end
};
...
public:
  ...
  /// <summary>
  ///     Returns an instance of an extent that captures the values of the
  ///     tiled_extent template argument _Dim0.
  /// </summary>
  __declspec(property(get = get_tile_extent)) Concurrency::extent<rank>
      tile_extent;
  Concurrency::extent<rank> get_tile_extent() const __GPU {
  ...
  // Given the local index, the tile index, the global index, in the 0-based
  // domain that has same extents as 'this', and a barrier object, return a
  // tiled_index<_Dim0> into the 'this' tiled_extent domain.
  tiled_index<_Dim0> _map_index(const index<rank> &_Local,
                                const index<rank> &_Tile,
                                const index<rank> &_Global,
                                tile_barrier &_Barrier) const __GPU {
    index<rank> _Tile_origin =
...
int _Calculate_reinterpreted_size(int _Old_size) __CPU_ONLY {
  ...
  if (_New_size * _New_element_size > _Total_size)
    throw runtime_exception(
        "Element type of reinterpret_as does not evenly divide into extent",
        E_INVALIDARG);
...
class _Array_view_shape {
  typedef _Array_flatten_helper<_Rank,
                                typename Concurrency::extent<_Rank>::value_type,
                                typename Concurrency::index<_Rank>::value_type>
      _Flatten_helper;
...
public:
  ...
  Concurrency::extent<_Rank> get_extent() const __GPU { return _M_view_extent; }

  ~_Array_view_shape() __GPU {}

protected:
  int _Base_linear_offset() const __GPU {
    return (_M_total_linear_offset -
            (_Element_size * _Flatten_helper::func(_M_array_multiplier._M_base,
                                                   _M_view_offset._M_base)));
  }
  ...
  // For "section"
  _Array_view_shape(const _Array_view_shape &_Other,
                    const Concurrency::index<_Rank> &_Section_origin,
                    const Concurrency::extent<_Rank> &_Section_extent) __GPU
      : _M_array_extent(_Other._M_array_extent),
        _M_array_multiplier(_Other._M_array_multiplier),
  ...
  _Array_view_shape(int _Base_linear_offset,
                    const Concurrency::extent<_Rank> &_Array_extent) __GPU
  ...
  void _Project0(int _I,
                 _Array_view_shape<_Rank - 1, _Element_size> &_Projected_shape)
      const __GPU {
    static_assert(_Rank > 1, "Projection is only supported on array_views with "
                             "a rank of 2 or higher");
    ...
    _Projected_shape._M_total_linear_offset =
        _M_total_linear_offset + (_Element_size * _I * _M_array_multiplier[0]);
  }

  _Array_view_shape() __GPU : _M_array_extent(details::_do_not_initialize),
                              _M_array_multiplier(details::_do_not_initialize),
                              _M_view_offset(details::_do_not_initialize),
                              _M_view_extent(details::_do_not_initialize) {}

private:
  void _Initialize_multiplier() __GPU {
    details::_Is_valid_extent(_M_array_extent);
    unsigned int _Ext = _M_array_extent[_Rank - 1];
    details::_Array_init_helper<
        Concurrency::extent<_Rank>,
        Concurrency::extent<_Rank>>::func(_Ext, _M_array_multiplier,
                                          _M_array_extent);
  }
...
class _Array_view_base
    : public _Array_view_shape<_Rank, _Element_size /* in number of ints */> {
  typedef _Array_flatten_helper<_Rank,
                                typename Concurrency::extent<_Rank>::value_type,
                                typename Concurrency::index<_Rank>::value_type>
      _Flatten_helper;

  template <int _R, int _S> friend class _Array_view_base;
...
protected:
  ...
  _Array_view_base(const _Buffer_descriptor &_Buffer_desc,
                   const _Array_view_shape<_Rank, _Element_size> &_Shape) __GPU
  ...
  _Array_view_base(const _Array_view_base &_Other) __GPU
    ...
    // update this buffer descriptor in case _Register_copy was late and missed
    // the update opportunity.
    _M_buffer_descriptor = _Other._M_buffer_descriptor;
  }

  _Array_view_base(const _Array_view_base &_Other,
                   const Concurrency::extent<_Rank> &_Array_extent) __GPU
      : _M_buffer_descriptor(_Other._M_buffer_descriptor),
        _Array_view_shape<_Rank, _Element_size>(_Other._Base_linear_offset(),
                                                _Array_extent) {
    // Register the view
    _Register();
  }
  ...
  _Array_view_base(const _Array_view_base &_Other,
                   ...
                   const Concurrency::extent<_Rank> &_Section_extent) __GPU
      : _M_buffer_descriptor(_Other._M_buffer_descriptor),
        _Array_view_shape<_Rank, _Element_size>(_Other, _Section_origin,
                                                _Section_extent) {
    // Register the view
    _Register();
  }
  ...
  _Array_view_base(const _Buffer_descriptor &_Buffer_desc,
                   ...
                   const Concurrency::extent<_Rank> &_Array_extent) __GPU
      : _M_buffer_descriptor(_Buffer_desc),
        _Array_view_shape<_Rank, _Element_size>(_Base_linear_offset,
                                                _Array_extent) {
    // Register the view
    _Register();
  }
  ...
  _Array_view_base(const _Buffer_descriptor &_Buffer_desc,
                   ...
                   const Concurrency::extent<_Rank> &_View_extent) __CPU_ONLY
      : _M_buffer_descriptor(_Buffer_desc),
        _Array_view_shape<_Rank, _Element_size>(_Base_linear_offset,
                                                _Array_extent, _View_offset,
                                                _View_extent) {
    // Register the view
  ...
  _Array_view_base(const _Buffer_descriptor &_Buffer_desc,
                   ...
                   const Concurrency::extent<_Rank> &_Array_extent,
                   const Concurrency::index<_Rank> &_View_offset,
                   const Concurrency::extent<_Rank> &_View_extent) __GPU_ONLY
      : _M_buffer_descriptor(_Buffer_desc),
        _Array_view_shape<_Rank, _Element_size>(_Base_linear_offset,
                                                _Array_extent, _View_offset,
                                                _View_extent) {
  ...
  _Array_view_base(const Concurrency::extent<_Rank> &_Array_extent) __CPU_ONLY
      : _Array_view_shape<_Rank, _Element_size>(0, _Array_extent) {
    _Ubiquitous_buffer_ptr _PUBuf =
        _Ubiquitous_buffer::_Create_ubiquitous_buffer(
            _Array_extent.size(), _Element_size * sizeof(int));
    _M_buffer_descriptor =
        _Buffer_descriptor(NULL, _PUBuf, _No_access, _No_access);

    // Register the view
    _Register();
  }

  _Array_view_base(_In_ void *_Data,
                   const Concurrency::extent<_Rank> &_Array_extent) __CPU_ONLY
      : _Array_view_shape<_Rank, _Element_size>(0, _Array_extent) {
    if (_Data == NULL) {
      throw runtime_exception(
    ...
    _Buffer_ptr _PBuf = _Buffer::_Create_buffer(
        _Data, accelerator(accelerator::cpu_accelerator).default_view,
        _Array_extent.size(), _Element_size * sizeof(int));
    _Ubiquitous_buffer_ptr _PUBuf =
        _Ubiquitous_buffer::_Create_ubiquitous_buffer(_PBuf);
    _M_buffer_descriptor = _Buffer_descriptor(_Data, _PUBuf, _Read_write_access,
                                              _Read_write_access);
  ...
  _Array_view_base(_In_ void *_Data,
                   const Concurrency::extent<_Rank> &_Array_extent) __GPU_ONLY
      : _Array_view_shape<_Rank, _Element_size>(0, _Array_extent),
        _M_buffer_descriptor(_Data, NULL, _Read_write_access,
                             _Read_write_access) {}

  _Array_view_base(const void *_Data,
                   const Concurrency::extent<_Rank> &_Array_extent) __CPU_ONLY
      : _Array_view_shape<_Rank, _Element_size>(0, _Array_extent) {
    if (_Data == NULL) {
      throw runtime_exception(
    ...
    _Ubiquitous_buffer_ptr _PUBuf =
        _Ubiquitous_buffer::_Create_ubiquitous_buffer(_PBuf);
    _M_buffer_descriptor = _Buffer_descriptor(const_cast<void *>(_Data), _PUBuf,
...
#pragma warning(disable : 4880)
      ...
      // undefined behavior, therefore, the compiler will report a level 1
      // warning for it. But the following const_cast is harmless thus we are
      // suppressing this warning just for this line.
      _Array_view_shape<_Rank, _Element_size>(0, _Array_extent),
      _M_buffer_descriptor(const_cast<void *>(_Data), NULL, _Read_access,
                           _Read_access)
#pragma warning(pop)
  {
  }
  ...
  _Array_view_base &operator=(const _Array_view_base &_Other) __GPU {
    if (this != &_Other) {
      ...
      // update this buffer descriptor in case _Register_copy was late and
      // missed the update opportunity.
      _M_buffer_descriptor = _Other._M_buffer_descriptor;
    }
  ...
  _Ret_ void *_Access(const index<_Rank> &_Index) const __GPU {
    ...
    return &_Ptr[this->_M_total_linear_offset +
                 (_Element_size *
                  _Flatten_helper::func(this->_M_array_multiplier._M_base,
                                        _Index._M_base))];
  }

  _Ret_ void *_Access(_Access_mode _Requested_mode,
                      const index<_Rank> &_Index) const __CPU_ONLY {
    // Refresh the data ptr if we do not have requested access
    if ((_M_buffer_descriptor._M_curr_cpu_access_mode & _Requested_mode) !=
        _Requested_mode) {
  ...
  _Ret_ void *_Access(_Access_mode /*_Requested_mode*/,
                      const index<_Rank> &_Index) const __GPU_ONLY {
    return _Access(_Index);
  }

  _Array_view_base
  _Section(const Concurrency::index<_Rank> &_Section_origin,
           const Concurrency::extent<_Rank> &_Section_extent) const __GPU {
    ...
    _View._Register(_Array_view_base::_Create_section_buffer_shape(
        this->_M_buffer_descriptor, _Section_origin, _Section_extent));
  ...
  void _Project0(
      int _I,
      _Array_view_base<_Rank - 1, _Element_size> &_Projected_view) const __GPU {
    ...
    _Projected_view._Register(_Array_view_base::_Create_projection_buffer_shape(
        this->_M_buffer_descriptor, 0, _I));
  }
  ...
  _Array_view_base<_Rank, _New_element_size> _Reinterpret_as() const __GPU {
    ...
    int _New_size =
        _Calculate_reinterpreted_size<_Element_size, _New_element_size>(
            this->_M_view_extent.size());
    return _Array_view_base<_Rank, _New_element_size>(
        this->_M_buffer_descriptor, this->_M_total_linear_offset,
        Concurrency::extent<_Rank>(_New_size));
  }

  template <int _New_rank>
  _Array_view_base<_New_rank, _Element_size>
  _View_as(const Concurrency::extent<_New_rank> &_View_extent) const __GPU {
    static_assert(_Rank == 1,
                  "view_as is only permissible on array views of rank 1");
    return _Array_view_base<_New_rank, _Element_size>(
        this->_M_buffer_descriptor, this->_M_total_linear_offset, _View_extent,
        index<_New_rank>(), _View_extent);
  }

  _Ret_ _View_shape *_Create_buffer_view_shape() const __CPU_ONLY {
    unsigned int bufElemSize = static_cast<unsigned int>(
        _M_buffer_descriptor._Get_buffer_ptr()->_Get_master_buffer_elem_size());
    ...
    // The base array extent, view extent, and view offset must be compatible
    // with the underlying buffer's element size
    if (((linearOffsetInBytes % bufElemSize) != 0) ||
      ...
      throw runtime_exception(
          "The array_view base extent, view offset and/or view extent is "
          "incompatible with the underlying buffer",
          E_FAIL);
    }

    // The shape to be passed to the underlying buffer for registration must be
    // in terms of the element size of the buffer
    _ASSERTE((linearOffsetInBytes / bufElemSize) <= UINT_MAX);
    unsigned int linearOffset =
...
#pragma warning(disable                                                        \
                : 6201) //  Index '-1' is out of valid index range '0' to '0'
                        //  for possibly stack allocated buffer 'baseExtent'.
...
#pragma warning(pop)
    ...
    return _View_shape::_Create_view_shape(_Rank, linearOffset, baseExtent,
                                           viewOffset, viewExtent);
  }
...
private:
  void
  _Register(_In_opt_ const _View_key _Source_view_key = nullptr) __CPU_ONLY {
    _M_buffer_descriptor._Get_buffer_ptr()->_Register_view(
        _M_buffer_descriptor._Get_view_key(),
        accelerator(accelerator::cpu_accelerator).default_view,
        _Create_buffer_view_shape(), _Source_view_key);

    if (_M_buffer_descriptor._M_curr_cpu_access_mode != _No_access) {
      _Buffer_ptr _PBuf;
      _Get_access_async(_M_buffer_descriptor._Get_view_key(),
                        accelerator(accelerator::cpu_accelerator).default_view,
                        _M_buffer_descriptor._M_curr_cpu_access_mode, _PBuf)
          ._Get();
  ...
  void _Register_copy(const _Array_view_base &_Other) __CPU_ONLY {
    _M_buffer_descriptor._Get_buffer_ptr()->_Register_view_copy(
        _M_buffer_descriptor._Get_view_key(),
        _Other._M_buffer_descriptor._Get_view_key());
  }
  ...
  void _Unregister(bool _Throw_exception = true) __CPU_ONLY {
    ...
    try {
      _M_buffer_descriptor._Get_buffer_ptr()->_Unregister_view(
          _M_buffer_descriptor._Get_view_key());
    } catch (...) {
      if (_Throw_exception) {
        throw;
  ...
  static _Ret_ void *
  _Create_projection_buffer_shape(const _Buffer_descriptor &_Descriptor,
                                  unsigned int _Dim,
                                  int _Dim_offset) __CPU_ONLY {
    ...
    auto _PView_shape = _View_shape::_Create_view_shape(
        _Base_shape->_Get_rank(), _Base_shape->_Get_linear_offset(),
        _Base_shape->_Get_base_extent(), _New_view_offset.data(),
        _New_view_extent.data(), _New_projection_info);
  ...
  static _Ret_ void *_Create_section_buffer_shape(
      const _Buffer_descriptor &_Descriptor,
      const Concurrency::index<_Rank> &_Section_origin,
      const Concurrency::extent<_Rank> &_Section_extent) __CPU_ONLY {
    _View_shape *_Base_shape = _Get_buffer_view_shape(_Descriptor);
    ...
    while (_I < _Base_shape->_Get_rank()) {
      if (_Base_shape->_Get_projection_info()[_I]) {
        ...
        if (_J == (_Rank - 1)) {
          unsigned int bufElemSize = static_cast<unsigned int>(
              _Descriptor._Get_buffer_ptr()->_Get_master_buffer_elem_size());
          unsigned int elemSize = _Element_size * sizeof(int);
          ...
          // The section offset and extent must be compatible with the
          // underlying buffer's element size
          if (((sectionLSDOriginInBytes % bufElemSize) != 0) ||
              ((sectionLSDExtentInBytes % bufElemSize) != 0)) {
            throw runtime_exception(
                "The array_view section origin and/or extent is incompatible "
                "with the underlying buffer",
                E_FAIL);
          }

          // The extent in the least significant dimension needs to be adjusted
          // for difference in element size between the buffer and ourselves
          _ASSERTE((sectionLSDOriginInBytes / bufElemSize) <= UINT_MAX);
          _New_view_offset[_I] =
              _Base_shape->_Get_view_offset()[_I] +
          ...
          _New_view_offset[_I] =
              _Base_shape->_Get_view_offset()[_I] + _Section_origin[_J];
        }
    ...
    return _View_shape::_Create_view_shape(
        _Base_shape->_Get_rank(), _Base_shape->_Get_linear_offset(),
        _Base_shape->_Get_base_extent(), _New_view_offset.data(),
        _New_view_extent.data(), _Base_shape->_Get_projection_info());
  }
  ...
  static _Ret_ void *_Create_section_buffer_shape(
      const _Buffer_descriptor & /*_Descriptor*/,
      const Concurrency::index<_Rank> & /*_Section_origin*/,
      const Concurrency::extent<_Rank> & /*_Section_extent*/) __GPU_ONLY {
    return NULL;
  }
};

template <typename _Container> struct _Is_container {
  template <class _Uty>
  static auto _Fn(_Uty _Val, decltype(_Val.size(), _Val.data(), 0))
      -> std::true_type;
...
/// <summary>
///     An array_view is an N-dimensional view over data held in another
///     container (such as array&lt;T,N&gt; or other container.  It exposes an
///     indexing interface congruent to that of array&lt;T,N&gt;).
/// </summary>
/// <param name="_Rank">
...
class array_view
    : public _Array_view_base<_Rank, sizeof(_Value_type) / sizeof(int)> {
  typedef _Array_view_base<_Rank, sizeof(_Value_type) / sizeof(int)> _Base;

  _CPP_AMP_VERIFY_RANK(_Rank, array_view);
  static_assert(0 == (sizeof(_Value_type) % sizeof(int)),
                "only value types whose size is a multiple of the size of an "
                "integer are allowed in array views");
  ...
  template <typename _T, int _R> friend class array;

  friend const typename _Base::_Buffer_descriptor &
  details::_Get_buffer_descriptor<array_view<_Value_type, _Rank>>(
...
public:
  ...
  /// <summary>
  ///   Construct an array_view which is bound to the data contained in the _Src
  ///   array.  The extent of the array_view is that of the _Src array, and the
  ///   origin of the array view is at zero.
  /// </summary>
  /// <param name="_Src">
  ...
  array_view(const Concurrency::extent<_Rank> &_Extent,
             _Container &_Src) __CPU_ONLY : _Base(_Src.data(), _Extent) {
    static_assert(
        std::is_same<decltype(_Src.data()), _Value_type *>::value,
  ...
  /// </param>
  /// <param name="_Src">
  ///   A pointer to the source data this array_view will bind to.  If the
  ///   number of elements pointed to by _Src is less than the size of _Extent,
  ...
  /// </param>
  explicit array_view(int _E0) __CPU_ONLY : _Base(Concurrency::extent<1>(_E0)) {
  ...
  explicit array_view(
      _Container &_Src,
      typename std::enable_if<details::_Is_container<_Container>::type::value,
                              void **>::type = 0) __CPU_ONLY
      : _Base(_Src.data(),
              Concurrency::extent<1>(static_cast<int>(_Src.size()))) {
    if (_Src.size() > INT_MAX) {
      throw runtime_exception(
          "Invalid _Src container argument - _Src size is greater than INT_MAX",
          E_INVALIDARG);
    }
    static_assert(
        std::is_same<decltype(_Src.data()), _Value_type *>::value,
  ...
  /// </param>
  template <typename _Container>
  explicit array_view(int _E0, _Container &_Src) __CPU_ONLY
  ...
  /// </summary>
  /// <param name="_E0">
  ///   An integer that is the length of the most-significant dimension of this
  ///   array_view.
  /// </param>
  /// <param name="_E1">
  ///   An integer that is the length of the least-significant dimension of this
  ///   array_view.
  /// </param>
  ...
  /// </param>
  template <typename _Container>
  explicit array_view(int _E0, int _E1, _Container &_Src) __CPU_ONLY
  ...
  /// </param>
  /// <param name="_E1">
  ///   An integer that is the length of the next-to-most-significant dimension
  ///   of this array_view.
  /// </param>
  /// <param name="_E2">
  ///   An integer that is the length of the least-significant dimension of this
  ...
  /// </param>
  template <typename _Container>
  explicit array_view(int _E0, int _E1, int _E2, _Container &_Src) __CPU_ONLY
  ...
  /// </param>
  /// <param name="_Src">
  ///   A container which contains the data that this array_view is bound to. If
  ///   the number of elements pointed to by _Src is less than _E0, undefined
  ///   behavior results.
  /// </param>
  ...
  /// </param>
  template <int _Size>
  explicit array_view(_In_ _Value_type (&_Src)[_Size]) __GPU
  ...
  /// <param name="_Src">
  ///   A container which contains the data that this array_view is bound to. If
  ///   the number of elements pointed to by _Src is less than _E0*_E1,
  ///   undefined behavior results.
  /// </param>
  ...
  /// <param name="_Src">
  ///   A container which contains the data that this array_view is bound to. If
  ///   the number of elements pointed to by _Src is less than _E0*_E1*_E2,
  ///   undefined behavior results.
  /// </param>
  ...
  /// <summary>
  ///     Projects the most-significant dimension of this array_view.  If the
  ///     array_view rank is 1, this produces a single element; otherwise it
  ///     produces an array_view with one fewer dimensions.
  /// </summary>
  /// <param name="_I">
  ///     The most-significant index component
  /// </param>
  /// <returns>
  ///     The element at index component _I, or an array_view projected on the
  ///     most-significant dimension.
  /// </returns>
  typename details::_Projection_result_type<_Value_type, _Rank>::_Result_type
  operator[](int _I) const __GPU {
    return details::_Array_view_projection_helper<_Value_type,
                                                  _Rank>::_Project0(this, _I);
  }

  /// <summary>
  ///     Get a reference to the element indexed by _Index. Unlike the other
  ///     indexing operators for accessing the array_view on the CPU, this
  ///     method does not implicitly synchronize this array_view's contents to
  ///     the CPU. After accessing the array_view on a remote location or
  ///     performing a copy operation involving this array_view users are
  ...
  _Value_type &operator()(int _I0, int _I1) const __GPU {
    static_assert(_Rank == 2, "value_type& array_view::operator()(int,int) is "
                              "only permissible on array_view<T, 2>");
  ...
  _Value_type &operator()(int _I0, int _I1, int _I2) const __GPU {
    static_assert(_Rank == 3, "value_type& array_view::operator()(int,int,int) "
                              "is only permissible on array_view<T, 3>");
    return this->operator()(index<3>(_I0, _I1, _I2));
  }

  /// <summary>
  ///     Produces a subsection of the source array_view at the given origin and
  ///     extent.
  /// </summary>
  ...
  /// </returns>
  array_view
  section(const Concurrency::index<_Rank> &_Section_origin,
          const Concurrency::extent<_Rank> &_Section_extent) const __GPU {
    return _Convert<_Value_type>(
        this->_Section(_Section_origin, _Section_extent));
  }

  /// <summary>
  ///     Produces a subsection of the source array_view with origin specified
  ///     by an index, with an extent of (this-&gt;extent - _Idx).
  /// </summary>
  /// <param name="_Idx">
  ...
  /// <summary>
  ///     Produces a subsection of the source array_view with origin of zero,
  ///     with an extent of _Ext.
  /// </summary>
  /// <param name="_Ext">
  ...
  /// <summary>
  ///     Produces a one-dimensional subsection of the source array_view with
  ///     origin specified by the index components _I0, with extent _E0.
  /// </summary>
  /// <param name="_I0">
  ...
  /// <summary>
  ///     Produces a two-dimensional subsection of the source array_view with
  ///     origin specified by the index components (_I0,_I1), with extent
  ///     (_E0,_E1).
  /// </summary>
  /// <param name="_I0">
  ...
  array_view section(int _I0, int _I1, int _E0, int _E1) const __GPU {
    static_assert(_Rank == 2, "rank must be 2");
    return section(Concurrency::index<2>(_I0, _I1),
                   Concurrency::extent<2>(_E0, _E1));
  }

  /// <summary>
  ///     Produces a three-dimensional subsection of the source array_view with
  ///     origin specified by the index components (_I0,_I1,_I2), with extent
  ///     (_E0,_E1,_E2).
  /// </summary>
  /// <param name="_I0">
  ///     The most-significant component of the origin of this section.
  ...
  ///     A subsection of the array_view.
  /// </returns>
  array_view section(int _I0, int _I1, int _I2, int _E0, int _E1,
                     int _E2) const __GPU {
    static_assert(_Rank == 3, "rank must be 3");
    return section(Concurrency::index<3>(_I0, _I1, _I2),
                   Concurrency::extent<3>(_E0, _E1, _E2));
  }

  /// <summary>
  ///     Produces a (possibly unsafe) reinterpretation of this array_view that
  ///     is linear and with a different element type. The size of _Value_type2
  ///     must evenly divide into the size of this array.
  /// </summary>
  /// <returns>
  ...
  array_view<_Value_type2, _Rank> reinterpret_as() const __GPU {
    return _Convert<_Value_type2>(
        this->template _Reinterpret_as<sizeof(_Value_type2) / sizeof(int)>());
  }

  /// <summary>
  ///     Produces an array_view of a different rank over this array_view's
  ///     data.
  /// </summary>
  ...
  /// </returns>
  template <int _New_rank>
  array_view<_Value_type, _New_rank>
  view_as(const Concurrency::extent<_New_rank> &_View_extent) const __GPU {
  ...
  ///     the array_view interface.  This will render all cached information
  ///     stale.
  /// </summary>
  void refresh() const __CPU_ONLY {
    ...
    _Get_access_async(this->_M_buffer_descriptor._Get_view_key(),
                      this->_M_buffer_descriptor._Get_buffer_ptr()
  ...
  /// <summary>
  ///     Asynchronously synchronizes any modifications made to "this"
  ///     array_view to the specified accelerator_view.
  /// </summary>
  ...
  concurrency::completion_future synchronize_to_async(
      ...
      access_type _Access_type = access_type_read) const __CPU_ONLY {
    auto _Async_op_id =
        details::_Get_amp_trace()->_Launch_array_view_synchronize_event_helper(
            this->_M_buffer_descriptor);

    _Buffer_ptr _PBuf;
    _Event _Ev;

    if (_Access_type != access_type_none) {
      _Ev = _Get_access_async(
          this->_M_buffer_descriptor._Get_view_key(), _Accl_view,
          _Get_synchronize_access_mode(_Access_type), _PBuf);
    }

    return details::_Get_amp_trace()->_Start_async_op_wait_event_helper(
        _Async_op_id, _Ev);
  }

  /// <summary>
  ///     Asynchronously synchronizes any modifications made to "this"
  ///     array_view to its source data.
  /// </summary>
  /// <param name="_Access_type">
  ///     The desired access_type on the target accelerator_view.
  ///     This parameter has a default value of access_type_read.
  ...
  concurrency::completion_future synchronize_async(
    ...
    if ((_Access_type != access_type_none) &&
        this->_M_buffer_descriptor._Get_buffer_ptr()->_Has_data_source()) {
      _Ev =
          _Get_access_async(this->_M_buffer_descriptor._Get_view_key(),
                            this->_M_buffer_descriptor._Get_buffer_ptr()
                                ->_Get_master_accelerator_view(),
  ...
  /// <summary>
  ///     Synchronizes any modifications made to "this" array_view to the
  ///     specified accelerator_view.
  /// </summary>
  /// <param name="_Accl_view">
  ///     The target accelerator_view to synchronize to.
  /// </param>
  ...
  /// </param>
  void
  synchronize_to(const accelerator_view &_Accl_view,
                 access_type _Access_type = access_type_read) const __CPU_ONLY {
    auto _Span_id =
        details::_Get_amp_trace()->_Start_array_view_synchronize_event_helper(
            this->_M_buffer_descriptor);

    _Buffer_ptr _PBuf;

    if (_Access_type != access_type_none) {
      _Get_access_async(this->_M_buffer_descriptor._Get_view_key(), _Accl_view,
                        _Get_synchronize_access_mode(_Access_type), _PBuf)
          ._Get();
    }
  ...
  /// <summary>
  ///     Synchronizes any modifications made to "this" array_view to its source
  ///     data.
  /// </summary>
  /// <param name="_Access_type">
  ///     The desired access_type on the target accelerator_view.
  ...
  /// </param>
  void
  synchronize(access_type _Access_type = access_type_read) const __CPU_ONLY {
    auto _Span_id =
        details::_Get_amp_trace()->_Start_array_view_synchronize_event_helper(
            this->_M_buffer_descriptor);
  ...
  /// <summary>
  ///     Discards the current data underlying this view. This is an
  ///     optimization hint to the runtime used to avoid copying the current
  ///     contents of the view to a target accelerator_view that it is accessed
  ///     on, and its use is recommended if the existing content is not needed.
  ///     This method is only available in a restrict(cpu) context and cannot be
  ///     used in a restrict(amp) context.
  /// </summary>
  void discard_data() const __CPU_ONLY {
    this->_M_buffer_descriptor._Get_buffer_ptr()->_Discard(
        this->_M_buffer_descriptor._Get_view_key());
  }

  /// <summary>
  ///     Returns the accelerator_view where the data source of the array_view
  ///     is located. If the array_view does not have a data source, this API
  ///     throws a runtime_exception
  /// </summary>
  accelerator_view get_source_accelerator_view() const {
    if (this->_M_buffer_descriptor._Get_buffer_ptr()->_Has_data_source()) {
      return this->_M_buffer_descriptor._Get_buffer_ptr()
          ->_Get_master_accelerator_view();
    } else {
      throw runtime_exception("Cannot query source accelerator_view for an "
                              "array_view without a data source.",
                              E_INVALIDARG);
    }
  }

  __declspec(property(get = get_source_accelerator_view)) accelerator_view
      source_accelerator_view;

private:
  template <typename _T, int _R>
  static array_view<_T, _R>
  _Convert(const _Array_view_base<_R, sizeof(_T) / sizeof(int)> &_Other) __GPU {
    static_assert(sizeof(array_view<_T, _R>) ==
                      sizeof(_Array_view_base<_R, sizeof(_T) / sizeof(int)>),
                  "ASSERT FAILURE: implementation relies on binary conversion "
                  "between the two");
  ...
  void
  _Project0(int _I,
            array_view<_Value_type, _Rank - 1> &_Projected_view) const __GPU {
  ...
  array_view(const array_view &_Other,
             const Concurrency::index<_Rank> &_Section_origin,
             const Concurrency::extent<_Rank> &_Section_extent) __GPU
  ...
  array_view(typename _Base::_Buffer_descriptor &_Src_buffer,
             const Concurrency::extent<_Rank> &_Extent) __GPU
  ...
  void _Initialize(size_t _Src_data_size,
                   bool _Discard_data = false) __CPU_ONLY {
    // Ensure that the _Src_data_size is at least as big as the size
    // of the array_view
    if (_Src_data_size < this->extent.size()) {
      throw runtime_exception("Invalid _Src container argument - _Src size is "
                              "less than the size of the array_view.",
                              E_INVALIDARG);
    }
...
class array_view<const _Value_type, _Rank>
  ...
  friend class details::_Const_array_view_projection_helper<_Value_type,
                                                            _Rank + 1>;
  ...
  friend const typename _Base::_Buffer_descriptor &
  details::_Get_buffer_descriptor<array_view<const _Value_type, _Rank>>(
      const array_view<const _Value_type, _Rank> &_Array) __GPU;
...
public:
  ...
  ///   Copy constructor. Shallow copy.
  /// </summary>
  array_view(const array_view<_Value_type, _Rank> &_Src) __GPU : _Base(_Src) {
    _Initialize();
  }
  ...
  template <typename _Container>
  array_view(const Concurrency::extent<_Rank> &_Extent,
             const _Container &_Src) __CPU_ONLY : _Base(_Src.data(), _Extent) {
    static_assert(
        std::is_same<typename std::remove_const<typename std::remove_reference<
                         decltype(*_Src.data())>::type>::type,
                     _Value_type>::value,
        "container element type and array view element type must match");
    _Initialize(_Src.size());
  }
  ...
  explicit array_view(
    ...
    static_assert(
        std::is_same<decltype(_Src.data()), const _Value_type *>::value,
        "container element type and array view element type must match");
    static_assert(_Rank == 1, "rank must be 1");
    _Initialize(_Src.size());
  }
  ...
  /// </param>
  array_view(const Concurrency::extent<_Rank> &_Extent,
             const _Value_type *_Src) __GPU : _Base(_Src, _Extent) {
    _Initialize();
  }
  ...
  /// </param>
  array_view(const Concurrency::extent<_Rank> &_Extent,
             _In_ _Value_type *_Src) __GPU : _Base(_Src, _Extent) {
    _Initialize();
  }
  ...
  /// </param>
  template <int _Size>
  explicit array_view(const _In_ _Value_type (&_Src)[_Size]) __GPU
      : _Base(_Src, Concurrency::extent<1>(_Size)) {
    static_assert(_Rank == 1, "rank must be 1");
    _Initialize();
  }
  ...
  ///     most-significant dimension.
  /// </returns>
  typename details::_Projection_result_type<_Value_type,
                                            _Rank>::_Const_result_type
  operator[](int _I) const __GPU {
    return details::_Const_array_view_projection_helper<_Value_type,
                                                        _Rank>::_Project0(this,
                                                                          _I);
  }
  ...
  ///     Produces a (possibly unsafe) reinterpretation of this array_view that
  ///     is linear and with a different element type. The size of _Value_type2
  ///     must evenly divide into the size of this array_view.
  /// </summary>
  /// <returns>
  ///     A linear array_view with a reinterpreted element type.
  /// </returns>
  ...
  /// </returns>
  template <int _New_rank>
  array_view<const _Value_type, _New_rank>
  view_as(const Concurrency::extent<_New_rank> &_View_extent) const __GPU {
    return _Convert<_Value_type>(this->_View_as(_View_extent));
  }
  ...
  synchronize_to_async(const accelerator_view &_Accl_view) const __CPU_ONLY {
    auto _Async_op_id =
        details::_Get_amp_trace()->_Launch_array_view_synchronize_event_helper(
            this->_M_buffer_descriptor);
...
private:
  template <typename _T, int _R>
  static array_view<const _T, _R>
  _Convert(const _Array_view_base<_R, sizeof(_T) / sizeof(int)> &_Other) __GPU {
    static_assert(sizeof(array_view<const _T, _R>) ==
                      sizeof(_Array_view_base<_R, sizeof(_T) / sizeof(int)>),
                  "ASSERT FAILURE: implementation relies on binary conversion "
                  "between the two");
  ...
  void _Project0(
      int _I,
      array_view<const _Value_type, _Rank - 1> &_Projected_view) const __GPU {
    _Base::_Project0(_I, _Projected_view);
    _Projected_view._Initialize();
  }
...
template <typename _Value_type, int _Rank>
concurrency::completion_future copy_async(const array<_Value_type, _Rank> &_Src,
                                          array<_Value_type, _Rank> &_Dest);
template <typename _Value_type, int _Rank>
void copy(const array<_Value_type, _Rank> &_Src,
          array<_Value_type, _Rank> &_Dest);
...
template <typename _Value_type, int _Rank>
concurrency::completion_future
copy_async(const array<_Value_type, _Rank> &_Src,
...
template <typename _Value_type, int _Rank>
concurrency::completion_future
copy_async(const array_view<const _Value_type, _Rank> &_Src,
           array<_Value_type, _Rank> &_Dest);
template <typename _Value_type, int _Rank>
void copy(const array_view<const _Value_type, _Rank> &_Src,
          array<_Value_type, _Rank> &_Dest);
template <typename _Value_type, int _Rank>
concurrency::completion_future
copy_async(const array_view<_Value_type, _Rank> &_Src,
           array<_Value_type, _Rank> &_Dest);
template <typename _Value_type, int _Rank>
void copy(const array_view<_Value_type, _Rank> &_Src,
          array<_Value_type, _Rank> &_Dest);
template <typename _Value_type, int _Rank>
concurrency::completion_future
copy_async(const array_view<const _Value_type, _Rank> &_Src,
...
template <typename InputIterator, typename _Value_type, int _Rank>
concurrency::completion_future
copy_async(InputIterator _SrcFirst, InputIterator _SrcLast,
           const array_view<_Value_type, _Rank> &_Dest);
template <typename InputIterator, typename _Value_type, int _Rank>
concurrency::completion_future
copy_async(InputIterator _SrcFirst,
           const array_view<_Value_type, _Rank> &_Dest);
template <typename InputIterator, typename _Value_type, int _Rank>
void copy(InputIterator _SrcFirst, InputIterator _SrcLast,
          const array_view<_Value_type, _Rank> &_Dest);
...
namespace direct3d {
template <typename _Value_type, int _Rank>
array<_Value_type, _Rank> make_array(const Concurrency::extent<_Rank> &_Extent,
                                     const Concurrency::accelerator_view &_Av,
                                     _In_ IUnknown *_D3D_buffer) __CPU_ONLY;
}
...
template <typename _Value_type, int _Rank = 1> class array {
  ...
  static_assert(0 == (sizeof(_Value_type) % sizeof(int)),
                "only value types whose size is a multiple of the size of an "
                "integer are allowed in array");

  // Friends
  friend array<_Value_type, _Rank> direct3d::make_array<_Value_type, _Rank>(
      const Concurrency::extent<_Rank> &_Extent,
      const Concurrency::accelerator_view &_Av,
      _In_ IUnknown *_D3D_buffer) __CPU_ONLY;
  friend const _Buffer_descriptor &
  details::_Get_buffer_descriptor<array<_Value_type, _Rank>>(
      const array<_Value_type, _Rank> &_Array) __GPU;
  friend _Ret_ _Ubiquitous_buffer *
  details::_Get_buffer<array<_Value_type, _Rank>>(
      const array<_Value_type, _Rank> &_Array) __CPU_ONLY;
  friend _Event details::_Get_access_async<array<_Value_type, _Rank>>(
      const array<_Value_type, _Rank> &_Array, _Access_mode _Mode,
      _Buffer_ptr &_Buf_ptr) __CPU_ONLY;
...
public:
  ...
  /// </param>
  array(const Concurrency::extent<_Rank> &_Extent,
        Concurrency::accelerator_view _Av,
        access_type _Cpu_access_type = access_type_auto) __CPU_ONLY
      : _M_extent(_Extent) {
    _Initialize(_Av, _Cpu_access_type);
  }

  /// <summary>
  ///    Construct array&lt;T,1&gt; with the extent _E0, bound to a specific
  ///    accelerator_view.
  /// </summary>
  /// <param name="_E0">
  ///   An integer that is the length of this array.
  ...
  ///   get_cpu_access_type method.
  /// </param>
  array(int _E0, Concurrency::accelerator_view _Av,
        access_type _Cpu_access_type = access_type_auto) __CPU_ONLY
      : _M_extent(Concurrency::extent<_Rank>(_E0)) {
    static_assert(
        _Rank == 1,
  ...
  /// <summary>
  ///    Construct an array&lt;T,2&gt; from two integer extents, bound to a
  ...
  ///   get_cpu_access_type method.
  /// </param>
  array(int _E0, int _E1, Concurrency::accelerator_view _Av,
        access_type _Cpu_access_type = access_type_auto) __CPU_ONLY
      : _M_extent(Concurrency::extent<_Rank>(_E0, _E1)) {
    static_assert(
        _Rank == 2,
  ...
  /// <summary>
  ///   Construct an array&lt;T,3&gt; from three integer extents, bound to a
  ///   specific accelerator_view.
  /// </summary>
  /// <param name="_E0">
  ///   An integer that is the length of the most-significant dimension of this
  ...
  ///   get_cpu_access_type method.
  /// </param>
  array(int _E0, int _E1, int _E2, Concurrency::accelerator_view _Av,
        access_type _Cpu_access_type = access_type_auto) __CPU_ONLY
      : _M_extent(Concurrency::extent<_Rank>(_E0, _E1, _E2)) {
    static_assert(_Rank == 3, "array(int, int, int, accelerator_view) is only "
                              "permissible on array<T, 3>");
    _Initialize(_Av, _Cpu_access_type);
  }
  ...
  ///   An accelerator_view which specifies the preferred target location of the
  ///   array.
  /// </param>
  array(const Concurrency::extent<_Rank> &_Extent,
        Concurrency::accelerator_view _Av,
        Concurrency::accelerator_view _Associated_Av) __CPU_ONLY
      : _M_extent(_Extent) {
  ...
  ///   array.
  /// </param>
  array(int _E0, accelerator_view _Av,
        Concurrency::accelerator_view _Associated_Av) __CPU_ONLY
      : _M_extent(Concurrency::extent<_Rank>(_E0)) {
    static_assert(_Rank == 1, "array(int, accelerator_view, accelerator_view) "
                              "is only permissible on array<T, 1>");
    _Initialize(_Av, _Associated_Av);
  }
  ...
  array(int _E0, int _E1, Concurrency::accelerator_view _Av,
      ...
      : _M_extent(Concurrency::extent<_Rank>(_E0, _E1)) {
    static_assert(_Rank == 2,
                  "array(int, int, accelerator_view, accelerator_view) is only "
                  "permissible on array<T, 2>");
    _Initialize(_Av, _Associated_Av);
  }
  ...
  array(int _E0, int _E1, int _E2, Concurrency::accelerator_view _Av,
      ...
      : _M_extent(Concurrency::extent<_Rank>(_E0, _E1, _E2)) {
    static_assert(_Rank == 3,
                  "array(int, int, int, accelerator_view, accelerator_view) is "
                  "only permissible on array<T, 3>");
    _Initialize(_Av, _Associated_Av);
  }

  /// <summary>
  ///   Construct an array initialized from a pair of iterators into a
  ///   container.
  /// </summary>
  /// <param name="_Extent">
  ///   An extent that describes the shape of the array.
  ...
  array(const Concurrency::extent<_Rank> &_Extent, _InputIterator _Src_first,
        _InputIterator _Src_last) __CPU_ONLY : _M_extent(_Extent) {
    _Initialize(details::_Select_default_accelerator().default_view, _Src_first,
                _Src_last, access_type_auto);
  }
  ...
  /// </param>
  /// <param name="_Src_first">
  ///   A beginning iterator into the source container; if the number of
  ///   available container elements starting at this iterator position is less
  ///   than this-&gt;extent.size(), undefined behavior results.
  /// </param>
  template <typename _InputIterator>
  array(const Concurrency::extent<_Rank> &_Extent,
        _InputIterator _Src_first) __CPU_ONLY : _M_extent(_Extent) {
  ...
  /// </param>
  template <typename _InputIterator>
  array(int _E0, int _E1, _InputIterator _Src_first,
        _InputIterator _Src_last) __CPU_ONLY
      : _M_extent(Concurrency::extent<_Rank>(_E0, _E1)) {
    static_assert(_Rank == 2, "array(int, int, iterator, iterator) is only "
                              "permissible on array<T, 2>");
    _Initialize(details::_Select_default_accelerator().default_view, _Src_first,
                _Src_last, access_type_auto);
  }
  ...
  /// </param>
  template <typename _InputIterator>
  array(int _E0, int _E1, int _E2, _InputIterator _Src_first,
        _InputIterator _Src_last) __CPU_ONLY
      : _M_extent(Concurrency::extent<_Rank>(_E0, _E1, _E2)) {
    static_assert(_Rank == 3, "array(int, int, int, iterator, iterator) is "
                              "only permissible on array<T, 3>");
    _Initialize(details::_Select_default_accelerator().default_view, _Src_first,
                _Src_last, access_type_auto);
  }
  ...
  template <typename _InputIterator>
  array(const Concurrency::extent<_Rank> &_Extent, _InputIterator _Src_first,
        _InputIterator _Src_last, Concurrency::accelerator_view _Av,
        access_type _Cpu_access_type = access_type_auto) __CPU_ONLY
      : _M_extent(_Extent) {
  ...
  /// <summary>
  ///   Construct an array initialized from an iterator into a container, bound
  ///   to a specific accelerator_view.
  /// </summary>
  /// <param name="_Extent">
  ///   An extent that describes the shape of the array.
  /// </param>
  ...
  /// </param>
  template <typename _InputIterator>
  array(int _E0, _InputIterator _Src_first, _InputIterator _Src_last,
        Concurrency::accelerator_view _Av,
        access_type _Cpu_access_type = access_type_auto) __CPU_ONLY
      : _M_extent(Concurrency::extent<_Rank>(_E0)) {
    static_assert(
  ...
  /// </param>
  template <typename _InputIterator>
  array(int _E0, _InputIterator _Src_first, Concurrency::accelerator_view _Av,
        access_type _Cpu_access_type = access_type_auto) __CPU_ONLY
      : _M_extent(Concurrency::extent<_Rank>(_E0)) {
    static_assert(_Rank == 1,
                  "array(int, iterator) is only permissible on array<T, 1>");
  ...
  /// </param>
  template <typename _InputIterator>
  array(int _E0, int _E1, _InputIterator _Src_first, _InputIterator _Src_last,
        Concurrency::accelerator_view _Av,
        access_type _Cpu_access_type = access_type_auto) __CPU_ONLY
      : _M_extent(Concurrency::extent<_Rank>(_E0, _E1)) {
    static_assert(_Rank == 2, "array(int, int, iterator, iterator) is only "
  ...
  /// <summary>
  ///   Construct a staging array between two associated accelerator_view,
  ///   initialized from a pair of iterators into a container.
  /// </summary>
  /// <param name="_Extent">
  ///   An extent that describes the shape of the array.
  /// </param>
  ...
  /// <summary>
  ///   Construct a staging array between two associated accelerator_view,
  ///   initialized from an iterator into a container.
  /// </summary>
  /// <param name="_Extent">
  ///   An extent that describes the shape of the array.
  /// </param>
  ...
  array(int _E0, _InputIterator _Src_first, _InputIterator _Src_last,
      ...
      : _M_extent(Concurrency::extent<_Rank>(_E0)) {
    static_assert(_Rank == 1,
                  "array(int, iterator, iterator, accelerator_view, "
                  "accelerator_view) is only permissible on array<T, 1>");
    _Initialize(_Av, _Associated_Av, _Src_first, _Src_last);
  }
  ...
  array(int _E0, _InputIterator _Src_first, Concurrency::accelerator_view _Av,
      ...
      : _M_extent(Concurrency::extent<_Rank>(_E0)) {
    static_assert(_Rank == 1,
                  "array(int, iterator, accelerator_view, accelerator_view) is "
                  "only permissible on array<T, 1>");
  ...
  array(int _E0, int _E1, _InputIterator _Src_first, _InputIterator _Src_last,
      ...
      : _M_extent(Concurrency::extent<_Rank>(_E0, _E1)) {
    static_assert(_Rank == 2,
                  "array(int, int, iterator, iterator, accelerator_view, "
                  "accelerator_view) is only permissible on array<T, 2>");
    _Initialize(_Av, _Associated_Av, _Src_first, _Src_last);
  }
  ...
  array(int _E0, int _E1, _InputIterator _Src_first,
      ...
      : _M_extent(Concurrency::extent<_Rank>(_E0, _E1)) {
    static_assert(_Rank == 2,
                  "array(int, int, iterator, accelerator_view, "
                  "accelerator_view) is only permissible on array<T, 2>");
  ...
  array(int _E0, int _E1, int _E2, _InputIterator _Src_first,
      ...
      : _M_extent(Concurrency::extent<_Rank>(_E0, _E1, _E2)) {
    static_assert(_Rank == 3,
                  "array(int, int, int, iterator, iterator, accelerator_view, "
                  "accelerator_view) is only permissible on array<T, 3>");
    _Initialize(_Av, _Associated_Av, _Src_first, _Src_last);
  }
  ...
  array(int _E0, int _E1, int _E2, _InputIterator _Src_first,
      ...
      : _M_extent(Concurrency::extent<_Rank>(_E0, _E1, _E2)) {
    static_assert(_Rank == 3,
                  "array(int, int, int, iterator, accelerator_view, "
                  "accelerator_view) is only permissible on array<T, 3>");
  ...
  /// <summary>
  ///   Construct an array initialized from an array_view, bound to a specific
  ///   accelerator_view.
  /// </summary>
  /// <param name="_Src">
  ///   An array_view to copy from.
  ...
  ///   get_cpu_access_type method.
  /// </param>
  array(const array_view<const _Value_type, _Rank> &_Src, accelerator_view _Av,
        access_type _Cpu_access_type = access_type_auto) __CPU_ONLY
      : _M_extent(_Src.extent) {
    _Initialize(_Av, _Cpu_access_type);
    Concurrency::copy(_Src, *this);
  ...
  /// <summary>
  ///   Construct a staging array between two associated accelerator_views,
  ///   initialized from an array_view.
  /// </summary>
  /// <param name="_Src">
  ///   An array_view to copy from.
  /// </param>
  ...
  /// </param>
  array(const array_view<const _Value_type, _Rank> &_Src, accelerator_view _Av,
        accelerator_view _Associated_Av) __CPU_ONLY : _M_extent(_Src.extent) {
    _Initialize(_Av, _Associated_Av);
    Concurrency::copy(_Src, *this);
  }
  ...
  /// </summary>
  array(const array &_Other) __CPU_ONLY : _M_extent(_Other._M_extent) {
  ...
  /// </summary>
  array &
  operator=(const array_view<const _Value_type, _Rank> &_Src) __CPU_ONLY {
    Concurrency::copy(_Src, *this);
    return *this;
  }
  ...
  _Value_type &operator[](const index<_Rank> &_Index) __GPU {
    ...
    _Value_type *_Ptr =
        reinterpret_cast<_Value_type *>(_M_buffer_descriptor._M_data_ptr);
...
#pragma warning(pop)
  ...
  /// <summary>
  ///     Projects the most-significant dimension of this array.  If the array
  ///     rank is 1, this produces a single element; otherwise it produces an
  ///     array_view with one fewer dimensions.
  /// </summary>
  /// <param name="_I">
  ///     The most-significant index component
  /// </param>
  ...
  /// </returns>
  typename details::_Projection_result_type<_Value_type, _Rank>::_Result_type
  operator[](int _I) __GPU {
    return details::_Array_projection_helper<_Value_type, _Rank>::_Project0(
        this, _I);
  }
  ...
  typename details::_Projection_result_type<_Value_type,
                                            _Rank>::_Const_result_type
  operator[](int _I) const __GPU {
    return details::_Const_array_projection_helper<_Value_type,
                                                   _Rank>::_Project0(this, _I);
  }
  ...
  _Value_type &operator()(int _I0, int _I1) __GPU {
    static_assert(_Rank == 2, "value_type& array::operator()(int, int) is only "
                              "permissible on array<T, 2>");
    return this->operator[](index<2>(_I0, _I1));
  }
  ...
  /// </returns>
  const _Value_type &operator()(int _I0, int _I1) const __GPU {
    static_assert(_Rank == 2, "const value_type& array::operator()(int, int) "
                              "is only permissible on array<T, 2>");
    return this->operator[](index<2>(_I0, _I1));
  }
  ...
  _Value_type &operator()(int _I0, int _I1, int _I2) __GPU {
    static_assert(_Rank == 3, "value_type& array::operator()(int, int, int) is "
                              "only permissible on array<T, 3>");
    return this->operator[](index<3>(_I0, _I1, _I2));
  }
  ...
  /// </returns>
  const _Value_type &operator()(int _I0, int _I1, int _I2) const __GPU {
    static_assert(_Rank == 3, "const value_type& array::operator()(int, int, "
                              "int) const is only permissible on array<T, 3>");
    return this->operator[](index<3>(_I0, _I1, _I2));
  }
  ...
  /// <summary>
  ///     Produces a subsection of the source array at the given origin and
  ///     extent.
  /// </summary>
  /// <param name="_Section_origin">
  ///     The origin of the section.
  ...
  ///     A subsection of the array.
  /// </returns>
  array_view<const _Value_type, _Rank>
  section(const Concurrency::index<_Rank> &_Section_origin,
          const Concurrency::extent<_Rank> &_Section_extent) const __GPU {
  ...
  /// </returns>
  array_view<_Value_type, _Rank>
  section(const Concurrency::extent<_Rank> &_Ext) __GPU {
    return section(Concurrency::index<_Rank>(), _Ext);
  }
  ...
  /// </returns>
  array_view<const _Value_type, _Rank>
  section(const Concurrency::extent<_Rank> &_Ext) const __GPU {
    return section(Concurrency::index<_Rank>(), _Ext);
  }

  /// <summary>
  ///     Produces a subsection of the source array with origin specified by an
  ///     index, with an extent of (this-&gt;extent - _Idx).
  /// </summary>
  /// <param name="_Idx">
  ///     The index that specifies the origin of this section.
  /// </param>
  ...
  /// </returns>
  array_view<const _Value_type, _Rank>
  section(const index<_Rank> &_Idx) const __GPU {
    array_view<const _Value_type, _Rank> _T1(*this);
    return _T1.section(_Idx);
  }

  /// <summary>
  ///     Produces a one-dimensional subsection of the source array with origin
  ///     specified by the index components _I0, with extent _E0.
  /// </summary>
  /// <param name="_I0">
  ///     The origin of this section.
  /// </param>
  ...
  /// <summary>
  ///     Produces a two-dimensional subsection of the source array with origin
  ///     specified by the index components (_I0,_I1), with extent (_E0,_E1).
  /// </summary>
  /// <param name="_I0">
  ///     The most-significant component of the origin of this section.
  /// </param>
  ...
  ///     A subsection of the array.
  /// </returns>
  array_view<const _Value_type, 2> section(int _I0, int _I1, int _E0,
                                           int _E1) const __GPU {
    array_view<const _Value_type, _Rank> _T1(*this);
    return _T1.section(_I0, _I1, _E0, _E1);
  }
  ...
  /// <summary>
  ///     Produces a three-dimensional subsection of the source array with
  ///     origin specified by the index components (_I0,_I1,_I2), with extent
  ///     (_E0,_E1,_E2).
  /// </summary>
  /// <param name="_I0">
  ...
  ///     A subsection of the array.
  /// </returns>
  array_view<_Value_type, 3> section(int _I0, int _I1, int _I2, int _E0,
                                     int _E1, int _E2) __GPU {
    array_view<_Value_type, _Rank> _T1(*this);
  ...
  ///     A subsection of the array.
  /// </returns>
  array_view<const _Value_type, 3> section(int _I0, int _I1, int _I2, int _E0,
                                           int _E1, int _E2) const __GPU {
    array_view<const _Value_type, _Rank> _T1(*this);
    return _T1.section(_I0, _I1, _I2, _E0, _E1, _E2);
  }

  /// <summary>
  ///     Produces a (possibly unsafe) reinterpretation of this array that is
  ///     linear and with a different element type.
  /// </summary>
  /// <returns>
  ///     A linear array_view with a reinterpreted element type.
  /// </returns>
  ...
  array_view<_Value_type2, 1> reinterpret_as() __GPU {
    return array_view<_Value_type, 1>(_M_buffer_descriptor,
                                      Concurrency::extent<1>(extent.size()))
        .template reinterpret_as<_Value_type2>();
  }
...
#pragma warning(pop)
  ...
  template <int _New_rank>
  array_view<_Value_type, _New_rank>
  view_as(const Concurrency::extent<_New_rank> &_View_extent) __GPU {
    return array_view<_Value_type, _New_rank>(_M_buffer_descriptor,
                                              _View_extent);
  }
...
#pragma warning(disable : 4880)
    ...
    const_cast<array *>(this)->_Refresh_data_ptr(_Read_access,
                                                 false /* _Exception */);
#pragma warning(pop)
    return reinterpret_cast<const _Value_type *>(
...
private:
  ...
  unsigned int _Initialize() __CPU_ONLY {
    ...
    // This is the mechanism for differentiating between arrays and array_views
    // by the runtime
    _M_buffer_descriptor._M_type_access_mode = _Is_array_mode;
    unsigned int totalExtent = _M_extent[_Rank - 1];
    details::_Array_init_helper<Concurrency::extent<_Rank>,
                                Concurrency::extent<_Rank>>::func(totalExtent,
                                                                  _M_multiplier,
                                                                  _M_extent);
  ...
  void _Initialize(Concurrency::accelerator_view _Av,
                   access_type _Cpu_access_type) __CPU_ONLY {
    ...
    _Buffer_ptr _PBuf =
        _Buffer::_Create_buffer(_Av, _Av, totalExtent, sizeof(_Value_type),
                                false /* _Is_temp */, _Cpu_access_type);

    _M_buffer_descriptor._Set_buffer_ptr(
        _Ubiquitous_buffer::_Create_ubiquitous_buffer(_PBuf));
    _Register();
  }

  // Initialize and allocate on specified accelerator_view and copy specified
  // data
  template <typename _InputIterator>
  void _Initialize(Concurrency::accelerator_view _Av, _InputIterator _Src_first,
  ...
  void _Initialize(Concurrency::accelerator_view _Av,
    ...
    // Staging arrays can only be created if the accelerator_view is on the
    // cpu_accelerator
    ...
    if (_Is_cpu_accelerator(_Av.accelerator)) {
      // If the accelerator _Associated_Av supports zero-copy and the default
      // cpu access type for the accelerator is access_type_read_write, create a
      // zero-copy buffer instead of a staging buffer
      if (_Associated_Av.accelerator.supports_cpu_shared_memory &&
          (_Get_recommended_buffer_host_access_mode(_Associated_Av) ==
           _Read_write_access)) {
        _PBuf = _Buffer::_Create_buffer(
            _Associated_Av, _Av, totalExtent, sizeof(_Value_type),
            false /* _Is_temp */, access_type_read_write);
      } else {
        _PBuf = _Buffer::_Create_stage_buffer(_Associated_Av, _Av, totalExtent,
                                              sizeof(_Value_type));
      }
      ...
      _PBuf =
          _Buffer::_Create_buffer(_Av, _Av, totalExtent, sizeof(_Value_type),
                                  false /* _Is_temp */, access_type_auto);
    }
  ...
  void _Register() __CPU_ONLY {
    Concurrency::accelerator_view cpuAv =
        _Is_cpu_accelerator(this->accelerator_view.accelerator)
            ? this->accelerator_view
            : accelerator(accelerator::cpu_accelerator).default_view;
    _M_buffer_descriptor._Get_buffer_ptr()->_Register_view(
        _M_buffer_descriptor._Get_view_key(), cpuAv,
        _Create_buffer_view_shape());

    _M_buffer_descriptor._Get_buffer_ptr()->_Discard(
        _M_buffer_descriptor._Get_view_key());

    // If the array is on the CPU accelerator then we will ensure that the
    // descriptor indicates CPU access
  ...
  void _Unregister() __CPU_ONLY {
    // No need to unregister if the array was moved causing the buffer ptr to be
    // set to NULL
  ...
  _Event
  _Get_access_async(_Access_mode _Mode, _Buffer_ptr &_Buf_ptr,
                    bool _Zero_copy_cpu_access = false) const __CPU_ONLY {
    _ASSERTE(
        !_Zero_copy_cpu_access ||
        (_Get_buffer()->_Get_master_buffer()->_Get_allowed_host_access_mode() !=
         _No_access));

    _Buffer_ptr _PBuf;
    Concurrency::accelerator_view _Access_av =
        _Zero_copy_cpu_access
            ? accelerator(accelerator::cpu_accelerator).default_view
            : this->accelerator_view;
    _Event _Ev = details::_Get_access_async(
        _M_buffer_descriptor._Get_view_key(), _Access_av, _Mode, _PBuf);
    _Buf_ptr = _PBuf;

    if (_Is_cpu_accelerator(_Access_av.accelerator)) {
      _Ev = _Ev._Add_continuation(
          std::function<_Event()>([_PBuf, this]() mutable -> _Event {
            const_cast<array *>(this)->_M_buffer_descriptor._M_data_ptr =
                _PBuf->_Get_host_ptr();
            return _Event();
          }));
    }
  ...
  _Ret_ _View_shape *_Create_buffer_view_shape() const {
    _ASSERTE(_Get_buffer()->_Get_master_buffer_elem_size() ==
             sizeof(_Value_type));
    ...
    return _View_shape::_Create_view_shape(static_cast<unsigned int>(_Rank), 0,
                                           &_View_extent[0], &_ZeroOffset[0],
                                           &_View_extent[0]);
  }
  ...
  void _Refresh_data_ptr(_Access_mode _Requested_mode,
                         bool _Exception = true) __CPU_ONLY {
    _ASSERTE(_Is_valid_access_mode(_Requested_mode));

    // For an array that has CPU access, the maximum CPU access allowed is that
    // allowed by the underlying _Buffer allocation
    _Requested_mode = static_cast<_Access_mode>(
        _Requested_mode &
        _Get_buffer()->_Get_master_buffer()->_Get_allowed_host_access_mode());

    // Refresh the data ptr if we do not have requested access
    if ((_Requested_mode == _No_access) ||
        ((_M_buffer_descriptor._M_curr_cpu_access_mode & _Requested_mode) !=
         _Requested_mode)) {
      if (_Has_cpu_access() && (_Requested_mode != _No_access)) {
        auto _Span_id = details::_Get_amp_trace()
                            ->_Start_array_view_synchronize_event_helper(
                                _M_buffer_descriptor);
        _Buffer_ptr _PBuf;
        bool _Zero_copy_cpu_access =
            !_Is_cpu_accelerator(this->accelerator_view.accelerator);
        this->_Get_access_async(_Requested_mode, _PBuf, _Zero_copy_cpu_access)
            ._Get();
        details::_Get_amp_trace()->_Write_end_event(_Span_id);
      } else {
        if (_Exception) {
          if (!_Has_cpu_access()) {
            throw runtime_exception("The array is not accessible on CPU.",
                                    E_FAIL);
          } else {
            throw runtime_exception(
  ...
  void _Refresh_data_ptr(_Access_mode /*_Requested_mode*/,
                         bool /*_Exception*/ = true) __GPU_ONLY {}
...
namespace details {
template <typename _Value_type, int _Rank>
_Event _Copy_async_impl(const array<_Value_type, _Rank> &_Src,
                        array<_Value_type, _Rank> &_Dest) {
  if (_Src.extent.size() > _Dest.extent.size()) {
    throw runtime_exception(
        "Invalid _Src argument. _Src size exceeds total size of the _Dest.",
        E_INVALIDARG);
  }

  // We can obliterate the existing content of dest if it is about to be totally
  // overwritten
  _Access_mode _Dest_access_mode = (_Src.extent.size() == _Dest.extent.size())
                                       ? _Write_access
                                       : _Read_write_access;
  ...
  size_t _NumElemsToCopy =
      (_Src.extent.size() * sizeof(_Value_type)) / _PBufSrc->_Get_elem_size();
  return _Ev._Add_continuation(std::function<_Event()>(
      [_PBufSrc, _PBufDest, _NumElemsToCopy]() mutable -> _Event {
        return details::_Copy_impl(_PBufSrc, 0, _PBufDest, 0, _NumElemsToCopy);
      }));
}

template <typename InputIterator, typename _Value_type, int _Rank>
_Event _Copy_async_impl(InputIterator _SrcFirst, InputIterator _SrcLast,
                        array<_Value_type, _Rank> &_Dest) {
  size_t _NumElemsToCopy = std::distance(_SrcFirst, _SrcLast);
  // We can obliterate the existing content of dest if it is about to be totally
  // overwritten
  _Access_mode _Dest_access_mode = (_NumElemsToCopy == _Dest.extent.size())
                                       ? _Write_access
                                       : _Read_write_access;
  ...
  return _Ev._Add_continuation(std::function<_Event()>(
      [_SrcFirst, _SrcLast, _PDestBuf, _NumElemsToCopy]() mutable -> _Event {
        return details::_Copy_impl<InputIterator, _Value_type>(
            _SrcFirst, _SrcLast, _NumElemsToCopy, _PDestBuf, 0);
      }));
}
...
_Event _Copy_async_impl(const array<_Value_type, _Rank> &_Src,
  ...
  size_t _NumElemsToCopy =
      (_Src.extent.size() * sizeof(_Value_type)) / _PSrcBuf->_Get_elem_size();
  return _Ev._Add_continuation(std::function<_Event()>(
      [_PSrcBuf, _NumElemsToCopy, _DestIter]() mutable -> _Event {
        return details::_Copy_impl<OutputIterator, _Value_type>(
            _PSrcBuf, 0, _NumElemsToCopy, _DestIter);
      }));
}
...
_Event _Copy_async_impl(const array<_Value_type, _Rank> &_Src,
  ...
  if (_SrcBufDesc._Get_buffer_ptr() == _DestBufDesc._Get_buffer_ptr()) {
    throw runtime_exception(
        "Cannot copy between overlapping regions of the same buffer.",
        E_INVALIDARG);
  }
  ...
  _Ev = _Ev._Add_event(_Get_access_async(_DestBufDesc._Get_view_key(),
                                         _AccelInfo.second, _Write_access,
                                         _PDestBuf));
  ...
  return _Ev._Add_continuation(std::function<_Event()>(
      [_PSrcBuf, _PSrcShape, _PDestBuf, _PDestShape]() mutable -> _Event {
        return details::_Copy_impl(_PSrcBuf, _PSrcShape, _PDestBuf,
                                   _PDestShape);
      }));
}

template <typename _Value_type, int _Rank>
_Event _Copy_async_impl(const array_view<const _Value_type, _Rank> &_Src,
                        array<_Value_type, _Rank> &_Dest) {
  const _Buffer_descriptor &_SrcBufDesc = _Get_buffer_descriptor(_Src);
  const _Buffer_descriptor &_DestBufDesc = _Get_buffer_descriptor(_Dest);
  if (_SrcBufDesc._Get_buffer_ptr() == _DestBufDesc._Get_buffer_ptr()) {
  ...
  _Buffer_ptr _PSrcBuf, _PDestBuf;
  _Event _Ev = _Get_access_async(_SrcBufDesc._Get_view_key(), _AccelInfo.first,
                                 _Read_access, _PSrcBuf);
...
_Event _Copy_async_impl(const array_view<const _Value_type, _Rank> &_Src,
  ...
  _View_shape_ptr _PDestShape = _Get_buffer_view_shape(_DestBufDesc);
  if ((_SrcBufDesc._Get_buffer_ptr() == _DestBufDesc._Get_buffer_ptr()) &&
      _PSrcShape->_Overlaps(_PDestShape)) {
    throw runtime_exception(
        "Cannot copy between overlapping regions of the same buffer.",
        E_INVALIDARG);
  }
...
_Event _Copy_async_impl(InputIterator _SrcFirst, InputIterator _SrcLast,
  ...
  if (_Src_size > _Dest.extent.size()) {
    throw runtime_exception("Number of elements in range between [_SrcFirst, "
                            "_SrcLast) exceeds total size of the _Dest.",
                            E_INVALIDARG);
  }

#pragma warning(push)
#pragma warning(                                                               \
    disable : 4127) // Disable warning about constant conditional expression
  // Higher ranks need to have as many elements as in _Dest array_view
  if ((_Rank > 1) && (_Src_size != _Dest.extent.size())) {
    throw runtime_exception(
        "For _Rank > 1 the number of elements in range between [_SrcFirst, "
        "_SrcLast) has to be equal to total size of the _Dest.",
        E_INVALIDARG);
  }
#pragma warning(pop)
  ...
  // We can obliterate the existing content of dest if it is about to be totally
  // overwritten
  _Access_mode _Dest_access_mode =
      (_Src_size == _Dest.extent.size()) ? _Write_access : _Read_write_access;

  // Get read-write access for array_view on cpu_accelerator and take underlying
  // pointer to data
  const _Buffer_descriptor &_DestBufDesc = _Get_buffer_descriptor(_Dest);
  ...
  _Buffer_ptr _PDestBuf;
  _Event _Ev =
      _Get_access_async(_DestBufDesc._Get_view_key(), _AccelInfo.second,
                        _Dest_access_mode, _PDestBuf);
  ...
  if (_Dst_shape->_Is_view_linear(_Dst_linear_offset, _Dst_linear_size)) {
    _Ev = _Ev._Add_continuation(
        std::function<_Event()>([_PDestBuf, _SrcFirst, _SrcLast, _Src_size,
                                 _Dst_linear_offset]() mutable -> _Event {
          return details::_Copy_impl<InputIterator, _Value_type>(
              _SrcFirst, _SrcLast, _Src_size, _PDestBuf, _Dst_linear_offset);
        }));
  } else {
    _View_shape_ptr _Reinterpreted_dst_shape = _Create_reinterpreted_shape(
        _Dst_shape, _PDestBuf->_Get_elem_size(), sizeof(_Value_type));

    // Source has as many elements as in destination, reshape source to match
    // destination shape
    std::vector<unsigned int> _Src_offset(_Reinterpreted_dst_shape->_Get_rank(),
                                          0);
    _View_shape_ptr _Src_shape = details::_View_shape::_Create_view_shape(
        _Reinterpreted_dst_shape->_Get_rank(), 0 /* linear offset*/,
        _Reinterpreted_dst_shape->_Get_view_extent(), _Src_offset.data(),
        _Reinterpreted_dst_shape->_Get_view_extent());

    _Ev = _Ev._Add_continuation(std::function<_Event()>(
        [_PDestBuf, _SrcFirst, _Src_shape, _Dst_shape]() mutable -> _Event {
          return details::_Copy_impl<InputIterator, _Value_type>(
              _SrcFirst, _Src_shape, _PDestBuf, _Dst_shape);
        }));
  }
...
template <typename OutputIterator, typename _Value_type, int _Rank>
_Event _Copy_async_impl(const array_view<_Value_type, _Rank> &_Src,
                        OutputIterator _DestIter) {
  // Caller is responsible for passing valid _DestIter

  // Get read access for array_view on cpu_accelerator and take underlying
  // pointer to data
  const _Buffer_descriptor &_SrcBufDesc = _Get_buffer_descriptor(_Src);
  ...
  if (_Src_shape->_Is_view_linear(_Src_linear_offset, _Src_linear_size)) {
    _Ev = _Ev._Add_continuation(
        std::function<_Event()>([_PSrcBuf, _Src_linear_offset, _Src_linear_size,
                                 _DestIter]() mutable -> _Event {
          return details::_Copy_impl<OutputIterator, _Value_type>(
              _PSrcBuf, _Src_linear_offset, _Src_linear_size, _DestIter);
        }));
  } else {
    _View_shape_ptr _Reinterpreted_src_shape = _Create_reinterpreted_shape(
        _Src_shape, _PSrcBuf->_Get_elem_size(), sizeof(_Value_type));

    // Valid destination should have space for as many elements as in source
    // array_view, reshape to match source view shape
    std::vector<unsigned int> _Dst_offset(_Reinterpreted_src_shape->_Get_rank(),
                                          0);
    _View_shape_ptr _Dst_shape = details::_View_shape::_Create_view_shape(
        _Reinterpreted_src_shape->_Get_rank(), 0 /* linear offset*/,
        _Reinterpreted_src_shape->_Get_view_extent(), _Dst_offset.data(),
        _Reinterpreted_src_shape->_Get_view_extent());

    _Ev = _Ev._Add_continuation(std::function<_Event()>(
        [_PSrcBuf, _Src_shape, _DestIter, _Dst_shape]() mutable -> _Event {
          return details::_Copy_impl<OutputIterator, _Value_type>(
              _PSrcBuf, _Src_shape, _DestIter, _Dst_shape);
        }));
  }
...
/// <summary>
///     Asynchronously copies the contents of the source array into the
///     destination array.
/// </summary>
/// <param name="_Src">
///     The source array.
...
concurrency::completion_future copy_async(const array<_Value_type, _Rank> &_Src,
                                          array<_Value_type, _Rank> &_Dest) {
  auto _Async_op_id =
      details::_Get_amp_trace()->_Launch_async_copy_event_helper(
          details::_Get_buffer_descriptor(_Src),
...
void copy(const array<_Value_type, _Rank> &_Src,
          array<_Value_type, _Rank> &_Dest) {
  auto _Span_id = details::_Get_amp_trace()->_Start_copy_event_helper(
      details::_Get_buffer_descriptor(_Src),
      details::_Get_buffer_descriptor(_Dest),
      sizeof(_Value_type) * _Src.extent.size());
...
/// <summary>
///     Asynchronously copies the elements in the range [_SrcFirst, _SrcLast)
...
concurrency::completion_future copy_async(InputIterator _SrcFirst,
  ...
  auto _Async_op_id =
      details::_Get_amp_trace()->_Launch_async_copy_event_helper(
          nullptr, details::_Get_buffer_descriptor(_Dest),
...
/// <summary>
///     Copies the elements in the range [_SrcFirst, _SrcLast) into the
///     destination array.
/// </summary>
/// <param name="_SrcFirst">
///     A beginning iterator into the source container.
...
/// <summary>
///     Asynchronously copies the elements beginning at _SrcFirst into the
///     destination array.
/// </summary>
/// <param name="_SrcFirst">
///     A beginning iterator into the source container; if the number of
...
/// <summary>
///     Asynchronously copies the contents of the array into the destination
///     beginning at _DestIter.
/// </summary>
/// <param name="_Src">
///     The source array.
/// </param>
...
concurrency::completion_future copy_async(const array<_Value_type, _Rank> &_Src,
  ...
  auto _Async_op_id =
      details::_Get_amp_trace()->_Launch_async_copy_event_helper(
          details::_Get_buffer_descriptor(_Src), nullptr,
          sizeof(_Value_type) * _Src.extent.size());
...
/// <summary>
///     Copies the contents of the array into the destination beginning at
///     _DestIter.
/// </summary>
/// <param name="_Src">
///     The source array.
...
/// <summary>
///     Asynchronously copies the contents of the source array_view into the
///     destination array.
/// </summary>
/// <param name="_Src">
...
copy_async(const array_view<_Value_type, _Rank> &_Src,
           array<_Value_type, _Rank> &_Dest) {
  return copy_async<_Value_type, _Rank>(
      array_view<const _Value_type, _Rank>(_Src), _Dest);
}
...
/// <summary>
///     Copies the contents of the source array_view into the destination
///     array_view.
/// </summary>
/// <param name="_Src">
///     The source array_view.
...
/// <summary>
///     Asynchronously copies the elements in the range [_SrcFirst, _SrcLast)
///     into the destination array_view.
/// </summary>
/// <param name="_SrcFirst">
///     A beginning iterator into the source container.
/// </param>
...
/// <summary>
///     Asynchronously copies the contents of the array_view into the
///     destination beginning at _DestIter.
/// </summary>
/// <param name="_Src">
///     The source array_view.
/// </param>
...
/// <summary>
///     Copies the contents of the array_view into the destination beginning at
///     _DestIter.
/// </summary>
/// <param name="_Src">
///     The source array_view.
...
/// </param>
/// <param name="_Array">
///     A array on a D3D accelerator_view for which the underlying D3D buffer
///     interface is returned.
/// </param>
/// <returns>
///     The IUnknown interface pointer corresponding to the D3D buffer
///     underlying the array.
/// </returns>
template <typename _Value_type, int _Rank>
...
array<_Value_type, _Rank> make_array(const Concurrency::extent<_Rank> &_Extent,
  ...
  _Ubiquitous_buffer_ptr _PBuf =
      _Ubiquitous_buffer::_Create_ubiquitous_buffer(_Buffer::_Create_buffer(
          _D3D_buffer, _Av, _Extent.size(), sizeof(_Value_type)));
  return array<_Value_type, _Rank>(
      _Extent, _Buffer_descriptor(_PBuf->_Get_master_buffer()->_Get_host_ptr(),
                                  _PBuf, _Is_array_mode, _Read_write_access));
}
...
/// <summary>
///     Performs an atomic addition of _Value to the memory location pointed to
///     by _Dest
/// </summary>
/// <param name="_Dest">
...
///     The original value of the location pointed to by _Dest
/// </returns>
inline unsigned int atomic_fetch_add(_Inout_ unsigned int *_Dest,
                                     unsigned int _Value) __GPU_ONLY {
  return __dp_d3d_interlocked_add(_Dest, _Value);
}

/// <summary>
///     Performs an atomic subtraction of _Value from the memory location
///     pointed to by _Dest
/// </summary>
/// <param name="_Dest">
///     Pointer to the destination location
...
inline unsigned int atomic_fetch_sub(_Inout_ unsigned int *_Dest,
                                     unsigned int _Value) __GPU_ONLY {
#pragma warning(push)
...
/// <summary>
///     Sets the value of location pointed to by _Dest to _Value as an atomic
///     operation
/// </summary>
/// <param name="_Dest">
///     Pointer to the destination location
...
inline int atomic_exchange(_Inout_ int *_Dest, int _Value) __GPU_ONLY {
  unsigned int _Ret =
      __dp_d3d_interlocked_exchange(AS_UINT_PTR(_Dest), AS_UINT(_Value));
  return AS_INT(_Ret);
}
...
///     The original value of the location pointed to by _Dest
/// </returns>
inline unsigned int atomic_exchange(_Inout_ unsigned int *_Dest,
                                    unsigned int _Value) __GPU_ONLY {
...
/// <summary>
///     Atomically, compares the value pointed to by _Dest for equality with
///     that pointed to by _Expected_value, and if true, returns true and
///     replaces the value with _Value, and if false, returns false and updates
///     the value pointed to by _Expected_value with the value pointed to by
///     _Dest
/// </summary>
/// <param name="_Dest">
///     Pointer to the destination location
...
///     Pointer to the value being compared to the value pointed to by _Dest. If
///     the comparison is unsuccessful, the value is updated with the value
///     pointed to by _Dest
/// </param>
/// <param name="_Value">
///     The value to be stored to the location pointed to by _Dest if the
///     comparison is successful
/// </param>
/// <returns>
///     If the operation is successful, return true. Otherwise, false
/// </returns>
inline bool atomic_compare_exchange(_Inout_ int *_Dest,
                                    _Inout_ int *_Expected_value,
                                    int _Value) __GPU_ONLY {
  int _Old = *_Expected_value;
  unsigned int _Ret = __dp_d3d_interlocked_compare_exchange(
      AS_UINT_PTR(_Dest), AS_UINT(_Value), AS_UINT(_Old));
...
///     If the operation is successful, return true. Otherwise, false
/// </returns>
inline bool atomic_compare_exchange(_Inout_ unsigned int *_Dest,
                                    _Inout_ unsigned int *_Expected_value,
                                    unsigned int _Value) __GPU_ONLY {
  unsigned int _Old = *_Expected_value;
  unsigned int _Ret =
      __dp_d3d_interlocked_compare_exchange(_Dest, _Value, _Old);
  if (_Ret == _Old) {
    return true;
  } else {
...
/// <summary>
///     Atomically computes the maximum of _Value and the value of the memory
///     location pointed to by _Dest, and stores the maximum value to the memory
///     location
/// </summary>
/// <param name="_Dest">
///     Pointer to the destination location
...
///     The original value of the location pointed to by _Dest
/// </returns>
inline unsigned int atomic_fetch_max(_Inout_ unsigned int *_Dest,
                                     unsigned int _Value) __GPU_ONLY {
  return __dp_d3d_interlocked_max_uint(_Dest, _Value);
}

/// <summary>
///     Atomically computes the minimum of _Value and the value of the memory
///     location pointed to by _Dest, and stores the minimum value to the memory
///     location
/// </summary>
/// <param name="_Dest">
///     Pointer to the destination location
...
///     The original value of the location pointed to by _Dest
/// </returns>
inline unsigned int atomic_fetch_min(_Inout_ unsigned int *_Dest,
                                     unsigned int _Value) __GPU_ONLY {
  return __dp_d3d_interlocked_min_uint(_Dest, _Value);
}

/// <summary>
///     Performs an atomic bitwise and operation of _Value to the memory
///     location pointed to by _Dest
/// </summary>
/// <param name="_Dest">
///     Pointer to the destination location
/// </param>
...
///     The original value of the location pointed to by _Dest
/// </returns>
inline unsigned int atomic_fetch_and(_Inout_ unsigned int *_Dest,
                                     unsigned int _Value) __GPU_ONLY {
  return __dp_d3d_interlocked_and(_Dest, _Value);
}

/// <summary>
///     Performs an atomic bitwise or operation of _Value to the memory location
///     pointed to by _Dest
/// </summary>
/// <param name="_Dest">
///     Pointer to the destination location
...
///     The original value of the location pointed to by _Dest
/// </returns>
inline unsigned int atomic_fetch_or(_Inout_ unsigned int *_Dest,
                                    unsigned int _Value) __GPU_ONLY {
  return __dp_d3d_interlocked_or(_Dest, _Value);
}

/// <summary>
///     Performs an atomic bitwise xor operation of _Value to the memory
///     location pointed to by _Dest
/// </summary>
/// <param name="_Dest">
///     Pointer to the destination location
...
///     The original value of the location pointed to by _Dest
/// </returns>
inline unsigned int atomic_fetch_xor(_Inout_ unsigned int *_Dest,
                                     unsigned int _Value) __GPU_ONLY {
...
/// <summary>
///     Invokes a parallel computation of a kernel function over a compute
///     domain on an accelerator_view. The accelerator_view is determined from
///     the arrays and/or array_views captured by the kernel function, or if no
///     accelerator_view can be derived, the default is chosen.
/// </summary>
/// <param name="_Compute_domain">
///     An extent which represents the set of indices that form the compute
///     domain.
/// </param>
/// <param name="_Kernel">
///     A function object that takes an argument of type "index&lt;_Rank&gt;"
///     which performs the parallel computation.
/// </param>
template <int _Rank, typename _Kernel_type>
void parallel_for_each(const extent<_Rank> &_Compute_domain,
                       const _Kernel_type &_Kernel) {
  _Host_Scheduling_info _SchedulingInfo = {
...
/// <summary>
///     Invokes a parallel computation of a kernel function over a compute
///     domain that has been tiled into 3-dimensional regions.  The accelerator
///     is determined from the arrays and/or array_views captured by the kernel
///     function, or if no accelerator can be derived, the default is chosen.
/// </summary>
/// <param name="_Compute_domain">
///     A tiled_extent&lt;_Dim0,_Dim1,_Dim2&gt; which represents the tiled set
///     of indices that form the compute domain.
/// </param>
/// <param name="_Kernel">
///     A function object that takes an argument of type
///     "tiled_index&lt;_Dim0,_Dim1,_Dim2&gt;" which performs the parallel
///     computation.
/// </param>
template <int _Dim0, int _Dim1, int _Dim2, typename _Kernel_type>
void parallel_for_each(const tiled_extent<_Dim0, _Dim1, _Dim2> &_Compute_domain,
                       const _Kernel_type &_Kernel) {
  _Host_Scheduling_info _SchedulingInfo = {
      accelerator::get_auto_selection_view()};
  details::_Parallel_for_each(&_SchedulingInfo, _Compute_domain, _Kernel);
...
/// <summary>
///     Invokes a parallel computation of a kernel function over a compute
///     domain that has been tiled into 2-dimensional regions.  The accelerator
///     is determined from the arrays and/or array_views captured by the kernel
///     function, or if no accelerator can be derived, the default is chosen.
/// </summary>
/// <param name="_Compute_domain">
///     A tiled_extent&lt;_Dim0,_Dim1&gt; which represents the tiled set of
///     indices that form the compute domain.
/// </param>
/// <param name="_Kernel">
///     A function object that takes an argument of type
///     "tiled_index&lt;_Dim0,_Dim1&gt;" which performs the parallel
///     computation.
/// </param>
template <int _Dim0, int _Dim1, typename _Kernel_type>
void parallel_for_each(const tiled_extent<_Dim0, _Dim1> &_Compute_domain,
                       const _Kernel_type &_Kernel) {
  _Host_Scheduling_info _SchedulingInfo = {
      accelerator::get_auto_selection_view()};
  details::_Parallel_for_each(&_SchedulingInfo, _Compute_domain, _Kernel);
...
/// <summary>
///     Invokes a parallel computation of a kernel function over a compute
///     domain that has been tiled into 1-dimensional regions.  The accelerator
///     is determined from the arrays and/or array_views captured by the kernel
///     function, or if no accelerator can be derived, the default is chosen.
/// </summary>
/// <param name="_Compute_domain">
///     A tiled_extent&lt;_Dim0&gt; which represents the tiled set of indices
///     that form the compute domain.
/// </param>
/// <param name="_Kernel">
///     A function object that takes an argument of type
///     "tiled_index&lt;_Dim0&gt;" which performs the parallel computation.
/// </param>
template <int _Dim0, typename _Kernel_type>
void parallel_for_each(const tiled_extent<_Dim0> &_Compute_domain,
                       const _Kernel_type &_Kernel) {
  _Host_Scheduling_info _SchedulingInfo = {
      accelerator::get_auto_selection_view()};
  details::_Parallel_for_each(&_SchedulingInfo, _Compute_domain, _Kernel);
...
/// </param>
template <int _Rank, typename _Kernel_type>
void parallel_for_each(const accelerator_view &_Accl_view,
...
/// <summary>
///     Invokes a parallel computation of a kernel function over a compute
///     domain that has been tiled into 3-dimensional regions.
/// </summary>
/// <param name="_Accl_view">
///     The accelerator_view upon which to run this parallel computation.
/// </param>
...
/// <summary>
///     Invokes a parallel computation of a kernel function over a compute
///     domain that has been tiled into 2-dimensional regions.
/// </summary>
/// <param name="_Accl_view">
///     The accelerator_view upon which to run this parallel computation.
/// </param>
...
/// <summary>
///     Invokes a parallel computation of a kernel function over a compute
///     domain that has been tiled into 1-dimensional regions.
/// </summary>
/// <param name="_Accl_view">
///     The accelerator_view upon which to run this parallel computation.
/// </param>
...
/// <summary>
///     Ensures that memory accesses are visible to other threads in the thread
///     tile, and are executed according to program order
/// </summary>
/// <param name="_Barrier">
...
/// <summary>
///     Ensures that global memory accesses are visible to other threads in the
///     thread tile, and are executed according to program order
/// </summary>
/// <param name="_Barrier">
///     A tile_barrier object
/// </param>
...
/// <summary>
///     Ensures that tile_static memory accesses are visible to other threads in
///     the thread tile, and are executed according to program order
/// </summary>
/// <param name="_Barrier">
///     A tile_barrier object
/// </param>
...
///     Returns the absolute value of the argument
/// </returns>
inline int abs(int _X) __GPU_ONLY { return __dp_d3d_absi(_X); }
...
/// <summary>
///     Gets the location of the first set bit in _X, starting from the highest
///     order bit and working downward
/// </summary>
/// <param name="_X">
///     Integer value
/// </param>
...
/// <summary>
///     Gets the location of the first set bit in _X, starting from the lowest
///     order bit and working upward
/// </summary>
/// <param name="_X">
///     Integer value
/// </param>
...
///     Returns The location of the first set bit
/// </returns>
inline int firstbitlow(int _X) __GPU_ONLY { return __dp_d3d_firstbitlowi(_X); }
...
/// </returns>
inline int imax(int _X, int _Y) __GPU_ONLY { return __dp_d3d_maxi(_X, _Y); }
...
/// </returns>
inline int imin(int _X, int _Y) __GPU_ONLY { return __dp_d3d_mini(_X, _Y); }
...
/// <summary>
///     Performs an arithmetic multiply/add operation on three arguments: _X *
///     _Y + _Z
/// </summary>
/// <param name="_X">
///     Floating-point value
...
///     Returns _X * _Y + _Z
/// </returns>
inline unsigned int mad(unsigned int _X, unsigned int _Y,
...
/// </returns>
inline float noise(float _X) __GPU_ONLY { return __dp_d3d_noisef(_X); }
...
/// </returns>
inline float radians(float _X) __GPU_ONLY { return __dp_d3d_radiansf(_X); }
...
/// </returns>
inline float rcp(float _X) __GPU_ONLY { return __dp_d3d_rcpf(_X); }
...
/// </returns>
inline float saturate(float _X) __GPU_ONLY { return __dp_d3d_saturatef(_X); }
...
///     Returns the sign of the argument
/// </returns>
inline int sign(int _X) __GPU_ONLY { return __dp_d3d_signi(_X); }

/// <summary>
///     Returns a smooth Hermite interpolation between 0 and 1, if _X is in the
///     range [_Min, _Max].
/// </summary>
/// <param name="_X">
///     Floating-point value
...
/// </param>
/// <returns>
///     Returns 0 if _X is less than _Min; 1 if _X is greater than _Max;
///     otherwise, a value between 0 and 1 if _X is in the range [_Min, _Max]
/// </returns>
