...
public:
  ...
  I64vec1 &operator&=(const M64 &_A) {
    return *this = (I64vec1)_m_pand(vec, _A);
  }
  I64vec1 &operator|=(const M64 &_A) {
    return *this = (I64vec1)_m_por(vec, _A);
  }
  I64vec1 &operator^=(const M64 &_A) {
    return *this = (I64vec1)_m_pxor(vec, _A);
  }
  ...
  I64vec1 &operator<<=(const M64 &_A) {
    return *this = (I64vec1)_m_psllq(vec, _A);
  }
  I64vec1 &operator<<=(int _Count) {
    return *this = (I64vec1)_m_psllqi(vec, _Count);
  }
  I64vec1 operator>>(const M64 &_A) { return _m_psrlq(vec, _A); }
  I64vec1 operator>>(int _Count) { return _m_psrlqi(vec, _Count); }
  I64vec1 &operator>>=(const M64 &_A) {
    return *this = (I64vec1)_m_psrlq(vec, _A);
  }
  I64vec1 &operator>>=(int _Count) {
    return *this = (I64vec1)_m_psrlqi(vec, _Count);
  }
};
...
public:
  ...
  I32vec2 &operator&=(const M64 &_A) {
    return *this = (I32vec2)_m_pand(vec, _A);
  }
  I32vec2 &operator|=(const M64 &_A) {
    return *this = (I32vec2)_m_por(vec, _A);
  }
  I32vec2 &operator^=(const M64 &_A) {
    return *this = (I32vec2)_m_pxor(vec, _A);
  }

  /* Addition & Subtraction Assignment Operators */
  I32vec2 &operator+=(const I32vec2 &_A) {
    return *this = (I32vec2)_m_paddd(vec, _A);
  }
  I32vec2 &operator-=(const I32vec2 &_A) {
    return *this = (I32vec2)_m_psubd(vec, _A);
  }
  ...
  I32vec2 &operator<<=(const I32vec2 &_A) {
    return *this = (I32vec2)_m_pslld(vec, _A);
  }
  I32vec2 &operator<<=(int _Count) {
    return *this = (I32vec2)_m_pslldi(vec, _Count);
  }
};

/* Compare For Equality */
inline I32vec2 cmpeq(const I32vec2 &_A, const I32vec2 &_B) {
  return _m_pcmpeqd(_A, _B);
}
inline I32vec2 cmpneq(const I32vec2 &_A, const I32vec2 &_B) {
  return _m_pandn(_m_pcmpeqd(_A, _B), _mmx_all_ones);
}
/* Unpacks */
inline I32vec2 unpack_low(const I32vec2 &_A, const I32vec2 &_B) {
  return _m_punpckldq(_A, _B);
}
inline I32vec2 unpack_high(const I32vec2 &_A, const I32vec2 &_B) {
...
public:
  ...
  /* Logical Assignment Operators */
  Is32vec2 &operator&=(const M64 &_A) {
    return *this = (Is32vec2)_m_pand(vec, _A);
  }
  Is32vec2 &operator|=(const M64 &_A) {
    return *this = (Is32vec2)_m_por(vec, _A);
  }
  Is32vec2 &operator^=(const M64 &_A) {
    return *this = (Is32vec2)_m_pxor(vec, _A);
  }

  /* Addition & Subtraction Assignment Operators */
  Is32vec2 &operator+=(const I32vec2 &_A) {
    return *this = (Is32vec2)_m_paddd(vec, _A);
  }
  Is32vec2 &operator-=(const I32vec2 &_A) {
    return *this = (Is32vec2)_m_psubd(vec, _A);
  }
  ...
  Is32vec2 &operator<<=(const M64 &_A) {
    return *this = (Is32vec2)_m_pslld(vec, _A);
  }
  Is32vec2 &operator<<=(int _Count) {
    return *this = (Is32vec2)_m_pslldi(vec, _Count);
  }
  ...
  Is32vec2 &operator>>=(const M64 &_A) {
    return *this = (Is32vec2)_m_psrad(vec, _A);
  }
  Is32vec2 &operator>>=(int _Count) {
    return *this = (Is32vec2)_m_psradi(vec, _Count);
  }

#if defined(_ENABLE_VEC_DEBUG)
  /* Output for Debug */
  friend std::ostream &operator<<(std::ostream &_Os, const Is32vec2 &_A) {
    _Os << " [1]:" << _MM_2DW(1, _A) << " [0]:" << _MM_2DW(0, _A);
    return _Os;
  }
#endif /* defined (_ENABLE_VEC_DEBUG) */
...
/* Compares */
inline Is32vec2 cmpeq(const Is32vec2 &_A, const Is32vec2 &_B) {
  return _m_pcmpeqd(_A, _B);
}
inline Is32vec2 cmpneq(const Is32vec2 &_A, const Is32vec2 &_B) {
  return _m_pandn(_m_pcmpeqd(_A, _B), _mmx_all_ones);
}
inline Is32vec2 cmpgt(const Is32vec2 &_A, const Is32vec2 &_B) {
  return _m_pcmpgtd(_A, _B);
}
inline Is32vec2 cmplt(const Is32vec2 &_A, const Is32vec2 &_B) {
  return _m_pcmpgtd(_B, _A);
}
inline Is32vec2 cmple(const Is32vec2 &_A, const Is32vec2 &_B) {
  return _m_pandn(_m_pcmpgtd(_A, _B), _mmx_all_ones);
}
inline Is32vec2 cmpge(const Is32vec2 &_A, const Is32vec2 &_B) {
  return _m_pandn(_m_pcmpgtd(_B, _A), _mmx_all_ones);
}
/* Unpacks & Pack */
inline Is32vec2 unpack_low(const Is32vec2 &_A, const Is32vec2 &_B) {
  return _m_punpckldq(_A, _B);
}
inline Is32vec2 unpack_high(const Is32vec2 &_A, const Is32vec2 &_B) {
  return _m_punpckhdq(_A, _B);
}
...
public:
  ...
  /* Logical Assignment Operators */
  Iu32vec2 &operator&=(const M64 &_A) {
    return *this = (Iu32vec2)_m_pand(vec, _A);
  }
  Iu32vec2 &operator|=(const M64 &_A) {
    return *this = (Iu32vec2)_m_por(vec, _A);
  }
  Iu32vec2 &operator^=(const M64 &_A) {
    return *this = (Iu32vec2)_m_pxor(vec, _A);
  }

  /* Addition & Subtraction Assignment Operators */
  Iu32vec2 &operator+=(const I32vec2 &_A) {
    return *this = (Iu32vec2)_m_paddd(vec, _A);
  }
  Iu32vec2 &operator-=(const I32vec2 &_A) {
    return *this = (Iu32vec2)_m_psubd(vec, _A);
  }
  ...
  Iu32vec2 &operator<<=(const M64 &_A) {
    return *this = (Iu32vec2)_m_pslld(vec, _A);
  }
  Iu32vec2 &operator<<=(int _Count) {
    return *this = (Iu32vec2)_m_pslldi(vec, _Count);
  }
  Iu32vec2 operator>>(const M64 &_A) { return _m_psrld(vec, _A); }
  Iu32vec2 operator>>(int _Count) { return _m_psrldi(vec, _Count); }
  Iu32vec2 &operator>>=(const M64 &_A) {
    return *this = (Iu32vec2)_m_psrld(vec, _A);
  }
  Iu32vec2 &operator>>=(int _Count) {
    return *this = (Iu32vec2)_m_psrldi(vec, _Count);
  }

#if defined(_ENABLE_VEC_DEBUG)
  /* Output for Debug */
  friend std::ostream &operator<<(std::ostream &_Os, const Iu32vec2 &_A) {
    _Os << "[1]:" << _MM_2UDW(1, _A) << " [0]:" << _MM_2UDW(0, _A);
    return _Os;
  }
#endif /* defined (_ENABLE_VEC_DEBUG) */
...
inline Iu32vec2 cmpeq(const Iu32vec2 &_A, const Iu32vec2 &_B) {
  return _m_pcmpeqd(_A, _B);
}
inline Iu32vec2 cmpneq(const Iu32vec2 &_A, const Iu32vec2 &_B) {
  return _m_pandn(_m_pcmpeqd(_A, _B), _mmx_all_ones);
}
/* Unpacks */
inline Iu32vec2 unpack_low(const Iu32vec2 &_A, const Iu32vec2 &_B) {
  return _m_punpckldq(_A, _B);
}
inline Iu32vec2 unpack_high(const Iu32vec2 &_A, const Iu32vec2 &_B) {
  return _m_punpckhdq(_A, _B);
}
...
public:
  ...
  /* Addition & Subtraction Assignment Operators */
  I16vec4 &operator&=(const M64 &_A) {
    return *this = (I16vec4)_m_pand(vec, _A);
  }
  I16vec4 &operator|=(const M64 &_A) {
    return *this = (I16vec4)_m_por(vec, _A);
  }
  I16vec4 &operator^=(const M64 &_A) {
    return *this = (I16vec4)_m_pxor(vec, _A);
  }

  /* Addition & Subtraction Assignment Operators */
  I16vec4 &operator+=(const I16vec4 &_A) {
    return *this = (I16vec4)_m_paddw(vec, _A);
  }
  I16vec4 &operator-=(const I16vec4 &_A) {
    return *this = (I16vec4)_m_psubw(vec, _A);
  }
  I16vec4 &operator*=(const I16vec4 &_A) {
    return *this = (I16vec4)_m_pmullw(vec, _A);
  }
  ...
  I16vec4 &operator<<=(const I16vec4 &_A) {
    return *this = (I16vec4)_m_psllw(vec, _A);
  }
  I16vec4 &operator<<=(int _Count) {
    return *this = (I16vec4)_m_psllwi(vec, _Count);
  }
};

inline I16vec4 operator*(const I16vec4 &_A, const I16vec4 &_B) {
  return _m_pmullw(_A, _B);
}
inline I16vec4 cmpeq(const I16vec4 &_A, const I16vec4 &_B) {
  return _m_pcmpeqw(_A, _B);
}
inline I16vec4 cmpneq(const I16vec4 &_A, const I16vec4 &_B) {
  return _m_pandn(_m_pcmpeqw(_A, _B), _mmx_all_ones);
}

inline I16vec4 unpack_low(const I16vec4 &_A, const I16vec4 &_B) {
  return _m_punpcklwd(_A, _B);
}
inline I16vec4 unpack_high(const I16vec4 &_A, const I16vec4 &_B) {
...
public:
  ...
  Is16vec4(short _I0, short _I1, short _I2, short _I3)
      : I16vec4(_I0, _I1, _I2, _I3) {}
  ...
  /* Addition & Subtraction Assignment Operators */
  Is16vec4 &operator&=(const M64 &_A) {
    return *this = (Is16vec4)_m_pand(vec, _A);
  }
  Is16vec4 &operator|=(const M64 &_A) {
    return *this = (Is16vec4)_m_por(vec, _A);
  }
  Is16vec4 &operator^=(const M64 &_A) {
    return *this = (Is16vec4)_m_pxor(vec, _A);
  }

  /* Addition & Subtraction Assignment Operators */
  Is16vec4 &operator+=(const I16vec4 &_A) {
    return *this = (Is16vec4)_m_paddw(vec, _A);
  }
  Is16vec4 &operator-=(const I16vec4 &_A) {
    return *this = (Is16vec4)_m_psubw(vec, _A);
  }
  Is16vec4 &operator*=(const I16vec4 &_A) {
    return *this = (Is16vec4)_m_pmullw(vec, _A);
  }
  ...
  Is16vec4 &operator<<=(const M64 &_A) {
    return *this = (Is16vec4)_m_psllw(vec, _A);
  }
  Is16vec4 &operator<<=(int _Count) {
    return *this = (Is16vec4)_m_psllwi(vec, _Count);
  }
  /* Shift Arithmetic Operations */
  Is16vec4 operator>>(const M64 &_A) { return _m_psraw(vec, _A); }
  Is16vec4 operator>>(int _Count) { return _m_psrawi(vec, _Count); }
  Is16vec4 &operator>>=(const M64 &_A) {
    return *this = (Is16vec4)_m_psraw(vec, _A);
  }
  Is16vec4 &operator>>=(int _Count) {
    return *this = (Is16vec4)_m_psrawi(vec, _Count);
  }

#if defined(_ENABLE_VEC_DEBUG)
  /* Output for Debug */
  friend std::ostream &operator<<(std::ostream &_Os, const Is16vec4 &_A) {
    _Os << "[3]:" << _MM_4W(3, _A) << " [2]:" << _MM_4W(2, _A)
        << " [1]:" << _MM_4W(1, _A) << " [0]:" << _MM_4W(0, _A);
    return _Os;
  }
#endif /* defined (_ENABLE_VEC_DEBUG) */
...
inline Is16vec4 operator*(const Is16vec4 &_A, const Is16vec4 &_B) {
  return _m_pmullw(_A, _B);
}

/* Compares */
inline Is16vec4 cmpeq(const Is16vec4 &_A, const Is16vec4 &_B) {
  return _m_pcmpeqw(_A, _B);
}
inline Is16vec4 cmpneq(const Is16vec4 &_A, const Is16vec4 &_B) {
  return _m_pandn(_m_pcmpeqw(_A, _B), _mmx_all_ones);
}
inline Is16vec4 cmpgt(const Is16vec4 &_A, const Is16vec4 &_B) {
  return _m_pcmpgtw(_A, _B);
}
inline Is16vec4 cmplt(const Is16vec4 &_A, const Is16vec4 &_B) {
  return _m_pcmpgtw(_B, _A);
}
inline Is16vec4 cmple(const Is16vec4 &_A, const Is16vec4 &_B) {
  return _m_pandn(_m_pcmpgtw(_A, _B), _mmx_all_ones);
}
inline Is16vec4 cmpge(const Is16vec4 &_A, const Is16vec4 &_B) {
  return _m_pandn(_m_pcmpgtw(_B, _A), _mmx_all_ones);
}
/* Unpacks */
inline Is16vec4 unpack_low(const Is16vec4 &_A, const Is16vec4 &_B) {
  return _m_punpcklwd(_A, _B);
}
inline Is16vec4 unpack_high(const Is16vec4 &_A, const Is16vec4 &_B) {
  return _m_punpckhwd(_A, _B);
}

inline Is16vec4 sat_add(const Is16vec4 &_A, const Is16vec4 &_B) {
  return _m_paddsw(_A, _B);
}
inline Is16vec4 sat_sub(const Is16vec4 &_A, const Is16vec4 &_B) {
  return _m_psubsw(_A, _B);
}
inline Is16vec4 mul_high(const Is16vec4 &_A, const Is16vec4 &_B) {
  return _m_pmulhw(_A, _B);
}
inline Is32vec2 mul_add(const Is16vec4 &_A, const Is16vec4 &_B) {
...
public:
  ...
  Iu16vec4(unsigned short _Ui0, unsigned short _Ui1, unsigned short _Ui2,
           unsigned short _Ui3)
  ...
  /* Logical Assignment Operators */
  Iu16vec4 &operator&=(const M64 &_A) {
    return *this = (Iu16vec4)_m_pand(vec, _A);
  }
  Iu16vec4 &operator|=(const M64 &_A) {
    return *this = (Iu16vec4)_m_por(vec, _A);
  }
  Iu16vec4 &operator^=(const M64 &_A) {
    return *this = (Iu16vec4)_m_pxor(vec, _A);
  }

  /* Addition & Subtraction Assignment Operators */
  Iu16vec4 &operator+=(const I16vec4 &_A) {
    return *this = (Iu16vec4)_m_paddw(vec, _A);
  }
  Iu16vec4 &operator-=(const I16vec4 &_A) {
    return *this = (Iu16vec4)_m_psubw(vec, _A);
  }
  Iu16vec4 &operator*=(const I16vec4 &_A) {
    return *this = (Iu16vec4)_m_pmullw(vec, _A);
  }
  ...
  Iu16vec4 &operator<<=(const M64 &_A) {
    return *this = (Iu16vec4)_m_psllw(vec, _A);
  }
  Iu16vec4 &operator<<=(int _Count) {
    return *this = (Iu16vec4)_m_psllwi(vec, _Count);
  }
  Iu16vec4 operator>>(const M64 &_A) { return _m_psrlw(vec, _A); }
  Iu16vec4 operator>>(int _Count) { return _m_psrlwi(vec, _Count); }
  Iu16vec4 &operator>>=(const M64 &_A) {
    return *this = (Iu16vec4)_m_psrlw(vec, _A);
  }
  Iu16vec4 &operator>>=(int _Count) {
    return *this = (Iu16vec4)_m_psrlwi(vec, _Count);
  }

#if defined(_ENABLE_VEC_DEBUG)
  /* Output for Debug */
  friend std::ostream &operator<<(std::ostream &_Os, const Iu16vec4 &_A) {
    _Os << "[3]:" << _MM_4UW(3, _A) << " [2]:" << _MM_4UW(2, _A)
        << " [1]:" << _MM_4UW(1, _A) << " [0]:" << _MM_4UW(0, _A);
    return _Os;
  }
#endif /* defined (_ENABLE_VEC_DEBUG) */
...
inline Iu16vec4 operator*(const Iu16vec4 &_A, const Iu16vec4 &_B) {
  return _m_pmullw(_A, _B);
}
inline Iu16vec4 cmpeq(const Iu16vec4 &_A, const Iu16vec4 &_B) {
  return _m_pcmpeqw(_A, _B);
}
inline Iu16vec4 cmpneq(const Iu16vec4 &_A, const Iu16vec4 &_B) {
  return _m_pandn(_m_pcmpeqw(_A, _B), _mmx_all_ones);
}

inline Iu16vec4 sat_add(const Iu16vec4 &_A, const Iu16vec4 &_B) {
  return _m_paddusw(_A, _B);
}
inline Iu16vec4 sat_sub(const Iu16vec4 &_A, const Iu16vec4 &_B) {
  return _m_psubusw(_A, _B);
}

inline Iu16vec4 unpack_low(const Iu16vec4 &_A, const Iu16vec4 &_B) {
  return _m_punpcklwd(_A, _B);
}
inline Iu16vec4 unpack_high(const Iu16vec4 &_A, const Iu16vec4 &_B) {
  return _m_punpckhwd(_A, _B);
}
...
public:
  ...
  I8vec8(char _S0, char _S1, char _S2, char _S3, char _S4, char _S5, char _S6,
         char _S7) {
  ...
  /* Addition & Subtraction Assignment Operators */
  I8vec8 &operator+=(const I8vec8 &_A) {
    return *this = (I8vec8)_m_paddb(vec, _A);
  }
  I8vec8 &operator-=(const I8vec8 &_A) {
    return *this = (I8vec8)_m_psubb(vec, _A);
  }
};

inline I8vec8 cmpeq(const I8vec8 &_A, const I8vec8 &_B) {
  return _m_pcmpeqb(_A, _B);
}
inline I8vec8 cmpneq(const I8vec8 &_A, const I8vec8 &_B) {
  return _m_pandn(_m_pcmpeqb(_A, _B), _mmx_all_ones);
}

inline I8vec8 unpack_low(const I8vec8 &_A, const I8vec8 &_B) {
  return _m_punpcklbw(_A, _B);
}
inline I8vec8 unpack_high(const I8vec8 &_A, const I8vec8 &_B) {
...
public:
  ...
  /* Logical Assignment Operators */
  Is8vec8 &operator&=(const M64 &_A) {
    return *this = (Is8vec8)_m_pand(vec, _A);
  }
  Is8vec8 &operator|=(const M64 &_A) {
    return *this = (Is8vec8)_m_por(vec, _A);
  }
  Is8vec8 &operator^=(const M64 &_A) {
    return *this = (Is8vec8)_m_pxor(vec, _A);
  }

  /* Addition & Subtraction Assignment Operators */
  Is8vec8 &operator+=(const I8vec8 &_A) {
    return *this = (Is8vec8)_m_paddb(vec, _A);
  }
  Is8vec8 &operator-=(const I8vec8 &_A) {
    return *this = (Is8vec8)_m_psubb(vec, _A);
  }

#if defined(_ENABLE_VEC_DEBUG)
  /* Output for Debug */
  friend std::ostream &operator<<(std::ostream &_Os, const Is8vec8 &_A) {
    _Os << "[7]:" << short(_MM_8B(7, _A)) << " [6]:" << short(_MM_8B(6, _A))
        << " [5]:" << short(_MM_8B(5, _A)) << " [4]:" << short(_MM_8B(4, _A))
        << " [3]:" << short(_MM_8B(3, _A)) << " [2]:" << short(_MM_8B(2, _A))
        << " [1]:" << short(_MM_8B(1, _A)) << " [0]:" << short(_MM_8B(0, _A));
    return _Os;
  }
#endif /* defined (_ENABLE_VEC_DEBUG) */
...
inline Is8vec8 cmpeq(const Is8vec8 &_A, const Is8vec8 &_B) {
  return _m_pcmpeqb(_A, _B);
}
inline Is8vec8 cmpneq(const Is8vec8 &_A, const Is8vec8 &_B) {
  return _m_pandn(_m_pcmpeqb(_A, _B), _mmx_all_ones);
}
inline Is8vec8 cmpgt(const Is8vec8 &_A, const Is8vec8 &_B) {
  return _m_pcmpgtb(_A, _B);
}
inline Is8vec8 cmplt(const Is8vec8 &_A, const Is8vec8 &_B) {
  return _m_pcmpgtb(_B, _A);
}
inline Is8vec8 cmple(const Is8vec8 &_A, const Is8vec8 &_B) {
  return _m_pandn(_m_pcmpgtb(_A, _B), _mmx_all_ones);
}
inline Is8vec8 cmpge(const Is8vec8 &_A, const Is8vec8 &_B) {
  return _m_pandn(_m_pcmpgtb(_B, _A), _mmx_all_ones);
}

inline Is8vec8 unpack_low(const Is8vec8 &_A, const Is8vec8 &_B) {
  return _m_punpcklbw(_A, _B);
}
inline Is8vec8 unpack_high(const Is8vec8 &_A, const Is8vec8 &_B) {
  return _m_punpckhbw(_A, _B);
}

inline Is8vec8 sat_add(const Is8vec8 &_A, const Is8vec8 &_B) {
  return _m_paddsb(_A, _B);
}
inline Is8vec8 sat_sub(const Is8vec8 &_A, const Is8vec8 &_B) {
...
public:
  ...
  /* Logical Assignment Operators */
  Iu8vec8 &operator&=(const M64 &_A) {
    return *this = (Iu8vec8)_m_pand(vec, _A);
  }
  Iu8vec8 &operator|=(const M64 &_A) {
    return *this = (Iu8vec8)_m_por(vec, _A);
  }
  Iu8vec8 &operator^=(const M64 &_A) {
    return *this = (Iu8vec8)_m_pxor(vec, _A);
  }
  /* Addition & Subtraction Assignment Operators */
  Iu8vec8 &operator+=(const I8vec8 &_A) {
    return *this = (Iu8vec8)_m_paddb(vec, _A);
  }
  Iu8vec8 &operator-=(const I8vec8 &_A) {
    return *this = (Iu8vec8)_m_psubb(vec, _A);
  }
...
inline Iu8vec8 cmpeq(const Iu8vec8 &_A, const Iu8vec8 &_B) {
  return _m_pcmpeqb(_A, _B);
}
inline Iu8vec8 cmpneq(const Iu8vec8 &_A, const Iu8vec8 &_B) {
  return _m_pandn(_m_pcmpeqb(_A, _B), _mmx_all_ones);
}

inline Iu8vec8 unpack_low(const Iu8vec8 &_A, const Iu8vec8 &_B) {
  return _m_punpcklbw(_A, _B);
}
inline Iu8vec8 unpack_high(const Iu8vec8 &_A, const Iu8vec8 &_B) {
  return _m_punpckhbw(_A, _B);
}

inline Iu8vec8 sat_add(const Iu8vec8 &_A, const Iu8vec8 &_B) {
  return _m_paddusb(_A, _B);
}
inline Iu8vec8 sat_sub(const Iu8vec8 &_A, const Iu8vec8 &_B) {
  return _m_psubusb(_A, _B);
}

inline Is16vec4 pack_sat(const Is32vec2 &_A, const Is32vec2 &_B) {
  return _m_packssdw(_A, _B);
}
inline Is8vec8 pack_sat(const Is16vec4 &_A, const Is16vec4 &_B) {
  return _m_packsswb(_A, _B);
}
inline Iu8vec8 packu_sat(const Is16vec4 &_A, const Is16vec4 &_B) {
