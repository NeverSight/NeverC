...
#if defined(_VCRT_BUILD) || !_HAS_CXX23 // C++98 unexpected() is incompatible
                                        // with C++23 unexpected<E>.
...
#ifndef _M_CEE_PURE
_VCRTIMP unexpected_handler __cdecl
set_unexpected(_In_opt_ unexpected_handler _NewUnexpectedHandler) noexcept;
...
_VCRTIMP _se_translator_function __cdecl
_set_se_translator(_In_opt_ _se_translator_function _NewSETranslator);
#endif // _M_CEE_PURE
...
_is_exception_typeof(_In_ type_info const &_Type,
