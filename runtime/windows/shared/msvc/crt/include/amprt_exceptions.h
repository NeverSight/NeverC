...
public:
  /// <summary>
  ///     Construct a runtime_exception exception with a message and an error
  ///     code
  /// </summary>
  /// <param name="_Message">
...
public:
  ...
  ///     accelerator_view
  /// </param>
  _AMPIMP explicit accelerator_view_removed(
      const char *_Message, HRESULT _View_removed_reason) throw();
  ...
  /// <summary>
  ///     Returns an HRESULT error code indicating the cause of the
  ///     accelerator_view's removal
  /// </summary>
  /// <returns>
  ///     The HRESULT error code that indicates the cause of accelerator_view's
  ///     removal
  /// </returns>
