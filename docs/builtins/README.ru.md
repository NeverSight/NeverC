...
| [**`xorstr`**](xorstr/README.ru.md) | `-fencrypt-call-strings` | Выкл. | Шифрование для каждого экземпляра, обязательное позднее запечатывание, разворачивание в точке вызова и volatile-очистка стека |
