...
| `NevercValueRef` | LLVM Value (함수, 명령어, 전역 변수) |
...
| `NevercMachineFuncRef` / `MBBRef` / `MInstrRef` | 머신 함수 / 블록 / 명령어 |
| `NevercUseRef` | Use-def 체인 항목 |
| `NevercLinkerSymbolRef` / `SectionRef` | 링커 심볼 / 섹션 |
