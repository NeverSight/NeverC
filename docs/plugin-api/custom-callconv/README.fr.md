...
Le plugin s'enregistre à `NEVERC_HOOK_POST_OPT` et `NEVERC_HOOK_LTO_POST_OPT`, garantissant l'application des conventions personnalisées après la fusion LTO des unités de traduction.
