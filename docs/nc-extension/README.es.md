...
```bash
# Automático — no se necesitan -fbuiltin-string ni -fneverc-types
...
Para archivos `.c`, estos flags permanecen opcionales: el usuario debe pasar explícitamente `-fneverc-types` y/o `-fbuiltin-string`.
