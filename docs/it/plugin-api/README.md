...
| Guida | Contenuto |
|---|---|
| [Plugin Python](python.md) | Python embedded opzionale, ciclo di vita, opzioni, observer read-only, diagnostica e limiti attuali |
| [API Driver](driver.md) | [Riga di comando](driver.md#argomenti-grezzi), [scelta della toolchain](driver.md#selezione-della-toolchain), [grafo delle azioni](driver.md#il-grafo-delle-azioni), [grafo dei job](driver.md#il-grafo-dei-job) |
| [API Source e I/O](source.md) | [Provider VFS](source.md#provider-di-file-system-virtuale), [posizioni sorgente](source.md#posizioni-sorgente), [buffer](source.md#leggere-file), [sink di output](source.md#scrivere-output), [dipendenze](source.md#registrare-le-dipendenze) |
| [API Preprocessore](prep.md) | [Token](prep.md#leggere-i-token), [macro](prep.md#identificatori-e-macro), [pragma](prep.md#pragma-e-interrogazioni-di-funzionalità), [inclusioni](prep.md#reindirizzare-uninclusione), [interrogazioni sulle funzionalità](prep.md#pragma-e-interrogazioni-di-funzionalità), [39 tipi di evento](prep.md#sottoscrizione-agli-eventi) |
| [API AST e semantica](ast-sema.md) | [Estensione del parser](ast-sema.md#estensione-del-parser), [mutazione dell'AST](ast-sema.md#costruire-e-modificare), [ricerca dei nomi](ast-sema.md#interrogazioni-semantiche), [tipi](ast-sema.md#accessori-tipizzati), [costanti](ast-sema.md#interrogazioni-semantiche) |
| [API IR](ir.md) | [Lettura dell'IR LLVM](ir.md#percorrere-un-modulo), [costruzione transazionale](ir.md#modifica-transazionale), [analisi](ir.md#analisi), [pass](ir.md#passi), [provider](ir.md#sostituire-generazione-e-ottimizzazione) |
| [API MIR](mir.md) | [Funzioni macchina](mir.md#leggere-la-mir), [registri](mir.md#registri), [stack frame](mir.md#lo-stack-frame), [pass e analisi MIR](mir.md#pass) |
| [Target, MC, assembly, oggetto](target-mc-object.md) | [Registrazione di target](target-mc-object.md#registrare-un-target), [convenzioni di chiamata](target-mc-object.md#abi-e-convenzioni-di-chiamata), [codifica MC](target-mc-object.md#encoder-decoder-e-layout), [grafi oggetto](target-mc-object.md#grafi-oggetto) |
| [API Link e LTO](link-lto.md) | [Grafo di collegamento](link-lto.md#leggere-il-grafo), [risoluzione dei simboli](link-lto.md#modificare-il-grafo), [GC/ICF](link-lto.md#la-macchina-a-stati), [provider di linker e LTO](link-lto.md#provider) |
| [API DynCode](dyncode.md) | [Immagini piatte indipendenti dalla posizione](dyncode.md#immagine-report-e-modifiche-di-byte-limitate), [abbassamento degli import](dyncode.md#riferimenti-esterni-e-abbassamento-degli-import), [codifica del set di caratteri](dyncode.md#immagine-report-e-modifiche-di-byte-limitate) |
| [Convenzioni di chiamata personalizzate](custom-callconv.md) | [Plugin di convenzione di chiamata guidati dai dati](custom-callconv.md#formato-della-spec) |
