**Lingue**: [English](../plugin-api-ast-sema.md) | [简体中文](../zh-CN/plugin-api-ast-sema.md) | [繁體中文](../zh-TW/plugin-api-ast-sema.md) | [日本語](../ja/plugin-api-ast-sema.md) | [한국어](../ko/plugin-api-ast-sema.md) | [Français](../fr/plugin-api-ast-sema.md) | [Deutsch](../de/plugin-api-ast-sema.md) | [Español](../es/plugin-api-ast-sema.md) | [Italiano](plugin-api-ast-sema.md) | [Русский](../ru/plugin-api-ast-sema.md) | [العربية](../ar/plugin-api-ast-sema.md)
...
dichiarazioni normative, [`Schema/PhaseSchema.json`] per le policy delle fasi,
e [`pluginsdk/examples/ASTRewritePlugin.c`] per un'intercettazione del parser
e una riscrittura atomica dell'albero funzionanti.
