**Lingue**: [English](../examples.md) | [简体中文](../zh-CN/examples.md) | [繁體中文](../zh-TW/examples.md) | [日本語](../ja/examples.md) | [한국어](../ko/examples.md) | [Français](../fr/examples.md) | [Deutsch](../de/examples.md) | [Español](../es/examples.md) | [Italiano](examples.md) | [Русский](../ru/examples.md) | [العربية](../ar/examples.md)

[← Documentazione](README.md) · [← Progetto NeverC](project.md)
...
Per il driver Makefile vero e proprio, vedi [`neverc build` / `make` →](build.md).
