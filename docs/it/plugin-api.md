**Lingue**: [English](../plugin-api.md) | [简体中文](../zh-CN/plugin-api.md) | [繁體中文](../zh-TW/plugin-api.md) | [日本語](../ja/plugin-api.md) | [한국어](../ko/plugin-api.md) | [Français](../fr/plugin-api.md) | [Deutsch](../de/plugin-api.md) | [Español](../es/plugin-api.md) | [Italiano](plugin-api.md) | [Русский](../ru/plugin-api.md) | [العربية](../ar/plugin-api.md)
...
| Guida | Contenuto |
|---|---|
| [Plugin Python](plugin-api-python.md) | Python embedded opzionale, ciclo di vita, opzioni, observer read-only, diagnostica e limiti attuali |
| [API Driver](plugin-api-driver.md) | [Riga di comando](plugin-api-driver.md#argomenti-grezzi), [scelta della toolchain](plugin-api-driver.md#selezione-della-toolchain), [grafo delle azioni](plugin-api-driver.md#il-grafo-delle-azioni), [grafo dei job](plugin-api-driver.md#il-grafo-dei-job) |
| [API Source e I/O](plugin-api-source.md) | [Provider VFS](plugin-api-source.md#provider-di-file-system-virtuale), [posizioni sorgente](plugin-api-source.md#posizioni-sorgente), [buffer](plugin-api-source.md#leggere-file), [sink di output](plugin-api-source.md#scrivere-output), [dipendenze](plugin-api-source.md#registrare-le-dipendenze) |
| [API Preprocessore](plugin-api-prep.md) | [Token](plugin-api-prep.md#leggere-i-token), [macro](plugin-api-prep.md#identificatori-e-macro), [pragma](plugin-api-prep.md#pragma-e-interrogazioni-di-funzionalità), [inclusioni](plugin-api-prep.md#reindirizzare-uninclusione), [interrogazioni sulle funzionalità](plugin-api-prep.md#pragma-e-interrogazioni-di-funzionalità), [39 tipi di evento](plugin-api-prep.md#sottoscrizione-agli-eventi) |
| [API AST e semantica](plugin-api-ast-sema.md) | [Estensione del parser](plugin-api-ast-sema.md#estensione-del-parser), [mutazione dell'AST](plugin-api-ast-sema.md#costruire-e-modificare), [ricerca dei nomi](plugin-api-ast-sema.md#interrogazioni-semantiche), [tipi](plugin-api-ast-sema.md#accessori-tipizzati), [costanti](plugin-api-ast-sema.md#interrogazioni-semantiche) |
| [API IR](plugin-api-ir.md) | [Lettura dell'IR LLVM](plugin-api-ir.md#percorrere-un-modulo), [costruzione transazionale](plugin-api-ir.md#modifica-transazionale), [analisi](plugin-api-ir.md#analisi), [pass](plugin-api-ir.md#passi), [provider](plugin-api-ir.md#sostituire-generazione-e-ottimizzazione) |
| [API MIR](plugin-api-mir.md) | [Funzioni macchina](plugin-api-mir.md#leggere-la-mir), [registri](plugin-api-mir.md#registri), [stack frame](plugin-api-mir.md#lo-stack-frame), [pass e analisi MIR](plugin-api-mir.md#pass) |
| [Target, MC, assembly, oggetto](plugin-api-target-mc-object.md) | [Registrazione di target](plugin-api-target-mc-object.md#registrare-un-target), [convenzioni di chiamata](plugin-api-target-mc-object.md#abi-e-convenzioni-di-chiamata), [codifica MC](plugin-api-target-mc-object.md#encoder-decoder-e-layout), [grafi oggetto](plugin-api-target-mc-object.md#grafi-oggetto) |
| [API Link e LTO](plugin-api-link-lto.md) | [Grafo di collegamento](plugin-api-link-lto.md#leggere-il-grafo), [risoluzione dei simboli](plugin-api-link-lto.md#modificare-il-grafo), [GC/ICF](plugin-api-link-lto.md#la-macchina-a-stati), [provider di linker e LTO](plugin-api-link-lto.md#provider) |
| [API DynCode](plugin-api-dyncode.md) | [Immagini piatte indipendenti dalla posizione](plugin-api-dyncode.md#immagine-report-e-modifiche-di-byte-limitate), [abbassamento degli import](plugin-api-dyncode.md#riferimenti-esterni-e-abbassamento-degli-import), [codifica del set di caratteri](plugin-api-dyncode.md#immagine-report-e-modifiche-di-byte-limitate) |
| [Convenzioni di chiamata personalizzate](plugin-api-custom-callconv.md) | [Plugin di convenzione di chiamata guidati dai dati](plugin-api-custom-callconv.md#formato-della-spec) |
| [Prove di copertura delle fasi](../plugin-api-coverage.json) | Corrispondenza dei test per ogni fase stabile |
