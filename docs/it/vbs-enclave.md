**Lingue**: [English](../vbs-enclave.md) | [简体中文](../zh-CN/vbs-enclave.md) | [繁體中文](../zh-TW/vbs-enclave.md) | [日本語](../ja/vbs-enclave.md) | [한국어](../ko/vbs-enclave.md) | [Français](../fr/vbs-enclave.md) | [Deutsch](../de/vbs-enclave.md) | [Español](../es/vbs-enclave.md) | [Italiano](vbs-enclave.md) | [Русский](../ru/vbs-enclave.md) | [العربية](../ar/vbs-enclave.md)
...
La verifica a runtime x64 esegue prima l’immagine Microsoft, poi entrambi i candidati NeverC. Risolve una funzione esportata con `GetProcAddress`, ripete le chiamate `CallEnclave`, coprendo i percorsi di chiamata indiretta protetti da CFG e legacy, e controlla i valori restituiti. `PASS` richiede prove ordinate di ogni fase del ciclo di vita, incluse terminazione e liberazione riuscite; il solo caricamento e l’inizializzazione non bastano. In questo workflow, ARM64 è coperto dalla convalida statica e dal collegamento differenziale; la verifica a runtime ordinaria rimane limitata a x64.

Una verifica separata su Windows 11 ARM64 nativo è riuscita il 2026-09-11 ([esecuzione 34554067852](https://github.com/NeverSight/NeverC/actions/runs/34554067852)). Ha riutilizzato entrambe le DLL ARM64 di NeverC compilate da `c46e3a4cc4b3732823a7241a43bca6c44b0f0b74` e le ha testate insieme a un’immagine di riferimento appena compilata con MSVC. Sono state superate tutte le 48 fasi del ciclo di vita e le 12 chiamate con verifica dei risultati; anche la terminazione e la liberazione degli enclave e la pulizia del certificato di firma sono riuscite. Ciò convalida questi artefatti specifici, non una nuova compilazione del compilatore NeverC né un controllo CI permanente dell’esecuzione ARM64.
