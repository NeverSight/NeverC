...
(vedi [Source e I/O](plugin-api-source.md#scrivere-output)): è così che l'host conferma
che i file che un job ha dichiarato di scrivere esistono davvero con i digest
riportati.
