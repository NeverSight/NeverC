**Lingue**: [English](../runtime.md) | [简体中文](../zh-CN/runtime.md) | [繁體中文](../zh-TW/runtime.md) | [日本語](../ja/runtime.md) | [한국어](../ko/runtime.md) | [Français](../fr/runtime.md) | [Deutsch](../de/runtime.md) | [Español](../es/runtime.md) | [Italiano](runtime.md) | [Русский](../ru/runtime.md) | [العربية](../ar/runtime.md)
...
- [`neverc update`](update.md) sposta **compilatore e tutti i
...
|---------|---------------|
| [`neverc update`](update.md) | Aggiornare/declassare insieme compilatore + runtime installati |
| [`neverc build` / `make`](build.md) | Compilare esempi cross contro questi sysroot |
| [Examples](examples.md) | `Makefile` di esempio con `--target=…` |
