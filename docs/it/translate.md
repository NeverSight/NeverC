...
Core v2 supporta template di funzioni libere con al massimo 64 parametri di tipo senza pack e argomenti di tipo supportati. Deduzione, istanziazione e specializzazione esplicite, tipi predefiniti, argomenti predefiniti risolti, ricorsione e importazioni producono funzioni tipizzate ordinarie. Ogni istanza mantiene tipi locali e memoria statica scalare propri, anche tra template primari con firme identiche. Corpi generici e valori predefiniti differiti sono controllati quando istanziati; ogni corpo materializzato viene controllato. Le chiamate con sola firma in sizeof/noexcept richiedono ancora una definizione. Template di classi, membri, operatori e friend, parametri non di tipo, pack, header standard e STL completo restano incompleti. La verifica nativa richiede il CI della revisione corrispondente.
