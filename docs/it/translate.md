...
Core v2 supporta costruttori ordinari definiti dall’utente per record con layout standard e operazioni di copia supportate. Oggetti locali, campi ed elementi di array vengono costruiti nella memoria finale; i campi seguono l’ordine di dichiarazione. Restano esclusi i costruttori esplicitamente default, deleganti o di spostamento e le eccezioni.
