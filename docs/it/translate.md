...
Core v2 supporta costruttori ordinari definiti dall’utente per record con layout standard e copia triviale. Oggetti locali, campi ed elementi di array vengono costruiti nella memoria finale; i campi seguono l’ordine di dichiarazione. Restano esclusi i costruttori esplicitamente default, deleganti o di copia/spostamento definiti dall’utente e le eccezioni.
