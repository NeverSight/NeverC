**Lingue**: [English](../dyncode-compiler-roadmap.md) | [简体中文](../zh-CN/dyncode-compiler-roadmap.md) | [繁體中文](../zh-TW/dyncode-compiler-roadmap.md) | [日本語](../ja/dyncode-compiler-roadmap.md) | [한국어](../ko/dyncode-compiler-roadmap.md) | [Français](../fr/dyncode-compiler-roadmap.md) | [Deutsch](../de/dyncode-compiler-roadmap.md) | [Español](../es/dyncode-compiler-roadmap.md) | [Italiano](dyncode-compiler-roadmap.md) | [Русский](../ru/dyncode-compiler-roadmap.md) | [العربية](../ar/dyncode-compiler-roadmap.md)
...
2. **API Plugin C fuori dall'albero** — Interfaccia plugin C ABI pura ([`NevercPluginAPI.h`]) per pass IR, MIR, Binary e Linker personalizzati. I plugin si registrano a 11 interpose point dyncode (`NEVERC_INTERPOSE_SC_*`). SDK a singolo header, zero dipendenze LLVM/CRT. Vedere [documentazione API Plugin](plugin-api.md).
...
Utilizzo ed esempi di codice nella [documentazione Plugin API](plugin-api.md).
