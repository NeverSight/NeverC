...
- **Interpose IR**: 6 interpose point IR (`NEVERC_INTERPOSE_SC_BEFORE_PREP` a `NEVERC_INTERPOSE_SC_AFTER_FINAL_IR`) via l'[API Plugin](../plugin-api/README.md). 11 interpose totali (6 IR + 3 MIR + 2 flusso byte).
...
Vedere [kernel-mode-dyncode.md](kernel-mode-dyncode.md).
