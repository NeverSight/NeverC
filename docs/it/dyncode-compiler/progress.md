**Lingue**: [English](../../dyncode-compiler/progress.md) | [简体中文](../../zh-CN/dyncode-compiler/progress.md) | [繁體中文](../../zh-TW/dyncode-compiler/progress.md) | [日本語](../../ja/dyncode-compiler/progress.md) | [한국어](../../ko/dyncode-compiler/progress.md) | [Français](../../fr/dyncode-compiler/progress.md) | [Deutsch](../../de/dyncode-compiler/progress.md) | [Español](../../es/dyncode-compiler/progress.md) | [Italiano](progress.md) | [Русский](../../ru/dyncode-compiler/progress.md) | [العربية](../../ar/dyncode-compiler/progress.md)

[← Compilatore dyncode](README.md)

# Compilatore dyncode — Tracciamento progressi

## Fase 0 — macOS arm64 MVP (consegnato)

- [x] Scheletro directory e CMake (libreria `nevercDynCode`)
...
**Test**: 108/108 asserzioni dyncode superate. Dimensioni binarie: `add` 8B, `fib` 64B, `hello` 64B, `big_const` 632B.
...
- [x] Semantica `-mdyncode-syscall` multipiattaforma (sostituisce `-mdyncode-libsystem` solo Darwin)
- [x] Tabelle numeri di syscall Linux / Android (Darwin BSD 100+, Linux arm64 130+, Linux x86_64 150+)
- [x] `DynCodeExtractor` rifattorizzato in `MachOExtractor` / `ELFExtractor` / `COFFExtractor`
...
- [x] Interpose di offuscamento MIR + livello byte (11 interpose su livelli IR/MIR/flusso byte)
- [x] Downgrade automatico AArch64 non-Darwin `long double` a binary64
- [x] Header shim dyncode: `<windows.h>`, `<unistd.h>`, `<fcntl.h>`, `<sys/stat.h>`, `<sys/mman.h>`, `<string.h>`, `<stdlib.h>`
...
**Test**: 743+ asserzioni dyncode, tutte superate su 8 triple. Suite NeverC completa: 1000+ test superati.

## Fase 2 — Encoder stampabile / alfanumerico (pianificato)

- [ ] Encoder dyncode stampabile ARM64 (sottoinsieme istruzioni 0x20–0x7e)
...
- [ ] Anti-rilevamento: evitare pattern di firma dyncode noti
