**Lingue**: [English](../../dyncode-compiler/platform-extension-guide.md) | [简体中文](../../zh-CN/dyncode-compiler/platform-extension-guide.md) | [繁體中文](../../zh-TW/dyncode-compiler/platform-extension-guide.md) | [日本語](../../ja/dyncode-compiler/platform-extension-guide.md) | [한국어](../../ko/dyncode-compiler/platform-extension-guide.md) | [Français](../../fr/dyncode-compiler/platform-extension-guide.md) | [Deutsch](../../de/dyncode-compiler/platform-extension-guide.md) | [Español](../../es/dyncode-compiler/platform-extension-guide.md) | [Italiano](platform-extension-guide.md) | [Русский](../../ru/dyncode-compiler/platform-extension-guide.md) | [العربية](../../ar/dyncode-compiler/platform-extension-guide.md)

[← Compilatore dyncode](README.md)

# Guida all'estensione della piattaforma

Questo documento spiega come estendere il compilatore dyncode a nuove piattaforme target. Attualmente supportato: **arm64 / x86_64 su macOS / Linux / Android / Windows** (8 triple), ciascuno con contesti indipendenti **User** / **Kernel** (16 varianti totali). L'aggiunta di una nuova piattaforma richiede tipicamente poche centinaia di righe di codice.
...
| `DriverInjectFlags` | Flag specifici della piattaforma in modalità dyncode | null → nessuna iniezione |
...
Aggiungere un controllo di cross-compilazione in [`tests/neverc/DynCodeCrossTargetTests.cpp`].
