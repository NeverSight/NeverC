**Lingue**: [English](../../dyncode-compiler/README.md) | [简体中文](../../zh-CN/dyncode-compiler/README.md) | [繁體中文](../../zh-TW/dyncode-compiler/README.md) | [日本語](../../ja/dyncode-compiler/README.md) | [한국어](../../ko/dyncode-compiler/README.md) | [Français](../../fr/dyncode-compiler/README.md) | [Deutsch](../../de/dyncode-compiler/README.md) | [Español](../../es/dyncode-compiler/README.md) | [Italiano](README.md) | [Русский](../../ru/dyncode-compiler/README.md) | [العربية](../../ar/dyncode-compiler/README.md)
...
- [Tutorial assembly ARM64 (AArch64) — Prospettiva DynCode](arm64-assembly-tutorial.md)
- [Architettura multipiattaforma NeverC DynCode — Panoramica](cross-platform-architecture.md)
- [Progettazione dei pass IR — Principi, pipeline ed esempi prima/dopo](ir-pass-design.md)
- [Supporto dyncode modalità kernel (Ring-0)](kernel-mode-dyncode.md)
- [Progettazione dei pass MIR — Principi e punti interpose](mir-pass-design.md)
- [Pipeline DynCode, MIR e Strategia PIC (Note di progettazione)](pipeline-and-pic.md)
- [Guida all'estensione della piattaforma](platform-extension-guide.md)
- [Compilatore dyncode — Tracciamento progressi](progress.md)
- [Roadmap](roadmap.md)
...
| `-fdyncode-obfuscate=<spec>` | Passa agli interpose plugin **livello IR** via l'[API Plugin](../plugin-api/README.md). No-op senza plugin caricato. Vedi [ir-pass-design.md §9 — Obfuscation Interposes](ir-pass-design.md#9-obfuscation-interposes). |
| `-fdyncode-mir-obfuscate=<spec>` | Passa agli interpose **livello MIR** (`RunBeforePreEmit` / `RunAfterPreEmit`). Predefinito `-fdyncode-obfuscate=` se non impostato. Vedi [mir-pass-design.md §3 — User Obfuscation Interposes](mir-pass-design.md#3-interpose-di-offuscamento-utente). |
...
La pipeline dyncode di per sé garantisce solo che «il codice funzioni correttamente». Offuscamento, polimorfismo, encoder a stadi e funzionalità simili dello strato strategico **non sono integrati di proposito** — sono forniti da plugin fuori dall'albero tramite l'[API Plugin](../plugin-api/README.md).
...
Consulta la [documentazione dell'API Plugin](../plugin-api/README.md) per l'elenco completo degli interpose, la registrazione dei pass ed esempi di codice.

- IR-level: [ir-pass-design.md §9 — Obfuscation Interposes](ir-pass-design.md#9-obfuscation-interposes).
- MIR-level: [mir-pass-design.md §3 — User Obfuscation Interposes](mir-pass-design.md#3-interpose-di-offuscamento-utente)
---
