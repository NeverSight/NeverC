...
[文档索引](../README.zh-CN.md) · [Shellcode 指南](../shellcode-compiler/README.zh-CN.md) · [内置运行时](../builtins/README.zh-CN.md) · [插件 API](../plugin-api/README.zh-CN.md)
...
- **[插件系统](../plugin-api/README.zh-CN.md)，一个头文件搞定** — 纯 C API，20+ 钩子点覆盖 IR、MIR、Binary、Linker 全流程。用任何语言写插件，几乎可以介入编译流水线的任何执行点——不需要 LLVM 头文件。
