...
[文档索引](../README.zh-CN.md) · [Shellcode 指南](../shellcode-compiler/README.zh-CN.md) · [内置字符串](../builtin-string/README.zh-CN.md)
...
- **[内置 `string` 类型](../builtin-string/README.zh-CN.md)** — 值语义字符串，支持点号方法语法、自动内存管理与原生 UTF-8 后备
