...
[Dokumentationsindex](../README.de.md) · [Shellcode-Leitfaden](../shellcode-compiler/README.de.md) · [Eingebauter String](../builtin-string/README.de.md)
...
- **[Eingebauter `string`-Typ](../builtin-string/README.de.md)** — Werttyp-String mit Punkt-Methodensyntax, automatischer Speicherverwaltung und nativer UTF-8-Unterstützung
