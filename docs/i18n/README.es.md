...
- **Extensible sin fricción** — Escribe [plugins de compilador](../plugin-api/README.es.md) en cualquier lenguaje con un solo encabezado C. 20+ puntos de enganche para intervenir en prácticamente cualquier etapa — desde la optimización IR hasta la salida binaria final — sin tocar los internos de LLVM.
