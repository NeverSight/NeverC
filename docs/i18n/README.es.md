...
- **[Strip de publicación](../release-builds/README.es.md)** — `--strip` / `-s` integrado elimina símbolos no necesarios en ejecución y depuración fuente de las imágenes ELF, Mach-O y PE/COFF finales
