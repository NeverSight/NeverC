...
Requisitos, comandos de compilación, binarios macOS precompilados, compilación cruzada a Windows, configuración de PATH y entorno — consulte **[Desarrollo local](../local-dev/README.es.md)**.
