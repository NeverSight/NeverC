...
- **Расширяемый без порога вхождения** — Один C-заголовок, 20+ точек подключения — и у вас [плагин компилятора](../plugin-api/README.ru.md), способный вмешаться на любом этапе от оптимизации IR до финального бинарного вывода — без знания LLVM.
