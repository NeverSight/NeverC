...
- **Расширяемый без порога вхождения** — Пишите [плагины компилятора](../plugin-api/README.ru.md) на любом языке с единственным C-заголовком. 20+ точек подключения позволяют вмешаться практически на любом этапе — от оптимизации IR до финального бинарного вывода — не касаясь внутренностей LLVM.
