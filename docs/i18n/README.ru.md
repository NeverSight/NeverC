...
- **[Система плагинов](../plugin-api/README.ru.md), один заголовок** — Чистый C API с 20+ точками подключения на уровнях IR, MIR, Binary и Linker. Пишите плагин на любом языке и вмешивайтесь практически в любую точку конвейера компиляции — без заголовков LLVM.
