...
- **[Удаление релизных символов](../release-builds/README.ru.md)** — встроенные `--strip` / `-s` удаляют ненужные во время выполнения символы и исходную отладку из итоговых ELF, Mach-O и PE/COFF
