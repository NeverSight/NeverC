...
整合連結器 · Shellcode 流水線 · 內建 `string` 型別
...
[文件索引](../README.zh-TW.md) · [Shellcode 指南](../shellcode-compiler/README.zh-TW.md) · [內建字串](../builtins/string/README.zh-TW.md)
...
- **[內建 `string` 型別](../builtins/string/README.zh-TW.md)** — 值語意字串，支援點號方法語法、自動記憶體管理與原生 UTF-8 後備
