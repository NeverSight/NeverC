...
- **قابل للتوسيع بلا عوائق** — اكتب [إضافات المُجمِّع](../plugin-api/README.ar.md) بأي لغة باستخدام ملف رأس C واحد. 20+ نقطة ربط تتيح التدخل في أي مرحلة تقريبًا — من تحسين IR إلى الإخراج الثنائي النهائي — دون لمس عمق LLVM.
