...
قد تنجح أعلام الترجمة المتقاطعة في التجميع، لكن الملف المؤقت يُشغَّل دائمًا على المضيف. القواعد والأمثلة والقيود: **[`neverc run` →](../run/README.ar.md)**.
...
راجع [الإشعارات](../../NOTICE) و[دليل نسب العمل (بالإنجليزية والصينية)](../../ATTRIBUTION.md) و[بيانات الاستشهاد القابلة للقراءة آليًا](../../CITATION.cff).
