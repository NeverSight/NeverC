...
`neverc run -O2 hello.c Alice`. توضع خيارات المترجم قبل قائمة ملفات المصدر المتتالية
`.c`/`.nc`، وتُمرّر الوسائط التالية إلى البرنامج. وللاستدعاءات المتقدمة يفصل `--`
الجزأين بوضوح، مثل `neverc run hello.c helper.o -O2 -- Alice`. يرث الملف التنفيذي
