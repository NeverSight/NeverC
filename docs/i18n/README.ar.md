...
- **[نظام إضافات](../plugin-api/README.ar.md)، ملف رأس واحد** — واجهة C صرفة مع 20+ نقطة ربط تغطي IR وMIR وBinary وLinker. اكتب إضافة بأي لغة وتدخَّل في أي نقطة تقريبًا من مسار التجميع — بدون ملفات رأس LLVM.
