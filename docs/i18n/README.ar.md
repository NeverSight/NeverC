...
لتشغيل برنامج دون الاحتفاظ بملف ثنائي، استخدم
`neverc run -O2 -fbuiltin-string hello.c`. توضع خيارات المترجم قبل قائمة ملفات المصدر المتتالية
`.c`/`.nc`، وتُمرّر الوسائط التالية إلى البرنامج. وللاستدعاءات المتقدمة يفصل `--`
الجزأين بوضوح، مثل `neverc run hello.c -O2 -fbuiltin-string --`. يرث الملف التنفيذي
المؤقت مجلد العمل والبيئة وتدفقات الإدخال والإخراج القياسية، ويعيد حالة خروج البرنامج،
ثم يُحذف بعد انتهائه. استخدم أمر المترجم المعتاد عندما تريد الاحتفاظ بالناتج.
