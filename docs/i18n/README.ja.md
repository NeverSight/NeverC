...
[ドキュメント索引](../README.ja.md) · [Shellcode ガイド](../shellcode-compiler/README.ja.md) · [組み込み文字列](../builtin-string/README.ja.md)
...
- **[組み込み `string` 型](../builtin-string/README.ja.md)** — 値セマンティクスの文字列型、ドットメソッド構文、自動メモリ管理、ネイティブ UTF-8 バッキング
