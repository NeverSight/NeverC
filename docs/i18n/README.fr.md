...
- **[Dépouillement des versions](../release-builds/README.fr.md)** — `--strip` / `-s` intégré retire des images ELF, Mach-O et PE/COFF finales les symboles non requis à l'exécution et le débogage source
