**Languages**: [English](nc-extension.md) | [简体中文](zh-CN/nc-extension.md) | [繁體中文](zh-TW/nc-extension.md) | [日本語](ja/nc-extension.md) | [한국어](ko/nc-extension.md) | [Français](fr/nc-extension.md) | [Deutsch](de/nc-extension.md) | [Español](es/nc-extension.md) | [Italiano](it/nc-extension.md) | [Русский](ru/nc-extension.md) | [العربية](ar/nc-extension.md)
...
For `.c` files, these flags remain opt-in: pass the flags you need (`-fneverc-types`, `-fbuiltin-string`) explicitly.
