**Languages**: [English](plugin-api.md) | [简体中文](zh-CN/plugin-api.md) | [繁體中文](zh-TW/plugin-api.md) | [日本語](ja/plugin-api.md) | [한국어](ko/plugin-api.md) | [Français](fr/plugin-api.md) | [Deutsch](de/plugin-api.md) | [Español](es/plugin-api.md) | [Italiano](it/plugin-api.md) | [Русский](ru/plugin-api.md) | [العربية](ar/plugin-api.md)
...
| Guide | Covers |
|---|---|
| [Python plugins](plugin-api-python.md) | Optional embedded Python, lifecycle, options, read-only observers, diagnostics, and current limitations |
| [Driver API](plugin-api-driver.md) | [Command line](plugin-api-driver.md#raw-arguments), [toolchain selection](plugin-api-driver.md#toolchain-selection), [action graph](plugin-api-driver.md#the-action-graph), [job graph](plugin-api-driver.md#the-job-graph) |
| [Source and I/O API](plugin-api-source.md) | [VFS providers](plugin-api-source.md#virtual-file-system-providers), [source locations](plugin-api-source.md#source-locations), [buffers](plugin-api-source.md#reading-files), [output sinks](plugin-api-source.md#writing-outputs), [dependencies](plugin-api-source.md#recording-dependencies) |
| [Preprocessor API](plugin-api-prep.md) | [Tokens](plugin-api-prep.md#reading-tokens), [macros](plugin-api-prep.md#identifiers-and-macros), [pragmas](plugin-api-prep.md#pragmas-and-feature-queries), [includes](plugin-api-prep.md#redirecting-an-include), [feature queries](plugin-api-prep.md#pragmas-and-feature-queries), [39 event kinds](plugin-api-prep.md#event-subscription) |
| [AST and semantic API](plugin-api-ast-sema.md) | [Parser extension](plugin-api-ast-sema.md#parser-extension), [AST mutation](plugin-api-ast-sema.md#building-and-mutating), [name lookup](plugin-api-ast-sema.md#semantic-queries), [types](plugin-api-ast-sema.md#typed-accessors), [constants](plugin-api-ast-sema.md#semantic-queries) |
| [IR API](plugin-api-ir.md) | [LLVM IR reading](plugin-api-ir.md#walking-a-module), [transactional building](plugin-api-ir.md#transactional-mutation), [analyses](plugin-api-ir.md#analyses), [passes](plugin-api-ir.md#passes), [providers](plugin-api-ir.md#replacing-generation-and-optimization) |
| [MIR API](plugin-api-mir.md) | [Machine functions](plugin-api-mir.md#reading-mir), [registers](plugin-api-mir.md#registers), [frames](plugin-api-mir.md#the-stack-frame), [MIR passes and analyses](plugin-api-mir.md#passes) |
| [Target, MC, assembly, object](plugin-api-target-mc-object.md) | [Target registration](plugin-api-target-mc-object.md#registering-a-target), [calling conventions](plugin-api-target-mc-object.md#abi-and-calling-conventions), [MC encoding](plugin-api-target-mc-object.md#encoders-decoders-and-layout), [object graphs](plugin-api-target-mc-object.md#object-graphs) |
| [Link and LTO API](plugin-api-link-lto.md) | [Link graph](plugin-api-link-lto.md#reading-the-graph), [symbol resolution](plugin-api-link-lto.md#mutating-the-graph), [GC/ICF](plugin-api-link-lto.md#the-state-machine), [linker and LTO providers](plugin-api-link-lto.md#providers) |
| [DynCode API](plugin-api-dyncode.md) | [Flat position-independent images](plugin-api-dyncode.md#image-report-and-bounded-byte-edits), [import lowering](plugin-api-dyncode.md#external-references-and-import-lowering), [charset encoding](plugin-api-dyncode.md#image-report-and-bounded-byte-edits) |
| [Custom calling conventions](plugin-api-custom-callconv.md) | [Data-driven calling-convention plugins](plugin-api-custom-callconv.md#spec-format) |
| [Phase coverage evidence](plugin-api-coverage.json) | Test mapping for every stable phase |
