...
يوضح هذا المستند الاتجاهات الرئيسية المخطط لها لمشروع NeverC بعد مُجمِّع shellcode الحالي وأوقات التشغيل المدمجة.
...
- تجربة تجميع shellcode (مستقل عن الموضع، وقت تشغيل أدنى) تنطبق مباشرة على قيود برامج السلسلة
