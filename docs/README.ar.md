...
| [`neverc translate`](translate/README.ar.md) | ترجمة C++ إلى NeverC |
...
| المستند | الوصف |
|---------|--------|
| [ملفات DLL لجيوب VBS](vbs-enclave/README.ar.md) | ربط صور جيوب VBS المتوافقة مع Microsoft والتحقق منها ومعالجتها وتوقيعها وتحميلها |
