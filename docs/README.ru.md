...
| [`neverc translate`](translate/README.ru.md) | Перевод C++ в NeverC |
...
| [Релизные бинарные файлы и `--strip`](release-builds/README.ru.md) | Удалить ненужные символы и исходную отладку и структурно переименовать символы `.ko` с учётом ядра (это не hash и не encryption) |
...
| Документ | Описание |
|----------|----------|
| [DLL VBS-анклавов](vbs-enclave/README.ru.md) | Компоновка, проверка, обработка, подпись и загрузка совместимых с Microsoft образов VBS-анклавов |
...
**[руководство по указанию источников →](attribution/README.ru.md)**
