**Sprachen**: [English](../examples.md) | [简体中文](../zh-CN/examples.md) | [繁體中文](../zh-TW/examples.md) | [日本語](../ja/examples.md) | [한국어](../ko/examples.md) | [Français](../fr/examples.md) | [Deutsch](examples.md) | [Español](../es/examples.md) | [Italiano](../it/examples.md) | [Русский](../ru/examples.md) | [العربية](../ar/examples.md)
...
Zum Makefile-Treiber selbst siehe [`neverc build` / `make` →](build.md).
