**Sprachen**: [English](../dyncode-compiler.md) | [简体中文](../zh-CN/dyncode-compiler.md) | [繁體中文](../zh-TW/dyncode-compiler.md) | [日本語](../ja/dyncode-compiler.md) | [한국어](../ko/dyncode-compiler.md) | [Français](../fr/dyncode-compiler.md) | [Deutsch](dyncode-compiler.md) | [Español](../es/dyncode-compiler.md) | [Italiano](../it/dyncode-compiler.md) | [Русский](../ru/dyncode-compiler.md) | [العربية](../ar/dyncode-compiler.md)
...
- [ARM64 (AArch64) Assembly-Tutorial — DynCode-Perspektive](dyncode-compiler-arm64-assembly-tutorial.md)
- [NeverC DynCode Cross-Platform-Architektur — Überblick](dyncode-compiler-cross-platform-architecture.md)
- [IR-Pass-Design — Prinzipien, Pipeline und Vorher/Nachher-Beispiele](dyncode-compiler-ir-pass-design.md)
- [Kernel-Modus (Ring-0) DynCode-Unterstützung](dyncode-compiler-kernel-mode-dyncode.md)
- [MIR-Pass-Design — Prinzipien und Interpose-Punkte](dyncode-compiler-mir-pass-design.md)
- [DynCode-Pipeline, MIR & PIC-Strategie (Design-Notizen)](dyncode-compiler-pipeline-and-pic.md)
- [Plattform-Erweiterungsanleitung](dyncode-compiler-platform-extension-guide.md)
- [DynCode-Compiler — Fortschrittsverfolgung](dyncode-compiler-progress.md)
...
| `-fdyncode-obfuscate=<spec>` | An **IR-Level**-Plugin-Interposes über die [Plugin-API](plugin-api.md). No-op ohne geladenes Plugin. Siehe [ir-pass-design.md §9 — Obfuscation Interposes](dyncode-compiler-ir-pass-design.md#9-obfuscation-interposes). |
| `-fdyncode-mir-obfuscate=<spec>` | An **MIR-Level**-Interposes (`RunBeforePreEmit` / `RunAfterPreEmit`). Fallback `-fdyncode-obfuscate=`. Siehe [mir-pass-design.md §3 — User Obfuscation Interposes](dyncode-compiler-mir-pass-design.md#3-benutzer-obfuskations-interposes). |
...
## Obfuskation & Plugin-Erweiterung

Die DynCode-Pipeline stellt selbst nur sicher, dass „der Code korrekt läuft“. Obfuskation, Polymorphismus, gestufte Encoder und ähnliche Features der Strategieebene sind **absichtlich nicht eingebaut** — sie werden von Out-of-Tree-Plugins über die [Plugin-API](plugin-api.md) bereitgestellt.
...
Siehe die [Plugin-API-Dokumentation](plugin-api.md) für die vollständige Interpose-Liste, Pass-Registrierung und Codebeispiele.

- IR-level: [ir-pass-design.md §9 — Obfuscation Interposes](dyncode-compiler-ir-pass-design.md#9-obfuscation-interposes).
- MIR-level: [mir-pass-design.md §3 — User Obfuscation Interposes](dyncode-compiler-mir-pass-design.md#3-benutzer-obfuskations-interposes)
---
