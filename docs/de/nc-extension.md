**Sprachen**: [English](../nc-extension.md) | [简体中文](../zh-CN/nc-extension.md) | [繁體中文](../zh-TW/nc-extension.md) | [日本語](../ja/nc-extension.md) | [한국어](../ko/nc-extension.md) | [Français](../fr/nc-extension.md) | [Deutsch](nc-extension.md) | [Español](../es/nc-extension.md) | [Italiano](../it/nc-extension.md) | [Русский](../ru/nc-extension.md) | [العربية](../ar/nc-extension.md)
...
- `-fdyncode` kombiniert sich natürlich mit `.nc`: Der DynCode-Modus aktiviert `string` bereits, und `.nc` stellt sicher, dass auch `neverc-types` aktiv ist
...
| DynCode-Projekt | Beides möglich — `-fdyncode` aktiviert `string` in jedem Fall |
