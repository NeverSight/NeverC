**Sprachen**: [English](../vbs-enclave.md) | [简体中文](../zh-CN/vbs-enclave.md) | [繁體中文](../zh-TW/vbs-enclave.md) | [日本語](../ja/vbs-enclave.md) | [한국어](../ko/vbs-enclave.md) | [Français](../fr/vbs-enclave.md) | [Deutsch](vbs-enclave.md) | [Español](../es/vbs-enclave.md) | [Italiano](../it/vbs-enclave.md) | [Русский](../ru/vbs-enclave.md) | [العربية](../ar/vbs-enclave.md)
...
Die x64-Laufzeitprüfung führt zuerst das Microsoft-Image und anschließend beide NeverC-Kandidaten aus. Sie ermittelt eine exportierte Funktion mit `GetProcAddress`, ruft sie wiederholt über `CallEnclave` auf, deckt CFG-geschützte und ältere indirekte Aufrufpfade ab und prüft die Rückgabewerte. `PASS` erfordert geordnete Nachweise für jede Lebenszyklusphase einschließlich erfolgreicher Beendigung und Freigabe; Laden und Initialisieren allein reichen nicht aus. In diesem Workflow wird ARM64 durch statische Prüfung und differentielles Linken abgedeckt; die reguläre Laufzeitprüfung bleibt auf x64 beschränkt.

Eine separate Prüfung auf nativem Windows 11 ARM64 war am 2026-09-11 erfolgreich ([Lauf 34554067852](https://github.com/NeverSight/NeverC/actions/runs/34554067852)). Sie verwendete beide aus `c46e3a4cc4b3732823a7241a43bca6c44b0f0b74` gebauten NeverC-ARM64-DLLs erneut und prüfte sie zusammen mit einem neu gebauten MSVC-Referenzimage. Alle 48 Lebenszyklusphasen und 12 Aufrufe mit geprüften Ergebnissen bestanden; auch die Beendigung und Freigabe der Enklaven sowie die Bereinigung des Signaturzertifikats waren erfolgreich. Dies bestätigt diese festgelegten Artefakte, nicht einen neuen Build des NeverC-Compilers oder ein dauerhaftes ARM64-Laufzeit-CI-Gate.
