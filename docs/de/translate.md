...
Core v2 unterstützt private und geschützte Datenmember in ansonsten unterstützten Standard-Layout-Klassen. Das eingebettete Clang prüft den Zugriff vor der Übersetzung; zulässige Methoden, Konstruktoren, Fabrikfunktionen, Standardargumente sowie generierte Kopier- und Verschiebeoperationen verwenden denselben typisierten Memberspeicher. Unzulässiger externer Zugriff bleibt eine C++-Diagnose. Zugriffsspezifizierer sind Quellsprachregeln und bieten keine Geheimhaltung zur Laufzeit. Klassen ohne Standardlayout mit gemischten Zugriffsebenen, Friend-Templates, Vererbung und nicht unterstützte Feldtypen bleiben eingeschränkt. Native Ergebnisse erfordern CI der implementierenden Revision.

Core v2 unterstützt aufgelöste Nicht-Template-Friend-Funktionen und Friend-Typen in unterstützten Klassen. ADL für versteckte Friends, Operatoren, Standardargumente, Namensraumdefinitionen, Friend-Klassen und ausgewählte Friend-Member behalten Clangs Zugriffskontrolle und normale typisierte Aufrufe. Wiederholte Deklarationen behalten dieselbe Funktionsidentität. Nicht unterstützte oder abhängige Friend-Formen und Friend-Templates bleiben abgewiesen; alle Friend-Funktionskörper werden geprüft. Native Ergebnisse erfordern CI der implementierenden Revision.
