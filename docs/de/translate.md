...
Core v2 unterstützt gewöhnliche benutzerdefinierte Konstruktoren für Record-Typen mit Standardlayout und trivialem Kopieren. Lokale Objekte, Felder und Array-Elemente entstehen direkt im endgültigen Speicher; Felder werden in Deklarationsreihenfolge initialisiert. Explizit als default markierte oder delegierende Konstruktoren, benutzerdefinierte Kopier-/Move-Konstruktoren und Ausnahmen fehlen noch.
