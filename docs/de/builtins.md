**Languages**: [English](../builtins.md) | [简体中文](../zh-CN/builtins.md) | [繁體中文](../zh-TW/builtins.md) | [日本語](../ja/builtins.md) | [한국어](../ko/builtins.md) | [Français](../fr/builtins.md) | [Deutsch](builtins.md) | [Español](../es/builtins.md) | [Italiano](../it/builtins.md) | [Русский](../ru/builtins.md) | [العربية](../ar/builtins.md)
...
|------------|------|----------|-------------|
| [**`string`**](builtins-string.md) | `-fbuiltin-string` | Aus | Wertesemantischer String-Typ mit Punkt-Aufruf-Methoden, automatischer Speicherverwaltung und nativem UTF-8 |
| [**`mimalloc`**](builtins-mimalloc.md) | `-fbuiltin-mimalloc` | **An** | Hochleistungs-Speicherallokator, der `malloc`/`free`/`calloc`/`realloc` transparent ersetzt |
| [**`xorstr`**](builtins-xorstr.md) | `-fencrypt-call-strings` | Aus | Instanzbezogene Kompilierzeitverschlüsselung, verpflichtende späte Versiegelung, Expansion pro Aufrufstelle und volatile Stack-Bereinigung |
| [**`strhash`**](builtins-strhash.md) | `-fstrhash-algo` / `-fstrhash-fold` | Aus | Kompilierzeit-Zeichenketten-Hashing, übereinstimmende Laufzeit, optionaler IR-Fold |
...
> **Hinweis:** `xorstr` verwendet nicht das Embedded-Bitcode-Modell. `semaBuiltinNeverCXorstr` in `SemaCheckingBuiltinNeverC.cpp` senkt das explizite Makro ab. `EncryptCallStringsPass` und `XorStrCleanupPass` versiegeln automatische Literale und Klartext-Stack-Speicher vor IPO sowie nach jeder späten normalen oder Plugin-IR-Phase. `FinalizeXorStrPass` rekeyt und expandiert explizite Decoder erst an einer echten nativen Maschinencode-Grenze und entfernt anschließend den gemeinsamen Hilfsgraphen. Details und den Reproduzierbarkeitsvertrag enthält die [xorstr-Dokumentation](builtins-xorstr.md).

> **Hinweis:** `strhash` verwendet ebenfalls kein eingebettetes Bitcode-Modell. [`NC_STRHASH(s)`](builtins-strhash.md) wird in Sema zu einer Konstante gefaltet; `-fstrhash-fold` aktiviert `StrHashFoldPass`. Siehe [strhash-Dokumentation](builtins-strhash.md).
