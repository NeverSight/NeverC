**Sprachen**: [English](../dyncode-compiler-progress.md) | [简体中文](../zh-CN/dyncode-compiler-progress.md) | [繁體中文](../zh-TW/dyncode-compiler-progress.md) | [日本語](../ja/dyncode-compiler-progress.md) | [한국어](../ko/dyncode-compiler-progress.md) | [Français](../fr/dyncode-compiler-progress.md) | [Deutsch](dyncode-compiler-progress.md) | [Español](../es/dyncode-compiler-progress.md) | [Italiano](../it/dyncode-compiler-progress.md) | [Русский](../ru/dyncode-compiler-progress.md) | [العربية](../ar/dyncode-compiler-progress.md)
...
- [x] Verzeichnis- & CMake-Skelett (`nevercDynCode`-Bibliothek)
...
**Tests**: 108/108 DynCode-Assertions bestanden. Binärgrößen: `add` 8B, `fib` 64B, `hello` 64B, `big_const` 632B.
...
- [x] Plattformübergreifende `-mdyncode-syscall`-Semantik (ersetzt Darwin-only `-mdyncode-libsystem`)
- [x] Linux / Android Syscall-Nummerntabellen (Darwin BSD 100+, Linux arm64 130+, Linux x86_64 150+)
- [x] `DynCodeExtractor` refaktoriert in `MachOExtractor` / `ELFExtractor` / `COFFExtractor`
...
- [x] MIR + Byte-Level-Obfuskationsinterposes (11 Interposes über IR/MIR/Byte-Stream-Schichten)
- [x] AArch64 Nicht-Darwin `long double` automatisches Downgrade auf binary64
- [x] DynCode-Shim-Header: `<windows.h>`, `<unistd.h>`, `<fcntl.h>`, `<sys/stat.h>`, `<sys/mman.h>`, `<string.h>`, `<stdlib.h>`
...
**Tests**: 743+ DynCode-Assertions, alle bestanden über 8 Triples. Gesamte NeverC-Suite: 1000+ Tests bestanden.

## Phase 2 — Druckbare / Alphanumerische Encoder (geplant)

- [ ] ARM64 druckbarer DynCode-Encoder (0x20–0x7e Instruktionssubset)
...
- [ ] Anti-Erkennung: Vermeidung bekannter DynCode-Signaturmuster
