**Sprachen**: [English](../plugin-api.md) | [简体中文](../zh-CN/plugin-api.md) | [繁體中文](../zh-TW/plugin-api.md) | [日本語](../ja/plugin-api.md) | [한국어](../ko/plugin-api.md) | [Français](../fr/plugin-api.md) | [Deutsch](plugin-api.md) | [Español](../es/plugin-api.md) | [Italiano](../it/plugin-api.md) | [Русский](../ru/plugin-api.md) | [العربية](../ar/plugin-api.md)
...
| Leitfaden | Inhalt |
|---|---|
| [Python-Plugins](plugin-api-python.md) | Optionales eingebettetes Python, Lebenszyklus, Optionen, schreibgeschützte Observer, Diagnosen und aktuelle Grenzen |
| [Driver-API](plugin-api-driver.md) | [Kommandozeile](plugin-api-driver.md#rohe-argumente), [Toolchain-Auswahl](plugin-api-driver.md#toolchain-auswahl), [Aktionsgraph](plugin-api-driver.md#der-aktionsgraph), [Job-Graph](plugin-api-driver.md#der-job-graph) |
| [Source- und E/A-API](plugin-api-source.md) | [VFS-Provider](plugin-api-source.md#anbieter-für-virtuelle-dateisysteme), [Quellpositionen](plugin-api-source.md#quelltextpositionen), [Puffer](plugin-api-source.md#dateien-lesen), [Ausgabesenken](plugin-api-source.md#ausgaben-schreiben), [Abhängigkeiten](plugin-api-source.md#abhängigkeiten-festhalten) |
| [Präprozessor-API](plugin-api-prep.md) | [Token](plugin-api-prep.md#token-lesen), [Makros](plugin-api-prep.md#bezeichner-und-makros), [Pragmas](plugin-api-prep.md#pragmas-und-feature-abfragen), [Includes](plugin-api-prep.md#ein-include-umleiten), [Feature-Abfragen](plugin-api-prep.md#pragmas-und-feature-abfragen), [39 Ereignisarten](plugin-api-prep.md#ereignisabonnement) |
| [AST- und Semantik-API](plugin-api-ast-sema.md) | [Parser-Erweiterung](plugin-api-ast-sema.md#parser-erweiterung), [AST-Mutation](plugin-api-ast-sema.md#bauen-und-verändern), [Namensauflösung](plugin-api-ast-sema.md#semantische-abfragen), [Typen](plugin-api-ast-sema.md#typisierte-zugriffsfunktionen), [Konstanten](plugin-api-ast-sema.md#semantische-abfragen) |
| [IR-API](plugin-api-ir.md) | [LLVM-IR lesen](plugin-api-ir.md#ein-modul-durchlaufen), [transaktionales Bauen](plugin-api-ir.md#transaktionale-veränderung), [Analysen](plugin-api-ir.md#analysen), [Passes](plugin-api-ir.md#durchläufe), [Provider](plugin-api-ir.md#erzeugung-und-optimierung-ersetzen) |
| [MIR-API](plugin-api-mir.md) | [Maschinenfunktionen](plugin-api-mir.md#mir-lesen), [Register](plugin-api-mir.md#register), [Stackframes](plugin-api-mir.md#der-stackframe), [MIR-Passes und -Analysen](plugin-api-mir.md#passes) |
| [Target, MC, Assembly, Objekt](plugin-api-target-mc-object.md) | [Target-Registrierung](plugin-api-target-mc-object.md#ein-target-registrieren), [Aufrufkonventionen](plugin-api-target-mc-object.md#abi-und-aufrufkonventionen), [MC-Kodierung](plugin-api-target-mc-object.md#encoder-decoder-und-layout), [Objektgraphen](plugin-api-target-mc-object.md#objektgraphen) |
| [Link- und LTO-API](plugin-api-link-lto.md) | [Link-Graph](plugin-api-link-lto.md#den-graphen-lesen), [Symbolauflösung](plugin-api-link-lto.md#den-graphen-verändern), [GC/ICF](plugin-api-link-lto.md#die-zustandsmaschine), [Linker- und LTO-Provider](plugin-api-link-lto.md#provider) |
| [DynCode-API](plugin-api-dyncode.md) | [Flache positionsunabhängige Images](plugin-api-dyncode.md#abbild-bericht-und-begrenzte-byte-änderungen), [Import-Lowering](plugin-api-dyncode.md#externe-referenzen-und-import-absenkung), [Zeichensatzkodierung](plugin-api-dyncode.md#abbild-bericht-und-begrenzte-byte-änderungen) |
| [Eigene Aufrufkonventionen](plugin-api-custom-callconv.md) | [Datengetriebene Aufrufkonventions-Plugins](plugin-api-custom-callconv.md#spec-format) |
| [Nachweis der Phasenabdeckung](../plugin-api-coverage.json) | Testzuordnung für jede stabile Phase |
