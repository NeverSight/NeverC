**Sprachen**: [English](../../dyncode-compiler/README.md) | [简体中文](../../zh-CN/dyncode-compiler/README.md) | [繁體中文](../../zh-TW/dyncode-compiler/README.md) | [日本語](../../ja/dyncode-compiler/README.md) | [한국어](../../ko/dyncode-compiler/README.md) | [Français](../../fr/dyncode-compiler/README.md) | [Deutsch](README.md) | [Español](../../es/dyncode-compiler/README.md) | [Italiano](../../it/dyncode-compiler/README.md) | [Русский](../../ru/dyncode-compiler/README.md) | [العربية](../../ar/dyncode-compiler/README.md)
...
- [ARM64 (AArch64) Assembly-Tutorial — DynCode-Perspektive](arm64-assembly-tutorial.md)
- [NeverC DynCode Cross-Platform-Architektur — Überblick](cross-platform-architecture.md)
- [IR-Pass-Design — Prinzipien, Pipeline und Vorher/Nachher-Beispiele](ir-pass-design.md)
- [Kernel-Modus (Ring-0) DynCode-Unterstützung](kernel-mode-dyncode.md)
- [MIR-Pass-Design — Prinzipien und Interpose-Punkte](mir-pass-design.md)
- [DynCode-Pipeline, MIR & PIC-Strategie (Design-Notizen)](pipeline-and-pic.md)
- [Plattform-Erweiterungsanleitung](platform-extension-guide.md)
- [DynCode-Compiler — Fortschrittsverfolgung](progress.md)
- [Roadmap](roadmap.md)
...
| `-fdyncode-obfuscate=<spec>` | An **IR-Level**-Plugin-Interposes über die [Plugin-API](../plugin-api/README.md). No-op ohne geladenes Plugin. Siehe [ir-pass-design.md §9 — Obfuscation Interposes](ir-pass-design.md#9-obfuscation-interposes). |
| `-fdyncode-mir-obfuscate=<spec>` | An **MIR-Level**-Interposes (`RunBeforePreEmit` / `RunAfterPreEmit`). Fallback `-fdyncode-obfuscate=`. Siehe [mir-pass-design.md §3 — User Obfuscation Interposes](mir-pass-design.md#3-benutzer-obfuskations-interposes). |
...
Die DynCode-Pipeline stellt selbst nur sicher, dass „der Code korrekt läuft“. Obfuskation, Polymorphismus, gestufte Encoder und ähnliche Features der Strategieebene sind **absichtlich nicht eingebaut** — sie werden von Out-of-Tree-Plugins über die [Plugin-API](../plugin-api/README.md) bereitgestellt.
...
Siehe die [Plugin-API-Dokumentation](../plugin-api/README.md) für die vollständige Interpose-Liste, Pass-Registrierung und Codebeispiele.

- IR-level: [ir-pass-design.md §9 — Obfuscation Interposes](ir-pass-design.md#9-obfuscation-interposes).
- MIR-level: [mir-pass-design.md §3 — User Obfuscation Interposes](mir-pass-design.md#3-benutzer-obfuskations-interposes)
---
