**Sprachen**: [English](../../dyncode-compiler/mir-pass-design.md) | [简体中文](../../zh-CN/dyncode-compiler/mir-pass-design.md) | [繁體中文](../../zh-TW/dyncode-compiler/mir-pass-design.md) | [日本語](../../ja/dyncode-compiler/mir-pass-design.md) | [한국어](../../ko/dyncode-compiler/mir-pass-design.md) | [Français](../../fr/dyncode-compiler/mir-pass-design.md) | [Deutsch](mir-pass-design.md) | [Español](../../es/dyncode-compiler/mir-pass-design.md) | [Italiano](../../it/dyncode-compiler/mir-pass-design.md) | [Русский](../../ru/dyncode-compiler/mir-pass-design.md) | [العربية](../../ar/dyncode-compiler/mir-pass-design.md)

[← DynCode-Compiler](README.md)

# MIR-Pass-Design — Prinzipien und Interpose-Punkte

> Begleitdokument zu [ir-pass-design.md](ir-pass-design.md). Die IR-Schicht eliminiert Konstrukte, die auf IR-Ebene sichtbar Relocations erzeugen. Die MIR-Schicht dient als **Auffangnetz** nach Befehlsauswahl und Registerallokation: sie entfernt codegen-eingeführte Pseudo-/Metadaten-Befehle und bietet Interpose-Punkte für Drittanbieter-Obfuskations-Passes.
>
...
- **Drittanbieter**: [Plugin-API](../plugin-api/README.md) (`NEVERC_INTERPOSE_SC_*` Interposes).
