**Sprachen**: [English](../dyncode-compiler-platform-extension-guide.md) | [简体中文](../zh-CN/dyncode-compiler-platform-extension-guide.md) | [繁體中文](../zh-TW/dyncode-compiler-platform-extension-guide.md) | [日本語](../ja/dyncode-compiler-platform-extension-guide.md) | [한국어](../ko/dyncode-compiler-platform-extension-guide.md) | [Français](../fr/dyncode-compiler-platform-extension-guide.md) | [Deutsch](dyncode-compiler-platform-extension-guide.md) | [Español](../es/dyncode-compiler-platform-extension-guide.md) | [Italiano](../it/dyncode-compiler-platform-extension-guide.md) | [Русский](../ru/dyncode-compiler-platform-extension-guide.md) | [العربية](../ar/dyncode-compiler-platform-extension-guide.md)

[← DynCode-Compiler](dyncode-compiler.md)

# Plattform-Erweiterungsanleitung

Dieses Dokument erklärt, wie der DynCode-Compiler auf neue Zielplattformen erweitert wird. Aktuell unterstützt: **arm64 / x86_64 auf macOS / Linux / Android / Windows** (8 Triples), jeweils mit unabhängigen **User** / **Kernel** Kontexten (16 Varianten insgesamt). Das Hinzufügen einer neuen Plattform erfordert typischerweise einige hundert Codezeilen.
...
| `DriverInjectFlags` | Plattformspezifische Flags im DynCode-Modus | null → keine Injektion |
...
2. Deklaration im DynCode-Zweig von `lib/Headers/windows.h` spiegeln
...
2. Case in `DynCodeExtractor.cpp`s Dispatch-Switch hinzufügen
...
- **ABI-Unterschiede**: Win64 (rcx/rdx/r8/r9) vs System V AMD64 (rdi/rsi/rdx/rcx/r8/r9) haben komplett verschiedene Argumentregister. Dies wird in der NeverC-Frontend-Schicht behandelt; die DynCode-Pipeline muss sich nicht darum kümmern.
...
Die DynCode-Pipeline exponiert 11 Interposes über `Pipeline.h::ObfuscationInterposes` für Drittanbieter-Obfuskationsbibliotheken:
