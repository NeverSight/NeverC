...
| Leitfaden | Inhalt |
|---|---|
| [Python-Plugins](python.md) | Optionales eingebettetes Python, Lebenszyklus, Optionen, schreibgeschützte Observer, Diagnosen und aktuelle Grenzen |
| [Driver-API](driver.md) | [Kommandozeile](driver.md#rohe-argumente), [Toolchain-Auswahl](driver.md#toolchain-auswahl), [Aktionsgraph](driver.md#der-aktionsgraph), [Job-Graph](driver.md#der-job-graph) |
| [Source- und E/A-API](source.md) | [VFS-Provider](source.md#anbieter-für-virtuelle-dateisysteme), [Quellpositionen](source.md#quelltextpositionen), [Puffer](source.md#dateien-lesen), [Ausgabesenken](source.md#ausgaben-schreiben), [Abhängigkeiten](source.md#abhängigkeiten-festhalten) |
| [Präprozessor-API](prep.md) | [Token](prep.md#token-lesen), [Makros](prep.md#bezeichner-und-makros), [Pragmas](prep.md#pragmas-und-feature-abfragen), [Includes](prep.md#ein-include-umleiten), [Feature-Abfragen](prep.md#pragmas-und-feature-abfragen), [39 Ereignisarten](prep.md#ereignisabonnement) |
| [AST- und Semantik-API](ast-sema.md) | [Parser-Erweiterung](ast-sema.md#parser-erweiterung), [AST-Mutation](ast-sema.md#bauen-und-verändern), [Namensauflösung](ast-sema.md#semantische-abfragen), [Typen](ast-sema.md#typisierte-zugriffsfunktionen), [Konstanten](ast-sema.md#semantische-abfragen) |
| [IR-API](ir.md) | [LLVM-IR lesen](ir.md#ein-modul-durchlaufen), [transaktionales Bauen](ir.md#transaktionale-veränderung), [Analysen](ir.md#analysen), [Passes](ir.md#durchläufe), [Provider](ir.md#erzeugung-und-optimierung-ersetzen) |
| [MIR-API](mir.md) | [Maschinenfunktionen](mir.md#mir-lesen), [Register](mir.md#register), [Stackframes](mir.md#der-stackframe), [MIR-Passes und -Analysen](mir.md#passes) |
| [Target, MC, Assembly, Objekt](target-mc-object.md) | [Target-Registrierung](target-mc-object.md#ein-target-registrieren), [Aufrufkonventionen](target-mc-object.md#abi-und-aufrufkonventionen), [MC-Kodierung](target-mc-object.md#encoder-decoder-und-layout), [Objektgraphen](target-mc-object.md#objektgraphen) |
| [Link- und LTO-API](link-lto.md) | [Link-Graph](link-lto.md#den-graphen-lesen), [Symbolauflösung](link-lto.md#den-graphen-verändern), [GC/ICF](link-lto.md#die-zustandsmaschine), [Linker- und LTO-Provider](link-lto.md#provider) |
| [DynCode-API](dyncode.md) | [Flache positionsunabhängige Images](dyncode.md#abbild-bericht-und-begrenzte-byte-änderungen), [Import-Lowering](dyncode.md#externe-referenzen-und-import-absenkung), [Zeichensatzkodierung](dyncode.md#abbild-bericht-und-begrenzte-byte-änderungen) |
| [Eigene Aufrufkonventionen](custom-callconv.md) | [Datengetriebene Aufrufkonventions-Plugins](custom-callconv.md#spec-format) |
