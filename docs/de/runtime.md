**Sprachen**: [English](../runtime.md) | [简体中文](../zh-CN/runtime.md) | [繁體中文](../zh-TW/runtime.md) | [日本語](../ja/runtime.md) | [한국어](../ko/runtime.md) | [Français](../fr/runtime.md) | [Deutsch](runtime.md) | [Español](../es/runtime.md) | [Italiano](../it/runtime.md) | [Русский](../ru/runtime.md) | [العربية](../ar/runtime.md)
...
- [`neverc update`](update.md) bewegt **Compiler und alle bereits
...
| Befehl | Verwendung |
|--------|------------|
| [`neverc update`](update.md) | Compiler und installierte Runtimes gemeinsam up-/downgraden |
| [`neverc build` / `make`](build.md) | Cross-Compile-Beispiele gegen diese Sysroots bauen |
| [Examples](examples.md) | Beispiel-`Makefile`s mit `--target=…` |
