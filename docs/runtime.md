**Languages**: [English](runtime.md) | [简体中文](zh-CN/runtime.md) | [繁體中文](zh-TW/runtime.md) | [日本語](ja/runtime.md) | [한국어](ko/runtime.md) | [Français](fr/runtime.md) | [Deutsch](de/runtime.md) | [Español](es/runtime.md) | [Italiano](it/runtime.md) | [Русский](ru/runtime.md) | [العربية](ar/runtime.md)
...
- [`neverc update`](update.md) moves the **compiler and all already
...
|---------|----------------|
| [`neverc update`](update.md) | Upgrade/downgrade compiler + installed runtimes together |
| [`neverc build` / `make`](build.md) | Build examples that cross-compile against these sysroots |
| [Examples](examples.md) | Sample `Makefile`s that invoke `neverc` with `--target=…` |
