...
**اللغات**: [English](../plugin-api.md) | [简体中文](../zh-CN/plugin-api.md) | [繁體中文](../zh-TW/plugin-api.md) | [日本語](../ja/plugin-api.md) | [한국어](../ko/plugin-api.md) | [Français](../fr/plugin-api.md) | [Deutsch](../de/plugin-api.md) | [Español](../es/plugin-api.md) | [Italiano](../it/plugin-api.md) | [Русский](../ru/plugin-api.md) | [العربية](plugin-api.md)
...
| الدليل | ما يغطيه |
|---|---|
| [إضافات Python](plugin-api-python.md) | Python مضمّن اختياري، ودورة الحياة، والخيارات، وobservers للقراءة فقط، والتشخيصات، والقيود الحالية |
| [واجهة المُشغِّل](plugin-api-driver.md) | [سطر الأوامر](plugin-api-driver.md#الوسائط-الخام)، [اختيار سلسلة الأدوات](plugin-api-driver.md#اختيار-سلسلة-الأدوات)، [رسم الإجراءات](plugin-api-driver.md#مخطط-الإجراءات)، [رسم المهام](plugin-api-driver.md#مخطط-المهام) |
| [واجهة المصادر والإدخال/الإخراج](plugin-api-source.md) | [مزوِّدو VFS](plugin-api-source.md#مزوّدو-نظام-الملفات-الافتراضي)، [مواقع المصدر](plugin-api-source.md#مواضع-المصدر)، [المخازن المؤقتة](plugin-api-source.md#قراءة-الملفات)، [مصارف الإخراج](plugin-api-source.md#كتابة-المخرجات)، [التبعيات](plugin-api-source.md#تسجيل-التبعيات) |
| [واجهة المعالج المسبق](plugin-api-prep.md) | [الرموز](plugin-api-prep.md#قراءة-الرموز)، [الماكرو](plugin-api-prep.md#المعرّفات-ووحدات-الماكرو)، [البراغما](plugin-api-prep.md#الـ-pragma-واستعلامات-الخصائص)، [التضمينات](plugin-api-prep.md#إعادة-توجيه-تضمين)، [استعلامات الميزات](plugin-api-prep.md#الـ-pragma-واستعلامات-الخصائص)، [39 نوعًا من الأحداث](plugin-api-prep.md#الاشتراك-في-الأحداث) |
| [واجهة الشجرة النحوية والدلالات](plugin-api-ast-sema.md) | [توسيع المُحلِّل](plugin-api-ast-sema.md#امتداد-المحلل-النحوي)، [تعديل الشجرة النحوية](plugin-api-ast-sema.md#البناء-والتعديل)، [البحث عن الأسماء](plugin-api-ast-sema.md#الاستعلامات-الدلالية)، [الأنواع](plugin-api-ast-sema.md#الموصِّلات-المُنمّطة)، [الثوابت](plugin-api-ast-sema.md#الاستعلامات-الدلالية) |
| [واجهة IR](plugin-api-ir.md) | [قراءة LLVM IR](plugin-api-ir.md#اجتياز-وحدة)، [البناء المعاملاتي](plugin-api-ir.md#التعديل-المعامَلاتي)، [التحليلات](plugin-api-ir.md#التحليلات)، [المرورات](plugin-api-ir.md#التمريرات)، [المزوِّدون](plugin-api-ir.md#استبدال-التوليد-والتحسين) |
| [واجهة MIR](plugin-api-mir.md) | [دوال الآلة](plugin-api-mir.md#قراءة-mir)، [السجلات](plugin-api-mir.md#السجلات)، [إطارات المكدس](plugin-api-mir.md#إطار-المكدس)، [مرورات وتحليلات MIR](plugin-api-mir.md#المرورات) |
| [الهدف وMC والتجميع والكائنات](plugin-api-target-mc-object.md) | [تسجيل الأهداف](plugin-api-target-mc-object.md#تسجيل-هدف)، [اصطلاحات الاستدعاء](plugin-api-target-mc-object.md#abi-واصطلاحات-الاستدعاء)، [ترميز MC](plugin-api-target-mc-object.md#المرمِّزات-والمفكِّكات-والتخطيط)، [رسوم الكائنات](plugin-api-target-mc-object.md#رسوم-الكائنات) |
| [واجهة الربط وLTO](plugin-api-link-lto.md) | [رسم الربط](plugin-api-link-lto.md#قراءة-المخطط)، [حل الرموز](plugin-api-link-lto.md#تعديل-المخطط)، [GC/ICF](plugin-api-link-lto.md#آلة-الحالات)، [مزوِّدو الرابط وLTO](plugin-api-link-lto.md#المزوِّدون) |
| [واجهة DynCode](plugin-api-dyncode.md) | [صور مسطّحة مستقلة عن الموضع](plugin-api-dyncode.md#الصورة-والتقرير-وتحرير-البايتات-المحدود)، [خفض الاستيرادات](plugin-api-dyncode.md#المراجع-الخارجية-وخفض-الاستيراد)، [ترميز مجموعة المحارف](plugin-api-dyncode.md#الصورة-والتقرير-وتحرير-البايتات-المحدود) |
| [اصطلاحات استدعاء مخصّصة](plugin-api-custom-callconv.md) | [إضافات اصطلاحات الاستدعاء المُوجَّهة بالبيانات](plugin-api-custom-callconv.md#صيغة-المواصفات) |
| [أدلة تغطية المراحل](../plugin-api-coverage.json) | ربط الاختبارات بكل مرحلة مستقرة |
