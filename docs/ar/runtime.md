...
**اللغات**: [English](../runtime.md) | [简体中文](../zh-CN/runtime.md) | [繁體中文](../zh-TW/runtime.md) | [日本語](../ja/runtime.md) | [한국어](../ko/runtime.md) | [Français](../fr/runtime.md) | [Deutsch](../de/runtime.md) | [Español](../es/runtime.md) | [Italiano](../it/runtime.md) | [Русский](../ru/runtime.md) | [العربية](runtime.md)
...
- [`neverc update`](update.md) ينقل **المترجم وكل بيئات runtime
...
| الأمر | متى تُستخدم |
|-------|-------------|
| [`neverc update`](update.md) | ترقية/تخفيض المترجم والـ runtime المثبّتة معًا |
| [`neverc build` / `make`](build.md) | بناء أمثلة الترجمة المتقاطعة على هذه الـ sysroot |
| [Examples](examples.md) | ملفات `Makefile` نموذجية مع `--target=…` |
