...
**اللغات**: [English](../examples.md) | [简体中文](../zh-CN/examples.md) | [繁體中文](../zh-TW/examples.md) | [日本語](../ja/examples.md) | [한국어](../ko/examples.md) | [Français](../fr/examples.md) | [Deutsch](../de/examples.md) | [Español](../es/examples.md) | [Italiano](../it/examples.md) | [Русский](../ru/examples.md) | [العربية](examples.md)

[← التوثيق](README.md) · [← مشروع NeverC](project.md)
...
لمشغّل Makefile نفسه، انظر [`neverc build` / `make` →](build.md).
