...
**اللغات**: [English](../plugin-api-custom-callconv.md) | [简体中文](../zh-CN/plugin-api-custom-callconv.md) | [繁體中文](../zh-TW/plugin-api-custom-callconv.md) | [日本語](../ja/plugin-api-custom-callconv.md) | [한국어](../ko/plugin-api-custom-callconv.md) | [Français](../fr/plugin-api-custom-callconv.md) | [Deutsch](../de/plugin-api-custom-callconv.md) | [Español](../es/plugin-api-custom-callconv.md) | [Italiano](../it/plugin-api-custom-callconv.md) | [Русский](../ru/plugin-api-custom-callconv.md) | [العربية](plugin-api-custom-callconv.md)
...
أما الإضافة التي تسجّل هدفًا خاصًا بها فبإمكانها بدلًا من ذلك أن توفّر رد النداء `PlanCallingConvention` في `NevercCallingConventionDescriptor` الخاص بها وتنتج الخطط مباشرة، متخطيةً طبقة المواصفات. انظر [الهدف وMC والتجميع والكائنات](plugin-api-target-mc-object.md#abi-واصطلاحات-الاستدعاء).
