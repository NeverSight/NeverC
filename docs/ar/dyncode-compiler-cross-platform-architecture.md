...
مستندات مرتبطة:
- [README.md](dyncode-compiler.md) — نظرة عامة، خيارات CLI، بدء سريع
- [ir-pass-design.md](dyncode-compiler-ir-pass-design.md) — مسؤوليات مرورات IR
- [mir-pass-design.md](dyncode-compiler-mir-pass-design.md) — طبقة MIR
- [kernel-mode-dyncode.md](dyncode-compiler-kernel-mode-dyncode.md) — سياق النواة
- [platform-extension-guide.md](dyncode-compiler-platform-extension-guide.md) — إضافة منصات
