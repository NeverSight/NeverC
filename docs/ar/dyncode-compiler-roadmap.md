...
2. **واجهة الإضافات C خارج الشجرة** — واجهة إضافات C ABI خالصة ([`NevercPluginAPI.h`]) لمرورات IR وMIR وBinary وLinker المخصصة. تُسجَّل الإضافات في 11 نقطة ربط dyncode (`NEVERC_INTERPOSE_SC_*`). SDK بملف رأس واحد، صفر تبعيات LLVM/CRT. راجع [وثائق واجهة الإضافات](plugin-api.md).
...
الاستخدام وأمثلة الكود في [وثائق Plugin API](plugin-api.md).
