...
**مكتبة تشويش من طرف ثالث**: سجّل عبر [واجهة الإضافات](../plugin-api/README.md) (خطافات `NEVERC_INTERPOSE_SC_*`).
