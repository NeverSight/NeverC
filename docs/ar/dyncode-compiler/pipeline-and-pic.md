...
- **خطافات IR**: 6 نقاط ربط IR (`NEVERC_INTERPOSE_SC_BEFORE_PREP` إلى `NEVERC_INTERPOSE_SC_AFTER_FINAL_IR`) عبر [واجهة الإضافات](../plugin-api/README.md). 11 خطافاً إجمالاً (6 IR + 3 MIR + 2 تدفق بايتات).
...
راجع [kernel-mode-dyncode.md](kernel-mode-dyncode.md).
