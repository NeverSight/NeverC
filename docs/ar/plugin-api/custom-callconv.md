...
أما الإضافة التي تسجّل هدفًا خاصًا بها فبإمكانها بدلًا من ذلك أن توفّر رد النداء `PlanCallingConvention` في `NevercCallingConventionDescriptor` الخاص بها وتنتج الخطط مباشرة، متخطيةً طبقة المواصفات. انظر [الهدف وMC والتجميع والكائنات](target-mc-object.md#abi-واصطلاحات-الاستدعاء).
