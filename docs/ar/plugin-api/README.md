...
| الدليل | ما يغطيه |
|---|---|
| [إضافات Python](python.md) | Python مضمّن اختياري، ودورة الحياة، والخيارات، وobservers للقراءة فقط، والتشخيصات، والقيود الحالية |
| [واجهة المُشغِّل](driver.md) | [سطر الأوامر](driver.md#الوسائط-الخام)، [اختيار سلسلة الأدوات](driver.md#اختيار-سلسلة-الأدوات)، [رسم الإجراءات](driver.md#مخطط-الإجراءات)، [رسم المهام](driver.md#مخطط-المهام) |
| [واجهة المصادر والإدخال/الإخراج](source.md) | [مزوِّدو VFS](source.md#مزوّدو-نظام-الملفات-الافتراضي)، [مواقع المصدر](source.md#مواضع-المصدر)، [المخازن المؤقتة](source.md#قراءة-الملفات)، [مصارف الإخراج](source.md#كتابة-المخرجات)، [التبعيات](source.md#تسجيل-التبعيات) |
| [واجهة المعالج المسبق](prep.md) | [الرموز](prep.md#قراءة-الرموز)، [الماكرو](prep.md#المعرّفات-ووحدات-الماكرو)، [البراغما](prep.md#الـ-pragma-واستعلامات-الخصائص)، [التضمينات](prep.md#إعادة-توجيه-تضمين)، [استعلامات الميزات](prep.md#الـ-pragma-واستعلامات-الخصائص)، [39 نوعًا من الأحداث](prep.md#الاشتراك-في-الأحداث) |
| [واجهة الشجرة النحوية والدلالات](ast-sema.md) | [توسيع المُحلِّل](ast-sema.md#امتداد-المحلل-النحوي)، [تعديل الشجرة النحوية](ast-sema.md#البناء-والتعديل)، [البحث عن الأسماء](ast-sema.md#الاستعلامات-الدلالية)، [الأنواع](ast-sema.md#الموصِّلات-المُنمّطة)، [الثوابت](ast-sema.md#الاستعلامات-الدلالية) |
| [واجهة IR](ir.md) | [قراءة LLVM IR](ir.md#اجتياز-وحدة)، [البناء المعاملاتي](ir.md#التعديل-المعامَلاتي)، [التحليلات](ir.md#التحليلات)، [المرورات](ir.md#التمريرات)، [المزوِّدون](ir.md#استبدال-التوليد-والتحسين) |
| [واجهة MIR](mir.md) | [دوال الآلة](mir.md#قراءة-mir)، [السجلات](mir.md#السجلات)، [إطارات المكدس](mir.md#إطار-المكدس)، [مرورات وتحليلات MIR](mir.md#المرورات) |
| [الهدف وMC والتجميع والكائنات](target-mc-object.md) | [تسجيل الأهداف](target-mc-object.md#تسجيل-هدف)، [اصطلاحات الاستدعاء](target-mc-object.md#abi-واصطلاحات-الاستدعاء)، [ترميز MC](target-mc-object.md#المرمِّزات-والمفكِّكات-والتخطيط)، [رسوم الكائنات](target-mc-object.md#رسوم-الكائنات) |
| [واجهة الربط وLTO](link-lto.md) | [رسم الربط](link-lto.md#قراءة-المخطط)، [حل الرموز](link-lto.md#تعديل-المخطط)، [GC/ICF](link-lto.md#آلة-الحالات)، [مزوِّدو الرابط وLTO](link-lto.md#المزوِّدون) |
| [واجهة DynCode](dyncode.md) | [صور مسطّحة مستقلة عن الموضع](dyncode.md#الصورة-والتقرير-وتحرير-البايتات-المحدود)، [خفض الاستيرادات](dyncode.md#المراجع-الخارجية-وخفض-الاستيراد)، [ترميز مجموعة المحارف](dyncode.md#الصورة-والتقرير-وتحرير-البايتات-المحدود) |
| [اصطلاحات استدعاء مخصّصة](custom-callconv.md) | [إضافات اصطلاحات الاستدعاء المُوجَّهة بالبيانات](custom-callconv.md#صيغة-المواصفات) |
