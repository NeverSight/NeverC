**Langues** : [English](../plugin-api.md) | [简体中文](../zh-CN/plugin-api.md) | [繁體中文](../zh-TW/plugin-api.md) | [日本語](../ja/plugin-api.md) | [한국어](../ko/plugin-api.md) | [Français](plugin-api.md) | [Deutsch](../de/plugin-api.md) | [Español](../es/plugin-api.md) | [Italiano](../it/plugin-api.md) | [Русский](../ru/plugin-api.md) | [العربية](../ar/plugin-api.md)
...
| Guide | Contenu |
|---|---|
| [Plugins Python](plugin-api-python.md) | Python embarqué facultatif, cycle de vie, options, observers en lecture seule, diagnostics et limites actuelles |
| [API Driver](plugin-api-driver.md) | [Ligne de commande](plugin-api-driver.md#arguments-bruts), [choix de la chaîne d'outils](plugin-api-driver.md#sélection-de-la-chaîne-doutils), [graphe d'actions](plugin-api-driver.md#le-graphe-dactions), [graphe de jobs](plugin-api-driver.md#le-graphe-de-tâches) |
| [API Source et E/S](plugin-api-source.md) | [Fournisseurs VFS](plugin-api-source.md#fournisseurs-de-système-de-fichiers-virtuel), [positions source](plugin-api-source.md#emplacements-source), [tampons](plugin-api-source.md#lire-des-fichiers), [puits de sortie](plugin-api-source.md#écrire-des-sorties), [dépendances](plugin-api-source.md#enregistrer-les-dépendances) |
| [API Préprocesseur](plugin-api-prep.md) | [Jetons](plugin-api-prep.md#lire-les-jetons), [macros](plugin-api-prep.md#identifiants-et-macros), [pragmas](plugin-api-prep.md#pragmas-et-requêtes-de-fonctionnalité), [inclusions](plugin-api-prep.md#rediriger-une-inclusion), [requêtes de fonctionnalités](plugin-api-prep.md#pragmas-et-requêtes-de-fonctionnalité), [39 types d'événements](plugin-api-prep.md#abonnement-aux-événements) |
| [API AST et sémantique](plugin-api-ast-sema.md) | [Extension du parseur](plugin-api-ast-sema.md#extension-de-lanalyseur-syntaxique), [mutation de l'AST](plugin-api-ast-sema.md#construire-et-modifier), [recherche de noms](plugin-api-ast-sema.md#requêtes-sémantiques), [types](plugin-api-ast-sema.md#accesseurs-typés), [constantes](plugin-api-ast-sema.md#requêtes-sémantiques) |
| [API IR](plugin-api-ir.md) | [Lecture de l'IR LLVM](plugin-api-ir.md#parcourir-un-module), [construction transactionnelle](plugin-api-ir.md#modification-transactionnelle), [analyses](plugin-api-ir.md#analyses), [passes](plugin-api-ir.md#passes), [fournisseurs](plugin-api-ir.md#remplacer-la-génération-et-loptimisation) |
| [API MIR](plugin-api-mir.md) | [Fonctions machine](plugin-api-mir.md#lire-la-mir), [registres](plugin-api-mir.md#registres), [cadres de pile](plugin-api-mir.md#le-cadre-de-pile), [passes et analyses MIR](plugin-api-mir.md#passes) |
| [Cible, MC, assembleur, objet](plugin-api-target-mc-object.md) | [Enregistrement de cible](plugin-api-target-mc-object.md#enregistrer-une-cible), [conventions d'appel](plugin-api-target-mc-object.md#abi-et-conventions-dappel), [encodage MC](plugin-api-target-mc-object.md#encodeurs-décodeurs-et-disposition), [graphes objet](plugin-api-target-mc-object.md#graphes-objet) |
| [API Link et LTO](plugin-api-link-lto.md) | [Graphe de liaison](plugin-api-link-lto.md#lire-le-graphe), [résolution de symboles](plugin-api-link-lto.md#modifier-le-graphe), [GC/ICF](plugin-api-link-lto.md#la-machine-à-états), [fournisseurs de lieur et de LTO](plugin-api-link-lto.md#fournisseurs) |
| [API DynCode](plugin-api-dyncode.md) | [Images plates indépendantes de la position](plugin-api-dyncode.md#image-rapport-et-éditions-doctets-bornées), [abaissement des imports](plugin-api-dyncode.md#références-externes-et-abaissement-des-imports), [encodage de jeu de caractères](plugin-api-dyncode.md#image-rapport-et-éditions-doctets-bornées) |
| [Conventions d'appel personnalisées](plugin-api-custom-callconv.md) | [Plugins de convention d'appel pilotés par les données](plugin-api-custom-callconv.md#format-de-la-spec) |
| [Preuves de couverture des phases](../plugin-api-coverage.json) | Correspondance des tests pour chaque phase stable |
