...
Core v2 prend en charge les constructeurs ordinaires définis par l’utilisateur pour les enregistrements à disposition standard et copie triviale. Objets locaux, champs et éléments de tableau sont construits dans leur stockage final ; les champs suivent l’ordre de déclaration. Les constructeurs explicitement default, délégués ou de copie/déplacement définis par l’utilisateur et les exceptions restent exclus.
