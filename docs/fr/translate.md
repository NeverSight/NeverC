...
Core v2 prend en charge les constructeurs ordinaires définis par l’utilisateur pour les enregistrements à disposition standard et opérations de copie prises en charge. Objets locaux, champs et éléments de tableau sont construits dans leur stockage final ; les champs suivent l’ordre de déclaration. Les constructeurs délégués ou de déplacement et les exceptions restent exclus.
