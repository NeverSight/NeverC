**Langues**: [English](../dyncode-compiler-mir-pass-design.md) | [简体中文](../zh-CN/dyncode-compiler-mir-pass-design.md) | [繁體中文](../zh-TW/dyncode-compiler-mir-pass-design.md) | [日本語](../ja/dyncode-compiler-mir-pass-design.md) | [한국어](../ko/dyncode-compiler-mir-pass-design.md) | [Français](dyncode-compiler-mir-pass-design.md) | [Deutsch](../de/dyncode-compiler-mir-pass-design.md) | [Español](../es/dyncode-compiler-mir-pass-design.md) | [Italiano](../it/dyncode-compiler-mir-pass-design.md) | [Русский](../ru/dyncode-compiler-mir-pass-design.md) | [العربية](../ar/dyncode-compiler-mir-pass-design.md)

[← Compilateur dyncode](dyncode-compiler.md)

# Conception des passes MIR — Principes et points de interpose

> Document compagnon de [ir-pass-design.md](dyncode-compiler-ir-pass-design.md). La couche IR élimine les constructions qui produisent visiblement des relocalisations. La couche MIR sert de **filet de sécurité** après la sélection d'instructions et l'allocation de registres : elle supprime les pseudo-instructions/métadonnées introduites par le codegen et expose des points de interpose pour les passes d'obfuscation tierces.
>
...
- **Tiers** : [API Plugin](plugin-api.md) (interposes `NEVERC_INTERPOSE_SC_*`).
