**Langues**: [English](../runtime.md) | [简体中文](../zh-CN/runtime.md) | [繁體中文](../zh-TW/runtime.md) | [日本語](../ja/runtime.md) | [한국어](../ko/runtime.md) | [Français](runtime.md) | [Deutsch](../de/runtime.md) | [Español](../es/runtime.md) | [Italiano](../it/runtime.md) | [Русский](../ru/runtime.md) | [العربية](../ar/runtime.md)
...
- [`neverc update`](update.md) déplace le **compilateur et tous
...
|----------|------------------|
| [`neverc update`](update.md) | Monter/descendre compilateur + runtimes installés ensemble |
| [`neverc build` / `make`](build.md) | Construire les exemples de compilation croisée contre ces sysroots |
| [Examples](examples.md) | `Makefile`s d’exemple avec `--target=…` |
