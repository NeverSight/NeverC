**Langues**: [English](../builtins-string.md) | [简体中文](../zh-CN/builtins-string.md) | [繁體中文](../zh-TW/builtins-string.md) | [日本語](../ja/builtins-string.md) | [한국어](../ko/builtins-string.md) | [Français](builtins-string.md) | [Deutsch](../de/builtins-string.md) | [Español](../es/builtins-string.md) | [Italiano](../it/builtins-string.md) | [Русский](../ru/builtins-string.md) | [العربية](../ar/builtins-string.md)

[← Système de Runtime Intégré NeverC](builtins.md) · [Documentation NeverC](README.md)
...
- Le fichier d'entrée a l'extension `.nc` (voir [documentation de l'extension `.nc`](nc-extension.md))
- Le mode `-fdyncode` est actif
