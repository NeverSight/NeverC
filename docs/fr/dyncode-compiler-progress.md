**Langues**: [English](../dyncode-compiler-progress.md) | [简体中文](../zh-CN/dyncode-compiler-progress.md) | [繁體中文](../zh-TW/dyncode-compiler-progress.md) | [日本語](../ja/dyncode-compiler-progress.md) | [한국어](../ko/dyncode-compiler-progress.md) | [Français](dyncode-compiler-progress.md) | [Deutsch](../de/dyncode-compiler-progress.md) | [Español](../es/dyncode-compiler-progress.md) | [Italiano](../it/dyncode-compiler-progress.md) | [Русский](../ru/dyncode-compiler-progress.md) | [العربية](../ar/dyncode-compiler-progress.md)

[← Compilateur dyncode](dyncode-compiler.md)

# Compilateur dyncode — Suivi de progression

## Phase 0 — macOS arm64 MVP (livré)

- [x] Squelette répertoire & CMake (bibliothèque `nevercDynCode`)
...
**Tests** : 108/108 assertions dyncode réussies. Tailles binaires : `add` 8B, `fib` 64B, `hello` 64B, `big_const` 632B.

## Phase 1 — Linux / Android / Windows multiplateforme (livré)

- [x] Abstraction `TargetDesc` : différences de plateforme pilotées par table
- [x] Sémantique `-mdyncode-syscall` multiplateforme (remplace `-mdyncode-libsystem` Darwin-only)
- [x] Tables de numéros de syscall Linux / Android (Darwin BSD 100+, Linux arm64 130+, Linux x86_64 150+)
- [x] `DynCodeExtractor` refactorisé en `MachOExtractor` / `ELFExtractor` / `COFFExtractor`
...
- [x] Interposes d'obfuscation MIR + niveau octet (11 interposes sur les couches IR/MIR/flux d'octets)
- [x] Rétrogradation automatique AArch64 non-Darwin `long double` en binary64
- [x] En-têtes shim dyncode : `<windows.h>`, `<unistd.h>`, `<fcntl.h>`, `<sys/stat.h>`, `<sys/mman.h>`, `<string.h>`, `<stdlib.h>`
...
**Tests** : 743+ assertions dyncode, toutes réussies sur 8 triples. Suite NeverC complète : 1000+ tests réussis.

## Phase 2 — Encodeur imprimable / alphanumérique (planifié)

- [ ] Encodeur dyncode imprimable ARM64 (sous-ensemble d'instructions 0x20–0x7e)
...
- [ ] Anti-détection : éviter les motifs de signature dyncode connus
