**Langues**: [English](../../plugin-api/custom-callconv.md) | [简体中文](../../zh-CN/plugin-api/custom-callconv.md) | [繁體中文](../../zh-TW/plugin-api/custom-callconv.md) | [日本語](../../ja/plugin-api/custom-callconv.md) | [한국어](../../ko/plugin-api/custom-callconv.md) | [Français](custom-callconv.md) | [Deutsch](../../de/plugin-api/custom-callconv.md) | [Español](../../es/plugin-api/custom-callconv.md) | [Italiano](../../it/plugin-api/custom-callconv.md) | [Русский](../../ru/plugin-api/custom-callconv.md) | [العربية](../../ar/plugin-api/custom-callconv.md)

[← ABI de plugin NeverC](README.md)
...
Un plugin qui enregistre sa propre cible peut au contraire fournir un rappel `PlanCallingConvention` sur son `NevercCallingConventionDescriptor` et produire directement des plans, en sautant la couche spec. Voir [Cible, MC, assembleur, objet](target-mc-object.md#abi-et-conventions-dappel).
