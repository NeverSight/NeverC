**Langues** : [English](../../plugin-api/README.md) | [简体中文](../../zh-CN/plugin-api/README.md) | [繁體中文](../../zh-TW/plugin-api/README.md) | [日本語](../../ja/plugin-api/README.md) | [한국어](../../ko/plugin-api/README.md) | [Français](README.md) | [Deutsch](../../de/plugin-api/README.md) | [Español](../../es/plugin-api/README.md) | [Italiano](../../it/plugin-api/README.md) | [Русский](../../ru/plugin-api/README.md) | [العربية](../../ar/plugin-api/README.md)
...
| Guide | Contenu |
|---|---|
| [Plugins Python](python.md) | Python embarqué facultatif, cycle de vie, options, observers en lecture seule, diagnostics et limites actuelles |
| [API Driver](driver.md) | [Ligne de commande](driver.md#arguments-bruts), [choix de la chaîne d'outils](driver.md#sélection-de-la-chaîne-doutils), [graphe d'actions](driver.md#le-graphe-dactions), [graphe de jobs](driver.md#le-graphe-de-tâches) |
| [API Source et E/S](source.md) | [Fournisseurs VFS](source.md#fournisseurs-de-système-de-fichiers-virtuel), [positions source](source.md#emplacements-source), [tampons](source.md#lire-des-fichiers), [puits de sortie](source.md#écrire-des-sorties), [dépendances](source.md#enregistrer-les-dépendances) |
| [API Préprocesseur](prep.md) | [Jetons](prep.md#lire-les-jetons), [macros](prep.md#identifiants-et-macros), [pragmas](prep.md#pragmas-et-requêtes-de-fonctionnalité), [inclusions](prep.md#rediriger-une-inclusion), [requêtes de fonctionnalités](prep.md#pragmas-et-requêtes-de-fonctionnalité), [39 types d'événements](prep.md#abonnement-aux-événements) |
| [API AST et sémantique](ast-sema.md) | [Extension du parseur](ast-sema.md#extension-de-lanalyseur-syntaxique), [mutation de l'AST](ast-sema.md#construire-et-modifier), [recherche de noms](ast-sema.md#requêtes-sémantiques), [types](ast-sema.md#accesseurs-typés), [constantes](ast-sema.md#requêtes-sémantiques) |
| [API IR](ir.md) | [Lecture de l'IR LLVM](ir.md#parcourir-un-module), [construction transactionnelle](ir.md#modification-transactionnelle), [analyses](ir.md#analyses), [passes](ir.md#passes), [fournisseurs](ir.md#remplacer-la-génération-et-loptimisation) |
| [API MIR](mir.md) | [Fonctions machine](mir.md#lire-la-mir), [registres](mir.md#registres), [cadres de pile](mir.md#le-cadre-de-pile), [passes et analyses MIR](mir.md#passes) |
| [Cible, MC, assembleur, objet](target-mc-object.md) | [Enregistrement de cible](target-mc-object.md#enregistrer-une-cible), [conventions d'appel](target-mc-object.md#abi-et-conventions-dappel), [encodage MC](target-mc-object.md#encodeurs-décodeurs-et-disposition), [graphes objet](target-mc-object.md#graphes-objet) |
| [API Link et LTO](link-lto.md) | [Graphe de liaison](link-lto.md#lire-le-graphe), [résolution de symboles](link-lto.md#modifier-le-graphe), [GC/ICF](link-lto.md#la-machine-à-états), [fournisseurs de lieur et de LTO](link-lto.md#fournisseurs) |
| [API DynCode](dyncode.md) | [Images plates indépendantes de la position](dyncode.md#image-rapport-et-éditions-doctets-bornées), [abaissement des imports](dyncode.md#références-externes-et-abaissement-des-imports), [encodage de jeu de caractères](dyncode.md#image-rapport-et-éditions-doctets-bornées) |
| [Conventions d'appel personnalisées](custom-callconv.md) | [Plugins de convention d'appel pilotés par les données](custom-callconv.md#format-de-la-spec) |
