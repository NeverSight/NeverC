**Languages**: [English](build.md) | [简体中文](zh-CN/build.md) | [繁體中文](zh-TW/build.md) | [日本語](ja/build.md) | [한국어](ko/build.md) | [Français](fr/build.md) | [Deutsch](de/build.md) | [Español](es/build.md) | [Italiano](it/build.md) | [Русский](ru/build.md) | [العربية](ar/build.md)
...
functions, and run recipes. Example projects under [`examples/`](examples.md)
...
| [`neverc run`](run.md) | Temporary compile-and-run on the host |
| [`neverc runtime`](runtime.md) | Install sysroots needed by cross `--target` builds |
| [Release binaries and `--strip`](release-builds.md) | Strip final linked images for distribution |
