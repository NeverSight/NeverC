**Languages**: [English](run.md) | [简体中文](zh-CN/run.md) | [繁體中文](zh-TW/run.md) | [日本語](ja/run.md) | [한국어](ko/run.md) | [Français](fr/run.md) | [Deutsch](de/run.md) | [Español](es/run.md) | [Italiano](it/run.md) | [Русский](ru/run.md) | [العربية](ar/run.md)
...
| [`neverc build` / `neverc make`](build.md) | GNU Make–compatible builds driven by a Makefile |
