...
11 хуков обфускации (`NEVERC_INTERPOSE_SC_*`). Философия диагностики: 1 ошибка = 1 действенная диагностика. См. [Plugin API — Точки подключения](../../plugin-api/README.ru.md#5-точки-подключения) и [kernel-mode-dyncode.md](../kernel-mode-dyncode/README.ru.md).
