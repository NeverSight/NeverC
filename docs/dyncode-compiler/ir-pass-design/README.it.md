...
11 interpose di offuscamento. Filosofia diagnostica: 1 errore = 1 diagnostica azionabile. Vedere [mir-pass-design.md §3](../mir-pass-design/README.it.md#3-interpose-di-offuscamento-utente) e [kernel-mode-dyncode.md](../kernel-mode-dyncode/README.it.md).
