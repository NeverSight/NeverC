...
11 interposes d'obfuscation. Philosophie de diagnostic : 1 erreur = 1 diagnostic actionnable. Voir [mir-pass-design.md §3](../mir-pass-design/README.fr.md#3-interposes-dobfuscation-utilisateur) et [kernel-mode-dyncode.md](../kernel-mode-dyncode/README.fr.md).
