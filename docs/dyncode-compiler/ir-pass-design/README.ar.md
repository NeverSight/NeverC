...
11 خطاف تشويش. فلسفة التشخيص: خطأ واحد = تشخيص واحد قابل للتنفيذ. راجع [mir-pass-design.md §3](../mir-pass-design/README.ar.md#3-خطافات-تشويش-المستخدم) و[kernel-mode-dyncode.md](../kernel-mode-dyncode/README.ar.md).
