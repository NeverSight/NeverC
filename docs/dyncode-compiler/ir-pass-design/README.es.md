...
11 interposes de ofuscación. Filosofía de diagnóstico: 1 error = 1 diagnóstico accionable. Ver [mir-pass-design.md §3](../mir-pass-design/README.es.md#3-interposes-de-ofuscación-del-usuario) y [kernel-mode-dyncode.md](../kernel-mode-dyncode/README.es.md).
