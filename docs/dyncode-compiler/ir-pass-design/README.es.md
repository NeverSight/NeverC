...
11 interposes de ofuscación (`NEVERC_INTERPOSE_SC_*`). Filosofía de diagnóstico: 1 error = 1 diagnóstico accionable. Ver [Plugin API — Puntos de enganche](../../plugin-api/README.es.md#5-puntos-de-enganche) y [kernel-mode-dyncode.md](../kernel-mode-dyncode/README.es.md).
