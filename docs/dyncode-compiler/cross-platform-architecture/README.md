...
- [mir-pass-design.md](../mir-pass-design/README.md) — MIR-layer prep pass + obfuscation interposes
- [kernel-mode-dyncode.md](../kernel-mode-dyncode/README.md) — kernel context design details
