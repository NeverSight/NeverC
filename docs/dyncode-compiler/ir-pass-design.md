...
DynCode exposes 11 obfuscation interpose points (6 IR-level, 3 MIR-level, 2 byte-level) for third-party obfuscation passes. See [mir-pass-design.md §3 — User Obfuscation Interposes](mir-pass-design.md#3-user-obfuscation-interposes) for the full list.
