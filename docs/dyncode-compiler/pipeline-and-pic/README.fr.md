...
- **Interposes IR** : 6 points d'accroche IR (`NEVERC_INTERPOSE_SC_BEFORE_PREP` à `NEVERC_INTERPOSE_SC_AFTER_FINAL_IR`) via l'[API Plugin](../../plugin-api/README.fr.md). `NEVERC_INTERPOSE_SC_AFTER_FINAL_IR` est le vrai dernier point d'injection IR — aucune passe après. 11 points de interpose total (6 IR + 3 MIR + 2 flux d'octets).
...
Voir [kernel-mode-dyncode.md](../kernel-mode-dyncode/README.fr.md) pour les détails.
