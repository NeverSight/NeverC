...
- [ir-pass-design.md](ir-pass-design.md) — IR-layer pass responsibilities and examples
- [mir-pass-design.md](mir-pass-design.md) — MIR-layer prep pass + obfuscation interposes
- [kernel-mode-dyncode.md](kernel-mode-dyncode.md) — kernel context design details
- [platform-extension-guide.md](platform-extension-guide.md) — step-by-step guide for adding new platforms
