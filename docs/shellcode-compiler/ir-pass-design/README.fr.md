...
11 hooks d'obfuscation (`NEVERC_HOOK_SC_*`). Philosophie de diagnostic : 1 erreur = 1 diagnostic actionnable. Voir [Plugin API — Points d'accrochage](../../plugin-api/README.fr.md#5-points-daccrochage) et [kernel-mode-shellcode.md](../kernel-mode-shellcode/README.fr.md).
