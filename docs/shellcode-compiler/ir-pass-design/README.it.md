...
11 hook di offuscamento (`NEVERC_HOOK_SC_*`). Filosofia diagnostica: 1 errore = 1 diagnostica azionabile. Vedere [Plugin API — Punti di aggancio](../../plugin-api/README.it.md#5-punti-di-aggancio) e [kernel-mode-shellcode.md](../kernel-mode-shellcode/README.it.md).
