...
- **SDK إضافات Finalize**: `Plugin.h` يكشف `registerBadByteRewriteStrategy` و`registerCharsetEncoder`. راجع [plugin-interface.md §2–§3](../plugin-interface/README.ar.md#2-bad-byte-rewriter-badbyterewritestrategy).
