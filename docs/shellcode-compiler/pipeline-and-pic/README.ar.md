...
- **خطافات IR**: 6 نقاط ربط IR (`NEVERC_HOOK_SC_BEFORE_PREP` إلى `NEVERC_HOOK_SC_AFTER_FINAL_IR`) عبر [واجهة الإضافات](../../plugin-api/README.ar.md). 11 خطافاً إجمالاً (6 IR + 3 MIR + 2 تدفق بايتات).
