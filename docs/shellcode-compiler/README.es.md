...
[← Índice de documentación](../README.es.md) · [← Proyecto NeverC](../../README.es.md)
...
**Nivel flujo de bytes (3 hooks, `SmallVectorImpl<uint8_t> &`)**:
