...
- [x] Tables de numéros de syscall Linux / Android (Darwin BSD 80+, Linux arm64 60+, Linux x86_64 90+)
...
- [x] Liste blanche Win32 API multi-DLL (~190 API sur kernel32/ntdll/user32/ws2_32/advapi32/shell32)
