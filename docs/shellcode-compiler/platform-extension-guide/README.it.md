...
Aggiungere riga `cross_compile_check` in `run_cross_target_tests.sh`.
...
- **Differenze ABI**: Win64 vs System V AMD64 hanno registri argomento completamente diversi. Gestito a livello frontend Clang.
