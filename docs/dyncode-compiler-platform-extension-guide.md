**Languages**: [English](dyncode-compiler-platform-extension-guide.md) | [简体中文](zh-CN/dyncode-compiler-platform-extension-guide.md) | [繁體中文](zh-TW/dyncode-compiler-platform-extension-guide.md) | [日本語](ja/dyncode-compiler-platform-extension-guide.md) | [한국어](ko/dyncode-compiler-platform-extension-guide.md) | [Français](fr/dyncode-compiler-platform-extension-guide.md) | [Deutsch](de/dyncode-compiler-platform-extension-guide.md) | [Español](es/dyncode-compiler-platform-extension-guide.md) | [Italiano](it/dyncode-compiler-platform-extension-guide.md) | [Русский](ru/dyncode-compiler-platform-extension-guide.md) | [العربية](ar/dyncode-compiler-platform-extension-guide.md)

[← DynCode Compiler](dyncode-compiler.md)

# Platform Extension Guide

This document explains how to extend the dyncode compiler to new target platforms. Currently supported: **arm64 / x86_64 on macOS / Linux / Android / Windows** (8 triples), each with independent **User** / **Kernel** contexts (16 variants total). Adding a new platform typically requires a few hundred lines of code.
...
| `DriverInjectFlags` | Platform-specific flags injected in dyncode mode | null → none injected |
...
2. Mirror the declaration in `lib/Headers/windows.h`'s dyncode branch
...
2. Add a case in `DynCodeExtractor.cpp`'s dispatch switch
...
- **ABI differences**: Win64 (rcx/rdx/r8/r9) vs System V AMD64 (rdi/rsi/rdx/rcx/r8/r9) have completely different argument registers. This is handled at the NeverC frontend layer; the dyncode pipeline does not need to care.
...
The dyncode pipeline exposes 11 interpose points via `Pipeline.h::ObfuscationInterposes` for third-party obfuscation libraries:
...
// Register via Plugin API: NEVERC_INTERPOSE_SC_* interposes (see plugin-api docs)
```
