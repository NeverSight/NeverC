...
| 指南 | 覆盖内容 |
|---|---|
| [Python 插件](python.md) | 可选的嵌入式 Python、生命周期、选项、只读 observer、诊断与当前限制 |
| [驱动 API](driver.md) | [命令行](driver.md#原始参数)、[工具链选择](driver.md#工具链选择)、[action 图](driver.md#action-图)、[job 图](driver.md#job-图) |
| [源与 I/O API](source.md) | [VFS Provider](source.md#虚拟文件系统-provider)、[源位置](source.md#源位置)、[缓冲区](source.md#读文件)、[输出 sink](source.md#写输出)、[依赖](source.md#记录依赖) |
| [预处理器 API](prep.md) | [token](prep.md#读取-token)、[宏](prep.md#标识符与宏)、[pragma](prep.md#pragma-与特性查询)、[include](prep.md#重定向一个-include)、[特性查询](prep.md#pragma-与特性查询)、[39 种事件](prep.md#事件订阅) |
| [AST 与语义 API](ast-sema.md) | [解析器扩展](ast-sema.md#解析器扩展)、[AST 修改](ast-sema.md#构造与修改)、[名字查找](ast-sema.md#语义查询)、[类型](ast-sema.md#带类型的访问器)、[常量](ast-sema.md#语义查询) |
| [IR API](ir.md) | [LLVM IR 读取](ir.md#遍历模块)、[事务式构造](ir.md#事务式修改)、[分析](ir.md#分析)、[pass](ir.md#pass)、[Provider](ir.md#替换生成与优化) |
| [MIR API](mir.md) | [机器函数](mir.md#读取-mir)、[寄存器](mir.md#寄存器)、[栈帧](mir.md#栈帧)、[MIR pass 与分析](mir.md#pass) |
| [Target、MC、汇编、目标文件](target-mc-object.md) | [目标注册](target-mc-object.md#注册目标)、[调用约定](target-mc-object.md#abi-与调用约定)、[MC 编码](target-mc-object.md#编码器解码器与布局)、[目标文件图](target-mc-object.md#目标文件图) |
| [链接与 LTO API](link-lto.md) | [链接图](link-lto.md#读取图)、[符号决议](link-lto.md#修改图)、[GC/ICF](link-lto.md#状态机)、[链接器与 LTO Provider](link-lto.md#provider) |
| [DynCode API](dyncode.md) | [扁平位置无关映像](dyncode.md#镜像报告与有界字节修改)、[导入降级](dyncode.md#外部引用与-import-降级)、[字符集编码](dyncode.md#镜像报告与有界字节修改) |
| [自定义调用约定](custom-callconv.md) | [数据驱动的调用约定插件](custom-callconv.md#spec-格式) |
