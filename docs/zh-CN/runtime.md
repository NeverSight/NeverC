**语言**: [English](../runtime.md) | [简体中文](runtime.md) | [繁體中文](../zh-TW/runtime.md) | [日本語](../ja/runtime.md) | [한국어](../ko/runtime.md) | [Français](../fr/runtime.md) | [Deutsch](../de/runtime.md) | [Español](../es/runtime.md) | [Italiano](../it/runtime.md) | [Русский](../ru/runtime.md) | [العربية](../ar/runtime.md)
...
- [`neverc update`](update.md) 把**编译器与所有已安装 runtime**
  作为一次事务同步到同一标签。
...
| 命令 | 适用场景 |
|------|----------|
| [`neverc update`](update.md) | 编译器与已装 runtime 一起升级/降级 |
| [`neverc build` / `make`](build.md) | 构建依赖这些 sysroot 的交叉编译示例 |
| [示例](examples.md) | 带 `--target=…` 的示例 `Makefile` |
