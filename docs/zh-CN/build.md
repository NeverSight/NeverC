**语言**: [English](../build.md) | [简体中文](build.md) | [繁體中文](../zh-TW/build.md) | [日本語](../ja/build.md) | [한국어](../ko/build.md) | [Français](../fr/build.md) | [Deutsch](../de/build.md) | [Español](../es/build.md) | [Italiano](../it/build.md) | [Русский](../ru/build.md) | [العربية](../ar/build.md)
...
命令：读取 Makefile、展开变量与函数并执行配方。[`examples/`](examples.md)
下的示例均按此工作流编写。
...
`adb` 的 `run` 目标。详见 [示例](examples.md)。
...
| [`neverc run`](run.md) | 本机临时编译并运行 |
| [`neverc runtime`](runtime.md) | 安装交叉 `--target` 所需的 sysroot |
| [发布二进制与 `--strip`](release-builds.md) | 为分发剥离最终链接映像 |
