**语言**: [English](../plugin-api.md) | [简体中文](plugin-api.md) | [繁體中文](../zh-TW/plugin-api.md) | [日本語](../ja/plugin-api.md) | [한국어](../ko/plugin-api.md) | [Français](../fr/plugin-api.md) | [Deutsch](../de/plugin-api.md) | [Español](../es/plugin-api.md) | [Italiano](../it/plugin-api.md) | [Русский](../ru/plugin-api.md) | [العربية](../ar/plugin-api.md)
...
| 指南 | 覆盖内容 |
|---|---|
| [Python 插件](plugin-api-python.md) | 可选的嵌入式 Python、生命周期、选项、只读 observer、诊断与当前限制 |
| [驱动 API](plugin-api-driver.md) | [命令行](plugin-api-driver.md#原始参数)、[工具链选择](plugin-api-driver.md#工具链选择)、[action 图](plugin-api-driver.md#action-图)、[job 图](plugin-api-driver.md#job-图) |
| [源与 I/O API](plugin-api-source.md) | [VFS Provider](plugin-api-source.md#虚拟文件系统-provider)、[源位置](plugin-api-source.md#源位置)、[缓冲区](plugin-api-source.md#读文件)、[输出 sink](plugin-api-source.md#写输出)、[依赖](plugin-api-source.md#记录依赖) |
| [预处理器 API](plugin-api-prep.md) | [token](plugin-api-prep.md#读取-token)、[宏](plugin-api-prep.md#标识符与宏)、[pragma](plugin-api-prep.md#pragma-与特性查询)、[include](plugin-api-prep.md#重定向一个-include)、[特性查询](plugin-api-prep.md#pragma-与特性查询)、[39 种事件](plugin-api-prep.md#事件订阅) |
| [AST 与语义 API](plugin-api-ast-sema.md) | [解析器扩展](plugin-api-ast-sema.md#解析器扩展)、[AST 修改](plugin-api-ast-sema.md#构造与修改)、[名字查找](plugin-api-ast-sema.md#语义查询)、[类型](plugin-api-ast-sema.md#带类型的访问器)、[常量](plugin-api-ast-sema.md#语义查询) |
| [IR API](plugin-api-ir.md) | [LLVM IR 读取](plugin-api-ir.md#遍历模块)、[事务式构造](plugin-api-ir.md#事务式修改)、[分析](plugin-api-ir.md#分析)、[pass](plugin-api-ir.md#pass)、[Provider](plugin-api-ir.md#替换生成与优化) |
| [MIR API](plugin-api-mir.md) | [机器函数](plugin-api-mir.md#读取-mir)、[寄存器](plugin-api-mir.md#寄存器)、[栈帧](plugin-api-mir.md#栈帧)、[MIR pass 与分析](plugin-api-mir.md#pass) |
| [Target、MC、汇编、目标文件](plugin-api-target-mc-object.md) | [目标注册](plugin-api-target-mc-object.md#注册目标)、[调用约定](plugin-api-target-mc-object.md#abi-与调用约定)、[MC 编码](plugin-api-target-mc-object.md#编码器解码器与布局)、[目标文件图](plugin-api-target-mc-object.md#目标文件图) |
| [链接与 LTO API](plugin-api-link-lto.md) | [链接图](plugin-api-link-lto.md#读取图)、[符号决议](plugin-api-link-lto.md#修改图)、[GC/ICF](plugin-api-link-lto.md#状态机)、[链接器与 LTO Provider](plugin-api-link-lto.md#provider) |
| [DynCode API](plugin-api-dyncode.md) | [扁平位置无关映像](plugin-api-dyncode.md#镜像报告与有界字节修改)、[导入降级](plugin-api-dyncode.md#外部引用与-import-降级)、[字符集编码](plugin-api-dyncode.md#镜像报告与有界字节修改) |
| [自定义调用约定](plugin-api-custom-callconv.md) | [数据驱动的调用约定插件](plugin-api-custom-callconv.md#spec-格式) |
| [阶段覆盖证据](../plugin-api-coverage.json) | 每个稳定阶段的测试映射 |
...
[`Schema/PhaseSchema.json`] 是阶段 ID、策略、稳定性层级和验证器关卡的规范来源。
[`PluginPhaseSchema.h`] 及其包含的生成文件 [`Schema/PluginPhaseSchema.inc`] 把它们
全都暴露为编译期常量——以阶段 `neverc.ir.pass.pipeline_start` 为例：
...
包含聚合头文件 [`NevercPluginAPI.h`]，或者只包含你用到的领域：
