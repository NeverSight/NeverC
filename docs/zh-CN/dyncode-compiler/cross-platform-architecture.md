...
相关子系统文档：
- [README.md](README.md) — 概述、CLI 选项、快速开始
- [ir-pass-design.md](ir-pass-design.md) — IR 层 pass 职责与示例
- [mir-pass-design.md](mir-pass-design.md) — MIR 层 prep pass + 混淆钩子
- [kernel-mode-dyncode.md](kernel-mode-dyncode.md) — 内核上下文设计细节
- [platform-extension-guide.md](platform-extension-guide.md) — 添加新平台的分步指南
