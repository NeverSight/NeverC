...
DynCode 为第三方混淆 pass 提供 11 个混淆钩子点（6 个 IR 级、3 个 MIR 级、2 个字节级）。完整清单详见 [mir-pass-design.md 第 3 节](mir-pass-design.md#3-用户混淆钩子)。
