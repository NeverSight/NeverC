**语言**: [English](../examples.md) | [简体中文](examples.md) | [繁體中文](../zh-TW/examples.md) | [日本語](../ja/examples.md) | [한국어](../ko/examples.md) | [Français](../fr/examples.md) | [Deutsch](../de/examples.md) | [Español](../es/examples.md) | [Italiano](../it/examples.md) | [Русский](../ru/examples.md) | [العربية](../ar/examples.md)
...
关于 Makefile 驱动本身，见 [`neverc build` / `make` →](build.md)。
