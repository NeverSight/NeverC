...
| 指南 | 涵蓋內容 |
|---|---|
| [Python 外掛](python.md) | 選用的嵌入式 Python、生命週期、選項、唯讀 observer、diagnostic 與目前限制 |
| [驅動程式 API](driver.md) | [命令列](driver.md#原始引數)、[工具鏈選擇](driver.md#工具鏈選擇)、[action 圖](driver.md#action-圖)、[job 圖](driver.md#job-圖) |
| [Source 與 I/O API](source.md) | [VFS Provider](source.md#虛擬檔案系統-provider)、[原始碼位置](source.md#原始碼位置)、[緩衝區](source.md#讀取檔案)、[輸出 sink](source.md#寫出輸出)、[相依性](source.md#記錄相依) |
| [前置處理器 API](prep.md) | [token](prep.md#讀取-token)、[巨集](prep.md#識別字與巨集)、[pragma](prep.md#pragma-與功能查詢)、[include](prep.md#導向另一個-include)、[特性查詢](prep.md#pragma-與功能查詢)、[39 種事件](prep.md#事件訂閱) |
| [AST 與語意 API](ast-sema.md) | [剖析器擴充](ast-sema.md#剖析器擴充)、[AST 變更](ast-sema.md#建構與變更)、[名稱查找](ast-sema.md#語意查詢)、[型別](ast-sema.md#具型別的存取器)、[常數](ast-sema.md#語意查詢) |
| [IR API](ir.md) | [LLVM IR 讀取](ir.md#走訪模組)、[交易式建構](ir.md#交易式變更)、[分析](ir.md#分析)、[pass](ir.md#pass)、[Provider](ir.md#取代產生與最佳化) |
| [MIR API](mir.md) | [機器函式](mir.md#讀取-mir)、[暫存器](mir.md#暫存器)、[堆疊框](mir.md#堆疊框架)、[MIR pass 與分析](mir.md#pass) |
| [Target、MC、組合語言、目的檔](target-mc-object.md) | [目標註冊](target-mc-object.md#註冊一個目標)、[呼叫慣例](target-mc-object.md#abi-與呼叫慣例)、[MC 編碼](target-mc-object.md#編碼器解碼器與版面配置)、[目的檔圖](target-mc-object.md#目的檔圖) |
| [連結與 LTO API](link-lto.md) | [連結圖](link-lto.md#讀取圖)、[符號解析](link-lto.md#變更圖)、[GC/ICF](link-lto.md#狀態機)、[連結器與 LTO Provider](link-lto.md#provider) |
| [DynCode API](dyncode.md) | [扁平位置無關映像](dyncode.md#映像報告與有界的位元組編輯)、[匯入降級](dyncode.md#外部參考與匯入降階)、[字元集編碼](dyncode.md#映像報告與有界的位元組編輯) |
| [自訂呼叫慣例](custom-callconv.md) | [資料驅動的呼叫慣例外掛](custom-callconv.md#spec-格式) |
