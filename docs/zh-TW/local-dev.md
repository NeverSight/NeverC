**語言**: [English](../local-dev.md) | [简体中文](../zh-CN/local-dev.md) | [繁體中文](local-dev.md) | [日本語](../ja/local-dev.md) | [한국어](../ko/local-dev.md) | [Français](../fr/local-dev.md) | [Deutsch](../de/local-dev.md) | [Español](../es/local-dev.md) | [Italiano](../it/local-dev.md) | [Русский](../ru/local-dev.md) | [العربية](../ar/local-dev.md)
...
兩階段 bootstrap 細節見 [Builtins](builtins/README.md)。
...
Windows dyncode（`-fdyncode`、PEB 匯入解析等）詳見 [dyncode 編譯器文件](dyncode-compiler/README.md)。
