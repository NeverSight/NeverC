**語言**: [English](../runtime.md) | [简体中文](../zh-CN/runtime.md) | [繁體中文](runtime.md) | [日本語](../ja/runtime.md) | [한국어](../ko/runtime.md) | [Français](../fr/runtime.md) | [Deutsch](../de/runtime.md) | [Español](../es/runtime.md) | [Italiano](../it/runtime.md) | [Русский](../ru/runtime.md) | [العربية](../ar/runtime.md)
...
- [`neverc update`](update.md) 把**編譯器與所有已安裝 runtime**
  作為一次事務同步到同一標籤。
...
| 命令 | 適用場景 |
|------|----------|
| [`neverc update`](update.md) | 編譯器與已裝 runtime 一起升級/降級 |
| [`neverc build` / `make`](build.md) | 構建依賴這些 sysroot 的交叉編譯範例 |
| [範例](examples.md) | 帶 `--target=…` 的範例 `Makefile` |
