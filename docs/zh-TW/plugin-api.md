**語言**: [English](../plugin-api.md) | [简体中文](../zh-CN/plugin-api.md) | [繁體中文](plugin-api.md) | [日本語](../ja/plugin-api.md) | [한국어](../ko/plugin-api.md) | [Français](../fr/plugin-api.md) | [Deutsch](../de/plugin-api.md) | [Español](../es/plugin-api.md) | [Italiano](../it/plugin-api.md) | [Русский](../ru/plugin-api.md) | [العربية](../ar/plugin-api.md)
...
| 指南 | 涵蓋內容 |
|---|---|
| [Python 外掛](plugin-api-python.md) | 選用的嵌入式 Python、生命週期、選項、唯讀 observer、diagnostic 與目前限制 |
| [驅動程式 API](plugin-api-driver.md) | [命令列](plugin-api-driver.md#原始引數)、[工具鏈選擇](plugin-api-driver.md#工具鏈選擇)、[action 圖](plugin-api-driver.md#action-圖)、[job 圖](plugin-api-driver.md#job-圖) |
| [Source 與 I/O API](plugin-api-source.md) | [VFS Provider](plugin-api-source.md#虛擬檔案系統-provider)、[原始碼位置](plugin-api-source.md#原始碼位置)、[緩衝區](plugin-api-source.md#讀取檔案)、[輸出 sink](plugin-api-source.md#寫出輸出)、[相依性](plugin-api-source.md#記錄相依) |
| [前置處理器 API](plugin-api-prep.md) | [token](plugin-api-prep.md#讀取-token)、[巨集](plugin-api-prep.md#識別字與巨集)、[pragma](plugin-api-prep.md#pragma-與功能查詢)、[include](plugin-api-prep.md#導向另一個-include)、[特性查詢](plugin-api-prep.md#pragma-與功能查詢)、[39 種事件](plugin-api-prep.md#事件訂閱) |
| [AST 與語意 API](plugin-api-ast-sema.md) | [剖析器擴充](plugin-api-ast-sema.md#剖析器擴充)、[AST 變更](plugin-api-ast-sema.md#建構與變更)、[名稱查找](plugin-api-ast-sema.md#語意查詢)、[型別](plugin-api-ast-sema.md#具型別的存取器)、[常數](plugin-api-ast-sema.md#語意查詢) |
| [IR API](plugin-api-ir.md) | [LLVM IR 讀取](plugin-api-ir.md#走訪模組)、[交易式建構](plugin-api-ir.md#交易式變更)、[分析](plugin-api-ir.md#分析)、[pass](plugin-api-ir.md#pass)、[Provider](plugin-api-ir.md#取代產生與最佳化) |
| [MIR API](plugin-api-mir.md) | [機器函式](plugin-api-mir.md#讀取-mir)、[暫存器](plugin-api-mir.md#暫存器)、[堆疊框](plugin-api-mir.md#堆疊框架)、[MIR pass 與分析](plugin-api-mir.md#pass) |
| [Target、MC、組合語言、目的檔](plugin-api-target-mc-object.md) | [目標註冊](plugin-api-target-mc-object.md#註冊一個目標)、[呼叫慣例](plugin-api-target-mc-object.md#abi-與呼叫慣例)、[MC 編碼](plugin-api-target-mc-object.md#編碼器解碼器與版面配置)、[目的檔圖](plugin-api-target-mc-object.md#目的檔圖) |
| [連結與 LTO API](plugin-api-link-lto.md) | [連結圖](plugin-api-link-lto.md#讀取圖)、[符號解析](plugin-api-link-lto.md#變更圖)、[GC/ICF](plugin-api-link-lto.md#狀態機)、[連結器與 LTO Provider](plugin-api-link-lto.md#provider) |
| [DynCode API](plugin-api-dyncode.md) | [扁平位置無關映像](plugin-api-dyncode.md#映像報告與有界的位元組編輯)、[匯入降級](plugin-api-dyncode.md#外部參考與匯入降階)、[字元集編碼](plugin-api-dyncode.md#映像報告與有界的位元組編輯) |
| [自訂呼叫慣例](plugin-api-custom-callconv.md) | [資料驅動的呼叫慣例外掛](plugin-api-custom-callconv.md#spec-格式) |
| [階段涵蓋範圍證據](../plugin-api-coverage.json) | 每個穩定階段的測試對應 |
