...
相關子系統文檔：
- [README.md](README.md) — 概述、CLI 選項、快速開始
- [ir-pass-design.md](ir-pass-design.md) — IR 層 pass 職責與範例
- [mir-pass-design.md](mir-pass-design.md) — MIR 層 prep pass + 混淆掛鉤
- [kernel-mode-dyncode.md](kernel-mode-dyncode.md) — 核心上下文設計細節
- [platform-extension-guide.md](platform-extension-guide.md) — 新增平台的分步指南
