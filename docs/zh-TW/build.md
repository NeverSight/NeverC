**語言**: [English](../build.md) | [简体中文](../zh-CN/build.md) | [繁體中文](build.md) | [日本語](../ja/build.md) | [한국어](../ko/build.md) | [Français](../fr/build.md) | [Deutsch](../de/build.md) | [Español](../es/build.md) | [Italiano](../it/build.md) | [Русский](../ru/build.md) | [العربية](../ar/build.md)
...
讀取 Makefile、展開變數與函數並執行配方。[`examples/`](examples.md)
下的範例皆按此工作流編寫。
...
| [`neverc run`](run.md) | 本機暫存編譯並執行 |
| [`neverc runtime`](runtime.md) | 安裝交叉編譯 sysroot |
| [發布二進位與 `--strip`](release-builds.md) | 為發行剝離最終映像 |
