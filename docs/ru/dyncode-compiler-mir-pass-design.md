**Языки**: [English](../dyncode-compiler-mir-pass-design.md) | [简体中文](../zh-CN/dyncode-compiler-mir-pass-design.md) | [繁體中文](../zh-TW/dyncode-compiler-mir-pass-design.md) | [日本語](../ja/dyncode-compiler-mir-pass-design.md) | [한국어](../ko/dyncode-compiler-mir-pass-design.md) | [Français](../fr/dyncode-compiler-mir-pass-design.md) | [Deutsch](../de/dyncode-compiler-mir-pass-design.md) | [Español](../es/dyncode-compiler-mir-pass-design.md) | [Italiano](../it/dyncode-compiler-mir-pass-design.md) | [Русский](dyncode-compiler-mir-pass-design.md) | [العربية](../ar/dyncode-compiler-mir-pass-design.md)

[← Компилятор dyncode](dyncode-compiler.md)

# Проектирование проходов MIR — Принципы и точки хуков

> Документ-компаньон к [ir-pass-design.md](dyncode-compiler-ir-pass-design.md). Уровень IR устраняет конструкции, которые на уровне IR явно порождают релокации. Уровень MIR служит **страховочной сетью** после выбора инструкций и распределения регистров: удаляет введённые codegen псевдоинструкции/метаданные и открывает точки хуков для сторонних проходов обфускации, выполняющих финальные преобразования на уровне инструкций.
>
...
**Сторонняя библиотека обфускации**: регистрируйте через [API плагинов](plugin-api.md) (хуки `NEVERC_INTERPOSE_SC_*`).
