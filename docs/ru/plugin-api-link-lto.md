**Языки**: [English](../plugin-api-link-lto.md) | [简体中文](../zh-CN/plugin-api-link-lto.md) | [繁體中文](../zh-TW/plugin-api-link-lto.md) | [日本語](../ja/plugin-api-link-lto.md) | [한국어](../ko/plugin-api-link-lto.md) | [Français](../fr/plugin-api-link-lto.md) | [Deutsch](../de/plugin-api-link-lto.md) | [Español](../es/plugin-api-link-lto.md) | [Italiano](../it/plugin-api-link-lto.md) | [Русский](plugin-api-link-lto.md) | [العربية](../ar/plugin-api-link-lto.md)
...
пятнадцать счётчиков сущностей и 32-байтовый `SemanticDigest`. Сами сущности
