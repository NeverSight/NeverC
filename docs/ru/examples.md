**Языки**: [English](../examples.md) | [简体中文](../zh-CN/examples.md) | [繁體中文](../zh-TW/examples.md) | [日本語](../ja/examples.md) | [한국어](../ko/examples.md) | [Français](../fr/examples.md) | [Deutsch](../de/examples.md) | [Español](../es/examples.md) | [Italiano](../it/examples.md) | [Русский](examples.md) | [العربية](../ar/examples.md)

[← Документация](README.md) · [← Проект NeverC](project.md)
...
|--------|----------|---------------------|
| [Авторитетный игровой сервер](../../examples/network-authoritative-server/README.ru.md) | Кроссплатформенный игровой бэкенд | Фиксированный tick 60 Гц, TCP-сессии, ввод UDP/QUIC, защита от replay |
| [Сборщик античита](../../examples/network-anticheat-collector/README.ru.md) | Усиленный сбор телеметрии | mTLS, потоковый NRPC, HMAC-телеметрия, ограниченный конвейер аудита |
...
О самом драйвере Makefile см. [`neverc build` / `make` →](build.md).
