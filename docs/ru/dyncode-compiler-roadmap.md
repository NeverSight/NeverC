**Языки**: [English](../dyncode-compiler-roadmap.md) | [简体中文](../zh-CN/dyncode-compiler-roadmap.md) | [繁體中文](../zh-TW/dyncode-compiler-roadmap.md) | [日本語](../ja/dyncode-compiler-roadmap.md) | [한국어](../ko/dyncode-compiler-roadmap.md) | [Français](../fr/dyncode-compiler-roadmap.md) | [Deutsch](../de/dyncode-compiler-roadmap.md) | [Español](../es/dyncode-compiler-roadmap.md) | [Italiano](../it/dyncode-compiler-roadmap.md) | [Русский](dyncode-compiler-roadmap.md) | [العربية](../ar/dyncode-compiler-roadmap.md)
...
Конвейер dyncode NeverC охватывает:
...
- Ограничения размера / выравнивания / заполнения (`-fdyncode-max-length=`, `-fdyncode-align=`, `-fdyncode-pad=`)
...
2. **Внедеревный C-плагин API** — Чистый C ABI интерфейс плагинов ([`NevercPluginAPI.h`]) для пользовательских IR, MIR, Binary и Linker проходов. Плагины регистрируются в 11 точках подключения dyncode (`NEVERC_INTERPOSE_SC_*`). SDK с одним заголовком, ноль зависимостей LLVM/CRT. См. [документацию API плагинов](plugin-api.md).
...
| Module stomping / uninterposing | Плагин прохода IR | Паттерны манипуляции памятью |
...
- `RunBeforePrep` — Перед любым проходом dyncode
...
Каждый экстрактор вызывает `finalizeDynCodeBytes` перед записью `.bin`:
...
Использование и примеры кода см. в [документации Plugin API](plugin-api.md).
