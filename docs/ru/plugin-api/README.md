...
|---|---|
| [Плагины Python](python.md) | Необязательный встроенный Python, жизненный цикл, опции, read-only observers, диагностика и текущие ограничения |
| [API драйвера](driver.md) | [Командная строка](driver.md#сырые-аргументы), [выбор тулчейна](driver.md#выбор-инструментальной-цепочки), [граф действий](driver.md#граф-действий), [граф заданий](driver.md#граф-заданий) |
| [API источников и ввода-вывода](source.md) | [Провайдеры VFS](source.md#поставщики-виртуальной-файловой-системы), [позиции в исходниках](source.md#позиции-в-исходниках), [буферы](source.md#чтение-файлов), [приёмники вывода](source.md#запись-вывода), [зависимости](source.md#запись-зависимостей) |
| [API препроцессора](prep.md) | [Токены](prep.md#чтение-токенов), [макросы](prep.md#идентификаторы-и-макросы), [прагмы](prep.md#прагмы-и-запросы-возможностей), [включения](prep.md#перенаправление-включения), [запросы возможностей](prep.md#прагмы-и-запросы-возможностей), [39 видов событий](prep.md#подписка-на-события) |
| [API AST и семантики](ast-sema.md) | [Расширение парсера](ast-sema.md#расширение-синтаксического-анализатора), [изменение AST](ast-sema.md#построение-и-изменение), [поиск имён](ast-sema.md#семантические-запросы), [типы](ast-sema.md#типизированные-аксессоры), [константы](ast-sema.md#семантические-запросы) |
| [API IR](ir.md) | [Чтение LLVM IR](ir.md#обход-модуля), [транзакционное построение](ir.md#транзакционное-изменение), [анализы](ir.md#анализы), [проходы](ir.md#проходы), [провайдеры](ir.md#замена-генерации-и-оптимизации) |
| [API MIR](mir.md) | [Машинные функции](mir.md#чтение-mir), [регистры](mir.md#регистры), [кадры стека](mir.md#кадр-стека), [проходы и анализы MIR](mir.md#проходы) |
| [Целевая платформа, MC, ассемблер, объектные файлы](target-mc-object.md) | [Регистрация целевых платформ](target-mc-object.md#регистрация-целевой-платформы), [соглашения о вызовах](target-mc-object.md#abi-и-соглашения-о-вызовах), [кодирование MC](target-mc-object.md#кодировщики-декодировщики-и-раскладка), [графы объектных файлов](target-mc-object.md#объектные-графы) |
| [API компоновки и LTO](link-lto.md) | [Граф компоновки](link-lto.md#чтение-графа), [разрешение символов](link-lto.md#изменение-графа), [GC/ICF](link-lto.md#конечный-автомат), [провайдеры компоновщика и LTO](link-lto.md#провайдеры) |
| [API DynCode](dyncode.md) | [Плоские позиционно-независимые образы](dyncode.md#образ-отчёт-и-ограниченные-правки-байтов), [понижение импортов](dyncode.md#внешние-ссылки-и-понижение-импортов), [кодирование набора символов](dyncode.md#образ-отчёт-и-ограниченные-правки-байтов) |
| [Пользовательские соглашения о вызовах](custom-callconv.md) | [Плагины соглашений о вызовах, управляемые данными](custom-callconv.md#формат-спецификации) |
