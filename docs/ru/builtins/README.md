**Languages**: [English](../../builtins/README.md) | [简体中文](../../zh-CN/builtins/README.md) | [繁體中文](../../zh-TW/builtins/README.md) | [日本語](../../ja/builtins/README.md) | [한국어](../../ko/builtins/README.md) | [Français](../../fr/builtins/README.md) | [Deutsch](../../de/builtins/README.md) | [Español](../../es/builtins/README.md) | [Italiano](../../it/builtins/README.md) | [Русский](README.md) | [العربية](../../ar/builtins/README.md)
...
|-----------|------|-------------|----------|
| [**`string`**](string.md) | `-fbuiltin-string` | Выкл. | Строковый тип с семантикой значения, методы через точку, автоматическое управление памятью и нативная поддержка UTF-8 |
| [**`mimalloc`**](mimalloc.md) | `-fbuiltin-mimalloc` | **Вкл.** | Высокопроизводительный аллокатор памяти, прозрачно заменяющий `malloc`/`free`/`calloc`/`realloc` |
| [**`xorstr`**](xorstr.md) | `-fencrypt-call-strings` | Выкл. | Шифрование для каждого экземпляра, обязательное позднее запечатывание, разворачивание в точке вызова и volatile-очистка стека |
| [**`strhash`**](strhash.md) | `-fstrhash-algo` / `-fstrhash-fold` | Выкл. | Хеширование строк на этапе компиляции, тот же алгоритм во время выполнения, опциональный IR-fold |
