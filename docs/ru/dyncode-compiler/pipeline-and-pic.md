...
- **IR-хуки**: 6 точек подключения IR (`NEVERC_INTERPOSE_SC_BEFORE_PREP` — `NEVERC_INTERPOSE_SC_AFTER_FINAL_IR`) через [API плагинов](../plugin-api/README.md). 11 хуков всего (6 IR + 3 MIR + 2 байтовый поток).
...
См. [kernel-mode-dyncode.md](kernel-mode-dyncode.md).
