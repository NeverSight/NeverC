...
**Сторонняя библиотека обфускации**: регистрируйте через [API плагинов](../plugin-api/README.md) (хуки `NEVERC_INTERPOSE_SC_*`).
