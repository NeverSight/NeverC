**Языки**: [English](../runtime.md) | [简体中文](../zh-CN/runtime.md) | [繁體中文](../zh-TW/runtime.md) | [日本語](../ja/runtime.md) | [한국어](../ko/runtime.md) | [Français](../fr/runtime.md) | [Deutsch](../de/runtime.md) | [Español](../es/runtime.md) | [Italiano](../it/runtime.md) | [Русский](runtime.md) | [العربية](../ar/runtime.md)
...
- [`neverc update`](update.md) переводит **компилятор и все уже
...
|---------|--------------------|
| [`neverc update`](update.md) | Обновить/откатить компилятор + установленные runtime вместе |
| [`neverc build` / `make`](build.md) | Собирать примеры кросс-компиляции против этих sysroot |
| [Examples](examples.md) | Примеры `Makefile` с `--target=…` |
