**Языки**: [English](../dyncode-compiler-progress.md) | [简体中文](../zh-CN/dyncode-compiler-progress.md) | [繁體中文](../zh-TW/dyncode-compiler-progress.md) | [日本語](../ja/dyncode-compiler-progress.md) | [한국어](../ko/dyncode-compiler-progress.md) | [Français](../fr/dyncode-compiler-progress.md) | [Deutsch](../de/dyncode-compiler-progress.md) | [Español](../es/dyncode-compiler-progress.md) | [Italiano](../it/dyncode-compiler-progress.md) | [Русский](dyncode-compiler-progress.md) | [العربية](../ar/dyncode-compiler-progress.md)
...
- [x] Скелет каталогов и CMake (библиотека `nevercDynCode`)
...
- [x] Кроссплатформенная семантика `-mdyncode-syscall` (заменяет `-mdyncode-libsystem` только для Darwin)
- [x] Таблицы номеров syscall Linux / Android (Darwin BSD 100+, Linux arm64 130+, Linux x86_64 150+)
- [x] `DynCodeExtractor` рефакторирован в `MachOExtractor` / `ELFExtractor` / `COFFExtractor`
...
- [x] Шим-заголовки dyncode: `<windows.h>`, `<unistd.h>`, `<fcntl.h>`, `<sys/stat.h>`, `<sys/mman.h>`, `<string.h>`, `<stdlib.h>`
