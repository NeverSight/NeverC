**Языки**: [English](../plugin-api.md) | [简体中文](../zh-CN/plugin-api.md) | [繁體中文](../zh-TW/plugin-api.md) | [日本語](../ja/plugin-api.md) | [한국어](../ko/plugin-api.md) | [Français](../fr/plugin-api.md) | [Deutsch](../de/plugin-api.md) | [Español](../es/plugin-api.md) | [Italiano](../it/plugin-api.md) | [Русский](plugin-api.md) | [العربية](../ar/plugin-api.md)
...
|---|---|
| [Плагины Python](plugin-api-python.md) | Необязательный встроенный Python, жизненный цикл, опции, read-only observers, диагностика и текущие ограничения |
| [API драйвера](plugin-api-driver.md) | [Командная строка](plugin-api-driver.md#сырые-аргументы), [выбор тулчейна](plugin-api-driver.md#выбор-инструментальной-цепочки), [граф действий](plugin-api-driver.md#граф-действий), [граф заданий](plugin-api-driver.md#граф-заданий) |
| [API источников и ввода-вывода](plugin-api-source.md) | [Провайдеры VFS](plugin-api-source.md#поставщики-виртуальной-файловой-системы), [позиции в исходниках](plugin-api-source.md#позиции-в-исходниках), [буферы](plugin-api-source.md#чтение-файлов), [приёмники вывода](plugin-api-source.md#запись-вывода), [зависимости](plugin-api-source.md#запись-зависимостей) |
| [API препроцессора](plugin-api-prep.md) | [Токены](plugin-api-prep.md#чтение-токенов), [макросы](plugin-api-prep.md#идентификаторы-и-макросы), [прагмы](plugin-api-prep.md#прагмы-и-запросы-возможностей), [включения](plugin-api-prep.md#перенаправление-включения), [запросы возможностей](plugin-api-prep.md#прагмы-и-запросы-возможностей), [39 видов событий](plugin-api-prep.md#подписка-на-события) |
| [API AST и семантики](plugin-api-ast-sema.md) | [Расширение парсера](plugin-api-ast-sema.md#расширение-синтаксического-анализатора), [изменение AST](plugin-api-ast-sema.md#построение-и-изменение), [поиск имён](plugin-api-ast-sema.md#семантические-запросы), [типы](plugin-api-ast-sema.md#типизированные-аксессоры), [константы](plugin-api-ast-sema.md#семантические-запросы) |
| [API IR](plugin-api-ir.md) | [Чтение LLVM IR](plugin-api-ir.md#обход-модуля), [транзакционное построение](plugin-api-ir.md#транзакционное-изменение), [анализы](plugin-api-ir.md#анализы), [проходы](plugin-api-ir.md#проходы), [провайдеры](plugin-api-ir.md#замена-генерации-и-оптимизации) |
| [API MIR](plugin-api-mir.md) | [Машинные функции](plugin-api-mir.md#чтение-mir), [регистры](plugin-api-mir.md#регистры), [кадры стека](plugin-api-mir.md#кадр-стека), [проходы и анализы MIR](plugin-api-mir.md#проходы) |
| [Целевая платформа, MC, ассемблер, объектные файлы](plugin-api-target-mc-object.md) | [Регистрация целевых платформ](plugin-api-target-mc-object.md#регистрация-целевой-платформы), [соглашения о вызовах](plugin-api-target-mc-object.md#abi-и-соглашения-о-вызовах), [кодирование MC](plugin-api-target-mc-object.md#кодировщики-декодировщики-и-раскладка), [графы объектных файлов](plugin-api-target-mc-object.md#объектные-графы) |
| [API компоновки и LTO](plugin-api-link-lto.md) | [Граф компоновки](plugin-api-link-lto.md#чтение-графа), [разрешение символов](plugin-api-link-lto.md#изменение-графа), [GC/ICF](plugin-api-link-lto.md#конечный-автомат), [провайдеры компоновщика и LTO](plugin-api-link-lto.md#провайдеры) |
| [API DynCode](plugin-api-dyncode.md) | [Плоские позиционно-независимые образы](plugin-api-dyncode.md#образ-отчёт-и-ограниченные-правки-байтов), [понижение импортов](plugin-api-dyncode.md#внешние-ссылки-и-понижение-импортов), [кодирование набора символов](plugin-api-dyncode.md#образ-отчёт-и-ограниченные-правки-байтов) |
| [Пользовательские соглашения о вызовах](plugin-api-custom-callconv.md) | [Плагины соглашений о вызовах, управляемые данными](plugin-api-custom-callconv.md#формат-спецификации) |
| [Свидетельства покрытия фаз](../plugin-api-coverage.json) | Сопоставление тестов для каждой стабильной фазы |
