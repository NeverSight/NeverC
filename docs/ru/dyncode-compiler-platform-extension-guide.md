**Языки**: [English](../dyncode-compiler-platform-extension-guide.md) | [简体中文](../zh-CN/dyncode-compiler-platform-extension-guide.md) | [繁體中文](../zh-TW/dyncode-compiler-platform-extension-guide.md) | [日本語](../ja/dyncode-compiler-platform-extension-guide.md) | [한국어](../ko/dyncode-compiler-platform-extension-guide.md) | [Français](../fr/dyncode-compiler-platform-extension-guide.md) | [Deutsch](../de/dyncode-compiler-platform-extension-guide.md) | [Español](../es/dyncode-compiler-platform-extension-guide.md) | [Italiano](../it/dyncode-compiler-platform-extension-guide.md) | [Русский](dyncode-compiler-platform-extension-guide.md) | [العربية](../ar/dyncode-compiler-platform-extension-guide.md)

[← Компилятор dyncode](dyncode-compiler.md)

# Руководство по расширению платформ

Этот документ объясняет, как расширить компилятор dyncode для новых целевых платформ. Текущая поддержка: **arm64 / x86_64 на macOS / Linux / Android / Windows** (8 троек), каждая с независимыми контекстами **User** / **Kernel** (16 вариантов). Добавление новой платформы обычно требует нескольких сотен строк кода.
...
| `DriverInjectFlags` | Платформенные флаги в режиме dyncode | null → без инъекции |
...
- **Различия ABI**: Win64 vs System V AMD64 имеют полностью различные регистры аргументов. Обрабатывается на уровне фронтенда NeverC.
