**言語**: [English](../dyncode-compiler-roadmap.md) | [简体中文](../zh-CN/dyncode-compiler-roadmap.md) | [繁體中文](../zh-TW/dyncode-compiler-roadmap.md) | [日本語](dyncode-compiler-roadmap.md) | [한국어](../ko/dyncode-compiler-roadmap.md) | [Français](../fr/dyncode-compiler-roadmap.md) | [Deutsch](../de/dyncode-compiler-roadmap.md) | [Español](../es/dyncode-compiler-roadmap.md) | [Italiano](../it/dyncode-compiler-roadmap.md) | [Русский](../ru/dyncode-compiler-roadmap.md) | [العربية](../ar/dyncode-compiler-roadmap.md)
...
2. **アウトオブツリー C プラグイン API** — 純粋 C ABI プラグインインターフェース（[`NevercPluginAPI.h`]）。IR、MIR、Binary、Linker のカスタムパスを 11 の dyncode フックポイント（`NEVERC_INTERPOSE_SC_*`）に登録可能。単一ヘッダー SDK、LLVM/CRT 依存ゼロ。詳細は [Plugin API ドキュメント](plugin-api.md) を参照。
...
使用法とコード例は [Plugin API ドキュメント](plugin-api.md) を参照。
