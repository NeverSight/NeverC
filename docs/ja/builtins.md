**Languages**: [English](../builtins.md) | [简体中文](../zh-CN/builtins.md) | [繁體中文](../zh-TW/builtins.md) | [日本語](builtins.md) | [한국어](../ko/builtins.md) | [Français](../fr/builtins.md) | [Deutsch](../de/builtins.md) | [Español](../es/builtins.md) | [Italiano](../it/builtins.md) | [Русский](../ru/builtins.md) | [العربية](../ar/builtins.md)

[← NeverC ドキュメント](README.md)
...
| 組み込み | フラグ | デフォルト | 説明 |
|---------|--------|----------|------|
| [**`string`**](builtins-string.md) | `-fbuiltin-string` | オフ | 値セマンティクスの文字列型。ドットコールメソッド、自動メモリ管理、ネイティブ UTF-8 対応 |
| [**`mimalloc`**](builtins-mimalloc.md) | `-fbuiltin-mimalloc` | **オン** | 高性能メモリアロケータ。`malloc`/`free`/`calloc`/`realloc` を透過的に置換 |
| [**`xorstr`**](builtins-xorstr.md) | `-fencrypt-call-strings` | オフ | インスタンスごとの暗号化、必須 late seal、呼び出し箇所ごとの最終展開、volatile スタッククリア |
| [**`strhash`**](builtins-strhash.md) | `-fstrhash-algo` / `-fstrhash-fold` | オフ | コンパイル時文字列ハッシュ、実行時と同一アルゴリズム、任意 IR 畳み込み |
...
└── lib/Compiler/Preprocessor/
    └── InitPredefinedMacros.cpp          # __NEVERC_MIMALLOC__ マクロ
```
