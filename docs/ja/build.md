**言語**: [English](../build.md) | [简体中文](../zh-CN/build.md) | [繁體中文](../zh-TW/build.md) | [日本語](build.md) | [한국어](../ko/build.md) | [Français](../fr/build.md) | [Deutsch](../de/build.md) | [Español](../es/build.md) | [Italiano](../it/build.md) | [Русский](../ru/build.md) | [العربية](../ar/build.md)
...
[`examples/`](examples.md) はこの流れ向けです。
...
| [`neverc run`](run.md) | ホストで一時コンパイル実行 |
| [`neverc runtime`](runtime.md) | クロス用 sysroot の導入 |
| [リリースと `--strip`](release-builds.md) | 配布用に最終イメージを strip |
