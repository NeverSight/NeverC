**言語**: [English](../nc-extension.md) | [简体中文](../zh-CN/nc-extension.md) | [繁體中文](../zh-TW/nc-extension.md) | [日本語](nc-extension.md) | [한국어](../ko/nc-extension.md) | [Français](../fr/nc-extension.md) | [Deutsch](../de/nc-extension.md) | [Español](../es/nc-extension.md) | [Italiano](../it/nc-extension.md) | [Русский](../ru/nc-extension.md) | [العربية](../ar/nc-extension.md)
...
- `-fdyncode` は `.nc` と自然に組み合わせられます：dyncode モードはそれ自体で `string` を有効にし、`.nc` は `neverc-types` もアクティブにします
...
| DynCode プロジェクト | どちらでも可 — `-fdyncode` は `string` を常に有効化 |
