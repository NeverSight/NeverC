**言語**: [English](../runtime.md) | [简体中文](../zh-CN/runtime.md) | [繁體中文](../zh-TW/runtime.md) | [日本語](runtime.md) | [한국어](../ko/runtime.md) | [Français](../fr/runtime.md) | [Deutsch](../de/runtime.md) | [Español](../es/runtime.md) | [Italiano](../it/runtime.md) | [Русский](../ru/runtime.md) | [العربية](../ar/runtime.md)
...
- [`neverc update`](update.md) は**コンパイラと導入済み runtime すべて**を
...
| コマンド | 用途 |
|----------|------|
| [`neverc update`](update.md) | コンパイラ＋導入済み runtime の一括更新／ダウングレード |
| [`neverc build` / `make`](build.md) | これらの sysroot に依存するクロスコンパイル例のビルド |
| [Examples](examples.md) | `--target=…` を使うサンプル `Makefile` |
