**Languages**: [English](../../builtins/README.md) | [简体中文](../../zh-CN/builtins/README.md) | [繁體中文](../../zh-TW/builtins/README.md) | [日本語](README.md) | [한국어](../../ko/builtins/README.md) | [Français](../../fr/builtins/README.md) | [Deutsch](../../de/builtins/README.md) | [Español](../../es/builtins/README.md) | [Italiano](../../it/builtins/README.md) | [Русский](../../ru/builtins/README.md) | [العربية](../../ar/builtins/README.md)
...
| 組み込み | フラグ | デフォルト | 説明 |
|---------|--------|----------|------|
| [**`string`**](string.md) | `-fbuiltin-string` | オフ | 値セマンティクスの文字列型。ドットコールメソッド、自動メモリ管理、ネイティブ UTF-8 対応 |
| [**`mimalloc`**](mimalloc.md) | `-fbuiltin-mimalloc` | **オン** | 高性能メモリアロケータ。`malloc`/`free`/`calloc`/`realloc` を透過的に置換 |
| [**`xorstr`**](xorstr.md) | `-fencrypt-call-strings` | オフ | インスタンスごとの暗号化、必須 late seal、呼び出し箇所ごとの最終展開、volatile スタッククリア |
| [**`strhash`**](strhash.md) | `-fstrhash-algo` / `-fstrhash-fold` | オフ | コンパイル時文字列ハッシュ、実行時と同一アルゴリズム、任意 IR 畳み込み |
