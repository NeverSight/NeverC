**言語**: [English](../../dyncode-compiler/mir-pass-design.md) | [简体中文](../../zh-CN/dyncode-compiler/mir-pass-design.md) | [繁體中文](../../zh-TW/dyncode-compiler/mir-pass-design.md) | [日本語](mir-pass-design.md) | [한국어](../../ko/dyncode-compiler/mir-pass-design.md) | [Français](../../fr/dyncode-compiler/mir-pass-design.md) | [Deutsch](../../de/dyncode-compiler/mir-pass-design.md) | [Español](../../es/dyncode-compiler/mir-pass-design.md) | [Italiano](../../it/dyncode-compiler/mir-pass-design.md) | [Русский](../../ru/dyncode-compiler/mir-pass-design.md) | [العربية](../../ar/dyncode-compiler/mir-pass-design.md)

[← DynCode コンパイラ](README.md)

# MIR パス設計 — 原則とフックポイント

> [ir-pass-design.md](ir-pass-design.md) の姉妹文書。IR 層は IR レベルで明らかに reloc を生むコンストラクトを除去する。MIR 層は命令選択・レジスタ割当後の**キャッチオール**であり、コード生成で導入された疑似/メタデータ命令を除去し、サードパーティ難読化パスが最終命令レベル変換を行うためのフックポイントを公開する。
>
...
- **サードパーティ難読化**: [Plugin API](../plugin-api/README.md)（`NEVERC_INTERPOSE_SC_*` フック）で登録。
