...
| ガイド | 扱う範囲 |
|---|---|
| [Python プラグイン](python.md) | 任意の埋め込み Python、ライフサイクル、オプション、read-only observer、診断、現在の制限 |
| [ドライバー API](driver.md) | [コマンドライン](driver.md#生の引数)、[ツールチェーン選択](driver.md#ツールチェーンの選択)、[アクショングラフ](driver.md#アクショングラフ)、[ジョブグラフ](driver.md#ジョブグラフ) |
| [ソースと I/O API](source.md) | [VFS プロバイダー](source.md#仮想ファイルシステムプロバイダ)、[ソース位置](source.md#ソース位置)、[バッファー](source.md#ファイルの読み取り)、[出力シンク](source.md#出力の書き出し)、[依存関係](source.md#依存関係の記録) |
| [プリプロセッサー API](prep.md) | [トークン](prep.md#トークンの読み取り)、[マクロ](prep.md#識別子とマクロ)、[pragma](prep.md#pragma-と機能問い合わせ)、[include](prep.md#include-のリダイレクト)、[機能クエリ](prep.md#pragma-と機能問い合わせ)、[39 種類のイベント](prep.md#イベントの購読) |
| [AST と意味解析 API](ast-sema.md) | [パーサー拡張](ast-sema.md#パーサ拡張)、[AST 変更](ast-sema.md#構築と変更)、[名前探索](ast-sema.md#意味問い合わせ)、[型](ast-sema.md#型付きアクセサ)、[定数](ast-sema.md#意味問い合わせ) |
| [IR API](ir.md) | [LLVM IR の読み取り](ir.md#モジュールの走査)、[トランザクショナルな構築](ir.md#トランザクショナルな変更)、[解析](ir.md#解析)、[パス](ir.md#パス)、[プロバイダー](ir.md#生成と最適化の置き換え) |
| [MIR API](mir.md) | [マシン関数](mir.md#mir-の読み取り)、[レジスター](mir.md#レジスタ)、[スタックフレーム](mir.md#スタックフレーム)、[MIR パスと解析](mir.md#パス) |
| [ターゲット、MC、アセンブリ、オブジェクト](target-mc-object.md) | [ターゲット登録](target-mc-object.md#ターゲットの登録)、[呼び出し規約](target-mc-object.md#abi-と呼び出し規約)、[MC エンコード](target-mc-object.md#エンコーダーデコーダーレイアウト)、[オブジェクトグラフ](target-mc-object.md#オブジェクトグラフ) |
| [リンクと LTO API](link-lto.md) | [リンクグラフ](link-lto.md#グラフを読む)、[シンボル解決](link-lto.md#グラフを変更する)、[GC/ICF](link-lto.md#状態機械)、[リンカーと LTO プロバイダー](link-lto.md#プロバイダ) |
| [DynCode API](dyncode.md) | [フラットな位置独立イメージ](dyncode.md#イメージレポート範囲限定のバイト編集)、[インポートの低位化](dyncode.md#外部参照とインポートの低位化)、[文字セットエンコード](dyncode.md#イメージレポート範囲限定のバイト編集) |
| [カスタム呼び出し規約](custom-callconv.md) | [データ駆動の呼び出し規約プラグイン](custom-callconv.md#spec-の形式) |
