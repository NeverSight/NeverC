**言語**: [English](../builtins-string.md) | [简体中文](../zh-CN/builtins-string.md) | [繁體中文](../zh-TW/builtins-string.md) | [日本語](builtins-string.md) | [한국어](../ko/builtins-string.md) | [Français](../fr/builtins-string.md) | [Deutsch](../de/builtins-string.md) | [Español](../es/builtins-string.md) | [Italiano](../it/builtins-string.md) | [Русский](../ru/builtins-string.md) | [العربية](../ar/builtins-string.md)

[← NeverC 組み込みランタイムシステム](builtins.md) · [NeverC ドキュメント](README.md)
...
- 入力ファイルが `.nc` 拡張子の場合（[`.nc` 拡張子ドキュメント](nc-extension.md)を参照）
- `-fdyncode` モードがアクティブな場合
...
- `AlwaysInliner` は最終的にすべての関数をインライン化 — dyncode 内のスタンドアロンシンボルはゼロ
