**Idiomas**: [English](../runtime.md) | [简体中文](../zh-CN/runtime.md) | [繁體中文](../zh-TW/runtime.md) | [日本語](../ja/runtime.md) | [한국어](../ko/runtime.md) | [Français](../fr/runtime.md) | [Deutsch](../de/runtime.md) | [Español](runtime.md) | [Italiano](../it/runtime.md) | [Русский](../ru/runtime.md) | [العربية](../ar/runtime.md)
...
- [`neverc update`](update.md) mueve el **compilador y todos los
...
|---------|---------------|
| [`neverc update`](update.md) | Subir/bajar compilador + runtimes instalados juntos |
| [`neverc build` / `make`](build.md) | Construir ejemplos de compilación cruzada contra estos sysroots |
| [Examples](examples.md) | `Makefile`s de ejemplo con `--target=…` |
