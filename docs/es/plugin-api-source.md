**Idiomas**: [English](../plugin-api-source.md) | [简体中文](../zh-CN/plugin-api-source.md) | [繁體中文](../zh-TW/plugin-api-source.md) | [日本語](../ja/plugin-api-source.md) | [한국어](../ko/plugin-api-source.md) | [Français](../fr/plugin-api-source.md) | [Deutsch](../de/plugin-api-source.md) | [Español](plugin-api-source.md) | [Italiano](../it/plugin-api-source.md) | [Русский](../ru/plugin-api-source.md) | [العربية](../ar/plugin-api-source.md)
...
[`pluginsdk/examples/VirtualHeaderPlugin.c`] es un proveedor completo y funcional.
...
Consulte [`PluginSource.h`] para las declaraciones normativas,
[`Schema/PhaseSchema.json`] para las tres fases de source y sus políticas, y
