**Idiomas**: [English](../../dyncode-compiler/README.md) | [简体中文](../../zh-CN/dyncode-compiler/README.md) | [繁體中文](../../zh-TW/dyncode-compiler/README.md) | [日本語](../../ja/dyncode-compiler/README.md) | [한국어](../../ko/dyncode-compiler/README.md) | [Français](../../fr/dyncode-compiler/README.md) | [Deutsch](../../de/dyncode-compiler/README.md) | [Español](README.md) | [Italiano](../../it/dyncode-compiler/README.md) | [Русский](../../ru/dyncode-compiler/README.md) | [العربية](../../ar/dyncode-compiler/README.md)
...
- [Tutorial de ensamblaje ARM64 (AArch64) — Perspectiva DynCode](arm64-assembly-tutorial.md)
- [Arquitectura multiplataforma de NeverC DynCode — Resumen](cross-platform-architecture.md)
- [Diseño de pasadas IR — Principios, pipeline y ejemplos antes/después](ir-pass-design.md)
- [Soporte de dyncode modo kernel (Ring-0)](kernel-mode-dyncode.md)
- [Diseño de pasadas MIR — Principios y puntos de interpose](mir-pass-design.md)
- [Pipeline de DynCode, MIR y Estrategia PIC (Notas de Diseño)](pipeline-and-pic.md)
- [Guía de extensión de plataforma](platform-extension-guide.md)
- [Compilador de dyncode — Seguimiento de progreso](progress.md)
...
Los ocho triples (OS, arch) comparten **el mismo conjunto de passes**. Las diferencias están en `TargetDesc.cpp` y tres ramas de extractores. Nueva plataforma = una fila + un case por extractor. `ExecutionLevel` es ortogonal: `User` → syscall / PEB; `Kernel` desactiva ambos e inyecta `KernelImportPass` para reescribir llamadas externas mediante shims. Véase [kernel-mode-dyncode.md](kernel-mode-dyncode.md).
...
| `-fdyncode-obfuscate=<spec>` | Pasa a interposes de plugin **nivel IR** vía la [API de Plugins](../plugin-api/README.md). No-op sin plugin cargado. Ver [ir-pass-design.md §9 — Obfuscation Interposes](ir-pass-design.md#9-obfuscation-interposes). |
| `-fdyncode-mir-obfuscate=<spec>` | Pasa a interposes **nivel MIR** (`RunBeforePreEmit` / `RunAfterPreEmit`). Por defecto `-fdyncode-obfuscate=` si no se define. Ver [mir-pass-design.md §3 — User Obfuscation Interposes](mir-pass-design.md#3-interposes-de-ofuscación-del-usuario). |
...
El pipeline dyncode en sí solo garantiza que «el código se ejecute correctamente». La ofuscación, el polimorfismo, los codificadores por etapas y funciones similares de la capa de estrategia **no están integrados a propósito** — los proporcionan plugins fuera del árbol a través de la [API de Plugins](../plugin-api/README.md).
...
Consulta la [documentación de la API de Plugins](../plugin-api/README.md) para la lista completa de interposes, registro de pases y ejemplos de código.

- IR-level: [ir-pass-design.md §9 — Obfuscation Interposes](ir-pass-design.md#9-obfuscation-interposes).
- MIR-level: [mir-pass-design.md §3 — User Obfuscation Interposes](mir-pass-design.md#3-interposes-de-ofuscación-del-usuario)
---
