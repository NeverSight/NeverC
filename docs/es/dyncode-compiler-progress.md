**Idiomas**: [English](../dyncode-compiler-progress.md) | [简体中文](../zh-CN/dyncode-compiler-progress.md) | [繁體中文](../zh-TW/dyncode-compiler-progress.md) | [日本語](../ja/dyncode-compiler-progress.md) | [한국어](../ko/dyncode-compiler-progress.md) | [Français](../fr/dyncode-compiler-progress.md) | [Deutsch](../de/dyncode-compiler-progress.md) | [Español](dyncode-compiler-progress.md) | [Italiano](../it/dyncode-compiler-progress.md) | [Русский](../ru/dyncode-compiler-progress.md) | [العربية](../ar/dyncode-compiler-progress.md)

[← Compilador de dyncode](dyncode-compiler.md)

# Compilador de dyncode — Seguimiento de progreso

## Etapa 0 — macOS arm64 MVP (entregado)

- [x] Esqueleto de directorio y CMake (biblioteca `nevercDynCode`)
...
**Tests**: 108/108 aserciones de dyncode pasadas. Tamaños binarios: `add` 8B, `fib` 64B, `hello` 64B, `big_const` 632B.
...
- [x] Semántica `-mdyncode-syscall` multiplataforma (reemplaza `-mdyncode-libsystem` exclusivo de Darwin)
- [x] Tablas de números de syscall Linux / Android (Darwin BSD 100+, Linux arm64 130+, Linux x86_64 150+)
- [x] `DynCodeExtractor` refactorizado en `MachOExtractor` / `ELFExtractor` / `COFFExtractor`
...
- [x] Whitelist Win32 API multi-DLL (~210 APIs en kernel32/ntdll/user32/ws2_32/advapi32/shell32)
...
- [x] Interposes de ofuscación MIR + nivel de byte (11 interposes en capas IR/MIR/flujo de bytes)
- [x] Degradación automática de AArch64 no-Darwin `long double` a binary64
- [x] Cabeceras shim de dyncode: `<windows.h>`, `<unistd.h>`, `<fcntl.h>`, `<sys/stat.h>`, `<sys/mman.h>`, `<string.h>`, `<stdlib.h>`
...
**Tests**: 743+ aserciones de dyncode, todas pasadas en 8 triples. Suite NeverC completa: 1000+ tests pasados.

## Etapa 2 — Codificador imprimible / alfanumérico (planificado)

- [ ] Codificador de dyncode imprimible ARM64 (subconjunto de instrucciones 0x20–0x7e)
...
- [ ] Anti-detección: evitar patrones de firma de dyncode conocidos
