**Idiomas**: [English](../examples.md) | [简体中文](../zh-CN/examples.md) | [繁體中文](../zh-TW/examples.md) | [日本語](../ja/examples.md) | [한국어](../ko/examples.md) | [Français](../fr/examples.md) | [Deutsch](../de/examples.md) | [Español](examples.md) | [Italiano](../it/examples.md) | [Русский](../ru/examples.md) | [العربية](../ar/examples.md)

[← Documentación](README.md) · [← Proyecto NeverC](project.md)
...
Sobre el controlador Makefile en sí, véase [`neverc build` / `make` →](build.md).
