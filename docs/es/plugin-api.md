**Idiomas**: [English](../plugin-api.md) | [简体中文](../zh-CN/plugin-api.md) | [繁體中文](../zh-TW/plugin-api.md) | [日本語](../ja/plugin-api.md) | [한국어](../ko/plugin-api.md) | [Français](../fr/plugin-api.md) | [Deutsch](../de/plugin-api.md) | [Español](plugin-api.md) | [Italiano](../it/plugin-api.md) | [Русский](../ru/plugin-api.md) | [العربية](../ar/plugin-api.md)
...
| Guía | Cubre |
|---|---|
| [Plugins de Python](plugin-api-python.md) | Python embebido opcional, ciclo de vida, opciones, observers de solo lectura, diagnósticos y límites actuales |
| [API del driver](plugin-api-driver.md) | [Línea de órdenes](plugin-api-driver.md#argumentos-en-bruto), [selección de cadena de herramientas](plugin-api-driver.md#selección-de-la-cadena-de-herramientas), [grafo de acciones](plugin-api-driver.md#el-grafo-de-acciones), [grafo de trabajos](plugin-api-driver.md#el-grafo-de-trabajos) |
| [API de fuentes y E/S](plugin-api-source.md) | [Proveedores VFS](plugin-api-source.md#proveedores-de-sistema-de-archivos-virtual), [ubicaciones de origen](plugin-api-source.md#ubicaciones-de-fuente), [búferes](plugin-api-source.md#leer-archivos), [sumideros de salida](plugin-api-source.md#escribir-salidas), [dependencias](plugin-api-source.md#registrar-dependencias) |
| [API del preprocesador](plugin-api-prep.md) | [Tokens](plugin-api-prep.md#leer-tokens), [macros](plugin-api-prep.md#identificadores-y-macros), [pragmas](plugin-api-prep.md#pragmas-y-consultas-de-características), [inclusiones](plugin-api-prep.md#redirigir-una-inclusión), [consultas de características](plugin-api-prep.md#pragmas-y-consultas-de-características), [39 tipos de eventos](plugin-api-prep.md#suscripción-a-eventos) |
| [API de AST y semántica](plugin-api-ast-sema.md) | [Extensión del analizador](plugin-api-ast-sema.md#extensión-del-analizador-sintáctico), [mutación del AST](plugin-api-ast-sema.md#construir-y-modificar), [búsqueda de nombres](plugin-api-ast-sema.md#consultas-semánticas), [tipos](plugin-api-ast-sema.md#accesores-tipados), [constantes](plugin-api-ast-sema.md#consultas-semánticas) |
| [API de IR](plugin-api-ir.md) | [Lectura de IR de LLVM](plugin-api-ir.md#recorrer-un-módulo), [construcción transaccional](plugin-api-ir.md#modificación-transaccional), [análisis](plugin-api-ir.md#análisis), [pases](plugin-api-ir.md#pasadas), [proveedores](plugin-api-ir.md#sustituir-la-generación-y-la-optimización) |
| [API de MIR](plugin-api-mir.md) | [Funciones máquina](plugin-api-mir.md#leer-la-mir), [registros](plugin-api-mir.md#registros), [marcos de pila](plugin-api-mir.md#el-marco-de-pila), [pases y análisis de MIR](plugin-api-mir.md#pases) |
| [Destino, MC, ensamblador, objeto](plugin-api-target-mc-object.md) | [Registro de destinos](plugin-api-target-mc-object.md#registrar-un-destino), [convenciones de llamada](plugin-api-target-mc-object.md#abi-y-convenciones-de-llamada), [codificación MC](plugin-api-target-mc-object.md#codificadores-decodificadores-y-disposición), [grafos de objetos](plugin-api-target-mc-object.md#grafos-de-objetos) |
| [API de enlazado y LTO](plugin-api-link-lto.md) | [Grafo de enlazado](plugin-api-link-lto.md#leer-el-grafo), [resolución de símbolos](plugin-api-link-lto.md#modificar-el-grafo), [GC/ICF](plugin-api-link-lto.md#la-máquina-de-estados), [proveedores de enlazador y LTO](plugin-api-link-lto.md#proveedores) |
| [API de DynCode](plugin-api-dyncode.md) | [Imágenes planas independientes de la posición](plugin-api-dyncode.md#imagen-informe-y-ediciones-de-bytes-acotadas), [rebajado de importaciones](plugin-api-dyncode.md#referencias-externas-y-rebaje-de-importaciones), [codificación de juegos de caracteres](plugin-api-dyncode.md#imagen-informe-y-ediciones-de-bytes-acotadas) |
| [Convenciones de llamada personalizadas](plugin-api-custom-callconv.md) | [Complementos de convención de llamada dirigidos por datos](plugin-api-custom-callconv.md#formato-de-la-spec) |
| [Evidencia de cobertura de fases](../plugin-api-coverage.json) | Correspondencia de pruebas para cada fase estable |
