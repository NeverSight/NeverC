**Idiomas**: [English](../dyncode-compiler-mir-pass-design.md) | [简体中文](../zh-CN/dyncode-compiler-mir-pass-design.md) | [繁體中文](../zh-TW/dyncode-compiler-mir-pass-design.md) | [日本語](../ja/dyncode-compiler-mir-pass-design.md) | [한국어](../ko/dyncode-compiler-mir-pass-design.md) | [Français](../fr/dyncode-compiler-mir-pass-design.md) | [Deutsch](../de/dyncode-compiler-mir-pass-design.md) | [Español](dyncode-compiler-mir-pass-design.md) | [Italiano](../it/dyncode-compiler-mir-pass-design.md) | [Русский](../ru/dyncode-compiler-mir-pass-design.md) | [العربية](../ar/dyncode-compiler-mir-pass-design.md)

[← Compilador de dyncode](dyncode-compiler.md)

# Diseño de pasadas MIR — Principios y puntos de interpose

> Documento acompañante de [ir-pass-design.md](dyncode-compiler-ir-pass-design.md). La capa IR elimina construcciones que visiblemente producen relocalizaciones. La capa MIR sirve como **red de captura** después de la selección de instrucciones y asignación de registros: elimina pseudo-instrucciones/metadatos introducidos por codegen y expone puntos de interpose para pasadas de ofuscación de terceros.
>
...
- **Terceros**: [API de Plugins](plugin-api.md) (interposes `NEVERC_INTERPOSE_SC_*`).
