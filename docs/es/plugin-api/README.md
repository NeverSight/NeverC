**Idiomas**: [English](../../plugin-api/README.md) | [简体中文](../../zh-CN/plugin-api/README.md) | [繁體中文](../../zh-TW/plugin-api/README.md) | [日本語](../../ja/plugin-api/README.md) | [한국어](../../ko/plugin-api/README.md) | [Français](../../fr/plugin-api/README.md) | [Deutsch](../../de/plugin-api/README.md) | [Español](README.md) | [Italiano](../../it/plugin-api/README.md) | [Русский](../../ru/plugin-api/README.md) | [العربية](../../ar/plugin-api/README.md)
...
| Guía | Cubre |
|---|---|
| [Plugins de Python](python.md) | Python embebido opcional, ciclo de vida, opciones, observers de solo lectura, diagnósticos y límites actuales |
| [API del driver](driver.md) | [Línea de órdenes](driver.md#argumentos-en-bruto), [selección de cadena de herramientas](driver.md#selección-de-la-cadena-de-herramientas), [grafo de acciones](driver.md#el-grafo-de-acciones), [grafo de trabajos](driver.md#el-grafo-de-trabajos) |
| [API de fuentes y E/S](source.md) | [Proveedores VFS](source.md#proveedores-de-sistema-de-archivos-virtual), [ubicaciones de origen](source.md#ubicaciones-de-fuente), [búferes](source.md#leer-archivos), [sumideros de salida](source.md#escribir-salidas), [dependencias](source.md#registrar-dependencias) |
| [API del preprocesador](prep.md) | [Tokens](prep.md#leer-tokens), [macros](prep.md#identificadores-y-macros), [pragmas](prep.md#pragmas-y-consultas-de-características), [inclusiones](prep.md#redirigir-una-inclusión), [consultas de características](prep.md#pragmas-y-consultas-de-características), [39 tipos de eventos](prep.md#suscripción-a-eventos) |
| [API de AST y semántica](ast-sema.md) | [Extensión del analizador](ast-sema.md#extensión-del-analizador-sintáctico), [mutación del AST](ast-sema.md#construir-y-modificar), [búsqueda de nombres](ast-sema.md#consultas-semánticas), [tipos](ast-sema.md#accesores-tipados), [constantes](ast-sema.md#consultas-semánticas) |
| [API de IR](ir.md) | [Lectura de IR de LLVM](ir.md#recorrer-un-módulo), [construcción transaccional](ir.md#modificación-transaccional), [análisis](ir.md#análisis), [pases](ir.md#pasadas), [proveedores](ir.md#sustituir-la-generación-y-la-optimización) |
| [API de MIR](mir.md) | [Funciones máquina](mir.md#leer-la-mir), [registros](mir.md#registros), [marcos de pila](mir.md#el-marco-de-pila), [pases y análisis de MIR](mir.md#pases) |
| [Destino, MC, ensamblador, objeto](target-mc-object.md) | [Registro de destinos](target-mc-object.md#registrar-un-destino), [convenciones de llamada](target-mc-object.md#abi-y-convenciones-de-llamada), [codificación MC](target-mc-object.md#codificadores-decodificadores-y-disposición), [grafos de objetos](target-mc-object.md#grafos-de-objetos) |
| [API de enlazado y LTO](link-lto.md) | [Grafo de enlazado](link-lto.md#leer-el-grafo), [resolución de símbolos](link-lto.md#modificar-el-grafo), [GC/ICF](link-lto.md#la-máquina-de-estados), [proveedores de enlazador y LTO](link-lto.md#proveedores) |
| [API de DynCode](dyncode.md) | [Imágenes planas independientes de la posición](dyncode.md#imagen-informe-y-ediciones-de-bytes-acotadas), [rebajado de importaciones](dyncode.md#referencias-externas-y-rebaje-de-importaciones), [codificación de juegos de caracteres](dyncode.md#imagen-informe-y-ediciones-de-bytes-acotadas) |
| [Convenciones de llamada personalizadas](custom-callconv.md) | [Complementos de convención de llamada dirigidos por datos](custom-callconv.md#formato-de-la-spec) |
