**Idiomas**: [English](../vbs-enclave.md) | [简体中文](../zh-CN/vbs-enclave.md) | [繁體中文](../zh-TW/vbs-enclave.md) | [日本語](../ja/vbs-enclave.md) | [한국어](../ko/vbs-enclave.md) | [Français](../fr/vbs-enclave.md) | [Deutsch](../de/vbs-enclave.md) | [Español](vbs-enclave.md) | [Italiano](../it/vbs-enclave.md) | [Русский](../ru/vbs-enclave.md) | [العربية](../ar/vbs-enclave.md)
...
7. Resuelva una función exportada del enclave con `GetProcAddress`, ejecútela mediante `CallEnclave` y verifique su valor de retorno. Repita las llamadas, cubriendo las rutas de llamadas indirectas protegidas por CFG y heredadas.
8. Termine y libere el enclave con `TerminateEnclave` y `DeleteEnclave`, comprobando que ambas operaciones tengan éxito.
...
La sonda de ejecución x64 ejecuta primero la imagen de Microsoft y después ambos candidatos de NeverC. Resuelve una función exportada con `GetProcAddress`, repite las llamadas `CallEnclave`, cubriendo las rutas de llamadas indirectas protegidas por CFG y heredadas, y comprueba los valores de retorno. `PASS` exige evidencias ordenadas de cada etapa del ciclo de vida, incluidas la terminación y la liberación correctas; cargar e inicializar no es suficiente. En este workflow, ARM64 está cubierto por validación estática y enlace diferencial; la sonda de ejecución habitual sigue limitada a x64.

Una validación independiente en Windows 11 ARM64 nativo se completó correctamente el 2026-09-11 ([ejecución 34554067852](https://github.com/NeverSight/NeverC/actions/runs/34554067852)). Reutilizó las dos DLL ARM64 de NeverC compiladas a partir de `c46e3a4cc4b3732823a7241a43bca6c44b0f0b74` y las probó junto con una imagen de referencia recién compilada con MSVC. Se superaron las 48 etapas del ciclo de vida y las 12 llamadas con verificación de resultados; también se completaron correctamente la terminación y liberación de los enclaves y la limpieza del certificado de firma. Esto valida esos artefactos concretos, no una nueva compilación del compilador NeverC ni una comprobación permanente de ejecución ARM64 en CI.

Una sonda de ejecución opcional solo puede informar `SKIP` ante una indisponibilidad reconocida de los requisitos del entorno antes de ejecutar la función. Los cierres inesperados, tiempos de espera agotados, evidencias de etapas ausentes o desordenadas y errores funcionales son `FAIL`, incluso en la referencia de Microsoft. Un runner VBS autoalojado y configurado puede hacer obligatorio el éxito en tiempo de ejecución.
