**언어**: [English](../nc-extension.md) | [简体中文](../zh-CN/nc-extension.md) | [繁體中文](../zh-TW/nc-extension.md) | [日本語](../ja/nc-extension.md) | [한국어](nc-extension.md) | [Français](../fr/nc-extension.md) | [Deutsch](../de/nc-extension.md) | [Español](../es/nc-extension.md) | [Italiano](../it/nc-extension.md) | [Русский](../ru/nc-extension.md) | [العربية](../ar/nc-extension.md)
...
- `-fdyncode`는 `.nc`와 자연스럽게 결합됩니다: dyncode 모드는 자체적으로 `string`을 활성화하고, `.nc`는 `neverc-types`도 활성화합니다
...
| DynCode 프로젝트 | 둘 다 가능 — `-fdyncode`는 `string`을 항상 활성화 |
