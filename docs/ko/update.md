**언어**: [English](../update.md) | [简体中文](../zh-CN/update.md) | [繁體中文](../zh-TW/update.md) | [日本語](../ja/update.md) | [한국어](update.md) | [Français](../fr/update.md) | [Deutsch](../de/update.md) | [Español](../es/update.md) | [Italiano](../it/update.md) | [Русский](../ru/update.md) | [العربية](../ar/update.md)
...
| 미설치 runtime | 자동 설치 안 함 — [`neverc runtime install`](runtime.md) |
...
| 명령 | 용도 |
|------|------|
| [`neverc runtime`](runtime.md) | 개별 sysroot만 관리 |
| [`neverc run`](run.md) | 호스트에서 임시 바이너리 컴파일·실행 |
| [`neverc build` / `make`](build.md) | Makefile 기반 빌드 |
