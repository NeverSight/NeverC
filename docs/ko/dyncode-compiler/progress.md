**언어**: [English](../../dyncode-compiler/progress.md) | [简体中文](../../zh-CN/dyncode-compiler/progress.md) | [繁體中文](../../zh-TW/dyncode-compiler/progress.md) | [日本語](../../ja/dyncode-compiler/progress.md) | [한국어](progress.md) | [Français](../../fr/dyncode-compiler/progress.md) | [Deutsch](../../de/dyncode-compiler/progress.md) | [Español](../../es/dyncode-compiler/progress.md) | [Italiano](../../it/dyncode-compiler/progress.md) | [Русский](../../ru/dyncode-compiler/progress.md) | [العربية](../../ar/dyncode-compiler/progress.md)
...
- [x] 디렉터리 및 CMake 스켈레톤 (`nevercDynCode` 라이브러리)
...
- [x] 크로스 플랫폼 `-mdyncode-syscall` 시맨틱 (Darwin 전용 `-mdyncode-libsystem` 대체)
- [x] Linux / Android syscall 번호 테이블 (Darwin BSD 100+, Linux arm64 130+, Linux x86_64 150+)
- [x] `DynCodeExtractor`를 `MachOExtractor` / `ELFExtractor` / `COFFExtractor`로 리팩터링
...
- [x] DynCode 심 헤더: `<windows.h>`, `<unistd.h>`, `<fcntl.h>`, `<sys/stat.h>`, `<sys/mman.h>`, `<string.h>`, `<stdlib.h>`
