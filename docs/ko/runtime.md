**언어**: [English](../runtime.md) | [简体中文](../zh-CN/runtime.md) | [繁體中文](../zh-TW/runtime.md) | [日本語](../ja/runtime.md) | [한국어](runtime.md) | [Français](../fr/runtime.md) | [Deutsch](../de/runtime.md) | [Español](../es/runtime.md) | [Italiano](../it/runtime.md) | [Русский](../ru/runtime.md) | [العربية](../ar/runtime.md)
...
- [`neverc update`](update.md)는 **컴파일러와 이미 설치된 모든
...
| 명령 | 사용 시기 |
|------|-----------|
| [`neverc update`](update.md) | 컴파일러+설치된 runtime 함께 업/다운그레이드 |
| [`neverc build` / `make`](build.md) | 이 sysroot에 의존하는 크로스 컴파일 예제 빌드 |
| [예제](examples.md) | `--target=…`를 쓰는 샘플 `Makefile` |
