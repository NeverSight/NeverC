...
| 가이드 | 다루는 범위 |
|---|---|
| [Python 플러그인](python.md) | 선택적 embedded Python, 수명 주기, 옵션, read-only observer, 진단 및 현재 제한 |
| [드라이버 API](driver.md) | [명령줄](driver.md#원시-인자), [툴체인 선택](driver.md#툴체인-선택), [액션 그래프](driver.md#액션-그래프), [잡 그래프](driver.md#작업-그래프) |
| [소스와 I/O API](source.md) | [VFS 프로바이더](source.md#가상-파일-시스템-제공자), [소스 위치](source.md#소스-위치), [버퍼](source.md#파일-읽기), [출력 싱크](source.md#출력-쓰기), [의존성](source.md#의존성-기록) |
| [전처리기 API](prep.md) | [토큰](prep.md#토큰-읽기), [매크로](prep.md#식별자와-매크로), [pragma](prep.md#프래그마와-기능-질의), [include](prep.md#include-방향-바꾸기), [기능 질의](prep.md#프래그마와-기능-질의), [39가지 이벤트](prep.md#이벤트-구독) |
| [AST와 의미 분석 API](ast-sema.md) | [파서 확장](ast-sema.md#파서-확장), [AST 변경](ast-sema.md#만들기와-변경하기), [이름 조회](ast-sema.md#의미-질의), [타입](ast-sema.md#타입이-붙은-접근자), [상수](ast-sema.md#의미-질의) |
| [IR API](ir.md) | [LLVM IR 읽기](ir.md#모듈-훑기), [트랜잭션 기반 구성](ir.md#트랜잭션-방식-변경), [분석](ir.md#분석), [패스](ir.md#패스), [프로바이더](ir.md#생성과-최적화-대체) |
| [MIR API](mir.md) | [머신 함수](mir.md#mir-읽기), [레지스터](mir.md#레지스터), [스택 프레임](mir.md#스택-프레임), [MIR 패스와 분석](mir.md#패스) |
| [타깃, MC, 어셈블리, 오브젝트](target-mc-object.md) | [타깃 등록](target-mc-object.md#타깃-등록), [호출 규약](target-mc-object.md#abi와-호출-규약), [MC 인코딩](target-mc-object.md#인코더-디코더-레이아웃), [오브젝트 그래프](target-mc-object.md#오브젝트-그래프) |
| [링크와 LTO API](link-lto.md) | [링크 그래프](link-lto.md#그래프-읽기), [심볼 결정](link-lto.md#그래프-변경), [GC/ICF](link-lto.md#상태-기계), [링커와 LTO 프로바이더](link-lto.md#프로바이더) |
| [DynCode API](dyncode.md) | [평평한 위치 독립 이미지](dyncode.md#이미지-리포트-범위가-제한된-바이트-편집), [임포트 로워링](dyncode.md#외부-참조와-임포트-낮추기), [문자셋 인코딩](dyncode.md#이미지-리포트-범위가-제한된-바이트-편집) |
| [사용자 정의 호출 규약](custom-callconv.md) | [데이터 주도 호출 규약 플러그인](custom-callconv.md#spec-형식) |
