**언어**: [English](../dyncode-compiler-roadmap.md) | [简体中文](../zh-CN/dyncode-compiler-roadmap.md) | [繁體中文](../zh-TW/dyncode-compiler-roadmap.md) | [日本語](../ja/dyncode-compiler-roadmap.md) | [한국어](dyncode-compiler-roadmap.md) | [Français](../fr/dyncode-compiler-roadmap.md) | [Deutsch](../de/dyncode-compiler-roadmap.md) | [Español](../es/dyncode-compiler-roadmap.md) | [Italiano](../it/dyncode-compiler-roadmap.md) | [Русский](../ru/dyncode-compiler-roadmap.md) | [العربية](../ar/dyncode-compiler-roadmap.md)
...
2. **아웃오브트리 C 플러그인 API** — 순수 C ABI 플러그인 인터페이스([`NevercPluginAPI.h`]). IR, MIR, Binary, Linker 커스텀 패스를 11개 dyncode 훅 포인트(`NEVERC_INTERPOSE_SC_*`)에 등록 가능. 단일 헤더 SDK, LLVM/CRT 의존성 제로. 자세한 내용은 [Plugin API 문서](plugin-api.md) 참조.
...
사용법 및 코드 예제는 [Plugin API 문서](plugin-api.md) 참조.
