**언어**: [English](../build.md) | [简体中文](../zh-CN/build.md) | [繁體中文](../zh-TW/build.md) | [日本語](../ja/build.md) | [한국어](build.md) | [Français](../fr/build.md) | [Deutsch](../de/build.md) | [Español](../es/build.md) | [Italiano](../it/build.md) | [Русский](../ru/build.md) | [العربية](../ar/build.md)
...
[`examples/`](examples.md)는 이 흐름용입니다.
...
| [`neverc run`](run.md) | 호스트 임시 컴파일·실행 |
| [`neverc runtime`](runtime.md) | 교차용 sysroot 설치 |
| [릴리스와 `--strip`](release-builds.md) | 배포용 최종 이미지 strip |
