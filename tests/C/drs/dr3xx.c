...
void (*dr316_1_ptr)(int, int, int) = dr316_1; /* expected-warning {{incompatible function pointer types initializing 'void (*)(int, int, int)' with an expression of type 'void ()'}} */
