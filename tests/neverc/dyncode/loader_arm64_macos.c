...
/*
 * DynCode loader for macOS ARM64.
 *
 * Reads a flat .bin dyncode file, maps it with MAP_JIT (per-thread W^X
 ...
 *
 * Usage:
 *   loader <dyncode.bin> [arg0] [arg1]
 *
 * Exit code is the dyncode's return value (or its exit() call for void
...
int main(int argc, char **argv) {
    ...
    if (argc >= 4) {
        ...
        /* void entry(void) — use the process exit code set by the dyncode. */
