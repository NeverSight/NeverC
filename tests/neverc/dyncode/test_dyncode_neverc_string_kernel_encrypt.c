...
/* NeverC builtin string .encrypt() in kernel-context dyncode mode.
 *
 * Compile-only guard for -mdyncode-context=kernel: string encryption
 * must use the dyncode-local arena and must not leave malloc/free externs.
 */
