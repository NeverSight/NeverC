...
/* NeverC builtin string in kernel-context dyncode mode.
 *
 * This is a compile-only guard for `-mdyncode-context=kernel`: the builtin
 * string runtime must use the dyncode-local arena and must not leave
