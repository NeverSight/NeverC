...
/* NeverC builtin string memory-safety guard for kernel-context dyncode.
 *
 * Compile-only mirror of `test_dyncode_neverc_string_safety.c`: ensures
 ...
 * loader — the test only asserts that the dyncode pipeline accepts
 * every helper.
 */
