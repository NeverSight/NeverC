...
/* NeverC builtin string arena behaviour stress in ring-0 dyncode mode.
 *
 * Compile-only mirror of `test_dyncode_neverc_string_arena.c` for the
 ...
 * dyncode pipeline accepts every helper on the kernel arena.
 */
