...
TEST(PluginBinaryImageTest,
     PostEmitObserverCannotMutatePreSealBinaryImage) {
  LinkTaskScope Scope;
  ASSERT_TRUE(Scope.initialize());
  TemporaryDirectory Directory;
