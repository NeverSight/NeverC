---
name: graphics-api-interception
description: Guide for graphics API interception, overlay rendering, and render-pipeline analysis across DirectX, OpenGL, and Vulkan. Use this skill when working with Present or SwapBuffers intercepts, DXGI swap chains, shader or draw-call interception, screenshot-sensitive overlays, or graphics debugging in game security research.
---

# Graphics API Interception & Rendering

## Overview

This skill covers graphics API resources from the awesome-game-security collection, including DirectX, OpenGL, and Vulkan interception techniques, overlay rendering, and graphics debugging.
...
## Universal Intercept Libraries

### Kiero
- Cross-API intercept library
- Supports DX9/10/11/12, OpenGL, Vulkan
- Automatic method detection

### Universal ImGui Intercept
...
### DWM Overlay
```
- Intercept Desktop Window Manager
...
```
- Intercept Steam's overlay functions
...
```
- Intercept GeForce Experience overlay
...
- Disable overlay rendering during screenshot frame:
  - Detect screenshot by intercepting BitBlt/PrintWindow in AC module
...
- Techniques: intercept Present to suppress overlay on screenshot frames
...
- Intercepts IDXGISwapChain::Present (D3D11/12) or SwapBuffers (OpenGL)
...
Capture path (latency-critical):
  Game render → Present intercept copies backbuffer
...
- IDXGISwapChain::Present intercept or detour in game process
...
The README contains:
- DirectX 9/11/12 intercept implementations
- OpenGL intercept libraries
