#ifndef LINKER_MACHO_EH_FRAME_H
#define LINKER_MACHO_EH_FRAME_H

#include "Linker/MachO/InputSection.h"
#include "Linker/MachO/Relocations.h"
 ...
 * 10.  DWARF instructions (ignored by the linker)
 *
 ...
 * 6. DWARF instructions (ignored by the linker)
 */
...
// However, we need this operation to be cross-platform, and AArch64 does not
// have a similar relocation that is applicable. We therefore use the more
// verbose (but more generic) subtractor relocation to encode these pcrel
// values. ld64 appears to do something similar -- its `-r` output contains
// these explicit subtractor relocations.
class EhRelocator {
public:
