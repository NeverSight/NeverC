#ifndef LINKER_MACHO_SYMBOLS_H
#define LINKER_MACHO_SYMBOLS_H
...
public:
  ...
  // Set for example on `__attribute__((used))` globals.
  // This is information only for the static linker and not written to the
  // output.
  bool noDeadStrip : 1;
...
// defined symbol by passing -fno-common. -fno-common is the default in NeverC
