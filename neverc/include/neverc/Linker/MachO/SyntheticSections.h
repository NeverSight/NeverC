#ifndef LINKER_MACHO_SYNTHETIC_SECTIONS_H
#define LINKER_MACHO_SYNTHETIC_SECTIONS_H
...
//
// The linker generates the fixup data in 5 stages:
...
//      fixups are linked together in the image emitter's buildFixupChains().
