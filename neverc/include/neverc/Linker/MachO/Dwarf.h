#ifndef LINKER_MACHO_DWARF_H
#define LINKER_MACHO_DWARF_H
...
// Implements the interface between LLVM's DWARF-parsing utilities and the
// linker's InputSection structures.
