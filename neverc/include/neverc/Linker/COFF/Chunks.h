#ifndef LINKER_COFF_CHUNKS_H
#define LINKER_COFF_CHUNKS_H
...
public:
  ...
  // Reloc setter used by AArch64 range extension thunk insertion.
...
// This class is used to implement a linker-specific feature (not implemented in
...
static const uint8_t importThunkX64[] = {
...
public:
  ...
  size_t getSize() const override { return sizeof(importThunkX64); }
  void writeTo(uint8_t *buf) const override;
...
// Table which contains symbol RVAs. Used for /guard:cf.
...
namespace llvm {
template <>
struct DenseMapInfo<linker::coff::ChunkAndOffset>
    : linker::coff::ChunkAndOffset::DenseMapInfo {};
} // namespace llvm
