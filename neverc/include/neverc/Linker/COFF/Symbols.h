#ifndef LINKER_COFF_SYMBOLS_H
#define LINKER_COFF_SYMBOLS_H
...
public:
  ...
  // This bit is used by the image emitter's symbol-table pass to prevent
...
// This symbol is used for linker-synthesized symbols like __ImageBase.
...
public:
  ...
  // other synthesized chunk (e.g. /guard:cf RVA tables).
