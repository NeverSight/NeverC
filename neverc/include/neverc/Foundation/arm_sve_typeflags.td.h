...
EltTyFloat64 = 8,
    EltTyInt128 = 5, EltTyFloat16 = 6, EltTyInt64 = 4, EltTyBool8 = 9,
    EltTyInt16 = 2, EltTyFloat32 = 7, EltTyBool16 = 10, EltTyInt8 = 1,
    EltTyBool32 = 11, EltTyBool64 = 12, EltTyInvalid = 0, EltTyBFloat16 = 13,
    EltTyInt32 = 3,
#endif

#ifdef LLVM_GET_SVE_MEMELTTYPES
    MemEltTyInt8 = 1, MemEltTyInt32 = 3, MemEltTyInt16 = 2, MemEltTyInt64 = 4,
    MemEltTyDefault = 0,
#endif

#ifdef LLVM_GET_SVE_MERGETYPES
    MergeAny = 1, MergeNone = 0, MergeOp1 = 2, MergeZero = 3, MergeZeroExp = 5,
    MergeAnyExp = 4,
#endif

#ifdef LLVM_GET_SVE_IMMCHECKTYPES
    ImmCheckLaneIndexDot = 9, ImmCheck0_0 = 16, ImmCheckShiftLeft = 5,
    ImmCheck0_3 = 15, ImmCheck0_15 = 17, ImmCheckExtract = 2,
    ImmCheckLaneIndex = 7, ImmCheck1_1 = 20, ImmCheck0_1 = 13, ImmCheck0_2 = 14,
    ImmCheck1_7 = 22, ImmCheck0_7 = 6, ImmCheck0_255 = 18, ImmCheck0_13 = 12,
    ImmCheck1_16 = 1, ImmCheckShiftRight = 3, ImmCheckComplexRotAll90 = 11,
    ImmCheckLaneIndexCompRotate = 8, ImmCheckComplexRot90_270 = 10,
    ImmCheckShiftRightNarrow = 4, ImmCheck2_4_Mul2 = 19, ImmCheck0_31 = 0,
    ImmCheck1_3 = 21,
#endif
