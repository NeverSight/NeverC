...
template <> struct PointerLikeTypeTraits<neverc::DeclGroupRef> {
  static inline void *getAsVoidPointer(neverc::DeclGroupRef P) {
    return P.getAsOpaquePtr();
  }

  static inline neverc::DeclGroupRef getFromVoidPointer(void *P) {
    return neverc::DeclGroupRef::getFromOpaquePtr(P);
  }
