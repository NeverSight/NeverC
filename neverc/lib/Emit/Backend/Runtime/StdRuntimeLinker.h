#ifndef NEVERC_LIB_EMIT_BACKEND_RUNTIME_STDRUNTIMELINKER_H
#define NEVERC_LIB_EMIT_BACKEND_RUNTIME_STDRUNTIMELINKER_H
...
#endif // NEVERC_LIB_EMIT_BACKEND_RUNTIME_STDRUNTIMELINKER_H
