...
#include "neverc/DynCode/Tables/Syscalls_Darwin.def"
#include "neverc/DynCode/Tables/UserExtra_Syscalls_Darwin.def"
#undef NEVERC_SYSCALL
};

const Syscall kLinuxArm64Table[] = {
#define NEVERC_SYSCALL(name, number) {#name, number},
#include "neverc/DynCode/Tables/Syscalls_LinuxArm64.def"
#include "neverc/DynCode/Tables/UserExtra_Syscalls_LinuxArm64.def"
#undef NEVERC_SYSCALL
};

const Syscall kLinuxX86_64Table[] = {
#define NEVERC_SYSCALL(name, number) {#name, number},
#include "neverc/DynCode/Tables/Syscalls_LinuxX86_64.def"
#include "neverc/DynCode/Tables/UserExtra_Syscalls_LinuxX86_64.def"
#undef NEVERC_SYSCALL
};
