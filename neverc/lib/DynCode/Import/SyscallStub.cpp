...
#include "neverc/DynCode/Tables/PosixCanonicalTypes.def"
#include "neverc/DynCode/Tables/UserExtra_PosixCanonicalTypes.def"
...
PreservedAnalyses SyscallStubPass::run(Module &M, ModuleAnalysisManager &) {
...

  {
    ...
    for (Function &F : M) {
      ...
      if (isDynCodeInternalRuntimeName(Name))
        continue;
