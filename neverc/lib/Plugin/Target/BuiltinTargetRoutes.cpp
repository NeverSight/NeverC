...
constexpr uint64_t BuiltinMCSchemaIDHigh =
    UINT64_C(0x4e434d435343484d);
constexpr uint64_t BuiltinObjectFormatIDHigh =
    UINT64_C(0x4e434f424a464d54);
...
constexpr NevercInterfaceID
objectFormatID(BuiltinObjectFormat Format) {
  return {BuiltinObjectFormatIDHigh,
          Format == BuiltinObjectFormat::ELF
              ? UINT64_C(1)
              : (Format == BuiltinObjectFormat::COFF ? UINT64_C(2)
                                                     : UINT64_C(3))};
}

const std::array<BuiltinTargetRoute, 9> Routes = {{
    {"builtin.x86_64.macos", "x86_64-apple-macosx", "generic",
     targetID(1), abiID(1), mcSchemaID(false),
     objectFormatID(BuiltinObjectFormat::MachO),
     BuiltinTargetABIKind::X86_64SysV, BuiltinObjectFormat::MachO,
     true, true, true, false},
    {"builtin.aarch64.macos", "aarch64-apple-macosx", "generic",
     targetID(2), abiID(2), mcSchemaID(true),
     objectFormatID(BuiltinObjectFormat::MachO),
     BuiltinTargetABIKind::AArch64DarwinPCS,
     BuiltinObjectFormat::MachO, true, true, true, false},
    {"builtin.x86_64.linux", "x86_64-unknown-linux-gnu", "generic",
     targetID(3), abiID(3), mcSchemaID(false),
    ...
    {"builtin.aarch64.linux", "aarch64-unknown-linux-gnu", "generic",
     ...
     true, true, true, false},
    {"builtin.x86_64.android", "x86_64-unknown-linux-android29",
     "generic", targetID(5), abiID(5), mcSchemaID(false),
     objectFormatID(BuiltinObjectFormat::ELF),
     BuiltinTargetABIKind::X86_64SysV, BuiltinObjectFormat::ELF,
     true, true, true, false},
    {"builtin.aarch64.android", "aarch64-unknown-linux-android29",
     "generic", targetID(6), abiID(6), mcSchemaID(true),
     objectFormatID(BuiltinObjectFormat::ELF),
     BuiltinTargetABIKind::AArch64AAPCS, BuiltinObjectFormat::ELF,
     true, true, true, false},
    {"builtin.x86_64.windows", "x86_64-pc-windows-msvc", "generic",
     targetID(7), abiID(7), mcSchemaID(false),
     objectFormatID(BuiltinObjectFormat::COFF),
     BuiltinTargetABIKind::X86_64Win64, BuiltinObjectFormat::COFF,
     true, true, true, false},
    {"builtin.aarch64.windows", "aarch64-pc-windows-msvc", "generic",
     targetID(8), abiID(8), mcSchemaID(true),
     objectFormatID(BuiltinObjectFormat::COFF),
     BuiltinTargetABIKind::AArch64Win64, BuiltinObjectFormat::COFF,
     true, true, true, false},
    {"builtin.aarch64.ios", "aarch64-apple-ios", "generic",
     targetID(9), abiID(9), mcSchemaID(true),
     objectFormatID(BuiltinObjectFormat::MachO),
     BuiltinTargetABIKind::AArch64DarwinPCS,
     BuiltinObjectFormat::MachO, true, true, true, false},
}};
