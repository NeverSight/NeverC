#ifndef NEVERC_LIB_PLUGIN_BRIDGE_BRIDGECASTHELPERS_H
#define NEVERC_LIB_PLUGIN_BRIDGE_BRIDGECASTHELPERS_H
...
// ===----------------------------------------------------------------------===
//  Shared state -- defined in Host/HostAPIBridge.cpp
// ===----------------------------------------------------------------------===

extern bool gDynCodeModeEnabled;

// ===----------------------------------------------------------------------===
//  Shared bridge functions -- defined in Host/HostAPIBridge.cpp, used across files
// ===----------------------------------------------------------------------===
...
#endif // NEVERC_LIB_PLUGIN_BRIDGE_BRIDGECASTHELPERS_H
