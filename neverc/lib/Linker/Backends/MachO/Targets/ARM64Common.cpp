...
namespace {
void writeValue(uint8_t *loc, const Reloc &r, uint64_t value) {
  switch (r.length) {
  case 2:
...
namespace {
void reportUnalignedLdrStr(Twine loc, uint64_t va, int align,
                           const Symbol *sym) {
...
void macho::reportUnalignedLdrStr(void *loc, const linker::macho::Reloc &r,
...
void macho::reportUnalignedLdrStr(void *loc, linker::macho::SymbolDiagnostic d,
                                  uint64_t va, int align) {
