...
namespace {
constexpr std::array<RelocAttrs, 10> relocAttrsArray{{
...
// ===----------------------------------------------------------------------===
// Stub & stub-helper code emission
// ===----------------------------------------------------------------------===

namespace {
void writeRipRelative(SymbolDiagnostic d, uint8_t *buf, uint64_t bufAddr,
...
namespace {
constexpr uint8_t stubHelperHeader[] = {
...
namespace {
constexpr uint8_t stubHelperEntry[] = {
