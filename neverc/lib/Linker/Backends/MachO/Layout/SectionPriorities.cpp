...
// ===----------------------------------------------------------------------===
// Cluster merging primitives
// ===----------------------------------------------------------------------===

namespace {

// It's bad to merge clusters which would degrade the density too much.
bool isNewDensityBad(Cluster &a, Cluster &b) {
...
int getLeader(std::vector<int> &leaders, int v) {
  while (leaders[v] != v) {
...
void mergeClusters(std::vector<Cluster> &cs, Cluster &into, int intoIdx,
...
// ===----------------------------------------------------------------------===
// PriorityBuilder: order-file driven priorities
// ===----------------------------------------------------------------------===
...
// ===----------------------------------------------------------------------===
// PriorityBuilder: call-graph profile extraction & order file parsing
// ===----------------------------------------------------------------------===
...
// ===----------------------------------------------------------------------===
// PriorityBuilder: final input-section priority assembly
// ===----------------------------------------------------------------------===
