...
// ===----------------------------------------------------------------------===
// Internal data: trie edges and per-symbol export info
// ===----------------------------------------------------------------------===
...
// ===----------------------------------------------------------------------===
// TrieNode: serialized export-trie node
// ===----------------------------------------------------------------------===
...
// ===----------------------------------------------------------------------===
// TrieBuilder: assemble nodes from sorted symbols
// ===----------------------------------------------------------------------===
...
namespace {
int charAt(const Symbol *sym, size_t pos) {
...
// ===----------------------------------------------------------------------===
// TrieParser: walk a serialized export trie
// ===----------------------------------------------------------------------===
