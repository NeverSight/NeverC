...
// ===----------------------------------------------------------------------===
// Layout helpers & symbol gathering
// ===----------------------------------------------------------------------===

namespace {
constexpr char indent8[] = "        ";          // 8 spaces
constexpr char indent16[] = "                "; // 16 spaces

// Print out the first three columns of a line.
void writeHeader(raw_ostream &os, uint64_t vma, uint64_t lma, uint64_t size,
                 uint64_t align) {
...
namespace {
SymbolMapTy getSectionSyms(ArrayRef<Defined *> syms) {
  SymbolMapTy ret;
  for (Defined *dr : syms)
...
namespace {
DenseMap<Symbol *, std::string> getSymbolStrings(ArrayRef<Defined *> syms) {
...
// ===----------------------------------------------------------------------===
// .eh_frame pretty printer & main map emission
// ===----------------------------------------------------------------------===
...
namespace {
void printEhFrame(raw_ostream &os, const EhFrameSection *sec) {
...
void writeMapFile(raw_fd_ostream &os) {
