...
boundary. A direct source-written address of an admitted scalar field may be
invoked on the same receivers and retains its lvalue result. Stored member
pointers, base adjustments, reference signatures and volatile receivers remain
