#ifndef NEVERC_LIB_COMPILER_CORE_COMPILERINVOCATIONARG_H
#define NEVERC_LIB_COMPILER_CORE_COMPILERINVOCATIONARG_H

// Internal header shared by CompilerInvocation*.cpp split files.
// NOT part of the public API.  Only include from
// neverc/lib/Compiler/Core/CompilerInvocation*.cpp files.
//
...
#endif // NEVERC_LIB_COMPILER_CORE_COMPILERINVOCATIONARG_H
