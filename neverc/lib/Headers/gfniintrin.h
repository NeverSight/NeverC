...
static __inline__ __m256i
    __DEFAULT_FN_ATTRS_Y _mm256_gf2p8mul_epi8(__m256i __A, __m256i __B) {
...
#define _mm512_maskz_gf2p8affineinv_epi64_epi8(U, A, B, I)                     \
  _mm512_mask_gf2p8affineinv_epi64_epi8((__m512i)_mm512_setzero_si512(), U, A, \
                                        B, I)
...
#define _mm512_maskz_gf2p8affine_epi64_epi8(U, A, B, I)                        \
  _mm512_mask_gf2p8affine_epi64_epi8((__m512i)_mm512_setzero_si512(), U, A, B, \
                                     I)

static __inline__ __m512i
    __DEFAULT_FN_ATTRS_Z _mm512_gf2p8mul_epi8(__m512i __A, __m512i __B) {
  return (__m512i)__builtin_ia32_vgf2p8mulb_v64qi((__v64qi)__A, (__v64qi)__B);
}

static __inline__ __m512i __DEFAULT_FN_ATTRS_Z_MASK _mm512_mask_gf2p8mul_epi8(
...
#define _mm_maskz_gf2p8affineinv_epi64_epi8(U, A, B, I)                        \
  _mm_mask_gf2p8affineinv_epi64_epi8((__m128i)_mm_setzero_si128(), U, A, B, I)
...
#define _mm256_maskz_gf2p8affineinv_epi64_epi8(U, A, B, I)                     \
  _mm256_mask_gf2p8affineinv_epi64_epi8((__m256i)_mm256_setzero_si256(), U, A, \
                                        B, I)
...
#define _mm256_maskz_gf2p8affine_epi64_epi8(U, A, B, I)                        \
  _mm256_mask_gf2p8affine_epi64_epi8((__m256i)_mm256_setzero_si256(), U, A, B, \
                                     I)
