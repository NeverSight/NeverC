...
/// ZeroExtend32(__B.word[2*j+1]) 	dst.dword[j] := __W.dword[j] + tmp1 +
/// tmp2 ENDFOR dst[MAX:128] := 0
/// \endcode
...
/// 	tmp1.dword := SignExtend32(__A.word[2*j]) * ZeroExtend32(__B.word[2*j])
/// 	tmp2.dword := SignExtend32(__A.word[2*j+1]) *
/// ZeroExtend32(__B.word[2*j+1]) 	dst.dword[j] :=
/// SIGNED_DWORD_SATURATE(__W.dword[j] + tmp1 + tmp2) ENDFOR dst[MAX:128] := 0
/// \endcode
...
/// 	tmp2.dword := SignExtend32(__A.word[2*j+1]) *
/// ZeroExtend32(__B.word[2*j+1]) 	dst.dword[j] :=
/// SIGNED_DWORD_SATURATE(__W.dword[j] + tmp1 + tmp2) ENDFOR dst[MAX:256] := 0
/// \endcode
static __inline__ __m256i __DEFAULT_FN_ATTRS256
...
/// 	tmp2.dword := ZeroExtend32(__A.word[2*j+1]) *
/// SignExtend32(__B.word[2*j+1]) 	dst.dword[j] := __W.dword[j] + tmp1 +
/// tmp2 ENDFOR dst[MAX:128] := 0
/// \endcode
...
/// 	tmp1.dword := ZeroExtend32(__A.word[2*j]) * SignExtend32(__B.word[2*j])
/// 	tmp2.dword := ZeroExtend32(__A.word[2*j+1]) *
/// SignExtend32(__B.word[2*j+1]) 	dst.dword[j] :=
/// SIGNED_DWORD_SATURATE(__W.dword[j] + tmp1 + tmp2) ENDFOR dst[MAX:128] := 0
/// \endcode
...
/// 	tmp2.dword := ZeroExtend32(__A.word[2*j+1]) *
/// ZeroExtend32(__B.word[2*j+1]) 	dst.dword[j] :=
/// UNSIGNED_DWORD_SATURATE(__W.dword[j] + tmp1 + tmp2) ENDFOR dst[MAX:128] := 0
/// \endcode
...
/// 	tmp2.dword := ZeroExtend32(__A.word[2*j+1]) *
/// ZeroExtend32(__B.word[2*j+1]) 	dst.dword[j] :=
/// UNSIGNED_DWORD_SATURATE(__W.dword[j] + tmp1 + tmp2) ENDFOR dst[MAX:256] := 0
/// \endcode
static __inline__ __m256i __DEFAULT_FN_ATTRS256
