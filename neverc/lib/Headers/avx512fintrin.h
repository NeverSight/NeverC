...
#define __DEFAULT_FN_ATTRS512                                                  \
  __attribute__((__always_inline__, __nodebug__,                               \
                 __target__("avx512f,evex512"), __min_vector_width__(512)))
...
static __inline__ __m512d
    __DEFAULT_FN_ATTRS512 _mm512_broadcastsd_pd(__m128d __A) {
...
_mm512_castpd128_pd512(__m128d __A) {
  ...
  return __builtin_shufflevector(
      __builtin_shufflevector(__A, __builtin_nondeterministic_value(__A), 0, 1,
                              2, 3),
      __B, 0, 1, 2, 3, 4, 5, 6, 7);
}
...
static __inline __m512 __DEFAULT_FN_ATTRS512 _mm512_floor_ps(__m512 __A) {
  return (__m512)__builtin_ia32_rndscaleps_mask(
      (__v16sf)__A, _MM_FROUND_FLOOR, (__v16sf)__A, (unsigned short)-1,
      _MM_FROUND_CUR_DIRECTION);
}
...
static __inline __m512 __DEFAULT_FN_ATTRS512 _mm512_ceil_ps(__m512 __A) {
  return (__m512)__builtin_ia32_rndscaleps_mask(
      (__v16sf)__A, _MM_FROUND_CEIL, (__v16sf)__A, (unsigned short)-1,
      _MM_FROUND_CUR_DIRECTION);
}

static __inline __m512d __DEFAULT_FN_ATTRS512 _mm512_ceil_pd(__m512d __A) {
  return (__m512d)__builtin_ia32_rndscalepd_mask((__v8df)__A, _MM_FROUND_CEIL,
                                                 (__v8df)__A, (unsigned char)-1,
                                                 _MM_FROUND_CUR_DIRECTION);
}
...
static __inline__ __m512
    __DEFAULT_FN_ATTRS512 _mm512_fmadd_ps(__m512 __A, __m512 __B, __m512 __C) {
...
static __inline__ __m256i
    __DEFAULT_FN_ATTRS512 _mm512_cvtpd_epi32(__m512d __A) {
...
static __inline__ __m256i
    __DEFAULT_FN_ATTRS512 _mm512_cvtpd_epu32(__m512d __A) {
...
static __inline__ __m512i
    __DEFAULT_FN_ATTRS512 _mm512_cvtepi8_epi32(__m128i __A) {
...
static __inline__ __m512i
    __DEFAULT_FN_ATTRS512 _mm512_slli_epi32(__m512i __A, unsigned int __B) {
...
static __inline__ unsigned long long
    __DEFAULT_FN_ATTRS128 _mm_cvtsd_u64(__m128d __A) {
...
static __inline__ unsigned long long
    __DEFAULT_FN_ATTRS128 _mm_cvtss_u64(__m128 __A) {
...
static __inline__ unsigned long long
    __DEFAULT_FN_ATTRS128 _mm_cvttsd_u64(__m128d __A) {
...
static __inline__ unsigned long long
    __DEFAULT_FN_ATTRS128 _mm_cvttss_u64(__m128 __A) {
...
static __inline__ __m512d
    __DEFAULT_FN_ATTRS512 _mm512_permutevar_pd(__m512d __A, __m512i __C) {
...
static __inline__ __m256i
    __DEFAULT_FN_ATTRS512 _mm512_cvttpd_epu32(__m512d __A) {
...
static __inline__ __m512i
    __DEFAULT_FN_ATTRS512 _mm512_srai_epi32(__m512i __A, unsigned int __B) {
...
static __inline__ __m512
    __DEFAULT_FN_ATTRS512 _mm512_broadcast_f32x4(__m128 __A) {
...
static __inline__ __m512d
    __DEFAULT_FN_ATTRS512 _mm512_permutexvar_pd(__m512i __X, __m512d __Y) {
...
static __inline__ unsigned int
    __DEFAULT_FN_ATTRS _cvtmask16_u32(__mmask16 __A) {
...
static __inline__ __m128d
    __DEFAULT_FN_ATTRS128 _mm_cvtu64_sd(__m128d __A, unsigned long long __B) {
  __A[0] = __B;
  return __A;
}
#endif
...
static __inline__ __m128
    __DEFAULT_FN_ATTRS128 _mm_cvtu64_ss(__m128 __A, unsigned long long __B) {
  __A[0] = __B;
  return __A;
}
#endif
...
static __inline__ __m512d
    __DEFAULT_FN_ATTRS512 _mm512_set_pd(double __A, double __B, double __C,
                                        double __D, double __E, double __F,
                                        double __G, double __H) {
...
/// base_addr at packed 32-bit integer indices stored in the lower half of \a
/// vindex scaled by \a scale and stores them in dst.
///
...
/// Loads 8 64-bit integer elements from memory starting at location \a
/// base_addr at packed 32-bit integer indices stored in the lower half of \a
/// vindex scaled by \a scale and stores them in dst using writemask \a mask
/// (elements are copied from \a src when the corresponding mask bit is not
/// set).
///
/// This intrinsic corresponds to the <c> VPGATHERDQ </c> instructions.
///
...
#define _mm512_i32loscatter_epi64(base_addr, vindex, v1, scale)                \
  _mm512_i32scatter_epi64((base_addr), _mm512_castsi512_si256(vindex), (v1),   \
                          (scale))

/// Stores 8 packed 64-bit integer elements located in a and stores them in
/// memory locations starting at location \a base_addr at packed 32-bit integer
/// indices stored in \a vindex scaled by scale using writemask \a mask
/// (elements whose corresponding mask bit is not set are not written to
/// memory).
///
/// This intrinsic corresponds to the <c> VPSCATTERDQ </c> instructions.
///
