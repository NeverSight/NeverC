...
static __inline__ unsigned int
    __DEFAULT_FN_ATTRS _cvtmask32_u32(__mmask32 __A) {
...
#define _mm512_bslli_epi128(a, imm)                                            \
  ((__m512i)__builtin_ia32_pslldqi512_byteshift((__v8di)(__m512i)(a),          \
                                                (int)(imm)))
...
_mm512_maskz_srli_epi16(__mmask32 __U, __m512i __A, int __B) {
  return (__m512i)__builtin_ia32_selectw_512(
      (__mmask32)__U, (__v32hi)_mm512_srli_epi16(__A, (unsigned int)__B),
      (__v32hi)_mm512_setzero_si512());
}

#define _mm512_bsrli_epi128(a, imm)                                            \
  ((__m512i)__builtin_ia32_psrldqi512_byteshift((__v8di)(__m512i)(a),          \
                                                (int)(imm)))
