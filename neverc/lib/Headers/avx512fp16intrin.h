...
static __inline __m512h
    __DEFAULT_FN_ATTRS512 _mm512_set1_pch(_Float16 _Complex h) {
...
_mm_mask_load_sh(__m128h __W, __mmask8 __U, const void *__A) {
  ...
  return (__m128h)__builtin_ia32_loadsh128_mask((const __v8hf *)__A, src,
                                                __U & 1);
}
...
static __inline__ __m512i
    __DEFAULT_FN_ATTRS512 _mm512_cvtph_epi16(__m512h __A) {
...
static __inline__ __m512i
    __DEFAULT_FN_ATTRS512 _mm512_cvttph_epi16(__m512h __A) {
...
static __inline__ __m512h
    __DEFAULT_FN_ATTRS512 _mm512_cvtepi16_ph(__m512i __A) {
...
static __inline__ __m512i
    __DEFAULT_FN_ATTRS512 _mm512_cvtph_epu16(__m512h __A) {
...
static __inline__ __m512i
    __DEFAULT_FN_ATTRS512 _mm512_cvttph_epu16(__m512h __A) {
...
static __inline__ __m512h
    __DEFAULT_FN_ATTRS512 _mm512_cvtepu16_ph(__m512i __A) {
...
static __inline__ __m512i
    __DEFAULT_FN_ATTRS512 _mm512_cvtph_epi32(__m256h __A) {
...
static __inline__ __m512i
    __DEFAULT_FN_ATTRS512 _mm512_cvtph_epu32(__m256h __A) {
...
static __inline__ __m256h
    __DEFAULT_FN_ATTRS512 _mm512_cvtepi32_ph(__m512i __A) {
...
static __inline__ __m256h
    __DEFAULT_FN_ATTRS512 _mm512_cvtepu32_ph(__m512i __A) {
...
static __inline__ __m512i
    __DEFAULT_FN_ATTRS512 _mm512_cvttph_epi32(__m256h __A) {
...
static __inline__ __m512i
    __DEFAULT_FN_ATTRS512 _mm512_cvttph_epu32(__m256h __A) {
...
static __inline__ __m128h
    __DEFAULT_FN_ATTRS512 _mm512_cvtepi64_ph(__m512i __A) {
...
static __inline__ __m512i
    __DEFAULT_FN_ATTRS512 _mm512_cvtph_epi64(__m128h __A) {
...
static __inline__ __m128h
    __DEFAULT_FN_ATTRS512 _mm512_cvtepu64_ph(__m512i __A) {
...
static __inline__ __m512i
    __DEFAULT_FN_ATTRS512 _mm512_cvtph_epu64(__m128h __A) {
...
static __inline__ __m512i
    __DEFAULT_FN_ATTRS512 _mm512_cvttph_epi64(__m128h __A) {
...
static __inline__ __m512i
    __DEFAULT_FN_ATTRS512 _mm512_cvttph_epu64(__m128h __A) {
...
static __inline__ unsigned int
    __DEFAULT_FN_ATTRS128 _mm_cvtsh_u32(__m128h __A) {
...
static __inline__ unsigned long long
    __DEFAULT_FN_ATTRS128 _mm_cvtsh_u64(__m128h __A) {
...
static __inline__ __m128h
    __DEFAULT_FN_ATTRS128 _mm_cvtu32_sh(__m128h __A, unsigned int __B) {
  __A[0] = __B;
  return __A;
}
...
static __inline__ __m128h
    __DEFAULT_FN_ATTRS128 _mm_cvtu64_sh(__m128h __A, unsigned long long __B) {
  __A[0] = __B;
  return __A;
}
#endif
...
static __inline__ unsigned int
    __DEFAULT_FN_ATTRS128 _mm_cvttsh_u32(__m128h __A) {
...
static __inline__ unsigned long long
    __DEFAULT_FN_ATTRS128 _mm_cvttsh_u64(__m128h __A) {
...
static __inline__ __m128h
    __DEFAULT_FN_ATTRS128 _mm_fmsub_sh(__m128h __W, __m128h __A, __m128h __B) {
...
static __inline__ __m128h
    __DEFAULT_FN_ATTRS128 _mm_fnmadd_sh(__m128h __W, __m128h __A, __m128h __B) {
  return __builtin_ia32_vfmaddsh3_mask((__v8hf)__W, -(__v8hf)__A, (__v8hf)__B,
                                       (__mmask8)-1, _MM_FROUND_CUR_DIRECTION);
}
...
static __inline__ __m128h
    __DEFAULT_FN_ATTRS128 _mm_fnmsub_sh(__m128h __W, __m128h __A, __m128h __B) {
  return __builtin_ia32_vfmaddsh3_mask((__v8hf)__W, -(__v8hf)__A, -(__v8hf)__B,
                                       (__mmask8)-1, _MM_FROUND_CUR_DIRECTION);
}
...
static __inline__ __m128h
    __DEFAULT_FN_ATTRS128 _mm_fmadd_sch(__m128h __A, __m128h __B, __m128h __C) {
...
static __inline__ _Float16
    __DEFAULT_FN_ATTRS512 _mm512_reduce_add_ph(__m512h __W) {
