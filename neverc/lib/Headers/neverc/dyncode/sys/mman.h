/*===---- sys/mman.h - NeverC dyncode-oriented mmap shim ---------------===*\
|*
|* Normal mode forwards to the system header.
|* DynCode mode provides a compact declaration/constant subset for
...
#error                                                                         \
    "<sys/mman.h> is a user-mode header. In -mdyncode-context=kernel mode include <neverc/dyncode/kernel.h> and use vmalloc / ExAllocatePool2 / IOMalloc via the kernel resolver shim instead."
#endif
...
/* madvise hints commonly referenced by dyncode loaders.  Values 0-4
