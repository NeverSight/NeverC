...
#define _mm256_dp_ps(V1, V2, M)                                                \
  ((__m256)__builtin_ia32_dpps256((__v8sf)(__m256)(V1), (__v8sf)(__m256)(V2),  \
                                  (M)))
...
#define _mm256_cmp_ps(a, b, c)                                                 \
  ((__m256)__builtin_ia32_cmpps256((__v8sf)(__m256)(a), (__v8sf)(__m256)(b),   \
                                   (c)))
...
#define _mm256_insert_epi32(X, I, N)                                           \
  ((__m256i)__builtin_ia32_vec_set_v8si((__v8si)(__m256i)(X), (int)(I),        \
                                        (int)(N)))
...
#define _mm256_insert_epi16(X, I, N)                                           \
  ((__m256i)__builtin_ia32_vec_set_v16hi((__v16hi)(__m256i)(X), (int)(I),      \
                                         (int)(N)))
...
#define _mm256_insert_epi8(X, I, N)                                            \
  ((__m256i)__builtin_ia32_vec_set_v32qi((__v32qi)(__m256i)(X), (int)(I),      \
                                         (int)(N)))
