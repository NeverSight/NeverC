...
Hook de `openat` reemplazando su puntero en `sys_call_table`. Demuestra la intercepción clásica de syscall en kernels ARM64 GKI con `neverc_krt_syscall_replace` / `neverc_krt_syscall_restore`.
