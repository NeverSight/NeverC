...
تكامل SDK الكامل — يُهيئ جميع أنظمة NVK الفرعية ويعرضها عبر واجهة أوامر netlink. التنفيذ المرجعي لوحدات الإنتاج. يشمل: محرك Hook، بيانات الاعتماد، إخفاء الوحدة، SELinux، تعداد العمليات، فحص VMA، إدخال/إخراج الملفات، كشف البيئة، والإحصائيات.
