...
class GenStdModuleMethodsTest(unittest.TestCase):
    ...
    def test_html_template_module_maps_every_registered_symbol(self):
        with GEN.DEFAULT_MANIFEST.open(encoding="utf-8") as source:
            module = json.load(source)["modules"]["html/template"]
        ...
        self.assertEqual(
            registered - mapped,
            set(),
            "html/template has registered symbols without dot methods",
        )

    def test_fmt_module_maps_every_registered_symbol(self):
        with GEN.DEFAULT_MANIFEST.open(encoding="utf-8") as source:
            module = json.load(source)["modules"]["fmt"]
        ...
        self.assertEqual(
            registered - mapped,
            set(),
            "fmt has registered symbols without dot methods",
        )

    def test_strconv_module_maps_every_registered_symbol(self):
        with GEN.DEFAULT_MANIFEST.open(encoding="utf-8") as source:
            module = json.load(source)["modules"]["strconv"]
        ...
        self.assertEqual(
            registered - mapped,
            set(),
            "strconv has registered symbols without dot methods",
        )

    def test_flag_module_maps_every_registered_symbol(self):
        with GEN.DEFAULT_MANIFEST.open(encoding="utf-8") as source:
            module = json.load(source)["modules"]["flag"]
        ...
        self.assertEqual(
            registered - mapped,
            set(),
            "flag has registered symbols without dot methods",
        )

    def test_bufio_module_maps_every_registered_symbol(self):
        with GEN.DEFAULT_MANIFEST.open(encoding="utf-8") as source:
            module = json.load(source)["modules"]["bufio"]
        ...
        self.assertEqual(
            registered - mapped,
            set(),
            "bufio has registered symbols without dot methods",
        )

    def test_cmp_module_maps_every_registered_symbol(self):
        with GEN.DEFAULT_MANIFEST.open(encoding="utf-8") as source:
            module = json.load(source)["modules"]["cmp"]
    ...
    def test_ecdsa_module_maps_every_registered_symbol(self):
        with GEN.DEFAULT_MANIFEST.open(encoding="utf-8") as source:
            module = json.load(source)["modules"]["crypto/ecdsa"]
        ...
        self.assertEqual(
            registered - mapped,
            set(),
            "crypto/ecdsa has registered symbols without dot methods",
        )

    def test_dsa_module_maps_every_registered_symbol(self):
        with GEN.DEFAULT_MANIFEST.open(encoding="utf-8") as source:
            module = json.load(source)["modules"]["crypto/dsa"]
        ...
        self.assertEqual(
            registered - mapped,
            set(),
            "crypto/dsa has registered symbols without dot methods",
        )

    def test_mldsa_module_maps_every_registered_symbol(self):
        with GEN.DEFAULT_MANIFEST.open(encoding="utf-8") as source:
            module = json.load(source)["modules"]["crypto/mldsa"]
        ...
        self.assertEqual(
            registered - mapped,
            set(),
            "crypto/mldsa has registered symbols without dot methods",
        )

        expected_methods = {
            "new_pk44": "neverc_mldsa44_new_pk",
            "new_sk44": "neverc_mldsa44_new_sk",
            "pk_bytes44": "neverc_mldsa44_pk_bytes",
            "sk_bytes44": "neverc_mldsa44_sk_bytes",
            "sk_public_key44": "neverc_mldsa44_sk_public_key",
        }
        self.assertEqual(
            {
