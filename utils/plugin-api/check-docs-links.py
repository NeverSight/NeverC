...
COMPANIONS = [
    ...
    ROOT / "neverc/lib/Plugin/AndroidKernelReleaseWriterPolicy.h",
    ROOT / "neverc/lib/Plugin/Link/AndroidKernelReleaseBoundary.h",
    ...
    ROOT / "examples/android-kernel-common.mk",
