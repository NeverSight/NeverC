...
| Ordinary constructors in `cpp-core-v2` | User-provided default/converting/explicit constructors for standard-layout records with admitted copying and destruction. Fixtures check final destination identity, field declaration order, per-element array construction, materialization, hidden signatures and old-profile rejection. Generated/defaulted moves, exceptions and STL remain outside this increment; native results require the implementing revision. |
