...
| Nonpublic data members in `cpp-core-v2` | Private/protected fields in supported standard-layout classes retain Clang access checks and ordinary typed storage. Fixtures cover factories, defaults, aliases, generated copies/moves, private arrays and cleanup; illegal external access stays rejected. Mixed-access non-standard-layout classes, friends, inheritance and nested records remain separate work. Native results require the implementing revision. |
