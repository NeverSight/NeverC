...
`neverc-embedded-clang20.1.8-libcxx200100-macos15.5-r8`. No SDK descriptor, host SDK
...
and its source files are compiled into NeverC. The catalog contains 546 approved
...
Catalog SHA-256 is
`b40c4f1899ac3cbc0373d71296ca2ba48127a56bc05b681994ccd1648e0fa857`.
